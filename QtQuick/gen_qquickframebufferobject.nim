...
proc fcQQuickFramebufferObject_virtualbase_geometryChanged(self: pointer, newGeometry: pointer, oldGeometry: pointer): void {.importc: "QQuickFramebufferObject_virtualbase_geometryChanged".}
...
proc fcQQuickFramebufferObject_virtualbase_windowDeactivateEvent(self: pointer, ): void {.importc: "QQuickFramebufferObject_virtualbase_windowDeactivateEvent".}
...
proc miqt_exec_callback_cQQuickFramebufferObject_textureFollowsItemSizeChanged(slot: int, param1: bool) {.exportc: "miqt_exec_callback_QQuickFramebufferObject_textureFollowsItemSizeChanged".} =
...
proc miqt_exec_callback_cQQuickFramebufferObject_mirrorVerticallyChanged(slot: int, param1: bool) {.exportc: "miqt_exec_callback_QQuickFramebufferObject_mirrorVerticallyChanged".} =
...
type QQuickFramebufferObjectgeometryChangedProc* = proc(self: QQuickFramebufferObject, newGeometry: gen_qrect_types.QRectF, oldGeometry: gen_qrect_types.QRectF): void {.raises: [], gcsafe.}
...
type QQuickFramebufferObjectwindowDeactivateEventProc* = proc(self: QQuickFramebufferObject): void {.raises: [], gcsafe.}
...
type QQuickFramebufferObjectVTable* = object
  ...
  geometryChanged*: QQuickFramebufferObjectgeometryChangedProc
  ...
  windowDeactivateEvent*: QQuickFramebufferObjectwindowDeactivateEventProc
...
proc miqt_exec_callback_cQQuickFramebufferObject_createRenderer(vtbl: pointer, self: pointer): pointer {.cdecl.} =
  let vtbl = cast[ptr QQuickFramebufferObjectVTable](vtbl)
  let self = QQuickFramebufferObject(h: self)
  let virtualReturn = vtbl[].createRenderer(self)
  virtualReturn.h
...
proc QQuickFramebufferObjectgeometryChanged*(self: gen_qquickframebufferobject_types.QQuickFramebufferObject, newGeometry: gen_qrect_types.QRectF, oldGeometry: gen_qrect_types.QRectF): void =
  fcQQuickFramebufferObject_virtualbase_geometryChanged(self.h, newGeometry.h, oldGeometry.h)

proc miqt_exec_callback_cQQuickFramebufferObject_geometryChanged(vtbl: pointer, self: pointer, newGeometry: pointer, oldGeometry: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QQuickFramebufferObjectVTable](vtbl)
  let self = QQuickFramebufferObject(h: self)
...
proc QQuickFramebufferObjectwindowDeactivateEvent*(self: gen_qquickframebufferobject_types.QQuickFramebufferObject, ): void =
  fcQQuickFramebufferObject_virtualbase_windowDeactivateEvent(self.h)

proc miqt_exec_callback_cQQuickFramebufferObject_windowDeactivateEvent(vtbl: pointer, self: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QQuickFramebufferObjectVTable](vtbl)
  let self = QQuickFramebufferObject(h: self)
...
proc create*(T: type gen_qquickframebufferobject_types.QQuickFramebufferObject,
  ...
  if not isNil(vtbl.geometryChanged):
    vtbl[].vtbl.geometryChanged = miqt_exec_callback_cQQuickFramebufferObject_geometryChanged
  ...
  if not isNil(vtbl.windowDeactivateEvent):
    vtbl[].vtbl.windowDeactivateEvent = miqt_exec_callback_cQQuickFramebufferObject_windowDeactivateEvent
