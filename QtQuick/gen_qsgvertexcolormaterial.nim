...
proc QSGVertexColorMaterialcreateShader*(self: gen_qsgvertexcolormaterial_types.QSGVertexColorMaterial, renderMode: cint): gen_qsgmaterialshader_types.QSGMaterialShader =
  gen_qsgmaterialshader_types.QSGMaterialShader(h: fQSGVertexColorMaterial_virtualbase_createShader(self.h, cint(renderMode)))

type QSGVertexColorMaterialcreateShaderProc* = proc(renderMode: cint): gen_qsgmaterialshader_types.QSGMaterialShader
