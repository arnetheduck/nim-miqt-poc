...
public:
	...
	// Wrapper to allow calling protected method
	QSGTexture* virtualbase_removedFromAtlas() const {
...
QSGTexture* QSGTexture_virtualbase_removedFromAtlas(const void* self) {
	return ( (const MiqtVirtualQSGTexture*)(self) )->virtualbase_removedFromAtlas();
}
...
QSGTexture* QSGDynamicTexture_virtualbase_removedFromAtlas(const void* self) {
	return ( (const MiqtVirtualQSGDynamicTexture*)(self) )->virtualbase_removedFromAtlas();
}
