...
proc QSGOpaqueTextureMaterialcreateShader*(self: gen_qsgtexturematerial_types.QSGOpaqueTextureMaterial, renderMode: cint): gen_qsgmaterialshader_types.QSGMaterialShader =
  gen_qsgmaterialshader_types.QSGMaterialShader(h: fQSGOpaqueTextureMaterial_virtualbase_createShader(self.h, cint(renderMode)))

type QSGOpaqueTextureMaterialcreateShaderProc* = proc(renderMode: cint): gen_qsgmaterialshader_types.QSGMaterialShader
