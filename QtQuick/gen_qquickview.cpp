...
public:
	...
	bool virtualbase_nativeEvent(struct miqt_string eventType, void* message, intptr_t* result) {
		...
		return QQuickView::nativeEvent(eventType_QByteArray, message, (qintptr*)(result));
...
void QQuickView_virtualbase_closeEvent(void* self, QCloseEvent* param1) {
	( (MiqtVirtualQQuickView*)(self) )->virtualbase_closeEvent(param1);
}
...
void QQuickView_virtualbase_paintEvent(void* self, QPaintEvent* param1) {
	( (MiqtVirtualQQuickView*)(self) )->virtualbase_paintEvent(param1);
}
