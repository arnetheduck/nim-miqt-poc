...
public:
	...
	// Wrapper to allow calling protected method
	void virtualbase_geometryChange(QRectF* newGeometry, QRectF* oldGeometry) {
...
void QQuickPaintedItem_virtualbase_geometryChange(void* self, QRectF* newGeometry, QRectF* oldGeometry) {
	( (MiqtVirtualQQuickPaintedItem*)(self) )->virtualbase_geometryChange(newGeometry, oldGeometry);
}
