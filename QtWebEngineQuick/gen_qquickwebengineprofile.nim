...
proc miqt_exec_callback_cQQuickWebEngineProfile_downloadRequested(slot: int, download: ptr cQQuickWebEngineDownloadRequest) {.exportc: "miqt_exec_callback_QQuickWebEngineProfile_downloadRequested".} =
...
proc miqt_exec_callback_cQQuickWebEngineProfile_downloadFinished(slot: int, download: ptr cQQuickWebEngineDownloadRequest) {.exportc: "miqt_exec_callback_QQuickWebEngineProfile_downloadFinished".} =
