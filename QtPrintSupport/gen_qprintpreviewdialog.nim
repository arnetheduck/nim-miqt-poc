...
type QPrintPreviewDialognativeEventProc* = proc(self: QPrintPreviewDialog, eventType: seq[byte], message: pointer, resultVal: ptr clong): bool {.raises: [], gcsafe.}
...
proc miqt_exec_callback_cQPrintPreviewDialog_nativeEvent(vtbl: pointer, self: pointer, eventType: struct_miqt_string, message: pointer, resultVal: ptr clong): bool {.cdecl.} =
  let vtbl = cast[ptr QPrintPreviewDialogVTable](vtbl)
  let self = QPrintPreviewDialog(h: self)
