...
type QPrintPreviewWidgetnativeEventProc* = proc(self: QPrintPreviewWidget, eventType: seq[byte], message: pointer, resultVal: ptr clong): bool {.raises: [], gcsafe.}
...
proc miqt_exec_callback_cQPrintPreviewWidget_nativeEvent(vtbl: pointer, self: pointer, eventType: struct_miqt_string, message: pointer, resultVal: ptr clong): bool {.cdecl.} =
  let vtbl = cast[ptr QPrintPreviewWidgetVTable](vtbl)
  let self = QPrintPreviewWidget(h: self)
