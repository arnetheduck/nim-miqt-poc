...
proc fcQPageSetupDialog_virtualbase_nativeEvent(self: pointer, eventType: struct_miqt_string, message: pointer, resultVal: ptr uint): bool {.importc: "QPageSetupDialog_virtualbase_nativeEvent".}
...
type QPageSetupDialogenterEventProc* = proc(self: QPageSetupDialog, event: gen_qevent_types.QEnterEvent): void {.raises: [], gcsafe.}
...
proc miqt_exec_callback_cQPageSetupDialog_nativeEvent(vtbl: pointer, self: pointer, eventType: struct_miqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let vtbl = cast[ptr QPageSetupDialogVTable](vtbl)
  let self = QPageSetupDialog(h: self)
