...
public:
	...
	MiqtVirtualQPixmap(struct QPixmap_VTable* vtbl): QPixmap(), vtbl(vtbl) {};
	MiqtVirtualQPixmap(struct QPixmap_VTable* vtbl, int w, int h): QPixmap(w, h), vtbl(vtbl) {};
	MiqtVirtualQPixmap(struct QPixmap_VTable* vtbl, const QSize& param1): QPixmap(param1), vtbl(vtbl) {};
	MiqtVirtualQPixmap(struct QPixmap_VTable* vtbl, const QString& fileName): QPixmap(fileName), vtbl(vtbl) {};
	MiqtVirtualQPixmap(struct QPixmap_VTable* vtbl, const QPixmap& param1): QPixmap(param1), vtbl(vtbl) {};
	MiqtVirtualQPixmap(struct QPixmap_VTable* vtbl, const QString& fileName, const char* format): QPixmap(fileName, format), vtbl(vtbl) {};
	MiqtVirtualQPixmap(struct QPixmap_VTable* vtbl, const QString& fileName, const char* format, Qt::ImageConversionFlags flags): QPixmap(fileName, format, flags), vtbl(vtbl) {};

	virtual ~MiqtVirtualQPixmap() override { if(vtbl->destructor) vtbl->destructor(vtbl, this); }
...
QPixmap* QPixmap_new6(struct QPixmap_VTable* vtbl, struct miqt_string fileName, const char* format) {
	QString fileName_QString = QString::fromUtf8(fileName.data, fileName.len);
	return new MiqtVirtualQPixmap(vtbl, fileName_QString, format);
}

QPixmap* QPixmap_new7(struct QPixmap_VTable* vtbl, struct miqt_string fileName, const char* format, int flags) {
	QString fileName_QString = QString::fromUtf8(fileName.data, fileName.len);
	return new MiqtVirtualQPixmap(vtbl, fileName_QString, format, static_cast<Qt::ImageConversionFlags>(flags));
}
