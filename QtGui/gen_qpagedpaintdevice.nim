...
type QPagedPaintDevicesetPageSizeProc* = proc(self: QPagedPaintDevice, size: cint): void {.raises: [], gcsafe.}
...
type QPagedPaintDeviceVTable* = object
  ...
  setPageSize*: QPagedPaintDevicesetPageSizeProc
...
proc create*(T: type gen_qpagedpaintdevice_types.QPagedPaintDevice,
  ...
  if not isNil(vtbl.setPageSize):
    vtbl[].vtbl.setPageSize = miqt_exec_callback_cQPagedPaintDevice_setPageSizeWithSize
