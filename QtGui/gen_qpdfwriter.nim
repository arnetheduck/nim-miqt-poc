...
type QPdfWritersetPageLayoutProc* = proc(pageLayout: gen_qpagelayout_types.QPageLayout): bool
...
type QPdfWritersetPageSizeProc* = proc(pageSize: gen_qpagesize_types.QPageSize): bool
...
type QPdfWritersetPageMarginsProc* = proc(margins: gen_qmargins_types.QMarginsF, units: cint): bool
...
type QPdfWritersetPageRangesProc* = proc(ranges: gen_qpageranges_types.QPageRanges): void
