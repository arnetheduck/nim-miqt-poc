...
type QWindowpaintEventProc* = proc(param1: gen_qevent_types.QPaintEvent): void
...
type QWindowcloseEventProc* = proc(param1: gen_qevent_types.QCloseEvent): void
