...
public:
	...
	MiqtVirtualQQmlAbstractUrlInterceptor(struct QQmlAbstractUrlInterceptor_VTable* vtbl): QQmlAbstractUrlInterceptor(), vtbl(vtbl) {};

	virtual ~MiqtVirtualQQmlAbstractUrlInterceptor() override { if(vtbl->destructor) vtbl->destructor(vtbl, this); }
...
QQmlAbstractUrlInterceptor* QQmlAbstractUrlInterceptor_new(struct QQmlAbstractUrlInterceptor_VTable* vtbl) {
	return new MiqtVirtualQQmlAbstractUrlInterceptor(vtbl);
}
