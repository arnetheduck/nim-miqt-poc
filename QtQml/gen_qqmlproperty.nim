...
proc create*(T: type gen_qqmlproperty_types.QQmlProperty, param1: gen_qobject_types.QObject): gen_qqmlproperty_types.QQmlProperty =
  gen_qqmlproperty_types.QQmlProperty.init(fcQQmlProperty_new2(param1.h))

proc create*(T: type gen_qqmlproperty_types.QQmlProperty, param1: gen_qobject_types.QObject, param2: gen_qqmlcontext_types.QQmlContext): gen_qqmlproperty_types.QQmlProperty =
  gen_qqmlproperty_types.QQmlProperty.init(fcQQmlProperty_new3(param1.h, param2.h))

proc create*(T: type gen_qqmlproperty_types.QQmlProperty, param1: gen_qobject_types.QObject, param2: gen_qqmlengine_types.QQmlEngine): gen_qqmlproperty_types.QQmlProperty =
  gen_qqmlproperty_types.QQmlProperty.init(fcQQmlProperty_new4(param1.h, param2.h))

proc create*(T: type gen_qqmlproperty_types.QQmlProperty, param1: gen_qobject_types.QObject, param2: string): gen_qqmlproperty_types.QQmlProperty =
...
proc create*(T: type gen_qqmlproperty_types.QQmlProperty, param1: gen_qobject_types.QObject, param2: string, param3: gen_qqmlcontext_types.QQmlContext): gen_qqmlproperty_types.QQmlProperty =
...
proc create*(T: type gen_qqmlproperty_types.QQmlProperty, param1: gen_qobject_types.QObject, param2: string, param3: gen_qqmlengine_types.QQmlEngine): gen_qqmlproperty_types.QQmlProperty =
...
proc create*(T: type gen_qqmlproperty_types.QQmlProperty, param1: gen_qqmlproperty_types.QQmlProperty): gen_qqmlproperty_types.QQmlProperty =
...
proc swap*(self: gen_qqmlproperty_types.QQmlProperty, other: gen_qqmlproperty_types.QQmlProperty): void =
...
proc propertyMetaType*(self: gen_qqmlproperty_types.QQmlProperty, ): gen_qmetatype_types.QMetaType =
  gen_qmetatype_types.QMetaType(h: fcQQmlProperty_propertyMetaType(self.h))
...
proc read*(self: gen_qqmlproperty_types.QQmlProperty, ): gen_qvariant_types.QVariant =
  gen_qvariant_types.QVariant(h: fcQQmlProperty_read(self.h))
...
proc read*(_: type gen_qqmlproperty_types.QQmlProperty, param1: gen_qobject_types.QObject, param2: string): gen_qvariant_types.QVariant =
  gen_qvariant_types.QVariant(h: fcQQmlProperty_read2(param1.h, struct_miqt_string(data: param2, len: csize_t(len(param2)))))
...
proc read*(_: type gen_qqmlproperty_types.QQmlProperty, param1: gen_qobject_types.QObject, param2: string, param3: gen_qqmlcontext_types.QQmlContext): gen_qvariant_types.QVariant =
  gen_qvariant_types.QVariant(h: fcQQmlProperty_read3(param1.h, struct_miqt_string(data: param2, len: csize_t(len(param2))), param3.h))
...
proc read*(_: type gen_qqmlproperty_types.QQmlProperty, param1: gen_qobject_types.QObject, param2: string, param3: gen_qqmlengine_types.QQmlEngine): gen_qvariant_types.QVariant =
  gen_qvariant_types.QVariant(h: fcQQmlProperty_read4(param1.h, struct_miqt_string(data: param2, len: csize_t(len(param2))), param3.h))
...
proc objectX*(self: gen_qqmlproperty_types.QQmlProperty, ): gen_qobject_types.QObject =
  gen_qobject_types.QObject(h: fcQQmlProperty_objectX(self.h))
...
proc property*(self: gen_qqmlproperty_types.QQmlProperty, ): gen_qmetaobject_types.QMetaProperty =
  gen_qmetaobject_types.QMetaProperty(h: fcQQmlProperty_property(self.h))
