...
proc miqt_exec_callback_cQPlainTextEdit_textChanged_release(slot: int) {.exportc: "miqt_exec_callback_QPlainTextEdit_textChanged_release".} =
...
proc miqt_exec_callback_cQPlainTextEdit_undoAvailable_release(slot: int) {.exportc: "miqt_exec_callback_QPlainTextEdit_undoAvailable_release".} =
...
proc miqt_exec_callback_cQPlainTextEdit_redoAvailable_release(slot: int) {.exportc: "miqt_exec_callback_QPlainTextEdit_redoAvailable_release".} =
...
proc miqt_exec_callback_cQPlainTextEdit_copyAvailable_release(slot: int) {.exportc: "miqt_exec_callback_QPlainTextEdit_copyAvailable_release".} =
...
proc miqt_exec_callback_cQPlainTextEdit_selectionChanged_release(slot: int) {.exportc: "miqt_exec_callback_QPlainTextEdit_selectionChanged_release".} =
...
proc miqt_exec_callback_cQPlainTextEdit_cursorPositionChanged_release(slot: int) {.exportc: "miqt_exec_callback_QPlainTextEdit_cursorPositionChanged_release".} =
...
proc miqt_exec_callback_cQPlainTextEdit_updateRequest_release(slot: int) {.exportc: "miqt_exec_callback_QPlainTextEdit_updateRequest_release".} =
...
proc miqt_exec_callback_cQPlainTextEdit_blockCountChanged_release(slot: int) {.exportc: "miqt_exec_callback_QPlainTextEdit_blockCountChanged_release".} =
...
proc miqt_exec_callback_cQPlainTextEdit_modificationChanged_release(slot: int) {.exportc: "miqt_exec_callback_QPlainTextEdit_modificationChanged_release".} =
...
proc miqt_exec_callback_cQPlainTextEdit_loadResource(vtbl: pointer, self: pointer, typeVal: cint, name: pointer): pointer {.cdecl.} =
  ...
  let virtualReturn = vtbl[].loadResource(self, slotval1, slotval2)
  virtualReturn.h
...
proc miqt_exec_callback_cQPlainTextEdit_createMimeDataFromSelection(vtbl: pointer, self: pointer): pointer {.cdecl.} =
  let vtbl = cast[ptr QPlainTextEditVTable](vtbl)
  let self = QPlainTextEdit(h: self)
  let virtualReturn = vtbl[].createMimeDataFromSelection(self)
  virtualReturn.h
...
proc miqt_exec_callback_cQPlainTextDocumentLayout_hitTest(vtbl: pointer, self: pointer, param1: pointer, param2: cint): cint {.cdecl.} =
  ...
  let virtualReturn = vtbl[].hitTest(self, slotval1, slotval2)
  virtualReturn
...
proc miqt_exec_callback_cQPlainTextDocumentLayout_pageCount(vtbl: pointer, self: pointer): cint {.cdecl.} =
  let vtbl = cast[ptr QPlainTextDocumentLayoutVTable](vtbl)
  let self = QPlainTextDocumentLayout(h: self)
  let virtualReturn = vtbl[].pageCount(self)
  virtualReturn
...
proc miqt_exec_callback_cQPlainTextDocumentLayout_documentSize(vtbl: pointer, self: pointer): pointer {.cdecl.} =
  let vtbl = cast[ptr QPlainTextDocumentLayoutVTable](vtbl)
  let self = QPlainTextDocumentLayout(h: self)
  let virtualReturn = vtbl[].documentSize(self)
  virtualReturn.h
...
proc miqt_exec_callback_cQPlainTextDocumentLayout_frameBoundingRect(vtbl: pointer, self: pointer, param1: pointer): pointer {.cdecl.} =
  ...
  let virtualReturn = vtbl[].frameBoundingRect(self, slotval1)
  virtualReturn.h
...
proc miqt_exec_callback_cQPlainTextDocumentLayout_blockBoundingRect(vtbl: pointer, self: pointer, blockVal: pointer): pointer {.cdecl.} =
  ...
  let virtualReturn = vtbl[].blockBoundingRect(self, slotval1)
  virtualReturn.h
