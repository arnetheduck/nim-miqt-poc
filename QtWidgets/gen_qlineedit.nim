...
type QLineEditkeyReleaseEventProc* = proc(event: gen_qevent_types.QKeyEvent): void
...
type QLineEditenterEventProc* = proc(event: gen_qcoreevent_types.QEvent): void
...
type QLineEdittimerEventProc* = proc(event: gen_qcoreevent_types.QTimerEvent): void
...
proc miqt_exec_callback_QLineEdit_disconnectNotify(self: ptr cQLineEdit, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QLineEdit_disconnectNotify ".} =
  ...
  nimfunc[](slotval1)
proc staticMetaObject*(_: type gen_qlineedit_types.QLineEdit): gen_qobjectdefs.QMetaObject =
