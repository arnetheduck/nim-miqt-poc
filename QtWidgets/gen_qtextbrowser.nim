...
type QTextBrowserdoSetSourceProc* = proc(name: gen_qurl_types.QUrl, typeVal: cint): void
...
type QTextBrowserinitStyleOptionProc* = proc(option: gen_qstyleoption_types.QStyleOptionFrame): void
...
type QTextBrowserenterEventProc* = proc(event: gen_qevent_types.QEnterEvent): void
