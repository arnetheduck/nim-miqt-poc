...
type QTreeViewchangeEventProc* = proc(event: gen_qcoreevent_types.QEvent): void
...
proc QTreeViewitemDelegateForIndex*(self: gen_qtreeview_types.QTreeView, index: gen_qabstractitemmodel_types.QModelIndex): gen_qabstractitemdelegate_types.QAbstractItemDelegate =
  gen_qabstractitemdelegate_types.QAbstractItemDelegate(h: fQTreeView_virtualbase_itemDelegateForIndex(self.h, index.h))

type QTreeViewitemDelegateForIndexProc* = proc(index: gen_qabstractitemmodel_types.QModelIndex): gen_qabstractitemdelegate_types.QAbstractItemDelegate
...
type QTreeViewinitViewItemOptionProc* = proc(option: gen_qstyleoption_types.QStyleOptionViewItem): void
...
type QTreeViewinitStyleOptionProc* = proc(option: gen_qstyleoption_types.QStyleOptionFrame): void
...
type QTreeViewenterEventProc* = proc(event: gen_qevent_types.QEnterEvent): void
