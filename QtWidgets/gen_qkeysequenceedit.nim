...
type QKeySequenceEditfocusOutEventProc* = proc(event: gen_qevent_types.QFocusEvent): void
...
type QKeySequenceEditenterEventProc* = proc(event: gen_qcoreevent_types.QEvent): void
