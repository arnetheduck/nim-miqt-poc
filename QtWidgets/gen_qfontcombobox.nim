...
type QFontComboBoxsetModelProc* = proc(model: gen_qabstractitemmodel_types.QAbstractItemModel): void
...
type QFontComboBoxinitStyleOptionProc* = proc(option: gen_qstyleoption_types.QStyleOptionComboBox): void
...
type QFontComboBoxenterEventProc* = proc(event: gen_qevent_types.QEnterEvent): void
