...
proc fcQTextEdit_virtualbase_initStyleOption(self: pointer, option: pointer): void {.importc: "QTextEdit_virtualbase_initStyleOption".}
...
proc fcQTextEdit_virtualbase_nativeEvent(self: pointer, eventType: struct_miqt_string, message: pointer, resultVal: ptr uint): bool {.importc: "QTextEdit_virtualbase_nativeEvent".}
...
type QTextEditinitStyleOptionProc* = proc(self: QTextEdit, option: gen_qstyleoption_types.QStyleOptionFrame): void {.raises: [], gcsafe.}
...
type QTextEditenterEventProc* = proc(self: QTextEdit, event: gen_qevent_types.QEnterEvent): void {.raises: [], gcsafe.}
...
type QTextEditnativeEventProc* = proc(self: QTextEdit, eventType: seq[byte], message: pointer, resultVal: ptr uint): bool {.raises: [], gcsafe.}
...
type QTextEditVTable* = object
  ...
  initStyleOption*: QTextEditinitStyleOptionProc
...
proc QTextEditinitStyleOption*(self: gen_qtextedit_types.QTextEdit, option: gen_qstyleoption_types.QStyleOptionFrame): void =
  fcQTextEdit_virtualbase_initStyleOption(self.h, option.h)

proc miqt_exec_callback_cQTextEdit_initStyleOption(vtbl: pointer, self: pointer, option: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QTextEditVTable](vtbl)
  let self = QTextEdit(h: self)
...
proc miqt_exec_callback_cQTextEdit_nativeEvent(vtbl: pointer, self: pointer, eventType: struct_miqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let vtbl = cast[ptr QTextEditVTable](vtbl)
  let self = QTextEdit(h: self)
...
proc create*(T: type gen_qtextedit_types.QTextEdit,
  ...
  if not isNil(vtbl.initStyleOption):
    vtbl[].vtbl.initStyleOption = miqt_exec_callback_cQTextEdit_initStyleOption
