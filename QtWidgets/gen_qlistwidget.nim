...
type QListWidgetItemsetBackgroundColorProc* = proc(color: gen_qcolor_types.QColor): void
...
proc QListWidgetviewOptions*(self: gen_qlistwidget_types.QListWidget, ): gen_qstyleoption_types.QStyleOptionViewItem =
  gen_qstyleoption_types.QStyleOptionViewItem(h: fQListWidget_virtualbase_viewOptions(self.h))

type QListWidgetviewOptionsProc* = proc(): gen_qstyleoption_types.QStyleOptionViewItem
...
type QListWidgetenterEventProc* = proc(event: gen_qcoreevent_types.QEvent): void
