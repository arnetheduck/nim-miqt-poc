...
type QToolBarinitStyleOptionProc* = proc(option: gen_qstyleoption_types.QStyleOptionToolBar): void
...
type QToolBarenterEventProc* = proc(event: gen_qevent_types.QEnterEvent): void
