...
proc QColumnViewviewOptions*(self: gen_qcolumnview_types.QColumnView, ): gen_qstyleoption_types.QStyleOptionViewItem =
  gen_qstyleoption_types.QStyleOptionViewItem(h: fQColumnView_virtualbase_viewOptions(self.h))

type QColumnViewviewOptionsProc* = proc(): gen_qstyleoption_types.QStyleOptionViewItem
...
type QColumnViewenterEventProc* = proc(event: gen_qcoreevent_types.QEvent): void
