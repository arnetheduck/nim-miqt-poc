...
type QColumnVieweditProc* = proc(self: QColumnView, index: gen_qabstractitemmodel_types.QModelIndex, trigger: cint, event: gen_qcoreevent_types.QEvent): bool {.raises: [], gcsafe.}
...
proc miqt_exec_callback_cQColumnView_createColumn(vtbl: pointer, self: pointer, rootIndex: pointer): pointer {.cdecl.} =
  ...
  let virtualReturn = vtbl[].createColumn(self, slotval1)
  virtualReturn.h
...
proc QColumnViewitemDelegateForIndex*(self: gen_qcolumnview_types.QColumnView, index: gen_qabstractitemmodel_types.QModelIndex): gen_qabstractitemdelegate_types.QAbstractItemDelegate =
  gen_qabstractitemdelegate_types.QAbstractItemDelegate(h: fcQColumnView_virtualbase_itemDelegateForIndex(self.h, index.h))
...
proc create*(T: type gen_qcolumnview_types.QColumnView,
  ...
  if not isNil(vtbl.edit):
    vtbl[].vtbl.edit = miqt_exec_callback_cQColumnView_edit2
