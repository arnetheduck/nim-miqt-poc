...
type QToolButtonenterEventProc* = proc(param1: gen_qevent_types.QEnterEvent): void
...
type QToolButtoninitStyleOptionProc* = proc(option: gen_qstyleoption_types.QStyleOptionToolButton): void
...
proc miqt_exec_callback_QToolButton_initStyleOption(self: ptr cQToolButton, slot: int, option: pointer): void {.exportc: "miqt_exec_callback_QToolButton_initStyleOption ".} =
  ...
  let slotval1 = gen_qstyleoption_types.QStyleOptionToolButton(h: option)
