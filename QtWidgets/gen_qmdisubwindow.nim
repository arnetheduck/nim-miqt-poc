...
proc fcQMdiSubWindow_virtualbase_nativeEvent(self: pointer, eventType: struct_miqt_string, message: pointer, resultVal: ptr clong): bool {.importc: "QMdiSubWindow_virtualbase_nativeEvent".}
...
type QMdiSubWindowenterEventProc* = proc(self: QMdiSubWindow, event: gen_qcoreevent_types.QEvent): void {.raises: [], gcsafe.}
...
type QMdiSubWindownativeEventProc* = proc(self: QMdiSubWindow, eventType: seq[byte], message: pointer, resultVal: ptr clong): bool {.raises: [], gcsafe.}
...
proc miqt_exec_callback_cQMdiSubWindow_nativeEvent(vtbl: pointer, self: pointer, eventType: struct_miqt_string, message: pointer, resultVal: ptr clong): bool {.cdecl.} =
  let vtbl = cast[ptr QMdiSubWindowVTable](vtbl)
  let self = QMdiSubWindow(h: self)
