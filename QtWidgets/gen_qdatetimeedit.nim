...
proc miqt_exec_callback_cQDateTimeEdit_dateTimeFromText(vtbl: pointer, self: pointer, text: struct_miqt_string): pointer {.cdecl.} =
  ...
  let virtualReturn = vtbl[].dateTimeFromText(self, slotval1)
  virtualReturn.h
...
proc miqt_exec_callback_cQDateTimeEdit_textFromDateTime(vtbl: pointer, self: pointer, dt: pointer): struct_miqt_string {.cdecl.} =
  ...
  let virtualReturn = vtbl[].textFromDateTime(self, slotval1)
...
proc miqt_exec_callback_cQDateTimeEdit_initStyleOption(vtbl: pointer, self: pointer, option: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QDateTimeEditVTable](vtbl)
  let self = QDateTimeEdit(h: self)
...
proc miqt_exec_callback_cQDateTimeEdit_nativeEvent(vtbl: pointer, self: pointer, eventType: struct_miqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let vtbl = cast[ptr QDateTimeEditVTable](vtbl)
  let self = QDateTimeEdit(h: self)
...
proc create*(T: type gen_qdatetimeedit_types.QDateTimeEdit,
  ...
  if not isNil(vtbl.initStyleOption):
    vtbl[].vtbl.initStyleOption = miqt_exec_callback_cQDateTimeEdit_initStyleOption
...
proc miqt_exec_callback_cQTimeEdit_initStyleOption(vtbl: pointer, self: pointer, option: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QTimeEditVTable](vtbl)
  let self = QTimeEdit(h: self)
  let slotval1 = gen_qstyleoption_types.QStyleOptionSpinBox(h: option)
  vtbl[].initStyleOption(self, slotval1)
...
proc miqt_exec_callback_cQTimeEdit_nativeEvent(vtbl: pointer, self: pointer, eventType: struct_miqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let vtbl = cast[ptr QTimeEditVTable](vtbl)
  let self = QTimeEdit(h: self)
  var veventType_bytearray = eventType
  var veventTypex_ret = @(toOpenArrayByte(veventType_bytearray.data, 0, int(veventType_bytearray.len)-1))
...
proc create*(T: type gen_qdatetimeedit_types.QTimeEdit,
  ...
  if not isNil(vtbl.initStyleOption):
    vtbl[].vtbl.initStyleOption = miqt_exec_callback_cQTimeEdit_initStyleOption
  if not isNil(vtbl.minimumSizeHint):
...
proc miqt_exec_callback_cQDateEdit_initStyleOption(vtbl: pointer, self: pointer, option: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QDateEditVTable](vtbl)
  let self = QDateEdit(h: self)
  let slotval1 = gen_qstyleoption_types.QStyleOptionSpinBox(h: option)
  vtbl[].initStyleOption(self, slotval1)
...
proc miqt_exec_callback_cQDateEdit_nativeEvent(vtbl: pointer, self: pointer, eventType: struct_miqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let vtbl = cast[ptr QDateEditVTable](vtbl)
  let self = QDateEdit(h: self)
  var veventType_bytearray = eventType
  var veventTypex_ret = @(toOpenArrayByte(veventType_bytearray.data, 0, int(veventType_bytearray.len)-1))
...
proc create*(T: type gen_qdatetimeedit_types.QDateEdit,
  ...
  if not isNil(vtbl.initStyleOption):
    vtbl[].vtbl.initStyleOption = miqt_exec_callback_cQDateEdit_initStyleOption
  if not isNil(vtbl.minimumSizeHint):
