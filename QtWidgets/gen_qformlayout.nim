...
proc QFormLayoutreplaceWidget*(self: gen_qformlayout_types.QFormLayout, fromVal: gen_qwidget_types.QWidget, to: gen_qwidget_types.QWidget, options: cint): gen_qlayoutitem_types.QLayoutItem =
  gen_qlayoutitem_types.QLayoutItem(h: fQFormLayout_virtualbase_replaceWidget(self.h, fromVal.h, to.h, cint(options)))

type QFormLayoutreplaceWidgetProc* = proc(fromVal: gen_qwidget_types.QWidget, to: gen_qwidget_types.QWidget, options: cint): gen_qlayoutitem_types.QLayoutItem
...
proc miqt_exec_callback_QFormLayout_spacerItem(self: ptr cQFormLayout, slot: int): pointer {.exportc: "miqt_exec_callback_QFormLayout_spacerItem ".} =
  ...
  virtualReturn.h
proc staticMetaObject*(_: type gen_qformlayout_types.QFormLayout): gen_qobjectdefs.QMetaObject =
