...
type QRubberBandinitStyleOptionProc* = proc(option: gen_qstyleoption_types.QStyleOptionRubberBand): void
...
proc miqt_exec_callback_QRubberBand_initStyleOption(self: ptr cQRubberBand, slot: int, option: pointer): void {.exportc: "miqt_exec_callback_QRubberBand_initStyleOption ".} =
  ...
  let slotval1 = gen_qstyleoption_types.QStyleOptionRubberBand(h: option)
...
type QRubberBandenterEventProc* = proc(event: gen_qevent_types.QEnterEvent): void
