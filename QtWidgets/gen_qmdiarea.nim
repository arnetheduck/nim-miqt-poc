...
proc fcQMdiArea_virtualbase_nativeEvent(self: pointer, eventType: struct_miqt_string, message: pointer, resultVal: ptr clong): bool {.importc: "QMdiArea_virtualbase_nativeEvent".}
...
type QMdiAreaenterEventProc* = proc(self: QMdiArea, event: gen_qcoreevent_types.QEvent): void {.raises: [], gcsafe.}
...
type QMdiAreanativeEventProc* = proc(self: QMdiArea, eventType: seq[byte], message: pointer, resultVal: ptr clong): bool {.raises: [], gcsafe.}
...
proc QMdiAreaenterEvent*(self: gen_qmdiarea_types.QMdiArea, event: gen_qcoreevent_types.QEvent): void =
...
proc miqt_exec_callback_cQMdiArea_nativeEvent(vtbl: pointer, self: pointer, eventType: struct_miqt_string, message: pointer, resultVal: ptr clong): bool {.cdecl.} =
  let vtbl = cast[ptr QMdiAreaVTable](vtbl)
  let self = QMdiArea(h: self)
