...
type QFocusFrameinitStyleOptionProc* = proc(option: gen_qstyleoption_types.QStyleOption): void
...
type QFocusFrameenterEventProc* = proc(event: gen_qevent_types.QEnterEvent): void
