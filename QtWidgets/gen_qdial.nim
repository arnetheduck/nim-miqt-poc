...
type QDialinitStyleOptionProc* = proc(option: gen_qstyleoption_types.QStyleOptionSlider): void
...
type QDialenterEventProc* = proc(event: gen_qevent_types.QEnterEvent): void
