...
type QTabBarmouseDoubleClickEventProc* = proc(event: gen_qevent_types.QMouseEvent): void
...
type QTabBarenterEventProc* = proc(event: gen_qcoreevent_types.QEvent): void
