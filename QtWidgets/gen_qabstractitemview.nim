...
proc QAbstractItemViewviewOptions*(self: gen_qabstractitemview_types.QAbstractItemView, ): gen_qstyleoption_types.QStyleOptionViewItem =
  gen_qstyleoption_types.QStyleOptionViewItem(h: fQAbstractItemView_virtualbase_viewOptions(self.h))

type QAbstractItemViewviewOptionsProc* = proc(): gen_qstyleoption_types.QStyleOptionViewItem
...
type QAbstractItemViewenterEventProc* = proc(event: gen_qcoreevent_types.QEvent): void
