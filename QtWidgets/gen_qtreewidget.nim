...
proc QTreeWidgetviewOptions*(self: gen_qtreewidget_types.QTreeWidget, ): gen_qstyleoption_types.QStyleOptionViewItem =
  gen_qstyleoption_types.QStyleOptionViewItem(h: fQTreeWidget_virtualbase_viewOptions(self.h))

type QTreeWidgetviewOptionsProc* = proc(): gen_qstyleoption_types.QStyleOptionViewItem
...
type QTreeWidgetchangeEventProc* = proc(param1: gen_qcoreevent_types.QEvent): void
...
type QTreeWidgetenterEventProc* = proc(event: gen_qcoreevent_types.QEvent): void
