...
type QDockWidgetinitStyleOptionProc* = proc(option: gen_qstyleoption_types.QStyleOptionDockWidget): void
...
proc miqt_exec_callback_QDockWidget_initStyleOption(self: ptr cQDockWidget, slot: int, option: pointer): void {.exportc: "miqt_exec_callback_QDockWidget_initStyleOption ".} =
  ...
  let slotval1 = gen_qstyleoption_types.QStyleOptionDockWidget(h: option)
...
type QDockWidgetenterEventProc* = proc(event: gen_qevent_types.QEnterEvent): void
