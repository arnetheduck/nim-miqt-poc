...
type QSplitterinitStyleOptionProc* = proc(option: gen_qstyleoption_types.QStyleOptionFrame): void
...
type QSplitterenterEventProc* = proc(event: gen_qevent_types.QEnterEvent): void
...
type QSplitterHandleenterEventProc* = proc(event: gen_qevent_types.QEnterEvent): void
