...
type QScrollBarinitStyleOptionProc* = proc(option: gen_qstyleoption_types.QStyleOptionSlider): void
...
type QScrollBarenterEventProc* = proc(event: gen_qevent_types.QEnterEvent): void
