...
type QCommandLinkButtonmouseMoveEventProc* = proc(e: gen_qevent_types.QMouseEvent): void
...
type QCommandLinkButtonenterEventProc* = proc(event: gen_qcoreevent_types.QEvent): void
