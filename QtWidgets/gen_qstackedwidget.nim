...
type QStackedWidgetinitStyleOptionProc* = proc(option: gen_qstyleoption_types.QStyleOptionFrame): void
...
type QStackedWidgetenterEventProc* = proc(event: gen_qevent_types.QEnterEvent): void
