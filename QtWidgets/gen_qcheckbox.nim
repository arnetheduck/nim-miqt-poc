...
type QCheckBoxinitStyleOptionProc* = proc(option: gen_qstyleoption_types.QStyleOptionButton): void
...
type QCheckBoxenterEventProc* = proc(event: gen_qevent_types.QEnterEvent): void
