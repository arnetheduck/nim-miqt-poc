...
type QRadioButtoninitStyleOptionProc* = proc(button: gen_qstyleoption_types.QStyleOptionButton): void
...
type QRadioButtonenterEventProc* = proc(event: gen_qevent_types.QEnterEvent): void
