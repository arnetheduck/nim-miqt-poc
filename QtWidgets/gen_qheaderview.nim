...
type QHeaderViewinitStyleOptionForIndexProc* = proc(option: gen_qstyleoption_types.QStyleOptionHeader, logicalIndex: cint): void
...
type QHeaderViewinitStyleOptionProc* = proc(option: gen_qstyleoption_types.QStyleOptionHeader): void
...
proc QHeaderViewitemDelegateForIndex*(self: gen_qheaderview_types.QHeaderView, index: gen_qabstractitemmodel_types.QModelIndex): gen_qabstractitemdelegate_types.QAbstractItemDelegate =
  gen_qabstractitemdelegate_types.QAbstractItemDelegate(h: fQHeaderView_virtualbase_itemDelegateForIndex(self.h, index.h))

type QHeaderViewitemDelegateForIndexProc* = proc(index: gen_qabstractitemmodel_types.QModelIndex): gen_qabstractitemdelegate_types.QAbstractItemDelegate
...
type QHeaderViewinitViewItemOptionProc* = proc(option: gen_qstyleoption_types.QStyleOptionViewItem): void
...
type QHeaderViewenterEventProc* = proc(event: gen_qevent_types.QEnterEvent): void
