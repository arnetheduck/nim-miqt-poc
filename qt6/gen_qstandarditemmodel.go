...
func miqt_exec_callback_QStandardItem_multiData(self *C.QStandardItem, cb C.intptr_t, roleDataSpan *C.QModelRoleDataSpan) {
...
func (this *QStandardItemModel) Metacall(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {
	return (int)(C.QStandardItemModel_metacall(this.h, (C.int)(param1), (C.int)(param2), param3))
}
...
func miqt_exec_callback_QStandardItemModel_metaObject(self *C.QStandardItemModel, cb C.intptr_t) *C.QMetaObject {
...
func miqt_exec_callback_QStandardItemModel_metacast(self *C.QStandardItemModel, cb C.intptr_t, param1 *C.const_char) unsafe.Pointer {
...
func (this *QStandardItemModel) callVirtualBase_Metacall(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {

	return (int)(C.QStandardItemModel_virtualbase_metacall(unsafe.Pointer(this.h), (C.int)(param1), (C.int)(param2), param3))

}
func (this *QStandardItemModel) OnMetacall(slot func(super func(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int, param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int) {
	ok := C.QStandardItemModel_override_virtual_metacall(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}

//export miqt_exec_callback_QStandardItemModel_metacall
func miqt_exec_callback_QStandardItemModel_metacall(self *C.QStandardItemModel, cb C.intptr_t, param1 C.int, param2 C.int, param3 unsafe.Pointer) C.int {
	...
	virtualReturn := gofunc((&QStandardItemModel{h: self}).callVirtualBase_Metacall, slotval1, slotval2, slotval3)
...
func miqt_exec_callback_QStandardItemModel_multiData(self *C.QStandardItemModel, cb C.intptr_t, index *C.QModelIndex, roleDataSpan *C.QModelRoleDataSpan) {
...
func miqt_exec_callback_QStandardItemModel_clearItemData(self *C.QStandardItemModel, cb C.intptr_t, index *C.QModelIndex) C.bool {
...
func miqt_exec_callback_QStandardItemModel_resetInternalData(self *C.QStandardItemModel, cb C.intptr_t) {
	gofunc, ok := cgo.Handle(cb).Value().(func(super func()))
	if !ok {
		panic("miqt: callback of non-callback type (heap corruption?)")
	}
