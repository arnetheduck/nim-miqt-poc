...
proc sortByColumn*(self: QTreeView, column: cint, order: gen_qnamespace.SortOrder): void =
...
proc callVirtualBase_changeEvent(self: QTreeView, event: gen_qcoreevent.QEvent): void =


  fQTreeView_virtualbase_changeEvent(self.h, event.h)

type QTreeViewchangeEventBase* = proc(event: gen_qcoreevent.QEvent): void
proc onchangeEvent*(self: QTreeView, slot: proc(super: QTreeViewchangeEventBase, event: gen_qcoreevent.QEvent): void) =
  # TODO check subclass
  type Cb = proc(super: QTreeViewchangeEventBase, event: gen_qcoreevent.QEvent): void
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QTreeView_changeEvent(self: ptr cQTreeView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTreeView_changeEvent ".} =
  ...
  proc superCall(event: gen_qcoreevent.QEvent): auto =
    callVirtualBase_changeEvent(QTreeView(h: self), event)
...
proc miqt_exec_callback_QTreeView_sizeHintForRow(self: ptr cQTreeView, slot: int, row: cint): cint {.exportc: "miqt_exec_callback_QTreeView_sizeHintForRow ".} =
  ...
  virtualReturn
proc callVirtualBase_itemDelegateForIndex(self: QTreeView, index: gen_qabstractitemmodel.QModelIndex): gen_qabstractitemdelegate.QAbstractItemDelegate =


  gen_qabstractitemdelegate.QAbstractItemDelegate(h: fQTreeView_virtualbase_itemDelegateForIndex(self.h, index.h))

type QTreeViewitemDelegateForIndexBase* = proc(index: gen_qabstractitemmodel.QModelIndex): gen_qabstractitemdelegate.QAbstractItemDelegate
proc onitemDelegateForIndex*(self: QTreeView, slot: proc(super: QTreeViewitemDelegateForIndexBase, index: gen_qabstractitemmodel.QModelIndex): gen_qabstractitemdelegate.QAbstractItemDelegate) =
  # TODO check subclass
  type Cb = proc(super: QTreeViewitemDelegateForIndexBase, index: gen_qabstractitemmodel.QModelIndex): gen_qabstractitemdelegate.QAbstractItemDelegate
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QTreeView_itemDelegateForIndex(self: ptr cQTreeView, slot: int, index: pointer): pointer {.exportc: "miqt_exec_callback_QTreeView_itemDelegateForIndex ".} =
  ...
  var nimfunc = cast[ptr Cb](cast[pointer](slot))
  proc superCall(index: gen_qabstractitemmodel.QModelIndex): auto =
    callVirtualBase_itemDelegateForIndex(QTreeView(h: self), index)
  let slotval1 = gen_qabstractitemmodel.QModelIndex(h: index)
...
proc miqt_exec_callback_QTreeView_startDrag(self: ptr cQTreeView, slot: int, supportedActions: cint): void {.exportc: "miqt_exec_callback_QTreeView_startDrag ".} =
  ...
  nimfunc[](superCall, slotval1)
proc callVirtualBase_initViewItemOption(self: QTreeView, option: gen_qstyleoption.QStyleOptionViewItem): void =


  fQTreeView_virtualbase_initViewItemOption(self.h, option.h)

type QTreeViewinitViewItemOptionBase* = proc(option: gen_qstyleoption.QStyleOptionViewItem): void
proc oninitViewItemOption*(self: QTreeView, slot: proc(super: QTreeViewinitViewItemOptionBase, option: gen_qstyleoption.QStyleOptionViewItem): void) =
  # TODO check subclass
  type Cb = proc(super: QTreeViewinitViewItemOptionBase, option: gen_qstyleoption.QStyleOptionViewItem): void
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QTreeView_initViewItemOption(self: ptr cQTreeView, slot: int, option: pointer): void {.exportc: "miqt_exec_callback_QTreeView_initViewItemOption ".} =
  ...
  proc superCall(option: gen_qstyleoption.QStyleOptionViewItem): auto =
    callVirtualBase_initViewItemOption(QTreeView(h: self), option)
...
proc miqt_exec_callback_QTreeView_contextMenuEvent(self: ptr cQTreeView, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QTreeView_contextMenuEvent ".} =
  ...
  nimfunc[](superCall, slotval1)
proc callVirtualBase_initStyleOption(self: QTreeView, option: gen_qstyleoption.QStyleOptionFrame): void =


  fQTreeView_virtualbase_initStyleOption(self.h, option.h)

type QTreeViewinitStyleOptionBase* = proc(option: gen_qstyleoption.QStyleOptionFrame): void
proc oninitStyleOption*(self: QTreeView, slot: proc(super: QTreeViewinitStyleOptionBase, option: gen_qstyleoption.QStyleOptionFrame): void) =
  # TODO check subclass
  type Cb = proc(super: QTreeViewinitStyleOptionBase, option: gen_qstyleoption.QStyleOptionFrame): void
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QTreeView_initStyleOption(self: ptr cQTreeView, slot: int, option: pointer): void {.exportc: "miqt_exec_callback_QTreeView_initStyleOption ".} =
  ...
  proc superCall(option: gen_qstyleoption.QStyleOptionFrame): auto =
    callVirtualBase_initStyleOption(QTreeView(h: self), option)
...
proc miqt_exec_callback_QTreeView_keyReleaseEvent(self: ptr cQTreeView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTreeView_keyReleaseEvent ".} =
  ...
  nimfunc[](superCall, slotval1)
proc callVirtualBase_enterEvent(self: QTreeView, event: gen_qevent.QEnterEvent): void =


  fQTreeView_virtualbase_enterEvent(self.h, event.h)

type QTreeViewenterEventBase* = proc(event: gen_qevent.QEnterEvent): void
proc onenterEvent*(self: QTreeView, slot: proc(super: QTreeViewenterEventBase, event: gen_qevent.QEnterEvent): void) =
  # TODO check subclass
  type Cb = proc(super: QTreeViewenterEventBase, event: gen_qevent.QEnterEvent): void
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QTreeView_hideEvent(self: ptr cQTreeView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTreeView_hideEvent ".} =
  ...
  nimfunc[](superCall, slotval1)
proc callVirtualBase_nativeEvent(self: QTreeView, eventType: seq[byte], message: pointer, resultVal: ptr uint): bool =
...
type QTreeViewnativeEventBase* = proc(eventType: seq[byte], message: pointer, resultVal: ptr uint): bool
proc onnativeEvent*(self: QTreeView, slot: proc(super: QTreeViewnativeEventBase, eventType: seq[byte], message: pointer, resultVal: ptr uint): bool) =
  # TODO check subclass
  type Cb = proc(super: QTreeViewnativeEventBase, eventType: seq[byte], message: pointer, resultVal: ptr uint): bool
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
