...
proc fcQSplashScreen_new(vtbl: pointer, ): ptr cQSplashScreen {.importc: "QSplashScreen_new".}
proc fcQSplashScreen_new2(vtbl: pointer, screen: pointer): ptr cQSplashScreen {.importc: "QSplashScreen_new2".}
proc fcQSplashScreen_new3(vtbl: pointer, pixmap: pointer): ptr cQSplashScreen {.importc: "QSplashScreen_new3".}
proc fcQSplashScreen_new4(vtbl: pointer, pixmap: pointer, f: cint): ptr cQSplashScreen {.importc: "QSplashScreen_new4".}
...
proc miqt_exec_callback_cQSplashScreen_nativeEvent(vtbl: pointer, self: pointer, eventType: struct_miqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let vtbl = cast[ptr QSplashScreenVTable](vtbl)
  let self = QSplashScreen(h: self)
