...
proc miqt_exec_callback_QToolButton_actionEvent(self: ptr cQToolButton, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QToolButton_actionEvent ".} =
  ...
  nimfunc[](slotval1)
proc QToolButtonenterEvent*(self: gen_qtoolbutton_types.QToolButton, param1: gen_qevent.QEnterEvent): void =

  fQToolButton_virtualbase_enterEvent(self.h, param1.h)

type QToolButtonenterEventProc* = proc(param1: gen_qevent.QEnterEvent): void
...
proc miqt_exec_callback_QToolButton_nextCheckState(self: ptr cQToolButton, slot: int): void {.exportc: "miqt_exec_callback_QToolButton_nextCheckState ".} =
  ...
  nimfunc[]()
proc QToolButtoninitStyleOption*(self: gen_qtoolbutton_types.QToolButton, option: gen_qstyleoption.QStyleOptionToolButton): void =

  fQToolButton_virtualbase_initStyleOption(self.h, option.h)

type QToolButtoninitStyleOptionProc* = proc(option: gen_qstyleoption.QStyleOptionToolButton): void
