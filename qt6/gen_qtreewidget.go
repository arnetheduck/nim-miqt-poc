...
func (this *QTreeWidget) Metacall(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {
	return (int)(C.QTreeWidget_metacall(this.h, (C.int)(param1), (C.int)(param2), param3))
}
...
func (this *QTreeWidget) callVirtualBase_MetaObject() *QMetaObject {
	...
	return newQMetaObject(C.QTreeWidget_virtualbase_metaObject(unsafe.Pointer(this.h)))

}
func (this *QTreeWidget) OnMetaObject(slot func(super func() *QMetaObject) *QMetaObject) {
	ok := C.QTreeWidget_override_virtual_metaObject(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func miqt_exec_callback_QTreeWidget_metaObject(self *C.QTreeWidget, cb C.intptr_t) *C.QMetaObject {
...
func (this *QTreeWidget) callVirtualBase_Metacast(param1 string) unsafe.Pointer {
	...
	return (unsafe.Pointer)(C.QTreeWidget_virtualbase_metacast(unsafe.Pointer(this.h), param1_Cstring))

}
func (this *QTreeWidget) OnMetacast(slot func(super func(param1 string) unsafe.Pointer, param1 string) unsafe.Pointer) {
	ok := C.QTreeWidget_override_virtual_metacast(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func miqt_exec_callback_QTreeWidget_metacast(self *C.QTreeWidget, cb C.intptr_t, param1 *C.const_char) unsafe.Pointer {
...
func (this *QTreeWidget) callVirtualBase_Metacall(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {

	return (int)(C.QTreeWidget_virtualbase_metacall(unsafe.Pointer(this.h), (C.int)(param1), (C.int)(param2), param3))

}
func (this *QTreeWidget) OnMetacall(slot func(super func(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int, param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int) {
	ok := C.QTreeWidget_override_virtual_metacall(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}

//export miqt_exec_callback_QTreeWidget_metacall
func miqt_exec_callback_QTreeWidget_metacall(self *C.QTreeWidget, cb C.intptr_t, param1 C.int, param2 C.int, param3 unsafe.Pointer) C.int {
	...
	virtualReturn := gofunc((&QTreeWidget{h: self}).callVirtualBase_Metacall, slotval1, slotval2, slotval3)
