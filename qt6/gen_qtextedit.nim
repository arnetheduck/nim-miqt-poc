...
proc findWithExp*(self: gen_qtextedit_types.QTextEdit, exp: gen_qregularexpression.QRegularExpression): bool =
...
proc find2*(self: gen_qtextedit_types.QTextEdit, exp: string, options: cint): bool =

  fcQTextEdit_find2(self.h, struct_miqt_string(data: exp, len: csize_t(len(exp))), cint(options))

proc find22*(self: gen_qtextedit_types.QTextEdit, exp: gen_qregularexpression.QRegularExpression, options: cint): bool =
...
proc miqt_exec_callback_QTextEdit_viewportSizeHint(self: ptr cQTextEdit, slot: int): pointer {.exportc: "miqt_exec_callback_QTextEdit_viewportSizeHint ".} =
  ...
  virtualReturn.h
proc QTextEditinitStyleOption*(self: gen_qtextedit_types.QTextEdit, option: gen_qstyleoption.QStyleOptionFrame): void =

  fQTextEdit_virtualbase_initStyleOption(self.h, option.h)

type QTextEditinitStyleOptionProc* = proc(option: gen_qstyleoption.QStyleOptionFrame): void
...
proc miqt_exec_callback_QTextEdit_paintEngine(self: ptr cQTextEdit, slot: int): pointer {.exportc: "miqt_exec_callback_QTextEdit_paintEngine ".} =
  ...
  virtualReturn.h
proc QTextEditenterEvent*(self: gen_qtextedit_types.QTextEdit, event: gen_qevent.QEnterEvent): void =

  fQTextEdit_virtualbase_enterEvent(self.h, event.h)

type QTextEditenterEventProc* = proc(event: gen_qevent.QEnterEvent): void
