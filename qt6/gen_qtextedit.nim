...
proc findWithExp*(self: QTextEdit, exp: gen_qregularexpression.QRegularExpression): bool =
...
proc find2*(self: QTextEdit, exp: string, options: gen_qtextdocument.QTextDocumentFindFlag): bool =

  fcQTextEdit_find2(self.h, struct_miqt_string(data: exp, len: csize_t(len(exp))), cint(options))

proc find22*(self: QTextEdit, exp: gen_qregularexpression.QRegularExpression, options: gen_qtextdocument.QTextDocumentFindFlag): bool =
...
proc miqt_exec_callback_QTextEdit_viewportSizeHint(self: ptr cQTextEdit, slot: int): pointer {.exportc: "miqt_exec_callback_QTextEdit_viewportSizeHint ".} =
  ...
  virtualReturn.h
proc callVirtualBase_initStyleOption(self: QTextEdit, option: gen_qstyleoption.QStyleOptionFrame): void =


  fQTextEdit_virtualbase_initStyleOption(self.h, option.h)

type QTextEditinitStyleOptionBase* = proc(option: gen_qstyleoption.QStyleOptionFrame): void
proc oninitStyleOption*(self: QTextEdit, slot: proc(super: QTextEditinitStyleOptionBase, option: gen_qstyleoption.QStyleOptionFrame): void) =
  # TODO check subclass
  type Cb = proc(super: QTextEditinitStyleOptionBase, option: gen_qstyleoption.QStyleOptionFrame): void
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QTextEdit_initStyleOption(self: ptr cQTextEdit, slot: int, option: pointer): void {.exportc: "miqt_exec_callback_QTextEdit_initStyleOption ".} =
  ...
  proc superCall(option: gen_qstyleoption.QStyleOptionFrame): auto =
    callVirtualBase_initStyleOption(QTextEdit(h: self), option)
...
proc miqt_exec_callback_QTextEdit_paintEngine(self: ptr cQTextEdit, slot: int): pointer {.exportc: "miqt_exec_callback_QTextEdit_paintEngine ".} =
  ...
  virtualReturn.h
proc callVirtualBase_enterEvent(self: QTextEdit, event: gen_qevent.QEnterEvent): void =


  fQTextEdit_virtualbase_enterEvent(self.h, event.h)

type QTextEditenterEventBase* = proc(event: gen_qevent.QEnterEvent): void
proc onenterEvent*(self: QTextEdit, slot: proc(super: QTextEditenterEventBase, event: gen_qevent.QEnterEvent): void) =
  # TODO check subclass
  type Cb = proc(super: QTextEditenterEventBase, event: gen_qevent.QEnterEvent): void
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QTextEdit_hideEvent(self: ptr cQTextEdit, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTextEdit_hideEvent ".} =
  ...
  nimfunc[](superCall, slotval1)
proc callVirtualBase_nativeEvent(self: QTextEdit, eventType: seq[byte], message: pointer, resultVal: ptr uint): bool =
...
type QTextEditnativeEventBase* = proc(eventType: seq[byte], message: pointer, resultVal: ptr uint): bool
proc onnativeEvent*(self: QTextEdit, slot: proc(super: QTextEditnativeEventBase, eventType: seq[byte], message: pointer, resultVal: ptr uint): bool) =
  # TODO check subclass
  type Cb = proc(super: QTextEditnativeEventBase, eventType: seq[byte], message: pointer, resultVal: ptr uint): bool
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
