...
func (this *QToolBar) Metacall(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {
	return (int)(C.QToolBar_metacall(this.h, (C.int)(param1), (C.int)(param2), param3))
}
...
func (this *QToolBar) callVirtualBase_MetaObject() *QMetaObject {
	...
	return newQMetaObject(C.QToolBar_virtualbase_metaObject(unsafe.Pointer(this.h)))

}
func (this *QToolBar) OnMetaObject(slot func(super func() *QMetaObject) *QMetaObject) {
	ok := C.QToolBar_override_virtual_metaObject(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
...
func miqt_exec_callback_QToolBar_metaObject(self *C.QToolBar, cb C.intptr_t) *C.QMetaObject {
...
func (this *QToolBar) callVirtualBase_Metacast(param1 string) unsafe.Pointer {
	...
	return (unsafe.Pointer)(C.QToolBar_virtualbase_metacast(unsafe.Pointer(this.h), param1_Cstring))

}
func (this *QToolBar) OnMetacast(slot func(super func(param1 string) unsafe.Pointer, param1 string) unsafe.Pointer) {
	ok := C.QToolBar_override_virtual_metacast(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func miqt_exec_callback_QToolBar_metacast(self *C.QToolBar, cb C.intptr_t, param1 *C.const_char) unsafe.Pointer {
...
func (this *QToolBar) callVirtualBase_Metacall(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {

	return (int)(C.QToolBar_virtualbase_metacall(unsafe.Pointer(this.h), (C.int)(param1), (C.int)(param2), param3))

}
func (this *QToolBar) OnMetacall(slot func(super func(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int, param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int) {
	ok := C.QToolBar_override_virtual_metacall(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}

//export miqt_exec_callback_QToolBar_metacall
func miqt_exec_callback_QToolBar_metacall(self *C.QToolBar, cb C.intptr_t, param1 C.int, param2 C.int, param3 unsafe.Pointer) C.int {
	...
	virtualReturn := gofunc((&QToolBar{h: self}).callVirtualBase_Metacall, slotval1, slotval2, slotval3)
...
func (this *QToolBar) callVirtualBase_InitStyleOption(option *QStyleOptionToolBar) {
	...
	C.QToolBar_virtualbase_initStyleOption(unsafe.Pointer(this.h), option.cPointer())

}
func (this *QToolBar) OnInitStyleOption(slot func(super func(option *QStyleOptionToolBar), option *QStyleOptionToolBar)) {
	ok := C.QToolBar_override_virtual_initStyleOption(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func miqt_exec_callback_QToolBar_initStyleOption(self *C.QToolBar, cb C.intptr_t, option *C.QStyleOptionToolBar) {
...
func miqt_exec_callback_QToolBar_enterEvent(self *C.QToolBar, cb C.intptr_t, event *C.QEnterEvent) {
...
func (this *QToolBar) callVirtualBase_NativeEvent(eventType []byte, message unsafe.Pointer, result *uintptr) bool {
	...
	return (bool)(C.QToolBar_virtualbase_nativeEvent(unsafe.Pointer(this.h), eventType_alias, message, (*C.intptr_t)(unsafe.Pointer(result))))
...
func miqt_exec_callback_QToolBar_nativeEvent(self *C.QToolBar, cb C.intptr_t, eventType C.struct_miqt_string, message unsafe.Pointer, result *C.intptr_t) C.bool {
