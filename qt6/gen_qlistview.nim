...
proc callVirtualBase_metaObject(self: QListView, ): gen_qobjectdefs.QMetaObject =


  gen_qobjectdefs.QMetaObject(h: fQListView_virtualbase_metaObject(self.h))

type QListViewmetaObjectBase* = proc(): gen_qobjectdefs.QMetaObject
proc onmetaObject*(self: QListView, slot: proc(super: QListViewmetaObjectBase): gen_qobjectdefs.QMetaObject) =
  # TODO check subclass
  type Cb = proc(super: QListViewmetaObjectBase): gen_qobjectdefs.QMetaObject
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QListView_metaObject(self: ptr cQListView, slot: int): pointer {.exportc: "miqt_exec_callback_QListView_metaObject ".} =
  ...
  proc superCall(): auto =
    callVirtualBase_metaObject(QListView(h: self), )

  let virtualReturn = nimfunc[](superCall )

  virtualReturn.h
proc callVirtualBase_metacast(self: QListView, param1: cstring): pointer =


  fQListView_virtualbase_metacast(self.h, param1)

type QListViewmetacastBase* = proc(param1: cstring): pointer
proc onmetacast*(self: QListView, slot: proc(super: QListViewmetacastBase, param1: cstring): pointer) =
  # TODO check subclass
  type Cb = proc(super: QListViewmetacastBase, param1: cstring): pointer
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QListView_metacast(self: ptr cQListView, slot: int, param1: cstring): pointer {.exportc: "miqt_exec_callback_QListView_metacast ".} =
  ...
  proc superCall(param1: cstring): auto =
    callVirtualBase_metacast(QListView(h: self), param1)
  let slotval1 = (param1)
...
proc miqt_exec_callback_QListView_startDrag(self: ptr cQListView, slot: int, supportedActions: cint): void {.exportc: "miqt_exec_callback_QListView_startDrag ".} =
  ...
  nimfunc[](superCall, slotval1)
proc callVirtualBase_initViewItemOption(self: QListView, option: gen_qstyleoption.QStyleOptionViewItem): void =


  fQListView_virtualbase_initViewItemOption(self.h, option.h)

type QListViewinitViewItemOptionBase* = proc(option: gen_qstyleoption.QStyleOptionViewItem): void
proc oninitViewItemOption*(self: QListView, slot: proc(super: QListViewinitViewItemOptionBase, option: gen_qstyleoption.QStyleOptionViewItem): void) =
  # TODO check subclass
  type Cb = proc(super: QListViewinitViewItemOptionBase, option: gen_qstyleoption.QStyleOptionViewItem): void
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QListView_initViewItemOption(self: ptr cQListView, slot: int, option: pointer): void {.exportc: "miqt_exec_callback_QListView_initViewItemOption ".} =
  ...
  proc superCall(option: gen_qstyleoption.QStyleOptionViewItem): auto =
    callVirtualBase_initViewItemOption(QListView(h: self), option)
...
proc miqt_exec_callback_QListView_sizeHintForColumn(self: ptr cQListView, slot: int, column: cint): cint {.exportc: "miqt_exec_callback_QListView_sizeHintForColumn ".} =
  ...
  virtualReturn
proc callVirtualBase_itemDelegateForIndex(self: QListView, index: gen_qabstractitemmodel.QModelIndex): gen_qabstractitemdelegate.QAbstractItemDelegate =


  gen_qabstractitemdelegate.QAbstractItemDelegate(h: fQListView_virtualbase_itemDelegateForIndex(self.h, index.h))

type QListViewitemDelegateForIndexBase* = proc(index: gen_qabstractitemmodel.QModelIndex): gen_qabstractitemdelegate.QAbstractItemDelegate
proc onitemDelegateForIndex*(self: QListView, slot: proc(super: QListViewitemDelegateForIndexBase, index: gen_qabstractitemmodel.QModelIndex): gen_qabstractitemdelegate.QAbstractItemDelegate) =
  # TODO check subclass
  type Cb = proc(super: QListViewitemDelegateForIndexBase, index: gen_qabstractitemmodel.QModelIndex): gen_qabstractitemdelegate.QAbstractItemDelegate
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QListView_itemDelegateForIndex(self: ptr cQListView, slot: int, index: pointer): pointer {.exportc: "miqt_exec_callback_QListView_itemDelegateForIndex ".} =
  ...
  var nimfunc = cast[ptr Cb](cast[pointer](slot))
  proc superCall(index: gen_qabstractitemmodel.QModelIndex): auto =
    callVirtualBase_itemDelegateForIndex(QListView(h: self), index)
  let slotval1 = gen_qabstractitemmodel.QModelIndex(h: index)
...
proc miqt_exec_callback_QListView_changeEvent(self: ptr cQListView, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QListView_changeEvent ".} =
  ...
  nimfunc[](superCall, slotval1)
proc callVirtualBase_initStyleOption(self: QListView, option: gen_qstyleoption.QStyleOptionFrame): void =


  fQListView_virtualbase_initStyleOption(self.h, option.h)

type QListViewinitStyleOptionBase* = proc(option: gen_qstyleoption.QStyleOptionFrame): void
proc oninitStyleOption*(self: QListView, slot: proc(super: QListViewinitStyleOptionBase, option: gen_qstyleoption.QStyleOptionFrame): void) =
  # TODO check subclass
  type Cb = proc(super: QListViewinitStyleOptionBase, option: gen_qstyleoption.QStyleOptionFrame): void
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QListView_initStyleOption(self: ptr cQListView, slot: int, option: pointer): void {.exportc: "miqt_exec_callback_QListView_initStyleOption ".} =
  ...
  proc superCall(option: gen_qstyleoption.QStyleOptionFrame): auto =
    callVirtualBase_initStyleOption(QListView(h: self), option)
...
proc miqt_exec_callback_QListView_keyReleaseEvent(self: ptr cQListView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QListView_keyReleaseEvent ".} =
  ...
  nimfunc[](superCall, slotval1)
proc callVirtualBase_enterEvent(self: QListView, event: gen_qevent.QEnterEvent): void =


  fQListView_virtualbase_enterEvent(self.h, event.h)

type QListViewenterEventBase* = proc(event: gen_qevent.QEnterEvent): void
proc onenterEvent*(self: QListView, slot: proc(super: QListViewenterEventBase, event: gen_qevent.QEnterEvent): void) =
  # TODO check subclass
  type Cb = proc(super: QListViewenterEventBase, event: gen_qevent.QEnterEvent): void
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QListView_hideEvent(self: ptr cQListView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QListView_hideEvent ".} =
  ...
  nimfunc[](superCall, slotval1)
proc callVirtualBase_nativeEvent(self: QListView, eventType: seq[byte], message: pointer, resultVal: ptr uint): bool =
...
type QListViewnativeEventBase* = proc(eventType: seq[byte], message: pointer, resultVal: ptr uint): bool
proc onnativeEvent*(self: QListView, slot: proc(super: QListViewnativeEventBase, eventType: seq[byte], message: pointer, resultVal: ptr uint): bool) =
  # TODO check subclass
  type Cb = proc(super: QListViewnativeEventBase, eventType: seq[byte], message: pointer, resultVal: ptr uint): bool
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
