...
const
  ...
  QMetaObjectCreateInstance* = 4
  QMetaObjectIndexOfMethod* = 5
  QMetaObjectRegisterPropertyMetaType* = 6
  QMetaObjectRegisterMethodArgumentMetaType* = 7
  QMetaObjectBindableProperty* = 8
  QMetaObjectCustomCall* = 9
...
func init*(T: type QMethodRawArguments, h: ptr cQMethodRawArguments): QMethodRawArguments =
  T(h: h)
proc delete*(self: QMethodRawArguments) =
...
proc metaType*(self: QMetaObject, ): gen_qmetatype.QMetaType =
...
proc swap*(self: QMetaObjectConnection, other: QMetaObjectConnection): void =
...
func init*(T: type QMetaObjectData, h: ptr cQMetaObjectData): QMetaObjectData =
  T(h: h)
proc create*(T: type QMetaObjectData, ): QMetaObjectData =

  QMetaObjectData.init(fcQMetaObjectData_new())
proc create*(T: type QMetaObjectData, param1: QMetaObjectData): QMetaObjectData =

  QMetaObjectData.init(fcQMetaObjectData_new2(param1.h))
proc operatorAssign*(self: QMetaObjectData, param1: QMetaObjectData): void =

  fcQMetaObjectData_operatorAssign(self.h, param1.h)

proc delete*(self: QMetaObjectData) =
