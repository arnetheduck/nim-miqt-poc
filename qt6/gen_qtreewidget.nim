...
proc indexFromItem*(self: gen_qtreewidget_types.QTreeWidget, item: gen_qtreewidget_types.QTreeWidgetItem, column: cint): gen_qabstractitemmodel.QModelIndex =
...
proc miqt_exec_callback_QTreeWidget_editorDestroyed(self: ptr cQTreeWidget, slot: int, editor: pointer): void {.exportc: "miqt_exec_callback_QTreeWidget_editorDestroyed ".} =
  ...
  nimfunc[](slotval1)
proc QTreeWidgetedit*(self: gen_qtreewidget_types.QTreeWidget, index: gen_qabstractitemmodel.QModelIndex, trigger: cint, event: gen_qcoreevent.QEvent): bool =
