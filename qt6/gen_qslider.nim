...
proc miqt_exec_callback_QSlider_mouseMoveEvent(self: ptr cQSlider, slot: int, ev: pointer): void {.exportc: "miqt_exec_callback_QSlider_mouseMoveEvent ".} =
  ...
  nimfunc[](superCall, slotval1)
proc callVirtualBase_initStyleOption(self: QSlider, option: gen_qstyleoption.QStyleOptionSlider): void =


  fQSlider_virtualbase_initStyleOption(self.h, option.h)

type QSliderinitStyleOptionBase* = proc(option: gen_qstyleoption.QStyleOptionSlider): void
proc oninitStyleOption*(self: QSlider, slot: proc(super: QSliderinitStyleOptionBase, option: gen_qstyleoption.QStyleOptionSlider): void) =
  # TODO check subclass
  type Cb = proc(super: QSliderinitStyleOptionBase, option: gen_qstyleoption.QStyleOptionSlider): void
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QSlider_initStyleOption(self: ptr cQSlider, slot: int, option: pointer): void {.exportc: "miqt_exec_callback_QSlider_initStyleOption ".} =
  ...
  proc superCall(option: gen_qstyleoption.QStyleOptionSlider): auto =
    callVirtualBase_initStyleOption(QSlider(h: self), option)
...
proc miqt_exec_callback_QSlider_focusOutEvent(self: ptr cQSlider, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QSlider_focusOutEvent ".} =
  ...
  nimfunc[](superCall, slotval1)
proc callVirtualBase_enterEvent(self: QSlider, event: gen_qevent.QEnterEvent): void =


  fQSlider_virtualbase_enterEvent(self.h, event.h)

type QSliderenterEventBase* = proc(event: gen_qevent.QEnterEvent): void
proc onenterEvent*(self: QSlider, slot: proc(super: QSliderenterEventBase, event: gen_qevent.QEnterEvent): void) =
  # TODO check subclass
  type Cb = proc(super: QSliderenterEventBase, event: gen_qevent.QEnterEvent): void
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QSlider_hideEvent(self: ptr cQSlider, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QSlider_hideEvent ".} =
  ...
  nimfunc[](superCall, slotval1)
proc callVirtualBase_nativeEvent(self: QSlider, eventType: seq[byte], message: pointer, resultVal: ptr uint): bool =
...
type QSlidernativeEventBase* = proc(eventType: seq[byte], message: pointer, resultVal: ptr uint): bool
proc onnativeEvent*(self: QSlider, slot: proc(super: QSlidernativeEventBase, eventType: seq[byte], message: pointer, resultVal: ptr uint): bool) =
  # TODO check subclass
  type Cb = proc(super: QSlidernativeEventBase, eventType: seq[byte], message: pointer, resultVal: ptr uint): bool
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
