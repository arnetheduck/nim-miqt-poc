...
proc fcQTextList_protectedbase_setFormat(self: pointer, format: pointer): void {.importc: "QTextList_protectedbase_setFormat".}
...
proc setFormat*(self: gen_qtextlist_types.QTextList, format: gen_qtextformat_types.QTextFormat): void =
  fcQTextList_protectedbase_setFormat(self.h, format.h)
