...
func (this *QWindow) Metacall(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {
	return (int)(C.QWindow_metacall(this.h, (C.int)(param1), (C.int)(param2), param3))
}
...
func (this *QWindow) Parent() *QWindow {
	return newQWindow(C.QWindow_parent(this.h))
}
...
func (this *QWindow) MapToGlobal(pos *QPointF) *QPointF {
	_goptr := newQPointF(C.QWindow_mapToGlobal(this.h, pos.cPointer()))
	_goptr.GoGC() // Qt uses pass-by-value semantics for this type. Mimic with finalizer
	return _goptr
}

func (this *QWindow) MapFromGlobal(pos *QPointF) *QPointF {
	_goptr := newQPointF(C.QWindow_mapFromGlobal(this.h, pos.cPointer()))
	_goptr.GoGC() // Qt uses pass-by-value semantics for this type. Mimic with finalizer
	return _goptr
}

func (this *QWindow) MapToGlobalWithPos(pos *QPoint) *QPoint {
	_goptr := newQPoint(C.QWindow_mapToGlobalWithPos(this.h, pos.cPointer()))
	_goptr.GoGC() // Qt uses pass-by-value semantics for this type. Mimic with finalizer
	return _goptr
}

func (this *QWindow) MapFromGlobalWithPos(pos *QPoint) *QPoint {
	_goptr := newQPoint(C.QWindow_mapFromGlobalWithPos(this.h, pos.cPointer()))
	_goptr.GoGC() // Qt uses pass-by-value semantics for this type. Mimic with finalizer
	return _goptr
}
...
func (this *QWindow) callVirtualBase_MetaObject() *QMetaObject {
	...
	return newQMetaObject(C.QWindow_virtualbase_metaObject(unsafe.Pointer(this.h)))

}
func (this *QWindow) OnMetaObject(slot func(super func() *QMetaObject) *QMetaObject) {
	ok := C.QWindow_override_virtual_metaObject(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
...
func miqt_exec_callback_QWindow_metaObject(self *C.QWindow, cb C.intptr_t) *C.QMetaObject {
...
func (this *QWindow) callVirtualBase_Metacast(param1 string) unsafe.Pointer {
	...
	return (unsafe.Pointer)(C.QWindow_virtualbase_metacast(unsafe.Pointer(this.h), param1_Cstring))

}
func (this *QWindow) OnMetacast(slot func(super func(param1 string) unsafe.Pointer, param1 string) unsafe.Pointer) {
	ok := C.QWindow_override_virtual_metacast(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func miqt_exec_callback_QWindow_metacast(self *C.QWindow, cb C.intptr_t, param1 *C.const_char) unsafe.Pointer {
...
func (this *QWindow) callVirtualBase_Metacall(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {

	return (int)(C.QWindow_virtualbase_metacall(unsafe.Pointer(this.h), (C.int)(param1), (C.int)(param2), param3))

}
func (this *QWindow) OnMetacall(slot func(super func(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int, param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int) {
	ok := C.QWindow_override_virtual_metacall(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}

//export miqt_exec_callback_QWindow_metacall
func miqt_exec_callback_QWindow_metacall(self *C.QWindow, cb C.intptr_t, param1 C.int, param2 C.int, param3 unsafe.Pointer) C.int {
	...
	virtualReturn := gofunc((&QWindow{h: self}).callVirtualBase_Metacall, slotval1, slotval2, slotval3)
...
func (this *QWindow) callVirtualBase_PaintEvent(param1 *QPaintEvent) {
	...
	C.QWindow_virtualbase_paintEvent(unsafe.Pointer(this.h), param1.cPointer())

}
func (this *QWindow) OnPaintEvent(slot func(super func(param1 *QPaintEvent), param1 *QPaintEvent)) {
	ok := C.QWindow_override_virtual_paintEvent(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func miqt_exec_callback_QWindow_paintEvent(self *C.QWindow, cb C.intptr_t, param1 *C.QPaintEvent) {
...
func (this *QWindow) callVirtualBase_CloseEvent(param1 *QCloseEvent) {
	...
	C.QWindow_virtualbase_closeEvent(unsafe.Pointer(this.h), param1.cPointer())

}
func (this *QWindow) OnCloseEvent(slot func(super func(param1 *QCloseEvent), param1 *QCloseEvent)) {
	ok := C.QWindow_override_virtual_closeEvent(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func miqt_exec_callback_QWindow_closeEvent(self *C.QWindow, cb C.intptr_t, param1 *C.QCloseEvent) {
