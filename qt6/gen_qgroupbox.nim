...
proc fcQGroupBox_virtualbase_initStyleOption(self: pointer, option: pointer): void {.importc: "QGroupBox_virtualbase_initStyleOption".}
...
proc fcQGroupBox_virtualbase_nativeEvent(self: pointer, eventType: struct_miqt_string, message: pointer, resultVal: ptr uint): bool {.importc: "QGroupBox_virtualbase_nativeEvent".}
...
proc miqt_exec_callback_cQGroupBox_clicked(slot: int) {.exportc: "miqt_exec_callback_QGroupBox_clicked".} =
...
proc miqt_exec_callback_cQGroupBox_toggled(slot: int, param1: bool) {.exportc: "miqt_exec_callback_QGroupBox_toggled".} =
...
proc miqt_exec_callback_cQGroupBox_clicked1(slot: int, checked: bool) {.exportc: "miqt_exec_callback_QGroupBox_clicked1".} =
...
type QGroupBoxinitStyleOptionProc* = proc(self: QGroupBox, option: gen_qstyleoption_types.QStyleOptionGroupBox): void {.raises: [], gcsafe.}
...
type QGroupBoxenterEventProc* = proc(self: QGroupBox, event: gen_qevent_types.QEnterEvent): void {.raises: [], gcsafe.}
...
type QGroupBoxVTable* = object
  ...
  initStyleOption*: QGroupBoxinitStyleOptionProc
...
proc QGroupBoxinitStyleOption*(self: gen_qgroupbox_types.QGroupBox, option: gen_qstyleoption_types.QStyleOptionGroupBox): void =
  fcQGroupBox_virtualbase_initStyleOption(self.h, option.h)

proc miqt_exec_callback_cQGroupBox_initStyleOption(vtbl: pointer, self: pointer, option: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QGroupBoxVTable](vtbl)
  let self = QGroupBox(h: self)
...
proc miqt_exec_callback_cQGroupBox_nativeEvent(vtbl: pointer, self: pointer, eventType: struct_miqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let vtbl = cast[ptr QGroupBoxVTable](vtbl)
  let self = QGroupBox(h: self)
...
proc create*(T: type gen_qgroupbox_types.QGroupBox,
  ...
  if not isNil(vtbl.initStyleOption):
    vtbl[].vtbl.initStyleOption = miqt_exec_callback_cQGroupBox_initStyleOption
