...
public:
	...
	// Wrapper to allow calling protected method
	QModelIndex* protectedbase_createIndex3(int row, int column, const void* data) const {
...
void QAbstractItemModel_connect_dataChanged(QAbstractItemModel* self, intptr_t slot) {
	...
	MiqtVirtualQAbstractItemModel::connect(self, static_cast<void (QAbstractItemModel::*)(const QModelIndex&, const QModelIndex&, const QList<int>&)>(&QAbstractItemModel::dataChanged), self, caller{slot});
}
