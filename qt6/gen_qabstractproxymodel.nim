...
proc clearItemData*(self: QAbstractProxyModel, index: gen_qabstractitemmodel.QModelIndex): bool =
...
proc roleNames*(self: QAbstractProxyModel, ): Table[cint,seq[byte]] =
...
proc callVirtualBase_metaObject(self: QAbstractProxyModel, ): gen_qobjectdefs.QMetaObject =


  gen_qobjectdefs.QMetaObject(h: fQAbstractProxyModel_virtualbase_metaObject(self.h))

type QAbstractProxyModelmetaObjectBase* = proc(): gen_qobjectdefs.QMetaObject
proc onmetaObject*(self: QAbstractProxyModel, slot: proc(super: QAbstractProxyModelmetaObjectBase): gen_qobjectdefs.QMetaObject) =
  # TODO check subclass
  type Cb = proc(super: QAbstractProxyModelmetaObjectBase): gen_qobjectdefs.QMetaObject
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QAbstractProxyModel_metaObject(self: ptr cQAbstractProxyModel, slot: int): pointer {.exportc: "miqt_exec_callback_QAbstractProxyModel_metaObject ".} =
  ...
  proc superCall(): auto =
    callVirtualBase_metaObject(QAbstractProxyModel(h: self), )

  let virtualReturn = nimfunc[](superCall )

  virtualReturn.h
proc callVirtualBase_metacast(self: QAbstractProxyModel, param1: cstring): pointer =


  fQAbstractProxyModel_virtualbase_metacast(self.h, param1)

type QAbstractProxyModelmetacastBase* = proc(param1: cstring): pointer
proc onmetacast*(self: QAbstractProxyModel, slot: proc(super: QAbstractProxyModelmetacastBase, param1: cstring): pointer) =
  # TODO check subclass
  type Cb = proc(super: QAbstractProxyModelmetacastBase, param1: cstring): pointer
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QAbstractProxyModel_metacast(self: ptr cQAbstractProxyModel, slot: int, param1: cstring): pointer {.exportc: "miqt_exec_callback_QAbstractProxyModel_metacast ".} =
  ...
  proc superCall(param1: cstring): auto =
    callVirtualBase_metacast(QAbstractProxyModel(h: self), param1)
  let slotval1 = (param1)
...
proc miqt_exec_callback_QAbstractProxyModel_setHeaderData(self: ptr cQAbstractProxyModel, slot: int, section: cint, orientation: cint, value: pointer, role: cint): bool {.exportc: "miqt_exec_callback_QAbstractProxyModel_setHeaderData ".} =
  ...
  virtualReturn
proc callVirtualBase_clearItemData(self: QAbstractProxyModel, index: gen_qabstractitemmodel.QModelIndex): bool =


  fQAbstractProxyModel_virtualbase_clearItemData(self.h, index.h)

type QAbstractProxyModelclearItemDataBase* = proc(index: gen_qabstractitemmodel.QModelIndex): bool
proc onclearItemData*(self: QAbstractProxyModel, slot: proc(super: QAbstractProxyModelclearItemDataBase, index: gen_qabstractitemmodel.QModelIndex): bool) =
  # TODO check subclass
  type Cb = proc(super: QAbstractProxyModelclearItemDataBase, index: gen_qabstractitemmodel.QModelIndex): bool
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QAbstractProxyModel_clearItemData(self: ptr cQAbstractProxyModel, slot: int, index: pointer): bool {.exportc: "miqt_exec_callback_QAbstractProxyModel_clearItemData ".} =
  ...
  var nimfunc = cast[ptr Cb](cast[pointer](slot))
  proc superCall(index: gen_qabstractitemmodel.QModelIndex): auto =
    callVirtualBase_clearItemData(QAbstractProxyModel(h: self), index)
  let slotval1 = gen_qabstractitemmodel.QModelIndex(h: index)
...
proc miqt_exec_callback_QAbstractProxyModel_match(self: ptr cQAbstractProxyModel, slot: int, start: pointer, role: cint, value: pointer, hits: cint, flags: cint): struct_miqt_array {.exportc: "miqt_exec_callback_QAbstractProxyModel_match ".} =
  ...
  struct_miqt_array(len: csize_t(len(virtualReturn)), data: if len(virtualReturn) == 0: nil else: addr(virtualReturn_CArray[0]))
proc callVirtualBase_multiData(self: QAbstractProxyModel, index: gen_qabstractitemmodel.QModelIndex, roleDataSpan: gen_qabstractitemmodel.QModelRoleDataSpan): void =


  fQAbstractProxyModel_virtualbase_multiData(self.h, index.h, roleDataSpan.h)

type QAbstractProxyModelmultiDataBase* = proc(index: gen_qabstractitemmodel.QModelIndex, roleDataSpan: gen_qabstractitemmodel.QModelRoleDataSpan): void
proc onmultiData*(self: QAbstractProxyModel, slot: proc(super: QAbstractProxyModelmultiDataBase, index: gen_qabstractitemmodel.QModelIndex, roleDataSpan: gen_qabstractitemmodel.QModelRoleDataSpan): void) =
  # TODO check subclass
  type Cb = proc(super: QAbstractProxyModelmultiDataBase, index: gen_qabstractitemmodel.QModelIndex, roleDataSpan: gen_qabstractitemmodel.QModelRoleDataSpan): void
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QAbstractProxyModel_multiData(self: ptr cQAbstractProxyModel, slot: int, index: pointer, roleDataSpan: pointer): void {.exportc: "miqt_exec_callback_QAbstractProxyModel_multiData ".} =
  ...
  proc superCall(index: gen_qabstractitemmodel.QModelIndex, roleDataSpan: gen_qabstractitemmodel.QModelRoleDataSpan): auto =
    callVirtualBase_multiData(QAbstractProxyModel(h: self), index, roleDataSpan)
  let slotval1 = gen_qabstractitemmodel.QModelIndex(h: index)
  ...
  nimfunc[](superCall, slotval1, slotval2)
proc callVirtualBase_resetInternalData(self: QAbstractProxyModel, ): void =


  fQAbstractProxyModel_virtualbase_resetInternalData(self.h)

type QAbstractProxyModelresetInternalDataBase* = proc(): void
proc onresetInternalData*(self: QAbstractProxyModel, slot: proc(super: QAbstractProxyModelresetInternalDataBase): void) =
  # TODO check subclass
  type Cb = proc(super: QAbstractProxyModelresetInternalDataBase): void
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QAbstractProxyModel_resetInternalData(self: ptr cQAbstractProxyModel, slot: int): void {.exportc: "miqt_exec_callback_QAbstractProxyModel_resetInternalData ".} =
  ...
  var nimfunc = cast[ptr Cb](cast[pointer](slot))
  proc superCall(): auto =
    callVirtualBase_resetInternalData(QAbstractProxyModel(h: self), )
