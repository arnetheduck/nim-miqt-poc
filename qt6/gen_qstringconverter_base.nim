...
proc create*(T: type gen_qstringconverter_base_types.QStringConverterBase,
  ...
  gen_qstringconverter_base_types.QStringConverterBase(h: fcQStringConverterBase_new(param1.h))
...
proc create*(T: type gen_qstringconverter_base_types.QStringConverterBase): gen_qstringconverter_base_types.QStringConverterBase =
  gen_qstringconverter_base_types.QStringConverterBase(h: fcQStringConverterBase_new2())
