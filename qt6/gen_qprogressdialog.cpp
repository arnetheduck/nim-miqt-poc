...
void miqt_exec_callback_QProgressDialog_canceled_release(intptr_t);
#ifdef __cplusplus
} /* extern C */
#endif
...
public:
	...
	MiqtVirtualQProgressDialog(struct QProgressDialog_VTable* vtbl, QWidget* parent): QProgressDialog(parent), vtbl(vtbl) {};
	MiqtVirtualQProgressDialog(struct QProgressDialog_VTable* vtbl): QProgressDialog(), vtbl(vtbl) {};
	MiqtVirtualQProgressDialog(struct QProgressDialog_VTable* vtbl, const QString& labelText, const QString& cancelButtonText, int minimum, int maximum): QProgressDialog(labelText, cancelButtonText, minimum, maximum), vtbl(vtbl) {};
	MiqtVirtualQProgressDialog(struct QProgressDialog_VTable* vtbl, QWidget* parent, Qt::WindowFlags flags): QProgressDialog(parent, flags), vtbl(vtbl) {};
	MiqtVirtualQProgressDialog(struct QProgressDialog_VTable* vtbl, const QString& labelText, const QString& cancelButtonText, int minimum, int maximum, QWidget* parent): QProgressDialog(labelText, cancelButtonText, minimum, maximum, parent), vtbl(vtbl) {};
	MiqtVirtualQProgressDialog(struct QProgressDialog_VTable* vtbl, const QString& labelText, const QString& cancelButtonText, int minimum, int maximum, QWidget* parent, Qt::WindowFlags flags): QProgressDialog(labelText, cancelButtonText, minimum, maximum, parent, flags), vtbl(vtbl) {};

	virtual ~MiqtVirtualQProgressDialog() override { if(vtbl->destructor) vtbl->destructor(vtbl, this); }
	...
	int virtualbase_metacall(int param1, int param2, void** param3) {
		...
		return QProgressDialog::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
QProgressDialog* QProgressDialog_new(struct QProgressDialog_VTable* vtbl, QWidget* parent) {
	return new MiqtVirtualQProgressDialog(vtbl, parent);
}

QProgressDialog* QProgressDialog_new2(struct QProgressDialog_VTable* vtbl) {
	return new MiqtVirtualQProgressDialog(vtbl);
}
...
QProgressDialog* QProgressDialog_new3(struct QProgressDialog_VTable* vtbl, struct miqt_string labelText, struct miqt_string cancelButtonText, int minimum, int maximum) {
	...
	return new MiqtVirtualQProgressDialog(vtbl, labelText_QString, cancelButtonText_QString, static_cast<int>(minimum), static_cast<int>(maximum));
}

QProgressDialog* QProgressDialog_new4(struct QProgressDialog_VTable* vtbl, QWidget* parent, int flags) {
	return new MiqtVirtualQProgressDialog(vtbl, parent, static_cast<Qt::WindowFlags>(flags));
}
...
QProgressDialog* QProgressDialog_new5(struct QProgressDialog_VTable* vtbl, struct miqt_string labelText, struct miqt_string cancelButtonText, int minimum, int maximum, QWidget* parent) {
	QString labelText_QString = QString::fromUtf8(labelText.data, labelText.len);
	QString cancelButtonText_QString = QString::fromUtf8(cancelButtonText.data, cancelButtonText.len);
	return new MiqtVirtualQProgressDialog(vtbl, labelText_QString, cancelButtonText_QString, static_cast<int>(minimum), static_cast<int>(maximum), parent);
}
...
QProgressDialog* QProgressDialog_new6(struct QProgressDialog_VTable* vtbl, struct miqt_string labelText, struct miqt_string cancelButtonText, int minimum, int maximum, QWidget* parent, int flags) {
	QString labelText_QString = QString::fromUtf8(labelText.data, labelText.len);
	QString cancelButtonText_QString = QString::fromUtf8(cancelButtonText.data, cancelButtonText.len);
	return new MiqtVirtualQProgressDialog(vtbl, labelText_QString, cancelButtonText_QString, static_cast<int>(minimum), static_cast<int>(maximum), parent, static_cast<Qt::WindowFlags>(flags));
}
...
void QProgressDialog_connect_canceled(QProgressDialog* self, intptr_t slot) {
	struct caller {
		...
		~caller() { miqt_exec_callback_QProgressDialog_canceled_release(slot); }
	};
	MiqtVirtualQProgressDialog::connect(self, static_cast<void (QProgressDialog::*)()>(&QProgressDialog::canceled), self, caller{slot});
}
...
int QProgressDialog_virtualbase_metacall(void* self, int param1, int param2, void** param3) {
	return ( (MiqtVirtualQProgressDialog*)(self) )->virtualbase_metacall(param1, param2, param3);
}
...
void QProgressDialog_protectedbase_forceShow(void* self) {
	( (MiqtVirtualQProgressDialog*)(self) )->protectedbase_forceShow();
}

void QProgressDialog_protectedbase_adjustPosition(void* self, QWidget* param1) {
	( (MiqtVirtualQProgressDialog*)(self) )->protectedbase_adjustPosition(param1);
}

void QProgressDialog_protectedbase_updateMicroFocus(void* self) {
	( (MiqtVirtualQProgressDialog*)(self) )->protectedbase_updateMicroFocus();
}

void QProgressDialog_protectedbase_create(void* self) {
	( (MiqtVirtualQProgressDialog*)(self) )->protectedbase_create();
}

void QProgressDialog_protectedbase_destroy(void* self) {
	( (MiqtVirtualQProgressDialog*)(self) )->protectedbase_destroy();
}

bool QProgressDialog_protectedbase_focusNextChild(void* self) {
	return ( (MiqtVirtualQProgressDialog*)(self) )->protectedbase_focusNextChild();
}

bool QProgressDialog_protectedbase_focusPreviousChild(void* self) {
	return ( (MiqtVirtualQProgressDialog*)(self) )->protectedbase_focusPreviousChild();
}

QObject* QProgressDialog_protectedbase_sender(const void* self) {
	return ( (const MiqtVirtualQProgressDialog*)(self) )->protectedbase_sender();
}

int QProgressDialog_protectedbase_senderSignalIndex(const void* self) {
	return ( (const MiqtVirtualQProgressDialog*)(self) )->protectedbase_senderSignalIndex();
}

int QProgressDialog_protectedbase_receivers(const void* self, const char* signal) {
	return ( (const MiqtVirtualQProgressDialog*)(self) )->protectedbase_receivers(signal);
}

bool QProgressDialog_protectedbase_isSignalConnected(const void* self, QMetaMethod* signal) {
	return ( (const MiqtVirtualQProgressDialog*)(self) )->protectedbase_isSignalConnected(signal);
}
