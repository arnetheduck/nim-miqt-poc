...
proc callVirtualBase_setAccepted(self: QGestureEvent, accepted: bool): void =


  fQGestureEvent_virtualbase_setAccepted(self.h, accepted)

type QGestureEventsetAcceptedBase* = proc(accepted: bool): void
proc onsetAccepted*(self: QGestureEvent, slot: proc(super: QGestureEventsetAcceptedBase, accepted: bool): void) =
  # TODO check subclass
  type Cb = proc(super: QGestureEventsetAcceptedBase, accepted: bool): void
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QGestureEvent_setAccepted(self: ptr cQGestureEvent, slot: int, accepted: bool): void {.exportc: "miqt_exec_callback_QGestureEvent_setAccepted ".} =
  ...
  proc superCall(accepted: bool): auto =
    callVirtualBase_setAccepted(QGestureEvent(h: self), accepted)
  let slotval1 = accepted


  nimfunc[](superCall, slotval1)
proc callVirtualBase_clone(self: QGestureEvent, ): gen_qcoreevent.QEvent =


  gen_qcoreevent.QEvent(h: fQGestureEvent_virtualbase_clone(self.h))

type QGestureEventcloneBase* = proc(): gen_qcoreevent.QEvent
proc onclone*(self: QGestureEvent, slot: proc(super: QGestureEventcloneBase): gen_qcoreevent.QEvent) =
  # TODO check subclass
  type Cb = proc(super: QGestureEventcloneBase): gen_qcoreevent.QEvent
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QGestureEvent_clone(self: ptr cQGestureEvent, slot: int): pointer {.exportc: "miqt_exec_callback_QGestureEvent_clone ".} =
  ...
  var nimfunc = cast[ptr Cb](cast[pointer](slot))
  proc superCall(): auto =
    callVirtualBase_clone(QGestureEvent(h: self), )
