...
func (this *QPrintPreviewDialog) Metacall(param1 qt6.QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {
	return (int)(C.QPrintPreviewDialog_metacall(this.h, (C.int)(param1), (C.int)(param2), param3))
}
...
func (this *QPrintPreviewDialog) callVirtualBase_MetaObject() *qt6.QMetaObject {

	return qt6.UnsafeNewQMetaObject(unsafe.Pointer(C.QPrintPreviewDialog_virtualbase_metaObject(unsafe.Pointer(this.h))))

}
func (this *QPrintPreviewDialog) OnmetaObject(slot func(super func() *qt6.QMetaObject) *qt6.QMetaObject) {
	ok := C.QPrintPreviewDialog_override_virtual_metaObject(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
...
func miqt_exec_callback_QPrintPreviewDialog_metaObject(self *C.QPrintPreviewDialog, cb C.intptr_t) *C.QMetaObject {
...
func (this *QPrintPreviewDialog) callVirtualBase_Metacast(param1 string) unsafe.Pointer {
	...
	return (unsafe.Pointer)(C.QPrintPreviewDialog_virtualbase_metacast(unsafe.Pointer(this.h), param1_Cstring))

}
func (this *QPrintPreviewDialog) Onmetacast(slot func(super func(param1 string) unsafe.Pointer, param1 string) unsafe.Pointer) {
	ok := C.QPrintPreviewDialog_override_virtual_metacast(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func miqt_exec_callback_QPrintPreviewDialog_metacast(self *C.QPrintPreviewDialog, cb C.intptr_t, param1 *C.const_char) unsafe.Pointer {
...
func (this *QPrintPreviewDialog) callVirtualBase_Metacall(param1 qt6.QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {

	return (int)(C.QPrintPreviewDialog_virtualbase_metacall(unsafe.Pointer(this.h), (C.int)(param1), (C.int)(param2), param3))

}
func (this *QPrintPreviewDialog) OnMetacall(slot func(super func(param1 qt6.QMetaObject__Call, param2 int, param3 unsafe.Pointer) int, param1 qt6.QMetaObject__Call, param2 int, param3 unsafe.Pointer) int) {
	ok := C.QPrintPreviewDialog_override_virtual_metacall(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}

//export miqt_exec_callback_QPrintPreviewDialog_metacall
func miqt_exec_callback_QPrintPreviewDialog_metacall(self *C.QPrintPreviewDialog, cb C.intptr_t, param1 C.int, param2 C.int, param3 unsafe.Pointer) C.int {
	...
	virtualReturn := gofunc((&QPrintPreviewDialog{h: self}).callVirtualBase_Metacall, slotval1, slotval2, slotval3)
