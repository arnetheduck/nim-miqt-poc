...
proc fcQAbstractPrintDialog_virtualbase_nativeEvent(self: pointer, eventType: struct_miqt_string, message: pointer, resultVal: ptr uint): bool {.importc: "QAbstractPrintDialog_virtualbase_nativeEvent".}
...
type QAbstractPrintDialogenterEventProc* = proc(self: QAbstractPrintDialog, event: gen_qevent_types.QEnterEvent): void {.raises: [], gcsafe.}
...
proc miqt_exec_callback_cQAbstractPrintDialog_nativeEvent(vtbl: pointer, self: pointer, eventType: struct_miqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let vtbl = cast[ptr QAbstractPrintDialogVTable](vtbl)
  let self = QAbstractPrintDialog(h: self)
