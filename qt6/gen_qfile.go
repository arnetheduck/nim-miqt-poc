...
func (this *QFile) callVirtualBase_MetaObject() *QMetaObject {
	...
	return newQMetaObject(C.QFile_virtualbase_metaObject(unsafe.Pointer(this.h)))

}
func (this *QFile) OnMetaObject(slot func(super func() *QMetaObject) *QMetaObject) {
	ok := C.QFile_override_virtual_metaObject(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
...
func miqt_exec_callback_QFile_metaObject(self *C.QFile, cb C.intptr_t) *C.QMetaObject {
...
func (this *QFile) callVirtualBase_Metacast(param1 string) unsafe.Pointer {
	...
	return (unsafe.Pointer)(C.QFile_virtualbase_metacast(unsafe.Pointer(this.h), param1_Cstring))

}
func (this *QFile) OnMetacast(slot func(super func(param1 string) unsafe.Pointer, param1 string) unsafe.Pointer) {
	ok := C.QFile_override_virtual_metacast(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func miqt_exec_callback_QFile_metacast(self *C.QFile, cb C.intptr_t, param1 *C.const_char) unsafe.Pointer {
