...
void miqt_exec_callback_QStyleHints_cursorFlashTimeChanged_release(intptr_t);
void miqt_exec_callback_QStyleHints_keyboardInputIntervalChanged(intptr_t, int);
void miqt_exec_callback_QStyleHints_keyboardInputIntervalChanged_release(intptr_t);
void miqt_exec_callback_QStyleHints_mouseDoubleClickIntervalChanged(intptr_t, int);
void miqt_exec_callback_QStyleHints_mouseDoubleClickIntervalChanged_release(intptr_t);
void miqt_exec_callback_QStyleHints_mousePressAndHoldIntervalChanged(intptr_t, int);
void miqt_exec_callback_QStyleHints_mousePressAndHoldIntervalChanged_release(intptr_t);
void miqt_exec_callback_QStyleHints_startDragDistanceChanged(intptr_t, int);
void miqt_exec_callback_QStyleHints_startDragDistanceChanged_release(intptr_t);
void miqt_exec_callback_QStyleHints_startDragTimeChanged(intptr_t, int);
void miqt_exec_callback_QStyleHints_startDragTimeChanged_release(intptr_t);
void miqt_exec_callback_QStyleHints_tabFocusBehaviorChanged(intptr_t, int);
void miqt_exec_callback_QStyleHints_tabFocusBehaviorChanged_release(intptr_t);
void miqt_exec_callback_QStyleHints_useHoverEffectsChanged(intptr_t, bool);
void miqt_exec_callback_QStyleHints_useHoverEffectsChanged_release(intptr_t);
void miqt_exec_callback_QStyleHints_showShortcutsInContextMenusChanged(intptr_t, bool);
void miqt_exec_callback_QStyleHints_showShortcutsInContextMenusChanged_release(intptr_t);
void miqt_exec_callback_QStyleHints_wheelScrollLinesChanged(intptr_t, int);
void miqt_exec_callback_QStyleHints_wheelScrollLinesChanged_release(intptr_t);
void miqt_exec_callback_QStyleHints_mouseQuickSelectionThresholdChanged(intptr_t, int);
void miqt_exec_callback_QStyleHints_mouseQuickSelectionThresholdChanged_release(intptr_t);
#ifdef __cplusplus
} /* extern C */
#endif
...
void QStyleHints_connect_cursorFlashTimeChanged(QStyleHints* self, intptr_t slot) {
	struct caller {
		...
		~caller() { miqt_exec_callback_QStyleHints_cursorFlashTimeChanged_release(slot); }
	};
	QStyleHints::connect(self, static_cast<void (QStyleHints::*)(int)>(&QStyleHints::cursorFlashTimeChanged), self, caller{slot});
}
...
void QStyleHints_connect_keyboardInputIntervalChanged(QStyleHints* self, intptr_t slot) {
	struct caller {
		...
		caller(const caller &) = delete;
		caller &operator=(const caller &) = delete;
		~caller() { miqt_exec_callback_QStyleHints_keyboardInputIntervalChanged_release(slot); }
	};
	QStyleHints::connect(self, static_cast<void (QStyleHints::*)(int)>(&QStyleHints::keyboardInputIntervalChanged), self, caller{slot});
}
...
void QStyleHints_connect_mouseDoubleClickIntervalChanged(QStyleHints* self, intptr_t slot) {
	struct caller {
		...
		caller(const caller &) = delete;
		caller &operator=(const caller &) = delete;
		~caller() { miqt_exec_callback_QStyleHints_mouseDoubleClickIntervalChanged_release(slot); }
	};
	QStyleHints::connect(self, static_cast<void (QStyleHints::*)(int)>(&QStyleHints::mouseDoubleClickIntervalChanged), self, caller{slot});
}
...
void QStyleHints_connect_mousePressAndHoldIntervalChanged(QStyleHints* self, intptr_t slot) {
	struct caller {
		...
		caller(const caller &) = delete;
		caller &operator=(const caller &) = delete;
		~caller() { miqt_exec_callback_QStyleHints_mousePressAndHoldIntervalChanged_release(slot); }
	};
	QStyleHints::connect(self, static_cast<void (QStyleHints::*)(int)>(&QStyleHints::mousePressAndHoldIntervalChanged), self, caller{slot});
}
...
void QStyleHints_connect_startDragDistanceChanged(QStyleHints* self, intptr_t slot) {
	struct caller {
		...
		caller(const caller &) = delete;
		caller &operator=(const caller &) = delete;
		~caller() { miqt_exec_callback_QStyleHints_startDragDistanceChanged_release(slot); }
	};
	QStyleHints::connect(self, static_cast<void (QStyleHints::*)(int)>(&QStyleHints::startDragDistanceChanged), self, caller{slot});
}
...
void QStyleHints_connect_startDragTimeChanged(QStyleHints* self, intptr_t slot) {
	struct caller {
		...
		caller(const caller &) = delete;
		caller &operator=(const caller &) = delete;
		~caller() { miqt_exec_callback_QStyleHints_startDragTimeChanged_release(slot); }
	};
	QStyleHints::connect(self, static_cast<void (QStyleHints::*)(int)>(&QStyleHints::startDragTimeChanged), self, caller{slot});
}
...
void QStyleHints_connect_tabFocusBehaviorChanged(QStyleHints* self, intptr_t slot) {
	struct caller {
		...
		caller(const caller &) = delete;
		caller &operator=(const caller &) = delete;
		~caller() { miqt_exec_callback_QStyleHints_tabFocusBehaviorChanged_release(slot); }
	};
	QStyleHints::connect(self, static_cast<void (QStyleHints::*)(Qt::TabFocusBehavior)>(&QStyleHints::tabFocusBehaviorChanged), self, caller{slot});
}
...
void QStyleHints_connect_useHoverEffectsChanged(QStyleHints* self, intptr_t slot) {
	struct caller {
		...
		caller(const caller &) = delete;
		caller &operator=(const caller &) = delete;
		~caller() { miqt_exec_callback_QStyleHints_useHoverEffectsChanged_release(slot); }
	};
	QStyleHints::connect(self, static_cast<void (QStyleHints::*)(bool)>(&QStyleHints::useHoverEffectsChanged), self, caller{slot});
}
...
void QStyleHints_connect_showShortcutsInContextMenusChanged(QStyleHints* self, intptr_t slot) {
	struct caller {
		...
		caller(const caller &) = delete;
		caller &operator=(const caller &) = delete;
		~caller() { miqt_exec_callback_QStyleHints_showShortcutsInContextMenusChanged_release(slot); }
	};
	QStyleHints::connect(self, static_cast<void (QStyleHints::*)(bool)>(&QStyleHints::showShortcutsInContextMenusChanged), self, caller{slot});
}
...
void QStyleHints_connect_wheelScrollLinesChanged(QStyleHints* self, intptr_t slot) {
	struct caller {
		...
		caller(const caller &) = delete;
		caller &operator=(const caller &) = delete;
		~caller() { miqt_exec_callback_QStyleHints_wheelScrollLinesChanged_release(slot); }
	};
	QStyleHints::connect(self, static_cast<void (QStyleHints::*)(int)>(&QStyleHints::wheelScrollLinesChanged), self, caller{slot});
}
...
void QStyleHints_connect_mouseQuickSelectionThresholdChanged(QStyleHints* self, intptr_t slot) {
	struct caller {
		...
		caller(const caller &) = delete;
		caller &operator=(const caller &) = delete;
		~caller() { miqt_exec_callback_QStyleHints_mouseQuickSelectionThresholdChanged_release(slot); }
	};
	QStyleHints::connect(self, static_cast<void (QStyleHints::*)(int)>(&QStyleHints::mouseQuickSelectionThresholdChanged), self, caller{slot});
}
