...
func init*(T: type Disambiguated_t, h: ptr cDisambiguated_t): Disambiguated_t =
  T(h: h)
proc create*(T: type Disambiguated_t, ): Disambiguated_t =

  Disambiguated_t.init(fcDisambiguated_t_new())
proc create*(T: type Disambiguated_t, param1: Disambiguated_t): Disambiguated_t =

  Disambiguated_t.init(fcDisambiguated_t_new2(param1.h))
proc delete*(self: Disambiguated_t) =
...
func init*(T: type QKeyCombination, h: ptr cQKeyCombination): QKeyCombination =
  T(h: h)
proc create*(T: type QKeyCombination, ): QKeyCombination =

  QKeyCombination.init(fcQKeyCombination_new())
proc create*(T: type QKeyCombination, modifiers: Modifier): QKeyCombination =

  QKeyCombination.init(fcQKeyCombination_new2(cint(modifiers)))
proc create2*(T: type QKeyCombination, modifiers: KeyboardModifier): QKeyCombination =

  QKeyCombination.init(fcQKeyCombination_new3(cint(modifiers)))
proc create*(T: type QKeyCombination, param1: QKeyCombination): QKeyCombination =

  QKeyCombination.init(fcQKeyCombination_new4(param1.h))
proc create2*(T: type QKeyCombination, key: Key): QKeyCombination =

  QKeyCombination.init(fcQKeyCombination_new5(cint(key)))
proc create*(T: type QKeyCombination, modifiers: Modifier, key: Key): QKeyCombination =

  QKeyCombination.init(fcQKeyCombination_new6(cint(modifiers), cint(key)))
proc create2*(T: type QKeyCombination, modifiers: KeyboardModifier, key: Key): QKeyCombination =

  QKeyCombination.init(fcQKeyCombination_new7(cint(modifiers), cint(key)))
proc keyboardModifiers*(self: QKeyCombination, ): KeyboardModifier =

  KeyboardModifier(fcQKeyCombination_keyboardModifiers(self.h))

proc key*(self: QKeyCombination, ): Key =

  Key(fcQKeyCombination_key(self.h))

proc fromCombined*(_: type QKeyCombination, combined: cint): QKeyCombination =

  QKeyCombination(h: fcQKeyCombination_fromCombined(combined))

proc toCombined*(self: QKeyCombination, ): cint =

  fcQKeyCombination_toCombined(self.h)

proc ToInt*(self: QKeyCombination, ): cint =

  fcQKeyCombination_ToInt(self.h)

proc delete*(self: QKeyCombination) =
