...
proc create*(T: type gen_qoffscreensurface_types.QOffscreenSurface,
  ...
  gen_qoffscreensurface_types.QOffscreenSurface(h: fcQOffscreenSurface_new(addr(vtbl[]), ))
...
proc create*(T: type gen_qoffscreensurface_types.QOffscreenSurface,
  ...
  if not isNil(vtbl.disconnectNotify):
    vtbl[].vtbl.disconnectNotify = miqt_exec_callback_cQOffscreenSurface_disconnectNotify
  gen_qoffscreensurface_types.QOffscreenSurface(h: fcQOffscreenSurface_new2(addr(vtbl[]), screen.h))
...
proc create*(T: type gen_qoffscreensurface_types.QOffscreenSurface,
  ...
  if not isNil(vtbl.disconnectNotify):
    vtbl[].vtbl.disconnectNotify = miqt_exec_callback_cQOffscreenSurface_disconnectNotify
  gen_qoffscreensurface_types.QOffscreenSurface(h: fcQOffscreenSurface_new3(addr(vtbl[]), screen.h, parent.h))
