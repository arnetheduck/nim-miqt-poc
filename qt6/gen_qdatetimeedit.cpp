...
void QDateTimeEdit_connect_timeChanged(QDateTimeEdit* self, intptr_t slot) {
	...
	MiqtVirtualQDateTimeEdit::connect(self, static_cast<void (QDateTimeEdit::*)(QTime)>(&QDateTimeEdit::timeChanged), self, caller{slot});
}
...
void QDateTimeEdit_connect_dateChanged(QDateTimeEdit* self, intptr_t slot) {
	...
	MiqtVirtualQDateTimeEdit::connect(self, static_cast<void (QDateTimeEdit::*)(QDate)>(&QDateTimeEdit::dateChanged), self, caller{slot});
}
...
void QTimeEdit_connect_userTimeChanged(QTimeEdit* self, intptr_t slot) {
	...
	MiqtVirtualQTimeEdit::connect(self, static_cast<void (QTimeEdit::*)(QTime)>(&QTimeEdit::userTimeChanged), self, caller{slot});
}
...
void QDateEdit_connect_userDateChanged(QDateEdit* self, intptr_t slot) {
	...
	MiqtVirtualQDateEdit::connect(self, static_cast<void (QDateEdit::*)(QDate)>(&QDateEdit::userDateChanged), self, caller{slot});
}
