...
proc operatorMinusGreater2*(self: QCborArrayIterator, ): gen_qcborvalue.QCborValueConstRef =
...
proc operatorMultiply*(self: QCborArrayConstIterator, ): gen_qcborvalue.QCborValueConstRef =

  gen_qcborvalue.QCborValueConstRef(h: fcQCborArrayConstIterator_operatorMultiply(self.h))

proc operatorMinusGreater*(self: QCborArrayConstIterator, ): gen_qcborvalue.QCborValueConstRef =

  gen_qcborvalue.QCborValueConstRef(h: fcQCborArrayConstIterator_operatorMinusGreater(self.h))

proc operatorSubscript*(self: QCborArrayConstIterator, j: int64): gen_qcborvalue.QCborValueConstRef =
