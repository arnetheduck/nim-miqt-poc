...
func (this *QTabWidget) callVirtualBase_MetaObject() *QMetaObject {
	...
	return newQMetaObject(C.QTabWidget_virtualbase_metaObject(unsafe.Pointer(this.h)))

}
func (this *QTabWidget) OnMetaObject(slot func(super func() *QMetaObject) *QMetaObject) {
	ok := C.QTabWidget_override_virtual_metaObject(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
...
func miqt_exec_callback_QTabWidget_metaObject(self *C.QTabWidget, cb C.intptr_t) *C.QMetaObject {
...
func (this *QTabWidget) callVirtualBase_Metacast(param1 string) unsafe.Pointer {
	...
	return (unsafe.Pointer)(C.QTabWidget_virtualbase_metacast(unsafe.Pointer(this.h), param1_Cstring))

}
func (this *QTabWidget) OnMetacast(slot func(super func(param1 string) unsafe.Pointer, param1 string) unsafe.Pointer) {
	ok := C.QTabWidget_override_virtual_metacast(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func miqt_exec_callback_QTabWidget_metacast(self *C.QTabWidget, cb C.intptr_t, param1 *C.const_char) unsafe.Pointer {
...
func (this *QTabWidget) callVirtualBase_InitStyleOption(option *QStyleOptionTabWidgetFrame) {
	...
	C.QTabWidget_virtualbase_initStyleOption(unsafe.Pointer(this.h), option.cPointer())
...
func (this *QTabWidget) OnInitStyleOption(slot func(super func(option *QStyleOptionTabWidgetFrame), option *QStyleOptionTabWidgetFrame)) {
	ok := C.QTabWidget_override_virtual_initStyleOption(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func miqt_exec_callback_QTabWidget_initStyleOption(self *C.QTabWidget, cb C.intptr_t, option *C.QStyleOptionTabWidgetFrame) {
...
func miqt_exec_callback_QTabWidget_enterEvent(self *C.QTabWidget, cb C.intptr_t, event *C.QEnterEvent) {
