...
proc miqt_exec_callback_QScrollArea_changeEvent(self: ptr cQScrollArea, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QScrollArea_changeEvent ".} =
  ...
  nimfunc[](superCall, slotval1)
proc callVirtualBase_initStyleOption(self: QScrollArea, option: gen_qstyleoption.QStyleOptionFrame): void =


  fQScrollArea_virtualbase_initStyleOption(self.h, option.h)

type QScrollAreainitStyleOptionBase* = proc(option: gen_qstyleoption.QStyleOptionFrame): void
proc oninitStyleOption*(self: QScrollArea, slot: proc(super: QScrollAreainitStyleOptionBase, option: gen_qstyleoption.QStyleOptionFrame): void) =
  # TODO check subclass
  type Cb = proc(super: QScrollAreainitStyleOptionBase, option: gen_qstyleoption.QStyleOptionFrame): void
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QScrollArea_initStyleOption(self: ptr cQScrollArea, slot: int, option: pointer): void {.exportc: "miqt_exec_callback_QScrollArea_initStyleOption ".} =
  ...
  proc superCall(option: gen_qstyleoption.QStyleOptionFrame): auto =
    callVirtualBase_initStyleOption(QScrollArea(h: self), option)
...
proc miqt_exec_callback_QScrollArea_focusOutEvent(self: ptr cQScrollArea, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QScrollArea_focusOutEvent ".} =
  ...
  nimfunc[](superCall, slotval1)
proc callVirtualBase_enterEvent(self: QScrollArea, event: gen_qevent.QEnterEvent): void =


  fQScrollArea_virtualbase_enterEvent(self.h, event.h)

type QScrollAreaenterEventBase* = proc(event: gen_qevent.QEnterEvent): void
proc onenterEvent*(self: QScrollArea, slot: proc(super: QScrollAreaenterEventBase, event: gen_qevent.QEnterEvent): void) =
  # TODO check subclass
  type Cb = proc(super: QScrollAreaenterEventBase, event: gen_qevent.QEnterEvent): void
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QScrollArea_hideEvent(self: ptr cQScrollArea, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QScrollArea_hideEvent ".} =
  ...
  nimfunc[](superCall, slotval1)
proc callVirtualBase_nativeEvent(self: QScrollArea, eventType: seq[byte], message: pointer, resultVal: ptr uint): bool =
...
type QScrollAreanativeEventBase* = proc(eventType: seq[byte], message: pointer, resultVal: ptr uint): bool
proc onnativeEvent*(self: QScrollArea, slot: proc(super: QScrollAreanativeEventBase, eventType: seq[byte], message: pointer, resultVal: ptr uint): bool) =
  # TODO check subclass
  type Cb = proc(super: QScrollAreanativeEventBase, eventType: seq[byte], message: pointer, resultVal: ptr uint): bool
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
