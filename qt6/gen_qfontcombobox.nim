...
proc setSampleTextForSystem*(self: QFontComboBox, writingSystem: gen_qfontdatabase.QFontDatabaseWritingSystem, sampleText: string): void =
...
proc sampleTextForSystem*(self: QFontComboBox, writingSystem: gen_qfontdatabase.QFontDatabaseWritingSystem): string =
...
proc setSampleTextForFont*(self: QFontComboBox, fontFamily: string, sampleText: string): void =
...
proc sampleTextForFont*(self: QFontComboBox, fontFamily: string): string =
...
proc setDisplayFont*(self: QFontComboBox, fontFamily: string, font: gen_qfont.QFont): void =
...
proc miqt_exec_callback_QFontComboBox_event(self: ptr cQFontComboBox, slot: int, e: pointer): bool {.exportc: "miqt_exec_callback_QFontComboBox_event ".} =
  ...
  virtualReturn
proc callVirtualBase_setModel(self: QFontComboBox, model: gen_qabstractitemmodel.QAbstractItemModel): void =


  fQFontComboBox_virtualbase_setModel(self.h, model.h)

type QFontComboBoxsetModelBase* = proc(model: gen_qabstractitemmodel.QAbstractItemModel): void
proc onsetModel*(self: QFontComboBox, slot: proc(super: QFontComboBoxsetModelBase, model: gen_qabstractitemmodel.QAbstractItemModel): void) =
  # TODO check subclass
  type Cb = proc(super: QFontComboBoxsetModelBase, model: gen_qabstractitemmodel.QAbstractItemModel): void
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QFontComboBox_setModel(self: ptr cQFontComboBox, slot: int, model: pointer): void {.exportc: "miqt_exec_callback_QFontComboBox_setModel ".} =
  ...
  proc superCall(model: gen_qabstractitemmodel.QAbstractItemModel): auto =
    callVirtualBase_setModel(QFontComboBox(h: self), model)
...
proc miqt_exec_callback_QFontComboBox_inputMethodEvent(self: ptr cQFontComboBox, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QFontComboBox_inputMethodEvent ".} =
  ...
  nimfunc[](superCall, slotval1)
proc callVirtualBase_initStyleOption(self: QFontComboBox, option: gen_qstyleoption.QStyleOptionComboBox): void =


  fQFontComboBox_virtualbase_initStyleOption(self.h, option.h)

type QFontComboBoxinitStyleOptionBase* = proc(option: gen_qstyleoption.QStyleOptionComboBox): void
proc oninitStyleOption*(self: QFontComboBox, slot: proc(super: QFontComboBoxinitStyleOptionBase, option: gen_qstyleoption.QStyleOptionComboBox): void) =
  # TODO check subclass
  type Cb = proc(super: QFontComboBoxinitStyleOptionBase, option: gen_qstyleoption.QStyleOptionComboBox): void
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QFontComboBox_initStyleOption(self: ptr cQFontComboBox, slot: int, option: pointer): void {.exportc: "miqt_exec_callback_QFontComboBox_initStyleOption ".} =
  ...
  proc superCall(option: gen_qstyleoption.QStyleOptionComboBox): auto =
    callVirtualBase_initStyleOption(QFontComboBox(h: self), option)
...
proc miqt_exec_callback_QFontComboBox_mouseMoveEvent(self: ptr cQFontComboBox, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QFontComboBox_mouseMoveEvent ".} =
  ...
  nimfunc[](superCall, slotval1)
proc callVirtualBase_enterEvent(self: QFontComboBox, event: gen_qevent.QEnterEvent): void =


  fQFontComboBox_virtualbase_enterEvent(self.h, event.h)

type QFontComboBoxenterEventBase* = proc(event: gen_qevent.QEnterEvent): void
proc onenterEvent*(self: QFontComboBox, slot: proc(super: QFontComboBoxenterEventBase, event: gen_qevent.QEnterEvent): void) =
  # TODO check subclass
  type Cb = proc(super: QFontComboBoxenterEventBase, event: gen_qevent.QEnterEvent): void
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QFontComboBox_dropEvent(self: ptr cQFontComboBox, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QFontComboBox_dropEvent ".} =
  ...
  nimfunc[](superCall, slotval1)
proc callVirtualBase_nativeEvent(self: QFontComboBox, eventType: seq[byte], message: pointer, resultVal: ptr uint): bool =
...
type QFontComboBoxnativeEventBase* = proc(eventType: seq[byte], message: pointer, resultVal: ptr uint): bool
proc onnativeEvent*(self: QFontComboBox, slot: proc(super: QFontComboBoxnativeEventBase, eventType: seq[byte], message: pointer, resultVal: ptr uint): bool) =
  # TODO check subclass
  type Cb = proc(super: QFontComboBoxnativeEventBase, eventType: seq[byte], message: pointer, resultVal: ptr uint): bool
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
