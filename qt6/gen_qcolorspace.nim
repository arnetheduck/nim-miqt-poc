...
proc create*(T: type QColorSpace, primaries: QColorSpacePrimaries, transferFunctionTable: seq[uint16]): QColorSpace =
  ...
  QColorSpace.init(fcQColorSpace_new5(cint(primaries), struct_miqt_array(len: csize_t(len(transferFunctionTable)), data: if len(transferFunctionTable) == 0: nil else: addr(transferFunctionTable_CArray[0]))))
proc create*(T: type QColorSpace, whitePoint: gen_qpoint.QPointF, redPoint: gen_qpoint.QPointF, greenPoint: gen_qpoint.QPointF, bluePoint: gen_qpoint.QPointF, transferFunction: QColorSpaceTransferFunction): QColorSpace =
  ...
  QColorSpace.init(fcQColorSpace_new6(whitePoint.h, redPoint.h, greenPoint.h, bluePoint.h, cint(transferFunction)))
proc create*(T: type QColorSpace, whitePoint: gen_qpoint.QPointF, redPoint: gen_qpoint.QPointF, greenPoint: gen_qpoint.QPointF, bluePoint: gen_qpoint.QPointF, transferFunctionTable: seq[uint16]): QColorSpace =

  var transferFunctionTable_CArray = newSeq[uint16](len(transferFunctionTable))
  for i in 0..<len(transferFunctionTable):
    transferFunctionTable_CArray[i] = transferFunctionTable[i]

  QColorSpace.init(fcQColorSpace_new7(whitePoint.h, redPoint.h, greenPoint.h, bluePoint.h, struct_miqt_array(len: csize_t(len(transferFunctionTable)), data: if len(transferFunctionTable) == 0: nil else: addr(transferFunctionTable_CArray[0]))))
proc create*(T: type QColorSpace, whitePoint: gen_qpoint.QPointF, redPoint: gen_qpoint.QPointF, greenPoint: gen_qpoint.QPointF, bluePoint: gen_qpoint.QPointF, redTransferFunctionTable: seq[uint16], greenTransferFunctionTable: seq[uint16], blueTransferFunctionTable: seq[uint16]): QColorSpace =
...
proc create*(T: type QColorSpace, primaries: QColorSpacePrimaries, transferFunction: QColorSpaceTransferFunction, gamma: float32): QColorSpace =
  ...
  QColorSpace.init(fcQColorSpace_new10(cint(primaries), cint(transferFunction), gamma))
proc create*(T: type QColorSpace, whitePoint: gen_qpoint.QPointF, redPoint: gen_qpoint.QPointF, greenPoint: gen_qpoint.QPointF, bluePoint: gen_qpoint.QPointF, transferFunction: QColorSpaceTransferFunction, gamma: float32): QColorSpace =
  ...
  QColorSpace.init(fcQColorSpace_new11(whitePoint.h, redPoint.h, greenPoint.h, bluePoint.h, cint(transferFunction), gamma))
...
proc description*(self: QColorSpace, ): string =
...
proc setDescription*(self: QColorSpace, description: string): void =
...
proc setTransferFunctionWithTransferFunctionTable*(self: QColorSpace, transferFunctionTable: seq[uint16]): void =
...
proc setTransferFunctions*(self: QColorSpace, redTransferFunctionTable: seq[uint16], greenTransferFunctionTable: seq[uint16], blueTransferFunctionTable: seq[uint16]): void =
...
proc withTransferFunctionWithTransferFunctionTable*(self: QColorSpace, transferFunctionTable: seq[uint16]): QColorSpace =
...
proc withTransferFunctions*(self: QColorSpace, redTransferFunctionTable: seq[uint16], greenTransferFunctionTable: seq[uint16], blueTransferFunctionTable: seq[uint16]): QColorSpace =
...
proc detach*(self: QColorSpace, ): void =
