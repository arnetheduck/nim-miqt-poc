...
public:
	...
	MiqtVirtualQImage(struct QImage_VTable* vtbl): QImage(), vtbl(vtbl) {};
	MiqtVirtualQImage(struct QImage_VTable* vtbl, const QSize& size, QImage::Format format): QImage(size, format), vtbl(vtbl) {};
	MiqtVirtualQImage(struct QImage_VTable* vtbl, int width, int height, QImage::Format format): QImage(width, height, format), vtbl(vtbl) {};
	MiqtVirtualQImage(struct QImage_VTable* vtbl, uchar* data, int width, int height, QImage::Format format): QImage(data, width, height, format), vtbl(vtbl) {};
	MiqtVirtualQImage(struct QImage_VTable* vtbl, const uchar* data, int width, int height, QImage::Format format): QImage(data, width, height, format), vtbl(vtbl) {};
	MiqtVirtualQImage(struct QImage_VTable* vtbl, uchar* data, int width, int height, qsizetype bytesPerLine, QImage::Format format): QImage(data, width, height, bytesPerLine, format), vtbl(vtbl) {};
	MiqtVirtualQImage(struct QImage_VTable* vtbl, const uchar* data, int width, int height, qsizetype bytesPerLine, QImage::Format format): QImage(data, width, height, bytesPerLine, format), vtbl(vtbl) {};
	MiqtVirtualQImage(struct QImage_VTable* vtbl, const QString& fileName): QImage(fileName), vtbl(vtbl) {};
	MiqtVirtualQImage(struct QImage_VTable* vtbl, const QImage& param1): QImage(param1), vtbl(vtbl) {};
	MiqtVirtualQImage(struct QImage_VTable* vtbl, const QString& fileName, const char* format): QImage(fileName, format), vtbl(vtbl) {};

	virtual ~MiqtVirtualQImage() override { if(vtbl->destructor) vtbl->destructor(vtbl, this); }
	...
	// Wrapper to allow calling protected method
	void protectedbase_detachMetadata() {
	...
	// Wrapper to allow calling protected method
	void protectedbase_detachMetadata1(bool invalidateCache) {
...
QImage* QImage_new(struct QImage_VTable* vtbl) {
	return new MiqtVirtualQImage(vtbl);
}

QImage* QImage_new2(struct QImage_VTable* vtbl, QSize* size, int format) {
	return new MiqtVirtualQImage(vtbl, *size, static_cast<QImage::Format>(format));
}

QImage* QImage_new3(struct QImage_VTable* vtbl, int width, int height, int format) {
	return new MiqtVirtualQImage(vtbl, static_cast<int>(width), static_cast<int>(height), static_cast<QImage::Format>(format));
}

QImage* QImage_new4(struct QImage_VTable* vtbl, unsigned char* data, int width, int height, int format) {
	return new MiqtVirtualQImage(vtbl, static_cast<uchar*>(data), static_cast<int>(width), static_cast<int>(height), static_cast<QImage::Format>(format));
}

QImage* QImage_new5(struct QImage_VTable* vtbl, const unsigned char* data, int width, int height, int format) {
	return new MiqtVirtualQImage(vtbl, static_cast<const uchar*>(data), static_cast<int>(width), static_cast<int>(height), static_cast<QImage::Format>(format));
}

QImage* QImage_new6(struct QImage_VTable* vtbl, unsigned char* data, int width, int height, ptrdiff_t bytesPerLine, int format) {
	return new MiqtVirtualQImage(vtbl, static_cast<uchar*>(data), static_cast<int>(width), static_cast<int>(height), (qsizetype)(bytesPerLine), static_cast<QImage::Format>(format));
}
...
QImage* QImage_new7(struct QImage_VTable* vtbl, const unsigned char* data, int width, int height, ptrdiff_t bytesPerLine, int format) {
	return new MiqtVirtualQImage(vtbl, static_cast<const uchar*>(data), static_cast<int>(width), static_cast<int>(height), (qsizetype)(bytesPerLine), static_cast<QImage::Format>(format));
}

QImage* QImage_new8(struct QImage_VTable* vtbl, struct miqt_string fileName) {
	QString fileName_QString = QString::fromUtf8(fileName.data, fileName.len);
	return new MiqtVirtualQImage(vtbl, fileName_QString);
}

QImage* QImage_new9(struct QImage_VTable* vtbl, QImage* param1) {
	return new MiqtVirtualQImage(vtbl, *param1);
}

QImage* QImage_new10(struct QImage_VTable* vtbl, struct miqt_string fileName, const char* format) {
	QString fileName_QString = QString::fromUtf8(fileName.data, fileName.len);
	return new MiqtVirtualQImage(vtbl, fileName_QString, format);
}
...
void QImage_protectedbase_detachMetadata(void* self) {
	( (MiqtVirtualQImage*)(self) )->protectedbase_detachMetadata();
}

void QImage_protectedbase_detachMetadata1(void* self, bool invalidateCache) {
	( (MiqtVirtualQImage*)(self) )->protectedbase_detachMetadata1(invalidateCache);
}
