...
func (this *QPluginLoader) Metacall(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {
	return (int)(C.QPluginLoader_metacall(this.h, (C.int)(param1), (C.int)(param2), param3))
}
...
func (this *QPluginLoader) OnMetacall(slot func(super func(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int, param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int) {
	ok := C.QPluginLoader_override_virtual_metacall(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}

//export miqt_exec_callback_QPluginLoader_metacall
func miqt_exec_callback_QPluginLoader_metacall(self *C.QPluginLoader, cb C.intptr_t, param1 C.int, param2 C.int, param3 unsafe.Pointer) C.int {
	...
	virtualReturn := gofunc((&QPluginLoader{h: self}).callVirtualBase_Metacall, slotval1, slotval2, slotval3)
