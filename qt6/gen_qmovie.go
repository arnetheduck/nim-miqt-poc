...
func (this *QMovie) Metacall(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {
	return (int)(C.QMovie_metacall(this.h, (C.int)(param1), (C.int)(param2), param3))
}
...
func (this *QMovie) callVirtualBase_MetaObject() *QMetaObject {
	...
	return newQMetaObject(C.QMovie_virtualbase_metaObject(unsafe.Pointer(this.h)))

}
func (this *QMovie) OnMetaObject(slot func(super func() *QMetaObject) *QMetaObject) {
	ok := C.QMovie_override_virtual_metaObject(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
...
func miqt_exec_callback_QMovie_metaObject(self *C.QMovie, cb C.intptr_t) *C.QMetaObject {
...
func (this *QMovie) callVirtualBase_Metacast(param1 string) unsafe.Pointer {
	...
	return (unsafe.Pointer)(C.QMovie_virtualbase_metacast(unsafe.Pointer(this.h), param1_Cstring))

}
func (this *QMovie) OnMetacast(slot func(super func(param1 string) unsafe.Pointer, param1 string) unsafe.Pointer) {
	ok := C.QMovie_override_virtual_metacast(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func miqt_exec_callback_QMovie_metacast(self *C.QMovie, cb C.intptr_t, param1 *C.const_char) unsafe.Pointer {
...
func (this *QMovie) callVirtualBase_Metacall(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {

	return (int)(C.QMovie_virtualbase_metacall(unsafe.Pointer(this.h), (C.int)(param1), (C.int)(param2), param3))

}
func (this *QMovie) OnMetacall(slot func(super func(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int, param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int) {
	ok := C.QMovie_override_virtual_metacall(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}

//export miqt_exec_callback_QMovie_metacall
func miqt_exec_callback_QMovie_metacall(self *C.QMovie, cb C.intptr_t, param1 C.int, param2 C.int, param3 unsafe.Pointer) C.int {
	...
	virtualReturn := gofunc((&QMovie{h: self}).callVirtualBase_Metacall, slotval1, slotval2, slotval3)
