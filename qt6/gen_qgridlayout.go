...
func (this *QGridLayout) Metacall(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {
	return (int)(C.QGridLayout_metacall(this.h, (C.int)(param1), (C.int)(param2), param3))
}
...
func miqt_exec_callback_QGridLayout_metaObject(self *C.QGridLayout, cb C.intptr_t) *C.QMetaObject {
...
func miqt_exec_callback_QGridLayout_metacast(self *C.QGridLayout, cb C.intptr_t, param1 *C.const_char) unsafe.Pointer {
...
func (this *QGridLayout) callVirtualBase_Metacall(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {

	return (int)(C.QGridLayout_virtualbase_metacall(unsafe.Pointer(this.h), (C.int)(param1), (C.int)(param2), param3))

}
func (this *QGridLayout) OnMetacall(slot func(super func(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int, param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int) {
	ok := C.QGridLayout_override_virtual_metacall(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}

//export miqt_exec_callback_QGridLayout_metacall
func miqt_exec_callback_QGridLayout_metacall(self *C.QGridLayout, cb C.intptr_t, param1 C.int, param2 C.int, param3 unsafe.Pointer) C.int {
	...
	virtualReturn := gofunc((&QGridLayout{h: self}).callVirtualBase_Metacall, slotval1, slotval2, slotval3)
