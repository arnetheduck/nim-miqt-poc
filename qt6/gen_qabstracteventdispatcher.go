...
func (this *QAbstractEventDispatcher) Metacall(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {
	return (int)(C.QAbstractEventDispatcher_metacall(this.h, (C.int)(param1), (C.int)(param2), param3))
}
