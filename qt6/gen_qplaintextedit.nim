...
proc findWithExp*(self: QPlainTextEdit, exp: gen_qregularexpression.QRegularExpression): bool =
...
proc find2*(self: QPlainTextEdit, exp: string, options: gen_qtextdocument.QTextDocumentFindFlag): bool =

  fcQPlainTextEdit_find2(self.h, struct_miqt_string(data: exp, len: csize_t(len(exp))), cint(options))

proc find22*(self: QPlainTextEdit, exp: gen_qregularexpression.QRegularExpression, options: gen_qtextdocument.QTextDocumentFindFlag): bool =
...
proc miqt_exec_callback_QPlainTextEdit_viewportSizeHint(self: ptr cQPlainTextEdit, slot: int): pointer {.exportc: "miqt_exec_callback_QPlainTextEdit_viewportSizeHint ".} =
  ...
  virtualReturn.h
proc callVirtualBase_initStyleOption(self: QPlainTextEdit, option: gen_qstyleoption.QStyleOptionFrame): void =


  fQPlainTextEdit_virtualbase_initStyleOption(self.h, option.h)

type QPlainTextEditinitStyleOptionBase* = proc(option: gen_qstyleoption.QStyleOptionFrame): void
proc oninitStyleOption*(self: QPlainTextEdit, slot: proc(super: QPlainTextEditinitStyleOptionBase, option: gen_qstyleoption.QStyleOptionFrame): void) =
  # TODO check subclass
  type Cb = proc(super: QPlainTextEditinitStyleOptionBase, option: gen_qstyleoption.QStyleOptionFrame): void
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QPlainTextEdit_initStyleOption(self: ptr cQPlainTextEdit, slot: int, option: pointer): void {.exportc: "miqt_exec_callback_QPlainTextEdit_initStyleOption ".} =
  ...
  proc superCall(option: gen_qstyleoption.QStyleOptionFrame): auto =
    callVirtualBase_initStyleOption(QPlainTextEdit(h: self), option)
...
proc miqt_exec_callback_QPlainTextEdit_paintEngine(self: ptr cQPlainTextEdit, slot: int): pointer {.exportc: "miqt_exec_callback_QPlainTextEdit_paintEngine ".} =
  ...
  virtualReturn.h
proc callVirtualBase_enterEvent(self: QPlainTextEdit, event: gen_qevent.QEnterEvent): void =


  fQPlainTextEdit_virtualbase_enterEvent(self.h, event.h)

type QPlainTextEditenterEventBase* = proc(event: gen_qevent.QEnterEvent): void
proc onenterEvent*(self: QPlainTextEdit, slot: proc(super: QPlainTextEditenterEventBase, event: gen_qevent.QEnterEvent): void) =
  # TODO check subclass
  type Cb = proc(super: QPlainTextEditenterEventBase, event: gen_qevent.QEnterEvent): void
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QPlainTextEdit_hideEvent(self: ptr cQPlainTextEdit, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QPlainTextEdit_hideEvent ".} =
  ...
  nimfunc[](superCall, slotval1)
proc callVirtualBase_nativeEvent(self: QPlainTextEdit, eventType: seq[byte], message: pointer, resultVal: ptr uint): bool =
...
type QPlainTextEditnativeEventBase* = proc(eventType: seq[byte], message: pointer, resultVal: ptr uint): bool
proc onnativeEvent*(self: QPlainTextEdit, slot: proc(super: QPlainTextEditnativeEventBase, eventType: seq[byte], message: pointer, resultVal: ptr uint): bool) =
  # TODO check subclass
  type Cb = proc(super: QPlainTextEditnativeEventBase, eventType: seq[byte], message: pointer, resultVal: ptr uint): bool
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
