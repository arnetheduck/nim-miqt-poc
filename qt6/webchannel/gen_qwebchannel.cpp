...
QObject* QWebChannel_protectedbase_sender(const void* self) {
	return ( (const MiqtVirtualQWebChannel*)(self) )->protectedbase_sender();
}

int QWebChannel_protectedbase_senderSignalIndex(const void* self) {
	return ( (const MiqtVirtualQWebChannel*)(self) )->protectedbase_senderSignalIndex();
}

int QWebChannel_protectedbase_receivers(const void* self, const char* signal) {
	return ( (const MiqtVirtualQWebChannel*)(self) )->protectedbase_receivers(signal);
}

bool QWebChannel_protectedbase_isSignalConnected(const void* self, QMetaMethod* signal) {
	return ( (const MiqtVirtualQWebChannel*)(self) )->protectedbase_isSignalConnected(signal);
}
