...
func (this *QQmlWebChannel) Metacall(param1 qt6.QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {
...
func (this *QQmlWebChannel) callVirtualBase_MetaObject() *qt6.QMetaObject {

	return qt6.UnsafeNewQMetaObject(unsafe.Pointer(C.QQmlWebChannel_virtualbase_metaObject(unsafe.Pointer(this.h))))

}
func (this *QQmlWebChannel) OnmetaObject(slot func(super func() *qt6.QMetaObject) *qt6.QMetaObject) {
...
func (this *QQmlWebChannel) callVirtualBase_Metacall(param1 qt6.QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {

	return (int)(C.QQmlWebChannel_virtualbase_metacall(unsafe.Pointer(this.h), (C.int)(param1), (C.int)(param2), param3))

}
func (this *QQmlWebChannel) OnMetacall(slot func(super func(param1 qt6.QMetaObject__Call, param2 int, param3 unsafe.Pointer) int, param1 qt6.QMetaObject__Call, param2 int, param3 unsafe.Pointer) int) {
