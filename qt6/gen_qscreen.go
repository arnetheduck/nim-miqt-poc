...
func (this *QScreen) Metacall(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {
	return (int)(C.QScreen_metacall(this.h, (C.int)(param1), (C.int)(param2), param3))
}
...
func (this *QScreen) GrabWindow() *QPixmap {
	_goptr := newQPixmap(C.QScreen_grabWindow(this.h))
	_goptr.GoGC() // Qt uses pass-by-value semantics for this type. Mimic with finalizer
	return _goptr
}
