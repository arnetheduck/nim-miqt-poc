...
type cQStandardItemVTable = object
  ...
  multiData*: proc(vtbl, self: pointer, roleDataSpan: pointer): void {.cdecl, raises: [], gcsafe.}
...
proc fcQStandardItem_virtualbase_multiData(self: pointer, roleDataSpan: pointer): void {.importc: "QStandardItem_virtualbase_multiData".}
...
proc fcQStandardItem_protectedbase_operatorAssign(self: pointer, other: pointer): void {.importc: "QStandardItem_protectedbase_operatorAssign".}
...
proc fcQStandardItemModel_virtualbase_multiData(self: pointer, index: pointer, roleDataSpan: pointer): void {.importc: "QStandardItemModel_virtualbase_multiData".}
...
proc fcQStandardItemModel_virtualbase_clearItemData(self: pointer, index: pointer): bool {.importc: "QStandardItemModel_virtualbase_clearItemData".}
...
proc fcQStandardItemModel_virtualbase_resetInternalData(self: pointer, ): void {.importc: "QStandardItemModel_virtualbase_resetInternalData".}
...
proc miqt_exec_callback_cQStandardItem_multiData(vtbl: pointer, self: pointer, roleDataSpan: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QStandardItemVTable](vtbl)
  let self = QStandardItem(h: self)
...
proc miqt_exec_callback_cQStandardItem_typeX(vtbl: pointer, self: pointer): cint {.cdecl.} =
  let vtbl = cast[ptr QStandardItemVTable](vtbl)
  let self = QStandardItem(h: self)
  let virtualReturn = vtbl[].typeX(self)
  virtualReturn
...
proc operatorAssign*(self: gen_qstandarditemmodel_types.QStandardItem, other: gen_qstandarditemmodel_types.QStandardItem): void =
  fcQStandardItem_protectedbase_operatorAssign(self.h, other.h)
...
proc create*(T: type gen_qstandarditemmodel_types.QStandardItem,
  ...
  if not isNil(vtbl.multiData):
    vtbl[].vtbl.multiData = miqt_exec_callback_cQStandardItem_multiData
...
type QStandardItemModelmultiDataProc* = proc(self: QStandardItemModel, index: gen_qabstractitemmodel_types.QModelIndex, roleDataSpan: gen_qabstractitemmodel_types.QModelRoleDataSpan): void {.raises: [], gcsafe.}
...
type QStandardItemModelclearItemDataProc* = proc(self: QStandardItemModel, index: gen_qabstractitemmodel_types.QModelIndex): bool {.raises: [], gcsafe.}
...
type QStandardItemModelresetInternalDataProc* = proc(self: QStandardItemModel): void {.raises: [], gcsafe.}
...
type QStandardItemModelVTable* = object
  ...
  multiData*: QStandardItemModelmultiDataProc
  setData*: QStandardItemModelsetDataProc
  clearItemData*: QStandardItemModelclearItemDataProc
  ...
  resetInternalData*: QStandardItemModelresetInternalDataProc
...
proc miqt_exec_callback_cQStandardItemModel_multiData(vtbl: pointer, self: pointer, index: pointer, roleDataSpan: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QStandardItemModelVTable](vtbl)
  let self = QStandardItemModel(h: self)
  let slotval1 = gen_qabstractitemmodel_types.QModelIndex(h: index)
...
proc miqt_exec_callback_cQStandardItemModel_clearItemData(vtbl: pointer, self: pointer, index: pointer): bool {.cdecl.} =
  let vtbl = cast[ptr QStandardItemModelVTable](vtbl)
  let self = QStandardItemModel(h: self)
  let slotval1 = gen_qabstractitemmodel_types.QModelIndex(h: index)
  let virtualReturn = vtbl[].clearItemData(self, slotval1)
  virtualReturn
...
proc QStandardItemModelresetInternalData*(self: gen_qstandarditemmodel_types.QStandardItemModel, ): void =
  fcQStandardItemModel_virtualbase_resetInternalData(self.h)

proc miqt_exec_callback_cQStandardItemModel_resetInternalData(vtbl: pointer, self: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QStandardItemModelVTable](vtbl)
  let self = QStandardItemModel(h: self)
...
proc encodeData*(self: gen_qstandarditemmodel_types.QStandardItemModel, indexes: seq[gen_qabstractitemmodel_types.QModelIndex], stream: gen_qdatastream_types.QDataStream): void =
  var indexes_CArray = newSeq[pointer](len(indexes))
  for i in 0..<len(indexes):
    indexes_CArray[i] = indexes[i].h
...
proc changePersistentIndexList*(self: gen_qstandarditemmodel_types.QStandardItemModel, fromVal: seq[gen_qabstractitemmodel_types.QModelIndex], to: seq[gen_qabstractitemmodel_types.QModelIndex]): void =
...
proc create*(T: type gen_qstandarditemmodel_types.QStandardItemModel,
  ...
  if not isNil(vtbl.multiData):
    vtbl[].vtbl.multiData = miqt_exec_callback_cQStandardItemModel_multiData
  if not isNil(vtbl.setData):
    vtbl[].vtbl.setData = miqt_exec_callback_cQStandardItemModel_setData
  if not isNil(vtbl.clearItemData):
    vtbl[].vtbl.clearItemData = miqt_exec_callback_cQStandardItemModel_clearItemData
  ...
  if not isNil(vtbl.resetInternalData):
    vtbl[].vtbl.resetInternalData = miqt_exec_callback_cQStandardItemModel_resetInternalData
