...
proc multiData*(self: gen_qstandarditemmodel_types.QStandardItem, roleDataSpan: gen_qabstractitemmodel.QModelRoleDataSpan): void =
...
proc miqt_exec_callback_QStandardItem_data(self: ptr cQStandardItem, slot: int, role: cint): pointer {.exportc: "miqt_exec_callback_QStandardItem_data ".} =
  ...
  virtualReturn.h
proc QStandardItemmultiData*(self: gen_qstandarditemmodel_types.QStandardItem, roleDataSpan: gen_qabstractitemmodel.QModelRoleDataSpan): void =
  fQStandardItem_virtualbase_multiData(self.h, roleDataSpan.h)

type QStandardItemmultiDataProc* = proc(roleDataSpan: gen_qabstractitemmodel.QModelRoleDataSpan): void
...
proc multiData*(self: gen_qstandarditemmodel_types.QStandardItemModel, index: gen_qabstractitemmodel.QModelIndex, roleDataSpan: gen_qabstractitemmodel.QModelRoleDataSpan): void =
...
proc insertRow*(self: gen_qstandarditemmodel_types.QStandardItemModel, row: cint, parent: gen_qabstractitemmodel.QModelIndex): bool =
  fcQStandardItemModel_insertRow22(self.h, row, parent.h)

proc insertColumn*(self: gen_qstandarditemmodel_types.QStandardItemModel, column: cint, parent: gen_qabstractitemmodel.QModelIndex): bool =
...
proc miqt_exec_callback_QStandardItemModel_data(self: ptr cQStandardItemModel, slot: int, index: pointer, role: cint): pointer {.exportc: "miqt_exec_callback_QStandardItemModel_data ".} =
  ...
  virtualReturn.h
proc QStandardItemModelmultiData*(self: gen_qstandarditemmodel_types.QStandardItemModel, index: gen_qabstractitemmodel.QModelIndex, roleDataSpan: gen_qabstractitemmodel.QModelRoleDataSpan): void =
  fQStandardItemModel_virtualbase_multiData(self.h, index.h, roleDataSpan.h)

type QStandardItemModelmultiDataProc* = proc(index: gen_qabstractitemmodel.QModelIndex, roleDataSpan: gen_qabstractitemmodel.QModelRoleDataSpan): void
...
proc miqt_exec_callback_QStandardItemModel_setData(self: ptr cQStandardItemModel, slot: int, index: pointer, value: pointer, role: cint): bool {.exportc: "miqt_exec_callback_QStandardItemModel_setData ".} =
  ...
  virtualReturn
proc QStandardItemModelclearItemData*(self: gen_qstandarditemmodel_types.QStandardItemModel, index: gen_qabstractitemmodel.QModelIndex): bool =
  fQStandardItemModel_virtualbase_clearItemData(self.h, index.h)

type QStandardItemModelclearItemDataProc* = proc(index: gen_qabstractitemmodel.QModelIndex): bool
