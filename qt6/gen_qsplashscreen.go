...
func NewQSplashScreen5(screen *QScreen, pixmap *QPixmap) *QSplashScreen {
	...
	return newQSplashScreen(C.QSplashScreen_new5(screen.cPointer(), pixmap.cPointer()))
}
...
func NewQSplashScreen6(screen *QScreen, pixmap *QPixmap, f WindowType) *QSplashScreen {
	...
	return newQSplashScreen(C.QSplashScreen_new6(screen.cPointer(), pixmap.cPointer(), (C.int)(f)))
}
...
func (this *QSplashScreen) callVirtualBase_MetaObject() *QMetaObject {
	...
	return newQMetaObject(C.QSplashScreen_virtualbase_metaObject(unsafe.Pointer(this.h)))

}
func (this *QSplashScreen) OnMetaObject(slot func(super func() *QMetaObject) *QMetaObject) {
	ok := C.QSplashScreen_override_virtual_metaObject(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
...
func miqt_exec_callback_QSplashScreen_metaObject(self *C.QSplashScreen, cb C.intptr_t) *C.QMetaObject {
...
func (this *QSplashScreen) callVirtualBase_Metacast(param1 string) unsafe.Pointer {
	...
	return (unsafe.Pointer)(C.QSplashScreen_virtualbase_metacast(unsafe.Pointer(this.h), param1_Cstring))

}
func (this *QSplashScreen) OnMetacast(slot func(super func(param1 string) unsafe.Pointer, param1 string) unsafe.Pointer) {
	ok := C.QSplashScreen_override_virtual_metacast(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func miqt_exec_callback_QSplashScreen_metacast(self *C.QSplashScreen, cb C.intptr_t, param1 *C.const_char) unsafe.Pointer {
...
func miqt_exec_callback_QSplashScreen_enterEvent(self *C.QSplashScreen, cb C.intptr_t, event *C.QEnterEvent) {
...
func miqt_exec_callback_QSplashScreen_nativeEvent(self *C.QSplashScreen, cb C.intptr_t, eventType C.struct_miqt_string, message unsafe.Pointer, result *C.intptr_t) C.bool {
