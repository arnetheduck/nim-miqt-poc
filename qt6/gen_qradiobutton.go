...
func (this *QRadioButton) Metacall(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {
	return (int)(C.QRadioButton_metacall(this.h, (C.int)(param1), (C.int)(param2), param3))
}
...
func (this *QRadioButton) callVirtualBase_MetaObject() *QMetaObject {
	...
	return newQMetaObject(C.QRadioButton_virtualbase_metaObject(unsafe.Pointer(this.h)))

}
func (this *QRadioButton) OnmetaObject(slot func(super func() *QMetaObject) *QMetaObject) {
	ok := C.QRadioButton_override_virtual_metaObject(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
...
func miqt_exec_callback_QRadioButton_metaObject(self *C.QRadioButton, cb C.intptr_t) *C.QMetaObject {
...
func (this *QRadioButton) callVirtualBase_Metacast(param1 string) unsafe.Pointer {
	...
	return (unsafe.Pointer)(C.QRadioButton_virtualbase_metacast(unsafe.Pointer(this.h), param1_Cstring))

}
func (this *QRadioButton) Onmetacast(slot func(super func(param1 string) unsafe.Pointer, param1 string) unsafe.Pointer) {
	ok := C.QRadioButton_override_virtual_metacast(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func miqt_exec_callback_QRadioButton_metacast(self *C.QRadioButton, cb C.intptr_t, param1 *C.const_char) unsafe.Pointer {
...
func (this *QRadioButton) callVirtualBase_Metacall(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {

	return (int)(C.QRadioButton_virtualbase_metacall(unsafe.Pointer(this.h), (C.int)(param1), (C.int)(param2), param3))

}
func (this *QRadioButton) OnMetacall(slot func(super func(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int, param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int) {
	ok := C.QRadioButton_override_virtual_metacall(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}

//export miqt_exec_callback_QRadioButton_metacall
func miqt_exec_callback_QRadioButton_metacall(self *C.QRadioButton, cb C.intptr_t, param1 C.int, param2 C.int, param3 unsafe.Pointer) C.int {
	...
	virtualReturn := gofunc((&QRadioButton{h: self}).callVirtualBase_Metacall, slotval1, slotval2, slotval3)
