...
void miqt_exec_callback_QCompleter_activated_release(intptr_t);
void miqt_exec_callback_QCompleter_activatedWithIndex(intptr_t, QModelIndex*);
void miqt_exec_callback_QCompleter_activatedWithIndex_release(intptr_t);
void miqt_exec_callback_QCompleter_highlighted(intptr_t, struct miqt_string);
void miqt_exec_callback_QCompleter_highlighted_release(intptr_t);
void miqt_exec_callback_QCompleter_highlightedWithIndex(intptr_t, QModelIndex*);
void miqt_exec_callback_QCompleter_highlightedWithIndex_release(intptr_t);
#ifdef __cplusplus
} /* extern C */
#endif
...
public:
	...
	MiqtVirtualQCompleter(struct QCompleter_VTable* vtbl): QCompleter(), vtbl(vtbl) {};
	MiqtVirtualQCompleter(struct QCompleter_VTable* vtbl, QAbstractItemModel* model): QCompleter(model), vtbl(vtbl) {};
	MiqtVirtualQCompleter(struct QCompleter_VTable* vtbl, const QStringList& completions): QCompleter(completions), vtbl(vtbl) {};
	MiqtVirtualQCompleter(struct QCompleter_VTable* vtbl, QObject* parent): QCompleter(parent), vtbl(vtbl) {};
	MiqtVirtualQCompleter(struct QCompleter_VTable* vtbl, QAbstractItemModel* model, QObject* parent): QCompleter(model, parent), vtbl(vtbl) {};
	MiqtVirtualQCompleter(struct QCompleter_VTable* vtbl, const QStringList& completions, QObject* parent): QCompleter(completions, parent), vtbl(vtbl) {};

	virtual ~MiqtVirtualQCompleter() override { if(vtbl->destructor) vtbl->destructor(vtbl, this); }
	...
	QMetaObject* virtualbase_metaObject() const {
		...
		return (QMetaObject*) QCompleter::metaObject();
	...
	int virtualbase_metacall(int param1, int param2, void** param3) {
		...
		return QCompleter::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
QCompleter* QCompleter_new6(struct QCompleter_VTable* vtbl, struct miqt_array /* of struct miqt_string */  completions, QObject* parent) {
	...
	return new MiqtVirtualQCompleter(vtbl, completions_QList, parent);
}
...
void QCompleter_connect_activated(QCompleter* self, intptr_t slot) {
	struct caller {
		...
		~caller() { miqt_exec_callback_QCompleter_activated_release(slot); }
	};
	MiqtVirtualQCompleter::connect(self, static_cast<void (QCompleter::*)(const QString&)>(&QCompleter::activated), self, caller{slot});
}
...
void QCompleter_connect_activatedWithIndex(QCompleter* self, intptr_t slot) {
	struct caller {
		...
		caller(const caller &) = delete;
		caller &operator=(const caller &) = delete;
		~caller() { miqt_exec_callback_QCompleter_activatedWithIndex_release(slot); }
	};
	MiqtVirtualQCompleter::connect(self, static_cast<void (QCompleter::*)(const QModelIndex&)>(&QCompleter::activated), self, caller{slot});
}
...
void QCompleter_connect_highlighted(QCompleter* self, intptr_t slot) {
	struct caller {
		...
		caller(const caller &) = delete;
		caller &operator=(const caller &) = delete;
		~caller() { miqt_exec_callback_QCompleter_highlighted_release(slot); }
	};
	MiqtVirtualQCompleter::connect(self, static_cast<void (QCompleter::*)(const QString&)>(&QCompleter::highlighted), self, caller{slot});
}
...
void QCompleter_connect_highlightedWithIndex(QCompleter* self, intptr_t slot) {
	struct caller {
		...
		caller(const caller &) = delete;
		caller &operator=(const caller &) = delete;
		~caller() { miqt_exec_callback_QCompleter_highlightedWithIndex_release(slot); }
	};
	MiqtVirtualQCompleter::connect(self, static_cast<void (QCompleter::*)(const QModelIndex&)>(&QCompleter::highlighted), self, caller{slot});
}
...
QMetaObject* QCompleter_virtualbase_metaObject(const void* self) {
	return ( (const MiqtVirtualQCompleter*)(self) )->virtualbase_metaObject();
}

void* QCompleter_virtualbase_metacast(void* self, const char* param1) {
	return ( (MiqtVirtualQCompleter*)(self) )->virtualbase_metacast(param1);
}

int QCompleter_virtualbase_metacall(void* self, int param1, int param2, void** param3) {
	return ( (MiqtVirtualQCompleter*)(self) )->virtualbase_metacall(param1, param2, param3);
}
