...
func miqt_exec_callback_QFontDialog_metaObject(self *C.QFontDialog, cb C.intptr_t) *C.QMetaObject {
...
func miqt_exec_callback_QFontDialog_metacast(self *C.QFontDialog, cb C.intptr_t, param1 *C.const_char) unsafe.Pointer {
