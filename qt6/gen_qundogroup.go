...
func (this *QUndoGroup) callVirtualBase_MetaObject() *QMetaObject {
	...
	return newQMetaObject(C.QUndoGroup_virtualbase_metaObject(unsafe.Pointer(this.h)))

}
func (this *QUndoGroup) OnmetaObject(slot func(super func() *QMetaObject) *QMetaObject) {
	ok := C.QUndoGroup_override_virtual_metaObject(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
...
func miqt_exec_callback_QUndoGroup_metaObject(self *C.QUndoGroup, cb C.intptr_t) *C.QMetaObject {
...
func (this *QUndoGroup) callVirtualBase_Metacast(param1 string) unsafe.Pointer {
	...
	return (unsafe.Pointer)(C.QUndoGroup_virtualbase_metacast(unsafe.Pointer(this.h), param1_Cstring))

}
func (this *QUndoGroup) Onmetacast(slot func(super func(param1 string) unsafe.Pointer, param1 string) unsafe.Pointer) {
	ok := C.QUndoGroup_override_virtual_metacast(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func miqt_exec_callback_QUndoGroup_metacast(self *C.QUndoGroup, cb C.intptr_t, param1 *C.const_char) unsafe.Pointer {
