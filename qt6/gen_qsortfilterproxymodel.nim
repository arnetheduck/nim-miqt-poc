...
proc fcQSortFilterProxyModel_virtualbase_clearItemData(self: pointer, index: pointer): bool {.importc: "QSortFilterProxyModel_virtualbase_clearItemData".}
...
proc fcQSortFilterProxyModel_virtualbase_multiData(self: pointer, index: pointer, roleDataSpan: pointer): void {.importc: "QSortFilterProxyModel_virtualbase_multiData".}
proc fcQSortFilterProxyModel_virtualbase_resetInternalData(self: pointer, ): void {.importc: "QSortFilterProxyModel_virtualbase_resetInternalData".}
...
type QSortFilterProxyModelclearItemDataProc* = proc(self: QSortFilterProxyModel, index: gen_qabstractitemmodel_types.QModelIndex): bool {.raises: [], gcsafe.}
...
type QSortFilterProxyModelmultiDataProc* = proc(self: QSortFilterProxyModel, index: gen_qabstractitemmodel_types.QModelIndex, roleDataSpan: gen_qabstractitemmodel_types.QModelRoleDataSpan): void {.raises: [], gcsafe.}
type QSortFilterProxyModelresetInternalDataProc* = proc(self: QSortFilterProxyModel): void {.raises: [], gcsafe.}
...
type QSortFilterProxyModelVTable* = object
  ...
  clearItemData*: QSortFilterProxyModelclearItemDataProc
  ...
  multiData*: QSortFilterProxyModelmultiDataProc
  resetInternalData*: QSortFilterProxyModelresetInternalDataProc
...
proc QSortFilterProxyModelclearItemData*(self: gen_qsortfilterproxymodel_types.QSortFilterProxyModel, index: gen_qabstractitemmodel_types.QModelIndex): bool =
  fcQSortFilterProxyModel_virtualbase_clearItemData(self.h, index.h)

proc miqt_exec_callback_cQSortFilterProxyModel_clearItemData(vtbl: pointer, self: pointer, index: pointer): bool {.cdecl.} =
  let vtbl = cast[ptr QSortFilterProxyModelVTable](vtbl)
  let self = QSortFilterProxyModel(h: self)
  let slotval1 = gen_qabstractitemmodel_types.QModelIndex(h: index)
...
proc QSortFilterProxyModelmultiData*(self: gen_qsortfilterproxymodel_types.QSortFilterProxyModel, index: gen_qabstractitemmodel_types.QModelIndex, roleDataSpan: gen_qabstractitemmodel_types.QModelRoleDataSpan): void =
  fcQSortFilterProxyModel_virtualbase_multiData(self.h, index.h, roleDataSpan.h)

proc miqt_exec_callback_cQSortFilterProxyModel_multiData(vtbl: pointer, self: pointer, index: pointer, roleDataSpan: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QSortFilterProxyModelVTable](vtbl)
  let self = QSortFilterProxyModel(h: self)
  let slotval1 = gen_qabstractitemmodel_types.QModelIndex(h: index)
...
proc QSortFilterProxyModelresetInternalData*(self: gen_qsortfilterproxymodel_types.QSortFilterProxyModel, ): void =
  fcQSortFilterProxyModel_virtualbase_resetInternalData(self.h)

proc miqt_exec_callback_cQSortFilterProxyModel_resetInternalData(vtbl: pointer, self: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QSortFilterProxyModelVTable](vtbl)
  let self = QSortFilterProxyModel(h: self)
...
proc create*(T: type gen_qsortfilterproxymodel_types.QSortFilterProxyModel,
  ...
  if not isNil(vtbl.clearItemData):
    vtbl[].vtbl.clearItemData = miqt_exec_callback_cQSortFilterProxyModel_clearItemData
  ...
  if not isNil(vtbl.multiData):
    vtbl[].vtbl.multiData = miqt_exec_callback_cQSortFilterProxyModel_multiData
  if not isNil(vtbl.resetInternalData):
    vtbl[].vtbl.resetInternalData = miqt_exec_callback_cQSortFilterProxyModel_resetInternalData
