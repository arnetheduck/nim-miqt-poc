...
func (this *QGraphicsScene) callVirtualBase_MetaObject() *QMetaObject {
	...
	return newQMetaObject(C.QGraphicsScene_virtualbase_metaObject(unsafe.Pointer(this.h)))

}
func (this *QGraphicsScene) OnmetaObject(slot func(super func() *QMetaObject) *QMetaObject) {
	ok := C.QGraphicsScene_override_virtual_metaObject(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
...
func miqt_exec_callback_QGraphicsScene_metaObject(self *C.QGraphicsScene, cb C.intptr_t) *C.QMetaObject {
...
func (this *QGraphicsScene) callVirtualBase_Metacast(param1 string) unsafe.Pointer {
	...
	return (unsafe.Pointer)(C.QGraphicsScene_virtualbase_metacast(unsafe.Pointer(this.h), param1_Cstring))

}
func (this *QGraphicsScene) Onmetacast(slot func(super func(param1 string) unsafe.Pointer, param1 string) unsafe.Pointer) {
	ok := C.QGraphicsScene_override_virtual_metacast(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func miqt_exec_callback_QGraphicsScene_metacast(self *C.QGraphicsScene, cb C.intptr_t, param1 *C.const_char) unsafe.Pointer {
...
func (this *QGraphicsScene) OnFocusNextPrevChild(slot func(super func(next bool) bool, next bool) bool) {
	ok := C.QGraphicsScene_override_virtual_focusNextPrevChild(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
