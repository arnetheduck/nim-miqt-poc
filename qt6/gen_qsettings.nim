...
proc beginGroup*(self: QSettings, prefix: gen_qanystringview.QAnyStringView): void =
...
proc beginReadArray*(self: QSettings, prefix: gen_qanystringview.QAnyStringView): cint =

  fcQSettings_beginReadArray(self.h, prefix.h)

proc beginWriteArray*(self: QSettings, prefix: gen_qanystringview.QAnyStringView): void =
...
proc setValue*(self: QSettings, key: gen_qanystringview.QAnyStringView, value: gen_qvariant.QVariant): void =

  fcQSettings_setValue(self.h, key.h, value.h)

proc value*(self: QSettings, key: gen_qanystringview.QAnyStringView, defaultValue: gen_qvariant.QVariant): gen_qvariant.QVariant =

  gen_qvariant.QVariant(h: fcQSettings_value(self.h, key.h, defaultValue.h))

proc valueWithKey*(self: QSettings, key: gen_qanystringview.QAnyStringView): gen_qvariant.QVariant =

  gen_qvariant.QVariant(h: fcQSettings_valueWithKey(self.h, key.h))

proc remove*(self: QSettings, key: gen_qanystringview.QAnyStringView): void =

  fcQSettings_remove(self.h, key.h)

proc contains*(self: QSettings, key: gen_qanystringview.QAnyStringView): bool =
...
proc beginWriteArray2*(self: QSettings, prefix: gen_qanystringview.QAnyStringView, size: cint): void =
