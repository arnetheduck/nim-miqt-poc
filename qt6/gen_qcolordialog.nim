...
proc miqt_exec_callback_cQColorDialog_nativeEvent(vtbl: pointer, self: pointer, eventType: struct_miqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let vtbl = cast[ptr QColorDialogVTable](vtbl)
  let self = QColorDialog(h: self)
