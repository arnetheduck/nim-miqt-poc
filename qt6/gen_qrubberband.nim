...
proc miqt_exec_callback_QRubberBand_moveEvent(self: ptr cQRubberBand, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QRubberBand_moveEvent ".} =
  ...
  nimfunc[](superCall, slotval1)
proc callVirtualBase_initStyleOption(self: QRubberBand, option: gen_qstyleoption.QStyleOptionRubberBand): void =


  fQRubberBand_virtualbase_initStyleOption(self.h, option.h)

type QRubberBandinitStyleOptionBase* = proc(option: gen_qstyleoption.QStyleOptionRubberBand): void
proc oninitStyleOption*(self: QRubberBand, slot: proc(super: QRubberBandinitStyleOptionBase, option: gen_qstyleoption.QStyleOptionRubberBand): void) =
  # TODO check subclass
  type Cb = proc(super: QRubberBandinitStyleOptionBase, option: gen_qstyleoption.QStyleOptionRubberBand): void
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QRubberBand_initStyleOption(self: ptr cQRubberBand, slot: int, option: pointer): void {.exportc: "miqt_exec_callback_QRubberBand_initStyleOption ".} =
  type Cb = proc(super: QRubberBandinitStyleOptionBase, option: gen_qstyleoption.QStyleOptionRubberBand): void
  var nimfunc = cast[ptr Cb](cast[pointer](slot))
  proc superCall(option: gen_qstyleoption.QStyleOptionRubberBand): auto =
    callVirtualBase_initStyleOption(QRubberBand(h: self), option)
  let slotval1 = gen_qstyleoption.QStyleOptionRubberBand(h: option)
...
proc miqt_exec_callback_QRubberBand_focusOutEvent(self: ptr cQRubberBand, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QRubberBand_focusOutEvent ".} =
  ...
  nimfunc[](superCall, slotval1)
proc callVirtualBase_enterEvent(self: QRubberBand, event: gen_qevent.QEnterEvent): void =


  fQRubberBand_virtualbase_enterEvent(self.h, event.h)

type QRubberBandenterEventBase* = proc(event: gen_qevent.QEnterEvent): void
proc onenterEvent*(self: QRubberBand, slot: proc(super: QRubberBandenterEventBase, event: gen_qevent.QEnterEvent): void) =
  # TODO check subclass
  type Cb = proc(super: QRubberBandenterEventBase, event: gen_qevent.QEnterEvent): void
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QRubberBand_hideEvent(self: ptr cQRubberBand, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QRubberBand_hideEvent ".} =
  ...
  nimfunc[](superCall, slotval1)
proc callVirtualBase_nativeEvent(self: QRubberBand, eventType: seq[byte], message: pointer, resultVal: ptr uint): bool =
...
type QRubberBandnativeEventBase* = proc(eventType: seq[byte], message: pointer, resultVal: ptr uint): bool
proc onnativeEvent*(self: QRubberBand, slot: proc(super: QRubberBandnativeEventBase, eventType: seq[byte], message: pointer, resultVal: ptr uint): bool) =
  # TODO check subclass
  type Cb = proc(super: QRubberBandnativeEventBase, eventType: seq[byte], message: pointer, resultVal: ptr uint): bool
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
