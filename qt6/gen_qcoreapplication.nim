...
proc fcQCoreApplication_connect_installNativeEventFilter(self: pointer, slot: int) {.importc: "QCoreApplication_connect_installNativeEventFilter".}
...
proc fcQCoreApplication_connect_removeNativeEventFilter(self: pointer, slot: int) {.importc: "QCoreApplication_connect_removeNativeEventFilter".}
...
proc oninstallNativeEventFilter*(self: gen_qcoreapplication_types.QCoreApplication, slot: QCoreApplicationinstallNativeEventFilterSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQCoreApplication_connect_installNativeEventFilter(self.h, cast[int](addr tmp[]))
...
proc onremoveNativeEventFilter*(self: gen_qcoreapplication_types.QCoreApplication, slot: QCoreApplicationremoveNativeEventFilterSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQCoreApplication_connect_removeNativeEventFilter(self.h, cast[int](addr tmp[]))
