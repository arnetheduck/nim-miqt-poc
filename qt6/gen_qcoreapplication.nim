...
type QCoreApplicationinstallNativeEventFilterSlot* = proc(filterObj: gen_qabstractnativeeventfilter.QAbstractNativeEventFilter)
...
type QCoreApplicationremoveNativeEventFilterSlot* = proc(filterObj: gen_qabstractnativeeventfilter.QAbstractNativeEventFilter)
