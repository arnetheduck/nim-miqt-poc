...
proc map2*(self: gen_qmatrix4x4_types.QMatrix4x4, point: gen_qvectornd.QVector3D): gen_qvectornd.QVector3D =
...
proc map3*(self: gen_qmatrix4x4_types.QMatrix4x4, point: gen_qvectornd.QVector4D): gen_qvectornd.QVector4D =
