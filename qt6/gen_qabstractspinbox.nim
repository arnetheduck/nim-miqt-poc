...
proc miqt_exec_callback_QAbstractSpinBox_showEvent(self: ptr cQAbstractSpinBox, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QAbstractSpinBox_showEvent ".} =
  ...
  nimfunc[](superCall, slotval1)
proc callVirtualBase_initStyleOption(self: QAbstractSpinBox, option: gen_qstyleoption.QStyleOptionSpinBox): void =


  fQAbstractSpinBox_virtualbase_initStyleOption(self.h, option.h)

type QAbstractSpinBoxinitStyleOptionBase* = proc(option: gen_qstyleoption.QStyleOptionSpinBox): void
proc oninitStyleOption*(self: QAbstractSpinBox, slot: proc(super: QAbstractSpinBoxinitStyleOptionBase, option: gen_qstyleoption.QStyleOptionSpinBox): void) =
  # TODO check subclass
  type Cb = proc(super: QAbstractSpinBoxinitStyleOptionBase, option: gen_qstyleoption.QStyleOptionSpinBox): void
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QAbstractSpinBox_initStyleOption(self: ptr cQAbstractSpinBox, slot: int, option: pointer): void {.exportc: "miqt_exec_callback_QAbstractSpinBox_initStyleOption ".} =
  ...
  proc superCall(option: gen_qstyleoption.QStyleOptionSpinBox): auto =
    callVirtualBase_initStyleOption(QAbstractSpinBox(h: self), option)
...
proc miqt_exec_callback_QAbstractSpinBox_mouseDoubleClickEvent(self: ptr cQAbstractSpinBox, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QAbstractSpinBox_mouseDoubleClickEvent ".} =
  ...
  nimfunc[](superCall, slotval1)
proc callVirtualBase_enterEvent(self: QAbstractSpinBox, event: gen_qevent.QEnterEvent): void =


  fQAbstractSpinBox_virtualbase_enterEvent(self.h, event.h)

type QAbstractSpinBoxenterEventBase* = proc(event: gen_qevent.QEnterEvent): void
proc onenterEvent*(self: QAbstractSpinBox, slot: proc(super: QAbstractSpinBoxenterEventBase, event: gen_qevent.QEnterEvent): void) =
  # TODO check subclass
  type Cb = proc(super: QAbstractSpinBoxenterEventBase, event: gen_qevent.QEnterEvent): void
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QAbstractSpinBox_dropEvent(self: ptr cQAbstractSpinBox, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QAbstractSpinBox_dropEvent ".} =
  ...
  nimfunc[](superCall, slotval1)
proc callVirtualBase_nativeEvent(self: QAbstractSpinBox, eventType: seq[byte], message: pointer, resultVal: ptr uint): bool =
...
type QAbstractSpinBoxnativeEventBase* = proc(eventType: seq[byte], message: pointer, resultVal: ptr uint): bool
proc onnativeEvent*(self: QAbstractSpinBox, slot: proc(super: QAbstractSpinBoxnativeEventBase, eventType: seq[byte], message: pointer, resultVal: ptr uint): bool) =
  # TODO check subclass
  type Cb = proc(super: QAbstractSpinBoxnativeEventBase, eventType: seq[byte], message: pointer, resultVal: ptr uint): bool
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
