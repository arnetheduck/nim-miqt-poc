...
proc fcQAbstractSpinBox_virtualbase_initStyleOption(self: pointer, option: pointer): void {.importc: "QAbstractSpinBox_virtualbase_initStyleOption".}
...
proc fcQAbstractSpinBox_virtualbase_nativeEvent(self: pointer, eventType: struct_miqt_string, message: pointer, resultVal: ptr uint): bool {.importc: "QAbstractSpinBox_virtualbase_nativeEvent".}
...
type QAbstractSpinBoxinitStyleOptionProc* = proc(self: QAbstractSpinBox, option: gen_qstyleoption_types.QStyleOptionSpinBox): void {.raises: [], gcsafe.}
...
type QAbstractSpinBoxenterEventProc* = proc(self: QAbstractSpinBox, event: gen_qevent_types.QEnterEvent): void {.raises: [], gcsafe.}
...
type QAbstractSpinBoxnativeEventProc* = proc(self: QAbstractSpinBox, eventType: seq[byte], message: pointer, resultVal: ptr uint): bool {.raises: [], gcsafe.}
...
type QAbstractSpinBoxVTable* = object
  ...
  initStyleOption*: QAbstractSpinBoxinitStyleOptionProc
...
proc QAbstractSpinBoxinitStyleOption*(self: gen_qabstractspinbox_types.QAbstractSpinBox, option: gen_qstyleoption_types.QStyleOptionSpinBox): void =
  fcQAbstractSpinBox_virtualbase_initStyleOption(self.h, option.h)

proc miqt_exec_callback_cQAbstractSpinBox_initStyleOption(vtbl: pointer, self: pointer, option: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QAbstractSpinBoxVTable](vtbl)
  let self = QAbstractSpinBox(h: self)
...
proc miqt_exec_callback_cQAbstractSpinBox_stepEnabled(vtbl: pointer, self: pointer): cint {.cdecl.} =
  let vtbl = cast[ptr QAbstractSpinBoxVTable](vtbl)
  let self = QAbstractSpinBox(h: self)
  let virtualReturn = vtbl[].stepEnabled(self)
  cint(virtualReturn)
...
proc miqt_exec_callback_cQAbstractSpinBox_nativeEvent(vtbl: pointer, self: pointer, eventType: struct_miqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let vtbl = cast[ptr QAbstractSpinBoxVTable](vtbl)
  let self = QAbstractSpinBox(h: self)
...
proc lineEdit*(self: gen_qabstractspinbox_types.QAbstractSpinBox, ): gen_qlineedit_types.QLineEdit =
  gen_qlineedit_types.QLineEdit(h: fcQAbstractSpinBox_protectedbase_lineEdit(self.h))
...
proc sender*(self: gen_qabstractspinbox_types.QAbstractSpinBox, ): gen_qobject_types.QObject =
  gen_qobject_types.QObject(h: fcQAbstractSpinBox_protectedbase_sender(self.h))
...
proc create*(T: type gen_qabstractspinbox_types.QAbstractSpinBox,
  ...
  if not isNil(vtbl.initStyleOption):
    vtbl[].vtbl.initStyleOption = miqt_exec_callback_cQAbstractSpinBox_initStyleOption
