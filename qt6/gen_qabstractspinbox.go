...
func (this *QAbstractSpinBox) Metacall(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {
	return (int)(C.QAbstractSpinBox_metacall(this.h, (C.int)(param1), (C.int)(param2), param3))
}
...
func (this *QAbstractSpinBox) callVirtualBase_MetaObject() *QMetaObject {
	...
	return newQMetaObject(C.QAbstractSpinBox_virtualbase_metaObject(unsafe.Pointer(this.h)))

}
func (this *QAbstractSpinBox) OnMetaObject(slot func(super func() *QMetaObject) *QMetaObject) {
	ok := C.QAbstractSpinBox_override_virtual_metaObject(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
...
func miqt_exec_callback_QAbstractSpinBox_metaObject(self *C.QAbstractSpinBox, cb C.intptr_t) *C.QMetaObject {
...
func (this *QAbstractSpinBox) callVirtualBase_Metacast(param1 string) unsafe.Pointer {
	...
	return (unsafe.Pointer)(C.QAbstractSpinBox_virtualbase_metacast(unsafe.Pointer(this.h), param1_Cstring))

}
func (this *QAbstractSpinBox) OnMetacast(slot func(super func(param1 string) unsafe.Pointer, param1 string) unsafe.Pointer) {
	ok := C.QAbstractSpinBox_override_virtual_metacast(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func miqt_exec_callback_QAbstractSpinBox_metacast(self *C.QAbstractSpinBox, cb C.intptr_t, param1 *C.const_char) unsafe.Pointer {
...
func (this *QAbstractSpinBox) callVirtualBase_Metacall(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {

	return (int)(C.QAbstractSpinBox_virtualbase_metacall(unsafe.Pointer(this.h), (C.int)(param1), (C.int)(param2), param3))

}
func (this *QAbstractSpinBox) OnMetacall(slot func(super func(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int, param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int) {
	ok := C.QAbstractSpinBox_override_virtual_metacall(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}

//export miqt_exec_callback_QAbstractSpinBox_metacall
func miqt_exec_callback_QAbstractSpinBox_metacall(self *C.QAbstractSpinBox, cb C.intptr_t, param1 C.int, param2 C.int, param3 unsafe.Pointer) C.int {
	...
	virtualReturn := gofunc((&QAbstractSpinBox{h: self}).callVirtualBase_Metacall, slotval1, slotval2, slotval3)
...
func (this *QAbstractSpinBox) OnInitStyleOption(slot func(super func(option *QStyleOptionSpinBox), option *QStyleOptionSpinBox)) {
	ok := C.QAbstractSpinBox_override_virtual_initStyleOption(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
