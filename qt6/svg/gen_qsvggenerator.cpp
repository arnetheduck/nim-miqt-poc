...
public:
	...
	MiqtVirtualQSvgGenerator(struct QSvgGenerator_VTable* vtbl): QSvgGenerator(), vtbl(vtbl) {};

	virtual ~MiqtVirtualQSvgGenerator() override { if(vtbl->destructor) vtbl->destructor(vtbl, this); }
...
QSvgGenerator* QSvgGenerator_new(struct QSvgGenerator_VTable* vtbl) {
	return new MiqtVirtualQSvgGenerator(vtbl);
}
