...
proc miqt_exec_callback_QMdiSubWindow_keyReleaseEvent(self: ptr cQMdiSubWindow, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QMdiSubWindow_keyReleaseEvent ".} =
  ...
  nimfunc[](superCall, slotval1)
proc callVirtualBase_enterEvent(self: QMdiSubWindow, event: gen_qevent.QEnterEvent): void =


  fQMdiSubWindow_virtualbase_enterEvent(self.h, event.h)

type QMdiSubWindowenterEventBase* = proc(event: gen_qevent.QEnterEvent): void
proc onenterEvent*(self: QMdiSubWindow, slot: proc(super: QMdiSubWindowenterEventBase, event: gen_qevent.QEnterEvent): void) =
  # TODO check subclass
  type Cb = proc(super: QMdiSubWindowenterEventBase, event: gen_qevent.QEnterEvent): void
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QMdiSubWindow_dropEvent(self: ptr cQMdiSubWindow, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QMdiSubWindow_dropEvent ".} =
  ...
  nimfunc[](superCall, slotval1)
proc callVirtualBase_nativeEvent(self: QMdiSubWindow, eventType: seq[byte], message: pointer, resultVal: ptr uint): bool =
...
type QMdiSubWindownativeEventBase* = proc(eventType: seq[byte], message: pointer, resultVal: ptr uint): bool
proc onnativeEvent*(self: QMdiSubWindow, slot: proc(super: QMdiSubWindownativeEventBase, eventType: seq[byte], message: pointer, resultVal: ptr uint): bool) =
  # TODO check subclass
  type Cb = proc(super: QMdiSubWindownativeEventBase, eventType: seq[byte], message: pointer, resultVal: ptr uint): bool
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
