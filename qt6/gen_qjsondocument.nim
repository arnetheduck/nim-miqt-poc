...
proc operatorSubscriptWithQsizetype*(self: gen_qjsondocument_types.QJsonDocument, i: int64): gen_qjsonvalue.QJsonValue =
...
proc toJson1*(self: gen_qjsondocument_types.QJsonDocument, format: cint): seq[byte] =
