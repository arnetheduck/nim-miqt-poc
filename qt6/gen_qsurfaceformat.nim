...
const
  ...
  QSurfaceFormatProtectedContent* = 16
...
proc setOption*(self: QSurfaceFormat, option: QSurfaceFormatFormatOption): void =

  fcQSurfaceFormat_setOption(self.h, cint(option))

proc testOption*(self: QSurfaceFormat, option: QSurfaceFormatFormatOption): bool =
...
proc colorSpace*(self: QSurfaceFormat, ): gen_qcolorspace.QColorSpace =

  gen_qcolorspace.QColorSpace(h: fcQSurfaceFormat_colorSpace(self.h))

proc setColorSpace*(self: QSurfaceFormat, colorSpace: gen_qcolorspace.QColorSpace): void =

  fcQSurfaceFormat_setColorSpace(self.h, colorSpace.h)

proc setColorSpaceWithColorSpace*(self: QSurfaceFormat, colorSpace: QSurfaceFormatColorSpace): void =
