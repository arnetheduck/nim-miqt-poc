...
func (this *QSocketNotifier) Metacall(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {
	return (int)(C.QSocketNotifier_metacall(this.h, (C.int)(param1), (C.int)(param2), param3))
}
...
func (this *QSocketNotifier) IsValid() bool {
	return (bool)(C.QSocketNotifier_isValid(this.h))
}
...
func miqt_exec_callback_QSocketNotifier_metaObject(self *C.QSocketNotifier, cb C.intptr_t) *C.QMetaObject {
...
func miqt_exec_callback_QSocketNotifier_metacast(self *C.QSocketNotifier, cb C.intptr_t, param1 *C.const_char) unsafe.Pointer {
...
func (this *QSocketNotifier) callVirtualBase_Metacall(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {

	return (int)(C.QSocketNotifier_virtualbase_metacall(unsafe.Pointer(this.h), (C.int)(param1), (C.int)(param2), param3))

}
func (this *QSocketNotifier) OnMetacall(slot func(super func(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int, param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int) {
	ok := C.QSocketNotifier_override_virtual_metacall(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}

//export miqt_exec_callback_QSocketNotifier_metacall
func miqt_exec_callback_QSocketNotifier_metacall(self *C.QSocketNotifier, cb C.intptr_t, param1 C.int, param2 C.int, param3 unsafe.Pointer) C.int {
	...
	virtualReturn := gofunc((&QSocketNotifier{h: self}).callVirtualBase_Metacall, slotval1, slotval2, slotval3)
