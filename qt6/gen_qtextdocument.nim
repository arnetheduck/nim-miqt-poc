...
proc findWithExpr*(self: gen_qtextdocument_types.QTextDocument, expr: gen_qregularexpression.QRegularExpression): gen_qtextcursor.QTextCursor =

  gen_qtextcursor.QTextCursor(h: fcQTextDocument_findWithExpr(self.h, expr.h))

proc find3*(self: gen_qtextdocument_types.QTextDocument, expr: gen_qregularexpression.QRegularExpression, cursor: gen_qtextcursor.QTextCursor): gen_qtextcursor.QTextCursor =
...
proc find23*(self: gen_qtextdocument_types.QTextDocument, expr: gen_qregularexpression.QRegularExpression, fromVal: cint): gen_qtextcursor.QTextCursor =

  gen_qtextcursor.QTextCursor(h: fcQTextDocument_find23(self.h, expr.h, fromVal))

proc find34*(self: gen_qtextdocument_types.QTextDocument, expr: gen_qregularexpression.QRegularExpression, fromVal: cint, options: cint): gen_qtextcursor.QTextCursor =

  gen_qtextcursor.QTextCursor(h: fcQTextDocument_find34(self.h, expr.h, fromVal, cint(options)))

proc find35*(self: gen_qtextdocument_types.QTextDocument, expr: gen_qregularexpression.QRegularExpression, cursor: gen_qtextcursor.QTextCursor, options: cint): gen_qtextcursor.QTextCursor =
