...
proc miqt_exec_callback_QToolBar_event(self: ptr cQToolBar, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QToolBar_event ".} =
  ...
  virtualReturn
proc callVirtualBase_initStyleOption(self: QToolBar, option: gen_qstyleoption.QStyleOptionToolBar): void =


  fQToolBar_virtualbase_initStyleOption(self.h, option.h)

type QToolBarinitStyleOptionBase* = proc(option: gen_qstyleoption.QStyleOptionToolBar): void
proc oninitStyleOption*(self: QToolBar, slot: proc(super: QToolBarinitStyleOptionBase, option: gen_qstyleoption.QStyleOptionToolBar): void) =
  # TODO check subclass
  type Cb = proc(super: QToolBarinitStyleOptionBase, option: gen_qstyleoption.QStyleOptionToolBar): void
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QToolBar_initStyleOption(self: ptr cQToolBar, slot: int, option: pointer): void {.exportc: "miqt_exec_callback_QToolBar_initStyleOption ".} =
  type Cb = proc(super: QToolBarinitStyleOptionBase, option: gen_qstyleoption.QStyleOptionToolBar): void
  var nimfunc = cast[ptr Cb](cast[pointer](slot))
  proc superCall(option: gen_qstyleoption.QStyleOptionToolBar): auto =
    callVirtualBase_initStyleOption(QToolBar(h: self), option)
  let slotval1 = gen_qstyleoption.QStyleOptionToolBar(h: option)
...
proc miqt_exec_callback_QToolBar_focusOutEvent(self: ptr cQToolBar, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QToolBar_focusOutEvent ".} =
  ...
  nimfunc[](superCall, slotval1)
proc callVirtualBase_enterEvent(self: QToolBar, event: gen_qevent.QEnterEvent): void =


  fQToolBar_virtualbase_enterEvent(self.h, event.h)

type QToolBarenterEventBase* = proc(event: gen_qevent.QEnterEvent): void
proc onenterEvent*(self: QToolBar, slot: proc(super: QToolBarenterEventBase, event: gen_qevent.QEnterEvent): void) =
  # TODO check subclass
  type Cb = proc(super: QToolBarenterEventBase, event: gen_qevent.QEnterEvent): void
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QToolBar_hideEvent(self: ptr cQToolBar, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QToolBar_hideEvent ".} =
  ...
  nimfunc[](superCall, slotval1)
proc callVirtualBase_nativeEvent(self: QToolBar, eventType: seq[byte], message: pointer, resultVal: ptr uint): bool =
...
type QToolBarnativeEventBase* = proc(eventType: seq[byte], message: pointer, resultVal: ptr uint): bool
proc onnativeEvent*(self: QToolBar, slot: proc(super: QToolBarnativeEventBase, eventType: seq[byte], message: pointer, resultVal: ptr uint): bool) =
  # TODO check subclass
  type Cb = proc(super: QToolBarnativeEventBase, eventType: seq[byte], message: pointer, resultVal: ptr uint): bool
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
