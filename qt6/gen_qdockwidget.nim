...
proc miqt_exec_callback_QDockWidget_event(self: ptr cQDockWidget, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QDockWidget_event ".} =
  ...
  virtualReturn
proc QDockWidgetinitStyleOption*(self: gen_qdockwidget_types.QDockWidget, option: gen_qstyleoption.QStyleOptionDockWidget): void =

  fQDockWidget_virtualbase_initStyleOption(self.h, option.h)

type QDockWidgetinitStyleOptionProc* = proc(option: gen_qstyleoption.QStyleOptionDockWidget): void
...
proc miqt_exec_callback_QDockWidget_focusOutEvent(self: ptr cQDockWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QDockWidget_focusOutEvent ".} =
  ...
  nimfunc[](slotval1)
proc QDockWidgetenterEvent*(self: gen_qdockwidget_types.QDockWidget, event: gen_qevent.QEnterEvent): void =

  fQDockWidget_virtualbase_enterEvent(self.h, event.h)

type QDockWidgetenterEventProc* = proc(event: gen_qevent.QEnterEvent): void
...
proc miqt_exec_callback_QDockWidget_disconnectNotify(self: ptr cQDockWidget, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QDockWidget_disconnectNotify ".} =
  ...
  nimfunc[](slotval1)
proc staticMetaObject*(_: type gen_qdockwidget_types.QDockWidget): gen_qobjectdefs.QMetaObject =
