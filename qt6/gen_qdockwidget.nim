...
proc miqt_exec_callback_QDockWidget_event(self: ptr cQDockWidget, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QDockWidget_event ".} =
  ...
  virtualReturn
proc callVirtualBase_initStyleOption(self: QDockWidget, option: gen_qstyleoption.QStyleOptionDockWidget): void =


  fQDockWidget_virtualbase_initStyleOption(self.h, option.h)

type QDockWidgetinitStyleOptionBase* = proc(option: gen_qstyleoption.QStyleOptionDockWidget): void
proc oninitStyleOption*(self: QDockWidget, slot: proc(super: QDockWidgetinitStyleOptionBase, option: gen_qstyleoption.QStyleOptionDockWidget): void) =
  # TODO check subclass
  type Cb = proc(super: QDockWidgetinitStyleOptionBase, option: gen_qstyleoption.QStyleOptionDockWidget): void
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QDockWidget_initStyleOption(self: ptr cQDockWidget, slot: int, option: pointer): void {.exportc: "miqt_exec_callback_QDockWidget_initStyleOption ".} =
  type Cb = proc(super: QDockWidgetinitStyleOptionBase, option: gen_qstyleoption.QStyleOptionDockWidget): void
  var nimfunc = cast[ptr Cb](cast[pointer](slot))
  proc superCall(option: gen_qstyleoption.QStyleOptionDockWidget): auto =
    callVirtualBase_initStyleOption(QDockWidget(h: self), option)
  let slotval1 = gen_qstyleoption.QStyleOptionDockWidget(h: option)
...
proc miqt_exec_callback_QDockWidget_focusOutEvent(self: ptr cQDockWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QDockWidget_focusOutEvent ".} =
  ...
  nimfunc[](superCall, slotval1)
proc callVirtualBase_enterEvent(self: QDockWidget, event: gen_qevent.QEnterEvent): void =


  fQDockWidget_virtualbase_enterEvent(self.h, event.h)

type QDockWidgetenterEventBase* = proc(event: gen_qevent.QEnterEvent): void
proc onenterEvent*(self: QDockWidget, slot: proc(super: QDockWidgetenterEventBase, event: gen_qevent.QEnterEvent): void) =
  # TODO check subclass
  type Cb = proc(super: QDockWidgetenterEventBase, event: gen_qevent.QEnterEvent): void
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QDockWidget_hideEvent(self: ptr cQDockWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QDockWidget_hideEvent ".} =
  ...
  nimfunc[](superCall, slotval1)
proc callVirtualBase_nativeEvent(self: QDockWidget, eventType: seq[byte], message: pointer, resultVal: ptr uint): bool =
...
type QDockWidgetnativeEventBase* = proc(eventType: seq[byte], message: pointer, resultVal: ptr uint): bool
proc onnativeEvent*(self: QDockWidget, slot: proc(super: QDockWidgetnativeEventBase, eventType: seq[byte], message: pointer, resultVal: ptr uint): bool) =
  # TODO check subclass
  type Cb = proc(super: QDockWidgetnativeEventBase, eventType: seq[byte], message: pointer, resultVal: ptr uint): bool
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
