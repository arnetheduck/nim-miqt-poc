...
func (this *QMessageBox) callVirtualBase_MetaObject() *QMetaObject {
	...
	return newQMetaObject(C.QMessageBox_virtualbase_metaObject(unsafe.Pointer(this.h)))

}
func (this *QMessageBox) OnMetaObject(slot func(super func() *QMetaObject) *QMetaObject) {
	ok := C.QMessageBox_override_virtual_metaObject(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
...
func miqt_exec_callback_QMessageBox_metaObject(self *C.QMessageBox, cb C.intptr_t) *C.QMetaObject {
...
func (this *QMessageBox) callVirtualBase_Metacast(param1 string) unsafe.Pointer {
	...
	return (unsafe.Pointer)(C.QMessageBox_virtualbase_metacast(unsafe.Pointer(this.h), param1_Cstring))

}
func (this *QMessageBox) OnMetacast(slot func(super func(param1 string) unsafe.Pointer, param1 string) unsafe.Pointer) {
	ok := C.QMessageBox_override_virtual_metacast(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func miqt_exec_callback_QMessageBox_metacast(self *C.QMessageBox, cb C.intptr_t, param1 *C.const_char) unsafe.Pointer {
...
func (this *QMessageBox) callVirtualBase_EnterEvent(event *QEnterEvent) {

	C.QMessageBox_virtualbase_enterEvent(unsafe.Pointer(this.h), event.cPointer())

}
func (this *QMessageBox) OnEnterEvent(slot func(super func(event *QEnterEvent), event *QEnterEvent)) {
...
func miqt_exec_callback_QMessageBox_enterEvent(self *C.QMessageBox, cb C.intptr_t, event *C.QEnterEvent) {
...
func (this *QMessageBox) callVirtualBase_NativeEvent(eventType []byte, message unsafe.Pointer, result *uintptr) bool {
	...
	return (bool)(C.QMessageBox_virtualbase_nativeEvent(unsafe.Pointer(this.h), eventType_alias, message, (*C.intptr_t)(unsafe.Pointer(result))))

}
func (this *QMessageBox) OnNativeEvent(slot func(super func(eventType []byte, message unsafe.Pointer, result *uintptr) bool, eventType []byte, message unsafe.Pointer, result *uintptr) bool) {
...
func miqt_exec_callback_QMessageBox_nativeEvent(self *C.QMessageBox, cb C.intptr_t, eventType C.struct_miqt_string, message unsafe.Pointer, result *C.intptr_t) C.bool {
