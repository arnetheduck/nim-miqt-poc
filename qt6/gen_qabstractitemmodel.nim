...
func init*(T: type QModelRoleData, h: ptr cQModelRoleData): QModelRoleData =
  T(h: h)
proc create*(T: type QModelRoleData, role: cint): QModelRoleData =

  QModelRoleData.init(fcQModelRoleData_new(role))
proc create*(T: type QModelRoleData, param1: QModelRoleData): QModelRoleData =

  QModelRoleData.init(fcQModelRoleData_new2(param1.h))
proc role*(self: QModelRoleData, ): cint =

  fcQModelRoleData_role(self.h)

proc data*(self: QModelRoleData, ): gen_qvariant.QVariant =

  gen_qvariant.QVariant(h: fcQModelRoleData_data(self.h))

proc data2*(self: QModelRoleData, ): gen_qvariant.QVariant =

  gen_qvariant.QVariant(h: fcQModelRoleData_data2(self.h))

proc clearData*(self: QModelRoleData, ): void =

  fcQModelRoleData_clearData(self.h)

proc operatorAssign*(self: QModelRoleData, param1: QModelRoleData): void =

  fcQModelRoleData_operatorAssign(self.h, param1.h)

proc delete*(self: QModelRoleData) =
  fcQModelRoleData_delete(self.h)

func init*(T: type QModelRoleDataSpan, h: ptr cQModelRoleDataSpan): QModelRoleDataSpan =
  T(h: h)
proc create*(T: type QModelRoleDataSpan, ): QModelRoleDataSpan =

  QModelRoleDataSpan.init(fcQModelRoleDataSpan_new())
proc create*(T: type QModelRoleDataSpan, modelRoleData: QModelRoleData): QModelRoleDataSpan =

  QModelRoleDataSpan.init(fcQModelRoleDataSpan_new2(modelRoleData.h))
proc create*(T: type QModelRoleDataSpan, modelRoleData: QModelRoleData, len: int64): QModelRoleDataSpan =

  QModelRoleDataSpan.init(fcQModelRoleDataSpan_new3(modelRoleData.h, len))
proc create2*(T: type QModelRoleDataSpan, param1: QModelRoleDataSpan): QModelRoleDataSpan =

  QModelRoleDataSpan.init(fcQModelRoleDataSpan_new4(param1.h))
proc size*(self: QModelRoleDataSpan, ): int64 =

  fcQModelRoleDataSpan_size(self.h)

proc length*(self: QModelRoleDataSpan, ): int64 =

  fcQModelRoleDataSpan_length(self.h)

proc data*(self: QModelRoleDataSpan, ): QModelRoleData =

  QModelRoleData(h: fcQModelRoleDataSpan_data(self.h))

proc begin*(self: QModelRoleDataSpan, ): QModelRoleData =

  QModelRoleData(h: fcQModelRoleDataSpan_begin(self.h))

proc endX*(self: QModelRoleDataSpan, ): QModelRoleData =

  QModelRoleData(h: fcQModelRoleDataSpan_endX(self.h))

proc operatorSubscript*(self: QModelRoleDataSpan, index: int64): QModelRoleData =

  QModelRoleData(h: fcQModelRoleDataSpan_operatorSubscript(self.h, index))

proc dataForRole*(self: QModelRoleDataSpan, role: cint): gen_qvariant.QVariant =

  gen_qvariant.QVariant(h: fcQModelRoleDataSpan_dataForRole(self.h, role))

proc delete*(self: QModelRoleDataSpan) =
...
proc constInternalPointer*(self: QModelIndex, ): pointer =
...
proc multiData*(self: QModelIndex, roleDataSpan: QModelRoleDataSpan): void =
...
proc ToQModelIndex*(self: QPersistentModelIndex, ): QModelIndex =
...
proc constInternalPointer*(self: QPersistentModelIndex, ): pointer =
...
proc multiData*(self: QPersistentModelIndex, roleDataSpan: QModelRoleDataSpan): void =
...
proc clearItemData*(self: QAbstractItemModel, index: QModelIndex): bool =
...
proc multiData*(self: QAbstractItemModel, index: QModelIndex, roleDataSpan: QModelRoleDataSpan): void =
...
proc miqt_exec_callback_QAbstractItemModel_setItemData(self: ptr cQAbstractItemModel, slot: int, index: pointer, roles: struct_miqt_map): bool {.exportc: "miqt_exec_callback_QAbstractItemModel_setItemData ".} =
  ...
  virtualReturn
proc callVirtualBase_clearItemData(self: QAbstractItemModel, index: QModelIndex): bool =


  fQAbstractItemModel_virtualbase_clearItemData(self.h, index.h)

type QAbstractItemModelclearItemDataBase* = proc(index: QModelIndex): bool
proc onclearItemData*(self: QAbstractItemModel, slot: proc(super: QAbstractItemModelclearItemDataBase, index: QModelIndex): bool) =
  # TODO check subclass
  type Cb = proc(super: QAbstractItemModelclearItemDataBase, index: QModelIndex): bool
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QAbstractItemModel_clearItemData(self: ptr cQAbstractItemModel, slot: int, index: pointer): bool {.exportc: "miqt_exec_callback_QAbstractItemModel_clearItemData ".} =
  ...
  var nimfunc = cast[ptr Cb](cast[pointer](slot))
  proc superCall(index: QModelIndex): auto =
    callVirtualBase_clearItemData(QAbstractItemModel(h: self), index)
  let slotval1 = QModelIndex(h: index)
...
proc miqt_exec_callback_QAbstractItemModel_roleNames(self: ptr cQAbstractItemModel, slot: int): struct_miqt_map {.exportc: "miqt_exec_callback_QAbstractItemModel_roleNames ".} =
  ...
  struct_miqt_map(len: csize_t(len(virtualReturn)),keys: if len(virtualReturn) == 0: nil else: addr(virtualReturn_Keys_CArray[0]), values: if len(virtualReturn) == 0: nil else: addr(virtualReturn_Values_CArray[0]),)
proc callVirtualBase_multiData(self: QAbstractItemModel, index: QModelIndex, roleDataSpan: QModelRoleDataSpan): void =


  fQAbstractItemModel_virtualbase_multiData(self.h, index.h, roleDataSpan.h)

type QAbstractItemModelmultiDataBase* = proc(index: QModelIndex, roleDataSpan: QModelRoleDataSpan): void
proc onmultiData*(self: QAbstractItemModel, slot: proc(super: QAbstractItemModelmultiDataBase, index: QModelIndex, roleDataSpan: QModelRoleDataSpan): void) =
  # TODO check subclass
  type Cb = proc(super: QAbstractItemModelmultiDataBase, index: QModelIndex, roleDataSpan: QModelRoleDataSpan): void
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QAbstractItemModel_multiData(self: ptr cQAbstractItemModel, slot: int, index: pointer, roleDataSpan: pointer): void {.exportc: "miqt_exec_callback_QAbstractItemModel_multiData ".} =
  type Cb = proc(super: QAbstractItemModelmultiDataBase, index: QModelIndex, roleDataSpan: QModelRoleDataSpan): void
  var nimfunc = cast[ptr Cb](cast[pointer](slot))
  proc superCall(index: QModelIndex, roleDataSpan: QModelRoleDataSpan): auto =
    callVirtualBase_multiData(QAbstractItemModel(h: self), index, roleDataSpan)
  let slotval1 = QModelIndex(h: index)
...
proc miqt_exec_callback_QAbstractItemModel_revert(self: ptr cQAbstractItemModel, slot: int): void {.exportc: "miqt_exec_callback_QAbstractItemModel_revert ".} =
  ...
  nimfunc[](superCall)
proc callVirtualBase_resetInternalData(self: QAbstractItemModel, ): void =


  fQAbstractItemModel_virtualbase_resetInternalData(self.h)

type QAbstractItemModelresetInternalDataBase* = proc(): void
proc onresetInternalData*(self: QAbstractItemModel, slot: proc(super: QAbstractItemModelresetInternalDataBase): void) =
  # TODO check subclass
  type Cb = proc(super: QAbstractItemModelresetInternalDataBase): void
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QAbstractItemModel_resetInternalData(self: ptr cQAbstractItemModel, slot: int): void {.exportc: "miqt_exec_callback_QAbstractItemModel_resetInternalData ".} =
  ...
  var nimfunc = cast[ptr Cb](cast[pointer](slot))
  proc superCall(): auto =
    callVirtualBase_resetInternalData(QAbstractItemModel(h: self), )
...
proc miqt_exec_callback_QAbstractTableModel_setItemData(self: ptr cQAbstractTableModel, slot: int, index: pointer, roles: struct_miqt_map): bool {.exportc: "miqt_exec_callback_QAbstractTableModel_setItemData ".} =
  ...
  virtualReturn
proc callVirtualBase_clearItemData(self: QAbstractTableModel, index: QModelIndex): bool =


  fQAbstractTableModel_virtualbase_clearItemData(self.h, index.h)

type QAbstractTableModelclearItemDataBase* = proc(index: QModelIndex): bool
proc onclearItemData*(self: QAbstractTableModel, slot: proc(super: QAbstractTableModelclearItemDataBase, index: QModelIndex): bool) =
  # TODO check subclass
  type Cb = proc(super: QAbstractTableModelclearItemDataBase, index: QModelIndex): bool
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QAbstractTableModel_clearItemData(self: ptr cQAbstractTableModel, slot: int, index: pointer): bool {.exportc: "miqt_exec_callback_QAbstractTableModel_clearItemData ".} =
  ...
  var nimfunc = cast[ptr Cb](cast[pointer](slot))
  proc superCall(index: QModelIndex): auto =
    callVirtualBase_clearItemData(QAbstractTableModel(h: self), index)
  let slotval1 = QModelIndex(h: index)
...
proc miqt_exec_callback_QAbstractTableModel_roleNames(self: ptr cQAbstractTableModel, slot: int): struct_miqt_map {.exportc: "miqt_exec_callback_QAbstractTableModel_roleNames ".} =
  ...
  struct_miqt_map(len: csize_t(len(virtualReturn)),keys: if len(virtualReturn) == 0: nil else: addr(virtualReturn_Keys_CArray[0]), values: if len(virtualReturn) == 0: nil else: addr(virtualReturn_Values_CArray[0]),)
proc callVirtualBase_multiData(self: QAbstractTableModel, index: QModelIndex, roleDataSpan: QModelRoleDataSpan): void =


  fQAbstractTableModel_virtualbase_multiData(self.h, index.h, roleDataSpan.h)

type QAbstractTableModelmultiDataBase* = proc(index: QModelIndex, roleDataSpan: QModelRoleDataSpan): void
proc onmultiData*(self: QAbstractTableModel, slot: proc(super: QAbstractTableModelmultiDataBase, index: QModelIndex, roleDataSpan: QModelRoleDataSpan): void) =
  # TODO check subclass
  type Cb = proc(super: QAbstractTableModelmultiDataBase, index: QModelIndex, roleDataSpan: QModelRoleDataSpan): void
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QAbstractTableModel_multiData(self: ptr cQAbstractTableModel, slot: int, index: pointer, roleDataSpan: pointer): void {.exportc: "miqt_exec_callback_QAbstractTableModel_multiData ".} =
  ...
  var nimfunc = cast[ptr Cb](cast[pointer](slot))
  proc superCall(index: QModelIndex, roleDataSpan: QModelRoleDataSpan): auto =
    callVirtualBase_multiData(QAbstractTableModel(h: self), index, roleDataSpan)
  let slotval1 = QModelIndex(h: index)
...
proc miqt_exec_callback_QAbstractTableModel_revert(self: ptr cQAbstractTableModel, slot: int): void {.exportc: "miqt_exec_callback_QAbstractTableModel_revert ".} =
  ...
  nimfunc[](superCall)
proc callVirtualBase_resetInternalData(self: QAbstractTableModel, ): void =


  fQAbstractTableModel_virtualbase_resetInternalData(self.h)

type QAbstractTableModelresetInternalDataBase* = proc(): void
proc onresetInternalData*(self: QAbstractTableModel, slot: proc(super: QAbstractTableModelresetInternalDataBase): void) =
  # TODO check subclass
  type Cb = proc(super: QAbstractTableModelresetInternalDataBase): void
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QAbstractTableModel_resetInternalData(self: ptr cQAbstractTableModel, slot: int): void {.exportc: "miqt_exec_callback_QAbstractTableModel_resetInternalData ".} =
  ...
  var nimfunc = cast[ptr Cb](cast[pointer](slot))
  proc superCall(): auto =
    callVirtualBase_resetInternalData(QAbstractTableModel(h: self), )
...
proc miqt_exec_callback_QAbstractListModel_setItemData(self: ptr cQAbstractListModel, slot: int, index: pointer, roles: struct_miqt_map): bool {.exportc: "miqt_exec_callback_QAbstractListModel_setItemData ".} =
  ...
  virtualReturn
proc callVirtualBase_clearItemData(self: QAbstractListModel, index: QModelIndex): bool =


  fQAbstractListModel_virtualbase_clearItemData(self.h, index.h)

type QAbstractListModelclearItemDataBase* = proc(index: QModelIndex): bool
proc onclearItemData*(self: QAbstractListModel, slot: proc(super: QAbstractListModelclearItemDataBase, index: QModelIndex): bool) =
  # TODO check subclass
  type Cb = proc(super: QAbstractListModelclearItemDataBase, index: QModelIndex): bool
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QAbstractListModel_clearItemData(self: ptr cQAbstractListModel, slot: int, index: pointer): bool {.exportc: "miqt_exec_callback_QAbstractListModel_clearItemData ".} =
  ...
  var nimfunc = cast[ptr Cb](cast[pointer](slot))
  proc superCall(index: QModelIndex): auto =
    callVirtualBase_clearItemData(QAbstractListModel(h: self), index)
  let slotval1 = QModelIndex(h: index)
...
proc miqt_exec_callback_QAbstractListModel_roleNames(self: ptr cQAbstractListModel, slot: int): struct_miqt_map {.exportc: "miqt_exec_callback_QAbstractListModel_roleNames ".} =
  ...
  struct_miqt_map(len: csize_t(len(virtualReturn)),keys: if len(virtualReturn) == 0: nil else: addr(virtualReturn_Keys_CArray[0]), values: if len(virtualReturn) == 0: nil else: addr(virtualReturn_Values_CArray[0]),)
proc callVirtualBase_multiData(self: QAbstractListModel, index: QModelIndex, roleDataSpan: QModelRoleDataSpan): void =


  fQAbstractListModel_virtualbase_multiData(self.h, index.h, roleDataSpan.h)

type QAbstractListModelmultiDataBase* = proc(index: QModelIndex, roleDataSpan: QModelRoleDataSpan): void
proc onmultiData*(self: QAbstractListModel, slot: proc(super: QAbstractListModelmultiDataBase, index: QModelIndex, roleDataSpan: QModelRoleDataSpan): void) =
  # TODO check subclass
  type Cb = proc(super: QAbstractListModelmultiDataBase, index: QModelIndex, roleDataSpan: QModelRoleDataSpan): void
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QAbstractListModel_multiData(self: ptr cQAbstractListModel, slot: int, index: pointer, roleDataSpan: pointer): void {.exportc: "miqt_exec_callback_QAbstractListModel_multiData ".} =
  ...
  var nimfunc = cast[ptr Cb](cast[pointer](slot))
  proc superCall(index: QModelIndex, roleDataSpan: QModelRoleDataSpan): auto =
    callVirtualBase_multiData(QAbstractListModel(h: self), index, roleDataSpan)
  let slotval1 = QModelIndex(h: index)
...
proc miqt_exec_callback_QAbstractListModel_revert(self: ptr cQAbstractListModel, slot: int): void {.exportc: "miqt_exec_callback_QAbstractListModel_revert ".} =
  ...
  nimfunc[](superCall)
proc callVirtualBase_resetInternalData(self: QAbstractListModel, ): void =


  fQAbstractListModel_virtualbase_resetInternalData(self.h)

type QAbstractListModelresetInternalDataBase* = proc(): void
proc onresetInternalData*(self: QAbstractListModel, slot: proc(super: QAbstractListModelresetInternalDataBase): void) =
  # TODO check subclass
  type Cb = proc(super: QAbstractListModelresetInternalDataBase): void
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QAbstractListModel_resetInternalData(self: ptr cQAbstractListModel, slot: int): void {.exportc: "miqt_exec_callback_QAbstractListModel_resetInternalData ".} =
  ...
  var nimfunc = cast[ptr Cb](cast[pointer](slot))
  proc superCall(): auto =
    callVirtualBase_resetInternalData(QAbstractListModel(h: self), )
