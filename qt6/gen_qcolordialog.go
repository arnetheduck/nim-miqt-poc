...
func (this *QColorDialog) Metacall(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {
	return (int)(C.QColorDialog_metacall(this.h, (C.int)(param1), (C.int)(param2), param3))
}
...
func (this *QColorDialog) callVirtualBase_MetaObject() *QMetaObject {
	...
	return newQMetaObject(C.QColorDialog_virtualbase_metaObject(unsafe.Pointer(this.h)))

}
func (this *QColorDialog) OnMetaObject(slot func(super func() *QMetaObject) *QMetaObject) {
	ok := C.QColorDialog_override_virtual_metaObject(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
...
func miqt_exec_callback_QColorDialog_metaObject(self *C.QColorDialog, cb C.intptr_t) *C.QMetaObject {
...
func (this *QColorDialog) callVirtualBase_Metacast(param1 string) unsafe.Pointer {
	...
	return (unsafe.Pointer)(C.QColorDialog_virtualbase_metacast(unsafe.Pointer(this.h), param1_Cstring))

}
func (this *QColorDialog) OnMetacast(slot func(super func(param1 string) unsafe.Pointer, param1 string) unsafe.Pointer) {
	ok := C.QColorDialog_override_virtual_metacast(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func miqt_exec_callback_QColorDialog_metacast(self *C.QColorDialog, cb C.intptr_t, param1 *C.const_char) unsafe.Pointer {
...
func (this *QColorDialog) callVirtualBase_Metacall(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {

	return (int)(C.QColorDialog_virtualbase_metacall(unsafe.Pointer(this.h), (C.int)(param1), (C.int)(param2), param3))

}
func (this *QColorDialog) OnMetacall(slot func(super func(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int, param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int) {
	ok := C.QColorDialog_override_virtual_metacall(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}

//export miqt_exec_callback_QColorDialog_metacall
func miqt_exec_callback_QColorDialog_metacall(self *C.QColorDialog, cb C.intptr_t, param1 C.int, param2 C.int, param3 unsafe.Pointer) C.int {
	...
	virtualReturn := gofunc((&QColorDialog{h: self}).callVirtualBase_Metacall, slotval1, slotval2, slotval3)
...
func (this *QColorDialog) callVirtualBase_EnterEvent(event *QEnterEvent) {

	C.QColorDialog_virtualbase_enterEvent(unsafe.Pointer(this.h), event.cPointer())

}
func (this *QColorDialog) OnEnterEvent(slot func(super func(event *QEnterEvent), event *QEnterEvent)) {
...
func miqt_exec_callback_QColorDialog_enterEvent(self *C.QColorDialog, cb C.intptr_t, event *C.QEnterEvent) {
...
func (this *QColorDialog) callVirtualBase_NativeEvent(eventType []byte, message unsafe.Pointer, result *uintptr) bool {
	...
	return (bool)(C.QColorDialog_virtualbase_nativeEvent(unsafe.Pointer(this.h), eventType_alias, message, (*C.intptr_t)(unsafe.Pointer(result))))

}
func (this *QColorDialog) OnNativeEvent(slot func(super func(eventType []byte, message unsafe.Pointer, result *uintptr) bool, eventType []byte, message unsafe.Pointer, result *uintptr) bool) {
...
func miqt_exec_callback_QColorDialog_nativeEvent(self *C.QColorDialog, cb C.intptr_t, eventType C.struct_miqt_string, message unsafe.Pointer, result *C.intptr_t) C.bool {
