...
proc menuInAction*(_: type QMenu, action: gen_qaction.QAction): QMenu =

  QMenu(h: fcQMenu_menuInAction(action.h))
...
proc miqt_exec_callback_QMenu_wheelEvent(self: ptr cQMenu, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QMenu_wheelEvent ".} =
  ...
  nimfunc[](superCall, slotval1)
proc callVirtualBase_enterEvent(self: QMenu, param1: gen_qevent.QEnterEvent): void =


  fQMenu_virtualbase_enterEvent(self.h, param1.h)

type QMenuenterEventBase* = proc(param1: gen_qevent.QEnterEvent): void
proc onenterEvent*(self: QMenu, slot: proc(super: QMenuenterEventBase, param1: gen_qevent.QEnterEvent): void) =
  # TODO check subclass
  type Cb = proc(super: QMenuenterEventBase, param1: gen_qevent.QEnterEvent): void
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QMenu_focusNextPrevChild(self: ptr cQMenu, slot: int, next: bool): bool {.exportc: "miqt_exec_callback_QMenu_focusNextPrevChild ".} =
  ...
  virtualReturn
proc callVirtualBase_initStyleOption(self: QMenu, option: gen_qstyleoption.QStyleOptionMenuItem, action: gen_qaction.QAction): void =


  fQMenu_virtualbase_initStyleOption(self.h, option.h, action.h)

type QMenuinitStyleOptionBase* = proc(option: gen_qstyleoption.QStyleOptionMenuItem, action: gen_qaction.QAction): void
proc oninitStyleOption*(self: QMenu, slot: proc(super: QMenuinitStyleOptionBase, option: gen_qstyleoption.QStyleOptionMenuItem, action: gen_qaction.QAction): void) =
  # TODO check subclass
  type Cb = proc(super: QMenuinitStyleOptionBase, option: gen_qstyleoption.QStyleOptionMenuItem, action: gen_qaction.QAction): void
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QMenu_initStyleOption(self: ptr cQMenu, slot: int, option: pointer, action: pointer): void {.exportc: "miqt_exec_callback_QMenu_initStyleOption ".} =
  ...
  proc superCall(option: gen_qstyleoption.QStyleOptionMenuItem, action: gen_qaction.QAction): auto =
    callVirtualBase_initStyleOption(QMenu(h: self), option, action)
...
proc miqt_exec_callback_QMenu_showEvent(self: ptr cQMenu, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QMenu_showEvent ".} =
  ...
  nimfunc[](superCall, slotval1)
proc callVirtualBase_nativeEvent(self: QMenu, eventType: seq[byte], message: pointer, resultVal: ptr uint): bool =
...
type QMenunativeEventBase* = proc(eventType: seq[byte], message: pointer, resultVal: ptr uint): bool
proc onnativeEvent*(self: QMenu, slot: proc(super: QMenunativeEventBase, eventType: seq[byte], message: pointer, resultVal: ptr uint): bool) =
  # TODO check subclass
  type Cb = proc(super: QMenunativeEventBase, eventType: seq[byte], message: pointer, resultVal: ptr uint): bool
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QMenu_disconnectNotify(self: ptr cQMenu, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QMenu_disconnectNotify ".} =
  ...
  nimfunc[](superCall, slotval1)
proc staticMetaObject*(_: type QMenu): gen_qobjectdefs.QMetaObject =
