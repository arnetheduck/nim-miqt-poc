...
proc miqt_exec_callback_QColumnView_sizeHintForColumn(self: ptr cQColumnView, slot: int, column: cint): cint {.exportc: "miqt_exec_callback_QColumnView_sizeHintForColumn ".} =
  ...
  virtualReturn
proc callVirtualBase_itemDelegateForIndex(self: QColumnView, index: gen_qabstractitemmodel.QModelIndex): gen_qabstractitemdelegate.QAbstractItemDelegate =


  gen_qabstractitemdelegate.QAbstractItemDelegate(h: fQColumnView_virtualbase_itemDelegateForIndex(self.h, index.h))

type QColumnViewitemDelegateForIndexBase* = proc(index: gen_qabstractitemmodel.QModelIndex): gen_qabstractitemdelegate.QAbstractItemDelegate
proc onitemDelegateForIndex*(self: QColumnView, slot: proc(super: QColumnViewitemDelegateForIndexBase, index: gen_qabstractitemmodel.QModelIndex): gen_qabstractitemdelegate.QAbstractItemDelegate) =
  # TODO check subclass
  type Cb = proc(super: QColumnViewitemDelegateForIndexBase, index: gen_qabstractitemmodel.QModelIndex): gen_qabstractitemdelegate.QAbstractItemDelegate
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QColumnView_itemDelegateForIndex(self: ptr cQColumnView, slot: int, index: pointer): pointer {.exportc: "miqt_exec_callback_QColumnView_itemDelegateForIndex ".} =
  ...
  var nimfunc = cast[ptr Cb](cast[pointer](slot))
  proc superCall(index: gen_qabstractitemmodel.QModelIndex): auto =
    callVirtualBase_itemDelegateForIndex(QColumnView(h: self), index)
  let slotval1 = gen_qabstractitemmodel.QModelIndex(h: index)
...
proc miqt_exec_callback_QColumnView_startDrag(self: ptr cQColumnView, slot: int, supportedActions: cint): void {.exportc: "miqt_exec_callback_QColumnView_startDrag ".} =
  ...
  nimfunc[](superCall, slotval1)
proc callVirtualBase_initViewItemOption(self: QColumnView, option: gen_qstyleoption.QStyleOptionViewItem): void =


  fQColumnView_virtualbase_initViewItemOption(self.h, option.h)

type QColumnViewinitViewItemOptionBase* = proc(option: gen_qstyleoption.QStyleOptionViewItem): void
proc oninitViewItemOption*(self: QColumnView, slot: proc(super: QColumnViewinitViewItemOptionBase, option: gen_qstyleoption.QStyleOptionViewItem): void) =
  # TODO check subclass
  type Cb = proc(super: QColumnViewinitViewItemOptionBase, option: gen_qstyleoption.QStyleOptionViewItem): void
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QColumnView_initViewItemOption(self: ptr cQColumnView, slot: int, option: pointer): void {.exportc: "miqt_exec_callback_QColumnView_initViewItemOption ".} =
  ...
  proc superCall(option: gen_qstyleoption.QStyleOptionViewItem): auto =
    callVirtualBase_initViewItemOption(QColumnView(h: self), option)
...
proc miqt_exec_callback_QColumnView_changeEvent(self: ptr cQColumnView, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QColumnView_changeEvent ".} =
  ...
  nimfunc[](superCall, slotval1)
proc callVirtualBase_initStyleOption(self: QColumnView, option: gen_qstyleoption.QStyleOptionFrame): void =


  fQColumnView_virtualbase_initStyleOption(self.h, option.h)

type QColumnViewinitStyleOptionBase* = proc(option: gen_qstyleoption.QStyleOptionFrame): void
proc oninitStyleOption*(self: QColumnView, slot: proc(super: QColumnViewinitStyleOptionBase, option: gen_qstyleoption.QStyleOptionFrame): void) =
  # TODO check subclass
  type Cb = proc(super: QColumnViewinitStyleOptionBase, option: gen_qstyleoption.QStyleOptionFrame): void
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QColumnView_initStyleOption(self: ptr cQColumnView, slot: int, option: pointer): void {.exportc: "miqt_exec_callback_QColumnView_initStyleOption ".} =
  ...
  proc superCall(option: gen_qstyleoption.QStyleOptionFrame): auto =
    callVirtualBase_initStyleOption(QColumnView(h: self), option)
...
proc miqt_exec_callback_QColumnView_keyReleaseEvent(self: ptr cQColumnView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QColumnView_keyReleaseEvent ".} =
  ...
  nimfunc[](superCall, slotval1)
proc callVirtualBase_enterEvent(self: QColumnView, event: gen_qevent.QEnterEvent): void =


  fQColumnView_virtualbase_enterEvent(self.h, event.h)

type QColumnViewenterEventBase* = proc(event: gen_qevent.QEnterEvent): void
proc onenterEvent*(self: QColumnView, slot: proc(super: QColumnViewenterEventBase, event: gen_qevent.QEnterEvent): void) =
  # TODO check subclass
  type Cb = proc(super: QColumnViewenterEventBase, event: gen_qevent.QEnterEvent): void
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QColumnView_hideEvent(self: ptr cQColumnView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QColumnView_hideEvent ".} =
  ...
  nimfunc[](superCall, slotval1)
proc callVirtualBase_nativeEvent(self: QColumnView, eventType: seq[byte], message: pointer, resultVal: ptr uint): bool =
...
type QColumnViewnativeEventBase* = proc(eventType: seq[byte], message: pointer, resultVal: ptr uint): bool
proc onnativeEvent*(self: QColumnView, slot: proc(super: QColumnViewnativeEventBase, eventType: seq[byte], message: pointer, resultVal: ptr uint): bool) =
  # TODO check subclass
  type Cb = proc(super: QColumnViewnativeEventBase, eventType: seq[byte], message: pointer, resultVal: ptr uint): bool
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
