...
func (this *QIODevice) Metacall(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {
	return (int)(C.QIODevice_metacall(this.h, (C.int)(param1), (C.int)(param2), param3))
}
...
func (this *QIODevice) callVirtualBase_MetaObject() *QMetaObject {
	...
	return newQMetaObject(C.QIODevice_virtualbase_metaObject(unsafe.Pointer(this.h)))

}
func (this *QIODevice) OnMetaObject(slot func(super func() *QMetaObject) *QMetaObject) {
	ok := C.QIODevice_override_virtual_metaObject(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
...
func miqt_exec_callback_QIODevice_metaObject(self *C.QIODevice, cb C.intptr_t) *C.QMetaObject {
...
func (this *QIODevice) callVirtualBase_Metacast(param1 string) unsafe.Pointer {
	...
	return (unsafe.Pointer)(C.QIODevice_virtualbase_metacast(unsafe.Pointer(this.h), param1_Cstring))

}
func (this *QIODevice) OnMetacast(slot func(super func(param1 string) unsafe.Pointer, param1 string) unsafe.Pointer) {
	ok := C.QIODevice_override_virtual_metacast(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func miqt_exec_callback_QIODevice_metacast(self *C.QIODevice, cb C.intptr_t, param1 *C.const_char) unsafe.Pointer {
...
func (this *QIODevice) callVirtualBase_Metacall(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {

	return (int)(C.QIODevice_virtualbase_metacall(unsafe.Pointer(this.h), (C.int)(param1), (C.int)(param2), param3))

}
func (this *QIODevice) OnMetacall(slot func(super func(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int, param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int) {
	ok := C.QIODevice_override_virtual_metacall(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}

//export miqt_exec_callback_QIODevice_metacall
func miqt_exec_callback_QIODevice_metacall(self *C.QIODevice, cb C.intptr_t, param1 C.int, param2 C.int, param3 unsafe.Pointer) C.int {
	...
	virtualReturn := gofunc((&QIODevice{h: self}).callVirtualBase_Metacall, slotval1, slotval2, slotval3)
...
func (this *QIODevice) OnSkipData(slot func(super func(maxSize int64) int64, maxSize int64) int64) {
	ok := C.QIODevice_override_virtual_skipData(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
