...
func (this *QListView) Metacall(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {
	return (int)(C.QListView_metacall(this.h, (C.int)(param1), (C.int)(param2), param3))
}
...
func (this *QListView) callVirtualBase_MetaObject() *QMetaObject {
	...
	return newQMetaObject(C.QListView_virtualbase_metaObject(unsafe.Pointer(this.h)))

}
func (this *QListView) OnMetaObject(slot func(super func() *QMetaObject) *QMetaObject) {
	ok := C.QListView_override_virtual_metaObject(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
...
func miqt_exec_callback_QListView_metaObject(self *C.QListView, cb C.intptr_t) *C.QMetaObject {
...
func (this *QListView) callVirtualBase_Metacast(param1 string) unsafe.Pointer {
	...
	return (unsafe.Pointer)(C.QListView_virtualbase_metacast(unsafe.Pointer(this.h), param1_Cstring))

}
func (this *QListView) OnMetacast(slot func(super func(param1 string) unsafe.Pointer, param1 string) unsafe.Pointer) {
	ok := C.QListView_override_virtual_metacast(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func miqt_exec_callback_QListView_metacast(self *C.QListView, cb C.intptr_t, param1 *C.const_char) unsafe.Pointer {
...
func (this *QListView) callVirtualBase_Metacall(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {

	return (int)(C.QListView_virtualbase_metacall(unsafe.Pointer(this.h), (C.int)(param1), (C.int)(param2), param3))

}
func (this *QListView) OnMetacall(slot func(super func(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int, param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int) {
	ok := C.QListView_override_virtual_metacall(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}

//export miqt_exec_callback_QListView_metacall
func miqt_exec_callback_QListView_metacall(self *C.QListView, cb C.intptr_t, param1 C.int, param2 C.int, param3 unsafe.Pointer) C.int {
	...
	virtualReturn := gofunc((&QListView{h: self}).callVirtualBase_Metacall, slotval1, slotval2, slotval3)
...
func (this *QListView) callVirtualBase_InitViewItemOption(option *QStyleOptionViewItem) {

	C.QListView_virtualbase_initViewItemOption(unsafe.Pointer(this.h), option.cPointer())

}
func (this *QListView) OnInitViewItemOption(slot func(super func(option *QStyleOptionViewItem), option *QStyleOptionViewItem)) {
	ok := C.QListView_override_virtual_initViewItemOption(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}

//export miqt_exec_callback_QListView_initViewItemOption
func miqt_exec_callback_QListView_initViewItemOption(self *C.QListView, cb C.intptr_t, option *C.QStyleOptionViewItem) {
...
func (this *QListView) OnItemDelegateForIndex(slot func(super func(index *QModelIndex) *QAbstractItemDelegate, index *QModelIndex) *QAbstractItemDelegate) {
	ok := C.QListView_override_virtual_itemDelegateForIndex(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}

//export miqt_exec_callback_QListView_itemDelegateForIndex
func miqt_exec_callback_QListView_itemDelegateForIndex(self *C.QListView, cb C.intptr_t, index *C.QModelIndex) *C.QAbstractItemDelegate {
	...
	virtualReturn := gofunc((&QListView{h: self}).callVirtualBase_ItemDelegateForIndex, slotval1)
...
func (this *QListView) callVirtualBase_InitStyleOption(option *QStyleOptionFrame) {

	C.QListView_virtualbase_initStyleOption(unsafe.Pointer(this.h), option.cPointer())

}
func (this *QListView) OnInitStyleOption(slot func(super func(option *QStyleOptionFrame), option *QStyleOptionFrame)) {
	ok := C.QListView_override_virtual_initStyleOption(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}

//export miqt_exec_callback_QListView_initStyleOption
func miqt_exec_callback_QListView_initStyleOption(self *C.QListView, cb C.intptr_t, option *C.QStyleOptionFrame) {
	...
	gofunc((&QListView{h: self}).callVirtualBase_InitStyleOption, slotval1)
...
func (this *QListView) callVirtualBase_EnterEvent(event *QEnterEvent) {

	C.QListView_virtualbase_enterEvent(unsafe.Pointer(this.h), event.cPointer())

}
func (this *QListView) OnEnterEvent(slot func(super func(event *QEnterEvent), event *QEnterEvent)) {
...
func miqt_exec_callback_QListView_enterEvent(self *C.QListView, cb C.intptr_t, event *C.QEnterEvent) {
...
func (this *QListView) callVirtualBase_NativeEvent(eventType []byte, message unsafe.Pointer, result *uintptr) bool {
	...
	return (bool)(C.QListView_virtualbase_nativeEvent(unsafe.Pointer(this.h), eventType_alias, message, (*C.intptr_t)(unsafe.Pointer(result))))

}
func (this *QListView) OnNativeEvent(slot func(super func(eventType []byte, message unsafe.Pointer, result *uintptr) bool, eventType []byte, message unsafe.Pointer, result *uintptr) bool) {
...
func miqt_exec_callback_QListView_nativeEvent(self *C.QListView, cb C.intptr_t, eventType C.struct_miqt_string, message unsafe.Pointer, result *C.intptr_t) C.bool {
