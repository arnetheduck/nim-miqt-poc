...
import
  ...
  gen_qurl,
  gen_qvariant,
  gen_qwebenginecontextmenurequest,
...
proc create*(T: type gen_qwebengineview_types.QWebEngineView, profile: gen_qwebengineprofile.QWebEngineProfile): gen_qwebengineview_types.QWebEngineView =
  gen_qwebengineview_types.QWebEngineView.init(fcQWebEngineView_new3(profile.h))

proc create*(T: type gen_qwebengineview_types.QWebEngineView, page: gen_qwebenginepage.QWebEnginePage): gen_qwebengineview_types.QWebEngineView =
...
proc create*(T: type gen_qwebengineview_types.QWebEngineView, page: gen_qwebenginepage.QWebEnginePage, parent: gen_qwidget.QWidget): gen_qwebengineview_types.QWebEngineView =
...
proc printToPdf*(self: gen_qwebengineview_types.QWebEngineView, filePath: string, layout: gen_qpagelayout.QPageLayout): void =
  fcQWebEngineView_printToPdf2(self.h, struct_miqt_string(data: filePath, len: csize_t(len(filePath))), layout.h)

proc printToPdf*(self: gen_qwebengineview_types.QWebEngineView, filePath: string, layout: gen_qpagelayout.QPageLayout, ranges: gen_qpageranges.QPageRanges): void =
