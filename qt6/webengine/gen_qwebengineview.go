...
func (this *QWebEngineView) callVirtualBase_MetaObject() *qt6.QMetaObject {

	return qt6.UnsafeNewQMetaObject(unsafe.Pointer(C.QWebEngineView_virtualbase_metaObject(unsafe.Pointer(this.h))))

}
func (this *QWebEngineView) OnMetaObject(slot func(super func() *qt6.QMetaObject) *qt6.QMetaObject) {
