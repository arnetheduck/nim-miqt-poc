...
func (this *QWebEngineUrlRequestInterceptor) Metacall(param1 qt6.QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {
...
func (this *QWebEngineUrlRequestInterceptor) callVirtualBase_MetaObject() *qt6.QMetaObject {

	return qt6.UnsafeNewQMetaObject(unsafe.Pointer(C.QWebEngineUrlRequestInterceptor_virtualbase_metaObject(unsafe.Pointer(this.h))))

}
func (this *QWebEngineUrlRequestInterceptor) OnMetaObject(slot func(super func() *qt6.QMetaObject) *qt6.QMetaObject) {
...
func (this *QWebEngineUrlRequestInterceptor) callVirtualBase_Metacall(param1 qt6.QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {

	return (int)(C.QWebEngineUrlRequestInterceptor_virtualbase_metacall(unsafe.Pointer(this.h), (C.int)(param1), (C.int)(param2), param3))

}
func (this *QWebEngineUrlRequestInterceptor) OnMetacall(slot func(super func(param1 qt6.QMetaObject__Call, param2 int, param3 unsafe.Pointer) int, param1 qt6.QMetaObject__Call, param2 int, param3 unsafe.Pointer) int) {
