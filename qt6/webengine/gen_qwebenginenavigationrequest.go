...
func (this *QWebEngineNavigationRequest) Metacall(param1 qt6.QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {
	return (int)(C.QWebEngineNavigationRequest_metacall(this.h, (C.int)(param1), (C.int)(param2), param3))
}
