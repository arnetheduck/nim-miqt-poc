...
proc onloadingChanged*(self: gen_qwebenginepage_types.QWebEnginePage, slot: proc(loadingInfo: gen_qwebengineloadinginfo.QWebEngineLoadingInfo)) =
  type Cb = proc(loadingInfo: gen_qwebengineloadinginfo.QWebEngineLoadingInfo)
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc onfileSystemAccessRequested*(self: gen_qwebenginepage_types.QWebEnginePage, slot: proc(request: gen_qwebenginefilesystemaccessrequest.QWebEngineFileSystemAccessRequest)) =
  type Cb = proc(request: gen_qwebenginefilesystemaccessrequest.QWebEngineFileSystemAccessRequest)
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc oncertificateError*(self: gen_qwebenginepage_types.QWebEnginePage, slot: proc(certificateError: gen_qwebenginecertificateerror.QWebEngineCertificateError)) =
  type Cb = proc(certificateError: gen_qwebenginecertificateerror.QWebEngineCertificateError)
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc onnavigationRequested*(self: gen_qwebenginepage_types.QWebEnginePage, slot: proc(request: gen_qwebenginenavigationrequest.QWebEngineNavigationRequest)) =
  type Cb = proc(request: gen_qwebenginenavigationrequest.QWebEngineNavigationRequest)
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc onnewWindowRequested*(self: gen_qwebenginepage_types.QWebEnginePage, slot: proc(request: gen_qwebenginenewwindowrequest.QWebEngineNewWindowRequest)) =
  type Cb = proc(request: gen_qwebenginenewwindowrequest.QWebEngineNewWindowRequest)
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc onQAboutToDelete*(self: gen_qwebenginepage_types.QWebEnginePage, slot: proc()) =
  type Cb = proc()
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc printToPdf3*(self: gen_qwebenginepage_types.QWebEnginePage, filePath: string, layout: gen_qpagelayout.QPageLayout, ranges: gen_qpageranges.QPageRanges): void =
