...
void miqt_exec_callback_QWebEnginePage_loadingChanged_release(intptr_t);
...
void miqt_exec_callback_QWebEnginePage_fileSystemAccessRequested_release(intptr_t);
...
void miqt_exec_callback_QWebEnginePage_certificateError_release(intptr_t);
void miqt_exec_callback_QWebEnginePage_navigationRequested(intptr_t, QWebEngineNavigationRequest*);
void miqt_exec_callback_QWebEnginePage_navigationRequested_release(intptr_t);
void miqt_exec_callback_QWebEnginePage_newWindowRequested(intptr_t, QWebEngineNewWindowRequest*);
void miqt_exec_callback_QWebEnginePage_newWindowRequested_release(intptr_t);
...
void miqt_exec_callback_QWebEnginePage_QAboutToDelete_release(intptr_t);
#ifdef __cplusplus
} /* extern C */
#endif
...
public:
	...
	QMetaObject* virtualbase_metaObject() const {
		...
		return (QMetaObject*) QWebEnginePage::metaObject();
...
void QWebEnginePage_connect_loadingChanged(QWebEnginePage* self, intptr_t slot) {
	struct caller {
		...
		caller(const caller &) = delete;
		caller &operator=(const caller &) = delete;
		~caller() { miqt_exec_callback_QWebEnginePage_loadingChanged_release(slot); }
	};
	MiqtVirtualQWebEnginePage::connect(self, static_cast<void (QWebEnginePage::*)(const QWebEngineLoadingInfo&)>(&QWebEnginePage::loadingChanged), self, caller{slot});
}
...
void QWebEnginePage_connect_fileSystemAccessRequested(QWebEnginePage* self, intptr_t slot) {
	struct caller {
		...
		caller(const caller &) = delete;
		caller &operator=(const caller &) = delete;
		~caller() { miqt_exec_callback_QWebEnginePage_fileSystemAccessRequested_release(slot); }
	};
	MiqtVirtualQWebEnginePage::connect(self, static_cast<void (QWebEnginePage::*)(QWebEngineFileSystemAccessRequest)>(&QWebEnginePage::fileSystemAccessRequested), self, caller{slot});
}
...
void QWebEnginePage_connect_certificateError(QWebEnginePage* self, intptr_t slot) {
	struct caller {
		...
		caller(const caller &) = delete;
		caller &operator=(const caller &) = delete;
		~caller() { miqt_exec_callback_QWebEnginePage_certificateError_release(slot); }
	};
	MiqtVirtualQWebEnginePage::connect(self, static_cast<void (QWebEnginePage::*)(const QWebEngineCertificateError&)>(&QWebEnginePage::certificateError), self, caller{slot});
}
...
void QWebEnginePage_connect_navigationRequested(QWebEnginePage* self, intptr_t slot) {
	struct caller {
		...
		caller(const caller &) = delete;
		caller &operator=(const caller &) = delete;
		~caller() { miqt_exec_callback_QWebEnginePage_navigationRequested_release(slot); }
	};
	MiqtVirtualQWebEnginePage::connect(self, static_cast<void (QWebEnginePage::*)(QWebEngineNavigationRequest&)>(&QWebEnginePage::navigationRequested), self, caller{slot});
}
...
void QWebEnginePage_connect_newWindowRequested(QWebEnginePage* self, intptr_t slot) {
	struct caller {
		...
		caller(const caller &) = delete;
		caller &operator=(const caller &) = delete;
		~caller() { miqt_exec_callback_QWebEnginePage_newWindowRequested_release(slot); }
	};
	MiqtVirtualQWebEnginePage::connect(self, static_cast<void (QWebEnginePage::*)(QWebEngineNewWindowRequest&)>(&QWebEnginePage::newWindowRequested), self, caller{slot});
}
...
void QWebEnginePage_connect_QAboutToDelete(QWebEnginePage* self, intptr_t slot) {
	struct caller {
		...
		caller(const caller &) = delete;
		caller &operator=(const caller &) = delete;
		~caller() { miqt_exec_callback_QWebEnginePage_QAboutToDelete_release(slot); }
	};
	MiqtVirtualQWebEnginePage::connect(self, static_cast<void (QWebEnginePage::*)()>(&QWebEnginePage::_q_aboutToDelete), self, caller{slot});
}
...
QObject* QWebEnginePage_protectedbase_sender(const void* self) {
	return ( (const MiqtVirtualQWebEnginePage*)(self) )->protectedbase_sender();
}

int QWebEnginePage_protectedbase_senderSignalIndex(const void* self) {
	return ( (const MiqtVirtualQWebEnginePage*)(self) )->protectedbase_senderSignalIndex();
}

int QWebEnginePage_protectedbase_receivers(const void* self, const char* signal) {
	return ( (const MiqtVirtualQWebEnginePage*)(self) )->protectedbase_receivers(signal);
}

bool QWebEnginePage_protectedbase_isSignalConnected(const void* self, QMetaMethod* signal) {
	return ( (const MiqtVirtualQWebEnginePage*)(self) )->protectedbase_isSignalConnected(signal);
}
