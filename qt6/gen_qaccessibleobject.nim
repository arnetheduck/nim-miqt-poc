...
proc setText*(self: QAccessibleObject, t: gen_qaccessible_base.QAccessibleText, text: string): void =
...
proc text*(self: QAccessibleApplication, t: gen_qaccessible_base.QAccessibleText): string =
...
proc role*(self: QAccessibleApplication, ): gen_qaccessible_base.QAccessibleRole =

  gen_qaccessible_base.QAccessibleRole(fcQAccessibleApplication_role(self.h))

proc state*(self: QAccessibleApplication, ): gen_qaccessible_base.QAccessibleState =
