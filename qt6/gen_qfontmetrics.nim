...
proc horizontalAdvance2*(self: QFontMetrics, param1: string, textOption: gen_qtextoption.QTextOption): cint =
...
proc boundingRect2*(self: QFontMetrics, text: string, textOption: gen_qtextoption.QTextOption): gen_qrect.QRect =

  gen_qrect.QRect(h: fcQFontMetrics_boundingRect2(self.h, struct_miqt_string(data: text, len: csize_t(len(text))), textOption.h))

proc boundingRect3*(self: QFontMetrics, r: gen_qrect.QRect, flags: cint, text: string): gen_qrect.QRect =

  gen_qrect.QRect(h: fcQFontMetrics_boundingRect3(self.h, r.h, flags, struct_miqt_string(data: text, len: csize_t(len(text)))))

proc boundingRect4*(self: QFontMetrics, x: cint, y: cint, w: cint, h: cint, flags: cint, text: string): gen_qrect.QRect =
...
proc tightBoundingRect2*(self: QFontMetrics, text: string, textOption: gen_qtextoption.QTextOption): gen_qrect.QRect =
...
proc horizontalAdvance22*(self: QFontMetrics, param1: string, len: cint): cint =

  fcQFontMetrics_horizontalAdvance22(self.h, struct_miqt_string(data: param1, len: csize_t(len(param1))), len)

proc boundingRect42*(self: QFontMetrics, r: gen_qrect.QRect, flags: cint, text: string, tabstops: cint): gen_qrect.QRect =
...
proc horizontalAdvance2*(self: QFontMetricsF, string: string, textOption: gen_qtextoption.QTextOption): float64 =
...
proc boundingRect2*(self: QFontMetricsF, text: string, textOption: gen_qtextoption.QTextOption): gen_qrect.QRectF =
...
proc boundingRect3*(self: QFontMetricsF, r: gen_qrect.QRectF, flags: cint, string: string): gen_qrect.QRectF =
...
proc tightBoundingRect2*(self: QFontMetricsF, text: string, textOption: gen_qtextoption.QTextOption): gen_qrect.QRectF =
...
proc horizontalAdvance22*(self: QFontMetricsF, string: string, length: cint): float64 =
