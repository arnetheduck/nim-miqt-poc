...
proc horizontalAdvance2*(self: gen_qfontmetrics_types.QFontMetrics, param1: string, textOption: gen_qtextoption.QTextOption): cint =
...
proc boundingRect2*(self: gen_qfontmetrics_types.QFontMetrics, text: string, textOption: gen_qtextoption.QTextOption): gen_qrect.QRect =

  gen_qrect.QRect(h: fcQFontMetrics_boundingRect2(self.h, struct_miqt_string(data: text, len: csize_t(len(text))), textOption.h))

proc boundingRect3*(self: gen_qfontmetrics_types.QFontMetrics, r: gen_qrect.QRect, flags: cint, text: string): gen_qrect.QRect =

  gen_qrect.QRect(h: fcQFontMetrics_boundingRect3(self.h, r.h, flags, struct_miqt_string(data: text, len: csize_t(len(text)))))

proc boundingRect4*(self: gen_qfontmetrics_types.QFontMetrics, x: cint, y: cint, w: cint, h: cint, flags: cint, text: string): gen_qrect.QRect =

  gen_qrect.QRect(h: fcQFontMetrics_boundingRect4(self.h, x, y, w, h, flags, struct_miqt_string(data: text, len: csize_t(len(text)))))
...
proc tightBoundingRect2*(self: gen_qfontmetrics_types.QFontMetrics, text: string, textOption: gen_qtextoption.QTextOption): gen_qrect.QRect =

  gen_qrect.QRect(h: fcQFontMetrics_tightBoundingRect2(self.h, struct_miqt_string(data: text, len: csize_t(len(text))), textOption.h))
...
proc horizontalAdvance22*(self: gen_qfontmetrics_types.QFontMetrics, param1: string, len: cint): cint =

  fcQFontMetrics_horizontalAdvance22(self.h, struct_miqt_string(data: param1, len: csize_t(len(param1))), len)

proc boundingRect42*(self: gen_qfontmetrics_types.QFontMetrics, r: gen_qrect.QRect, flags: cint, text: string, tabstops: cint): gen_qrect.QRect =

  gen_qrect.QRect(h: fcQFontMetrics_boundingRect42(self.h, r.h, flags, struct_miqt_string(data: text, len: csize_t(len(text))), tabstops))
...
proc horizontalAdvance2*(self: gen_qfontmetrics_types.QFontMetricsF, string: string, textOption: gen_qtextoption.QTextOption): float64 =
...
proc boundingRect2*(self: gen_qfontmetrics_types.QFontMetricsF, text: string, textOption: gen_qtextoption.QTextOption): gen_qrect.QRectF =

  gen_qrect.QRectF(h: fcQFontMetricsF_boundingRect2(self.h, struct_miqt_string(data: text, len: csize_t(len(text))), textOption.h))
...
proc boundingRect3*(self: gen_qfontmetrics_types.QFontMetricsF, r: gen_qrect.QRectF, flags: cint, string: string): gen_qrect.QRectF =

  gen_qrect.QRectF(h: fcQFontMetricsF_boundingRect3(self.h, r.h, flags, struct_miqt_string(data: string, len: csize_t(len(string)))))
...
proc tightBoundingRect2*(self: gen_qfontmetrics_types.QFontMetricsF, text: string, textOption: gen_qtextoption.QTextOption): gen_qrect.QRectF =

  gen_qrect.QRectF(h: fcQFontMetricsF_tightBoundingRect2(self.h, struct_miqt_string(data: text, len: csize_t(len(text))), textOption.h))
...
proc horizontalAdvance22*(self: gen_qfontmetrics_types.QFontMetricsF, string: string, length: cint): float64 =
