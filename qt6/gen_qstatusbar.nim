...
proc callVirtualBase_metaObject(self: QStatusBar, ): gen_qobjectdefs.QMetaObject =


  gen_qobjectdefs.QMetaObject(h: fQStatusBar_virtualbase_metaObject(self.h))

type QStatusBarmetaObjectBase* = proc(): gen_qobjectdefs.QMetaObject
proc onmetaObject*(self: QStatusBar, slot: proc(super: QStatusBarmetaObjectBase): gen_qobjectdefs.QMetaObject) =
  # TODO check subclass
  type Cb = proc(super: QStatusBarmetaObjectBase): gen_qobjectdefs.QMetaObject
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QStatusBar_metaObject(self: ptr cQStatusBar, slot: int): pointer {.exportc: "miqt_exec_callback_QStatusBar_metaObject ".} =
  ...
  proc superCall(): auto =
    callVirtualBase_metaObject(QStatusBar(h: self), )

  let virtualReturn = nimfunc[](superCall )

  virtualReturn.h
proc callVirtualBase_metacast(self: QStatusBar, param1: cstring): pointer =


  fQStatusBar_virtualbase_metacast(self.h, param1)

type QStatusBarmetacastBase* = proc(param1: cstring): pointer
proc onmetacast*(self: QStatusBar, slot: proc(super: QStatusBarmetacastBase, param1: cstring): pointer) =
  # TODO check subclass
  type Cb = proc(super: QStatusBarmetacastBase, param1: cstring): pointer
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QStatusBar_metacast(self: ptr cQStatusBar, slot: int, param1: cstring): pointer {.exportc: "miqt_exec_callback_QStatusBar_metacast ".} =
  ...
  proc superCall(param1: cstring): auto =
    callVirtualBase_metacast(QStatusBar(h: self), param1)
  let slotval1 = (param1)
...
proc miqt_exec_callback_QStatusBar_focusOutEvent(self: ptr cQStatusBar, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QStatusBar_focusOutEvent ".} =
  ...
  nimfunc[](superCall, slotval1)
proc callVirtualBase_enterEvent(self: QStatusBar, event: gen_qevent.QEnterEvent): void =


  fQStatusBar_virtualbase_enterEvent(self.h, event.h)

type QStatusBarenterEventBase* = proc(event: gen_qevent.QEnterEvent): void
proc onenterEvent*(self: QStatusBar, slot: proc(super: QStatusBarenterEventBase, event: gen_qevent.QEnterEvent): void) =
  # TODO check subclass
  type Cb = proc(super: QStatusBarenterEventBase, event: gen_qevent.QEnterEvent): void
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QStatusBar_hideEvent(self: ptr cQStatusBar, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QStatusBar_hideEvent ".} =
  ...
  nimfunc[](superCall, slotval1)
proc callVirtualBase_nativeEvent(self: QStatusBar, eventType: seq[byte], message: pointer, resultVal: ptr uint): bool =
...
type QStatusBarnativeEventBase* = proc(eventType: seq[byte], message: pointer, resultVal: ptr uint): bool
proc onnativeEvent*(self: QStatusBar, slot: proc(super: QStatusBarnativeEventBase, eventType: seq[byte], message: pointer, resultVal: ptr uint): bool) =
  # TODO check subclass
  type Cb = proc(super: QStatusBarnativeEventBase, eventType: seq[byte], message: pointer, resultVal: ptr uint): bool
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
