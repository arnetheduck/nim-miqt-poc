...
proc isSuspending*(self: QFutureWatcherBase, ): bool =

  fcQFutureWatcherBase_isSuspending(self.h)

proc isSuspended*(self: QFutureWatcherBase, ): bool =
...
proc suspending*(self: QFutureWatcherBase, ): void =
...
proc onsuspending*(self: QFutureWatcherBase, slot: proc()) =
  type Cb = proc()
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
  fQFutureWatcherBase_connect_suspending(self.h, cast[int](addr tmp[]))
proc suspended*(self: QFutureWatcherBase, ): void =
...
proc onsuspended*(self: QFutureWatcherBase, slot: proc()) =
  type Cb = proc()
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc setSuspended*(self: QFutureWatcherBase, suspend: bool): void =

  fcQFutureWatcherBase_setSuspended(self.h, suspend)

proc suspend*(self: QFutureWatcherBase, ): void =
...
proc toggleSuspended*(self: QFutureWatcherBase, ): void =
