...
proc deviceIndependentSize*(self: gen_qpixmap_types.QPixmap, ): gen_qsize.QSizeF =
  gen_qsize.QSizeF(h: fcQPixmap_deviceIndependentSize(self.h))
...
proc trueMatrix*(_: type gen_qpixmap_types.QPixmap, m: gen_qtransform.QTransform, w: cint, h: cint): gen_qtransform.QTransform =
  gen_qtransform.QTransform(h: fcQPixmap_trueMatrix(m.h, w, h))
