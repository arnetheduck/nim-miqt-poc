...
proc deviceIndependentSize*(self: QPixmap, ): gen_qsize.QSizeF =
...
proc transformed*(self: QPixmap, param1: gen_qtransform.QTransform): QPixmap =

  QPixmap(h: fcQPixmap_transformed(self.h, param1.h))

proc trueMatrix*(_: type QPixmap, m: gen_qtransform.QTransform, w: cint, h: cint): gen_qtransform.QTransform =
...
proc transformed2*(self: QPixmap, param1: gen_qtransform.QTransform, mode: gen_qnamespace.TransformationMode): QPixmap =
