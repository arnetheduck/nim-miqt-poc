...
proc operatorShiftLeftWithQByteArrayView*(self: QDebug, t: gen_qbytearrayview.QByteArrayView): QDebug =

  QDebug(h: fcQDebug_operatorShiftLeftWithQByteArrayView(self.h, t.h))
