...
func (this *QProgressBar) Metacall(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {
	return (int)(C.QProgressBar_metacall(this.h, (C.int)(param1), (C.int)(param2), param3))
}
...
func (this *QProgressBar) callVirtualBase_MetaObject() *QMetaObject {
	...
	return newQMetaObject(C.QProgressBar_virtualbase_metaObject(unsafe.Pointer(this.h)))

}
func (this *QProgressBar) OnmetaObject(slot func(super func() *QMetaObject) *QMetaObject) {
	ok := C.QProgressBar_override_virtual_metaObject(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
...
func miqt_exec_callback_QProgressBar_metaObject(self *C.QProgressBar, cb C.intptr_t) *C.QMetaObject {
...
func (this *QProgressBar) callVirtualBase_Metacast(param1 string) unsafe.Pointer {
	...
	return (unsafe.Pointer)(C.QProgressBar_virtualbase_metacast(unsafe.Pointer(this.h), param1_Cstring))

}
func (this *QProgressBar) Onmetacast(slot func(super func(param1 string) unsafe.Pointer, param1 string) unsafe.Pointer) {
	ok := C.QProgressBar_override_virtual_metacast(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func miqt_exec_callback_QProgressBar_metacast(self *C.QProgressBar, cb C.intptr_t, param1 *C.const_char) unsafe.Pointer {
...
func (this *QProgressBar) callVirtualBase_Metacall(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {

	return (int)(C.QProgressBar_virtualbase_metacall(unsafe.Pointer(this.h), (C.int)(param1), (C.int)(param2), param3))

}
func (this *QProgressBar) OnMetacall(slot func(super func(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int, param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int) {
	ok := C.QProgressBar_override_virtual_metacall(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}

//export miqt_exec_callback_QProgressBar_metacall
func miqt_exec_callback_QProgressBar_metacall(self *C.QProgressBar, cb C.intptr_t, param1 C.int, param2 C.int, param3 unsafe.Pointer) C.int {
	...
	virtualReturn := gofunc((&QProgressBar{h: self}).callVirtualBase_Metacall, slotval1, slotval2, slotval3)
