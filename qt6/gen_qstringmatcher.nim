...
proc indexIn*(self: gen_qstringmatcher_types.QStringMatcher, str: gen_qchar.QChar, length: int64): int64 =
...
proc indexIn*(self: gen_qstringmatcher_types.QStringMatcher, str: gen_qchar.QChar, length: int64, fromVal: int64): int64 =
