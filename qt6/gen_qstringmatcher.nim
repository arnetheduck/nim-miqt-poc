...
proc create*(T: type gen_qstringmatcher_types.QStringMatcher, uc: gen_qchar.QChar, len: int64): gen_qstringmatcher_types.QStringMatcher =

  gen_qstringmatcher_types.QStringMatcher.init(fcQStringMatcher_new3(uc.h, len))
proc create*(T: type gen_qstringmatcher_types.QStringMatcher, other: gen_qstringmatcher_types.QStringMatcher): gen_qstringmatcher_types.QStringMatcher =
...
proc create*(T: type gen_qstringmatcher_types.QStringMatcher, uc: gen_qchar.QChar, len: int64, cs: cint): gen_qstringmatcher_types.QStringMatcher =
...
proc indexIn2*(self: gen_qstringmatcher_types.QStringMatcher, str: gen_qchar.QChar, length: int64): int64 =
...
proc indexIn22*(self: gen_qstringmatcher_types.QStringMatcher, str: string, fromVal: int64): int64 =

  fcQStringMatcher_indexIn22(self.h, struct_miqt_string(data: str, len: csize_t(len(str))), fromVal)

proc indexIn3*(self: gen_qstringmatcher_types.QStringMatcher, str: gen_qchar.QChar, length: int64, fromVal: int64): int64 =
