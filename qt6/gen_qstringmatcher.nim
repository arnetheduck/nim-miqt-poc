...
proc create*(T: type QStringMatcher, uc: gen_qchar.QChar, len: int64): QStringMatcher =
...
proc create*(T: type QStringMatcher, uc: gen_qchar.QChar, len: int64, cs: gen_qnamespace.CaseSensitivity): QStringMatcher =
...
proc indexIn*(self: QStringMatcher, str: string): int64 =

  fcQStringMatcher_indexIn(self.h, struct_miqt_string(data: str, len: csize_t(len(str))))

proc indexIn2*(self: QStringMatcher, str: gen_qchar.QChar, length: int64): int64 =
...
proc indexIn22*(self: QStringMatcher, str: string, fromVal: int64): int64 =

  fcQStringMatcher_indexIn22(self.h, struct_miqt_string(data: str, len: csize_t(len(str))), fromVal)

proc indexIn3*(self: QStringMatcher, str: gen_qchar.QChar, length: int64, fromVal: int64): int64 =
