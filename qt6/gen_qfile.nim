...
proc link2*(_: type gen_qfile_types.QFile, fileName: string, newName: string): bool =
...
proc open2*(self: gen_qfile_types.QFile, flags: cint, permissions: cint): bool =

  fcQFile_open2(self.h, cint(flags), cint(permissions))

proc open4*(self: gen_qfile_types.QFile, fd: cint, ioFlags: cint): bool =
...
proc miqt_exec_callback_QFile_disconnectNotify(self: ptr cQFile, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QFile_disconnectNotify ".} =
  ...
  nimfunc[](slotval1)
proc staticMetaObject*(_: type gen_qfile_types.QFile): gen_qobjectdefs.QMetaObject =
