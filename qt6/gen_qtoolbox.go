...
func (this *QToolBox) Metacall(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {
	return (int)(C.QToolBox_metacall(this.h, (C.int)(param1), (C.int)(param2), param3))
}
...
func (this *QToolBox) callVirtualBase_MetaObject() *QMetaObject {
	...
	return newQMetaObject(C.QToolBox_virtualbase_metaObject(unsafe.Pointer(this.h)))

}
func (this *QToolBox) OnMetaObject(slot func(super func() *QMetaObject) *QMetaObject) {
	ok := C.QToolBox_override_virtual_metaObject(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
...
func miqt_exec_callback_QToolBox_metaObject(self *C.QToolBox, cb C.intptr_t) *C.QMetaObject {
...
func (this *QToolBox) callVirtualBase_Metacast(param1 string) unsafe.Pointer {
	...
	return (unsafe.Pointer)(C.QToolBox_virtualbase_metacast(unsafe.Pointer(this.h), param1_Cstring))

}
func (this *QToolBox) OnMetacast(slot func(super func(param1 string) unsafe.Pointer, param1 string) unsafe.Pointer) {
	ok := C.QToolBox_override_virtual_metacast(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func miqt_exec_callback_QToolBox_metacast(self *C.QToolBox, cb C.intptr_t, param1 *C.const_char) unsafe.Pointer {
...
func (this *QToolBox) callVirtualBase_Metacall(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {

	return (int)(C.QToolBox_virtualbase_metacall(unsafe.Pointer(this.h), (C.int)(param1), (C.int)(param2), param3))

}
func (this *QToolBox) OnMetacall(slot func(super func(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int, param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int) {
	ok := C.QToolBox_override_virtual_metacall(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}

//export miqt_exec_callback_QToolBox_metacall
func miqt_exec_callback_QToolBox_metacall(self *C.QToolBox, cb C.intptr_t, param1 C.int, param2 C.int, param3 unsafe.Pointer) C.int {
	...
	virtualReturn := gofunc((&QToolBox{h: self}).callVirtualBase_Metacall, slotval1, slotval2, slotval3)
...
func (this *QToolBox) OnInitStyleOption(slot func(super func(option *QStyleOptionFrame), option *QStyleOptionFrame)) {
	ok := C.QToolBox_override_virtual_initStyleOption(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func (this *QToolBox) callVirtualBase_EnterEvent(event *QEnterEvent) {

	C.QToolBox_virtualbase_enterEvent(unsafe.Pointer(this.h), event.cPointer())

}
func (this *QToolBox) OnEnterEvent(slot func(super func(event *QEnterEvent), event *QEnterEvent)) {
...
func miqt_exec_callback_QToolBox_enterEvent(self *C.QToolBox, cb C.intptr_t, event *C.QEnterEvent) {
...
func (this *QToolBox) callVirtualBase_NativeEvent(eventType []byte, message unsafe.Pointer, result *uintptr) bool {
	...
	return (bool)(C.QToolBox_virtualbase_nativeEvent(unsafe.Pointer(this.h), eventType_alias, message, (*C.intptr_t)(unsafe.Pointer(result))))

}
func (this *QToolBox) OnNativeEvent(slot func(super func(eventType []byte, message unsafe.Pointer, result *uintptr) bool, eventType []byte, message unsafe.Pointer, result *uintptr) bool) {
...
func miqt_exec_callback_QToolBox_nativeEvent(self *C.QToolBox, cb C.intptr_t, eventType C.struct_miqt_string, message unsafe.Pointer, result *C.intptr_t) C.bool {
