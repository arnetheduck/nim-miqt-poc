...
proc create*(T: type QQuaternion, scalar: float32, vector: gen_qvectornd.QVector3D): QQuaternion =

  QQuaternion.init(fcQQuaternion_new4(scalar, vector.h))
proc create*(T: type QQuaternion, vector: gen_qvectornd.QVector4D): QQuaternion =
...
proc vector*(self: QQuaternion, ): gen_qvectornd.QVector3D =

  gen_qvectornd.QVector3D(h: fcQQuaternion_vector(self.h))

proc setVector*(self: QQuaternion, vector: gen_qvectornd.QVector3D): void =
...
proc rotatedVector*(self: QQuaternion, vector: gen_qvectornd.QVector3D): gen_qvectornd.QVector3D =

  gen_qvectornd.QVector3D(h: fcQQuaternion_rotatedVector(self.h, vector.h))
...
proc toVector4D*(self: QQuaternion, ): gen_qvectornd.QVector4D =

  gen_qvectornd.QVector4D(h: fcQQuaternion_toVector4D(self.h))

proc ToQVariant*(self: QQuaternion, ): gen_qvariant.QVariant =

  gen_qvariant.QVariant(h: fcQQuaternion_ToQVariant(self.h))

proc getAxisAndAngle*(self: QQuaternion, axis: gen_qvectornd.QVector3D, angle: ptr float32): void =

  fcQQuaternion_getAxisAndAngle(self.h, axis.h, angle)

proc fromAxisAndAngle*(_: type QQuaternion, axis: gen_qvectornd.QVector3D, angle: float32): QQuaternion =
...
proc toEulerAngles*(self: QQuaternion, ): gen_qvectornd.QVector3D =

  gen_qvectornd.QVector3D(h: fcQQuaternion_toEulerAngles(self.h))

proc fromEulerAngles*(_: type QQuaternion, eulerAngles: gen_qvectornd.QVector3D): QQuaternion =
...
proc getAxes*(self: QQuaternion, xAxis: gen_qvectornd.QVector3D, yAxis: gen_qvectornd.QVector3D, zAxis: gen_qvectornd.QVector3D): void =

  fcQQuaternion_getAxes(self.h, xAxis.h, yAxis.h, zAxis.h)

proc fromAxes*(_: type QQuaternion, xAxis: gen_qvectornd.QVector3D, yAxis: gen_qvectornd.QVector3D, zAxis: gen_qvectornd.QVector3D): QQuaternion =

  QQuaternion(h: fcQQuaternion_fromAxes(xAxis.h, yAxis.h, zAxis.h))

proc fromDirection*(_: type QQuaternion, direction: gen_qvectornd.QVector3D, up: gen_qvectornd.QVector3D): QQuaternion =

  QQuaternion(h: fcQQuaternion_fromDirection(direction.h, up.h))

proc rotationTo*(_: type QQuaternion, fromVal: gen_qvectornd.QVector3D, to: gen_qvectornd.QVector3D): QQuaternion =
