...
QObject* QFileSystemWatcher_protectedbase_sender(const void* self) {
	return ( (const MiqtVirtualQFileSystemWatcher*)(self) )->protectedbase_sender();
}

int QFileSystemWatcher_protectedbase_senderSignalIndex(const void* self) {
	return ( (const MiqtVirtualQFileSystemWatcher*)(self) )->protectedbase_senderSignalIndex();
}

int QFileSystemWatcher_protectedbase_receivers(const void* self, const char* signal) {
	return ( (const MiqtVirtualQFileSystemWatcher*)(self) )->protectedbase_receivers(signal);
}

bool QFileSystemWatcher_protectedbase_isSignalConnected(const void* self, QMetaMethod* signal) {
	return ( (const MiqtVirtualQFileSystemWatcher*)(self) )->protectedbase_isSignalConnected(signal);
}
