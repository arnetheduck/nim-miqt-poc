...
func (this *QPdfWriter) callVirtualBase_MetaObject() *QMetaObject {
	...
	return newQMetaObject(C.QPdfWriter_virtualbase_metaObject(unsafe.Pointer(this.h)))

}
func (this *QPdfWriter) OnMetaObject(slot func(super func() *QMetaObject) *QMetaObject) {
	ok := C.QPdfWriter_override_virtual_metaObject(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
...
func miqt_exec_callback_QPdfWriter_metaObject(self *C.QPdfWriter, cb C.intptr_t) *C.QMetaObject {
...
func (this *QPdfWriter) callVirtualBase_Metacast(param1 string) unsafe.Pointer {
	...
	return (unsafe.Pointer)(C.QPdfWriter_virtualbase_metacast(unsafe.Pointer(this.h), param1_Cstring))

}
func (this *QPdfWriter) OnMetacast(slot func(super func(param1 string) unsafe.Pointer, param1 string) unsafe.Pointer) {
	ok := C.QPdfWriter_override_virtual_metacast(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func miqt_exec_callback_QPdfWriter_metacast(self *C.QPdfWriter, cb C.intptr_t, param1 *C.const_char) unsafe.Pointer {
