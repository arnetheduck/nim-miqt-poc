...
proc grabWindow*(self: QScreen, ): gen_qpixmap.QPixmap =
...
proc grabWindow1*(self: QScreen, window: uint): gen_qpixmap.QPixmap =
...
proc staticMetaObject*(_: type QScreen): gen_qobjectdefs.QMetaObject =
