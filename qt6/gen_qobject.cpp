...
public:
	...
	MiqtVirtualQObject(struct QObject_VTable* vtbl): QObject(), vtbl(vtbl) {};
	MiqtVirtualQObject(struct QObject_VTable* vtbl, QObject* parent): QObject(parent), vtbl(vtbl) {};

	virtual ~MiqtVirtualQObject() override { if(vtbl->destructor) vtbl->destructor(vtbl, this); }
...
QObject* QObject_new(struct QObject_VTable* vtbl) {
	return new MiqtVirtualQObject(vtbl);
}

QObject* QObject_new2(struct QObject_VTable* vtbl, QObject* parent) {
	return new MiqtVirtualQObject(vtbl, parent);
}
...
QObject* QObject_protectedbase_sender(const void* self) {
	return ( (const MiqtVirtualQObject*)(self) )->protectedbase_sender();
}

int QObject_protectedbase_senderSignalIndex(const void* self) {
	return ( (const MiqtVirtualQObject*)(self) )->protectedbase_senderSignalIndex();
}

int QObject_protectedbase_receivers(const void* self, const char* signal) {
	return ( (const MiqtVirtualQObject*)(self) )->protectedbase_receivers(signal);
}

bool QObject_protectedbase_isSignalConnected(const void* self, QMetaMethod* signal) {
	return ( (const MiqtVirtualQObject*)(self) )->protectedbase_isSignalConnected(signal);
}
