...
func (this *QIdentityProxyModel) Metacall(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {
	return (int)(C.QIdentityProxyModel_metacall(this.h, (C.int)(param1), (C.int)(param2), param3))
}
...
func miqt_exec_callback_QIdentityProxyModel_metaObject(self *C.QIdentityProxyModel, cb C.intptr_t) *C.QMetaObject {
...
func miqt_exec_callback_QIdentityProxyModel_metacast(self *C.QIdentityProxyModel, cb C.intptr_t, param1 *C.const_char) unsafe.Pointer {
...
func (this *QIdentityProxyModel) callVirtualBase_Metacall(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {

	return (int)(C.QIdentityProxyModel_virtualbase_metacall(unsafe.Pointer(this.h), (C.int)(param1), (C.int)(param2), param3))

}
func (this *QIdentityProxyModel) OnMetacall(slot func(super func(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int, param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int) {
	ok := C.QIdentityProxyModel_override_virtual_metacall(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}

//export miqt_exec_callback_QIdentityProxyModel_metacall
func miqt_exec_callback_QIdentityProxyModel_metacall(self *C.QIdentityProxyModel, cb C.intptr_t, param1 C.int, param2 C.int, param3 unsafe.Pointer) C.int {
	...
	virtualReturn := gofunc((&QIdentityProxyModel{h: self}).callVirtualBase_Metacall, slotval1, slotval2, slotval3)
