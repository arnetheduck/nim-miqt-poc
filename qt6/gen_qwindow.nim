...
proc parent*(self: QWindow, ): QWindow =
...
proc mapToGlobal*(self: QWindow, pos: gen_qpoint.QPointF): gen_qpoint.QPointF =

  gen_qpoint.QPointF(h: fcQWindow_mapToGlobal(self.h, pos.h))

proc mapFromGlobal*(self: QWindow, pos: gen_qpoint.QPointF): gen_qpoint.QPointF =

  gen_qpoint.QPointF(h: fcQWindow_mapFromGlobal(self.h, pos.h))

proc mapToGlobalWithPos*(self: QWindow, pos: gen_qpoint.QPoint): gen_qpoint.QPoint =

  gen_qpoint.QPoint(h: fcQWindow_mapToGlobalWithPos(self.h, pos.h))

proc mapFromGlobalWithPos*(self: QWindow, pos: gen_qpoint.QPoint): gen_qpoint.QPoint =

  gen_qpoint.QPoint(h: fcQWindow_mapFromGlobalWithPos(self.h, pos.h))
...
proc parent1*(self: QWindow, mode: QWindowAncestorMode): QWindow =
...
proc miqt_exec_callback_QWindow_resizeEvent(self: ptr cQWindow, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QWindow_resizeEvent ".} =
  ...
  nimfunc[](superCall, slotval1)
proc callVirtualBase_paintEvent(self: QWindow, param1: gen_qevent.QPaintEvent): void =


  fQWindow_virtualbase_paintEvent(self.h, param1.h)

type QWindowpaintEventBase* = proc(param1: gen_qevent.QPaintEvent): void
proc onpaintEvent*(self: QWindow, slot: proc(super: QWindowpaintEventBase, param1: gen_qevent.QPaintEvent): void) =
  # TODO check subclass
  type Cb = proc(super: QWindowpaintEventBase, param1: gen_qevent.QPaintEvent): void
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QWindow_paintEvent(self: ptr cQWindow, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QWindow_paintEvent ".} =
  ...
  proc superCall(param1: gen_qevent.QPaintEvent): auto =
    callVirtualBase_paintEvent(QWindow(h: self), param1)
...
proc miqt_exec_callback_QWindow_hideEvent(self: ptr cQWindow, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QWindow_hideEvent ".} =
  ...
  nimfunc[](superCall, slotval1)
proc callVirtualBase_closeEvent(self: QWindow, param1: gen_qevent.QCloseEvent): void =


  fQWindow_virtualbase_closeEvent(self.h, param1.h)

type QWindowcloseEventBase* = proc(param1: gen_qevent.QCloseEvent): void
proc oncloseEvent*(self: QWindow, slot: proc(super: QWindowcloseEventBase, param1: gen_qevent.QCloseEvent): void) =
  # TODO check subclass
  type Cb = proc(super: QWindowcloseEventBase, param1: gen_qevent.QCloseEvent): void
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QWindow_closeEvent(self: ptr cQWindow, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QWindow_closeEvent ".} =
  ...
  proc superCall(param1: gen_qevent.QCloseEvent): auto =
    callVirtualBase_closeEvent(QWindow(h: self), param1)
...
proc miqt_exec_callback_QWindow_tabletEvent(self: ptr cQWindow, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QWindow_tabletEvent ".} =
  ...
  nimfunc[](superCall, slotval1)
proc callVirtualBase_nativeEvent(self: QWindow, eventType: seq[byte], message: pointer, resultVal: ptr uint): bool =
...
type QWindownativeEventBase* = proc(eventType: seq[byte], message: pointer, resultVal: ptr uint): bool
proc onnativeEvent*(self: QWindow, slot: proc(super: QWindownativeEventBase, eventType: seq[byte], message: pointer, resultVal: ptr uint): bool) =
  # TODO check subclass
  type Cb = proc(super: QWindownativeEventBase, eventType: seq[byte], message: pointer, resultVal: ptr uint): bool
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
