...
const
  ...
  QStyleSE_LabelLayoutItem* = 35
  QStyleSE_ProgressBarLayoutItem* = 36
  QStyleSE_PushButtonLayoutItem* = 37
  QStyleSE_RadioButtonLayoutItem* = 38
  QStyleSE_SliderLayoutItem* = 39
  QStyleSE_SpinBoxLayoutItem* = 40
  QStyleSE_ToolButtonLayoutItem* = 41
  QStyleSE_FrameLayoutItem* = 42
  QStyleSE_GroupBoxLayoutItem* = 43
  QStyleSE_TabWidgetLayoutItem* = 44
  QStyleSE_ItemViewItemDecoration* = 45
  QStyleSE_ItemViewItemText* = 46
  QStyleSE_ItemViewItemFocusRect* = 47
  QStyleSE_TabBarTabLeftButton* = 48
  QStyleSE_TabBarTabRightButton* = 49
  QStyleSE_TabBarTabText* = 50
  QStyleSE_ShapedFrameContents* = 51
  QStyleSE_ToolBarHandle* = 52
  QStyleSE_TabBarScrollLeftButton* = 53
  QStyleSE_TabBarScrollRightButton* = 54
  QStyleSE_TabBarTearIndicatorRight* = 55
  QStyleSE_PushButtonBevel* = 56
...
const
  ...
  QStylePM_ToolBarIconSize* = 59
  QStylePM_ListViewIconSize* = 60
  QStylePM_IconViewIconSize* = 61
  QStylePM_SmallIconSize* = 62
  QStylePM_LargeIconSize* = 63
  QStylePM_FocusFrameVMargin* = 64
  QStylePM_FocusFrameHMargin* = 65
  QStylePM_ToolTipLabelFrameWidth* = 66
  QStylePM_CheckBoxLabelSpacing* = 67
  QStylePM_TabBarIconSize* = 68
  QStylePM_SizeGripSize* = 69
  QStylePM_DockWidgetTitleMargin* = 70
  QStylePM_MessageBoxIconSize* = 71
  QStylePM_ButtonIconSize* = 72
  QStylePM_DockWidgetTitleBarButtonMargin* = 73
  QStylePM_RadioButtonLabelSpacing* = 74
  QStylePM_LayoutLeftMargin* = 75
  QStylePM_LayoutTopMargin* = 76
  QStylePM_LayoutRightMargin* = 77
  QStylePM_LayoutBottomMargin* = 78
  QStylePM_LayoutHorizontalSpacing* = 79
  QStylePM_LayoutVerticalSpacing* = 80
  QStylePM_TabBar_ScrollButtonOverlap* = 81
  QStylePM_TextCursorWidth* = 82
  QStylePM_TabCloseIndicatorWidth* = 83
  QStylePM_TabCloseIndicatorHeight* = 84
  QStylePM_ScrollView_ScrollBarSpacing* = 85
  QStylePM_ScrollView_ScrollBarOverlap* = 86
  QStylePM_SubMenuOverlap* = 87
  QStylePM_TreeViewIndentation* = 88
  QStylePM_HeaderDefaultSectionSizeHorizontal* = 89
  QStylePM_HeaderDefaultSectionSizeVertical* = 90
  QStylePM_TitleBarButtonIconSize* = 91
  QStylePM_TitleBarButtonSize* = 92
  QStylePM_LineEditIconSize* = 93
  QStylePM_LineEditIconMargin* = 94
...
const
  ...
  QStyleSH_MessageBox_CenterButtons* = 72
  QStyleSH_Menu_SelectionWrap* = 73
  QStyleSH_ItemView_MovementWithoutUpdatingSelection* = 74
  QStyleSH_ToolTip_Mask* = 75
  QStyleSH_FocusFrame_AboveWidget* = 76
  QStyleSH_TextControl_FocusIndicatorTextCharFormat* = 77
  QStyleSH_WizardStyle* = 78
  QStyleSH_ItemView_ArrowKeysNavigateIntoChildren* = 79
  QStyleSH_Menu_Mask* = 80
  QStyleSH_Menu_FlashTriggeredItem* = 81
  QStyleSH_Menu_FadeOutOnHide* = 82
  QStyleSH_SpinBox_ClickAutoRepeatThreshold* = 83
  QStyleSH_ItemView_PaintAlternatingRowColorsForEmptyArea* = 84
  QStyleSH_FormLayoutWrapPolicy* = 85
  QStyleSH_TabWidget_DefaultTabPosition* = 86
  QStyleSH_ToolBar_Movable* = 87
  QStyleSH_FormLayoutFieldGrowthPolicy* = 88
  QStyleSH_FormLayoutFormAlignment* = 89
  QStyleSH_FormLayoutLabelAlignment* = 90
  QStyleSH_ItemView_DrawDelegateFrame* = 91
  QStyleSH_TabBar_CloseButtonPosition* = 92
  QStyleSH_DockWidget_ButtonsHaveFrame* = 93
  QStyleSH_ToolButtonStyle* = 94
  QStyleSH_RequestSoftwareInputPanel* = 95
  QStyleSH_ScrollBar_Transient* = 96
  QStyleSH_Menu_SupportsSections* = 97
  QStyleSH_ToolTip_WakeUpDelay* = 98
  QStyleSH_ToolTip_FallAsleepDelay* = 99
  QStyleSH_Widget_Animate* = 100
  QStyleSH_Splitter_OpaqueResize* = 101
  QStyleSH_ComboBox_UseNativePopup* = 102
  QStyleSH_LineEdit_PasswordMaskDelay* = 103
  QStyleSH_TabBar_ChangeCurrentDelay* = 104
  QStyleSH_Menu_SubMenuUniDirection* = 105
  QStyleSH_Menu_SubMenuUniDirectionFailCount* = 106
  QStyleSH_Menu_SubMenuSloppySelectOtherActions* = 107
  QStyleSH_Menu_SubMenuSloppyCloseTimeout* = 108
  QStyleSH_Menu_SubMenuResetWhenReenteringParent* = 109
  QStyleSH_Menu_SubMenuDontStartSloppyOnLeave* = 110
  QStyleSH_ItemView_ScrollMode* = 111
  QStyleSH_TitleBar_ShowToolTipsOnButtons* = 112
  QStyleSH_Widget_Animation_Duration* = 113
  QStyleSH_ComboBox_AllowWheelScrolling* = 114
  QStyleSH_SpinBox_ButtonsInsideFrame* = 115
  QStyleSH_SpinBox_StepModifier* = 116
  QStyleSH_TabBar_AllowWheelScrolling* = 117
  QStyleSH_Table_AlwaysDrawLeftTopGridLines* = 118
  QStyleSH_SpinBox_SelectOnStep* = 119
...
const
  ...
  QStyleSP_TabCloseButton* = 78
  QStyleNStandardPixmap* = 79
