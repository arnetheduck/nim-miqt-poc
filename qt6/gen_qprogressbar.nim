...
proc callVirtualBase_initStyleOption(self: QProgressBar, option: gen_qstyleoption.QStyleOptionProgressBar): void =


  fQProgressBar_virtualbase_initStyleOption(self.h, option.h)

type QProgressBarinitStyleOptionBase* = proc(option: gen_qstyleoption.QStyleOptionProgressBar): void
proc oninitStyleOption*(self: QProgressBar, slot: proc(super: QProgressBarinitStyleOptionBase, option: gen_qstyleoption.QStyleOptionProgressBar): void) =
  # TODO check subclass
  type Cb = proc(super: QProgressBarinitStyleOptionBase, option: gen_qstyleoption.QStyleOptionProgressBar): void
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QProgressBar_initStyleOption(self: ptr cQProgressBar, slot: int, option: pointer): void {.exportc: "miqt_exec_callback_QProgressBar_initStyleOption ".} =
  type Cb = proc(super: QProgressBarinitStyleOptionBase, option: gen_qstyleoption.QStyleOptionProgressBar): void
  var nimfunc = cast[ptr Cb](cast[pointer](slot))
  proc superCall(option: gen_qstyleoption.QStyleOptionProgressBar): auto =
    callVirtualBase_initStyleOption(QProgressBar(h: self), option)
  let slotval1 = gen_qstyleoption.QStyleOptionProgressBar(h: option)
...
proc miqt_exec_callback_QProgressBar_focusOutEvent(self: ptr cQProgressBar, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QProgressBar_focusOutEvent ".} =
  ...
  nimfunc[](superCall, slotval1)
proc callVirtualBase_enterEvent(self: QProgressBar, event: gen_qevent.QEnterEvent): void =


  fQProgressBar_virtualbase_enterEvent(self.h, event.h)

type QProgressBarenterEventBase* = proc(event: gen_qevent.QEnterEvent): void
proc onenterEvent*(self: QProgressBar, slot: proc(super: QProgressBarenterEventBase, event: gen_qevent.QEnterEvent): void) =
  # TODO check subclass
  type Cb = proc(super: QProgressBarenterEventBase, event: gen_qevent.QEnterEvent): void
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QProgressBar_hideEvent(self: ptr cQProgressBar, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QProgressBar_hideEvent ".} =
  ...
  nimfunc[](superCall, slotval1)
proc callVirtualBase_nativeEvent(self: QProgressBar, eventType: seq[byte], message: pointer, resultVal: ptr uint): bool =
...
type QProgressBarnativeEventBase* = proc(eventType: seq[byte], message: pointer, resultVal: ptr uint): bool
proc onnativeEvent*(self: QProgressBar, slot: proc(super: QProgressBarnativeEventBase, eventType: seq[byte], message: pointer, resultVal: ptr uint): bool) =
  # TODO check subclass
  type Cb = proc(super: QProgressBarnativeEventBase, eventType: seq[byte], message: pointer, resultVal: ptr uint): bool
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
