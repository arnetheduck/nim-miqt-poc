...
func (this *QMenu) Metacall(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {
	return (int)(C.QMenu_metacall(this.h, (C.int)(param1), (C.int)(param2), param3))
}
...
func QMenu_MenuInAction(action *QAction) *QMenu {
	return newQMenu(C.QMenu_menuInAction(action.cPointer()))
}
...
func (this *QMenu) callVirtualBase_MetaObject() *QMetaObject {
	...
	return newQMetaObject(C.QMenu_virtualbase_metaObject(unsafe.Pointer(this.h)))

}
func (this *QMenu) OnmetaObject(slot func(super func() *QMetaObject) *QMetaObject) {
	ok := C.QMenu_override_virtual_metaObject(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
...
func miqt_exec_callback_QMenu_metaObject(self *C.QMenu, cb C.intptr_t) *C.QMetaObject {
...
func (this *QMenu) callVirtualBase_Metacast(param1 string) unsafe.Pointer {
	...
	return (unsafe.Pointer)(C.QMenu_virtualbase_metacast(unsafe.Pointer(this.h), param1_Cstring))

}
func (this *QMenu) Onmetacast(slot func(super func(param1 string) unsafe.Pointer, param1 string) unsafe.Pointer) {
	ok := C.QMenu_override_virtual_metacast(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func miqt_exec_callback_QMenu_metacast(self *C.QMenu, cb C.intptr_t, param1 *C.const_char) unsafe.Pointer {
...
func (this *QMenu) callVirtualBase_Metacall(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {

	return (int)(C.QMenu_virtualbase_metacall(unsafe.Pointer(this.h), (C.int)(param1), (C.int)(param2), param3))

}
func (this *QMenu) OnMetacall(slot func(super func(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int, param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int) {
	ok := C.QMenu_override_virtual_metacall(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}

//export miqt_exec_callback_QMenu_metacall
func miqt_exec_callback_QMenu_metacall(self *C.QMenu, cb C.intptr_t, param1 C.int, param2 C.int, param3 unsafe.Pointer) C.int {
	...
	virtualReturn := gofunc((&QMenu{h: self}).callVirtualBase_Metacall, slotval1, slotval2, slotval3)
...
func miqt_exec_callback_QMenu_enterEvent(self *C.QMenu, cb C.intptr_t, param1 *C.QEnterEvent) {
...
func (this *QMenu) callVirtualBase_InitStyleOption(option *QStyleOptionMenuItem, action *QAction) {
	...
	C.QMenu_virtualbase_initStyleOption(unsafe.Pointer(this.h), option.cPointer(), action.cPointer())
...
func (this *QMenu) OnInitStyleOption(slot func(super func(option *QStyleOptionMenuItem, action *QAction), option *QStyleOptionMenuItem, action *QAction)) {
	ok := C.QMenu_override_virtual_initStyleOption(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func miqt_exec_callback_QMenu_initStyleOption(self *C.QMenu, cb C.intptr_t, option *C.QStyleOptionMenuItem, action *C.QAction) {
...
func (this *QMenu) callVirtualBase_NativeEvent(eventType []byte, message unsafe.Pointer, result *uintptr) bool {
	...
	return (bool)(C.QMenu_virtualbase_nativeEvent(unsafe.Pointer(this.h), eventType_alias, message, (*C.intptr_t)(unsafe.Pointer(result))))
...
func miqt_exec_callback_QMenu_nativeEvent(self *C.QMenu, cb C.intptr_t, eventType C.struct_miqt_string, message unsafe.Pointer, result *C.intptr_t) C.bool {
