...
func (this *QWidget) Metacall(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {
	return (int)(C.QWidget_metacall(this.h, (C.int)(param1), (C.int)(param2), param3))
}
...
func (this *QWidget) MapToGlobal(param1 *QPointF) *QPointF {
	_goptr := newQPointF(C.QWidget_mapToGlobal(this.h, param1.cPointer()))
	_goptr.GoGC() // Qt uses pass-by-value semantics for this type. Mimic with finalizer
	return _goptr
}

func (this *QWidget) MapToGlobalWithQPoint(param1 *QPoint) *QPoint {
	_goptr := newQPoint(C.QWidget_mapToGlobalWithQPoint(this.h, param1.cPointer()))
	_goptr.GoGC() // Qt uses pass-by-value semantics for this type. Mimic with finalizer
	return _goptr
}

func (this *QWidget) MapFromGlobal(param1 *QPointF) *QPointF {
	_goptr := newQPointF(C.QWidget_mapFromGlobal(this.h, param1.cPointer()))
	_goptr.GoGC() // Qt uses pass-by-value semantics for this type. Mimic with finalizer
	return _goptr
}

func (this *QWidget) MapFromGlobalWithQPoint(param1 *QPoint) *QPoint {
	_goptr := newQPoint(C.QWidget_mapFromGlobalWithQPoint(this.h, param1.cPointer()))
	_goptr.GoGC() // Qt uses pass-by-value semantics for this type. Mimic with finalizer
	return _goptr
}

func (this *QWidget) MapToParent(param1 *QPointF) *QPointF {
	_goptr := newQPointF(C.QWidget_mapToParent(this.h, param1.cPointer()))
	_goptr.GoGC() // Qt uses pass-by-value semantics for this type. Mimic with finalizer
	return _goptr
}

func (this *QWidget) MapToParentWithQPoint(param1 *QPoint) *QPoint {
	_goptr := newQPoint(C.QWidget_mapToParentWithQPoint(this.h, param1.cPointer()))
	_goptr.GoGC() // Qt uses pass-by-value semantics for this type. Mimic with finalizer
	return _goptr
}

func (this *QWidget) MapFromParent(param1 *QPointF) *QPointF {
	_goptr := newQPointF(C.QWidget_mapFromParent(this.h, param1.cPointer()))
	_goptr.GoGC() // Qt uses pass-by-value semantics for this type. Mimic with finalizer
	return _goptr
}

func (this *QWidget) MapFromParentWithQPoint(param1 *QPoint) *QPoint {
	_goptr := newQPoint(C.QWidget_mapFromParentWithQPoint(this.h, param1.cPointer()))
	_goptr.GoGC() // Qt uses pass-by-value semantics for this type. Mimic with finalizer
	return _goptr
}

func (this *QWidget) MapTo(param1 *QWidget, param2 *QPointF) *QPointF {
	_goptr := newQPointF(C.QWidget_mapTo(this.h, param1.cPointer(), param2.cPointer()))
	_goptr.GoGC() // Qt uses pass-by-value semantics for this type. Mimic with finalizer
	return _goptr
}

func (this *QWidget) MapTo2(param1 *QWidget, param2 *QPoint) *QPoint {
	_goptr := newQPoint(C.QWidget_mapTo2(this.h, param1.cPointer(), param2.cPointer()))
	_goptr.GoGC() // Qt uses pass-by-value semantics for this type. Mimic with finalizer
	return _goptr
}

func (this *QWidget) MapFrom(param1 *QWidget, param2 *QPointF) *QPointF {
	_goptr := newQPointF(C.QWidget_mapFrom(this.h, param1.cPointer(), param2.cPointer()))
	_goptr.GoGC() // Qt uses pass-by-value semantics for this type. Mimic with finalizer
	return _goptr
}

func (this *QWidget) MapFrom2(param1 *QWidget, param2 *QPoint) *QPoint {
	_goptr := newQPoint(C.QWidget_mapFrom2(this.h, param1.cPointer(), param2.cPointer()))
	_goptr.GoGC() // Qt uses pass-by-value semantics for this type. Mimic with finalizer
	return _goptr
}
...
func (this *QWidget) AddActionWithText(text string) *QAction {
	...
	return newQAction(C.QWidget_addActionWithText(this.h, text_ms))
}
...
func (this *QWidget) AddAction2(icon *QIcon, text string) *QAction {
	...
	text_ms.len = C.size_t(len(text))
	defer C.free(unsafe.Pointer(text_ms.data))
	return newQAction(C.QWidget_addAction2(this.h, icon.cPointer(), text_ms))
}
...
func (this *QWidget) AddAction3(text string, shortcut *QKeySequence) *QAction {
	...
	text_ms.len = C.size_t(len(text))
	defer C.free(unsafe.Pointer(text_ms.data))
	return newQAction(C.QWidget_addAction3(this.h, text_ms, shortcut.cPointer()))
}
...
func (this *QWidget) AddAction4(icon *QIcon, text string, shortcut *QKeySequence) *QAction {
	...
	text_ms.len = C.size_t(len(text))
	defer C.free(unsafe.Pointer(text_ms.data))
	return newQAction(C.QWidget_addAction4(this.h, icon.cPointer(), text_ms, shortcut.cPointer()))
}
...
func (this *QWidget) SetScreen(screen *QScreen) {
	C.QWidget_setScreen(this.h, screen.cPointer())
}
...
func (this *QWidget) callVirtualBase_MetaObject() *QMetaObject {
	...
	return newQMetaObject(C.QWidget_virtualbase_metaObject(unsafe.Pointer(this.h)))

}
func (this *QWidget) OnmetaObject(slot func(super func() *QMetaObject) *QMetaObject) {
	ok := C.QWidget_override_virtual_metaObject(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
...
func miqt_exec_callback_QWidget_metaObject(self *C.QWidget, cb C.intptr_t) *C.QMetaObject {
...
func (this *QWidget) callVirtualBase_Metacast(param1 string) unsafe.Pointer {
	...
	return (unsafe.Pointer)(C.QWidget_virtualbase_metacast(unsafe.Pointer(this.h), param1_Cstring))

}
func (this *QWidget) Onmetacast(slot func(super func(param1 string) unsafe.Pointer, param1 string) unsafe.Pointer) {
	ok := C.QWidget_override_virtual_metacast(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func miqt_exec_callback_QWidget_metacast(self *C.QWidget, cb C.intptr_t, param1 *C.const_char) unsafe.Pointer {
...
func (this *QWidget) callVirtualBase_Metacall(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {

	return (int)(C.QWidget_virtualbase_metacall(unsafe.Pointer(this.h), (C.int)(param1), (C.int)(param2), param3))

}
func (this *QWidget) OnMetacall(slot func(super func(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int, param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int) {
	ok := C.QWidget_override_virtual_metacall(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}

//export miqt_exec_callback_QWidget_metacall
func miqt_exec_callback_QWidget_metacall(self *C.QWidget, cb C.intptr_t, param1 C.int, param2 C.int, param3 unsafe.Pointer) C.int {
	...
	virtualReturn := gofunc((&QWidget{h: self}).callVirtualBase_Metacall, slotval1, slotval2, slotval3)
...
func miqt_exec_callback_QWidget_enterEvent(self *C.QWidget, cb C.intptr_t, event *C.QEnterEvent) {
...
func miqt_exec_callback_QWidget_nativeEvent(self *C.QWidget, cb C.intptr_t, eventType C.struct_miqt_string, message unsafe.Pointer, result *C.intptr_t) C.bool {
