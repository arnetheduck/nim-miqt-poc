...
proc callVirtualBase_metaObject(self: QCommonStyle, ): gen_qobjectdefs.QMetaObject =


  gen_qobjectdefs.QMetaObject(h: fQCommonStyle_virtualbase_metaObject(self.h))

type QCommonStylemetaObjectBase* = proc(): gen_qobjectdefs.QMetaObject
proc onmetaObject*(self: QCommonStyle, slot: proc(super: QCommonStylemetaObjectBase): gen_qobjectdefs.QMetaObject) =
  # TODO check subclass
  type Cb = proc(super: QCommonStylemetaObjectBase): gen_qobjectdefs.QMetaObject
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QCommonStyle_metaObject(self: ptr cQCommonStyle, slot: int): pointer {.exportc: "miqt_exec_callback_QCommonStyle_metaObject ".} =
  ...
  proc superCall(): auto =
    callVirtualBase_metaObject(QCommonStyle(h: self), )

  let virtualReturn = nimfunc[](superCall )

  virtualReturn.h
proc callVirtualBase_metacast(self: QCommonStyle, param1: cstring): pointer =


  fQCommonStyle_virtualbase_metacast(self.h, param1)

type QCommonStylemetacastBase* = proc(param1: cstring): pointer
proc onmetacast*(self: QCommonStyle, slot: proc(super: QCommonStylemetacastBase, param1: cstring): pointer) =
  # TODO check subclass
  type Cb = proc(super: QCommonStylemetacastBase, param1: cstring): pointer
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QCommonStyle_metacast(self: ptr cQCommonStyle, slot: int, param1: cstring): pointer {.exportc: "miqt_exec_callback_QCommonStyle_metacast ".} =
  ...
  proc superCall(param1: cstring): auto =
    callVirtualBase_metacast(QCommonStyle(h: self), param1)
  let slotval1 = (param1)
