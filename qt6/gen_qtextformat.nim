...
const
  ...
  QTextFormatFontLetterSpacingType* = 8169
  QTextFormatFontStretch* = 8170
  ...
  QTextFormatTextUnderlineColor* = 8224
  ...
  QTextFormatTextSuperScriptBaseline* = 8229
  QTextFormatTextSubScriptBaseline* = 8230
  QTextFormatTextBaselineOffset* = 8231
  QTextFormatIsAnchor* = 8240
  QTextFormatAnchorHref* = 8241
  QTextFormatAnchorName* = 8242
  QTextFormatOldFontLetterSpacingType* = 8243
  QTextFormatOldFontStretch* = 8244
  QTextFormatOldTextUnderlineColor* = 8208
  QTextFormatOldFontFamily* = 8192
...
proc setFont*(self: QTextCharFormat, font: gen_qfont.QFont): void =
...
proc setSuperScriptBaseline*(self: QTextCharFormat, baseline: float64): void =

  fcQTextCharFormat_setSuperScriptBaseline(self.h, baseline)

proc superScriptBaseline*(self: QTextCharFormat, ): float64 =

  fcQTextCharFormat_superScriptBaseline(self.h)

proc setSubScriptBaseline*(self: QTextCharFormat, baseline: float64): void =

  fcQTextCharFormat_setSubScriptBaseline(self.h, baseline)

proc subScriptBaseline*(self: QTextCharFormat, ): float64 =

  fcQTextCharFormat_subScriptBaseline(self.h)

proc setBaselineOffset*(self: QTextCharFormat, baseline: float64): void =

  fcQTextCharFormat_setBaselineOffset(self.h, baseline)

proc baselineOffset*(self: QTextCharFormat, ): float64 =
...
proc setFont2*(self: QTextCharFormat, font: gen_qfont.QFont, behavior: QTextCharFormatFontPropertiesInheritanceBehavior): void =
...
proc setQuality*(self: QTextImageFormat, quality: cint): void =

  fcQTextImageFormat_setQuality(self.h, quality)

proc setQuality2*(self: QTextImageFormat, ): void =
