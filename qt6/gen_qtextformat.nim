...
proc setFont*(self: gen_qtextformat_types.QTextCharFormat, font: gen_qfont.QFont): void =
...
proc setFont2*(self: gen_qtextformat_types.QTextCharFormat, font: gen_qfont.QFont, behavior: cint): void =
...
proc setQuality2*(self: gen_qtextformat_types.QTextImageFormat, ): void =
