...
func (this *QCalendarWidget) Metacall(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {
	return (int)(C.QCalendarWidget_metacall(this.h, (C.int)(param1), (C.int)(param2), param3))
}
...
func miqt_exec_callback_QCalendarWidget_metaObject(self *C.QCalendarWidget, cb C.intptr_t) *C.QMetaObject {
...
func miqt_exec_callback_QCalendarWidget_metacast(self *C.QCalendarWidget, cb C.intptr_t, param1 *C.const_char) unsafe.Pointer {
...
func (this *QCalendarWidget) callVirtualBase_Metacall(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {

	return (int)(C.QCalendarWidget_virtualbase_metacall(unsafe.Pointer(this.h), (C.int)(param1), (C.int)(param2), param3))

}
func (this *QCalendarWidget) OnMetacall(slot func(super func(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int, param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int) {
	ok := C.QCalendarWidget_override_virtual_metacall(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}

//export miqt_exec_callback_QCalendarWidget_metacall
func miqt_exec_callback_QCalendarWidget_metacall(self *C.QCalendarWidget, cb C.intptr_t, param1 C.int, param2 C.int, param3 unsafe.Pointer) C.int {
	...
	virtualReturn := gofunc((&QCalendarWidget{h: self}).callVirtualBase_Metacall, slotval1, slotval2, slotval3)
...
func miqt_exec_callback_QCalendarWidget_enterEvent(self *C.QCalendarWidget, cb C.intptr_t, event *C.QEnterEvent) {
...
func (this *QCalendarWidget) callVirtualBase_NativeEvent(eventType []byte, message unsafe.Pointer, result *uintptr) bool {
	...
	return (bool)(C.QCalendarWidget_virtualbase_nativeEvent(unsafe.Pointer(this.h), eventType_alias, message, (*C.intptr_t)(unsafe.Pointer(result))))
...
func miqt_exec_callback_QCalendarWidget_nativeEvent(self *C.QCalendarWidget, cb C.intptr_t, eventType C.struct_miqt_string, message unsafe.Pointer, result *C.intptr_t) C.bool {
