...
public:
	...
	QMetaObject* virtualbase_metaObject() const {
		...
		return (QMetaObject*) QGuiApplication::metaObject();
	...
	int virtualbase_metacall(int param1, int param2, void** param3) {
		...
		return QGuiApplication::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
	...
	void* protectedbase_resolveInterface(const char* name, int revision) const {
		...
		return QGuiApplication::resolveInterface(name, static_cast<int>(revision));
...
QMetaObject* QGuiApplication_virtualbase_metaObject(const void* self) {
	return ( (const MiqtVirtualQGuiApplication*)(self) )->virtualbase_metaObject();
}

void* QGuiApplication_virtualbase_metacast(void* self, const char* param1) {
	return ( (MiqtVirtualQGuiApplication*)(self) )->virtualbase_metacast(param1);
}

int QGuiApplication_virtualbase_metacall(void* self, int param1, int param2, void** param3) {
	return ( (MiqtVirtualQGuiApplication*)(self) )->virtualbase_metacall(param1, param2, param3);
}
...
void* QGuiApplication_protectedbase_resolveInterface(const void* self, const char* name, int revision) {
	return ( (const MiqtVirtualQGuiApplication*)(self) )->protectedbase_resolveInterface(name, revision);
}
