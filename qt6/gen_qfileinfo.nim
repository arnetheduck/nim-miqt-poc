...
proc create*(T: type QFileInfo, file: gen_qfiledevice.QFileDevice): QFileInfo =
...
proc setFileWithFile*(self: QFileInfo, file: gen_qfiledevice.QFileDevice): void =
...
proc isAlias*(self: QFileInfo, ): bool =
...
proc junctionTarget*(self: QFileInfo, ): string =
