...
proc pixmap*(self: gen_qicon_types.QIcon, size: gen_qsize.QSize, devicePixelRatio: float64): gen_qpixmap.QPixmap =
...
proc pixmap*(self: gen_qicon_types.QIcon, size: gen_qsize.QSize, devicePixelRatio: float64, mode: cint): gen_qpixmap.QPixmap =
  gen_qpixmap.QPixmap(h: fcQIcon_pixmap35(self.h, size.h, devicePixelRatio, cint(mode)))

proc pixmap*(self: gen_qicon_types.QIcon, size: gen_qsize.QSize, devicePixelRatio: float64, mode: cint, state: cint): gen_qpixmap.QPixmap =
