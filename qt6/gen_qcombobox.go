...
func miqt_exec_callback_QComboBox_metaObject(self *C.QComboBox, cb C.intptr_t) *C.QMetaObject {
...
func miqt_exec_callback_QComboBox_metacast(self *C.QComboBox, cb C.intptr_t, param1 *C.const_char) unsafe.Pointer {
