...
public:
	...
	MiqtVirtualQPaintEngine(struct QPaintEngine_VTable* vtbl): QPaintEngine(), vtbl(vtbl) {};
	MiqtVirtualQPaintEngine(struct QPaintEngine_VTable* vtbl, QPaintEngine::PaintEngineFeatures features): QPaintEngine(features), vtbl(vtbl) {};

	virtual ~MiqtVirtualQPaintEngine() override { if(vtbl->destructor) vtbl->destructor(vtbl, this); }
	...
	// Wrapper to allow calling protected method
	QPixmap* virtualbase_createPixmap(QSize* size) {

		return new QPixmap(QPaintEngine::createPixmap(*size));
	...
	// Wrapper to allow calling protected method
	QPixmap* virtualbase_createPixmapFromImage(QImage* image, int flags) {

		return new QPixmap(QPaintEngine::createPixmapFromImage(*image, static_cast<Qt::ImageConversionFlags>(flags)));
...
QPaintEngine* QPaintEngine_new(struct QPaintEngine_VTable* vtbl) {
	return new MiqtVirtualQPaintEngine(vtbl);
}

QPaintEngine* QPaintEngine_new2(struct QPaintEngine_VTable* vtbl, int features) {
	return new MiqtVirtualQPaintEngine(vtbl, static_cast<QPaintEngine::PaintEngineFeatures>(features));
}
...
QPixmap* QPaintEngine_virtualbase_createPixmap(void* self, QSize* size) {
	return ( (MiqtVirtualQPaintEngine*)(self) )->virtualbase_createPixmap(size);
}
