...
proc fcQMenuBar_virtualbase_initStyleOption(self: pointer, option: pointer, action: pointer): void {.importc: "QMenuBar_virtualbase_initStyleOption".}
...
proc fcQMenuBar_virtualbase_nativeEvent(self: pointer, eventType: struct_miqt_string, message: pointer, resultVal: ptr uint): bool {.importc: "QMenuBar_virtualbase_nativeEvent".}
...
type QMenuBarinitStyleOptionProc* = proc(self: QMenuBar, option: gen_qstyleoption_types.QStyleOptionMenuItem, action: gen_qaction_types.QAction): void {.raises: [], gcsafe.}
...
type QMenuBarenterEventProc* = proc(self: QMenuBar, event: gen_qevent_types.QEnterEvent): void {.raises: [], gcsafe.}
...
type QMenuBarVTable* = object
  ...
  initStyleOption*: QMenuBarinitStyleOptionProc
...
proc QMenuBarinitStyleOption*(self: gen_qmenubar_types.QMenuBar, option: gen_qstyleoption_types.QStyleOptionMenuItem, action: gen_qaction_types.QAction): void =
  fcQMenuBar_virtualbase_initStyleOption(self.h, option.h, action.h)

proc miqt_exec_callback_cQMenuBar_initStyleOption(vtbl: pointer, self: pointer, option: pointer, action: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QMenuBarVTable](vtbl)
  let self = QMenuBar(h: self)
...
proc miqt_exec_callback_cQMenuBar_nativeEvent(vtbl: pointer, self: pointer, eventType: struct_miqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let vtbl = cast[ptr QMenuBarVTable](vtbl)
  let self = QMenuBar(h: self)
...
proc sender*(self: gen_qmenubar_types.QMenuBar, ): gen_qobject_types.QObject =
  gen_qobject_types.QObject(h: fcQMenuBar_protectedbase_sender(self.h))
...
proc create*(T: type gen_qmenubar_types.QMenuBar,
  ...
  if not isNil(vtbl.initStyleOption):
    vtbl[].vtbl.initStyleOption = miqt_exec_callback_cQMenuBar_initStyleOption
