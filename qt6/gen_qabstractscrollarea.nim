...
proc fcQAbstractScrollArea_virtualbase_initStyleOption(self: pointer, option: pointer): void {.importc: "QAbstractScrollArea_virtualbase_initStyleOption".}
...
proc fcQAbstractScrollArea_virtualbase_nativeEvent(self: pointer, eventType: struct_miqt_string, message: pointer, resultVal: ptr uint): bool {.importc: "QAbstractScrollArea_virtualbase_nativeEvent".}
...
type QAbstractScrollAreainitStyleOptionProc* = proc(self: QAbstractScrollArea, option: gen_qstyleoption_types.QStyleOptionFrame): void {.raises: [], gcsafe.}
...
type QAbstractScrollAreaenterEventProc* = proc(self: QAbstractScrollArea, event: gen_qevent_types.QEnterEvent): void {.raises: [], gcsafe.}
...
type QAbstractScrollAreaVTable* = object
  ...
  initStyleOption*: QAbstractScrollAreainitStyleOptionProc
...
proc QAbstractScrollAreainitStyleOption*(self: gen_qabstractscrollarea_types.QAbstractScrollArea, option: gen_qstyleoption_types.QStyleOptionFrame): void =
  fcQAbstractScrollArea_virtualbase_initStyleOption(self.h, option.h)

proc miqt_exec_callback_cQAbstractScrollArea_initStyleOption(vtbl: pointer, self: pointer, option: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QAbstractScrollAreaVTable](vtbl)
  let self = QAbstractScrollArea(h: self)
...
proc QAbstractScrollAreaenterEvent*(self: gen_qabstractscrollarea_types.QAbstractScrollArea, event: gen_qevent_types.QEnterEvent): void =
...
proc miqt_exec_callback_cQAbstractScrollArea_nativeEvent(vtbl: pointer, self: pointer, eventType: struct_miqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let vtbl = cast[ptr QAbstractScrollAreaVTable](vtbl)
  let self = QAbstractScrollArea(h: self)
...
proc create*(T: type gen_qabstractscrollarea_types.QAbstractScrollArea,
  ...
  if not isNil(vtbl.initStyleOption):
    vtbl[].vtbl.initStyleOption = miqt_exec_callback_cQAbstractScrollArea_initStyleOption
