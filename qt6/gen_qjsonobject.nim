...
proc size*(self: QJsonObject, ): int64 =

  fcQJsonObject_size(self.h)

proc count*(self: QJsonObject, ): int64 =

  fcQJsonObject_count(self.h)

proc length*(self: QJsonObject, ): int64 =
...
proc create*(T: type QJsonObjectiterator, obj: QJsonObject, index: int64): QJsonObjectiterator =

  QJsonObjectiterator.init(fcQJsonObjectiterator_new2(obj.h, index))
proc create*(T: type QJsonObjectiterator, other: QJsonObjectiterator): QJsonObjectiterator =

  QJsonObjectiterator.init(fcQJsonObjectiterator_new3(other.h))
proc operatorAssign*(self: QJsonObjectiterator, other: QJsonObjectiterator): void =
...
proc operatorMinusGreater*(self: QJsonObjectiterator, ): gen_qjsonvalue.QJsonValueConstRef =

  gen_qjsonvalue.QJsonValueConstRef(h: fcQJsonObjectiterator_operatorMinusGreater(self.h))

proc operatorMinusGreater2*(self: QJsonObjectiterator, ): gen_qjsonvalue.QJsonValueRef =

  gen_qjsonvalue.QJsonValueRef(h: fcQJsonObjectiterator_operatorMinusGreater2(self.h))

proc operatorSubscript*(self: QJsonObjectiterator, j: int64): gen_qjsonvalue.QJsonValueRef =
...
proc operatorPlus*(self: QJsonObjectiterator, j: int64): QJsonObjectiterator =

  QJsonObjectiterator(h: fcQJsonObjectiterator_operatorPlus(self.h, j))

proc operatorMinus*(self: QJsonObjectiterator, j: int64): QJsonObjectiterator =

  QJsonObjectiterator(h: fcQJsonObjectiterator_operatorMinus(self.h, j))

proc operatorPlusAssign*(self: QJsonObjectiterator, j: int64): QJsonObjectiterator =

  QJsonObjectiterator(h: fcQJsonObjectiterator_operatorPlusAssign(self.h, j))

proc operatorMinusAssign*(self: QJsonObjectiterator, j: int64): QJsonObjectiterator =

  QJsonObjectiterator(h: fcQJsonObjectiterator_operatorMinusAssign(self.h, j))

proc operatorMinusWithQJsonObjectiterator*(self: QJsonObjectiterator, j: QJsonObjectiterator): int64 =
...
proc create*(T: type QJsonObjectconst_iterator, obj: QJsonObject, index: int64): QJsonObjectconst_iterator =
...
proc create2*(T: type QJsonObjectconst_iterator, other: QJsonObjectconst_iterator): QJsonObjectconst_iterator =

  QJsonObjectconst_iterator.init(fcQJsonObjectconst_iterator_new4(other.h))
proc operatorAssign*(self: QJsonObjectconst_iterator, other: QJsonObjectconst_iterator): void =
...
proc value*(self: QJsonObjectconst_iterator, ): gen_qjsonvalue.QJsonValueConstRef =

  gen_qjsonvalue.QJsonValueConstRef(h: fcQJsonObjectconst_iterator_value(self.h))

proc operatorMultiply*(self: QJsonObjectconst_iterator, ): gen_qjsonvalue.QJsonValueConstRef =

  gen_qjsonvalue.QJsonValueConstRef(h: fcQJsonObjectconst_iterator_operatorMultiply(self.h))

proc operatorMinusGreater*(self: QJsonObjectconst_iterator, ): gen_qjsonvalue.QJsonValueConstRef =

  gen_qjsonvalue.QJsonValueConstRef(h: fcQJsonObjectconst_iterator_operatorMinusGreater(self.h))

proc operatorSubscript*(self: QJsonObjectconst_iterator, j: int64): gen_qjsonvalue.QJsonValueConstRef =
...
proc operatorPlus*(self: QJsonObjectconst_iterator, j: int64): QJsonObjectconst_iterator =

  QJsonObjectconst_iterator(h: fcQJsonObjectconst_iterator_operatorPlus(self.h, j))

proc operatorMinus*(self: QJsonObjectconst_iterator, j: int64): QJsonObjectconst_iterator =

  QJsonObjectconst_iterator(h: fcQJsonObjectconst_iterator_operatorMinus(self.h, j))

proc operatorPlusAssign*(self: QJsonObjectconst_iterator, j: int64): QJsonObjectconst_iterator =

  QJsonObjectconst_iterator(h: fcQJsonObjectconst_iterator_operatorPlusAssign(self.h, j))

proc operatorMinusAssign*(self: QJsonObjectconst_iterator, j: int64): QJsonObjectconst_iterator =

  QJsonObjectconst_iterator(h: fcQJsonObjectconst_iterator_operatorMinusAssign(self.h, j))

proc operatorMinusWithQJsonObjectconstIterator*(self: QJsonObjectconst_iterator, j: QJsonObjectconst_iterator): int64 =
