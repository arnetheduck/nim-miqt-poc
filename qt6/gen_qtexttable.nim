...
proc fcQTextTable_protectedbase_setFormat(self: pointer, format: pointer): void {.importc: "QTextTable_protectedbase_setFormat".}
...
proc setFormat*(self: gen_qtexttable_types.QTextTable, format: gen_qtextformat_types.QTextFormat): void =
  fcQTextTable_protectedbase_setFormat(self.h, format.h)
