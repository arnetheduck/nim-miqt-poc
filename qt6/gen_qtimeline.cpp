...
public:
	...
	MiqtVirtualQTimeLine(struct QTimeLine_VTable* vtbl): QTimeLine(), vtbl(vtbl) {};
	MiqtVirtualQTimeLine(struct QTimeLine_VTable* vtbl, int duration): QTimeLine(duration), vtbl(vtbl) {};
	MiqtVirtualQTimeLine(struct QTimeLine_VTable* vtbl, int duration, QObject* parent): QTimeLine(duration, parent), vtbl(vtbl) {};

	virtual ~MiqtVirtualQTimeLine() override { if(vtbl->destructor) vtbl->destructor(vtbl, this); }
	...
	int virtualbase_metacall(int param1, int param2, void** param3) {
		...
		return QTimeLine::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
QTimeLine* QTimeLine_new(struct QTimeLine_VTable* vtbl) {
	return new MiqtVirtualQTimeLine(vtbl);
}

QTimeLine* QTimeLine_new2(struct QTimeLine_VTable* vtbl, int duration) {
	return new MiqtVirtualQTimeLine(vtbl, static_cast<int>(duration));
}

QTimeLine* QTimeLine_new3(struct QTimeLine_VTable* vtbl, int duration, QObject* parent) {
	return new MiqtVirtualQTimeLine(vtbl, static_cast<int>(duration), parent);
}
...
int QTimeLine_virtualbase_metacall(void* self, int param1, int param2, void** param3) {
	return ( (MiqtVirtualQTimeLine*)(self) )->virtualbase_metacall(param1, param2, param3);
}
...
QObject* QTimeLine_protectedbase_sender(const void* self) {
	return ( (const MiqtVirtualQTimeLine*)(self) )->protectedbase_sender();
}

int QTimeLine_protectedbase_senderSignalIndex(const void* self) {
	return ( (const MiqtVirtualQTimeLine*)(self) )->protectedbase_senderSignalIndex();
}

int QTimeLine_protectedbase_receivers(const void* self, const char* signal) {
	return ( (const MiqtVirtualQTimeLine*)(self) )->protectedbase_receivers(signal);
}

bool QTimeLine_protectedbase_isSignalConnected(const void* self, QMetaMethod* signal) {
	return ( (const MiqtVirtualQTimeLine*)(self) )->protectedbase_isSignalConnected(signal);
}
