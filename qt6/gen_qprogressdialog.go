...
func (this *QProgressDialog) Metacall(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {
	return (int)(C.QProgressDialog_metacall(this.h, (C.int)(param1), (C.int)(param2), param3))
}
...
func miqt_exec_callback_QProgressDialog_metaObject(self *C.QProgressDialog, cb C.intptr_t) *C.QMetaObject {
...
func miqt_exec_callback_QProgressDialog_metacast(self *C.QProgressDialog, cb C.intptr_t, param1 *C.const_char) unsafe.Pointer {
...
func (this *QProgressDialog) callVirtualBase_Metacall(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {

	return (int)(C.QProgressDialog_virtualbase_metacall(unsafe.Pointer(this.h), (C.int)(param1), (C.int)(param2), param3))

}
func (this *QProgressDialog) OnMetacall(slot func(super func(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int, param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int) {
	ok := C.QProgressDialog_override_virtual_metacall(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}

//export miqt_exec_callback_QProgressDialog_metacall
func miqt_exec_callback_QProgressDialog_metacall(self *C.QProgressDialog, cb C.intptr_t, param1 C.int, param2 C.int, param3 unsafe.Pointer) C.int {
	...
	virtualReturn := gofunc((&QProgressDialog{h: self}).callVirtualBase_Metacall, slotval1, slotval2, slotval3)
