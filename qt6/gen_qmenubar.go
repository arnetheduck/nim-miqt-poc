...
func (this *QMenuBar) Metacall(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {
	return (int)(C.QMenuBar_metacall(this.h, (C.int)(param1), (C.int)(param2), param3))
}
...
func (this *QMenuBar) callVirtualBase_MetaObject() *QMetaObject {
	...
	return newQMetaObject(C.QMenuBar_virtualbase_metaObject(unsafe.Pointer(this.h)))

}
func (this *QMenuBar) OnmetaObject(slot func(super func() *QMetaObject) *QMetaObject) {
	ok := C.QMenuBar_override_virtual_metaObject(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
...
func miqt_exec_callback_QMenuBar_metaObject(self *C.QMenuBar, cb C.intptr_t) *C.QMetaObject {
...
func (this *QMenuBar) callVirtualBase_Metacast(param1 string) unsafe.Pointer {
	...
	return (unsafe.Pointer)(C.QMenuBar_virtualbase_metacast(unsafe.Pointer(this.h), param1_Cstring))

}
func (this *QMenuBar) Onmetacast(slot func(super func(param1 string) unsafe.Pointer, param1 string) unsafe.Pointer) {
	ok := C.QMenuBar_override_virtual_metacast(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func miqt_exec_callback_QMenuBar_metacast(self *C.QMenuBar, cb C.intptr_t, param1 *C.const_char) unsafe.Pointer {
...
func (this *QMenuBar) callVirtualBase_Metacall(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {

	return (int)(C.QMenuBar_virtualbase_metacall(unsafe.Pointer(this.h), (C.int)(param1), (C.int)(param2), param3))

}
func (this *QMenuBar) OnMetacall(slot func(super func(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int, param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int) {
	ok := C.QMenuBar_override_virtual_metacall(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}

//export miqt_exec_callback_QMenuBar_metacall
func miqt_exec_callback_QMenuBar_metacall(self *C.QMenuBar, cb C.intptr_t, param1 C.int, param2 C.int, param3 unsafe.Pointer) C.int {
	...
	virtualReturn := gofunc((&QMenuBar{h: self}).callVirtualBase_Metacall, slotval1, slotval2, slotval3)
