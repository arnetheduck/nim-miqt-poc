...
type QFormLayoutitemAtProc* = proc(self: QFormLayout, index: cint): gen_qlayoutitem_types.QLayoutItem {.raises: [], gcsafe.}
...
proc create*(T: type gen_qformlayout_types.QFormLayout,
  ...
  if not isNil(vtbl.itemAt):
    vtbl[].vtbl.itemAt = miqt_exec_callback_cQFormLayout_itemAtWithIndex
