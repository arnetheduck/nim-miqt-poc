...
func (this *QTemporaryFile) Metacall(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {
	return (int)(C.QTemporaryFile_metacall(this.h, (C.int)(param1), (C.int)(param2), param3))
}
...
func (this *QTemporaryFile) callVirtualBase_MetaObject() *QMetaObject {
	...
	return newQMetaObject(C.QTemporaryFile_virtualbase_metaObject(unsafe.Pointer(this.h)))

}
func (this *QTemporaryFile) OnMetaObject(slot func(super func() *QMetaObject) *QMetaObject) {
	ok := C.QTemporaryFile_override_virtual_metaObject(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
...
func miqt_exec_callback_QTemporaryFile_metaObject(self *C.QTemporaryFile, cb C.intptr_t) *C.QMetaObject {
...
func (this *QTemporaryFile) callVirtualBase_Metacast(param1 string) unsafe.Pointer {
	...
	return (unsafe.Pointer)(C.QTemporaryFile_virtualbase_metacast(unsafe.Pointer(this.h), param1_Cstring))

}
func (this *QTemporaryFile) OnMetacast(slot func(super func(param1 string) unsafe.Pointer, param1 string) unsafe.Pointer) {
	ok := C.QTemporaryFile_override_virtual_metacast(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func miqt_exec_callback_QTemporaryFile_metacast(self *C.QTemporaryFile, cb C.intptr_t, param1 *C.const_char) unsafe.Pointer {
...
func (this *QTemporaryFile) callVirtualBase_Metacall(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {

	return (int)(C.QTemporaryFile_virtualbase_metacall(unsafe.Pointer(this.h), (C.int)(param1), (C.int)(param2), param3))

}
func (this *QTemporaryFile) OnMetacall(slot func(super func(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int, param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int) {
	ok := C.QTemporaryFile_override_virtual_metacall(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}

//export miqt_exec_callback_QTemporaryFile_metacall
func miqt_exec_callback_QTemporaryFile_metacall(self *C.QTemporaryFile, cb C.intptr_t, param1 C.int, param2 C.int, param3 unsafe.Pointer) C.int {
	...
	virtualReturn := gofunc((&QTemporaryFile{h: self}).callVirtualBase_Metacall, slotval1, slotval2, slotval3)
...
func (this *QTemporaryFile) callVirtualBase_SkipData(maxSize int64) int64 {

	return (int64)(C.QTemporaryFile_virtualbase_skipData(unsafe.Pointer(this.h), (C.longlong)(maxSize)))

}
func (this *QTemporaryFile) OnSkipData(slot func(super func(maxSize int64) int64, maxSize int64) int64) {
	ok := C.QTemporaryFile_override_virtual_skipData(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}

//export miqt_exec_callback_QTemporaryFile_skipData
func miqt_exec_callback_QTemporaryFile_skipData(self *C.QTemporaryFile, cb C.intptr_t, maxSize C.longlong) C.longlong {
	...
	virtualReturn := gofunc((&QTemporaryFile{h: self}).callVirtualBase_SkipData, slotval1)
