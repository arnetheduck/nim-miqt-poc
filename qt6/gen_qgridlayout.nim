...
proc miqt_exec_callback_QGridLayout_controlTypes(self: ptr cQGridLayout, slot: int): cint {.exportc: "miqt_exec_callback_QGridLayout_controlTypes ".} =
  ...
  cint(virtualReturn)
proc QGridLayoutreplaceWidget*(self: gen_qgridlayout_types.QGridLayout, fromVal: gen_qwidget.QWidget, to: gen_qwidget.QWidget, options: cint): gen_qlayoutitem.QLayoutItem =
  gen_qlayoutitem.QLayoutItem(h: fQGridLayout_virtualbase_replaceWidget(self.h, fromVal.h, to.h, cint(options)))

type QGridLayoutreplaceWidgetProc* = proc(fromVal: gen_qwidget.QWidget, to: gen_qwidget.QWidget, options: cint): gen_qlayoutitem.QLayoutItem
