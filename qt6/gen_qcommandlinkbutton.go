...
func (this *QCommandLinkButton) Metacall(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {
	return (int)(C.QCommandLinkButton_metacall(this.h, (C.int)(param1), (C.int)(param2), param3))
}
...
func (this *QCommandLinkButton) callVirtualBase_MetaObject() *QMetaObject {
	...
	return newQMetaObject(C.QCommandLinkButton_virtualbase_metaObject(unsafe.Pointer(this.h)))

}
func (this *QCommandLinkButton) OnmetaObject(slot func(super func() *QMetaObject) *QMetaObject) {
	ok := C.QCommandLinkButton_override_virtual_metaObject(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
...
func miqt_exec_callback_QCommandLinkButton_metaObject(self *C.QCommandLinkButton, cb C.intptr_t) *C.QMetaObject {
...
func (this *QCommandLinkButton) callVirtualBase_Metacast(param1 string) unsafe.Pointer {
	...
	return (unsafe.Pointer)(C.QCommandLinkButton_virtualbase_metacast(unsafe.Pointer(this.h), param1_Cstring))

}
func (this *QCommandLinkButton) Onmetacast(slot func(super func(param1 string) unsafe.Pointer, param1 string) unsafe.Pointer) {
	ok := C.QCommandLinkButton_override_virtual_metacast(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func miqt_exec_callback_QCommandLinkButton_metacast(self *C.QCommandLinkButton, cb C.intptr_t, param1 *C.const_char) unsafe.Pointer {
...
func (this *QCommandLinkButton) callVirtualBase_Metacall(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {

	return (int)(C.QCommandLinkButton_virtualbase_metacall(unsafe.Pointer(this.h), (C.int)(param1), (C.int)(param2), param3))

}
func (this *QCommandLinkButton) OnMetacall(slot func(super func(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int, param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int) {
	ok := C.QCommandLinkButton_override_virtual_metacall(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}

//export miqt_exec_callback_QCommandLinkButton_metacall
func miqt_exec_callback_QCommandLinkButton_metacall(self *C.QCommandLinkButton, cb C.intptr_t, param1 C.int, param2 C.int, param3 unsafe.Pointer) C.int {
	...
	virtualReturn := gofunc((&QCommandLinkButton{h: self}).callVirtualBase_Metacall, slotval1, slotval2, slotval3)
...
func (this *QCommandLinkButton) callVirtualBase_EnterEvent(event *QEnterEvent) {

	C.QCommandLinkButton_virtualbase_enterEvent(unsafe.Pointer(this.h), event.cPointer())

}
func (this *QCommandLinkButton) OnEnterEvent(slot func(super func(event *QEnterEvent), event *QEnterEvent)) {
...
func miqt_exec_callback_QCommandLinkButton_enterEvent(self *C.QCommandLinkButton, cb C.intptr_t, event *C.QEnterEvent) {
...
func (this *QCommandLinkButton) callVirtualBase_NativeEvent(eventType []byte, message unsafe.Pointer, result *uintptr) bool {
	...
	return (bool)(C.QCommandLinkButton_virtualbase_nativeEvent(unsafe.Pointer(this.h), eventType_alias, message, (*C.intptr_t)(unsafe.Pointer(result))))

}
func (this *QCommandLinkButton) OnNativeEvent(slot func(super func(eventType []byte, message unsafe.Pointer, result *uintptr) bool, eventType []byte, message unsafe.Pointer, result *uintptr) bool) {
...
func miqt_exec_callback_QCommandLinkButton_nativeEvent(self *C.QCommandLinkButton, cb C.intptr_t, eventType C.struct_miqt_string, message unsafe.Pointer, result *C.intptr_t) C.bool {
