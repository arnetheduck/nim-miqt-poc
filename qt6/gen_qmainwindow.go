...
func (this *QMainWindow) Metacall(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {
	return (int)(C.QMainWindow_metacall(this.h, (C.int)(param1), (C.int)(param2), param3))
}
...
func (this *QMainWindow) callVirtualBase_MetaObject() *QMetaObject {
	...
	return newQMetaObject(C.QMainWindow_virtualbase_metaObject(unsafe.Pointer(this.h)))

}
func (this *QMainWindow) OnmetaObject(slot func(super func() *QMetaObject) *QMetaObject) {
	ok := C.QMainWindow_override_virtual_metaObject(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
...
func miqt_exec_callback_QMainWindow_metaObject(self *C.QMainWindow, cb C.intptr_t) *C.QMetaObject {
...
func (this *QMainWindow) callVirtualBase_Metacast(param1 string) unsafe.Pointer {
	...
	return (unsafe.Pointer)(C.QMainWindow_virtualbase_metacast(unsafe.Pointer(this.h), param1_Cstring))

}
func (this *QMainWindow) Onmetacast(slot func(super func(param1 string) unsafe.Pointer, param1 string) unsafe.Pointer) {
	ok := C.QMainWindow_override_virtual_metacast(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func miqt_exec_callback_QMainWindow_metacast(self *C.QMainWindow, cb C.intptr_t, param1 *C.const_char) unsafe.Pointer {
...
func (this *QMainWindow) callVirtualBase_Metacall(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {

	return (int)(C.QMainWindow_virtualbase_metacall(unsafe.Pointer(this.h), (C.int)(param1), (C.int)(param2), param3))

}
func (this *QMainWindow) OnMetacall(slot func(super func(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int, param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int) {
	ok := C.QMainWindow_override_virtual_metacall(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}

//export miqt_exec_callback_QMainWindow_metacall
func miqt_exec_callback_QMainWindow_metacall(self *C.QMainWindow, cb C.intptr_t, param1 C.int, param2 C.int, param3 unsafe.Pointer) C.int {
	...
	virtualReturn := gofunc((&QMainWindow{h: self}).callVirtualBase_Metacall, slotval1, slotval2, slotval3)
...
func miqt_exec_callback_QMainWindow_enterEvent(self *C.QMainWindow, cb C.intptr_t, event *C.QEnterEvent) {
...
func miqt_exec_callback_QMainWindow_nativeEvent(self *C.QMainWindow, cb C.intptr_t, eventType C.struct_miqt_string, message unsafe.Pointer, result *C.intptr_t) C.bool {
