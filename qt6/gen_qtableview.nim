...
proc miqt_exec_callback_QTableView_scrollContentsBy(self: ptr cQTableView, slot: int, dx: cint, dy: cint): void {.exportc: "miqt_exec_callback_QTableView_scrollContentsBy ".} =
  ...
  nimfunc[](slotval1, slotval2)
proc QTableViewinitViewItemOption*(self: gen_qtableview_types.QTableView, option: gen_qstyleoption.QStyleOptionViewItem): void =
  fQTableView_virtualbase_initViewItemOption(self.h, option.h)

type QTableViewinitViewItemOptionProc* = proc(option: gen_qstyleoption.QStyleOptionViewItem): void
...
type QTableViewselectedIndexesProc* = proc(): seq[gen_qabstractitemmodel.QModelIndex]
...
proc miqt_exec_callback_QTableView_keyboardSearch(self: ptr cQTableView, slot: int, search: struct_miqt_string): void {.exportc: "miqt_exec_callback_QTableView_keyboardSearch ".} =
  ...
  nimfunc[](slotval1)
proc QTableViewitemDelegateForIndex*(self: gen_qtableview_types.QTableView, index: gen_qabstractitemmodel.QModelIndex): gen_qabstractitemdelegate.QAbstractItemDelegate =
  gen_qabstractitemdelegate.QAbstractItemDelegate(h: fQTableView_virtualbase_itemDelegateForIndex(self.h, index.h))

type QTableViewitemDelegateForIndexProc* = proc(index: gen_qabstractitemmodel.QModelIndex): gen_qabstractitemdelegate.QAbstractItemDelegate
...
type QTableViewdataChangedProc* = proc(topLeft: gen_qabstractitemmodel.QModelIndex, bottomRight: gen_qabstractitemmodel.QModelIndex, roles: seq[cint]): void
...
proc miqt_exec_callback_QTableView_changeEvent(self: ptr cQTableView, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QTableView_changeEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTableViewinitStyleOption*(self: gen_qtableview_types.QTableView, option: gen_qstyleoption.QStyleOptionFrame): void =
  fQTableView_virtualbase_initStyleOption(self.h, option.h)

type QTableViewinitStyleOptionProc* = proc(option: gen_qstyleoption.QStyleOptionFrame): void
...
proc miqt_exec_callback_QTableView_keyReleaseEvent(self: ptr cQTableView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTableView_keyReleaseEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTableViewenterEvent*(self: gen_qtableview_types.QTableView, event: gen_qevent.QEnterEvent): void =
  fQTableView_virtualbase_enterEvent(self.h, event.h)

type QTableViewenterEventProc* = proc(event: gen_qevent.QEnterEvent): void
...
proc miqt_exec_callback_QTableView_disconnectNotify(self: ptr cQTableView, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QTableView_disconnectNotify ".} =
  ...
  nimfunc[](slotval1)
proc staticMetaObject*(_: type gen_qtableview_types.QTableView): gen_qobjectdefs.QMetaObject =
