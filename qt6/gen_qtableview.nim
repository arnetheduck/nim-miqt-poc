...
proc sortByColumn*(self: QTableView, column: cint, order: gen_qnamespace.SortOrder): void =
...
proc miqt_exec_callback_QTableView_scrollContentsBy(self: ptr cQTableView, slot: int, dx: cint, dy: cint): void {.exportc: "miqt_exec_callback_QTableView_scrollContentsBy ".} =
  ...
  nimfunc[](superCall, slotval1, slotval2)
proc callVirtualBase_initViewItemOption(self: QTableView, option: gen_qstyleoption.QStyleOptionViewItem): void =


  fQTableView_virtualbase_initViewItemOption(self.h, option.h)

type QTableViewinitViewItemOptionBase* = proc(option: gen_qstyleoption.QStyleOptionViewItem): void
proc oninitViewItemOption*(self: QTableView, slot: proc(super: QTableViewinitViewItemOptionBase, option: gen_qstyleoption.QStyleOptionViewItem): void) =
  # TODO check subclass
  type Cb = proc(super: QTableViewinitViewItemOptionBase, option: gen_qstyleoption.QStyleOptionViewItem): void
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QTableView_initViewItemOption(self: ptr cQTableView, slot: int, option: pointer): void {.exportc: "miqt_exec_callback_QTableView_initViewItemOption ".} =
  ...
  proc superCall(option: gen_qstyleoption.QStyleOptionViewItem): auto =
    callVirtualBase_initViewItemOption(QTableView(h: self), option)
...
proc miqt_exec_callback_QTableView_keyboardSearch(self: ptr cQTableView, slot: int, search: struct_miqt_string): void {.exportc: "miqt_exec_callback_QTableView_keyboardSearch ".} =
  ...
  nimfunc[](superCall, slotval1)
proc callVirtualBase_itemDelegateForIndex(self: QTableView, index: gen_qabstractitemmodel.QModelIndex): gen_qabstractitemdelegate.QAbstractItemDelegate =


  gen_qabstractitemdelegate.QAbstractItemDelegate(h: fQTableView_virtualbase_itemDelegateForIndex(self.h, index.h))

type QTableViewitemDelegateForIndexBase* = proc(index: gen_qabstractitemmodel.QModelIndex): gen_qabstractitemdelegate.QAbstractItemDelegate
proc onitemDelegateForIndex*(self: QTableView, slot: proc(super: QTableViewitemDelegateForIndexBase, index: gen_qabstractitemmodel.QModelIndex): gen_qabstractitemdelegate.QAbstractItemDelegate) =
  # TODO check subclass
  type Cb = proc(super: QTableViewitemDelegateForIndexBase, index: gen_qabstractitemmodel.QModelIndex): gen_qabstractitemdelegate.QAbstractItemDelegate
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QTableView_itemDelegateForIndex(self: ptr cQTableView, slot: int, index: pointer): pointer {.exportc: "miqt_exec_callback_QTableView_itemDelegateForIndex ".} =
  ...
  var nimfunc = cast[ptr Cb](cast[pointer](slot))
  proc superCall(index: gen_qabstractitemmodel.QModelIndex): auto =
    callVirtualBase_itemDelegateForIndex(QTableView(h: self), index)
  let slotval1 = gen_qabstractitemmodel.QModelIndex(h: index)
...
proc miqt_exec_callback_QTableView_changeEvent(self: ptr cQTableView, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QTableView_changeEvent ".} =
  ...
  nimfunc[](superCall, slotval1)
proc callVirtualBase_initStyleOption(self: QTableView, option: gen_qstyleoption.QStyleOptionFrame): void =


  fQTableView_virtualbase_initStyleOption(self.h, option.h)

type QTableViewinitStyleOptionBase* = proc(option: gen_qstyleoption.QStyleOptionFrame): void
proc oninitStyleOption*(self: QTableView, slot: proc(super: QTableViewinitStyleOptionBase, option: gen_qstyleoption.QStyleOptionFrame): void) =
  # TODO check subclass
  type Cb = proc(super: QTableViewinitStyleOptionBase, option: gen_qstyleoption.QStyleOptionFrame): void
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QTableView_initStyleOption(self: ptr cQTableView, slot: int, option: pointer): void {.exportc: "miqt_exec_callback_QTableView_initStyleOption ".} =
  ...
  proc superCall(option: gen_qstyleoption.QStyleOptionFrame): auto =
    callVirtualBase_initStyleOption(QTableView(h: self), option)
...
proc miqt_exec_callback_QTableView_keyReleaseEvent(self: ptr cQTableView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTableView_keyReleaseEvent ".} =
  ...
  nimfunc[](superCall, slotval1)
proc callVirtualBase_enterEvent(self: QTableView, event: gen_qevent.QEnterEvent): void =


  fQTableView_virtualbase_enterEvent(self.h, event.h)

type QTableViewenterEventBase* = proc(event: gen_qevent.QEnterEvent): void
proc onenterEvent*(self: QTableView, slot: proc(super: QTableViewenterEventBase, event: gen_qevent.QEnterEvent): void) =
  # TODO check subclass
  type Cb = proc(super: QTableViewenterEventBase, event: gen_qevent.QEnterEvent): void
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QTableView_hideEvent(self: ptr cQTableView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTableView_hideEvent ".} =
  ...
  nimfunc[](superCall, slotval1)
proc callVirtualBase_nativeEvent(self: QTableView, eventType: seq[byte], message: pointer, resultVal: ptr uint): bool =
...
type QTableViewnativeEventBase* = proc(eventType: seq[byte], message: pointer, resultVal: ptr uint): bool
proc onnativeEvent*(self: QTableView, slot: proc(super: QTableViewnativeEventBase, eventType: seq[byte], message: pointer, resultVal: ptr uint): bool) =
  # TODO check subclass
  type Cb = proc(super: QTableViewnativeEventBase, eventType: seq[byte], message: pointer, resultVal: ptr uint): bool
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
