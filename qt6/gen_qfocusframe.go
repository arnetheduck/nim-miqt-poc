...
func (this *QFocusFrame) Metacall(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {
	return (int)(C.QFocusFrame_metacall(this.h, (C.int)(param1), (C.int)(param2), param3))
}
...
func (this *QFocusFrame) callVirtualBase_MetaObject() *QMetaObject {
	...
	return newQMetaObject(C.QFocusFrame_virtualbase_metaObject(unsafe.Pointer(this.h)))

}
func (this *QFocusFrame) OnMetaObject(slot func(super func() *QMetaObject) *QMetaObject) {
	ok := C.QFocusFrame_override_virtual_metaObject(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
...
func miqt_exec_callback_QFocusFrame_metaObject(self *C.QFocusFrame, cb C.intptr_t) *C.QMetaObject {
...
func (this *QFocusFrame) callVirtualBase_Metacast(param1 string) unsafe.Pointer {
	...
	return (unsafe.Pointer)(C.QFocusFrame_virtualbase_metacast(unsafe.Pointer(this.h), param1_Cstring))

}
func (this *QFocusFrame) OnMetacast(slot func(super func(param1 string) unsafe.Pointer, param1 string) unsafe.Pointer) {
	ok := C.QFocusFrame_override_virtual_metacast(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func miqt_exec_callback_QFocusFrame_metacast(self *C.QFocusFrame, cb C.intptr_t, param1 *C.const_char) unsafe.Pointer {
...
func (this *QFocusFrame) callVirtualBase_Metacall(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {

	return (int)(C.QFocusFrame_virtualbase_metacall(unsafe.Pointer(this.h), (C.int)(param1), (C.int)(param2), param3))

}
func (this *QFocusFrame) OnMetacall(slot func(super func(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int, param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int) {
	ok := C.QFocusFrame_override_virtual_metacall(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}

//export miqt_exec_callback_QFocusFrame_metacall
func miqt_exec_callback_QFocusFrame_metacall(self *C.QFocusFrame, cb C.intptr_t, param1 C.int, param2 C.int, param3 unsafe.Pointer) C.int {
	...
	virtualReturn := gofunc((&QFocusFrame{h: self}).callVirtualBase_Metacall, slotval1, slotval2, slotval3)
...
func (this *QFocusFrame) OnInitStyleOption(slot func(super func(option *QStyleOption), option *QStyleOption)) {
	ok := C.QFocusFrame_override_virtual_initStyleOption(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
