...
proc miqt_exec_callback_QGraphicsWidget_extension(self: ptr cQGraphicsWidget, slot: int, variant: pointer): pointer {.exportc: "miqt_exec_callback_QGraphicsWidget_extension ".} =
  ...
  virtualReturn.h
proc callVirtualBase_isEmpty(self: QGraphicsWidget, ): bool =


  fQGraphicsWidget_virtualbase_isEmpty(self.h)

type QGraphicsWidgetisEmptyBase* = proc(): bool
proc onisEmpty*(self: QGraphicsWidget, slot: proc(super: QGraphicsWidgetisEmptyBase): bool) =
  # TODO check subclass
  type Cb = proc(super: QGraphicsWidgetisEmptyBase): bool
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QGraphicsWidget_isEmpty(self: ptr cQGraphicsWidget, slot: int): bool {.exportc: "miqt_exec_callback_QGraphicsWidget_isEmpty ".} =
  ...
  var nimfunc = cast[ptr Cb](cast[pointer](slot))
  proc superCall(): auto =
    callVirtualBase_isEmpty(QGraphicsWidget(h: self), )
