...
func (this *QGroupBox) Metacall(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {
	return (int)(C.QGroupBox_metacall(this.h, (C.int)(param1), (C.int)(param2), param3))
}
...
func (this *QGroupBox) callVirtualBase_MetaObject() *QMetaObject {
	...
	return newQMetaObject(C.QGroupBox_virtualbase_metaObject(unsafe.Pointer(this.h)))

}
func (this *QGroupBox) OnmetaObject(slot func(super func() *QMetaObject) *QMetaObject) {
	ok := C.QGroupBox_override_virtual_metaObject(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
...
func miqt_exec_callback_QGroupBox_metaObject(self *C.QGroupBox, cb C.intptr_t) *C.QMetaObject {
...
func (this *QGroupBox) callVirtualBase_Metacast(param1 string) unsafe.Pointer {
	...
	return (unsafe.Pointer)(C.QGroupBox_virtualbase_metacast(unsafe.Pointer(this.h), param1_Cstring))

}
func (this *QGroupBox) Onmetacast(slot func(super func(param1 string) unsafe.Pointer, param1 string) unsafe.Pointer) {
	ok := C.QGroupBox_override_virtual_metacast(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func miqt_exec_callback_QGroupBox_metacast(self *C.QGroupBox, cb C.intptr_t, param1 *C.const_char) unsafe.Pointer {
...
func (this *QGroupBox) callVirtualBase_Metacall(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {

	return (int)(C.QGroupBox_virtualbase_metacall(unsafe.Pointer(this.h), (C.int)(param1), (C.int)(param2), param3))

}
func (this *QGroupBox) OnMetacall(slot func(super func(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int, param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int) {
	ok := C.QGroupBox_override_virtual_metacall(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}

//export miqt_exec_callback_QGroupBox_metacall
func miqt_exec_callback_QGroupBox_metacall(self *C.QGroupBox, cb C.intptr_t, param1 C.int, param2 C.int, param3 unsafe.Pointer) C.int {
	...
	virtualReturn := gofunc((&QGroupBox{h: self}).callVirtualBase_Metacall, slotval1, slotval2, slotval3)
...
func (this *QGroupBox) OnInitStyleOption(slot func(super func(option *QStyleOptionGroupBox), option *QStyleOptionGroupBox)) {
	ok := C.QGroupBox_override_virtual_initStyleOption(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
