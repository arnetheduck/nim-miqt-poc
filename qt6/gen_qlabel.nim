...
proc fcQLabel_virtualbase_initStyleOption(self: pointer, option: pointer): void {.importc: "QLabel_virtualbase_initStyleOption".}
...
proc fcQLabel_virtualbase_nativeEvent(self: pointer, eventType: struct_miqt_string, message: pointer, resultVal: ptr uint): bool {.importc: "QLabel_virtualbase_nativeEvent".}
...
type QLabelinitStyleOptionProc* = proc(self: QLabel, option: gen_qstyleoption_types.QStyleOptionFrame): void {.raises: [], gcsafe.}
...
type QLabelenterEventProc* = proc(self: QLabel, event: gen_qevent_types.QEnterEvent): void {.raises: [], gcsafe.}
...
type QLabelVTable* = object
  ...
  initStyleOption*: QLabelinitStyleOptionProc
...
proc QLabelinitStyleOption*(self: gen_qlabel_types.QLabel, option: gen_qstyleoption_types.QStyleOptionFrame): void =
  fcQLabel_virtualbase_initStyleOption(self.h, option.h)

proc miqt_exec_callback_cQLabel_initStyleOption(vtbl: pointer, self: pointer, option: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QLabelVTable](vtbl)
  let self = QLabel(h: self)
...
proc miqt_exec_callback_cQLabel_nativeEvent(vtbl: pointer, self: pointer, eventType: struct_miqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let vtbl = cast[ptr QLabelVTable](vtbl)
  let self = QLabel(h: self)
...
proc create*(T: type gen_qlabel_types.QLabel,
  ...
  if not isNil(vtbl.initStyleOption):
    vtbl[].vtbl.initStyleOption = miqt_exec_callback_cQLabel_initStyleOption
