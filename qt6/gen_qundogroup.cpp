...
public:
	...
	int virtualbase_metacall(int param1, int param2, void** param3) {
		...
		return QUndoGroup::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
int QUndoGroup_virtualbase_metacall(void* self, int param1, int param2, void** param3) {
	return ( (MiqtVirtualQUndoGroup*)(self) )->virtualbase_metacall(param1, param2, param3);
}
...
QObject* QUndoGroup_protectedbase_sender(const void* self) {
	return ( (const MiqtVirtualQUndoGroup*)(self) )->protectedbase_sender();
}

int QUndoGroup_protectedbase_senderSignalIndex(const void* self) {
	return ( (const MiqtVirtualQUndoGroup*)(self) )->protectedbase_senderSignalIndex();
}

int QUndoGroup_protectedbase_receivers(const void* self, const char* signal) {
	return ( (const MiqtVirtualQUndoGroup*)(self) )->protectedbase_receivers(signal);
}

bool QUndoGroup_protectedbase_isSignalConnected(const void* self, QMetaMethod* signal) {
	return ( (const MiqtVirtualQUndoGroup*)(self) )->protectedbase_isSignalConnected(signal);
}
