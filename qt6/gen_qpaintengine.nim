...
const
  ...
  QPaintEngineOpenGL* = 6
  QPaintEnginePicture* = 7
  QPaintEngineSVG* = 8
  QPaintEngineRaster* = 9
  QPaintEngineDirect3D* = 10
  QPaintEnginePdf* = 11
  QPaintEngineOpenVG* = 12
  QPaintEngineOpenGL2* = 13
  QPaintEnginePaintBuffer* = 14
  QPaintEngineBlitter* = 15
  QPaintEngineDirect2D* = 16
  QPaintEngineUser* = 50
...
proc createPixmap*(self: QPaintEngine, size: gen_qsize.QSize): gen_qpixmap.QPixmap =

  gen_qpixmap.QPixmap(h: fcQPaintEngine_createPixmap(self.h, size.h))

proc createPixmapFromImage*(self: QPaintEngine, image: gen_qimage.QImage, flags: gen_qnamespace.ImageConversionFlag): gen_qpixmap.QPixmap =
...
proc miqt_exec_callback_QPaintEngine_type(self: ptr cQPaintEngine, slot: int): cint {.exportc: "miqt_exec_callback_QPaintEngine_type ".} =
  ...
  cint(virtualReturn)
proc callVirtualBase_createPixmap(self: QPaintEngine, size: gen_qsize.QSize): gen_qpixmap.QPixmap =


  gen_qpixmap.QPixmap(h: fQPaintEngine_virtualbase_createPixmap(self.h, size.h))

type QPaintEnginecreatePixmapBase* = proc(size: gen_qsize.QSize): gen_qpixmap.QPixmap
proc oncreatePixmap*(self: QPaintEngine, slot: proc(super: QPaintEnginecreatePixmapBase, size: gen_qsize.QSize): gen_qpixmap.QPixmap) =
  # TODO check subclass
  type Cb = proc(super: QPaintEnginecreatePixmapBase, size: gen_qsize.QSize): gen_qpixmap.QPixmap
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QPaintEngine_createPixmap(self: ptr cQPaintEngine, slot: int, size: pointer): pointer {.exportc: "miqt_exec_callback_QPaintEngine_createPixmap ".} =
  type Cb = proc(super: QPaintEnginecreatePixmapBase, size: gen_qsize.QSize): gen_qpixmap.QPixmap
  var nimfunc = cast[ptr Cb](cast[pointer](slot))
  proc superCall(size: gen_qsize.QSize): auto =
    callVirtualBase_createPixmap(QPaintEngine(h: self), size)
  ...
  virtualReturn.h
proc callVirtualBase_createPixmapFromImage(self: QPaintEngine, image: gen_qimage.QImage, flags: gen_qnamespace.ImageConversionFlag): gen_qpixmap.QPixmap =


  gen_qpixmap.QPixmap(h: fQPaintEngine_virtualbase_createPixmapFromImage(self.h, image.h, cint(flags)))

type QPaintEnginecreatePixmapFromImageBase* = proc(image: gen_qimage.QImage, flags: gen_qnamespace.ImageConversionFlag): gen_qpixmap.QPixmap
proc oncreatePixmapFromImage*(self: QPaintEngine, slot: proc(super: QPaintEnginecreatePixmapFromImageBase, image: gen_qimage.QImage, flags: gen_qnamespace.ImageConversionFlag): gen_qpixmap.QPixmap) =
  # TODO check subclass
  type Cb = proc(super: QPaintEnginecreatePixmapFromImageBase, image: gen_qimage.QImage, flags: gen_qnamespace.ImageConversionFlag): gen_qpixmap.QPixmap
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QPaintEngine_createPixmapFromImage(self: ptr cQPaintEngine, slot: int, image: pointer, flags: cint): pointer {.exportc: "miqt_exec_callback_QPaintEngine_createPixmapFromImage ".} =
  type Cb = proc(super: QPaintEnginecreatePixmapFromImageBase, image: gen_qimage.QImage, flags: gen_qnamespace.ImageConversionFlag): gen_qpixmap.QPixmap
  var nimfunc = cast[ptr Cb](cast[pointer](slot))
  proc superCall(image: gen_qimage.QImage, flags: gen_qnamespace.ImageConversionFlag): auto =
    callVirtualBase_createPixmapFromImage(QPaintEngine(h: self), image, flags)
  let slotval1 = gen_qimage.QImage(h: image)

  let slotval2 = gen_qnamespace.ImageConversionFlag(flags)
