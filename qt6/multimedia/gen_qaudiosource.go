...
func (this *QAudioSource) Metacall(param1 qt6.QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {
	return (int)(C.QAudioSource_metacall(this.h, (C.int)(param1), (C.int)(param2), param3))
}
...
func (this *QAudioSource) callVirtualBase_MetaObject() *qt6.QMetaObject {

	return qt6.UnsafeNewQMetaObject(unsafe.Pointer(C.QAudioSource_virtualbase_metaObject(unsafe.Pointer(this.h))))

}
func (this *QAudioSource) OnmetaObject(slot func(super func() *qt6.QMetaObject) *qt6.QMetaObject) {
	ok := C.QAudioSource_override_virtual_metaObject(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
...
func miqt_exec_callback_QAudioSource_metaObject(self *C.QAudioSource, cb C.intptr_t) *C.QMetaObject {
...
func (this *QAudioSource) callVirtualBase_Metacast(param1 string) unsafe.Pointer {
	...
	return (unsafe.Pointer)(C.QAudioSource_virtualbase_metacast(unsafe.Pointer(this.h), param1_Cstring))

}
func (this *QAudioSource) Onmetacast(slot func(super func(param1 string) unsafe.Pointer, param1 string) unsafe.Pointer) {
	ok := C.QAudioSource_override_virtual_metacast(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func miqt_exec_callback_QAudioSource_metacast(self *C.QAudioSource, cb C.intptr_t, param1 *C.const_char) unsafe.Pointer {
...
func (this *QAudioSource) callVirtualBase_Metacall(param1 qt6.QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {

	return (int)(C.QAudioSource_virtualbase_metacall(unsafe.Pointer(this.h), (C.int)(param1), (C.int)(param2), param3))

}
func (this *QAudioSource) OnMetacall(slot func(super func(param1 qt6.QMetaObject__Call, param2 int, param3 unsafe.Pointer) int, param1 qt6.QMetaObject__Call, param2 int, param3 unsafe.Pointer) int) {
	ok := C.QAudioSource_override_virtual_metacall(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}

//export miqt_exec_callback_QAudioSource_metacall
func miqt_exec_callback_QAudioSource_metacall(self *C.QAudioSource, cb C.intptr_t, param1 C.int, param2 C.int, param3 unsafe.Pointer) C.int {
	...
	virtualReturn := gofunc((&QAudioSource{h: self}).callVirtualBase_Metacall, slotval1, slotval2, slotval3)
