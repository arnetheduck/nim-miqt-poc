...
func (this *QAudioDecoder) Metacall(param1 qt6.QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {
...
func (this *QAudioDecoder) callVirtualBase_MetaObject() *qt6.QMetaObject {

	return qt6.UnsafeNewQMetaObject(unsafe.Pointer(C.QAudioDecoder_virtualbase_metaObject(unsafe.Pointer(this.h))))

}
func (this *QAudioDecoder) OnMetaObject(slot func(super func() *qt6.QMetaObject) *qt6.QMetaObject) {
	ok := C.QAudioDecoder_override_virtual_metaObject(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
...
func miqt_exec_callback_QAudioDecoder_metaObject(self *C.QAudioDecoder, cb C.intptr_t) *C.QMetaObject {
...
func (this *QAudioDecoder) callVirtualBase_Metacast(param1 string) unsafe.Pointer {
	...
	return (unsafe.Pointer)(C.QAudioDecoder_virtualbase_metacast(unsafe.Pointer(this.h), param1_Cstring))

}
func (this *QAudioDecoder) OnMetacast(slot func(super func(param1 string) unsafe.Pointer, param1 string) unsafe.Pointer) {
	ok := C.QAudioDecoder_override_virtual_metacast(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func miqt_exec_callback_QAudioDecoder_metacast(self *C.QAudioDecoder, cb C.intptr_t, param1 *C.const_char) unsafe.Pointer {
...
func (this *QAudioDecoder) callVirtualBase_Metacall(param1 qt6.QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {

	return (int)(C.QAudioDecoder_virtualbase_metacall(unsafe.Pointer(this.h), (C.int)(param1), (C.int)(param2), param3))

}
func (this *QAudioDecoder) OnMetacall(slot func(super func(param1 qt6.QMetaObject__Call, param2 int, param3 unsafe.Pointer) int, param1 qt6.QMetaObject__Call, param2 int, param3 unsafe.Pointer) int) {
