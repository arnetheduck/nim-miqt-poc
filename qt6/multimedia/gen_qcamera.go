...
func (this *QCamera) Metacall(param1 qt6.QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {
	return (int)(C.QCamera_metacall(this.h, (C.int)(param1), (C.int)(param2), param3))
}
...
func (this *QCamera) callVirtualBase_MetaObject() *qt6.QMetaObject {

	return qt6.UnsafeNewQMetaObject(unsafe.Pointer(C.QCamera_virtualbase_metaObject(unsafe.Pointer(this.h))))

}
func (this *QCamera) OnMetaObject(slot func(super func() *qt6.QMetaObject) *qt6.QMetaObject) {
...
func miqt_exec_callback_QCamera_metaObject(self *C.QCamera, cb C.intptr_t) *C.QMetaObject {
...
func miqt_exec_callback_QCamera_metacast(self *C.QCamera, cb C.intptr_t, param1 *C.const_char) unsafe.Pointer {
...
func (this *QCamera) callVirtualBase_Metacall(param1 qt6.QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {

	return (int)(C.QCamera_virtualbase_metacall(unsafe.Pointer(this.h), (C.int)(param1), (C.int)(param2), param3))

}
func (this *QCamera) OnMetacall(slot func(super func(param1 qt6.QMetaObject__Call, param2 int, param3 unsafe.Pointer) int, param1 qt6.QMetaObject__Call, param2 int, param3 unsafe.Pointer) int) {
	ok := C.QCamera_override_virtual_metacall(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}

//export miqt_exec_callback_QCamera_metacall
func miqt_exec_callback_QCamera_metacall(self *C.QCamera, cb C.intptr_t, param1 C.int, param2 C.int, param3 unsafe.Pointer) C.int {
	...
	virtualReturn := gofunc((&QCamera{h: self}).callVirtualBase_Metacall, slotval1, slotval2, slotval3)
