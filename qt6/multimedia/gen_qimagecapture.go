...
func (this *QImageCapture) callVirtualBase_MetaObject() *qt6.QMetaObject {

	return qt6.UnsafeNewQMetaObject(unsafe.Pointer(C.QImageCapture_virtualbase_metaObject(unsafe.Pointer(this.h))))

}
func (this *QImageCapture) OnMetaObject(slot func(super func() *qt6.QMetaObject) *qt6.QMetaObject) {
	ok := C.QImageCapture_override_virtual_metaObject(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
...
func miqt_exec_callback_QImageCapture_metaObject(self *C.QImageCapture, cb C.intptr_t) *C.QMetaObject {
...
func (this *QImageCapture) callVirtualBase_Metacast(param1 string) unsafe.Pointer {
	...
	return (unsafe.Pointer)(C.QImageCapture_virtualbase_metacast(unsafe.Pointer(this.h), param1_Cstring))

}
func (this *QImageCapture) OnMetacast(slot func(super func(param1 string) unsafe.Pointer, param1 string) unsafe.Pointer) {
	ok := C.QImageCapture_override_virtual_metacast(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func miqt_exec_callback_QImageCapture_metacast(self *C.QImageCapture, cb C.intptr_t, param1 *C.const_char) unsafe.Pointer {
