...
QObject* QMediaCaptureSession_protectedbase_sender(const void* self) {
	return ( (const MiqtVirtualQMediaCaptureSession*)(self) )->protectedbase_sender();
}

int QMediaCaptureSession_protectedbase_senderSignalIndex(const void* self) {
	return ( (const MiqtVirtualQMediaCaptureSession*)(self) )->protectedbase_senderSignalIndex();
}

int QMediaCaptureSession_protectedbase_receivers(const void* self, const char* signal) {
	return ( (const MiqtVirtualQMediaCaptureSession*)(self) )->protectedbase_receivers(signal);
}

bool QMediaCaptureSession_protectedbase_isSignalConnected(const void* self, QMetaMethod* signal) {
	return ( (const MiqtVirtualQMediaCaptureSession*)(self) )->protectedbase_isSignalConnected(signal);
}
