...
proc create*(T: type gen_qvideosink_types.QVideoSink, parent: gen_qobject.QObject): gen_qvideosink_types.QVideoSink =

  gen_qvideosink_types.QVideoSink.init(fcQVideoSink_new2(parent.h))
proc metaObject*(self: gen_qvideosink_types.QVideoSink, ): gen_qobjectdefs.QMetaObject =
...
proc videoSize*(self: gen_qvideosink_types.QVideoSink, ): gen_qsize.QSize =
...
proc setVideoFrame*(self: gen_qvideosink_types.QVideoSink, frame: gen_qvideoframe.QVideoFrame): void =

  fcQVideoSink_setVideoFrame(self.h, frame.h)

proc videoFrame*(self: gen_qvideosink_types.QVideoSink, ): gen_qvideoframe.QVideoFrame =

  gen_qvideoframe.QVideoFrame(h: fcQVideoSink_videoFrame(self.h))

proc videoFrameChanged*(self: gen_qvideosink_types.QVideoSink, frame: gen_qvideoframe.QVideoFrame): void =
...
proc onvideoFrameChanged*(self: gen_qvideosink_types.QVideoSink, slot: proc(frame: gen_qvideoframe.QVideoFrame)) =
  type Cb = proc(frame: gen_qvideoframe.QVideoFrame)
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc onsubtitleTextChanged*(self: gen_qvideosink_types.QVideoSink, slot: proc(subtitleText: string)) =
  type Cb = proc(subtitleText: string)
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc onvideoSizeChanged*(self: gen_qvideosink_types.QVideoSink, slot: proc()) =
  type Cb = proc()
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
  fQVideoSink_connect_videoSizeChanged(self.h, cast[int](addr tmp[]))
proc tr2*(_: type gen_qvideosink_types.QVideoSink, s: cstring, c: cstring): string =
...
proc tr3*(_: type gen_qvideosink_types.QVideoSink, s: cstring, c: cstring, n: cint): string =
...
proc QVideoSinkmetaObject*(self: gen_qvideosink_types.QVideoSink, ): gen_qobjectdefs.QMetaObject =

  gen_qobjectdefs.QMetaObject(h: fQVideoSink_virtualbase_metaObject(self.h))

type QVideoSinkmetaObjectProc* = proc(): gen_qobjectdefs.QMetaObject
...
proc miqt_exec_callback_QVideoSink_metacall(self: ptr cQVideoSink, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QVideoSink_metacall ".} =
  ...
  virtualReturn
proc QVideoSinkevent*(self: gen_qvideosink_types.QVideoSink, event: gen_qcoreevent.QEvent): bool =

  fQVideoSink_virtualbase_event(self.h, event.h)

type QVideoSinkeventProc* = proc(event: gen_qcoreevent.QEvent): bool
...
proc miqt_exec_callback_QVideoSink_event(self: ptr cQVideoSink, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QVideoSink_event ".} =
  ...
  virtualReturn
proc QVideoSinkeventFilter*(self: gen_qvideosink_types.QVideoSink, watched: gen_qobject.QObject, event: gen_qcoreevent.QEvent): bool =

  fQVideoSink_virtualbase_eventFilter(self.h, watched.h, event.h)

type QVideoSinkeventFilterProc* = proc(watched: gen_qobject.QObject, event: gen_qcoreevent.QEvent): bool
...
proc miqt_exec_callback_QVideoSink_eventFilter(self: ptr cQVideoSink, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QVideoSink_eventFilter ".} =
  ...
  virtualReturn
proc QVideoSinktimerEvent*(self: gen_qvideosink_types.QVideoSink, event: gen_qcoreevent.QTimerEvent): void =

  fQVideoSink_virtualbase_timerEvent(self.h, event.h)

type QVideoSinktimerEventProc* = proc(event: gen_qcoreevent.QTimerEvent): void
...
proc miqt_exec_callback_QVideoSink_timerEvent(self: ptr cQVideoSink, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QVideoSink_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QVideoSinkchildEvent*(self: gen_qvideosink_types.QVideoSink, event: gen_qcoreevent.QChildEvent): void =

  fQVideoSink_virtualbase_childEvent(self.h, event.h)

type QVideoSinkchildEventProc* = proc(event: gen_qcoreevent.QChildEvent): void
...
proc miqt_exec_callback_QVideoSink_childEvent(self: ptr cQVideoSink, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QVideoSink_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QVideoSinkcustomEvent*(self: gen_qvideosink_types.QVideoSink, event: gen_qcoreevent.QEvent): void =

  fQVideoSink_virtualbase_customEvent(self.h, event.h)

type QVideoSinkcustomEventProc* = proc(event: gen_qcoreevent.QEvent): void
...
proc miqt_exec_callback_QVideoSink_customEvent(self: ptr cQVideoSink, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QVideoSink_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QVideoSinkconnectNotify*(self: gen_qvideosink_types.QVideoSink, signal: gen_qmetaobject.QMetaMethod): void =

  fQVideoSink_virtualbase_connectNotify(self.h, signal.h)

type QVideoSinkconnectNotifyProc* = proc(signal: gen_qmetaobject.QMetaMethod): void
...
proc miqt_exec_callback_QVideoSink_connectNotify(self: ptr cQVideoSink, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QVideoSink_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QVideoSinkdisconnectNotify*(self: gen_qvideosink_types.QVideoSink, signal: gen_qmetaobject.QMetaMethod): void =

  fQVideoSink_virtualbase_disconnectNotify(self.h, signal.h)

type QVideoSinkdisconnectNotifyProc* = proc(signal: gen_qmetaobject.QMetaMethod): void
