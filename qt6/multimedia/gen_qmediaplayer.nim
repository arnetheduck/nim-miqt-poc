...
type QMediaPlayersourceChangedSlot* = proc(media: gen_qurl.QUrl)
...
proc setSourceDevice*(self: gen_qmediaplayer_types.QMediaPlayer, device: gen_qiodevice.QIODevice, sourceUrl: gen_qurl.QUrl): void =
