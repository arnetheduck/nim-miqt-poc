...
func (this *QDtlsClientVerifier) Metacall(param1 qt6.QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {
...
func (this *QDtlsClientVerifier) callVirtualBase_MetaObject() *qt6.QMetaObject {

	return qt6.UnsafeNewQMetaObject(unsafe.Pointer(C.QDtlsClientVerifier_virtualbase_metaObject(unsafe.Pointer(this.h))))

}
func (this *QDtlsClientVerifier) OnmetaObject(slot func(super func() *qt6.QMetaObject) *qt6.QMetaObject) {
...
//export miqt_exec_callback_QDtlsClientVerifier_metaObject
func miqt_exec_callback_QDtlsClientVerifier_metaObject(self *C.QDtlsClientVerifier, cb C.intptr_t) *C.QMetaObject {
	gofunc, ok := cgo.Handle(cb).Value().(func(super func() *qt6.QMetaObject) *qt6.QMetaObject)
	if !ok {
		panic("miqt: callback of non-callback type (heap corruption?)")
	}

	virtualReturn := gofunc((&QDtlsClientVerifier{h: self}).callVirtualBase_MetaObject)

	return (*C.QMetaObject)(virtualReturn.UnsafePointer())

}

func (this *QDtlsClientVerifier) callVirtualBase_Metacast(param1 string) unsafe.Pointer {
	param1_Cstring := C.CString(param1)
	defer C.free(unsafe.Pointer(param1_Cstring))
...
//export miqt_exec_callback_QDtlsClientVerifier_metacast
func miqt_exec_callback_QDtlsClientVerifier_metacast(self *C.QDtlsClientVerifier, cb C.intptr_t, param1 *C.const_char) unsafe.Pointer {
	...
	virtualReturn := gofunc((&QDtlsClientVerifier{h: self}).callVirtualBase_Metacast, slotval1)

	return virtualReturn

}

func (this *QDtlsClientVerifier) callVirtualBase_Metacall(param1 qt6.QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {

	return (int)(C.QDtlsClientVerifier_virtualbase_metacall(unsafe.Pointer(this.h), (C.int)(param1), (C.int)(param2), param3))

}
func (this *QDtlsClientVerifier) OnMetacall(slot func(super func(param1 qt6.QMetaObject__Call, param2 int, param3 unsafe.Pointer) int, param1 qt6.QMetaObject__Call, param2 int, param3 unsafe.Pointer) int) {
...
func (this *QDtls) Metacall(param1 qt6.QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {
...
func (this *QDtls) callVirtualBase_MetaObject() *qt6.QMetaObject {

	return qt6.UnsafeNewQMetaObject(unsafe.Pointer(C.QDtls_virtualbase_metaObject(unsafe.Pointer(this.h))))

}
func (this *QDtls) OnmetaObject(slot func(super func() *qt6.QMetaObject) *qt6.QMetaObject) {
...
//export miqt_exec_callback_QDtls_metaObject
func miqt_exec_callback_QDtls_metaObject(self *C.QDtls, cb C.intptr_t) *C.QMetaObject {
	gofunc, ok := cgo.Handle(cb).Value().(func(super func() *qt6.QMetaObject) *qt6.QMetaObject)
	if !ok {
		panic("miqt: callback of non-callback type (heap corruption?)")
	}

	virtualReturn := gofunc((&QDtls{h: self}).callVirtualBase_MetaObject)

	return (*C.QMetaObject)(virtualReturn.UnsafePointer())

}

func (this *QDtls) callVirtualBase_Metacast(param1 string) unsafe.Pointer {
	param1_Cstring := C.CString(param1)
	defer C.free(unsafe.Pointer(param1_Cstring))
...
//export miqt_exec_callback_QDtls_metacast
func miqt_exec_callback_QDtls_metacast(self *C.QDtls, cb C.intptr_t, param1 *C.const_char) unsafe.Pointer {
	gofunc, ok := cgo.Handle(cb).Value().(func(super func(param1 string) unsafe.Pointer, param1 string) unsafe.Pointer)
	if !ok {
		panic("miqt: callback of non-callback type (heap corruption?)")
	}
	...
	virtualReturn := gofunc((&QDtls{h: self}).callVirtualBase_Metacast, slotval1)

	return virtualReturn

}

func (this *QDtls) callVirtualBase_Metacall(param1 qt6.QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {

	return (int)(C.QDtls_virtualbase_metacall(unsafe.Pointer(this.h), (C.int)(param1), (C.int)(param2), param3))

}
func (this *QDtls) OnMetacall(slot func(super func(param1 qt6.QMetaObject__Call, param2 int, param3 unsafe.Pointer) int, param1 qt6.QMetaObject__Call, param2 int, param3 unsafe.Pointer) int) {
