...
proc toRawForm1*(self: gen_qnetworkcookie_types.QNetworkCookie, form: cint): seq[byte] =
...
proc staticMetaObject*(_: type gen_qnetworkcookie_types.QNetworkCookie): gen_qobjectdefs.QMetaObject =
