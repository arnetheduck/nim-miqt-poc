...
func (this *QNetworkAccessManager) Metacall(param1 qt6.QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {
...
func (this *QNetworkAccessManager) SendCustomRequest32(request *QNetworkRequest, verb []byte, data *qt6.QIODevice) *QNetworkReply {
	verb_alias := C.struct_miqt_string{}
	if len(verb) > 0 {
		verb_alias.data = (*C.char)(unsafe.Pointer(&verb[0]))
	} else {
...
func (this *QNetworkAccessManager) callVirtualBase_MetaObject() *qt6.QMetaObject {

	return qt6.UnsafeNewQMetaObject(unsafe.Pointer(C.QNetworkAccessManager_virtualbase_metaObject(unsafe.Pointer(this.h))))

}
func (this *QNetworkAccessManager) OnMetaObject(slot func(super func() *qt6.QMetaObject) *qt6.QMetaObject) {
...
func (this *QNetworkAccessManager) callVirtualBase_Metacall(param1 qt6.QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {

	return (int)(C.QNetworkAccessManager_virtualbase_metacall(unsafe.Pointer(this.h), (C.int)(param1), (C.int)(param2), param3))

}
func (this *QNetworkAccessManager) OnMetacall(slot func(super func(param1 qt6.QMetaObject__Call, param2 int, param3 unsafe.Pointer) int, param1 qt6.QMetaObject__Call, param2 int, param3 unsafe.Pointer) int) {
