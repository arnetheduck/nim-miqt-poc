...
proc setCiphersWithCiphers*(self: QSslConfiguration, ciphers: string): void =
...
proc handshakeMustInterruptOnError*(self: QSslConfiguration, ): bool =

  fcQSslConfiguration_handshakeMustInterruptOnError(self.h)

proc setHandshakeMustInterruptOnError*(self: QSslConfiguration, interrupt: bool): void =

  fcQSslConfiguration_setHandshakeMustInterruptOnError(self.h, interrupt)

proc missingCertificateIsFatal*(self: QSslConfiguration, ): bool =

  fcQSslConfiguration_missingCertificateIsFatal(self.h)

proc setMissingCertificateIsFatal*(self: QSslConfiguration, cannotRecover: bool): void =
