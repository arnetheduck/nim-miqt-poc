...
func (this *QTcpSocket) callVirtualBase_MetaObject() *qt6.QMetaObject {

	return qt6.UnsafeNewQMetaObject(unsafe.Pointer(C.QTcpSocket_virtualbase_metaObject(unsafe.Pointer(this.h))))

}
func (this *QTcpSocket) OnmetaObject(slot func(super func() *qt6.QMetaObject) *qt6.QMetaObject) {
