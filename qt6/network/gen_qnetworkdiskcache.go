...
func (this *QNetworkDiskCache) Metacall(param1 qt6.QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {
	return (int)(C.QNetworkDiskCache_metacall(this.h, (C.int)(param1), (C.int)(param2), param3))
}
...
func (this *QNetworkDiskCache) callVirtualBase_MetaObject() *qt6.QMetaObject {

	return qt6.UnsafeNewQMetaObject(unsafe.Pointer(C.QNetworkDiskCache_virtualbase_metaObject(unsafe.Pointer(this.h))))

}
func (this *QNetworkDiskCache) OnmetaObject(slot func(super func() *qt6.QMetaObject) *qt6.QMetaObject) {
	ok := C.QNetworkDiskCache_override_virtual_metaObject(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
...
func miqt_exec_callback_QNetworkDiskCache_metaObject(self *C.QNetworkDiskCache, cb C.intptr_t) *C.QMetaObject {
...
func (this *QNetworkDiskCache) callVirtualBase_Metacast(param1 string) unsafe.Pointer {
	...
	return (unsafe.Pointer)(C.QNetworkDiskCache_virtualbase_metacast(unsafe.Pointer(this.h), param1_Cstring))

}
func (this *QNetworkDiskCache) Onmetacast(slot func(super func(param1 string) unsafe.Pointer, param1 string) unsafe.Pointer) {
	ok := C.QNetworkDiskCache_override_virtual_metacast(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func miqt_exec_callback_QNetworkDiskCache_metacast(self *C.QNetworkDiskCache, cb C.intptr_t, param1 *C.const_char) unsafe.Pointer {
...
func (this *QNetworkDiskCache) callVirtualBase_Metacall(param1 qt6.QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {

	return (int)(C.QNetworkDiskCache_virtualbase_metacall(unsafe.Pointer(this.h), (C.int)(param1), (C.int)(param2), param3))

}
func (this *QNetworkDiskCache) OnMetacall(slot func(super func(param1 qt6.QMetaObject__Call, param2 int, param3 unsafe.Pointer) int, param1 qt6.QMetaObject__Call, param2 int, param3 unsafe.Pointer) int) {
	ok := C.QNetworkDiskCache_override_virtual_metacall(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}

//export miqt_exec_callback_QNetworkDiskCache_metacall
func miqt_exec_callback_QNetworkDiskCache_metacall(self *C.QNetworkDiskCache, cb C.intptr_t, param1 C.int, param2 C.int, param3 unsafe.Pointer) C.int {
	...
	virtualReturn := gofunc((&QNetworkDiskCache{h: self}).callVirtualBase_Metacall, slotval1, slotval2, slotval3)
