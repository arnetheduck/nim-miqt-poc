...
proc miqt_exec_callback_cQNetworkReply_socketStartedConnecting_release(slot: int) {.exportc: "miqt_exec_callback_QNetworkReply_socketStartedConnecting_release".} =
...
proc miqt_exec_callback_cQNetworkReply_requestSent_release(slot: int) {.exportc: "miqt_exec_callback_QNetworkReply_requestSent_release".} =
