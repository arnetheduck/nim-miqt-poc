...
proc fQUdpSocket_virtualbase_metaObject(self: pointer, ): pointer{.importc: "QUdpSocket_virtualbase_metaObject".}
proc fcQUdpSocket_override_virtual_metaObject(self: pointer, slot: int) {.importc: "QUdpSocket_override_virtual_metaObject".}
proc fQUdpSocket_virtualbase_metacast(self: pointer, param1: cstring): pointer{.importc: "QUdpSocket_virtualbase_metacast".}
proc fcQUdpSocket_override_virtual_metacast(self: pointer, slot: int) {.importc: "QUdpSocket_override_virtual_metacast".}
...
proc bindX*(self: QUdpSocket, addrVal: gen_qhostaddress.QHostAddressSpecialAddress): bool =
...
proc bind2*(self: QUdpSocket, addrVal: gen_qhostaddress.QHostAddressSpecialAddress, port: cushort): bool =

  fcQUdpSocket_bind2(self.h, cint(addrVal), port)

proc bind3*(self: QUdpSocket, addrVal: gen_qhostaddress.QHostAddressSpecialAddress, port: cushort, mode: gen_qabstractsocket.QAbstractSocketBindFlag): bool =
...
proc miqt_exec_callback_QUdpSocket_resume(self: ptr cQUdpSocket, slot: int): void {.exportc: "miqt_exec_callback_QUdpSocket_resume ".} =
  ...
  nimfunc[](superCall)
proc callVirtualBase_bindX(self: QUdpSocket, address: gen_qhostaddress.QHostAddress, port: cushort, mode: gen_qabstractsocket.QAbstractSocketBindFlag): bool =


  fQUdpSocket_virtualbase_bind(self.h, address.h, port, cint(mode))

type QUdpSocketbindXBase* = proc(address: gen_qhostaddress.QHostAddress, port: cushort, mode: gen_qabstractsocket.QAbstractSocketBindFlag): bool
proc onbindX*(self: QUdpSocket, slot: proc(super: QUdpSocketbindXBase, address: gen_qhostaddress.QHostAddress, port: cushort, mode: gen_qabstractsocket.QAbstractSocketBindFlag): bool) =
  # TODO check subclass
  type Cb = proc(super: QUdpSocketbindXBase, address: gen_qhostaddress.QHostAddress, port: cushort, mode: gen_qabstractsocket.QAbstractSocketBindFlag): bool
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QUdpSocket_bind(self: ptr cQUdpSocket, slot: int, address: pointer, port: cushort, mode: cint): bool {.exportc: "miqt_exec_callback_QUdpSocket_bind ".} =
  ...
  proc superCall(address: gen_qhostaddress.QHostAddress, port: cushort, mode: gen_qabstractsocket.QAbstractSocketBindFlag): auto =
    callVirtualBase_bindX(QUdpSocket(h: self), address, port, mode)
  ...
  virtualReturn
proc callVirtualBase_connectToHost(self: QUdpSocket, hostName: string, port: cushort, mode: gen_qiodevicebase.QIODeviceBaseOpenModeFlag, protocol: gen_qabstractsocket.QAbstractSocketNetworkLayerProtocol): void =
...
type QUdpSocketconnectToHostBase* = proc(hostName: string, port: cushort, mode: gen_qiodevicebase.QIODeviceBaseOpenModeFlag, protocol: gen_qabstractsocket.QAbstractSocketNetworkLayerProtocol): void
proc onconnectToHost*(self: QUdpSocket, slot: proc(super: QUdpSocketconnectToHostBase, hostName: string, port: cushort, mode: gen_qiodevicebase.QIODeviceBaseOpenModeFlag, protocol: gen_qabstractsocket.QAbstractSocketNetworkLayerProtocol): void) =
  # TODO check subclass
  type Cb = proc(super: QUdpSocketconnectToHostBase, hostName: string, port: cushort, mode: gen_qiodevicebase.QIODeviceBaseOpenModeFlag, protocol: gen_qabstractsocket.QAbstractSocketNetworkLayerProtocol): void
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QUdpSocket_socketDescriptor(self: ptr cQUdpSocket, slot: int): uint {.exportc: "miqt_exec_callback_QUdpSocket_socketDescriptor ".} =
  ...
  virtualReturn
proc callVirtualBase_setSocketDescriptor(self: QUdpSocket, socketDescriptor: uint, state: gen_qabstractsocket.QAbstractSocketSocketState, openMode: gen_qiodevicebase.QIODeviceBaseOpenModeFlag): bool =


  fQUdpSocket_virtualbase_setSocketDescriptor(self.h, socketDescriptor, cint(state), cint(openMode))

type QUdpSocketsetSocketDescriptorBase* = proc(socketDescriptor: uint, state: gen_qabstractsocket.QAbstractSocketSocketState, openMode: gen_qiodevicebase.QIODeviceBaseOpenModeFlag): bool
proc onsetSocketDescriptor*(self: QUdpSocket, slot: proc(super: QUdpSocketsetSocketDescriptorBase, socketDescriptor: uint, state: gen_qabstractsocket.QAbstractSocketSocketState, openMode: gen_qiodevicebase.QIODeviceBaseOpenModeFlag): bool) =
  # TODO check subclass
  type Cb = proc(super: QUdpSocketsetSocketDescriptorBase, socketDescriptor: uint, state: gen_qabstractsocket.QAbstractSocketSocketState, openMode: gen_qiodevicebase.QIODeviceBaseOpenModeFlag): bool
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QUdpSocket_readLineData(self: ptr cQUdpSocket, slot: int, data: cstring, maxlen: clonglong): clonglong {.exportc: "miqt_exec_callback_QUdpSocket_readLineData ".} =
  ...
  virtualReturn
proc callVirtualBase_skipData(self: QUdpSocket, maxSize: clonglong): clonglong =


  fQUdpSocket_virtualbase_skipData(self.h, maxSize)

type QUdpSocketskipDataBase* = proc(maxSize: clonglong): clonglong
proc onskipData*(self: QUdpSocket, slot: proc(super: QUdpSocketskipDataBase, maxSize: clonglong): clonglong) =
  # TODO check subclass
  type Cb = proc(super: QUdpSocketskipDataBase, maxSize: clonglong): clonglong
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QUdpSocket_skipData(self: ptr cQUdpSocket, slot: int, maxSize: clonglong): clonglong {.exportc: "miqt_exec_callback_QUdpSocket_skipData ".} =
  ...
  proc superCall(maxSize: clonglong): auto =
    callVirtualBase_skipData(QUdpSocket(h: self), maxSize)
...
proc miqt_exec_callback_QUdpSocket_writeData(self: ptr cQUdpSocket, slot: int, data: cstring, len: clonglong): clonglong {.exportc: "miqt_exec_callback_QUdpSocket_writeData ".} =
  ...
  virtualReturn
proc callVirtualBase_open(self: QUdpSocket, mode: gen_qiodevicebase.QIODeviceBaseOpenModeFlag): bool =


  fQUdpSocket_virtualbase_open(self.h, cint(mode))

type QUdpSocketopenBase* = proc(mode: gen_qiodevicebase.QIODeviceBaseOpenModeFlag): bool
proc onopen*(self: QUdpSocket, slot: proc(super: QUdpSocketopenBase, mode: gen_qiodevicebase.QIODeviceBaseOpenModeFlag): bool) =
  # TODO check subclass
  type Cb = proc(super: QUdpSocketopenBase, mode: gen_qiodevicebase.QIODeviceBaseOpenModeFlag): bool
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
