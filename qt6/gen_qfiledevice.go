...
type QFileDevice__MemoryMapFlag int

const (
	QFileDevice__NoOptions        QFileDevice__MemoryMapFlag = 0
	QFileDevice__MapPrivateOption QFileDevice__MemoryMapFlag = 1
)
...
func (this *QFileDevice) Metacall(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {
	return (int)(C.QFileDevice_metacall(this.h, (C.int)(param1), (C.int)(param2), param3))
}
