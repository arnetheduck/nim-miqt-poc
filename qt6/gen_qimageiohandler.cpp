...
QObject* QImageIOPlugin_protectedbase_sender(const void* self) {
	return ( (const MiqtVirtualQImageIOPlugin*)(self) )->protectedbase_sender();
}

int QImageIOPlugin_protectedbase_senderSignalIndex(const void* self) {
	return ( (const MiqtVirtualQImageIOPlugin*)(self) )->protectedbase_senderSignalIndex();
}

int QImageIOPlugin_protectedbase_receivers(const void* self, const char* signal) {
	return ( (const MiqtVirtualQImageIOPlugin*)(self) )->protectedbase_receivers(signal);
}

bool QImageIOPlugin_protectedbase_isSignalConnected(const void* self, QMetaMethod* signal) {
	return ( (const MiqtVirtualQImageIOPlugin*)(self) )->protectedbase_isSignalConnected(signal);
}
