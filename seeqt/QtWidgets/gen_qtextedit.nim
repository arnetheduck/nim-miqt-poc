...
proc find*(self: gen_qtextedit_types.QTextEdit, exp: QRegExp): bool =
...
proc find*(self: gen_qtextedit_types.QTextEdit, exp: QRegExp, options: cint): bool =
...
proc miqt_exec_callback_QTextEdit_paintEngine(self: ptr cQTextEdit, slot: int): pointer {.exportc: "miqt_exec_callback_QTextEdit_paintEngine ".} =
  ...
  virtualReturn.h
proc QTextEditenterEvent*(self: gen_qtextedit_types.QTextEdit, event: QEvent): void =
  fQTextEdit_virtualbase_enterEvent(self.h, event.h)

type QTextEditenterEventProc* = proc(event: QEvent): void
