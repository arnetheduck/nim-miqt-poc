...
func init*(T: type gen_qtextedit_types.QTextEdit, h: ptr cQTextEdit): gen_qtextedit_types.QTextEdit =
  T(h: h)
proc create*(T: type gen_qtextedit_types.QTextEdit, parent: QWidget): gen_qtextedit_types.QTextEdit =
...
proc create*(T: type gen_qtextedit_types.QTextEdit, text: string, parent: QWidget): gen_qtextedit_types.QTextEdit =
  gen_qtextedit_types.QTextEdit.init(fcQTextEdit_new4(struct_miqt_string(data: text, len: csize_t(len(text))), parent.h))

proc metaObject*(self: gen_qtextedit_types.QTextEdit, ): QMetaObject =
  QMetaObject(h: fcQTextEdit_metaObject(self.h))
...
proc setDocument*(self: gen_qtextedit_types.QTextEdit, document: QTextDocument): void =
  fcQTextEdit_setDocument(self.h, document.h)

proc document*(self: gen_qtextedit_types.QTextEdit, ): QTextDocument =
  QTextDocument(h: fcQTextEdit_document(self.h))
...
proc setTextCursor*(self: gen_qtextedit_types.QTextEdit, cursor: QTextCursor): void =
  fcQTextEdit_setTextCursor(self.h, cursor.h)

proc textCursor*(self: gen_qtextedit_types.QTextEdit, ): QTextCursor =
  QTextCursor(h: fcQTextEdit_textCursor(self.h))
...
proc textColor*(self: gen_qtextedit_types.QTextEdit, ): QColor =
  QColor(h: fcQTextEdit_textColor(self.h))

proc textBackgroundColor*(self: gen_qtextedit_types.QTextEdit, ): QColor =
  QColor(h: fcQTextEdit_textBackgroundColor(self.h))

proc currentFont*(self: gen_qtextedit_types.QTextEdit, ): QFont =
  QFont(h: fcQTextEdit_currentFont(self.h))

proc alignment*(self: gen_qtextedit_types.QTextEdit, ): cint =
  cint(fcQTextEdit_alignment(self.h))

proc mergeCurrentCharFormat*(self: gen_qtextedit_types.QTextEdit, modifier: QTextCharFormat): void =
  fcQTextEdit_mergeCurrentCharFormat(self.h, modifier.h)

proc setCurrentCharFormat*(self: gen_qtextedit_types.QTextEdit, format: QTextCharFormat): void =
  fcQTextEdit_setCurrentCharFormat(self.h, format.h)

proc currentCharFormat*(self: gen_qtextedit_types.QTextEdit, ): QTextCharFormat =
  QTextCharFormat(h: fcQTextEdit_currentCharFormat(self.h))
...
proc find*(self: gen_qtextedit_types.QTextEdit, exp: QRegularExpression): bool =
...
proc loadResource*(self: gen_qtextedit_types.QTextEdit, typeVal: cint, name: QUrl): QVariant =
  QVariant(h: fcQTextEdit_loadResource(self.h, typeVal, name.h))

proc createStandardContextMenu*(self: gen_qtextedit_types.QTextEdit, ): QMenu =
  QMenu(h: fcQTextEdit_createStandardContextMenu(self.h))

proc createStandardContextMenu*(self: gen_qtextedit_types.QTextEdit, position: QPoint): QMenu =
  QMenu(h: fcQTextEdit_createStandardContextMenuWithPosition(self.h, position.h))

proc cursorForPosition*(self: gen_qtextedit_types.QTextEdit, pos: QPoint): QTextCursor =
  QTextCursor(h: fcQTextEdit_cursorForPosition(self.h, pos.h))

proc cursorRect*(self: gen_qtextedit_types.QTextEdit, cursor: QTextCursor): QRect =
  QRect(h: fcQTextEdit_cursorRect(self.h, cursor.h))

proc cursorRect*(self: gen_qtextedit_types.QTextEdit, ): QRect =
  QRect(h: fcQTextEdit_cursorRect2(self.h))

proc anchorAt*(self: gen_qtextedit_types.QTextEdit, pos: QPoint): string =
...
proc setExtraSelections*(self: gen_qtextedit_types.QTextEdit, selections: seq[QTextEditExtraSelection]): void =
...
proc extraSelections*(self: gen_qtextedit_types.QTextEdit, ): seq[QTextEditExtraSelection] =
...
proc print*(self: gen_qtextedit_types.QTextEdit, printer: QPagedPaintDevice): void =
  fcQTextEdit_print(self.h, printer.h)

proc inputMethodQuery*(self: gen_qtextedit_types.QTextEdit, property: cint): QVariant =
  QVariant(h: fcQTextEdit_inputMethodQuery(self.h, cint(property)))

proc inputMethodQuery*(self: gen_qtextedit_types.QTextEdit, query: cint, argument: QVariant): QVariant =
  QVariant(h: fcQTextEdit_inputMethodQuery2(self.h, cint(query), argument.h))
...
proc setTextColor*(self: gen_qtextedit_types.QTextEdit, c: QColor): void =
  fcQTextEdit_setTextColor(self.h, c.h)

proc setTextBackgroundColor*(self: gen_qtextedit_types.QTextEdit, c: QColor): void =
  fcQTextEdit_setTextBackgroundColor(self.h, c.h)

proc setCurrentFont*(self: gen_qtextedit_types.QTextEdit, f: QFont): void =
...
proc currentCharFormatChanged*(self: gen_qtextedit_types.QTextEdit, format: QTextCharFormat): void =
  fcQTextEdit_currentCharFormatChanged(self.h, format.h)

type QTextEditcurrentCharFormatChangedSlot* = proc(format: QTextCharFormat)
proc miqt_exec_callback_QTextEdit_currentCharFormatChanged(slot: int, format: pointer) {.exportc.} =
  ...
  let slotval1 = QTextCharFormat(h: format)
...
proc find*(self: gen_qtextedit_types.QTextEdit, exp: QRegularExpression, options: cint): bool =
...
proc miqt_exec_callback_QTextEdit_metacall(self: ptr cQTextEdit, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QTextEdit_metacall ".} =
  ...
  virtualReturn
proc QTextEditloadResource*(self: gen_qtextedit_types.QTextEdit, typeVal: cint, name: QUrl): QVariant =
  QVariant(h: fQTextEdit_virtualbase_loadResource(self.h, typeVal, name.h))

type QTextEditloadResourceProc* = proc(typeVal: cint, name: QUrl): QVariant
...
proc miqt_exec_callback_QTextEdit_loadResource(self: ptr cQTextEdit, slot: int, typeVal: cint, name: pointer): pointer {.exportc: "miqt_exec_callback_QTextEdit_loadResource ".} =
  ...
  virtualReturn.h
proc QTextEditinputMethodQuery*(self: gen_qtextedit_types.QTextEdit, property: cint): QVariant =
  QVariant(h: fQTextEdit_virtualbase_inputMethodQuery(self.h, cint(property)))

type QTextEditinputMethodQueryProc* = proc(property: cint): QVariant
...
proc miqt_exec_callback_QTextEdit_inputMethodQuery(self: ptr cQTextEdit, slot: int, property: cint): pointer {.exportc: "miqt_exec_callback_QTextEdit_inputMethodQuery ".} =
  ...
  virtualReturn.h
proc QTextEditevent*(self: gen_qtextedit_types.QTextEdit, e: QEvent): bool =
  fQTextEdit_virtualbase_event(self.h, e.h)

type QTextEditeventProc* = proc(e: QEvent): bool
...
proc miqt_exec_callback_QTextEdit_event(self: ptr cQTextEdit, slot: int, e: pointer): bool {.exportc: "miqt_exec_callback_QTextEdit_event ".} =
  ...
  virtualReturn
proc QTextEdittimerEvent*(self: gen_qtextedit_types.QTextEdit, e: QTimerEvent): void =
  fQTextEdit_virtualbase_timerEvent(self.h, e.h)

type QTextEdittimerEventProc* = proc(e: QTimerEvent): void
...
proc miqt_exec_callback_QTextEdit_timerEvent(self: ptr cQTextEdit, slot: int, e: pointer): void {.exportc: "miqt_exec_callback_QTextEdit_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTextEditkeyPressEvent*(self: gen_qtextedit_types.QTextEdit, e: QKeyEvent): void =
  fQTextEdit_virtualbase_keyPressEvent(self.h, e.h)

type QTextEditkeyPressEventProc* = proc(e: QKeyEvent): void
...
proc miqt_exec_callback_QTextEdit_keyPressEvent(self: ptr cQTextEdit, slot: int, e: pointer): void {.exportc: "miqt_exec_callback_QTextEdit_keyPressEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTextEditkeyReleaseEvent*(self: gen_qtextedit_types.QTextEdit, e: QKeyEvent): void =
  fQTextEdit_virtualbase_keyReleaseEvent(self.h, e.h)

type QTextEditkeyReleaseEventProc* = proc(e: QKeyEvent): void
...
proc miqt_exec_callback_QTextEdit_keyReleaseEvent(self: ptr cQTextEdit, slot: int, e: pointer): void {.exportc: "miqt_exec_callback_QTextEdit_keyReleaseEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTextEditresizeEvent*(self: gen_qtextedit_types.QTextEdit, e: QResizeEvent): void =
  fQTextEdit_virtualbase_resizeEvent(self.h, e.h)

type QTextEditresizeEventProc* = proc(e: QResizeEvent): void
...
proc miqt_exec_callback_QTextEdit_resizeEvent(self: ptr cQTextEdit, slot: int, e: pointer): void {.exportc: "miqt_exec_callback_QTextEdit_resizeEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTextEditpaintEvent*(self: gen_qtextedit_types.QTextEdit, e: QPaintEvent): void =
  fQTextEdit_virtualbase_paintEvent(self.h, e.h)

type QTextEditpaintEventProc* = proc(e: QPaintEvent): void
...
proc miqt_exec_callback_QTextEdit_paintEvent(self: ptr cQTextEdit, slot: int, e: pointer): void {.exportc: "miqt_exec_callback_QTextEdit_paintEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTextEditmousePressEvent*(self: gen_qtextedit_types.QTextEdit, e: QMouseEvent): void =
  fQTextEdit_virtualbase_mousePressEvent(self.h, e.h)

type QTextEditmousePressEventProc* = proc(e: QMouseEvent): void
...
proc miqt_exec_callback_QTextEdit_mousePressEvent(self: ptr cQTextEdit, slot: int, e: pointer): void {.exportc: "miqt_exec_callback_QTextEdit_mousePressEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTextEditmouseMoveEvent*(self: gen_qtextedit_types.QTextEdit, e: QMouseEvent): void =
  fQTextEdit_virtualbase_mouseMoveEvent(self.h, e.h)

type QTextEditmouseMoveEventProc* = proc(e: QMouseEvent): void
...
proc miqt_exec_callback_QTextEdit_mouseMoveEvent(self: ptr cQTextEdit, slot: int, e: pointer): void {.exportc: "miqt_exec_callback_QTextEdit_mouseMoveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTextEditmouseReleaseEvent*(self: gen_qtextedit_types.QTextEdit, e: QMouseEvent): void =
  fQTextEdit_virtualbase_mouseReleaseEvent(self.h, e.h)

type QTextEditmouseReleaseEventProc* = proc(e: QMouseEvent): void
...
proc miqt_exec_callback_QTextEdit_mouseReleaseEvent(self: ptr cQTextEdit, slot: int, e: pointer): void {.exportc: "miqt_exec_callback_QTextEdit_mouseReleaseEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTextEditmouseDoubleClickEvent*(self: gen_qtextedit_types.QTextEdit, e: QMouseEvent): void =
  fQTextEdit_virtualbase_mouseDoubleClickEvent(self.h, e.h)

type QTextEditmouseDoubleClickEventProc* = proc(e: QMouseEvent): void
...
proc miqt_exec_callback_QTextEdit_focusNextPrevChild(self: ptr cQTextEdit, slot: int, next: bool): bool {.exportc: "miqt_exec_callback_QTextEdit_focusNextPrevChild ".} =
  ...
  virtualReturn
proc QTextEditcontextMenuEvent*(self: gen_qtextedit_types.QTextEdit, e: QContextMenuEvent): void =
  fQTextEdit_virtualbase_contextMenuEvent(self.h, e.h)

type QTextEditcontextMenuEventProc* = proc(e: QContextMenuEvent): void
...
proc miqt_exec_callback_QTextEdit_contextMenuEvent(self: ptr cQTextEdit, slot: int, e: pointer): void {.exportc: "miqt_exec_callback_QTextEdit_contextMenuEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTextEditdragEnterEvent*(self: gen_qtextedit_types.QTextEdit, e: QDragEnterEvent): void =
  fQTextEdit_virtualbase_dragEnterEvent(self.h, e.h)

type QTextEditdragEnterEventProc* = proc(e: QDragEnterEvent): void
...
proc miqt_exec_callback_QTextEdit_dragEnterEvent(self: ptr cQTextEdit, slot: int, e: pointer): void {.exportc: "miqt_exec_callback_QTextEdit_dragEnterEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTextEditdragLeaveEvent*(self: gen_qtextedit_types.QTextEdit, e: QDragLeaveEvent): void =
  fQTextEdit_virtualbase_dragLeaveEvent(self.h, e.h)

type QTextEditdragLeaveEventProc* = proc(e: QDragLeaveEvent): void
...
proc miqt_exec_callback_QTextEdit_dragLeaveEvent(self: ptr cQTextEdit, slot: int, e: pointer): void {.exportc: "miqt_exec_callback_QTextEdit_dragLeaveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTextEditdragMoveEvent*(self: gen_qtextedit_types.QTextEdit, e: QDragMoveEvent): void =
  fQTextEdit_virtualbase_dragMoveEvent(self.h, e.h)

type QTextEditdragMoveEventProc* = proc(e: QDragMoveEvent): void
...
proc miqt_exec_callback_QTextEdit_dragMoveEvent(self: ptr cQTextEdit, slot: int, e: pointer): void {.exportc: "miqt_exec_callback_QTextEdit_dragMoveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTextEditdropEvent*(self: gen_qtextedit_types.QTextEdit, e: QDropEvent): void =
  fQTextEdit_virtualbase_dropEvent(self.h, e.h)

type QTextEditdropEventProc* = proc(e: QDropEvent): void
...
proc miqt_exec_callback_QTextEdit_dropEvent(self: ptr cQTextEdit, slot: int, e: pointer): void {.exportc: "miqt_exec_callback_QTextEdit_dropEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTextEditfocusInEvent*(self: gen_qtextedit_types.QTextEdit, e: QFocusEvent): void =
  fQTextEdit_virtualbase_focusInEvent(self.h, e.h)

type QTextEditfocusInEventProc* = proc(e: QFocusEvent): void
...
proc miqt_exec_callback_QTextEdit_focusInEvent(self: ptr cQTextEdit, slot: int, e: pointer): void {.exportc: "miqt_exec_callback_QTextEdit_focusInEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTextEditfocusOutEvent*(self: gen_qtextedit_types.QTextEdit, e: QFocusEvent): void =
  fQTextEdit_virtualbase_focusOutEvent(self.h, e.h)

type QTextEditfocusOutEventProc* = proc(e: QFocusEvent): void
...
proc miqt_exec_callback_QTextEdit_focusOutEvent(self: ptr cQTextEdit, slot: int, e: pointer): void {.exportc: "miqt_exec_callback_QTextEdit_focusOutEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTextEditshowEvent*(self: gen_qtextedit_types.QTextEdit, param1: QShowEvent): void =
  fQTextEdit_virtualbase_showEvent(self.h, param1.h)

type QTextEditshowEventProc* = proc(param1: QShowEvent): void
...
proc miqt_exec_callback_QTextEdit_showEvent(self: ptr cQTextEdit, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QTextEdit_showEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTextEditchangeEvent*(self: gen_qtextedit_types.QTextEdit, e: QEvent): void =
  fQTextEdit_virtualbase_changeEvent(self.h, e.h)

type QTextEditchangeEventProc* = proc(e: QEvent): void
...
proc miqt_exec_callback_QTextEdit_changeEvent(self: ptr cQTextEdit, slot: int, e: pointer): void {.exportc: "miqt_exec_callback_QTextEdit_changeEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTextEditwheelEvent*(self: gen_qtextedit_types.QTextEdit, e: QWheelEvent): void =
  fQTextEdit_virtualbase_wheelEvent(self.h, e.h)

type QTextEditwheelEventProc* = proc(e: QWheelEvent): void
...
proc miqt_exec_callback_QTextEdit_wheelEvent(self: ptr cQTextEdit, slot: int, e: pointer): void {.exportc: "miqt_exec_callback_QTextEdit_wheelEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTextEditcreateMimeDataFromSelection*(self: gen_qtextedit_types.QTextEdit, ): QMimeData =
  QMimeData(h: fQTextEdit_virtualbase_createMimeDataFromSelection(self.h))

type QTextEditcreateMimeDataFromSelectionProc* = proc(): QMimeData
...
proc miqt_exec_callback_QTextEdit_createMimeDataFromSelection(self: ptr cQTextEdit, slot: int): pointer {.exportc: "miqt_exec_callback_QTextEdit_createMimeDataFromSelection ".} =
  ...
  virtualReturn.h
proc QTextEditcanInsertFromMimeData*(self: gen_qtextedit_types.QTextEdit, source: QMimeData): bool =
  fQTextEdit_virtualbase_canInsertFromMimeData(self.h, source.h)

type QTextEditcanInsertFromMimeDataProc* = proc(source: QMimeData): bool
...
proc miqt_exec_callback_QTextEdit_canInsertFromMimeData(self: ptr cQTextEdit, slot: int, source: pointer): bool {.exportc: "miqt_exec_callback_QTextEdit_canInsertFromMimeData ".} =
  ...
  virtualReturn
proc QTextEditinsertFromMimeData*(self: gen_qtextedit_types.QTextEdit, source: QMimeData): void =
  fQTextEdit_virtualbase_insertFromMimeData(self.h, source.h)

type QTextEditinsertFromMimeDataProc* = proc(source: QMimeData): void
...
proc miqt_exec_callback_QTextEdit_insertFromMimeData(self: ptr cQTextEdit, slot: int, source: pointer): void {.exportc: "miqt_exec_callback_QTextEdit_insertFromMimeData ".} =
  ...
  nimfunc[](slotval1)
proc QTextEditinputMethodEvent*(self: gen_qtextedit_types.QTextEdit, param1: QInputMethodEvent): void =
  fQTextEdit_virtualbase_inputMethodEvent(self.h, param1.h)

type QTextEditinputMethodEventProc* = proc(param1: QInputMethodEvent): void
...
proc QTextEditdoSetTextCursor*(self: gen_qtextedit_types.QTextEdit, cursor: QTextCursor): void =
  fQTextEdit_virtualbase_doSetTextCursor(self.h, cursor.h)

type QTextEditdoSetTextCursorProc* = proc(cursor: QTextCursor): void
...
proc miqt_exec_callback_QTextEdit_doSetTextCursor(self: ptr cQTextEdit, slot: int, cursor: pointer): void {.exportc: "miqt_exec_callback_QTextEdit_doSetTextCursor ".} =
  ...
  nimfunc[](slotval1)
proc QTextEditminimumSizeHint*(self: gen_qtextedit_types.QTextEdit, ): QSize =
  QSize(h: fQTextEdit_virtualbase_minimumSizeHint(self.h))

type QTextEditminimumSizeHintProc* = proc(): QSize
...
proc miqt_exec_callback_QTextEdit_minimumSizeHint(self: ptr cQTextEdit, slot: int): pointer {.exportc: "miqt_exec_callback_QTextEdit_minimumSizeHint ".} =
  ...
  virtualReturn.h
proc QTextEditsizeHint*(self: gen_qtextedit_types.QTextEdit, ): QSize =
  QSize(h: fQTextEdit_virtualbase_sizeHint(self.h))

type QTextEditsizeHintProc* = proc(): QSize
...
proc miqt_exec_callback_QTextEdit_sizeHint(self: ptr cQTextEdit, slot: int): pointer {.exportc: "miqt_exec_callback_QTextEdit_sizeHint ".} =
  ...
  virtualReturn.h
proc QTextEditsetupViewport*(self: gen_qtextedit_types.QTextEdit, viewport: QWidget): void =
  fQTextEdit_virtualbase_setupViewport(self.h, viewport.h)

type QTextEditsetupViewportProc* = proc(viewport: QWidget): void
...
proc miqt_exec_callback_QTextEdit_setupViewport(self: ptr cQTextEdit, slot: int, viewport: pointer): void {.exportc: "miqt_exec_callback_QTextEdit_setupViewport ".} =
  ...
  nimfunc[](slotval1)
proc QTextEditeventFilter*(self: gen_qtextedit_types.QTextEdit, param1: QObject, param2: QEvent): bool =
  fQTextEdit_virtualbase_eventFilter(self.h, param1.h, param2.h)

type QTextEditeventFilterProc* = proc(param1: QObject, param2: QEvent): bool
...
proc miqt_exec_callback_QTextEdit_eventFilter(self: ptr cQTextEdit, slot: int, param1: pointer, param2: pointer): bool {.exportc: "miqt_exec_callback_QTextEdit_eventFilter ".} =
  ...
  virtualReturn
proc QTextEditviewportEvent*(self: gen_qtextedit_types.QTextEdit, param1: QEvent): bool =
  fQTextEdit_virtualbase_viewportEvent(self.h, param1.h)

type QTextEditviewportEventProc* = proc(param1: QEvent): bool
...
proc miqt_exec_callback_QTextEdit_viewportEvent(self: ptr cQTextEdit, slot: int, param1: pointer): bool {.exportc: "miqt_exec_callback_QTextEdit_viewportEvent ".} =
  ...
  virtualReturn
proc QTextEditviewportSizeHint*(self: gen_qtextedit_types.QTextEdit, ): QSize =
  QSize(h: fQTextEdit_virtualbase_viewportSizeHint(self.h))

type QTextEditviewportSizeHintProc* = proc(): QSize
...
proc miqt_exec_callback_QTextEdit_viewportSizeHint(self: ptr cQTextEdit, slot: int): pointer {.exportc: "miqt_exec_callback_QTextEdit_viewportSizeHint ".} =
  ...
  virtualReturn.h
proc QTextEditinitStyleOption*(self: gen_qtextedit_types.QTextEdit, option: QStyleOptionFrame): void =
  fQTextEdit_virtualbase_initStyleOption(self.h, option.h)

type QTextEditinitStyleOptionProc* = proc(option: QStyleOptionFrame): void
...
proc miqt_exec_callback_QTextEdit_hasHeightForWidth(self: ptr cQTextEdit, slot: int): bool {.exportc: "miqt_exec_callback_QTextEdit_hasHeightForWidth ".} =
  ...
  virtualReturn
proc QTextEditpaintEngine*(self: gen_qtextedit_types.QTextEdit, ): QPaintEngine =
  QPaintEngine(h: fQTextEdit_virtualbase_paintEngine(self.h))

type QTextEditpaintEngineProc* = proc(): QPaintEngine
...
proc miqt_exec_callback_QTextEdit_paintEngine(self: ptr cQTextEdit, slot: int): pointer {.exportc: "miqt_exec_callback_QTextEdit_paintEngine ".} =
  ...
  virtualReturn.h
proc QTextEditenterEvent*(self: gen_qtextedit_types.QTextEdit, event: QEnterEvent): void =
  fQTextEdit_virtualbase_enterEvent(self.h, event.h)

type QTextEditenterEventProc* = proc(event: QEnterEvent): void
...
proc miqt_exec_callback_QTextEdit_enterEvent(self: ptr cQTextEdit, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTextEdit_enterEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTextEditleaveEvent*(self: gen_qtextedit_types.QTextEdit, event: QEvent): void =
  fQTextEdit_virtualbase_leaveEvent(self.h, event.h)

type QTextEditleaveEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QTextEdit_leaveEvent(self: ptr cQTextEdit, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTextEdit_leaveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTextEditmoveEvent*(self: gen_qtextedit_types.QTextEdit, event: QMoveEvent): void =
  fQTextEdit_virtualbase_moveEvent(self.h, event.h)

type QTextEditmoveEventProc* = proc(event: QMoveEvent): void
...
proc miqt_exec_callback_QTextEdit_moveEvent(self: ptr cQTextEdit, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTextEdit_moveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTextEditcloseEvent*(self: gen_qtextedit_types.QTextEdit, event: QCloseEvent): void =
  fQTextEdit_virtualbase_closeEvent(self.h, event.h)

type QTextEditcloseEventProc* = proc(event: QCloseEvent): void
...
proc miqt_exec_callback_QTextEdit_closeEvent(self: ptr cQTextEdit, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTextEdit_closeEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTextEdittabletEvent*(self: gen_qtextedit_types.QTextEdit, event: QTabletEvent): void =
  fQTextEdit_virtualbase_tabletEvent(self.h, event.h)

type QTextEdittabletEventProc* = proc(event: QTabletEvent): void
...
proc miqt_exec_callback_QTextEdit_tabletEvent(self: ptr cQTextEdit, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTextEdit_tabletEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTextEditactionEvent*(self: gen_qtextedit_types.QTextEdit, event: QActionEvent): void =
  fQTextEdit_virtualbase_actionEvent(self.h, event.h)

type QTextEditactionEventProc* = proc(event: QActionEvent): void
...
proc miqt_exec_callback_QTextEdit_actionEvent(self: ptr cQTextEdit, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTextEdit_actionEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTextEdithideEvent*(self: gen_qtextedit_types.QTextEdit, event: QHideEvent): void =
  fQTextEdit_virtualbase_hideEvent(self.h, event.h)

type QTextEdithideEventProc* = proc(event: QHideEvent): void
...
proc miqt_exec_callback_QTextEdit_metric(self: ptr cQTextEdit, slot: int, param1: cint): cint {.exportc: "miqt_exec_callback_QTextEdit_metric ".} =
  ...
  virtualReturn
proc QTextEditinitPainter*(self: gen_qtextedit_types.QTextEdit, painter: QPainter): void =
  fQTextEdit_virtualbase_initPainter(self.h, painter.h)

type QTextEditinitPainterProc* = proc(painter: QPainter): void
...
proc miqt_exec_callback_QTextEdit_initPainter(self: ptr cQTextEdit, slot: int, painter: pointer): void {.exportc: "miqt_exec_callback_QTextEdit_initPainter ".} =
  ...
  nimfunc[](slotval1)
proc QTextEditredirected*(self: gen_qtextedit_types.QTextEdit, offset: QPoint): QPaintDevice =
  QPaintDevice(h: fQTextEdit_virtualbase_redirected(self.h, offset.h))

type QTextEditredirectedProc* = proc(offset: QPoint): QPaintDevice
...
proc miqt_exec_callback_QTextEdit_redirected(self: ptr cQTextEdit, slot: int, offset: pointer): pointer {.exportc: "miqt_exec_callback_QTextEdit_redirected ".} =
  ...
  virtualReturn.h
proc QTextEditsharedPainter*(self: gen_qtextedit_types.QTextEdit, ): QPainter =
  QPainter(h: fQTextEdit_virtualbase_sharedPainter(self.h))

type QTextEditsharedPainterProc* = proc(): QPainter
...
proc miqt_exec_callback_QTextEdit_sharedPainter(self: ptr cQTextEdit, slot: int): pointer {.exportc: "miqt_exec_callback_QTextEdit_sharedPainter ".} =
  ...
  virtualReturn.h
proc QTextEditchildEvent*(self: gen_qtextedit_types.QTextEdit, event: QChildEvent): void =
  fQTextEdit_virtualbase_childEvent(self.h, event.h)

type QTextEditchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QTextEdit_childEvent(self: ptr cQTextEdit, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTextEdit_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTextEditcustomEvent*(self: gen_qtextedit_types.QTextEdit, event: QEvent): void =
  fQTextEdit_virtualbase_customEvent(self.h, event.h)

type QTextEditcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QTextEdit_customEvent(self: ptr cQTextEdit, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTextEdit_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTextEditconnectNotify*(self: gen_qtextedit_types.QTextEdit, signal: QMetaMethod): void =
  fQTextEdit_virtualbase_connectNotify(self.h, signal.h)

type QTextEditconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QTextEdit_connectNotify(self: ptr cQTextEdit, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QTextEdit_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QTextEditdisconnectNotify*(self: gen_qtextedit_types.QTextEdit, signal: QMetaMethod): void =
  fQTextEdit_virtualbase_disconnectNotify(self.h, signal.h)

type QTextEditdisconnectNotifyProc* = proc(signal: QMetaMethod): void
...
func init*(T: type gen_qtextedit_types.QTextEditExtraSelection, h: ptr cQTextEditExtraSelection): gen_qtextedit_types.QTextEditExtraSelection =
  T(h: h)
proc create*(T: type gen_qtextedit_types.QTextEditExtraSelection, param1: QTextEditExtraSelection): gen_qtextedit_types.QTextEditExtraSelection =
  gen_qtextedit_types.QTextEditExtraSelection.init(fcQTextEditExtraSelection_new(param1.h))

proc operatorAssign*(self: gen_qtextedit_types.QTextEditExtraSelection, param1: QTextEditExtraSelection): void =
