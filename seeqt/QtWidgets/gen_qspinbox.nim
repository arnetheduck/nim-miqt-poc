...
proc miqt_exec_callback_cQSpinBox_valueChangedWithQString(slot: int, param1: struct_miqt_string) {.cdecl.} =
...
proc miqt_exec_callback_cQSpinBox_valueChangedWithQString_release(slot: int) {.cdecl.} =
...
proc onvalueChanged*(self: gen_qspinbox_types.QSpinBox, slot: QSpinBoxvalueChangedWithQStringSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQSpinBox_connect_valueChangedWithQString(self.h, cast[int](addr tmp[]), miqt_exec_callback_cQSpinBox_valueChangedWithQString, miqt_exec_callback_cQSpinBox_valueChangedWithQString_release)
...
proc miqt_exec_callback_cQDoubleSpinBox_valueChangedWithQString(slot: int, param1: struct_miqt_string) {.cdecl.} =
...
proc miqt_exec_callback_cQDoubleSpinBox_valueChangedWithQString_release(slot: int) {.cdecl.} =
...
proc onvalueChanged*(self: gen_qspinbox_types.QDoubleSpinBox, slot: QDoubleSpinBoxvalueChangedWithQStringSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQDoubleSpinBox_connect_valueChangedWithQString(self.h, cast[int](addr tmp[]), miqt_exec_callback_cQDoubleSpinBox_valueChangedWithQString, miqt_exec_callback_cQDoubleSpinBox_valueChangedWithQString_release)
