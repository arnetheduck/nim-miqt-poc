...
void QStackedWidget_connect_currentChanged(QStackedWidget* self, intptr_t slot, void (*callback)(intptr_t, int), void (*release)(intptr_t)) {
	...
	MiqtVirtualQStackedWidget::connect(self, static_cast<void (QStackedWidget::*)(int)>(&QStackedWidget::currentChanged), self, caller{slot, callback, release});
}
...
void QStackedWidget_connect_widgetRemoved(QStackedWidget* self, intptr_t slot, void (*callback)(intptr_t, int), void (*release)(intptr_t)) {
	...
	MiqtVirtualQStackedWidget::connect(self, static_cast<void (QStackedWidget::*)(int)>(&QStackedWidget::widgetRemoved), self, caller{slot, callback, release});
}
...
QMetaObject* QStackedWidget_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQStackedWidget*)(self) )->QStackedWidget::metaObject();

}

void* QStackedWidget_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQStackedWidget*)(self) )->QStackedWidget::qt_metacast(param1);

}

int QStackedWidget_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQStackedWidget*)(self) )->QStackedWidget::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
bool QStackedWidget_virtualbase_nativeEvent(void* self, struct miqt_string eventType, void* message, long* result) {
	...
	return ( (MiqtVirtualQStackedWidget*)(self) )->QStackedWidget::nativeEvent(eventType_QByteArray, message, static_cast<long*>(result));
