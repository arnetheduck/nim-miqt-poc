...
void QFontDialog_connect_currentFontChanged(QFontDialog* self, intptr_t slot, void (*callback)(intptr_t, QFont*), void (*release)(intptr_t)) {
	...
	MiqtVirtualQFontDialog::connect(self, static_cast<void (QFontDialog::*)(const QFont&)>(&QFontDialog::currentFontChanged), self, caller{slot, callback, release});
}
...
void QFontDialog_connect_fontSelected(QFontDialog* self, intptr_t slot, void (*callback)(intptr_t, QFont*), void (*release)(intptr_t)) {
	...
	MiqtVirtualQFontDialog::connect(self, static_cast<void (QFontDialog::*)(const QFont&)>(&QFontDialog::fontSelected), self, caller{slot, callback, release});
}
...
QMetaObject* QFontDialog_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQFontDialog*)(self) )->QFontDialog::metaObject();

}

void* QFontDialog_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQFontDialog*)(self) )->QFontDialog::qt_metacast(param1);

}

int QFontDialog_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQFontDialog*)(self) )->QFontDialog::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
void QFontDialog_protectedbase_adjustPosition(void* self, QWidget* param1) {
	MiqtVirtualQFontDialog* self_cast = static_cast<MiqtVirtualQFontDialog*>( (QFontDialog*)(self) );
