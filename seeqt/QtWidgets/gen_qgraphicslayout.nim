...
proc create*(T: type gen_qgraphicslayout_types.QGraphicsLayout, parent: QGraphicsLayoutItem): gen_qgraphicslayout_types.QGraphicsLayout =
...
proc widgetEvent*(self: gen_qgraphicslayout_types.QGraphicsLayout, e: QEvent): void =
...
proc itemAt*(self: gen_qgraphicslayout_types.QGraphicsLayout, i: cint): QGraphicsLayoutItem =
  QGraphicsLayoutItem(h: fcQGraphicsLayout_itemAt(self.h, i))
...
proc miqt_exec_callback_QGraphicsLayout_updateGeometry(self: ptr cQGraphicsLayout, slot: int): void {.exportc: "miqt_exec_callback_QGraphicsLayout_updateGeometry ".} =
  ...
  nimfunc[]()
proc QGraphicsLayoutwidgetEvent*(self: gen_qgraphicslayout_types.QGraphicsLayout, e: QEvent): void =
  fQGraphicsLayout_virtualbase_widgetEvent(self.h, e.h)

type QGraphicsLayoutwidgetEventProc* = proc(e: QEvent): void
...
proc miqt_exec_callback_QGraphicsLayout_count(self: ptr cQGraphicsLayout, slot: int): cint {.exportc: "miqt_exec_callback_QGraphicsLayout_count ".} =
  ...
  virtualReturn
type QGraphicsLayoutitemAtProc* = proc(i: cint): QGraphicsLayoutItem
...
proc miqt_exec_callback_QGraphicsLayout_removeAt(self: ptr cQGraphicsLayout, slot: int, index: cint): void {.exportc: "miqt_exec_callback_QGraphicsLayout_removeAt ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsLayoutsetGeometry*(self: gen_qgraphicslayout_types.QGraphicsLayout, rect: QRectF): void =
  fQGraphicsLayout_virtualbase_setGeometry(self.h, rect.h)

type QGraphicsLayoutsetGeometryProc* = proc(rect: QRectF): void
...
proc miqt_exec_callback_QGraphicsLayout_isEmpty(self: ptr cQGraphicsLayout, slot: int): bool {.exportc: "miqt_exec_callback_QGraphicsLayout_isEmpty ".} =
  ...
  virtualReturn
type QGraphicsLayoutsizeHintProc* = proc(which: cint, constraint: QSizeF): QSizeF
