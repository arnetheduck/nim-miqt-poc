...
func init*(T: type gen_qmainwindow_types.QMainWindow, h: ptr cQMainWindow): gen_qmainwindow_types.QMainWindow =
  T(h: h)
proc create*(T: type gen_qmainwindow_types.QMainWindow, parent: QWidget): gen_qmainwindow_types.QMainWindow =
...
proc create*(T: type gen_qmainwindow_types.QMainWindow, parent: QWidget, flags: cint): gen_qmainwindow_types.QMainWindow =
  gen_qmainwindow_types.QMainWindow.init(fcQMainWindow_new3(parent.h, cint(flags)))

proc metaObject*(self: gen_qmainwindow_types.QMainWindow, ): QMetaObject =
  QMetaObject(h: fcQMainWindow_metaObject(self.h))
...
proc iconSize*(self: gen_qmainwindow_types.QMainWindow, ): QSize =
  QSize(h: fcQMainWindow_iconSize(self.h))

proc setIconSize*(self: gen_qmainwindow_types.QMainWindow, iconSize: QSize): void =
...
proc isSeparator*(self: gen_qmainwindow_types.QMainWindow, pos: QPoint): bool =
  fcQMainWindow_isSeparator(self.h, pos.h)

proc menuBar*(self: gen_qmainwindow_types.QMainWindow, ): QMenuBar =
  QMenuBar(h: fcQMainWindow_menuBar(self.h))

proc setMenuBar*(self: gen_qmainwindow_types.QMainWindow, menubar: QMenuBar): void =
  fcQMainWindow_setMenuBar(self.h, menubar.h)

proc menuWidget*(self: gen_qmainwindow_types.QMainWindow, ): QWidget =
  QWidget(h: fcQMainWindow_menuWidget(self.h))

proc setMenuWidget*(self: gen_qmainwindow_types.QMainWindow, menubar: QWidget): void =
  fcQMainWindow_setMenuWidget(self.h, menubar.h)

proc statusBar*(self: gen_qmainwindow_types.QMainWindow, ): QStatusBar =
  QStatusBar(h: fcQMainWindow_statusBar(self.h))

proc setStatusBar*(self: gen_qmainwindow_types.QMainWindow, statusbar: QStatusBar): void =
  fcQMainWindow_setStatusBar(self.h, statusbar.h)

proc centralWidget*(self: gen_qmainwindow_types.QMainWindow, ): QWidget =
  QWidget(h: fcQMainWindow_centralWidget(self.h))

proc setCentralWidget*(self: gen_qmainwindow_types.QMainWindow, widget: QWidget): void =
  fcQMainWindow_setCentralWidget(self.h, widget.h)

proc takeCentralWidget*(self: gen_qmainwindow_types.QMainWindow, ): QWidget =
  QWidget(h: fcQMainWindow_takeCentralWidget(self.h))
...
proc insertToolBarBreak*(self: gen_qmainwindow_types.QMainWindow, before: QToolBar): void =
  fcQMainWindow_insertToolBarBreak(self.h, before.h)

proc addToolBar*(self: gen_qmainwindow_types.QMainWindow, area: cint, toolbar: QToolBar): void =
  fcQMainWindow_addToolBar(self.h, cint(area), toolbar.h)

proc addToolBar*(self: gen_qmainwindow_types.QMainWindow, toolbar: QToolBar): void =
  fcQMainWindow_addToolBarWithToolbar(self.h, toolbar.h)

proc addToolBar*(self: gen_qmainwindow_types.QMainWindow, title: string): QToolBar =
  QToolBar(h: fcQMainWindow_addToolBarWithTitle(self.h, struct_miqt_string(data: title, len: csize_t(len(title)))))

proc insertToolBar*(self: gen_qmainwindow_types.QMainWindow, before: QToolBar, toolbar: QToolBar): void =
  fcQMainWindow_insertToolBar(self.h, before.h, toolbar.h)

proc removeToolBar*(self: gen_qmainwindow_types.QMainWindow, toolbar: QToolBar): void =
  fcQMainWindow_removeToolBar(self.h, toolbar.h)

proc removeToolBarBreak*(self: gen_qmainwindow_types.QMainWindow, before: QToolBar): void =
...
proc toolBarArea*(self: gen_qmainwindow_types.QMainWindow, toolbar: QToolBar): cint =
  cint(fcQMainWindow_toolBarArea(self.h, toolbar.h))

proc toolBarBreak*(self: gen_qmainwindow_types.QMainWindow, toolbar: QToolBar): bool =
  fcQMainWindow_toolBarBreak(self.h, toolbar.h)

proc addDockWidget*(self: gen_qmainwindow_types.QMainWindow, area: cint, dockwidget: QDockWidget): void =
  fcQMainWindow_addDockWidget(self.h, cint(area), dockwidget.h)

proc addDockWidget*(self: gen_qmainwindow_types.QMainWindow, area: cint, dockwidget: QDockWidget, orientation: cint): void =
  fcQMainWindow_addDockWidget2(self.h, cint(area), dockwidget.h, cint(orientation))

proc splitDockWidget*(self: gen_qmainwindow_types.QMainWindow, after: QDockWidget, dockwidget: QDockWidget, orientation: cint): void =
  fcQMainWindow_splitDockWidget(self.h, after.h, dockwidget.h, cint(orientation))

proc tabifyDockWidget*(self: gen_qmainwindow_types.QMainWindow, first: QDockWidget, second: QDockWidget): void =
  fcQMainWindow_tabifyDockWidget(self.h, first.h, second.h)

proc tabifiedDockWidgets*(self: gen_qmainwindow_types.QMainWindow, dockwidget: QDockWidget): seq[QDockWidget] =
  var v_ma = fcQMainWindow_tabifiedDockWidgets(self.h, dockwidget.h)
  var vx_ret = newSeq[QDockWidget](int(v_ma.len))
  let v_outCast = cast[ptr UncheckedArray[pointer]](v_ma.data)
  for i in 0 ..< v_ma.len:
    vx_ret[i] = QDockWidget(h: v_outCast[i])
  vx_ret

proc removeDockWidget*(self: gen_qmainwindow_types.QMainWindow, dockwidget: QDockWidget): void =
  fcQMainWindow_removeDockWidget(self.h, dockwidget.h)

proc restoreDockWidget*(self: gen_qmainwindow_types.QMainWindow, dockwidget: QDockWidget): bool =
  fcQMainWindow_restoreDockWidget(self.h, dockwidget.h)

proc dockWidgetArea*(self: gen_qmainwindow_types.QMainWindow, dockwidget: QDockWidget): cint =
  cint(fcQMainWindow_dockWidgetArea(self.h, dockwidget.h))

proc resizeDocks*(self: gen_qmainwindow_types.QMainWindow, docks: seq[QDockWidget], sizes: seq[cint], orientation: cint): void =
...
proc createPopupMenu*(self: gen_qmainwindow_types.QMainWindow, ): QMenu =
  QMenu(h: fcQMainWindow_createPopupMenu(self.h))
...
proc iconSizeChanged*(self: gen_qmainwindow_types.QMainWindow, iconSize: QSize): void =
  fcQMainWindow_iconSizeChanged(self.h, iconSize.h)

type QMainWindowiconSizeChangedSlot* = proc(iconSize: QSize)
...
proc tabifiedDockWidgetActivated*(self: gen_qmainwindow_types.QMainWindow, dockWidget: QDockWidget): void =
  fcQMainWindow_tabifiedDockWidgetActivated(self.h, dockWidget.h)

type QMainWindowtabifiedDockWidgetActivatedSlot* = proc(dockWidget: QDockWidget)
proc miqt_exec_callback_QMainWindow_tabifiedDockWidgetActivated(slot: int, dockWidget: pointer) {.exportc.} =
  ...
  let slotval1 = QDockWidget(h: dockWidget)
...
proc miqt_exec_callback_QMainWindow_metacall(self: ptr cQMainWindow, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QMainWindow_metacall ".} =
  ...
  virtualReturn
proc QMainWindowcreatePopupMenu*(self: gen_qmainwindow_types.QMainWindow, ): QMenu =
  QMenu(h: fQMainWindow_virtualbase_createPopupMenu(self.h))

type QMainWindowcreatePopupMenuProc* = proc(): QMenu
...
proc miqt_exec_callback_QMainWindow_createPopupMenu(self: ptr cQMainWindow, slot: int): pointer {.exportc: "miqt_exec_callback_QMainWindow_createPopupMenu ".} =
  ...
  virtualReturn.h
proc QMainWindowcontextMenuEvent*(self: gen_qmainwindow_types.QMainWindow, event: QContextMenuEvent): void =
  fQMainWindow_virtualbase_contextMenuEvent(self.h, event.h)

type QMainWindowcontextMenuEventProc* = proc(event: QContextMenuEvent): void
...
proc miqt_exec_callback_QMainWindow_contextMenuEvent(self: ptr cQMainWindow, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QMainWindow_contextMenuEvent ".} =
  ...
  nimfunc[](slotval1)
proc QMainWindowevent*(self: gen_qmainwindow_types.QMainWindow, event: QEvent): bool =
  fQMainWindow_virtualbase_event(self.h, event.h)

type QMainWindoweventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QMainWindow_setVisible(self: ptr cQMainWindow, slot: int, visible: bool): void {.exportc: "miqt_exec_callback_QMainWindow_setVisible ".} =
  ...
  nimfunc[](slotval1)
proc QMainWindowsizeHint*(self: gen_qmainwindow_types.QMainWindow, ): QSize =
  QSize(h: fQMainWindow_virtualbase_sizeHint(self.h))

type QMainWindowsizeHintProc* = proc(): QSize
...
proc miqt_exec_callback_QMainWindow_sizeHint(self: ptr cQMainWindow, slot: int): pointer {.exportc: "miqt_exec_callback_QMainWindow_sizeHint ".} =
  ...
  virtualReturn.h
proc QMainWindowminimumSizeHint*(self: gen_qmainwindow_types.QMainWindow, ): QSize =
  QSize(h: fQMainWindow_virtualbase_minimumSizeHint(self.h))

type QMainWindowminimumSizeHintProc* = proc(): QSize
...
proc miqt_exec_callback_QMainWindow_hasHeightForWidth(self: ptr cQMainWindow, slot: int): bool {.exportc: "miqt_exec_callback_QMainWindow_hasHeightForWidth ".} =
  ...
  virtualReturn
proc QMainWindowpaintEngine*(self: gen_qmainwindow_types.QMainWindow, ): QPaintEngine =
  QPaintEngine(h: fQMainWindow_virtualbase_paintEngine(self.h))

type QMainWindowpaintEngineProc* = proc(): QPaintEngine
...
proc miqt_exec_callback_QMainWindow_paintEngine(self: ptr cQMainWindow, slot: int): pointer {.exportc: "miqt_exec_callback_QMainWindow_paintEngine ".} =
  ...
  virtualReturn.h
proc QMainWindowmousePressEvent*(self: gen_qmainwindow_types.QMainWindow, event: QMouseEvent): void =
  fQMainWindow_virtualbase_mousePressEvent(self.h, event.h)

type QMainWindowmousePressEventProc* = proc(event: QMouseEvent): void
...
proc miqt_exec_callback_QMainWindow_mousePressEvent(self: ptr cQMainWindow, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QMainWindow_mousePressEvent ".} =
  ...
  nimfunc[](slotval1)
proc QMainWindowmouseReleaseEvent*(self: gen_qmainwindow_types.QMainWindow, event: QMouseEvent): void =
  fQMainWindow_virtualbase_mouseReleaseEvent(self.h, event.h)

type QMainWindowmouseReleaseEventProc* = proc(event: QMouseEvent): void
...
proc miqt_exec_callback_QMainWindow_mouseReleaseEvent(self: ptr cQMainWindow, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QMainWindow_mouseReleaseEvent ".} =
  ...
  nimfunc[](slotval1)
proc QMainWindowmouseDoubleClickEvent*(self: gen_qmainwindow_types.QMainWindow, event: QMouseEvent): void =
  fQMainWindow_virtualbase_mouseDoubleClickEvent(self.h, event.h)

type QMainWindowmouseDoubleClickEventProc* = proc(event: QMouseEvent): void
...
proc miqt_exec_callback_QMainWindow_mouseDoubleClickEvent(self: ptr cQMainWindow, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QMainWindow_mouseDoubleClickEvent ".} =
  ...
  nimfunc[](slotval1)
proc QMainWindowmouseMoveEvent*(self: gen_qmainwindow_types.QMainWindow, event: QMouseEvent): void =
  fQMainWindow_virtualbase_mouseMoveEvent(self.h, event.h)

type QMainWindowmouseMoveEventProc* = proc(event: QMouseEvent): void
...
proc miqt_exec_callback_QMainWindow_mouseMoveEvent(self: ptr cQMainWindow, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QMainWindow_mouseMoveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QMainWindowwheelEvent*(self: gen_qmainwindow_types.QMainWindow, event: QWheelEvent): void =
  fQMainWindow_virtualbase_wheelEvent(self.h, event.h)

type QMainWindowwheelEventProc* = proc(event: QWheelEvent): void
...
proc miqt_exec_callback_QMainWindow_wheelEvent(self: ptr cQMainWindow, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QMainWindow_wheelEvent ".} =
  ...
  nimfunc[](slotval1)
proc QMainWindowkeyPressEvent*(self: gen_qmainwindow_types.QMainWindow, event: QKeyEvent): void =
  fQMainWindow_virtualbase_keyPressEvent(self.h, event.h)

type QMainWindowkeyPressEventProc* = proc(event: QKeyEvent): void
...
proc miqt_exec_callback_QMainWindow_keyPressEvent(self: ptr cQMainWindow, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QMainWindow_keyPressEvent ".} =
  ...
  nimfunc[](slotval1)
proc QMainWindowkeyReleaseEvent*(self: gen_qmainwindow_types.QMainWindow, event: QKeyEvent): void =
  fQMainWindow_virtualbase_keyReleaseEvent(self.h, event.h)

type QMainWindowkeyReleaseEventProc* = proc(event: QKeyEvent): void
...
proc miqt_exec_callback_QMainWindow_keyReleaseEvent(self: ptr cQMainWindow, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QMainWindow_keyReleaseEvent ".} =
  ...
  nimfunc[](slotval1)
proc QMainWindowfocusInEvent*(self: gen_qmainwindow_types.QMainWindow, event: QFocusEvent): void =
  fQMainWindow_virtualbase_focusInEvent(self.h, event.h)

type QMainWindowfocusInEventProc* = proc(event: QFocusEvent): void
...
proc miqt_exec_callback_QMainWindow_focusInEvent(self: ptr cQMainWindow, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QMainWindow_focusInEvent ".} =
  ...
  nimfunc[](slotval1)
proc QMainWindowfocusOutEvent*(self: gen_qmainwindow_types.QMainWindow, event: QFocusEvent): void =
  fQMainWindow_virtualbase_focusOutEvent(self.h, event.h)

type QMainWindowfocusOutEventProc* = proc(event: QFocusEvent): void
...
proc miqt_exec_callback_QMainWindow_focusOutEvent(self: ptr cQMainWindow, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QMainWindow_focusOutEvent ".} =
  ...
  nimfunc[](slotval1)
proc QMainWindowenterEvent*(self: gen_qmainwindow_types.QMainWindow, event: QEvent): void =
  fQMainWindow_virtualbase_enterEvent(self.h, event.h)

type QMainWindowenterEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QMainWindow_enterEvent(self: ptr cQMainWindow, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QMainWindow_enterEvent ".} =
  ...
  nimfunc[](slotval1)
proc QMainWindowleaveEvent*(self: gen_qmainwindow_types.QMainWindow, event: QEvent): void =
  fQMainWindow_virtualbase_leaveEvent(self.h, event.h)

type QMainWindowleaveEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QMainWindow_leaveEvent(self: ptr cQMainWindow, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QMainWindow_leaveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QMainWindowpaintEvent*(self: gen_qmainwindow_types.QMainWindow, event: QPaintEvent): void =
  fQMainWindow_virtualbase_paintEvent(self.h, event.h)

type QMainWindowpaintEventProc* = proc(event: QPaintEvent): void
...
proc miqt_exec_callback_QMainWindow_paintEvent(self: ptr cQMainWindow, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QMainWindow_paintEvent ".} =
  ...
  nimfunc[](slotval1)
proc QMainWindowmoveEvent*(self: gen_qmainwindow_types.QMainWindow, event: QMoveEvent): void =
  fQMainWindow_virtualbase_moveEvent(self.h, event.h)

type QMainWindowmoveEventProc* = proc(event: QMoveEvent): void
...
proc miqt_exec_callback_QMainWindow_moveEvent(self: ptr cQMainWindow, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QMainWindow_moveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QMainWindowresizeEvent*(self: gen_qmainwindow_types.QMainWindow, event: QResizeEvent): void =
  fQMainWindow_virtualbase_resizeEvent(self.h, event.h)

type QMainWindowresizeEventProc* = proc(event: QResizeEvent): void
...
proc miqt_exec_callback_QMainWindow_resizeEvent(self: ptr cQMainWindow, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QMainWindow_resizeEvent ".} =
  ...
  nimfunc[](slotval1)
proc QMainWindowcloseEvent*(self: gen_qmainwindow_types.QMainWindow, event: QCloseEvent): void =
  fQMainWindow_virtualbase_closeEvent(self.h, event.h)

type QMainWindowcloseEventProc* = proc(event: QCloseEvent): void
...
proc miqt_exec_callback_QMainWindow_closeEvent(self: ptr cQMainWindow, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QMainWindow_closeEvent ".} =
  ...
  nimfunc[](slotval1)
proc QMainWindowtabletEvent*(self: gen_qmainwindow_types.QMainWindow, event: QTabletEvent): void =
  fQMainWindow_virtualbase_tabletEvent(self.h, event.h)

type QMainWindowtabletEventProc* = proc(event: QTabletEvent): void
...
proc miqt_exec_callback_QMainWindow_tabletEvent(self: ptr cQMainWindow, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QMainWindow_tabletEvent ".} =
  ...
  nimfunc[](slotval1)
proc QMainWindowactionEvent*(self: gen_qmainwindow_types.QMainWindow, event: QActionEvent): void =
  fQMainWindow_virtualbase_actionEvent(self.h, event.h)

type QMainWindowactionEventProc* = proc(event: QActionEvent): void
...
proc miqt_exec_callback_QMainWindow_actionEvent(self: ptr cQMainWindow, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QMainWindow_actionEvent ".} =
  ...
  nimfunc[](slotval1)
proc QMainWindowdragEnterEvent*(self: gen_qmainwindow_types.QMainWindow, event: QDragEnterEvent): void =
  fQMainWindow_virtualbase_dragEnterEvent(self.h, event.h)

type QMainWindowdragEnterEventProc* = proc(event: QDragEnterEvent): void
...
proc miqt_exec_callback_QMainWindow_dragEnterEvent(self: ptr cQMainWindow, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QMainWindow_dragEnterEvent ".} =
  ...
  nimfunc[](slotval1)
proc QMainWindowdragMoveEvent*(self: gen_qmainwindow_types.QMainWindow, event: QDragMoveEvent): void =
  fQMainWindow_virtualbase_dragMoveEvent(self.h, event.h)

type QMainWindowdragMoveEventProc* = proc(event: QDragMoveEvent): void
...
proc miqt_exec_callback_QMainWindow_dragMoveEvent(self: ptr cQMainWindow, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QMainWindow_dragMoveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QMainWindowdragLeaveEvent*(self: gen_qmainwindow_types.QMainWindow, event: QDragLeaveEvent): void =
  fQMainWindow_virtualbase_dragLeaveEvent(self.h, event.h)

type QMainWindowdragLeaveEventProc* = proc(event: QDragLeaveEvent): void
...
proc miqt_exec_callback_QMainWindow_dragLeaveEvent(self: ptr cQMainWindow, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QMainWindow_dragLeaveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QMainWindowdropEvent*(self: gen_qmainwindow_types.QMainWindow, event: QDropEvent): void =
  fQMainWindow_virtualbase_dropEvent(self.h, event.h)

type QMainWindowdropEventProc* = proc(event: QDropEvent): void
...
proc miqt_exec_callback_QMainWindow_dropEvent(self: ptr cQMainWindow, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QMainWindow_dropEvent ".} =
  ...
  nimfunc[](slotval1)
proc QMainWindowshowEvent*(self: gen_qmainwindow_types.QMainWindow, event: QShowEvent): void =
  fQMainWindow_virtualbase_showEvent(self.h, event.h)

type QMainWindowshowEventProc* = proc(event: QShowEvent): void
...
proc miqt_exec_callback_QMainWindow_showEvent(self: ptr cQMainWindow, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QMainWindow_showEvent ".} =
  ...
  nimfunc[](slotval1)
proc QMainWindowhideEvent*(self: gen_qmainwindow_types.QMainWindow, event: QHideEvent): void =
  fQMainWindow_virtualbase_hideEvent(self.h, event.h)

type QMainWindowhideEventProc* = proc(event: QHideEvent): void
...
proc miqt_exec_callback_QMainWindow_nativeEvent(self: ptr cQMainWindow, slot: int, eventType: struct_miqt_string, message: pointer, resultVal: ptr clong): bool {.exportc: "miqt_exec_callback_QMainWindow_nativeEvent ".} =
  ...
  virtualReturn
proc QMainWindowchangeEvent*(self: gen_qmainwindow_types.QMainWindow, param1: QEvent): void =
  fQMainWindow_virtualbase_changeEvent(self.h, param1.h)

type QMainWindowchangeEventProc* = proc(param1: QEvent): void
...
proc miqt_exec_callback_QMainWindow_metric(self: ptr cQMainWindow, slot: int, param1: cint): cint {.exportc: "miqt_exec_callback_QMainWindow_metric ".} =
  ...
  virtualReturn
proc QMainWindowinitPainter*(self: gen_qmainwindow_types.QMainWindow, painter: QPainter): void =
  fQMainWindow_virtualbase_initPainter(self.h, painter.h)

type QMainWindowinitPainterProc* = proc(painter: QPainter): void
...
proc miqt_exec_callback_QMainWindow_initPainter(self: ptr cQMainWindow, slot: int, painter: pointer): void {.exportc: "miqt_exec_callback_QMainWindow_initPainter ".} =
  ...
  nimfunc[](slotval1)
proc QMainWindowredirected*(self: gen_qmainwindow_types.QMainWindow, offset: QPoint): QPaintDevice =
  QPaintDevice(h: fQMainWindow_virtualbase_redirected(self.h, offset.h))

type QMainWindowredirectedProc* = proc(offset: QPoint): QPaintDevice
...
proc miqt_exec_callback_QMainWindow_redirected(self: ptr cQMainWindow, slot: int, offset: pointer): pointer {.exportc: "miqt_exec_callback_QMainWindow_redirected ".} =
  ...
  virtualReturn.h
proc QMainWindowsharedPainter*(self: gen_qmainwindow_types.QMainWindow, ): QPainter =
  QPainter(h: fQMainWindow_virtualbase_sharedPainter(self.h))

type QMainWindowsharedPainterProc* = proc(): QPainter
...
proc miqt_exec_callback_QMainWindow_sharedPainter(self: ptr cQMainWindow, slot: int): pointer {.exportc: "miqt_exec_callback_QMainWindow_sharedPainter ".} =
  ...
  virtualReturn.h
proc QMainWindowinputMethodEvent*(self: gen_qmainwindow_types.QMainWindow, param1: QInputMethodEvent): void =
  fQMainWindow_virtualbase_inputMethodEvent(self.h, param1.h)

type QMainWindowinputMethodEventProc* = proc(param1: QInputMethodEvent): void
...
proc miqt_exec_callback_QMainWindow_inputMethodEvent(self: ptr cQMainWindow, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QMainWindow_inputMethodEvent ".} =
  ...
  nimfunc[](slotval1)
proc QMainWindowinputMethodQuery*(self: gen_qmainwindow_types.QMainWindow, param1: cint): QVariant =
  QVariant(h: fQMainWindow_virtualbase_inputMethodQuery(self.h, cint(param1)))

type QMainWindowinputMethodQueryProc* = proc(param1: cint): QVariant
...
proc miqt_exec_callback_QMainWindow_focusNextPrevChild(self: ptr cQMainWindow, slot: int, next: bool): bool {.exportc: "miqt_exec_callback_QMainWindow_focusNextPrevChild ".} =
  ...
  virtualReturn
proc QMainWindoweventFilter*(self: gen_qmainwindow_types.QMainWindow, watched: QObject, event: QEvent): bool =
  fQMainWindow_virtualbase_eventFilter(self.h, watched.h, event.h)

type QMainWindoweventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QMainWindow_eventFilter(self: ptr cQMainWindow, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QMainWindow_eventFilter ".} =
  ...
  virtualReturn
proc QMainWindowtimerEvent*(self: gen_qmainwindow_types.QMainWindow, event: QTimerEvent): void =
  fQMainWindow_virtualbase_timerEvent(self.h, event.h)

type QMainWindowtimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QMainWindow_timerEvent(self: ptr cQMainWindow, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QMainWindow_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QMainWindowchildEvent*(self: gen_qmainwindow_types.QMainWindow, event: QChildEvent): void =
  fQMainWindow_virtualbase_childEvent(self.h, event.h)

type QMainWindowchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QMainWindow_childEvent(self: ptr cQMainWindow, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QMainWindow_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QMainWindowcustomEvent*(self: gen_qmainwindow_types.QMainWindow, event: QEvent): void =
  fQMainWindow_virtualbase_customEvent(self.h, event.h)

type QMainWindowcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QMainWindow_customEvent(self: ptr cQMainWindow, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QMainWindow_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QMainWindowconnectNotify*(self: gen_qmainwindow_types.QMainWindow, signal: QMetaMethod): void =
  fQMainWindow_virtualbase_connectNotify(self.h, signal.h)

type QMainWindowconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QMainWindow_connectNotify(self: ptr cQMainWindow, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QMainWindow_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QMainWindowdisconnectNotify*(self: gen_qmainwindow_types.QMainWindow, signal: QMetaMethod): void =
  fQMainWindow_virtualbase_disconnectNotify(self.h, signal.h)

type QMainWindowdisconnectNotifyProc* = proc(signal: QMetaMethod): void
