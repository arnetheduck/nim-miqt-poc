...
public:
	...
	MiqtVirtualQDirModel(struct QDirModel_VTable* vtbl, const QStringList& nameFilters, QDir::Filters filters, QDir::SortFlags sort): QDirModel(nameFilters, filters, sort), vtbl(vtbl) {};
	MiqtVirtualQDirModel(struct QDirModel_VTable* vtbl): QDirModel(), vtbl(vtbl) {};
	MiqtVirtualQDirModel(struct QDirModel_VTable* vtbl, const QStringList& nameFilters, QDir::Filters filters, QDir::SortFlags sort, QObject* parent): QDirModel(nameFilters, filters, sort, parent), vtbl(vtbl) {};
	MiqtVirtualQDirModel(struct QDirModel_VTable* vtbl, QObject* parent): QDirModel(parent), vtbl(vtbl) {};

	virtual ~MiqtVirtualQDirModel() override { if(vtbl->destructor) vtbl->destructor(vtbl, this); }
...
QDirModel* QDirModel_new(struct QDirModel_VTable* vtbl, struct miqt_array /* of struct miqt_string */  nameFilters, int filters, int sort) {
	...
	return new MiqtVirtualQDirModel(vtbl, nameFilters_QList, static_cast<QDir::Filters>(filters), static_cast<QDir::SortFlags>(sort));
}

QDirModel* QDirModel_new2(struct QDirModel_VTable* vtbl) {
	return new MiqtVirtualQDirModel(vtbl);
}
...
QDirModel* QDirModel_new3(struct QDirModel_VTable* vtbl, struct miqt_array /* of struct miqt_string */  nameFilters, int filters, int sort, QObject* parent) {
	...
	return new MiqtVirtualQDirModel(vtbl, nameFilters_QList, static_cast<QDir::Filters>(filters), static_cast<QDir::SortFlags>(sort), parent);
}

QDirModel* QDirModel_new4(struct QDirModel_VTable* vtbl, QObject* parent) {
	return new MiqtVirtualQDirModel(vtbl, parent);
}
...
QMetaObject* QDirModel_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQDirModel*)(self) )->QDirModel::metaObject();

}

void* QDirModel_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQDirModel*)(self) )->QDirModel::qt_metacast(param1);

}

int QDirModel_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQDirModel*)(self) )->QDirModel::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
void QDirModel_protectedbase_resetInternalData(void* self) {
	MiqtVirtualQDirModel* self_cast = static_cast<MiqtVirtualQDirModel*>( (QDirModel*)(self) );
