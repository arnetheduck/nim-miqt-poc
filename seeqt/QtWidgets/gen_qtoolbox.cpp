...
void QToolBox_connect_currentChanged(QToolBox* self, intptr_t slot, void (*callback)(intptr_t, int), void (*release)(intptr_t)) {
	...
	MiqtVirtualQToolBox::connect(self, static_cast<void (QToolBox::*)(int)>(&QToolBox::currentChanged), self, caller{slot, callback, release});
}
...
QMetaObject* QToolBox_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQToolBox*)(self) )->QToolBox::metaObject();

}

void* QToolBox_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQToolBox*)(self) )->QToolBox::qt_metacast(param1);

}

int QToolBox_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQToolBox*)(self) )->QToolBox::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
void QToolBox_virtualbase_initStyleOption(const void* self, QStyleOptionFrame* option) {
	...
	( (const MiqtVirtualQToolBox*)(self) )->QToolBox::initStyleOption(option);
...
bool QToolBox_virtualbase_nativeEvent(void* self, struct miqt_string eventType, void* message, intptr_t* result) {
	...
	return ( (MiqtVirtualQToolBox*)(self) )->QToolBox::nativeEvent(eventType_QByteArray, message, (qintptr*)(result));
...
void QToolBox_protectedbase_drawFrame(void* self, QPainter* param1) {
	MiqtVirtualQToolBox* self_cast = static_cast<MiqtVirtualQToolBox*>( (QToolBox*)(self) );
