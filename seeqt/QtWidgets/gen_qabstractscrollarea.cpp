...
QMetaObject* QAbstractScrollArea_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQAbstractScrollArea*)(self) )->QAbstractScrollArea::metaObject();

}

void* QAbstractScrollArea_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQAbstractScrollArea*)(self) )->QAbstractScrollArea::qt_metacast(param1);

}

int QAbstractScrollArea_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQAbstractScrollArea*)(self) )->QAbstractScrollArea::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
bool QAbstractScrollArea_virtualbase_nativeEvent(void* self, struct miqt_string eventType, void* message, long* result) {
	...
	return ( (MiqtVirtualQAbstractScrollArea*)(self) )->QAbstractScrollArea::nativeEvent(eventType_QByteArray, message, static_cast<long*>(result));
...
void QAbstractScrollArea_protectedbase_setViewportMargins(void* self, int left, int top, int right, int bottom) {
	MiqtVirtualQAbstractScrollArea* self_cast = static_cast<MiqtVirtualQAbstractScrollArea*>( (QAbstractScrollArea*)(self) );
