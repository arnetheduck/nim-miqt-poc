...
QMetaObject* QCommandLinkButton_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQCommandLinkButton*)(self) )->QCommandLinkButton::metaObject();

}

void* QCommandLinkButton_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQCommandLinkButton*)(self) )->QCommandLinkButton::qt_metacast(param1);

}

int QCommandLinkButton_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQCommandLinkButton*)(self) )->QCommandLinkButton::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
void QCommandLinkButton_virtualbase_mouseMoveEvent(void* self, QMouseEvent* e) {
	...
	( (MiqtVirtualQCommandLinkButton*)(self) )->QCommandLinkButton::mouseMoveEvent(e);
...
bool QCommandLinkButton_virtualbase_nativeEvent(void* self, struct miqt_string eventType, void* message, long* result) {
	...
	return ( (MiqtVirtualQCommandLinkButton*)(self) )->QCommandLinkButton::nativeEvent(eventType_QByteArray, message, static_cast<long*>(result));
...
void QCommandLinkButton_protectedbase_initStyleOption(const void* self, QStyleOptionButton* option) {
	MiqtVirtualQCommandLinkButton* self_cast = static_cast<MiqtVirtualQCommandLinkButton*>( (QCommandLinkButton*)(self) );
