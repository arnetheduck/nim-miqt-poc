...
proc metaObject*(self: gen_qapplication_types.QApplication, ): QMetaObject =
  QMetaObject(h: fcQApplication_metaObject(self.h))
...
proc style*(_: type gen_qapplication_types.QApplication, ): QStyle =
  QStyle(h: fcQApplication_style())

proc setStyle*(_: type gen_qapplication_types.QApplication, style: QStyle): void =
  fcQApplication_setStyle(style.h)

proc setStyle*(_: type gen_qapplication_types.QApplication, style: string): QStyle =
  QStyle(h: fcQApplication_setStyleWithStyle(struct_miqt_string(data: style, len: csize_t(len(style)))))
...
proc palette*(_: type gen_qapplication_types.QApplication, param1: QWidget): QPalette =
  QPalette(h: fcQApplication_palette(param1.h))

proc palette*(_: type gen_qapplication_types.QApplication, className: cstring): QPalette =
  QPalette(h: fcQApplication_paletteWithClassName(className))

proc setPalette*(_: type gen_qapplication_types.QApplication, param1: QPalette): void =
  fcQApplication_setPalette(param1.h)

proc font*(_: type gen_qapplication_types.QApplication, ): QFont =
  QFont(h: fcQApplication_font())

proc font*(_: type gen_qapplication_types.QApplication, param1: QWidget): QFont =
  QFont(h: fcQApplication_fontWithQWidget(param1.h))

proc font*(_: type gen_qapplication_types.QApplication, className: cstring): QFont =
  QFont(h: fcQApplication_fontWithClassName(className))

proc setFont*(_: type gen_qapplication_types.QApplication, param1: QFont): void =
  fcQApplication_setFont(param1.h)

proc fontMetrics*(_: type gen_qapplication_types.QApplication, ): QFontMetrics =
  QFontMetrics(h: fcQApplication_fontMetrics())

proc setWindowIcon*(_: type gen_qapplication_types.QApplication, icon: QIcon): void =
  fcQApplication_setWindowIcon(icon.h)

proc windowIcon*(_: type gen_qapplication_types.QApplication, ): QIcon =
  QIcon(h: fcQApplication_windowIcon())

proc allWidgets*(_: type gen_qapplication_types.QApplication, ): seq[QWidget] =
...
proc topLevelWidgets*(_: type gen_qapplication_types.QApplication, ): seq[QWidget] =
...
proc desktop*(_: type gen_qapplication_types.QApplication, ): QDesktopWidget =
  QDesktopWidget(h: fcQApplication_desktop())

proc activePopupWidget*(_: type gen_qapplication_types.QApplication, ): QWidget =
  QWidget(h: fcQApplication_activePopupWidget())

proc activeModalWidget*(_: type gen_qapplication_types.QApplication, ): QWidget =
  QWidget(h: fcQApplication_activeModalWidget())

proc focusWidget*(_: type gen_qapplication_types.QApplication, ): QWidget =
  QWidget(h: fcQApplication_focusWidget())

proc activeWindow*(_: type gen_qapplication_types.QApplication, ): QWidget =
  QWidget(h: fcQApplication_activeWindow())

proc setActiveWindow*(_: type gen_qapplication_types.QApplication, act: QWidget): void =
  fcQApplication_setActiveWindow(act.h)

proc widgetAt*(_: type gen_qapplication_types.QApplication, p: QPoint): QWidget =
  QWidget(h: fcQApplication_widgetAt(p.h))

proc widgetAt*(_: type gen_qapplication_types.QApplication, x: cint, y: cint): QWidget =
  QWidget(h: fcQApplication_widgetAt2(x, y))

proc topLevelAt*(_: type gen_qapplication_types.QApplication, p: QPoint): QWidget =
  QWidget(h: fcQApplication_topLevelAt(p.h))

proc topLevelAt*(_: type gen_qapplication_types.QApplication, x: cint, y: cint): QWidget =
  QWidget(h: fcQApplication_topLevelAt2(x, y))

proc beep*(_: type gen_qapplication_types.QApplication, ): void =
  fcQApplication_beep()

proc alert*(_: type gen_qapplication_types.QApplication, widget: QWidget): void =
...
proc setGlobalStrut*(_: type gen_qapplication_types.QApplication, globalStrut: QSize): void =
  fcQApplication_setGlobalStrut(globalStrut.h)

proc globalStrut*(_: type gen_qapplication_types.QApplication, ): QSize =
  QSize(h: fcQApplication_globalStrut())
...
proc notify*(self: gen_qapplication_types.QApplication, param1: QObject, param2: QEvent): bool =
  fcQApplication_notify(self.h, param1.h, param2.h)

proc focusChanged*(self: gen_qapplication_types.QApplication, old: QWidget, now: QWidget): void =
  fcQApplication_focusChanged(self.h, old.h, now.h)

type QApplicationfocusChangedSlot* = proc(old: QWidget, now: QWidget)
proc miqt_exec_callback_QApplication_focusChanged(slot: int, old: pointer, now: pointer) {.exportc.} =
  ...
  let slotval1 = QWidget(h: old)

  let slotval2 = QWidget(h: now)
...
proc setPalette*(_: type gen_qapplication_types.QApplication, param1: QPalette, className: cstring): void =
  fcQApplication_setPalette2(param1.h, className)

proc setFont*(_: type gen_qapplication_types.QApplication, param1: QFont, className: cstring): void =
  fcQApplication_setFont2(param1.h, className)

proc alert*(_: type gen_qapplication_types.QApplication, widget: QWidget, duration: cint): void =
...
proc miqt_exec_callback_QApplication_metacall(self: ptr cQApplication, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QApplication_metacall ".} =
  ...
  virtualReturn
proc QApplicationnotify*(self: gen_qapplication_types.QApplication, param1: QObject, param2: QEvent): bool =
  fQApplication_virtualbase_notify(self.h, param1.h, param2.h)

type QApplicationnotifyProc* = proc(param1: QObject, param2: QEvent): bool
...
proc miqt_exec_callback_QApplication_notify(self: ptr cQApplication, slot: int, param1: pointer, param2: pointer): bool {.exportc: "miqt_exec_callback_QApplication_notify ".} =
  ...
  virtualReturn
proc QApplicationevent*(self: gen_qapplication_types.QApplication, param1: QEvent): bool =
  fQApplication_virtualbase_event(self.h, param1.h)

type QApplicationeventProc* = proc(param1: QEvent): bool
...
proc miqt_exec_callback_QApplication_event(self: ptr cQApplication, slot: int, param1: pointer): bool {.exportc: "miqt_exec_callback_QApplication_event ".} =
  ...
  virtualReturn
proc QApplicationeventFilter*(self: gen_qapplication_types.QApplication, watched: QObject, event: QEvent): bool =
  fQApplication_virtualbase_eventFilter(self.h, watched.h, event.h)

type QApplicationeventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QApplication_eventFilter(self: ptr cQApplication, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QApplication_eventFilter ".} =
  ...
  virtualReturn
proc QApplicationtimerEvent*(self: gen_qapplication_types.QApplication, event: QTimerEvent): void =
  fQApplication_virtualbase_timerEvent(self.h, event.h)

type QApplicationtimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QApplication_timerEvent(self: ptr cQApplication, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QApplication_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QApplicationchildEvent*(self: gen_qapplication_types.QApplication, event: QChildEvent): void =
  fQApplication_virtualbase_childEvent(self.h, event.h)

type QApplicationchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QApplication_childEvent(self: ptr cQApplication, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QApplication_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QApplicationcustomEvent*(self: gen_qapplication_types.QApplication, event: QEvent): void =
  fQApplication_virtualbase_customEvent(self.h, event.h)

type QApplicationcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QApplication_customEvent(self: ptr cQApplication, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QApplication_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QApplicationconnectNotify*(self: gen_qapplication_types.QApplication, signal: QMetaMethod): void =
  fQApplication_virtualbase_connectNotify(self.h, signal.h)

type QApplicationconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QApplication_connectNotify(self: ptr cQApplication, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QApplication_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QApplicationdisconnectNotify*(self: gen_qapplication_types.QApplication, signal: QMetaMethod): void =
  fQApplication_virtualbase_disconnectNotify(self.h, signal.h)

type QApplicationdisconnectNotifyProc* = proc(signal: QMetaMethod): void
