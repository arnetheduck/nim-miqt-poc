...
QWidget* QLayoutItem_virtualbase_widget(void* self) {
	...
	return ( (MiqtVirtualQLayoutItem*)(self) )->QLayoutItem::widget();
...
QWidget* QSpacerItem_virtualbase_widget(void* self) {
	...
	return ( (MiqtVirtualQSpacerItem*)(self) )->QSpacerItem::widget();
...
QWidget* QWidgetItem_virtualbase_widget(void* self) {
	...
	return ( (MiqtVirtualQWidgetItem*)(self) )->QWidgetItem::widget();
...
QWidget* QWidgetItemV2_virtualbase_widget(void* self) {
	...
	return ( (MiqtVirtualQWidgetItemV2*)(self) )->QWidgetItemV2::widget();
