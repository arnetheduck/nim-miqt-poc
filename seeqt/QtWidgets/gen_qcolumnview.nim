...
func init*(T: type gen_qcolumnview_types.QColumnView, h: ptr cQColumnView): gen_qcolumnview_types.QColumnView =
  T(h: h)
proc create*(T: type gen_qcolumnview_types.QColumnView, parent: QWidget): gen_qcolumnview_types.QColumnView =
...
proc metaObject*(self: gen_qcolumnview_types.QColumnView, ): QMetaObject =
  QMetaObject(h: fcQColumnView_metaObject(self.h))
...
proc updatePreviewWidget*(self: gen_qcolumnview_types.QColumnView, index: QModelIndex): void =
  fcQColumnView_updatePreviewWidget(self.h, index.h)

type QColumnViewupdatePreviewWidgetSlot* = proc(index: QModelIndex)
...
proc indexAt*(self: gen_qcolumnview_types.QColumnView, point: QPoint): QModelIndex =
  QModelIndex(h: fcQColumnView_indexAt(self.h, point.h))

proc scrollTo*(self: gen_qcolumnview_types.QColumnView, index: QModelIndex, hint: cint): void =
  fcQColumnView_scrollTo(self.h, index.h, cint(hint))

proc sizeHint*(self: gen_qcolumnview_types.QColumnView, ): QSize =
  QSize(h: fcQColumnView_sizeHint(self.h))

proc visualRect*(self: gen_qcolumnview_types.QColumnView, index: QModelIndex): QRect =
  QRect(h: fcQColumnView_visualRect(self.h, index.h))

proc setModel*(self: gen_qcolumnview_types.QColumnView, model: QAbstractItemModel): void =
  fcQColumnView_setModel(self.h, model.h)

proc setSelectionModel*(self: gen_qcolumnview_types.QColumnView, selectionModel: QItemSelectionModel): void =
  fcQColumnView_setSelectionModel(self.h, selectionModel.h)

proc setRootIndex*(self: gen_qcolumnview_types.QColumnView, index: QModelIndex): void =
...
proc previewWidget*(self: gen_qcolumnview_types.QColumnView, ): QWidget =
  QWidget(h: fcQColumnView_previewWidget(self.h))

proc setPreviewWidget*(self: gen_qcolumnview_types.QColumnView, widget: QWidget): void =
...
proc miqt_exec_callback_QColumnView_metacall(self: ptr cQColumnView, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QColumnView_metacall ".} =
  ...
  virtualReturn
proc QColumnViewindexAt*(self: gen_qcolumnview_types.QColumnView, point: QPoint): QModelIndex =
  QModelIndex(h: fQColumnView_virtualbase_indexAt(self.h, point.h))

type QColumnViewindexAtProc* = proc(point: QPoint): QModelIndex
...
proc miqt_exec_callback_QColumnView_indexAt(self: ptr cQColumnView, slot: int, point: pointer): pointer {.exportc: "miqt_exec_callback_QColumnView_indexAt ".} =
  ...
  virtualReturn.h
proc QColumnViewscrollTo*(self: gen_qcolumnview_types.QColumnView, index: QModelIndex, hint: cint): void =
  fQColumnView_virtualbase_scrollTo(self.h, index.h, cint(hint))

type QColumnViewscrollToProc* = proc(index: QModelIndex, hint: cint): void
...
proc QColumnViewsizeHint*(self: gen_qcolumnview_types.QColumnView, ): QSize =
  QSize(h: fQColumnView_virtualbase_sizeHint(self.h))

type QColumnViewsizeHintProc* = proc(): QSize
...
proc miqt_exec_callback_QColumnView_sizeHint(self: ptr cQColumnView, slot: int): pointer {.exportc: "miqt_exec_callback_QColumnView_sizeHint ".} =
  ...
  virtualReturn.h
proc QColumnViewvisualRect*(self: gen_qcolumnview_types.QColumnView, index: QModelIndex): QRect =
  QRect(h: fQColumnView_virtualbase_visualRect(self.h, index.h))

type QColumnViewvisualRectProc* = proc(index: QModelIndex): QRect
...
proc miqt_exec_callback_QColumnView_visualRect(self: ptr cQColumnView, slot: int, index: pointer): pointer {.exportc: "miqt_exec_callback_QColumnView_visualRect ".} =
  ...
  virtualReturn.h
proc QColumnViewsetModel*(self: gen_qcolumnview_types.QColumnView, model: QAbstractItemModel): void =
  fQColumnView_virtualbase_setModel(self.h, model.h)

type QColumnViewsetModelProc* = proc(model: QAbstractItemModel): void
...
proc miqt_exec_callback_QColumnView_setModel(self: ptr cQColumnView, slot: int, model: pointer): void {.exportc: "miqt_exec_callback_QColumnView_setModel ".} =
  ...
  nimfunc[](slotval1)
proc QColumnViewsetSelectionModel*(self: gen_qcolumnview_types.QColumnView, selectionModel: QItemSelectionModel): void =
  fQColumnView_virtualbase_setSelectionModel(self.h, selectionModel.h)

type QColumnViewsetSelectionModelProc* = proc(selectionModel: QItemSelectionModel): void
...
proc miqt_exec_callback_QColumnView_setSelectionModel(self: ptr cQColumnView, slot: int, selectionModel: pointer): void {.exportc: "miqt_exec_callback_QColumnView_setSelectionModel ".} =
  ...
  nimfunc[](slotval1)
proc QColumnViewsetRootIndex*(self: gen_qcolumnview_types.QColumnView, index: QModelIndex): void =
  fQColumnView_virtualbase_setRootIndex(self.h, index.h)

type QColumnViewsetRootIndexProc* = proc(index: QModelIndex): void
...
proc miqt_exec_callback_QColumnView_selectAll(self: ptr cQColumnView, slot: int): void {.exportc: "miqt_exec_callback_QColumnView_selectAll ".} =
  ...
  nimfunc[]()
proc QColumnViewisIndexHidden*(self: gen_qcolumnview_types.QColumnView, index: QModelIndex): bool =
  fQColumnView_virtualbase_isIndexHidden(self.h, index.h)

type QColumnViewisIndexHiddenProc* = proc(index: QModelIndex): bool
...
proc miqt_exec_callback_QColumnView_isIndexHidden(self: ptr cQColumnView, slot: int, index: pointer): bool {.exportc: "miqt_exec_callback_QColumnView_isIndexHidden ".} =
  ...
  virtualReturn
proc QColumnViewmoveCursor*(self: gen_qcolumnview_types.QColumnView, cursorAction: cint, modifiers: cint): QModelIndex =
  QModelIndex(h: fQColumnView_virtualbase_moveCursor(self.h, cint(cursorAction), cint(modifiers)))

type QColumnViewmoveCursorProc* = proc(cursorAction: cint, modifiers: cint): QModelIndex
...
proc miqt_exec_callback_QColumnView_moveCursor(self: ptr cQColumnView, slot: int, cursorAction: cint, modifiers: cint): pointer {.exportc: "miqt_exec_callback_QColumnView_moveCursor ".} =
  ...
  virtualReturn.h
proc QColumnViewresizeEvent*(self: gen_qcolumnview_types.QColumnView, event: QResizeEvent): void =
  fQColumnView_virtualbase_resizeEvent(self.h, event.h)

type QColumnViewresizeEventProc* = proc(event: QResizeEvent): void
...
proc miqt_exec_callback_QColumnView_resizeEvent(self: ptr cQColumnView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QColumnView_resizeEvent ".} =
  ...
  nimfunc[](slotval1)
proc QColumnViewsetSelection*(self: gen_qcolumnview_types.QColumnView, rect: QRect, command: cint): void =
  fQColumnView_virtualbase_setSelection(self.h, rect.h, cint(command))

type QColumnViewsetSelectionProc* = proc(rect: QRect, command: cint): void
...
proc miqt_exec_callback_QColumnView_setSelection(self: ptr cQColumnView, slot: int, rect: pointer, command: cint): void {.exportc: "miqt_exec_callback_QColumnView_setSelection ".} =
  ...
  nimfunc[](slotval1, slotval2)
proc QColumnViewvisualRegionForSelection*(self: gen_qcolumnview_types.QColumnView, selection: QItemSelection): QRegion =
  QRegion(h: fQColumnView_virtualbase_visualRegionForSelection(self.h, selection.h))

type QColumnViewvisualRegionForSelectionProc* = proc(selection: QItemSelection): QRegion
...
proc miqt_exec_callback_QColumnView_verticalOffset(self: ptr cQColumnView, slot: int): cint {.exportc: "miqt_exec_callback_QColumnView_verticalOffset ".} =
  ...
  virtualReturn
proc QColumnViewrowsInserted*(self: gen_qcolumnview_types.QColumnView, parent: QModelIndex, start: cint, endVal: cint): void =
  fQColumnView_virtualbase_rowsInserted(self.h, parent.h, start, endVal)

type QColumnViewrowsInsertedProc* = proc(parent: QModelIndex, start: cint, endVal: cint): void
...
proc QColumnViewcurrentChanged*(self: gen_qcolumnview_types.QColumnView, current: QModelIndex, previous: QModelIndex): void =
  fQColumnView_virtualbase_currentChanged(self.h, current.h, previous.h)

type QColumnViewcurrentChangedProc* = proc(current: QModelIndex, previous: QModelIndex): void
...
proc miqt_exec_callback_QColumnView_scrollContentsBy(self: ptr cQColumnView, slot: int, dx: cint, dy: cint): void {.exportc: "miqt_exec_callback_QColumnView_scrollContentsBy ".} =
  ...
  nimfunc[](slotval1, slotval2)
proc QColumnViewcreateColumn*(self: gen_qcolumnview_types.QColumnView, rootIndex: QModelIndex): QAbstractItemView =
  QAbstractItemView(h: fQColumnView_virtualbase_createColumn(self.h, rootIndex.h))

type QColumnViewcreateColumnProc* = proc(rootIndex: QModelIndex): QAbstractItemView
...
proc miqt_exec_callback_QColumnView_createColumn(self: ptr cQColumnView, slot: int, rootIndex: pointer): pointer {.exportc: "miqt_exec_callback_QColumnView_createColumn ".} =
  ...
  let slotval1 = QModelIndex(h: rootIndex)
...
proc miqt_exec_callback_QColumnView_sizeHintForColumn(self: ptr cQColumnView, slot: int, column: cint): cint {.exportc: "miqt_exec_callback_QColumnView_sizeHintForColumn ".} =
  ...
  virtualReturn
proc QColumnViewitemDelegateForIndex*(self: gen_qcolumnview_types.QColumnView, index: QModelIndex): QAbstractItemDelegate =
  QAbstractItemDelegate(h: fQColumnView_virtualbase_itemDelegateForIndex(self.h, index.h))

type QColumnViewitemDelegateForIndexProc* = proc(index: QModelIndex): QAbstractItemDelegate
...
proc miqt_exec_callback_QColumnView_itemDelegateForIndex(self: ptr cQColumnView, slot: int, index: pointer): pointer {.exportc: "miqt_exec_callback_QColumnView_itemDelegateForIndex ".} =
  ...
  virtualReturn.h
proc QColumnViewinputMethodQuery*(self: gen_qcolumnview_types.QColumnView, query: cint): QVariant =
  QVariant(h: fQColumnView_virtualbase_inputMethodQuery(self.h, cint(query)))

type QColumnViewinputMethodQueryProc* = proc(query: cint): QVariant
...
proc miqt_exec_callback_QColumnView_doItemsLayout(self: ptr cQColumnView, slot: int): void {.exportc: "miqt_exec_callback_QColumnView_doItemsLayout ".} =
  ...
  nimfunc[]()
proc QColumnViewdataChanged*(self: gen_qcolumnview_types.QColumnView, topLeft: QModelIndex, bottomRight: QModelIndex, roles: seq[cint]): void =
...
type QColumnViewdataChangedProc* = proc(topLeft: QModelIndex, bottomRight: QModelIndex, roles: seq[cint]): void
...
proc miqt_exec_callback_QColumnView_dataChanged(self: ptr cQColumnView, slot: int, topLeft: pointer, bottomRight: pointer, roles: struct_miqt_array): void {.exportc: "miqt_exec_callback_QColumnView_dataChanged ".} =
  ...
  nimfunc[](slotval1, slotval2, slotval3)
proc QColumnViewrowsAboutToBeRemoved*(self: gen_qcolumnview_types.QColumnView, parent: QModelIndex, start: cint, endVal: cint): void =
  fQColumnView_virtualbase_rowsAboutToBeRemoved(self.h, parent.h, start, endVal)

type QColumnViewrowsAboutToBeRemovedProc* = proc(parent: QModelIndex, start: cint, endVal: cint): void
...
proc miqt_exec_callback_QColumnView_rowsAboutToBeRemoved(self: ptr cQColumnView, slot: int, parent: pointer, start: cint, endVal: cint): void {.exportc: "miqt_exec_callback_QColumnView_rowsAboutToBeRemoved ".} =
  ...
  nimfunc[](slotval1, slotval2, slotval3)
proc QColumnViewselectionChanged*(self: gen_qcolumnview_types.QColumnView, selected: QItemSelection, deselected: QItemSelection): void =
  fQColumnView_virtualbase_selectionChanged(self.h, selected.h, deselected.h)

type QColumnViewselectionChangedProc* = proc(selected: QItemSelection, deselected: QItemSelection): void
...
proc miqt_exec_callback_QColumnView_horizontalScrollbarValueChanged(self: ptr cQColumnView, slot: int, value: cint): void {.exportc: "miqt_exec_callback_QColumnView_horizontalScrollbarValueChanged ".} =
  ...
  nimfunc[](slotval1)
proc QColumnViewcloseEditor*(self: gen_qcolumnview_types.QColumnView, editor: QWidget, hint: cint): void =
  fQColumnView_virtualbase_closeEditor(self.h, editor.h, cint(hint))

type QColumnViewcloseEditorProc* = proc(editor: QWidget, hint: cint): void
...
proc miqt_exec_callback_QColumnView_closeEditor(self: ptr cQColumnView, slot: int, editor: pointer, hint: cint): void {.exportc: "miqt_exec_callback_QColumnView_closeEditor ".} =
  ...
  nimfunc[](slotval1, slotval2)
proc QColumnViewcommitData*(self: gen_qcolumnview_types.QColumnView, editor: QWidget): void =
  fQColumnView_virtualbase_commitData(self.h, editor.h)

type QColumnViewcommitDataProc* = proc(editor: QWidget): void
...
proc miqt_exec_callback_QColumnView_commitData(self: ptr cQColumnView, slot: int, editor: pointer): void {.exportc: "miqt_exec_callback_QColumnView_commitData ".} =
  ...
  nimfunc[](slotval1)
proc QColumnVieweditorDestroyed*(self: gen_qcolumnview_types.QColumnView, editor: QObject): void =
  fQColumnView_virtualbase_editorDestroyed(self.h, editor.h)

type QColumnVieweditorDestroyedProc* = proc(editor: QObject): void
...
proc miqt_exec_callback_QColumnView_editorDestroyed(self: ptr cQColumnView, slot: int, editor: pointer): void {.exportc: "miqt_exec_callback_QColumnView_editorDestroyed ".} =
  ...
  nimfunc[](slotval1)
proc QColumnViewselectedIndexes*(self: gen_qcolumnview_types.QColumnView, ): seq[QModelIndex] =
...
type QColumnViewselectedIndexesProc* = proc(): seq[QModelIndex]
...
proc QColumnViewedit*(self: gen_qcolumnview_types.QColumnView, index: QModelIndex, trigger: cint, event: QEvent): bool =
  fQColumnView_virtualbase_edit2(self.h, index.h, cint(trigger), event.h)

type QColumnViewedit2Proc* = proc(index: QModelIndex, trigger: cint, event: QEvent): bool
...
proc miqt_exec_callback_QColumnView_edit2(self: ptr cQColumnView, slot: int, index: pointer, trigger: cint, event: pointer): bool {.exportc: "miqt_exec_callback_QColumnView_edit2 ".} =
  ...
  virtualReturn
proc QColumnViewselectionCommand*(self: gen_qcolumnview_types.QColumnView, index: QModelIndex, event: QEvent): cint =
  cint(fQColumnView_virtualbase_selectionCommand(self.h, index.h, event.h))

type QColumnViewselectionCommandProc* = proc(index: QModelIndex, event: QEvent): cint
...
proc miqt_exec_callback_QColumnView_startDrag(self: ptr cQColumnView, slot: int, supportedActions: cint): void {.exportc: "miqt_exec_callback_QColumnView_startDrag ".} =
  ...
  nimfunc[](slotval1)
proc QColumnViewinitViewItemOption*(self: gen_qcolumnview_types.QColumnView, option: QStyleOptionViewItem): void =
  fQColumnView_virtualbase_initViewItemOption(self.h, option.h)

type QColumnViewinitViewItemOptionProc* = proc(option: QStyleOptionViewItem): void
...
proc miqt_exec_callback_QColumnView_focusNextPrevChild(self: ptr cQColumnView, slot: int, next: bool): bool {.exportc: "miqt_exec_callback_QColumnView_focusNextPrevChild ".} =
  ...
  virtualReturn
proc QColumnViewevent*(self: gen_qcolumnview_types.QColumnView, event: QEvent): bool =
  fQColumnView_virtualbase_event(self.h, event.h)

type QColumnVieweventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QColumnView_event(self: ptr cQColumnView, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QColumnView_event ".} =
  ...
  virtualReturn
proc QColumnViewviewportEvent*(self: gen_qcolumnview_types.QColumnView, event: QEvent): bool =
  fQColumnView_virtualbase_viewportEvent(self.h, event.h)

type QColumnViewviewportEventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QColumnView_viewportEvent(self: ptr cQColumnView, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QColumnView_viewportEvent ".} =
  ...
  virtualReturn
proc QColumnViewmousePressEvent*(self: gen_qcolumnview_types.QColumnView, event: QMouseEvent): void =
  fQColumnView_virtualbase_mousePressEvent(self.h, event.h)

type QColumnViewmousePressEventProc* = proc(event: QMouseEvent): void
...
proc miqt_exec_callback_QColumnView_mousePressEvent(self: ptr cQColumnView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QColumnView_mousePressEvent ".} =
  ...
  nimfunc[](slotval1)
proc QColumnViewmouseMoveEvent*(self: gen_qcolumnview_types.QColumnView, event: QMouseEvent): void =
  fQColumnView_virtualbase_mouseMoveEvent(self.h, event.h)

type QColumnViewmouseMoveEventProc* = proc(event: QMouseEvent): void
...
proc miqt_exec_callback_QColumnView_mouseMoveEvent(self: ptr cQColumnView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QColumnView_mouseMoveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QColumnViewmouseReleaseEvent*(self: gen_qcolumnview_types.QColumnView, event: QMouseEvent): void =
  fQColumnView_virtualbase_mouseReleaseEvent(self.h, event.h)

type QColumnViewmouseReleaseEventProc* = proc(event: QMouseEvent): void
...
proc miqt_exec_callback_QColumnView_mouseReleaseEvent(self: ptr cQColumnView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QColumnView_mouseReleaseEvent ".} =
  ...
  nimfunc[](slotval1)
proc QColumnViewmouseDoubleClickEvent*(self: gen_qcolumnview_types.QColumnView, event: QMouseEvent): void =
  fQColumnView_virtualbase_mouseDoubleClickEvent(self.h, event.h)

type QColumnViewmouseDoubleClickEventProc* = proc(event: QMouseEvent): void
...
proc miqt_exec_callback_QColumnView_mouseDoubleClickEvent(self: ptr cQColumnView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QColumnView_mouseDoubleClickEvent ".} =
  ...
  nimfunc[](slotval1)
proc QColumnViewdragEnterEvent*(self: gen_qcolumnview_types.QColumnView, event: QDragEnterEvent): void =
  fQColumnView_virtualbase_dragEnterEvent(self.h, event.h)

type QColumnViewdragEnterEventProc* = proc(event: QDragEnterEvent): void
...
proc miqt_exec_callback_QColumnView_dragEnterEvent(self: ptr cQColumnView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QColumnView_dragEnterEvent ".} =
  ...
  nimfunc[](slotval1)
proc QColumnViewdragMoveEvent*(self: gen_qcolumnview_types.QColumnView, event: QDragMoveEvent): void =
  fQColumnView_virtualbase_dragMoveEvent(self.h, event.h)

type QColumnViewdragMoveEventProc* = proc(event: QDragMoveEvent): void
...
proc miqt_exec_callback_QColumnView_dragMoveEvent(self: ptr cQColumnView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QColumnView_dragMoveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QColumnViewdragLeaveEvent*(self: gen_qcolumnview_types.QColumnView, event: QDragLeaveEvent): void =
  fQColumnView_virtualbase_dragLeaveEvent(self.h, event.h)

type QColumnViewdragLeaveEventProc* = proc(event: QDragLeaveEvent): void
...
proc miqt_exec_callback_QColumnView_dragLeaveEvent(self: ptr cQColumnView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QColumnView_dragLeaveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QColumnViewdropEvent*(self: gen_qcolumnview_types.QColumnView, event: QDropEvent): void =
  fQColumnView_virtualbase_dropEvent(self.h, event.h)

type QColumnViewdropEventProc* = proc(event: QDropEvent): void
...
proc miqt_exec_callback_QColumnView_dropEvent(self: ptr cQColumnView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QColumnView_dropEvent ".} =
  ...
  nimfunc[](slotval1)
proc QColumnViewfocusInEvent*(self: gen_qcolumnview_types.QColumnView, event: QFocusEvent): void =
  fQColumnView_virtualbase_focusInEvent(self.h, event.h)

type QColumnViewfocusInEventProc* = proc(event: QFocusEvent): void
...
proc miqt_exec_callback_QColumnView_focusInEvent(self: ptr cQColumnView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QColumnView_focusInEvent ".} =
  ...
  nimfunc[](slotval1)
proc QColumnViewfocusOutEvent*(self: gen_qcolumnview_types.QColumnView, event: QFocusEvent): void =
  fQColumnView_virtualbase_focusOutEvent(self.h, event.h)

type QColumnViewfocusOutEventProc* = proc(event: QFocusEvent): void
...
proc miqt_exec_callback_QColumnView_focusOutEvent(self: ptr cQColumnView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QColumnView_focusOutEvent ".} =
  ...
  nimfunc[](slotval1)
proc QColumnViewkeyPressEvent*(self: gen_qcolumnview_types.QColumnView, event: QKeyEvent): void =
  fQColumnView_virtualbase_keyPressEvent(self.h, event.h)

type QColumnViewkeyPressEventProc* = proc(event: QKeyEvent): void
...
proc miqt_exec_callback_QColumnView_keyPressEvent(self: ptr cQColumnView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QColumnView_keyPressEvent ".} =
  ...
  nimfunc[](slotval1)
proc QColumnViewtimerEvent*(self: gen_qcolumnview_types.QColumnView, event: QTimerEvent): void =
  fQColumnView_virtualbase_timerEvent(self.h, event.h)

type QColumnViewtimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QColumnView_timerEvent(self: ptr cQColumnView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QColumnView_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QColumnViewinputMethodEvent*(self: gen_qcolumnview_types.QColumnView, event: QInputMethodEvent): void =
  fQColumnView_virtualbase_inputMethodEvent(self.h, event.h)

type QColumnViewinputMethodEventProc* = proc(event: QInputMethodEvent): void
...
proc miqt_exec_callback_QColumnView_inputMethodEvent(self: ptr cQColumnView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QColumnView_inputMethodEvent ".} =
  ...
  nimfunc[](slotval1)
proc QColumnVieweventFilter*(self: gen_qcolumnview_types.QColumnView, objectVal: QObject, event: QEvent): bool =
  fQColumnView_virtualbase_eventFilter(self.h, objectVal.h, event.h)

type QColumnVieweventFilterProc* = proc(objectVal: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QColumnView_eventFilter(self: ptr cQColumnView, slot: int, objectVal: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QColumnView_eventFilter ".} =
  ...
  virtualReturn
proc QColumnViewviewportSizeHint*(self: gen_qcolumnview_types.QColumnView, ): QSize =
  QSize(h: fQColumnView_virtualbase_viewportSizeHint(self.h))

type QColumnViewviewportSizeHintProc* = proc(): QSize
...
proc miqt_exec_callback_QColumnView_viewportSizeHint(self: ptr cQColumnView, slot: int): pointer {.exportc: "miqt_exec_callback_QColumnView_viewportSizeHint ".} =
  ...
  virtualReturn.h
proc QColumnViewminimumSizeHint*(self: gen_qcolumnview_types.QColumnView, ): QSize =
  QSize(h: fQColumnView_virtualbase_minimumSizeHint(self.h))

type QColumnViewminimumSizeHintProc* = proc(): QSize
...
proc miqt_exec_callback_QColumnView_minimumSizeHint(self: ptr cQColumnView, slot: int): pointer {.exportc: "miqt_exec_callback_QColumnView_minimumSizeHint ".} =
  ...
  virtualReturn.h
proc QColumnViewsetupViewport*(self: gen_qcolumnview_types.QColumnView, viewport: QWidget): void =
  fQColumnView_virtualbase_setupViewport(self.h, viewport.h)

type QColumnViewsetupViewportProc* = proc(viewport: QWidget): void
...
proc miqt_exec_callback_QColumnView_setupViewport(self: ptr cQColumnView, slot: int, viewport: pointer): void {.exportc: "miqt_exec_callback_QColumnView_setupViewport ".} =
  ...
  nimfunc[](slotval1)
proc QColumnViewpaintEvent*(self: gen_qcolumnview_types.QColumnView, param1: QPaintEvent): void =
  fQColumnView_virtualbase_paintEvent(self.h, param1.h)

type QColumnViewpaintEventProc* = proc(param1: QPaintEvent): void
...
proc miqt_exec_callback_QColumnView_paintEvent(self: ptr cQColumnView, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QColumnView_paintEvent ".} =
  ...
  nimfunc[](slotval1)
proc QColumnViewwheelEvent*(self: gen_qcolumnview_types.QColumnView, param1: QWheelEvent): void =
  fQColumnView_virtualbase_wheelEvent(self.h, param1.h)

type QColumnViewwheelEventProc* = proc(param1: QWheelEvent): void
...
proc miqt_exec_callback_QColumnView_wheelEvent(self: ptr cQColumnView, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QColumnView_wheelEvent ".} =
  ...
  nimfunc[](slotval1)
proc QColumnViewcontextMenuEvent*(self: gen_qcolumnview_types.QColumnView, param1: QContextMenuEvent): void =
  fQColumnView_virtualbase_contextMenuEvent(self.h, param1.h)

type QColumnViewcontextMenuEventProc* = proc(param1: QContextMenuEvent): void
...
proc miqt_exec_callback_QColumnView_contextMenuEvent(self: ptr cQColumnView, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QColumnView_contextMenuEvent ".} =
  ...
  nimfunc[](slotval1)
proc QColumnViewchangeEvent*(self: gen_qcolumnview_types.QColumnView, param1: QEvent): void =
  fQColumnView_virtualbase_changeEvent(self.h, param1.h)

type QColumnViewchangeEventProc* = proc(param1: QEvent): void
...
proc miqt_exec_callback_QColumnView_changeEvent(self: ptr cQColumnView, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QColumnView_changeEvent ".} =
  ...
  nimfunc[](slotval1)
proc QColumnViewinitStyleOption*(self: gen_qcolumnview_types.QColumnView, option: QStyleOptionFrame): void =
  fQColumnView_virtualbase_initStyleOption(self.h, option.h)

type QColumnViewinitStyleOptionProc* = proc(option: QStyleOptionFrame): void
...
proc miqt_exec_callback_QColumnView_hasHeightForWidth(self: ptr cQColumnView, slot: int): bool {.exportc: "miqt_exec_callback_QColumnView_hasHeightForWidth ".} =
  ...
  virtualReturn
proc QColumnViewpaintEngine*(self: gen_qcolumnview_types.QColumnView, ): QPaintEngine =
  QPaintEngine(h: fQColumnView_virtualbase_paintEngine(self.h))

type QColumnViewpaintEngineProc* = proc(): QPaintEngine
...
proc miqt_exec_callback_QColumnView_paintEngine(self: ptr cQColumnView, slot: int): pointer {.exportc: "miqt_exec_callback_QColumnView_paintEngine ".} =
  ...
  virtualReturn.h
proc QColumnViewkeyReleaseEvent*(self: gen_qcolumnview_types.QColumnView, event: QKeyEvent): void =
  fQColumnView_virtualbase_keyReleaseEvent(self.h, event.h)

type QColumnViewkeyReleaseEventProc* = proc(event: QKeyEvent): void
...
proc miqt_exec_callback_QColumnView_keyReleaseEvent(self: ptr cQColumnView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QColumnView_keyReleaseEvent ".} =
  ...
  nimfunc[](slotval1)
proc QColumnViewenterEvent*(self: gen_qcolumnview_types.QColumnView, event: QEnterEvent): void =
  fQColumnView_virtualbase_enterEvent(self.h, event.h)

type QColumnViewenterEventProc* = proc(event: QEnterEvent): void
...
proc miqt_exec_callback_QColumnView_enterEvent(self: ptr cQColumnView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QColumnView_enterEvent ".} =
  ...
  nimfunc[](slotval1)
proc QColumnViewleaveEvent*(self: gen_qcolumnview_types.QColumnView, event: QEvent): void =
  fQColumnView_virtualbase_leaveEvent(self.h, event.h)

type QColumnViewleaveEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QColumnView_leaveEvent(self: ptr cQColumnView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QColumnView_leaveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QColumnViewmoveEvent*(self: gen_qcolumnview_types.QColumnView, event: QMoveEvent): void =
  fQColumnView_virtualbase_moveEvent(self.h, event.h)

type QColumnViewmoveEventProc* = proc(event: QMoveEvent): void
...
proc miqt_exec_callback_QColumnView_moveEvent(self: ptr cQColumnView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QColumnView_moveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QColumnViewcloseEvent*(self: gen_qcolumnview_types.QColumnView, event: QCloseEvent): void =
  fQColumnView_virtualbase_closeEvent(self.h, event.h)

type QColumnViewcloseEventProc* = proc(event: QCloseEvent): void
...
proc miqt_exec_callback_QColumnView_closeEvent(self: ptr cQColumnView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QColumnView_closeEvent ".} =
  ...
  nimfunc[](slotval1)
proc QColumnViewtabletEvent*(self: gen_qcolumnview_types.QColumnView, event: QTabletEvent): void =
  fQColumnView_virtualbase_tabletEvent(self.h, event.h)

type QColumnViewtabletEventProc* = proc(event: QTabletEvent): void
...
proc miqt_exec_callback_QColumnView_tabletEvent(self: ptr cQColumnView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QColumnView_tabletEvent ".} =
  ...
  nimfunc[](slotval1)
proc QColumnViewactionEvent*(self: gen_qcolumnview_types.QColumnView, event: QActionEvent): void =
  fQColumnView_virtualbase_actionEvent(self.h, event.h)

type QColumnViewactionEventProc* = proc(event: QActionEvent): void
...
proc miqt_exec_callback_QColumnView_actionEvent(self: ptr cQColumnView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QColumnView_actionEvent ".} =
  ...
  nimfunc[](slotval1)
proc QColumnViewshowEvent*(self: gen_qcolumnview_types.QColumnView, event: QShowEvent): void =
  fQColumnView_virtualbase_showEvent(self.h, event.h)

type QColumnViewshowEventProc* = proc(event: QShowEvent): void
...
proc miqt_exec_callback_QColumnView_showEvent(self: ptr cQColumnView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QColumnView_showEvent ".} =
  ...
  nimfunc[](slotval1)
proc QColumnViewhideEvent*(self: gen_qcolumnview_types.QColumnView, event: QHideEvent): void =
  fQColumnView_virtualbase_hideEvent(self.h, event.h)

type QColumnViewhideEventProc* = proc(event: QHideEvent): void
...
proc miqt_exec_callback_QColumnView_metric(self: ptr cQColumnView, slot: int, param1: cint): cint {.exportc: "miqt_exec_callback_QColumnView_metric ".} =
  ...
  virtualReturn
proc QColumnViewinitPainter*(self: gen_qcolumnview_types.QColumnView, painter: QPainter): void =
  fQColumnView_virtualbase_initPainter(self.h, painter.h)

type QColumnViewinitPainterProc* = proc(painter: QPainter): void
...
proc miqt_exec_callback_QColumnView_initPainter(self: ptr cQColumnView, slot: int, painter: pointer): void {.exportc: "miqt_exec_callback_QColumnView_initPainter ".} =
  ...
  nimfunc[](slotval1)
proc QColumnViewredirected*(self: gen_qcolumnview_types.QColumnView, offset: QPoint): QPaintDevice =
  QPaintDevice(h: fQColumnView_virtualbase_redirected(self.h, offset.h))

type QColumnViewredirectedProc* = proc(offset: QPoint): QPaintDevice
...
proc miqt_exec_callback_QColumnView_redirected(self: ptr cQColumnView, slot: int, offset: pointer): pointer {.exportc: "miqt_exec_callback_QColumnView_redirected ".} =
  ...
  virtualReturn.h
proc QColumnViewsharedPainter*(self: gen_qcolumnview_types.QColumnView, ): QPainter =
  QPainter(h: fQColumnView_virtualbase_sharedPainter(self.h))

type QColumnViewsharedPainterProc* = proc(): QPainter
...
proc miqt_exec_callback_QColumnView_sharedPainter(self: ptr cQColumnView, slot: int): pointer {.exportc: "miqt_exec_callback_QColumnView_sharedPainter ".} =
  ...
  virtualReturn.h
proc QColumnViewchildEvent*(self: gen_qcolumnview_types.QColumnView, event: QChildEvent): void =
  fQColumnView_virtualbase_childEvent(self.h, event.h)

type QColumnViewchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QColumnView_childEvent(self: ptr cQColumnView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QColumnView_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QColumnViewcustomEvent*(self: gen_qcolumnview_types.QColumnView, event: QEvent): void =
  fQColumnView_virtualbase_customEvent(self.h, event.h)

type QColumnViewcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QColumnView_customEvent(self: ptr cQColumnView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QColumnView_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QColumnViewconnectNotify*(self: gen_qcolumnview_types.QColumnView, signal: QMetaMethod): void =
  fQColumnView_virtualbase_connectNotify(self.h, signal.h)

type QColumnViewconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QColumnView_connectNotify(self: ptr cQColumnView, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QColumnView_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QColumnViewdisconnectNotify*(self: gen_qcolumnview_types.QColumnView, signal: QMetaMethod): void =
  fQColumnView_virtualbase_disconnectNotify(self.h, signal.h)

type QColumnViewdisconnectNotifyProc* = proc(signal: QMetaMethod): void
