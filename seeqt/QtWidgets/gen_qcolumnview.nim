...
proc miqt_exec_callback_QColumnView_startDrag(self: ptr cQColumnView, slot: int, supportedActions: cint): void {.exportc: "miqt_exec_callback_QColumnView_startDrag ".} =
  ...
  nimfunc[](slotval1)
proc QColumnViewviewOptions*(self: gen_qcolumnview_types.QColumnView, ): QStyleOptionViewItem =
  QStyleOptionViewItem(h: fQColumnView_virtualbase_viewOptions(self.h))

type QColumnViewviewOptionsProc* = proc(): QStyleOptionViewItem
proc onviewOptions*(self: gen_qcolumnview_types.QColumnView, slot: QColumnViewviewOptionsProc) =
  # TODO check subclass
  var tmp = new QColumnViewviewOptionsProc
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QColumnView_viewOptions(self: ptr cQColumnView, slot: int): pointer {.exportc: "miqt_exec_callback_QColumnView_viewOptions ".} =
  var nimfunc = cast[ptr QColumnViewviewOptionsProc](cast[pointer](slot))
...
proc miqt_exec_callback_QColumnView_keyReleaseEvent(self: ptr cQColumnView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QColumnView_keyReleaseEvent ".} =
  ...
  nimfunc[](slotval1)
proc QColumnViewenterEvent*(self: gen_qcolumnview_types.QColumnView, event: QEvent): void =
  fQColumnView_virtualbase_enterEvent(self.h, event.h)

type QColumnViewenterEventProc* = proc(event: QEvent): void
