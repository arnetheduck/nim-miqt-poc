...
public:
	...
	MiqtVirtualQAbstractItemDelegate(struct QAbstractItemDelegate_VTable* vtbl): QAbstractItemDelegate(), vtbl(vtbl) {};
	MiqtVirtualQAbstractItemDelegate(struct QAbstractItemDelegate_VTable* vtbl, QObject* parent): QAbstractItemDelegate(parent), vtbl(vtbl) {};

	virtual ~MiqtVirtualQAbstractItemDelegate() override { if(vtbl->destructor) vtbl->destructor(vtbl, this); }
...
void QAbstractItemDelegate_connect_commitData(QAbstractItemDelegate* self, intptr_t slot, void (*callback)(intptr_t, QWidget*), void (*release)(intptr_t)) {
	...
	MiqtVirtualQAbstractItemDelegate::connect(self, static_cast<void (QAbstractItemDelegate::*)(QWidget*)>(&QAbstractItemDelegate::commitData), self, caller{slot, callback, release});
}
...
void QAbstractItemDelegate_connect_closeEditor(QAbstractItemDelegate* self, intptr_t slot, void (*callback)(intptr_t, QWidget*), void (*release)(intptr_t)) {
	...
	MiqtVirtualQAbstractItemDelegate::connect(self, static_cast<void (QAbstractItemDelegate::*)(QWidget*, QAbstractItemDelegate::EndEditHint)>(&QAbstractItemDelegate::closeEditor), self, caller{slot, callback, release});
}
...
void QAbstractItemDelegate_connect_sizeHintChanged(QAbstractItemDelegate* self, intptr_t slot, void (*callback)(intptr_t, QModelIndex*), void (*release)(intptr_t)) {
	...
	MiqtVirtualQAbstractItemDelegate::connect(self, static_cast<void (QAbstractItemDelegate::*)(const QModelIndex&)>(&QAbstractItemDelegate::sizeHintChanged), self, caller{slot, callback, release});
}
...
QMetaObject* QAbstractItemDelegate_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQAbstractItemDelegate*)(self) )->QAbstractItemDelegate::metaObject();

}

void* QAbstractItemDelegate_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQAbstractItemDelegate*)(self) )->QAbstractItemDelegate::qt_metacast(param1);

}

int QAbstractItemDelegate_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQAbstractItemDelegate*)(self) )->QAbstractItemDelegate::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
struct miqt_array /* of int */  QAbstractItemDelegate_virtualbase_paintingRoles(const void* self) {
	...
	QVector<int> _ret = ( (const MiqtVirtualQAbstractItemDelegate*)(self) )->QAbstractItemDelegate::paintingRoles();
	// Convert QList<> from C++ memory to manually-managed C memory
	int* _arr = static_cast<int*>(malloc(sizeof(int) * _ret.length()));
	for (size_t i = 0, e = _ret.length(); i < e; ++i) {
		_arr[i] = _ret[i];
