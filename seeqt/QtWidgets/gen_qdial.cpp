...
QMetaObject* QDial_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQDial*)(self) )->QDial::metaObject();

}

void* QDial_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQDial*)(self) )->QDial::qt_metacast(param1);

}

int QDial_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQDial*)(self) )->QDial::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
bool QDial_virtualbase_nativeEvent(void* self, struct miqt_string eventType, void* message, long* result) {
	...
	return ( (MiqtVirtualQDial*)(self) )->QDial::nativeEvent(eventType_QByteArray, message, static_cast<long*>(result));
...
void QDial_protectedbase_initStyleOption(const void* self, QStyleOptionSlider* option) {
	MiqtVirtualQDial* self_cast = static_cast<MiqtVirtualQDial*>( (QDial*)(self) );
