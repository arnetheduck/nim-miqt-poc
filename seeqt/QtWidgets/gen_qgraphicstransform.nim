...
proc create*(T: type gen_qgraphicstransform_types.QGraphicsTransform, parent: QObject): gen_qgraphicstransform_types.QGraphicsTransform =
  gen_qgraphicstransform_types.QGraphicsTransform.init(fcQGraphicsTransform_new2(parent.h))

proc metaObject*(self: gen_qgraphicstransform_types.QGraphicsTransform, ): QMetaObject =
  QMetaObject(h: fcQGraphicsTransform_metaObject(self.h))
...
proc applyTo*(self: gen_qgraphicstransform_types.QGraphicsTransform, matrix: QMatrix4x4): void =
...
proc miqt_exec_callback_QGraphicsTransform_metacall(self: ptr cQGraphicsTransform, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QGraphicsTransform_metacall ".} =
  ...
  virtualReturn
type QGraphicsTransformapplyToProc* = proc(matrix: QMatrix4x4): void
...
proc miqt_exec_callback_QGraphicsTransform_applyTo(self: ptr cQGraphicsTransform, slot: int, matrix: pointer): void {.exportc: "miqt_exec_callback_QGraphicsTransform_applyTo ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsTransformevent*(self: gen_qgraphicstransform_types.QGraphicsTransform, event: QEvent): bool =
  fQGraphicsTransform_virtualbase_event(self.h, event.h)

type QGraphicsTransformeventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QGraphicsTransform_event(self: ptr cQGraphicsTransform, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QGraphicsTransform_event ".} =
  ...
  virtualReturn
proc QGraphicsTransformeventFilter*(self: gen_qgraphicstransform_types.QGraphicsTransform, watched: QObject, event: QEvent): bool =
  fQGraphicsTransform_virtualbase_eventFilter(self.h, watched.h, event.h)

type QGraphicsTransformeventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QGraphicsTransform_eventFilter(self: ptr cQGraphicsTransform, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QGraphicsTransform_eventFilter ".} =
  ...
  virtualReturn
proc QGraphicsTransformtimerEvent*(self: gen_qgraphicstransform_types.QGraphicsTransform, event: QTimerEvent): void =
  fQGraphicsTransform_virtualbase_timerEvent(self.h, event.h)

type QGraphicsTransformtimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QGraphicsTransform_timerEvent(self: ptr cQGraphicsTransform, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsTransform_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsTransformchildEvent*(self: gen_qgraphicstransform_types.QGraphicsTransform, event: QChildEvent): void =
  fQGraphicsTransform_virtualbase_childEvent(self.h, event.h)

type QGraphicsTransformchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QGraphicsTransform_childEvent(self: ptr cQGraphicsTransform, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsTransform_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsTransformcustomEvent*(self: gen_qgraphicstransform_types.QGraphicsTransform, event: QEvent): void =
  fQGraphicsTransform_virtualbase_customEvent(self.h, event.h)

type QGraphicsTransformcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QGraphicsTransform_customEvent(self: ptr cQGraphicsTransform, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsTransform_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsTransformconnectNotify*(self: gen_qgraphicstransform_types.QGraphicsTransform, signal: QMetaMethod): void =
  fQGraphicsTransform_virtualbase_connectNotify(self.h, signal.h)

type QGraphicsTransformconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QGraphicsTransform_connectNotify(self: ptr cQGraphicsTransform, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QGraphicsTransform_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsTransformdisconnectNotify*(self: gen_qgraphicstransform_types.QGraphicsTransform, signal: QMetaMethod): void =
  fQGraphicsTransform_virtualbase_disconnectNotify(self.h, signal.h)

type QGraphicsTransformdisconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc create*(T: type gen_qgraphicstransform_types.QGraphicsScale, parent: QObject): gen_qgraphicstransform_types.QGraphicsScale =
  gen_qgraphicstransform_types.QGraphicsScale.init(fcQGraphicsScale_new2(parent.h))

proc metaObject*(self: gen_qgraphicstransform_types.QGraphicsScale, ): QMetaObject =
  QMetaObject(h: fcQGraphicsScale_metaObject(self.h))
...
proc origin*(self: gen_qgraphicstransform_types.QGraphicsScale, ): QVector3D =
  QVector3D(h: fcQGraphicsScale_origin(self.h))

proc setOrigin*(self: gen_qgraphicstransform_types.QGraphicsScale, point: QVector3D): void =
...
proc applyTo*(self: gen_qgraphicstransform_types.QGraphicsScale, matrix: QMatrix4x4): void =
...
proc miqt_exec_callback_QGraphicsScale_metacall(self: ptr cQGraphicsScale, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QGraphicsScale_metacall ".} =
  ...
  virtualReturn
proc QGraphicsScaleapplyTo*(self: gen_qgraphicstransform_types.QGraphicsScale, matrix: QMatrix4x4): void =
  fQGraphicsScale_virtualbase_applyTo(self.h, matrix.h)

type QGraphicsScaleapplyToProc* = proc(matrix: QMatrix4x4): void
...
proc miqt_exec_callback_QGraphicsScale_applyTo(self: ptr cQGraphicsScale, slot: int, matrix: pointer): void {.exportc: "miqt_exec_callback_QGraphicsScale_applyTo ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsScaleevent*(self: gen_qgraphicstransform_types.QGraphicsScale, event: QEvent): bool =
  fQGraphicsScale_virtualbase_event(self.h, event.h)

type QGraphicsScaleeventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QGraphicsScale_event(self: ptr cQGraphicsScale, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QGraphicsScale_event ".} =
  ...
  virtualReturn
proc QGraphicsScaleeventFilter*(self: gen_qgraphicstransform_types.QGraphicsScale, watched: QObject, event: QEvent): bool =
  fQGraphicsScale_virtualbase_eventFilter(self.h, watched.h, event.h)

type QGraphicsScaleeventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QGraphicsScale_eventFilter(self: ptr cQGraphicsScale, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QGraphicsScale_eventFilter ".} =
  ...
  virtualReturn
proc QGraphicsScaletimerEvent*(self: gen_qgraphicstransform_types.QGraphicsScale, event: QTimerEvent): void =
  fQGraphicsScale_virtualbase_timerEvent(self.h, event.h)

type QGraphicsScaletimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QGraphicsScale_timerEvent(self: ptr cQGraphicsScale, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsScale_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsScalechildEvent*(self: gen_qgraphicstransform_types.QGraphicsScale, event: QChildEvent): void =
  fQGraphicsScale_virtualbase_childEvent(self.h, event.h)

type QGraphicsScalechildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QGraphicsScale_childEvent(self: ptr cQGraphicsScale, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsScale_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsScalecustomEvent*(self: gen_qgraphicstransform_types.QGraphicsScale, event: QEvent): void =
  fQGraphicsScale_virtualbase_customEvent(self.h, event.h)

type QGraphicsScalecustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QGraphicsScale_customEvent(self: ptr cQGraphicsScale, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsScale_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsScaleconnectNotify*(self: gen_qgraphicstransform_types.QGraphicsScale, signal: QMetaMethod): void =
  fQGraphicsScale_virtualbase_connectNotify(self.h, signal.h)

type QGraphicsScaleconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QGraphicsScale_connectNotify(self: ptr cQGraphicsScale, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QGraphicsScale_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsScaledisconnectNotify*(self: gen_qgraphicstransform_types.QGraphicsScale, signal: QMetaMethod): void =
  fQGraphicsScale_virtualbase_disconnectNotify(self.h, signal.h)

type QGraphicsScaledisconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc create*(T: type gen_qgraphicstransform_types.QGraphicsRotation, parent: QObject): gen_qgraphicstransform_types.QGraphicsRotation =
  gen_qgraphicstransform_types.QGraphicsRotation.init(fcQGraphicsRotation_new2(parent.h))

proc metaObject*(self: gen_qgraphicstransform_types.QGraphicsRotation, ): QMetaObject =
  QMetaObject(h: fcQGraphicsRotation_metaObject(self.h))
...
proc origin*(self: gen_qgraphicstransform_types.QGraphicsRotation, ): QVector3D =
  QVector3D(h: fcQGraphicsRotation_origin(self.h))

proc setOrigin*(self: gen_qgraphicstransform_types.QGraphicsRotation, point: QVector3D): void =
...
proc axis*(self: gen_qgraphicstransform_types.QGraphicsRotation, ): QVector3D =
  QVector3D(h: fcQGraphicsRotation_axis(self.h))

proc setAxis*(self: gen_qgraphicstransform_types.QGraphicsRotation, axis: QVector3D): void =
...
proc applyTo*(self: gen_qgraphicstransform_types.QGraphicsRotation, matrix: QMatrix4x4): void =
...
proc miqt_exec_callback_QGraphicsRotation_metacall(self: ptr cQGraphicsRotation, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QGraphicsRotation_metacall ".} =
  ...
  virtualReturn
proc QGraphicsRotationapplyTo*(self: gen_qgraphicstransform_types.QGraphicsRotation, matrix: QMatrix4x4): void =
  fQGraphicsRotation_virtualbase_applyTo(self.h, matrix.h)

type QGraphicsRotationapplyToProc* = proc(matrix: QMatrix4x4): void
...
proc miqt_exec_callback_QGraphicsRotation_applyTo(self: ptr cQGraphicsRotation, slot: int, matrix: pointer): void {.exportc: "miqt_exec_callback_QGraphicsRotation_applyTo ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsRotationevent*(self: gen_qgraphicstransform_types.QGraphicsRotation, event: QEvent): bool =
  fQGraphicsRotation_virtualbase_event(self.h, event.h)

type QGraphicsRotationeventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QGraphicsRotation_event(self: ptr cQGraphicsRotation, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QGraphicsRotation_event ".} =
  ...
  virtualReturn
proc QGraphicsRotationeventFilter*(self: gen_qgraphicstransform_types.QGraphicsRotation, watched: QObject, event: QEvent): bool =
  fQGraphicsRotation_virtualbase_eventFilter(self.h, watched.h, event.h)

type QGraphicsRotationeventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QGraphicsRotation_eventFilter(self: ptr cQGraphicsRotation, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QGraphicsRotation_eventFilter ".} =
  ...
  virtualReturn
proc QGraphicsRotationtimerEvent*(self: gen_qgraphicstransform_types.QGraphicsRotation, event: QTimerEvent): void =
  fQGraphicsRotation_virtualbase_timerEvent(self.h, event.h)

type QGraphicsRotationtimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QGraphicsRotation_timerEvent(self: ptr cQGraphicsRotation, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsRotation_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsRotationchildEvent*(self: gen_qgraphicstransform_types.QGraphicsRotation, event: QChildEvent): void =
  fQGraphicsRotation_virtualbase_childEvent(self.h, event.h)

type QGraphicsRotationchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QGraphicsRotation_childEvent(self: ptr cQGraphicsRotation, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsRotation_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsRotationcustomEvent*(self: gen_qgraphicstransform_types.QGraphicsRotation, event: QEvent): void =
  fQGraphicsRotation_virtualbase_customEvent(self.h, event.h)

type QGraphicsRotationcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QGraphicsRotation_customEvent(self: ptr cQGraphicsRotation, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsRotation_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsRotationconnectNotify*(self: gen_qgraphicstransform_types.QGraphicsRotation, signal: QMetaMethod): void =
  fQGraphicsRotation_virtualbase_connectNotify(self.h, signal.h)

type QGraphicsRotationconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QGraphicsRotation_connectNotify(self: ptr cQGraphicsRotation, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QGraphicsRotation_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsRotationdisconnectNotify*(self: gen_qgraphicstransform_types.QGraphicsRotation, signal: QMetaMethod): void =
  fQGraphicsRotation_virtualbase_disconnectNotify(self.h, signal.h)

type QGraphicsRotationdisconnectNotifyProc* = proc(signal: QMetaMethod): void
