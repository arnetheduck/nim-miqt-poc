...
proc create*(T: type gen_qdatawidgetmapper_types.QDataWidgetMapper, parent: QObject): gen_qdatawidgetmapper_types.QDataWidgetMapper =
  gen_qdatawidgetmapper_types.QDataWidgetMapper.init(fcQDataWidgetMapper_new2(parent.h))

proc metaObject*(self: gen_qdatawidgetmapper_types.QDataWidgetMapper, ): QMetaObject =
  QMetaObject(h: fcQDataWidgetMapper_metaObject(self.h))
...
proc setModel*(self: gen_qdatawidgetmapper_types.QDataWidgetMapper, model: QAbstractItemModel): void =
  fcQDataWidgetMapper_setModel(self.h, model.h)

proc model*(self: gen_qdatawidgetmapper_types.QDataWidgetMapper, ): QAbstractItemModel =
  QAbstractItemModel(h: fcQDataWidgetMapper_model(self.h))

proc setItemDelegate*(self: gen_qdatawidgetmapper_types.QDataWidgetMapper, delegate: QAbstractItemDelegate): void =
  fcQDataWidgetMapper_setItemDelegate(self.h, delegate.h)

proc itemDelegate*(self: gen_qdatawidgetmapper_types.QDataWidgetMapper, ): QAbstractItemDelegate =
  QAbstractItemDelegate(h: fcQDataWidgetMapper_itemDelegate(self.h))

proc setRootIndex*(self: gen_qdatawidgetmapper_types.QDataWidgetMapper, index: QModelIndex): void =
  fcQDataWidgetMapper_setRootIndex(self.h, index.h)

proc rootIndex*(self: gen_qdatawidgetmapper_types.QDataWidgetMapper, ): QModelIndex =
  QModelIndex(h: fcQDataWidgetMapper_rootIndex(self.h))
...
proc addMapping*(self: gen_qdatawidgetmapper_types.QDataWidgetMapper, widget: QWidget, section: cint): void =
  fcQDataWidgetMapper_addMapping(self.h, widget.h, section)

proc addMapping*(self: gen_qdatawidgetmapper_types.QDataWidgetMapper, widget: QWidget, section: cint, propertyName: seq[byte]): void =
...
proc removeMapping*(self: gen_qdatawidgetmapper_types.QDataWidgetMapper, widget: QWidget): void =
  fcQDataWidgetMapper_removeMapping(self.h, widget.h)

proc mappedSection*(self: gen_qdatawidgetmapper_types.QDataWidgetMapper, widget: QWidget): cint =
  fcQDataWidgetMapper_mappedSection(self.h, widget.h)

proc mappedPropertyName*(self: gen_qdatawidgetmapper_types.QDataWidgetMapper, widget: QWidget): seq[byte] =
  var v_bytearray = fcQDataWidgetMapper_mappedPropertyName(self.h, widget.h)
  var vx_ret = @(toOpenArrayByte(v_bytearray.data, 0, int(v_bytearray.len)-1))
  c_free(v_bytearray.data)
  vx_ret

proc mappedWidgetAt*(self: gen_qdatawidgetmapper_types.QDataWidgetMapper, section: cint): QWidget =
  QWidget(h: fcQDataWidgetMapper_mappedWidgetAt(self.h, section))
...
proc setCurrentModelIndex*(self: gen_qdatawidgetmapper_types.QDataWidgetMapper, index: QModelIndex): void =
...
proc miqt_exec_callback_QDataWidgetMapper_setCurrentIndex(self: ptr cQDataWidgetMapper, slot: int, index: cint): void {.exportc: "miqt_exec_callback_QDataWidgetMapper_setCurrentIndex ".} =
  ...
  nimfunc[](slotval1)
proc QDataWidgetMapperevent*(self: gen_qdatawidgetmapper_types.QDataWidgetMapper, event: QEvent): bool =
  fQDataWidgetMapper_virtualbase_event(self.h, event.h)

type QDataWidgetMappereventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QDataWidgetMapper_event(self: ptr cQDataWidgetMapper, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QDataWidgetMapper_event ".} =
  ...
  virtualReturn
proc QDataWidgetMappereventFilter*(self: gen_qdatawidgetmapper_types.QDataWidgetMapper, watched: QObject, event: QEvent): bool =
  fQDataWidgetMapper_virtualbase_eventFilter(self.h, watched.h, event.h)

type QDataWidgetMappereventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QDataWidgetMapper_eventFilter(self: ptr cQDataWidgetMapper, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QDataWidgetMapper_eventFilter ".} =
  ...
  virtualReturn
proc QDataWidgetMappertimerEvent*(self: gen_qdatawidgetmapper_types.QDataWidgetMapper, event: QTimerEvent): void =
  fQDataWidgetMapper_virtualbase_timerEvent(self.h, event.h)

type QDataWidgetMappertimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QDataWidgetMapper_timerEvent(self: ptr cQDataWidgetMapper, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QDataWidgetMapper_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QDataWidgetMapperchildEvent*(self: gen_qdatawidgetmapper_types.QDataWidgetMapper, event: QChildEvent): void =
  fQDataWidgetMapper_virtualbase_childEvent(self.h, event.h)

type QDataWidgetMapperchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QDataWidgetMapper_childEvent(self: ptr cQDataWidgetMapper, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QDataWidgetMapper_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QDataWidgetMappercustomEvent*(self: gen_qdatawidgetmapper_types.QDataWidgetMapper, event: QEvent): void =
  fQDataWidgetMapper_virtualbase_customEvent(self.h, event.h)

type QDataWidgetMappercustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QDataWidgetMapper_customEvent(self: ptr cQDataWidgetMapper, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QDataWidgetMapper_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QDataWidgetMapperconnectNotify*(self: gen_qdatawidgetmapper_types.QDataWidgetMapper, signal: QMetaMethod): void =
  fQDataWidgetMapper_virtualbase_connectNotify(self.h, signal.h)

type QDataWidgetMapperconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QDataWidgetMapper_connectNotify(self: ptr cQDataWidgetMapper, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QDataWidgetMapper_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QDataWidgetMapperdisconnectNotify*(self: gen_qdatawidgetmapper_types.QDataWidgetMapper, signal: QMetaMethod): void =
  fQDataWidgetMapper_virtualbase_disconnectNotify(self.h, signal.h)

type QDataWidgetMapperdisconnectNotifyProc* = proc(signal: QMetaMethod): void
