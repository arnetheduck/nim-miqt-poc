...
func init*(T: type gen_qtableview_types.QTableView, h: ptr cQTableView): gen_qtableview_types.QTableView =
  T(h: h)
proc create*(T: type gen_qtableview_types.QTableView, parent: QWidget): gen_qtableview_types.QTableView =
...
proc metaObject*(self: gen_qtableview_types.QTableView, ): QMetaObject =
  QMetaObject(h: fcQTableView_metaObject(self.h))
...
proc setModel*(self: gen_qtableview_types.QTableView, model: QAbstractItemModel): void =
  fcQTableView_setModel(self.h, model.h)

proc setRootIndex*(self: gen_qtableview_types.QTableView, index: QModelIndex): void =
  fcQTableView_setRootIndex(self.h, index.h)

proc setSelectionModel*(self: gen_qtableview_types.QTableView, selectionModel: QItemSelectionModel): void =
...
proc horizontalHeader*(self: gen_qtableview_types.QTableView, ): QHeaderView =
  QHeaderView(h: fcQTableView_horizontalHeader(self.h))

proc verticalHeader*(self: gen_qtableview_types.QTableView, ): QHeaderView =
  QHeaderView(h: fcQTableView_verticalHeader(self.h))

proc setHorizontalHeader*(self: gen_qtableview_types.QTableView, header: QHeaderView): void =
  fcQTableView_setHorizontalHeader(self.h, header.h)

proc setVerticalHeader*(self: gen_qtableview_types.QTableView, header: QHeaderView): void =
...
proc visualRect*(self: gen_qtableview_types.QTableView, index: QModelIndex): QRect =
  QRect(h: fcQTableView_visualRect(self.h, index.h))

proc scrollTo*(self: gen_qtableview_types.QTableView, index: QModelIndex, hint: cint): void =
  fcQTableView_scrollTo(self.h, index.h, cint(hint))

proc indexAt*(self: gen_qtableview_types.QTableView, p: QPoint): QModelIndex =
  QModelIndex(h: fcQTableView_indexAt(self.h, p.h))
...
proc miqt_exec_callback_QTableView_metacall(self: ptr cQTableView, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QTableView_metacall ".} =
  ...
  virtualReturn
proc QTableViewsetModel*(self: gen_qtableview_types.QTableView, model: QAbstractItemModel): void =
  fQTableView_virtualbase_setModel(self.h, model.h)

type QTableViewsetModelProc* = proc(model: QAbstractItemModel): void
...
proc miqt_exec_callback_QTableView_setModel(self: ptr cQTableView, slot: int, model: pointer): void {.exportc: "miqt_exec_callback_QTableView_setModel ".} =
  ...
  nimfunc[](slotval1)
proc QTableViewsetRootIndex*(self: gen_qtableview_types.QTableView, index: QModelIndex): void =
  fQTableView_virtualbase_setRootIndex(self.h, index.h)

type QTableViewsetRootIndexProc* = proc(index: QModelIndex): void
...
proc miqt_exec_callback_QTableView_setRootIndex(self: ptr cQTableView, slot: int, index: pointer): void {.exportc: "miqt_exec_callback_QTableView_setRootIndex ".} =
  ...
  nimfunc[](slotval1)
proc QTableViewsetSelectionModel*(self: gen_qtableview_types.QTableView, selectionModel: QItemSelectionModel): void =
  fQTableView_virtualbase_setSelectionModel(self.h, selectionModel.h)

type QTableViewsetSelectionModelProc* = proc(selectionModel: QItemSelectionModel): void
...
proc miqt_exec_callback_QTableView_doItemsLayout(self: ptr cQTableView, slot: int): void {.exportc: "miqt_exec_callback_QTableView_doItemsLayout ".} =
  ...
  nimfunc[]()
proc QTableViewvisualRect*(self: gen_qtableview_types.QTableView, index: QModelIndex): QRect =
  QRect(h: fQTableView_virtualbase_visualRect(self.h, index.h))

type QTableViewvisualRectProc* = proc(index: QModelIndex): QRect
...
proc miqt_exec_callback_QTableView_visualRect(self: ptr cQTableView, slot: int, index: pointer): pointer {.exportc: "miqt_exec_callback_QTableView_visualRect ".} =
  ...
  virtualReturn.h
proc QTableViewscrollTo*(self: gen_qtableview_types.QTableView, index: QModelIndex, hint: cint): void =
  fQTableView_virtualbase_scrollTo(self.h, index.h, cint(hint))

type QTableViewscrollToProc* = proc(index: QModelIndex, hint: cint): void
...
proc QTableViewindexAt*(self: gen_qtableview_types.QTableView, p: QPoint): QModelIndex =
  QModelIndex(h: fQTableView_virtualbase_indexAt(self.h, p.h))

type QTableViewindexAtProc* = proc(p: QPoint): QModelIndex
...
proc miqt_exec_callback_QTableView_scrollContentsBy(self: ptr cQTableView, slot: int, dx: cint, dy: cint): void {.exportc: "miqt_exec_callback_QTableView_scrollContentsBy ".} =
  ...
  nimfunc[](slotval1, slotval2)
proc QTableViewinitViewItemOption*(self: gen_qtableview_types.QTableView, option: QStyleOptionViewItem): void =
  fQTableView_virtualbase_initViewItemOption(self.h, option.h)

type QTableViewinitViewItemOptionProc* = proc(option: QStyleOptionViewItem): void
...
proc miqt_exec_callback_QTableView_initViewItemOption(self: ptr cQTableView, slot: int, option: pointer): void {.exportc: "miqt_exec_callback_QTableView_initViewItemOption ".} =
  ...
  nimfunc[](slotval1)
proc QTableViewpaintEvent*(self: gen_qtableview_types.QTableView, e: QPaintEvent): void =
  fQTableView_virtualbase_paintEvent(self.h, e.h)

type QTableViewpaintEventProc* = proc(e: QPaintEvent): void
...
proc miqt_exec_callback_QTableView_paintEvent(self: ptr cQTableView, slot: int, e: pointer): void {.exportc: "miqt_exec_callback_QTableView_paintEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTableViewtimerEvent*(self: gen_qtableview_types.QTableView, event: QTimerEvent): void =
  fQTableView_virtualbase_timerEvent(self.h, event.h)

type QTableViewtimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QTableView_verticalOffset(self: ptr cQTableView, slot: int): cint {.exportc: "miqt_exec_callback_QTableView_verticalOffset ".} =
  ...
  virtualReturn
proc QTableViewmoveCursor*(self: gen_qtableview_types.QTableView, cursorAction: cint, modifiers: cint): QModelIndex =
  QModelIndex(h: fQTableView_virtualbase_moveCursor(self.h, cint(cursorAction), cint(modifiers)))

type QTableViewmoveCursorProc* = proc(cursorAction: cint, modifiers: cint): QModelIndex
...
proc miqt_exec_callback_QTableView_moveCursor(self: ptr cQTableView, slot: int, cursorAction: cint, modifiers: cint): pointer {.exportc: "miqt_exec_callback_QTableView_moveCursor ".} =
  ...
  virtualReturn.h
proc QTableViewsetSelection*(self: gen_qtableview_types.QTableView, rect: QRect, command: cint): void =
  fQTableView_virtualbase_setSelection(self.h, rect.h, cint(command))

type QTableViewsetSelectionProc* = proc(rect: QRect, command: cint): void
...
proc miqt_exec_callback_QTableView_setSelection(self: ptr cQTableView, slot: int, rect: pointer, command: cint): void {.exportc: "miqt_exec_callback_QTableView_setSelection ".} =
  ...
  nimfunc[](slotval1, slotval2)
proc QTableViewvisualRegionForSelection*(self: gen_qtableview_types.QTableView, selection: QItemSelection): QRegion =
  QRegion(h: fQTableView_virtualbase_visualRegionForSelection(self.h, selection.h))

type QTableViewvisualRegionForSelectionProc* = proc(selection: QItemSelection): QRegion
...
proc miqt_exec_callback_QTableView_visualRegionForSelection(self: ptr cQTableView, slot: int, selection: pointer): pointer {.exportc: "miqt_exec_callback_QTableView_visualRegionForSelection ".} =
  ...
  virtualReturn.h
proc QTableViewselectedIndexes*(self: gen_qtableview_types.QTableView, ): seq[QModelIndex] =
...
type QTableViewselectedIndexesProc* = proc(): seq[QModelIndex]
...
proc miqt_exec_callback_QTableView_updateGeometries(self: ptr cQTableView, slot: int): void {.exportc: "miqt_exec_callback_QTableView_updateGeometries ".} =
  ...
  nimfunc[]()
proc QTableViewviewportSizeHint*(self: gen_qtableview_types.QTableView, ): QSize =
  QSize(h: fQTableView_virtualbase_viewportSizeHint(self.h))

type QTableViewviewportSizeHintProc* = proc(): QSize
...
proc miqt_exec_callback_QTableView_horizontalScrollbarAction(self: ptr cQTableView, slot: int, action: cint): void {.exportc: "miqt_exec_callback_QTableView_horizontalScrollbarAction ".} =
  ...
  nimfunc[](slotval1)
proc QTableViewisIndexHidden*(self: gen_qtableview_types.QTableView, index: QModelIndex): bool =
  fQTableView_virtualbase_isIndexHidden(self.h, index.h)

type QTableViewisIndexHiddenProc* = proc(index: QModelIndex): bool
...
proc miqt_exec_callback_QTableView_isIndexHidden(self: ptr cQTableView, slot: int, index: pointer): bool {.exportc: "miqt_exec_callback_QTableView_isIndexHidden ".} =
  ...
  virtualReturn
proc QTableViewselectionChanged*(self: gen_qtableview_types.QTableView, selected: QItemSelection, deselected: QItemSelection): void =
  fQTableView_virtualbase_selectionChanged(self.h, selected.h, deselected.h)

type QTableViewselectionChangedProc* = proc(selected: QItemSelection, deselected: QItemSelection): void
...
proc miqt_exec_callback_QTableView_selectionChanged(self: ptr cQTableView, slot: int, selected: pointer, deselected: pointer): void {.exportc: "miqt_exec_callback_QTableView_selectionChanged ".} =
  ...
  nimfunc[](slotval1, slotval2)
proc QTableViewcurrentChanged*(self: gen_qtableview_types.QTableView, current: QModelIndex, previous: QModelIndex): void =
  fQTableView_virtualbase_currentChanged(self.h, current.h, previous.h)

type QTableViewcurrentChangedProc* = proc(current: QModelIndex, previous: QModelIndex): void
...
proc miqt_exec_callback_QTableView_keyboardSearch(self: ptr cQTableView, slot: int, search: struct_miqt_string): void {.exportc: "miqt_exec_callback_QTableView_keyboardSearch ".} =
  ...
  nimfunc[](slotval1)
proc QTableViewitemDelegateForIndex*(self: gen_qtableview_types.QTableView, index: QModelIndex): QAbstractItemDelegate =
  QAbstractItemDelegate(h: fQTableView_virtualbase_itemDelegateForIndex(self.h, index.h))

type QTableViewitemDelegateForIndexProc* = proc(index: QModelIndex): QAbstractItemDelegate
...
proc miqt_exec_callback_QTableView_itemDelegateForIndex(self: ptr cQTableView, slot: int, index: pointer): pointer {.exportc: "miqt_exec_callback_QTableView_itemDelegateForIndex ".} =
  ...
  virtualReturn.h
proc QTableViewinputMethodQuery*(self: gen_qtableview_types.QTableView, query: cint): QVariant =
  QVariant(h: fQTableView_virtualbase_inputMethodQuery(self.h, cint(query)))

type QTableViewinputMethodQueryProc* = proc(query: cint): QVariant
...
proc miqt_exec_callback_QTableView_selectAll(self: ptr cQTableView, slot: int): void {.exportc: "miqt_exec_callback_QTableView_selectAll ".} =
  ...
  nimfunc[]()
proc QTableViewdataChanged*(self: gen_qtableview_types.QTableView, topLeft: QModelIndex, bottomRight: QModelIndex, roles: seq[cint]): void =
...
type QTableViewdataChangedProc* = proc(topLeft: QModelIndex, bottomRight: QModelIndex, roles: seq[cint]): void
...
proc QTableViewrowsInserted*(self: gen_qtableview_types.QTableView, parent: QModelIndex, start: cint, endVal: cint): void =
  fQTableView_virtualbase_rowsInserted(self.h, parent.h, start, endVal)

type QTableViewrowsInsertedProc* = proc(parent: QModelIndex, start: cint, endVal: cint): void
...
proc miqt_exec_callback_QTableView_rowsInserted(self: ptr cQTableView, slot: int, parent: pointer, start: cint, endVal: cint): void {.exportc: "miqt_exec_callback_QTableView_rowsInserted ".} =
  ...
  nimfunc[](slotval1, slotval2, slotval3)
proc QTableViewrowsAboutToBeRemoved*(self: gen_qtableview_types.QTableView, parent: QModelIndex, start: cint, endVal: cint): void =
  fQTableView_virtualbase_rowsAboutToBeRemoved(self.h, parent.h, start, endVal)

type QTableViewrowsAboutToBeRemovedProc* = proc(parent: QModelIndex, start: cint, endVal: cint): void
...
proc miqt_exec_callback_QTableView_horizontalScrollbarValueChanged(self: ptr cQTableView, slot: int, value: cint): void {.exportc: "miqt_exec_callback_QTableView_horizontalScrollbarValueChanged ".} =
  ...
  nimfunc[](slotval1)
proc QTableViewcloseEditor*(self: gen_qtableview_types.QTableView, editor: QWidget, hint: cint): void =
  fQTableView_virtualbase_closeEditor(self.h, editor.h, cint(hint))

type QTableViewcloseEditorProc* = proc(editor: QWidget, hint: cint): void
...
proc miqt_exec_callback_QTableView_closeEditor(self: ptr cQTableView, slot: int, editor: pointer, hint: cint): void {.exportc: "miqt_exec_callback_QTableView_closeEditor ".} =
  ...
  nimfunc[](slotval1, slotval2)
proc QTableViewcommitData*(self: gen_qtableview_types.QTableView, editor: QWidget): void =
  fQTableView_virtualbase_commitData(self.h, editor.h)

type QTableViewcommitDataProc* = proc(editor: QWidget): void
...
proc miqt_exec_callback_QTableView_commitData(self: ptr cQTableView, slot: int, editor: pointer): void {.exportc: "miqt_exec_callback_QTableView_commitData ".} =
  ...
  nimfunc[](slotval1)
proc QTableVieweditorDestroyed*(self: gen_qtableview_types.QTableView, editor: QObject): void =
  fQTableView_virtualbase_editorDestroyed(self.h, editor.h)

type QTableVieweditorDestroyedProc* = proc(editor: QObject): void
...
proc miqt_exec_callback_QTableView_editorDestroyed(self: ptr cQTableView, slot: int, editor: pointer): void {.exportc: "miqt_exec_callback_QTableView_editorDestroyed ".} =
  ...
  nimfunc[](slotval1)
proc QTableViewedit*(self: gen_qtableview_types.QTableView, index: QModelIndex, trigger: cint, event: QEvent): bool =
  fQTableView_virtualbase_edit2(self.h, index.h, cint(trigger), event.h)

type QTableViewedit2Proc* = proc(index: QModelIndex, trigger: cint, event: QEvent): bool
...
proc miqt_exec_callback_QTableView_edit2(self: ptr cQTableView, slot: int, index: pointer, trigger: cint, event: pointer): bool {.exportc: "miqt_exec_callback_QTableView_edit2 ".} =
  ...
  virtualReturn
proc QTableViewselectionCommand*(self: gen_qtableview_types.QTableView, index: QModelIndex, event: QEvent): cint =
  cint(fQTableView_virtualbase_selectionCommand(self.h, index.h, event.h))

type QTableViewselectionCommandProc* = proc(index: QModelIndex, event: QEvent): cint
...
proc miqt_exec_callback_QTableView_focusNextPrevChild(self: ptr cQTableView, slot: int, next: bool): bool {.exportc: "miqt_exec_callback_QTableView_focusNextPrevChild ".} =
  ...
  virtualReturn
proc QTableViewevent*(self: gen_qtableview_types.QTableView, event: QEvent): bool =
  fQTableView_virtualbase_event(self.h, event.h)

type QTableVieweventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QTableView_event(self: ptr cQTableView, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QTableView_event ".} =
  ...
  virtualReturn
proc QTableViewviewportEvent*(self: gen_qtableview_types.QTableView, event: QEvent): bool =
  fQTableView_virtualbase_viewportEvent(self.h, event.h)

type QTableViewviewportEventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QTableView_viewportEvent(self: ptr cQTableView, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QTableView_viewportEvent ".} =
  ...
  virtualReturn
proc QTableViewmousePressEvent*(self: gen_qtableview_types.QTableView, event: QMouseEvent): void =
  fQTableView_virtualbase_mousePressEvent(self.h, event.h)

type QTableViewmousePressEventProc* = proc(event: QMouseEvent): void
...
proc miqt_exec_callback_QTableView_mousePressEvent(self: ptr cQTableView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTableView_mousePressEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTableViewmouseMoveEvent*(self: gen_qtableview_types.QTableView, event: QMouseEvent): void =
  fQTableView_virtualbase_mouseMoveEvent(self.h, event.h)

type QTableViewmouseMoveEventProc* = proc(event: QMouseEvent): void
...
proc miqt_exec_callback_QTableView_mouseMoveEvent(self: ptr cQTableView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTableView_mouseMoveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTableViewmouseReleaseEvent*(self: gen_qtableview_types.QTableView, event: QMouseEvent): void =
  fQTableView_virtualbase_mouseReleaseEvent(self.h, event.h)

type QTableViewmouseReleaseEventProc* = proc(event: QMouseEvent): void
...
proc miqt_exec_callback_QTableView_mouseReleaseEvent(self: ptr cQTableView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTableView_mouseReleaseEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTableViewmouseDoubleClickEvent*(self: gen_qtableview_types.QTableView, event: QMouseEvent): void =
  fQTableView_virtualbase_mouseDoubleClickEvent(self.h, event.h)

type QTableViewmouseDoubleClickEventProc* = proc(event: QMouseEvent): void
...
proc miqt_exec_callback_QTableView_mouseDoubleClickEvent(self: ptr cQTableView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTableView_mouseDoubleClickEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTableViewdragEnterEvent*(self: gen_qtableview_types.QTableView, event: QDragEnterEvent): void =
  fQTableView_virtualbase_dragEnterEvent(self.h, event.h)

type QTableViewdragEnterEventProc* = proc(event: QDragEnterEvent): void
...
proc miqt_exec_callback_QTableView_dragEnterEvent(self: ptr cQTableView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTableView_dragEnterEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTableViewdragMoveEvent*(self: gen_qtableview_types.QTableView, event: QDragMoveEvent): void =
  fQTableView_virtualbase_dragMoveEvent(self.h, event.h)

type QTableViewdragMoveEventProc* = proc(event: QDragMoveEvent): void
...
proc miqt_exec_callback_QTableView_dragMoveEvent(self: ptr cQTableView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTableView_dragMoveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTableViewdragLeaveEvent*(self: gen_qtableview_types.QTableView, event: QDragLeaveEvent): void =
  fQTableView_virtualbase_dragLeaveEvent(self.h, event.h)

type QTableViewdragLeaveEventProc* = proc(event: QDragLeaveEvent): void
...
proc miqt_exec_callback_QTableView_dragLeaveEvent(self: ptr cQTableView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTableView_dragLeaveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTableViewdropEvent*(self: gen_qtableview_types.QTableView, event: QDropEvent): void =
  fQTableView_virtualbase_dropEvent(self.h, event.h)

type QTableViewdropEventProc* = proc(event: QDropEvent): void
...
proc miqt_exec_callback_QTableView_dropEvent(self: ptr cQTableView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTableView_dropEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTableViewfocusInEvent*(self: gen_qtableview_types.QTableView, event: QFocusEvent): void =
  fQTableView_virtualbase_focusInEvent(self.h, event.h)

type QTableViewfocusInEventProc* = proc(event: QFocusEvent): void
...
proc miqt_exec_callback_QTableView_focusInEvent(self: ptr cQTableView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTableView_focusInEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTableViewfocusOutEvent*(self: gen_qtableview_types.QTableView, event: QFocusEvent): void =
  fQTableView_virtualbase_focusOutEvent(self.h, event.h)

type QTableViewfocusOutEventProc* = proc(event: QFocusEvent): void
...
proc miqt_exec_callback_QTableView_focusOutEvent(self: ptr cQTableView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTableView_focusOutEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTableViewkeyPressEvent*(self: gen_qtableview_types.QTableView, event: QKeyEvent): void =
  fQTableView_virtualbase_keyPressEvent(self.h, event.h)

type QTableViewkeyPressEventProc* = proc(event: QKeyEvent): void
...
proc miqt_exec_callback_QTableView_keyPressEvent(self: ptr cQTableView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTableView_keyPressEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTableViewresizeEvent*(self: gen_qtableview_types.QTableView, event: QResizeEvent): void =
  fQTableView_virtualbase_resizeEvent(self.h, event.h)

type QTableViewresizeEventProc* = proc(event: QResizeEvent): void
...
proc miqt_exec_callback_QTableView_resizeEvent(self: ptr cQTableView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTableView_resizeEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTableViewinputMethodEvent*(self: gen_qtableview_types.QTableView, event: QInputMethodEvent): void =
  fQTableView_virtualbase_inputMethodEvent(self.h, event.h)

type QTableViewinputMethodEventProc* = proc(event: QInputMethodEvent): void
...
proc miqt_exec_callback_QTableView_inputMethodEvent(self: ptr cQTableView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTableView_inputMethodEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTableVieweventFilter*(self: gen_qtableview_types.QTableView, objectVal: QObject, event: QEvent): bool =
  fQTableView_virtualbase_eventFilter(self.h, objectVal.h, event.h)

type QTableVieweventFilterProc* = proc(objectVal: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QTableView_eventFilter(self: ptr cQTableView, slot: int, objectVal: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QTableView_eventFilter ".} =
  ...
  virtualReturn
proc QTableViewminimumSizeHint*(self: gen_qtableview_types.QTableView, ): QSize =
  QSize(h: fQTableView_virtualbase_minimumSizeHint(self.h))

type QTableViewminimumSizeHintProc* = proc(): QSize
...
proc miqt_exec_callback_QTableView_minimumSizeHint(self: ptr cQTableView, slot: int): pointer {.exportc: "miqt_exec_callback_QTableView_minimumSizeHint ".} =
  ...
  virtualReturn.h
proc QTableViewsizeHint*(self: gen_qtableview_types.QTableView, ): QSize =
  QSize(h: fQTableView_virtualbase_sizeHint(self.h))

type QTableViewsizeHintProc* = proc(): QSize
...
proc miqt_exec_callback_QTableView_sizeHint(self: ptr cQTableView, slot: int): pointer {.exportc: "miqt_exec_callback_QTableView_sizeHint ".} =
  ...
  virtualReturn.h
proc QTableViewsetupViewport*(self: gen_qtableview_types.QTableView, viewport: QWidget): void =
  fQTableView_virtualbase_setupViewport(self.h, viewport.h)

type QTableViewsetupViewportProc* = proc(viewport: QWidget): void
...
proc miqt_exec_callback_QTableView_setupViewport(self: ptr cQTableView, slot: int, viewport: pointer): void {.exportc: "miqt_exec_callback_QTableView_setupViewport ".} =
  ...
  nimfunc[](slotval1)
proc QTableViewwheelEvent*(self: gen_qtableview_types.QTableView, param1: QWheelEvent): void =
  fQTableView_virtualbase_wheelEvent(self.h, param1.h)

type QTableViewwheelEventProc* = proc(param1: QWheelEvent): void
...
proc miqt_exec_callback_QTableView_wheelEvent(self: ptr cQTableView, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QTableView_wheelEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTableViewcontextMenuEvent*(self: gen_qtableview_types.QTableView, param1: QContextMenuEvent): void =
  fQTableView_virtualbase_contextMenuEvent(self.h, param1.h)

type QTableViewcontextMenuEventProc* = proc(param1: QContextMenuEvent): void
...
proc miqt_exec_callback_QTableView_contextMenuEvent(self: ptr cQTableView, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QTableView_contextMenuEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTableViewchangeEvent*(self: gen_qtableview_types.QTableView, param1: QEvent): void =
  fQTableView_virtualbase_changeEvent(self.h, param1.h)

type QTableViewchangeEventProc* = proc(param1: QEvent): void
...
proc miqt_exec_callback_QTableView_changeEvent(self: ptr cQTableView, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QTableView_changeEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTableViewinitStyleOption*(self: gen_qtableview_types.QTableView, option: QStyleOptionFrame): void =
  fQTableView_virtualbase_initStyleOption(self.h, option.h)

type QTableViewinitStyleOptionProc* = proc(option: QStyleOptionFrame): void
...
proc miqt_exec_callback_QTableView_hasHeightForWidth(self: ptr cQTableView, slot: int): bool {.exportc: "miqt_exec_callback_QTableView_hasHeightForWidth ".} =
  ...
  virtualReturn
proc QTableViewpaintEngine*(self: gen_qtableview_types.QTableView, ): QPaintEngine =
  QPaintEngine(h: fQTableView_virtualbase_paintEngine(self.h))

type QTableViewpaintEngineProc* = proc(): QPaintEngine
...
proc miqt_exec_callback_QTableView_paintEngine(self: ptr cQTableView, slot: int): pointer {.exportc: "miqt_exec_callback_QTableView_paintEngine ".} =
  ...
  virtualReturn.h
proc QTableViewkeyReleaseEvent*(self: gen_qtableview_types.QTableView, event: QKeyEvent): void =
  fQTableView_virtualbase_keyReleaseEvent(self.h, event.h)

type QTableViewkeyReleaseEventProc* = proc(event: QKeyEvent): void
...
proc miqt_exec_callback_QTableView_keyReleaseEvent(self: ptr cQTableView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTableView_keyReleaseEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTableViewenterEvent*(self: gen_qtableview_types.QTableView, event: QEnterEvent): void =
  fQTableView_virtualbase_enterEvent(self.h, event.h)

type QTableViewenterEventProc* = proc(event: QEnterEvent): void
...
proc miqt_exec_callback_QTableView_enterEvent(self: ptr cQTableView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTableView_enterEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTableViewleaveEvent*(self: gen_qtableview_types.QTableView, event: QEvent): void =
  fQTableView_virtualbase_leaveEvent(self.h, event.h)

type QTableViewleaveEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QTableView_leaveEvent(self: ptr cQTableView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTableView_leaveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTableViewmoveEvent*(self: gen_qtableview_types.QTableView, event: QMoveEvent): void =
  fQTableView_virtualbase_moveEvent(self.h, event.h)

type QTableViewmoveEventProc* = proc(event: QMoveEvent): void
...
proc miqt_exec_callback_QTableView_moveEvent(self: ptr cQTableView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTableView_moveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTableViewcloseEvent*(self: gen_qtableview_types.QTableView, event: QCloseEvent): void =
  fQTableView_virtualbase_closeEvent(self.h, event.h)

type QTableViewcloseEventProc* = proc(event: QCloseEvent): void
...
proc miqt_exec_callback_QTableView_closeEvent(self: ptr cQTableView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTableView_closeEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTableViewtabletEvent*(self: gen_qtableview_types.QTableView, event: QTabletEvent): void =
  fQTableView_virtualbase_tabletEvent(self.h, event.h)

type QTableViewtabletEventProc* = proc(event: QTabletEvent): void
...
proc miqt_exec_callback_QTableView_tabletEvent(self: ptr cQTableView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTableView_tabletEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTableViewactionEvent*(self: gen_qtableview_types.QTableView, event: QActionEvent): void =
  fQTableView_virtualbase_actionEvent(self.h, event.h)

type QTableViewactionEventProc* = proc(event: QActionEvent): void
...
proc miqt_exec_callback_QTableView_actionEvent(self: ptr cQTableView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTableView_actionEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTableViewshowEvent*(self: gen_qtableview_types.QTableView, event: QShowEvent): void =
  fQTableView_virtualbase_showEvent(self.h, event.h)

type QTableViewshowEventProc* = proc(event: QShowEvent): void
...
proc miqt_exec_callback_QTableView_showEvent(self: ptr cQTableView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTableView_showEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTableViewhideEvent*(self: gen_qtableview_types.QTableView, event: QHideEvent): void =
  fQTableView_virtualbase_hideEvent(self.h, event.h)

type QTableViewhideEventProc* = proc(event: QHideEvent): void
...
proc miqt_exec_callback_QTableView_metric(self: ptr cQTableView, slot: int, param1: cint): cint {.exportc: "miqt_exec_callback_QTableView_metric ".} =
  ...
  virtualReturn
proc QTableViewinitPainter*(self: gen_qtableview_types.QTableView, painter: QPainter): void =
  fQTableView_virtualbase_initPainter(self.h, painter.h)

type QTableViewinitPainterProc* = proc(painter: QPainter): void
...
proc miqt_exec_callback_QTableView_initPainter(self: ptr cQTableView, slot: int, painter: pointer): void {.exportc: "miqt_exec_callback_QTableView_initPainter ".} =
  ...
  nimfunc[](slotval1)
proc QTableViewredirected*(self: gen_qtableview_types.QTableView, offset: QPoint): QPaintDevice =
  QPaintDevice(h: fQTableView_virtualbase_redirected(self.h, offset.h))

type QTableViewredirectedProc* = proc(offset: QPoint): QPaintDevice
...
proc miqt_exec_callback_QTableView_redirected(self: ptr cQTableView, slot: int, offset: pointer): pointer {.exportc: "miqt_exec_callback_QTableView_redirected ".} =
  ...
  virtualReturn.h
proc QTableViewsharedPainter*(self: gen_qtableview_types.QTableView, ): QPainter =
  QPainter(h: fQTableView_virtualbase_sharedPainter(self.h))

type QTableViewsharedPainterProc* = proc(): QPainter
...
proc miqt_exec_callback_QTableView_sharedPainter(self: ptr cQTableView, slot: int): pointer {.exportc: "miqt_exec_callback_QTableView_sharedPainter ".} =
  ...
  virtualReturn.h
proc QTableViewchildEvent*(self: gen_qtableview_types.QTableView, event: QChildEvent): void =
  fQTableView_virtualbase_childEvent(self.h, event.h)

type QTableViewchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QTableView_childEvent(self: ptr cQTableView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTableView_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTableViewcustomEvent*(self: gen_qtableview_types.QTableView, event: QEvent): void =
  fQTableView_virtualbase_customEvent(self.h, event.h)

type QTableViewcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QTableView_customEvent(self: ptr cQTableView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTableView_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTableViewconnectNotify*(self: gen_qtableview_types.QTableView, signal: QMetaMethod): void =
  fQTableView_virtualbase_connectNotify(self.h, signal.h)

type QTableViewconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QTableView_connectNotify(self: ptr cQTableView, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QTableView_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QTableViewdisconnectNotify*(self: gen_qtableview_types.QTableView, signal: QMetaMethod): void =
  fQTableView_virtualbase_disconnectNotify(self.h, signal.h)

type QTableViewdisconnectNotifyProc* = proc(signal: QMetaMethod): void
