...
QMetaObject* QLayout_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQLayout*)(self) )->QLayout::metaObject();

}

void* QLayout_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQLayout*)(self) )->QLayout::qt_metacast(param1);

}

int QLayout_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQLayout*)(self) )->QLayout::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
QWidget* QLayout_virtualbase_widget(void* self) {
	...
	return ( (MiqtVirtualQLayout*)(self) )->QLayout::widget();
...
void QLayout_protectedbase_widgetEvent(void* self, QEvent* param1) {
	MiqtVirtualQLayout* self_cast = static_cast<MiqtVirtualQLayout*>( (QLayout*)(self) );
