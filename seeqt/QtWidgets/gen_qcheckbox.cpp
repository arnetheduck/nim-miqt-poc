...
void QCheckBox_connect_stateChanged(QCheckBox* self, intptr_t slot, void (*callback)(intptr_t, int), void (*release)(intptr_t)) {
	...
	MiqtVirtualQCheckBox::connect(self, static_cast<void (QCheckBox::*)(int)>(&QCheckBox::stateChanged), self, caller{slot, callback, release});
}
...
QMetaObject* QCheckBox_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQCheckBox*)(self) )->QCheckBox::metaObject();

}

void* QCheckBox_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQCheckBox*)(self) )->QCheckBox::qt_metacast(param1);

}

int QCheckBox_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQCheckBox*)(self) )->QCheckBox::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
bool QCheckBox_virtualbase_nativeEvent(void* self, struct miqt_string eventType, void* message, long* result) {
	...
	return ( (MiqtVirtualQCheckBox*)(self) )->QCheckBox::nativeEvent(eventType_QByteArray, message, static_cast<long*>(result));
...
void QCheckBox_protectedbase_initStyleOption(const void* self, QStyleOptionButton* option) {
	MiqtVirtualQCheckBox* self_cast = static_cast<MiqtVirtualQCheckBox*>( (QCheckBox*)(self) );
