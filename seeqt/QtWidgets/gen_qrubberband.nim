...
proc fQRubberBand_virtualbase_initStyleOption(self: pointer, option: pointer): void{.importc: "QRubberBand_virtualbase_initStyleOption".}
proc fcQRubberBand_override_virtual_initStyleOption(self: pointer, slot: int) {.importc: "QRubberBand_override_virtual_initStyleOption".}
...
proc fQRubberBand_virtualbase_nativeEvent(self: pointer, eventType: struct_miqt_string, message: pointer, resultVal: ptr uint): bool{.importc: "QRubberBand_virtualbase_nativeEvent".}
...
proc create*(T: type gen_qrubberband_types.QRubberBand, param1: cint, param2: QWidget): gen_qrubberband_types.QRubberBand =
  gen_qrubberband_types.QRubberBand.init(fcQRubberBand_new2(cint(param1), param2.h))

proc metaObject*(self: gen_qrubberband_types.QRubberBand, ): QMetaObject =
  QMetaObject(h: fcQRubberBand_metaObject(self.h))
...
proc setGeometry*(self: gen_qrubberband_types.QRubberBand, r: QRect): void =
...
proc move*(self: gen_qrubberband_types.QRubberBand, p: QPoint): void =
...
proc resize*(self: gen_qrubberband_types.QRubberBand, s: QSize): void =
...
proc miqt_exec_callback_QRubberBand_metacall(self: ptr cQRubberBand, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QRubberBand_metacall ".} =
  ...
  virtualReturn
proc QRubberBandevent*(self: gen_qrubberband_types.QRubberBand, e: QEvent): bool =
  fQRubberBand_virtualbase_event(self.h, e.h)

type QRubberBandeventProc* = proc(e: QEvent): bool
...
proc miqt_exec_callback_QRubberBand_event(self: ptr cQRubberBand, slot: int, e: pointer): bool {.exportc: "miqt_exec_callback_QRubberBand_event ".} =
  ...
  virtualReturn
proc QRubberBandpaintEvent*(self: gen_qrubberband_types.QRubberBand, param1: QPaintEvent): void =
  fQRubberBand_virtualbase_paintEvent(self.h, param1.h)

type QRubberBandpaintEventProc* = proc(param1: QPaintEvent): void
...
proc miqt_exec_callback_QRubberBand_paintEvent(self: ptr cQRubberBand, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QRubberBand_paintEvent ".} =
  ...
  nimfunc[](slotval1)
proc QRubberBandchangeEvent*(self: gen_qrubberband_types.QRubberBand, param1: QEvent): void =
  fQRubberBand_virtualbase_changeEvent(self.h, param1.h)

type QRubberBandchangeEventProc* = proc(param1: QEvent): void
...
proc miqt_exec_callback_QRubberBand_changeEvent(self: ptr cQRubberBand, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QRubberBand_changeEvent ".} =
  ...
  nimfunc[](slotval1)
proc QRubberBandshowEvent*(self: gen_qrubberband_types.QRubberBand, param1: QShowEvent): void =
  fQRubberBand_virtualbase_showEvent(self.h, param1.h)

type QRubberBandshowEventProc* = proc(param1: QShowEvent): void
...
proc miqt_exec_callback_QRubberBand_showEvent(self: ptr cQRubberBand, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QRubberBand_showEvent ".} =
  ...
  nimfunc[](slotval1)
proc QRubberBandresizeEvent*(self: gen_qrubberband_types.QRubberBand, param1: QResizeEvent): void =
  fQRubberBand_virtualbase_resizeEvent(self.h, param1.h)

type QRubberBandresizeEventProc* = proc(param1: QResizeEvent): void
...
proc miqt_exec_callback_QRubberBand_resizeEvent(self: ptr cQRubberBand, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QRubberBand_resizeEvent ".} =
  ...
  nimfunc[](slotval1)
proc QRubberBandmoveEvent*(self: gen_qrubberband_types.QRubberBand, param1: QMoveEvent): void =
  fQRubberBand_virtualbase_moveEvent(self.h, param1.h)

type QRubberBandmoveEventProc* = proc(param1: QMoveEvent): void
...
proc miqt_exec_callback_QRubberBand_moveEvent(self: ptr cQRubberBand, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QRubberBand_moveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QRubberBandinitStyleOption*(self: gen_qrubberband_types.QRubberBand, option: QStyleOptionRubberBand): void =
  fQRubberBand_virtualbase_initStyleOption(self.h, option.h)

type QRubberBandinitStyleOptionProc* = proc(option: QStyleOptionRubberBand): void
proc oninitStyleOption*(self: gen_qrubberband_types.QRubberBand, slot: QRubberBandinitStyleOptionProc) =
  # TODO check subclass
  var tmp = new QRubberBandinitStyleOptionProc
  tmp[] = slot
  GC_ref(tmp)
  fcQRubberBand_override_virtual_initStyleOption(self.h, cast[int](addr tmp[]))

proc miqt_exec_callback_QRubberBand_initStyleOption(self: ptr cQRubberBand, slot: int, option: pointer): void {.exportc: "miqt_exec_callback_QRubberBand_initStyleOption ".} =
  var nimfunc = cast[ptr QRubberBandinitStyleOptionProc](cast[pointer](slot))
  let slotval1 = QStyleOptionRubberBand(h: option)
...
proc miqt_exec_callback_QRubberBand_setVisible(self: ptr cQRubberBand, slot: int, visible: bool): void {.exportc: "miqt_exec_callback_QRubberBand_setVisible ".} =
  ...
  nimfunc[](slotval1)
proc QRubberBandsizeHint*(self: gen_qrubberband_types.QRubberBand, ): QSize =
  QSize(h: fQRubberBand_virtualbase_sizeHint(self.h))

type QRubberBandsizeHintProc* = proc(): QSize
...
proc miqt_exec_callback_QRubberBand_sizeHint(self: ptr cQRubberBand, slot: int): pointer {.exportc: "miqt_exec_callback_QRubberBand_sizeHint ".} =
  ...
  virtualReturn.h
proc QRubberBandminimumSizeHint*(self: gen_qrubberband_types.QRubberBand, ): QSize =
  QSize(h: fQRubberBand_virtualbase_minimumSizeHint(self.h))

type QRubberBandminimumSizeHintProc* = proc(): QSize
...
proc miqt_exec_callback_QRubberBand_hasHeightForWidth(self: ptr cQRubberBand, slot: int): bool {.exportc: "miqt_exec_callback_QRubberBand_hasHeightForWidth ".} =
  ...
  virtualReturn
proc QRubberBandpaintEngine*(self: gen_qrubberband_types.QRubberBand, ): QPaintEngine =
  QPaintEngine(h: fQRubberBand_virtualbase_paintEngine(self.h))

type QRubberBandpaintEngineProc* = proc(): QPaintEngine
...
proc miqt_exec_callback_QRubberBand_paintEngine(self: ptr cQRubberBand, slot: int): pointer {.exportc: "miqt_exec_callback_QRubberBand_paintEngine ".} =
  ...
  virtualReturn.h
proc QRubberBandmousePressEvent*(self: gen_qrubberband_types.QRubberBand, event: QMouseEvent): void =
  fQRubberBand_virtualbase_mousePressEvent(self.h, event.h)

type QRubberBandmousePressEventProc* = proc(event: QMouseEvent): void
...
proc miqt_exec_callback_QRubberBand_mousePressEvent(self: ptr cQRubberBand, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QRubberBand_mousePressEvent ".} =
  ...
  nimfunc[](slotval1)
proc QRubberBandmouseReleaseEvent*(self: gen_qrubberband_types.QRubberBand, event: QMouseEvent): void =
  fQRubberBand_virtualbase_mouseReleaseEvent(self.h, event.h)

type QRubberBandmouseReleaseEventProc* = proc(event: QMouseEvent): void
...
proc miqt_exec_callback_QRubberBand_mouseReleaseEvent(self: ptr cQRubberBand, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QRubberBand_mouseReleaseEvent ".} =
  ...
  nimfunc[](slotval1)
proc QRubberBandmouseDoubleClickEvent*(self: gen_qrubberband_types.QRubberBand, event: QMouseEvent): void =
  fQRubberBand_virtualbase_mouseDoubleClickEvent(self.h, event.h)

type QRubberBandmouseDoubleClickEventProc* = proc(event: QMouseEvent): void
...
proc miqt_exec_callback_QRubberBand_mouseDoubleClickEvent(self: ptr cQRubberBand, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QRubberBand_mouseDoubleClickEvent ".} =
  ...
  nimfunc[](slotval1)
proc QRubberBandmouseMoveEvent*(self: gen_qrubberband_types.QRubberBand, event: QMouseEvent): void =
  fQRubberBand_virtualbase_mouseMoveEvent(self.h, event.h)

type QRubberBandmouseMoveEventProc* = proc(event: QMouseEvent): void
...
proc miqt_exec_callback_QRubberBand_mouseMoveEvent(self: ptr cQRubberBand, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QRubberBand_mouseMoveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QRubberBandwheelEvent*(self: gen_qrubberband_types.QRubberBand, event: QWheelEvent): void =
  fQRubberBand_virtualbase_wheelEvent(self.h, event.h)

type QRubberBandwheelEventProc* = proc(event: QWheelEvent): void
...
proc miqt_exec_callback_QRubberBand_wheelEvent(self: ptr cQRubberBand, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QRubberBand_wheelEvent ".} =
  ...
  nimfunc[](slotval1)
proc QRubberBandkeyPressEvent*(self: gen_qrubberband_types.QRubberBand, event: QKeyEvent): void =
  fQRubberBand_virtualbase_keyPressEvent(self.h, event.h)

type QRubberBandkeyPressEventProc* = proc(event: QKeyEvent): void
...
proc miqt_exec_callback_QRubberBand_keyPressEvent(self: ptr cQRubberBand, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QRubberBand_keyPressEvent ".} =
  ...
  nimfunc[](slotval1)
proc QRubberBandkeyReleaseEvent*(self: gen_qrubberband_types.QRubberBand, event: QKeyEvent): void =
  fQRubberBand_virtualbase_keyReleaseEvent(self.h, event.h)

type QRubberBandkeyReleaseEventProc* = proc(event: QKeyEvent): void
...
proc miqt_exec_callback_QRubberBand_keyReleaseEvent(self: ptr cQRubberBand, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QRubberBand_keyReleaseEvent ".} =
  ...
  nimfunc[](slotval1)
proc QRubberBandfocusInEvent*(self: gen_qrubberband_types.QRubberBand, event: QFocusEvent): void =
  fQRubberBand_virtualbase_focusInEvent(self.h, event.h)

type QRubberBandfocusInEventProc* = proc(event: QFocusEvent): void
...
proc miqt_exec_callback_QRubberBand_focusInEvent(self: ptr cQRubberBand, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QRubberBand_focusInEvent ".} =
  ...
  nimfunc[](slotval1)
proc QRubberBandfocusOutEvent*(self: gen_qrubberband_types.QRubberBand, event: QFocusEvent): void =
  fQRubberBand_virtualbase_focusOutEvent(self.h, event.h)

type QRubberBandfocusOutEventProc* = proc(event: QFocusEvent): void
...
proc miqt_exec_callback_QRubberBand_focusOutEvent(self: ptr cQRubberBand, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QRubberBand_focusOutEvent ".} =
  ...
  nimfunc[](slotval1)
proc QRubberBandenterEvent*(self: gen_qrubberband_types.QRubberBand, event: QEnterEvent): void =
  fQRubberBand_virtualbase_enterEvent(self.h, event.h)

type QRubberBandenterEventProc* = proc(event: QEnterEvent): void
...
proc miqt_exec_callback_QRubberBand_enterEvent(self: ptr cQRubberBand, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QRubberBand_enterEvent ".} =
  ...
  nimfunc[](slotval1)
proc QRubberBandleaveEvent*(self: gen_qrubberband_types.QRubberBand, event: QEvent): void =
  fQRubberBand_virtualbase_leaveEvent(self.h, event.h)

type QRubberBandleaveEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QRubberBand_leaveEvent(self: ptr cQRubberBand, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QRubberBand_leaveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QRubberBandcloseEvent*(self: gen_qrubberband_types.QRubberBand, event: QCloseEvent): void =
  fQRubberBand_virtualbase_closeEvent(self.h, event.h)

type QRubberBandcloseEventProc* = proc(event: QCloseEvent): void
...
proc miqt_exec_callback_QRubberBand_closeEvent(self: ptr cQRubberBand, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QRubberBand_closeEvent ".} =
  ...
  nimfunc[](slotval1)
proc QRubberBandcontextMenuEvent*(self: gen_qrubberband_types.QRubberBand, event: QContextMenuEvent): void =
  fQRubberBand_virtualbase_contextMenuEvent(self.h, event.h)

type QRubberBandcontextMenuEventProc* = proc(event: QContextMenuEvent): void
...
proc miqt_exec_callback_QRubberBand_contextMenuEvent(self: ptr cQRubberBand, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QRubberBand_contextMenuEvent ".} =
  ...
  nimfunc[](slotval1)
proc QRubberBandtabletEvent*(self: gen_qrubberband_types.QRubberBand, event: QTabletEvent): void =
  fQRubberBand_virtualbase_tabletEvent(self.h, event.h)

type QRubberBandtabletEventProc* = proc(event: QTabletEvent): void
...
proc miqt_exec_callback_QRubberBand_tabletEvent(self: ptr cQRubberBand, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QRubberBand_tabletEvent ".} =
  ...
  nimfunc[](slotval1)
proc QRubberBandactionEvent*(self: gen_qrubberband_types.QRubberBand, event: QActionEvent): void =
  fQRubberBand_virtualbase_actionEvent(self.h, event.h)

type QRubberBandactionEventProc* = proc(event: QActionEvent): void
...
proc miqt_exec_callback_QRubberBand_actionEvent(self: ptr cQRubberBand, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QRubberBand_actionEvent ".} =
  ...
  nimfunc[](slotval1)
proc QRubberBanddragEnterEvent*(self: gen_qrubberband_types.QRubberBand, event: QDragEnterEvent): void =
  fQRubberBand_virtualbase_dragEnterEvent(self.h, event.h)

type QRubberBanddragEnterEventProc* = proc(event: QDragEnterEvent): void
...
proc miqt_exec_callback_QRubberBand_dragEnterEvent(self: ptr cQRubberBand, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QRubberBand_dragEnterEvent ".} =
  ...
  nimfunc[](slotval1)
proc QRubberBanddragMoveEvent*(self: gen_qrubberband_types.QRubberBand, event: QDragMoveEvent): void =
  fQRubberBand_virtualbase_dragMoveEvent(self.h, event.h)

type QRubberBanddragMoveEventProc* = proc(event: QDragMoveEvent): void
...
proc miqt_exec_callback_QRubberBand_dragMoveEvent(self: ptr cQRubberBand, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QRubberBand_dragMoveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QRubberBanddragLeaveEvent*(self: gen_qrubberband_types.QRubberBand, event: QDragLeaveEvent): void =
  fQRubberBand_virtualbase_dragLeaveEvent(self.h, event.h)

type QRubberBanddragLeaveEventProc* = proc(event: QDragLeaveEvent): void
...
proc miqt_exec_callback_QRubberBand_dragLeaveEvent(self: ptr cQRubberBand, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QRubberBand_dragLeaveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QRubberBanddropEvent*(self: gen_qrubberband_types.QRubberBand, event: QDropEvent): void =
  fQRubberBand_virtualbase_dropEvent(self.h, event.h)

type QRubberBanddropEventProc* = proc(event: QDropEvent): void
...
proc miqt_exec_callback_QRubberBand_dropEvent(self: ptr cQRubberBand, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QRubberBand_dropEvent ".} =
  ...
  nimfunc[](slotval1)
proc QRubberBandhideEvent*(self: gen_qrubberband_types.QRubberBand, event: QHideEvent): void =
  fQRubberBand_virtualbase_hideEvent(self.h, event.h)

type QRubberBandhideEventProc* = proc(event: QHideEvent): void
...
proc miqt_exec_callback_QRubberBand_nativeEvent(self: ptr cQRubberBand, slot: int, eventType: struct_miqt_string, message: pointer, resultVal: ptr uint): bool {.exportc: "miqt_exec_callback_QRubberBand_nativeEvent ".} =
...
proc miqt_exec_callback_QRubberBand_metric(self: ptr cQRubberBand, slot: int, param1: cint): cint {.exportc: "miqt_exec_callback_QRubberBand_metric ".} =
  ...
  virtualReturn
proc QRubberBandinitPainter*(self: gen_qrubberband_types.QRubberBand, painter: QPainter): void =
  fQRubberBand_virtualbase_initPainter(self.h, painter.h)

type QRubberBandinitPainterProc* = proc(painter: QPainter): void
...
proc miqt_exec_callback_QRubberBand_initPainter(self: ptr cQRubberBand, slot: int, painter: pointer): void {.exportc: "miqt_exec_callback_QRubberBand_initPainter ".} =
  ...
  nimfunc[](slotval1)
proc QRubberBandredirected*(self: gen_qrubberband_types.QRubberBand, offset: QPoint): QPaintDevice =
  QPaintDevice(h: fQRubberBand_virtualbase_redirected(self.h, offset.h))

type QRubberBandredirectedProc* = proc(offset: QPoint): QPaintDevice
...
proc miqt_exec_callback_QRubberBand_redirected(self: ptr cQRubberBand, slot: int, offset: pointer): pointer {.exportc: "miqt_exec_callback_QRubberBand_redirected ".} =
  ...
  virtualReturn.h
proc QRubberBandsharedPainter*(self: gen_qrubberband_types.QRubberBand, ): QPainter =
  QPainter(h: fQRubberBand_virtualbase_sharedPainter(self.h))

type QRubberBandsharedPainterProc* = proc(): QPainter
...
proc miqt_exec_callback_QRubberBand_sharedPainter(self: ptr cQRubberBand, slot: int): pointer {.exportc: "miqt_exec_callback_QRubberBand_sharedPainter ".} =
  ...
  virtualReturn.h
proc QRubberBandinputMethodEvent*(self: gen_qrubberband_types.QRubberBand, param1: QInputMethodEvent): void =
  fQRubberBand_virtualbase_inputMethodEvent(self.h, param1.h)

type QRubberBandinputMethodEventProc* = proc(param1: QInputMethodEvent): void
...
proc miqt_exec_callback_QRubberBand_inputMethodEvent(self: ptr cQRubberBand, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QRubberBand_inputMethodEvent ".} =
  ...
  nimfunc[](slotval1)
proc QRubberBandinputMethodQuery*(self: gen_qrubberband_types.QRubberBand, param1: cint): QVariant =
  QVariant(h: fQRubberBand_virtualbase_inputMethodQuery(self.h, cint(param1)))

type QRubberBandinputMethodQueryProc* = proc(param1: cint): QVariant
...
proc miqt_exec_callback_QRubberBand_focusNextPrevChild(self: ptr cQRubberBand, slot: int, next: bool): bool {.exportc: "miqt_exec_callback_QRubberBand_focusNextPrevChild ".} =
  ...
  virtualReturn
proc QRubberBandeventFilter*(self: gen_qrubberband_types.QRubberBand, watched: QObject, event: QEvent): bool =
  fQRubberBand_virtualbase_eventFilter(self.h, watched.h, event.h)

type QRubberBandeventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QRubberBand_eventFilter(self: ptr cQRubberBand, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QRubberBand_eventFilter ".} =
  ...
  virtualReturn
proc QRubberBandtimerEvent*(self: gen_qrubberband_types.QRubberBand, event: QTimerEvent): void =
  fQRubberBand_virtualbase_timerEvent(self.h, event.h)

type QRubberBandtimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QRubberBand_timerEvent(self: ptr cQRubberBand, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QRubberBand_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QRubberBandchildEvent*(self: gen_qrubberband_types.QRubberBand, event: QChildEvent): void =
  fQRubberBand_virtualbase_childEvent(self.h, event.h)

type QRubberBandchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QRubberBand_childEvent(self: ptr cQRubberBand, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QRubberBand_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QRubberBandcustomEvent*(self: gen_qrubberband_types.QRubberBand, event: QEvent): void =
  fQRubberBand_virtualbase_customEvent(self.h, event.h)

type QRubberBandcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QRubberBand_customEvent(self: ptr cQRubberBand, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QRubberBand_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QRubberBandconnectNotify*(self: gen_qrubberband_types.QRubberBand, signal: QMetaMethod): void =
  fQRubberBand_virtualbase_connectNotify(self.h, signal.h)

type QRubberBandconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QRubberBand_connectNotify(self: ptr cQRubberBand, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QRubberBand_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QRubberBanddisconnectNotify*(self: gen_qrubberband_types.QRubberBand, signal: QMetaMethod): void =
  fQRubberBand_virtualbase_disconnectNotify(self.h, signal.h)

type QRubberBanddisconnectNotifyProc* = proc(signal: QMetaMethod): void
