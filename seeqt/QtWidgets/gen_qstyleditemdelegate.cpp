...
QMetaObject* QStyledItemDelegate_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQStyledItemDelegate*)(self) )->QStyledItemDelegate::metaObject();

}

void* QStyledItemDelegate_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQStyledItemDelegate*)(self) )->QStyledItemDelegate::qt_metacast(param1);

}

int QStyledItemDelegate_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQStyledItemDelegate*)(self) )->QStyledItemDelegate::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
struct miqt_array /* of int */  QStyledItemDelegate_virtualbase_paintingRoles(const void* self) {
	...
	QList<int> _ret = ( (const MiqtVirtualQStyledItemDelegate*)(self) )->QStyledItemDelegate::paintingRoles();
