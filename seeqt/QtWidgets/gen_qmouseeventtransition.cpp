...
QMetaObject* QMouseEventTransition_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQMouseEventTransition*)(self) )->QMouseEventTransition::metaObject();

}

void* QMouseEventTransition_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQMouseEventTransition*)(self) )->QMouseEventTransition::qt_metacast(param1);

}

int QMouseEventTransition_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQMouseEventTransition*)(self) )->QMouseEventTransition::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
