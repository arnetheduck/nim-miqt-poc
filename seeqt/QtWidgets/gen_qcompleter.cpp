...
QMetaObject* QCompleter_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQCompleter*)(self) )->QCompleter::metaObject();

}

void* QCompleter_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQCompleter*)(self) )->QCompleter::qt_metacast(param1);

}

int QCompleter_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQCompleter*)(self) )->QCompleter::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
