...
proc fQMessageBox_virtualbase_nativeEvent(self: pointer, eventType: struct_miqt_string, message: pointer, resultVal: ptr clong): bool{.importc: "QMessageBox_virtualbase_nativeEvent".}
...
func init*(T: type gen_qmessagebox_types.QMessageBox, h: ptr cQMessageBox): gen_qmessagebox_types.QMessageBox =
  T(h: h)
proc create*(T: type gen_qmessagebox_types.QMessageBox, parent: QWidget): gen_qmessagebox_types.QMessageBox =
...
proc create*(T: type gen_qmessagebox_types.QMessageBox, icon: cint, title: string, text: string, buttons: cint, parent: QWidget): gen_qmessagebox_types.QMessageBox =
...
proc create*(T: type gen_qmessagebox_types.QMessageBox, icon: cint, title: string, text: string, buttons: cint, parent: QWidget, flags: cint): gen_qmessagebox_types.QMessageBox =
...
proc create*(T: type gen_qmessagebox_types.QMessageBox, title: string, text: string, icon: cint, button0: cint, button1: cint, button2: cint, parent: QWidget): gen_qmessagebox_types.QMessageBox =
...
proc create*(T: type gen_qmessagebox_types.QMessageBox, title: string, text: string, icon: cint, button0: cint, button1: cint, button2: cint, parent: QWidget, f: cint): gen_qmessagebox_types.QMessageBox =
...
proc metaObject*(self: gen_qmessagebox_types.QMessageBox, ): QMetaObject =
  QMetaObject(h: fcQMessageBox_metaObject(self.h))
...
proc addButton*(self: gen_qmessagebox_types.QMessageBox, button: QAbstractButton, role: cint): void =
  fcQMessageBox_addButton(self.h, button.h, cint(role))

proc addButton*(self: gen_qmessagebox_types.QMessageBox, text: string, role: cint): QPushButton =
  QPushButton(h: fcQMessageBox_addButton2(self.h, struct_miqt_string(data: text, len: csize_t(len(text))), cint(role)))

proc addButton*(self: gen_qmessagebox_types.QMessageBox, button: cint): QPushButton =
  QPushButton(h: fcQMessageBox_addButtonWithButton(self.h, cint(button)))

proc removeButton*(self: gen_qmessagebox_types.QMessageBox, button: QAbstractButton): void =
  fcQMessageBox_removeButton(self.h, button.h)

proc buttons*(self: gen_qmessagebox_types.QMessageBox, ): seq[QAbstractButton] =
  var v_ma = fcQMessageBox_buttons(self.h)
  var vx_ret = newSeq[QAbstractButton](int(v_ma.len))
  let v_outCast = cast[ptr UncheckedArray[pointer]](v_ma.data)
  for i in 0 ..< v_ma.len:
    vx_ret[i] = QAbstractButton(h: v_outCast[i])
  vx_ret

proc buttonRole*(self: gen_qmessagebox_types.QMessageBox, button: QAbstractButton): cint =
...
proc standardButton*(self: gen_qmessagebox_types.QMessageBox, button: QAbstractButton): cint =
  cint(fcQMessageBox_standardButton(self.h, button.h))

proc button*(self: gen_qmessagebox_types.QMessageBox, which: cint): QAbstractButton =
  QAbstractButton(h: fcQMessageBox_button(self.h, cint(which)))

proc defaultButton*(self: gen_qmessagebox_types.QMessageBox, ): QPushButton =
  QPushButton(h: fcQMessageBox_defaultButton(self.h))

proc setDefaultButton*(self: gen_qmessagebox_types.QMessageBox, button: QPushButton): void =
...
proc escapeButton*(self: gen_qmessagebox_types.QMessageBox, ): QAbstractButton =
  QAbstractButton(h: fcQMessageBox_escapeButton(self.h))

proc setEscapeButton*(self: gen_qmessagebox_types.QMessageBox, button: QAbstractButton): void =
...
proc clickedButton*(self: gen_qmessagebox_types.QMessageBox, ): QAbstractButton =
  QAbstractButton(h: fcQMessageBox_clickedButton(self.h))
...
proc iconPixmap*(self: gen_qmessagebox_types.QMessageBox, ): QPixmap =
  QPixmap(h: fcQMessageBox_iconPixmap(self.h))

proc setIconPixmap*(self: gen_qmessagebox_types.QMessageBox, pixmap: QPixmap): void =
...
proc setCheckBox*(self: gen_qmessagebox_types.QMessageBox, cb: QCheckBox): void =
  fcQMessageBox_setCheckBox(self.h, cb.h)

proc checkBox*(self: gen_qmessagebox_types.QMessageBox, ): QCheckBox =
  QCheckBox(h: fcQMessageBox_checkBox(self.h))

proc information*(_: type gen_qmessagebox_types.QMessageBox, parent: QWidget, title: string, text: string): cint =
...
proc question*(_: type gen_qmessagebox_types.QMessageBox, parent: QWidget, title: string, text: string): cint =
...
proc warning*(_: type gen_qmessagebox_types.QMessageBox, parent: QWidget, title: string, text: string): cint =
...
proc critical*(_: type gen_qmessagebox_types.QMessageBox, parent: QWidget, title: string, text: string): cint =
...
proc about*(_: type gen_qmessagebox_types.QMessageBox, parent: QWidget, title: string, text: string): void =
...
proc aboutQt*(_: type gen_qmessagebox_types.QMessageBox, parent: QWidget): void =
  fcQMessageBox_aboutQt(parent.h)

proc information*(_: type gen_qmessagebox_types.QMessageBox, parent: QWidget, title: string, text: string, button0: cint): cint =
...
proc information*(_: type gen_qmessagebox_types.QMessageBox, parent: QWidget, title: string, text: string, button0Text: string): cint =
...
proc information2*(_: type gen_qmessagebox_types.QMessageBox, parent: QWidget, title: string, text: string, button0: cint): cint =
...
proc question*(_: type gen_qmessagebox_types.QMessageBox, parent: QWidget, title: string, text: string, button0: cint): cint =
...
proc question*(_: type gen_qmessagebox_types.QMessageBox, parent: QWidget, title: string, text: string, button0Text: string): cint =
...
proc question*(_: type gen_qmessagebox_types.QMessageBox, parent: QWidget, title: string, text: string, button0: cint, button1: cint): cint =
...
proc warning*(_: type gen_qmessagebox_types.QMessageBox, parent: QWidget, title: string, text: string, button0: cint, button1: cint): cint =
...
proc warning*(_: type gen_qmessagebox_types.QMessageBox, parent: QWidget, title: string, text: string, button0Text: string): cint =
...
proc warning2*(_: type gen_qmessagebox_types.QMessageBox, parent: QWidget, title: string, text: string, button0: cint, button1: cint): cint =
...
proc critical*(_: type gen_qmessagebox_types.QMessageBox, parent: QWidget, title: string, text: string, button0: cint, button1: cint): cint =
...
proc critical*(_: type gen_qmessagebox_types.QMessageBox, parent: QWidget, title: string, text: string, button0Text: string): cint =
...
proc critical2*(_: type gen_qmessagebox_types.QMessageBox, parent: QWidget, title: string, text: string, button0: cint, button1: cint): cint =
...
proc standardIcon*(_: type gen_qmessagebox_types.QMessageBox, icon: cint): QPixmap =
  QPixmap(h: fcQMessageBox_standardIcon(cint(icon)))

proc buttonClicked*(self: gen_qmessagebox_types.QMessageBox, button: QAbstractButton): void =
  fcQMessageBox_buttonClicked(self.h, button.h)

type QMessageBoxbuttonClickedSlot* = proc(button: QAbstractButton)
proc miqt_exec_callback_QMessageBox_buttonClicked(slot: int, button: pointer) {.exportc.} =
  ...
  let slotval1 = QAbstractButton(h: button)
...
proc information3*(_: type gen_qmessagebox_types.QMessageBox, parent: QWidget, title: string, text: string, buttons: cint): cint =
...
proc information*(_: type gen_qmessagebox_types.QMessageBox, parent: QWidget, title: string, text: string, buttons: cint, defaultButton: cint): cint =
...
proc question2*(_: type gen_qmessagebox_types.QMessageBox, parent: QWidget, title: string, text: string, buttons: cint): cint =
...
proc question2*(_: type gen_qmessagebox_types.QMessageBox, parent: QWidget, title: string, text: string, buttons: cint, defaultButton: cint): cint =
...
proc warning*(_: type gen_qmessagebox_types.QMessageBox, parent: QWidget, title: string, text: string, buttons: cint): cint =
...
proc warning3*(_: type gen_qmessagebox_types.QMessageBox, parent: QWidget, title: string, text: string, buttons: cint, defaultButton: cint): cint =
...
proc critical*(_: type gen_qmessagebox_types.QMessageBox, parent: QWidget, title: string, text: string, buttons: cint): cint =
...
proc critical3*(_: type gen_qmessagebox_types.QMessageBox, parent: QWidget, title: string, text: string, buttons: cint, defaultButton: cint): cint =
...
proc aboutQt*(_: type gen_qmessagebox_types.QMessageBox, parent: QWidget, title: string): void =
  fcQMessageBox_aboutQt2(parent.h, struct_miqt_string(data: title, len: csize_t(len(title))))

proc information2*(_: type gen_qmessagebox_types.QMessageBox, parent: QWidget, title: string, text: string, button0: cint, button1: cint): cint =
...
proc information*(_: type gen_qmessagebox_types.QMessageBox, parent: QWidget, title: string, text: string, button0: cint, button1: cint, button2: cint): cint =
...
proc information*(_: type gen_qmessagebox_types.QMessageBox, parent: QWidget, title: string, text: string, button0Text: string, button1Text: string): cint =
...
proc information*(_: type gen_qmessagebox_types.QMessageBox, parent: QWidget, title: string, text: string, button0Text: string, button1Text: string, button2Text: string): cint =
...
proc information*(_: type gen_qmessagebox_types.QMessageBox, parent: QWidget, title: string, text: string, button0Text: string, button1Text: string, button2Text: string, defaultButtonNumber: cint): cint =
...
proc information*(_: type gen_qmessagebox_types.QMessageBox, parent: QWidget, title: string, text: string, button0Text: string, button1Text: string, button2Text: string, defaultButtonNumber: cint, escapeButtonNumber: cint): cint =
...
proc information3*(_: type gen_qmessagebox_types.QMessageBox, parent: QWidget, title: string, text: string, button0: cint, button1: cint): cint =
...
proc question3*(_: type gen_qmessagebox_types.QMessageBox, parent: QWidget, title: string, text: string, button0: cint, button1: cint): cint =
...
proc question*(_: type gen_qmessagebox_types.QMessageBox, parent: QWidget, title: string, text: string, button0: cint, button1: cint, button2: cint): cint =
...
proc question*(_: type gen_qmessagebox_types.QMessageBox, parent: QWidget, title: string, text: string, button0Text: string, button1Text: string): cint =
...
proc question*(_: type gen_qmessagebox_types.QMessageBox, parent: QWidget, title: string, text: string, button0Text: string, button1Text: string, button2Text: string): cint =
  fcQMessageBox_question62(parent.h, struct_miqt_string(data: title, len: csize_t(len(title))), struct_miqt_string(data: text, len: csize_t(len(text))), struct_miqt_string(data: button0Text, len: csize_t(len(button0Text))), struct_miqt_string(data: button1Text, len: csize_t(len(button1Text))), struct_miqt_string(data: button2Text, len: csize_t(len(button2Text))))

proc question*(_: type gen_qmessagebox_types.QMessageBox, parent: QWidget, title: string, text: string, button0Text: string, button1Text: string, button2Text: string, defaultButtonNumber: cint): cint =
...
proc question*(_: type gen_qmessagebox_types.QMessageBox, parent: QWidget, title: string, text: string, button0Text: string, button1Text: string, button2Text: string, defaultButtonNumber: cint, escapeButtonNumber: cint): cint =
...
proc warning*(_: type gen_qmessagebox_types.QMessageBox, parent: QWidget, title: string, text: string, button0: cint, button1: cint, button2: cint): cint =
...
proc warning*(_: type gen_qmessagebox_types.QMessageBox, parent: QWidget, title: string, text: string, button0Text: string, button1Text: string): cint =
...
proc warning*(_: type gen_qmessagebox_types.QMessageBox, parent: QWidget, title: string, text: string, button0Text: string, button1Text: string, button2Text: string): cint =
...
proc warning*(_: type gen_qmessagebox_types.QMessageBox, parent: QWidget, title: string, text: string, button0Text: string, button1Text: string, button2Text: string, defaultButtonNumber: cint): cint =
...
proc warning*(_: type gen_qmessagebox_types.QMessageBox, parent: QWidget, title: string, text: string, button0Text: string, button1Text: string, button2Text: string, defaultButtonNumber: cint, escapeButtonNumber: cint): cint =
...
proc critical*(_: type gen_qmessagebox_types.QMessageBox, parent: QWidget, title: string, text: string, button0: cint, button1: cint, button2: cint): cint =
...
proc critical*(_: type gen_qmessagebox_types.QMessageBox, parent: QWidget, title: string, text: string, button0Text: string, button1Text: string): cint =
...
proc critical*(_: type gen_qmessagebox_types.QMessageBox, parent: QWidget, title: string, text: string, button0Text: string, button1Text: string, button2Text: string): cint =
...
proc critical*(_: type gen_qmessagebox_types.QMessageBox, parent: QWidget, title: string, text: string, button0Text: string, button1Text: string, button2Text: string, defaultButtonNumber: cint): cint =
...
proc critical*(_: type gen_qmessagebox_types.QMessageBox, parent: QWidget, title: string, text: string, button0Text: string, button1Text: string, button2Text: string, defaultButtonNumber: cint, escapeButtonNumber: cint): cint =
...
proc miqt_exec_callback_QMessageBox_metacall(self: ptr cQMessageBox, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QMessageBox_metacall ".} =
  ...
  virtualReturn
proc QMessageBoxevent*(self: gen_qmessagebox_types.QMessageBox, e: QEvent): bool =
  fQMessageBox_virtualbase_event(self.h, e.h)

type QMessageBoxeventProc* = proc(e: QEvent): bool
...
proc miqt_exec_callback_QMessageBox_event(self: ptr cQMessageBox, slot: int, e: pointer): bool {.exportc: "miqt_exec_callback_QMessageBox_event ".} =
  ...
  virtualReturn
proc QMessageBoxresizeEvent*(self: gen_qmessagebox_types.QMessageBox, event: QResizeEvent): void =
  fQMessageBox_virtualbase_resizeEvent(self.h, event.h)

type QMessageBoxresizeEventProc* = proc(event: QResizeEvent): void
...
proc miqt_exec_callback_QMessageBox_resizeEvent(self: ptr cQMessageBox, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QMessageBox_resizeEvent ".} =
  ...
  nimfunc[](slotval1)
proc QMessageBoxshowEvent*(self: gen_qmessagebox_types.QMessageBox, event: QShowEvent): void =
  fQMessageBox_virtualbase_showEvent(self.h, event.h)

type QMessageBoxshowEventProc* = proc(event: QShowEvent): void
...
proc miqt_exec_callback_QMessageBox_showEvent(self: ptr cQMessageBox, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QMessageBox_showEvent ".} =
  ...
  nimfunc[](slotval1)
proc QMessageBoxcloseEvent*(self: gen_qmessagebox_types.QMessageBox, event: QCloseEvent): void =
  fQMessageBox_virtualbase_closeEvent(self.h, event.h)

type QMessageBoxcloseEventProc* = proc(event: QCloseEvent): void
...
proc miqt_exec_callback_QMessageBox_closeEvent(self: ptr cQMessageBox, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QMessageBox_closeEvent ".} =
  ...
  nimfunc[](slotval1)
proc QMessageBoxkeyPressEvent*(self: gen_qmessagebox_types.QMessageBox, event: QKeyEvent): void =
  fQMessageBox_virtualbase_keyPressEvent(self.h, event.h)

type QMessageBoxkeyPressEventProc* = proc(event: QKeyEvent): void
...
proc miqt_exec_callback_QMessageBox_keyPressEvent(self: ptr cQMessageBox, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QMessageBox_keyPressEvent ".} =
  ...
  nimfunc[](slotval1)
proc QMessageBoxchangeEvent*(self: gen_qmessagebox_types.QMessageBox, event: QEvent): void =
  fQMessageBox_virtualbase_changeEvent(self.h, event.h)

type QMessageBoxchangeEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QMessageBox_setVisible(self: ptr cQMessageBox, slot: int, visible: bool): void {.exportc: "miqt_exec_callback_QMessageBox_setVisible ".} =
  ...
  nimfunc[](slotval1)
proc QMessageBoxsizeHint*(self: gen_qmessagebox_types.QMessageBox, ): QSize =
  QSize(h: fQMessageBox_virtualbase_sizeHint(self.h))

type QMessageBoxsizeHintProc* = proc(): QSize
...
proc miqt_exec_callback_QMessageBox_sizeHint(self: ptr cQMessageBox, slot: int): pointer {.exportc: "miqt_exec_callback_QMessageBox_sizeHint ".} =
  ...
  virtualReturn.h
proc QMessageBoxminimumSizeHint*(self: gen_qmessagebox_types.QMessageBox, ): QSize =
  QSize(h: fQMessageBox_virtualbase_minimumSizeHint(self.h))

type QMessageBoxminimumSizeHintProc* = proc(): QSize
...
proc miqt_exec_callback_QMessageBox_reject(self: ptr cQMessageBox, slot: int): void {.exportc: "miqt_exec_callback_QMessageBox_reject ".} =
  ...
  nimfunc[]()
proc QMessageBoxcontextMenuEvent*(self: gen_qmessagebox_types.QMessageBox, param1: QContextMenuEvent): void =
  fQMessageBox_virtualbase_contextMenuEvent(self.h, param1.h)

type QMessageBoxcontextMenuEventProc* = proc(param1: QContextMenuEvent): void
...
proc miqt_exec_callback_QMessageBox_contextMenuEvent(self: ptr cQMessageBox, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QMessageBox_contextMenuEvent ".} =
  ...
  nimfunc[](slotval1)
proc QMessageBoxeventFilter*(self: gen_qmessagebox_types.QMessageBox, param1: QObject, param2: QEvent): bool =
  fQMessageBox_virtualbase_eventFilter(self.h, param1.h, param2.h)

type QMessageBoxeventFilterProc* = proc(param1: QObject, param2: QEvent): bool
...
proc miqt_exec_callback_QMessageBox_hasHeightForWidth(self: ptr cQMessageBox, slot: int): bool {.exportc: "miqt_exec_callback_QMessageBox_hasHeightForWidth ".} =
  ...
  virtualReturn
proc QMessageBoxpaintEngine*(self: gen_qmessagebox_types.QMessageBox, ): QPaintEngine =
  QPaintEngine(h: fQMessageBox_virtualbase_paintEngine(self.h))

type QMessageBoxpaintEngineProc* = proc(): QPaintEngine
...
proc miqt_exec_callback_QMessageBox_paintEngine(self: ptr cQMessageBox, slot: int): pointer {.exportc: "miqt_exec_callback_QMessageBox_paintEngine ".} =
  ...
  virtualReturn.h
proc QMessageBoxmousePressEvent*(self: gen_qmessagebox_types.QMessageBox, event: QMouseEvent): void =
  fQMessageBox_virtualbase_mousePressEvent(self.h, event.h)

type QMessageBoxmousePressEventProc* = proc(event: QMouseEvent): void
...
proc miqt_exec_callback_QMessageBox_mousePressEvent(self: ptr cQMessageBox, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QMessageBox_mousePressEvent ".} =
  ...
  nimfunc[](slotval1)
proc QMessageBoxmouseReleaseEvent*(self: gen_qmessagebox_types.QMessageBox, event: QMouseEvent): void =
  fQMessageBox_virtualbase_mouseReleaseEvent(self.h, event.h)

type QMessageBoxmouseReleaseEventProc* = proc(event: QMouseEvent): void
...
proc miqt_exec_callback_QMessageBox_mouseReleaseEvent(self: ptr cQMessageBox, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QMessageBox_mouseReleaseEvent ".} =
  ...
  nimfunc[](slotval1)
proc QMessageBoxmouseDoubleClickEvent*(self: gen_qmessagebox_types.QMessageBox, event: QMouseEvent): void =
  fQMessageBox_virtualbase_mouseDoubleClickEvent(self.h, event.h)

type QMessageBoxmouseDoubleClickEventProc* = proc(event: QMouseEvent): void
...
proc miqt_exec_callback_QMessageBox_mouseDoubleClickEvent(self: ptr cQMessageBox, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QMessageBox_mouseDoubleClickEvent ".} =
  ...
  nimfunc[](slotval1)
proc QMessageBoxmouseMoveEvent*(self: gen_qmessagebox_types.QMessageBox, event: QMouseEvent): void =
  fQMessageBox_virtualbase_mouseMoveEvent(self.h, event.h)

type QMessageBoxmouseMoveEventProc* = proc(event: QMouseEvent): void
...
proc miqt_exec_callback_QMessageBox_mouseMoveEvent(self: ptr cQMessageBox, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QMessageBox_mouseMoveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QMessageBoxwheelEvent*(self: gen_qmessagebox_types.QMessageBox, event: QWheelEvent): void =
  fQMessageBox_virtualbase_wheelEvent(self.h, event.h)

type QMessageBoxwheelEventProc* = proc(event: QWheelEvent): void
...
proc miqt_exec_callback_QMessageBox_wheelEvent(self: ptr cQMessageBox, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QMessageBox_wheelEvent ".} =
  ...
  nimfunc[](slotval1)
proc QMessageBoxkeyReleaseEvent*(self: gen_qmessagebox_types.QMessageBox, event: QKeyEvent): void =
  fQMessageBox_virtualbase_keyReleaseEvent(self.h, event.h)

type QMessageBoxkeyReleaseEventProc* = proc(event: QKeyEvent): void
...
proc miqt_exec_callback_QMessageBox_keyReleaseEvent(self: ptr cQMessageBox, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QMessageBox_keyReleaseEvent ".} =
  ...
  nimfunc[](slotval1)
proc QMessageBoxfocusInEvent*(self: gen_qmessagebox_types.QMessageBox, event: QFocusEvent): void =
  fQMessageBox_virtualbase_focusInEvent(self.h, event.h)

type QMessageBoxfocusInEventProc* = proc(event: QFocusEvent): void
...
proc miqt_exec_callback_QMessageBox_focusInEvent(self: ptr cQMessageBox, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QMessageBox_focusInEvent ".} =
  ...
  nimfunc[](slotval1)
proc QMessageBoxfocusOutEvent*(self: gen_qmessagebox_types.QMessageBox, event: QFocusEvent): void =
  fQMessageBox_virtualbase_focusOutEvent(self.h, event.h)

type QMessageBoxfocusOutEventProc* = proc(event: QFocusEvent): void
...
proc miqt_exec_callback_QMessageBox_focusOutEvent(self: ptr cQMessageBox, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QMessageBox_focusOutEvent ".} =
  ...
  nimfunc[](slotval1)
proc QMessageBoxenterEvent*(self: gen_qmessagebox_types.QMessageBox, event: QEvent): void =
  fQMessageBox_virtualbase_enterEvent(self.h, event.h)

type QMessageBoxenterEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QMessageBox_enterEvent(self: ptr cQMessageBox, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QMessageBox_enterEvent ".} =
  ...
  nimfunc[](slotval1)
proc QMessageBoxleaveEvent*(self: gen_qmessagebox_types.QMessageBox, event: QEvent): void =
  fQMessageBox_virtualbase_leaveEvent(self.h, event.h)

type QMessageBoxleaveEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QMessageBox_leaveEvent(self: ptr cQMessageBox, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QMessageBox_leaveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QMessageBoxpaintEvent*(self: gen_qmessagebox_types.QMessageBox, event: QPaintEvent): void =
  fQMessageBox_virtualbase_paintEvent(self.h, event.h)

type QMessageBoxpaintEventProc* = proc(event: QPaintEvent): void
...
proc miqt_exec_callback_QMessageBox_paintEvent(self: ptr cQMessageBox, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QMessageBox_paintEvent ".} =
  ...
  nimfunc[](slotval1)
proc QMessageBoxmoveEvent*(self: gen_qmessagebox_types.QMessageBox, event: QMoveEvent): void =
  fQMessageBox_virtualbase_moveEvent(self.h, event.h)

type QMessageBoxmoveEventProc* = proc(event: QMoveEvent): void
...
proc miqt_exec_callback_QMessageBox_moveEvent(self: ptr cQMessageBox, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QMessageBox_moveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QMessageBoxtabletEvent*(self: gen_qmessagebox_types.QMessageBox, event: QTabletEvent): void =
  fQMessageBox_virtualbase_tabletEvent(self.h, event.h)

type QMessageBoxtabletEventProc* = proc(event: QTabletEvent): void
...
proc miqt_exec_callback_QMessageBox_tabletEvent(self: ptr cQMessageBox, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QMessageBox_tabletEvent ".} =
  ...
  nimfunc[](slotval1)
proc QMessageBoxactionEvent*(self: gen_qmessagebox_types.QMessageBox, event: QActionEvent): void =
  fQMessageBox_virtualbase_actionEvent(self.h, event.h)

type QMessageBoxactionEventProc* = proc(event: QActionEvent): void
...
proc miqt_exec_callback_QMessageBox_actionEvent(self: ptr cQMessageBox, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QMessageBox_actionEvent ".} =
  ...
  nimfunc[](slotval1)
proc QMessageBoxdragEnterEvent*(self: gen_qmessagebox_types.QMessageBox, event: QDragEnterEvent): void =
  fQMessageBox_virtualbase_dragEnterEvent(self.h, event.h)

type QMessageBoxdragEnterEventProc* = proc(event: QDragEnterEvent): void
...
proc miqt_exec_callback_QMessageBox_dragEnterEvent(self: ptr cQMessageBox, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QMessageBox_dragEnterEvent ".} =
  ...
  nimfunc[](slotval1)
proc QMessageBoxdragMoveEvent*(self: gen_qmessagebox_types.QMessageBox, event: QDragMoveEvent): void =
  fQMessageBox_virtualbase_dragMoveEvent(self.h, event.h)

type QMessageBoxdragMoveEventProc* = proc(event: QDragMoveEvent): void
...
proc miqt_exec_callback_QMessageBox_dragMoveEvent(self: ptr cQMessageBox, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QMessageBox_dragMoveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QMessageBoxdragLeaveEvent*(self: gen_qmessagebox_types.QMessageBox, event: QDragLeaveEvent): void =
  fQMessageBox_virtualbase_dragLeaveEvent(self.h, event.h)

type QMessageBoxdragLeaveEventProc* = proc(event: QDragLeaveEvent): void
...
proc miqt_exec_callback_QMessageBox_dragLeaveEvent(self: ptr cQMessageBox, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QMessageBox_dragLeaveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QMessageBoxdropEvent*(self: gen_qmessagebox_types.QMessageBox, event: QDropEvent): void =
  fQMessageBox_virtualbase_dropEvent(self.h, event.h)

type QMessageBoxdropEventProc* = proc(event: QDropEvent): void
...
proc miqt_exec_callback_QMessageBox_dropEvent(self: ptr cQMessageBox, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QMessageBox_dropEvent ".} =
  ...
  nimfunc[](slotval1)
proc QMessageBoxhideEvent*(self: gen_qmessagebox_types.QMessageBox, event: QHideEvent): void =
  fQMessageBox_virtualbase_hideEvent(self.h, event.h)

type QMessageBoxhideEventProc* = proc(event: QHideEvent): void
...
proc miqt_exec_callback_QMessageBox_metric(self: ptr cQMessageBox, slot: int, param1: cint): cint {.exportc: "miqt_exec_callback_QMessageBox_metric ".} =
  ...
  virtualReturn
proc QMessageBoxinitPainter*(self: gen_qmessagebox_types.QMessageBox, painter: QPainter): void =
  fQMessageBox_virtualbase_initPainter(self.h, painter.h)

type QMessageBoxinitPainterProc* = proc(painter: QPainter): void
...
proc miqt_exec_callback_QMessageBox_initPainter(self: ptr cQMessageBox, slot: int, painter: pointer): void {.exportc: "miqt_exec_callback_QMessageBox_initPainter ".} =
  ...
  nimfunc[](slotval1)
proc QMessageBoxredirected*(self: gen_qmessagebox_types.QMessageBox, offset: QPoint): QPaintDevice =
  QPaintDevice(h: fQMessageBox_virtualbase_redirected(self.h, offset.h))

type QMessageBoxredirectedProc* = proc(offset: QPoint): QPaintDevice
...
proc miqt_exec_callback_QMessageBox_redirected(self: ptr cQMessageBox, slot: int, offset: pointer): pointer {.exportc: "miqt_exec_callback_QMessageBox_redirected ".} =
  ...
  virtualReturn.h
proc QMessageBoxsharedPainter*(self: gen_qmessagebox_types.QMessageBox, ): QPainter =
  QPainter(h: fQMessageBox_virtualbase_sharedPainter(self.h))

type QMessageBoxsharedPainterProc* = proc(): QPainter
...
proc miqt_exec_callback_QMessageBox_sharedPainter(self: ptr cQMessageBox, slot: int): pointer {.exportc: "miqt_exec_callback_QMessageBox_sharedPainter ".} =
  ...
  virtualReturn.h
proc QMessageBoxinputMethodEvent*(self: gen_qmessagebox_types.QMessageBox, param1: QInputMethodEvent): void =
  fQMessageBox_virtualbase_inputMethodEvent(self.h, param1.h)

type QMessageBoxinputMethodEventProc* = proc(param1: QInputMethodEvent): void
...
proc miqt_exec_callback_QMessageBox_inputMethodEvent(self: ptr cQMessageBox, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QMessageBox_inputMethodEvent ".} =
  ...
  nimfunc[](slotval1)
proc QMessageBoxinputMethodQuery*(self: gen_qmessagebox_types.QMessageBox, param1: cint): QVariant =
  QVariant(h: fQMessageBox_virtualbase_inputMethodQuery(self.h, cint(param1)))

type QMessageBoxinputMethodQueryProc* = proc(param1: cint): QVariant
...
proc miqt_exec_callback_QMessageBox_focusNextPrevChild(self: ptr cQMessageBox, slot: int, next: bool): bool {.exportc: "miqt_exec_callback_QMessageBox_focusNextPrevChild ".} =
  ...
  virtualReturn
proc QMessageBoxtimerEvent*(self: gen_qmessagebox_types.QMessageBox, event: QTimerEvent): void =
  fQMessageBox_virtualbase_timerEvent(self.h, event.h)

type QMessageBoxtimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QMessageBox_timerEvent(self: ptr cQMessageBox, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QMessageBox_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QMessageBoxchildEvent*(self: gen_qmessagebox_types.QMessageBox, event: QChildEvent): void =
  fQMessageBox_virtualbase_childEvent(self.h, event.h)

type QMessageBoxchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QMessageBox_childEvent(self: ptr cQMessageBox, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QMessageBox_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QMessageBoxcustomEvent*(self: gen_qmessagebox_types.QMessageBox, event: QEvent): void =
  fQMessageBox_virtualbase_customEvent(self.h, event.h)

type QMessageBoxcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QMessageBox_customEvent(self: ptr cQMessageBox, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QMessageBox_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QMessageBoxconnectNotify*(self: gen_qmessagebox_types.QMessageBox, signal: QMetaMethod): void =
  fQMessageBox_virtualbase_connectNotify(self.h, signal.h)

type QMessageBoxconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QMessageBox_connectNotify(self: ptr cQMessageBox, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QMessageBox_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QMessageBoxdisconnectNotify*(self: gen_qmessagebox_types.QMessageBox, signal: QMetaMethod): void =
  fQMessageBox_virtualbase_disconnectNotify(self.h, signal.h)

type QMessageBoxdisconnectNotifyProc* = proc(signal: QMetaMethod): void
