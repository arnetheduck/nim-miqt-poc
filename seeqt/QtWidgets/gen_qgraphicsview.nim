...
func init*(T: type gen_qgraphicsview_types.QGraphicsView, h: ptr cQGraphicsView): gen_qgraphicsview_types.QGraphicsView =
  T(h: h)
proc create*(T: type gen_qgraphicsview_types.QGraphicsView, parent: QWidget): gen_qgraphicsview_types.QGraphicsView =
...
proc create*(T: type gen_qgraphicsview_types.QGraphicsView, scene: QGraphicsScene): gen_qgraphicsview_types.QGraphicsView =
  gen_qgraphicsview_types.QGraphicsView.init(fcQGraphicsView_new3(scene.h))

proc create*(T: type gen_qgraphicsview_types.QGraphicsView, scene: QGraphicsScene, parent: QWidget): gen_qgraphicsview_types.QGraphicsView =
  gen_qgraphicsview_types.QGraphicsView.init(fcQGraphicsView_new4(scene.h, parent.h))

proc metaObject*(self: gen_qgraphicsview_types.QGraphicsView, ): QMetaObject =
  QMetaObject(h: fcQGraphicsView_metaObject(self.h))
...
proc sizeHint*(self: gen_qgraphicsview_types.QGraphicsView, ): QSize =
  QSize(h: fcQGraphicsView_sizeHint(self.h))
...
proc rubberBandRect*(self: gen_qgraphicsview_types.QGraphicsView, ): QRect =
  QRect(h: fcQGraphicsView_rubberBandRect(self.h))
...
proc scene*(self: gen_qgraphicsview_types.QGraphicsView, ): QGraphicsScene =
  QGraphicsScene(h: fcQGraphicsView_scene(self.h))

proc setScene*(self: gen_qgraphicsview_types.QGraphicsView, scene: QGraphicsScene): void =
  fcQGraphicsView_setScene(self.h, scene.h)

proc sceneRect*(self: gen_qgraphicsview_types.QGraphicsView, ): QRectF =
  QRectF(h: fcQGraphicsView_sceneRect(self.h))

proc setSceneRect*(self: gen_qgraphicsview_types.QGraphicsView, rect: QRectF): void =
...
proc matrix*(self: gen_qgraphicsview_types.QGraphicsView, ): QMatrix =
  QMatrix(h: fcQGraphicsView_matrix(self.h))

proc setMatrix*(self: gen_qgraphicsview_types.QGraphicsView, matrix: QMatrix): void =
...
proc transform*(self: gen_qgraphicsview_types.QGraphicsView, ): QTransform =
  QTransform(h: fcQGraphicsView_transform(self.h))

proc viewportTransform*(self: gen_qgraphicsview_types.QGraphicsView, ): QTransform =
  QTransform(h: fcQGraphicsView_viewportTransform(self.h))

proc isTransformed*(self: gen_qgraphicsview_types.QGraphicsView, ): bool =
  fcQGraphicsView_isTransformed(self.h)

proc setTransform*(self: gen_qgraphicsview_types.QGraphicsView, matrix: QTransform): void =
...
proc centerOn*(self: gen_qgraphicsview_types.QGraphicsView, pos: QPointF): void =
...
proc centerOn*(self: gen_qgraphicsview_types.QGraphicsView, item: QGraphicsItem): void =
  fcQGraphicsView_centerOnWithItem(self.h, item.h)

proc ensureVisible*(self: gen_qgraphicsview_types.QGraphicsView, rect: QRectF): void =
...
proc ensureVisible*(self: gen_qgraphicsview_types.QGraphicsView, item: QGraphicsItem): void =
  fcQGraphicsView_ensureVisibleWithItem(self.h, item.h)

proc fitInView*(self: gen_qgraphicsview_types.QGraphicsView, rect: QRectF): void =
...
proc fitInView*(self: gen_qgraphicsview_types.QGraphicsView, item: QGraphicsItem): void =
  fcQGraphicsView_fitInViewWithItem(self.h, item.h)

proc render*(self: gen_qgraphicsview_types.QGraphicsView, painter: QPainter): void =
  fcQGraphicsView_render(self.h, painter.h)

proc items*(self: gen_qgraphicsview_types.QGraphicsView, ): seq[QGraphicsItem] =
...
proc items*(self: gen_qgraphicsview_types.QGraphicsView, pos: QPoint): seq[QGraphicsItem] =
...
proc items*(self: gen_qgraphicsview_types.QGraphicsView, x: cint, y: cint): seq[QGraphicsItem] =
...
proc items*(self: gen_qgraphicsview_types.QGraphicsView, rect: QRect): seq[QGraphicsItem] =
...
proc items*(self: gen_qgraphicsview_types.QGraphicsView, x: cint, y: cint, w: cint, h: cint): seq[QGraphicsItem] =
...
proc items*(self: gen_qgraphicsview_types.QGraphicsView, path: QPainterPath): seq[QGraphicsItem] =
...
proc itemAt*(self: gen_qgraphicsview_types.QGraphicsView, pos: QPoint): QGraphicsItem =
  QGraphicsItem(h: fcQGraphicsView_itemAt(self.h, pos.h))

proc itemAt*(self: gen_qgraphicsview_types.QGraphicsView, x: cint, y: cint): QGraphicsItem =
  QGraphicsItem(h: fcQGraphicsView_itemAt2(self.h, x, y))

proc mapToScene*(self: gen_qgraphicsview_types.QGraphicsView, point: QPoint): QPointF =
  QPointF(h: fcQGraphicsView_mapToScene(self.h, point.h))

proc mapToScene*(self: gen_qgraphicsview_types.QGraphicsView, path: QPainterPath): QPainterPath =
  QPainterPath(h: fcQGraphicsView_mapToSceneWithPath(self.h, path.h))

proc mapFromScene*(self: gen_qgraphicsview_types.QGraphicsView, point: QPointF): QPoint =
  QPoint(h: fcQGraphicsView_mapFromScene(self.h, point.h))

proc mapFromScene*(self: gen_qgraphicsview_types.QGraphicsView, path: QPainterPath): QPainterPath =
  QPainterPath(h: fcQGraphicsView_mapFromSceneWithPath(self.h, path.h))

proc mapToScene*(self: gen_qgraphicsview_types.QGraphicsView, x: cint, y: cint): QPointF =
  QPointF(h: fcQGraphicsView_mapToScene2(self.h, x, y))

proc mapFromScene*(self: gen_qgraphicsview_types.QGraphicsView, x: float64, y: float64): QPoint =
  QPoint(h: fcQGraphicsView_mapFromScene2(self.h, x, y))

proc inputMethodQuery*(self: gen_qgraphicsview_types.QGraphicsView, query: cint): QVariant =
  QVariant(h: fcQGraphicsView_inputMethodQuery(self.h, cint(query)))

proc backgroundBrush*(self: gen_qgraphicsview_types.QGraphicsView, ): QBrush =
  QBrush(h: fcQGraphicsView_backgroundBrush(self.h))

proc setBackgroundBrush*(self: gen_qgraphicsview_types.QGraphicsView, brush: QBrush): void =
  fcQGraphicsView_setBackgroundBrush(self.h, brush.h)

proc foregroundBrush*(self: gen_qgraphicsview_types.QGraphicsView, ): QBrush =
  QBrush(h: fcQGraphicsView_foregroundBrush(self.h))

proc setForegroundBrush*(self: gen_qgraphicsview_types.QGraphicsView, brush: QBrush): void =
  fcQGraphicsView_setForegroundBrush(self.h, brush.h)

proc updateScene*(self: gen_qgraphicsview_types.QGraphicsView, rects: seq[QRectF]): void =
...
proc updateSceneRect*(self: gen_qgraphicsview_types.QGraphicsView, rect: QRectF): void =
  fcQGraphicsView_updateSceneRect(self.h, rect.h)

proc rubberBandChanged*(self: gen_qgraphicsview_types.QGraphicsView, viewportRect: QRect, fromScenePoint: QPointF, toScenePoint: QPointF): void =
  fcQGraphicsView_rubberBandChanged(self.h, viewportRect.h, fromScenePoint.h, toScenePoint.h)

type QGraphicsViewrubberBandChangedSlot* = proc(viewportRect: QRect, fromScenePoint: QPointF, toScenePoint: QPointF)
proc miqt_exec_callback_QGraphicsView_rubberBandChanged(slot: int, viewportRect: pointer, fromScenePoint: pointer, toScenePoint: pointer) {.exportc.} =
  ...
  let slotval1 = QRect(h: viewportRect)

  let slotval2 = QPointF(h: fromScenePoint)

  let slotval3 = QPointF(h: toScenePoint)
...
proc setMatrix*(self: gen_qgraphicsview_types.QGraphicsView, matrix: QMatrix, combine: bool): void =
  fcQGraphicsView_setMatrix2(self.h, matrix.h, combine)

proc setTransform*(self: gen_qgraphicsview_types.QGraphicsView, matrix: QTransform, combine: bool): void =
  fcQGraphicsView_setTransform2(self.h, matrix.h, combine)

proc ensureVisible*(self: gen_qgraphicsview_types.QGraphicsView, rect: QRectF, xmargin: cint): void =
  fcQGraphicsView_ensureVisible22(self.h, rect.h, xmargin)

proc ensureVisible*(self: gen_qgraphicsview_types.QGraphicsView, rect: QRectF, xmargin: cint, ymargin: cint): void =
...
proc ensureVisible*(self: gen_qgraphicsview_types.QGraphicsView, item: QGraphicsItem, xmargin: cint): void =
  fcQGraphicsView_ensureVisible23(self.h, item.h, xmargin)

proc ensureVisible*(self: gen_qgraphicsview_types.QGraphicsView, item: QGraphicsItem, xmargin: cint, ymargin: cint): void =
  fcQGraphicsView_ensureVisible32(self.h, item.h, xmargin, ymargin)

proc fitInView*(self: gen_qgraphicsview_types.QGraphicsView, rect: QRectF, aspectRadioMode: cint): void =
...
proc fitInView*(self: gen_qgraphicsview_types.QGraphicsView, item: QGraphicsItem, aspectRadioMode: cint): void =
  fcQGraphicsView_fitInView23(self.h, item.h, cint(aspectRadioMode))

proc render*(self: gen_qgraphicsview_types.QGraphicsView, painter: QPainter, target: QRectF): void =
  fcQGraphicsView_render2(self.h, painter.h, target.h)

proc render*(self: gen_qgraphicsview_types.QGraphicsView, painter: QPainter, target: QRectF, source: QRect): void =
  fcQGraphicsView_render3(self.h, painter.h, target.h, source.h)

proc render*(self: gen_qgraphicsview_types.QGraphicsView, painter: QPainter, target: QRectF, source: QRect, aspectRatioMode: cint): void =
  fcQGraphicsView_render4(self.h, painter.h, target.h, source.h, cint(aspectRatioMode))

proc items*(self: gen_qgraphicsview_types.QGraphicsView, rect: QRect, mode: cint): seq[QGraphicsItem] =
...
proc items*(self: gen_qgraphicsview_types.QGraphicsView, x: cint, y: cint, w: cint, h: cint, mode: cint): seq[QGraphicsItem] =
...
proc items*(self: gen_qgraphicsview_types.QGraphicsView, path: QPainterPath, mode: cint): seq[QGraphicsItem] =
...
proc invalidateScene*(self: gen_qgraphicsview_types.QGraphicsView, rect: QRectF): void =
  fcQGraphicsView_invalidateScene1(self.h, rect.h)

proc invalidateScene*(self: gen_qgraphicsview_types.QGraphicsView, rect: QRectF, layers: cint): void =
...
proc miqt_exec_callback_QGraphicsView_metacall(self: ptr cQGraphicsView, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QGraphicsView_metacall ".} =
  ...
  virtualReturn
proc QGraphicsViewsizeHint*(self: gen_qgraphicsview_types.QGraphicsView, ): QSize =
  QSize(h: fQGraphicsView_virtualbase_sizeHint(self.h))

type QGraphicsViewsizeHintProc* = proc(): QSize
...
proc miqt_exec_callback_QGraphicsView_sizeHint(self: ptr cQGraphicsView, slot: int): pointer {.exportc: "miqt_exec_callback_QGraphicsView_sizeHint ".} =
  ...
  virtualReturn.h
proc QGraphicsViewinputMethodQuery*(self: gen_qgraphicsview_types.QGraphicsView, query: cint): QVariant =
  QVariant(h: fQGraphicsView_virtualbase_inputMethodQuery(self.h, cint(query)))

type QGraphicsViewinputMethodQueryProc* = proc(query: cint): QVariant
...
proc miqt_exec_callback_QGraphicsView_inputMethodQuery(self: ptr cQGraphicsView, slot: int, query: cint): pointer {.exportc: "miqt_exec_callback_QGraphicsView_inputMethodQuery ".} =
  ...
  virtualReturn.h
proc QGraphicsViewsetupViewport*(self: gen_qgraphicsview_types.QGraphicsView, widget: QWidget): void =
  fQGraphicsView_virtualbase_setupViewport(self.h, widget.h)

type QGraphicsViewsetupViewportProc* = proc(widget: QWidget): void
...
proc miqt_exec_callback_QGraphicsView_setupViewport(self: ptr cQGraphicsView, slot: int, widget: pointer): void {.exportc: "miqt_exec_callback_QGraphicsView_setupViewport ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsViewevent*(self: gen_qgraphicsview_types.QGraphicsView, event: QEvent): bool =
  fQGraphicsView_virtualbase_event(self.h, event.h)

type QGraphicsVieweventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QGraphicsView_event(self: ptr cQGraphicsView, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QGraphicsView_event ".} =
  ...
  virtualReturn
proc QGraphicsViewviewportEvent*(self: gen_qgraphicsview_types.QGraphicsView, event: QEvent): bool =
  fQGraphicsView_virtualbase_viewportEvent(self.h, event.h)

type QGraphicsViewviewportEventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QGraphicsView_viewportEvent(self: ptr cQGraphicsView, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QGraphicsView_viewportEvent ".} =
  ...
  virtualReturn
proc QGraphicsViewcontextMenuEvent*(self: gen_qgraphicsview_types.QGraphicsView, event: QContextMenuEvent): void =
  fQGraphicsView_virtualbase_contextMenuEvent(self.h, event.h)

type QGraphicsViewcontextMenuEventProc* = proc(event: QContextMenuEvent): void
...
proc miqt_exec_callback_QGraphicsView_contextMenuEvent(self: ptr cQGraphicsView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsView_contextMenuEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsViewdragEnterEvent*(self: gen_qgraphicsview_types.QGraphicsView, event: QDragEnterEvent): void =
  fQGraphicsView_virtualbase_dragEnterEvent(self.h, event.h)

type QGraphicsViewdragEnterEventProc* = proc(event: QDragEnterEvent): void
...
proc miqt_exec_callback_QGraphicsView_dragEnterEvent(self: ptr cQGraphicsView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsView_dragEnterEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsViewdragLeaveEvent*(self: gen_qgraphicsview_types.QGraphicsView, event: QDragLeaveEvent): void =
  fQGraphicsView_virtualbase_dragLeaveEvent(self.h, event.h)

type QGraphicsViewdragLeaveEventProc* = proc(event: QDragLeaveEvent): void
...
proc miqt_exec_callback_QGraphicsView_dragLeaveEvent(self: ptr cQGraphicsView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsView_dragLeaveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsViewdragMoveEvent*(self: gen_qgraphicsview_types.QGraphicsView, event: QDragMoveEvent): void =
  fQGraphicsView_virtualbase_dragMoveEvent(self.h, event.h)

type QGraphicsViewdragMoveEventProc* = proc(event: QDragMoveEvent): void
...
proc miqt_exec_callback_QGraphicsView_dragMoveEvent(self: ptr cQGraphicsView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsView_dragMoveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsViewdropEvent*(self: gen_qgraphicsview_types.QGraphicsView, event: QDropEvent): void =
  fQGraphicsView_virtualbase_dropEvent(self.h, event.h)

type QGraphicsViewdropEventProc* = proc(event: QDropEvent): void
...
proc miqt_exec_callback_QGraphicsView_dropEvent(self: ptr cQGraphicsView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsView_dropEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsViewfocusInEvent*(self: gen_qgraphicsview_types.QGraphicsView, event: QFocusEvent): void =
  fQGraphicsView_virtualbase_focusInEvent(self.h, event.h)

type QGraphicsViewfocusInEventProc* = proc(event: QFocusEvent): void
...
proc miqt_exec_callback_QGraphicsView_focusNextPrevChild(self: ptr cQGraphicsView, slot: int, next: bool): bool {.exportc: "miqt_exec_callback_QGraphicsView_focusNextPrevChild ".} =
  ...
  virtualReturn
proc QGraphicsViewfocusOutEvent*(self: gen_qgraphicsview_types.QGraphicsView, event: QFocusEvent): void =
  fQGraphicsView_virtualbase_focusOutEvent(self.h, event.h)

type QGraphicsViewfocusOutEventProc* = proc(event: QFocusEvent): void
...
proc miqt_exec_callback_QGraphicsView_focusOutEvent(self: ptr cQGraphicsView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsView_focusOutEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsViewkeyPressEvent*(self: gen_qgraphicsview_types.QGraphicsView, event: QKeyEvent): void =
  fQGraphicsView_virtualbase_keyPressEvent(self.h, event.h)

type QGraphicsViewkeyPressEventProc* = proc(event: QKeyEvent): void
...
proc miqt_exec_callback_QGraphicsView_keyPressEvent(self: ptr cQGraphicsView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsView_keyPressEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsViewkeyReleaseEvent*(self: gen_qgraphicsview_types.QGraphicsView, event: QKeyEvent): void =
  fQGraphicsView_virtualbase_keyReleaseEvent(self.h, event.h)

type QGraphicsViewkeyReleaseEventProc* = proc(event: QKeyEvent): void
...
proc miqt_exec_callback_QGraphicsView_keyReleaseEvent(self: ptr cQGraphicsView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsView_keyReleaseEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsViewmouseDoubleClickEvent*(self: gen_qgraphicsview_types.QGraphicsView, event: QMouseEvent): void =
  fQGraphicsView_virtualbase_mouseDoubleClickEvent(self.h, event.h)

type QGraphicsViewmouseDoubleClickEventProc* = proc(event: QMouseEvent): void
...
proc miqt_exec_callback_QGraphicsView_mouseDoubleClickEvent(self: ptr cQGraphicsView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsView_mouseDoubleClickEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsViewmousePressEvent*(self: gen_qgraphicsview_types.QGraphicsView, event: QMouseEvent): void =
  fQGraphicsView_virtualbase_mousePressEvent(self.h, event.h)

type QGraphicsViewmousePressEventProc* = proc(event: QMouseEvent): void
...
proc miqt_exec_callback_QGraphicsView_mousePressEvent(self: ptr cQGraphicsView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsView_mousePressEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsViewmouseMoveEvent*(self: gen_qgraphicsview_types.QGraphicsView, event: QMouseEvent): void =
  fQGraphicsView_virtualbase_mouseMoveEvent(self.h, event.h)

type QGraphicsViewmouseMoveEventProc* = proc(event: QMouseEvent): void
...
proc miqt_exec_callback_QGraphicsView_mouseMoveEvent(self: ptr cQGraphicsView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsView_mouseMoveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsViewmouseReleaseEvent*(self: gen_qgraphicsview_types.QGraphicsView, event: QMouseEvent): void =
  fQGraphicsView_virtualbase_mouseReleaseEvent(self.h, event.h)

type QGraphicsViewmouseReleaseEventProc* = proc(event: QMouseEvent): void
...
proc miqt_exec_callback_QGraphicsView_mouseReleaseEvent(self: ptr cQGraphicsView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsView_mouseReleaseEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsViewwheelEvent*(self: gen_qgraphicsview_types.QGraphicsView, event: QWheelEvent): void =
  fQGraphicsView_virtualbase_wheelEvent(self.h, event.h)

type QGraphicsViewwheelEventProc* = proc(event: QWheelEvent): void
...
proc miqt_exec_callback_QGraphicsView_wheelEvent(self: ptr cQGraphicsView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsView_wheelEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsViewpaintEvent*(self: gen_qgraphicsview_types.QGraphicsView, event: QPaintEvent): void =
  fQGraphicsView_virtualbase_paintEvent(self.h, event.h)

type QGraphicsViewpaintEventProc* = proc(event: QPaintEvent): void
...
proc miqt_exec_callback_QGraphicsView_paintEvent(self: ptr cQGraphicsView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsView_paintEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsViewresizeEvent*(self: gen_qgraphicsview_types.QGraphicsView, event: QResizeEvent): void =
  fQGraphicsView_virtualbase_resizeEvent(self.h, event.h)

type QGraphicsViewresizeEventProc* = proc(event: QResizeEvent): void
...
proc QGraphicsViewshowEvent*(self: gen_qgraphicsview_types.QGraphicsView, event: QShowEvent): void =
  fQGraphicsView_virtualbase_showEvent(self.h, event.h)

type QGraphicsViewshowEventProc* = proc(event: QShowEvent): void
...
proc miqt_exec_callback_QGraphicsView_showEvent(self: ptr cQGraphicsView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsView_showEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsViewinputMethodEvent*(self: gen_qgraphicsview_types.QGraphicsView, event: QInputMethodEvent): void =
  fQGraphicsView_virtualbase_inputMethodEvent(self.h, event.h)

type QGraphicsViewinputMethodEventProc* = proc(event: QInputMethodEvent): void
...
proc miqt_exec_callback_QGraphicsView_inputMethodEvent(self: ptr cQGraphicsView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsView_inputMethodEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsViewdrawBackground*(self: gen_qgraphicsview_types.QGraphicsView, painter: QPainter, rect: QRectF): void =
  fQGraphicsView_virtualbase_drawBackground(self.h, painter.h, rect.h)

type QGraphicsViewdrawBackgroundProc* = proc(painter: QPainter, rect: QRectF): void
...
proc miqt_exec_callback_QGraphicsView_drawBackground(self: ptr cQGraphicsView, slot: int, painter: pointer, rect: pointer): void {.exportc: "miqt_exec_callback_QGraphicsView_drawBackground ".} =
  ...
  nimfunc[](slotval1, slotval2)
proc QGraphicsViewdrawForeground*(self: gen_qgraphicsview_types.QGraphicsView, painter: QPainter, rect: QRectF): void =
  fQGraphicsView_virtualbase_drawForeground(self.h, painter.h, rect.h)

type QGraphicsViewdrawForegroundProc* = proc(painter: QPainter, rect: QRectF): void
...
proc miqt_exec_callback_QGraphicsView_drawForeground(self: ptr cQGraphicsView, slot: int, painter: pointer, rect: pointer): void {.exportc: "miqt_exec_callback_QGraphicsView_drawForeground ".} =
  ...
  nimfunc[](slotval1, slotval2)
proc QGraphicsViewminimumSizeHint*(self: gen_qgraphicsview_types.QGraphicsView, ): QSize =
  QSize(h: fQGraphicsView_virtualbase_minimumSizeHint(self.h))

type QGraphicsViewminimumSizeHintProc* = proc(): QSize
...
proc miqt_exec_callback_QGraphicsView_minimumSizeHint(self: ptr cQGraphicsView, slot: int): pointer {.exportc: "miqt_exec_callback_QGraphicsView_minimumSizeHint ".} =
  ...
  virtualReturn.h
proc QGraphicsVieweventFilter*(self: gen_qgraphicsview_types.QGraphicsView, param1: QObject, param2: QEvent): bool =
  fQGraphicsView_virtualbase_eventFilter(self.h, param1.h, param2.h)

type QGraphicsVieweventFilterProc* = proc(param1: QObject, param2: QEvent): bool
...
proc miqt_exec_callback_QGraphicsView_eventFilter(self: ptr cQGraphicsView, slot: int, param1: pointer, param2: pointer): bool {.exportc: "miqt_exec_callback_QGraphicsView_eventFilter ".} =
  ...
  virtualReturn
proc QGraphicsViewviewportSizeHint*(self: gen_qgraphicsview_types.QGraphicsView, ): QSize =
  QSize(h: fQGraphicsView_virtualbase_viewportSizeHint(self.h))

type QGraphicsViewviewportSizeHintProc* = proc(): QSize
...
proc miqt_exec_callback_QGraphicsView_viewportSizeHint(self: ptr cQGraphicsView, slot: int): pointer {.exportc: "miqt_exec_callback_QGraphicsView_viewportSizeHint ".} =
  ...
  virtualReturn.h
proc QGraphicsViewchangeEvent*(self: gen_qgraphicsview_types.QGraphicsView, param1: QEvent): void =
  fQGraphicsView_virtualbase_changeEvent(self.h, param1.h)

type QGraphicsViewchangeEventProc* = proc(param1: QEvent): void
...
proc miqt_exec_callback_QGraphicsView_hasHeightForWidth(self: ptr cQGraphicsView, slot: int): bool {.exportc: "miqt_exec_callback_QGraphicsView_hasHeightForWidth ".} =
  ...
  virtualReturn
proc QGraphicsViewpaintEngine*(self: gen_qgraphicsview_types.QGraphicsView, ): QPaintEngine =
  QPaintEngine(h: fQGraphicsView_virtualbase_paintEngine(self.h))

type QGraphicsViewpaintEngineProc* = proc(): QPaintEngine
...
proc miqt_exec_callback_QGraphicsView_paintEngine(self: ptr cQGraphicsView, slot: int): pointer {.exportc: "miqt_exec_callback_QGraphicsView_paintEngine ".} =
  ...
  virtualReturn.h
proc QGraphicsViewenterEvent*(self: gen_qgraphicsview_types.QGraphicsView, event: QEvent): void =
  fQGraphicsView_virtualbase_enterEvent(self.h, event.h)

type QGraphicsViewenterEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QGraphicsView_enterEvent(self: ptr cQGraphicsView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsView_enterEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsViewleaveEvent*(self: gen_qgraphicsview_types.QGraphicsView, event: QEvent): void =
  fQGraphicsView_virtualbase_leaveEvent(self.h, event.h)

type QGraphicsViewleaveEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QGraphicsView_leaveEvent(self: ptr cQGraphicsView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsView_leaveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsViewmoveEvent*(self: gen_qgraphicsview_types.QGraphicsView, event: QMoveEvent): void =
  fQGraphicsView_virtualbase_moveEvent(self.h, event.h)

type QGraphicsViewmoveEventProc* = proc(event: QMoveEvent): void
...
proc miqt_exec_callback_QGraphicsView_moveEvent(self: ptr cQGraphicsView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsView_moveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsViewcloseEvent*(self: gen_qgraphicsview_types.QGraphicsView, event: QCloseEvent): void =
  fQGraphicsView_virtualbase_closeEvent(self.h, event.h)

type QGraphicsViewcloseEventProc* = proc(event: QCloseEvent): void
...
proc miqt_exec_callback_QGraphicsView_closeEvent(self: ptr cQGraphicsView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsView_closeEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsViewtabletEvent*(self: gen_qgraphicsview_types.QGraphicsView, event: QTabletEvent): void =
  fQGraphicsView_virtualbase_tabletEvent(self.h, event.h)

type QGraphicsViewtabletEventProc* = proc(event: QTabletEvent): void
...
proc miqt_exec_callback_QGraphicsView_tabletEvent(self: ptr cQGraphicsView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsView_tabletEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsViewactionEvent*(self: gen_qgraphicsview_types.QGraphicsView, event: QActionEvent): void =
  fQGraphicsView_virtualbase_actionEvent(self.h, event.h)

type QGraphicsViewactionEventProc* = proc(event: QActionEvent): void
...
proc miqt_exec_callback_QGraphicsView_actionEvent(self: ptr cQGraphicsView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsView_actionEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsViewhideEvent*(self: gen_qgraphicsview_types.QGraphicsView, event: QHideEvent): void =
  fQGraphicsView_virtualbase_hideEvent(self.h, event.h)

type QGraphicsViewhideEventProc* = proc(event: QHideEvent): void
...
proc miqt_exec_callback_QGraphicsView_metric(self: ptr cQGraphicsView, slot: int, param1: cint): cint {.exportc: "miqt_exec_callback_QGraphicsView_metric ".} =
  ...
  virtualReturn
proc QGraphicsViewinitPainter*(self: gen_qgraphicsview_types.QGraphicsView, painter: QPainter): void =
  fQGraphicsView_virtualbase_initPainter(self.h, painter.h)

type QGraphicsViewinitPainterProc* = proc(painter: QPainter): void
...
proc miqt_exec_callback_QGraphicsView_initPainter(self: ptr cQGraphicsView, slot: int, painter: pointer): void {.exportc: "miqt_exec_callback_QGraphicsView_initPainter ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsViewredirected*(self: gen_qgraphicsview_types.QGraphicsView, offset: QPoint): QPaintDevice =
  QPaintDevice(h: fQGraphicsView_virtualbase_redirected(self.h, offset.h))

type QGraphicsViewredirectedProc* = proc(offset: QPoint): QPaintDevice
...
proc miqt_exec_callback_QGraphicsView_redirected(self: ptr cQGraphicsView, slot: int, offset: pointer): pointer {.exportc: "miqt_exec_callback_QGraphicsView_redirected ".} =
  ...
  virtualReturn.h
proc QGraphicsViewsharedPainter*(self: gen_qgraphicsview_types.QGraphicsView, ): QPainter =
  QPainter(h: fQGraphicsView_virtualbase_sharedPainter(self.h))

type QGraphicsViewsharedPainterProc* = proc(): QPainter
...
proc miqt_exec_callback_QGraphicsView_sharedPainter(self: ptr cQGraphicsView, slot: int): pointer {.exportc: "miqt_exec_callback_QGraphicsView_sharedPainter ".} =
  ...
  virtualReturn.h
proc QGraphicsViewtimerEvent*(self: gen_qgraphicsview_types.QGraphicsView, event: QTimerEvent): void =
  fQGraphicsView_virtualbase_timerEvent(self.h, event.h)

type QGraphicsViewtimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QGraphicsView_timerEvent(self: ptr cQGraphicsView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsView_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsViewchildEvent*(self: gen_qgraphicsview_types.QGraphicsView, event: QChildEvent): void =
  fQGraphicsView_virtualbase_childEvent(self.h, event.h)

type QGraphicsViewchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QGraphicsView_childEvent(self: ptr cQGraphicsView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsView_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsViewcustomEvent*(self: gen_qgraphicsview_types.QGraphicsView, event: QEvent): void =
  fQGraphicsView_virtualbase_customEvent(self.h, event.h)

type QGraphicsViewcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QGraphicsView_customEvent(self: ptr cQGraphicsView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsView_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsViewconnectNotify*(self: gen_qgraphicsview_types.QGraphicsView, signal: QMetaMethod): void =
  fQGraphicsView_virtualbase_connectNotify(self.h, signal.h)

type QGraphicsViewconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QGraphicsView_connectNotify(self: ptr cQGraphicsView, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QGraphicsView_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsViewdisconnectNotify*(self: gen_qgraphicsview_types.QGraphicsView, signal: QMetaMethod): void =
  fQGraphicsView_virtualbase_disconnectNotify(self.h, signal.h)

type QGraphicsViewdisconnectNotifyProc* = proc(signal: QMetaMethod): void
