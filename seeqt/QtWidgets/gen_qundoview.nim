...
proc miqt_exec_callback_QUndoView_startDrag(self: ptr cQUndoView, slot: int, supportedActions: cint): void {.exportc: "miqt_exec_callback_QUndoView_startDrag ".} =
  ...
  nimfunc[](slotval1)
proc QUndoViewviewOptions*(self: gen_qundoview_types.QUndoView, ): QStyleOptionViewItem =
  QStyleOptionViewItem(h: fQUndoView_virtualbase_viewOptions(self.h))

type QUndoViewviewOptionsProc* = proc(): QStyleOptionViewItem
...
proc miqt_exec_callback_QUndoView_keyReleaseEvent(self: ptr cQUndoView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QUndoView_keyReleaseEvent ".} =
  ...
  nimfunc[](slotval1)
proc QUndoViewenterEvent*(self: gen_qundoview_types.QUndoView, event: QEvent): void =
  fQUndoView_virtualbase_enterEvent(self.h, event.h)

type QUndoViewenterEventProc* = proc(event: QEvent): void
