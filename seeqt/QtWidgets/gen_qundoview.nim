...
proc fQUndoView_virtualbase_initViewItemOption(self: pointer, option: pointer): void{.importc: "QUndoView_virtualbase_initViewItemOption".}
proc fcQUndoView_override_virtual_initViewItemOption(self: pointer, slot: int) {.importc: "QUndoView_override_virtual_initViewItemOption".}
...
proc fQUndoView_virtualbase_itemDelegateForIndex(self: pointer, index: pointer): pointer{.importc: "QUndoView_virtualbase_itemDelegateForIndex".}
proc fcQUndoView_override_virtual_itemDelegateForIndex(self: pointer, slot: int) {.importc: "QUndoView_override_virtual_itemDelegateForIndex".}
...
proc fQUndoView_virtualbase_initStyleOption(self: pointer, option: pointer): void{.importc: "QUndoView_virtualbase_initStyleOption".}
proc fcQUndoView_override_virtual_initStyleOption(self: pointer, slot: int) {.importc: "QUndoView_override_virtual_initStyleOption".}
...
proc fQUndoView_virtualbase_nativeEvent(self: pointer, eventType: struct_miqt_string, message: pointer, resultVal: ptr uint): bool{.importc: "QUndoView_virtualbase_nativeEvent".}
...
func init*(T: type gen_qundoview_types.QUndoView, h: ptr cQUndoView): gen_qundoview_types.QUndoView =
  T(h: h)
proc create*(T: type gen_qundoview_types.QUndoView, parent: QWidget): gen_qundoview_types.QUndoView =
...
proc create*(T: type gen_qundoview_types.QUndoView, stack: QUndoStack): gen_qundoview_types.QUndoView =
  gen_qundoview_types.QUndoView.init(fcQUndoView_new3(stack.h))

proc create*(T: type gen_qundoview_types.QUndoView, group: QUndoGroup): gen_qundoview_types.QUndoView =
  gen_qundoview_types.QUndoView.init(fcQUndoView_new4(group.h))

proc create*(T: type gen_qundoview_types.QUndoView, stack: QUndoStack, parent: QWidget): gen_qundoview_types.QUndoView =
  gen_qundoview_types.QUndoView.init(fcQUndoView_new5(stack.h, parent.h))

proc create*(T: type gen_qundoview_types.QUndoView, group: QUndoGroup, parent: QWidget): gen_qundoview_types.QUndoView =
  gen_qundoview_types.QUndoView.init(fcQUndoView_new6(group.h, parent.h))

proc metaObject*(self: gen_qundoview_types.QUndoView, ): QMetaObject =
  QMetaObject(h: fcQUndoView_metaObject(self.h))
...
proc stack*(self: gen_qundoview_types.QUndoView, ): QUndoStack =
  QUndoStack(h: fcQUndoView_stack(self.h))

proc group*(self: gen_qundoview_types.QUndoView, ): QUndoGroup =
  QUndoGroup(h: fcQUndoView_group(self.h))
...
proc setCleanIcon*(self: gen_qundoview_types.QUndoView, icon: QIcon): void =
  fcQUndoView_setCleanIcon(self.h, icon.h)

proc cleanIcon*(self: gen_qundoview_types.QUndoView, ): QIcon =
  QIcon(h: fcQUndoView_cleanIcon(self.h))

proc setStack*(self: gen_qundoview_types.QUndoView, stack: QUndoStack): void =
  fcQUndoView_setStack(self.h, stack.h)

proc setGroup*(self: gen_qundoview_types.QUndoView, group: QUndoGroup): void =
...
proc miqt_exec_callback_QUndoView_metacall(self: ptr cQUndoView, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QUndoView_metacall ".} =
  ...
  virtualReturn
proc QUndoViewvisualRect*(self: gen_qundoview_types.QUndoView, index: QModelIndex): QRect =
  QRect(h: fQUndoView_virtualbase_visualRect(self.h, index.h))

type QUndoViewvisualRectProc* = proc(index: QModelIndex): QRect
...
proc miqt_exec_callback_QUndoView_visualRect(self: ptr cQUndoView, slot: int, index: pointer): pointer {.exportc: "miqt_exec_callback_QUndoView_visualRect ".} =
  ...
  virtualReturn.h
proc QUndoViewscrollTo*(self: gen_qundoview_types.QUndoView, index: QModelIndex, hint: cint): void =
  fQUndoView_virtualbase_scrollTo(self.h, index.h, cint(hint))

type QUndoViewscrollToProc* = proc(index: QModelIndex, hint: cint): void
...
proc QUndoViewindexAt*(self: gen_qundoview_types.QUndoView, p: QPoint): QModelIndex =
  QModelIndex(h: fQUndoView_virtualbase_indexAt(self.h, p.h))

type QUndoViewindexAtProc* = proc(p: QPoint): QModelIndex
...
proc miqt_exec_callback_QUndoView_reset(self: ptr cQUndoView, slot: int): void {.exportc: "miqt_exec_callback_QUndoView_reset ".} =
  ...
  nimfunc[]()
proc QUndoViewsetRootIndex*(self: gen_qundoview_types.QUndoView, index: QModelIndex): void =
  fQUndoView_virtualbase_setRootIndex(self.h, index.h)

type QUndoViewsetRootIndexProc* = proc(index: QModelIndex): void
...
proc miqt_exec_callback_QUndoView_setRootIndex(self: ptr cQUndoView, slot: int, index: pointer): void {.exportc: "miqt_exec_callback_QUndoView_setRootIndex ".} =
  ...
  nimfunc[](slotval1)
proc QUndoViewevent*(self: gen_qundoview_types.QUndoView, e: QEvent): bool =
  fQUndoView_virtualbase_event(self.h, e.h)

type QUndoVieweventProc* = proc(e: QEvent): bool
...
proc miqt_exec_callback_QUndoView_scrollContentsBy(self: ptr cQUndoView, slot: int, dx: cint, dy: cint): void {.exportc: "miqt_exec_callback_QUndoView_scrollContentsBy ".} =
  ...
  nimfunc[](slotval1, slotval2)
proc QUndoViewdataChanged*(self: gen_qundoview_types.QUndoView, topLeft: QModelIndex, bottomRight: QModelIndex, roles: seq[cint]): void =
...
type QUndoViewdataChangedProc* = proc(topLeft: QModelIndex, bottomRight: QModelIndex, roles: seq[cint]): void
...
proc QUndoViewrowsInserted*(self: gen_qundoview_types.QUndoView, parent: QModelIndex, start: cint, endVal: cint): void =
  fQUndoView_virtualbase_rowsInserted(self.h, parent.h, start, endVal)

type QUndoViewrowsInsertedProc* = proc(parent: QModelIndex, start: cint, endVal: cint): void
...
proc miqt_exec_callback_QUndoView_rowsInserted(self: ptr cQUndoView, slot: int, parent: pointer, start: cint, endVal: cint): void {.exportc: "miqt_exec_callback_QUndoView_rowsInserted ".} =
  ...
  nimfunc[](slotval1, slotval2, slotval3)
proc QUndoViewrowsAboutToBeRemoved*(self: gen_qundoview_types.QUndoView, parent: QModelIndex, start: cint, endVal: cint): void =
  fQUndoView_virtualbase_rowsAboutToBeRemoved(self.h, parent.h, start, endVal)

type QUndoViewrowsAboutToBeRemovedProc* = proc(parent: QModelIndex, start: cint, endVal: cint): void
...
proc miqt_exec_callback_QUndoView_rowsAboutToBeRemoved(self: ptr cQUndoView, slot: int, parent: pointer, start: cint, endVal: cint): void {.exportc: "miqt_exec_callback_QUndoView_rowsAboutToBeRemoved ".} =
  ...
  nimfunc[](slotval1, slotval2, slotval3)
proc QUndoViewmouseMoveEvent*(self: gen_qundoview_types.QUndoView, e: QMouseEvent): void =
  fQUndoView_virtualbase_mouseMoveEvent(self.h, e.h)

type QUndoViewmouseMoveEventProc* = proc(e: QMouseEvent): void
...
proc miqt_exec_callback_QUndoView_mouseMoveEvent(self: ptr cQUndoView, slot: int, e: pointer): void {.exportc: "miqt_exec_callback_QUndoView_mouseMoveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QUndoViewmouseReleaseEvent*(self: gen_qundoview_types.QUndoView, e: QMouseEvent): void =
  fQUndoView_virtualbase_mouseReleaseEvent(self.h, e.h)

type QUndoViewmouseReleaseEventProc* = proc(e: QMouseEvent): void
...
proc miqt_exec_callback_QUndoView_mouseReleaseEvent(self: ptr cQUndoView, slot: int, e: pointer): void {.exportc: "miqt_exec_callback_QUndoView_mouseReleaseEvent ".} =
  ...
  nimfunc[](slotval1)
proc QUndoViewwheelEvent*(self: gen_qundoview_types.QUndoView, e: QWheelEvent): void =
  fQUndoView_virtualbase_wheelEvent(self.h, e.h)

type QUndoViewwheelEventProc* = proc(e: QWheelEvent): void
...
proc miqt_exec_callback_QUndoView_wheelEvent(self: ptr cQUndoView, slot: int, e: pointer): void {.exportc: "miqt_exec_callback_QUndoView_wheelEvent ".} =
  ...
  nimfunc[](slotval1)
proc QUndoViewtimerEvent*(self: gen_qundoview_types.QUndoView, e: QTimerEvent): void =
  fQUndoView_virtualbase_timerEvent(self.h, e.h)

type QUndoViewtimerEventProc* = proc(e: QTimerEvent): void
...
proc miqt_exec_callback_QUndoView_timerEvent(self: ptr cQUndoView, slot: int, e: pointer): void {.exportc: "miqt_exec_callback_QUndoView_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QUndoViewresizeEvent*(self: gen_qundoview_types.QUndoView, e: QResizeEvent): void =
  fQUndoView_virtualbase_resizeEvent(self.h, e.h)

type QUndoViewresizeEventProc* = proc(e: QResizeEvent): void
...
proc miqt_exec_callback_QUndoView_resizeEvent(self: ptr cQUndoView, slot: int, e: pointer): void {.exportc: "miqt_exec_callback_QUndoView_resizeEvent ".} =
  ...
  nimfunc[](slotval1)
proc QUndoViewdragMoveEvent*(self: gen_qundoview_types.QUndoView, e: QDragMoveEvent): void =
  fQUndoView_virtualbase_dragMoveEvent(self.h, e.h)

type QUndoViewdragMoveEventProc* = proc(e: QDragMoveEvent): void
...
proc miqt_exec_callback_QUndoView_dragMoveEvent(self: ptr cQUndoView, slot: int, e: pointer): void {.exportc: "miqt_exec_callback_QUndoView_dragMoveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QUndoViewdragLeaveEvent*(self: gen_qundoview_types.QUndoView, e: QDragLeaveEvent): void =
  fQUndoView_virtualbase_dragLeaveEvent(self.h, e.h)

type QUndoViewdragLeaveEventProc* = proc(e: QDragLeaveEvent): void
...
proc miqt_exec_callback_QUndoView_dragLeaveEvent(self: ptr cQUndoView, slot: int, e: pointer): void {.exportc: "miqt_exec_callback_QUndoView_dragLeaveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QUndoViewdropEvent*(self: gen_qundoview_types.QUndoView, e: QDropEvent): void =
  fQUndoView_virtualbase_dropEvent(self.h, e.h)

type QUndoViewdropEventProc* = proc(e: QDropEvent): void
...
proc miqt_exec_callback_QUndoView_startDrag(self: ptr cQUndoView, slot: int, supportedActions: cint): void {.exportc: "miqt_exec_callback_QUndoView_startDrag ".} =
  ...
  nimfunc[](slotval1)
proc QUndoViewinitViewItemOption*(self: gen_qundoview_types.QUndoView, option: QStyleOptionViewItem): void =
  fQUndoView_virtualbase_initViewItemOption(self.h, option.h)

type QUndoViewinitViewItemOptionProc* = proc(option: QStyleOptionViewItem): void
...
proc miqt_exec_callback_QUndoView_initViewItemOption(self: ptr cQUndoView, slot: int, option: pointer): void {.exportc: "miqt_exec_callback_QUndoView_initViewItemOption ".} =
  ...
  nimfunc[](slotval1)
proc QUndoViewpaintEvent*(self: gen_qundoview_types.QUndoView, e: QPaintEvent): void =
  fQUndoView_virtualbase_paintEvent(self.h, e.h)

type QUndoViewpaintEventProc* = proc(e: QPaintEvent): void
...
proc miqt_exec_callback_QUndoView_verticalOffset(self: ptr cQUndoView, slot: int): cint {.exportc: "miqt_exec_callback_QUndoView_verticalOffset ".} =
  ...
  virtualReturn
proc QUndoViewmoveCursor*(self: gen_qundoview_types.QUndoView, cursorAction: cint, modifiers: cint): QModelIndex =
  QModelIndex(h: fQUndoView_virtualbase_moveCursor(self.h, cint(cursorAction), cint(modifiers)))

type QUndoViewmoveCursorProc* = proc(cursorAction: cint, modifiers: cint): QModelIndex
...
proc miqt_exec_callback_QUndoView_moveCursor(self: ptr cQUndoView, slot: int, cursorAction: cint, modifiers: cint): pointer {.exportc: "miqt_exec_callback_QUndoView_moveCursor ".} =
  ...
  virtualReturn.h
proc QUndoViewsetSelection*(self: gen_qundoview_types.QUndoView, rect: QRect, command: cint): void =
  fQUndoView_virtualbase_setSelection(self.h, rect.h, cint(command))

type QUndoViewsetSelectionProc* = proc(rect: QRect, command: cint): void
...
proc miqt_exec_callback_QUndoView_setSelection(self: ptr cQUndoView, slot: int, rect: pointer, command: cint): void {.exportc: "miqt_exec_callback_QUndoView_setSelection ".} =
  ...
  nimfunc[](slotval1, slotval2)
proc QUndoViewvisualRegionForSelection*(self: gen_qundoview_types.QUndoView, selection: QItemSelection): QRegion =
  QRegion(h: fQUndoView_virtualbase_visualRegionForSelection(self.h, selection.h))

type QUndoViewvisualRegionForSelectionProc* = proc(selection: QItemSelection): QRegion
...
proc miqt_exec_callback_QUndoView_visualRegionForSelection(self: ptr cQUndoView, slot: int, selection: pointer): pointer {.exportc: "miqt_exec_callback_QUndoView_visualRegionForSelection ".} =
  ...
  virtualReturn.h
proc QUndoViewselectedIndexes*(self: gen_qundoview_types.QUndoView, ): seq[QModelIndex] =
...
type QUndoViewselectedIndexesProc* = proc(): seq[QModelIndex]
...
proc miqt_exec_callback_QUndoView_updateGeometries(self: ptr cQUndoView, slot: int): void {.exportc: "miqt_exec_callback_QUndoView_updateGeometries ".} =
  ...
  nimfunc[]()
proc QUndoViewisIndexHidden*(self: gen_qundoview_types.QUndoView, index: QModelIndex): bool =
  fQUndoView_virtualbase_isIndexHidden(self.h, index.h)

type QUndoViewisIndexHiddenProc* = proc(index: QModelIndex): bool
...
proc miqt_exec_callback_QUndoView_isIndexHidden(self: ptr cQUndoView, slot: int, index: pointer): bool {.exportc: "miqt_exec_callback_QUndoView_isIndexHidden ".} =
  ...
  virtualReturn
proc QUndoViewselectionChanged*(self: gen_qundoview_types.QUndoView, selected: QItemSelection, deselected: QItemSelection): void =
  fQUndoView_virtualbase_selectionChanged(self.h, selected.h, deselected.h)

type QUndoViewselectionChangedProc* = proc(selected: QItemSelection, deselected: QItemSelection): void
...
proc miqt_exec_callback_QUndoView_selectionChanged(self: ptr cQUndoView, slot: int, selected: pointer, deselected: pointer): void {.exportc: "miqt_exec_callback_QUndoView_selectionChanged ".} =
  ...
  nimfunc[](slotval1, slotval2)
proc QUndoViewcurrentChanged*(self: gen_qundoview_types.QUndoView, current: QModelIndex, previous: QModelIndex): void =
  fQUndoView_virtualbase_currentChanged(self.h, current.h, previous.h)

type QUndoViewcurrentChangedProc* = proc(current: QModelIndex, previous: QModelIndex): void
...
proc miqt_exec_callback_QUndoView_currentChanged(self: ptr cQUndoView, slot: int, current: pointer, previous: pointer): void {.exportc: "miqt_exec_callback_QUndoView_currentChanged ".} =
  ...
  nimfunc[](slotval1, slotval2)
proc QUndoViewviewportSizeHint*(self: gen_qundoview_types.QUndoView, ): QSize =
  QSize(h: fQUndoView_virtualbase_viewportSizeHint(self.h))

type QUndoViewviewportSizeHintProc* = proc(): QSize
...
proc miqt_exec_callback_QUndoView_viewportSizeHint(self: ptr cQUndoView, slot: int): pointer {.exportc: "miqt_exec_callback_QUndoView_viewportSizeHint ".} =
  ...
  virtualReturn.h
proc QUndoViewsetModel*(self: gen_qundoview_types.QUndoView, model: QAbstractItemModel): void =
  fQUndoView_virtualbase_setModel(self.h, model.h)

type QUndoViewsetModelProc* = proc(model: QAbstractItemModel): void
...
proc miqt_exec_callback_QUndoView_setModel(self: ptr cQUndoView, slot: int, model: pointer): void {.exportc: "miqt_exec_callback_QUndoView_setModel ".} =
  ...
  nimfunc[](slotval1)
proc QUndoViewsetSelectionModel*(self: gen_qundoview_types.QUndoView, selectionModel: QItemSelectionModel): void =
  fQUndoView_virtualbase_setSelectionModel(self.h, selectionModel.h)

type QUndoViewsetSelectionModelProc* = proc(selectionModel: QItemSelectionModel): void
...
proc miqt_exec_callback_QUndoView_sizeHintForColumn(self: ptr cQUndoView, slot: int, column: cint): cint {.exportc: "miqt_exec_callback_QUndoView_sizeHintForColumn ".} =
  ...
  virtualReturn
proc QUndoViewitemDelegateForIndex*(self: gen_qundoview_types.QUndoView, index: QModelIndex): QAbstractItemDelegate =
  QAbstractItemDelegate(h: fQUndoView_virtualbase_itemDelegateForIndex(self.h, index.h))

type QUndoViewitemDelegateForIndexProc* = proc(index: QModelIndex): QAbstractItemDelegate
...
proc miqt_exec_callback_QUndoView_itemDelegateForIndex(self: ptr cQUndoView, slot: int, index: pointer): pointer {.exportc: "miqt_exec_callback_QUndoView_itemDelegateForIndex ".} =
  ...
  virtualReturn.h
proc QUndoViewinputMethodQuery*(self: gen_qundoview_types.QUndoView, query: cint): QVariant =
  QVariant(h: fQUndoView_virtualbase_inputMethodQuery(self.h, cint(query)))

type QUndoViewinputMethodQueryProc* = proc(query: cint): QVariant
...
proc miqt_exec_callback_QUndoView_horizontalScrollbarValueChanged(self: ptr cQUndoView, slot: int, value: cint): void {.exportc: "miqt_exec_callback_QUndoView_horizontalScrollbarValueChanged ".} =
  ...
  nimfunc[](slotval1)
proc QUndoViewcloseEditor*(self: gen_qundoview_types.QUndoView, editor: QWidget, hint: cint): void =
  fQUndoView_virtualbase_closeEditor(self.h, editor.h, cint(hint))

type QUndoViewcloseEditorProc* = proc(editor: QWidget, hint: cint): void
...
proc miqt_exec_callback_QUndoView_closeEditor(self: ptr cQUndoView, slot: int, editor: pointer, hint: cint): void {.exportc: "miqt_exec_callback_QUndoView_closeEditor ".} =
  ...
  nimfunc[](slotval1, slotval2)
proc QUndoViewcommitData*(self: gen_qundoview_types.QUndoView, editor: QWidget): void =
  fQUndoView_virtualbase_commitData(self.h, editor.h)

type QUndoViewcommitDataProc* = proc(editor: QWidget): void
...
proc miqt_exec_callback_QUndoView_commitData(self: ptr cQUndoView, slot: int, editor: pointer): void {.exportc: "miqt_exec_callback_QUndoView_commitData ".} =
  ...
  nimfunc[](slotval1)
proc QUndoVieweditorDestroyed*(self: gen_qundoview_types.QUndoView, editor: QObject): void =
  fQUndoView_virtualbase_editorDestroyed(self.h, editor.h)

type QUndoVieweditorDestroyedProc* = proc(editor: QObject): void
...
proc miqt_exec_callback_QUndoView_editorDestroyed(self: ptr cQUndoView, slot: int, editor: pointer): void {.exportc: "miqt_exec_callback_QUndoView_editorDestroyed ".} =
  ...
  nimfunc[](slotval1)
proc QUndoViewedit*(self: gen_qundoview_types.QUndoView, index: QModelIndex, trigger: cint, event: QEvent): bool =
  fQUndoView_virtualbase_edit2(self.h, index.h, cint(trigger), event.h)

type QUndoViewedit2Proc* = proc(index: QModelIndex, trigger: cint, event: QEvent): bool
...
proc miqt_exec_callback_QUndoView_edit2(self: ptr cQUndoView, slot: int, index: pointer, trigger: cint, event: pointer): bool {.exportc: "miqt_exec_callback_QUndoView_edit2 ".} =
  ...
  virtualReturn
proc QUndoViewselectionCommand*(self: gen_qundoview_types.QUndoView, index: QModelIndex, event: QEvent): cint =
  cint(fQUndoView_virtualbase_selectionCommand(self.h, index.h, event.h))

type QUndoViewselectionCommandProc* = proc(index: QModelIndex, event: QEvent): cint
...
proc miqt_exec_callback_QUndoView_focusNextPrevChild(self: ptr cQUndoView, slot: int, next: bool): bool {.exportc: "miqt_exec_callback_QUndoView_focusNextPrevChild ".} =
  ...
  virtualReturn
proc QUndoViewviewportEvent*(self: gen_qundoview_types.QUndoView, event: QEvent): bool =
  fQUndoView_virtualbase_viewportEvent(self.h, event.h)

type QUndoViewviewportEventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QUndoView_viewportEvent(self: ptr cQUndoView, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QUndoView_viewportEvent ".} =
  ...
  virtualReturn
proc QUndoViewmousePressEvent*(self: gen_qundoview_types.QUndoView, event: QMouseEvent): void =
  fQUndoView_virtualbase_mousePressEvent(self.h, event.h)

type QUndoViewmousePressEventProc* = proc(event: QMouseEvent): void
...
proc miqt_exec_callback_QUndoView_mousePressEvent(self: ptr cQUndoView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QUndoView_mousePressEvent ".} =
  ...
  nimfunc[](slotval1)
proc QUndoViewmouseDoubleClickEvent*(self: gen_qundoview_types.QUndoView, event: QMouseEvent): void =
  fQUndoView_virtualbase_mouseDoubleClickEvent(self.h, event.h)

type QUndoViewmouseDoubleClickEventProc* = proc(event: QMouseEvent): void
...
proc miqt_exec_callback_QUndoView_mouseDoubleClickEvent(self: ptr cQUndoView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QUndoView_mouseDoubleClickEvent ".} =
  ...
  nimfunc[](slotval1)
proc QUndoViewdragEnterEvent*(self: gen_qundoview_types.QUndoView, event: QDragEnterEvent): void =
  fQUndoView_virtualbase_dragEnterEvent(self.h, event.h)

type QUndoViewdragEnterEventProc* = proc(event: QDragEnterEvent): void
...
proc miqt_exec_callback_QUndoView_dragEnterEvent(self: ptr cQUndoView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QUndoView_dragEnterEvent ".} =
  ...
  nimfunc[](slotval1)
proc QUndoViewfocusInEvent*(self: gen_qundoview_types.QUndoView, event: QFocusEvent): void =
  fQUndoView_virtualbase_focusInEvent(self.h, event.h)

type QUndoViewfocusInEventProc* = proc(event: QFocusEvent): void
...
proc miqt_exec_callback_QUndoView_focusInEvent(self: ptr cQUndoView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QUndoView_focusInEvent ".} =
  ...
  nimfunc[](slotval1)
proc QUndoViewfocusOutEvent*(self: gen_qundoview_types.QUndoView, event: QFocusEvent): void =
  fQUndoView_virtualbase_focusOutEvent(self.h, event.h)

type QUndoViewfocusOutEventProc* = proc(event: QFocusEvent): void
...
proc miqt_exec_callback_QUndoView_focusOutEvent(self: ptr cQUndoView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QUndoView_focusOutEvent ".} =
  ...
  nimfunc[](slotval1)
proc QUndoViewkeyPressEvent*(self: gen_qundoview_types.QUndoView, event: QKeyEvent): void =
  fQUndoView_virtualbase_keyPressEvent(self.h, event.h)

type QUndoViewkeyPressEventProc* = proc(event: QKeyEvent): void
...
proc miqt_exec_callback_QUndoView_keyPressEvent(self: ptr cQUndoView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QUndoView_keyPressEvent ".} =
  ...
  nimfunc[](slotval1)
proc QUndoViewinputMethodEvent*(self: gen_qundoview_types.QUndoView, event: QInputMethodEvent): void =
  fQUndoView_virtualbase_inputMethodEvent(self.h, event.h)

type QUndoViewinputMethodEventProc* = proc(event: QInputMethodEvent): void
...
proc miqt_exec_callback_QUndoView_inputMethodEvent(self: ptr cQUndoView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QUndoView_inputMethodEvent ".} =
  ...
  nimfunc[](slotval1)
proc QUndoVieweventFilter*(self: gen_qundoview_types.QUndoView, objectVal: QObject, event: QEvent): bool =
  fQUndoView_virtualbase_eventFilter(self.h, objectVal.h, event.h)

type QUndoVieweventFilterProc* = proc(objectVal: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QUndoView_eventFilter(self: ptr cQUndoView, slot: int, objectVal: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QUndoView_eventFilter ".} =
  ...
  virtualReturn
proc QUndoViewminimumSizeHint*(self: gen_qundoview_types.QUndoView, ): QSize =
  QSize(h: fQUndoView_virtualbase_minimumSizeHint(self.h))

type QUndoViewminimumSizeHintProc* = proc(): QSize
...
proc miqt_exec_callback_QUndoView_minimumSizeHint(self: ptr cQUndoView, slot: int): pointer {.exportc: "miqt_exec_callback_QUndoView_minimumSizeHint ".} =
  ...
  virtualReturn.h
proc QUndoViewsizeHint*(self: gen_qundoview_types.QUndoView, ): QSize =
  QSize(h: fQUndoView_virtualbase_sizeHint(self.h))

type QUndoViewsizeHintProc* = proc(): QSize
...
proc miqt_exec_callback_QUndoView_sizeHint(self: ptr cQUndoView, slot: int): pointer {.exportc: "miqt_exec_callback_QUndoView_sizeHint ".} =
  ...
  virtualReturn.h
proc QUndoViewsetupViewport*(self: gen_qundoview_types.QUndoView, viewport: QWidget): void =
  fQUndoView_virtualbase_setupViewport(self.h, viewport.h)

type QUndoViewsetupViewportProc* = proc(viewport: QWidget): void
...
proc miqt_exec_callback_QUndoView_setupViewport(self: ptr cQUndoView, slot: int, viewport: pointer): void {.exportc: "miqt_exec_callback_QUndoView_setupViewport ".} =
  ...
  nimfunc[](slotval1)
proc QUndoViewcontextMenuEvent*(self: gen_qundoview_types.QUndoView, param1: QContextMenuEvent): void =
  fQUndoView_virtualbase_contextMenuEvent(self.h, param1.h)

type QUndoViewcontextMenuEventProc* = proc(param1: QContextMenuEvent): void
...
proc miqt_exec_callback_QUndoView_contextMenuEvent(self: ptr cQUndoView, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QUndoView_contextMenuEvent ".} =
  ...
  nimfunc[](slotval1)
proc QUndoViewchangeEvent*(self: gen_qundoview_types.QUndoView, param1: QEvent): void =
  fQUndoView_virtualbase_changeEvent(self.h, param1.h)

type QUndoViewchangeEventProc* = proc(param1: QEvent): void
...
proc miqt_exec_callback_QUndoView_changeEvent(self: ptr cQUndoView, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QUndoView_changeEvent ".} =
  ...
  nimfunc[](slotval1)
proc QUndoViewinitStyleOption*(self: gen_qundoview_types.QUndoView, option: QStyleOptionFrame): void =
  fQUndoView_virtualbase_initStyleOption(self.h, option.h)

type QUndoViewinitStyleOptionProc* = proc(option: QStyleOptionFrame): void
...
proc miqt_exec_callback_QUndoView_hasHeightForWidth(self: ptr cQUndoView, slot: int): bool {.exportc: "miqt_exec_callback_QUndoView_hasHeightForWidth ".} =
  ...
  virtualReturn
proc QUndoViewpaintEngine*(self: gen_qundoview_types.QUndoView, ): QPaintEngine =
  QPaintEngine(h: fQUndoView_virtualbase_paintEngine(self.h))

type QUndoViewpaintEngineProc* = proc(): QPaintEngine
...
proc miqt_exec_callback_QUndoView_paintEngine(self: ptr cQUndoView, slot: int): pointer {.exportc: "miqt_exec_callback_QUndoView_paintEngine ".} =
  ...
  virtualReturn.h
proc QUndoViewkeyReleaseEvent*(self: gen_qundoview_types.QUndoView, event: QKeyEvent): void =
  fQUndoView_virtualbase_keyReleaseEvent(self.h, event.h)

type QUndoViewkeyReleaseEventProc* = proc(event: QKeyEvent): void
...
proc miqt_exec_callback_QUndoView_keyReleaseEvent(self: ptr cQUndoView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QUndoView_keyReleaseEvent ".} =
  ...
  nimfunc[](slotval1)
proc QUndoViewenterEvent*(self: gen_qundoview_types.QUndoView, event: QEnterEvent): void =
  fQUndoView_virtualbase_enterEvent(self.h, event.h)

type QUndoViewenterEventProc* = proc(event: QEnterEvent): void
...
proc miqt_exec_callback_QUndoView_enterEvent(self: ptr cQUndoView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QUndoView_enterEvent ".} =
  ...
  nimfunc[](slotval1)
proc QUndoViewleaveEvent*(self: gen_qundoview_types.QUndoView, event: QEvent): void =
  fQUndoView_virtualbase_leaveEvent(self.h, event.h)

type QUndoViewleaveEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QUndoView_leaveEvent(self: ptr cQUndoView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QUndoView_leaveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QUndoViewmoveEvent*(self: gen_qundoview_types.QUndoView, event: QMoveEvent): void =
  fQUndoView_virtualbase_moveEvent(self.h, event.h)

type QUndoViewmoveEventProc* = proc(event: QMoveEvent): void
...
proc miqt_exec_callback_QUndoView_moveEvent(self: ptr cQUndoView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QUndoView_moveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QUndoViewcloseEvent*(self: gen_qundoview_types.QUndoView, event: QCloseEvent): void =
  fQUndoView_virtualbase_closeEvent(self.h, event.h)

type QUndoViewcloseEventProc* = proc(event: QCloseEvent): void
...
proc miqt_exec_callback_QUndoView_closeEvent(self: ptr cQUndoView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QUndoView_closeEvent ".} =
  ...
  nimfunc[](slotval1)
proc QUndoViewtabletEvent*(self: gen_qundoview_types.QUndoView, event: QTabletEvent): void =
  fQUndoView_virtualbase_tabletEvent(self.h, event.h)

type QUndoViewtabletEventProc* = proc(event: QTabletEvent): void
...
proc miqt_exec_callback_QUndoView_tabletEvent(self: ptr cQUndoView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QUndoView_tabletEvent ".} =
  ...
  nimfunc[](slotval1)
proc QUndoViewactionEvent*(self: gen_qundoview_types.QUndoView, event: QActionEvent): void =
  fQUndoView_virtualbase_actionEvent(self.h, event.h)

type QUndoViewactionEventProc* = proc(event: QActionEvent): void
...
proc miqt_exec_callback_QUndoView_actionEvent(self: ptr cQUndoView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QUndoView_actionEvent ".} =
  ...
  nimfunc[](slotval1)
proc QUndoViewshowEvent*(self: gen_qundoview_types.QUndoView, event: QShowEvent): void =
  fQUndoView_virtualbase_showEvent(self.h, event.h)

type QUndoViewshowEventProc* = proc(event: QShowEvent): void
...
proc miqt_exec_callback_QUndoView_showEvent(self: ptr cQUndoView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QUndoView_showEvent ".} =
  ...
  nimfunc[](slotval1)
proc QUndoViewhideEvent*(self: gen_qundoview_types.QUndoView, event: QHideEvent): void =
  fQUndoView_virtualbase_hideEvent(self.h, event.h)

type QUndoViewhideEventProc* = proc(event: QHideEvent): void
...
proc miqt_exec_callback_QUndoView_metric(self: ptr cQUndoView, slot: int, param1: cint): cint {.exportc: "miqt_exec_callback_QUndoView_metric ".} =
  ...
  virtualReturn
proc QUndoViewinitPainter*(self: gen_qundoview_types.QUndoView, painter: QPainter): void =
  fQUndoView_virtualbase_initPainter(self.h, painter.h)

type QUndoViewinitPainterProc* = proc(painter: QPainter): void
...
proc miqt_exec_callback_QUndoView_initPainter(self: ptr cQUndoView, slot: int, painter: pointer): void {.exportc: "miqt_exec_callback_QUndoView_initPainter ".} =
  ...
  nimfunc[](slotval1)
proc QUndoViewredirected*(self: gen_qundoview_types.QUndoView, offset: QPoint): QPaintDevice =
  QPaintDevice(h: fQUndoView_virtualbase_redirected(self.h, offset.h))

type QUndoViewredirectedProc* = proc(offset: QPoint): QPaintDevice
...
proc miqt_exec_callback_QUndoView_redirected(self: ptr cQUndoView, slot: int, offset: pointer): pointer {.exportc: "miqt_exec_callback_QUndoView_redirected ".} =
  ...
  virtualReturn.h
proc QUndoViewsharedPainter*(self: gen_qundoview_types.QUndoView, ): QPainter =
  QPainter(h: fQUndoView_virtualbase_sharedPainter(self.h))

type QUndoViewsharedPainterProc* = proc(): QPainter
...
proc miqt_exec_callback_QUndoView_sharedPainter(self: ptr cQUndoView, slot: int): pointer {.exportc: "miqt_exec_callback_QUndoView_sharedPainter ".} =
  ...
  virtualReturn.h
proc QUndoViewchildEvent*(self: gen_qundoview_types.QUndoView, event: QChildEvent): void =
  fQUndoView_virtualbase_childEvent(self.h, event.h)

type QUndoViewchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QUndoView_childEvent(self: ptr cQUndoView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QUndoView_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QUndoViewcustomEvent*(self: gen_qundoview_types.QUndoView, event: QEvent): void =
  fQUndoView_virtualbase_customEvent(self.h, event.h)

type QUndoViewcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QUndoView_customEvent(self: ptr cQUndoView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QUndoView_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QUndoViewconnectNotify*(self: gen_qundoview_types.QUndoView, signal: QMetaMethod): void =
  fQUndoView_virtualbase_connectNotify(self.h, signal.h)

type QUndoViewconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QUndoView_connectNotify(self: ptr cQUndoView, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QUndoView_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QUndoViewdisconnectNotify*(self: gen_qundoview_types.QUndoView, signal: QMetaMethod): void =
  fQUndoView_virtualbase_disconnectNotify(self.h, signal.h)

type QUndoViewdisconnectNotifyProc* = proc(signal: QMetaMethod): void
