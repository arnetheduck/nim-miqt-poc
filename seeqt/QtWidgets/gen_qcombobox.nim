...
func init*(T: type gen_qcombobox_types.QComboBox, h: ptr cQComboBox): gen_qcombobox_types.QComboBox =
  T(h: h)
proc create*(T: type gen_qcombobox_types.QComboBox, parent: QWidget): gen_qcombobox_types.QComboBox =
...
proc metaObject*(self: gen_qcombobox_types.QComboBox, ): QMetaObject =
  QMetaObject(h: fcQComboBox_metaObject(self.h))
...
proc findData*(self: gen_qcombobox_types.QComboBox, data: QVariant): cint =
...
proc iconSize*(self: gen_qcombobox_types.QComboBox, ): QSize =
  QSize(h: fcQComboBox_iconSize(self.h))

proc setIconSize*(self: gen_qcombobox_types.QComboBox, size: QSize): void =
...
proc setLineEdit*(self: gen_qcombobox_types.QComboBox, edit: QLineEdit): void =
  fcQComboBox_setLineEdit(self.h, edit.h)

proc lineEdit*(self: gen_qcombobox_types.QComboBox, ): QLineEdit =
  QLineEdit(h: fcQComboBox_lineEdit(self.h))

proc setValidator*(self: gen_qcombobox_types.QComboBox, v: QValidator): void =
  fcQComboBox_setValidator(self.h, v.h)

proc validator*(self: gen_qcombobox_types.QComboBox, ): QValidator =
  QValidator(h: fcQComboBox_validator(self.h))

proc setCompleter*(self: gen_qcombobox_types.QComboBox, c: QCompleter): void =
  fcQComboBox_setCompleter(self.h, c.h)

proc completer*(self: gen_qcombobox_types.QComboBox, ): QCompleter =
  QCompleter(h: fcQComboBox_completer(self.h))

proc itemDelegate*(self: gen_qcombobox_types.QComboBox, ): QAbstractItemDelegate =
  QAbstractItemDelegate(h: fcQComboBox_itemDelegate(self.h))

proc setItemDelegate*(self: gen_qcombobox_types.QComboBox, delegate: QAbstractItemDelegate): void =
  fcQComboBox_setItemDelegate(self.h, delegate.h)

proc model*(self: gen_qcombobox_types.QComboBox, ): QAbstractItemModel =
  QAbstractItemModel(h: fcQComboBox_model(self.h))

proc setModel*(self: gen_qcombobox_types.QComboBox, model: QAbstractItemModel): void =
  fcQComboBox_setModel(self.h, model.h)

proc rootModelIndex*(self: gen_qcombobox_types.QComboBox, ): QModelIndex =
  QModelIndex(h: fcQComboBox_rootModelIndex(self.h))

proc setRootModelIndex*(self: gen_qcombobox_types.QComboBox, index: QModelIndex): void =
...
proc currentData*(self: gen_qcombobox_types.QComboBox, ): QVariant =
  QVariant(h: fcQComboBox_currentData(self.h))
...
proc itemIcon*(self: gen_qcombobox_types.QComboBox, index: cint): QIcon =
  QIcon(h: fcQComboBox_itemIcon(self.h, index))

proc itemData*(self: gen_qcombobox_types.QComboBox, index: cint): QVariant =
  QVariant(h: fcQComboBox_itemData(self.h, index))
...
proc addItem*(self: gen_qcombobox_types.QComboBox, icon: QIcon, text: string): void =
...
proc insertItem*(self: gen_qcombobox_types.QComboBox, index: cint, icon: QIcon, text: string): void =
...
proc setItemIcon*(self: gen_qcombobox_types.QComboBox, index: cint, icon: QIcon): void =
  fcQComboBox_setItemIcon(self.h, index, icon.h)

proc setItemData*(self: gen_qcombobox_types.QComboBox, index: cint, value: QVariant): void =
  fcQComboBox_setItemData(self.h, index, value.h)

proc view*(self: gen_qcombobox_types.QComboBox, ): QAbstractItemView =
  QAbstractItemView(h: fcQComboBox_view(self.h))

proc setView*(self: gen_qcombobox_types.QComboBox, itemView: QAbstractItemView): void =
  fcQComboBox_setView(self.h, itemView.h)

proc sizeHint*(self: gen_qcombobox_types.QComboBox, ): QSize =
  QSize(h: fcQComboBox_sizeHint(self.h))

proc minimumSizeHint*(self: gen_qcombobox_types.QComboBox, ): QSize =
  QSize(h: fcQComboBox_minimumSizeHint(self.h))
...
proc event*(self: gen_qcombobox_types.QComboBox, event: QEvent): bool =
  fcQComboBox_event(self.h, event.h)

proc inputMethodQuery*(self: gen_qcombobox_types.QComboBox, param1: cint): QVariant =
  QVariant(h: fcQComboBox_inputMethodQuery(self.h, cint(param1)))

proc inputMethodQuery*(self: gen_qcombobox_types.QComboBox, query: cint, argument: QVariant): QVariant =
  QVariant(h: fcQComboBox_inputMethodQuery2(self.h, cint(query), argument.h))
...
proc currentIndexChanged*(self: gen_qcombobox_types.QComboBox, param1: string): void =
  fcQComboBox_currentIndexChangedWithQString(self.h, struct_miqt_string(data: param1, len: csize_t(len(param1))))

type QComboBoxcurrentIndexChangedWithQStringSlot* = proc(param1: string)
...
proc activated*(self: gen_qcombobox_types.QComboBox, param1: string): void =
  fcQComboBox_activatedWithQString(self.h, struct_miqt_string(data: param1, len: csize_t(len(param1))))

type QComboBoxactivatedWithQStringSlot* = proc(param1: string)
...
proc highlighted*(self: gen_qcombobox_types.QComboBox, param1: string): void =
  fcQComboBox_highlightedWithQString(self.h, struct_miqt_string(data: param1, len: csize_t(len(param1))))

type QComboBoxhighlightedWithQStringSlot* = proc(param1: string)
...
proc findData*(self: gen_qcombobox_types.QComboBox, data: QVariant, role: cint): cint =
  fcQComboBox_findData2(self.h, data.h, role)

proc findData*(self: gen_qcombobox_types.QComboBox, data: QVariant, role: cint, flags: cint): cint =
  fcQComboBox_findData3(self.h, data.h, role, cint(flags))

proc currentData*(self: gen_qcombobox_types.QComboBox, role: cint): QVariant =
  QVariant(h: fcQComboBox_currentData1(self.h, role))

proc itemData*(self: gen_qcombobox_types.QComboBox, index: cint, role: cint): QVariant =
  QVariant(h: fcQComboBox_itemData2(self.h, index, role))

proc addItem*(self: gen_qcombobox_types.QComboBox, text: string, userData: QVariant): void =
  fcQComboBox_addItem22(self.h, struct_miqt_string(data: text, len: csize_t(len(text))), userData.h)

proc addItem*(self: gen_qcombobox_types.QComboBox, icon: QIcon, text: string, userData: QVariant): void =
  fcQComboBox_addItem3(self.h, icon.h, struct_miqt_string(data: text, len: csize_t(len(text))), userData.h)

proc insertItem*(self: gen_qcombobox_types.QComboBox, index: cint, text: string, userData: QVariant): void =
  fcQComboBox_insertItem3(self.h, index, struct_miqt_string(data: text, len: csize_t(len(text))), userData.h)

proc insertItem*(self: gen_qcombobox_types.QComboBox, index: cint, icon: QIcon, text: string, userData: QVariant): void =
  fcQComboBox_insertItem4(self.h, index, icon.h, struct_miqt_string(data: text, len: csize_t(len(text))), userData.h)

proc setItemData*(self: gen_qcombobox_types.QComboBox, index: cint, value: QVariant, role: cint): void =
...
proc miqt_exec_callback_QComboBox_metacall(self: ptr cQComboBox, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QComboBox_metacall ".} =
  ...
  virtualReturn
proc QComboBoxsizeHint*(self: gen_qcombobox_types.QComboBox, ): QSize =
  QSize(h: fQComboBox_virtualbase_sizeHint(self.h))

type QComboBoxsizeHintProc* = proc(): QSize
...
proc miqt_exec_callback_QComboBox_sizeHint(self: ptr cQComboBox, slot: int): pointer {.exportc: "miqt_exec_callback_QComboBox_sizeHint ".} =
  ...
  virtualReturn.h
proc QComboBoxminimumSizeHint*(self: gen_qcombobox_types.QComboBox, ): QSize =
  QSize(h: fQComboBox_virtualbase_minimumSizeHint(self.h))

type QComboBoxminimumSizeHintProc* = proc(): QSize
...
proc miqt_exec_callback_QComboBox_hidePopup(self: ptr cQComboBox, slot: int): void {.exportc: "miqt_exec_callback_QComboBox_hidePopup ".} =
  ...
  nimfunc[]()
proc QComboBoxevent*(self: gen_qcombobox_types.QComboBox, event: QEvent): bool =
  fQComboBox_virtualbase_event(self.h, event.h)

type QComboBoxeventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QComboBox_event(self: ptr cQComboBox, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QComboBox_event ".} =
  ...
  virtualReturn
proc QComboBoxinputMethodQuery*(self: gen_qcombobox_types.QComboBox, param1: cint): QVariant =
  QVariant(h: fQComboBox_virtualbase_inputMethodQuery(self.h, cint(param1)))

type QComboBoxinputMethodQueryProc* = proc(param1: cint): QVariant
...
proc miqt_exec_callback_QComboBox_inputMethodQuery(self: ptr cQComboBox, slot: int, param1: cint): pointer {.exportc: "miqt_exec_callback_QComboBox_inputMethodQuery ".} =
  ...
  virtualReturn.h
proc QComboBoxfocusInEvent*(self: gen_qcombobox_types.QComboBox, e: QFocusEvent): void =
  fQComboBox_virtualbase_focusInEvent(self.h, e.h)

type QComboBoxfocusInEventProc* = proc(e: QFocusEvent): void
...
proc miqt_exec_callback_QComboBox_focusInEvent(self: ptr cQComboBox, slot: int, e: pointer): void {.exportc: "miqt_exec_callback_QComboBox_focusInEvent ".} =
  ...
  nimfunc[](slotval1)
proc QComboBoxfocusOutEvent*(self: gen_qcombobox_types.QComboBox, e: QFocusEvent): void =
  fQComboBox_virtualbase_focusOutEvent(self.h, e.h)

type QComboBoxfocusOutEventProc* = proc(e: QFocusEvent): void
...
proc miqt_exec_callback_QComboBox_focusOutEvent(self: ptr cQComboBox, slot: int, e: pointer): void {.exportc: "miqt_exec_callback_QComboBox_focusOutEvent ".} =
  ...
  nimfunc[](slotval1)
proc QComboBoxchangeEvent*(self: gen_qcombobox_types.QComboBox, e: QEvent): void =
  fQComboBox_virtualbase_changeEvent(self.h, e.h)

type QComboBoxchangeEventProc* = proc(e: QEvent): void
...
proc miqt_exec_callback_QComboBox_changeEvent(self: ptr cQComboBox, slot: int, e: pointer): void {.exportc: "miqt_exec_callback_QComboBox_changeEvent ".} =
  ...
  nimfunc[](slotval1)
proc QComboBoxresizeEvent*(self: gen_qcombobox_types.QComboBox, e: QResizeEvent): void =
  fQComboBox_virtualbase_resizeEvent(self.h, e.h)

type QComboBoxresizeEventProc* = proc(e: QResizeEvent): void
...
proc miqt_exec_callback_QComboBox_resizeEvent(self: ptr cQComboBox, slot: int, e: pointer): void {.exportc: "miqt_exec_callback_QComboBox_resizeEvent ".} =
  ...
  nimfunc[](slotval1)
proc QComboBoxpaintEvent*(self: gen_qcombobox_types.QComboBox, e: QPaintEvent): void =
  fQComboBox_virtualbase_paintEvent(self.h, e.h)

type QComboBoxpaintEventProc* = proc(e: QPaintEvent): void
...
proc miqt_exec_callback_QComboBox_paintEvent(self: ptr cQComboBox, slot: int, e: pointer): void {.exportc: "miqt_exec_callback_QComboBox_paintEvent ".} =
  ...
  nimfunc[](slotval1)
proc QComboBoxshowEvent*(self: gen_qcombobox_types.QComboBox, e: QShowEvent): void =
  fQComboBox_virtualbase_showEvent(self.h, e.h)

type QComboBoxshowEventProc* = proc(e: QShowEvent): void
...
proc miqt_exec_callback_QComboBox_showEvent(self: ptr cQComboBox, slot: int, e: pointer): void {.exportc: "miqt_exec_callback_QComboBox_showEvent ".} =
  ...
  let slotval1 = QShowEvent(h: e)


  nimfunc[](slotval1)
proc QComboBoxhideEvent*(self: gen_qcombobox_types.QComboBox, e: QHideEvent): void =
  fQComboBox_virtualbase_hideEvent(self.h, e.h)

type QComboBoxhideEventProc* = proc(e: QHideEvent): void
...
proc miqt_exec_callback_QComboBox_hideEvent(self: ptr cQComboBox, slot: int, e: pointer): void {.exportc: "miqt_exec_callback_QComboBox_hideEvent ".} =
  ...
  let slotval1 = QHideEvent(h: e)


  nimfunc[](slotval1)
proc QComboBoxmousePressEvent*(self: gen_qcombobox_types.QComboBox, e: QMouseEvent): void =
  fQComboBox_virtualbase_mousePressEvent(self.h, e.h)

type QComboBoxmousePressEventProc* = proc(e: QMouseEvent): void
...
proc miqt_exec_callback_QComboBox_mousePressEvent(self: ptr cQComboBox, slot: int, e: pointer): void {.exportc: "miqt_exec_callback_QComboBox_mousePressEvent ".} =
  ...
  nimfunc[](slotval1)
proc QComboBoxmouseReleaseEvent*(self: gen_qcombobox_types.QComboBox, e: QMouseEvent): void =
  fQComboBox_virtualbase_mouseReleaseEvent(self.h, e.h)

type QComboBoxmouseReleaseEventProc* = proc(e: QMouseEvent): void
...
proc miqt_exec_callback_QComboBox_mouseReleaseEvent(self: ptr cQComboBox, slot: int, e: pointer): void {.exportc: "miqt_exec_callback_QComboBox_mouseReleaseEvent ".} =
  ...
  nimfunc[](slotval1)
proc QComboBoxkeyPressEvent*(self: gen_qcombobox_types.QComboBox, e: QKeyEvent): void =
  fQComboBox_virtualbase_keyPressEvent(self.h, e.h)

type QComboBoxkeyPressEventProc* = proc(e: QKeyEvent): void
...
proc miqt_exec_callback_QComboBox_keyPressEvent(self: ptr cQComboBox, slot: int, e: pointer): void {.exportc: "miqt_exec_callback_QComboBox_keyPressEvent ".} =
  ...
  nimfunc[](slotval1)
proc QComboBoxkeyReleaseEvent*(self: gen_qcombobox_types.QComboBox, e: QKeyEvent): void =
  fQComboBox_virtualbase_keyReleaseEvent(self.h, e.h)

type QComboBoxkeyReleaseEventProc* = proc(e: QKeyEvent): void
...
proc miqt_exec_callback_QComboBox_keyReleaseEvent(self: ptr cQComboBox, slot: int, e: pointer): void {.exportc: "miqt_exec_callback_QComboBox_keyReleaseEvent ".} =
  ...
  nimfunc[](slotval1)
proc QComboBoxwheelEvent*(self: gen_qcombobox_types.QComboBox, e: QWheelEvent): void =
  fQComboBox_virtualbase_wheelEvent(self.h, e.h)

type QComboBoxwheelEventProc* = proc(e: QWheelEvent): void
...
proc miqt_exec_callback_QComboBox_wheelEvent(self: ptr cQComboBox, slot: int, e: pointer): void {.exportc: "miqt_exec_callback_QComboBox_wheelEvent ".} =
  ...
  nimfunc[](slotval1)
proc QComboBoxcontextMenuEvent*(self: gen_qcombobox_types.QComboBox, e: QContextMenuEvent): void =
  fQComboBox_virtualbase_contextMenuEvent(self.h, e.h)

type QComboBoxcontextMenuEventProc* = proc(e: QContextMenuEvent): void
...
proc miqt_exec_callback_QComboBox_contextMenuEvent(self: ptr cQComboBox, slot: int, e: pointer): void {.exportc: "miqt_exec_callback_QComboBox_contextMenuEvent ".} =
  ...
  nimfunc[](slotval1)
proc QComboBoxinputMethodEvent*(self: gen_qcombobox_types.QComboBox, param1: QInputMethodEvent): void =
  fQComboBox_virtualbase_inputMethodEvent(self.h, param1.h)

type QComboBoxinputMethodEventProc* = proc(param1: QInputMethodEvent): void
...
proc miqt_exec_callback_QComboBox_hasHeightForWidth(self: ptr cQComboBox, slot: int): bool {.exportc: "miqt_exec_callback_QComboBox_hasHeightForWidth ".} =
  ...
  virtualReturn
proc QComboBoxpaintEngine*(self: gen_qcombobox_types.QComboBox, ): QPaintEngine =
  QPaintEngine(h: fQComboBox_virtualbase_paintEngine(self.h))

type QComboBoxpaintEngineProc* = proc(): QPaintEngine
...
proc miqt_exec_callback_QComboBox_paintEngine(self: ptr cQComboBox, slot: int): pointer {.exportc: "miqt_exec_callback_QComboBox_paintEngine ".} =
  ...
  virtualReturn.h
proc QComboBoxmouseDoubleClickEvent*(self: gen_qcombobox_types.QComboBox, event: QMouseEvent): void =
  fQComboBox_virtualbase_mouseDoubleClickEvent(self.h, event.h)

type QComboBoxmouseDoubleClickEventProc* = proc(event: QMouseEvent): void
...
proc miqt_exec_callback_QComboBox_mouseDoubleClickEvent(self: ptr cQComboBox, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QComboBox_mouseDoubleClickEvent ".} =
  ...
  nimfunc[](slotval1)
proc QComboBoxmouseMoveEvent*(self: gen_qcombobox_types.QComboBox, event: QMouseEvent): void =
  fQComboBox_virtualbase_mouseMoveEvent(self.h, event.h)

type QComboBoxmouseMoveEventProc* = proc(event: QMouseEvent): void
...
proc miqt_exec_callback_QComboBox_mouseMoveEvent(self: ptr cQComboBox, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QComboBox_mouseMoveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QComboBoxenterEvent*(self: gen_qcombobox_types.QComboBox, event: QEvent): void =
  fQComboBox_virtualbase_enterEvent(self.h, event.h)

type QComboBoxenterEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QComboBox_enterEvent(self: ptr cQComboBox, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QComboBox_enterEvent ".} =
  ...
  nimfunc[](slotval1)
proc QComboBoxleaveEvent*(self: gen_qcombobox_types.QComboBox, event: QEvent): void =
  fQComboBox_virtualbase_leaveEvent(self.h, event.h)

type QComboBoxleaveEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QComboBox_leaveEvent(self: ptr cQComboBox, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QComboBox_leaveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QComboBoxmoveEvent*(self: gen_qcombobox_types.QComboBox, event: QMoveEvent): void =
  fQComboBox_virtualbase_moveEvent(self.h, event.h)

type QComboBoxmoveEventProc* = proc(event: QMoveEvent): void
...
proc miqt_exec_callback_QComboBox_moveEvent(self: ptr cQComboBox, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QComboBox_moveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QComboBoxcloseEvent*(self: gen_qcombobox_types.QComboBox, event: QCloseEvent): void =
  fQComboBox_virtualbase_closeEvent(self.h, event.h)

type QComboBoxcloseEventProc* = proc(event: QCloseEvent): void
...
proc miqt_exec_callback_QComboBox_closeEvent(self: ptr cQComboBox, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QComboBox_closeEvent ".} =
  ...
  nimfunc[](slotval1)
proc QComboBoxtabletEvent*(self: gen_qcombobox_types.QComboBox, event: QTabletEvent): void =
  fQComboBox_virtualbase_tabletEvent(self.h, event.h)

type QComboBoxtabletEventProc* = proc(event: QTabletEvent): void
...
proc miqt_exec_callback_QComboBox_tabletEvent(self: ptr cQComboBox, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QComboBox_tabletEvent ".} =
  ...
  nimfunc[](slotval1)
proc QComboBoxactionEvent*(self: gen_qcombobox_types.QComboBox, event: QActionEvent): void =
  fQComboBox_virtualbase_actionEvent(self.h, event.h)

type QComboBoxactionEventProc* = proc(event: QActionEvent): void
...
proc miqt_exec_callback_QComboBox_actionEvent(self: ptr cQComboBox, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QComboBox_actionEvent ".} =
  ...
  nimfunc[](slotval1)
proc QComboBoxdragEnterEvent*(self: gen_qcombobox_types.QComboBox, event: QDragEnterEvent): void =
  fQComboBox_virtualbase_dragEnterEvent(self.h, event.h)

type QComboBoxdragEnterEventProc* = proc(event: QDragEnterEvent): void
...
proc miqt_exec_callback_QComboBox_dragEnterEvent(self: ptr cQComboBox, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QComboBox_dragEnterEvent ".} =
  ...
  nimfunc[](slotval1)
proc QComboBoxdragMoveEvent*(self: gen_qcombobox_types.QComboBox, event: QDragMoveEvent): void =
  fQComboBox_virtualbase_dragMoveEvent(self.h, event.h)

type QComboBoxdragMoveEventProc* = proc(event: QDragMoveEvent): void
...
proc miqt_exec_callback_QComboBox_dragMoveEvent(self: ptr cQComboBox, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QComboBox_dragMoveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QComboBoxdragLeaveEvent*(self: gen_qcombobox_types.QComboBox, event: QDragLeaveEvent): void =
  fQComboBox_virtualbase_dragLeaveEvent(self.h, event.h)

type QComboBoxdragLeaveEventProc* = proc(event: QDragLeaveEvent): void
...
proc miqt_exec_callback_QComboBox_dragLeaveEvent(self: ptr cQComboBox, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QComboBox_dragLeaveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QComboBoxdropEvent*(self: gen_qcombobox_types.QComboBox, event: QDropEvent): void =
  fQComboBox_virtualbase_dropEvent(self.h, event.h)

type QComboBoxdropEventProc* = proc(event: QDropEvent): void
...
proc miqt_exec_callback_QComboBox_dropEvent(self: ptr cQComboBox, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QComboBox_dropEvent ".} =
  ...
  nimfunc[](slotval1)
proc QComboBoxnativeEvent*(self: gen_qcombobox_types.QComboBox, eventType: seq[byte], message: pointer, resultVal: ptr clong): bool =
...
type QComboBoxnativeEventProc* = proc(eventType: seq[byte], message: pointer, resultVal: ptr clong): bool
...
proc miqt_exec_callback_QComboBox_metric(self: ptr cQComboBox, slot: int, param1: cint): cint {.exportc: "miqt_exec_callback_QComboBox_metric ".} =
  ...
  virtualReturn
proc QComboBoxinitPainter*(self: gen_qcombobox_types.QComboBox, painter: QPainter): void =
  fQComboBox_virtualbase_initPainter(self.h, painter.h)

type QComboBoxinitPainterProc* = proc(painter: QPainter): void
...
proc miqt_exec_callback_QComboBox_initPainter(self: ptr cQComboBox, slot: int, painter: pointer): void {.exportc: "miqt_exec_callback_QComboBox_initPainter ".} =
  ...
  nimfunc[](slotval1)
proc QComboBoxredirected*(self: gen_qcombobox_types.QComboBox, offset: QPoint): QPaintDevice =
  QPaintDevice(h: fQComboBox_virtualbase_redirected(self.h, offset.h))

type QComboBoxredirectedProc* = proc(offset: QPoint): QPaintDevice
...
proc miqt_exec_callback_QComboBox_redirected(self: ptr cQComboBox, slot: int, offset: pointer): pointer {.exportc: "miqt_exec_callback_QComboBox_redirected ".} =
  ...
  virtualReturn.h
proc QComboBoxsharedPainter*(self: gen_qcombobox_types.QComboBox, ): QPainter =
  QPainter(h: fQComboBox_virtualbase_sharedPainter(self.h))

type QComboBoxsharedPainterProc* = proc(): QPainter
...
proc miqt_exec_callback_QComboBox_focusNextPrevChild(self: ptr cQComboBox, slot: int, next: bool): bool {.exportc: "miqt_exec_callback_QComboBox_focusNextPrevChild ".} =
  ...
  virtualReturn
proc QComboBoxeventFilter*(self: gen_qcombobox_types.QComboBox, watched: QObject, event: QEvent): bool =
  fQComboBox_virtualbase_eventFilter(self.h, watched.h, event.h)

type QComboBoxeventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QComboBox_eventFilter(self: ptr cQComboBox, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QComboBox_eventFilter ".} =
  ...
  virtualReturn
proc QComboBoxtimerEvent*(self: gen_qcombobox_types.QComboBox, event: QTimerEvent): void =
  fQComboBox_virtualbase_timerEvent(self.h, event.h)

type QComboBoxtimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QComboBox_timerEvent(self: ptr cQComboBox, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QComboBox_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QComboBoxchildEvent*(self: gen_qcombobox_types.QComboBox, event: QChildEvent): void =
  fQComboBox_virtualbase_childEvent(self.h, event.h)

type QComboBoxchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QComboBox_childEvent(self: ptr cQComboBox, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QComboBox_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QComboBoxcustomEvent*(self: gen_qcombobox_types.QComboBox, event: QEvent): void =
  fQComboBox_virtualbase_customEvent(self.h, event.h)

type QComboBoxcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QComboBox_customEvent(self: ptr cQComboBox, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QComboBox_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QComboBoxconnectNotify*(self: gen_qcombobox_types.QComboBox, signal: QMetaMethod): void =
  fQComboBox_virtualbase_connectNotify(self.h, signal.h)

type QComboBoxconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QComboBox_connectNotify(self: ptr cQComboBox, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QComboBox_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QComboBoxdisconnectNotify*(self: gen_qcombobox_types.QComboBox, signal: QMetaMethod): void =
  fQComboBox_virtualbase_disconnectNotify(self.h, signal.h)

type QComboBoxdisconnectNotifyProc* = proc(signal: QMetaMethod): void
