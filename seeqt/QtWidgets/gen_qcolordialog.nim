...
proc fQColorDialog_virtualbase_nativeEvent(self: pointer, eventType: struct_miqt_string, message: pointer, resultVal: ptr uint): bool{.importc: "QColorDialog_virtualbase_nativeEvent".}
...
func init*(T: type gen_qcolordialog_types.QColorDialog, h: ptr cQColorDialog): gen_qcolordialog_types.QColorDialog =
  T(h: h)
proc create*(T: type gen_qcolordialog_types.QColorDialog, parent: QWidget): gen_qcolordialog_types.QColorDialog =
...
proc create*(T: type gen_qcolordialog_types.QColorDialog, initial: QColor): gen_qcolordialog_types.QColorDialog =
  gen_qcolordialog_types.QColorDialog.init(fcQColorDialog_new3(initial.h))

proc create*(T: type gen_qcolordialog_types.QColorDialog, initial: QColor, parent: QWidget): gen_qcolordialog_types.QColorDialog =
  gen_qcolordialog_types.QColorDialog.init(fcQColorDialog_new4(initial.h, parent.h))

proc metaObject*(self: gen_qcolordialog_types.QColorDialog, ): QMetaObject =
  QMetaObject(h: fcQColorDialog_metaObject(self.h))
...
proc setCurrentColor*(self: gen_qcolordialog_types.QColorDialog, color: QColor): void =
  fcQColorDialog_setCurrentColor(self.h, color.h)

proc currentColor*(self: gen_qcolordialog_types.QColorDialog, ): QColor =
  QColor(h: fcQColorDialog_currentColor(self.h))

proc selectedColor*(self: gen_qcolordialog_types.QColorDialog, ): QColor =
  QColor(h: fcQColorDialog_selectedColor(self.h))
...
proc getColor*(_: type gen_qcolordialog_types.QColorDialog, ): QColor =
  QColor(h: fcQColorDialog_getColor())

proc customCount*(_: type gen_qcolordialog_types.QColorDialog, ): cint =
  fcQColorDialog_customCount()

proc customColor*(_: type gen_qcolordialog_types.QColorDialog, index: cint): QColor =
  QColor(h: fcQColorDialog_customColor(index))

proc setCustomColor*(_: type gen_qcolordialog_types.QColorDialog, index: cint, color: QColor): void =
  fcQColorDialog_setCustomColor(index, color.h)

proc standardColor*(_: type gen_qcolordialog_types.QColorDialog, index: cint): QColor =
  QColor(h: fcQColorDialog_standardColor(index))

proc setStandardColor*(_: type gen_qcolordialog_types.QColorDialog, index: cint, color: QColor): void =
  fcQColorDialog_setStandardColor(index, color.h)

proc currentColorChanged*(self: gen_qcolordialog_types.QColorDialog, color: QColor): void =
  fcQColorDialog_currentColorChanged(self.h, color.h)

type QColorDialogcurrentColorChangedSlot* = proc(color: QColor)
...
proc colorSelected*(self: gen_qcolordialog_types.QColorDialog, color: QColor): void =
  fcQColorDialog_colorSelected(self.h, color.h)

type QColorDialogcolorSelectedSlot* = proc(color: QColor)
...
proc getColor*(_: type gen_qcolordialog_types.QColorDialog, initial: QColor): QColor =
  QColor(h: fcQColorDialog_getColor1(initial.h))

proc getColor*(_: type gen_qcolordialog_types.QColorDialog, initial: QColor, parent: QWidget): QColor =
  QColor(h: fcQColorDialog_getColor2(initial.h, parent.h))

proc getColor*(_: type gen_qcolordialog_types.QColorDialog, initial: QColor, parent: QWidget, title: string): QColor =
  QColor(h: fcQColorDialog_getColor3(initial.h, parent.h, struct_miqt_string(data: title, len: csize_t(len(title)))))

proc getColor*(_: type gen_qcolordialog_types.QColorDialog, initial: QColor, parent: QWidget, title: string, options: cint): QColor =
  QColor(h: fcQColorDialog_getColor4(initial.h, parent.h, struct_miqt_string(data: title, len: csize_t(len(title))), cint(options)))
...
proc miqt_exec_callback_QColorDialog_setVisible(self: ptr cQColorDialog, slot: int, visible: bool): void {.exportc: "miqt_exec_callback_QColorDialog_setVisible ".} =
  ...
  nimfunc[](slotval1)
proc QColorDialogchangeEvent*(self: gen_qcolordialog_types.QColorDialog, event: QEvent): void =
  fQColorDialog_virtualbase_changeEvent(self.h, event.h)

type QColorDialogchangeEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QColorDialog_done(self: ptr cQColorDialog, slot: int, resultVal: cint): void {.exportc: "miqt_exec_callback_QColorDialog_done ".} =
  ...
  nimfunc[](slotval1)
proc QColorDialogsizeHint*(self: gen_qcolordialog_types.QColorDialog, ): QSize =
  QSize(h: fQColorDialog_virtualbase_sizeHint(self.h))

type QColorDialogsizeHintProc* = proc(): QSize
...
proc miqt_exec_callback_QColorDialog_sizeHint(self: ptr cQColorDialog, slot: int): pointer {.exportc: "miqt_exec_callback_QColorDialog_sizeHint ".} =
  ...
  virtualReturn.h
proc QColorDialogminimumSizeHint*(self: gen_qcolordialog_types.QColorDialog, ): QSize =
  QSize(h: fQColorDialog_virtualbase_minimumSizeHint(self.h))

type QColorDialogminimumSizeHintProc* = proc(): QSize
...
proc miqt_exec_callback_QColorDialog_reject(self: ptr cQColorDialog, slot: int): void {.exportc: "miqt_exec_callback_QColorDialog_reject ".} =
  ...
  nimfunc[]()
proc QColorDialogkeyPressEvent*(self: gen_qcolordialog_types.QColorDialog, param1: QKeyEvent): void =
  fQColorDialog_virtualbase_keyPressEvent(self.h, param1.h)

type QColorDialogkeyPressEventProc* = proc(param1: QKeyEvent): void
...
proc miqt_exec_callback_QColorDialog_keyPressEvent(self: ptr cQColorDialog, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QColorDialog_keyPressEvent ".} =
  ...
  nimfunc[](slotval1)
proc QColorDialogcloseEvent*(self: gen_qcolordialog_types.QColorDialog, param1: QCloseEvent): void =
  fQColorDialog_virtualbase_closeEvent(self.h, param1.h)

type QColorDialogcloseEventProc* = proc(param1: QCloseEvent): void
...
proc miqt_exec_callback_QColorDialog_closeEvent(self: ptr cQColorDialog, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QColorDialog_closeEvent ".} =
  ...
  nimfunc[](slotval1)
proc QColorDialogshowEvent*(self: gen_qcolordialog_types.QColorDialog, param1: QShowEvent): void =
  fQColorDialog_virtualbase_showEvent(self.h, param1.h)

type QColorDialogshowEventProc* = proc(param1: QShowEvent): void
...
proc miqt_exec_callback_QColorDialog_showEvent(self: ptr cQColorDialog, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QColorDialog_showEvent ".} =
  ...
  nimfunc[](slotval1)
proc QColorDialogresizeEvent*(self: gen_qcolordialog_types.QColorDialog, param1: QResizeEvent): void =
  fQColorDialog_virtualbase_resizeEvent(self.h, param1.h)

type QColorDialogresizeEventProc* = proc(param1: QResizeEvent): void
...
proc miqt_exec_callback_QColorDialog_resizeEvent(self: ptr cQColorDialog, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QColorDialog_resizeEvent ".} =
  ...
  nimfunc[](slotval1)
proc QColorDialogcontextMenuEvent*(self: gen_qcolordialog_types.QColorDialog, param1: QContextMenuEvent): void =
  fQColorDialog_virtualbase_contextMenuEvent(self.h, param1.h)

type QColorDialogcontextMenuEventProc* = proc(param1: QContextMenuEvent): void
...
proc miqt_exec_callback_QColorDialog_contextMenuEvent(self: ptr cQColorDialog, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QColorDialog_contextMenuEvent ".} =
  ...
  nimfunc[](slotval1)
proc QColorDialogeventFilter*(self: gen_qcolordialog_types.QColorDialog, param1: QObject, param2: QEvent): bool =
  fQColorDialog_virtualbase_eventFilter(self.h, param1.h, param2.h)

type QColorDialogeventFilterProc* = proc(param1: QObject, param2: QEvent): bool
...
proc miqt_exec_callback_QColorDialog_hasHeightForWidth(self: ptr cQColorDialog, slot: int): bool {.exportc: "miqt_exec_callback_QColorDialog_hasHeightForWidth ".} =
  ...
  virtualReturn
proc QColorDialogpaintEngine*(self: gen_qcolordialog_types.QColorDialog, ): QPaintEngine =
  QPaintEngine(h: fQColorDialog_virtualbase_paintEngine(self.h))

type QColorDialogpaintEngineProc* = proc(): QPaintEngine
...
proc miqt_exec_callback_QColorDialog_paintEngine(self: ptr cQColorDialog, slot: int): pointer {.exportc: "miqt_exec_callback_QColorDialog_paintEngine ".} =
  ...
  virtualReturn.h
proc QColorDialogevent*(self: gen_qcolordialog_types.QColorDialog, event: QEvent): bool =
  fQColorDialog_virtualbase_event(self.h, event.h)

type QColorDialogeventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QColorDialog_event(self: ptr cQColorDialog, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QColorDialog_event ".} =
  ...
  virtualReturn
proc QColorDialogmousePressEvent*(self: gen_qcolordialog_types.QColorDialog, event: QMouseEvent): void =
  fQColorDialog_virtualbase_mousePressEvent(self.h, event.h)

type QColorDialogmousePressEventProc* = proc(event: QMouseEvent): void
...
proc miqt_exec_callback_QColorDialog_mousePressEvent(self: ptr cQColorDialog, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QColorDialog_mousePressEvent ".} =
  ...
  nimfunc[](slotval1)
proc QColorDialogmouseReleaseEvent*(self: gen_qcolordialog_types.QColorDialog, event: QMouseEvent): void =
  fQColorDialog_virtualbase_mouseReleaseEvent(self.h, event.h)

type QColorDialogmouseReleaseEventProc* = proc(event: QMouseEvent): void
...
proc miqt_exec_callback_QColorDialog_mouseReleaseEvent(self: ptr cQColorDialog, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QColorDialog_mouseReleaseEvent ".} =
  ...
  nimfunc[](slotval1)
proc QColorDialogmouseDoubleClickEvent*(self: gen_qcolordialog_types.QColorDialog, event: QMouseEvent): void =
  fQColorDialog_virtualbase_mouseDoubleClickEvent(self.h, event.h)

type QColorDialogmouseDoubleClickEventProc* = proc(event: QMouseEvent): void
...
proc miqt_exec_callback_QColorDialog_mouseDoubleClickEvent(self: ptr cQColorDialog, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QColorDialog_mouseDoubleClickEvent ".} =
  ...
  nimfunc[](slotval1)
proc QColorDialogmouseMoveEvent*(self: gen_qcolordialog_types.QColorDialog, event: QMouseEvent): void =
  fQColorDialog_virtualbase_mouseMoveEvent(self.h, event.h)

type QColorDialogmouseMoveEventProc* = proc(event: QMouseEvent): void
...
proc miqt_exec_callback_QColorDialog_mouseMoveEvent(self: ptr cQColorDialog, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QColorDialog_mouseMoveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QColorDialogwheelEvent*(self: gen_qcolordialog_types.QColorDialog, event: QWheelEvent): void =
  fQColorDialog_virtualbase_wheelEvent(self.h, event.h)

type QColorDialogwheelEventProc* = proc(event: QWheelEvent): void
...
proc miqt_exec_callback_QColorDialog_wheelEvent(self: ptr cQColorDialog, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QColorDialog_wheelEvent ".} =
  ...
  nimfunc[](slotval1)
proc QColorDialogkeyReleaseEvent*(self: gen_qcolordialog_types.QColorDialog, event: QKeyEvent): void =
  fQColorDialog_virtualbase_keyReleaseEvent(self.h, event.h)

type QColorDialogkeyReleaseEventProc* = proc(event: QKeyEvent): void
...
proc miqt_exec_callback_QColorDialog_keyReleaseEvent(self: ptr cQColorDialog, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QColorDialog_keyReleaseEvent ".} =
  ...
  nimfunc[](slotval1)
proc QColorDialogfocusInEvent*(self: gen_qcolordialog_types.QColorDialog, event: QFocusEvent): void =
  fQColorDialog_virtualbase_focusInEvent(self.h, event.h)

type QColorDialogfocusInEventProc* = proc(event: QFocusEvent): void
...
proc miqt_exec_callback_QColorDialog_focusInEvent(self: ptr cQColorDialog, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QColorDialog_focusInEvent ".} =
  ...
  nimfunc[](slotval1)
proc QColorDialogfocusOutEvent*(self: gen_qcolordialog_types.QColorDialog, event: QFocusEvent): void =
  fQColorDialog_virtualbase_focusOutEvent(self.h, event.h)

type QColorDialogfocusOutEventProc* = proc(event: QFocusEvent): void
...
proc miqt_exec_callback_QColorDialog_focusOutEvent(self: ptr cQColorDialog, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QColorDialog_focusOutEvent ".} =
  ...
  nimfunc[](slotval1)
proc QColorDialogenterEvent*(self: gen_qcolordialog_types.QColorDialog, event: QEnterEvent): void =
  fQColorDialog_virtualbase_enterEvent(self.h, event.h)

type QColorDialogenterEventProc* = proc(event: QEnterEvent): void
...
proc miqt_exec_callback_QColorDialog_enterEvent(self: ptr cQColorDialog, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QColorDialog_enterEvent ".} =
  ...
  nimfunc[](slotval1)
proc QColorDialogleaveEvent*(self: gen_qcolordialog_types.QColorDialog, event: QEvent): void =
  fQColorDialog_virtualbase_leaveEvent(self.h, event.h)

type QColorDialogleaveEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QColorDialog_leaveEvent(self: ptr cQColorDialog, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QColorDialog_leaveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QColorDialogpaintEvent*(self: gen_qcolordialog_types.QColorDialog, event: QPaintEvent): void =
  fQColorDialog_virtualbase_paintEvent(self.h, event.h)

type QColorDialogpaintEventProc* = proc(event: QPaintEvent): void
...
proc miqt_exec_callback_QColorDialog_paintEvent(self: ptr cQColorDialog, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QColorDialog_paintEvent ".} =
  ...
  nimfunc[](slotval1)
proc QColorDialogmoveEvent*(self: gen_qcolordialog_types.QColorDialog, event: QMoveEvent): void =
  fQColorDialog_virtualbase_moveEvent(self.h, event.h)

type QColorDialogmoveEventProc* = proc(event: QMoveEvent): void
...
proc miqt_exec_callback_QColorDialog_moveEvent(self: ptr cQColorDialog, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QColorDialog_moveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QColorDialogtabletEvent*(self: gen_qcolordialog_types.QColorDialog, event: QTabletEvent): void =
  fQColorDialog_virtualbase_tabletEvent(self.h, event.h)

type QColorDialogtabletEventProc* = proc(event: QTabletEvent): void
...
proc miqt_exec_callback_QColorDialog_tabletEvent(self: ptr cQColorDialog, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QColorDialog_tabletEvent ".} =
  ...
  nimfunc[](slotval1)
proc QColorDialogactionEvent*(self: gen_qcolordialog_types.QColorDialog, event: QActionEvent): void =
  fQColorDialog_virtualbase_actionEvent(self.h, event.h)

type QColorDialogactionEventProc* = proc(event: QActionEvent): void
...
proc miqt_exec_callback_QColorDialog_actionEvent(self: ptr cQColorDialog, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QColorDialog_actionEvent ".} =
  ...
  nimfunc[](slotval1)
proc QColorDialogdragEnterEvent*(self: gen_qcolordialog_types.QColorDialog, event: QDragEnterEvent): void =
  fQColorDialog_virtualbase_dragEnterEvent(self.h, event.h)

type QColorDialogdragEnterEventProc* = proc(event: QDragEnterEvent): void
...
proc miqt_exec_callback_QColorDialog_dragEnterEvent(self: ptr cQColorDialog, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QColorDialog_dragEnterEvent ".} =
  ...
  nimfunc[](slotval1)
proc QColorDialogdragMoveEvent*(self: gen_qcolordialog_types.QColorDialog, event: QDragMoveEvent): void =
  fQColorDialog_virtualbase_dragMoveEvent(self.h, event.h)

type QColorDialogdragMoveEventProc* = proc(event: QDragMoveEvent): void
...
proc miqt_exec_callback_QColorDialog_dragMoveEvent(self: ptr cQColorDialog, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QColorDialog_dragMoveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QColorDialogdragLeaveEvent*(self: gen_qcolordialog_types.QColorDialog, event: QDragLeaveEvent): void =
  fQColorDialog_virtualbase_dragLeaveEvent(self.h, event.h)

type QColorDialogdragLeaveEventProc* = proc(event: QDragLeaveEvent): void
...
proc miqt_exec_callback_QColorDialog_dragLeaveEvent(self: ptr cQColorDialog, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QColorDialog_dragLeaveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QColorDialogdropEvent*(self: gen_qcolordialog_types.QColorDialog, event: QDropEvent): void =
  fQColorDialog_virtualbase_dropEvent(self.h, event.h)

type QColorDialogdropEventProc* = proc(event: QDropEvent): void
...
proc miqt_exec_callback_QColorDialog_dropEvent(self: ptr cQColorDialog, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QColorDialog_dropEvent ".} =
  ...
  nimfunc[](slotval1)
proc QColorDialoghideEvent*(self: gen_qcolordialog_types.QColorDialog, event: QHideEvent): void =
  fQColorDialog_virtualbase_hideEvent(self.h, event.h)

type QColorDialoghideEventProc* = proc(event: QHideEvent): void
...
proc miqt_exec_callback_QColorDialog_metric(self: ptr cQColorDialog, slot: int, param1: cint): cint {.exportc: "miqt_exec_callback_QColorDialog_metric ".} =
  ...
  virtualReturn
proc QColorDialoginitPainter*(self: gen_qcolordialog_types.QColorDialog, painter: QPainter): void =
  fQColorDialog_virtualbase_initPainter(self.h, painter.h)

type QColorDialoginitPainterProc* = proc(painter: QPainter): void
...
proc miqt_exec_callback_QColorDialog_initPainter(self: ptr cQColorDialog, slot: int, painter: pointer): void {.exportc: "miqt_exec_callback_QColorDialog_initPainter ".} =
  ...
  nimfunc[](slotval1)
proc QColorDialogredirected*(self: gen_qcolordialog_types.QColorDialog, offset: QPoint): QPaintDevice =
  QPaintDevice(h: fQColorDialog_virtualbase_redirected(self.h, offset.h))

type QColorDialogredirectedProc* = proc(offset: QPoint): QPaintDevice
...
proc miqt_exec_callback_QColorDialog_redirected(self: ptr cQColorDialog, slot: int, offset: pointer): pointer {.exportc: "miqt_exec_callback_QColorDialog_redirected ".} =
  ...
  virtualReturn.h
proc QColorDialogsharedPainter*(self: gen_qcolordialog_types.QColorDialog, ): QPainter =
  QPainter(h: fQColorDialog_virtualbase_sharedPainter(self.h))

type QColorDialogsharedPainterProc* = proc(): QPainter
...
proc miqt_exec_callback_QColorDialog_sharedPainter(self: ptr cQColorDialog, slot: int): pointer {.exportc: "miqt_exec_callback_QColorDialog_sharedPainter ".} =
  ...
  virtualReturn.h
proc QColorDialoginputMethodEvent*(self: gen_qcolordialog_types.QColorDialog, param1: QInputMethodEvent): void =
  fQColorDialog_virtualbase_inputMethodEvent(self.h, param1.h)

type QColorDialoginputMethodEventProc* = proc(param1: QInputMethodEvent): void
...
proc miqt_exec_callback_QColorDialog_inputMethodEvent(self: ptr cQColorDialog, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QColorDialog_inputMethodEvent ".} =
  ...
  nimfunc[](slotval1)
proc QColorDialoginputMethodQuery*(self: gen_qcolordialog_types.QColorDialog, param1: cint): QVariant =
  QVariant(h: fQColorDialog_virtualbase_inputMethodQuery(self.h, cint(param1)))

type QColorDialoginputMethodQueryProc* = proc(param1: cint): QVariant
...
proc miqt_exec_callback_QColorDialog_focusNextPrevChild(self: ptr cQColorDialog, slot: int, next: bool): bool {.exportc: "miqt_exec_callback_QColorDialog_focusNextPrevChild ".} =
  ...
  virtualReturn
proc QColorDialogtimerEvent*(self: gen_qcolordialog_types.QColorDialog, event: QTimerEvent): void =
  fQColorDialog_virtualbase_timerEvent(self.h, event.h)

type QColorDialogtimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QColorDialog_timerEvent(self: ptr cQColorDialog, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QColorDialog_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QColorDialogchildEvent*(self: gen_qcolordialog_types.QColorDialog, event: QChildEvent): void =
  fQColorDialog_virtualbase_childEvent(self.h, event.h)

type QColorDialogchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QColorDialog_childEvent(self: ptr cQColorDialog, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QColorDialog_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QColorDialogcustomEvent*(self: gen_qcolordialog_types.QColorDialog, event: QEvent): void =
  fQColorDialog_virtualbase_customEvent(self.h, event.h)

type QColorDialogcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QColorDialog_customEvent(self: ptr cQColorDialog, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QColorDialog_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QColorDialogconnectNotify*(self: gen_qcolordialog_types.QColorDialog, signal: QMetaMethod): void =
  fQColorDialog_virtualbase_connectNotify(self.h, signal.h)

type QColorDialogconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QColorDialog_connectNotify(self: ptr cQColorDialog, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QColorDialog_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QColorDialogdisconnectNotify*(self: gen_qcolordialog_types.QColorDialog, signal: QMetaMethod): void =
  fQColorDialog_virtualbase_disconnectNotify(self.h, signal.h)

type QColorDialogdisconnectNotifyProc* = proc(signal: QMetaMethod): void
