...
proc getRgba*(_: type gen_qcolordialog_types.QColorDialog, rgba: cuint, ok: ptr bool, parent: QWidget): cuint =
...
proc miqt_exec_callback_QColorDialog_focusOutEvent(self: ptr cQColorDialog, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QColorDialog_focusOutEvent ".} =
  ...
  nimfunc[](slotval1)
proc QColorDialogenterEvent*(self: gen_qcolordialog_types.QColorDialog, event: QEvent): void =
  fQColorDialog_virtualbase_enterEvent(self.h, event.h)

type QColorDialogenterEventProc* = proc(event: QEvent): void
