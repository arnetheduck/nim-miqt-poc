...
func init*(T: type gen_qstackedlayout_types.QStackedLayout, h: ptr cQStackedLayout): gen_qstackedlayout_types.QStackedLayout =
  T(h: h)
proc create*(T: type gen_qstackedlayout_types.QStackedLayout, parent: QWidget): gen_qstackedlayout_types.QStackedLayout =
...
proc create*(T: type gen_qstackedlayout_types.QStackedLayout, parentLayout: QLayout): gen_qstackedlayout_types.QStackedLayout =
  gen_qstackedlayout_types.QStackedLayout.init(fcQStackedLayout_new3(parentLayout.h))

proc metaObject*(self: gen_qstackedlayout_types.QStackedLayout, ): QMetaObject =
  QMetaObject(h: fcQStackedLayout_metaObject(self.h))
...
proc addWidget*(self: gen_qstackedlayout_types.QStackedLayout, w: QWidget): cint =
  fcQStackedLayout_addWidget(self.h, w.h)

proc insertWidget*(self: gen_qstackedlayout_types.QStackedLayout, index: cint, w: QWidget): cint =
  fcQStackedLayout_insertWidget(self.h, index, w.h)

proc currentWidget*(self: gen_qstackedlayout_types.QStackedLayout, ): QWidget =
  QWidget(h: fcQStackedLayout_currentWidget(self.h))

proc currentIndex*(self: gen_qstackedlayout_types.QStackedLayout, ): cint =
  fcQStackedLayout_currentIndex(self.h)

proc widget*(self: gen_qstackedlayout_types.QStackedLayout, param1: cint): QWidget =
  QWidget(h: fcQStackedLayout_widget(self.h, param1))
...
proc addItem*(self: gen_qstackedlayout_types.QStackedLayout, item: QLayoutItem): void =
  fcQStackedLayout_addItem(self.h, item.h)

proc sizeHint*(self: gen_qstackedlayout_types.QStackedLayout, ): QSize =
  QSize(h: fcQStackedLayout_sizeHint(self.h))

proc minimumSize*(self: gen_qstackedlayout_types.QStackedLayout, ): QSize =
  QSize(h: fcQStackedLayout_minimumSize(self.h))

proc itemAt*(self: gen_qstackedlayout_types.QStackedLayout, param1: cint): QLayoutItem =
  QLayoutItem(h: fcQStackedLayout_itemAt(self.h, param1))

proc takeAt*(self: gen_qstackedlayout_types.QStackedLayout, param1: cint): QLayoutItem =
  QLayoutItem(h: fcQStackedLayout_takeAt(self.h, param1))

proc setGeometry*(self: gen_qstackedlayout_types.QStackedLayout, rect: QRect): void =
...
proc setCurrentWidget*(self: gen_qstackedlayout_types.QStackedLayout, w: QWidget): void =
...
proc miqt_exec_callback_QStackedLayout_count(self: ptr cQStackedLayout, slot: int): cint {.exportc: "miqt_exec_callback_QStackedLayout_count ".} =
  ...
  virtualReturn
proc QStackedLayoutaddItem*(self: gen_qstackedlayout_types.QStackedLayout, item: QLayoutItem): void =
  fQStackedLayout_virtualbase_addItem(self.h, item.h)

type QStackedLayoutaddItemProc* = proc(item: QLayoutItem): void
...
proc miqt_exec_callback_QStackedLayout_addItem(self: ptr cQStackedLayout, slot: int, item: pointer): void {.exportc: "miqt_exec_callback_QStackedLayout_addItem ".} =
  ...
  nimfunc[](slotval1)
proc QStackedLayoutsizeHint*(self: gen_qstackedlayout_types.QStackedLayout, ): QSize =
  QSize(h: fQStackedLayout_virtualbase_sizeHint(self.h))

type QStackedLayoutsizeHintProc* = proc(): QSize
...
proc miqt_exec_callback_QStackedLayout_sizeHint(self: ptr cQStackedLayout, slot: int): pointer {.exportc: "miqt_exec_callback_QStackedLayout_sizeHint ".} =
  ...
  virtualReturn.h
proc QStackedLayoutminimumSize*(self: gen_qstackedlayout_types.QStackedLayout, ): QSize =
  QSize(h: fQStackedLayout_virtualbase_minimumSize(self.h))

type QStackedLayoutminimumSizeProc* = proc(): QSize
...
proc miqt_exec_callback_QStackedLayout_minimumSize(self: ptr cQStackedLayout, slot: int): pointer {.exportc: "miqt_exec_callback_QStackedLayout_minimumSize ".} =
  ...
  virtualReturn.h
proc QStackedLayoutitemAt*(self: gen_qstackedlayout_types.QStackedLayout, param1: cint): QLayoutItem =
  QLayoutItem(h: fQStackedLayout_virtualbase_itemAt(self.h, param1))

type QStackedLayoutitemAtProc* = proc(param1: cint): QLayoutItem
...
proc miqt_exec_callback_QStackedLayout_itemAt(self: ptr cQStackedLayout, slot: int, param1: cint): pointer {.exportc: "miqt_exec_callback_QStackedLayout_itemAt ".} =
  ...
  virtualReturn.h
proc QStackedLayouttakeAt*(self: gen_qstackedlayout_types.QStackedLayout, param1: cint): QLayoutItem =
  QLayoutItem(h: fQStackedLayout_virtualbase_takeAt(self.h, param1))

type QStackedLayouttakeAtProc* = proc(param1: cint): QLayoutItem
...
proc miqt_exec_callback_QStackedLayout_takeAt(self: ptr cQStackedLayout, slot: int, param1: cint): pointer {.exportc: "miqt_exec_callback_QStackedLayout_takeAt ".} =
  ...
  virtualReturn.h
proc QStackedLayoutsetGeometry*(self: gen_qstackedlayout_types.QStackedLayout, rect: QRect): void =
  fQStackedLayout_virtualbase_setGeometry(self.h, rect.h)

type QStackedLayoutsetGeometryProc* = proc(rect: QRect): void
...
type QStackedLayoutspacingProc* = proc(): cint
proc onspacing*(self: gen_qstackedlayout_types.QStackedLayout, slot: QStackedLayoutspacingProc) =
  # TODO check subclass
  var tmp = new QStackedLayoutspacingProc
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QStackedLayout_spacing(self: ptr cQStackedLayout, slot: int): cint {.exportc: "miqt_exec_callback_QStackedLayout_spacing ".} =
  var nimfunc = cast[ptr QStackedLayoutspacingProc](cast[pointer](slot))
...
type QStackedLayoutsetSpacingProc* = proc(spacing: cint): void
proc onsetSpacing*(self: gen_qstackedlayout_types.QStackedLayout, slot: QStackedLayoutsetSpacingProc) =
  # TODO check subclass
  var tmp = new QStackedLayoutsetSpacingProc
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QStackedLayout_setSpacing(self: ptr cQStackedLayout, slot: int, spacing: cint): void {.exportc: "miqt_exec_callback_QStackedLayout_setSpacing ".} =
  var nimfunc = cast[ptr QStackedLayoutsetSpacingProc](cast[pointer](slot))
...
proc miqt_exec_callback_QStackedLayout_invalidate(self: ptr cQStackedLayout, slot: int): void {.exportc: "miqt_exec_callback_QStackedLayout_invalidate ".} =
  ...
  nimfunc[]()
proc QStackedLayoutgeometry*(self: gen_qstackedlayout_types.QStackedLayout, ): QRect =
  QRect(h: fQStackedLayout_virtualbase_geometry(self.h))

type QStackedLayoutgeometryProc* = proc(): QRect
...
proc miqt_exec_callback_QStackedLayout_expandingDirections(self: ptr cQStackedLayout, slot: int): cint {.exportc: "miqt_exec_callback_QStackedLayout_expandingDirections ".} =
  ...
  cint(virtualReturn)
proc QStackedLayoutmaximumSize*(self: gen_qstackedlayout_types.QStackedLayout, ): QSize =
  QSize(h: fQStackedLayout_virtualbase_maximumSize(self.h))

type QStackedLayoutmaximumSizeProc* = proc(): QSize
...
proc miqt_exec_callback_QStackedLayout_maximumSize(self: ptr cQStackedLayout, slot: int): pointer {.exportc: "miqt_exec_callback_QStackedLayout_maximumSize ".} =
  ...
  virtualReturn.h
proc QStackedLayoutindexOf*(self: gen_qstackedlayout_types.QStackedLayout, param1: QWidget): cint =
  fQStackedLayout_virtualbase_indexOf(self.h, param1.h)

type QStackedLayoutindexOfProc* = proc(param1: QWidget): cint
...
proc miqt_exec_callback_QStackedLayout_controlTypes(self: ptr cQStackedLayout, slot: int): cint {.exportc: "miqt_exec_callback_QStackedLayout_controlTypes ".} =
  ...
  cint(virtualReturn)
proc QStackedLayoutreplaceWidget*(self: gen_qstackedlayout_types.QStackedLayout, fromVal: QWidget, to: QWidget, options: cint): QLayoutItem =
  QLayoutItem(h: fQStackedLayout_virtualbase_replaceWidget(self.h, fromVal.h, to.h, cint(options)))

type QStackedLayoutreplaceWidgetProc* = proc(fromVal: QWidget, to: QWidget, options: cint): QLayoutItem
proc onreplaceWidget*(self: gen_qstackedlayout_types.QStackedLayout, slot: QStackedLayoutreplaceWidgetProc) =
  # TODO check subclass
  var tmp = new QStackedLayoutreplaceWidgetProc
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QStackedLayout_replaceWidget(self: ptr cQStackedLayout, slot: int, fromVal: pointer, to: pointer, options: cint): pointer {.exportc: "miqt_exec_callback_QStackedLayout_replaceWidget ".} =
  var nimfunc = cast[ptr QStackedLayoutreplaceWidgetProc](cast[pointer](slot))
  ...
  virtualReturn.h
proc QStackedLayoutlayout*(self: gen_qstackedlayout_types.QStackedLayout, ): QLayout =
  QLayout(h: fQStackedLayout_virtualbase_layout(self.h))

type QStackedLayoutlayoutProc* = proc(): QLayout
...
proc miqt_exec_callback_QStackedLayout_layout(self: ptr cQStackedLayout, slot: int): pointer {.exportc: "miqt_exec_callback_QStackedLayout_layout ".} =
  ...
  virtualReturn.h
proc QStackedLayoutchildEvent*(self: gen_qstackedlayout_types.QStackedLayout, e: QChildEvent): void =
  fQStackedLayout_virtualbase_childEvent(self.h, e.h)

type QStackedLayoutchildEventProc* = proc(e: QChildEvent): void
...
proc miqt_exec_callback_QStackedLayout_childEvent(self: ptr cQStackedLayout, slot: int, e: pointer): void {.exportc: "miqt_exec_callback_QStackedLayout_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QStackedLayoutevent*(self: gen_qstackedlayout_types.QStackedLayout, event: QEvent): bool =
  fQStackedLayout_virtualbase_event(self.h, event.h)

type QStackedLayouteventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QStackedLayout_event(self: ptr cQStackedLayout, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QStackedLayout_event ".} =
  ...
  virtualReturn
proc QStackedLayouteventFilter*(self: gen_qstackedlayout_types.QStackedLayout, watched: QObject, event: QEvent): bool =
  fQStackedLayout_virtualbase_eventFilter(self.h, watched.h, event.h)

type QStackedLayouteventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QStackedLayout_eventFilter(self: ptr cQStackedLayout, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QStackedLayout_eventFilter ".} =
  ...
  virtualReturn
proc QStackedLayouttimerEvent*(self: gen_qstackedlayout_types.QStackedLayout, event: QTimerEvent): void =
  fQStackedLayout_virtualbase_timerEvent(self.h, event.h)

type QStackedLayouttimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QStackedLayout_timerEvent(self: ptr cQStackedLayout, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QStackedLayout_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QStackedLayoutcustomEvent*(self: gen_qstackedlayout_types.QStackedLayout, event: QEvent): void =
  fQStackedLayout_virtualbase_customEvent(self.h, event.h)

type QStackedLayoutcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QStackedLayout_customEvent(self: ptr cQStackedLayout, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QStackedLayout_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QStackedLayoutconnectNotify*(self: gen_qstackedlayout_types.QStackedLayout, signal: QMetaMethod): void =
  fQStackedLayout_virtualbase_connectNotify(self.h, signal.h)

type QStackedLayoutconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QStackedLayout_connectNotify(self: ptr cQStackedLayout, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QStackedLayout_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QStackedLayoutdisconnectNotify*(self: gen_qstackedlayout_types.QStackedLayout, signal: QMetaMethod): void =
  fQStackedLayout_virtualbase_disconnectNotify(self.h, signal.h)

type QStackedLayoutdisconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QStackedLayout_minimumHeightForWidth(self: ptr cQStackedLayout, slot: int, param1: cint): cint {.exportc: "miqt_exec_callback_QStackedLayout_minimumHeightForWidth ".} =
  ...
  virtualReturn
proc QStackedLayoutwidget*(self: gen_qstackedlayout_types.QStackedLayout, ): QWidget =
  QWidget(h: fQStackedLayout_virtualbase_widget(self.h))

type QStackedLayoutwidgetProc* = proc(): QWidget
...
proc miqt_exec_callback_QStackedLayout_widget(self: ptr cQStackedLayout, slot: int): pointer {.exportc: "miqt_exec_callback_QStackedLayout_widget ".} =
  ...
  virtualReturn.h
proc QStackedLayoutspacerItem*(self: gen_qstackedlayout_types.QStackedLayout, ): QSpacerItem =
  QSpacerItem(h: fQStackedLayout_virtualbase_spacerItem(self.h))

type QStackedLayoutspacerItemProc* = proc(): QSpacerItem
