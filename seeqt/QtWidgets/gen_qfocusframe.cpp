...
QMetaObject* QFocusFrame_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQFocusFrame*)(self) )->QFocusFrame::metaObject();

}

void* QFocusFrame_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQFocusFrame*)(self) )->QFocusFrame::qt_metacast(param1);

}

int QFocusFrame_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQFocusFrame*)(self) )->QFocusFrame::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
void QFocusFrame_virtualbase_initStyleOption(const void* self, QStyleOption* option) {
	...
	( (const MiqtVirtualQFocusFrame*)(self) )->QFocusFrame::initStyleOption(option);
...
bool QFocusFrame_virtualbase_nativeEvent(void* self, struct miqt_string eventType, void* message, intptr_t* result) {
	...
	return ( (MiqtVirtualQFocusFrame*)(self) )->QFocusFrame::nativeEvent(eventType_QByteArray, message, (qintptr*)(result));
...
void QFocusFrame_protectedbase_updateMicroFocus(void* self) {
	MiqtVirtualQFocusFrame* self_cast = static_cast<MiqtVirtualQFocusFrame*>( (QFocusFrame*)(self) );
