...
void QDialog_connect_finished(QDialog* self, intptr_t slot, void (*callback)(intptr_t, int), void (*release)(intptr_t)) {
	...
	MiqtVirtualQDialog::connect(self, static_cast<void (QDialog::*)(int)>(&QDialog::finished), self, caller{slot, callback, release});
}
...
void QDialog_connect_accepted(QDialog* self, intptr_t slot, void (*callback)(intptr_t), void (*release)(intptr_t)) {
	...
	MiqtVirtualQDialog::connect(self, static_cast<void (QDialog::*)()>(&QDialog::accepted), self, caller{slot, callback, release});
}
...
void QDialog_connect_rejected(QDialog* self, intptr_t slot, void (*callback)(intptr_t), void (*release)(intptr_t)) {
	...
	MiqtVirtualQDialog::connect(self, static_cast<void (QDialog::*)()>(&QDialog::rejected), self, caller{slot, callback, release});
}
...
QMetaObject* QDialog_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQDialog*)(self) )->QDialog::metaObject();

}

void* QDialog_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQDialog*)(self) )->QDialog::qt_metacast(param1);

}

int QDialog_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQDialog*)(self) )->QDialog::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
bool QDialog_virtualbase_nativeEvent(void* self, struct miqt_string eventType, void* message, long* result) {
	...
	return ( (MiqtVirtualQDialog*)(self) )->QDialog::nativeEvent(eventType_QByteArray, message, static_cast<long*>(result));
