...
proc create*(T: type gen_qbuttongroup_types.QButtonGroup, parent: QObject): gen_qbuttongroup_types.QButtonGroup =
  gen_qbuttongroup_types.QButtonGroup.init(fcQButtonGroup_new2(parent.h))

proc metaObject*(self: gen_qbuttongroup_types.QButtonGroup, ): QMetaObject =
  QMetaObject(h: fcQButtonGroup_metaObject(self.h))
...
proc addButton*(self: gen_qbuttongroup_types.QButtonGroup, param1: QAbstractButton): void =
  fcQButtonGroup_addButton(self.h, param1.h)

proc removeButton*(self: gen_qbuttongroup_types.QButtonGroup, param1: QAbstractButton): void =
  fcQButtonGroup_removeButton(self.h, param1.h)

proc buttons*(self: gen_qbuttongroup_types.QButtonGroup, ): seq[QAbstractButton] =
...
proc checkedButton*(self: gen_qbuttongroup_types.QButtonGroup, ): QAbstractButton =
  QAbstractButton(h: fcQButtonGroup_checkedButton(self.h))

proc button*(self: gen_qbuttongroup_types.QButtonGroup, id: cint): QAbstractButton =
  QAbstractButton(h: fcQButtonGroup_button(self.h, id))

proc setId*(self: gen_qbuttongroup_types.QButtonGroup, button: QAbstractButton, id: cint): void =
  fcQButtonGroup_setId(self.h, button.h, id)

proc id*(self: gen_qbuttongroup_types.QButtonGroup, button: QAbstractButton): cint =
...
proc buttonClicked*(self: gen_qbuttongroup_types.QButtonGroup, param1: QAbstractButton): void =
  fcQButtonGroup_buttonClicked(self.h, param1.h)

type QButtonGroupbuttonClickedSlot* = proc(param1: QAbstractButton)
proc miqt_exec_callback_QButtonGroup_buttonClicked(slot: int, param1: pointer) {.exportc.} =
  ...
  let slotval1 = QAbstractButton(h: param1)
...
proc buttonPressed*(self: gen_qbuttongroup_types.QButtonGroup, param1: QAbstractButton): void =
  fcQButtonGroup_buttonPressed(self.h, param1.h)

type QButtonGroupbuttonPressedSlot* = proc(param1: QAbstractButton)
...
proc buttonReleased*(self: gen_qbuttongroup_types.QButtonGroup, param1: QAbstractButton): void =
  fcQButtonGroup_buttonReleased(self.h, param1.h)

type QButtonGroupbuttonReleasedSlot* = proc(param1: QAbstractButton)
...
proc buttonToggled*(self: gen_qbuttongroup_types.QButtonGroup, param1: QAbstractButton, param2: bool): void =
  fcQButtonGroup_buttonToggled(self.h, param1.h, param2)

type QButtonGroupbuttonToggledSlot* = proc(param1: QAbstractButton, param2: bool)
...
proc addButton*(self: gen_qbuttongroup_types.QButtonGroup, param1: QAbstractButton, id: cint): void =
...
proc miqt_exec_callback_QButtonGroup_metacall(self: ptr cQButtonGroup, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QButtonGroup_metacall ".} =
  ...
  virtualReturn
proc QButtonGroupevent*(self: gen_qbuttongroup_types.QButtonGroup, event: QEvent): bool =
  fQButtonGroup_virtualbase_event(self.h, event.h)

type QButtonGroupeventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QButtonGroup_event(self: ptr cQButtonGroup, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QButtonGroup_event ".} =
  ...
  virtualReturn
proc QButtonGroupeventFilter*(self: gen_qbuttongroup_types.QButtonGroup, watched: QObject, event: QEvent): bool =
  fQButtonGroup_virtualbase_eventFilter(self.h, watched.h, event.h)

type QButtonGroupeventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QButtonGroup_eventFilter(self: ptr cQButtonGroup, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QButtonGroup_eventFilter ".} =
  ...
  virtualReturn
proc QButtonGrouptimerEvent*(self: gen_qbuttongroup_types.QButtonGroup, event: QTimerEvent): void =
  fQButtonGroup_virtualbase_timerEvent(self.h, event.h)

type QButtonGrouptimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QButtonGroup_timerEvent(self: ptr cQButtonGroup, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QButtonGroup_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QButtonGroupchildEvent*(self: gen_qbuttongroup_types.QButtonGroup, event: QChildEvent): void =
  fQButtonGroup_virtualbase_childEvent(self.h, event.h)

type QButtonGroupchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QButtonGroup_childEvent(self: ptr cQButtonGroup, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QButtonGroup_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QButtonGroupcustomEvent*(self: gen_qbuttongroup_types.QButtonGroup, event: QEvent): void =
  fQButtonGroup_virtualbase_customEvent(self.h, event.h)

type QButtonGroupcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QButtonGroup_customEvent(self: ptr cQButtonGroup, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QButtonGroup_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QButtonGroupconnectNotify*(self: gen_qbuttongroup_types.QButtonGroup, signal: QMetaMethod): void =
  fQButtonGroup_virtualbase_connectNotify(self.h, signal.h)

type QButtonGroupconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QButtonGroup_connectNotify(self: ptr cQButtonGroup, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QButtonGroup_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QButtonGroupdisconnectNotify*(self: gen_qbuttongroup_types.QButtonGroup, signal: QMetaMethod): void =
  fQButtonGroup_virtualbase_disconnectNotify(self.h, signal.h)

type QButtonGroupdisconnectNotifyProc* = proc(signal: QMetaMethod): void
