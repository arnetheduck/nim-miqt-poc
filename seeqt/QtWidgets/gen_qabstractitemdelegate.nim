...
proc create*(T: type gen_qabstractitemdelegate_types.QAbstractItemDelegate, parent: QObject): gen_qabstractitemdelegate_types.QAbstractItemDelegate =
  gen_qabstractitemdelegate_types.QAbstractItemDelegate.init(fcQAbstractItemDelegate_new2(parent.h))

proc metaObject*(self: gen_qabstractitemdelegate_types.QAbstractItemDelegate, ): QMetaObject =
  QMetaObject(h: fcQAbstractItemDelegate_metaObject(self.h))
...
proc paint*(self: gen_qabstractitemdelegate_types.QAbstractItemDelegate, painter: QPainter, option: QStyleOptionViewItem, index: QModelIndex): void =
  fcQAbstractItemDelegate_paint(self.h, painter.h, option.h, index.h)

proc sizeHint*(self: gen_qabstractitemdelegate_types.QAbstractItemDelegate, option: QStyleOptionViewItem, index: QModelIndex): QSize =
  QSize(h: fcQAbstractItemDelegate_sizeHint(self.h, option.h, index.h))

proc createEditor*(self: gen_qabstractitemdelegate_types.QAbstractItemDelegate, parent: QWidget, option: QStyleOptionViewItem, index: QModelIndex): QWidget =
  QWidget(h: fcQAbstractItemDelegate_createEditor(self.h, parent.h, option.h, index.h))

proc destroyEditor*(self: gen_qabstractitemdelegate_types.QAbstractItemDelegate, editor: QWidget, index: QModelIndex): void =
  fcQAbstractItemDelegate_destroyEditor(self.h, editor.h, index.h)

proc setEditorData*(self: gen_qabstractitemdelegate_types.QAbstractItemDelegate, editor: QWidget, index: QModelIndex): void =
  fcQAbstractItemDelegate_setEditorData(self.h, editor.h, index.h)

proc setModelData*(self: gen_qabstractitemdelegate_types.QAbstractItemDelegate, editor: QWidget, model: QAbstractItemModel, index: QModelIndex): void =
  fcQAbstractItemDelegate_setModelData(self.h, editor.h, model.h, index.h)

proc updateEditorGeometry*(self: gen_qabstractitemdelegate_types.QAbstractItemDelegate, editor: QWidget, option: QStyleOptionViewItem, index: QModelIndex): void =
  fcQAbstractItemDelegate_updateEditorGeometry(self.h, editor.h, option.h, index.h)

proc editorEvent*(self: gen_qabstractitemdelegate_types.QAbstractItemDelegate, event: QEvent, model: QAbstractItemModel, option: QStyleOptionViewItem, index: QModelIndex): bool =
  fcQAbstractItemDelegate_editorEvent(self.h, event.h, model.h, option.h, index.h)

proc elidedText*(_: type gen_qabstractitemdelegate_types.QAbstractItemDelegate, fontMetrics: QFontMetrics, width: cint, mode: cint, text: string): string =
...
proc helpEvent*(self: gen_qabstractitemdelegate_types.QAbstractItemDelegate, event: QHelpEvent, view: QAbstractItemView, option: QStyleOptionViewItem, index: QModelIndex): bool =
...
proc commitData*(self: gen_qabstractitemdelegate_types.QAbstractItemDelegate, editor: QWidget): void =
  fcQAbstractItemDelegate_commitData(self.h, editor.h)

type QAbstractItemDelegatecommitDataSlot* = proc(editor: QWidget)
...
proc closeEditor*(self: gen_qabstractitemdelegate_types.QAbstractItemDelegate, editor: QWidget): void =
  fcQAbstractItemDelegate_closeEditor(self.h, editor.h)

type QAbstractItemDelegatecloseEditorSlot* = proc(editor: QWidget)
...
proc sizeHintChanged*(self: gen_qabstractitemdelegate_types.QAbstractItemDelegate, param1: QModelIndex): void =
  fcQAbstractItemDelegate_sizeHintChanged(self.h, param1.h)

type QAbstractItemDelegatesizeHintChangedSlot* = proc(param1: QModelIndex)
proc miqt_exec_callback_QAbstractItemDelegate_sizeHintChanged(slot: int, param1: pointer) {.exportc.} =
  ...
  let slotval1 = QModelIndex(h: param1)
...
proc closeEditor*(self: gen_qabstractitemdelegate_types.QAbstractItemDelegate, editor: QWidget, hint: cint): void =
  fcQAbstractItemDelegate_closeEditor2(self.h, editor.h, cint(hint))

type QAbstractItemDelegatecloseEditor2Slot* = proc(editor: QWidget, hint: cint)
...
proc miqt_exec_callback_QAbstractItemDelegate_metacall(self: ptr cQAbstractItemDelegate, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QAbstractItemDelegate_metacall ".} =
  ...
  virtualReturn
type QAbstractItemDelegatepaintProc* = proc(painter: QPainter, option: QStyleOptionViewItem, index: QModelIndex): void
...
type QAbstractItemDelegatesizeHintProc* = proc(option: QStyleOptionViewItem, index: QModelIndex): QSize
...
proc miqt_exec_callback_QAbstractItemDelegate_sizeHint(self: ptr cQAbstractItemDelegate, slot: int, option: pointer, index: pointer): pointer {.exportc: "miqt_exec_callback_QAbstractItemDelegate_sizeHint ".} =
  ...
  virtualReturn.h
proc QAbstractItemDelegatecreateEditor*(self: gen_qabstractitemdelegate_types.QAbstractItemDelegate, parent: QWidget, option: QStyleOptionViewItem, index: QModelIndex): QWidget =
  QWidget(h: fQAbstractItemDelegate_virtualbase_createEditor(self.h, parent.h, option.h, index.h))

type QAbstractItemDelegatecreateEditorProc* = proc(parent: QWidget, option: QStyleOptionViewItem, index: QModelIndex): QWidget
...
proc miqt_exec_callback_QAbstractItemDelegate_createEditor(self: ptr cQAbstractItemDelegate, slot: int, parent: pointer, option: pointer, index: pointer): pointer {.exportc: "miqt_exec_callback_QAbstractItemDelegate_createEditor ".} =
  ...
  virtualReturn.h
proc QAbstractItemDelegatedestroyEditor*(self: gen_qabstractitemdelegate_types.QAbstractItemDelegate, editor: QWidget, index: QModelIndex): void =
  fQAbstractItemDelegate_virtualbase_destroyEditor(self.h, editor.h, index.h)

type QAbstractItemDelegatedestroyEditorProc* = proc(editor: QWidget, index: QModelIndex): void
...
proc miqt_exec_callback_QAbstractItemDelegate_destroyEditor(self: ptr cQAbstractItemDelegate, slot: int, editor: pointer, index: pointer): void {.exportc: "miqt_exec_callback_QAbstractItemDelegate_destroyEditor ".} =
  ...
  nimfunc[](slotval1, slotval2)
proc QAbstractItemDelegatesetEditorData*(self: gen_qabstractitemdelegate_types.QAbstractItemDelegate, editor: QWidget, index: QModelIndex): void =
  fQAbstractItemDelegate_virtualbase_setEditorData(self.h, editor.h, index.h)

type QAbstractItemDelegatesetEditorDataProc* = proc(editor: QWidget, index: QModelIndex): void
...
proc miqt_exec_callback_QAbstractItemDelegate_setEditorData(self: ptr cQAbstractItemDelegate, slot: int, editor: pointer, index: pointer): void {.exportc: "miqt_exec_callback_QAbstractItemDelegate_setEditorData ".} =
  ...
  nimfunc[](slotval1, slotval2)
proc QAbstractItemDelegatesetModelData*(self: gen_qabstractitemdelegate_types.QAbstractItemDelegate, editor: QWidget, model: QAbstractItemModel, index: QModelIndex): void =
  fQAbstractItemDelegate_virtualbase_setModelData(self.h, editor.h, model.h, index.h)

type QAbstractItemDelegatesetModelDataProc* = proc(editor: QWidget, model: QAbstractItemModel, index: QModelIndex): void
...
proc miqt_exec_callback_QAbstractItemDelegate_setModelData(self: ptr cQAbstractItemDelegate, slot: int, editor: pointer, model: pointer, index: pointer): void {.exportc: "miqt_exec_callback_QAbstractItemDelegate_setModelData ".} =
  ...
  nimfunc[](slotval1, slotval2, slotval3)
proc QAbstractItemDelegateupdateEditorGeometry*(self: gen_qabstractitemdelegate_types.QAbstractItemDelegate, editor: QWidget, option: QStyleOptionViewItem, index: QModelIndex): void =
  fQAbstractItemDelegate_virtualbase_updateEditorGeometry(self.h, editor.h, option.h, index.h)

type QAbstractItemDelegateupdateEditorGeometryProc* = proc(editor: QWidget, option: QStyleOptionViewItem, index: QModelIndex): void
...
proc miqt_exec_callback_QAbstractItemDelegate_updateEditorGeometry(self: ptr cQAbstractItemDelegate, slot: int, editor: pointer, option: pointer, index: pointer): void {.exportc: "miqt_exec_callback_QAbstractItemDelegate_updateEditorGeometry ".} =
  ...
  nimfunc[](slotval1, slotval2, slotval3)
proc QAbstractItemDelegateeditorEvent*(self: gen_qabstractitemdelegate_types.QAbstractItemDelegate, event: QEvent, model: QAbstractItemModel, option: QStyleOptionViewItem, index: QModelIndex): bool =
  fQAbstractItemDelegate_virtualbase_editorEvent(self.h, event.h, model.h, option.h, index.h)

type QAbstractItemDelegateeditorEventProc* = proc(event: QEvent, model: QAbstractItemModel, option: QStyleOptionViewItem, index: QModelIndex): bool
...
proc miqt_exec_callback_QAbstractItemDelegate_editorEvent(self: ptr cQAbstractItemDelegate, slot: int, event: pointer, model: pointer, option: pointer, index: pointer): bool {.exportc: "miqt_exec_callback_QAbstractItemDelegate_editorEvent ".} =
  ...
  virtualReturn
proc QAbstractItemDelegatehelpEvent*(self: gen_qabstractitemdelegate_types.QAbstractItemDelegate, event: QHelpEvent, view: QAbstractItemView, option: QStyleOptionViewItem, index: QModelIndex): bool =
  fQAbstractItemDelegate_virtualbase_helpEvent(self.h, event.h, view.h, option.h, index.h)

type QAbstractItemDelegatehelpEventProc* = proc(event: QHelpEvent, view: QAbstractItemView, option: QStyleOptionViewItem, index: QModelIndex): bool
...
proc QAbstractItemDelegateevent*(self: gen_qabstractitemdelegate_types.QAbstractItemDelegate, event: QEvent): bool =
  fQAbstractItemDelegate_virtualbase_event(self.h, event.h)

type QAbstractItemDelegateeventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QAbstractItemDelegate_event(self: ptr cQAbstractItemDelegate, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QAbstractItemDelegate_event ".} =
  ...
  virtualReturn
proc QAbstractItemDelegateeventFilter*(self: gen_qabstractitemdelegate_types.QAbstractItemDelegate, watched: QObject, event: QEvent): bool =
  fQAbstractItemDelegate_virtualbase_eventFilter(self.h, watched.h, event.h)

type QAbstractItemDelegateeventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QAbstractItemDelegate_eventFilter(self: ptr cQAbstractItemDelegate, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QAbstractItemDelegate_eventFilter ".} =
  ...
  virtualReturn
proc QAbstractItemDelegatetimerEvent*(self: gen_qabstractitemdelegate_types.QAbstractItemDelegate, event: QTimerEvent): void =
  fQAbstractItemDelegate_virtualbase_timerEvent(self.h, event.h)

type QAbstractItemDelegatetimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QAbstractItemDelegate_timerEvent(self: ptr cQAbstractItemDelegate, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QAbstractItemDelegate_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QAbstractItemDelegatechildEvent*(self: gen_qabstractitemdelegate_types.QAbstractItemDelegate, event: QChildEvent): void =
  fQAbstractItemDelegate_virtualbase_childEvent(self.h, event.h)

type QAbstractItemDelegatechildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QAbstractItemDelegate_childEvent(self: ptr cQAbstractItemDelegate, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QAbstractItemDelegate_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QAbstractItemDelegatecustomEvent*(self: gen_qabstractitemdelegate_types.QAbstractItemDelegate, event: QEvent): void =
  fQAbstractItemDelegate_virtualbase_customEvent(self.h, event.h)

type QAbstractItemDelegatecustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QAbstractItemDelegate_customEvent(self: ptr cQAbstractItemDelegate, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QAbstractItemDelegate_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QAbstractItemDelegateconnectNotify*(self: gen_qabstractitemdelegate_types.QAbstractItemDelegate, signal: QMetaMethod): void =
  fQAbstractItemDelegate_virtualbase_connectNotify(self.h, signal.h)

type QAbstractItemDelegateconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QAbstractItemDelegate_connectNotify(self: ptr cQAbstractItemDelegate, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QAbstractItemDelegate_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QAbstractItemDelegatedisconnectNotify*(self: gen_qabstractitemdelegate_types.QAbstractItemDelegate, signal: QMetaMethod): void =
  fQAbstractItemDelegate_virtualbase_disconnectNotify(self.h, signal.h)

type QAbstractItemDelegatedisconnectNotifyProc* = proc(signal: QMetaMethod): void
