...
proc create*(T: type gen_qgraphicswidget_types.QGraphicsWidget, parent: QGraphicsItem): gen_qgraphicswidget_types.QGraphicsWidget =
  gen_qgraphicswidget_types.QGraphicsWidget.init(fcQGraphicsWidget_new2(parent.h))

proc create*(T: type gen_qgraphicswidget_types.QGraphicsWidget, parent: QGraphicsItem, wFlags: cint): gen_qgraphicswidget_types.QGraphicsWidget =
  gen_qgraphicswidget_types.QGraphicsWidget.init(fcQGraphicsWidget_new3(parent.h, cint(wFlags)))

proc metaObject*(self: gen_qgraphicswidget_types.QGraphicsWidget, ): QMetaObject =
  QMetaObject(h: fcQGraphicsWidget_metaObject(self.h))
...
proc layout*(self: gen_qgraphicswidget_types.QGraphicsWidget, ): QGraphicsLayout =
  QGraphicsLayout(h: fcQGraphicsWidget_layout(self.h))

proc setLayout*(self: gen_qgraphicswidget_types.QGraphicsWidget, layout: QGraphicsLayout): void =
...
proc style*(self: gen_qgraphicswidget_types.QGraphicsWidget, ): QStyle =
  QStyle(h: fcQGraphicsWidget_style(self.h))

proc setStyle*(self: gen_qgraphicswidget_types.QGraphicsWidget, style: QStyle): void =
  fcQGraphicsWidget_setStyle(self.h, style.h)

proc font*(self: gen_qgraphicswidget_types.QGraphicsWidget, ): QFont =
  QFont(h: fcQGraphicsWidget_font(self.h))

proc setFont*(self: gen_qgraphicswidget_types.QGraphicsWidget, font: QFont): void =
  fcQGraphicsWidget_setFont(self.h, font.h)

proc palette*(self: gen_qgraphicswidget_types.QGraphicsWidget, ): QPalette =
  QPalette(h: fcQGraphicsWidget_palette(self.h))

proc setPalette*(self: gen_qgraphicswidget_types.QGraphicsWidget, palette: QPalette): void =
...
proc resize*(self: gen_qgraphicswidget_types.QGraphicsWidget, size: QSizeF): void =
...
proc size*(self: gen_qgraphicswidget_types.QGraphicsWidget, ): QSizeF =
  QSizeF(h: fcQGraphicsWidget_size(self.h))

proc setGeometry*(self: gen_qgraphicswidget_types.QGraphicsWidget, rect: QRectF): void =
...
proc rect*(self: gen_qgraphicswidget_types.QGraphicsWidget, ): QRectF =
  QRectF(h: fcQGraphicsWidget_rect(self.h))
...
proc setContentsMargins*(self: gen_qgraphicswidget_types.QGraphicsWidget, margins: QMarginsF): void =
...
proc setWindowFrameMargins*(self: gen_qgraphicswidget_types.QGraphicsWidget, margins: QMarginsF): void =
...
proc windowFrameGeometry*(self: gen_qgraphicswidget_types.QGraphicsWidget, ): QRectF =
  QRectF(h: fcQGraphicsWidget_windowFrameGeometry(self.h))

proc windowFrameRect*(self: gen_qgraphicswidget_types.QGraphicsWidget, ): QRectF =
  QRectF(h: fcQGraphicsWidget_windowFrameRect(self.h))
...
proc setTabOrder*(_: type gen_qgraphicswidget_types.QGraphicsWidget, first: QGraphicsWidget, second: QGraphicsWidget): void =
  fcQGraphicsWidget_setTabOrder(first.h, second.h)

proc focusWidget*(self: gen_qgraphicswidget_types.QGraphicsWidget, ): QGraphicsWidget =
  QGraphicsWidget(h: fcQGraphicsWidget_focusWidget(self.h))

proc grabShortcut*(self: gen_qgraphicswidget_types.QGraphicsWidget, sequence: QKeySequence): cint =
...
proc paint*(self: gen_qgraphicswidget_types.QGraphicsWidget, painter: QPainter, option: QStyleOptionGraphicsItem, widget: QWidget): void =
  fcQGraphicsWidget_paint(self.h, painter.h, option.h, widget.h)

proc paintWindowFrame*(self: gen_qgraphicswidget_types.QGraphicsWidget, painter: QPainter, option: QStyleOptionGraphicsItem, widget: QWidget): void =
  fcQGraphicsWidget_paintWindowFrame(self.h, painter.h, option.h, widget.h)

proc boundingRect*(self: gen_qgraphicswidget_types.QGraphicsWidget, ): QRectF =
  QRectF(h: fcQGraphicsWidget_boundingRect(self.h))

proc shape*(self: gen_qgraphicswidget_types.QGraphicsWidget, ): QPainterPath =
  QPainterPath(h: fcQGraphicsWidget_shape(self.h))
...
proc grabShortcut*(self: gen_qgraphicswidget_types.QGraphicsWidget, sequence: QKeySequence, context: cint): cint =
...
proc miqt_exec_callback_QGraphicsWidget_metacall(self: ptr cQGraphicsWidget, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QGraphicsWidget_metacall ".} =
  ...
  virtualReturn
proc QGraphicsWidgetsetGeometry*(self: gen_qgraphicswidget_types.QGraphicsWidget, rect: QRectF): void =
  fQGraphicsWidget_virtualbase_setGeometry(self.h, rect.h)

type QGraphicsWidgetsetGeometryProc* = proc(rect: QRectF): void
...
proc miqt_exec_callback_QGraphicsWidget_type(self: ptr cQGraphicsWidget, slot: int): cint {.exportc: "miqt_exec_callback_QGraphicsWidget_type ".} =
  ...
  virtualReturn
proc QGraphicsWidgetpaint*(self: gen_qgraphicswidget_types.QGraphicsWidget, painter: QPainter, option: QStyleOptionGraphicsItem, widget: QWidget): void =
  fQGraphicsWidget_virtualbase_paint(self.h, painter.h, option.h, widget.h)

type QGraphicsWidgetpaintProc* = proc(painter: QPainter, option: QStyleOptionGraphicsItem, widget: QWidget): void
...
proc QGraphicsWidgetpaintWindowFrame*(self: gen_qgraphicswidget_types.QGraphicsWidget, painter: QPainter, option: QStyleOptionGraphicsItem, widget: QWidget): void =
  fQGraphicsWidget_virtualbase_paintWindowFrame(self.h, painter.h, option.h, widget.h)

type QGraphicsWidgetpaintWindowFrameProc* = proc(painter: QPainter, option: QStyleOptionGraphicsItem, widget: QWidget): void
...
proc miqt_exec_callback_QGraphicsWidget_paintWindowFrame(self: ptr cQGraphicsWidget, slot: int, painter: pointer, option: pointer, widget: pointer): void {.exportc: "miqt_exec_callback_QGraphicsWidget_paintWindowFrame ".} =
  ...
  nimfunc[](slotval1, slotval2, slotval3)
proc QGraphicsWidgetboundingRect*(self: gen_qgraphicswidget_types.QGraphicsWidget, ): QRectF =
  QRectF(h: fQGraphicsWidget_virtualbase_boundingRect(self.h))

type QGraphicsWidgetboundingRectProc* = proc(): QRectF
...
proc miqt_exec_callback_QGraphicsWidget_boundingRect(self: ptr cQGraphicsWidget, slot: int): pointer {.exportc: "miqt_exec_callback_QGraphicsWidget_boundingRect ".} =
  ...
  virtualReturn.h
proc QGraphicsWidgetshape*(self: gen_qgraphicswidget_types.QGraphicsWidget, ): QPainterPath =
  QPainterPath(h: fQGraphicsWidget_virtualbase_shape(self.h))

type QGraphicsWidgetshapeProc* = proc(): QPainterPath
...
proc miqt_exec_callback_QGraphicsWidget_shape(self: ptr cQGraphicsWidget, slot: int): pointer {.exportc: "miqt_exec_callback_QGraphicsWidget_shape ".} =
  ...
  virtualReturn.h
proc QGraphicsWidgetinitStyleOption*(self: gen_qgraphicswidget_types.QGraphicsWidget, option: QStyleOption): void =
  fQGraphicsWidget_virtualbase_initStyleOption(self.h, option.h)

type QGraphicsWidgetinitStyleOptionProc* = proc(option: QStyleOption): void
...
proc miqt_exec_callback_QGraphicsWidget_initStyleOption(self: ptr cQGraphicsWidget, slot: int, option: pointer): void {.exportc: "miqt_exec_callback_QGraphicsWidget_initStyleOption ".} =
  ...
  let slotval1 = QStyleOption(h: option)


  nimfunc[](slotval1)
proc QGraphicsWidgetsizeHint*(self: gen_qgraphicswidget_types.QGraphicsWidget, which: cint, constraint: QSizeF): QSizeF =
  QSizeF(h: fQGraphicsWidget_virtualbase_sizeHint(self.h, cint(which), constraint.h))

type QGraphicsWidgetsizeHintProc* = proc(which: cint, constraint: QSizeF): QSizeF
...
proc miqt_exec_callback_QGraphicsWidget_sizeHint(self: ptr cQGraphicsWidget, slot: int, which: cint, constraint: pointer): pointer {.exportc: "miqt_exec_callback_QGraphicsWidget_sizeHint ".} =
  ...
  let slotval2 = QSizeF(h: constraint)
...
proc miqt_exec_callback_QGraphicsWidget_updateGeometry(self: ptr cQGraphicsWidget, slot: int): void {.exportc: "miqt_exec_callback_QGraphicsWidget_updateGeometry ".} =
  ...
  nimfunc[]()
proc QGraphicsWidgetitemChange*(self: gen_qgraphicswidget_types.QGraphicsWidget, change: cint, value: QVariant): QVariant =
  QVariant(h: fQGraphicsWidget_virtualbase_itemChange(self.h, cint(change), value.h))

type QGraphicsWidgetitemChangeProc* = proc(change: cint, value: QVariant): QVariant
...
proc miqt_exec_callback_QGraphicsWidget_itemChange(self: ptr cQGraphicsWidget, slot: int, change: cint, value: pointer): pointer {.exportc: "miqt_exec_callback_QGraphicsWidget_itemChange ".} =
  ...
  virtualReturn.h
proc QGraphicsWidgetpropertyChange*(self: gen_qgraphicswidget_types.QGraphicsWidget, propertyName: string, value: QVariant): QVariant =
  QVariant(h: fQGraphicsWidget_virtualbase_propertyChange(self.h, struct_miqt_string(data: propertyName, len: csize_t(len(propertyName))), value.h))

type QGraphicsWidgetpropertyChangeProc* = proc(propertyName: string, value: QVariant): QVariant
...
proc miqt_exec_callback_QGraphicsWidget_propertyChange(self: ptr cQGraphicsWidget, slot: int, propertyName: struct_miqt_string, value: pointer): pointer {.exportc: "miqt_exec_callback_QGraphicsWidget_propertyChange ".} =
  ...
  virtualReturn.h
proc QGraphicsWidgetsceneEvent*(self: gen_qgraphicswidget_types.QGraphicsWidget, event: QEvent): bool =
  fQGraphicsWidget_virtualbase_sceneEvent(self.h, event.h)

type QGraphicsWidgetsceneEventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QGraphicsWidget_sceneEvent(self: ptr cQGraphicsWidget, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QGraphicsWidget_sceneEvent ".} =
  ...
  virtualReturn
proc QGraphicsWidgetwindowFrameEvent*(self: gen_qgraphicswidget_types.QGraphicsWidget, e: QEvent): bool =
  fQGraphicsWidget_virtualbase_windowFrameEvent(self.h, e.h)

type QGraphicsWidgetwindowFrameEventProc* = proc(e: QEvent): bool
...
proc miqt_exec_callback_QGraphicsWidget_windowFrameEvent(self: ptr cQGraphicsWidget, slot: int, e: pointer): bool {.exportc: "miqt_exec_callback_QGraphicsWidget_windowFrameEvent ".} =
  ...
  virtualReturn
proc QGraphicsWidgetwindowFrameSectionAt*(self: gen_qgraphicswidget_types.QGraphicsWidget, pos: QPointF): cint =
  cint(fQGraphicsWidget_virtualbase_windowFrameSectionAt(self.h, pos.h))

type QGraphicsWidgetwindowFrameSectionAtProc* = proc(pos: QPointF): cint
...
proc miqt_exec_callback_QGraphicsWidget_windowFrameSectionAt(self: ptr cQGraphicsWidget, slot: int, pos: pointer): cint {.exportc: "miqt_exec_callback_QGraphicsWidget_windowFrameSectionAt ".} =
  ...
  let slotval1 = QPointF(h: pos)


  let virtualReturn = nimfunc[](slotval1 )

  cint(virtualReturn)
proc QGraphicsWidgetevent*(self: gen_qgraphicswidget_types.QGraphicsWidget, event: QEvent): bool =
  fQGraphicsWidget_virtualbase_event(self.h, event.h)

type QGraphicsWidgeteventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QGraphicsWidget_event(self: ptr cQGraphicsWidget, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QGraphicsWidget_event ".} =
  ...
  virtualReturn
proc QGraphicsWidgetchangeEvent*(self: gen_qgraphicswidget_types.QGraphicsWidget, event: QEvent): void =
  fQGraphicsWidget_virtualbase_changeEvent(self.h, event.h)

type QGraphicsWidgetchangeEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QGraphicsWidget_changeEvent(self: ptr cQGraphicsWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsWidget_changeEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsWidgetcloseEvent*(self: gen_qgraphicswidget_types.QGraphicsWidget, event: QCloseEvent): void =
  fQGraphicsWidget_virtualbase_closeEvent(self.h, event.h)

type QGraphicsWidgetcloseEventProc* = proc(event: QCloseEvent): void
...
proc miqt_exec_callback_QGraphicsWidget_closeEvent(self: ptr cQGraphicsWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsWidget_closeEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsWidgetfocusInEvent*(self: gen_qgraphicswidget_types.QGraphicsWidget, event: QFocusEvent): void =
  fQGraphicsWidget_virtualbase_focusInEvent(self.h, event.h)

type QGraphicsWidgetfocusInEventProc* = proc(event: QFocusEvent): void
...
proc miqt_exec_callback_QGraphicsWidget_focusNextPrevChild(self: ptr cQGraphicsWidget, slot: int, next: bool): bool {.exportc: "miqt_exec_callback_QGraphicsWidget_focusNextPrevChild ".} =
  ...
  virtualReturn
proc QGraphicsWidgetfocusOutEvent*(self: gen_qgraphicswidget_types.QGraphicsWidget, event: QFocusEvent): void =
  fQGraphicsWidget_virtualbase_focusOutEvent(self.h, event.h)

type QGraphicsWidgetfocusOutEventProc* = proc(event: QFocusEvent): void
...
proc miqt_exec_callback_QGraphicsWidget_focusOutEvent(self: ptr cQGraphicsWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsWidget_focusOutEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsWidgethideEvent*(self: gen_qgraphicswidget_types.QGraphicsWidget, event: QHideEvent): void =
  fQGraphicsWidget_virtualbase_hideEvent(self.h, event.h)

type QGraphicsWidgethideEventProc* = proc(event: QHideEvent): void
...
proc miqt_exec_callback_QGraphicsWidget_hideEvent(self: ptr cQGraphicsWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsWidget_hideEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsWidgetmoveEvent*(self: gen_qgraphicswidget_types.QGraphicsWidget, event: QGraphicsSceneMoveEvent): void =
  fQGraphicsWidget_virtualbase_moveEvent(self.h, event.h)

type QGraphicsWidgetmoveEventProc* = proc(event: QGraphicsSceneMoveEvent): void
...
proc miqt_exec_callback_QGraphicsWidget_moveEvent(self: ptr cQGraphicsWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsWidget_moveEvent ".} =
  ...
  let slotval1 = QGraphicsSceneMoveEvent(h: event)
...
proc miqt_exec_callback_QGraphicsWidget_polishEvent(self: ptr cQGraphicsWidget, slot: int): void {.exportc: "miqt_exec_callback_QGraphicsWidget_polishEvent ".} =
  ...
  nimfunc[]()
proc QGraphicsWidgetresizeEvent*(self: gen_qgraphicswidget_types.QGraphicsWidget, event: QGraphicsSceneResizeEvent): void =
  fQGraphicsWidget_virtualbase_resizeEvent(self.h, event.h)

type QGraphicsWidgetresizeEventProc* = proc(event: QGraphicsSceneResizeEvent): void
...
proc miqt_exec_callback_QGraphicsWidget_resizeEvent(self: ptr cQGraphicsWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsWidget_resizeEvent ".} =
  ...
  let slotval1 = QGraphicsSceneResizeEvent(h: event)


  nimfunc[](slotval1)
proc QGraphicsWidgetshowEvent*(self: gen_qgraphicswidget_types.QGraphicsWidget, event: QShowEvent): void =
  fQGraphicsWidget_virtualbase_showEvent(self.h, event.h)

type QGraphicsWidgetshowEventProc* = proc(event: QShowEvent): void
...
proc miqt_exec_callback_QGraphicsWidget_showEvent(self: ptr cQGraphicsWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsWidget_showEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsWidgethoverMoveEvent*(self: gen_qgraphicswidget_types.QGraphicsWidget, event: QGraphicsSceneHoverEvent): void =
  fQGraphicsWidget_virtualbase_hoverMoveEvent(self.h, event.h)

type QGraphicsWidgethoverMoveEventProc* = proc(event: QGraphicsSceneHoverEvent): void
...
proc miqt_exec_callback_QGraphicsWidget_hoverMoveEvent(self: ptr cQGraphicsWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsWidget_hoverMoveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsWidgethoverLeaveEvent*(self: gen_qgraphicswidget_types.QGraphicsWidget, event: QGraphicsSceneHoverEvent): void =
  fQGraphicsWidget_virtualbase_hoverLeaveEvent(self.h, event.h)

type QGraphicsWidgethoverLeaveEventProc* = proc(event: QGraphicsSceneHoverEvent): void
...
proc miqt_exec_callback_QGraphicsWidget_hoverLeaveEvent(self: ptr cQGraphicsWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsWidget_hoverLeaveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsWidgetgrabMouseEvent*(self: gen_qgraphicswidget_types.QGraphicsWidget, event: QEvent): void =
  fQGraphicsWidget_virtualbase_grabMouseEvent(self.h, event.h)

type QGraphicsWidgetgrabMouseEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QGraphicsWidget_grabMouseEvent(self: ptr cQGraphicsWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsWidget_grabMouseEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsWidgetungrabMouseEvent*(self: gen_qgraphicswidget_types.QGraphicsWidget, event: QEvent): void =
  fQGraphicsWidget_virtualbase_ungrabMouseEvent(self.h, event.h)

type QGraphicsWidgetungrabMouseEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QGraphicsWidget_ungrabMouseEvent(self: ptr cQGraphicsWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsWidget_ungrabMouseEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsWidgetgrabKeyboardEvent*(self: gen_qgraphicswidget_types.QGraphicsWidget, event: QEvent): void =
  fQGraphicsWidget_virtualbase_grabKeyboardEvent(self.h, event.h)

type QGraphicsWidgetgrabKeyboardEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QGraphicsWidget_grabKeyboardEvent(self: ptr cQGraphicsWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsWidget_grabKeyboardEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsWidgetungrabKeyboardEvent*(self: gen_qgraphicswidget_types.QGraphicsWidget, event: QEvent): void =
  fQGraphicsWidget_virtualbase_ungrabKeyboardEvent(self.h, event.h)

type QGraphicsWidgetungrabKeyboardEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QGraphicsWidget_ungrabKeyboardEvent(self: ptr cQGraphicsWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsWidget_ungrabKeyboardEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsWidgeteventFilter*(self: gen_qgraphicswidget_types.QGraphicsWidget, watched: QObject, event: QEvent): bool =
  fQGraphicsWidget_virtualbase_eventFilter(self.h, watched.h, event.h)

type QGraphicsWidgeteventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QGraphicsWidget_eventFilter(self: ptr cQGraphicsWidget, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QGraphicsWidget_eventFilter ".} =
  ...
  virtualReturn
proc QGraphicsWidgettimerEvent*(self: gen_qgraphicswidget_types.QGraphicsWidget, event: QTimerEvent): void =
  fQGraphicsWidget_virtualbase_timerEvent(self.h, event.h)

type QGraphicsWidgettimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QGraphicsWidget_timerEvent(self: ptr cQGraphicsWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsWidget_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsWidgetchildEvent*(self: gen_qgraphicswidget_types.QGraphicsWidget, event: QChildEvent): void =
  fQGraphicsWidget_virtualbase_childEvent(self.h, event.h)

type QGraphicsWidgetchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QGraphicsWidget_childEvent(self: ptr cQGraphicsWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsWidget_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsWidgetcustomEvent*(self: gen_qgraphicswidget_types.QGraphicsWidget, event: QEvent): void =
  fQGraphicsWidget_virtualbase_customEvent(self.h, event.h)

type QGraphicsWidgetcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QGraphicsWidget_customEvent(self: ptr cQGraphicsWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsWidget_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsWidgetconnectNotify*(self: gen_qgraphicswidget_types.QGraphicsWidget, signal: QMetaMethod): void =
  fQGraphicsWidget_virtualbase_connectNotify(self.h, signal.h)

type QGraphicsWidgetconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QGraphicsWidget_connectNotify(self: ptr cQGraphicsWidget, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QGraphicsWidget_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsWidgetdisconnectNotify*(self: gen_qgraphicswidget_types.QGraphicsWidget, signal: QMetaMethod): void =
  fQGraphicsWidget_virtualbase_disconnectNotify(self.h, signal.h)

type QGraphicsWidgetdisconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QGraphicsWidget_advance(self: ptr cQGraphicsWidget, slot: int, phase: cint): void {.exportc: "miqt_exec_callback_QGraphicsWidget_advance ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsWidgetcontains*(self: gen_qgraphicswidget_types.QGraphicsWidget, point: QPointF): bool =
  fQGraphicsWidget_virtualbase_contains(self.h, point.h)

type QGraphicsWidgetcontainsProc* = proc(point: QPointF): bool
...
proc miqt_exec_callback_QGraphicsWidget_contains(self: ptr cQGraphicsWidget, slot: int, point: pointer): bool {.exportc: "miqt_exec_callback_QGraphicsWidget_contains ".} =
  ...
  virtualReturn
proc QGraphicsWidgetcollidesWithItem*(self: gen_qgraphicswidget_types.QGraphicsWidget, other: QGraphicsItem, mode: cint): bool =
  fQGraphicsWidget_virtualbase_collidesWithItem(self.h, other.h, cint(mode))

type QGraphicsWidgetcollidesWithItemProc* = proc(other: QGraphicsItem, mode: cint): bool
...
proc miqt_exec_callback_QGraphicsWidget_collidesWithItem(self: ptr cQGraphicsWidget, slot: int, other: pointer, mode: cint): bool {.exportc: "miqt_exec_callback_QGraphicsWidget_collidesWithItem ".} =
  ...
  virtualReturn
proc QGraphicsWidgetcollidesWithPath*(self: gen_qgraphicswidget_types.QGraphicsWidget, path: QPainterPath, mode: cint): bool =
  fQGraphicsWidget_virtualbase_collidesWithPath(self.h, path.h, cint(mode))

type QGraphicsWidgetcollidesWithPathProc* = proc(path: QPainterPath, mode: cint): bool
...
proc miqt_exec_callback_QGraphicsWidget_collidesWithPath(self: ptr cQGraphicsWidget, slot: int, path: pointer, mode: cint): bool {.exportc: "miqt_exec_callback_QGraphicsWidget_collidesWithPath ".} =
  ...
  virtualReturn
proc QGraphicsWidgetisObscuredBy*(self: gen_qgraphicswidget_types.QGraphicsWidget, item: QGraphicsItem): bool =
  fQGraphicsWidget_virtualbase_isObscuredBy(self.h, item.h)

type QGraphicsWidgetisObscuredByProc* = proc(item: QGraphicsItem): bool
...
proc miqt_exec_callback_QGraphicsWidget_isObscuredBy(self: ptr cQGraphicsWidget, slot: int, item: pointer): bool {.exportc: "miqt_exec_callback_QGraphicsWidget_isObscuredBy ".} =
  ...
  virtualReturn
proc QGraphicsWidgetopaqueArea*(self: gen_qgraphicswidget_types.QGraphicsWidget, ): QPainterPath =
  QPainterPath(h: fQGraphicsWidget_virtualbase_opaqueArea(self.h))

type QGraphicsWidgetopaqueAreaProc* = proc(): QPainterPath
...
proc miqt_exec_callback_QGraphicsWidget_opaqueArea(self: ptr cQGraphicsWidget, slot: int): pointer {.exportc: "miqt_exec_callback_QGraphicsWidget_opaqueArea ".} =
  ...
  virtualReturn.h
proc QGraphicsWidgetsceneEventFilter*(self: gen_qgraphicswidget_types.QGraphicsWidget, watched: QGraphicsItem, event: QEvent): bool =
  fQGraphicsWidget_virtualbase_sceneEventFilter(self.h, watched.h, event.h)

type QGraphicsWidgetsceneEventFilterProc* = proc(watched: QGraphicsItem, event: QEvent): bool
...
proc miqt_exec_callback_QGraphicsWidget_sceneEventFilter(self: ptr cQGraphicsWidget, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QGraphicsWidget_sceneEventFilter ".} =
  ...
  virtualReturn
proc QGraphicsWidgetcontextMenuEvent*(self: gen_qgraphicswidget_types.QGraphicsWidget, event: QGraphicsSceneContextMenuEvent): void =
  fQGraphicsWidget_virtualbase_contextMenuEvent(self.h, event.h)

type QGraphicsWidgetcontextMenuEventProc* = proc(event: QGraphicsSceneContextMenuEvent): void
...
proc miqt_exec_callback_QGraphicsWidget_contextMenuEvent(self: ptr cQGraphicsWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsWidget_contextMenuEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsWidgetdragEnterEvent*(self: gen_qgraphicswidget_types.QGraphicsWidget, event: QGraphicsSceneDragDropEvent): void =
  fQGraphicsWidget_virtualbase_dragEnterEvent(self.h, event.h)

type QGraphicsWidgetdragEnterEventProc* = proc(event: QGraphicsSceneDragDropEvent): void
...
proc miqt_exec_callback_QGraphicsWidget_dragEnterEvent(self: ptr cQGraphicsWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsWidget_dragEnterEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsWidgetdragLeaveEvent*(self: gen_qgraphicswidget_types.QGraphicsWidget, event: QGraphicsSceneDragDropEvent): void =
  fQGraphicsWidget_virtualbase_dragLeaveEvent(self.h, event.h)

type QGraphicsWidgetdragLeaveEventProc* = proc(event: QGraphicsSceneDragDropEvent): void
...
proc miqt_exec_callback_QGraphicsWidget_dragLeaveEvent(self: ptr cQGraphicsWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsWidget_dragLeaveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsWidgetdragMoveEvent*(self: gen_qgraphicswidget_types.QGraphicsWidget, event: QGraphicsSceneDragDropEvent): void =
  fQGraphicsWidget_virtualbase_dragMoveEvent(self.h, event.h)

type QGraphicsWidgetdragMoveEventProc* = proc(event: QGraphicsSceneDragDropEvent): void
...
proc miqt_exec_callback_QGraphicsWidget_dragMoveEvent(self: ptr cQGraphicsWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsWidget_dragMoveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsWidgetdropEvent*(self: gen_qgraphicswidget_types.QGraphicsWidget, event: QGraphicsSceneDragDropEvent): void =
  fQGraphicsWidget_virtualbase_dropEvent(self.h, event.h)

type QGraphicsWidgetdropEventProc* = proc(event: QGraphicsSceneDragDropEvent): void
...
proc miqt_exec_callback_QGraphicsWidget_dropEvent(self: ptr cQGraphicsWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsWidget_dropEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsWidgethoverEnterEvent*(self: gen_qgraphicswidget_types.QGraphicsWidget, event: QGraphicsSceneHoverEvent): void =
  fQGraphicsWidget_virtualbase_hoverEnterEvent(self.h, event.h)

type QGraphicsWidgethoverEnterEventProc* = proc(event: QGraphicsSceneHoverEvent): void
...
proc miqt_exec_callback_QGraphicsWidget_hoverEnterEvent(self: ptr cQGraphicsWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsWidget_hoverEnterEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsWidgetkeyPressEvent*(self: gen_qgraphicswidget_types.QGraphicsWidget, event: QKeyEvent): void =
  fQGraphicsWidget_virtualbase_keyPressEvent(self.h, event.h)

type QGraphicsWidgetkeyPressEventProc* = proc(event: QKeyEvent): void
...
proc miqt_exec_callback_QGraphicsWidget_keyPressEvent(self: ptr cQGraphicsWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsWidget_keyPressEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsWidgetkeyReleaseEvent*(self: gen_qgraphicswidget_types.QGraphicsWidget, event: QKeyEvent): void =
  fQGraphicsWidget_virtualbase_keyReleaseEvent(self.h, event.h)

type QGraphicsWidgetkeyReleaseEventProc* = proc(event: QKeyEvent): void
...
proc miqt_exec_callback_QGraphicsWidget_keyReleaseEvent(self: ptr cQGraphicsWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsWidget_keyReleaseEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsWidgetmousePressEvent*(self: gen_qgraphicswidget_types.QGraphicsWidget, event: QGraphicsSceneMouseEvent): void =
  fQGraphicsWidget_virtualbase_mousePressEvent(self.h, event.h)

type QGraphicsWidgetmousePressEventProc* = proc(event: QGraphicsSceneMouseEvent): void
...
proc miqt_exec_callback_QGraphicsWidget_mousePressEvent(self: ptr cQGraphicsWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsWidget_mousePressEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsWidgetmouseMoveEvent*(self: gen_qgraphicswidget_types.QGraphicsWidget, event: QGraphicsSceneMouseEvent): void =
  fQGraphicsWidget_virtualbase_mouseMoveEvent(self.h, event.h)

type QGraphicsWidgetmouseMoveEventProc* = proc(event: QGraphicsSceneMouseEvent): void
...
proc miqt_exec_callback_QGraphicsWidget_mouseMoveEvent(self: ptr cQGraphicsWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsWidget_mouseMoveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsWidgetmouseReleaseEvent*(self: gen_qgraphicswidget_types.QGraphicsWidget, event: QGraphicsSceneMouseEvent): void =
  fQGraphicsWidget_virtualbase_mouseReleaseEvent(self.h, event.h)

type QGraphicsWidgetmouseReleaseEventProc* = proc(event: QGraphicsSceneMouseEvent): void
...
proc miqt_exec_callback_QGraphicsWidget_mouseReleaseEvent(self: ptr cQGraphicsWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsWidget_mouseReleaseEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsWidgetmouseDoubleClickEvent*(self: gen_qgraphicswidget_types.QGraphicsWidget, event: QGraphicsSceneMouseEvent): void =
  fQGraphicsWidget_virtualbase_mouseDoubleClickEvent(self.h, event.h)

type QGraphicsWidgetmouseDoubleClickEventProc* = proc(event: QGraphicsSceneMouseEvent): void
...
proc miqt_exec_callback_QGraphicsWidget_mouseDoubleClickEvent(self: ptr cQGraphicsWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsWidget_mouseDoubleClickEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsWidgetwheelEvent*(self: gen_qgraphicswidget_types.QGraphicsWidget, event: QGraphicsSceneWheelEvent): void =
  fQGraphicsWidget_virtualbase_wheelEvent(self.h, event.h)

type QGraphicsWidgetwheelEventProc* = proc(event: QGraphicsSceneWheelEvent): void
...
proc miqt_exec_callback_QGraphicsWidget_wheelEvent(self: ptr cQGraphicsWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsWidget_wheelEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsWidgetinputMethodEvent*(self: gen_qgraphicswidget_types.QGraphicsWidget, event: QInputMethodEvent): void =
  fQGraphicsWidget_virtualbase_inputMethodEvent(self.h, event.h)

type QGraphicsWidgetinputMethodEventProc* = proc(event: QInputMethodEvent): void
...
proc miqt_exec_callback_QGraphicsWidget_inputMethodEvent(self: ptr cQGraphicsWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsWidget_inputMethodEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsWidgetinputMethodQuery*(self: gen_qgraphicswidget_types.QGraphicsWidget, query: cint): QVariant =
  QVariant(h: fQGraphicsWidget_virtualbase_inputMethodQuery(self.h, cint(query)))

type QGraphicsWidgetinputMethodQueryProc* = proc(query: cint): QVariant
...
proc miqt_exec_callback_QGraphicsWidget_supportsExtension(self: ptr cQGraphicsWidget, slot: int, extension: cint): bool {.exportc: "miqt_exec_callback_QGraphicsWidget_supportsExtension ".} =
  ...
  virtualReturn
proc QGraphicsWidgetsetExtension*(self: gen_qgraphicswidget_types.QGraphicsWidget, extension: cint, variant: QVariant): void =
  fQGraphicsWidget_virtualbase_setExtension(self.h, cint(extension), variant.h)

type QGraphicsWidgetsetExtensionProc* = proc(extension: cint, variant: QVariant): void
...
proc QGraphicsWidgetextension*(self: gen_qgraphicswidget_types.QGraphicsWidget, variant: QVariant): QVariant =
  QVariant(h: fQGraphicsWidget_virtualbase_extension(self.h, variant.h))

type QGraphicsWidgetextensionProc* = proc(variant: QVariant): QVariant
