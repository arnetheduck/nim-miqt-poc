...
QMetaObject* QFrame_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQFrame*)(self) )->QFrame::metaObject();

}

void* QFrame_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQFrame*)(self) )->QFrame::qt_metacast(param1);

}

int QFrame_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQFrame*)(self) )->QFrame::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
void QFrame_virtualbase_initStyleOption(const void* self, QStyleOptionFrame* option) {
	...
	( (const MiqtVirtualQFrame*)(self) )->QFrame::initStyleOption(option);
...
bool QFrame_virtualbase_nativeEvent(void* self, struct miqt_string eventType, void* message, intptr_t* result) {
	...
	return ( (MiqtVirtualQFrame*)(self) )->QFrame::nativeEvent(eventType_QByteArray, message, (qintptr*)(result));
