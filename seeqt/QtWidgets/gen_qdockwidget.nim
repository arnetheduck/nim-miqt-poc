...
proc miqt_exec_callback_cQDockWidget_initStyleOption(vtbl: pointer, self: pointer, option: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QDockWidgetVTable](vtbl)
  let self = QDockWidget(h: self)
...
proc miqt_exec_callback_cQDockWidget_nativeEvent(vtbl: pointer, self: pointer, eventType: struct_miqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let vtbl = cast[ptr QDockWidgetVTable](vtbl)
  let self = QDockWidget(h: self)
...
proc miqt_exec_method_cQDockWidget_initStyleOption(vtbl: pointer, inst: pointer, option: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQDockWidget](cast[uint](vtbl) - uint(offsetOf(VirtualQDockWidget, vtbl)))
  let slotval1 = gen_qstyleoption_types.QStyleOptionDockWidget(h: option, owned: false)
...
proc miqt_exec_method_cQDockWidget_nativeEvent(vtbl: pointer, inst: pointer, eventType: struct_miqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let vtbl = cast[VirtualQDockWidget](cast[uint](vtbl) - uint(offsetOf(VirtualQDockWidget, vtbl)))
  var veventType_bytearray = eventType
  var veventTypex_ret = @(toOpenArrayByte(veventType_bytearray.data, 0, int(veventType_bytearray.len)-1))
  c_free(veventType_bytearray.data)
...
proc create*(T: type gen_qdockwidget_types.QDockWidget,
  ...
  if not isNil(vtbl[].initStyleOption):
    vtbl[].vtbl.initStyleOption = miqt_exec_callback_cQDockWidget_initStyleOption
...
proc create*(T: type gen_qdockwidget_types.QDockWidget,
  ...
  vtbl[].vtbl.initStyleOption = miqt_exec_method_cQDockWidget_initStyleOption
