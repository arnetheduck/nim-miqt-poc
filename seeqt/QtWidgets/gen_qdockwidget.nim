...
proc fQDockWidget_virtualbase_initStyleOption(self: pointer, option: pointer): void{.importc: "QDockWidget_virtualbase_initStyleOption".}
proc fcQDockWidget_override_virtual_initStyleOption(self: pointer, slot: int) {.importc: "QDockWidget_override_virtual_initStyleOption".}
...
proc fQDockWidget_virtualbase_nativeEvent(self: pointer, eventType: struct_miqt_string, message: pointer, resultVal: ptr uint): bool{.importc: "QDockWidget_virtualbase_nativeEvent".}
...
func init*(T: type gen_qdockwidget_types.QDockWidget, h: ptr cQDockWidget): gen_qdockwidget_types.QDockWidget =
  T(h: h)
proc create*(T: type gen_qdockwidget_types.QDockWidget, parent: QWidget): gen_qdockwidget_types.QDockWidget =
...
proc create*(T: type gen_qdockwidget_types.QDockWidget, title: string, parent: QWidget): gen_qdockwidget_types.QDockWidget =
  gen_qdockwidget_types.QDockWidget.init(fcQDockWidget_new4(struct_miqt_string(data: title, len: csize_t(len(title))), parent.h))

proc create*(T: type gen_qdockwidget_types.QDockWidget, title: string, parent: QWidget, flags: cint): gen_qdockwidget_types.QDockWidget =
...
proc create*(T: type gen_qdockwidget_types.QDockWidget, parent: QWidget, flags: cint): gen_qdockwidget_types.QDockWidget =
  gen_qdockwidget_types.QDockWidget.init(fcQDockWidget_new6(parent.h, cint(flags)))

proc metaObject*(self: gen_qdockwidget_types.QDockWidget, ): QMetaObject =
  QMetaObject(h: fcQDockWidget_metaObject(self.h))
...
proc widget*(self: gen_qdockwidget_types.QDockWidget, ): QWidget =
  QWidget(h: fcQDockWidget_widget(self.h))

proc setWidget*(self: gen_qdockwidget_types.QDockWidget, widget: QWidget): void =
...
proc setTitleBarWidget*(self: gen_qdockwidget_types.QDockWidget, widget: QWidget): void =
  fcQDockWidget_setTitleBarWidget(self.h, widget.h)

proc titleBarWidget*(self: gen_qdockwidget_types.QDockWidget, ): QWidget =
  QWidget(h: fcQDockWidget_titleBarWidget(self.h))
...
proc miqt_exec_callback_QDockWidget_metacall(self: ptr cQDockWidget, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QDockWidget_metacall ".} =
  ...
  virtualReturn
proc QDockWidgetchangeEvent*(self: gen_qdockwidget_types.QDockWidget, event: QEvent): void =
  fQDockWidget_virtualbase_changeEvent(self.h, event.h)

type QDockWidgetchangeEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QDockWidget_changeEvent(self: ptr cQDockWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QDockWidget_changeEvent ".} =
  ...
  nimfunc[](slotval1)
proc QDockWidgetcloseEvent*(self: gen_qdockwidget_types.QDockWidget, event: QCloseEvent): void =
  fQDockWidget_virtualbase_closeEvent(self.h, event.h)

type QDockWidgetcloseEventProc* = proc(event: QCloseEvent): void
...
proc miqt_exec_callback_QDockWidget_closeEvent(self: ptr cQDockWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QDockWidget_closeEvent ".} =
  ...
  nimfunc[](slotval1)
proc QDockWidgetpaintEvent*(self: gen_qdockwidget_types.QDockWidget, event: QPaintEvent): void =
  fQDockWidget_virtualbase_paintEvent(self.h, event.h)

type QDockWidgetpaintEventProc* = proc(event: QPaintEvent): void
...
proc miqt_exec_callback_QDockWidget_paintEvent(self: ptr cQDockWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QDockWidget_paintEvent ".} =
  ...
  nimfunc[](slotval1)
proc QDockWidgetevent*(self: gen_qdockwidget_types.QDockWidget, event: QEvent): bool =
  fQDockWidget_virtualbase_event(self.h, event.h)

type QDockWidgeteventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QDockWidget_event(self: ptr cQDockWidget, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QDockWidget_event ".} =
  ...
  virtualReturn
proc QDockWidgetinitStyleOption*(self: gen_qdockwidget_types.QDockWidget, option: QStyleOptionDockWidget): void =
  fQDockWidget_virtualbase_initStyleOption(self.h, option.h)

type QDockWidgetinitStyleOptionProc* = proc(option: QStyleOptionDockWidget): void
proc oninitStyleOption*(self: gen_qdockwidget_types.QDockWidget, slot: QDockWidgetinitStyleOptionProc) =
  # TODO check subclass
  var tmp = new QDockWidgetinitStyleOptionProc
  tmp[] = slot
  GC_ref(tmp)
  fcQDockWidget_override_virtual_initStyleOption(self.h, cast[int](addr tmp[]))

proc miqt_exec_callback_QDockWidget_initStyleOption(self: ptr cQDockWidget, slot: int, option: pointer): void {.exportc: "miqt_exec_callback_QDockWidget_initStyleOption ".} =
  var nimfunc = cast[ptr QDockWidgetinitStyleOptionProc](cast[pointer](slot))
  let slotval1 = QStyleOptionDockWidget(h: option)
...
proc miqt_exec_callback_QDockWidget_setVisible(self: ptr cQDockWidget, slot: int, visible: bool): void {.exportc: "miqt_exec_callback_QDockWidget_setVisible ".} =
  ...
  nimfunc[](slotval1)
proc QDockWidgetsizeHint*(self: gen_qdockwidget_types.QDockWidget, ): QSize =
  QSize(h: fQDockWidget_virtualbase_sizeHint(self.h))

type QDockWidgetsizeHintProc* = proc(): QSize
...
proc miqt_exec_callback_QDockWidget_sizeHint(self: ptr cQDockWidget, slot: int): pointer {.exportc: "miqt_exec_callback_QDockWidget_sizeHint ".} =
  ...
  virtualReturn.h
proc QDockWidgetminimumSizeHint*(self: gen_qdockwidget_types.QDockWidget, ): QSize =
  QSize(h: fQDockWidget_virtualbase_minimumSizeHint(self.h))

type QDockWidgetminimumSizeHintProc* = proc(): QSize
...
proc miqt_exec_callback_QDockWidget_hasHeightForWidth(self: ptr cQDockWidget, slot: int): bool {.exportc: "miqt_exec_callback_QDockWidget_hasHeightForWidth ".} =
  ...
  virtualReturn
proc QDockWidgetpaintEngine*(self: gen_qdockwidget_types.QDockWidget, ): QPaintEngine =
  QPaintEngine(h: fQDockWidget_virtualbase_paintEngine(self.h))

type QDockWidgetpaintEngineProc* = proc(): QPaintEngine
...
proc miqt_exec_callback_QDockWidget_paintEngine(self: ptr cQDockWidget, slot: int): pointer {.exportc: "miqt_exec_callback_QDockWidget_paintEngine ".} =
  ...
  virtualReturn.h
proc QDockWidgetmousePressEvent*(self: gen_qdockwidget_types.QDockWidget, event: QMouseEvent): void =
  fQDockWidget_virtualbase_mousePressEvent(self.h, event.h)

type QDockWidgetmousePressEventProc* = proc(event: QMouseEvent): void
...
proc miqt_exec_callback_QDockWidget_mousePressEvent(self: ptr cQDockWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QDockWidget_mousePressEvent ".} =
  ...
  nimfunc[](slotval1)
proc QDockWidgetmouseReleaseEvent*(self: gen_qdockwidget_types.QDockWidget, event: QMouseEvent): void =
  fQDockWidget_virtualbase_mouseReleaseEvent(self.h, event.h)

type QDockWidgetmouseReleaseEventProc* = proc(event: QMouseEvent): void
...
proc miqt_exec_callback_QDockWidget_mouseReleaseEvent(self: ptr cQDockWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QDockWidget_mouseReleaseEvent ".} =
  ...
  nimfunc[](slotval1)
proc QDockWidgetmouseDoubleClickEvent*(self: gen_qdockwidget_types.QDockWidget, event: QMouseEvent): void =
  fQDockWidget_virtualbase_mouseDoubleClickEvent(self.h, event.h)

type QDockWidgetmouseDoubleClickEventProc* = proc(event: QMouseEvent): void
...
proc miqt_exec_callback_QDockWidget_mouseDoubleClickEvent(self: ptr cQDockWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QDockWidget_mouseDoubleClickEvent ".} =
  ...
  nimfunc[](slotval1)
proc QDockWidgetmouseMoveEvent*(self: gen_qdockwidget_types.QDockWidget, event: QMouseEvent): void =
  fQDockWidget_virtualbase_mouseMoveEvent(self.h, event.h)

type QDockWidgetmouseMoveEventProc* = proc(event: QMouseEvent): void
...
proc miqt_exec_callback_QDockWidget_mouseMoveEvent(self: ptr cQDockWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QDockWidget_mouseMoveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QDockWidgetwheelEvent*(self: gen_qdockwidget_types.QDockWidget, event: QWheelEvent): void =
  fQDockWidget_virtualbase_wheelEvent(self.h, event.h)

type QDockWidgetwheelEventProc* = proc(event: QWheelEvent): void
...
proc miqt_exec_callback_QDockWidget_wheelEvent(self: ptr cQDockWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QDockWidget_wheelEvent ".} =
  ...
  nimfunc[](slotval1)
proc QDockWidgetkeyPressEvent*(self: gen_qdockwidget_types.QDockWidget, event: QKeyEvent): void =
  fQDockWidget_virtualbase_keyPressEvent(self.h, event.h)

type QDockWidgetkeyPressEventProc* = proc(event: QKeyEvent): void
...
proc miqt_exec_callback_QDockWidget_keyPressEvent(self: ptr cQDockWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QDockWidget_keyPressEvent ".} =
  ...
  nimfunc[](slotval1)
proc QDockWidgetkeyReleaseEvent*(self: gen_qdockwidget_types.QDockWidget, event: QKeyEvent): void =
  fQDockWidget_virtualbase_keyReleaseEvent(self.h, event.h)

type QDockWidgetkeyReleaseEventProc* = proc(event: QKeyEvent): void
...
proc miqt_exec_callback_QDockWidget_keyReleaseEvent(self: ptr cQDockWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QDockWidget_keyReleaseEvent ".} =
  ...
  nimfunc[](slotval1)
proc QDockWidgetfocusInEvent*(self: gen_qdockwidget_types.QDockWidget, event: QFocusEvent): void =
  fQDockWidget_virtualbase_focusInEvent(self.h, event.h)

type QDockWidgetfocusInEventProc* = proc(event: QFocusEvent): void
...
proc miqt_exec_callback_QDockWidget_focusInEvent(self: ptr cQDockWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QDockWidget_focusInEvent ".} =
  ...
  nimfunc[](slotval1)
proc QDockWidgetfocusOutEvent*(self: gen_qdockwidget_types.QDockWidget, event: QFocusEvent): void =
  fQDockWidget_virtualbase_focusOutEvent(self.h, event.h)

type QDockWidgetfocusOutEventProc* = proc(event: QFocusEvent): void
...
proc miqt_exec_callback_QDockWidget_focusOutEvent(self: ptr cQDockWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QDockWidget_focusOutEvent ".} =
  ...
  nimfunc[](slotval1)
proc QDockWidgetenterEvent*(self: gen_qdockwidget_types.QDockWidget, event: QEnterEvent): void =
  fQDockWidget_virtualbase_enterEvent(self.h, event.h)

type QDockWidgetenterEventProc* = proc(event: QEnterEvent): void
...
proc miqt_exec_callback_QDockWidget_enterEvent(self: ptr cQDockWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QDockWidget_enterEvent ".} =
  ...
  nimfunc[](slotval1)
proc QDockWidgetleaveEvent*(self: gen_qdockwidget_types.QDockWidget, event: QEvent): void =
  fQDockWidget_virtualbase_leaveEvent(self.h, event.h)

type QDockWidgetleaveEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QDockWidget_leaveEvent(self: ptr cQDockWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QDockWidget_leaveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QDockWidgetmoveEvent*(self: gen_qdockwidget_types.QDockWidget, event: QMoveEvent): void =
  fQDockWidget_virtualbase_moveEvent(self.h, event.h)

type QDockWidgetmoveEventProc* = proc(event: QMoveEvent): void
...
proc miqt_exec_callback_QDockWidget_moveEvent(self: ptr cQDockWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QDockWidget_moveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QDockWidgetresizeEvent*(self: gen_qdockwidget_types.QDockWidget, event: QResizeEvent): void =
  fQDockWidget_virtualbase_resizeEvent(self.h, event.h)

type QDockWidgetresizeEventProc* = proc(event: QResizeEvent): void
...
proc miqt_exec_callback_QDockWidget_resizeEvent(self: ptr cQDockWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QDockWidget_resizeEvent ".} =
  ...
  nimfunc[](slotval1)
proc QDockWidgetcontextMenuEvent*(self: gen_qdockwidget_types.QDockWidget, event: QContextMenuEvent): void =
  fQDockWidget_virtualbase_contextMenuEvent(self.h, event.h)

type QDockWidgetcontextMenuEventProc* = proc(event: QContextMenuEvent): void
...
proc miqt_exec_callback_QDockWidget_contextMenuEvent(self: ptr cQDockWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QDockWidget_contextMenuEvent ".} =
  ...
  nimfunc[](slotval1)
proc QDockWidgettabletEvent*(self: gen_qdockwidget_types.QDockWidget, event: QTabletEvent): void =
  fQDockWidget_virtualbase_tabletEvent(self.h, event.h)

type QDockWidgettabletEventProc* = proc(event: QTabletEvent): void
...
proc miqt_exec_callback_QDockWidget_tabletEvent(self: ptr cQDockWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QDockWidget_tabletEvent ".} =
  ...
  nimfunc[](slotval1)
proc QDockWidgetactionEvent*(self: gen_qdockwidget_types.QDockWidget, event: QActionEvent): void =
  fQDockWidget_virtualbase_actionEvent(self.h, event.h)

type QDockWidgetactionEventProc* = proc(event: QActionEvent): void
...
proc miqt_exec_callback_QDockWidget_actionEvent(self: ptr cQDockWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QDockWidget_actionEvent ".} =
  ...
  nimfunc[](slotval1)
proc QDockWidgetdragEnterEvent*(self: gen_qdockwidget_types.QDockWidget, event: QDragEnterEvent): void =
  fQDockWidget_virtualbase_dragEnterEvent(self.h, event.h)

type QDockWidgetdragEnterEventProc* = proc(event: QDragEnterEvent): void
...
proc miqt_exec_callback_QDockWidget_dragEnterEvent(self: ptr cQDockWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QDockWidget_dragEnterEvent ".} =
  ...
  nimfunc[](slotval1)
proc QDockWidgetdragMoveEvent*(self: gen_qdockwidget_types.QDockWidget, event: QDragMoveEvent): void =
  fQDockWidget_virtualbase_dragMoveEvent(self.h, event.h)

type QDockWidgetdragMoveEventProc* = proc(event: QDragMoveEvent): void
...
proc miqt_exec_callback_QDockWidget_dragMoveEvent(self: ptr cQDockWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QDockWidget_dragMoveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QDockWidgetdragLeaveEvent*(self: gen_qdockwidget_types.QDockWidget, event: QDragLeaveEvent): void =
  fQDockWidget_virtualbase_dragLeaveEvent(self.h, event.h)

type QDockWidgetdragLeaveEventProc* = proc(event: QDragLeaveEvent): void
...
proc miqt_exec_callback_QDockWidget_dragLeaveEvent(self: ptr cQDockWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QDockWidget_dragLeaveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QDockWidgetdropEvent*(self: gen_qdockwidget_types.QDockWidget, event: QDropEvent): void =
  fQDockWidget_virtualbase_dropEvent(self.h, event.h)

type QDockWidgetdropEventProc* = proc(event: QDropEvent): void
...
proc miqt_exec_callback_QDockWidget_dropEvent(self: ptr cQDockWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QDockWidget_dropEvent ".} =
  ...
  nimfunc[](slotval1)
proc QDockWidgetshowEvent*(self: gen_qdockwidget_types.QDockWidget, event: QShowEvent): void =
  fQDockWidget_virtualbase_showEvent(self.h, event.h)

type QDockWidgetshowEventProc* = proc(event: QShowEvent): void
...
proc miqt_exec_callback_QDockWidget_showEvent(self: ptr cQDockWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QDockWidget_showEvent ".} =
  ...
  nimfunc[](slotval1)
proc QDockWidgethideEvent*(self: gen_qdockwidget_types.QDockWidget, event: QHideEvent): void =
  fQDockWidget_virtualbase_hideEvent(self.h, event.h)

type QDockWidgethideEventProc* = proc(event: QHideEvent): void
...
type QDockWidgetnativeEventProc* = proc(eventType: seq[byte], message: pointer, resultVal: ptr uint): bool
...
proc miqt_exec_callback_QDockWidget_nativeEvent(self: ptr cQDockWidget, slot: int, eventType: struct_miqt_string, message: pointer, resultVal: ptr uint): bool {.exportc: "miqt_exec_callback_QDockWidget_nativeEvent ".} =
...
proc miqt_exec_callback_QDockWidget_metric(self: ptr cQDockWidget, slot: int, param1: cint): cint {.exportc: "miqt_exec_callback_QDockWidget_metric ".} =
  ...
  virtualReturn
proc QDockWidgetinitPainter*(self: gen_qdockwidget_types.QDockWidget, painter: QPainter): void =
  fQDockWidget_virtualbase_initPainter(self.h, painter.h)

type QDockWidgetinitPainterProc* = proc(painter: QPainter): void
...
proc miqt_exec_callback_QDockWidget_initPainter(self: ptr cQDockWidget, slot: int, painter: pointer): void {.exportc: "miqt_exec_callback_QDockWidget_initPainter ".} =
  ...
  nimfunc[](slotval1)
proc QDockWidgetredirected*(self: gen_qdockwidget_types.QDockWidget, offset: QPoint): QPaintDevice =
  QPaintDevice(h: fQDockWidget_virtualbase_redirected(self.h, offset.h))

type QDockWidgetredirectedProc* = proc(offset: QPoint): QPaintDevice
...
proc miqt_exec_callback_QDockWidget_redirected(self: ptr cQDockWidget, slot: int, offset: pointer): pointer {.exportc: "miqt_exec_callback_QDockWidget_redirected ".} =
  ...
  virtualReturn.h
proc QDockWidgetsharedPainter*(self: gen_qdockwidget_types.QDockWidget, ): QPainter =
  QPainter(h: fQDockWidget_virtualbase_sharedPainter(self.h))

type QDockWidgetsharedPainterProc* = proc(): QPainter
...
proc miqt_exec_callback_QDockWidget_sharedPainter(self: ptr cQDockWidget, slot: int): pointer {.exportc: "miqt_exec_callback_QDockWidget_sharedPainter ".} =
  ...
  virtualReturn.h
proc QDockWidgetinputMethodEvent*(self: gen_qdockwidget_types.QDockWidget, param1: QInputMethodEvent): void =
  fQDockWidget_virtualbase_inputMethodEvent(self.h, param1.h)

type QDockWidgetinputMethodEventProc* = proc(param1: QInputMethodEvent): void
...
proc miqt_exec_callback_QDockWidget_inputMethodEvent(self: ptr cQDockWidget, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QDockWidget_inputMethodEvent ".} =
  ...
  nimfunc[](slotval1)
proc QDockWidgetinputMethodQuery*(self: gen_qdockwidget_types.QDockWidget, param1: cint): QVariant =
  QVariant(h: fQDockWidget_virtualbase_inputMethodQuery(self.h, cint(param1)))

type QDockWidgetinputMethodQueryProc* = proc(param1: cint): QVariant
...
proc miqt_exec_callback_QDockWidget_focusNextPrevChild(self: ptr cQDockWidget, slot: int, next: bool): bool {.exportc: "miqt_exec_callback_QDockWidget_focusNextPrevChild ".} =
  ...
  virtualReturn
proc QDockWidgeteventFilter*(self: gen_qdockwidget_types.QDockWidget, watched: QObject, event: QEvent): bool =
  fQDockWidget_virtualbase_eventFilter(self.h, watched.h, event.h)

type QDockWidgeteventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QDockWidget_eventFilter(self: ptr cQDockWidget, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QDockWidget_eventFilter ".} =
  ...
  virtualReturn
proc QDockWidgettimerEvent*(self: gen_qdockwidget_types.QDockWidget, event: QTimerEvent): void =
  fQDockWidget_virtualbase_timerEvent(self.h, event.h)

type QDockWidgettimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QDockWidget_timerEvent(self: ptr cQDockWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QDockWidget_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QDockWidgetchildEvent*(self: gen_qdockwidget_types.QDockWidget, event: QChildEvent): void =
  fQDockWidget_virtualbase_childEvent(self.h, event.h)

type QDockWidgetchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QDockWidget_childEvent(self: ptr cQDockWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QDockWidget_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QDockWidgetcustomEvent*(self: gen_qdockwidget_types.QDockWidget, event: QEvent): void =
  fQDockWidget_virtualbase_customEvent(self.h, event.h)

type QDockWidgetcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QDockWidget_customEvent(self: ptr cQDockWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QDockWidget_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QDockWidgetconnectNotify*(self: gen_qdockwidget_types.QDockWidget, signal: QMetaMethod): void =
  fQDockWidget_virtualbase_connectNotify(self.h, signal.h)

type QDockWidgetconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QDockWidget_connectNotify(self: ptr cQDockWidget, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QDockWidget_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QDockWidgetdisconnectNotify*(self: gen_qdockwidget_types.QDockWidget, signal: QMetaMethod): void =
  fQDockWidget_virtualbase_disconnectNotify(self.h, signal.h)

type QDockWidgetdisconnectNotifyProc* = proc(signal: QMetaMethod): void
