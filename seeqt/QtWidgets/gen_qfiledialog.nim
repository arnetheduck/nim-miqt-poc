...
proc setIconProvider*(self: gen_qfiledialog_types.QFileDialog, provider: QAbstractFileIconProvider): void =
  fcQFileDialog_setIconProvider(self.h, provider.h)

proc iconProvider*(self: gen_qfiledialog_types.QFileDialog, ): QAbstractFileIconProvider =
  QAbstractFileIconProvider(h: fcQFileDialog_iconProvider(self.h))
...
proc miqt_exec_callback_QFileDialog_focusOutEvent(self: ptr cQFileDialog, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QFileDialog_focusOutEvent ".} =
  ...
  nimfunc[](slotval1)
proc QFileDialogenterEvent*(self: gen_qfiledialog_types.QFileDialog, event: QEnterEvent): void =
  fQFileDialog_virtualbase_enterEvent(self.h, event.h)

type QFileDialogenterEventProc* = proc(event: QEnterEvent): void
