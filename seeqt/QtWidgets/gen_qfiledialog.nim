...
func init*(T: type gen_qfiledialog_types.QFileDialog, h: ptr cQFileDialog): gen_qfiledialog_types.QFileDialog =
  T(h: h)
proc create*(T: type gen_qfiledialog_types.QFileDialog, parent: QWidget): gen_qfiledialog_types.QFileDialog =
  gen_qfiledialog_types.QFileDialog.init(fcQFileDialog_new(parent.h))

proc create*(T: type gen_qfiledialog_types.QFileDialog, parent: QWidget, f: cint): gen_qfiledialog_types.QFileDialog =
...
proc create*(T: type gen_qfiledialog_types.QFileDialog, parent: QWidget, caption: string): gen_qfiledialog_types.QFileDialog =
...
proc create*(T: type gen_qfiledialog_types.QFileDialog, parent: QWidget, caption: string, directory: string): gen_qfiledialog_types.QFileDialog =
...
proc create*(T: type gen_qfiledialog_types.QFileDialog, parent: QWidget, caption: string, directory: string, filter: string): gen_qfiledialog_types.QFileDialog =
...
proc metaObject*(self: gen_qfiledialog_types.QFileDialog, ): QMetaObject =
  QMetaObject(h: fcQFileDialog_metaObject(self.h))
...
proc setDirectory*(self: gen_qfiledialog_types.QFileDialog, directory: QDir): void =
  fcQFileDialog_setDirectoryWithDirectory(self.h, directory.h)

proc directory*(self: gen_qfiledialog_types.QFileDialog, ): QDir =
  QDir(h: fcQFileDialog_directory(self.h))

proc setDirectoryUrl*(self: gen_qfiledialog_types.QFileDialog, directory: QUrl): void =
  fcQFileDialog_setDirectoryUrl(self.h, directory.h)

proc directoryUrl*(self: gen_qfiledialog_types.QFileDialog, ): QUrl =
  QUrl(h: fcQFileDialog_directoryUrl(self.h))
...
proc selectUrl*(self: gen_qfiledialog_types.QFileDialog, url: QUrl): void =
  fcQFileDialog_selectUrl(self.h, url.h)

proc selectedUrls*(self: gen_qfiledialog_types.QFileDialog, ): seq[QUrl] =
...
proc setSidebarUrls*(self: gen_qfiledialog_types.QFileDialog, urls: seq[QUrl]): void =
...
proc sidebarUrls*(self: gen_qfiledialog_types.QFileDialog, ): seq[QUrl] =
...
proc setItemDelegate*(self: gen_qfiledialog_types.QFileDialog, delegate: QAbstractItemDelegate): void =
  fcQFileDialog_setItemDelegate(self.h, delegate.h)

proc itemDelegate*(self: gen_qfiledialog_types.QFileDialog, ): QAbstractItemDelegate =
  QAbstractItemDelegate(h: fcQFileDialog_itemDelegate(self.h))

proc setIconProvider*(self: gen_qfiledialog_types.QFileDialog, provider: QFileIconProvider): void =
  fcQFileDialog_setIconProvider(self.h, provider.h)

proc iconProvider*(self: gen_qfiledialog_types.QFileDialog, ): QFileIconProvider =
  QFileIconProvider(h: fcQFileDialog_iconProvider(self.h))
...
proc setProxyModel*(self: gen_qfiledialog_types.QFileDialog, model: QAbstractProxyModel): void =
  fcQFileDialog_setProxyModel(self.h, model.h)

proc proxyModel*(self: gen_qfiledialog_types.QFileDialog, ): QAbstractProxyModel =
  QAbstractProxyModel(h: fcQFileDialog_proxyModel(self.h))
...
proc urlSelected*(self: gen_qfiledialog_types.QFileDialog, url: QUrl): void =
  fcQFileDialog_urlSelected(self.h, url.h)

type QFileDialogurlSelectedSlot* = proc(url: QUrl)
...
proc urlsSelected*(self: gen_qfiledialog_types.QFileDialog, urls: seq[QUrl]): void =
  var urls_CArray = newSeq[pointer](len(urls))
  for i in 0..<len(urls):
    urls_CArray[i] = urls[i].h
...
type QFileDialogurlsSelectedSlot* = proc(urls: seq[QUrl])
...
proc currentUrlChanged*(self: gen_qfiledialog_types.QFileDialog, url: QUrl): void =
  fcQFileDialog_currentUrlChanged(self.h, url.h)

type QFileDialogcurrentUrlChangedSlot* = proc(url: QUrl)
...
proc directoryUrlEntered*(self: gen_qfiledialog_types.QFileDialog, directory: QUrl): void =
  fcQFileDialog_directoryUrlEntered(self.h, directory.h)

type QFileDialogdirectoryUrlEnteredSlot* = proc(directory: QUrl)
...
proc getOpenFileUrl*(_: type gen_qfiledialog_types.QFileDialog, ): QUrl =
  QUrl(h: fcQFileDialog_getOpenFileUrl())
...
proc getSaveFileUrl*(_: type gen_qfiledialog_types.QFileDialog, ): QUrl =
  QUrl(h: fcQFileDialog_getSaveFileUrl())
...
proc getExistingDirectoryUrl*(_: type gen_qfiledialog_types.QFileDialog, ): QUrl =
  QUrl(h: fcQFileDialog_getExistingDirectoryUrl())
...
proc getOpenFileUrls*(_: type gen_qfiledialog_types.QFileDialog, ): seq[QUrl] =
...
proc getOpenFileName*(_: type gen_qfiledialog_types.QFileDialog, parent: QWidget): string =
  let v_ms = fcQFileDialog_getOpenFileName1(parent.h)
  let vx_ret = string.fromBytes(toOpenArrayByte(v_ms.data, 0, int(v_ms.len)-1))
  c_free(v_ms.data)
  vx_ret

proc getOpenFileName*(_: type gen_qfiledialog_types.QFileDialog, parent: QWidget, caption: string): string =
  let v_ms = fcQFileDialog_getOpenFileName2(parent.h, struct_miqt_string(data: caption, len: csize_t(len(caption))))
  let vx_ret = string.fromBytes(toOpenArrayByte(v_ms.data, 0, int(v_ms.len)-1))
  c_free(v_ms.data)
  vx_ret

proc getOpenFileName*(_: type gen_qfiledialog_types.QFileDialog, parent: QWidget, caption: string, dir: string): string =
...
proc getOpenFileName*(_: type gen_qfiledialog_types.QFileDialog, parent: QWidget, caption: string, dir: string, filter: string): string =
...
proc getOpenFileUrl*(_: type gen_qfiledialog_types.QFileDialog, parent: QWidget): QUrl =
  QUrl(h: fcQFileDialog_getOpenFileUrl1(parent.h))

proc getOpenFileUrl*(_: type gen_qfiledialog_types.QFileDialog, parent: QWidget, caption: string): QUrl =
  QUrl(h: fcQFileDialog_getOpenFileUrl2(parent.h, struct_miqt_string(data: caption, len: csize_t(len(caption)))))

proc getOpenFileUrl*(_: type gen_qfiledialog_types.QFileDialog, parent: QWidget, caption: string, dir: QUrl): QUrl =
  QUrl(h: fcQFileDialog_getOpenFileUrl3(parent.h, struct_miqt_string(data: caption, len: csize_t(len(caption))), dir.h))

proc getOpenFileUrl*(_: type gen_qfiledialog_types.QFileDialog, parent: QWidget, caption: string, dir: QUrl, filter: string): QUrl =
  QUrl(h: fcQFileDialog_getOpenFileUrl4(parent.h, struct_miqt_string(data: caption, len: csize_t(len(caption))), dir.h, struct_miqt_string(data: filter, len: csize_t(len(filter)))))

proc getSaveFileName*(_: type gen_qfiledialog_types.QFileDialog, parent: QWidget): string =
  let v_ms = fcQFileDialog_getSaveFileName1(parent.h)
  let vx_ret = string.fromBytes(toOpenArrayByte(v_ms.data, 0, int(v_ms.len)-1))
  c_free(v_ms.data)
  vx_ret

proc getSaveFileName*(_: type gen_qfiledialog_types.QFileDialog, parent: QWidget, caption: string): string =
  let v_ms = fcQFileDialog_getSaveFileName2(parent.h, struct_miqt_string(data: caption, len: csize_t(len(caption))))
  let vx_ret = string.fromBytes(toOpenArrayByte(v_ms.data, 0, int(v_ms.len)-1))
  c_free(v_ms.data)
  vx_ret

proc getSaveFileName*(_: type gen_qfiledialog_types.QFileDialog, parent: QWidget, caption: string, dir: string): string =
...
proc getSaveFileName*(_: type gen_qfiledialog_types.QFileDialog, parent: QWidget, caption: string, dir: string, filter: string): string =
...
proc getSaveFileUrl*(_: type gen_qfiledialog_types.QFileDialog, parent: QWidget): QUrl =
  QUrl(h: fcQFileDialog_getSaveFileUrl1(parent.h))

proc getSaveFileUrl*(_: type gen_qfiledialog_types.QFileDialog, parent: QWidget, caption: string): QUrl =
  QUrl(h: fcQFileDialog_getSaveFileUrl2(parent.h, struct_miqt_string(data: caption, len: csize_t(len(caption)))))

proc getSaveFileUrl*(_: type gen_qfiledialog_types.QFileDialog, parent: QWidget, caption: string, dir: QUrl): QUrl =
  QUrl(h: fcQFileDialog_getSaveFileUrl3(parent.h, struct_miqt_string(data: caption, len: csize_t(len(caption))), dir.h))

proc getSaveFileUrl*(_: type gen_qfiledialog_types.QFileDialog, parent: QWidget, caption: string, dir: QUrl, filter: string): QUrl =
  QUrl(h: fcQFileDialog_getSaveFileUrl4(parent.h, struct_miqt_string(data: caption, len: csize_t(len(caption))), dir.h, struct_miqt_string(data: filter, len: csize_t(len(filter)))))

proc getExistingDirectory*(_: type gen_qfiledialog_types.QFileDialog, parent: QWidget): string =
  let v_ms = fcQFileDialog_getExistingDirectory1(parent.h)
  let vx_ret = string.fromBytes(toOpenArrayByte(v_ms.data, 0, int(v_ms.len)-1))
  c_free(v_ms.data)
  vx_ret

proc getExistingDirectory*(_: type gen_qfiledialog_types.QFileDialog, parent: QWidget, caption: string): string =
  let v_ms = fcQFileDialog_getExistingDirectory2(parent.h, struct_miqt_string(data: caption, len: csize_t(len(caption))))
  let vx_ret = string.fromBytes(toOpenArrayByte(v_ms.data, 0, int(v_ms.len)-1))
  c_free(v_ms.data)
  vx_ret

proc getExistingDirectory*(_: type gen_qfiledialog_types.QFileDialog, parent: QWidget, caption: string, dir: string): string =
...
proc getExistingDirectory*(_: type gen_qfiledialog_types.QFileDialog, parent: QWidget, caption: string, dir: string, options: cint): string =
...
proc getExistingDirectoryUrl*(_: type gen_qfiledialog_types.QFileDialog, parent: QWidget): QUrl =
  QUrl(h: fcQFileDialog_getExistingDirectoryUrl1(parent.h))

proc getExistingDirectoryUrl*(_: type gen_qfiledialog_types.QFileDialog, parent: QWidget, caption: string): QUrl =
  QUrl(h: fcQFileDialog_getExistingDirectoryUrl2(parent.h, struct_miqt_string(data: caption, len: csize_t(len(caption)))))

proc getExistingDirectoryUrl*(_: type gen_qfiledialog_types.QFileDialog, parent: QWidget, caption: string, dir: QUrl): QUrl =
  QUrl(h: fcQFileDialog_getExistingDirectoryUrl3(parent.h, struct_miqt_string(data: caption, len: csize_t(len(caption))), dir.h))

proc getExistingDirectoryUrl*(_: type gen_qfiledialog_types.QFileDialog, parent: QWidget, caption: string, dir: QUrl, options: cint): QUrl =
  QUrl(h: fcQFileDialog_getExistingDirectoryUrl4(parent.h, struct_miqt_string(data: caption, len: csize_t(len(caption))), dir.h, cint(options)))

proc getExistingDirectoryUrl*(_: type gen_qfiledialog_types.QFileDialog, parent: QWidget, caption: string, dir: QUrl, options: cint, supportedSchemes: seq[string]): QUrl =
  ...
  QUrl(h: fcQFileDialog_getExistingDirectoryUrl5(parent.h, struct_miqt_string(data: caption, len: csize_t(len(caption))), dir.h, cint(options), struct_miqt_array(len: csize_t(len(supportedSchemes)), data: if len(supportedSchemes) == 0: nil else: addr(supportedSchemes_CArray[0]))))

proc getOpenFileNames*(_: type gen_qfiledialog_types.QFileDialog, parent: QWidget): seq[string] =
...
proc getOpenFileNames*(_: type gen_qfiledialog_types.QFileDialog, parent: QWidget, caption: string): seq[string] =
...
proc getOpenFileNames*(_: type gen_qfiledialog_types.QFileDialog, parent: QWidget, caption: string, dir: string): seq[string] =
...
proc getOpenFileNames*(_: type gen_qfiledialog_types.QFileDialog, parent: QWidget, caption: string, dir: string, filter: string): seq[string] =
...
proc getOpenFileUrls*(_: type gen_qfiledialog_types.QFileDialog, parent: QWidget): seq[QUrl] =
...
proc getOpenFileUrls*(_: type gen_qfiledialog_types.QFileDialog, parent: QWidget, caption: string): seq[QUrl] =
...
proc getOpenFileUrls*(_: type gen_qfiledialog_types.QFileDialog, parent: QWidget, caption: string, dir: QUrl): seq[QUrl] =
...
proc getOpenFileUrls*(_: type gen_qfiledialog_types.QFileDialog, parent: QWidget, caption: string, dir: QUrl, filter: string): seq[QUrl] =
...
proc miqt_exec_callback_QFileDialog_accept(self: ptr cQFileDialog, slot: int): void {.exportc: "miqt_exec_callback_QFileDialog_accept ".} =
  ...
  nimfunc[]()
proc QFileDialogchangeEvent*(self: gen_qfiledialog_types.QFileDialog, e: QEvent): void =
  fQFileDialog_virtualbase_changeEvent(self.h, e.h)

type QFileDialogchangeEventProc* = proc(e: QEvent): void
...
proc miqt_exec_callback_QFileDialog_changeEvent(self: ptr cQFileDialog, slot: int, e: pointer): void {.exportc: "miqt_exec_callback_QFileDialog_changeEvent ".} =
  ...
  nimfunc[](slotval1)
proc QFileDialogsizeHint*(self: gen_qfiledialog_types.QFileDialog, ): QSize =
  QSize(h: fQFileDialog_virtualbase_sizeHint(self.h))

type QFileDialogsizeHintProc* = proc(): QSize
...
proc miqt_exec_callback_QFileDialog_sizeHint(self: ptr cQFileDialog, slot: int): pointer {.exportc: "miqt_exec_callback_QFileDialog_sizeHint ".} =
  ...
  virtualReturn.h
proc QFileDialogminimumSizeHint*(self: gen_qfiledialog_types.QFileDialog, ): QSize =
  QSize(h: fQFileDialog_virtualbase_minimumSizeHint(self.h))

type QFileDialogminimumSizeHintProc* = proc(): QSize
...
proc miqt_exec_callback_QFileDialog_reject(self: ptr cQFileDialog, slot: int): void {.exportc: "miqt_exec_callback_QFileDialog_reject ".} =
  ...
  nimfunc[]()
proc QFileDialogkeyPressEvent*(self: gen_qfiledialog_types.QFileDialog, param1: QKeyEvent): void =
  fQFileDialog_virtualbase_keyPressEvent(self.h, param1.h)

type QFileDialogkeyPressEventProc* = proc(param1: QKeyEvent): void
...
proc miqt_exec_callback_QFileDialog_keyPressEvent(self: ptr cQFileDialog, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QFileDialog_keyPressEvent ".} =
  ...
  let slotval1 = QKeyEvent(h: param1)


  nimfunc[](slotval1)
proc QFileDialogcloseEvent*(self: gen_qfiledialog_types.QFileDialog, param1: QCloseEvent): void =
  fQFileDialog_virtualbase_closeEvent(self.h, param1.h)

type QFileDialogcloseEventProc* = proc(param1: QCloseEvent): void
...
proc miqt_exec_callback_QFileDialog_closeEvent(self: ptr cQFileDialog, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QFileDialog_closeEvent ".} =
  ...
  let slotval1 = QCloseEvent(h: param1)


  nimfunc[](slotval1)
proc QFileDialogshowEvent*(self: gen_qfiledialog_types.QFileDialog, param1: QShowEvent): void =
  fQFileDialog_virtualbase_showEvent(self.h, param1.h)

type QFileDialogshowEventProc* = proc(param1: QShowEvent): void
...
proc miqt_exec_callback_QFileDialog_showEvent(self: ptr cQFileDialog, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QFileDialog_showEvent ".} =
  ...
  nimfunc[](slotval1)
proc QFileDialogresizeEvent*(self: gen_qfiledialog_types.QFileDialog, param1: QResizeEvent): void =
  fQFileDialog_virtualbase_resizeEvent(self.h, param1.h)

type QFileDialogresizeEventProc* = proc(param1: QResizeEvent): void
...
proc miqt_exec_callback_QFileDialog_resizeEvent(self: ptr cQFileDialog, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QFileDialog_resizeEvent ".} =
  ...
  nimfunc[](slotval1)
proc QFileDialogcontextMenuEvent*(self: gen_qfiledialog_types.QFileDialog, param1: QContextMenuEvent): void =
  fQFileDialog_virtualbase_contextMenuEvent(self.h, param1.h)

type QFileDialogcontextMenuEventProc* = proc(param1: QContextMenuEvent): void
...
proc miqt_exec_callback_QFileDialog_contextMenuEvent(self: ptr cQFileDialog, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QFileDialog_contextMenuEvent ".} =
  ...
  nimfunc[](slotval1)
proc QFileDialogeventFilter*(self: gen_qfiledialog_types.QFileDialog, param1: QObject, param2: QEvent): bool =
  fQFileDialog_virtualbase_eventFilter(self.h, param1.h, param2.h)

type QFileDialogeventFilterProc* = proc(param1: QObject, param2: QEvent): bool
...
proc miqt_exec_callback_QFileDialog_hasHeightForWidth(self: ptr cQFileDialog, slot: int): bool {.exportc: "miqt_exec_callback_QFileDialog_hasHeightForWidth ".} =
  ...
  virtualReturn
proc QFileDialogpaintEngine*(self: gen_qfiledialog_types.QFileDialog, ): QPaintEngine =
  QPaintEngine(h: fQFileDialog_virtualbase_paintEngine(self.h))

type QFileDialogpaintEngineProc* = proc(): QPaintEngine
...
proc miqt_exec_callback_QFileDialog_paintEngine(self: ptr cQFileDialog, slot: int): pointer {.exportc: "miqt_exec_callback_QFileDialog_paintEngine ".} =
  ...
  virtualReturn.h
proc QFileDialogevent*(self: gen_qfiledialog_types.QFileDialog, event: QEvent): bool =
  fQFileDialog_virtualbase_event(self.h, event.h)

type QFileDialogeventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QFileDialog_event(self: ptr cQFileDialog, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QFileDialog_event ".} =
  ...
  virtualReturn
proc QFileDialogmousePressEvent*(self: gen_qfiledialog_types.QFileDialog, event: QMouseEvent): void =
  fQFileDialog_virtualbase_mousePressEvent(self.h, event.h)

type QFileDialogmousePressEventProc* = proc(event: QMouseEvent): void
...
proc miqt_exec_callback_QFileDialog_mousePressEvent(self: ptr cQFileDialog, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QFileDialog_mousePressEvent ".} =
  ...
  nimfunc[](slotval1)
proc QFileDialogmouseReleaseEvent*(self: gen_qfiledialog_types.QFileDialog, event: QMouseEvent): void =
  fQFileDialog_virtualbase_mouseReleaseEvent(self.h, event.h)

type QFileDialogmouseReleaseEventProc* = proc(event: QMouseEvent): void
...
proc miqt_exec_callback_QFileDialog_mouseReleaseEvent(self: ptr cQFileDialog, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QFileDialog_mouseReleaseEvent ".} =
  ...
  nimfunc[](slotval1)
proc QFileDialogmouseDoubleClickEvent*(self: gen_qfiledialog_types.QFileDialog, event: QMouseEvent): void =
  fQFileDialog_virtualbase_mouseDoubleClickEvent(self.h, event.h)

type QFileDialogmouseDoubleClickEventProc* = proc(event: QMouseEvent): void
...
proc miqt_exec_callback_QFileDialog_mouseDoubleClickEvent(self: ptr cQFileDialog, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QFileDialog_mouseDoubleClickEvent ".} =
  ...
  nimfunc[](slotval1)
proc QFileDialogmouseMoveEvent*(self: gen_qfiledialog_types.QFileDialog, event: QMouseEvent): void =
  fQFileDialog_virtualbase_mouseMoveEvent(self.h, event.h)

type QFileDialogmouseMoveEventProc* = proc(event: QMouseEvent): void
...
proc miqt_exec_callback_QFileDialog_mouseMoveEvent(self: ptr cQFileDialog, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QFileDialog_mouseMoveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QFileDialogwheelEvent*(self: gen_qfiledialog_types.QFileDialog, event: QWheelEvent): void =
  fQFileDialog_virtualbase_wheelEvent(self.h, event.h)

type QFileDialogwheelEventProc* = proc(event: QWheelEvent): void
...
proc miqt_exec_callback_QFileDialog_wheelEvent(self: ptr cQFileDialog, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QFileDialog_wheelEvent ".} =
  ...
  nimfunc[](slotval1)
proc QFileDialogkeyReleaseEvent*(self: gen_qfiledialog_types.QFileDialog, event: QKeyEvent): void =
  fQFileDialog_virtualbase_keyReleaseEvent(self.h, event.h)

type QFileDialogkeyReleaseEventProc* = proc(event: QKeyEvent): void
...
proc miqt_exec_callback_QFileDialog_keyReleaseEvent(self: ptr cQFileDialog, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QFileDialog_keyReleaseEvent ".} =
  ...
  nimfunc[](slotval1)
proc QFileDialogfocusInEvent*(self: gen_qfiledialog_types.QFileDialog, event: QFocusEvent): void =
  fQFileDialog_virtualbase_focusInEvent(self.h, event.h)

type QFileDialogfocusInEventProc* = proc(event: QFocusEvent): void
...
proc miqt_exec_callback_QFileDialog_focusInEvent(self: ptr cQFileDialog, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QFileDialog_focusInEvent ".} =
  ...
  nimfunc[](slotval1)
proc QFileDialogfocusOutEvent*(self: gen_qfiledialog_types.QFileDialog, event: QFocusEvent): void =
  fQFileDialog_virtualbase_focusOutEvent(self.h, event.h)

type QFileDialogfocusOutEventProc* = proc(event: QFocusEvent): void
...
proc miqt_exec_callback_QFileDialog_focusOutEvent(self: ptr cQFileDialog, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QFileDialog_focusOutEvent ".} =
  ...
  nimfunc[](slotval1)
proc QFileDialogenterEvent*(self: gen_qfiledialog_types.QFileDialog, event: QEvent): void =
  fQFileDialog_virtualbase_enterEvent(self.h, event.h)

type QFileDialogenterEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QFileDialog_enterEvent(self: ptr cQFileDialog, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QFileDialog_enterEvent ".} =
  ...
  nimfunc[](slotval1)
proc QFileDialogleaveEvent*(self: gen_qfiledialog_types.QFileDialog, event: QEvent): void =
  fQFileDialog_virtualbase_leaveEvent(self.h, event.h)

type QFileDialogleaveEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QFileDialog_leaveEvent(self: ptr cQFileDialog, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QFileDialog_leaveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QFileDialogpaintEvent*(self: gen_qfiledialog_types.QFileDialog, event: QPaintEvent): void =
  fQFileDialog_virtualbase_paintEvent(self.h, event.h)

type QFileDialogpaintEventProc* = proc(event: QPaintEvent): void
...
proc miqt_exec_callback_QFileDialog_paintEvent(self: ptr cQFileDialog, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QFileDialog_paintEvent ".} =
  ...
  nimfunc[](slotval1)
proc QFileDialogmoveEvent*(self: gen_qfiledialog_types.QFileDialog, event: QMoveEvent): void =
  fQFileDialog_virtualbase_moveEvent(self.h, event.h)

type QFileDialogmoveEventProc* = proc(event: QMoveEvent): void
...
proc miqt_exec_callback_QFileDialog_moveEvent(self: ptr cQFileDialog, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QFileDialog_moveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QFileDialogtabletEvent*(self: gen_qfiledialog_types.QFileDialog, event: QTabletEvent): void =
  fQFileDialog_virtualbase_tabletEvent(self.h, event.h)

type QFileDialogtabletEventProc* = proc(event: QTabletEvent): void
...
proc miqt_exec_callback_QFileDialog_tabletEvent(self: ptr cQFileDialog, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QFileDialog_tabletEvent ".} =
  ...
  nimfunc[](slotval1)
proc QFileDialogactionEvent*(self: gen_qfiledialog_types.QFileDialog, event: QActionEvent): void =
  fQFileDialog_virtualbase_actionEvent(self.h, event.h)

type QFileDialogactionEventProc* = proc(event: QActionEvent): void
...
proc miqt_exec_callback_QFileDialog_actionEvent(self: ptr cQFileDialog, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QFileDialog_actionEvent ".} =
  ...
  nimfunc[](slotval1)
proc QFileDialogdragEnterEvent*(self: gen_qfiledialog_types.QFileDialog, event: QDragEnterEvent): void =
  fQFileDialog_virtualbase_dragEnterEvent(self.h, event.h)

type QFileDialogdragEnterEventProc* = proc(event: QDragEnterEvent): void
...
proc miqt_exec_callback_QFileDialog_dragEnterEvent(self: ptr cQFileDialog, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QFileDialog_dragEnterEvent ".} =
  ...
  nimfunc[](slotval1)
proc QFileDialogdragMoveEvent*(self: gen_qfiledialog_types.QFileDialog, event: QDragMoveEvent): void =
  fQFileDialog_virtualbase_dragMoveEvent(self.h, event.h)

type QFileDialogdragMoveEventProc* = proc(event: QDragMoveEvent): void
...
proc miqt_exec_callback_QFileDialog_dragMoveEvent(self: ptr cQFileDialog, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QFileDialog_dragMoveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QFileDialogdragLeaveEvent*(self: gen_qfiledialog_types.QFileDialog, event: QDragLeaveEvent): void =
  fQFileDialog_virtualbase_dragLeaveEvent(self.h, event.h)

type QFileDialogdragLeaveEventProc* = proc(event: QDragLeaveEvent): void
...
proc miqt_exec_callback_QFileDialog_dragLeaveEvent(self: ptr cQFileDialog, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QFileDialog_dragLeaveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QFileDialogdropEvent*(self: gen_qfiledialog_types.QFileDialog, event: QDropEvent): void =
  fQFileDialog_virtualbase_dropEvent(self.h, event.h)

type QFileDialogdropEventProc* = proc(event: QDropEvent): void
...
proc miqt_exec_callback_QFileDialog_dropEvent(self: ptr cQFileDialog, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QFileDialog_dropEvent ".} =
  ...
  nimfunc[](slotval1)
proc QFileDialoghideEvent*(self: gen_qfiledialog_types.QFileDialog, event: QHideEvent): void =
  fQFileDialog_virtualbase_hideEvent(self.h, event.h)

type QFileDialoghideEventProc* = proc(event: QHideEvent): void
...
proc miqt_exec_callback_QFileDialog_hideEvent(self: ptr cQFileDialog, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QFileDialog_hideEvent ".} =
  ...
  nimfunc[](slotval1)
proc QFileDialognativeEvent*(self: gen_qfiledialog_types.QFileDialog, eventType: seq[byte], message: pointer, resultVal: ptr clong): bool =
...
type QFileDialognativeEventProc* = proc(eventType: seq[byte], message: pointer, resultVal: ptr clong): bool
...
proc miqt_exec_callback_QFileDialog_metric(self: ptr cQFileDialog, slot: int, param1: cint): cint {.exportc: "miqt_exec_callback_QFileDialog_metric ".} =
  ...
  virtualReturn
proc QFileDialoginitPainter*(self: gen_qfiledialog_types.QFileDialog, painter: QPainter): void =
  fQFileDialog_virtualbase_initPainter(self.h, painter.h)

type QFileDialoginitPainterProc* = proc(painter: QPainter): void
...
proc miqt_exec_callback_QFileDialog_initPainter(self: ptr cQFileDialog, slot: int, painter: pointer): void {.exportc: "miqt_exec_callback_QFileDialog_initPainter ".} =
  ...
  nimfunc[](slotval1)
proc QFileDialogredirected*(self: gen_qfiledialog_types.QFileDialog, offset: QPoint): QPaintDevice =
  QPaintDevice(h: fQFileDialog_virtualbase_redirected(self.h, offset.h))

type QFileDialogredirectedProc* = proc(offset: QPoint): QPaintDevice
...
proc miqt_exec_callback_QFileDialog_redirected(self: ptr cQFileDialog, slot: int, offset: pointer): pointer {.exportc: "miqt_exec_callback_QFileDialog_redirected ".} =
  ...
  virtualReturn.h
proc QFileDialogsharedPainter*(self: gen_qfiledialog_types.QFileDialog, ): QPainter =
  QPainter(h: fQFileDialog_virtualbase_sharedPainter(self.h))

type QFileDialogsharedPainterProc* = proc(): QPainter
...
proc miqt_exec_callback_QFileDialog_sharedPainter(self: ptr cQFileDialog, slot: int): pointer {.exportc: "miqt_exec_callback_QFileDialog_sharedPainter ".} =
  ...
  virtualReturn.h
proc QFileDialoginputMethodEvent*(self: gen_qfiledialog_types.QFileDialog, param1: QInputMethodEvent): void =
  fQFileDialog_virtualbase_inputMethodEvent(self.h, param1.h)

type QFileDialoginputMethodEventProc* = proc(param1: QInputMethodEvent): void
...
proc miqt_exec_callback_QFileDialog_inputMethodEvent(self: ptr cQFileDialog, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QFileDialog_inputMethodEvent ".} =
  ...
  nimfunc[](slotval1)
proc QFileDialoginputMethodQuery*(self: gen_qfiledialog_types.QFileDialog, param1: cint): QVariant =
  QVariant(h: fQFileDialog_virtualbase_inputMethodQuery(self.h, cint(param1)))

type QFileDialoginputMethodQueryProc* = proc(param1: cint): QVariant
...
proc miqt_exec_callback_QFileDialog_focusNextPrevChild(self: ptr cQFileDialog, slot: int, next: bool): bool {.exportc: "miqt_exec_callback_QFileDialog_focusNextPrevChild ".} =
  ...
  virtualReturn
proc QFileDialogtimerEvent*(self: gen_qfiledialog_types.QFileDialog, event: QTimerEvent): void =
  fQFileDialog_virtualbase_timerEvent(self.h, event.h)

type QFileDialogtimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QFileDialog_timerEvent(self: ptr cQFileDialog, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QFileDialog_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QFileDialogchildEvent*(self: gen_qfiledialog_types.QFileDialog, event: QChildEvent): void =
  fQFileDialog_virtualbase_childEvent(self.h, event.h)

type QFileDialogchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QFileDialog_childEvent(self: ptr cQFileDialog, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QFileDialog_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QFileDialogcustomEvent*(self: gen_qfiledialog_types.QFileDialog, event: QEvent): void =
  fQFileDialog_virtualbase_customEvent(self.h, event.h)

type QFileDialogcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QFileDialog_customEvent(self: ptr cQFileDialog, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QFileDialog_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QFileDialogconnectNotify*(self: gen_qfiledialog_types.QFileDialog, signal: QMetaMethod): void =
  fQFileDialog_virtualbase_connectNotify(self.h, signal.h)

type QFileDialogconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QFileDialog_connectNotify(self: ptr cQFileDialog, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QFileDialog_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QFileDialogdisconnectNotify*(self: gen_qfiledialog_types.QFileDialog, signal: QMetaMethod): void =
  fQFileDialog_virtualbase_disconnectNotify(self.h, signal.h)

type QFileDialogdisconnectNotifyProc* = proc(signal: QMetaMethod): void
