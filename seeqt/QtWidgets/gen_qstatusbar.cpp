...
void QStatusBar_connect_messageChanged(QStatusBar* self, intptr_t slot, void (*callback)(intptr_t, struct miqt_string), void (*release)(intptr_t)) {
	...
	MiqtVirtualQStatusBar::connect(self, static_cast<void (QStatusBar::*)(const QString&)>(&QStatusBar::messageChanged), self, caller{slot, callback, release});
}
...
QMetaObject* QStatusBar_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQStatusBar*)(self) )->QStatusBar::metaObject();

}

void* QStatusBar_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQStatusBar*)(self) )->QStatusBar::qt_metacast(param1);

}

int QStatusBar_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQStatusBar*)(self) )->QStatusBar::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
bool QStatusBar_virtualbase_nativeEvent(void* self, struct miqt_string eventType, void* message, long* result) {
	...
	return ( (MiqtVirtualQStatusBar*)(self) )->QStatusBar::nativeEvent(eventType_QByteArray, message, static_cast<long*>(result));
