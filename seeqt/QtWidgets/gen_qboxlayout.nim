...
proc create*(T: type gen_qboxlayout_types.QBoxLayout, param1: cint, parent: QWidget): gen_qboxlayout_types.QBoxLayout =
  gen_qboxlayout_types.QBoxLayout.init(fcQBoxLayout_new2(cint(param1), parent.h))

proc metaObject*(self: gen_qboxlayout_types.QBoxLayout, ): QMetaObject =
  QMetaObject(h: fcQBoxLayout_metaObject(self.h))
...
proc addSpacerItem*(self: gen_qboxlayout_types.QBoxLayout, spacerItem: QSpacerItem): void =
  fcQBoxLayout_addSpacerItem(self.h, spacerItem.h)

proc addWidget*(self: gen_qboxlayout_types.QBoxLayout, param1: QWidget): void =
  fcQBoxLayout_addWidget(self.h, param1.h)

proc addLayout*(self: gen_qboxlayout_types.QBoxLayout, layout: QLayout): void =
...
proc addItem*(self: gen_qboxlayout_types.QBoxLayout, param1: QLayoutItem): void =
...
proc insertSpacerItem*(self: gen_qboxlayout_types.QBoxLayout, index: cint, spacerItem: QSpacerItem): void =
  fcQBoxLayout_insertSpacerItem(self.h, index, spacerItem.h)

proc insertWidget*(self: gen_qboxlayout_types.QBoxLayout, index: cint, widget: QWidget): void =
  fcQBoxLayout_insertWidget(self.h, index, widget.h)

proc insertLayout*(self: gen_qboxlayout_types.QBoxLayout, index: cint, layout: QLayout): void =
  fcQBoxLayout_insertLayout(self.h, index, layout.h)

proc insertItem*(self: gen_qboxlayout_types.QBoxLayout, index: cint, param2: QLayoutItem): void =
...
proc setStretchFactor*(self: gen_qboxlayout_types.QBoxLayout, w: QWidget, stretch: cint): bool =
  fcQBoxLayout_setStretchFactor(self.h, w.h, stretch)

proc setStretchFactor*(self: gen_qboxlayout_types.QBoxLayout, l: QLayout, stretch: cint): bool =
...
proc sizeHint*(self: gen_qboxlayout_types.QBoxLayout, ): QSize =
  QSize(h: fcQBoxLayout_sizeHint(self.h))

proc minimumSize*(self: gen_qboxlayout_types.QBoxLayout, ): QSize =
  QSize(h: fcQBoxLayout_minimumSize(self.h))

proc maximumSize*(self: gen_qboxlayout_types.QBoxLayout, ): QSize =
  QSize(h: fcQBoxLayout_maximumSize(self.h))
...
proc itemAt*(self: gen_qboxlayout_types.QBoxLayout, param1: cint): QLayoutItem =
  QLayoutItem(h: fcQBoxLayout_itemAt(self.h, param1))

proc takeAt*(self: gen_qboxlayout_types.QBoxLayout, param1: cint): QLayoutItem =
  QLayoutItem(h: fcQBoxLayout_takeAt(self.h, param1))

proc count*(self: gen_qboxlayout_types.QBoxLayout, ): cint =
  fcQBoxLayout_count(self.h)

proc setGeometry*(self: gen_qboxlayout_types.QBoxLayout, geometry: QRect): void =
...
proc addWidget*(self: gen_qboxlayout_types.QBoxLayout, param1: QWidget, stretch: cint): void =
  fcQBoxLayout_addWidget2(self.h, param1.h, stretch)

proc addWidget*(self: gen_qboxlayout_types.QBoxLayout, param1: QWidget, stretch: cint, alignment: cint): void =
  fcQBoxLayout_addWidget3(self.h, param1.h, stretch, cint(alignment))

proc addLayout*(self: gen_qboxlayout_types.QBoxLayout, layout: QLayout, stretch: cint): void =
...
proc insertWidget*(self: gen_qboxlayout_types.QBoxLayout, index: cint, widget: QWidget, stretch: cint): void =
  fcQBoxLayout_insertWidget3(self.h, index, widget.h, stretch)

proc insertWidget*(self: gen_qboxlayout_types.QBoxLayout, index: cint, widget: QWidget, stretch: cint, alignment: cint): void =
  fcQBoxLayout_insertWidget4(self.h, index, widget.h, stretch, cint(alignment))

proc insertLayout*(self: gen_qboxlayout_types.QBoxLayout, index: cint, layout: QLayout, stretch: cint): void =
...
proc miqt_exec_callback_QBoxLayout_metacall(self: ptr cQBoxLayout, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QBoxLayout_metacall ".} =
  ...
  virtualReturn
proc QBoxLayoutaddItem*(self: gen_qboxlayout_types.QBoxLayout, param1: QLayoutItem): void =
  fQBoxLayout_virtualbase_addItem(self.h, param1.h)

type QBoxLayoutaddItemProc* = proc(param1: QLayoutItem): void
...
proc miqt_exec_callback_QBoxLayout_addItem(self: ptr cQBoxLayout, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QBoxLayout_addItem ".} =
  ...
  let slotval1 = QLayoutItem(h: param1)
...
proc miqt_exec_callback_QBoxLayout_setSpacing(self: ptr cQBoxLayout, slot: int, spacing: cint): void {.exportc: "miqt_exec_callback_QBoxLayout_setSpacing ".} =
  ...
  nimfunc[](slotval1)
proc QBoxLayoutsizeHint*(self: gen_qboxlayout_types.QBoxLayout, ): QSize =
  QSize(h: fQBoxLayout_virtualbase_sizeHint(self.h))

type QBoxLayoutsizeHintProc* = proc(): QSize
...
proc miqt_exec_callback_QBoxLayout_sizeHint(self: ptr cQBoxLayout, slot: int): pointer {.exportc: "miqt_exec_callback_QBoxLayout_sizeHint ".} =
  ...
  virtualReturn.h
proc QBoxLayoutminimumSize*(self: gen_qboxlayout_types.QBoxLayout, ): QSize =
  QSize(h: fQBoxLayout_virtualbase_minimumSize(self.h))

type QBoxLayoutminimumSizeProc* = proc(): QSize
...
proc miqt_exec_callback_QBoxLayout_minimumSize(self: ptr cQBoxLayout, slot: int): pointer {.exportc: "miqt_exec_callback_QBoxLayout_minimumSize ".} =
  ...
  virtualReturn.h
proc QBoxLayoutmaximumSize*(self: gen_qboxlayout_types.QBoxLayout, ): QSize =
  QSize(h: fQBoxLayout_virtualbase_maximumSize(self.h))

type QBoxLayoutmaximumSizeProc* = proc(): QSize
...
proc miqt_exec_callback_QBoxLayout_invalidate(self: ptr cQBoxLayout, slot: int): void {.exportc: "miqt_exec_callback_QBoxLayout_invalidate ".} =
  ...
  nimfunc[]()
proc QBoxLayoutitemAt*(self: gen_qboxlayout_types.QBoxLayout, param1: cint): QLayoutItem =
  QLayoutItem(h: fQBoxLayout_virtualbase_itemAt(self.h, param1))

type QBoxLayoutitemAtProc* = proc(param1: cint): QLayoutItem
...
proc miqt_exec_callback_QBoxLayout_itemAt(self: ptr cQBoxLayout, slot: int, param1: cint): pointer {.exportc: "miqt_exec_callback_QBoxLayout_itemAt ".} =
  ...
  virtualReturn.h
proc QBoxLayouttakeAt*(self: gen_qboxlayout_types.QBoxLayout, param1: cint): QLayoutItem =
  QLayoutItem(h: fQBoxLayout_virtualbase_takeAt(self.h, param1))

type QBoxLayouttakeAtProc* = proc(param1: cint): QLayoutItem
...
proc miqt_exec_callback_QBoxLayout_count(self: ptr cQBoxLayout, slot: int): cint {.exportc: "miqt_exec_callback_QBoxLayout_count ".} =
  ...
  virtualReturn
proc QBoxLayoutsetGeometry*(self: gen_qboxlayout_types.QBoxLayout, geometry: QRect): void =
  fQBoxLayout_virtualbase_setGeometry(self.h, geometry.h)

type QBoxLayoutsetGeometryProc* = proc(geometry: QRect): void
...
proc miqt_exec_callback_QBoxLayout_setGeometry(self: ptr cQBoxLayout, slot: int, geometry: pointer): void {.exportc: "miqt_exec_callback_QBoxLayout_setGeometry ".} =
  ...
  let slotval1 = QRect(h: geometry)


  nimfunc[](slotval1)
proc QBoxLayoutgeometry*(self: gen_qboxlayout_types.QBoxLayout, ): QRect =
  QRect(h: fQBoxLayout_virtualbase_geometry(self.h))

type QBoxLayoutgeometryProc* = proc(): QRect
...
proc miqt_exec_callback_QBoxLayout_geometry(self: ptr cQBoxLayout, slot: int): pointer {.exportc: "miqt_exec_callback_QBoxLayout_geometry ".} =
  ...
  virtualReturn.h
proc QBoxLayoutindexOf*(self: gen_qboxlayout_types.QBoxLayout, param1: QWidget): cint =
  fQBoxLayout_virtualbase_indexOf(self.h, param1.h)

type QBoxLayoutindexOfProc* = proc(param1: QWidget): cint
...
proc miqt_exec_callback_QBoxLayout_controlTypes(self: ptr cQBoxLayout, slot: int): cint {.exportc: "miqt_exec_callback_QBoxLayout_controlTypes ".} =
  ...
  cint(virtualReturn)
proc QBoxLayoutreplaceWidget*(self: gen_qboxlayout_types.QBoxLayout, fromVal: QWidget, to: QWidget, options: cint): QLayoutItem =
  QLayoutItem(h: fQBoxLayout_virtualbase_replaceWidget(self.h, fromVal.h, to.h, cint(options)))

type QBoxLayoutreplaceWidgetProc* = proc(fromVal: QWidget, to: QWidget, options: cint): QLayoutItem
...
proc miqt_exec_callback_QBoxLayout_replaceWidget(self: ptr cQBoxLayout, slot: int, fromVal: pointer, to: pointer, options: cint): pointer {.exportc: "miqt_exec_callback_QBoxLayout_replaceWidget ".} =
  ...
  let slotval1 = QWidget(h: fromVal)

  let slotval2 = QWidget(h: to)
  ...
  virtualReturn.h
proc QBoxLayoutlayout*(self: gen_qboxlayout_types.QBoxLayout, ): QLayout =
  QLayout(h: fQBoxLayout_virtualbase_layout(self.h))

type QBoxLayoutlayoutProc* = proc(): QLayout
...
proc miqt_exec_callback_QBoxLayout_layout(self: ptr cQBoxLayout, slot: int): pointer {.exportc: "miqt_exec_callback_QBoxLayout_layout ".} =
  ...
  virtualReturn.h
proc QBoxLayoutchildEvent*(self: gen_qboxlayout_types.QBoxLayout, e: QChildEvent): void =
  fQBoxLayout_virtualbase_childEvent(self.h, e.h)

type QBoxLayoutchildEventProc* = proc(e: QChildEvent): void
...
proc miqt_exec_callback_QBoxLayout_childEvent(self: ptr cQBoxLayout, slot: int, e: pointer): void {.exportc: "miqt_exec_callback_QBoxLayout_childEvent ".} =
  ...
  let slotval1 = QChildEvent(h: e)


  nimfunc[](slotval1)
proc QBoxLayoutevent*(self: gen_qboxlayout_types.QBoxLayout, event: QEvent): bool =
  fQBoxLayout_virtualbase_event(self.h, event.h)

type QBoxLayouteventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QBoxLayout_event(self: ptr cQBoxLayout, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QBoxLayout_event ".} =
  ...
  virtualReturn
proc QBoxLayouteventFilter*(self: gen_qboxlayout_types.QBoxLayout, watched: QObject, event: QEvent): bool =
  fQBoxLayout_virtualbase_eventFilter(self.h, watched.h, event.h)

type QBoxLayouteventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QBoxLayout_eventFilter(self: ptr cQBoxLayout, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QBoxLayout_eventFilter ".} =
  ...
  virtualReturn
proc QBoxLayouttimerEvent*(self: gen_qboxlayout_types.QBoxLayout, event: QTimerEvent): void =
  fQBoxLayout_virtualbase_timerEvent(self.h, event.h)

type QBoxLayouttimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QBoxLayout_timerEvent(self: ptr cQBoxLayout, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QBoxLayout_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QBoxLayoutcustomEvent*(self: gen_qboxlayout_types.QBoxLayout, event: QEvent): void =
  fQBoxLayout_virtualbase_customEvent(self.h, event.h)

type QBoxLayoutcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QBoxLayout_customEvent(self: ptr cQBoxLayout, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QBoxLayout_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QBoxLayoutconnectNotify*(self: gen_qboxlayout_types.QBoxLayout, signal: QMetaMethod): void =
  fQBoxLayout_virtualbase_connectNotify(self.h, signal.h)

type QBoxLayoutconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QBoxLayout_connectNotify(self: ptr cQBoxLayout, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QBoxLayout_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QBoxLayoutdisconnectNotify*(self: gen_qboxlayout_types.QBoxLayout, signal: QMetaMethod): void =
  fQBoxLayout_virtualbase_disconnectNotify(self.h, signal.h)

type QBoxLayoutdisconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QBoxLayout_disconnectNotify(self: ptr cQBoxLayout, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QBoxLayout_disconnectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QBoxLayoutwidget*(self: gen_qboxlayout_types.QBoxLayout, ): QWidget =
  QWidget(h: fQBoxLayout_virtualbase_widget(self.h))

type QBoxLayoutwidgetProc* = proc(): QWidget
...
proc miqt_exec_callback_QBoxLayout_widget(self: ptr cQBoxLayout, slot: int): pointer {.exportc: "miqt_exec_callback_QBoxLayout_widget ".} =
  ...
  virtualReturn.h
proc QBoxLayoutspacerItem*(self: gen_qboxlayout_types.QBoxLayout, ): QSpacerItem =
  QSpacerItem(h: fQBoxLayout_virtualbase_spacerItem(self.h))

type QBoxLayoutspacerItemProc* = proc(): QSpacerItem
...
func init*(T: type gen_qboxlayout_types.QHBoxLayout, h: ptr cQHBoxLayout): gen_qboxlayout_types.QHBoxLayout =
  T(h: h)
proc create*(T: type gen_qboxlayout_types.QHBoxLayout, parent: QWidget): gen_qboxlayout_types.QHBoxLayout =
...
proc metaObject*(self: gen_qboxlayout_types.QHBoxLayout, ): QMetaObject =
  QMetaObject(h: fcQHBoxLayout_metaObject(self.h))
...
proc miqt_exec_callback_QHBoxLayout_metacall(self: ptr cQHBoxLayout, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QHBoxLayout_metacall ".} =
  ...
  virtualReturn
proc QHBoxLayoutaddItem*(self: gen_qboxlayout_types.QHBoxLayout, param1: QLayoutItem): void =
  fQHBoxLayout_virtualbase_addItem(self.h, param1.h)

type QHBoxLayoutaddItemProc* = proc(param1: QLayoutItem): void
...
proc miqt_exec_callback_QHBoxLayout_setSpacing(self: ptr cQHBoxLayout, slot: int, spacing: cint): void {.exportc: "miqt_exec_callback_QHBoxLayout_setSpacing ".} =
  ...
  nimfunc[](slotval1)
proc QHBoxLayoutsizeHint*(self: gen_qboxlayout_types.QHBoxLayout, ): QSize =
  QSize(h: fQHBoxLayout_virtualbase_sizeHint(self.h))

type QHBoxLayoutsizeHintProc* = proc(): QSize
...
proc miqt_exec_callback_QHBoxLayout_sizeHint(self: ptr cQHBoxLayout, slot: int): pointer {.exportc: "miqt_exec_callback_QHBoxLayout_sizeHint ".} =
  ...
  virtualReturn.h
proc QHBoxLayoutminimumSize*(self: gen_qboxlayout_types.QHBoxLayout, ): QSize =
  QSize(h: fQHBoxLayout_virtualbase_minimumSize(self.h))

type QHBoxLayoutminimumSizeProc* = proc(): QSize
...
proc miqt_exec_callback_QHBoxLayout_minimumSize(self: ptr cQHBoxLayout, slot: int): pointer {.exportc: "miqt_exec_callback_QHBoxLayout_minimumSize ".} =
  ...
  virtualReturn.h
proc QHBoxLayoutmaximumSize*(self: gen_qboxlayout_types.QHBoxLayout, ): QSize =
  QSize(h: fQHBoxLayout_virtualbase_maximumSize(self.h))

type QHBoxLayoutmaximumSizeProc* = proc(): QSize
...
proc miqt_exec_callback_QHBoxLayout_invalidate(self: ptr cQHBoxLayout, slot: int): void {.exportc: "miqt_exec_callback_QHBoxLayout_invalidate ".} =
  ...
  nimfunc[]()
proc QHBoxLayoutitemAt*(self: gen_qboxlayout_types.QHBoxLayout, param1: cint): QLayoutItem =
  QLayoutItem(h: fQHBoxLayout_virtualbase_itemAt(self.h, param1))

type QHBoxLayoutitemAtProc* = proc(param1: cint): QLayoutItem
...
proc miqt_exec_callback_QHBoxLayout_itemAt(self: ptr cQHBoxLayout, slot: int, param1: cint): pointer {.exportc: "miqt_exec_callback_QHBoxLayout_itemAt ".} =
  ...
  virtualReturn.h
proc QHBoxLayouttakeAt*(self: gen_qboxlayout_types.QHBoxLayout, param1: cint): QLayoutItem =
  QLayoutItem(h: fQHBoxLayout_virtualbase_takeAt(self.h, param1))

type QHBoxLayouttakeAtProc* = proc(param1: cint): QLayoutItem
...
proc miqt_exec_callback_QHBoxLayout_count(self: ptr cQHBoxLayout, slot: int): cint {.exportc: "miqt_exec_callback_QHBoxLayout_count ".} =
  ...
  virtualReturn
proc QHBoxLayoutsetGeometry*(self: gen_qboxlayout_types.QHBoxLayout, geometry: QRect): void =
  fQHBoxLayout_virtualbase_setGeometry(self.h, geometry.h)

type QHBoxLayoutsetGeometryProc* = proc(geometry: QRect): void
...
proc miqt_exec_callback_QHBoxLayout_setGeometry(self: ptr cQHBoxLayout, slot: int, geometry: pointer): void {.exportc: "miqt_exec_callback_QHBoxLayout_setGeometry ".} =
  ...
  nimfunc[](slotval1)
proc QHBoxLayoutgeometry*(self: gen_qboxlayout_types.QHBoxLayout, ): QRect =
  QRect(h: fQHBoxLayout_virtualbase_geometry(self.h))

type QHBoxLayoutgeometryProc* = proc(): QRect
...
proc miqt_exec_callback_QHBoxLayout_geometry(self: ptr cQHBoxLayout, slot: int): pointer {.exportc: "miqt_exec_callback_QHBoxLayout_geometry ".} =
  ...
  virtualReturn.h
proc QHBoxLayoutindexOf*(self: gen_qboxlayout_types.QHBoxLayout, param1: QWidget): cint =
  fQHBoxLayout_virtualbase_indexOf(self.h, param1.h)

type QHBoxLayoutindexOfProc* = proc(param1: QWidget): cint
...
proc miqt_exec_callback_QHBoxLayout_controlTypes(self: ptr cQHBoxLayout, slot: int): cint {.exportc: "miqt_exec_callback_QHBoxLayout_controlTypes ".} =
  ...
  cint(virtualReturn)
proc QHBoxLayoutreplaceWidget*(self: gen_qboxlayout_types.QHBoxLayout, fromVal: QWidget, to: QWidget, options: cint): QLayoutItem =
  QLayoutItem(h: fQHBoxLayout_virtualbase_replaceWidget(self.h, fromVal.h, to.h, cint(options)))

type QHBoxLayoutreplaceWidgetProc* = proc(fromVal: QWidget, to: QWidget, options: cint): QLayoutItem
...
proc miqt_exec_callback_QHBoxLayout_replaceWidget(self: ptr cQHBoxLayout, slot: int, fromVal: pointer, to: pointer, options: cint): pointer {.exportc: "miqt_exec_callback_QHBoxLayout_replaceWidget ".} =
  ...
  virtualReturn.h
proc QHBoxLayoutlayout*(self: gen_qboxlayout_types.QHBoxLayout, ): QLayout =
  QLayout(h: fQHBoxLayout_virtualbase_layout(self.h))

type QHBoxLayoutlayoutProc* = proc(): QLayout
...
proc miqt_exec_callback_QHBoxLayout_layout(self: ptr cQHBoxLayout, slot: int): pointer {.exportc: "miqt_exec_callback_QHBoxLayout_layout ".} =
  ...
  virtualReturn.h
proc QHBoxLayoutchildEvent*(self: gen_qboxlayout_types.QHBoxLayout, e: QChildEvent): void =
  fQHBoxLayout_virtualbase_childEvent(self.h, e.h)

type QHBoxLayoutchildEventProc* = proc(e: QChildEvent): void
...
proc miqt_exec_callback_QHBoxLayout_childEvent(self: ptr cQHBoxLayout, slot: int, e: pointer): void {.exportc: "miqt_exec_callback_QHBoxLayout_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QHBoxLayoutevent*(self: gen_qboxlayout_types.QHBoxLayout, event: QEvent): bool =
  fQHBoxLayout_virtualbase_event(self.h, event.h)

type QHBoxLayouteventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QHBoxLayout_event(self: ptr cQHBoxLayout, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QHBoxLayout_event ".} =
  ...
  virtualReturn
proc QHBoxLayouteventFilter*(self: gen_qboxlayout_types.QHBoxLayout, watched: QObject, event: QEvent): bool =
  fQHBoxLayout_virtualbase_eventFilter(self.h, watched.h, event.h)

type QHBoxLayouteventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QHBoxLayout_eventFilter(self: ptr cQHBoxLayout, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QHBoxLayout_eventFilter ".} =
  ...
  virtualReturn
proc QHBoxLayouttimerEvent*(self: gen_qboxlayout_types.QHBoxLayout, event: QTimerEvent): void =
  fQHBoxLayout_virtualbase_timerEvent(self.h, event.h)

type QHBoxLayouttimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QHBoxLayout_timerEvent(self: ptr cQHBoxLayout, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QHBoxLayout_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QHBoxLayoutcustomEvent*(self: gen_qboxlayout_types.QHBoxLayout, event: QEvent): void =
  fQHBoxLayout_virtualbase_customEvent(self.h, event.h)

type QHBoxLayoutcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QHBoxLayout_customEvent(self: ptr cQHBoxLayout, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QHBoxLayout_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QHBoxLayoutconnectNotify*(self: gen_qboxlayout_types.QHBoxLayout, signal: QMetaMethod): void =
  fQHBoxLayout_virtualbase_connectNotify(self.h, signal.h)

type QHBoxLayoutconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QHBoxLayout_connectNotify(self: ptr cQHBoxLayout, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QHBoxLayout_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QHBoxLayoutdisconnectNotify*(self: gen_qboxlayout_types.QHBoxLayout, signal: QMetaMethod): void =
  fQHBoxLayout_virtualbase_disconnectNotify(self.h, signal.h)

type QHBoxLayoutdisconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QHBoxLayout_disconnectNotify(self: ptr cQHBoxLayout, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QHBoxLayout_disconnectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QHBoxLayoutwidget*(self: gen_qboxlayout_types.QHBoxLayout, ): QWidget =
  QWidget(h: fQHBoxLayout_virtualbase_widget(self.h))

type QHBoxLayoutwidgetProc* = proc(): QWidget
...
proc miqt_exec_callback_QHBoxLayout_widget(self: ptr cQHBoxLayout, slot: int): pointer {.exportc: "miqt_exec_callback_QHBoxLayout_widget ".} =
  ...
  virtualReturn.h
proc QHBoxLayoutspacerItem*(self: gen_qboxlayout_types.QHBoxLayout, ): QSpacerItem =
  QSpacerItem(h: fQHBoxLayout_virtualbase_spacerItem(self.h))

type QHBoxLayoutspacerItemProc* = proc(): QSpacerItem
...
func init*(T: type gen_qboxlayout_types.QVBoxLayout, h: ptr cQVBoxLayout): gen_qboxlayout_types.QVBoxLayout =
  T(h: h)
proc create*(T: type gen_qboxlayout_types.QVBoxLayout, parent: QWidget): gen_qboxlayout_types.QVBoxLayout =
...
proc metaObject*(self: gen_qboxlayout_types.QVBoxLayout, ): QMetaObject =
  QMetaObject(h: fcQVBoxLayout_metaObject(self.h))
...
proc miqt_exec_callback_QVBoxLayout_metacall(self: ptr cQVBoxLayout, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QVBoxLayout_metacall ".} =
  ...
  virtualReturn
proc QVBoxLayoutaddItem*(self: gen_qboxlayout_types.QVBoxLayout, param1: QLayoutItem): void =
  fQVBoxLayout_virtualbase_addItem(self.h, param1.h)

type QVBoxLayoutaddItemProc* = proc(param1: QLayoutItem): void
...
proc miqt_exec_callback_QVBoxLayout_setSpacing(self: ptr cQVBoxLayout, slot: int, spacing: cint): void {.exportc: "miqt_exec_callback_QVBoxLayout_setSpacing ".} =
  ...
  nimfunc[](slotval1)
proc QVBoxLayoutsizeHint*(self: gen_qboxlayout_types.QVBoxLayout, ): QSize =
  QSize(h: fQVBoxLayout_virtualbase_sizeHint(self.h))

type QVBoxLayoutsizeHintProc* = proc(): QSize
...
proc miqt_exec_callback_QVBoxLayout_sizeHint(self: ptr cQVBoxLayout, slot: int): pointer {.exportc: "miqt_exec_callback_QVBoxLayout_sizeHint ".} =
  ...
  virtualReturn.h
proc QVBoxLayoutminimumSize*(self: gen_qboxlayout_types.QVBoxLayout, ): QSize =
  QSize(h: fQVBoxLayout_virtualbase_minimumSize(self.h))

type QVBoxLayoutminimumSizeProc* = proc(): QSize
...
proc miqt_exec_callback_QVBoxLayout_minimumSize(self: ptr cQVBoxLayout, slot: int): pointer {.exportc: "miqt_exec_callback_QVBoxLayout_minimumSize ".} =
  ...
  virtualReturn.h
proc QVBoxLayoutmaximumSize*(self: gen_qboxlayout_types.QVBoxLayout, ): QSize =
  QSize(h: fQVBoxLayout_virtualbase_maximumSize(self.h))

type QVBoxLayoutmaximumSizeProc* = proc(): QSize
...
proc miqt_exec_callback_QVBoxLayout_invalidate(self: ptr cQVBoxLayout, slot: int): void {.exportc: "miqt_exec_callback_QVBoxLayout_invalidate ".} =
  ...
  nimfunc[]()
proc QVBoxLayoutitemAt*(self: gen_qboxlayout_types.QVBoxLayout, param1: cint): QLayoutItem =
  QLayoutItem(h: fQVBoxLayout_virtualbase_itemAt(self.h, param1))

type QVBoxLayoutitemAtProc* = proc(param1: cint): QLayoutItem
...
proc miqt_exec_callback_QVBoxLayout_itemAt(self: ptr cQVBoxLayout, slot: int, param1: cint): pointer {.exportc: "miqt_exec_callback_QVBoxLayout_itemAt ".} =
  ...
  virtualReturn.h
proc QVBoxLayouttakeAt*(self: gen_qboxlayout_types.QVBoxLayout, param1: cint): QLayoutItem =
  QLayoutItem(h: fQVBoxLayout_virtualbase_takeAt(self.h, param1))

type QVBoxLayouttakeAtProc* = proc(param1: cint): QLayoutItem
...
proc miqt_exec_callback_QVBoxLayout_count(self: ptr cQVBoxLayout, slot: int): cint {.exportc: "miqt_exec_callback_QVBoxLayout_count ".} =
  ...
  virtualReturn
proc QVBoxLayoutsetGeometry*(self: gen_qboxlayout_types.QVBoxLayout, geometry: QRect): void =
  fQVBoxLayout_virtualbase_setGeometry(self.h, geometry.h)

type QVBoxLayoutsetGeometryProc* = proc(geometry: QRect): void
...
proc miqt_exec_callback_QVBoxLayout_setGeometry(self: ptr cQVBoxLayout, slot: int, geometry: pointer): void {.exportc: "miqt_exec_callback_QVBoxLayout_setGeometry ".} =
  ...
  nimfunc[](slotval1)
proc QVBoxLayoutgeometry*(self: gen_qboxlayout_types.QVBoxLayout, ): QRect =
  QRect(h: fQVBoxLayout_virtualbase_geometry(self.h))

type QVBoxLayoutgeometryProc* = proc(): QRect
...
proc miqt_exec_callback_QVBoxLayout_geometry(self: ptr cQVBoxLayout, slot: int): pointer {.exportc: "miqt_exec_callback_QVBoxLayout_geometry ".} =
  ...
  virtualReturn.h
proc QVBoxLayoutindexOf*(self: gen_qboxlayout_types.QVBoxLayout, param1: QWidget): cint =
  fQVBoxLayout_virtualbase_indexOf(self.h, param1.h)

type QVBoxLayoutindexOfProc* = proc(param1: QWidget): cint
...
proc miqt_exec_callback_QVBoxLayout_controlTypes(self: ptr cQVBoxLayout, slot: int): cint {.exportc: "miqt_exec_callback_QVBoxLayout_controlTypes ".} =
  ...
  cint(virtualReturn)
proc QVBoxLayoutreplaceWidget*(self: gen_qboxlayout_types.QVBoxLayout, fromVal: QWidget, to: QWidget, options: cint): QLayoutItem =
  QLayoutItem(h: fQVBoxLayout_virtualbase_replaceWidget(self.h, fromVal.h, to.h, cint(options)))

type QVBoxLayoutreplaceWidgetProc* = proc(fromVal: QWidget, to: QWidget, options: cint): QLayoutItem
...
proc miqt_exec_callback_QVBoxLayout_replaceWidget(self: ptr cQVBoxLayout, slot: int, fromVal: pointer, to: pointer, options: cint): pointer {.exportc: "miqt_exec_callback_QVBoxLayout_replaceWidget ".} =
  ...
  virtualReturn.h
proc QVBoxLayoutlayout*(self: gen_qboxlayout_types.QVBoxLayout, ): QLayout =
  QLayout(h: fQVBoxLayout_virtualbase_layout(self.h))

type QVBoxLayoutlayoutProc* = proc(): QLayout
...
proc miqt_exec_callback_QVBoxLayout_layout(self: ptr cQVBoxLayout, slot: int): pointer {.exportc: "miqt_exec_callback_QVBoxLayout_layout ".} =
  ...
  virtualReturn.h
proc QVBoxLayoutchildEvent*(self: gen_qboxlayout_types.QVBoxLayout, e: QChildEvent): void =
  fQVBoxLayout_virtualbase_childEvent(self.h, e.h)

type QVBoxLayoutchildEventProc* = proc(e: QChildEvent): void
...
proc miqt_exec_callback_QVBoxLayout_childEvent(self: ptr cQVBoxLayout, slot: int, e: pointer): void {.exportc: "miqt_exec_callback_QVBoxLayout_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QVBoxLayoutevent*(self: gen_qboxlayout_types.QVBoxLayout, event: QEvent): bool =
  fQVBoxLayout_virtualbase_event(self.h, event.h)

type QVBoxLayouteventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QVBoxLayout_event(self: ptr cQVBoxLayout, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QVBoxLayout_event ".} =
  ...
  virtualReturn
proc QVBoxLayouteventFilter*(self: gen_qboxlayout_types.QVBoxLayout, watched: QObject, event: QEvent): bool =
  fQVBoxLayout_virtualbase_eventFilter(self.h, watched.h, event.h)

type QVBoxLayouteventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QVBoxLayout_eventFilter(self: ptr cQVBoxLayout, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QVBoxLayout_eventFilter ".} =
  ...
  virtualReturn
proc QVBoxLayouttimerEvent*(self: gen_qboxlayout_types.QVBoxLayout, event: QTimerEvent): void =
  fQVBoxLayout_virtualbase_timerEvent(self.h, event.h)

type QVBoxLayouttimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QVBoxLayout_timerEvent(self: ptr cQVBoxLayout, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QVBoxLayout_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QVBoxLayoutcustomEvent*(self: gen_qboxlayout_types.QVBoxLayout, event: QEvent): void =
  fQVBoxLayout_virtualbase_customEvent(self.h, event.h)

type QVBoxLayoutcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QVBoxLayout_customEvent(self: ptr cQVBoxLayout, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QVBoxLayout_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QVBoxLayoutconnectNotify*(self: gen_qboxlayout_types.QVBoxLayout, signal: QMetaMethod): void =
  fQVBoxLayout_virtualbase_connectNotify(self.h, signal.h)

type QVBoxLayoutconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QVBoxLayout_connectNotify(self: ptr cQVBoxLayout, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QVBoxLayout_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QVBoxLayoutdisconnectNotify*(self: gen_qboxlayout_types.QVBoxLayout, signal: QMetaMethod): void =
  fQVBoxLayout_virtualbase_disconnectNotify(self.h, signal.h)

type QVBoxLayoutdisconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QVBoxLayout_disconnectNotify(self: ptr cQVBoxLayout, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QVBoxLayout_disconnectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QVBoxLayoutwidget*(self: gen_qboxlayout_types.QVBoxLayout, ): QWidget =
  QWidget(h: fQVBoxLayout_virtualbase_widget(self.h))

type QVBoxLayoutwidgetProc* = proc(): QWidget
...
proc miqt_exec_callback_QVBoxLayout_widget(self: ptr cQVBoxLayout, slot: int): pointer {.exportc: "miqt_exec_callback_QVBoxLayout_widget ".} =
  ...
  virtualReturn.h
proc QVBoxLayoutspacerItem*(self: gen_qboxlayout_types.QVBoxLayout, ): QSpacerItem =
  QSpacerItem(h: fQVBoxLayout_virtualbase_spacerItem(self.h))

type QVBoxLayoutspacerItemProc* = proc(): QSpacerItem
