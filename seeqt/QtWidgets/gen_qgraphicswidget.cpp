...
QMetaObject* QGraphicsWidget_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQGraphicsWidget*)(self) )->QGraphicsWidget::metaObject();

}

void* QGraphicsWidget_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQGraphicsWidget*)(self) )->QGraphicsWidget::qt_metacast(param1);

}

int QGraphicsWidget_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQGraphicsWidget*)(self) )->QGraphicsWidget::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
bool QGraphicsWidget_virtualbase_isEmpty(const void* self) {
	...
	return ( (const MiqtVirtualQGraphicsWidget*)(self) )->QGraphicsWidget::isEmpty();
...
void QGraphicsWidget_protectedbase_updateMicroFocus(void* self) {
	MiqtVirtualQGraphicsWidget* self_cast = static_cast<MiqtVirtualQGraphicsWidget*>( (QGraphicsWidget*)(self) );
