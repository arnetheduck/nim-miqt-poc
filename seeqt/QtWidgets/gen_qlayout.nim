...
proc fcQLayout_unsetContentsMargins(self: pointer, ): void {.importc: "QLayout_unsetContentsMargins".}
...
proc fcQLayout_replaceWidget(self: pointer, fromVal: pointer, to: pointer, options: cint): pointer {.importc: "QLayout_replaceWidget".}
proc fcQLayout_totalMinimumHeightForWidth(self: pointer, w: cint): cint {.importc: "QLayout_totalMinimumHeightForWidth".}
...
proc fQLayout_virtualbase_spacing(self: pointer, ): cint{.importc: "QLayout_virtualbase_spacing".}
proc fcQLayout_override_virtual_spacing(self: pointer, slot: int) {.importc: "QLayout_override_virtual_spacing".}
proc fQLayout_virtualbase_setSpacing(self: pointer, spacing: cint): void{.importc: "QLayout_virtualbase_setSpacing".}
proc fcQLayout_override_virtual_setSpacing(self: pointer, slot: int) {.importc: "QLayout_override_virtual_setSpacing".}
...
proc fQLayout_virtualbase_indexOfWithQLayoutItem(self: pointer, param1: pointer): cint{.importc: "QLayout_virtualbase_indexOfWithQLayoutItem".}
proc fcQLayout_override_virtual_indexOfWithQLayoutItem(self: pointer, slot: int) {.importc: "QLayout_override_virtual_indexOfWithQLayoutItem".}
...
proc fQLayout_virtualbase_replaceWidget(self: pointer, fromVal: pointer, to: pointer, options: cint): pointer{.importc: "QLayout_virtualbase_replaceWidget".}
proc fcQLayout_override_virtual_replaceWidget(self: pointer, slot: int) {.importc: "QLayout_override_virtual_replaceWidget".}
...
func init*(T: type gen_qlayout_types.QLayout, h: ptr cQLayout): gen_qlayout_types.QLayout =
  T(h: h)
proc create*(T: type gen_qlayout_types.QLayout, parent: QWidget): gen_qlayout_types.QLayout =
...
proc metaObject*(self: gen_qlayout_types.QLayout, ): QMetaObject =
  QMetaObject(h: fcQLayout_metaObject(self.h))
...
proc setContentsMargins*(self: gen_qlayout_types.QLayout, margins: QMargins): void =
...
proc contentsMargins*(self: gen_qlayout_types.QLayout, ): QMargins =
  QMargins(h: fcQLayout_contentsMargins(self.h))

proc contentsRect*(self: gen_qlayout_types.QLayout, ): QRect =
  QRect(h: fcQLayout_contentsRect(self.h))

proc setAlignment*(self: gen_qlayout_types.QLayout, w: QWidget, alignment: cint): bool =
  fcQLayout_setAlignment(self.h, w.h, cint(alignment))

proc setAlignment*(self: gen_qlayout_types.QLayout, l: QLayout, alignment: cint): bool =
...
proc setMenuBar*(self: gen_qlayout_types.QLayout, w: QWidget): void =
  fcQLayout_setMenuBar(self.h, w.h)

proc menuBar*(self: gen_qlayout_types.QLayout, ): QWidget =
  QWidget(h: fcQLayout_menuBar(self.h))

proc parentWidget*(self: gen_qlayout_types.QLayout, ): QWidget =
  QWidget(h: fcQLayout_parentWidget(self.h))

proc invalidate*(self: gen_qlayout_types.QLayout, ): void =
  fcQLayout_invalidate(self.h)

proc geometry*(self: gen_qlayout_types.QLayout, ): QRect =
  QRect(h: fcQLayout_geometry(self.h))
...
proc addWidget*(self: gen_qlayout_types.QLayout, w: QWidget): void =
  fcQLayout_addWidget(self.h, w.h)

proc addItem*(self: gen_qlayout_types.QLayout, param1: QLayoutItem): void =
  fcQLayout_addItem(self.h, param1.h)

proc removeWidget*(self: gen_qlayout_types.QLayout, w: QWidget): void =
  fcQLayout_removeWidget(self.h, w.h)

proc removeItem*(self: gen_qlayout_types.QLayout, param1: QLayoutItem): void =
...
proc minimumSize*(self: gen_qlayout_types.QLayout, ): QSize =
  QSize(h: fcQLayout_minimumSize(self.h))

proc maximumSize*(self: gen_qlayout_types.QLayout, ): QSize =
  QSize(h: fcQLayout_maximumSize(self.h))

proc setGeometry*(self: gen_qlayout_types.QLayout, geometry: QRect): void =
  fcQLayout_setGeometry(self.h, geometry.h)

proc itemAt*(self: gen_qlayout_types.QLayout, index: cint): QLayoutItem =
  QLayoutItem(h: fcQLayout_itemAt(self.h, index))

proc takeAt*(self: gen_qlayout_types.QLayout, index: cint): QLayoutItem =
  QLayoutItem(h: fcQLayout_takeAt(self.h, index))

proc indexOf*(self: gen_qlayout_types.QLayout, param1: QWidget): cint =
  fcQLayout_indexOf(self.h, param1.h)

proc indexOf*(self: gen_qlayout_types.QLayout, param1: QLayoutItem): cint =
...
proc replaceWidget*(self: gen_qlayout_types.QLayout, fromVal: QWidget, to: QWidget, options: cint): QLayoutItem =
  QLayoutItem(h: fcQLayout_replaceWidget(self.h, fromVal.h, to.h, cint(options)))
...
proc totalMinimumSize*(self: gen_qlayout_types.QLayout, ): QSize =
  QSize(h: fcQLayout_totalMinimumSize(self.h))

proc totalMaximumSize*(self: gen_qlayout_types.QLayout, ): QSize =
  QSize(h: fcQLayout_totalMaximumSize(self.h))

proc totalSizeHint*(self: gen_qlayout_types.QLayout, ): QSize =
  QSize(h: fcQLayout_totalSizeHint(self.h))

proc layout*(self: gen_qlayout_types.QLayout, ): QLayout =
...
proc closestAcceptableSize*(_: type gen_qlayout_types.QLayout, w: QWidget, s: QSize): QSize =
  QSize(h: fcQLayout_closestAcceptableSize(w.h, s.h))
...
proc miqt_exec_callback_QLayout_invalidate(self: ptr cQLayout, slot: int): void {.exportc: "miqt_exec_callback_QLayout_invalidate ".} =
  ...
  nimfunc[]()
proc QLayoutgeometry*(self: gen_qlayout_types.QLayout, ): QRect =
  QRect(h: fQLayout_virtualbase_geometry(self.h))

type QLayoutgeometryProc* = proc(): QRect
...
proc miqt_exec_callback_QLayout_geometry(self: ptr cQLayout, slot: int): pointer {.exportc: "miqt_exec_callback_QLayout_geometry ".} =
  ...
  virtualReturn.h
type QLayoutaddItemProc* = proc(param1: QLayoutItem): void
...
proc miqt_exec_callback_QLayout_expandingDirections(self: ptr cQLayout, slot: int): cint {.exportc: "miqt_exec_callback_QLayout_expandingDirections ".} =
  ...
  cint(virtualReturn)
proc QLayoutminimumSize*(self: gen_qlayout_types.QLayout, ): QSize =
  QSize(h: fQLayout_virtualbase_minimumSize(self.h))

type QLayoutminimumSizeProc* = proc(): QSize
...
proc miqt_exec_callback_QLayout_minimumSize(self: ptr cQLayout, slot: int): pointer {.exportc: "miqt_exec_callback_QLayout_minimumSize ".} =
  ...
  virtualReturn.h
proc QLayoutmaximumSize*(self: gen_qlayout_types.QLayout, ): QSize =
  QSize(h: fQLayout_virtualbase_maximumSize(self.h))

type QLayoutmaximumSizeProc* = proc(): QSize
...
proc miqt_exec_callback_QLayout_maximumSize(self: ptr cQLayout, slot: int): pointer {.exportc: "miqt_exec_callback_QLayout_maximumSize ".} =
  ...
  virtualReturn.h
proc QLayoutsetGeometry*(self: gen_qlayout_types.QLayout, geometry: QRect): void =
  fQLayout_virtualbase_setGeometry(self.h, geometry.h)

type QLayoutsetGeometryProc* = proc(geometry: QRect): void
...
proc miqt_exec_callback_QLayout_setGeometry(self: ptr cQLayout, slot: int, geometry: pointer): void {.exportc: "miqt_exec_callback_QLayout_setGeometry ".} =
  ...
  nimfunc[](slotval1)
type QLayoutitemAtProc* = proc(index: cint): QLayoutItem
...
proc miqt_exec_callback_QLayout_itemAt(self: ptr cQLayout, slot: int, index: cint): pointer {.exportc: "miqt_exec_callback_QLayout_itemAt ".} =
  ...
  virtualReturn.h
type QLayouttakeAtProc* = proc(index: cint): QLayoutItem
...
proc miqt_exec_callback_QLayout_takeAt(self: ptr cQLayout, slot: int, index: cint): pointer {.exportc: "miqt_exec_callback_QLayout_takeAt ".} =
  ...
  virtualReturn.h
proc QLayoutindexOf*(self: gen_qlayout_types.QLayout, param1: QWidget): cint =
  fQLayout_virtualbase_indexOf(self.h, param1.h)

type QLayoutindexOfProc* = proc(param1: QWidget): cint
...
proc miqt_exec_callback_QLayout_indexOf(self: ptr cQLayout, slot: int, param1: pointer): cint {.exportc: "miqt_exec_callback_QLayout_indexOf ".} =
  ...
  virtualReturn
proc QLayoutindexOf*(self: gen_qlayout_types.QLayout, param1: QLayoutItem): cint =
  fQLayout_virtualbase_indexOfWithQLayoutItem(self.h, param1.h)

type QLayoutindexOfWithQLayoutItemProc* = proc(param1: QLayoutItem): cint
proc onindexOf*(self: gen_qlayout_types.QLayout, slot: QLayoutindexOfWithQLayoutItemProc) =
  # TODO check subclass
...
proc miqt_exec_callback_QLayout_controlTypes(self: ptr cQLayout, slot: int): cint {.exportc: "miqt_exec_callback_QLayout_controlTypes ".} =
  ...
  cint(virtualReturn)
proc QLayoutreplaceWidget*(self: gen_qlayout_types.QLayout, fromVal: QWidget, to: QWidget, options: cint): QLayoutItem =
  QLayoutItem(h: fQLayout_virtualbase_replaceWidget(self.h, fromVal.h, to.h, cint(options)))

type QLayoutreplaceWidgetProc* = proc(fromVal: QWidget, to: QWidget, options: cint): QLayoutItem
...
proc miqt_exec_callback_QLayout_replaceWidget(self: ptr cQLayout, slot: int, fromVal: pointer, to: pointer, options: cint): pointer {.exportc: "miqt_exec_callback_QLayout_replaceWidget ".} =
  ...
  virtualReturn.h
proc QLayoutlayout*(self: gen_qlayout_types.QLayout, ): QLayout =
  QLayout(h: fQLayout_virtualbase_layout(self.h))

type QLayoutlayoutProc* = proc(): QLayout
...
proc miqt_exec_callback_QLayout_layout(self: ptr cQLayout, slot: int): pointer {.exportc: "miqt_exec_callback_QLayout_layout ".} =
  ...
  virtualReturn.h
proc QLayoutchildEvent*(self: gen_qlayout_types.QLayout, e: QChildEvent): void =
  fQLayout_virtualbase_childEvent(self.h, e.h)

type QLayoutchildEventProc* = proc(e: QChildEvent): void
...
proc miqt_exec_callback_QLayout_childEvent(self: ptr cQLayout, slot: int, e: pointer): void {.exportc: "miqt_exec_callback_QLayout_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QLayoutevent*(self: gen_qlayout_types.QLayout, event: QEvent): bool =
  fQLayout_virtualbase_event(self.h, event.h)

type QLayouteventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QLayout_event(self: ptr cQLayout, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QLayout_event ".} =
  ...
  virtualReturn
proc QLayouteventFilter*(self: gen_qlayout_types.QLayout, watched: QObject, event: QEvent): bool =
  fQLayout_virtualbase_eventFilter(self.h, watched.h, event.h)

type QLayouteventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QLayout_eventFilter(self: ptr cQLayout, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QLayout_eventFilter ".} =
  ...
  virtualReturn
proc QLayouttimerEvent*(self: gen_qlayout_types.QLayout, event: QTimerEvent): void =
  fQLayout_virtualbase_timerEvent(self.h, event.h)

type QLayouttimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QLayout_timerEvent(self: ptr cQLayout, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QLayout_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QLayoutcustomEvent*(self: gen_qlayout_types.QLayout, event: QEvent): void =
  fQLayout_virtualbase_customEvent(self.h, event.h)

type QLayoutcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QLayout_customEvent(self: ptr cQLayout, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QLayout_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QLayoutconnectNotify*(self: gen_qlayout_types.QLayout, signal: QMetaMethod): void =
  fQLayout_virtualbase_connectNotify(self.h, signal.h)

type QLayoutconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QLayout_connectNotify(self: ptr cQLayout, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QLayout_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QLayoutdisconnectNotify*(self: gen_qlayout_types.QLayout, signal: QMetaMethod): void =
  fQLayout_virtualbase_disconnectNotify(self.h, signal.h)

type QLayoutdisconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QLayout_disconnectNotify(self: ptr cQLayout, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QLayout_disconnectNotify ".} =
  ...
  nimfunc[](slotval1)
type QLayoutsizeHintProc* = proc(): QSize
...
proc miqt_exec_callback_QLayout_minimumHeightForWidth(self: ptr cQLayout, slot: int, param1: cint): cint {.exportc: "miqt_exec_callback_QLayout_minimumHeightForWidth ".} =
  ...
  virtualReturn
proc QLayoutwidget*(self: gen_qlayout_types.QLayout, ): QWidget =
  QWidget(h: fQLayout_virtualbase_widget(self.h))

type QLayoutwidgetProc* = proc(): QWidget
...
proc miqt_exec_callback_QLayout_widget(self: ptr cQLayout, slot: int): pointer {.exportc: "miqt_exec_callback_QLayout_widget ".} =
  ...
  virtualReturn.h
proc QLayoutspacerItem*(self: gen_qlayout_types.QLayout, ): QSpacerItem =
  QSpacerItem(h: fQLayout_virtualbase_spacerItem(self.h))

type QLayoutspacerItemProc* = proc(): QSpacerItem
