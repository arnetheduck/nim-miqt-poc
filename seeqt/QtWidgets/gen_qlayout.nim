...
proc replaceWidget*(self: gen_qlayout_types.QLayout, fromVal: QWidget, to: QWidget): QLayoutItem =
  QLayoutItem(h: fcQLayout_replaceWidget(self.h, fromVal.h, to.h))
...
proc replaceWidget*(self: gen_qlayout_types.QLayout, fromVal: QWidget, to: QWidget, options: cint): QLayoutItem =
  QLayoutItem(h: fcQLayout_replaceWidget3(self.h, fromVal.h, to.h, cint(options)))
