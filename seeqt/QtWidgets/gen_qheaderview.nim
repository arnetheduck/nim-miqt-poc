...
proc miqt_exec_callback_QHeaderView_startDrag(self: ptr cQHeaderView, slot: int, supportedActions: cint): void {.exportc: "miqt_exec_callback_QHeaderView_startDrag ".} =
  ...
  nimfunc[](slotval1)
proc QHeaderViewviewOptions*(self: gen_qheaderview_types.QHeaderView, ): QStyleOptionViewItem =
  QStyleOptionViewItem(h: fQHeaderView_virtualbase_viewOptions(self.h))

type QHeaderViewviewOptionsProc* = proc(): QStyleOptionViewItem
...
proc miqt_exec_callback_QHeaderView_keyReleaseEvent(self: ptr cQHeaderView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QHeaderView_keyReleaseEvent ".} =
  ...
  nimfunc[](slotval1)
proc QHeaderViewenterEvent*(self: gen_qheaderview_types.QHeaderView, event: QEvent): void =
  fQHeaderView_virtualbase_enterEvent(self.h, event.h)

type QHeaderViewenterEventProc* = proc(event: QEvent): void
