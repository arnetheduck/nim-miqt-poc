...
proc fcQHeaderView_setSortIndicatorClearable(self: pointer, clearable: bool): void {.importc: "QHeaderView_setSortIndicatorClearable".}
proc fcQHeaderView_isSortIndicatorClearable(self: pointer, ): bool {.importc: "QHeaderView_isSortIndicatorClearable".}
...
proc fcQHeaderView_sortIndicatorClearableChanged(self: pointer, clearable: bool): void {.importc: "QHeaderView_sortIndicatorClearableChanged".}
proc fQHeaderView_connect_sortIndicatorClearableChanged(self: pointer, slot: int) {.importc: "QHeaderView_connect_sortIndicatorClearableChanged".}
...
proc fQHeaderView_virtualbase_initStyleOptionForIndex(self: pointer, option: pointer, logicalIndex: cint): void{.importc: "QHeaderView_virtualbase_initStyleOptionForIndex".}
proc fcQHeaderView_override_virtual_initStyleOptionForIndex(self: pointer, slot: int) {.importc: "QHeaderView_override_virtual_initStyleOptionForIndex".}
proc fQHeaderView_virtualbase_initStyleOption(self: pointer, option: pointer): void{.importc: "QHeaderView_virtualbase_initStyleOption".}
proc fcQHeaderView_override_virtual_initStyleOption(self: pointer, slot: int) {.importc: "QHeaderView_override_virtual_initStyleOption".}
...
proc fQHeaderView_virtualbase_itemDelegateForIndex(self: pointer, index: pointer): pointer{.importc: "QHeaderView_virtualbase_itemDelegateForIndex".}
proc fcQHeaderView_override_virtual_itemDelegateForIndex(self: pointer, slot: int) {.importc: "QHeaderView_override_virtual_itemDelegateForIndex".}
...
proc fQHeaderView_virtualbase_initViewItemOption(self: pointer, option: pointer): void{.importc: "QHeaderView_virtualbase_initViewItemOption".}
proc fcQHeaderView_override_virtual_initViewItemOption(self: pointer, slot: int) {.importc: "QHeaderView_override_virtual_initViewItemOption".}
...
proc fQHeaderView_virtualbase_nativeEvent(self: pointer, eventType: struct_miqt_string, message: pointer, resultVal: ptr uint): bool{.importc: "QHeaderView_virtualbase_nativeEvent".}
...
proc create*(T: type gen_qheaderview_types.QHeaderView, orientation: cint, parent: QWidget): gen_qheaderview_types.QHeaderView =
  gen_qheaderview_types.QHeaderView.init(fcQHeaderView_new2(cint(orientation), parent.h))

proc metaObject*(self: gen_qheaderview_types.QHeaderView, ): QMetaObject =
  QMetaObject(h: fcQHeaderView_metaObject(self.h))
...
proc setModel*(self: gen_qheaderview_types.QHeaderView, model: QAbstractItemModel): void =
...
proc sizeHint*(self: gen_qheaderview_types.QHeaderView, ): QSize =
  QSize(h: fcQHeaderView_sizeHint(self.h))
...
proc logicalIndexAt*(self: gen_qheaderview_types.QHeaderView, pos: QPoint): cint =
...
type QHeaderViewsortIndicatorClearableChangedSlot* = proc(clearable: bool)
proc miqt_exec_callback_QHeaderView_sortIndicatorClearableChanged(slot: int, clearable: bool) {.exportc.} =
  let nimfunc = cast[ptr QHeaderViewsortIndicatorClearableChangedSlot](cast[pointer](slot))
...
proc miqt_exec_callback_QHeaderView_metacall(self: ptr cQHeaderView, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QHeaderView_metacall ".} =
  ...
  virtualReturn
proc QHeaderViewsetModel*(self: gen_qheaderview_types.QHeaderView, model: QAbstractItemModel): void =
  fQHeaderView_virtualbase_setModel(self.h, model.h)

type QHeaderViewsetModelProc* = proc(model: QAbstractItemModel): void
...
proc miqt_exec_callback_QHeaderView_setModel(self: ptr cQHeaderView, slot: int, model: pointer): void {.exportc: "miqt_exec_callback_QHeaderView_setModel ".} =
  ...
  nimfunc[](slotval1)
proc QHeaderViewsizeHint*(self: gen_qheaderview_types.QHeaderView, ): QSize =
  QSize(h: fQHeaderView_virtualbase_sizeHint(self.h))

type QHeaderViewsizeHintProc* = proc(): QSize
...
proc miqt_exec_callback_QHeaderView_reset(self: ptr cQHeaderView, slot: int): void {.exportc: "miqt_exec_callback_QHeaderView_reset ".} =
  ...
  nimfunc[]()
proc QHeaderViewcurrentChanged*(self: gen_qheaderview_types.QHeaderView, current: QModelIndex, old: QModelIndex): void =
  fQHeaderView_virtualbase_currentChanged(self.h, current.h, old.h)

type QHeaderViewcurrentChangedProc* = proc(current: QModelIndex, old: QModelIndex): void
...
proc miqt_exec_callback_QHeaderView_currentChanged(self: ptr cQHeaderView, slot: int, current: pointer, old: pointer): void {.exportc: "miqt_exec_callback_QHeaderView_currentChanged ".} =
  ...
  let slotval2 = QModelIndex(h: old)


  nimfunc[](slotval1, slotval2)
proc QHeaderViewevent*(self: gen_qheaderview_types.QHeaderView, e: QEvent): bool =
  fQHeaderView_virtualbase_event(self.h, e.h)

type QHeaderVieweventProc* = proc(e: QEvent): bool
...
proc miqt_exec_callback_QHeaderView_event(self: ptr cQHeaderView, slot: int, e: pointer): bool {.exportc: "miqt_exec_callback_QHeaderView_event ".} =
  ...
  virtualReturn
proc QHeaderViewpaintEvent*(self: gen_qheaderview_types.QHeaderView, e: QPaintEvent): void =
  fQHeaderView_virtualbase_paintEvent(self.h, e.h)

type QHeaderViewpaintEventProc* = proc(e: QPaintEvent): void
...
proc miqt_exec_callback_QHeaderView_paintEvent(self: ptr cQHeaderView, slot: int, e: pointer): void {.exportc: "miqt_exec_callback_QHeaderView_paintEvent ".} =
  ...
  nimfunc[](slotval1)
proc QHeaderViewmousePressEvent*(self: gen_qheaderview_types.QHeaderView, e: QMouseEvent): void =
  fQHeaderView_virtualbase_mousePressEvent(self.h, e.h)

type QHeaderViewmousePressEventProc* = proc(e: QMouseEvent): void
...
proc miqt_exec_callback_QHeaderView_mousePressEvent(self: ptr cQHeaderView, slot: int, e: pointer): void {.exportc: "miqt_exec_callback_QHeaderView_mousePressEvent ".} =
  ...
  nimfunc[](slotval1)
proc QHeaderViewmouseMoveEvent*(self: gen_qheaderview_types.QHeaderView, e: QMouseEvent): void =
  fQHeaderView_virtualbase_mouseMoveEvent(self.h, e.h)

type QHeaderViewmouseMoveEventProc* = proc(e: QMouseEvent): void
...
proc miqt_exec_callback_QHeaderView_mouseMoveEvent(self: ptr cQHeaderView, slot: int, e: pointer): void {.exportc: "miqt_exec_callback_QHeaderView_mouseMoveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QHeaderViewmouseReleaseEvent*(self: gen_qheaderview_types.QHeaderView, e: QMouseEvent): void =
  fQHeaderView_virtualbase_mouseReleaseEvent(self.h, e.h)

type QHeaderViewmouseReleaseEventProc* = proc(e: QMouseEvent): void
...
proc miqt_exec_callback_QHeaderView_mouseReleaseEvent(self: ptr cQHeaderView, slot: int, e: pointer): void {.exportc: "miqt_exec_callback_QHeaderView_mouseReleaseEvent ".} =
  ...
  nimfunc[](slotval1)
proc QHeaderViewmouseDoubleClickEvent*(self: gen_qheaderview_types.QHeaderView, e: QMouseEvent): void =
  fQHeaderView_virtualbase_mouseDoubleClickEvent(self.h, e.h)

type QHeaderViewmouseDoubleClickEventProc* = proc(e: QMouseEvent): void
...
proc miqt_exec_callback_QHeaderView_mouseDoubleClickEvent(self: ptr cQHeaderView, slot: int, e: pointer): void {.exportc: "miqt_exec_callback_QHeaderView_mouseDoubleClickEvent ".} =
  ...
  nimfunc[](slotval1)
proc QHeaderViewviewportEvent*(self: gen_qheaderview_types.QHeaderView, e: QEvent): bool =
  fQHeaderView_virtualbase_viewportEvent(self.h, e.h)

type QHeaderViewviewportEventProc* = proc(e: QEvent): bool
...
proc miqt_exec_callback_QHeaderView_viewportEvent(self: ptr cQHeaderView, slot: int, e: pointer): bool {.exportc: "miqt_exec_callback_QHeaderView_viewportEvent ".} =
  ...
  virtualReturn
proc QHeaderViewpaintSection*(self: gen_qheaderview_types.QHeaderView, painter: QPainter, rect: QRect, logicalIndex: cint): void =
  fQHeaderView_virtualbase_paintSection(self.h, painter.h, rect.h, logicalIndex)

type QHeaderViewpaintSectionProc* = proc(painter: QPainter, rect: QRect, logicalIndex: cint): void
...
proc miqt_exec_callback_QHeaderView_paintSection(self: ptr cQHeaderView, slot: int, painter: pointer, rect: pointer, logicalIndex: cint): void {.exportc: "miqt_exec_callback_QHeaderView_paintSection ".} =
  ...
  nimfunc[](slotval1, slotval2, slotval3)
proc QHeaderViewsectionSizeFromContents*(self: gen_qheaderview_types.QHeaderView, logicalIndex: cint): QSize =
  QSize(h: fQHeaderView_virtualbase_sectionSizeFromContents(self.h, logicalIndex))

type QHeaderViewsectionSizeFromContentsProc* = proc(logicalIndex: cint): QSize
...
proc miqt_exec_callback_QHeaderView_scrollContentsBy(self: ptr cQHeaderView, slot: int, dx: cint, dy: cint): void {.exportc: "miqt_exec_callback_QHeaderView_scrollContentsBy ".} =
  ...
  nimfunc[](slotval1, slotval2)
proc QHeaderViewdataChanged*(self: gen_qheaderview_types.QHeaderView, topLeft: QModelIndex, bottomRight: QModelIndex, roles: seq[cint]): void =
...
type QHeaderViewdataChangedProc* = proc(topLeft: QModelIndex, bottomRight: QModelIndex, roles: seq[cint]): void
...
proc miqt_exec_callback_QHeaderView_dataChanged(self: ptr cQHeaderView, slot: int, topLeft: pointer, bottomRight: pointer, roles: struct_miqt_array): void {.exportc: "miqt_exec_callback_QHeaderView_dataChanged ".} =
  ...
  nimfunc[](slotval1, slotval2, slotval3)
proc QHeaderViewrowsInserted*(self: gen_qheaderview_types.QHeaderView, parent: QModelIndex, start: cint, endVal: cint): void =
  fQHeaderView_virtualbase_rowsInserted(self.h, parent.h, start, endVal)

type QHeaderViewrowsInsertedProc* = proc(parent: QModelIndex, start: cint, endVal: cint): void
...
proc miqt_exec_callback_QHeaderView_rowsInserted(self: ptr cQHeaderView, slot: int, parent: pointer, start: cint, endVal: cint): void {.exportc: "miqt_exec_callback_QHeaderView_rowsInserted ".} =
  ...
  nimfunc[](slotval1, slotval2, slotval3)
proc QHeaderViewvisualRect*(self: gen_qheaderview_types.QHeaderView, index: QModelIndex): QRect =
  QRect(h: fQHeaderView_virtualbase_visualRect(self.h, index.h))

type QHeaderViewvisualRectProc* = proc(index: QModelIndex): QRect
...
proc miqt_exec_callback_QHeaderView_visualRect(self: ptr cQHeaderView, slot: int, index: pointer): pointer {.exportc: "miqt_exec_callback_QHeaderView_visualRect ".} =
  ...
  virtualReturn.h
proc QHeaderViewscrollTo*(self: gen_qheaderview_types.QHeaderView, index: QModelIndex, hint: cint): void =
  fQHeaderView_virtualbase_scrollTo(self.h, index.h, cint(hint))

type QHeaderViewscrollToProc* = proc(index: QModelIndex, hint: cint): void
...
proc miqt_exec_callback_QHeaderView_scrollTo(self: ptr cQHeaderView, slot: int, index: pointer, hint: cint): void {.exportc: "miqt_exec_callback_QHeaderView_scrollTo ".} =
  ...
  nimfunc[](slotval1, slotval2)
proc QHeaderViewindexAt*(self: gen_qheaderview_types.QHeaderView, p: QPoint): QModelIndex =
  QModelIndex(h: fQHeaderView_virtualbase_indexAt(self.h, p.h))

type QHeaderViewindexAtProc* = proc(p: QPoint): QModelIndex
...
proc miqt_exec_callback_QHeaderView_indexAt(self: ptr cQHeaderView, slot: int, p: pointer): pointer {.exportc: "miqt_exec_callback_QHeaderView_indexAt ".} =
  ...
  virtualReturn.h
proc QHeaderViewisIndexHidden*(self: gen_qheaderview_types.QHeaderView, index: QModelIndex): bool =
  fQHeaderView_virtualbase_isIndexHidden(self.h, index.h)

type QHeaderViewisIndexHiddenProc* = proc(index: QModelIndex): bool
...
proc miqt_exec_callback_QHeaderView_isIndexHidden(self: ptr cQHeaderView, slot: int, index: pointer): bool {.exportc: "miqt_exec_callback_QHeaderView_isIndexHidden ".} =
  ...
  virtualReturn
proc QHeaderViewmoveCursor*(self: gen_qheaderview_types.QHeaderView, param1: cint, param2: cint): QModelIndex =
  QModelIndex(h: fQHeaderView_virtualbase_moveCursor(self.h, cint(param1), cint(param2)))

type QHeaderViewmoveCursorProc* = proc(param1: cint, param2: cint): QModelIndex
...
proc miqt_exec_callback_QHeaderView_moveCursor(self: ptr cQHeaderView, slot: int, param1: cint, param2: cint): pointer {.exportc: "miqt_exec_callback_QHeaderView_moveCursor ".} =
  ...
  virtualReturn.h
proc QHeaderViewsetSelection*(self: gen_qheaderview_types.QHeaderView, rect: QRect, flags: cint): void =
  fQHeaderView_virtualbase_setSelection(self.h, rect.h, cint(flags))

type QHeaderViewsetSelectionProc* = proc(rect: QRect, flags: cint): void
...
proc miqt_exec_callback_QHeaderView_setSelection(self: ptr cQHeaderView, slot: int, rect: pointer, flags: cint): void {.exportc: "miqt_exec_callback_QHeaderView_setSelection ".} =
  ...
  nimfunc[](slotval1, slotval2)
proc QHeaderViewvisualRegionForSelection*(self: gen_qheaderview_types.QHeaderView, selection: QItemSelection): QRegion =
  QRegion(h: fQHeaderView_virtualbase_visualRegionForSelection(self.h, selection.h))

type QHeaderViewvisualRegionForSelectionProc* = proc(selection: QItemSelection): QRegion
...
proc miqt_exec_callback_QHeaderView_visualRegionForSelection(self: ptr cQHeaderView, slot: int, selection: pointer): pointer {.exportc: "miqt_exec_callback_QHeaderView_visualRegionForSelection ".} =
  ...
  virtualReturn.h
proc QHeaderViewinitStyleOptionForIndex*(self: gen_qheaderview_types.QHeaderView, option: QStyleOptionHeader, logicalIndex: cint): void =
  fQHeaderView_virtualbase_initStyleOptionForIndex(self.h, option.h, logicalIndex)

type QHeaderViewinitStyleOptionForIndexProc* = proc(option: QStyleOptionHeader, logicalIndex: cint): void
...
proc miqt_exec_callback_QHeaderView_initStyleOptionForIndex(self: ptr cQHeaderView, slot: int, option: pointer, logicalIndex: cint): void {.exportc: "miqt_exec_callback_QHeaderView_initStyleOptionForIndex ".} =
  ...
  let slotval1 = QStyleOptionHeader(h: option)

  let slotval2 = logicalIndex


  nimfunc[](slotval1, slotval2)
proc QHeaderViewinitStyleOption*(self: gen_qheaderview_types.QHeaderView, option: QStyleOptionHeader): void =
  fQHeaderView_virtualbase_initStyleOption(self.h, option.h)

type QHeaderViewinitStyleOptionProc* = proc(option: QStyleOptionHeader): void
...
proc miqt_exec_callback_QHeaderView_initStyleOption(self: ptr cQHeaderView, slot: int, option: pointer): void {.exportc: "miqt_exec_callback_QHeaderView_initStyleOption ".} =
  ...
  nimfunc[](slotval1)
proc QHeaderViewsetSelectionModel*(self: gen_qheaderview_types.QHeaderView, selectionModel: QItemSelectionModel): void =
  fQHeaderView_virtualbase_setSelectionModel(self.h, selectionModel.h)

type QHeaderViewsetSelectionModelProc* = proc(selectionModel: QItemSelectionModel): void
...
proc miqt_exec_callback_QHeaderView_sizeHintForColumn(self: ptr cQHeaderView, slot: int, column: cint): cint {.exportc: "miqt_exec_callback_QHeaderView_sizeHintForColumn ".} =
  ...
  virtualReturn
proc QHeaderViewitemDelegateForIndex*(self: gen_qheaderview_types.QHeaderView, index: QModelIndex): QAbstractItemDelegate =
  QAbstractItemDelegate(h: fQHeaderView_virtualbase_itemDelegateForIndex(self.h, index.h))

type QHeaderViewitemDelegateForIndexProc* = proc(index: QModelIndex): QAbstractItemDelegate
...
proc miqt_exec_callback_QHeaderView_itemDelegateForIndex(self: ptr cQHeaderView, slot: int, index: pointer): pointer {.exportc: "miqt_exec_callback_QHeaderView_itemDelegateForIndex ".} =
  ...
  virtualReturn.h
proc QHeaderViewinputMethodQuery*(self: gen_qheaderview_types.QHeaderView, query: cint): QVariant =
  QVariant(h: fQHeaderView_virtualbase_inputMethodQuery(self.h, cint(query)))

type QHeaderViewinputMethodQueryProc* = proc(query: cint): QVariant
...
proc miqt_exec_callback_QHeaderView_inputMethodQuery(self: ptr cQHeaderView, slot: int, query: cint): pointer {.exportc: "miqt_exec_callback_QHeaderView_inputMethodQuery ".} =
  ...
  virtualReturn.h
proc QHeaderViewsetRootIndex*(self: gen_qheaderview_types.QHeaderView, index: QModelIndex): void =
  fQHeaderView_virtualbase_setRootIndex(self.h, index.h)

type QHeaderViewsetRootIndexProc* = proc(index: QModelIndex): void
...
proc miqt_exec_callback_QHeaderView_selectAll(self: ptr cQHeaderView, slot: int): void {.exportc: "miqt_exec_callback_QHeaderView_selectAll ".} =
  ...
  nimfunc[]()
proc QHeaderViewrowsAboutToBeRemoved*(self: gen_qheaderview_types.QHeaderView, parent: QModelIndex, start: cint, endVal: cint): void =
  fQHeaderView_virtualbase_rowsAboutToBeRemoved(self.h, parent.h, start, endVal)

type QHeaderViewrowsAboutToBeRemovedProc* = proc(parent: QModelIndex, start: cint, endVal: cint): void
...
proc miqt_exec_callback_QHeaderView_rowsAboutToBeRemoved(self: ptr cQHeaderView, slot: int, parent: pointer, start: cint, endVal: cint): void {.exportc: "miqt_exec_callback_QHeaderView_rowsAboutToBeRemoved ".} =
  ...
  nimfunc[](slotval1, slotval2, slotval3)
proc QHeaderViewselectionChanged*(self: gen_qheaderview_types.QHeaderView, selected: QItemSelection, deselected: QItemSelection): void =
  fQHeaderView_virtualbase_selectionChanged(self.h, selected.h, deselected.h)

type QHeaderViewselectionChangedProc* = proc(selected: QItemSelection, deselected: QItemSelection): void
...
proc miqt_exec_callback_QHeaderView_horizontalScrollbarValueChanged(self: ptr cQHeaderView, slot: int, value: cint): void {.exportc: "miqt_exec_callback_QHeaderView_horizontalScrollbarValueChanged ".} =
  ...
  nimfunc[](slotval1)
proc QHeaderViewcloseEditor*(self: gen_qheaderview_types.QHeaderView, editor: QWidget, hint: cint): void =
  fQHeaderView_virtualbase_closeEditor(self.h, editor.h, cint(hint))

type QHeaderViewcloseEditorProc* = proc(editor: QWidget, hint: cint): void
...
proc miqt_exec_callback_QHeaderView_closeEditor(self: ptr cQHeaderView, slot: int, editor: pointer, hint: cint): void {.exportc: "miqt_exec_callback_QHeaderView_closeEditor ".} =
  ...
  nimfunc[](slotval1, slotval2)
proc QHeaderViewcommitData*(self: gen_qheaderview_types.QHeaderView, editor: QWidget): void =
  fQHeaderView_virtualbase_commitData(self.h, editor.h)

type QHeaderViewcommitDataProc* = proc(editor: QWidget): void
...
proc miqt_exec_callback_QHeaderView_commitData(self: ptr cQHeaderView, slot: int, editor: pointer): void {.exportc: "miqt_exec_callback_QHeaderView_commitData ".} =
  ...
  nimfunc[](slotval1)
proc QHeaderVieweditorDestroyed*(self: gen_qheaderview_types.QHeaderView, editor: QObject): void =
  fQHeaderView_virtualbase_editorDestroyed(self.h, editor.h)

type QHeaderVieweditorDestroyedProc* = proc(editor: QObject): void
...
proc miqt_exec_callback_QHeaderView_editorDestroyed(self: ptr cQHeaderView, slot: int, editor: pointer): void {.exportc: "miqt_exec_callback_QHeaderView_editorDestroyed ".} =
  ...
  nimfunc[](slotval1)
proc QHeaderViewselectedIndexes*(self: gen_qheaderview_types.QHeaderView, ): seq[QModelIndex] =
...
type QHeaderViewselectedIndexesProc* = proc(): seq[QModelIndex]
...
proc QHeaderViewedit*(self: gen_qheaderview_types.QHeaderView, index: QModelIndex, trigger: cint, event: QEvent): bool =
  fQHeaderView_virtualbase_edit2(self.h, index.h, cint(trigger), event.h)

type QHeaderViewedit2Proc* = proc(index: QModelIndex, trigger: cint, event: QEvent): bool
...
proc miqt_exec_callback_QHeaderView_edit2(self: ptr cQHeaderView, slot: int, index: pointer, trigger: cint, event: pointer): bool {.exportc: "miqt_exec_callback_QHeaderView_edit2 ".} =
  ...
  virtualReturn
proc QHeaderViewselectionCommand*(self: gen_qheaderview_types.QHeaderView, index: QModelIndex, event: QEvent): cint =
  cint(fQHeaderView_virtualbase_selectionCommand(self.h, index.h, event.h))

type QHeaderViewselectionCommandProc* = proc(index: QModelIndex, event: QEvent): cint
...
proc miqt_exec_callback_QHeaderView_startDrag(self: ptr cQHeaderView, slot: int, supportedActions: cint): void {.exportc: "miqt_exec_callback_QHeaderView_startDrag ".} =
  ...
  nimfunc[](slotval1)
proc QHeaderViewinitViewItemOption*(self: gen_qheaderview_types.QHeaderView, option: QStyleOptionViewItem): void =
  fQHeaderView_virtualbase_initViewItemOption(self.h, option.h)

type QHeaderViewinitViewItemOptionProc* = proc(option: QStyleOptionViewItem): void
...
proc miqt_exec_callback_QHeaderView_focusNextPrevChild(self: ptr cQHeaderView, slot: int, next: bool): bool {.exportc: "miqt_exec_callback_QHeaderView_focusNextPrevChild ".} =
  ...
  virtualReturn
proc QHeaderViewdragEnterEvent*(self: gen_qheaderview_types.QHeaderView, event: QDragEnterEvent): void =
  fQHeaderView_virtualbase_dragEnterEvent(self.h, event.h)

type QHeaderViewdragEnterEventProc* = proc(event: QDragEnterEvent): void
...
proc miqt_exec_callback_QHeaderView_dragEnterEvent(self: ptr cQHeaderView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QHeaderView_dragEnterEvent ".} =
  ...
  nimfunc[](slotval1)
proc QHeaderViewdragMoveEvent*(self: gen_qheaderview_types.QHeaderView, event: QDragMoveEvent): void =
  fQHeaderView_virtualbase_dragMoveEvent(self.h, event.h)

type QHeaderViewdragMoveEventProc* = proc(event: QDragMoveEvent): void
...
proc miqt_exec_callback_QHeaderView_dragMoveEvent(self: ptr cQHeaderView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QHeaderView_dragMoveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QHeaderViewdragLeaveEvent*(self: gen_qheaderview_types.QHeaderView, event: QDragLeaveEvent): void =
  fQHeaderView_virtualbase_dragLeaveEvent(self.h, event.h)

type QHeaderViewdragLeaveEventProc* = proc(event: QDragLeaveEvent): void
...
proc miqt_exec_callback_QHeaderView_dragLeaveEvent(self: ptr cQHeaderView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QHeaderView_dragLeaveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QHeaderViewdropEvent*(self: gen_qheaderview_types.QHeaderView, event: QDropEvent): void =
  fQHeaderView_virtualbase_dropEvent(self.h, event.h)

type QHeaderViewdropEventProc* = proc(event: QDropEvent): void
...
proc miqt_exec_callback_QHeaderView_dropEvent(self: ptr cQHeaderView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QHeaderView_dropEvent ".} =
  ...
  nimfunc[](slotval1)
proc QHeaderViewfocusInEvent*(self: gen_qheaderview_types.QHeaderView, event: QFocusEvent): void =
  fQHeaderView_virtualbase_focusInEvent(self.h, event.h)

type QHeaderViewfocusInEventProc* = proc(event: QFocusEvent): void
...
proc miqt_exec_callback_QHeaderView_focusInEvent(self: ptr cQHeaderView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QHeaderView_focusInEvent ".} =
  ...
  nimfunc[](slotval1)
proc QHeaderViewfocusOutEvent*(self: gen_qheaderview_types.QHeaderView, event: QFocusEvent): void =
  fQHeaderView_virtualbase_focusOutEvent(self.h, event.h)

type QHeaderViewfocusOutEventProc* = proc(event: QFocusEvent): void
...
proc miqt_exec_callback_QHeaderView_focusOutEvent(self: ptr cQHeaderView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QHeaderView_focusOutEvent ".} =
  ...
  nimfunc[](slotval1)
proc QHeaderViewkeyPressEvent*(self: gen_qheaderview_types.QHeaderView, event: QKeyEvent): void =
  fQHeaderView_virtualbase_keyPressEvent(self.h, event.h)

type QHeaderViewkeyPressEventProc* = proc(event: QKeyEvent): void
...
proc miqt_exec_callback_QHeaderView_keyPressEvent(self: ptr cQHeaderView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QHeaderView_keyPressEvent ".} =
  ...
  nimfunc[](slotval1)
proc QHeaderViewresizeEvent*(self: gen_qheaderview_types.QHeaderView, event: QResizeEvent): void =
  fQHeaderView_virtualbase_resizeEvent(self.h, event.h)

type QHeaderViewresizeEventProc* = proc(event: QResizeEvent): void
...
proc miqt_exec_callback_QHeaderView_resizeEvent(self: ptr cQHeaderView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QHeaderView_resizeEvent ".} =
  ...
  nimfunc[](slotval1)
proc QHeaderViewtimerEvent*(self: gen_qheaderview_types.QHeaderView, event: QTimerEvent): void =
  fQHeaderView_virtualbase_timerEvent(self.h, event.h)

type QHeaderViewtimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QHeaderView_timerEvent(self: ptr cQHeaderView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QHeaderView_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QHeaderViewinputMethodEvent*(self: gen_qheaderview_types.QHeaderView, event: QInputMethodEvent): void =
  fQHeaderView_virtualbase_inputMethodEvent(self.h, event.h)

type QHeaderViewinputMethodEventProc* = proc(event: QInputMethodEvent): void
...
proc miqt_exec_callback_QHeaderView_inputMethodEvent(self: ptr cQHeaderView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QHeaderView_inputMethodEvent ".} =
  ...
  nimfunc[](slotval1)
proc QHeaderVieweventFilter*(self: gen_qheaderview_types.QHeaderView, objectVal: QObject, event: QEvent): bool =
  fQHeaderView_virtualbase_eventFilter(self.h, objectVal.h, event.h)

type QHeaderVieweventFilterProc* = proc(objectVal: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QHeaderView_eventFilter(self: ptr cQHeaderView, slot: int, objectVal: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QHeaderView_eventFilter ".} =
  ...
  virtualReturn
proc QHeaderViewviewportSizeHint*(self: gen_qheaderview_types.QHeaderView, ): QSize =
  QSize(h: fQHeaderView_virtualbase_viewportSizeHint(self.h))

type QHeaderViewviewportSizeHintProc* = proc(): QSize
...
proc miqt_exec_callback_QHeaderView_viewportSizeHint(self: ptr cQHeaderView, slot: int): pointer {.exportc: "miqt_exec_callback_QHeaderView_viewportSizeHint ".} =
  ...
  virtualReturn.h
proc QHeaderViewminimumSizeHint*(self: gen_qheaderview_types.QHeaderView, ): QSize =
  QSize(h: fQHeaderView_virtualbase_minimumSizeHint(self.h))

type QHeaderViewminimumSizeHintProc* = proc(): QSize
...
proc miqt_exec_callback_QHeaderView_minimumSizeHint(self: ptr cQHeaderView, slot: int): pointer {.exportc: "miqt_exec_callback_QHeaderView_minimumSizeHint ".} =
  ...
  virtualReturn.h
proc QHeaderViewsetupViewport*(self: gen_qheaderview_types.QHeaderView, viewport: QWidget): void =
  fQHeaderView_virtualbase_setupViewport(self.h, viewport.h)

type QHeaderViewsetupViewportProc* = proc(viewport: QWidget): void
...
proc miqt_exec_callback_QHeaderView_setupViewport(self: ptr cQHeaderView, slot: int, viewport: pointer): void {.exportc: "miqt_exec_callback_QHeaderView_setupViewport ".} =
  ...
  nimfunc[](slotval1)
proc QHeaderViewwheelEvent*(self: gen_qheaderview_types.QHeaderView, param1: QWheelEvent): void =
  fQHeaderView_virtualbase_wheelEvent(self.h, param1.h)

type QHeaderViewwheelEventProc* = proc(param1: QWheelEvent): void
...
proc miqt_exec_callback_QHeaderView_wheelEvent(self: ptr cQHeaderView, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QHeaderView_wheelEvent ".} =
  ...
  nimfunc[](slotval1)
proc QHeaderViewcontextMenuEvent*(self: gen_qheaderview_types.QHeaderView, param1: QContextMenuEvent): void =
  fQHeaderView_virtualbase_contextMenuEvent(self.h, param1.h)

type QHeaderViewcontextMenuEventProc* = proc(param1: QContextMenuEvent): void
...
proc miqt_exec_callback_QHeaderView_contextMenuEvent(self: ptr cQHeaderView, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QHeaderView_contextMenuEvent ".} =
  ...
  nimfunc[](slotval1)
proc QHeaderViewchangeEvent*(self: gen_qheaderview_types.QHeaderView, param1: QEvent): void =
  fQHeaderView_virtualbase_changeEvent(self.h, param1.h)

type QHeaderViewchangeEventProc* = proc(param1: QEvent): void
...
proc miqt_exec_callback_QHeaderView_hasHeightForWidth(self: ptr cQHeaderView, slot: int): bool {.exportc: "miqt_exec_callback_QHeaderView_hasHeightForWidth ".} =
  ...
  virtualReturn
proc QHeaderViewpaintEngine*(self: gen_qheaderview_types.QHeaderView, ): QPaintEngine =
  QPaintEngine(h: fQHeaderView_virtualbase_paintEngine(self.h))

type QHeaderViewpaintEngineProc* = proc(): QPaintEngine
...
proc miqt_exec_callback_QHeaderView_paintEngine(self: ptr cQHeaderView, slot: int): pointer {.exportc: "miqt_exec_callback_QHeaderView_paintEngine ".} =
  ...
  virtualReturn.h
proc QHeaderViewkeyReleaseEvent*(self: gen_qheaderview_types.QHeaderView, event: QKeyEvent): void =
  fQHeaderView_virtualbase_keyReleaseEvent(self.h, event.h)

type QHeaderViewkeyReleaseEventProc* = proc(event: QKeyEvent): void
...
proc miqt_exec_callback_QHeaderView_keyReleaseEvent(self: ptr cQHeaderView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QHeaderView_keyReleaseEvent ".} =
  ...
  nimfunc[](slotval1)
proc QHeaderViewenterEvent*(self: gen_qheaderview_types.QHeaderView, event: QEnterEvent): void =
  fQHeaderView_virtualbase_enterEvent(self.h, event.h)

type QHeaderViewenterEventProc* = proc(event: QEnterEvent): void
...
proc miqt_exec_callback_QHeaderView_enterEvent(self: ptr cQHeaderView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QHeaderView_enterEvent ".} =
  ...
  nimfunc[](slotval1)
proc QHeaderViewleaveEvent*(self: gen_qheaderview_types.QHeaderView, event: QEvent): void =
  fQHeaderView_virtualbase_leaveEvent(self.h, event.h)

type QHeaderViewleaveEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QHeaderView_leaveEvent(self: ptr cQHeaderView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QHeaderView_leaveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QHeaderViewmoveEvent*(self: gen_qheaderview_types.QHeaderView, event: QMoveEvent): void =
  fQHeaderView_virtualbase_moveEvent(self.h, event.h)

type QHeaderViewmoveEventProc* = proc(event: QMoveEvent): void
...
proc miqt_exec_callback_QHeaderView_moveEvent(self: ptr cQHeaderView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QHeaderView_moveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QHeaderViewcloseEvent*(self: gen_qheaderview_types.QHeaderView, event: QCloseEvent): void =
  fQHeaderView_virtualbase_closeEvent(self.h, event.h)

type QHeaderViewcloseEventProc* = proc(event: QCloseEvent): void
...
proc miqt_exec_callback_QHeaderView_closeEvent(self: ptr cQHeaderView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QHeaderView_closeEvent ".} =
  ...
  nimfunc[](slotval1)
proc QHeaderViewtabletEvent*(self: gen_qheaderview_types.QHeaderView, event: QTabletEvent): void =
  fQHeaderView_virtualbase_tabletEvent(self.h, event.h)

type QHeaderViewtabletEventProc* = proc(event: QTabletEvent): void
...
proc miqt_exec_callback_QHeaderView_tabletEvent(self: ptr cQHeaderView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QHeaderView_tabletEvent ".} =
  ...
  nimfunc[](slotval1)
proc QHeaderViewactionEvent*(self: gen_qheaderview_types.QHeaderView, event: QActionEvent): void =
  fQHeaderView_virtualbase_actionEvent(self.h, event.h)

type QHeaderViewactionEventProc* = proc(event: QActionEvent): void
...
proc miqt_exec_callback_QHeaderView_actionEvent(self: ptr cQHeaderView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QHeaderView_actionEvent ".} =
  ...
  nimfunc[](slotval1)
proc QHeaderViewshowEvent*(self: gen_qheaderview_types.QHeaderView, event: QShowEvent): void =
  fQHeaderView_virtualbase_showEvent(self.h, event.h)

type QHeaderViewshowEventProc* = proc(event: QShowEvent): void
...
proc miqt_exec_callback_QHeaderView_showEvent(self: ptr cQHeaderView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QHeaderView_showEvent ".} =
  ...
  nimfunc[](slotval1)
proc QHeaderViewhideEvent*(self: gen_qheaderview_types.QHeaderView, event: QHideEvent): void =
  fQHeaderView_virtualbase_hideEvent(self.h, event.h)

type QHeaderViewhideEventProc* = proc(event: QHideEvent): void
...
proc miqt_exec_callback_QHeaderView_metric(self: ptr cQHeaderView, slot: int, param1: cint): cint {.exportc: "miqt_exec_callback_QHeaderView_metric ".} =
  ...
  virtualReturn
proc QHeaderViewinitPainter*(self: gen_qheaderview_types.QHeaderView, painter: QPainter): void =
  fQHeaderView_virtualbase_initPainter(self.h, painter.h)

type QHeaderViewinitPainterProc* = proc(painter: QPainter): void
...
proc miqt_exec_callback_QHeaderView_initPainter(self: ptr cQHeaderView, slot: int, painter: pointer): void {.exportc: "miqt_exec_callback_QHeaderView_initPainter ".} =
  ...
  nimfunc[](slotval1)
proc QHeaderViewredirected*(self: gen_qheaderview_types.QHeaderView, offset: QPoint): QPaintDevice =
  QPaintDevice(h: fQHeaderView_virtualbase_redirected(self.h, offset.h))

type QHeaderViewredirectedProc* = proc(offset: QPoint): QPaintDevice
...
proc miqt_exec_callback_QHeaderView_redirected(self: ptr cQHeaderView, slot: int, offset: pointer): pointer {.exportc: "miqt_exec_callback_QHeaderView_redirected ".} =
  ...
  virtualReturn.h
proc QHeaderViewsharedPainter*(self: gen_qheaderview_types.QHeaderView, ): QPainter =
  QPainter(h: fQHeaderView_virtualbase_sharedPainter(self.h))

type QHeaderViewsharedPainterProc* = proc(): QPainter
...
proc miqt_exec_callback_QHeaderView_sharedPainter(self: ptr cQHeaderView, slot: int): pointer {.exportc: "miqt_exec_callback_QHeaderView_sharedPainter ".} =
  ...
  virtualReturn.h
proc QHeaderViewchildEvent*(self: gen_qheaderview_types.QHeaderView, event: QChildEvent): void =
  fQHeaderView_virtualbase_childEvent(self.h, event.h)

type QHeaderViewchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QHeaderView_childEvent(self: ptr cQHeaderView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QHeaderView_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QHeaderViewcustomEvent*(self: gen_qheaderview_types.QHeaderView, event: QEvent): void =
  fQHeaderView_virtualbase_customEvent(self.h, event.h)

type QHeaderViewcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QHeaderView_customEvent(self: ptr cQHeaderView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QHeaderView_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QHeaderViewconnectNotify*(self: gen_qheaderview_types.QHeaderView, signal: QMetaMethod): void =
  fQHeaderView_virtualbase_connectNotify(self.h, signal.h)

type QHeaderViewconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QHeaderView_connectNotify(self: ptr cQHeaderView, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QHeaderView_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QHeaderViewdisconnectNotify*(self: gen_qheaderview_types.QHeaderView, signal: QMetaMethod): void =
  fQHeaderView_virtualbase_disconnectNotify(self.h, signal.h)

type QHeaderViewdisconnectNotifyProc* = proc(signal: QMetaMethod): void
