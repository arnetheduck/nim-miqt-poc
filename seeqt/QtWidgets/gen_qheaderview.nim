...
proc fcQHeaderView_connect_sortIndicatorClearableChanged(self: pointer, slot: int, callback: proc (slot: int, clearable: bool) {.cdecl.}, release: proc(slot: int) {.cdecl.}) {.importc: "QHeaderView_connect_sortIndicatorClearableChanged".}
...
type cQHeaderViewVTable = object
  ...
  initStyleOptionForIndex*: proc(vtbl, self: pointer, option: pointer, logicalIndex: cint): void {.cdecl, raises: [], gcsafe.}
...
proc fcQHeaderView_virtualbase_initStyleOptionForIndex(self: pointer, option: pointer, logicalIndex: cint): void {.importc: "QHeaderView_virtualbase_initStyleOptionForIndex".}
proc fcQHeaderView_virtualbase_initStyleOption(self: pointer, option: pointer): void {.importc: "QHeaderView_virtualbase_initStyleOption".}
...
proc fcQHeaderView_virtualbase_itemDelegateForIndex(self: pointer, index: pointer): pointer {.importc: "QHeaderView_virtualbase_itemDelegateForIndex".}
...
proc fcQHeaderView_virtualbase_initViewItemOption(self: pointer, option: pointer): void {.importc: "QHeaderView_virtualbase_initViewItemOption".}
...
proc fcQHeaderView_virtualbase_nativeEvent(self: pointer, eventType: struct_miqt_string, message: pointer, resultVal: ptr uint): bool {.importc: "QHeaderView_virtualbase_nativeEvent".}
...
proc miqt_exec_callback_cQHeaderView_sortIndicatorClearableChanged(slot: int, clearable: bool) {.cdecl.} =
  let nimfunc = cast[ptr QHeaderViewsortIndicatorClearableChangedSlot](cast[pointer](slot))
  let slotval1 = clearable

  nimfunc[](slotval1)

proc miqt_exec_callback_cQHeaderView_sortIndicatorClearableChanged_release(slot: int) {.cdecl.} =
...
proc onsortIndicatorClearableChanged*(self: gen_qheaderview_types.QHeaderView, slot: QHeaderViewsortIndicatorClearableChangedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQHeaderView_connect_sortIndicatorClearableChanged(self.h, cast[int](addr tmp[]), miqt_exec_callback_cQHeaderView_sortIndicatorClearableChanged, miqt_exec_callback_cQHeaderView_sortIndicatorClearableChanged_release)
...
type QHeaderViewinitStyleOptionForIndexProc* = proc(self: QHeaderView, option: gen_qstyleoption_types.QStyleOptionHeader, logicalIndex: cint): void {.raises: [], gcsafe.}
type QHeaderViewinitStyleOptionProc* = proc(self: QHeaderView, option: gen_qstyleoption_types.QStyleOptionHeader): void {.raises: [], gcsafe.}
...
type QHeaderViewitemDelegateForIndexProc* = proc(self: QHeaderView, index: gen_qabstractitemmodel_types.QModelIndex): gen_qabstractitemdelegate_types.QAbstractItemDelegate {.raises: [], gcsafe.}
...
type QHeaderViewinitViewItemOptionProc* = proc(self: QHeaderView, option: gen_qstyleoption_types.QStyleOptionViewItem): void {.raises: [], gcsafe.}
...
type QHeaderViewenterEventProc* = proc(self: QHeaderView, event: gen_qevent_types.QEnterEvent): void {.raises: [], gcsafe.}
...
type QHeaderViewnativeEventProc* = proc(self: QHeaderView, eventType: seq[byte], message: pointer, resultVal: ptr uint): bool {.raises: [], gcsafe.}
...
type QHeaderViewVTable* = object
  ...
  initStyleOptionForIndex*: QHeaderViewinitStyleOptionForIndexProc
  initStyleOption*: QHeaderViewinitStyleOptionProc
  ...
  itemDelegateForIndex*: QHeaderViewitemDelegateForIndexProc
  ...
  initViewItemOption*: QHeaderViewinitViewItemOptionProc
...
proc QHeaderViewinitStyleOptionForIndex*(self: gen_qheaderview_types.QHeaderView, option: gen_qstyleoption_types.QStyleOptionHeader, logicalIndex: cint): void =
  fcQHeaderView_virtualbase_initStyleOptionForIndex(self.h, option.h, logicalIndex)

proc miqt_exec_callback_cQHeaderView_initStyleOptionForIndex(vtbl: pointer, self: pointer, option: pointer, logicalIndex: cint): void {.cdecl.} =
  let vtbl = cast[ptr QHeaderViewVTable](vtbl)
  let self = QHeaderView(h: self)
  let slotval1 = gen_qstyleoption_types.QStyleOptionHeader(h: option)
  let slotval2 = logicalIndex
  vtbl[].initStyleOptionForIndex(self, slotval1, slotval2)

proc QHeaderViewinitStyleOption*(self: gen_qheaderview_types.QHeaderView, option: gen_qstyleoption_types.QStyleOptionHeader): void =
  fcQHeaderView_virtualbase_initStyleOption(self.h, option.h)

proc miqt_exec_callback_cQHeaderView_initStyleOption(vtbl: pointer, self: pointer, option: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QHeaderViewVTable](vtbl)
  let self = QHeaderView(h: self)
  let slotval1 = gen_qstyleoption_types.QStyleOptionHeader(h: option)
...
proc QHeaderViewitemDelegateForIndex*(self: gen_qheaderview_types.QHeaderView, index: gen_qabstractitemmodel_types.QModelIndex): gen_qabstractitemdelegate_types.QAbstractItemDelegate =
  gen_qabstractitemdelegate_types.QAbstractItemDelegate(h: fcQHeaderView_virtualbase_itemDelegateForIndex(self.h, index.h))

proc miqt_exec_callback_cQHeaderView_itemDelegateForIndex(vtbl: pointer, self: pointer, index: pointer): pointer {.cdecl.} =
  let vtbl = cast[ptr QHeaderViewVTable](vtbl)
  let self = QHeaderView(h: self)
  let slotval1 = gen_qabstractitemmodel_types.QModelIndex(h: index)
...
proc QHeaderViewinitViewItemOption*(self: gen_qheaderview_types.QHeaderView, option: gen_qstyleoption_types.QStyleOptionViewItem): void =
  fcQHeaderView_virtualbase_initViewItemOption(self.h, option.h)

proc miqt_exec_callback_cQHeaderView_initViewItemOption(vtbl: pointer, self: pointer, option: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QHeaderViewVTable](vtbl)
  let self = QHeaderView(h: self)
...
proc QHeaderViewenterEvent*(self: gen_qheaderview_types.QHeaderView, event: gen_qevent_types.QEnterEvent): void =
...
proc miqt_exec_callback_cQHeaderView_nativeEvent(vtbl: pointer, self: pointer, eventType: struct_miqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let vtbl = cast[ptr QHeaderViewVTable](vtbl)
  let self = QHeaderView(h: self)
...
proc create*(T: type gen_qheaderview_types.QHeaderView,
  ...
  if not isNil(vtbl.initStyleOptionForIndex):
    vtbl[].vtbl.initStyleOptionForIndex = miqt_exec_callback_cQHeaderView_initStyleOptionForIndex
  if not isNil(vtbl.initStyleOption):
    vtbl[].vtbl.initStyleOption = miqt_exec_callback_cQHeaderView_initStyleOption
  ...
  if not isNil(vtbl.itemDelegateForIndex):
    vtbl[].vtbl.itemDelegateForIndex = miqt_exec_callback_cQHeaderView_itemDelegateForIndex
  ...
  if not isNil(vtbl.initViewItemOption):
    vtbl[].vtbl.initViewItemOption = miqt_exec_callback_cQHeaderView_initViewItemOption
