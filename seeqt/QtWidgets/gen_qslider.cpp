...
QMetaObject* QSlider_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQSlider*)(self) )->QSlider::metaObject();

}

void* QSlider_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQSlider*)(self) )->QSlider::qt_metacast(param1);

}

int QSlider_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQSlider*)(self) )->QSlider::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
void QSlider_virtualbase_initStyleOption(const void* self, QStyleOptionSlider* option) {
	...
	( (const MiqtVirtualQSlider*)(self) )->QSlider::initStyleOption(option);
...
bool QSlider_virtualbase_nativeEvent(void* self, struct miqt_string eventType, void* message, intptr_t* result) {
	...
	return ( (MiqtVirtualQSlider*)(self) )->QSlider::nativeEvent(eventType_QByteArray, message, (qintptr*)(result));
