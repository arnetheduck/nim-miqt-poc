...
QMetaObject* QLCDNumber_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQLCDNumber*)(self) )->QLCDNumber::metaObject();

}

void* QLCDNumber_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQLCDNumber*)(self) )->QLCDNumber::qt_metacast(param1);

}

int QLCDNumber_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQLCDNumber*)(self) )->QLCDNumber::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
bool QLCDNumber_virtualbase_nativeEvent(void* self, struct miqt_string eventType, void* message, long* result) {
	...
	return ( (MiqtVirtualQLCDNumber*)(self) )->QLCDNumber::nativeEvent(eventType_QByteArray, message, static_cast<long*>(result));
