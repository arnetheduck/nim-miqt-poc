...
QMetaObject* QCommonStyle_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQCommonStyle*)(self) )->QCommonStyle::metaObject();

}

void* QCommonStyle_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQCommonStyle*)(self) )->QCommonStyle::qt_metacast(param1);

}

int QCommonStyle_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQCommonStyle*)(self) )->QCommonStyle::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
QObject* QCommonStyle_protectedbase_sender(const void* self) {
	MiqtVirtualQCommonStyle* self_cast = static_cast<MiqtVirtualQCommonStyle*>( (QCommonStyle*)(self) );
