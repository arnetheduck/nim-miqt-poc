...
void QTreeWidgetItem_protectedbase_emitDataChanged(void* self) {
	MiqtVirtualQTreeWidgetItem* self_cast = static_cast<MiqtVirtualQTreeWidgetItem*>( (QTreeWidgetItem*)(self) );
...
QMetaObject* QTreeWidget_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQTreeWidget*)(self) )->QTreeWidget::metaObject();

}

void* QTreeWidget_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQTreeWidget*)(self) )->QTreeWidget::qt_metacast(param1);

}

int QTreeWidget_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQTreeWidget*)(self) )->QTreeWidget::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
QStyleOptionViewItem* QTreeWidget_virtualbase_viewOptions(const void* self) {
	...
	return new QStyleOptionViewItem(( (const MiqtVirtualQTreeWidget*)(self) )->QTreeWidget::viewOptions());
...
void QTreeWidget_virtualbase_changeEvent(void* self, QEvent* param1) {
	...
	( (MiqtVirtualQTreeWidget*)(self) )->QTreeWidget::changeEvent(param1);
...
bool QTreeWidget_virtualbase_nativeEvent(void* self, struct miqt_string eventType, void* message, long* result) {
	...
	return ( (MiqtVirtualQTreeWidget*)(self) )->QTreeWidget::nativeEvent(eventType_QByteArray, message, static_cast<long*>(result));
...
struct miqt_array /* of QTreeWidgetItem* */  QTreeWidget_protectedbase_items(const void* self, QMimeData* data) {
	MiqtVirtualQTreeWidget* self_cast = static_cast<MiqtVirtualQTreeWidget*>( (QTreeWidget*)(self) );
