...
proc fQTextBrowser_connect_highlightedWithQString(self: pointer, slot: int) {.importc: "QTextBrowser_connect_highlightedWithQString".}
...
proc miqt_exec_callback_QTextBrowser_loadResource(self: ptr cQTextBrowser, slot: int, typeVal: cint, name: pointer): pointer {.exportc: "miqt_exec_callback_QTextBrowser_loadResource ".} =
  ...
  virtualReturn.h
proc QTextBrowsersetSource*(self: gen_qtextbrowser_types.QTextBrowser, name: QUrl): void =
  fQTextBrowser_virtualbase_setSource(self.h, name.h)

type QTextBrowsersetSourceProc* = proc(name: QUrl): void
...
proc miqt_exec_callback_QTextBrowser_paintEngine(self: ptr cQTextBrowser, slot: int): pointer {.exportc: "miqt_exec_callback_QTextBrowser_paintEngine ".} =
  ...
  virtualReturn.h
proc QTextBrowserenterEvent*(self: gen_qtextbrowser_types.QTextBrowser, event: QEvent): void =
  fQTextBrowser_virtualbase_enterEvent(self.h, event.h)

type QTextBrowserenterEventProc* = proc(event: QEvent): void
