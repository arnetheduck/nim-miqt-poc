...
void QSplitter_connect_splitterMoved(QSplitter* self, intptr_t slot, void (*callback)(intptr_t, int, int), void (*release)(intptr_t)) {
	...
	MiqtVirtualQSplitter::connect(self, static_cast<void (QSplitter::*)(int, int)>(&QSplitter::splitterMoved), self, caller{slot, callback, release});
}
...
QMetaObject* QSplitter_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQSplitter*)(self) )->QSplitter::metaObject();

}

void* QSplitter_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQSplitter*)(self) )->QSplitter::qt_metacast(param1);

}

int QSplitter_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQSplitter*)(self) )->QSplitter::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
bool QSplitter_virtualbase_nativeEvent(void* self, struct miqt_string eventType, void* message, long* result) {
	...
	return ( (MiqtVirtualQSplitter*)(self) )->QSplitter::nativeEvent(eventType_QByteArray, message, static_cast<long*>(result));
...
QMetaObject* QSplitterHandle_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQSplitterHandle*)(self) )->QSplitterHandle::metaObject();

}

void* QSplitterHandle_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQSplitterHandle*)(self) )->QSplitterHandle::qt_metacast(param1);

}

int QSplitterHandle_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQSplitterHandle*)(self) )->QSplitterHandle::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
bool QSplitterHandle_virtualbase_nativeEvent(void* self, struct miqt_string eventType, void* message, long* result) {
	...
	return ( (MiqtVirtualQSplitterHandle*)(self) )->QSplitterHandle::nativeEvent(eventType_QByteArray, message, static_cast<long*>(result));
