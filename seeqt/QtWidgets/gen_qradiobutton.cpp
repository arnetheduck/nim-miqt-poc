...
QMetaObject* QRadioButton_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQRadioButton*)(self) )->QRadioButton::metaObject();

}

void* QRadioButton_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQRadioButton*)(self) )->QRadioButton::qt_metacast(param1);

}

int QRadioButton_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQRadioButton*)(self) )->QRadioButton::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
void QRadioButton_virtualbase_initStyleOption(const void* self, QStyleOptionButton* button) {
	...
	( (const MiqtVirtualQRadioButton*)(self) )->QRadioButton::initStyleOption(button);
...
bool QRadioButton_virtualbase_nativeEvent(void* self, struct miqt_string eventType, void* message, intptr_t* result) {
	...
	return ( (MiqtVirtualQRadioButton*)(self) )->QRadioButton::nativeEvent(eventType_QByteArray, message, (qintptr*)(result));
...
void QRadioButton_protectedbase_updateMicroFocus(void* self) {
	MiqtVirtualQRadioButton* self_cast = static_cast<MiqtVirtualQRadioButton*>( (QRadioButton*)(self) );
