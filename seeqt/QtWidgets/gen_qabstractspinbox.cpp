...
void QAbstractSpinBox_connect_editingFinished(QAbstractSpinBox* self, intptr_t slot, void (*callback)(intptr_t), void (*release)(intptr_t)) {
	...
	MiqtVirtualQAbstractSpinBox::connect(self, static_cast<void (QAbstractSpinBox::*)()>(&QAbstractSpinBox::editingFinished), self, caller{slot, callback, release});
}
...
QMetaObject* QAbstractSpinBox_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQAbstractSpinBox*)(self) )->QAbstractSpinBox::metaObject();

}

void* QAbstractSpinBox_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQAbstractSpinBox*)(self) )->QAbstractSpinBox::qt_metacast(param1);

}

int QAbstractSpinBox_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQAbstractSpinBox*)(self) )->QAbstractSpinBox::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
void QAbstractSpinBox_virtualbase_initStyleOption(const void* self, QStyleOptionSpinBox* option) {
	...
	( (const MiqtVirtualQAbstractSpinBox*)(self) )->QAbstractSpinBox::initStyleOption(option);
...
bool QAbstractSpinBox_virtualbase_nativeEvent(void* self, struct miqt_string eventType, void* message, intptr_t* result) {
	...
	return ( (MiqtVirtualQAbstractSpinBox*)(self) )->QAbstractSpinBox::nativeEvent(eventType_QByteArray, message, (qintptr*)(result));
...
QLineEdit* QAbstractSpinBox_protectedbase_lineEdit(const void* self) {
	MiqtVirtualQAbstractSpinBox* self_cast = static_cast<MiqtVirtualQAbstractSpinBox*>( (QAbstractSpinBox*)(self) );
