...
func init*(T: type gen_qabstractitemview_types.QAbstractItemView, h: ptr cQAbstractItemView): gen_qabstractitemview_types.QAbstractItemView =
  T(h: h)
proc create*(T: type gen_qabstractitemview_types.QAbstractItemView, parent: QWidget): gen_qabstractitemview_types.QAbstractItemView =
...
proc metaObject*(self: gen_qabstractitemview_types.QAbstractItemView, ): QMetaObject =
  QMetaObject(h: fcQAbstractItemView_metaObject(self.h))
...
proc setModel*(self: gen_qabstractitemview_types.QAbstractItemView, model: QAbstractItemModel): void =
  fcQAbstractItemView_setModel(self.h, model.h)

proc model*(self: gen_qabstractitemview_types.QAbstractItemView, ): QAbstractItemModel =
  QAbstractItemModel(h: fcQAbstractItemView_model(self.h))

proc setSelectionModel*(self: gen_qabstractitemview_types.QAbstractItemView, selectionModel: QItemSelectionModel): void =
  fcQAbstractItemView_setSelectionModel(self.h, selectionModel.h)

proc selectionModel*(self: gen_qabstractitemview_types.QAbstractItemView, ): QItemSelectionModel =
  QItemSelectionModel(h: fcQAbstractItemView_selectionModel(self.h))

proc setItemDelegate*(self: gen_qabstractitemview_types.QAbstractItemView, delegate: QAbstractItemDelegate): void =
  fcQAbstractItemView_setItemDelegate(self.h, delegate.h)

proc itemDelegate*(self: gen_qabstractitemview_types.QAbstractItemView, ): QAbstractItemDelegate =
  QAbstractItemDelegate(h: fcQAbstractItemView_itemDelegate(self.h))
...
proc currentIndex*(self: gen_qabstractitemview_types.QAbstractItemView, ): QModelIndex =
  QModelIndex(h: fcQAbstractItemView_currentIndex(self.h))

proc rootIndex*(self: gen_qabstractitemview_types.QAbstractItemView, ): QModelIndex =
  QModelIndex(h: fcQAbstractItemView_rootIndex(self.h))
...
proc setIconSize*(self: gen_qabstractitemview_types.QAbstractItemView, size: QSize): void =
  fcQAbstractItemView_setIconSize(self.h, size.h)

proc iconSize*(self: gen_qabstractitemview_types.QAbstractItemView, ): QSize =
  QSize(h: fcQAbstractItemView_iconSize(self.h))
...
proc visualRect*(self: gen_qabstractitemview_types.QAbstractItemView, index: QModelIndex): QRect =
  QRect(h: fcQAbstractItemView_visualRect(self.h, index.h))

proc scrollTo*(self: gen_qabstractitemview_types.QAbstractItemView, index: QModelIndex, hint: cint): void =
  fcQAbstractItemView_scrollTo(self.h, index.h, cint(hint))

proc indexAt*(self: gen_qabstractitemview_types.QAbstractItemView, point: QPoint): QModelIndex =
  QModelIndex(h: fcQAbstractItemView_indexAt(self.h, point.h))

proc sizeHintForIndex*(self: gen_qabstractitemview_types.QAbstractItemView, index: QModelIndex): QSize =
  QSize(h: fcQAbstractItemView_sizeHintForIndex(self.h, index.h))
...
proc openPersistentEditor*(self: gen_qabstractitemview_types.QAbstractItemView, index: QModelIndex): void =
  fcQAbstractItemView_openPersistentEditor(self.h, index.h)

proc closePersistentEditor*(self: gen_qabstractitemview_types.QAbstractItemView, index: QModelIndex): void =
  fcQAbstractItemView_closePersistentEditor(self.h, index.h)

proc isPersistentEditorOpen*(self: gen_qabstractitemview_types.QAbstractItemView, index: QModelIndex): bool =
  fcQAbstractItemView_isPersistentEditorOpen(self.h, index.h)

proc setIndexWidget*(self: gen_qabstractitemview_types.QAbstractItemView, index: QModelIndex, widget: QWidget): void =
  fcQAbstractItemView_setIndexWidget(self.h, index.h, widget.h)

proc indexWidget*(self: gen_qabstractitemview_types.QAbstractItemView, index: QModelIndex): QWidget =
  QWidget(h: fcQAbstractItemView_indexWidget(self.h, index.h))

proc setItemDelegateForRow*(self: gen_qabstractitemview_types.QAbstractItemView, row: cint, delegate: QAbstractItemDelegate): void =
  fcQAbstractItemView_setItemDelegateForRow(self.h, row, delegate.h)

proc itemDelegateForRow*(self: gen_qabstractitemview_types.QAbstractItemView, row: cint): QAbstractItemDelegate =
  QAbstractItemDelegate(h: fcQAbstractItemView_itemDelegateForRow(self.h, row))

proc setItemDelegateForColumn*(self: gen_qabstractitemview_types.QAbstractItemView, column: cint, delegate: QAbstractItemDelegate): void =
  fcQAbstractItemView_setItemDelegateForColumn(self.h, column, delegate.h)

proc itemDelegateForColumn*(self: gen_qabstractitemview_types.QAbstractItemView, column: cint): QAbstractItemDelegate =
  QAbstractItemDelegate(h: fcQAbstractItemView_itemDelegateForColumn(self.h, column))

proc itemDelegate*(self: gen_qabstractitemview_types.QAbstractItemView, index: QModelIndex): QAbstractItemDelegate =
  QAbstractItemDelegate(h: fcQAbstractItemView_itemDelegateWithIndex(self.h, index.h))

proc inputMethodQuery*(self: gen_qabstractitemview_types.QAbstractItemView, query: cint): QVariant =
  QVariant(h: fcQAbstractItemView_inputMethodQuery(self.h, cint(query)))

proc reset*(self: gen_qabstractitemview_types.QAbstractItemView, ): void =
  fcQAbstractItemView_reset(self.h)

proc setRootIndex*(self: gen_qabstractitemview_types.QAbstractItemView, index: QModelIndex): void =
...
proc edit*(self: gen_qabstractitemview_types.QAbstractItemView, index: QModelIndex): void =
...
proc setCurrentIndex*(self: gen_qabstractitemview_types.QAbstractItemView, index: QModelIndex): void =
...
proc update*(self: gen_qabstractitemview_types.QAbstractItemView, index: QModelIndex): void =
  fcQAbstractItemView_update(self.h, index.h)

proc pressed*(self: gen_qabstractitemview_types.QAbstractItemView, index: QModelIndex): void =
  fcQAbstractItemView_pressed(self.h, index.h)

type QAbstractItemViewpressedSlot* = proc(index: QModelIndex)
...
proc clicked*(self: gen_qabstractitemview_types.QAbstractItemView, index: QModelIndex): void =
  fcQAbstractItemView_clicked(self.h, index.h)

type QAbstractItemViewclickedSlot* = proc(index: QModelIndex)
...
proc doubleClicked*(self: gen_qabstractitemview_types.QAbstractItemView, index: QModelIndex): void =
  fcQAbstractItemView_doubleClicked(self.h, index.h)

type QAbstractItemViewdoubleClickedSlot* = proc(index: QModelIndex)
...
proc activated*(self: gen_qabstractitemview_types.QAbstractItemView, index: QModelIndex): void =
  fcQAbstractItemView_activated(self.h, index.h)

type QAbstractItemViewactivatedSlot* = proc(index: QModelIndex)
...
proc entered*(self: gen_qabstractitemview_types.QAbstractItemView, index: QModelIndex): void =
  fcQAbstractItemView_entered(self.h, index.h)

type QAbstractItemViewenteredSlot* = proc(index: QModelIndex)
...
proc iconSizeChanged*(self: gen_qabstractitemview_types.QAbstractItemView, size: QSize): void =
  fcQAbstractItemView_iconSizeChanged(self.h, size.h)

type QAbstractItemViewiconSizeChangedSlot* = proc(size: QSize)
...
proc miqt_exec_callback_QAbstractItemView_metacall(self: ptr cQAbstractItemView, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QAbstractItemView_metacall ".} =
  ...
  virtualReturn
proc QAbstractItemViewsetModel*(self: gen_qabstractitemview_types.QAbstractItemView, model: QAbstractItemModel): void =
  fQAbstractItemView_virtualbase_setModel(self.h, model.h)

type QAbstractItemViewsetModelProc* = proc(model: QAbstractItemModel): void
...
proc miqt_exec_callback_QAbstractItemView_setModel(self: ptr cQAbstractItemView, slot: int, model: pointer): void {.exportc: "miqt_exec_callback_QAbstractItemView_setModel ".} =
  ...
  let slotval1 = QAbstractItemModel(h: model)


  nimfunc[](slotval1)
proc QAbstractItemViewsetSelectionModel*(self: gen_qabstractitemview_types.QAbstractItemView, selectionModel: QItemSelectionModel): void =
  fQAbstractItemView_virtualbase_setSelectionModel(self.h, selectionModel.h)

type QAbstractItemViewsetSelectionModelProc* = proc(selectionModel: QItemSelectionModel): void
...
proc miqt_exec_callback_QAbstractItemView_keyboardSearch(self: ptr cQAbstractItemView, slot: int, search: struct_miqt_string): void {.exportc: "miqt_exec_callback_QAbstractItemView_keyboardSearch ".} =
  ...
  nimfunc[](slotval1)
type QAbstractItemViewvisualRectProc* = proc(index: QModelIndex): QRect
...
proc miqt_exec_callback_QAbstractItemView_visualRect(self: ptr cQAbstractItemView, slot: int, index: pointer): pointer {.exportc: "miqt_exec_callback_QAbstractItemView_visualRect ".} =
  ...
  virtualReturn.h
type QAbstractItemViewscrollToProc* = proc(index: QModelIndex, hint: cint): void
...
type QAbstractItemViewindexAtProc* = proc(point: QPoint): QModelIndex
...
proc miqt_exec_callback_QAbstractItemView_sizeHintForColumn(self: ptr cQAbstractItemView, slot: int, column: cint): cint {.exportc: "miqt_exec_callback_QAbstractItemView_sizeHintForColumn ".} =
  ...
  virtualReturn
proc QAbstractItemViewinputMethodQuery*(self: gen_qabstractitemview_types.QAbstractItemView, query: cint): QVariant =
  QVariant(h: fQAbstractItemView_virtualbase_inputMethodQuery(self.h, cint(query)))

type QAbstractItemViewinputMethodQueryProc* = proc(query: cint): QVariant
...
proc miqt_exec_callback_QAbstractItemView_reset(self: ptr cQAbstractItemView, slot: int): void {.exportc: "miqt_exec_callback_QAbstractItemView_reset ".} =
  ...
  nimfunc[]()
proc QAbstractItemViewsetRootIndex*(self: gen_qabstractitemview_types.QAbstractItemView, index: QModelIndex): void =
  fQAbstractItemView_virtualbase_setRootIndex(self.h, index.h)

type QAbstractItemViewsetRootIndexProc* = proc(index: QModelIndex): void
...
proc miqt_exec_callback_QAbstractItemView_selectAll(self: ptr cQAbstractItemView, slot: int): void {.exportc: "miqt_exec_callback_QAbstractItemView_selectAll ".} =
  ...
  nimfunc[]()
proc QAbstractItemViewdataChanged*(self: gen_qabstractitemview_types.QAbstractItemView, topLeft: QModelIndex, bottomRight: QModelIndex, roles: seq[cint]): void =
...
type QAbstractItemViewdataChangedProc* = proc(topLeft: QModelIndex, bottomRight: QModelIndex, roles: seq[cint]): void
...
proc QAbstractItemViewrowsInserted*(self: gen_qabstractitemview_types.QAbstractItemView, parent: QModelIndex, start: cint, endVal: cint): void =
  fQAbstractItemView_virtualbase_rowsInserted(self.h, parent.h, start, endVal)

type QAbstractItemViewrowsInsertedProc* = proc(parent: QModelIndex, start: cint, endVal: cint): void
...
proc miqt_exec_callback_QAbstractItemView_rowsInserted(self: ptr cQAbstractItemView, slot: int, parent: pointer, start: cint, endVal: cint): void {.exportc: "miqt_exec_callback_QAbstractItemView_rowsInserted ".} =
  ...
  nimfunc[](slotval1, slotval2, slotval3)
proc QAbstractItemViewrowsAboutToBeRemoved*(self: gen_qabstractitemview_types.QAbstractItemView, parent: QModelIndex, start: cint, endVal: cint): void =
  fQAbstractItemView_virtualbase_rowsAboutToBeRemoved(self.h, parent.h, start, endVal)

type QAbstractItemViewrowsAboutToBeRemovedProc* = proc(parent: QModelIndex, start: cint, endVal: cint): void
...
proc miqt_exec_callback_QAbstractItemView_rowsAboutToBeRemoved(self: ptr cQAbstractItemView, slot: int, parent: pointer, start: cint, endVal: cint): void {.exportc: "miqt_exec_callback_QAbstractItemView_rowsAboutToBeRemoved ".} =
  ...
  nimfunc[](slotval1, slotval2, slotval3)
proc QAbstractItemViewselectionChanged*(self: gen_qabstractitemview_types.QAbstractItemView, selected: QItemSelection, deselected: QItemSelection): void =
  fQAbstractItemView_virtualbase_selectionChanged(self.h, selected.h, deselected.h)

type QAbstractItemViewselectionChangedProc* = proc(selected: QItemSelection, deselected: QItemSelection): void
...
proc miqt_exec_callback_QAbstractItemView_selectionChanged(self: ptr cQAbstractItemView, slot: int, selected: pointer, deselected: pointer): void {.exportc: "miqt_exec_callback_QAbstractItemView_selectionChanged ".} =
  ...
  nimfunc[](slotval1, slotval2)
proc QAbstractItemViewcurrentChanged*(self: gen_qabstractitemview_types.QAbstractItemView, current: QModelIndex, previous: QModelIndex): void =
  fQAbstractItemView_virtualbase_currentChanged(self.h, current.h, previous.h)

type QAbstractItemViewcurrentChangedProc* = proc(current: QModelIndex, previous: QModelIndex): void
...
proc miqt_exec_callback_QAbstractItemView_horizontalScrollbarValueChanged(self: ptr cQAbstractItemView, slot: int, value: cint): void {.exportc: "miqt_exec_callback_QAbstractItemView_horizontalScrollbarValueChanged ".} =
  ...
  nimfunc[](slotval1)
proc QAbstractItemViewcloseEditor*(self: gen_qabstractitemview_types.QAbstractItemView, editor: QWidget, hint: cint): void =
  fQAbstractItemView_virtualbase_closeEditor(self.h, editor.h, cint(hint))

type QAbstractItemViewcloseEditorProc* = proc(editor: QWidget, hint: cint): void
...
proc miqt_exec_callback_QAbstractItemView_closeEditor(self: ptr cQAbstractItemView, slot: int, editor: pointer, hint: cint): void {.exportc: "miqt_exec_callback_QAbstractItemView_closeEditor ".} =
  ...
  nimfunc[](slotval1, slotval2)
proc QAbstractItemViewcommitData*(self: gen_qabstractitemview_types.QAbstractItemView, editor: QWidget): void =
  fQAbstractItemView_virtualbase_commitData(self.h, editor.h)

type QAbstractItemViewcommitDataProc* = proc(editor: QWidget): void
...
proc miqt_exec_callback_QAbstractItemView_commitData(self: ptr cQAbstractItemView, slot: int, editor: pointer): void {.exportc: "miqt_exec_callback_QAbstractItemView_commitData ".} =
  ...
  nimfunc[](slotval1)
proc QAbstractItemVieweditorDestroyed*(self: gen_qabstractitemview_types.QAbstractItemView, editor: QObject): void =
  fQAbstractItemView_virtualbase_editorDestroyed(self.h, editor.h)

type QAbstractItemVieweditorDestroyedProc* = proc(editor: QObject): void
...
proc miqt_exec_callback_QAbstractItemView_editorDestroyed(self: ptr cQAbstractItemView, slot: int, editor: pointer): void {.exportc: "miqt_exec_callback_QAbstractItemView_editorDestroyed ".} =
  ...
  nimfunc[](slotval1)
type QAbstractItemViewmoveCursorProc* = proc(cursorAction: cint, modifiers: cint): QModelIndex
...
proc miqt_exec_callback_QAbstractItemView_verticalOffset(self: ptr cQAbstractItemView, slot: int): cint {.exportc: "miqt_exec_callback_QAbstractItemView_verticalOffset ".} =
  ...
  virtualReturn
type QAbstractItemViewisIndexHiddenProc* = proc(index: QModelIndex): bool
...
proc miqt_exec_callback_QAbstractItemView_isIndexHidden(self: ptr cQAbstractItemView, slot: int, index: pointer): bool {.exportc: "miqt_exec_callback_QAbstractItemView_isIndexHidden ".} =
  ...
  virtualReturn
type QAbstractItemViewsetSelectionProc* = proc(rect: QRect, command: cint): void
...
proc miqt_exec_callback_QAbstractItemView_setSelection(self: ptr cQAbstractItemView, slot: int, rect: pointer, command: cint): void {.exportc: "miqt_exec_callback_QAbstractItemView_setSelection ".} =
  ...
  nimfunc[](slotval1, slotval2)
type QAbstractItemViewvisualRegionForSelectionProc* = proc(selection: QItemSelection): QRegion
...
proc miqt_exec_callback_QAbstractItemView_visualRegionForSelection(self: ptr cQAbstractItemView, slot: int, selection: pointer): pointer {.exportc: "miqt_exec_callback_QAbstractItemView_visualRegionForSelection ".} =
  ...
  virtualReturn.h
proc QAbstractItemViewselectedIndexes*(self: gen_qabstractitemview_types.QAbstractItemView, ): seq[QModelIndex] =
...
type QAbstractItemViewselectedIndexesProc* = proc(): seq[QModelIndex]
...
proc QAbstractItemViewedit*(self: gen_qabstractitemview_types.QAbstractItemView, index: QModelIndex, trigger: cint, event: QEvent): bool =
  fQAbstractItemView_virtualbase_edit2(self.h, index.h, cint(trigger), event.h)

type QAbstractItemViewedit2Proc* = proc(index: QModelIndex, trigger: cint, event: QEvent): bool
...
proc miqt_exec_callback_QAbstractItemView_edit2(self: ptr cQAbstractItemView, slot: int, index: pointer, trigger: cint, event: pointer): bool {.exportc: "miqt_exec_callback_QAbstractItemView_edit2 ".} =
  ...
  virtualReturn
proc QAbstractItemViewselectionCommand*(self: gen_qabstractitemview_types.QAbstractItemView, index: QModelIndex, event: QEvent): cint =
  cint(fQAbstractItemView_virtualbase_selectionCommand(self.h, index.h, event.h))

type QAbstractItemViewselectionCommandProc* = proc(index: QModelIndex, event: QEvent): cint
...
proc miqt_exec_callback_QAbstractItemView_startDrag(self: ptr cQAbstractItemView, slot: int, supportedActions: cint): void {.exportc: "miqt_exec_callback_QAbstractItemView_startDrag ".} =
  ...
  nimfunc[](slotval1)
proc QAbstractItemViewviewOptions*(self: gen_qabstractitemview_types.QAbstractItemView, ): QStyleOptionViewItem =
  QStyleOptionViewItem(h: fQAbstractItemView_virtualbase_viewOptions(self.h))

type QAbstractItemViewviewOptionsProc* = proc(): QStyleOptionViewItem
...
proc miqt_exec_callback_QAbstractItemView_focusNextPrevChild(self: ptr cQAbstractItemView, slot: int, next: bool): bool {.exportc: "miqt_exec_callback_QAbstractItemView_focusNextPrevChild ".} =
  ...
  virtualReturn
proc QAbstractItemViewevent*(self: gen_qabstractitemview_types.QAbstractItemView, event: QEvent): bool =
  fQAbstractItemView_virtualbase_event(self.h, event.h)

type QAbstractItemVieweventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QAbstractItemView_event(self: ptr cQAbstractItemView, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QAbstractItemView_event ".} =
  ...
  virtualReturn
proc QAbstractItemViewviewportEvent*(self: gen_qabstractitemview_types.QAbstractItemView, event: QEvent): bool =
  fQAbstractItemView_virtualbase_viewportEvent(self.h, event.h)

type QAbstractItemViewviewportEventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QAbstractItemView_viewportEvent(self: ptr cQAbstractItemView, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QAbstractItemView_viewportEvent ".} =
  ...
  virtualReturn
proc QAbstractItemViewmousePressEvent*(self: gen_qabstractitemview_types.QAbstractItemView, event: QMouseEvent): void =
  fQAbstractItemView_virtualbase_mousePressEvent(self.h, event.h)

type QAbstractItemViewmousePressEventProc* = proc(event: QMouseEvent): void
...
proc miqt_exec_callback_QAbstractItemView_mousePressEvent(self: ptr cQAbstractItemView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QAbstractItemView_mousePressEvent ".} =
  ...
  nimfunc[](slotval1)
proc QAbstractItemViewmouseMoveEvent*(self: gen_qabstractitemview_types.QAbstractItemView, event: QMouseEvent): void =
  fQAbstractItemView_virtualbase_mouseMoveEvent(self.h, event.h)

type QAbstractItemViewmouseMoveEventProc* = proc(event: QMouseEvent): void
...
proc miqt_exec_callback_QAbstractItemView_mouseMoveEvent(self: ptr cQAbstractItemView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QAbstractItemView_mouseMoveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QAbstractItemViewmouseReleaseEvent*(self: gen_qabstractitemview_types.QAbstractItemView, event: QMouseEvent): void =
  fQAbstractItemView_virtualbase_mouseReleaseEvent(self.h, event.h)

type QAbstractItemViewmouseReleaseEventProc* = proc(event: QMouseEvent): void
...
proc miqt_exec_callback_QAbstractItemView_mouseReleaseEvent(self: ptr cQAbstractItemView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QAbstractItemView_mouseReleaseEvent ".} =
  ...
  nimfunc[](slotval1)
proc QAbstractItemViewmouseDoubleClickEvent*(self: gen_qabstractitemview_types.QAbstractItemView, event: QMouseEvent): void =
  fQAbstractItemView_virtualbase_mouseDoubleClickEvent(self.h, event.h)

type QAbstractItemViewmouseDoubleClickEventProc* = proc(event: QMouseEvent): void
...
proc miqt_exec_callback_QAbstractItemView_mouseDoubleClickEvent(self: ptr cQAbstractItemView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QAbstractItemView_mouseDoubleClickEvent ".} =
  ...
  nimfunc[](slotval1)
proc QAbstractItemViewdragEnterEvent*(self: gen_qabstractitemview_types.QAbstractItemView, event: QDragEnterEvent): void =
  fQAbstractItemView_virtualbase_dragEnterEvent(self.h, event.h)

type QAbstractItemViewdragEnterEventProc* = proc(event: QDragEnterEvent): void
...
proc miqt_exec_callback_QAbstractItemView_dragEnterEvent(self: ptr cQAbstractItemView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QAbstractItemView_dragEnterEvent ".} =
  ...
  nimfunc[](slotval1)
proc QAbstractItemViewdragMoveEvent*(self: gen_qabstractitemview_types.QAbstractItemView, event: QDragMoveEvent): void =
  fQAbstractItemView_virtualbase_dragMoveEvent(self.h, event.h)

type QAbstractItemViewdragMoveEventProc* = proc(event: QDragMoveEvent): void
...
proc miqt_exec_callback_QAbstractItemView_dragMoveEvent(self: ptr cQAbstractItemView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QAbstractItemView_dragMoveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QAbstractItemViewdragLeaveEvent*(self: gen_qabstractitemview_types.QAbstractItemView, event: QDragLeaveEvent): void =
  fQAbstractItemView_virtualbase_dragLeaveEvent(self.h, event.h)

type QAbstractItemViewdragLeaveEventProc* = proc(event: QDragLeaveEvent): void
...
proc miqt_exec_callback_QAbstractItemView_dragLeaveEvent(self: ptr cQAbstractItemView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QAbstractItemView_dragLeaveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QAbstractItemViewdropEvent*(self: gen_qabstractitemview_types.QAbstractItemView, event: QDropEvent): void =
  fQAbstractItemView_virtualbase_dropEvent(self.h, event.h)

type QAbstractItemViewdropEventProc* = proc(event: QDropEvent): void
...
proc miqt_exec_callback_QAbstractItemView_dropEvent(self: ptr cQAbstractItemView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QAbstractItemView_dropEvent ".} =
  ...
  nimfunc[](slotval1)
proc QAbstractItemViewfocusInEvent*(self: gen_qabstractitemview_types.QAbstractItemView, event: QFocusEvent): void =
  fQAbstractItemView_virtualbase_focusInEvent(self.h, event.h)

type QAbstractItemViewfocusInEventProc* = proc(event: QFocusEvent): void
...
proc miqt_exec_callback_QAbstractItemView_focusInEvent(self: ptr cQAbstractItemView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QAbstractItemView_focusInEvent ".} =
  ...
  nimfunc[](slotval1)
proc QAbstractItemViewfocusOutEvent*(self: gen_qabstractitemview_types.QAbstractItemView, event: QFocusEvent): void =
  fQAbstractItemView_virtualbase_focusOutEvent(self.h, event.h)

type QAbstractItemViewfocusOutEventProc* = proc(event: QFocusEvent): void
...
proc miqt_exec_callback_QAbstractItemView_focusOutEvent(self: ptr cQAbstractItemView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QAbstractItemView_focusOutEvent ".} =
  ...
  nimfunc[](slotval1)
proc QAbstractItemViewkeyPressEvent*(self: gen_qabstractitemview_types.QAbstractItemView, event: QKeyEvent): void =
  fQAbstractItemView_virtualbase_keyPressEvent(self.h, event.h)

type QAbstractItemViewkeyPressEventProc* = proc(event: QKeyEvent): void
...
proc miqt_exec_callback_QAbstractItemView_keyPressEvent(self: ptr cQAbstractItemView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QAbstractItemView_keyPressEvent ".} =
  ...
  nimfunc[](slotval1)
proc QAbstractItemViewresizeEvent*(self: gen_qabstractitemview_types.QAbstractItemView, event: QResizeEvent): void =
  fQAbstractItemView_virtualbase_resizeEvent(self.h, event.h)

type QAbstractItemViewresizeEventProc* = proc(event: QResizeEvent): void
...
proc miqt_exec_callback_QAbstractItemView_resizeEvent(self: ptr cQAbstractItemView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QAbstractItemView_resizeEvent ".} =
  ...
  nimfunc[](slotval1)
proc QAbstractItemViewtimerEvent*(self: gen_qabstractitemview_types.QAbstractItemView, event: QTimerEvent): void =
  fQAbstractItemView_virtualbase_timerEvent(self.h, event.h)

type QAbstractItemViewtimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QAbstractItemView_timerEvent(self: ptr cQAbstractItemView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QAbstractItemView_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QAbstractItemViewinputMethodEvent*(self: gen_qabstractitemview_types.QAbstractItemView, event: QInputMethodEvent): void =
  fQAbstractItemView_virtualbase_inputMethodEvent(self.h, event.h)

type QAbstractItemViewinputMethodEventProc* = proc(event: QInputMethodEvent): void
...
proc miqt_exec_callback_QAbstractItemView_inputMethodEvent(self: ptr cQAbstractItemView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QAbstractItemView_inputMethodEvent ".} =
  ...
  nimfunc[](slotval1)
proc QAbstractItemVieweventFilter*(self: gen_qabstractitemview_types.QAbstractItemView, objectVal: QObject, event: QEvent): bool =
  fQAbstractItemView_virtualbase_eventFilter(self.h, objectVal.h, event.h)

type QAbstractItemVieweventFilterProc* = proc(objectVal: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QAbstractItemView_eventFilter(self: ptr cQAbstractItemView, slot: int, objectVal: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QAbstractItemView_eventFilter ".} =
  ...
  virtualReturn
proc QAbstractItemViewviewportSizeHint*(self: gen_qabstractitemview_types.QAbstractItemView, ): QSize =
  QSize(h: fQAbstractItemView_virtualbase_viewportSizeHint(self.h))

type QAbstractItemViewviewportSizeHintProc* = proc(): QSize
...
proc miqt_exec_callback_QAbstractItemView_viewportSizeHint(self: ptr cQAbstractItemView, slot: int): pointer {.exportc: "miqt_exec_callback_QAbstractItemView_viewportSizeHint ".} =
  ...
  virtualReturn.h
proc QAbstractItemViewminimumSizeHint*(self: gen_qabstractitemview_types.QAbstractItemView, ): QSize =
  QSize(h: fQAbstractItemView_virtualbase_minimumSizeHint(self.h))

type QAbstractItemViewminimumSizeHintProc* = proc(): QSize
...
proc miqt_exec_callback_QAbstractItemView_minimumSizeHint(self: ptr cQAbstractItemView, slot: int): pointer {.exportc: "miqt_exec_callback_QAbstractItemView_minimumSizeHint ".} =
  ...
  virtualReturn.h
proc QAbstractItemViewsizeHint*(self: gen_qabstractitemview_types.QAbstractItemView, ): QSize =
  QSize(h: fQAbstractItemView_virtualbase_sizeHint(self.h))

type QAbstractItemViewsizeHintProc* = proc(): QSize
...
proc miqt_exec_callback_QAbstractItemView_sizeHint(self: ptr cQAbstractItemView, slot: int): pointer {.exportc: "miqt_exec_callback_QAbstractItemView_sizeHint ".} =
  ...
  virtualReturn.h
proc QAbstractItemViewsetupViewport*(self: gen_qabstractitemview_types.QAbstractItemView, viewport: QWidget): void =
  fQAbstractItemView_virtualbase_setupViewport(self.h, viewport.h)

type QAbstractItemViewsetupViewportProc* = proc(viewport: QWidget): void
...
proc miqt_exec_callback_QAbstractItemView_setupViewport(self: ptr cQAbstractItemView, slot: int, viewport: pointer): void {.exportc: "miqt_exec_callback_QAbstractItemView_setupViewport ".} =
  ...
  nimfunc[](slotval1)
proc QAbstractItemViewpaintEvent*(self: gen_qabstractitemview_types.QAbstractItemView, param1: QPaintEvent): void =
  fQAbstractItemView_virtualbase_paintEvent(self.h, param1.h)

type QAbstractItemViewpaintEventProc* = proc(param1: QPaintEvent): void
...
proc miqt_exec_callback_QAbstractItemView_paintEvent(self: ptr cQAbstractItemView, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QAbstractItemView_paintEvent ".} =
  ...
  let slotval1 = QPaintEvent(h: param1)


  nimfunc[](slotval1)
proc QAbstractItemViewwheelEvent*(self: gen_qabstractitemview_types.QAbstractItemView, param1: QWheelEvent): void =
  fQAbstractItemView_virtualbase_wheelEvent(self.h, param1.h)

type QAbstractItemViewwheelEventProc* = proc(param1: QWheelEvent): void
...
proc miqt_exec_callback_QAbstractItemView_wheelEvent(self: ptr cQAbstractItemView, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QAbstractItemView_wheelEvent ".} =
  ...
  nimfunc[](slotval1)
proc QAbstractItemViewcontextMenuEvent*(self: gen_qabstractitemview_types.QAbstractItemView, param1: QContextMenuEvent): void =
  fQAbstractItemView_virtualbase_contextMenuEvent(self.h, param1.h)

type QAbstractItemViewcontextMenuEventProc* = proc(param1: QContextMenuEvent): void
...
proc miqt_exec_callback_QAbstractItemView_scrollContentsBy(self: ptr cQAbstractItemView, slot: int, dx: cint, dy: cint): void {.exportc: "miqt_exec_callback_QAbstractItemView_scrollContentsBy ".} =
  ...
  nimfunc[](slotval1, slotval2)
proc QAbstractItemViewchangeEvent*(self: gen_qabstractitemview_types.QAbstractItemView, param1: QEvent): void =
  fQAbstractItemView_virtualbase_changeEvent(self.h, param1.h)

type QAbstractItemViewchangeEventProc* = proc(param1: QEvent): void
...
proc miqt_exec_callback_QAbstractItemView_hasHeightForWidth(self: ptr cQAbstractItemView, slot: int): bool {.exportc: "miqt_exec_callback_QAbstractItemView_hasHeightForWidth ".} =
  ...
  virtualReturn
proc QAbstractItemViewpaintEngine*(self: gen_qabstractitemview_types.QAbstractItemView, ): QPaintEngine =
  QPaintEngine(h: fQAbstractItemView_virtualbase_paintEngine(self.h))

type QAbstractItemViewpaintEngineProc* = proc(): QPaintEngine
...
proc miqt_exec_callback_QAbstractItemView_paintEngine(self: ptr cQAbstractItemView, slot: int): pointer {.exportc: "miqt_exec_callback_QAbstractItemView_paintEngine ".} =
  ...
  virtualReturn.h
proc QAbstractItemViewkeyReleaseEvent*(self: gen_qabstractitemview_types.QAbstractItemView, event: QKeyEvent): void =
  fQAbstractItemView_virtualbase_keyReleaseEvent(self.h, event.h)

type QAbstractItemViewkeyReleaseEventProc* = proc(event: QKeyEvent): void
...
proc miqt_exec_callback_QAbstractItemView_keyReleaseEvent(self: ptr cQAbstractItemView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QAbstractItemView_keyReleaseEvent ".} =
  ...
  nimfunc[](slotval1)
proc QAbstractItemViewenterEvent*(self: gen_qabstractitemview_types.QAbstractItemView, event: QEvent): void =
  fQAbstractItemView_virtualbase_enterEvent(self.h, event.h)

type QAbstractItemViewenterEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QAbstractItemView_enterEvent(self: ptr cQAbstractItemView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QAbstractItemView_enterEvent ".} =
  ...
  nimfunc[](slotval1)
proc QAbstractItemViewleaveEvent*(self: gen_qabstractitemview_types.QAbstractItemView, event: QEvent): void =
  fQAbstractItemView_virtualbase_leaveEvent(self.h, event.h)

type QAbstractItemViewleaveEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QAbstractItemView_leaveEvent(self: ptr cQAbstractItemView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QAbstractItemView_leaveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QAbstractItemViewmoveEvent*(self: gen_qabstractitemview_types.QAbstractItemView, event: QMoveEvent): void =
  fQAbstractItemView_virtualbase_moveEvent(self.h, event.h)

type QAbstractItemViewmoveEventProc* = proc(event: QMoveEvent): void
...
proc miqt_exec_callback_QAbstractItemView_moveEvent(self: ptr cQAbstractItemView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QAbstractItemView_moveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QAbstractItemViewcloseEvent*(self: gen_qabstractitemview_types.QAbstractItemView, event: QCloseEvent): void =
  fQAbstractItemView_virtualbase_closeEvent(self.h, event.h)

type QAbstractItemViewcloseEventProc* = proc(event: QCloseEvent): void
...
proc miqt_exec_callback_QAbstractItemView_closeEvent(self: ptr cQAbstractItemView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QAbstractItemView_closeEvent ".} =
  ...
  nimfunc[](slotval1)
proc QAbstractItemViewtabletEvent*(self: gen_qabstractitemview_types.QAbstractItemView, event: QTabletEvent): void =
  fQAbstractItemView_virtualbase_tabletEvent(self.h, event.h)

type QAbstractItemViewtabletEventProc* = proc(event: QTabletEvent): void
...
proc miqt_exec_callback_QAbstractItemView_tabletEvent(self: ptr cQAbstractItemView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QAbstractItemView_tabletEvent ".} =
  ...
  nimfunc[](slotval1)
proc QAbstractItemViewactionEvent*(self: gen_qabstractitemview_types.QAbstractItemView, event: QActionEvent): void =
  fQAbstractItemView_virtualbase_actionEvent(self.h, event.h)

type QAbstractItemViewactionEventProc* = proc(event: QActionEvent): void
...
proc miqt_exec_callback_QAbstractItemView_actionEvent(self: ptr cQAbstractItemView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QAbstractItemView_actionEvent ".} =
  ...
  nimfunc[](slotval1)
proc QAbstractItemViewshowEvent*(self: gen_qabstractitemview_types.QAbstractItemView, event: QShowEvent): void =
  fQAbstractItemView_virtualbase_showEvent(self.h, event.h)

type QAbstractItemViewshowEventProc* = proc(event: QShowEvent): void
...
proc miqt_exec_callback_QAbstractItemView_showEvent(self: ptr cQAbstractItemView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QAbstractItemView_showEvent ".} =
  ...
  nimfunc[](slotval1)
proc QAbstractItemViewhideEvent*(self: gen_qabstractitemview_types.QAbstractItemView, event: QHideEvent): void =
  fQAbstractItemView_virtualbase_hideEvent(self.h, event.h)

type QAbstractItemViewhideEventProc* = proc(event: QHideEvent): void
...
proc miqt_exec_callback_QAbstractItemView_metric(self: ptr cQAbstractItemView, slot: int, param1: cint): cint {.exportc: "miqt_exec_callback_QAbstractItemView_metric ".} =
  ...
  virtualReturn
proc QAbstractItemViewinitPainter*(self: gen_qabstractitemview_types.QAbstractItemView, painter: QPainter): void =
  fQAbstractItemView_virtualbase_initPainter(self.h, painter.h)

type QAbstractItemViewinitPainterProc* = proc(painter: QPainter): void
...
proc miqt_exec_callback_QAbstractItemView_initPainter(self: ptr cQAbstractItemView, slot: int, painter: pointer): void {.exportc: "miqt_exec_callback_QAbstractItemView_initPainter ".} =
  ...
  nimfunc[](slotval1)
proc QAbstractItemViewredirected*(self: gen_qabstractitemview_types.QAbstractItemView, offset: QPoint): QPaintDevice =
  QPaintDevice(h: fQAbstractItemView_virtualbase_redirected(self.h, offset.h))

type QAbstractItemViewredirectedProc* = proc(offset: QPoint): QPaintDevice
...
proc miqt_exec_callback_QAbstractItemView_redirected(self: ptr cQAbstractItemView, slot: int, offset: pointer): pointer {.exportc: "miqt_exec_callback_QAbstractItemView_redirected ".} =
  ...
  virtualReturn.h
proc QAbstractItemViewsharedPainter*(self: gen_qabstractitemview_types.QAbstractItemView, ): QPainter =
  QPainter(h: fQAbstractItemView_virtualbase_sharedPainter(self.h))

type QAbstractItemViewsharedPainterProc* = proc(): QPainter
...
proc miqt_exec_callback_QAbstractItemView_sharedPainter(self: ptr cQAbstractItemView, slot: int): pointer {.exportc: "miqt_exec_callback_QAbstractItemView_sharedPainter ".} =
  ...
  virtualReturn.h
proc QAbstractItemViewchildEvent*(self: gen_qabstractitemview_types.QAbstractItemView, event: QChildEvent): void =
  fQAbstractItemView_virtualbase_childEvent(self.h, event.h)

type QAbstractItemViewchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QAbstractItemView_childEvent(self: ptr cQAbstractItemView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QAbstractItemView_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QAbstractItemViewcustomEvent*(self: gen_qabstractitemview_types.QAbstractItemView, event: QEvent): void =
  fQAbstractItemView_virtualbase_customEvent(self.h, event.h)

type QAbstractItemViewcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QAbstractItemView_customEvent(self: ptr cQAbstractItemView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QAbstractItemView_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QAbstractItemViewconnectNotify*(self: gen_qabstractitemview_types.QAbstractItemView, signal: QMetaMethod): void =
  fQAbstractItemView_virtualbase_connectNotify(self.h, signal.h)

type QAbstractItemViewconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QAbstractItemView_connectNotify(self: ptr cQAbstractItemView, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QAbstractItemView_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QAbstractItemViewdisconnectNotify*(self: gen_qabstractitemview_types.QAbstractItemView, signal: QMetaMethod): void =
  fQAbstractItemView_virtualbase_disconnectNotify(self.h, signal.h)

type QAbstractItemViewdisconnectNotifyProc* = proc(signal: QMetaMethod): void
