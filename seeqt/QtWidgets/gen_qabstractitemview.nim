...
proc itemDelegateForIndex*(self: gen_qabstractitemview_types.QAbstractItemView, index: QModelIndex): QAbstractItemDelegate =
  QAbstractItemDelegate(h: fcQAbstractItemView_itemDelegateForIndex(self.h, index.h))
...
proc miqt_exec_callback_QAbstractItemView_sizeHintForColumn(self: ptr cQAbstractItemView, slot: int, column: cint): cint {.exportc: "miqt_exec_callback_QAbstractItemView_sizeHintForColumn ".} =
  ...
  virtualReturn
proc QAbstractItemViewitemDelegateForIndex*(self: gen_qabstractitemview_types.QAbstractItemView, index: QModelIndex): QAbstractItemDelegate =
  QAbstractItemDelegate(h: fQAbstractItemView_virtualbase_itemDelegateForIndex(self.h, index.h))

type QAbstractItemViewitemDelegateForIndexProc* = proc(index: QModelIndex): QAbstractItemDelegate
...
proc miqt_exec_callback_QAbstractItemView_startDrag(self: ptr cQAbstractItemView, slot: int, supportedActions: cint): void {.exportc: "miqt_exec_callback_QAbstractItemView_startDrag ".} =
  ...
  nimfunc[](slotval1)
proc QAbstractItemViewinitViewItemOption*(self: gen_qabstractitemview_types.QAbstractItemView, option: QStyleOptionViewItem): void =
  fQAbstractItemView_virtualbase_initViewItemOption(self.h, option.h)

type QAbstractItemViewinitViewItemOptionProc* = proc(option: QStyleOptionViewItem): void
...
proc miqt_exec_callback_QAbstractItemView_changeEvent(self: ptr cQAbstractItemView, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QAbstractItemView_changeEvent ".} =
  ...
  nimfunc[](slotval1)
proc QAbstractItemViewinitStyleOption*(self: gen_qabstractitemview_types.QAbstractItemView, option: QStyleOptionFrame): void =
  fQAbstractItemView_virtualbase_initStyleOption(self.h, option.h)

type QAbstractItemViewinitStyleOptionProc* = proc(option: QStyleOptionFrame): void
...
proc miqt_exec_callback_QAbstractItemView_keyReleaseEvent(self: ptr cQAbstractItemView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QAbstractItemView_keyReleaseEvent ".} =
  ...
  nimfunc[](slotval1)
proc QAbstractItemViewenterEvent*(self: gen_qabstractitemview_types.QAbstractItemView, event: QEnterEvent): void =
  fQAbstractItemView_virtualbase_enterEvent(self.h, event.h)

type QAbstractItemViewenterEventProc* = proc(event: QEnterEvent): void
