...
proc fQCommandLinkButton_virtualbase_mouseMoveEvent(self: pointer, e: pointer): void{.importc: "QCommandLinkButton_virtualbase_mouseMoveEvent".}
...
proc fQCommandLinkButton_virtualbase_nativeEvent(self: pointer, eventType: struct_miqt_string, message: pointer, resultVal: ptr clong): bool{.importc: "QCommandLinkButton_virtualbase_nativeEvent".}
...
proc miqt_exec_callback_QCommandLinkButton_mouseReleaseEvent(self: ptr cQCommandLinkButton, slot: int, e: pointer): void {.exportc: "miqt_exec_callback_QCommandLinkButton_mouseReleaseEvent ".} =
  ...
  nimfunc[](slotval1)
proc QCommandLinkButtonmouseMoveEvent*(self: gen_qcommandlinkbutton_types.QCommandLinkButton, e: QMouseEvent): void =
  fQCommandLinkButton_virtualbase_mouseMoveEvent(self.h, e.h)

type QCommandLinkButtonmouseMoveEventProc* = proc(e: QMouseEvent): void
...
proc miqt_exec_callback_QCommandLinkButton_wheelEvent(self: ptr cQCommandLinkButton, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QCommandLinkButton_wheelEvent ".} =
  ...
  nimfunc[](slotval1)
proc QCommandLinkButtonenterEvent*(self: gen_qcommandlinkbutton_types.QCommandLinkButton, event: QEvent): void =
  fQCommandLinkButton_virtualbase_enterEvent(self.h, event.h)

type QCommandLinkButtonenterEventProc* = proc(event: QEvent): void
