...
proc indexFromItem*(self: gen_qtreewidget_types.QTreeWidget, item: QTreeWidgetItem): QModelIndex =
  QModelIndex(h: fcQTreeWidget_indexFromItem(self.h, item.h))

proc itemFromIndex*(self: gen_qtreewidget_types.QTreeWidget, index: QModelIndex): QTreeWidgetItem =
  QTreeWidgetItem(h: fcQTreeWidget_itemFromIndex(self.h, index.h))
...
proc indexFromItem*(self: gen_qtreewidget_types.QTreeWidget, item: QTreeWidgetItem, column: cint): QModelIndex =
  QModelIndex(h: fcQTreeWidget_indexFromItem2(self.h, item.h, column))
...
proc miqt_exec_callback_QTreeWidget_selectedIndexes(self: ptr cQTreeWidget, slot: int): struct_miqt_array {.exportc: "miqt_exec_callback_QTreeWidget_selectedIndexes ".} =
  ...
  struct_miqt_array(len: csize_t(len(virtualReturn)), data: if len(virtualReturn) == 0: nil else: addr(virtualReturn_CArray[0]))
proc QTreeWidgetchangeEvent*(self: gen_qtreewidget_types.QTreeWidget, event: QEvent): void =
  fQTreeWidget_virtualbase_changeEvent(self.h, event.h)

type QTreeWidgetchangeEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QTreeWidget_sizeHintForRow(self: ptr cQTreeWidget, slot: int, row: cint): cint {.exportc: "miqt_exec_callback_QTreeWidget_sizeHintForRow ".} =
  ...
  virtualReturn
proc QTreeWidgetitemDelegateForIndex*(self: gen_qtreewidget_types.QTreeWidget, index: QModelIndex): QAbstractItemDelegate =
  QAbstractItemDelegate(h: fQTreeWidget_virtualbase_itemDelegateForIndex(self.h, index.h))

type QTreeWidgetitemDelegateForIndexProc* = proc(index: QModelIndex): QAbstractItemDelegate
...
proc miqt_exec_callback_QTreeWidget_startDrag(self: ptr cQTreeWidget, slot: int, supportedActions: cint): void {.exportc: "miqt_exec_callback_QTreeWidget_startDrag ".} =
  ...
  nimfunc[](slotval1)
proc QTreeWidgetinitViewItemOption*(self: gen_qtreewidget_types.QTreeWidget, option: QStyleOptionViewItem): void =
  fQTreeWidget_virtualbase_initViewItemOption(self.h, option.h)

type QTreeWidgetinitViewItemOptionProc* = proc(option: QStyleOptionViewItem): void
...
proc miqt_exec_callback_QTreeWidget_initViewItemOption(self: ptr cQTreeWidget, slot: int, option: pointer): void {.exportc: "miqt_exec_callback_QTreeWidget_initViewItemOption ".} =
  ...
  let slotval1 = QStyleOptionViewItem(h: option)
...
proc miqt_exec_callback_QTreeWidget_contextMenuEvent(self: ptr cQTreeWidget, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QTreeWidget_contextMenuEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTreeWidgetinitStyleOption*(self: gen_qtreewidget_types.QTreeWidget, option: QStyleOptionFrame): void =
  fQTreeWidget_virtualbase_initStyleOption(self.h, option.h)

type QTreeWidgetinitStyleOptionProc* = proc(option: QStyleOptionFrame): void
...
proc miqt_exec_callback_QTreeWidget_initStyleOption(self: ptr cQTreeWidget, slot: int, option: pointer): void {.exportc: "miqt_exec_callback_QTreeWidget_initStyleOption ".} =
  ...
  let slotval1 = QStyleOptionFrame(h: option)
...
proc miqt_exec_callback_QTreeWidget_keyReleaseEvent(self: ptr cQTreeWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTreeWidget_keyReleaseEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTreeWidgetenterEvent*(self: gen_qtreewidget_types.QTreeWidget, event: QEnterEvent): void =
  fQTreeWidget_virtualbase_enterEvent(self.h, event.h)

type QTreeWidgetenterEventProc* = proc(event: QEnterEvent): void
