...
proc create*(T: type gen_qtreewidget_types.QTreeWidgetItem, treeview: QTreeWidget): gen_qtreewidget_types.QTreeWidgetItem =
  gen_qtreewidget_types.QTreeWidgetItem.init(fcQTreeWidgetItem_new3(treeview.h))

proc create*(T: type gen_qtreewidget_types.QTreeWidgetItem, treeview: QTreeWidget, strings: seq[string]): gen_qtreewidget_types.QTreeWidgetItem =
  var strings_CArray = newSeq[struct_miqt_string](len(strings))
  for i in 0..<len(strings):
    strings_CArray[i] = struct_miqt_string(data: strings[i], len: csize_t(len(strings[i])))
...
proc create*(T: type gen_qtreewidget_types.QTreeWidgetItem, treeview: QTreeWidget, after: QTreeWidgetItem): gen_qtreewidget_types.QTreeWidgetItem =
  gen_qtreewidget_types.QTreeWidgetItem.init(fcQTreeWidgetItem_new5(treeview.h, after.h))

proc create*(T: type gen_qtreewidget_types.QTreeWidgetItem, parent: QTreeWidgetItem): gen_qtreewidget_types.QTreeWidgetItem =
  gen_qtreewidget_types.QTreeWidgetItem.init(fcQTreeWidgetItem_new6(parent.h))

proc create*(T: type gen_qtreewidget_types.QTreeWidgetItem, parent: QTreeWidgetItem, strings: seq[string]): gen_qtreewidget_types.QTreeWidgetItem =
  var strings_CArray = newSeq[struct_miqt_string](len(strings))
  for i in 0..<len(strings):
    strings_CArray[i] = struct_miqt_string(data: strings[i], len: csize_t(len(strings[i])))
...
proc create*(T: type gen_qtreewidget_types.QTreeWidgetItem, parent: QTreeWidgetItem, after: QTreeWidgetItem): gen_qtreewidget_types.QTreeWidgetItem =
  gen_qtreewidget_types.QTreeWidgetItem.init(fcQTreeWidgetItem_new8(parent.h, after.h))

proc create2*(T: type gen_qtreewidget_types.QTreeWidgetItem, other: QTreeWidgetItem): gen_qtreewidget_types.QTreeWidgetItem =
...
proc create*(T: type gen_qtreewidget_types.QTreeWidgetItem, treeview: QTreeWidget, typeVal: cint): gen_qtreewidget_types.QTreeWidgetItem =
  gen_qtreewidget_types.QTreeWidgetItem.init(fcQTreeWidgetItem_new12(treeview.h, typeVal))

proc create*(T: type gen_qtreewidget_types.QTreeWidgetItem, treeview: QTreeWidget, strings: seq[string], typeVal: cint): gen_qtreewidget_types.QTreeWidgetItem =
  var strings_CArray = newSeq[struct_miqt_string](len(strings))
  for i in 0..<len(strings):
    strings_CArray[i] = struct_miqt_string(data: strings[i], len: csize_t(len(strings[i])))
...
proc create*(T: type gen_qtreewidget_types.QTreeWidgetItem, treeview: QTreeWidget, after: QTreeWidgetItem, typeVal: cint): gen_qtreewidget_types.QTreeWidgetItem =
  gen_qtreewidget_types.QTreeWidgetItem.init(fcQTreeWidgetItem_new14(treeview.h, after.h, typeVal))

proc create*(T: type gen_qtreewidget_types.QTreeWidgetItem, parent: QTreeWidgetItem, typeVal: cint): gen_qtreewidget_types.QTreeWidgetItem =
  gen_qtreewidget_types.QTreeWidgetItem.init(fcQTreeWidgetItem_new15(parent.h, typeVal))

proc create*(T: type gen_qtreewidget_types.QTreeWidgetItem, parent: QTreeWidgetItem, strings: seq[string], typeVal: cint): gen_qtreewidget_types.QTreeWidgetItem =
  var strings_CArray = newSeq[struct_miqt_string](len(strings))
  for i in 0..<len(strings):
    strings_CArray[i] = struct_miqt_string(data: strings[i], len: csize_t(len(strings[i])))
...
proc create*(T: type gen_qtreewidget_types.QTreeWidgetItem, parent: QTreeWidgetItem, after: QTreeWidgetItem, typeVal: cint): gen_qtreewidget_types.QTreeWidgetItem =
  gen_qtreewidget_types.QTreeWidgetItem.init(fcQTreeWidgetItem_new17(parent.h, after.h, typeVal))

proc clone*(self: gen_qtreewidget_types.QTreeWidgetItem, ): QTreeWidgetItem =
  QTreeWidgetItem(h: fcQTreeWidgetItem_clone(self.h))

proc treeWidget*(self: gen_qtreewidget_types.QTreeWidgetItem, ): QTreeWidget =
...
proc icon*(self: gen_qtreewidget_types.QTreeWidgetItem, column: cint): QIcon =
  QIcon(h: fcQTreeWidgetItem_icon(self.h, column))

proc setIcon*(self: gen_qtreewidget_types.QTreeWidgetItem, column: cint, icon: QIcon): void =
...
proc font*(self: gen_qtreewidget_types.QTreeWidgetItem, column: cint): QFont =
  QFont(h: fcQTreeWidgetItem_font(self.h, column))

proc setFont*(self: gen_qtreewidget_types.QTreeWidgetItem, column: cint, font: QFont): void =
...
proc backgroundColor*(self: gen_qtreewidget_types.QTreeWidgetItem, column: cint): QColor =
  QColor(h: fcQTreeWidgetItem_backgroundColor(self.h, column))

proc setBackgroundColor*(self: gen_qtreewidget_types.QTreeWidgetItem, column: cint, color: QColor): void =
  fcQTreeWidgetItem_setBackgroundColor(self.h, column, color.h)

proc background*(self: gen_qtreewidget_types.QTreeWidgetItem, column: cint): QBrush =
  QBrush(h: fcQTreeWidgetItem_background(self.h, column))

proc setBackground*(self: gen_qtreewidget_types.QTreeWidgetItem, column: cint, brush: QBrush): void =
  fcQTreeWidgetItem_setBackground(self.h, column, brush.h)

proc textColor*(self: gen_qtreewidget_types.QTreeWidgetItem, column: cint): QColor =
  QColor(h: fcQTreeWidgetItem_textColor(self.h, column))

proc setTextColor*(self: gen_qtreewidget_types.QTreeWidgetItem, column: cint, color: QColor): void =
  fcQTreeWidgetItem_setTextColor(self.h, column, color.h)

proc foreground*(self: gen_qtreewidget_types.QTreeWidgetItem, column: cint): QBrush =
  QBrush(h: fcQTreeWidgetItem_foreground(self.h, column))

proc setForeground*(self: gen_qtreewidget_types.QTreeWidgetItem, column: cint, brush: QBrush): void =
...
proc sizeHint*(self: gen_qtreewidget_types.QTreeWidgetItem, column: cint): QSize =
  QSize(h: fcQTreeWidgetItem_sizeHint(self.h, column))

proc setSizeHint*(self: gen_qtreewidget_types.QTreeWidgetItem, column: cint, size: QSize): void =
  fcQTreeWidgetItem_setSizeHint(self.h, column, size.h)

proc data*(self: gen_qtreewidget_types.QTreeWidgetItem, column: cint, role: cint): QVariant =
  QVariant(h: fcQTreeWidgetItem_data(self.h, column, role))

proc setData*(self: gen_qtreewidget_types.QTreeWidgetItem, column: cint, role: cint, value: QVariant): void =
  fcQTreeWidgetItem_setData(self.h, column, role, value.h)

proc operatorLesser*(self: gen_qtreewidget_types.QTreeWidgetItem, other: QTreeWidgetItem): bool =
  fcQTreeWidgetItem_operatorLesser(self.h, other.h)

proc read*(self: gen_qtreewidget_types.QTreeWidgetItem, inVal: QDataStream): void =
  fcQTreeWidgetItem_read(self.h, inVal.h)

proc write*(self: gen_qtreewidget_types.QTreeWidgetItem, outVal: QDataStream): void =
  fcQTreeWidgetItem_write(self.h, outVal.h)

proc operatorAssign*(self: gen_qtreewidget_types.QTreeWidgetItem, other: QTreeWidgetItem): void =
  fcQTreeWidgetItem_operatorAssign(self.h, other.h)

proc parent*(self: gen_qtreewidget_types.QTreeWidgetItem, ): QTreeWidgetItem =
  QTreeWidgetItem(h: fcQTreeWidgetItem_parent(self.h))

proc child*(self: gen_qtreewidget_types.QTreeWidgetItem, index: cint): QTreeWidgetItem =
...
proc indexOfChild*(self: gen_qtreewidget_types.QTreeWidgetItem, child: QTreeWidgetItem): cint =
  fcQTreeWidgetItem_indexOfChild(self.h, child.h)

proc addChild*(self: gen_qtreewidget_types.QTreeWidgetItem, child: QTreeWidgetItem): void =
  fcQTreeWidgetItem_addChild(self.h, child.h)

proc insertChild*(self: gen_qtreewidget_types.QTreeWidgetItem, index: cint, child: QTreeWidgetItem): void =
  fcQTreeWidgetItem_insertChild(self.h, index, child.h)

proc removeChild*(self: gen_qtreewidget_types.QTreeWidgetItem, child: QTreeWidgetItem): void =
  fcQTreeWidgetItem_removeChild(self.h, child.h)

proc takeChild*(self: gen_qtreewidget_types.QTreeWidgetItem, index: cint): QTreeWidgetItem =
  QTreeWidgetItem(h: fcQTreeWidgetItem_takeChild(self.h, index))

proc addChildren*(self: gen_qtreewidget_types.QTreeWidgetItem, children: seq[QTreeWidgetItem]): void =
...
proc insertChildren*(self: gen_qtreewidget_types.QTreeWidgetItem, index: cint, children: seq[QTreeWidgetItem]): void =
  var children_CArray = newSeq[pointer](len(children))
  for i in 0..<len(children):
    children_CArray[i] = children[i].h
...
proc takeChildren*(self: gen_qtreewidget_types.QTreeWidgetItem, ): seq[QTreeWidgetItem] =
...
proc QTreeWidgetItemclone*(self: gen_qtreewidget_types.QTreeWidgetItem, ): QTreeWidgetItem =
  QTreeWidgetItem(h: fQTreeWidgetItem_virtualbase_clone(self.h))

type QTreeWidgetItemcloneProc* = proc(): QTreeWidgetItem
...
proc miqt_exec_callback_QTreeWidgetItem_clone(self: ptr cQTreeWidgetItem, slot: int): pointer {.exportc: "miqt_exec_callback_QTreeWidgetItem_clone ".} =
  ...
  virtualReturn.h
proc QTreeWidgetItemdata*(self: gen_qtreewidget_types.QTreeWidgetItem, column: cint, role: cint): QVariant =
  QVariant(h: fQTreeWidgetItem_virtualbase_data(self.h, column, role))

type QTreeWidgetItemdataProc* = proc(column: cint, role: cint): QVariant
...
proc miqt_exec_callback_QTreeWidgetItem_data(self: ptr cQTreeWidgetItem, slot: int, column: cint, role: cint): pointer {.exportc: "miqt_exec_callback_QTreeWidgetItem_data ".} =
  ...
  virtualReturn.h
proc QTreeWidgetItemsetData*(self: gen_qtreewidget_types.QTreeWidgetItem, column: cint, role: cint, value: QVariant): void =
  fQTreeWidgetItem_virtualbase_setData(self.h, column, role, value.h)

type QTreeWidgetItemsetDataProc* = proc(column: cint, role: cint, value: QVariant): void
...
proc QTreeWidgetItemoperatorLesser*(self: gen_qtreewidget_types.QTreeWidgetItem, other: QTreeWidgetItem): bool =
  fQTreeWidgetItem_virtualbase_operatorLesser(self.h, other.h)

type QTreeWidgetItemoperatorLesserProc* = proc(other: QTreeWidgetItem): bool
...
proc miqt_exec_callback_QTreeWidgetItem_operatorLesser(self: ptr cQTreeWidgetItem, slot: int, other: pointer): bool {.exportc: "miqt_exec_callback_QTreeWidgetItem_operatorLesser ".} =
  ...
  virtualReturn
proc QTreeWidgetItemread*(self: gen_qtreewidget_types.QTreeWidgetItem, inVal: QDataStream): void =
  fQTreeWidgetItem_virtualbase_read(self.h, inVal.h)

type QTreeWidgetItemreadProc* = proc(inVal: QDataStream): void
...
proc miqt_exec_callback_QTreeWidgetItem_read(self: ptr cQTreeWidgetItem, slot: int, inVal: pointer): void {.exportc: "miqt_exec_callback_QTreeWidgetItem_read ".} =
  ...
  let slotval1 = QDataStream(h: inVal)


  nimfunc[](slotval1)
proc QTreeWidgetItemwrite*(self: gen_qtreewidget_types.QTreeWidgetItem, outVal: QDataStream): void =
  fQTreeWidgetItem_virtualbase_write(self.h, outVal.h)

type QTreeWidgetItemwriteProc* = proc(outVal: QDataStream): void
...
proc miqt_exec_callback_QTreeWidgetItem_write(self: ptr cQTreeWidgetItem, slot: int, outVal: pointer): void {.exportc: "miqt_exec_callback_QTreeWidgetItem_write ".} =
  ...
  let slotval1 = QDataStream(h: outVal)
...
func init*(T: type gen_qtreewidget_types.QTreeWidget, h: ptr cQTreeWidget): gen_qtreewidget_types.QTreeWidget =
  T(h: h)
proc create*(T: type gen_qtreewidget_types.QTreeWidget, parent: QWidget): gen_qtreewidget_types.QTreeWidget =
...
proc metaObject*(self: gen_qtreewidget_types.QTreeWidget, ): QMetaObject =
  QMetaObject(h: fcQTreeWidget_metaObject(self.h))
...
proc invisibleRootItem*(self: gen_qtreewidget_types.QTreeWidget, ): QTreeWidgetItem =
  QTreeWidgetItem(h: fcQTreeWidget_invisibleRootItem(self.h))

proc topLevelItem*(self: gen_qtreewidget_types.QTreeWidget, index: cint): QTreeWidgetItem =
...
proc insertTopLevelItem*(self: gen_qtreewidget_types.QTreeWidget, index: cint, item: QTreeWidgetItem): void =
  fcQTreeWidget_insertTopLevelItem(self.h, index, item.h)

proc addTopLevelItem*(self: gen_qtreewidget_types.QTreeWidget, item: QTreeWidgetItem): void =
  fcQTreeWidget_addTopLevelItem(self.h, item.h)

proc takeTopLevelItem*(self: gen_qtreewidget_types.QTreeWidget, index: cint): QTreeWidgetItem =
  QTreeWidgetItem(h: fcQTreeWidget_takeTopLevelItem(self.h, index))

proc indexOfTopLevelItem*(self: gen_qtreewidget_types.QTreeWidget, item: QTreeWidgetItem): cint =
  fcQTreeWidget_indexOfTopLevelItem(self.h, item.h)

proc insertTopLevelItems*(self: gen_qtreewidget_types.QTreeWidget, index: cint, items: seq[QTreeWidgetItem]): void =
...
proc addTopLevelItems*(self: gen_qtreewidget_types.QTreeWidget, items: seq[QTreeWidgetItem]): void =
  var items_CArray = newSeq[pointer](len(items))
  for i in 0..<len(items):
    items_CArray[i] = items[i].h
...
proc headerItem*(self: gen_qtreewidget_types.QTreeWidget, ): QTreeWidgetItem =
  QTreeWidgetItem(h: fcQTreeWidget_headerItem(self.h))

proc setHeaderItem*(self: gen_qtreewidget_types.QTreeWidget, item: QTreeWidgetItem): void =
...
proc currentItem*(self: gen_qtreewidget_types.QTreeWidget, ): QTreeWidgetItem =
...
proc setCurrentItem*(self: gen_qtreewidget_types.QTreeWidget, item: QTreeWidgetItem): void =
  fcQTreeWidget_setCurrentItem(self.h, item.h)

proc setCurrentItem*(self: gen_qtreewidget_types.QTreeWidget, item: QTreeWidgetItem, column: cint): void =
  fcQTreeWidget_setCurrentItem2(self.h, item.h, column)

proc setCurrentItem*(self: gen_qtreewidget_types.QTreeWidget, item: QTreeWidgetItem, column: cint, command: cint): void =
  fcQTreeWidget_setCurrentItem3(self.h, item.h, column, cint(command))

proc itemAt*(self: gen_qtreewidget_types.QTreeWidget, p: QPoint): QTreeWidgetItem =
  QTreeWidgetItem(h: fcQTreeWidget_itemAt(self.h, p.h))

proc itemAt*(self: gen_qtreewidget_types.QTreeWidget, x: cint, y: cint): QTreeWidgetItem =
  QTreeWidgetItem(h: fcQTreeWidget_itemAt2(self.h, x, y))

proc visualItemRect*(self: gen_qtreewidget_types.QTreeWidget, item: QTreeWidgetItem): QRect =
  QRect(h: fcQTreeWidget_visualItemRect(self.h, item.h))
...
proc editItem*(self: gen_qtreewidget_types.QTreeWidget, item: QTreeWidgetItem): void =
  fcQTreeWidget_editItem(self.h, item.h)

proc openPersistentEditor*(self: gen_qtreewidget_types.QTreeWidget, item: QTreeWidgetItem): void =
  fcQTreeWidget_openPersistentEditor(self.h, item.h)

proc closePersistentEditor*(self: gen_qtreewidget_types.QTreeWidget, item: QTreeWidgetItem): void =
  fcQTreeWidget_closePersistentEditor(self.h, item.h)

proc isPersistentEditorOpen*(self: gen_qtreewidget_types.QTreeWidget, item: QTreeWidgetItem): bool =
  fcQTreeWidget_isPersistentEditorOpen(self.h, item.h)

proc itemWidget*(self: gen_qtreewidget_types.QTreeWidget, item: QTreeWidgetItem, column: cint): QWidget =
  QWidget(h: fcQTreeWidget_itemWidget(self.h, item.h, column))

proc setItemWidget*(self: gen_qtreewidget_types.QTreeWidget, item: QTreeWidgetItem, column: cint, widget: QWidget): void =
  fcQTreeWidget_setItemWidget(self.h, item.h, column, widget.h)

proc removeItemWidget*(self: gen_qtreewidget_types.QTreeWidget, item: QTreeWidgetItem, column: cint): void =
  fcQTreeWidget_removeItemWidget(self.h, item.h, column)

proc isItemSelected*(self: gen_qtreewidget_types.QTreeWidget, item: QTreeWidgetItem): bool =
  fcQTreeWidget_isItemSelected(self.h, item.h)

proc setItemSelected*(self: gen_qtreewidget_types.QTreeWidget, item: QTreeWidgetItem, select: bool): void =
  fcQTreeWidget_setItemSelected(self.h, item.h, select)

proc selectedItems*(self: gen_qtreewidget_types.QTreeWidget, ): seq[QTreeWidgetItem] =
...
proc findItems*(self: gen_qtreewidget_types.QTreeWidget, text: string, flags: cint): seq[QTreeWidgetItem] =
...
proc isItemHidden*(self: gen_qtreewidget_types.QTreeWidget, item: QTreeWidgetItem): bool =
  fcQTreeWidget_isItemHidden(self.h, item.h)

proc setItemHidden*(self: gen_qtreewidget_types.QTreeWidget, item: QTreeWidgetItem, hide: bool): void =
  fcQTreeWidget_setItemHidden(self.h, item.h, hide)

proc isItemExpanded*(self: gen_qtreewidget_types.QTreeWidget, item: QTreeWidgetItem): bool =
  fcQTreeWidget_isItemExpanded(self.h, item.h)

proc setItemExpanded*(self: gen_qtreewidget_types.QTreeWidget, item: QTreeWidgetItem, expand: bool): void =
  fcQTreeWidget_setItemExpanded(self.h, item.h, expand)

proc isFirstItemColumnSpanned*(self: gen_qtreewidget_types.QTreeWidget, item: QTreeWidgetItem): bool =
  fcQTreeWidget_isFirstItemColumnSpanned(self.h, item.h)

proc setFirstItemColumnSpanned*(self: gen_qtreewidget_types.QTreeWidget, item: QTreeWidgetItem, span: bool): void =
  fcQTreeWidget_setFirstItemColumnSpanned(self.h, item.h, span)

proc itemAbove*(self: gen_qtreewidget_types.QTreeWidget, item: QTreeWidgetItem): QTreeWidgetItem =
  QTreeWidgetItem(h: fcQTreeWidget_itemAbove(self.h, item.h))

proc itemBelow*(self: gen_qtreewidget_types.QTreeWidget, item: QTreeWidgetItem): QTreeWidgetItem =
  QTreeWidgetItem(h: fcQTreeWidget_itemBelow(self.h, item.h))

proc setSelectionModel*(self: gen_qtreewidget_types.QTreeWidget, selectionModel: QItemSelectionModel): void =
  fcQTreeWidget_setSelectionModel(self.h, selectionModel.h)

proc scrollToItem*(self: gen_qtreewidget_types.QTreeWidget, item: QTreeWidgetItem): void =
  fcQTreeWidget_scrollToItem(self.h, item.h)

proc expandItem*(self: gen_qtreewidget_types.QTreeWidget, item: QTreeWidgetItem): void =
  fcQTreeWidget_expandItem(self.h, item.h)

proc collapseItem*(self: gen_qtreewidget_types.QTreeWidget, item: QTreeWidgetItem): void =
  fcQTreeWidget_collapseItem(self.h, item.h)

proc clear*(self: gen_qtreewidget_types.QTreeWidget, ): void =
  fcQTreeWidget_clear(self.h)

proc itemPressed*(self: gen_qtreewidget_types.QTreeWidget, item: QTreeWidgetItem, column: cint): void =
  fcQTreeWidget_itemPressed(self.h, item.h, column)

type QTreeWidgetitemPressedSlot* = proc(item: QTreeWidgetItem, column: cint)
...
proc itemClicked*(self: gen_qtreewidget_types.QTreeWidget, item: QTreeWidgetItem, column: cint): void =
  fcQTreeWidget_itemClicked(self.h, item.h, column)

type QTreeWidgetitemClickedSlot* = proc(item: QTreeWidgetItem, column: cint)
...
proc itemDoubleClicked*(self: gen_qtreewidget_types.QTreeWidget, item: QTreeWidgetItem, column: cint): void =
  fcQTreeWidget_itemDoubleClicked(self.h, item.h, column)

type QTreeWidgetitemDoubleClickedSlot* = proc(item: QTreeWidgetItem, column: cint)
...
proc itemActivated*(self: gen_qtreewidget_types.QTreeWidget, item: QTreeWidgetItem, column: cint): void =
  fcQTreeWidget_itemActivated(self.h, item.h, column)

type QTreeWidgetitemActivatedSlot* = proc(item: QTreeWidgetItem, column: cint)
...
proc itemEntered*(self: gen_qtreewidget_types.QTreeWidget, item: QTreeWidgetItem, column: cint): void =
  fcQTreeWidget_itemEntered(self.h, item.h, column)

type QTreeWidgetitemEnteredSlot* = proc(item: QTreeWidgetItem, column: cint)
...
proc itemChanged*(self: gen_qtreewidget_types.QTreeWidget, item: QTreeWidgetItem, column: cint): void =
  fcQTreeWidget_itemChanged(self.h, item.h, column)

type QTreeWidgetitemChangedSlot* = proc(item: QTreeWidgetItem, column: cint)
...
proc itemExpanded*(self: gen_qtreewidget_types.QTreeWidget, item: QTreeWidgetItem): void =
  fcQTreeWidget_itemExpanded(self.h, item.h)

type QTreeWidgetitemExpandedSlot* = proc(item: QTreeWidgetItem)
...
proc itemCollapsed*(self: gen_qtreewidget_types.QTreeWidget, item: QTreeWidgetItem): void =
  fcQTreeWidget_itemCollapsed(self.h, item.h)

type QTreeWidgetitemCollapsedSlot* = proc(item: QTreeWidgetItem)
...
proc currentItemChanged*(self: gen_qtreewidget_types.QTreeWidget, current: QTreeWidgetItem, previous: QTreeWidgetItem): void =
  fcQTreeWidget_currentItemChanged(self.h, current.h, previous.h)

type QTreeWidgetcurrentItemChangedSlot* = proc(current: QTreeWidgetItem, previous: QTreeWidgetItem)
...
proc editItem*(self: gen_qtreewidget_types.QTreeWidget, item: QTreeWidgetItem, column: cint): void =
  fcQTreeWidget_editItem2(self.h, item.h, column)

proc openPersistentEditor*(self: gen_qtreewidget_types.QTreeWidget, item: QTreeWidgetItem, column: cint): void =
  fcQTreeWidget_openPersistentEditor2(self.h, item.h, column)

proc closePersistentEditor*(self: gen_qtreewidget_types.QTreeWidget, item: QTreeWidgetItem, column: cint): void =
  fcQTreeWidget_closePersistentEditor2(self.h, item.h, column)

proc isPersistentEditorOpen*(self: gen_qtreewidget_types.QTreeWidget, item: QTreeWidgetItem, column: cint): bool =
  fcQTreeWidget_isPersistentEditorOpen2(self.h, item.h, column)

proc findItems*(self: gen_qtreewidget_types.QTreeWidget, text: string, flags: cint, column: cint): seq[QTreeWidgetItem] =
...
proc scrollToItem*(self: gen_qtreewidget_types.QTreeWidget, item: QTreeWidgetItem, hint: cint): void =
...
proc miqt_exec_callback_QTreeWidget_metacall(self: ptr cQTreeWidget, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QTreeWidget_metacall ".} =
  ...
  virtualReturn
proc QTreeWidgetsetSelectionModel*(self: gen_qtreewidget_types.QTreeWidget, selectionModel: QItemSelectionModel): void =
  fQTreeWidget_virtualbase_setSelectionModel(self.h, selectionModel.h)

type QTreeWidgetsetSelectionModelProc* = proc(selectionModel: QItemSelectionModel): void
...
proc miqt_exec_callback_QTreeWidget_setSelectionModel(self: ptr cQTreeWidget, slot: int, selectionModel: pointer): void {.exportc: "miqt_exec_callback_QTreeWidget_setSelectionModel ".} =
  ...
  let slotval1 = QItemSelectionModel(h: selectionModel)


  nimfunc[](slotval1)
proc QTreeWidgetevent*(self: gen_qtreewidget_types.QTreeWidget, e: QEvent): bool =
  fQTreeWidget_virtualbase_event(self.h, e.h)

type QTreeWidgeteventProc* = proc(e: QEvent): bool
...
proc QTreeWidgetmimeData*(self: gen_qtreewidget_types.QTreeWidget, items: seq[QTreeWidgetItem]): QMimeData =
  var items_CArray = newSeq[pointer](len(items))
  for i in 0..<len(items):
    items_CArray[i] = items[i].h

  QMimeData(h: fQTreeWidget_virtualbase_mimeData(self.h, struct_miqt_array(len: csize_t(len(items)), data: if len(items) == 0: nil else: addr(items_CArray[0]))))

type QTreeWidgetmimeDataProc* = proc(items: seq[QTreeWidgetItem]): QMimeData
...
proc miqt_exec_callback_QTreeWidget_mimeData(self: ptr cQTreeWidget, slot: int, items: struct_miqt_array): pointer {.exportc: "miqt_exec_callback_QTreeWidget_mimeData ".} =
  ...
  virtualReturn.h
proc QTreeWidgetdropMimeData*(self: gen_qtreewidget_types.QTreeWidget, parent: QTreeWidgetItem, index: cint, data: QMimeData, action: cint): bool =
  fQTreeWidget_virtualbase_dropMimeData(self.h, parent.h, index, data.h, cint(action))

type QTreeWidgetdropMimeDataProc* = proc(parent: QTreeWidgetItem, index: cint, data: QMimeData, action: cint): bool
...
proc miqt_exec_callback_QTreeWidget_supportedDropActions(self: ptr cQTreeWidget, slot: int): cint {.exportc: "miqt_exec_callback_QTreeWidget_supportedDropActions ".} =
  ...
  cint(virtualReturn)
proc QTreeWidgetdropEvent*(self: gen_qtreewidget_types.QTreeWidget, event: QDropEvent): void =
  fQTreeWidget_virtualbase_dropEvent(self.h, event.h)

type QTreeWidgetdropEventProc* = proc(event: QDropEvent): void
...
proc miqt_exec_callback_QTreeWidget_dropEvent(self: ptr cQTreeWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTreeWidget_dropEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTreeWidgetsetRootIndex*(self: gen_qtreewidget_types.QTreeWidget, index: QModelIndex): void =
  fQTreeWidget_virtualbase_setRootIndex(self.h, index.h)

type QTreeWidgetsetRootIndexProc* = proc(index: QModelIndex): void
...
proc miqt_exec_callback_QTreeWidget_keyboardSearch(self: ptr cQTreeWidget, slot: int, search: struct_miqt_string): void {.exportc: "miqt_exec_callback_QTreeWidget_keyboardSearch ".} =
  ...
  nimfunc[](slotval1)
proc QTreeWidgetvisualRect*(self: gen_qtreewidget_types.QTreeWidget, index: QModelIndex): QRect =
  QRect(h: fQTreeWidget_virtualbase_visualRect(self.h, index.h))

type QTreeWidgetvisualRectProc* = proc(index: QModelIndex): QRect
...
proc miqt_exec_callback_QTreeWidget_visualRect(self: ptr cQTreeWidget, slot: int, index: pointer): pointer {.exportc: "miqt_exec_callback_QTreeWidget_visualRect ".} =
  ...
  virtualReturn.h
proc QTreeWidgetscrollTo*(self: gen_qtreewidget_types.QTreeWidget, index: QModelIndex, hint: cint): void =
  fQTreeWidget_virtualbase_scrollTo(self.h, index.h, cint(hint))

type QTreeWidgetscrollToProc* = proc(index: QModelIndex, hint: cint): void
...
proc miqt_exec_callback_QTreeWidget_scrollTo(self: ptr cQTreeWidget, slot: int, index: pointer, hint: cint): void {.exportc: "miqt_exec_callback_QTreeWidget_scrollTo ".} =
  ...
  nimfunc[](slotval1, slotval2)
proc QTreeWidgetindexAt*(self: gen_qtreewidget_types.QTreeWidget, p: QPoint): QModelIndex =
  QModelIndex(h: fQTreeWidget_virtualbase_indexAt(self.h, p.h))

type QTreeWidgetindexAtProc* = proc(p: QPoint): QModelIndex
...
proc miqt_exec_callback_QTreeWidget_reset(self: ptr cQTreeWidget, slot: int): void {.exportc: "miqt_exec_callback_QTreeWidget_reset ".} =
  ...
  nimfunc[]()
proc QTreeWidgetdataChanged*(self: gen_qtreewidget_types.QTreeWidget, topLeft: QModelIndex, bottomRight: QModelIndex, roles: seq[cint]): void =
...
type QTreeWidgetdataChangedProc* = proc(topLeft: QModelIndex, bottomRight: QModelIndex, roles: seq[cint]): void
...
proc miqt_exec_callback_QTreeWidget_scrollContentsBy(self: ptr cQTreeWidget, slot: int, dx: cint, dy: cint): void {.exportc: "miqt_exec_callback_QTreeWidget_scrollContentsBy ".} =
  ...
  nimfunc[](slotval1, slotval2)
proc QTreeWidgetrowsInserted*(self: gen_qtreewidget_types.QTreeWidget, parent: QModelIndex, start: cint, endVal: cint): void =
  fQTreeWidget_virtualbase_rowsInserted(self.h, parent.h, start, endVal)

type QTreeWidgetrowsInsertedProc* = proc(parent: QModelIndex, start: cint, endVal: cint): void
...
proc miqt_exec_callback_QTreeWidget_rowsInserted(self: ptr cQTreeWidget, slot: int, parent: pointer, start: cint, endVal: cint): void {.exportc: "miqt_exec_callback_QTreeWidget_rowsInserted ".} =
  ...
  nimfunc[](slotval1, slotval2, slotval3)
proc QTreeWidgetrowsAboutToBeRemoved*(self: gen_qtreewidget_types.QTreeWidget, parent: QModelIndex, start: cint, endVal: cint): void =
  fQTreeWidget_virtualbase_rowsAboutToBeRemoved(self.h, parent.h, start, endVal)

type QTreeWidgetrowsAboutToBeRemovedProc* = proc(parent: QModelIndex, start: cint, endVal: cint): void
...
proc miqt_exec_callback_QTreeWidget_rowsAboutToBeRemoved(self: ptr cQTreeWidget, slot: int, parent: pointer, start: cint, endVal: cint): void {.exportc: "miqt_exec_callback_QTreeWidget_rowsAboutToBeRemoved ".} =
  ...
  nimfunc[](slotval1, slotval2, slotval3)
proc QTreeWidgetmoveCursor*(self: gen_qtreewidget_types.QTreeWidget, cursorAction: cint, modifiers: cint): QModelIndex =
  QModelIndex(h: fQTreeWidget_virtualbase_moveCursor(self.h, cint(cursorAction), cint(modifiers)))

type QTreeWidgetmoveCursorProc* = proc(cursorAction: cint, modifiers: cint): QModelIndex
...
proc miqt_exec_callback_QTreeWidget_verticalOffset(self: ptr cQTreeWidget, slot: int): cint {.exportc: "miqt_exec_callback_QTreeWidget_verticalOffset ".} =
  ...
  virtualReturn
proc QTreeWidgetsetSelection*(self: gen_qtreewidget_types.QTreeWidget, rect: QRect, command: cint): void =
  fQTreeWidget_virtualbase_setSelection(self.h, rect.h, cint(command))

type QTreeWidgetsetSelectionProc* = proc(rect: QRect, command: cint): void
...
proc miqt_exec_callback_QTreeWidget_setSelection(self: ptr cQTreeWidget, slot: int, rect: pointer, command: cint): void {.exportc: "miqt_exec_callback_QTreeWidget_setSelection ".} =
  ...
  let slotval1 = QRect(h: rect)

  let slotval2 = cint(command)


  nimfunc[](slotval1, slotval2)
proc QTreeWidgetvisualRegionForSelection*(self: gen_qtreewidget_types.QTreeWidget, selection: QItemSelection): QRegion =
  QRegion(h: fQTreeWidget_virtualbase_visualRegionForSelection(self.h, selection.h))

type QTreeWidgetvisualRegionForSelectionProc* = proc(selection: QItemSelection): QRegion
...
proc miqt_exec_callback_QTreeWidget_visualRegionForSelection(self: ptr cQTreeWidget, slot: int, selection: pointer): pointer {.exportc: "miqt_exec_callback_QTreeWidget_visualRegionForSelection ".} =
  ...
  virtualReturn.h
proc QTreeWidgetselectedIndexes*(self: gen_qtreewidget_types.QTreeWidget, ): seq[QModelIndex] =
...
type QTreeWidgetselectedIndexesProc* = proc(): seq[QModelIndex]
...
proc miqt_exec_callback_QTreeWidget_selectedIndexes(self: ptr cQTreeWidget, slot: int): struct_miqt_array {.exportc: "miqt_exec_callback_QTreeWidget_selectedIndexes ".} =
  ...
  struct_miqt_array(len: csize_t(len(virtualReturn)), data: if len(virtualReturn) == 0: nil else: addr(virtualReturn_CArray[0]))
proc QTreeWidgettimerEvent*(self: gen_qtreewidget_types.QTreeWidget, event: QTimerEvent): void =
  fQTreeWidget_virtualbase_timerEvent(self.h, event.h)

type QTreeWidgettimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QTreeWidget_timerEvent(self: ptr cQTreeWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTreeWidget_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTreeWidgetpaintEvent*(self: gen_qtreewidget_types.QTreeWidget, event: QPaintEvent): void =
  fQTreeWidget_virtualbase_paintEvent(self.h, event.h)

type QTreeWidgetpaintEventProc* = proc(event: QPaintEvent): void
...
proc miqt_exec_callback_QTreeWidget_paintEvent(self: ptr cQTreeWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTreeWidget_paintEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTreeWidgetdrawRow*(self: gen_qtreewidget_types.QTreeWidget, painter: QPainter, options: QStyleOptionViewItem, index: QModelIndex): void =
  fQTreeWidget_virtualbase_drawRow(self.h, painter.h, options.h, index.h)

type QTreeWidgetdrawRowProc* = proc(painter: QPainter, options: QStyleOptionViewItem, index: QModelIndex): void
...
proc miqt_exec_callback_QTreeWidget_drawRow(self: ptr cQTreeWidget, slot: int, painter: pointer, options: pointer, index: pointer): void {.exportc: "miqt_exec_callback_QTreeWidget_drawRow ".} =
  ...
  let slotval2 = QStyleOptionViewItem(h: options)

  let slotval3 = QModelIndex(h: index)


  nimfunc[](slotval1, slotval2, slotval3)
proc QTreeWidgetdrawBranches*(self: gen_qtreewidget_types.QTreeWidget, painter: QPainter, rect: QRect, index: QModelIndex): void =
  fQTreeWidget_virtualbase_drawBranches(self.h, painter.h, rect.h, index.h)

type QTreeWidgetdrawBranchesProc* = proc(painter: QPainter, rect: QRect, index: QModelIndex): void
...
proc miqt_exec_callback_QTreeWidget_drawBranches(self: ptr cQTreeWidget, slot: int, painter: pointer, rect: pointer, index: pointer): void {.exportc: "miqt_exec_callback_QTreeWidget_drawBranches ".} =
  ...
  let slotval2 = QRect(h: rect)

  let slotval3 = QModelIndex(h: index)


  nimfunc[](slotval1, slotval2, slotval3)
proc QTreeWidgetmousePressEvent*(self: gen_qtreewidget_types.QTreeWidget, event: QMouseEvent): void =
  fQTreeWidget_virtualbase_mousePressEvent(self.h, event.h)

type QTreeWidgetmousePressEventProc* = proc(event: QMouseEvent): void
...
proc miqt_exec_callback_QTreeWidget_mousePressEvent(self: ptr cQTreeWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTreeWidget_mousePressEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTreeWidgetmouseReleaseEvent*(self: gen_qtreewidget_types.QTreeWidget, event: QMouseEvent): void =
  fQTreeWidget_virtualbase_mouseReleaseEvent(self.h, event.h)

type QTreeWidgetmouseReleaseEventProc* = proc(event: QMouseEvent): void
...
proc miqt_exec_callback_QTreeWidget_mouseReleaseEvent(self: ptr cQTreeWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTreeWidget_mouseReleaseEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTreeWidgetmouseDoubleClickEvent*(self: gen_qtreewidget_types.QTreeWidget, event: QMouseEvent): void =
  fQTreeWidget_virtualbase_mouseDoubleClickEvent(self.h, event.h)

type QTreeWidgetmouseDoubleClickEventProc* = proc(event: QMouseEvent): void
...
proc miqt_exec_callback_QTreeWidget_mouseDoubleClickEvent(self: ptr cQTreeWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTreeWidget_mouseDoubleClickEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTreeWidgetmouseMoveEvent*(self: gen_qtreewidget_types.QTreeWidget, event: QMouseEvent): void =
  fQTreeWidget_virtualbase_mouseMoveEvent(self.h, event.h)

type QTreeWidgetmouseMoveEventProc* = proc(event: QMouseEvent): void
...
proc miqt_exec_callback_QTreeWidget_mouseMoveEvent(self: ptr cQTreeWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTreeWidget_mouseMoveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTreeWidgetkeyPressEvent*(self: gen_qtreewidget_types.QTreeWidget, event: QKeyEvent): void =
  fQTreeWidget_virtualbase_keyPressEvent(self.h, event.h)

type QTreeWidgetkeyPressEventProc* = proc(event: QKeyEvent): void
...
proc miqt_exec_callback_QTreeWidget_keyPressEvent(self: ptr cQTreeWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTreeWidget_keyPressEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTreeWidgetdragMoveEvent*(self: gen_qtreewidget_types.QTreeWidget, event: QDragMoveEvent): void =
  fQTreeWidget_virtualbase_dragMoveEvent(self.h, event.h)

type QTreeWidgetdragMoveEventProc* = proc(event: QDragMoveEvent): void
...
proc miqt_exec_callback_QTreeWidget_dragMoveEvent(self: ptr cQTreeWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTreeWidget_dragMoveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTreeWidgetviewportEvent*(self: gen_qtreewidget_types.QTreeWidget, event: QEvent): bool =
  fQTreeWidget_virtualbase_viewportEvent(self.h, event.h)

type QTreeWidgetviewportEventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QTreeWidget_updateGeometries(self: ptr cQTreeWidget, slot: int): void {.exportc: "miqt_exec_callback_QTreeWidget_updateGeometries ".} =
  ...
  nimfunc[]()
proc QTreeWidgetviewportSizeHint*(self: gen_qtreewidget_types.QTreeWidget, ): QSize =
  QSize(h: fQTreeWidget_virtualbase_viewportSizeHint(self.h))

type QTreeWidgetviewportSizeHintProc* = proc(): QSize
...
proc miqt_exec_callback_QTreeWidget_horizontalScrollbarAction(self: ptr cQTreeWidget, slot: int, action: cint): void {.exportc: "miqt_exec_callback_QTreeWidget_horizontalScrollbarAction ".} =
  ...
  nimfunc[](slotval1)
proc QTreeWidgetisIndexHidden*(self: gen_qtreewidget_types.QTreeWidget, index: QModelIndex): bool =
  fQTreeWidget_virtualbase_isIndexHidden(self.h, index.h)

type QTreeWidgetisIndexHiddenProc* = proc(index: QModelIndex): bool
...
proc miqt_exec_callback_QTreeWidget_isIndexHidden(self: ptr cQTreeWidget, slot: int, index: pointer): bool {.exportc: "miqt_exec_callback_QTreeWidget_isIndexHidden ".} =
  ...
  virtualReturn
proc QTreeWidgetselectionChanged*(self: gen_qtreewidget_types.QTreeWidget, selected: QItemSelection, deselected: QItemSelection): void =
  fQTreeWidget_virtualbase_selectionChanged(self.h, selected.h, deselected.h)

type QTreeWidgetselectionChangedProc* = proc(selected: QItemSelection, deselected: QItemSelection): void
...
proc miqt_exec_callback_QTreeWidget_selectionChanged(self: ptr cQTreeWidget, slot: int, selected: pointer, deselected: pointer): void {.exportc: "miqt_exec_callback_QTreeWidget_selectionChanged ".} =
  ...
  nimfunc[](slotval1, slotval2)
proc QTreeWidgetcurrentChanged*(self: gen_qtreewidget_types.QTreeWidget, current: QModelIndex, previous: QModelIndex): void =
  fQTreeWidget_virtualbase_currentChanged(self.h, current.h, previous.h)

type QTreeWidgetcurrentChangedProc* = proc(current: QModelIndex, previous: QModelIndex): void
...
proc miqt_exec_callback_QTreeWidget_currentChanged(self: ptr cQTreeWidget, slot: int, current: pointer, previous: pointer): void {.exportc: "miqt_exec_callback_QTreeWidget_currentChanged ".} =
  ...
  let slotval1 = QModelIndex(h: current)

  let slotval2 = QModelIndex(h: previous)
...
proc miqt_exec_callback_QTreeWidget_sizeHintForRow(self: ptr cQTreeWidget, slot: int, row: cint): cint {.exportc: "miqt_exec_callback_QTreeWidget_sizeHintForRow ".} =
  ...
  virtualReturn
proc QTreeWidgetinputMethodQuery*(self: gen_qtreewidget_types.QTreeWidget, query: cint): QVariant =
  QVariant(h: fQTreeWidget_virtualbase_inputMethodQuery(self.h, cint(query)))

type QTreeWidgetinputMethodQueryProc* = proc(query: cint): QVariant
...
proc miqt_exec_callback_QTreeWidget_horizontalScrollbarValueChanged(self: ptr cQTreeWidget, slot: int, value: cint): void {.exportc: "miqt_exec_callback_QTreeWidget_horizontalScrollbarValueChanged ".} =
  ...
  nimfunc[](slotval1)
proc QTreeWidgetcloseEditor*(self: gen_qtreewidget_types.QTreeWidget, editor: QWidget, hint: cint): void =
  fQTreeWidget_virtualbase_closeEditor(self.h, editor.h, cint(hint))

type QTreeWidgetcloseEditorProc* = proc(editor: QWidget, hint: cint): void
...
proc miqt_exec_callback_QTreeWidget_closeEditor(self: ptr cQTreeWidget, slot: int, editor: pointer, hint: cint): void {.exportc: "miqt_exec_callback_QTreeWidget_closeEditor ".} =
  ...
  let slotval1 = QWidget(h: editor)

  let slotval2 = cint(hint)


  nimfunc[](slotval1, slotval2)
proc QTreeWidgetcommitData*(self: gen_qtreewidget_types.QTreeWidget, editor: QWidget): void =
  fQTreeWidget_virtualbase_commitData(self.h, editor.h)

type QTreeWidgetcommitDataProc* = proc(editor: QWidget): void
...
proc miqt_exec_callback_QTreeWidget_commitData(self: ptr cQTreeWidget, slot: int, editor: pointer): void {.exportc: "miqt_exec_callback_QTreeWidget_commitData ".} =
  ...
  nimfunc[](slotval1)
proc QTreeWidgeteditorDestroyed*(self: gen_qtreewidget_types.QTreeWidget, editor: QObject): void =
  fQTreeWidget_virtualbase_editorDestroyed(self.h, editor.h)

type QTreeWidgeteditorDestroyedProc* = proc(editor: QObject): void
...
proc miqt_exec_callback_QTreeWidget_editorDestroyed(self: ptr cQTreeWidget, slot: int, editor: pointer): void {.exportc: "miqt_exec_callback_QTreeWidget_editorDestroyed ".} =
  ...
  let slotval1 = QObject(h: editor)


  nimfunc[](slotval1)
proc QTreeWidgetedit*(self: gen_qtreewidget_types.QTreeWidget, index: QModelIndex, trigger: cint, event: QEvent): bool =
  fQTreeWidget_virtualbase_edit2(self.h, index.h, cint(trigger), event.h)

type QTreeWidgetedit2Proc* = proc(index: QModelIndex, trigger: cint, event: QEvent): bool
...
proc miqt_exec_callback_QTreeWidget_edit2(self: ptr cQTreeWidget, slot: int, index: pointer, trigger: cint, event: pointer): bool {.exportc: "miqt_exec_callback_QTreeWidget_edit2 ".} =
  ...
  let slotval3 = QEvent(h: event)


  let virtualReturn = nimfunc[](slotval1, slotval2, slotval3 )

  virtualReturn
proc QTreeWidgetselectionCommand*(self: gen_qtreewidget_types.QTreeWidget, index: QModelIndex, event: QEvent): cint =
  cint(fQTreeWidget_virtualbase_selectionCommand(self.h, index.h, event.h))

type QTreeWidgetselectionCommandProc* = proc(index: QModelIndex, event: QEvent): cint
...
proc miqt_exec_callback_QTreeWidget_startDrag(self: ptr cQTreeWidget, slot: int, supportedActions: cint): void {.exportc: "miqt_exec_callback_QTreeWidget_startDrag ".} =
  ...
  nimfunc[](slotval1)
proc QTreeWidgetviewOptions*(self: gen_qtreewidget_types.QTreeWidget, ): QStyleOptionViewItem =
  QStyleOptionViewItem(h: fQTreeWidget_virtualbase_viewOptions(self.h))

type QTreeWidgetviewOptionsProc* = proc(): QStyleOptionViewItem
proc onviewOptions*(self: gen_qtreewidget_types.QTreeWidget, slot: QTreeWidgetviewOptionsProc) =
  # TODO check subclass
  var tmp = new QTreeWidgetviewOptionsProc
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QTreeWidget_viewOptions(self: ptr cQTreeWidget, slot: int): pointer {.exportc: "miqt_exec_callback_QTreeWidget_viewOptions ".} =
  var nimfunc = cast[ptr QTreeWidgetviewOptionsProc](cast[pointer](slot))
...
proc miqt_exec_callback_QTreeWidget_focusNextPrevChild(self: ptr cQTreeWidget, slot: int, next: bool): bool {.exportc: "miqt_exec_callback_QTreeWidget_focusNextPrevChild ".} =
  ...
  virtualReturn
proc QTreeWidgetdragEnterEvent*(self: gen_qtreewidget_types.QTreeWidget, event: QDragEnterEvent): void =
  fQTreeWidget_virtualbase_dragEnterEvent(self.h, event.h)

type QTreeWidgetdragEnterEventProc* = proc(event: QDragEnterEvent): void
...
proc miqt_exec_callback_QTreeWidget_dragEnterEvent(self: ptr cQTreeWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTreeWidget_dragEnterEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTreeWidgetdragLeaveEvent*(self: gen_qtreewidget_types.QTreeWidget, event: QDragLeaveEvent): void =
  fQTreeWidget_virtualbase_dragLeaveEvent(self.h, event.h)

type QTreeWidgetdragLeaveEventProc* = proc(event: QDragLeaveEvent): void
...
proc miqt_exec_callback_QTreeWidget_dragLeaveEvent(self: ptr cQTreeWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTreeWidget_dragLeaveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTreeWidgetfocusInEvent*(self: gen_qtreewidget_types.QTreeWidget, event: QFocusEvent): void =
  fQTreeWidget_virtualbase_focusInEvent(self.h, event.h)

type QTreeWidgetfocusInEventProc* = proc(event: QFocusEvent): void
...
proc miqt_exec_callback_QTreeWidget_focusInEvent(self: ptr cQTreeWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTreeWidget_focusInEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTreeWidgetfocusOutEvent*(self: gen_qtreewidget_types.QTreeWidget, event: QFocusEvent): void =
  fQTreeWidget_virtualbase_focusOutEvent(self.h, event.h)

type QTreeWidgetfocusOutEventProc* = proc(event: QFocusEvent): void
...
proc miqt_exec_callback_QTreeWidget_focusOutEvent(self: ptr cQTreeWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTreeWidget_focusOutEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTreeWidgetresizeEvent*(self: gen_qtreewidget_types.QTreeWidget, event: QResizeEvent): void =
  fQTreeWidget_virtualbase_resizeEvent(self.h, event.h)

type QTreeWidgetresizeEventProc* = proc(event: QResizeEvent): void
...
proc miqt_exec_callback_QTreeWidget_resizeEvent(self: ptr cQTreeWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTreeWidget_resizeEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTreeWidgetinputMethodEvent*(self: gen_qtreewidget_types.QTreeWidget, event: QInputMethodEvent): void =
  fQTreeWidget_virtualbase_inputMethodEvent(self.h, event.h)

type QTreeWidgetinputMethodEventProc* = proc(event: QInputMethodEvent): void
...
proc miqt_exec_callback_QTreeWidget_inputMethodEvent(self: ptr cQTreeWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTreeWidget_inputMethodEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTreeWidgeteventFilter*(self: gen_qtreewidget_types.QTreeWidget, objectVal: QObject, event: QEvent): bool =
  fQTreeWidget_virtualbase_eventFilter(self.h, objectVal.h, event.h)

type QTreeWidgeteventFilterProc* = proc(objectVal: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QTreeWidget_eventFilter(self: ptr cQTreeWidget, slot: int, objectVal: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QTreeWidget_eventFilter ".} =
  ...
  let slotval1 = QObject(h: objectVal)
  ...
  virtualReturn
proc QTreeWidgetminimumSizeHint*(self: gen_qtreewidget_types.QTreeWidget, ): QSize =
  QSize(h: fQTreeWidget_virtualbase_minimumSizeHint(self.h))

type QTreeWidgetminimumSizeHintProc* = proc(): QSize
...
proc miqt_exec_callback_QTreeWidget_minimumSizeHint(self: ptr cQTreeWidget, slot: int): pointer {.exportc: "miqt_exec_callback_QTreeWidget_minimumSizeHint ".} =
  ...
  virtualReturn.h
proc QTreeWidgetsizeHint*(self: gen_qtreewidget_types.QTreeWidget, ): QSize =
  QSize(h: fQTreeWidget_virtualbase_sizeHint(self.h))

type QTreeWidgetsizeHintProc* = proc(): QSize
...
proc miqt_exec_callback_QTreeWidget_sizeHint(self: ptr cQTreeWidget, slot: int): pointer {.exportc: "miqt_exec_callback_QTreeWidget_sizeHint ".} =
  ...
  virtualReturn.h
proc QTreeWidgetsetupViewport*(self: gen_qtreewidget_types.QTreeWidget, viewport: QWidget): void =
  fQTreeWidget_virtualbase_setupViewport(self.h, viewport.h)

type QTreeWidgetsetupViewportProc* = proc(viewport: QWidget): void
...
proc miqt_exec_callback_QTreeWidget_setupViewport(self: ptr cQTreeWidget, slot: int, viewport: pointer): void {.exportc: "miqt_exec_callback_QTreeWidget_setupViewport ".} =
  ...
  let slotval1 = QWidget(h: viewport)


  nimfunc[](slotval1)
proc QTreeWidgetwheelEvent*(self: gen_qtreewidget_types.QTreeWidget, param1: QWheelEvent): void =
  fQTreeWidget_virtualbase_wheelEvent(self.h, param1.h)

type QTreeWidgetwheelEventProc* = proc(param1: QWheelEvent): void
...
proc miqt_exec_callback_QTreeWidget_wheelEvent(self: ptr cQTreeWidget, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QTreeWidget_wheelEvent ".} =
  ...
  let slotval1 = QWheelEvent(h: param1)


  nimfunc[](slotval1)
proc QTreeWidgetcontextMenuEvent*(self: gen_qtreewidget_types.QTreeWidget, param1: QContextMenuEvent): void =
  fQTreeWidget_virtualbase_contextMenuEvent(self.h, param1.h)

type QTreeWidgetcontextMenuEventProc* = proc(param1: QContextMenuEvent): void
...
proc miqt_exec_callback_QTreeWidget_contextMenuEvent(self: ptr cQTreeWidget, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QTreeWidget_contextMenuEvent ".} =
  ...
  let slotval1 = QContextMenuEvent(h: param1)


  nimfunc[](slotval1)
proc QTreeWidgetchangeEvent*(self: gen_qtreewidget_types.QTreeWidget, param1: QEvent): void =
  fQTreeWidget_virtualbase_changeEvent(self.h, param1.h)

type QTreeWidgetchangeEventProc* = proc(param1: QEvent): void
...
proc miqt_exec_callback_QTreeWidget_hasHeightForWidth(self: ptr cQTreeWidget, slot: int): bool {.exportc: "miqt_exec_callback_QTreeWidget_hasHeightForWidth ".} =
  ...
  virtualReturn
proc QTreeWidgetpaintEngine*(self: gen_qtreewidget_types.QTreeWidget, ): QPaintEngine =
  QPaintEngine(h: fQTreeWidget_virtualbase_paintEngine(self.h))

type QTreeWidgetpaintEngineProc* = proc(): QPaintEngine
...
proc miqt_exec_callback_QTreeWidget_paintEngine(self: ptr cQTreeWidget, slot: int): pointer {.exportc: "miqt_exec_callback_QTreeWidget_paintEngine ".} =
  ...
  virtualReturn.h
proc QTreeWidgetkeyReleaseEvent*(self: gen_qtreewidget_types.QTreeWidget, event: QKeyEvent): void =
  fQTreeWidget_virtualbase_keyReleaseEvent(self.h, event.h)

type QTreeWidgetkeyReleaseEventProc* = proc(event: QKeyEvent): void
...
proc miqt_exec_callback_QTreeWidget_keyReleaseEvent(self: ptr cQTreeWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTreeWidget_keyReleaseEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTreeWidgetenterEvent*(self: gen_qtreewidget_types.QTreeWidget, event: QEvent): void =
  fQTreeWidget_virtualbase_enterEvent(self.h, event.h)

type QTreeWidgetenterEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QTreeWidget_enterEvent(self: ptr cQTreeWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTreeWidget_enterEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTreeWidgetleaveEvent*(self: gen_qtreewidget_types.QTreeWidget, event: QEvent): void =
  fQTreeWidget_virtualbase_leaveEvent(self.h, event.h)

type QTreeWidgetleaveEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QTreeWidget_leaveEvent(self: ptr cQTreeWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTreeWidget_leaveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTreeWidgetmoveEvent*(self: gen_qtreewidget_types.QTreeWidget, event: QMoveEvent): void =
  fQTreeWidget_virtualbase_moveEvent(self.h, event.h)

type QTreeWidgetmoveEventProc* = proc(event: QMoveEvent): void
...
proc miqt_exec_callback_QTreeWidget_moveEvent(self: ptr cQTreeWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTreeWidget_moveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTreeWidgetcloseEvent*(self: gen_qtreewidget_types.QTreeWidget, event: QCloseEvent): void =
  fQTreeWidget_virtualbase_closeEvent(self.h, event.h)

type QTreeWidgetcloseEventProc* = proc(event: QCloseEvent): void
...
proc miqt_exec_callback_QTreeWidget_closeEvent(self: ptr cQTreeWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTreeWidget_closeEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTreeWidgettabletEvent*(self: gen_qtreewidget_types.QTreeWidget, event: QTabletEvent): void =
  fQTreeWidget_virtualbase_tabletEvent(self.h, event.h)

type QTreeWidgettabletEventProc* = proc(event: QTabletEvent): void
...
proc miqt_exec_callback_QTreeWidget_tabletEvent(self: ptr cQTreeWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTreeWidget_tabletEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTreeWidgetactionEvent*(self: gen_qtreewidget_types.QTreeWidget, event: QActionEvent): void =
  fQTreeWidget_virtualbase_actionEvent(self.h, event.h)

type QTreeWidgetactionEventProc* = proc(event: QActionEvent): void
...
proc miqt_exec_callback_QTreeWidget_actionEvent(self: ptr cQTreeWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTreeWidget_actionEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTreeWidgetshowEvent*(self: gen_qtreewidget_types.QTreeWidget, event: QShowEvent): void =
  fQTreeWidget_virtualbase_showEvent(self.h, event.h)

type QTreeWidgetshowEventProc* = proc(event: QShowEvent): void
...
proc miqt_exec_callback_QTreeWidget_showEvent(self: ptr cQTreeWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTreeWidget_showEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTreeWidgethideEvent*(self: gen_qtreewidget_types.QTreeWidget, event: QHideEvent): void =
  fQTreeWidget_virtualbase_hideEvent(self.h, event.h)

type QTreeWidgethideEventProc* = proc(event: QHideEvent): void
...
type QTreeWidgetnativeEventProc* = proc(eventType: seq[byte], message: pointer, resultVal: ptr clong): bool
...
proc miqt_exec_callback_QTreeWidget_metric(self: ptr cQTreeWidget, slot: int, param1: cint): cint {.exportc: "miqt_exec_callback_QTreeWidget_metric ".} =
  ...
  virtualReturn
proc QTreeWidgetinitPainter*(self: gen_qtreewidget_types.QTreeWidget, painter: QPainter): void =
  fQTreeWidget_virtualbase_initPainter(self.h, painter.h)

type QTreeWidgetinitPainterProc* = proc(painter: QPainter): void
...
proc miqt_exec_callback_QTreeWidget_initPainter(self: ptr cQTreeWidget, slot: int, painter: pointer): void {.exportc: "miqt_exec_callback_QTreeWidget_initPainter ".} =
  ...
  nimfunc[](slotval1)
proc QTreeWidgetredirected*(self: gen_qtreewidget_types.QTreeWidget, offset: QPoint): QPaintDevice =
  QPaintDevice(h: fQTreeWidget_virtualbase_redirected(self.h, offset.h))

type QTreeWidgetredirectedProc* = proc(offset: QPoint): QPaintDevice
...
proc miqt_exec_callback_QTreeWidget_redirected(self: ptr cQTreeWidget, slot: int, offset: pointer): pointer {.exportc: "miqt_exec_callback_QTreeWidget_redirected ".} =
  ...
  virtualReturn.h
proc QTreeWidgetsharedPainter*(self: gen_qtreewidget_types.QTreeWidget, ): QPainter =
  QPainter(h: fQTreeWidget_virtualbase_sharedPainter(self.h))

type QTreeWidgetsharedPainterProc* = proc(): QPainter
...
proc miqt_exec_callback_QTreeWidget_sharedPainter(self: ptr cQTreeWidget, slot: int): pointer {.exportc: "miqt_exec_callback_QTreeWidget_sharedPainter ".} =
  ...
  virtualReturn.h
proc QTreeWidgetchildEvent*(self: gen_qtreewidget_types.QTreeWidget, event: QChildEvent): void =
  fQTreeWidget_virtualbase_childEvent(self.h, event.h)

type QTreeWidgetchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QTreeWidget_childEvent(self: ptr cQTreeWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTreeWidget_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTreeWidgetcustomEvent*(self: gen_qtreewidget_types.QTreeWidget, event: QEvent): void =
  fQTreeWidget_virtualbase_customEvent(self.h, event.h)

type QTreeWidgetcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QTreeWidget_customEvent(self: ptr cQTreeWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTreeWidget_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTreeWidgetconnectNotify*(self: gen_qtreewidget_types.QTreeWidget, signal: QMetaMethod): void =
  fQTreeWidget_virtualbase_connectNotify(self.h, signal.h)

type QTreeWidgetconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QTreeWidget_connectNotify(self: ptr cQTreeWidget, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QTreeWidget_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QTreeWidgetdisconnectNotify*(self: gen_qtreewidget_types.QTreeWidget, signal: QMetaMethod): void =
  fQTreeWidget_virtualbase_disconnectNotify(self.h, signal.h)

type QTreeWidgetdisconnectNotifyProc* = proc(signal: QMetaMethod): void
