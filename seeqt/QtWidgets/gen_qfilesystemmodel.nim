...
proc setIconProvider*(self: gen_qfilesystemmodel_types.QFileSystemModel, provider: QFileIconProvider): void =
  fcQFileSystemModel_setIconProvider(self.h, provider.h)

proc iconProvider*(self: gen_qfilesystemmodel_types.QFileSystemModel, ): QFileIconProvider =
  QFileIconProvider(h: fcQFileSystemModel_iconProvider(self.h))
