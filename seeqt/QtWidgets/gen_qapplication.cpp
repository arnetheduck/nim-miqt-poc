...
QMetaObject* QApplication_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQApplication*)(self) )->QApplication::metaObject();

}

void* QApplication_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQApplication*)(self) )->QApplication::qt_metacast(param1);

}

int QApplication_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQApplication*)(self) )->QApplication::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
