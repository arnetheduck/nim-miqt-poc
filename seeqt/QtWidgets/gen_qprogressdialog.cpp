...
QMetaObject* QProgressDialog_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQProgressDialog*)(self) )->QProgressDialog::metaObject();

}

void* QProgressDialog_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQProgressDialog*)(self) )->QProgressDialog::qt_metacast(param1);

}

int QProgressDialog_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQProgressDialog*)(self) )->QProgressDialog::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
bool QProgressDialog_virtualbase_nativeEvent(void* self, struct miqt_string eventType, void* message, long* result) {
	...
	return ( (MiqtVirtualQProgressDialog*)(self) )->QProgressDialog::nativeEvent(eventType_QByteArray, message, static_cast<long*>(result));
...
void QProgressDialog_protectedbase_forceShow(void* self) {
	MiqtVirtualQProgressDialog* self_cast = static_cast<MiqtVirtualQProgressDialog*>( (QProgressDialog*)(self) );
