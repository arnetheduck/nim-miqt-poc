...
void QColorDialog_connect_currentColorChanged(QColorDialog* self, intptr_t slot, void (*callback)(intptr_t, QColor*), void (*release)(intptr_t)) {
	...
	MiqtVirtualQColorDialog::connect(self, static_cast<void (QColorDialog::*)(const QColor&)>(&QColorDialog::currentColorChanged), self, caller{slot, callback, release});
}
...
void QColorDialog_connect_colorSelected(QColorDialog* self, intptr_t slot, void (*callback)(intptr_t, QColor*), void (*release)(intptr_t)) {
	...
	MiqtVirtualQColorDialog::connect(self, static_cast<void (QColorDialog::*)(const QColor&)>(&QColorDialog::colorSelected), self, caller{slot, callback, release});
}
...
QMetaObject* QColorDialog_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQColorDialog*)(self) )->QColorDialog::metaObject();

}

void* QColorDialog_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQColorDialog*)(self) )->QColorDialog::qt_metacast(param1);

}

int QColorDialog_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQColorDialog*)(self) )->QColorDialog::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
bool QColorDialog_virtualbase_nativeEvent(void* self, struct miqt_string eventType, void* message, long* result) {
	...
	return ( (MiqtVirtualQColorDialog*)(self) )->QColorDialog::nativeEvent(eventType_QByteArray, message, static_cast<long*>(result));
...
void QColorDialog_protectedbase_adjustPosition(void* self, QWidget* param1) {
	MiqtVirtualQColorDialog* self_cast = static_cast<MiqtVirtualQColorDialog*>( (QColorDialog*)(self) );
