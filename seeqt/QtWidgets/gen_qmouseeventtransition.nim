...
proc create*(T: type gen_qmouseeventtransition_types.QMouseEventTransition, objectVal: QObject, typeVal: cint, button: cint): gen_qmouseeventtransition_types.QMouseEventTransition =
...
proc create*(T: type gen_qmouseeventtransition_types.QMouseEventTransition, sourceState: QState): gen_qmouseeventtransition_types.QMouseEventTransition =
  gen_qmouseeventtransition_types.QMouseEventTransition.init(fcQMouseEventTransition_new3(sourceState.h))

proc create*(T: type gen_qmouseeventtransition_types.QMouseEventTransition, objectVal: QObject, typeVal: cint, button: cint, sourceState: QState): gen_qmouseeventtransition_types.QMouseEventTransition =
...
proc metaObject*(self: gen_qmouseeventtransition_types.QMouseEventTransition, ): QMetaObject =
  QMetaObject(h: fcQMouseEventTransition_metaObject(self.h))
...
proc hitTestPath*(self: gen_qmouseeventtransition_types.QMouseEventTransition, ): QPainterPath =
  QPainterPath(h: fcQMouseEventTransition_hitTestPath(self.h))

proc setHitTestPath*(self: gen_qmouseeventtransition_types.QMouseEventTransition, path: QPainterPath): void =
...
proc miqt_exec_callback_QMouseEventTransition_metacall(self: ptr cQMouseEventTransition, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QMouseEventTransition_metacall ".} =
  ...
  virtualReturn
proc QMouseEventTransitiononTransition*(self: gen_qmouseeventtransition_types.QMouseEventTransition, event: QEvent): void =
  fQMouseEventTransition_virtualbase_onTransition(self.h, event.h)

type QMouseEventTransitiononTransitionProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QMouseEventTransition_onTransition(self: ptr cQMouseEventTransition, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QMouseEventTransition_onTransition ".} =
  ...
  nimfunc[](slotval1)
proc QMouseEventTransitioneventTest*(self: gen_qmouseeventtransition_types.QMouseEventTransition, event: QEvent): bool =
  fQMouseEventTransition_virtualbase_eventTest(self.h, event.h)

type QMouseEventTransitioneventTestProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QMouseEventTransition_eventTest(self: ptr cQMouseEventTransition, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QMouseEventTransition_eventTest ".} =
  ...
  virtualReturn
proc QMouseEventTransitionevent*(self: gen_qmouseeventtransition_types.QMouseEventTransition, e: QEvent): bool =
  fQMouseEventTransition_virtualbase_event(self.h, e.h)

type QMouseEventTransitioneventProc* = proc(e: QEvent): bool
...
proc miqt_exec_callback_QMouseEventTransition_event(self: ptr cQMouseEventTransition, slot: int, e: pointer): bool {.exportc: "miqt_exec_callback_QMouseEventTransition_event ".} =
  ...
  virtualReturn
proc QMouseEventTransitioneventFilter*(self: gen_qmouseeventtransition_types.QMouseEventTransition, watched: QObject, event: QEvent): bool =
  fQMouseEventTransition_virtualbase_eventFilter(self.h, watched.h, event.h)

type QMouseEventTransitioneventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QMouseEventTransition_eventFilter(self: ptr cQMouseEventTransition, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QMouseEventTransition_eventFilter ".} =
  ...
  virtualReturn
proc QMouseEventTransitiontimerEvent*(self: gen_qmouseeventtransition_types.QMouseEventTransition, event: QTimerEvent): void =
  fQMouseEventTransition_virtualbase_timerEvent(self.h, event.h)

type QMouseEventTransitiontimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QMouseEventTransition_timerEvent(self: ptr cQMouseEventTransition, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QMouseEventTransition_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QMouseEventTransitionchildEvent*(self: gen_qmouseeventtransition_types.QMouseEventTransition, event: QChildEvent): void =
  fQMouseEventTransition_virtualbase_childEvent(self.h, event.h)

type QMouseEventTransitionchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QMouseEventTransition_childEvent(self: ptr cQMouseEventTransition, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QMouseEventTransition_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QMouseEventTransitioncustomEvent*(self: gen_qmouseeventtransition_types.QMouseEventTransition, event: QEvent): void =
  fQMouseEventTransition_virtualbase_customEvent(self.h, event.h)

type QMouseEventTransitioncustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QMouseEventTransition_customEvent(self: ptr cQMouseEventTransition, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QMouseEventTransition_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QMouseEventTransitionconnectNotify*(self: gen_qmouseeventtransition_types.QMouseEventTransition, signal: QMetaMethod): void =
  fQMouseEventTransition_virtualbase_connectNotify(self.h, signal.h)

type QMouseEventTransitionconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QMouseEventTransition_connectNotify(self: ptr cQMouseEventTransition, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QMouseEventTransition_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QMouseEventTransitiondisconnectNotify*(self: gen_qmouseeventtransition_types.QMouseEventTransition, signal: QMetaMethod): void =
  fQMouseEventTransition_virtualbase_disconnectNotify(self.h, signal.h)

type QMouseEventTransitiondisconnectNotifyProc* = proc(signal: QMetaMethod): void
