...
proc find*(self: gen_qplaintextedit_types.QPlainTextEdit, exp: QRegExp): bool =
...
proc find*(self: gen_qplaintextedit_types.QPlainTextEdit, exp: QRegExp, options: cint): bool =
...
proc miqt_exec_callback_QPlainTextEdit_paintEngine(self: ptr cQPlainTextEdit, slot: int): pointer {.exportc: "miqt_exec_callback_QPlainTextEdit_paintEngine ".} =
  ...
  virtualReturn.h
proc QPlainTextEditenterEvent*(self: gen_qplaintextedit_types.QPlainTextEdit, event: QEvent): void =
  fQPlainTextEdit_virtualbase_enterEvent(self.h, event.h)

type QPlainTextEditenterEventProc* = proc(event: QEvent): void
