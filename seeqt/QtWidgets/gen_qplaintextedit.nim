...
func init*(T: type gen_qplaintextedit_types.QPlainTextEdit, h: ptr cQPlainTextEdit): gen_qplaintextedit_types.QPlainTextEdit =
  T(h: h)
proc create*(T: type gen_qplaintextedit_types.QPlainTextEdit, parent: QWidget): gen_qplaintextedit_types.QPlainTextEdit =
...
proc create*(T: type gen_qplaintextedit_types.QPlainTextEdit, text: string, parent: QWidget): gen_qplaintextedit_types.QPlainTextEdit =
...
proc metaObject*(self: gen_qplaintextedit_types.QPlainTextEdit, ): QMetaObject =
  QMetaObject(h: fcQPlainTextEdit_metaObject(self.h))
...
proc setDocument*(self: gen_qplaintextedit_types.QPlainTextEdit, document: QTextDocument): void =
  fcQPlainTextEdit_setDocument(self.h, document.h)

proc document*(self: gen_qplaintextedit_types.QPlainTextEdit, ): QTextDocument =
  QTextDocument(h: fcQPlainTextEdit_document(self.h))
...
proc setTextCursor*(self: gen_qplaintextedit_types.QPlainTextEdit, cursor: QTextCursor): void =
  fcQPlainTextEdit_setTextCursor(self.h, cursor.h)

proc textCursor*(self: gen_qplaintextedit_types.QPlainTextEdit, ): QTextCursor =
  QTextCursor(h: fcQPlainTextEdit_textCursor(self.h))
...
proc mergeCurrentCharFormat*(self: gen_qplaintextedit_types.QPlainTextEdit, modifier: QTextCharFormat): void =
  fcQPlainTextEdit_mergeCurrentCharFormat(self.h, modifier.h)

proc setCurrentCharFormat*(self: gen_qplaintextedit_types.QPlainTextEdit, format: QTextCharFormat): void =
  fcQPlainTextEdit_setCurrentCharFormat(self.h, format.h)

proc currentCharFormat*(self: gen_qplaintextedit_types.QPlainTextEdit, ): QTextCharFormat =
  QTextCharFormat(h: fcQPlainTextEdit_currentCharFormat(self.h))
...
proc find*(self: gen_qplaintextedit_types.QPlainTextEdit, exp: QRegularExpression): bool =
...
proc loadResource*(self: gen_qplaintextedit_types.QPlainTextEdit, typeVal: cint, name: QUrl): QVariant =
  QVariant(h: fcQPlainTextEdit_loadResource(self.h, typeVal, name.h))

proc createStandardContextMenu*(self: gen_qplaintextedit_types.QPlainTextEdit, ): QMenu =
  QMenu(h: fcQPlainTextEdit_createStandardContextMenu(self.h))

proc createStandardContextMenu*(self: gen_qplaintextedit_types.QPlainTextEdit, position: QPoint): QMenu =
  QMenu(h: fcQPlainTextEdit_createStandardContextMenuWithPosition(self.h, position.h))

proc cursorForPosition*(self: gen_qplaintextedit_types.QPlainTextEdit, pos: QPoint): QTextCursor =
  QTextCursor(h: fcQPlainTextEdit_cursorForPosition(self.h, pos.h))

proc cursorRect*(self: gen_qplaintextedit_types.QPlainTextEdit, cursor: QTextCursor): QRect =
  QRect(h: fcQPlainTextEdit_cursorRect(self.h, cursor.h))

proc cursorRect*(self: gen_qplaintextedit_types.QPlainTextEdit, ): QRect =
  QRect(h: fcQPlainTextEdit_cursorRect2(self.h))

proc anchorAt*(self: gen_qplaintextedit_types.QPlainTextEdit, pos: QPoint): string =
...
proc setExtraSelections*(self: gen_qplaintextedit_types.QPlainTextEdit, selections: seq[QTextEditExtraSelection]): void =
...
proc extraSelections*(self: gen_qplaintextedit_types.QPlainTextEdit, ): seq[QTextEditExtraSelection] =
...
proc print*(self: gen_qplaintextedit_types.QPlainTextEdit, printer: QPagedPaintDevice): void =
...
proc inputMethodQuery*(self: gen_qplaintextedit_types.QPlainTextEdit, property: cint): QVariant =
  QVariant(h: fcQPlainTextEdit_inputMethodQuery(self.h, cint(property)))

proc inputMethodQuery*(self: gen_qplaintextedit_types.QPlainTextEdit, query: cint, argument: QVariant): QVariant =
  QVariant(h: fcQPlainTextEdit_inputMethodQuery2(self.h, cint(query), argument.h))
...
proc updateRequest*(self: gen_qplaintextedit_types.QPlainTextEdit, rect: QRect, dy: cint): void =
  fcQPlainTextEdit_updateRequest(self.h, rect.h, dy)

type QPlainTextEditupdateRequestSlot* = proc(rect: QRect, dy: cint)
...
proc find*(self: gen_qplaintextedit_types.QPlainTextEdit, exp: QRegularExpression, options: cint): bool =
...
proc miqt_exec_callback_QPlainTextEdit_metacall(self: ptr cQPlainTextEdit, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QPlainTextEdit_metacall ".} =
  ...
  virtualReturn
proc QPlainTextEditloadResource*(self: gen_qplaintextedit_types.QPlainTextEdit, typeVal: cint, name: QUrl): QVariant =
  QVariant(h: fQPlainTextEdit_virtualbase_loadResource(self.h, typeVal, name.h))

type QPlainTextEditloadResourceProc* = proc(typeVal: cint, name: QUrl): QVariant
...
proc miqt_exec_callback_QPlainTextEdit_loadResource(self: ptr cQPlainTextEdit, slot: int, typeVal: cint, name: pointer): pointer {.exportc: "miqt_exec_callback_QPlainTextEdit_loadResource ".} =
  ...
  let slotval2 = QUrl(h: name)


  let virtualReturn = nimfunc[](slotval1, slotval2 )

  virtualReturn.h
proc QPlainTextEditinputMethodQuery*(self: gen_qplaintextedit_types.QPlainTextEdit, property: cint): QVariant =
  QVariant(h: fQPlainTextEdit_virtualbase_inputMethodQuery(self.h, cint(property)))

type QPlainTextEditinputMethodQueryProc* = proc(property: cint): QVariant
...
proc miqt_exec_callback_QPlainTextEdit_inputMethodQuery(self: ptr cQPlainTextEdit, slot: int, property: cint): pointer {.exportc: "miqt_exec_callback_QPlainTextEdit_inputMethodQuery ".} =
  ...
  virtualReturn.h
proc QPlainTextEditevent*(self: gen_qplaintextedit_types.QPlainTextEdit, e: QEvent): bool =
  fQPlainTextEdit_virtualbase_event(self.h, e.h)

type QPlainTextEditeventProc* = proc(e: QEvent): bool
...
proc miqt_exec_callback_QPlainTextEdit_event(self: ptr cQPlainTextEdit, slot: int, e: pointer): bool {.exportc: "miqt_exec_callback_QPlainTextEdit_event ".} =
  ...
  virtualReturn
proc QPlainTextEdittimerEvent*(self: gen_qplaintextedit_types.QPlainTextEdit, e: QTimerEvent): void =
  fQPlainTextEdit_virtualbase_timerEvent(self.h, e.h)

type QPlainTextEdittimerEventProc* = proc(e: QTimerEvent): void
...
proc miqt_exec_callback_QPlainTextEdit_timerEvent(self: ptr cQPlainTextEdit, slot: int, e: pointer): void {.exportc: "miqt_exec_callback_QPlainTextEdit_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QPlainTextEditkeyPressEvent*(self: gen_qplaintextedit_types.QPlainTextEdit, e: QKeyEvent): void =
  fQPlainTextEdit_virtualbase_keyPressEvent(self.h, e.h)

type QPlainTextEditkeyPressEventProc* = proc(e: QKeyEvent): void
...
proc miqt_exec_callback_QPlainTextEdit_keyPressEvent(self: ptr cQPlainTextEdit, slot: int, e: pointer): void {.exportc: "miqt_exec_callback_QPlainTextEdit_keyPressEvent ".} =
  ...
  let slotval1 = QKeyEvent(h: e)


  nimfunc[](slotval1)
proc QPlainTextEditkeyReleaseEvent*(self: gen_qplaintextedit_types.QPlainTextEdit, e: QKeyEvent): void =
  fQPlainTextEdit_virtualbase_keyReleaseEvent(self.h, e.h)

type QPlainTextEditkeyReleaseEventProc* = proc(e: QKeyEvent): void
...
proc miqt_exec_callback_QPlainTextEdit_keyReleaseEvent(self: ptr cQPlainTextEdit, slot: int, e: pointer): void {.exportc: "miqt_exec_callback_QPlainTextEdit_keyReleaseEvent ".} =
  ...
  nimfunc[](slotval1)
proc QPlainTextEditresizeEvent*(self: gen_qplaintextedit_types.QPlainTextEdit, e: QResizeEvent): void =
  fQPlainTextEdit_virtualbase_resizeEvent(self.h, e.h)

type QPlainTextEditresizeEventProc* = proc(e: QResizeEvent): void
...
proc miqt_exec_callback_QPlainTextEdit_resizeEvent(self: ptr cQPlainTextEdit, slot: int, e: pointer): void {.exportc: "miqt_exec_callback_QPlainTextEdit_resizeEvent ".} =
  ...
  nimfunc[](slotval1)
proc QPlainTextEditpaintEvent*(self: gen_qplaintextedit_types.QPlainTextEdit, e: QPaintEvent): void =
  fQPlainTextEdit_virtualbase_paintEvent(self.h, e.h)

type QPlainTextEditpaintEventProc* = proc(e: QPaintEvent): void
...
proc miqt_exec_callback_QPlainTextEdit_paintEvent(self: ptr cQPlainTextEdit, slot: int, e: pointer): void {.exportc: "miqt_exec_callback_QPlainTextEdit_paintEvent ".} =
  ...
  nimfunc[](slotval1)
proc QPlainTextEditmousePressEvent*(self: gen_qplaintextedit_types.QPlainTextEdit, e: QMouseEvent): void =
  fQPlainTextEdit_virtualbase_mousePressEvent(self.h, e.h)

type QPlainTextEditmousePressEventProc* = proc(e: QMouseEvent): void
...
proc miqt_exec_callback_QPlainTextEdit_mousePressEvent(self: ptr cQPlainTextEdit, slot: int, e: pointer): void {.exportc: "miqt_exec_callback_QPlainTextEdit_mousePressEvent ".} =
  ...
  nimfunc[](slotval1)
proc QPlainTextEditmouseMoveEvent*(self: gen_qplaintextedit_types.QPlainTextEdit, e: QMouseEvent): void =
  fQPlainTextEdit_virtualbase_mouseMoveEvent(self.h, e.h)

type QPlainTextEditmouseMoveEventProc* = proc(e: QMouseEvent): void
...
proc miqt_exec_callback_QPlainTextEdit_mouseMoveEvent(self: ptr cQPlainTextEdit, slot: int, e: pointer): void {.exportc: "miqt_exec_callback_QPlainTextEdit_mouseMoveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QPlainTextEditmouseReleaseEvent*(self: gen_qplaintextedit_types.QPlainTextEdit, e: QMouseEvent): void =
  fQPlainTextEdit_virtualbase_mouseReleaseEvent(self.h, e.h)

type QPlainTextEditmouseReleaseEventProc* = proc(e: QMouseEvent): void
...
proc miqt_exec_callback_QPlainTextEdit_mouseReleaseEvent(self: ptr cQPlainTextEdit, slot: int, e: pointer): void {.exportc: "miqt_exec_callback_QPlainTextEdit_mouseReleaseEvent ".} =
  ...
  nimfunc[](slotval1)
proc QPlainTextEditmouseDoubleClickEvent*(self: gen_qplaintextedit_types.QPlainTextEdit, e: QMouseEvent): void =
  fQPlainTextEdit_virtualbase_mouseDoubleClickEvent(self.h, e.h)

type QPlainTextEditmouseDoubleClickEventProc* = proc(e: QMouseEvent): void
...
proc miqt_exec_callback_QPlainTextEdit_focusNextPrevChild(self: ptr cQPlainTextEdit, slot: int, next: bool): bool {.exportc: "miqt_exec_callback_QPlainTextEdit_focusNextPrevChild ".} =
  ...
  virtualReturn
proc QPlainTextEditcontextMenuEvent*(self: gen_qplaintextedit_types.QPlainTextEdit, e: QContextMenuEvent): void =
  fQPlainTextEdit_virtualbase_contextMenuEvent(self.h, e.h)

type QPlainTextEditcontextMenuEventProc* = proc(e: QContextMenuEvent): void
...
proc miqt_exec_callback_QPlainTextEdit_contextMenuEvent(self: ptr cQPlainTextEdit, slot: int, e: pointer): void {.exportc: "miqt_exec_callback_QPlainTextEdit_contextMenuEvent ".} =
  ...
  let slotval1 = QContextMenuEvent(h: e)


  nimfunc[](slotval1)
proc QPlainTextEditdragEnterEvent*(self: gen_qplaintextedit_types.QPlainTextEdit, e: QDragEnterEvent): void =
  fQPlainTextEdit_virtualbase_dragEnterEvent(self.h, e.h)

type QPlainTextEditdragEnterEventProc* = proc(e: QDragEnterEvent): void
...
proc miqt_exec_callback_QPlainTextEdit_dragEnterEvent(self: ptr cQPlainTextEdit, slot: int, e: pointer): void {.exportc: "miqt_exec_callback_QPlainTextEdit_dragEnterEvent ".} =
  ...
  let slotval1 = QDragEnterEvent(h: e)


  nimfunc[](slotval1)
proc QPlainTextEditdragLeaveEvent*(self: gen_qplaintextedit_types.QPlainTextEdit, e: QDragLeaveEvent): void =
  fQPlainTextEdit_virtualbase_dragLeaveEvent(self.h, e.h)

type QPlainTextEditdragLeaveEventProc* = proc(e: QDragLeaveEvent): void
...
proc miqt_exec_callback_QPlainTextEdit_dragLeaveEvent(self: ptr cQPlainTextEdit, slot: int, e: pointer): void {.exportc: "miqt_exec_callback_QPlainTextEdit_dragLeaveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QPlainTextEditdragMoveEvent*(self: gen_qplaintextedit_types.QPlainTextEdit, e: QDragMoveEvent): void =
  fQPlainTextEdit_virtualbase_dragMoveEvent(self.h, e.h)

type QPlainTextEditdragMoveEventProc* = proc(e: QDragMoveEvent): void
...
proc miqt_exec_callback_QPlainTextEdit_dragMoveEvent(self: ptr cQPlainTextEdit, slot: int, e: pointer): void {.exportc: "miqt_exec_callback_QPlainTextEdit_dragMoveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QPlainTextEditdropEvent*(self: gen_qplaintextedit_types.QPlainTextEdit, e: QDropEvent): void =
  fQPlainTextEdit_virtualbase_dropEvent(self.h, e.h)

type QPlainTextEditdropEventProc* = proc(e: QDropEvent): void
...
proc miqt_exec_callback_QPlainTextEdit_dropEvent(self: ptr cQPlainTextEdit, slot: int, e: pointer): void {.exportc: "miqt_exec_callback_QPlainTextEdit_dropEvent ".} =
  ...
  let slotval1 = QDropEvent(h: e)


  nimfunc[](slotval1)
proc QPlainTextEditfocusInEvent*(self: gen_qplaintextedit_types.QPlainTextEdit, e: QFocusEvent): void =
  fQPlainTextEdit_virtualbase_focusInEvent(self.h, e.h)

type QPlainTextEditfocusInEventProc* = proc(e: QFocusEvent): void
...
proc miqt_exec_callback_QPlainTextEdit_focusInEvent(self: ptr cQPlainTextEdit, slot: int, e: pointer): void {.exportc: "miqt_exec_callback_QPlainTextEdit_focusInEvent ".} =
  ...
  let slotval1 = QFocusEvent(h: e)


  nimfunc[](slotval1)
proc QPlainTextEditfocusOutEvent*(self: gen_qplaintextedit_types.QPlainTextEdit, e: QFocusEvent): void =
  fQPlainTextEdit_virtualbase_focusOutEvent(self.h, e.h)

type QPlainTextEditfocusOutEventProc* = proc(e: QFocusEvent): void
...
proc miqt_exec_callback_QPlainTextEdit_focusOutEvent(self: ptr cQPlainTextEdit, slot: int, e: pointer): void {.exportc: "miqt_exec_callback_QPlainTextEdit_focusOutEvent ".} =
  ...
  nimfunc[](slotval1)
proc QPlainTextEditshowEvent*(self: gen_qplaintextedit_types.QPlainTextEdit, param1: QShowEvent): void =
  fQPlainTextEdit_virtualbase_showEvent(self.h, param1.h)

type QPlainTextEditshowEventProc* = proc(param1: QShowEvent): void
...
proc miqt_exec_callback_QPlainTextEdit_showEvent(self: ptr cQPlainTextEdit, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QPlainTextEdit_showEvent ".} =
  ...
  let slotval1 = QShowEvent(h: param1)


  nimfunc[](slotval1)
proc QPlainTextEditchangeEvent*(self: gen_qplaintextedit_types.QPlainTextEdit, e: QEvent): void =
  fQPlainTextEdit_virtualbase_changeEvent(self.h, e.h)

type QPlainTextEditchangeEventProc* = proc(e: QEvent): void
...
proc miqt_exec_callback_QPlainTextEdit_changeEvent(self: ptr cQPlainTextEdit, slot: int, e: pointer): void {.exportc: "miqt_exec_callback_QPlainTextEdit_changeEvent ".} =
  ...
  nimfunc[](slotval1)
proc QPlainTextEditwheelEvent*(self: gen_qplaintextedit_types.QPlainTextEdit, e: QWheelEvent): void =
  fQPlainTextEdit_virtualbase_wheelEvent(self.h, e.h)

type QPlainTextEditwheelEventProc* = proc(e: QWheelEvent): void
...
proc miqt_exec_callback_QPlainTextEdit_wheelEvent(self: ptr cQPlainTextEdit, slot: int, e: pointer): void {.exportc: "miqt_exec_callback_QPlainTextEdit_wheelEvent ".} =
  ...
  nimfunc[](slotval1)
proc QPlainTextEditcreateMimeDataFromSelection*(self: gen_qplaintextedit_types.QPlainTextEdit, ): QMimeData =
  QMimeData(h: fQPlainTextEdit_virtualbase_createMimeDataFromSelection(self.h))

type QPlainTextEditcreateMimeDataFromSelectionProc* = proc(): QMimeData
...
proc miqt_exec_callback_QPlainTextEdit_createMimeDataFromSelection(self: ptr cQPlainTextEdit, slot: int): pointer {.exportc: "miqt_exec_callback_QPlainTextEdit_createMimeDataFromSelection ".} =
  ...
  virtualReturn.h
proc QPlainTextEditcanInsertFromMimeData*(self: gen_qplaintextedit_types.QPlainTextEdit, source: QMimeData): bool =
  fQPlainTextEdit_virtualbase_canInsertFromMimeData(self.h, source.h)

type QPlainTextEditcanInsertFromMimeDataProc* = proc(source: QMimeData): bool
...
proc miqt_exec_callback_QPlainTextEdit_canInsertFromMimeData(self: ptr cQPlainTextEdit, slot: int, source: pointer): bool {.exportc: "miqt_exec_callback_QPlainTextEdit_canInsertFromMimeData ".} =
  ...
  let slotval1 = QMimeData(h: source)


  let virtualReturn = nimfunc[](slotval1 )

  virtualReturn
proc QPlainTextEditinsertFromMimeData*(self: gen_qplaintextedit_types.QPlainTextEdit, source: QMimeData): void =
  fQPlainTextEdit_virtualbase_insertFromMimeData(self.h, source.h)

type QPlainTextEditinsertFromMimeDataProc* = proc(source: QMimeData): void
...
proc miqt_exec_callback_QPlainTextEdit_insertFromMimeData(self: ptr cQPlainTextEdit, slot: int, source: pointer): void {.exportc: "miqt_exec_callback_QPlainTextEdit_insertFromMimeData ".} =
  ...
  nimfunc[](slotval1)
proc QPlainTextEditinputMethodEvent*(self: gen_qplaintextedit_types.QPlainTextEdit, param1: QInputMethodEvent): void =
  fQPlainTextEdit_virtualbase_inputMethodEvent(self.h, param1.h)

type QPlainTextEditinputMethodEventProc* = proc(param1: QInputMethodEvent): void
...
proc miqt_exec_callback_QPlainTextEdit_scrollContentsBy(self: ptr cQPlainTextEdit, slot: int, dx: cint, dy: cint): void {.exportc: "miqt_exec_callback_QPlainTextEdit_scrollContentsBy ".} =
  ...
  nimfunc[](slotval1, slotval2)
proc QPlainTextEditdoSetTextCursor*(self: gen_qplaintextedit_types.QPlainTextEdit, cursor: QTextCursor): void =
  fQPlainTextEdit_virtualbase_doSetTextCursor(self.h, cursor.h)

type QPlainTextEditdoSetTextCursorProc* = proc(cursor: QTextCursor): void
...
proc miqt_exec_callback_QPlainTextEdit_doSetTextCursor(self: ptr cQPlainTextEdit, slot: int, cursor: pointer): void {.exportc: "miqt_exec_callback_QPlainTextEdit_doSetTextCursor ".} =
  ...
  let slotval1 = QTextCursor(h: cursor)


  nimfunc[](slotval1)
proc QPlainTextEditminimumSizeHint*(self: gen_qplaintextedit_types.QPlainTextEdit, ): QSize =
  QSize(h: fQPlainTextEdit_virtualbase_minimumSizeHint(self.h))

type QPlainTextEditminimumSizeHintProc* = proc(): QSize
...
proc miqt_exec_callback_QPlainTextEdit_minimumSizeHint(self: ptr cQPlainTextEdit, slot: int): pointer {.exportc: "miqt_exec_callback_QPlainTextEdit_minimumSizeHint ".} =
  ...
  virtualReturn.h
proc QPlainTextEditsizeHint*(self: gen_qplaintextedit_types.QPlainTextEdit, ): QSize =
  QSize(h: fQPlainTextEdit_virtualbase_sizeHint(self.h))

type QPlainTextEditsizeHintProc* = proc(): QSize
...
proc miqt_exec_callback_QPlainTextEdit_sizeHint(self: ptr cQPlainTextEdit, slot: int): pointer {.exportc: "miqt_exec_callback_QPlainTextEdit_sizeHint ".} =
  ...
  virtualReturn.h
proc QPlainTextEditsetupViewport*(self: gen_qplaintextedit_types.QPlainTextEdit, viewport: QWidget): void =
  fQPlainTextEdit_virtualbase_setupViewport(self.h, viewport.h)

type QPlainTextEditsetupViewportProc* = proc(viewport: QWidget): void
...
proc miqt_exec_callback_QPlainTextEdit_setupViewport(self: ptr cQPlainTextEdit, slot: int, viewport: pointer): void {.exportc: "miqt_exec_callback_QPlainTextEdit_setupViewport ".} =
  ...
  nimfunc[](slotval1)
proc QPlainTextEditeventFilter*(self: gen_qplaintextedit_types.QPlainTextEdit, param1: QObject, param2: QEvent): bool =
  fQPlainTextEdit_virtualbase_eventFilter(self.h, param1.h, param2.h)

type QPlainTextEditeventFilterProc* = proc(param1: QObject, param2: QEvent): bool
...
proc miqt_exec_callback_QPlainTextEdit_eventFilter(self: ptr cQPlainTextEdit, slot: int, param1: pointer, param2: pointer): bool {.exportc: "miqt_exec_callback_QPlainTextEdit_eventFilter ".} =
  ...
  let slotval2 = QEvent(h: param2)


  let virtualReturn = nimfunc[](slotval1, slotval2 )

  virtualReturn
proc QPlainTextEditviewportEvent*(self: gen_qplaintextedit_types.QPlainTextEdit, param1: QEvent): bool =
  fQPlainTextEdit_virtualbase_viewportEvent(self.h, param1.h)

type QPlainTextEditviewportEventProc* = proc(param1: QEvent): bool
...
proc miqt_exec_callback_QPlainTextEdit_viewportEvent(self: ptr cQPlainTextEdit, slot: int, param1: pointer): bool {.exportc: "miqt_exec_callback_QPlainTextEdit_viewportEvent ".} =
  ...
  virtualReturn
proc QPlainTextEditviewportSizeHint*(self: gen_qplaintextedit_types.QPlainTextEdit, ): QSize =
  QSize(h: fQPlainTextEdit_virtualbase_viewportSizeHint(self.h))

type QPlainTextEditviewportSizeHintProc* = proc(): QSize
...
proc miqt_exec_callback_QPlainTextEdit_viewportSizeHint(self: ptr cQPlainTextEdit, slot: int): pointer {.exportc: "miqt_exec_callback_QPlainTextEdit_viewportSizeHint ".} =
  ...
  virtualReturn.h
proc QPlainTextEditinitStyleOption*(self: gen_qplaintextedit_types.QPlainTextEdit, option: QStyleOptionFrame): void =
  fQPlainTextEdit_virtualbase_initStyleOption(self.h, option.h)

type QPlainTextEditinitStyleOptionProc* = proc(option: QStyleOptionFrame): void
...
proc miqt_exec_callback_QPlainTextEdit_hasHeightForWidth(self: ptr cQPlainTextEdit, slot: int): bool {.exportc: "miqt_exec_callback_QPlainTextEdit_hasHeightForWidth ".} =
  ...
  virtualReturn
proc QPlainTextEditpaintEngine*(self: gen_qplaintextedit_types.QPlainTextEdit, ): QPaintEngine =
  QPaintEngine(h: fQPlainTextEdit_virtualbase_paintEngine(self.h))

type QPlainTextEditpaintEngineProc* = proc(): QPaintEngine
...
proc miqt_exec_callback_QPlainTextEdit_paintEngine(self: ptr cQPlainTextEdit, slot: int): pointer {.exportc: "miqt_exec_callback_QPlainTextEdit_paintEngine ".} =
  ...
  virtualReturn.h
proc QPlainTextEditenterEvent*(self: gen_qplaintextedit_types.QPlainTextEdit, event: QEnterEvent): void =
  fQPlainTextEdit_virtualbase_enterEvent(self.h, event.h)

type QPlainTextEditenterEventProc* = proc(event: QEnterEvent): void
...
proc miqt_exec_callback_QPlainTextEdit_enterEvent(self: ptr cQPlainTextEdit, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QPlainTextEdit_enterEvent ".} =
  ...
  nimfunc[](slotval1)
proc QPlainTextEditleaveEvent*(self: gen_qplaintextedit_types.QPlainTextEdit, event: QEvent): void =
  fQPlainTextEdit_virtualbase_leaveEvent(self.h, event.h)

type QPlainTextEditleaveEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QPlainTextEdit_leaveEvent(self: ptr cQPlainTextEdit, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QPlainTextEdit_leaveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QPlainTextEditmoveEvent*(self: gen_qplaintextedit_types.QPlainTextEdit, event: QMoveEvent): void =
  fQPlainTextEdit_virtualbase_moveEvent(self.h, event.h)

type QPlainTextEditmoveEventProc* = proc(event: QMoveEvent): void
...
proc miqt_exec_callback_QPlainTextEdit_moveEvent(self: ptr cQPlainTextEdit, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QPlainTextEdit_moveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QPlainTextEditcloseEvent*(self: gen_qplaintextedit_types.QPlainTextEdit, event: QCloseEvent): void =
  fQPlainTextEdit_virtualbase_closeEvent(self.h, event.h)

type QPlainTextEditcloseEventProc* = proc(event: QCloseEvent): void
...
proc miqt_exec_callback_QPlainTextEdit_closeEvent(self: ptr cQPlainTextEdit, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QPlainTextEdit_closeEvent ".} =
  ...
  nimfunc[](slotval1)
proc QPlainTextEdittabletEvent*(self: gen_qplaintextedit_types.QPlainTextEdit, event: QTabletEvent): void =
  fQPlainTextEdit_virtualbase_tabletEvent(self.h, event.h)

type QPlainTextEdittabletEventProc* = proc(event: QTabletEvent): void
...
proc miqt_exec_callback_QPlainTextEdit_tabletEvent(self: ptr cQPlainTextEdit, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QPlainTextEdit_tabletEvent ".} =
  ...
  nimfunc[](slotval1)
proc QPlainTextEditactionEvent*(self: gen_qplaintextedit_types.QPlainTextEdit, event: QActionEvent): void =
  fQPlainTextEdit_virtualbase_actionEvent(self.h, event.h)

type QPlainTextEditactionEventProc* = proc(event: QActionEvent): void
...
proc miqt_exec_callback_QPlainTextEdit_actionEvent(self: ptr cQPlainTextEdit, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QPlainTextEdit_actionEvent ".} =
  ...
  nimfunc[](slotval1)
proc QPlainTextEdithideEvent*(self: gen_qplaintextedit_types.QPlainTextEdit, event: QHideEvent): void =
  fQPlainTextEdit_virtualbase_hideEvent(self.h, event.h)

type QPlainTextEdithideEventProc* = proc(event: QHideEvent): void
...
proc miqt_exec_callback_QPlainTextEdit_metric(self: ptr cQPlainTextEdit, slot: int, param1: cint): cint {.exportc: "miqt_exec_callback_QPlainTextEdit_metric ".} =
  ...
  virtualReturn
proc QPlainTextEditinitPainter*(self: gen_qplaintextedit_types.QPlainTextEdit, painter: QPainter): void =
  fQPlainTextEdit_virtualbase_initPainter(self.h, painter.h)

type QPlainTextEditinitPainterProc* = proc(painter: QPainter): void
...
proc miqt_exec_callback_QPlainTextEdit_initPainter(self: ptr cQPlainTextEdit, slot: int, painter: pointer): void {.exportc: "miqt_exec_callback_QPlainTextEdit_initPainter ".} =
  ...
  nimfunc[](slotval1)
proc QPlainTextEditredirected*(self: gen_qplaintextedit_types.QPlainTextEdit, offset: QPoint): QPaintDevice =
  QPaintDevice(h: fQPlainTextEdit_virtualbase_redirected(self.h, offset.h))

type QPlainTextEditredirectedProc* = proc(offset: QPoint): QPaintDevice
...
proc miqt_exec_callback_QPlainTextEdit_redirected(self: ptr cQPlainTextEdit, slot: int, offset: pointer): pointer {.exportc: "miqt_exec_callback_QPlainTextEdit_redirected ".} =
  ...
  virtualReturn.h
proc QPlainTextEditsharedPainter*(self: gen_qplaintextedit_types.QPlainTextEdit, ): QPainter =
  QPainter(h: fQPlainTextEdit_virtualbase_sharedPainter(self.h))

type QPlainTextEditsharedPainterProc* = proc(): QPainter
...
proc miqt_exec_callback_QPlainTextEdit_sharedPainter(self: ptr cQPlainTextEdit, slot: int): pointer {.exportc: "miqt_exec_callback_QPlainTextEdit_sharedPainter ".} =
  ...
  virtualReturn.h
proc QPlainTextEditchildEvent*(self: gen_qplaintextedit_types.QPlainTextEdit, event: QChildEvent): void =
  fQPlainTextEdit_virtualbase_childEvent(self.h, event.h)

type QPlainTextEditchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QPlainTextEdit_childEvent(self: ptr cQPlainTextEdit, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QPlainTextEdit_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QPlainTextEditcustomEvent*(self: gen_qplaintextedit_types.QPlainTextEdit, event: QEvent): void =
  fQPlainTextEdit_virtualbase_customEvent(self.h, event.h)

type QPlainTextEditcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QPlainTextEdit_customEvent(self: ptr cQPlainTextEdit, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QPlainTextEdit_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QPlainTextEditconnectNotify*(self: gen_qplaintextedit_types.QPlainTextEdit, signal: QMetaMethod): void =
  fQPlainTextEdit_virtualbase_connectNotify(self.h, signal.h)

type QPlainTextEditconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QPlainTextEdit_connectNotify(self: ptr cQPlainTextEdit, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QPlainTextEdit_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QPlainTextEditdisconnectNotify*(self: gen_qplaintextedit_types.QPlainTextEdit, signal: QMetaMethod): void =
  fQPlainTextEdit_virtualbase_disconnectNotify(self.h, signal.h)

type QPlainTextEditdisconnectNotifyProc* = proc(signal: QMetaMethod): void
...
func init*(T: type gen_qplaintextedit_types.QPlainTextDocumentLayout, h: ptr cQPlainTextDocumentLayout): gen_qplaintextedit_types.QPlainTextDocumentLayout =
  T(h: h)
proc create*(T: type gen_qplaintextedit_types.QPlainTextDocumentLayout, document: QTextDocument): gen_qplaintextedit_types.QPlainTextDocumentLayout =
  gen_qplaintextedit_types.QPlainTextDocumentLayout.init(fcQPlainTextDocumentLayout_new(document.h))

proc metaObject*(self: gen_qplaintextedit_types.QPlainTextDocumentLayout, ): QMetaObject =
  QMetaObject(h: fcQPlainTextDocumentLayout_metaObject(self.h))
...
proc draw*(self: gen_qplaintextedit_types.QPlainTextDocumentLayout, param1: QPainter, param2: QAbstractTextDocumentLayoutPaintContext): void =
  fcQPlainTextDocumentLayout_draw(self.h, param1.h, param2.h)

proc hitTest*(self: gen_qplaintextedit_types.QPlainTextDocumentLayout, param1: QPointF, param2: cint): cint =
...
proc documentSize*(self: gen_qplaintextedit_types.QPlainTextDocumentLayout, ): QSizeF =
  QSizeF(h: fcQPlainTextDocumentLayout_documentSize(self.h))

proc frameBoundingRect*(self: gen_qplaintextedit_types.QPlainTextDocumentLayout, param1: QTextFrame): QRectF =
  QRectF(h: fcQPlainTextDocumentLayout_frameBoundingRect(self.h, param1.h))

proc blockBoundingRect*(self: gen_qplaintextedit_types.QPlainTextDocumentLayout, blockVal: QTextBlock): QRectF =
  QRectF(h: fcQPlainTextDocumentLayout_blockBoundingRect(self.h, blockVal.h))

proc ensureBlockLayout*(self: gen_qplaintextedit_types.QPlainTextDocumentLayout, blockVal: QTextBlock): void =
...
proc miqt_exec_callback_QPlainTextDocumentLayout_metacall(self: ptr cQPlainTextDocumentLayout, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QPlainTextDocumentLayout_metacall ".} =
  ...
  virtualReturn
proc QPlainTextDocumentLayoutdraw*(self: gen_qplaintextedit_types.QPlainTextDocumentLayout, param1: QPainter, param2: QAbstractTextDocumentLayoutPaintContext): void =
  fQPlainTextDocumentLayout_virtualbase_draw(self.h, param1.h, param2.h)

type QPlainTextDocumentLayoutdrawProc* = proc(param1: QPainter, param2: QAbstractTextDocumentLayoutPaintContext): void
...
proc miqt_exec_callback_QPlainTextDocumentLayout_draw(self: ptr cQPlainTextDocumentLayout, slot: int, param1: pointer, param2: pointer): void {.exportc: "miqt_exec_callback_QPlainTextDocumentLayout_draw ".} =
  ...
  let slotval1 = QPainter(h: param1)

  let slotval2 = QAbstractTextDocumentLayoutPaintContext(h: param2)


  nimfunc[](slotval1, slotval2)
proc QPlainTextDocumentLayouthitTest*(self: gen_qplaintextedit_types.QPlainTextDocumentLayout, param1: QPointF, param2: cint): cint =
  fQPlainTextDocumentLayout_virtualbase_hitTest(self.h, param1.h, cint(param2))

type QPlainTextDocumentLayouthitTestProc* = proc(param1: QPointF, param2: cint): cint
...
proc miqt_exec_callback_QPlainTextDocumentLayout_pageCount(self: ptr cQPlainTextDocumentLayout, slot: int): cint {.exportc: "miqt_exec_callback_QPlainTextDocumentLayout_pageCount ".} =
  ...
  virtualReturn
proc QPlainTextDocumentLayoutdocumentSize*(self: gen_qplaintextedit_types.QPlainTextDocumentLayout, ): QSizeF =
  QSizeF(h: fQPlainTextDocumentLayout_virtualbase_documentSize(self.h))

type QPlainTextDocumentLayoutdocumentSizeProc* = proc(): QSizeF
...
proc miqt_exec_callback_QPlainTextDocumentLayout_documentSize(self: ptr cQPlainTextDocumentLayout, slot: int): pointer {.exportc: "miqt_exec_callback_QPlainTextDocumentLayout_documentSize ".} =
  ...
  virtualReturn.h
proc QPlainTextDocumentLayoutframeBoundingRect*(self: gen_qplaintextedit_types.QPlainTextDocumentLayout, param1: QTextFrame): QRectF =
  QRectF(h: fQPlainTextDocumentLayout_virtualbase_frameBoundingRect(self.h, param1.h))

type QPlainTextDocumentLayoutframeBoundingRectProc* = proc(param1: QTextFrame): QRectF
...
proc miqt_exec_callback_QPlainTextDocumentLayout_frameBoundingRect(self: ptr cQPlainTextDocumentLayout, slot: int, param1: pointer): pointer {.exportc: "miqt_exec_callback_QPlainTextDocumentLayout_frameBoundingRect ".} =
  ...
  let slotval1 = QTextFrame(h: param1)


  let virtualReturn = nimfunc[](slotval1 )

  virtualReturn.h
proc QPlainTextDocumentLayoutblockBoundingRect*(self: gen_qplaintextedit_types.QPlainTextDocumentLayout, blockVal: QTextBlock): QRectF =
  QRectF(h: fQPlainTextDocumentLayout_virtualbase_blockBoundingRect(self.h, blockVal.h))

type QPlainTextDocumentLayoutblockBoundingRectProc* = proc(blockVal: QTextBlock): QRectF
...
proc miqt_exec_callback_QPlainTextDocumentLayout_blockBoundingRect(self: ptr cQPlainTextDocumentLayout, slot: int, blockVal: pointer): pointer {.exportc: "miqt_exec_callback_QPlainTextDocumentLayout_blockBoundingRect ".} =
  ...
  let slotval1 = QTextBlock(h: blockVal)
...
proc QPlainTextDocumentLayoutresizeInlineObject*(self: gen_qplaintextedit_types.QPlainTextDocumentLayout, item: QTextInlineObject, posInDocument: cint, format: QTextFormat): void =
  fQPlainTextDocumentLayout_virtualbase_resizeInlineObject(self.h, item.h, posInDocument, format.h)

type QPlainTextDocumentLayoutresizeInlineObjectProc* = proc(item: QTextInlineObject, posInDocument: cint, format: QTextFormat): void
...
proc miqt_exec_callback_QPlainTextDocumentLayout_resizeInlineObject(self: ptr cQPlainTextDocumentLayout, slot: int, item: pointer, posInDocument: cint, format: pointer): void {.exportc: "miqt_exec_callback_QPlainTextDocumentLayout_resizeInlineObject ".} =
  ...
  let slotval1 = QTextInlineObject(h: item)

  let slotval2 = posInDocument

  let slotval3 = QTextFormat(h: format)


  nimfunc[](slotval1, slotval2, slotval3)
proc QPlainTextDocumentLayoutpositionInlineObject*(self: gen_qplaintextedit_types.QPlainTextDocumentLayout, item: QTextInlineObject, posInDocument: cint, format: QTextFormat): void =
  fQPlainTextDocumentLayout_virtualbase_positionInlineObject(self.h, item.h, posInDocument, format.h)

type QPlainTextDocumentLayoutpositionInlineObjectProc* = proc(item: QTextInlineObject, posInDocument: cint, format: QTextFormat): void
...
proc miqt_exec_callback_QPlainTextDocumentLayout_positionInlineObject(self: ptr cQPlainTextDocumentLayout, slot: int, item: pointer, posInDocument: cint, format: pointer): void {.exportc: "miqt_exec_callback_QPlainTextDocumentLayout_positionInlineObject ".} =
  ...
  nimfunc[](slotval1, slotval2, slotval3)
proc QPlainTextDocumentLayoutdrawInlineObject*(self: gen_qplaintextedit_types.QPlainTextDocumentLayout, painter: QPainter, rect: QRectF, objectVal: QTextInlineObject, posInDocument: cint, format: QTextFormat): void =
  fQPlainTextDocumentLayout_virtualbase_drawInlineObject(self.h, painter.h, rect.h, objectVal.h, posInDocument, format.h)

type QPlainTextDocumentLayoutdrawInlineObjectProc* = proc(painter: QPainter, rect: QRectF, objectVal: QTextInlineObject, posInDocument: cint, format: QTextFormat): void
...
proc miqt_exec_callback_QPlainTextDocumentLayout_drawInlineObject(self: ptr cQPlainTextDocumentLayout, slot: int, painter: pointer, rect: pointer, objectVal: pointer, posInDocument: cint, format: pointer): void {.exportc: "miqt_exec_callback_QPlainTextDocumentLayout_drawInlineObject ".} =
  ...
  let slotval3 = QTextInlineObject(h: objectVal)

  let slotval4 = posInDocument

  let slotval5 = QTextFormat(h: format)


  nimfunc[](slotval1, slotval2, slotval3, slotval4, slotval5)
proc QPlainTextDocumentLayoutevent*(self: gen_qplaintextedit_types.QPlainTextDocumentLayout, event: QEvent): bool =
  fQPlainTextDocumentLayout_virtualbase_event(self.h, event.h)

type QPlainTextDocumentLayouteventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QPlainTextDocumentLayout_event(self: ptr cQPlainTextDocumentLayout, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QPlainTextDocumentLayout_event ".} =
  ...
  virtualReturn
proc QPlainTextDocumentLayouteventFilter*(self: gen_qplaintextedit_types.QPlainTextDocumentLayout, watched: QObject, event: QEvent): bool =
  fQPlainTextDocumentLayout_virtualbase_eventFilter(self.h, watched.h, event.h)

type QPlainTextDocumentLayouteventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QPlainTextDocumentLayout_eventFilter(self: ptr cQPlainTextDocumentLayout, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QPlainTextDocumentLayout_eventFilter ".} =
  ...
  virtualReturn
proc QPlainTextDocumentLayouttimerEvent*(self: gen_qplaintextedit_types.QPlainTextDocumentLayout, event: QTimerEvent): void =
  fQPlainTextDocumentLayout_virtualbase_timerEvent(self.h, event.h)

type QPlainTextDocumentLayouttimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QPlainTextDocumentLayout_timerEvent(self: ptr cQPlainTextDocumentLayout, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QPlainTextDocumentLayout_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QPlainTextDocumentLayoutchildEvent*(self: gen_qplaintextedit_types.QPlainTextDocumentLayout, event: QChildEvent): void =
  fQPlainTextDocumentLayout_virtualbase_childEvent(self.h, event.h)

type QPlainTextDocumentLayoutchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QPlainTextDocumentLayout_childEvent(self: ptr cQPlainTextDocumentLayout, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QPlainTextDocumentLayout_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QPlainTextDocumentLayoutcustomEvent*(self: gen_qplaintextedit_types.QPlainTextDocumentLayout, event: QEvent): void =
  fQPlainTextDocumentLayout_virtualbase_customEvent(self.h, event.h)

type QPlainTextDocumentLayoutcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QPlainTextDocumentLayout_customEvent(self: ptr cQPlainTextDocumentLayout, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QPlainTextDocumentLayout_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QPlainTextDocumentLayoutconnectNotify*(self: gen_qplaintextedit_types.QPlainTextDocumentLayout, signal: QMetaMethod): void =
  fQPlainTextDocumentLayout_virtualbase_connectNotify(self.h, signal.h)

type QPlainTextDocumentLayoutconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QPlainTextDocumentLayout_connectNotify(self: ptr cQPlainTextDocumentLayout, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QPlainTextDocumentLayout_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QPlainTextDocumentLayoutdisconnectNotify*(self: gen_qplaintextedit_types.QPlainTextDocumentLayout, signal: QMetaMethod): void =
  fQPlainTextDocumentLayout_virtualbase_disconnectNotify(self.h, signal.h)

type QPlainTextDocumentLayoutdisconnectNotifyProc* = proc(signal: QMetaMethod): void
