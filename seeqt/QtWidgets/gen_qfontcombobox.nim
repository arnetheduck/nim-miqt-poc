...
proc fQFontComboBox_virtualbase_setModel(self: pointer, model: pointer): void{.importc: "QFontComboBox_virtualbase_setModel".}
proc fcQFontComboBox_override_virtual_setModel(self: pointer, slot: int) {.importc: "QFontComboBox_override_virtual_setModel".}
...
proc fQFontComboBox_virtualbase_initStyleOption(self: pointer, option: pointer): void{.importc: "QFontComboBox_virtualbase_initStyleOption".}
proc fcQFontComboBox_override_virtual_initStyleOption(self: pointer, slot: int) {.importc: "QFontComboBox_override_virtual_initStyleOption".}
...
proc fQFontComboBox_virtualbase_nativeEvent(self: pointer, eventType: struct_miqt_string, message: pointer, resultVal: ptr uint): bool{.importc: "QFontComboBox_virtualbase_nativeEvent".}
...
func init*(T: type gen_qfontcombobox_types.QFontComboBox, h: ptr cQFontComboBox): gen_qfontcombobox_types.QFontComboBox =
  T(h: h)
proc create*(T: type gen_qfontcombobox_types.QFontComboBox, parent: QWidget): gen_qfontcombobox_types.QFontComboBox =
...
proc metaObject*(self: gen_qfontcombobox_types.QFontComboBox, ): QMetaObject =
  QMetaObject(h: fcQFontComboBox_metaObject(self.h))
...
proc currentFont*(self: gen_qfontcombobox_types.QFontComboBox, ): QFont =
  QFont(h: fcQFontComboBox_currentFont(self.h))

proc sizeHint*(self: gen_qfontcombobox_types.QFontComboBox, ): QSize =
  QSize(h: fcQFontComboBox_sizeHint(self.h))
...
proc setDisplayFont*(self: gen_qfontcombobox_types.QFontComboBox, fontFamily: string, font: QFont): void =
  fcQFontComboBox_setDisplayFont(self.h, struct_miqt_string(data: fontFamily, len: csize_t(len(fontFamily))), font.h)

proc setCurrentFont*(self: gen_qfontcombobox_types.QFontComboBox, f: QFont): void =
  fcQFontComboBox_setCurrentFont(self.h, f.h)

proc currentFontChanged*(self: gen_qfontcombobox_types.QFontComboBox, f: QFont): void =
  fcQFontComboBox_currentFontChanged(self.h, f.h)

type QFontComboBoxcurrentFontChangedSlot* = proc(f: QFont)
...
proc miqt_exec_callback_QFontComboBox_metacall(self: ptr cQFontComboBox, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QFontComboBox_metacall ".} =
  ...
  virtualReturn
proc QFontComboBoxsizeHint*(self: gen_qfontcombobox_types.QFontComboBox, ): QSize =
  QSize(h: fQFontComboBox_virtualbase_sizeHint(self.h))

type QFontComboBoxsizeHintProc* = proc(): QSize
...
proc miqt_exec_callback_QFontComboBox_sizeHint(self: ptr cQFontComboBox, slot: int): pointer {.exportc: "miqt_exec_callback_QFontComboBox_sizeHint ".} =
  ...
  virtualReturn.h
proc QFontComboBoxevent*(self: gen_qfontcombobox_types.QFontComboBox, e: QEvent): bool =
  fQFontComboBox_virtualbase_event(self.h, e.h)

type QFontComboBoxeventProc* = proc(e: QEvent): bool
...
proc miqt_exec_callback_QFontComboBox_event(self: ptr cQFontComboBox, slot: int, e: pointer): bool {.exportc: "miqt_exec_callback_QFontComboBox_event ".} =
  ...
  virtualReturn
proc QFontComboBoxsetModel*(self: gen_qfontcombobox_types.QFontComboBox, model: QAbstractItemModel): void =
  fQFontComboBox_virtualbase_setModel(self.h, model.h)

type QFontComboBoxsetModelProc* = proc(model: QAbstractItemModel): void
proc onsetModel*(self: gen_qfontcombobox_types.QFontComboBox, slot: QFontComboBoxsetModelProc) =
  # TODO check subclass
  var tmp = new QFontComboBoxsetModelProc
  tmp[] = slot
  GC_ref(tmp)
  fcQFontComboBox_override_virtual_setModel(self.h, cast[int](addr tmp[]))

proc miqt_exec_callback_QFontComboBox_setModel(self: ptr cQFontComboBox, slot: int, model: pointer): void {.exportc: "miqt_exec_callback_QFontComboBox_setModel ".} =
  var nimfunc = cast[ptr QFontComboBoxsetModelProc](cast[pointer](slot))
  let slotval1 = QAbstractItemModel(h: model)


  nimfunc[](slotval1)
proc QFontComboBoxminimumSizeHint*(self: gen_qfontcombobox_types.QFontComboBox, ): QSize =
  QSize(h: fQFontComboBox_virtualbase_minimumSizeHint(self.h))

type QFontComboBoxminimumSizeHintProc* = proc(): QSize
...
proc miqt_exec_callback_QFontComboBox_hidePopup(self: ptr cQFontComboBox, slot: int): void {.exportc: "miqt_exec_callback_QFontComboBox_hidePopup ".} =
  ...
  nimfunc[]()
proc QFontComboBoxinputMethodQuery*(self: gen_qfontcombobox_types.QFontComboBox, param1: cint): QVariant =
  QVariant(h: fQFontComboBox_virtualbase_inputMethodQuery(self.h, cint(param1)))

type QFontComboBoxinputMethodQueryProc* = proc(param1: cint): QVariant
...
proc miqt_exec_callback_QFontComboBox_inputMethodQuery(self: ptr cQFontComboBox, slot: int, param1: cint): pointer {.exportc: "miqt_exec_callback_QFontComboBox_inputMethodQuery ".} =
  ...
  virtualReturn.h
proc QFontComboBoxfocusInEvent*(self: gen_qfontcombobox_types.QFontComboBox, e: QFocusEvent): void =
  fQFontComboBox_virtualbase_focusInEvent(self.h, e.h)

type QFontComboBoxfocusInEventProc* = proc(e: QFocusEvent): void
...
proc miqt_exec_callback_QFontComboBox_focusInEvent(self: ptr cQFontComboBox, slot: int, e: pointer): void {.exportc: "miqt_exec_callback_QFontComboBox_focusInEvent ".} =
  ...
  nimfunc[](slotval1)
proc QFontComboBoxfocusOutEvent*(self: gen_qfontcombobox_types.QFontComboBox, e: QFocusEvent): void =
  fQFontComboBox_virtualbase_focusOutEvent(self.h, e.h)

type QFontComboBoxfocusOutEventProc* = proc(e: QFocusEvent): void
...
proc miqt_exec_callback_QFontComboBox_focusOutEvent(self: ptr cQFontComboBox, slot: int, e: pointer): void {.exportc: "miqt_exec_callback_QFontComboBox_focusOutEvent ".} =
  ...
  nimfunc[](slotval1)
proc QFontComboBoxchangeEvent*(self: gen_qfontcombobox_types.QFontComboBox, e: QEvent): void =
  fQFontComboBox_virtualbase_changeEvent(self.h, e.h)

type QFontComboBoxchangeEventProc* = proc(e: QEvent): void
...
proc miqt_exec_callback_QFontComboBox_changeEvent(self: ptr cQFontComboBox, slot: int, e: pointer): void {.exportc: "miqt_exec_callback_QFontComboBox_changeEvent ".} =
  ...
  nimfunc[](slotval1)
proc QFontComboBoxresizeEvent*(self: gen_qfontcombobox_types.QFontComboBox, e: QResizeEvent): void =
  fQFontComboBox_virtualbase_resizeEvent(self.h, e.h)

type QFontComboBoxresizeEventProc* = proc(e: QResizeEvent): void
...
proc miqt_exec_callback_QFontComboBox_resizeEvent(self: ptr cQFontComboBox, slot: int, e: pointer): void {.exportc: "miqt_exec_callback_QFontComboBox_resizeEvent ".} =
  ...
  nimfunc[](slotval1)
proc QFontComboBoxpaintEvent*(self: gen_qfontcombobox_types.QFontComboBox, e: QPaintEvent): void =
  fQFontComboBox_virtualbase_paintEvent(self.h, e.h)

type QFontComboBoxpaintEventProc* = proc(e: QPaintEvent): void
...
proc miqt_exec_callback_QFontComboBox_paintEvent(self: ptr cQFontComboBox, slot: int, e: pointer): void {.exportc: "miqt_exec_callback_QFontComboBox_paintEvent ".} =
  ...
  nimfunc[](slotval1)
proc QFontComboBoxshowEvent*(self: gen_qfontcombobox_types.QFontComboBox, e: QShowEvent): void =
  fQFontComboBox_virtualbase_showEvent(self.h, e.h)

type QFontComboBoxshowEventProc* = proc(e: QShowEvent): void
...
proc miqt_exec_callback_QFontComboBox_showEvent(self: ptr cQFontComboBox, slot: int, e: pointer): void {.exportc: "miqt_exec_callback_QFontComboBox_showEvent ".} =
  ...
  nimfunc[](slotval1)
proc QFontComboBoxhideEvent*(self: gen_qfontcombobox_types.QFontComboBox, e: QHideEvent): void =
  fQFontComboBox_virtualbase_hideEvent(self.h, e.h)

type QFontComboBoxhideEventProc* = proc(e: QHideEvent): void
...
proc miqt_exec_callback_QFontComboBox_hideEvent(self: ptr cQFontComboBox, slot: int, e: pointer): void {.exportc: "miqt_exec_callback_QFontComboBox_hideEvent ".} =
  ...
  nimfunc[](slotval1)
proc QFontComboBoxmousePressEvent*(self: gen_qfontcombobox_types.QFontComboBox, e: QMouseEvent): void =
  fQFontComboBox_virtualbase_mousePressEvent(self.h, e.h)

type QFontComboBoxmousePressEventProc* = proc(e: QMouseEvent): void
...
proc miqt_exec_callback_QFontComboBox_mousePressEvent(self: ptr cQFontComboBox, slot: int, e: pointer): void {.exportc: "miqt_exec_callback_QFontComboBox_mousePressEvent ".} =
  ...
  nimfunc[](slotval1)
proc QFontComboBoxmouseReleaseEvent*(self: gen_qfontcombobox_types.QFontComboBox, e: QMouseEvent): void =
  fQFontComboBox_virtualbase_mouseReleaseEvent(self.h, e.h)

type QFontComboBoxmouseReleaseEventProc* = proc(e: QMouseEvent): void
...
proc miqt_exec_callback_QFontComboBox_mouseReleaseEvent(self: ptr cQFontComboBox, slot: int, e: pointer): void {.exportc: "miqt_exec_callback_QFontComboBox_mouseReleaseEvent ".} =
  ...
  nimfunc[](slotval1)
proc QFontComboBoxkeyPressEvent*(self: gen_qfontcombobox_types.QFontComboBox, e: QKeyEvent): void =
  fQFontComboBox_virtualbase_keyPressEvent(self.h, e.h)

type QFontComboBoxkeyPressEventProc* = proc(e: QKeyEvent): void
...
proc miqt_exec_callback_QFontComboBox_keyPressEvent(self: ptr cQFontComboBox, slot: int, e: pointer): void {.exportc: "miqt_exec_callback_QFontComboBox_keyPressEvent ".} =
  ...
  nimfunc[](slotval1)
proc QFontComboBoxkeyReleaseEvent*(self: gen_qfontcombobox_types.QFontComboBox, e: QKeyEvent): void =
  fQFontComboBox_virtualbase_keyReleaseEvent(self.h, e.h)

type QFontComboBoxkeyReleaseEventProc* = proc(e: QKeyEvent): void
...
proc miqt_exec_callback_QFontComboBox_keyReleaseEvent(self: ptr cQFontComboBox, slot: int, e: pointer): void {.exportc: "miqt_exec_callback_QFontComboBox_keyReleaseEvent ".} =
  ...
  nimfunc[](slotval1)
proc QFontComboBoxwheelEvent*(self: gen_qfontcombobox_types.QFontComboBox, e: QWheelEvent): void =
  fQFontComboBox_virtualbase_wheelEvent(self.h, e.h)

type QFontComboBoxwheelEventProc* = proc(e: QWheelEvent): void
...
proc miqt_exec_callback_QFontComboBox_wheelEvent(self: ptr cQFontComboBox, slot: int, e: pointer): void {.exportc: "miqt_exec_callback_QFontComboBox_wheelEvent ".} =
  ...
  nimfunc[](slotval1)
proc QFontComboBoxcontextMenuEvent*(self: gen_qfontcombobox_types.QFontComboBox, e: QContextMenuEvent): void =
  fQFontComboBox_virtualbase_contextMenuEvent(self.h, e.h)

type QFontComboBoxcontextMenuEventProc* = proc(e: QContextMenuEvent): void
...
proc miqt_exec_callback_QFontComboBox_contextMenuEvent(self: ptr cQFontComboBox, slot: int, e: pointer): void {.exportc: "miqt_exec_callback_QFontComboBox_contextMenuEvent ".} =
  ...
  nimfunc[](slotval1)
proc QFontComboBoxinputMethodEvent*(self: gen_qfontcombobox_types.QFontComboBox, param1: QInputMethodEvent): void =
  fQFontComboBox_virtualbase_inputMethodEvent(self.h, param1.h)

type QFontComboBoxinputMethodEventProc* = proc(param1: QInputMethodEvent): void
...
proc miqt_exec_callback_QFontComboBox_inputMethodEvent(self: ptr cQFontComboBox, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QFontComboBox_inputMethodEvent ".} =
  ...
  nimfunc[](slotval1)
proc QFontComboBoxinitStyleOption*(self: gen_qfontcombobox_types.QFontComboBox, option: QStyleOptionComboBox): void =
  fQFontComboBox_virtualbase_initStyleOption(self.h, option.h)

type QFontComboBoxinitStyleOptionProc* = proc(option: QStyleOptionComboBox): void
proc oninitStyleOption*(self: gen_qfontcombobox_types.QFontComboBox, slot: QFontComboBoxinitStyleOptionProc) =
  # TODO check subclass
  var tmp = new QFontComboBoxinitStyleOptionProc
  tmp[] = slot
  GC_ref(tmp)
  fcQFontComboBox_override_virtual_initStyleOption(self.h, cast[int](addr tmp[]))

proc miqt_exec_callback_QFontComboBox_initStyleOption(self: ptr cQFontComboBox, slot: int, option: pointer): void {.exportc: "miqt_exec_callback_QFontComboBox_initStyleOption ".} =
  var nimfunc = cast[ptr QFontComboBoxinitStyleOptionProc](cast[pointer](slot))
...
proc miqt_exec_callback_QFontComboBox_hasHeightForWidth(self: ptr cQFontComboBox, slot: int): bool {.exportc: "miqt_exec_callback_QFontComboBox_hasHeightForWidth ".} =
  ...
  virtualReturn
proc QFontComboBoxpaintEngine*(self: gen_qfontcombobox_types.QFontComboBox, ): QPaintEngine =
  QPaintEngine(h: fQFontComboBox_virtualbase_paintEngine(self.h))

type QFontComboBoxpaintEngineProc* = proc(): QPaintEngine
...
proc miqt_exec_callback_QFontComboBox_paintEngine(self: ptr cQFontComboBox, slot: int): pointer {.exportc: "miqt_exec_callback_QFontComboBox_paintEngine ".} =
  ...
  virtualReturn.h
proc QFontComboBoxmouseDoubleClickEvent*(self: gen_qfontcombobox_types.QFontComboBox, event: QMouseEvent): void =
  fQFontComboBox_virtualbase_mouseDoubleClickEvent(self.h, event.h)

type QFontComboBoxmouseDoubleClickEventProc* = proc(event: QMouseEvent): void
...
proc miqt_exec_callback_QFontComboBox_mouseDoubleClickEvent(self: ptr cQFontComboBox, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QFontComboBox_mouseDoubleClickEvent ".} =
  ...
  nimfunc[](slotval1)
proc QFontComboBoxmouseMoveEvent*(self: gen_qfontcombobox_types.QFontComboBox, event: QMouseEvent): void =
  fQFontComboBox_virtualbase_mouseMoveEvent(self.h, event.h)

type QFontComboBoxmouseMoveEventProc* = proc(event: QMouseEvent): void
...
proc miqt_exec_callback_QFontComboBox_mouseMoveEvent(self: ptr cQFontComboBox, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QFontComboBox_mouseMoveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QFontComboBoxenterEvent*(self: gen_qfontcombobox_types.QFontComboBox, event: QEnterEvent): void =
  fQFontComboBox_virtualbase_enterEvent(self.h, event.h)

type QFontComboBoxenterEventProc* = proc(event: QEnterEvent): void
...
proc miqt_exec_callback_QFontComboBox_enterEvent(self: ptr cQFontComboBox, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QFontComboBox_enterEvent ".} =
  ...
  nimfunc[](slotval1)
proc QFontComboBoxleaveEvent*(self: gen_qfontcombobox_types.QFontComboBox, event: QEvent): void =
  fQFontComboBox_virtualbase_leaveEvent(self.h, event.h)

type QFontComboBoxleaveEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QFontComboBox_leaveEvent(self: ptr cQFontComboBox, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QFontComboBox_leaveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QFontComboBoxmoveEvent*(self: gen_qfontcombobox_types.QFontComboBox, event: QMoveEvent): void =
  fQFontComboBox_virtualbase_moveEvent(self.h, event.h)

type QFontComboBoxmoveEventProc* = proc(event: QMoveEvent): void
...
proc miqt_exec_callback_QFontComboBox_moveEvent(self: ptr cQFontComboBox, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QFontComboBox_moveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QFontComboBoxcloseEvent*(self: gen_qfontcombobox_types.QFontComboBox, event: QCloseEvent): void =
  fQFontComboBox_virtualbase_closeEvent(self.h, event.h)

type QFontComboBoxcloseEventProc* = proc(event: QCloseEvent): void
...
proc miqt_exec_callback_QFontComboBox_closeEvent(self: ptr cQFontComboBox, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QFontComboBox_closeEvent ".} =
  ...
  nimfunc[](slotval1)
proc QFontComboBoxtabletEvent*(self: gen_qfontcombobox_types.QFontComboBox, event: QTabletEvent): void =
  fQFontComboBox_virtualbase_tabletEvent(self.h, event.h)

type QFontComboBoxtabletEventProc* = proc(event: QTabletEvent): void
...
proc miqt_exec_callback_QFontComboBox_tabletEvent(self: ptr cQFontComboBox, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QFontComboBox_tabletEvent ".} =
  ...
  nimfunc[](slotval1)
proc QFontComboBoxactionEvent*(self: gen_qfontcombobox_types.QFontComboBox, event: QActionEvent): void =
  fQFontComboBox_virtualbase_actionEvent(self.h, event.h)

type QFontComboBoxactionEventProc* = proc(event: QActionEvent): void
...
proc miqt_exec_callback_QFontComboBox_actionEvent(self: ptr cQFontComboBox, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QFontComboBox_actionEvent ".} =
  ...
  nimfunc[](slotval1)
proc QFontComboBoxdragEnterEvent*(self: gen_qfontcombobox_types.QFontComboBox, event: QDragEnterEvent): void =
  fQFontComboBox_virtualbase_dragEnterEvent(self.h, event.h)

type QFontComboBoxdragEnterEventProc* = proc(event: QDragEnterEvent): void
...
proc miqt_exec_callback_QFontComboBox_dragEnterEvent(self: ptr cQFontComboBox, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QFontComboBox_dragEnterEvent ".} =
  ...
  nimfunc[](slotval1)
proc QFontComboBoxdragMoveEvent*(self: gen_qfontcombobox_types.QFontComboBox, event: QDragMoveEvent): void =
  fQFontComboBox_virtualbase_dragMoveEvent(self.h, event.h)

type QFontComboBoxdragMoveEventProc* = proc(event: QDragMoveEvent): void
...
proc miqt_exec_callback_QFontComboBox_dragMoveEvent(self: ptr cQFontComboBox, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QFontComboBox_dragMoveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QFontComboBoxdragLeaveEvent*(self: gen_qfontcombobox_types.QFontComboBox, event: QDragLeaveEvent): void =
  fQFontComboBox_virtualbase_dragLeaveEvent(self.h, event.h)

type QFontComboBoxdragLeaveEventProc* = proc(event: QDragLeaveEvent): void
...
proc miqt_exec_callback_QFontComboBox_dragLeaveEvent(self: ptr cQFontComboBox, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QFontComboBox_dragLeaveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QFontComboBoxdropEvent*(self: gen_qfontcombobox_types.QFontComboBox, event: QDropEvent): void =
  fQFontComboBox_virtualbase_dropEvent(self.h, event.h)

type QFontComboBoxdropEventProc* = proc(event: QDropEvent): void
...
proc miqt_exec_callback_QFontComboBox_nativeEvent(self: ptr cQFontComboBox, slot: int, eventType: struct_miqt_string, message: pointer, resultVal: ptr uint): bool {.exportc: "miqt_exec_callback_QFontComboBox_nativeEvent ".} =
...
proc miqt_exec_callback_QFontComboBox_metric(self: ptr cQFontComboBox, slot: int, param1: cint): cint {.exportc: "miqt_exec_callback_QFontComboBox_metric ".} =
  ...
  virtualReturn
proc QFontComboBoxinitPainter*(self: gen_qfontcombobox_types.QFontComboBox, painter: QPainter): void =
  fQFontComboBox_virtualbase_initPainter(self.h, painter.h)

type QFontComboBoxinitPainterProc* = proc(painter: QPainter): void
...
proc miqt_exec_callback_QFontComboBox_initPainter(self: ptr cQFontComboBox, slot: int, painter: pointer): void {.exportc: "miqt_exec_callback_QFontComboBox_initPainter ".} =
  ...
  nimfunc[](slotval1)
proc QFontComboBoxredirected*(self: gen_qfontcombobox_types.QFontComboBox, offset: QPoint): QPaintDevice =
  QPaintDevice(h: fQFontComboBox_virtualbase_redirected(self.h, offset.h))

type QFontComboBoxredirectedProc* = proc(offset: QPoint): QPaintDevice
...
proc miqt_exec_callback_QFontComboBox_redirected(self: ptr cQFontComboBox, slot: int, offset: pointer): pointer {.exportc: "miqt_exec_callback_QFontComboBox_redirected ".} =
  ...
  virtualReturn.h
proc QFontComboBoxsharedPainter*(self: gen_qfontcombobox_types.QFontComboBox, ): QPainter =
  QPainter(h: fQFontComboBox_virtualbase_sharedPainter(self.h))

type QFontComboBoxsharedPainterProc* = proc(): QPainter
...
proc miqt_exec_callback_QFontComboBox_focusNextPrevChild(self: ptr cQFontComboBox, slot: int, next: bool): bool {.exportc: "miqt_exec_callback_QFontComboBox_focusNextPrevChild ".} =
  ...
  virtualReturn
proc QFontComboBoxeventFilter*(self: gen_qfontcombobox_types.QFontComboBox, watched: QObject, event: QEvent): bool =
  fQFontComboBox_virtualbase_eventFilter(self.h, watched.h, event.h)

type QFontComboBoxeventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QFontComboBox_eventFilter(self: ptr cQFontComboBox, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QFontComboBox_eventFilter ".} =
  ...
  virtualReturn
proc QFontComboBoxtimerEvent*(self: gen_qfontcombobox_types.QFontComboBox, event: QTimerEvent): void =
  fQFontComboBox_virtualbase_timerEvent(self.h, event.h)

type QFontComboBoxtimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QFontComboBox_timerEvent(self: ptr cQFontComboBox, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QFontComboBox_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QFontComboBoxchildEvent*(self: gen_qfontcombobox_types.QFontComboBox, event: QChildEvent): void =
  fQFontComboBox_virtualbase_childEvent(self.h, event.h)

type QFontComboBoxchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QFontComboBox_childEvent(self: ptr cQFontComboBox, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QFontComboBox_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QFontComboBoxcustomEvent*(self: gen_qfontcombobox_types.QFontComboBox, event: QEvent): void =
  fQFontComboBox_virtualbase_customEvent(self.h, event.h)

type QFontComboBoxcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QFontComboBox_customEvent(self: ptr cQFontComboBox, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QFontComboBox_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QFontComboBoxconnectNotify*(self: gen_qfontcombobox_types.QFontComboBox, signal: QMetaMethod): void =
  fQFontComboBox_virtualbase_connectNotify(self.h, signal.h)

type QFontComboBoxconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QFontComboBox_connectNotify(self: ptr cQFontComboBox, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QFontComboBox_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QFontComboBoxdisconnectNotify*(self: gen_qfontcombobox_types.QFontComboBox, signal: QMetaMethod): void =
  fQFontComboBox_virtualbase_disconnectNotify(self.h, signal.h)

type QFontComboBoxdisconnectNotifyProc* = proc(signal: QMetaMethod): void
