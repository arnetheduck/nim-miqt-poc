...
proc fQCalendarWidget_virtualbase_nativeEvent(self: pointer, eventType: struct_miqt_string, message: pointer, resultVal: ptr clong): bool{.importc: "QCalendarWidget_virtualbase_nativeEvent".}
...
func init*(T: type gen_qcalendarwidget_types.QCalendarWidget, h: ptr cQCalendarWidget): gen_qcalendarwidget_types.QCalendarWidget =
  T(h: h)
proc create*(T: type gen_qcalendarwidget_types.QCalendarWidget, parent: QWidget): gen_qcalendarwidget_types.QCalendarWidget =
...
proc metaObject*(self: gen_qcalendarwidget_types.QCalendarWidget, ): QMetaObject =
  QMetaObject(h: fcQCalendarWidget_metaObject(self.h))
...
proc sizeHint*(self: gen_qcalendarwidget_types.QCalendarWidget, ): QSize =
  QSize(h: fcQCalendarWidget_sizeHint(self.h))

proc minimumSizeHint*(self: gen_qcalendarwidget_types.QCalendarWidget, ): QSize =
  QSize(h: fcQCalendarWidget_minimumSizeHint(self.h))

proc selectedDate*(self: gen_qcalendarwidget_types.QCalendarWidget, ): QDate =
  QDate(h: fcQCalendarWidget_selectedDate(self.h))
...
proc minimumDate*(self: gen_qcalendarwidget_types.QCalendarWidget, ): QDate =
  QDate(h: fcQCalendarWidget_minimumDate(self.h))

proc setMinimumDate*(self: gen_qcalendarwidget_types.QCalendarWidget, date: QDate): void =
  fcQCalendarWidget_setMinimumDate(self.h, date.h)

proc maximumDate*(self: gen_qcalendarwidget_types.QCalendarWidget, ): QDate =
  QDate(h: fcQCalendarWidget_maximumDate(self.h))

proc setMaximumDate*(self: gen_qcalendarwidget_types.QCalendarWidget, date: QDate): void =
...
proc calendar*(self: gen_qcalendarwidget_types.QCalendarWidget, ): QCalendar =
  QCalendar(h: fcQCalendarWidget_calendar(self.h))

proc setCalendar*(self: gen_qcalendarwidget_types.QCalendarWidget, calendar: QCalendar): void =
...
proc headerTextFormat*(self: gen_qcalendarwidget_types.QCalendarWidget, ): QTextCharFormat =
  QTextCharFormat(h: fcQCalendarWidget_headerTextFormat(self.h))

proc setHeaderTextFormat*(self: gen_qcalendarwidget_types.QCalendarWidget, format: QTextCharFormat): void =
  fcQCalendarWidget_setHeaderTextFormat(self.h, format.h)

proc weekdayTextFormat*(self: gen_qcalendarwidget_types.QCalendarWidget, dayOfWeek: cint): QTextCharFormat =
  QTextCharFormat(h: fcQCalendarWidget_weekdayTextFormat(self.h, cint(dayOfWeek)))

proc setWeekdayTextFormat*(self: gen_qcalendarwidget_types.QCalendarWidget, dayOfWeek: cint, format: QTextCharFormat): void =
  fcQCalendarWidget_setWeekdayTextFormat(self.h, cint(dayOfWeek), format.h)

proc dateTextFormat*(self: gen_qcalendarwidget_types.QCalendarWidget, ): Table[QDate,QTextCharFormat] =
  var v_mm = fcQCalendarWidget_dateTextFormat(self.h)
  var vx_ret: Table[QDate, QTextCharFormat]
  var v_Keys = cast[ptr UncheckedArray[pointer]](v_mm.keys)
  var v_Values = cast[ptr UncheckedArray[pointer]](v_mm.values)
  for i in 0..<v_mm.len:
    var v_entry_Key = QDate(h: v_Keys[i])

    var v_entry_Value = QTextCharFormat(h: v_Values[i])

    vx_ret[v_entry_Key] = v_entry_Value
  vx_ret

proc dateTextFormat*(self: gen_qcalendarwidget_types.QCalendarWidget, date: QDate): QTextCharFormat =
  QTextCharFormat(h: fcQCalendarWidget_dateTextFormatWithDate(self.h, date.h))

proc setDateTextFormat*(self: gen_qcalendarwidget_types.QCalendarWidget, date: QDate, format: QTextCharFormat): void =
...
proc setSelectedDate*(self: gen_qcalendarwidget_types.QCalendarWidget, date: QDate): void =
  fcQCalendarWidget_setSelectedDate(self.h, date.h)

proc setDateRange*(self: gen_qcalendarwidget_types.QCalendarWidget, min: QDate, max: QDate): void =
...
proc clicked*(self: gen_qcalendarwidget_types.QCalendarWidget, date: QDate): void =
  fcQCalendarWidget_clicked(self.h, date.h)

type QCalendarWidgetclickedSlot* = proc(date: QDate)
...
proc activated*(self: gen_qcalendarwidget_types.QCalendarWidget, date: QDate): void =
  fcQCalendarWidget_activated(self.h, date.h)

type QCalendarWidgetactivatedSlot* = proc(date: QDate)
...
proc miqt_exec_callback_QCalendarWidget_metacall(self: ptr cQCalendarWidget, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QCalendarWidget_metacall ".} =
  ...
  virtualReturn
proc QCalendarWidgetsizeHint*(self: gen_qcalendarwidget_types.QCalendarWidget, ): QSize =
  QSize(h: fQCalendarWidget_virtualbase_sizeHint(self.h))

type QCalendarWidgetsizeHintProc* = proc(): QSize
...
proc miqt_exec_callback_QCalendarWidget_sizeHint(self: ptr cQCalendarWidget, slot: int): pointer {.exportc: "miqt_exec_callback_QCalendarWidget_sizeHint ".} =
  ...
  virtualReturn.h
proc QCalendarWidgetminimumSizeHint*(self: gen_qcalendarwidget_types.QCalendarWidget, ): QSize =
  QSize(h: fQCalendarWidget_virtualbase_minimumSizeHint(self.h))

type QCalendarWidgetminimumSizeHintProc* = proc(): QSize
...
proc miqt_exec_callback_QCalendarWidget_minimumSizeHint(self: ptr cQCalendarWidget, slot: int): pointer {.exportc: "miqt_exec_callback_QCalendarWidget_minimumSizeHint ".} =
  ...
  virtualReturn.h
proc QCalendarWidgetevent*(self: gen_qcalendarwidget_types.QCalendarWidget, event: QEvent): bool =
  fQCalendarWidget_virtualbase_event(self.h, event.h)

type QCalendarWidgeteventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QCalendarWidget_event(self: ptr cQCalendarWidget, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QCalendarWidget_event ".} =
  ...
  virtualReturn
proc QCalendarWidgeteventFilter*(self: gen_qcalendarwidget_types.QCalendarWidget, watched: QObject, event: QEvent): bool =
  fQCalendarWidget_virtualbase_eventFilter(self.h, watched.h, event.h)

type QCalendarWidgeteventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QCalendarWidget_eventFilter(self: ptr cQCalendarWidget, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QCalendarWidget_eventFilter ".} =
  ...
  virtualReturn
proc QCalendarWidgetmousePressEvent*(self: gen_qcalendarwidget_types.QCalendarWidget, event: QMouseEvent): void =
  fQCalendarWidget_virtualbase_mousePressEvent(self.h, event.h)

type QCalendarWidgetmousePressEventProc* = proc(event: QMouseEvent): void
...
proc miqt_exec_callback_QCalendarWidget_mousePressEvent(self: ptr cQCalendarWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QCalendarWidget_mousePressEvent ".} =
  ...
  nimfunc[](slotval1)
proc QCalendarWidgetresizeEvent*(self: gen_qcalendarwidget_types.QCalendarWidget, event: QResizeEvent): void =
  fQCalendarWidget_virtualbase_resizeEvent(self.h, event.h)

type QCalendarWidgetresizeEventProc* = proc(event: QResizeEvent): void
...
proc miqt_exec_callback_QCalendarWidget_resizeEvent(self: ptr cQCalendarWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QCalendarWidget_resizeEvent ".} =
  ...
  nimfunc[](slotval1)
proc QCalendarWidgetkeyPressEvent*(self: gen_qcalendarwidget_types.QCalendarWidget, event: QKeyEvent): void =
  fQCalendarWidget_virtualbase_keyPressEvent(self.h, event.h)

type QCalendarWidgetkeyPressEventProc* = proc(event: QKeyEvent): void
...
proc miqt_exec_callback_QCalendarWidget_keyPressEvent(self: ptr cQCalendarWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QCalendarWidget_keyPressEvent ".} =
  ...
  nimfunc[](slotval1)
proc QCalendarWidgetpaintCell*(self: gen_qcalendarwidget_types.QCalendarWidget, painter: QPainter, rect: QRect, date: QDate): void =
  fQCalendarWidget_virtualbase_paintCell(self.h, painter.h, rect.h, date.h)

type QCalendarWidgetpaintCellProc* = proc(painter: QPainter, rect: QRect, date: QDate): void
...
proc miqt_exec_callback_QCalendarWidget_hasHeightForWidth(self: ptr cQCalendarWidget, slot: int): bool {.exportc: "miqt_exec_callback_QCalendarWidget_hasHeightForWidth ".} =
  ...
  virtualReturn
proc QCalendarWidgetpaintEngine*(self: gen_qcalendarwidget_types.QCalendarWidget, ): QPaintEngine =
  QPaintEngine(h: fQCalendarWidget_virtualbase_paintEngine(self.h))

type QCalendarWidgetpaintEngineProc* = proc(): QPaintEngine
...
proc miqt_exec_callback_QCalendarWidget_paintEngine(self: ptr cQCalendarWidget, slot: int): pointer {.exportc: "miqt_exec_callback_QCalendarWidget_paintEngine ".} =
  ...
  virtualReturn.h
proc QCalendarWidgetmouseReleaseEvent*(self: gen_qcalendarwidget_types.QCalendarWidget, event: QMouseEvent): void =
  fQCalendarWidget_virtualbase_mouseReleaseEvent(self.h, event.h)

type QCalendarWidgetmouseReleaseEventProc* = proc(event: QMouseEvent): void
...
proc miqt_exec_callback_QCalendarWidget_mouseReleaseEvent(self: ptr cQCalendarWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QCalendarWidget_mouseReleaseEvent ".} =
  ...
  nimfunc[](slotval1)
proc QCalendarWidgetmouseDoubleClickEvent*(self: gen_qcalendarwidget_types.QCalendarWidget, event: QMouseEvent): void =
  fQCalendarWidget_virtualbase_mouseDoubleClickEvent(self.h, event.h)

type QCalendarWidgetmouseDoubleClickEventProc* = proc(event: QMouseEvent): void
...
proc miqt_exec_callback_QCalendarWidget_mouseDoubleClickEvent(self: ptr cQCalendarWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QCalendarWidget_mouseDoubleClickEvent ".} =
  ...
  nimfunc[](slotval1)
proc QCalendarWidgetmouseMoveEvent*(self: gen_qcalendarwidget_types.QCalendarWidget, event: QMouseEvent): void =
  fQCalendarWidget_virtualbase_mouseMoveEvent(self.h, event.h)

type QCalendarWidgetmouseMoveEventProc* = proc(event: QMouseEvent): void
...
proc miqt_exec_callback_QCalendarWidget_mouseMoveEvent(self: ptr cQCalendarWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QCalendarWidget_mouseMoveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QCalendarWidgetwheelEvent*(self: gen_qcalendarwidget_types.QCalendarWidget, event: QWheelEvent): void =
  fQCalendarWidget_virtualbase_wheelEvent(self.h, event.h)

type QCalendarWidgetwheelEventProc* = proc(event: QWheelEvent): void
...
proc miqt_exec_callback_QCalendarWidget_wheelEvent(self: ptr cQCalendarWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QCalendarWidget_wheelEvent ".} =
  ...
  nimfunc[](slotval1)
proc QCalendarWidgetkeyReleaseEvent*(self: gen_qcalendarwidget_types.QCalendarWidget, event: QKeyEvent): void =
  fQCalendarWidget_virtualbase_keyReleaseEvent(self.h, event.h)

type QCalendarWidgetkeyReleaseEventProc* = proc(event: QKeyEvent): void
...
proc miqt_exec_callback_QCalendarWidget_keyReleaseEvent(self: ptr cQCalendarWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QCalendarWidget_keyReleaseEvent ".} =
  ...
  nimfunc[](slotval1)
proc QCalendarWidgetfocusInEvent*(self: gen_qcalendarwidget_types.QCalendarWidget, event: QFocusEvent): void =
  fQCalendarWidget_virtualbase_focusInEvent(self.h, event.h)

type QCalendarWidgetfocusInEventProc* = proc(event: QFocusEvent): void
...
proc miqt_exec_callback_QCalendarWidget_focusInEvent(self: ptr cQCalendarWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QCalendarWidget_focusInEvent ".} =
  ...
  nimfunc[](slotval1)
proc QCalendarWidgetfocusOutEvent*(self: gen_qcalendarwidget_types.QCalendarWidget, event: QFocusEvent): void =
  fQCalendarWidget_virtualbase_focusOutEvent(self.h, event.h)

type QCalendarWidgetfocusOutEventProc* = proc(event: QFocusEvent): void
...
proc miqt_exec_callback_QCalendarWidget_focusOutEvent(self: ptr cQCalendarWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QCalendarWidget_focusOutEvent ".} =
  ...
  nimfunc[](slotval1)
proc QCalendarWidgetenterEvent*(self: gen_qcalendarwidget_types.QCalendarWidget, event: QEvent): void =
  fQCalendarWidget_virtualbase_enterEvent(self.h, event.h)

type QCalendarWidgetenterEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QCalendarWidget_enterEvent(self: ptr cQCalendarWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QCalendarWidget_enterEvent ".} =
  ...
  nimfunc[](slotval1)
proc QCalendarWidgetleaveEvent*(self: gen_qcalendarwidget_types.QCalendarWidget, event: QEvent): void =
  fQCalendarWidget_virtualbase_leaveEvent(self.h, event.h)

type QCalendarWidgetleaveEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QCalendarWidget_leaveEvent(self: ptr cQCalendarWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QCalendarWidget_leaveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QCalendarWidgetpaintEvent*(self: gen_qcalendarwidget_types.QCalendarWidget, event: QPaintEvent): void =
  fQCalendarWidget_virtualbase_paintEvent(self.h, event.h)

type QCalendarWidgetpaintEventProc* = proc(event: QPaintEvent): void
...
proc miqt_exec_callback_QCalendarWidget_paintEvent(self: ptr cQCalendarWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QCalendarWidget_paintEvent ".} =
  ...
  nimfunc[](slotval1)
proc QCalendarWidgetmoveEvent*(self: gen_qcalendarwidget_types.QCalendarWidget, event: QMoveEvent): void =
  fQCalendarWidget_virtualbase_moveEvent(self.h, event.h)

type QCalendarWidgetmoveEventProc* = proc(event: QMoveEvent): void
...
proc miqt_exec_callback_QCalendarWidget_moveEvent(self: ptr cQCalendarWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QCalendarWidget_moveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QCalendarWidgetcloseEvent*(self: gen_qcalendarwidget_types.QCalendarWidget, event: QCloseEvent): void =
  fQCalendarWidget_virtualbase_closeEvent(self.h, event.h)

type QCalendarWidgetcloseEventProc* = proc(event: QCloseEvent): void
...
proc miqt_exec_callback_QCalendarWidget_closeEvent(self: ptr cQCalendarWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QCalendarWidget_closeEvent ".} =
  ...
  nimfunc[](slotval1)
proc QCalendarWidgetcontextMenuEvent*(self: gen_qcalendarwidget_types.QCalendarWidget, event: QContextMenuEvent): void =
  fQCalendarWidget_virtualbase_contextMenuEvent(self.h, event.h)

type QCalendarWidgetcontextMenuEventProc* = proc(event: QContextMenuEvent): void
...
proc miqt_exec_callback_QCalendarWidget_contextMenuEvent(self: ptr cQCalendarWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QCalendarWidget_contextMenuEvent ".} =
  ...
  nimfunc[](slotval1)
proc QCalendarWidgettabletEvent*(self: gen_qcalendarwidget_types.QCalendarWidget, event: QTabletEvent): void =
  fQCalendarWidget_virtualbase_tabletEvent(self.h, event.h)

type QCalendarWidgettabletEventProc* = proc(event: QTabletEvent): void
...
proc miqt_exec_callback_QCalendarWidget_tabletEvent(self: ptr cQCalendarWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QCalendarWidget_tabletEvent ".} =
  ...
  nimfunc[](slotval1)
proc QCalendarWidgetactionEvent*(self: gen_qcalendarwidget_types.QCalendarWidget, event: QActionEvent): void =
  fQCalendarWidget_virtualbase_actionEvent(self.h, event.h)

type QCalendarWidgetactionEventProc* = proc(event: QActionEvent): void
...
proc miqt_exec_callback_QCalendarWidget_actionEvent(self: ptr cQCalendarWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QCalendarWidget_actionEvent ".} =
  ...
  nimfunc[](slotval1)
proc QCalendarWidgetdragEnterEvent*(self: gen_qcalendarwidget_types.QCalendarWidget, event: QDragEnterEvent): void =
  fQCalendarWidget_virtualbase_dragEnterEvent(self.h, event.h)

type QCalendarWidgetdragEnterEventProc* = proc(event: QDragEnterEvent): void
...
proc miqt_exec_callback_QCalendarWidget_dragEnterEvent(self: ptr cQCalendarWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QCalendarWidget_dragEnterEvent ".} =
  ...
  nimfunc[](slotval1)
proc QCalendarWidgetdragMoveEvent*(self: gen_qcalendarwidget_types.QCalendarWidget, event: QDragMoveEvent): void =
  fQCalendarWidget_virtualbase_dragMoveEvent(self.h, event.h)

type QCalendarWidgetdragMoveEventProc* = proc(event: QDragMoveEvent): void
...
proc miqt_exec_callback_QCalendarWidget_dragMoveEvent(self: ptr cQCalendarWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QCalendarWidget_dragMoveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QCalendarWidgetdragLeaveEvent*(self: gen_qcalendarwidget_types.QCalendarWidget, event: QDragLeaveEvent): void =
  fQCalendarWidget_virtualbase_dragLeaveEvent(self.h, event.h)

type QCalendarWidgetdragLeaveEventProc* = proc(event: QDragLeaveEvent): void
...
proc miqt_exec_callback_QCalendarWidget_dragLeaveEvent(self: ptr cQCalendarWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QCalendarWidget_dragLeaveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QCalendarWidgetdropEvent*(self: gen_qcalendarwidget_types.QCalendarWidget, event: QDropEvent): void =
  fQCalendarWidget_virtualbase_dropEvent(self.h, event.h)

type QCalendarWidgetdropEventProc* = proc(event: QDropEvent): void
...
proc miqt_exec_callback_QCalendarWidget_dropEvent(self: ptr cQCalendarWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QCalendarWidget_dropEvent ".} =
  ...
  nimfunc[](slotval1)
proc QCalendarWidgetshowEvent*(self: gen_qcalendarwidget_types.QCalendarWidget, event: QShowEvent): void =
  fQCalendarWidget_virtualbase_showEvent(self.h, event.h)

type QCalendarWidgetshowEventProc* = proc(event: QShowEvent): void
...
proc miqt_exec_callback_QCalendarWidget_showEvent(self: ptr cQCalendarWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QCalendarWidget_showEvent ".} =
  ...
  nimfunc[](slotval1)
proc QCalendarWidgethideEvent*(self: gen_qcalendarwidget_types.QCalendarWidget, event: QHideEvent): void =
  fQCalendarWidget_virtualbase_hideEvent(self.h, event.h)

type QCalendarWidgethideEventProc* = proc(event: QHideEvent): void
...
proc miqt_exec_callback_QCalendarWidget_nativeEvent(self: ptr cQCalendarWidget, slot: int, eventType: struct_miqt_string, message: pointer, resultVal: ptr clong): bool {.exportc: "miqt_exec_callback_QCalendarWidget_nativeEvent ".} =
  ...
  virtualReturn
proc QCalendarWidgetchangeEvent*(self: gen_qcalendarwidget_types.QCalendarWidget, param1: QEvent): void =
  fQCalendarWidget_virtualbase_changeEvent(self.h, param1.h)

type QCalendarWidgetchangeEventProc* = proc(param1: QEvent): void
...
proc miqt_exec_callback_QCalendarWidget_metric(self: ptr cQCalendarWidget, slot: int, param1: cint): cint {.exportc: "miqt_exec_callback_QCalendarWidget_metric ".} =
  ...
  virtualReturn
proc QCalendarWidgetinitPainter*(self: gen_qcalendarwidget_types.QCalendarWidget, painter: QPainter): void =
  fQCalendarWidget_virtualbase_initPainter(self.h, painter.h)

type QCalendarWidgetinitPainterProc* = proc(painter: QPainter): void
...
proc miqt_exec_callback_QCalendarWidget_initPainter(self: ptr cQCalendarWidget, slot: int, painter: pointer): void {.exportc: "miqt_exec_callback_QCalendarWidget_initPainter ".} =
  ...
  nimfunc[](slotval1)
proc QCalendarWidgetredirected*(self: gen_qcalendarwidget_types.QCalendarWidget, offset: QPoint): QPaintDevice =
  QPaintDevice(h: fQCalendarWidget_virtualbase_redirected(self.h, offset.h))

type QCalendarWidgetredirectedProc* = proc(offset: QPoint): QPaintDevice
...
proc miqt_exec_callback_QCalendarWidget_redirected(self: ptr cQCalendarWidget, slot: int, offset: pointer): pointer {.exportc: "miqt_exec_callback_QCalendarWidget_redirected ".} =
  ...
  virtualReturn.h
proc QCalendarWidgetsharedPainter*(self: gen_qcalendarwidget_types.QCalendarWidget, ): QPainter =
  QPainter(h: fQCalendarWidget_virtualbase_sharedPainter(self.h))

type QCalendarWidgetsharedPainterProc* = proc(): QPainter
...
proc miqt_exec_callback_QCalendarWidget_sharedPainter(self: ptr cQCalendarWidget, slot: int): pointer {.exportc: "miqt_exec_callback_QCalendarWidget_sharedPainter ".} =
  ...
  virtualReturn.h
proc QCalendarWidgetinputMethodEvent*(self: gen_qcalendarwidget_types.QCalendarWidget, param1: QInputMethodEvent): void =
  fQCalendarWidget_virtualbase_inputMethodEvent(self.h, param1.h)

type QCalendarWidgetinputMethodEventProc* = proc(param1: QInputMethodEvent): void
...
proc miqt_exec_callback_QCalendarWidget_inputMethodEvent(self: ptr cQCalendarWidget, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QCalendarWidget_inputMethodEvent ".} =
  ...
  nimfunc[](slotval1)
proc QCalendarWidgetinputMethodQuery*(self: gen_qcalendarwidget_types.QCalendarWidget, param1: cint): QVariant =
  QVariant(h: fQCalendarWidget_virtualbase_inputMethodQuery(self.h, cint(param1)))

type QCalendarWidgetinputMethodQueryProc* = proc(param1: cint): QVariant
...
proc miqt_exec_callback_QCalendarWidget_focusNextPrevChild(self: ptr cQCalendarWidget, slot: int, next: bool): bool {.exportc: "miqt_exec_callback_QCalendarWidget_focusNextPrevChild ".} =
  ...
  virtualReturn
proc QCalendarWidgettimerEvent*(self: gen_qcalendarwidget_types.QCalendarWidget, event: QTimerEvent): void =
  fQCalendarWidget_virtualbase_timerEvent(self.h, event.h)

type QCalendarWidgettimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QCalendarWidget_timerEvent(self: ptr cQCalendarWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QCalendarWidget_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QCalendarWidgetchildEvent*(self: gen_qcalendarwidget_types.QCalendarWidget, event: QChildEvent): void =
  fQCalendarWidget_virtualbase_childEvent(self.h, event.h)

type QCalendarWidgetchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QCalendarWidget_childEvent(self: ptr cQCalendarWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QCalendarWidget_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QCalendarWidgetcustomEvent*(self: gen_qcalendarwidget_types.QCalendarWidget, event: QEvent): void =
  fQCalendarWidget_virtualbase_customEvent(self.h, event.h)

type QCalendarWidgetcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QCalendarWidget_customEvent(self: ptr cQCalendarWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QCalendarWidget_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QCalendarWidgetconnectNotify*(self: gen_qcalendarwidget_types.QCalendarWidget, signal: QMetaMethod): void =
  fQCalendarWidget_virtualbase_connectNotify(self.h, signal.h)

type QCalendarWidgetconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QCalendarWidget_connectNotify(self: ptr cQCalendarWidget, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QCalendarWidget_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QCalendarWidgetdisconnectNotify*(self: gen_qcalendarwidget_types.QCalendarWidget, signal: QMetaMethod): void =
  fQCalendarWidget_virtualbase_disconnectNotify(self.h, signal.h)

type QCalendarWidgetdisconnectNotifyProc* = proc(signal: QMetaMethod): void
