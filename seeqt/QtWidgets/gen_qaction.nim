...
proc create*(T: type gen_qaction_types.QAction, icon: QIcon, text: string): gen_qaction_types.QAction =
  gen_qaction_types.QAction.init(fcQAction_new3(icon.h, struct_miqt_string(data: text, len: csize_t(len(text)))))

proc create*(T: type gen_qaction_types.QAction, parent: QObject): gen_qaction_types.QAction =
  gen_qaction_types.QAction.init(fcQAction_new4(parent.h))

proc create*(T: type gen_qaction_types.QAction, text: string, parent: QObject): gen_qaction_types.QAction =
  gen_qaction_types.QAction.init(fcQAction_new5(struct_miqt_string(data: text, len: csize_t(len(text))), parent.h))

proc create*(T: type gen_qaction_types.QAction, icon: QIcon, text: string, parent: QObject): gen_qaction_types.QAction =
  gen_qaction_types.QAction.init(fcQAction_new6(icon.h, struct_miqt_string(data: text, len: csize_t(len(text))), parent.h))

proc metaObject*(self: gen_qaction_types.QAction, ): QMetaObject =
  QMetaObject(h: fcQAction_metaObject(self.h))
...
proc setActionGroup*(self: gen_qaction_types.QAction, group: QActionGroup): void =
  fcQAction_setActionGroup(self.h, group.h)

proc actionGroup*(self: gen_qaction_types.QAction, ): QActionGroup =
  QActionGroup(h: fcQAction_actionGroup(self.h))

proc setIcon*(self: gen_qaction_types.QAction, icon: QIcon): void =
  fcQAction_setIcon(self.h, icon.h)

proc icon*(self: gen_qaction_types.QAction, ): QIcon =
  QIcon(h: fcQAction_icon(self.h))
...
proc menu*(self: gen_qaction_types.QAction, ): QMenu =
  QMenu(h: fcQAction_menu(self.h))

proc setMenu*(self: gen_qaction_types.QAction, menu: QMenu): void =
...
proc setShortcut*(self: gen_qaction_types.QAction, shortcut: QKeySequence): void =
  fcQAction_setShortcut(self.h, shortcut.h)

proc shortcut*(self: gen_qaction_types.QAction, ): QKeySequence =
  QKeySequence(h: fcQAction_shortcut(self.h))

proc setShortcuts*(self: gen_qaction_types.QAction, shortcuts: seq[QKeySequence]): void =
...
proc shortcuts*(self: gen_qaction_types.QAction, ): seq[QKeySequence] =
...
proc setFont*(self: gen_qaction_types.QAction, font: QFont): void =
  fcQAction_setFont(self.h, font.h)

proc font*(self: gen_qaction_types.QAction, ): QFont =
  QFont(h: fcQAction_font(self.h))
...
proc data*(self: gen_qaction_types.QAction, ): QVariant =
  QVariant(h: fcQAction_data(self.h))

proc setData*(self: gen_qaction_types.QAction, varVal: QVariant): void =
...
proc parentWidget*(self: gen_qaction_types.QAction, ): QWidget =
  QWidget(h: fcQAction_parentWidget(self.h))

proc associatedWidgets*(self: gen_qaction_types.QAction, ): seq[QWidget] =
...
proc associatedGraphicsWidgets*(self: gen_qaction_types.QAction, ): seq[QGraphicsWidget] =
  var v_ma = fcQAction_associatedGraphicsWidgets(self.h)
  var vx_ret = newSeq[QGraphicsWidget](int(v_ma.len))
  let v_outCast = cast[ptr UncheckedArray[pointer]](v_ma.data)
  for i in 0 ..< v_ma.len:
    vx_ret[i] = QGraphicsWidget(h: v_outCast[i])
  vx_ret
...
proc showStatusText*(self: gen_qaction_types.QAction, widget: QWidget): bool =
...
proc miqt_exec_callback_QAction_metacall(self: ptr cQAction, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QAction_metacall ".} =
  ...
  virtualReturn
proc QActionevent*(self: gen_qaction_types.QAction, param1: QEvent): bool =
  fQAction_virtualbase_event(self.h, param1.h)

type QActioneventProc* = proc(param1: QEvent): bool
...
proc miqt_exec_callback_QAction_event(self: ptr cQAction, slot: int, param1: pointer): bool {.exportc: "miqt_exec_callback_QAction_event ".} =
  ...
  virtualReturn
proc QActioneventFilter*(self: gen_qaction_types.QAction, watched: QObject, event: QEvent): bool =
  fQAction_virtualbase_eventFilter(self.h, watched.h, event.h)

type QActioneventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QAction_eventFilter(self: ptr cQAction, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QAction_eventFilter ".} =
  ...
  virtualReturn
proc QActiontimerEvent*(self: gen_qaction_types.QAction, event: QTimerEvent): void =
  fQAction_virtualbase_timerEvent(self.h, event.h)

type QActiontimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QAction_timerEvent(self: ptr cQAction, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QAction_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QActionchildEvent*(self: gen_qaction_types.QAction, event: QChildEvent): void =
  fQAction_virtualbase_childEvent(self.h, event.h)

type QActionchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QAction_childEvent(self: ptr cQAction, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QAction_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QActioncustomEvent*(self: gen_qaction_types.QAction, event: QEvent): void =
  fQAction_virtualbase_customEvent(self.h, event.h)

type QActioncustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QAction_customEvent(self: ptr cQAction, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QAction_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QActionconnectNotify*(self: gen_qaction_types.QAction, signal: QMetaMethod): void =
  fQAction_virtualbase_connectNotify(self.h, signal.h)

type QActionconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QAction_connectNotify(self: ptr cQAction, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QAction_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QActiondisconnectNotify*(self: gen_qaction_types.QAction, signal: QMetaMethod): void =
  fQAction_virtualbase_disconnectNotify(self.h, signal.h)

type QActiondisconnectNotifyProc* = proc(signal: QMetaMethod): void
