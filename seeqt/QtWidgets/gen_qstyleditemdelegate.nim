...
proc create*(T: type gen_qstyleditemdelegate_types.QStyledItemDelegate, parent: QObject): gen_qstyleditemdelegate_types.QStyledItemDelegate =
  gen_qstyleditemdelegate_types.QStyledItemDelegate.init(fcQStyledItemDelegate_new2(parent.h))

proc metaObject*(self: gen_qstyleditemdelegate_types.QStyledItemDelegate, ): QMetaObject =
  QMetaObject(h: fcQStyledItemDelegate_metaObject(self.h))
...
proc paint*(self: gen_qstyleditemdelegate_types.QStyledItemDelegate, painter: QPainter, option: QStyleOptionViewItem, index: QModelIndex): void =
  fcQStyledItemDelegate_paint(self.h, painter.h, option.h, index.h)

proc sizeHint*(self: gen_qstyleditemdelegate_types.QStyledItemDelegate, option: QStyleOptionViewItem, index: QModelIndex): QSize =
  QSize(h: fcQStyledItemDelegate_sizeHint(self.h, option.h, index.h))

proc createEditor*(self: gen_qstyleditemdelegate_types.QStyledItemDelegate, parent: QWidget, option: QStyleOptionViewItem, index: QModelIndex): QWidget =
  QWidget(h: fcQStyledItemDelegate_createEditor(self.h, parent.h, option.h, index.h))

proc setEditorData*(self: gen_qstyleditemdelegate_types.QStyledItemDelegate, editor: QWidget, index: QModelIndex): void =
  fcQStyledItemDelegate_setEditorData(self.h, editor.h, index.h)

proc setModelData*(self: gen_qstyleditemdelegate_types.QStyledItemDelegate, editor: QWidget, model: QAbstractItemModel, index: QModelIndex): void =
  fcQStyledItemDelegate_setModelData(self.h, editor.h, model.h, index.h)

proc updateEditorGeometry*(self: gen_qstyleditemdelegate_types.QStyledItemDelegate, editor: QWidget, option: QStyleOptionViewItem, index: QModelIndex): void =
  fcQStyledItemDelegate_updateEditorGeometry(self.h, editor.h, option.h, index.h)

proc itemEditorFactory*(self: gen_qstyleditemdelegate_types.QStyledItemDelegate, ): QItemEditorFactory =
  QItemEditorFactory(h: fcQStyledItemDelegate_itemEditorFactory(self.h))

proc setItemEditorFactory*(self: gen_qstyleditemdelegate_types.QStyledItemDelegate, factory: QItemEditorFactory): void =
  fcQStyledItemDelegate_setItemEditorFactory(self.h, factory.h)

proc displayText*(self: gen_qstyleditemdelegate_types.QStyledItemDelegate, value: QVariant, locale: QLocale): string =
...
proc miqt_exec_callback_QStyledItemDelegate_metacall(self: ptr cQStyledItemDelegate, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QStyledItemDelegate_metacall ".} =
  ...
  virtualReturn
proc QStyledItemDelegatepaint*(self: gen_qstyleditemdelegate_types.QStyledItemDelegate, painter: QPainter, option: QStyleOptionViewItem, index: QModelIndex): void =
  fQStyledItemDelegate_virtualbase_paint(self.h, painter.h, option.h, index.h)

type QStyledItemDelegatepaintProc* = proc(painter: QPainter, option: QStyleOptionViewItem, index: QModelIndex): void
...
proc QStyledItemDelegatesizeHint*(self: gen_qstyleditemdelegate_types.QStyledItemDelegate, option: QStyleOptionViewItem, index: QModelIndex): QSize =
  QSize(h: fQStyledItemDelegate_virtualbase_sizeHint(self.h, option.h, index.h))

type QStyledItemDelegatesizeHintProc* = proc(option: QStyleOptionViewItem, index: QModelIndex): QSize
...
proc miqt_exec_callback_QStyledItemDelegate_sizeHint(self: ptr cQStyledItemDelegate, slot: int, option: pointer, index: pointer): pointer {.exportc: "miqt_exec_callback_QStyledItemDelegate_sizeHint ".} =
  ...
  virtualReturn.h
proc QStyledItemDelegatecreateEditor*(self: gen_qstyleditemdelegate_types.QStyledItemDelegate, parent: QWidget, option: QStyleOptionViewItem, index: QModelIndex): QWidget =
  QWidget(h: fQStyledItemDelegate_virtualbase_createEditor(self.h, parent.h, option.h, index.h))

type QStyledItemDelegatecreateEditorProc* = proc(parent: QWidget, option: QStyleOptionViewItem, index: QModelIndex): QWidget
...
proc miqt_exec_callback_QStyledItemDelegate_createEditor(self: ptr cQStyledItemDelegate, slot: int, parent: pointer, option: pointer, index: pointer): pointer {.exportc: "miqt_exec_callback_QStyledItemDelegate_createEditor ".} =
  ...
  virtualReturn.h
proc QStyledItemDelegatesetEditorData*(self: gen_qstyleditemdelegate_types.QStyledItemDelegate, editor: QWidget, index: QModelIndex): void =
  fQStyledItemDelegate_virtualbase_setEditorData(self.h, editor.h, index.h)

type QStyledItemDelegatesetEditorDataProc* = proc(editor: QWidget, index: QModelIndex): void
...
proc QStyledItemDelegatesetModelData*(self: gen_qstyleditemdelegate_types.QStyledItemDelegate, editor: QWidget, model: QAbstractItemModel, index: QModelIndex): void =
  fQStyledItemDelegate_virtualbase_setModelData(self.h, editor.h, model.h, index.h)

type QStyledItemDelegatesetModelDataProc* = proc(editor: QWidget, model: QAbstractItemModel, index: QModelIndex): void
...
proc miqt_exec_callback_QStyledItemDelegate_setModelData(self: ptr cQStyledItemDelegate, slot: int, editor: pointer, model: pointer, index: pointer): void {.exportc: "miqt_exec_callback_QStyledItemDelegate_setModelData ".} =
  ...
  nimfunc[](slotval1, slotval2, slotval3)
proc QStyledItemDelegateupdateEditorGeometry*(self: gen_qstyleditemdelegate_types.QStyledItemDelegate, editor: QWidget, option: QStyleOptionViewItem, index: QModelIndex): void =
  fQStyledItemDelegate_virtualbase_updateEditorGeometry(self.h, editor.h, option.h, index.h)

type QStyledItemDelegateupdateEditorGeometryProc* = proc(editor: QWidget, option: QStyleOptionViewItem, index: QModelIndex): void
...
proc miqt_exec_callback_QStyledItemDelegate_updateEditorGeometry(self: ptr cQStyledItemDelegate, slot: int, editor: pointer, option: pointer, index: pointer): void {.exportc: "miqt_exec_callback_QStyledItemDelegate_updateEditorGeometry ".} =
  ...
  nimfunc[](slotval1, slotval2, slotval3)
proc QStyledItemDelegatedisplayText*(self: gen_qstyleditemdelegate_types.QStyledItemDelegate, value: QVariant, locale: QLocale): string =
  let v_ms = fQStyledItemDelegate_virtualbase_displayText(self.h, value.h, locale.h)
  let vx_ret = string.fromBytes(toOpenArrayByte(v_ms.data, 0, int(v_ms.len)-1))
  c_free(v_ms.data)
  vx_ret

type QStyledItemDelegatedisplayTextProc* = proc(value: QVariant, locale: QLocale): string
...
proc miqt_exec_callback_QStyledItemDelegate_displayText(self: ptr cQStyledItemDelegate, slot: int, value: pointer, locale: pointer): struct_miqt_string {.exportc: "miqt_exec_callback_QStyledItemDelegate_displayText ".} =
  ...
  let slotval2 = QLocale(h: locale)


  let virtualReturn = nimfunc[](slotval1, slotval2 )

  struct_miqt_string(data: virtualReturn, len: csize_t(len(virtualReturn)))
proc QStyledItemDelegateinitStyleOption*(self: gen_qstyleditemdelegate_types.QStyledItemDelegate, option: QStyleOptionViewItem, index: QModelIndex): void =
  fQStyledItemDelegate_virtualbase_initStyleOption(self.h, option.h, index.h)

type QStyledItemDelegateinitStyleOptionProc* = proc(option: QStyleOptionViewItem, index: QModelIndex): void
...
proc miqt_exec_callback_QStyledItemDelegate_initStyleOption(self: ptr cQStyledItemDelegate, slot: int, option: pointer, index: pointer): void {.exportc: "miqt_exec_callback_QStyledItemDelegate_initStyleOption ".} =
  ...
  nimfunc[](slotval1, slotval2)
proc QStyledItemDelegateeventFilter*(self: gen_qstyleditemdelegate_types.QStyledItemDelegate, objectVal: QObject, event: QEvent): bool =
  fQStyledItemDelegate_virtualbase_eventFilter(self.h, objectVal.h, event.h)

type QStyledItemDelegateeventFilterProc* = proc(objectVal: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QStyledItemDelegate_eventFilter(self: ptr cQStyledItemDelegate, slot: int, objectVal: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QStyledItemDelegate_eventFilter ".} =
  ...
  virtualReturn
proc QStyledItemDelegateeditorEvent*(self: gen_qstyleditemdelegate_types.QStyledItemDelegate, event: QEvent, model: QAbstractItemModel, option: QStyleOptionViewItem, index: QModelIndex): bool =
  fQStyledItemDelegate_virtualbase_editorEvent(self.h, event.h, model.h, option.h, index.h)

type QStyledItemDelegateeditorEventProc* = proc(event: QEvent, model: QAbstractItemModel, option: QStyleOptionViewItem, index: QModelIndex): bool
...
proc miqt_exec_callback_QStyledItemDelegate_editorEvent(self: ptr cQStyledItemDelegate, slot: int, event: pointer, model: pointer, option: pointer, index: pointer): bool {.exportc: "miqt_exec_callback_QStyledItemDelegate_editorEvent ".} =
  ...
  virtualReturn
proc QStyledItemDelegatedestroyEditor*(self: gen_qstyleditemdelegate_types.QStyledItemDelegate, editor: QWidget, index: QModelIndex): void =
  fQStyledItemDelegate_virtualbase_destroyEditor(self.h, editor.h, index.h)

type QStyledItemDelegatedestroyEditorProc* = proc(editor: QWidget, index: QModelIndex): void
...
proc miqt_exec_callback_QStyledItemDelegate_destroyEditor(self: ptr cQStyledItemDelegate, slot: int, editor: pointer, index: pointer): void {.exportc: "miqt_exec_callback_QStyledItemDelegate_destroyEditor ".} =
  ...
  nimfunc[](slotval1, slotval2)
proc QStyledItemDelegatehelpEvent*(self: gen_qstyleditemdelegate_types.QStyledItemDelegate, event: QHelpEvent, view: QAbstractItemView, option: QStyleOptionViewItem, index: QModelIndex): bool =
  fQStyledItemDelegate_virtualbase_helpEvent(self.h, event.h, view.h, option.h, index.h)

type QStyledItemDelegatehelpEventProc* = proc(event: QHelpEvent, view: QAbstractItemView, option: QStyleOptionViewItem, index: QModelIndex): bool
...
proc QStyledItemDelegateevent*(self: gen_qstyleditemdelegate_types.QStyledItemDelegate, event: QEvent): bool =
  fQStyledItemDelegate_virtualbase_event(self.h, event.h)

type QStyledItemDelegateeventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QStyledItemDelegate_event(self: ptr cQStyledItemDelegate, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QStyledItemDelegate_event ".} =
  ...
  virtualReturn
proc QStyledItemDelegatetimerEvent*(self: gen_qstyleditemdelegate_types.QStyledItemDelegate, event: QTimerEvent): void =
  fQStyledItemDelegate_virtualbase_timerEvent(self.h, event.h)

type QStyledItemDelegatetimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QStyledItemDelegate_timerEvent(self: ptr cQStyledItemDelegate, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QStyledItemDelegate_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QStyledItemDelegatechildEvent*(self: gen_qstyleditemdelegate_types.QStyledItemDelegate, event: QChildEvent): void =
  fQStyledItemDelegate_virtualbase_childEvent(self.h, event.h)

type QStyledItemDelegatechildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QStyledItemDelegate_childEvent(self: ptr cQStyledItemDelegate, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QStyledItemDelegate_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QStyledItemDelegatecustomEvent*(self: gen_qstyleditemdelegate_types.QStyledItemDelegate, event: QEvent): void =
  fQStyledItemDelegate_virtualbase_customEvent(self.h, event.h)

type QStyledItemDelegatecustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QStyledItemDelegate_customEvent(self: ptr cQStyledItemDelegate, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QStyledItemDelegate_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QStyledItemDelegateconnectNotify*(self: gen_qstyleditemdelegate_types.QStyledItemDelegate, signal: QMetaMethod): void =
  fQStyledItemDelegate_virtualbase_connectNotify(self.h, signal.h)

type QStyledItemDelegateconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QStyledItemDelegate_connectNotify(self: ptr cQStyledItemDelegate, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QStyledItemDelegate_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QStyledItemDelegatedisconnectNotify*(self: gen_qstyleditemdelegate_types.QStyledItemDelegate, signal: QMetaMethod): void =
  fQStyledItemDelegate_virtualbase_disconnectNotify(self.h, signal.h)

type QStyledItemDelegatedisconnectNotifyProc* = proc(signal: QMetaMethod): void
