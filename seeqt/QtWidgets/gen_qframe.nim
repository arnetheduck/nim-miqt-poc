...
proc miqt_exec_callback_QFrame_focusOutEvent(self: ptr cQFrame, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QFrame_focusOutEvent ".} =
  ...
  nimfunc[](slotval1)
proc QFrameenterEvent*(self: gen_qframe_types.QFrame, event: QEvent): void =
  fQFrame_virtualbase_enterEvent(self.h, event.h)

type QFrameenterEventProc* = proc(event: QEvent): void
...
type QFramenativeEventProc* = proc(eventType: seq[byte], message: pointer, resultVal: ptr clong): bool
