...
QMetaObject* QSizeGrip_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQSizeGrip*)(self) )->QSizeGrip::metaObject();

}

void* QSizeGrip_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQSizeGrip*)(self) )->QSizeGrip::qt_metacast(param1);

}

int QSizeGrip_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQSizeGrip*)(self) )->QSizeGrip::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
bool QSizeGrip_virtualbase_nativeEvent(void* self, struct miqt_string eventType, void* message, intptr_t* result) {
	...
	return ( (MiqtVirtualQSizeGrip*)(self) )->QSizeGrip::nativeEvent(eventType_QByteArray, message, (qintptr*)(result));
