...
func init*(T: type gen_qdialogbuttonbox_types.QDialogButtonBox, h: ptr cQDialogButtonBox): gen_qdialogbuttonbox_types.QDialogButtonBox =
  T(h: h)
proc create*(T: type gen_qdialogbuttonbox_types.QDialogButtonBox, parent: QWidget): gen_qdialogbuttonbox_types.QDialogButtonBox =
...
proc create*(T: type gen_qdialogbuttonbox_types.QDialogButtonBox, orientation: cint, parent: QWidget): gen_qdialogbuttonbox_types.QDialogButtonBox =
  gen_qdialogbuttonbox_types.QDialogButtonBox.init(fcQDialogButtonBox_new6(cint(orientation), parent.h))

proc create2*(T: type gen_qdialogbuttonbox_types.QDialogButtonBox, buttons: cint, parent: QWidget): gen_qdialogbuttonbox_types.QDialogButtonBox =
  gen_qdialogbuttonbox_types.QDialogButtonBox.init(fcQDialogButtonBox_new7(cint(buttons), parent.h))

proc create*(T: type gen_qdialogbuttonbox_types.QDialogButtonBox, buttons: cint, orientation: cint, parent: QWidget): gen_qdialogbuttonbox_types.QDialogButtonBox =
  gen_qdialogbuttonbox_types.QDialogButtonBox.init(fcQDialogButtonBox_new8(cint(buttons), cint(orientation), parent.h))

proc metaObject*(self: gen_qdialogbuttonbox_types.QDialogButtonBox, ): QMetaObject =
  QMetaObject(h: fcQDialogButtonBox_metaObject(self.h))
...
proc addButton*(self: gen_qdialogbuttonbox_types.QDialogButtonBox, button: QAbstractButton, role: cint): void =
  fcQDialogButtonBox_addButton(self.h, button.h, cint(role))

proc addButton*(self: gen_qdialogbuttonbox_types.QDialogButtonBox, text: string, role: cint): QPushButton =
  QPushButton(h: fcQDialogButtonBox_addButton2(self.h, struct_miqt_string(data: text, len: csize_t(len(text))), cint(role)))

proc addButton*(self: gen_qdialogbuttonbox_types.QDialogButtonBox, button: cint): QPushButton =
  QPushButton(h: fcQDialogButtonBox_addButtonWithButton(self.h, cint(button)))

proc removeButton*(self: gen_qdialogbuttonbox_types.QDialogButtonBox, button: QAbstractButton): void =
...
proc buttons*(self: gen_qdialogbuttonbox_types.QDialogButtonBox, ): seq[QAbstractButton] =
...
proc buttonRole*(self: gen_qdialogbuttonbox_types.QDialogButtonBox, button: QAbstractButton): cint =
...
proc standardButton*(self: gen_qdialogbuttonbox_types.QDialogButtonBox, button: QAbstractButton): cint =
  cint(fcQDialogButtonBox_standardButton(self.h, button.h))

proc button*(self: gen_qdialogbuttonbox_types.QDialogButtonBox, which: cint): QPushButton =
  QPushButton(h: fcQDialogButtonBox_button(self.h, cint(which)))
...
proc clicked*(self: gen_qdialogbuttonbox_types.QDialogButtonBox, button: QAbstractButton): void =
  fcQDialogButtonBox_clicked(self.h, button.h)

type QDialogButtonBoxclickedSlot* = proc(button: QAbstractButton)
...
proc miqt_exec_callback_QDialogButtonBox_metacall(self: ptr cQDialogButtonBox, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QDialogButtonBox_metacall ".} =
  ...
  virtualReturn
proc QDialogButtonBoxchangeEvent*(self: gen_qdialogbuttonbox_types.QDialogButtonBox, event: QEvent): void =
  fQDialogButtonBox_virtualbase_changeEvent(self.h, event.h)

type QDialogButtonBoxchangeEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QDialogButtonBox_changeEvent(self: ptr cQDialogButtonBox, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QDialogButtonBox_changeEvent ".} =
  ...
  nimfunc[](slotval1)
proc QDialogButtonBoxevent*(self: gen_qdialogbuttonbox_types.QDialogButtonBox, event: QEvent): bool =
  fQDialogButtonBox_virtualbase_event(self.h, event.h)

type QDialogButtonBoxeventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QDialogButtonBox_setVisible(self: ptr cQDialogButtonBox, slot: int, visible: bool): void {.exportc: "miqt_exec_callback_QDialogButtonBox_setVisible ".} =
  ...
  nimfunc[](slotval1)
proc QDialogButtonBoxsizeHint*(self: gen_qdialogbuttonbox_types.QDialogButtonBox, ): QSize =
  QSize(h: fQDialogButtonBox_virtualbase_sizeHint(self.h))

type QDialogButtonBoxsizeHintProc* = proc(): QSize
...
proc miqt_exec_callback_QDialogButtonBox_sizeHint(self: ptr cQDialogButtonBox, slot: int): pointer {.exportc: "miqt_exec_callback_QDialogButtonBox_sizeHint ".} =
  ...
  virtualReturn.h
proc QDialogButtonBoxminimumSizeHint*(self: gen_qdialogbuttonbox_types.QDialogButtonBox, ): QSize =
  QSize(h: fQDialogButtonBox_virtualbase_minimumSizeHint(self.h))

type QDialogButtonBoxminimumSizeHintProc* = proc(): QSize
...
proc miqt_exec_callback_QDialogButtonBox_hasHeightForWidth(self: ptr cQDialogButtonBox, slot: int): bool {.exportc: "miqt_exec_callback_QDialogButtonBox_hasHeightForWidth ".} =
  ...
  virtualReturn
proc QDialogButtonBoxpaintEngine*(self: gen_qdialogbuttonbox_types.QDialogButtonBox, ): QPaintEngine =
  QPaintEngine(h: fQDialogButtonBox_virtualbase_paintEngine(self.h))

type QDialogButtonBoxpaintEngineProc* = proc(): QPaintEngine
...
proc miqt_exec_callback_QDialogButtonBox_paintEngine(self: ptr cQDialogButtonBox, slot: int): pointer {.exportc: "miqt_exec_callback_QDialogButtonBox_paintEngine ".} =
  ...
  virtualReturn.h
proc QDialogButtonBoxmousePressEvent*(self: gen_qdialogbuttonbox_types.QDialogButtonBox, event: QMouseEvent): void =
  fQDialogButtonBox_virtualbase_mousePressEvent(self.h, event.h)

type QDialogButtonBoxmousePressEventProc* = proc(event: QMouseEvent): void
...
proc miqt_exec_callback_QDialogButtonBox_mousePressEvent(self: ptr cQDialogButtonBox, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QDialogButtonBox_mousePressEvent ".} =
  ...
  nimfunc[](slotval1)
proc QDialogButtonBoxmouseReleaseEvent*(self: gen_qdialogbuttonbox_types.QDialogButtonBox, event: QMouseEvent): void =
  fQDialogButtonBox_virtualbase_mouseReleaseEvent(self.h, event.h)

type QDialogButtonBoxmouseReleaseEventProc* = proc(event: QMouseEvent): void
...
proc miqt_exec_callback_QDialogButtonBox_mouseReleaseEvent(self: ptr cQDialogButtonBox, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QDialogButtonBox_mouseReleaseEvent ".} =
  ...
  nimfunc[](slotval1)
proc QDialogButtonBoxmouseDoubleClickEvent*(self: gen_qdialogbuttonbox_types.QDialogButtonBox, event: QMouseEvent): void =
  fQDialogButtonBox_virtualbase_mouseDoubleClickEvent(self.h, event.h)

type QDialogButtonBoxmouseDoubleClickEventProc* = proc(event: QMouseEvent): void
...
proc miqt_exec_callback_QDialogButtonBox_mouseDoubleClickEvent(self: ptr cQDialogButtonBox, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QDialogButtonBox_mouseDoubleClickEvent ".} =
  ...
  nimfunc[](slotval1)
proc QDialogButtonBoxmouseMoveEvent*(self: gen_qdialogbuttonbox_types.QDialogButtonBox, event: QMouseEvent): void =
  fQDialogButtonBox_virtualbase_mouseMoveEvent(self.h, event.h)

type QDialogButtonBoxmouseMoveEventProc* = proc(event: QMouseEvent): void
...
proc miqt_exec_callback_QDialogButtonBox_mouseMoveEvent(self: ptr cQDialogButtonBox, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QDialogButtonBox_mouseMoveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QDialogButtonBoxwheelEvent*(self: gen_qdialogbuttonbox_types.QDialogButtonBox, event: QWheelEvent): void =
  fQDialogButtonBox_virtualbase_wheelEvent(self.h, event.h)

type QDialogButtonBoxwheelEventProc* = proc(event: QWheelEvent): void
...
proc miqt_exec_callback_QDialogButtonBox_wheelEvent(self: ptr cQDialogButtonBox, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QDialogButtonBox_wheelEvent ".} =
  ...
  nimfunc[](slotval1)
proc QDialogButtonBoxkeyPressEvent*(self: gen_qdialogbuttonbox_types.QDialogButtonBox, event: QKeyEvent): void =
  fQDialogButtonBox_virtualbase_keyPressEvent(self.h, event.h)

type QDialogButtonBoxkeyPressEventProc* = proc(event: QKeyEvent): void
...
proc miqt_exec_callback_QDialogButtonBox_keyPressEvent(self: ptr cQDialogButtonBox, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QDialogButtonBox_keyPressEvent ".} =
  ...
  nimfunc[](slotval1)
proc QDialogButtonBoxkeyReleaseEvent*(self: gen_qdialogbuttonbox_types.QDialogButtonBox, event: QKeyEvent): void =
  fQDialogButtonBox_virtualbase_keyReleaseEvent(self.h, event.h)

type QDialogButtonBoxkeyReleaseEventProc* = proc(event: QKeyEvent): void
...
proc miqt_exec_callback_QDialogButtonBox_keyReleaseEvent(self: ptr cQDialogButtonBox, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QDialogButtonBox_keyReleaseEvent ".} =
  ...
  nimfunc[](slotval1)
proc QDialogButtonBoxfocusInEvent*(self: gen_qdialogbuttonbox_types.QDialogButtonBox, event: QFocusEvent): void =
  fQDialogButtonBox_virtualbase_focusInEvent(self.h, event.h)

type QDialogButtonBoxfocusInEventProc* = proc(event: QFocusEvent): void
...
proc miqt_exec_callback_QDialogButtonBox_focusInEvent(self: ptr cQDialogButtonBox, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QDialogButtonBox_focusInEvent ".} =
  ...
  nimfunc[](slotval1)
proc QDialogButtonBoxfocusOutEvent*(self: gen_qdialogbuttonbox_types.QDialogButtonBox, event: QFocusEvent): void =
  fQDialogButtonBox_virtualbase_focusOutEvent(self.h, event.h)

type QDialogButtonBoxfocusOutEventProc* = proc(event: QFocusEvent): void
...
proc miqt_exec_callback_QDialogButtonBox_focusOutEvent(self: ptr cQDialogButtonBox, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QDialogButtonBox_focusOutEvent ".} =
  ...
  nimfunc[](slotval1)
proc QDialogButtonBoxenterEvent*(self: gen_qdialogbuttonbox_types.QDialogButtonBox, event: QEvent): void =
  fQDialogButtonBox_virtualbase_enterEvent(self.h, event.h)

type QDialogButtonBoxenterEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QDialogButtonBox_enterEvent(self: ptr cQDialogButtonBox, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QDialogButtonBox_enterEvent ".} =
  ...
  nimfunc[](slotval1)
proc QDialogButtonBoxleaveEvent*(self: gen_qdialogbuttonbox_types.QDialogButtonBox, event: QEvent): void =
  fQDialogButtonBox_virtualbase_leaveEvent(self.h, event.h)

type QDialogButtonBoxleaveEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QDialogButtonBox_leaveEvent(self: ptr cQDialogButtonBox, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QDialogButtonBox_leaveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QDialogButtonBoxpaintEvent*(self: gen_qdialogbuttonbox_types.QDialogButtonBox, event: QPaintEvent): void =
  fQDialogButtonBox_virtualbase_paintEvent(self.h, event.h)

type QDialogButtonBoxpaintEventProc* = proc(event: QPaintEvent): void
...
proc miqt_exec_callback_QDialogButtonBox_paintEvent(self: ptr cQDialogButtonBox, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QDialogButtonBox_paintEvent ".} =
  ...
  nimfunc[](slotval1)
proc QDialogButtonBoxmoveEvent*(self: gen_qdialogbuttonbox_types.QDialogButtonBox, event: QMoveEvent): void =
  fQDialogButtonBox_virtualbase_moveEvent(self.h, event.h)

type QDialogButtonBoxmoveEventProc* = proc(event: QMoveEvent): void
...
proc miqt_exec_callback_QDialogButtonBox_moveEvent(self: ptr cQDialogButtonBox, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QDialogButtonBox_moveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QDialogButtonBoxresizeEvent*(self: gen_qdialogbuttonbox_types.QDialogButtonBox, event: QResizeEvent): void =
  fQDialogButtonBox_virtualbase_resizeEvent(self.h, event.h)

type QDialogButtonBoxresizeEventProc* = proc(event: QResizeEvent): void
...
proc miqt_exec_callback_QDialogButtonBox_resizeEvent(self: ptr cQDialogButtonBox, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QDialogButtonBox_resizeEvent ".} =
  ...
  nimfunc[](slotval1)
proc QDialogButtonBoxcloseEvent*(self: gen_qdialogbuttonbox_types.QDialogButtonBox, event: QCloseEvent): void =
  fQDialogButtonBox_virtualbase_closeEvent(self.h, event.h)

type QDialogButtonBoxcloseEventProc* = proc(event: QCloseEvent): void
...
proc miqt_exec_callback_QDialogButtonBox_closeEvent(self: ptr cQDialogButtonBox, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QDialogButtonBox_closeEvent ".} =
  ...
  nimfunc[](slotval1)
proc QDialogButtonBoxcontextMenuEvent*(self: gen_qdialogbuttonbox_types.QDialogButtonBox, event: QContextMenuEvent): void =
  fQDialogButtonBox_virtualbase_contextMenuEvent(self.h, event.h)

type QDialogButtonBoxcontextMenuEventProc* = proc(event: QContextMenuEvent): void
...
proc miqt_exec_callback_QDialogButtonBox_contextMenuEvent(self: ptr cQDialogButtonBox, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QDialogButtonBox_contextMenuEvent ".} =
  ...
  nimfunc[](slotval1)
proc QDialogButtonBoxtabletEvent*(self: gen_qdialogbuttonbox_types.QDialogButtonBox, event: QTabletEvent): void =
  fQDialogButtonBox_virtualbase_tabletEvent(self.h, event.h)

type QDialogButtonBoxtabletEventProc* = proc(event: QTabletEvent): void
...
proc miqt_exec_callback_QDialogButtonBox_tabletEvent(self: ptr cQDialogButtonBox, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QDialogButtonBox_tabletEvent ".} =
  ...
  nimfunc[](slotval1)
proc QDialogButtonBoxactionEvent*(self: gen_qdialogbuttonbox_types.QDialogButtonBox, event: QActionEvent): void =
  fQDialogButtonBox_virtualbase_actionEvent(self.h, event.h)

type QDialogButtonBoxactionEventProc* = proc(event: QActionEvent): void
...
proc miqt_exec_callback_QDialogButtonBox_actionEvent(self: ptr cQDialogButtonBox, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QDialogButtonBox_actionEvent ".} =
  ...
  nimfunc[](slotval1)
proc QDialogButtonBoxdragEnterEvent*(self: gen_qdialogbuttonbox_types.QDialogButtonBox, event: QDragEnterEvent): void =
  fQDialogButtonBox_virtualbase_dragEnterEvent(self.h, event.h)

type QDialogButtonBoxdragEnterEventProc* = proc(event: QDragEnterEvent): void
...
proc miqt_exec_callback_QDialogButtonBox_dragEnterEvent(self: ptr cQDialogButtonBox, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QDialogButtonBox_dragEnterEvent ".} =
  ...
  nimfunc[](slotval1)
proc QDialogButtonBoxdragMoveEvent*(self: gen_qdialogbuttonbox_types.QDialogButtonBox, event: QDragMoveEvent): void =
  fQDialogButtonBox_virtualbase_dragMoveEvent(self.h, event.h)

type QDialogButtonBoxdragMoveEventProc* = proc(event: QDragMoveEvent): void
...
proc miqt_exec_callback_QDialogButtonBox_dragMoveEvent(self: ptr cQDialogButtonBox, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QDialogButtonBox_dragMoveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QDialogButtonBoxdragLeaveEvent*(self: gen_qdialogbuttonbox_types.QDialogButtonBox, event: QDragLeaveEvent): void =
  fQDialogButtonBox_virtualbase_dragLeaveEvent(self.h, event.h)

type QDialogButtonBoxdragLeaveEventProc* = proc(event: QDragLeaveEvent): void
...
proc miqt_exec_callback_QDialogButtonBox_dragLeaveEvent(self: ptr cQDialogButtonBox, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QDialogButtonBox_dragLeaveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QDialogButtonBoxdropEvent*(self: gen_qdialogbuttonbox_types.QDialogButtonBox, event: QDropEvent): void =
  fQDialogButtonBox_virtualbase_dropEvent(self.h, event.h)

type QDialogButtonBoxdropEventProc* = proc(event: QDropEvent): void
...
proc miqt_exec_callback_QDialogButtonBox_dropEvent(self: ptr cQDialogButtonBox, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QDialogButtonBox_dropEvent ".} =
  ...
  nimfunc[](slotval1)
proc QDialogButtonBoxshowEvent*(self: gen_qdialogbuttonbox_types.QDialogButtonBox, event: QShowEvent): void =
  fQDialogButtonBox_virtualbase_showEvent(self.h, event.h)

type QDialogButtonBoxshowEventProc* = proc(event: QShowEvent): void
...
proc miqt_exec_callback_QDialogButtonBox_showEvent(self: ptr cQDialogButtonBox, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QDialogButtonBox_showEvent ".} =
  ...
  nimfunc[](slotval1)
proc QDialogButtonBoxhideEvent*(self: gen_qdialogbuttonbox_types.QDialogButtonBox, event: QHideEvent): void =
  fQDialogButtonBox_virtualbase_hideEvent(self.h, event.h)

type QDialogButtonBoxhideEventProc* = proc(event: QHideEvent): void
...
proc miqt_exec_callback_QDialogButtonBox_metric(self: ptr cQDialogButtonBox, slot: int, param1: cint): cint {.exportc: "miqt_exec_callback_QDialogButtonBox_metric ".} =
  ...
  virtualReturn
proc QDialogButtonBoxinitPainter*(self: gen_qdialogbuttonbox_types.QDialogButtonBox, painter: QPainter): void =
  fQDialogButtonBox_virtualbase_initPainter(self.h, painter.h)

type QDialogButtonBoxinitPainterProc* = proc(painter: QPainter): void
...
proc miqt_exec_callback_QDialogButtonBox_initPainter(self: ptr cQDialogButtonBox, slot: int, painter: pointer): void {.exportc: "miqt_exec_callback_QDialogButtonBox_initPainter ".} =
  ...
  nimfunc[](slotval1)
proc QDialogButtonBoxredirected*(self: gen_qdialogbuttonbox_types.QDialogButtonBox, offset: QPoint): QPaintDevice =
  QPaintDevice(h: fQDialogButtonBox_virtualbase_redirected(self.h, offset.h))

type QDialogButtonBoxredirectedProc* = proc(offset: QPoint): QPaintDevice
...
proc miqt_exec_callback_QDialogButtonBox_redirected(self: ptr cQDialogButtonBox, slot: int, offset: pointer): pointer {.exportc: "miqt_exec_callback_QDialogButtonBox_redirected ".} =
  ...
  virtualReturn.h
proc QDialogButtonBoxsharedPainter*(self: gen_qdialogbuttonbox_types.QDialogButtonBox, ): QPainter =
  QPainter(h: fQDialogButtonBox_virtualbase_sharedPainter(self.h))

type QDialogButtonBoxsharedPainterProc* = proc(): QPainter
...
proc miqt_exec_callback_QDialogButtonBox_sharedPainter(self: ptr cQDialogButtonBox, slot: int): pointer {.exportc: "miqt_exec_callback_QDialogButtonBox_sharedPainter ".} =
  ...
  virtualReturn.h
proc QDialogButtonBoxinputMethodEvent*(self: gen_qdialogbuttonbox_types.QDialogButtonBox, param1: QInputMethodEvent): void =
  fQDialogButtonBox_virtualbase_inputMethodEvent(self.h, param1.h)

type QDialogButtonBoxinputMethodEventProc* = proc(param1: QInputMethodEvent): void
...
proc miqt_exec_callback_QDialogButtonBox_inputMethodEvent(self: ptr cQDialogButtonBox, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QDialogButtonBox_inputMethodEvent ".} =
  ...
  nimfunc[](slotval1)
proc QDialogButtonBoxinputMethodQuery*(self: gen_qdialogbuttonbox_types.QDialogButtonBox, param1: cint): QVariant =
  QVariant(h: fQDialogButtonBox_virtualbase_inputMethodQuery(self.h, cint(param1)))

type QDialogButtonBoxinputMethodQueryProc* = proc(param1: cint): QVariant
...
proc miqt_exec_callback_QDialogButtonBox_focusNextPrevChild(self: ptr cQDialogButtonBox, slot: int, next: bool): bool {.exportc: "miqt_exec_callback_QDialogButtonBox_focusNextPrevChild ".} =
  ...
  virtualReturn
proc QDialogButtonBoxeventFilter*(self: gen_qdialogbuttonbox_types.QDialogButtonBox, watched: QObject, event: QEvent): bool =
  fQDialogButtonBox_virtualbase_eventFilter(self.h, watched.h, event.h)

type QDialogButtonBoxeventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QDialogButtonBox_eventFilter(self: ptr cQDialogButtonBox, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QDialogButtonBox_eventFilter ".} =
  ...
  virtualReturn
proc QDialogButtonBoxtimerEvent*(self: gen_qdialogbuttonbox_types.QDialogButtonBox, event: QTimerEvent): void =
  fQDialogButtonBox_virtualbase_timerEvent(self.h, event.h)

type QDialogButtonBoxtimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QDialogButtonBox_timerEvent(self: ptr cQDialogButtonBox, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QDialogButtonBox_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QDialogButtonBoxchildEvent*(self: gen_qdialogbuttonbox_types.QDialogButtonBox, event: QChildEvent): void =
  fQDialogButtonBox_virtualbase_childEvent(self.h, event.h)

type QDialogButtonBoxchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QDialogButtonBox_childEvent(self: ptr cQDialogButtonBox, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QDialogButtonBox_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QDialogButtonBoxcustomEvent*(self: gen_qdialogbuttonbox_types.QDialogButtonBox, event: QEvent): void =
  fQDialogButtonBox_virtualbase_customEvent(self.h, event.h)

type QDialogButtonBoxcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QDialogButtonBox_customEvent(self: ptr cQDialogButtonBox, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QDialogButtonBox_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QDialogButtonBoxconnectNotify*(self: gen_qdialogbuttonbox_types.QDialogButtonBox, signal: QMetaMethod): void =
  fQDialogButtonBox_virtualbase_connectNotify(self.h, signal.h)

type QDialogButtonBoxconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QDialogButtonBox_connectNotify(self: ptr cQDialogButtonBox, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QDialogButtonBox_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QDialogButtonBoxdisconnectNotify*(self: gen_qdialogbuttonbox_types.QDialogButtonBox, signal: QMetaMethod): void =
  fQDialogButtonBox_virtualbase_disconnectNotify(self.h, signal.h)

type QDialogButtonBoxdisconnectNotifyProc* = proc(signal: QMetaMethod): void
