...
proc miqt_exec_callback_QGroupBox_focusOutEvent(self: ptr cQGroupBox, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGroupBox_focusOutEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGroupBoxenterEvent*(self: gen_qgroupbox_types.QGroupBox, event: QEvent): void =
  fQGroupBox_virtualbase_enterEvent(self.h, event.h)

type QGroupBoxenterEventProc* = proc(event: QEvent): void
...
type QGroupBoxnativeEventProc* = proc(eventType: seq[byte], message: pointer, resultVal: ptr clong): bool
