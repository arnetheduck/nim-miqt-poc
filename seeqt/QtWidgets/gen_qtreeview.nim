...
func init*(T: type gen_qtreeview_types.QTreeView, h: ptr cQTreeView): gen_qtreeview_types.QTreeView =
  T(h: h)
proc create*(T: type gen_qtreeview_types.QTreeView, parent: QWidget): gen_qtreeview_types.QTreeView =
...
proc metaObject*(self: gen_qtreeview_types.QTreeView, ): QMetaObject =
  QMetaObject(h: fcQTreeView_metaObject(self.h))
...
proc setModel*(self: gen_qtreeview_types.QTreeView, model: QAbstractItemModel): void =
  fcQTreeView_setModel(self.h, model.h)

proc setRootIndex*(self: gen_qtreeview_types.QTreeView, index: QModelIndex): void =
  fcQTreeView_setRootIndex(self.h, index.h)

proc setSelectionModel*(self: gen_qtreeview_types.QTreeView, selectionModel: QItemSelectionModel): void =
  fcQTreeView_setSelectionModel(self.h, selectionModel.h)

proc header*(self: gen_qtreeview_types.QTreeView, ): QHeaderView =
  QHeaderView(h: fcQTreeView_header(self.h))

proc setHeader*(self: gen_qtreeview_types.QTreeView, header: QHeaderView): void =
...
proc isRowHidden*(self: gen_qtreeview_types.QTreeView, row: cint, parent: QModelIndex): bool =
  fcQTreeView_isRowHidden(self.h, row, parent.h)

proc setRowHidden*(self: gen_qtreeview_types.QTreeView, row: cint, parent: QModelIndex, hide: bool): void =
  fcQTreeView_setRowHidden(self.h, row, parent.h, hide)

proc isFirstColumnSpanned*(self: gen_qtreeview_types.QTreeView, row: cint, parent: QModelIndex): bool =
  fcQTreeView_isFirstColumnSpanned(self.h, row, parent.h)

proc setFirstColumnSpanned*(self: gen_qtreeview_types.QTreeView, row: cint, parent: QModelIndex, span: bool): void =
  fcQTreeView_setFirstColumnSpanned(self.h, row, parent.h, span)

proc isExpanded*(self: gen_qtreeview_types.QTreeView, index: QModelIndex): bool =
  fcQTreeView_isExpanded(self.h, index.h)

proc setExpanded*(self: gen_qtreeview_types.QTreeView, index: QModelIndex, expand: bool): void =
...
proc visualRect*(self: gen_qtreeview_types.QTreeView, index: QModelIndex): QRect =
  QRect(h: fcQTreeView_visualRect(self.h, index.h))

proc scrollTo*(self: gen_qtreeview_types.QTreeView, index: QModelIndex, hint: cint): void =
  fcQTreeView_scrollTo(self.h, index.h, cint(hint))

proc indexAt*(self: gen_qtreeview_types.QTreeView, p: QPoint): QModelIndex =
  QModelIndex(h: fcQTreeView_indexAt(self.h, p.h))

proc indexAbove*(self: gen_qtreeview_types.QTreeView, index: QModelIndex): QModelIndex =
  QModelIndex(h: fcQTreeView_indexAbove(self.h, index.h))

proc indexBelow*(self: gen_qtreeview_types.QTreeView, index: QModelIndex): QModelIndex =
  QModelIndex(h: fcQTreeView_indexBelow(self.h, index.h))
...
proc dataChanged*(self: gen_qtreeview_types.QTreeView, topLeft: QModelIndex, bottomRight: QModelIndex, roles: seq[cint]): void =
...
proc expanded*(self: gen_qtreeview_types.QTreeView, index: QModelIndex): void =
  fcQTreeView_expanded(self.h, index.h)

type QTreeViewexpandedSlot* = proc(index: QModelIndex)
...
proc collapsed*(self: gen_qtreeview_types.QTreeView, index: QModelIndex): void =
  fcQTreeView_collapsed(self.h, index.h)

type QTreeViewcollapsedSlot* = proc(index: QModelIndex)
...
proc expand*(self: gen_qtreeview_types.QTreeView, index: QModelIndex): void =
  fcQTreeView_expand(self.h, index.h)

proc collapse*(self: gen_qtreeview_types.QTreeView, index: QModelIndex): void =
...
proc expandRecursively*(self: gen_qtreeview_types.QTreeView, index: QModelIndex): void =
...
proc expandRecursively*(self: gen_qtreeview_types.QTreeView, index: QModelIndex, depth: cint): void =
...
proc miqt_exec_callback_QTreeView_metacall(self: ptr cQTreeView, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QTreeView_metacall ".} =
  ...
  virtualReturn
proc QTreeViewsetModel*(self: gen_qtreeview_types.QTreeView, model: QAbstractItemModel): void =
  fQTreeView_virtualbase_setModel(self.h, model.h)

type QTreeViewsetModelProc* = proc(model: QAbstractItemModel): void
...
proc miqt_exec_callback_QTreeView_setModel(self: ptr cQTreeView, slot: int, model: pointer): void {.exportc: "miqt_exec_callback_QTreeView_setModel ".} =
  ...
  nimfunc[](slotval1)
proc QTreeViewsetRootIndex*(self: gen_qtreeview_types.QTreeView, index: QModelIndex): void =
  fQTreeView_virtualbase_setRootIndex(self.h, index.h)

type QTreeViewsetRootIndexProc* = proc(index: QModelIndex): void
...
proc miqt_exec_callback_QTreeView_setRootIndex(self: ptr cQTreeView, slot: int, index: pointer): void {.exportc: "miqt_exec_callback_QTreeView_setRootIndex ".} =
  ...
  nimfunc[](slotval1)
proc QTreeViewsetSelectionModel*(self: gen_qtreeview_types.QTreeView, selectionModel: QItemSelectionModel): void =
  fQTreeView_virtualbase_setSelectionModel(self.h, selectionModel.h)

type QTreeViewsetSelectionModelProc* = proc(selectionModel: QItemSelectionModel): void
...
proc miqt_exec_callback_QTreeView_keyboardSearch(self: ptr cQTreeView, slot: int, search: struct_miqt_string): void {.exportc: "miqt_exec_callback_QTreeView_keyboardSearch ".} =
  ...
  nimfunc[](slotval1)
proc QTreeViewvisualRect*(self: gen_qtreeview_types.QTreeView, index: QModelIndex): QRect =
  QRect(h: fQTreeView_virtualbase_visualRect(self.h, index.h))

type QTreeViewvisualRectProc* = proc(index: QModelIndex): QRect
...
proc miqt_exec_callback_QTreeView_visualRect(self: ptr cQTreeView, slot: int, index: pointer): pointer {.exportc: "miqt_exec_callback_QTreeView_visualRect ".} =
  ...
  virtualReturn.h
proc QTreeViewscrollTo*(self: gen_qtreeview_types.QTreeView, index: QModelIndex, hint: cint): void =
  fQTreeView_virtualbase_scrollTo(self.h, index.h, cint(hint))

type QTreeViewscrollToProc* = proc(index: QModelIndex, hint: cint): void
...
proc QTreeViewindexAt*(self: gen_qtreeview_types.QTreeView, p: QPoint): QModelIndex =
  QModelIndex(h: fQTreeView_virtualbase_indexAt(self.h, p.h))

type QTreeViewindexAtProc* = proc(p: QPoint): QModelIndex
...
proc miqt_exec_callback_QTreeView_reset(self: ptr cQTreeView, slot: int): void {.exportc: "miqt_exec_callback_QTreeView_reset ".} =
  ...
  nimfunc[]()
proc QTreeViewdataChanged*(self: gen_qtreeview_types.QTreeView, topLeft: QModelIndex, bottomRight: QModelIndex, roles: seq[cint]): void =
  var roles_CArray = newSeq[cint](len(roles))
  for i in 0..<len(roles):
    roles_CArray[i] = roles[i]
...
type QTreeViewdataChangedProc* = proc(topLeft: QModelIndex, bottomRight: QModelIndex, roles: seq[cint]): void
...
proc miqt_exec_callback_QTreeView_scrollContentsBy(self: ptr cQTreeView, slot: int, dx: cint, dy: cint): void {.exportc: "miqt_exec_callback_QTreeView_scrollContentsBy ".} =
  ...
  nimfunc[](slotval1, slotval2)
proc QTreeViewrowsInserted*(self: gen_qtreeview_types.QTreeView, parent: QModelIndex, start: cint, endVal: cint): void =
  fQTreeView_virtualbase_rowsInserted(self.h, parent.h, start, endVal)

type QTreeViewrowsInsertedProc* = proc(parent: QModelIndex, start: cint, endVal: cint): void
...
proc miqt_exec_callback_QTreeView_rowsInserted(self: ptr cQTreeView, slot: int, parent: pointer, start: cint, endVal: cint): void {.exportc: "miqt_exec_callback_QTreeView_rowsInserted ".} =
  ...
  nimfunc[](slotval1, slotval2, slotval3)
proc QTreeViewrowsAboutToBeRemoved*(self: gen_qtreeview_types.QTreeView, parent: QModelIndex, start: cint, endVal: cint): void =
  fQTreeView_virtualbase_rowsAboutToBeRemoved(self.h, parent.h, start, endVal)

type QTreeViewrowsAboutToBeRemovedProc* = proc(parent: QModelIndex, start: cint, endVal: cint): void
...
proc miqt_exec_callback_QTreeView_rowsAboutToBeRemoved(self: ptr cQTreeView, slot: int, parent: pointer, start: cint, endVal: cint): void {.exportc: "miqt_exec_callback_QTreeView_rowsAboutToBeRemoved ".} =
  ...
  nimfunc[](slotval1, slotval2, slotval3)
proc QTreeViewmoveCursor*(self: gen_qtreeview_types.QTreeView, cursorAction: cint, modifiers: cint): QModelIndex =
  QModelIndex(h: fQTreeView_virtualbase_moveCursor(self.h, cint(cursorAction), cint(modifiers)))

type QTreeViewmoveCursorProc* = proc(cursorAction: cint, modifiers: cint): QModelIndex
...
proc miqt_exec_callback_QTreeView_verticalOffset(self: ptr cQTreeView, slot: int): cint {.exportc: "miqt_exec_callback_QTreeView_verticalOffset ".} =
  ...
  virtualReturn
proc QTreeViewsetSelection*(self: gen_qtreeview_types.QTreeView, rect: QRect, command: cint): void =
  fQTreeView_virtualbase_setSelection(self.h, rect.h, cint(command))

type QTreeViewsetSelectionProc* = proc(rect: QRect, command: cint): void
...
proc miqt_exec_callback_QTreeView_setSelection(self: ptr cQTreeView, slot: int, rect: pointer, command: cint): void {.exportc: "miqt_exec_callback_QTreeView_setSelection ".} =
  ...
  nimfunc[](slotval1, slotval2)
proc QTreeViewvisualRegionForSelection*(self: gen_qtreeview_types.QTreeView, selection: QItemSelection): QRegion =
  QRegion(h: fQTreeView_virtualbase_visualRegionForSelection(self.h, selection.h))

type QTreeViewvisualRegionForSelectionProc* = proc(selection: QItemSelection): QRegion
...
proc miqt_exec_callback_QTreeView_visualRegionForSelection(self: ptr cQTreeView, slot: int, selection: pointer): pointer {.exportc: "miqt_exec_callback_QTreeView_visualRegionForSelection ".} =
  ...
  virtualReturn.h
proc QTreeViewselectedIndexes*(self: gen_qtreeview_types.QTreeView, ): seq[QModelIndex] =
...
type QTreeViewselectedIndexesProc* = proc(): seq[QModelIndex]
...
proc QTreeViewchangeEvent*(self: gen_qtreeview_types.QTreeView, event: QEvent): void =
  fQTreeView_virtualbase_changeEvent(self.h, event.h)

type QTreeViewchangeEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QTreeView_changeEvent(self: ptr cQTreeView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTreeView_changeEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTreeViewtimerEvent*(self: gen_qtreeview_types.QTreeView, event: QTimerEvent): void =
  fQTreeView_virtualbase_timerEvent(self.h, event.h)

type QTreeViewtimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QTreeView_timerEvent(self: ptr cQTreeView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTreeView_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTreeViewpaintEvent*(self: gen_qtreeview_types.QTreeView, event: QPaintEvent): void =
  fQTreeView_virtualbase_paintEvent(self.h, event.h)

type QTreeViewpaintEventProc* = proc(event: QPaintEvent): void
...
proc miqt_exec_callback_QTreeView_paintEvent(self: ptr cQTreeView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTreeView_paintEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTreeViewdrawRow*(self: gen_qtreeview_types.QTreeView, painter: QPainter, options: QStyleOptionViewItem, index: QModelIndex): void =
  fQTreeView_virtualbase_drawRow(self.h, painter.h, options.h, index.h)

type QTreeViewdrawRowProc* = proc(painter: QPainter, options: QStyleOptionViewItem, index: QModelIndex): void
...
proc miqt_exec_callback_QTreeView_drawRow(self: ptr cQTreeView, slot: int, painter: pointer, options: pointer, index: pointer): void {.exportc: "miqt_exec_callback_QTreeView_drawRow ".} =
  ...
  nimfunc[](slotval1, slotval2, slotval3)
proc QTreeViewdrawBranches*(self: gen_qtreeview_types.QTreeView, painter: QPainter, rect: QRect, index: QModelIndex): void =
  fQTreeView_virtualbase_drawBranches(self.h, painter.h, rect.h, index.h)

type QTreeViewdrawBranchesProc* = proc(painter: QPainter, rect: QRect, index: QModelIndex): void
...
proc miqt_exec_callback_QTreeView_drawBranches(self: ptr cQTreeView, slot: int, painter: pointer, rect: pointer, index: pointer): void {.exportc: "miqt_exec_callback_QTreeView_drawBranches ".} =
  ...
  nimfunc[](slotval1, slotval2, slotval3)
proc QTreeViewmousePressEvent*(self: gen_qtreeview_types.QTreeView, event: QMouseEvent): void =
  fQTreeView_virtualbase_mousePressEvent(self.h, event.h)

type QTreeViewmousePressEventProc* = proc(event: QMouseEvent): void
...
proc miqt_exec_callback_QTreeView_mousePressEvent(self: ptr cQTreeView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTreeView_mousePressEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTreeViewmouseReleaseEvent*(self: gen_qtreeview_types.QTreeView, event: QMouseEvent): void =
  fQTreeView_virtualbase_mouseReleaseEvent(self.h, event.h)

type QTreeViewmouseReleaseEventProc* = proc(event: QMouseEvent): void
...
proc miqt_exec_callback_QTreeView_mouseReleaseEvent(self: ptr cQTreeView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTreeView_mouseReleaseEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTreeViewmouseDoubleClickEvent*(self: gen_qtreeview_types.QTreeView, event: QMouseEvent): void =
  fQTreeView_virtualbase_mouseDoubleClickEvent(self.h, event.h)

type QTreeViewmouseDoubleClickEventProc* = proc(event: QMouseEvent): void
...
proc miqt_exec_callback_QTreeView_mouseDoubleClickEvent(self: ptr cQTreeView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTreeView_mouseDoubleClickEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTreeViewmouseMoveEvent*(self: gen_qtreeview_types.QTreeView, event: QMouseEvent): void =
  fQTreeView_virtualbase_mouseMoveEvent(self.h, event.h)

type QTreeViewmouseMoveEventProc* = proc(event: QMouseEvent): void
...
proc miqt_exec_callback_QTreeView_mouseMoveEvent(self: ptr cQTreeView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTreeView_mouseMoveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTreeViewkeyPressEvent*(self: gen_qtreeview_types.QTreeView, event: QKeyEvent): void =
  fQTreeView_virtualbase_keyPressEvent(self.h, event.h)

type QTreeViewkeyPressEventProc* = proc(event: QKeyEvent): void
...
proc miqt_exec_callback_QTreeView_keyPressEvent(self: ptr cQTreeView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTreeView_keyPressEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTreeViewdragMoveEvent*(self: gen_qtreeview_types.QTreeView, event: QDragMoveEvent): void =
  fQTreeView_virtualbase_dragMoveEvent(self.h, event.h)

type QTreeViewdragMoveEventProc* = proc(event: QDragMoveEvent): void
...
proc miqt_exec_callback_QTreeView_dragMoveEvent(self: ptr cQTreeView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTreeView_dragMoveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTreeViewviewportEvent*(self: gen_qtreeview_types.QTreeView, event: QEvent): bool =
  fQTreeView_virtualbase_viewportEvent(self.h, event.h)

type QTreeViewviewportEventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QTreeView_updateGeometries(self: ptr cQTreeView, slot: int): void {.exportc: "miqt_exec_callback_QTreeView_updateGeometries ".} =
  ...
  nimfunc[]()
proc QTreeViewviewportSizeHint*(self: gen_qtreeview_types.QTreeView, ): QSize =
  QSize(h: fQTreeView_virtualbase_viewportSizeHint(self.h))

type QTreeViewviewportSizeHintProc* = proc(): QSize
...
proc miqt_exec_callback_QTreeView_horizontalScrollbarAction(self: ptr cQTreeView, slot: int, action: cint): void {.exportc: "miqt_exec_callback_QTreeView_horizontalScrollbarAction ".} =
  ...
  nimfunc[](slotval1)
proc QTreeViewisIndexHidden*(self: gen_qtreeview_types.QTreeView, index: QModelIndex): bool =
  fQTreeView_virtualbase_isIndexHidden(self.h, index.h)

type QTreeViewisIndexHiddenProc* = proc(index: QModelIndex): bool
...
proc miqt_exec_callback_QTreeView_isIndexHidden(self: ptr cQTreeView, slot: int, index: pointer): bool {.exportc: "miqt_exec_callback_QTreeView_isIndexHidden ".} =
  ...
  virtualReturn
proc QTreeViewselectionChanged*(self: gen_qtreeview_types.QTreeView, selected: QItemSelection, deselected: QItemSelection): void =
  fQTreeView_virtualbase_selectionChanged(self.h, selected.h, deselected.h)

type QTreeViewselectionChangedProc* = proc(selected: QItemSelection, deselected: QItemSelection): void
...
proc miqt_exec_callback_QTreeView_selectionChanged(self: ptr cQTreeView, slot: int, selected: pointer, deselected: pointer): void {.exportc: "miqt_exec_callback_QTreeView_selectionChanged ".} =
  ...
  nimfunc[](slotval1, slotval2)
proc QTreeViewcurrentChanged*(self: gen_qtreeview_types.QTreeView, current: QModelIndex, previous: QModelIndex): void =
  fQTreeView_virtualbase_currentChanged(self.h, current.h, previous.h)

type QTreeViewcurrentChangedProc* = proc(current: QModelIndex, previous: QModelIndex): void
...
proc miqt_exec_callback_QTreeView_sizeHintForRow(self: ptr cQTreeView, slot: int, row: cint): cint {.exportc: "miqt_exec_callback_QTreeView_sizeHintForRow ".} =
  ...
  virtualReturn
proc QTreeViewitemDelegateForIndex*(self: gen_qtreeview_types.QTreeView, index: QModelIndex): QAbstractItemDelegate =
  QAbstractItemDelegate(h: fQTreeView_virtualbase_itemDelegateForIndex(self.h, index.h))

type QTreeViewitemDelegateForIndexProc* = proc(index: QModelIndex): QAbstractItemDelegate
...
proc miqt_exec_callback_QTreeView_itemDelegateForIndex(self: ptr cQTreeView, slot: int, index: pointer): pointer {.exportc: "miqt_exec_callback_QTreeView_itemDelegateForIndex ".} =
  ...
  virtualReturn.h
proc QTreeViewinputMethodQuery*(self: gen_qtreeview_types.QTreeView, query: cint): QVariant =
  QVariant(h: fQTreeView_virtualbase_inputMethodQuery(self.h, cint(query)))

type QTreeViewinputMethodQueryProc* = proc(query: cint): QVariant
...
proc miqt_exec_callback_QTreeView_horizontalScrollbarValueChanged(self: ptr cQTreeView, slot: int, value: cint): void {.exportc: "miqt_exec_callback_QTreeView_horizontalScrollbarValueChanged ".} =
  ...
  nimfunc[](slotval1)
proc QTreeViewcloseEditor*(self: gen_qtreeview_types.QTreeView, editor: QWidget, hint: cint): void =
  fQTreeView_virtualbase_closeEditor(self.h, editor.h, cint(hint))

type QTreeViewcloseEditorProc* = proc(editor: QWidget, hint: cint): void
...
proc miqt_exec_callback_QTreeView_closeEditor(self: ptr cQTreeView, slot: int, editor: pointer, hint: cint): void {.exportc: "miqt_exec_callback_QTreeView_closeEditor ".} =
  ...
  nimfunc[](slotval1, slotval2)
proc QTreeViewcommitData*(self: gen_qtreeview_types.QTreeView, editor: QWidget): void =
  fQTreeView_virtualbase_commitData(self.h, editor.h)

type QTreeViewcommitDataProc* = proc(editor: QWidget): void
...
proc miqt_exec_callback_QTreeView_commitData(self: ptr cQTreeView, slot: int, editor: pointer): void {.exportc: "miqt_exec_callback_QTreeView_commitData ".} =
  ...
  nimfunc[](slotval1)
proc QTreeVieweditorDestroyed*(self: gen_qtreeview_types.QTreeView, editor: QObject): void =
  fQTreeView_virtualbase_editorDestroyed(self.h, editor.h)

type QTreeVieweditorDestroyedProc* = proc(editor: QObject): void
...
proc miqt_exec_callback_QTreeView_editorDestroyed(self: ptr cQTreeView, slot: int, editor: pointer): void {.exportc: "miqt_exec_callback_QTreeView_editorDestroyed ".} =
  ...
  nimfunc[](slotval1)
proc QTreeViewedit*(self: gen_qtreeview_types.QTreeView, index: QModelIndex, trigger: cint, event: QEvent): bool =
  fQTreeView_virtualbase_edit2(self.h, index.h, cint(trigger), event.h)

type QTreeViewedit2Proc* = proc(index: QModelIndex, trigger: cint, event: QEvent): bool
...
proc miqt_exec_callback_QTreeView_edit2(self: ptr cQTreeView, slot: int, index: pointer, trigger: cint, event: pointer): bool {.exportc: "miqt_exec_callback_QTreeView_edit2 ".} =
  ...
  virtualReturn
proc QTreeViewselectionCommand*(self: gen_qtreeview_types.QTreeView, index: QModelIndex, event: QEvent): cint =
  cint(fQTreeView_virtualbase_selectionCommand(self.h, index.h, event.h))

type QTreeViewselectionCommandProc* = proc(index: QModelIndex, event: QEvent): cint
...
proc miqt_exec_callback_QTreeView_startDrag(self: ptr cQTreeView, slot: int, supportedActions: cint): void {.exportc: "miqt_exec_callback_QTreeView_startDrag ".} =
  ...
  nimfunc[](slotval1)
proc QTreeViewinitViewItemOption*(self: gen_qtreeview_types.QTreeView, option: QStyleOptionViewItem): void =
  fQTreeView_virtualbase_initViewItemOption(self.h, option.h)

type QTreeViewinitViewItemOptionProc* = proc(option: QStyleOptionViewItem): void
...
proc miqt_exec_callback_QTreeView_focusNextPrevChild(self: ptr cQTreeView, slot: int, next: bool): bool {.exportc: "miqt_exec_callback_QTreeView_focusNextPrevChild ".} =
  ...
  virtualReturn
proc QTreeViewevent*(self: gen_qtreeview_types.QTreeView, event: QEvent): bool =
  fQTreeView_virtualbase_event(self.h, event.h)

type QTreeVieweventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QTreeView_event(self: ptr cQTreeView, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QTreeView_event ".} =
  ...
  virtualReturn
proc QTreeViewdragEnterEvent*(self: gen_qtreeview_types.QTreeView, event: QDragEnterEvent): void =
  fQTreeView_virtualbase_dragEnterEvent(self.h, event.h)

type QTreeViewdragEnterEventProc* = proc(event: QDragEnterEvent): void
...
proc miqt_exec_callback_QTreeView_dragEnterEvent(self: ptr cQTreeView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTreeView_dragEnterEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTreeViewdragLeaveEvent*(self: gen_qtreeview_types.QTreeView, event: QDragLeaveEvent): void =
  fQTreeView_virtualbase_dragLeaveEvent(self.h, event.h)

type QTreeViewdragLeaveEventProc* = proc(event: QDragLeaveEvent): void
...
proc miqt_exec_callback_QTreeView_dragLeaveEvent(self: ptr cQTreeView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTreeView_dragLeaveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTreeViewdropEvent*(self: gen_qtreeview_types.QTreeView, event: QDropEvent): void =
  fQTreeView_virtualbase_dropEvent(self.h, event.h)

type QTreeViewdropEventProc* = proc(event: QDropEvent): void
...
proc miqt_exec_callback_QTreeView_dropEvent(self: ptr cQTreeView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTreeView_dropEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTreeViewfocusInEvent*(self: gen_qtreeview_types.QTreeView, event: QFocusEvent): void =
  fQTreeView_virtualbase_focusInEvent(self.h, event.h)

type QTreeViewfocusInEventProc* = proc(event: QFocusEvent): void
...
proc miqt_exec_callback_QTreeView_focusInEvent(self: ptr cQTreeView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTreeView_focusInEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTreeViewfocusOutEvent*(self: gen_qtreeview_types.QTreeView, event: QFocusEvent): void =
  fQTreeView_virtualbase_focusOutEvent(self.h, event.h)

type QTreeViewfocusOutEventProc* = proc(event: QFocusEvent): void
...
proc miqt_exec_callback_QTreeView_focusOutEvent(self: ptr cQTreeView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTreeView_focusOutEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTreeViewresizeEvent*(self: gen_qtreeview_types.QTreeView, event: QResizeEvent): void =
  fQTreeView_virtualbase_resizeEvent(self.h, event.h)

type QTreeViewresizeEventProc* = proc(event: QResizeEvent): void
...
proc miqt_exec_callback_QTreeView_resizeEvent(self: ptr cQTreeView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTreeView_resizeEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTreeViewinputMethodEvent*(self: gen_qtreeview_types.QTreeView, event: QInputMethodEvent): void =
  fQTreeView_virtualbase_inputMethodEvent(self.h, event.h)

type QTreeViewinputMethodEventProc* = proc(event: QInputMethodEvent): void
...
proc miqt_exec_callback_QTreeView_inputMethodEvent(self: ptr cQTreeView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTreeView_inputMethodEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTreeVieweventFilter*(self: gen_qtreeview_types.QTreeView, objectVal: QObject, event: QEvent): bool =
  fQTreeView_virtualbase_eventFilter(self.h, objectVal.h, event.h)

type QTreeVieweventFilterProc* = proc(objectVal: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QTreeView_eventFilter(self: ptr cQTreeView, slot: int, objectVal: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QTreeView_eventFilter ".} =
  ...
  virtualReturn
proc QTreeViewminimumSizeHint*(self: gen_qtreeview_types.QTreeView, ): QSize =
  QSize(h: fQTreeView_virtualbase_minimumSizeHint(self.h))

type QTreeViewminimumSizeHintProc* = proc(): QSize
...
proc miqt_exec_callback_QTreeView_minimumSizeHint(self: ptr cQTreeView, slot: int): pointer {.exportc: "miqt_exec_callback_QTreeView_minimumSizeHint ".} =
  ...
  virtualReturn.h
proc QTreeViewsizeHint*(self: gen_qtreeview_types.QTreeView, ): QSize =
  QSize(h: fQTreeView_virtualbase_sizeHint(self.h))

type QTreeViewsizeHintProc* = proc(): QSize
...
proc miqt_exec_callback_QTreeView_sizeHint(self: ptr cQTreeView, slot: int): pointer {.exportc: "miqt_exec_callback_QTreeView_sizeHint ".} =
  ...
  virtualReturn.h
proc QTreeViewsetupViewport*(self: gen_qtreeview_types.QTreeView, viewport: QWidget): void =
  fQTreeView_virtualbase_setupViewport(self.h, viewport.h)

type QTreeViewsetupViewportProc* = proc(viewport: QWidget): void
...
proc miqt_exec_callback_QTreeView_setupViewport(self: ptr cQTreeView, slot: int, viewport: pointer): void {.exportc: "miqt_exec_callback_QTreeView_setupViewport ".} =
  ...
  nimfunc[](slotval1)
proc QTreeViewwheelEvent*(self: gen_qtreeview_types.QTreeView, param1: QWheelEvent): void =
  fQTreeView_virtualbase_wheelEvent(self.h, param1.h)

type QTreeViewwheelEventProc* = proc(param1: QWheelEvent): void
...
proc miqt_exec_callback_QTreeView_wheelEvent(self: ptr cQTreeView, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QTreeView_wheelEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTreeViewcontextMenuEvent*(self: gen_qtreeview_types.QTreeView, param1: QContextMenuEvent): void =
  fQTreeView_virtualbase_contextMenuEvent(self.h, param1.h)

type QTreeViewcontextMenuEventProc* = proc(param1: QContextMenuEvent): void
...
proc miqt_exec_callback_QTreeView_contextMenuEvent(self: ptr cQTreeView, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QTreeView_contextMenuEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTreeViewinitStyleOption*(self: gen_qtreeview_types.QTreeView, option: QStyleOptionFrame): void =
  fQTreeView_virtualbase_initStyleOption(self.h, option.h)

type QTreeViewinitStyleOptionProc* = proc(option: QStyleOptionFrame): void
...
proc miqt_exec_callback_QTreeView_hasHeightForWidth(self: ptr cQTreeView, slot: int): bool {.exportc: "miqt_exec_callback_QTreeView_hasHeightForWidth ".} =
  ...
  virtualReturn
proc QTreeViewpaintEngine*(self: gen_qtreeview_types.QTreeView, ): QPaintEngine =
  QPaintEngine(h: fQTreeView_virtualbase_paintEngine(self.h))

type QTreeViewpaintEngineProc* = proc(): QPaintEngine
...
proc miqt_exec_callback_QTreeView_paintEngine(self: ptr cQTreeView, slot: int): pointer {.exportc: "miqt_exec_callback_QTreeView_paintEngine ".} =
  ...
  virtualReturn.h
proc QTreeViewkeyReleaseEvent*(self: gen_qtreeview_types.QTreeView, event: QKeyEvent): void =
  fQTreeView_virtualbase_keyReleaseEvent(self.h, event.h)

type QTreeViewkeyReleaseEventProc* = proc(event: QKeyEvent): void
...
proc miqt_exec_callback_QTreeView_keyReleaseEvent(self: ptr cQTreeView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTreeView_keyReleaseEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTreeViewenterEvent*(self: gen_qtreeview_types.QTreeView, event: QEnterEvent): void =
  fQTreeView_virtualbase_enterEvent(self.h, event.h)

type QTreeViewenterEventProc* = proc(event: QEnterEvent): void
...
proc miqt_exec_callback_QTreeView_enterEvent(self: ptr cQTreeView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTreeView_enterEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTreeViewleaveEvent*(self: gen_qtreeview_types.QTreeView, event: QEvent): void =
  fQTreeView_virtualbase_leaveEvent(self.h, event.h)

type QTreeViewleaveEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QTreeView_leaveEvent(self: ptr cQTreeView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTreeView_leaveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTreeViewmoveEvent*(self: gen_qtreeview_types.QTreeView, event: QMoveEvent): void =
  fQTreeView_virtualbase_moveEvent(self.h, event.h)

type QTreeViewmoveEventProc* = proc(event: QMoveEvent): void
...
proc miqt_exec_callback_QTreeView_moveEvent(self: ptr cQTreeView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTreeView_moveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTreeViewcloseEvent*(self: gen_qtreeview_types.QTreeView, event: QCloseEvent): void =
  fQTreeView_virtualbase_closeEvent(self.h, event.h)

type QTreeViewcloseEventProc* = proc(event: QCloseEvent): void
...
proc miqt_exec_callback_QTreeView_closeEvent(self: ptr cQTreeView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTreeView_closeEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTreeViewtabletEvent*(self: gen_qtreeview_types.QTreeView, event: QTabletEvent): void =
  fQTreeView_virtualbase_tabletEvent(self.h, event.h)

type QTreeViewtabletEventProc* = proc(event: QTabletEvent): void
...
proc miqt_exec_callback_QTreeView_tabletEvent(self: ptr cQTreeView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTreeView_tabletEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTreeViewactionEvent*(self: gen_qtreeview_types.QTreeView, event: QActionEvent): void =
  fQTreeView_virtualbase_actionEvent(self.h, event.h)

type QTreeViewactionEventProc* = proc(event: QActionEvent): void
...
proc miqt_exec_callback_QTreeView_actionEvent(self: ptr cQTreeView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTreeView_actionEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTreeViewshowEvent*(self: gen_qtreeview_types.QTreeView, event: QShowEvent): void =
  fQTreeView_virtualbase_showEvent(self.h, event.h)

type QTreeViewshowEventProc* = proc(event: QShowEvent): void
...
proc miqt_exec_callback_QTreeView_showEvent(self: ptr cQTreeView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTreeView_showEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTreeViewhideEvent*(self: gen_qtreeview_types.QTreeView, event: QHideEvent): void =
  fQTreeView_virtualbase_hideEvent(self.h, event.h)

type QTreeViewhideEventProc* = proc(event: QHideEvent): void
...
proc miqt_exec_callback_QTreeView_metric(self: ptr cQTreeView, slot: int, param1: cint): cint {.exportc: "miqt_exec_callback_QTreeView_metric ".} =
  ...
  virtualReturn
proc QTreeViewinitPainter*(self: gen_qtreeview_types.QTreeView, painter: QPainter): void =
  fQTreeView_virtualbase_initPainter(self.h, painter.h)

type QTreeViewinitPainterProc* = proc(painter: QPainter): void
...
proc miqt_exec_callback_QTreeView_initPainter(self: ptr cQTreeView, slot: int, painter: pointer): void {.exportc: "miqt_exec_callback_QTreeView_initPainter ".} =
  ...
  nimfunc[](slotval1)
proc QTreeViewredirected*(self: gen_qtreeview_types.QTreeView, offset: QPoint): QPaintDevice =
  QPaintDevice(h: fQTreeView_virtualbase_redirected(self.h, offset.h))

type QTreeViewredirectedProc* = proc(offset: QPoint): QPaintDevice
...
proc miqt_exec_callback_QTreeView_redirected(self: ptr cQTreeView, slot: int, offset: pointer): pointer {.exportc: "miqt_exec_callback_QTreeView_redirected ".} =
  ...
  virtualReturn.h
proc QTreeViewsharedPainter*(self: gen_qtreeview_types.QTreeView, ): QPainter =
  QPainter(h: fQTreeView_virtualbase_sharedPainter(self.h))

type QTreeViewsharedPainterProc* = proc(): QPainter
...
proc miqt_exec_callback_QTreeView_sharedPainter(self: ptr cQTreeView, slot: int): pointer {.exportc: "miqt_exec_callback_QTreeView_sharedPainter ".} =
  ...
  virtualReturn.h
proc QTreeViewchildEvent*(self: gen_qtreeview_types.QTreeView, event: QChildEvent): void =
  fQTreeView_virtualbase_childEvent(self.h, event.h)

type QTreeViewchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QTreeView_childEvent(self: ptr cQTreeView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTreeView_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTreeViewcustomEvent*(self: gen_qtreeview_types.QTreeView, event: QEvent): void =
  fQTreeView_virtualbase_customEvent(self.h, event.h)

type QTreeViewcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QTreeView_customEvent(self: ptr cQTreeView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTreeView_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTreeViewconnectNotify*(self: gen_qtreeview_types.QTreeView, signal: QMetaMethod): void =
  fQTreeView_virtualbase_connectNotify(self.h, signal.h)

type QTreeViewconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QTreeView_connectNotify(self: ptr cQTreeView, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QTreeView_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QTreeViewdisconnectNotify*(self: gen_qtreeview_types.QTreeView, signal: QMetaMethod): void =
  fQTreeView_virtualbase_disconnectNotify(self.h, signal.h)

type QTreeViewdisconnectNotifyProc* = proc(signal: QMetaMethod): void
