...
func init*(T: type gen_qlistview_types.QListView, h: ptr cQListView): gen_qlistview_types.QListView =
  T(h: h)
proc create*(T: type gen_qlistview_types.QListView, parent: QWidget): gen_qlistview_types.QListView =
...
proc metaObject*(self: gen_qlistview_types.QListView, ): QMetaObject =
  QMetaObject(h: fcQListView_metaObject(self.h))
...
proc setGridSize*(self: gen_qlistview_types.QListView, size: QSize): void =
  fcQListView_setGridSize(self.h, size.h)

proc gridSize*(self: gen_qlistview_types.QListView, ): QSize =
  QSize(h: fcQListView_gridSize(self.h))
...
proc visualRect*(self: gen_qlistview_types.QListView, index: QModelIndex): QRect =
  QRect(h: fcQListView_visualRect(self.h, index.h))

proc scrollTo*(self: gen_qlistview_types.QListView, index: QModelIndex, hint: cint): void =
  fcQListView_scrollTo(self.h, index.h, cint(hint))

proc indexAt*(self: gen_qlistview_types.QListView, p: QPoint): QModelIndex =
  QModelIndex(h: fcQListView_indexAt(self.h, p.h))
...
proc setRootIndex*(self: gen_qlistview_types.QListView, index: QModelIndex): void =
  fcQListView_setRootIndex(self.h, index.h)

proc indexesMoved*(self: gen_qlistview_types.QListView, indexes: seq[QModelIndex]): void =
...
type QListViewindexesMovedSlot* = proc(indexes: seq[QModelIndex])
...
proc miqt_exec_callback_QListView_metacall(self: ptr cQListView, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QListView_metacall ".} =
  ...
  virtualReturn
proc QListViewvisualRect*(self: gen_qlistview_types.QListView, index: QModelIndex): QRect =
  QRect(h: fQListView_virtualbase_visualRect(self.h, index.h))

type QListViewvisualRectProc* = proc(index: QModelIndex): QRect
...
proc miqt_exec_callback_QListView_visualRect(self: ptr cQListView, slot: int, index: pointer): pointer {.exportc: "miqt_exec_callback_QListView_visualRect ".} =
  ...
  virtualReturn.h
proc QListViewscrollTo*(self: gen_qlistview_types.QListView, index: QModelIndex, hint: cint): void =
  fQListView_virtualbase_scrollTo(self.h, index.h, cint(hint))

type QListViewscrollToProc* = proc(index: QModelIndex, hint: cint): void
...
proc QListViewindexAt*(self: gen_qlistview_types.QListView, p: QPoint): QModelIndex =
  QModelIndex(h: fQListView_virtualbase_indexAt(self.h, p.h))

type QListViewindexAtProc* = proc(p: QPoint): QModelIndex
...
proc miqt_exec_callback_QListView_reset(self: ptr cQListView, slot: int): void {.exportc: "miqt_exec_callback_QListView_reset ".} =
  ...
  nimfunc[]()
proc QListViewsetRootIndex*(self: gen_qlistview_types.QListView, index: QModelIndex): void =
  fQListView_virtualbase_setRootIndex(self.h, index.h)

type QListViewsetRootIndexProc* = proc(index: QModelIndex): void
...
proc miqt_exec_callback_QListView_setRootIndex(self: ptr cQListView, slot: int, index: pointer): void {.exportc: "miqt_exec_callback_QListView_setRootIndex ".} =
  ...
  nimfunc[](slotval1)
proc QListViewevent*(self: gen_qlistview_types.QListView, e: QEvent): bool =
  fQListView_virtualbase_event(self.h, e.h)

type QListVieweventProc* = proc(e: QEvent): bool
...
proc miqt_exec_callback_QListView_scrollContentsBy(self: ptr cQListView, slot: int, dx: cint, dy: cint): void {.exportc: "miqt_exec_callback_QListView_scrollContentsBy ".} =
  ...
  nimfunc[](slotval1, slotval2)
proc QListViewdataChanged*(self: gen_qlistview_types.QListView, topLeft: QModelIndex, bottomRight: QModelIndex, roles: seq[cint]): void =
...
type QListViewdataChangedProc* = proc(topLeft: QModelIndex, bottomRight: QModelIndex, roles: seq[cint]): void
...
proc QListViewrowsInserted*(self: gen_qlistview_types.QListView, parent: QModelIndex, start: cint, endVal: cint): void =
  fQListView_virtualbase_rowsInserted(self.h, parent.h, start, endVal)

type QListViewrowsInsertedProc* = proc(parent: QModelIndex, start: cint, endVal: cint): void
...
proc miqt_exec_callback_QListView_rowsInserted(self: ptr cQListView, slot: int, parent: pointer, start: cint, endVal: cint): void {.exportc: "miqt_exec_callback_QListView_rowsInserted ".} =
  ...
  nimfunc[](slotval1, slotval2, slotval3)
proc QListViewrowsAboutToBeRemoved*(self: gen_qlistview_types.QListView, parent: QModelIndex, start: cint, endVal: cint): void =
  fQListView_virtualbase_rowsAboutToBeRemoved(self.h, parent.h, start, endVal)

type QListViewrowsAboutToBeRemovedProc* = proc(parent: QModelIndex, start: cint, endVal: cint): void
...
proc miqt_exec_callback_QListView_rowsAboutToBeRemoved(self: ptr cQListView, slot: int, parent: pointer, start: cint, endVal: cint): void {.exportc: "miqt_exec_callback_QListView_rowsAboutToBeRemoved ".} =
  ...
  nimfunc[](slotval1, slotval2, slotval3)
proc QListViewmouseMoveEvent*(self: gen_qlistview_types.QListView, e: QMouseEvent): void =
  fQListView_virtualbase_mouseMoveEvent(self.h, e.h)

type QListViewmouseMoveEventProc* = proc(e: QMouseEvent): void
...
proc miqt_exec_callback_QListView_mouseMoveEvent(self: ptr cQListView, slot: int, e: pointer): void {.exportc: "miqt_exec_callback_QListView_mouseMoveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QListViewmouseReleaseEvent*(self: gen_qlistview_types.QListView, e: QMouseEvent): void =
  fQListView_virtualbase_mouseReleaseEvent(self.h, e.h)

type QListViewmouseReleaseEventProc* = proc(e: QMouseEvent): void
...
proc miqt_exec_callback_QListView_mouseReleaseEvent(self: ptr cQListView, slot: int, e: pointer): void {.exportc: "miqt_exec_callback_QListView_mouseReleaseEvent ".} =
  ...
  nimfunc[](slotval1)
proc QListViewwheelEvent*(self: gen_qlistview_types.QListView, e: QWheelEvent): void =
  fQListView_virtualbase_wheelEvent(self.h, e.h)

type QListViewwheelEventProc* = proc(e: QWheelEvent): void
...
proc miqt_exec_callback_QListView_wheelEvent(self: ptr cQListView, slot: int, e: pointer): void {.exportc: "miqt_exec_callback_QListView_wheelEvent ".} =
  ...
  nimfunc[](slotval1)
proc QListViewtimerEvent*(self: gen_qlistview_types.QListView, e: QTimerEvent): void =
  fQListView_virtualbase_timerEvent(self.h, e.h)

type QListViewtimerEventProc* = proc(e: QTimerEvent): void
...
proc miqt_exec_callback_QListView_timerEvent(self: ptr cQListView, slot: int, e: pointer): void {.exportc: "miqt_exec_callback_QListView_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QListViewresizeEvent*(self: gen_qlistview_types.QListView, e: QResizeEvent): void =
  fQListView_virtualbase_resizeEvent(self.h, e.h)

type QListViewresizeEventProc* = proc(e: QResizeEvent): void
...
proc miqt_exec_callback_QListView_resizeEvent(self: ptr cQListView, slot: int, e: pointer): void {.exportc: "miqt_exec_callback_QListView_resizeEvent ".} =
  ...
  nimfunc[](slotval1)
proc QListViewdragMoveEvent*(self: gen_qlistview_types.QListView, e: QDragMoveEvent): void =
  fQListView_virtualbase_dragMoveEvent(self.h, e.h)

type QListViewdragMoveEventProc* = proc(e: QDragMoveEvent): void
...
proc miqt_exec_callback_QListView_dragMoveEvent(self: ptr cQListView, slot: int, e: pointer): void {.exportc: "miqt_exec_callback_QListView_dragMoveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QListViewdragLeaveEvent*(self: gen_qlistview_types.QListView, e: QDragLeaveEvent): void =
  fQListView_virtualbase_dragLeaveEvent(self.h, e.h)

type QListViewdragLeaveEventProc* = proc(e: QDragLeaveEvent): void
...
proc miqt_exec_callback_QListView_dragLeaveEvent(self: ptr cQListView, slot: int, e: pointer): void {.exportc: "miqt_exec_callback_QListView_dragLeaveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QListViewdropEvent*(self: gen_qlistview_types.QListView, e: QDropEvent): void =
  fQListView_virtualbase_dropEvent(self.h, e.h)

type QListViewdropEventProc* = proc(e: QDropEvent): void
...
proc miqt_exec_callback_QListView_startDrag(self: ptr cQListView, slot: int, supportedActions: cint): void {.exportc: "miqt_exec_callback_QListView_startDrag ".} =
  ...
  nimfunc[](slotval1)
proc QListViewinitViewItemOption*(self: gen_qlistview_types.QListView, option: QStyleOptionViewItem): void =
  fQListView_virtualbase_initViewItemOption(self.h, option.h)

type QListViewinitViewItemOptionProc* = proc(option: QStyleOptionViewItem): void
...
proc miqt_exec_callback_QListView_initViewItemOption(self: ptr cQListView, slot: int, option: pointer): void {.exportc: "miqt_exec_callback_QListView_initViewItemOption ".} =
  ...
  nimfunc[](slotval1)
proc QListViewpaintEvent*(self: gen_qlistview_types.QListView, e: QPaintEvent): void =
  fQListView_virtualbase_paintEvent(self.h, e.h)

type QListViewpaintEventProc* = proc(e: QPaintEvent): void
...
proc miqt_exec_callback_QListView_verticalOffset(self: ptr cQListView, slot: int): cint {.exportc: "miqt_exec_callback_QListView_verticalOffset ".} =
  ...
  virtualReturn
proc QListViewmoveCursor*(self: gen_qlistview_types.QListView, cursorAction: cint, modifiers: cint): QModelIndex =
  QModelIndex(h: fQListView_virtualbase_moveCursor(self.h, cint(cursorAction), cint(modifiers)))

type QListViewmoveCursorProc* = proc(cursorAction: cint, modifiers: cint): QModelIndex
...
proc miqt_exec_callback_QListView_moveCursor(self: ptr cQListView, slot: int, cursorAction: cint, modifiers: cint): pointer {.exportc: "miqt_exec_callback_QListView_moveCursor ".} =
  ...
  virtualReturn.h
proc QListViewsetSelection*(self: gen_qlistview_types.QListView, rect: QRect, command: cint): void =
  fQListView_virtualbase_setSelection(self.h, rect.h, cint(command))

type QListViewsetSelectionProc* = proc(rect: QRect, command: cint): void
...
proc miqt_exec_callback_QListView_setSelection(self: ptr cQListView, slot: int, rect: pointer, command: cint): void {.exportc: "miqt_exec_callback_QListView_setSelection ".} =
  ...
  nimfunc[](slotval1, slotval2)
proc QListViewvisualRegionForSelection*(self: gen_qlistview_types.QListView, selection: QItemSelection): QRegion =
  QRegion(h: fQListView_virtualbase_visualRegionForSelection(self.h, selection.h))

type QListViewvisualRegionForSelectionProc* = proc(selection: QItemSelection): QRegion
...
proc miqt_exec_callback_QListView_visualRegionForSelection(self: ptr cQListView, slot: int, selection: pointer): pointer {.exportc: "miqt_exec_callback_QListView_visualRegionForSelection ".} =
  ...
  virtualReturn.h
proc QListViewselectedIndexes*(self: gen_qlistview_types.QListView, ): seq[QModelIndex] =
...
type QListViewselectedIndexesProc* = proc(): seq[QModelIndex]
...
proc miqt_exec_callback_QListView_updateGeometries(self: ptr cQListView, slot: int): void {.exportc: "miqt_exec_callback_QListView_updateGeometries ".} =
  ...
  nimfunc[]()
proc QListViewisIndexHidden*(self: gen_qlistview_types.QListView, index: QModelIndex): bool =
  fQListView_virtualbase_isIndexHidden(self.h, index.h)

type QListViewisIndexHiddenProc* = proc(index: QModelIndex): bool
...
proc miqt_exec_callback_QListView_isIndexHidden(self: ptr cQListView, slot: int, index: pointer): bool {.exportc: "miqt_exec_callback_QListView_isIndexHidden ".} =
  ...
  virtualReturn
proc QListViewselectionChanged*(self: gen_qlistview_types.QListView, selected: QItemSelection, deselected: QItemSelection): void =
  fQListView_virtualbase_selectionChanged(self.h, selected.h, deselected.h)

type QListViewselectionChangedProc* = proc(selected: QItemSelection, deselected: QItemSelection): void
...
proc miqt_exec_callback_QListView_selectionChanged(self: ptr cQListView, slot: int, selected: pointer, deselected: pointer): void {.exportc: "miqt_exec_callback_QListView_selectionChanged ".} =
  ...
  nimfunc[](slotval1, slotval2)
proc QListViewcurrentChanged*(self: gen_qlistview_types.QListView, current: QModelIndex, previous: QModelIndex): void =
  fQListView_virtualbase_currentChanged(self.h, current.h, previous.h)

type QListViewcurrentChangedProc* = proc(current: QModelIndex, previous: QModelIndex): void
...
proc miqt_exec_callback_QListView_currentChanged(self: ptr cQListView, slot: int, current: pointer, previous: pointer): void {.exportc: "miqt_exec_callback_QListView_currentChanged ".} =
  ...
  nimfunc[](slotval1, slotval2)
proc QListViewviewportSizeHint*(self: gen_qlistview_types.QListView, ): QSize =
  QSize(h: fQListView_virtualbase_viewportSizeHint(self.h))

type QListViewviewportSizeHintProc* = proc(): QSize
...
proc miqt_exec_callback_QListView_viewportSizeHint(self: ptr cQListView, slot: int): pointer {.exportc: "miqt_exec_callback_QListView_viewportSizeHint ".} =
  ...
  virtualReturn.h
proc QListViewsetModel*(self: gen_qlistview_types.QListView, model: QAbstractItemModel): void =
  fQListView_virtualbase_setModel(self.h, model.h)

type QListViewsetModelProc* = proc(model: QAbstractItemModel): void
...
proc miqt_exec_callback_QListView_setModel(self: ptr cQListView, slot: int, model: pointer): void {.exportc: "miqt_exec_callback_QListView_setModel ".} =
  ...
  nimfunc[](slotval1)
proc QListViewsetSelectionModel*(self: gen_qlistview_types.QListView, selectionModel: QItemSelectionModel): void =
  fQListView_virtualbase_setSelectionModel(self.h, selectionModel.h)

type QListViewsetSelectionModelProc* = proc(selectionModel: QItemSelectionModel): void
...
proc miqt_exec_callback_QListView_sizeHintForColumn(self: ptr cQListView, slot: int, column: cint): cint {.exportc: "miqt_exec_callback_QListView_sizeHintForColumn ".} =
  ...
  virtualReturn
proc QListViewitemDelegateForIndex*(self: gen_qlistview_types.QListView, index: QModelIndex): QAbstractItemDelegate =
  QAbstractItemDelegate(h: fQListView_virtualbase_itemDelegateForIndex(self.h, index.h))

type QListViewitemDelegateForIndexProc* = proc(index: QModelIndex): QAbstractItemDelegate
...
proc miqt_exec_callback_QListView_itemDelegateForIndex(self: ptr cQListView, slot: int, index: pointer): pointer {.exportc: "miqt_exec_callback_QListView_itemDelegateForIndex ".} =
  ...
  virtualReturn.h
proc QListViewinputMethodQuery*(self: gen_qlistview_types.QListView, query: cint): QVariant =
  QVariant(h: fQListView_virtualbase_inputMethodQuery(self.h, cint(query)))

type QListViewinputMethodQueryProc* = proc(query: cint): QVariant
...
proc miqt_exec_callback_QListView_horizontalScrollbarValueChanged(self: ptr cQListView, slot: int, value: cint): void {.exportc: "miqt_exec_callback_QListView_horizontalScrollbarValueChanged ".} =
  ...
  nimfunc[](slotval1)
proc QListViewcloseEditor*(self: gen_qlistview_types.QListView, editor: QWidget, hint: cint): void =
  fQListView_virtualbase_closeEditor(self.h, editor.h, cint(hint))

type QListViewcloseEditorProc* = proc(editor: QWidget, hint: cint): void
...
proc miqt_exec_callback_QListView_closeEditor(self: ptr cQListView, slot: int, editor: pointer, hint: cint): void {.exportc: "miqt_exec_callback_QListView_closeEditor ".} =
  ...
  nimfunc[](slotval1, slotval2)
proc QListViewcommitData*(self: gen_qlistview_types.QListView, editor: QWidget): void =
  fQListView_virtualbase_commitData(self.h, editor.h)

type QListViewcommitDataProc* = proc(editor: QWidget): void
...
proc miqt_exec_callback_QListView_commitData(self: ptr cQListView, slot: int, editor: pointer): void {.exportc: "miqt_exec_callback_QListView_commitData ".} =
  ...
  nimfunc[](slotval1)
proc QListVieweditorDestroyed*(self: gen_qlistview_types.QListView, editor: QObject): void =
  fQListView_virtualbase_editorDestroyed(self.h, editor.h)

type QListVieweditorDestroyedProc* = proc(editor: QObject): void
...
proc miqt_exec_callback_QListView_editorDestroyed(self: ptr cQListView, slot: int, editor: pointer): void {.exportc: "miqt_exec_callback_QListView_editorDestroyed ".} =
  ...
  nimfunc[](slotval1)
proc QListViewedit*(self: gen_qlistview_types.QListView, index: QModelIndex, trigger: cint, event: QEvent): bool =
  fQListView_virtualbase_edit2(self.h, index.h, cint(trigger), event.h)

type QListViewedit2Proc* = proc(index: QModelIndex, trigger: cint, event: QEvent): bool
...
proc miqt_exec_callback_QListView_edit2(self: ptr cQListView, slot: int, index: pointer, trigger: cint, event: pointer): bool {.exportc: "miqt_exec_callback_QListView_edit2 ".} =
  ...
  virtualReturn
proc QListViewselectionCommand*(self: gen_qlistview_types.QListView, index: QModelIndex, event: QEvent): cint =
  cint(fQListView_virtualbase_selectionCommand(self.h, index.h, event.h))

type QListViewselectionCommandProc* = proc(index: QModelIndex, event: QEvent): cint
...
proc miqt_exec_callback_QListView_focusNextPrevChild(self: ptr cQListView, slot: int, next: bool): bool {.exportc: "miqt_exec_callback_QListView_focusNextPrevChild ".} =
  ...
  virtualReturn
proc QListViewviewportEvent*(self: gen_qlistview_types.QListView, event: QEvent): bool =
  fQListView_virtualbase_viewportEvent(self.h, event.h)

type QListViewviewportEventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QListView_viewportEvent(self: ptr cQListView, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QListView_viewportEvent ".} =
  ...
  virtualReturn
proc QListViewmousePressEvent*(self: gen_qlistview_types.QListView, event: QMouseEvent): void =
  fQListView_virtualbase_mousePressEvent(self.h, event.h)

type QListViewmousePressEventProc* = proc(event: QMouseEvent): void
...
proc miqt_exec_callback_QListView_mousePressEvent(self: ptr cQListView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QListView_mousePressEvent ".} =
  ...
  nimfunc[](slotval1)
proc QListViewmouseDoubleClickEvent*(self: gen_qlistview_types.QListView, event: QMouseEvent): void =
  fQListView_virtualbase_mouseDoubleClickEvent(self.h, event.h)

type QListViewmouseDoubleClickEventProc* = proc(event: QMouseEvent): void
...
proc miqt_exec_callback_QListView_mouseDoubleClickEvent(self: ptr cQListView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QListView_mouseDoubleClickEvent ".} =
  ...
  nimfunc[](slotval1)
proc QListViewdragEnterEvent*(self: gen_qlistview_types.QListView, event: QDragEnterEvent): void =
  fQListView_virtualbase_dragEnterEvent(self.h, event.h)

type QListViewdragEnterEventProc* = proc(event: QDragEnterEvent): void
...
proc miqt_exec_callback_QListView_dragEnterEvent(self: ptr cQListView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QListView_dragEnterEvent ".} =
  ...
  nimfunc[](slotval1)
proc QListViewfocusInEvent*(self: gen_qlistview_types.QListView, event: QFocusEvent): void =
  fQListView_virtualbase_focusInEvent(self.h, event.h)

type QListViewfocusInEventProc* = proc(event: QFocusEvent): void
...
proc miqt_exec_callback_QListView_focusInEvent(self: ptr cQListView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QListView_focusInEvent ".} =
  ...
  nimfunc[](slotval1)
proc QListViewfocusOutEvent*(self: gen_qlistview_types.QListView, event: QFocusEvent): void =
  fQListView_virtualbase_focusOutEvent(self.h, event.h)

type QListViewfocusOutEventProc* = proc(event: QFocusEvent): void
...
proc miqt_exec_callback_QListView_focusOutEvent(self: ptr cQListView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QListView_focusOutEvent ".} =
  ...
  nimfunc[](slotval1)
proc QListViewkeyPressEvent*(self: gen_qlistview_types.QListView, event: QKeyEvent): void =
  fQListView_virtualbase_keyPressEvent(self.h, event.h)

type QListViewkeyPressEventProc* = proc(event: QKeyEvent): void
...
proc miqt_exec_callback_QListView_keyPressEvent(self: ptr cQListView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QListView_keyPressEvent ".} =
  ...
  nimfunc[](slotval1)
proc QListViewinputMethodEvent*(self: gen_qlistview_types.QListView, event: QInputMethodEvent): void =
  fQListView_virtualbase_inputMethodEvent(self.h, event.h)

type QListViewinputMethodEventProc* = proc(event: QInputMethodEvent): void
...
proc miqt_exec_callback_QListView_inputMethodEvent(self: ptr cQListView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QListView_inputMethodEvent ".} =
  ...
  nimfunc[](slotval1)
proc QListVieweventFilter*(self: gen_qlistview_types.QListView, objectVal: QObject, event: QEvent): bool =
  fQListView_virtualbase_eventFilter(self.h, objectVal.h, event.h)

type QListVieweventFilterProc* = proc(objectVal: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QListView_eventFilter(self: ptr cQListView, slot: int, objectVal: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QListView_eventFilter ".} =
  ...
  virtualReturn
proc QListViewminimumSizeHint*(self: gen_qlistview_types.QListView, ): QSize =
  QSize(h: fQListView_virtualbase_minimumSizeHint(self.h))

type QListViewminimumSizeHintProc* = proc(): QSize
...
proc miqt_exec_callback_QListView_minimumSizeHint(self: ptr cQListView, slot: int): pointer {.exportc: "miqt_exec_callback_QListView_minimumSizeHint ".} =
  ...
  virtualReturn.h
proc QListViewsizeHint*(self: gen_qlistview_types.QListView, ): QSize =
  QSize(h: fQListView_virtualbase_sizeHint(self.h))

type QListViewsizeHintProc* = proc(): QSize
...
proc miqt_exec_callback_QListView_sizeHint(self: ptr cQListView, slot: int): pointer {.exportc: "miqt_exec_callback_QListView_sizeHint ".} =
  ...
  virtualReturn.h
proc QListViewsetupViewport*(self: gen_qlistview_types.QListView, viewport: QWidget): void =
  fQListView_virtualbase_setupViewport(self.h, viewport.h)

type QListViewsetupViewportProc* = proc(viewport: QWidget): void
...
proc miqt_exec_callback_QListView_setupViewport(self: ptr cQListView, slot: int, viewport: pointer): void {.exportc: "miqt_exec_callback_QListView_setupViewport ".} =
  ...
  nimfunc[](slotval1)
proc QListViewcontextMenuEvent*(self: gen_qlistview_types.QListView, param1: QContextMenuEvent): void =
  fQListView_virtualbase_contextMenuEvent(self.h, param1.h)

type QListViewcontextMenuEventProc* = proc(param1: QContextMenuEvent): void
...
proc miqt_exec_callback_QListView_contextMenuEvent(self: ptr cQListView, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QListView_contextMenuEvent ".} =
  ...
  nimfunc[](slotval1)
proc QListViewchangeEvent*(self: gen_qlistview_types.QListView, param1: QEvent): void =
  fQListView_virtualbase_changeEvent(self.h, param1.h)

type QListViewchangeEventProc* = proc(param1: QEvent): void
...
proc miqt_exec_callback_QListView_changeEvent(self: ptr cQListView, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QListView_changeEvent ".} =
  ...
  nimfunc[](slotval1)
proc QListViewinitStyleOption*(self: gen_qlistview_types.QListView, option: QStyleOptionFrame): void =
  fQListView_virtualbase_initStyleOption(self.h, option.h)

type QListViewinitStyleOptionProc* = proc(option: QStyleOptionFrame): void
...
proc miqt_exec_callback_QListView_hasHeightForWidth(self: ptr cQListView, slot: int): bool {.exportc: "miqt_exec_callback_QListView_hasHeightForWidth ".} =
  ...
  virtualReturn
proc QListViewpaintEngine*(self: gen_qlistview_types.QListView, ): QPaintEngine =
  QPaintEngine(h: fQListView_virtualbase_paintEngine(self.h))

type QListViewpaintEngineProc* = proc(): QPaintEngine
...
proc miqt_exec_callback_QListView_paintEngine(self: ptr cQListView, slot: int): pointer {.exportc: "miqt_exec_callback_QListView_paintEngine ".} =
  ...
  virtualReturn.h
proc QListViewkeyReleaseEvent*(self: gen_qlistview_types.QListView, event: QKeyEvent): void =
  fQListView_virtualbase_keyReleaseEvent(self.h, event.h)

type QListViewkeyReleaseEventProc* = proc(event: QKeyEvent): void
...
proc miqt_exec_callback_QListView_keyReleaseEvent(self: ptr cQListView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QListView_keyReleaseEvent ".} =
  ...
  nimfunc[](slotval1)
proc QListViewenterEvent*(self: gen_qlistview_types.QListView, event: QEnterEvent): void =
  fQListView_virtualbase_enterEvent(self.h, event.h)

type QListViewenterEventProc* = proc(event: QEnterEvent): void
...
proc miqt_exec_callback_QListView_enterEvent(self: ptr cQListView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QListView_enterEvent ".} =
  ...
  nimfunc[](slotval1)
proc QListViewleaveEvent*(self: gen_qlistview_types.QListView, event: QEvent): void =
  fQListView_virtualbase_leaveEvent(self.h, event.h)

type QListViewleaveEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QListView_leaveEvent(self: ptr cQListView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QListView_leaveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QListViewmoveEvent*(self: gen_qlistview_types.QListView, event: QMoveEvent): void =
  fQListView_virtualbase_moveEvent(self.h, event.h)

type QListViewmoveEventProc* = proc(event: QMoveEvent): void
...
proc miqt_exec_callback_QListView_moveEvent(self: ptr cQListView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QListView_moveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QListViewcloseEvent*(self: gen_qlistview_types.QListView, event: QCloseEvent): void =
  fQListView_virtualbase_closeEvent(self.h, event.h)

type QListViewcloseEventProc* = proc(event: QCloseEvent): void
...
proc miqt_exec_callback_QListView_closeEvent(self: ptr cQListView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QListView_closeEvent ".} =
  ...
  nimfunc[](slotval1)
proc QListViewtabletEvent*(self: gen_qlistview_types.QListView, event: QTabletEvent): void =
  fQListView_virtualbase_tabletEvent(self.h, event.h)

type QListViewtabletEventProc* = proc(event: QTabletEvent): void
...
proc miqt_exec_callback_QListView_tabletEvent(self: ptr cQListView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QListView_tabletEvent ".} =
  ...
  nimfunc[](slotval1)
proc QListViewactionEvent*(self: gen_qlistview_types.QListView, event: QActionEvent): void =
  fQListView_virtualbase_actionEvent(self.h, event.h)

type QListViewactionEventProc* = proc(event: QActionEvent): void
...
proc miqt_exec_callback_QListView_actionEvent(self: ptr cQListView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QListView_actionEvent ".} =
  ...
  nimfunc[](slotval1)
proc QListViewshowEvent*(self: gen_qlistview_types.QListView, event: QShowEvent): void =
  fQListView_virtualbase_showEvent(self.h, event.h)

type QListViewshowEventProc* = proc(event: QShowEvent): void
...
proc miqt_exec_callback_QListView_showEvent(self: ptr cQListView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QListView_showEvent ".} =
  ...
  nimfunc[](slotval1)
proc QListViewhideEvent*(self: gen_qlistview_types.QListView, event: QHideEvent): void =
  fQListView_virtualbase_hideEvent(self.h, event.h)

type QListViewhideEventProc* = proc(event: QHideEvent): void
...
proc miqt_exec_callback_QListView_metric(self: ptr cQListView, slot: int, param1: cint): cint {.exportc: "miqt_exec_callback_QListView_metric ".} =
  ...
  virtualReturn
proc QListViewinitPainter*(self: gen_qlistview_types.QListView, painter: QPainter): void =
  fQListView_virtualbase_initPainter(self.h, painter.h)

type QListViewinitPainterProc* = proc(painter: QPainter): void
...
proc miqt_exec_callback_QListView_initPainter(self: ptr cQListView, slot: int, painter: pointer): void {.exportc: "miqt_exec_callback_QListView_initPainter ".} =
  ...
  nimfunc[](slotval1)
proc QListViewredirected*(self: gen_qlistview_types.QListView, offset: QPoint): QPaintDevice =
  QPaintDevice(h: fQListView_virtualbase_redirected(self.h, offset.h))

type QListViewredirectedProc* = proc(offset: QPoint): QPaintDevice
...
proc miqt_exec_callback_QListView_redirected(self: ptr cQListView, slot: int, offset: pointer): pointer {.exportc: "miqt_exec_callback_QListView_redirected ".} =
  ...
  virtualReturn.h
proc QListViewsharedPainter*(self: gen_qlistview_types.QListView, ): QPainter =
  QPainter(h: fQListView_virtualbase_sharedPainter(self.h))

type QListViewsharedPainterProc* = proc(): QPainter
...
proc miqt_exec_callback_QListView_sharedPainter(self: ptr cQListView, slot: int): pointer {.exportc: "miqt_exec_callback_QListView_sharedPainter ".} =
  ...
  virtualReturn.h
proc QListViewchildEvent*(self: gen_qlistview_types.QListView, event: QChildEvent): void =
  fQListView_virtualbase_childEvent(self.h, event.h)

type QListViewchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QListView_childEvent(self: ptr cQListView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QListView_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QListViewcustomEvent*(self: gen_qlistview_types.QListView, event: QEvent): void =
  fQListView_virtualbase_customEvent(self.h, event.h)

type QListViewcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QListView_customEvent(self: ptr cQListView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QListView_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QListViewconnectNotify*(self: gen_qlistview_types.QListView, signal: QMetaMethod): void =
  fQListView_virtualbase_connectNotify(self.h, signal.h)

type QListViewconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QListView_connectNotify(self: ptr cQListView, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QListView_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QListViewdisconnectNotify*(self: gen_qlistview_types.QListView, signal: QMetaMethod): void =
  fQListView_virtualbase_disconnectNotify(self.h, signal.h)

type QListViewdisconnectNotifyProc* = proc(signal: QMetaMethod): void
