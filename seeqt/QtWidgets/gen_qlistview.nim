...
proc miqt_exec_callback_QListView_startDrag(self: ptr cQListView, slot: int, supportedActions: cint): void {.exportc: "miqt_exec_callback_QListView_startDrag ".} =
  ...
  nimfunc[](slotval1)
proc QListViewviewOptions*(self: gen_qlistview_types.QListView, ): QStyleOptionViewItem =
  QStyleOptionViewItem(h: fQListView_virtualbase_viewOptions(self.h))

type QListViewviewOptionsProc* = proc(): QStyleOptionViewItem
...
proc miqt_exec_callback_QListView_keyReleaseEvent(self: ptr cQListView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QListView_keyReleaseEvent ".} =
  ...
  nimfunc[](slotval1)
proc QListViewenterEvent*(self: gen_qlistview_types.QListView, event: QEvent): void =
  fQListView_virtualbase_enterEvent(self.h, event.h)

type QListViewenterEventProc* = proc(event: QEvent): void
