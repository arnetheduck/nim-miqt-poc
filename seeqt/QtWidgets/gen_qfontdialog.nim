...
proc fQFontDialog_virtualbase_nativeEvent(self: pointer, eventType: struct_miqt_string, message: pointer, resultVal: ptr clong): bool{.importc: "QFontDialog_virtualbase_nativeEvent".}
...
func init*(T: type gen_qfontdialog_types.QFontDialog, h: ptr cQFontDialog): gen_qfontdialog_types.QFontDialog =
  T(h: h)
proc create*(T: type gen_qfontdialog_types.QFontDialog, parent: QWidget): gen_qfontdialog_types.QFontDialog =
...
proc create*(T: type gen_qfontdialog_types.QFontDialog, initial: QFont): gen_qfontdialog_types.QFontDialog =
  gen_qfontdialog_types.QFontDialog.init(fcQFontDialog_new3(initial.h))

proc create*(T: type gen_qfontdialog_types.QFontDialog, initial: QFont, parent: QWidget): gen_qfontdialog_types.QFontDialog =
  gen_qfontdialog_types.QFontDialog.init(fcQFontDialog_new4(initial.h, parent.h))

proc metaObject*(self: gen_qfontdialog_types.QFontDialog, ): QMetaObject =
  QMetaObject(h: fcQFontDialog_metaObject(self.h))
...
proc setCurrentFont*(self: gen_qfontdialog_types.QFontDialog, font: QFont): void =
  fcQFontDialog_setCurrentFont(self.h, font.h)

proc currentFont*(self: gen_qfontdialog_types.QFontDialog, ): QFont =
  QFont(h: fcQFontDialog_currentFont(self.h))

proc selectedFont*(self: gen_qfontdialog_types.QFontDialog, ): QFont =
  QFont(h: fcQFontDialog_selectedFont(self.h))
...
proc getFont*(_: type gen_qfontdialog_types.QFontDialog, ok: ptr bool): QFont =
  QFont(h: fcQFontDialog_getFont(ok))

proc getFont*(_: type gen_qfontdialog_types.QFontDialog, ok: ptr bool, initial: QFont): QFont =
  QFont(h: fcQFontDialog_getFont2(ok, initial.h))

proc currentFontChanged*(self: gen_qfontdialog_types.QFontDialog, font: QFont): void =
  fcQFontDialog_currentFontChanged(self.h, font.h)

type QFontDialogcurrentFontChangedSlot* = proc(font: QFont)
...
proc fontSelected*(self: gen_qfontdialog_types.QFontDialog, font: QFont): void =
  fcQFontDialog_fontSelected(self.h, font.h)

type QFontDialogfontSelectedSlot* = proc(font: QFont)
...
proc getFont*(_: type gen_qfontdialog_types.QFontDialog, ok: ptr bool, parent: QWidget): QFont =
  QFont(h: fcQFontDialog_getFont22(ok, parent.h))

proc getFont*(_: type gen_qfontdialog_types.QFontDialog, ok: ptr bool, initial: QFont, parent: QWidget): QFont =
  QFont(h: fcQFontDialog_getFont3(ok, initial.h, parent.h))

proc getFont*(_: type gen_qfontdialog_types.QFontDialog, ok: ptr bool, initial: QFont, parent: QWidget, title: string): QFont =
  QFont(h: fcQFontDialog_getFont4(ok, initial.h, parent.h, struct_miqt_string(data: title, len: csize_t(len(title)))))

proc getFont*(_: type gen_qfontdialog_types.QFontDialog, ok: ptr bool, initial: QFont, parent: QWidget, title: string, options: cint): QFont =
  QFont(h: fcQFontDialog_getFont5(ok, initial.h, parent.h, struct_miqt_string(data: title, len: csize_t(len(title))), cint(options)))
...
proc miqt_exec_callback_QFontDialog_setVisible(self: ptr cQFontDialog, slot: int, visible: bool): void {.exportc: "miqt_exec_callback_QFontDialog_setVisible ".} =
  ...
  nimfunc[](slotval1)
proc QFontDialogchangeEvent*(self: gen_qfontdialog_types.QFontDialog, event: QEvent): void =
  fQFontDialog_virtualbase_changeEvent(self.h, event.h)

type QFontDialogchangeEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QFontDialog_done(self: ptr cQFontDialog, slot: int, resultVal: cint): void {.exportc: "miqt_exec_callback_QFontDialog_done ".} =
  ...
  nimfunc[](slotval1)
proc QFontDialogeventFilter*(self: gen_qfontdialog_types.QFontDialog, objectVal: QObject, event: QEvent): bool =
  fQFontDialog_virtualbase_eventFilter(self.h, objectVal.h, event.h)

type QFontDialogeventFilterProc* = proc(objectVal: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QFontDialog_eventFilter(self: ptr cQFontDialog, slot: int, objectVal: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QFontDialog_eventFilter ".} =
  ...
  virtualReturn
proc QFontDialogsizeHint*(self: gen_qfontdialog_types.QFontDialog, ): QSize =
  QSize(h: fQFontDialog_virtualbase_sizeHint(self.h))

type QFontDialogsizeHintProc* = proc(): QSize
...
proc miqt_exec_callback_QFontDialog_sizeHint(self: ptr cQFontDialog, slot: int): pointer {.exportc: "miqt_exec_callback_QFontDialog_sizeHint ".} =
  ...
  virtualReturn.h
proc QFontDialogminimumSizeHint*(self: gen_qfontdialog_types.QFontDialog, ): QSize =
  QSize(h: fQFontDialog_virtualbase_minimumSizeHint(self.h))

type QFontDialogminimumSizeHintProc* = proc(): QSize
...
proc miqt_exec_callback_QFontDialog_reject(self: ptr cQFontDialog, slot: int): void {.exportc: "miqt_exec_callback_QFontDialog_reject ".} =
  ...
  nimfunc[]()
proc QFontDialogkeyPressEvent*(self: gen_qfontdialog_types.QFontDialog, param1: QKeyEvent): void =
  fQFontDialog_virtualbase_keyPressEvent(self.h, param1.h)

type QFontDialogkeyPressEventProc* = proc(param1: QKeyEvent): void
...
proc miqt_exec_callback_QFontDialog_keyPressEvent(self: ptr cQFontDialog, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QFontDialog_keyPressEvent ".} =
  ...
  nimfunc[](slotval1)
proc QFontDialogcloseEvent*(self: gen_qfontdialog_types.QFontDialog, param1: QCloseEvent): void =
  fQFontDialog_virtualbase_closeEvent(self.h, param1.h)

type QFontDialogcloseEventProc* = proc(param1: QCloseEvent): void
...
proc miqt_exec_callback_QFontDialog_closeEvent(self: ptr cQFontDialog, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QFontDialog_closeEvent ".} =
  ...
  nimfunc[](slotval1)
proc QFontDialogshowEvent*(self: gen_qfontdialog_types.QFontDialog, param1: QShowEvent): void =
  fQFontDialog_virtualbase_showEvent(self.h, param1.h)

type QFontDialogshowEventProc* = proc(param1: QShowEvent): void
...
proc miqt_exec_callback_QFontDialog_showEvent(self: ptr cQFontDialog, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QFontDialog_showEvent ".} =
  ...
  nimfunc[](slotval1)
proc QFontDialogresizeEvent*(self: gen_qfontdialog_types.QFontDialog, param1: QResizeEvent): void =
  fQFontDialog_virtualbase_resizeEvent(self.h, param1.h)

type QFontDialogresizeEventProc* = proc(param1: QResizeEvent): void
...
proc miqt_exec_callback_QFontDialog_resizeEvent(self: ptr cQFontDialog, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QFontDialog_resizeEvent ".} =
  ...
  nimfunc[](slotval1)
proc QFontDialogcontextMenuEvent*(self: gen_qfontdialog_types.QFontDialog, param1: QContextMenuEvent): void =
  fQFontDialog_virtualbase_contextMenuEvent(self.h, param1.h)

type QFontDialogcontextMenuEventProc* = proc(param1: QContextMenuEvent): void
...
proc miqt_exec_callback_QFontDialog_hasHeightForWidth(self: ptr cQFontDialog, slot: int): bool {.exportc: "miqt_exec_callback_QFontDialog_hasHeightForWidth ".} =
  ...
  virtualReturn
proc QFontDialogpaintEngine*(self: gen_qfontdialog_types.QFontDialog, ): QPaintEngine =
  QPaintEngine(h: fQFontDialog_virtualbase_paintEngine(self.h))

type QFontDialogpaintEngineProc* = proc(): QPaintEngine
...
proc miqt_exec_callback_QFontDialog_paintEngine(self: ptr cQFontDialog, slot: int): pointer {.exportc: "miqt_exec_callback_QFontDialog_paintEngine ".} =
  ...
  virtualReturn.h
proc QFontDialogevent*(self: gen_qfontdialog_types.QFontDialog, event: QEvent): bool =
  fQFontDialog_virtualbase_event(self.h, event.h)

type QFontDialogeventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QFontDialog_event(self: ptr cQFontDialog, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QFontDialog_event ".} =
  ...
  virtualReturn
proc QFontDialogmousePressEvent*(self: gen_qfontdialog_types.QFontDialog, event: QMouseEvent): void =
  fQFontDialog_virtualbase_mousePressEvent(self.h, event.h)

type QFontDialogmousePressEventProc* = proc(event: QMouseEvent): void
...
proc miqt_exec_callback_QFontDialog_mousePressEvent(self: ptr cQFontDialog, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QFontDialog_mousePressEvent ".} =
  ...
  nimfunc[](slotval1)
proc QFontDialogmouseReleaseEvent*(self: gen_qfontdialog_types.QFontDialog, event: QMouseEvent): void =
  fQFontDialog_virtualbase_mouseReleaseEvent(self.h, event.h)

type QFontDialogmouseReleaseEventProc* = proc(event: QMouseEvent): void
...
proc miqt_exec_callback_QFontDialog_mouseReleaseEvent(self: ptr cQFontDialog, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QFontDialog_mouseReleaseEvent ".} =
  ...
  nimfunc[](slotval1)
proc QFontDialogmouseDoubleClickEvent*(self: gen_qfontdialog_types.QFontDialog, event: QMouseEvent): void =
  fQFontDialog_virtualbase_mouseDoubleClickEvent(self.h, event.h)

type QFontDialogmouseDoubleClickEventProc* = proc(event: QMouseEvent): void
...
proc miqt_exec_callback_QFontDialog_mouseDoubleClickEvent(self: ptr cQFontDialog, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QFontDialog_mouseDoubleClickEvent ".} =
  ...
  nimfunc[](slotval1)
proc QFontDialogmouseMoveEvent*(self: gen_qfontdialog_types.QFontDialog, event: QMouseEvent): void =
  fQFontDialog_virtualbase_mouseMoveEvent(self.h, event.h)

type QFontDialogmouseMoveEventProc* = proc(event: QMouseEvent): void
...
proc miqt_exec_callback_QFontDialog_mouseMoveEvent(self: ptr cQFontDialog, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QFontDialog_mouseMoveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QFontDialogwheelEvent*(self: gen_qfontdialog_types.QFontDialog, event: QWheelEvent): void =
  fQFontDialog_virtualbase_wheelEvent(self.h, event.h)

type QFontDialogwheelEventProc* = proc(event: QWheelEvent): void
...
proc miqt_exec_callback_QFontDialog_wheelEvent(self: ptr cQFontDialog, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QFontDialog_wheelEvent ".} =
  ...
  nimfunc[](slotval1)
proc QFontDialogkeyReleaseEvent*(self: gen_qfontdialog_types.QFontDialog, event: QKeyEvent): void =
  fQFontDialog_virtualbase_keyReleaseEvent(self.h, event.h)

type QFontDialogkeyReleaseEventProc* = proc(event: QKeyEvent): void
...
proc miqt_exec_callback_QFontDialog_keyReleaseEvent(self: ptr cQFontDialog, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QFontDialog_keyReleaseEvent ".} =
  ...
  nimfunc[](slotval1)
proc QFontDialogfocusInEvent*(self: gen_qfontdialog_types.QFontDialog, event: QFocusEvent): void =
  fQFontDialog_virtualbase_focusInEvent(self.h, event.h)

type QFontDialogfocusInEventProc* = proc(event: QFocusEvent): void
...
proc miqt_exec_callback_QFontDialog_focusInEvent(self: ptr cQFontDialog, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QFontDialog_focusInEvent ".} =
  ...
  nimfunc[](slotval1)
proc QFontDialogfocusOutEvent*(self: gen_qfontdialog_types.QFontDialog, event: QFocusEvent): void =
  fQFontDialog_virtualbase_focusOutEvent(self.h, event.h)

type QFontDialogfocusOutEventProc* = proc(event: QFocusEvent): void
...
proc miqt_exec_callback_QFontDialog_focusOutEvent(self: ptr cQFontDialog, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QFontDialog_focusOutEvent ".} =
  ...
  nimfunc[](slotval1)
proc QFontDialogenterEvent*(self: gen_qfontdialog_types.QFontDialog, event: QEvent): void =
  fQFontDialog_virtualbase_enterEvent(self.h, event.h)

type QFontDialogenterEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QFontDialog_enterEvent(self: ptr cQFontDialog, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QFontDialog_enterEvent ".} =
  ...
  nimfunc[](slotval1)
proc QFontDialogleaveEvent*(self: gen_qfontdialog_types.QFontDialog, event: QEvent): void =
  fQFontDialog_virtualbase_leaveEvent(self.h, event.h)

type QFontDialogleaveEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QFontDialog_leaveEvent(self: ptr cQFontDialog, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QFontDialog_leaveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QFontDialogpaintEvent*(self: gen_qfontdialog_types.QFontDialog, event: QPaintEvent): void =
  fQFontDialog_virtualbase_paintEvent(self.h, event.h)

type QFontDialogpaintEventProc* = proc(event: QPaintEvent): void
...
proc miqt_exec_callback_QFontDialog_paintEvent(self: ptr cQFontDialog, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QFontDialog_paintEvent ".} =
  ...
  nimfunc[](slotval1)
proc QFontDialogmoveEvent*(self: gen_qfontdialog_types.QFontDialog, event: QMoveEvent): void =
  fQFontDialog_virtualbase_moveEvent(self.h, event.h)

type QFontDialogmoveEventProc* = proc(event: QMoveEvent): void
...
proc miqt_exec_callback_QFontDialog_moveEvent(self: ptr cQFontDialog, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QFontDialog_moveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QFontDialogtabletEvent*(self: gen_qfontdialog_types.QFontDialog, event: QTabletEvent): void =
  fQFontDialog_virtualbase_tabletEvent(self.h, event.h)

type QFontDialogtabletEventProc* = proc(event: QTabletEvent): void
...
proc miqt_exec_callback_QFontDialog_tabletEvent(self: ptr cQFontDialog, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QFontDialog_tabletEvent ".} =
  ...
  nimfunc[](slotval1)
proc QFontDialogactionEvent*(self: gen_qfontdialog_types.QFontDialog, event: QActionEvent): void =
  fQFontDialog_virtualbase_actionEvent(self.h, event.h)

type QFontDialogactionEventProc* = proc(event: QActionEvent): void
...
proc miqt_exec_callback_QFontDialog_actionEvent(self: ptr cQFontDialog, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QFontDialog_actionEvent ".} =
  ...
  nimfunc[](slotval1)
proc QFontDialogdragEnterEvent*(self: gen_qfontdialog_types.QFontDialog, event: QDragEnterEvent): void =
  fQFontDialog_virtualbase_dragEnterEvent(self.h, event.h)

type QFontDialogdragEnterEventProc* = proc(event: QDragEnterEvent): void
...
proc miqt_exec_callback_QFontDialog_dragEnterEvent(self: ptr cQFontDialog, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QFontDialog_dragEnterEvent ".} =
  ...
  nimfunc[](slotval1)
proc QFontDialogdragMoveEvent*(self: gen_qfontdialog_types.QFontDialog, event: QDragMoveEvent): void =
  fQFontDialog_virtualbase_dragMoveEvent(self.h, event.h)

type QFontDialogdragMoveEventProc* = proc(event: QDragMoveEvent): void
...
proc miqt_exec_callback_QFontDialog_dragMoveEvent(self: ptr cQFontDialog, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QFontDialog_dragMoveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QFontDialogdragLeaveEvent*(self: gen_qfontdialog_types.QFontDialog, event: QDragLeaveEvent): void =
  fQFontDialog_virtualbase_dragLeaveEvent(self.h, event.h)

type QFontDialogdragLeaveEventProc* = proc(event: QDragLeaveEvent): void
...
proc miqt_exec_callback_QFontDialog_dragLeaveEvent(self: ptr cQFontDialog, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QFontDialog_dragLeaveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QFontDialogdropEvent*(self: gen_qfontdialog_types.QFontDialog, event: QDropEvent): void =
  fQFontDialog_virtualbase_dropEvent(self.h, event.h)

type QFontDialogdropEventProc* = proc(event: QDropEvent): void
...
proc miqt_exec_callback_QFontDialog_dropEvent(self: ptr cQFontDialog, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QFontDialog_dropEvent ".} =
  ...
  nimfunc[](slotval1)
proc QFontDialoghideEvent*(self: gen_qfontdialog_types.QFontDialog, event: QHideEvent): void =
  fQFontDialog_virtualbase_hideEvent(self.h, event.h)

type QFontDialoghideEventProc* = proc(event: QHideEvent): void
...
proc miqt_exec_callback_QFontDialog_metric(self: ptr cQFontDialog, slot: int, param1: cint): cint {.exportc: "miqt_exec_callback_QFontDialog_metric ".} =
  ...
  virtualReturn
proc QFontDialoginitPainter*(self: gen_qfontdialog_types.QFontDialog, painter: QPainter): void =
  fQFontDialog_virtualbase_initPainter(self.h, painter.h)

type QFontDialoginitPainterProc* = proc(painter: QPainter): void
...
proc miqt_exec_callback_QFontDialog_initPainter(self: ptr cQFontDialog, slot: int, painter: pointer): void {.exportc: "miqt_exec_callback_QFontDialog_initPainter ".} =
  ...
  nimfunc[](slotval1)
proc QFontDialogredirected*(self: gen_qfontdialog_types.QFontDialog, offset: QPoint): QPaintDevice =
  QPaintDevice(h: fQFontDialog_virtualbase_redirected(self.h, offset.h))

type QFontDialogredirectedProc* = proc(offset: QPoint): QPaintDevice
...
proc miqt_exec_callback_QFontDialog_redirected(self: ptr cQFontDialog, slot: int, offset: pointer): pointer {.exportc: "miqt_exec_callback_QFontDialog_redirected ".} =
  ...
  virtualReturn.h
proc QFontDialogsharedPainter*(self: gen_qfontdialog_types.QFontDialog, ): QPainter =
  QPainter(h: fQFontDialog_virtualbase_sharedPainter(self.h))

type QFontDialogsharedPainterProc* = proc(): QPainter
...
proc miqt_exec_callback_QFontDialog_sharedPainter(self: ptr cQFontDialog, slot: int): pointer {.exportc: "miqt_exec_callback_QFontDialog_sharedPainter ".} =
  ...
  virtualReturn.h
proc QFontDialoginputMethodEvent*(self: gen_qfontdialog_types.QFontDialog, param1: QInputMethodEvent): void =
  fQFontDialog_virtualbase_inputMethodEvent(self.h, param1.h)

type QFontDialoginputMethodEventProc* = proc(param1: QInputMethodEvent): void
...
proc miqt_exec_callback_QFontDialog_inputMethodEvent(self: ptr cQFontDialog, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QFontDialog_inputMethodEvent ".} =
  ...
  nimfunc[](slotval1)
proc QFontDialoginputMethodQuery*(self: gen_qfontdialog_types.QFontDialog, param1: cint): QVariant =
  QVariant(h: fQFontDialog_virtualbase_inputMethodQuery(self.h, cint(param1)))

type QFontDialoginputMethodQueryProc* = proc(param1: cint): QVariant
...
proc miqt_exec_callback_QFontDialog_focusNextPrevChild(self: ptr cQFontDialog, slot: int, next: bool): bool {.exportc: "miqt_exec_callback_QFontDialog_focusNextPrevChild ".} =
  ...
  virtualReturn
proc QFontDialogtimerEvent*(self: gen_qfontdialog_types.QFontDialog, event: QTimerEvent): void =
  fQFontDialog_virtualbase_timerEvent(self.h, event.h)

type QFontDialogtimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QFontDialog_timerEvent(self: ptr cQFontDialog, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QFontDialog_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QFontDialogchildEvent*(self: gen_qfontdialog_types.QFontDialog, event: QChildEvent): void =
  fQFontDialog_virtualbase_childEvent(self.h, event.h)

type QFontDialogchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QFontDialog_childEvent(self: ptr cQFontDialog, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QFontDialog_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QFontDialogcustomEvent*(self: gen_qfontdialog_types.QFontDialog, event: QEvent): void =
  fQFontDialog_virtualbase_customEvent(self.h, event.h)

type QFontDialogcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QFontDialog_customEvent(self: ptr cQFontDialog, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QFontDialog_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QFontDialogconnectNotify*(self: gen_qfontdialog_types.QFontDialog, signal: QMetaMethod): void =
  fQFontDialog_virtualbase_connectNotify(self.h, signal.h)

type QFontDialogconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QFontDialog_connectNotify(self: ptr cQFontDialog, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QFontDialog_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QFontDialogdisconnectNotify*(self: gen_qfontdialog_types.QFontDialog, signal: QMetaMethod): void =
  fQFontDialog_virtualbase_disconnectNotify(self.h, signal.h)

type QFontDialogdisconnectNotifyProc* = proc(signal: QMetaMethod): void
