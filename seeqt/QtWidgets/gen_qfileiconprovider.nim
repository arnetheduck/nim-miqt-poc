...
proc icon*(self: gen_qfileiconprovider_types.QFileIconProvider, typeVal: cint): QIcon =
  QIcon(h: fcQFileIconProvider_icon(self.h, cint(typeVal)))

proc icon*(self: gen_qfileiconprovider_types.QFileIconProvider, info: QFileInfo): QIcon =
  QIcon(h: fcQFileIconProvider_iconWithInfo(self.h, info.h))

proc typeX*(self: gen_qfileiconprovider_types.QFileIconProvider, info: QFileInfo): string =
...
proc QFileIconProvidericon*(self: gen_qfileiconprovider_types.QFileIconProvider, typeVal: cint): QIcon =
  QIcon(h: fQFileIconProvider_virtualbase_icon(self.h, cint(typeVal)))

type QFileIconProvidericonProc* = proc(typeVal: cint): QIcon
...
proc miqt_exec_callback_QFileIconProvider_icon(self: ptr cQFileIconProvider, slot: int, typeVal: cint): pointer {.exportc: "miqt_exec_callback_QFileIconProvider_icon ".} =
  ...
  virtualReturn.h
proc QFileIconProvidericon*(self: gen_qfileiconprovider_types.QFileIconProvider, info: QFileInfo): QIcon =
  QIcon(h: fQFileIconProvider_virtualbase_iconWithInfo(self.h, info.h))

type QFileIconProvidericonWithInfoProc* = proc(info: QFileInfo): QIcon
...
proc miqt_exec_callback_QFileIconProvider_iconWithInfo(self: ptr cQFileIconProvider, slot: int, info: pointer): pointer {.exportc: "miqt_exec_callback_QFileIconProvider_iconWithInfo ".} =
  ...
  let slotval1 = QFileInfo(h: info)


  let virtualReturn = nimfunc[](slotval1 )

  virtualReturn.h
proc QFileIconProvidertypeX*(self: gen_qfileiconprovider_types.QFileIconProvider, info: QFileInfo): string =
  let v_ms = fQFileIconProvider_virtualbase_type(self.h, info.h)
  let vx_ret = string.fromBytes(toOpenArrayByte(v_ms.data, 0, int(v_ms.len)-1))
  c_free(v_ms.data)
  vx_ret

type QFileIconProvidertypeXProc* = proc(info: QFileInfo): string
