...
void QKeySequenceEdit_connect_editingFinished(QKeySequenceEdit* self, intptr_t slot, void (*callback)(intptr_t), void (*release)(intptr_t)) {
	...
	MiqtVirtualQKeySequenceEdit::connect(self, static_cast<void (QKeySequenceEdit::*)()>(&QKeySequenceEdit::editingFinished), self, caller{slot, callback, release});
}
...
void QKeySequenceEdit_connect_keySequenceChanged(QKeySequenceEdit* self, intptr_t slot, void (*callback)(intptr_t, QKeySequence*), void (*release)(intptr_t)) {
	...
	MiqtVirtualQKeySequenceEdit::connect(self, static_cast<void (QKeySequenceEdit::*)(const QKeySequence&)>(&QKeySequenceEdit::keySequenceChanged), self, caller{slot, callback, release});
}
...
QMetaObject* QKeySequenceEdit_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQKeySequenceEdit*)(self) )->QKeySequenceEdit::metaObject();

}

void* QKeySequenceEdit_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQKeySequenceEdit*)(self) )->QKeySequenceEdit::qt_metacast(param1);

}

int QKeySequenceEdit_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQKeySequenceEdit*)(self) )->QKeySequenceEdit::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
void QKeySequenceEdit_virtualbase_focusOutEvent(void* self, QFocusEvent* param1) {
	...
	( (MiqtVirtualQKeySequenceEdit*)(self) )->QKeySequenceEdit::focusOutEvent(param1);
...
bool QKeySequenceEdit_virtualbase_nativeEvent(void* self, struct miqt_string eventType, void* message, intptr_t* result) {
	...
	return ( (MiqtVirtualQKeySequenceEdit*)(self) )->QKeySequenceEdit::nativeEvent(eventType_QByteArray, message, (qintptr*)(result));
