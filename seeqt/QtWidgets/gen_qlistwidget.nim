...
proc items*(self: gen_qlistwidget_types.QListWidget, data: QMimeData): seq[QListWidgetItem] =
...
proc indexFromItem*(self: gen_qlistwidget_types.QListWidget, item: QListWidgetItem): QModelIndex =
  QModelIndex(h: fcQListWidget_indexFromItem(self.h, item.h))

proc itemFromIndex*(self: gen_qlistwidget_types.QListWidget, index: QModelIndex): QListWidgetItem =
...
proc miqt_exec_callback_QListWidget_startDrag(self: ptr cQListWidget, slot: int, supportedActions: cint): void {.exportc: "miqt_exec_callback_QListWidget_startDrag ".} =
  ...
  nimfunc[](slotval1)
proc QListWidgetinitViewItemOption*(self: gen_qlistwidget_types.QListWidget, option: QStyleOptionViewItem): void =
  fQListWidget_virtualbase_initViewItemOption(self.h, option.h)

type QListWidgetinitViewItemOptionProc* = proc(option: QStyleOptionViewItem): void
...
proc miqt_exec_callback_QListWidget_sizeHintForColumn(self: ptr cQListWidget, slot: int, column: cint): cint {.exportc: "miqt_exec_callback_QListWidget_sizeHintForColumn ".} =
  ...
  virtualReturn
proc QListWidgetitemDelegateForIndex*(self: gen_qlistwidget_types.QListWidget, index: QModelIndex): QAbstractItemDelegate =
  QAbstractItemDelegate(h: fQListWidget_virtualbase_itemDelegateForIndex(self.h, index.h))

type QListWidgetitemDelegateForIndexProc* = proc(index: QModelIndex): QAbstractItemDelegate
...
proc miqt_exec_callback_QListWidget_changeEvent(self: ptr cQListWidget, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QListWidget_changeEvent ".} =
  ...
  nimfunc[](slotval1)
proc QListWidgetinitStyleOption*(self: gen_qlistwidget_types.QListWidget, option: QStyleOptionFrame): void =
  fQListWidget_virtualbase_initStyleOption(self.h, option.h)

type QListWidgetinitStyleOptionProc* = proc(option: QStyleOptionFrame): void
...
proc miqt_exec_callback_QListWidget_keyReleaseEvent(self: ptr cQListWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QListWidget_keyReleaseEvent ".} =
  ...
  nimfunc[](slotval1)
proc QListWidgetenterEvent*(self: gen_qlistwidget_types.QListWidget, event: QEnterEvent): void =
  fQListWidget_virtualbase_enterEvent(self.h, event.h)

type QListWidgetenterEventProc* = proc(event: QEnterEvent): void
