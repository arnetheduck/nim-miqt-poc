...
void QListView_connect_indexesMoved(QListView* self, intptr_t slot, void (*callback)(intptr_t, struct miqt_array /* of QModelIndex* */ ), void (*release)(intptr_t)) {
	...
	MiqtVirtualQListView::connect(self, static_cast<void (QListView::*)(const QModelIndexList&)>(&QListView::indexesMoved), self, caller{slot, callback, release});
}
...
QMetaObject* QListView_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQListView*)(self) )->QListView::metaObject();

}

void* QListView_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQListView*)(self) )->QListView::qt_metacast(param1);

}

int QListView_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQListView*)(self) )->QListView::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
QStyleOptionViewItem* QListView_virtualbase_viewOptions(const void* self) {
	...
	return new QStyleOptionViewItem(( (const MiqtVirtualQListView*)(self) )->QListView::viewOptions());
...
bool QListView_virtualbase_nativeEvent(void* self, struct miqt_string eventType, void* message, long* result) {
	...
	return ( (MiqtVirtualQListView*)(self) )->QListView::nativeEvent(eventType_QByteArray, message, static_cast<long*>(result));
