...
func init*(T: type gen_qgraphicsanchorlayout_types.QGraphicsAnchor, h: ptr cQGraphicsAnchor): gen_qgraphicsanchorlayout_types.QGraphicsAnchor =
  T(h: h)
proc metaObject*(self: gen_qgraphicsanchorlayout_types.QGraphicsAnchor, ): QMetaObject =
  QMetaObject(h: fcQGraphicsAnchor_metaObject(self.h))
...
proc create*(T: type gen_qgraphicsanchorlayout_types.QGraphicsAnchorLayout, parent: QGraphicsLayoutItem): gen_qgraphicsanchorlayout_types.QGraphicsAnchorLayout =
  gen_qgraphicsanchorlayout_types.QGraphicsAnchorLayout.init(fcQGraphicsAnchorLayout_new2(parent.h))

proc addAnchor*(self: gen_qgraphicsanchorlayout_types.QGraphicsAnchorLayout, firstItem: QGraphicsLayoutItem, firstEdge: cint, secondItem: QGraphicsLayoutItem, secondEdge: cint): QGraphicsAnchor =
  QGraphicsAnchor(h: fcQGraphicsAnchorLayout_addAnchor(self.h, firstItem.h, cint(firstEdge), secondItem.h, cint(secondEdge)))

proc anchor*(self: gen_qgraphicsanchorlayout_types.QGraphicsAnchorLayout, firstItem: QGraphicsLayoutItem, firstEdge: cint, secondItem: QGraphicsLayoutItem, secondEdge: cint): QGraphicsAnchor =
  QGraphicsAnchor(h: fcQGraphicsAnchorLayout_anchor(self.h, firstItem.h, cint(firstEdge), secondItem.h, cint(secondEdge)))

proc addCornerAnchors*(self: gen_qgraphicsanchorlayout_types.QGraphicsAnchorLayout, firstItem: QGraphicsLayoutItem, firstCorner: cint, secondItem: QGraphicsLayoutItem, secondCorner: cint): void =
  fcQGraphicsAnchorLayout_addCornerAnchors(self.h, firstItem.h, cint(firstCorner), secondItem.h, cint(secondCorner))

proc addAnchors*(self: gen_qgraphicsanchorlayout_types.QGraphicsAnchorLayout, firstItem: QGraphicsLayoutItem, secondItem: QGraphicsLayoutItem): void =
...
proc setGeometry*(self: gen_qgraphicsanchorlayout_types.QGraphicsAnchorLayout, rect: QRectF): void =
...
proc itemAt*(self: gen_qgraphicsanchorlayout_types.QGraphicsAnchorLayout, index: cint): QGraphicsLayoutItem =
  QGraphicsLayoutItem(h: fcQGraphicsAnchorLayout_itemAt(self.h, index))

proc invalidate*(self: gen_qgraphicsanchorlayout_types.QGraphicsAnchorLayout, ): void =
  fcQGraphicsAnchorLayout_invalidate(self.h)

proc addAnchors*(self: gen_qgraphicsanchorlayout_types.QGraphicsAnchorLayout, firstItem: QGraphicsLayoutItem, secondItem: QGraphicsLayoutItem, orientations: cint): void =
...
proc miqt_exec_callback_QGraphicsAnchorLayout_removeAt(self: ptr cQGraphicsAnchorLayout, slot: int, index: cint): void {.exportc: "miqt_exec_callback_QGraphicsAnchorLayout_removeAt ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsAnchorLayoutsetGeometry*(self: gen_qgraphicsanchorlayout_types.QGraphicsAnchorLayout, rect: QRectF): void =
  fQGraphicsAnchorLayout_virtualbase_setGeometry(self.h, rect.h)

type QGraphicsAnchorLayoutsetGeometryProc* = proc(rect: QRectF): void
...
proc miqt_exec_callback_QGraphicsAnchorLayout_count(self: ptr cQGraphicsAnchorLayout, slot: int): cint {.exportc: "miqt_exec_callback_QGraphicsAnchorLayout_count ".} =
  ...
  virtualReturn
proc QGraphicsAnchorLayoutitemAt*(self: gen_qgraphicsanchorlayout_types.QGraphicsAnchorLayout, index: cint): QGraphicsLayoutItem =
  QGraphicsLayoutItem(h: fQGraphicsAnchorLayout_virtualbase_itemAt(self.h, index))

type QGraphicsAnchorLayoutitemAtProc* = proc(index: cint): QGraphicsLayoutItem
...
proc miqt_exec_callback_QGraphicsAnchorLayout_invalidate(self: ptr cQGraphicsAnchorLayout, slot: int): void {.exportc: "miqt_exec_callback_QGraphicsAnchorLayout_invalidate ".} =
  ...
  nimfunc[]()
proc QGraphicsAnchorLayoutsizeHint*(self: gen_qgraphicsanchorlayout_types.QGraphicsAnchorLayout, which: cint, constraint: QSizeF): QSizeF =
  QSizeF(h: fQGraphicsAnchorLayout_virtualbase_sizeHint(self.h, cint(which), constraint.h))

type QGraphicsAnchorLayoutsizeHintProc* = proc(which: cint, constraint: QSizeF): QSizeF
...
proc miqt_exec_callback_QGraphicsAnchorLayout_updateGeometry(self: ptr cQGraphicsAnchorLayout, slot: int): void {.exportc: "miqt_exec_callback_QGraphicsAnchorLayout_updateGeometry ".} =
  ...
  nimfunc[]()
proc QGraphicsAnchorLayoutwidgetEvent*(self: gen_qgraphicsanchorlayout_types.QGraphicsAnchorLayout, e: QEvent): void =
  fQGraphicsAnchorLayout_virtualbase_widgetEvent(self.h, e.h)

type QGraphicsAnchorLayoutwidgetEventProc* = proc(e: QEvent): void
