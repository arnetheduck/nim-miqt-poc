...
proc fcQItemDelegate_trUtf8(s: cstring): struct_miqt_string {.importc: "QItemDelegate_trUtf8".}
...
proc fcQItemDelegate_trUtf82(s: cstring, c: cstring): struct_miqt_string {.importc: "QItemDelegate_trUtf82".}
proc fcQItemDelegate_trUtf83(s: cstring, c: cstring, n: cint): struct_miqt_string {.importc: "QItemDelegate_trUtf83".}
...
proc create*(T: type gen_qitemdelegate_types.QItemDelegate, parent: QObject): gen_qitemdelegate_types.QItemDelegate =
  gen_qitemdelegate_types.QItemDelegate.init(fcQItemDelegate_new2(parent.h))

proc metaObject*(self: gen_qitemdelegate_types.QItemDelegate, ): QMetaObject =
  QMetaObject(h: fcQItemDelegate_metaObject(self.h))
...
proc paint*(self: gen_qitemdelegate_types.QItemDelegate, painter: QPainter, option: QStyleOptionViewItem, index: QModelIndex): void =
  fcQItemDelegate_paint(self.h, painter.h, option.h, index.h)

proc sizeHint*(self: gen_qitemdelegate_types.QItemDelegate, option: QStyleOptionViewItem, index: QModelIndex): QSize =
  QSize(h: fcQItemDelegate_sizeHint(self.h, option.h, index.h))

proc createEditor*(self: gen_qitemdelegate_types.QItemDelegate, parent: QWidget, option: QStyleOptionViewItem, index: QModelIndex): QWidget =
  QWidget(h: fcQItemDelegate_createEditor(self.h, parent.h, option.h, index.h))

proc setEditorData*(self: gen_qitemdelegate_types.QItemDelegate, editor: QWidget, index: QModelIndex): void =
  fcQItemDelegate_setEditorData(self.h, editor.h, index.h)

proc setModelData*(self: gen_qitemdelegate_types.QItemDelegate, editor: QWidget, model: QAbstractItemModel, index: QModelIndex): void =
  fcQItemDelegate_setModelData(self.h, editor.h, model.h, index.h)

proc updateEditorGeometry*(self: gen_qitemdelegate_types.QItemDelegate, editor: QWidget, option: QStyleOptionViewItem, index: QModelIndex): void =
  fcQItemDelegate_updateEditorGeometry(self.h, editor.h, option.h, index.h)

proc itemEditorFactory*(self: gen_qitemdelegate_types.QItemDelegate, ): QItemEditorFactory =
  QItemEditorFactory(h: fcQItemDelegate_itemEditorFactory(self.h))

proc setItemEditorFactory*(self: gen_qitemdelegate_types.QItemDelegate, factory: QItemEditorFactory): void =
...
proc miqt_exec_callback_QItemDelegate_metacall(self: ptr cQItemDelegate, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QItemDelegate_metacall ".} =
  ...
  virtualReturn
proc QItemDelegatepaint*(self: gen_qitemdelegate_types.QItemDelegate, painter: QPainter, option: QStyleOptionViewItem, index: QModelIndex): void =
  fQItemDelegate_virtualbase_paint(self.h, painter.h, option.h, index.h)

type QItemDelegatepaintProc* = proc(painter: QPainter, option: QStyleOptionViewItem, index: QModelIndex): void
...
proc miqt_exec_callback_QItemDelegate_paint(self: ptr cQItemDelegate, slot: int, painter: pointer, option: pointer, index: pointer): void {.exportc: "miqt_exec_callback_QItemDelegate_paint ".} =
  ...
  let slotval2 = QStyleOptionViewItem(h: option)

  let slotval3 = QModelIndex(h: index)


  nimfunc[](slotval1, slotval2, slotval3)
proc QItemDelegatesizeHint*(self: gen_qitemdelegate_types.QItemDelegate, option: QStyleOptionViewItem, index: QModelIndex): QSize =
  QSize(h: fQItemDelegate_virtualbase_sizeHint(self.h, option.h, index.h))

type QItemDelegatesizeHintProc* = proc(option: QStyleOptionViewItem, index: QModelIndex): QSize
...
proc miqt_exec_callback_QItemDelegate_sizeHint(self: ptr cQItemDelegate, slot: int, option: pointer, index: pointer): pointer {.exportc: "miqt_exec_callback_QItemDelegate_sizeHint ".} =
  ...
  let slotval2 = QModelIndex(h: index)


  let virtualReturn = nimfunc[](slotval1, slotval2 )

  virtualReturn.h
proc QItemDelegatecreateEditor*(self: gen_qitemdelegate_types.QItemDelegate, parent: QWidget, option: QStyleOptionViewItem, index: QModelIndex): QWidget =
  QWidget(h: fQItemDelegate_virtualbase_createEditor(self.h, parent.h, option.h, index.h))

type QItemDelegatecreateEditorProc* = proc(parent: QWidget, option: QStyleOptionViewItem, index: QModelIndex): QWidget
...
proc miqt_exec_callback_QItemDelegate_createEditor(self: ptr cQItemDelegate, slot: int, parent: pointer, option: pointer, index: pointer): pointer {.exportc: "miqt_exec_callback_QItemDelegate_createEditor ".} =
  ...
  virtualReturn.h
proc QItemDelegatesetEditorData*(self: gen_qitemdelegate_types.QItemDelegate, editor: QWidget, index: QModelIndex): void =
  fQItemDelegate_virtualbase_setEditorData(self.h, editor.h, index.h)

type QItemDelegatesetEditorDataProc* = proc(editor: QWidget, index: QModelIndex): void
...
proc QItemDelegatesetModelData*(self: gen_qitemdelegate_types.QItemDelegate, editor: QWidget, model: QAbstractItemModel, index: QModelIndex): void =
  fQItemDelegate_virtualbase_setModelData(self.h, editor.h, model.h, index.h)

type QItemDelegatesetModelDataProc* = proc(editor: QWidget, model: QAbstractItemModel, index: QModelIndex): void
...
proc miqt_exec_callback_QItemDelegate_setModelData(self: ptr cQItemDelegate, slot: int, editor: pointer, model: pointer, index: pointer): void {.exportc: "miqt_exec_callback_QItemDelegate_setModelData ".} =
  ...
  let slotval2 = QAbstractItemModel(h: model)

  let slotval3 = QModelIndex(h: index)


  nimfunc[](slotval1, slotval2, slotval3)
proc QItemDelegateupdateEditorGeometry*(self: gen_qitemdelegate_types.QItemDelegate, editor: QWidget, option: QStyleOptionViewItem, index: QModelIndex): void =
  fQItemDelegate_virtualbase_updateEditorGeometry(self.h, editor.h, option.h, index.h)

type QItemDelegateupdateEditorGeometryProc* = proc(editor: QWidget, option: QStyleOptionViewItem, index: QModelIndex): void
...
proc miqt_exec_callback_QItemDelegate_updateEditorGeometry(self: ptr cQItemDelegate, slot: int, editor: pointer, option: pointer, index: pointer): void {.exportc: "miqt_exec_callback_QItemDelegate_updateEditorGeometry ".} =
  ...
  nimfunc[](slotval1, slotval2, slotval3)
proc QItemDelegatedrawDisplay*(self: gen_qitemdelegate_types.QItemDelegate, painter: QPainter, option: QStyleOptionViewItem, rect: QRect, text: string): void =
...
type QItemDelegatedrawDisplayProc* = proc(painter: QPainter, option: QStyleOptionViewItem, rect: QRect, text: string): void
...
proc QItemDelegatedrawDecoration*(self: gen_qitemdelegate_types.QItemDelegate, painter: QPainter, option: QStyleOptionViewItem, rect: QRect, pixmap: QPixmap): void =
  fQItemDelegate_virtualbase_drawDecoration(self.h, painter.h, option.h, rect.h, pixmap.h)

type QItemDelegatedrawDecorationProc* = proc(painter: QPainter, option: QStyleOptionViewItem, rect: QRect, pixmap: QPixmap): void
...
proc miqt_exec_callback_QItemDelegate_drawDecoration(self: ptr cQItemDelegate, slot: int, painter: pointer, option: pointer, rect: pointer, pixmap: pointer): void {.exportc: "miqt_exec_callback_QItemDelegate_drawDecoration ".} =
  ...
  nimfunc[](slotval1, slotval2, slotval3, slotval4)
proc QItemDelegatedrawFocus*(self: gen_qitemdelegate_types.QItemDelegate, painter: QPainter, option: QStyleOptionViewItem, rect: QRect): void =
  fQItemDelegate_virtualbase_drawFocus(self.h, painter.h, option.h, rect.h)

type QItemDelegatedrawFocusProc* = proc(painter: QPainter, option: QStyleOptionViewItem, rect: QRect): void
...
proc miqt_exec_callback_QItemDelegate_drawFocus(self: ptr cQItemDelegate, slot: int, painter: pointer, option: pointer, rect: pointer): void {.exportc: "miqt_exec_callback_QItemDelegate_drawFocus ".} =
  ...
  nimfunc[](slotval1, slotval2, slotval3)
proc QItemDelegatedrawCheck*(self: gen_qitemdelegate_types.QItemDelegate, painter: QPainter, option: QStyleOptionViewItem, rect: QRect, state: cint): void =
  fQItemDelegate_virtualbase_drawCheck(self.h, painter.h, option.h, rect.h, cint(state))

type QItemDelegatedrawCheckProc* = proc(painter: QPainter, option: QStyleOptionViewItem, rect: QRect, state: cint): void
...
proc miqt_exec_callback_QItemDelegate_drawCheck(self: ptr cQItemDelegate, slot: int, painter: pointer, option: pointer, rect: pointer, state: cint): void {.exportc: "miqt_exec_callback_QItemDelegate_drawCheck ".} =
  ...
  nimfunc[](slotval1, slotval2, slotval3, slotval4)
proc QItemDelegateeventFilter*(self: gen_qitemdelegate_types.QItemDelegate, objectVal: QObject, event: QEvent): bool =
  fQItemDelegate_virtualbase_eventFilter(self.h, objectVal.h, event.h)

type QItemDelegateeventFilterProc* = proc(objectVal: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QItemDelegate_eventFilter(self: ptr cQItemDelegate, slot: int, objectVal: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QItemDelegate_eventFilter ".} =
  ...
  virtualReturn
proc QItemDelegateeditorEvent*(self: gen_qitemdelegate_types.QItemDelegate, event: QEvent, model: QAbstractItemModel, option: QStyleOptionViewItem, index: QModelIndex): bool =
  fQItemDelegate_virtualbase_editorEvent(self.h, event.h, model.h, option.h, index.h)

type QItemDelegateeditorEventProc* = proc(event: QEvent, model: QAbstractItemModel, option: QStyleOptionViewItem, index: QModelIndex): bool
...
proc miqt_exec_callback_QItemDelegate_editorEvent(self: ptr cQItemDelegate, slot: int, event: pointer, model: pointer, option: pointer, index: pointer): bool {.exportc: "miqt_exec_callback_QItemDelegate_editorEvent ".} =
  ...
  let slotval3 = QStyleOptionViewItem(h: option)

  let slotval4 = QModelIndex(h: index)


  let virtualReturn = nimfunc[](slotval1, slotval2, slotval3, slotval4 )

  virtualReturn
proc QItemDelegatedestroyEditor*(self: gen_qitemdelegate_types.QItemDelegate, editor: QWidget, index: QModelIndex): void =
  fQItemDelegate_virtualbase_destroyEditor(self.h, editor.h, index.h)

type QItemDelegatedestroyEditorProc* = proc(editor: QWidget, index: QModelIndex): void
...
proc miqt_exec_callback_QItemDelegate_destroyEditor(self: ptr cQItemDelegate, slot: int, editor: pointer, index: pointer): void {.exportc: "miqt_exec_callback_QItemDelegate_destroyEditor ".} =
  ...
  nimfunc[](slotval1, slotval2)
proc QItemDelegatehelpEvent*(self: gen_qitemdelegate_types.QItemDelegate, event: QHelpEvent, view: QAbstractItemView, option: QStyleOptionViewItem, index: QModelIndex): bool =
  fQItemDelegate_virtualbase_helpEvent(self.h, event.h, view.h, option.h, index.h)

type QItemDelegatehelpEventProc* = proc(event: QHelpEvent, view: QAbstractItemView, option: QStyleOptionViewItem, index: QModelIndex): bool
...
proc miqt_exec_callback_QItemDelegate_helpEvent(self: ptr cQItemDelegate, slot: int, event: pointer, view: pointer, option: pointer, index: pointer): bool {.exportc: "miqt_exec_callback_QItemDelegate_helpEvent ".} =
  ...
  let slotval1 = QHelpEvent(h: event)

  let slotval2 = QAbstractItemView(h: view)
...
proc QItemDelegateevent*(self: gen_qitemdelegate_types.QItemDelegate, event: QEvent): bool =
  fQItemDelegate_virtualbase_event(self.h, event.h)

type QItemDelegateeventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QItemDelegate_event(self: ptr cQItemDelegate, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QItemDelegate_event ".} =
  ...
  virtualReturn
proc QItemDelegatetimerEvent*(self: gen_qitemdelegate_types.QItemDelegate, event: QTimerEvent): void =
  fQItemDelegate_virtualbase_timerEvent(self.h, event.h)

type QItemDelegatetimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QItemDelegate_timerEvent(self: ptr cQItemDelegate, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QItemDelegate_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QItemDelegatechildEvent*(self: gen_qitemdelegate_types.QItemDelegate, event: QChildEvent): void =
  fQItemDelegate_virtualbase_childEvent(self.h, event.h)

type QItemDelegatechildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QItemDelegate_childEvent(self: ptr cQItemDelegate, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QItemDelegate_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QItemDelegatecustomEvent*(self: gen_qitemdelegate_types.QItemDelegate, event: QEvent): void =
  fQItemDelegate_virtualbase_customEvent(self.h, event.h)

type QItemDelegatecustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QItemDelegate_customEvent(self: ptr cQItemDelegate, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QItemDelegate_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QItemDelegateconnectNotify*(self: gen_qitemdelegate_types.QItemDelegate, signal: QMetaMethod): void =
  fQItemDelegate_virtualbase_connectNotify(self.h, signal.h)

type QItemDelegateconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QItemDelegate_connectNotify(self: ptr cQItemDelegate, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QItemDelegate_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QItemDelegatedisconnectNotify*(self: gen_qitemdelegate_types.QItemDelegate, signal: QMetaMethod): void =
  fQItemDelegate_virtualbase_disconnectNotify(self.h, signal.h)

type QItemDelegatedisconnectNotifyProc* = proc(signal: QMetaMethod): void
