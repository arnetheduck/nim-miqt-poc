...
QMetaObject* QWidgetAction_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQWidgetAction*)(self) )->QWidgetAction::metaObject();

}

void* QWidgetAction_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQWidgetAction*)(self) )->QWidgetAction::qt_metacast(param1);

}

int QWidgetAction_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQWidgetAction*)(self) )->QWidgetAction::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
struct miqt_array /* of QWidget* */  QWidgetAction_protectedbase_createdWidgets(const void* self) {
	MiqtVirtualQWidgetAction* self_cast = static_cast<MiqtVirtualQWidgetAction*>( (QWidgetAction*)(self) );
