...
func init*(T: type gen_qaccessiblewidget_types.QAccessibleWidget, h: ptr cQAccessibleWidget): gen_qaccessiblewidget_types.QAccessibleWidget =
  T(h: h)
proc create*(T: type gen_qaccessiblewidget_types.QAccessibleWidget, o: QWidget): gen_qaccessiblewidget_types.QAccessibleWidget =
  gen_qaccessiblewidget_types.QAccessibleWidget.init(fcQAccessibleWidget_new(o.h))

proc create*(T: type gen_qaccessiblewidget_types.QAccessibleWidget, o: QWidget, r: cint): gen_qaccessiblewidget_types.QAccessibleWidget =
  gen_qaccessiblewidget_types.QAccessibleWidget.init(fcQAccessibleWidget_new2(o.h, cint(r)))

proc create*(T: type gen_qaccessiblewidget_types.QAccessibleWidget, o: QWidget, r: cint, name: string): gen_qaccessiblewidget_types.QAccessibleWidget =
...
proc window*(self: gen_qaccessiblewidget_types.QAccessibleWidget, ): QWindow =
  QWindow(h: fcQAccessibleWidget_window(self.h))

proc childCount*(self: gen_qaccessiblewidget_types.QAccessibleWidget, ): cint =
  fcQAccessibleWidget_childCount(self.h)

proc indexOfChild*(self: gen_qaccessiblewidget_types.QAccessibleWidget, child: QAccessibleInterface): cint =
  fcQAccessibleWidget_indexOfChild(self.h, child.h)

proc relations*(self: gen_qaccessiblewidget_types.QAccessibleWidget, match: cint): seq[tuple[first: QAccessibleInterface, second: cint]] =
...
proc focusChild*(self: gen_qaccessiblewidget_types.QAccessibleWidget, ): QAccessibleInterface =
  QAccessibleInterface(h: fcQAccessibleWidget_focusChild(self.h))

proc rect*(self: gen_qaccessiblewidget_types.QAccessibleWidget, ): QRect =
  QRect(h: fcQAccessibleWidget_rect(self.h))

proc parent*(self: gen_qaccessiblewidget_types.QAccessibleWidget, ): QAccessibleInterface =
  QAccessibleInterface(h: fcQAccessibleWidget_parent(self.h))

proc child*(self: gen_qaccessiblewidget_types.QAccessibleWidget, index: cint): QAccessibleInterface =
  QAccessibleInterface(h: fcQAccessibleWidget_child(self.h, index))
...
proc state*(self: gen_qaccessiblewidget_types.QAccessibleWidget, ): QAccessibleState =
  QAccessibleState(h: fcQAccessibleWidget_state(self.h))

proc foregroundColor*(self: gen_qaccessiblewidget_types.QAccessibleWidget, ): QColor =
  QColor(h: fcQAccessibleWidget_foregroundColor(self.h))

proc backgroundColor*(self: gen_qaccessiblewidget_types.QAccessibleWidget, ): QColor =
  QColor(h: fcQAccessibleWidget_backgroundColor(self.h))
