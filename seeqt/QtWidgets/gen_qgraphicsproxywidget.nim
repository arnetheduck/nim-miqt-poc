...
proc create*(T: type gen_qgraphicsproxywidget_types.QGraphicsProxyWidget, parent: QGraphicsItem): gen_qgraphicsproxywidget_types.QGraphicsProxyWidget =
  gen_qgraphicsproxywidget_types.QGraphicsProxyWidget.init(fcQGraphicsProxyWidget_new2(parent.h))

proc create*(T: type gen_qgraphicsproxywidget_types.QGraphicsProxyWidget, parent: QGraphicsItem, wFlags: cint): gen_qgraphicsproxywidget_types.QGraphicsProxyWidget =
  gen_qgraphicsproxywidget_types.QGraphicsProxyWidget.init(fcQGraphicsProxyWidget_new3(parent.h, cint(wFlags)))

proc metaObject*(self: gen_qgraphicsproxywidget_types.QGraphicsProxyWidget, ): QMetaObject =
  QMetaObject(h: fcQGraphicsProxyWidget_metaObject(self.h))
...
proc setWidget*(self: gen_qgraphicsproxywidget_types.QGraphicsProxyWidget, widget: QWidget): void =
  fcQGraphicsProxyWidget_setWidget(self.h, widget.h)

proc widget*(self: gen_qgraphicsproxywidget_types.QGraphicsProxyWidget, ): QWidget =
  QWidget(h: fcQGraphicsProxyWidget_widget(self.h))

proc subWidgetRect*(self: gen_qgraphicsproxywidget_types.QGraphicsProxyWidget, widget: QWidget): QRectF =
  QRectF(h: fcQGraphicsProxyWidget_subWidgetRect(self.h, widget.h))

proc setGeometry*(self: gen_qgraphicsproxywidget_types.QGraphicsProxyWidget, rect: QRectF): void =
  fcQGraphicsProxyWidget_setGeometry(self.h, rect.h)

proc paint*(self: gen_qgraphicsproxywidget_types.QGraphicsProxyWidget, painter: QPainter, option: QStyleOptionGraphicsItem, widget: QWidget): void =
...
proc createProxyForChildWidget*(self: gen_qgraphicsproxywidget_types.QGraphicsProxyWidget, child: QWidget): QGraphicsProxyWidget =
...
proc miqt_exec_callback_QGraphicsProxyWidget_metacall(self: ptr cQGraphicsProxyWidget, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QGraphicsProxyWidget_metacall ".} =
  ...
  virtualReturn
proc QGraphicsProxyWidgetsetGeometry*(self: gen_qgraphicsproxywidget_types.QGraphicsProxyWidget, rect: QRectF): void =
  fQGraphicsProxyWidget_virtualbase_setGeometry(self.h, rect.h)

type QGraphicsProxyWidgetsetGeometryProc* = proc(rect: QRectF): void
...
proc miqt_exec_callback_QGraphicsProxyWidget_setGeometry(self: ptr cQGraphicsProxyWidget, slot: int, rect: pointer): void {.exportc: "miqt_exec_callback_QGraphicsProxyWidget_setGeometry ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsProxyWidgetpaint*(self: gen_qgraphicsproxywidget_types.QGraphicsProxyWidget, painter: QPainter, option: QStyleOptionGraphicsItem, widget: QWidget): void =
  fQGraphicsProxyWidget_virtualbase_paint(self.h, painter.h, option.h, widget.h)

type QGraphicsProxyWidgetpaintProc* = proc(painter: QPainter, option: QStyleOptionGraphicsItem, widget: QWidget): void
...
proc miqt_exec_callback_QGraphicsProxyWidget_type(self: ptr cQGraphicsProxyWidget, slot: int): cint {.exportc: "miqt_exec_callback_QGraphicsProxyWidget_type ".} =
  ...
  virtualReturn
proc QGraphicsProxyWidgetitemChange*(self: gen_qgraphicsproxywidget_types.QGraphicsProxyWidget, change: cint, value: QVariant): QVariant =
  QVariant(h: fQGraphicsProxyWidget_virtualbase_itemChange(self.h, cint(change), value.h))

type QGraphicsProxyWidgetitemChangeProc* = proc(change: cint, value: QVariant): QVariant
...
proc miqt_exec_callback_QGraphicsProxyWidget_itemChange(self: ptr cQGraphicsProxyWidget, slot: int, change: cint, value: pointer): pointer {.exportc: "miqt_exec_callback_QGraphicsProxyWidget_itemChange ".} =
  ...
  virtualReturn.h
proc QGraphicsProxyWidgetevent*(self: gen_qgraphicsproxywidget_types.QGraphicsProxyWidget, event: QEvent): bool =
  fQGraphicsProxyWidget_virtualbase_event(self.h, event.h)

type QGraphicsProxyWidgeteventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QGraphicsProxyWidget_event(self: ptr cQGraphicsProxyWidget, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QGraphicsProxyWidget_event ".} =
  ...
  virtualReturn
proc QGraphicsProxyWidgeteventFilter*(self: gen_qgraphicsproxywidget_types.QGraphicsProxyWidget, objectVal: QObject, event: QEvent): bool =
  fQGraphicsProxyWidget_virtualbase_eventFilter(self.h, objectVal.h, event.h)

type QGraphicsProxyWidgeteventFilterProc* = proc(objectVal: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QGraphicsProxyWidget_eventFilter(self: ptr cQGraphicsProxyWidget, slot: int, objectVal: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QGraphicsProxyWidget_eventFilter ".} =
  ...
  virtualReturn
proc QGraphicsProxyWidgetshowEvent*(self: gen_qgraphicsproxywidget_types.QGraphicsProxyWidget, event: QShowEvent): void =
  fQGraphicsProxyWidget_virtualbase_showEvent(self.h, event.h)

type QGraphicsProxyWidgetshowEventProc* = proc(event: QShowEvent): void
...
proc miqt_exec_callback_QGraphicsProxyWidget_showEvent(self: ptr cQGraphicsProxyWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsProxyWidget_showEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsProxyWidgethideEvent*(self: gen_qgraphicsproxywidget_types.QGraphicsProxyWidget, event: QHideEvent): void =
  fQGraphicsProxyWidget_virtualbase_hideEvent(self.h, event.h)

type QGraphicsProxyWidgethideEventProc* = proc(event: QHideEvent): void
...
proc miqt_exec_callback_QGraphicsProxyWidget_hideEvent(self: ptr cQGraphicsProxyWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsProxyWidget_hideEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsProxyWidgetcontextMenuEvent*(self: gen_qgraphicsproxywidget_types.QGraphicsProxyWidget, event: QGraphicsSceneContextMenuEvent): void =
  fQGraphicsProxyWidget_virtualbase_contextMenuEvent(self.h, event.h)

type QGraphicsProxyWidgetcontextMenuEventProc* = proc(event: QGraphicsSceneContextMenuEvent): void
...
proc miqt_exec_callback_QGraphicsProxyWidget_contextMenuEvent(self: ptr cQGraphicsProxyWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsProxyWidget_contextMenuEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsProxyWidgetdragEnterEvent*(self: gen_qgraphicsproxywidget_types.QGraphicsProxyWidget, event: QGraphicsSceneDragDropEvent): void =
  fQGraphicsProxyWidget_virtualbase_dragEnterEvent(self.h, event.h)

type QGraphicsProxyWidgetdragEnterEventProc* = proc(event: QGraphicsSceneDragDropEvent): void
...
proc miqt_exec_callback_QGraphicsProxyWidget_dragEnterEvent(self: ptr cQGraphicsProxyWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsProxyWidget_dragEnterEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsProxyWidgetdragLeaveEvent*(self: gen_qgraphicsproxywidget_types.QGraphicsProxyWidget, event: QGraphicsSceneDragDropEvent): void =
  fQGraphicsProxyWidget_virtualbase_dragLeaveEvent(self.h, event.h)

type QGraphicsProxyWidgetdragLeaveEventProc* = proc(event: QGraphicsSceneDragDropEvent): void
...
proc miqt_exec_callback_QGraphicsProxyWidget_dragLeaveEvent(self: ptr cQGraphicsProxyWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsProxyWidget_dragLeaveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsProxyWidgetdragMoveEvent*(self: gen_qgraphicsproxywidget_types.QGraphicsProxyWidget, event: QGraphicsSceneDragDropEvent): void =
  fQGraphicsProxyWidget_virtualbase_dragMoveEvent(self.h, event.h)

type QGraphicsProxyWidgetdragMoveEventProc* = proc(event: QGraphicsSceneDragDropEvent): void
...
proc miqt_exec_callback_QGraphicsProxyWidget_dragMoveEvent(self: ptr cQGraphicsProxyWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsProxyWidget_dragMoveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsProxyWidgetdropEvent*(self: gen_qgraphicsproxywidget_types.QGraphicsProxyWidget, event: QGraphicsSceneDragDropEvent): void =
  fQGraphicsProxyWidget_virtualbase_dropEvent(self.h, event.h)

type QGraphicsProxyWidgetdropEventProc* = proc(event: QGraphicsSceneDragDropEvent): void
...
proc miqt_exec_callback_QGraphicsProxyWidget_dropEvent(self: ptr cQGraphicsProxyWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsProxyWidget_dropEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsProxyWidgethoverEnterEvent*(self: gen_qgraphicsproxywidget_types.QGraphicsProxyWidget, event: QGraphicsSceneHoverEvent): void =
  fQGraphicsProxyWidget_virtualbase_hoverEnterEvent(self.h, event.h)

type QGraphicsProxyWidgethoverEnterEventProc* = proc(event: QGraphicsSceneHoverEvent): void
...
proc miqt_exec_callback_QGraphicsProxyWidget_hoverEnterEvent(self: ptr cQGraphicsProxyWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsProxyWidget_hoverEnterEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsProxyWidgethoverLeaveEvent*(self: gen_qgraphicsproxywidget_types.QGraphicsProxyWidget, event: QGraphicsSceneHoverEvent): void =
  fQGraphicsProxyWidget_virtualbase_hoverLeaveEvent(self.h, event.h)

type QGraphicsProxyWidgethoverLeaveEventProc* = proc(event: QGraphicsSceneHoverEvent): void
...
proc miqt_exec_callback_QGraphicsProxyWidget_hoverLeaveEvent(self: ptr cQGraphicsProxyWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsProxyWidget_hoverLeaveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsProxyWidgethoverMoveEvent*(self: gen_qgraphicsproxywidget_types.QGraphicsProxyWidget, event: QGraphicsSceneHoverEvent): void =
  fQGraphicsProxyWidget_virtualbase_hoverMoveEvent(self.h, event.h)

type QGraphicsProxyWidgethoverMoveEventProc* = proc(event: QGraphicsSceneHoverEvent): void
...
proc miqt_exec_callback_QGraphicsProxyWidget_hoverMoveEvent(self: ptr cQGraphicsProxyWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsProxyWidget_hoverMoveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsProxyWidgetgrabMouseEvent*(self: gen_qgraphicsproxywidget_types.QGraphicsProxyWidget, event: QEvent): void =
  fQGraphicsProxyWidget_virtualbase_grabMouseEvent(self.h, event.h)

type QGraphicsProxyWidgetgrabMouseEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QGraphicsProxyWidget_grabMouseEvent(self: ptr cQGraphicsProxyWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsProxyWidget_grabMouseEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsProxyWidgetungrabMouseEvent*(self: gen_qgraphicsproxywidget_types.QGraphicsProxyWidget, event: QEvent): void =
  fQGraphicsProxyWidget_virtualbase_ungrabMouseEvent(self.h, event.h)

type QGraphicsProxyWidgetungrabMouseEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QGraphicsProxyWidget_ungrabMouseEvent(self: ptr cQGraphicsProxyWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsProxyWidget_ungrabMouseEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsProxyWidgetmouseMoveEvent*(self: gen_qgraphicsproxywidget_types.QGraphicsProxyWidget, event: QGraphicsSceneMouseEvent): void =
  fQGraphicsProxyWidget_virtualbase_mouseMoveEvent(self.h, event.h)

type QGraphicsProxyWidgetmouseMoveEventProc* = proc(event: QGraphicsSceneMouseEvent): void
...
proc miqt_exec_callback_QGraphicsProxyWidget_mouseMoveEvent(self: ptr cQGraphicsProxyWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsProxyWidget_mouseMoveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsProxyWidgetmousePressEvent*(self: gen_qgraphicsproxywidget_types.QGraphicsProxyWidget, event: QGraphicsSceneMouseEvent): void =
  fQGraphicsProxyWidget_virtualbase_mousePressEvent(self.h, event.h)

type QGraphicsProxyWidgetmousePressEventProc* = proc(event: QGraphicsSceneMouseEvent): void
...
proc miqt_exec_callback_QGraphicsProxyWidget_mousePressEvent(self: ptr cQGraphicsProxyWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsProxyWidget_mousePressEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsProxyWidgetmouseReleaseEvent*(self: gen_qgraphicsproxywidget_types.QGraphicsProxyWidget, event: QGraphicsSceneMouseEvent): void =
  fQGraphicsProxyWidget_virtualbase_mouseReleaseEvent(self.h, event.h)

type QGraphicsProxyWidgetmouseReleaseEventProc* = proc(event: QGraphicsSceneMouseEvent): void
...
proc miqt_exec_callback_QGraphicsProxyWidget_mouseReleaseEvent(self: ptr cQGraphicsProxyWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsProxyWidget_mouseReleaseEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsProxyWidgetmouseDoubleClickEvent*(self: gen_qgraphicsproxywidget_types.QGraphicsProxyWidget, event: QGraphicsSceneMouseEvent): void =
  fQGraphicsProxyWidget_virtualbase_mouseDoubleClickEvent(self.h, event.h)

type QGraphicsProxyWidgetmouseDoubleClickEventProc* = proc(event: QGraphicsSceneMouseEvent): void
...
proc miqt_exec_callback_QGraphicsProxyWidget_mouseDoubleClickEvent(self: ptr cQGraphicsProxyWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsProxyWidget_mouseDoubleClickEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsProxyWidgetwheelEvent*(self: gen_qgraphicsproxywidget_types.QGraphicsProxyWidget, event: QGraphicsSceneWheelEvent): void =
  fQGraphicsProxyWidget_virtualbase_wheelEvent(self.h, event.h)

type QGraphicsProxyWidgetwheelEventProc* = proc(event: QGraphicsSceneWheelEvent): void
...
proc miqt_exec_callback_QGraphicsProxyWidget_wheelEvent(self: ptr cQGraphicsProxyWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsProxyWidget_wheelEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsProxyWidgetkeyPressEvent*(self: gen_qgraphicsproxywidget_types.QGraphicsProxyWidget, event: QKeyEvent): void =
  fQGraphicsProxyWidget_virtualbase_keyPressEvent(self.h, event.h)

type QGraphicsProxyWidgetkeyPressEventProc* = proc(event: QKeyEvent): void
...
proc miqt_exec_callback_QGraphicsProxyWidget_keyPressEvent(self: ptr cQGraphicsProxyWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsProxyWidget_keyPressEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsProxyWidgetkeyReleaseEvent*(self: gen_qgraphicsproxywidget_types.QGraphicsProxyWidget, event: QKeyEvent): void =
  fQGraphicsProxyWidget_virtualbase_keyReleaseEvent(self.h, event.h)

type QGraphicsProxyWidgetkeyReleaseEventProc* = proc(event: QKeyEvent): void
...
proc miqt_exec_callback_QGraphicsProxyWidget_keyReleaseEvent(self: ptr cQGraphicsProxyWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsProxyWidget_keyReleaseEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsProxyWidgetfocusInEvent*(self: gen_qgraphicsproxywidget_types.QGraphicsProxyWidget, event: QFocusEvent): void =
  fQGraphicsProxyWidget_virtualbase_focusInEvent(self.h, event.h)

type QGraphicsProxyWidgetfocusInEventProc* = proc(event: QFocusEvent): void
...
proc miqt_exec_callback_QGraphicsProxyWidget_focusInEvent(self: ptr cQGraphicsProxyWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsProxyWidget_focusInEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsProxyWidgetfocusOutEvent*(self: gen_qgraphicsproxywidget_types.QGraphicsProxyWidget, event: QFocusEvent): void =
  fQGraphicsProxyWidget_virtualbase_focusOutEvent(self.h, event.h)

type QGraphicsProxyWidgetfocusOutEventProc* = proc(event: QFocusEvent): void
...
proc miqt_exec_callback_QGraphicsProxyWidget_focusNextPrevChild(self: ptr cQGraphicsProxyWidget, slot: int, next: bool): bool {.exportc: "miqt_exec_callback_QGraphicsProxyWidget_focusNextPrevChild ".} =
  ...
  virtualReturn
proc QGraphicsProxyWidgetinputMethodQuery*(self: gen_qgraphicsproxywidget_types.QGraphicsProxyWidget, query: cint): QVariant =
  QVariant(h: fQGraphicsProxyWidget_virtualbase_inputMethodQuery(self.h, cint(query)))

type QGraphicsProxyWidgetinputMethodQueryProc* = proc(query: cint): QVariant
...
proc miqt_exec_callback_QGraphicsProxyWidget_inputMethodQuery(self: ptr cQGraphicsProxyWidget, slot: int, query: cint): pointer {.exportc: "miqt_exec_callback_QGraphicsProxyWidget_inputMethodQuery ".} =
  ...
  virtualReturn.h
proc QGraphicsProxyWidgetinputMethodEvent*(self: gen_qgraphicsproxywidget_types.QGraphicsProxyWidget, event: QInputMethodEvent): void =
  fQGraphicsProxyWidget_virtualbase_inputMethodEvent(self.h, event.h)

type QGraphicsProxyWidgetinputMethodEventProc* = proc(event: QInputMethodEvent): void
...
proc miqt_exec_callback_QGraphicsProxyWidget_inputMethodEvent(self: ptr cQGraphicsProxyWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsProxyWidget_inputMethodEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsProxyWidgetsizeHint*(self: gen_qgraphicsproxywidget_types.QGraphicsProxyWidget, which: cint, constraint: QSizeF): QSizeF =
  QSizeF(h: fQGraphicsProxyWidget_virtualbase_sizeHint(self.h, cint(which), constraint.h))

type QGraphicsProxyWidgetsizeHintProc* = proc(which: cint, constraint: QSizeF): QSizeF
...
proc miqt_exec_callback_QGraphicsProxyWidget_sizeHint(self: ptr cQGraphicsProxyWidget, slot: int, which: cint, constraint: pointer): pointer {.exportc: "miqt_exec_callback_QGraphicsProxyWidget_sizeHint ".} =
  ...
  virtualReturn.h
proc QGraphicsProxyWidgetresizeEvent*(self: gen_qgraphicsproxywidget_types.QGraphicsProxyWidget, event: QGraphicsSceneResizeEvent): void =
  fQGraphicsProxyWidget_virtualbase_resizeEvent(self.h, event.h)

type QGraphicsProxyWidgetresizeEventProc* = proc(event: QGraphicsSceneResizeEvent): void
...
proc QGraphicsProxyWidgetpaintWindowFrame*(self: gen_qgraphicsproxywidget_types.QGraphicsProxyWidget, painter: QPainter, option: QStyleOptionGraphicsItem, widget: QWidget): void =
  fQGraphicsProxyWidget_virtualbase_paintWindowFrame(self.h, painter.h, option.h, widget.h)

type QGraphicsProxyWidgetpaintWindowFrameProc* = proc(painter: QPainter, option: QStyleOptionGraphicsItem, widget: QWidget): void
...
proc miqt_exec_callback_QGraphicsProxyWidget_paintWindowFrame(self: ptr cQGraphicsProxyWidget, slot: int, painter: pointer, option: pointer, widget: pointer): void {.exportc: "miqt_exec_callback_QGraphicsProxyWidget_paintWindowFrame ".} =
  ...
  nimfunc[](slotval1, slotval2, slotval3)
proc QGraphicsProxyWidgetboundingRect*(self: gen_qgraphicsproxywidget_types.QGraphicsProxyWidget, ): QRectF =
  QRectF(h: fQGraphicsProxyWidget_virtualbase_boundingRect(self.h))

type QGraphicsProxyWidgetboundingRectProc* = proc(): QRectF
...
proc miqt_exec_callback_QGraphicsProxyWidget_boundingRect(self: ptr cQGraphicsProxyWidget, slot: int): pointer {.exportc: "miqt_exec_callback_QGraphicsProxyWidget_boundingRect ".} =
  ...
  virtualReturn.h
proc QGraphicsProxyWidgetshape*(self: gen_qgraphicsproxywidget_types.QGraphicsProxyWidget, ): QPainterPath =
  QPainterPath(h: fQGraphicsProxyWidget_virtualbase_shape(self.h))

type QGraphicsProxyWidgetshapeProc* = proc(): QPainterPath
...
proc miqt_exec_callback_QGraphicsProxyWidget_shape(self: ptr cQGraphicsProxyWidget, slot: int): pointer {.exportc: "miqt_exec_callback_QGraphicsProxyWidget_shape ".} =
  ...
  virtualReturn.h
proc QGraphicsProxyWidgetinitStyleOption*(self: gen_qgraphicsproxywidget_types.QGraphicsProxyWidget, option: QStyleOption): void =
  fQGraphicsProxyWidget_virtualbase_initStyleOption(self.h, option.h)

type QGraphicsProxyWidgetinitStyleOptionProc* = proc(option: QStyleOption): void
...
proc miqt_exec_callback_QGraphicsProxyWidget_updateGeometry(self: ptr cQGraphicsProxyWidget, slot: int): void {.exportc: "miqt_exec_callback_QGraphicsProxyWidget_updateGeometry ".} =
  ...
  nimfunc[]()
proc QGraphicsProxyWidgetpropertyChange*(self: gen_qgraphicsproxywidget_types.QGraphicsProxyWidget, propertyName: string, value: QVariant): QVariant =
  QVariant(h: fQGraphicsProxyWidget_virtualbase_propertyChange(self.h, struct_miqt_string(data: propertyName, len: csize_t(len(propertyName))), value.h))

type QGraphicsProxyWidgetpropertyChangeProc* = proc(propertyName: string, value: QVariant): QVariant
...
proc miqt_exec_callback_QGraphicsProxyWidget_propertyChange(self: ptr cQGraphicsProxyWidget, slot: int, propertyName: struct_miqt_string, value: pointer): pointer {.exportc: "miqt_exec_callback_QGraphicsProxyWidget_propertyChange ".} =
  ...
  virtualReturn.h
proc QGraphicsProxyWidgetsceneEvent*(self: gen_qgraphicsproxywidget_types.QGraphicsProxyWidget, event: QEvent): bool =
  fQGraphicsProxyWidget_virtualbase_sceneEvent(self.h, event.h)

type QGraphicsProxyWidgetsceneEventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QGraphicsProxyWidget_sceneEvent(self: ptr cQGraphicsProxyWidget, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QGraphicsProxyWidget_sceneEvent ".} =
  ...
  virtualReturn
proc QGraphicsProxyWidgetwindowFrameEvent*(self: gen_qgraphicsproxywidget_types.QGraphicsProxyWidget, e: QEvent): bool =
  fQGraphicsProxyWidget_virtualbase_windowFrameEvent(self.h, e.h)

type QGraphicsProxyWidgetwindowFrameEventProc* = proc(e: QEvent): bool
...
proc miqt_exec_callback_QGraphicsProxyWidget_windowFrameEvent(self: ptr cQGraphicsProxyWidget, slot: int, e: pointer): bool {.exportc: "miqt_exec_callback_QGraphicsProxyWidget_windowFrameEvent ".} =
  ...
  virtualReturn
proc QGraphicsProxyWidgetwindowFrameSectionAt*(self: gen_qgraphicsproxywidget_types.QGraphicsProxyWidget, pos: QPointF): cint =
  cint(fQGraphicsProxyWidget_virtualbase_windowFrameSectionAt(self.h, pos.h))

type QGraphicsProxyWidgetwindowFrameSectionAtProc* = proc(pos: QPointF): cint
...
proc miqt_exec_callback_QGraphicsProxyWidget_windowFrameSectionAt(self: ptr cQGraphicsProxyWidget, slot: int, pos: pointer): cint {.exportc: "miqt_exec_callback_QGraphicsProxyWidget_windowFrameSectionAt ".} =
  ...
  cint(virtualReturn)
proc QGraphicsProxyWidgetchangeEvent*(self: gen_qgraphicsproxywidget_types.QGraphicsProxyWidget, event: QEvent): void =
  fQGraphicsProxyWidget_virtualbase_changeEvent(self.h, event.h)

type QGraphicsProxyWidgetchangeEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QGraphicsProxyWidget_changeEvent(self: ptr cQGraphicsProxyWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsProxyWidget_changeEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsProxyWidgetcloseEvent*(self: gen_qgraphicsproxywidget_types.QGraphicsProxyWidget, event: QCloseEvent): void =
  fQGraphicsProxyWidget_virtualbase_closeEvent(self.h, event.h)

type QGraphicsProxyWidgetcloseEventProc* = proc(event: QCloseEvent): void
...
proc miqt_exec_callback_QGraphicsProxyWidget_closeEvent(self: ptr cQGraphicsProxyWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsProxyWidget_closeEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsProxyWidgetmoveEvent*(self: gen_qgraphicsproxywidget_types.QGraphicsProxyWidget, event: QGraphicsSceneMoveEvent): void =
  fQGraphicsProxyWidget_virtualbase_moveEvent(self.h, event.h)

type QGraphicsProxyWidgetmoveEventProc* = proc(event: QGraphicsSceneMoveEvent): void
...
proc miqt_exec_callback_QGraphicsProxyWidget_polishEvent(self: ptr cQGraphicsProxyWidget, slot: int): void {.exportc: "miqt_exec_callback_QGraphicsProxyWidget_polishEvent ".} =
  ...
  nimfunc[]()
proc QGraphicsProxyWidgetgrabKeyboardEvent*(self: gen_qgraphicsproxywidget_types.QGraphicsProxyWidget, event: QEvent): void =
  fQGraphicsProxyWidget_virtualbase_grabKeyboardEvent(self.h, event.h)

type QGraphicsProxyWidgetgrabKeyboardEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QGraphicsProxyWidget_grabKeyboardEvent(self: ptr cQGraphicsProxyWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsProxyWidget_grabKeyboardEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsProxyWidgetungrabKeyboardEvent*(self: gen_qgraphicsproxywidget_types.QGraphicsProxyWidget, event: QEvent): void =
  fQGraphicsProxyWidget_virtualbase_ungrabKeyboardEvent(self.h, event.h)

type QGraphicsProxyWidgetungrabKeyboardEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QGraphicsProxyWidget_ungrabKeyboardEvent(self: ptr cQGraphicsProxyWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsProxyWidget_ungrabKeyboardEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsProxyWidgettimerEvent*(self: gen_qgraphicsproxywidget_types.QGraphicsProxyWidget, event: QTimerEvent): void =
  fQGraphicsProxyWidget_virtualbase_timerEvent(self.h, event.h)

type QGraphicsProxyWidgettimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QGraphicsProxyWidget_timerEvent(self: ptr cQGraphicsProxyWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsProxyWidget_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsProxyWidgetchildEvent*(self: gen_qgraphicsproxywidget_types.QGraphicsProxyWidget, event: QChildEvent): void =
  fQGraphicsProxyWidget_virtualbase_childEvent(self.h, event.h)

type QGraphicsProxyWidgetchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QGraphicsProxyWidget_childEvent(self: ptr cQGraphicsProxyWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsProxyWidget_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsProxyWidgetcustomEvent*(self: gen_qgraphicsproxywidget_types.QGraphicsProxyWidget, event: QEvent): void =
  fQGraphicsProxyWidget_virtualbase_customEvent(self.h, event.h)

type QGraphicsProxyWidgetcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QGraphicsProxyWidget_customEvent(self: ptr cQGraphicsProxyWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsProxyWidget_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsProxyWidgetconnectNotify*(self: gen_qgraphicsproxywidget_types.QGraphicsProxyWidget, signal: QMetaMethod): void =
  fQGraphicsProxyWidget_virtualbase_connectNotify(self.h, signal.h)

type QGraphicsProxyWidgetconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QGraphicsProxyWidget_connectNotify(self: ptr cQGraphicsProxyWidget, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QGraphicsProxyWidget_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsProxyWidgetdisconnectNotify*(self: gen_qgraphicsproxywidget_types.QGraphicsProxyWidget, signal: QMetaMethod): void =
  fQGraphicsProxyWidget_virtualbase_disconnectNotify(self.h, signal.h)

type QGraphicsProxyWidgetdisconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QGraphicsProxyWidget_advance(self: ptr cQGraphicsProxyWidget, slot: int, phase: cint): void {.exportc: "miqt_exec_callback_QGraphicsProxyWidget_advance ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsProxyWidgetcontains*(self: gen_qgraphicsproxywidget_types.QGraphicsProxyWidget, point: QPointF): bool =
  fQGraphicsProxyWidget_virtualbase_contains(self.h, point.h)

type QGraphicsProxyWidgetcontainsProc* = proc(point: QPointF): bool
...
proc miqt_exec_callback_QGraphicsProxyWidget_contains(self: ptr cQGraphicsProxyWidget, slot: int, point: pointer): bool {.exportc: "miqt_exec_callback_QGraphicsProxyWidget_contains ".} =
  ...
  virtualReturn
proc QGraphicsProxyWidgetcollidesWithItem*(self: gen_qgraphicsproxywidget_types.QGraphicsProxyWidget, other: QGraphicsItem, mode: cint): bool =
  fQGraphicsProxyWidget_virtualbase_collidesWithItem(self.h, other.h, cint(mode))

type QGraphicsProxyWidgetcollidesWithItemProc* = proc(other: QGraphicsItem, mode: cint): bool
...
proc miqt_exec_callback_QGraphicsProxyWidget_collidesWithItem(self: ptr cQGraphicsProxyWidget, slot: int, other: pointer, mode: cint): bool {.exportc: "miqt_exec_callback_QGraphicsProxyWidget_collidesWithItem ".} =
  ...
  virtualReturn
proc QGraphicsProxyWidgetcollidesWithPath*(self: gen_qgraphicsproxywidget_types.QGraphicsProxyWidget, path: QPainterPath, mode: cint): bool =
  fQGraphicsProxyWidget_virtualbase_collidesWithPath(self.h, path.h, cint(mode))

type QGraphicsProxyWidgetcollidesWithPathProc* = proc(path: QPainterPath, mode: cint): bool
...
proc miqt_exec_callback_QGraphicsProxyWidget_collidesWithPath(self: ptr cQGraphicsProxyWidget, slot: int, path: pointer, mode: cint): bool {.exportc: "miqt_exec_callback_QGraphicsProxyWidget_collidesWithPath ".} =
  ...
  virtualReturn
proc QGraphicsProxyWidgetisObscuredBy*(self: gen_qgraphicsproxywidget_types.QGraphicsProxyWidget, item: QGraphicsItem): bool =
  fQGraphicsProxyWidget_virtualbase_isObscuredBy(self.h, item.h)

type QGraphicsProxyWidgetisObscuredByProc* = proc(item: QGraphicsItem): bool
...
proc miqt_exec_callback_QGraphicsProxyWidget_isObscuredBy(self: ptr cQGraphicsProxyWidget, slot: int, item: pointer): bool {.exportc: "miqt_exec_callback_QGraphicsProxyWidget_isObscuredBy ".} =
  ...
  virtualReturn
proc QGraphicsProxyWidgetopaqueArea*(self: gen_qgraphicsproxywidget_types.QGraphicsProxyWidget, ): QPainterPath =
  QPainterPath(h: fQGraphicsProxyWidget_virtualbase_opaqueArea(self.h))

type QGraphicsProxyWidgetopaqueAreaProc* = proc(): QPainterPath
...
proc miqt_exec_callback_QGraphicsProxyWidget_opaqueArea(self: ptr cQGraphicsProxyWidget, slot: int): pointer {.exportc: "miqt_exec_callback_QGraphicsProxyWidget_opaqueArea ".} =
  ...
  virtualReturn.h
proc QGraphicsProxyWidgetsceneEventFilter*(self: gen_qgraphicsproxywidget_types.QGraphicsProxyWidget, watched: QGraphicsItem, event: QEvent): bool =
  fQGraphicsProxyWidget_virtualbase_sceneEventFilter(self.h, watched.h, event.h)

type QGraphicsProxyWidgetsceneEventFilterProc* = proc(watched: QGraphicsItem, event: QEvent): bool
...
proc miqt_exec_callback_QGraphicsProxyWidget_supportsExtension(self: ptr cQGraphicsProxyWidget, slot: int, extension: cint): bool {.exportc: "miqt_exec_callback_QGraphicsProxyWidget_supportsExtension ".} =
  ...
  virtualReturn
proc QGraphicsProxyWidgetsetExtension*(self: gen_qgraphicsproxywidget_types.QGraphicsProxyWidget, extension: cint, variant: QVariant): void =
  fQGraphicsProxyWidget_virtualbase_setExtension(self.h, cint(extension), variant.h)

type QGraphicsProxyWidgetsetExtensionProc* = proc(extension: cint, variant: QVariant): void
...
proc QGraphicsProxyWidgetextension*(self: gen_qgraphicsproxywidget_types.QGraphicsProxyWidget, variant: QVariant): QVariant =
  QVariant(h: fQGraphicsProxyWidget_virtualbase_extension(self.h, variant.h))

type QGraphicsProxyWidgetextensionProc* = proc(variant: QVariant): QVariant
