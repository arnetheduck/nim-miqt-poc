...
proc create*(T: type gen_qtablewidget_types.QTableWidgetSelectionRange, other: QTableWidgetSelectionRange): gen_qtablewidget_types.QTableWidgetSelectionRange =
  gen_qtablewidget_types.QTableWidgetSelectionRange.init(fcQTableWidgetSelectionRange_new3(other.h))

proc operatorAssign*(self: gen_qtablewidget_types.QTableWidgetSelectionRange, other: QTableWidgetSelectionRange): void =
...
proc backgroundColor*(self: gen_qtablewidget_types.QTableWidgetItem, ): QColor =
  QColor(h: fcQTableWidgetItem_backgroundColor(self.h))

proc setBackgroundColor*(self: gen_qtablewidget_types.QTableWidgetItem, color: QColor): void =
...
proc textColor*(self: gen_qtablewidget_types.QTableWidgetItem, ): QColor =
  QColor(h: fcQTableWidgetItem_textColor(self.h))

proc setTextColor*(self: gen_qtablewidget_types.QTableWidgetItem, color: QColor): void =
...
proc isItemSelected*(self: gen_qtablewidget_types.QTableWidget, item: QTableWidgetItem): bool =
  fcQTableWidget_isItemSelected(self.h, item.h)

proc setItemSelected*(self: gen_qtablewidget_types.QTableWidget, item: QTableWidgetItem, select: bool): void =
...
proc miqt_exec_callback_QTableWidget_scrollContentsBy(self: ptr cQTableWidget, slot: int, dx: cint, dy: cint): void {.exportc: "miqt_exec_callback_QTableWidget_scrollContentsBy ".} =
  ...
  nimfunc[](slotval1, slotval2)
proc QTableWidgetviewOptions*(self: gen_qtablewidget_types.QTableWidget, ): QStyleOptionViewItem =
  QStyleOptionViewItem(h: fQTableWidget_virtualbase_viewOptions(self.h))

type QTableWidgetviewOptionsProc* = proc(): QStyleOptionViewItem
...
proc miqt_exec_callback_QTableWidget_keyReleaseEvent(self: ptr cQTableWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTableWidget_keyReleaseEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTableWidgetenterEvent*(self: gen_qtablewidget_types.QTableWidget, event: QEvent): void =
  fQTableWidget_virtualbase_enterEvent(self.h, event.h)

type QTableWidgetenterEventProc* = proc(event: QEvent): void
