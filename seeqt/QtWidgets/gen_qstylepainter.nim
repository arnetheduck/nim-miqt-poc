...
func init*(T: type gen_qstylepainter_types.QStylePainter, h: ptr cQStylePainter): gen_qstylepainter_types.QStylePainter =
  T(h: h)
proc create*(T: type gen_qstylepainter_types.QStylePainter, w: QWidget): gen_qstylepainter_types.QStylePainter =
...
proc create*(T: type gen_qstylepainter_types.QStylePainter, pd: QPaintDevice, w: QWidget): gen_qstylepainter_types.QStylePainter =
  gen_qstylepainter_types.QStylePainter.init(fcQStylePainter_new3(pd.h, w.h))

proc begin*(self: gen_qstylepainter_types.QStylePainter, w: QWidget): bool =
  fcQStylePainter_begin(self.h, w.h)

proc begin*(self: gen_qstylepainter_types.QStylePainter, pd: QPaintDevice, w: QWidget): bool =
  fcQStylePainter_begin2(self.h, pd.h, w.h)

proc drawPrimitive*(self: gen_qstylepainter_types.QStylePainter, pe: cint, opt: QStyleOption): void =
  fcQStylePainter_drawPrimitive(self.h, cint(pe), opt.h)

proc drawControl*(self: gen_qstylepainter_types.QStylePainter, ce: cint, opt: QStyleOption): void =
  fcQStylePainter_drawControl(self.h, cint(ce), opt.h)

proc drawComplexControl*(self: gen_qstylepainter_types.QStylePainter, cc: cint, opt: QStyleOptionComplex): void =
  fcQStylePainter_drawComplexControl(self.h, cint(cc), opt.h)

proc drawItemText*(self: gen_qstylepainter_types.QStylePainter, r: QRect, flags: cint, pal: QPalette, enabled: bool, text: string): void =
  fcQStylePainter_drawItemText(self.h, r.h, flags, pal.h, enabled, struct_miqt_string(data: text, len: csize_t(len(text))))

proc drawItemPixmap*(self: gen_qstylepainter_types.QStylePainter, r: QRect, flags: cint, pixmap: QPixmap): void =
  fcQStylePainter_drawItemPixmap(self.h, r.h, flags, pixmap.h)

proc style*(self: gen_qstylepainter_types.QStylePainter, ): QStyle =
  QStyle(h: fcQStylePainter_style(self.h))

proc drawItemText*(self: gen_qstylepainter_types.QStylePainter, r: QRect, flags: cint, pal: QPalette, enabled: bool, text: string, textRole: cint): void =
