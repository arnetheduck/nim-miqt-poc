...
void QWizard_connect_currentIdChanged(QWizard* self, intptr_t slot, void (*callback)(intptr_t, int), void (*release)(intptr_t)) {
	...
	MiqtVirtualQWizard::connect(self, static_cast<void (QWizard::*)(int)>(&QWizard::currentIdChanged), self, caller{slot, callback, release});
}
...
void QWizard_connect_helpRequested(QWizard* self, intptr_t slot, void (*callback)(intptr_t), void (*release)(intptr_t)) {
	...
	MiqtVirtualQWizard::connect(self, static_cast<void (QWizard::*)()>(&QWizard::helpRequested), self, caller{slot, callback, release});
}
...
void QWizard_connect_customButtonClicked(QWizard* self, intptr_t slot, void (*callback)(intptr_t, int), void (*release)(intptr_t)) {
	...
	MiqtVirtualQWizard::connect(self, static_cast<void (QWizard::*)(int)>(&QWizard::customButtonClicked), self, caller{slot, callback, release});
}
...
void QWizard_connect_pageAdded(QWizard* self, intptr_t slot, void (*callback)(intptr_t, int), void (*release)(intptr_t)) {
	...
	MiqtVirtualQWizard::connect(self, static_cast<void (QWizard::*)(int)>(&QWizard::pageAdded), self, caller{slot, callback, release});
}
...
void QWizard_connect_pageRemoved(QWizard* self, intptr_t slot, void (*callback)(intptr_t, int), void (*release)(intptr_t)) {
	...
	MiqtVirtualQWizard::connect(self, static_cast<void (QWizard::*)(int)>(&QWizard::pageRemoved), self, caller{slot, callback, release});
}
...
QMetaObject* QWizard_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQWizard*)(self) )->QWizard::metaObject();

}

void* QWizard_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQWizard*)(self) )->QWizard::qt_metacast(param1);

}

int QWizard_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQWizard*)(self) )->QWizard::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
bool QWizard_virtualbase_nativeEvent(void* self, struct miqt_string eventType, void* message, intptr_t* result) {
	...
	return ( (MiqtVirtualQWizard*)(self) )->QWizard::nativeEvent(eventType_QByteArray, message, (qintptr*)(result));
...
void QWizard_protectedbase_adjustPosition(void* self, QWidget* param1) {
	MiqtVirtualQWizard* self_cast = static_cast<MiqtVirtualQWizard*>( (QWizard*)(self) );
...
void QWizardPage_connect_completeChanged(QWizardPage* self, intptr_t slot, void (*callback)(intptr_t), void (*release)(intptr_t)) {
	...
	MiqtVirtualQWizardPage::connect(self, static_cast<void (QWizardPage::*)()>(&QWizardPage::completeChanged), self, caller{slot, callback, release});
}
...
QMetaObject* QWizardPage_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQWizardPage*)(self) )->QWizardPage::metaObject();

}

void* QWizardPage_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQWizardPage*)(self) )->QWizardPage::qt_metacast(param1);

}

int QWizardPage_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQWizardPage*)(self) )->QWizardPage::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
bool QWizardPage_virtualbase_nativeEvent(void* self, struct miqt_string eventType, void* message, intptr_t* result) {
	...
	return ( (MiqtVirtualQWizardPage*)(self) )->QWizardPage::nativeEvent(eventType_QByteArray, message, (qintptr*)(result));
...
void QWizardPage_protectedbase_setField(void* self, struct miqt_string name, QVariant* value) {
	MiqtVirtualQWizardPage* self_cast = static_cast<MiqtVirtualQWizardPage*>( (QWizardPage*)(self) );
			QString name_QString = QString::fromUtf8(name.data, name.len);
