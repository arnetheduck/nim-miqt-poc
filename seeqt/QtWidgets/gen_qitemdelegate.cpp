...
QMetaObject* QItemDelegate_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQItemDelegate*)(self) )->QItemDelegate::metaObject();

}

void* QItemDelegate_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQItemDelegate*)(self) )->QItemDelegate::qt_metacast(param1);

}

int QItemDelegate_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQItemDelegate*)(self) )->QItemDelegate::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
struct miqt_array /* of int */  QItemDelegate_virtualbase_paintingRoles(const void* self) {
	...
	QVector<int> _ret = ( (const MiqtVirtualQItemDelegate*)(self) )->QItemDelegate::paintingRoles();
