...
void miqt_exec_callback_QWidget_windowTitleChanged_release(intptr_t);
void miqt_exec_callback_QWidget_windowIconChanged(intptr_t, QIcon*);
void miqt_exec_callback_QWidget_windowIconChanged_release(intptr_t);
void miqt_exec_callback_QWidget_windowIconTextChanged(intptr_t, struct miqt_string);
void miqt_exec_callback_QWidget_windowIconTextChanged_release(intptr_t);
void miqt_exec_callback_QWidget_customContextMenuRequested(intptr_t, QPoint*);
void miqt_exec_callback_QWidget_customContextMenuRequested_release(intptr_t);
#ifdef __cplusplus
} /* extern C */
#endif
...
public:
	...
	MiqtVirtualQWidget(struct QWidget_VTable* vtbl, QWidget* parent): QWidget(parent), vtbl(vtbl) {};
	MiqtVirtualQWidget(struct QWidget_VTable* vtbl): QWidget(), vtbl(vtbl) {};
	MiqtVirtualQWidget(struct QWidget_VTable* vtbl, QWidget* parent, Qt::WindowFlags f): QWidget(parent, f), vtbl(vtbl) {};

	virtual ~MiqtVirtualQWidget() override { if(vtbl->destructor) vtbl->destructor(vtbl, this); }
...
QWidget* QWidget_new(struct QWidget_VTable* vtbl, QWidget* parent) {
	return new MiqtVirtualQWidget(vtbl, parent);
}

QWidget* QWidget_new2(struct QWidget_VTable* vtbl) {
	return new MiqtVirtualQWidget(vtbl);
}

QWidget* QWidget_new3(struct QWidget_VTable* vtbl, QWidget* parent, int f) {
	return new MiqtVirtualQWidget(vtbl, parent, static_cast<Qt::WindowFlags>(f));
}
...
void QWidget_connect_windowTitleChanged(QWidget* self, intptr_t slot) {
	struct caller {
		...
		~caller() { miqt_exec_callback_QWidget_windowTitleChanged_release(slot); }
	};
	MiqtVirtualQWidget::connect(self, static_cast<void (QWidget::*)(const QString&)>(&QWidget::windowTitleChanged), self, caller{slot});
}
...
void QWidget_connect_windowIconChanged(QWidget* self, intptr_t slot) {
	struct caller {
		...
		caller(const caller &) = delete;
		caller &operator=(const caller &) = delete;
		~caller() { miqt_exec_callback_QWidget_windowIconChanged_release(slot); }
	};
	MiqtVirtualQWidget::connect(self, static_cast<void (QWidget::*)(const QIcon&)>(&QWidget::windowIconChanged), self, caller{slot});
}
...
void QWidget_connect_windowIconTextChanged(QWidget* self, intptr_t slot) {
	struct caller {
		...
		caller(const caller &) = delete;
		caller &operator=(const caller &) = delete;
		~caller() { miqt_exec_callback_QWidget_windowIconTextChanged_release(slot); }
	};
	MiqtVirtualQWidget::connect(self, static_cast<void (QWidget::*)(const QString&)>(&QWidget::windowIconTextChanged), self, caller{slot});
}
...
void QWidget_connect_customContextMenuRequested(QWidget* self, intptr_t slot) {
	struct caller {
		...
		caller(const caller &) = delete;
		caller &operator=(const caller &) = delete;
		~caller() { miqt_exec_callback_QWidget_customContextMenuRequested_release(slot); }
	};
	MiqtVirtualQWidget::connect(self, static_cast<void (QWidget::*)(const QPoint&)>(&QWidget::customContextMenuRequested), self, caller{slot});
}
...
bool QWidget_virtualbase_nativeEvent(void* self, struct miqt_string eventType, void* message, long* result) {
	...
	return ( (MiqtVirtualQWidget*)(self) )->QWidget::nativeEvent(eventType_QByteArray, message, static_cast<long*>(result));

}

void QWidget_virtualbase_changeEvent(void* self, QEvent* param1) {

	( (MiqtVirtualQWidget*)(self) )->QWidget::changeEvent(param1);

}

int QWidget_virtualbase_metric(const void* self, int param1) {

	return ( (const MiqtVirtualQWidget*)(self) )->QWidget::metric(static_cast<MiqtVirtualQWidget::PaintDeviceMetric>(param1));

}

void QWidget_virtualbase_initPainter(const void* self, QPainter* painter) {

	( (const MiqtVirtualQWidget*)(self) )->QWidget::initPainter(painter);

}

QPaintDevice* QWidget_virtualbase_redirected(const void* self, QPoint* offset) {

	return ( (const MiqtVirtualQWidget*)(self) )->QWidget::redirected(offset);

}

QPainter* QWidget_virtualbase_sharedPainter(const void* self) {

	return ( (const MiqtVirtualQWidget*)(self) )->QWidget::sharedPainter();

}

void QWidget_virtualbase_inputMethodEvent(void* self, QInputMethodEvent* param1) {

	( (MiqtVirtualQWidget*)(self) )->QWidget::inputMethodEvent(param1);

}

QVariant* QWidget_virtualbase_inputMethodQuery(const void* self, int param1) {

	return new QVariant(( (const MiqtVirtualQWidget*)(self) )->QWidget::inputMethodQuery(static_cast<Qt::InputMethodQuery>(param1)));

}

bool QWidget_virtualbase_focusNextPrevChild(void* self, bool next) {

	return ( (MiqtVirtualQWidget*)(self) )->QWidget::focusNextPrevChild(next);

}

bool QWidget_virtualbase_eventFilter(void* self, QObject* watched, QEvent* event) {

	return ( (MiqtVirtualQWidget*)(self) )->QWidget::eventFilter(watched, event);

}

void QWidget_virtualbase_timerEvent(void* self, QTimerEvent* event) {

	( (MiqtVirtualQWidget*)(self) )->QWidget::timerEvent(event);

}

void QWidget_virtualbase_childEvent(void* self, QChildEvent* event) {

	( (MiqtVirtualQWidget*)(self) )->QWidget::childEvent(event);

}

void QWidget_virtualbase_customEvent(void* self, QEvent* event) {

	( (MiqtVirtualQWidget*)(self) )->QWidget::customEvent(event);

}

void QWidget_virtualbase_connectNotify(void* self, QMetaMethod* signal) {

	( (MiqtVirtualQWidget*)(self) )->QWidget::connectNotify(*signal);

}

void QWidget_virtualbase_disconnectNotify(void* self, QMetaMethod* signal) {

	( (MiqtVirtualQWidget*)(self) )->QWidget::disconnectNotify(*signal);
...
void QWidget_protectedbase_updateMicroFocus(void* self) {
	MiqtVirtualQWidget* self_cast = static_cast<MiqtVirtualQWidget*>( (QWidget*)(self) );
