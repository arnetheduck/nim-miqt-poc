...
void QAbstractSlider_connect_valueChanged(QAbstractSlider* self, intptr_t slot, void (*callback)(intptr_t, int), void (*release)(intptr_t)) {
	...
	MiqtVirtualQAbstractSlider::connect(self, static_cast<void (QAbstractSlider::*)(int)>(&QAbstractSlider::valueChanged), self, caller{slot, callback, release});
}
...
void QAbstractSlider_connect_sliderPressed(QAbstractSlider* self, intptr_t slot, void (*callback)(intptr_t), void (*release)(intptr_t)) {
	...
	MiqtVirtualQAbstractSlider::connect(self, static_cast<void (QAbstractSlider::*)()>(&QAbstractSlider::sliderPressed), self, caller{slot, callback, release});
}
...
void QAbstractSlider_connect_sliderMoved(QAbstractSlider* self, intptr_t slot, void (*callback)(intptr_t, int), void (*release)(intptr_t)) {
	...
	MiqtVirtualQAbstractSlider::connect(self, static_cast<void (QAbstractSlider::*)(int)>(&QAbstractSlider::sliderMoved), self, caller{slot, callback, release});
}
...
void QAbstractSlider_connect_sliderReleased(QAbstractSlider* self, intptr_t slot, void (*callback)(intptr_t), void (*release)(intptr_t)) {
	...
	MiqtVirtualQAbstractSlider::connect(self, static_cast<void (QAbstractSlider::*)()>(&QAbstractSlider::sliderReleased), self, caller{slot, callback, release});
}
...
void QAbstractSlider_connect_rangeChanged(QAbstractSlider* self, intptr_t slot, void (*callback)(intptr_t, int, int), void (*release)(intptr_t)) {
	...
	MiqtVirtualQAbstractSlider::connect(self, static_cast<void (QAbstractSlider::*)(int, int)>(&QAbstractSlider::rangeChanged), self, caller{slot, callback, release});
}
...
void QAbstractSlider_connect_actionTriggered(QAbstractSlider* self, intptr_t slot, void (*callback)(intptr_t, int), void (*release)(intptr_t)) {
	...
	MiqtVirtualQAbstractSlider::connect(self, static_cast<void (QAbstractSlider::*)(int)>(&QAbstractSlider::actionTriggered), self, caller{slot, callback, release});
}
...
QMetaObject* QAbstractSlider_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQAbstractSlider*)(self) )->QAbstractSlider::metaObject();

}

void* QAbstractSlider_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQAbstractSlider*)(self) )->QAbstractSlider::qt_metacast(param1);

}

int QAbstractSlider_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQAbstractSlider*)(self) )->QAbstractSlider::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
bool QAbstractSlider_virtualbase_nativeEvent(void* self, struct miqt_string eventType, void* message, intptr_t* result) {
	...
	return ( (MiqtVirtualQAbstractSlider*)(self) )->QAbstractSlider::nativeEvent(eventType_QByteArray, message, (qintptr*)(result));
...
void QAbstractSlider_protectedbase_setRepeatAction(void* self, int action) {
	MiqtVirtualQAbstractSlider* self_cast = static_cast<MiqtVirtualQAbstractSlider*>( (QAbstractSlider*)(self) );
