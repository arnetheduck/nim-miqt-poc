...
proc create*(T: type gen_qgraphicsgridlayout_types.QGraphicsGridLayout, parent: QGraphicsLayoutItem): gen_qgraphicsgridlayout_types.QGraphicsGridLayout =
  gen_qgraphicsgridlayout_types.QGraphicsGridLayout.init(fcQGraphicsGridLayout_new2(parent.h))

proc addItem*(self: gen_qgraphicsgridlayout_types.QGraphicsGridLayout, item: QGraphicsLayoutItem, row: cint, column: cint, rowSpan: cint, columnSpan: cint): void =
  fcQGraphicsGridLayout_addItem(self.h, item.h, row, column, rowSpan, columnSpan)

proc addItem*(self: gen_qgraphicsgridlayout_types.QGraphicsGridLayout, item: QGraphicsLayoutItem, row: cint, column: cint): void =
...
proc setAlignment*(self: gen_qgraphicsgridlayout_types.QGraphicsGridLayout, item: QGraphicsLayoutItem, alignment: cint): void =
  fcQGraphicsGridLayout_setAlignment(self.h, item.h, cint(alignment))

proc alignment*(self: gen_qgraphicsgridlayout_types.QGraphicsGridLayout, item: QGraphicsLayoutItem): cint =
...
proc itemAt*(self: gen_qgraphicsgridlayout_types.QGraphicsGridLayout, row: cint, column: cint): QGraphicsLayoutItem =
  QGraphicsLayoutItem(h: fcQGraphicsGridLayout_itemAt(self.h, row, column))

proc count*(self: gen_qgraphicsgridlayout_types.QGraphicsGridLayout, ): cint =
  fcQGraphicsGridLayout_count(self.h)

proc itemAt*(self: gen_qgraphicsgridlayout_types.QGraphicsGridLayout, index: cint): QGraphicsLayoutItem =
  QGraphicsLayoutItem(h: fcQGraphicsGridLayout_itemAtWithIndex(self.h, index))
...
proc removeItem*(self: gen_qgraphicsgridlayout_types.QGraphicsGridLayout, item: QGraphicsLayoutItem): void =
...
proc setGeometry*(self: gen_qgraphicsgridlayout_types.QGraphicsGridLayout, rect: QRectF): void =
  fcQGraphicsGridLayout_setGeometry(self.h, rect.h)

proc sizeHint*(self: gen_qgraphicsgridlayout_types.QGraphicsGridLayout, which: cint, constraint: QSizeF): QSizeF =
  QSizeF(h: fcQGraphicsGridLayout_sizeHint(self.h, cint(which), constraint.h))

proc addItem*(self: gen_qgraphicsgridlayout_types.QGraphicsGridLayout, item: QGraphicsLayoutItem, row: cint, column: cint, rowSpan: cint, columnSpan: cint, alignment: cint): void =
  fcQGraphicsGridLayout_addItem6(self.h, item.h, row, column, rowSpan, columnSpan, cint(alignment))

proc addItem*(self: gen_qgraphicsgridlayout_types.QGraphicsGridLayout, item: QGraphicsLayoutItem, row: cint, column: cint, alignment: cint): void =
...
proc miqt_exec_callback_QGraphicsGridLayout_count(self: ptr cQGraphicsGridLayout, slot: int): cint {.exportc: "miqt_exec_callback_QGraphicsGridLayout_count ".} =
  ...
  virtualReturn
proc QGraphicsGridLayoutitemAt*(self: gen_qgraphicsgridlayout_types.QGraphicsGridLayout, index: cint): QGraphicsLayoutItem =
  QGraphicsLayoutItem(h: fQGraphicsGridLayout_virtualbase_itemAtWithIndex(self.h, index))

type QGraphicsGridLayoutitemAtWithIndexProc* = proc(index: cint): QGraphicsLayoutItem
...
proc miqt_exec_callback_QGraphicsGridLayout_invalidate(self: ptr cQGraphicsGridLayout, slot: int): void {.exportc: "miqt_exec_callback_QGraphicsGridLayout_invalidate ".} =
  ...
  nimfunc[]()
proc QGraphicsGridLayoutsetGeometry*(self: gen_qgraphicsgridlayout_types.QGraphicsGridLayout, rect: QRectF): void =
  fQGraphicsGridLayout_virtualbase_setGeometry(self.h, rect.h)

type QGraphicsGridLayoutsetGeometryProc* = proc(rect: QRectF): void
...
proc miqt_exec_callback_QGraphicsGridLayout_setGeometry(self: ptr cQGraphicsGridLayout, slot: int, rect: pointer): void {.exportc: "miqt_exec_callback_QGraphicsGridLayout_setGeometry ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsGridLayoutsizeHint*(self: gen_qgraphicsgridlayout_types.QGraphicsGridLayout, which: cint, constraint: QSizeF): QSizeF =
  QSizeF(h: fQGraphicsGridLayout_virtualbase_sizeHint(self.h, cint(which), constraint.h))

type QGraphicsGridLayoutsizeHintProc* = proc(which: cint, constraint: QSizeF): QSizeF
...
proc miqt_exec_callback_QGraphicsGridLayout_updateGeometry(self: ptr cQGraphicsGridLayout, slot: int): void {.exportc: "miqt_exec_callback_QGraphicsGridLayout_updateGeometry ".} =
  ...
  nimfunc[]()
proc QGraphicsGridLayoutwidgetEvent*(self: gen_qgraphicsgridlayout_types.QGraphicsGridLayout, e: QEvent): void =
  fQGraphicsGridLayout_virtualbase_widgetEvent(self.h, e.h)

type QGraphicsGridLayoutwidgetEventProc* = proc(e: QEvent): void
