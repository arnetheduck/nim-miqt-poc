...
proc create*(T: type gen_qsystemtrayicon_types.QSystemTrayIcon, icon: QIcon): gen_qsystemtrayicon_types.QSystemTrayIcon =
  gen_qsystemtrayicon_types.QSystemTrayIcon.init(fcQSystemTrayIcon_new2(icon.h))

proc create*(T: type gen_qsystemtrayicon_types.QSystemTrayIcon, parent: QObject): gen_qsystemtrayicon_types.QSystemTrayIcon =
  gen_qsystemtrayicon_types.QSystemTrayIcon.init(fcQSystemTrayIcon_new3(parent.h))

proc create*(T: type gen_qsystemtrayicon_types.QSystemTrayIcon, icon: QIcon, parent: QObject): gen_qsystemtrayicon_types.QSystemTrayIcon =
  gen_qsystemtrayicon_types.QSystemTrayIcon.init(fcQSystemTrayIcon_new4(icon.h, parent.h))

proc metaObject*(self: gen_qsystemtrayicon_types.QSystemTrayIcon, ): QMetaObject =
  QMetaObject(h: fcQSystemTrayIcon_metaObject(self.h))
...
proc setContextMenu*(self: gen_qsystemtrayicon_types.QSystemTrayIcon, menu: QMenu): void =
  fcQSystemTrayIcon_setContextMenu(self.h, menu.h)

proc contextMenu*(self: gen_qsystemtrayicon_types.QSystemTrayIcon, ): QMenu =
  QMenu(h: fcQSystemTrayIcon_contextMenu(self.h))

proc icon*(self: gen_qsystemtrayicon_types.QSystemTrayIcon, ): QIcon =
  QIcon(h: fcQSystemTrayIcon_icon(self.h))

proc setIcon*(self: gen_qsystemtrayicon_types.QSystemTrayIcon, icon: QIcon): void =
...
proc geometry*(self: gen_qsystemtrayicon_types.QSystemTrayIcon, ): QRect =
  QRect(h: fcQSystemTrayIcon_geometry(self.h))
...
proc showMessage*(self: gen_qsystemtrayicon_types.QSystemTrayIcon, title: string, msg: string, icon: QIcon): void =
...
proc showMessage*(self: gen_qsystemtrayicon_types.QSystemTrayIcon, title: string, msg: string, icon: QIcon, msecs: cint): void =
...
proc miqt_exec_callback_QSystemTrayIcon_metacall(self: ptr cQSystemTrayIcon, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QSystemTrayIcon_metacall ".} =
  ...
  virtualReturn
proc QSystemTrayIconevent*(self: gen_qsystemtrayicon_types.QSystemTrayIcon, event: QEvent): bool =
  fQSystemTrayIcon_virtualbase_event(self.h, event.h)

type QSystemTrayIconeventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QSystemTrayIcon_event(self: ptr cQSystemTrayIcon, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QSystemTrayIcon_event ".} =
  ...
  virtualReturn
proc QSystemTrayIconeventFilter*(self: gen_qsystemtrayicon_types.QSystemTrayIcon, watched: QObject, event: QEvent): bool =
  fQSystemTrayIcon_virtualbase_eventFilter(self.h, watched.h, event.h)

type QSystemTrayIconeventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QSystemTrayIcon_eventFilter(self: ptr cQSystemTrayIcon, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QSystemTrayIcon_eventFilter ".} =
  ...
  virtualReturn
proc QSystemTrayIcontimerEvent*(self: gen_qsystemtrayicon_types.QSystemTrayIcon, event: QTimerEvent): void =
  fQSystemTrayIcon_virtualbase_timerEvent(self.h, event.h)

type QSystemTrayIcontimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QSystemTrayIcon_timerEvent(self: ptr cQSystemTrayIcon, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QSystemTrayIcon_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QSystemTrayIconchildEvent*(self: gen_qsystemtrayicon_types.QSystemTrayIcon, event: QChildEvent): void =
  fQSystemTrayIcon_virtualbase_childEvent(self.h, event.h)

type QSystemTrayIconchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QSystemTrayIcon_childEvent(self: ptr cQSystemTrayIcon, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QSystemTrayIcon_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QSystemTrayIconcustomEvent*(self: gen_qsystemtrayicon_types.QSystemTrayIcon, event: QEvent): void =
  fQSystemTrayIcon_virtualbase_customEvent(self.h, event.h)

type QSystemTrayIconcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QSystemTrayIcon_customEvent(self: ptr cQSystemTrayIcon, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QSystemTrayIcon_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QSystemTrayIconconnectNotify*(self: gen_qsystemtrayicon_types.QSystemTrayIcon, signal: QMetaMethod): void =
  fQSystemTrayIcon_virtualbase_connectNotify(self.h, signal.h)

type QSystemTrayIconconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QSystemTrayIcon_connectNotify(self: ptr cQSystemTrayIcon, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QSystemTrayIcon_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QSystemTrayIcondisconnectNotify*(self: gen_qsystemtrayicon_types.QSystemTrayIcon, signal: QMetaMethod): void =
  fQSystemTrayIcon_virtualbase_disconnectNotify(self.h, signal.h)

type QSystemTrayIcondisconnectNotifyProc* = proc(signal: QMetaMethod): void
