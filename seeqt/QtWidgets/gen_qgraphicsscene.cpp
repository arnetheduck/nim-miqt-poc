...
public:
	...
	MiqtVirtualQGraphicsScene(struct QGraphicsScene_VTable* vtbl): QGraphicsScene(), vtbl(vtbl) {};
	MiqtVirtualQGraphicsScene(struct QGraphicsScene_VTable* vtbl, const QRectF& sceneRect): QGraphicsScene(sceneRect), vtbl(vtbl) {};
	MiqtVirtualQGraphicsScene(struct QGraphicsScene_VTable* vtbl, qreal x, qreal y, qreal width, qreal height): QGraphicsScene(x, y, width, height), vtbl(vtbl) {};
	MiqtVirtualQGraphicsScene(struct QGraphicsScene_VTable* vtbl, QObject* parent): QGraphicsScene(parent), vtbl(vtbl) {};
	MiqtVirtualQGraphicsScene(struct QGraphicsScene_VTable* vtbl, const QRectF& sceneRect, QObject* parent): QGraphicsScene(sceneRect, parent), vtbl(vtbl) {};
	MiqtVirtualQGraphicsScene(struct QGraphicsScene_VTable* vtbl, qreal x, qreal y, qreal width, qreal height, QObject* parent): QGraphicsScene(x, y, width, height, parent), vtbl(vtbl) {};

	virtual ~MiqtVirtualQGraphicsScene() override { if(vtbl->destructor) vtbl->destructor(vtbl, this); }
...
QGraphicsScene* QGraphicsScene_new6(struct QGraphicsScene_VTable* vtbl, double x, double y, double width, double height, QObject* parent) {
	return new MiqtVirtualQGraphicsScene(vtbl, static_cast<qreal>(x), static_cast<qreal>(y), static_cast<qreal>(width), static_cast<qreal>(height), parent);
}
...
void QGraphicsScene_connect_changed(QGraphicsScene* self, intptr_t slot, void (*callback)(intptr_t, struct miqt_array /* of QRectF* */ ), void (*release)(intptr_t)) {
	...
	MiqtVirtualQGraphicsScene::connect(self, static_cast<void (QGraphicsScene::*)(const QList<QRectF>&)>(&QGraphicsScene::changed), self, caller{slot, callback, release});
}
...
void QGraphicsScene_connect_sceneRectChanged(QGraphicsScene* self, intptr_t slot, void (*callback)(intptr_t, QRectF*), void (*release)(intptr_t)) {
	...
	MiqtVirtualQGraphicsScene::connect(self, static_cast<void (QGraphicsScene::*)(const QRectF&)>(&QGraphicsScene::sceneRectChanged), self, caller{slot, callback, release});
}
...
void QGraphicsScene_connect_selectionChanged(QGraphicsScene* self, intptr_t slot, void (*callback)(intptr_t), void (*release)(intptr_t)) {
	...
	MiqtVirtualQGraphicsScene::connect(self, static_cast<void (QGraphicsScene::*)()>(&QGraphicsScene::selectionChanged), self, caller{slot, callback, release});
}
...
void QGraphicsScene_connect_focusItemChanged(QGraphicsScene* self, intptr_t slot, void (*callback)(intptr_t, QGraphicsItem*, QGraphicsItem*, int), void (*release)(intptr_t)) {
	...
	MiqtVirtualQGraphicsScene::connect(self, static_cast<void (QGraphicsScene::*)(QGraphicsItem*, QGraphicsItem*, Qt::FocusReason)>(&QGraphicsScene::focusItemChanged), self, caller{slot, callback, release});
}
...
QObject* QGraphicsScene_protectedbase_sender(const void* self) {
	MiqtVirtualQGraphicsScene* self_cast = static_cast<MiqtVirtualQGraphicsScene*>( (QGraphicsScene*)(self) );
