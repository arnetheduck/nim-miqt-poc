...
QMetaObject* QStylePlugin_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQStylePlugin*)(self) )->QStylePlugin::metaObject();

}

void* QStylePlugin_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQStylePlugin*)(self) )->QStylePlugin::qt_metacast(param1);

}

int QStylePlugin_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQStylePlugin*)(self) )->QStylePlugin::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
QObject* QStylePlugin_protectedbase_sender(const void* self) {
	MiqtVirtualQStylePlugin* self_cast = static_cast<MiqtVirtualQStylePlugin*>( (QStylePlugin*)(self) );
