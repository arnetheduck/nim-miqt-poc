...
func init*(T: type gen_qgridlayout_types.QGridLayout, h: ptr cQGridLayout): gen_qgridlayout_types.QGridLayout =
  T(h: h)
proc create*(T: type gen_qgridlayout_types.QGridLayout, parent: QWidget): gen_qgridlayout_types.QGridLayout =
...
proc metaObject*(self: gen_qgridlayout_types.QGridLayout, ): QMetaObject =
  QMetaObject(h: fcQGridLayout_metaObject(self.h))
...
proc sizeHint*(self: gen_qgridlayout_types.QGridLayout, ): QSize =
  QSize(h: fcQGridLayout_sizeHint(self.h))

proc minimumSize*(self: gen_qgridlayout_types.QGridLayout, ): QSize =
  QSize(h: fcQGridLayout_minimumSize(self.h))

proc maximumSize*(self: gen_qgridlayout_types.QGridLayout, ): QSize =
  QSize(h: fcQGridLayout_maximumSize(self.h))
...
proc cellRect*(self: gen_qgridlayout_types.QGridLayout, row: cint, column: cint): QRect =
  QRect(h: fcQGridLayout_cellRect(self.h, row, column))
...
proc addWidget*(self: gen_qgridlayout_types.QGridLayout, w: QWidget): void =
  fcQGridLayout_addWidget(self.h, w.h)

proc addWidget*(self: gen_qgridlayout_types.QGridLayout, param1: QWidget, row: cint, column: cint): void =
  fcQGridLayout_addWidget2(self.h, param1.h, row, column)

proc addWidget*(self: gen_qgridlayout_types.QGridLayout, param1: QWidget, row: cint, column: cint, rowSpan: cint, columnSpan: cint): void =
  fcQGridLayout_addWidget3(self.h, param1.h, row, column, rowSpan, columnSpan)

proc addLayout*(self: gen_qgridlayout_types.QGridLayout, param1: QLayout, row: cint, column: cint): void =
  fcQGridLayout_addLayout(self.h, param1.h, row, column)

proc addLayout*(self: gen_qgridlayout_types.QGridLayout, param1: QLayout, row: cint, column: cint, rowSpan: cint, columnSpan: cint): void =
...
proc itemAt*(self: gen_qgridlayout_types.QGridLayout, index: cint): QLayoutItem =
  QLayoutItem(h: fcQGridLayout_itemAt(self.h, index))

proc itemAtPosition*(self: gen_qgridlayout_types.QGridLayout, row: cint, column: cint): QLayoutItem =
  QLayoutItem(h: fcQGridLayout_itemAtPosition(self.h, row, column))

proc takeAt*(self: gen_qgridlayout_types.QGridLayout, index: cint): QLayoutItem =
  QLayoutItem(h: fcQGridLayout_takeAt(self.h, index))

proc count*(self: gen_qgridlayout_types.QGridLayout, ): cint =
  fcQGridLayout_count(self.h)

proc setGeometry*(self: gen_qgridlayout_types.QGridLayout, geometry: QRect): void =
  fcQGridLayout_setGeometry(self.h, geometry.h)

proc addItem*(self: gen_qgridlayout_types.QGridLayout, item: QLayoutItem, row: cint, column: cint): void =
...
proc addWidget*(self: gen_qgridlayout_types.QGridLayout, param1: QWidget, row: cint, column: cint, param4: cint): void =
  fcQGridLayout_addWidget4(self.h, param1.h, row, column, cint(param4))

proc addWidget*(self: gen_qgridlayout_types.QGridLayout, param1: QWidget, row: cint, column: cint, rowSpan: cint, columnSpan: cint, param6: cint): void =
  fcQGridLayout_addWidget6(self.h, param1.h, row, column, rowSpan, columnSpan, cint(param6))

proc addLayout*(self: gen_qgridlayout_types.QGridLayout, param1: QLayout, row: cint, column: cint, param4: cint): void =
  fcQGridLayout_addLayout4(self.h, param1.h, row, column, cint(param4))

proc addLayout*(self: gen_qgridlayout_types.QGridLayout, param1: QLayout, row: cint, column: cint, rowSpan: cint, columnSpan: cint, param6: cint): void =
  fcQGridLayout_addLayout6(self.h, param1.h, row, column, rowSpan, columnSpan, cint(param6))

proc addItem*(self: gen_qgridlayout_types.QGridLayout, item: QLayoutItem, row: cint, column: cint, rowSpan: cint): void =
  fcQGridLayout_addItem4(self.h, item.h, row, column, rowSpan)

proc addItem*(self: gen_qgridlayout_types.QGridLayout, item: QLayoutItem, row: cint, column: cint, rowSpan: cint, columnSpan: cint): void =
  fcQGridLayout_addItem5(self.h, item.h, row, column, rowSpan, columnSpan)

proc addItem*(self: gen_qgridlayout_types.QGridLayout, item: QLayoutItem, row: cint, column: cint, rowSpan: cint, columnSpan: cint, param6: cint): void =
...
proc miqt_exec_callback_QGridLayout_metacall(self: ptr cQGridLayout, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QGridLayout_metacall ".} =
  ...
  virtualReturn
proc QGridLayoutsizeHint*(self: gen_qgridlayout_types.QGridLayout, ): QSize =
  QSize(h: fQGridLayout_virtualbase_sizeHint(self.h))

type QGridLayoutsizeHintProc* = proc(): QSize
...
proc miqt_exec_callback_QGridLayout_sizeHint(self: ptr cQGridLayout, slot: int): pointer {.exportc: "miqt_exec_callback_QGridLayout_sizeHint ".} =
  ...
  virtualReturn.h
proc QGridLayoutminimumSize*(self: gen_qgridlayout_types.QGridLayout, ): QSize =
  QSize(h: fQGridLayout_virtualbase_minimumSize(self.h))

type QGridLayoutminimumSizeProc* = proc(): QSize
...
proc miqt_exec_callback_QGridLayout_minimumSize(self: ptr cQGridLayout, slot: int): pointer {.exportc: "miqt_exec_callback_QGridLayout_minimumSize ".} =
  ...
  virtualReturn.h
proc QGridLayoutmaximumSize*(self: gen_qgridlayout_types.QGridLayout, ): QSize =
  QSize(h: fQGridLayout_virtualbase_maximumSize(self.h))

type QGridLayoutmaximumSizeProc* = proc(): QSize
...
type QGridLayoutsetSpacingProc* = proc(spacing: cint): void
proc onsetSpacing*(self: gen_qgridlayout_types.QGridLayout, slot: QGridLayoutsetSpacingProc) =
  # TODO check subclass
  var tmp = new QGridLayoutsetSpacingProc
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QGridLayout_setSpacing(self: ptr cQGridLayout, slot: int, spacing: cint): void {.exportc: "miqt_exec_callback_QGridLayout_setSpacing ".} =
  var nimfunc = cast[ptr QGridLayoutsetSpacingProc](cast[pointer](slot))
...
type QGridLayoutspacingProc* = proc(): cint
proc onspacing*(self: gen_qgridlayout_types.QGridLayout, slot: QGridLayoutspacingProc) =
  # TODO check subclass
  var tmp = new QGridLayoutspacingProc
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QGridLayout_spacing(self: ptr cQGridLayout, slot: int): cint {.exportc: "miqt_exec_callback_QGridLayout_spacing ".} =
  var nimfunc = cast[ptr QGridLayoutspacingProc](cast[pointer](slot))
...
proc miqt_exec_callback_QGridLayout_invalidate(self: ptr cQGridLayout, slot: int): void {.exportc: "miqt_exec_callback_QGridLayout_invalidate ".} =
  ...
  nimfunc[]()
proc QGridLayoutitemAt*(self: gen_qgridlayout_types.QGridLayout, index: cint): QLayoutItem =
  QLayoutItem(h: fQGridLayout_virtualbase_itemAt(self.h, index))

type QGridLayoutitemAtProc* = proc(index: cint): QLayoutItem
...
proc miqt_exec_callback_QGridLayout_itemAt(self: ptr cQGridLayout, slot: int, index: cint): pointer {.exportc: "miqt_exec_callback_QGridLayout_itemAt ".} =
  ...
  virtualReturn.h
proc QGridLayouttakeAt*(self: gen_qgridlayout_types.QGridLayout, index: cint): QLayoutItem =
  QLayoutItem(h: fQGridLayout_virtualbase_takeAt(self.h, index))

type QGridLayouttakeAtProc* = proc(index: cint): QLayoutItem
...
proc miqt_exec_callback_QGridLayout_count(self: ptr cQGridLayout, slot: int): cint {.exportc: "miqt_exec_callback_QGridLayout_count ".} =
  ...
  virtualReturn
proc QGridLayoutsetGeometry*(self: gen_qgridlayout_types.QGridLayout, geometry: QRect): void =
  fQGridLayout_virtualbase_setGeometry(self.h, geometry.h)

type QGridLayoutsetGeometryProc* = proc(geometry: QRect): void
...
proc miqt_exec_callback_QGridLayout_setGeometry(self: ptr cQGridLayout, slot: int, geometry: pointer): void {.exportc: "miqt_exec_callback_QGridLayout_setGeometry ".} =
  ...
  nimfunc[](slotval1)
proc QGridLayoutaddItem*(self: gen_qgridlayout_types.QGridLayout, param1: QLayoutItem): void =
  fQGridLayout_virtualbase_addItemWithQLayoutItem(self.h, param1.h)

type QGridLayoutaddItemWithQLayoutItemProc* = proc(param1: QLayoutItem): void
...
proc miqt_exec_callback_QGridLayout_addItemWithQLayoutItem(self: ptr cQGridLayout, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QGridLayout_addItemWithQLayoutItem ".} =
  ...
  nimfunc[](slotval1)
proc QGridLayoutgeometry*(self: gen_qgridlayout_types.QGridLayout, ): QRect =
  QRect(h: fQGridLayout_virtualbase_geometry(self.h))

type QGridLayoutgeometryProc* = proc(): QRect
...
proc miqt_exec_callback_QGridLayout_geometry(self: ptr cQGridLayout, slot: int): pointer {.exportc: "miqt_exec_callback_QGridLayout_geometry ".} =
  ...
  virtualReturn.h
proc QGridLayoutindexOf*(self: gen_qgridlayout_types.QGridLayout, param1: QWidget): cint =
  fQGridLayout_virtualbase_indexOf(self.h, param1.h)

type QGridLayoutindexOfProc* = proc(param1: QWidget): cint
...
proc miqt_exec_callback_QGridLayout_controlTypes(self: ptr cQGridLayout, slot: int): cint {.exportc: "miqt_exec_callback_QGridLayout_controlTypes ".} =
  ...
  cint(virtualReturn)
proc QGridLayoutreplaceWidget*(self: gen_qgridlayout_types.QGridLayout, fromVal: QWidget, to: QWidget, options: cint): QLayoutItem =
  QLayoutItem(h: fQGridLayout_virtualbase_replaceWidget(self.h, fromVal.h, to.h, cint(options)))

type QGridLayoutreplaceWidgetProc* = proc(fromVal: QWidget, to: QWidget, options: cint): QLayoutItem
proc onreplaceWidget*(self: gen_qgridlayout_types.QGridLayout, slot: QGridLayoutreplaceWidgetProc) =
  # TODO check subclass
  var tmp = new QGridLayoutreplaceWidgetProc
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QGridLayout_replaceWidget(self: ptr cQGridLayout, slot: int, fromVal: pointer, to: pointer, options: cint): pointer {.exportc: "miqt_exec_callback_QGridLayout_replaceWidget ".} =
  var nimfunc = cast[ptr QGridLayoutreplaceWidgetProc](cast[pointer](slot))
  ...
  virtualReturn.h
proc QGridLayoutlayout*(self: gen_qgridlayout_types.QGridLayout, ): QLayout =
  QLayout(h: fQGridLayout_virtualbase_layout(self.h))

type QGridLayoutlayoutProc* = proc(): QLayout
...
proc miqt_exec_callback_QGridLayout_layout(self: ptr cQGridLayout, slot: int): pointer {.exportc: "miqt_exec_callback_QGridLayout_layout ".} =
  ...
  virtualReturn.h
proc QGridLayoutchildEvent*(self: gen_qgridlayout_types.QGridLayout, e: QChildEvent): void =
  fQGridLayout_virtualbase_childEvent(self.h, e.h)

type QGridLayoutchildEventProc* = proc(e: QChildEvent): void
...
proc miqt_exec_callback_QGridLayout_childEvent(self: ptr cQGridLayout, slot: int, e: pointer): void {.exportc: "miqt_exec_callback_QGridLayout_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGridLayoutevent*(self: gen_qgridlayout_types.QGridLayout, event: QEvent): bool =
  fQGridLayout_virtualbase_event(self.h, event.h)

type QGridLayouteventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QGridLayout_event(self: ptr cQGridLayout, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QGridLayout_event ".} =
  ...
  virtualReturn
proc QGridLayouteventFilter*(self: gen_qgridlayout_types.QGridLayout, watched: QObject, event: QEvent): bool =
  fQGridLayout_virtualbase_eventFilter(self.h, watched.h, event.h)

type QGridLayouteventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QGridLayout_eventFilter(self: ptr cQGridLayout, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QGridLayout_eventFilter ".} =
  ...
  virtualReturn
proc QGridLayouttimerEvent*(self: gen_qgridlayout_types.QGridLayout, event: QTimerEvent): void =
  fQGridLayout_virtualbase_timerEvent(self.h, event.h)

type QGridLayouttimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QGridLayout_timerEvent(self: ptr cQGridLayout, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGridLayout_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGridLayoutcustomEvent*(self: gen_qgridlayout_types.QGridLayout, event: QEvent): void =
  fQGridLayout_virtualbase_customEvent(self.h, event.h)

type QGridLayoutcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QGridLayout_customEvent(self: ptr cQGridLayout, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGridLayout_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGridLayoutconnectNotify*(self: gen_qgridlayout_types.QGridLayout, signal: QMetaMethod): void =
  fQGridLayout_virtualbase_connectNotify(self.h, signal.h)

type QGridLayoutconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QGridLayout_connectNotify(self: ptr cQGridLayout, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QGridLayout_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QGridLayoutdisconnectNotify*(self: gen_qgridlayout_types.QGridLayout, signal: QMetaMethod): void =
  fQGridLayout_virtualbase_disconnectNotify(self.h, signal.h)

type QGridLayoutdisconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QGridLayout_disconnectNotify(self: ptr cQGridLayout, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QGridLayout_disconnectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QGridLayoutwidget*(self: gen_qgridlayout_types.QGridLayout, ): QWidget =
  QWidget(h: fQGridLayout_virtualbase_widget(self.h))

type QGridLayoutwidgetProc* = proc(): QWidget
...
proc miqt_exec_callback_QGridLayout_widget(self: ptr cQGridLayout, slot: int): pointer {.exportc: "miqt_exec_callback_QGridLayout_widget ".} =
  ...
  virtualReturn.h
proc QGridLayoutspacerItem*(self: gen_qgridlayout_types.QGridLayout, ): QSpacerItem =
  QSpacerItem(h: fQGridLayout_virtualbase_spacerItem(self.h))

type QGridLayoutspacerItemProc* = proc(): QSpacerItem
