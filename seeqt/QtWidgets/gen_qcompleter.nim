...
proc create*(T: type gen_qcompleter_types.QCompleter, model: QAbstractItemModel): gen_qcompleter_types.QCompleter =
...
proc create*(T: type gen_qcompleter_types.QCompleter, parent: QObject): gen_qcompleter_types.QCompleter =
  gen_qcompleter_types.QCompleter.init(fcQCompleter_new4(parent.h))

proc create*(T: type gen_qcompleter_types.QCompleter, model: QAbstractItemModel, parent: QObject): gen_qcompleter_types.QCompleter =
  gen_qcompleter_types.QCompleter.init(fcQCompleter_new5(model.h, parent.h))

proc create*(T: type gen_qcompleter_types.QCompleter, completions: seq[string], parent: QObject): gen_qcompleter_types.QCompleter =
  var completions_CArray = newSeq[struct_miqt_string](len(completions))
  for i in 0..<len(completions):
    completions_CArray[i] = struct_miqt_string(data: completions[i], len: csize_t(len(completions[i])))
...
proc metaObject*(self: gen_qcompleter_types.QCompleter, ): QMetaObject =
  QMetaObject(h: fcQCompleter_metaObject(self.h))
...
proc setWidget*(self: gen_qcompleter_types.QCompleter, widget: QWidget): void =
  fcQCompleter_setWidget(self.h, widget.h)

proc widget*(self: gen_qcompleter_types.QCompleter, ): QWidget =
  QWidget(h: fcQCompleter_widget(self.h))

proc setModel*(self: gen_qcompleter_types.QCompleter, c: QAbstractItemModel): void =
  fcQCompleter_setModel(self.h, c.h)

proc model*(self: gen_qcompleter_types.QCompleter, ): QAbstractItemModel =
  QAbstractItemModel(h: fcQCompleter_model(self.h))
...
proc popup*(self: gen_qcompleter_types.QCompleter, ): QAbstractItemView =
  QAbstractItemView(h: fcQCompleter_popup(self.h))

proc setPopup*(self: gen_qcompleter_types.QCompleter, popup: QAbstractItemView): void =
...
proc currentIndex*(self: gen_qcompleter_types.QCompleter, ): QModelIndex =
  QModelIndex(h: fcQCompleter_currentIndex(self.h))
...
proc completionModel*(self: gen_qcompleter_types.QCompleter, ): QAbstractItemModel =
  QAbstractItemModel(h: fcQCompleter_completionModel(self.h))
...
proc pathFromIndex*(self: gen_qcompleter_types.QCompleter, index: QModelIndex): string =
...
proc activated*(self: gen_qcompleter_types.QCompleter, index: QModelIndex): void =
  fcQCompleter_activatedWithIndex(self.h, index.h)

type QCompleteractivatedWithIndexSlot* = proc(index: QModelIndex)
...
proc highlighted*(self: gen_qcompleter_types.QCompleter, index: QModelIndex): void =
  fcQCompleter_highlightedWithIndex(self.h, index.h)

type QCompleterhighlightedWithIndexSlot* = proc(index: QModelIndex)
...
proc complete*(self: gen_qcompleter_types.QCompleter, rect: QRect): void =
...
proc miqt_exec_callback_QCompleter_metacall(self: ptr cQCompleter, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QCompleter_metacall ".} =
  ...
  virtualReturn
proc QCompleterpathFromIndex*(self: gen_qcompleter_types.QCompleter, index: QModelIndex): string =
  let v_ms = fQCompleter_virtualbase_pathFromIndex(self.h, index.h)
  let vx_ret = string.fromBytes(toOpenArrayByte(v_ms.data, 0, int(v_ms.len)-1))
  c_free(v_ms.data)
  vx_ret

type QCompleterpathFromIndexProc* = proc(index: QModelIndex): string
...
proc QCompletereventFilter*(self: gen_qcompleter_types.QCompleter, o: QObject, e: QEvent): bool =
  fQCompleter_virtualbase_eventFilter(self.h, o.h, e.h)

type QCompletereventFilterProc* = proc(o: QObject, e: QEvent): bool
...
proc miqt_exec_callback_QCompleter_eventFilter(self: ptr cQCompleter, slot: int, o: pointer, e: pointer): bool {.exportc: "miqt_exec_callback_QCompleter_eventFilter ".} =
  ...
  let slotval1 = QObject(h: o)

  let slotval2 = QEvent(h: e)


  let virtualReturn = nimfunc[](slotval1, slotval2 )

  virtualReturn
proc QCompleterevent*(self: gen_qcompleter_types.QCompleter, param1: QEvent): bool =
  fQCompleter_virtualbase_event(self.h, param1.h)

type QCompletereventProc* = proc(param1: QEvent): bool
...
proc miqt_exec_callback_QCompleter_event(self: ptr cQCompleter, slot: int, param1: pointer): bool {.exportc: "miqt_exec_callback_QCompleter_event ".} =
  ...
  virtualReturn
proc QCompletertimerEvent*(self: gen_qcompleter_types.QCompleter, event: QTimerEvent): void =
  fQCompleter_virtualbase_timerEvent(self.h, event.h)

type QCompletertimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QCompleter_timerEvent(self: ptr cQCompleter, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QCompleter_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QCompleterchildEvent*(self: gen_qcompleter_types.QCompleter, event: QChildEvent): void =
  fQCompleter_virtualbase_childEvent(self.h, event.h)

type QCompleterchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QCompleter_childEvent(self: ptr cQCompleter, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QCompleter_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QCompletercustomEvent*(self: gen_qcompleter_types.QCompleter, event: QEvent): void =
  fQCompleter_virtualbase_customEvent(self.h, event.h)

type QCompletercustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QCompleter_customEvent(self: ptr cQCompleter, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QCompleter_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QCompleterconnectNotify*(self: gen_qcompleter_types.QCompleter, signal: QMetaMethod): void =
  fQCompleter_virtualbase_connectNotify(self.h, signal.h)

type QCompleterconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QCompleter_connectNotify(self: ptr cQCompleter, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QCompleter_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QCompleterdisconnectNotify*(self: gen_qcompleter_types.QCompleter, signal: QMetaMethod): void =
  fQCompleter_virtualbase_disconnectNotify(self.h, signal.h)

type QCompleterdisconnectNotifyProc* = proc(signal: QMetaMethod): void
