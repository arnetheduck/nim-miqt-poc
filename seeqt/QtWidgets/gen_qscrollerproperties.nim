...
proc create*(T: type gen_qscrollerproperties_types.QScrollerProperties, sp: QScrollerProperties): gen_qscrollerproperties_types.QScrollerProperties =
  gen_qscrollerproperties_types.QScrollerProperties.init(fcQScrollerProperties_new2(sp.h))

proc operatorAssign*(self: gen_qscrollerproperties_types.QScrollerProperties, sp: QScrollerProperties): void =
  fcQScrollerProperties_operatorAssign(self.h, sp.h)

proc operatorEqual*(self: gen_qscrollerproperties_types.QScrollerProperties, sp: QScrollerProperties): bool =
  fcQScrollerProperties_operatorEqual(self.h, sp.h)

proc operatorNotEqual*(self: gen_qscrollerproperties_types.QScrollerProperties, sp: QScrollerProperties): bool =
  fcQScrollerProperties_operatorNotEqual(self.h, sp.h)

proc setDefaultScrollerProperties*(_: type gen_qscrollerproperties_types.QScrollerProperties, sp: QScrollerProperties): void =
...
proc scrollMetric*(self: gen_qscrollerproperties_types.QScrollerProperties, metric: cint): QVariant =
  QVariant(h: fcQScrollerProperties_scrollMetric(self.h, cint(metric)))

proc setScrollMetric*(self: gen_qscrollerproperties_types.QScrollerProperties, metric: cint, value: QVariant): void =
