...
func init*(T: type gen_qinputdialog_types.QInputDialog, h: ptr cQInputDialog): gen_qinputdialog_types.QInputDialog =
  T(h: h)
proc create*(T: type gen_qinputdialog_types.QInputDialog, parent: QWidget): gen_qinputdialog_types.QInputDialog =
...
proc create*(T: type gen_qinputdialog_types.QInputDialog, parent: QWidget, flags: cint): gen_qinputdialog_types.QInputDialog =
  gen_qinputdialog_types.QInputDialog.init(fcQInputDialog_new3(parent.h, cint(flags)))

proc metaObject*(self: gen_qinputdialog_types.QInputDialog, ): QMetaObject =
  QMetaObject(h: fcQInputDialog_metaObject(self.h))
...
proc minimumSizeHint*(self: gen_qinputdialog_types.QInputDialog, ): QSize =
  QSize(h: fcQInputDialog_minimumSizeHint(self.h))

proc sizeHint*(self: gen_qinputdialog_types.QInputDialog, ): QSize =
  QSize(h: fcQInputDialog_sizeHint(self.h))

proc setVisible*(self: gen_qinputdialog_types.QInputDialog, visible: bool): void =
  fcQInputDialog_setVisible(self.h, visible)

proc getText*(_: type gen_qinputdialog_types.QInputDialog, parent: QWidget, title: string, label: string): string =
...
proc getMultiLineText*(_: type gen_qinputdialog_types.QInputDialog, parent: QWidget, title: string, label: string): string =
...
proc getItem*(_: type gen_qinputdialog_types.QInputDialog, parent: QWidget, title: string, label: string, items: seq[string]): string =
  var items_CArray = newSeq[struct_miqt_string](len(items))
  for i in 0..<len(items):
    items_CArray[i] = struct_miqt_string(data: items[i], len: csize_t(len(items[i])))
...
proc getInt*(_: type gen_qinputdialog_types.QInputDialog, parent: QWidget, title: string, label: string): cint =
...
proc getDouble*(_: type gen_qinputdialog_types.QInputDialog, parent: QWidget, title: string, label: string): float64 =
...
proc getDouble*(_: type gen_qinputdialog_types.QInputDialog, parent: QWidget, title: string, label: string, value: float64, minValue: float64, maxValue: float64, decimals: cint, ok: ptr bool, flags: cint, step: float64): float64 =
...
proc getText*(_: type gen_qinputdialog_types.QInputDialog, parent: QWidget, title: string, label: string, echo: cint): string =
...
proc getText*(_: type gen_qinputdialog_types.QInputDialog, parent: QWidget, title: string, label: string, echo: cint, text: string): string =
...
proc getText*(_: type gen_qinputdialog_types.QInputDialog, parent: QWidget, title: string, label: string, echo: cint, text: string, ok: ptr bool): string =
...
proc getText*(_: type gen_qinputdialog_types.QInputDialog, parent: QWidget, title: string, label: string, echo: cint, text: string, ok: ptr bool, flags: cint): string =
...
proc getText*(_: type gen_qinputdialog_types.QInputDialog, parent: QWidget, title: string, label: string, echo: cint, text: string, ok: ptr bool, flags: cint, inputMethodHints: cint): string =
...
proc getMultiLineText*(_: type gen_qinputdialog_types.QInputDialog, parent: QWidget, title: string, label: string, text: string): string =
...
proc getMultiLineText*(_: type gen_qinputdialog_types.QInputDialog, parent: QWidget, title: string, label: string, text: string, ok: ptr bool): string =
...
proc getMultiLineText*(_: type gen_qinputdialog_types.QInputDialog, parent: QWidget, title: string, label: string, text: string, ok: ptr bool, flags: cint): string =
...
proc getMultiLineText*(_: type gen_qinputdialog_types.QInputDialog, parent: QWidget, title: string, label: string, text: string, ok: ptr bool, flags: cint, inputMethodHints: cint): string =
...
proc getItem*(_: type gen_qinputdialog_types.QInputDialog, parent: QWidget, title: string, label: string, items: seq[string], current: cint): string =
  var items_CArray = newSeq[struct_miqt_string](len(items))
  for i in 0..<len(items):
    items_CArray[i] = struct_miqt_string(data: items[i], len: csize_t(len(items[i])))
...
proc getItem*(_: type gen_qinputdialog_types.QInputDialog, parent: QWidget, title: string, label: string, items: seq[string], current: cint, editable: bool): string =
  var items_CArray = newSeq[struct_miqt_string](len(items))
  for i in 0..<len(items):
    items_CArray[i] = struct_miqt_string(data: items[i], len: csize_t(len(items[i])))
...
proc getItem*(_: type gen_qinputdialog_types.QInputDialog, parent: QWidget, title: string, label: string, items: seq[string], current: cint, editable: bool, ok: ptr bool): string =
  var items_CArray = newSeq[struct_miqt_string](len(items))
  for i in 0..<len(items):
    items_CArray[i] = struct_miqt_string(data: items[i], len: csize_t(len(items[i])))
...
proc getItem*(_: type gen_qinputdialog_types.QInputDialog, parent: QWidget, title: string, label: string, items: seq[string], current: cint, editable: bool, ok: ptr bool, flags: cint): string =
  var items_CArray = newSeq[struct_miqt_string](len(items))
  for i in 0..<len(items):
    items_CArray[i] = struct_miqt_string(data: items[i], len: csize_t(len(items[i])))
...
proc getItem*(_: type gen_qinputdialog_types.QInputDialog, parent: QWidget, title: string, label: string, items: seq[string], current: cint, editable: bool, ok: ptr bool, flags: cint, inputMethodHints: cint): string =
  var items_CArray = newSeq[struct_miqt_string](len(items))
  for i in 0..<len(items):
    items_CArray[i] = struct_miqt_string(data: items[i], len: csize_t(len(items[i])))
...
proc getInt*(_: type gen_qinputdialog_types.QInputDialog, parent: QWidget, title: string, label: string, value: cint): cint =
...
proc getInt*(_: type gen_qinputdialog_types.QInputDialog, parent: QWidget, title: string, label: string, value: cint, minValue: cint): cint =
...
proc getInt*(_: type gen_qinputdialog_types.QInputDialog, parent: QWidget, title: string, label: string, value: cint, minValue: cint, maxValue: cint): cint =
...
proc getInt*(_: type gen_qinputdialog_types.QInputDialog, parent: QWidget, title: string, label: string, value: cint, minValue: cint, maxValue: cint, step: cint): cint =
...
proc getInt*(_: type gen_qinputdialog_types.QInputDialog, parent: QWidget, title: string, label: string, value: cint, minValue: cint, maxValue: cint, step: cint, ok: ptr bool): cint =
...
proc getInt*(_: type gen_qinputdialog_types.QInputDialog, parent: QWidget, title: string, label: string, value: cint, minValue: cint, maxValue: cint, step: cint, ok: ptr bool, flags: cint): cint =
...
proc getDouble*(_: type gen_qinputdialog_types.QInputDialog, parent: QWidget, title: string, label: string, value: float64): float64 =
...
proc getDouble*(_: type gen_qinputdialog_types.QInputDialog, parent: QWidget, title: string, label: string, value: float64, minValue: float64): float64 =
...
proc getDouble*(_: type gen_qinputdialog_types.QInputDialog, parent: QWidget, title: string, label: string, value: float64, minValue: float64, maxValue: float64): float64 =
...
proc getDouble*(_: type gen_qinputdialog_types.QInputDialog, parent: QWidget, title: string, label: string, value: float64, minValue: float64, maxValue: float64, decimals: cint): float64 =
...
proc getDouble*(_: type gen_qinputdialog_types.QInputDialog, parent: QWidget, title: string, label: string, value: float64, minValue: float64, maxValue: float64, decimals: cint, ok: ptr bool): float64 =
...
proc getDouble*(_: type gen_qinputdialog_types.QInputDialog, parent: QWidget, title: string, label: string, value: float64, minValue: float64, maxValue: float64, decimals: cint, ok: ptr bool, flags: cint): float64 =
...
proc miqt_exec_callback_QInputDialog_metacall(self: ptr cQInputDialog, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QInputDialog_metacall ".} =
  ...
  virtualReturn
proc QInputDialogminimumSizeHint*(self: gen_qinputdialog_types.QInputDialog, ): QSize =
  QSize(h: fQInputDialog_virtualbase_minimumSizeHint(self.h))

type QInputDialogminimumSizeHintProc* = proc(): QSize
...
proc miqt_exec_callback_QInputDialog_minimumSizeHint(self: ptr cQInputDialog, slot: int): pointer {.exportc: "miqt_exec_callback_QInputDialog_minimumSizeHint ".} =
  ...
  virtualReturn.h
proc QInputDialogsizeHint*(self: gen_qinputdialog_types.QInputDialog, ): QSize =
  QSize(h: fQInputDialog_virtualbase_sizeHint(self.h))

type QInputDialogsizeHintProc* = proc(): QSize
...
proc miqt_exec_callback_QInputDialog_reject(self: ptr cQInputDialog, slot: int): void {.exportc: "miqt_exec_callback_QInputDialog_reject ".} =
  ...
  nimfunc[]()
proc QInputDialogkeyPressEvent*(self: gen_qinputdialog_types.QInputDialog, param1: QKeyEvent): void =
  fQInputDialog_virtualbase_keyPressEvent(self.h, param1.h)

type QInputDialogkeyPressEventProc* = proc(param1: QKeyEvent): void
...
proc miqt_exec_callback_QInputDialog_keyPressEvent(self: ptr cQInputDialog, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QInputDialog_keyPressEvent ".} =
  ...
  nimfunc[](slotval1)
proc QInputDialogcloseEvent*(self: gen_qinputdialog_types.QInputDialog, param1: QCloseEvent): void =
  fQInputDialog_virtualbase_closeEvent(self.h, param1.h)

type QInputDialogcloseEventProc* = proc(param1: QCloseEvent): void
...
proc miqt_exec_callback_QInputDialog_closeEvent(self: ptr cQInputDialog, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QInputDialog_closeEvent ".} =
  ...
  nimfunc[](slotval1)
proc QInputDialogshowEvent*(self: gen_qinputdialog_types.QInputDialog, param1: QShowEvent): void =
  fQInputDialog_virtualbase_showEvent(self.h, param1.h)

type QInputDialogshowEventProc* = proc(param1: QShowEvent): void
...
proc miqt_exec_callback_QInputDialog_showEvent(self: ptr cQInputDialog, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QInputDialog_showEvent ".} =
  ...
  nimfunc[](slotval1)
proc QInputDialogresizeEvent*(self: gen_qinputdialog_types.QInputDialog, param1: QResizeEvent): void =
  fQInputDialog_virtualbase_resizeEvent(self.h, param1.h)

type QInputDialogresizeEventProc* = proc(param1: QResizeEvent): void
...
proc miqt_exec_callback_QInputDialog_resizeEvent(self: ptr cQInputDialog, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QInputDialog_resizeEvent ".} =
  ...
  nimfunc[](slotval1)
proc QInputDialogcontextMenuEvent*(self: gen_qinputdialog_types.QInputDialog, param1: QContextMenuEvent): void =
  fQInputDialog_virtualbase_contextMenuEvent(self.h, param1.h)

type QInputDialogcontextMenuEventProc* = proc(param1: QContextMenuEvent): void
...
proc miqt_exec_callback_QInputDialog_contextMenuEvent(self: ptr cQInputDialog, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QInputDialog_contextMenuEvent ".} =
  ...
  nimfunc[](slotval1)
proc QInputDialogeventFilter*(self: gen_qinputdialog_types.QInputDialog, param1: QObject, param2: QEvent): bool =
  fQInputDialog_virtualbase_eventFilter(self.h, param1.h, param2.h)

type QInputDialogeventFilterProc* = proc(param1: QObject, param2: QEvent): bool
...
proc miqt_exec_callback_QInputDialog_hasHeightForWidth(self: ptr cQInputDialog, slot: int): bool {.exportc: "miqt_exec_callback_QInputDialog_hasHeightForWidth ".} =
  ...
  virtualReturn
proc QInputDialogpaintEngine*(self: gen_qinputdialog_types.QInputDialog, ): QPaintEngine =
  QPaintEngine(h: fQInputDialog_virtualbase_paintEngine(self.h))

type QInputDialogpaintEngineProc* = proc(): QPaintEngine
...
proc miqt_exec_callback_QInputDialog_paintEngine(self: ptr cQInputDialog, slot: int): pointer {.exportc: "miqt_exec_callback_QInputDialog_paintEngine ".} =
  ...
  virtualReturn.h
proc QInputDialogevent*(self: gen_qinputdialog_types.QInputDialog, event: QEvent): bool =
  fQInputDialog_virtualbase_event(self.h, event.h)

type QInputDialogeventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QInputDialog_event(self: ptr cQInputDialog, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QInputDialog_event ".} =
  ...
  virtualReturn
proc QInputDialogmousePressEvent*(self: gen_qinputdialog_types.QInputDialog, event: QMouseEvent): void =
  fQInputDialog_virtualbase_mousePressEvent(self.h, event.h)

type QInputDialogmousePressEventProc* = proc(event: QMouseEvent): void
...
proc miqt_exec_callback_QInputDialog_mousePressEvent(self: ptr cQInputDialog, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QInputDialog_mousePressEvent ".} =
  ...
  nimfunc[](slotval1)
proc QInputDialogmouseReleaseEvent*(self: gen_qinputdialog_types.QInputDialog, event: QMouseEvent): void =
  fQInputDialog_virtualbase_mouseReleaseEvent(self.h, event.h)

type QInputDialogmouseReleaseEventProc* = proc(event: QMouseEvent): void
...
proc miqt_exec_callback_QInputDialog_mouseReleaseEvent(self: ptr cQInputDialog, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QInputDialog_mouseReleaseEvent ".} =
  ...
  nimfunc[](slotval1)
proc QInputDialogmouseDoubleClickEvent*(self: gen_qinputdialog_types.QInputDialog, event: QMouseEvent): void =
  fQInputDialog_virtualbase_mouseDoubleClickEvent(self.h, event.h)

type QInputDialogmouseDoubleClickEventProc* = proc(event: QMouseEvent): void
...
proc miqt_exec_callback_QInputDialog_mouseDoubleClickEvent(self: ptr cQInputDialog, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QInputDialog_mouseDoubleClickEvent ".} =
  ...
  nimfunc[](slotval1)
proc QInputDialogmouseMoveEvent*(self: gen_qinputdialog_types.QInputDialog, event: QMouseEvent): void =
  fQInputDialog_virtualbase_mouseMoveEvent(self.h, event.h)

type QInputDialogmouseMoveEventProc* = proc(event: QMouseEvent): void
...
proc miqt_exec_callback_QInputDialog_mouseMoveEvent(self: ptr cQInputDialog, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QInputDialog_mouseMoveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QInputDialogwheelEvent*(self: gen_qinputdialog_types.QInputDialog, event: QWheelEvent): void =
  fQInputDialog_virtualbase_wheelEvent(self.h, event.h)

type QInputDialogwheelEventProc* = proc(event: QWheelEvent): void
...
proc miqt_exec_callback_QInputDialog_wheelEvent(self: ptr cQInputDialog, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QInputDialog_wheelEvent ".} =
  ...
  nimfunc[](slotval1)
proc QInputDialogkeyReleaseEvent*(self: gen_qinputdialog_types.QInputDialog, event: QKeyEvent): void =
  fQInputDialog_virtualbase_keyReleaseEvent(self.h, event.h)

type QInputDialogkeyReleaseEventProc* = proc(event: QKeyEvent): void
...
proc miqt_exec_callback_QInputDialog_keyReleaseEvent(self: ptr cQInputDialog, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QInputDialog_keyReleaseEvent ".} =
  ...
  nimfunc[](slotval1)
proc QInputDialogfocusInEvent*(self: gen_qinputdialog_types.QInputDialog, event: QFocusEvent): void =
  fQInputDialog_virtualbase_focusInEvent(self.h, event.h)

type QInputDialogfocusInEventProc* = proc(event: QFocusEvent): void
...
proc miqt_exec_callback_QInputDialog_focusInEvent(self: ptr cQInputDialog, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QInputDialog_focusInEvent ".} =
  ...
  nimfunc[](slotval1)
proc QInputDialogfocusOutEvent*(self: gen_qinputdialog_types.QInputDialog, event: QFocusEvent): void =
  fQInputDialog_virtualbase_focusOutEvent(self.h, event.h)

type QInputDialogfocusOutEventProc* = proc(event: QFocusEvent): void
...
proc miqt_exec_callback_QInputDialog_focusOutEvent(self: ptr cQInputDialog, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QInputDialog_focusOutEvent ".} =
  ...
  nimfunc[](slotval1)
proc QInputDialogenterEvent*(self: gen_qinputdialog_types.QInputDialog, event: QEvent): void =
  fQInputDialog_virtualbase_enterEvent(self.h, event.h)

type QInputDialogenterEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QInputDialog_enterEvent(self: ptr cQInputDialog, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QInputDialog_enterEvent ".} =
  ...
  nimfunc[](slotval1)
proc QInputDialogleaveEvent*(self: gen_qinputdialog_types.QInputDialog, event: QEvent): void =
  fQInputDialog_virtualbase_leaveEvent(self.h, event.h)

type QInputDialogleaveEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QInputDialog_leaveEvent(self: ptr cQInputDialog, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QInputDialog_leaveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QInputDialogpaintEvent*(self: gen_qinputdialog_types.QInputDialog, event: QPaintEvent): void =
  fQInputDialog_virtualbase_paintEvent(self.h, event.h)

type QInputDialogpaintEventProc* = proc(event: QPaintEvent): void
...
proc miqt_exec_callback_QInputDialog_paintEvent(self: ptr cQInputDialog, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QInputDialog_paintEvent ".} =
  ...
  nimfunc[](slotval1)
proc QInputDialogmoveEvent*(self: gen_qinputdialog_types.QInputDialog, event: QMoveEvent): void =
  fQInputDialog_virtualbase_moveEvent(self.h, event.h)

type QInputDialogmoveEventProc* = proc(event: QMoveEvent): void
...
proc miqt_exec_callback_QInputDialog_moveEvent(self: ptr cQInputDialog, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QInputDialog_moveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QInputDialogtabletEvent*(self: gen_qinputdialog_types.QInputDialog, event: QTabletEvent): void =
  fQInputDialog_virtualbase_tabletEvent(self.h, event.h)

type QInputDialogtabletEventProc* = proc(event: QTabletEvent): void
...
proc miqt_exec_callback_QInputDialog_tabletEvent(self: ptr cQInputDialog, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QInputDialog_tabletEvent ".} =
  ...
  nimfunc[](slotval1)
proc QInputDialogactionEvent*(self: gen_qinputdialog_types.QInputDialog, event: QActionEvent): void =
  fQInputDialog_virtualbase_actionEvent(self.h, event.h)

type QInputDialogactionEventProc* = proc(event: QActionEvent): void
...
proc miqt_exec_callback_QInputDialog_actionEvent(self: ptr cQInputDialog, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QInputDialog_actionEvent ".} =
  ...
  nimfunc[](slotval1)
proc QInputDialogdragEnterEvent*(self: gen_qinputdialog_types.QInputDialog, event: QDragEnterEvent): void =
  fQInputDialog_virtualbase_dragEnterEvent(self.h, event.h)

type QInputDialogdragEnterEventProc* = proc(event: QDragEnterEvent): void
...
proc miqt_exec_callback_QInputDialog_dragEnterEvent(self: ptr cQInputDialog, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QInputDialog_dragEnterEvent ".} =
  ...
  nimfunc[](slotval1)
proc QInputDialogdragMoveEvent*(self: gen_qinputdialog_types.QInputDialog, event: QDragMoveEvent): void =
  fQInputDialog_virtualbase_dragMoveEvent(self.h, event.h)

type QInputDialogdragMoveEventProc* = proc(event: QDragMoveEvent): void
...
proc miqt_exec_callback_QInputDialog_dragMoveEvent(self: ptr cQInputDialog, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QInputDialog_dragMoveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QInputDialogdragLeaveEvent*(self: gen_qinputdialog_types.QInputDialog, event: QDragLeaveEvent): void =
  fQInputDialog_virtualbase_dragLeaveEvent(self.h, event.h)

type QInputDialogdragLeaveEventProc* = proc(event: QDragLeaveEvent): void
...
proc miqt_exec_callback_QInputDialog_dragLeaveEvent(self: ptr cQInputDialog, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QInputDialog_dragLeaveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QInputDialogdropEvent*(self: gen_qinputdialog_types.QInputDialog, event: QDropEvent): void =
  fQInputDialog_virtualbase_dropEvent(self.h, event.h)

type QInputDialogdropEventProc* = proc(event: QDropEvent): void
...
proc miqt_exec_callback_QInputDialog_dropEvent(self: ptr cQInputDialog, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QInputDialog_dropEvent ".} =
  ...
  nimfunc[](slotval1)
proc QInputDialoghideEvent*(self: gen_qinputdialog_types.QInputDialog, event: QHideEvent): void =
  fQInputDialog_virtualbase_hideEvent(self.h, event.h)

type QInputDialoghideEventProc* = proc(event: QHideEvent): void
...
type QInputDialognativeEventProc* = proc(eventType: seq[byte], message: pointer, resultVal: ptr clong): bool
...
proc miqt_exec_callback_QInputDialog_nativeEvent(self: ptr cQInputDialog, slot: int, eventType: struct_miqt_string, message: pointer, resultVal: ptr clong): bool {.exportc: "miqt_exec_callback_QInputDialog_nativeEvent ".} =
  ...
  virtualReturn
proc QInputDialogchangeEvent*(self: gen_qinputdialog_types.QInputDialog, param1: QEvent): void =
  fQInputDialog_virtualbase_changeEvent(self.h, param1.h)

type QInputDialogchangeEventProc* = proc(param1: QEvent): void
...
proc miqt_exec_callback_QInputDialog_metric(self: ptr cQInputDialog, slot: int, param1: cint): cint {.exportc: "miqt_exec_callback_QInputDialog_metric ".} =
  ...
  virtualReturn
proc QInputDialoginitPainter*(self: gen_qinputdialog_types.QInputDialog, painter: QPainter): void =
  fQInputDialog_virtualbase_initPainter(self.h, painter.h)

type QInputDialoginitPainterProc* = proc(painter: QPainter): void
...
proc miqt_exec_callback_QInputDialog_initPainter(self: ptr cQInputDialog, slot: int, painter: pointer): void {.exportc: "miqt_exec_callback_QInputDialog_initPainter ".} =
  ...
  nimfunc[](slotval1)
proc QInputDialogredirected*(self: gen_qinputdialog_types.QInputDialog, offset: QPoint): QPaintDevice =
  QPaintDevice(h: fQInputDialog_virtualbase_redirected(self.h, offset.h))

type QInputDialogredirectedProc* = proc(offset: QPoint): QPaintDevice
...
proc miqt_exec_callback_QInputDialog_redirected(self: ptr cQInputDialog, slot: int, offset: pointer): pointer {.exportc: "miqt_exec_callback_QInputDialog_redirected ".} =
  ...
  virtualReturn.h
proc QInputDialogsharedPainter*(self: gen_qinputdialog_types.QInputDialog, ): QPainter =
  QPainter(h: fQInputDialog_virtualbase_sharedPainter(self.h))

type QInputDialogsharedPainterProc* = proc(): QPainter
...
proc miqt_exec_callback_QInputDialog_sharedPainter(self: ptr cQInputDialog, slot: int): pointer {.exportc: "miqt_exec_callback_QInputDialog_sharedPainter ".} =
  ...
  virtualReturn.h
proc QInputDialoginputMethodEvent*(self: gen_qinputdialog_types.QInputDialog, param1: QInputMethodEvent): void =
  fQInputDialog_virtualbase_inputMethodEvent(self.h, param1.h)

type QInputDialoginputMethodEventProc* = proc(param1: QInputMethodEvent): void
...
proc miqt_exec_callback_QInputDialog_inputMethodEvent(self: ptr cQInputDialog, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QInputDialog_inputMethodEvent ".} =
  ...
  nimfunc[](slotval1)
proc QInputDialoginputMethodQuery*(self: gen_qinputdialog_types.QInputDialog, param1: cint): QVariant =
  QVariant(h: fQInputDialog_virtualbase_inputMethodQuery(self.h, cint(param1)))

type QInputDialoginputMethodQueryProc* = proc(param1: cint): QVariant
...
proc miqt_exec_callback_QInputDialog_focusNextPrevChild(self: ptr cQInputDialog, slot: int, next: bool): bool {.exportc: "miqt_exec_callback_QInputDialog_focusNextPrevChild ".} =
  ...
  virtualReturn
proc QInputDialogtimerEvent*(self: gen_qinputdialog_types.QInputDialog, event: QTimerEvent): void =
  fQInputDialog_virtualbase_timerEvent(self.h, event.h)

type QInputDialogtimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QInputDialog_timerEvent(self: ptr cQInputDialog, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QInputDialog_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QInputDialogchildEvent*(self: gen_qinputdialog_types.QInputDialog, event: QChildEvent): void =
  fQInputDialog_virtualbase_childEvent(self.h, event.h)

type QInputDialogchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QInputDialog_childEvent(self: ptr cQInputDialog, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QInputDialog_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QInputDialogcustomEvent*(self: gen_qinputdialog_types.QInputDialog, event: QEvent): void =
  fQInputDialog_virtualbase_customEvent(self.h, event.h)

type QInputDialogcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QInputDialog_customEvent(self: ptr cQInputDialog, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QInputDialog_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QInputDialogconnectNotify*(self: gen_qinputdialog_types.QInputDialog, signal: QMetaMethod): void =
  fQInputDialog_virtualbase_connectNotify(self.h, signal.h)

type QInputDialogconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QInputDialog_connectNotify(self: ptr cQInputDialog, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QInputDialog_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QInputDialogdisconnectNotify*(self: gen_qinputdialog_types.QInputDialog, signal: QMetaMethod): void =
  fQInputDialog_virtualbase_disconnectNotify(self.h, signal.h)

type QInputDialogdisconnectNotifyProc* = proc(signal: QMetaMethod): void
