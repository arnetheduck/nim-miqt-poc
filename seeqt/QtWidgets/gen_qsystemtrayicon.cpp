...
public:
	...
	MiqtVirtualQSystemTrayIcon(struct QSystemTrayIcon_VTable* vtbl): QSystemTrayIcon(), vtbl(vtbl) {};
	MiqtVirtualQSystemTrayIcon(struct QSystemTrayIcon_VTable* vtbl, const QIcon& icon): QSystemTrayIcon(icon), vtbl(vtbl) {};
	MiqtVirtualQSystemTrayIcon(struct QSystemTrayIcon_VTable* vtbl, QObject* parent): QSystemTrayIcon(parent), vtbl(vtbl) {};
	MiqtVirtualQSystemTrayIcon(struct QSystemTrayIcon_VTable* vtbl, const QIcon& icon, QObject* parent): QSystemTrayIcon(icon, parent), vtbl(vtbl) {};

	virtual ~MiqtVirtualQSystemTrayIcon() override { if(vtbl->destructor) vtbl->destructor(vtbl, this); }
...
void QSystemTrayIcon_connect_activated(QSystemTrayIcon* self, intptr_t slot, void (*callback)(intptr_t, int), void (*release)(intptr_t)) {
	...
	MiqtVirtualQSystemTrayIcon::connect(self, static_cast<void (QSystemTrayIcon::*)(QSystemTrayIcon::ActivationReason)>(&QSystemTrayIcon::activated), self, caller{slot, callback, release});
}
...
void QSystemTrayIcon_connect_messageClicked(QSystemTrayIcon* self, intptr_t slot, void (*callback)(intptr_t), void (*release)(intptr_t)) {
	...
	MiqtVirtualQSystemTrayIcon::connect(self, static_cast<void (QSystemTrayIcon::*)()>(&QSystemTrayIcon::messageClicked), self, caller{slot, callback, release});
}
...
QMetaObject* QSystemTrayIcon_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQSystemTrayIcon*)(self) )->QSystemTrayIcon::metaObject();

}

void* QSystemTrayIcon_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQSystemTrayIcon*)(self) )->QSystemTrayIcon::qt_metacast(param1);

}

int QSystemTrayIcon_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQSystemTrayIcon*)(self) )->QSystemTrayIcon::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
