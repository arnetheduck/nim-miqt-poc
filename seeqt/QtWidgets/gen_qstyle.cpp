...
QMetaObject* QStyle_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQStyle*)(self) )->QStyle::metaObject();

}

void* QStyle_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQStyle*)(self) )->QStyle::qt_metacast(param1);

}

int QStyle_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQStyle*)(self) )->QStyle::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
