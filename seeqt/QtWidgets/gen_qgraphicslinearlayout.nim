...
proc create*(T: type gen_qgraphicslinearlayout_types.QGraphicsLinearLayout, parent: QGraphicsLayoutItem): gen_qgraphicslinearlayout_types.QGraphicsLinearLayout =
  gen_qgraphicslinearlayout_types.QGraphicsLinearLayout.init(fcQGraphicsLinearLayout_new3(parent.h))

proc create*(T: type gen_qgraphicslinearlayout_types.QGraphicsLinearLayout, orientation: cint, parent: QGraphicsLayoutItem): gen_qgraphicslinearlayout_types.QGraphicsLinearLayout =
...
proc addItem*(self: gen_qgraphicslinearlayout_types.QGraphicsLinearLayout, item: QGraphicsLayoutItem): void =
...
proc insertItem*(self: gen_qgraphicslinearlayout_types.QGraphicsLinearLayout, index: cint, item: QGraphicsLayoutItem): void =
...
proc removeItem*(self: gen_qgraphicslinearlayout_types.QGraphicsLinearLayout, item: QGraphicsLayoutItem): void =
...
proc setStretchFactor*(self: gen_qgraphicslinearlayout_types.QGraphicsLinearLayout, item: QGraphicsLayoutItem, stretch: cint): void =
  fcQGraphicsLinearLayout_setStretchFactor(self.h, item.h, stretch)

proc stretchFactor*(self: gen_qgraphicslinearlayout_types.QGraphicsLinearLayout, item: QGraphicsLayoutItem): cint =
  fcQGraphicsLinearLayout_stretchFactor(self.h, item.h)

proc setAlignment*(self: gen_qgraphicslinearlayout_types.QGraphicsLinearLayout, item: QGraphicsLayoutItem, alignment: cint): void =
  fcQGraphicsLinearLayout_setAlignment(self.h, item.h, cint(alignment))

proc alignment*(self: gen_qgraphicslinearlayout_types.QGraphicsLinearLayout, item: QGraphicsLayoutItem): cint =
  cint(fcQGraphicsLinearLayout_alignment(self.h, item.h))

proc setGeometry*(self: gen_qgraphicslinearlayout_types.QGraphicsLinearLayout, rect: QRectF): void =
...
proc itemAt*(self: gen_qgraphicslinearlayout_types.QGraphicsLinearLayout, index: cint): QGraphicsLayoutItem =
  QGraphicsLayoutItem(h: fcQGraphicsLinearLayout_itemAt(self.h, index))

proc invalidate*(self: gen_qgraphicslinearlayout_types.QGraphicsLinearLayout, ): void =
  fcQGraphicsLinearLayout_invalidate(self.h)

proc sizeHint*(self: gen_qgraphicslinearlayout_types.QGraphicsLinearLayout, which: cint, constraint: QSizeF): QSizeF =
  QSizeF(h: fcQGraphicsLinearLayout_sizeHint(self.h, cint(which), constraint.h))
...
proc miqt_exec_callback_QGraphicsLinearLayout_removeAt(self: ptr cQGraphicsLinearLayout, slot: int, index: cint): void {.exportc: "miqt_exec_callback_QGraphicsLinearLayout_removeAt ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsLinearLayoutsetGeometry*(self: gen_qgraphicslinearlayout_types.QGraphicsLinearLayout, rect: QRectF): void =
  fQGraphicsLinearLayout_virtualbase_setGeometry(self.h, rect.h)

type QGraphicsLinearLayoutsetGeometryProc* = proc(rect: QRectF): void
...
proc miqt_exec_callback_QGraphicsLinearLayout_count(self: ptr cQGraphicsLinearLayout, slot: int): cint {.exportc: "miqt_exec_callback_QGraphicsLinearLayout_count ".} =
  ...
  virtualReturn
proc QGraphicsLinearLayoutitemAt*(self: gen_qgraphicslinearlayout_types.QGraphicsLinearLayout, index: cint): QGraphicsLayoutItem =
  QGraphicsLayoutItem(h: fQGraphicsLinearLayout_virtualbase_itemAt(self.h, index))

type QGraphicsLinearLayoutitemAtProc* = proc(index: cint): QGraphicsLayoutItem
...
proc miqt_exec_callback_QGraphicsLinearLayout_invalidate(self: ptr cQGraphicsLinearLayout, slot: int): void {.exportc: "miqt_exec_callback_QGraphicsLinearLayout_invalidate ".} =
  ...
  nimfunc[]()
proc QGraphicsLinearLayoutsizeHint*(self: gen_qgraphicslinearlayout_types.QGraphicsLinearLayout, which: cint, constraint: QSizeF): QSizeF =
  QSizeF(h: fQGraphicsLinearLayout_virtualbase_sizeHint(self.h, cint(which), constraint.h))

type QGraphicsLinearLayoutsizeHintProc* = proc(which: cint, constraint: QSizeF): QSizeF
...
proc miqt_exec_callback_QGraphicsLinearLayout_updateGeometry(self: ptr cQGraphicsLinearLayout, slot: int): void {.exportc: "miqt_exec_callback_QGraphicsLinearLayout_updateGeometry ".} =
  ...
  nimfunc[]()
proc QGraphicsLinearLayoutwidgetEvent*(self: gen_qgraphicslinearlayout_types.QGraphicsLinearLayout, e: QEvent): void =
  fQGraphicsLinearLayout_virtualbase_widgetEvent(self.h, e.h)

type QGraphicsLinearLayoutwidgetEventProc* = proc(e: QEvent): void
