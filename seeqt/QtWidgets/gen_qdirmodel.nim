...
proc create*(T: type gen_qdirmodel_types.QDirModel, nameFilters: seq[string], filters: cint, sort: cint, parent: QObject): gen_qdirmodel_types.QDirModel =
  var nameFilters_CArray = newSeq[struct_miqt_string](len(nameFilters))
  for i in 0..<len(nameFilters):
    nameFilters_CArray[i] = struct_miqt_string(data: nameFilters[i], len: csize_t(len(nameFilters[i])))
...
proc create*(T: type gen_qdirmodel_types.QDirModel, parent: QObject): gen_qdirmodel_types.QDirModel =
  gen_qdirmodel_types.QDirModel.init(fcQDirModel_new4(parent.h))

proc metaObject*(self: gen_qdirmodel_types.QDirModel, ): QMetaObject =
  QMetaObject(h: fcQDirModel_metaObject(self.h))
...
proc index*(self: gen_qdirmodel_types.QDirModel, row: cint, column: cint, parent: QModelIndex): QModelIndex =
  QModelIndex(h: fcQDirModel_index(self.h, row, column, parent.h))

proc parent*(self: gen_qdirmodel_types.QDirModel, child: QModelIndex): QModelIndex =
  QModelIndex(h: fcQDirModel_parent(self.h, child.h))

proc rowCount*(self: gen_qdirmodel_types.QDirModel, parent: QModelIndex): cint =
  fcQDirModel_rowCount(self.h, parent.h)

proc columnCount*(self: gen_qdirmodel_types.QDirModel, parent: QModelIndex): cint =
  fcQDirModel_columnCount(self.h, parent.h)

proc data*(self: gen_qdirmodel_types.QDirModel, index: QModelIndex, role: cint): QVariant =
  QVariant(h: fcQDirModel_data(self.h, index.h, role))

proc setData*(self: gen_qdirmodel_types.QDirModel, index: QModelIndex, value: QVariant, role: cint): bool =
  fcQDirModel_setData(self.h, index.h, value.h, role)

proc headerData*(self: gen_qdirmodel_types.QDirModel, section: cint, orientation: cint, role: cint): QVariant =
  QVariant(h: fcQDirModel_headerData(self.h, section, cint(orientation), role))

proc hasChildren*(self: gen_qdirmodel_types.QDirModel, index: QModelIndex): bool =
  fcQDirModel_hasChildren(self.h, index.h)

proc flags*(self: gen_qdirmodel_types.QDirModel, index: QModelIndex): cint =
...
proc mimeData*(self: gen_qdirmodel_types.QDirModel, indexes: seq[QModelIndex]): QMimeData =
  var indexes_CArray = newSeq[pointer](len(indexes))
  for i in 0..<len(indexes):
    indexes_CArray[i] = indexes[i].h

  QMimeData(h: fcQDirModel_mimeData(self.h, struct_miqt_array(len: csize_t(len(indexes)), data: if len(indexes) == 0: nil else: addr(indexes_CArray[0]))))

proc dropMimeData*(self: gen_qdirmodel_types.QDirModel, data: QMimeData, action: cint, row: cint, column: cint, parent: QModelIndex): bool =
...
proc setIconProvider*(self: gen_qdirmodel_types.QDirModel, provider: QFileIconProvider): void =
  fcQDirModel_setIconProvider(self.h, provider.h)

proc iconProvider*(self: gen_qdirmodel_types.QDirModel, ): QFileIconProvider =
  QFileIconProvider(h: fcQDirModel_iconProvider(self.h))
...
proc index*(self: gen_qdirmodel_types.QDirModel, path: string): QModelIndex =
  QModelIndex(h: fcQDirModel_indexWithPath(self.h, struct_miqt_string(data: path, len: csize_t(len(path)))))

proc isDir*(self: gen_qdirmodel_types.QDirModel, index: QModelIndex): bool =
  fcQDirModel_isDir(self.h, index.h)

proc mkdir*(self: gen_qdirmodel_types.QDirModel, parent: QModelIndex, name: string): QModelIndex =
  QModelIndex(h: fcQDirModel_mkdir(self.h, parent.h, struct_miqt_string(data: name, len: csize_t(len(name)))))

proc rmdir*(self: gen_qdirmodel_types.QDirModel, index: QModelIndex): bool =
  fcQDirModel_rmdir(self.h, index.h)

proc remove*(self: gen_qdirmodel_types.QDirModel, index: QModelIndex): bool =
  fcQDirModel_remove(self.h, index.h)

proc filePath*(self: gen_qdirmodel_types.QDirModel, index: QModelIndex): string =
  let v_ms = fcQDirModel_filePath(self.h, index.h)
  let vx_ret = string.fromBytes(toOpenArrayByte(v_ms.data, 0, int(v_ms.len)-1))
  c_free(v_ms.data)
  vx_ret

proc fileName*(self: gen_qdirmodel_types.QDirModel, index: QModelIndex): string =
  let v_ms = fcQDirModel_fileName(self.h, index.h)
  let vx_ret = string.fromBytes(toOpenArrayByte(v_ms.data, 0, int(v_ms.len)-1))
  c_free(v_ms.data)
  vx_ret

proc fileIcon*(self: gen_qdirmodel_types.QDirModel, index: QModelIndex): QIcon =
  QIcon(h: fcQDirModel_fileIcon(self.h, index.h))

proc fileInfo*(self: gen_qdirmodel_types.QDirModel, index: QModelIndex): QFileInfo =
  QFileInfo(h: fcQDirModel_fileInfo(self.h, index.h))
...
proc index*(self: gen_qdirmodel_types.QDirModel, path: string, column: cint): QModelIndex =
  QModelIndex(h: fcQDirModel_index2(self.h, struct_miqt_string(data: path, len: csize_t(len(path))), column))

proc refresh*(self: gen_qdirmodel_types.QDirModel, parent: QModelIndex): void =
...
proc miqt_exec_callback_QDirModel_metacall(self: ptr cQDirModel, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QDirModel_metacall ".} =
  ...
  virtualReturn
proc QDirModelindex*(self: gen_qdirmodel_types.QDirModel, row: cint, column: cint, parent: QModelIndex): QModelIndex =
  QModelIndex(h: fQDirModel_virtualbase_index(self.h, row, column, parent.h))

type QDirModelindexProc* = proc(row: cint, column: cint, parent: QModelIndex): QModelIndex
...
proc miqt_exec_callback_QDirModel_index(self: ptr cQDirModel, slot: int, row: cint, column: cint, parent: pointer): pointer {.exportc: "miqt_exec_callback_QDirModel_index ".} =
  ...
  virtualReturn.h
proc QDirModelparent*(self: gen_qdirmodel_types.QDirModel, child: QModelIndex): QModelIndex =
  QModelIndex(h: fQDirModel_virtualbase_parent(self.h, child.h))

type QDirModelparentProc* = proc(child: QModelIndex): QModelIndex
...
proc miqt_exec_callback_QDirModel_parent(self: ptr cQDirModel, slot: int, child: pointer): pointer {.exportc: "miqt_exec_callback_QDirModel_parent ".} =
  ...
  virtualReturn.h
proc QDirModelrowCount*(self: gen_qdirmodel_types.QDirModel, parent: QModelIndex): cint =
  fQDirModel_virtualbase_rowCount(self.h, parent.h)

type QDirModelrowCountProc* = proc(parent: QModelIndex): cint
...
proc miqt_exec_callback_QDirModel_rowCount(self: ptr cQDirModel, slot: int, parent: pointer): cint {.exportc: "miqt_exec_callback_QDirModel_rowCount ".} =
  ...
  virtualReturn
proc QDirModelcolumnCount*(self: gen_qdirmodel_types.QDirModel, parent: QModelIndex): cint =
  fQDirModel_virtualbase_columnCount(self.h, parent.h)

type QDirModelcolumnCountProc* = proc(parent: QModelIndex): cint
...
proc miqt_exec_callback_QDirModel_columnCount(self: ptr cQDirModel, slot: int, parent: pointer): cint {.exportc: "miqt_exec_callback_QDirModel_columnCount ".} =
  ...
  virtualReturn
proc QDirModeldata*(self: gen_qdirmodel_types.QDirModel, index: QModelIndex, role: cint): QVariant =
  QVariant(h: fQDirModel_virtualbase_data(self.h, index.h, role))

type QDirModeldataProc* = proc(index: QModelIndex, role: cint): QVariant
...
proc miqt_exec_callback_QDirModel_data(self: ptr cQDirModel, slot: int, index: pointer, role: cint): pointer {.exportc: "miqt_exec_callback_QDirModel_data ".} =
  ...
  virtualReturn.h
proc QDirModelsetData*(self: gen_qdirmodel_types.QDirModel, index: QModelIndex, value: QVariant, role: cint): bool =
  fQDirModel_virtualbase_setData(self.h, index.h, value.h, role)

type QDirModelsetDataProc* = proc(index: QModelIndex, value: QVariant, role: cint): bool
...
proc miqt_exec_callback_QDirModel_setData(self: ptr cQDirModel, slot: int, index: pointer, value: pointer, role: cint): bool {.exportc: "miqt_exec_callback_QDirModel_setData ".} =
  ...
  virtualReturn
proc QDirModelheaderData*(self: gen_qdirmodel_types.QDirModel, section: cint, orientation: cint, role: cint): QVariant =
  QVariant(h: fQDirModel_virtualbase_headerData(self.h, section, cint(orientation), role))

type QDirModelheaderDataProc* = proc(section: cint, orientation: cint, role: cint): QVariant
...
proc miqt_exec_callback_QDirModel_headerData(self: ptr cQDirModel, slot: int, section: cint, orientation: cint, role: cint): pointer {.exportc: "miqt_exec_callback_QDirModel_headerData ".} =
  ...
  virtualReturn.h
proc QDirModelhasChildren*(self: gen_qdirmodel_types.QDirModel, index: QModelIndex): bool =
  fQDirModel_virtualbase_hasChildren(self.h, index.h)

type QDirModelhasChildrenProc* = proc(index: QModelIndex): bool
...
proc miqt_exec_callback_QDirModel_hasChildren(self: ptr cQDirModel, slot: int, index: pointer): bool {.exportc: "miqt_exec_callback_QDirModel_hasChildren ".} =
  ...
  virtualReturn
proc QDirModelflags*(self: gen_qdirmodel_types.QDirModel, index: QModelIndex): cint =
  cint(fQDirModel_virtualbase_flags(self.h, index.h))

type QDirModelflagsProc* = proc(index: QModelIndex): cint
...
proc QDirModelmimeData*(self: gen_qdirmodel_types.QDirModel, indexes: seq[QModelIndex]): QMimeData =
  var indexes_CArray = newSeq[pointer](len(indexes))
  for i in 0..<len(indexes):
    indexes_CArray[i] = indexes[i].h

  QMimeData(h: fQDirModel_virtualbase_mimeData(self.h, struct_miqt_array(len: csize_t(len(indexes)), data: if len(indexes) == 0: nil else: addr(indexes_CArray[0]))))

type QDirModelmimeDataProc* = proc(indexes: seq[QModelIndex]): QMimeData
...
proc miqt_exec_callback_QDirModel_mimeData(self: ptr cQDirModel, slot: int, indexes: struct_miqt_array): pointer {.exportc: "miqt_exec_callback_QDirModel_mimeData ".} =
  ...
  virtualReturn.h
proc QDirModeldropMimeData*(self: gen_qdirmodel_types.QDirModel, data: QMimeData, action: cint, row: cint, column: cint, parent: QModelIndex): bool =
  fQDirModel_virtualbase_dropMimeData(self.h, data.h, cint(action), row, column, parent.h)

type QDirModeldropMimeDataProc* = proc(data: QMimeData, action: cint, row: cint, column: cint, parent: QModelIndex): bool
...
proc miqt_exec_callback_QDirModel_supportedDropActions(self: ptr cQDirModel, slot: int): cint {.exportc: "miqt_exec_callback_QDirModel_supportedDropActions ".} =
  ...
  cint(virtualReturn)
proc QDirModelsibling*(self: gen_qdirmodel_types.QDirModel, row: cint, column: cint, idx: QModelIndex): QModelIndex =
  QModelIndex(h: fQDirModel_virtualbase_sibling(self.h, row, column, idx.h))

type QDirModelsiblingProc* = proc(row: cint, column: cint, idx: QModelIndex): QModelIndex
...
proc miqt_exec_callback_QDirModel_sibling(self: ptr cQDirModel, slot: int, row: cint, column: cint, idx: pointer): pointer {.exportc: "miqt_exec_callback_QDirModel_sibling ".} =
  ...
  virtualReturn.h
proc QDirModelsetHeaderData*(self: gen_qdirmodel_types.QDirModel, section: cint, orientation: cint, value: QVariant, role: cint): bool =
  fQDirModel_virtualbase_setHeaderData(self.h, section, cint(orientation), value.h, role)

type QDirModelsetHeaderDataProc* = proc(section: cint, orientation: cint, value: QVariant, role: cint): bool
...
proc miqt_exec_callback_QDirModel_setHeaderData(self: ptr cQDirModel, slot: int, section: cint, orientation: cint, value: pointer, role: cint): bool {.exportc: "miqt_exec_callback_QDirModel_setHeaderData ".} =
  ...
  virtualReturn
proc QDirModelitemData*(self: gen_qdirmodel_types.QDirModel, index: QModelIndex): Table[cint,QVariant] =
...
type QDirModelitemDataProc* = proc(index: QModelIndex): Table[cint,QVariant]
...
proc QDirModelsetItemData*(self: gen_qdirmodel_types.QDirModel, index: QModelIndex, roles: Table[cint,QVariant]): bool =
...
type QDirModelsetItemDataProc* = proc(index: QModelIndex, roles: Table[cint,QVariant]): bool
...
proc miqt_exec_callback_QDirModel_setItemData(self: ptr cQDirModel, slot: int, index: pointer, roles: struct_miqt_map): bool {.exportc: "miqt_exec_callback_QDirModel_setItemData ".} =
  ...
  virtualReturn
proc QDirModelcanDropMimeData*(self: gen_qdirmodel_types.QDirModel, data: QMimeData, action: cint, row: cint, column: cint, parent: QModelIndex): bool =
  fQDirModel_virtualbase_canDropMimeData(self.h, data.h, cint(action), row, column, parent.h)

type QDirModelcanDropMimeDataProc* = proc(data: QMimeData, action: cint, row: cint, column: cint, parent: QModelIndex): bool
...
proc miqt_exec_callback_QDirModel_supportedDragActions(self: ptr cQDirModel, slot: int): cint {.exportc: "miqt_exec_callback_QDirModel_supportedDragActions ".} =
  ...
  cint(virtualReturn)
proc QDirModelinsertRows*(self: gen_qdirmodel_types.QDirModel, row: cint, count: cint, parent: QModelIndex): bool =
  fQDirModel_virtualbase_insertRows(self.h, row, count, parent.h)

type QDirModelinsertRowsProc* = proc(row: cint, count: cint, parent: QModelIndex): bool
...
proc miqt_exec_callback_QDirModel_insertRows(self: ptr cQDirModel, slot: int, row: cint, count: cint, parent: pointer): bool {.exportc: "miqt_exec_callback_QDirModel_insertRows ".} =
  ...
  virtualReturn
proc QDirModelinsertColumns*(self: gen_qdirmodel_types.QDirModel, column: cint, count: cint, parent: QModelIndex): bool =
  fQDirModel_virtualbase_insertColumns(self.h, column, count, parent.h)

type QDirModelinsertColumnsProc* = proc(column: cint, count: cint, parent: QModelIndex): bool
...
proc miqt_exec_callback_QDirModel_insertColumns(self: ptr cQDirModel, slot: int, column: cint, count: cint, parent: pointer): bool {.exportc: "miqt_exec_callback_QDirModel_insertColumns ".} =
  ...
  virtualReturn
proc QDirModelremoveRows*(self: gen_qdirmodel_types.QDirModel, row: cint, count: cint, parent: QModelIndex): bool =
  fQDirModel_virtualbase_removeRows(self.h, row, count, parent.h)

type QDirModelremoveRowsProc* = proc(row: cint, count: cint, parent: QModelIndex): bool
...
proc miqt_exec_callback_QDirModel_removeRows(self: ptr cQDirModel, slot: int, row: cint, count: cint, parent: pointer): bool {.exportc: "miqt_exec_callback_QDirModel_removeRows ".} =
  ...
  virtualReturn
proc QDirModelremoveColumns*(self: gen_qdirmodel_types.QDirModel, column: cint, count: cint, parent: QModelIndex): bool =
  fQDirModel_virtualbase_removeColumns(self.h, column, count, parent.h)

type QDirModelremoveColumnsProc* = proc(column: cint, count: cint, parent: QModelIndex): bool
...
proc miqt_exec_callback_QDirModel_removeColumns(self: ptr cQDirModel, slot: int, column: cint, count: cint, parent: pointer): bool {.exportc: "miqt_exec_callback_QDirModel_removeColumns ".} =
  ...
  virtualReturn
proc QDirModelmoveRows*(self: gen_qdirmodel_types.QDirModel, sourceParent: QModelIndex, sourceRow: cint, count: cint, destinationParent: QModelIndex, destinationChild: cint): bool =
  fQDirModel_virtualbase_moveRows(self.h, sourceParent.h, sourceRow, count, destinationParent.h, destinationChild)

type QDirModelmoveRowsProc* = proc(sourceParent: QModelIndex, sourceRow: cint, count: cint, destinationParent: QModelIndex, destinationChild: cint): bool
...
proc miqt_exec_callback_QDirModel_moveRows(self: ptr cQDirModel, slot: int, sourceParent: pointer, sourceRow: cint, count: cint, destinationParent: pointer, destinationChild: cint): bool {.exportc: "miqt_exec_callback_QDirModel_moveRows ".} =
  ...
  virtualReturn
proc QDirModelmoveColumns*(self: gen_qdirmodel_types.QDirModel, sourceParent: QModelIndex, sourceColumn: cint, count: cint, destinationParent: QModelIndex, destinationChild: cint): bool =
  fQDirModel_virtualbase_moveColumns(self.h, sourceParent.h, sourceColumn, count, destinationParent.h, destinationChild)

type QDirModelmoveColumnsProc* = proc(sourceParent: QModelIndex, sourceColumn: cint, count: cint, destinationParent: QModelIndex, destinationChild: cint): bool
...
proc miqt_exec_callback_QDirModel_moveColumns(self: ptr cQDirModel, slot: int, sourceParent: pointer, sourceColumn: cint, count: cint, destinationParent: pointer, destinationChild: cint): bool {.exportc: "miqt_exec_callback_QDirModel_moveColumns ".} =
  ...
  virtualReturn
proc QDirModelfetchMore*(self: gen_qdirmodel_types.QDirModel, parent: QModelIndex): void =
  fQDirModel_virtualbase_fetchMore(self.h, parent.h)

type QDirModelfetchMoreProc* = proc(parent: QModelIndex): void
...
proc miqt_exec_callback_QDirModel_fetchMore(self: ptr cQDirModel, slot: int, parent: pointer): void {.exportc: "miqt_exec_callback_QDirModel_fetchMore ".} =
  ...
  nimfunc[](slotval1)
proc QDirModelcanFetchMore*(self: gen_qdirmodel_types.QDirModel, parent: QModelIndex): bool =
  fQDirModel_virtualbase_canFetchMore(self.h, parent.h)

type QDirModelcanFetchMoreProc* = proc(parent: QModelIndex): bool
...
proc miqt_exec_callback_QDirModel_canFetchMore(self: ptr cQDirModel, slot: int, parent: pointer): bool {.exportc: "miqt_exec_callback_QDirModel_canFetchMore ".} =
  ...
  virtualReturn
proc QDirModelbuddy*(self: gen_qdirmodel_types.QDirModel, index: QModelIndex): QModelIndex =
  QModelIndex(h: fQDirModel_virtualbase_buddy(self.h, index.h))

type QDirModelbuddyProc* = proc(index: QModelIndex): QModelIndex
...
proc miqt_exec_callback_QDirModel_buddy(self: ptr cQDirModel, slot: int, index: pointer): pointer {.exportc: "miqt_exec_callback_QDirModel_buddy ".} =
  ...
  virtualReturn.h
proc QDirModelmatch*(self: gen_qdirmodel_types.QDirModel, start: QModelIndex, role: cint, value: QVariant, hits: cint, flags: cint): seq[QModelIndex] =
...
type QDirModelmatchProc* = proc(start: QModelIndex, role: cint, value: QVariant, hits: cint, flags: cint): seq[QModelIndex]
...
proc miqt_exec_callback_QDirModel_match(self: ptr cQDirModel, slot: int, start: pointer, role: cint, value: pointer, hits: cint, flags: cint): struct_miqt_array {.exportc: "miqt_exec_callback_QDirModel_match ".} =
  ...
  struct_miqt_array(len: csize_t(len(virtualReturn)), data: if len(virtualReturn) == 0: nil else: addr(virtualReturn_CArray[0]))
proc QDirModelspan*(self: gen_qdirmodel_types.QDirModel, index: QModelIndex): QSize =
  QSize(h: fQDirModel_virtualbase_span(self.h, index.h))

type QDirModelspanProc* = proc(index: QModelIndex): QSize
...
proc miqt_exec_callback_QDirModel_revert(self: ptr cQDirModel, slot: int): void {.exportc: "miqt_exec_callback_QDirModel_revert ".} =
  ...
  nimfunc[]()
proc QDirModelevent*(self: gen_qdirmodel_types.QDirModel, event: QEvent): bool =
  fQDirModel_virtualbase_event(self.h, event.h)

type QDirModeleventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QDirModel_event(self: ptr cQDirModel, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QDirModel_event ".} =
  ...
  virtualReturn
proc QDirModeleventFilter*(self: gen_qdirmodel_types.QDirModel, watched: QObject, event: QEvent): bool =
  fQDirModel_virtualbase_eventFilter(self.h, watched.h, event.h)

type QDirModeleventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QDirModel_eventFilter(self: ptr cQDirModel, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QDirModel_eventFilter ".} =
  ...
  virtualReturn
proc QDirModeltimerEvent*(self: gen_qdirmodel_types.QDirModel, event: QTimerEvent): void =
  fQDirModel_virtualbase_timerEvent(self.h, event.h)

type QDirModeltimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QDirModel_timerEvent(self: ptr cQDirModel, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QDirModel_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QDirModelchildEvent*(self: gen_qdirmodel_types.QDirModel, event: QChildEvent): void =
  fQDirModel_virtualbase_childEvent(self.h, event.h)

type QDirModelchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QDirModel_childEvent(self: ptr cQDirModel, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QDirModel_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QDirModelcustomEvent*(self: gen_qdirmodel_types.QDirModel, event: QEvent): void =
  fQDirModel_virtualbase_customEvent(self.h, event.h)

type QDirModelcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QDirModel_customEvent(self: ptr cQDirModel, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QDirModel_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QDirModelconnectNotify*(self: gen_qdirmodel_types.QDirModel, signal: QMetaMethod): void =
  fQDirModel_virtualbase_connectNotify(self.h, signal.h)

type QDirModelconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QDirModel_connectNotify(self: ptr cQDirModel, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QDirModel_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QDirModeldisconnectNotify*(self: gen_qdirmodel_types.QDirModel, signal: QMetaMethod): void =
  fQDirModel_virtualbase_disconnectNotify(self.h, signal.h)

type QDirModeldisconnectNotifyProc* = proc(signal: QMetaMethod): void
