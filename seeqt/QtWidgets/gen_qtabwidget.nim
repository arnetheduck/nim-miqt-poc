...
func init*(T: type gen_qtabwidget_types.QTabWidget, h: ptr cQTabWidget): gen_qtabwidget_types.QTabWidget =
  T(h: h)
proc create*(T: type gen_qtabwidget_types.QTabWidget, parent: QWidget): gen_qtabwidget_types.QTabWidget =
...
proc metaObject*(self: gen_qtabwidget_types.QTabWidget, ): QMetaObject =
  QMetaObject(h: fcQTabWidget_metaObject(self.h))
...
proc addTab*(self: gen_qtabwidget_types.QTabWidget, widget: QWidget, param2: string): cint =
  fcQTabWidget_addTab(self.h, widget.h, struct_miqt_string(data: param2, len: csize_t(len(param2))))

proc addTab*(self: gen_qtabwidget_types.QTabWidget, widget: QWidget, icon: QIcon, label: string): cint =
  fcQTabWidget_addTab2(self.h, widget.h, icon.h, struct_miqt_string(data: label, len: csize_t(len(label))))

proc insertTab*(self: gen_qtabwidget_types.QTabWidget, index: cint, widget: QWidget, param3: string): cint =
  fcQTabWidget_insertTab(self.h, index, widget.h, struct_miqt_string(data: param3, len: csize_t(len(param3))))

proc insertTab*(self: gen_qtabwidget_types.QTabWidget, index: cint, widget: QWidget, icon: QIcon, label: string): cint =
...
proc tabIcon*(self: gen_qtabwidget_types.QTabWidget, index: cint): QIcon =
  QIcon(h: fcQTabWidget_tabIcon(self.h, index))

proc setTabIcon*(self: gen_qtabwidget_types.QTabWidget, index: cint, icon: QIcon): void =
...
proc currentWidget*(self: gen_qtabwidget_types.QTabWidget, ): QWidget =
  QWidget(h: fcQTabWidget_currentWidget(self.h))

proc widget*(self: gen_qtabwidget_types.QTabWidget, index: cint): QWidget =
  QWidget(h: fcQTabWidget_widget(self.h, index))

proc indexOf*(self: gen_qtabwidget_types.QTabWidget, widget: QWidget): cint =
...
proc sizeHint*(self: gen_qtabwidget_types.QTabWidget, ): QSize =
  QSize(h: fcQTabWidget_sizeHint(self.h))

proc minimumSizeHint*(self: gen_qtabwidget_types.QTabWidget, ): QSize =
  QSize(h: fcQTabWidget_minimumSizeHint(self.h))
...
proc setCornerWidget*(self: gen_qtabwidget_types.QTabWidget, w: QWidget): void =
  fcQTabWidget_setCornerWidget(self.h, w.h)

proc cornerWidget*(self: gen_qtabwidget_types.QTabWidget, ): QWidget =
  QWidget(h: fcQTabWidget_cornerWidget(self.h))
...
proc iconSize*(self: gen_qtabwidget_types.QTabWidget, ): QSize =
  QSize(h: fcQTabWidget_iconSize(self.h))

proc setIconSize*(self: gen_qtabwidget_types.QTabWidget, size: QSize): void =
...
proc tabBar*(self: gen_qtabwidget_types.QTabWidget, ): QTabBar =
  QTabBar(h: fcQTabWidget_tabBar(self.h))

proc setCurrentIndex*(self: gen_qtabwidget_types.QTabWidget, index: cint): void =
  fcQTabWidget_setCurrentIndex(self.h, index)

proc setCurrentWidget*(self: gen_qtabwidget_types.QTabWidget, widget: QWidget): void =
...
proc setCornerWidget*(self: gen_qtabwidget_types.QTabWidget, w: QWidget, corner: cint): void =
  fcQTabWidget_setCornerWidget2(self.h, w.h, cint(corner))

proc cornerWidget*(self: gen_qtabwidget_types.QTabWidget, corner: cint): QWidget =
  QWidget(h: fcQTabWidget_cornerWidget1(self.h, cint(corner)))
...
proc miqt_exec_callback_QTabWidget_metacall(self: ptr cQTabWidget, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QTabWidget_metacall ".} =
  ...
  virtualReturn
proc QTabWidgetsizeHint*(self: gen_qtabwidget_types.QTabWidget, ): QSize =
  QSize(h: fQTabWidget_virtualbase_sizeHint(self.h))

type QTabWidgetsizeHintProc* = proc(): QSize
...
proc miqt_exec_callback_QTabWidget_sizeHint(self: ptr cQTabWidget, slot: int): pointer {.exportc: "miqt_exec_callback_QTabWidget_sizeHint ".} =
  ...
  virtualReturn.h
proc QTabWidgetminimumSizeHint*(self: gen_qtabwidget_types.QTabWidget, ): QSize =
  QSize(h: fQTabWidget_virtualbase_minimumSizeHint(self.h))

type QTabWidgetminimumSizeHintProc* = proc(): QSize
...
proc miqt_exec_callback_QTabWidget_tabRemoved(self: ptr cQTabWidget, slot: int, index: cint): void {.exportc: "miqt_exec_callback_QTabWidget_tabRemoved ".} =
  ...
  nimfunc[](slotval1)
proc QTabWidgetshowEvent*(self: gen_qtabwidget_types.QTabWidget, param1: QShowEvent): void =
  fQTabWidget_virtualbase_showEvent(self.h, param1.h)

type QTabWidgetshowEventProc* = proc(param1: QShowEvent): void
...
proc miqt_exec_callback_QTabWidget_showEvent(self: ptr cQTabWidget, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QTabWidget_showEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTabWidgetresizeEvent*(self: gen_qtabwidget_types.QTabWidget, param1: QResizeEvent): void =
  fQTabWidget_virtualbase_resizeEvent(self.h, param1.h)

type QTabWidgetresizeEventProc* = proc(param1: QResizeEvent): void
...
proc miqt_exec_callback_QTabWidget_resizeEvent(self: ptr cQTabWidget, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QTabWidget_resizeEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTabWidgetkeyPressEvent*(self: gen_qtabwidget_types.QTabWidget, param1: QKeyEvent): void =
  fQTabWidget_virtualbase_keyPressEvent(self.h, param1.h)

type QTabWidgetkeyPressEventProc* = proc(param1: QKeyEvent): void
...
proc miqt_exec_callback_QTabWidget_keyPressEvent(self: ptr cQTabWidget, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QTabWidget_keyPressEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTabWidgetpaintEvent*(self: gen_qtabwidget_types.QTabWidget, param1: QPaintEvent): void =
  fQTabWidget_virtualbase_paintEvent(self.h, param1.h)

type QTabWidgetpaintEventProc* = proc(param1: QPaintEvent): void
...
proc miqt_exec_callback_QTabWidget_paintEvent(self: ptr cQTabWidget, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QTabWidget_paintEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTabWidgetchangeEvent*(self: gen_qtabwidget_types.QTabWidget, param1: QEvent): void =
  fQTabWidget_virtualbase_changeEvent(self.h, param1.h)

type QTabWidgetchangeEventProc* = proc(param1: QEvent): void
...
proc miqt_exec_callback_QTabWidget_changeEvent(self: ptr cQTabWidget, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QTabWidget_changeEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTabWidgetevent*(self: gen_qtabwidget_types.QTabWidget, param1: QEvent): bool =
  fQTabWidget_virtualbase_event(self.h, param1.h)

type QTabWidgeteventProc* = proc(param1: QEvent): bool
...
proc miqt_exec_callback_QTabWidget_setVisible(self: ptr cQTabWidget, slot: int, visible: bool): void {.exportc: "miqt_exec_callback_QTabWidget_setVisible ".} =
  ...
  nimfunc[](slotval1)
proc QTabWidgetpaintEngine*(self: gen_qtabwidget_types.QTabWidget, ): QPaintEngine =
  QPaintEngine(h: fQTabWidget_virtualbase_paintEngine(self.h))

type QTabWidgetpaintEngineProc* = proc(): QPaintEngine
...
proc miqt_exec_callback_QTabWidget_paintEngine(self: ptr cQTabWidget, slot: int): pointer {.exportc: "miqt_exec_callback_QTabWidget_paintEngine ".} =
  ...
  virtualReturn.h
proc QTabWidgetmousePressEvent*(self: gen_qtabwidget_types.QTabWidget, event: QMouseEvent): void =
  fQTabWidget_virtualbase_mousePressEvent(self.h, event.h)

type QTabWidgetmousePressEventProc* = proc(event: QMouseEvent): void
...
proc miqt_exec_callback_QTabWidget_mousePressEvent(self: ptr cQTabWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTabWidget_mousePressEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTabWidgetmouseReleaseEvent*(self: gen_qtabwidget_types.QTabWidget, event: QMouseEvent): void =
  fQTabWidget_virtualbase_mouseReleaseEvent(self.h, event.h)

type QTabWidgetmouseReleaseEventProc* = proc(event: QMouseEvent): void
...
proc miqt_exec_callback_QTabWidget_mouseReleaseEvent(self: ptr cQTabWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTabWidget_mouseReleaseEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTabWidgetmouseDoubleClickEvent*(self: gen_qtabwidget_types.QTabWidget, event: QMouseEvent): void =
  fQTabWidget_virtualbase_mouseDoubleClickEvent(self.h, event.h)

type QTabWidgetmouseDoubleClickEventProc* = proc(event: QMouseEvent): void
...
proc miqt_exec_callback_QTabWidget_mouseDoubleClickEvent(self: ptr cQTabWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTabWidget_mouseDoubleClickEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTabWidgetmouseMoveEvent*(self: gen_qtabwidget_types.QTabWidget, event: QMouseEvent): void =
  fQTabWidget_virtualbase_mouseMoveEvent(self.h, event.h)

type QTabWidgetmouseMoveEventProc* = proc(event: QMouseEvent): void
...
proc miqt_exec_callback_QTabWidget_mouseMoveEvent(self: ptr cQTabWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTabWidget_mouseMoveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTabWidgetwheelEvent*(self: gen_qtabwidget_types.QTabWidget, event: QWheelEvent): void =
  fQTabWidget_virtualbase_wheelEvent(self.h, event.h)

type QTabWidgetwheelEventProc* = proc(event: QWheelEvent): void
...
proc miqt_exec_callback_QTabWidget_wheelEvent(self: ptr cQTabWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTabWidget_wheelEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTabWidgetkeyReleaseEvent*(self: gen_qtabwidget_types.QTabWidget, event: QKeyEvent): void =
  fQTabWidget_virtualbase_keyReleaseEvent(self.h, event.h)

type QTabWidgetkeyReleaseEventProc* = proc(event: QKeyEvent): void
...
proc miqt_exec_callback_QTabWidget_keyReleaseEvent(self: ptr cQTabWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTabWidget_keyReleaseEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTabWidgetfocusInEvent*(self: gen_qtabwidget_types.QTabWidget, event: QFocusEvent): void =
  fQTabWidget_virtualbase_focusInEvent(self.h, event.h)

type QTabWidgetfocusInEventProc* = proc(event: QFocusEvent): void
...
proc miqt_exec_callback_QTabWidget_focusInEvent(self: ptr cQTabWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTabWidget_focusInEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTabWidgetfocusOutEvent*(self: gen_qtabwidget_types.QTabWidget, event: QFocusEvent): void =
  fQTabWidget_virtualbase_focusOutEvent(self.h, event.h)

type QTabWidgetfocusOutEventProc* = proc(event: QFocusEvent): void
...
proc miqt_exec_callback_QTabWidget_focusOutEvent(self: ptr cQTabWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTabWidget_focusOutEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTabWidgetenterEvent*(self: gen_qtabwidget_types.QTabWidget, event: QEvent): void =
  fQTabWidget_virtualbase_enterEvent(self.h, event.h)

type QTabWidgetenterEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QTabWidget_enterEvent(self: ptr cQTabWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTabWidget_enterEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTabWidgetleaveEvent*(self: gen_qtabwidget_types.QTabWidget, event: QEvent): void =
  fQTabWidget_virtualbase_leaveEvent(self.h, event.h)

type QTabWidgetleaveEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QTabWidget_leaveEvent(self: ptr cQTabWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTabWidget_leaveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTabWidgetmoveEvent*(self: gen_qtabwidget_types.QTabWidget, event: QMoveEvent): void =
  fQTabWidget_virtualbase_moveEvent(self.h, event.h)

type QTabWidgetmoveEventProc* = proc(event: QMoveEvent): void
...
proc miqt_exec_callback_QTabWidget_moveEvent(self: ptr cQTabWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTabWidget_moveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTabWidgetcloseEvent*(self: gen_qtabwidget_types.QTabWidget, event: QCloseEvent): void =
  fQTabWidget_virtualbase_closeEvent(self.h, event.h)

type QTabWidgetcloseEventProc* = proc(event: QCloseEvent): void
...
proc miqt_exec_callback_QTabWidget_closeEvent(self: ptr cQTabWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTabWidget_closeEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTabWidgetcontextMenuEvent*(self: gen_qtabwidget_types.QTabWidget, event: QContextMenuEvent): void =
  fQTabWidget_virtualbase_contextMenuEvent(self.h, event.h)

type QTabWidgetcontextMenuEventProc* = proc(event: QContextMenuEvent): void
...
proc miqt_exec_callback_QTabWidget_contextMenuEvent(self: ptr cQTabWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTabWidget_contextMenuEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTabWidgettabletEvent*(self: gen_qtabwidget_types.QTabWidget, event: QTabletEvent): void =
  fQTabWidget_virtualbase_tabletEvent(self.h, event.h)

type QTabWidgettabletEventProc* = proc(event: QTabletEvent): void
...
proc miqt_exec_callback_QTabWidget_tabletEvent(self: ptr cQTabWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTabWidget_tabletEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTabWidgetactionEvent*(self: gen_qtabwidget_types.QTabWidget, event: QActionEvent): void =
  fQTabWidget_virtualbase_actionEvent(self.h, event.h)

type QTabWidgetactionEventProc* = proc(event: QActionEvent): void
...
proc miqt_exec_callback_QTabWidget_actionEvent(self: ptr cQTabWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTabWidget_actionEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTabWidgetdragEnterEvent*(self: gen_qtabwidget_types.QTabWidget, event: QDragEnterEvent): void =
  fQTabWidget_virtualbase_dragEnterEvent(self.h, event.h)

type QTabWidgetdragEnterEventProc* = proc(event: QDragEnterEvent): void
...
proc miqt_exec_callback_QTabWidget_dragEnterEvent(self: ptr cQTabWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTabWidget_dragEnterEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTabWidgetdragMoveEvent*(self: gen_qtabwidget_types.QTabWidget, event: QDragMoveEvent): void =
  fQTabWidget_virtualbase_dragMoveEvent(self.h, event.h)

type QTabWidgetdragMoveEventProc* = proc(event: QDragMoveEvent): void
...
proc miqt_exec_callback_QTabWidget_dragMoveEvent(self: ptr cQTabWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTabWidget_dragMoveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTabWidgetdragLeaveEvent*(self: gen_qtabwidget_types.QTabWidget, event: QDragLeaveEvent): void =
  fQTabWidget_virtualbase_dragLeaveEvent(self.h, event.h)

type QTabWidgetdragLeaveEventProc* = proc(event: QDragLeaveEvent): void
...
proc miqt_exec_callback_QTabWidget_dragLeaveEvent(self: ptr cQTabWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTabWidget_dragLeaveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTabWidgetdropEvent*(self: gen_qtabwidget_types.QTabWidget, event: QDropEvent): void =
  fQTabWidget_virtualbase_dropEvent(self.h, event.h)

type QTabWidgetdropEventProc* = proc(event: QDropEvent): void
...
proc miqt_exec_callback_QTabWidget_dropEvent(self: ptr cQTabWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTabWidget_dropEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTabWidgethideEvent*(self: gen_qtabwidget_types.QTabWidget, event: QHideEvent): void =
  fQTabWidget_virtualbase_hideEvent(self.h, event.h)

type QTabWidgethideEventProc* = proc(event: QHideEvent): void
...
proc miqt_exec_callback_QTabWidget_metric(self: ptr cQTabWidget, slot: int, param1: cint): cint {.exportc: "miqt_exec_callback_QTabWidget_metric ".} =
  ...
  virtualReturn
proc QTabWidgetinitPainter*(self: gen_qtabwidget_types.QTabWidget, painter: QPainter): void =
  fQTabWidget_virtualbase_initPainter(self.h, painter.h)

type QTabWidgetinitPainterProc* = proc(painter: QPainter): void
...
proc miqt_exec_callback_QTabWidget_initPainter(self: ptr cQTabWidget, slot: int, painter: pointer): void {.exportc: "miqt_exec_callback_QTabWidget_initPainter ".} =
  ...
  nimfunc[](slotval1)
proc QTabWidgetredirected*(self: gen_qtabwidget_types.QTabWidget, offset: QPoint): QPaintDevice =
  QPaintDevice(h: fQTabWidget_virtualbase_redirected(self.h, offset.h))

type QTabWidgetredirectedProc* = proc(offset: QPoint): QPaintDevice
...
proc miqt_exec_callback_QTabWidget_redirected(self: ptr cQTabWidget, slot: int, offset: pointer): pointer {.exportc: "miqt_exec_callback_QTabWidget_redirected ".} =
  ...
  virtualReturn.h
proc QTabWidgetsharedPainter*(self: gen_qtabwidget_types.QTabWidget, ): QPainter =
  QPainter(h: fQTabWidget_virtualbase_sharedPainter(self.h))

type QTabWidgetsharedPainterProc* = proc(): QPainter
...
proc miqt_exec_callback_QTabWidget_sharedPainter(self: ptr cQTabWidget, slot: int): pointer {.exportc: "miqt_exec_callback_QTabWidget_sharedPainter ".} =
  ...
  virtualReturn.h
proc QTabWidgetinputMethodEvent*(self: gen_qtabwidget_types.QTabWidget, param1: QInputMethodEvent): void =
  fQTabWidget_virtualbase_inputMethodEvent(self.h, param1.h)

type QTabWidgetinputMethodEventProc* = proc(param1: QInputMethodEvent): void
...
proc miqt_exec_callback_QTabWidget_inputMethodEvent(self: ptr cQTabWidget, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QTabWidget_inputMethodEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTabWidgetinputMethodQuery*(self: gen_qtabwidget_types.QTabWidget, param1: cint): QVariant =
  QVariant(h: fQTabWidget_virtualbase_inputMethodQuery(self.h, cint(param1)))

type QTabWidgetinputMethodQueryProc* = proc(param1: cint): QVariant
...
proc miqt_exec_callback_QTabWidget_focusNextPrevChild(self: ptr cQTabWidget, slot: int, next: bool): bool {.exportc: "miqt_exec_callback_QTabWidget_focusNextPrevChild ".} =
  ...
  virtualReturn
proc QTabWidgeteventFilter*(self: gen_qtabwidget_types.QTabWidget, watched: QObject, event: QEvent): bool =
  fQTabWidget_virtualbase_eventFilter(self.h, watched.h, event.h)

type QTabWidgeteventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QTabWidget_eventFilter(self: ptr cQTabWidget, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QTabWidget_eventFilter ".} =
  ...
  virtualReturn
proc QTabWidgettimerEvent*(self: gen_qtabwidget_types.QTabWidget, event: QTimerEvent): void =
  fQTabWidget_virtualbase_timerEvent(self.h, event.h)

type QTabWidgettimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QTabWidget_timerEvent(self: ptr cQTabWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTabWidget_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTabWidgetchildEvent*(self: gen_qtabwidget_types.QTabWidget, event: QChildEvent): void =
  fQTabWidget_virtualbase_childEvent(self.h, event.h)

type QTabWidgetchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QTabWidget_childEvent(self: ptr cQTabWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTabWidget_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTabWidgetcustomEvent*(self: gen_qtabwidget_types.QTabWidget, event: QEvent): void =
  fQTabWidget_virtualbase_customEvent(self.h, event.h)

type QTabWidgetcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QTabWidget_customEvent(self: ptr cQTabWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTabWidget_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTabWidgetconnectNotify*(self: gen_qtabwidget_types.QTabWidget, signal: QMetaMethod): void =
  fQTabWidget_virtualbase_connectNotify(self.h, signal.h)

type QTabWidgetconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QTabWidget_connectNotify(self: ptr cQTabWidget, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QTabWidget_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QTabWidgetdisconnectNotify*(self: gen_qtabwidget_types.QTabWidget, signal: QMetaMethod): void =
  fQTabWidget_virtualbase_disconnectNotify(self.h, signal.h)

type QTabWidgetdisconnectNotifyProc* = proc(signal: QMetaMethod): void
