...
void QSplashScreen_connect_messageChanged(QSplashScreen* self, intptr_t slot, void (*callback)(intptr_t, struct miqt_string), void (*release)(intptr_t)) {
	...
	MiqtVirtualQSplashScreen::connect(self, static_cast<void (QSplashScreen::*)(const QString&)>(&QSplashScreen::messageChanged), self, caller{slot, callback, release});
}
...
QMetaObject* QSplashScreen_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQSplashScreen*)(self) )->QSplashScreen::metaObject();

}

void* QSplashScreen_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQSplashScreen*)(self) )->QSplashScreen::qt_metacast(param1);

}

int QSplashScreen_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQSplashScreen*)(self) )->QSplashScreen::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
bool QSplashScreen_virtualbase_nativeEvent(void* self, struct miqt_string eventType, void* message, long* result) {
	...
	return ( (MiqtVirtualQSplashScreen*)(self) )->QSplashScreen::nativeEvent(eventType_QByteArray, message, static_cast<long*>(result));
...
void QSplashScreen_protectedbase_updateMicroFocus(void* self) {
	MiqtVirtualQSplashScreen* self_cast = static_cast<MiqtVirtualQSplashScreen*>( (QSplashScreen*)(self) );
