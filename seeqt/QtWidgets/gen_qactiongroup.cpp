...
QMetaObject* QActionGroup_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQActionGroup*)(self) )->QActionGroup::metaObject();

}

void* QActionGroup_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQActionGroup*)(self) )->QActionGroup::qt_metacast(param1);

}

int QActionGroup_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQActionGroup*)(self) )->QActionGroup::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
