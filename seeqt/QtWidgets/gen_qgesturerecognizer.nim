...
proc create*(self: gen_qgesturerecognizer_types.QGestureRecognizer, target: QObject): QGesture =
  QGesture(h: fcQGestureRecognizer_create(self.h, target.h))

proc recognize*(self: gen_qgesturerecognizer_types.QGestureRecognizer, state: QGesture, watched: QObject, event: QEvent): cint =
  cint(fcQGestureRecognizer_recognize(self.h, state.h, watched.h, event.h))

proc reset*(self: gen_qgesturerecognizer_types.QGestureRecognizer, state: QGesture): void =
  fcQGestureRecognizer_reset(self.h, state.h)

proc registerRecognizer*(_: type gen_qgesturerecognizer_types.QGestureRecognizer, recognizer: QGestureRecognizer): cint =
...
proc operatorAssign*(self: gen_qgesturerecognizer_types.QGestureRecognizer, param1: QGestureRecognizer): void =
  fcQGestureRecognizer_operatorAssign(self.h, param1.h)

proc QGestureRecognizercreate*(self: gen_qgesturerecognizer_types.QGestureRecognizer, target: QObject): QGesture =
  QGesture(h: fQGestureRecognizer_virtualbase_create(self.h, target.h))

type QGestureRecognizercreateProc* = proc(target: QObject): QGesture
...
proc miqt_exec_callback_QGestureRecognizer_create(self: ptr cQGestureRecognizer, slot: int, target: pointer): pointer {.exportc: "miqt_exec_callback_QGestureRecognizer_create ".} =
  ...
  let slotval1 = QObject(h: target)


  let virtualReturn = nimfunc[](slotval1 )

  virtualReturn.h
type QGestureRecognizerrecognizeProc* = proc(state: QGesture, watched: QObject, event: QEvent): cint
...
proc miqt_exec_callback_QGestureRecognizer_recognize(self: ptr cQGestureRecognizer, slot: int, state: pointer, watched: pointer, event: pointer): cint {.exportc: "miqt_exec_callback_QGestureRecognizer_recognize ".} =
  ...
  let slotval1 = QGesture(h: state)

  let slotval2 = QObject(h: watched)
  ...
  cint(virtualReturn)
proc QGestureRecognizerreset*(self: gen_qgesturerecognizer_types.QGestureRecognizer, state: QGesture): void =
  fQGestureRecognizer_virtualbase_reset(self.h, state.h)

type QGestureRecognizerresetProc* = proc(state: QGesture): void
