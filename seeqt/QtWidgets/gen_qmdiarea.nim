...
proc miqt_exec_callback_QMdiArea_focusOutEvent(self: ptr cQMdiArea, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QMdiArea_focusOutEvent ".} =
  ...
  nimfunc[](slotval1)
proc QMdiAreaenterEvent*(self: gen_qmdiarea_types.QMdiArea, event: QEvent): void =
  fQMdiArea_virtualbase_enterEvent(self.h, event.h)

type QMdiAreaenterEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QMdiArea_hideEvent(self: ptr cQMdiArea, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QMdiArea_hideEvent ".} =
  ...
  nimfunc[](slotval1)
proc QMdiAreanativeEvent*(self: gen_qmdiarea_types.QMdiArea, eventType: seq[byte], message: pointer, resultVal: ptr clong): bool =
...
type QMdiAreanativeEventProc* = proc(eventType: seq[byte], message: pointer, resultVal: ptr clong): bool
