...
void miqt_exec_callback_QButtonGroup_buttonClickedWithInt_release(intptr_t);
void miqt_exec_callback_QButtonGroup_buttonPressedWithInt(intptr_t, int);
void miqt_exec_callback_QButtonGroup_buttonPressedWithInt_release(intptr_t);
void miqt_exec_callback_QButtonGroup_buttonReleasedWithInt(intptr_t, int);
void miqt_exec_callback_QButtonGroup_buttonReleasedWithInt_release(intptr_t);
void miqt_exec_callback_QButtonGroup_buttonToggled2(intptr_t, int, bool);
void miqt_exec_callback_QButtonGroup_buttonToggled2_release(intptr_t);
#ifdef __cplusplus
} /* extern C */
#endif
...
void QButtonGroup_connect_buttonClickedWithInt(QButtonGroup* self, intptr_t slot) {
	struct caller {
		...
		caller(const caller &) = delete;
		caller &operator=(const caller &) = delete;
		~caller() { miqt_exec_callback_QButtonGroup_buttonClickedWithInt_release(slot); }
	};
	MiqtVirtualQButtonGroup::connect(self, static_cast<void (QButtonGroup::*)(int)>(&QButtonGroup::buttonClicked), self, caller{slot});
}
...
void QButtonGroup_connect_buttonPressedWithInt(QButtonGroup* self, intptr_t slot) {
	struct caller {
		...
		caller(const caller &) = delete;
		caller &operator=(const caller &) = delete;
		~caller() { miqt_exec_callback_QButtonGroup_buttonPressedWithInt_release(slot); }
	};
	MiqtVirtualQButtonGroup::connect(self, static_cast<void (QButtonGroup::*)(int)>(&QButtonGroup::buttonPressed), self, caller{slot});
}
...
void QButtonGroup_connect_buttonReleasedWithInt(QButtonGroup* self, intptr_t slot) {
	struct caller {
		...
		caller(const caller &) = delete;
		caller &operator=(const caller &) = delete;
		~caller() { miqt_exec_callback_QButtonGroup_buttonReleasedWithInt_release(slot); }
	};
	MiqtVirtualQButtonGroup::connect(self, static_cast<void (QButtonGroup::*)(int)>(&QButtonGroup::buttonReleased), self, caller{slot});
}
...
void QButtonGroup_connect_buttonToggled2(QButtonGroup* self, intptr_t slot) {
	struct caller {
		...
		caller(const caller &) = delete;
		caller &operator=(const caller &) = delete;
		~caller() { miqt_exec_callback_QButtonGroup_buttonToggled2_release(slot); }
	};
	MiqtVirtualQButtonGroup::connect(self, static_cast<void (QButtonGroup::*)(int, bool)>(&QButtonGroup::buttonToggled), self, caller{slot});
}
