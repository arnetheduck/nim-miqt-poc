...
func init*(T: type gen_qshortcut_types.QShortcut, h: ptr cQShortcut): gen_qshortcut_types.QShortcut =
  T(h: h)
proc create*(T: type gen_qshortcut_types.QShortcut, parent: QWidget): gen_qshortcut_types.QShortcut =
  gen_qshortcut_types.QShortcut.init(fcQShortcut_new(parent.h))

proc create*(T: type gen_qshortcut_types.QShortcut, key: QKeySequence, parent: QWidget): gen_qshortcut_types.QShortcut =
  gen_qshortcut_types.QShortcut.init(fcQShortcut_new2(key.h, parent.h))

proc create*(T: type gen_qshortcut_types.QShortcut, key: QKeySequence, parent: QWidget, member: cstring): gen_qshortcut_types.QShortcut =
  gen_qshortcut_types.QShortcut.init(fcQShortcut_new3(key.h, parent.h, member))

proc create*(T: type gen_qshortcut_types.QShortcut, key: QKeySequence, parent: QWidget, member: cstring, ambiguousMember: cstring): gen_qshortcut_types.QShortcut =
  gen_qshortcut_types.QShortcut.init(fcQShortcut_new4(key.h, parent.h, member, ambiguousMember))

proc create*(T: type gen_qshortcut_types.QShortcut, key: QKeySequence, parent: QWidget, member: cstring, ambiguousMember: cstring, shortcutContext: cint): gen_qshortcut_types.QShortcut =
...
proc parentWidget*(self: gen_qshortcut_types.QShortcut, ): QWidget =
  QWidget(h: fcQShortcut_parentWidget(self.h))
