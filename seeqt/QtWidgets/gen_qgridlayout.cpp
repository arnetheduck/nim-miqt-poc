...
QMetaObject* QGridLayout_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQGridLayout*)(self) )->QGridLayout::metaObject();

}

void* QGridLayout_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQGridLayout*)(self) )->QGridLayout::qt_metacast(param1);

}

int QGridLayout_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQGridLayout*)(self) )->QGridLayout::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
void QGridLayout_virtualbase_setSpacing(void* self, int spacing) {
	...
	( (MiqtVirtualQGridLayout*)(self) )->QGridLayout::setSpacing(static_cast<int>(spacing));

}

int QGridLayout_virtualbase_spacing(const void* self) {

	return ( (const MiqtVirtualQGridLayout*)(self) )->QGridLayout::spacing();
...
QLayoutItem* QGridLayout_virtualbase_replaceWidget(void* self, QWidget* from, QWidget* to, int options) {
	...
	return ( (MiqtVirtualQGridLayout*)(self) )->QGridLayout::replaceWidget(from, to, static_cast<Qt::FindChildOptions>(options));
...
QWidget* QGridLayout_virtualbase_widget(const void* self) {
	...
	return ( (const MiqtVirtualQGridLayout*)(self) )->QGridLayout::widget();
...
void QGridLayout_protectedbase_widgetEvent(void* self, QEvent* param1) {
	MiqtVirtualQGridLayout* self_cast = static_cast<MiqtVirtualQGridLayout*>( (QGridLayout*)(self) );
