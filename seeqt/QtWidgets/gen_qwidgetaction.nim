...
func init*(T: type gen_qwidgetaction_types.QWidgetAction, h: ptr cQWidgetAction): gen_qwidgetaction_types.QWidgetAction =
  T(h: h)
proc create*(T: type gen_qwidgetaction_types.QWidgetAction, parent: QObject): gen_qwidgetaction_types.QWidgetAction =
  gen_qwidgetaction_types.QWidgetAction.init(fcQWidgetAction_new(parent.h))

proc metaObject*(self: gen_qwidgetaction_types.QWidgetAction, ): QMetaObject =
  QMetaObject(h: fcQWidgetAction_metaObject(self.h))
...
proc setDefaultWidget*(self: gen_qwidgetaction_types.QWidgetAction, w: QWidget): void =
  fcQWidgetAction_setDefaultWidget(self.h, w.h)

proc defaultWidget*(self: gen_qwidgetaction_types.QWidgetAction, ): QWidget =
  QWidget(h: fcQWidgetAction_defaultWidget(self.h))

proc requestWidget*(self: gen_qwidgetaction_types.QWidgetAction, parent: QWidget): QWidget =
  QWidget(h: fcQWidgetAction_requestWidget(self.h, parent.h))

proc releaseWidget*(self: gen_qwidgetaction_types.QWidgetAction, widget: QWidget): void =
...
proc miqt_exec_callback_QWidgetAction_metacall(self: ptr cQWidgetAction, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QWidgetAction_metacall ".} =
  ...
  virtualReturn
proc QWidgetActionevent*(self: gen_qwidgetaction_types.QWidgetAction, param1: QEvent): bool =
  fQWidgetAction_virtualbase_event(self.h, param1.h)

type QWidgetActioneventProc* = proc(param1: QEvent): bool
...
proc miqt_exec_callback_QWidgetAction_event(self: ptr cQWidgetAction, slot: int, param1: pointer): bool {.exportc: "miqt_exec_callback_QWidgetAction_event ".} =
  ...
  virtualReturn
proc QWidgetActioneventFilter*(self: gen_qwidgetaction_types.QWidgetAction, param1: QObject, param2: QEvent): bool =
  fQWidgetAction_virtualbase_eventFilter(self.h, param1.h, param2.h)

type QWidgetActioneventFilterProc* = proc(param1: QObject, param2: QEvent): bool
...
proc miqt_exec_callback_QWidgetAction_eventFilter(self: ptr cQWidgetAction, slot: int, param1: pointer, param2: pointer): bool {.exportc: "miqt_exec_callback_QWidgetAction_eventFilter ".} =
  ...
  virtualReturn
proc QWidgetActioncreateWidget*(self: gen_qwidgetaction_types.QWidgetAction, parent: QWidget): QWidget =
  QWidget(h: fQWidgetAction_virtualbase_createWidget(self.h, parent.h))

type QWidgetActioncreateWidgetProc* = proc(parent: QWidget): QWidget
...
proc miqt_exec_callback_QWidgetAction_createWidget(self: ptr cQWidgetAction, slot: int, parent: pointer): pointer {.exportc: "miqt_exec_callback_QWidgetAction_createWidget ".} =
  ...
  virtualReturn.h
proc QWidgetActiondeleteWidget*(self: gen_qwidgetaction_types.QWidgetAction, widget: QWidget): void =
  fQWidgetAction_virtualbase_deleteWidget(self.h, widget.h)

type QWidgetActiondeleteWidgetProc* = proc(widget: QWidget): void
...
proc miqt_exec_callback_QWidgetAction_deleteWidget(self: ptr cQWidgetAction, slot: int, widget: pointer): void {.exportc: "miqt_exec_callback_QWidgetAction_deleteWidget ".} =
  ...
  nimfunc[](slotval1)
proc QWidgetActiontimerEvent*(self: gen_qwidgetaction_types.QWidgetAction, event: QTimerEvent): void =
  fQWidgetAction_virtualbase_timerEvent(self.h, event.h)

type QWidgetActiontimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QWidgetAction_timerEvent(self: ptr cQWidgetAction, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QWidgetAction_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QWidgetActionchildEvent*(self: gen_qwidgetaction_types.QWidgetAction, event: QChildEvent): void =
  fQWidgetAction_virtualbase_childEvent(self.h, event.h)

type QWidgetActionchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QWidgetAction_childEvent(self: ptr cQWidgetAction, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QWidgetAction_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QWidgetActioncustomEvent*(self: gen_qwidgetaction_types.QWidgetAction, event: QEvent): void =
  fQWidgetAction_virtualbase_customEvent(self.h, event.h)

type QWidgetActioncustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QWidgetAction_customEvent(self: ptr cQWidgetAction, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QWidgetAction_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QWidgetActionconnectNotify*(self: gen_qwidgetaction_types.QWidgetAction, signal: QMetaMethod): void =
  fQWidgetAction_virtualbase_connectNotify(self.h, signal.h)

type QWidgetActionconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QWidgetAction_connectNotify(self: ptr cQWidgetAction, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QWidgetAction_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QWidgetActiondisconnectNotify*(self: gen_qwidgetaction_types.QWidgetAction, signal: QMetaMethod): void =
  fQWidgetAction_virtualbase_disconnectNotify(self.h, signal.h)

type QWidgetActiondisconnectNotifyProc* = proc(signal: QMetaMethod): void
