...
QMetaObject* QErrorMessage_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQErrorMessage*)(self) )->QErrorMessage::metaObject();

}

void* QErrorMessage_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQErrorMessage*)(self) )->QErrorMessage::qt_metacast(param1);

}

int QErrorMessage_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQErrorMessage*)(self) )->QErrorMessage::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
void QErrorMessage_protectedbase_adjustPosition(void* self, QWidget* param1) {
	MiqtVirtualQErrorMessage* self_cast = static_cast<MiqtVirtualQErrorMessage*>( (QErrorMessage*)(self) );
