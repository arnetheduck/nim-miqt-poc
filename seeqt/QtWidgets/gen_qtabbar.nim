...
func init*(T: type gen_qtabbar_types.QTabBar, h: ptr cQTabBar): gen_qtabbar_types.QTabBar =
  T(h: h)
proc create*(T: type gen_qtabbar_types.QTabBar, parent: QWidget): gen_qtabbar_types.QTabBar =
...
proc metaObject*(self: gen_qtabbar_types.QTabBar, ): QMetaObject =
  QMetaObject(h: fcQTabBar_metaObject(self.h))
...
proc addTab*(self: gen_qtabbar_types.QTabBar, icon: QIcon, text: string): cint =
...
proc insertTab*(self: gen_qtabbar_types.QTabBar, index: cint, icon: QIcon, text: string): cint =
...
proc tabTextColor*(self: gen_qtabbar_types.QTabBar, index: cint): QColor =
  QColor(h: fcQTabBar_tabTextColor(self.h, index))

proc setTabTextColor*(self: gen_qtabbar_types.QTabBar, index: cint, color: QColor): void =
  fcQTabBar_setTabTextColor(self.h, index, color.h)

proc tabIcon*(self: gen_qtabbar_types.QTabBar, index: cint): QIcon =
  QIcon(h: fcQTabBar_tabIcon(self.h, index))

proc setTabIcon*(self: gen_qtabbar_types.QTabBar, index: cint, icon: QIcon): void =
...
proc setTabData*(self: gen_qtabbar_types.QTabBar, index: cint, data: QVariant): void =
  fcQTabBar_setTabData(self.h, index, data.h)

proc tabData*(self: gen_qtabbar_types.QTabBar, index: cint): QVariant =
  QVariant(h: fcQTabBar_tabData(self.h, index))

proc tabRect*(self: gen_qtabbar_types.QTabBar, index: cint): QRect =
  QRect(h: fcQTabBar_tabRect(self.h, index))

proc tabAt*(self: gen_qtabbar_types.QTabBar, pos: QPoint): cint =
...
proc sizeHint*(self: gen_qtabbar_types.QTabBar, ): QSize =
  QSize(h: fcQTabBar_sizeHint(self.h))

proc minimumSizeHint*(self: gen_qtabbar_types.QTabBar, ): QSize =
  QSize(h: fcQTabBar_minimumSizeHint(self.h))
...
proc iconSize*(self: gen_qtabbar_types.QTabBar, ): QSize =
  QSize(h: fcQTabBar_iconSize(self.h))

proc setIconSize*(self: gen_qtabbar_types.QTabBar, size: QSize): void =
...
proc setTabButton*(self: gen_qtabbar_types.QTabBar, index: cint, position: cint, widget: QWidget): void =
  fcQTabBar_setTabButton(self.h, index, cint(position), widget.h)

proc tabButton*(self: gen_qtabbar_types.QTabBar, index: cint, position: cint): QWidget =
  QWidget(h: fcQTabBar_tabButton(self.h, index, cint(position)))
...
proc miqt_exec_callback_QTabBar_metacall(self: ptr cQTabBar, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QTabBar_metacall ".} =
  ...
  virtualReturn
proc QTabBarsizeHint*(self: gen_qtabbar_types.QTabBar, ): QSize =
  QSize(h: fQTabBar_virtualbase_sizeHint(self.h))

type QTabBarsizeHintProc* = proc(): QSize
...
proc miqt_exec_callback_QTabBar_sizeHint(self: ptr cQTabBar, slot: int): pointer {.exportc: "miqt_exec_callback_QTabBar_sizeHint ".} =
  ...
  virtualReturn.h
proc QTabBarminimumSizeHint*(self: gen_qtabbar_types.QTabBar, ): QSize =
  QSize(h: fQTabBar_virtualbase_minimumSizeHint(self.h))

type QTabBarminimumSizeHintProc* = proc(): QSize
...
proc miqt_exec_callback_QTabBar_minimumSizeHint(self: ptr cQTabBar, slot: int): pointer {.exportc: "miqt_exec_callback_QTabBar_minimumSizeHint ".} =
  ...
  virtualReturn.h
proc QTabBartabSizeHint*(self: gen_qtabbar_types.QTabBar, index: cint): QSize =
  QSize(h: fQTabBar_virtualbase_tabSizeHint(self.h, index))

type QTabBartabSizeHintProc* = proc(index: cint): QSize
...
proc miqt_exec_callback_QTabBar_tabSizeHint(self: ptr cQTabBar, slot: int, index: cint): pointer {.exportc: "miqt_exec_callback_QTabBar_tabSizeHint ".} =
  ...
  virtualReturn.h
proc QTabBarminimumTabSizeHint*(self: gen_qtabbar_types.QTabBar, index: cint): QSize =
  QSize(h: fQTabBar_virtualbase_minimumTabSizeHint(self.h, index))

type QTabBarminimumTabSizeHintProc* = proc(index: cint): QSize
...
proc miqt_exec_callback_QTabBar_tabLayoutChange(self: ptr cQTabBar, slot: int): void {.exportc: "miqt_exec_callback_QTabBar_tabLayoutChange ".} =
  ...
  nimfunc[]()
proc QTabBarevent*(self: gen_qtabbar_types.QTabBar, param1: QEvent): bool =
  fQTabBar_virtualbase_event(self.h, param1.h)

type QTabBareventProc* = proc(param1: QEvent): bool
...
proc miqt_exec_callback_QTabBar_event(self: ptr cQTabBar, slot: int, param1: pointer): bool {.exportc: "miqt_exec_callback_QTabBar_event ".} =
  ...
  virtualReturn
proc QTabBarresizeEvent*(self: gen_qtabbar_types.QTabBar, param1: QResizeEvent): void =
  fQTabBar_virtualbase_resizeEvent(self.h, param1.h)

type QTabBarresizeEventProc* = proc(param1: QResizeEvent): void
...
proc miqt_exec_callback_QTabBar_resizeEvent(self: ptr cQTabBar, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QTabBar_resizeEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTabBarshowEvent*(self: gen_qtabbar_types.QTabBar, param1: QShowEvent): void =
  fQTabBar_virtualbase_showEvent(self.h, param1.h)

type QTabBarshowEventProc* = proc(param1: QShowEvent): void
...
proc miqt_exec_callback_QTabBar_showEvent(self: ptr cQTabBar, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QTabBar_showEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTabBarhideEvent*(self: gen_qtabbar_types.QTabBar, param1: QHideEvent): void =
  fQTabBar_virtualbase_hideEvent(self.h, param1.h)

type QTabBarhideEventProc* = proc(param1: QHideEvent): void
...
proc miqt_exec_callback_QTabBar_hideEvent(self: ptr cQTabBar, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QTabBar_hideEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTabBarpaintEvent*(self: gen_qtabbar_types.QTabBar, param1: QPaintEvent): void =
  fQTabBar_virtualbase_paintEvent(self.h, param1.h)

type QTabBarpaintEventProc* = proc(param1: QPaintEvent): void
...
proc miqt_exec_callback_QTabBar_paintEvent(self: ptr cQTabBar, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QTabBar_paintEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTabBarmousePressEvent*(self: gen_qtabbar_types.QTabBar, param1: QMouseEvent): void =
  fQTabBar_virtualbase_mousePressEvent(self.h, param1.h)

type QTabBarmousePressEventProc* = proc(param1: QMouseEvent): void
...
proc miqt_exec_callback_QTabBar_mousePressEvent(self: ptr cQTabBar, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QTabBar_mousePressEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTabBarmouseMoveEvent*(self: gen_qtabbar_types.QTabBar, param1: QMouseEvent): void =
  fQTabBar_virtualbase_mouseMoveEvent(self.h, param1.h)

type QTabBarmouseMoveEventProc* = proc(param1: QMouseEvent): void
...
proc miqt_exec_callback_QTabBar_mouseMoveEvent(self: ptr cQTabBar, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QTabBar_mouseMoveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTabBarmouseReleaseEvent*(self: gen_qtabbar_types.QTabBar, param1: QMouseEvent): void =
  fQTabBar_virtualbase_mouseReleaseEvent(self.h, param1.h)

type QTabBarmouseReleaseEventProc* = proc(param1: QMouseEvent): void
...
proc miqt_exec_callback_QTabBar_mouseReleaseEvent(self: ptr cQTabBar, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QTabBar_mouseReleaseEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTabBarmouseDoubleClickEvent*(self: gen_qtabbar_types.QTabBar, param1: QMouseEvent): void =
  fQTabBar_virtualbase_mouseDoubleClickEvent(self.h, param1.h)

type QTabBarmouseDoubleClickEventProc* = proc(param1: QMouseEvent): void
...
proc miqt_exec_callback_QTabBar_mouseDoubleClickEvent(self: ptr cQTabBar, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QTabBar_mouseDoubleClickEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTabBarwheelEvent*(self: gen_qtabbar_types.QTabBar, event: QWheelEvent): void =
  fQTabBar_virtualbase_wheelEvent(self.h, event.h)

type QTabBarwheelEventProc* = proc(event: QWheelEvent): void
...
proc miqt_exec_callback_QTabBar_wheelEvent(self: ptr cQTabBar, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTabBar_wheelEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTabBarkeyPressEvent*(self: gen_qtabbar_types.QTabBar, param1: QKeyEvent): void =
  fQTabBar_virtualbase_keyPressEvent(self.h, param1.h)

type QTabBarkeyPressEventProc* = proc(param1: QKeyEvent): void
...
proc miqt_exec_callback_QTabBar_keyPressEvent(self: ptr cQTabBar, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QTabBar_keyPressEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTabBarchangeEvent*(self: gen_qtabbar_types.QTabBar, param1: QEvent): void =
  fQTabBar_virtualbase_changeEvent(self.h, param1.h)

type QTabBarchangeEventProc* = proc(param1: QEvent): void
...
proc miqt_exec_callback_QTabBar_changeEvent(self: ptr cQTabBar, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QTabBar_changeEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTabBartimerEvent*(self: gen_qtabbar_types.QTabBar, event: QTimerEvent): void =
  fQTabBar_virtualbase_timerEvent(self.h, event.h)

type QTabBartimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QTabBar_timerEvent(self: ptr cQTabBar, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTabBar_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTabBarinitStyleOption*(self: gen_qtabbar_types.QTabBar, option: QStyleOptionTab, tabIndex: cint): void =
  fQTabBar_virtualbase_initStyleOption(self.h, option.h, tabIndex)

type QTabBarinitStyleOptionProc* = proc(option: QStyleOptionTab, tabIndex: cint): void
...
proc miqt_exec_callback_QTabBar_initStyleOption(self: ptr cQTabBar, slot: int, option: pointer, tabIndex: cint): void {.exportc: "miqt_exec_callback_QTabBar_initStyleOption ".} =
  ...
  let slotval1 = QStyleOptionTab(h: option)
...
proc miqt_exec_callback_QTabBar_hasHeightForWidth(self: ptr cQTabBar, slot: int): bool {.exportc: "miqt_exec_callback_QTabBar_hasHeightForWidth ".} =
  ...
  virtualReturn
proc QTabBarpaintEngine*(self: gen_qtabbar_types.QTabBar, ): QPaintEngine =
  QPaintEngine(h: fQTabBar_virtualbase_paintEngine(self.h))

type QTabBarpaintEngineProc* = proc(): QPaintEngine
...
proc miqt_exec_callback_QTabBar_paintEngine(self: ptr cQTabBar, slot: int): pointer {.exportc: "miqt_exec_callback_QTabBar_paintEngine ".} =
  ...
  virtualReturn.h
proc QTabBarkeyReleaseEvent*(self: gen_qtabbar_types.QTabBar, event: QKeyEvent): void =
  fQTabBar_virtualbase_keyReleaseEvent(self.h, event.h)

type QTabBarkeyReleaseEventProc* = proc(event: QKeyEvent): void
...
proc miqt_exec_callback_QTabBar_keyReleaseEvent(self: ptr cQTabBar, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTabBar_keyReleaseEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTabBarfocusInEvent*(self: gen_qtabbar_types.QTabBar, event: QFocusEvent): void =
  fQTabBar_virtualbase_focusInEvent(self.h, event.h)

type QTabBarfocusInEventProc* = proc(event: QFocusEvent): void
...
proc miqt_exec_callback_QTabBar_focusInEvent(self: ptr cQTabBar, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTabBar_focusInEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTabBarfocusOutEvent*(self: gen_qtabbar_types.QTabBar, event: QFocusEvent): void =
  fQTabBar_virtualbase_focusOutEvent(self.h, event.h)

type QTabBarfocusOutEventProc* = proc(event: QFocusEvent): void
...
proc miqt_exec_callback_QTabBar_focusOutEvent(self: ptr cQTabBar, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTabBar_focusOutEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTabBarenterEvent*(self: gen_qtabbar_types.QTabBar, event: QEnterEvent): void =
  fQTabBar_virtualbase_enterEvent(self.h, event.h)

type QTabBarenterEventProc* = proc(event: QEnterEvent): void
...
proc miqt_exec_callback_QTabBar_enterEvent(self: ptr cQTabBar, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTabBar_enterEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTabBarleaveEvent*(self: gen_qtabbar_types.QTabBar, event: QEvent): void =
  fQTabBar_virtualbase_leaveEvent(self.h, event.h)

type QTabBarleaveEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QTabBar_leaveEvent(self: ptr cQTabBar, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTabBar_leaveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTabBarmoveEvent*(self: gen_qtabbar_types.QTabBar, event: QMoveEvent): void =
  fQTabBar_virtualbase_moveEvent(self.h, event.h)

type QTabBarmoveEventProc* = proc(event: QMoveEvent): void
...
proc miqt_exec_callback_QTabBar_moveEvent(self: ptr cQTabBar, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTabBar_moveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTabBarcloseEvent*(self: gen_qtabbar_types.QTabBar, event: QCloseEvent): void =
  fQTabBar_virtualbase_closeEvent(self.h, event.h)

type QTabBarcloseEventProc* = proc(event: QCloseEvent): void
...
proc miqt_exec_callback_QTabBar_closeEvent(self: ptr cQTabBar, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTabBar_closeEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTabBarcontextMenuEvent*(self: gen_qtabbar_types.QTabBar, event: QContextMenuEvent): void =
  fQTabBar_virtualbase_contextMenuEvent(self.h, event.h)

type QTabBarcontextMenuEventProc* = proc(event: QContextMenuEvent): void
...
proc miqt_exec_callback_QTabBar_contextMenuEvent(self: ptr cQTabBar, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTabBar_contextMenuEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTabBartabletEvent*(self: gen_qtabbar_types.QTabBar, event: QTabletEvent): void =
  fQTabBar_virtualbase_tabletEvent(self.h, event.h)

type QTabBartabletEventProc* = proc(event: QTabletEvent): void
...
proc miqt_exec_callback_QTabBar_tabletEvent(self: ptr cQTabBar, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTabBar_tabletEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTabBaractionEvent*(self: gen_qtabbar_types.QTabBar, event: QActionEvent): void =
  fQTabBar_virtualbase_actionEvent(self.h, event.h)

type QTabBaractionEventProc* = proc(event: QActionEvent): void
...
proc miqt_exec_callback_QTabBar_actionEvent(self: ptr cQTabBar, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTabBar_actionEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTabBardragEnterEvent*(self: gen_qtabbar_types.QTabBar, event: QDragEnterEvent): void =
  fQTabBar_virtualbase_dragEnterEvent(self.h, event.h)

type QTabBardragEnterEventProc* = proc(event: QDragEnterEvent): void
...
proc miqt_exec_callback_QTabBar_dragEnterEvent(self: ptr cQTabBar, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTabBar_dragEnterEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTabBardragMoveEvent*(self: gen_qtabbar_types.QTabBar, event: QDragMoveEvent): void =
  fQTabBar_virtualbase_dragMoveEvent(self.h, event.h)

type QTabBardragMoveEventProc* = proc(event: QDragMoveEvent): void
...
proc miqt_exec_callback_QTabBar_dragMoveEvent(self: ptr cQTabBar, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTabBar_dragMoveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTabBardragLeaveEvent*(self: gen_qtabbar_types.QTabBar, event: QDragLeaveEvent): void =
  fQTabBar_virtualbase_dragLeaveEvent(self.h, event.h)

type QTabBardragLeaveEventProc* = proc(event: QDragLeaveEvent): void
...
proc miqt_exec_callback_QTabBar_dragLeaveEvent(self: ptr cQTabBar, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTabBar_dragLeaveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTabBardropEvent*(self: gen_qtabbar_types.QTabBar, event: QDropEvent): void =
  fQTabBar_virtualbase_dropEvent(self.h, event.h)

type QTabBardropEventProc* = proc(event: QDropEvent): void
...
proc miqt_exec_callback_QTabBar_metric(self: ptr cQTabBar, slot: int, param1: cint): cint {.exportc: "miqt_exec_callback_QTabBar_metric ".} =
  ...
  virtualReturn
proc QTabBarinitPainter*(self: gen_qtabbar_types.QTabBar, painter: QPainter): void =
  fQTabBar_virtualbase_initPainter(self.h, painter.h)

type QTabBarinitPainterProc* = proc(painter: QPainter): void
...
proc miqt_exec_callback_QTabBar_initPainter(self: ptr cQTabBar, slot: int, painter: pointer): void {.exportc: "miqt_exec_callback_QTabBar_initPainter ".} =
  ...
  nimfunc[](slotval1)
proc QTabBarredirected*(self: gen_qtabbar_types.QTabBar, offset: QPoint): QPaintDevice =
  QPaintDevice(h: fQTabBar_virtualbase_redirected(self.h, offset.h))

type QTabBarredirectedProc* = proc(offset: QPoint): QPaintDevice
...
proc miqt_exec_callback_QTabBar_redirected(self: ptr cQTabBar, slot: int, offset: pointer): pointer {.exportc: "miqt_exec_callback_QTabBar_redirected ".} =
  ...
  virtualReturn.h
proc QTabBarsharedPainter*(self: gen_qtabbar_types.QTabBar, ): QPainter =
  QPainter(h: fQTabBar_virtualbase_sharedPainter(self.h))

type QTabBarsharedPainterProc* = proc(): QPainter
...
proc miqt_exec_callback_QTabBar_sharedPainter(self: ptr cQTabBar, slot: int): pointer {.exportc: "miqt_exec_callback_QTabBar_sharedPainter ".} =
  ...
  virtualReturn.h
proc QTabBarinputMethodEvent*(self: gen_qtabbar_types.QTabBar, param1: QInputMethodEvent): void =
  fQTabBar_virtualbase_inputMethodEvent(self.h, param1.h)

type QTabBarinputMethodEventProc* = proc(param1: QInputMethodEvent): void
...
proc miqt_exec_callback_QTabBar_inputMethodEvent(self: ptr cQTabBar, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QTabBar_inputMethodEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTabBarinputMethodQuery*(self: gen_qtabbar_types.QTabBar, param1: cint): QVariant =
  QVariant(h: fQTabBar_virtualbase_inputMethodQuery(self.h, cint(param1)))

type QTabBarinputMethodQueryProc* = proc(param1: cint): QVariant
...
proc miqt_exec_callback_QTabBar_focusNextPrevChild(self: ptr cQTabBar, slot: int, next: bool): bool {.exportc: "miqt_exec_callback_QTabBar_focusNextPrevChild ".} =
  ...
  virtualReturn
proc QTabBareventFilter*(self: gen_qtabbar_types.QTabBar, watched: QObject, event: QEvent): bool =
  fQTabBar_virtualbase_eventFilter(self.h, watched.h, event.h)

type QTabBareventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QTabBar_eventFilter(self: ptr cQTabBar, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QTabBar_eventFilter ".} =
  ...
  virtualReturn
proc QTabBarchildEvent*(self: gen_qtabbar_types.QTabBar, event: QChildEvent): void =
  fQTabBar_virtualbase_childEvent(self.h, event.h)

type QTabBarchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QTabBar_childEvent(self: ptr cQTabBar, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTabBar_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTabBarcustomEvent*(self: gen_qtabbar_types.QTabBar, event: QEvent): void =
  fQTabBar_virtualbase_customEvent(self.h, event.h)

type QTabBarcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QTabBar_customEvent(self: ptr cQTabBar, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTabBar_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTabBarconnectNotify*(self: gen_qtabbar_types.QTabBar, signal: QMetaMethod): void =
  fQTabBar_virtualbase_connectNotify(self.h, signal.h)

type QTabBarconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QTabBar_connectNotify(self: ptr cQTabBar, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QTabBar_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QTabBardisconnectNotify*(self: gen_qtabbar_types.QTabBar, signal: QMetaMethod): void =
  fQTabBar_virtualbase_disconnectNotify(self.h, signal.h)

type QTabBardisconnectNotifyProc* = proc(signal: QMetaMethod): void
