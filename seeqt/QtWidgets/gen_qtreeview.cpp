...
void QTreeView_connect_expanded(QTreeView* self, intptr_t slot, void (*callback)(intptr_t, QModelIndex*), void (*release)(intptr_t)) {
	...
	MiqtVirtualQTreeView::connect(self, static_cast<void (QTreeView::*)(const QModelIndex&)>(&QTreeView::expanded), self, caller{slot, callback, release});
}
...
void QTreeView_connect_collapsed(QTreeView* self, intptr_t slot, void (*callback)(intptr_t, QModelIndex*), void (*release)(intptr_t)) {
	...
	MiqtVirtualQTreeView::connect(self, static_cast<void (QTreeView::*)(const QModelIndex&)>(&QTreeView::collapsed), self, caller{slot, callback, release});
}
...
QMetaObject* QTreeView_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQTreeView*)(self) )->QTreeView::metaObject();

}

void* QTreeView_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQTreeView*)(self) )->QTreeView::qt_metacast(param1);

}

int QTreeView_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQTreeView*)(self) )->QTreeView::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
QStyleOptionViewItem* QTreeView_virtualbase_viewOptions(const void* self) {
	...
	return new QStyleOptionViewItem(( (const MiqtVirtualQTreeView*)(self) )->QTreeView::viewOptions());
...
void QTreeView_virtualbase_changeEvent(void* self, QEvent* param1) {
	...
	( (MiqtVirtualQTreeView*)(self) )->QTreeView::changeEvent(param1);
...
bool QTreeView_virtualbase_nativeEvent(void* self, struct miqt_string eventType, void* message, long* result) {
	...
	return ( (MiqtVirtualQTreeView*)(self) )->QTreeView::nativeEvent(eventType_QByteArray, message, static_cast<long*>(result));
...
void QTreeView_protectedbase_columnResized(void* self, int column, int oldSize, int newSize) {
	MiqtVirtualQTreeView* self_cast = static_cast<MiqtVirtualQTreeView*>( (QTreeView*)(self) );
