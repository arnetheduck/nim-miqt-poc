...
QMetaObject* QRubberBand_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQRubberBand*)(self) )->QRubberBand::metaObject();

}

void* QRubberBand_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQRubberBand*)(self) )->QRubberBand::qt_metacast(param1);

}

int QRubberBand_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQRubberBand*)(self) )->QRubberBand::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
bool QRubberBand_virtualbase_nativeEvent(void* self, struct miqt_string eventType, void* message, long* result) {
	...
	return ( (MiqtVirtualQRubberBand*)(self) )->QRubberBand::nativeEvent(eventType_QByteArray, message, static_cast<long*>(result));
...
void QRubberBand_protectedbase_initStyleOption(const void* self, QStyleOptionRubberBand* option) {
	MiqtVirtualQRubberBand* self_cast = static_cast<MiqtVirtualQRubberBand*>( (QRubberBand*)(self) );
