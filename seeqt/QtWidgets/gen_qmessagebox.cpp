...
void QMessageBox_connect_buttonClicked(QMessageBox* self, intptr_t slot, void (*callback)(intptr_t, QAbstractButton*), void (*release)(intptr_t)) {
	...
	MiqtVirtualQMessageBox::connect(self, static_cast<void (QMessageBox::*)(QAbstractButton*)>(&QMessageBox::buttonClicked), self, caller{slot, callback, release});
}
...
QMetaObject* QMessageBox_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQMessageBox*)(self) )->QMessageBox::metaObject();

}

void* QMessageBox_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQMessageBox*)(self) )->QMessageBox::qt_metacast(param1);

}

int QMessageBox_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQMessageBox*)(self) )->QMessageBox::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
void QMessageBox_protectedbase_adjustPosition(void* self, QWidget* param1) {
	MiqtVirtualQMessageBox* self_cast = static_cast<MiqtVirtualQMessageBox*>( (QMessageBox*)(self) );
