...
proc create*(T: type gen_qgraphicsitemanimation_types.QGraphicsItemAnimation, parent: QObject): gen_qgraphicsitemanimation_types.QGraphicsItemAnimation =
  gen_qgraphicsitemanimation_types.QGraphicsItemAnimation.init(fcQGraphicsItemAnimation_new2(parent.h))

proc metaObject*(self: gen_qgraphicsitemanimation_types.QGraphicsItemAnimation, ): QMetaObject =
  QMetaObject(h: fcQGraphicsItemAnimation_metaObject(self.h))
...
proc item*(self: gen_qgraphicsitemanimation_types.QGraphicsItemAnimation, ): QGraphicsItem =
  QGraphicsItem(h: fcQGraphicsItemAnimation_item(self.h))

proc setItem*(self: gen_qgraphicsitemanimation_types.QGraphicsItemAnimation, item: QGraphicsItem): void =
  fcQGraphicsItemAnimation_setItem(self.h, item.h)

proc timeLine*(self: gen_qgraphicsitemanimation_types.QGraphicsItemAnimation, ): QTimeLine =
  QTimeLine(h: fcQGraphicsItemAnimation_timeLine(self.h))

proc setTimeLine*(self: gen_qgraphicsitemanimation_types.QGraphicsItemAnimation, timeLine: QTimeLine): void =
  fcQGraphicsItemAnimation_setTimeLine(self.h, timeLine.h)

proc posAt*(self: gen_qgraphicsitemanimation_types.QGraphicsItemAnimation, step: float64): QPointF =
  QPointF(h: fcQGraphicsItemAnimation_posAt(self.h, step))

proc posList*(self: gen_qgraphicsitemanimation_types.QGraphicsItemAnimation, ): seq[tuple[first: float64, second: QPointF]] =
  var v_ma = fcQGraphicsItemAnimation_posList(self.h)
  var vx_ret = newSeq[tuple[first: float64, second: QPointF]](int(v_ma.len))
  ...
  for i in 0 ..< v_ma.len:
    ...
    var vx_lv_entry_Second = QPointF(h: vx_lv_Second_CArray[0])

    vx_ret[i] = (first: vx_lv_entry_First , second: vx_lv_entry_Second )
  vx_ret

proc setPosAt*(self: gen_qgraphicsitemanimation_types.QGraphicsItemAnimation, step: float64, pos: QPointF): void =
  fcQGraphicsItemAnimation_setPosAt(self.h, step, pos.h)

proc matrixAt*(self: gen_qgraphicsitemanimation_types.QGraphicsItemAnimation, step: float64): QMatrix =
  QMatrix(h: fcQGraphicsItemAnimation_matrixAt(self.h, step))

proc transformAt*(self: gen_qgraphicsitemanimation_types.QGraphicsItemAnimation, step: float64): QTransform =
  QTransform(h: fcQGraphicsItemAnimation_transformAt(self.h, step))
...
proc translationList*(self: gen_qgraphicsitemanimation_types.QGraphicsItemAnimation, ): seq[tuple[first: float64, second: QPointF]] =
...
proc scaleList*(self: gen_qgraphicsitemanimation_types.QGraphicsItemAnimation, ): seq[tuple[first: float64, second: QPointF]] =
...
proc shearList*(self: gen_qgraphicsitemanimation_types.QGraphicsItemAnimation, ): seq[tuple[first: float64, second: QPointF]] =
...
proc miqt_exec_callback_QGraphicsItemAnimation_afterAnimationStep(self: ptr cQGraphicsItemAnimation, slot: int, step: float64): void {.exportc: "miqt_exec_callback_QGraphicsItemAnimation_afterAnimationStep ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsItemAnimationevent*(self: gen_qgraphicsitemanimation_types.QGraphicsItemAnimation, event: QEvent): bool =
  fQGraphicsItemAnimation_virtualbase_event(self.h, event.h)

type QGraphicsItemAnimationeventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QGraphicsItemAnimation_event(self: ptr cQGraphicsItemAnimation, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QGraphicsItemAnimation_event ".} =
  ...
  virtualReturn
proc QGraphicsItemAnimationeventFilter*(self: gen_qgraphicsitemanimation_types.QGraphicsItemAnimation, watched: QObject, event: QEvent): bool =
  fQGraphicsItemAnimation_virtualbase_eventFilter(self.h, watched.h, event.h)

type QGraphicsItemAnimationeventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QGraphicsItemAnimation_eventFilter(self: ptr cQGraphicsItemAnimation, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QGraphicsItemAnimation_eventFilter ".} =
  ...
  virtualReturn
proc QGraphicsItemAnimationtimerEvent*(self: gen_qgraphicsitemanimation_types.QGraphicsItemAnimation, event: QTimerEvent): void =
  fQGraphicsItemAnimation_virtualbase_timerEvent(self.h, event.h)

type QGraphicsItemAnimationtimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QGraphicsItemAnimation_timerEvent(self: ptr cQGraphicsItemAnimation, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsItemAnimation_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsItemAnimationchildEvent*(self: gen_qgraphicsitemanimation_types.QGraphicsItemAnimation, event: QChildEvent): void =
  fQGraphicsItemAnimation_virtualbase_childEvent(self.h, event.h)

type QGraphicsItemAnimationchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QGraphicsItemAnimation_childEvent(self: ptr cQGraphicsItemAnimation, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsItemAnimation_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsItemAnimationcustomEvent*(self: gen_qgraphicsitemanimation_types.QGraphicsItemAnimation, event: QEvent): void =
  fQGraphicsItemAnimation_virtualbase_customEvent(self.h, event.h)

type QGraphicsItemAnimationcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QGraphicsItemAnimation_customEvent(self: ptr cQGraphicsItemAnimation, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsItemAnimation_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsItemAnimationconnectNotify*(self: gen_qgraphicsitemanimation_types.QGraphicsItemAnimation, signal: QMetaMethod): void =
  fQGraphicsItemAnimation_virtualbase_connectNotify(self.h, signal.h)

type QGraphicsItemAnimationconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QGraphicsItemAnimation_connectNotify(self: ptr cQGraphicsItemAnimation, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QGraphicsItemAnimation_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsItemAnimationdisconnectNotify*(self: gen_qgraphicsitemanimation_types.QGraphicsItemAnimation, signal: QMetaMethod): void =
  fQGraphicsItemAnimation_virtualbase_disconnectNotify(self.h, signal.h)

type QGraphicsItemAnimationdisconnectNotifyProc* = proc(signal: QMetaMethod): void
