...
proc create*(T: type gen_qproxystyle_types.QProxyStyle, style: QStyle): gen_qproxystyle_types.QProxyStyle =
  gen_qproxystyle_types.QProxyStyle.init(fcQProxyStyle_new3(style.h))

proc metaObject*(self: gen_qproxystyle_types.QProxyStyle, ): QMetaObject =
  QMetaObject(h: fcQProxyStyle_metaObject(self.h))
...
proc baseStyle*(self: gen_qproxystyle_types.QProxyStyle, ): QStyle =
  QStyle(h: fcQProxyStyle_baseStyle(self.h))

proc setBaseStyle*(self: gen_qproxystyle_types.QProxyStyle, style: QStyle): void =
  fcQProxyStyle_setBaseStyle(self.h, style.h)

proc drawPrimitive*(self: gen_qproxystyle_types.QProxyStyle, element: cint, option: QStyleOption, painter: QPainter, widget: QWidget): void =
  fcQProxyStyle_drawPrimitive(self.h, cint(element), option.h, painter.h, widget.h)

proc drawControl*(self: gen_qproxystyle_types.QProxyStyle, element: cint, option: QStyleOption, painter: QPainter, widget: QWidget): void =
  fcQProxyStyle_drawControl(self.h, cint(element), option.h, painter.h, widget.h)

proc drawComplexControl*(self: gen_qproxystyle_types.QProxyStyle, control: cint, option: QStyleOptionComplex, painter: QPainter, widget: QWidget): void =
  fcQProxyStyle_drawComplexControl(self.h, cint(control), option.h, painter.h, widget.h)

proc drawItemText*(self: gen_qproxystyle_types.QProxyStyle, painter: QPainter, rect: QRect, flags: cint, pal: QPalette, enabled: bool, text: string, textRole: cint): void =
...
proc drawItemPixmap*(self: gen_qproxystyle_types.QProxyStyle, painter: QPainter, rect: QRect, alignment: cint, pixmap: QPixmap): void =
  fcQProxyStyle_drawItemPixmap(self.h, painter.h, rect.h, alignment, pixmap.h)

proc sizeFromContents*(self: gen_qproxystyle_types.QProxyStyle, typeVal: cint, option: QStyleOption, size: QSize, widget: QWidget): QSize =
  QSize(h: fcQProxyStyle_sizeFromContents(self.h, cint(typeVal), option.h, size.h, widget.h))

proc subElementRect*(self: gen_qproxystyle_types.QProxyStyle, element: cint, option: QStyleOption, widget: QWidget): QRect =
  QRect(h: fcQProxyStyle_subElementRect(self.h, cint(element), option.h, widget.h))

proc subControlRect*(self: gen_qproxystyle_types.QProxyStyle, cc: cint, opt: QStyleOptionComplex, sc: cint, widget: QWidget): QRect =
  QRect(h: fcQProxyStyle_subControlRect(self.h, cint(cc), opt.h, cint(sc), widget.h))

proc itemTextRect*(self: gen_qproxystyle_types.QProxyStyle, fm: QFontMetrics, r: QRect, flags: cint, enabled: bool, text: string): QRect =
  QRect(h: fcQProxyStyle_itemTextRect(self.h, fm.h, r.h, flags, enabled, struct_miqt_string(data: text, len: csize_t(len(text)))))

proc itemPixmapRect*(self: gen_qproxystyle_types.QProxyStyle, r: QRect, flags: cint, pixmap: QPixmap): QRect =
  QRect(h: fcQProxyStyle_itemPixmapRect(self.h, r.h, flags, pixmap.h))

proc hitTestComplexControl*(self: gen_qproxystyle_types.QProxyStyle, control: cint, option: QStyleOptionComplex, pos: QPoint, widget: QWidget): cint =
  cint(fcQProxyStyle_hitTestComplexControl(self.h, cint(control), option.h, pos.h, widget.h))

proc styleHint*(self: gen_qproxystyle_types.QProxyStyle, hint: cint, option: QStyleOption, widget: QWidget, returnData: QStyleHintReturn): cint =
  fcQProxyStyle_styleHint(self.h, cint(hint), option.h, widget.h, returnData.h)

proc pixelMetric*(self: gen_qproxystyle_types.QProxyStyle, metric: cint, option: QStyleOption, widget: QWidget): cint =
  fcQProxyStyle_pixelMetric(self.h, cint(metric), option.h, widget.h)

proc layoutSpacing*(self: gen_qproxystyle_types.QProxyStyle, control1: cint, control2: cint, orientation: cint, option: QStyleOption, widget: QWidget): cint =
  fcQProxyStyle_layoutSpacing(self.h, cint(control1), cint(control2), cint(orientation), option.h, widget.h)

proc standardIcon*(self: gen_qproxystyle_types.QProxyStyle, standardIcon: cint, option: QStyleOption, widget: QWidget): QIcon =
  QIcon(h: fcQProxyStyle_standardIcon(self.h, cint(standardIcon), option.h, widget.h))

proc standardPixmap*(self: gen_qproxystyle_types.QProxyStyle, standardPixmap: cint, opt: QStyleOption, widget: QWidget): QPixmap =
  QPixmap(h: fcQProxyStyle_standardPixmap(self.h, cint(standardPixmap), opt.h, widget.h))

proc generatedIconPixmap*(self: gen_qproxystyle_types.QProxyStyle, iconMode: cint, pixmap: QPixmap, opt: QStyleOption): QPixmap =
  QPixmap(h: fcQProxyStyle_generatedIconPixmap(self.h, cint(iconMode), pixmap.h, opt.h))

proc standardPalette*(self: gen_qproxystyle_types.QProxyStyle, ): QPalette =
  QPalette(h: fcQProxyStyle_standardPalette(self.h))

proc polish*(self: gen_qproxystyle_types.QProxyStyle, widget: QWidget): void =
  fcQProxyStyle_polish(self.h, widget.h)

proc polish*(self: gen_qproxystyle_types.QProxyStyle, pal: QPalette): void =
  fcQProxyStyle_polishWithPal(self.h, pal.h)

proc polish*(self: gen_qproxystyle_types.QProxyStyle, app: QApplication): void =
  fcQProxyStyle_polishWithApp(self.h, app.h)

proc unpolish*(self: gen_qproxystyle_types.QProxyStyle, widget: QWidget): void =
  fcQProxyStyle_unpolish(self.h, widget.h)

proc unpolish*(self: gen_qproxystyle_types.QProxyStyle, app: QApplication): void =
...
proc miqt_exec_callback_QProxyStyle_metacall(self: ptr cQProxyStyle, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QProxyStyle_metacall ".} =
  ...
  virtualReturn
proc QProxyStyledrawPrimitive*(self: gen_qproxystyle_types.QProxyStyle, element: cint, option: QStyleOption, painter: QPainter, widget: QWidget): void =
  fQProxyStyle_virtualbase_drawPrimitive(self.h, cint(element), option.h, painter.h, widget.h)

type QProxyStyledrawPrimitiveProc* = proc(element: cint, option: QStyleOption, painter: QPainter, widget: QWidget): void
...
proc miqt_exec_callback_QProxyStyle_drawPrimitive(self: ptr cQProxyStyle, slot: int, element: cint, option: pointer, painter: pointer, widget: pointer): void {.exportc: "miqt_exec_callback_QProxyStyle_drawPrimitive ".} =
  ...
  let slotval3 = QPainter(h: painter)

  let slotval4 = QWidget(h: widget)


  nimfunc[](slotval1, slotval2, slotval3, slotval4)
proc QProxyStyledrawControl*(self: gen_qproxystyle_types.QProxyStyle, element: cint, option: QStyleOption, painter: QPainter, widget: QWidget): void =
  fQProxyStyle_virtualbase_drawControl(self.h, cint(element), option.h, painter.h, widget.h)

type QProxyStyledrawControlProc* = proc(element: cint, option: QStyleOption, painter: QPainter, widget: QWidget): void
...
proc miqt_exec_callback_QProxyStyle_drawControl(self: ptr cQProxyStyle, slot: int, element: cint, option: pointer, painter: pointer, widget: pointer): void {.exportc: "miqt_exec_callback_QProxyStyle_drawControl ".} =
  ...
  nimfunc[](slotval1, slotval2, slotval3, slotval4)
proc QProxyStyledrawComplexControl*(self: gen_qproxystyle_types.QProxyStyle, control: cint, option: QStyleOptionComplex, painter: QPainter, widget: QWidget): void =
  fQProxyStyle_virtualbase_drawComplexControl(self.h, cint(control), option.h, painter.h, widget.h)

type QProxyStyledrawComplexControlProc* = proc(control: cint, option: QStyleOptionComplex, painter: QPainter, widget: QWidget): void
...
proc miqt_exec_callback_QProxyStyle_drawComplexControl(self: ptr cQProxyStyle, slot: int, control: cint, option: pointer, painter: pointer, widget: pointer): void {.exportc: "miqt_exec_callback_QProxyStyle_drawComplexControl ".} =
  ...
  let slotval2 = QStyleOptionComplex(h: option)
  ...
  nimfunc[](slotval1, slotval2, slotval3, slotval4)
proc QProxyStyledrawItemText*(self: gen_qproxystyle_types.QProxyStyle, painter: QPainter, rect: QRect, flags: cint, pal: QPalette, enabled: bool, text: string, textRole: cint): void =
...
type QProxyStyledrawItemTextProc* = proc(painter: QPainter, rect: QRect, flags: cint, pal: QPalette, enabled: bool, text: string, textRole: cint): void
...
proc QProxyStyledrawItemPixmap*(self: gen_qproxystyle_types.QProxyStyle, painter: QPainter, rect: QRect, alignment: cint, pixmap: QPixmap): void =
  fQProxyStyle_virtualbase_drawItemPixmap(self.h, painter.h, rect.h, alignment, pixmap.h)

type QProxyStyledrawItemPixmapProc* = proc(painter: QPainter, rect: QRect, alignment: cint, pixmap: QPixmap): void
...
proc miqt_exec_callback_QProxyStyle_drawItemPixmap(self: ptr cQProxyStyle, slot: int, painter: pointer, rect: pointer, alignment: cint, pixmap: pointer): void {.exportc: "miqt_exec_callback_QProxyStyle_drawItemPixmap ".} =
  ...
  nimfunc[](slotval1, slotval2, slotval3, slotval4)
proc QProxyStylesizeFromContents*(self: gen_qproxystyle_types.QProxyStyle, typeVal: cint, option: QStyleOption, size: QSize, widget: QWidget): QSize =
  QSize(h: fQProxyStyle_virtualbase_sizeFromContents(self.h, cint(typeVal), option.h, size.h, widget.h))

type QProxyStylesizeFromContentsProc* = proc(typeVal: cint, option: QStyleOption, size: QSize, widget: QWidget): QSize
...
proc miqt_exec_callback_QProxyStyle_sizeFromContents(self: ptr cQProxyStyle, slot: int, typeVal: cint, option: pointer, size: pointer, widget: pointer): pointer {.exportc: "miqt_exec_callback_QProxyStyle_sizeFromContents ".} =
  ...
  virtualReturn.h
proc QProxyStylesubElementRect*(self: gen_qproxystyle_types.QProxyStyle, element: cint, option: QStyleOption, widget: QWidget): QRect =
  QRect(h: fQProxyStyle_virtualbase_subElementRect(self.h, cint(element), option.h, widget.h))

type QProxyStylesubElementRectProc* = proc(element: cint, option: QStyleOption, widget: QWidget): QRect
...
proc miqt_exec_callback_QProxyStyle_subElementRect(self: ptr cQProxyStyle, slot: int, element: cint, option: pointer, widget: pointer): pointer {.exportc: "miqt_exec_callback_QProxyStyle_subElementRect ".} =
  ...
  virtualReturn.h
proc QProxyStylesubControlRect*(self: gen_qproxystyle_types.QProxyStyle, cc: cint, opt: QStyleOptionComplex, sc: cint, widget: QWidget): QRect =
  QRect(h: fQProxyStyle_virtualbase_subControlRect(self.h, cint(cc), opt.h, cint(sc), widget.h))

type QProxyStylesubControlRectProc* = proc(cc: cint, opt: QStyleOptionComplex, sc: cint, widget: QWidget): QRect
...
proc miqt_exec_callback_QProxyStyle_subControlRect(self: ptr cQProxyStyle, slot: int, cc: cint, opt: pointer, sc: cint, widget: pointer): pointer {.exportc: "miqt_exec_callback_QProxyStyle_subControlRect ".} =
  ...
  virtualReturn.h
proc QProxyStyleitemTextRect*(self: gen_qproxystyle_types.QProxyStyle, fm: QFontMetrics, r: QRect, flags: cint, enabled: bool, text: string): QRect =
  QRect(h: fQProxyStyle_virtualbase_itemTextRect(self.h, fm.h, r.h, flags, enabled, struct_miqt_string(data: text, len: csize_t(len(text)))))

type QProxyStyleitemTextRectProc* = proc(fm: QFontMetrics, r: QRect, flags: cint, enabled: bool, text: string): QRect
...
proc miqt_exec_callback_QProxyStyle_itemTextRect(self: ptr cQProxyStyle, slot: int, fm: pointer, r: pointer, flags: cint, enabled: bool, text: struct_miqt_string): pointer {.exportc: "miqt_exec_callback_QProxyStyle_itemTextRect ".} =
  ...
  virtualReturn.h
proc QProxyStyleitemPixmapRect*(self: gen_qproxystyle_types.QProxyStyle, r: QRect, flags: cint, pixmap: QPixmap): QRect =
  QRect(h: fQProxyStyle_virtualbase_itemPixmapRect(self.h, r.h, flags, pixmap.h))

type QProxyStyleitemPixmapRectProc* = proc(r: QRect, flags: cint, pixmap: QPixmap): QRect
...
proc miqt_exec_callback_QProxyStyle_itemPixmapRect(self: ptr cQProxyStyle, slot: int, r: pointer, flags: cint, pixmap: pointer): pointer {.exportc: "miqt_exec_callback_QProxyStyle_itemPixmapRect ".} =
  ...
  virtualReturn.h
proc QProxyStylehitTestComplexControl*(self: gen_qproxystyle_types.QProxyStyle, control: cint, option: QStyleOptionComplex, pos: QPoint, widget: QWidget): cint =
  cint(fQProxyStyle_virtualbase_hitTestComplexControl(self.h, cint(control), option.h, pos.h, widget.h))

type QProxyStylehitTestComplexControlProc* = proc(control: cint, option: QStyleOptionComplex, pos: QPoint, widget: QWidget): cint
...
proc miqt_exec_callback_QProxyStyle_hitTestComplexControl(self: ptr cQProxyStyle, slot: int, control: cint, option: pointer, pos: pointer, widget: pointer): cint {.exportc: "miqt_exec_callback_QProxyStyle_hitTestComplexControl ".} =
  ...
  cint(virtualReturn)
proc QProxyStylestyleHint*(self: gen_qproxystyle_types.QProxyStyle, hint: cint, option: QStyleOption, widget: QWidget, returnData: QStyleHintReturn): cint =
  fQProxyStyle_virtualbase_styleHint(self.h, cint(hint), option.h, widget.h, returnData.h)

type QProxyStylestyleHintProc* = proc(hint: cint, option: QStyleOption, widget: QWidget, returnData: QStyleHintReturn): cint
...
proc miqt_exec_callback_QProxyStyle_styleHint(self: ptr cQProxyStyle, slot: int, hint: cint, option: pointer, widget: pointer, returnData: pointer): cint {.exportc: "miqt_exec_callback_QProxyStyle_styleHint ".} =
  ...
  virtualReturn
proc QProxyStylepixelMetric*(self: gen_qproxystyle_types.QProxyStyle, metric: cint, option: QStyleOption, widget: QWidget): cint =
  fQProxyStyle_virtualbase_pixelMetric(self.h, cint(metric), option.h, widget.h)

type QProxyStylepixelMetricProc* = proc(metric: cint, option: QStyleOption, widget: QWidget): cint
...
proc miqt_exec_callback_QProxyStyle_pixelMetric(self: ptr cQProxyStyle, slot: int, metric: cint, option: pointer, widget: pointer): cint {.exportc: "miqt_exec_callback_QProxyStyle_pixelMetric ".} =
  ...
  virtualReturn
proc QProxyStylelayoutSpacing*(self: gen_qproxystyle_types.QProxyStyle, control1: cint, control2: cint, orientation: cint, option: QStyleOption, widget: QWidget): cint =
  fQProxyStyle_virtualbase_layoutSpacing(self.h, cint(control1), cint(control2), cint(orientation), option.h, widget.h)

type QProxyStylelayoutSpacingProc* = proc(control1: cint, control2: cint, orientation: cint, option: QStyleOption, widget: QWidget): cint
...
proc miqt_exec_callback_QProxyStyle_layoutSpacing(self: ptr cQProxyStyle, slot: int, control1: cint, control2: cint, orientation: cint, option: pointer, widget: pointer): cint {.exportc: "miqt_exec_callback_QProxyStyle_layoutSpacing ".} =
  ...
  virtualReturn
proc QProxyStylestandardIcon*(self: gen_qproxystyle_types.QProxyStyle, standardIcon: cint, option: QStyleOption, widget: QWidget): QIcon =
  QIcon(h: fQProxyStyle_virtualbase_standardIcon(self.h, cint(standardIcon), option.h, widget.h))

type QProxyStylestandardIconProc* = proc(standardIcon: cint, option: QStyleOption, widget: QWidget): QIcon
...
proc miqt_exec_callback_QProxyStyle_standardIcon(self: ptr cQProxyStyle, slot: int, standardIcon: cint, option: pointer, widget: pointer): pointer {.exportc: "miqt_exec_callback_QProxyStyle_standardIcon ".} =
  ...
  virtualReturn.h
proc QProxyStylestandardPixmap*(self: gen_qproxystyle_types.QProxyStyle, standardPixmap: cint, opt: QStyleOption, widget: QWidget): QPixmap =
  QPixmap(h: fQProxyStyle_virtualbase_standardPixmap(self.h, cint(standardPixmap), opt.h, widget.h))

type QProxyStylestandardPixmapProc* = proc(standardPixmap: cint, opt: QStyleOption, widget: QWidget): QPixmap
...
proc miqt_exec_callback_QProxyStyle_standardPixmap(self: ptr cQProxyStyle, slot: int, standardPixmap: cint, opt: pointer, widget: pointer): pointer {.exportc: "miqt_exec_callback_QProxyStyle_standardPixmap ".} =
  ...
  virtualReturn.h
proc QProxyStylegeneratedIconPixmap*(self: gen_qproxystyle_types.QProxyStyle, iconMode: cint, pixmap: QPixmap, opt: QStyleOption): QPixmap =
  QPixmap(h: fQProxyStyle_virtualbase_generatedIconPixmap(self.h, cint(iconMode), pixmap.h, opt.h))

type QProxyStylegeneratedIconPixmapProc* = proc(iconMode: cint, pixmap: QPixmap, opt: QStyleOption): QPixmap
...
proc miqt_exec_callback_QProxyStyle_generatedIconPixmap(self: ptr cQProxyStyle, slot: int, iconMode: cint, pixmap: pointer, opt: pointer): pointer {.exportc: "miqt_exec_callback_QProxyStyle_generatedIconPixmap ".} =
  ...
  virtualReturn.h
proc QProxyStylestandardPalette*(self: gen_qproxystyle_types.QProxyStyle, ): QPalette =
  QPalette(h: fQProxyStyle_virtualbase_standardPalette(self.h))

type QProxyStylestandardPaletteProc* = proc(): QPalette
...
proc miqt_exec_callback_QProxyStyle_standardPalette(self: ptr cQProxyStyle, slot: int): pointer {.exportc: "miqt_exec_callback_QProxyStyle_standardPalette ".} =
  ...
  virtualReturn.h
proc QProxyStylepolish*(self: gen_qproxystyle_types.QProxyStyle, widget: QWidget): void =
  fQProxyStyle_virtualbase_polish(self.h, widget.h)

type QProxyStylepolishProc* = proc(widget: QWidget): void
...
proc miqt_exec_callback_QProxyStyle_polish(self: ptr cQProxyStyle, slot: int, widget: pointer): void {.exportc: "miqt_exec_callback_QProxyStyle_polish ".} =
  ...
  nimfunc[](slotval1)
proc QProxyStylepolish*(self: gen_qproxystyle_types.QProxyStyle, pal: QPalette): void =
  fQProxyStyle_virtualbase_polishWithPal(self.h, pal.h)

type QProxyStylepolishWithPalProc* = proc(pal: QPalette): void
...
proc miqt_exec_callback_QProxyStyle_polishWithPal(self: ptr cQProxyStyle, slot: int, pal: pointer): void {.exportc: "miqt_exec_callback_QProxyStyle_polishWithPal ".} =
  ...
  let slotval1 = QPalette(h: pal)


  nimfunc[](slotval1)
proc QProxyStylepolish*(self: gen_qproxystyle_types.QProxyStyle, app: QApplication): void =
  fQProxyStyle_virtualbase_polishWithApp(self.h, app.h)

type QProxyStylepolishWithAppProc* = proc(app: QApplication): void
...
proc miqt_exec_callback_QProxyStyle_polishWithApp(self: ptr cQProxyStyle, slot: int, app: pointer): void {.exportc: "miqt_exec_callback_QProxyStyle_polishWithApp ".} =
  ...
  let slotval1 = QApplication(h: app)


  nimfunc[](slotval1)
proc QProxyStyleunpolish*(self: gen_qproxystyle_types.QProxyStyle, widget: QWidget): void =
  fQProxyStyle_virtualbase_unpolish(self.h, widget.h)

type QProxyStyleunpolishProc* = proc(widget: QWidget): void
...
proc miqt_exec_callback_QProxyStyle_unpolish(self: ptr cQProxyStyle, slot: int, widget: pointer): void {.exportc: "miqt_exec_callback_QProxyStyle_unpolish ".} =
  ...
  nimfunc[](slotval1)
proc QProxyStyleunpolish*(self: gen_qproxystyle_types.QProxyStyle, app: QApplication): void =
  fQProxyStyle_virtualbase_unpolishWithApp(self.h, app.h)

type QProxyStyleunpolishWithAppProc* = proc(app: QApplication): void
...
proc miqt_exec_callback_QProxyStyle_unpolishWithApp(self: ptr cQProxyStyle, slot: int, app: pointer): void {.exportc: "miqt_exec_callback_QProxyStyle_unpolishWithApp ".} =
  ...
  nimfunc[](slotval1)
proc QProxyStyleevent*(self: gen_qproxystyle_types.QProxyStyle, e: QEvent): bool =
  fQProxyStyle_virtualbase_event(self.h, e.h)

type QProxyStyleeventProc* = proc(e: QEvent): bool
...
proc miqt_exec_callback_QProxyStyle_event(self: ptr cQProxyStyle, slot: int, e: pointer): bool {.exportc: "miqt_exec_callback_QProxyStyle_event ".} =
  ...
  virtualReturn
proc QProxyStyleeventFilter*(self: gen_qproxystyle_types.QProxyStyle, watched: QObject, event: QEvent): bool =
  fQProxyStyle_virtualbase_eventFilter(self.h, watched.h, event.h)

type QProxyStyleeventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QProxyStyle_eventFilter(self: ptr cQProxyStyle, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QProxyStyle_eventFilter ".} =
  ...
  virtualReturn
proc QProxyStyletimerEvent*(self: gen_qproxystyle_types.QProxyStyle, event: QTimerEvent): void =
  fQProxyStyle_virtualbase_timerEvent(self.h, event.h)

type QProxyStyletimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QProxyStyle_timerEvent(self: ptr cQProxyStyle, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QProxyStyle_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QProxyStylechildEvent*(self: gen_qproxystyle_types.QProxyStyle, event: QChildEvent): void =
  fQProxyStyle_virtualbase_childEvent(self.h, event.h)

type QProxyStylechildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QProxyStyle_childEvent(self: ptr cQProxyStyle, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QProxyStyle_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QProxyStylecustomEvent*(self: gen_qproxystyle_types.QProxyStyle, event: QEvent): void =
  fQProxyStyle_virtualbase_customEvent(self.h, event.h)

type QProxyStylecustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QProxyStyle_customEvent(self: ptr cQProxyStyle, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QProxyStyle_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QProxyStyleconnectNotify*(self: gen_qproxystyle_types.QProxyStyle, signal: QMetaMethod): void =
  fQProxyStyle_virtualbase_connectNotify(self.h, signal.h)

type QProxyStyleconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QProxyStyle_connectNotify(self: ptr cQProxyStyle, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QProxyStyle_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QProxyStyledisconnectNotify*(self: gen_qproxystyle_types.QProxyStyle, signal: QMetaMethod): void =
  fQProxyStyle_virtualbase_disconnectNotify(self.h, signal.h)

type QProxyStyledisconnectNotifyProc* = proc(signal: QMetaMethod): void
