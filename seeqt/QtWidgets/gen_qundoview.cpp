...
QMetaObject* QUndoView_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQUndoView*)(self) )->QUndoView::metaObject();

}

void* QUndoView_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQUndoView*)(self) )->QUndoView::qt_metacast(param1);

}

int QUndoView_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQUndoView*)(self) )->QUndoView::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
