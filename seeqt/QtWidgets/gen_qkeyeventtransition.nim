...
proc create*(T: type gen_qkeyeventtransition_types.QKeyEventTransition, objectVal: QObject, typeVal: cint, key: cint): gen_qkeyeventtransition_types.QKeyEventTransition =
  gen_qkeyeventtransition_types.QKeyEventTransition.init(fcQKeyEventTransition_new2(objectVal.h, cint(typeVal), key))

proc create*(T: type gen_qkeyeventtransition_types.QKeyEventTransition, sourceState: QState): gen_qkeyeventtransition_types.QKeyEventTransition =
  gen_qkeyeventtransition_types.QKeyEventTransition.init(fcQKeyEventTransition_new3(sourceState.h))

proc create*(T: type gen_qkeyeventtransition_types.QKeyEventTransition, objectVal: QObject, typeVal: cint, key: cint, sourceState: QState): gen_qkeyeventtransition_types.QKeyEventTransition =
...
proc metaObject*(self: gen_qkeyeventtransition_types.QKeyEventTransition, ): QMetaObject =
  QMetaObject(h: fcQKeyEventTransition_metaObject(self.h))
...
proc miqt_exec_callback_QKeyEventTransition_metacall(self: ptr cQKeyEventTransition, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QKeyEventTransition_metacall ".} =
  ...
  virtualReturn
proc QKeyEventTransitiononTransition*(self: gen_qkeyeventtransition_types.QKeyEventTransition, event: QEvent): void =
  fQKeyEventTransition_virtualbase_onTransition(self.h, event.h)

type QKeyEventTransitiononTransitionProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QKeyEventTransition_onTransition(self: ptr cQKeyEventTransition, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QKeyEventTransition_onTransition ".} =
  ...
  nimfunc[](slotval1)
proc QKeyEventTransitioneventTest*(self: gen_qkeyeventtransition_types.QKeyEventTransition, event: QEvent): bool =
  fQKeyEventTransition_virtualbase_eventTest(self.h, event.h)

type QKeyEventTransitioneventTestProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QKeyEventTransition_eventTest(self: ptr cQKeyEventTransition, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QKeyEventTransition_eventTest ".} =
  ...
  virtualReturn
proc QKeyEventTransitionevent*(self: gen_qkeyeventtransition_types.QKeyEventTransition, e: QEvent): bool =
  fQKeyEventTransition_virtualbase_event(self.h, e.h)

type QKeyEventTransitioneventProc* = proc(e: QEvent): bool
...
proc miqt_exec_callback_QKeyEventTransition_event(self: ptr cQKeyEventTransition, slot: int, e: pointer): bool {.exportc: "miqt_exec_callback_QKeyEventTransition_event ".} =
  ...
  virtualReturn
proc QKeyEventTransitioneventFilter*(self: gen_qkeyeventtransition_types.QKeyEventTransition, watched: QObject, event: QEvent): bool =
  fQKeyEventTransition_virtualbase_eventFilter(self.h, watched.h, event.h)

type QKeyEventTransitioneventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QKeyEventTransition_eventFilter(self: ptr cQKeyEventTransition, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QKeyEventTransition_eventFilter ".} =
  ...
  virtualReturn
proc QKeyEventTransitiontimerEvent*(self: gen_qkeyeventtransition_types.QKeyEventTransition, event: QTimerEvent): void =
  fQKeyEventTransition_virtualbase_timerEvent(self.h, event.h)

type QKeyEventTransitiontimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QKeyEventTransition_timerEvent(self: ptr cQKeyEventTransition, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QKeyEventTransition_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QKeyEventTransitionchildEvent*(self: gen_qkeyeventtransition_types.QKeyEventTransition, event: QChildEvent): void =
  fQKeyEventTransition_virtualbase_childEvent(self.h, event.h)

type QKeyEventTransitionchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QKeyEventTransition_childEvent(self: ptr cQKeyEventTransition, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QKeyEventTransition_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QKeyEventTransitioncustomEvent*(self: gen_qkeyeventtransition_types.QKeyEventTransition, event: QEvent): void =
  fQKeyEventTransition_virtualbase_customEvent(self.h, event.h)

type QKeyEventTransitioncustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QKeyEventTransition_customEvent(self: ptr cQKeyEventTransition, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QKeyEventTransition_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QKeyEventTransitionconnectNotify*(self: gen_qkeyeventtransition_types.QKeyEventTransition, signal: QMetaMethod): void =
  fQKeyEventTransition_virtualbase_connectNotify(self.h, signal.h)

type QKeyEventTransitionconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QKeyEventTransition_connectNotify(self: ptr cQKeyEventTransition, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QKeyEventTransition_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QKeyEventTransitiondisconnectNotify*(self: gen_qkeyeventtransition_types.QKeyEventTransition, signal: QMetaMethod): void =
  fQKeyEventTransition_virtualbase_disconnectNotify(self.h, signal.h)

type QKeyEventTransitiondisconnectNotifyProc* = proc(signal: QMetaMethod): void
