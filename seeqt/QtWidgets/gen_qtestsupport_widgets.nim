...
func init*(T: type gen_qtestsupport_widgets_types.QTestQTouchEventWidgetSequence, h: ptr cQTestQTouchEventWidgetSequence): gen_qtestsupport_widgets_types.QTestQTouchEventWidgetSequence =
  T(h: h)
proc create*(T: type gen_qtestsupport_widgets_types.QTestQTouchEventWidgetSequence, param1: QTestQTouchEventWidgetSequence): gen_qtestsupport_widgets_types.QTestQTouchEventWidgetSequence =
  gen_qtestsupport_widgets_types.QTestQTouchEventWidgetSequence.init(fcQTestQTouchEventWidgetSequence_new(param1.h))

proc press*(self: gen_qtestsupport_widgets_types.QTestQTouchEventWidgetSequence, touchId: cint, pt: QPoint): QTestQTouchEventWidgetSequence =
  QTestQTouchEventWidgetSequence(h: fcQTestQTouchEventWidgetSequence_press(self.h, touchId, pt.h))

proc move*(self: gen_qtestsupport_widgets_types.QTestQTouchEventWidgetSequence, touchId: cint, pt: QPoint): QTestQTouchEventWidgetSequence =
  QTestQTouchEventWidgetSequence(h: fcQTestQTouchEventWidgetSequence_move(self.h, touchId, pt.h))

proc release*(self: gen_qtestsupport_widgets_types.QTestQTouchEventWidgetSequence, touchId: cint, pt: QPoint): QTestQTouchEventWidgetSequence =
  QTestQTouchEventWidgetSequence(h: fcQTestQTouchEventWidgetSequence_release(self.h, touchId, pt.h))

proc stationary*(self: gen_qtestsupport_widgets_types.QTestQTouchEventWidgetSequence, touchId: cint): QTestQTouchEventWidgetSequence =
...
proc press*(self: gen_qtestsupport_widgets_types.QTestQTouchEventWidgetSequence, touchId: cint, pt: QPoint, widget: QWidget): QTestQTouchEventWidgetSequence =
  QTestQTouchEventWidgetSequence(h: fcQTestQTouchEventWidgetSequence_press3(self.h, touchId, pt.h, widget.h))

proc move*(self: gen_qtestsupport_widgets_types.QTestQTouchEventWidgetSequence, touchId: cint, pt: QPoint, widget: QWidget): QTestQTouchEventWidgetSequence =
  QTestQTouchEventWidgetSequence(h: fcQTestQTouchEventWidgetSequence_move3(self.h, touchId, pt.h, widget.h))

proc release*(self: gen_qtestsupport_widgets_types.QTestQTouchEventWidgetSequence, touchId: cint, pt: QPoint, widget: QWidget): QTestQTouchEventWidgetSequence =
  QTestQTouchEventWidgetSequence(h: fcQTestQTouchEventWidgetSequence_release3(self.h, touchId, pt.h, widget.h))

proc QTestQTouchEventWidgetSequencestationary*(self: gen_qtestsupport_widgets_types.QTestQTouchEventWidgetSequence, touchId: cint): QTestQTouchEventWidgetSequence =
  QTestQTouchEventWidgetSequence(h: fQTest__QTouchEventWidgetSequence_virtualbase_stationary(self.h, touchId))

type QTestQTouchEventWidgetSequencestationaryProc* = proc(touchId: cint): QTestQTouchEventWidgetSequence
