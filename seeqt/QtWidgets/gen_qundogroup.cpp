...
public:
	...
	MiqtVirtualQUndoGroup(struct QUndoGroup_VTable* vtbl): QUndoGroup(), vtbl(vtbl) {};
	MiqtVirtualQUndoGroup(struct QUndoGroup_VTable* vtbl, QObject* parent): QUndoGroup(parent), vtbl(vtbl) {};

	virtual ~MiqtVirtualQUndoGroup() override { if(vtbl->destructor) vtbl->destructor(vtbl, this); }
...
QUndoGroup* QUndoGroup_new(struct QUndoGroup_VTable* vtbl) {
	return new MiqtVirtualQUndoGroup(vtbl);
}

QUndoGroup* QUndoGroup_new2(struct QUndoGroup_VTable* vtbl, QObject* parent) {
	return new MiqtVirtualQUndoGroup(vtbl, parent);
}
...
void QUndoGroup_connect_activeStackChanged(QUndoGroup* self, intptr_t slot, void (*callback)(intptr_t, QUndoStack*), void (*release)(intptr_t)) {
	...
	MiqtVirtualQUndoGroup::connect(self, static_cast<void (QUndoGroup::*)(QUndoStack*)>(&QUndoGroup::activeStackChanged), self, caller{slot, callback, release});
}
...
void QUndoGroup_connect_indexChanged(QUndoGroup* self, intptr_t slot, void (*callback)(intptr_t, int), void (*release)(intptr_t)) {
	...
	MiqtVirtualQUndoGroup::connect(self, static_cast<void (QUndoGroup::*)(int)>(&QUndoGroup::indexChanged), self, caller{slot, callback, release});
}
...
void QUndoGroup_connect_cleanChanged(QUndoGroup* self, intptr_t slot, void (*callback)(intptr_t, bool), void (*release)(intptr_t)) {
	...
	MiqtVirtualQUndoGroup::connect(self, static_cast<void (QUndoGroup::*)(bool)>(&QUndoGroup::cleanChanged), self, caller{slot, callback, release});
}
...
void QUndoGroup_connect_canUndoChanged(QUndoGroup* self, intptr_t slot, void (*callback)(intptr_t, bool), void (*release)(intptr_t)) {
	...
	MiqtVirtualQUndoGroup::connect(self, static_cast<void (QUndoGroup::*)(bool)>(&QUndoGroup::canUndoChanged), self, caller{slot, callback, release});
}
...
void QUndoGroup_connect_canRedoChanged(QUndoGroup* self, intptr_t slot, void (*callback)(intptr_t, bool), void (*release)(intptr_t)) {
	...
	MiqtVirtualQUndoGroup::connect(self, static_cast<void (QUndoGroup::*)(bool)>(&QUndoGroup::canRedoChanged), self, caller{slot, callback, release});
}
...
void QUndoGroup_connect_undoTextChanged(QUndoGroup* self, intptr_t slot, void (*callback)(intptr_t, struct miqt_string), void (*release)(intptr_t)) {
	...
	MiqtVirtualQUndoGroup::connect(self, static_cast<void (QUndoGroup::*)(const QString&)>(&QUndoGroup::undoTextChanged), self, caller{slot, callback, release});
}
...
void QUndoGroup_connect_redoTextChanged(QUndoGroup* self, intptr_t slot, void (*callback)(intptr_t, struct miqt_string), void (*release)(intptr_t)) {
	...
	MiqtVirtualQUndoGroup::connect(self, static_cast<void (QUndoGroup::*)(const QString&)>(&QUndoGroup::redoTextChanged), self, caller{slot, callback, release});
}
...
QMetaObject* QUndoGroup_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQUndoGroup*)(self) )->QUndoGroup::metaObject();

}

void* QUndoGroup_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQUndoGroup*)(self) )->QUndoGroup::qt_metacast(param1);

}

int QUndoGroup_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQUndoGroup*)(self) )->QUndoGroup::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
