...
void QPlainTextEdit_connect_textChanged(QPlainTextEdit* self, intptr_t slot, void (*callback)(intptr_t), void (*release)(intptr_t)) {
	...
	MiqtVirtualQPlainTextEdit::connect(self, static_cast<void (QPlainTextEdit::*)()>(&QPlainTextEdit::textChanged), self, caller{slot, callback, release});
}
...
void QPlainTextEdit_connect_undoAvailable(QPlainTextEdit* self, intptr_t slot, void (*callback)(intptr_t, bool), void (*release)(intptr_t)) {
	...
	MiqtVirtualQPlainTextEdit::connect(self, static_cast<void (QPlainTextEdit::*)(bool)>(&QPlainTextEdit::undoAvailable), self, caller{slot, callback, release});
}
...
void QPlainTextEdit_connect_redoAvailable(QPlainTextEdit* self, intptr_t slot, void (*callback)(intptr_t, bool), void (*release)(intptr_t)) {
	...
	MiqtVirtualQPlainTextEdit::connect(self, static_cast<void (QPlainTextEdit::*)(bool)>(&QPlainTextEdit::redoAvailable), self, caller{slot, callback, release});
}
...
void QPlainTextEdit_connect_copyAvailable(QPlainTextEdit* self, intptr_t slot, void (*callback)(intptr_t, bool), void (*release)(intptr_t)) {
	...
	MiqtVirtualQPlainTextEdit::connect(self, static_cast<void (QPlainTextEdit::*)(bool)>(&QPlainTextEdit::copyAvailable), self, caller{slot, callback, release});
}
...
void QPlainTextEdit_connect_selectionChanged(QPlainTextEdit* self, intptr_t slot, void (*callback)(intptr_t), void (*release)(intptr_t)) {
	...
	MiqtVirtualQPlainTextEdit::connect(self, static_cast<void (QPlainTextEdit::*)()>(&QPlainTextEdit::selectionChanged), self, caller{slot, callback, release});
}
...
void QPlainTextEdit_connect_cursorPositionChanged(QPlainTextEdit* self, intptr_t slot, void (*callback)(intptr_t), void (*release)(intptr_t)) {
	...
	MiqtVirtualQPlainTextEdit::connect(self, static_cast<void (QPlainTextEdit::*)()>(&QPlainTextEdit::cursorPositionChanged), self, caller{slot, callback, release});
}
...
void QPlainTextEdit_connect_updateRequest(QPlainTextEdit* self, intptr_t slot, void (*callback)(intptr_t, QRect*, int), void (*release)(intptr_t)) {
	...
	MiqtVirtualQPlainTextEdit::connect(self, static_cast<void (QPlainTextEdit::*)(const QRect&, int)>(&QPlainTextEdit::updateRequest), self, caller{slot, callback, release});
}
...
void QPlainTextEdit_connect_blockCountChanged(QPlainTextEdit* self, intptr_t slot, void (*callback)(intptr_t, int), void (*release)(intptr_t)) {
	...
	MiqtVirtualQPlainTextEdit::connect(self, static_cast<void (QPlainTextEdit::*)(int)>(&QPlainTextEdit::blockCountChanged), self, caller{slot, callback, release});
}
...
void QPlainTextEdit_connect_modificationChanged(QPlainTextEdit* self, intptr_t slot, void (*callback)(intptr_t, bool), void (*release)(intptr_t)) {
	...
	MiqtVirtualQPlainTextEdit::connect(self, static_cast<void (QPlainTextEdit::*)(bool)>(&QPlainTextEdit::modificationChanged), self, caller{slot, callback, release});
}
...
QMetaObject* QPlainTextEdit_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQPlainTextEdit*)(self) )->QPlainTextEdit::metaObject();

}

void* QPlainTextEdit_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQPlainTextEdit*)(self) )->QPlainTextEdit::qt_metacast(param1);

}

int QPlainTextEdit_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQPlainTextEdit*)(self) )->QPlainTextEdit::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
void QPlainTextEdit_virtualbase_initStyleOption(const void* self, QStyleOptionFrame* option) {
	...
	( (const MiqtVirtualQPlainTextEdit*)(self) )->QPlainTextEdit::initStyleOption(option);
...
bool QPlainTextEdit_virtualbase_nativeEvent(void* self, struct miqt_string eventType, void* message, intptr_t* result) {
	...
	return ( (MiqtVirtualQPlainTextEdit*)(self) )->QPlainTextEdit::nativeEvent(eventType_QByteArray, message, (qintptr*)(result));
...
QMetaObject* QPlainTextDocumentLayout_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQPlainTextDocumentLayout*)(self) )->QPlainTextDocumentLayout::metaObject();

}

void* QPlainTextDocumentLayout_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQPlainTextDocumentLayout*)(self) )->QPlainTextDocumentLayout::qt_metacast(param1);

}

int QPlainTextDocumentLayout_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQPlainTextDocumentLayout*)(self) )->QPlainTextDocumentLayout::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
