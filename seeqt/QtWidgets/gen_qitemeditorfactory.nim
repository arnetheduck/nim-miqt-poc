...
func init*(T: type gen_qitemeditorfactory_types.QItemEditorCreatorBase, h: ptr cQItemEditorCreatorBase): gen_qitemeditorfactory_types.QItemEditorCreatorBase =
  T(h: h)
proc createWidget*(self: gen_qitemeditorfactory_types.QItemEditorCreatorBase, parent: QWidget): QWidget =
  QWidget(h: fcQItemEditorCreatorBase_createWidget(self.h, parent.h))
...
proc operatorAssign*(self: gen_qitemeditorfactory_types.QItemEditorCreatorBase, param1: QItemEditorCreatorBase): void =
...
proc create*(T: type gen_qitemeditorfactory_types.QItemEditorFactory, param1: QItemEditorFactory): gen_qitemeditorfactory_types.QItemEditorFactory =
  gen_qitemeditorfactory_types.QItemEditorFactory.init(fcQItemEditorFactory_new2(param1.h))

proc createEditor*(self: gen_qitemeditorfactory_types.QItemEditorFactory, userType: cint, parent: QWidget): QWidget =
  QWidget(h: fcQItemEditorFactory_createEditor(self.h, userType, parent.h))
...
proc registerEditor*(self: gen_qitemeditorfactory_types.QItemEditorFactory, userType: cint, creator: QItemEditorCreatorBase): void =
  fcQItemEditorFactory_registerEditor(self.h, userType, creator.h)

proc defaultFactory*(_: type gen_qitemeditorfactory_types.QItemEditorFactory, ): QItemEditorFactory =
  QItemEditorFactory(h: fcQItemEditorFactory_defaultFactory())

proc setDefaultFactory*(_: type gen_qitemeditorfactory_types.QItemEditorFactory, factory: QItemEditorFactory): void =
  fcQItemEditorFactory_setDefaultFactory(factory.h)

proc QItemEditorFactorycreateEditor*(self: gen_qitemeditorfactory_types.QItemEditorFactory, userType: cint, parent: QWidget): QWidget =
  QWidget(h: fQItemEditorFactory_virtualbase_createEditor(self.h, userType, parent.h))

type QItemEditorFactorycreateEditorProc* = proc(userType: cint, parent: QWidget): QWidget
