...
proc fQGraphicsLayoutItem_virtualbase_isEmpty(self: pointer, ): bool{.importc: "QGraphicsLayoutItem_virtualbase_isEmpty".}
proc fcQGraphicsLayoutItem_override_virtual_isEmpty(self: pointer, slot: int) {.importc: "QGraphicsLayoutItem_override_virtual_isEmpty".}
...
proc create*(T: type gen_qgraphicslayoutitem_types.QGraphicsLayoutItem, parent: QGraphicsLayoutItem): gen_qgraphicslayoutitem_types.QGraphicsLayoutItem =
  gen_qgraphicslayoutitem_types.QGraphicsLayoutItem.init(fcQGraphicsLayoutItem_new2(parent.h))

proc create*(T: type gen_qgraphicslayoutitem_types.QGraphicsLayoutItem, parent: QGraphicsLayoutItem, isLayout: bool): gen_qgraphicslayoutitem_types.QGraphicsLayoutItem =
  gen_qgraphicslayoutitem_types.QGraphicsLayoutItem.init(fcQGraphicsLayoutItem_new3(parent.h, isLayout))

proc setSizePolicy*(self: gen_qgraphicslayoutitem_types.QGraphicsLayoutItem, policy: QSizePolicy): void =
...
proc sizePolicy*(self: gen_qgraphicslayoutitem_types.QGraphicsLayoutItem, ): QSizePolicy =
  QSizePolicy(h: fcQGraphicsLayoutItem_sizePolicy(self.h))

proc setMinimumSize*(self: gen_qgraphicslayoutitem_types.QGraphicsLayoutItem, size: QSizeF): void =
...
proc minimumSize*(self: gen_qgraphicslayoutitem_types.QGraphicsLayoutItem, ): QSizeF =
  QSizeF(h: fcQGraphicsLayoutItem_minimumSize(self.h))
...
proc setPreferredSize*(self: gen_qgraphicslayoutitem_types.QGraphicsLayoutItem, size: QSizeF): void =
...
proc preferredSize*(self: gen_qgraphicslayoutitem_types.QGraphicsLayoutItem, ): QSizeF =
  QSizeF(h: fcQGraphicsLayoutItem_preferredSize(self.h))
...
proc setMaximumSize*(self: gen_qgraphicslayoutitem_types.QGraphicsLayoutItem, size: QSizeF): void =
...
proc maximumSize*(self: gen_qgraphicslayoutitem_types.QGraphicsLayoutItem, ): QSizeF =
  QSizeF(h: fcQGraphicsLayoutItem_maximumSize(self.h))
...
proc setGeometry*(self: gen_qgraphicslayoutitem_types.QGraphicsLayoutItem, rect: QRectF): void =
  fcQGraphicsLayoutItem_setGeometry(self.h, rect.h)

proc geometry*(self: gen_qgraphicslayoutitem_types.QGraphicsLayoutItem, ): QRectF =
  QRectF(h: fcQGraphicsLayoutItem_geometry(self.h))
...
proc contentsRect*(self: gen_qgraphicslayoutitem_types.QGraphicsLayoutItem, ): QRectF =
  QRectF(h: fcQGraphicsLayoutItem_contentsRect(self.h))

proc effectiveSizeHint*(self: gen_qgraphicslayoutitem_types.QGraphicsLayoutItem, which: cint): QSizeF =
  QSizeF(h: fcQGraphicsLayoutItem_effectiveSizeHint(self.h, cint(which)))
...
proc parentLayoutItem*(self: gen_qgraphicslayoutitem_types.QGraphicsLayoutItem, ): QGraphicsLayoutItem =
  QGraphicsLayoutItem(h: fcQGraphicsLayoutItem_parentLayoutItem(self.h))

proc setParentLayoutItem*(self: gen_qgraphicslayoutitem_types.QGraphicsLayoutItem, parent: QGraphicsLayoutItem): void =
...
proc graphicsItem*(self: gen_qgraphicslayoutitem_types.QGraphicsLayoutItem, ): QGraphicsItem =
  QGraphicsItem(h: fcQGraphicsLayoutItem_graphicsItem(self.h))
...
proc effectiveSizeHint*(self: gen_qgraphicslayoutitem_types.QGraphicsLayoutItem, which: cint, constraint: QSizeF): QSizeF =
  QSizeF(h: fcQGraphicsLayoutItem_effectiveSizeHint2(self.h, cint(which), constraint.h))

proc QGraphicsLayoutItemsetGeometry*(self: gen_qgraphicslayoutitem_types.QGraphicsLayoutItem, rect: QRectF): void =
  fQGraphicsLayoutItem_virtualbase_setGeometry(self.h, rect.h)

type QGraphicsLayoutItemsetGeometryProc* = proc(rect: QRectF): void
...
proc onisEmpty*(self: gen_qgraphicslayoutitem_types.QGraphicsLayoutItem, slot: QGraphicsLayoutItemisEmptyProc) =
  # TODO check subclass
  var tmp = new QGraphicsLayoutItemisEmptyProc
  tmp[] = slot
  GC_ref(tmp)
  fcQGraphicsLayoutItem_override_virtual_isEmpty(self.h, cast[int](addr tmp[]))

proc miqt_exec_callback_QGraphicsLayoutItem_isEmpty(self: ptr cQGraphicsLayoutItem, slot: int): bool {.exportc: "miqt_exec_callback_QGraphicsLayoutItem_isEmpty ".} =
  var nimfunc = cast[ptr QGraphicsLayoutItemisEmptyProc](cast[pointer](slot))

  let virtualReturn = nimfunc[]( )

  virtualReturn
type QGraphicsLayoutItemsizeHintProc* = proc(which: cint, constraint: QSizeF): QSizeF
