...
proc metaObject*(self: gen_qcommonstyle_types.QCommonStyle, ): QMetaObject =
  QMetaObject(h: fcQCommonStyle_metaObject(self.h))
...
proc trUtf8*(_: type gen_qcommonstyle_types.QCommonStyle, s: cstring): string =
  let v_ms = fcQCommonStyle_trUtf8(s)
  let vx_ret = string.fromBytes(toOpenArrayByte(v_ms.data, 0, int(v_ms.len)-1))
  c_free(v_ms.data)
  vx_ret

proc drawPrimitive*(self: gen_qcommonstyle_types.QCommonStyle, pe: cint, opt: QStyleOption, p: QPainter, w: QWidget): void =
  fcQCommonStyle_drawPrimitive(self.h, cint(pe), opt.h, p.h, w.h)

proc drawControl*(self: gen_qcommonstyle_types.QCommonStyle, element: cint, opt: QStyleOption, p: QPainter, w: QWidget): void =
  fcQCommonStyle_drawControl(self.h, cint(element), opt.h, p.h, w.h)

proc subElementRect*(self: gen_qcommonstyle_types.QCommonStyle, r: cint, opt: QStyleOption, widget: QWidget): QRect =
  QRect(h: fcQCommonStyle_subElementRect(self.h, cint(r), opt.h, widget.h))

proc drawComplexControl*(self: gen_qcommonstyle_types.QCommonStyle, cc: cint, opt: QStyleOptionComplex, p: QPainter, w: QWidget): void =
  fcQCommonStyle_drawComplexControl(self.h, cint(cc), opt.h, p.h, w.h)

proc hitTestComplexControl*(self: gen_qcommonstyle_types.QCommonStyle, cc: cint, opt: QStyleOptionComplex, pt: QPoint, w: QWidget): cint =
  cint(fcQCommonStyle_hitTestComplexControl(self.h, cint(cc), opt.h, pt.h, w.h))

proc subControlRect*(self: gen_qcommonstyle_types.QCommonStyle, cc: cint, opt: QStyleOptionComplex, sc: cint, w: QWidget): QRect =
  QRect(h: fcQCommonStyle_subControlRect(self.h, cint(cc), opt.h, cint(sc), w.h))

proc sizeFromContents*(self: gen_qcommonstyle_types.QCommonStyle, ct: cint, opt: QStyleOption, contentsSize: QSize, widget: QWidget): QSize =
  QSize(h: fcQCommonStyle_sizeFromContents(self.h, cint(ct), opt.h, contentsSize.h, widget.h))

proc pixelMetric*(self: gen_qcommonstyle_types.QCommonStyle, m: cint, opt: QStyleOption, widget: QWidget): cint =
  fcQCommonStyle_pixelMetric(self.h, cint(m), opt.h, widget.h)

proc styleHint*(self: gen_qcommonstyle_types.QCommonStyle, sh: cint, opt: QStyleOption, w: QWidget, shret: QStyleHintReturn): cint =
  fcQCommonStyle_styleHint(self.h, cint(sh), opt.h, w.h, shret.h)

proc standardIcon*(self: gen_qcommonstyle_types.QCommonStyle, standardIcon: cint, opt: QStyleOption, widget: QWidget): QIcon =
  QIcon(h: fcQCommonStyle_standardIcon(self.h, cint(standardIcon), opt.h, widget.h))

proc standardPixmap*(self: gen_qcommonstyle_types.QCommonStyle, sp: cint, opt: QStyleOption, widget: QWidget): QPixmap =
  QPixmap(h: fcQCommonStyle_standardPixmap(self.h, cint(sp), opt.h, widget.h))

proc generatedIconPixmap*(self: gen_qcommonstyle_types.QCommonStyle, iconMode: cint, pixmap: QPixmap, opt: QStyleOption): QPixmap =
  QPixmap(h: fcQCommonStyle_generatedIconPixmap(self.h, cint(iconMode), pixmap.h, opt.h))

proc layoutSpacing*(self: gen_qcommonstyle_types.QCommonStyle, control1: cint, control2: cint, orientation: cint, option: QStyleOption, widget: QWidget): cint =
  fcQCommonStyle_layoutSpacing(self.h, cint(control1), cint(control2), cint(orientation), option.h, widget.h)

proc polish*(self: gen_qcommonstyle_types.QCommonStyle, param1: QPalette): void =
  fcQCommonStyle_polish(self.h, param1.h)

proc polish*(self: gen_qcommonstyle_types.QCommonStyle, app: QApplication): void =
  fcQCommonStyle_polishWithApp(self.h, app.h)

proc polish*(self: gen_qcommonstyle_types.QCommonStyle, widget: QWidget): void =
  fcQCommonStyle_polishWithWidget(self.h, widget.h)

proc unpolish*(self: gen_qcommonstyle_types.QCommonStyle, widget: QWidget): void =
  fcQCommonStyle_unpolish(self.h, widget.h)

proc unpolish*(self: gen_qcommonstyle_types.QCommonStyle, application: QApplication): void =
...
proc trUtf8*(_: type gen_qcommonstyle_types.QCommonStyle, s: cstring, c: cstring): string =
  let v_ms = fcQCommonStyle_trUtf82(s, c)
  let vx_ret = string.fromBytes(toOpenArrayByte(v_ms.data, 0, int(v_ms.len)-1))
  c_free(v_ms.data)
  vx_ret

proc trUtf8*(_: type gen_qcommonstyle_types.QCommonStyle, s: cstring, c: cstring, n: cint): string =
...
proc miqt_exec_callback_QCommonStyle_metacall(self: ptr cQCommonStyle, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QCommonStyle_metacall ".} =
  ...
  virtualReturn
proc QCommonStyledrawPrimitive*(self: gen_qcommonstyle_types.QCommonStyle, pe: cint, opt: QStyleOption, p: QPainter, w: QWidget): void =
  fQCommonStyle_virtualbase_drawPrimitive(self.h, cint(pe), opt.h, p.h, w.h)

type QCommonStyledrawPrimitiveProc* = proc(pe: cint, opt: QStyleOption, p: QPainter, w: QWidget): void
...
proc QCommonStyledrawControl*(self: gen_qcommonstyle_types.QCommonStyle, element: cint, opt: QStyleOption, p: QPainter, w: QWidget): void =
  fQCommonStyle_virtualbase_drawControl(self.h, cint(element), opt.h, p.h, w.h)

type QCommonStyledrawControlProc* = proc(element: cint, opt: QStyleOption, p: QPainter, w: QWidget): void
...
proc miqt_exec_callback_QCommonStyle_drawControl(self: ptr cQCommonStyle, slot: int, element: cint, opt: pointer, p: pointer, w: pointer): void {.exportc: "miqt_exec_callback_QCommonStyle_drawControl ".} =
  ...
  nimfunc[](slotval1, slotval2, slotval3, slotval4)
proc QCommonStylesubElementRect*(self: gen_qcommonstyle_types.QCommonStyle, r: cint, opt: QStyleOption, widget: QWidget): QRect =
  QRect(h: fQCommonStyle_virtualbase_subElementRect(self.h, cint(r), opt.h, widget.h))

type QCommonStylesubElementRectProc* = proc(r: cint, opt: QStyleOption, widget: QWidget): QRect
...
proc miqt_exec_callback_QCommonStyle_subElementRect(self: ptr cQCommonStyle, slot: int, r: cint, opt: pointer, widget: pointer): pointer {.exportc: "miqt_exec_callback_QCommonStyle_subElementRect ".} =
  ...
  virtualReturn.h
proc QCommonStyledrawComplexControl*(self: gen_qcommonstyle_types.QCommonStyle, cc: cint, opt: QStyleOptionComplex, p: QPainter, w: QWidget): void =
  fQCommonStyle_virtualbase_drawComplexControl(self.h, cint(cc), opt.h, p.h, w.h)

type QCommonStyledrawComplexControlProc* = proc(cc: cint, opt: QStyleOptionComplex, p: QPainter, w: QWidget): void
...
proc miqt_exec_callback_QCommonStyle_drawComplexControl(self: ptr cQCommonStyle, slot: int, cc: cint, opt: pointer, p: pointer, w: pointer): void {.exportc: "miqt_exec_callback_QCommonStyle_drawComplexControl ".} =
  ...
  nimfunc[](slotval1, slotval2, slotval3, slotval4)
proc QCommonStylehitTestComplexControl*(self: gen_qcommonstyle_types.QCommonStyle, cc: cint, opt: QStyleOptionComplex, pt: QPoint, w: QWidget): cint =
  cint(fQCommonStyle_virtualbase_hitTestComplexControl(self.h, cint(cc), opt.h, pt.h, w.h))

type QCommonStylehitTestComplexControlProc* = proc(cc: cint, opt: QStyleOptionComplex, pt: QPoint, w: QWidget): cint
...
proc miqt_exec_callback_QCommonStyle_hitTestComplexControl(self: ptr cQCommonStyle, slot: int, cc: cint, opt: pointer, pt: pointer, w: pointer): cint {.exportc: "miqt_exec_callback_QCommonStyle_hitTestComplexControl ".} =
  ...
  cint(virtualReturn)
proc QCommonStylesubControlRect*(self: gen_qcommonstyle_types.QCommonStyle, cc: cint, opt: QStyleOptionComplex, sc: cint, w: QWidget): QRect =
  QRect(h: fQCommonStyle_virtualbase_subControlRect(self.h, cint(cc), opt.h, cint(sc), w.h))

type QCommonStylesubControlRectProc* = proc(cc: cint, opt: QStyleOptionComplex, sc: cint, w: QWidget): QRect
...
proc miqt_exec_callback_QCommonStyle_subControlRect(self: ptr cQCommonStyle, slot: int, cc: cint, opt: pointer, sc: cint, w: pointer): pointer {.exportc: "miqt_exec_callback_QCommonStyle_subControlRect ".} =
  ...
  virtualReturn.h
proc QCommonStylesizeFromContents*(self: gen_qcommonstyle_types.QCommonStyle, ct: cint, opt: QStyleOption, contentsSize: QSize, widget: QWidget): QSize =
  QSize(h: fQCommonStyle_virtualbase_sizeFromContents(self.h, cint(ct), opt.h, contentsSize.h, widget.h))

type QCommonStylesizeFromContentsProc* = proc(ct: cint, opt: QStyleOption, contentsSize: QSize, widget: QWidget): QSize
...
proc miqt_exec_callback_QCommonStyle_sizeFromContents(self: ptr cQCommonStyle, slot: int, ct: cint, opt: pointer, contentsSize: pointer, widget: pointer): pointer {.exportc: "miqt_exec_callback_QCommonStyle_sizeFromContents ".} =
  ...
  virtualReturn.h
proc QCommonStylepixelMetric*(self: gen_qcommonstyle_types.QCommonStyle, m: cint, opt: QStyleOption, widget: QWidget): cint =
  fQCommonStyle_virtualbase_pixelMetric(self.h, cint(m), opt.h, widget.h)

type QCommonStylepixelMetricProc* = proc(m: cint, opt: QStyleOption, widget: QWidget): cint
...
proc miqt_exec_callback_QCommonStyle_pixelMetric(self: ptr cQCommonStyle, slot: int, m: cint, opt: pointer, widget: pointer): cint {.exportc: "miqt_exec_callback_QCommonStyle_pixelMetric ".} =
  ...
  virtualReturn
proc QCommonStylestyleHint*(self: gen_qcommonstyle_types.QCommonStyle, sh: cint, opt: QStyleOption, w: QWidget, shret: QStyleHintReturn): cint =
  fQCommonStyle_virtualbase_styleHint(self.h, cint(sh), opt.h, w.h, shret.h)

type QCommonStylestyleHintProc* = proc(sh: cint, opt: QStyleOption, w: QWidget, shret: QStyleHintReturn): cint
...
proc miqt_exec_callback_QCommonStyle_styleHint(self: ptr cQCommonStyle, slot: int, sh: cint, opt: pointer, w: pointer, shret: pointer): cint {.exportc: "miqt_exec_callback_QCommonStyle_styleHint ".} =
  ...
  let slotval3 = QWidget(h: w)

  let slotval4 = QStyleHintReturn(h: shret)


  let virtualReturn = nimfunc[](slotval1, slotval2, slotval3, slotval4 )

  virtualReturn
proc QCommonStylestandardIcon*(self: gen_qcommonstyle_types.QCommonStyle, standardIcon: cint, opt: QStyleOption, widget: QWidget): QIcon =
  QIcon(h: fQCommonStyle_virtualbase_standardIcon(self.h, cint(standardIcon), opt.h, widget.h))

type QCommonStylestandardIconProc* = proc(standardIcon: cint, opt: QStyleOption, widget: QWidget): QIcon
...
proc miqt_exec_callback_QCommonStyle_standardIcon(self: ptr cQCommonStyle, slot: int, standardIcon: cint, opt: pointer, widget: pointer): pointer {.exportc: "miqt_exec_callback_QCommonStyle_standardIcon ".} =
  ...
  virtualReturn.h
proc QCommonStylestandardPixmap*(self: gen_qcommonstyle_types.QCommonStyle, sp: cint, opt: QStyleOption, widget: QWidget): QPixmap =
  QPixmap(h: fQCommonStyle_virtualbase_standardPixmap(self.h, cint(sp), opt.h, widget.h))

type QCommonStylestandardPixmapProc* = proc(sp: cint, opt: QStyleOption, widget: QWidget): QPixmap
...
proc miqt_exec_callback_QCommonStyle_standardPixmap(self: ptr cQCommonStyle, slot: int, sp: cint, opt: pointer, widget: pointer): pointer {.exportc: "miqt_exec_callback_QCommonStyle_standardPixmap ".} =
  ...
  virtualReturn.h
proc QCommonStylegeneratedIconPixmap*(self: gen_qcommonstyle_types.QCommonStyle, iconMode: cint, pixmap: QPixmap, opt: QStyleOption): QPixmap =
  QPixmap(h: fQCommonStyle_virtualbase_generatedIconPixmap(self.h, cint(iconMode), pixmap.h, opt.h))

type QCommonStylegeneratedIconPixmapProc* = proc(iconMode: cint, pixmap: QPixmap, opt: QStyleOption): QPixmap
...
proc miqt_exec_callback_QCommonStyle_generatedIconPixmap(self: ptr cQCommonStyle, slot: int, iconMode: cint, pixmap: pointer, opt: pointer): pointer {.exportc: "miqt_exec_callback_QCommonStyle_generatedIconPixmap ".} =
  ...
  virtualReturn.h
proc QCommonStylelayoutSpacing*(self: gen_qcommonstyle_types.QCommonStyle, control1: cint, control2: cint, orientation: cint, option: QStyleOption, widget: QWidget): cint =
  fQCommonStyle_virtualbase_layoutSpacing(self.h, cint(control1), cint(control2), cint(orientation), option.h, widget.h)

type QCommonStylelayoutSpacingProc* = proc(control1: cint, control2: cint, orientation: cint, option: QStyleOption, widget: QWidget): cint
...
proc miqt_exec_callback_QCommonStyle_layoutSpacing(self: ptr cQCommonStyle, slot: int, control1: cint, control2: cint, orientation: cint, option: pointer, widget: pointer): cint {.exportc: "miqt_exec_callback_QCommonStyle_layoutSpacing ".} =
  ...
  virtualReturn
proc QCommonStylepolish*(self: gen_qcommonstyle_types.QCommonStyle, param1: QPalette): void =
  fQCommonStyle_virtualbase_polish(self.h, param1.h)

type QCommonStylepolishProc* = proc(param1: QPalette): void
...
proc miqt_exec_callback_QCommonStyle_polish(self: ptr cQCommonStyle, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QCommonStyle_polish ".} =
  ...
  let slotval1 = QPalette(h: param1)


  nimfunc[](slotval1)
proc QCommonStylepolish*(self: gen_qcommonstyle_types.QCommonStyle, app: QApplication): void =
  fQCommonStyle_virtualbase_polishWithApp(self.h, app.h)

type QCommonStylepolishWithAppProc* = proc(app: QApplication): void
...
proc miqt_exec_callback_QCommonStyle_polishWithApp(self: ptr cQCommonStyle, slot: int, app: pointer): void {.exportc: "miqt_exec_callback_QCommonStyle_polishWithApp ".} =
  ...
  nimfunc[](slotval1)
proc QCommonStylepolish*(self: gen_qcommonstyle_types.QCommonStyle, widget: QWidget): void =
  fQCommonStyle_virtualbase_polishWithWidget(self.h, widget.h)

type QCommonStylepolishWithWidgetProc* = proc(widget: QWidget): void
...
proc miqt_exec_callback_QCommonStyle_polishWithWidget(self: ptr cQCommonStyle, slot: int, widget: pointer): void {.exportc: "miqt_exec_callback_QCommonStyle_polishWithWidget ".} =
  ...
  nimfunc[](slotval1)
proc QCommonStyleunpolish*(self: gen_qcommonstyle_types.QCommonStyle, widget: QWidget): void =
  fQCommonStyle_virtualbase_unpolish(self.h, widget.h)

type QCommonStyleunpolishProc* = proc(widget: QWidget): void
...
proc miqt_exec_callback_QCommonStyle_unpolish(self: ptr cQCommonStyle, slot: int, widget: pointer): void {.exportc: "miqt_exec_callback_QCommonStyle_unpolish ".} =
  ...
  nimfunc[](slotval1)
proc QCommonStyleunpolish*(self: gen_qcommonstyle_types.QCommonStyle, application: QApplication): void =
  fQCommonStyle_virtualbase_unpolishWithApplication(self.h, application.h)

type QCommonStyleunpolishWithApplicationProc* = proc(application: QApplication): void
...
proc miqt_exec_callback_QCommonStyle_unpolishWithApplication(self: ptr cQCommonStyle, slot: int, application: pointer): void {.exportc: "miqt_exec_callback_QCommonStyle_unpolishWithApplication ".} =
  ...
  nimfunc[](slotval1)
proc QCommonStyleitemTextRect*(self: gen_qcommonstyle_types.QCommonStyle, fm: QFontMetrics, r: QRect, flags: cint, enabled: bool, text: string): QRect =
  QRect(h: fQCommonStyle_virtualbase_itemTextRect(self.h, fm.h, r.h, flags, enabled, struct_miqt_string(data: text, len: csize_t(len(text)))))

type QCommonStyleitemTextRectProc* = proc(fm: QFontMetrics, r: QRect, flags: cint, enabled: bool, text: string): QRect
...
proc miqt_exec_callback_QCommonStyle_itemTextRect(self: ptr cQCommonStyle, slot: int, fm: pointer, r: pointer, flags: cint, enabled: bool, text: struct_miqt_string): pointer {.exportc: "miqt_exec_callback_QCommonStyle_itemTextRect ".} =
  ...
  virtualReturn.h
proc QCommonStyleitemPixmapRect*(self: gen_qcommonstyle_types.QCommonStyle, r: QRect, flags: cint, pixmap: QPixmap): QRect =
  QRect(h: fQCommonStyle_virtualbase_itemPixmapRect(self.h, r.h, flags, pixmap.h))

type QCommonStyleitemPixmapRectProc* = proc(r: QRect, flags: cint, pixmap: QPixmap): QRect
...
proc miqt_exec_callback_QCommonStyle_itemPixmapRect(self: ptr cQCommonStyle, slot: int, r: pointer, flags: cint, pixmap: pointer): pointer {.exportc: "miqt_exec_callback_QCommonStyle_itemPixmapRect ".} =
  ...
  virtualReturn.h
proc QCommonStyledrawItemText*(self: gen_qcommonstyle_types.QCommonStyle, painter: QPainter, rect: QRect, flags: cint, pal: QPalette, enabled: bool, text: string, textRole: cint): void =
...
type QCommonStyledrawItemTextProc* = proc(painter: QPainter, rect: QRect, flags: cint, pal: QPalette, enabled: bool, text: string, textRole: cint): void
...
proc QCommonStyledrawItemPixmap*(self: gen_qcommonstyle_types.QCommonStyle, painter: QPainter, rect: QRect, alignment: cint, pixmap: QPixmap): void =
  fQCommonStyle_virtualbase_drawItemPixmap(self.h, painter.h, rect.h, alignment, pixmap.h)

type QCommonStyledrawItemPixmapProc* = proc(painter: QPainter, rect: QRect, alignment: cint, pixmap: QPixmap): void
...
proc miqt_exec_callback_QCommonStyle_drawItemPixmap(self: ptr cQCommonStyle, slot: int, painter: pointer, rect: pointer, alignment: cint, pixmap: pointer): void {.exportc: "miqt_exec_callback_QCommonStyle_drawItemPixmap ".} =
  ...
  nimfunc[](slotval1, slotval2, slotval3, slotval4)
proc QCommonStylestandardPalette*(self: gen_qcommonstyle_types.QCommonStyle, ): QPalette =
  QPalette(h: fQCommonStyle_virtualbase_standardPalette(self.h))

type QCommonStylestandardPaletteProc* = proc(): QPalette
...
proc miqt_exec_callback_QCommonStyle_standardPalette(self: ptr cQCommonStyle, slot: int): pointer {.exportc: "miqt_exec_callback_QCommonStyle_standardPalette ".} =
  ...
  virtualReturn.h
proc QCommonStyleevent*(self: gen_qcommonstyle_types.QCommonStyle, event: QEvent): bool =
  fQCommonStyle_virtualbase_event(self.h, event.h)

type QCommonStyleeventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QCommonStyle_event(self: ptr cQCommonStyle, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QCommonStyle_event ".} =
  ...
  virtualReturn
proc QCommonStyleeventFilter*(self: gen_qcommonstyle_types.QCommonStyle, watched: QObject, event: QEvent): bool =
  fQCommonStyle_virtualbase_eventFilter(self.h, watched.h, event.h)

type QCommonStyleeventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QCommonStyle_eventFilter(self: ptr cQCommonStyle, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QCommonStyle_eventFilter ".} =
  ...
  virtualReturn
proc QCommonStyletimerEvent*(self: gen_qcommonstyle_types.QCommonStyle, event: QTimerEvent): void =
  fQCommonStyle_virtualbase_timerEvent(self.h, event.h)

type QCommonStyletimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QCommonStyle_timerEvent(self: ptr cQCommonStyle, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QCommonStyle_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QCommonStylechildEvent*(self: gen_qcommonstyle_types.QCommonStyle, event: QChildEvent): void =
  fQCommonStyle_virtualbase_childEvent(self.h, event.h)

type QCommonStylechildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QCommonStyle_childEvent(self: ptr cQCommonStyle, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QCommonStyle_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QCommonStylecustomEvent*(self: gen_qcommonstyle_types.QCommonStyle, event: QEvent): void =
  fQCommonStyle_virtualbase_customEvent(self.h, event.h)

type QCommonStylecustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QCommonStyle_customEvent(self: ptr cQCommonStyle, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QCommonStyle_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QCommonStyleconnectNotify*(self: gen_qcommonstyle_types.QCommonStyle, signal: QMetaMethod): void =
  fQCommonStyle_virtualbase_connectNotify(self.h, signal.h)

type QCommonStyleconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QCommonStyle_connectNotify(self: ptr cQCommonStyle, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QCommonStyle_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QCommonStyledisconnectNotify*(self: gen_qcommonstyle_types.QCommonStyle, signal: QMetaMethod): void =
  fQCommonStyle_virtualbase_disconnectNotify(self.h, signal.h)

type QCommonStyledisconnectNotifyProc* = proc(signal: QMetaMethod): void
