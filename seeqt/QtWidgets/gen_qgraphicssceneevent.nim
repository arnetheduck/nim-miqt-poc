...
proc widget*(self: gen_qgraphicssceneevent_types.QGraphicsSceneEvent, ): QWidget =
  QWidget(h: fcQGraphicsSceneEvent_widget(self.h))

proc setWidget*(self: gen_qgraphicssceneevent_types.QGraphicsSceneEvent, widget: QWidget): void =
...
proc miqt_exec_callback_QGraphicsSceneEvent_setAccepted(self: ptr cQGraphicsSceneEvent, slot: int, accepted: bool): void {.exportc: "miqt_exec_callback_QGraphicsSceneEvent_setAccepted ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsSceneEventclone*(self: gen_qgraphicssceneevent_types.QGraphicsSceneEvent, ): QEvent =
  QEvent(h: fQGraphicsSceneEvent_virtualbase_clone(self.h))

type QGraphicsSceneEventcloneProc* = proc(): QEvent
...
proc pos*(self: gen_qgraphicssceneevent_types.QGraphicsSceneMouseEvent, ): QPointF =
  QPointF(h: fcQGraphicsSceneMouseEvent_pos(self.h))

proc setPos*(self: gen_qgraphicssceneevent_types.QGraphicsSceneMouseEvent, pos: QPointF): void =
  fcQGraphicsSceneMouseEvent_setPos(self.h, pos.h)

proc scenePos*(self: gen_qgraphicssceneevent_types.QGraphicsSceneMouseEvent, ): QPointF =
  QPointF(h: fcQGraphicsSceneMouseEvent_scenePos(self.h))

proc setScenePos*(self: gen_qgraphicssceneevent_types.QGraphicsSceneMouseEvent, pos: QPointF): void =
  fcQGraphicsSceneMouseEvent_setScenePos(self.h, pos.h)

proc screenPos*(self: gen_qgraphicssceneevent_types.QGraphicsSceneMouseEvent, ): QPoint =
  QPoint(h: fcQGraphicsSceneMouseEvent_screenPos(self.h))

proc setScreenPos*(self: gen_qgraphicssceneevent_types.QGraphicsSceneMouseEvent, pos: QPoint): void =
  fcQGraphicsSceneMouseEvent_setScreenPos(self.h, pos.h)

proc buttonDownPos*(self: gen_qgraphicssceneevent_types.QGraphicsSceneMouseEvent, button: cint): QPointF =
  QPointF(h: fcQGraphicsSceneMouseEvent_buttonDownPos(self.h, cint(button)))

proc setButtonDownPos*(self: gen_qgraphicssceneevent_types.QGraphicsSceneMouseEvent, button: cint, pos: QPointF): void =
  fcQGraphicsSceneMouseEvent_setButtonDownPos(self.h, cint(button), pos.h)

proc buttonDownScenePos*(self: gen_qgraphicssceneevent_types.QGraphicsSceneMouseEvent, button: cint): QPointF =
  QPointF(h: fcQGraphicsSceneMouseEvent_buttonDownScenePos(self.h, cint(button)))

proc setButtonDownScenePos*(self: gen_qgraphicssceneevent_types.QGraphicsSceneMouseEvent, button: cint, pos: QPointF): void =
  fcQGraphicsSceneMouseEvent_setButtonDownScenePos(self.h, cint(button), pos.h)

proc buttonDownScreenPos*(self: gen_qgraphicssceneevent_types.QGraphicsSceneMouseEvent, button: cint): QPoint =
  QPoint(h: fcQGraphicsSceneMouseEvent_buttonDownScreenPos(self.h, cint(button)))

proc setButtonDownScreenPos*(self: gen_qgraphicssceneevent_types.QGraphicsSceneMouseEvent, button: cint, pos: QPoint): void =
  fcQGraphicsSceneMouseEvent_setButtonDownScreenPos(self.h, cint(button), pos.h)

proc lastPos*(self: gen_qgraphicssceneevent_types.QGraphicsSceneMouseEvent, ): QPointF =
  QPointF(h: fcQGraphicsSceneMouseEvent_lastPos(self.h))

proc setLastPos*(self: gen_qgraphicssceneevent_types.QGraphicsSceneMouseEvent, pos: QPointF): void =
  fcQGraphicsSceneMouseEvent_setLastPos(self.h, pos.h)

proc lastScenePos*(self: gen_qgraphicssceneevent_types.QGraphicsSceneMouseEvent, ): QPointF =
  QPointF(h: fcQGraphicsSceneMouseEvent_lastScenePos(self.h))

proc setLastScenePos*(self: gen_qgraphicssceneevent_types.QGraphicsSceneMouseEvent, pos: QPointF): void =
  fcQGraphicsSceneMouseEvent_setLastScenePos(self.h, pos.h)

proc lastScreenPos*(self: gen_qgraphicssceneevent_types.QGraphicsSceneMouseEvent, ): QPoint =
  QPoint(h: fcQGraphicsSceneMouseEvent_lastScreenPos(self.h))

proc setLastScreenPos*(self: gen_qgraphicssceneevent_types.QGraphicsSceneMouseEvent, pos: QPoint): void =
...
proc miqt_exec_callback_QGraphicsSceneMouseEvent_setAccepted(self: ptr cQGraphicsSceneMouseEvent, slot: int, accepted: bool): void {.exportc: "miqt_exec_callback_QGraphicsSceneMouseEvent_setAccepted ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsSceneMouseEventclone*(self: gen_qgraphicssceneevent_types.QGraphicsSceneMouseEvent, ): QEvent =
  QEvent(h: fQGraphicsSceneMouseEvent_virtualbase_clone(self.h))

type QGraphicsSceneMouseEventcloneProc* = proc(): QEvent
...
proc pos*(self: gen_qgraphicssceneevent_types.QGraphicsSceneWheelEvent, ): QPointF =
  QPointF(h: fcQGraphicsSceneWheelEvent_pos(self.h))

proc setPos*(self: gen_qgraphicssceneevent_types.QGraphicsSceneWheelEvent, pos: QPointF): void =
  fcQGraphicsSceneWheelEvent_setPos(self.h, pos.h)

proc scenePos*(self: gen_qgraphicssceneevent_types.QGraphicsSceneWheelEvent, ): QPointF =
  QPointF(h: fcQGraphicsSceneWheelEvent_scenePos(self.h))

proc setScenePos*(self: gen_qgraphicssceneevent_types.QGraphicsSceneWheelEvent, pos: QPointF): void =
  fcQGraphicsSceneWheelEvent_setScenePos(self.h, pos.h)

proc screenPos*(self: gen_qgraphicssceneevent_types.QGraphicsSceneWheelEvent, ): QPoint =
  QPoint(h: fcQGraphicsSceneWheelEvent_screenPos(self.h))

proc setScreenPos*(self: gen_qgraphicssceneevent_types.QGraphicsSceneWheelEvent, pos: QPoint): void =
...
proc pixelDelta*(self: gen_qgraphicssceneevent_types.QGraphicsSceneWheelEvent, ): QPoint =
  QPoint(h: fcQGraphicsSceneWheelEvent_pixelDelta(self.h))

proc setPixelDelta*(self: gen_qgraphicssceneevent_types.QGraphicsSceneWheelEvent, delta: QPoint): void =
...
proc miqt_exec_callback_QGraphicsSceneWheelEvent_setAccepted(self: ptr cQGraphicsSceneWheelEvent, slot: int, accepted: bool): void {.exportc: "miqt_exec_callback_QGraphicsSceneWheelEvent_setAccepted ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsSceneWheelEventclone*(self: gen_qgraphicssceneevent_types.QGraphicsSceneWheelEvent, ): QEvent =
  QEvent(h: fQGraphicsSceneWheelEvent_virtualbase_clone(self.h))

type QGraphicsSceneWheelEventcloneProc* = proc(): QEvent
...
proc pos*(self: gen_qgraphicssceneevent_types.QGraphicsSceneContextMenuEvent, ): QPointF =
  QPointF(h: fcQGraphicsSceneContextMenuEvent_pos(self.h))

proc setPos*(self: gen_qgraphicssceneevent_types.QGraphicsSceneContextMenuEvent, pos: QPointF): void =
  fcQGraphicsSceneContextMenuEvent_setPos(self.h, pos.h)

proc scenePos*(self: gen_qgraphicssceneevent_types.QGraphicsSceneContextMenuEvent, ): QPointF =
  QPointF(h: fcQGraphicsSceneContextMenuEvent_scenePos(self.h))

proc setScenePos*(self: gen_qgraphicssceneevent_types.QGraphicsSceneContextMenuEvent, pos: QPointF): void =
  fcQGraphicsSceneContextMenuEvent_setScenePos(self.h, pos.h)

proc screenPos*(self: gen_qgraphicssceneevent_types.QGraphicsSceneContextMenuEvent, ): QPoint =
  QPoint(h: fcQGraphicsSceneContextMenuEvent_screenPos(self.h))

proc setScreenPos*(self: gen_qgraphicssceneevent_types.QGraphicsSceneContextMenuEvent, pos: QPoint): void =
...
proc miqt_exec_callback_QGraphicsSceneContextMenuEvent_setAccepted(self: ptr cQGraphicsSceneContextMenuEvent, slot: int, accepted: bool): void {.exportc: "miqt_exec_callback_QGraphicsSceneContextMenuEvent_setAccepted ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsSceneContextMenuEventclone*(self: gen_qgraphicssceneevent_types.QGraphicsSceneContextMenuEvent, ): QEvent =
  QEvent(h: fQGraphicsSceneContextMenuEvent_virtualbase_clone(self.h))

type QGraphicsSceneContextMenuEventcloneProc* = proc(): QEvent
...
proc pos*(self: gen_qgraphicssceneevent_types.QGraphicsSceneHoverEvent, ): QPointF =
  QPointF(h: fcQGraphicsSceneHoverEvent_pos(self.h))

proc setPos*(self: gen_qgraphicssceneevent_types.QGraphicsSceneHoverEvent, pos: QPointF): void =
  fcQGraphicsSceneHoverEvent_setPos(self.h, pos.h)

proc scenePos*(self: gen_qgraphicssceneevent_types.QGraphicsSceneHoverEvent, ): QPointF =
  QPointF(h: fcQGraphicsSceneHoverEvent_scenePos(self.h))

proc setScenePos*(self: gen_qgraphicssceneevent_types.QGraphicsSceneHoverEvent, pos: QPointF): void =
  fcQGraphicsSceneHoverEvent_setScenePos(self.h, pos.h)

proc screenPos*(self: gen_qgraphicssceneevent_types.QGraphicsSceneHoverEvent, ): QPoint =
  QPoint(h: fcQGraphicsSceneHoverEvent_screenPos(self.h))

proc setScreenPos*(self: gen_qgraphicssceneevent_types.QGraphicsSceneHoverEvent, pos: QPoint): void =
  fcQGraphicsSceneHoverEvent_setScreenPos(self.h, pos.h)

proc lastPos*(self: gen_qgraphicssceneevent_types.QGraphicsSceneHoverEvent, ): QPointF =
  QPointF(h: fcQGraphicsSceneHoverEvent_lastPos(self.h))

proc setLastPos*(self: gen_qgraphicssceneevent_types.QGraphicsSceneHoverEvent, pos: QPointF): void =
  fcQGraphicsSceneHoverEvent_setLastPos(self.h, pos.h)

proc lastScenePos*(self: gen_qgraphicssceneevent_types.QGraphicsSceneHoverEvent, ): QPointF =
  QPointF(h: fcQGraphicsSceneHoverEvent_lastScenePos(self.h))

proc setLastScenePos*(self: gen_qgraphicssceneevent_types.QGraphicsSceneHoverEvent, pos: QPointF): void =
  fcQGraphicsSceneHoverEvent_setLastScenePos(self.h, pos.h)

proc lastScreenPos*(self: gen_qgraphicssceneevent_types.QGraphicsSceneHoverEvent, ): QPoint =
  QPoint(h: fcQGraphicsSceneHoverEvent_lastScreenPos(self.h))

proc setLastScreenPos*(self: gen_qgraphicssceneevent_types.QGraphicsSceneHoverEvent, pos: QPoint): void =
...
proc miqt_exec_callback_QGraphicsSceneHoverEvent_setAccepted(self: ptr cQGraphicsSceneHoverEvent, slot: int, accepted: bool): void {.exportc: "miqt_exec_callback_QGraphicsSceneHoverEvent_setAccepted ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsSceneHoverEventclone*(self: gen_qgraphicssceneevent_types.QGraphicsSceneHoverEvent, ): QEvent =
  QEvent(h: fQGraphicsSceneHoverEvent_virtualbase_clone(self.h))

type QGraphicsSceneHoverEventcloneProc* = proc(): QEvent
...
proc scenePos*(self: gen_qgraphicssceneevent_types.QGraphicsSceneHelpEvent, ): QPointF =
  QPointF(h: fcQGraphicsSceneHelpEvent_scenePos(self.h))

proc setScenePos*(self: gen_qgraphicssceneevent_types.QGraphicsSceneHelpEvent, pos: QPointF): void =
  fcQGraphicsSceneHelpEvent_setScenePos(self.h, pos.h)

proc screenPos*(self: gen_qgraphicssceneevent_types.QGraphicsSceneHelpEvent, ): QPoint =
  QPoint(h: fcQGraphicsSceneHelpEvent_screenPos(self.h))

proc setScreenPos*(self: gen_qgraphicssceneevent_types.QGraphicsSceneHelpEvent, pos: QPoint): void =
...
proc miqt_exec_callback_QGraphicsSceneHelpEvent_setAccepted(self: ptr cQGraphicsSceneHelpEvent, slot: int, accepted: bool): void {.exportc: "miqt_exec_callback_QGraphicsSceneHelpEvent_setAccepted ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsSceneHelpEventclone*(self: gen_qgraphicssceneevent_types.QGraphicsSceneHelpEvent, ): QEvent =
  QEvent(h: fQGraphicsSceneHelpEvent_virtualbase_clone(self.h))

type QGraphicsSceneHelpEventcloneProc* = proc(): QEvent
...
proc pos*(self: gen_qgraphicssceneevent_types.QGraphicsSceneDragDropEvent, ): QPointF =
  QPointF(h: fcQGraphicsSceneDragDropEvent_pos(self.h))

proc setPos*(self: gen_qgraphicssceneevent_types.QGraphicsSceneDragDropEvent, pos: QPointF): void =
  fcQGraphicsSceneDragDropEvent_setPos(self.h, pos.h)

proc scenePos*(self: gen_qgraphicssceneevent_types.QGraphicsSceneDragDropEvent, ): QPointF =
  QPointF(h: fcQGraphicsSceneDragDropEvent_scenePos(self.h))

proc setScenePos*(self: gen_qgraphicssceneevent_types.QGraphicsSceneDragDropEvent, pos: QPointF): void =
  fcQGraphicsSceneDragDropEvent_setScenePos(self.h, pos.h)

proc screenPos*(self: gen_qgraphicssceneevent_types.QGraphicsSceneDragDropEvent, ): QPoint =
  QPoint(h: fcQGraphicsSceneDragDropEvent_screenPos(self.h))

proc setScreenPos*(self: gen_qgraphicssceneevent_types.QGraphicsSceneDragDropEvent, pos: QPoint): void =
...
proc source*(self: gen_qgraphicssceneevent_types.QGraphicsSceneDragDropEvent, ): QWidget =
  QWidget(h: fcQGraphicsSceneDragDropEvent_source(self.h))

proc setSource*(self: gen_qgraphicssceneevent_types.QGraphicsSceneDragDropEvent, source: QWidget): void =
  fcQGraphicsSceneDragDropEvent_setSource(self.h, source.h)

proc mimeData*(self: gen_qgraphicssceneevent_types.QGraphicsSceneDragDropEvent, ): QMimeData =
  QMimeData(h: fcQGraphicsSceneDragDropEvent_mimeData(self.h))

proc setMimeData*(self: gen_qgraphicssceneevent_types.QGraphicsSceneDragDropEvent, data: QMimeData): void =
...
proc miqt_exec_callback_QGraphicsSceneDragDropEvent_setAccepted(self: ptr cQGraphicsSceneDragDropEvent, slot: int, accepted: bool): void {.exportc: "miqt_exec_callback_QGraphicsSceneDragDropEvent_setAccepted ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsSceneDragDropEventclone*(self: gen_qgraphicssceneevent_types.QGraphicsSceneDragDropEvent, ): QEvent =
  QEvent(h: fQGraphicsSceneDragDropEvent_virtualbase_clone(self.h))

type QGraphicsSceneDragDropEventcloneProc* = proc(): QEvent
...
proc oldSize*(self: gen_qgraphicssceneevent_types.QGraphicsSceneResizeEvent, ): QSizeF =
  QSizeF(h: fcQGraphicsSceneResizeEvent_oldSize(self.h))

proc setOldSize*(self: gen_qgraphicssceneevent_types.QGraphicsSceneResizeEvent, size: QSizeF): void =
  fcQGraphicsSceneResizeEvent_setOldSize(self.h, size.h)

proc newSize*(self: gen_qgraphicssceneevent_types.QGraphicsSceneResizeEvent, ): QSizeF =
  QSizeF(h: fcQGraphicsSceneResizeEvent_newSize(self.h))

proc setNewSize*(self: gen_qgraphicssceneevent_types.QGraphicsSceneResizeEvent, size: QSizeF): void =
...
proc miqt_exec_callback_QGraphicsSceneResizeEvent_setAccepted(self: ptr cQGraphicsSceneResizeEvent, slot: int, accepted: bool): void {.exportc: "miqt_exec_callback_QGraphicsSceneResizeEvent_setAccepted ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsSceneResizeEventclone*(self: gen_qgraphicssceneevent_types.QGraphicsSceneResizeEvent, ): QEvent =
  QEvent(h: fQGraphicsSceneResizeEvent_virtualbase_clone(self.h))

type QGraphicsSceneResizeEventcloneProc* = proc(): QEvent
...
proc oldPos*(self: gen_qgraphicssceneevent_types.QGraphicsSceneMoveEvent, ): QPointF =
  QPointF(h: fcQGraphicsSceneMoveEvent_oldPos(self.h))

proc setOldPos*(self: gen_qgraphicssceneevent_types.QGraphicsSceneMoveEvent, pos: QPointF): void =
  fcQGraphicsSceneMoveEvent_setOldPos(self.h, pos.h)

proc newPos*(self: gen_qgraphicssceneevent_types.QGraphicsSceneMoveEvent, ): QPointF =
  QPointF(h: fcQGraphicsSceneMoveEvent_newPos(self.h))

proc setNewPos*(self: gen_qgraphicssceneevent_types.QGraphicsSceneMoveEvent, pos: QPointF): void =
...
proc miqt_exec_callback_QGraphicsSceneMoveEvent_setAccepted(self: ptr cQGraphicsSceneMoveEvent, slot: int, accepted: bool): void {.exportc: "miqt_exec_callback_QGraphicsSceneMoveEvent_setAccepted ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsSceneMoveEventclone*(self: gen_qgraphicssceneevent_types.QGraphicsSceneMoveEvent, ): QEvent =
  QEvent(h: fQGraphicsSceneMoveEvent_virtualbase_clone(self.h))

type QGraphicsSceneMoveEventcloneProc* = proc(): QEvent
