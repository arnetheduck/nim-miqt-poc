...
proc create*(T: type gen_qundogroup_types.QUndoGroup, parent: QObject): gen_qundogroup_types.QUndoGroup =
  gen_qundogroup_types.QUndoGroup.init(fcQUndoGroup_new2(parent.h))

proc metaObject*(self: gen_qundogroup_types.QUndoGroup, ): QMetaObject =
  QMetaObject(h: fcQUndoGroup_metaObject(self.h))
...
proc addStack*(self: gen_qundogroup_types.QUndoGroup, stack: QUndoStack): void =
  fcQUndoGroup_addStack(self.h, stack.h)

proc removeStack*(self: gen_qundogroup_types.QUndoGroup, stack: QUndoStack): void =
  fcQUndoGroup_removeStack(self.h, stack.h)

proc stacks*(self: gen_qundogroup_types.QUndoGroup, ): seq[QUndoStack] =
  var v_ma = fcQUndoGroup_stacks(self.h)
  var vx_ret = newSeq[QUndoStack](int(v_ma.len))
  let v_outCast = cast[ptr UncheckedArray[pointer]](v_ma.data)
  for i in 0 ..< v_ma.len:
    vx_ret[i] = QUndoStack(h: v_outCast[i])
  vx_ret

proc activeStack*(self: gen_qundogroup_types.QUndoGroup, ): QUndoStack =
  QUndoStack(h: fcQUndoGroup_activeStack(self.h))
...
proc setActiveStack*(self: gen_qundogroup_types.QUndoGroup, stack: QUndoStack): void =
  fcQUndoGroup_setActiveStack(self.h, stack.h)

proc activeStackChanged*(self: gen_qundogroup_types.QUndoGroup, stack: QUndoStack): void =
  fcQUndoGroup_activeStackChanged(self.h, stack.h)

type QUndoGroupactiveStackChangedSlot* = proc(stack: QUndoStack)
proc miqt_exec_callback_QUndoGroup_activeStackChanged(slot: int, stack: pointer) {.exportc.} =
  ...
  let slotval1 = QUndoStack(h: stack)
...
proc miqt_exec_callback_QUndoGroup_metacall(self: ptr cQUndoGroup, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QUndoGroup_metacall ".} =
  ...
  virtualReturn
proc QUndoGroupevent*(self: gen_qundogroup_types.QUndoGroup, event: QEvent): bool =
  fQUndoGroup_virtualbase_event(self.h, event.h)

type QUndoGroupeventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QUndoGroup_event(self: ptr cQUndoGroup, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QUndoGroup_event ".} =
  ...
  virtualReturn
proc QUndoGroupeventFilter*(self: gen_qundogroup_types.QUndoGroup, watched: QObject, event: QEvent): bool =
  fQUndoGroup_virtualbase_eventFilter(self.h, watched.h, event.h)

type QUndoGroupeventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QUndoGroup_eventFilter(self: ptr cQUndoGroup, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QUndoGroup_eventFilter ".} =
  ...
  virtualReturn
proc QUndoGrouptimerEvent*(self: gen_qundogroup_types.QUndoGroup, event: QTimerEvent): void =
  fQUndoGroup_virtualbase_timerEvent(self.h, event.h)

type QUndoGrouptimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QUndoGroup_timerEvent(self: ptr cQUndoGroup, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QUndoGroup_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QUndoGroupchildEvent*(self: gen_qundogroup_types.QUndoGroup, event: QChildEvent): void =
  fQUndoGroup_virtualbase_childEvent(self.h, event.h)

type QUndoGroupchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QUndoGroup_childEvent(self: ptr cQUndoGroup, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QUndoGroup_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QUndoGroupcustomEvent*(self: gen_qundogroup_types.QUndoGroup, event: QEvent): void =
  fQUndoGroup_virtualbase_customEvent(self.h, event.h)

type QUndoGroupcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QUndoGroup_customEvent(self: ptr cQUndoGroup, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QUndoGroup_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QUndoGroupconnectNotify*(self: gen_qundogroup_types.QUndoGroup, signal: QMetaMethod): void =
  fQUndoGroup_virtualbase_connectNotify(self.h, signal.h)

type QUndoGroupconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QUndoGroup_connectNotify(self: ptr cQUndoGroup, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QUndoGroup_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QUndoGroupdisconnectNotify*(self: gen_qundogroup_types.QUndoGroup, signal: QMetaMethod): void =
  fQUndoGroup_virtualbase_disconnectNotify(self.h, signal.h)

type QUndoGroupdisconnectNotifyProc* = proc(signal: QMetaMethod): void
