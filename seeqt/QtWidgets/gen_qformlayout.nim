...
proc fQFormLayout_virtualbase_spacing(self: pointer, ): cint{.importc: "QFormLayout_virtualbase_spacing".}
proc fcQFormLayout_override_virtual_spacing(self: pointer, slot: int) {.importc: "QFormLayout_override_virtual_spacing".}
proc fQFormLayout_virtualbase_setSpacing(self: pointer, spacing: cint): void{.importc: "QFormLayout_virtualbase_setSpacing".}
proc fcQFormLayout_override_virtual_setSpacing(self: pointer, slot: int) {.importc: "QFormLayout_override_virtual_setSpacing".}
...
proc fQFormLayout_virtualbase_replaceWidget(self: pointer, fromVal: pointer, to: pointer, options: cint): pointer{.importc: "QFormLayout_virtualbase_replaceWidget".}
proc fcQFormLayout_override_virtual_replaceWidget(self: pointer, slot: int) {.importc: "QFormLayout_override_virtual_replaceWidget".}
...
func init*(T: type gen_qformlayout_types.QFormLayout, h: ptr cQFormLayout): gen_qformlayout_types.QFormLayout =
  T(h: h)
proc create*(T: type gen_qformlayout_types.QFormLayout, parent: QWidget): gen_qformlayout_types.QFormLayout =
...
proc metaObject*(self: gen_qformlayout_types.QFormLayout, ): QMetaObject =
  QMetaObject(h: fcQFormLayout_metaObject(self.h))
...
proc addRow*(self: gen_qformlayout_types.QFormLayout, label: QWidget, field: QWidget): void =
  fcQFormLayout_addRow(self.h, label.h, field.h)

proc addRow*(self: gen_qformlayout_types.QFormLayout, label: QWidget, field: QLayout): void =
  fcQFormLayout_addRow2(self.h, label.h, field.h)

proc addRow*(self: gen_qformlayout_types.QFormLayout, labelText: string, field: QWidget): void =
  fcQFormLayout_addRow3(self.h, struct_miqt_string(data: labelText, len: csize_t(len(labelText))), field.h)

proc addRow*(self: gen_qformlayout_types.QFormLayout, labelText: string, field: QLayout): void =
  fcQFormLayout_addRow4(self.h, struct_miqt_string(data: labelText, len: csize_t(len(labelText))), field.h)

proc addRow*(self: gen_qformlayout_types.QFormLayout, widget: QWidget): void =
  fcQFormLayout_addRowWithWidget(self.h, widget.h)

proc addRow*(self: gen_qformlayout_types.QFormLayout, layout: QLayout): void =
  fcQFormLayout_addRowWithLayout(self.h, layout.h)

proc insertRow*(self: gen_qformlayout_types.QFormLayout, row: cint, label: QWidget, field: QWidget): void =
  fcQFormLayout_insertRow(self.h, row, label.h, field.h)

proc insertRow*(self: gen_qformlayout_types.QFormLayout, row: cint, label: QWidget, field: QLayout): void =
  fcQFormLayout_insertRow2(self.h, row, label.h, field.h)

proc insertRow*(self: gen_qformlayout_types.QFormLayout, row: cint, labelText: string, field: QWidget): void =
  fcQFormLayout_insertRow3(self.h, row, struct_miqt_string(data: labelText, len: csize_t(len(labelText))), field.h)

proc insertRow*(self: gen_qformlayout_types.QFormLayout, row: cint, labelText: string, field: QLayout): void =
  fcQFormLayout_insertRow4(self.h, row, struct_miqt_string(data: labelText, len: csize_t(len(labelText))), field.h)

proc insertRow*(self: gen_qformlayout_types.QFormLayout, row: cint, widget: QWidget): void =
  fcQFormLayout_insertRow5(self.h, row, widget.h)

proc insertRow*(self: gen_qformlayout_types.QFormLayout, row: cint, layout: QLayout): void =
...
proc removeRow*(self: gen_qformlayout_types.QFormLayout, widget: QWidget): void =
  fcQFormLayout_removeRowWithWidget(self.h, widget.h)

proc removeRow*(self: gen_qformlayout_types.QFormLayout, layout: QLayout): void =
  fcQFormLayout_removeRowWithLayout(self.h, layout.h)

proc takeRow*(self: gen_qformlayout_types.QFormLayout, row: cint): QFormLayoutTakeRowResult =
  QFormLayoutTakeRowResult(h: fcQFormLayout_takeRow(self.h, row))

proc takeRow*(self: gen_qformlayout_types.QFormLayout, widget: QWidget): QFormLayoutTakeRowResult =
  QFormLayoutTakeRowResult(h: fcQFormLayout_takeRowWithWidget(self.h, widget.h))

proc takeRow*(self: gen_qformlayout_types.QFormLayout, layout: QLayout): QFormLayoutTakeRowResult =
  QFormLayoutTakeRowResult(h: fcQFormLayout_takeRowWithLayout(self.h, layout.h))

proc setItem*(self: gen_qformlayout_types.QFormLayout, row: cint, role: cint, item: QLayoutItem): void =
  fcQFormLayout_setItem(self.h, row, cint(role), item.h)

proc setWidget*(self: gen_qformlayout_types.QFormLayout, row: cint, role: cint, widget: QWidget): void =
  fcQFormLayout_setWidget(self.h, row, cint(role), widget.h)

proc setLayout*(self: gen_qformlayout_types.QFormLayout, row: cint, role: cint, layout: QLayout): void =
...
proc setRowVisible*(self: gen_qformlayout_types.QFormLayout, widget: QWidget, on: bool): void =
  fcQFormLayout_setRowVisible2(self.h, widget.h, on)

proc setRowVisible*(self: gen_qformlayout_types.QFormLayout, layout: QLayout, on: bool): void =
...
proc isRowVisible*(self: gen_qformlayout_types.QFormLayout, widget: QWidget): bool =
  fcQFormLayout_isRowVisibleWithWidget(self.h, widget.h)

proc isRowVisible*(self: gen_qformlayout_types.QFormLayout, layout: QLayout): bool =
  fcQFormLayout_isRowVisibleWithLayout(self.h, layout.h)

proc itemAt*(self: gen_qformlayout_types.QFormLayout, row: cint, role: cint): QLayoutItem =
  QLayoutItem(h: fcQFormLayout_itemAt(self.h, row, cint(role)))

proc labelForField*(self: gen_qformlayout_types.QFormLayout, field: QWidget): QWidget =
  QWidget(h: fcQFormLayout_labelForField(self.h, field.h))

proc labelForField*(self: gen_qformlayout_types.QFormLayout, field: QLayout): QWidget =
  QWidget(h: fcQFormLayout_labelForFieldWithField(self.h, field.h))

proc addItem*(self: gen_qformlayout_types.QFormLayout, item: QLayoutItem): void =
  fcQFormLayout_addItem(self.h, item.h)

proc itemAt*(self: gen_qformlayout_types.QFormLayout, index: cint): QLayoutItem =
  QLayoutItem(h: fcQFormLayout_itemAtWithIndex(self.h, index))

proc takeAt*(self: gen_qformlayout_types.QFormLayout, index: cint): QLayoutItem =
  QLayoutItem(h: fcQFormLayout_takeAt(self.h, index))

proc setGeometry*(self: gen_qformlayout_types.QFormLayout, rect: QRect): void =
  fcQFormLayout_setGeometry(self.h, rect.h)

proc minimumSize*(self: gen_qformlayout_types.QFormLayout, ): QSize =
  QSize(h: fcQFormLayout_minimumSize(self.h))

proc sizeHint*(self: gen_qformlayout_types.QFormLayout, ): QSize =
  QSize(h: fcQFormLayout_sizeHint(self.h))
...
proc onmetacall*(self: gen_qformlayout_types.QFormLayout, slot: QFormLayoutmetacallProc) =
  # TODO check subclass
  var tmp = new QFormLayoutmetacallProc
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QFormLayout_metacall(self: ptr cQFormLayout, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QFormLayout_metacall ".} =
  var nimfunc = cast[ptr QFormLayoutmetacallProc](cast[pointer](slot))
...
proc onspacing*(self: gen_qformlayout_types.QFormLayout, slot: QFormLayoutspacingProc) =
  # TODO check subclass
  var tmp = new QFormLayoutspacingProc
  tmp[] = slot
  GC_ref(tmp)
  fcQFormLayout_override_virtual_spacing(self.h, cast[int](addr tmp[]))

proc miqt_exec_callback_QFormLayout_spacing(self: ptr cQFormLayout, slot: int): cint {.exportc: "miqt_exec_callback_QFormLayout_spacing ".} =
  var nimfunc = cast[ptr QFormLayoutspacingProc](cast[pointer](slot))
...
proc onsetSpacing*(self: gen_qformlayout_types.QFormLayout, slot: QFormLayoutsetSpacingProc) =
  # TODO check subclass
  var tmp = new QFormLayoutsetSpacingProc
  tmp[] = slot
  GC_ref(tmp)
  fcQFormLayout_override_virtual_setSpacing(self.h, cast[int](addr tmp[]))

proc miqt_exec_callback_QFormLayout_setSpacing(self: ptr cQFormLayout, slot: int, spacing: cint): void {.exportc: "miqt_exec_callback_QFormLayout_setSpacing ".} =
  var nimfunc = cast[ptr QFormLayoutsetSpacingProc](cast[pointer](slot))
  let slotval1 = spacing


  nimfunc[](slotval1)
proc QFormLayoutaddItem*(self: gen_qformlayout_types.QFormLayout, item: QLayoutItem): void =
  fQFormLayout_virtualbase_addItem(self.h, item.h)

type QFormLayoutaddItemProc* = proc(item: QLayoutItem): void
...
proc miqt_exec_callback_QFormLayout_addItem(self: ptr cQFormLayout, slot: int, item: pointer): void {.exportc: "miqt_exec_callback_QFormLayout_addItem ".} =
  ...
  let slotval1 = QLayoutItem(h: item)


  nimfunc[](slotval1)
proc QFormLayoutitemAt*(self: gen_qformlayout_types.QFormLayout, index: cint): QLayoutItem =
  QLayoutItem(h: fQFormLayout_virtualbase_itemAtWithIndex(self.h, index))

type QFormLayoutitemAtWithIndexProc* = proc(index: cint): QLayoutItem
...
proc miqt_exec_callback_QFormLayout_itemAtWithIndex(self: ptr cQFormLayout, slot: int, index: cint): pointer {.exportc: "miqt_exec_callback_QFormLayout_itemAtWithIndex ".} =
  ...
  virtualReturn.h
proc QFormLayouttakeAt*(self: gen_qformlayout_types.QFormLayout, index: cint): QLayoutItem =
  QLayoutItem(h: fQFormLayout_virtualbase_takeAt(self.h, index))

type QFormLayouttakeAtProc* = proc(index: cint): QLayoutItem
...
proc miqt_exec_callback_QFormLayout_takeAt(self: ptr cQFormLayout, slot: int, index: cint): pointer {.exportc: "miqt_exec_callback_QFormLayout_takeAt ".} =
  ...
  virtualReturn.h
proc QFormLayoutsetGeometry*(self: gen_qformlayout_types.QFormLayout, rect: QRect): void =
  fQFormLayout_virtualbase_setGeometry(self.h, rect.h)

type QFormLayoutsetGeometryProc* = proc(rect: QRect): void
...
proc miqt_exec_callback_QFormLayout_setGeometry(self: ptr cQFormLayout, slot: int, rect: pointer): void {.exportc: "miqt_exec_callback_QFormLayout_setGeometry ".} =
  ...
  nimfunc[](slotval1)
proc QFormLayoutminimumSize*(self: gen_qformlayout_types.QFormLayout, ): QSize =
  QSize(h: fQFormLayout_virtualbase_minimumSize(self.h))

type QFormLayoutminimumSizeProc* = proc(): QSize
...
proc miqt_exec_callback_QFormLayout_minimumSize(self: ptr cQFormLayout, slot: int): pointer {.exportc: "miqt_exec_callback_QFormLayout_minimumSize ".} =
  ...
  virtualReturn.h
proc QFormLayoutsizeHint*(self: gen_qformlayout_types.QFormLayout, ): QSize =
  QSize(h: fQFormLayout_virtualbase_sizeHint(self.h))

type QFormLayoutsizeHintProc* = proc(): QSize
...
proc miqt_exec_callback_QFormLayout_count(self: ptr cQFormLayout, slot: int): cint {.exportc: "miqt_exec_callback_QFormLayout_count ".} =
  ...
  virtualReturn
proc QFormLayoutgeometry*(self: gen_qformlayout_types.QFormLayout, ): QRect =
  QRect(h: fQFormLayout_virtualbase_geometry(self.h))

type QFormLayoutgeometryProc* = proc(): QRect
...
proc miqt_exec_callback_QFormLayout_geometry(self: ptr cQFormLayout, slot: int): pointer {.exportc: "miqt_exec_callback_QFormLayout_geometry ".} =
  ...
  virtualReturn.h
proc QFormLayoutmaximumSize*(self: gen_qformlayout_types.QFormLayout, ): QSize =
  QSize(h: fQFormLayout_virtualbase_maximumSize(self.h))

type QFormLayoutmaximumSizeProc* = proc(): QSize
...
proc miqt_exec_callback_QFormLayout_maximumSize(self: ptr cQFormLayout, slot: int): pointer {.exportc: "miqt_exec_callback_QFormLayout_maximumSize ".} =
  ...
  virtualReturn.h
proc QFormLayoutindexOf*(self: gen_qformlayout_types.QFormLayout, param1: QWidget): cint =
  fQFormLayout_virtualbase_indexOf(self.h, param1.h)

type QFormLayoutindexOfProc* = proc(param1: QWidget): cint
...
proc miqt_exec_callback_QFormLayout_controlTypes(self: ptr cQFormLayout, slot: int): cint {.exportc: "miqt_exec_callback_QFormLayout_controlTypes ".} =
  ...
  cint(virtualReturn)
proc QFormLayoutreplaceWidget*(self: gen_qformlayout_types.QFormLayout, fromVal: QWidget, to: QWidget, options: cint): QLayoutItem =
  QLayoutItem(h: fQFormLayout_virtualbase_replaceWidget(self.h, fromVal.h, to.h, cint(options)))

type QFormLayoutreplaceWidgetProc* = proc(fromVal: QWidget, to: QWidget, options: cint): QLayoutItem
proc onreplaceWidget*(self: gen_qformlayout_types.QFormLayout, slot: QFormLayoutreplaceWidgetProc) =
  # TODO check subclass
  var tmp = new QFormLayoutreplaceWidgetProc
  tmp[] = slot
  GC_ref(tmp)
  fcQFormLayout_override_virtual_replaceWidget(self.h, cast[int](addr tmp[]))

proc miqt_exec_callback_QFormLayout_replaceWidget(self: ptr cQFormLayout, slot: int, fromVal: pointer, to: pointer, options: cint): pointer {.exportc: "miqt_exec_callback_QFormLayout_replaceWidget ".} =
  var nimfunc = cast[ptr QFormLayoutreplaceWidgetProc](cast[pointer](slot))
  ...
  virtualReturn.h
proc QFormLayoutlayout*(self: gen_qformlayout_types.QFormLayout, ): QLayout =
  QLayout(h: fQFormLayout_virtualbase_layout(self.h))

type QFormLayoutlayoutProc* = proc(): QLayout
...
proc miqt_exec_callback_QFormLayout_layout(self: ptr cQFormLayout, slot: int): pointer {.exportc: "miqt_exec_callback_QFormLayout_layout ".} =
  ...
  virtualReturn.h
proc QFormLayoutchildEvent*(self: gen_qformlayout_types.QFormLayout, e: QChildEvent): void =
  fQFormLayout_virtualbase_childEvent(self.h, e.h)

type QFormLayoutchildEventProc* = proc(e: QChildEvent): void
...
proc miqt_exec_callback_QFormLayout_childEvent(self: ptr cQFormLayout, slot: int, e: pointer): void {.exportc: "miqt_exec_callback_QFormLayout_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QFormLayoutevent*(self: gen_qformlayout_types.QFormLayout, event: QEvent): bool =
  fQFormLayout_virtualbase_event(self.h, event.h)

type QFormLayouteventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QFormLayout_event(self: ptr cQFormLayout, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QFormLayout_event ".} =
  ...
  virtualReturn
proc QFormLayouteventFilter*(self: gen_qformlayout_types.QFormLayout, watched: QObject, event: QEvent): bool =
  fQFormLayout_virtualbase_eventFilter(self.h, watched.h, event.h)

type QFormLayouteventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QFormLayout_eventFilter(self: ptr cQFormLayout, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QFormLayout_eventFilter ".} =
  ...
  virtualReturn
proc QFormLayouttimerEvent*(self: gen_qformlayout_types.QFormLayout, event: QTimerEvent): void =
  fQFormLayout_virtualbase_timerEvent(self.h, event.h)

type QFormLayouttimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QFormLayout_timerEvent(self: ptr cQFormLayout, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QFormLayout_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QFormLayoutcustomEvent*(self: gen_qformlayout_types.QFormLayout, event: QEvent): void =
  fQFormLayout_virtualbase_customEvent(self.h, event.h)

type QFormLayoutcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QFormLayout_customEvent(self: ptr cQFormLayout, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QFormLayout_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QFormLayoutconnectNotify*(self: gen_qformlayout_types.QFormLayout, signal: QMetaMethod): void =
  fQFormLayout_virtualbase_connectNotify(self.h, signal.h)

type QFormLayoutconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QFormLayout_connectNotify(self: ptr cQFormLayout, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QFormLayout_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QFormLayoutdisconnectNotify*(self: gen_qformlayout_types.QFormLayout, signal: QMetaMethod): void =
  fQFormLayout_virtualbase_disconnectNotify(self.h, signal.h)

type QFormLayoutdisconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QFormLayout_minimumHeightForWidth(self: ptr cQFormLayout, slot: int, param1: cint): cint {.exportc: "miqt_exec_callback_QFormLayout_minimumHeightForWidth ".} =
  ...
  virtualReturn
proc QFormLayoutwidget*(self: gen_qformlayout_types.QFormLayout, ): QWidget =
  QWidget(h: fQFormLayout_virtualbase_widget(self.h))

type QFormLayoutwidgetProc* = proc(): QWidget
...
proc miqt_exec_callback_QFormLayout_widget(self: ptr cQFormLayout, slot: int): pointer {.exportc: "miqt_exec_callback_QFormLayout_widget ".} =
  ...
  virtualReturn.h
proc QFormLayoutspacerItem*(self: gen_qformlayout_types.QFormLayout, ): QSpacerItem =
  QSpacerItem(h: fQFormLayout_virtualbase_spacerItem(self.h))

type QFormLayoutspacerItemProc* = proc(): QSpacerItem
