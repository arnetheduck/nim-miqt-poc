...
public:
	...
	MiqtVirtualQNetworkSession(struct QNetworkSession_VTable* vtbl, const QNetworkConfiguration& connConfig): QNetworkSession(connConfig), vtbl(vtbl) {};
	MiqtVirtualQNetworkSession(struct QNetworkSession_VTable* vtbl, const QNetworkConfiguration& connConfig, QObject* parent): QNetworkSession(connConfig, parent), vtbl(vtbl) {};

	virtual ~MiqtVirtualQNetworkSession() override { if(vtbl->destructor) vtbl->destructor(vtbl, this); }
...
void QNetworkSession_connect_stateChanged(QNetworkSession* self, intptr_t slot, void (*callback)(intptr_t, int), void (*release)(intptr_t)) {
	...
	MiqtVirtualQNetworkSession::connect(self, static_cast<void (QNetworkSession::*)(QNetworkSession::State)>(&QNetworkSession::stateChanged), self, caller{slot, callback, release});
}
...
void QNetworkSession_connect_opened(QNetworkSession* self, intptr_t slot, void (*callback)(intptr_t), void (*release)(intptr_t)) {
	...
	MiqtVirtualQNetworkSession::connect(self, static_cast<void (QNetworkSession::*)()>(&QNetworkSession::opened), self, caller{slot, callback, release});
}
...
void QNetworkSession_connect_closed(QNetworkSession* self, intptr_t slot, void (*callback)(intptr_t), void (*release)(intptr_t)) {
	...
	MiqtVirtualQNetworkSession::connect(self, static_cast<void (QNetworkSession::*)()>(&QNetworkSession::closed), self, caller{slot, callback, release});
}
...
void QNetworkSession_connect_errorWithQNetworkSessionSessionError(QNetworkSession* self, intptr_t slot, void (*callback)(intptr_t, int), void (*release)(intptr_t)) {
	...
	MiqtVirtualQNetworkSession::connect(self, static_cast<void (QNetworkSession::*)(QNetworkSession::SessionError)>(&QNetworkSession::error), self, caller{slot, callback, release});
}
...
void QNetworkSession_connect_preferredConfigurationChanged(QNetworkSession* self, intptr_t slot, void (*callback)(intptr_t, QNetworkConfiguration*, bool), void (*release)(intptr_t)) {
	...
	MiqtVirtualQNetworkSession::connect(self, static_cast<void (QNetworkSession::*)(const QNetworkConfiguration&, bool)>(&QNetworkSession::preferredConfigurationChanged), self, caller{slot, callback, release});
}
...
void QNetworkSession_connect_newConfigurationActivated(QNetworkSession* self, intptr_t slot, void (*callback)(intptr_t), void (*release)(intptr_t)) {
	...
	MiqtVirtualQNetworkSession::connect(self, static_cast<void (QNetworkSession::*)()>(&QNetworkSession::newConfigurationActivated), self, caller{slot, callback, release});
}
...
void QNetworkSession_connect_usagePoliciesChanged(QNetworkSession* self, intptr_t slot, void (*callback)(intptr_t, int), void (*release)(intptr_t)) {
	...
	MiqtVirtualQNetworkSession::connect(self, static_cast<void (QNetworkSession::*)(QNetworkSession::UsagePolicies)>(&QNetworkSession::usagePoliciesChanged), self, caller{slot, callback, release});
}
...
QMetaObject* QNetworkSession_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQNetworkSession*)(self) )->QNetworkSession::metaObject();

}

void* QNetworkSession_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQNetworkSession*)(self) )->QNetworkSession::qt_metacast(param1);

}

int QNetworkSession_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQNetworkSession*)(self) )->QNetworkSession::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
