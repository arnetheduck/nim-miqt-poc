...
func init*(T: type gen_qnetworksession_types.QNetworkSession, h: ptr cQNetworkSession): gen_qnetworksession_types.QNetworkSession =
  T(h: h)
proc create*(T: type gen_qnetworksession_types.QNetworkSession, connConfig: QNetworkConfiguration): gen_qnetworksession_types.QNetworkSession =
  gen_qnetworksession_types.QNetworkSession.init(fcQNetworkSession_new(connConfig.h))

proc create*(T: type gen_qnetworksession_types.QNetworkSession, connConfig: QNetworkConfiguration, parent: QObject): gen_qnetworksession_types.QNetworkSession =
  gen_qnetworksession_types.QNetworkSession.init(fcQNetworkSession_new2(connConfig.h, parent.h))

proc metaObject*(self: gen_qnetworksession_types.QNetworkSession, ): QMetaObject =
  QMetaObject(h: fcQNetworkSession_metaObject(self.h))
...
proc configuration*(self: gen_qnetworksession_types.QNetworkSession, ): QNetworkConfiguration =
  QNetworkConfiguration(h: fcQNetworkSession_configuration(self.h))

proc interfaceX*(self: gen_qnetworksession_types.QNetworkSession, ): QNetworkInterface =
  QNetworkInterface(h: fcQNetworkSession_interfaceX(self.h))
...
proc sessionProperty*(self: gen_qnetworksession_types.QNetworkSession, key: string): QVariant =
  QVariant(h: fcQNetworkSession_sessionProperty(self.h, struct_miqt_string(data: key, len: csize_t(len(key)))))

proc setSessionProperty*(self: gen_qnetworksession_types.QNetworkSession, key: string, value: QVariant): void =
...
proc preferredConfigurationChanged*(self: gen_qnetworksession_types.QNetworkSession, config: QNetworkConfiguration, isSeamless: bool): void =
  fcQNetworkSession_preferredConfigurationChanged(self.h, config.h, isSeamless)

type QNetworkSessionpreferredConfigurationChangedSlot* = proc(config: QNetworkConfiguration, isSeamless: bool)
...
proc miqt_exec_callback_QNetworkSession_metacall(self: ptr cQNetworkSession, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QNetworkSession_metacall ".} =
  ...
  virtualReturn
proc QNetworkSessionconnectNotify*(self: gen_qnetworksession_types.QNetworkSession, signal: QMetaMethod): void =
  fQNetworkSession_virtualbase_connectNotify(self.h, signal.h)

type QNetworkSessionconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QNetworkSession_connectNotify(self: ptr cQNetworkSession, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QNetworkSession_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QNetworkSessiondisconnectNotify*(self: gen_qnetworksession_types.QNetworkSession, signal: QMetaMethod): void =
  fQNetworkSession_virtualbase_disconnectNotify(self.h, signal.h)

type QNetworkSessiondisconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QNetworkSession_disconnectNotify(self: ptr cQNetworkSession, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QNetworkSession_disconnectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QNetworkSessionevent*(self: gen_qnetworksession_types.QNetworkSession, event: QEvent): bool =
  fQNetworkSession_virtualbase_event(self.h, event.h)

type QNetworkSessioneventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QNetworkSession_event(self: ptr cQNetworkSession, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QNetworkSession_event ".} =
  ...
  virtualReturn
proc QNetworkSessioneventFilter*(self: gen_qnetworksession_types.QNetworkSession, watched: QObject, event: QEvent): bool =
  fQNetworkSession_virtualbase_eventFilter(self.h, watched.h, event.h)

type QNetworkSessioneventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QNetworkSession_eventFilter(self: ptr cQNetworkSession, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QNetworkSession_eventFilter ".} =
  ...
  virtualReturn
proc QNetworkSessiontimerEvent*(self: gen_qnetworksession_types.QNetworkSession, event: QTimerEvent): void =
  fQNetworkSession_virtualbase_timerEvent(self.h, event.h)

type QNetworkSessiontimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QNetworkSession_timerEvent(self: ptr cQNetworkSession, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QNetworkSession_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QNetworkSessionchildEvent*(self: gen_qnetworksession_types.QNetworkSession, event: QChildEvent): void =
  fQNetworkSession_virtualbase_childEvent(self.h, event.h)

type QNetworkSessionchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QNetworkSession_childEvent(self: ptr cQNetworkSession, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QNetworkSession_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QNetworkSessioncustomEvent*(self: gen_qnetworksession_types.QNetworkSession, event: QEvent): void =
  fQNetworkSession_virtualbase_customEvent(self.h, event.h)

type QNetworkSessioncustomEventProc* = proc(event: QEvent): void
