...
proc create*(T: type gen_qnetworkconfigmanager_types.QNetworkConfigurationManager, parent: QObject): gen_qnetworkconfigmanager_types.QNetworkConfigurationManager =
  gen_qnetworkconfigmanager_types.QNetworkConfigurationManager.init(fcQNetworkConfigurationManager_new2(parent.h))

proc metaObject*(self: gen_qnetworkconfigmanager_types.QNetworkConfigurationManager, ): QMetaObject =
  QMetaObject(h: fcQNetworkConfigurationManager_metaObject(self.h))
...
proc defaultConfiguration*(self: gen_qnetworkconfigmanager_types.QNetworkConfigurationManager, ): QNetworkConfiguration =
  QNetworkConfiguration(h: fcQNetworkConfigurationManager_defaultConfiguration(self.h))

proc allConfigurations*(self: gen_qnetworkconfigmanager_types.QNetworkConfigurationManager, ): seq[QNetworkConfiguration] =
...
proc configurationFromIdentifier*(self: gen_qnetworkconfigmanager_types.QNetworkConfigurationManager, identifier: string): QNetworkConfiguration =
  QNetworkConfiguration(h: fcQNetworkConfigurationManager_configurationFromIdentifier(self.h, struct_miqt_string(data: identifier, len: csize_t(len(identifier)))))
...
proc configurationAdded*(self: gen_qnetworkconfigmanager_types.QNetworkConfigurationManager, config: QNetworkConfiguration): void =
  fcQNetworkConfigurationManager_configurationAdded(self.h, config.h)

type QNetworkConfigurationManagerconfigurationAddedSlot* = proc(config: QNetworkConfiguration)
proc miqt_exec_callback_QNetworkConfigurationManager_configurationAdded(slot: int, config: pointer) {.exportc.} =
  ...
  let slotval1 = QNetworkConfiguration(h: config)
...
proc configurationRemoved*(self: gen_qnetworkconfigmanager_types.QNetworkConfigurationManager, config: QNetworkConfiguration): void =
  fcQNetworkConfigurationManager_configurationRemoved(self.h, config.h)

type QNetworkConfigurationManagerconfigurationRemovedSlot* = proc(config: QNetworkConfiguration)
...
proc configurationChanged*(self: gen_qnetworkconfigmanager_types.QNetworkConfigurationManager, config: QNetworkConfiguration): void =
  fcQNetworkConfigurationManager_configurationChanged(self.h, config.h)

type QNetworkConfigurationManagerconfigurationChangedSlot* = proc(config: QNetworkConfiguration)
...
proc allConfigurations*(self: gen_qnetworkconfigmanager_types.QNetworkConfigurationManager, flags: cint): seq[QNetworkConfiguration] =
...
proc miqt_exec_callback_QNetworkConfigurationManager_metacall(self: ptr cQNetworkConfigurationManager, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QNetworkConfigurationManager_metacall ".} =
  ...
  virtualReturn
proc QNetworkConfigurationManagerevent*(self: gen_qnetworkconfigmanager_types.QNetworkConfigurationManager, event: QEvent): bool =
  fQNetworkConfigurationManager_virtualbase_event(self.h, event.h)

type QNetworkConfigurationManagereventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QNetworkConfigurationManager_event(self: ptr cQNetworkConfigurationManager, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QNetworkConfigurationManager_event ".} =
  ...
  virtualReturn
proc QNetworkConfigurationManagereventFilter*(self: gen_qnetworkconfigmanager_types.QNetworkConfigurationManager, watched: QObject, event: QEvent): bool =
  fQNetworkConfigurationManager_virtualbase_eventFilter(self.h, watched.h, event.h)

type QNetworkConfigurationManagereventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QNetworkConfigurationManager_eventFilter(self: ptr cQNetworkConfigurationManager, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QNetworkConfigurationManager_eventFilter ".} =
  ...
  virtualReturn
proc QNetworkConfigurationManagertimerEvent*(self: gen_qnetworkconfigmanager_types.QNetworkConfigurationManager, event: QTimerEvent): void =
  fQNetworkConfigurationManager_virtualbase_timerEvent(self.h, event.h)

type QNetworkConfigurationManagertimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QNetworkConfigurationManager_timerEvent(self: ptr cQNetworkConfigurationManager, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QNetworkConfigurationManager_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QNetworkConfigurationManagerchildEvent*(self: gen_qnetworkconfigmanager_types.QNetworkConfigurationManager, event: QChildEvent): void =
  fQNetworkConfigurationManager_virtualbase_childEvent(self.h, event.h)

type QNetworkConfigurationManagerchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QNetworkConfigurationManager_childEvent(self: ptr cQNetworkConfigurationManager, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QNetworkConfigurationManager_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QNetworkConfigurationManagercustomEvent*(self: gen_qnetworkconfigmanager_types.QNetworkConfigurationManager, event: QEvent): void =
  fQNetworkConfigurationManager_virtualbase_customEvent(self.h, event.h)

type QNetworkConfigurationManagercustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QNetworkConfigurationManager_customEvent(self: ptr cQNetworkConfigurationManager, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QNetworkConfigurationManager_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QNetworkConfigurationManagerconnectNotify*(self: gen_qnetworkconfigmanager_types.QNetworkConfigurationManager, signal: QMetaMethod): void =
  fQNetworkConfigurationManager_virtualbase_connectNotify(self.h, signal.h)

type QNetworkConfigurationManagerconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QNetworkConfigurationManager_connectNotify(self: ptr cQNetworkConfigurationManager, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QNetworkConfigurationManager_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QNetworkConfigurationManagerdisconnectNotify*(self: gen_qnetworkconfigmanager_types.QNetworkConfigurationManager, signal: QMetaMethod): void =
  fQNetworkConfigurationManager_virtualbase_disconnectNotify(self.h, signal.h)

type QNetworkConfigurationManagerdisconnectNotifyProc* = proc(signal: QMetaMethod): void
