...
public:
	...
	MiqtVirtualQDnsLookup(struct QDnsLookup_VTable* vtbl): QDnsLookup(), vtbl(vtbl) {};
	MiqtVirtualQDnsLookup(struct QDnsLookup_VTable* vtbl, QDnsLookup::Type type, const QString& name): QDnsLookup(type, name), vtbl(vtbl) {};
	MiqtVirtualQDnsLookup(struct QDnsLookup_VTable* vtbl, QDnsLookup::Type type, const QString& name, const QHostAddress& nameserver): QDnsLookup(type, name, nameserver), vtbl(vtbl) {};
	MiqtVirtualQDnsLookup(struct QDnsLookup_VTable* vtbl, QObject* parent): QDnsLookup(parent), vtbl(vtbl) {};
	MiqtVirtualQDnsLookup(struct QDnsLookup_VTable* vtbl, QDnsLookup::Type type, const QString& name, QObject* parent): QDnsLookup(type, name, parent), vtbl(vtbl) {};
	MiqtVirtualQDnsLookup(struct QDnsLookup_VTable* vtbl, QDnsLookup::Type type, const QString& name, const QHostAddress& nameserver, QObject* parent): QDnsLookup(type, name, nameserver, parent), vtbl(vtbl) {};

	virtual ~MiqtVirtualQDnsLookup() override { if(vtbl->destructor) vtbl->destructor(vtbl, this); }
...
QDnsLookup* QDnsLookup_new6(struct QDnsLookup_VTable* vtbl, int type, struct miqt_string name, QHostAddress* nameserver, QObject* parent) {
	QString name_QString = QString::fromUtf8(name.data, name.len);
	return new MiqtVirtualQDnsLookup(vtbl, static_cast<QDnsLookup::Type>(type), name_QString, *nameserver, parent);
}
...
void QDnsLookup_connect_finished(QDnsLookup* self, intptr_t slot, void (*callback)(intptr_t), void (*release)(intptr_t)) {
	...
	MiqtVirtualQDnsLookup::connect(self, static_cast<void (QDnsLookup::*)()>(&QDnsLookup::finished), self, caller{slot, callback, release});
}
...
void QDnsLookup_connect_nameChanged(QDnsLookup* self, intptr_t slot, void (*callback)(intptr_t, struct miqt_string), void (*release)(intptr_t)) {
	...
	MiqtVirtualQDnsLookup::connect(self, static_cast<void (QDnsLookup::*)(const QString&)>(&QDnsLookup::nameChanged), self, caller{slot, callback, release});
}
...
void QDnsLookup_connect_typeChanged(QDnsLookup* self, intptr_t slot, void (*callback)(intptr_t, int), void (*release)(intptr_t)) {
	...
	MiqtVirtualQDnsLookup::connect(self, static_cast<void (QDnsLookup::*)(QDnsLookup::Type)>(&QDnsLookup::typeChanged), self, caller{slot, callback, release});
}
...
void QDnsLookup_connect_nameserverChanged(QDnsLookup* self, intptr_t slot, void (*callback)(intptr_t, QHostAddress*), void (*release)(intptr_t)) {
	...
	MiqtVirtualQDnsLookup::connect(self, static_cast<void (QDnsLookup::*)(const QHostAddress&)>(&QDnsLookup::nameserverChanged), self, caller{slot, callback, release});
}
...
QMetaObject* QDnsLookup_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQDnsLookup*)(self) )->QDnsLookup::metaObject();

}

void* QDnsLookup_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQDnsLookup*)(self) )->QDnsLookup::qt_metacast(param1);

}

int QDnsLookup_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQDnsLookup*)(self) )->QDnsLookup::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
