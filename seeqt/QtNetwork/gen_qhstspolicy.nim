...
proc create*(T: type gen_qhstspolicy_types.QHstsPolicy, expiry: QDateTime, flags: cint, host: string): gen_qhstspolicy_types.QHstsPolicy =
...
proc create*(T: type gen_qhstspolicy_types.QHstsPolicy, rhs: QHstsPolicy): gen_qhstspolicy_types.QHstsPolicy =
  gen_qhstspolicy_types.QHstsPolicy.init(fcQHstsPolicy_new3(rhs.h))

proc create*(T: type gen_qhstspolicy_types.QHstsPolicy, expiry: QDateTime, flags: cint, host: string, mode: cint): gen_qhstspolicy_types.QHstsPolicy =
...
proc operatorAssign*(self: gen_qhstspolicy_types.QHstsPolicy, rhs: QHstsPolicy): void =
  fcQHstsPolicy_operatorAssign(self.h, rhs.h)

proc swap*(self: gen_qhstspolicy_types.QHstsPolicy, other: QHstsPolicy): void =
...
proc setExpiry*(self: gen_qhstspolicy_types.QHstsPolicy, expiry: QDateTime): void =
  fcQHstsPolicy_setExpiry(self.h, expiry.h)

proc expiry*(self: gen_qhstspolicy_types.QHstsPolicy, ): QDateTime =
  QDateTime(h: fcQHstsPolicy_expiry(self.h))
