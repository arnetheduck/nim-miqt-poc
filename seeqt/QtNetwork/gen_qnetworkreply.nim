...
func init*(T: type gen_qnetworkreply_types.QNetworkReply, h: ptr cQNetworkReply): gen_qnetworkreply_types.QNetworkReply =
  T(h: h)
proc metaObject*(self: gen_qnetworkreply_types.QNetworkReply, ): QMetaObject =
  QMetaObject(h: fcQNetworkReply_metaObject(self.h))
...
proc manager*(self: gen_qnetworkreply_types.QNetworkReply, ): QNetworkAccessManager =
  QNetworkAccessManager(h: fcQNetworkReply_manager(self.h))

proc operation*(self: gen_qnetworkreply_types.QNetworkReply, ): cint =
  cint(fcQNetworkReply_operation(self.h))

proc request*(self: gen_qnetworkreply_types.QNetworkReply, ): QNetworkRequest =
  QNetworkRequest(h: fcQNetworkReply_request(self.h))
...
proc url*(self: gen_qnetworkreply_types.QNetworkReply, ): QUrl =
  QUrl(h: fcQNetworkReply_url(self.h))

proc header*(self: gen_qnetworkreply_types.QNetworkReply, header: cint): QVariant =
  QVariant(h: fcQNetworkReply_header(self.h, cint(header)))
...
proc attribute*(self: gen_qnetworkreply_types.QNetworkReply, code: cint): QVariant =
  QVariant(h: fcQNetworkReply_attribute(self.h, cint(code)))

proc sslConfiguration*(self: gen_qnetworkreply_types.QNetworkReply, ): QSslConfiguration =
  QSslConfiguration(h: fcQNetworkReply_sslConfiguration(self.h))

proc setSslConfiguration*(self: gen_qnetworkreply_types.QNetworkReply, configuration: QSslConfiguration): void =
  fcQNetworkReply_setSslConfiguration(self.h, configuration.h)

proc ignoreSslErrors*(self: gen_qnetworkreply_types.QNetworkReply, errors: seq[QSslError]): void =
...
proc sslErrors*(self: gen_qnetworkreply_types.QNetworkReply, errors: seq[QSslError]): void =
  var errors_CArray = newSeq[pointer](len(errors))
  for i in 0..<len(errors):
    errors_CArray[i] = errors[i].h
...
type QNetworkReplysslErrorsSlot* = proc(errors: seq[QSslError])
...
proc preSharedKeyAuthenticationRequired*(self: gen_qnetworkreply_types.QNetworkReply, authenticator: QSslPreSharedKeyAuthenticator): void =
  fcQNetworkReply_preSharedKeyAuthenticationRequired(self.h, authenticator.h)

type QNetworkReplypreSharedKeyAuthenticationRequiredSlot* = proc(authenticator: QSslPreSharedKeyAuthenticator)
...
proc redirected*(self: gen_qnetworkreply_types.QNetworkReply, url: QUrl): void =
  fcQNetworkReply_redirected(self.h, url.h)

type QNetworkReplyredirectedSlot* = proc(url: QUrl)
