...
QMetaObject* QNetworkCookieJar_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQNetworkCookieJar*)(self) )->QNetworkCookieJar::metaObject();

}

void* QNetworkCookieJar_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQNetworkCookieJar*)(self) )->QNetworkCookieJar::qt_metacast(param1);

}

int QNetworkCookieJar_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQNetworkCookieJar*)(self) )->QNetworkCookieJar::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
