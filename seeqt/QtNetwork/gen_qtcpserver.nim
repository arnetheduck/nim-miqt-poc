...
proc create*(T: type gen_qtcpserver_types.QTcpServer, parent: QObject): gen_qtcpserver_types.QTcpServer =
  gen_qtcpserver_types.QTcpServer.init(fcQTcpServer_new2(parent.h))

proc metaObject*(self: gen_qtcpserver_types.QTcpServer, ): QMetaObject =
  QMetaObject(h: fcQTcpServer_metaObject(self.h))
...
proc serverAddress*(self: gen_qtcpserver_types.QTcpServer, ): QHostAddress =
  QHostAddress(h: fcQTcpServer_serverAddress(self.h))
...
proc nextPendingConnection*(self: gen_qtcpserver_types.QTcpServer, ): QTcpSocket =
  QTcpSocket(h: fcQTcpServer_nextPendingConnection(self.h))
...
proc setProxy*(self: gen_qtcpserver_types.QTcpServer, networkProxy: QNetworkProxy): void =
  fcQTcpServer_setProxy(self.h, networkProxy.h)

proc proxy*(self: gen_qtcpserver_types.QTcpServer, ): QNetworkProxy =
  QNetworkProxy(h: fcQTcpServer_proxy(self.h))
...
proc listen*(self: gen_qtcpserver_types.QTcpServer, address: QHostAddress): bool =
  fcQTcpServer_listen1(self.h, address.h)

proc listen*(self: gen_qtcpserver_types.QTcpServer, address: QHostAddress, port: cushort): bool =
...
proc miqt_exec_callback_QTcpServer_hasPendingConnections(self: ptr cQTcpServer, slot: int): bool {.exportc: "miqt_exec_callback_QTcpServer_hasPendingConnections ".} =
  ...
  virtualReturn
proc QTcpServernextPendingConnection*(self: gen_qtcpserver_types.QTcpServer, ): QTcpSocket =
  QTcpSocket(h: fQTcpServer_virtualbase_nextPendingConnection(self.h))

type QTcpServernextPendingConnectionProc* = proc(): QTcpSocket
...
proc miqt_exec_callback_QTcpServer_incomingConnection(self: ptr cQTcpServer, slot: int, handle: uint): void {.exportc: "miqt_exec_callback_QTcpServer_incomingConnection ".} =
  ...
  nimfunc[](slotval1)
proc QTcpServerevent*(self: gen_qtcpserver_types.QTcpServer, event: QEvent): bool =
  fQTcpServer_virtualbase_event(self.h, event.h)

type QTcpServereventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QTcpServer_event(self: ptr cQTcpServer, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QTcpServer_event ".} =
  ...
  virtualReturn
proc QTcpServereventFilter*(self: gen_qtcpserver_types.QTcpServer, watched: QObject, event: QEvent): bool =
  fQTcpServer_virtualbase_eventFilter(self.h, watched.h, event.h)

type QTcpServereventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QTcpServer_eventFilter(self: ptr cQTcpServer, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QTcpServer_eventFilter ".} =
  ...
  virtualReturn
proc QTcpServertimerEvent*(self: gen_qtcpserver_types.QTcpServer, event: QTimerEvent): void =
  fQTcpServer_virtualbase_timerEvent(self.h, event.h)

type QTcpServertimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QTcpServer_timerEvent(self: ptr cQTcpServer, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTcpServer_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTcpServerchildEvent*(self: gen_qtcpserver_types.QTcpServer, event: QChildEvent): void =
  fQTcpServer_virtualbase_childEvent(self.h, event.h)

type QTcpServerchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QTcpServer_childEvent(self: ptr cQTcpServer, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTcpServer_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTcpServercustomEvent*(self: gen_qtcpserver_types.QTcpServer, event: QEvent): void =
  fQTcpServer_virtualbase_customEvent(self.h, event.h)

type QTcpServercustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QTcpServer_customEvent(self: ptr cQTcpServer, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTcpServer_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTcpServerconnectNotify*(self: gen_qtcpserver_types.QTcpServer, signal: QMetaMethod): void =
  fQTcpServer_virtualbase_connectNotify(self.h, signal.h)

type QTcpServerconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QTcpServer_connectNotify(self: ptr cQTcpServer, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QTcpServer_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QTcpServerdisconnectNotify*(self: gen_qtcpserver_types.QTcpServer, signal: QMetaMethod): void =
  fQTcpServer_virtualbase_disconnectNotify(self.h, signal.h)

type QTcpServerdisconnectNotifyProc* = proc(signal: QMetaMethod): void
