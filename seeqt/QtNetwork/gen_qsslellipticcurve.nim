...
proc create*(T: type gen_qsslellipticcurve_types.QSslEllipticCurve, param1: QSslEllipticCurve): gen_qsslellipticcurve_types.QSslEllipticCurve =
  gen_qsslellipticcurve_types.QSslEllipticCurve.init(fcQSslEllipticCurve_new2(param1.h))

proc fromShortName*(_: type gen_qsslellipticcurve_types.QSslEllipticCurve, name: string): QSslEllipticCurve =
  QSslEllipticCurve(h: fcQSslEllipticCurve_fromShortName(struct_miqt_string(data: name, len: csize_t(len(name)))))

proc fromLongName*(_: type gen_qsslellipticcurve_types.QSslEllipticCurve, name: string): QSslEllipticCurve =
