...
proc create*(T: type gen_qsslcipher_types.QSslCipher, other: QSslCipher): gen_qsslcipher_types.QSslCipher =
  gen_qsslcipher_types.QSslCipher.init(fcQSslCipher_new4(other.h))

proc operatorAssign*(self: gen_qsslcipher_types.QSslCipher, other: QSslCipher): void =
  fcQSslCipher_operatorAssign(self.h, other.h)

proc swap*(self: gen_qsslcipher_types.QSslCipher, other: QSslCipher): void =
  fcQSslCipher_swap(self.h, other.h)

proc operatorEqual*(self: gen_qsslcipher_types.QSslCipher, other: QSslCipher): bool =
  fcQSslCipher_operatorEqual(self.h, other.h)

proc operatorNotEqual*(self: gen_qsslcipher_types.QSslCipher, other: QSslCipher): bool =
