...
proc create*(T: type gen_qnetworkcookiejar_types.QNetworkCookieJar, parent: QObject): gen_qnetworkcookiejar_types.QNetworkCookieJar =
  gen_qnetworkcookiejar_types.QNetworkCookieJar.init(fcQNetworkCookieJar_new2(parent.h))

proc metaObject*(self: gen_qnetworkcookiejar_types.QNetworkCookieJar, ): QMetaObject =
  QMetaObject(h: fcQNetworkCookieJar_metaObject(self.h))
...
proc cookiesForUrl*(self: gen_qnetworkcookiejar_types.QNetworkCookieJar, url: QUrl): seq[QNetworkCookie] =
  var v_ma = fcQNetworkCookieJar_cookiesForUrl(self.h, url.h)
  var vx_ret = newSeq[QNetworkCookie](int(v_ma.len))
  let v_outCast = cast[ptr UncheckedArray[pointer]](v_ma.data)
  for i in 0 ..< v_ma.len:
    vx_ret[i] = QNetworkCookie(h: v_outCast[i])
  vx_ret

proc setCookiesFromUrl*(self: gen_qnetworkcookiejar_types.QNetworkCookieJar, cookieList: seq[QNetworkCookie], url: QUrl): bool =
...
proc insertCookie*(self: gen_qnetworkcookiejar_types.QNetworkCookieJar, cookie: QNetworkCookie): bool =
  fcQNetworkCookieJar_insertCookie(self.h, cookie.h)

proc updateCookie*(self: gen_qnetworkcookiejar_types.QNetworkCookieJar, cookie: QNetworkCookie): bool =
  fcQNetworkCookieJar_updateCookie(self.h, cookie.h)

proc deleteCookie*(self: gen_qnetworkcookiejar_types.QNetworkCookieJar, cookie: QNetworkCookie): bool =
...
proc miqt_exec_callback_QNetworkCookieJar_metacall(self: ptr cQNetworkCookieJar, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QNetworkCookieJar_metacall ".} =
  ...
  virtualReturn
proc QNetworkCookieJarcookiesForUrl*(self: gen_qnetworkcookiejar_types.QNetworkCookieJar, url: QUrl): seq[QNetworkCookie] =
...
type QNetworkCookieJarcookiesForUrlProc* = proc(url: QUrl): seq[QNetworkCookie]
...
proc QNetworkCookieJarsetCookiesFromUrl*(self: gen_qnetworkcookiejar_types.QNetworkCookieJar, cookieList: seq[QNetworkCookie], url: QUrl): bool =
  var cookieList_CArray = newSeq[pointer](len(cookieList))
  for i in 0..<len(cookieList):
    cookieList_CArray[i] = cookieList[i].h
...
type QNetworkCookieJarsetCookiesFromUrlProc* = proc(cookieList: seq[QNetworkCookie], url: QUrl): bool
...
proc miqt_exec_callback_QNetworkCookieJar_setCookiesFromUrl(self: ptr cQNetworkCookieJar, slot: int, cookieList: struct_miqt_array, url: pointer): bool {.exportc: "miqt_exec_callback_QNetworkCookieJar_setCookiesFromUrl ".} =
  ...
  var vcookieListx_ret = newSeq[QNetworkCookie](int(vcookieList_ma.len))
  let vcookieList_outCast = cast[ptr UncheckedArray[pointer]](vcookieList_ma.data)
  for i in 0 ..< vcookieList_ma.len:
    vcookieListx_ret[i] = QNetworkCookie(h: vcookieList_outCast[i])
  ...
  virtualReturn
proc QNetworkCookieJarinsertCookie*(self: gen_qnetworkcookiejar_types.QNetworkCookieJar, cookie: QNetworkCookie): bool =
  fQNetworkCookieJar_virtualbase_insertCookie(self.h, cookie.h)

type QNetworkCookieJarinsertCookieProc* = proc(cookie: QNetworkCookie): bool
...
proc miqt_exec_callback_QNetworkCookieJar_insertCookie(self: ptr cQNetworkCookieJar, slot: int, cookie: pointer): bool {.exportc: "miqt_exec_callback_QNetworkCookieJar_insertCookie ".} =
  ...
  let slotval1 = QNetworkCookie(h: cookie)


  let virtualReturn = nimfunc[](slotval1 )

  virtualReturn
proc QNetworkCookieJarupdateCookie*(self: gen_qnetworkcookiejar_types.QNetworkCookieJar, cookie: QNetworkCookie): bool =
  fQNetworkCookieJar_virtualbase_updateCookie(self.h, cookie.h)

type QNetworkCookieJarupdateCookieProc* = proc(cookie: QNetworkCookie): bool
...
proc miqt_exec_callback_QNetworkCookieJar_updateCookie(self: ptr cQNetworkCookieJar, slot: int, cookie: pointer): bool {.exportc: "miqt_exec_callback_QNetworkCookieJar_updateCookie ".} =
  ...
  virtualReturn
proc QNetworkCookieJardeleteCookie*(self: gen_qnetworkcookiejar_types.QNetworkCookieJar, cookie: QNetworkCookie): bool =
  fQNetworkCookieJar_virtualbase_deleteCookie(self.h, cookie.h)

type QNetworkCookieJardeleteCookieProc* = proc(cookie: QNetworkCookie): bool
...
proc miqt_exec_callback_QNetworkCookieJar_deleteCookie(self: ptr cQNetworkCookieJar, slot: int, cookie: pointer): bool {.exportc: "miqt_exec_callback_QNetworkCookieJar_deleteCookie ".} =
  ...
  virtualReturn
proc QNetworkCookieJarvalidateCookie*(self: gen_qnetworkcookiejar_types.QNetworkCookieJar, cookie: QNetworkCookie, url: QUrl): bool =
  fQNetworkCookieJar_virtualbase_validateCookie(self.h, cookie.h, url.h)

type QNetworkCookieJarvalidateCookieProc* = proc(cookie: QNetworkCookie, url: QUrl): bool
...
proc miqt_exec_callback_QNetworkCookieJar_validateCookie(self: ptr cQNetworkCookieJar, slot: int, cookie: pointer, url: pointer): bool {.exportc: "miqt_exec_callback_QNetworkCookieJar_validateCookie ".} =
  ...
  virtualReturn
proc QNetworkCookieJarevent*(self: gen_qnetworkcookiejar_types.QNetworkCookieJar, event: QEvent): bool =
  fQNetworkCookieJar_virtualbase_event(self.h, event.h)

type QNetworkCookieJareventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QNetworkCookieJar_event(self: ptr cQNetworkCookieJar, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QNetworkCookieJar_event ".} =
  ...
  virtualReturn
proc QNetworkCookieJareventFilter*(self: gen_qnetworkcookiejar_types.QNetworkCookieJar, watched: QObject, event: QEvent): bool =
  fQNetworkCookieJar_virtualbase_eventFilter(self.h, watched.h, event.h)

type QNetworkCookieJareventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QNetworkCookieJar_eventFilter(self: ptr cQNetworkCookieJar, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QNetworkCookieJar_eventFilter ".} =
  ...
  virtualReturn
proc QNetworkCookieJartimerEvent*(self: gen_qnetworkcookiejar_types.QNetworkCookieJar, event: QTimerEvent): void =
  fQNetworkCookieJar_virtualbase_timerEvent(self.h, event.h)

type QNetworkCookieJartimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QNetworkCookieJar_timerEvent(self: ptr cQNetworkCookieJar, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QNetworkCookieJar_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QNetworkCookieJarchildEvent*(self: gen_qnetworkcookiejar_types.QNetworkCookieJar, event: QChildEvent): void =
  fQNetworkCookieJar_virtualbase_childEvent(self.h, event.h)

type QNetworkCookieJarchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QNetworkCookieJar_childEvent(self: ptr cQNetworkCookieJar, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QNetworkCookieJar_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QNetworkCookieJarcustomEvent*(self: gen_qnetworkcookiejar_types.QNetworkCookieJar, event: QEvent): void =
  fQNetworkCookieJar_virtualbase_customEvent(self.h, event.h)

type QNetworkCookieJarcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QNetworkCookieJar_customEvent(self: ptr cQNetworkCookieJar, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QNetworkCookieJar_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QNetworkCookieJarconnectNotify*(self: gen_qnetworkcookiejar_types.QNetworkCookieJar, signal: QMetaMethod): void =
  fQNetworkCookieJar_virtualbase_connectNotify(self.h, signal.h)

type QNetworkCookieJarconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QNetworkCookieJar_connectNotify(self: ptr cQNetworkCookieJar, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QNetworkCookieJar_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QNetworkCookieJardisconnectNotify*(self: gen_qnetworkcookiejar_types.QNetworkCookieJar, signal: QMetaMethod): void =
  fQNetworkCookieJar_virtualbase_disconnectNotify(self.h, signal.h)

type QNetworkCookieJardisconnectNotifyProc* = proc(signal: QMetaMethod): void
