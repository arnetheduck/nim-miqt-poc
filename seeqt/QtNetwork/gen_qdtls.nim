...
proc create*(T: type gen_qdtls_types.QDtlsClientVerifier, parent: QObject): gen_qdtls_types.QDtlsClientVerifier =
  gen_qdtls_types.QDtlsClientVerifier.init(fcQDtlsClientVerifier_new2(parent.h))

proc metaObject*(self: gen_qdtls_types.QDtlsClientVerifier, ): QMetaObject =
  QMetaObject(h: fcQDtlsClientVerifier_metaObject(self.h))
...
proc setCookieGeneratorParameters*(self: gen_qdtls_types.QDtlsClientVerifier, params: QDtlsClientVerifierGeneratorParameters): bool =
  fcQDtlsClientVerifier_setCookieGeneratorParameters(self.h, params.h)

proc cookieGeneratorParameters*(self: gen_qdtls_types.QDtlsClientVerifier, ): QDtlsClientVerifierGeneratorParameters =
  QDtlsClientVerifierGeneratorParameters(h: fcQDtlsClientVerifier_cookieGeneratorParameters(self.h))

proc verifyClient*(self: gen_qdtls_types.QDtlsClientVerifier, socket: QUdpSocket, dgram: seq[byte], address: QHostAddress, port: cushort): bool =
...
proc miqt_exec_callback_QDtlsClientVerifier_metacall(self: ptr cQDtlsClientVerifier, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QDtlsClientVerifier_metacall ".} =
  ...
  virtualReturn
proc QDtlsClientVerifierevent*(self: gen_qdtls_types.QDtlsClientVerifier, event: QEvent): bool =
  fQDtlsClientVerifier_virtualbase_event(self.h, event.h)

type QDtlsClientVerifiereventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QDtlsClientVerifier_event(self: ptr cQDtlsClientVerifier, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QDtlsClientVerifier_event ".} =
  ...
  virtualReturn
proc QDtlsClientVerifiereventFilter*(self: gen_qdtls_types.QDtlsClientVerifier, watched: QObject, event: QEvent): bool =
  fQDtlsClientVerifier_virtualbase_eventFilter(self.h, watched.h, event.h)

type QDtlsClientVerifiereventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QDtlsClientVerifier_eventFilter(self: ptr cQDtlsClientVerifier, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QDtlsClientVerifier_eventFilter ".} =
  ...
  virtualReturn
proc QDtlsClientVerifiertimerEvent*(self: gen_qdtls_types.QDtlsClientVerifier, event: QTimerEvent): void =
  fQDtlsClientVerifier_virtualbase_timerEvent(self.h, event.h)

type QDtlsClientVerifiertimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QDtlsClientVerifier_timerEvent(self: ptr cQDtlsClientVerifier, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QDtlsClientVerifier_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QDtlsClientVerifierchildEvent*(self: gen_qdtls_types.QDtlsClientVerifier, event: QChildEvent): void =
  fQDtlsClientVerifier_virtualbase_childEvent(self.h, event.h)

type QDtlsClientVerifierchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QDtlsClientVerifier_childEvent(self: ptr cQDtlsClientVerifier, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QDtlsClientVerifier_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QDtlsClientVerifiercustomEvent*(self: gen_qdtls_types.QDtlsClientVerifier, event: QEvent): void =
  fQDtlsClientVerifier_virtualbase_customEvent(self.h, event.h)

type QDtlsClientVerifiercustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QDtlsClientVerifier_customEvent(self: ptr cQDtlsClientVerifier, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QDtlsClientVerifier_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QDtlsClientVerifierconnectNotify*(self: gen_qdtls_types.QDtlsClientVerifier, signal: QMetaMethod): void =
  fQDtlsClientVerifier_virtualbase_connectNotify(self.h, signal.h)

type QDtlsClientVerifierconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QDtlsClientVerifier_connectNotify(self: ptr cQDtlsClientVerifier, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QDtlsClientVerifier_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QDtlsClientVerifierdisconnectNotify*(self: gen_qdtls_types.QDtlsClientVerifier, signal: QMetaMethod): void =
  fQDtlsClientVerifier_virtualbase_disconnectNotify(self.h, signal.h)

type QDtlsClientVerifierdisconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc create*(T: type gen_qdtls_types.QDtls, mode: cint, parent: QObject): gen_qdtls_types.QDtls =
  gen_qdtls_types.QDtls.init(fcQDtls_new2(cint(mode), parent.h))

proc metaObject*(self: gen_qdtls_types.QDtls, ): QMetaObject =
  QMetaObject(h: fcQDtls_metaObject(self.h))
...
proc setPeer*(self: gen_qdtls_types.QDtls, address: QHostAddress, port: cushort): bool =
...
proc peerAddress*(self: gen_qdtls_types.QDtls, ): QHostAddress =
  QHostAddress(h: fcQDtls_peerAddress(self.h))
...
proc setCookieGeneratorParameters*(self: gen_qdtls_types.QDtls, params: QDtlsClientVerifierGeneratorParameters): bool =
  fcQDtls_setCookieGeneratorParameters(self.h, params.h)

proc cookieGeneratorParameters*(self: gen_qdtls_types.QDtls, ): QDtlsClientVerifierGeneratorParameters =
  QDtlsClientVerifierGeneratorParameters(h: fcQDtls_cookieGeneratorParameters(self.h))

proc setDtlsConfiguration*(self: gen_qdtls_types.QDtls, configuration: QSslConfiguration): bool =
  fcQDtls_setDtlsConfiguration(self.h, configuration.h)

proc dtlsConfiguration*(self: gen_qdtls_types.QDtls, ): QSslConfiguration =
  QSslConfiguration(h: fcQDtls_dtlsConfiguration(self.h))

proc handshakeState*(self: gen_qdtls_types.QDtls, ): cint =
  cint(fcQDtls_handshakeState(self.h))

proc doHandshake*(self: gen_qdtls_types.QDtls, socket: QUdpSocket): bool =
  fcQDtls_doHandshake(self.h, socket.h)

proc handleTimeout*(self: gen_qdtls_types.QDtls, socket: QUdpSocket): bool =
  fcQDtls_handleTimeout(self.h, socket.h)

proc resumeHandshake*(self: gen_qdtls_types.QDtls, socket: QUdpSocket): bool =
  fcQDtls_resumeHandshake(self.h, socket.h)

proc abortHandshake*(self: gen_qdtls_types.QDtls, socket: QUdpSocket): bool =
  fcQDtls_abortHandshake(self.h, socket.h)

proc shutdown*(self: gen_qdtls_types.QDtls, socket: QUdpSocket): bool =
...
proc sessionCipher*(self: gen_qdtls_types.QDtls, ): QSslCipher =
  QSslCipher(h: fcQDtls_sessionCipher(self.h))

proc sessionProtocol*(self: gen_qdtls_types.QDtls, ): cint =
  cint(fcQDtls_sessionProtocol(self.h))

proc writeDatagramEncrypted*(self: gen_qdtls_types.QDtls, socket: QUdpSocket, dgram: seq[byte]): clonglong =
...
proc decryptDatagram*(self: gen_qdtls_types.QDtls, socket: QUdpSocket, dgram: seq[byte]): seq[byte] =
...
proc peerVerificationErrors*(self: gen_qdtls_types.QDtls, ): seq[QSslError] =
...
proc ignoreVerificationErrors*(self: gen_qdtls_types.QDtls, errorsToIgnore: seq[QSslError]): void =
...
proc pskRequired*(self: gen_qdtls_types.QDtls, authenticator: QSslPreSharedKeyAuthenticator): void =
  fcQDtls_pskRequired(self.h, authenticator.h)

type QDtlspskRequiredSlot* = proc(authenticator: QSslPreSharedKeyAuthenticator)
...
proc setPeer*(self: gen_qdtls_types.QDtls, address: QHostAddress, port: cushort, verificationName: string): bool =
  fcQDtls_setPeer3(self.h, address.h, port, struct_miqt_string(data: verificationName, len: csize_t(len(verificationName))))

proc doHandshake*(self: gen_qdtls_types.QDtls, socket: QUdpSocket, dgram: seq[byte]): bool =
...
proc miqt_exec_callback_QDtls_metacall(self: ptr cQDtls, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QDtls_metacall ".} =
  ...
  virtualReturn
proc QDtlsevent*(self: gen_qdtls_types.QDtls, event: QEvent): bool =
  fQDtls_virtualbase_event(self.h, event.h)

type QDtlseventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QDtls_event(self: ptr cQDtls, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QDtls_event ".} =
  ...
  virtualReturn
proc QDtlseventFilter*(self: gen_qdtls_types.QDtls, watched: QObject, event: QEvent): bool =
  fQDtls_virtualbase_eventFilter(self.h, watched.h, event.h)

type QDtlseventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QDtls_eventFilter(self: ptr cQDtls, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QDtls_eventFilter ".} =
  ...
  virtualReturn
proc QDtlstimerEvent*(self: gen_qdtls_types.QDtls, event: QTimerEvent): void =
  fQDtls_virtualbase_timerEvent(self.h, event.h)

type QDtlstimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QDtls_timerEvent(self: ptr cQDtls, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QDtls_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QDtlschildEvent*(self: gen_qdtls_types.QDtls, event: QChildEvent): void =
  fQDtls_virtualbase_childEvent(self.h, event.h)

type QDtlschildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QDtls_childEvent(self: ptr cQDtls, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QDtls_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QDtlscustomEvent*(self: gen_qdtls_types.QDtls, event: QEvent): void =
  fQDtls_virtualbase_customEvent(self.h, event.h)

type QDtlscustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QDtls_customEvent(self: ptr cQDtls, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QDtls_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QDtlsconnectNotify*(self: gen_qdtls_types.QDtls, signal: QMetaMethod): void =
  fQDtls_virtualbase_connectNotify(self.h, signal.h)

type QDtlsconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QDtls_connectNotify(self: ptr cQDtls, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QDtls_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QDtlsdisconnectNotify*(self: gen_qdtls_types.QDtls, signal: QMetaMethod): void =
  fQDtls_virtualbase_disconnectNotify(self.h, signal.h)

type QDtlsdisconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc create*(T: type gen_qdtls_types.QDtlsClientVerifierGeneratorParameters, param1: QDtlsClientVerifierGeneratorParameters): gen_qdtls_types.QDtlsClientVerifierGeneratorParameters =
  gen_qdtls_types.QDtlsClientVerifierGeneratorParameters.init(fcQDtlsClientVerifierGeneratorParameters_new3(param1.h))

proc operatorAssign*(self: gen_qdtls_types.QDtlsClientVerifierGeneratorParameters, param1: QDtlsClientVerifierGeneratorParameters): void =
