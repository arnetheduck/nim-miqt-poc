...
void miqt_exec_callback_QTcpServer_newConnection_release(intptr_t);
void miqt_exec_callback_QTcpServer_acceptError(intptr_t, int);
void miqt_exec_callback_QTcpServer_acceptError_release(intptr_t);
#ifdef __cplusplus
} /* extern C */
#endif
...
public:
	...
	MiqtVirtualQTcpServer(struct QTcpServer_VTable* vtbl): QTcpServer(), vtbl(vtbl) {};
	MiqtVirtualQTcpServer(struct QTcpServer_VTable* vtbl, QObject* parent): QTcpServer(parent), vtbl(vtbl) {};

	virtual ~MiqtVirtualQTcpServer() override { if(vtbl->destructor) vtbl->destructor(vtbl, this); }
...
QTcpServer* QTcpServer_new(struct QTcpServer_VTable* vtbl) {
	return new MiqtVirtualQTcpServer(vtbl);
}

QTcpServer* QTcpServer_new2(struct QTcpServer_VTable* vtbl, QObject* parent) {
	return new MiqtVirtualQTcpServer(vtbl, parent);
}
...
void QTcpServer_connect_newConnection(QTcpServer* self, intptr_t slot) {
	struct caller {
		...
		~caller() { miqt_exec_callback_QTcpServer_newConnection_release(slot); }
	};
	MiqtVirtualQTcpServer::connect(self, static_cast<void (QTcpServer::*)()>(&QTcpServer::newConnection), self, caller{slot});
}
...
void QTcpServer_connect_acceptError(QTcpServer* self, intptr_t slot) {
	struct caller {
		...
		caller(const caller &) = delete;
		caller &operator=(const caller &) = delete;
		~caller() { miqt_exec_callback_QTcpServer_acceptError_release(slot); }
	};
	MiqtVirtualQTcpServer::connect(self, static_cast<void (QTcpServer::*)(QAbstractSocket::SocketError)>(&QTcpServer::acceptError), self, caller{slot});
}
...
QMetaObject* QTcpServer_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQTcpServer*)(self) )->QTcpServer::metaObject();

}

void* QTcpServer_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQTcpServer*)(self) )->QTcpServer::qt_metacast(param1);

}

int QTcpServer_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQTcpServer*)(self) )->QTcpServer::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);

}

bool QTcpServer_virtualbase_hasPendingConnections(const void* self) {

	return ( (const MiqtVirtualQTcpServer*)(self) )->QTcpServer::hasPendingConnections();

}

QTcpSocket* QTcpServer_virtualbase_nextPendingConnection(void* self) {

	return ( (MiqtVirtualQTcpServer*)(self) )->QTcpServer::nextPendingConnection();

}

void QTcpServer_virtualbase_incomingConnection(void* self, intptr_t handle) {

	( (MiqtVirtualQTcpServer*)(self) )->QTcpServer::incomingConnection((qintptr)(handle));

}

bool QTcpServer_virtualbase_event(void* self, QEvent* event) {

	return ( (MiqtVirtualQTcpServer*)(self) )->QTcpServer::event(event);

}

bool QTcpServer_virtualbase_eventFilter(void* self, QObject* watched, QEvent* event) {

	return ( (MiqtVirtualQTcpServer*)(self) )->QTcpServer::eventFilter(watched, event);

}

void QTcpServer_virtualbase_timerEvent(void* self, QTimerEvent* event) {

	( (MiqtVirtualQTcpServer*)(self) )->QTcpServer::timerEvent(event);

}

void QTcpServer_virtualbase_childEvent(void* self, QChildEvent* event) {

	( (MiqtVirtualQTcpServer*)(self) )->QTcpServer::childEvent(event);

}

void QTcpServer_virtualbase_customEvent(void* self, QEvent* event) {

	( (MiqtVirtualQTcpServer*)(self) )->QTcpServer::customEvent(event);

}

void QTcpServer_virtualbase_connectNotify(void* self, QMetaMethod* signal) {

	( (MiqtVirtualQTcpServer*)(self) )->QTcpServer::connectNotify(*signal);

}

void QTcpServer_virtualbase_disconnectNotify(void* self, QMetaMethod* signal) {

	( (MiqtVirtualQTcpServer*)(self) )->QTcpServer::disconnectNotify(*signal);
...
void QTcpServer_protectedbase_addPendingConnection(void* self, QTcpSocket* socket) {
	MiqtVirtualQTcpServer* self_cast = static_cast<MiqtVirtualQTcpServer*>( (QTcpServer*)(self) );
