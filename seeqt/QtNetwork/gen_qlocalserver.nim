...
proc create*(T: type gen_qlocalserver_types.QLocalServer, parent: QObject): gen_qlocalserver_types.QLocalServer =
  gen_qlocalserver_types.QLocalServer.init(fcQLocalServer_new2(parent.h))

proc metaObject*(self: gen_qlocalserver_types.QLocalServer, ): QMetaObject =
  QMetaObject(h: fcQLocalServer_metaObject(self.h))
...
proc nextPendingConnection*(self: gen_qlocalserver_types.QLocalServer, ): QLocalSocket =
  QLocalSocket(h: fcQLocalServer_nextPendingConnection(self.h))
...
proc miqt_exec_callback_QLocalServer_hasPendingConnections(self: ptr cQLocalServer, slot: int): bool {.exportc: "miqt_exec_callback_QLocalServer_hasPendingConnections ".} =
  ...
  virtualReturn
proc QLocalServernextPendingConnection*(self: gen_qlocalserver_types.QLocalServer, ): QLocalSocket =
  QLocalSocket(h: fQLocalServer_virtualbase_nextPendingConnection(self.h))

type QLocalServernextPendingConnectionProc* = proc(): QLocalSocket
...
proc miqt_exec_callback_QLocalServer_incomingConnection(self: ptr cQLocalServer, slot: int, socketDescriptor: uint): void {.exportc: "miqt_exec_callback_QLocalServer_incomingConnection ".} =
  ...
  nimfunc[](slotval1)
proc QLocalServerevent*(self: gen_qlocalserver_types.QLocalServer, event: QEvent): bool =
  fQLocalServer_virtualbase_event(self.h, event.h)

type QLocalServereventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QLocalServer_event(self: ptr cQLocalServer, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QLocalServer_event ".} =
  ...
  virtualReturn
proc QLocalServereventFilter*(self: gen_qlocalserver_types.QLocalServer, watched: QObject, event: QEvent): bool =
  fQLocalServer_virtualbase_eventFilter(self.h, watched.h, event.h)

type QLocalServereventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QLocalServer_eventFilter(self: ptr cQLocalServer, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QLocalServer_eventFilter ".} =
  ...
  virtualReturn
proc QLocalServertimerEvent*(self: gen_qlocalserver_types.QLocalServer, event: QTimerEvent): void =
  fQLocalServer_virtualbase_timerEvent(self.h, event.h)

type QLocalServertimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QLocalServer_timerEvent(self: ptr cQLocalServer, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QLocalServer_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QLocalServerchildEvent*(self: gen_qlocalserver_types.QLocalServer, event: QChildEvent): void =
  fQLocalServer_virtualbase_childEvent(self.h, event.h)

type QLocalServerchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QLocalServer_childEvent(self: ptr cQLocalServer, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QLocalServer_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QLocalServercustomEvent*(self: gen_qlocalserver_types.QLocalServer, event: QEvent): void =
  fQLocalServer_virtualbase_customEvent(self.h, event.h)

type QLocalServercustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QLocalServer_customEvent(self: ptr cQLocalServer, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QLocalServer_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QLocalServerconnectNotify*(self: gen_qlocalserver_types.QLocalServer, signal: QMetaMethod): void =
  fQLocalServer_virtualbase_connectNotify(self.h, signal.h)

type QLocalServerconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QLocalServer_connectNotify(self: ptr cQLocalServer, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QLocalServer_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QLocalServerdisconnectNotify*(self: gen_qlocalserver_types.QLocalServer, signal: QMetaMethod): void =
  fQLocalServer_virtualbase_disconnectNotify(self.h, signal.h)

type QLocalServerdisconnectNotifyProc* = proc(signal: QMetaMethod): void
