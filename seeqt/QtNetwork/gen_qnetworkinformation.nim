...
func init*(T: type gen_qnetworkinformation_types.QNetworkInformation, h: ptr cQNetworkInformation): gen_qnetworkinformation_types.QNetworkInformation =
  T(h: h)
proc metaObject*(self: gen_qnetworkinformation_types.QNetworkInformation, ): QMetaObject =
  QMetaObject(h: fcQNetworkInformation_metaObject(self.h))
...
proc instance*(_: type gen_qnetworkinformation_types.QNetworkInformation, ): QNetworkInformation =
