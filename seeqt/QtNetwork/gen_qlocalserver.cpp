...
QMetaObject* QLocalServer_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQLocalServer*)(self) )->QLocalServer::metaObject();

}

void* QLocalServer_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQLocalServer*)(self) )->QLocalServer::qt_metacast(param1);

}

int QLocalServer_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQLocalServer*)(self) )->QLocalServer::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
QObject* QLocalServer_protectedbase_sender(const void* self) {
	MiqtVirtualQLocalServer* self_cast = static_cast<MiqtVirtualQLocalServer*>( (QLocalServer*)(self) );
