...
void QLocalSocket_connect_connected(QLocalSocket* self, intptr_t slot, void (*callback)(intptr_t), void (*release)(intptr_t)) {
	...
	MiqtVirtualQLocalSocket::connect(self, static_cast<void (QLocalSocket::*)()>(&QLocalSocket::connected), self, caller{slot, callback, release});
}
...
void QLocalSocket_connect_disconnected(QLocalSocket* self, intptr_t slot, void (*callback)(intptr_t), void (*release)(intptr_t)) {
	...
	MiqtVirtualQLocalSocket::connect(self, static_cast<void (QLocalSocket::*)()>(&QLocalSocket::disconnected), self, caller{slot, callback, release});
}
...
void QLocalSocket_connect_errorWithSocketError(QLocalSocket* self, intptr_t slot, void (*callback)(intptr_t, int), void (*release)(intptr_t)) {
	...
	MiqtVirtualQLocalSocket::connect(self, static_cast<void (QLocalSocket::*)(QLocalSocket::LocalSocketError)>(&QLocalSocket::error), self, caller{slot, callback, release});
}
...
void QLocalSocket_connect_errorOccurred(QLocalSocket* self, intptr_t slot, void (*callback)(intptr_t, int), void (*release)(intptr_t)) {
	...
	MiqtVirtualQLocalSocket::connect(self, static_cast<void (QLocalSocket::*)(QLocalSocket::LocalSocketError)>(&QLocalSocket::errorOccurred), self, caller{slot, callback, release});
}
...
void QLocalSocket_connect_stateChanged(QLocalSocket* self, intptr_t slot, void (*callback)(intptr_t, int), void (*release)(intptr_t)) {
	...
	MiqtVirtualQLocalSocket::connect(self, static_cast<void (QLocalSocket::*)(QLocalSocket::LocalSocketState)>(&QLocalSocket::stateChanged), self, caller{slot, callback, release});
}
...
QMetaObject* QLocalSocket_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQLocalSocket*)(self) )->QLocalSocket::metaObject();

}

void* QLocalSocket_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQLocalSocket*)(self) )->QLocalSocket::qt_metacast(param1);

}

int QLocalSocket_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQLocalSocket*)(self) )->QLocalSocket::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
long long QLocalSocket_virtualbase_readLineData(void* self, char* data, long long maxlen) {
	...
	qint64 _ret = ( (MiqtVirtualQLocalSocket*)(self) )->QLocalSocket::readLineData(data, static_cast<qint64>(maxlen));
	return static_cast<long long>(_ret);
...
void QLocalSocket_protectedbase_setOpenMode(void* self, int openMode) {
	MiqtVirtualQLocalSocket* self_cast = static_cast<MiqtVirtualQLocalSocket*>( (QLocalSocket*)(self) );
