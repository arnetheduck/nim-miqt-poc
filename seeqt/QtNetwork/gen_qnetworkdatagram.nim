...
func init*(T: type gen_qnetworkdatagram_types.QNetworkDatagram, h: ptr cQNetworkDatagram): gen_qnetworkdatagram_types.QNetworkDatagram =
  T(h: h)
proc create*(T: type gen_qnetworkdatagram_types.QNetworkDatagram, ): gen_qnetworkdatagram_types.QNetworkDatagram =
  gen_qnetworkdatagram_types.QNetworkDatagram.init(fcQNetworkDatagram_new())

proc create*(T: type gen_qnetworkdatagram_types.QNetworkDatagram, data: seq[byte]): gen_qnetworkdatagram_types.QNetworkDatagram =
  gen_qnetworkdatagram_types.QNetworkDatagram.init(fcQNetworkDatagram_new2(struct_miqt_string(data: cast[cstring](if len(data) == 0: nil else: unsafeAddr data[0]), len: csize_t(len(data)))))

proc create*(T: type gen_qnetworkdatagram_types.QNetworkDatagram, other: QNetworkDatagram): gen_qnetworkdatagram_types.QNetworkDatagram =
  gen_qnetworkdatagram_types.QNetworkDatagram.init(fcQNetworkDatagram_new3(other.h))

proc create*(T: type gen_qnetworkdatagram_types.QNetworkDatagram, data: seq[byte], destinationAddress: QHostAddress): gen_qnetworkdatagram_types.QNetworkDatagram =
  gen_qnetworkdatagram_types.QNetworkDatagram.init(fcQNetworkDatagram_new4(struct_miqt_string(data: cast[cstring](if len(data) == 0: nil else: unsafeAddr data[0]), len: csize_t(len(data))), destinationAddress.h))

proc create*(T: type gen_qnetworkdatagram_types.QNetworkDatagram, data: seq[byte], destinationAddress: QHostAddress, port: cushort): gen_qnetworkdatagram_types.QNetworkDatagram =
  gen_qnetworkdatagram_types.QNetworkDatagram.init(fcQNetworkDatagram_new5(struct_miqt_string(data: cast[cstring](if len(data) == 0: nil else: unsafeAddr data[0]), len: csize_t(len(data))), destinationAddress.h, port))

proc operatorAssign*(self: gen_qnetworkdatagram_types.QNetworkDatagram, other: QNetworkDatagram): void =
  fcQNetworkDatagram_operatorAssign(self.h, other.h)

proc swap*(self: gen_qnetworkdatagram_types.QNetworkDatagram, other: QNetworkDatagram): void =
...
proc senderAddress*(self: gen_qnetworkdatagram_types.QNetworkDatagram, ): QHostAddress =
  QHostAddress(h: fcQNetworkDatagram_senderAddress(self.h))

proc destinationAddress*(self: gen_qnetworkdatagram_types.QNetworkDatagram, ): QHostAddress =
  QHostAddress(h: fcQNetworkDatagram_destinationAddress(self.h))
...
proc setSender*(self: gen_qnetworkdatagram_types.QNetworkDatagram, address: QHostAddress): void =
  fcQNetworkDatagram_setSender(self.h, address.h)

proc setDestination*(self: gen_qnetworkdatagram_types.QNetworkDatagram, address: QHostAddress, port: cushort): void =
...
proc makeReply*(self: gen_qnetworkdatagram_types.QNetworkDatagram, payload: seq[byte]): QNetworkDatagram =
...
proc setSender*(self: gen_qnetworkdatagram_types.QNetworkDatagram, address: QHostAddress, port: cushort): void =
