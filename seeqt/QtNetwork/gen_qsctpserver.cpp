...
QMetaObject* QSctpServer_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQSctpServer*)(self) )->QSctpServer::metaObject();

}

void* QSctpServer_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQSctpServer*)(self) )->QSctpServer::qt_metacast(param1);

}

int QSctpServer_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQSctpServer*)(self) )->QSctpServer::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
