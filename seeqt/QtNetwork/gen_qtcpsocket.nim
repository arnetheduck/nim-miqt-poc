...
proc create*(T: type gen_qtcpsocket_types.QTcpSocket, parent: QObject): gen_qtcpsocket_types.QTcpSocket =
  gen_qtcpsocket_types.QTcpSocket.init(fcQTcpSocket_new2(parent.h))

proc metaObject*(self: gen_qtcpsocket_types.QTcpSocket, ): QMetaObject =
  QMetaObject(h: fcQTcpSocket_metaObject(self.h))
...
proc miqt_exec_callback_QTcpSocket_resume(self: ptr cQTcpSocket, slot: int): void {.exportc: "miqt_exec_callback_QTcpSocket_resume ".} =
  ...
  nimfunc[]()
proc QTcpSocketbindX*(self: gen_qtcpsocket_types.QTcpSocket, address: QHostAddress, port: cushort, mode: cint): bool =
  fQTcpSocket_virtualbase_bind(self.h, address.h, port, cint(mode))

type QTcpSocketbindXProc* = proc(address: QHostAddress, port: cushort, mode: cint): bool
proc onbindX*(self: gen_qtcpsocket_types.QTcpSocket, slot: QTcpSocketbindXProc) =
  # TODO check subclass
  var tmp = new QTcpSocketbindXProc
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QTcpSocket_bind(self: ptr cQTcpSocket, slot: int, address: pointer, port: cushort, mode: cint): bool {.exportc: "miqt_exec_callback_QTcpSocket_bind ".} =
  var nimfunc = cast[ptr QTcpSocketbindXProc](cast[pointer](slot))
...
proc miqt_exec_callback_QTcpSocket_setSocketDescriptor(self: ptr cQTcpSocket, slot: int, socketDescriptor: uint, state: cint, openMode: cint): bool {.exportc: "miqt_exec_callback_QTcpSocket_setSocketDescriptor ".} =
  ...
  virtualReturn
proc QTcpSocketsetSocketOption*(self: gen_qtcpsocket_types.QTcpSocket, option: cint, value: QVariant): void =
  fQTcpSocket_virtualbase_setSocketOption(self.h, cint(option), value.h)

type QTcpSocketsetSocketOptionProc* = proc(option: cint, value: QVariant): void
...
proc QTcpSocketsocketOption*(self: gen_qtcpsocket_types.QTcpSocket, option: cint): QVariant =
  QVariant(h: fQTcpSocket_virtualbase_socketOption(self.h, cint(option)))

type QTcpSocketsocketOptionProc* = proc(option: cint): QVariant
...
proc onskipData*(self: gen_qtcpsocket_types.QTcpSocket, slot: QTcpSocketskipDataProc) =
  # TODO check subclass
  var tmp = new QTcpSocketskipDataProc
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QTcpSocket_skipData(self: ptr cQTcpSocket, slot: int, maxSize: clonglong): clonglong {.exportc: "miqt_exec_callback_QTcpSocket_skipData ".} =
  var nimfunc = cast[ptr QTcpSocketskipDataProc](cast[pointer](slot))
...
proc miqt_exec_callback_QTcpSocket_canReadLine(self: ptr cQTcpSocket, slot: int): bool {.exportc: "miqt_exec_callback_QTcpSocket_canReadLine ".} =
  ...
  virtualReturn
proc QTcpSocketevent*(self: gen_qtcpsocket_types.QTcpSocket, event: QEvent): bool =
  fQTcpSocket_virtualbase_event(self.h, event.h)

type QTcpSocketeventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QTcpSocket_event(self: ptr cQTcpSocket, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QTcpSocket_event ".} =
  ...
  virtualReturn
proc QTcpSocketeventFilter*(self: gen_qtcpsocket_types.QTcpSocket, watched: QObject, event: QEvent): bool =
  fQTcpSocket_virtualbase_eventFilter(self.h, watched.h, event.h)

type QTcpSocketeventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QTcpSocket_eventFilter(self: ptr cQTcpSocket, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QTcpSocket_eventFilter ".} =
  ...
  virtualReturn
proc QTcpSockettimerEvent*(self: gen_qtcpsocket_types.QTcpSocket, event: QTimerEvent): void =
  fQTcpSocket_virtualbase_timerEvent(self.h, event.h)

type QTcpSockettimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QTcpSocket_timerEvent(self: ptr cQTcpSocket, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTcpSocket_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTcpSocketchildEvent*(self: gen_qtcpsocket_types.QTcpSocket, event: QChildEvent): void =
  fQTcpSocket_virtualbase_childEvent(self.h, event.h)

type QTcpSocketchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QTcpSocket_childEvent(self: ptr cQTcpSocket, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTcpSocket_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTcpSocketcustomEvent*(self: gen_qtcpsocket_types.QTcpSocket, event: QEvent): void =
  fQTcpSocket_virtualbase_customEvent(self.h, event.h)

type QTcpSocketcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QTcpSocket_customEvent(self: ptr cQTcpSocket, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTcpSocket_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTcpSocketconnectNotify*(self: gen_qtcpsocket_types.QTcpSocket, signal: QMetaMethod): void =
  fQTcpSocket_virtualbase_connectNotify(self.h, signal.h)

type QTcpSocketconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QTcpSocket_connectNotify(self: ptr cQTcpSocket, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QTcpSocket_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QTcpSocketdisconnectNotify*(self: gen_qtcpsocket_types.QTcpSocket, signal: QMetaMethod): void =
  fQTcpSocket_virtualbase_disconnectNotify(self.h, signal.h)

type QTcpSocketdisconnectNotifyProc* = proc(signal: QMetaMethod): void
