...
void QNetworkReply_connect_socketStartedConnecting(QNetworkReply* self, intptr_t slot, void (*callback)(intptr_t), void (*release)(intptr_t)) {
	...
	QNetworkReply::connect(self, static_cast<void (QNetworkReply::*)()>(&QNetworkReply::socketStartedConnecting), self, caller{slot, callback, release});
}
...
void QNetworkReply_connect_requestSent(QNetworkReply* self, intptr_t slot, void (*callback)(intptr_t), void (*release)(intptr_t)) {
	...
	QNetworkReply::connect(self, static_cast<void (QNetworkReply::*)()>(&QNetworkReply::requestSent), self, caller{slot, callback, release});
}
...
void QNetworkReply_connect_metaDataChanged(QNetworkReply* self, intptr_t slot, void (*callback)(intptr_t), void (*release)(intptr_t)) {
	...
	QNetworkReply::connect(self, static_cast<void (QNetworkReply::*)()>(&QNetworkReply::metaDataChanged), self, caller{slot, callback, release});
}
...
void QNetworkReply_connect_finished(QNetworkReply* self, intptr_t slot, void (*callback)(intptr_t), void (*release)(intptr_t)) {
	...
	QNetworkReply::connect(self, static_cast<void (QNetworkReply::*)()>(&QNetworkReply::finished), self, caller{slot, callback, release});
}
...
void QNetworkReply_connect_errorOccurred(QNetworkReply* self, intptr_t slot, void (*callback)(intptr_t, int), void (*release)(intptr_t)) {
	...
	QNetworkReply::connect(self, static_cast<void (QNetworkReply::*)(QNetworkReply::NetworkError)>(&QNetworkReply::errorOccurred), self, caller{slot, callback, release});
}
...
void QNetworkReply_connect_encrypted(QNetworkReply* self, intptr_t slot, void (*callback)(intptr_t), void (*release)(intptr_t)) {
	...
	QNetworkReply::connect(self, static_cast<void (QNetworkReply::*)()>(&QNetworkReply::encrypted), self, caller{slot, callback, release});
}
...
void QNetworkReply_connect_sslErrors(QNetworkReply* self, intptr_t slot, void (*callback)(intptr_t, struct miqt_array /* of QSslError* */ ), void (*release)(intptr_t)) {
	...
	QNetworkReply::connect(self, static_cast<void (QNetworkReply::*)(const QList<QSslError>&)>(&QNetworkReply::sslErrors), self, caller{slot, callback, release});
}
...
void QNetworkReply_connect_preSharedKeyAuthenticationRequired(QNetworkReply* self, intptr_t slot, void (*callback)(intptr_t, QSslPreSharedKeyAuthenticator*), void (*release)(intptr_t)) {
	...
	QNetworkReply::connect(self, static_cast<void (QNetworkReply::*)(QSslPreSharedKeyAuthenticator*)>(&QNetworkReply::preSharedKeyAuthenticationRequired), self, caller{slot, callback, release});
}
...
void QNetworkReply_connect_redirected(QNetworkReply* self, intptr_t slot, void (*callback)(intptr_t, QUrl*), void (*release)(intptr_t)) {
	...
	QNetworkReply::connect(self, static_cast<void (QNetworkReply::*)(const QUrl&)>(&QNetworkReply::redirected), self, caller{slot, callback, release});
}
...
void QNetworkReply_connect_redirectAllowed(QNetworkReply* self, intptr_t slot, void (*callback)(intptr_t), void (*release)(intptr_t)) {
	...
	QNetworkReply::connect(self, static_cast<void (QNetworkReply::*)()>(&QNetworkReply::redirectAllowed), self, caller{slot, callback, release});
}
...
void QNetworkReply_connect_uploadProgress(QNetworkReply* self, intptr_t slot, void (*callback)(intptr_t, long long, long long), void (*release)(intptr_t)) {
	...
	QNetworkReply::connect(self, static_cast<void (QNetworkReply::*)(qint64, qint64)>(&QNetworkReply::uploadProgress), self, caller{slot, callback, release});
}
...
void QNetworkReply_connect_downloadProgress(QNetworkReply* self, intptr_t slot, void (*callback)(intptr_t, long long, long long), void (*release)(intptr_t)) {
	...
	QNetworkReply::connect(self, static_cast<void (QNetworkReply::*)(qint64, qint64)>(&QNetworkReply::downloadProgress), self, caller{slot, callback, release});
}
