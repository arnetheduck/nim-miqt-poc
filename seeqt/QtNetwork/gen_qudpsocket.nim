...
proc fQUdpSocket_virtualbase_bind(self: pointer, address: pointer, port: cushort, mode: cint): bool{.importc: "QUdpSocket_virtualbase_bind".}
proc fcQUdpSocket_override_virtual_bindX(self: pointer, slot: int) {.importc: "QUdpSocket_override_virtual_bind".}
...
proc fQUdpSocket_virtualbase_skipData(self: pointer, maxSize: clonglong): clonglong{.importc: "QUdpSocket_virtualbase_skipData".}
proc fcQUdpSocket_override_virtual_skipData(self: pointer, slot: int) {.importc: "QUdpSocket_override_virtual_skipData".}
...
proc create*(T: type gen_qudpsocket_types.QUdpSocket, parent: QObject): gen_qudpsocket_types.QUdpSocket =
  gen_qudpsocket_types.QUdpSocket.init(fcQUdpSocket_new2(parent.h))

proc metaObject*(self: gen_qudpsocket_types.QUdpSocket, ): QMetaObject =
  QMetaObject(h: fcQUdpSocket_metaObject(self.h))
...
proc joinMulticastGroup*(self: gen_qudpsocket_types.QUdpSocket, groupAddress: QHostAddress): bool =
  fcQUdpSocket_joinMulticastGroup(self.h, groupAddress.h)

proc joinMulticastGroup*(self: gen_qudpsocket_types.QUdpSocket, groupAddress: QHostAddress, iface: QNetworkInterface): bool =
  fcQUdpSocket_joinMulticastGroup2(self.h, groupAddress.h, iface.h)

proc leaveMulticastGroup*(self: gen_qudpsocket_types.QUdpSocket, groupAddress: QHostAddress): bool =
  fcQUdpSocket_leaveMulticastGroup(self.h, groupAddress.h)

proc leaveMulticastGroup*(self: gen_qudpsocket_types.QUdpSocket, groupAddress: QHostAddress, iface: QNetworkInterface): bool =
  fcQUdpSocket_leaveMulticastGroup2(self.h, groupAddress.h, iface.h)

proc multicastInterface*(self: gen_qudpsocket_types.QUdpSocket, ): QNetworkInterface =
  QNetworkInterface(h: fcQUdpSocket_multicastInterface(self.h))

proc setMulticastInterface*(self: gen_qudpsocket_types.QUdpSocket, iface: QNetworkInterface): void =
...
proc receiveDatagram*(self: gen_qudpsocket_types.QUdpSocket, ): QNetworkDatagram =
  QNetworkDatagram(h: fcQUdpSocket_receiveDatagram(self.h))
...
proc writeDatagram*(self: gen_qudpsocket_types.QUdpSocket, datagram: QNetworkDatagram): clonglong =
  fcQUdpSocket_writeDatagram(self.h, datagram.h)

proc writeDatagram*(self: gen_qudpsocket_types.QUdpSocket, data: cstring, len: clonglong, host: QHostAddress, port: cushort): clonglong =
  fcQUdpSocket_writeDatagram2(self.h, data, len, host.h, port)

proc writeDatagram*(self: gen_qudpsocket_types.QUdpSocket, datagram: seq[byte], host: QHostAddress, port: cushort): clonglong =
...
proc receiveDatagram*(self: gen_qudpsocket_types.QUdpSocket, maxSize: clonglong): QNetworkDatagram =
  QNetworkDatagram(h: fcQUdpSocket_receiveDatagram1(self.h, maxSize))

proc readDatagram*(self: gen_qudpsocket_types.QUdpSocket, data: cstring, maxlen: clonglong, host: QHostAddress): clonglong =
  fcQUdpSocket_readDatagram3(self.h, data, maxlen, host.h)

proc readDatagram*(self: gen_qudpsocket_types.QUdpSocket, data: cstring, maxlen: clonglong, host: QHostAddress, port: ptr cushort): clonglong =
...
proc miqt_exec_callback_QUdpSocket_resume(self: ptr cQUdpSocket, slot: int): void {.exportc: "miqt_exec_callback_QUdpSocket_resume ".} =
  ...
  nimfunc[]()
proc QUdpSocketbindX*(self: gen_qudpsocket_types.QUdpSocket, address: QHostAddress, port: cushort, mode: cint): bool =
  fQUdpSocket_virtualbase_bind(self.h, address.h, port, cint(mode))

type QUdpSocketbindXProc* = proc(address: QHostAddress, port: cushort, mode: cint): bool
proc onbindX*(self: gen_qudpsocket_types.QUdpSocket, slot: QUdpSocketbindXProc) =
  # TODO check subclass
  var tmp = new QUdpSocketbindXProc
  tmp[] = slot
  GC_ref(tmp)
  fcQUdpSocket_override_virtual_bindX(self.h, cast[int](addr tmp[]))

proc miqt_exec_callback_QUdpSocket_bind(self: ptr cQUdpSocket, slot: int, address: pointer, port: cushort, mode: cint): bool {.exportc: "miqt_exec_callback_QUdpSocket_bind ".} =
  var nimfunc = cast[ptr QUdpSocketbindXProc](cast[pointer](slot))
  let slotval1 = QHostAddress(h: address)
...
proc miqt_exec_callback_QUdpSocket_setSocketDescriptor(self: ptr cQUdpSocket, slot: int, socketDescriptor: uint, state: cint, openMode: cint): bool {.exportc: "miqt_exec_callback_QUdpSocket_setSocketDescriptor ".} =
  ...
  virtualReturn
proc QUdpSocketsetSocketOption*(self: gen_qudpsocket_types.QUdpSocket, option: cint, value: QVariant): void =
  fQUdpSocket_virtualbase_setSocketOption(self.h, cint(option), value.h)

type QUdpSocketsetSocketOptionProc* = proc(option: cint, value: QVariant): void
...
proc QUdpSocketsocketOption*(self: gen_qudpsocket_types.QUdpSocket, option: cint): QVariant =
  QVariant(h: fQUdpSocket_virtualbase_socketOption(self.h, cint(option)))

type QUdpSocketsocketOptionProc* = proc(option: cint): QVariant
...
proc QUdpSocketskipData*(self: gen_qudpsocket_types.QUdpSocket, maxSize: clonglong): clonglong =
  fQUdpSocket_virtualbase_skipData(self.h, maxSize)

type QUdpSocketskipDataProc* = proc(maxSize: clonglong): clonglong
proc onskipData*(self: gen_qudpsocket_types.QUdpSocket, slot: QUdpSocketskipDataProc) =
  # TODO check subclass
  var tmp = new QUdpSocketskipDataProc
  tmp[] = slot
  GC_ref(tmp)
  fcQUdpSocket_override_virtual_skipData(self.h, cast[int](addr tmp[]))

proc miqt_exec_callback_QUdpSocket_skipData(self: ptr cQUdpSocket, slot: int, maxSize: clonglong): clonglong {.exportc: "miqt_exec_callback_QUdpSocket_skipData ".} =
  var nimfunc = cast[ptr QUdpSocketskipDataProc](cast[pointer](slot))
...
proc miqt_exec_callback_QUdpSocket_canReadLine(self: ptr cQUdpSocket, slot: int): bool {.exportc: "miqt_exec_callback_QUdpSocket_canReadLine ".} =
  ...
  virtualReturn
proc QUdpSocketevent*(self: gen_qudpsocket_types.QUdpSocket, event: QEvent): bool =
  fQUdpSocket_virtualbase_event(self.h, event.h)

type QUdpSocketeventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QUdpSocket_event(self: ptr cQUdpSocket, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QUdpSocket_event ".} =
  ...
  virtualReturn
proc QUdpSocketeventFilter*(self: gen_qudpsocket_types.QUdpSocket, watched: QObject, event: QEvent): bool =
  fQUdpSocket_virtualbase_eventFilter(self.h, watched.h, event.h)

type QUdpSocketeventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QUdpSocket_eventFilter(self: ptr cQUdpSocket, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QUdpSocket_eventFilter ".} =
  ...
  virtualReturn
proc QUdpSockettimerEvent*(self: gen_qudpsocket_types.QUdpSocket, event: QTimerEvent): void =
  fQUdpSocket_virtualbase_timerEvent(self.h, event.h)

type QUdpSockettimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QUdpSocket_timerEvent(self: ptr cQUdpSocket, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QUdpSocket_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QUdpSocketchildEvent*(self: gen_qudpsocket_types.QUdpSocket, event: QChildEvent): void =
  fQUdpSocket_virtualbase_childEvent(self.h, event.h)

type QUdpSocketchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QUdpSocket_childEvent(self: ptr cQUdpSocket, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QUdpSocket_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QUdpSocketcustomEvent*(self: gen_qudpsocket_types.QUdpSocket, event: QEvent): void =
  fQUdpSocket_virtualbase_customEvent(self.h, event.h)

type QUdpSocketcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QUdpSocket_customEvent(self: ptr cQUdpSocket, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QUdpSocket_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QUdpSocketconnectNotify*(self: gen_qudpsocket_types.QUdpSocket, signal: QMetaMethod): void =
  fQUdpSocket_virtualbase_connectNotify(self.h, signal.h)

type QUdpSocketconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QUdpSocket_connectNotify(self: ptr cQUdpSocket, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QUdpSocket_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QUdpSocketdisconnectNotify*(self: gen_qudpsocket_types.QUdpSocket, signal: QMetaMethod): void =
  fQUdpSocket_virtualbase_disconnectNotify(self.h, signal.h)

type QUdpSocketdisconnectNotifyProc* = proc(signal: QMetaMethod): void
