...
proc create*(T: type gen_qsslserver_types.QSslServer, parent: QObject): gen_qsslserver_types.QSslServer =
  gen_qsslserver_types.QSslServer.init(fcQSslServer_new2(parent.h))

proc metaObject*(self: gen_qsslserver_types.QSslServer, ): QMetaObject =
  QMetaObject(h: fcQSslServer_metaObject(self.h))
...
proc setSslConfiguration*(self: gen_qsslserver_types.QSslServer, sslConfiguration: QSslConfiguration): void =
  fcQSslServer_setSslConfiguration(self.h, sslConfiguration.h)

proc sslConfiguration*(self: gen_qsslserver_types.QSslServer, ): QSslConfiguration =
  QSslConfiguration(h: fcQSslServer_sslConfiguration(self.h))
...
proc sslErrors*(self: gen_qsslserver_types.QSslServer, socket: QSslSocket, errors: seq[QSslError]): void =
...
type QSslServersslErrorsSlot* = proc(socket: QSslSocket, errors: seq[QSslError])
proc miqt_exec_callback_QSslServer_sslErrors(slot: int, socket: pointer, errors: struct_miqt_array) {.exportc.} =
  ...
  let slotval1 = QSslSocket(h: socket)
...
proc peerVerifyError*(self: gen_qsslserver_types.QSslServer, socket: QSslSocket, error: QSslError): void =
  fcQSslServer_peerVerifyError(self.h, socket.h, error.h)

type QSslServerpeerVerifyErrorSlot* = proc(socket: QSslSocket, error: QSslError)
proc miqt_exec_callback_QSslServer_peerVerifyError(slot: int, socket: pointer, error: pointer) {.exportc.} =
  ...
  let slotval2 = QSslError(h: error)
...
proc errorOccurred*(self: gen_qsslserver_types.QSslServer, socket: QSslSocket, error: cint): void =
  fcQSslServer_errorOccurred(self.h, socket.h, cint(error))

type QSslServererrorOccurredSlot* = proc(socket: QSslSocket, error: cint)
...
proc preSharedKeyAuthenticationRequired*(self: gen_qsslserver_types.QSslServer, socket: QSslSocket, authenticator: QSslPreSharedKeyAuthenticator): void =
  fcQSslServer_preSharedKeyAuthenticationRequired(self.h, socket.h, authenticator.h)

type QSslServerpreSharedKeyAuthenticationRequiredSlot* = proc(socket: QSslSocket, authenticator: QSslPreSharedKeyAuthenticator)
...
proc alertSent*(self: gen_qsslserver_types.QSslServer, socket: QSslSocket, level: cint, typeVal: cint, description: string): void =
...
type QSslServeralertSentSlot* = proc(socket: QSslSocket, level: cint, typeVal: cint, description: string)
...
proc alertReceived*(self: gen_qsslserver_types.QSslServer, socket: QSslSocket, level: cint, typeVal: cint, description: string): void =
...
type QSslServeralertReceivedSlot* = proc(socket: QSslSocket, level: cint, typeVal: cint, description: string)
...
proc handshakeInterruptedOnError*(self: gen_qsslserver_types.QSslServer, socket: QSslSocket, error: QSslError): void =
  fcQSslServer_handshakeInterruptedOnError(self.h, socket.h, error.h)

type QSslServerhandshakeInterruptedOnErrorSlot* = proc(socket: QSslSocket, error: QSslError)
...
proc startedEncryptionHandshake*(self: gen_qsslserver_types.QSslServer, socket: QSslSocket): void =
  fcQSslServer_startedEncryptionHandshake(self.h, socket.h)

type QSslServerstartedEncryptionHandshakeSlot* = proc(socket: QSslSocket)
...
proc miqt_exec_callback_QSslServer_hasPendingConnections(self: ptr cQSslServer, slot: int): bool {.exportc: "miqt_exec_callback_QSslServer_hasPendingConnections ".} =
  ...
  virtualReturn
proc QSslServernextPendingConnection*(self: gen_qsslserver_types.QSslServer, ): QTcpSocket =
  QTcpSocket(h: fQSslServer_virtualbase_nextPendingConnection(self.h))

type QSslServernextPendingConnectionProc* = proc(): QTcpSocket
...
proc miqt_exec_callback_QSslServer_nextPendingConnection(self: ptr cQSslServer, slot: int): pointer {.exportc: "miqt_exec_callback_QSslServer_nextPendingConnection ".} =
  ...
  virtualReturn.h
proc QSslServerevent*(self: gen_qsslserver_types.QSslServer, event: QEvent): bool =
  fQSslServer_virtualbase_event(self.h, event.h)

type QSslServereventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QSslServer_event(self: ptr cQSslServer, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QSslServer_event ".} =
  ...
  virtualReturn
proc QSslServereventFilter*(self: gen_qsslserver_types.QSslServer, watched: QObject, event: QEvent): bool =
  fQSslServer_virtualbase_eventFilter(self.h, watched.h, event.h)

type QSslServereventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QSslServer_eventFilter(self: ptr cQSslServer, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QSslServer_eventFilter ".} =
  ...
  virtualReturn
proc QSslServertimerEvent*(self: gen_qsslserver_types.QSslServer, event: QTimerEvent): void =
  fQSslServer_virtualbase_timerEvent(self.h, event.h)

type QSslServertimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QSslServer_timerEvent(self: ptr cQSslServer, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QSslServer_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QSslServerchildEvent*(self: gen_qsslserver_types.QSslServer, event: QChildEvent): void =
  fQSslServer_virtualbase_childEvent(self.h, event.h)

type QSslServerchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QSslServer_childEvent(self: ptr cQSslServer, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QSslServer_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QSslServercustomEvent*(self: gen_qsslserver_types.QSslServer, event: QEvent): void =
  fQSslServer_virtualbase_customEvent(self.h, event.h)

type QSslServercustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QSslServer_customEvent(self: ptr cQSslServer, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QSslServer_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QSslServerconnectNotify*(self: gen_qsslserver_types.QSslServer, signal: QMetaMethod): void =
  fQSslServer_virtualbase_connectNotify(self.h, signal.h)

type QSslServerconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QSslServer_connectNotify(self: ptr cQSslServer, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QSslServer_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QSslServerdisconnectNotify*(self: gen_qsslserver_types.QSslServer, signal: QMetaMethod): void =
  fQSslServer_virtualbase_disconnectNotify(self.h, signal.h)

type QSslServerdisconnectNotifyProc* = proc(signal: QMetaMethod): void
