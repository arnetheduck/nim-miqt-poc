...
QMetaObject* QDtlsClientVerifier_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQDtlsClientVerifier*)(self) )->QDtlsClientVerifier::metaObject();

}

void* QDtlsClientVerifier_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQDtlsClientVerifier*)(self) )->QDtlsClientVerifier::qt_metacast(param1);

}

int QDtlsClientVerifier_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQDtlsClientVerifier*)(self) )->QDtlsClientVerifier::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
QObject* QDtlsClientVerifier_protectedbase_sender(const void* self) {
	MiqtVirtualQDtlsClientVerifier* self_cast = static_cast<MiqtVirtualQDtlsClientVerifier*>( (QDtlsClientVerifier*)(self) );
...
void QDtls_connect_pskRequired(QDtls* self, intptr_t slot, void (*callback)(intptr_t, QSslPreSharedKeyAuthenticator*), void (*release)(intptr_t)) {
	...
	MiqtVirtualQDtls::connect(self, static_cast<void (QDtls::*)(QSslPreSharedKeyAuthenticator*)>(&QDtls::pskRequired), self, caller{slot, callback, release});
}
...
void QDtls_connect_handshakeTimeout(QDtls* self, intptr_t slot, void (*callback)(intptr_t), void (*release)(intptr_t)) {
	...
	MiqtVirtualQDtls::connect(self, static_cast<void (QDtls::*)()>(&QDtls::handshakeTimeout), self, caller{slot, callback, release});
}
...
QMetaObject* QDtls_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQDtls*)(self) )->QDtls::metaObject();

}

void* QDtls_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQDtls*)(self) )->QDtls::qt_metacast(param1);

}

int QDtls_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQDtls*)(self) )->QDtls::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
QObject* QDtls_protectedbase_sender(const void* self) {
	MiqtVirtualQDtls* self_cast = static_cast<MiqtVirtualQDtls*>( (QDtls*)(self) );
