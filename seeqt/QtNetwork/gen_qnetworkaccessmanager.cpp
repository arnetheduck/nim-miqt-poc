...
public:
	...
	MiqtVirtualQNetworkAccessManager(struct QNetworkAccessManager_VTable* vtbl): QNetworkAccessManager(), vtbl(vtbl) {};
	MiqtVirtualQNetworkAccessManager(struct QNetworkAccessManager_VTable* vtbl, QObject* parent): QNetworkAccessManager(parent), vtbl(vtbl) {};

	virtual ~MiqtVirtualQNetworkAccessManager() override { if(vtbl->destructor) vtbl->destructor(vtbl, this); }
...
void QNetworkAccessManager_connect_proxyAuthenticationRequired(QNetworkAccessManager* self, intptr_t slot, void (*callback)(intptr_t, QNetworkProxy*, QAuthenticator*), void (*release)(intptr_t)) {
	...
	MiqtVirtualQNetworkAccessManager::connect(self, static_cast<void (QNetworkAccessManager::*)(const QNetworkProxy&, QAuthenticator*)>(&QNetworkAccessManager::proxyAuthenticationRequired), self, caller{slot, callback, release});
}
...
void QNetworkAccessManager_connect_authenticationRequired(QNetworkAccessManager* self, intptr_t slot, void (*callback)(intptr_t, QNetworkReply*, QAuthenticator*), void (*release)(intptr_t)) {
	...
	MiqtVirtualQNetworkAccessManager::connect(self, static_cast<void (QNetworkAccessManager::*)(QNetworkReply*, QAuthenticator*)>(&QNetworkAccessManager::authenticationRequired), self, caller{slot, callback, release});
}
...
void QNetworkAccessManager_connect_finished(QNetworkAccessManager* self, intptr_t slot, void (*callback)(intptr_t, QNetworkReply*), void (*release)(intptr_t)) {
	...
	MiqtVirtualQNetworkAccessManager::connect(self, static_cast<void (QNetworkAccessManager::*)(QNetworkReply*)>(&QNetworkAccessManager::finished), self, caller{slot, callback, release});
}
...
void QNetworkAccessManager_connect_encrypted(QNetworkAccessManager* self, intptr_t slot, void (*callback)(intptr_t, QNetworkReply*), void (*release)(intptr_t)) {
	...
	MiqtVirtualQNetworkAccessManager::connect(self, static_cast<void (QNetworkAccessManager::*)(QNetworkReply*)>(&QNetworkAccessManager::encrypted), self, caller{slot, callback, release});
}
...
void QNetworkAccessManager_connect_sslErrors(QNetworkAccessManager* self, intptr_t slot, void (*callback)(intptr_t, QNetworkReply*, struct miqt_array /* of QSslError* */ ), void (*release)(intptr_t)) {
	...
	MiqtVirtualQNetworkAccessManager::connect(self, static_cast<void (QNetworkAccessManager::*)(QNetworkReply*, const QList<QSslError>&)>(&QNetworkAccessManager::sslErrors), self, caller{slot, callback, release});
}
...
void QNetworkAccessManager_connect_preSharedKeyAuthenticationRequired(QNetworkAccessManager* self, intptr_t slot, void (*callback)(intptr_t, QNetworkReply*, QSslPreSharedKeyAuthenticator*), void (*release)(intptr_t)) {
	...
	MiqtVirtualQNetworkAccessManager::connect(self, static_cast<void (QNetworkAccessManager::*)(QNetworkReply*, QSslPreSharedKeyAuthenticator*)>(&QNetworkAccessManager::preSharedKeyAuthenticationRequired), self, caller{slot, callback, release});
}
...
void QNetworkAccessManager_connect_networkSessionConnected(QNetworkAccessManager* self, intptr_t slot, void (*callback)(intptr_t), void (*release)(intptr_t)) {
	...
	MiqtVirtualQNetworkAccessManager::connect(self, static_cast<void (QNetworkAccessManager::*)()>(&QNetworkAccessManager::networkSessionConnected), self, caller{slot, callback, release});
}
...
void QNetworkAccessManager_connect_networkAccessibleChanged(QNetworkAccessManager* self, intptr_t slot, void (*callback)(intptr_t, int), void (*release)(intptr_t)) {
	...
	MiqtVirtualQNetworkAccessManager::connect(self, static_cast<void (QNetworkAccessManager::*)(QNetworkAccessManager::NetworkAccessibility)>(&QNetworkAccessManager::networkAccessibleChanged), self, caller{slot, callback, release});
}
...
QMetaObject* QNetworkAccessManager_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQNetworkAccessManager*)(self) )->QNetworkAccessManager::metaObject();

}

void* QNetworkAccessManager_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQNetworkAccessManager*)(self) )->QNetworkAccessManager::qt_metacast(param1);

}

int QNetworkAccessManager_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQNetworkAccessManager*)(self) )->QNetworkAccessManager::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
struct miqt_array /* of struct miqt_string */  QNetworkAccessManager_protectedbase_supportedSchemesImplementation(const void* self) {
	MiqtVirtualQNetworkAccessManager* self_cast = static_cast<MiqtVirtualQNetworkAccessManager*>( (QNetworkAccessManager*)(self) );
