...
proc create*(T: type gen_qocspresponse_types.QOcspResponse, other: QOcspResponse): gen_qocspresponse_types.QOcspResponse =
  gen_qocspresponse_types.QOcspResponse.init(fcQOcspResponse_new2(other.h))

proc operatorAssign*(self: gen_qocspresponse_types.QOcspResponse, other: QOcspResponse): void =
...
proc responder*(self: gen_qocspresponse_types.QOcspResponse, ): QSslCertificate =
  QSslCertificate(h: fcQOcspResponse_responder(self.h))

proc subject*(self: gen_qocspresponse_types.QOcspResponse, ): QSslCertificate =
  QSslCertificate(h: fcQOcspResponse_subject(self.h))

proc swap*(self: gen_qocspresponse_types.QOcspResponse, other: QOcspResponse): void =
