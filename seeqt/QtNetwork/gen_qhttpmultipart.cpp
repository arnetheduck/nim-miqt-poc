...
int QHttpMultiPart_virtualbase_metacall(void* self, int param1, int param2, void** param3) {
	...
	return ( (MiqtVirtualQHttpMultiPart*)(self) )->QHttpMultiPart::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
QObject* QHttpMultiPart_protectedbase_sender(const void* self) {
	MiqtVirtualQHttpMultiPart* self_cast = static_cast<MiqtVirtualQHttpMultiPart*>( (QHttpMultiPart*)(self) );
