...
proc create*(T: type gen_qsctpserver_types.QSctpServer, parent: QObject): gen_qsctpserver_types.QSctpServer =
  gen_qsctpserver_types.QSctpServer.init(fcQSctpServer_new2(parent.h))

proc metaObject*(self: gen_qsctpserver_types.QSctpServer, ): QMetaObject =
  QMetaObject(h: fcQSctpServer_metaObject(self.h))
...
proc nextPendingDatagramConnection*(self: gen_qsctpserver_types.QSctpServer, ): QSctpSocket =
  QSctpSocket(h: fcQSctpServer_nextPendingDatagramConnection(self.h))
...
proc miqt_exec_callback_QSctpServer_hasPendingConnections(self: ptr cQSctpServer, slot: int): bool {.exportc: "miqt_exec_callback_QSctpServer_hasPendingConnections ".} =
  ...
  virtualReturn
proc QSctpServernextPendingConnection*(self: gen_qsctpserver_types.QSctpServer, ): QTcpSocket =
  QTcpSocket(h: fQSctpServer_virtualbase_nextPendingConnection(self.h))

type QSctpServernextPendingConnectionProc* = proc(): QTcpSocket
...
proc miqt_exec_callback_QSctpServer_nextPendingConnection(self: ptr cQSctpServer, slot: int): pointer {.exportc: "miqt_exec_callback_QSctpServer_nextPendingConnection ".} =
  ...
  virtualReturn.h
proc QSctpServerevent*(self: gen_qsctpserver_types.QSctpServer, event: QEvent): bool =
  fQSctpServer_virtualbase_event(self.h, event.h)

type QSctpServereventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QSctpServer_event(self: ptr cQSctpServer, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QSctpServer_event ".} =
  ...
  virtualReturn
proc QSctpServereventFilter*(self: gen_qsctpserver_types.QSctpServer, watched: QObject, event: QEvent): bool =
  fQSctpServer_virtualbase_eventFilter(self.h, watched.h, event.h)

type QSctpServereventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QSctpServer_eventFilter(self: ptr cQSctpServer, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QSctpServer_eventFilter ".} =
  ...
  virtualReturn
proc QSctpServertimerEvent*(self: gen_qsctpserver_types.QSctpServer, event: QTimerEvent): void =
  fQSctpServer_virtualbase_timerEvent(self.h, event.h)

type QSctpServertimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QSctpServer_timerEvent(self: ptr cQSctpServer, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QSctpServer_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QSctpServerchildEvent*(self: gen_qsctpserver_types.QSctpServer, event: QChildEvent): void =
  fQSctpServer_virtualbase_childEvent(self.h, event.h)

type QSctpServerchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QSctpServer_childEvent(self: ptr cQSctpServer, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QSctpServer_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QSctpServercustomEvent*(self: gen_qsctpserver_types.QSctpServer, event: QEvent): void =
  fQSctpServer_virtualbase_customEvent(self.h, event.h)

type QSctpServercustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QSctpServer_customEvent(self: ptr cQSctpServer, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QSctpServer_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QSctpServerconnectNotify*(self: gen_qsctpserver_types.QSctpServer, signal: QMetaMethod): void =
  fQSctpServer_virtualbase_connectNotify(self.h, signal.h)

type QSctpServerconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QSctpServer_connectNotify(self: ptr cQSctpServer, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QSctpServer_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QSctpServerdisconnectNotify*(self: gen_qsctpserver_types.QSctpServer, signal: QMetaMethod): void =
  fQSctpServer_virtualbase_disconnectNotify(self.h, signal.h)

type QSctpServerdisconnectNotifyProc* = proc(signal: QMetaMethod): void
