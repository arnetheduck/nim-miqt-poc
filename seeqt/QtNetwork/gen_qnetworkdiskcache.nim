...
proc create*(T: type gen_qnetworkdiskcache_types.QNetworkDiskCache, parent: QObject): gen_qnetworkdiskcache_types.QNetworkDiskCache =
  gen_qnetworkdiskcache_types.QNetworkDiskCache.init(fcQNetworkDiskCache_new2(parent.h))

proc metaObject*(self: gen_qnetworkdiskcache_types.QNetworkDiskCache, ): QMetaObject =
  QMetaObject(h: fcQNetworkDiskCache_metaObject(self.h))
...
proc metaData*(self: gen_qnetworkdiskcache_types.QNetworkDiskCache, url: QUrl): QNetworkCacheMetaData =
  QNetworkCacheMetaData(h: fcQNetworkDiskCache_metaData(self.h, url.h))

proc updateMetaData*(self: gen_qnetworkdiskcache_types.QNetworkDiskCache, metaData: QNetworkCacheMetaData): void =
  fcQNetworkDiskCache_updateMetaData(self.h, metaData.h)

proc data*(self: gen_qnetworkdiskcache_types.QNetworkDiskCache, url: QUrl): QIODevice =
  QIODevice(h: fcQNetworkDiskCache_data(self.h, url.h))

proc remove*(self: gen_qnetworkdiskcache_types.QNetworkDiskCache, url: QUrl): bool =
  fcQNetworkDiskCache_remove(self.h, url.h)

proc prepare*(self: gen_qnetworkdiskcache_types.QNetworkDiskCache, metaData: QNetworkCacheMetaData): QIODevice =
  QIODevice(h: fcQNetworkDiskCache_prepare(self.h, metaData.h))

proc insert*(self: gen_qnetworkdiskcache_types.QNetworkDiskCache, device: QIODevice): void =
  fcQNetworkDiskCache_insert(self.h, device.h)

proc fileMetaData*(self: gen_qnetworkdiskcache_types.QNetworkDiskCache, fileName: string): QNetworkCacheMetaData =
  QNetworkCacheMetaData(h: fcQNetworkDiskCache_fileMetaData(self.h, struct_miqt_string(data: fileName, len: csize_t(len(fileName)))))
...
proc miqt_exec_callback_QNetworkDiskCache_cacheSize(self: ptr cQNetworkDiskCache, slot: int): clonglong {.exportc: "miqt_exec_callback_QNetworkDiskCache_cacheSize ".} =
  ...
  virtualReturn
proc QNetworkDiskCachemetaData*(self: gen_qnetworkdiskcache_types.QNetworkDiskCache, url: QUrl): QNetworkCacheMetaData =
  QNetworkCacheMetaData(h: fQNetworkDiskCache_virtualbase_metaData(self.h, url.h))

type QNetworkDiskCachemetaDataProc* = proc(url: QUrl): QNetworkCacheMetaData
...
proc miqt_exec_callback_QNetworkDiskCache_metaData(self: ptr cQNetworkDiskCache, slot: int, url: pointer): pointer {.exportc: "miqt_exec_callback_QNetworkDiskCache_metaData ".} =
  ...
  virtualReturn.h
proc QNetworkDiskCacheupdateMetaData*(self: gen_qnetworkdiskcache_types.QNetworkDiskCache, metaData: QNetworkCacheMetaData): void =
  fQNetworkDiskCache_virtualbase_updateMetaData(self.h, metaData.h)

type QNetworkDiskCacheupdateMetaDataProc* = proc(metaData: QNetworkCacheMetaData): void
...
proc miqt_exec_callback_QNetworkDiskCache_updateMetaData(self: ptr cQNetworkDiskCache, slot: int, metaData: pointer): void {.exportc: "miqt_exec_callback_QNetworkDiskCache_updateMetaData ".} =
  ...
  let slotval1 = QNetworkCacheMetaData(h: metaData)


  nimfunc[](slotval1)
proc QNetworkDiskCachedata*(self: gen_qnetworkdiskcache_types.QNetworkDiskCache, url: QUrl): QIODevice =
  QIODevice(h: fQNetworkDiskCache_virtualbase_data(self.h, url.h))

type QNetworkDiskCachedataProc* = proc(url: QUrl): QIODevice
...
proc miqt_exec_callback_QNetworkDiskCache_data(self: ptr cQNetworkDiskCache, slot: int, url: pointer): pointer {.exportc: "miqt_exec_callback_QNetworkDiskCache_data ".} =
  ...
  virtualReturn.h
proc QNetworkDiskCacheremove*(self: gen_qnetworkdiskcache_types.QNetworkDiskCache, url: QUrl): bool =
  fQNetworkDiskCache_virtualbase_remove(self.h, url.h)

type QNetworkDiskCacheremoveProc* = proc(url: QUrl): bool
...
proc miqt_exec_callback_QNetworkDiskCache_remove(self: ptr cQNetworkDiskCache, slot: int, url: pointer): bool {.exportc: "miqt_exec_callback_QNetworkDiskCache_remove ".} =
  ...
  virtualReturn
proc QNetworkDiskCacheprepare*(self: gen_qnetworkdiskcache_types.QNetworkDiskCache, metaData: QNetworkCacheMetaData): QIODevice =
  QIODevice(h: fQNetworkDiskCache_virtualbase_prepare(self.h, metaData.h))

type QNetworkDiskCacheprepareProc* = proc(metaData: QNetworkCacheMetaData): QIODevice
...
proc miqt_exec_callback_QNetworkDiskCache_prepare(self: ptr cQNetworkDiskCache, slot: int, metaData: pointer): pointer {.exportc: "miqt_exec_callback_QNetworkDiskCache_prepare ".} =
  ...
  virtualReturn.h
proc QNetworkDiskCacheinsert*(self: gen_qnetworkdiskcache_types.QNetworkDiskCache, device: QIODevice): void =
  fQNetworkDiskCache_virtualbase_insert(self.h, device.h)

type QNetworkDiskCacheinsertProc* = proc(device: QIODevice): void
...
proc miqt_exec_callback_QNetworkDiskCache_expire(self: ptr cQNetworkDiskCache, slot: int): clonglong {.exportc: "miqt_exec_callback_QNetworkDiskCache_expire ".} =
  ...
  virtualReturn
proc QNetworkDiskCacheevent*(self: gen_qnetworkdiskcache_types.QNetworkDiskCache, event: QEvent): bool =
  fQNetworkDiskCache_virtualbase_event(self.h, event.h)

type QNetworkDiskCacheeventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QNetworkDiskCache_event(self: ptr cQNetworkDiskCache, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QNetworkDiskCache_event ".} =
  ...
  virtualReturn
proc QNetworkDiskCacheeventFilter*(self: gen_qnetworkdiskcache_types.QNetworkDiskCache, watched: QObject, event: QEvent): bool =
  fQNetworkDiskCache_virtualbase_eventFilter(self.h, watched.h, event.h)

type QNetworkDiskCacheeventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QNetworkDiskCache_eventFilter(self: ptr cQNetworkDiskCache, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QNetworkDiskCache_eventFilter ".} =
  ...
  virtualReturn
proc QNetworkDiskCachetimerEvent*(self: gen_qnetworkdiskcache_types.QNetworkDiskCache, event: QTimerEvent): void =
  fQNetworkDiskCache_virtualbase_timerEvent(self.h, event.h)

type QNetworkDiskCachetimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QNetworkDiskCache_timerEvent(self: ptr cQNetworkDiskCache, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QNetworkDiskCache_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QNetworkDiskCachechildEvent*(self: gen_qnetworkdiskcache_types.QNetworkDiskCache, event: QChildEvent): void =
  fQNetworkDiskCache_virtualbase_childEvent(self.h, event.h)

type QNetworkDiskCachechildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QNetworkDiskCache_childEvent(self: ptr cQNetworkDiskCache, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QNetworkDiskCache_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QNetworkDiskCachecustomEvent*(self: gen_qnetworkdiskcache_types.QNetworkDiskCache, event: QEvent): void =
  fQNetworkDiskCache_virtualbase_customEvent(self.h, event.h)

type QNetworkDiskCachecustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QNetworkDiskCache_customEvent(self: ptr cQNetworkDiskCache, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QNetworkDiskCache_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QNetworkDiskCacheconnectNotify*(self: gen_qnetworkdiskcache_types.QNetworkDiskCache, signal: QMetaMethod): void =
  fQNetworkDiskCache_virtualbase_connectNotify(self.h, signal.h)

type QNetworkDiskCacheconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QNetworkDiskCache_connectNotify(self: ptr cQNetworkDiskCache, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QNetworkDiskCache_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QNetworkDiskCachedisconnectNotify*(self: gen_qnetworkdiskcache_types.QNetworkDiskCache, signal: QMetaMethod): void =
  fQNetworkDiskCache_virtualbase_disconnectNotify(self.h, signal.h)

type QNetworkDiskCachedisconnectNotifyProc* = proc(signal: QMetaMethod): void
