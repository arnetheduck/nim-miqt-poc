...
proc create*(T: type gen_qabstractnetworkcache_types.QNetworkCacheMetaData, other: QNetworkCacheMetaData): gen_qabstractnetworkcache_types.QNetworkCacheMetaData =
  gen_qabstractnetworkcache_types.QNetworkCacheMetaData.init(fcQNetworkCacheMetaData_new2(other.h))

proc operatorAssign*(self: gen_qabstractnetworkcache_types.QNetworkCacheMetaData, other: QNetworkCacheMetaData): void =
  fcQNetworkCacheMetaData_operatorAssign(self.h, other.h)

proc swap*(self: gen_qabstractnetworkcache_types.QNetworkCacheMetaData, other: QNetworkCacheMetaData): void =
  fcQNetworkCacheMetaData_swap(self.h, other.h)

proc operatorEqual*(self: gen_qabstractnetworkcache_types.QNetworkCacheMetaData, other: QNetworkCacheMetaData): bool =
  fcQNetworkCacheMetaData_operatorEqual(self.h, other.h)

proc operatorNotEqual*(self: gen_qabstractnetworkcache_types.QNetworkCacheMetaData, other: QNetworkCacheMetaData): bool =
...
proc url*(self: gen_qabstractnetworkcache_types.QNetworkCacheMetaData, ): QUrl =
  QUrl(h: fcQNetworkCacheMetaData_url(self.h))

proc setUrl*(self: gen_qabstractnetworkcache_types.QNetworkCacheMetaData, url: QUrl): void =
...
proc lastModified*(self: gen_qabstractnetworkcache_types.QNetworkCacheMetaData, ): QDateTime =
  QDateTime(h: fcQNetworkCacheMetaData_lastModified(self.h))

proc setLastModified*(self: gen_qabstractnetworkcache_types.QNetworkCacheMetaData, dateTime: QDateTime): void =
  fcQNetworkCacheMetaData_setLastModified(self.h, dateTime.h)

proc expirationDate*(self: gen_qabstractnetworkcache_types.QNetworkCacheMetaData, ): QDateTime =
  QDateTime(h: fcQNetworkCacheMetaData_expirationDate(self.h))

proc setExpirationDate*(self: gen_qabstractnetworkcache_types.QNetworkCacheMetaData, dateTime: QDateTime): void =
...
proc attributes*(self: gen_qabstractnetworkcache_types.QNetworkCacheMetaData, ): Table[cint,QVariant] =
...
proc setAttributes*(self: gen_qabstractnetworkcache_types.QNetworkCacheMetaData, attributes: Table[cint,QVariant]): void =
...
func init*(T: type gen_qabstractnetworkcache_types.QAbstractNetworkCache, h: ptr cQAbstractNetworkCache): gen_qabstractnetworkcache_types.QAbstractNetworkCache =
  T(h: h)
proc metaObject*(self: gen_qabstractnetworkcache_types.QAbstractNetworkCache, ): QMetaObject =
  QMetaObject(h: fcQAbstractNetworkCache_metaObject(self.h))
...
proc metaData*(self: gen_qabstractnetworkcache_types.QAbstractNetworkCache, url: QUrl): QNetworkCacheMetaData =
  QNetworkCacheMetaData(h: fcQAbstractNetworkCache_metaData(self.h, url.h))

proc updateMetaData*(self: gen_qabstractnetworkcache_types.QAbstractNetworkCache, metaData: QNetworkCacheMetaData): void =
  fcQAbstractNetworkCache_updateMetaData(self.h, metaData.h)

proc data*(self: gen_qabstractnetworkcache_types.QAbstractNetworkCache, url: QUrl): QIODevice =
  QIODevice(h: fcQAbstractNetworkCache_data(self.h, url.h))

proc remove*(self: gen_qabstractnetworkcache_types.QAbstractNetworkCache, url: QUrl): bool =
...
proc prepare*(self: gen_qabstractnetworkcache_types.QAbstractNetworkCache, metaData: QNetworkCacheMetaData): QIODevice =
  QIODevice(h: fcQAbstractNetworkCache_prepare(self.h, metaData.h))

proc insert*(self: gen_qabstractnetworkcache_types.QAbstractNetworkCache, device: QIODevice): void =
