...
proc create*(T: type gen_qnetworkrequest_types.QNetworkRequest, url: QUrl): gen_qnetworkrequest_types.QNetworkRequest =
  gen_qnetworkrequest_types.QNetworkRequest.init(fcQNetworkRequest_new2(url.h))

proc create*(T: type gen_qnetworkrequest_types.QNetworkRequest, other: QNetworkRequest): gen_qnetworkrequest_types.QNetworkRequest =
  gen_qnetworkrequest_types.QNetworkRequest.init(fcQNetworkRequest_new3(other.h))

proc operatorAssign*(self: gen_qnetworkrequest_types.QNetworkRequest, other: QNetworkRequest): void =
  fcQNetworkRequest_operatorAssign(self.h, other.h)

proc swap*(self: gen_qnetworkrequest_types.QNetworkRequest, other: QNetworkRequest): void =
  fcQNetworkRequest_swap(self.h, other.h)

proc operatorEqual*(self: gen_qnetworkrequest_types.QNetworkRequest, other: QNetworkRequest): bool =
  fcQNetworkRequest_operatorEqual(self.h, other.h)

proc operatorNotEqual*(self: gen_qnetworkrequest_types.QNetworkRequest, other: QNetworkRequest): bool =
  fcQNetworkRequest_operatorNotEqual(self.h, other.h)

proc url*(self: gen_qnetworkrequest_types.QNetworkRequest, ): QUrl =
  QUrl(h: fcQNetworkRequest_url(self.h))

proc setUrl*(self: gen_qnetworkrequest_types.QNetworkRequest, url: QUrl): void =
  fcQNetworkRequest_setUrl(self.h, url.h)

proc header*(self: gen_qnetworkrequest_types.QNetworkRequest, header: cint): QVariant =
  QVariant(h: fcQNetworkRequest_header(self.h, cint(header)))

proc setHeader*(self: gen_qnetworkrequest_types.QNetworkRequest, header: cint, value: QVariant): void =
...
proc attribute*(self: gen_qnetworkrequest_types.QNetworkRequest, code: cint): QVariant =
  QVariant(h: fcQNetworkRequest_attribute(self.h, cint(code)))

proc setAttribute*(self: gen_qnetworkrequest_types.QNetworkRequest, code: cint, value: QVariant): void =
  fcQNetworkRequest_setAttribute(self.h, cint(code), value.h)

proc sslConfiguration*(self: gen_qnetworkrequest_types.QNetworkRequest, ): QSslConfiguration =
  QSslConfiguration(h: fcQNetworkRequest_sslConfiguration(self.h))

proc setSslConfiguration*(self: gen_qnetworkrequest_types.QNetworkRequest, configuration: QSslConfiguration): void =
  fcQNetworkRequest_setSslConfiguration(self.h, configuration.h)

proc setOriginatingObject*(self: gen_qnetworkrequest_types.QNetworkRequest, objectVal: QObject): void =
  fcQNetworkRequest_setOriginatingObject(self.h, objectVal.h)

proc originatingObject*(self: gen_qnetworkrequest_types.QNetworkRequest, ): QObject =
  QObject(h: fcQNetworkRequest_originatingObject(self.h))
...
proc http2Configuration*(self: gen_qnetworkrequest_types.QNetworkRequest, ): QHttp2Configuration =
  QHttp2Configuration(h: fcQNetworkRequest_http2Configuration(self.h))

proc setHttp2Configuration*(self: gen_qnetworkrequest_types.QNetworkRequest, configuration: QHttp2Configuration): void =
...
proc attribute*(self: gen_qnetworkrequest_types.QNetworkRequest, code: cint, defaultValue: QVariant): QVariant =
  QVariant(h: fcQNetworkRequest_attribute2(self.h, cint(code), defaultValue.h))
