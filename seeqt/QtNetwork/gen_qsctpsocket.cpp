...
QMetaObject* QSctpSocket_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQSctpSocket*)(self) )->QSctpSocket::metaObject();

}

void* QSctpSocket_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQSctpSocket*)(self) )->QSctpSocket::qt_metacast(param1);

}

int QSctpSocket_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQSctpSocket*)(self) )->QSctpSocket::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
void QSctpSocket_protectedbase_setSocketState(void* self, int state) {
	MiqtVirtualQSctpSocket* self_cast = static_cast<MiqtVirtualQSctpSocket*>( (QSctpSocket*)(self) );
