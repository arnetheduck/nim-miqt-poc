...
proc create*(T: type gen_qnetworkproxy_types.QNetworkProxyQuery, requestUrl: QUrl): gen_qnetworkproxy_types.QNetworkProxyQuery =
...
proc create*(T: type gen_qnetworkproxy_types.QNetworkProxyQuery, networkConfiguration: QNetworkConfiguration, requestUrl: QUrl): gen_qnetworkproxy_types.QNetworkProxyQuery =
  gen_qnetworkproxy_types.QNetworkProxyQuery.init(fcQNetworkProxyQuery_new5(networkConfiguration.h, requestUrl.h))

proc create*(T: type gen_qnetworkproxy_types.QNetworkProxyQuery, networkConfiguration: QNetworkConfiguration, hostname: string, port: cint): gen_qnetworkproxy_types.QNetworkProxyQuery =
...
proc create*(T: type gen_qnetworkproxy_types.QNetworkProxyQuery, networkConfiguration: QNetworkConfiguration, bindPort: cushort): gen_qnetworkproxy_types.QNetworkProxyQuery =
  gen_qnetworkproxy_types.QNetworkProxyQuery.init(fcQNetworkProxyQuery_new7(networkConfiguration.h, bindPort))

proc create*(T: type gen_qnetworkproxy_types.QNetworkProxyQuery, other: QNetworkProxyQuery): gen_qnetworkproxy_types.QNetworkProxyQuery =
  gen_qnetworkproxy_types.QNetworkProxyQuery.init(fcQNetworkProxyQuery_new8(other.h))

proc create*(T: type gen_qnetworkproxy_types.QNetworkProxyQuery, requestUrl: QUrl, queryType: cint): gen_qnetworkproxy_types.QNetworkProxyQuery =
...
proc create*(T: type gen_qnetworkproxy_types.QNetworkProxyQuery, networkConfiguration: QNetworkConfiguration, requestUrl: QUrl, queryType: cint): gen_qnetworkproxy_types.QNetworkProxyQuery =
...
proc create*(T: type gen_qnetworkproxy_types.QNetworkProxyQuery, networkConfiguration: QNetworkConfiguration, hostname: string, port: cint, protocolTag: string): gen_qnetworkproxy_types.QNetworkProxyQuery =
...
proc create*(T: type gen_qnetworkproxy_types.QNetworkProxyQuery, networkConfiguration: QNetworkConfiguration, hostname: string, port: cint, protocolTag: string, queryType: cint): gen_qnetworkproxy_types.QNetworkProxyQuery =
...
proc create*(T: type gen_qnetworkproxy_types.QNetworkProxyQuery, networkConfiguration: QNetworkConfiguration, bindPort: cushort, protocolTag: string): gen_qnetworkproxy_types.QNetworkProxyQuery =
...
proc create*(T: type gen_qnetworkproxy_types.QNetworkProxyQuery, networkConfiguration: QNetworkConfiguration, bindPort: cushort, protocolTag: string, queryType: cint): gen_qnetworkproxy_types.QNetworkProxyQuery =
...
proc operatorAssign*(self: gen_qnetworkproxy_types.QNetworkProxyQuery, other: QNetworkProxyQuery): void =
  fcQNetworkProxyQuery_operatorAssign(self.h, other.h)

proc swap*(self: gen_qnetworkproxy_types.QNetworkProxyQuery, other: QNetworkProxyQuery): void =
  fcQNetworkProxyQuery_swap(self.h, other.h)

proc operatorEqual*(self: gen_qnetworkproxy_types.QNetworkProxyQuery, other: QNetworkProxyQuery): bool =
  fcQNetworkProxyQuery_operatorEqual(self.h, other.h)

proc operatorNotEqual*(self: gen_qnetworkproxy_types.QNetworkProxyQuery, other: QNetworkProxyQuery): bool =
...
proc url*(self: gen_qnetworkproxy_types.QNetworkProxyQuery, ): QUrl =
  QUrl(h: fcQNetworkProxyQuery_url(self.h))

proc setUrl*(self: gen_qnetworkproxy_types.QNetworkProxyQuery, url: QUrl): void =
  fcQNetworkProxyQuery_setUrl(self.h, url.h)

proc networkConfiguration*(self: gen_qnetworkproxy_types.QNetworkProxyQuery, ): QNetworkConfiguration =
  QNetworkConfiguration(h: fcQNetworkProxyQuery_networkConfiguration(self.h))

proc setNetworkConfiguration*(self: gen_qnetworkproxy_types.QNetworkProxyQuery, networkConfiguration: QNetworkConfiguration): void =
...
proc create*(T: type gen_qnetworkproxy_types.QNetworkProxy, other: QNetworkProxy): gen_qnetworkproxy_types.QNetworkProxy =
...
proc operatorAssign*(self: gen_qnetworkproxy_types.QNetworkProxy, other: QNetworkProxy): void =
  fcQNetworkProxy_operatorAssign(self.h, other.h)

proc swap*(self: gen_qnetworkproxy_types.QNetworkProxy, other: QNetworkProxy): void =
  fcQNetworkProxy_swap(self.h, other.h)

proc operatorEqual*(self: gen_qnetworkproxy_types.QNetworkProxy, other: QNetworkProxy): bool =
  fcQNetworkProxy_operatorEqual(self.h, other.h)

proc operatorNotEqual*(self: gen_qnetworkproxy_types.QNetworkProxy, other: QNetworkProxy): bool =
...
proc setApplicationProxy*(_: type gen_qnetworkproxy_types.QNetworkProxy, proxy: QNetworkProxy): void =
  fcQNetworkProxy_setApplicationProxy(proxy.h)

proc applicationProxy*(_: type gen_qnetworkproxy_types.QNetworkProxy, ): QNetworkProxy =
  QNetworkProxy(h: fcQNetworkProxy_applicationProxy())

proc header*(self: gen_qnetworkproxy_types.QNetworkProxy, header: cint): QVariant =
  QVariant(h: fcQNetworkProxy_header(self.h, cint(header)))

proc setHeader*(self: gen_qnetworkproxy_types.QNetworkProxy, header: cint, value: QVariant): void =
...
proc queryProxy*(self: gen_qnetworkproxy_types.QNetworkProxyFactory, query: QNetworkProxyQuery): seq[QNetworkProxy] =
...
proc setApplicationProxyFactory*(_: type gen_qnetworkproxy_types.QNetworkProxyFactory, factory: QNetworkProxyFactory): void =
  fcQNetworkProxyFactory_setApplicationProxyFactory(factory.h)

proc proxyForQuery*(_: type gen_qnetworkproxy_types.QNetworkProxyFactory, query: QNetworkProxyQuery): seq[QNetworkProxy] =
...
proc systemProxyForQuery*(_: type gen_qnetworkproxy_types.QNetworkProxyFactory, ): seq[QNetworkProxy] =
...
proc operatorAssign*(self: gen_qnetworkproxy_types.QNetworkProxyFactory, param1: QNetworkProxyFactory): void =
  fcQNetworkProxyFactory_operatorAssign(self.h, param1.h)

proc systemProxyForQuery*(_: type gen_qnetworkproxy_types.QNetworkProxyFactory, query: QNetworkProxyQuery): seq[QNetworkProxy] =
...
type QNetworkProxyFactoryqueryProxyProc* = proc(query: QNetworkProxyQuery): seq[QNetworkProxy]
