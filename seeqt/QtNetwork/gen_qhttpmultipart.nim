...
proc create*(T: type gen_qhttpmultipart_types.QHttpPart, other: QHttpPart): gen_qhttpmultipart_types.QHttpPart =
  gen_qhttpmultipart_types.QHttpPart.init(fcQHttpPart_new2(other.h))

proc operatorAssign*(self: gen_qhttpmultipart_types.QHttpPart, other: QHttpPart): void =
  fcQHttpPart_operatorAssign(self.h, other.h)

proc swap*(self: gen_qhttpmultipart_types.QHttpPart, other: QHttpPart): void =
  fcQHttpPart_swap(self.h, other.h)

proc operatorEqual*(self: gen_qhttpmultipart_types.QHttpPart, other: QHttpPart): bool =
  fcQHttpPart_operatorEqual(self.h, other.h)

proc operatorNotEqual*(self: gen_qhttpmultipart_types.QHttpPart, other: QHttpPart): bool =
  fcQHttpPart_operatorNotEqual(self.h, other.h)

proc setHeader*(self: gen_qhttpmultipart_types.QHttpPart, header: cint, value: QVariant): void =
...
proc setBodyDevice*(self: gen_qhttpmultipart_types.QHttpPart, device: QIODevice): void =
...
proc create*(T: type gen_qhttpmultipart_types.QHttpMultiPart, parent: QObject): gen_qhttpmultipart_types.QHttpMultiPart =
  gen_qhttpmultipart_types.QHttpMultiPart.init(fcQHttpMultiPart_new3(parent.h))

proc create*(T: type gen_qhttpmultipart_types.QHttpMultiPart, contentType: cint, parent: QObject): gen_qhttpmultipart_types.QHttpMultiPart =
  gen_qhttpmultipart_types.QHttpMultiPart.init(fcQHttpMultiPart_new4(cint(contentType), parent.h))

proc metaObject*(self: gen_qhttpmultipart_types.QHttpMultiPart, ): QMetaObject =
  QMetaObject(h: fcQHttpMultiPart_metaObject(self.h))
...
proc append*(self: gen_qhttpmultipart_types.QHttpMultiPart, httpPart: QHttpPart): void =
...
proc miqt_exec_callback_QHttpMultiPart_metacall(self: ptr cQHttpMultiPart, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QHttpMultiPart_metacall ".} =
  ...
  virtualReturn
proc QHttpMultiPartevent*(self: gen_qhttpmultipart_types.QHttpMultiPart, event: QEvent): bool =
  fQHttpMultiPart_virtualbase_event(self.h, event.h)

type QHttpMultiParteventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QHttpMultiPart_event(self: ptr cQHttpMultiPart, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QHttpMultiPart_event ".} =
  ...
  virtualReturn
proc QHttpMultiParteventFilter*(self: gen_qhttpmultipart_types.QHttpMultiPart, watched: QObject, event: QEvent): bool =
  fQHttpMultiPart_virtualbase_eventFilter(self.h, watched.h, event.h)

type QHttpMultiParteventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QHttpMultiPart_eventFilter(self: ptr cQHttpMultiPart, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QHttpMultiPart_eventFilter ".} =
  ...
  virtualReturn
proc QHttpMultiParttimerEvent*(self: gen_qhttpmultipart_types.QHttpMultiPart, event: QTimerEvent): void =
  fQHttpMultiPart_virtualbase_timerEvent(self.h, event.h)

type QHttpMultiParttimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QHttpMultiPart_timerEvent(self: ptr cQHttpMultiPart, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QHttpMultiPart_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QHttpMultiPartchildEvent*(self: gen_qhttpmultipart_types.QHttpMultiPart, event: QChildEvent): void =
  fQHttpMultiPart_virtualbase_childEvent(self.h, event.h)

type QHttpMultiPartchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QHttpMultiPart_childEvent(self: ptr cQHttpMultiPart, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QHttpMultiPart_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QHttpMultiPartcustomEvent*(self: gen_qhttpmultipart_types.QHttpMultiPart, event: QEvent): void =
  fQHttpMultiPart_virtualbase_customEvent(self.h, event.h)

type QHttpMultiPartcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QHttpMultiPart_customEvent(self: ptr cQHttpMultiPart, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QHttpMultiPart_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QHttpMultiPartconnectNotify*(self: gen_qhttpmultipart_types.QHttpMultiPart, signal: QMetaMethod): void =
  fQHttpMultiPart_virtualbase_connectNotify(self.h, signal.h)

type QHttpMultiPartconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QHttpMultiPart_connectNotify(self: ptr cQHttpMultiPart, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QHttpMultiPart_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QHttpMultiPartdisconnectNotify*(self: gen_qhttpmultipart_types.QHttpMultiPart, signal: QMetaMethod): void =
  fQHttpMultiPart_virtualbase_disconnectNotify(self.h, signal.h)

type QHttpMultiPartdisconnectNotifyProc* = proc(signal: QMetaMethod): void
