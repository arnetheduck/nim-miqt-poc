...
func init*(T: type gen_qabstractsocket_types.QAbstractSocket, h: ptr cQAbstractSocket): gen_qabstractsocket_types.QAbstractSocket =
  T(h: h)
proc create*(T: type gen_qabstractsocket_types.QAbstractSocket, socketType: cint, parent: QObject): gen_qabstractsocket_types.QAbstractSocket =
  gen_qabstractsocket_types.QAbstractSocket.init(fcQAbstractSocket_new(cint(socketType), parent.h))

proc metaObject*(self: gen_qabstractsocket_types.QAbstractSocket, ): QMetaObject =
  QMetaObject(h: fcQAbstractSocket_metaObject(self.h))
...
proc bindX*(self: gen_qabstractsocket_types.QAbstractSocket, address: QHostAddress, port: cushort, mode: cint): bool =
...
proc connectToHost*(self: gen_qabstractsocket_types.QAbstractSocket, address: QHostAddress, port: cushort): void =
...
proc localAddress*(self: gen_qabstractsocket_types.QAbstractSocket, ): QHostAddress =
  QHostAddress(h: fcQAbstractSocket_localAddress(self.h))

proc peerPort*(self: gen_qabstractsocket_types.QAbstractSocket, ): cushort =
  fcQAbstractSocket_peerPort(self.h)

proc peerAddress*(self: gen_qabstractsocket_types.QAbstractSocket, ): QHostAddress =
  QHostAddress(h: fcQAbstractSocket_peerAddress(self.h))
...
proc setSocketOption*(self: gen_qabstractsocket_types.QAbstractSocket, option: cint, value: QVariant): void =
  fcQAbstractSocket_setSocketOption(self.h, cint(option), value.h)

proc socketOption*(self: gen_qabstractsocket_types.QAbstractSocket, option: cint): QVariant =
  QVariant(h: fcQAbstractSocket_socketOption(self.h, cint(option)))
...
proc setProxy*(self: gen_qabstractsocket_types.QAbstractSocket, networkProxy: QNetworkProxy): void =
  fcQAbstractSocket_setProxy(self.h, networkProxy.h)

proc proxy*(self: gen_qabstractsocket_types.QAbstractSocket, ): QNetworkProxy =
  QNetworkProxy(h: fcQAbstractSocket_proxy(self.h))
...
proc proxyAuthenticationRequired*(self: gen_qabstractsocket_types.QAbstractSocket, proxy: QNetworkProxy, authenticator: QAuthenticator): void =
  fcQAbstractSocket_proxyAuthenticationRequired(self.h, proxy.h, authenticator.h)

type QAbstractSocketproxyAuthenticationRequiredSlot* = proc(proxy: QNetworkProxy, authenticator: QAuthenticator)
...
proc connectToHost*(self: gen_qabstractsocket_types.QAbstractSocket, address: QHostAddress, port: cushort, mode: cint): void =
...
proc miqt_exec_callback_QAbstractSocket_resume(self: ptr cQAbstractSocket, slot: int): void {.exportc: "miqt_exec_callback_QAbstractSocket_resume ".} =
  ...
  nimfunc[]()
proc QAbstractSocketbindX*(self: gen_qabstractsocket_types.QAbstractSocket, address: QHostAddress, port: cushort, mode: cint): bool =
  fQAbstractSocket_virtualbase_bind(self.h, address.h, port, cint(mode))

type QAbstractSocketbindXProc* = proc(address: QHostAddress, port: cushort, mode: cint): bool
...
proc miqt_exec_callback_QAbstractSocket_setSocketDescriptor(self: ptr cQAbstractSocket, slot: int, socketDescriptor: uint, state: cint, openMode: cint): bool {.exportc: "miqt_exec_callback_QAbstractSocket_setSocketDescriptor ".} =
  ...
  virtualReturn
proc QAbstractSocketsetSocketOption*(self: gen_qabstractsocket_types.QAbstractSocket, option: cint, value: QVariant): void =
  fQAbstractSocket_virtualbase_setSocketOption(self.h, cint(option), value.h)

type QAbstractSocketsetSocketOptionProc* = proc(option: cint, value: QVariant): void
...
proc miqt_exec_callback_QAbstractSocket_setSocketOption(self: ptr cQAbstractSocket, slot: int, option: cint, value: pointer): void {.exportc: "miqt_exec_callback_QAbstractSocket_setSocketOption ".} =
  ...
  nimfunc[](slotval1, slotval2)
proc QAbstractSocketsocketOption*(self: gen_qabstractsocket_types.QAbstractSocket, option: cint): QVariant =
  QVariant(h: fQAbstractSocket_virtualbase_socketOption(self.h, cint(option)))

type QAbstractSocketsocketOptionProc* = proc(option: cint): QVariant
...
proc miqt_exec_callback_QAbstractSocket_canReadLine(self: ptr cQAbstractSocket, slot: int): bool {.exportc: "miqt_exec_callback_QAbstractSocket_canReadLine ".} =
  ...
  virtualReturn
proc QAbstractSocketevent*(self: gen_qabstractsocket_types.QAbstractSocket, event: QEvent): bool =
  fQAbstractSocket_virtualbase_event(self.h, event.h)

type QAbstractSocketeventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QAbstractSocket_event(self: ptr cQAbstractSocket, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QAbstractSocket_event ".} =
  ...
  virtualReturn
proc QAbstractSocketeventFilter*(self: gen_qabstractsocket_types.QAbstractSocket, watched: QObject, event: QEvent): bool =
  fQAbstractSocket_virtualbase_eventFilter(self.h, watched.h, event.h)

type QAbstractSocketeventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QAbstractSocket_eventFilter(self: ptr cQAbstractSocket, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QAbstractSocket_eventFilter ".} =
  ...
  virtualReturn
proc QAbstractSockettimerEvent*(self: gen_qabstractsocket_types.QAbstractSocket, event: QTimerEvent): void =
  fQAbstractSocket_virtualbase_timerEvent(self.h, event.h)

type QAbstractSockettimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QAbstractSocket_timerEvent(self: ptr cQAbstractSocket, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QAbstractSocket_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QAbstractSocketchildEvent*(self: gen_qabstractsocket_types.QAbstractSocket, event: QChildEvent): void =
  fQAbstractSocket_virtualbase_childEvent(self.h, event.h)

type QAbstractSocketchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QAbstractSocket_childEvent(self: ptr cQAbstractSocket, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QAbstractSocket_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QAbstractSocketcustomEvent*(self: gen_qabstractsocket_types.QAbstractSocket, event: QEvent): void =
  fQAbstractSocket_virtualbase_customEvent(self.h, event.h)

type QAbstractSocketcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QAbstractSocket_customEvent(self: ptr cQAbstractSocket, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QAbstractSocket_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QAbstractSocketconnectNotify*(self: gen_qabstractsocket_types.QAbstractSocket, signal: QMetaMethod): void =
  fQAbstractSocket_virtualbase_connectNotify(self.h, signal.h)

type QAbstractSocketconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QAbstractSocket_connectNotify(self: ptr cQAbstractSocket, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QAbstractSocket_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QAbstractSocketdisconnectNotify*(self: gen_qabstractsocket_types.QAbstractSocket, signal: QMetaMethod): void =
  fQAbstractSocket_virtualbase_disconnectNotify(self.h, signal.h)

type QAbstractSocketdisconnectNotifyProc* = proc(signal: QMetaMethod): void
