...
proc bindX*(self: gen_qabstractsocket_types.QAbstractSocket, address: QHostAddress): bool =
...
proc bindX*(self: gen_qabstractsocket_types.QAbstractSocket, address: QHostAddress, port: cushort): bool =
...
proc QAbstractSocketconnectToHost*(self: gen_qabstractsocket_types.QAbstractSocket, address: QHostAddress, port: cushort, mode: cint): void =
  fQAbstractSocket_virtualbase_connectToHost2(self.h, address.h, port, cint(mode))

type QAbstractSocketconnectToHost2Proc* = proc(address: QHostAddress, port: cushort, mode: cint): void
