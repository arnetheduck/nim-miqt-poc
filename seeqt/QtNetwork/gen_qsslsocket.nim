...
proc miqt_exec_callback_cQSslSocket_sslErrorsWithErrors(slot: int, errors: struct_miqt_array) {.cdecl.} =
...
proc miqt_exec_callback_cQSslSocket_sslErrorsWithErrors_release(slot: int) {.cdecl.} =
...
proc onsslErrors*(self: gen_qsslsocket_types.QSslSocket, slot: QSslSocketsslErrorsWithErrorsSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQSslSocket_connect_sslErrorsWithErrors(self.h, cast[int](addr tmp[]), miqt_exec_callback_cQSslSocket_sslErrorsWithErrors, miqt_exec_callback_cQSslSocket_sslErrorsWithErrors_release)
