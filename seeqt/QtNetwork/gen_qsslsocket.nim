...
proc create*(T: type gen_qsslsocket_types.QSslSocket, parent: QObject): gen_qsslsocket_types.QSslSocket =
  gen_qsslsocket_types.QSslSocket.init(fcQSslSocket_new2(parent.h))

proc metaObject*(self: gen_qsslsocket_types.QSslSocket, ): QMetaObject =
  QMetaObject(h: fcQSslSocket_metaObject(self.h))
...
proc setSocketOption*(self: gen_qsslsocket_types.QSslSocket, option: cint, value: QVariant): void =
  fcQSslSocket_setSocketOption(self.h, cint(option), value.h)

proc socketOption*(self: gen_qsslsocket_types.QSslSocket, option: cint): QVariant =
  QVariant(h: fcQSslSocket_socketOption(self.h, cint(option)))
...
proc sslConfiguration*(self: gen_qsslsocket_types.QSslSocket, ): QSslConfiguration =
  QSslConfiguration(h: fcQSslSocket_sslConfiguration(self.h))

proc setSslConfiguration*(self: gen_qsslsocket_types.QSslSocket, config: QSslConfiguration): void =
  fcQSslSocket_setSslConfiguration(self.h, config.h)

proc setLocalCertificateChain*(self: gen_qsslsocket_types.QSslSocket, localChain: seq[QSslCertificate]): void =
...
proc localCertificateChain*(self: gen_qsslsocket_types.QSslSocket, ): seq[QSslCertificate] =
...
proc setLocalCertificate*(self: gen_qsslsocket_types.QSslSocket, certificate: QSslCertificate): void =
...
proc localCertificate*(self: gen_qsslsocket_types.QSslSocket, ): QSslCertificate =
  QSslCertificate(h: fcQSslSocket_localCertificate(self.h))

proc peerCertificate*(self: gen_qsslsocket_types.QSslSocket, ): QSslCertificate =
  QSslCertificate(h: fcQSslSocket_peerCertificate(self.h))

proc peerCertificateChain*(self: gen_qsslsocket_types.QSslSocket, ): seq[QSslCertificate] =
...
proc sessionCipher*(self: gen_qsslsocket_types.QSslSocket, ): QSslCipher =
  QSslCipher(h: fcQSslSocket_sessionCipher(self.h))

proc sessionProtocol*(self: gen_qsslsocket_types.QSslSocket, ): cint =
  cint(fcQSslSocket_sessionProtocol(self.h))

proc ocspResponses*(self: gen_qsslsocket_types.QSslSocket, ): seq[QOcspResponse] =
  var v_ma = fcQSslSocket_ocspResponses(self.h)
  var vx_ret = newSeq[QOcspResponse](int(v_ma.len))
  let v_outCast = cast[ptr UncheckedArray[pointer]](v_ma.data)
  for i in 0 ..< v_ma.len:
    vx_ret[i] = QOcspResponse(h: v_outCast[i])
  vx_ret

proc setPrivateKey*(self: gen_qsslsocket_types.QSslSocket, key: QSslKey): void =
...
proc privateKey*(self: gen_qsslsocket_types.QSslSocket, ): QSslKey =
  QSslKey(h: fcQSslSocket_privateKey(self.h))

proc ciphers*(self: gen_qsslsocket_types.QSslSocket, ): seq[QSslCipher] =
  var v_ma = fcQSslSocket_ciphers(self.h)
  var vx_ret = newSeq[QSslCipher](int(v_ma.len))
  let v_outCast = cast[ptr UncheckedArray[pointer]](v_ma.data)
  for i in 0 ..< v_ma.len:
    vx_ret[i] = QSslCipher(h: v_outCast[i])
  vx_ret

proc setCiphers*(self: gen_qsslsocket_types.QSslSocket, ciphers: seq[QSslCipher]): void =
...
proc setDefaultCiphers*(_: type gen_qsslsocket_types.QSslSocket, ciphers: seq[QSslCipher]): void =
  var ciphers_CArray = newSeq[pointer](len(ciphers))
  for i in 0..<len(ciphers):
    ciphers_CArray[i] = ciphers[i].h
...
proc defaultCiphers*(_: type gen_qsslsocket_types.QSslSocket, ): seq[QSslCipher] =
...
proc supportedCiphers*(_: type gen_qsslsocket_types.QSslSocket, ): seq[QSslCipher] =
...
proc addCaCertificate*(self: gen_qsslsocket_types.QSslSocket, certificate: QSslCertificate): void =
  fcQSslSocket_addCaCertificate(self.h, certificate.h)

proc addCaCertificates*(self: gen_qsslsocket_types.QSslSocket, certificates: seq[QSslCertificate]): void =
...
proc setCaCertificates*(self: gen_qsslsocket_types.QSslSocket, certificates: seq[QSslCertificate]): void =
  var certificates_CArray = newSeq[pointer](len(certificates))
  for i in 0..<len(certificates):
    certificates_CArray[i] = certificates[i].h
...
proc caCertificates*(self: gen_qsslsocket_types.QSslSocket, ): seq[QSslCertificate] =
...
proc addDefaultCaCertificate*(_: type gen_qsslsocket_types.QSslSocket, certificate: QSslCertificate): void =
  fcQSslSocket_addDefaultCaCertificate(certificate.h)

proc addDefaultCaCertificates*(_: type gen_qsslsocket_types.QSslSocket, certificates: seq[QSslCertificate]): void =
  var certificates_CArray = newSeq[pointer](len(certificates))
  for i in 0..<len(certificates):
    certificates_CArray[i] = certificates[i].h
...
proc setDefaultCaCertificates*(_: type gen_qsslsocket_types.QSslSocket, certificates: seq[QSslCertificate]): void =
  var certificates_CArray = newSeq[pointer](len(certificates))
  for i in 0..<len(certificates):
    certificates_CArray[i] = certificates[i].h
...
proc defaultCaCertificates*(_: type gen_qsslsocket_types.QSslSocket, ): seq[QSslCertificate] =
...
proc systemCaCertificates*(_: type gen_qsslsocket_types.QSslSocket, ): seq[QSslCertificate] =
...
proc sslErrors*(self: gen_qsslsocket_types.QSslSocket, ): seq[QSslError] =
  var v_ma = fcQSslSocket_sslErrors(self.h)
  var vx_ret = newSeq[QSslError](int(v_ma.len))
  let v_outCast = cast[ptr UncheckedArray[pointer]](v_ma.data)
  for i in 0 ..< v_ma.len:
    vx_ret[i] = QSslError(h: v_outCast[i])
  vx_ret

proc sslHandshakeErrors*(self: gen_qsslsocket_types.QSslSocket, ): seq[QSslError] =
...
proc ignoreSslErrors*(self: gen_qsslsocket_types.QSslSocket, errors: seq[QSslError]): void =
...
proc peerVerifyError*(self: gen_qsslsocket_types.QSslSocket, error: QSslError): void =
  fcQSslSocket_peerVerifyError(self.h, error.h)

type QSslSocketpeerVerifyErrorSlot* = proc(error: QSslError)
proc miqt_exec_callback_QSslSocket_peerVerifyError(slot: int, error: pointer) {.exportc.} =
  ...
  let slotval1 = QSslError(h: error)
...
proc sslErrors*(self: gen_qsslsocket_types.QSslSocket, errors: seq[QSslError]): void =
  var errors_CArray = newSeq[pointer](len(errors))
  for i in 0..<len(errors):
    errors_CArray[i] = errors[i].h
...
type QSslSocketsslErrorsWithErrorsSlot* = proc(errors: seq[QSslError])
...
proc preSharedKeyAuthenticationRequired*(self: gen_qsslsocket_types.QSslSocket, authenticator: QSslPreSharedKeyAuthenticator): void =
  fcQSslSocket_preSharedKeyAuthenticationRequired(self.h, authenticator.h)

type QSslSocketpreSharedKeyAuthenticationRequiredSlot* = proc(authenticator: QSslPreSharedKeyAuthenticator)
proc miqt_exec_callback_QSslSocket_preSharedKeyAuthenticationRequired(slot: int, authenticator: pointer) {.exportc.} =
  ...
  let slotval1 = QSslPreSharedKeyAuthenticator(h: authenticator)
...
proc miqt_exec_callback_QSslSocket_disconnectFromHost(self: ptr cQSslSocket, slot: int): void {.exportc: "miqt_exec_callback_QSslSocket_disconnectFromHost ".} =
  ...
  nimfunc[]()
proc QSslSocketsetSocketOption*(self: gen_qsslsocket_types.QSslSocket, option: cint, value: QVariant): void =
  fQSslSocket_virtualbase_setSocketOption(self.h, cint(option), value.h)

type QSslSocketsetSocketOptionProc* = proc(option: cint, value: QVariant): void
...
proc QSslSocketsocketOption*(self: gen_qsslsocket_types.QSslSocket, option: cint): QVariant =
  QVariant(h: fQSslSocket_virtualbase_socketOption(self.h, cint(option)))

type QSslSocketsocketOptionProc* = proc(option: cint): QVariant
...
proc miqt_exec_callback_QSslSocket_reset(self: ptr cQSslSocket, slot: int): bool {.exportc: "miqt_exec_callback_QSslSocket_reset ".} =
  ...
  virtualReturn
proc QSslSocketevent*(self: gen_qsslsocket_types.QSslSocket, event: QEvent): bool =
  fQSslSocket_virtualbase_event(self.h, event.h)

type QSslSocketeventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QSslSocket_event(self: ptr cQSslSocket, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QSslSocket_event ".} =
  ...
  virtualReturn
proc QSslSocketeventFilter*(self: gen_qsslsocket_types.QSslSocket, watched: QObject, event: QEvent): bool =
  fQSslSocket_virtualbase_eventFilter(self.h, watched.h, event.h)

type QSslSocketeventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QSslSocket_eventFilter(self: ptr cQSslSocket, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QSslSocket_eventFilter ".} =
  ...
  virtualReturn
proc QSslSockettimerEvent*(self: gen_qsslsocket_types.QSslSocket, event: QTimerEvent): void =
  fQSslSocket_virtualbase_timerEvent(self.h, event.h)

type QSslSockettimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QSslSocket_timerEvent(self: ptr cQSslSocket, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QSslSocket_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QSslSocketchildEvent*(self: gen_qsslsocket_types.QSslSocket, event: QChildEvent): void =
  fQSslSocket_virtualbase_childEvent(self.h, event.h)

type QSslSocketchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QSslSocket_childEvent(self: ptr cQSslSocket, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QSslSocket_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QSslSocketcustomEvent*(self: gen_qsslsocket_types.QSslSocket, event: QEvent): void =
  fQSslSocket_virtualbase_customEvent(self.h, event.h)

type QSslSocketcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QSslSocket_customEvent(self: ptr cQSslSocket, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QSslSocket_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QSslSocketconnectNotify*(self: gen_qsslsocket_types.QSslSocket, signal: QMetaMethod): void =
  fQSslSocket_virtualbase_connectNotify(self.h, signal.h)

type QSslSocketconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QSslSocket_connectNotify(self: ptr cQSslSocket, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QSslSocket_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QSslSocketdisconnectNotify*(self: gen_qsslsocket_types.QSslSocket, signal: QMetaMethod): void =
  fQSslSocket_virtualbase_disconnectNotify(self.h, signal.h)

type QSslSocketdisconnectNotifyProc* = proc(signal: QMetaMethod): void
