...
type QSslSocketsslErrorsSlot* = proc(errors: seq[QSslError])
...
proc handshakeInterruptedOnError*(self: gen_qsslsocket_types.QSslSocket, error: QSslError): void =
  fcQSslSocket_handshakeInterruptedOnError(self.h, error.h)

type QSslSockethandshakeInterruptedOnErrorSlot* = proc(error: QSslError)
...
proc miqt_exec_callback_QSslSocket_writeData(self: ptr cQSslSocket, slot: int, data: cstring, len: clonglong): clonglong {.exportc: "miqt_exec_callback_QSslSocket_writeData ".} =
  ...
  virtualReturn
proc QSslSocketbindX*(self: gen_qsslsocket_types.QSslSocket, address: QHostAddress, port: cushort, mode: cint): bool =
  fQSslSocket_virtualbase_bind(self.h, address.h, port, cint(mode))

type QSslSocketbindXProc* = proc(address: QHostAddress, port: cushort, mode: cint): bool
