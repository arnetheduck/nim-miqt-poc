...
proc create*(T: type gen_qsslerror_types.QSslError, error: cint, certificate: QSslCertificate): gen_qsslerror_types.QSslError =
  gen_qsslerror_types.QSslError.init(fcQSslError_new3(cint(error), certificate.h))

proc create*(T: type gen_qsslerror_types.QSslError, other: QSslError): gen_qsslerror_types.QSslError =
  gen_qsslerror_types.QSslError.init(fcQSslError_new4(other.h))

proc swap*(self: gen_qsslerror_types.QSslError, other: QSslError): void =
  fcQSslError_swap(self.h, other.h)

proc operatorAssign*(self: gen_qsslerror_types.QSslError, other: QSslError): void =
  fcQSslError_operatorAssign(self.h, other.h)

proc operatorEqual*(self: gen_qsslerror_types.QSslError, other: QSslError): bool =
  fcQSslError_operatorEqual(self.h, other.h)

proc operatorNotEqual*(self: gen_qsslerror_types.QSslError, other: QSslError): bool =
...
proc certificate*(self: gen_qsslerror_types.QSslError, ): QSslCertificate =
  QSslCertificate(h: fcQSslError_certificate(self.h))
