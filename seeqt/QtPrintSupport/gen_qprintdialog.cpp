...
void miqt_exec_callback_QPrintDialog_accepted_release(intptr_t);
#ifdef __cplusplus
} /* extern C */
#endif
...
void QPrintDialog_connect_accepted(QPrintDialog* self, intptr_t slot) {
	struct caller {
		...
		~caller() { miqt_exec_callback_QPrintDialog_accepted_release(slot); }
	};
	MiqtVirtualQPrintDialog::connect(self, static_cast<void (QPrintDialog::*)(QPrinter*)>(&QPrintDialog::accepted), self, caller{slot});
}
...
QMetaObject* QPrintDialog_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQPrintDialog*)(self) )->QPrintDialog::metaObject();

}

void* QPrintDialog_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQPrintDialog*)(self) )->QPrintDialog::qt_metacast(param1);

}

int QPrintDialog_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQPrintDialog*)(self) )->QPrintDialog::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
bool QPrintDialog_virtualbase_nativeEvent(void* self, struct miqt_string eventType, void* message, long* result) {
	...
	return ( (MiqtVirtualQPrintDialog*)(self) )->QPrintDialog::nativeEvent(eventType_QByteArray, message, static_cast<long*>(result));
...
void QPrintDialog_protectedbase_adjustPosition(void* self, QWidget* param1) {
	MiqtVirtualQPrintDialog* self_cast = static_cast<MiqtVirtualQPrintDialog*>( (QPrintDialog*)(self) );
