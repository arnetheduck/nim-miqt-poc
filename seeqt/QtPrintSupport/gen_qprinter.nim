...
proc create*(T: type gen_qprinter_types.QPrinter, printer: QPrinterInfo): gen_qprinter_types.QPrinter =
...
proc create*(T: type gen_qprinter_types.QPrinter, printer: QPrinterInfo, mode: cint): gen_qprinter_types.QPrinter =
...
proc setPageSizeMM*(self: gen_qprinter_types.QPrinter, size: QSizeF): void =
...
proc setPaperSize*(self: gen_qprinter_types.QPrinter, paperSize: QSizeF, unit: cint): void =
  fcQPrinter_setPaperSize2(self.h, paperSize.h, cint(unit))

proc paperSize*(self: gen_qprinter_types.QPrinter, unit: cint): QSizeF =
  QSizeF(h: fcQPrinter_paperSizeWithUnit(self.h, cint(unit)))
...
proc paperRect*(self: gen_qprinter_types.QPrinter, ): QRect =
  QRect(h: fcQPrinter_paperRect(self.h))

proc pageRect*(self: gen_qprinter_types.QPrinter, ): QRect =
  QRect(h: fcQPrinter_pageRect(self.h))

proc paperRect*(self: gen_qprinter_types.QPrinter, param1: cint): QRectF =
  QRectF(h: fcQPrinter_paperRectWithQPrinterUnit(self.h, cint(param1)))

proc pageRect*(self: gen_qprinter_types.QPrinter, param1: cint): QRectF =
  QRectF(h: fcQPrinter_pageRectWithQPrinterUnit(self.h, cint(param1)))
...
proc paintEngine*(self: gen_qprinter_types.QPrinter, ): QPaintEngine =
  QPaintEngine(h: fcQPrinter_paintEngine(self.h))

proc printEngine*(self: gen_qprinter_types.QPrinter, ): QPrintEngine =
  QPrintEngine(h: fcQPrinter_printEngine(self.h))
...
proc setMargins*(self: gen_qprinter_types.QPrinter, m: QPagedPaintDeviceMargins): void =
...
proc miqt_exec_callback_QPrinter_setPageSize(self: ptr cQPrinter, slot: int, pageSize: cint): void {.exportc: "miqt_exec_callback_QPrinter_setPageSize ".} =
  ...
  nimfunc[](slotval1)
proc QPrintersetPageSizeMM*(self: gen_qprinter_types.QPrinter, size: QSizeF): void =
  fQPrinter_virtualbase_setPageSizeMM(self.h, size.h)

type QPrintersetPageSizeMMProc* = proc(size: QSizeF): void
...
proc miqt_exec_callback_QPrinter_newPage(self: ptr cQPrinter, slot: int): bool {.exportc: "miqt_exec_callback_QPrinter_newPage ".} =
  ...
  virtualReturn
proc QPrinterpaintEngine*(self: gen_qprinter_types.QPrinter, ): QPaintEngine =
  QPaintEngine(h: fQPrinter_virtualbase_paintEngine(self.h))

type QPrinterpaintEngineProc* = proc(): QPaintEngine
...
proc miqt_exec_callback_QPrinter_paintEngine(self: ptr cQPrinter, slot: int): pointer {.exportc: "miqt_exec_callback_QPrinter_paintEngine ".} =
  ...
  virtualReturn.h
proc QPrintersetMargins*(self: gen_qprinter_types.QPrinter, m: QPagedPaintDeviceMargins): void =
  fQPrinter_virtualbase_setMargins(self.h, m.h)

type QPrintersetMarginsProc* = proc(m: QPagedPaintDeviceMargins): void
...
proc miqt_exec_callback_QPrinter_metric(self: ptr cQPrinter, slot: int, param1: cint): cint {.exportc: "miqt_exec_callback_QPrinter_metric ".} =
  ...
  virtualReturn
proc QPrinterinitPainter*(self: gen_qprinter_types.QPrinter, painter: QPainter): void =
  fQPrinter_virtualbase_initPainter(self.h, painter.h)

type QPrinterinitPainterProc* = proc(painter: QPainter): void
...
proc miqt_exec_callback_QPrinter_initPainter(self: ptr cQPrinter, slot: int, painter: pointer): void {.exportc: "miqt_exec_callback_QPrinter_initPainter ".} =
  ...
  nimfunc[](slotval1)
proc QPrinterredirected*(self: gen_qprinter_types.QPrinter, offset: QPoint): QPaintDevice =
  QPaintDevice(h: fQPrinter_virtualbase_redirected(self.h, offset.h))

type QPrinterredirectedProc* = proc(offset: QPoint): QPaintDevice
...
proc miqt_exec_callback_QPrinter_redirected(self: ptr cQPrinter, slot: int, offset: pointer): pointer {.exportc: "miqt_exec_callback_QPrinter_redirected ".} =
  ...
  virtualReturn.h
proc QPrintersharedPainter*(self: gen_qprinter_types.QPrinter, ): QPainter =
  QPainter(h: fQPrinter_virtualbase_sharedPainter(self.h))

type QPrintersharedPainterProc* = proc(): QPainter
