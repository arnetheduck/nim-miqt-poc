...
proc paperRect*(self: gen_qprinter_types.QPrinter, param1: cint): QRectF =
  QRectF(h: fcQPrinter_paperRect(self.h, cint(param1)))

proc pageRect*(self: gen_qprinter_types.QPrinter, param1: cint): QRectF =
  QRectF(h: fcQPrinter_pageRect(self.h, cint(param1)))
...
proc miqt_exec_callback_QPrinter_metric(self: ptr cQPrinter, slot: int, param1: cint): cint {.exportc: "miqt_exec_callback_QPrinter_metric ".} =
  ...
  virtualReturn
proc QPrintersetPageLayout*(self: gen_qprinter_types.QPrinter, pageLayout: QPageLayout): bool =
  fQPrinter_virtualbase_setPageLayout(self.h, pageLayout.h)

type QPrintersetPageLayoutProc* = proc(pageLayout: QPageLayout): bool
...
proc miqt_exec_callback_QPrinter_setPageLayout(self: ptr cQPrinter, slot: int, pageLayout: pointer): bool {.exportc: "miqt_exec_callback_QPrinter_setPageLayout ".} =
  ...
  virtualReturn
proc QPrintersetPageSize*(self: gen_qprinter_types.QPrinter, pageSize: QPageSize): bool =
  fQPrinter_virtualbase_setPageSize(self.h, pageSize.h)

type QPrintersetPageSizeProc* = proc(pageSize: QPageSize): bool
...
proc miqt_exec_callback_QPrinter_setPageOrientation(self: ptr cQPrinter, slot: int, orientation: cint): bool {.exportc: "miqt_exec_callback_QPrinter_setPageOrientation ".} =
  ...
  virtualReturn
proc QPrintersetPageMargins*(self: gen_qprinter_types.QPrinter, margins: QMarginsF, units: cint): bool =
  fQPrinter_virtualbase_setPageMargins(self.h, margins.h, cint(units))

type QPrintersetPageMarginsProc* = proc(margins: QMarginsF, units: cint): bool
...
proc miqt_exec_callback_QPrinter_setPageMargins(self: ptr cQPrinter, slot: int, margins: pointer, units: cint): bool {.exportc: "miqt_exec_callback_QPrinter_setPageMargins ".} =
  ...
  virtualReturn
proc QPrintersetPageRanges*(self: gen_qprinter_types.QPrinter, ranges: QPageRanges): void =
  fQPrinter_virtualbase_setPageRanges(self.h, ranges.h)

type QPrintersetPageRangesProc* = proc(ranges: QPageRanges): void
