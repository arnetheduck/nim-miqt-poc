...
void QPrintPreviewWidget_connect_paintRequested(QPrintPreviewWidget* self, intptr_t slot, void (*callback)(intptr_t, QPrinter*), void (*release)(intptr_t)) {
	...
	MiqtVirtualQPrintPreviewWidget::connect(self, static_cast<void (QPrintPreviewWidget::*)(QPrinter*)>(&QPrintPreviewWidget::paintRequested), self, caller{slot, callback, release});
}
...
void QPrintPreviewWidget_connect_previewChanged(QPrintPreviewWidget* self, intptr_t slot, void (*callback)(intptr_t), void (*release)(intptr_t)) {
	...
	MiqtVirtualQPrintPreviewWidget::connect(self, static_cast<void (QPrintPreviewWidget::*)()>(&QPrintPreviewWidget::previewChanged), self, caller{slot, callback, release});
}
...
QMetaObject* QPrintPreviewWidget_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQPrintPreviewWidget*)(self) )->QPrintPreviewWidget::metaObject();

}

void* QPrintPreviewWidget_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQPrintPreviewWidget*)(self) )->QPrintPreviewWidget::qt_metacast(param1);

}

int QPrintPreviewWidget_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQPrintPreviewWidget*)(self) )->QPrintPreviewWidget::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
bool QPrintPreviewWidget_virtualbase_nativeEvent(void* self, struct miqt_string eventType, void* message, long* result) {
	...
	return ( (MiqtVirtualQPrintPreviewWidget*)(self) )->QPrintPreviewWidget::nativeEvent(eventType_QByteArray, message, static_cast<long*>(result));
...
void QPrintPreviewWidget_protectedbase_updateMicroFocus(void* self) {
	MiqtVirtualQPrintPreviewWidget* self_cast = static_cast<MiqtVirtualQPrintPreviewWidget*>( (QPrintPreviewWidget*)(self) );
