...
QMetaObject* QCameraViewfinder_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQCameraViewfinder*)(self) )->QCameraViewfinder::metaObject();

}

void* QCameraViewfinder_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQCameraViewfinder*)(self) )->QCameraViewfinder::qt_metacast(param1);

}

int QCameraViewfinder_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQCameraViewfinder*)(self) )->QCameraViewfinder::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
void QCameraViewfinder_protectedbase_updateMicroFocus(void* self) {
	MiqtVirtualQCameraViewfinder* self_cast = static_cast<MiqtVirtualQCameraViewfinder*>( (QCameraViewfinder*)(self) );
