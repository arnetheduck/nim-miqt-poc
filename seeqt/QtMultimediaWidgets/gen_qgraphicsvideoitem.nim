...
proc fQGraphicsVideoItem_virtualbase_mediaObject(self: pointer, ): pointer{.importc: "QGraphicsVideoItem_virtualbase_mediaObject".}
proc fcQGraphicsVideoItem_override_virtual_mediaObject(self: pointer, slot: int) {.importc: "QGraphicsVideoItem_override_virtual_mediaObject".}
...
proc fQGraphicsVideoItem_virtualbase_setMediaObject(self: pointer, objectVal: pointer): bool{.importc: "QGraphicsVideoItem_virtualbase_setMediaObject".}
proc fcQGraphicsVideoItem_override_virtual_setMediaObject(self: pointer, slot: int) {.importc: "QGraphicsVideoItem_override_virtual_setMediaObject".}
...
proc create*(T: type gen_qgraphicsvideoitem_types.QGraphicsVideoItem, parent: QGraphicsItem): gen_qgraphicsvideoitem_types.QGraphicsVideoItem =
  gen_qgraphicsvideoitem_types.QGraphicsVideoItem.init(fcQGraphicsVideoItem_new2(parent.h))

proc metaObject*(self: gen_qgraphicsvideoitem_types.QGraphicsVideoItem, ): QMetaObject =
  QMetaObject(h: fcQGraphicsVideoItem_metaObject(self.h))
...
proc mediaObject*(self: gen_qgraphicsvideoitem_types.QGraphicsVideoItem, ): QMediaObject =
  QMediaObject(h: fcQGraphicsVideoItem_mediaObject(self.h))

proc videoSurface*(self: gen_qgraphicsvideoitem_types.QGraphicsVideoItem, ): QAbstractVideoSurface =
  QAbstractVideoSurface(h: fcQGraphicsVideoItem_videoSurface(self.h))
...
proc offset*(self: gen_qgraphicsvideoitem_types.QGraphicsVideoItem, ): QPointF =
  QPointF(h: fcQGraphicsVideoItem_offset(self.h))

proc setOffset*(self: gen_qgraphicsvideoitem_types.QGraphicsVideoItem, offset: QPointF): void =
  fcQGraphicsVideoItem_setOffset(self.h, offset.h)

proc size*(self: gen_qgraphicsvideoitem_types.QGraphicsVideoItem, ): QSizeF =
  QSizeF(h: fcQGraphicsVideoItem_size(self.h))

proc setSize*(self: gen_qgraphicsvideoitem_types.QGraphicsVideoItem, size: QSizeF): void =
  fcQGraphicsVideoItem_setSize(self.h, size.h)

proc nativeSize*(self: gen_qgraphicsvideoitem_types.QGraphicsVideoItem, ): QSizeF =
  QSizeF(h: fcQGraphicsVideoItem_nativeSize(self.h))

proc boundingRect*(self: gen_qgraphicsvideoitem_types.QGraphicsVideoItem, ): QRectF =
  QRectF(h: fcQGraphicsVideoItem_boundingRect(self.h))

proc paint*(self: gen_qgraphicsvideoitem_types.QGraphicsVideoItem, painter: QPainter, option: QStyleOptionGraphicsItem, widget: QWidget): void =
  fcQGraphicsVideoItem_paint(self.h, painter.h, option.h, widget.h)

proc nativeSizeChanged*(self: gen_qgraphicsvideoitem_types.QGraphicsVideoItem, size: QSizeF): void =
  fcQGraphicsVideoItem_nativeSizeChanged(self.h, size.h)

type QGraphicsVideoItemnativeSizeChangedSlot* = proc(size: QSizeF)
...
proc miqt_exec_callback_QGraphicsVideoItem_metacall(self: ptr cQGraphicsVideoItem, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QGraphicsVideoItem_metacall ".} =
  ...
  virtualReturn
proc QGraphicsVideoItemmediaObject*(self: gen_qgraphicsvideoitem_types.QGraphicsVideoItem, ): QMediaObject =
  QMediaObject(h: fQGraphicsVideoItem_virtualbase_mediaObject(self.h))

type QGraphicsVideoItemmediaObjectProc* = proc(): QMediaObject
proc onmediaObject*(self: gen_qgraphicsvideoitem_types.QGraphicsVideoItem, slot: QGraphicsVideoItemmediaObjectProc) =
  # TODO check subclass
  var tmp = new QGraphicsVideoItemmediaObjectProc
  tmp[] = slot
  GC_ref(tmp)
  fcQGraphicsVideoItem_override_virtual_mediaObject(self.h, cast[int](addr tmp[]))

proc miqt_exec_callback_QGraphicsVideoItem_mediaObject(self: ptr cQGraphicsVideoItem, slot: int): pointer {.exportc: "miqt_exec_callback_QGraphicsVideoItem_mediaObject ".} =
  var nimfunc = cast[ptr QGraphicsVideoItemmediaObjectProc](cast[pointer](slot))

  let virtualReturn = nimfunc[]( )

  virtualReturn.h
proc QGraphicsVideoItemboundingRect*(self: gen_qgraphicsvideoitem_types.QGraphicsVideoItem, ): QRectF =
  QRectF(h: fQGraphicsVideoItem_virtualbase_boundingRect(self.h))

type QGraphicsVideoItemboundingRectProc* = proc(): QRectF
...
proc miqt_exec_callback_QGraphicsVideoItem_boundingRect(self: ptr cQGraphicsVideoItem, slot: int): pointer {.exportc: "miqt_exec_callback_QGraphicsVideoItem_boundingRect ".} =
  ...
  virtualReturn.h
proc QGraphicsVideoItempaint*(self: gen_qgraphicsvideoitem_types.QGraphicsVideoItem, painter: QPainter, option: QStyleOptionGraphicsItem, widget: QWidget): void =
  fQGraphicsVideoItem_virtualbase_paint(self.h, painter.h, option.h, widget.h)

type QGraphicsVideoItempaintProc* = proc(painter: QPainter, option: QStyleOptionGraphicsItem, widget: QWidget): void
...
proc QGraphicsVideoItemtimerEvent*(self: gen_qgraphicsvideoitem_types.QGraphicsVideoItem, event: QTimerEvent): void =
  fQGraphicsVideoItem_virtualbase_timerEvent(self.h, event.h)

type QGraphicsVideoItemtimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QGraphicsVideoItem_timerEvent(self: ptr cQGraphicsVideoItem, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsVideoItem_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsVideoItemitemChange*(self: gen_qgraphicsvideoitem_types.QGraphicsVideoItem, change: cint, value: QVariant): QVariant =
  QVariant(h: fQGraphicsVideoItem_virtualbase_itemChange(self.h, cint(change), value.h))

type QGraphicsVideoItemitemChangeProc* = proc(change: cint, value: QVariant): QVariant
...
proc miqt_exec_callback_QGraphicsVideoItem_itemChange(self: ptr cQGraphicsVideoItem, slot: int, change: cint, value: pointer): pointer {.exportc: "miqt_exec_callback_QGraphicsVideoItem_itemChange ".} =
  ...
  virtualReturn.h
proc QGraphicsVideoItemsetMediaObject*(self: gen_qgraphicsvideoitem_types.QGraphicsVideoItem, objectVal: QMediaObject): bool =
  fQGraphicsVideoItem_virtualbase_setMediaObject(self.h, objectVal.h)

type QGraphicsVideoItemsetMediaObjectProc* = proc(objectVal: QMediaObject): bool
proc onsetMediaObject*(self: gen_qgraphicsvideoitem_types.QGraphicsVideoItem, slot: QGraphicsVideoItemsetMediaObjectProc) =
  # TODO check subclass
  var tmp = new QGraphicsVideoItemsetMediaObjectProc
  tmp[] = slot
  GC_ref(tmp)
  fcQGraphicsVideoItem_override_virtual_setMediaObject(self.h, cast[int](addr tmp[]))

proc miqt_exec_callback_QGraphicsVideoItem_setMediaObject(self: ptr cQGraphicsVideoItem, slot: int, objectVal: pointer): bool {.exportc: "miqt_exec_callback_QGraphicsVideoItem_setMediaObject ".} =
  var nimfunc = cast[ptr QGraphicsVideoItemsetMediaObjectProc](cast[pointer](slot))
  let slotval1 = QMediaObject(h: objectVal)


  let virtualReturn = nimfunc[](slotval1 )

  virtualReturn
proc QGraphicsVideoItemevent*(self: gen_qgraphicsvideoitem_types.QGraphicsVideoItem, ev: QEvent): bool =
  fQGraphicsVideoItem_virtualbase_event(self.h, ev.h)

type QGraphicsVideoItemeventProc* = proc(ev: QEvent): bool
...
proc miqt_exec_callback_QGraphicsVideoItem_event(self: ptr cQGraphicsVideoItem, slot: int, ev: pointer): bool {.exportc: "miqt_exec_callback_QGraphicsVideoItem_event ".} =
  ...
  virtualReturn
proc QGraphicsVideoItemeventFilter*(self: gen_qgraphicsvideoitem_types.QGraphicsVideoItem, watched: QObject, event: QEvent): bool =
  fQGraphicsVideoItem_virtualbase_eventFilter(self.h, watched.h, event.h)

type QGraphicsVideoItemeventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QGraphicsVideoItem_eventFilter(self: ptr cQGraphicsVideoItem, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QGraphicsVideoItem_eventFilter ".} =
  ...
  virtualReturn
proc QGraphicsVideoItemchildEvent*(self: gen_qgraphicsvideoitem_types.QGraphicsVideoItem, event: QChildEvent): void =
  fQGraphicsVideoItem_virtualbase_childEvent(self.h, event.h)

type QGraphicsVideoItemchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QGraphicsVideoItem_childEvent(self: ptr cQGraphicsVideoItem, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsVideoItem_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsVideoItemcustomEvent*(self: gen_qgraphicsvideoitem_types.QGraphicsVideoItem, event: QEvent): void =
  fQGraphicsVideoItem_virtualbase_customEvent(self.h, event.h)

type QGraphicsVideoItemcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QGraphicsVideoItem_customEvent(self: ptr cQGraphicsVideoItem, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsVideoItem_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsVideoItemconnectNotify*(self: gen_qgraphicsvideoitem_types.QGraphicsVideoItem, signal: QMetaMethod): void =
  fQGraphicsVideoItem_virtualbase_connectNotify(self.h, signal.h)

type QGraphicsVideoItemconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QGraphicsVideoItem_connectNotify(self: ptr cQGraphicsVideoItem, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QGraphicsVideoItem_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsVideoItemdisconnectNotify*(self: gen_qgraphicsvideoitem_types.QGraphicsVideoItem, signal: QMetaMethod): void =
  fQGraphicsVideoItem_virtualbase_disconnectNotify(self.h, signal.h)

type QGraphicsVideoItemdisconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QGraphicsVideoItem_advance(self: ptr cQGraphicsVideoItem, slot: int, phase: cint): void {.exportc: "miqt_exec_callback_QGraphicsVideoItem_advance ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsVideoItemshape*(self: gen_qgraphicsvideoitem_types.QGraphicsVideoItem, ): QPainterPath =
  QPainterPath(h: fQGraphicsVideoItem_virtualbase_shape(self.h))

type QGraphicsVideoItemshapeProc* = proc(): QPainterPath
...
proc miqt_exec_callback_QGraphicsVideoItem_shape(self: ptr cQGraphicsVideoItem, slot: int): pointer {.exportc: "miqt_exec_callback_QGraphicsVideoItem_shape ".} =
  ...
  virtualReturn.h
proc QGraphicsVideoItemcontains*(self: gen_qgraphicsvideoitem_types.QGraphicsVideoItem, point: QPointF): bool =
  fQGraphicsVideoItem_virtualbase_contains(self.h, point.h)

type QGraphicsVideoItemcontainsProc* = proc(point: QPointF): bool
...
proc miqt_exec_callback_QGraphicsVideoItem_contains(self: ptr cQGraphicsVideoItem, slot: int, point: pointer): bool {.exportc: "miqt_exec_callback_QGraphicsVideoItem_contains ".} =
  ...
  virtualReturn
proc QGraphicsVideoItemcollidesWithItem*(self: gen_qgraphicsvideoitem_types.QGraphicsVideoItem, other: QGraphicsItem, mode: cint): bool =
  fQGraphicsVideoItem_virtualbase_collidesWithItem(self.h, other.h, cint(mode))

type QGraphicsVideoItemcollidesWithItemProc* = proc(other: QGraphicsItem, mode: cint): bool
...
proc miqt_exec_callback_QGraphicsVideoItem_collidesWithItem(self: ptr cQGraphicsVideoItem, slot: int, other: pointer, mode: cint): bool {.exportc: "miqt_exec_callback_QGraphicsVideoItem_collidesWithItem ".} =
  ...
  virtualReturn
proc QGraphicsVideoItemcollidesWithPath*(self: gen_qgraphicsvideoitem_types.QGraphicsVideoItem, path: QPainterPath, mode: cint): bool =
  fQGraphicsVideoItem_virtualbase_collidesWithPath(self.h, path.h, cint(mode))

type QGraphicsVideoItemcollidesWithPathProc* = proc(path: QPainterPath, mode: cint): bool
...
proc miqt_exec_callback_QGraphicsVideoItem_collidesWithPath(self: ptr cQGraphicsVideoItem, slot: int, path: pointer, mode: cint): bool {.exportc: "miqt_exec_callback_QGraphicsVideoItem_collidesWithPath ".} =
  ...
  virtualReturn
proc QGraphicsVideoItemisObscuredBy*(self: gen_qgraphicsvideoitem_types.QGraphicsVideoItem, item: QGraphicsItem): bool =
  fQGraphicsVideoItem_virtualbase_isObscuredBy(self.h, item.h)

type QGraphicsVideoItemisObscuredByProc* = proc(item: QGraphicsItem): bool
...
proc miqt_exec_callback_QGraphicsVideoItem_isObscuredBy(self: ptr cQGraphicsVideoItem, slot: int, item: pointer): bool {.exportc: "miqt_exec_callback_QGraphicsVideoItem_isObscuredBy ".} =
  ...
  virtualReturn
proc QGraphicsVideoItemopaqueArea*(self: gen_qgraphicsvideoitem_types.QGraphicsVideoItem, ): QPainterPath =
  QPainterPath(h: fQGraphicsVideoItem_virtualbase_opaqueArea(self.h))

type QGraphicsVideoItemopaqueAreaProc* = proc(): QPainterPath
...
proc miqt_exec_callback_QGraphicsVideoItem_type(self: ptr cQGraphicsVideoItem, slot: int): cint {.exportc: "miqt_exec_callback_QGraphicsVideoItem_type ".} =
  ...
  virtualReturn
proc QGraphicsVideoItemsceneEventFilter*(self: gen_qgraphicsvideoitem_types.QGraphicsVideoItem, watched: QGraphicsItem, event: QEvent): bool =
  fQGraphicsVideoItem_virtualbase_sceneEventFilter(self.h, watched.h, event.h)

type QGraphicsVideoItemsceneEventFilterProc* = proc(watched: QGraphicsItem, event: QEvent): bool
...
proc miqt_exec_callback_QGraphicsVideoItem_sceneEventFilter(self: ptr cQGraphicsVideoItem, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QGraphicsVideoItem_sceneEventFilter ".} =
  ...
  virtualReturn
proc QGraphicsVideoItemsceneEvent*(self: gen_qgraphicsvideoitem_types.QGraphicsVideoItem, event: QEvent): bool =
  fQGraphicsVideoItem_virtualbase_sceneEvent(self.h, event.h)

type QGraphicsVideoItemsceneEventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QGraphicsVideoItem_sceneEvent(self: ptr cQGraphicsVideoItem, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QGraphicsVideoItem_sceneEvent ".} =
  ...
  virtualReturn
proc QGraphicsVideoItemcontextMenuEvent*(self: gen_qgraphicsvideoitem_types.QGraphicsVideoItem, event: QGraphicsSceneContextMenuEvent): void =
  fQGraphicsVideoItem_virtualbase_contextMenuEvent(self.h, event.h)

type QGraphicsVideoItemcontextMenuEventProc* = proc(event: QGraphicsSceneContextMenuEvent): void
...
proc miqt_exec_callback_QGraphicsVideoItem_contextMenuEvent(self: ptr cQGraphicsVideoItem, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsVideoItem_contextMenuEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsVideoItemdragEnterEvent*(self: gen_qgraphicsvideoitem_types.QGraphicsVideoItem, event: QGraphicsSceneDragDropEvent): void =
  fQGraphicsVideoItem_virtualbase_dragEnterEvent(self.h, event.h)

type QGraphicsVideoItemdragEnterEventProc* = proc(event: QGraphicsSceneDragDropEvent): void
...
proc miqt_exec_callback_QGraphicsVideoItem_dragEnterEvent(self: ptr cQGraphicsVideoItem, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsVideoItem_dragEnterEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsVideoItemdragLeaveEvent*(self: gen_qgraphicsvideoitem_types.QGraphicsVideoItem, event: QGraphicsSceneDragDropEvent): void =
  fQGraphicsVideoItem_virtualbase_dragLeaveEvent(self.h, event.h)

type QGraphicsVideoItemdragLeaveEventProc* = proc(event: QGraphicsSceneDragDropEvent): void
...
proc miqt_exec_callback_QGraphicsVideoItem_dragLeaveEvent(self: ptr cQGraphicsVideoItem, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsVideoItem_dragLeaveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsVideoItemdragMoveEvent*(self: gen_qgraphicsvideoitem_types.QGraphicsVideoItem, event: QGraphicsSceneDragDropEvent): void =
  fQGraphicsVideoItem_virtualbase_dragMoveEvent(self.h, event.h)

type QGraphicsVideoItemdragMoveEventProc* = proc(event: QGraphicsSceneDragDropEvent): void
...
proc miqt_exec_callback_QGraphicsVideoItem_dragMoveEvent(self: ptr cQGraphicsVideoItem, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsVideoItem_dragMoveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsVideoItemdropEvent*(self: gen_qgraphicsvideoitem_types.QGraphicsVideoItem, event: QGraphicsSceneDragDropEvent): void =
  fQGraphicsVideoItem_virtualbase_dropEvent(self.h, event.h)

type QGraphicsVideoItemdropEventProc* = proc(event: QGraphicsSceneDragDropEvent): void
...
proc miqt_exec_callback_QGraphicsVideoItem_dropEvent(self: ptr cQGraphicsVideoItem, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsVideoItem_dropEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsVideoItemfocusInEvent*(self: gen_qgraphicsvideoitem_types.QGraphicsVideoItem, event: QFocusEvent): void =
  fQGraphicsVideoItem_virtualbase_focusInEvent(self.h, event.h)

type QGraphicsVideoItemfocusInEventProc* = proc(event: QFocusEvent): void
...
proc miqt_exec_callback_QGraphicsVideoItem_focusInEvent(self: ptr cQGraphicsVideoItem, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsVideoItem_focusInEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsVideoItemfocusOutEvent*(self: gen_qgraphicsvideoitem_types.QGraphicsVideoItem, event: QFocusEvent): void =
  fQGraphicsVideoItem_virtualbase_focusOutEvent(self.h, event.h)

type QGraphicsVideoItemfocusOutEventProc* = proc(event: QFocusEvent): void
...
proc miqt_exec_callback_QGraphicsVideoItem_focusOutEvent(self: ptr cQGraphicsVideoItem, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsVideoItem_focusOutEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsVideoItemhoverEnterEvent*(self: gen_qgraphicsvideoitem_types.QGraphicsVideoItem, event: QGraphicsSceneHoverEvent): void =
  fQGraphicsVideoItem_virtualbase_hoverEnterEvent(self.h, event.h)

type QGraphicsVideoItemhoverEnterEventProc* = proc(event: QGraphicsSceneHoverEvent): void
...
proc miqt_exec_callback_QGraphicsVideoItem_hoverEnterEvent(self: ptr cQGraphicsVideoItem, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsVideoItem_hoverEnterEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsVideoItemhoverMoveEvent*(self: gen_qgraphicsvideoitem_types.QGraphicsVideoItem, event: QGraphicsSceneHoverEvent): void =
  fQGraphicsVideoItem_virtualbase_hoverMoveEvent(self.h, event.h)

type QGraphicsVideoItemhoverMoveEventProc* = proc(event: QGraphicsSceneHoverEvent): void
...
proc miqt_exec_callback_QGraphicsVideoItem_hoverMoveEvent(self: ptr cQGraphicsVideoItem, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsVideoItem_hoverMoveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsVideoItemhoverLeaveEvent*(self: gen_qgraphicsvideoitem_types.QGraphicsVideoItem, event: QGraphicsSceneHoverEvent): void =
  fQGraphicsVideoItem_virtualbase_hoverLeaveEvent(self.h, event.h)

type QGraphicsVideoItemhoverLeaveEventProc* = proc(event: QGraphicsSceneHoverEvent): void
...
proc miqt_exec_callback_QGraphicsVideoItem_hoverLeaveEvent(self: ptr cQGraphicsVideoItem, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsVideoItem_hoverLeaveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsVideoItemkeyPressEvent*(self: gen_qgraphicsvideoitem_types.QGraphicsVideoItem, event: QKeyEvent): void =
  fQGraphicsVideoItem_virtualbase_keyPressEvent(self.h, event.h)

type QGraphicsVideoItemkeyPressEventProc* = proc(event: QKeyEvent): void
...
proc miqt_exec_callback_QGraphicsVideoItem_keyPressEvent(self: ptr cQGraphicsVideoItem, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsVideoItem_keyPressEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsVideoItemkeyReleaseEvent*(self: gen_qgraphicsvideoitem_types.QGraphicsVideoItem, event: QKeyEvent): void =
  fQGraphicsVideoItem_virtualbase_keyReleaseEvent(self.h, event.h)

type QGraphicsVideoItemkeyReleaseEventProc* = proc(event: QKeyEvent): void
...
proc miqt_exec_callback_QGraphicsVideoItem_keyReleaseEvent(self: ptr cQGraphicsVideoItem, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsVideoItem_keyReleaseEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsVideoItemmousePressEvent*(self: gen_qgraphicsvideoitem_types.QGraphicsVideoItem, event: QGraphicsSceneMouseEvent): void =
  fQGraphicsVideoItem_virtualbase_mousePressEvent(self.h, event.h)

type QGraphicsVideoItemmousePressEventProc* = proc(event: QGraphicsSceneMouseEvent): void
...
proc miqt_exec_callback_QGraphicsVideoItem_mousePressEvent(self: ptr cQGraphicsVideoItem, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsVideoItem_mousePressEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsVideoItemmouseMoveEvent*(self: gen_qgraphicsvideoitem_types.QGraphicsVideoItem, event: QGraphicsSceneMouseEvent): void =
  fQGraphicsVideoItem_virtualbase_mouseMoveEvent(self.h, event.h)

type QGraphicsVideoItemmouseMoveEventProc* = proc(event: QGraphicsSceneMouseEvent): void
...
proc miqt_exec_callback_QGraphicsVideoItem_mouseMoveEvent(self: ptr cQGraphicsVideoItem, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsVideoItem_mouseMoveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsVideoItemmouseReleaseEvent*(self: gen_qgraphicsvideoitem_types.QGraphicsVideoItem, event: QGraphicsSceneMouseEvent): void =
  fQGraphicsVideoItem_virtualbase_mouseReleaseEvent(self.h, event.h)

type QGraphicsVideoItemmouseReleaseEventProc* = proc(event: QGraphicsSceneMouseEvent): void
...
proc miqt_exec_callback_QGraphicsVideoItem_mouseReleaseEvent(self: ptr cQGraphicsVideoItem, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsVideoItem_mouseReleaseEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsVideoItemmouseDoubleClickEvent*(self: gen_qgraphicsvideoitem_types.QGraphicsVideoItem, event: QGraphicsSceneMouseEvent): void =
  fQGraphicsVideoItem_virtualbase_mouseDoubleClickEvent(self.h, event.h)

type QGraphicsVideoItemmouseDoubleClickEventProc* = proc(event: QGraphicsSceneMouseEvent): void
...
proc miqt_exec_callback_QGraphicsVideoItem_mouseDoubleClickEvent(self: ptr cQGraphicsVideoItem, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsVideoItem_mouseDoubleClickEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsVideoItemwheelEvent*(self: gen_qgraphicsvideoitem_types.QGraphicsVideoItem, event: QGraphicsSceneWheelEvent): void =
  fQGraphicsVideoItem_virtualbase_wheelEvent(self.h, event.h)

type QGraphicsVideoItemwheelEventProc* = proc(event: QGraphicsSceneWheelEvent): void
...
proc miqt_exec_callback_QGraphicsVideoItem_wheelEvent(self: ptr cQGraphicsVideoItem, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsVideoItem_wheelEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsVideoIteminputMethodEvent*(self: gen_qgraphicsvideoitem_types.QGraphicsVideoItem, event: QInputMethodEvent): void =
  fQGraphicsVideoItem_virtualbase_inputMethodEvent(self.h, event.h)

type QGraphicsVideoIteminputMethodEventProc* = proc(event: QInputMethodEvent): void
...
proc miqt_exec_callback_QGraphicsVideoItem_inputMethodEvent(self: ptr cQGraphicsVideoItem, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsVideoItem_inputMethodEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsVideoIteminputMethodQuery*(self: gen_qgraphicsvideoitem_types.QGraphicsVideoItem, query: cint): QVariant =
  QVariant(h: fQGraphicsVideoItem_virtualbase_inputMethodQuery(self.h, cint(query)))

type QGraphicsVideoIteminputMethodQueryProc* = proc(query: cint): QVariant
...
proc miqt_exec_callback_QGraphicsVideoItem_supportsExtension(self: ptr cQGraphicsVideoItem, slot: int, extension: cint): bool {.exportc: "miqt_exec_callback_QGraphicsVideoItem_supportsExtension ".} =
  ...
  virtualReturn
proc QGraphicsVideoItemsetExtension*(self: gen_qgraphicsvideoitem_types.QGraphicsVideoItem, extension: cint, variant: QVariant): void =
  fQGraphicsVideoItem_virtualbase_setExtension(self.h, cint(extension), variant.h)

type QGraphicsVideoItemsetExtensionProc* = proc(extension: cint, variant: QVariant): void
...
proc QGraphicsVideoItemextension*(self: gen_qgraphicsvideoitem_types.QGraphicsVideoItem, variant: QVariant): QVariant =
  QVariant(h: fQGraphicsVideoItem_virtualbase_extension(self.h, variant.h))

type QGraphicsVideoItemextensionProc* = proc(variant: QVariant): QVariant
