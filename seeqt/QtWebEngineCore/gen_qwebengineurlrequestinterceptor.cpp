...
QMetaObject* QWebEngineUrlRequestInterceptor_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQWebEngineUrlRequestInterceptor*)(self) )->QWebEngineUrlRequestInterceptor::metaObject();

}

void* QWebEngineUrlRequestInterceptor_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQWebEngineUrlRequestInterceptor*)(self) )->QWebEngineUrlRequestInterceptor::qt_metacast(param1);

}

int QWebEngineUrlRequestInterceptor_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQWebEngineUrlRequestInterceptor*)(self) )->QWebEngineUrlRequestInterceptor::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
