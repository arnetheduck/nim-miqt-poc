...
func init*(T: type gen_qwebenginenavigationrequest_types.QWebEngineNavigationRequest, h: ptr cQWebEngineNavigationRequest): gen_qwebenginenavigationrequest_types.QWebEngineNavigationRequest =
  T(h: h)
proc metaObject*(self: gen_qwebenginenavigationrequest_types.QWebEngineNavigationRequest, ): QMetaObject =
  QMetaObject(h: fcQWebEngineNavigationRequest_metaObject(self.h))
...
proc url*(self: gen_qwebenginenavigationrequest_types.QWebEngineNavigationRequest, ): QUrl =
  QUrl(h: fcQWebEngineNavigationRequest_url(self.h))
