...
proc create*(T: type gen_qwebenginescript_types.QWebEngineScript, other: QWebEngineScript): gen_qwebenginescript_types.QWebEngineScript =
  gen_qwebenginescript_types.QWebEngineScript.init(fcQWebEngineScript_new2(other.h))

proc operatorAssign*(self: gen_qwebenginescript_types.QWebEngineScript, other: QWebEngineScript): void =
...
proc sourceUrl*(self: gen_qwebenginescript_types.QWebEngineScript, ): QUrl =
  QUrl(h: fcQWebEngineScript_sourceUrl(self.h))

proc setSourceUrl*(self: gen_qwebenginescript_types.QWebEngineScript, url: QUrl): void =
...
proc operatorEqual*(self: gen_qwebenginescript_types.QWebEngineScript, other: QWebEngineScript): bool =
  fcQWebEngineScript_operatorEqual(self.h, other.h)

proc operatorNotEqual*(self: gen_qwebenginescript_types.QWebEngineScript, other: QWebEngineScript): bool =
  fcQWebEngineScript_operatorNotEqual(self.h, other.h)

proc swap*(self: gen_qwebenginescript_types.QWebEngineScript, other: QWebEngineScript): void =
