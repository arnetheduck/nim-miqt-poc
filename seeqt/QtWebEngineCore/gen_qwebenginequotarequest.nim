...
proc create*(T: type gen_qwebenginequotarequest_types.QWebEngineQuotaRequest, param1: QWebEngineQuotaRequest): gen_qwebenginequotarequest_types.QWebEngineQuotaRequest =
...
proc origin*(self: gen_qwebenginequotarequest_types.QWebEngineQuotaRequest, ): QUrl =
  QUrl(h: fcQWebEngineQuotaRequest_origin(self.h))
...
proc operatorEqual*(self: gen_qwebenginequotarequest_types.QWebEngineQuotaRequest, that: QWebEngineQuotaRequest): bool =
  fcQWebEngineQuotaRequest_operatorEqual(self.h, that.h)

proc operatorNotEqual*(self: gen_qwebenginequotarequest_types.QWebEngineQuotaRequest, that: QWebEngineQuotaRequest): bool =
