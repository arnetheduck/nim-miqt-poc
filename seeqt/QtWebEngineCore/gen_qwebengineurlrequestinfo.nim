...
proc requestUrl*(self: gen_qwebengineurlrequestinfo_types.QWebEngineUrlRequestInfo, ): QUrl =
  QUrl(h: fcQWebEngineUrlRequestInfo_requestUrl(self.h))

proc firstPartyUrl*(self: gen_qwebengineurlrequestinfo_types.QWebEngineUrlRequestInfo, ): QUrl =
  QUrl(h: fcQWebEngineUrlRequestInfo_firstPartyUrl(self.h))

proc initiator*(self: gen_qwebengineurlrequestinfo_types.QWebEngineUrlRequestInfo, ): QUrl =
  QUrl(h: fcQWebEngineUrlRequestInfo_initiator(self.h))
...
proc redirect*(self: gen_qwebengineurlrequestinfo_types.QWebEngineUrlRequestInfo, url: QUrl): void =
