...
func init*(T: type gen_qwebenginedownloadrequest_types.QWebEngineDownloadRequest, h: ptr cQWebEngineDownloadRequest): gen_qwebenginedownloadrequest_types.QWebEngineDownloadRequest =
  T(h: h)
proc metaObject*(self: gen_qwebenginedownloadrequest_types.QWebEngineDownloadRequest, ): QMetaObject =
  QMetaObject(h: fcQWebEngineDownloadRequest_metaObject(self.h))
...
proc url*(self: gen_qwebenginedownloadrequest_types.QWebEngineDownloadRequest, ): QUrl =
  QUrl(h: fcQWebEngineDownloadRequest_url(self.h))
...
proc page*(self: gen_qwebenginedownloadrequest_types.QWebEngineDownloadRequest, ): QWebEnginePage =
  QWebEnginePage(h: fcQWebEngineDownloadRequest_page(self.h))
