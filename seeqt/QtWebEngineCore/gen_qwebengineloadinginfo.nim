...
func init*(T: type gen_qwebengineloadinginfo_types.QWebEngineLoadingInfo, h: ptr cQWebEngineLoadingInfo): gen_qwebengineloadinginfo_types.QWebEngineLoadingInfo =
  T(h: h)
proc create*(T: type gen_qwebengineloadinginfo_types.QWebEngineLoadingInfo, other: QWebEngineLoadingInfo): gen_qwebengineloadinginfo_types.QWebEngineLoadingInfo =
  gen_qwebengineloadinginfo_types.QWebEngineLoadingInfo.init(fcQWebEngineLoadingInfo_new(other.h))

proc operatorAssign*(self: gen_qwebengineloadinginfo_types.QWebEngineLoadingInfo, other: QWebEngineLoadingInfo): void =
  fcQWebEngineLoadingInfo_operatorAssign(self.h, other.h)

proc url*(self: gen_qwebengineloadinginfo_types.QWebEngineLoadingInfo, ): QUrl =
  QUrl(h: fcQWebEngineLoadingInfo_url(self.h))
