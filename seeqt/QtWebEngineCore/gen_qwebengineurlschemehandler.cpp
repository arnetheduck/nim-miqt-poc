...
QMetaObject* QWebEngineUrlSchemeHandler_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQWebEngineUrlSchemeHandler*)(self) )->QWebEngineUrlSchemeHandler::metaObject();

}

void* QWebEngineUrlSchemeHandler_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQWebEngineUrlSchemeHandler*)(self) )->QWebEngineUrlSchemeHandler::qt_metacast(param1);

}

int QWebEngineUrlSchemeHandler_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQWebEngineUrlSchemeHandler*)(self) )->QWebEngineUrlSchemeHandler::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
QObject* QWebEngineUrlSchemeHandler_protectedbase_sender(const void* self) {
	MiqtVirtualQWebEngineUrlSchemeHandler* self_cast = static_cast<MiqtVirtualQWebEngineUrlSchemeHandler*>( (QWebEngineUrlSchemeHandler*)(self) );
