...
proc create*(T: type gen_qwebenginepage_types.QWebEnginePage, profile: QWebEngineProfile): gen_qwebenginepage_types.QWebEnginePage =
  gen_qwebenginepage_types.QWebEnginePage.init(fcQWebEnginePage_new2(profile.h))

proc create*(T: type gen_qwebenginepage_types.QWebEnginePage, parent: QObject): gen_qwebenginepage_types.QWebEnginePage =
  gen_qwebenginepage_types.QWebEnginePage.init(fcQWebEnginePage_new3(parent.h))

proc create*(T: type gen_qwebenginepage_types.QWebEnginePage, profile: QWebEngineProfile, parent: QObject): gen_qwebenginepage_types.QWebEnginePage =
  gen_qwebenginepage_types.QWebEnginePage.init(fcQWebEnginePage_new4(profile.h, parent.h))

proc metaObject*(self: gen_qwebenginepage_types.QWebEnginePage, ): QMetaObject =
  QMetaObject(h: fcQWebEnginePage_metaObject(self.h))
...
proc history*(self: gen_qwebenginepage_types.QWebEnginePage, ): QWebEngineHistory =
  QWebEngineHistory(h: fcQWebEnginePage_history(self.h))
...
proc profile*(self: gen_qwebenginepage_types.QWebEnginePage, ): QWebEngineProfile =
  QWebEngineProfile(h: fcQWebEnginePage_profile(self.h))
...
proc event*(self: gen_qwebenginepage_types.QWebEnginePage, param1: QEvent): bool =
  fcQWebEnginePage_event(self.h, param1.h)

proc setFeaturePermission*(self: gen_qwebenginepage_types.QWebEnginePage, securityOrigin: QUrl, feature: cint, policy: cint): void =
...
proc load*(self: gen_qwebenginepage_types.QWebEnginePage, url: QUrl): void =
  fcQWebEnginePage_load(self.h, url.h)

proc load*(self: gen_qwebenginepage_types.QWebEnginePage, request: QWebEngineHttpRequest): void =
  fcQWebEnginePage_loadWithRequest(self.h, request.h)

proc download*(self: gen_qwebenginepage_types.QWebEnginePage, url: QUrl): void =
...
proc setUrl*(self: gen_qwebenginepage_types.QWebEnginePage, url: QUrl): void =
  fcQWebEnginePage_setUrl(self.h, url.h)

proc url*(self: gen_qwebenginepage_types.QWebEnginePage, ): QUrl =
  QUrl(h: fcQWebEnginePage_url(self.h))

proc requestedUrl*(self: gen_qwebenginepage_types.QWebEnginePage, ): QUrl =
  QUrl(h: fcQWebEnginePage_requestedUrl(self.h))

proc iconUrl*(self: gen_qwebenginepage_types.QWebEnginePage, ): QUrl =
  QUrl(h: fcQWebEnginePage_iconUrl(self.h))

proc icon*(self: gen_qwebenginepage_types.QWebEnginePage, ): QIcon =
  QIcon(h: fcQWebEnginePage_icon(self.h))
...
proc scrollPosition*(self: gen_qwebenginepage_types.QWebEnginePage, ): QPointF =
  QPointF(h: fcQWebEnginePage_scrollPosition(self.h))

proc contentsSize*(self: gen_qwebenginepage_types.QWebEnginePage, ): QSizeF =
  QSizeF(h: fcQWebEnginePage_contentsSize(self.h))

proc scripts*(self: gen_qwebenginepage_types.QWebEnginePage, ): QWebEngineScriptCollection =
  QWebEngineScriptCollection(h: fcQWebEnginePage_scripts(self.h))

proc settings*(self: gen_qwebenginepage_types.QWebEnginePage, ): QWebEngineSettings =
  QWebEngineSettings(h: fcQWebEnginePage_settings(self.h))

proc webChannel*(self: gen_qwebenginepage_types.QWebEnginePage, ): QWebChannel =
  QWebChannel(h: fcQWebEnginePage_webChannel(self.h))

proc setWebChannel*(self: gen_qwebenginepage_types.QWebEnginePage, param1: QWebChannel): void =
  fcQWebEnginePage_setWebChannel(self.h, param1.h)

proc backgroundColor*(self: gen_qwebenginepage_types.QWebEnginePage, ): QColor =
  QColor(h: fcQWebEnginePage_backgroundColor(self.h))

proc setBackgroundColor*(self: gen_qwebenginepage_types.QWebEnginePage, color: QColor): void =
...
proc setInspectedPage*(self: gen_qwebenginepage_types.QWebEnginePage, page: QWebEnginePage): void =
  fcQWebEnginePage_setInspectedPage(self.h, page.h)

proc inspectedPage*(self: gen_qwebenginepage_types.QWebEnginePage, ): QWebEnginePage =
  QWebEnginePage(h: fcQWebEnginePage_inspectedPage(self.h))

proc setDevToolsPage*(self: gen_qwebenginepage_types.QWebEnginePage, page: QWebEnginePage): void =
  fcQWebEnginePage_setDevToolsPage(self.h, page.h)

proc devToolsPage*(self: gen_qwebenginepage_types.QWebEnginePage, ): QWebEnginePage =
  QWebEnginePage(h: fcQWebEnginePage_devToolsPage(self.h))

proc setUrlRequestInterceptor*(self: gen_qwebenginepage_types.QWebEnginePage, interceptor: QWebEngineUrlRequestInterceptor): void =
...
proc acceptAsNewWindow*(self: gen_qwebenginepage_types.QWebEnginePage, request: QWebEngineNewWindowRequest): void =
...
proc loadingChanged*(self: gen_qwebenginepage_types.QWebEnginePage, loadingInfo: QWebEngineLoadingInfo): void =
  fcQWebEnginePage_loadingChanged(self.h, loadingInfo.h)

type QWebEnginePageloadingChangedSlot* = proc(loadingInfo: QWebEngineLoadingInfo)
proc miqt_exec_callback_QWebEnginePage_loadingChanged(slot: int, loadingInfo: pointer) {.exportc.} =
  ...
  let slotval1 = QWebEngineLoadingInfo(h: loadingInfo)
...
proc geometryChangeRequested*(self: gen_qwebenginepage_types.QWebEnginePage, geom: QRect): void =
  fcQWebEnginePage_geometryChangeRequested(self.h, geom.h)

type QWebEnginePagegeometryChangeRequestedSlot* = proc(geom: QRect)
...
proc featurePermissionRequested*(self: gen_qwebenginepage_types.QWebEnginePage, securityOrigin: QUrl, feature: cint): void =
  fcQWebEnginePage_featurePermissionRequested(self.h, securityOrigin.h, cint(feature))

type QWebEnginePagefeaturePermissionRequestedSlot* = proc(securityOrigin: QUrl, feature: cint)
proc miqt_exec_callback_QWebEnginePage_featurePermissionRequested(slot: int, securityOrigin: pointer, feature: cint) {.exportc.} =
  ...
  let slotval1 = QUrl(h: securityOrigin)
...
proc featurePermissionRequestCanceled*(self: gen_qwebenginepage_types.QWebEnginePage, securityOrigin: QUrl, feature: cint): void =
  fcQWebEnginePage_featurePermissionRequestCanceled(self.h, securityOrigin.h, cint(feature))

type QWebEnginePagefeaturePermissionRequestCanceledSlot* = proc(securityOrigin: QUrl, feature: cint)
...
proc fullScreenRequested*(self: gen_qwebenginepage_types.QWebEnginePage, fullScreenRequest: QWebEngineFullScreenRequest): void =
  fcQWebEnginePage_fullScreenRequested(self.h, fullScreenRequest.h)

type QWebEnginePagefullScreenRequestedSlot* = proc(fullScreenRequest: QWebEngineFullScreenRequest)
proc miqt_exec_callback_QWebEnginePage_fullScreenRequested(slot: int, fullScreenRequest: pointer) {.exportc.} =
  ...
  let slotval1 = QWebEngineFullScreenRequest(h: fullScreenRequest)
...
proc quotaRequested*(self: gen_qwebenginepage_types.QWebEnginePage, quotaRequest: QWebEngineQuotaRequest): void =
  fcQWebEnginePage_quotaRequested(self.h, quotaRequest.h)

type QWebEnginePagequotaRequestedSlot* = proc(quotaRequest: QWebEngineQuotaRequest)
proc miqt_exec_callback_QWebEnginePage_quotaRequested(slot: int, quotaRequest: pointer) {.exportc.} =
  ...
  let slotval1 = QWebEngineQuotaRequest(h: quotaRequest)
...
proc registerProtocolHandlerRequested*(self: gen_qwebenginepage_types.QWebEnginePage, request: QWebEngineRegisterProtocolHandlerRequest): void =
  fcQWebEnginePage_registerProtocolHandlerRequested(self.h, request.h)

type QWebEnginePageregisterProtocolHandlerRequestedSlot* = proc(request: QWebEngineRegisterProtocolHandlerRequest)
proc miqt_exec_callback_QWebEnginePage_registerProtocolHandlerRequested(slot: int, request: pointer) {.exportc.} =
  ...
  let slotval1 = QWebEngineRegisterProtocolHandlerRequest(h: request)
...
proc fileSystemAccessRequested*(self: gen_qwebenginepage_types.QWebEnginePage, request: QWebEngineFileSystemAccessRequest): void =
  fcQWebEnginePage_fileSystemAccessRequested(self.h, request.h)

type QWebEnginePagefileSystemAccessRequestedSlot* = proc(request: QWebEngineFileSystemAccessRequest)
proc miqt_exec_callback_QWebEnginePage_fileSystemAccessRequested(slot: int, request: pointer) {.exportc.} =
  ...
  let slotval1 = QWebEngineFileSystemAccessRequest(h: request)
...
proc selectClientCertificate*(self: gen_qwebenginepage_types.QWebEnginePage, clientCertSelection: QWebEngineClientCertificateSelection): void =
  fcQWebEnginePage_selectClientCertificate(self.h, clientCertSelection.h)

type QWebEnginePageselectClientCertificateSlot* = proc(clientCertSelection: QWebEngineClientCertificateSelection)
proc miqt_exec_callback_QWebEnginePage_selectClientCertificate(slot: int, clientCertSelection: pointer) {.exportc.} =
  ...
  let slotval1 = QWebEngineClientCertificateSelection(h: clientCertSelection)
...
proc authenticationRequired*(self: gen_qwebenginepage_types.QWebEnginePage, requestUrl: QUrl, authenticator: QAuthenticator): void =
  fcQWebEnginePage_authenticationRequired(self.h, requestUrl.h, authenticator.h)

type QWebEnginePageauthenticationRequiredSlot* = proc(requestUrl: QUrl, authenticator: QAuthenticator)
proc miqt_exec_callback_QWebEnginePage_authenticationRequired(slot: int, requestUrl: pointer, authenticator: pointer) {.exportc.} =
  ...
  let slotval1 = QUrl(h: requestUrl)

  let slotval2 = QAuthenticator(h: authenticator)
...
proc proxyAuthenticationRequired*(self: gen_qwebenginepage_types.QWebEnginePage, requestUrl: QUrl, authenticator: QAuthenticator, proxyHost: string): void =
...
type QWebEnginePageproxyAuthenticationRequiredSlot* = proc(requestUrl: QUrl, authenticator: QAuthenticator, proxyHost: string)
...
proc certificateError*(self: gen_qwebenginepage_types.QWebEnginePage, certificateError: QWebEngineCertificateError): void =
  fcQWebEnginePage_certificateError(self.h, certificateError.h)

type QWebEnginePagecertificateErrorSlot* = proc(certificateError: QWebEngineCertificateError)
proc miqt_exec_callback_QWebEnginePage_certificateError(slot: int, certificateError: pointer) {.exportc.} =
  ...
  let slotval1 = QWebEngineCertificateError(h: certificateError)
...
proc navigationRequested*(self: gen_qwebenginepage_types.QWebEnginePage, request: QWebEngineNavigationRequest): void =
  fcQWebEnginePage_navigationRequested(self.h, request.h)

type QWebEnginePagenavigationRequestedSlot* = proc(request: QWebEngineNavigationRequest)
proc miqt_exec_callback_QWebEnginePage_navigationRequested(slot: int, request: pointer) {.exportc.} =
  ...
  let slotval1 = QWebEngineNavigationRequest(h: request)
...
proc newWindowRequested*(self: gen_qwebenginepage_types.QWebEnginePage, request: QWebEngineNewWindowRequest): void =
  fcQWebEnginePage_newWindowRequested(self.h, request.h)

type QWebEnginePagenewWindowRequestedSlot* = proc(request: QWebEngineNewWindowRequest)
proc miqt_exec_callback_QWebEnginePage_newWindowRequested(slot: int, request: pointer) {.exportc.} =
  ...
  let slotval1 = QWebEngineNewWindowRequest(h: request)
...
proc urlChanged*(self: gen_qwebenginepage_types.QWebEnginePage, url: QUrl): void =
  fcQWebEnginePage_urlChanged(self.h, url.h)

type QWebEnginePageurlChangedSlot* = proc(url: QUrl)
...
proc iconUrlChanged*(self: gen_qwebenginepage_types.QWebEnginePage, url: QUrl): void =
  fcQWebEnginePage_iconUrlChanged(self.h, url.h)

type QWebEnginePageiconUrlChangedSlot* = proc(url: QUrl)
...
proc iconChanged*(self: gen_qwebenginepage_types.QWebEnginePage, icon: QIcon): void =
  fcQWebEnginePage_iconChanged(self.h, icon.h)

type QWebEnginePageiconChangedSlot* = proc(icon: QIcon)
...
proc scrollPositionChanged*(self: gen_qwebenginepage_types.QWebEnginePage, position: QPointF): void =
  fcQWebEnginePage_scrollPositionChanged(self.h, position.h)

type QWebEnginePagescrollPositionChangedSlot* = proc(position: QPointF)
proc miqt_exec_callback_QWebEnginePage_scrollPositionChanged(slot: int, position: pointer) {.exportc.} =
  ...
  let slotval1 = QPointF(h: position)
...
proc contentsSizeChanged*(self: gen_qwebenginepage_types.QWebEnginePage, size: QSizeF): void =
  fcQWebEnginePage_contentsSizeChanged(self.h, size.h)

type QWebEnginePagecontentsSizeChangedSlot* = proc(size: QSizeF)
...
proc findTextFinished*(self: gen_qwebenginepage_types.QWebEnginePage, resultVal: QWebEngineFindTextResult): void =
  fcQWebEnginePage_findTextFinished(self.h, resultVal.h)

type QWebEnginePagefindTextFinishedSlot* = proc(resultVal: QWebEngineFindTextResult)
proc miqt_exec_callback_QWebEnginePage_findTextFinished(slot: int, resultVal: pointer) {.exportc.} =
  ...
  let slotval1 = QWebEngineFindTextResult(h: resultVal)
...
proc download*(self: gen_qwebenginepage_types.QWebEnginePage, url: QUrl, filename: string): void =
  fcQWebEnginePage_download2(self.h, url.h, struct_miqt_string(data: filename, len: csize_t(len(filename))))

proc setHtml*(self: gen_qwebenginepage_types.QWebEnginePage, html: string, baseUrl: QUrl): void =
...
proc setContent*(self: gen_qwebenginepage_types.QWebEnginePage, data: seq[byte], mimeType: string, baseUrl: QUrl): void =
...
proc setWebChannel*(self: gen_qwebenginepage_types.QWebEnginePage, param1: QWebChannel, worldId: cuint): void =
...
proc printToPdf*(self: gen_qwebenginepage_types.QWebEnginePage, filePath: string, layout: QPageLayout): void =
  fcQWebEnginePage_printToPdf2(self.h, struct_miqt_string(data: filePath, len: csize_t(len(filePath))), layout.h)

proc printToPdf*(self: gen_qwebenginepage_types.QWebEnginePage, filePath: string, layout: QPageLayout, ranges: QPageRanges): void =
...
proc miqt_exec_callback_QWebEnginePage_triggerAction(self: ptr cQWebEnginePage, slot: int, action: cint, checked: bool): void {.exportc: "miqt_exec_callback_QWebEnginePage_triggerAction ".} =
  ...
  nimfunc[](slotval1, slotval2)
proc QWebEnginePageevent*(self: gen_qwebenginepage_types.QWebEnginePage, param1: QEvent): bool =
  fQWebEnginePage_virtualbase_event(self.h, param1.h)

type QWebEnginePageeventProc* = proc(param1: QEvent): bool
...
proc miqt_exec_callback_QWebEnginePage_event(self: ptr cQWebEnginePage, slot: int, param1: pointer): bool {.exportc: "miqt_exec_callback_QWebEnginePage_event ".} =
  ...
  virtualReturn
proc QWebEnginePagecreateWindow*(self: gen_qwebenginepage_types.QWebEnginePage, typeVal: cint): QWebEnginePage =
  QWebEnginePage(h: fQWebEnginePage_virtualbase_createWindow(self.h, cint(typeVal)))

type QWebEnginePagecreateWindowProc* = proc(typeVal: cint): QWebEnginePage
...
proc QWebEnginePagejavaScriptAlert*(self: gen_qwebenginepage_types.QWebEnginePage, securityOrigin: QUrl, msg: string): void =
  fQWebEnginePage_virtualbase_javaScriptAlert(self.h, securityOrigin.h, struct_miqt_string(data: msg, len: csize_t(len(msg))))

type QWebEnginePagejavaScriptAlertProc* = proc(securityOrigin: QUrl, msg: string): void
...
proc miqt_exec_callback_QWebEnginePage_javaScriptAlert(self: ptr cQWebEnginePage, slot: int, securityOrigin: pointer, msg: struct_miqt_string): void {.exportc: "miqt_exec_callback_QWebEnginePage_javaScriptAlert ".} =
  ...
  nimfunc[](slotval1, slotval2)
proc QWebEnginePagejavaScriptConfirm*(self: gen_qwebenginepage_types.QWebEnginePage, securityOrigin: QUrl, msg: string): bool =
  fQWebEnginePage_virtualbase_javaScriptConfirm(self.h, securityOrigin.h, struct_miqt_string(data: msg, len: csize_t(len(msg))))

type QWebEnginePagejavaScriptConfirmProc* = proc(securityOrigin: QUrl, msg: string): bool
...
proc QWebEnginePageacceptNavigationRequest*(self: gen_qwebenginepage_types.QWebEnginePage, url: QUrl, typeVal: cint, isMainFrame: bool): bool =
  fQWebEnginePage_virtualbase_acceptNavigationRequest(self.h, url.h, cint(typeVal), isMainFrame)

type QWebEnginePageacceptNavigationRequestProc* = proc(url: QUrl, typeVal: cint, isMainFrame: bool): bool
...
proc miqt_exec_callback_QWebEnginePage_acceptNavigationRequest(self: ptr cQWebEnginePage, slot: int, url: pointer, typeVal: cint, isMainFrame: bool): bool {.exportc: "miqt_exec_callback_QWebEnginePage_acceptNavigationRequest ".} =
  ...
  virtualReturn
proc QWebEnginePageeventFilter*(self: gen_qwebenginepage_types.QWebEnginePage, watched: QObject, event: QEvent): bool =
  fQWebEnginePage_virtualbase_eventFilter(self.h, watched.h, event.h)

type QWebEnginePageeventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QWebEnginePage_eventFilter(self: ptr cQWebEnginePage, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QWebEnginePage_eventFilter ".} =
  ...
  virtualReturn
proc QWebEnginePagetimerEvent*(self: gen_qwebenginepage_types.QWebEnginePage, event: QTimerEvent): void =
  fQWebEnginePage_virtualbase_timerEvent(self.h, event.h)

type QWebEnginePagetimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QWebEnginePage_timerEvent(self: ptr cQWebEnginePage, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QWebEnginePage_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QWebEnginePagechildEvent*(self: gen_qwebenginepage_types.QWebEnginePage, event: QChildEvent): void =
  fQWebEnginePage_virtualbase_childEvent(self.h, event.h)

type QWebEnginePagechildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QWebEnginePage_childEvent(self: ptr cQWebEnginePage, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QWebEnginePage_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QWebEnginePagecustomEvent*(self: gen_qwebenginepage_types.QWebEnginePage, event: QEvent): void =
  fQWebEnginePage_virtualbase_customEvent(self.h, event.h)

type QWebEnginePagecustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QWebEnginePage_customEvent(self: ptr cQWebEnginePage, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QWebEnginePage_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QWebEnginePageconnectNotify*(self: gen_qwebenginepage_types.QWebEnginePage, signal: QMetaMethod): void =
  fQWebEnginePage_virtualbase_connectNotify(self.h, signal.h)

type QWebEnginePageconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QWebEnginePage_connectNotify(self: ptr cQWebEnginePage, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QWebEnginePage_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QWebEnginePagedisconnectNotify*(self: gen_qwebenginepage_types.QWebEnginePage, signal: QMetaMethod): void =
  fQWebEnginePage_virtualbase_disconnectNotify(self.h, signal.h)

type QWebEnginePagedisconnectNotifyProc* = proc(signal: QMetaMethod): void
