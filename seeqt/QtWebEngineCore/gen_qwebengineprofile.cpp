...
QMetaObject* QWebEngineProfile_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQWebEngineProfile*)(self) )->QWebEngineProfile::metaObject();

}

void* QWebEngineProfile_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQWebEngineProfile*)(self) )->QWebEngineProfile::qt_metacast(param1);

}

int QWebEngineProfile_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQWebEngineProfile*)(self) )->QWebEngineProfile::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
