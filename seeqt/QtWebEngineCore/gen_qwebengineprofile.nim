...
proc create*(T: type gen_qwebengineprofile_types.QWebEngineProfile, parent: QObject): gen_qwebengineprofile_types.QWebEngineProfile =
  gen_qwebengineprofile_types.QWebEngineProfile.init(fcQWebEngineProfile_new3(parent.h))

proc create*(T: type gen_qwebengineprofile_types.QWebEngineProfile, name: string, parent: QObject): gen_qwebengineprofile_types.QWebEngineProfile =
...
proc metaObject*(self: gen_qwebengineprofile_types.QWebEngineProfile, ): QMetaObject =
  QMetaObject(h: fcQWebEngineProfile_metaObject(self.h))
...
proc cookieStore*(self: gen_qwebengineprofile_types.QWebEngineProfile, ): QWebEngineCookieStore =
  QWebEngineCookieStore(h: fcQWebEngineProfile_cookieStore(self.h))

proc setUrlRequestInterceptor*(self: gen_qwebengineprofile_types.QWebEngineProfile, interceptor: QWebEngineUrlRequestInterceptor): void =
...
proc clearVisitedLinks*(self: gen_qwebengineprofile_types.QWebEngineProfile, urls: seq[QUrl]): void =
...
proc visitedLinksContainsUrl*(self: gen_qwebengineprofile_types.QWebEngineProfile, url: QUrl): bool =
  fcQWebEngineProfile_visitedLinksContainsUrl(self.h, url.h)

proc settings*(self: gen_qwebengineprofile_types.QWebEngineProfile, ): QWebEngineSettings =
  QWebEngineSettings(h: fcQWebEngineProfile_settings(self.h))

proc scripts*(self: gen_qwebengineprofile_types.QWebEngineProfile, ): QWebEngineScriptCollection =
  QWebEngineScriptCollection(h: fcQWebEngineProfile_scripts(self.h))

proc urlSchemeHandler*(self: gen_qwebengineprofile_types.QWebEngineProfile, param1: seq[byte]): QWebEngineUrlSchemeHandler =
  QWebEngineUrlSchemeHandler(h: fcQWebEngineProfile_urlSchemeHandler(self.h, struct_miqt_string(data: cast[cstring](if len(param1) == 0: nil else: unsafeAddr param1[0]), len: csize_t(len(param1)))))

proc installUrlSchemeHandler*(self: gen_qwebengineprofile_types.QWebEngineProfile, scheme: seq[byte], param2: QWebEngineUrlSchemeHandler): void =
...
proc removeUrlSchemeHandler*(self: gen_qwebengineprofile_types.QWebEngineProfile, param1: QWebEngineUrlSchemeHandler): void =
...
proc clientCertificateStore*(self: gen_qwebengineprofile_types.QWebEngineProfile, ): QWebEngineClientCertificateStore =
  QWebEngineClientCertificateStore(h: fcQWebEngineProfile_clientCertificateStore(self.h))

proc defaultProfile*(_: type gen_qwebengineprofile_types.QWebEngineProfile, ): QWebEngineProfile =
  QWebEngineProfile(h: fcQWebEngineProfile_defaultProfile())

proc downloadRequested*(self: gen_qwebengineprofile_types.QWebEngineProfile, download: QWebEngineDownloadRequest): void =
  fcQWebEngineProfile_downloadRequested(self.h, download.h)

type QWebEngineProfiledownloadRequestedSlot* = proc(download: QWebEngineDownloadRequest)
proc miqt_exec_callback_QWebEngineProfile_downloadRequested(slot: int, download: pointer) {.exportc.} =
  ...
  let slotval1 = QWebEngineDownloadRequest(h: download)
...
proc miqt_exec_callback_QWebEngineProfile_metacall(self: ptr cQWebEngineProfile, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QWebEngineProfile_metacall ".} =
  ...
  virtualReturn
proc QWebEngineProfileevent*(self: gen_qwebengineprofile_types.QWebEngineProfile, event: QEvent): bool =
  fQWebEngineProfile_virtualbase_event(self.h, event.h)

type QWebEngineProfileeventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QWebEngineProfile_event(self: ptr cQWebEngineProfile, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QWebEngineProfile_event ".} =
  ...
  virtualReturn
proc QWebEngineProfileeventFilter*(self: gen_qwebengineprofile_types.QWebEngineProfile, watched: QObject, event: QEvent): bool =
  fQWebEngineProfile_virtualbase_eventFilter(self.h, watched.h, event.h)

type QWebEngineProfileeventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QWebEngineProfile_eventFilter(self: ptr cQWebEngineProfile, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QWebEngineProfile_eventFilter ".} =
  ...
  virtualReturn
proc QWebEngineProfiletimerEvent*(self: gen_qwebengineprofile_types.QWebEngineProfile, event: QTimerEvent): void =
  fQWebEngineProfile_virtualbase_timerEvent(self.h, event.h)

type QWebEngineProfiletimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QWebEngineProfile_timerEvent(self: ptr cQWebEngineProfile, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QWebEngineProfile_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QWebEngineProfilechildEvent*(self: gen_qwebengineprofile_types.QWebEngineProfile, event: QChildEvent): void =
  fQWebEngineProfile_virtualbase_childEvent(self.h, event.h)

type QWebEngineProfilechildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QWebEngineProfile_childEvent(self: ptr cQWebEngineProfile, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QWebEngineProfile_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QWebEngineProfilecustomEvent*(self: gen_qwebengineprofile_types.QWebEngineProfile, event: QEvent): void =
  fQWebEngineProfile_virtualbase_customEvent(self.h, event.h)

type QWebEngineProfilecustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QWebEngineProfile_customEvent(self: ptr cQWebEngineProfile, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QWebEngineProfile_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QWebEngineProfileconnectNotify*(self: gen_qwebengineprofile_types.QWebEngineProfile, signal: QMetaMethod): void =
  fQWebEngineProfile_virtualbase_connectNotify(self.h, signal.h)

type QWebEngineProfileconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QWebEngineProfile_connectNotify(self: ptr cQWebEngineProfile, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QWebEngineProfile_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QWebEngineProfiledisconnectNotify*(self: gen_qwebengineprofile_types.QWebEngineProfile, signal: QMetaMethod): void =
  fQWebEngineProfile_virtualbase_disconnectNotify(self.h, signal.h)

type QWebEngineProfiledisconnectNotifyProc* = proc(signal: QMetaMethod): void
