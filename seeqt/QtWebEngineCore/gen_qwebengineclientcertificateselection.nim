...
func init*(T: type gen_qwebengineclientcertificateselection_types.QWebEngineClientCertificateSelection, h: ptr cQWebEngineClientCertificateSelection): gen_qwebengineclientcertificateselection_types.QWebEngineClientCertificateSelection =
  T(h: h)
proc create*(T: type gen_qwebengineclientcertificateselection_types.QWebEngineClientCertificateSelection, param1: QWebEngineClientCertificateSelection): gen_qwebengineclientcertificateselection_types.QWebEngineClientCertificateSelection =
...
proc operatorAssign*(self: gen_qwebengineclientcertificateselection_types.QWebEngineClientCertificateSelection, param1: QWebEngineClientCertificateSelection): void =
  fcQWebEngineClientCertificateSelection_operatorAssign(self.h, param1.h)

proc host*(self: gen_qwebengineclientcertificateselection_types.QWebEngineClientCertificateSelection, ): QUrl =
  QUrl(h: fcQWebEngineClientCertificateSelection_host(self.h))

proc select*(self: gen_qwebengineclientcertificateselection_types.QWebEngineClientCertificateSelection, certificate: QSslCertificate): void =
...
proc certificates*(self: gen_qwebengineclientcertificateselection_types.QWebEngineClientCertificateSelection, ): seq[QSslCertificate] =
