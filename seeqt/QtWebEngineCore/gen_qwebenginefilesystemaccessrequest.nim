...
func init*(T: type gen_qwebenginefilesystemaccessrequest_types.QWebEngineFileSystemAccessRequest, h: ptr cQWebEngineFileSystemAccessRequest): gen_qwebenginefilesystemaccessrequest_types.QWebEngineFileSystemAccessRequest =
  T(h: h)
proc create*(T: type gen_qwebenginefilesystemaccessrequest_types.QWebEngineFileSystemAccessRequest, other: QWebEngineFileSystemAccessRequest): gen_qwebenginefilesystemaccessrequest_types.QWebEngineFileSystemAccessRequest =
...
proc operatorAssign*(self: gen_qwebenginefilesystemaccessrequest_types.QWebEngineFileSystemAccessRequest, other: QWebEngineFileSystemAccessRequest): void =
  fcQWebEngineFileSystemAccessRequest_operatorAssign(self.h, other.h)

proc swap*(self: gen_qwebenginefilesystemaccessrequest_types.QWebEngineFileSystemAccessRequest, other: QWebEngineFileSystemAccessRequest): void =
...
proc origin*(self: gen_qwebenginefilesystemaccessrequest_types.QWebEngineFileSystemAccessRequest, ): QUrl =
  QUrl(h: fcQWebEngineFileSystemAccessRequest_origin(self.h))

proc filePath*(self: gen_qwebenginefilesystemaccessrequest_types.QWebEngineFileSystemAccessRequest, ): QUrl =
  QUrl(h: fcQWebEngineFileSystemAccessRequest_filePath(self.h))
