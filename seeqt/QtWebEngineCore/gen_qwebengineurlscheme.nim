...
proc create*(T: type gen_qwebengineurlscheme_types.QWebEngineUrlScheme, that: QWebEngineUrlScheme): gen_qwebengineurlscheme_types.QWebEngineUrlScheme =
  gen_qwebengineurlscheme_types.QWebEngineUrlScheme.init(fcQWebEngineUrlScheme_new3(that.h))

proc operatorAssign*(self: gen_qwebengineurlscheme_types.QWebEngineUrlScheme, that: QWebEngineUrlScheme): void =
  fcQWebEngineUrlScheme_operatorAssign(self.h, that.h)

proc operatorEqual*(self: gen_qwebengineurlscheme_types.QWebEngineUrlScheme, that: QWebEngineUrlScheme): bool =
  fcQWebEngineUrlScheme_operatorEqual(self.h, that.h)

proc operatorNotEqual*(self: gen_qwebengineurlscheme_types.QWebEngineUrlScheme, that: QWebEngineUrlScheme): bool =
...
proc registerScheme*(_: type gen_qwebengineurlscheme_types.QWebEngineUrlScheme, scheme: QWebEngineUrlScheme): void =
  fcQWebEngineUrlScheme_registerScheme(scheme.h)

proc schemeByName*(_: type gen_qwebengineurlscheme_types.QWebEngineUrlScheme, name: seq[byte]): QWebEngineUrlScheme =
