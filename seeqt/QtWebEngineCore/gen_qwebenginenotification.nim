...
func init*(T: type gen_qwebenginenotification_types.QWebEngineNotification, h: ptr cQWebEngineNotification): gen_qwebenginenotification_types.QWebEngineNotification =
  T(h: h)
proc metaObject*(self: gen_qwebenginenotification_types.QWebEngineNotification, ): QMetaObject =
  QMetaObject(h: fcQWebEngineNotification_metaObject(self.h))
...
proc matches*(self: gen_qwebenginenotification_types.QWebEngineNotification, other: QWebEngineNotification): bool =
  fcQWebEngineNotification_matches(self.h, other.h)

proc origin*(self: gen_qwebenginenotification_types.QWebEngineNotification, ): QUrl =
  QUrl(h: fcQWebEngineNotification_origin(self.h))

proc icon*(self: gen_qwebenginenotification_types.QWebEngineNotification, ): QImage =
  QImage(h: fcQWebEngineNotification_icon(self.h))
