...
proc fcQWebEngineCookieStore_trUtf82(s: cstring, c: cstring): struct_miqt_string {.importc: "QWebEngineCookieStore_trUtf82".}
...
func init*(T: type gen_qwebenginecookiestore_types.QWebEngineCookieStore, h: ptr cQWebEngineCookieStore): gen_qwebenginecookiestore_types.QWebEngineCookieStore =
  T(h: h)
proc metaObject*(self: gen_qwebenginecookiestore_types.QWebEngineCookieStore, ): QMetaObject =
  QMetaObject(h: fcQWebEngineCookieStore_metaObject(self.h))
...
proc trUtf8*(_: type gen_qwebenginecookiestore_types.QWebEngineCookieStore, s: cstring): string =
  let v_ms = fcQWebEngineCookieStore_trUtf8(s)
  let vx_ret = string.fromBytes(toOpenArrayByte(v_ms.data, 0, int(v_ms.len)-1))
  c_free(v_ms.data)
  vx_ret

proc setCookie*(self: gen_qwebenginecookiestore_types.QWebEngineCookieStore, cookie: QNetworkCookie): void =
  fcQWebEngineCookieStore_setCookie(self.h, cookie.h)

proc deleteCookie*(self: gen_qwebenginecookiestore_types.QWebEngineCookieStore, cookie: QNetworkCookie): void =
...
proc cookieAdded*(self: gen_qwebenginecookiestore_types.QWebEngineCookieStore, cookie: QNetworkCookie): void =
  fcQWebEngineCookieStore_cookieAdded(self.h, cookie.h)

type QWebEngineCookieStorecookieAddedSlot* = proc(cookie: QNetworkCookie)
...
proc cookieRemoved*(self: gen_qwebenginecookiestore_types.QWebEngineCookieStore, cookie: QNetworkCookie): void =
  fcQWebEngineCookieStore_cookieRemoved(self.h, cookie.h)

type QWebEngineCookieStorecookieRemovedSlot* = proc(cookie: QNetworkCookie)
...
proc trUtf8*(_: type gen_qwebenginecookiestore_types.QWebEngineCookieStore, s: cstring, c: cstring): string =
  let v_ms = fcQWebEngineCookieStore_trUtf82(s, c)
  let vx_ret = string.fromBytes(toOpenArrayByte(v_ms.data, 0, int(v_ms.len)-1))
  c_free(v_ms.data)
  vx_ret

proc trUtf8*(_: type gen_qwebenginecookiestore_types.QWebEngineCookieStore, s: cstring, c: cstring, n: cint): string =
  let v_ms = fcQWebEngineCookieStore_trUtf83(s, c, n)
  let vx_ret = string.fromBytes(toOpenArrayByte(v_ms.data, 0, int(v_ms.len)-1))
  c_free(v_ms.data)
  vx_ret

proc setCookie*(self: gen_qwebenginecookiestore_types.QWebEngineCookieStore, cookie: QNetworkCookie, origin: QUrl): void =
  fcQWebEngineCookieStore_setCookie2(self.h, cookie.h, origin.h)

proc deleteCookie*(self: gen_qwebenginecookiestore_types.QWebEngineCookieStore, cookie: QNetworkCookie, origin: QUrl): void =
...
func init*(T: type gen_qwebenginecookiestore_types.QWebEngineCookieStoreFilterRequest, h: ptr cQWebEngineCookieStoreFilterRequest): gen_qwebenginecookiestore_types.QWebEngineCookieStoreFilterRequest =
  T(h: h)
proc create*(T: type gen_qwebenginecookiestore_types.QWebEngineCookieStoreFilterRequest, param1: QWebEngineCookieStoreFilterRequest): gen_qwebenginecookiestore_types.QWebEngineCookieStoreFilterRequest =
...
proc operatorAssign*(self: gen_qwebenginecookiestore_types.QWebEngineCookieStoreFilterRequest, param1: QWebEngineCookieStoreFilterRequest): void =
