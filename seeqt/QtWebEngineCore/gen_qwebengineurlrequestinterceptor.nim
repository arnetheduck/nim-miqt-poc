...
const cflags = gorge("pkg-config --cflags Qt5WebEngineCore")
...
proc create*(T: type gen_qwebengineurlrequestinterceptor_types.QWebEngineUrlRequestInterceptor, p: QObject): gen_qwebengineurlrequestinterceptor_types.QWebEngineUrlRequestInterceptor =
...
proc metaObject*(self: gen_qwebengineurlrequestinterceptor_types.QWebEngineUrlRequestInterceptor, ): QMetaObject =
  QMetaObject(h: fcQWebEngineUrlRequestInterceptor_metaObject(self.h))
...
proc interceptRequest*(self: gen_qwebengineurlrequestinterceptor_types.QWebEngineUrlRequestInterceptor, info: QWebEngineUrlRequestInfo): void =
...
proc miqt_exec_callback_QWebEngineUrlRequestInterceptor_metacall(self: ptr cQWebEngineUrlRequestInterceptor, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QWebEngineUrlRequestInterceptor_metacall ".} =
  ...
  virtualReturn
type QWebEngineUrlRequestInterceptorinterceptRequestProc* = proc(info: QWebEngineUrlRequestInfo): void
...
proc miqt_exec_callback_QWebEngineUrlRequestInterceptor_interceptRequest(self: ptr cQWebEngineUrlRequestInterceptor, slot: int, info: pointer): void {.exportc: "miqt_exec_callback_QWebEngineUrlRequestInterceptor_interceptRequest ".} =
  ...
  let slotval1 = QWebEngineUrlRequestInfo(h: info)


  nimfunc[](slotval1)
proc QWebEngineUrlRequestInterceptorevent*(self: gen_qwebengineurlrequestinterceptor_types.QWebEngineUrlRequestInterceptor, event: QEvent): bool =
  fQWebEngineUrlRequestInterceptor_virtualbase_event(self.h, event.h)

type QWebEngineUrlRequestInterceptoreventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QWebEngineUrlRequestInterceptor_event(self: ptr cQWebEngineUrlRequestInterceptor, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QWebEngineUrlRequestInterceptor_event ".} =
  ...
  virtualReturn
proc QWebEngineUrlRequestInterceptoreventFilter*(self: gen_qwebengineurlrequestinterceptor_types.QWebEngineUrlRequestInterceptor, watched: QObject, event: QEvent): bool =
  fQWebEngineUrlRequestInterceptor_virtualbase_eventFilter(self.h, watched.h, event.h)

type QWebEngineUrlRequestInterceptoreventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QWebEngineUrlRequestInterceptor_eventFilter(self: ptr cQWebEngineUrlRequestInterceptor, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QWebEngineUrlRequestInterceptor_eventFilter ".} =
  ...
  virtualReturn
proc QWebEngineUrlRequestInterceptortimerEvent*(self: gen_qwebengineurlrequestinterceptor_types.QWebEngineUrlRequestInterceptor, event: QTimerEvent): void =
  fQWebEngineUrlRequestInterceptor_virtualbase_timerEvent(self.h, event.h)

type QWebEngineUrlRequestInterceptortimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QWebEngineUrlRequestInterceptor_timerEvent(self: ptr cQWebEngineUrlRequestInterceptor, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QWebEngineUrlRequestInterceptor_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QWebEngineUrlRequestInterceptorchildEvent*(self: gen_qwebengineurlrequestinterceptor_types.QWebEngineUrlRequestInterceptor, event: QChildEvent): void =
  fQWebEngineUrlRequestInterceptor_virtualbase_childEvent(self.h, event.h)

type QWebEngineUrlRequestInterceptorchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QWebEngineUrlRequestInterceptor_childEvent(self: ptr cQWebEngineUrlRequestInterceptor, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QWebEngineUrlRequestInterceptor_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QWebEngineUrlRequestInterceptorcustomEvent*(self: gen_qwebengineurlrequestinterceptor_types.QWebEngineUrlRequestInterceptor, event: QEvent): void =
  fQWebEngineUrlRequestInterceptor_virtualbase_customEvent(self.h, event.h)

type QWebEngineUrlRequestInterceptorcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QWebEngineUrlRequestInterceptor_customEvent(self: ptr cQWebEngineUrlRequestInterceptor, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QWebEngineUrlRequestInterceptor_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QWebEngineUrlRequestInterceptorconnectNotify*(self: gen_qwebengineurlrequestinterceptor_types.QWebEngineUrlRequestInterceptor, signal: QMetaMethod): void =
  fQWebEngineUrlRequestInterceptor_virtualbase_connectNotify(self.h, signal.h)

type QWebEngineUrlRequestInterceptorconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QWebEngineUrlRequestInterceptor_connectNotify(self: ptr cQWebEngineUrlRequestInterceptor, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QWebEngineUrlRequestInterceptor_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QWebEngineUrlRequestInterceptordisconnectNotify*(self: gen_qwebengineurlrequestinterceptor_types.QWebEngineUrlRequestInterceptor, signal: QMetaMethod): void =
  fQWebEngineUrlRequestInterceptor_virtualbase_disconnectNotify(self.h, signal.h)

type QWebEngineUrlRequestInterceptordisconnectNotifyProc* = proc(signal: QMetaMethod): void
