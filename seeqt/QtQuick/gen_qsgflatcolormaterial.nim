...
proc createShader*(self: gen_qsgflatcolormaterial_types.QSGFlatColorMaterial, ): QSGMaterialShader =
  QSGMaterialShader(h: fcQSGFlatColorMaterial_createShader(self.h))
...
proc miqt_exec_callback_QSGFlatColorMaterial_type(self: ptr cQSGFlatColorMaterial, slot: int): pointer {.exportc: "miqt_exec_callback_QSGFlatColorMaterial_type ".} =
  ...
  virtualReturn.h
proc QSGFlatColorMaterialcreateShader*(self: gen_qsgflatcolormaterial_types.QSGFlatColorMaterial, ): QSGMaterialShader =
  QSGMaterialShader(h: fQSGFlatColorMaterial_virtualbase_createShader(self.h))

type QSGFlatColorMaterialcreateShaderProc* = proc(): QSGMaterialShader
