...
proc fQSGFlatColorMaterial_virtualbase_createShader(self: pointer, renderMode: cint): pointer{.importc: "QSGFlatColorMaterial_virtualbase_createShader".}
...
proc typeX*(self: gen_qsgflatcolormaterial_types.QSGFlatColorMaterial, ): QSGMaterialType =
  QSGMaterialType(h: fcQSGFlatColorMaterial_typeX(self.h))

proc createShader*(self: gen_qsgflatcolormaterial_types.QSGFlatColorMaterial, renderMode: cint): QSGMaterialShader =
  QSGMaterialShader(h: fcQSGFlatColorMaterial_createShader(self.h, cint(renderMode)))

proc setColor*(self: gen_qsgflatcolormaterial_types.QSGFlatColorMaterial, color: QColor): void =
  fcQSGFlatColorMaterial_setColor(self.h, color.h)

proc color*(self: gen_qsgflatcolormaterial_types.QSGFlatColorMaterial, ): QColor =
  QColor(h: fcQSGFlatColorMaterial_color(self.h))

proc compare*(self: gen_qsgflatcolormaterial_types.QSGFlatColorMaterial, other: QSGMaterial): cint =
  fcQSGFlatColorMaterial_compare(self.h, other.h)

proc QSGFlatColorMaterialtypeX*(self: gen_qsgflatcolormaterial_types.QSGFlatColorMaterial, ): QSGMaterialType =
  QSGMaterialType(h: fQSGFlatColorMaterial_virtualbase_type(self.h))

type QSGFlatColorMaterialtypeXProc* = proc(): QSGMaterialType
...
proc miqt_exec_callback_QSGFlatColorMaterial_type(self: ptr cQSGFlatColorMaterial, slot: int): pointer {.exportc: "miqt_exec_callback_QSGFlatColorMaterial_type ".} =
  ...
  virtualReturn.h
proc QSGFlatColorMaterialcreateShader*(self: gen_qsgflatcolormaterial_types.QSGFlatColorMaterial, renderMode: cint): QSGMaterialShader =
  QSGMaterialShader(h: fQSGFlatColorMaterial_virtualbase_createShader(self.h, cint(renderMode)))

type QSGFlatColorMaterialcreateShaderProc* = proc(renderMode: cint): QSGMaterialShader
...
proc miqt_exec_callback_QSGFlatColorMaterial_createShader(self: ptr cQSGFlatColorMaterial, slot: int, renderMode: cint): pointer {.exportc: "miqt_exec_callback_QSGFlatColorMaterial_createShader ".} =
  ...
  virtualReturn.h
proc QSGFlatColorMaterialcompare*(self: gen_qsgflatcolormaterial_types.QSGFlatColorMaterial, other: QSGMaterial): cint =
  fQSGFlatColorMaterial_virtualbase_compare(self.h, other.h)

type QSGFlatColorMaterialcompareProc* = proc(other: QSGMaterial): cint
