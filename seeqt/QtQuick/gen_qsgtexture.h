...
struct QSGTexture_VTable {
	...
	QRhiTexture* (*rhiTexture)(struct QSGTexture_VTable* vtbl, const QSGTexture* self);
...
struct QSGDynamicTexture_VTable {
	...
	QRhiTexture* (*rhiTexture)(struct QSGDynamicTexture_VTable* vtbl, const QSGDynamicTexture* self);
