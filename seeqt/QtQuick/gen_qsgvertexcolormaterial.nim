...
proc miqt_exec_callback_QSGVertexColorMaterial_type(self: ptr cQSGVertexColorMaterial, slot: int): pointer {.exportc: "miqt_exec_callback_QSGVertexColorMaterial_type ".} =
  ...
  virtualReturn.h
proc QSGVertexColorMaterialcreateShader*(self: gen_qsgvertexcolormaterial_types.QSGVertexColorMaterial, ): QSGMaterialShader =
  QSGMaterialShader(h: fQSGVertexColorMaterial_virtualbase_createShader(self.h))

type QSGVertexColorMaterialcreateShaderProc* = proc(): QSGMaterialShader
