...
proc fQSGVertexColorMaterial_virtualbase_createShader(self: pointer, renderMode: cint): pointer{.importc: "QSGVertexColorMaterial_virtualbase_createShader".}
...
proc compare*(self: gen_qsgvertexcolormaterial_types.QSGVertexColorMaterial, other: QSGMaterial): cint =
  fcQSGVertexColorMaterial_compare(self.h, other.h)

proc QSGVertexColorMaterialcompare*(self: gen_qsgvertexcolormaterial_types.QSGVertexColorMaterial, other: QSGMaterial): cint =
  fQSGVertexColorMaterial_virtualbase_compare(self.h, other.h)

type QSGVertexColorMaterialcompareProc* = proc(other: QSGMaterial): cint
...
proc miqt_exec_callback_QSGVertexColorMaterial_compare(self: ptr cQSGVertexColorMaterial, slot: int, other: pointer): cint {.exportc: "miqt_exec_callback_QSGVertexColorMaterial_compare ".} =
  ...
  virtualReturn
proc QSGVertexColorMaterialtypeX*(self: gen_qsgvertexcolormaterial_types.QSGVertexColorMaterial, ): QSGMaterialType =
  QSGMaterialType(h: fQSGVertexColorMaterial_virtualbase_type(self.h))

type QSGVertexColorMaterialtypeXProc* = proc(): QSGMaterialType
...
proc miqt_exec_callback_QSGVertexColorMaterial_type(self: ptr cQSGVertexColorMaterial, slot: int): pointer {.exportc: "miqt_exec_callback_QSGVertexColorMaterial_type ".} =
  ...
  virtualReturn.h
proc QSGVertexColorMaterialcreateShader*(self: gen_qsgvertexcolormaterial_types.QSGVertexColorMaterial, renderMode: cint): QSGMaterialShader =
  QSGMaterialShader(h: fQSGVertexColorMaterial_virtualbase_createShader(self.h, cint(renderMode)))

type QSGVertexColorMaterialcreateShaderProc* = proc(renderMode: cint): QSGMaterialShader
...
proc miqt_exec_callback_QSGVertexColorMaterial_createShader(self: ptr cQSGVertexColorMaterial, slot: int, renderMode: cint): pointer {.exportc: "miqt_exec_callback_QSGVertexColorMaterial_createShader ".} =
