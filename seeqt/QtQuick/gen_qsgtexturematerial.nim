...
proc createShader*(self: gen_qsgtexturematerial_types.QSGOpaqueTextureMaterial, ): QSGMaterialShader =
  QSGMaterialShader(h: fcQSGOpaqueTextureMaterial_createShader(self.h))
...
proc miqt_exec_callback_QSGOpaqueTextureMaterial_type(self: ptr cQSGOpaqueTextureMaterial, slot: int): pointer {.exportc: "miqt_exec_callback_QSGOpaqueTextureMaterial_type ".} =
  ...
  virtualReturn.h
proc QSGOpaqueTextureMaterialcreateShader*(self: gen_qsgtexturematerial_types.QSGOpaqueTextureMaterial, ): QSGMaterialShader =
  QSGMaterialShader(h: fQSGOpaqueTextureMaterial_virtualbase_createShader(self.h))

type QSGOpaqueTextureMaterialcreateShaderProc* = proc(): QSGMaterialShader
...
proc createShader*(self: gen_qsgtexturematerial_types.QSGTextureMaterial, ): QSGMaterialShader =
  QSGMaterialShader(h: fcQSGTextureMaterial_createShader(self.h))
