...
proc fQSGOpaqueTextureMaterial_virtualbase_createShader(self: pointer, renderMode: cint): pointer{.importc: "QSGOpaqueTextureMaterial_virtualbase_createShader".}
...
proc typeX*(self: gen_qsgtexturematerial_types.QSGOpaqueTextureMaterial, ): QSGMaterialType =
  QSGMaterialType(h: fcQSGOpaqueTextureMaterial_typeX(self.h))

proc createShader*(self: gen_qsgtexturematerial_types.QSGOpaqueTextureMaterial, renderMode: cint): QSGMaterialShader =
  QSGMaterialShader(h: fcQSGOpaqueTextureMaterial_createShader(self.h, cint(renderMode)))

proc compare*(self: gen_qsgtexturematerial_types.QSGOpaqueTextureMaterial, other: QSGMaterial): cint =
  fcQSGOpaqueTextureMaterial_compare(self.h, other.h)

proc setTexture*(self: gen_qsgtexturematerial_types.QSGOpaqueTextureMaterial, texture: QSGTexture): void =
  fcQSGOpaqueTextureMaterial_setTexture(self.h, texture.h)

proc texture*(self: gen_qsgtexturematerial_types.QSGOpaqueTextureMaterial, ): QSGTexture =
  QSGTexture(h: fcQSGOpaqueTextureMaterial_texture(self.h))
...
proc QSGOpaqueTextureMaterialtypeX*(self: gen_qsgtexturematerial_types.QSGOpaqueTextureMaterial, ): QSGMaterialType =
  QSGMaterialType(h: fQSGOpaqueTextureMaterial_virtualbase_type(self.h))

type QSGOpaqueTextureMaterialtypeXProc* = proc(): QSGMaterialType
...
proc miqt_exec_callback_QSGOpaqueTextureMaterial_type(self: ptr cQSGOpaqueTextureMaterial, slot: int): pointer {.exportc: "miqt_exec_callback_QSGOpaqueTextureMaterial_type ".} =
  ...
  virtualReturn.h
proc QSGOpaqueTextureMaterialcreateShader*(self: gen_qsgtexturematerial_types.QSGOpaqueTextureMaterial, renderMode: cint): QSGMaterialShader =
  QSGMaterialShader(h: fQSGOpaqueTextureMaterial_virtualbase_createShader(self.h, cint(renderMode)))

type QSGOpaqueTextureMaterialcreateShaderProc* = proc(renderMode: cint): QSGMaterialShader
...
proc miqt_exec_callback_QSGOpaqueTextureMaterial_createShader(self: ptr cQSGOpaqueTextureMaterial, slot: int, renderMode: cint): pointer {.exportc: "miqt_exec_callback_QSGOpaqueTextureMaterial_createShader ".} =
  ...
  virtualReturn.h
proc QSGOpaqueTextureMaterialcompare*(self: gen_qsgtexturematerial_types.QSGOpaqueTextureMaterial, other: QSGMaterial): cint =
  fQSGOpaqueTextureMaterial_virtualbase_compare(self.h, other.h)

type QSGOpaqueTextureMaterialcompareProc* = proc(other: QSGMaterial): cint
...
func init*(T: type gen_qsgtexturematerial_types.QSGTextureMaterial, h: ptr cQSGTextureMaterial): gen_qsgtexturematerial_types.QSGTextureMaterial =
  T(h: h)
proc typeX*(self: gen_qsgtexturematerial_types.QSGTextureMaterial, ): QSGMaterialType =
  QSGMaterialType(h: fcQSGTextureMaterial_typeX(self.h))

proc createShader*(self: gen_qsgtexturematerial_types.QSGTextureMaterial, renderMode: cint): QSGMaterialShader =
  QSGMaterialShader(h: fcQSGTextureMaterial_createShader(self.h, cint(renderMode)))
