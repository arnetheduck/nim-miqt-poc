...
proc typeX*(self: gen_qsgmaterial_types.QSGMaterial, ): QSGMaterialType =
  QSGMaterialType(h: fcQSGMaterial_typeX(self.h))

proc createShader*(self: gen_qsgmaterial_types.QSGMaterial, renderMode: cint): QSGMaterialShader =
  QSGMaterialShader(h: fcQSGMaterial_createShader(self.h, cint(renderMode)))

proc compare*(self: gen_qsgmaterial_types.QSGMaterial, other: QSGMaterial): cint =
...
type QSGMaterialtypeXProc* = proc(): QSGMaterialType
...
proc miqt_exec_callback_QSGMaterial_type(self: ptr cQSGMaterial, slot: int): pointer {.exportc: "miqt_exec_callback_QSGMaterial_type ".} =
  ...
  virtualReturn.h
type QSGMaterialcreateShaderProc* = proc(renderMode: cint): QSGMaterialShader
...
proc miqt_exec_callback_QSGMaterial_createShader(self: ptr cQSGMaterial, slot: int, renderMode: cint): pointer {.exportc: "miqt_exec_callback_QSGMaterial_createShader ".} =
  ...
  virtualReturn.h
proc QSGMaterialcompare*(self: gen_qsgmaterial_types.QSGMaterial, other: QSGMaterial): cint =
  fQSGMaterial_virtualbase_compare(self.h, other.h)

type QSGMaterialcompareProc* = proc(other: QSGMaterial): cint
