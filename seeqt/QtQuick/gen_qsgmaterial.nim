...
proc createShader*(self: gen_qsgmaterial_types.QSGMaterial, ): QSGMaterialShader =
  QSGMaterialShader(h: fcQSGMaterial_createShader(self.h))
...
proc miqt_exec_callback_QSGMaterial_type(self: ptr cQSGMaterial, slot: int): pointer {.exportc: "miqt_exec_callback_QSGMaterial_type ".} =
  ...
  virtualReturn.h
type QSGMaterialcreateShaderProc* = proc(): QSGMaterialShader
