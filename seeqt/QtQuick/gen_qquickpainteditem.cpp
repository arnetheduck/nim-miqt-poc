...
void miqt_exec_callback_QQuickPaintedItem_fillColorChanged_release(intptr_t);
void miqt_exec_callback_QQuickPaintedItem_contentsSizeChanged(intptr_t);
void miqt_exec_callback_QQuickPaintedItem_contentsSizeChanged_release(intptr_t);
void miqt_exec_callback_QQuickPaintedItem_contentsScaleChanged(intptr_t);
void miqt_exec_callback_QQuickPaintedItem_contentsScaleChanged_release(intptr_t);
void miqt_exec_callback_QQuickPaintedItem_renderTargetChanged(intptr_t);
void miqt_exec_callback_QQuickPaintedItem_renderTargetChanged_release(intptr_t);
void miqt_exec_callback_QQuickPaintedItem_textureSizeChanged(intptr_t);
void miqt_exec_callback_QQuickPaintedItem_textureSizeChanged_release(intptr_t);
#ifdef __cplusplus
} /* extern C */
#endif
...
void QQuickPaintedItem_connect_fillColorChanged(QQuickPaintedItem* self, intptr_t slot) {
	struct caller {
		...
		~caller() { miqt_exec_callback_QQuickPaintedItem_fillColorChanged_release(slot); }
	};
	MiqtVirtualQQuickPaintedItem::connect(self, static_cast<void (QQuickPaintedItem::*)()>(&QQuickPaintedItem::fillColorChanged), self, caller{slot});
}
...
void QQuickPaintedItem_connect_contentsSizeChanged(QQuickPaintedItem* self, intptr_t slot) {
	struct caller {
		...
		caller(const caller &) = delete;
		caller &operator=(const caller &) = delete;
		~caller() { miqt_exec_callback_QQuickPaintedItem_contentsSizeChanged_release(slot); }
	};
	MiqtVirtualQQuickPaintedItem::connect(self, static_cast<void (QQuickPaintedItem::*)()>(&QQuickPaintedItem::contentsSizeChanged), self, caller{slot});
}
...
void QQuickPaintedItem_connect_contentsScaleChanged(QQuickPaintedItem* self, intptr_t slot) {
	struct caller {
		...
		caller(const caller &) = delete;
		caller &operator=(const caller &) = delete;
		~caller() { miqt_exec_callback_QQuickPaintedItem_contentsScaleChanged_release(slot); }
	};
	MiqtVirtualQQuickPaintedItem::connect(self, static_cast<void (QQuickPaintedItem::*)()>(&QQuickPaintedItem::contentsScaleChanged), self, caller{slot});
}
...
void QQuickPaintedItem_connect_renderTargetChanged(QQuickPaintedItem* self, intptr_t slot) {
	struct caller {
		...
		caller(const caller &) = delete;
		caller &operator=(const caller &) = delete;
		~caller() { miqt_exec_callback_QQuickPaintedItem_renderTargetChanged_release(slot); }
	};
	MiqtVirtualQQuickPaintedItem::connect(self, static_cast<void (QQuickPaintedItem::*)()>(&QQuickPaintedItem::renderTargetChanged), self, caller{slot});
}
...
void QQuickPaintedItem_connect_textureSizeChanged(QQuickPaintedItem* self, intptr_t slot) {
	struct caller {
		...
		caller(const caller &) = delete;
		caller &operator=(const caller &) = delete;
		~caller() { miqt_exec_callback_QQuickPaintedItem_textureSizeChanged_release(slot); }
	};
	MiqtVirtualQQuickPaintedItem::connect(self, static_cast<void (QQuickPaintedItem::*)()>(&QQuickPaintedItem::textureSizeChanged), self, caller{slot});
}
...
QMetaObject* QQuickPaintedItem_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQQuickPaintedItem*)(self) )->QQuickPaintedItem::metaObject();

}

void* QQuickPaintedItem_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQQuickPaintedItem*)(self) )->QQuickPaintedItem::qt_metacast(param1);

}

int QQuickPaintedItem_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQQuickPaintedItem*)(self) )->QQuickPaintedItem::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);

}

bool QQuickPaintedItem_virtualbase_isTextureProvider(const void* self) {

	return ( (const MiqtVirtualQQuickPaintedItem*)(self) )->QQuickPaintedItem::isTextureProvider();

}

QSGTextureProvider* QQuickPaintedItem_virtualbase_textureProvider(const void* self) {

	return ( (const MiqtVirtualQQuickPaintedItem*)(self) )->QQuickPaintedItem::textureProvider();

}

QSGNode* QQuickPaintedItem_virtualbase_updatePaintNode(void* self, QSGNode* param1, QQuickItem__UpdatePaintNodeData* param2) {

	return ( (MiqtVirtualQQuickPaintedItem*)(self) )->QQuickPaintedItem::updatePaintNode(param1, param2);

}

void QQuickPaintedItem_virtualbase_releaseResources(void* self) {

	( (MiqtVirtualQQuickPaintedItem*)(self) )->QQuickPaintedItem::releaseResources();

}

void QQuickPaintedItem_virtualbase_itemChange(void* self, int param1, QQuickItem__ItemChangeData* param2) {

	( (MiqtVirtualQQuickPaintedItem*)(self) )->QQuickPaintedItem::itemChange(static_cast<MiqtVirtualQQuickPaintedItem::ItemChange>(param1), *param2);

}

QRectF* QQuickPaintedItem_virtualbase_boundingRect(const void* self) {

	return new QRectF(( (const MiqtVirtualQQuickPaintedItem*)(self) )->QQuickPaintedItem::boundingRect());

}

QRectF* QQuickPaintedItem_virtualbase_clipRect(const void* self) {

	return new QRectF(( (const MiqtVirtualQQuickPaintedItem*)(self) )->QQuickPaintedItem::clipRect());

}

bool QQuickPaintedItem_virtualbase_contains(const void* self, QPointF* point) {

	return ( (const MiqtVirtualQQuickPaintedItem*)(self) )->QQuickPaintedItem::contains(*point);

}

QVariant* QQuickPaintedItem_virtualbase_inputMethodQuery(const void* self, int query) {

	return new QVariant(( (const MiqtVirtualQQuickPaintedItem*)(self) )->QQuickPaintedItem::inputMethodQuery(static_cast<Qt::InputMethodQuery>(query)));

}

bool QQuickPaintedItem_virtualbase_event(void* self, QEvent* param1) {

	return ( (MiqtVirtualQQuickPaintedItem*)(self) )->QQuickPaintedItem::event(param1);

}

void QQuickPaintedItem_virtualbase_classBegin(void* self) {

	( (MiqtVirtualQQuickPaintedItem*)(self) )->QQuickPaintedItem::classBegin();

}

void QQuickPaintedItem_virtualbase_componentComplete(void* self) {

	( (MiqtVirtualQQuickPaintedItem*)(self) )->QQuickPaintedItem::componentComplete();

}

void QQuickPaintedItem_virtualbase_keyPressEvent(void* self, QKeyEvent* event) {

	( (MiqtVirtualQQuickPaintedItem*)(self) )->QQuickPaintedItem::keyPressEvent(event);

}

void QQuickPaintedItem_virtualbase_keyReleaseEvent(void* self, QKeyEvent* event) {

	( (MiqtVirtualQQuickPaintedItem*)(self) )->QQuickPaintedItem::keyReleaseEvent(event);

}

void QQuickPaintedItem_virtualbase_inputMethodEvent(void* self, QInputMethodEvent* param1) {

	( (MiqtVirtualQQuickPaintedItem*)(self) )->QQuickPaintedItem::inputMethodEvent(param1);

}

void QQuickPaintedItem_virtualbase_focusInEvent(void* self, QFocusEvent* param1) {

	( (MiqtVirtualQQuickPaintedItem*)(self) )->QQuickPaintedItem::focusInEvent(param1);

}

void QQuickPaintedItem_virtualbase_focusOutEvent(void* self, QFocusEvent* param1) {

	( (MiqtVirtualQQuickPaintedItem*)(self) )->QQuickPaintedItem::focusOutEvent(param1);

}

void QQuickPaintedItem_virtualbase_mousePressEvent(void* self, QMouseEvent* event) {

	( (MiqtVirtualQQuickPaintedItem*)(self) )->QQuickPaintedItem::mousePressEvent(event);

}

void QQuickPaintedItem_virtualbase_mouseMoveEvent(void* self, QMouseEvent* event) {

	( (MiqtVirtualQQuickPaintedItem*)(self) )->QQuickPaintedItem::mouseMoveEvent(event);

}

void QQuickPaintedItem_virtualbase_mouseReleaseEvent(void* self, QMouseEvent* event) {

	( (MiqtVirtualQQuickPaintedItem*)(self) )->QQuickPaintedItem::mouseReleaseEvent(event);

}

void QQuickPaintedItem_virtualbase_mouseDoubleClickEvent(void* self, QMouseEvent* event) {

	( (MiqtVirtualQQuickPaintedItem*)(self) )->QQuickPaintedItem::mouseDoubleClickEvent(event);

}

void QQuickPaintedItem_virtualbase_mouseUngrabEvent(void* self) {

	( (MiqtVirtualQQuickPaintedItem*)(self) )->QQuickPaintedItem::mouseUngrabEvent();

}

void QQuickPaintedItem_virtualbase_touchUngrabEvent(void* self) {

	( (MiqtVirtualQQuickPaintedItem*)(self) )->QQuickPaintedItem::touchUngrabEvent();

}

void QQuickPaintedItem_virtualbase_wheelEvent(void* self, QWheelEvent* event) {

	( (MiqtVirtualQQuickPaintedItem*)(self) )->QQuickPaintedItem::wheelEvent(event);

}

void QQuickPaintedItem_virtualbase_touchEvent(void* self, QTouchEvent* event) {

	( (MiqtVirtualQQuickPaintedItem*)(self) )->QQuickPaintedItem::touchEvent(event);

}

void QQuickPaintedItem_virtualbase_hoverEnterEvent(void* self, QHoverEvent* event) {

	( (MiqtVirtualQQuickPaintedItem*)(self) )->QQuickPaintedItem::hoverEnterEvent(event);

}

void QQuickPaintedItem_virtualbase_hoverMoveEvent(void* self, QHoverEvent* event) {

	( (MiqtVirtualQQuickPaintedItem*)(self) )->QQuickPaintedItem::hoverMoveEvent(event);

}

void QQuickPaintedItem_virtualbase_hoverLeaveEvent(void* self, QHoverEvent* event) {

	( (MiqtVirtualQQuickPaintedItem*)(self) )->QQuickPaintedItem::hoverLeaveEvent(event);

}

void QQuickPaintedItem_virtualbase_dragEnterEvent(void* self, QDragEnterEvent* param1) {

	( (MiqtVirtualQQuickPaintedItem*)(self) )->QQuickPaintedItem::dragEnterEvent(param1);

}

void QQuickPaintedItem_virtualbase_dragMoveEvent(void* self, QDragMoveEvent* param1) {

	( (MiqtVirtualQQuickPaintedItem*)(self) )->QQuickPaintedItem::dragMoveEvent(param1);

}

void QQuickPaintedItem_virtualbase_dragLeaveEvent(void* self, QDragLeaveEvent* param1) {

	( (MiqtVirtualQQuickPaintedItem*)(self) )->QQuickPaintedItem::dragLeaveEvent(param1);

}

void QQuickPaintedItem_virtualbase_dropEvent(void* self, QDropEvent* param1) {

	( (MiqtVirtualQQuickPaintedItem*)(self) )->QQuickPaintedItem::dropEvent(param1);

}

bool QQuickPaintedItem_virtualbase_childMouseEventFilter(void* self, QQuickItem* param1, QEvent* param2) {

	return ( (MiqtVirtualQQuickPaintedItem*)(self) )->QQuickPaintedItem::childMouseEventFilter(param1, param2);

}

void QQuickPaintedItem_virtualbase_windowDeactivateEvent(void* self) {

	( (MiqtVirtualQQuickPaintedItem*)(self) )->QQuickPaintedItem::windowDeactivateEvent();

}

void QQuickPaintedItem_virtualbase_geometryChanged(void* self, QRectF* newGeometry, QRectF* oldGeometry) {

	( (MiqtVirtualQQuickPaintedItem*)(self) )->QQuickPaintedItem::geometryChanged(*newGeometry, *oldGeometry);

}

void QQuickPaintedItem_virtualbase_updatePolish(void* self) {

	( (MiqtVirtualQQuickPaintedItem*)(self) )->QQuickPaintedItem::updatePolish();

}

bool QQuickPaintedItem_virtualbase_eventFilter(void* self, QObject* watched, QEvent* event) {

	return ( (MiqtVirtualQQuickPaintedItem*)(self) )->QQuickPaintedItem::eventFilter(watched, event);

}

void QQuickPaintedItem_virtualbase_timerEvent(void* self, QTimerEvent* event) {

	( (MiqtVirtualQQuickPaintedItem*)(self) )->QQuickPaintedItem::timerEvent(event);

}

void QQuickPaintedItem_virtualbase_childEvent(void* self, QChildEvent* event) {

	( (MiqtVirtualQQuickPaintedItem*)(self) )->QQuickPaintedItem::childEvent(event);

}

void QQuickPaintedItem_virtualbase_customEvent(void* self, QEvent* event) {

	( (MiqtVirtualQQuickPaintedItem*)(self) )->QQuickPaintedItem::customEvent(event);

}

void QQuickPaintedItem_virtualbase_connectNotify(void* self, QMetaMethod* signal) {

	( (MiqtVirtualQQuickPaintedItem*)(self) )->QQuickPaintedItem::connectNotify(*signal);

}

void QQuickPaintedItem_virtualbase_disconnectNotify(void* self, QMetaMethod* signal) {

	( (MiqtVirtualQQuickPaintedItem*)(self) )->QQuickPaintedItem::disconnectNotify(*signal);
...
bool QQuickPaintedItem_protectedbase_isComponentComplete(const void* self) {
	MiqtVirtualQQuickPaintedItem* self_cast = static_cast<MiqtVirtualQQuickPaintedItem*>( (QQuickPaintedItem*)(self) );
