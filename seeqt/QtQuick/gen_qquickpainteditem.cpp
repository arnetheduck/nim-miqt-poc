...
public:
	...
	MiqtVirtualQQuickPaintedItem(): QQuickPaintedItem() {};
	MiqtVirtualQQuickPaintedItem(QQuickItem* parent): QQuickPaintedItem(parent) {};

	virtual ~MiqtVirtualQQuickPaintedItem() override = default;
...
QQuickPaintedItem* QQuickPaintedItem_new() {
	return new MiqtVirtualQQuickPaintedItem();
}

QQuickPaintedItem* QQuickPaintedItem_new2(QQuickItem* parent) {
	return new MiqtVirtualQQuickPaintedItem(parent);
}
