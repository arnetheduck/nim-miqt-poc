...
TODO GLuint
proc fromNative*(_: type gen_qsgtexture_platform_types.QNativeInterfaceQSGOpenGLTexture, textureId: GLuint, window: QQuickWindow, size: QSize): QSGTexture =
  QSGTexture(h: fcQNativeInterfaceQSGOpenGLTexture_fromNative(textureId, window.h, size.h))

proc fromNativeExternalOES*(_: type gen_qsgtexture_platform_types.QNativeInterfaceQSGOpenGLTexture, textureId: GLuint, window: QQuickWindow, size: QSize): QSGTexture =
  QSGTexture(h: fcQNativeInterfaceQSGOpenGLTexture_fromNativeExternalOES(textureId, window.h, size.h))

proc fromNative*(_: type gen_qsgtexture_platform_types.QNativeInterfaceQSGOpenGLTexture, textureId: GLuint, window: QQuickWindow, size: QSize, options: cint): QSGTexture =
  QSGTexture(h: fcQNativeInterfaceQSGOpenGLTexture_fromNative4(textureId, window.h, size.h, cint(options)))

proc fromNativeExternalOES*(_: type gen_qsgtexture_platform_types.QNativeInterfaceQSGOpenGLTexture, textureId: GLuint, window: QQuickWindow, size: QSize, options: cint): QSGTexture =
  QSGTexture(h: fcQNativeInterfaceQSGOpenGLTexture_fromNativeExternalOES4(textureId, window.h, size.h, cint(options)))
...
TODO VkImageLayout
proc fromNative*(_: type gen_qsgtexture_platform_types.QNativeInterfaceQSGVulkanTexture, image: VkImage, layout: VkImageLayout, window: QQuickWindow, size: QSize): QSGTexture =
  QSGTexture(h: fcQNativeInterfaceQSGVulkanTexture_fromNative(image, layout, window.h, size.h))

proc fromNative*(_: type gen_qsgtexture_platform_types.QNativeInterfaceQSGVulkanTexture, image: VkImage, layout: VkImageLayout, window: QQuickWindow, size: QSize, options: cint): QSGTexture =
  QSGTexture(h: fcQNativeInterfaceQSGVulkanTexture_fromNative5(image, layout, window.h, size.h, cint(options)))
