...
int QSGVertexColorMaterial_virtualbase_compare(const void* self, QSGMaterial* other) {
	...
	return ( (const MiqtVirtualQSGVertexColorMaterial*)(self) )->QSGVertexColorMaterial::compare(other);
...
QSGMaterialType* QSGVertexColorMaterial_virtualbase_type(const void* self) {
	...
	return ( (const MiqtVirtualQSGVertexColorMaterial*)(self) )->QSGVertexColorMaterial::type();
...
QSGMaterialShader* QSGVertexColorMaterial_virtualbase_createShader(const void* self, int renderMode) {
	...
	return ( (const MiqtVirtualQSGVertexColorMaterial*)(self) )->QSGVertexColorMaterial::createShader(static_cast<QSGRendererInterface::RenderMode>(renderMode));
