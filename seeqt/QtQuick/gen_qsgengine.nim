...
proc create*(T: type gen_qsgengine_types.QSGEngine, parent: QObject): gen_qsgengine_types.QSGEngine =
  gen_qsgengine_types.QSGEngine.init(fcQSGEngine_new2(parent.h))

proc metaObject*(self: gen_qsgengine_types.QSGEngine, ): QMetaObject =
  QMetaObject(h: fcQSGEngine_metaObject(self.h))
...
proc createRenderer*(self: gen_qsgengine_types.QSGEngine, ): QSGAbstractRenderer =
  QSGAbstractRenderer(h: fcQSGEngine_createRenderer(self.h))

proc createTextureFromImage*(self: gen_qsgengine_types.QSGEngine, image: QImage): QSGTexture =
  QSGTexture(h: fcQSGEngine_createTextureFromImage(self.h, image.h))

proc createTextureFromId*(self: gen_qsgengine_types.QSGEngine, id: cuint, size: QSize): QSGTexture =
  QSGTexture(h: fcQSGEngine_createTextureFromId(self.h, id, size.h))

proc rendererInterface*(self: gen_qsgengine_types.QSGEngine, ): QSGRendererInterface =
  QSGRendererInterface(h: fcQSGEngine_rendererInterface(self.h))

proc createRectangleNode*(self: gen_qsgengine_types.QSGEngine, ): QSGRectangleNode =
  QSGRectangleNode(h: fcQSGEngine_createRectangleNode(self.h))

proc createImageNode*(self: gen_qsgengine_types.QSGEngine, ): QSGImageNode =
  QSGImageNode(h: fcQSGEngine_createImageNode(self.h))

proc createNinePatchNode*(self: gen_qsgengine_types.QSGEngine, ): QSGNinePatchNode =
  QSGNinePatchNode(h: fcQSGEngine_createNinePatchNode(self.h))
...
proc createTextureFromImage*(self: gen_qsgengine_types.QSGEngine, image: QImage, options: cint): QSGTexture =
  QSGTexture(h: fcQSGEngine_createTextureFromImage2(self.h, image.h, cint(options)))

proc createTextureFromId*(self: gen_qsgengine_types.QSGEngine, id: cuint, size: QSize, options: cint): QSGTexture =
  QSGTexture(h: fcQSGEngine_createTextureFromId3(self.h, id, size.h, cint(options)))
...
proc miqt_exec_callback_QSGEngine_metacall(self: ptr cQSGEngine, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QSGEngine_metacall ".} =
  ...
  virtualReturn
proc QSGEngineevent*(self: gen_qsgengine_types.QSGEngine, event: QEvent): bool =
  fQSGEngine_virtualbase_event(self.h, event.h)

type QSGEngineeventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QSGEngine_event(self: ptr cQSGEngine, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QSGEngine_event ".} =
  ...
  virtualReturn
proc QSGEngineeventFilter*(self: gen_qsgengine_types.QSGEngine, watched: QObject, event: QEvent): bool =
  fQSGEngine_virtualbase_eventFilter(self.h, watched.h, event.h)

type QSGEngineeventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QSGEngine_eventFilter(self: ptr cQSGEngine, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QSGEngine_eventFilter ".} =
  ...
  virtualReturn
proc QSGEnginetimerEvent*(self: gen_qsgengine_types.QSGEngine, event: QTimerEvent): void =
  fQSGEngine_virtualbase_timerEvent(self.h, event.h)

type QSGEnginetimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QSGEngine_timerEvent(self: ptr cQSGEngine, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QSGEngine_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QSGEnginechildEvent*(self: gen_qsgengine_types.QSGEngine, event: QChildEvent): void =
  fQSGEngine_virtualbase_childEvent(self.h, event.h)

type QSGEnginechildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QSGEngine_childEvent(self: ptr cQSGEngine, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QSGEngine_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QSGEnginecustomEvent*(self: gen_qsgengine_types.QSGEngine, event: QEvent): void =
  fQSGEngine_virtualbase_customEvent(self.h, event.h)

type QSGEnginecustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QSGEngine_customEvent(self: ptr cQSGEngine, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QSGEngine_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QSGEngineconnectNotify*(self: gen_qsgengine_types.QSGEngine, signal: QMetaMethod): void =
  fQSGEngine_virtualbase_connectNotify(self.h, signal.h)

type QSGEngineconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QSGEngine_connectNotify(self: ptr cQSGEngine, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QSGEngine_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QSGEnginedisconnectNotify*(self: gen_qsgengine_types.QSGEngine, signal: QMetaMethod): void =
  fQSGEngine_virtualbase_disconnectNotify(self.h, signal.h)

type QSGEnginedisconnectNotifyProc* = proc(signal: QMetaMethod): void
