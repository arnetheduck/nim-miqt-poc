...
QMetaObject* QSGTexture_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQSGTexture*)(self) )->QSGTexture::metaObject();

}

void* QSGTexture_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQSGTexture*)(self) )->QSGTexture::qt_metacast(param1);

}

int QSGTexture_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQSGTexture*)(self) )->QSGTexture::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
QMetaObject* QSGDynamicTexture_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQSGDynamicTexture*)(self) )->QSGDynamicTexture::metaObject();

}

void* QSGDynamicTexture_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQSGDynamicTexture*)(self) )->QSGDynamicTexture::qt_metacast(param1);

}

int QSGDynamicTexture_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQSGDynamicTexture*)(self) )->QSGDynamicTexture::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
