...
func init*(T: type gen_qsgsimplerectnode_types.QSGSimpleRectNode, h: ptr cQSGSimpleRectNode): gen_qsgsimplerectnode_types.QSGSimpleRectNode =
  T(h: h)
proc create*(T: type gen_qsgsimplerectnode_types.QSGSimpleRectNode, rect: QRectF, color: QColor): gen_qsgsimplerectnode_types.QSGSimpleRectNode =
...
proc setRect*(self: gen_qsgsimplerectnode_types.QSGSimpleRectNode, rect: QRectF): void =
...
proc rect*(self: gen_qsgsimplerectnode_types.QSGSimpleRectNode, ): QRectF =
  QRectF(h: fcQSGSimpleRectNode_rect(self.h))

proc setColor*(self: gen_qsgsimplerectnode_types.QSGSimpleRectNode, color: QColor): void =
  fcQSGSimpleRectNode_setColor(self.h, color.h)

proc color*(self: gen_qsgsimplerectnode_types.QSGSimpleRectNode, ): QColor =
  QColor(h: fcQSGSimpleRectNode_color(self.h))
