...
QMetaObject* QSGEngine_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQSGEngine*)(self) )->QSGEngine::metaObject();

}

void* QSGEngine_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQSGEngine*)(self) )->QSGEngine::qt_metacast(param1);

}

int QSGEngine_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQSGEngine*)(self) )->QSGEngine::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);

}

bool QSGEngine_virtualbase_event(void* self, QEvent* event) {

	return ( (MiqtVirtualQSGEngine*)(self) )->QSGEngine::event(event);

}

bool QSGEngine_virtualbase_eventFilter(void* self, QObject* watched, QEvent* event) {

	return ( (MiqtVirtualQSGEngine*)(self) )->QSGEngine::eventFilter(watched, event);

}

void QSGEngine_virtualbase_timerEvent(void* self, QTimerEvent* event) {

	( (MiqtVirtualQSGEngine*)(self) )->QSGEngine::timerEvent(event);

}

void QSGEngine_virtualbase_childEvent(void* self, QChildEvent* event) {

	( (MiqtVirtualQSGEngine*)(self) )->QSGEngine::childEvent(event);

}

void QSGEngine_virtualbase_customEvent(void* self, QEvent* event) {

	( (MiqtVirtualQSGEngine*)(self) )->QSGEngine::customEvent(event);

}

void QSGEngine_virtualbase_connectNotify(void* self, QMetaMethod* signal) {

	( (MiqtVirtualQSGEngine*)(self) )->QSGEngine::connectNotify(*signal);

}

void QSGEngine_virtualbase_disconnectNotify(void* self, QMetaMethod* signal) {

	( (MiqtVirtualQSGEngine*)(self) )->QSGEngine::disconnectNotify(*signal);
...
QObject* QSGEngine_protectedbase_sender(const void* self) {
	MiqtVirtualQSGEngine* self_cast = static_cast<MiqtVirtualQSGEngine*>( (QSGEngine*)(self) );
