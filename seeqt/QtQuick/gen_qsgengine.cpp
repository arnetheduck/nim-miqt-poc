...
public:
	...
	MiqtVirtualQSGEngine(): QSGEngine() {};
	MiqtVirtualQSGEngine(QObject* parent): QSGEngine(parent) {};

	virtual ~MiqtVirtualQSGEngine() override = default;
...
QSGEngine* QSGEngine_new() {
	return new MiqtVirtualQSGEngine();
}

QSGEngine* QSGEngine_new2(QObject* parent) {
	return new MiqtVirtualQSGEngine(parent);
}
