...
proc fQQuickItem_connect_paletteChanged(self: pointer, slot: int) {.importc: "QQuickItem_connect_paletteChanged".}
proc fcQQuickItem_paletteCreated(self: pointer, ): void {.importc: "QQuickItem_paletteCreated".}
proc fQQuickItem_connect_paletteCreated(self: pointer, slot: int) {.importc: "QQuickItem_connect_paletteCreated".}
...
proc fQQuickItem_virtualbase_geometryChange(self: pointer, newGeometry: pointer, oldGeometry: pointer): void{.importc: "QQuickItem_virtualbase_geometryChange".}
proc fcQQuickItem_override_virtual_geometryChange(self: pointer, slot: int) {.importc: "QQuickItem_override_virtual_geometryChange".}
...
proc create*(T: type gen_qquickitem_types.QQuickTransform, parent: QObject): gen_qquickitem_types.QQuickTransform =
  gen_qquickitem_types.QQuickTransform.init(fcQQuickTransform_new2(parent.h))

proc metaObject*(self: gen_qquickitem_types.QQuickTransform, ): QMetaObject =
  QMetaObject(h: fcQQuickTransform_metaObject(self.h))
...
proc appendToItem*(self: gen_qquickitem_types.QQuickTransform, param1: QQuickItem): void =
  fcQQuickTransform_appendToItem(self.h, param1.h)

proc prependToItem*(self: gen_qquickitem_types.QQuickTransform, param1: QQuickItem): void =
  fcQQuickTransform_prependToItem(self.h, param1.h)

proc applyTo*(self: gen_qquickitem_types.QQuickTransform, matrix: QMatrix4x4): void =
...
proc miqt_exec_callback_QQuickTransform_metacall(self: ptr cQQuickTransform, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QQuickTransform_metacall ".} =
  ...
  virtualReturn
type QQuickTransformapplyToProc* = proc(matrix: QMatrix4x4): void
...
proc miqt_exec_callback_QQuickTransform_applyTo(self: ptr cQQuickTransform, slot: int, matrix: pointer): void {.exportc: "miqt_exec_callback_QQuickTransform_applyTo ".} =
  ...
  let slotval1 = QMatrix4x4(h: matrix)


  nimfunc[](slotval1)
proc QQuickTransformevent*(self: gen_qquickitem_types.QQuickTransform, event: QEvent): bool =
  fQQuickTransform_virtualbase_event(self.h, event.h)

type QQuickTransformeventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QQuickTransform_event(self: ptr cQQuickTransform, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QQuickTransform_event ".} =
  ...
  virtualReturn
proc QQuickTransformeventFilter*(self: gen_qquickitem_types.QQuickTransform, watched: QObject, event: QEvent): bool =
  fQQuickTransform_virtualbase_eventFilter(self.h, watched.h, event.h)

type QQuickTransformeventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QQuickTransform_eventFilter(self: ptr cQQuickTransform, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QQuickTransform_eventFilter ".} =
  ...
  virtualReturn
proc QQuickTransformtimerEvent*(self: gen_qquickitem_types.QQuickTransform, event: QTimerEvent): void =
  fQQuickTransform_virtualbase_timerEvent(self.h, event.h)

type QQuickTransformtimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QQuickTransform_timerEvent(self: ptr cQQuickTransform, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QQuickTransform_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QQuickTransformchildEvent*(self: gen_qquickitem_types.QQuickTransform, event: QChildEvent): void =
  fQQuickTransform_virtualbase_childEvent(self.h, event.h)

type QQuickTransformchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QQuickTransform_childEvent(self: ptr cQQuickTransform, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QQuickTransform_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QQuickTransformcustomEvent*(self: gen_qquickitem_types.QQuickTransform, event: QEvent): void =
  fQQuickTransform_virtualbase_customEvent(self.h, event.h)

type QQuickTransformcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QQuickTransform_customEvent(self: ptr cQQuickTransform, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QQuickTransform_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QQuickTransformconnectNotify*(self: gen_qquickitem_types.QQuickTransform, signal: QMetaMethod): void =
  fQQuickTransform_virtualbase_connectNotify(self.h, signal.h)

type QQuickTransformconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QQuickTransform_connectNotify(self: ptr cQQuickTransform, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QQuickTransform_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QQuickTransformdisconnectNotify*(self: gen_qquickitem_types.QQuickTransform, signal: QMetaMethod): void =
  fQQuickTransform_virtualbase_disconnectNotify(self.h, signal.h)

type QQuickTransformdisconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc create*(T: type gen_qquickitem_types.QQuickItem, parent: QQuickItem): gen_qquickitem_types.QQuickItem =
  gen_qquickitem_types.QQuickItem.init(fcQQuickItem_new2(parent.h))

proc metaObject*(self: gen_qquickitem_types.QQuickItem, ): QMetaObject =
  QMetaObject(h: fcQQuickItem_metaObject(self.h))
...
proc window*(self: gen_qquickitem_types.QQuickItem, ): QQuickWindow =
  QQuickWindow(h: fcQQuickItem_window(self.h))

proc parentItem*(self: gen_qquickitem_types.QQuickItem, ): QQuickItem =
  QQuickItem(h: fcQQuickItem_parentItem(self.h))

proc setParentItem*(self: gen_qquickitem_types.QQuickItem, parent: QQuickItem): void =
  fcQQuickItem_setParentItem(self.h, parent.h)

proc stackBefore*(self: gen_qquickitem_types.QQuickItem, param1: QQuickItem): void =
  fcQQuickItem_stackBefore(self.h, param1.h)

proc stackAfter*(self: gen_qquickitem_types.QQuickItem, param1: QQuickItem): void =
  fcQQuickItem_stackAfter(self.h, param1.h)

proc childrenRect*(self: gen_qquickitem_types.QQuickItem, ): QRectF =
  QRectF(h: fcQQuickItem_childrenRect(self.h))

proc childItems*(self: gen_qquickitem_types.QQuickItem, ): seq[QQuickItem] =
...
proc position*(self: gen_qquickitem_types.QQuickItem, ): QPointF =
  QPointF(h: fcQQuickItem_position(self.h))
...
proc setPosition*(self: gen_qquickitem_types.QQuickItem, position: QPointF): void =
...
proc size*(self: gen_qquickitem_types.QQuickItem, ): QSizeF =
  QSizeF(h: fcQQuickItem_size(self.h))

proc setSize*(self: gen_qquickitem_types.QQuickItem, size: QSizeF): void =
...
proc transformOriginPoint*(self: gen_qquickitem_types.QQuickItem, ): QPointF =
  QPointF(h: fcQQuickItem_transformOriginPoint(self.h))

proc setTransformOriginPoint*(self: gen_qquickitem_types.QQuickItem, transformOriginPoint: QPointF): void =
...
proc boundingRect*(self: gen_qquickitem_types.QQuickItem, ): QRectF =
  QRectF(h: fcQQuickItem_boundingRect(self.h))

proc clipRect*(self: gen_qquickitem_types.QQuickItem, ): QRectF =
  QRectF(h: fcQQuickItem_clipRect(self.h))

proc viewportItem*(self: gen_qquickitem_types.QQuickItem, ): QQuickItem =
  QQuickItem(h: fcQQuickItem_viewportItem(self.h))
...
proc scopedFocusItem*(self: gen_qquickitem_types.QQuickItem, ): QQuickItem =
  QQuickItem(h: fcQQuickItem_scopedFocusItem(self.h))

proc isAncestorOf*(self: gen_qquickitem_types.QQuickItem, child: QQuickItem): bool =
...
proc cursor*(self: gen_qquickitem_types.QQuickItem, ): QCursor =
  QCursor(h: fcQQuickItem_cursor(self.h))

proc setCursor*(self: gen_qquickitem_types.QQuickItem, cursor: QCursor): void =
...
proc grabToImage*(self: gen_qquickitem_types.QQuickItem, callback: QJSValue): bool =
  fcQQuickItem_grabToImage(self.h, callback.h)

proc contains*(self: gen_qquickitem_types.QQuickItem, point: QPointF): bool =
  fcQQuickItem_contains(self.h, point.h)

proc containmentMask*(self: gen_qquickitem_types.QQuickItem, ): QObject =
  QObject(h: fcQQuickItem_containmentMask(self.h))

proc setContainmentMask*(self: gen_qquickitem_types.QQuickItem, mask: QObject): void =
  fcQQuickItem_setContainmentMask(self.h, mask.h)

proc itemTransform*(self: gen_qquickitem_types.QQuickItem, param1: QQuickItem, param2: ptr bool): QTransform =
  QTransform(h: fcQQuickItem_itemTransform(self.h, param1.h, param2))

proc mapToItem*(self: gen_qquickitem_types.QQuickItem, item: QQuickItem, point: QPointF): QPointF =
  QPointF(h: fcQQuickItem_mapToItem(self.h, item.h, point.h))

proc mapToScene*(self: gen_qquickitem_types.QQuickItem, point: QPointF): QPointF =
  QPointF(h: fcQQuickItem_mapToScene(self.h, point.h))

proc mapToGlobal*(self: gen_qquickitem_types.QQuickItem, point: QPointF): QPointF =
  QPointF(h: fcQQuickItem_mapToGlobal(self.h, point.h))

proc mapRectToItem*(self: gen_qquickitem_types.QQuickItem, item: QQuickItem, rect: QRectF): QRectF =
  QRectF(h: fcQQuickItem_mapRectToItem(self.h, item.h, rect.h))

proc mapRectToScene*(self: gen_qquickitem_types.QQuickItem, rect: QRectF): QRectF =
  QRectF(h: fcQQuickItem_mapRectToScene(self.h, rect.h))

proc mapFromItem*(self: gen_qquickitem_types.QQuickItem, item: QQuickItem, point: QPointF): QPointF =
  QPointF(h: fcQQuickItem_mapFromItem(self.h, item.h, point.h))

proc mapFromScene*(self: gen_qquickitem_types.QQuickItem, point: QPointF): QPointF =
  QPointF(h: fcQQuickItem_mapFromScene(self.h, point.h))

proc mapFromGlobal*(self: gen_qquickitem_types.QQuickItem, point: QPointF): QPointF =
  QPointF(h: fcQQuickItem_mapFromGlobal(self.h, point.h))

proc mapRectFromItem*(self: gen_qquickitem_types.QQuickItem, item: QQuickItem, rect: QRectF): QRectF =
  QRectF(h: fcQQuickItem_mapRectFromItem(self.h, item.h, rect.h))

proc mapRectFromScene*(self: gen_qquickitem_types.QQuickItem, rect: QRectF): QRectF =
  QRectF(h: fcQQuickItem_mapRectFromScene(self.h, rect.h))
...
proc nextItemInFocusChain*(self: gen_qquickitem_types.QQuickItem, ): QQuickItem =
  QQuickItem(h: fcQQuickItem_nextItemInFocusChain(self.h))

proc childAt*(self: gen_qquickitem_types.QQuickItem, x: float64, y: float64): QQuickItem =
...
proc inputMethodQuery*(self: gen_qquickitem_types.QQuickItem, query: cint): QVariant =
  QVariant(h: fcQQuickItem_inputMethodQuery(self.h, cint(query)))

proc isTextureProvider*(self: gen_qquickitem_types.QQuickItem, ): bool =
  fcQQuickItem_isTextureProvider(self.h)

proc textureProvider*(self: gen_qquickitem_types.QQuickItem, ): QSGTextureProvider =
  QSGTextureProvider(h: fcQQuickItem_textureProvider(self.h))

proc update*(self: gen_qquickitem_types.QQuickItem, ): void =
  fcQQuickItem_update(self.h)

proc childrenRectChanged*(self: gen_qquickitem_types.QQuickItem, param1: QRectF): void =
  fcQQuickItem_childrenRectChanged(self.h, param1.h)

type QQuickItemchildrenRectChangedSlot* = proc(param1: QRectF)
...
proc parentChanged*(self: gen_qquickitem_types.QQuickItem, param1: QQuickItem): void =
  fcQQuickItem_parentChanged(self.h, param1.h)

type QQuickItemparentChangedSlot* = proc(param1: QQuickItem)
...
proc windowChanged*(self: gen_qquickitem_types.QQuickItem, window: QQuickWindow): void =
  fcQQuickItem_windowChanged(self.h, window.h)

type QQuickItemwindowChangedSlot* = proc(window: QQuickWindow)
proc miqt_exec_callback_QQuickItem_windowChanged(slot: int, window: pointer) {.exportc.} =
  ...
  let slotval1 = QQuickWindow(h: window)
...
proc miqt_exec_callback_QQuickItem_paletteChanged(slot: int) {.exportc.} =
...
proc onpaletteChanged*(self: gen_qquickitem_types.QQuickItem, slot: QQuickItempaletteChangedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fQQuickItem_connect_paletteChanged(self.h, cast[int](addr tmp[]))
...
proc miqt_exec_callback_QQuickItem_paletteCreated(slot: int) {.exportc.} =
...
proc onpaletteCreated*(self: gen_qquickitem_types.QQuickItem, slot: QQuickItempaletteCreatedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fQQuickItem_connect_paletteCreated(self.h, cast[int](addr tmp[]))
...
proc grabToImage*(self: gen_qquickitem_types.QQuickItem, callback: QJSValue, targetSize: QSize): bool =
  fcQQuickItem_grabToImage22(self.h, callback.h, targetSize.h)

proc nextItemInFocusChain*(self: gen_qquickitem_types.QQuickItem, forward: bool): QQuickItem =
...
proc miqt_exec_callback_QQuickItem_metacall(self: ptr cQQuickItem, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QQuickItem_metacall ".} =
  ...
  virtualReturn
proc QQuickItemboundingRect*(self: gen_qquickitem_types.QQuickItem, ): QRectF =
  QRectF(h: fQQuickItem_virtualbase_boundingRect(self.h))

type QQuickItemboundingRectProc* = proc(): QRectF
...
proc miqt_exec_callback_QQuickItem_boundingRect(self: ptr cQQuickItem, slot: int): pointer {.exportc: "miqt_exec_callback_QQuickItem_boundingRect ".} =
  ...
  virtualReturn.h
proc QQuickItemclipRect*(self: gen_qquickitem_types.QQuickItem, ): QRectF =
  QRectF(h: fQQuickItem_virtualbase_clipRect(self.h))

type QQuickItemclipRectProc* = proc(): QRectF
...
proc miqt_exec_callback_QQuickItem_clipRect(self: ptr cQQuickItem, slot: int): pointer {.exportc: "miqt_exec_callback_QQuickItem_clipRect ".} =
  ...
  virtualReturn.h
proc QQuickItemcontains*(self: gen_qquickitem_types.QQuickItem, point: QPointF): bool =
  fQQuickItem_virtualbase_contains(self.h, point.h)

type QQuickItemcontainsProc* = proc(point: QPointF): bool
...
proc miqt_exec_callback_QQuickItem_contains(self: ptr cQQuickItem, slot: int, point: pointer): bool {.exportc: "miqt_exec_callback_QQuickItem_contains ".} =
  ...
  virtualReturn
proc QQuickIteminputMethodQuery*(self: gen_qquickitem_types.QQuickItem, query: cint): QVariant =
  QVariant(h: fQQuickItem_virtualbase_inputMethodQuery(self.h, cint(query)))

type QQuickIteminputMethodQueryProc* = proc(query: cint): QVariant
...
proc miqt_exec_callback_QQuickItem_isTextureProvider(self: ptr cQQuickItem, slot: int): bool {.exportc: "miqt_exec_callback_QQuickItem_isTextureProvider ".} =
  ...
  virtualReturn
proc QQuickItemtextureProvider*(self: gen_qquickitem_types.QQuickItem, ): QSGTextureProvider =
  QSGTextureProvider(h: fQQuickItem_virtualbase_textureProvider(self.h))

type QQuickItemtextureProviderProc* = proc(): QSGTextureProvider
...
proc miqt_exec_callback_QQuickItem_textureProvider(self: ptr cQQuickItem, slot: int): pointer {.exportc: "miqt_exec_callback_QQuickItem_textureProvider ".} =
  ...
  virtualReturn.h
proc QQuickItemevent*(self: gen_qquickitem_types.QQuickItem, param1: QEvent): bool =
  fQQuickItem_virtualbase_event(self.h, param1.h)

type QQuickItemeventProc* = proc(param1: QEvent): bool
...
proc miqt_exec_callback_QQuickItem_event(self: ptr cQQuickItem, slot: int, param1: pointer): bool {.exportc: "miqt_exec_callback_QQuickItem_event ".} =
  ...
  virtualReturn
proc QQuickItemitemChange*(self: gen_qquickitem_types.QQuickItem, param1: cint, param2: QQuickItemItemChangeData): void =
  fQQuickItem_virtualbase_itemChange(self.h, cint(param1), param2.h)

type QQuickItemitemChangeProc* = proc(param1: cint, param2: QQuickItemItemChangeData): void
...
proc QQuickItemgeometryChange*(self: gen_qquickitem_types.QQuickItem, newGeometry: QRectF, oldGeometry: QRectF): void =
  fQQuickItem_virtualbase_geometryChange(self.h, newGeometry.h, oldGeometry.h)

type QQuickItemgeometryChangeProc* = proc(newGeometry: QRectF, oldGeometry: QRectF): void
proc ongeometryChange*(self: gen_qquickitem_types.QQuickItem, slot: QQuickItemgeometryChangeProc) =
  # TODO check subclass
  var tmp = new QQuickItemgeometryChangeProc
  tmp[] = slot
  GC_ref(tmp)
  fcQQuickItem_override_virtual_geometryChange(self.h, cast[int](addr tmp[]))

proc miqt_exec_callback_QQuickItem_geometryChange(self: ptr cQQuickItem, slot: int, newGeometry: pointer, oldGeometry: pointer): void {.exportc: "miqt_exec_callback_QQuickItem_geometryChange ".} =
  var nimfunc = cast[ptr QQuickItemgeometryChangeProc](cast[pointer](slot))
  let slotval1 = QRectF(h: newGeometry)

  let slotval2 = QRectF(h: oldGeometry)
...
proc miqt_exec_callback_QQuickItem_componentComplete(self: ptr cQQuickItem, slot: int): void {.exportc: "miqt_exec_callback_QQuickItem_componentComplete ".} =
  ...
  nimfunc[]()
proc QQuickItemkeyPressEvent*(self: gen_qquickitem_types.QQuickItem, event: QKeyEvent): void =
  fQQuickItem_virtualbase_keyPressEvent(self.h, event.h)

type QQuickItemkeyPressEventProc* = proc(event: QKeyEvent): void
...
proc miqt_exec_callback_QQuickItem_keyPressEvent(self: ptr cQQuickItem, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QQuickItem_keyPressEvent ".} =
  ...
  nimfunc[](slotval1)
proc QQuickItemkeyReleaseEvent*(self: gen_qquickitem_types.QQuickItem, event: QKeyEvent): void =
  fQQuickItem_virtualbase_keyReleaseEvent(self.h, event.h)

type QQuickItemkeyReleaseEventProc* = proc(event: QKeyEvent): void
...
proc miqt_exec_callback_QQuickItem_keyReleaseEvent(self: ptr cQQuickItem, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QQuickItem_keyReleaseEvent ".} =
  ...
  nimfunc[](slotval1)
proc QQuickIteminputMethodEvent*(self: gen_qquickitem_types.QQuickItem, param1: QInputMethodEvent): void =
  fQQuickItem_virtualbase_inputMethodEvent(self.h, param1.h)

type QQuickIteminputMethodEventProc* = proc(param1: QInputMethodEvent): void
...
proc miqt_exec_callback_QQuickItem_inputMethodEvent(self: ptr cQQuickItem, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QQuickItem_inputMethodEvent ".} =
  ...
  nimfunc[](slotval1)
proc QQuickItemfocusInEvent*(self: gen_qquickitem_types.QQuickItem, param1: QFocusEvent): void =
  fQQuickItem_virtualbase_focusInEvent(self.h, param1.h)

type QQuickItemfocusInEventProc* = proc(param1: QFocusEvent): void
...
proc miqt_exec_callback_QQuickItem_focusInEvent(self: ptr cQQuickItem, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QQuickItem_focusInEvent ".} =
  ...
  nimfunc[](slotval1)
proc QQuickItemfocusOutEvent*(self: gen_qquickitem_types.QQuickItem, param1: QFocusEvent): void =
  fQQuickItem_virtualbase_focusOutEvent(self.h, param1.h)

type QQuickItemfocusOutEventProc* = proc(param1: QFocusEvent): void
...
proc miqt_exec_callback_QQuickItem_focusOutEvent(self: ptr cQQuickItem, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QQuickItem_focusOutEvent ".} =
  ...
  nimfunc[](slotval1)
proc QQuickItemmousePressEvent*(self: gen_qquickitem_types.QQuickItem, event: QMouseEvent): void =
  fQQuickItem_virtualbase_mousePressEvent(self.h, event.h)

type QQuickItemmousePressEventProc* = proc(event: QMouseEvent): void
...
proc miqt_exec_callback_QQuickItem_mousePressEvent(self: ptr cQQuickItem, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QQuickItem_mousePressEvent ".} =
  ...
  nimfunc[](slotval1)
proc QQuickItemmouseMoveEvent*(self: gen_qquickitem_types.QQuickItem, event: QMouseEvent): void =
  fQQuickItem_virtualbase_mouseMoveEvent(self.h, event.h)

type QQuickItemmouseMoveEventProc* = proc(event: QMouseEvent): void
...
proc miqt_exec_callback_QQuickItem_mouseMoveEvent(self: ptr cQQuickItem, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QQuickItem_mouseMoveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QQuickItemmouseReleaseEvent*(self: gen_qquickitem_types.QQuickItem, event: QMouseEvent): void =
  fQQuickItem_virtualbase_mouseReleaseEvent(self.h, event.h)

type QQuickItemmouseReleaseEventProc* = proc(event: QMouseEvent): void
...
proc miqt_exec_callback_QQuickItem_mouseReleaseEvent(self: ptr cQQuickItem, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QQuickItem_mouseReleaseEvent ".} =
  ...
  nimfunc[](slotval1)
proc QQuickItemmouseDoubleClickEvent*(self: gen_qquickitem_types.QQuickItem, event: QMouseEvent): void =
  fQQuickItem_virtualbase_mouseDoubleClickEvent(self.h, event.h)

type QQuickItemmouseDoubleClickEventProc* = proc(event: QMouseEvent): void
...
proc miqt_exec_callback_QQuickItem_touchUngrabEvent(self: ptr cQQuickItem, slot: int): void {.exportc: "miqt_exec_callback_QQuickItem_touchUngrabEvent ".} =
  ...
  nimfunc[]()
proc QQuickItemwheelEvent*(self: gen_qquickitem_types.QQuickItem, event: QWheelEvent): void =
  fQQuickItem_virtualbase_wheelEvent(self.h, event.h)

type QQuickItemwheelEventProc* = proc(event: QWheelEvent): void
...
proc miqt_exec_callback_QQuickItem_wheelEvent(self: ptr cQQuickItem, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QQuickItem_wheelEvent ".} =
  ...
  nimfunc[](slotval1)
proc QQuickItemtouchEvent*(self: gen_qquickitem_types.QQuickItem, event: QTouchEvent): void =
  fQQuickItem_virtualbase_touchEvent(self.h, event.h)

type QQuickItemtouchEventProc* = proc(event: QTouchEvent): void
...
proc miqt_exec_callback_QQuickItem_touchEvent(self: ptr cQQuickItem, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QQuickItem_touchEvent ".} =
  ...
  let slotval1 = QTouchEvent(h: event)


  nimfunc[](slotval1)
proc QQuickItemhoverEnterEvent*(self: gen_qquickitem_types.QQuickItem, event: QHoverEvent): void =
  fQQuickItem_virtualbase_hoverEnterEvent(self.h, event.h)

type QQuickItemhoverEnterEventProc* = proc(event: QHoverEvent): void
...
proc miqt_exec_callback_QQuickItem_hoverEnterEvent(self: ptr cQQuickItem, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QQuickItem_hoverEnterEvent ".} =
  ...
  let slotval1 = QHoverEvent(h: event)


  nimfunc[](slotval1)
proc QQuickItemhoverMoveEvent*(self: gen_qquickitem_types.QQuickItem, event: QHoverEvent): void =
  fQQuickItem_virtualbase_hoverMoveEvent(self.h, event.h)

type QQuickItemhoverMoveEventProc* = proc(event: QHoverEvent): void
...
proc miqt_exec_callback_QQuickItem_hoverMoveEvent(self: ptr cQQuickItem, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QQuickItem_hoverMoveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QQuickItemhoverLeaveEvent*(self: gen_qquickitem_types.QQuickItem, event: QHoverEvent): void =
  fQQuickItem_virtualbase_hoverLeaveEvent(self.h, event.h)

type QQuickItemhoverLeaveEventProc* = proc(event: QHoverEvent): void
...
proc miqt_exec_callback_QQuickItem_hoverLeaveEvent(self: ptr cQQuickItem, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QQuickItem_hoverLeaveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QQuickItemdragEnterEvent*(self: gen_qquickitem_types.QQuickItem, param1: QDragEnterEvent): void =
  fQQuickItem_virtualbase_dragEnterEvent(self.h, param1.h)

type QQuickItemdragEnterEventProc* = proc(param1: QDragEnterEvent): void
...
proc miqt_exec_callback_QQuickItem_dragEnterEvent(self: ptr cQQuickItem, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QQuickItem_dragEnterEvent ".} =
  ...
  let slotval1 = QDragEnterEvent(h: param1)


  nimfunc[](slotval1)
proc QQuickItemdragMoveEvent*(self: gen_qquickitem_types.QQuickItem, param1: QDragMoveEvent): void =
  fQQuickItem_virtualbase_dragMoveEvent(self.h, param1.h)

type QQuickItemdragMoveEventProc* = proc(param1: QDragMoveEvent): void
...
proc miqt_exec_callback_QQuickItem_dragMoveEvent(self: ptr cQQuickItem, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QQuickItem_dragMoveEvent ".} =
  ...
  let slotval1 = QDragMoveEvent(h: param1)


  nimfunc[](slotval1)
proc QQuickItemdragLeaveEvent*(self: gen_qquickitem_types.QQuickItem, param1: QDragLeaveEvent): void =
  fQQuickItem_virtualbase_dragLeaveEvent(self.h, param1.h)

type QQuickItemdragLeaveEventProc* = proc(param1: QDragLeaveEvent): void
...
proc miqt_exec_callback_QQuickItem_dragLeaveEvent(self: ptr cQQuickItem, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QQuickItem_dragLeaveEvent ".} =
  ...
  let slotval1 = QDragLeaveEvent(h: param1)


  nimfunc[](slotval1)
proc QQuickItemdropEvent*(self: gen_qquickitem_types.QQuickItem, param1: QDropEvent): void =
  fQQuickItem_virtualbase_dropEvent(self.h, param1.h)

type QQuickItemdropEventProc* = proc(param1: QDropEvent): void
...
proc miqt_exec_callback_QQuickItem_dropEvent(self: ptr cQQuickItem, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QQuickItem_dropEvent ".} =
  ...
  let slotval1 = QDropEvent(h: param1)


  nimfunc[](slotval1)
proc QQuickItemchildMouseEventFilter*(self: gen_qquickitem_types.QQuickItem, param1: QQuickItem, param2: QEvent): bool =
  fQQuickItem_virtualbase_childMouseEventFilter(self.h, param1.h, param2.h)

type QQuickItemchildMouseEventFilterProc* = proc(param1: QQuickItem, param2: QEvent): bool
...
proc miqt_exec_callback_QQuickItem_childMouseEventFilter(self: ptr cQQuickItem, slot: int, param1: pointer, param2: pointer): bool {.exportc: "miqt_exec_callback_QQuickItem_childMouseEventFilter ".} =
  ...
  virtualReturn
proc QQuickItemupdatePaintNode*(self: gen_qquickitem_types.QQuickItem, param1: QSGNode, param2: QQuickItemUpdatePaintNodeData): QSGNode =
  QSGNode(h: fQQuickItem_virtualbase_updatePaintNode(self.h, param1.h, param2.h))

type QQuickItemupdatePaintNodeProc* = proc(param1: QSGNode, param2: QQuickItemUpdatePaintNodeData): QSGNode
...
proc miqt_exec_callback_QQuickItem_updatePolish(self: ptr cQQuickItem, slot: int): void {.exportc: "miqt_exec_callback_QQuickItem_updatePolish ".} =
  ...
  nimfunc[]()
proc QQuickItemeventFilter*(self: gen_qquickitem_types.QQuickItem, watched: QObject, event: QEvent): bool =
  fQQuickItem_virtualbase_eventFilter(self.h, watched.h, event.h)

type QQuickItemeventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QQuickItem_eventFilter(self: ptr cQQuickItem, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QQuickItem_eventFilter ".} =
  ...
  virtualReturn
proc QQuickItemtimerEvent*(self: gen_qquickitem_types.QQuickItem, event: QTimerEvent): void =
  fQQuickItem_virtualbase_timerEvent(self.h, event.h)

type QQuickItemtimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QQuickItem_timerEvent(self: ptr cQQuickItem, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QQuickItem_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QQuickItemchildEvent*(self: gen_qquickitem_types.QQuickItem, event: QChildEvent): void =
  fQQuickItem_virtualbase_childEvent(self.h, event.h)

type QQuickItemchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QQuickItem_childEvent(self: ptr cQQuickItem, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QQuickItem_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QQuickItemcustomEvent*(self: gen_qquickitem_types.QQuickItem, event: QEvent): void =
  fQQuickItem_virtualbase_customEvent(self.h, event.h)

type QQuickItemcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QQuickItem_customEvent(self: ptr cQQuickItem, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QQuickItem_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QQuickItemconnectNotify*(self: gen_qquickitem_types.QQuickItem, signal: QMetaMethod): void =
  fQQuickItem_virtualbase_connectNotify(self.h, signal.h)

type QQuickItemconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QQuickItem_connectNotify(self: ptr cQQuickItem, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QQuickItem_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QQuickItemdisconnectNotify*(self: gen_qquickitem_types.QQuickItem, signal: QMetaMethod): void =
  fQQuickItem_virtualbase_disconnectNotify(self.h, signal.h)

type QQuickItemdisconnectNotifyProc* = proc(signal: QMetaMethod): void
...
func init*(T: type gen_qquickitem_types.QQuickItemItemChangeData, h: ptr cQQuickItemItemChangeData): gen_qquickitem_types.QQuickItemItemChangeData =
  T(h: h)
proc create*(T: type gen_qquickitem_types.QQuickItemItemChangeData, v: QQuickItem): gen_qquickitem_types.QQuickItemItemChangeData =
  gen_qquickitem_types.QQuickItemItemChangeData.init(fcQQuickItemItemChangeData_new(v.h))

proc create*(T: type gen_qquickitem_types.QQuickItemItemChangeData, v: QQuickWindow): gen_qquickitem_types.QQuickItemItemChangeData =
