...
proc create*(T: type gen_qquickpainteditem_types.QQuickPaintedItem, parent: QQuickItem): gen_qquickpainteditem_types.QQuickPaintedItem =
  gen_qquickpainteditem_types.QQuickPaintedItem.init(fcQQuickPaintedItem_new2(parent.h))

proc metaObject*(self: gen_qquickpainteditem_types.QQuickPaintedItem, ): QMetaObject =
  QMetaObject(h: fcQQuickPaintedItem_metaObject(self.h))
...
proc contentsBoundingRect*(self: gen_qquickpainteditem_types.QQuickPaintedItem, ): QRectF =
  QRectF(h: fcQQuickPaintedItem_contentsBoundingRect(self.h))

proc contentsSize*(self: gen_qquickpainteditem_types.QQuickPaintedItem, ): QSize =
  QSize(h: fcQQuickPaintedItem_contentsSize(self.h))

proc setContentsSize*(self: gen_qquickpainteditem_types.QQuickPaintedItem, contentsSize: QSize): void =
...
proc textureSize*(self: gen_qquickpainteditem_types.QQuickPaintedItem, ): QSize =
  QSize(h: fcQQuickPaintedItem_textureSize(self.h))

proc setTextureSize*(self: gen_qquickpainteditem_types.QQuickPaintedItem, size: QSize): void =
  fcQQuickPaintedItem_setTextureSize(self.h, size.h)

proc fillColor*(self: gen_qquickpainteditem_types.QQuickPaintedItem, ): QColor =
  QColor(h: fcQQuickPaintedItem_fillColor(self.h))

proc setFillColor*(self: gen_qquickpainteditem_types.QQuickPaintedItem, fillColor: QColor): void =
...
proc paint*(self: gen_qquickpainteditem_types.QQuickPaintedItem, painter: QPainter): void =
...
proc textureProvider*(self: gen_qquickpainteditem_types.QQuickPaintedItem, ): QSGTextureProvider =
  QSGTextureProvider(h: fcQQuickPaintedItem_textureProvider(self.h))
...
proc update*(self: gen_qquickpainteditem_types.QQuickPaintedItem, rect: QRect): void =
...
proc miqt_exec_callback_QQuickPaintedItem_metacall(self: ptr cQQuickPaintedItem, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QQuickPaintedItem_metacall ".} =
  ...
  virtualReturn
type QQuickPaintedItempaintProc* = proc(painter: QPainter): void
...
proc miqt_exec_callback_QQuickPaintedItem_isTextureProvider(self: ptr cQQuickPaintedItem, slot: int): bool {.exportc: "miqt_exec_callback_QQuickPaintedItem_isTextureProvider ".} =
  ...
  virtualReturn
proc QQuickPaintedItemtextureProvider*(self: gen_qquickpainteditem_types.QQuickPaintedItem, ): QSGTextureProvider =
  QSGTextureProvider(h: fQQuickPaintedItem_virtualbase_textureProvider(self.h))

type QQuickPaintedItemtextureProviderProc* = proc(): QSGTextureProvider
...
proc miqt_exec_callback_QQuickPaintedItem_textureProvider(self: ptr cQQuickPaintedItem, slot: int): pointer {.exportc: "miqt_exec_callback_QQuickPaintedItem_textureProvider ".} =
  ...
  virtualReturn.h
proc QQuickPaintedItemupdatePaintNode*(self: gen_qquickpainteditem_types.QQuickPaintedItem, param1: QSGNode, param2: QQuickItemUpdatePaintNodeData): QSGNode =
  QSGNode(h: fQQuickPaintedItem_virtualbase_updatePaintNode(self.h, param1.h, param2.h))

type QQuickPaintedItemupdatePaintNodeProc* = proc(param1: QSGNode, param2: QQuickItemUpdatePaintNodeData): QSGNode
...
proc miqt_exec_callback_QQuickPaintedItem_releaseResources(self: ptr cQQuickPaintedItem, slot: int): void {.exportc: "miqt_exec_callback_QQuickPaintedItem_releaseResources ".} =
  ...
  nimfunc[]()
proc QQuickPaintedItemitemChange*(self: gen_qquickpainteditem_types.QQuickPaintedItem, param1: cint, param2: QQuickItemItemChangeData): void =
  fQQuickPaintedItem_virtualbase_itemChange(self.h, cint(param1), param2.h)

type QQuickPaintedItemitemChangeProc* = proc(param1: cint, param2: QQuickItemItemChangeData): void
...
proc QQuickPaintedItemboundingRect*(self: gen_qquickpainteditem_types.QQuickPaintedItem, ): QRectF =
  QRectF(h: fQQuickPaintedItem_virtualbase_boundingRect(self.h))

type QQuickPaintedItemboundingRectProc* = proc(): QRectF
...
proc miqt_exec_callback_QQuickPaintedItem_boundingRect(self: ptr cQQuickPaintedItem, slot: int): pointer {.exportc: "miqt_exec_callback_QQuickPaintedItem_boundingRect ".} =
  ...
  virtualReturn.h
proc QQuickPaintedItemclipRect*(self: gen_qquickpainteditem_types.QQuickPaintedItem, ): QRectF =
  QRectF(h: fQQuickPaintedItem_virtualbase_clipRect(self.h))

type QQuickPaintedItemclipRectProc* = proc(): QRectF
...
proc miqt_exec_callback_QQuickPaintedItem_clipRect(self: ptr cQQuickPaintedItem, slot: int): pointer {.exportc: "miqt_exec_callback_QQuickPaintedItem_clipRect ".} =
  ...
  virtualReturn.h
proc QQuickPaintedItemcontains*(self: gen_qquickpainteditem_types.QQuickPaintedItem, point: QPointF): bool =
  fQQuickPaintedItem_virtualbase_contains(self.h, point.h)

type QQuickPaintedItemcontainsProc* = proc(point: QPointF): bool
...
proc miqt_exec_callback_QQuickPaintedItem_contains(self: ptr cQQuickPaintedItem, slot: int, point: pointer): bool {.exportc: "miqt_exec_callback_QQuickPaintedItem_contains ".} =
  ...
  virtualReturn
proc QQuickPaintedIteminputMethodQuery*(self: gen_qquickpainteditem_types.QQuickPaintedItem, query: cint): QVariant =
  QVariant(h: fQQuickPaintedItem_virtualbase_inputMethodQuery(self.h, cint(query)))

type QQuickPaintedIteminputMethodQueryProc* = proc(query: cint): QVariant
...
proc miqt_exec_callback_QQuickPaintedItem_inputMethodQuery(self: ptr cQQuickPaintedItem, slot: int, query: cint): pointer {.exportc: "miqt_exec_callback_QQuickPaintedItem_inputMethodQuery ".} =
  ...
  virtualReturn.h
proc QQuickPaintedItemevent*(self: gen_qquickpainteditem_types.QQuickPaintedItem, param1: QEvent): bool =
  fQQuickPaintedItem_virtualbase_event(self.h, param1.h)

type QQuickPaintedItemeventProc* = proc(param1: QEvent): bool
...
proc miqt_exec_callback_QQuickPaintedItem_componentComplete(self: ptr cQQuickPaintedItem, slot: int): void {.exportc: "miqt_exec_callback_QQuickPaintedItem_componentComplete ".} =
  ...
  nimfunc[]()
proc QQuickPaintedItemkeyPressEvent*(self: gen_qquickpainteditem_types.QQuickPaintedItem, event: QKeyEvent): void =
  fQQuickPaintedItem_virtualbase_keyPressEvent(self.h, event.h)

type QQuickPaintedItemkeyPressEventProc* = proc(event: QKeyEvent): void
...
proc miqt_exec_callback_QQuickPaintedItem_keyPressEvent(self: ptr cQQuickPaintedItem, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QQuickPaintedItem_keyPressEvent ".} =
  ...
  nimfunc[](slotval1)
proc QQuickPaintedItemkeyReleaseEvent*(self: gen_qquickpainteditem_types.QQuickPaintedItem, event: QKeyEvent): void =
  fQQuickPaintedItem_virtualbase_keyReleaseEvent(self.h, event.h)

type QQuickPaintedItemkeyReleaseEventProc* = proc(event: QKeyEvent): void
...
proc miqt_exec_callback_QQuickPaintedItem_keyReleaseEvent(self: ptr cQQuickPaintedItem, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QQuickPaintedItem_keyReleaseEvent ".} =
  ...
  nimfunc[](slotval1)
proc QQuickPaintedIteminputMethodEvent*(self: gen_qquickpainteditem_types.QQuickPaintedItem, param1: QInputMethodEvent): void =
  fQQuickPaintedItem_virtualbase_inputMethodEvent(self.h, param1.h)

type QQuickPaintedIteminputMethodEventProc* = proc(param1: QInputMethodEvent): void
...
proc miqt_exec_callback_QQuickPaintedItem_inputMethodEvent(self: ptr cQQuickPaintedItem, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QQuickPaintedItem_inputMethodEvent ".} =
  ...
  nimfunc[](slotval1)
proc QQuickPaintedItemfocusInEvent*(self: gen_qquickpainteditem_types.QQuickPaintedItem, param1: QFocusEvent): void =
  fQQuickPaintedItem_virtualbase_focusInEvent(self.h, param1.h)

type QQuickPaintedItemfocusInEventProc* = proc(param1: QFocusEvent): void
...
proc miqt_exec_callback_QQuickPaintedItem_focusInEvent(self: ptr cQQuickPaintedItem, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QQuickPaintedItem_focusInEvent ".} =
  ...
  nimfunc[](slotval1)
proc QQuickPaintedItemfocusOutEvent*(self: gen_qquickpainteditem_types.QQuickPaintedItem, param1: QFocusEvent): void =
  fQQuickPaintedItem_virtualbase_focusOutEvent(self.h, param1.h)

type QQuickPaintedItemfocusOutEventProc* = proc(param1: QFocusEvent): void
...
proc miqt_exec_callback_QQuickPaintedItem_focusOutEvent(self: ptr cQQuickPaintedItem, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QQuickPaintedItem_focusOutEvent ".} =
  ...
  nimfunc[](slotval1)
proc QQuickPaintedItemmousePressEvent*(self: gen_qquickpainteditem_types.QQuickPaintedItem, event: QMouseEvent): void =
  fQQuickPaintedItem_virtualbase_mousePressEvent(self.h, event.h)

type QQuickPaintedItemmousePressEventProc* = proc(event: QMouseEvent): void
...
proc miqt_exec_callback_QQuickPaintedItem_mousePressEvent(self: ptr cQQuickPaintedItem, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QQuickPaintedItem_mousePressEvent ".} =
  ...
  nimfunc[](slotval1)
proc QQuickPaintedItemmouseMoveEvent*(self: gen_qquickpainteditem_types.QQuickPaintedItem, event: QMouseEvent): void =
  fQQuickPaintedItem_virtualbase_mouseMoveEvent(self.h, event.h)

type QQuickPaintedItemmouseMoveEventProc* = proc(event: QMouseEvent): void
...
proc miqt_exec_callback_QQuickPaintedItem_mouseMoveEvent(self: ptr cQQuickPaintedItem, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QQuickPaintedItem_mouseMoveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QQuickPaintedItemmouseReleaseEvent*(self: gen_qquickpainteditem_types.QQuickPaintedItem, event: QMouseEvent): void =
  fQQuickPaintedItem_virtualbase_mouseReleaseEvent(self.h, event.h)

type QQuickPaintedItemmouseReleaseEventProc* = proc(event: QMouseEvent): void
...
proc miqt_exec_callback_QQuickPaintedItem_mouseReleaseEvent(self: ptr cQQuickPaintedItem, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QQuickPaintedItem_mouseReleaseEvent ".} =
  ...
  nimfunc[](slotval1)
proc QQuickPaintedItemmouseDoubleClickEvent*(self: gen_qquickpainteditem_types.QQuickPaintedItem, event: QMouseEvent): void =
  fQQuickPaintedItem_virtualbase_mouseDoubleClickEvent(self.h, event.h)

type QQuickPaintedItemmouseDoubleClickEventProc* = proc(event: QMouseEvent): void
...
proc miqt_exec_callback_QQuickPaintedItem_touchUngrabEvent(self: ptr cQQuickPaintedItem, slot: int): void {.exportc: "miqt_exec_callback_QQuickPaintedItem_touchUngrabEvent ".} =
  ...
  nimfunc[]()
proc QQuickPaintedItemwheelEvent*(self: gen_qquickpainteditem_types.QQuickPaintedItem, event: QWheelEvent): void =
  fQQuickPaintedItem_virtualbase_wheelEvent(self.h, event.h)

type QQuickPaintedItemwheelEventProc* = proc(event: QWheelEvent): void
...
proc miqt_exec_callback_QQuickPaintedItem_wheelEvent(self: ptr cQQuickPaintedItem, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QQuickPaintedItem_wheelEvent ".} =
  ...
  nimfunc[](slotval1)
proc QQuickPaintedItemtouchEvent*(self: gen_qquickpainteditem_types.QQuickPaintedItem, event: QTouchEvent): void =
  fQQuickPaintedItem_virtualbase_touchEvent(self.h, event.h)

type QQuickPaintedItemtouchEventProc* = proc(event: QTouchEvent): void
...
proc miqt_exec_callback_QQuickPaintedItem_touchEvent(self: ptr cQQuickPaintedItem, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QQuickPaintedItem_touchEvent ".} =
  ...
  nimfunc[](slotval1)
proc QQuickPaintedItemhoverEnterEvent*(self: gen_qquickpainteditem_types.QQuickPaintedItem, event: QHoverEvent): void =
  fQQuickPaintedItem_virtualbase_hoverEnterEvent(self.h, event.h)

type QQuickPaintedItemhoverEnterEventProc* = proc(event: QHoverEvent): void
...
proc miqt_exec_callback_QQuickPaintedItem_hoverEnterEvent(self: ptr cQQuickPaintedItem, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QQuickPaintedItem_hoverEnterEvent ".} =
  ...
  nimfunc[](slotval1)
proc QQuickPaintedItemhoverMoveEvent*(self: gen_qquickpainteditem_types.QQuickPaintedItem, event: QHoverEvent): void =
  fQQuickPaintedItem_virtualbase_hoverMoveEvent(self.h, event.h)

type QQuickPaintedItemhoverMoveEventProc* = proc(event: QHoverEvent): void
...
proc miqt_exec_callback_QQuickPaintedItem_hoverMoveEvent(self: ptr cQQuickPaintedItem, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QQuickPaintedItem_hoverMoveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QQuickPaintedItemhoverLeaveEvent*(self: gen_qquickpainteditem_types.QQuickPaintedItem, event: QHoverEvent): void =
  fQQuickPaintedItem_virtualbase_hoverLeaveEvent(self.h, event.h)

type QQuickPaintedItemhoverLeaveEventProc* = proc(event: QHoverEvent): void
...
proc miqt_exec_callback_QQuickPaintedItem_hoverLeaveEvent(self: ptr cQQuickPaintedItem, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QQuickPaintedItem_hoverLeaveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QQuickPaintedItemdragEnterEvent*(self: gen_qquickpainteditem_types.QQuickPaintedItem, param1: QDragEnterEvent): void =
  fQQuickPaintedItem_virtualbase_dragEnterEvent(self.h, param1.h)

type QQuickPaintedItemdragEnterEventProc* = proc(param1: QDragEnterEvent): void
...
proc miqt_exec_callback_QQuickPaintedItem_dragEnterEvent(self: ptr cQQuickPaintedItem, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QQuickPaintedItem_dragEnterEvent ".} =
  ...
  nimfunc[](slotval1)
proc QQuickPaintedItemdragMoveEvent*(self: gen_qquickpainteditem_types.QQuickPaintedItem, param1: QDragMoveEvent): void =
  fQQuickPaintedItem_virtualbase_dragMoveEvent(self.h, param1.h)

type QQuickPaintedItemdragMoveEventProc* = proc(param1: QDragMoveEvent): void
...
proc miqt_exec_callback_QQuickPaintedItem_dragMoveEvent(self: ptr cQQuickPaintedItem, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QQuickPaintedItem_dragMoveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QQuickPaintedItemdragLeaveEvent*(self: gen_qquickpainteditem_types.QQuickPaintedItem, param1: QDragLeaveEvent): void =
  fQQuickPaintedItem_virtualbase_dragLeaveEvent(self.h, param1.h)

type QQuickPaintedItemdragLeaveEventProc* = proc(param1: QDragLeaveEvent): void
...
proc miqt_exec_callback_QQuickPaintedItem_dragLeaveEvent(self: ptr cQQuickPaintedItem, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QQuickPaintedItem_dragLeaveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QQuickPaintedItemdropEvent*(self: gen_qquickpainteditem_types.QQuickPaintedItem, param1: QDropEvent): void =
  fQQuickPaintedItem_virtualbase_dropEvent(self.h, param1.h)

type QQuickPaintedItemdropEventProc* = proc(param1: QDropEvent): void
...
proc miqt_exec_callback_QQuickPaintedItem_dropEvent(self: ptr cQQuickPaintedItem, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QQuickPaintedItem_dropEvent ".} =
  ...
  nimfunc[](slotval1)
proc QQuickPaintedItemchildMouseEventFilter*(self: gen_qquickpainteditem_types.QQuickPaintedItem, param1: QQuickItem, param2: QEvent): bool =
  fQQuickPaintedItem_virtualbase_childMouseEventFilter(self.h, param1.h, param2.h)

type QQuickPaintedItemchildMouseEventFilterProc* = proc(param1: QQuickItem, param2: QEvent): bool
...
proc miqt_exec_callback_QQuickPaintedItem_windowDeactivateEvent(self: ptr cQQuickPaintedItem, slot: int): void {.exportc: "miqt_exec_callback_QQuickPaintedItem_windowDeactivateEvent ".} =
  ...
  nimfunc[]()
proc QQuickPaintedItemgeometryChanged*(self: gen_qquickpainteditem_types.QQuickPaintedItem, newGeometry: QRectF, oldGeometry: QRectF): void =
  fQQuickPaintedItem_virtualbase_geometryChanged(self.h, newGeometry.h, oldGeometry.h)

type QQuickPaintedItemgeometryChangedProc* = proc(newGeometry: QRectF, oldGeometry: QRectF): void
...
proc miqt_exec_callback_QQuickPaintedItem_updatePolish(self: ptr cQQuickPaintedItem, slot: int): void {.exportc: "miqt_exec_callback_QQuickPaintedItem_updatePolish ".} =
  ...
  nimfunc[]()
proc QQuickPaintedItemeventFilter*(self: gen_qquickpainteditem_types.QQuickPaintedItem, watched: QObject, event: QEvent): bool =
  fQQuickPaintedItem_virtualbase_eventFilter(self.h, watched.h, event.h)

type QQuickPaintedItemeventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QQuickPaintedItem_eventFilter(self: ptr cQQuickPaintedItem, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QQuickPaintedItem_eventFilter ".} =
  ...
  virtualReturn
proc QQuickPaintedItemtimerEvent*(self: gen_qquickpainteditem_types.QQuickPaintedItem, event: QTimerEvent): void =
  fQQuickPaintedItem_virtualbase_timerEvent(self.h, event.h)

type QQuickPaintedItemtimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QQuickPaintedItem_timerEvent(self: ptr cQQuickPaintedItem, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QQuickPaintedItem_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QQuickPaintedItemchildEvent*(self: gen_qquickpainteditem_types.QQuickPaintedItem, event: QChildEvent): void =
  fQQuickPaintedItem_virtualbase_childEvent(self.h, event.h)

type QQuickPaintedItemchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QQuickPaintedItem_childEvent(self: ptr cQQuickPaintedItem, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QQuickPaintedItem_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QQuickPaintedItemcustomEvent*(self: gen_qquickpainteditem_types.QQuickPaintedItem, event: QEvent): void =
  fQQuickPaintedItem_virtualbase_customEvent(self.h, event.h)

type QQuickPaintedItemcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QQuickPaintedItem_customEvent(self: ptr cQQuickPaintedItem, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QQuickPaintedItem_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QQuickPaintedItemconnectNotify*(self: gen_qquickpainteditem_types.QQuickPaintedItem, signal: QMetaMethod): void =
  fQQuickPaintedItem_virtualbase_connectNotify(self.h, signal.h)

type QQuickPaintedItemconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QQuickPaintedItem_connectNotify(self: ptr cQQuickPaintedItem, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QQuickPaintedItem_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QQuickPaintedItemdisconnectNotify*(self: gen_qquickpainteditem_types.QQuickPaintedItem, signal: QMetaMethod): void =
  fQQuickPaintedItem_virtualbase_disconnectNotify(self.h, signal.h)

type QQuickPaintedItemdisconnectNotifyProc* = proc(signal: QMetaMethod): void
