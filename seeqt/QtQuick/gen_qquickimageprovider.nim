...
proc fQQuickImageProvider_virtualbase_metacall(self: pointer, param1: cint, param2: cint, param3: pointer): cint{.importc: "QQuickImageProvider_virtualbase_metacall".}
proc fcQQuickImageProvider_override_virtual_metacall(self: pointer, slot: int) {.importc: "QQuickImageProvider_override_virtual_metacall".}
...
proc fQQuickAsyncImageProvider_virtualbase_metacall(self: pointer, param1: cint, param2: cint, param3: pointer): cint{.importc: "QQuickAsyncImageProvider_virtualbase_metacall".}
proc fcQQuickAsyncImageProvider_override_virtual_metacall(self: pointer, slot: int) {.importc: "QQuickAsyncImageProvider_override_virtual_metacall".}
...
proc metaObject*(self: gen_qquickimageprovider_types.QQuickTextureFactory, ): QMetaObject =
  QMetaObject(h: fcQQuickTextureFactory_metaObject(self.h))
...
proc createTexture*(self: gen_qquickimageprovider_types.QQuickTextureFactory, window: QQuickWindow): QSGTexture =
  QSGTexture(h: fcQQuickTextureFactory_createTexture(self.h, window.h))

proc textureSize*(self: gen_qquickimageprovider_types.QQuickTextureFactory, ): QSize =
  QSize(h: fcQQuickTextureFactory_textureSize(self.h))
...
proc image*(self: gen_qquickimageprovider_types.QQuickTextureFactory, ): QImage =
  QImage(h: fcQQuickTextureFactory_image(self.h))

proc textureFactoryForImage*(_: type gen_qquickimageprovider_types.QQuickTextureFactory, image: QImage): QQuickTextureFactory =
...
proc miqt_exec_callback_QQuickTextureFactory_metacall(self: ptr cQQuickTextureFactory, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QQuickTextureFactory_metacall ".} =
  ...
  virtualReturn
type QQuickTextureFactorycreateTextureProc* = proc(window: QQuickWindow): QSGTexture
...
proc miqt_exec_callback_QQuickTextureFactory_createTexture(self: ptr cQQuickTextureFactory, slot: int, window: pointer): pointer {.exportc: "miqt_exec_callback_QQuickTextureFactory_createTexture ".} =
  ...
  virtualReturn.h
type QQuickTextureFactorytextureSizeProc* = proc(): QSize
...
proc miqt_exec_callback_QQuickTextureFactory_textureByteCount(self: ptr cQQuickTextureFactory, slot: int): cint {.exportc: "miqt_exec_callback_QQuickTextureFactory_textureByteCount ".} =
  ...
  virtualReturn
proc QQuickTextureFactoryimage*(self: gen_qquickimageprovider_types.QQuickTextureFactory, ): QImage =
  QImage(h: fQQuickTextureFactory_virtualbase_image(self.h))

type QQuickTextureFactoryimageProc* = proc(): QImage
...
proc miqt_exec_callback_QQuickTextureFactory_image(self: ptr cQQuickTextureFactory, slot: int): pointer {.exportc: "miqt_exec_callback_QQuickTextureFactory_image ".} =
  ...
  virtualReturn.h
proc QQuickTextureFactoryevent*(self: gen_qquickimageprovider_types.QQuickTextureFactory, event: QEvent): bool =
  fQQuickTextureFactory_virtualbase_event(self.h, event.h)

type QQuickTextureFactoryeventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QQuickTextureFactory_event(self: ptr cQQuickTextureFactory, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QQuickTextureFactory_event ".} =
  ...
  virtualReturn
proc QQuickTextureFactoryeventFilter*(self: gen_qquickimageprovider_types.QQuickTextureFactory, watched: QObject, event: QEvent): bool =
  fQQuickTextureFactory_virtualbase_eventFilter(self.h, watched.h, event.h)

type QQuickTextureFactoryeventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QQuickTextureFactory_eventFilter(self: ptr cQQuickTextureFactory, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QQuickTextureFactory_eventFilter ".} =
  ...
  virtualReturn
proc QQuickTextureFactorytimerEvent*(self: gen_qquickimageprovider_types.QQuickTextureFactory, event: QTimerEvent): void =
  fQQuickTextureFactory_virtualbase_timerEvent(self.h, event.h)

type QQuickTextureFactorytimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QQuickTextureFactory_timerEvent(self: ptr cQQuickTextureFactory, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QQuickTextureFactory_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QQuickTextureFactorychildEvent*(self: gen_qquickimageprovider_types.QQuickTextureFactory, event: QChildEvent): void =
  fQQuickTextureFactory_virtualbase_childEvent(self.h, event.h)

type QQuickTextureFactorychildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QQuickTextureFactory_childEvent(self: ptr cQQuickTextureFactory, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QQuickTextureFactory_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QQuickTextureFactorycustomEvent*(self: gen_qquickimageprovider_types.QQuickTextureFactory, event: QEvent): void =
  fQQuickTextureFactory_virtualbase_customEvent(self.h, event.h)

type QQuickTextureFactorycustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QQuickTextureFactory_customEvent(self: ptr cQQuickTextureFactory, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QQuickTextureFactory_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QQuickTextureFactoryconnectNotify*(self: gen_qquickimageprovider_types.QQuickTextureFactory, signal: QMetaMethod): void =
  fQQuickTextureFactory_virtualbase_connectNotify(self.h, signal.h)

type QQuickTextureFactoryconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QQuickTextureFactory_connectNotify(self: ptr cQQuickTextureFactory, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QQuickTextureFactory_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QQuickTextureFactorydisconnectNotify*(self: gen_qquickimageprovider_types.QQuickTextureFactory, signal: QMetaMethod): void =
  fQQuickTextureFactory_virtualbase_disconnectNotify(self.h, signal.h)

type QQuickTextureFactorydisconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc metaObject*(self: gen_qquickimageprovider_types.QQuickImageResponse, ): QMetaObject =
  QMetaObject(h: fcQQuickImageResponse_metaObject(self.h))
...
proc textureFactory*(self: gen_qquickimageprovider_types.QQuickImageResponse, ): QQuickTextureFactory =
...
proc miqt_exec_callback_QQuickImageResponse_metacall(self: ptr cQQuickImageResponse, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QQuickImageResponse_metacall ".} =
  ...
  virtualReturn
type QQuickImageResponsetextureFactoryProc* = proc(): QQuickTextureFactory
...
proc miqt_exec_callback_QQuickImageResponse_cancel(self: ptr cQQuickImageResponse, slot: int): void {.exportc: "miqt_exec_callback_QQuickImageResponse_cancel ".} =
  ...
  nimfunc[]()
proc QQuickImageResponseevent*(self: gen_qquickimageprovider_types.QQuickImageResponse, event: QEvent): bool =
  fQQuickImageResponse_virtualbase_event(self.h, event.h)

type QQuickImageResponseeventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QQuickImageResponse_event(self: ptr cQQuickImageResponse, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QQuickImageResponse_event ".} =
  ...
  virtualReturn
proc QQuickImageResponseeventFilter*(self: gen_qquickimageprovider_types.QQuickImageResponse, watched: QObject, event: QEvent): bool =
  fQQuickImageResponse_virtualbase_eventFilter(self.h, watched.h, event.h)

type QQuickImageResponseeventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QQuickImageResponse_eventFilter(self: ptr cQQuickImageResponse, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QQuickImageResponse_eventFilter ".} =
  ...
  virtualReturn
proc QQuickImageResponsetimerEvent*(self: gen_qquickimageprovider_types.QQuickImageResponse, event: QTimerEvent): void =
  fQQuickImageResponse_virtualbase_timerEvent(self.h, event.h)

type QQuickImageResponsetimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QQuickImageResponse_timerEvent(self: ptr cQQuickImageResponse, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QQuickImageResponse_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QQuickImageResponsechildEvent*(self: gen_qquickimageprovider_types.QQuickImageResponse, event: QChildEvent): void =
  fQQuickImageResponse_virtualbase_childEvent(self.h, event.h)

type QQuickImageResponsechildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QQuickImageResponse_childEvent(self: ptr cQQuickImageResponse, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QQuickImageResponse_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QQuickImageResponsecustomEvent*(self: gen_qquickimageprovider_types.QQuickImageResponse, event: QEvent): void =
  fQQuickImageResponse_virtualbase_customEvent(self.h, event.h)

type QQuickImageResponsecustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QQuickImageResponse_customEvent(self: ptr cQQuickImageResponse, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QQuickImageResponse_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QQuickImageResponseconnectNotify*(self: gen_qquickimageprovider_types.QQuickImageResponse, signal: QMetaMethod): void =
  fQQuickImageResponse_virtualbase_connectNotify(self.h, signal.h)

type QQuickImageResponseconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QQuickImageResponse_connectNotify(self: ptr cQQuickImageResponse, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QQuickImageResponse_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QQuickImageResponsedisconnectNotify*(self: gen_qquickimageprovider_types.QQuickImageResponse, signal: QMetaMethod): void =
  fQQuickImageResponse_virtualbase_disconnectNotify(self.h, signal.h)

type QQuickImageResponsedisconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc metaObject*(self: gen_qquickimageprovider_types.QQuickImageProvider, ): QMetaObject =
  QMetaObject(h: fcQQuickImageProvider_metaObject(self.h))
...
proc requestImage*(self: gen_qquickimageprovider_types.QQuickImageProvider, id: string, size: QSize, requestedSize: QSize): QImage =
  QImage(h: fcQQuickImageProvider_requestImage(self.h, struct_miqt_string(data: id, len: csize_t(len(id))), size.h, requestedSize.h))

proc requestPixmap*(self: gen_qquickimageprovider_types.QQuickImageProvider, id: string, size: QSize, requestedSize: QSize): QPixmap =
  QPixmap(h: fcQQuickImageProvider_requestPixmap(self.h, struct_miqt_string(data: id, len: csize_t(len(id))), size.h, requestedSize.h))

proc requestTexture*(self: gen_qquickimageprovider_types.QQuickImageProvider, id: string, size: QSize, requestedSize: QSize): QQuickTextureFactory =
...
proc QQuickImageProvidermetacall*(self: gen_qquickimageprovider_types.QQuickImageProvider, param1: cint, param2: cint, param3: pointer): cint =
  fQQuickImageProvider_virtualbase_metacall(self.h, cint(param1), param2, param3)

type QQuickImageProvidermetacallProc* = proc(param1: cint, param2: cint, param3: pointer): cint
proc onmetacall*(self: gen_qquickimageprovider_types.QQuickImageProvider, slot: QQuickImageProvidermetacallProc) =
  # TODO check subclass
  var tmp = new QQuickImageProvidermetacallProc
  tmp[] = slot
  GC_ref(tmp)
  fcQQuickImageProvider_override_virtual_metacall(self.h, cast[int](addr tmp[]))

proc miqt_exec_callback_QQuickImageProvider_metacall(self: ptr cQQuickImageProvider, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QQuickImageProvider_metacall ".} =
  var nimfunc = cast[ptr QQuickImageProvidermetacallProc](cast[pointer](slot))
  let slotval1 = cint(param1)
...
proc miqt_exec_callback_QQuickImageProvider_flags(self: ptr cQQuickImageProvider, slot: int): cint {.exportc: "miqt_exec_callback_QQuickImageProvider_flags ".} =
  ...
  cint(virtualReturn)
proc QQuickImageProviderrequestImage*(self: gen_qquickimageprovider_types.QQuickImageProvider, id: string, size: QSize, requestedSize: QSize): QImage =
  QImage(h: fQQuickImageProvider_virtualbase_requestImage(self.h, struct_miqt_string(data: id, len: csize_t(len(id))), size.h, requestedSize.h))

type QQuickImageProviderrequestImageProc* = proc(id: string, size: QSize, requestedSize: QSize): QImage
...
proc miqt_exec_callback_QQuickImageProvider_requestImage(self: ptr cQQuickImageProvider, slot: int, id: struct_miqt_string, size: pointer, requestedSize: pointer): pointer {.exportc: "miqt_exec_callback_QQuickImageProvider_requestImage ".} =
  ...
  let slotval2 = QSize(h: size)

  let slotval3 = QSize(h: requestedSize)


  let virtualReturn = nimfunc[](slotval1, slotval2, slotval3 )

  virtualReturn.h
proc QQuickImageProviderrequestPixmap*(self: gen_qquickimageprovider_types.QQuickImageProvider, id: string, size: QSize, requestedSize: QSize): QPixmap =
  QPixmap(h: fQQuickImageProvider_virtualbase_requestPixmap(self.h, struct_miqt_string(data: id, len: csize_t(len(id))), size.h, requestedSize.h))

type QQuickImageProviderrequestPixmapProc* = proc(id: string, size: QSize, requestedSize: QSize): QPixmap
...
proc miqt_exec_callback_QQuickImageProvider_requestPixmap(self: ptr cQQuickImageProvider, slot: int, id: struct_miqt_string, size: pointer, requestedSize: pointer): pointer {.exportc: "miqt_exec_callback_QQuickImageProvider_requestPixmap ".} =
  ...
  virtualReturn.h
proc QQuickImageProviderrequestTexture*(self: gen_qquickimageprovider_types.QQuickImageProvider, id: string, size: QSize, requestedSize: QSize): QQuickTextureFactory =
...
type QQuickImageProviderrequestTextureProc* = proc(id: string, size: QSize, requestedSize: QSize): QQuickTextureFactory
...
proc miqt_exec_callback_QQuickImageProvider_requestTexture(self: ptr cQQuickImageProvider, slot: int, id: struct_miqt_string, size: pointer, requestedSize: pointer): pointer {.exportc: "miqt_exec_callback_QQuickImageProvider_requestTexture ".} =
  ...
  virtualReturn.h
proc QQuickImageProviderevent*(self: gen_qquickimageprovider_types.QQuickImageProvider, event: QEvent): bool =
  fQQuickImageProvider_virtualbase_event(self.h, event.h)

type QQuickImageProvidereventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QQuickImageProvider_event(self: ptr cQQuickImageProvider, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QQuickImageProvider_event ".} =
  ...
  virtualReturn
proc QQuickImageProvidereventFilter*(self: gen_qquickimageprovider_types.QQuickImageProvider, watched: QObject, event: QEvent): bool =
  fQQuickImageProvider_virtualbase_eventFilter(self.h, watched.h, event.h)

type QQuickImageProvidereventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QQuickImageProvider_eventFilter(self: ptr cQQuickImageProvider, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QQuickImageProvider_eventFilter ".} =
  ...
  virtualReturn
proc QQuickImageProvidertimerEvent*(self: gen_qquickimageprovider_types.QQuickImageProvider, event: QTimerEvent): void =
  fQQuickImageProvider_virtualbase_timerEvent(self.h, event.h)

type QQuickImageProvidertimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QQuickImageProvider_timerEvent(self: ptr cQQuickImageProvider, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QQuickImageProvider_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QQuickImageProviderchildEvent*(self: gen_qquickimageprovider_types.QQuickImageProvider, event: QChildEvent): void =
  fQQuickImageProvider_virtualbase_childEvent(self.h, event.h)

type QQuickImageProviderchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QQuickImageProvider_childEvent(self: ptr cQQuickImageProvider, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QQuickImageProvider_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QQuickImageProvidercustomEvent*(self: gen_qquickimageprovider_types.QQuickImageProvider, event: QEvent): void =
  fQQuickImageProvider_virtualbase_customEvent(self.h, event.h)

type QQuickImageProvidercustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QQuickImageProvider_customEvent(self: ptr cQQuickImageProvider, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QQuickImageProvider_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QQuickImageProviderconnectNotify*(self: gen_qquickimageprovider_types.QQuickImageProvider, signal: QMetaMethod): void =
  fQQuickImageProvider_virtualbase_connectNotify(self.h, signal.h)

type QQuickImageProviderconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QQuickImageProvider_connectNotify(self: ptr cQQuickImageProvider, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QQuickImageProvider_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QQuickImageProviderdisconnectNotify*(self: gen_qquickimageprovider_types.QQuickImageProvider, signal: QMetaMethod): void =
  fQQuickImageProvider_virtualbase_disconnectNotify(self.h, signal.h)

type QQuickImageProviderdisconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc requestImageResponse*(self: gen_qquickimageprovider_types.QQuickAsyncImageProvider, id: string, requestedSize: QSize): QQuickImageResponse =
...
type QQuickAsyncImageProviderrequestImageResponseProc* = proc(id: string, requestedSize: QSize): QQuickImageResponse
...
proc miqt_exec_callback_QQuickAsyncImageProvider_requestImageResponse(self: ptr cQQuickAsyncImageProvider, slot: int, id: struct_miqt_string, requestedSize: pointer): pointer {.exportc: "miqt_exec_callback_QQuickAsyncImageProvider_requestImageResponse ".} =
  ...
  let slotval2 = QSize(h: requestedSize)
...
proc QQuickAsyncImageProvidermetacall*(self: gen_qquickimageprovider_types.QQuickAsyncImageProvider, param1: cint, param2: cint, param3: pointer): cint =
  fQQuickAsyncImageProvider_virtualbase_metacall(self.h, cint(param1), param2, param3)

type QQuickAsyncImageProvidermetacallProc* = proc(param1: cint, param2: cint, param3: pointer): cint
proc onmetacall*(self: gen_qquickimageprovider_types.QQuickAsyncImageProvider, slot: QQuickAsyncImageProvidermetacallProc) =
  # TODO check subclass
  var tmp = new QQuickAsyncImageProvidermetacallProc
  tmp[] = slot
  GC_ref(tmp)
  fcQQuickAsyncImageProvider_override_virtual_metacall(self.h, cast[int](addr tmp[]))

proc miqt_exec_callback_QQuickAsyncImageProvider_metacall(self: ptr cQQuickAsyncImageProvider, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QQuickAsyncImageProvider_metacall ".} =
  var nimfunc = cast[ptr QQuickAsyncImageProvidermetacallProc](cast[pointer](slot))
  let slotval1 = cint(param1)
...
proc miqt_exec_callback_QQuickAsyncImageProvider_flags(self: ptr cQQuickAsyncImageProvider, slot: int): cint {.exportc: "miqt_exec_callback_QQuickAsyncImageProvider_flags ".} =
  ...
  cint(virtualReturn)
proc QQuickAsyncImageProviderrequestImage*(self: gen_qquickimageprovider_types.QQuickAsyncImageProvider, id: string, size: QSize, requestedSize: QSize): QImage =
  QImage(h: fQQuickAsyncImageProvider_virtualbase_requestImage(self.h, struct_miqt_string(data: id, len: csize_t(len(id))), size.h, requestedSize.h))

type QQuickAsyncImageProviderrequestImageProc* = proc(id: string, size: QSize, requestedSize: QSize): QImage
...
proc miqt_exec_callback_QQuickAsyncImageProvider_requestImage(self: ptr cQQuickAsyncImageProvider, slot: int, id: struct_miqt_string, size: pointer, requestedSize: pointer): pointer {.exportc: "miqt_exec_callback_QQuickAsyncImageProvider_requestImage ".} =
  ...
  virtualReturn.h
proc QQuickAsyncImageProviderrequestPixmap*(self: gen_qquickimageprovider_types.QQuickAsyncImageProvider, id: string, size: QSize, requestedSize: QSize): QPixmap =
  QPixmap(h: fQQuickAsyncImageProvider_virtualbase_requestPixmap(self.h, struct_miqt_string(data: id, len: csize_t(len(id))), size.h, requestedSize.h))

type QQuickAsyncImageProviderrequestPixmapProc* = proc(id: string, size: QSize, requestedSize: QSize): QPixmap
...
proc miqt_exec_callback_QQuickAsyncImageProvider_requestPixmap(self: ptr cQQuickAsyncImageProvider, slot: int, id: struct_miqt_string, size: pointer, requestedSize: pointer): pointer {.exportc: "miqt_exec_callback_QQuickAsyncImageProvider_requestPixmap ".} =
  ...
  virtualReturn.h
proc QQuickAsyncImageProviderrequestTexture*(self: gen_qquickimageprovider_types.QQuickAsyncImageProvider, id: string, size: QSize, requestedSize: QSize): QQuickTextureFactory =
...
type QQuickAsyncImageProviderrequestTextureProc* = proc(id: string, size: QSize, requestedSize: QSize): QQuickTextureFactory
...
proc miqt_exec_callback_QQuickAsyncImageProvider_requestTexture(self: ptr cQQuickAsyncImageProvider, slot: int, id: struct_miqt_string, size: pointer, requestedSize: pointer): pointer {.exportc: "miqt_exec_callback_QQuickAsyncImageProvider_requestTexture ".} =
  ...
  virtualReturn.h
proc QQuickAsyncImageProviderevent*(self: gen_qquickimageprovider_types.QQuickAsyncImageProvider, event: QEvent): bool =
  fQQuickAsyncImageProvider_virtualbase_event(self.h, event.h)

type QQuickAsyncImageProvidereventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QQuickAsyncImageProvider_event(self: ptr cQQuickAsyncImageProvider, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QQuickAsyncImageProvider_event ".} =
  ...
  virtualReturn
proc QQuickAsyncImageProvidereventFilter*(self: gen_qquickimageprovider_types.QQuickAsyncImageProvider, watched: QObject, event: QEvent): bool =
  fQQuickAsyncImageProvider_virtualbase_eventFilter(self.h, watched.h, event.h)

type QQuickAsyncImageProvidereventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QQuickAsyncImageProvider_eventFilter(self: ptr cQQuickAsyncImageProvider, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QQuickAsyncImageProvider_eventFilter ".} =
  ...
  virtualReturn
proc QQuickAsyncImageProvidertimerEvent*(self: gen_qquickimageprovider_types.QQuickAsyncImageProvider, event: QTimerEvent): void =
  fQQuickAsyncImageProvider_virtualbase_timerEvent(self.h, event.h)

type QQuickAsyncImageProvidertimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QQuickAsyncImageProvider_timerEvent(self: ptr cQQuickAsyncImageProvider, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QQuickAsyncImageProvider_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QQuickAsyncImageProviderchildEvent*(self: gen_qquickimageprovider_types.QQuickAsyncImageProvider, event: QChildEvent): void =
  fQQuickAsyncImageProvider_virtualbase_childEvent(self.h, event.h)

type QQuickAsyncImageProviderchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QQuickAsyncImageProvider_childEvent(self: ptr cQQuickAsyncImageProvider, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QQuickAsyncImageProvider_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QQuickAsyncImageProvidercustomEvent*(self: gen_qquickimageprovider_types.QQuickAsyncImageProvider, event: QEvent): void =
  fQQuickAsyncImageProvider_virtualbase_customEvent(self.h, event.h)

type QQuickAsyncImageProvidercustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QQuickAsyncImageProvider_customEvent(self: ptr cQQuickAsyncImageProvider, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QQuickAsyncImageProvider_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QQuickAsyncImageProviderconnectNotify*(self: gen_qquickimageprovider_types.QQuickAsyncImageProvider, signal: QMetaMethod): void =
  fQQuickAsyncImageProvider_virtualbase_connectNotify(self.h, signal.h)

type QQuickAsyncImageProviderconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QQuickAsyncImageProvider_connectNotify(self: ptr cQQuickAsyncImageProvider, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QQuickAsyncImageProvider_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QQuickAsyncImageProviderdisconnectNotify*(self: gen_qquickimageprovider_types.QQuickAsyncImageProvider, signal: QMetaMethod): void =
  fQQuickAsyncImageProvider_virtualbase_disconnectNotify(self.h, signal.h)

type QQuickAsyncImageProviderdisconnectNotifyProc* = proc(signal: QMetaMethod): void
