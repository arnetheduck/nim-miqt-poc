...
int QSGRenderNode_virtualbase_changedStates(const void* self) {
	...
	MiqtVirtualQSGRenderNode::StateFlags _ret = ( (const MiqtVirtualQSGRenderNode*)(self) )->QSGRenderNode::changedStates();
	return static_cast<int>(_ret);
...
void QSGRenderNode_virtualbase_prepare(void* self) {
	...
	( (MiqtVirtualQSGRenderNode*)(self) )->QSGRenderNode::prepare();

}

void QSGRenderNode_virtualbase_releaseResources(void* self) {

	( (MiqtVirtualQSGRenderNode*)(self) )->QSGRenderNode::releaseResources();

}

int QSGRenderNode_virtualbase_flags(const void* self) {

	MiqtVirtualQSGRenderNode::RenderingFlags _ret = ( (const MiqtVirtualQSGRenderNode*)(self) )->QSGRenderNode::flags();
	return static_cast<int>(_ret);
...
QRectF* QSGRenderNode_virtualbase_rect(const void* self) {
	...
	return new QRectF(( (const MiqtVirtualQSGRenderNode*)(self) )->QSGRenderNode::rect());

}

bool QSGRenderNode_virtualbase_isSubtreeBlocked(const void* self) {

	return ( (const MiqtVirtualQSGRenderNode*)(self) )->QSGRenderNode::isSubtreeBlocked();

}

void QSGRenderNode_virtualbase_preprocess(void* self) {

	( (MiqtVirtualQSGRenderNode*)(self) )->QSGRenderNode::preprocess();
