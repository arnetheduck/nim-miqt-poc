...
proc updateState*(self: gen_qsgmaterialshader_types.QSGMaterialShader, state: QSGMaterialShaderRenderState, newMaterial: QSGMaterial, oldMaterial: QSGMaterial): void =
...
proc miqt_exec_callback_QSGMaterialShader_deactivate(self: ptr cQSGMaterialShader, slot: int): void {.exportc: "miqt_exec_callback_QSGMaterialShader_deactivate ".} =
  ...
  nimfunc[]()
proc QSGMaterialShaderupdateState*(self: gen_qsgmaterialshader_types.QSGMaterialShader, state: QSGMaterialShaderRenderState, newMaterial: QSGMaterial, oldMaterial: QSGMaterial): void =
  fQSGMaterialShader_virtualbase_updateState(self.h, state.h, newMaterial.h, oldMaterial.h)

type QSGMaterialShaderupdateStateProc* = proc(state: QSGMaterialShaderRenderState, newMaterial: QSGMaterial, oldMaterial: QSGMaterial): void
