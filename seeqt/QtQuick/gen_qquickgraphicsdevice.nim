...
proc create*(T: type gen_qquickgraphicsdevice_types.QQuickGraphicsDevice, other: QQuickGraphicsDevice): gen_qquickgraphicsdevice_types.QQuickGraphicsDevice =
  gen_qquickgraphicsdevice_types.QQuickGraphicsDevice.init(fcQQuickGraphicsDevice_new2(other.h))

proc operatorAssign*(self: gen_qquickgraphicsdevice_types.QQuickGraphicsDevice, other: QQuickGraphicsDevice): void =
...
proc fromPhysicalDevice*(_: type gen_qquickgraphicsdevice_types.QQuickGraphicsDevice, physicalDevice: VkPhysicalDevice): QQuickGraphicsDevice =
  QQuickGraphicsDevice(h: fcQQuickGraphicsDevice_fromPhysicalDevice(physicalDevice))

proc fromDeviceObjects*(_: type gen_qquickgraphicsdevice_types.QQuickGraphicsDevice, physicalDevice: VkPhysicalDevice, device: VkDevice, queueFamilyIndex: cint): QQuickGraphicsDevice =
  QQuickGraphicsDevice(h: fcQQuickGraphicsDevice_fromDeviceObjects(physicalDevice, device, queueFamilyIndex))

proc fromDeviceObjects*(_: type gen_qquickgraphicsdevice_types.QQuickGraphicsDevice, physicalDevice: VkPhysicalDevice, device: VkDevice, queueFamilyIndex: cint, queueIndex: cint): QQuickGraphicsDevice =
  QQuickGraphicsDevice(h: fcQQuickGraphicsDevice_fromDeviceObjects4(physicalDevice, device, queueFamilyIndex, queueIndex))
