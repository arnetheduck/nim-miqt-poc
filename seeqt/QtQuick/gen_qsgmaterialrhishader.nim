...
proc updateUniformData*(self: gen_qsgmaterialrhishader_types.QSGMaterialRhiShader, state: QSGMaterialRhiShaderRenderState, newMaterial: QSGMaterial, oldMaterial: QSGMaterial): bool =
  fcQSGMaterialRhiShader_updateUniformData(self.h, state.h, newMaterial.h, oldMaterial.h)

proc updateGraphicsPipelineState*(self: gen_qsgmaterialrhishader_types.QSGMaterialRhiShader, state: QSGMaterialRhiShaderRenderState, ps: QSGMaterialRhiShaderGraphicsPipelineState, newMaterial: QSGMaterial, oldMaterial: QSGMaterial): bool =
...
proc QSGMaterialRhiShaderupdateUniformData*(self: gen_qsgmaterialrhishader_types.QSGMaterialRhiShader, state: QSGMaterialRhiShaderRenderState, newMaterial: QSGMaterial, oldMaterial: QSGMaterial): bool =
  fQSGMaterialRhiShader_virtualbase_updateUniformData(self.h, state.h, newMaterial.h, oldMaterial.h)

type QSGMaterialRhiShaderupdateUniformDataProc* = proc(state: QSGMaterialRhiShaderRenderState, newMaterial: QSGMaterial, oldMaterial: QSGMaterial): bool
...
proc miqt_exec_callback_QSGMaterialRhiShader_updateUniformData(self: ptr cQSGMaterialRhiShader, slot: int, state: pointer, newMaterial: pointer, oldMaterial: pointer): bool {.exportc: "miqt_exec_callback_QSGMaterialRhiShader_updateUniformData ".} =
  ...
  let slotval2 = QSGMaterial(h: newMaterial)

  let slotval3 = QSGMaterial(h: oldMaterial)


  let virtualReturn = nimfunc[](slotval1, slotval2, slotval3 )

  virtualReturn
proc QSGMaterialRhiShaderupdateGraphicsPipelineState*(self: gen_qsgmaterialrhishader_types.QSGMaterialRhiShader, state: QSGMaterialRhiShaderRenderState, ps: QSGMaterialRhiShaderGraphicsPipelineState, newMaterial: QSGMaterial, oldMaterial: QSGMaterial): bool =
  fQSGMaterialRhiShader_virtualbase_updateGraphicsPipelineState(self.h, state.h, ps.h, newMaterial.h, oldMaterial.h)

type QSGMaterialRhiShaderupdateGraphicsPipelineStateProc* = proc(state: QSGMaterialRhiShaderRenderState, ps: QSGMaterialRhiShaderGraphicsPipelineState, newMaterial: QSGMaterial, oldMaterial: QSGMaterial): bool
...
proc miqt_exec_callback_QSGMaterialRhiShader_updateGraphicsPipelineState(self: ptr cQSGMaterialRhiShader, slot: int, state: pointer, ps: pointer, newMaterial: pointer, oldMaterial: pointer): bool {.exportc: "miqt_exec_callback_QSGMaterialRhiShader_updateGraphicsPipelineState ".} =
  ...
  let slotval3 = QSGMaterial(h: newMaterial)

  let slotval4 = QSGMaterial(h: oldMaterial)
...
proc miqt_exec_callback_QSGMaterialRhiShader_deactivate(self: ptr cQSGMaterialRhiShader, slot: int): void {.exportc: "miqt_exec_callback_QSGMaterialRhiShader_deactivate ".} =
  ...
  nimfunc[]()
proc QSGMaterialRhiShaderupdateState*(self: gen_qsgmaterialrhishader_types.QSGMaterialRhiShader, state: QSGMaterialShaderRenderState, newMaterial: QSGMaterial, oldMaterial: QSGMaterial): void =
  fQSGMaterialRhiShader_virtualbase_updateState(self.h, state.h, newMaterial.h, oldMaterial.h)

type QSGMaterialRhiShaderupdateStateProc* = proc(state: QSGMaterialShaderRenderState, newMaterial: QSGMaterial, oldMaterial: QSGMaterial): void
...
proc combinedMatrix*(self: gen_qsgmaterialrhishader_types.QSGMaterialRhiShaderRenderState, ): QMatrix4x4 =
  QMatrix4x4(h: fcQSGMaterialRhiShaderRenderState_combinedMatrix(self.h))

proc modelViewMatrix*(self: gen_qsgmaterialrhishader_types.QSGMaterialRhiShaderRenderState, ): QMatrix4x4 =
  QMatrix4x4(h: fcQSGMaterialRhiShaderRenderState_modelViewMatrix(self.h))

proc projectionMatrix*(self: gen_qsgmaterialrhishader_types.QSGMaterialRhiShaderRenderState, ): QMatrix4x4 =
  QMatrix4x4(h: fcQSGMaterialRhiShaderRenderState_projectionMatrix(self.h))

proc viewportRect*(self: gen_qsgmaterialrhishader_types.QSGMaterialRhiShaderRenderState, ): QRect =
  QRect(h: fcQSGMaterialRhiShaderRenderState_viewportRect(self.h))

proc deviceRect*(self: gen_qsgmaterialrhishader_types.QSGMaterialRhiShaderRenderState, ): QRect =
  QRect(h: fcQSGMaterialRhiShaderRenderState_deviceRect(self.h))
...
func init*(T: type gen_qsgmaterialrhishader_types.QSGMaterialRhiShaderGraphicsPipelineState, h: ptr cQSGMaterialRhiShaderGraphicsPipelineState): gen_qsgmaterialrhishader_types.QSGMaterialRhiShaderGraphicsPipelineState =
  T(h: h)
proc create*(T: type gen_qsgmaterialrhishader_types.QSGMaterialRhiShaderGraphicsPipelineState, param1: QSGMaterialRhiShaderGraphicsPipelineState): gen_qsgmaterialrhishader_types.QSGMaterialRhiShaderGraphicsPipelineState =
...
proc operatorAssign*(self: gen_qsgmaterialrhishader_types.QSGMaterialRhiShaderGraphicsPipelineState, param1: QSGMaterialRhiShaderGraphicsPipelineState): void =
