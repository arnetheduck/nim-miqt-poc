...
void miqt_exec_callback_QQuickView_statusChanged_release(intptr_t);
#ifdef __cplusplus
} /* extern C */
#endif
...
void QQuickView_connect_statusChanged(QQuickView* self, intptr_t slot) {
	struct caller {
		...
		~caller() { miqt_exec_callback_QQuickView_statusChanged_release(slot); }
	};
	MiqtVirtualQQuickView::connect(self, static_cast<void (QQuickView::*)(QQuickView::Status)>(&QQuickView::statusChanged), self, caller{slot});
}
...
QSurfaceFormat* QQuickView_virtualbase_format(const void* self) {
	...
	return new QSurfaceFormat(( (const MiqtVirtualQQuickView*)(self) )->QQuickView::format());

}

QSize* QQuickView_virtualbase_size(const void* self) {

	return new QSize(( (const MiqtVirtualQQuickView*)(self) )->QQuickView::size());

}

void QQuickView_virtualbase_moveEvent(void* self, QMoveEvent* param1) {

	( (MiqtVirtualQQuickView*)(self) )->QQuickView::moveEvent(param1);

}

void QQuickView_virtualbase_touchEvent(void* self, QTouchEvent* param1) {

	( (MiqtVirtualQQuickView*)(self) )->QQuickView::touchEvent(param1);
...
bool QQuickView_virtualbase_nativeEvent(void* self, struct miqt_string eventType, void* message, long* result) {
	...
	return ( (MiqtVirtualQQuickView*)(self) )->QQuickView::nativeEvent(eventType_QByteArray, message, static_cast<long*>(result));

}

bool QQuickView_virtualbase_eventFilter(void* self, QObject* watched, QEvent* event) {

	return ( (MiqtVirtualQQuickView*)(self) )->QQuickView::eventFilter(watched, event);

}

void QQuickView_virtualbase_childEvent(void* self, QChildEvent* event) {

	( (MiqtVirtualQQuickView*)(self) )->QQuickView::childEvent(event);

}

void QQuickView_virtualbase_customEvent(void* self, QEvent* event) {

	( (MiqtVirtualQQuickView*)(self) )->QQuickView::customEvent(event);

}

void QQuickView_virtualbase_connectNotify(void* self, QMetaMethod* signal) {

	( (MiqtVirtualQQuickView*)(self) )->QQuickView::connectNotify(*signal);

}

void QQuickView_virtualbase_disconnectNotify(void* self, QMetaMethod* signal) {

	( (MiqtVirtualQQuickView*)(self) )->QQuickView::disconnectNotify(*signal);
