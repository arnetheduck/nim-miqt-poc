...
proc parent*(self: gen_qsgnode_types.QSGNode, ): QSGNode =
  QSGNode(h: fcQSGNode_parent(self.h))

proc removeChildNode*(self: gen_qsgnode_types.QSGNode, node: QSGNode): void =
...
proc prependChildNode*(self: gen_qsgnode_types.QSGNode, node: QSGNode): void =
  fcQSGNode_prependChildNode(self.h, node.h)

proc appendChildNode*(self: gen_qsgnode_types.QSGNode, node: QSGNode): void =
  fcQSGNode_appendChildNode(self.h, node.h)

proc insertChildNodeBefore*(self: gen_qsgnode_types.QSGNode, node: QSGNode, before: QSGNode): void =
  fcQSGNode_insertChildNodeBefore(self.h, node.h, before.h)

proc insertChildNodeAfter*(self: gen_qsgnode_types.QSGNode, node: QSGNode, after: QSGNode): void =
  fcQSGNode_insertChildNodeAfter(self.h, node.h, after.h)

proc reparentChildNodesTo*(self: gen_qsgnode_types.QSGNode, newParent: QSGNode): void =
...
proc childAtIndex*(self: gen_qsgnode_types.QSGNode, i: cint): QSGNode =
  QSGNode(h: fcQSGNode_childAtIndex(self.h, i))

proc firstChild*(self: gen_qsgnode_types.QSGNode, ): QSGNode =
  QSGNode(h: fcQSGNode_firstChild(self.h))

proc lastChild*(self: gen_qsgnode_types.QSGNode, ): QSGNode =
  QSGNode(h: fcQSGNode_lastChild(self.h))

proc nextSibling*(self: gen_qsgnode_types.QSGNode, ): QSGNode =
  QSGNode(h: fcQSGNode_nextSibling(self.h))

proc previousSibling*(self: gen_qsgnode_types.QSGNode, ): QSGNode =
...
func init*(T: type gen_qsgnode_types.QSGBasicGeometryNode, h: ptr cQSGBasicGeometryNode): gen_qsgnode_types.QSGBasicGeometryNode =
  T(h: h)
proc setGeometry*(self: gen_qsgnode_types.QSGBasicGeometryNode, geometry: QSGGeometry): void =
  fcQSGBasicGeometryNode_setGeometry(self.h, geometry.h)

proc geometry*(self: gen_qsgnode_types.QSGBasicGeometryNode, ): QSGGeometry =
  QSGGeometry(h: fcQSGBasicGeometryNode_geometry(self.h))

proc geometry2*(self: gen_qsgnode_types.QSGBasicGeometryNode, ): QSGGeometry =
  QSGGeometry(h: fcQSGBasicGeometryNode_geometry2(self.h))

proc matrix*(self: gen_qsgnode_types.QSGBasicGeometryNode, ): QMatrix4x4 =
  QMatrix4x4(h: fcQSGBasicGeometryNode_matrix(self.h))

proc clipList*(self: gen_qsgnode_types.QSGBasicGeometryNode, ): QSGClipNode =
  QSGClipNode(h: fcQSGBasicGeometryNode_clipList(self.h))

proc setRendererMatrix*(self: gen_qsgnode_types.QSGBasicGeometryNode, m: QMatrix4x4): void =
  fcQSGBasicGeometryNode_setRendererMatrix(self.h, m.h)

proc setRendererClipList*(self: gen_qsgnode_types.QSGBasicGeometryNode, c: QSGClipNode): void =
...
proc setMaterial*(self: gen_qsgnode_types.QSGGeometryNode, material: QSGMaterial): void =
  fcQSGGeometryNode_setMaterial(self.h, material.h)

proc material*(self: gen_qsgnode_types.QSGGeometryNode, ): QSGMaterial =
  QSGMaterial(h: fcQSGGeometryNode_material(self.h))

proc setOpaqueMaterial*(self: gen_qsgnode_types.QSGGeometryNode, material: QSGMaterial): void =
  fcQSGGeometryNode_setOpaqueMaterial(self.h, material.h)

proc opaqueMaterial*(self: gen_qsgnode_types.QSGGeometryNode, ): QSGMaterial =
  QSGMaterial(h: fcQSGGeometryNode_opaqueMaterial(self.h))

proc activeMaterial*(self: gen_qsgnode_types.QSGGeometryNode, ): QSGMaterial =
  QSGMaterial(h: fcQSGGeometryNode_activeMaterial(self.h))
...
proc setClipRect*(self: gen_qsgnode_types.QSGClipNode, clipRect: QRectF): void =
  fcQSGClipNode_setClipRect(self.h, clipRect.h)

proc clipRect*(self: gen_qsgnode_types.QSGClipNode, ): QRectF =
  QRectF(h: fcQSGClipNode_clipRect(self.h))
...
proc setMatrix*(self: gen_qsgnode_types.QSGTransformNode, matrix: QMatrix4x4): void =
  fcQSGTransformNode_setMatrix(self.h, matrix.h)

proc matrix*(self: gen_qsgnode_types.QSGTransformNode, ): QMatrix4x4 =
  QMatrix4x4(h: fcQSGTransformNode_matrix(self.h))

proc setCombinedMatrix*(self: gen_qsgnode_types.QSGTransformNode, matrix: QMatrix4x4): void =
  fcQSGTransformNode_setCombinedMatrix(self.h, matrix.h)

proc combinedMatrix*(self: gen_qsgnode_types.QSGTransformNode, ): QMatrix4x4 =
  QMatrix4x4(h: fcQSGTransformNode_combinedMatrix(self.h))
