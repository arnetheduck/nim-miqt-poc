...
QMetaObject* QQuickTextDocument_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQQuickTextDocument*)(self) )->QQuickTextDocument::metaObject();

}

void* QQuickTextDocument_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQQuickTextDocument*)(self) )->QQuickTextDocument::qt_metacast(param1);
