...
public:
	...
	MiqtVirtualQQuickTextDocument(QQuickItem* parent): QQuickTextDocument(parent) {};

	virtual ~MiqtVirtualQQuickTextDocument() override = default;
...
QQuickTextDocument* QQuickTextDocument_new(QQuickItem* parent) {
	return new MiqtVirtualQQuickTextDocument(parent);
}
...
bool QQuickTextDocument_override_virtual_metacall(void* self, intptr_t slot) {
	MiqtVirtualQQuickTextDocument* self_cast = dynamic_cast<MiqtVirtualQQuickTextDocument*>( (QQuickTextDocument*)(self) );
...
int QQuickTextDocument_virtualbase_metacall(void* self, int param1, int param2, void** param3) {
	...
	return ( (MiqtVirtualQQuickTextDocument*)(self) )->QQuickTextDocument::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
bool QQuickTextDocument_virtualbase_event(void* self, QEvent* event) {
	...
	return ( (MiqtVirtualQQuickTextDocument*)(self) )->QQuickTextDocument::event(event);
...
bool QQuickTextDocument_virtualbase_eventFilter(void* self, QObject* watched, QEvent* event) {
	...
	return ( (MiqtVirtualQQuickTextDocument*)(self) )->QQuickTextDocument::eventFilter(watched, event);
...
void QQuickTextDocument_virtualbase_timerEvent(void* self, QTimerEvent* event) {
	...
	( (MiqtVirtualQQuickTextDocument*)(self) )->QQuickTextDocument::timerEvent(event);
...
void QQuickTextDocument_virtualbase_childEvent(void* self, QChildEvent* event) {
	...
	( (MiqtVirtualQQuickTextDocument*)(self) )->QQuickTextDocument::childEvent(event);
...
void QQuickTextDocument_virtualbase_customEvent(void* self, QEvent* event) {
	...
	( (MiqtVirtualQQuickTextDocument*)(self) )->QQuickTextDocument::customEvent(event);
...
void QQuickTextDocument_virtualbase_connectNotify(void* self, QMetaMethod* signal) {
	...
	( (MiqtVirtualQQuickTextDocument*)(self) )->QQuickTextDocument::connectNotify(*signal);
...
void QQuickTextDocument_virtualbase_disconnectNotify(void* self, QMetaMethod* signal) {
	...
	( (MiqtVirtualQQuickTextDocument*)(self) )->QQuickTextDocument::disconnectNotify(*signal);
