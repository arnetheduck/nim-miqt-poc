...
QSGMaterialType* QSGFlatColorMaterial_virtualbase_type(const void* self) {
	...
	return ( (const MiqtVirtualQSGFlatColorMaterial*)(self) )->QSGFlatColorMaterial::type();
...
QSGMaterialShader* QSGFlatColorMaterial_virtualbase_createShader(const void* self, int renderMode) {
	...
	return ( (const MiqtVirtualQSGFlatColorMaterial*)(self) )->QSGFlatColorMaterial::createShader(static_cast<QSGRendererInterface::RenderMode>(renderMode));
...
int QSGFlatColorMaterial_virtualbase_compare(const void* self, QSGMaterial* other) {
	...
	return ( (const MiqtVirtualQSGFlatColorMaterial*)(self) )->QSGFlatColorMaterial::compare(other);
