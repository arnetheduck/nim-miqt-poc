...
proc setRect*(self: gen_qsgsimpletexturenode_types.QSGSimpleTextureNode, rect: QRectF): void =
...
proc rect*(self: gen_qsgsimpletexturenode_types.QSGSimpleTextureNode, ): QRectF =
  QRectF(h: fcQSGSimpleTextureNode_rect(self.h))

proc setSourceRect*(self: gen_qsgsimpletexturenode_types.QSGSimpleTextureNode, r: QRectF): void =
...
proc sourceRect*(self: gen_qsgsimpletexturenode_types.QSGSimpleTextureNode, ): QRectF =
  QRectF(h: fcQSGSimpleTextureNode_sourceRect(self.h))

proc setTexture*(self: gen_qsgsimpletexturenode_types.QSGSimpleTextureNode, texture: QSGTexture): void =
  fcQSGSimpleTextureNode_setTexture(self.h, texture.h)

proc texture*(self: gen_qsgsimpletexturenode_types.QSGSimpleTextureNode, ): QSGTexture =
  QSGTexture(h: fcQSGSimpleTextureNode_texture(self.h))
