...
proc render*(self: gen_qsgrendernode_types.QSGRenderNode, state: QSGRenderNodeRenderState): void =
...
proc rect*(self: gen_qsgrendernode_types.QSGRenderNode, ): QRectF =
  QRectF(h: fcQSGRenderNode_rect(self.h))

proc matrix*(self: gen_qsgrendernode_types.QSGRenderNode, ): QMatrix4x4 =
  QMatrix4x4(h: fcQSGRenderNode_matrix(self.h))

proc clipList*(self: gen_qsgrendernode_types.QSGRenderNode, ): QSGClipNode =
  QSGClipNode(h: fcQSGRenderNode_clipList(self.h))
...
proc miqt_exec_callback_QSGRenderNode_prepare(self: ptr cQSGRenderNode, slot: int): void {.exportc: "miqt_exec_callback_QSGRenderNode_prepare ".} =
  ...
  nimfunc[]()
type QSGRenderNoderenderProc* = proc(state: QSGRenderNodeRenderState): void
...
proc miqt_exec_callback_QSGRenderNode_flags(self: ptr cQSGRenderNode, slot: int): cint {.exportc: "miqt_exec_callback_QSGRenderNode_flags ".} =
  ...
  cint(virtualReturn)
proc QSGRenderNoderect*(self: gen_qsgrendernode_types.QSGRenderNode, ): QRectF =
  QRectF(h: fQSGRenderNode_virtualbase_rect(self.h))

type QSGRenderNoderectProc* = proc(): QRectF
...
func init*(T: type gen_qsgrendernode_types.QSGRenderNodeRenderState, h: ptr cQSGRenderNodeRenderState): gen_qsgrendernode_types.QSGRenderNodeRenderState =
  T(h: h)
proc projectionMatrix*(self: gen_qsgrendernode_types.QSGRenderNodeRenderState, ): QMatrix4x4 =
  QMatrix4x4(h: fcQSGRenderNodeRenderState_projectionMatrix(self.h))

proc scissorRect*(self: gen_qsgrendernode_types.QSGRenderNodeRenderState, ): QRect =
  QRect(h: fcQSGRenderNodeRenderState_scissorRect(self.h))
...
proc clipRegion*(self: gen_qsgrendernode_types.QSGRenderNodeRenderState, ): QRegion =
  QRegion(h: fcQSGRenderNodeRenderState_clipRegion(self.h))
...
proc operatorAssign*(self: gen_qsgrendernode_types.QSGRenderNodeRenderState, param1: QSGRenderNodeRenderState): void =
