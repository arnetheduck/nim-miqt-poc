...
void QQuickRenderControl_connect_renderRequested(QQuickRenderControl* self, intptr_t slot, void (*callback)(intptr_t), void (*release)(intptr_t)) {
	...
	MiqtVirtualQQuickRenderControl::connect(self, static_cast<void (QQuickRenderControl::*)()>(&QQuickRenderControl::renderRequested), self, caller{slot, callback, release});
}
...
void QQuickRenderControl_connect_sceneChanged(QQuickRenderControl* self, intptr_t slot, void (*callback)(intptr_t), void (*release)(intptr_t)) {
	...
	MiqtVirtualQQuickRenderControl::connect(self, static_cast<void (QQuickRenderControl::*)()>(&QQuickRenderControl::sceneChanged), self, caller{slot, callback, release});
}
...
QMetaObject* QQuickRenderControl_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQQuickRenderControl*)(self) )->QQuickRenderControl::metaObject();

}

void* QQuickRenderControl_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQQuickRenderControl*)(self) )->QQuickRenderControl::qt_metacast(param1);

}

int QQuickRenderControl_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQQuickRenderControl*)(self) )->QQuickRenderControl::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);

}

QWindow* QQuickRenderControl_virtualbase_renderWindow(void* self, QPoint* offset) {

	return ( (MiqtVirtualQQuickRenderControl*)(self) )->QQuickRenderControl::renderWindow(offset);

}

bool QQuickRenderControl_virtualbase_event(void* self, QEvent* event) {

	return ( (MiqtVirtualQQuickRenderControl*)(self) )->QQuickRenderControl::event(event);

}

bool QQuickRenderControl_virtualbase_eventFilter(void* self, QObject* watched, QEvent* event) {

	return ( (MiqtVirtualQQuickRenderControl*)(self) )->QQuickRenderControl::eventFilter(watched, event);

}

void QQuickRenderControl_virtualbase_timerEvent(void* self, QTimerEvent* event) {

	( (MiqtVirtualQQuickRenderControl*)(self) )->QQuickRenderControl::timerEvent(event);

}

void QQuickRenderControl_virtualbase_childEvent(void* self, QChildEvent* event) {

	( (MiqtVirtualQQuickRenderControl*)(self) )->QQuickRenderControl::childEvent(event);

}

void QQuickRenderControl_virtualbase_customEvent(void* self, QEvent* event) {

	( (MiqtVirtualQQuickRenderControl*)(self) )->QQuickRenderControl::customEvent(event);

}

void QQuickRenderControl_virtualbase_connectNotify(void* self, QMetaMethod* signal) {

	( (MiqtVirtualQQuickRenderControl*)(self) )->QQuickRenderControl::connectNotify(*signal);

}

void QQuickRenderControl_virtualbase_disconnectNotify(void* self, QMetaMethod* signal) {

	( (MiqtVirtualQQuickRenderControl*)(self) )->QQuickRenderControl::disconnectNotify(*signal);
