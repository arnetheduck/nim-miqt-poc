...
proc fcQQuickGraphicsConfiguration_preferredInstanceExtensions(): cQByteArrayList {.importc: "QQuickGraphicsConfiguration_preferredInstanceExtensions".}
proc fcQQuickGraphicsConfiguration_setDeviceExtensions(self: pointer, extensions: ptr cQByteArrayList): void {.importc: "QQuickGraphicsConfiguration_setDeviceExtensions".}
proc fcQQuickGraphicsConfiguration_deviceExtensions(self: pointer, ): cQByteArrayList {.importc: "QQuickGraphicsConfiguration_deviceExtensions".}
...
proc create*(T: type gen_qquickgraphicsconfiguration_types.QQuickGraphicsConfiguration, other: QQuickGraphicsConfiguration): gen_qquickgraphicsconfiguration_types.QQuickGraphicsConfiguration =
  gen_qquickgraphicsconfiguration_types.QQuickGraphicsConfiguration.init(fcQQuickGraphicsConfiguration_new2(other.h))

proc operatorAssign*(self: gen_qquickgraphicsconfiguration_types.QQuickGraphicsConfiguration, other: QQuickGraphicsConfiguration): void =
  fcQQuickGraphicsConfiguration_operatorAssign(self.h, other.h)

proc preferredInstanceExtensions*(_: type gen_qquickgraphicsconfiguration_types.QQuickGraphicsConfiguration, ): QByteArrayList =
TODO QByteArrayList
proc setDeviceExtensions*(self: gen_qquickgraphicsconfiguration_types.QQuickGraphicsConfiguration, extensions: ptr QByteArrayList): void =
  fcQQuickGraphicsConfiguration_setDeviceExtensions(self.h, extensions)

proc deviceExtensions*(self: gen_qquickgraphicsconfiguration_types.QQuickGraphicsConfiguration, ): QByteArrayList =
TODO QByteArrayList
