...
func init*(T: type gen_qsggeometry_types.QSGGeometry, h: ptr cQSGGeometry): gen_qsggeometry_types.QSGGeometry =
  T(h: h)
proc create*(T: type gen_qsggeometry_types.QSGGeometry, attribs: QSGGeometryAttributeSet, vertexCount: cint): gen_qsggeometry_types.QSGGeometry =
  gen_qsggeometry_types.QSGGeometry.init(fcQSGGeometry_new(attribs.h, vertexCount))

proc create*(T: type gen_qsggeometry_types.QSGGeometry, attribs: QSGGeometryAttributeSet, vertexCount: cint, indexCount: cint): gen_qsggeometry_types.QSGGeometry =
  gen_qsggeometry_types.QSGGeometry.init(fcQSGGeometry_new2(attribs.h, vertexCount, indexCount))

proc create*(T: type gen_qsggeometry_types.QSGGeometry, attribs: QSGGeometryAttributeSet, vertexCount: cint, indexCount: cint, indexType: cint): gen_qsggeometry_types.QSGGeometry =
  gen_qsggeometry_types.QSGGeometry.init(fcQSGGeometry_new3(attribs.h, vertexCount, indexCount, indexType))

proc defaultAttributes_Point2D*(_: type gen_qsggeometry_types.QSGGeometry, ): QSGGeometryAttributeSet =
  QSGGeometryAttributeSet(h: fcQSGGeometry_defaultAttributes_Point2D())

proc defaultAttributes_TexturedPoint2D*(_: type gen_qsggeometry_types.QSGGeometry, ): QSGGeometryAttributeSet =
  QSGGeometryAttributeSet(h: fcQSGGeometry_defaultAttributes_TexturedPoint2D())

proc defaultAttributes_ColoredPoint2D*(_: type gen_qsggeometry_types.QSGGeometry, ): QSGGeometryAttributeSet =
...
proc vertexDataAsPoint2D*(self: gen_qsggeometry_types.QSGGeometry, ): QSGGeometryPoint2D =
  QSGGeometryPoint2D(h: fcQSGGeometry_vertexDataAsPoint2D(self.h))

proc vertexDataAsTexturedPoint2D*(self: gen_qsggeometry_types.QSGGeometry, ): QSGGeometryTexturedPoint2D =
  QSGGeometryTexturedPoint2D(h: fcQSGGeometry_vertexDataAsTexturedPoint2D(self.h))

proc vertexDataAsColoredPoint2D*(self: gen_qsggeometry_types.QSGGeometry, ): QSGGeometryColoredPoint2D =
...
proc vertexDataAsPoint2D2*(self: gen_qsggeometry_types.QSGGeometry, ): QSGGeometryPoint2D =
  QSGGeometryPoint2D(h: fcQSGGeometry_vertexDataAsPoint2D2(self.h))

proc vertexDataAsTexturedPoint2D2*(self: gen_qsggeometry_types.QSGGeometry, ): QSGGeometryTexturedPoint2D =
  QSGGeometryTexturedPoint2D(h: fcQSGGeometry_vertexDataAsTexturedPoint2D2(self.h))

proc vertexDataAsColoredPoint2D2*(self: gen_qsggeometry_types.QSGGeometry, ): QSGGeometryColoredPoint2D =
...
proc attributes*(self: gen_qsggeometry_types.QSGGeometry, ): QSGGeometryAttribute =
...
proc updateRectGeometry*(_: type gen_qsggeometry_types.QSGGeometry, g: QSGGeometry, rect: QRectF): void =
  fcQSGGeometry_updateRectGeometry(g.h, rect.h)

proc updateTexturedRectGeometry*(_: type gen_qsggeometry_types.QSGGeometry, g: QSGGeometry, rect: QRectF, sourceRect: QRectF): void =
  fcQSGGeometry_updateTexturedRectGeometry(g.h, rect.h, sourceRect.h)

proc updateColoredRectGeometry*(_: type gen_qsggeometry_types.QSGGeometry, g: QSGGeometry, rect: QRectF): void =
...
func init*(T: type gen_qsggeometry_types.QSGGeometryAttribute, h: ptr cQSGGeometryAttribute): gen_qsggeometry_types.QSGGeometryAttribute =
  T(h: h)
proc create*(_: type gen_qsggeometry_types.QSGGeometryAttribute, pos: cint, tupleSize: cint, primitiveType: cint): QSGGeometryAttribute =
  QSGGeometryAttribute(h: fcQSGGeometryAttribute_create(pos, tupleSize, primitiveType))

proc createWithAttributeType*(_: type gen_qsggeometry_types.QSGGeometryAttribute, pos: cint, tupleSize: cint, primitiveType: cint, attributeType: cint): QSGGeometryAttribute =
  QSGGeometryAttribute(h: fcQSGGeometryAttribute_createWithAttributeType(pos, tupleSize, primitiveType, cint(attributeType)))

proc create*(_: type gen_qsggeometry_types.QSGGeometryAttribute, pos: cint, tupleSize: cint, primitiveType: cint, isPosition: bool): QSGGeometryAttribute =
...
func init*(T: type gen_qsggeometry_types.QSGGeometryAttributeSet, h: ptr cQSGGeometryAttributeSet): gen_qsggeometry_types.QSGGeometryAttributeSet =
  T(h: h)
proc delete*(self: gen_qsggeometry_types.QSGGeometryAttributeSet) =
  fcQSGGeometryAttributeSet_delete(self.h)

func init*(T: type gen_qsggeometry_types.QSGGeometryPoint2D, h: ptr cQSGGeometryPoint2D): gen_qsggeometry_types.QSGGeometryPoint2D =
  T(h: h)
...
func init*(T: type gen_qsggeometry_types.QSGGeometryTexturedPoint2D, h: ptr cQSGGeometryTexturedPoint2D): gen_qsggeometry_types.QSGGeometryTexturedPoint2D =
  T(h: h)
...
func init*(T: type gen_qsggeometry_types.QSGGeometryColoredPoint2D, h: ptr cQSGGeometryColoredPoint2D): gen_qsggeometry_types.QSGGeometryColoredPoint2D =
  T(h: h)
