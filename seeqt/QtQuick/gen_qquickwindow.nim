...
proc sendEvent*(self: gen_qquickwindow_types.QQuickWindow, param1: QQuickItem, param2: QEvent): bool =
...
proc setRenderTarget*(self: gen_qquickwindow_types.QQuickWindow, fboId: cuint, size: QSize): void =
...
proc renderTargetSize*(self: gen_qquickwindow_types.QQuickWindow, ): QSize =
  QSize(h: fcQQuickWindow_renderTargetSize(self.h))
...
proc createTextureFromId*(self: gen_qquickwindow_types.QQuickWindow, id: cuint, size: QSize): QSGTexture =
  QSGTexture(h: fcQQuickWindow_createTextureFromId(self.h, id, size.h))

proc createTextureFromNativeObject*(self: gen_qquickwindow_types.QQuickWindow, typeVal: cint, nativeObjectPtr: pointer, nativeLayout: cint, size: QSize): QSGTexture =
  QSGTexture(h: fcQQuickWindow_createTextureFromNativeObject(self.h, cint(typeVal), nativeObjectPtr, nativeLayout, size.h))
...
proc createTextureFromId*(self: gen_qquickwindow_types.QQuickWindow, id: cuint, size: QSize, options: cint): QSGTexture =
  QSGTexture(h: fcQQuickWindow_createTextureFromId3(self.h, id, size.h, cint(options)))

proc createTextureFromNativeObject*(self: gen_qquickwindow_types.QQuickWindow, typeVal: cint, nativeObjectPtr: pointer, nativeLayout: cint, size: QSize, options: cint): QSGTexture =
  QSGTexture(h: fcQQuickWindow_createTextureFromNativeObject5(self.h, cint(typeVal), nativeObjectPtr, nativeLayout, size.h, cint(options)))
