...
proc fQQuickWindow_connect_paletteChanged(self: pointer, slot: int) {.importc: "QQuickWindow_connect_paletteChanged".}
proc fcQQuickWindow_paletteCreated(self: pointer, ): void {.importc: "QQuickWindow_paletteCreated".}
proc fQQuickWindow_connect_paletteCreated(self: pointer, slot: int) {.importc: "QQuickWindow_connect_paletteCreated".}
proc fcQQuickWindow_beforeFrameBegin(self: pointer, ): void {.importc: "QQuickWindow_beforeFrameBegin".}
proc fQQuickWindow_connect_beforeFrameBegin(self: pointer, slot: int) {.importc: "QQuickWindow_connect_beforeFrameBegin".}
proc fcQQuickWindow_afterFrameEnd(self: pointer, ): void {.importc: "QQuickWindow_afterFrameEnd".}
proc fQQuickWindow_connect_afterFrameEnd(self: pointer, slot: int) {.importc: "QQuickWindow_connect_afterFrameEnd".}
...
proc create*(T: type gen_qquickwindow_types.QQuickWindow, renderControl: QQuickRenderControl): gen_qquickwindow_types.QQuickWindow =
  gen_qquickwindow_types.QQuickWindow.init(fcQQuickWindow_new2(renderControl.h))

proc create*(T: type gen_qquickwindow_types.QQuickWindow, parent: QWindow): gen_qquickwindow_types.QQuickWindow =
  gen_qquickwindow_types.QQuickWindow.init(fcQQuickWindow_new3(parent.h))

proc metaObject*(self: gen_qquickwindow_types.QQuickWindow, ): QMetaObject =
  QMetaObject(h: fcQQuickWindow_metaObject(self.h))
...
proc contentItem*(self: gen_qquickwindow_types.QQuickWindow, ): QQuickItem =
  QQuickItem(h: fcQQuickWindow_contentItem(self.h))

proc activeFocusItem*(self: gen_qquickwindow_types.QQuickWindow, ): QQuickItem =
  QQuickItem(h: fcQQuickWindow_activeFocusItem(self.h))

proc focusObject*(self: gen_qquickwindow_types.QQuickWindow, ): QObject =
  QObject(h: fcQQuickWindow_focusObject(self.h))

proc mouseGrabberItem*(self: gen_qquickwindow_types.QQuickWindow, ): QQuickItem =
  QQuickItem(h: fcQQuickWindow_mouseGrabberItem(self.h))

proc grabWindow*(self: gen_qquickwindow_types.QQuickWindow, ): QImage =
  QImage(h: fcQQuickWindow_grabWindow(self.h))

proc setRenderTarget*(self: gen_qquickwindow_types.QQuickWindow, target: QQuickRenderTarget): void =
  fcQQuickWindow_setRenderTarget(self.h, target.h)

proc renderTarget*(self: gen_qquickwindow_types.QQuickWindow, ): QQuickRenderTarget =
  QQuickRenderTarget(h: fcQQuickWindow_renderTarget(self.h))

proc graphicsStateInfo*(self: gen_qquickwindow_types.QQuickWindow, ): QQuickWindowGraphicsStateInfo =
...
proc incubationController*(self: gen_qquickwindow_types.QQuickWindow, ): QQmlIncubationController =
  QQmlIncubationController(h: fcQQuickWindow_incubationController(self.h))

proc accessibleRoot*(self: gen_qquickwindow_types.QQuickWindow, ): QAccessibleInterface =
  QAccessibleInterface(h: fcQQuickWindow_accessibleRoot(self.h))

proc createTextureFromImage*(self: gen_qquickwindow_types.QQuickWindow, image: QImage): QSGTexture =
  QSGTexture(h: fcQQuickWindow_createTextureFromImage(self.h, image.h))

proc createTextureFromImage*(self: gen_qquickwindow_types.QQuickWindow, image: QImage, options: cint): QSGTexture =
  QSGTexture(h: fcQQuickWindow_createTextureFromImage2(self.h, image.h, cint(options)))

proc setColor*(self: gen_qquickwindow_types.QQuickWindow, color: QColor): void =
  fcQQuickWindow_setColor(self.h, color.h)

proc color*(self: gen_qquickwindow_types.QQuickWindow, ): QColor =
  QColor(h: fcQQuickWindow_color(self.h))
...
proc scheduleRenderJob*(self: gen_qquickwindow_types.QQuickWindow, job: QRunnable, schedule: cint): void =
...
proc rendererInterface*(self: gen_qquickwindow_types.QQuickWindow, ): QSGRendererInterface =
  QSGRendererInterface(h: fcQQuickWindow_rendererInterface(self.h))
...
proc setGraphicsDevice*(self: gen_qquickwindow_types.QQuickWindow, device: QQuickGraphicsDevice): void =
  fcQQuickWindow_setGraphicsDevice(self.h, device.h)

proc graphicsDevice*(self: gen_qquickwindow_types.QQuickWindow, ): QQuickGraphicsDevice =
  QQuickGraphicsDevice(h: fcQQuickWindow_graphicsDevice(self.h))

proc setGraphicsConfiguration*(self: gen_qquickwindow_types.QQuickWindow, config: QQuickGraphicsConfiguration): void =
  fcQQuickWindow_setGraphicsConfiguration(self.h, config.h)

proc graphicsConfiguration*(self: gen_qquickwindow_types.QQuickWindow, ): QQuickGraphicsConfiguration =
  QQuickGraphicsConfiguration(h: fcQQuickWindow_graphicsConfiguration(self.h))

proc createRectangleNode*(self: gen_qquickwindow_types.QQuickWindow, ): QSGRectangleNode =
  QSGRectangleNode(h: fcQQuickWindow_createRectangleNode(self.h))

proc createImageNode*(self: gen_qquickwindow_types.QQuickWindow, ): QSGImageNode =
  QSGImageNode(h: fcQQuickWindow_createImageNode(self.h))

proc createNinePatchNode*(self: gen_qquickwindow_types.QQuickWindow, ): QSGNinePatchNode =
  QSGNinePatchNode(h: fcQQuickWindow_createNinePatchNode(self.h))
...
proc colorChanged*(self: gen_qquickwindow_types.QQuickWindow, param1: QColor): void =
  fcQQuickWindow_colorChanged(self.h, param1.h)

type QQuickWindowcolorChangedSlot* = proc(param1: QColor)
...
proc onpaletteChanged*(self: gen_qquickwindow_types.QQuickWindow, slot: QQuickWindowpaletteChangedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fQQuickWindow_connect_paletteChanged(self.h, cast[int](addr tmp[]))
...
proc onpaletteCreated*(self: gen_qquickwindow_types.QQuickWindow, slot: QQuickWindowpaletteCreatedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fQQuickWindow_connect_paletteCreated(self.h, cast[int](addr tmp[]))
...
proc onbeforeFrameBegin*(self: gen_qquickwindow_types.QQuickWindow, slot: QQuickWindowbeforeFrameBeginSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fQQuickWindow_connect_beforeFrameBegin(self.h, cast[int](addr tmp[]))
...
proc onafterFrameEnd*(self: gen_qquickwindow_types.QQuickWindow, slot: QQuickWindowafterFrameEndSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fQQuickWindow_connect_afterFrameEnd(self.h, cast[int](addr tmp[]))
...
proc miqt_exec_callback_QQuickWindow_metacall(self: ptr cQQuickWindow, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QQuickWindow_metacall ".} =
  ...
  virtualReturn
proc QQuickWindowfocusObject*(self: gen_qquickwindow_types.QQuickWindow, ): QObject =
  QObject(h: fQQuickWindow_virtualbase_focusObject(self.h))

type QQuickWindowfocusObjectProc* = proc(): QObject
...
proc miqt_exec_callback_QQuickWindow_focusObject(self: ptr cQQuickWindow, slot: int): pointer {.exportc: "miqt_exec_callback_QQuickWindow_focusObject ".} =
  ...
  virtualReturn.h
proc QQuickWindowaccessibleRoot*(self: gen_qquickwindow_types.QQuickWindow, ): QAccessibleInterface =
  QAccessibleInterface(h: fQQuickWindow_virtualbase_accessibleRoot(self.h))

type QQuickWindowaccessibleRootProc* = proc(): QAccessibleInterface
...
proc miqt_exec_callback_QQuickWindow_accessibleRoot(self: ptr cQQuickWindow, slot: int): pointer {.exportc: "miqt_exec_callback_QQuickWindow_accessibleRoot ".} =
  ...
  virtualReturn.h
proc QQuickWindowexposeEvent*(self: gen_qquickwindow_types.QQuickWindow, param1: QExposeEvent): void =
  fQQuickWindow_virtualbase_exposeEvent(self.h, param1.h)

type QQuickWindowexposeEventProc* = proc(param1: QExposeEvent): void
...
proc miqt_exec_callback_QQuickWindow_exposeEvent(self: ptr cQQuickWindow, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QQuickWindow_exposeEvent ".} =
  ...
  nimfunc[](slotval1)
proc QQuickWindowresizeEvent*(self: gen_qquickwindow_types.QQuickWindow, param1: QResizeEvent): void =
  fQQuickWindow_virtualbase_resizeEvent(self.h, param1.h)

type QQuickWindowresizeEventProc* = proc(param1: QResizeEvent): void
...
proc miqt_exec_callback_QQuickWindow_resizeEvent(self: ptr cQQuickWindow, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QQuickWindow_resizeEvent ".} =
  ...
  nimfunc[](slotval1)
proc QQuickWindowshowEvent*(self: gen_qquickwindow_types.QQuickWindow, param1: QShowEvent): void =
  fQQuickWindow_virtualbase_showEvent(self.h, param1.h)

type QQuickWindowshowEventProc* = proc(param1: QShowEvent): void
...
proc miqt_exec_callback_QQuickWindow_showEvent(self: ptr cQQuickWindow, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QQuickWindow_showEvent ".} =
  ...
  nimfunc[](slotval1)
proc QQuickWindowhideEvent*(self: gen_qquickwindow_types.QQuickWindow, param1: QHideEvent): void =
  fQQuickWindow_virtualbase_hideEvent(self.h, param1.h)

type QQuickWindowhideEventProc* = proc(param1: QHideEvent): void
...
proc miqt_exec_callback_QQuickWindow_hideEvent(self: ptr cQQuickWindow, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QQuickWindow_hideEvent ".} =
  ...
  nimfunc[](slotval1)
proc QQuickWindowcloseEvent*(self: gen_qquickwindow_types.QQuickWindow, param1: QCloseEvent): void =
  fQQuickWindow_virtualbase_closeEvent(self.h, param1.h)

type QQuickWindowcloseEventProc* = proc(param1: QCloseEvent): void
...
proc miqt_exec_callback_QQuickWindow_closeEvent(self: ptr cQQuickWindow, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QQuickWindow_closeEvent ".} =
  ...
  nimfunc[](slotval1)
proc QQuickWindowfocusInEvent*(self: gen_qquickwindow_types.QQuickWindow, param1: QFocusEvent): void =
  fQQuickWindow_virtualbase_focusInEvent(self.h, param1.h)

type QQuickWindowfocusInEventProc* = proc(param1: QFocusEvent): void
...
proc miqt_exec_callback_QQuickWindow_focusInEvent(self: ptr cQQuickWindow, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QQuickWindow_focusInEvent ".} =
  ...
  nimfunc[](slotval1)
proc QQuickWindowfocusOutEvent*(self: gen_qquickwindow_types.QQuickWindow, param1: QFocusEvent): void =
  fQQuickWindow_virtualbase_focusOutEvent(self.h, param1.h)

type QQuickWindowfocusOutEventProc* = proc(param1: QFocusEvent): void
...
proc miqt_exec_callback_QQuickWindow_focusOutEvent(self: ptr cQQuickWindow, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QQuickWindow_focusOutEvent ".} =
  ...
  nimfunc[](slotval1)
proc QQuickWindowevent*(self: gen_qquickwindow_types.QQuickWindow, param1: QEvent): bool =
  fQQuickWindow_virtualbase_event(self.h, param1.h)

type QQuickWindoweventProc* = proc(param1: QEvent): bool
...
proc miqt_exec_callback_QQuickWindow_event(self: ptr cQQuickWindow, slot: int, param1: pointer): bool {.exportc: "miqt_exec_callback_QQuickWindow_event ".} =
  ...
  virtualReturn
proc QQuickWindowkeyPressEvent*(self: gen_qquickwindow_types.QQuickWindow, param1: QKeyEvent): void =
  fQQuickWindow_virtualbase_keyPressEvent(self.h, param1.h)

type QQuickWindowkeyPressEventProc* = proc(param1: QKeyEvent): void
...
proc miqt_exec_callback_QQuickWindow_keyPressEvent(self: ptr cQQuickWindow, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QQuickWindow_keyPressEvent ".} =
  ...
  nimfunc[](slotval1)
proc QQuickWindowkeyReleaseEvent*(self: gen_qquickwindow_types.QQuickWindow, param1: QKeyEvent): void =
  fQQuickWindow_virtualbase_keyReleaseEvent(self.h, param1.h)

type QQuickWindowkeyReleaseEventProc* = proc(param1: QKeyEvent): void
...
proc miqt_exec_callback_QQuickWindow_keyReleaseEvent(self: ptr cQQuickWindow, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QQuickWindow_keyReleaseEvent ".} =
  ...
  nimfunc[](slotval1)
proc QQuickWindowmousePressEvent*(self: gen_qquickwindow_types.QQuickWindow, param1: QMouseEvent): void =
  fQQuickWindow_virtualbase_mousePressEvent(self.h, param1.h)

type QQuickWindowmousePressEventProc* = proc(param1: QMouseEvent): void
...
proc miqt_exec_callback_QQuickWindow_mousePressEvent(self: ptr cQQuickWindow, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QQuickWindow_mousePressEvent ".} =
  ...
  nimfunc[](slotval1)
proc QQuickWindowmouseReleaseEvent*(self: gen_qquickwindow_types.QQuickWindow, param1: QMouseEvent): void =
  fQQuickWindow_virtualbase_mouseReleaseEvent(self.h, param1.h)

type QQuickWindowmouseReleaseEventProc* = proc(param1: QMouseEvent): void
...
proc miqt_exec_callback_QQuickWindow_mouseReleaseEvent(self: ptr cQQuickWindow, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QQuickWindow_mouseReleaseEvent ".} =
  ...
  nimfunc[](slotval1)
proc QQuickWindowmouseDoubleClickEvent*(self: gen_qquickwindow_types.QQuickWindow, param1: QMouseEvent): void =
  fQQuickWindow_virtualbase_mouseDoubleClickEvent(self.h, param1.h)

type QQuickWindowmouseDoubleClickEventProc* = proc(param1: QMouseEvent): void
...
proc miqt_exec_callback_QQuickWindow_mouseDoubleClickEvent(self: ptr cQQuickWindow, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QQuickWindow_mouseDoubleClickEvent ".} =
  ...
  nimfunc[](slotval1)
proc QQuickWindowmouseMoveEvent*(self: gen_qquickwindow_types.QQuickWindow, param1: QMouseEvent): void =
  fQQuickWindow_virtualbase_mouseMoveEvent(self.h, param1.h)

type QQuickWindowmouseMoveEventProc* = proc(param1: QMouseEvent): void
...
proc miqt_exec_callback_QQuickWindow_mouseMoveEvent(self: ptr cQQuickWindow, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QQuickWindow_mouseMoveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QQuickWindowwheelEvent*(self: gen_qquickwindow_types.QQuickWindow, param1: QWheelEvent): void =
  fQQuickWindow_virtualbase_wheelEvent(self.h, param1.h)

type QQuickWindowwheelEventProc* = proc(param1: QWheelEvent): void
...
proc miqt_exec_callback_QQuickWindow_wheelEvent(self: ptr cQQuickWindow, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QQuickWindow_wheelEvent ".} =
  ...
  nimfunc[](slotval1)
proc QQuickWindowtabletEvent*(self: gen_qquickwindow_types.QQuickWindow, param1: QTabletEvent): void =
  fQQuickWindow_virtualbase_tabletEvent(self.h, param1.h)

type QQuickWindowtabletEventProc* = proc(param1: QTabletEvent): void
...
proc miqt_exec_callback_QQuickWindow_surfaceType(self: ptr cQQuickWindow, slot: int): cint {.exportc: "miqt_exec_callback_QQuickWindow_surfaceType ".} =
  ...
  cint(virtualReturn)
proc QQuickWindowformat*(self: gen_qquickwindow_types.QQuickWindow, ): QSurfaceFormat =
  QSurfaceFormat(h: fQQuickWindow_virtualbase_format(self.h))

type QQuickWindowformatProc* = proc(): QSurfaceFormat
...
proc miqt_exec_callback_QQuickWindow_format(self: ptr cQQuickWindow, slot: int): pointer {.exportc: "miqt_exec_callback_QQuickWindow_format ".} =
  ...
  virtualReturn.h
proc QQuickWindowsize*(self: gen_qquickwindow_types.QQuickWindow, ): QSize =
  QSize(h: fQQuickWindow_virtualbase_size(self.h))

type QQuickWindowsizeProc* = proc(): QSize
...
proc miqt_exec_callback_QQuickWindow_size(self: ptr cQQuickWindow, slot: int): pointer {.exportc: "miqt_exec_callback_QQuickWindow_size ".} =
  ...
  virtualReturn.h
proc QQuickWindowpaintEvent*(self: gen_qquickwindow_types.QQuickWindow, param1: QPaintEvent): void =
  fQQuickWindow_virtualbase_paintEvent(self.h, param1.h)

type QQuickWindowpaintEventProc* = proc(param1: QPaintEvent): void
...
proc miqt_exec_callback_QQuickWindow_paintEvent(self: ptr cQQuickWindow, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QQuickWindow_paintEvent ".} =
  ...
  nimfunc[](slotval1)
proc QQuickWindowmoveEvent*(self: gen_qquickwindow_types.QQuickWindow, param1: QMoveEvent): void =
  fQQuickWindow_virtualbase_moveEvent(self.h, param1.h)

type QQuickWindowmoveEventProc* = proc(param1: QMoveEvent): void
...
proc miqt_exec_callback_QQuickWindow_moveEvent(self: ptr cQQuickWindow, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QQuickWindow_moveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QQuickWindowtouchEvent*(self: gen_qquickwindow_types.QQuickWindow, param1: QTouchEvent): void =
  fQQuickWindow_virtualbase_touchEvent(self.h, param1.h)

type QQuickWindowtouchEventProc* = proc(param1: QTouchEvent): void
...
proc miqt_exec_callback_QQuickWindow_nativeEvent(self: ptr cQQuickWindow, slot: int, eventType: struct_miqt_string, message: pointer, resultVal: ptr uint): bool {.exportc: "miqt_exec_callback_QQuickWindow_nativeEvent ".} =
  ...
  virtualReturn
proc QQuickWindoweventFilter*(self: gen_qquickwindow_types.QQuickWindow, watched: QObject, event: QEvent): bool =
  fQQuickWindow_virtualbase_eventFilter(self.h, watched.h, event.h)

type QQuickWindoweventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QQuickWindow_eventFilter(self: ptr cQQuickWindow, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QQuickWindow_eventFilter ".} =
  ...
  virtualReturn
proc QQuickWindowtimerEvent*(self: gen_qquickwindow_types.QQuickWindow, event: QTimerEvent): void =
  fQQuickWindow_virtualbase_timerEvent(self.h, event.h)

type QQuickWindowtimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QQuickWindow_timerEvent(self: ptr cQQuickWindow, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QQuickWindow_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QQuickWindowchildEvent*(self: gen_qquickwindow_types.QQuickWindow, event: QChildEvent): void =
  fQQuickWindow_virtualbase_childEvent(self.h, event.h)

type QQuickWindowchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QQuickWindow_childEvent(self: ptr cQQuickWindow, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QQuickWindow_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QQuickWindowcustomEvent*(self: gen_qquickwindow_types.QQuickWindow, event: QEvent): void =
  fQQuickWindow_virtualbase_customEvent(self.h, event.h)

type QQuickWindowcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QQuickWindow_customEvent(self: ptr cQQuickWindow, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QQuickWindow_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QQuickWindowconnectNotify*(self: gen_qquickwindow_types.QQuickWindow, signal: QMetaMethod): void =
  fQQuickWindow_virtualbase_connectNotify(self.h, signal.h)

type QQuickWindowconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QQuickWindow_connectNotify(self: ptr cQQuickWindow, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QQuickWindow_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QQuickWindowdisconnectNotify*(self: gen_qquickwindow_types.QQuickWindow, signal: QMetaMethod): void =
  fQQuickWindow_virtualbase_disconnectNotify(self.h, signal.h)

type QQuickWindowdisconnectNotifyProc* = proc(signal: QMetaMethod): void
