...
proc fcQSGTexture_rhiTexture(self: pointer, ): ptr cQRhiTexture {.importc: "QSGTexture_rhiTexture".}
...
proc fQSGTexture_virtualbase_rhiTexture(self: pointer, ): ptr cQRhiTexture{.importc: "QSGTexture_virtualbase_rhiTexture".}
proc fcQSGTexture_override_virtual_rhiTexture(self: pointer, slot: int) {.importc: "QSGTexture_override_virtual_rhiTexture".}
...
proc fQSGDynamicTexture_virtualbase_rhiTexture(self: pointer, ): ptr cQRhiTexture{.importc: "QSGDynamicTexture_virtualbase_rhiTexture".}
proc fcQSGDynamicTexture_override_virtual_rhiTexture(self: pointer, slot: int) {.importc: "QSGDynamicTexture_override_virtual_rhiTexture".}
...
proc rhiTexture*(self: gen_qsgtexture_types.QSGTexture, ): ptr QRhiTexture =
TODO QRhiTexture
...
proc miqt_exec_callback_QSGTexture_comparisonKey(self: ptr cQSGTexture, slot: int): clonglong {.exportc: "miqt_exec_callback_QSGTexture_comparisonKey ".} =
  ...
  virtualReturn
proc QSGTexturerhiTexture*(self: gen_qsgtexture_types.QSGTexture, ): ptr QRhiTexture =
TODO QRhiTexture
type QSGTexturerhiTextureProc* = proc(): ptr QRhiTexture
proc onrhiTexture*(self: gen_qsgtexture_types.QSGTexture, slot: QSGTexturerhiTextureProc) =
  # TODO check subclass
  var tmp = new QSGTexturerhiTextureProc
  tmp[] = slot
  GC_ref(tmp)
  fcQSGTexture_override_virtual_rhiTexture(self.h, cast[int](addr tmp[]))

proc miqt_exec_callback_QSGTexture_rhiTexture(self: ptr cQSGTexture, slot: int): ptr cQRhiTexture {.exportc: "miqt_exec_callback_QSGTexture_rhiTexture ".} =
  var nimfunc = cast[ptr QSGTexturerhiTextureProc](cast[pointer](slot))
...
proc miqt_exec_callback_QSGDynamicTexture_comparisonKey(self: ptr cQSGDynamicTexture, slot: int): clonglong {.exportc: "miqt_exec_callback_QSGDynamicTexture_comparisonKey ".} =
  ...
  virtualReturn
proc QSGDynamicTexturerhiTexture*(self: gen_qsgtexture_types.QSGDynamicTexture, ): ptr QRhiTexture =
TODO QRhiTexture
type QSGDynamicTexturerhiTextureProc* = proc(): ptr QRhiTexture
proc onrhiTexture*(self: gen_qsgtexture_types.QSGDynamicTexture, slot: QSGDynamicTexturerhiTextureProc) =
  # TODO check subclass
  var tmp = new QSGDynamicTexturerhiTextureProc
  tmp[] = slot
  GC_ref(tmp)
  fcQSGDynamicTexture_override_virtual_rhiTexture(self.h, cast[int](addr tmp[]))

proc miqt_exec_callback_QSGDynamicTexture_rhiTexture(self: ptr cQSGDynamicTexture, slot: int): ptr cQRhiTexture {.exportc: "miqt_exec_callback_QSGDynamicTexture_rhiTexture ".} =
  var nimfunc = cast[ptr QSGDynamicTexturerhiTextureProc](cast[pointer](slot))
