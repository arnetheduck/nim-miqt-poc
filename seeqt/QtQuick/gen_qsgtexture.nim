...
type cQSGTextureVTable {.pure.} = object
  ...
  rhiTexture*: proc(vtbl, self: pointer, ): ptr cQRhiTexture {.cdecl, raises: [], gcsafe.}
...
proc fcQSGTexture_virtualbase_rhiTexture(self: pointer, ): ptr cQRhiTexture {.importc: "QSGTexture_virtualbase_rhiTexture".}
...
proc fcQSGDynamicTexture_virtualbase_rhiTexture(self: pointer, ): ptr cQRhiTexture {.importc: "QSGDynamicTexture_virtualbase_rhiTexture".}
...
type QSGTexturerhiTextureProc* = proc(self: QSGTexture): ptr QRhiTexture {.raises: [], gcsafe.}
...
type QSGTextureVTable* {.inheritable, pure.} = object
  ...
  rhiTexture*: QSGTexturerhiTextureProc
...
TODO QRhiTexture
proc miqt_exec_callback_cQSGTexture_rhiTexture(vtbl: pointer, self: pointer): ptr cQRhiTexture {.cdecl.} =
  let vtbl = cast[ptr QSGTextureVTable](vtbl)
  let self = QSGTexture(h: self)
  var virtualReturn = vtbl[].rhiTexture(self)
  virtualReturn
...
method rhiTexture*(self: VirtualQSGTexture, ): ptr QRhiTexture {.base.} =
  QSGTexturerhiTexture(self[])
proc miqt_exec_method_cQSGTexture_rhiTexture(vtbl: pointer, inst: pointer): ptr cQRhiTexture {.cdecl.} =
  let vtbl = cast[VirtualQSGTexture](cast[uint](vtbl) - uint(offsetOf(VirtualQSGTexture, vtbl)))
  var virtualReturn = vtbl.rhiTexture()
  virtualReturn
...
proc create*(T: type gen_qsgtexture_types.QSGTexture,
  ...
  if not isNil(vtbl[].rhiTexture):
    vtbl[].vtbl.rhiTexture = miqt_exec_callback_cQSGTexture_rhiTexture
...
proc create*(T: type gen_qsgtexture_types.QSGTexture,
  ...
  vtbl[].vtbl.rhiTexture = miqt_exec_method_cQSGTexture_rhiTexture
...
type QSGDynamicTexturerhiTextureProc* = proc(self: QSGDynamicTexture): ptr QRhiTexture {.raises: [], gcsafe.}
...
type QSGDynamicTextureVTable* {.inheritable, pure.} = object
  ...
  rhiTexture*: QSGDynamicTexturerhiTextureProc
...
TODO QRhiTexture
proc miqt_exec_callback_cQSGDynamicTexture_rhiTexture(vtbl: pointer, self: pointer): ptr cQRhiTexture {.cdecl.} =
  let vtbl = cast[ptr QSGDynamicTextureVTable](vtbl)
  let self = QSGDynamicTexture(h: self)
  var virtualReturn = vtbl[].rhiTexture(self)
  virtualReturn
...
method rhiTexture*(self: VirtualQSGDynamicTexture, ): ptr QRhiTexture {.base.} =
  QSGDynamicTexturerhiTexture(self[])
proc miqt_exec_method_cQSGDynamicTexture_rhiTexture(vtbl: pointer, inst: pointer): ptr cQRhiTexture {.cdecl.} =
  let vtbl = cast[VirtualQSGDynamicTexture](cast[uint](vtbl) - uint(offsetOf(VirtualQSGDynamicTexture, vtbl)))
  var virtualReturn = vtbl.rhiTexture()
  virtualReturn
...
proc create*(T: type gen_qsgtexture_types.QSGDynamicTexture,
  ...
  if not isNil(vtbl[].rhiTexture):
    vtbl[].vtbl.rhiTexture = miqt_exec_callback_cQSGDynamicTexture_rhiTexture
  if not isNil(vtbl[].textureSize):
...
proc create*(T: type gen_qsgtexture_types.QSGDynamicTexture,
  ...
  vtbl[].vtbl.rhiTexture = miqt_exec_method_cQSGDynamicTexture_rhiTexture
