...
proc create*(T: type gen_qquickrendercontrol_types.QQuickRenderControl, parent: QObject): gen_qquickrendercontrol_types.QQuickRenderControl =
  gen_qquickrendercontrol_types.QQuickRenderControl.init(fcQQuickRenderControl_new2(parent.h))

proc metaObject*(self: gen_qquickrendercontrol_types.QQuickRenderControl, ): QMetaObject =
  QMetaObject(h: fcQQuickRenderControl_metaObject(self.h))
...
proc prepareThread*(self: gen_qquickrendercontrol_types.QQuickRenderControl, targetThread: QThread): void =
...
proc renderWindowFor*(_: type gen_qquickrendercontrol_types.QQuickRenderControl, win: QQuickWindow): QWindow =
  QWindow(h: fcQQuickRenderControl_renderWindowFor(win.h))

proc renderWindow*(self: gen_qquickrendercontrol_types.QQuickRenderControl, offset: QPoint): QWindow =
  QWindow(h: fcQQuickRenderControl_renderWindow(self.h, offset.h))

proc window*(self: gen_qquickrendercontrol_types.QQuickRenderControl, ): QQuickWindow =
  QQuickWindow(h: fcQQuickRenderControl_window(self.h))
...
proc renderWindowFor*(_: type gen_qquickrendercontrol_types.QQuickRenderControl, win: QQuickWindow, offset: QPoint): QWindow =
  QWindow(h: fcQQuickRenderControl_renderWindowFor2(win.h, offset.h))
...
proc miqt_exec_callback_QQuickRenderControl_metacall(self: ptr cQQuickRenderControl, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QQuickRenderControl_metacall ".} =
  ...
  virtualReturn
proc QQuickRenderControlrenderWindow*(self: gen_qquickrendercontrol_types.QQuickRenderControl, offset: QPoint): QWindow =
  QWindow(h: fQQuickRenderControl_virtualbase_renderWindow(self.h, offset.h))

type QQuickRenderControlrenderWindowProc* = proc(offset: QPoint): QWindow
...
proc miqt_exec_callback_QQuickRenderControl_renderWindow(self: ptr cQQuickRenderControl, slot: int, offset: pointer): pointer {.exportc: "miqt_exec_callback_QQuickRenderControl_renderWindow ".} =
  ...
  virtualReturn.h
proc QQuickRenderControlevent*(self: gen_qquickrendercontrol_types.QQuickRenderControl, event: QEvent): bool =
  fQQuickRenderControl_virtualbase_event(self.h, event.h)

type QQuickRenderControleventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QQuickRenderControl_event(self: ptr cQQuickRenderControl, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QQuickRenderControl_event ".} =
  ...
  virtualReturn
proc QQuickRenderControleventFilter*(self: gen_qquickrendercontrol_types.QQuickRenderControl, watched: QObject, event: QEvent): bool =
  fQQuickRenderControl_virtualbase_eventFilter(self.h, watched.h, event.h)

type QQuickRenderControleventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QQuickRenderControl_eventFilter(self: ptr cQQuickRenderControl, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QQuickRenderControl_eventFilter ".} =
  ...
  virtualReturn
proc QQuickRenderControltimerEvent*(self: gen_qquickrendercontrol_types.QQuickRenderControl, event: QTimerEvent): void =
  fQQuickRenderControl_virtualbase_timerEvent(self.h, event.h)

type QQuickRenderControltimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QQuickRenderControl_timerEvent(self: ptr cQQuickRenderControl, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QQuickRenderControl_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QQuickRenderControlchildEvent*(self: gen_qquickrendercontrol_types.QQuickRenderControl, event: QChildEvent): void =
  fQQuickRenderControl_virtualbase_childEvent(self.h, event.h)

type QQuickRenderControlchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QQuickRenderControl_childEvent(self: ptr cQQuickRenderControl, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QQuickRenderControl_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QQuickRenderControlcustomEvent*(self: gen_qquickrendercontrol_types.QQuickRenderControl, event: QEvent): void =
  fQQuickRenderControl_virtualbase_customEvent(self.h, event.h)

type QQuickRenderControlcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QQuickRenderControl_customEvent(self: ptr cQQuickRenderControl, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QQuickRenderControl_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QQuickRenderControlconnectNotify*(self: gen_qquickrendercontrol_types.QQuickRenderControl, signal: QMetaMethod): void =
  fQQuickRenderControl_virtualbase_connectNotify(self.h, signal.h)

type QQuickRenderControlconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QQuickRenderControl_connectNotify(self: ptr cQQuickRenderControl, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QQuickRenderControl_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QQuickRenderControldisconnectNotify*(self: gen_qquickrendercontrol_types.QQuickRenderControl, signal: QMetaMethod): void =
  fQQuickRenderControl_virtualbase_disconnectNotify(self.h, signal.h)

type QQuickRenderControldisconnectNotifyProc* = proc(signal: QMetaMethod): void
