...
proc create*(T: type gen_qqmlwebchannel_types.QQmlWebChannel, parent: QObject): gen_qqmlwebchannel_types.QQmlWebChannel =
  gen_qqmlwebchannel_types.QQmlWebChannel.init(fcQQmlWebChannel_new2(parent.h))

proc metaObject*(self: gen_qqmlwebchannel_types.QQmlWebChannel, ): QMetaObject =
  QMetaObject(h: fcQQmlWebChannel_metaObject(self.h))
...
proc registerObjects*(self: gen_qqmlwebchannel_types.QQmlWebChannel, objects: Table[string,QVariant]): void =
...
proc connectTo*(self: gen_qqmlwebchannel_types.QQmlWebChannel, transport: QObject): void =
  fcQQmlWebChannel_connectTo(self.h, transport.h)

proc disconnectFrom*(self: gen_qqmlwebchannel_types.QQmlWebChannel, transport: QObject): void =
...
proc miqt_exec_callback_QQmlWebChannel_metacall(self: ptr cQQmlWebChannel, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QQmlWebChannel_metacall ".} =
  ...
  virtualReturn
proc QQmlWebChannelevent*(self: gen_qqmlwebchannel_types.QQmlWebChannel, event: QEvent): bool =
  fQQmlWebChannel_virtualbase_event(self.h, event.h)

type QQmlWebChanneleventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QQmlWebChannel_event(self: ptr cQQmlWebChannel, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QQmlWebChannel_event ".} =
  ...
  virtualReturn
proc QQmlWebChanneleventFilter*(self: gen_qqmlwebchannel_types.QQmlWebChannel, watched: QObject, event: QEvent): bool =
  fQQmlWebChannel_virtualbase_eventFilter(self.h, watched.h, event.h)

type QQmlWebChanneleventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QQmlWebChannel_eventFilter(self: ptr cQQmlWebChannel, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QQmlWebChannel_eventFilter ".} =
  ...
  virtualReturn
proc QQmlWebChanneltimerEvent*(self: gen_qqmlwebchannel_types.QQmlWebChannel, event: QTimerEvent): void =
  fQQmlWebChannel_virtualbase_timerEvent(self.h, event.h)

type QQmlWebChanneltimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QQmlWebChannel_timerEvent(self: ptr cQQmlWebChannel, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QQmlWebChannel_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QQmlWebChannelchildEvent*(self: gen_qqmlwebchannel_types.QQmlWebChannel, event: QChildEvent): void =
  fQQmlWebChannel_virtualbase_childEvent(self.h, event.h)

type QQmlWebChannelchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QQmlWebChannel_childEvent(self: ptr cQQmlWebChannel, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QQmlWebChannel_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QQmlWebChannelcustomEvent*(self: gen_qqmlwebchannel_types.QQmlWebChannel, event: QEvent): void =
  fQQmlWebChannel_virtualbase_customEvent(self.h, event.h)

type QQmlWebChannelcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QQmlWebChannel_customEvent(self: ptr cQQmlWebChannel, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QQmlWebChannel_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QQmlWebChannelconnectNotify*(self: gen_qqmlwebchannel_types.QQmlWebChannel, signal: QMetaMethod): void =
  fQQmlWebChannel_virtualbase_connectNotify(self.h, signal.h)

type QQmlWebChannelconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QQmlWebChannel_connectNotify(self: ptr cQQmlWebChannel, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QQmlWebChannel_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QQmlWebChanneldisconnectNotify*(self: gen_qqmlwebchannel_types.QQmlWebChannel, signal: QMetaMethod): void =
  fQQmlWebChannel_virtualbase_disconnectNotify(self.h, signal.h)

type QQmlWebChanneldisconnectNotifyProc* = proc(signal: QMetaMethod): void
