...
proc create*(T: type gen_qwebchannel_types.QWebChannel, parent: QObject): gen_qwebchannel_types.QWebChannel =
  gen_qwebchannel_types.QWebChannel.init(fcQWebChannel_new2(parent.h))

proc metaObject*(self: gen_qwebchannel_types.QWebChannel, ): QMetaObject =
  QMetaObject(h: fcQWebChannel_metaObject(self.h))
...
proc registerObjects*(self: gen_qwebchannel_types.QWebChannel, objects: Table[string,QObject]): void =
...
proc registeredObjects*(self: gen_qwebchannel_types.QWebChannel, ): Table[string,QObject] =
  var v_mm = fcQWebChannel_registeredObjects(self.h)
  var vx_ret: Table[string, QObject]
  ...
  for i in 0..<v_mm.len:
    ...
    var v_entry_Value = QObject(h: v_Values[i])

    vx_ret[v_entry_Key] = v_entry_Value
  vx_ret

proc registerObject*(self: gen_qwebchannel_types.QWebChannel, id: string, objectVal: QObject): void =
  fcQWebChannel_registerObject(self.h, struct_miqt_string(data: id, len: csize_t(len(id))), objectVal.h)

proc deregisterObject*(self: gen_qwebchannel_types.QWebChannel, objectVal: QObject): void =
...
proc connectTo*(self: gen_qwebchannel_types.QWebChannel, transport: QWebChannelAbstractTransport): void =
  fcQWebChannel_connectTo(self.h, transport.h)

proc disconnectFrom*(self: gen_qwebchannel_types.QWebChannel, transport: QWebChannelAbstractTransport): void =
...
proc miqt_exec_callback_QWebChannel_metacall(self: ptr cQWebChannel, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QWebChannel_metacall ".} =
  ...
  virtualReturn
proc QWebChannelevent*(self: gen_qwebchannel_types.QWebChannel, event: QEvent): bool =
  fQWebChannel_virtualbase_event(self.h, event.h)

type QWebChanneleventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QWebChannel_event(self: ptr cQWebChannel, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QWebChannel_event ".} =
  ...
  virtualReturn
proc QWebChanneleventFilter*(self: gen_qwebchannel_types.QWebChannel, watched: QObject, event: QEvent): bool =
  fQWebChannel_virtualbase_eventFilter(self.h, watched.h, event.h)

type QWebChanneleventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QWebChannel_eventFilter(self: ptr cQWebChannel, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QWebChannel_eventFilter ".} =
  ...
  virtualReturn
proc QWebChanneltimerEvent*(self: gen_qwebchannel_types.QWebChannel, event: QTimerEvent): void =
  fQWebChannel_virtualbase_timerEvent(self.h, event.h)

type QWebChanneltimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QWebChannel_timerEvent(self: ptr cQWebChannel, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QWebChannel_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QWebChannelchildEvent*(self: gen_qwebchannel_types.QWebChannel, event: QChildEvent): void =
  fQWebChannel_virtualbase_childEvent(self.h, event.h)

type QWebChannelchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QWebChannel_childEvent(self: ptr cQWebChannel, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QWebChannel_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QWebChannelcustomEvent*(self: gen_qwebchannel_types.QWebChannel, event: QEvent): void =
  fQWebChannel_virtualbase_customEvent(self.h, event.h)

type QWebChannelcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QWebChannel_customEvent(self: ptr cQWebChannel, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QWebChannel_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QWebChannelconnectNotify*(self: gen_qwebchannel_types.QWebChannel, signal: QMetaMethod): void =
  fQWebChannel_virtualbase_connectNotify(self.h, signal.h)

type QWebChannelconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QWebChannel_connectNotify(self: ptr cQWebChannel, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QWebChannel_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QWebChanneldisconnectNotify*(self: gen_qwebchannel_types.QWebChannel, signal: QMetaMethod): void =
  fQWebChannel_virtualbase_disconnectNotify(self.h, signal.h)

type QWebChanneldisconnectNotifyProc* = proc(signal: QMetaMethod): void
