...
QMetaObject* QWebChannel_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQWebChannel*)(self) )->QWebChannel::metaObject();

}

void* QWebChannel_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQWebChannel*)(self) )->QWebChannel::qt_metacast(param1);

}

int QWebChannel_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQWebChannel*)(self) )->QWebChannel::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
