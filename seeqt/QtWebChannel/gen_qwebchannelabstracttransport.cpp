...
void QWebChannelAbstractTransport_connect_messageReceived(QWebChannelAbstractTransport* self, intptr_t slot, void (*callback)(intptr_t, QJsonObject*, QWebChannelAbstractTransport*), void (*release)(intptr_t)) {
	...
	MiqtVirtualQWebChannelAbstractTransport::connect(self, static_cast<void (QWebChannelAbstractTransport::*)(const QJsonObject&, QWebChannelAbstractTransport*)>(&QWebChannelAbstractTransport::messageReceived), self, caller{slot, callback, release});
}
...
QMetaObject* QWebChannelAbstractTransport_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQWebChannelAbstractTransport*)(self) )->QWebChannelAbstractTransport::metaObject();

}

void* QWebChannelAbstractTransport_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQWebChannelAbstractTransport*)(self) )->QWebChannelAbstractTransport::qt_metacast(param1);

}

int QWebChannelAbstractTransport_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQWebChannelAbstractTransport*)(self) )->QWebChannelAbstractTransport::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
QObject* QWebChannelAbstractTransport_protectedbase_sender(const void* self) {
	MiqtVirtualQWebChannelAbstractTransport* self_cast = static_cast<MiqtVirtualQWebChannelAbstractTransport*>( (QWebChannelAbstractTransport*)(self) );
