...
const cflags = gorge("pkg-config --cflags Qt6WebEngineQuick")
...
proc fcQQuickWebEngineProfile_userScripts(self: pointer, ): ptr cQQuickWebEngineScriptCollection {.importc: "QQuickWebEngineProfile_userScripts".}
...
proc fQQuickWebEngineProfile_connect_storageNameChanged(self: pointer, slot: int) {.importc: "QQuickWebEngineProfile_connect_storageNameChanged".}
proc fcQQuickWebEngineProfile_offTheRecordChanged(self: pointer, ): void {.importc: "QQuickWebEngineProfile_offTheRecordChanged".}
proc fQQuickWebEngineProfile_connect_offTheRecordChanged(self: pointer, slot: int) {.importc: "QQuickWebEngineProfile_connect_offTheRecordChanged".}
...
proc fQQuickWebEngineProfile_connect_persistentStoragePathChanged(self: pointer, slot: int) {.importc: "QQuickWebEngineProfile_connect_persistentStoragePathChanged".}
proc fcQQuickWebEngineProfile_cachePathChanged(self: pointer, ): void {.importc: "QQuickWebEngineProfile_cachePathChanged".}
proc fQQuickWebEngineProfile_connect_cachePathChanged(self: pointer, slot: int) {.importc: "QQuickWebEngineProfile_connect_cachePathChanged".}
proc fcQQuickWebEngineProfile_httpUserAgentChanged(self: pointer, ): void {.importc: "QQuickWebEngineProfile_httpUserAgentChanged".}
proc fQQuickWebEngineProfile_connect_httpUserAgentChanged(self: pointer, slot: int) {.importc: "QQuickWebEngineProfile_connect_httpUserAgentChanged".}
proc fcQQuickWebEngineProfile_httpCacheTypeChanged(self: pointer, ): void {.importc: "QQuickWebEngineProfile_httpCacheTypeChanged".}
proc fQQuickWebEngineProfile_connect_httpCacheTypeChanged(self: pointer, slot: int) {.importc: "QQuickWebEngineProfile_connect_httpCacheTypeChanged".}
...
proc fQQuickWebEngineProfile_connect_persistentCookiesPolicyChanged(self: pointer, slot: int) {.importc: "QQuickWebEngineProfile_connect_persistentCookiesPolicyChanged".}
...
proc fQQuickWebEngineProfile_connect_httpCacheMaximumSizeChanged(self: pointer, slot: int) {.importc: "QQuickWebEngineProfile_connect_httpCacheMaximumSizeChanged".}
...
proc fQQuickWebEngineProfile_connect_httpAcceptLanguageChanged(self: pointer, slot: int) {.importc: "QQuickWebEngineProfile_connect_httpAcceptLanguageChanged".}
...
proc fQQuickWebEngineProfile_connect_spellCheckLanguagesChanged(self: pointer, slot: int) {.importc: "QQuickWebEngineProfile_connect_spellCheckLanguagesChanged".}
...
proc fQQuickWebEngineProfile_connect_spellCheckEnabledChanged(self: pointer, slot: int) {.importc: "QQuickWebEngineProfile_connect_spellCheckEnabledChanged".}
proc fcQQuickWebEngineProfile_downloadPathChanged(self: pointer, ): void {.importc: "QQuickWebEngineProfile_downloadPathChanged".}
proc fQQuickWebEngineProfile_connect_downloadPathChanged(self: pointer, slot: int) {.importc: "QQuickWebEngineProfile_connect_downloadPathChanged".}
proc fcQQuickWebEngineProfile_downloadRequested(self: pointer, download: ptr cQQuickWebEngineDownloadRequest): void {.importc: "QQuickWebEngineProfile_downloadRequested".}
proc fQQuickWebEngineProfile_connect_downloadRequested(self: pointer, slot: int) {.importc: "QQuickWebEngineProfile_connect_downloadRequested".}
proc fcQQuickWebEngineProfile_downloadFinished(self: pointer, download: ptr cQQuickWebEngineDownloadRequest): void {.importc: "QQuickWebEngineProfile_downloadFinished".}
proc fQQuickWebEngineProfile_connect_downloadFinished(self: pointer, slot: int) {.importc: "QQuickWebEngineProfile_connect_downloadFinished".}
...
proc fQQuickWebEngineProfile_connect_presentNotification(self: pointer, slot: int) {.importc: "QQuickWebEngineProfile_connect_presentNotification".}
...
proc create*(T: type gen_qquickwebengineprofile_types.QQuickWebEngineProfile, parent: QObject): gen_qquickwebengineprofile_types.QQuickWebEngineProfile =
  gen_qquickwebengineprofile_types.QQuickWebEngineProfile.init(fcQQuickWebEngineProfile_new2(parent.h))

proc metaObject*(self: gen_qquickwebengineprofile_types.QQuickWebEngineProfile, ): QMetaObject =
  QMetaObject(h: fcQQuickWebEngineProfile_metaObject(self.h))
...
proc cookieStore*(self: gen_qquickwebengineprofile_types.QQuickWebEngineProfile, ): QWebEngineCookieStore =
  QWebEngineCookieStore(h: fcQQuickWebEngineProfile_cookieStore(self.h))

proc setUrlRequestInterceptor*(self: gen_qquickwebengineprofile_types.QQuickWebEngineProfile, interceptor: QWebEngineUrlRequestInterceptor): void =
  fcQQuickWebEngineProfile_setUrlRequestInterceptor(self.h, interceptor.h)

proc urlSchemeHandler*(self: gen_qquickwebengineprofile_types.QQuickWebEngineProfile, param1: seq[byte]): QWebEngineUrlSchemeHandler =
  QWebEngineUrlSchemeHandler(h: fcQQuickWebEngineProfile_urlSchemeHandler(self.h, struct_miqt_string(data: cast[cstring](if len(param1) == 0: nil else: unsafeAddr param1[0]), len: csize_t(len(param1)))))

proc installUrlSchemeHandler*(self: gen_qquickwebengineprofile_types.QQuickWebEngineProfile, scheme: seq[byte], param2: QWebEngineUrlSchemeHandler): void =
...
proc removeUrlSchemeHandler*(self: gen_qquickwebengineprofile_types.QQuickWebEngineProfile, param1: QWebEngineUrlSchemeHandler): void =
...
proc userScripts*(self: gen_qquickwebengineprofile_types.QQuickWebEngineProfile, ): ptr QQuickWebEngineScriptCollection =
TODO QQuickWebEngineScriptCollection
...
proc clientCertificateStore*(self: gen_qquickwebengineprofile_types.QQuickWebEngineProfile, ): QWebEngineClientCertificateStore =
  QWebEngineClientCertificateStore(h: fcQQuickWebEngineProfile_clientCertificateStore(self.h))

proc defaultProfile*(_: type gen_qquickwebengineprofile_types.QQuickWebEngineProfile, ): QQuickWebEngineProfile =
  QQuickWebEngineProfile(h: fcQQuickWebEngineProfile_defaultProfile())
...
proc onstorageNameChanged*(self: gen_qquickwebengineprofile_types.QQuickWebEngineProfile, slot: QQuickWebEngineProfilestorageNameChangedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fQQuickWebEngineProfile_connect_storageNameChanged(self.h, cast[int](addr tmp[]))
...
proc onoffTheRecordChanged*(self: gen_qquickwebengineprofile_types.QQuickWebEngineProfile, slot: QQuickWebEngineProfileoffTheRecordChangedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fQQuickWebEngineProfile_connect_offTheRecordChanged(self.h, cast[int](addr tmp[]))
...
proc onpersistentStoragePathChanged*(self: gen_qquickwebengineprofile_types.QQuickWebEngineProfile, slot: QQuickWebEngineProfilepersistentStoragePathChangedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fQQuickWebEngineProfile_connect_persistentStoragePathChanged(self.h, cast[int](addr tmp[]))
...
proc oncachePathChanged*(self: gen_qquickwebengineprofile_types.QQuickWebEngineProfile, slot: QQuickWebEngineProfilecachePathChangedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fQQuickWebEngineProfile_connect_cachePathChanged(self.h, cast[int](addr tmp[]))
...
proc onhttpUserAgentChanged*(self: gen_qquickwebengineprofile_types.QQuickWebEngineProfile, slot: QQuickWebEngineProfilehttpUserAgentChangedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fQQuickWebEngineProfile_connect_httpUserAgentChanged(self.h, cast[int](addr tmp[]))
...
proc onhttpCacheTypeChanged*(self: gen_qquickwebengineprofile_types.QQuickWebEngineProfile, slot: QQuickWebEngineProfilehttpCacheTypeChangedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fQQuickWebEngineProfile_connect_httpCacheTypeChanged(self.h, cast[int](addr tmp[]))
...
proc onpersistentCookiesPolicyChanged*(self: gen_qquickwebengineprofile_types.QQuickWebEngineProfile, slot: QQuickWebEngineProfilepersistentCookiesPolicyChangedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fQQuickWebEngineProfile_connect_persistentCookiesPolicyChanged(self.h, cast[int](addr tmp[]))
...
proc onhttpCacheMaximumSizeChanged*(self: gen_qquickwebengineprofile_types.QQuickWebEngineProfile, slot: QQuickWebEngineProfilehttpCacheMaximumSizeChangedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fQQuickWebEngineProfile_connect_httpCacheMaximumSizeChanged(self.h, cast[int](addr tmp[]))
...
proc onhttpAcceptLanguageChanged*(self: gen_qquickwebengineprofile_types.QQuickWebEngineProfile, slot: QQuickWebEngineProfilehttpAcceptLanguageChangedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fQQuickWebEngineProfile_connect_httpAcceptLanguageChanged(self.h, cast[int](addr tmp[]))
...
proc onspellCheckLanguagesChanged*(self: gen_qquickwebengineprofile_types.QQuickWebEngineProfile, slot: QQuickWebEngineProfilespellCheckLanguagesChangedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fQQuickWebEngineProfile_connect_spellCheckLanguagesChanged(self.h, cast[int](addr tmp[]))
...
proc onspellCheckEnabledChanged*(self: gen_qquickwebengineprofile_types.QQuickWebEngineProfile, slot: QQuickWebEngineProfilespellCheckEnabledChangedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fQQuickWebEngineProfile_connect_spellCheckEnabledChanged(self.h, cast[int](addr tmp[]))
...
proc ondownloadPathChanged*(self: gen_qquickwebengineprofile_types.QQuickWebEngineProfile, slot: QQuickWebEngineProfiledownloadPathChangedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fQQuickWebEngineProfile_connect_downloadPathChanged(self.h, cast[int](addr tmp[]))

proc downloadRequested*(self: gen_qquickwebengineprofile_types.QQuickWebEngineProfile, download: ptr QQuickWebEngineDownloadRequest): void =
  fcQQuickWebEngineProfile_downloadRequested(self.h, download)

type QQuickWebEngineProfiledownloadRequestedSlot* = proc(download: ptr QQuickWebEngineDownloadRequest)
proc miqt_exec_callback_QQuickWebEngineProfile_downloadRequested(slot: int, download: ptr cQQuickWebEngineDownloadRequest) {.exportc.} =
  let nimfunc = cast[ptr QQuickWebEngineProfiledownloadRequestedSlot](cast[pointer](slot))
TODO QQuickWebEngineDownloadRequest
  nimfunc[](slotval1)
...
proc ondownloadRequested*(self: gen_qquickwebengineprofile_types.QQuickWebEngineProfile, slot: QQuickWebEngineProfiledownloadRequestedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fQQuickWebEngineProfile_connect_downloadRequested(self.h, cast[int](addr tmp[]))

proc downloadFinished*(self: gen_qquickwebengineprofile_types.QQuickWebEngineProfile, download: ptr QQuickWebEngineDownloadRequest): void =
  fcQQuickWebEngineProfile_downloadFinished(self.h, download)

type QQuickWebEngineProfiledownloadFinishedSlot* = proc(download: ptr QQuickWebEngineDownloadRequest)
proc miqt_exec_callback_QQuickWebEngineProfile_downloadFinished(slot: int, download: ptr cQQuickWebEngineDownloadRequest) {.exportc.} =
...
proc ondownloadFinished*(self: gen_qquickwebengineprofile_types.QQuickWebEngineProfile, slot: QQuickWebEngineProfiledownloadFinishedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fQQuickWebEngineProfile_connect_downloadFinished(self.h, cast[int](addr tmp[]))

proc presentNotification*(self: gen_qquickwebengineprofile_types.QQuickWebEngineProfile, notification: QWebEngineNotification): void =
  fcQQuickWebEngineProfile_presentNotification(self.h, notification.h)

type QQuickWebEngineProfilepresentNotificationSlot* = proc(notification: QWebEngineNotification)
proc miqt_exec_callback_QQuickWebEngineProfile_presentNotification(slot: int, notification: pointer) {.exportc.} =
  ...
  let slotval1 = QWebEngineNotification(h: notification)
...
proc onpresentNotification*(self: gen_qquickwebengineprofile_types.QQuickWebEngineProfile, slot: QQuickWebEngineProfilepresentNotificationSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fQQuickWebEngineProfile_connect_presentNotification(self.h, cast[int](addr tmp[]))
...
proc miqt_exec_callback_QQuickWebEngineProfile_metacall(self: ptr cQQuickWebEngineProfile, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QQuickWebEngineProfile_metacall ".} =
  ...
  virtualReturn
proc QQuickWebEngineProfileevent*(self: gen_qquickwebengineprofile_types.QQuickWebEngineProfile, event: QEvent): bool =
  fQQuickWebEngineProfile_virtualbase_event(self.h, event.h)

type QQuickWebEngineProfileeventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QQuickWebEngineProfile_event(self: ptr cQQuickWebEngineProfile, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QQuickWebEngineProfile_event ".} =
  ...
  virtualReturn
proc QQuickWebEngineProfileeventFilter*(self: gen_qquickwebengineprofile_types.QQuickWebEngineProfile, watched: QObject, event: QEvent): bool =
  fQQuickWebEngineProfile_virtualbase_eventFilter(self.h, watched.h, event.h)

type QQuickWebEngineProfileeventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QQuickWebEngineProfile_eventFilter(self: ptr cQQuickWebEngineProfile, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QQuickWebEngineProfile_eventFilter ".} =
  ...
  virtualReturn
proc QQuickWebEngineProfiletimerEvent*(self: gen_qquickwebengineprofile_types.QQuickWebEngineProfile, event: QTimerEvent): void =
  fQQuickWebEngineProfile_virtualbase_timerEvent(self.h, event.h)

type QQuickWebEngineProfiletimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QQuickWebEngineProfile_timerEvent(self: ptr cQQuickWebEngineProfile, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QQuickWebEngineProfile_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QQuickWebEngineProfilechildEvent*(self: gen_qquickwebengineprofile_types.QQuickWebEngineProfile, event: QChildEvent): void =
  fQQuickWebEngineProfile_virtualbase_childEvent(self.h, event.h)

type QQuickWebEngineProfilechildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QQuickWebEngineProfile_childEvent(self: ptr cQQuickWebEngineProfile, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QQuickWebEngineProfile_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QQuickWebEngineProfilecustomEvent*(self: gen_qquickwebengineprofile_types.QQuickWebEngineProfile, event: QEvent): void =
  fQQuickWebEngineProfile_virtualbase_customEvent(self.h, event.h)

type QQuickWebEngineProfilecustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QQuickWebEngineProfile_customEvent(self: ptr cQQuickWebEngineProfile, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QQuickWebEngineProfile_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QQuickWebEngineProfileconnectNotify*(self: gen_qquickwebengineprofile_types.QQuickWebEngineProfile, signal: QMetaMethod): void =
  fQQuickWebEngineProfile_virtualbase_connectNotify(self.h, signal.h)

type QQuickWebEngineProfileconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QQuickWebEngineProfile_connectNotify(self: ptr cQQuickWebEngineProfile, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QQuickWebEngineProfile_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QQuickWebEngineProfiledisconnectNotify*(self: gen_qquickwebengineprofile_types.QQuickWebEngineProfile, signal: QMetaMethod): void =
  fQQuickWebEngineProfile_virtualbase_disconnectNotify(self.h, signal.h)

type QQuickWebEngineProfiledisconnectNotifyProc* = proc(signal: QMetaMethod): void
