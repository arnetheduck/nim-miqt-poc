...
class MiqtVirtualQQuickWebEngineProfile final : public QQuickWebEngineProfile {
	struct QQuickWebEngineProfile_VTable* vtbl;
public:

	MiqtVirtualQQuickWebEngineProfile(struct QQuickWebEngineProfile_VTable* vtbl): QQuickWebEngineProfile(), vtbl(vtbl) {};
	MiqtVirtualQQuickWebEngineProfile(struct QQuickWebEngineProfile_VTable* vtbl, QObject* parent): QQuickWebEngineProfile(parent), vtbl(vtbl) {};

	virtual ~MiqtVirtualQQuickWebEngineProfile() override { if(vtbl->destructor) vtbl->destructor(vtbl, this); }
...
QQuickWebEngineScriptCollection* QQuickWebEngineProfile_userScripts(const QQuickWebEngineProfile* self) {
	return self->userScripts();
}
...
void QQuickWebEngineProfile_connect_storageNameChanged(QQuickWebEngineProfile* self, intptr_t slot, void (*callback)(intptr_t), void (*release)(intptr_t)) {
	...
	MiqtVirtualQQuickWebEngineProfile::connect(self, static_cast<void (QQuickWebEngineProfile::*)()>(&QQuickWebEngineProfile::storageNameChanged), self, caller{slot, callback, release});
}
...
void QQuickWebEngineProfile_connect_offTheRecordChanged(QQuickWebEngineProfile* self, intptr_t slot, void (*callback)(intptr_t), void (*release)(intptr_t)) {
	...
	MiqtVirtualQQuickWebEngineProfile::connect(self, static_cast<void (QQuickWebEngineProfile::*)()>(&QQuickWebEngineProfile::offTheRecordChanged), self, caller{slot, callback, release});
}
...
void QQuickWebEngineProfile_connect_persistentStoragePathChanged(QQuickWebEngineProfile* self, intptr_t slot, void (*callback)(intptr_t), void (*release)(intptr_t)) {
	...
	MiqtVirtualQQuickWebEngineProfile::connect(self, static_cast<void (QQuickWebEngineProfile::*)()>(&QQuickWebEngineProfile::persistentStoragePathChanged), self, caller{slot, callback, release});
}
...
void QQuickWebEngineProfile_connect_cachePathChanged(QQuickWebEngineProfile* self, intptr_t slot, void (*callback)(intptr_t), void (*release)(intptr_t)) {
	...
	MiqtVirtualQQuickWebEngineProfile::connect(self, static_cast<void (QQuickWebEngineProfile::*)()>(&QQuickWebEngineProfile::cachePathChanged), self, caller{slot, callback, release});
}
...
void QQuickWebEngineProfile_connect_httpUserAgentChanged(QQuickWebEngineProfile* self, intptr_t slot, void (*callback)(intptr_t), void (*release)(intptr_t)) {
	...
	MiqtVirtualQQuickWebEngineProfile::connect(self, static_cast<void (QQuickWebEngineProfile::*)()>(&QQuickWebEngineProfile::httpUserAgentChanged), self, caller{slot, callback, release});
}
...
void QQuickWebEngineProfile_connect_httpCacheTypeChanged(QQuickWebEngineProfile* self, intptr_t slot, void (*callback)(intptr_t), void (*release)(intptr_t)) {
	...
	MiqtVirtualQQuickWebEngineProfile::connect(self, static_cast<void (QQuickWebEngineProfile::*)()>(&QQuickWebEngineProfile::httpCacheTypeChanged), self, caller{slot, callback, release});
}
...
void QQuickWebEngineProfile_connect_persistentCookiesPolicyChanged(QQuickWebEngineProfile* self, intptr_t slot, void (*callback)(intptr_t), void (*release)(intptr_t)) {
	...
	MiqtVirtualQQuickWebEngineProfile::connect(self, static_cast<void (QQuickWebEngineProfile::*)()>(&QQuickWebEngineProfile::persistentCookiesPolicyChanged), self, caller{slot, callback, release});
}
...
void QQuickWebEngineProfile_connect_httpCacheMaximumSizeChanged(QQuickWebEngineProfile* self, intptr_t slot, void (*callback)(intptr_t), void (*release)(intptr_t)) {
	...
	MiqtVirtualQQuickWebEngineProfile::connect(self, static_cast<void (QQuickWebEngineProfile::*)()>(&QQuickWebEngineProfile::httpCacheMaximumSizeChanged), self, caller{slot, callback, release});
}
...
void QQuickWebEngineProfile_connect_httpAcceptLanguageChanged(QQuickWebEngineProfile* self, intptr_t slot, void (*callback)(intptr_t), void (*release)(intptr_t)) {
	...
	MiqtVirtualQQuickWebEngineProfile::connect(self, static_cast<void (QQuickWebEngineProfile::*)()>(&QQuickWebEngineProfile::httpAcceptLanguageChanged), self, caller{slot, callback, release});
}
...
void QQuickWebEngineProfile_connect_spellCheckLanguagesChanged(QQuickWebEngineProfile* self, intptr_t slot, void (*callback)(intptr_t), void (*release)(intptr_t)) {
	...
	MiqtVirtualQQuickWebEngineProfile::connect(self, static_cast<void (QQuickWebEngineProfile::*)()>(&QQuickWebEngineProfile::spellCheckLanguagesChanged), self, caller{slot, callback, release});
}
...
void QQuickWebEngineProfile_connect_spellCheckEnabledChanged(QQuickWebEngineProfile* self, intptr_t slot, void (*callback)(intptr_t), void (*release)(intptr_t)) {
	...
	MiqtVirtualQQuickWebEngineProfile::connect(self, static_cast<void (QQuickWebEngineProfile::*)()>(&QQuickWebEngineProfile::spellCheckEnabledChanged), self, caller{slot, callback, release});
}
...
void QQuickWebEngineProfile_connect_downloadPathChanged(QQuickWebEngineProfile* self, intptr_t slot, void (*callback)(intptr_t), void (*release)(intptr_t)) {
	...
	MiqtVirtualQQuickWebEngineProfile::connect(self, static_cast<void (QQuickWebEngineProfile::*)()>(&QQuickWebEngineProfile::downloadPathChanged), self, caller{slot, callback, release});
}
...
void QQuickWebEngineProfile_connect_downloadRequested(QQuickWebEngineProfile* self, intptr_t slot, void (*callback)(intptr_t, QQuickWebEngineDownloadRequest*), void (*release)(intptr_t)) {
	struct caller {
		intptr_t slot;
		void (*callback)(intptr_t, QQuickWebEngineDownloadRequest*);
		seeqt::release_callback release;
	...
	MiqtVirtualQQuickWebEngineProfile::connect(self, static_cast<void (QQuickWebEngineProfile::*)(QQuickWebEngineDownloadRequest*)>(&QQuickWebEngineProfile::downloadRequested), self, caller{slot, callback, release});
}
...
void QQuickWebEngineProfile_connect_downloadFinished(QQuickWebEngineProfile* self, intptr_t slot, void (*callback)(intptr_t, QQuickWebEngineDownloadRequest*), void (*release)(intptr_t)) {
	struct caller {
		intptr_t slot;
		void (*callback)(intptr_t, QQuickWebEngineDownloadRequest*);
		seeqt::release_callback release;
	...
	MiqtVirtualQQuickWebEngineProfile::connect(self, static_cast<void (QQuickWebEngineProfile::*)(QQuickWebEngineDownloadRequest*)>(&QQuickWebEngineProfile::downloadFinished), self, caller{slot, callback, release});
}
...
void QQuickWebEngineProfile_connect_presentNotification(QQuickWebEngineProfile* self, intptr_t slot, void (*callback)(intptr_t, QWebEngineNotification*), void (*release)(intptr_t)) {
	...
	MiqtVirtualQQuickWebEngineProfile::connect(self, static_cast<void (QQuickWebEngineProfile::*)(QWebEngineNotification*)>(&QQuickWebEngineProfile::presentNotification), self, caller{slot, callback, release});
}
...
QMetaObject* QQuickWebEngineProfile_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQQuickWebEngineProfile*)(self) )->QQuickWebEngineProfile::metaObject();

}

void* QQuickWebEngineProfile_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQQuickWebEngineProfile*)(self) )->QQuickWebEngineProfile::qt_metacast(param1);

}

int QQuickWebEngineProfile_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQQuickWebEngineProfile*)(self) )->QQuickWebEngineProfile::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);

}

bool QQuickWebEngineProfile_virtualbase_event(void* self, QEvent* event) {

	return ( (MiqtVirtualQQuickWebEngineProfile*)(self) )->QQuickWebEngineProfile::event(event);

}

bool QQuickWebEngineProfile_virtualbase_eventFilter(void* self, QObject* watched, QEvent* event) {

	return ( (MiqtVirtualQQuickWebEngineProfile*)(self) )->QQuickWebEngineProfile::eventFilter(watched, event);

}

void QQuickWebEngineProfile_virtualbase_timerEvent(void* self, QTimerEvent* event) {

	( (MiqtVirtualQQuickWebEngineProfile*)(self) )->QQuickWebEngineProfile::timerEvent(event);

}

void QQuickWebEngineProfile_virtualbase_childEvent(void* self, QChildEvent* event) {

	( (MiqtVirtualQQuickWebEngineProfile*)(self) )->QQuickWebEngineProfile::childEvent(event);

}

void QQuickWebEngineProfile_virtualbase_customEvent(void* self, QEvent* event) {

	( (MiqtVirtualQQuickWebEngineProfile*)(self) )->QQuickWebEngineProfile::customEvent(event);

}

void QQuickWebEngineProfile_virtualbase_connectNotify(void* self, QMetaMethod* signal) {

	( (MiqtVirtualQQuickWebEngineProfile*)(self) )->QQuickWebEngineProfile::connectNotify(*signal);

}

void QQuickWebEngineProfile_virtualbase_disconnectNotify(void* self, QMetaMethod* signal) {

	( (MiqtVirtualQQuickWebEngineProfile*)(self) )->QQuickWebEngineProfile::disconnectNotify(*signal);
...
QObject* QQuickWebEngineProfile_protectedbase_sender(bool* _dynamic_cast_ok, const void* self) {
	MiqtVirtualQQuickWebEngineProfile* self_cast = dynamic_cast<MiqtVirtualQQuickWebEngineProfile*>( (QQuickWebEngineProfile*)(self) );
