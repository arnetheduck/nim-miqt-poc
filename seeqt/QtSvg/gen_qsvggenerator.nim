...
proc size*(self: gen_qsvggenerator_types.QSvgGenerator, ): QSize =
  QSize(h: fcQSvgGenerator_size(self.h))

proc setSize*(self: gen_qsvggenerator_types.QSvgGenerator, size: QSize): void =
  fcQSvgGenerator_setSize(self.h, size.h)

proc viewBox*(self: gen_qsvggenerator_types.QSvgGenerator, ): QRect =
  QRect(h: fcQSvgGenerator_viewBox(self.h))

proc viewBoxF*(self: gen_qsvggenerator_types.QSvgGenerator, ): QRectF =
  QRectF(h: fcQSvgGenerator_viewBoxF(self.h))

proc setViewBox*(self: gen_qsvggenerator_types.QSvgGenerator, viewBox: QRect): void =
  fcQSvgGenerator_setViewBox(self.h, viewBox.h)

proc setViewBox*(self: gen_qsvggenerator_types.QSvgGenerator, viewBox: QRectF): void =
...
proc outputDevice*(self: gen_qsvggenerator_types.QSvgGenerator, ): QIODevice =
  QIODevice(h: fcQSvgGenerator_outputDevice(self.h))

proc setOutputDevice*(self: gen_qsvggenerator_types.QSvgGenerator, outputDevice: QIODevice): void =
...
proc QSvgGeneratorpaintEngine*(self: gen_qsvggenerator_types.QSvgGenerator, ): QPaintEngine =
  QPaintEngine(h: fQSvgGenerator_virtualbase_paintEngine(self.h))

type QSvgGeneratorpaintEngineProc* = proc(): QPaintEngine
...
proc miqt_exec_callback_QSvgGenerator_devType(self: ptr cQSvgGenerator, slot: int): cint {.exportc: "miqt_exec_callback_QSvgGenerator_devType ".} =
  ...
  virtualReturn
proc QSvgGeneratorinitPainter*(self: gen_qsvggenerator_types.QSvgGenerator, painter: QPainter): void =
  fQSvgGenerator_virtualbase_initPainter(self.h, painter.h)

type QSvgGeneratorinitPainterProc* = proc(painter: QPainter): void
...
proc miqt_exec_callback_QSvgGenerator_initPainter(self: ptr cQSvgGenerator, slot: int, painter: pointer): void {.exportc: "miqt_exec_callback_QSvgGenerator_initPainter ".} =
  ...
  nimfunc[](slotval1)
proc QSvgGeneratorredirected*(self: gen_qsvggenerator_types.QSvgGenerator, offset: QPoint): QPaintDevice =
  QPaintDevice(h: fQSvgGenerator_virtualbase_redirected(self.h, offset.h))

type QSvgGeneratorredirectedProc* = proc(offset: QPoint): QPaintDevice
...
proc miqt_exec_callback_QSvgGenerator_redirected(self: ptr cQSvgGenerator, slot: int, offset: pointer): pointer {.exportc: "miqt_exec_callback_QSvgGenerator_redirected ".} =
  ...
  virtualReturn.h
proc QSvgGeneratorsharedPainter*(self: gen_qsvggenerator_types.QSvgGenerator, ): QPainter =
  QPainter(h: fQSvgGenerator_virtualbase_sharedPainter(self.h))

type QSvgGeneratorsharedPainterProc* = proc(): QPainter
