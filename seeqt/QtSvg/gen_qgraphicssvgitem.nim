...
proc create*(T: type gen_qgraphicssvgitem_types.QGraphicsSvgItem, parentItem: QGraphicsItem): gen_qgraphicssvgitem_types.QGraphicsSvgItem =
  gen_qgraphicssvgitem_types.QGraphicsSvgItem.init(fcQGraphicsSvgItem_new3(parentItem.h))

proc create*(T: type gen_qgraphicssvgitem_types.QGraphicsSvgItem, fileName: string, parentItem: QGraphicsItem): gen_qgraphicssvgitem_types.QGraphicsSvgItem =
...
proc metaObject*(self: gen_qgraphicssvgitem_types.QGraphicsSvgItem, ): QMetaObject =
  QMetaObject(h: fcQGraphicsSvgItem_metaObject(self.h))
...
proc setSharedRenderer*(self: gen_qgraphicssvgitem_types.QGraphicsSvgItem, renderer: QSvgRenderer): void =
  fcQGraphicsSvgItem_setSharedRenderer(self.h, renderer.h)

proc renderer*(self: gen_qgraphicssvgitem_types.QGraphicsSvgItem, ): QSvgRenderer =
  QSvgRenderer(h: fcQGraphicsSvgItem_renderer(self.h))
...
proc setMaximumCacheSize*(self: gen_qgraphicssvgitem_types.QGraphicsSvgItem, size: QSize): void =
  fcQGraphicsSvgItem_setMaximumCacheSize(self.h, size.h)

proc maximumCacheSize*(self: gen_qgraphicssvgitem_types.QGraphicsSvgItem, ): QSize =
  QSize(h: fcQGraphicsSvgItem_maximumCacheSize(self.h))

proc boundingRect*(self: gen_qgraphicssvgitem_types.QGraphicsSvgItem, ): QRectF =
  QRectF(h: fcQGraphicsSvgItem_boundingRect(self.h))

proc paint*(self: gen_qgraphicssvgitem_types.QGraphicsSvgItem, painter: QPainter, option: QStyleOptionGraphicsItem, widget: QWidget): void =
...
proc miqt_exec_callback_QGraphicsSvgItem_metacall(self: ptr cQGraphicsSvgItem, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QGraphicsSvgItem_metacall ".} =
  ...
  virtualReturn
proc QGraphicsSvgItemboundingRect*(self: gen_qgraphicssvgitem_types.QGraphicsSvgItem, ): QRectF =
  QRectF(h: fQGraphicsSvgItem_virtualbase_boundingRect(self.h))

type QGraphicsSvgItemboundingRectProc* = proc(): QRectF
...
proc miqt_exec_callback_QGraphicsSvgItem_boundingRect(self: ptr cQGraphicsSvgItem, slot: int): pointer {.exportc: "miqt_exec_callback_QGraphicsSvgItem_boundingRect ".} =
  ...
  virtualReturn.h
proc QGraphicsSvgItempaint*(self: gen_qgraphicssvgitem_types.QGraphicsSvgItem, painter: QPainter, option: QStyleOptionGraphicsItem, widget: QWidget): void =
  fQGraphicsSvgItem_virtualbase_paint(self.h, painter.h, option.h, widget.h)

type QGraphicsSvgItempaintProc* = proc(painter: QPainter, option: QStyleOptionGraphicsItem, widget: QWidget): void
...
proc miqt_exec_callback_QGraphicsSvgItem_type(self: ptr cQGraphicsSvgItem, slot: int): cint {.exportc: "miqt_exec_callback_QGraphicsSvgItem_type ".} =
  ...
  virtualReturn
proc QGraphicsSvgItemevent*(self: gen_qgraphicssvgitem_types.QGraphicsSvgItem, ev: QEvent): bool =
  fQGraphicsSvgItem_virtualbase_event(self.h, ev.h)

type QGraphicsSvgItemeventProc* = proc(ev: QEvent): bool
...
proc miqt_exec_callback_QGraphicsSvgItem_event(self: ptr cQGraphicsSvgItem, slot: int, ev: pointer): bool {.exportc: "miqt_exec_callback_QGraphicsSvgItem_event ".} =
  ...
  virtualReturn
proc QGraphicsSvgItemeventFilter*(self: gen_qgraphicssvgitem_types.QGraphicsSvgItem, watched: QObject, event: QEvent): bool =
  fQGraphicsSvgItem_virtualbase_eventFilter(self.h, watched.h, event.h)

type QGraphicsSvgItemeventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QGraphicsSvgItem_eventFilter(self: ptr cQGraphicsSvgItem, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QGraphicsSvgItem_eventFilter ".} =
  ...
  virtualReturn
proc QGraphicsSvgItemtimerEvent*(self: gen_qgraphicssvgitem_types.QGraphicsSvgItem, event: QTimerEvent): void =
  fQGraphicsSvgItem_virtualbase_timerEvent(self.h, event.h)

type QGraphicsSvgItemtimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QGraphicsSvgItem_timerEvent(self: ptr cQGraphicsSvgItem, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsSvgItem_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsSvgItemchildEvent*(self: gen_qgraphicssvgitem_types.QGraphicsSvgItem, event: QChildEvent): void =
  fQGraphicsSvgItem_virtualbase_childEvent(self.h, event.h)

type QGraphicsSvgItemchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QGraphicsSvgItem_childEvent(self: ptr cQGraphicsSvgItem, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsSvgItem_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsSvgItemcustomEvent*(self: gen_qgraphicssvgitem_types.QGraphicsSvgItem, event: QEvent): void =
  fQGraphicsSvgItem_virtualbase_customEvent(self.h, event.h)

type QGraphicsSvgItemcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QGraphicsSvgItem_customEvent(self: ptr cQGraphicsSvgItem, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsSvgItem_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsSvgItemconnectNotify*(self: gen_qgraphicssvgitem_types.QGraphicsSvgItem, signal: QMetaMethod): void =
  fQGraphicsSvgItem_virtualbase_connectNotify(self.h, signal.h)

type QGraphicsSvgItemconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QGraphicsSvgItem_connectNotify(self: ptr cQGraphicsSvgItem, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QGraphicsSvgItem_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsSvgItemdisconnectNotify*(self: gen_qgraphicssvgitem_types.QGraphicsSvgItem, signal: QMetaMethod): void =
  fQGraphicsSvgItem_virtualbase_disconnectNotify(self.h, signal.h)

type QGraphicsSvgItemdisconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QGraphicsSvgItem_advance(self: ptr cQGraphicsSvgItem, slot: int, phase: cint): void {.exportc: "miqt_exec_callback_QGraphicsSvgItem_advance ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsSvgItemshape*(self: gen_qgraphicssvgitem_types.QGraphicsSvgItem, ): QPainterPath =
  QPainterPath(h: fQGraphicsSvgItem_virtualbase_shape(self.h))

type QGraphicsSvgItemshapeProc* = proc(): QPainterPath
...
proc miqt_exec_callback_QGraphicsSvgItem_shape(self: ptr cQGraphicsSvgItem, slot: int): pointer {.exportc: "miqt_exec_callback_QGraphicsSvgItem_shape ".} =
  ...
  virtualReturn.h
proc QGraphicsSvgItemcontains*(self: gen_qgraphicssvgitem_types.QGraphicsSvgItem, point: QPointF): bool =
  fQGraphicsSvgItem_virtualbase_contains(self.h, point.h)

type QGraphicsSvgItemcontainsProc* = proc(point: QPointF): bool
...
proc miqt_exec_callback_QGraphicsSvgItem_contains(self: ptr cQGraphicsSvgItem, slot: int, point: pointer): bool {.exportc: "miqt_exec_callback_QGraphicsSvgItem_contains ".} =
  ...
  virtualReturn
proc QGraphicsSvgItemcollidesWithItem*(self: gen_qgraphicssvgitem_types.QGraphicsSvgItem, other: QGraphicsItem, mode: cint): bool =
  fQGraphicsSvgItem_virtualbase_collidesWithItem(self.h, other.h, cint(mode))

type QGraphicsSvgItemcollidesWithItemProc* = proc(other: QGraphicsItem, mode: cint): bool
...
proc miqt_exec_callback_QGraphicsSvgItem_collidesWithItem(self: ptr cQGraphicsSvgItem, slot: int, other: pointer, mode: cint): bool {.exportc: "miqt_exec_callback_QGraphicsSvgItem_collidesWithItem ".} =
  ...
  virtualReturn
proc QGraphicsSvgItemcollidesWithPath*(self: gen_qgraphicssvgitem_types.QGraphicsSvgItem, path: QPainterPath, mode: cint): bool =
  fQGraphicsSvgItem_virtualbase_collidesWithPath(self.h, path.h, cint(mode))

type QGraphicsSvgItemcollidesWithPathProc* = proc(path: QPainterPath, mode: cint): bool
...
proc miqt_exec_callback_QGraphicsSvgItem_collidesWithPath(self: ptr cQGraphicsSvgItem, slot: int, path: pointer, mode: cint): bool {.exportc: "miqt_exec_callback_QGraphicsSvgItem_collidesWithPath ".} =
  ...
  virtualReturn
proc QGraphicsSvgItemisObscuredBy*(self: gen_qgraphicssvgitem_types.QGraphicsSvgItem, item: QGraphicsItem): bool =
  fQGraphicsSvgItem_virtualbase_isObscuredBy(self.h, item.h)

type QGraphicsSvgItemisObscuredByProc* = proc(item: QGraphicsItem): bool
...
proc miqt_exec_callback_QGraphicsSvgItem_isObscuredBy(self: ptr cQGraphicsSvgItem, slot: int, item: pointer): bool {.exportc: "miqt_exec_callback_QGraphicsSvgItem_isObscuredBy ".} =
  ...
  virtualReturn
proc QGraphicsSvgItemopaqueArea*(self: gen_qgraphicssvgitem_types.QGraphicsSvgItem, ): QPainterPath =
  QPainterPath(h: fQGraphicsSvgItem_virtualbase_opaqueArea(self.h))

type QGraphicsSvgItemopaqueAreaProc* = proc(): QPainterPath
...
proc miqt_exec_callback_QGraphicsSvgItem_opaqueArea(self: ptr cQGraphicsSvgItem, slot: int): pointer {.exportc: "miqt_exec_callback_QGraphicsSvgItem_opaqueArea ".} =
  ...
  virtualReturn.h
proc QGraphicsSvgItemsceneEventFilter*(self: gen_qgraphicssvgitem_types.QGraphicsSvgItem, watched: QGraphicsItem, event: QEvent): bool =
  fQGraphicsSvgItem_virtualbase_sceneEventFilter(self.h, watched.h, event.h)

type QGraphicsSvgItemsceneEventFilterProc* = proc(watched: QGraphicsItem, event: QEvent): bool
...
proc miqt_exec_callback_QGraphicsSvgItem_sceneEventFilter(self: ptr cQGraphicsSvgItem, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QGraphicsSvgItem_sceneEventFilter ".} =
  ...
  virtualReturn
proc QGraphicsSvgItemsceneEvent*(self: gen_qgraphicssvgitem_types.QGraphicsSvgItem, event: QEvent): bool =
  fQGraphicsSvgItem_virtualbase_sceneEvent(self.h, event.h)

type QGraphicsSvgItemsceneEventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QGraphicsSvgItem_sceneEvent(self: ptr cQGraphicsSvgItem, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QGraphicsSvgItem_sceneEvent ".} =
  ...
  virtualReturn
proc QGraphicsSvgItemcontextMenuEvent*(self: gen_qgraphicssvgitem_types.QGraphicsSvgItem, event: QGraphicsSceneContextMenuEvent): void =
  fQGraphicsSvgItem_virtualbase_contextMenuEvent(self.h, event.h)

type QGraphicsSvgItemcontextMenuEventProc* = proc(event: QGraphicsSceneContextMenuEvent): void
...
proc miqt_exec_callback_QGraphicsSvgItem_contextMenuEvent(self: ptr cQGraphicsSvgItem, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsSvgItem_contextMenuEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsSvgItemdragEnterEvent*(self: gen_qgraphicssvgitem_types.QGraphicsSvgItem, event: QGraphicsSceneDragDropEvent): void =
  fQGraphicsSvgItem_virtualbase_dragEnterEvent(self.h, event.h)

type QGraphicsSvgItemdragEnterEventProc* = proc(event: QGraphicsSceneDragDropEvent): void
...
proc miqt_exec_callback_QGraphicsSvgItem_dragEnterEvent(self: ptr cQGraphicsSvgItem, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsSvgItem_dragEnterEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsSvgItemdragLeaveEvent*(self: gen_qgraphicssvgitem_types.QGraphicsSvgItem, event: QGraphicsSceneDragDropEvent): void =
  fQGraphicsSvgItem_virtualbase_dragLeaveEvent(self.h, event.h)

type QGraphicsSvgItemdragLeaveEventProc* = proc(event: QGraphicsSceneDragDropEvent): void
...
proc miqt_exec_callback_QGraphicsSvgItem_dragLeaveEvent(self: ptr cQGraphicsSvgItem, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsSvgItem_dragLeaveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsSvgItemdragMoveEvent*(self: gen_qgraphicssvgitem_types.QGraphicsSvgItem, event: QGraphicsSceneDragDropEvent): void =
  fQGraphicsSvgItem_virtualbase_dragMoveEvent(self.h, event.h)

type QGraphicsSvgItemdragMoveEventProc* = proc(event: QGraphicsSceneDragDropEvent): void
...
proc miqt_exec_callback_QGraphicsSvgItem_dragMoveEvent(self: ptr cQGraphicsSvgItem, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsSvgItem_dragMoveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsSvgItemdropEvent*(self: gen_qgraphicssvgitem_types.QGraphicsSvgItem, event: QGraphicsSceneDragDropEvent): void =
  fQGraphicsSvgItem_virtualbase_dropEvent(self.h, event.h)

type QGraphicsSvgItemdropEventProc* = proc(event: QGraphicsSceneDragDropEvent): void
...
proc miqt_exec_callback_QGraphicsSvgItem_dropEvent(self: ptr cQGraphicsSvgItem, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsSvgItem_dropEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsSvgItemfocusInEvent*(self: gen_qgraphicssvgitem_types.QGraphicsSvgItem, event: QFocusEvent): void =
  fQGraphicsSvgItem_virtualbase_focusInEvent(self.h, event.h)

type QGraphicsSvgItemfocusInEventProc* = proc(event: QFocusEvent): void
...
proc miqt_exec_callback_QGraphicsSvgItem_focusInEvent(self: ptr cQGraphicsSvgItem, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsSvgItem_focusInEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsSvgItemfocusOutEvent*(self: gen_qgraphicssvgitem_types.QGraphicsSvgItem, event: QFocusEvent): void =
  fQGraphicsSvgItem_virtualbase_focusOutEvent(self.h, event.h)

type QGraphicsSvgItemfocusOutEventProc* = proc(event: QFocusEvent): void
...
proc miqt_exec_callback_QGraphicsSvgItem_focusOutEvent(self: ptr cQGraphicsSvgItem, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsSvgItem_focusOutEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsSvgItemhoverEnterEvent*(self: gen_qgraphicssvgitem_types.QGraphicsSvgItem, event: QGraphicsSceneHoverEvent): void =
  fQGraphicsSvgItem_virtualbase_hoverEnterEvent(self.h, event.h)

type QGraphicsSvgItemhoverEnterEventProc* = proc(event: QGraphicsSceneHoverEvent): void
...
proc miqt_exec_callback_QGraphicsSvgItem_hoverEnterEvent(self: ptr cQGraphicsSvgItem, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsSvgItem_hoverEnterEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsSvgItemhoverMoveEvent*(self: gen_qgraphicssvgitem_types.QGraphicsSvgItem, event: QGraphicsSceneHoverEvent): void =
  fQGraphicsSvgItem_virtualbase_hoverMoveEvent(self.h, event.h)

type QGraphicsSvgItemhoverMoveEventProc* = proc(event: QGraphicsSceneHoverEvent): void
...
proc miqt_exec_callback_QGraphicsSvgItem_hoverMoveEvent(self: ptr cQGraphicsSvgItem, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsSvgItem_hoverMoveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsSvgItemhoverLeaveEvent*(self: gen_qgraphicssvgitem_types.QGraphicsSvgItem, event: QGraphicsSceneHoverEvent): void =
  fQGraphicsSvgItem_virtualbase_hoverLeaveEvent(self.h, event.h)

type QGraphicsSvgItemhoverLeaveEventProc* = proc(event: QGraphicsSceneHoverEvent): void
...
proc miqt_exec_callback_QGraphicsSvgItem_hoverLeaveEvent(self: ptr cQGraphicsSvgItem, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsSvgItem_hoverLeaveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsSvgItemkeyPressEvent*(self: gen_qgraphicssvgitem_types.QGraphicsSvgItem, event: QKeyEvent): void =
  fQGraphicsSvgItem_virtualbase_keyPressEvent(self.h, event.h)

type QGraphicsSvgItemkeyPressEventProc* = proc(event: QKeyEvent): void
...
proc miqt_exec_callback_QGraphicsSvgItem_keyPressEvent(self: ptr cQGraphicsSvgItem, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsSvgItem_keyPressEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsSvgItemkeyReleaseEvent*(self: gen_qgraphicssvgitem_types.QGraphicsSvgItem, event: QKeyEvent): void =
  fQGraphicsSvgItem_virtualbase_keyReleaseEvent(self.h, event.h)

type QGraphicsSvgItemkeyReleaseEventProc* = proc(event: QKeyEvent): void
...
proc miqt_exec_callback_QGraphicsSvgItem_keyReleaseEvent(self: ptr cQGraphicsSvgItem, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsSvgItem_keyReleaseEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsSvgItemmousePressEvent*(self: gen_qgraphicssvgitem_types.QGraphicsSvgItem, event: QGraphicsSceneMouseEvent): void =
  fQGraphicsSvgItem_virtualbase_mousePressEvent(self.h, event.h)

type QGraphicsSvgItemmousePressEventProc* = proc(event: QGraphicsSceneMouseEvent): void
...
proc miqt_exec_callback_QGraphicsSvgItem_mousePressEvent(self: ptr cQGraphicsSvgItem, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsSvgItem_mousePressEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsSvgItemmouseMoveEvent*(self: gen_qgraphicssvgitem_types.QGraphicsSvgItem, event: QGraphicsSceneMouseEvent): void =
  fQGraphicsSvgItem_virtualbase_mouseMoveEvent(self.h, event.h)

type QGraphicsSvgItemmouseMoveEventProc* = proc(event: QGraphicsSceneMouseEvent): void
...
proc miqt_exec_callback_QGraphicsSvgItem_mouseMoveEvent(self: ptr cQGraphicsSvgItem, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsSvgItem_mouseMoveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsSvgItemmouseReleaseEvent*(self: gen_qgraphicssvgitem_types.QGraphicsSvgItem, event: QGraphicsSceneMouseEvent): void =
  fQGraphicsSvgItem_virtualbase_mouseReleaseEvent(self.h, event.h)

type QGraphicsSvgItemmouseReleaseEventProc* = proc(event: QGraphicsSceneMouseEvent): void
...
proc miqt_exec_callback_QGraphicsSvgItem_mouseReleaseEvent(self: ptr cQGraphicsSvgItem, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsSvgItem_mouseReleaseEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsSvgItemmouseDoubleClickEvent*(self: gen_qgraphicssvgitem_types.QGraphicsSvgItem, event: QGraphicsSceneMouseEvent): void =
  fQGraphicsSvgItem_virtualbase_mouseDoubleClickEvent(self.h, event.h)

type QGraphicsSvgItemmouseDoubleClickEventProc* = proc(event: QGraphicsSceneMouseEvent): void
...
proc miqt_exec_callback_QGraphicsSvgItem_mouseDoubleClickEvent(self: ptr cQGraphicsSvgItem, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsSvgItem_mouseDoubleClickEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsSvgItemwheelEvent*(self: gen_qgraphicssvgitem_types.QGraphicsSvgItem, event: QGraphicsSceneWheelEvent): void =
  fQGraphicsSvgItem_virtualbase_wheelEvent(self.h, event.h)

type QGraphicsSvgItemwheelEventProc* = proc(event: QGraphicsSceneWheelEvent): void
...
proc miqt_exec_callback_QGraphicsSvgItem_wheelEvent(self: ptr cQGraphicsSvgItem, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsSvgItem_wheelEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsSvgIteminputMethodEvent*(self: gen_qgraphicssvgitem_types.QGraphicsSvgItem, event: QInputMethodEvent): void =
  fQGraphicsSvgItem_virtualbase_inputMethodEvent(self.h, event.h)

type QGraphicsSvgIteminputMethodEventProc* = proc(event: QInputMethodEvent): void
...
proc miqt_exec_callback_QGraphicsSvgItem_inputMethodEvent(self: ptr cQGraphicsSvgItem, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsSvgItem_inputMethodEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsSvgIteminputMethodQuery*(self: gen_qgraphicssvgitem_types.QGraphicsSvgItem, query: cint): QVariant =
  QVariant(h: fQGraphicsSvgItem_virtualbase_inputMethodQuery(self.h, cint(query)))

type QGraphicsSvgIteminputMethodQueryProc* = proc(query: cint): QVariant
...
proc miqt_exec_callback_QGraphicsSvgItem_inputMethodQuery(self: ptr cQGraphicsSvgItem, slot: int, query: cint): pointer {.exportc: "miqt_exec_callback_QGraphicsSvgItem_inputMethodQuery ".} =
  ...
  virtualReturn.h
proc QGraphicsSvgItemitemChange*(self: gen_qgraphicssvgitem_types.QGraphicsSvgItem, change: cint, value: QVariant): QVariant =
  QVariant(h: fQGraphicsSvgItem_virtualbase_itemChange(self.h, cint(change), value.h))

type QGraphicsSvgItemitemChangeProc* = proc(change: cint, value: QVariant): QVariant
...
proc miqt_exec_callback_QGraphicsSvgItem_supportsExtension(self: ptr cQGraphicsSvgItem, slot: int, extension: cint): bool {.exportc: "miqt_exec_callback_QGraphicsSvgItem_supportsExtension ".} =
  ...
  virtualReturn
proc QGraphicsSvgItemsetExtension*(self: gen_qgraphicssvgitem_types.QGraphicsSvgItem, extension: cint, variant: QVariant): void =
  fQGraphicsSvgItem_virtualbase_setExtension(self.h, cint(extension), variant.h)

type QGraphicsSvgItemsetExtensionProc* = proc(extension: cint, variant: QVariant): void
...
proc QGraphicsSvgItemextension*(self: gen_qgraphicssvgitem_types.QGraphicsSvgItem, variant: QVariant): QVariant =
  QVariant(h: fQGraphicsSvgItem_virtualbase_extension(self.h, variant.h))

type QGraphicsSvgItemextensionProc* = proc(variant: QVariant): QVariant
