...
public:
	...
	MiqtVirtualQSvgRenderer(struct QSvgRenderer_VTable* vtbl): QSvgRenderer(), vtbl(vtbl) {};
	MiqtVirtualQSvgRenderer(struct QSvgRenderer_VTable* vtbl, const QString& filename): QSvgRenderer(filename), vtbl(vtbl) {};
	MiqtVirtualQSvgRenderer(struct QSvgRenderer_VTable* vtbl, const QByteArray& contents): QSvgRenderer(contents), vtbl(vtbl) {};
	MiqtVirtualQSvgRenderer(struct QSvgRenderer_VTable* vtbl, QXmlStreamReader* contents): QSvgRenderer(contents), vtbl(vtbl) {};
	MiqtVirtualQSvgRenderer(struct QSvgRenderer_VTable* vtbl, QObject* parent): QSvgRenderer(parent), vtbl(vtbl) {};
	MiqtVirtualQSvgRenderer(struct QSvgRenderer_VTable* vtbl, const QString& filename, QObject* parent): QSvgRenderer(filename, parent), vtbl(vtbl) {};
	MiqtVirtualQSvgRenderer(struct QSvgRenderer_VTable* vtbl, const QByteArray& contents, QObject* parent): QSvgRenderer(contents, parent), vtbl(vtbl) {};
	MiqtVirtualQSvgRenderer(struct QSvgRenderer_VTable* vtbl, QXmlStreamReader* contents, QObject* parent): QSvgRenderer(contents, parent), vtbl(vtbl) {};

	virtual ~MiqtVirtualQSvgRenderer() override { if(vtbl->destructor) vtbl->destructor(vtbl, this); }
...
void QSvgRenderer_connect_repaintNeeded(QSvgRenderer* self, intptr_t slot, void (*callback)(intptr_t), void (*release)(intptr_t)) {
	...
	MiqtVirtualQSvgRenderer::connect(self, static_cast<void (QSvgRenderer::*)()>(&QSvgRenderer::repaintNeeded), self, caller{slot, callback, release});
}
...
QMetaObject* QSvgRenderer_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQSvgRenderer*)(self) )->QSvgRenderer::metaObject();

}

void* QSvgRenderer_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQSvgRenderer*)(self) )->QSvgRenderer::qt_metacast(param1);

}

int QSvgRenderer_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQSvgRenderer*)(self) )->QSvgRenderer::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
QObject* QSvgRenderer_protectedbase_sender(const void* self) {
	MiqtVirtualQSvgRenderer* self_cast = static_cast<MiqtVirtualQSvgRenderer*>( (QSvgRenderer*)(self) );
