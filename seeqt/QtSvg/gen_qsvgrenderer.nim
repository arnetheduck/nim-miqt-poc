...
proc create*(T: type gen_qsvgrenderer_types.QSvgRenderer, contents: QXmlStreamReader): gen_qsvgrenderer_types.QSvgRenderer =
  gen_qsvgrenderer_types.QSvgRenderer.init(fcQSvgRenderer_new4(contents.h))

proc create*(T: type gen_qsvgrenderer_types.QSvgRenderer, parent: QObject): gen_qsvgrenderer_types.QSvgRenderer =
  gen_qsvgrenderer_types.QSvgRenderer.init(fcQSvgRenderer_new5(parent.h))

proc create*(T: type gen_qsvgrenderer_types.QSvgRenderer, filename: string, parent: QObject): gen_qsvgrenderer_types.QSvgRenderer =
...
proc create*(T: type gen_qsvgrenderer_types.QSvgRenderer, contents: seq[byte], parent: QObject): gen_qsvgrenderer_types.QSvgRenderer =
...
proc create*(T: type gen_qsvgrenderer_types.QSvgRenderer, contents: QXmlStreamReader, parent: QObject): gen_qsvgrenderer_types.QSvgRenderer =
  gen_qsvgrenderer_types.QSvgRenderer.init(fcQSvgRenderer_new8(contents.h, parent.h))

proc metaObject*(self: gen_qsvgrenderer_types.QSvgRenderer, ): QMetaObject =
  QMetaObject(h: fcQSvgRenderer_metaObject(self.h))
...
proc defaultSize*(self: gen_qsvgrenderer_types.QSvgRenderer, ): QSize =
  QSize(h: fcQSvgRenderer_defaultSize(self.h))

proc viewBox*(self: gen_qsvgrenderer_types.QSvgRenderer, ): QRect =
  QRect(h: fcQSvgRenderer_viewBox(self.h))

proc viewBoxF*(self: gen_qsvgrenderer_types.QSvgRenderer, ): QRectF =
  QRectF(h: fcQSvgRenderer_viewBoxF(self.h))

proc setViewBox*(self: gen_qsvgrenderer_types.QSvgRenderer, viewbox: QRect): void =
  fcQSvgRenderer_setViewBox(self.h, viewbox.h)

proc setViewBox*(self: gen_qsvgrenderer_types.QSvgRenderer, viewbox: QRectF): void =
...
proc boundsOnElement*(self: gen_qsvgrenderer_types.QSvgRenderer, id: string): QRectF =
  QRectF(h: fcQSvgRenderer_boundsOnElement(self.h, struct_miqt_string(data: id, len: csize_t(len(id)))))
...
proc matrixForElement*(self: gen_qsvgrenderer_types.QSvgRenderer, id: string): QMatrix =
  QMatrix(h: fcQSvgRenderer_matrixForElement(self.h, struct_miqt_string(data: id, len: csize_t(len(id)))))

proc transformForElement*(self: gen_qsvgrenderer_types.QSvgRenderer, id: string): QTransform =
  QTransform(h: fcQSvgRenderer_transformForElement(self.h, struct_miqt_string(data: id, len: csize_t(len(id)))))
...
proc load*(self: gen_qsvgrenderer_types.QSvgRenderer, contents: QXmlStreamReader): bool =
  fcQSvgRenderer_load2(self.h, contents.h)

proc render*(self: gen_qsvgrenderer_types.QSvgRenderer, p: QPainter): void =
  fcQSvgRenderer_render(self.h, p.h)

proc render*(self: gen_qsvgrenderer_types.QSvgRenderer, p: QPainter, bounds: QRectF): void =
  fcQSvgRenderer_render2(self.h, p.h, bounds.h)

proc render*(self: gen_qsvgrenderer_types.QSvgRenderer, p: QPainter, elementId: string): void =
...
proc render*(self: gen_qsvgrenderer_types.QSvgRenderer, p: QPainter, elementId: string, bounds: QRectF): void =
...
proc miqt_exec_callback_QSvgRenderer_metacall(self: ptr cQSvgRenderer, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QSvgRenderer_metacall ".} =
  ...
  virtualReturn
proc QSvgRendererevent*(self: gen_qsvgrenderer_types.QSvgRenderer, event: QEvent): bool =
  fQSvgRenderer_virtualbase_event(self.h, event.h)

type QSvgRenderereventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QSvgRenderer_event(self: ptr cQSvgRenderer, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QSvgRenderer_event ".} =
  ...
  virtualReturn
proc QSvgRenderereventFilter*(self: gen_qsvgrenderer_types.QSvgRenderer, watched: QObject, event: QEvent): bool =
  fQSvgRenderer_virtualbase_eventFilter(self.h, watched.h, event.h)

type QSvgRenderereventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QSvgRenderer_eventFilter(self: ptr cQSvgRenderer, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QSvgRenderer_eventFilter ".} =
  ...
  virtualReturn
proc QSvgRenderertimerEvent*(self: gen_qsvgrenderer_types.QSvgRenderer, event: QTimerEvent): void =
  fQSvgRenderer_virtualbase_timerEvent(self.h, event.h)

type QSvgRenderertimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QSvgRenderer_timerEvent(self: ptr cQSvgRenderer, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QSvgRenderer_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QSvgRendererchildEvent*(self: gen_qsvgrenderer_types.QSvgRenderer, event: QChildEvent): void =
  fQSvgRenderer_virtualbase_childEvent(self.h, event.h)

type QSvgRendererchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QSvgRenderer_childEvent(self: ptr cQSvgRenderer, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QSvgRenderer_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QSvgRenderercustomEvent*(self: gen_qsvgrenderer_types.QSvgRenderer, event: QEvent): void =
  fQSvgRenderer_virtualbase_customEvent(self.h, event.h)

type QSvgRenderercustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QSvgRenderer_customEvent(self: ptr cQSvgRenderer, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QSvgRenderer_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QSvgRendererconnectNotify*(self: gen_qsvgrenderer_types.QSvgRenderer, signal: QMetaMethod): void =
  fQSvgRenderer_virtualbase_connectNotify(self.h, signal.h)

type QSvgRendererconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QSvgRenderer_connectNotify(self: ptr cQSvgRenderer, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QSvgRenderer_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QSvgRendererdisconnectNotify*(self: gen_qsvgrenderer_types.QSvgRenderer, signal: QMetaMethod): void =
  fQSvgRenderer_virtualbase_disconnectNotify(self.h, signal.h)

type QSvgRendererdisconnectNotifyProc* = proc(signal: QMetaMethod): void
