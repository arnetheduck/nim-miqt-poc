...
func init*(T: type gen_qwebdatabase_types.QWebDatabase, h: ptr cQWebDatabase): gen_qwebdatabase_types.QWebDatabase =
  T(h: h)
proc create*(T: type gen_qwebdatabase_types.QWebDatabase, other: QWebDatabase): gen_qwebdatabase_types.QWebDatabase =
  gen_qwebdatabase_types.QWebDatabase.init(fcQWebDatabase_new(other.h))

proc operatorAssign*(self: gen_qwebdatabase_types.QWebDatabase, other: QWebDatabase): void =
...
proc origin*(self: gen_qwebdatabase_types.QWebDatabase, ): QWebSecurityOrigin =
  QWebSecurityOrigin(h: fcQWebDatabase_origin(self.h))

proc removeDatabase*(_: type gen_qwebdatabase_types.QWebDatabase, param1: QWebDatabase): void =
