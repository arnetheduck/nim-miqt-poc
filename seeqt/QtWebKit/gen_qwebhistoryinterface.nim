...
proc create*(T: type gen_qwebhistoryinterface_types.QWebHistoryInterface, parent: QObject): gen_qwebhistoryinterface_types.QWebHistoryInterface =
  gen_qwebhistoryinterface_types.QWebHistoryInterface.init(fcQWebHistoryInterface_new2(parent.h))

proc metaObject*(self: gen_qwebhistoryinterface_types.QWebHistoryInterface, ): QMetaObject =
  QMetaObject(h: fcQWebHistoryInterface_metaObject(self.h))
...
proc setDefaultInterface*(_: type gen_qwebhistoryinterface_types.QWebHistoryInterface, defaultInterface: QWebHistoryInterface): void =
  fcQWebHistoryInterface_setDefaultInterface(defaultInterface.h)

proc defaultInterface*(_: type gen_qwebhistoryinterface_types.QWebHistoryInterface, ): QWebHistoryInterface =
...
proc miqt_exec_callback_QWebHistoryInterface_addHistoryEntry(self: ptr cQWebHistoryInterface, slot: int, url: struct_miqt_string): void {.exportc: "miqt_exec_callback_QWebHistoryInterface_addHistoryEntry ".} =
  ...
  nimfunc[](slotval1)
proc QWebHistoryInterfaceevent*(self: gen_qwebhistoryinterface_types.QWebHistoryInterface, event: QEvent): bool =
  fQWebHistoryInterface_virtualbase_event(self.h, event.h)

type QWebHistoryInterfaceeventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QWebHistoryInterface_event(self: ptr cQWebHistoryInterface, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QWebHistoryInterface_event ".} =
  ...
  virtualReturn
proc QWebHistoryInterfaceeventFilter*(self: gen_qwebhistoryinterface_types.QWebHistoryInterface, watched: QObject, event: QEvent): bool =
  fQWebHistoryInterface_virtualbase_eventFilter(self.h, watched.h, event.h)

type QWebHistoryInterfaceeventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QWebHistoryInterface_eventFilter(self: ptr cQWebHistoryInterface, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QWebHistoryInterface_eventFilter ".} =
  ...
  virtualReturn
proc QWebHistoryInterfacetimerEvent*(self: gen_qwebhistoryinterface_types.QWebHistoryInterface, event: QTimerEvent): void =
  fQWebHistoryInterface_virtualbase_timerEvent(self.h, event.h)

type QWebHistoryInterfacetimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QWebHistoryInterface_timerEvent(self: ptr cQWebHistoryInterface, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QWebHistoryInterface_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QWebHistoryInterfacechildEvent*(self: gen_qwebhistoryinterface_types.QWebHistoryInterface, event: QChildEvent): void =
  fQWebHistoryInterface_virtualbase_childEvent(self.h, event.h)

type QWebHistoryInterfacechildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QWebHistoryInterface_childEvent(self: ptr cQWebHistoryInterface, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QWebHistoryInterface_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QWebHistoryInterfacecustomEvent*(self: gen_qwebhistoryinterface_types.QWebHistoryInterface, event: QEvent): void =
  fQWebHistoryInterface_virtualbase_customEvent(self.h, event.h)

type QWebHistoryInterfacecustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QWebHistoryInterface_customEvent(self: ptr cQWebHistoryInterface, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QWebHistoryInterface_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QWebHistoryInterfaceconnectNotify*(self: gen_qwebhistoryinterface_types.QWebHistoryInterface, signal: QMetaMethod): void =
  fQWebHistoryInterface_virtualbase_connectNotify(self.h, signal.h)

type QWebHistoryInterfaceconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QWebHistoryInterface_connectNotify(self: ptr cQWebHistoryInterface, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QWebHistoryInterface_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QWebHistoryInterfacedisconnectNotify*(self: gen_qwebhistoryinterface_types.QWebHistoryInterface, signal: QMetaMethod): void =
  fQWebHistoryInterface_virtualbase_disconnectNotify(self.h, signal.h)

type QWebHistoryInterfacedisconnectNotifyProc* = proc(signal: QMetaMethod): void
