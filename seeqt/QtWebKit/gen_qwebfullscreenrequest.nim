...
proc create*(T: type gen_qwebfullscreenrequest_types.QWebFullScreenRequest, param1: QWebFullScreenRequest): gen_qwebfullscreenrequest_types.QWebFullScreenRequest =
...
proc origin*(self: gen_qwebfullscreenrequest_types.QWebFullScreenRequest, ): QUrl =
  QUrl(h: fcQWebFullScreenRequest_origin(self.h))

proc element*(self: gen_qwebfullscreenrequest_types.QWebFullScreenRequest, ): QWebElement =
  QWebElement(h: fcQWebFullScreenRequest_element(self.h))
