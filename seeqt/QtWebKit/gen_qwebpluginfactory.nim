...
proc create*(T: type gen_qwebpluginfactory_types.QWebPluginFactory, parent: QObject): gen_qwebpluginfactory_types.QWebPluginFactory =
  gen_qwebpluginfactory_types.QWebPluginFactory.init(fcQWebPluginFactory_new2(parent.h))

proc metaObject*(self: gen_qwebpluginfactory_types.QWebPluginFactory, ): QMetaObject =
  QMetaObject(h: fcQWebPluginFactory_metaObject(self.h))
...
proc plugins*(self: gen_qwebpluginfactory_types.QWebPluginFactory, ): seq[QWebPluginFactoryPlugin] =
...
proc create*(self: gen_qwebpluginfactory_types.QWebPluginFactory, mimeType: string, param2: QUrl, argumentNames: seq[string], argumentValues: seq[string]): QObject =
...
proc extension*(self: gen_qwebpluginfactory_types.QWebPluginFactory, extension: cint, option: QWebPluginFactoryExtensionOption, output: QWebPluginFactoryExtensionReturn): bool =
...
proc miqt_exec_callback_QWebPluginFactory_metacall(self: ptr cQWebPluginFactory, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QWebPluginFactory_metacall ".} =
  ...
  virtualReturn
type QWebPluginFactorypluginsProc* = proc(): seq[QWebPluginFactoryPlugin]
...
proc miqt_exec_callback_QWebPluginFactory_refreshPlugins(self: ptr cQWebPluginFactory, slot: int): void {.exportc: "miqt_exec_callback_QWebPluginFactory_refreshPlugins ".} =
  ...
  nimfunc[]()
type QWebPluginFactorycreateProc* = proc(mimeType: string, param2: QUrl, argumentNames: seq[string], argumentValues: seq[string]): QObject
...
proc miqt_exec_callback_QWebPluginFactory_create(self: ptr cQWebPluginFactory, slot: int, mimeType: struct_miqt_string, param2: pointer, argumentNames: struct_miqt_array, argumentValues: struct_miqt_array): pointer {.exportc: "miqt_exec_callback_QWebPluginFactory_create ".} =
  ...
  virtualReturn.h
proc QWebPluginFactoryextension*(self: gen_qwebpluginfactory_types.QWebPluginFactory, extension: cint, option: QWebPluginFactoryExtensionOption, output: QWebPluginFactoryExtensionReturn): bool =
  fQWebPluginFactory_virtualbase_extension(self.h, cint(extension), option.h, output.h)

type QWebPluginFactoryextensionProc* = proc(extension: cint, option: QWebPluginFactoryExtensionOption, output: QWebPluginFactoryExtensionReturn): bool
...
proc miqt_exec_callback_QWebPluginFactory_supportsExtension(self: ptr cQWebPluginFactory, slot: int, extension: cint): bool {.exportc: "miqt_exec_callback_QWebPluginFactory_supportsExtension ".} =
  ...
  virtualReturn
proc QWebPluginFactoryevent*(self: gen_qwebpluginfactory_types.QWebPluginFactory, event: QEvent): bool =
  fQWebPluginFactory_virtualbase_event(self.h, event.h)

type QWebPluginFactoryeventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QWebPluginFactory_event(self: ptr cQWebPluginFactory, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QWebPluginFactory_event ".} =
  ...
  virtualReturn
proc QWebPluginFactoryeventFilter*(self: gen_qwebpluginfactory_types.QWebPluginFactory, watched: QObject, event: QEvent): bool =
  fQWebPluginFactory_virtualbase_eventFilter(self.h, watched.h, event.h)

type QWebPluginFactoryeventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QWebPluginFactory_eventFilter(self: ptr cQWebPluginFactory, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QWebPluginFactory_eventFilter ".} =
  ...
  virtualReturn
proc QWebPluginFactorytimerEvent*(self: gen_qwebpluginfactory_types.QWebPluginFactory, event: QTimerEvent): void =
  fQWebPluginFactory_virtualbase_timerEvent(self.h, event.h)

type QWebPluginFactorytimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QWebPluginFactory_timerEvent(self: ptr cQWebPluginFactory, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QWebPluginFactory_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QWebPluginFactorychildEvent*(self: gen_qwebpluginfactory_types.QWebPluginFactory, event: QChildEvent): void =
  fQWebPluginFactory_virtualbase_childEvent(self.h, event.h)

type QWebPluginFactorychildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QWebPluginFactory_childEvent(self: ptr cQWebPluginFactory, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QWebPluginFactory_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QWebPluginFactorycustomEvent*(self: gen_qwebpluginfactory_types.QWebPluginFactory, event: QEvent): void =
  fQWebPluginFactory_virtualbase_customEvent(self.h, event.h)

type QWebPluginFactorycustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QWebPluginFactory_customEvent(self: ptr cQWebPluginFactory, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QWebPluginFactory_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QWebPluginFactoryconnectNotify*(self: gen_qwebpluginfactory_types.QWebPluginFactory, signal: QMetaMethod): void =
  fQWebPluginFactory_virtualbase_connectNotify(self.h, signal.h)

type QWebPluginFactoryconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QWebPluginFactory_connectNotify(self: ptr cQWebPluginFactory, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QWebPluginFactory_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QWebPluginFactorydisconnectNotify*(self: gen_qwebpluginfactory_types.QWebPluginFactory, signal: QMetaMethod): void =
  fQWebPluginFactory_virtualbase_disconnectNotify(self.h, signal.h)

type QWebPluginFactorydisconnectNotifyProc* = proc(signal: QMetaMethod): void
...
func init*(T: type gen_qwebpluginfactory_types.QWebPluginFactoryMimeType, h: ptr cQWebPluginFactoryMimeType): gen_qwebpluginfactory_types.QWebPluginFactoryMimeType =
  T(h: h)
proc create*(T: type gen_qwebpluginfactory_types.QWebPluginFactoryMimeType, param1: QWebPluginFactoryMimeType): gen_qwebpluginfactory_types.QWebPluginFactoryMimeType =
  gen_qwebpluginfactory_types.QWebPluginFactoryMimeType.init(fcQWebPluginFactoryMimeType_new(param1.h))

proc operatorEqual*(self: gen_qwebpluginfactory_types.QWebPluginFactoryMimeType, other: QWebPluginFactoryMimeType): bool =
  fcQWebPluginFactoryMimeType_operatorEqual(self.h, other.h)

proc operatorNotEqual*(self: gen_qwebpluginfactory_types.QWebPluginFactoryMimeType, other: QWebPluginFactoryMimeType): bool =
  fcQWebPluginFactoryMimeType_operatorNotEqual(self.h, other.h)

proc operatorAssign*(self: gen_qwebpluginfactory_types.QWebPluginFactoryMimeType, param1: QWebPluginFactoryMimeType): void =
...
func init*(T: type gen_qwebpluginfactory_types.QWebPluginFactoryPlugin, h: ptr cQWebPluginFactoryPlugin): gen_qwebpluginfactory_types.QWebPluginFactoryPlugin =
  T(h: h)
proc create*(T: type gen_qwebpluginfactory_types.QWebPluginFactoryPlugin, param1: QWebPluginFactoryPlugin): gen_qwebpluginfactory_types.QWebPluginFactoryPlugin =
  gen_qwebpluginfactory_types.QWebPluginFactoryPlugin.init(fcQWebPluginFactoryPlugin_new(param1.h))

proc operatorAssign*(self: gen_qwebpluginfactory_types.QWebPluginFactoryPlugin, param1: QWebPluginFactoryPlugin): void =
