...
func init*(T: type gen_qwebsecurityorigin_types.QWebSecurityOrigin, h: ptr cQWebSecurityOrigin): gen_qwebsecurityorigin_types.QWebSecurityOrigin =
  T(h: h)
proc create*(T: type gen_qwebsecurityorigin_types.QWebSecurityOrigin, url: QUrl): gen_qwebsecurityorigin_types.QWebSecurityOrigin =
  gen_qwebsecurityorigin_types.QWebSecurityOrigin.init(fcQWebSecurityOrigin_new(url.h))

proc create*(T: type gen_qwebsecurityorigin_types.QWebSecurityOrigin, other: QWebSecurityOrigin): gen_qwebsecurityorigin_types.QWebSecurityOrigin =
  gen_qwebsecurityorigin_types.QWebSecurityOrigin.init(fcQWebSecurityOrigin_new2(other.h))

proc allOrigins*(_: type gen_qwebsecurityorigin_types.QWebSecurityOrigin, ): seq[QWebSecurityOrigin] =
...
proc databases*(self: gen_qwebsecurityorigin_types.QWebSecurityOrigin, ): seq[QWebDatabase] =
  var v_ma = fcQWebSecurityOrigin_databases(self.h)
  var vx_ret = newSeq[QWebDatabase](int(v_ma.len))
  let v_outCast = cast[ptr UncheckedArray[pointer]](v_ma.data)
  for i in 0 ..< v_ma.len:
    vx_ret[i] = QWebDatabase(h: v_outCast[i])
  vx_ret

proc operatorAssign*(self: gen_qwebsecurityorigin_types.QWebSecurityOrigin, other: QWebSecurityOrigin): void =
