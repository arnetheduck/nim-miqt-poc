...
proc backgroundColor*(self: gen_qwebkitplatformplugin_types.QWebSelectData, ): QColor =
  QColor(h: fcQWebSelectData_backgroundColor(self.h))

proc foregroundColor*(self: gen_qwebkitplatformplugin_types.QWebSelectData, ): QColor =
  QColor(h: fcQWebSelectData_foregroundColor(self.h))

proc itemBackgroundColor*(self: gen_qwebkitplatformplugin_types.QWebSelectData, index: cint): QColor =
  QColor(h: fcQWebSelectData_itemBackgroundColor(self.h, index))

proc itemForegroundColor*(self: gen_qwebkitplatformplugin_types.QWebSelectData, index: cint): QColor =
  QColor(h: fcQWebSelectData_itemForegroundColor(self.h, index))

proc operatorAssign*(self: gen_qwebkitplatformplugin_types.QWebSelectData, param1: QWebSelectData): void =
...
func init*(T: type gen_qwebkitplatformplugin_types.QWebSelectMethod, h: ptr cQWebSelectMethod): gen_qwebkitplatformplugin_types.QWebSelectMethod =
  T(h: h)
proc metaObject*(self: gen_qwebkitplatformplugin_types.QWebSelectMethod, ): QMetaObject =
  QMetaObject(h: fcQWebSelectMethod_metaObject(self.h))
...
proc show*(self: gen_qwebkitplatformplugin_types.QWebSelectMethod, param1: QWebSelectData): void =
...
proc setGeometry*(self: gen_qwebkitplatformplugin_types.QWebSelectMethod, geometry: QRect): void =
  fcQWebSelectMethod_setGeometry(self.h, geometry.h)

proc setFont*(self: gen_qwebkitplatformplugin_types.QWebSelectMethod, font: QFont): void =
...
proc iconUrl*(self: gen_qwebkitplatformplugin_types.QWebNotificationData, ): QUrl =
  QUrl(h: fcQWebNotificationData_iconUrl(self.h))

proc openerPageUrl*(self: gen_qwebkitplatformplugin_types.QWebNotificationData, ): QUrl =
  QUrl(h: fcQWebNotificationData_openerPageUrl(self.h))

proc operatorAssign*(self: gen_qwebkitplatformplugin_types.QWebNotificationData, param1: QWebNotificationData): void =
...
func init*(T: type gen_qwebkitplatformplugin_types.QWebNotificationPresenter, h: ptr cQWebNotificationPresenter): gen_qwebkitplatformplugin_types.QWebNotificationPresenter =
  T(h: h)
proc metaObject*(self: gen_qwebkitplatformplugin_types.QWebNotificationPresenter, ): QMetaObject =
  QMetaObject(h: fcQWebNotificationPresenter_metaObject(self.h))
...
proc showNotification*(self: gen_qwebkitplatformplugin_types.QWebNotificationPresenter, param1: QWebNotificationData): void =
...
func init*(T: type gen_qwebkitplatformplugin_types.QWebHapticFeedbackPlayer, h: ptr cQWebHapticFeedbackPlayer): gen_qwebkitplatformplugin_types.QWebHapticFeedbackPlayer =
  T(h: h)
proc metaObject*(self: gen_qwebkitplatformplugin_types.QWebHapticFeedbackPlayer, ): QMetaObject =
  QMetaObject(h: fcQWebHapticFeedbackPlayer_metaObject(self.h))
...
func init*(T: type gen_qwebkitplatformplugin_types.QWebTouchModifier, h: ptr cQWebTouchModifier): gen_qwebkitplatformplugin_types.QWebTouchModifier =
  T(h: h)
proc metaObject*(self: gen_qwebkitplatformplugin_types.QWebTouchModifier, ): QMetaObject =
  QMetaObject(h: fcQWebTouchModifier_metaObject(self.h))
...
func init*(T: type gen_qwebkitplatformplugin_types.QWebSpellChecker, h: ptr cQWebSpellChecker): gen_qwebkitplatformplugin_types.QWebSpellChecker =
  T(h: h)
proc metaObject*(self: gen_qwebkitplatformplugin_types.QWebSpellChecker, ): QMetaObject =
  QMetaObject(h: fcQWebSpellChecker_metaObject(self.h))
...
proc checkGrammarOfString*(self: gen_qwebkitplatformplugin_types.QWebSpellChecker, param1: string, param2: seq[QWebSpellCheckerGrammarDetail], badGrammarLocation: ptr cint, badGrammarLength: ptr cint): void =
...
proc createExtension*(self: gen_qwebkitplatformplugin_types.QWebKitPlatformPlugin, param1: cint): QObject =
  QObject(h: fcQWebKitPlatformPlugin_createExtension(self.h, cint(param1)))

proc operatorAssign*(self: gen_qwebkitplatformplugin_types.QWebKitPlatformPlugin, param1: QWebKitPlatformPlugin): void =
...
func init*(T: type gen_qwebkitplatformplugin_types.QWebSpellCheckerGrammarDetail, h: ptr cQWebSpellCheckerGrammarDetail): gen_qwebkitplatformplugin_types.QWebSpellCheckerGrammarDetail =
  T(h: h)
proc create*(T: type gen_qwebkitplatformplugin_types.QWebSpellCheckerGrammarDetail, param1: QWebSpellCheckerGrammarDetail): gen_qwebkitplatformplugin_types.QWebSpellCheckerGrammarDetail =
  gen_qwebkitplatformplugin_types.QWebSpellCheckerGrammarDetail.init(fcQWebSpellCheckerGrammarDetail_new(param1.h))

proc operatorAssign*(self: gen_qwebkitplatformplugin_types.QWebSpellCheckerGrammarDetail, param1: QWebSpellCheckerGrammarDetail): void =
