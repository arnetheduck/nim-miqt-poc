...
func init*(T: type gen_qwebsettings_types.QWebSettings, h: ptr cQWebSettings): gen_qwebsettings_types.QWebSettings =
  T(h: h)
proc globalSettings*(_: type gen_qwebsettings_types.QWebSettings, ): QWebSettings =
...
proc setUserStyleSheetUrl*(self: gen_qwebsettings_types.QWebSettings, location: QUrl): void =
  fcQWebSettings_setUserStyleSheetUrl(self.h, location.h)

proc userStyleSheetUrl*(self: gen_qwebsettings_types.QWebSettings, ): QUrl =
  QUrl(h: fcQWebSettings_userStyleSheetUrl(self.h))
...
proc iconForUrl*(_: type gen_qwebsettings_types.QWebSettings, url: QUrl): QIcon =
  QIcon(h: fcQWebSettings_iconForUrl(url.h))
...
proc setWebGraphic*(_: type gen_qwebsettings_types.QWebSettings, typeVal: cint, graphic: QPixmap): void =
  fcQWebSettings_setWebGraphic(cint(typeVal), graphic.h)

proc webGraphic*(_: type gen_qwebsettings_types.QWebSettings, typeVal: cint): QPixmap =
  QPixmap(h: fcQWebSettings_webGraphic(cint(typeVal)))
