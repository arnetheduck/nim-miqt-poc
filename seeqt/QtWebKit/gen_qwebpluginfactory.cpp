...
QMetaObject* QWebPluginFactory_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQWebPluginFactory*)(self) )->QWebPluginFactory::metaObject();

}

void* QWebPluginFactory_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQWebPluginFactory*)(self) )->QWebPluginFactory::qt_metacast(param1);

}

int QWebPluginFactory_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQWebPluginFactory*)(self) )->QWebPluginFactory::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
QObject* QWebPluginFactory_protectedbase_sender(const void* self) {
	MiqtVirtualQWebPluginFactory* self_cast = static_cast<MiqtVirtualQWebPluginFactory*>( (QWebPluginFactory*)(self) );
