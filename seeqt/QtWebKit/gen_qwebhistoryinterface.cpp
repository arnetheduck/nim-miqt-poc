...
public:
	...
	MiqtVirtualQWebHistoryInterface(struct QWebHistoryInterface_VTable* vtbl): QWebHistoryInterface(), vtbl(vtbl) {};
	MiqtVirtualQWebHistoryInterface(struct QWebHistoryInterface_VTable* vtbl, QObject* parent): QWebHistoryInterface(parent), vtbl(vtbl) {};

	virtual ~MiqtVirtualQWebHistoryInterface() override { if(vtbl->destructor) vtbl->destructor(vtbl, this); }
...
QWebHistoryInterface* QWebHistoryInterface_new(struct QWebHistoryInterface_VTable* vtbl) {
	return new MiqtVirtualQWebHistoryInterface(vtbl);
}

QWebHistoryInterface* QWebHistoryInterface_new2(struct QWebHistoryInterface_VTable* vtbl, QObject* parent) {
	return new MiqtVirtualQWebHistoryInterface(vtbl, parent);
}
...
QMetaObject* QWebHistoryInterface_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQWebHistoryInterface*)(self) )->QWebHistoryInterface::metaObject();

}

void* QWebHistoryInterface_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQWebHistoryInterface*)(self) )->QWebHistoryInterface::qt_metacast(param1);

}

int QWebHistoryInterface_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQWebHistoryInterface*)(self) )->QWebHistoryInterface::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
QObject* QWebHistoryInterface_protectedbase_sender(const void* self) {
	MiqtVirtualQWebHistoryInterface* self_cast = static_cast<MiqtVirtualQWebHistoryInterface*>( (QWebHistoryInterface*)(self) );
