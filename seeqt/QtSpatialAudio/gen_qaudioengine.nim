...
proc create*(T: type gen_qaudioengine_types.QAudioEngine, parent: QObject): gen_qaudioengine_types.QAudioEngine =
...
proc create*(T: type gen_qaudioengine_types.QAudioEngine, sampleRate: cint, parent: QObject): gen_qaudioengine_types.QAudioEngine =
  gen_qaudioengine_types.QAudioEngine.init(fcQAudioEngine_new4(sampleRate, parent.h))

proc metaObject*(self: gen_qaudioengine_types.QAudioEngine, ): QMetaObject =
  QMetaObject(h: fcQAudioEngine_metaObject(self.h))
...
proc setOutputDevice*(self: gen_qaudioengine_types.QAudioEngine, device: QAudioDevice): void =
  fcQAudioEngine_setOutputDevice(self.h, device.h)

proc outputDevice*(self: gen_qaudioengine_types.QAudioEngine, ): QAudioDevice =
  QAudioDevice(h: fcQAudioEngine_outputDevice(self.h))
...
proc miqt_exec_callback_QAudioEngine_metacall(self: ptr cQAudioEngine, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QAudioEngine_metacall ".} =
  ...
  virtualReturn
proc QAudioEngineevent*(self: gen_qaudioengine_types.QAudioEngine, event: QEvent): bool =
  fQAudioEngine_virtualbase_event(self.h, event.h)

type QAudioEngineeventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QAudioEngine_event(self: ptr cQAudioEngine, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QAudioEngine_event ".} =
  ...
  virtualReturn
proc QAudioEngineeventFilter*(self: gen_qaudioengine_types.QAudioEngine, watched: QObject, event: QEvent): bool =
  fQAudioEngine_virtualbase_eventFilter(self.h, watched.h, event.h)

type QAudioEngineeventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QAudioEngine_eventFilter(self: ptr cQAudioEngine, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QAudioEngine_eventFilter ".} =
  ...
  virtualReturn
proc QAudioEnginetimerEvent*(self: gen_qaudioengine_types.QAudioEngine, event: QTimerEvent): void =
  fQAudioEngine_virtualbase_timerEvent(self.h, event.h)

type QAudioEnginetimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QAudioEngine_timerEvent(self: ptr cQAudioEngine, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QAudioEngine_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QAudioEnginechildEvent*(self: gen_qaudioengine_types.QAudioEngine, event: QChildEvent): void =
  fQAudioEngine_virtualbase_childEvent(self.h, event.h)

type QAudioEnginechildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QAudioEngine_childEvent(self: ptr cQAudioEngine, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QAudioEngine_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QAudioEnginecustomEvent*(self: gen_qaudioengine_types.QAudioEngine, event: QEvent): void =
  fQAudioEngine_virtualbase_customEvent(self.h, event.h)

type QAudioEnginecustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QAudioEngine_customEvent(self: ptr cQAudioEngine, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QAudioEngine_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QAudioEngineconnectNotify*(self: gen_qaudioengine_types.QAudioEngine, signal: QMetaMethod): void =
  fQAudioEngine_virtualbase_connectNotify(self.h, signal.h)

type QAudioEngineconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QAudioEngine_connectNotify(self: ptr cQAudioEngine, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QAudioEngine_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QAudioEnginedisconnectNotify*(self: gen_qaudioengine_types.QAudioEngine, signal: QMetaMethod): void =
  fQAudioEngine_virtualbase_disconnectNotify(self.h, signal.h)

type QAudioEnginedisconnectNotifyProc* = proc(signal: QMetaMethod): void
