...
void QAmbientSound_connect_sourceChanged(QAmbientSound* self, intptr_t slot, void (*callback)(intptr_t), void (*release)(intptr_t)) {
	...
	MiqtVirtualQAmbientSound::connect(self, static_cast<void (QAmbientSound::*)()>(&QAmbientSound::sourceChanged), self, caller{slot, callback, release});
}
...
void QAmbientSound_connect_loopsChanged(QAmbientSound* self, intptr_t slot, void (*callback)(intptr_t), void (*release)(intptr_t)) {
	...
	MiqtVirtualQAmbientSound::connect(self, static_cast<void (QAmbientSound::*)()>(&QAmbientSound::loopsChanged), self, caller{slot, callback, release});
}
...
void QAmbientSound_connect_autoPlayChanged(QAmbientSound* self, intptr_t slot, void (*callback)(intptr_t), void (*release)(intptr_t)) {
	...
	MiqtVirtualQAmbientSound::connect(self, static_cast<void (QAmbientSound::*)()>(&QAmbientSound::autoPlayChanged), self, caller{slot, callback, release});
}
...
void QAmbientSound_connect_volumeChanged(QAmbientSound* self, intptr_t slot, void (*callback)(intptr_t), void (*release)(intptr_t)) {
	...
	MiqtVirtualQAmbientSound::connect(self, static_cast<void (QAmbientSound::*)()>(&QAmbientSound::volumeChanged), self, caller{slot, callback, release});
}
...
QMetaObject* QAmbientSound_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQAmbientSound*)(self) )->QAmbientSound::metaObject();

}

void* QAmbientSound_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQAmbientSound*)(self) )->QAmbientSound::qt_metacast(param1);

}

int QAmbientSound_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQAmbientSound*)(self) )->QAmbientSound::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);

}

bool QAmbientSound_virtualbase_event(void* self, QEvent* event) {

	return ( (MiqtVirtualQAmbientSound*)(self) )->QAmbientSound::event(event);

}

bool QAmbientSound_virtualbase_eventFilter(void* self, QObject* watched, QEvent* event) {

	return ( (MiqtVirtualQAmbientSound*)(self) )->QAmbientSound::eventFilter(watched, event);

}

void QAmbientSound_virtualbase_timerEvent(void* self, QTimerEvent* event) {

	( (MiqtVirtualQAmbientSound*)(self) )->QAmbientSound::timerEvent(event);

}

void QAmbientSound_virtualbase_childEvent(void* self, QChildEvent* event) {

	( (MiqtVirtualQAmbientSound*)(self) )->QAmbientSound::childEvent(event);

}

void QAmbientSound_virtualbase_customEvent(void* self, QEvent* event) {

	( (MiqtVirtualQAmbientSound*)(self) )->QAmbientSound::customEvent(event);

}

void QAmbientSound_virtualbase_connectNotify(void* self, QMetaMethod* signal) {

	( (MiqtVirtualQAmbientSound*)(self) )->QAmbientSound::connectNotify(*signal);

}

void QAmbientSound_virtualbase_disconnectNotify(void* self, QMetaMethod* signal) {

	( (MiqtVirtualQAmbientSound*)(self) )->QAmbientSound::disconnectNotify(*signal);
