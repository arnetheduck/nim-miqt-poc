...
func init*(T: type gen_qambientsound_types.QAmbientSound, h: ptr cQAmbientSound): gen_qambientsound_types.QAmbientSound =
  T(h: h)
proc create*(T: type gen_qambientsound_types.QAmbientSound, engine: QAudioEngine): gen_qambientsound_types.QAmbientSound =
  gen_qambientsound_types.QAmbientSound.init(fcQAmbientSound_new(engine.h))

proc metaObject*(self: gen_qambientsound_types.QAmbientSound, ): QMetaObject =
  QMetaObject(h: fcQAmbientSound_metaObject(self.h))
...
proc setSource*(self: gen_qambientsound_types.QAmbientSound, url: QUrl): void =
  fcQAmbientSound_setSource(self.h, url.h)

proc source*(self: gen_qambientsound_types.QAmbientSound, ): QUrl =
  QUrl(h: fcQAmbientSound_source(self.h))
...
proc engine*(self: gen_qambientsound_types.QAmbientSound, ): QAudioEngine =
  QAudioEngine(h: fcQAmbientSound_engine(self.h))
...
proc miqt_exec_callback_QAmbientSound_metacall(self: ptr cQAmbientSound, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QAmbientSound_metacall ".} =
  ...
  virtualReturn
proc QAmbientSoundevent*(self: gen_qambientsound_types.QAmbientSound, event: QEvent): bool =
  fQAmbientSound_virtualbase_event(self.h, event.h)

type QAmbientSoundeventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QAmbientSound_event(self: ptr cQAmbientSound, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QAmbientSound_event ".} =
  ...
  virtualReturn
proc QAmbientSoundeventFilter*(self: gen_qambientsound_types.QAmbientSound, watched: QObject, event: QEvent): bool =
  fQAmbientSound_virtualbase_eventFilter(self.h, watched.h, event.h)

type QAmbientSoundeventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QAmbientSound_eventFilter(self: ptr cQAmbientSound, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QAmbientSound_eventFilter ".} =
  ...
  virtualReturn
proc QAmbientSoundtimerEvent*(self: gen_qambientsound_types.QAmbientSound, event: QTimerEvent): void =
  fQAmbientSound_virtualbase_timerEvent(self.h, event.h)

type QAmbientSoundtimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QAmbientSound_timerEvent(self: ptr cQAmbientSound, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QAmbientSound_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QAmbientSoundchildEvent*(self: gen_qambientsound_types.QAmbientSound, event: QChildEvent): void =
  fQAmbientSound_virtualbase_childEvent(self.h, event.h)

type QAmbientSoundchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QAmbientSound_childEvent(self: ptr cQAmbientSound, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QAmbientSound_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QAmbientSoundcustomEvent*(self: gen_qambientsound_types.QAmbientSound, event: QEvent): void =
  fQAmbientSound_virtualbase_customEvent(self.h, event.h)

type QAmbientSoundcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QAmbientSound_customEvent(self: ptr cQAmbientSound, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QAmbientSound_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QAmbientSoundconnectNotify*(self: gen_qambientsound_types.QAmbientSound, signal: QMetaMethod): void =
  fQAmbientSound_virtualbase_connectNotify(self.h, signal.h)

type QAmbientSoundconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QAmbientSound_connectNotify(self: ptr cQAmbientSound, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QAmbientSound_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QAmbientSounddisconnectNotify*(self: gen_qambientsound_types.QAmbientSound, signal: QMetaMethod): void =
  fQAmbientSound_virtualbase_disconnectNotify(self.h, signal.h)

type QAmbientSounddisconnectNotifyProc* = proc(signal: QMetaMethod): void
