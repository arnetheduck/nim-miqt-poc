...
func init*(T: type gen_qaudioroom_types.QAudioRoom, h: ptr cQAudioRoom): gen_qaudioroom_types.QAudioRoom =
  T(h: h)
proc create*(T: type gen_qaudioroom_types.QAudioRoom, engine: QAudioEngine): gen_qaudioroom_types.QAudioRoom =
  gen_qaudioroom_types.QAudioRoom.init(fcQAudioRoom_new(engine.h))

proc metaObject*(self: gen_qaudioroom_types.QAudioRoom, ): QMetaObject =
  QMetaObject(h: fcQAudioRoom_metaObject(self.h))
...
proc setPosition*(self: gen_qaudioroom_types.QAudioRoom, pos: QVector3D): void =
  fcQAudioRoom_setPosition(self.h, pos.h)

proc position*(self: gen_qaudioroom_types.QAudioRoom, ): QVector3D =
  QVector3D(h: fcQAudioRoom_position(self.h))

proc setDimensions*(self: gen_qaudioroom_types.QAudioRoom, dim: QVector3D): void =
  fcQAudioRoom_setDimensions(self.h, dim.h)

proc dimensions*(self: gen_qaudioroom_types.QAudioRoom, ): QVector3D =
  QVector3D(h: fcQAudioRoom_dimensions(self.h))

proc setRotation*(self: gen_qaudioroom_types.QAudioRoom, q: QQuaternion): void =
  fcQAudioRoom_setRotation(self.h, q.h)

proc rotation*(self: gen_qaudioroom_types.QAudioRoom, ): QQuaternion =
  QQuaternion(h: fcQAudioRoom_rotation(self.h))
...
proc onmetacall*(self: gen_qaudioroom_types.QAudioRoom, slot: QAudioRoommetacallProc) =
  # TODO check subclass
  var tmp = new QAudioRoommetacallProc
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QAudioRoom_metacall(self: ptr cQAudioRoom, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QAudioRoom_metacall ".} =
  var nimfunc = cast[ptr QAudioRoommetacallProc](cast[pointer](slot))
  ...
  virtualReturn
proc QAudioRoomevent*(self: gen_qaudioroom_types.QAudioRoom, event: QEvent): bool =
  fQAudioRoom_virtualbase_event(self.h, event.h)

type QAudioRoomeventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QAudioRoom_event(self: ptr cQAudioRoom, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QAudioRoom_event ".} =
  ...
  virtualReturn
proc QAudioRoomeventFilter*(self: gen_qaudioroom_types.QAudioRoom, watched: QObject, event: QEvent): bool =
  fQAudioRoom_virtualbase_eventFilter(self.h, watched.h, event.h)

type QAudioRoomeventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QAudioRoom_eventFilter(self: ptr cQAudioRoom, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QAudioRoom_eventFilter ".} =
  ...
  virtualReturn
proc QAudioRoomtimerEvent*(self: gen_qaudioroom_types.QAudioRoom, event: QTimerEvent): void =
  fQAudioRoom_virtualbase_timerEvent(self.h, event.h)

type QAudioRoomtimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QAudioRoom_timerEvent(self: ptr cQAudioRoom, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QAudioRoom_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QAudioRoomchildEvent*(self: gen_qaudioroom_types.QAudioRoom, event: QChildEvent): void =
  fQAudioRoom_virtualbase_childEvent(self.h, event.h)

type QAudioRoomchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QAudioRoom_childEvent(self: ptr cQAudioRoom, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QAudioRoom_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QAudioRoomcustomEvent*(self: gen_qaudioroom_types.QAudioRoom, event: QEvent): void =
  fQAudioRoom_virtualbase_customEvent(self.h, event.h)

type QAudioRoomcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QAudioRoom_customEvent(self: ptr cQAudioRoom, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QAudioRoom_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QAudioRoomconnectNotify*(self: gen_qaudioroom_types.QAudioRoom, signal: QMetaMethod): void =
  fQAudioRoom_virtualbase_connectNotify(self.h, signal.h)

type QAudioRoomconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QAudioRoom_connectNotify(self: ptr cQAudioRoom, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QAudioRoom_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QAudioRoomdisconnectNotify*(self: gen_qaudioroom_types.QAudioRoom, signal: QMetaMethod): void =
  fQAudioRoom_virtualbase_disconnectNotify(self.h, signal.h)

type QAudioRoomdisconnectNotifyProc* = proc(signal: QMetaMethod): void
