...
func init*(T: type gen_qspatialsound_types.QSpatialSound, h: ptr cQSpatialSound): gen_qspatialsound_types.QSpatialSound =
  T(h: h)
proc create*(T: type gen_qspatialsound_types.QSpatialSound, engine: QAudioEngine): gen_qspatialsound_types.QSpatialSound =
  gen_qspatialsound_types.QSpatialSound.init(fcQSpatialSound_new(engine.h))

proc metaObject*(self: gen_qspatialsound_types.QSpatialSound, ): QMetaObject =
  QMetaObject(h: fcQSpatialSound_metaObject(self.h))
...
proc setSource*(self: gen_qspatialsound_types.QSpatialSound, url: QUrl): void =
  fcQSpatialSound_setSource(self.h, url.h)

proc source*(self: gen_qspatialsound_types.QSpatialSound, ): QUrl =
  QUrl(h: fcQSpatialSound_source(self.h))
...
proc setPosition*(self: gen_qspatialsound_types.QSpatialSound, pos: QVector3D): void =
  fcQSpatialSound_setPosition(self.h, pos.h)

proc position*(self: gen_qspatialsound_types.QSpatialSound, ): QVector3D =
  QVector3D(h: fcQSpatialSound_position(self.h))

proc setRotation*(self: gen_qspatialsound_types.QSpatialSound, q: QQuaternion): void =
  fcQSpatialSound_setRotation(self.h, q.h)

proc rotation*(self: gen_qspatialsound_types.QSpatialSound, ): QQuaternion =
  QQuaternion(h: fcQSpatialSound_rotation(self.h))
...
proc engine*(self: gen_qspatialsound_types.QSpatialSound, ): QAudioEngine =
  QAudioEngine(h: fcQSpatialSound_engine(self.h))
...
proc miqt_exec_callback_QSpatialSound_metacall(self: ptr cQSpatialSound, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QSpatialSound_metacall ".} =
  ...
  virtualReturn
proc QSpatialSoundevent*(self: gen_qspatialsound_types.QSpatialSound, event: QEvent): bool =
  fQSpatialSound_virtualbase_event(self.h, event.h)

type QSpatialSoundeventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QSpatialSound_event(self: ptr cQSpatialSound, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QSpatialSound_event ".} =
  ...
  virtualReturn
proc QSpatialSoundeventFilter*(self: gen_qspatialsound_types.QSpatialSound, watched: QObject, event: QEvent): bool =
  fQSpatialSound_virtualbase_eventFilter(self.h, watched.h, event.h)

type QSpatialSoundeventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QSpatialSound_eventFilter(self: ptr cQSpatialSound, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QSpatialSound_eventFilter ".} =
  ...
  virtualReturn
proc QSpatialSoundtimerEvent*(self: gen_qspatialsound_types.QSpatialSound, event: QTimerEvent): void =
  fQSpatialSound_virtualbase_timerEvent(self.h, event.h)

type QSpatialSoundtimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QSpatialSound_timerEvent(self: ptr cQSpatialSound, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QSpatialSound_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QSpatialSoundchildEvent*(self: gen_qspatialsound_types.QSpatialSound, event: QChildEvent): void =
  fQSpatialSound_virtualbase_childEvent(self.h, event.h)

type QSpatialSoundchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QSpatialSound_childEvent(self: ptr cQSpatialSound, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QSpatialSound_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QSpatialSoundcustomEvent*(self: gen_qspatialsound_types.QSpatialSound, event: QEvent): void =
  fQSpatialSound_virtualbase_customEvent(self.h, event.h)

type QSpatialSoundcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QSpatialSound_customEvent(self: ptr cQSpatialSound, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QSpatialSound_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QSpatialSoundconnectNotify*(self: gen_qspatialsound_types.QSpatialSound, signal: QMetaMethod): void =
  fQSpatialSound_virtualbase_connectNotify(self.h, signal.h)

type QSpatialSoundconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QSpatialSound_connectNotify(self: ptr cQSpatialSound, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QSpatialSound_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QSpatialSounddisconnectNotify*(self: gen_qspatialsound_types.QSpatialSound, signal: QMetaMethod): void =
  fQSpatialSound_virtualbase_disconnectNotify(self.h, signal.h)

type QSpatialSounddisconnectNotifyProc* = proc(signal: QMetaMethod): void
