...
func init*(T: type gen_qaudiolistener_types.QAudioListener, h: ptr cQAudioListener): gen_qaudiolistener_types.QAudioListener =
  T(h: h)
proc create*(T: type gen_qaudiolistener_types.QAudioListener, engine: QAudioEngine): gen_qaudiolistener_types.QAudioListener =
  gen_qaudiolistener_types.QAudioListener.init(fcQAudioListener_new(engine.h))

proc setPosition*(self: gen_qaudiolistener_types.QAudioListener, pos: QVector3D): void =
  fcQAudioListener_setPosition(self.h, pos.h)

proc position*(self: gen_qaudiolistener_types.QAudioListener, ): QVector3D =
  QVector3D(h: fcQAudioListener_position(self.h))

proc setRotation*(self: gen_qaudiolistener_types.QAudioListener, q: QQuaternion): void =
  fcQAudioListener_setRotation(self.h, q.h)

proc rotation*(self: gen_qaudiolistener_types.QAudioListener, ): QQuaternion =
  QQuaternion(h: fcQAudioListener_rotation(self.h))

proc engine*(self: gen_qaudiolistener_types.QAudioListener, ): QAudioEngine =
  QAudioEngine(h: fcQAudioListener_engine(self.h))
...
proc miqt_exec_callback_QAudioListener_metacall(self: ptr cQAudioListener, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QAudioListener_metacall ".} =
  ...
  virtualReturn
proc QAudioListenerevent*(self: gen_qaudiolistener_types.QAudioListener, event: QEvent): bool =
  fQAudioListener_virtualbase_event(self.h, event.h)

type QAudioListenereventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QAudioListener_event(self: ptr cQAudioListener, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QAudioListener_event ".} =
  ...
  virtualReturn
proc QAudioListenereventFilter*(self: gen_qaudiolistener_types.QAudioListener, watched: QObject, event: QEvent): bool =
  fQAudioListener_virtualbase_eventFilter(self.h, watched.h, event.h)

type QAudioListenereventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QAudioListener_eventFilter(self: ptr cQAudioListener, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QAudioListener_eventFilter ".} =
  ...
  virtualReturn
proc QAudioListenertimerEvent*(self: gen_qaudiolistener_types.QAudioListener, event: QTimerEvent): void =
  fQAudioListener_virtualbase_timerEvent(self.h, event.h)

type QAudioListenertimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QAudioListener_timerEvent(self: ptr cQAudioListener, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QAudioListener_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QAudioListenerchildEvent*(self: gen_qaudiolistener_types.QAudioListener, event: QChildEvent): void =
  fQAudioListener_virtualbase_childEvent(self.h, event.h)

type QAudioListenerchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QAudioListener_childEvent(self: ptr cQAudioListener, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QAudioListener_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QAudioListenercustomEvent*(self: gen_qaudiolistener_types.QAudioListener, event: QEvent): void =
  fQAudioListener_virtualbase_customEvent(self.h, event.h)

type QAudioListenercustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QAudioListener_customEvent(self: ptr cQAudioListener, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QAudioListener_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QAudioListenerconnectNotify*(self: gen_qaudiolistener_types.QAudioListener, signal: QMetaMethod): void =
  fQAudioListener_virtualbase_connectNotify(self.h, signal.h)

type QAudioListenerconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QAudioListener_connectNotify(self: ptr cQAudioListener, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QAudioListener_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QAudioListenerdisconnectNotify*(self: gen_qaudiolistener_types.QAudioListener, signal: QMetaMethod): void =
  fQAudioListener_virtualbase_disconnectNotify(self.h, signal.h)

type QAudioListenerdisconnectNotifyProc* = proc(signal: QMetaMethod): void
