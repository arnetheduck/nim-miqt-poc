...
func init*(T: type gen_qscriptcontext_types.QScriptContext, h: ptr cQScriptContext): gen_qscriptcontext_types.QScriptContext =
  T(h: h)
proc parentContext*(self: gen_qscriptcontext_types.QScriptContext, ): QScriptContext =
  QScriptContext(h: fcQScriptContext_parentContext(self.h))

proc engine*(self: gen_qscriptcontext_types.QScriptContext, ): QScriptEngine =
  QScriptEngine(h: fcQScriptContext_engine(self.h))

proc state*(self: gen_qscriptcontext_types.QScriptContext, ): cint =
  cint(fcQScriptContext_state(self.h))

proc callee*(self: gen_qscriptcontext_types.QScriptContext, ): QScriptValue =
  QScriptValue(h: fcQScriptContext_callee(self.h))

proc argumentCount*(self: gen_qscriptcontext_types.QScriptContext, ): cint =
  fcQScriptContext_argumentCount(self.h)

proc argument*(self: gen_qscriptcontext_types.QScriptContext, index: cint): QScriptValue =
  QScriptValue(h: fcQScriptContext_argument(self.h, index))

proc argumentsObject*(self: gen_qscriptcontext_types.QScriptContext, ): QScriptValue =
  QScriptValue(h: fcQScriptContext_argumentsObject(self.h))

proc scopeChain*(self: gen_qscriptcontext_types.QScriptContext, ): seq[QScriptValue] =
  var v_ma = fcQScriptContext_scopeChain(self.h)
  var vx_ret = newSeq[QScriptValue](int(v_ma.len))
  let v_outCast = cast[ptr UncheckedArray[pointer]](v_ma.data)
  for i in 0 ..< v_ma.len:
    vx_ret[i] = QScriptValue(h: v_outCast[i])
  vx_ret

proc pushScope*(self: gen_qscriptcontext_types.QScriptContext, objectVal: QScriptValue): void =
  fcQScriptContext_pushScope(self.h, objectVal.h)

proc popScope*(self: gen_qscriptcontext_types.QScriptContext, ): QScriptValue =
  QScriptValue(h: fcQScriptContext_popScope(self.h))

proc returnValue*(self: gen_qscriptcontext_types.QScriptContext, ): QScriptValue =
  QScriptValue(h: fcQScriptContext_returnValue(self.h))

proc setReturnValue*(self: gen_qscriptcontext_types.QScriptContext, resultVal: QScriptValue): void =
  fcQScriptContext_setReturnValue(self.h, resultVal.h)

proc activationObject*(self: gen_qscriptcontext_types.QScriptContext, ): QScriptValue =
  QScriptValue(h: fcQScriptContext_activationObject(self.h))

proc setActivationObject*(self: gen_qscriptcontext_types.QScriptContext, activation: QScriptValue): void =
  fcQScriptContext_setActivationObject(self.h, activation.h)

proc thisObject*(self: gen_qscriptcontext_types.QScriptContext, ): QScriptValue =
  QScriptValue(h: fcQScriptContext_thisObject(self.h))

proc setThisObject*(self: gen_qscriptcontext_types.QScriptContext, thisObject: QScriptValue): void =
...
proc throwValue*(self: gen_qscriptcontext_types.QScriptContext, value: QScriptValue): QScriptValue =
  QScriptValue(h: fcQScriptContext_throwValue(self.h, value.h))

proc throwError*(self: gen_qscriptcontext_types.QScriptContext, error: cint, text: string): QScriptValue =
  QScriptValue(h: fcQScriptContext_throwError(self.h, cint(error), struct_miqt_string(data: text, len: csize_t(len(text)))))

proc throwError*(self: gen_qscriptcontext_types.QScriptContext, text: string): QScriptValue =
  QScriptValue(h: fcQScriptContext_throwErrorWithText(self.h, struct_miqt_string(data: text, len: csize_t(len(text)))))
