...
void QScriptEngine_connect_signalHandlerException(QScriptEngine* self, intptr_t slot, void (*callback)(intptr_t, QScriptValue*), void (*release)(intptr_t)) {
	...
	MiqtVirtualQScriptEngine::connect(self, static_cast<void (QScriptEngine::*)(const QScriptValue&)>(&QScriptEngine::signalHandlerException), self, caller{slot, callback, release});
}
...
QMetaObject* QScriptEngine_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQScriptEngine*)(self) )->QScriptEngine::metaObject();

}

void* QScriptEngine_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQScriptEngine*)(self) )->QScriptEngine::qt_metacast(param1);

}

int QScriptEngine_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQScriptEngine*)(self) )->QScriptEngine::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
