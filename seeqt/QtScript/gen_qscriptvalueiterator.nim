...
func init*(T: type gen_qscriptvalueiterator_types.QScriptValueIterator, h: ptr cQScriptValueIterator): gen_qscriptvalueiterator_types.QScriptValueIterator =
  T(h: h)
proc create*(T: type gen_qscriptvalueiterator_types.QScriptValueIterator, value: QScriptValue): gen_qscriptvalueiterator_types.QScriptValueIterator =
...
proc scriptName*(self: gen_qscriptvalueiterator_types.QScriptValueIterator, ): QScriptString =
  QScriptString(h: fcQScriptValueIterator_scriptName(self.h))

proc value*(self: gen_qscriptvalueiterator_types.QScriptValueIterator, ): QScriptValue =
  QScriptValue(h: fcQScriptValueIterator_value(self.h))

proc setValue*(self: gen_qscriptvalueiterator_types.QScriptValueIterator, value: QScriptValue): void =
...
proc operatorAssign*(self: gen_qscriptvalueiterator_types.QScriptValueIterator, value: QScriptValue): void =
