...
func init*(T: type gen_qscriptengine_types.QScriptSyntaxCheckResult, h: ptr cQScriptSyntaxCheckResult): gen_qscriptengine_types.QScriptSyntaxCheckResult =
  T(h: h)
proc create*(T: type gen_qscriptengine_types.QScriptSyntaxCheckResult, other: QScriptSyntaxCheckResult): gen_qscriptengine_types.QScriptSyntaxCheckResult =
...
proc operatorAssign*(self: gen_qscriptengine_types.QScriptSyntaxCheckResult, other: QScriptSyntaxCheckResult): void =
...
proc create*(T: type gen_qscriptengine_types.QScriptEngine, parent: QObject): gen_qscriptengine_types.QScriptEngine =
  gen_qscriptengine_types.QScriptEngine.init(fcQScriptEngine_new2(parent.h))

proc metaObject*(self: gen_qscriptengine_types.QScriptEngine, ): QMetaObject =
  QMetaObject(h: fcQScriptEngine_metaObject(self.h))
...
proc globalObject*(self: gen_qscriptengine_types.QScriptEngine, ): QScriptValue =
  QScriptValue(h: fcQScriptEngine_globalObject(self.h))

proc setGlobalObject*(self: gen_qscriptengine_types.QScriptEngine, objectVal: QScriptValue): void =
  fcQScriptEngine_setGlobalObject(self.h, objectVal.h)

proc currentContext*(self: gen_qscriptengine_types.QScriptEngine, ): QScriptContext =
  QScriptContext(h: fcQScriptEngine_currentContext(self.h))

proc pushContext*(self: gen_qscriptengine_types.QScriptEngine, ): QScriptContext =
  QScriptContext(h: fcQScriptEngine_pushContext(self.h))
...
proc checkSyntax*(_: type gen_qscriptengine_types.QScriptEngine, program: string): QScriptSyntaxCheckResult =
  QScriptSyntaxCheckResult(h: fcQScriptEngine_checkSyntax(struct_miqt_string(data: program, len: csize_t(len(program)))))

proc evaluate*(self: gen_qscriptengine_types.QScriptEngine, program: string): QScriptValue =
  QScriptValue(h: fcQScriptEngine_evaluate(self.h, struct_miqt_string(data: program, len: csize_t(len(program)))))

proc evaluate*(self: gen_qscriptengine_types.QScriptEngine, program: QScriptProgram): QScriptValue =
  QScriptValue(h: fcQScriptEngine_evaluateWithProgram(self.h, program.h))
...
proc uncaughtException*(self: gen_qscriptengine_types.QScriptEngine, ): QScriptValue =
  QScriptValue(h: fcQScriptEngine_uncaughtException(self.h))
...
proc nullValue*(self: gen_qscriptengine_types.QScriptEngine, ): QScriptValue =
  QScriptValue(h: fcQScriptEngine_nullValue(self.h))

proc undefinedValue*(self: gen_qscriptengine_types.QScriptEngine, ): QScriptValue =
  QScriptValue(h: fcQScriptEngine_undefinedValue(self.h))

proc newVariant*(self: gen_qscriptengine_types.QScriptEngine, value: QVariant): QScriptValue =
  QScriptValue(h: fcQScriptEngine_newVariant(self.h, value.h))

proc newVariant*(self: gen_qscriptengine_types.QScriptEngine, objectVal: QScriptValue, value: QVariant): QScriptValue =
  QScriptValue(h: fcQScriptEngine_newVariant2(self.h, objectVal.h, value.h))

proc newRegExp*(self: gen_qscriptengine_types.QScriptEngine, regexp: QRegExp): QScriptValue =
  QScriptValue(h: fcQScriptEngine_newRegExp(self.h, regexp.h))

proc newObject*(self: gen_qscriptengine_types.QScriptEngine, ): QScriptValue =
  QScriptValue(h: fcQScriptEngine_newObject(self.h))

proc newObject*(self: gen_qscriptengine_types.QScriptEngine, scriptClass: QScriptClass): QScriptValue =
  QScriptValue(h: fcQScriptEngine_newObjectWithScriptClass(self.h, scriptClass.h))

proc newArray*(self: gen_qscriptengine_types.QScriptEngine, ): QScriptValue =
  QScriptValue(h: fcQScriptEngine_newArray(self.h))

proc newRegExp*(self: gen_qscriptengine_types.QScriptEngine, pattern: string, flags: string): QScriptValue =
  QScriptValue(h: fcQScriptEngine_newRegExp2(self.h, struct_miqt_string(data: pattern, len: csize_t(len(pattern))), struct_miqt_string(data: flags, len: csize_t(len(flags)))))

proc newDate*(self: gen_qscriptengine_types.QScriptEngine, value: float64): QScriptValue =
  QScriptValue(h: fcQScriptEngine_newDate(self.h, value))

proc newDate*(self: gen_qscriptengine_types.QScriptEngine, value: QDateTime): QScriptValue =
  QScriptValue(h: fcQScriptEngine_newDateWithValue(self.h, value.h))

proc newActivationObject*(self: gen_qscriptengine_types.QScriptEngine, ): QScriptValue =
  QScriptValue(h: fcQScriptEngine_newActivationObject(self.h))

proc newQObject*(self: gen_qscriptengine_types.QScriptEngine, objectVal: QObject): QScriptValue =
  QScriptValue(h: fcQScriptEngine_newQObject(self.h, objectVal.h))

proc newQObject*(self: gen_qscriptengine_types.QScriptEngine, scriptObject: QScriptValue, qtObject: QObject): QScriptValue =
  QScriptValue(h: fcQScriptEngine_newQObject2(self.h, scriptObject.h, qtObject.h))

proc newQMetaObject*(self: gen_qscriptengine_types.QScriptEngine, metaObject: QMetaObject): QScriptValue =
  QScriptValue(h: fcQScriptEngine_newQMetaObject(self.h, metaObject.h))

proc defaultPrototype*(self: gen_qscriptengine_types.QScriptEngine, metaTypeId: cint): QScriptValue =
  QScriptValue(h: fcQScriptEngine_defaultPrototype(self.h, metaTypeId))

proc setDefaultPrototype*(self: gen_qscriptengine_types.QScriptEngine, metaTypeId: cint, prototype: QScriptValue): void =
...
proc importExtension*(self: gen_qscriptengine_types.QScriptEngine, extension: string): QScriptValue =
  QScriptValue(h: fcQScriptEngine_importExtension(self.h, struct_miqt_string(data: extension, len: csize_t(len(extension)))))
...
proc setAgent*(self: gen_qscriptengine_types.QScriptEngine, agent: QScriptEngineAgent): void =
  fcQScriptEngine_setAgent(self.h, agent.h)

proc agent*(self: gen_qscriptengine_types.QScriptEngine, ): QScriptEngineAgent =
  QScriptEngineAgent(h: fcQScriptEngine_agent(self.h))

proc toStringHandle*(self: gen_qscriptengine_types.QScriptEngine, str: string): QScriptString =
  QScriptString(h: fcQScriptEngine_toStringHandle(self.h, struct_miqt_string(data: str, len: csize_t(len(str)))))

proc toObject*(self: gen_qscriptengine_types.QScriptEngine, value: QScriptValue): QScriptValue =
  QScriptValue(h: fcQScriptEngine_toObject(self.h, value.h))

proc objectById*(self: gen_qscriptengine_types.QScriptEngine, id: clonglong): QScriptValue =
  QScriptValue(h: fcQScriptEngine_objectById(self.h, id))

proc signalHandlerException*(self: gen_qscriptengine_types.QScriptEngine, exception: QScriptValue): void =
  fcQScriptEngine_signalHandlerException(self.h, exception.h)

type QScriptEnginesignalHandlerExceptionSlot* = proc(exception: QScriptValue)
proc miqt_exec_callback_QScriptEngine_signalHandlerException(slot: int, exception: pointer) {.exportc.} =
  ...
  let slotval1 = QScriptValue(h: exception)
...
proc evaluate*(self: gen_qscriptengine_types.QScriptEngine, program: string, fileName: string): QScriptValue =
  QScriptValue(h: fcQScriptEngine_evaluate2(self.h, struct_miqt_string(data: program, len: csize_t(len(program))), struct_miqt_string(data: fileName, len: csize_t(len(fileName)))))

proc evaluate*(self: gen_qscriptengine_types.QScriptEngine, program: string, fileName: string, lineNumber: cint): QScriptValue =
  QScriptValue(h: fcQScriptEngine_evaluate3(self.h, struct_miqt_string(data: program, len: csize_t(len(program))), struct_miqt_string(data: fileName, len: csize_t(len(fileName))), lineNumber))

proc abortEvaluation*(self: gen_qscriptengine_types.QScriptEngine, resultVal: QScriptValue): void =
  fcQScriptEngine_abortEvaluation1(self.h, resultVal.h)

proc newObject*(self: gen_qscriptengine_types.QScriptEngine, scriptClass: QScriptClass, data: QScriptValue): QScriptValue =
  QScriptValue(h: fcQScriptEngine_newObject2(self.h, scriptClass.h, data.h))

proc newArray*(self: gen_qscriptengine_types.QScriptEngine, length: cuint): QScriptValue =
  QScriptValue(h: fcQScriptEngine_newArray1(self.h, length))

proc newQObject*(self: gen_qscriptengine_types.QScriptEngine, objectVal: QObject, ownership: cint): QScriptValue =
  QScriptValue(h: fcQScriptEngine_newQObject22(self.h, objectVal.h, cint(ownership)))

proc newQObject*(self: gen_qscriptengine_types.QScriptEngine, objectVal: QObject, ownership: cint, options: ptr cint): QScriptValue =
  QScriptValue(h: fcQScriptEngine_newQObject3(self.h, objectVal.h, cint(ownership), options))

proc newQObject*(self: gen_qscriptengine_types.QScriptEngine, scriptObject: QScriptValue, qtObject: QObject, ownership: cint): QScriptValue =
  QScriptValue(h: fcQScriptEngine_newQObject32(self.h, scriptObject.h, qtObject.h, cint(ownership)))

proc newQObject*(self: gen_qscriptengine_types.QScriptEngine, scriptObject: QScriptValue, qtObject: QObject, ownership: cint, options: ptr cint): QScriptValue =
  QScriptValue(h: fcQScriptEngine_newQObject4(self.h, scriptObject.h, qtObject.h, cint(ownership), options))

proc newQMetaObject*(self: gen_qscriptengine_types.QScriptEngine, metaObject: QMetaObject, ctor: QScriptValue): QScriptValue =
  QScriptValue(h: fcQScriptEngine_newQMetaObject2(self.h, metaObject.h, ctor.h))

proc installTranslatorFunctions*(self: gen_qscriptengine_types.QScriptEngine, objectVal: QScriptValue): void =
...
proc miqt_exec_callback_QScriptEngine_metacall(self: ptr cQScriptEngine, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QScriptEngine_metacall ".} =
  ...
  virtualReturn
proc QScriptEngineevent*(self: gen_qscriptengine_types.QScriptEngine, event: QEvent): bool =
  fQScriptEngine_virtualbase_event(self.h, event.h)

type QScriptEngineeventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QScriptEngine_event(self: ptr cQScriptEngine, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QScriptEngine_event ".} =
  ...
  virtualReturn
proc QScriptEngineeventFilter*(self: gen_qscriptengine_types.QScriptEngine, watched: QObject, event: QEvent): bool =
  fQScriptEngine_virtualbase_eventFilter(self.h, watched.h, event.h)

type QScriptEngineeventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QScriptEngine_eventFilter(self: ptr cQScriptEngine, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QScriptEngine_eventFilter ".} =
  ...
  virtualReturn
proc QScriptEnginetimerEvent*(self: gen_qscriptengine_types.QScriptEngine, event: QTimerEvent): void =
  fQScriptEngine_virtualbase_timerEvent(self.h, event.h)

type QScriptEnginetimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QScriptEngine_timerEvent(self: ptr cQScriptEngine, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QScriptEngine_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QScriptEnginechildEvent*(self: gen_qscriptengine_types.QScriptEngine, event: QChildEvent): void =
  fQScriptEngine_virtualbase_childEvent(self.h, event.h)

type QScriptEnginechildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QScriptEngine_childEvent(self: ptr cQScriptEngine, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QScriptEngine_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QScriptEnginecustomEvent*(self: gen_qscriptengine_types.QScriptEngine, event: QEvent): void =
  fQScriptEngine_virtualbase_customEvent(self.h, event.h)

type QScriptEnginecustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QScriptEngine_customEvent(self: ptr cQScriptEngine, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QScriptEngine_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QScriptEngineconnectNotify*(self: gen_qscriptengine_types.QScriptEngine, signal: QMetaMethod): void =
  fQScriptEngine_virtualbase_connectNotify(self.h, signal.h)

type QScriptEngineconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QScriptEngine_connectNotify(self: ptr cQScriptEngine, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QScriptEngine_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QScriptEnginedisconnectNotify*(self: gen_qscriptengine_types.QScriptEngine, signal: QMetaMethod): void =
  fQScriptEngine_virtualbase_disconnectNotify(self.h, signal.h)

type QScriptEnginedisconnectNotifyProc* = proc(signal: QMetaMethod): void
