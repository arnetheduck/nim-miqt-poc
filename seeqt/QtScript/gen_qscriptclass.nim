...
func init*(T: type gen_qscriptclass_types.QScriptClass, h: ptr cQScriptClass): gen_qscriptclass_types.QScriptClass =
  T(h: h)
proc create*(T: type gen_qscriptclass_types.QScriptClass, engine: QScriptEngine): gen_qscriptclass_types.QScriptClass =
  gen_qscriptclass_types.QScriptClass.init(fcQScriptClass_new(engine.h))

proc engine*(self: gen_qscriptclass_types.QScriptClass, ): QScriptEngine =
  QScriptEngine(h: fcQScriptClass_engine(self.h))

proc queryProperty*(self: gen_qscriptclass_types.QScriptClass, objectVal: QScriptValue, name: QScriptString, flags: cint, id: ptr cuint): cint =
  cint(fcQScriptClass_queryProperty(self.h, objectVal.h, name.h, cint(flags), id))

proc property*(self: gen_qscriptclass_types.QScriptClass, objectVal: QScriptValue, name: QScriptString, id: cuint): QScriptValue =
  QScriptValue(h: fcQScriptClass_property(self.h, objectVal.h, name.h, id))

proc setProperty*(self: gen_qscriptclass_types.QScriptClass, objectVal: QScriptValue, name: QScriptString, id: cuint, value: QScriptValue): void =
  fcQScriptClass_setProperty(self.h, objectVal.h, name.h, id, value.h)

proc propertyFlags*(self: gen_qscriptclass_types.QScriptClass, objectVal: QScriptValue, name: QScriptString, id: cuint): cint =
  cint(fcQScriptClass_propertyFlags(self.h, objectVal.h, name.h, id))

proc newIterator*(self: gen_qscriptclass_types.QScriptClass, objectVal: QScriptValue): QScriptClassPropertyIterator =
  QScriptClassPropertyIterator(h: fcQScriptClass_newIterator(self.h, objectVal.h))

proc prototype*(self: gen_qscriptclass_types.QScriptClass, ): QScriptValue =
  QScriptValue(h: fcQScriptClass_prototype(self.h))
...
proc extension*(self: gen_qscriptclass_types.QScriptClass, extension: cint, argument: QVariant): QVariant =
  QVariant(h: fcQScriptClass_extension(self.h, cint(extension), argument.h))

proc QScriptClassqueryProperty*(self: gen_qscriptclass_types.QScriptClass, objectVal: QScriptValue, name: QScriptString, flags: cint, id: ptr cuint): cint =
  cint(fQScriptClass_virtualbase_queryProperty(self.h, objectVal.h, name.h, cint(flags), id))

type QScriptClassqueryPropertyProc* = proc(objectVal: QScriptValue, name: QScriptString, flags: cint, id: ptr cuint): cint
...
proc miqt_exec_callback_QScriptClass_queryProperty(self: ptr cQScriptClass, slot: int, objectVal: pointer, name: pointer, flags: cint, id: ptr cuint): cint {.exportc: "miqt_exec_callback_QScriptClass_queryProperty ".} =
  ...
  let slotval1 = QScriptValue(h: objectVal)

  let slotval2 = QScriptString(h: name)
  ...
  cint(virtualReturn)
proc QScriptClassproperty*(self: gen_qscriptclass_types.QScriptClass, objectVal: QScriptValue, name: QScriptString, id: cuint): QScriptValue =
  QScriptValue(h: fQScriptClass_virtualbase_property(self.h, objectVal.h, name.h, id))

type QScriptClasspropertyProc* = proc(objectVal: QScriptValue, name: QScriptString, id: cuint): QScriptValue
...
proc miqt_exec_callback_QScriptClass_property(self: ptr cQScriptClass, slot: int, objectVal: pointer, name: pointer, id: cuint): pointer {.exportc: "miqt_exec_callback_QScriptClass_property ".} =
  ...
  virtualReturn.h
proc QScriptClasssetProperty*(self: gen_qscriptclass_types.QScriptClass, objectVal: QScriptValue, name: QScriptString, id: cuint, value: QScriptValue): void =
  fQScriptClass_virtualbase_setProperty(self.h, objectVal.h, name.h, id, value.h)

type QScriptClasssetPropertyProc* = proc(objectVal: QScriptValue, name: QScriptString, id: cuint, value: QScriptValue): void
...
proc miqt_exec_callback_QScriptClass_setProperty(self: ptr cQScriptClass, slot: int, objectVal: pointer, name: pointer, id: cuint, value: pointer): void {.exportc: "miqt_exec_callback_QScriptClass_setProperty ".} =
  ...
  let slotval4 = QScriptValue(h: value)


  nimfunc[](slotval1, slotval2, slotval3, slotval4)
proc QScriptClasspropertyFlags*(self: gen_qscriptclass_types.QScriptClass, objectVal: QScriptValue, name: QScriptString, id: cuint): cint =
  cint(fQScriptClass_virtualbase_propertyFlags(self.h, objectVal.h, name.h, id))

type QScriptClasspropertyFlagsProc* = proc(objectVal: QScriptValue, name: QScriptString, id: cuint): cint
...
proc miqt_exec_callback_QScriptClass_propertyFlags(self: ptr cQScriptClass, slot: int, objectVal: pointer, name: pointer, id: cuint): cint {.exportc: "miqt_exec_callback_QScriptClass_propertyFlags ".} =
  ...
  cint(virtualReturn)
proc QScriptClassnewIterator*(self: gen_qscriptclass_types.QScriptClass, objectVal: QScriptValue): QScriptClassPropertyIterator =
  QScriptClassPropertyIterator(h: fQScriptClass_virtualbase_newIterator(self.h, objectVal.h))

type QScriptClassnewIteratorProc* = proc(objectVal: QScriptValue): QScriptClassPropertyIterator
...
proc miqt_exec_callback_QScriptClass_newIterator(self: ptr cQScriptClass, slot: int, objectVal: pointer): pointer {.exportc: "miqt_exec_callback_QScriptClass_newIterator ".} =
  ...
  virtualReturn.h
proc QScriptClassprototype*(self: gen_qscriptclass_types.QScriptClass, ): QScriptValue =
  QScriptValue(h: fQScriptClass_virtualbase_prototype(self.h))

type QScriptClassprototypeProc* = proc(): QScriptValue
...
proc miqt_exec_callback_QScriptClass_supportsExtension(self: ptr cQScriptClass, slot: int, extension: cint): bool {.exportc: "miqt_exec_callback_QScriptClass_supportsExtension ".} =
  ...
  virtualReturn
proc QScriptClassextension*(self: gen_qscriptclass_types.QScriptClass, extension: cint, argument: QVariant): QVariant =
  QVariant(h: fQScriptClass_virtualbase_extension(self.h, cint(extension), argument.h))

type QScriptClassextensionProc* = proc(extension: cint, argument: QVariant): QVariant
...
proc miqt_exec_callback_QScriptClass_extension(self: ptr cQScriptClass, slot: int, extension: cint, argument: pointer): pointer {.exportc: "miqt_exec_callback_QScriptClass_extension ".} =
  ...
  let slotval2 = QVariant(h: argument)
