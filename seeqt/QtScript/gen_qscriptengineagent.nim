...
func init*(T: type gen_qscriptengineagent_types.QScriptEngineAgent, h: ptr cQScriptEngineAgent): gen_qscriptengineagent_types.QScriptEngineAgent =
  T(h: h)
proc create*(T: type gen_qscriptengineagent_types.QScriptEngineAgent, engine: QScriptEngine): gen_qscriptengineagent_types.QScriptEngineAgent =
...
proc functionExit*(self: gen_qscriptengineagent_types.QScriptEngineAgent, scriptId: clonglong, returnValue: QScriptValue): void =
...
proc exceptionThrow*(self: gen_qscriptengineagent_types.QScriptEngineAgent, scriptId: clonglong, exception: QScriptValue, hasHandler: bool): void =
  fcQScriptEngineAgent_exceptionThrow(self.h, scriptId, exception.h, hasHandler)

proc exceptionCatch*(self: gen_qscriptengineagent_types.QScriptEngineAgent, scriptId: clonglong, exception: QScriptValue): void =
...
proc extension*(self: gen_qscriptengineagent_types.QScriptEngineAgent, extension: cint, argument: QVariant): QVariant =
  QVariant(h: fcQScriptEngineAgent_extension(self.h, cint(extension), argument.h))

proc engine*(self: gen_qscriptengineagent_types.QScriptEngineAgent, ): QScriptEngine =
  QScriptEngine(h: fcQScriptEngineAgent_engine(self.h))
...
proc miqt_exec_callback_QScriptEngineAgent_functionEntry(self: ptr cQScriptEngineAgent, slot: int, scriptId: clonglong): void {.exportc: "miqt_exec_callback_QScriptEngineAgent_functionEntry ".} =
  ...
  nimfunc[](slotval1)
proc QScriptEngineAgentfunctionExit*(self: gen_qscriptengineagent_types.QScriptEngineAgent, scriptId: clonglong, returnValue: QScriptValue): void =
  fQScriptEngineAgent_virtualbase_functionExit(self.h, scriptId, returnValue.h)

type QScriptEngineAgentfunctionExitProc* = proc(scriptId: clonglong, returnValue: QScriptValue): void
...
proc miqt_exec_callback_QScriptEngineAgent_functionExit(self: ptr cQScriptEngineAgent, slot: int, scriptId: clonglong, returnValue: pointer): void {.exportc: "miqt_exec_callback_QScriptEngineAgent_functionExit ".} =
  ...
  let slotval2 = QScriptValue(h: returnValue)
...
proc QScriptEngineAgentexceptionThrow*(self: gen_qscriptengineagent_types.QScriptEngineAgent, scriptId: clonglong, exception: QScriptValue, hasHandler: bool): void =
  fQScriptEngineAgent_virtualbase_exceptionThrow(self.h, scriptId, exception.h, hasHandler)

type QScriptEngineAgentexceptionThrowProc* = proc(scriptId: clonglong, exception: QScriptValue, hasHandler: bool): void
...
proc miqt_exec_callback_QScriptEngineAgent_exceptionThrow(self: ptr cQScriptEngineAgent, slot: int, scriptId: clonglong, exception: pointer, hasHandler: bool): void {.exportc: "miqt_exec_callback_QScriptEngineAgent_exceptionThrow ".} =
  ...
  let slotval2 = QScriptValue(h: exception)

  let slotval3 = hasHandler


  nimfunc[](slotval1, slotval2, slotval3)
proc QScriptEngineAgentexceptionCatch*(self: gen_qscriptengineagent_types.QScriptEngineAgent, scriptId: clonglong, exception: QScriptValue): void =
  fQScriptEngineAgent_virtualbase_exceptionCatch(self.h, scriptId, exception.h)

type QScriptEngineAgentexceptionCatchProc* = proc(scriptId: clonglong, exception: QScriptValue): void
...
proc miqt_exec_callback_QScriptEngineAgent_supportsExtension(self: ptr cQScriptEngineAgent, slot: int, extension: cint): bool {.exportc: "miqt_exec_callback_QScriptEngineAgent_supportsExtension ".} =
  ...
  virtualReturn
proc QScriptEngineAgentextension*(self: gen_qscriptengineagent_types.QScriptEngineAgent, extension: cint, argument: QVariant): QVariant =
  QVariant(h: fQScriptEngineAgent_virtualbase_extension(self.h, cint(extension), argument.h))

type QScriptEngineAgentextensionProc* = proc(extension: cint, argument: QVariant): QVariant
