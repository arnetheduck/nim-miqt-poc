...
public:
	...
	MiqtVirtualQScriptExtensionInterface(struct QScriptExtensionInterface_VTable* vtbl, const QScriptExtensionInterface& param1): QScriptExtensionInterface(param1), vtbl(vtbl) {};

	virtual ~MiqtVirtualQScriptExtensionInterface() override { if(vtbl->destructor) vtbl->destructor(vtbl, this); }
...
QScriptExtensionInterface* QScriptExtensionInterface_new(struct QScriptExtensionInterface_VTable* vtbl, QScriptExtensionInterface* param1) {
	return new MiqtVirtualQScriptExtensionInterface(vtbl, *param1);
}
