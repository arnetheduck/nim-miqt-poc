...
proc create*(T: type gen_qscriptextensionplugin_types.QScriptExtensionPlugin, parent: QObject): gen_qscriptextensionplugin_types.QScriptExtensionPlugin =
  gen_qscriptextensionplugin_types.QScriptExtensionPlugin.init(fcQScriptExtensionPlugin_new2(parent.h))

proc metaObject*(self: gen_qscriptextensionplugin_types.QScriptExtensionPlugin, ): QMetaObject =
  QMetaObject(h: fcQScriptExtensionPlugin_metaObject(self.h))
...
proc initialize*(self: gen_qscriptextensionplugin_types.QScriptExtensionPlugin, key: string, engine: QScriptEngine): void =
  fcQScriptExtensionPlugin_initialize(self.h, struct_miqt_string(data: key, len: csize_t(len(key))), engine.h)

proc setupPackage*(self: gen_qscriptextensionplugin_types.QScriptExtensionPlugin, key: string, engine: QScriptEngine): QScriptValue =
  QScriptValue(h: fcQScriptExtensionPlugin_setupPackage(self.h, struct_miqt_string(data: key, len: csize_t(len(key))), engine.h))
...
type QScriptExtensionPlugininitializeProc* = proc(key: string, engine: QScriptEngine): void
...
proc miqt_exec_callback_QScriptExtensionPlugin_initialize(self: ptr cQScriptExtensionPlugin, slot: int, key: struct_miqt_string, engine: pointer): void {.exportc: "miqt_exec_callback_QScriptExtensionPlugin_initialize ".} =
  ...
  let slotval2 = QScriptEngine(h: engine)


  nimfunc[](slotval1, slotval2)
proc QScriptExtensionPluginevent*(self: gen_qscriptextensionplugin_types.QScriptExtensionPlugin, event: QEvent): bool =
  fQScriptExtensionPlugin_virtualbase_event(self.h, event.h)

type QScriptExtensionPlugineventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QScriptExtensionPlugin_event(self: ptr cQScriptExtensionPlugin, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QScriptExtensionPlugin_event ".} =
  ...
  virtualReturn
proc QScriptExtensionPlugineventFilter*(self: gen_qscriptextensionplugin_types.QScriptExtensionPlugin, watched: QObject, event: QEvent): bool =
  fQScriptExtensionPlugin_virtualbase_eventFilter(self.h, watched.h, event.h)

type QScriptExtensionPlugineventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QScriptExtensionPlugin_eventFilter(self: ptr cQScriptExtensionPlugin, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QScriptExtensionPlugin_eventFilter ".} =
  ...
  virtualReturn
proc QScriptExtensionPlugintimerEvent*(self: gen_qscriptextensionplugin_types.QScriptExtensionPlugin, event: QTimerEvent): void =
  fQScriptExtensionPlugin_virtualbase_timerEvent(self.h, event.h)

type QScriptExtensionPlugintimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QScriptExtensionPlugin_timerEvent(self: ptr cQScriptExtensionPlugin, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QScriptExtensionPlugin_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QScriptExtensionPluginchildEvent*(self: gen_qscriptextensionplugin_types.QScriptExtensionPlugin, event: QChildEvent): void =
  fQScriptExtensionPlugin_virtualbase_childEvent(self.h, event.h)

type QScriptExtensionPluginchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QScriptExtensionPlugin_childEvent(self: ptr cQScriptExtensionPlugin, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QScriptExtensionPlugin_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QScriptExtensionPlugincustomEvent*(self: gen_qscriptextensionplugin_types.QScriptExtensionPlugin, event: QEvent): void =
  fQScriptExtensionPlugin_virtualbase_customEvent(self.h, event.h)

type QScriptExtensionPlugincustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QScriptExtensionPlugin_customEvent(self: ptr cQScriptExtensionPlugin, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QScriptExtensionPlugin_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QScriptExtensionPluginconnectNotify*(self: gen_qscriptextensionplugin_types.QScriptExtensionPlugin, signal: QMetaMethod): void =
  fQScriptExtensionPlugin_virtualbase_connectNotify(self.h, signal.h)

type QScriptExtensionPluginconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QScriptExtensionPlugin_connectNotify(self: ptr cQScriptExtensionPlugin, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QScriptExtensionPlugin_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QScriptExtensionPlugindisconnectNotify*(self: gen_qscriptextensionplugin_types.QScriptExtensionPlugin, signal: QMetaMethod): void =
  fQScriptExtensionPlugin_virtualbase_disconnectNotify(self.h, signal.h)

type QScriptExtensionPlugindisconnectNotifyProc* = proc(signal: QMetaMethod): void
