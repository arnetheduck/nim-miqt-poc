...
QMetaObject* QScriptExtensionPlugin_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQScriptExtensionPlugin*)(self) )->QScriptExtensionPlugin::metaObject();

}

void* QScriptExtensionPlugin_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQScriptExtensionPlugin*)(self) )->QScriptExtensionPlugin::qt_metacast(param1);

}

int QScriptExtensionPlugin_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQScriptExtensionPlugin*)(self) )->QScriptExtensionPlugin::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
QObject* QScriptExtensionPlugin_protectedbase_sender(const void* self) {
	MiqtVirtualQScriptExtensionPlugin* self_cast = static_cast<MiqtVirtualQScriptExtensionPlugin*>( (QScriptExtensionPlugin*)(self) );
