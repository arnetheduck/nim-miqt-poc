...
proc create*(T: type gen_qscriptprogram_types.QScriptProgram, other: QScriptProgram): gen_qscriptprogram_types.QScriptProgram =
...
proc operatorAssign*(self: gen_qscriptprogram_types.QScriptProgram, other: QScriptProgram): void =
...
proc operatorEqual*(self: gen_qscriptprogram_types.QScriptProgram, other: QScriptProgram): bool =
  fcQScriptProgram_operatorEqual(self.h, other.h)

proc operatorNotEqual*(self: gen_qscriptprogram_types.QScriptProgram, other: QScriptProgram): bool =
