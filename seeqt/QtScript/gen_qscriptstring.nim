...
proc create*(T: type gen_qscriptstring_types.QScriptString, other: QScriptString): gen_qscriptstring_types.QScriptString =
  gen_qscriptstring_types.QScriptString.init(fcQScriptString_new2(other.h))

proc operatorAssign*(self: gen_qscriptstring_types.QScriptString, other: QScriptString): void =
...
proc operatorEqual*(self: gen_qscriptstring_types.QScriptString, other: QScriptString): bool =
  fcQScriptString_operatorEqual(self.h, other.h)

proc operatorNotEqual*(self: gen_qscriptstring_types.QScriptString, other: QScriptString): bool =
