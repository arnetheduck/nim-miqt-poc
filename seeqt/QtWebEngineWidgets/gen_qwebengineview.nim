...
proc fQWebEngineView_connect_pdfPrintingFinished(self: pointer, slot: int) {.importc: "QWebEngineView_connect_pdfPrintingFinished".}
proc fcQWebEngineView_printRequested(self: pointer, ): void {.importc: "QWebEngineView_printRequested".}
proc fQWebEngineView_connect_printRequested(self: pointer, slot: int) {.importc: "QWebEngineView_connect_printRequested".}
proc fcQWebEngineView_printFinished(self: pointer, success: bool): void {.importc: "QWebEngineView_printFinished".}
proc fQWebEngineView_connect_printFinished(self: pointer, slot: int) {.importc: "QWebEngineView_connect_printFinished".}
...
func init*(T: type gen_qwebengineview_types.QWebEngineView, h: ptr cQWebEngineView): gen_qwebengineview_types.QWebEngineView =
  T(h: h)
proc create*(T: type gen_qwebengineview_types.QWebEngineView, parent: QWidget): gen_qwebengineview_types.QWebEngineView =
...
proc create*(T: type gen_qwebengineview_types.QWebEngineView, profile: QWebEngineProfile): gen_qwebengineview_types.QWebEngineView =
  gen_qwebengineview_types.QWebEngineView.init(fcQWebEngineView_new3(profile.h))

proc create*(T: type gen_qwebengineview_types.QWebEngineView, page: QWebEnginePage): gen_qwebengineview_types.QWebEngineView =
  gen_qwebengineview_types.QWebEngineView.init(fcQWebEngineView_new4(page.h))

proc create*(T: type gen_qwebengineview_types.QWebEngineView, profile: QWebEngineProfile, parent: QWidget): gen_qwebengineview_types.QWebEngineView =
  gen_qwebengineview_types.QWebEngineView.init(fcQWebEngineView_new5(profile.h, parent.h))

proc create*(T: type gen_qwebengineview_types.QWebEngineView, page: QWebEnginePage, parent: QWidget): gen_qwebengineview_types.QWebEngineView =
  gen_qwebengineview_types.QWebEngineView.init(fcQWebEngineView_new6(page.h, parent.h))

proc metaObject*(self: gen_qwebengineview_types.QWebEngineView, ): QMetaObject =
  QMetaObject(h: fcQWebEngineView_metaObject(self.h))
...
proc forPage*(_: type gen_qwebengineview_types.QWebEngineView, page: QWebEnginePage): QWebEngineView =
  QWebEngineView(h: fcQWebEngineView_forPage(page.h))

proc page*(self: gen_qwebengineview_types.QWebEngineView, ): QWebEnginePage =
  QWebEnginePage(h: fcQWebEngineView_page(self.h))

proc setPage*(self: gen_qwebengineview_types.QWebEngineView, page: QWebEnginePage): void =
  fcQWebEngineView_setPage(self.h, page.h)

proc load*(self: gen_qwebengineview_types.QWebEngineView, url: QUrl): void =
  fcQWebEngineView_load(self.h, url.h)

proc load*(self: gen_qwebengineview_types.QWebEngineView, request: QWebEngineHttpRequest): void =
...
proc history*(self: gen_qwebengineview_types.QWebEngineView, ): QWebEngineHistory =
  QWebEngineHistory(h: fcQWebEngineView_history(self.h))
...
proc setUrl*(self: gen_qwebengineview_types.QWebEngineView, url: QUrl): void =
  fcQWebEngineView_setUrl(self.h, url.h)

proc url*(self: gen_qwebengineview_types.QWebEngineView, ): QUrl =
  QUrl(h: fcQWebEngineView_url(self.h))

proc iconUrl*(self: gen_qwebengineview_types.QWebEngineView, ): QUrl =
  QUrl(h: fcQWebEngineView_iconUrl(self.h))

proc icon*(self: gen_qwebengineview_types.QWebEngineView, ): QIcon =
  QIcon(h: fcQWebEngineView_icon(self.h))
...
proc sizeHint*(self: gen_qwebengineview_types.QWebEngineView, ): QSize =
  QSize(h: fcQWebEngineView_sizeHint(self.h))

proc settings*(self: gen_qwebengineview_types.QWebEngineView, ): QWebEngineSettings =
  QWebEngineSettings(h: fcQWebEngineView_settings(self.h))

proc createStandardContextMenu*(self: gen_qwebengineview_types.QWebEngineView, ): QMenu =
  QMenu(h: fcQWebEngineView_createStandardContextMenu(self.h))

proc lastContextMenuRequest*(self: gen_qwebengineview_types.QWebEngineView, ): QWebEngineContextMenuRequest =
  QWebEngineContextMenuRequest(h: fcQWebEngineView_lastContextMenuRequest(self.h))
...
proc print*(self: gen_qwebengineview_types.QWebEngineView, printer: QPrinter): void =
...
proc urlChanged*(self: gen_qwebengineview_types.QWebEngineView, param1: QUrl): void =
  fcQWebEngineView_urlChanged(self.h, param1.h)

type QWebEngineViewurlChangedSlot* = proc(param1: QUrl)
...
proc iconUrlChanged*(self: gen_qwebengineview_types.QWebEngineView, param1: QUrl): void =
  fcQWebEngineView_iconUrlChanged(self.h, param1.h)

type QWebEngineViewiconUrlChangedSlot* = proc(param1: QUrl)
...
proc iconChanged*(self: gen_qwebengineview_types.QWebEngineView, param1: QIcon): void =
  fcQWebEngineView_iconChanged(self.h, param1.h)

type QWebEngineViewiconChangedSlot* = proc(param1: QIcon)
...
proc setHtml*(self: gen_qwebengineview_types.QWebEngineView, html: string, baseUrl: QUrl): void =
...
proc setContent*(self: gen_qwebengineview_types.QWebEngineView, data: seq[byte], mimeType: string, baseUrl: QUrl): void =
...
proc printToPdf*(self: gen_qwebengineview_types.QWebEngineView, filePath: string, layout: QPageLayout): void =
  fcQWebEngineView_printToPdf2(self.h, struct_miqt_string(data: filePath, len: csize_t(len(filePath))), layout.h)

proc printToPdf*(self: gen_qwebengineview_types.QWebEngineView, filePath: string, layout: QPageLayout, ranges: QPageRanges): void =
...
proc miqt_exec_callback_QWebEngineView_metacall(self: ptr cQWebEngineView, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QWebEngineView_metacall ".} =
  ...
  virtualReturn
proc QWebEngineViewsizeHint*(self: gen_qwebengineview_types.QWebEngineView, ): QSize =
  QSize(h: fQWebEngineView_virtualbase_sizeHint(self.h))

type QWebEngineViewsizeHintProc* = proc(): QSize
...
proc miqt_exec_callback_QWebEngineView_sizeHint(self: ptr cQWebEngineView, slot: int): pointer {.exportc: "miqt_exec_callback_QWebEngineView_sizeHint ".} =
  ...
  virtualReturn.h
proc QWebEngineViewcreateWindow*(self: gen_qwebengineview_types.QWebEngineView, typeVal: cint): QWebEngineView =
  QWebEngineView(h: fQWebEngineView_virtualbase_createWindow(self.h, cint(typeVal)))

type QWebEngineViewcreateWindowProc* = proc(typeVal: cint): QWebEngineView
...
proc miqt_exec_callback_QWebEngineView_createWindow(self: ptr cQWebEngineView, slot: int, typeVal: cint): pointer {.exportc: "miqt_exec_callback_QWebEngineView_createWindow ".} =
  ...
  virtualReturn.h
proc QWebEngineViewcontextMenuEvent*(self: gen_qwebengineview_types.QWebEngineView, param1: QContextMenuEvent): void =
  fQWebEngineView_virtualbase_contextMenuEvent(self.h, param1.h)

type QWebEngineViewcontextMenuEventProc* = proc(param1: QContextMenuEvent): void
...
proc miqt_exec_callback_QWebEngineView_contextMenuEvent(self: ptr cQWebEngineView, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QWebEngineView_contextMenuEvent ".} =
  ...
  nimfunc[](slotval1)
proc QWebEngineViewevent*(self: gen_qwebengineview_types.QWebEngineView, param1: QEvent): bool =
  fQWebEngineView_virtualbase_event(self.h, param1.h)

type QWebEngineVieweventProc* = proc(param1: QEvent): bool
...
proc miqt_exec_callback_QWebEngineView_event(self: ptr cQWebEngineView, slot: int, param1: pointer): bool {.exportc: "miqt_exec_callback_QWebEngineView_event ".} =
  ...
  virtualReturn
proc QWebEngineViewshowEvent*(self: gen_qwebengineview_types.QWebEngineView, param1: QShowEvent): void =
  fQWebEngineView_virtualbase_showEvent(self.h, param1.h)

type QWebEngineViewshowEventProc* = proc(param1: QShowEvent): void
...
proc miqt_exec_callback_QWebEngineView_showEvent(self: ptr cQWebEngineView, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QWebEngineView_showEvent ".} =
  ...
  nimfunc[](slotval1)
proc QWebEngineViewhideEvent*(self: gen_qwebengineview_types.QWebEngineView, param1: QHideEvent): void =
  fQWebEngineView_virtualbase_hideEvent(self.h, param1.h)

type QWebEngineViewhideEventProc* = proc(param1: QHideEvent): void
...
proc miqt_exec_callback_QWebEngineView_hideEvent(self: ptr cQWebEngineView, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QWebEngineView_hideEvent ".} =
  ...
  let slotval1 = QHideEvent(h: param1)


  nimfunc[](slotval1)
proc QWebEngineViewcloseEvent*(self: gen_qwebengineview_types.QWebEngineView, param1: QCloseEvent): void =
  fQWebEngineView_virtualbase_closeEvent(self.h, param1.h)

type QWebEngineViewcloseEventProc* = proc(param1: QCloseEvent): void
...
proc miqt_exec_callback_QWebEngineView_closeEvent(self: ptr cQWebEngineView, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QWebEngineView_closeEvent ".} =
  ...
  nimfunc[](slotval1)
proc QWebEngineViewdragEnterEvent*(self: gen_qwebengineview_types.QWebEngineView, e: QDragEnterEvent): void =
  fQWebEngineView_virtualbase_dragEnterEvent(self.h, e.h)

type QWebEngineViewdragEnterEventProc* = proc(e: QDragEnterEvent): void
...
proc miqt_exec_callback_QWebEngineView_dragEnterEvent(self: ptr cQWebEngineView, slot: int, e: pointer): void {.exportc: "miqt_exec_callback_QWebEngineView_dragEnterEvent ".} =
  ...
  nimfunc[](slotval1)
proc QWebEngineViewdragLeaveEvent*(self: gen_qwebengineview_types.QWebEngineView, e: QDragLeaveEvent): void =
  fQWebEngineView_virtualbase_dragLeaveEvent(self.h, e.h)

type QWebEngineViewdragLeaveEventProc* = proc(e: QDragLeaveEvent): void
...
proc miqt_exec_callback_QWebEngineView_dragLeaveEvent(self: ptr cQWebEngineView, slot: int, e: pointer): void {.exportc: "miqt_exec_callback_QWebEngineView_dragLeaveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QWebEngineViewdragMoveEvent*(self: gen_qwebengineview_types.QWebEngineView, e: QDragMoveEvent): void =
  fQWebEngineView_virtualbase_dragMoveEvent(self.h, e.h)

type QWebEngineViewdragMoveEventProc* = proc(e: QDragMoveEvent): void
...
proc miqt_exec_callback_QWebEngineView_dragMoveEvent(self: ptr cQWebEngineView, slot: int, e: pointer): void {.exportc: "miqt_exec_callback_QWebEngineView_dragMoveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QWebEngineViewdropEvent*(self: gen_qwebengineview_types.QWebEngineView, e: QDropEvent): void =
  fQWebEngineView_virtualbase_dropEvent(self.h, e.h)

type QWebEngineViewdropEventProc* = proc(e: QDropEvent): void
...
proc miqt_exec_callback_QWebEngineView_setVisible(self: ptr cQWebEngineView, slot: int, visible: bool): void {.exportc: "miqt_exec_callback_QWebEngineView_setVisible ".} =
  ...
  nimfunc[](slotval1)
proc QWebEngineViewminimumSizeHint*(self: gen_qwebengineview_types.QWebEngineView, ): QSize =
  QSize(h: fQWebEngineView_virtualbase_minimumSizeHint(self.h))

type QWebEngineViewminimumSizeHintProc* = proc(): QSize
...
proc miqt_exec_callback_QWebEngineView_hasHeightForWidth(self: ptr cQWebEngineView, slot: int): bool {.exportc: "miqt_exec_callback_QWebEngineView_hasHeightForWidth ".} =
  ...
  virtualReturn
proc QWebEngineViewpaintEngine*(self: gen_qwebengineview_types.QWebEngineView, ): QPaintEngine =
  QPaintEngine(h: fQWebEngineView_virtualbase_paintEngine(self.h))

type QWebEngineViewpaintEngineProc* = proc(): QPaintEngine
...
proc miqt_exec_callback_QWebEngineView_paintEngine(self: ptr cQWebEngineView, slot: int): pointer {.exportc: "miqt_exec_callback_QWebEngineView_paintEngine ".} =
  ...
  virtualReturn.h
proc QWebEngineViewmousePressEvent*(self: gen_qwebengineview_types.QWebEngineView, event: QMouseEvent): void =
  fQWebEngineView_virtualbase_mousePressEvent(self.h, event.h)

type QWebEngineViewmousePressEventProc* = proc(event: QMouseEvent): void
...
proc miqt_exec_callback_QWebEngineView_mousePressEvent(self: ptr cQWebEngineView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QWebEngineView_mousePressEvent ".} =
  ...
  nimfunc[](slotval1)
proc QWebEngineViewmouseReleaseEvent*(self: gen_qwebengineview_types.QWebEngineView, event: QMouseEvent): void =
  fQWebEngineView_virtualbase_mouseReleaseEvent(self.h, event.h)

type QWebEngineViewmouseReleaseEventProc* = proc(event: QMouseEvent): void
...
proc miqt_exec_callback_QWebEngineView_mouseReleaseEvent(self: ptr cQWebEngineView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QWebEngineView_mouseReleaseEvent ".} =
  ...
  nimfunc[](slotval1)
proc QWebEngineViewmouseDoubleClickEvent*(self: gen_qwebengineview_types.QWebEngineView, event: QMouseEvent): void =
  fQWebEngineView_virtualbase_mouseDoubleClickEvent(self.h, event.h)

type QWebEngineViewmouseDoubleClickEventProc* = proc(event: QMouseEvent): void
...
proc miqt_exec_callback_QWebEngineView_mouseDoubleClickEvent(self: ptr cQWebEngineView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QWebEngineView_mouseDoubleClickEvent ".} =
  ...
  nimfunc[](slotval1)
proc QWebEngineViewmouseMoveEvent*(self: gen_qwebengineview_types.QWebEngineView, event: QMouseEvent): void =
  fQWebEngineView_virtualbase_mouseMoveEvent(self.h, event.h)

type QWebEngineViewmouseMoveEventProc* = proc(event: QMouseEvent): void
...
proc miqt_exec_callback_QWebEngineView_mouseMoveEvent(self: ptr cQWebEngineView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QWebEngineView_mouseMoveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QWebEngineViewwheelEvent*(self: gen_qwebengineview_types.QWebEngineView, event: QWheelEvent): void =
  fQWebEngineView_virtualbase_wheelEvent(self.h, event.h)

type QWebEngineViewwheelEventProc* = proc(event: QWheelEvent): void
...
proc miqt_exec_callback_QWebEngineView_wheelEvent(self: ptr cQWebEngineView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QWebEngineView_wheelEvent ".} =
  ...
  nimfunc[](slotval1)
proc QWebEngineViewkeyPressEvent*(self: gen_qwebengineview_types.QWebEngineView, event: QKeyEvent): void =
  fQWebEngineView_virtualbase_keyPressEvent(self.h, event.h)

type QWebEngineViewkeyPressEventProc* = proc(event: QKeyEvent): void
...
proc miqt_exec_callback_QWebEngineView_keyPressEvent(self: ptr cQWebEngineView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QWebEngineView_keyPressEvent ".} =
  ...
  nimfunc[](slotval1)
proc QWebEngineViewkeyReleaseEvent*(self: gen_qwebengineview_types.QWebEngineView, event: QKeyEvent): void =
  fQWebEngineView_virtualbase_keyReleaseEvent(self.h, event.h)

type QWebEngineViewkeyReleaseEventProc* = proc(event: QKeyEvent): void
...
proc miqt_exec_callback_QWebEngineView_keyReleaseEvent(self: ptr cQWebEngineView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QWebEngineView_keyReleaseEvent ".} =
  ...
  nimfunc[](slotval1)
proc QWebEngineViewfocusInEvent*(self: gen_qwebengineview_types.QWebEngineView, event: QFocusEvent): void =
  fQWebEngineView_virtualbase_focusInEvent(self.h, event.h)

type QWebEngineViewfocusInEventProc* = proc(event: QFocusEvent): void
...
proc miqt_exec_callback_QWebEngineView_focusInEvent(self: ptr cQWebEngineView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QWebEngineView_focusInEvent ".} =
  ...
  nimfunc[](slotval1)
proc QWebEngineViewfocusOutEvent*(self: gen_qwebengineview_types.QWebEngineView, event: QFocusEvent): void =
  fQWebEngineView_virtualbase_focusOutEvent(self.h, event.h)

type QWebEngineViewfocusOutEventProc* = proc(event: QFocusEvent): void
...
proc miqt_exec_callback_QWebEngineView_focusOutEvent(self: ptr cQWebEngineView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QWebEngineView_focusOutEvent ".} =
  ...
  nimfunc[](slotval1)
proc QWebEngineViewenterEvent*(self: gen_qwebengineview_types.QWebEngineView, event: QEnterEvent): void =
  fQWebEngineView_virtualbase_enterEvent(self.h, event.h)

type QWebEngineViewenterEventProc* = proc(event: QEnterEvent): void
...
proc miqt_exec_callback_QWebEngineView_enterEvent(self: ptr cQWebEngineView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QWebEngineView_enterEvent ".} =
  ...
  nimfunc[](slotval1)
proc QWebEngineViewleaveEvent*(self: gen_qwebengineview_types.QWebEngineView, event: QEvent): void =
  fQWebEngineView_virtualbase_leaveEvent(self.h, event.h)

type QWebEngineViewleaveEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QWebEngineView_leaveEvent(self: ptr cQWebEngineView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QWebEngineView_leaveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QWebEngineViewpaintEvent*(self: gen_qwebengineview_types.QWebEngineView, event: QPaintEvent): void =
  fQWebEngineView_virtualbase_paintEvent(self.h, event.h)

type QWebEngineViewpaintEventProc* = proc(event: QPaintEvent): void
...
proc miqt_exec_callback_QWebEngineView_paintEvent(self: ptr cQWebEngineView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QWebEngineView_paintEvent ".} =
  ...
  nimfunc[](slotval1)
proc QWebEngineViewmoveEvent*(self: gen_qwebengineview_types.QWebEngineView, event: QMoveEvent): void =
  fQWebEngineView_virtualbase_moveEvent(self.h, event.h)

type QWebEngineViewmoveEventProc* = proc(event: QMoveEvent): void
...
proc miqt_exec_callback_QWebEngineView_moveEvent(self: ptr cQWebEngineView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QWebEngineView_moveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QWebEngineViewresizeEvent*(self: gen_qwebengineview_types.QWebEngineView, event: QResizeEvent): void =
  fQWebEngineView_virtualbase_resizeEvent(self.h, event.h)

type QWebEngineViewresizeEventProc* = proc(event: QResizeEvent): void
...
proc miqt_exec_callback_QWebEngineView_resizeEvent(self: ptr cQWebEngineView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QWebEngineView_resizeEvent ".} =
  ...
  nimfunc[](slotval1)
proc QWebEngineViewtabletEvent*(self: gen_qwebengineview_types.QWebEngineView, event: QTabletEvent): void =
  fQWebEngineView_virtualbase_tabletEvent(self.h, event.h)

type QWebEngineViewtabletEventProc* = proc(event: QTabletEvent): void
...
proc miqt_exec_callback_QWebEngineView_tabletEvent(self: ptr cQWebEngineView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QWebEngineView_tabletEvent ".} =
  ...
  nimfunc[](slotval1)
proc QWebEngineViewactionEvent*(self: gen_qwebengineview_types.QWebEngineView, event: QActionEvent): void =
  fQWebEngineView_virtualbase_actionEvent(self.h, event.h)

type QWebEngineViewactionEventProc* = proc(event: QActionEvent): void
...
proc miqt_exec_callback_QWebEngineView_nativeEvent(self: ptr cQWebEngineView, slot: int, eventType: struct_miqt_string, message: pointer, resultVal: ptr uint): bool {.exportc: "miqt_exec_callback_QWebEngineView_nativeEvent ".} =
  ...
  virtualReturn
proc QWebEngineViewchangeEvent*(self: gen_qwebengineview_types.QWebEngineView, param1: QEvent): void =
  fQWebEngineView_virtualbase_changeEvent(self.h, param1.h)

type QWebEngineViewchangeEventProc* = proc(param1: QEvent): void
...
proc miqt_exec_callback_QWebEngineView_metric(self: ptr cQWebEngineView, slot: int, param1: cint): cint {.exportc: "miqt_exec_callback_QWebEngineView_metric ".} =
  ...
  virtualReturn
proc QWebEngineViewinitPainter*(self: gen_qwebengineview_types.QWebEngineView, painter: QPainter): void =
  fQWebEngineView_virtualbase_initPainter(self.h, painter.h)

type QWebEngineViewinitPainterProc* = proc(painter: QPainter): void
...
proc miqt_exec_callback_QWebEngineView_initPainter(self: ptr cQWebEngineView, slot: int, painter: pointer): void {.exportc: "miqt_exec_callback_QWebEngineView_initPainter ".} =
  ...
  nimfunc[](slotval1)
proc QWebEngineViewredirected*(self: gen_qwebengineview_types.QWebEngineView, offset: QPoint): QPaintDevice =
  QPaintDevice(h: fQWebEngineView_virtualbase_redirected(self.h, offset.h))

type QWebEngineViewredirectedProc* = proc(offset: QPoint): QPaintDevice
...
proc miqt_exec_callback_QWebEngineView_redirected(self: ptr cQWebEngineView, slot: int, offset: pointer): pointer {.exportc: "miqt_exec_callback_QWebEngineView_redirected ".} =
  ...
  virtualReturn.h
proc QWebEngineViewsharedPainter*(self: gen_qwebengineview_types.QWebEngineView, ): QPainter =
  QPainter(h: fQWebEngineView_virtualbase_sharedPainter(self.h))

type QWebEngineViewsharedPainterProc* = proc(): QPainter
...
proc miqt_exec_callback_QWebEngineView_sharedPainter(self: ptr cQWebEngineView, slot: int): pointer {.exportc: "miqt_exec_callback_QWebEngineView_sharedPainter ".} =
  ...
  virtualReturn.h
proc QWebEngineViewinputMethodEvent*(self: gen_qwebengineview_types.QWebEngineView, param1: QInputMethodEvent): void =
  fQWebEngineView_virtualbase_inputMethodEvent(self.h, param1.h)

type QWebEngineViewinputMethodEventProc* = proc(param1: QInputMethodEvent): void
...
proc miqt_exec_callback_QWebEngineView_inputMethodEvent(self: ptr cQWebEngineView, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QWebEngineView_inputMethodEvent ".} =
  ...
  nimfunc[](slotval1)
proc QWebEngineViewinputMethodQuery*(self: gen_qwebengineview_types.QWebEngineView, param1: cint): QVariant =
  QVariant(h: fQWebEngineView_virtualbase_inputMethodQuery(self.h, cint(param1)))

type QWebEngineViewinputMethodQueryProc* = proc(param1: cint): QVariant
...
proc miqt_exec_callback_QWebEngineView_focusNextPrevChild(self: ptr cQWebEngineView, slot: int, next: bool): bool {.exportc: "miqt_exec_callback_QWebEngineView_focusNextPrevChild ".} =
  ...
  virtualReturn
proc QWebEngineVieweventFilter*(self: gen_qwebengineview_types.QWebEngineView, watched: QObject, event: QEvent): bool =
  fQWebEngineView_virtualbase_eventFilter(self.h, watched.h, event.h)

type QWebEngineVieweventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QWebEngineView_eventFilter(self: ptr cQWebEngineView, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QWebEngineView_eventFilter ".} =
  ...
  virtualReturn
proc QWebEngineViewtimerEvent*(self: gen_qwebengineview_types.QWebEngineView, event: QTimerEvent): void =
  fQWebEngineView_virtualbase_timerEvent(self.h, event.h)

type QWebEngineViewtimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QWebEngineView_timerEvent(self: ptr cQWebEngineView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QWebEngineView_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QWebEngineViewchildEvent*(self: gen_qwebengineview_types.QWebEngineView, event: QChildEvent): void =
  fQWebEngineView_virtualbase_childEvent(self.h, event.h)

type QWebEngineViewchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QWebEngineView_childEvent(self: ptr cQWebEngineView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QWebEngineView_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QWebEngineViewcustomEvent*(self: gen_qwebengineview_types.QWebEngineView, event: QEvent): void =
  fQWebEngineView_virtualbase_customEvent(self.h, event.h)

type QWebEngineViewcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QWebEngineView_customEvent(self: ptr cQWebEngineView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QWebEngineView_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QWebEngineViewconnectNotify*(self: gen_qwebengineview_types.QWebEngineView, signal: QMetaMethod): void =
  fQWebEngineView_virtualbase_connectNotify(self.h, signal.h)

type QWebEngineViewconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QWebEngineView_connectNotify(self: ptr cQWebEngineView, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QWebEngineView_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QWebEngineViewdisconnectNotify*(self: gen_qwebengineview_types.QWebEngineView, signal: QMetaMethod): void =
  fQWebEngineView_virtualbase_disconnectNotify(self.h, signal.h)

type QWebEngineViewdisconnectNotifyProc* = proc(signal: QMetaMethod): void
