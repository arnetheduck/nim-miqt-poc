...
public:
	...
	MiqtVirtualQSettings(struct QSettings_VTable* vtbl, const QString& organization): QSettings(organization), vtbl(vtbl) {};
	MiqtVirtualQSettings(struct QSettings_VTable* vtbl, QSettings::Scope scope, const QString& organization): QSettings(scope, organization), vtbl(vtbl) {};
	MiqtVirtualQSettings(struct QSettings_VTable* vtbl, QSettings::Format format, QSettings::Scope scope, const QString& organization): QSettings(format, scope, organization), vtbl(vtbl) {};
	MiqtVirtualQSettings(struct QSettings_VTable* vtbl, const QString& fileName, QSettings::Format format): QSettings(fileName, format), vtbl(vtbl) {};
	MiqtVirtualQSettings(struct QSettings_VTable* vtbl): QSettings(), vtbl(vtbl) {};
	MiqtVirtualQSettings(struct QSettings_VTable* vtbl, QSettings::Scope scope): QSettings(scope), vtbl(vtbl) {};
	MiqtVirtualQSettings(struct QSettings_VTable* vtbl, const QString& organization, const QString& application): QSettings(organization, application), vtbl(vtbl) {};
	MiqtVirtualQSettings(struct QSettings_VTable* vtbl, const QString& organization, const QString& application, QObject* parent): QSettings(organization, application, parent), vtbl(vtbl) {};
	MiqtVirtualQSettings(struct QSettings_VTable* vtbl, QSettings::Scope scope, const QString& organization, const QString& application): QSettings(scope, organization, application), vtbl(vtbl) {};
	MiqtVirtualQSettings(struct QSettings_VTable* vtbl, QSettings::Scope scope, const QString& organization, const QString& application, QObject* parent): QSettings(scope, organization, application, parent), vtbl(vtbl) {};
	MiqtVirtualQSettings(struct QSettings_VTable* vtbl, QSettings::Format format, QSettings::Scope scope, const QString& organization, const QString& application): QSettings(format, scope, organization, application), vtbl(vtbl) {};
	MiqtVirtualQSettings(struct QSettings_VTable* vtbl, QSettings::Format format, QSettings::Scope scope, const QString& organization, const QString& application, QObject* parent): QSettings(format, scope, organization, application, parent), vtbl(vtbl) {};
	MiqtVirtualQSettings(struct QSettings_VTable* vtbl, const QString& fileName, QSettings::Format format, QObject* parent): QSettings(fileName, format, parent), vtbl(vtbl) {};
	MiqtVirtualQSettings(struct QSettings_VTable* vtbl, QObject* parent): QSettings(parent), vtbl(vtbl) {};
	MiqtVirtualQSettings(struct QSettings_VTable* vtbl, QSettings::Scope scope, QObject* parent): QSettings(scope, parent), vtbl(vtbl) {};

	virtual ~MiqtVirtualQSettings() override { if(vtbl->destructor) vtbl->destructor(vtbl, this); }
...
QSettings* QSettings_new(struct QSettings_VTable* vtbl, struct miqt_string organization) {
	...
	return new MiqtVirtualQSettings(vtbl, organization_QString);
}

QSettings* QSettings_new2(struct QSettings_VTable* vtbl, int scope, struct miqt_string organization) {
	QString organization_QString = QString::fromUtf8(organization.data, organization.len);
	return new MiqtVirtualQSettings(vtbl, static_cast<QSettings::Scope>(scope), organization_QString);
}

QSettings* QSettings_new3(struct QSettings_VTable* vtbl, int format, int scope, struct miqt_string organization) {
	QString organization_QString = QString::fromUtf8(organization.data, organization.len);
	return new MiqtVirtualQSettings(vtbl, static_cast<QSettings::Format>(format), static_cast<QSettings::Scope>(scope), organization_QString);
}

QSettings* QSettings_new4(struct QSettings_VTable* vtbl, struct miqt_string fileName, int format) {
	QString fileName_QString = QString::fromUtf8(fileName.data, fileName.len);
	return new MiqtVirtualQSettings(vtbl, fileName_QString, static_cast<QSettings::Format>(format));
}

QSettings* QSettings_new5(struct QSettings_VTable* vtbl) {
	return new MiqtVirtualQSettings(vtbl);
}

QSettings* QSettings_new6(struct QSettings_VTable* vtbl, int scope) {
	return new MiqtVirtualQSettings(vtbl, static_cast<QSettings::Scope>(scope));
}
...
QSettings* QSettings_new7(struct QSettings_VTable* vtbl, struct miqt_string organization, struct miqt_string application) {
	...
	return new MiqtVirtualQSettings(vtbl, organization_QString, application_QString);
}
...
QSettings* QSettings_new8(struct QSettings_VTable* vtbl, struct miqt_string organization, struct miqt_string application, QObject* parent) {
	QString organization_QString = QString::fromUtf8(organization.data, organization.len);
	QString application_QString = QString::fromUtf8(application.data, application.len);
	return new MiqtVirtualQSettings(vtbl, organization_QString, application_QString, parent);
}
...
QSettings* QSettings_new9(struct QSettings_VTable* vtbl, int scope, struct miqt_string organization, struct miqt_string application) {
	QString organization_QString = QString::fromUtf8(organization.data, organization.len);
	QString application_QString = QString::fromUtf8(application.data, application.len);
	return new MiqtVirtualQSettings(vtbl, static_cast<QSettings::Scope>(scope), organization_QString, application_QString);
}
...
QSettings* QSettings_new10(struct QSettings_VTable* vtbl, int scope, struct miqt_string organization, struct miqt_string application, QObject* parent) {
	QString organization_QString = QString::fromUtf8(organization.data, organization.len);
	QString application_QString = QString::fromUtf8(application.data, application.len);
	return new MiqtVirtualQSettings(vtbl, static_cast<QSettings::Scope>(scope), organization_QString, application_QString, parent);
}
...
QSettings* QSettings_new11(struct QSettings_VTable* vtbl, int format, int scope, struct miqt_string organization, struct miqt_string application) {
	QString organization_QString = QString::fromUtf8(organization.data, organization.len);
	QString application_QString = QString::fromUtf8(application.data, application.len);
	return new MiqtVirtualQSettings(vtbl, static_cast<QSettings::Format>(format), static_cast<QSettings::Scope>(scope), organization_QString, application_QString);
}
...
QSettings* QSettings_new12(struct QSettings_VTable* vtbl, int format, int scope, struct miqt_string organization, struct miqt_string application, QObject* parent) {
	QString organization_QString = QString::fromUtf8(organization.data, organization.len);
	QString application_QString = QString::fromUtf8(application.data, application.len);
	return new MiqtVirtualQSettings(vtbl, static_cast<QSettings::Format>(format), static_cast<QSettings::Scope>(scope), organization_QString, application_QString, parent);
}

QSettings* QSettings_new13(struct QSettings_VTable* vtbl, struct miqt_string fileName, int format, QObject* parent) {
	QString fileName_QString = QString::fromUtf8(fileName.data, fileName.len);
	return new MiqtVirtualQSettings(vtbl, fileName_QString, static_cast<QSettings::Format>(format), parent);
}

QSettings* QSettings_new14(struct QSettings_VTable* vtbl, QObject* parent) {
	return new MiqtVirtualQSettings(vtbl, parent);
}

QSettings* QSettings_new15(struct QSettings_VTable* vtbl, int scope, QObject* parent) {
	return new MiqtVirtualQSettings(vtbl, static_cast<QSettings::Scope>(scope), parent);
}
...
QMetaObject* QSettings_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQSettings*)(self) )->QSettings::metaObject();

}

void* QSettings_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQSettings*)(self) )->QSettings::qt_metacast(param1);

}

int QSettings_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQSettings*)(self) )->QSettings::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
QObject* QSettings_protectedbase_sender(const void* self) {
	MiqtVirtualQSettings* self_cast = static_cast<MiqtVirtualQSettings*>( (QSettings*)(self) );
