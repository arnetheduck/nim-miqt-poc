...
proc create*(T: type gen_qsignalmapper_types.QSignalMapper, parent: QObject): gen_qsignalmapper_types.QSignalMapper =
  gen_qsignalmapper_types.QSignalMapper.init(fcQSignalMapper_new2(parent.h))

proc metaObject*(self: gen_qsignalmapper_types.QSignalMapper, ): QMetaObject =
  QMetaObject(h: fcQSignalMapper_metaObject(self.h))
...
proc setMapping*(self: gen_qsignalmapper_types.QSignalMapper, sender: QObject, id: cint): void =
  fcQSignalMapper_setMapping(self.h, sender.h, id)

proc setMapping*(self: gen_qsignalmapper_types.QSignalMapper, sender: QObject, text: string): void =
  fcQSignalMapper_setMapping2(self.h, sender.h, struct_miqt_string(data: text, len: csize_t(len(text))))

proc setMapping*(self: gen_qsignalmapper_types.QSignalMapper, sender: QObject, widget: ptr QWidget): void =
  fcQSignalMapper_setMapping3(self.h, sender.h, widget)

proc setMapping*(self: gen_qsignalmapper_types.QSignalMapper, sender: QObject, objectVal: QObject): void =
  fcQSignalMapper_setMapping4(self.h, sender.h, objectVal.h)

proc removeMappings*(self: gen_qsignalmapper_types.QSignalMapper, sender: QObject): void =
  fcQSignalMapper_removeMappings(self.h, sender.h)

proc mapping*(self: gen_qsignalmapper_types.QSignalMapper, id: cint): QObject =
  QObject(h: fcQSignalMapper_mapping(self.h, id))

proc mapping*(self: gen_qsignalmapper_types.QSignalMapper, text: string): QObject =
  QObject(h: fcQSignalMapper_mappingWithText(self.h, struct_miqt_string(data: text, len: csize_t(len(text)))))

proc mapping*(self: gen_qsignalmapper_types.QSignalMapper, widget: ptr QWidget): QObject =
  QObject(h: fcQSignalMapper_mappingWithWidget(self.h, widget))

proc mapping*(self: gen_qsignalmapper_types.QSignalMapper, objectVal: QObject): QObject =
  QObject(h: fcQSignalMapper_mappingWithObject(self.h, objectVal.h))
...
proc mapped*(self: gen_qsignalmapper_types.QSignalMapper, param1: QObject): void =
  fcQSignalMapper_mappedWithQObject(self.h, param1.h)

type QSignalMappermappedWithQObjectSlot* = proc(param1: QObject)
...
proc mappedObject*(self: gen_qsignalmapper_types.QSignalMapper, param1: QObject): void =
  fcQSignalMapper_mappedObject(self.h, param1.h)

type QSignalMappermappedObjectSlot* = proc(param1: QObject)
...
proc map*(self: gen_qsignalmapper_types.QSignalMapper, sender: QObject): void =
...
proc miqt_exec_callback_QSignalMapper_metacall(self: ptr cQSignalMapper, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QSignalMapper_metacall ".} =
  ...
  virtualReturn
proc QSignalMapperevent*(self: gen_qsignalmapper_types.QSignalMapper, event: QEvent): bool =
  fQSignalMapper_virtualbase_event(self.h, event.h)

type QSignalMappereventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QSignalMapper_event(self: ptr cQSignalMapper, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QSignalMapper_event ".} =
  ...
  virtualReturn
proc QSignalMappereventFilter*(self: gen_qsignalmapper_types.QSignalMapper, watched: QObject, event: QEvent): bool =
  fQSignalMapper_virtualbase_eventFilter(self.h, watched.h, event.h)

type QSignalMappereventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QSignalMapper_eventFilter(self: ptr cQSignalMapper, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QSignalMapper_eventFilter ".} =
  ...
  virtualReturn
proc QSignalMappertimerEvent*(self: gen_qsignalmapper_types.QSignalMapper, event: QTimerEvent): void =
  fQSignalMapper_virtualbase_timerEvent(self.h, event.h)

type QSignalMappertimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QSignalMapper_timerEvent(self: ptr cQSignalMapper, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QSignalMapper_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QSignalMapperchildEvent*(self: gen_qsignalmapper_types.QSignalMapper, event: QChildEvent): void =
  fQSignalMapper_virtualbase_childEvent(self.h, event.h)

type QSignalMapperchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QSignalMapper_childEvent(self: ptr cQSignalMapper, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QSignalMapper_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QSignalMappercustomEvent*(self: gen_qsignalmapper_types.QSignalMapper, event: QEvent): void =
  fQSignalMapper_virtualbase_customEvent(self.h, event.h)

type QSignalMappercustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QSignalMapper_customEvent(self: ptr cQSignalMapper, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QSignalMapper_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QSignalMapperconnectNotify*(self: gen_qsignalmapper_types.QSignalMapper, signal: QMetaMethod): void =
  fQSignalMapper_virtualbase_connectNotify(self.h, signal.h)

type QSignalMapperconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QSignalMapper_connectNotify(self: ptr cQSignalMapper, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QSignalMapper_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QSignalMapperdisconnectNotify*(self: gen_qsignalmapper_types.QSignalMapper, signal: QMetaMethod): void =
  fQSignalMapper_virtualbase_disconnectNotify(self.h, signal.h)

type QSignalMapperdisconnectNotifyProc* = proc(signal: QMetaMethod): void
