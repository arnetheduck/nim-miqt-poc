...
QMetaObject* QObject_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQObject*)(self) )->QObject::metaObject();

}

void* QObject_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQObject*)(self) )->QObject::qt_metacast(param1);

}

int QObject_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQObject*)(self) )->QObject::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
