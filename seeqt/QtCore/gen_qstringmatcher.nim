...
proc create*(T: type gen_qstringmatcher_types.QStringMatcher, uc: QChar, len: cint): gen_qstringmatcher_types.QStringMatcher =
...
proc create*(T: type gen_qstringmatcher_types.QStringMatcher, uc: QChar, len: cint, cs: cint): gen_qstringmatcher_types.QStringMatcher =
...
proc indexIn*(self: gen_qstringmatcher_types.QStringMatcher, str: QChar, length: cint): cint =
...
proc indexIn*(self: gen_qstringmatcher_types.QStringMatcher, str: QChar, length: cint, fromVal: cint): cint =
