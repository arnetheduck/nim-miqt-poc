...
proc create*(T: type gen_qstate_types.QState, parent: QState): gen_qstate_types.QState =
  gen_qstate_types.QState.init(fcQState_new3(parent.h))

proc create*(T: type gen_qstate_types.QState, childMode: cint, parent: QState): gen_qstate_types.QState =
  gen_qstate_types.QState.init(fcQState_new4(cint(childMode), parent.h))

proc metaObject*(self: gen_qstate_types.QState, ): QMetaObject =
  QMetaObject(h: fcQState_metaObject(self.h))
...
proc errorState*(self: gen_qstate_types.QState, ): QAbstractState =
  QAbstractState(h: fcQState_errorState(self.h))

proc setErrorState*(self: gen_qstate_types.QState, state: QAbstractState): void =
  fcQState_setErrorState(self.h, state.h)

proc addTransition*(self: gen_qstate_types.QState, transition: QAbstractTransition): void =
  fcQState_addTransition(self.h, transition.h)

proc addTransition*(self: gen_qstate_types.QState, sender: QObject, signal: cstring, target: QAbstractState): QSignalTransition =
  QSignalTransition(h: fcQState_addTransition2(self.h, sender.h, signal, target.h))

proc addTransition*(self: gen_qstate_types.QState, target: QAbstractState): QAbstractTransition =
  QAbstractTransition(h: fcQState_addTransitionWithTarget(self.h, target.h))

proc removeTransition*(self: gen_qstate_types.QState, transition: QAbstractTransition): void =
  fcQState_removeTransition(self.h, transition.h)

proc transitions*(self: gen_qstate_types.QState, ): seq[QAbstractTransition] =
  var v_ma = fcQState_transitions(self.h)
  var vx_ret = newSeq[QAbstractTransition](int(v_ma.len))
  let v_outCast = cast[ptr UncheckedArray[pointer]](v_ma.data)
  for i in 0 ..< v_ma.len:
    vx_ret[i] = QAbstractTransition(h: v_outCast[i])
  vx_ret

proc initialState*(self: gen_qstate_types.QState, ): QAbstractState =
  QAbstractState(h: fcQState_initialState(self.h))

proc setInitialState*(self: gen_qstate_types.QState, state: QAbstractState): void =
...
proc assignProperty*(self: gen_qstate_types.QState, objectVal: QObject, name: cstring, value: QVariant): void =
...
proc miqt_exec_callback_QState_metacall(self: ptr cQState, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QState_metacall ".} =
  ...
  virtualReturn
proc QStateonEntry*(self: gen_qstate_types.QState, event: QEvent): void =
  fQState_virtualbase_onEntry(self.h, event.h)

type QStateonEntryProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QState_onEntry(self: ptr cQState, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QState_onEntry ".} =
  ...
  nimfunc[](slotval1)
proc QStateonExit*(self: gen_qstate_types.QState, event: QEvent): void =
  fQState_virtualbase_onExit(self.h, event.h)

type QStateonExitProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QState_onExit(self: ptr cQState, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QState_onExit ".} =
  ...
  nimfunc[](slotval1)
proc QStateevent*(self: gen_qstate_types.QState, e: QEvent): bool =
  fQState_virtualbase_event(self.h, e.h)

type QStateeventProc* = proc(e: QEvent): bool
...
proc miqt_exec_callback_QState_event(self: ptr cQState, slot: int, e: pointer): bool {.exportc: "miqt_exec_callback_QState_event ".} =
  ...
  virtualReturn
proc QStateeventFilter*(self: gen_qstate_types.QState, watched: QObject, event: QEvent): bool =
  fQState_virtualbase_eventFilter(self.h, watched.h, event.h)

type QStateeventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QState_eventFilter(self: ptr cQState, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QState_eventFilter ".} =
  ...
  virtualReturn
proc QStatetimerEvent*(self: gen_qstate_types.QState, event: QTimerEvent): void =
  fQState_virtualbase_timerEvent(self.h, event.h)

type QStatetimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QState_timerEvent(self: ptr cQState, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QState_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QStatechildEvent*(self: gen_qstate_types.QState, event: QChildEvent): void =
  fQState_virtualbase_childEvent(self.h, event.h)

type QStatechildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QState_childEvent(self: ptr cQState, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QState_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QStatecustomEvent*(self: gen_qstate_types.QState, event: QEvent): void =
  fQState_virtualbase_customEvent(self.h, event.h)

type QStatecustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QState_customEvent(self: ptr cQState, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QState_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QStateconnectNotify*(self: gen_qstate_types.QState, signal: QMetaMethod): void =
  fQState_virtualbase_connectNotify(self.h, signal.h)

type QStateconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QState_connectNotify(self: ptr cQState, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QState_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QStatedisconnectNotify*(self: gen_qstate_types.QState, signal: QMetaMethod): void =
  fQState_virtualbase_disconnectNotify(self.h, signal.h)

type QStatedisconnectNotifyProc* = proc(signal: QMetaMethod): void
