...
proc filterRegExp*(self: gen_qsortfilterproxymodel_types.QSortFilterProxyModel, ): QRegExp =
  QRegExp(h: fcQSortFilterProxyModel_filterRegExp(self.h))
...
proc setFilterRegExp*(self: gen_qsortfilterproxymodel_types.QSortFilterProxyModel, regExp: QRegExp): void =
