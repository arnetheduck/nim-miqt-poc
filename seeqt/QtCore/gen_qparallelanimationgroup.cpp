...
QMetaObject* QParallelAnimationGroup_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQParallelAnimationGroup*)(self) )->QParallelAnimationGroup::metaObject();

}

void* QParallelAnimationGroup_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQParallelAnimationGroup*)(self) )->QParallelAnimationGroup::qt_metacast(param1);

}

int QParallelAnimationGroup_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQParallelAnimationGroup*)(self) )->QParallelAnimationGroup::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
QObject* QParallelAnimationGroup_protectedbase_sender(const void* self) {
	MiqtVirtualQParallelAnimationGroup* self_cast = static_cast<MiqtVirtualQParallelAnimationGroup*>( (QParallelAnimationGroup*)(self) );
