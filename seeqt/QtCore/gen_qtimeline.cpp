...
QMetaObject* QTimeLine_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQTimeLine*)(self) )->QTimeLine::metaObject();

}

void* QTimeLine_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQTimeLine*)(self) )->QTimeLine::qt_metacast(param1);

}

int QTimeLine_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQTimeLine*)(self) )->QTimeLine::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
