...
proc appendToBuffer*(self: gen_qstringconverter_types.QStringDecoder, outVal: QChar, ba: QByteArrayView): QChar =
  QChar(h: fcQStringDecoder_appendToBuffer(self.h, outVal.h, ba.h))

proc decoderForHtml*(_: type gen_qstringconverter_types.QStringDecoder, data: QByteArrayView): QStringDecoder =
