...
func init*(T: type gen_qplugin_types.QStaticPlugin, h: ptr cQStaticPlugin): gen_qplugin_types.QStaticPlugin =
  T(h: h)
proc metaData*(self: gen_qplugin_types.QStaticPlugin, ): QJsonObject =
  QJsonObject(h: fcQStaticPlugin_metaData(self.h))
...
func init*(T: type gen_qplugin_types.QPluginMetaDataHeader, h: ptr cQPluginMetaDataHeader): gen_qplugin_types.QPluginMetaDataHeader =
  T(h: h)
proc create*(T: type gen_qplugin_types.QPluginMetaDataHeader, param1: QPluginMetaDataHeader): gen_qplugin_types.QPluginMetaDataHeader =
...
proc create*(T: type gen_qplugin_types.QPluginMetaDataElfNoteHeader, param1: QPluginMetaDataElfNoteHeader): gen_qplugin_types.QPluginMetaDataElfNoteHeader =
