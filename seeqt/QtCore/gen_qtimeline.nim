...
proc create*(T: type gen_qtimeline_types.QTimeLine, duration: cint, parent: QObject): gen_qtimeline_types.QTimeLine =
  gen_qtimeline_types.QTimeLine.init(fcQTimeLine_new3(duration, parent.h))

proc metaObject*(self: gen_qtimeline_types.QTimeLine, ): QMetaObject =
  QMetaObject(h: fcQTimeLine_metaObject(self.h))
...
proc easingCurve*(self: gen_qtimeline_types.QTimeLine, ): QEasingCurve =
  QEasingCurve(h: fcQTimeLine_easingCurve(self.h))

proc setEasingCurve*(self: gen_qtimeline_types.QTimeLine, curve: QEasingCurve): void =
...
proc miqt_exec_callback_QTimeLine_valueForTime(self: ptr cQTimeLine, slot: int, msec: cint): float64 {.exportc: "miqt_exec_callback_QTimeLine_valueForTime ".} =
  ...
  virtualReturn
proc QTimeLinetimerEvent*(self: gen_qtimeline_types.QTimeLine, event: QTimerEvent): void =
  fQTimeLine_virtualbase_timerEvent(self.h, event.h)

type QTimeLinetimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QTimeLine_timerEvent(self: ptr cQTimeLine, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTimeLine_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTimeLineevent*(self: gen_qtimeline_types.QTimeLine, event: QEvent): bool =
  fQTimeLine_virtualbase_event(self.h, event.h)

type QTimeLineeventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QTimeLine_event(self: ptr cQTimeLine, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QTimeLine_event ".} =
  ...
  virtualReturn
proc QTimeLineeventFilter*(self: gen_qtimeline_types.QTimeLine, watched: QObject, event: QEvent): bool =
  fQTimeLine_virtualbase_eventFilter(self.h, watched.h, event.h)

type QTimeLineeventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QTimeLine_eventFilter(self: ptr cQTimeLine, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QTimeLine_eventFilter ".} =
  ...
  virtualReturn
proc QTimeLinechildEvent*(self: gen_qtimeline_types.QTimeLine, event: QChildEvent): void =
  fQTimeLine_virtualbase_childEvent(self.h, event.h)

type QTimeLinechildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QTimeLine_childEvent(self: ptr cQTimeLine, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTimeLine_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTimeLinecustomEvent*(self: gen_qtimeline_types.QTimeLine, event: QEvent): void =
  fQTimeLine_virtualbase_customEvent(self.h, event.h)

type QTimeLinecustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QTimeLine_customEvent(self: ptr cQTimeLine, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTimeLine_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTimeLineconnectNotify*(self: gen_qtimeline_types.QTimeLine, signal: QMetaMethod): void =
  fQTimeLine_virtualbase_connectNotify(self.h, signal.h)

type QTimeLineconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QTimeLine_connectNotify(self: ptr cQTimeLine, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QTimeLine_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QTimeLinedisconnectNotify*(self: gen_qtimeline_types.QTimeLine, signal: QMetaMethod): void =
  fQTimeLine_virtualbase_disconnectNotify(self.h, signal.h)

type QTimeLinedisconnectNotifyProc* = proc(signal: QMetaMethod): void
