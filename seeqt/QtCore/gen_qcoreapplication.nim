...
proc fQCoreApplication_connect_installNativeEventFilter(self: pointer, slot: int) {.importc: "QCoreApplication_connect_installNativeEventFilter".}
...
proc fQCoreApplication_connect_removeNativeEventFilter(self: pointer, slot: int) {.importc: "QCoreApplication_connect_removeNativeEventFilter".}
...
proc metaObject*(self: gen_qcoreapplication_types.QCoreApplication, ): QMetaObject =
  QMetaObject(h: fcQCoreApplication_metaObject(self.h))
...
proc instance*(_: type gen_qcoreapplication_types.QCoreApplication, ): QCoreApplication =
...
proc sendEvent*(_: type gen_qcoreapplication_types.QCoreApplication, receiver: QObject, event: QEvent): bool =
  fcQCoreApplication_sendEvent(receiver.h, event.h)

proc postEvent*(_: type gen_qcoreapplication_types.QCoreApplication, receiver: QObject, event: QEvent): void =
...
proc removePostedEvents*(_: type gen_qcoreapplication_types.QCoreApplication, receiver: QObject): void =
  fcQCoreApplication_removePostedEvents(receiver.h)

proc eventDispatcher*(_: type gen_qcoreapplication_types.QCoreApplication, ): QAbstractEventDispatcher =
  QAbstractEventDispatcher(h: fcQCoreApplication_eventDispatcher())

proc setEventDispatcher*(_: type gen_qcoreapplication_types.QCoreApplication, eventDispatcher: QAbstractEventDispatcher): void =
  fcQCoreApplication_setEventDispatcher(eventDispatcher.h)

proc notify*(self: gen_qcoreapplication_types.QCoreApplication, param1: QObject, param2: QEvent): bool =
...
proc installTranslator*(_: type gen_qcoreapplication_types.QCoreApplication, messageFile: QTranslator): bool =
  fcQCoreApplication_installTranslator(messageFile.h)

proc removeTranslator*(_: type gen_qcoreapplication_types.QCoreApplication, messageFile: QTranslator): bool =
...
proc installNativeEventFilter*(self: gen_qcoreapplication_types.QCoreApplication, filterObj: QAbstractNativeEventFilter): void =
  fcQCoreApplication_installNativeEventFilter(self.h, filterObj.h)

type QCoreApplicationinstallNativeEventFilterSlot* = proc(filterObj: QAbstractNativeEventFilter)
proc miqt_exec_callback_QCoreApplication_installNativeEventFilter(slot: int, filterObj: pointer) {.exportc.} =
  ...
  let slotval1 = QAbstractNativeEventFilter(h: filterObj)
...
proc oninstallNativeEventFilter*(self: gen_qcoreapplication_types.QCoreApplication, slot: QCoreApplicationinstallNativeEventFilterSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fQCoreApplication_connect_installNativeEventFilter(self.h, cast[int](addr tmp[]))

proc removeNativeEventFilter*(self: gen_qcoreapplication_types.QCoreApplication, filterObj: QAbstractNativeEventFilter): void =
  fcQCoreApplication_removeNativeEventFilter(self.h, filterObj.h)

type QCoreApplicationremoveNativeEventFilterSlot* = proc(filterObj: QAbstractNativeEventFilter)
...
proc onremoveNativeEventFilter*(self: gen_qcoreapplication_types.QCoreApplication, slot: QCoreApplicationremoveNativeEventFilterSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fQCoreApplication_connect_removeNativeEventFilter(self.h, cast[int](addr tmp[]))
...
proc postEvent*(_: type gen_qcoreapplication_types.QCoreApplication, receiver: QObject, event: QEvent, priority: cint): void =
  fcQCoreApplication_postEvent3(receiver.h, event.h, priority)

proc sendPostedEvents*(_: type gen_qcoreapplication_types.QCoreApplication, receiver: QObject): void =
  fcQCoreApplication_sendPostedEvents1(receiver.h)

proc sendPostedEvents*(_: type gen_qcoreapplication_types.QCoreApplication, receiver: QObject, event_type: cint): void =
  fcQCoreApplication_sendPostedEvents2(receiver.h, event_type)

proc removePostedEvents*(_: type gen_qcoreapplication_types.QCoreApplication, receiver: QObject, eventType: cint): void =
...
proc miqt_exec_callback_QCoreApplication_metacall(self: ptr cQCoreApplication, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QCoreApplication_metacall ".} =
  ...
  virtualReturn
proc QCoreApplicationnotify*(self: gen_qcoreapplication_types.QCoreApplication, param1: QObject, param2: QEvent): bool =
  fQCoreApplication_virtualbase_notify(self.h, param1.h, param2.h)

type QCoreApplicationnotifyProc* = proc(param1: QObject, param2: QEvent): bool
...
proc miqt_exec_callback_QCoreApplication_notify(self: ptr cQCoreApplication, slot: int, param1: pointer, param2: pointer): bool {.exportc: "miqt_exec_callback_QCoreApplication_notify ".} =
  ...
  virtualReturn
proc QCoreApplicationevent*(self: gen_qcoreapplication_types.QCoreApplication, param1: QEvent): bool =
  fQCoreApplication_virtualbase_event(self.h, param1.h)

type QCoreApplicationeventProc* = proc(param1: QEvent): bool
...
proc miqt_exec_callback_QCoreApplication_event(self: ptr cQCoreApplication, slot: int, param1: pointer): bool {.exportc: "miqt_exec_callback_QCoreApplication_event ".} =
  ...
  virtualReturn
proc QCoreApplicationeventFilter*(self: gen_qcoreapplication_types.QCoreApplication, watched: QObject, event: QEvent): bool =
  fQCoreApplication_virtualbase_eventFilter(self.h, watched.h, event.h)

type QCoreApplicationeventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QCoreApplication_eventFilter(self: ptr cQCoreApplication, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QCoreApplication_eventFilter ".} =
  ...
  virtualReturn
proc QCoreApplicationtimerEvent*(self: gen_qcoreapplication_types.QCoreApplication, event: QTimerEvent): void =
  fQCoreApplication_virtualbase_timerEvent(self.h, event.h)

type QCoreApplicationtimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QCoreApplication_timerEvent(self: ptr cQCoreApplication, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QCoreApplication_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QCoreApplicationchildEvent*(self: gen_qcoreapplication_types.QCoreApplication, event: QChildEvent): void =
  fQCoreApplication_virtualbase_childEvent(self.h, event.h)

type QCoreApplicationchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QCoreApplication_childEvent(self: ptr cQCoreApplication, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QCoreApplication_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QCoreApplicationcustomEvent*(self: gen_qcoreapplication_types.QCoreApplication, event: QEvent): void =
  fQCoreApplication_virtualbase_customEvent(self.h, event.h)

type QCoreApplicationcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QCoreApplication_customEvent(self: ptr cQCoreApplication, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QCoreApplication_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QCoreApplicationconnectNotify*(self: gen_qcoreapplication_types.QCoreApplication, signal: QMetaMethod): void =
  fQCoreApplication_virtualbase_connectNotify(self.h, signal.h)

type QCoreApplicationconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QCoreApplication_connectNotify(self: ptr cQCoreApplication, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QCoreApplication_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QCoreApplicationdisconnectNotify*(self: gen_qcoreapplication_types.QCoreApplication, signal: QMetaMethod): void =
  fQCoreApplication_virtualbase_disconnectNotify(self.h, signal.h)

type QCoreApplicationdisconnectNotifyProc* = proc(signal: QMetaMethod): void
