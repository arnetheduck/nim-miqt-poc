...
void QProcess_connect_finished(QProcess* self, intptr_t slot, void (*callback)(intptr_t, int), void (*release)(intptr_t)) {
	...
	MiqtVirtualQProcess::connect(self, static_cast<void (QProcess::*)(int)>(&QProcess::finished), self, caller{slot, callback, release});
}
...
void QProcess_connect_finished2(QProcess* self, intptr_t slot, void (*callback)(intptr_t, int, int), void (*release)(intptr_t)) {
	...
	MiqtVirtualQProcess::connect(self, static_cast<void (QProcess::*)(int, QProcess::ExitStatus)>(&QProcess::finished), self, caller{slot, callback, release});
}
...
void QProcess_connect_errorWithError(QProcess* self, intptr_t slot, void (*callback)(intptr_t, int), void (*release)(intptr_t)) {
	...
	MiqtVirtualQProcess::connect(self, static_cast<void (QProcess::*)(QProcess::ProcessError)>(&QProcess::error), self, caller{slot, callback, release});
}
...
void QProcess_connect_errorOccurred(QProcess* self, intptr_t slot, void (*callback)(intptr_t, int), void (*release)(intptr_t)) {
	...
	MiqtVirtualQProcess::connect(self, static_cast<void (QProcess::*)(QProcess::ProcessError)>(&QProcess::errorOccurred), self, caller{slot, callback, release});
}
...
QMetaObject* QProcess_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQProcess*)(self) )->QProcess::metaObject();

}

void* QProcess_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQProcess*)(self) )->QProcess::qt_metacast(param1);

}

int QProcess_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQProcess*)(self) )->QProcess::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
