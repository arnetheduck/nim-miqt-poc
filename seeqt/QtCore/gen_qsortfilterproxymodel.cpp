...
QMetaObject* QSortFilterProxyModel_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQSortFilterProxyModel*)(self) )->QSortFilterProxyModel::metaObject();

}

void* QSortFilterProxyModel_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQSortFilterProxyModel*)(self) )->QSortFilterProxyModel::qt_metacast(param1);

}

int QSortFilterProxyModel_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQSortFilterProxyModel*)(self) )->QSortFilterProxyModel::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
