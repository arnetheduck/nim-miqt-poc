...
proc operatorSubscript*(self: gen_qcborvalue_types.QCborValueRef, key: string): QCborValue =
  QCborValue(h: fcQCborValueRef_operatorSubscript(self.h, struct_miqt_string(data: key, len: csize_t(len(key)))))

proc operatorSubscript*(self: gen_qcborvalue_types.QCborValueRef, key: clonglong): QCborValue =
  QCborValue(h: fcQCborValueRef_operatorSubscript2(self.h, key))

proc operatorSubscript2*(self: gen_qcborvalue_types.QCborValueRef, key: clonglong): QCborValueRef =
  QCborValueRef(h: fcQCborValueRef_operatorSubscript3(self.h, key))

proc operatorSubscript2*(self: gen_qcborvalue_types.QCborValueRef, key: string): QCborValueRef =
