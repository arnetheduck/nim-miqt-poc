...
QMetaObject* QAbstractTransition_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQAbstractTransition*)(self) )->QAbstractTransition::metaObject();

}

void* QAbstractTransition_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQAbstractTransition*)(self) )->QAbstractTransition::qt_metacast(param1);

}

int QAbstractTransition_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQAbstractTransition*)(self) )->QAbstractTransition::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
