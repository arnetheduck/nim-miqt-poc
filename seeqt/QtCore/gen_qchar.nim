...
template VisualTabCharacter*(_: type QCharSpecialCharacterEnum): untyped = 8594
...
template Script_CyproMinoan*(_: type QCharScriptEnum): untyped = 157
template Script_OldUyghur*(_: type QCharScriptEnum): untyped = 158
template Script_Tangsa*(_: type QCharScriptEnum): untyped = 159
template Script_Toto*(_: type QCharScriptEnum): untyped = 160
template Script_Vithkuqi*(_: type QCharScriptEnum): untyped = 161
template ScriptCount*(_: type QCharScriptEnum): untyped = 162
...
template Unicode_14_0*(_: type QCharUnicodeVersionEnum): untyped = 24
...
proc create*(T: type gen_qchar_types.QLatin1Char, param1: QLatin1Char): gen_qchar_types.QLatin1Char =
...
proc create*(T: type gen_qchar_types.QChar, ch: QLatin1Char): gen_qchar_types.QChar =
...
proc create*(T: type gen_qchar_types.QChar, param1: QChar): gen_qchar_types.QChar =
...
proc mirroredChar*(self: gen_qchar_types.QChar, ): QChar =
...
proc toLower*(self: gen_qchar_types.QChar, ): QChar =
  QChar(h: fcQChar_toLower(self.h))

proc toUpper*(self: gen_qchar_types.QChar, ): QChar =
  QChar(h: fcQChar_toUpper(self.h))

proc toTitleCase*(self: gen_qchar_types.QChar, ): QChar =
  QChar(h: fcQChar_toTitleCase(self.h))

proc toCaseFolded*(self: gen_qchar_types.QChar, ): QChar =
...
proc fromLatin1*(_: type gen_qchar_types.QChar, c: cchar): QChar =
