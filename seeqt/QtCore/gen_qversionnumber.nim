...
proc create*(T: type gen_qversionnumber_types.QVersionNumber, param1: QVersionNumber): gen_qversionnumber_types.QVersionNumber =
...
proc fromString*(_: type gen_qversionnumber_types.QVersionNumber, string: QAnyStringView): QVersionNumber =
  QVersionNumber(h: fcQVersionNumber_fromString(string.h))

proc fromString*(_: type gen_qversionnumber_types.QVersionNumber, string: QAnyStringView, suffixIndex: ptr int64): QVersionNumber =
...
proc create*(T: type gen_qversionnumber_types.QTypeRevision, param1: QTypeRevision): gen_qversionnumber_types.QTypeRevision =
  gen_qversionnumber_types.QTypeRevision.init(fcQTypeRevision_new2(param1.h))

proc zero*(_: type gen_qversionnumber_types.QTypeRevision, ): QTypeRevision =
