...
proc create*(T: type gen_qeventloop_types.QEventLoop, parent: QObject): gen_qeventloop_types.QEventLoop =
  gen_qeventloop_types.QEventLoop.init(fcQEventLoop_new2(parent.h))

proc metaObject*(self: gen_qeventloop_types.QEventLoop, ): QMetaObject =
  QMetaObject(h: fcQEventLoop_metaObject(self.h))
...
proc event*(self: gen_qeventloop_types.QEventLoop, event: QEvent): bool =
...
proc miqt_exec_callback_QEventLoop_metacall(self: ptr cQEventLoop, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QEventLoop_metacall ".} =
  ...
  virtualReturn
proc QEventLoopevent*(self: gen_qeventloop_types.QEventLoop, event: QEvent): bool =
  fQEventLoop_virtualbase_event(self.h, event.h)

type QEventLoopeventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QEventLoop_event(self: ptr cQEventLoop, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QEventLoop_event ".} =
  ...
  virtualReturn
proc QEventLoopeventFilter*(self: gen_qeventloop_types.QEventLoop, watched: QObject, event: QEvent): bool =
  fQEventLoop_virtualbase_eventFilter(self.h, watched.h, event.h)

type QEventLoopeventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QEventLoop_eventFilter(self: ptr cQEventLoop, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QEventLoop_eventFilter ".} =
  ...
  virtualReturn
proc QEventLooptimerEvent*(self: gen_qeventloop_types.QEventLoop, event: QTimerEvent): void =
  fQEventLoop_virtualbase_timerEvent(self.h, event.h)

type QEventLooptimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QEventLoop_timerEvent(self: ptr cQEventLoop, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QEventLoop_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QEventLoopchildEvent*(self: gen_qeventloop_types.QEventLoop, event: QChildEvent): void =
  fQEventLoop_virtualbase_childEvent(self.h, event.h)

type QEventLoopchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QEventLoop_childEvent(self: ptr cQEventLoop, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QEventLoop_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QEventLoopcustomEvent*(self: gen_qeventloop_types.QEventLoop, event: QEvent): void =
  fQEventLoop_virtualbase_customEvent(self.h, event.h)

type QEventLoopcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QEventLoop_customEvent(self: ptr cQEventLoop, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QEventLoop_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QEventLoopconnectNotify*(self: gen_qeventloop_types.QEventLoop, signal: QMetaMethod): void =
  fQEventLoop_virtualbase_connectNotify(self.h, signal.h)

type QEventLoopconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QEventLoop_connectNotify(self: ptr cQEventLoop, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QEventLoop_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QEventLoopdisconnectNotify*(self: gen_qeventloop_types.QEventLoop, signal: QMetaMethod): void =
  fQEventLoop_virtualbase_disconnectNotify(self.h, signal.h)

type QEventLoopdisconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc create*(T: type gen_qeventloop_types.QEventLoopLocker, loop: QEventLoop): gen_qeventloop_types.QEventLoopLocker =
  gen_qeventloop_types.QEventLoopLocker.init(fcQEventLoopLocker_new2(loop.h))

proc create*(T: type gen_qeventloop_types.QEventLoopLocker, thread: QThread): gen_qeventloop_types.QEventLoopLocker =
