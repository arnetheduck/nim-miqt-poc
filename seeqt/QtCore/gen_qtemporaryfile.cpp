...
QMetaObject* QTemporaryFile_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQTemporaryFile*)(self) )->QTemporaryFile::metaObject();

}

void* QTemporaryFile_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQTemporaryFile*)(self) )->QTemporaryFile::qt_metacast(param1);

}

int QTemporaryFile_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQTemporaryFile*)(self) )->QTemporaryFile::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
