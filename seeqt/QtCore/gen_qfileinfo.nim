...
proc create*(T: type gen_qfileinfo_types.QFileInfo, file: QFile): gen_qfileinfo_types.QFileInfo =
...
proc setFile*(self: gen_qfileinfo_types.QFileInfo, file: QFile): void =
...
proc created*(self: gen_qfileinfo_types.QFileInfo, ): QDateTime =
  QDateTime(h: fcQFileInfo_created(self.h))
