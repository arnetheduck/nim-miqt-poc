...
proc fcQFileInfo_isAlias(self: pointer, ): bool {.importc: "QFileInfo_isAlias".}
...
proc fcQFileInfo_junctionTarget(self: pointer, ): struct_miqt_string {.importc: "QFileInfo_junctionTarget".}
...
proc create*(T: type gen_qfileinfo_types.QFileInfo, file: QFileDevice): gen_qfileinfo_types.QFileInfo =
  gen_qfileinfo_types.QFileInfo.init(fcQFileInfo_new3(file.h))

proc create*(T: type gen_qfileinfo_types.QFileInfo, dir: QDir, file: string): gen_qfileinfo_types.QFileInfo =
  gen_qfileinfo_types.QFileInfo.init(fcQFileInfo_new4(dir.h, struct_miqt_string(data: file, len: csize_t(len(file)))))

proc create*(T: type gen_qfileinfo_types.QFileInfo, fileinfo: QFileInfo): gen_qfileinfo_types.QFileInfo =
  gen_qfileinfo_types.QFileInfo.init(fcQFileInfo_new5(fileinfo.h))

proc operatorAssign*(self: gen_qfileinfo_types.QFileInfo, fileinfo: QFileInfo): void =
  fcQFileInfo_operatorAssign(self.h, fileinfo.h)

proc swap*(self: gen_qfileinfo_types.QFileInfo, other: QFileInfo): void =
  fcQFileInfo_swap(self.h, other.h)

proc operatorEqual*(self: gen_qfileinfo_types.QFileInfo, fileinfo: QFileInfo): bool =
  fcQFileInfo_operatorEqual(self.h, fileinfo.h)

proc operatorNotEqual*(self: gen_qfileinfo_types.QFileInfo, fileinfo: QFileInfo): bool =
...
proc setFile*(self: gen_qfileinfo_types.QFileInfo, file: QFileDevice): void =
  fcQFileInfo_setFileWithFile(self.h, file.h)

proc setFile*(self: gen_qfileinfo_types.QFileInfo, dir: QDir, file: string): void =
...
proc dir*(self: gen_qfileinfo_types.QFileInfo, ): QDir =
  QDir(h: fcQFileInfo_dir(self.h))

proc absoluteDir*(self: gen_qfileinfo_types.QFileInfo, ): QDir =
  QDir(h: fcQFileInfo_absoluteDir(self.h))
...
proc isAlias*(self: gen_qfileinfo_types.QFileInfo, ): bool =
  fcQFileInfo_isAlias(self.h)
...
proc birthTime*(self: gen_qfileinfo_types.QFileInfo, ): QDateTime =
  QDateTime(h: fcQFileInfo_birthTime(self.h))

proc metadataChangeTime*(self: gen_qfileinfo_types.QFileInfo, ): QDateTime =
  QDateTime(h: fcQFileInfo_metadataChangeTime(self.h))

proc lastModified*(self: gen_qfileinfo_types.QFileInfo, ): QDateTime =
  QDateTime(h: fcQFileInfo_lastModified(self.h))

proc lastRead*(self: gen_qfileinfo_types.QFileInfo, ): QDateTime =
  QDateTime(h: fcQFileInfo_lastRead(self.h))

proc fileTime*(self: gen_qfileinfo_types.QFileInfo, time: cint): QDateTime =
  QDateTime(h: fcQFileInfo_fileTime(self.h, cint(time)))
