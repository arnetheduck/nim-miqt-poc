...
proc create*(T: type gen_qsemaphore_types.QSemaphoreReleaser, sem: QSemaphore): gen_qsemaphore_types.QSemaphoreReleaser =
  gen_qsemaphore_types.QSemaphoreReleaser.init(fcQSemaphoreReleaser_new2(sem.h))

proc create2*(T: type gen_qsemaphore_types.QSemaphoreReleaser, sem: QSemaphore): gen_qsemaphore_types.QSemaphoreReleaser =
  gen_qsemaphore_types.QSemaphoreReleaser.init(fcQSemaphoreReleaser_new3(sem.h))

proc create*(T: type gen_qsemaphore_types.QSemaphoreReleaser, sem: QSemaphore, n: cint): gen_qsemaphore_types.QSemaphoreReleaser =
  gen_qsemaphore_types.QSemaphoreReleaser.init(fcQSemaphoreReleaser_new4(sem.h, n))

proc create2*(T: type gen_qsemaphore_types.QSemaphoreReleaser, sem: QSemaphore, n: cint): gen_qsemaphore_types.QSemaphoreReleaser =
  gen_qsemaphore_types.QSemaphoreReleaser.init(fcQSemaphoreReleaser_new5(sem.h, n))

proc swap*(self: gen_qsemaphore_types.QSemaphoreReleaser, other: QSemaphoreReleaser): void =
  fcQSemaphoreReleaser_swap(self.h, other.h)

proc semaphore*(self: gen_qsemaphore_types.QSemaphoreReleaser, ): QSemaphore =
  QSemaphore(h: fcQSemaphoreReleaser_semaphore(self.h))

proc cancel*(self: gen_qsemaphore_types.QSemaphoreReleaser, ): QSemaphore =
