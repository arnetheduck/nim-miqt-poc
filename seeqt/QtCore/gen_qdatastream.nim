...
proc create*(T: type gen_qdatastream_types.QDataStream, param1: QIODevice): gen_qdatastream_types.QDataStream =
...
proc device*(self: gen_qdatastream_types.QDataStream, ): QIODevice =
  QIODevice(h: fcQDataStream_device(self.h))

proc setDevice*(self: gen_qdatastream_types.QDataStream, device: QIODevice): void =
...
proc readBytes*(self: gen_qdatastream_types.QDataStream, param1: cstring, len: ptr cuint): QDataStream =
