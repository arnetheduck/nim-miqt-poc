...
proc create*(T: type gen_qabstracttransition_types.QAbstractTransition, sourceState: QState): gen_qabstracttransition_types.QAbstractTransition =
  gen_qabstracttransition_types.QAbstractTransition.init(fcQAbstractTransition_new2(sourceState.h))

proc metaObject*(self: gen_qabstracttransition_types.QAbstractTransition, ): QMetaObject =
  QMetaObject(h: fcQAbstractTransition_metaObject(self.h))
...
proc sourceState*(self: gen_qabstracttransition_types.QAbstractTransition, ): QState =
  QState(h: fcQAbstractTransition_sourceState(self.h))

proc targetState*(self: gen_qabstracttransition_types.QAbstractTransition, ): QAbstractState =
  QAbstractState(h: fcQAbstractTransition_targetState(self.h))

proc setTargetState*(self: gen_qabstracttransition_types.QAbstractTransition, target: QAbstractState): void =
  fcQAbstractTransition_setTargetState(self.h, target.h)

proc targetStates*(self: gen_qabstracttransition_types.QAbstractTransition, ): seq[QAbstractState] =
  var v_ma = fcQAbstractTransition_targetStates(self.h)
  var vx_ret = newSeq[QAbstractState](int(v_ma.len))
  let v_outCast = cast[ptr UncheckedArray[pointer]](v_ma.data)
  for i in 0 ..< v_ma.len:
    vx_ret[i] = QAbstractState(h: v_outCast[i])
  vx_ret

proc setTargetStates*(self: gen_qabstracttransition_types.QAbstractTransition, targets: seq[QAbstractState]): void =
...
proc machine*(self: gen_qabstracttransition_types.QAbstractTransition, ): QStateMachine =
  QStateMachine(h: fcQAbstractTransition_machine(self.h))

proc addAnimation*(self: gen_qabstracttransition_types.QAbstractTransition, animation: QAbstractAnimation): void =
  fcQAbstractTransition_addAnimation(self.h, animation.h)

proc removeAnimation*(self: gen_qabstracttransition_types.QAbstractTransition, animation: QAbstractAnimation): void =
  fcQAbstractTransition_removeAnimation(self.h, animation.h)

proc animations*(self: gen_qabstracttransition_types.QAbstractTransition, ): seq[QAbstractAnimation] =
...
proc miqt_exec_callback_QAbstractTransition_metacall(self: ptr cQAbstractTransition, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QAbstractTransition_metacall ".} =
  ...
  virtualReturn
type QAbstractTransitioneventTestProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QAbstractTransition_eventTest(self: ptr cQAbstractTransition, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QAbstractTransition_eventTest ".} =
  ...
  virtualReturn
type QAbstractTransitiononTransitionProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QAbstractTransition_onTransition(self: ptr cQAbstractTransition, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QAbstractTransition_onTransition ".} =
  ...
  nimfunc[](slotval1)
proc QAbstractTransitionevent*(self: gen_qabstracttransition_types.QAbstractTransition, e: QEvent): bool =
  fQAbstractTransition_virtualbase_event(self.h, e.h)

type QAbstractTransitioneventProc* = proc(e: QEvent): bool
...
proc miqt_exec_callback_QAbstractTransition_event(self: ptr cQAbstractTransition, slot: int, e: pointer): bool {.exportc: "miqt_exec_callback_QAbstractTransition_event ".} =
  ...
  virtualReturn
proc QAbstractTransitioneventFilter*(self: gen_qabstracttransition_types.QAbstractTransition, watched: QObject, event: QEvent): bool =
  fQAbstractTransition_virtualbase_eventFilter(self.h, watched.h, event.h)

type QAbstractTransitioneventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QAbstractTransition_eventFilter(self: ptr cQAbstractTransition, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QAbstractTransition_eventFilter ".} =
  ...
  virtualReturn
proc QAbstractTransitiontimerEvent*(self: gen_qabstracttransition_types.QAbstractTransition, event: QTimerEvent): void =
  fQAbstractTransition_virtualbase_timerEvent(self.h, event.h)

type QAbstractTransitiontimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QAbstractTransition_timerEvent(self: ptr cQAbstractTransition, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QAbstractTransition_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QAbstractTransitionchildEvent*(self: gen_qabstracttransition_types.QAbstractTransition, event: QChildEvent): void =
  fQAbstractTransition_virtualbase_childEvent(self.h, event.h)

type QAbstractTransitionchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QAbstractTransition_childEvent(self: ptr cQAbstractTransition, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QAbstractTransition_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QAbstractTransitioncustomEvent*(self: gen_qabstracttransition_types.QAbstractTransition, event: QEvent): void =
  fQAbstractTransition_virtualbase_customEvent(self.h, event.h)

type QAbstractTransitioncustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QAbstractTransition_customEvent(self: ptr cQAbstractTransition, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QAbstractTransition_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QAbstractTransitionconnectNotify*(self: gen_qabstracttransition_types.QAbstractTransition, signal: QMetaMethod): void =
  fQAbstractTransition_virtualbase_connectNotify(self.h, signal.h)

type QAbstractTransitionconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QAbstractTransition_connectNotify(self: ptr cQAbstractTransition, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QAbstractTransition_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QAbstractTransitiondisconnectNotify*(self: gen_qabstracttransition_types.QAbstractTransition, signal: QMetaMethod): void =
  fQAbstractTransition_virtualbase_disconnectNotify(self.h, signal.h)

type QAbstractTransitiondisconnectNotifyProc* = proc(signal: QMetaMethod): void
