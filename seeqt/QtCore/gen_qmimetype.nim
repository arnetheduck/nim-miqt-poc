...
proc create*(T: type gen_qmimetype_types.QMimeType, other: QMimeType): gen_qmimetype_types.QMimeType =
  gen_qmimetype_types.QMimeType.init(fcQMimeType_new2(other.h))

proc operatorAssign*(self: gen_qmimetype_types.QMimeType, other: QMimeType): void =
  fcQMimeType_operatorAssign(self.h, other.h)

proc swap*(self: gen_qmimetype_types.QMimeType, other: QMimeType): void =
  fcQMimeType_swap(self.h, other.h)

proc operatorEqual*(self: gen_qmimetype_types.QMimeType, other: QMimeType): bool =
  fcQMimeType_operatorEqual(self.h, other.h)

proc operatorNotEqual*(self: gen_qmimetype_types.QMimeType, other: QMimeType): bool =
