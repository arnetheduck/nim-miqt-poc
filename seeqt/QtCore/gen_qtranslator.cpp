...
QMetaObject* QTranslator_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQTranslator*)(self) )->QTranslator::metaObject();

}

void* QTranslator_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQTranslator*)(self) )->QTranslator::qt_metacast(param1);

}

int QTranslator_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQTranslator*)(self) )->QTranslator::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
