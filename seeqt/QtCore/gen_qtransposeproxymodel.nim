...
proc create*(T: type gen_qtransposeproxymodel_types.QTransposeProxyModel, parent: QObject): gen_qtransposeproxymodel_types.QTransposeProxyModel =
  gen_qtransposeproxymodel_types.QTransposeProxyModel.init(fcQTransposeProxyModel_new2(parent.h))

proc metaObject*(self: gen_qtransposeproxymodel_types.QTransposeProxyModel, ): QMetaObject =
  QMetaObject(h: fcQTransposeProxyModel_metaObject(self.h))
...
proc setSourceModel*(self: gen_qtransposeproxymodel_types.QTransposeProxyModel, newSourceModel: QAbstractItemModel): void =
  fcQTransposeProxyModel_setSourceModel(self.h, newSourceModel.h)

proc rowCount*(self: gen_qtransposeproxymodel_types.QTransposeProxyModel, parent: QModelIndex): cint =
  fcQTransposeProxyModel_rowCount(self.h, parent.h)

proc columnCount*(self: gen_qtransposeproxymodel_types.QTransposeProxyModel, parent: QModelIndex): cint =
  fcQTransposeProxyModel_columnCount(self.h, parent.h)

proc headerData*(self: gen_qtransposeproxymodel_types.QTransposeProxyModel, section: cint, orientation: cint, role: cint): QVariant =
  QVariant(h: fcQTransposeProxyModel_headerData(self.h, section, cint(orientation), role))

proc setHeaderData*(self: gen_qtransposeproxymodel_types.QTransposeProxyModel, section: cint, orientation: cint, value: QVariant, role: cint): bool =
  fcQTransposeProxyModel_setHeaderData(self.h, section, cint(orientation), value.h, role)

proc setItemData*(self: gen_qtransposeproxymodel_types.QTransposeProxyModel, index: QModelIndex, roles: Table[cint,QVariant]): bool =
...
proc span*(self: gen_qtransposeproxymodel_types.QTransposeProxyModel, index: QModelIndex): QSize =
  QSize(h: fcQTransposeProxyModel_span(self.h, index.h))

proc itemData*(self: gen_qtransposeproxymodel_types.QTransposeProxyModel, index: QModelIndex): Table[cint,QVariant] =
...
proc mapFromSource*(self: gen_qtransposeproxymodel_types.QTransposeProxyModel, sourceIndex: QModelIndex): QModelIndex =
  QModelIndex(h: fcQTransposeProxyModel_mapFromSource(self.h, sourceIndex.h))

proc mapToSource*(self: gen_qtransposeproxymodel_types.QTransposeProxyModel, proxyIndex: QModelIndex): QModelIndex =
  QModelIndex(h: fcQTransposeProxyModel_mapToSource(self.h, proxyIndex.h))

proc parent*(self: gen_qtransposeproxymodel_types.QTransposeProxyModel, index: QModelIndex): QModelIndex =
  QModelIndex(h: fcQTransposeProxyModel_parent(self.h, index.h))

proc index*(self: gen_qtransposeproxymodel_types.QTransposeProxyModel, row: cint, column: cint, parent: QModelIndex): QModelIndex =
  QModelIndex(h: fcQTransposeProxyModel_index(self.h, row, column, parent.h))

proc insertRows*(self: gen_qtransposeproxymodel_types.QTransposeProxyModel, row: cint, count: cint, parent: QModelIndex): bool =
  fcQTransposeProxyModel_insertRows(self.h, row, count, parent.h)

proc removeRows*(self: gen_qtransposeproxymodel_types.QTransposeProxyModel, row: cint, count: cint, parent: QModelIndex): bool =
  fcQTransposeProxyModel_removeRows(self.h, row, count, parent.h)

proc moveRows*(self: gen_qtransposeproxymodel_types.QTransposeProxyModel, sourceParent: QModelIndex, sourceRow: cint, count: cint, destinationParent: QModelIndex, destinationChild: cint): bool =
  fcQTransposeProxyModel_moveRows(self.h, sourceParent.h, sourceRow, count, destinationParent.h, destinationChild)

proc insertColumns*(self: gen_qtransposeproxymodel_types.QTransposeProxyModel, column: cint, count: cint, parent: QModelIndex): bool =
  fcQTransposeProxyModel_insertColumns(self.h, column, count, parent.h)

proc removeColumns*(self: gen_qtransposeproxymodel_types.QTransposeProxyModel, column: cint, count: cint, parent: QModelIndex): bool =
  fcQTransposeProxyModel_removeColumns(self.h, column, count, parent.h)

proc moveColumns*(self: gen_qtransposeproxymodel_types.QTransposeProxyModel, sourceParent: QModelIndex, sourceColumn: cint, count: cint, destinationParent: QModelIndex, destinationChild: cint): bool =
...
proc miqt_exec_callback_QTransposeProxyModel_metacall(self: ptr cQTransposeProxyModel, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QTransposeProxyModel_metacall ".} =
  ...
  virtualReturn
proc QTransposeProxyModelsetSourceModel*(self: gen_qtransposeproxymodel_types.QTransposeProxyModel, newSourceModel: QAbstractItemModel): void =
  fQTransposeProxyModel_virtualbase_setSourceModel(self.h, newSourceModel.h)

type QTransposeProxyModelsetSourceModelProc* = proc(newSourceModel: QAbstractItemModel): void
...
proc miqt_exec_callback_QTransposeProxyModel_setSourceModel(self: ptr cQTransposeProxyModel, slot: int, newSourceModel: pointer): void {.exportc: "miqt_exec_callback_QTransposeProxyModel_setSourceModel ".} =
  ...
  let slotval1 = QAbstractItemModel(h: newSourceModel)


  nimfunc[](slotval1)
proc QTransposeProxyModelrowCount*(self: gen_qtransposeproxymodel_types.QTransposeProxyModel, parent: QModelIndex): cint =
  fQTransposeProxyModel_virtualbase_rowCount(self.h, parent.h)

type QTransposeProxyModelrowCountProc* = proc(parent: QModelIndex): cint
...
proc miqt_exec_callback_QTransposeProxyModel_rowCount(self: ptr cQTransposeProxyModel, slot: int, parent: pointer): cint {.exportc: "miqt_exec_callback_QTransposeProxyModel_rowCount ".} =
  ...
  virtualReturn
proc QTransposeProxyModelcolumnCount*(self: gen_qtransposeproxymodel_types.QTransposeProxyModel, parent: QModelIndex): cint =
  fQTransposeProxyModel_virtualbase_columnCount(self.h, parent.h)

type QTransposeProxyModelcolumnCountProc* = proc(parent: QModelIndex): cint
...
proc miqt_exec_callback_QTransposeProxyModel_columnCount(self: ptr cQTransposeProxyModel, slot: int, parent: pointer): cint {.exportc: "miqt_exec_callback_QTransposeProxyModel_columnCount ".} =
  ...
  virtualReturn
proc QTransposeProxyModelheaderData*(self: gen_qtransposeproxymodel_types.QTransposeProxyModel, section: cint, orientation: cint, role: cint): QVariant =
  QVariant(h: fQTransposeProxyModel_virtualbase_headerData(self.h, section, cint(orientation), role))

type QTransposeProxyModelheaderDataProc* = proc(section: cint, orientation: cint, role: cint): QVariant
...
proc miqt_exec_callback_QTransposeProxyModel_headerData(self: ptr cQTransposeProxyModel, slot: int, section: cint, orientation: cint, role: cint): pointer {.exportc: "miqt_exec_callback_QTransposeProxyModel_headerData ".} =
  ...
  virtualReturn.h
proc QTransposeProxyModelsetHeaderData*(self: gen_qtransposeproxymodel_types.QTransposeProxyModel, section: cint, orientation: cint, value: QVariant, role: cint): bool =
  fQTransposeProxyModel_virtualbase_setHeaderData(self.h, section, cint(orientation), value.h, role)

type QTransposeProxyModelsetHeaderDataProc* = proc(section: cint, orientation: cint, value: QVariant, role: cint): bool
...
proc miqt_exec_callback_QTransposeProxyModel_setHeaderData(self: ptr cQTransposeProxyModel, slot: int, section: cint, orientation: cint, value: pointer, role: cint): bool {.exportc: "miqt_exec_callback_QTransposeProxyModel_setHeaderData ".} =
  ...
  virtualReturn
proc QTransposeProxyModelsetItemData*(self: gen_qtransposeproxymodel_types.QTransposeProxyModel, index: QModelIndex, roles: Table[cint,QVariant]): bool =
  var roles_Keys_CArray = newSeq[cint](len(roles))
  var roles_Values_CArray = newSeq[pointer](len(roles))
  var roles_ctr = 0
  for rolesk, rolesv in roles:
...
type QTransposeProxyModelsetItemDataProc* = proc(index: QModelIndex, roles: Table[cint,QVariant]): bool
...
proc miqt_exec_callback_QTransposeProxyModel_setItemData(self: ptr cQTransposeProxyModel, slot: int, index: pointer, roles: struct_miqt_map): bool {.exportc: "miqt_exec_callback_QTransposeProxyModel_setItemData ".} =
  ...
  virtualReturn
proc QTransposeProxyModelspan*(self: gen_qtransposeproxymodel_types.QTransposeProxyModel, index: QModelIndex): QSize =
  QSize(h: fQTransposeProxyModel_virtualbase_span(self.h, index.h))

type QTransposeProxyModelspanProc* = proc(index: QModelIndex): QSize
...
proc miqt_exec_callback_QTransposeProxyModel_span(self: ptr cQTransposeProxyModel, slot: int, index: pointer): pointer {.exportc: "miqt_exec_callback_QTransposeProxyModel_span ".} =
  ...
  virtualReturn.h
proc QTransposeProxyModelitemData*(self: gen_qtransposeproxymodel_types.QTransposeProxyModel, index: QModelIndex): Table[cint,QVariant] =
...
type QTransposeProxyModelitemDataProc* = proc(index: QModelIndex): Table[cint,QVariant]
...
proc QTransposeProxyModelmapFromSource*(self: gen_qtransposeproxymodel_types.QTransposeProxyModel, sourceIndex: QModelIndex): QModelIndex =
  QModelIndex(h: fQTransposeProxyModel_virtualbase_mapFromSource(self.h, sourceIndex.h))

type QTransposeProxyModelmapFromSourceProc* = proc(sourceIndex: QModelIndex): QModelIndex
...
proc miqt_exec_callback_QTransposeProxyModel_mapFromSource(self: ptr cQTransposeProxyModel, slot: int, sourceIndex: pointer): pointer {.exportc: "miqt_exec_callback_QTransposeProxyModel_mapFromSource ".} =
  ...
  virtualReturn.h
proc QTransposeProxyModelmapToSource*(self: gen_qtransposeproxymodel_types.QTransposeProxyModel, proxyIndex: QModelIndex): QModelIndex =
  QModelIndex(h: fQTransposeProxyModel_virtualbase_mapToSource(self.h, proxyIndex.h))

type QTransposeProxyModelmapToSourceProc* = proc(proxyIndex: QModelIndex): QModelIndex
...
proc miqt_exec_callback_QTransposeProxyModel_mapToSource(self: ptr cQTransposeProxyModel, slot: int, proxyIndex: pointer): pointer {.exportc: "miqt_exec_callback_QTransposeProxyModel_mapToSource ".} =
  ...
  virtualReturn.h
proc QTransposeProxyModelparent*(self: gen_qtransposeproxymodel_types.QTransposeProxyModel, index: QModelIndex): QModelIndex =
  QModelIndex(h: fQTransposeProxyModel_virtualbase_parent(self.h, index.h))

type QTransposeProxyModelparentProc* = proc(index: QModelIndex): QModelIndex
...
proc miqt_exec_callback_QTransposeProxyModel_parent(self: ptr cQTransposeProxyModel, slot: int, index: pointer): pointer {.exportc: "miqt_exec_callback_QTransposeProxyModel_parent ".} =
  ...
  virtualReturn.h
proc QTransposeProxyModelindex*(self: gen_qtransposeproxymodel_types.QTransposeProxyModel, row: cint, column: cint, parent: QModelIndex): QModelIndex =
  QModelIndex(h: fQTransposeProxyModel_virtualbase_index(self.h, row, column, parent.h))

type QTransposeProxyModelindexProc* = proc(row: cint, column: cint, parent: QModelIndex): QModelIndex
...
proc miqt_exec_callback_QTransposeProxyModel_index(self: ptr cQTransposeProxyModel, slot: int, row: cint, column: cint, parent: pointer): pointer {.exportc: "miqt_exec_callback_QTransposeProxyModel_index ".} =
  ...
  virtualReturn.h
proc QTransposeProxyModelinsertRows*(self: gen_qtransposeproxymodel_types.QTransposeProxyModel, row: cint, count: cint, parent: QModelIndex): bool =
  fQTransposeProxyModel_virtualbase_insertRows(self.h, row, count, parent.h)

type QTransposeProxyModelinsertRowsProc* = proc(row: cint, count: cint, parent: QModelIndex): bool
...
proc miqt_exec_callback_QTransposeProxyModel_insertRows(self: ptr cQTransposeProxyModel, slot: int, row: cint, count: cint, parent: pointer): bool {.exportc: "miqt_exec_callback_QTransposeProxyModel_insertRows ".} =
  ...
  virtualReturn
proc QTransposeProxyModelremoveRows*(self: gen_qtransposeproxymodel_types.QTransposeProxyModel, row: cint, count: cint, parent: QModelIndex): bool =
  fQTransposeProxyModel_virtualbase_removeRows(self.h, row, count, parent.h)

type QTransposeProxyModelremoveRowsProc* = proc(row: cint, count: cint, parent: QModelIndex): bool
...
proc miqt_exec_callback_QTransposeProxyModel_removeRows(self: ptr cQTransposeProxyModel, slot: int, row: cint, count: cint, parent: pointer): bool {.exportc: "miqt_exec_callback_QTransposeProxyModel_removeRows ".} =
  ...
  virtualReturn
proc QTransposeProxyModelmoveRows*(self: gen_qtransposeproxymodel_types.QTransposeProxyModel, sourceParent: QModelIndex, sourceRow: cint, count: cint, destinationParent: QModelIndex, destinationChild: cint): bool =
  fQTransposeProxyModel_virtualbase_moveRows(self.h, sourceParent.h, sourceRow, count, destinationParent.h, destinationChild)

type QTransposeProxyModelmoveRowsProc* = proc(sourceParent: QModelIndex, sourceRow: cint, count: cint, destinationParent: QModelIndex, destinationChild: cint): bool
...
proc miqt_exec_callback_QTransposeProxyModel_moveRows(self: ptr cQTransposeProxyModel, slot: int, sourceParent: pointer, sourceRow: cint, count: cint, destinationParent: pointer, destinationChild: cint): bool {.exportc: "miqt_exec_callback_QTransposeProxyModel_moveRows ".} =
  ...
  virtualReturn
proc QTransposeProxyModelinsertColumns*(self: gen_qtransposeproxymodel_types.QTransposeProxyModel, column: cint, count: cint, parent: QModelIndex): bool =
  fQTransposeProxyModel_virtualbase_insertColumns(self.h, column, count, parent.h)

type QTransposeProxyModelinsertColumnsProc* = proc(column: cint, count: cint, parent: QModelIndex): bool
...
proc miqt_exec_callback_QTransposeProxyModel_insertColumns(self: ptr cQTransposeProxyModel, slot: int, column: cint, count: cint, parent: pointer): bool {.exportc: "miqt_exec_callback_QTransposeProxyModel_insertColumns ".} =
  ...
  virtualReturn
proc QTransposeProxyModelremoveColumns*(self: gen_qtransposeproxymodel_types.QTransposeProxyModel, column: cint, count: cint, parent: QModelIndex): bool =
  fQTransposeProxyModel_virtualbase_removeColumns(self.h, column, count, parent.h)

type QTransposeProxyModelremoveColumnsProc* = proc(column: cint, count: cint, parent: QModelIndex): bool
...
proc miqt_exec_callback_QTransposeProxyModel_removeColumns(self: ptr cQTransposeProxyModel, slot: int, column: cint, count: cint, parent: pointer): bool {.exportc: "miqt_exec_callback_QTransposeProxyModel_removeColumns ".} =
  ...
  virtualReturn
proc QTransposeProxyModelmoveColumns*(self: gen_qtransposeproxymodel_types.QTransposeProxyModel, sourceParent: QModelIndex, sourceColumn: cint, count: cint, destinationParent: QModelIndex, destinationChild: cint): bool =
...
type QTransposeProxyModelmoveColumnsProc* = proc(sourceParent: QModelIndex, sourceColumn: cint, count: cint, destinationParent: QModelIndex, destinationChild: cint): bool
...
proc QTransposeProxyModelmapSelectionToSource*(self: gen_qtransposeproxymodel_types.QTransposeProxyModel, selection: QItemSelection): QItemSelection =
  QItemSelection(h: fQTransposeProxyModel_virtualbase_mapSelectionToSource(self.h, selection.h))

type QTransposeProxyModelmapSelectionToSourceProc* = proc(selection: QItemSelection): QItemSelection
...
proc miqt_exec_callback_QTransposeProxyModel_mapSelectionToSource(self: ptr cQTransposeProxyModel, slot: int, selection: pointer): pointer {.exportc: "miqt_exec_callback_QTransposeProxyModel_mapSelectionToSource ".} =
  ...
  virtualReturn.h
proc QTransposeProxyModelmapSelectionFromSource*(self: gen_qtransposeproxymodel_types.QTransposeProxyModel, selection: QItemSelection): QItemSelection =
  QItemSelection(h: fQTransposeProxyModel_virtualbase_mapSelectionFromSource(self.h, selection.h))

type QTransposeProxyModelmapSelectionFromSourceProc* = proc(selection: QItemSelection): QItemSelection
...
proc miqt_exec_callback_QTransposeProxyModel_revert(self: ptr cQTransposeProxyModel, slot: int): void {.exportc: "miqt_exec_callback_QTransposeProxyModel_revert ".} =
  ...
  nimfunc[]()
proc QTransposeProxyModeldata*(self: gen_qtransposeproxymodel_types.QTransposeProxyModel, proxyIndex: QModelIndex, role: cint): QVariant =
  QVariant(h: fQTransposeProxyModel_virtualbase_data(self.h, proxyIndex.h, role))

type QTransposeProxyModeldataProc* = proc(proxyIndex: QModelIndex, role: cint): QVariant
...
proc miqt_exec_callback_QTransposeProxyModel_data(self: ptr cQTransposeProxyModel, slot: int, proxyIndex: pointer, role: cint): pointer {.exportc: "miqt_exec_callback_QTransposeProxyModel_data ".} =
  ...
  virtualReturn.h
proc QTransposeProxyModelflags*(self: gen_qtransposeproxymodel_types.QTransposeProxyModel, index: QModelIndex): cint =
  cint(fQTransposeProxyModel_virtualbase_flags(self.h, index.h))

type QTransposeProxyModelflagsProc* = proc(index: QModelIndex): cint
...
proc miqt_exec_callback_QTransposeProxyModel_flags(self: ptr cQTransposeProxyModel, slot: int, index: pointer): cint {.exportc: "miqt_exec_callback_QTransposeProxyModel_flags ".} =
  ...
  cint(virtualReturn)
proc QTransposeProxyModelsetData*(self: gen_qtransposeproxymodel_types.QTransposeProxyModel, index: QModelIndex, value: QVariant, role: cint): bool =
  fQTransposeProxyModel_virtualbase_setData(self.h, index.h, value.h, role)

type QTransposeProxyModelsetDataProc* = proc(index: QModelIndex, value: QVariant, role: cint): bool
...
proc miqt_exec_callback_QTransposeProxyModel_setData(self: ptr cQTransposeProxyModel, slot: int, index: pointer, value: pointer, role: cint): bool {.exportc: "miqt_exec_callback_QTransposeProxyModel_setData ".} =
  ...
  virtualReturn
proc QTransposeProxyModelclearItemData*(self: gen_qtransposeproxymodel_types.QTransposeProxyModel, index: QModelIndex): bool =
  fQTransposeProxyModel_virtualbase_clearItemData(self.h, index.h)

type QTransposeProxyModelclearItemDataProc* = proc(index: QModelIndex): bool
proc onclearItemData*(self: gen_qtransposeproxymodel_types.QTransposeProxyModel, slot: QTransposeProxyModelclearItemDataProc) =
  # TODO check subclass
  var tmp = new QTransposeProxyModelclearItemDataProc
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QTransposeProxyModel_clearItemData(self: ptr cQTransposeProxyModel, slot: int, index: pointer): bool {.exportc: "miqt_exec_callback_QTransposeProxyModel_clearItemData ".} =
  var nimfunc = cast[ptr QTransposeProxyModelclearItemDataProc](cast[pointer](slot))
  let slotval1 = QModelIndex(h: index)
  ...
  virtualReturn
proc QTransposeProxyModelbuddy*(self: gen_qtransposeproxymodel_types.QTransposeProxyModel, index: QModelIndex): QModelIndex =
  QModelIndex(h: fQTransposeProxyModel_virtualbase_buddy(self.h, index.h))

type QTransposeProxyModelbuddyProc* = proc(index: QModelIndex): QModelIndex
...
proc miqt_exec_callback_QTransposeProxyModel_buddy(self: ptr cQTransposeProxyModel, slot: int, index: pointer): pointer {.exportc: "miqt_exec_callback_QTransposeProxyModel_buddy ".} =
  ...
  virtualReturn.h
proc QTransposeProxyModelcanFetchMore*(self: gen_qtransposeproxymodel_types.QTransposeProxyModel, parent: QModelIndex): bool =
  fQTransposeProxyModel_virtualbase_canFetchMore(self.h, parent.h)

type QTransposeProxyModelcanFetchMoreProc* = proc(parent: QModelIndex): bool
...
proc miqt_exec_callback_QTransposeProxyModel_canFetchMore(self: ptr cQTransposeProxyModel, slot: int, parent: pointer): bool {.exportc: "miqt_exec_callback_QTransposeProxyModel_canFetchMore ".} =
  ...
  virtualReturn
proc QTransposeProxyModelfetchMore*(self: gen_qtransposeproxymodel_types.QTransposeProxyModel, parent: QModelIndex): void =
  fQTransposeProxyModel_virtualbase_fetchMore(self.h, parent.h)

type QTransposeProxyModelfetchMoreProc* = proc(parent: QModelIndex): void
...
proc miqt_exec_callback_QTransposeProxyModel_fetchMore(self: ptr cQTransposeProxyModel, slot: int, parent: pointer): void {.exportc: "miqt_exec_callback_QTransposeProxyModel_fetchMore ".} =
  ...
  nimfunc[](slotval1)
proc QTransposeProxyModelhasChildren*(self: gen_qtransposeproxymodel_types.QTransposeProxyModel, parent: QModelIndex): bool =
  fQTransposeProxyModel_virtualbase_hasChildren(self.h, parent.h)

type QTransposeProxyModelhasChildrenProc* = proc(parent: QModelIndex): bool
...
proc miqt_exec_callback_QTransposeProxyModel_hasChildren(self: ptr cQTransposeProxyModel, slot: int, parent: pointer): bool {.exportc: "miqt_exec_callback_QTransposeProxyModel_hasChildren ".} =
  ...
  virtualReturn
proc QTransposeProxyModelsibling*(self: gen_qtransposeproxymodel_types.QTransposeProxyModel, row: cint, column: cint, idx: QModelIndex): QModelIndex =
  QModelIndex(h: fQTransposeProxyModel_virtualbase_sibling(self.h, row, column, idx.h))

type QTransposeProxyModelsiblingProc* = proc(row: cint, column: cint, idx: QModelIndex): QModelIndex
...
proc miqt_exec_callback_QTransposeProxyModel_sibling(self: ptr cQTransposeProxyModel, slot: int, row: cint, column: cint, idx: pointer): pointer {.exportc: "miqt_exec_callback_QTransposeProxyModel_sibling ".} =
  ...
  virtualReturn.h
proc QTransposeProxyModelmimeData*(self: gen_qtransposeproxymodel_types.QTransposeProxyModel, indexes: seq[QModelIndex]): QMimeData =
  var indexes_CArray = newSeq[pointer](len(indexes))
  for i in 0..<len(indexes):
    indexes_CArray[i] = indexes[i].h

  QMimeData(h: fQTransposeProxyModel_virtualbase_mimeData(self.h, struct_miqt_array(len: csize_t(len(indexes)), data: if len(indexes) == 0: nil else: addr(indexes_CArray[0]))))

type QTransposeProxyModelmimeDataProc* = proc(indexes: seq[QModelIndex]): QMimeData
...
proc miqt_exec_callback_QTransposeProxyModel_mimeData(self: ptr cQTransposeProxyModel, slot: int, indexes: struct_miqt_array): pointer {.exportc: "miqt_exec_callback_QTransposeProxyModel_mimeData ".} =
  ...
  virtualReturn.h
proc QTransposeProxyModelcanDropMimeData*(self: gen_qtransposeproxymodel_types.QTransposeProxyModel, data: QMimeData, action: cint, row: cint, column: cint, parent: QModelIndex): bool =
  fQTransposeProxyModel_virtualbase_canDropMimeData(self.h, data.h, cint(action), row, column, parent.h)

type QTransposeProxyModelcanDropMimeDataProc* = proc(data: QMimeData, action: cint, row: cint, column: cint, parent: QModelIndex): bool
...
proc miqt_exec_callback_QTransposeProxyModel_canDropMimeData(self: ptr cQTransposeProxyModel, slot: int, data: pointer, action: cint, row: cint, column: cint, parent: pointer): bool {.exportc: "miqt_exec_callback_QTransposeProxyModel_canDropMimeData ".} =
  ...
  virtualReturn
proc QTransposeProxyModeldropMimeData*(self: gen_qtransposeproxymodel_types.QTransposeProxyModel, data: QMimeData, action: cint, row: cint, column: cint, parent: QModelIndex): bool =
  fQTransposeProxyModel_virtualbase_dropMimeData(self.h, data.h, cint(action), row, column, parent.h)

type QTransposeProxyModeldropMimeDataProc* = proc(data: QMimeData, action: cint, row: cint, column: cint, parent: QModelIndex): bool
...
proc miqt_exec_callback_QTransposeProxyModel_roleNames(self: ptr cQTransposeProxyModel, slot: int): struct_miqt_map {.exportc: "miqt_exec_callback_QTransposeProxyModel_roleNames ".} =
  ...
  struct_miqt_map(len: csize_t(len(virtualReturn)),keys: if len(virtualReturn) == 0: nil else: addr(virtualReturn_Keys_CArray[0]), values: if len(virtualReturn) == 0: nil else: addr(virtualReturn_Values_CArray[0]),)
proc QTransposeProxyModelmatch*(self: gen_qtransposeproxymodel_types.QTransposeProxyModel, start: QModelIndex, role: cint, value: QVariant, hits: cint, flags: cint): seq[QModelIndex] =
...
type QTransposeProxyModelmatchProc* = proc(start: QModelIndex, role: cint, value: QVariant, hits: cint, flags: cint): seq[QModelIndex]
...
proc miqt_exec_callback_QTransposeProxyModel_match(self: ptr cQTransposeProxyModel, slot: int, start: pointer, role: cint, value: pointer, hits: cint, flags: cint): struct_miqt_array {.exportc: "miqt_exec_callback_QTransposeProxyModel_match ".} =
  ...
  struct_miqt_array(len: csize_t(len(virtualReturn)), data: if len(virtualReturn) == 0: nil else: addr(virtualReturn_CArray[0]))
proc QTransposeProxyModelmultiData*(self: gen_qtransposeproxymodel_types.QTransposeProxyModel, index: QModelIndex, roleDataSpan: QModelRoleDataSpan): void =
  fQTransposeProxyModel_virtualbase_multiData(self.h, index.h, roleDataSpan.h)

type QTransposeProxyModelmultiDataProc* = proc(index: QModelIndex, roleDataSpan: QModelRoleDataSpan): void
proc onmultiData*(self: gen_qtransposeproxymodel_types.QTransposeProxyModel, slot: QTransposeProxyModelmultiDataProc) =
  # TODO check subclass
  var tmp = new QTransposeProxyModelmultiDataProc
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QTransposeProxyModel_multiData(self: ptr cQTransposeProxyModel, slot: int, index: pointer, roleDataSpan: pointer): void {.exportc: "miqt_exec_callback_QTransposeProxyModel_multiData ".} =
  var nimfunc = cast[ptr QTransposeProxyModelmultiDataProc](cast[pointer](slot))
  let slotval1 = QModelIndex(h: index)
...
type QTransposeProxyModelresetInternalDataProc* = proc(): void
proc onresetInternalData*(self: gen_qtransposeproxymodel_types.QTransposeProxyModel, slot: QTransposeProxyModelresetInternalDataProc) =
  # TODO check subclass
  var tmp = new QTransposeProxyModelresetInternalDataProc
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QTransposeProxyModel_resetInternalData(self: ptr cQTransposeProxyModel, slot: int): void {.exportc: "miqt_exec_callback_QTransposeProxyModel_resetInternalData ".} =
  var nimfunc = cast[ptr QTransposeProxyModelresetInternalDataProc](cast[pointer](slot))

  nimfunc[]()
proc QTransposeProxyModelevent*(self: gen_qtransposeproxymodel_types.QTransposeProxyModel, event: QEvent): bool =
  fQTransposeProxyModel_virtualbase_event(self.h, event.h)

type QTransposeProxyModeleventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QTransposeProxyModel_event(self: ptr cQTransposeProxyModel, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QTransposeProxyModel_event ".} =
  ...
  virtualReturn
proc QTransposeProxyModeleventFilter*(self: gen_qtransposeproxymodel_types.QTransposeProxyModel, watched: QObject, event: QEvent): bool =
  fQTransposeProxyModel_virtualbase_eventFilter(self.h, watched.h, event.h)

type QTransposeProxyModeleventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QTransposeProxyModel_eventFilter(self: ptr cQTransposeProxyModel, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QTransposeProxyModel_eventFilter ".} =
  ...
  virtualReturn
proc QTransposeProxyModeltimerEvent*(self: gen_qtransposeproxymodel_types.QTransposeProxyModel, event: QTimerEvent): void =
  fQTransposeProxyModel_virtualbase_timerEvent(self.h, event.h)

type QTransposeProxyModeltimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QTransposeProxyModel_timerEvent(self: ptr cQTransposeProxyModel, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTransposeProxyModel_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTransposeProxyModelchildEvent*(self: gen_qtransposeproxymodel_types.QTransposeProxyModel, event: QChildEvent): void =
  fQTransposeProxyModel_virtualbase_childEvent(self.h, event.h)

type QTransposeProxyModelchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QTransposeProxyModel_childEvent(self: ptr cQTransposeProxyModel, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTransposeProxyModel_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTransposeProxyModelcustomEvent*(self: gen_qtransposeproxymodel_types.QTransposeProxyModel, event: QEvent): void =
  fQTransposeProxyModel_virtualbase_customEvent(self.h, event.h)

type QTransposeProxyModelcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QTransposeProxyModel_customEvent(self: ptr cQTransposeProxyModel, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTransposeProxyModel_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTransposeProxyModelconnectNotify*(self: gen_qtransposeproxymodel_types.QTransposeProxyModel, signal: QMetaMethod): void =
  fQTransposeProxyModel_virtualbase_connectNotify(self.h, signal.h)

type QTransposeProxyModelconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QTransposeProxyModel_connectNotify(self: ptr cQTransposeProxyModel, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QTransposeProxyModel_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QTransposeProxyModeldisconnectNotify*(self: gen_qtransposeproxymodel_types.QTransposeProxyModel, signal: QMetaMethod): void =
  fQTransposeProxyModel_virtualbase_disconnectNotify(self.h, signal.h)

type QTransposeProxyModeldisconnectNotifyProc* = proc(signal: QMetaMethod): void
