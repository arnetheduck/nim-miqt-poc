...
proc create*(T: type gen_qresource_types.QResource, file: string, locale: QLocale): gen_qresource_types.QResource =
...
proc setLocale*(self: gen_qresource_types.QResource, locale: QLocale): void =
  fcQResource_setLocale(self.h, locale.h)

proc locale*(self: gen_qresource_types.QResource, ): QLocale =
  QLocale(h: fcQResource_locale(self.h))
...
proc lastModified*(self: gen_qresource_types.QResource, ): QDateTime =
  QDateTime(h: fcQResource_lastModified(self.h))
