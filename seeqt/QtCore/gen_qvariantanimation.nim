...
proc create*(T: type gen_qvariantanimation_types.QVariantAnimation, parent: QObject): gen_qvariantanimation_types.QVariantAnimation =
  gen_qvariantanimation_types.QVariantAnimation.init(fcQVariantAnimation_new2(parent.h))

proc metaObject*(self: gen_qvariantanimation_types.QVariantAnimation, ): QMetaObject =
  QMetaObject(h: fcQVariantAnimation_metaObject(self.h))
...
proc startValue*(self: gen_qvariantanimation_types.QVariantAnimation, ): QVariant =
  QVariant(h: fcQVariantAnimation_startValue(self.h))

proc setStartValue*(self: gen_qvariantanimation_types.QVariantAnimation, value: QVariant): void =
  fcQVariantAnimation_setStartValue(self.h, value.h)

proc endValue*(self: gen_qvariantanimation_types.QVariantAnimation, ): QVariant =
  QVariant(h: fcQVariantAnimation_endValue(self.h))

proc setEndValue*(self: gen_qvariantanimation_types.QVariantAnimation, value: QVariant): void =
  fcQVariantAnimation_setEndValue(self.h, value.h)

proc keyValueAt*(self: gen_qvariantanimation_types.QVariantAnimation, step: float64): QVariant =
  QVariant(h: fcQVariantAnimation_keyValueAt(self.h, step))

proc setKeyValueAt*(self: gen_qvariantanimation_types.QVariantAnimation, step: float64, value: QVariant): void =
  fcQVariantAnimation_setKeyValueAt(self.h, step, value.h)

proc keyValues*(self: gen_qvariantanimation_types.QVariantAnimation, ): seq[tuple[first: float64, second: QVariant]] =
  var v_ma = fcQVariantAnimation_keyValues(self.h)
  var vx_ret = newSeq[tuple[first: float64, second: QVariant]](int(v_ma.len))
  ...
  for i in 0 ..< v_ma.len:
    ...
    var vx_lv_entry_Second = QVariant(h: vx_lv_Second_CArray[0])

    vx_ret[i] = (first: vx_lv_entry_First , second: vx_lv_entry_Second )
  vx_ret

proc setKeyValues*(self: gen_qvariantanimation_types.QVariantAnimation, values: seq[tuple[first: float64, second: QVariant]]): void =
...
proc currentValue*(self: gen_qvariantanimation_types.QVariantAnimation, ): QVariant =
  QVariant(h: fcQVariantAnimation_currentValue(self.h))
...
proc easingCurve*(self: gen_qvariantanimation_types.QVariantAnimation, ): QEasingCurve =
  QEasingCurve(h: fcQVariantAnimation_easingCurve(self.h))

proc setEasingCurve*(self: gen_qvariantanimation_types.QVariantAnimation, easing: QEasingCurve): void =
  fcQVariantAnimation_setEasingCurve(self.h, easing.h)

proc valueChanged*(self: gen_qvariantanimation_types.QVariantAnimation, value: QVariant): void =
  fcQVariantAnimation_valueChanged(self.h, value.h)

type QVariantAnimationvalueChangedSlot* = proc(value: QVariant)
...
proc miqt_exec_callback_QVariantAnimation_duration(self: ptr cQVariantAnimation, slot: int): cint {.exportc: "miqt_exec_callback_QVariantAnimation_duration ".} =
  ...
  virtualReturn
proc QVariantAnimationevent*(self: gen_qvariantanimation_types.QVariantAnimation, event: QEvent): bool =
  fQVariantAnimation_virtualbase_event(self.h, event.h)

type QVariantAnimationeventProc* = proc(event: QEvent): bool
...
proc QVariantAnimationupdateCurrentValue*(self: gen_qvariantanimation_types.QVariantAnimation, value: QVariant): void =
  fQVariantAnimation_virtualbase_updateCurrentValue(self.h, value.h)

type QVariantAnimationupdateCurrentValueProc* = proc(value: QVariant): void
...
proc miqt_exec_callback_QVariantAnimation_updateCurrentValue(self: ptr cQVariantAnimation, slot: int, value: pointer): void {.exportc: "miqt_exec_callback_QVariantAnimation_updateCurrentValue ".} =
  ...
  nimfunc[](slotval1)
proc QVariantAnimationinterpolated*(self: gen_qvariantanimation_types.QVariantAnimation, fromVal: QVariant, to: QVariant, progress: float64): QVariant =
  QVariant(h: fQVariantAnimation_virtualbase_interpolated(self.h, fromVal.h, to.h, progress))

type QVariantAnimationinterpolatedProc* = proc(fromVal: QVariant, to: QVariant, progress: float64): QVariant
...
proc miqt_exec_callback_QVariantAnimation_interpolated(self: ptr cQVariantAnimation, slot: int, fromVal: pointer, to: pointer, progress: float64): pointer {.exportc: "miqt_exec_callback_QVariantAnimation_interpolated ".} =
  ...
  let slotval1 = QVariant(h: fromVal)

  let slotval2 = QVariant(h: to)
...
proc miqt_exec_callback_QVariantAnimation_updateDirection(self: ptr cQVariantAnimation, slot: int, direction: cint): void {.exportc: "miqt_exec_callback_QVariantAnimation_updateDirection ".} =
  ...
  nimfunc[](slotval1)
proc QVariantAnimationeventFilter*(self: gen_qvariantanimation_types.QVariantAnimation, watched: QObject, event: QEvent): bool =
  fQVariantAnimation_virtualbase_eventFilter(self.h, watched.h, event.h)

type QVariantAnimationeventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QVariantAnimation_eventFilter(self: ptr cQVariantAnimation, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QVariantAnimation_eventFilter ".} =
  ...
  virtualReturn
proc QVariantAnimationtimerEvent*(self: gen_qvariantanimation_types.QVariantAnimation, event: QTimerEvent): void =
  fQVariantAnimation_virtualbase_timerEvent(self.h, event.h)

type QVariantAnimationtimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QVariantAnimation_timerEvent(self: ptr cQVariantAnimation, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QVariantAnimation_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QVariantAnimationchildEvent*(self: gen_qvariantanimation_types.QVariantAnimation, event: QChildEvent): void =
  fQVariantAnimation_virtualbase_childEvent(self.h, event.h)

type QVariantAnimationchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QVariantAnimation_childEvent(self: ptr cQVariantAnimation, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QVariantAnimation_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QVariantAnimationcustomEvent*(self: gen_qvariantanimation_types.QVariantAnimation, event: QEvent): void =
  fQVariantAnimation_virtualbase_customEvent(self.h, event.h)

type QVariantAnimationcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QVariantAnimation_customEvent(self: ptr cQVariantAnimation, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QVariantAnimation_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QVariantAnimationconnectNotify*(self: gen_qvariantanimation_types.QVariantAnimation, signal: QMetaMethod): void =
  fQVariantAnimation_virtualbase_connectNotify(self.h, signal.h)

type QVariantAnimationconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QVariantAnimation_connectNotify(self: ptr cQVariantAnimation, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QVariantAnimation_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QVariantAnimationdisconnectNotify*(self: gen_qvariantanimation_types.QVariantAnimation, signal: QMetaMethod): void =
  fQVariantAnimation_virtualbase_disconnectNotify(self.h, signal.h)

type QVariantAnimationdisconnectNotifyProc* = proc(signal: QMetaMethod): void
