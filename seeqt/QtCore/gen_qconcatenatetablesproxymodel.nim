...
proc create*(T: type gen_qconcatenatetablesproxymodel_types.QConcatenateTablesProxyModel, parent: QObject): gen_qconcatenatetablesproxymodel_types.QConcatenateTablesProxyModel =
  gen_qconcatenatetablesproxymodel_types.QConcatenateTablesProxyModel.init(fcQConcatenateTablesProxyModel_new2(parent.h))

proc metaObject*(self: gen_qconcatenatetablesproxymodel_types.QConcatenateTablesProxyModel, ): QMetaObject =
  QMetaObject(h: fcQConcatenateTablesProxyModel_metaObject(self.h))
...
proc sourceModels*(self: gen_qconcatenatetablesproxymodel_types.QConcatenateTablesProxyModel, ): seq[QAbstractItemModel] =
  var v_ma = fcQConcatenateTablesProxyModel_sourceModels(self.h)
  var vx_ret = newSeq[QAbstractItemModel](int(v_ma.len))
  let v_outCast = cast[ptr UncheckedArray[pointer]](v_ma.data)
  for i in 0 ..< v_ma.len:
    vx_ret[i] = QAbstractItemModel(h: v_outCast[i])
  vx_ret

proc addSourceModel*(self: gen_qconcatenatetablesproxymodel_types.QConcatenateTablesProxyModel, sourceModel: QAbstractItemModel): void =
  fcQConcatenateTablesProxyModel_addSourceModel(self.h, sourceModel.h)

proc removeSourceModel*(self: gen_qconcatenatetablesproxymodel_types.QConcatenateTablesProxyModel, sourceModel: QAbstractItemModel): void =
  fcQConcatenateTablesProxyModel_removeSourceModel(self.h, sourceModel.h)

proc mapFromSource*(self: gen_qconcatenatetablesproxymodel_types.QConcatenateTablesProxyModel, sourceIndex: QModelIndex): QModelIndex =
  QModelIndex(h: fcQConcatenateTablesProxyModel_mapFromSource(self.h, sourceIndex.h))

proc mapToSource*(self: gen_qconcatenatetablesproxymodel_types.QConcatenateTablesProxyModel, proxyIndex: QModelIndex): QModelIndex =
  QModelIndex(h: fcQConcatenateTablesProxyModel_mapToSource(self.h, proxyIndex.h))

proc data*(self: gen_qconcatenatetablesproxymodel_types.QConcatenateTablesProxyModel, index: QModelIndex, role: cint): QVariant =
  QVariant(h: fcQConcatenateTablesProxyModel_data(self.h, index.h, role))

proc setData*(self: gen_qconcatenatetablesproxymodel_types.QConcatenateTablesProxyModel, index: QModelIndex, value: QVariant, role: cint): bool =
  fcQConcatenateTablesProxyModel_setData(self.h, index.h, value.h, role)

proc itemData*(self: gen_qconcatenatetablesproxymodel_types.QConcatenateTablesProxyModel, proxyIndex: QModelIndex): Table[cint,QVariant] =
...
proc setItemData*(self: gen_qconcatenatetablesproxymodel_types.QConcatenateTablesProxyModel, index: QModelIndex, roles: Table[cint,QVariant]): bool =
...
proc flags*(self: gen_qconcatenatetablesproxymodel_types.QConcatenateTablesProxyModel, index: QModelIndex): cint =
  cint(fcQConcatenateTablesProxyModel_flags(self.h, index.h))

proc index*(self: gen_qconcatenatetablesproxymodel_types.QConcatenateTablesProxyModel, row: cint, column: cint, parent: QModelIndex): QModelIndex =
  QModelIndex(h: fcQConcatenateTablesProxyModel_index(self.h, row, column, parent.h))

proc parent*(self: gen_qconcatenatetablesproxymodel_types.QConcatenateTablesProxyModel, index: QModelIndex): QModelIndex =
  QModelIndex(h: fcQConcatenateTablesProxyModel_parent(self.h, index.h))

proc rowCount*(self: gen_qconcatenatetablesproxymodel_types.QConcatenateTablesProxyModel, parent: QModelIndex): cint =
  fcQConcatenateTablesProxyModel_rowCount(self.h, parent.h)

proc headerData*(self: gen_qconcatenatetablesproxymodel_types.QConcatenateTablesProxyModel, section: cint, orientation: cint, role: cint): QVariant =
  QVariant(h: fcQConcatenateTablesProxyModel_headerData(self.h, section, cint(orientation), role))

proc columnCount*(self: gen_qconcatenatetablesproxymodel_types.QConcatenateTablesProxyModel, parent: QModelIndex): cint =
...
proc mimeData*(self: gen_qconcatenatetablesproxymodel_types.QConcatenateTablesProxyModel, indexes: seq[QModelIndex]): QMimeData =
  var indexes_CArray = newSeq[pointer](len(indexes))
  for i in 0..<len(indexes):
    indexes_CArray[i] = indexes[i].h

  QMimeData(h: fcQConcatenateTablesProxyModel_mimeData(self.h, struct_miqt_array(len: csize_t(len(indexes)), data: if len(indexes) == 0: nil else: addr(indexes_CArray[0]))))

proc canDropMimeData*(self: gen_qconcatenatetablesproxymodel_types.QConcatenateTablesProxyModel, data: QMimeData, action: cint, row: cint, column: cint, parent: QModelIndex): bool =
  fcQConcatenateTablesProxyModel_canDropMimeData(self.h, data.h, cint(action), row, column, parent.h)

proc dropMimeData*(self: gen_qconcatenatetablesproxymodel_types.QConcatenateTablesProxyModel, data: QMimeData, action: cint, row: cint, column: cint, parent: QModelIndex): bool =
  fcQConcatenateTablesProxyModel_dropMimeData(self.h, data.h, cint(action), row, column, parent.h)

proc span*(self: gen_qconcatenatetablesproxymodel_types.QConcatenateTablesProxyModel, index: QModelIndex): QSize =
  QSize(h: fcQConcatenateTablesProxyModel_span(self.h, index.h))
...
proc miqt_exec_callback_QConcatenateTablesProxyModel_metacall(self: ptr cQConcatenateTablesProxyModel, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QConcatenateTablesProxyModel_metacall ".} =
  ...
  virtualReturn
proc QConcatenateTablesProxyModeldata*(self: gen_qconcatenatetablesproxymodel_types.QConcatenateTablesProxyModel, index: QModelIndex, role: cint): QVariant =
  QVariant(h: fQConcatenateTablesProxyModel_virtualbase_data(self.h, index.h, role))

type QConcatenateTablesProxyModeldataProc* = proc(index: QModelIndex, role: cint): QVariant
...
proc miqt_exec_callback_QConcatenateTablesProxyModel_data(self: ptr cQConcatenateTablesProxyModel, slot: int, index: pointer, role: cint): pointer {.exportc: "miqt_exec_callback_QConcatenateTablesProxyModel_data ".} =
  ...
  virtualReturn.h
proc QConcatenateTablesProxyModelsetData*(self: gen_qconcatenatetablesproxymodel_types.QConcatenateTablesProxyModel, index: QModelIndex, value: QVariant, role: cint): bool =
  fQConcatenateTablesProxyModel_virtualbase_setData(self.h, index.h, value.h, role)

type QConcatenateTablesProxyModelsetDataProc* = proc(index: QModelIndex, value: QVariant, role: cint): bool
...
proc miqt_exec_callback_QConcatenateTablesProxyModel_setData(self: ptr cQConcatenateTablesProxyModel, slot: int, index: pointer, value: pointer, role: cint): bool {.exportc: "miqt_exec_callback_QConcatenateTablesProxyModel_setData ".} =
  ...
  virtualReturn
proc QConcatenateTablesProxyModelitemData*(self: gen_qconcatenatetablesproxymodel_types.QConcatenateTablesProxyModel, proxyIndex: QModelIndex): Table[cint,QVariant] =
...
type QConcatenateTablesProxyModelitemDataProc* = proc(proxyIndex: QModelIndex): Table[cint,QVariant]
...
proc QConcatenateTablesProxyModelsetItemData*(self: gen_qconcatenatetablesproxymodel_types.QConcatenateTablesProxyModel, index: QModelIndex, roles: Table[cint,QVariant]): bool =
  var roles_Keys_CArray = newSeq[cint](len(roles))
  var roles_Values_CArray = newSeq[pointer](len(roles))
  var roles_ctr = 0
  for rolesk, rolesv in roles:
...
type QConcatenateTablesProxyModelsetItemDataProc* = proc(index: QModelIndex, roles: Table[cint,QVariant]): bool
...
proc miqt_exec_callback_QConcatenateTablesProxyModel_setItemData(self: ptr cQConcatenateTablesProxyModel, slot: int, index: pointer, roles: struct_miqt_map): bool {.exportc: "miqt_exec_callback_QConcatenateTablesProxyModel_setItemData ".} =
  ...
  virtualReturn
proc QConcatenateTablesProxyModelflags*(self: gen_qconcatenatetablesproxymodel_types.QConcatenateTablesProxyModel, index: QModelIndex): cint =
  cint(fQConcatenateTablesProxyModel_virtualbase_flags(self.h, index.h))

type QConcatenateTablesProxyModelflagsProc* = proc(index: QModelIndex): cint
...
proc miqt_exec_callback_QConcatenateTablesProxyModel_flags(self: ptr cQConcatenateTablesProxyModel, slot: int, index: pointer): cint {.exportc: "miqt_exec_callback_QConcatenateTablesProxyModel_flags ".} =
  ...
  cint(virtualReturn)
proc QConcatenateTablesProxyModelindex*(self: gen_qconcatenatetablesproxymodel_types.QConcatenateTablesProxyModel, row: cint, column: cint, parent: QModelIndex): QModelIndex =
  QModelIndex(h: fQConcatenateTablesProxyModel_virtualbase_index(self.h, row, column, parent.h))

type QConcatenateTablesProxyModelindexProc* = proc(row: cint, column: cint, parent: QModelIndex): QModelIndex
...
proc miqt_exec_callback_QConcatenateTablesProxyModel_index(self: ptr cQConcatenateTablesProxyModel, slot: int, row: cint, column: cint, parent: pointer): pointer {.exportc: "miqt_exec_callback_QConcatenateTablesProxyModel_index ".} =
  ...
  virtualReturn.h
proc QConcatenateTablesProxyModelparent*(self: gen_qconcatenatetablesproxymodel_types.QConcatenateTablesProxyModel, index: QModelIndex): QModelIndex =
  QModelIndex(h: fQConcatenateTablesProxyModel_virtualbase_parent(self.h, index.h))

type QConcatenateTablesProxyModelparentProc* = proc(index: QModelIndex): QModelIndex
...
proc miqt_exec_callback_QConcatenateTablesProxyModel_parent(self: ptr cQConcatenateTablesProxyModel, slot: int, index: pointer): pointer {.exportc: "miqt_exec_callback_QConcatenateTablesProxyModel_parent ".} =
  ...
  virtualReturn.h
proc QConcatenateTablesProxyModelrowCount*(self: gen_qconcatenatetablesproxymodel_types.QConcatenateTablesProxyModel, parent: QModelIndex): cint =
  fQConcatenateTablesProxyModel_virtualbase_rowCount(self.h, parent.h)

type QConcatenateTablesProxyModelrowCountProc* = proc(parent: QModelIndex): cint
...
proc miqt_exec_callback_QConcatenateTablesProxyModel_rowCount(self: ptr cQConcatenateTablesProxyModel, slot: int, parent: pointer): cint {.exportc: "miqt_exec_callback_QConcatenateTablesProxyModel_rowCount ".} =
  ...
  virtualReturn
proc QConcatenateTablesProxyModelheaderData*(self: gen_qconcatenatetablesproxymodel_types.QConcatenateTablesProxyModel, section: cint, orientation: cint, role: cint): QVariant =
  QVariant(h: fQConcatenateTablesProxyModel_virtualbase_headerData(self.h, section, cint(orientation), role))

type QConcatenateTablesProxyModelheaderDataProc* = proc(section: cint, orientation: cint, role: cint): QVariant
...
proc miqt_exec_callback_QConcatenateTablesProxyModel_headerData(self: ptr cQConcatenateTablesProxyModel, slot: int, section: cint, orientation: cint, role: cint): pointer {.exportc: "miqt_exec_callback_QConcatenateTablesProxyModel_headerData ".} =
  ...
  virtualReturn.h
proc QConcatenateTablesProxyModelcolumnCount*(self: gen_qconcatenatetablesproxymodel_types.QConcatenateTablesProxyModel, parent: QModelIndex): cint =
  fQConcatenateTablesProxyModel_virtualbase_columnCount(self.h, parent.h)

type QConcatenateTablesProxyModelcolumnCountProc* = proc(parent: QModelIndex): cint
...
proc QConcatenateTablesProxyModelmimeData*(self: gen_qconcatenatetablesproxymodel_types.QConcatenateTablesProxyModel, indexes: seq[QModelIndex]): QMimeData =
  var indexes_CArray = newSeq[pointer](len(indexes))
  for i in 0..<len(indexes):
    indexes_CArray[i] = indexes[i].h

  QMimeData(h: fQConcatenateTablesProxyModel_virtualbase_mimeData(self.h, struct_miqt_array(len: csize_t(len(indexes)), data: if len(indexes) == 0: nil else: addr(indexes_CArray[0]))))

type QConcatenateTablesProxyModelmimeDataProc* = proc(indexes: seq[QModelIndex]): QMimeData
...
proc miqt_exec_callback_QConcatenateTablesProxyModel_mimeData(self: ptr cQConcatenateTablesProxyModel, slot: int, indexes: struct_miqt_array): pointer {.exportc: "miqt_exec_callback_QConcatenateTablesProxyModel_mimeData ".} =
  ...
  virtualReturn.h
proc QConcatenateTablesProxyModelcanDropMimeData*(self: gen_qconcatenatetablesproxymodel_types.QConcatenateTablesProxyModel, data: QMimeData, action: cint, row: cint, column: cint, parent: QModelIndex): bool =
  fQConcatenateTablesProxyModel_virtualbase_canDropMimeData(self.h, data.h, cint(action), row, column, parent.h)

type QConcatenateTablesProxyModelcanDropMimeDataProc* = proc(data: QMimeData, action: cint, row: cint, column: cint, parent: QModelIndex): bool
...
proc miqt_exec_callback_QConcatenateTablesProxyModel_canDropMimeData(self: ptr cQConcatenateTablesProxyModel, slot: int, data: pointer, action: cint, row: cint, column: cint, parent: pointer): bool {.exportc: "miqt_exec_callback_QConcatenateTablesProxyModel_canDropMimeData ".} =
  ...
  virtualReturn
proc QConcatenateTablesProxyModeldropMimeData*(self: gen_qconcatenatetablesproxymodel_types.QConcatenateTablesProxyModel, data: QMimeData, action: cint, row: cint, column: cint, parent: QModelIndex): bool =
  fQConcatenateTablesProxyModel_virtualbase_dropMimeData(self.h, data.h, cint(action), row, column, parent.h)

type QConcatenateTablesProxyModeldropMimeDataProc* = proc(data: QMimeData, action: cint, row: cint, column: cint, parent: QModelIndex): bool
...
proc miqt_exec_callback_QConcatenateTablesProxyModel_dropMimeData(self: ptr cQConcatenateTablesProxyModel, slot: int, data: pointer, action: cint, row: cint, column: cint, parent: pointer): bool {.exportc: "miqt_exec_callback_QConcatenateTablesProxyModel_dropMimeData ".} =
  ...
  virtualReturn
proc QConcatenateTablesProxyModelspan*(self: gen_qconcatenatetablesproxymodel_types.QConcatenateTablesProxyModel, index: QModelIndex): QSize =
  QSize(h: fQConcatenateTablesProxyModel_virtualbase_span(self.h, index.h))

type QConcatenateTablesProxyModelspanProc* = proc(index: QModelIndex): QSize
...
proc miqt_exec_callback_QConcatenateTablesProxyModel_span(self: ptr cQConcatenateTablesProxyModel, slot: int, index: pointer): pointer {.exportc: "miqt_exec_callback_QConcatenateTablesProxyModel_span ".} =
  ...
  virtualReturn.h
proc QConcatenateTablesProxyModelsibling*(self: gen_qconcatenatetablesproxymodel_types.QConcatenateTablesProxyModel, row: cint, column: cint, idx: QModelIndex): QModelIndex =
  QModelIndex(h: fQConcatenateTablesProxyModel_virtualbase_sibling(self.h, row, column, idx.h))

type QConcatenateTablesProxyModelsiblingProc* = proc(row: cint, column: cint, idx: QModelIndex): QModelIndex
...
proc miqt_exec_callback_QConcatenateTablesProxyModel_sibling(self: ptr cQConcatenateTablesProxyModel, slot: int, row: cint, column: cint, idx: pointer): pointer {.exportc: "miqt_exec_callback_QConcatenateTablesProxyModel_sibling ".} =
  ...
  virtualReturn.h
proc QConcatenateTablesProxyModelhasChildren*(self: gen_qconcatenatetablesproxymodel_types.QConcatenateTablesProxyModel, parent: QModelIndex): bool =
  fQConcatenateTablesProxyModel_virtualbase_hasChildren(self.h, parent.h)

type QConcatenateTablesProxyModelhasChildrenProc* = proc(parent: QModelIndex): bool
...
proc miqt_exec_callback_QConcatenateTablesProxyModel_hasChildren(self: ptr cQConcatenateTablesProxyModel, slot: int, parent: pointer): bool {.exportc: "miqt_exec_callback_QConcatenateTablesProxyModel_hasChildren ".} =
  ...
  virtualReturn
proc QConcatenateTablesProxyModelsetHeaderData*(self: gen_qconcatenatetablesproxymodel_types.QConcatenateTablesProxyModel, section: cint, orientation: cint, value: QVariant, role: cint): bool =
  fQConcatenateTablesProxyModel_virtualbase_setHeaderData(self.h, section, cint(orientation), value.h, role)

type QConcatenateTablesProxyModelsetHeaderDataProc* = proc(section: cint, orientation: cint, value: QVariant, role: cint): bool
...
proc miqt_exec_callback_QConcatenateTablesProxyModel_setHeaderData(self: ptr cQConcatenateTablesProxyModel, slot: int, section: cint, orientation: cint, value: pointer, role: cint): bool {.exportc: "miqt_exec_callback_QConcatenateTablesProxyModel_setHeaderData ".} =
  ...
  virtualReturn
proc QConcatenateTablesProxyModelclearItemData*(self: gen_qconcatenatetablesproxymodel_types.QConcatenateTablesProxyModel, index: QModelIndex): bool =
  fQConcatenateTablesProxyModel_virtualbase_clearItemData(self.h, index.h)

type QConcatenateTablesProxyModelclearItemDataProc* = proc(index: QModelIndex): bool
...
proc miqt_exec_callback_QConcatenateTablesProxyModel_supportedDragActions(self: ptr cQConcatenateTablesProxyModel, slot: int): cint {.exportc: "miqt_exec_callback_QConcatenateTablesProxyModel_supportedDragActions ".} =
  ...
  cint(virtualReturn)
proc QConcatenateTablesProxyModelinsertRows*(self: gen_qconcatenatetablesproxymodel_types.QConcatenateTablesProxyModel, row: cint, count: cint, parent: QModelIndex): bool =
  fQConcatenateTablesProxyModel_virtualbase_insertRows(self.h, row, count, parent.h)

type QConcatenateTablesProxyModelinsertRowsProc* = proc(row: cint, count: cint, parent: QModelIndex): bool
...
proc miqt_exec_callback_QConcatenateTablesProxyModel_insertRows(self: ptr cQConcatenateTablesProxyModel, slot: int, row: cint, count: cint, parent: pointer): bool {.exportc: "miqt_exec_callback_QConcatenateTablesProxyModel_insertRows ".} =
  ...
  virtualReturn
proc QConcatenateTablesProxyModelinsertColumns*(self: gen_qconcatenatetablesproxymodel_types.QConcatenateTablesProxyModel, column: cint, count: cint, parent: QModelIndex): bool =
  fQConcatenateTablesProxyModel_virtualbase_insertColumns(self.h, column, count, parent.h)

type QConcatenateTablesProxyModelinsertColumnsProc* = proc(column: cint, count: cint, parent: QModelIndex): bool
...
proc miqt_exec_callback_QConcatenateTablesProxyModel_insertColumns(self: ptr cQConcatenateTablesProxyModel, slot: int, column: cint, count: cint, parent: pointer): bool {.exportc: "miqt_exec_callback_QConcatenateTablesProxyModel_insertColumns ".} =
  ...
  virtualReturn
proc QConcatenateTablesProxyModelremoveRows*(self: gen_qconcatenatetablesproxymodel_types.QConcatenateTablesProxyModel, row: cint, count: cint, parent: QModelIndex): bool =
  fQConcatenateTablesProxyModel_virtualbase_removeRows(self.h, row, count, parent.h)

type QConcatenateTablesProxyModelremoveRowsProc* = proc(row: cint, count: cint, parent: QModelIndex): bool
...
proc miqt_exec_callback_QConcatenateTablesProxyModel_removeRows(self: ptr cQConcatenateTablesProxyModel, slot: int, row: cint, count: cint, parent: pointer): bool {.exportc: "miqt_exec_callback_QConcatenateTablesProxyModel_removeRows ".} =
  ...
  virtualReturn
proc QConcatenateTablesProxyModelremoveColumns*(self: gen_qconcatenatetablesproxymodel_types.QConcatenateTablesProxyModel, column: cint, count: cint, parent: QModelIndex): bool =
  fQConcatenateTablesProxyModel_virtualbase_removeColumns(self.h, column, count, parent.h)

type QConcatenateTablesProxyModelremoveColumnsProc* = proc(column: cint, count: cint, parent: QModelIndex): bool
...
proc miqt_exec_callback_QConcatenateTablesProxyModel_removeColumns(self: ptr cQConcatenateTablesProxyModel, slot: int, column: cint, count: cint, parent: pointer): bool {.exportc: "miqt_exec_callback_QConcatenateTablesProxyModel_removeColumns ".} =
  ...
  virtualReturn
proc QConcatenateTablesProxyModelmoveRows*(self: gen_qconcatenatetablesproxymodel_types.QConcatenateTablesProxyModel, sourceParent: QModelIndex, sourceRow: cint, count: cint, destinationParent: QModelIndex, destinationChild: cint): bool =
...
type QConcatenateTablesProxyModelmoveRowsProc* = proc(sourceParent: QModelIndex, sourceRow: cint, count: cint, destinationParent: QModelIndex, destinationChild: cint): bool
...
proc miqt_exec_callback_QConcatenateTablesProxyModel_moveRows(self: ptr cQConcatenateTablesProxyModel, slot: int, sourceParent: pointer, sourceRow: cint, count: cint, destinationParent: pointer, destinationChild: cint): bool {.exportc: "miqt_exec_callback_QConcatenateTablesProxyModel_moveRows ".} =
  ...
  virtualReturn
proc QConcatenateTablesProxyModelmoveColumns*(self: gen_qconcatenatetablesproxymodel_types.QConcatenateTablesProxyModel, sourceParent: QModelIndex, sourceColumn: cint, count: cint, destinationParent: QModelIndex, destinationChild: cint): bool =
...
type QConcatenateTablesProxyModelmoveColumnsProc* = proc(sourceParent: QModelIndex, sourceColumn: cint, count: cint, destinationParent: QModelIndex, destinationChild: cint): bool
...
proc miqt_exec_callback_QConcatenateTablesProxyModel_moveColumns(self: ptr cQConcatenateTablesProxyModel, slot: int, sourceParent: pointer, sourceColumn: cint, count: cint, destinationParent: pointer, destinationChild: cint): bool {.exportc: "miqt_exec_callback_QConcatenateTablesProxyModel_moveColumns ".} =
  ...
  virtualReturn
proc QConcatenateTablesProxyModelfetchMore*(self: gen_qconcatenatetablesproxymodel_types.QConcatenateTablesProxyModel, parent: QModelIndex): void =
  fQConcatenateTablesProxyModel_virtualbase_fetchMore(self.h, parent.h)

type QConcatenateTablesProxyModelfetchMoreProc* = proc(parent: QModelIndex): void
...
proc miqt_exec_callback_QConcatenateTablesProxyModel_fetchMore(self: ptr cQConcatenateTablesProxyModel, slot: int, parent: pointer): void {.exportc: "miqt_exec_callback_QConcatenateTablesProxyModel_fetchMore ".} =
  ...
  nimfunc[](slotval1)
proc QConcatenateTablesProxyModelcanFetchMore*(self: gen_qconcatenatetablesproxymodel_types.QConcatenateTablesProxyModel, parent: QModelIndex): bool =
  fQConcatenateTablesProxyModel_virtualbase_canFetchMore(self.h, parent.h)

type QConcatenateTablesProxyModelcanFetchMoreProc* = proc(parent: QModelIndex): bool
...
proc QConcatenateTablesProxyModelbuddy*(self: gen_qconcatenatetablesproxymodel_types.QConcatenateTablesProxyModel, index: QModelIndex): QModelIndex =
  QModelIndex(h: fQConcatenateTablesProxyModel_virtualbase_buddy(self.h, index.h))

type QConcatenateTablesProxyModelbuddyProc* = proc(index: QModelIndex): QModelIndex
...
proc miqt_exec_callback_QConcatenateTablesProxyModel_buddy(self: ptr cQConcatenateTablesProxyModel, slot: int, index: pointer): pointer {.exportc: "miqt_exec_callback_QConcatenateTablesProxyModel_buddy ".} =
  ...
  virtualReturn.h
proc QConcatenateTablesProxyModelmatch*(self: gen_qconcatenatetablesproxymodel_types.QConcatenateTablesProxyModel, start: QModelIndex, role: cint, value: QVariant, hits: cint, flags: cint): seq[QModelIndex] =
...
type QConcatenateTablesProxyModelmatchProc* = proc(start: QModelIndex, role: cint, value: QVariant, hits: cint, flags: cint): seq[QModelIndex]
...
proc miqt_exec_callback_QConcatenateTablesProxyModel_roleNames(self: ptr cQConcatenateTablesProxyModel, slot: int): struct_miqt_map {.exportc: "miqt_exec_callback_QConcatenateTablesProxyModel_roleNames ".} =
  ...
  struct_miqt_map(len: csize_t(len(virtualReturn)),keys: if len(virtualReturn) == 0: nil else: addr(virtualReturn_Keys_CArray[0]), values: if len(virtualReturn) == 0: nil else: addr(virtualReturn_Values_CArray[0]),)
proc QConcatenateTablesProxyModelmultiData*(self: gen_qconcatenatetablesproxymodel_types.QConcatenateTablesProxyModel, index: QModelIndex, roleDataSpan: QModelRoleDataSpan): void =
  fQConcatenateTablesProxyModel_virtualbase_multiData(self.h, index.h, roleDataSpan.h)

type QConcatenateTablesProxyModelmultiDataProc* = proc(index: QModelIndex, roleDataSpan: QModelRoleDataSpan): void
...
proc miqt_exec_callback_QConcatenateTablesProxyModel_resetInternalData(self: ptr cQConcatenateTablesProxyModel, slot: int): void {.exportc: "miqt_exec_callback_QConcatenateTablesProxyModel_resetInternalData ".} =
  ...
  nimfunc[]()
proc QConcatenateTablesProxyModelevent*(self: gen_qconcatenatetablesproxymodel_types.QConcatenateTablesProxyModel, event: QEvent): bool =
  fQConcatenateTablesProxyModel_virtualbase_event(self.h, event.h)

type QConcatenateTablesProxyModeleventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QConcatenateTablesProxyModel_event(self: ptr cQConcatenateTablesProxyModel, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QConcatenateTablesProxyModel_event ".} =
  ...
  virtualReturn
proc QConcatenateTablesProxyModeleventFilter*(self: gen_qconcatenatetablesproxymodel_types.QConcatenateTablesProxyModel, watched: QObject, event: QEvent): bool =
  fQConcatenateTablesProxyModel_virtualbase_eventFilter(self.h, watched.h, event.h)

type QConcatenateTablesProxyModeleventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QConcatenateTablesProxyModel_eventFilter(self: ptr cQConcatenateTablesProxyModel, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QConcatenateTablesProxyModel_eventFilter ".} =
  ...
  virtualReturn
proc QConcatenateTablesProxyModeltimerEvent*(self: gen_qconcatenatetablesproxymodel_types.QConcatenateTablesProxyModel, event: QTimerEvent): void =
  fQConcatenateTablesProxyModel_virtualbase_timerEvent(self.h, event.h)

type QConcatenateTablesProxyModeltimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QConcatenateTablesProxyModel_timerEvent(self: ptr cQConcatenateTablesProxyModel, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QConcatenateTablesProxyModel_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QConcatenateTablesProxyModelchildEvent*(self: gen_qconcatenatetablesproxymodel_types.QConcatenateTablesProxyModel, event: QChildEvent): void =
  fQConcatenateTablesProxyModel_virtualbase_childEvent(self.h, event.h)

type QConcatenateTablesProxyModelchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QConcatenateTablesProxyModel_childEvent(self: ptr cQConcatenateTablesProxyModel, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QConcatenateTablesProxyModel_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QConcatenateTablesProxyModelcustomEvent*(self: gen_qconcatenatetablesproxymodel_types.QConcatenateTablesProxyModel, event: QEvent): void =
  fQConcatenateTablesProxyModel_virtualbase_customEvent(self.h, event.h)

type QConcatenateTablesProxyModelcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QConcatenateTablesProxyModel_customEvent(self: ptr cQConcatenateTablesProxyModel, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QConcatenateTablesProxyModel_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QConcatenateTablesProxyModelconnectNotify*(self: gen_qconcatenatetablesproxymodel_types.QConcatenateTablesProxyModel, signal: QMetaMethod): void =
  fQConcatenateTablesProxyModel_virtualbase_connectNotify(self.h, signal.h)

type QConcatenateTablesProxyModelconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QConcatenateTablesProxyModel_connectNotify(self: ptr cQConcatenateTablesProxyModel, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QConcatenateTablesProxyModel_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QConcatenateTablesProxyModeldisconnectNotify*(self: gen_qconcatenatetablesproxymodel_types.QConcatenateTablesProxyModel, signal: QMetaMethod): void =
  fQConcatenateTablesProxyModel_virtualbase_disconnectNotify(self.h, signal.h)

type QConcatenateTablesProxyModeldisconnectNotifyProc* = proc(signal: QMetaMethod): void
