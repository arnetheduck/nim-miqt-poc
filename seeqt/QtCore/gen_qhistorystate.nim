...
proc create*(T: type gen_qhistorystate_types.QHistoryState, parent: QState): gen_qhistorystate_types.QHistoryState =
  gen_qhistorystate_types.QHistoryState.init(fcQHistoryState_new3(parent.h))

proc create*(T: type gen_qhistorystate_types.QHistoryState, typeVal: cint, parent: QState): gen_qhistorystate_types.QHistoryState =
  gen_qhistorystate_types.QHistoryState.init(fcQHistoryState_new4(cint(typeVal), parent.h))

proc metaObject*(self: gen_qhistorystate_types.QHistoryState, ): QMetaObject =
  QMetaObject(h: fcQHistoryState_metaObject(self.h))
...
proc defaultTransition*(self: gen_qhistorystate_types.QHistoryState, ): QAbstractTransition =
  QAbstractTransition(h: fcQHistoryState_defaultTransition(self.h))

proc setDefaultTransition*(self: gen_qhistorystate_types.QHistoryState, transition: QAbstractTransition): void =
  fcQHistoryState_setDefaultTransition(self.h, transition.h)

proc defaultState*(self: gen_qhistorystate_types.QHistoryState, ): QAbstractState =
  QAbstractState(h: fcQHistoryState_defaultState(self.h))

proc setDefaultState*(self: gen_qhistorystate_types.QHistoryState, state: QAbstractState): void =
...
proc miqt_exec_callback_QHistoryState_metacall(self: ptr cQHistoryState, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QHistoryState_metacall ".} =
  ...
  virtualReturn
proc QHistoryStateonEntry*(self: gen_qhistorystate_types.QHistoryState, event: QEvent): void =
  fQHistoryState_virtualbase_onEntry(self.h, event.h)

type QHistoryStateonEntryProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QHistoryState_onEntry(self: ptr cQHistoryState, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QHistoryState_onEntry ".} =
  ...
  nimfunc[](slotval1)
proc QHistoryStateonExit*(self: gen_qhistorystate_types.QHistoryState, event: QEvent): void =
  fQHistoryState_virtualbase_onExit(self.h, event.h)

type QHistoryStateonExitProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QHistoryState_onExit(self: ptr cQHistoryState, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QHistoryState_onExit ".} =
  ...
  nimfunc[](slotval1)
proc QHistoryStateevent*(self: gen_qhistorystate_types.QHistoryState, e: QEvent): bool =
  fQHistoryState_virtualbase_event(self.h, e.h)

type QHistoryStateeventProc* = proc(e: QEvent): bool
...
proc miqt_exec_callback_QHistoryState_event(self: ptr cQHistoryState, slot: int, e: pointer): bool {.exportc: "miqt_exec_callback_QHistoryState_event ".} =
  ...
  virtualReturn
proc QHistoryStateeventFilter*(self: gen_qhistorystate_types.QHistoryState, watched: QObject, event: QEvent): bool =
  fQHistoryState_virtualbase_eventFilter(self.h, watched.h, event.h)

type QHistoryStateeventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QHistoryState_eventFilter(self: ptr cQHistoryState, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QHistoryState_eventFilter ".} =
  ...
  virtualReturn
proc QHistoryStatetimerEvent*(self: gen_qhistorystate_types.QHistoryState, event: QTimerEvent): void =
  fQHistoryState_virtualbase_timerEvent(self.h, event.h)

type QHistoryStatetimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QHistoryState_timerEvent(self: ptr cQHistoryState, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QHistoryState_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QHistoryStatechildEvent*(self: gen_qhistorystate_types.QHistoryState, event: QChildEvent): void =
  fQHistoryState_virtualbase_childEvent(self.h, event.h)

type QHistoryStatechildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QHistoryState_childEvent(self: ptr cQHistoryState, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QHistoryState_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QHistoryStatecustomEvent*(self: gen_qhistorystate_types.QHistoryState, event: QEvent): void =
  fQHistoryState_virtualbase_customEvent(self.h, event.h)

type QHistoryStatecustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QHistoryState_customEvent(self: ptr cQHistoryState, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QHistoryState_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QHistoryStateconnectNotify*(self: gen_qhistorystate_types.QHistoryState, signal: QMetaMethod): void =
  fQHistoryState_virtualbase_connectNotify(self.h, signal.h)

type QHistoryStateconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QHistoryState_connectNotify(self: ptr cQHistoryState, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QHistoryState_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QHistoryStatedisconnectNotify*(self: gen_qhistorystate_types.QHistoryState, signal: QMetaMethod): void =
  fQHistoryState_virtualbase_disconnectNotify(self.h, signal.h)

type QHistoryStatedisconnectNotifyProc* = proc(signal: QMetaMethod): void
