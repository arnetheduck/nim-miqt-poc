...
func init*(T: type gen_qmutex_types.QMutexLocker, h: ptr cQMutexLocker): gen_qmutex_types.QMutexLocker =
  T(h: h)
proc create*(T: type gen_qmutex_types.QMutexLocker, m: QBasicMutex): gen_qmutex_types.QMutexLocker =
  gen_qmutex_types.QMutexLocker.init(fcQMutexLocker_new(m.h))

proc create*(T: type gen_qmutex_types.QMutexLocker, m: QRecursiveMutex): gen_qmutex_types.QMutexLocker =
...
proc mutex*(self: gen_qmutex_types.QMutexLocker, ): QMutex =
