...
proc create*(T: type gen_qvariant_types.QVariant, typeVal: QMetaType): gen_qvariant_types.QVariant =
...
proc create*(T: type gen_qvariant_types.QVariant, typeVal: QMetaType, copy: pointer): gen_qvariant_types.QVariant =
...
proc metaType*(self: gen_qvariant_types.QVariant, ): QMetaType =
  QMetaType(h: fcQVariant_metaType(self.h))

proc canConvert*(self: gen_qvariant_types.QVariant, targetType: QMetaType): bool =
  fcQVariant_canConvert(self.h, targetType.h)

proc convert*(self: gen_qvariant_types.QVariant, typeVal: QMetaType): bool =
  fcQVariant_convert(self.h, typeVal.h)

proc canView*(self: gen_qvariant_types.QVariant, targetType: QMetaType): bool =
...
proc setValue*(self: gen_qvariant_types.QVariant, avalue: QVariant): void =
  fcQVariant_setValue(self.h, avalue.h)

proc compare*(_: type gen_qvariant_types.QVariant, lhs: QVariant, rhs: QVariant): QPartialOrdering =
  QPartialOrdering(h: fcQVariant_compare(lhs.h, rhs.h))
...
func init*(T: type gen_qvariant_types.QVariantConstPointer, h: ptr cQVariantConstPointer): gen_qvariant_types.QVariantConstPointer =
  T(h: h)
proc create*(T: type gen_qvariant_types.QVariantConstPointer, variant: QVariant): gen_qvariant_types.QVariantConstPointer =
  gen_qvariant_types.QVariantConstPointer.init(fcQVariantConstPointer_new(variant.h))

proc create*(T: type gen_qvariant_types.QVariantConstPointer, param1: QVariantConstPointer): gen_qvariant_types.QVariantConstPointer =
  gen_qvariant_types.QVariantConstPointer.init(fcQVariantConstPointer_new2(param1.h))

proc operatorMultiply*(self: gen_qvariant_types.QVariantConstPointer, ): QVariant =
  QVariant(h: fcQVariantConstPointer_operatorMultiply(self.h))

proc operatorMinusGreater*(self: gen_qvariant_types.QVariantConstPointer, ): QVariant =
  QVariant(h: fcQVariantConstPointer_operatorMinusGreater(self.h))

proc operatorAssign*(self: gen_qvariant_types.QVariantConstPointer, param1: QVariantConstPointer): void =
