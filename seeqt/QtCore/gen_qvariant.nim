...
proc create*(T: type gen_qvariant_types.QVariant, other: QVariant): gen_qvariant_types.QVariant =
  gen_qvariant_types.QVariant.init(fcQVariant_new5(other.h))

proc create*(T: type gen_qvariant_types.QVariant, s: QDataStream): gen_qvariant_types.QVariant =
...
proc create*(T: type gen_qvariant_types.QVariant, bitarray: QBitArray): gen_qvariant_types.QVariant =
...
proc create*(T: type gen_qvariant_types.QVariant, qchar: QChar): gen_qvariant_types.QVariant =
  gen_qvariant_types.QVariant.init(fcQVariant_new19(qchar.h))

proc create*(T: type gen_qvariant_types.QVariant, date: QDate): gen_qvariant_types.QVariant =
  gen_qvariant_types.QVariant.init(fcQVariant_new20(date.h))

proc create*(T: type gen_qvariant_types.QVariant, time: QTime): gen_qvariant_types.QVariant =
  gen_qvariant_types.QVariant.init(fcQVariant_new21(time.h))

proc create*(T: type gen_qvariant_types.QVariant, datetime: QDateTime): gen_qvariant_types.QVariant =
  gen_qvariant_types.QVariant.init(fcQVariant_new22(datetime.h))

proc create*(T: type gen_qvariant_types.QVariant, map: Table[string,QVariant]): gen_qvariant_types.QVariant =
...
proc create2*(T: type gen_qvariant_types.QVariant, hash: Table[string,QVariant]): gen_qvariant_types.QVariant =
...
proc create*(T: type gen_qvariant_types.QVariant, size: QSize): gen_qvariant_types.QVariant =
  gen_qvariant_types.QVariant.init(fcQVariant_new25(size.h))

proc create*(T: type gen_qvariant_types.QVariant, size: QSizeF): gen_qvariant_types.QVariant =
  gen_qvariant_types.QVariant.init(fcQVariant_new26(size.h))

proc create*(T: type gen_qvariant_types.QVariant, pt: QPoint): gen_qvariant_types.QVariant =
  gen_qvariant_types.QVariant.init(fcQVariant_new27(pt.h))

proc create*(T: type gen_qvariant_types.QVariant, pt: QPointF): gen_qvariant_types.QVariant =
  gen_qvariant_types.QVariant.init(fcQVariant_new28(pt.h))

proc create*(T: type gen_qvariant_types.QVariant, line: QLine): gen_qvariant_types.QVariant =
  gen_qvariant_types.QVariant.init(fcQVariant_new29(line.h))

proc create*(T: type gen_qvariant_types.QVariant, line: QLineF): gen_qvariant_types.QVariant =
  gen_qvariant_types.QVariant.init(fcQVariant_new30(line.h))

proc create*(T: type gen_qvariant_types.QVariant, rect: QRect): gen_qvariant_types.QVariant =
  gen_qvariant_types.QVariant.init(fcQVariant_new31(rect.h))

proc create*(T: type gen_qvariant_types.QVariant, rect: QRectF): gen_qvariant_types.QVariant =
  gen_qvariant_types.QVariant.init(fcQVariant_new32(rect.h))

proc create*(T: type gen_qvariant_types.QVariant, locale: QLocale): gen_qvariant_types.QVariant =
  gen_qvariant_types.QVariant.init(fcQVariant_new33(locale.h))

proc create*(T: type gen_qvariant_types.QVariant, regExp: QRegExp): gen_qvariant_types.QVariant =
  gen_qvariant_types.QVariant.init(fcQVariant_new34(regExp.h))

proc create*(T: type gen_qvariant_types.QVariant, re: QRegularExpression): gen_qvariant_types.QVariant =
  gen_qvariant_types.QVariant.init(fcQVariant_new35(re.h))

proc create*(T: type gen_qvariant_types.QVariant, easing: QEasingCurve): gen_qvariant_types.QVariant =
  gen_qvariant_types.QVariant.init(fcQVariant_new36(easing.h))

proc create*(T: type gen_qvariant_types.QVariant, uuid: QUuid): gen_qvariant_types.QVariant =
  gen_qvariant_types.QVariant.init(fcQVariant_new37(uuid.h))

proc create*(T: type gen_qvariant_types.QVariant, url: QUrl): gen_qvariant_types.QVariant =
  gen_qvariant_types.QVariant.init(fcQVariant_new38(url.h))

proc create*(T: type gen_qvariant_types.QVariant, jsonValue: QJsonValue): gen_qvariant_types.QVariant =
  gen_qvariant_types.QVariant.init(fcQVariant_new39(jsonValue.h))

proc create*(T: type gen_qvariant_types.QVariant, jsonObject: QJsonObject): gen_qvariant_types.QVariant =
  gen_qvariant_types.QVariant.init(fcQVariant_new40(jsonObject.h))

proc create*(T: type gen_qvariant_types.QVariant, jsonArray: QJsonArray): gen_qvariant_types.QVariant =
  gen_qvariant_types.QVariant.init(fcQVariant_new41(jsonArray.h))

proc create*(T: type gen_qvariant_types.QVariant, jsonDocument: QJsonDocument): gen_qvariant_types.QVariant =
  gen_qvariant_types.QVariant.init(fcQVariant_new42(jsonDocument.h))

proc create*(T: type gen_qvariant_types.QVariant, modelIndex: QModelIndex): gen_qvariant_types.QVariant =
  gen_qvariant_types.QVariant.init(fcQVariant_new43(modelIndex.h))

proc create*(T: type gen_qvariant_types.QVariant, modelIndex: QPersistentModelIndex): gen_qvariant_types.QVariant =
  gen_qvariant_types.QVariant.init(fcQVariant_new44(modelIndex.h))

proc operatorAssign*(self: gen_qvariant_types.QVariant, other: QVariant): void =
  fcQVariant_operatorAssign(self.h, other.h)

proc swap*(self: gen_qvariant_types.QVariant, other: QVariant): void =
...
proc toBitArray*(self: gen_qvariant_types.QVariant, ): QBitArray =
  QBitArray(h: fcQVariant_toBitArray(self.h))
...
proc toChar*(self: gen_qvariant_types.QVariant, ): QChar =
  QChar(h: fcQVariant_toChar(self.h))

proc toDate*(self: gen_qvariant_types.QVariant, ): QDate =
  QDate(h: fcQVariant_toDate(self.h))

proc toTime*(self: gen_qvariant_types.QVariant, ): QTime =
  QTime(h: fcQVariant_toTime(self.h))

proc toDateTime*(self: gen_qvariant_types.QVariant, ): QDateTime =
  QDateTime(h: fcQVariant_toDateTime(self.h))

proc toMap*(self: gen_qvariant_types.QVariant, ): Table[string,QVariant] =
...
proc toHash*(self: gen_qvariant_types.QVariant, ): Table[string,QVariant] =
...
proc toPoint*(self: gen_qvariant_types.QVariant, ): QPoint =
  QPoint(h: fcQVariant_toPoint(self.h))

proc toPointF*(self: gen_qvariant_types.QVariant, ): QPointF =
  QPointF(h: fcQVariant_toPointF(self.h))

proc toRect*(self: gen_qvariant_types.QVariant, ): QRect =
  QRect(h: fcQVariant_toRect(self.h))

proc toSize*(self: gen_qvariant_types.QVariant, ): QSize =
  QSize(h: fcQVariant_toSize(self.h))

proc toSizeF*(self: gen_qvariant_types.QVariant, ): QSizeF =
  QSizeF(h: fcQVariant_toSizeF(self.h))

proc toLine*(self: gen_qvariant_types.QVariant, ): QLine =
  QLine(h: fcQVariant_toLine(self.h))

proc toLineF*(self: gen_qvariant_types.QVariant, ): QLineF =
  QLineF(h: fcQVariant_toLineF(self.h))

proc toRectF*(self: gen_qvariant_types.QVariant, ): QRectF =
  QRectF(h: fcQVariant_toRectF(self.h))

proc toLocale*(self: gen_qvariant_types.QVariant, ): QLocale =
  QLocale(h: fcQVariant_toLocale(self.h))

proc toRegExp*(self: gen_qvariant_types.QVariant, ): QRegExp =
  QRegExp(h: fcQVariant_toRegExp(self.h))

proc toRegularExpression*(self: gen_qvariant_types.QVariant, ): QRegularExpression =
  QRegularExpression(h: fcQVariant_toRegularExpression(self.h))

proc toEasingCurve*(self: gen_qvariant_types.QVariant, ): QEasingCurve =
  QEasingCurve(h: fcQVariant_toEasingCurve(self.h))

proc toUuid*(self: gen_qvariant_types.QVariant, ): QUuid =
  QUuid(h: fcQVariant_toUuid(self.h))

proc toUrl*(self: gen_qvariant_types.QVariant, ): QUrl =
  QUrl(h: fcQVariant_toUrl(self.h))

proc toJsonValue*(self: gen_qvariant_types.QVariant, ): QJsonValue =
  QJsonValue(h: fcQVariant_toJsonValue(self.h))

proc toJsonObject*(self: gen_qvariant_types.QVariant, ): QJsonObject =
  QJsonObject(h: fcQVariant_toJsonObject(self.h))

proc toJsonArray*(self: gen_qvariant_types.QVariant, ): QJsonArray =
  QJsonArray(h: fcQVariant_toJsonArray(self.h))

proc toJsonDocument*(self: gen_qvariant_types.QVariant, ): QJsonDocument =
  QJsonDocument(h: fcQVariant_toJsonDocument(self.h))

proc toModelIndex*(self: gen_qvariant_types.QVariant, ): QModelIndex =
  QModelIndex(h: fcQVariant_toModelIndex(self.h))

proc toPersistentModelIndex*(self: gen_qvariant_types.QVariant, ): QPersistentModelIndex =
  QPersistentModelIndex(h: fcQVariant_toPersistentModelIndex(self.h))

proc load*(self: gen_qvariant_types.QVariant, ds: QDataStream): void =
  fcQVariant_load(self.h, ds.h)

proc save*(self: gen_qvariant_types.QVariant, ds: QDataStream): void =
...
proc operatorEqual*(self: gen_qvariant_types.QVariant, v: QVariant): bool =
  fcQVariant_operatorEqual(self.h, v.h)

proc operatorNotEqual*(self: gen_qvariant_types.QVariant, v: QVariant): bool =
  fcQVariant_operatorNotEqual(self.h, v.h)

proc operatorLesser*(self: gen_qvariant_types.QVariant, v: QVariant): bool =
  fcQVariant_operatorLesser(self.h, v.h)

proc operatorLesserOrEqual*(self: gen_qvariant_types.QVariant, v: QVariant): bool =
  fcQVariant_operatorLesserOrEqual(self.h, v.h)

proc operatorGreater*(self: gen_qvariant_types.QVariant, v: QVariant): bool =
  fcQVariant_operatorGreater(self.h, v.h)

proc operatorGreaterOrEqual*(self: gen_qvariant_types.QVariant, v: QVariant): bool =
...
proc fromValue*(_: type gen_qvariant_types.QVariant, value: QObject): QVariant =
...
func init*(T: type gen_qvariant_types.QVariantComparisonHelper, h: ptr cQVariantComparisonHelper): gen_qvariant_types.QVariantComparisonHelper =
  T(h: h)
proc create*(T: type gen_qvariant_types.QVariantComparisonHelper, varVal: QVariant): gen_qvariant_types.QVariantComparisonHelper =
  gen_qvariant_types.QVariantComparisonHelper.init(fcQVariantComparisonHelper_new(varVal.h))

proc create*(T: type gen_qvariant_types.QVariantComparisonHelper, param1: QVariantComparisonHelper): gen_qvariant_types.QVariantComparisonHelper =
...
func init*(T: type gen_qvariant_types.QVariantHandler, h: ptr cQVariantHandler): gen_qvariant_types.QVariantHandler =
  T(h: h)
proc delete*(self: gen_qvariant_types.QVariantHandler) =
...
func init*(T: type gen_qvariant_types.QSequentialIterableconst_iterator, h: ptr cQSequentialIterableconst_iterator): gen_qvariant_types.QSequentialIterableconst_iterator =
  T(h: h)
proc create*(T: type gen_qvariant_types.QSequentialIterableconst_iterator, other: QSequentialIterableconst_iterator): gen_qvariant_types.QSequentialIterableconst_iterator =
  gen_qvariant_types.QSequentialIterableconst_iterator.init(fcQSequentialIterableconst_iterator_new(other.h))

proc operatorAssign*(self: gen_qvariant_types.QSequentialIterableconst_iterator, other: QSequentialIterableconst_iterator): void =
  fcQSequentialIterableconst_iterator_operatorAssign(self.h, other.h)

proc operatorMultiply*(self: gen_qvariant_types.QSequentialIterableconst_iterator, ): QVariant =
  QVariant(h: fcQSequentialIterableconst_iterator_operatorMultiply(self.h))

proc operatorEqual*(self: gen_qvariant_types.QSequentialIterableconst_iterator, o: QSequentialIterableconst_iterator): bool =
  fcQSequentialIterableconst_iterator_operatorEqual(self.h, o.h)

proc operatorNotEqual*(self: gen_qvariant_types.QSequentialIterableconst_iterator, o: QSequentialIterableconst_iterator): bool =
  fcQSequentialIterableconst_iterator_operatorNotEqual(self.h, o.h)

proc operatorPlusPlus*(self: gen_qvariant_types.QSequentialIterableconst_iterator, ): QSequentialIterableconst_iterator =
  QSequentialIterableconst_iterator(h: fcQSequentialIterableconst_iterator_operatorPlusPlus(self.h))

proc operatorPlusPlus*(self: gen_qvariant_types.QSequentialIterableconst_iterator, param1: cint): QSequentialIterableconst_iterator =
  QSequentialIterableconst_iterator(h: fcQSequentialIterableconst_iterator_operatorPlusPlusWithInt(self.h, param1))

proc operatorMinusMinus*(self: gen_qvariant_types.QSequentialIterableconst_iterator, ): QSequentialIterableconst_iterator =
  QSequentialIterableconst_iterator(h: fcQSequentialIterableconst_iterator_operatorMinusMinus(self.h))

proc operatorMinusMinus*(self: gen_qvariant_types.QSequentialIterableconst_iterator, param1: cint): QSequentialIterableconst_iterator =
  QSequentialIterableconst_iterator(h: fcQSequentialIterableconst_iterator_operatorMinusMinusWithInt(self.h, param1))

proc operatorPlusAssign*(self: gen_qvariant_types.QSequentialIterableconst_iterator, j: cint): QSequentialIterableconst_iterator =
  QSequentialIterableconst_iterator(h: fcQSequentialIterableconst_iterator_operatorPlusAssign(self.h, j))

proc operatorMinusAssign*(self: gen_qvariant_types.QSequentialIterableconst_iterator, j: cint): QSequentialIterableconst_iterator =
  QSequentialIterableconst_iterator(h: fcQSequentialIterableconst_iterator_operatorMinusAssign(self.h, j))

proc operatorPlus*(self: gen_qvariant_types.QSequentialIterableconst_iterator, j: cint): QSequentialIterableconst_iterator =
  QSequentialIterableconst_iterator(h: fcQSequentialIterableconst_iterator_operatorPlus(self.h, j))

proc operatorMinus*(self: gen_qvariant_types.QSequentialIterableconst_iterator, j: cint): QSequentialIterableconst_iterator =
...
func init*(T: type gen_qvariant_types.QAssociativeIterableconst_iterator, h: ptr cQAssociativeIterableconst_iterator): gen_qvariant_types.QAssociativeIterableconst_iterator =
  T(h: h)
proc create*(T: type gen_qvariant_types.QAssociativeIterableconst_iterator, other: QAssociativeIterableconst_iterator): gen_qvariant_types.QAssociativeIterableconst_iterator =
  gen_qvariant_types.QAssociativeIterableconst_iterator.init(fcQAssociativeIterableconst_iterator_new(other.h))

proc operatorAssign*(self: gen_qvariant_types.QAssociativeIterableconst_iterator, other: QAssociativeIterableconst_iterator): void =
  fcQAssociativeIterableconst_iterator_operatorAssign(self.h, other.h)

proc key*(self: gen_qvariant_types.QAssociativeIterableconst_iterator, ): QVariant =
  QVariant(h: fcQAssociativeIterableconst_iterator_key(self.h))

proc value*(self: gen_qvariant_types.QAssociativeIterableconst_iterator, ): QVariant =
  QVariant(h: fcQAssociativeIterableconst_iterator_value(self.h))

proc operatorMultiply*(self: gen_qvariant_types.QAssociativeIterableconst_iterator, ): QVariant =
  QVariant(h: fcQAssociativeIterableconst_iterator_operatorMultiply(self.h))

proc operatorEqual*(self: gen_qvariant_types.QAssociativeIterableconst_iterator, o: QAssociativeIterableconst_iterator): bool =
  fcQAssociativeIterableconst_iterator_operatorEqual(self.h, o.h)

proc operatorNotEqual*(self: gen_qvariant_types.QAssociativeIterableconst_iterator, o: QAssociativeIterableconst_iterator): bool =
  fcQAssociativeIterableconst_iterator_operatorNotEqual(self.h, o.h)

proc operatorPlusPlus*(self: gen_qvariant_types.QAssociativeIterableconst_iterator, ): QAssociativeIterableconst_iterator =
  QAssociativeIterableconst_iterator(h: fcQAssociativeIterableconst_iterator_operatorPlusPlus(self.h))

proc operatorPlusPlus*(self: gen_qvariant_types.QAssociativeIterableconst_iterator, param1: cint): QAssociativeIterableconst_iterator =
  QAssociativeIterableconst_iterator(h: fcQAssociativeIterableconst_iterator_operatorPlusPlusWithInt(self.h, param1))

proc operatorMinusMinus*(self: gen_qvariant_types.QAssociativeIterableconst_iterator, ): QAssociativeIterableconst_iterator =
  QAssociativeIterableconst_iterator(h: fcQAssociativeIterableconst_iterator_operatorMinusMinus(self.h))

proc operatorMinusMinus*(self: gen_qvariant_types.QAssociativeIterableconst_iterator, param1: cint): QAssociativeIterableconst_iterator =
  QAssociativeIterableconst_iterator(h: fcQAssociativeIterableconst_iterator_operatorMinusMinusWithInt(self.h, param1))

proc operatorPlusAssign*(self: gen_qvariant_types.QAssociativeIterableconst_iterator, j: cint): QAssociativeIterableconst_iterator =
  QAssociativeIterableconst_iterator(h: fcQAssociativeIterableconst_iterator_operatorPlusAssign(self.h, j))

proc operatorMinusAssign*(self: gen_qvariant_types.QAssociativeIterableconst_iterator, j: cint): QAssociativeIterableconst_iterator =
  QAssociativeIterableconst_iterator(h: fcQAssociativeIterableconst_iterator_operatorMinusAssign(self.h, j))

proc operatorPlus*(self: gen_qvariant_types.QAssociativeIterableconst_iterator, j: cint): QAssociativeIterableconst_iterator =
  QAssociativeIterableconst_iterator(h: fcQAssociativeIterableconst_iterator_operatorPlus(self.h, j))

proc operatorMinus*(self: gen_qvariant_types.QAssociativeIterableconst_iterator, j: cint): QAssociativeIterableconst_iterator =
