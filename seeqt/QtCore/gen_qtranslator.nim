...
proc create*(T: type gen_qtranslator_types.QTranslator, parent: QObject): gen_qtranslator_types.QTranslator =
  gen_qtranslator_types.QTranslator.init(fcQTranslator_new2(parent.h))

proc metaObject*(self: gen_qtranslator_types.QTranslator, ): QMetaObject =
  QMetaObject(h: fcQTranslator_metaObject(self.h))
...
proc load*(self: gen_qtranslator_types.QTranslator, locale: QLocale, filename: string): bool =
...
proc load*(self: gen_qtranslator_types.QTranslator, locale: QLocale, filename: string, prefix: string): bool =
...
proc load*(self: gen_qtranslator_types.QTranslator, locale: QLocale, filename: string, prefix: string, directory: string): bool =
...
proc load*(self: gen_qtranslator_types.QTranslator, locale: QLocale, filename: string, prefix: string, directory: string, suffix: string): bool =
...
proc miqt_exec_callback_QTranslator_isEmpty(self: ptr cQTranslator, slot: int): bool {.exportc: "miqt_exec_callback_QTranslator_isEmpty ".} =
  ...
  virtualReturn
proc QTranslatorevent*(self: gen_qtranslator_types.QTranslator, event: QEvent): bool =
  fQTranslator_virtualbase_event(self.h, event.h)

type QTranslatoreventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QTranslator_event(self: ptr cQTranslator, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QTranslator_event ".} =
  ...
  virtualReturn
proc QTranslatoreventFilter*(self: gen_qtranslator_types.QTranslator, watched: QObject, event: QEvent): bool =
  fQTranslator_virtualbase_eventFilter(self.h, watched.h, event.h)

type QTranslatoreventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QTranslator_eventFilter(self: ptr cQTranslator, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QTranslator_eventFilter ".} =
  ...
  virtualReturn
proc QTranslatortimerEvent*(self: gen_qtranslator_types.QTranslator, event: QTimerEvent): void =
  fQTranslator_virtualbase_timerEvent(self.h, event.h)

type QTranslatortimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QTranslator_timerEvent(self: ptr cQTranslator, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTranslator_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTranslatorchildEvent*(self: gen_qtranslator_types.QTranslator, event: QChildEvent): void =
  fQTranslator_virtualbase_childEvent(self.h, event.h)

type QTranslatorchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QTranslator_childEvent(self: ptr cQTranslator, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTranslator_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTranslatorcustomEvent*(self: gen_qtranslator_types.QTranslator, event: QEvent): void =
  fQTranslator_virtualbase_customEvent(self.h, event.h)

type QTranslatorcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QTranslator_customEvent(self: ptr cQTranslator, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTranslator_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTranslatorconnectNotify*(self: gen_qtranslator_types.QTranslator, signal: QMetaMethod): void =
  fQTranslator_virtualbase_connectNotify(self.h, signal.h)

type QTranslatorconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QTranslator_connectNotify(self: ptr cQTranslator, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QTranslator_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QTranslatordisconnectNotify*(self: gen_qtranslator_types.QTranslator, signal: QMetaMethod): void =
  fQTranslator_virtualbase_disconnectNotify(self.h, signal.h)

type QTranslatordisconnectNotifyProc* = proc(signal: QMetaMethod): void
