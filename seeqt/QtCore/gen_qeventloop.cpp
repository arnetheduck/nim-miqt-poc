...
QMetaObject* QEventLoop_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQEventLoop*)(self) )->QEventLoop::metaObject();

}

void* QEventLoop_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQEventLoop*)(self) )->QEventLoop::qt_metacast(param1);

}

int QEventLoop_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQEventLoop*)(self) )->QEventLoop::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
