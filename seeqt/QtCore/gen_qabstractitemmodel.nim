...
proc child*(self: gen_qabstractitemmodel_types.QModelIndex, row: cint, column: cint): QModelIndex =
...
proc ToConstQModelIndexBitwiseAnd*(self: gen_qabstractitemmodel_types.QPersistentModelIndex, ): QModelIndex =
...
proc child*(self: gen_qabstractitemmodel_types.QPersistentModelIndex, row: cint, column: cint): QModelIndex =
