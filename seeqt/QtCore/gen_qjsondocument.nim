...
proc operatorSubscript*(self: gen_qjsondocument_types.QJsonDocument, i: int64): QJsonValue =
  QJsonValue(h: fcQJsonDocument_operatorSubscriptWithQsizetype(self.h, i))
