...
proc create*(T: type gen_qjsondocument_types.QJsonDocument, objectVal: QJsonObject): gen_qjsondocument_types.QJsonDocument =
  gen_qjsondocument_types.QJsonDocument.init(fcQJsonDocument_new2(objectVal.h))

proc create*(T: type gen_qjsondocument_types.QJsonDocument, array: QJsonArray): gen_qjsondocument_types.QJsonDocument =
  gen_qjsondocument_types.QJsonDocument.init(fcQJsonDocument_new3(array.h))

proc create*(T: type gen_qjsondocument_types.QJsonDocument, other: QJsonDocument): gen_qjsondocument_types.QJsonDocument =
  gen_qjsondocument_types.QJsonDocument.init(fcQJsonDocument_new4(other.h))

proc operatorAssign*(self: gen_qjsondocument_types.QJsonDocument, other: QJsonDocument): void =
  fcQJsonDocument_operatorAssign(self.h, other.h)

proc swap*(self: gen_qjsondocument_types.QJsonDocument, other: QJsonDocument): void =
  fcQJsonDocument_swap(self.h, other.h)

proc fromRawData*(_: type gen_qjsondocument_types.QJsonDocument, data: cstring, size: cint): QJsonDocument =
...
proc fromBinaryData*(_: type gen_qjsondocument_types.QJsonDocument, data: seq[byte]): QJsonDocument =
...
proc fromVariant*(_: type gen_qjsondocument_types.QJsonDocument, variant: QVariant): QJsonDocument =
  QJsonDocument(h: fcQJsonDocument_fromVariant(variant.h))

proc toVariant*(self: gen_qjsondocument_types.QJsonDocument, ): QVariant =
  QVariant(h: fcQJsonDocument_toVariant(self.h))

proc fromJson*(_: type gen_qjsondocument_types.QJsonDocument, json: seq[byte]): QJsonDocument =
...
proc objectX*(self: gen_qjsondocument_types.QJsonDocument, ): QJsonObject =
  QJsonObject(h: fcQJsonDocument_objectX(self.h))

proc array*(self: gen_qjsondocument_types.QJsonDocument, ): QJsonArray =
  QJsonArray(h: fcQJsonDocument_array(self.h))

proc setObject*(self: gen_qjsondocument_types.QJsonDocument, objectVal: QJsonObject): void =
  fcQJsonDocument_setObject(self.h, objectVal.h)

proc setArray*(self: gen_qjsondocument_types.QJsonDocument, array: QJsonArray): void =
  fcQJsonDocument_setArray(self.h, array.h)

proc operatorSubscript*(self: gen_qjsondocument_types.QJsonDocument, key: string): QJsonValue =
  QJsonValue(h: fcQJsonDocument_operatorSubscript(self.h, struct_miqt_string(data: key, len: csize_t(len(key)))))

proc operatorSubscript*(self: gen_qjsondocument_types.QJsonDocument, i: cint): QJsonValue =
  QJsonValue(h: fcQJsonDocument_operatorSubscriptWithInt(self.h, i))

proc operatorEqual*(self: gen_qjsondocument_types.QJsonDocument, other: QJsonDocument): bool =
  fcQJsonDocument_operatorEqual(self.h, other.h)

proc operatorNotEqual*(self: gen_qjsondocument_types.QJsonDocument, other: QJsonDocument): bool =
...
proc fromRawData*(_: type gen_qjsondocument_types.QJsonDocument, data: cstring, size: cint, validation: cint): QJsonDocument =
  QJsonDocument(h: fcQJsonDocument_fromRawData3(data, size, cint(validation)))

proc fromBinaryData*(_: type gen_qjsondocument_types.QJsonDocument, data: seq[byte], validation: cint): QJsonDocument =
...
proc fromJson*(_: type gen_qjsondocument_types.QJsonDocument, json: seq[byte], error: QJsonParseError): QJsonDocument =
