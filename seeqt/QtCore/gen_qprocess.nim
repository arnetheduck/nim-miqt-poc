...
proc fQProcess_virtualbase_skipData(self: pointer, maxSize: clonglong): clonglong{.importc: "QProcess_virtualbase_skipData".}
proc fcQProcess_override_virtual_skipData(self: pointer, slot: int) {.importc: "QProcess_override_virtual_skipData".}
...
proc create*(T: type gen_qprocess_types.QProcessEnvironment, other: QProcessEnvironment): gen_qprocess_types.QProcessEnvironment =
  gen_qprocess_types.QProcessEnvironment.init(fcQProcessEnvironment_new3(other.h))

proc operatorAssign*(self: gen_qprocess_types.QProcessEnvironment, other: QProcessEnvironment): void =
  fcQProcessEnvironment_operatorAssign(self.h, other.h)

proc swap*(self: gen_qprocess_types.QProcessEnvironment, other: QProcessEnvironment): void =
  fcQProcessEnvironment_swap(self.h, other.h)

proc operatorEqual*(self: gen_qprocess_types.QProcessEnvironment, other: QProcessEnvironment): bool =
  fcQProcessEnvironment_operatorEqual(self.h, other.h)

proc operatorNotEqual*(self: gen_qprocess_types.QProcessEnvironment, other: QProcessEnvironment): bool =
...
proc insert*(self: gen_qprocess_types.QProcessEnvironment, e: QProcessEnvironment): void =
  fcQProcessEnvironment_insertWithQProcessEnvironment(self.h, e.h)

proc systemEnvironment*(_: type gen_qprocess_types.QProcessEnvironment, ): QProcessEnvironment =
...
proc create*(T: type gen_qprocess_types.QProcess, parent: QObject): gen_qprocess_types.QProcess =
  gen_qprocess_types.QProcess.init(fcQProcess_new2(parent.h))

proc metaObject*(self: gen_qprocess_types.QProcess, ): QMetaObject =
  QMetaObject(h: fcQProcess_metaObject(self.h))
...
proc setStandardOutputProcess*(self: gen_qprocess_types.QProcess, destination: QProcess): void =
...
proc setProcessEnvironment*(self: gen_qprocess_types.QProcess, environment: QProcessEnvironment): void =
  fcQProcess_setProcessEnvironment(self.h, environment.h)

proc processEnvironment*(self: gen_qprocess_types.QProcess, ): QProcessEnvironment =
...
proc onmetacall*(self: gen_qprocess_types.QProcess, slot: QProcessmetacallProc) =
  # TODO check subclass
  var tmp = new QProcessmetacallProc
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QProcess_metacall(self: ptr cQProcess, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QProcess_metacall ".} =
  var nimfunc = cast[ptr QProcessmetacallProc](cast[pointer](slot))
...
proc onskipData*(self: gen_qprocess_types.QProcess, slot: QProcessskipDataProc) =
  # TODO check subclass
  var tmp = new QProcessskipDataProc
  tmp[] = slot
  GC_ref(tmp)
  fcQProcess_override_virtual_skipData(self.h, cast[int](addr tmp[]))

proc miqt_exec_callback_QProcess_skipData(self: ptr cQProcess, slot: int, maxSize: clonglong): clonglong {.exportc: "miqt_exec_callback_QProcess_skipData ".} =
  var nimfunc = cast[ptr QProcessskipDataProc](cast[pointer](slot))
  ...
  virtualReturn
proc QProcessevent*(self: gen_qprocess_types.QProcess, event: QEvent): bool =
  fQProcess_virtualbase_event(self.h, event.h)

type QProcesseventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QProcess_event(self: ptr cQProcess, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QProcess_event ".} =
  ...
  virtualReturn
proc QProcesseventFilter*(self: gen_qprocess_types.QProcess, watched: QObject, event: QEvent): bool =
  fQProcess_virtualbase_eventFilter(self.h, watched.h, event.h)

type QProcesseventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QProcess_eventFilter(self: ptr cQProcess, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QProcess_eventFilter ".} =
  ...
  virtualReturn
proc QProcesstimerEvent*(self: gen_qprocess_types.QProcess, event: QTimerEvent): void =
  fQProcess_virtualbase_timerEvent(self.h, event.h)

type QProcesstimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QProcess_timerEvent(self: ptr cQProcess, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QProcess_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QProcesschildEvent*(self: gen_qprocess_types.QProcess, event: QChildEvent): void =
  fQProcess_virtualbase_childEvent(self.h, event.h)

type QProcesschildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QProcess_childEvent(self: ptr cQProcess, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QProcess_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QProcesscustomEvent*(self: gen_qprocess_types.QProcess, event: QEvent): void =
  fQProcess_virtualbase_customEvent(self.h, event.h)

type QProcesscustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QProcess_customEvent(self: ptr cQProcess, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QProcess_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QProcessconnectNotify*(self: gen_qprocess_types.QProcess, signal: QMetaMethod): void =
  fQProcess_virtualbase_connectNotify(self.h, signal.h)

type QProcessconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QProcess_connectNotify(self: ptr cQProcess, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QProcess_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QProcessdisconnectNotify*(self: gen_qprocess_types.QProcess, signal: QMetaMethod): void =
  fQProcess_virtualbase_disconnectNotify(self.h, signal.h)

type QProcessdisconnectNotifyProc* = proc(signal: QMetaMethod): void
