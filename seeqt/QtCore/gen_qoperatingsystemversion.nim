...
proc create*(T: type gen_qoperatingsystemversion_types.QOperatingSystemVersionBase, param1: QOperatingSystemVersionBase): gen_qoperatingsystemversion_types.QOperatingSystemVersionBase =
...
proc current*(_: type gen_qoperatingsystemversion_types.QOperatingSystemVersionBase, ): QOperatingSystemVersionBase =
  QOperatingSystemVersionBase(h: fcQOperatingSystemVersionBase_current())

proc name*(_: type gen_qoperatingsystemversion_types.QOperatingSystemVersionBase, osversion: QOperatingSystemVersionBase): string =
...
proc version*(self: gen_qoperatingsystemversion_types.QOperatingSystemVersionBase, ): QVersionNumber =
  QVersionNumber(h: fcQOperatingSystemVersionBase_version(self.h))
...
func init*(T: type gen_qoperatingsystemversion_types.QOperatingSystemVersion, h: ptr cQOperatingSystemVersion): gen_qoperatingsystemversion_types.QOperatingSystemVersion =
  T(h: h)
proc create*(T: type gen_qoperatingsystemversion_types.QOperatingSystemVersion, osversion: QOperatingSystemVersionBase): gen_qoperatingsystemversion_types.QOperatingSystemVersion =
...
proc create*(T: type gen_qoperatingsystemversion_types.QOperatingSystemVersion, param1: QOperatingSystemVersion): gen_qoperatingsystemversion_types.QOperatingSystemVersion =
...
proc current*(_: type gen_qoperatingsystemversion_types.QOperatingSystemVersion, ): QOperatingSystemVersion =
...
proc version*(self: gen_qoperatingsystemversion_types.QOperatingSystemVersion, ): QVersionNumber =
  QVersionNumber(h: fcQOperatingSystemVersion_version(self.h))
