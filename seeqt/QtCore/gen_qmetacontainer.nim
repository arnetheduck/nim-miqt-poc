...
proc fcQMetaSequence_delete(self: pointer) {.importc: "QMetaSequence_delete".}
...
proc create*(T: type gen_qmetacontainer_types.QMetaContainer, param1: QMetaContainer): gen_qmetacontainer_types.QMetaContainer =
...
proc valueMetaType*(self: gen_qmetacontainer_types.QMetaSequence, ): QMetaType =
  QMetaType(h: fcQMetaSequence_valueMetaType(self.h))
...
proc keyMetaType*(self: gen_qmetacontainer_types.QMetaAssociation, ): QMetaType =
  QMetaType(h: fcQMetaAssociation_keyMetaType(self.h))

proc mappedMetaType*(self: gen_qmetacontainer_types.QMetaAssociation, ): QMetaType =
  QMetaType(h: fcQMetaAssociation_mappedMetaType(self.h))
