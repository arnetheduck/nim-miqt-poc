...
proc create*(T: type gen_qthread_types.QThread, parent: QObject): gen_qthread_types.QThread =
  gen_qthread_types.QThread.init(fcQThread_new2(parent.h))

proc metaObject*(self: gen_qthread_types.QThread, ): QMetaObject =
  QMetaObject(h: fcQThread_metaObject(self.h))
...
proc currentThread*(_: type gen_qthread_types.QThread, ): QThread =
...
proc eventDispatcher*(self: gen_qthread_types.QThread, ): QAbstractEventDispatcher =
  QAbstractEventDispatcher(h: fcQThread_eventDispatcher(self.h))

proc setEventDispatcher*(self: gen_qthread_types.QThread, eventDispatcher: QAbstractEventDispatcher): void =
  fcQThread_setEventDispatcher(self.h, eventDispatcher.h)

proc event*(self: gen_qthread_types.QThread, event: QEvent): bool =
...
proc wait*(self: gen_qthread_types.QThread, deadline: QDeadlineTimer): bool =
...
proc miqt_exec_callback_QThread_metacall(self: ptr cQThread, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QThread_metacall ".} =
  ...
  virtualReturn
proc QThreadevent*(self: gen_qthread_types.QThread, event: QEvent): bool =
  fQThread_virtualbase_event(self.h, event.h)

type QThreadeventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QThread_run(self: ptr cQThread, slot: int): void {.exportc: "miqt_exec_callback_QThread_run ".} =
  ...
  nimfunc[]()
proc QThreadeventFilter*(self: gen_qthread_types.QThread, watched: QObject, event: QEvent): bool =
  fQThread_virtualbase_eventFilter(self.h, watched.h, event.h)

type QThreadeventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QThread_eventFilter(self: ptr cQThread, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QThread_eventFilter ".} =
  ...
  virtualReturn
proc QThreadtimerEvent*(self: gen_qthread_types.QThread, event: QTimerEvent): void =
  fQThread_virtualbase_timerEvent(self.h, event.h)

type QThreadtimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QThread_timerEvent(self: ptr cQThread, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QThread_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QThreadchildEvent*(self: gen_qthread_types.QThread, event: QChildEvent): void =
  fQThread_virtualbase_childEvent(self.h, event.h)

type QThreadchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QThread_childEvent(self: ptr cQThread, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QThread_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QThreadcustomEvent*(self: gen_qthread_types.QThread, event: QEvent): void =
  fQThread_virtualbase_customEvent(self.h, event.h)

type QThreadcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QThread_customEvent(self: ptr cQThread, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QThread_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QThreadconnectNotify*(self: gen_qthread_types.QThread, signal: QMetaMethod): void =
  fQThread_virtualbase_connectNotify(self.h, signal.h)

type QThreadconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QThread_connectNotify(self: ptr cQThread, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QThread_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QThreaddisconnectNotify*(self: gen_qthread_types.QThread, signal: QMetaMethod): void =
  fQThread_virtualbase_disconnectNotify(self.h, signal.h)

type QThreaddisconnectNotifyProc* = proc(signal: QMetaMethod): void
