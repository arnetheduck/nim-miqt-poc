...
proc create*(T: type gen_qeasingcurve_types.QEasingCurve, other: QEasingCurve): gen_qeasingcurve_types.QEasingCurve =
...
proc operatorAssign*(self: gen_qeasingcurve_types.QEasingCurve, other: QEasingCurve): void =
  fcQEasingCurve_operatorAssign(self.h, other.h)

proc swap*(self: gen_qeasingcurve_types.QEasingCurve, other: QEasingCurve): void =
  fcQEasingCurve_swap(self.h, other.h)

proc operatorEqual*(self: gen_qeasingcurve_types.QEasingCurve, other: QEasingCurve): bool =
  fcQEasingCurve_operatorEqual(self.h, other.h)

proc operatorNotEqual*(self: gen_qeasingcurve_types.QEasingCurve, other: QEasingCurve): bool =
...
proc addCubicBezierSegment*(self: gen_qeasingcurve_types.QEasingCurve, c1: QPointF, c2: QPointF, endPoint: QPointF): void =
  fcQEasingCurve_addCubicBezierSegment(self.h, c1.h, c2.h, endPoint.h)

proc addTCBSegment*(self: gen_qeasingcurve_types.QEasingCurve, nextPoint: QPointF, t: float64, c: float64, b: float64): void =
  fcQEasingCurve_addTCBSegment(self.h, nextPoint.h, t, c, b)

proc toCubicSpline*(self: gen_qeasingcurve_types.QEasingCurve, ): seq[QPointF] =
