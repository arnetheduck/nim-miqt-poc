...
QMetaObject* QFinalState_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQFinalState*)(self) )->QFinalState::metaObject();

}

void* QFinalState_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQFinalState*)(self) )->QFinalState::qt_metacast(param1);

}

int QFinalState_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQFinalState*)(self) )->QFinalState::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
QObject* QFinalState_protectedbase_sender(const void* self) {
	MiqtVirtualQFinalState* self_cast = static_cast<MiqtVirtualQFinalState*>( (QFinalState*)(self) );
