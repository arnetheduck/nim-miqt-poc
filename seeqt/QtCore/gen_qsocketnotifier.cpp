...
public:
	...
	MiqtVirtualQSocketNotifier(struct QSocketNotifier_VTable* vtbl, QSocketNotifier::Type param1): QSocketNotifier(param1), vtbl(vtbl) {};
	...
	MiqtVirtualQSocketNotifier(struct QSocketNotifier_VTable* vtbl, QSocketNotifier::Type param1, QObject* parent): QSocketNotifier(param1, parent), vtbl(vtbl) {};
...
QSocketNotifier* QSocketNotifier_new(struct QSocketNotifier_VTable* vtbl, int param1) {
	return new MiqtVirtualQSocketNotifier(vtbl, static_cast<QSocketNotifier::Type>(param1));
}
...
QSocketNotifier* QSocketNotifier_new3(struct QSocketNotifier_VTable* vtbl, int param1, QObject* parent) {
	return new MiqtVirtualQSocketNotifier(vtbl, static_cast<QSocketNotifier::Type>(param1), parent);
}
...
QMetaObject* QSocketNotifier_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQSocketNotifier*)(self) )->QSocketNotifier::metaObject();

}

void* QSocketNotifier_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQSocketNotifier*)(self) )->QSocketNotifier::qt_metacast(param1);

}

int QSocketNotifier_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQSocketNotifier*)(self) )->QSocketNotifier::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
QObject* QSocketNotifier_protectedbase_sender(const void* self) {
	MiqtVirtualQSocketNotifier* self_cast = static_cast<MiqtVirtualQSocketNotifier*>( (QSocketNotifier*)(self) );
