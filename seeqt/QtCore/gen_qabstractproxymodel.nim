...
proc create*(T: type gen_qabstractproxymodel_types.QAbstractProxyModel, parent: QObject): gen_qabstractproxymodel_types.QAbstractProxyModel =
  gen_qabstractproxymodel_types.QAbstractProxyModel.init(fcQAbstractProxyModel_new2(parent.h))

proc metaObject*(self: gen_qabstractproxymodel_types.QAbstractProxyModel, ): QMetaObject =
  QMetaObject(h: fcQAbstractProxyModel_metaObject(self.h))
...
proc setSourceModel*(self: gen_qabstractproxymodel_types.QAbstractProxyModel, sourceModel: QAbstractItemModel): void =
  fcQAbstractProxyModel_setSourceModel(self.h, sourceModel.h)

proc sourceModel*(self: gen_qabstractproxymodel_types.QAbstractProxyModel, ): QAbstractItemModel =
  QAbstractItemModel(h: fcQAbstractProxyModel_sourceModel(self.h))

proc mapToSource*(self: gen_qabstractproxymodel_types.QAbstractProxyModel, proxyIndex: QModelIndex): QModelIndex =
  QModelIndex(h: fcQAbstractProxyModel_mapToSource(self.h, proxyIndex.h))

proc mapFromSource*(self: gen_qabstractproxymodel_types.QAbstractProxyModel, sourceIndex: QModelIndex): QModelIndex =
  QModelIndex(h: fcQAbstractProxyModel_mapFromSource(self.h, sourceIndex.h))

proc mapSelectionToSource*(self: gen_qabstractproxymodel_types.QAbstractProxyModel, selection: QItemSelection): QItemSelection =
  QItemSelection(h: fcQAbstractProxyModel_mapSelectionToSource(self.h, selection.h))

proc mapSelectionFromSource*(self: gen_qabstractproxymodel_types.QAbstractProxyModel, selection: QItemSelection): QItemSelection =
  QItemSelection(h: fcQAbstractProxyModel_mapSelectionFromSource(self.h, selection.h))
...
proc data*(self: gen_qabstractproxymodel_types.QAbstractProxyModel, proxyIndex: QModelIndex, role: cint): QVariant =
  QVariant(h: fcQAbstractProxyModel_data(self.h, proxyIndex.h, role))

proc headerData*(self: gen_qabstractproxymodel_types.QAbstractProxyModel, section: cint, orientation: cint, role: cint): QVariant =
  QVariant(h: fcQAbstractProxyModel_headerData(self.h, section, cint(orientation), role))

proc itemData*(self: gen_qabstractproxymodel_types.QAbstractProxyModel, index: QModelIndex): Table[cint,QVariant] =
...
proc flags*(self: gen_qabstractproxymodel_types.QAbstractProxyModel, index: QModelIndex): cint =
  cint(fcQAbstractProxyModel_flags(self.h, index.h))

proc setData*(self: gen_qabstractproxymodel_types.QAbstractProxyModel, index: QModelIndex, value: QVariant, role: cint): bool =
  fcQAbstractProxyModel_setData(self.h, index.h, value.h, role)

proc setItemData*(self: gen_qabstractproxymodel_types.QAbstractProxyModel, index: QModelIndex, roles: Table[cint,QVariant]): bool =
...
proc setHeaderData*(self: gen_qabstractproxymodel_types.QAbstractProxyModel, section: cint, orientation: cint, value: QVariant, role: cint): bool =
  fcQAbstractProxyModel_setHeaderData(self.h, section, cint(orientation), value.h, role)

proc clearItemData*(self: gen_qabstractproxymodel_types.QAbstractProxyModel, index: QModelIndex): bool =
  fcQAbstractProxyModel_clearItemData(self.h, index.h)

proc buddy*(self: gen_qabstractproxymodel_types.QAbstractProxyModel, index: QModelIndex): QModelIndex =
  QModelIndex(h: fcQAbstractProxyModel_buddy(self.h, index.h))

proc canFetchMore*(self: gen_qabstractproxymodel_types.QAbstractProxyModel, parent: QModelIndex): bool =
  fcQAbstractProxyModel_canFetchMore(self.h, parent.h)

proc fetchMore*(self: gen_qabstractproxymodel_types.QAbstractProxyModel, parent: QModelIndex): void =
...
proc span*(self: gen_qabstractproxymodel_types.QAbstractProxyModel, index: QModelIndex): QSize =
  QSize(h: fcQAbstractProxyModel_span(self.h, index.h))

proc hasChildren*(self: gen_qabstractproxymodel_types.QAbstractProxyModel, parent: QModelIndex): bool =
  fcQAbstractProxyModel_hasChildren(self.h, parent.h)

proc sibling*(self: gen_qabstractproxymodel_types.QAbstractProxyModel, row: cint, column: cint, idx: QModelIndex): QModelIndex =
  QModelIndex(h: fcQAbstractProxyModel_sibling(self.h, row, column, idx.h))

proc mimeData*(self: gen_qabstractproxymodel_types.QAbstractProxyModel, indexes: seq[QModelIndex]): QMimeData =
  var indexes_CArray = newSeq[pointer](len(indexes))
  for i in 0..<len(indexes):
    indexes_CArray[i] = indexes[i].h

  QMimeData(h: fcQAbstractProxyModel_mimeData(self.h, struct_miqt_array(len: csize_t(len(indexes)), data: if len(indexes) == 0: nil else: addr(indexes_CArray[0]))))

proc canDropMimeData*(self: gen_qabstractproxymodel_types.QAbstractProxyModel, data: QMimeData, action: cint, row: cint, column: cint, parent: QModelIndex): bool =
  fcQAbstractProxyModel_canDropMimeData(self.h, data.h, cint(action), row, column, parent.h)

proc dropMimeData*(self: gen_qabstractproxymodel_types.QAbstractProxyModel, data: QMimeData, action: cint, row: cint, column: cint, parent: QModelIndex): bool =
...
proc miqt_exec_callback_QAbstractProxyModel_metacall(self: ptr cQAbstractProxyModel, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QAbstractProxyModel_metacall ".} =
  ...
  virtualReturn
proc QAbstractProxyModelsetSourceModel*(self: gen_qabstractproxymodel_types.QAbstractProxyModel, sourceModel: QAbstractItemModel): void =
  fQAbstractProxyModel_virtualbase_setSourceModel(self.h, sourceModel.h)

type QAbstractProxyModelsetSourceModelProc* = proc(sourceModel: QAbstractItemModel): void
...
proc miqt_exec_callback_QAbstractProxyModel_setSourceModel(self: ptr cQAbstractProxyModel, slot: int, sourceModel: pointer): void {.exportc: "miqt_exec_callback_QAbstractProxyModel_setSourceModel ".} =
  ...
  nimfunc[](slotval1)
type QAbstractProxyModelmapToSourceProc* = proc(proxyIndex: QModelIndex): QModelIndex
...
proc miqt_exec_callback_QAbstractProxyModel_mapToSource(self: ptr cQAbstractProxyModel, slot: int, proxyIndex: pointer): pointer {.exportc: "miqt_exec_callback_QAbstractProxyModel_mapToSource ".} =
  ...
  virtualReturn.h
type QAbstractProxyModelmapFromSourceProc* = proc(sourceIndex: QModelIndex): QModelIndex
...
proc miqt_exec_callback_QAbstractProxyModel_mapFromSource(self: ptr cQAbstractProxyModel, slot: int, sourceIndex: pointer): pointer {.exportc: "miqt_exec_callback_QAbstractProxyModel_mapFromSource ".} =
  ...
  virtualReturn.h
proc QAbstractProxyModelmapSelectionToSource*(self: gen_qabstractproxymodel_types.QAbstractProxyModel, selection: QItemSelection): QItemSelection =
  QItemSelection(h: fQAbstractProxyModel_virtualbase_mapSelectionToSource(self.h, selection.h))

type QAbstractProxyModelmapSelectionToSourceProc* = proc(selection: QItemSelection): QItemSelection
...
proc miqt_exec_callback_QAbstractProxyModel_mapSelectionToSource(self: ptr cQAbstractProxyModel, slot: int, selection: pointer): pointer {.exportc: "miqt_exec_callback_QAbstractProxyModel_mapSelectionToSource ".} =
  ...
  virtualReturn.h
proc QAbstractProxyModelmapSelectionFromSource*(self: gen_qabstractproxymodel_types.QAbstractProxyModel, selection: QItemSelection): QItemSelection =
  QItemSelection(h: fQAbstractProxyModel_virtualbase_mapSelectionFromSource(self.h, selection.h))

type QAbstractProxyModelmapSelectionFromSourceProc* = proc(selection: QItemSelection): QItemSelection
...
proc miqt_exec_callback_QAbstractProxyModel_revert(self: ptr cQAbstractProxyModel, slot: int): void {.exportc: "miqt_exec_callback_QAbstractProxyModel_revert ".} =
  ...
  nimfunc[]()
proc QAbstractProxyModeldata*(self: gen_qabstractproxymodel_types.QAbstractProxyModel, proxyIndex: QModelIndex, role: cint): QVariant =
  QVariant(h: fQAbstractProxyModel_virtualbase_data(self.h, proxyIndex.h, role))

type QAbstractProxyModeldataProc* = proc(proxyIndex: QModelIndex, role: cint): QVariant
...
proc miqt_exec_callback_QAbstractProxyModel_data(self: ptr cQAbstractProxyModel, slot: int, proxyIndex: pointer, role: cint): pointer {.exportc: "miqt_exec_callback_QAbstractProxyModel_data ".} =
  ...
  virtualReturn.h
proc QAbstractProxyModelheaderData*(self: gen_qabstractproxymodel_types.QAbstractProxyModel, section: cint, orientation: cint, role: cint): QVariant =
  QVariant(h: fQAbstractProxyModel_virtualbase_headerData(self.h, section, cint(orientation), role))

type QAbstractProxyModelheaderDataProc* = proc(section: cint, orientation: cint, role: cint): QVariant
...
proc miqt_exec_callback_QAbstractProxyModel_headerData(self: ptr cQAbstractProxyModel, slot: int, section: cint, orientation: cint, role: cint): pointer {.exportc: "miqt_exec_callback_QAbstractProxyModel_headerData ".} =
  ...
  virtualReturn.h
proc QAbstractProxyModelitemData*(self: gen_qabstractproxymodel_types.QAbstractProxyModel, index: QModelIndex): Table[cint,QVariant] =
...
type QAbstractProxyModelitemDataProc* = proc(index: QModelIndex): Table[cint,QVariant]
...
proc QAbstractProxyModelflags*(self: gen_qabstractproxymodel_types.QAbstractProxyModel, index: QModelIndex): cint =
  cint(fQAbstractProxyModel_virtualbase_flags(self.h, index.h))

type QAbstractProxyModelflagsProc* = proc(index: QModelIndex): cint
...
proc miqt_exec_callback_QAbstractProxyModel_flags(self: ptr cQAbstractProxyModel, slot: int, index: pointer): cint {.exportc: "miqt_exec_callback_QAbstractProxyModel_flags ".} =
  ...
  cint(virtualReturn)
proc QAbstractProxyModelsetData*(self: gen_qabstractproxymodel_types.QAbstractProxyModel, index: QModelIndex, value: QVariant, role: cint): bool =
  fQAbstractProxyModel_virtualbase_setData(self.h, index.h, value.h, role)

type QAbstractProxyModelsetDataProc* = proc(index: QModelIndex, value: QVariant, role: cint): bool
...
proc miqt_exec_callback_QAbstractProxyModel_setData(self: ptr cQAbstractProxyModel, slot: int, index: pointer, value: pointer, role: cint): bool {.exportc: "miqt_exec_callback_QAbstractProxyModel_setData ".} =
  ...
  virtualReturn
proc QAbstractProxyModelsetItemData*(self: gen_qabstractproxymodel_types.QAbstractProxyModel, index: QModelIndex, roles: Table[cint,QVariant]): bool =
  var roles_Keys_CArray = newSeq[cint](len(roles))
  var roles_Values_CArray = newSeq[pointer](len(roles))
  var roles_ctr = 0
  for rolesk, rolesv in roles:
...
type QAbstractProxyModelsetItemDataProc* = proc(index: QModelIndex, roles: Table[cint,QVariant]): bool
...
proc miqt_exec_callback_QAbstractProxyModel_setItemData(self: ptr cQAbstractProxyModel, slot: int, index: pointer, roles: struct_miqt_map): bool {.exportc: "miqt_exec_callback_QAbstractProxyModel_setItemData ".} =
  ...
  virtualReturn
proc QAbstractProxyModelsetHeaderData*(self: gen_qabstractproxymodel_types.QAbstractProxyModel, section: cint, orientation: cint, value: QVariant, role: cint): bool =
  fQAbstractProxyModel_virtualbase_setHeaderData(self.h, section, cint(orientation), value.h, role)

type QAbstractProxyModelsetHeaderDataProc* = proc(section: cint, orientation: cint, value: QVariant, role: cint): bool
...
proc miqt_exec_callback_QAbstractProxyModel_setHeaderData(self: ptr cQAbstractProxyModel, slot: int, section: cint, orientation: cint, value: pointer, role: cint): bool {.exportc: "miqt_exec_callback_QAbstractProxyModel_setHeaderData ".} =
  ...
  virtualReturn
proc QAbstractProxyModelclearItemData*(self: gen_qabstractproxymodel_types.QAbstractProxyModel, index: QModelIndex): bool =
  fQAbstractProxyModel_virtualbase_clearItemData(self.h, index.h)

type QAbstractProxyModelclearItemDataProc* = proc(index: QModelIndex): bool
...
proc miqt_exec_callback_QAbstractProxyModel_clearItemData(self: ptr cQAbstractProxyModel, slot: int, index: pointer): bool {.exportc: "miqt_exec_callback_QAbstractProxyModel_clearItemData ".} =
  ...
  virtualReturn
proc QAbstractProxyModelbuddy*(self: gen_qabstractproxymodel_types.QAbstractProxyModel, index: QModelIndex): QModelIndex =
  QModelIndex(h: fQAbstractProxyModel_virtualbase_buddy(self.h, index.h))

type QAbstractProxyModelbuddyProc* = proc(index: QModelIndex): QModelIndex
...
proc miqt_exec_callback_QAbstractProxyModel_buddy(self: ptr cQAbstractProxyModel, slot: int, index: pointer): pointer {.exportc: "miqt_exec_callback_QAbstractProxyModel_buddy ".} =
  ...
  virtualReturn.h
proc QAbstractProxyModelcanFetchMore*(self: gen_qabstractproxymodel_types.QAbstractProxyModel, parent: QModelIndex): bool =
  fQAbstractProxyModel_virtualbase_canFetchMore(self.h, parent.h)

type QAbstractProxyModelcanFetchMoreProc* = proc(parent: QModelIndex): bool
...
proc miqt_exec_callback_QAbstractProxyModel_canFetchMore(self: ptr cQAbstractProxyModel, slot: int, parent: pointer): bool {.exportc: "miqt_exec_callback_QAbstractProxyModel_canFetchMore ".} =
  ...
  virtualReturn
proc QAbstractProxyModelfetchMore*(self: gen_qabstractproxymodel_types.QAbstractProxyModel, parent: QModelIndex): void =
  fQAbstractProxyModel_virtualbase_fetchMore(self.h, parent.h)

type QAbstractProxyModelfetchMoreProc* = proc(parent: QModelIndex): void
...
proc QAbstractProxyModelspan*(self: gen_qabstractproxymodel_types.QAbstractProxyModel, index: QModelIndex): QSize =
  QSize(h: fQAbstractProxyModel_virtualbase_span(self.h, index.h))

type QAbstractProxyModelspanProc* = proc(index: QModelIndex): QSize
...
proc miqt_exec_callback_QAbstractProxyModel_span(self: ptr cQAbstractProxyModel, slot: int, index: pointer): pointer {.exportc: "miqt_exec_callback_QAbstractProxyModel_span ".} =
  ...
  virtualReturn.h
proc QAbstractProxyModelhasChildren*(self: gen_qabstractproxymodel_types.QAbstractProxyModel, parent: QModelIndex): bool =
  fQAbstractProxyModel_virtualbase_hasChildren(self.h, parent.h)

type QAbstractProxyModelhasChildrenProc* = proc(parent: QModelIndex): bool
...
proc miqt_exec_callback_QAbstractProxyModel_hasChildren(self: ptr cQAbstractProxyModel, slot: int, parent: pointer): bool {.exportc: "miqt_exec_callback_QAbstractProxyModel_hasChildren ".} =
  ...
  virtualReturn
proc QAbstractProxyModelsibling*(self: gen_qabstractproxymodel_types.QAbstractProxyModel, row: cint, column: cint, idx: QModelIndex): QModelIndex =
  QModelIndex(h: fQAbstractProxyModel_virtualbase_sibling(self.h, row, column, idx.h))

type QAbstractProxyModelsiblingProc* = proc(row: cint, column: cint, idx: QModelIndex): QModelIndex
...
proc miqt_exec_callback_QAbstractProxyModel_sibling(self: ptr cQAbstractProxyModel, slot: int, row: cint, column: cint, idx: pointer): pointer {.exportc: "miqt_exec_callback_QAbstractProxyModel_sibling ".} =
  ...
  virtualReturn.h
proc QAbstractProxyModelmimeData*(self: gen_qabstractproxymodel_types.QAbstractProxyModel, indexes: seq[QModelIndex]): QMimeData =
  var indexes_CArray = newSeq[pointer](len(indexes))
  for i in 0..<len(indexes):
    indexes_CArray[i] = indexes[i].h

  QMimeData(h: fQAbstractProxyModel_virtualbase_mimeData(self.h, struct_miqt_array(len: csize_t(len(indexes)), data: if len(indexes) == 0: nil else: addr(indexes_CArray[0]))))

type QAbstractProxyModelmimeDataProc* = proc(indexes: seq[QModelIndex]): QMimeData
...
proc miqt_exec_callback_QAbstractProxyModel_mimeData(self: ptr cQAbstractProxyModel, slot: int, indexes: struct_miqt_array): pointer {.exportc: "miqt_exec_callback_QAbstractProxyModel_mimeData ".} =
  ...
  virtualReturn.h
proc QAbstractProxyModelcanDropMimeData*(self: gen_qabstractproxymodel_types.QAbstractProxyModel, data: QMimeData, action: cint, row: cint, column: cint, parent: QModelIndex): bool =
  fQAbstractProxyModel_virtualbase_canDropMimeData(self.h, data.h, cint(action), row, column, parent.h)

type QAbstractProxyModelcanDropMimeDataProc* = proc(data: QMimeData, action: cint, row: cint, column: cint, parent: QModelIndex): bool
...
proc miqt_exec_callback_QAbstractProxyModel_canDropMimeData(self: ptr cQAbstractProxyModel, slot: int, data: pointer, action: cint, row: cint, column: cint, parent: pointer): bool {.exportc: "miqt_exec_callback_QAbstractProxyModel_canDropMimeData ".} =
  ...
  virtualReturn
proc QAbstractProxyModeldropMimeData*(self: gen_qabstractproxymodel_types.QAbstractProxyModel, data: QMimeData, action: cint, row: cint, column: cint, parent: QModelIndex): bool =
  fQAbstractProxyModel_virtualbase_dropMimeData(self.h, data.h, cint(action), row, column, parent.h)

type QAbstractProxyModeldropMimeDataProc* = proc(data: QMimeData, action: cint, row: cint, column: cint, parent: QModelIndex): bool
...
proc miqt_exec_callback_QAbstractProxyModel_roleNames(self: ptr cQAbstractProxyModel, slot: int): struct_miqt_map {.exportc: "miqt_exec_callback_QAbstractProxyModel_roleNames ".} =
  ...
  struct_miqt_map(len: csize_t(len(virtualReturn)),keys: if len(virtualReturn) == 0: nil else: addr(virtualReturn_Keys_CArray[0]), values: if len(virtualReturn) == 0: nil else: addr(virtualReturn_Values_CArray[0]),)
type QAbstractProxyModelindexProc* = proc(row: cint, column: cint, parent: QModelIndex): QModelIndex
...
proc miqt_exec_callback_QAbstractProxyModel_index(self: ptr cQAbstractProxyModel, slot: int, row: cint, column: cint, parent: pointer): pointer {.exportc: "miqt_exec_callback_QAbstractProxyModel_index ".} =
  ...
  virtualReturn.h
type QAbstractProxyModelparentProc* = proc(child: QModelIndex): QModelIndex
...
proc miqt_exec_callback_QAbstractProxyModel_parent(self: ptr cQAbstractProxyModel, slot: int, child: pointer): pointer {.exportc: "miqt_exec_callback_QAbstractProxyModel_parent ".} =
  ...
  virtualReturn.h
type QAbstractProxyModelrowCountProc* = proc(parent: QModelIndex): cint
...
proc miqt_exec_callback_QAbstractProxyModel_rowCount(self: ptr cQAbstractProxyModel, slot: int, parent: pointer): cint {.exportc: "miqt_exec_callback_QAbstractProxyModel_rowCount ".} =
  ...
  virtualReturn
type QAbstractProxyModelcolumnCountProc* = proc(parent: QModelIndex): cint
...
proc miqt_exec_callback_QAbstractProxyModel_columnCount(self: ptr cQAbstractProxyModel, slot: int, parent: pointer): cint {.exportc: "miqt_exec_callback_QAbstractProxyModel_columnCount ".} =
  ...
  virtualReturn
proc QAbstractProxyModelinsertRows*(self: gen_qabstractproxymodel_types.QAbstractProxyModel, row: cint, count: cint, parent: QModelIndex): bool =
  fQAbstractProxyModel_virtualbase_insertRows(self.h, row, count, parent.h)

type QAbstractProxyModelinsertRowsProc* = proc(row: cint, count: cint, parent: QModelIndex): bool
...
proc miqt_exec_callback_QAbstractProxyModel_insertRows(self: ptr cQAbstractProxyModel, slot: int, row: cint, count: cint, parent: pointer): bool {.exportc: "miqt_exec_callback_QAbstractProxyModel_insertRows ".} =
  ...
  virtualReturn
proc QAbstractProxyModelinsertColumns*(self: gen_qabstractproxymodel_types.QAbstractProxyModel, column: cint, count: cint, parent: QModelIndex): bool =
  fQAbstractProxyModel_virtualbase_insertColumns(self.h, column, count, parent.h)

type QAbstractProxyModelinsertColumnsProc* = proc(column: cint, count: cint, parent: QModelIndex): bool
...
proc miqt_exec_callback_QAbstractProxyModel_insertColumns(self: ptr cQAbstractProxyModel, slot: int, column: cint, count: cint, parent: pointer): bool {.exportc: "miqt_exec_callback_QAbstractProxyModel_insertColumns ".} =
  ...
  virtualReturn
proc QAbstractProxyModelremoveRows*(self: gen_qabstractproxymodel_types.QAbstractProxyModel, row: cint, count: cint, parent: QModelIndex): bool =
  fQAbstractProxyModel_virtualbase_removeRows(self.h, row, count, parent.h)

type QAbstractProxyModelremoveRowsProc* = proc(row: cint, count: cint, parent: QModelIndex): bool
...
proc miqt_exec_callback_QAbstractProxyModel_removeRows(self: ptr cQAbstractProxyModel, slot: int, row: cint, count: cint, parent: pointer): bool {.exportc: "miqt_exec_callback_QAbstractProxyModel_removeRows ".} =
  ...
  virtualReturn
proc QAbstractProxyModelremoveColumns*(self: gen_qabstractproxymodel_types.QAbstractProxyModel, column: cint, count: cint, parent: QModelIndex): bool =
  fQAbstractProxyModel_virtualbase_removeColumns(self.h, column, count, parent.h)

type QAbstractProxyModelremoveColumnsProc* = proc(column: cint, count: cint, parent: QModelIndex): bool
...
proc miqt_exec_callback_QAbstractProxyModel_removeColumns(self: ptr cQAbstractProxyModel, slot: int, column: cint, count: cint, parent: pointer): bool {.exportc: "miqt_exec_callback_QAbstractProxyModel_removeColumns ".} =
  ...
  virtualReturn
proc QAbstractProxyModelmoveRows*(self: gen_qabstractproxymodel_types.QAbstractProxyModel, sourceParent: QModelIndex, sourceRow: cint, count: cint, destinationParent: QModelIndex, destinationChild: cint): bool =
  fQAbstractProxyModel_virtualbase_moveRows(self.h, sourceParent.h, sourceRow, count, destinationParent.h, destinationChild)

type QAbstractProxyModelmoveRowsProc* = proc(sourceParent: QModelIndex, sourceRow: cint, count: cint, destinationParent: QModelIndex, destinationChild: cint): bool
...
proc miqt_exec_callback_QAbstractProxyModel_moveRows(self: ptr cQAbstractProxyModel, slot: int, sourceParent: pointer, sourceRow: cint, count: cint, destinationParent: pointer, destinationChild: cint): bool {.exportc: "miqt_exec_callback_QAbstractProxyModel_moveRows ".} =
  ...
  virtualReturn
proc QAbstractProxyModelmoveColumns*(self: gen_qabstractproxymodel_types.QAbstractProxyModel, sourceParent: QModelIndex, sourceColumn: cint, count: cint, destinationParent: QModelIndex, destinationChild: cint): bool =
...
type QAbstractProxyModelmoveColumnsProc* = proc(sourceParent: QModelIndex, sourceColumn: cint, count: cint, destinationParent: QModelIndex, destinationChild: cint): bool
...
proc miqt_exec_callback_QAbstractProxyModel_moveColumns(self: ptr cQAbstractProxyModel, slot: int, sourceParent: pointer, sourceColumn: cint, count: cint, destinationParent: pointer, destinationChild: cint): bool {.exportc: "miqt_exec_callback_QAbstractProxyModel_moveColumns ".} =
  ...
  virtualReturn
proc QAbstractProxyModelmatch*(self: gen_qabstractproxymodel_types.QAbstractProxyModel, start: QModelIndex, role: cint, value: QVariant, hits: cint, flags: cint): seq[QModelIndex] =
...
type QAbstractProxyModelmatchProc* = proc(start: QModelIndex, role: cint, value: QVariant, hits: cint, flags: cint): seq[QModelIndex]
...
proc miqt_exec_callback_QAbstractProxyModel_match(self: ptr cQAbstractProxyModel, slot: int, start: pointer, role: cint, value: pointer, hits: cint, flags: cint): struct_miqt_array {.exportc: "miqt_exec_callback_QAbstractProxyModel_match ".} =
  ...
  struct_miqt_array(len: csize_t(len(virtualReturn)), data: if len(virtualReturn) == 0: nil else: addr(virtualReturn_CArray[0]))
proc QAbstractProxyModelmultiData*(self: gen_qabstractproxymodel_types.QAbstractProxyModel, index: QModelIndex, roleDataSpan: QModelRoleDataSpan): void =
  fQAbstractProxyModel_virtualbase_multiData(self.h, index.h, roleDataSpan.h)

type QAbstractProxyModelmultiDataProc* = proc(index: QModelIndex, roleDataSpan: QModelRoleDataSpan): void
...
proc miqt_exec_callback_QAbstractProxyModel_resetInternalData(self: ptr cQAbstractProxyModel, slot: int): void {.exportc: "miqt_exec_callback_QAbstractProxyModel_resetInternalData ".} =
  ...
  nimfunc[]()
proc QAbstractProxyModelevent*(self: gen_qabstractproxymodel_types.QAbstractProxyModel, event: QEvent): bool =
  fQAbstractProxyModel_virtualbase_event(self.h, event.h)

type QAbstractProxyModeleventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QAbstractProxyModel_event(self: ptr cQAbstractProxyModel, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QAbstractProxyModel_event ".} =
  ...
  virtualReturn
proc QAbstractProxyModeleventFilter*(self: gen_qabstractproxymodel_types.QAbstractProxyModel, watched: QObject, event: QEvent): bool =
  fQAbstractProxyModel_virtualbase_eventFilter(self.h, watched.h, event.h)

type QAbstractProxyModeleventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QAbstractProxyModel_eventFilter(self: ptr cQAbstractProxyModel, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QAbstractProxyModel_eventFilter ".} =
  ...
  virtualReturn
proc QAbstractProxyModeltimerEvent*(self: gen_qabstractproxymodel_types.QAbstractProxyModel, event: QTimerEvent): void =
  fQAbstractProxyModel_virtualbase_timerEvent(self.h, event.h)

type QAbstractProxyModeltimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QAbstractProxyModel_timerEvent(self: ptr cQAbstractProxyModel, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QAbstractProxyModel_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QAbstractProxyModelchildEvent*(self: gen_qabstractproxymodel_types.QAbstractProxyModel, event: QChildEvent): void =
  fQAbstractProxyModel_virtualbase_childEvent(self.h, event.h)

type QAbstractProxyModelchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QAbstractProxyModel_childEvent(self: ptr cQAbstractProxyModel, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QAbstractProxyModel_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QAbstractProxyModelcustomEvent*(self: gen_qabstractproxymodel_types.QAbstractProxyModel, event: QEvent): void =
  fQAbstractProxyModel_virtualbase_customEvent(self.h, event.h)

type QAbstractProxyModelcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QAbstractProxyModel_customEvent(self: ptr cQAbstractProxyModel, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QAbstractProxyModel_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QAbstractProxyModelconnectNotify*(self: gen_qabstractproxymodel_types.QAbstractProxyModel, signal: QMetaMethod): void =
  fQAbstractProxyModel_virtualbase_connectNotify(self.h, signal.h)

type QAbstractProxyModelconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QAbstractProxyModel_connectNotify(self: ptr cQAbstractProxyModel, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QAbstractProxyModel_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QAbstractProxyModeldisconnectNotify*(self: gen_qabstractproxymodel_types.QAbstractProxyModel, signal: QMetaMethod): void =
  fQAbstractProxyModel_virtualbase_disconnectNotify(self.h, signal.h)

type QAbstractProxyModeldisconnectNotifyProc* = proc(signal: QMetaMethod): void
