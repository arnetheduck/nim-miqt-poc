...
func init*(T: type gen_qcborstreamwriter_types.QCborStreamWriter, h: ptr cQCborStreamWriter): gen_qcborstreamwriter_types.QCborStreamWriter =
  T(h: h)
proc create*(T: type gen_qcborstreamwriter_types.QCborStreamWriter, device: QIODevice): gen_qcborstreamwriter_types.QCborStreamWriter =
  gen_qcborstreamwriter_types.QCborStreamWriter.init(fcQCborStreamWriter_new(device.h))

proc setDevice*(self: gen_qcborstreamwriter_types.QCborStreamWriter, device: QIODevice): void =
  fcQCborStreamWriter_setDevice(self.h, device.h)

proc device*(self: gen_qcborstreamwriter_types.QCborStreamWriter, ): QIODevice =
  QIODevice(h: fcQCborStreamWriter_device(self.h))
