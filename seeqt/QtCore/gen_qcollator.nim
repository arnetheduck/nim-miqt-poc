...
proc fcQCollator_compare3(self: pointer, s1: pointer, len1: cint, s2: pointer, len2: cint): cint {.importc: "QCollator_compare3".}
...
func init*(T: type gen_qcollator_types.QCollatorSortKey, h: ptr cQCollatorSortKey): gen_qcollator_types.QCollatorSortKey =
  T(h: h)
proc create*(T: type gen_qcollator_types.QCollatorSortKey, other: QCollatorSortKey): gen_qcollator_types.QCollatorSortKey =
  gen_qcollator_types.QCollatorSortKey.init(fcQCollatorSortKey_new(other.h))

proc operatorAssign*(self: gen_qcollator_types.QCollatorSortKey, other: QCollatorSortKey): void =
  fcQCollatorSortKey_operatorAssign(self.h, other.h)

proc swap*(self: gen_qcollator_types.QCollatorSortKey, other: QCollatorSortKey): void =
  fcQCollatorSortKey_swap(self.h, other.h)

proc compare*(self: gen_qcollator_types.QCollatorSortKey, key: QCollatorSortKey): cint =
...
proc create*(T: type gen_qcollator_types.QCollator, locale: QLocale): gen_qcollator_types.QCollator =
  gen_qcollator_types.QCollator.init(fcQCollator_new2(locale.h))

proc create*(T: type gen_qcollator_types.QCollator, param1: QCollator): gen_qcollator_types.QCollator =
  gen_qcollator_types.QCollator.init(fcQCollator_new3(param1.h))

proc operatorAssign*(self: gen_qcollator_types.QCollator, param1: QCollator): void =
  fcQCollator_operatorAssign(self.h, param1.h)

proc swap*(self: gen_qcollator_types.QCollator, other: QCollator): void =
  fcQCollator_swap(self.h, other.h)

proc setLocale*(self: gen_qcollator_types.QCollator, locale: QLocale): void =
  fcQCollator_setLocale(self.h, locale.h)

proc locale*(self: gen_qcollator_types.QCollator, ): QLocale =
  QLocale(h: fcQCollator_locale(self.h))
...
proc compare*(self: gen_qcollator_types.QCollator, s1: QChar, len1: cint, s2: QChar, len2: cint): cint =
...
proc sortKey*(self: gen_qcollator_types.QCollator, string: string): QCollatorSortKey =
