...
proc create*(T: type gen_qthreadpool_types.QThreadPool, parent: QObject): gen_qthreadpool_types.QThreadPool =
  gen_qthreadpool_types.QThreadPool.init(fcQThreadPool_new2(parent.h))

proc metaObject*(self: gen_qthreadpool_types.QThreadPool, ): QMetaObject =
  QMetaObject(h: fcQThreadPool_metaObject(self.h))
...
proc globalInstance*(_: type gen_qthreadpool_types.QThreadPool, ): QThreadPool =
  QThreadPool(h: fcQThreadPool_globalInstance())

proc start*(self: gen_qthreadpool_types.QThreadPool, runnable: QRunnable): void =
  fcQThreadPool_start(self.h, runnable.h)

proc tryStart*(self: gen_qthreadpool_types.QThreadPool, runnable: QRunnable): bool =
  fcQThreadPool_tryStart(self.h, runnable.h)

proc startOnReservedThread*(self: gen_qthreadpool_types.QThreadPool, runnable: QRunnable): void =
...
proc contains*(self: gen_qthreadpool_types.QThreadPool, thread: QThread): bool =
  fcQThreadPool_contains(self.h, thread.h)

proc tryTake*(self: gen_qthreadpool_types.QThreadPool, runnable: QRunnable): bool =
...
proc start*(self: gen_qthreadpool_types.QThreadPool, runnable: QRunnable, priority: cint): void =
...
proc miqt_exec_callback_QThreadPool_metacall(self: ptr cQThreadPool, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QThreadPool_metacall ".} =
  ...
  virtualReturn
proc QThreadPoolevent*(self: gen_qthreadpool_types.QThreadPool, event: QEvent): bool =
  fQThreadPool_virtualbase_event(self.h, event.h)

type QThreadPooleventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QThreadPool_event(self: ptr cQThreadPool, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QThreadPool_event ".} =
  ...
  virtualReturn
proc QThreadPooleventFilter*(self: gen_qthreadpool_types.QThreadPool, watched: QObject, event: QEvent): bool =
  fQThreadPool_virtualbase_eventFilter(self.h, watched.h, event.h)

type QThreadPooleventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QThreadPool_eventFilter(self: ptr cQThreadPool, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QThreadPool_eventFilter ".} =
  ...
  virtualReturn
proc QThreadPooltimerEvent*(self: gen_qthreadpool_types.QThreadPool, event: QTimerEvent): void =
  fQThreadPool_virtualbase_timerEvent(self.h, event.h)

type QThreadPooltimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QThreadPool_timerEvent(self: ptr cQThreadPool, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QThreadPool_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QThreadPoolchildEvent*(self: gen_qthreadpool_types.QThreadPool, event: QChildEvent): void =
  fQThreadPool_virtualbase_childEvent(self.h, event.h)

type QThreadPoolchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QThreadPool_childEvent(self: ptr cQThreadPool, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QThreadPool_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QThreadPoolcustomEvent*(self: gen_qthreadpool_types.QThreadPool, event: QEvent): void =
  fQThreadPool_virtualbase_customEvent(self.h, event.h)

type QThreadPoolcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QThreadPool_customEvent(self: ptr cQThreadPool, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QThreadPool_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QThreadPoolconnectNotify*(self: gen_qthreadpool_types.QThreadPool, signal: QMetaMethod): void =
  fQThreadPool_virtualbase_connectNotify(self.h, signal.h)

type QThreadPoolconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QThreadPool_connectNotify(self: ptr cQThreadPool, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QThreadPool_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QThreadPooldisconnectNotify*(self: gen_qthreadpool_types.QThreadPool, signal: QMetaMethod): void =
  fQThreadPool_virtualbase_disconnectNotify(self.h, signal.h)

type QThreadPooldisconnectNotifyProc* = proc(signal: QMetaMethod): void
