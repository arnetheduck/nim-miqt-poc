...
QMetaObject* QMimeData_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQMimeData*)(self) )->QMimeData::metaObject();

}

void* QMimeData_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQMimeData*)(self) )->QMimeData::qt_metacast(param1);

}

int QMimeData_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQMimeData*)(self) )->QMimeData::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
QVariant* QMimeData_virtualbase_retrieveData(const void* self, struct miqt_string mimetype, int preferredType) {
	...
	return new QVariant(( (const MiqtVirtualQMimeData*)(self) )->QMimeData::retrieveData(mimetype_QString, static_cast<QVariant::Type>(preferredType)));
