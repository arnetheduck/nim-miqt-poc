...
QMetaObject* QObjectCleanupHandler_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQObjectCleanupHandler*)(self) )->QObjectCleanupHandler::metaObject();

}

void* QObjectCleanupHandler_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQObjectCleanupHandler*)(self) )->QObjectCleanupHandler::qt_metacast(param1);

}

int QObjectCleanupHandler_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQObjectCleanupHandler*)(self) )->QObjectCleanupHandler::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
QObject* QObjectCleanupHandler_protectedbase_sender(const void* self) {
	MiqtVirtualQObjectCleanupHandler* self_cast = static_cast<MiqtVirtualQObjectCleanupHandler*>( (QObjectCleanupHandler*)(self) );
