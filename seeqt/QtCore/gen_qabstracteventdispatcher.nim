...
func init*(T: type gen_qabstracteventdispatcher_types.QAbstractEventDispatcher, h: ptr cQAbstractEventDispatcher): gen_qabstracteventdispatcher_types.QAbstractEventDispatcher =
  T(h: h)
proc metaObject*(self: gen_qabstracteventdispatcher_types.QAbstractEventDispatcher, ): QMetaObject =
  QMetaObject(h: fcQAbstractEventDispatcher_metaObject(self.h))
...
proc instance*(_: type gen_qabstracteventdispatcher_types.QAbstractEventDispatcher, ): QAbstractEventDispatcher =
...
proc registerSocketNotifier*(self: gen_qabstracteventdispatcher_types.QAbstractEventDispatcher, notifier: QSocketNotifier): void =
  fcQAbstractEventDispatcher_registerSocketNotifier(self.h, notifier.h)

proc unregisterSocketNotifier*(self: gen_qabstracteventdispatcher_types.QAbstractEventDispatcher, notifier: QSocketNotifier): void =
  fcQAbstractEventDispatcher_unregisterSocketNotifier(self.h, notifier.h)

proc registerTimer*(self: gen_qabstracteventdispatcher_types.QAbstractEventDispatcher, interval: cint, timerType: cint, objectVal: QObject): cint =
  fcQAbstractEventDispatcher_registerTimer(self.h, interval, cint(timerType), objectVal.h)

proc registerTimer*(self: gen_qabstracteventdispatcher_types.QAbstractEventDispatcher, timerId: cint, interval: cint, timerType: cint, objectVal: QObject): void =
...
proc unregisterTimers*(self: gen_qabstracteventdispatcher_types.QAbstractEventDispatcher, objectVal: QObject): bool =
  fcQAbstractEventDispatcher_unregisterTimers(self.h, objectVal.h)

proc registeredTimers*(self: gen_qabstracteventdispatcher_types.QAbstractEventDispatcher, objectVal: QObject): seq[QAbstractEventDispatcherTimerInfo] =
...
proc installNativeEventFilter*(self: gen_qabstracteventdispatcher_types.QAbstractEventDispatcher, filterObj: QAbstractNativeEventFilter): void =
  fcQAbstractEventDispatcher_installNativeEventFilter(self.h, filterObj.h)

proc removeNativeEventFilter*(self: gen_qabstracteventdispatcher_types.QAbstractEventDispatcher, filterObj: QAbstractNativeEventFilter): void =
...
proc instance*(_: type gen_qabstracteventdispatcher_types.QAbstractEventDispatcher, thread: QThread): QAbstractEventDispatcher =
