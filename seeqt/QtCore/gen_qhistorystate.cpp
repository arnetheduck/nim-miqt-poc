...
QMetaObject* QHistoryState_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQHistoryState*)(self) )->QHistoryState::metaObject();

}

void* QHistoryState_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQHistoryState*)(self) )->QHistoryState::qt_metacast(param1);

}

int QHistoryState_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQHistoryState*)(self) )->QHistoryState::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
QObject* QHistoryState_protectedbase_sender(const void* self) {
	MiqtVirtualQHistoryState* self_cast = static_cast<MiqtVirtualQHistoryState*>( (QHistoryState*)(self) );
