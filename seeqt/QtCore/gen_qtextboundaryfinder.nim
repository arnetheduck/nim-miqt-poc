...
proc create*(T: type gen_qtextboundaryfinder_types.QTextBoundaryFinder, other: QTextBoundaryFinder): gen_qtextboundaryfinder_types.QTextBoundaryFinder =
...
proc create*(T: type gen_qtextboundaryfinder_types.QTextBoundaryFinder, typeVal: cint, chars: QChar, length: int64): gen_qtextboundaryfinder_types.QTextBoundaryFinder =
  gen_qtextboundaryfinder_types.QTextBoundaryFinder.init(fcQTextBoundaryFinder_new4(cint(typeVal), chars.h, length))

proc create*(T: type gen_qtextboundaryfinder_types.QTextBoundaryFinder, typeVal: cint, chars: QChar, length: int64, buffer: ptr uint8): gen_qtextboundaryfinder_types.QTextBoundaryFinder =
  gen_qtextboundaryfinder_types.QTextBoundaryFinder.init(fcQTextBoundaryFinder_new5(cint(typeVal), chars.h, length, buffer))

proc create*(T: type gen_qtextboundaryfinder_types.QTextBoundaryFinder, typeVal: cint, chars: QChar, length: int64, buffer: ptr uint8, bufferSize: int64): gen_qtextboundaryfinder_types.QTextBoundaryFinder =
...
proc operatorAssign*(self: gen_qtextboundaryfinder_types.QTextBoundaryFinder, other: QTextBoundaryFinder): void =
