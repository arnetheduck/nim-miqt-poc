...
proc create*(T: type gen_qtemporaryfile_types.QTemporaryFile, parent: QObject): gen_qtemporaryfile_types.QTemporaryFile =
  gen_qtemporaryfile_types.QTemporaryFile.init(fcQTemporaryFile_new3(parent.h))

proc create*(T: type gen_qtemporaryfile_types.QTemporaryFile, templateName: string, parent: QObject): gen_qtemporaryfile_types.QTemporaryFile =
...
proc metaObject*(self: gen_qtemporaryfile_types.QTemporaryFile, ): QMetaObject =
  QMetaObject(h: fcQTemporaryFile_metaObject(self.h))
...
proc createLocalFile*(_: type gen_qtemporaryfile_types.QTemporaryFile, fileName: string): QTemporaryFile =
  QTemporaryFile(h: fcQTemporaryFile_createLocalFile(struct_miqt_string(data: fileName, len: csize_t(len(fileName)))))

proc createLocalFile*(_: type gen_qtemporaryfile_types.QTemporaryFile, file: QFile): QTemporaryFile =
  QTemporaryFile(h: fcQTemporaryFile_createLocalFileWithFile(file.h))

proc createNativeFile*(_: type gen_qtemporaryfile_types.QTemporaryFile, fileName: string): QTemporaryFile =
  QTemporaryFile(h: fcQTemporaryFile_createNativeFile(struct_miqt_string(data: fileName, len: csize_t(len(fileName)))))

proc createNativeFile*(_: type gen_qtemporaryfile_types.QTemporaryFile, file: QFile): QTemporaryFile =
...
proc miqt_exec_callback_QTemporaryFile_waitForBytesWritten(self: ptr cQTemporaryFile, slot: int, msecs: cint): bool {.exportc: "miqt_exec_callback_QTemporaryFile_waitForBytesWritten ".} =
  ...
  virtualReturn
proc QTemporaryFileevent*(self: gen_qtemporaryfile_types.QTemporaryFile, event: QEvent): bool =
  fQTemporaryFile_virtualbase_event(self.h, event.h)

type QTemporaryFileeventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QTemporaryFile_event(self: ptr cQTemporaryFile, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QTemporaryFile_event ".} =
  ...
  virtualReturn
proc QTemporaryFileeventFilter*(self: gen_qtemporaryfile_types.QTemporaryFile, watched: QObject, event: QEvent): bool =
  fQTemporaryFile_virtualbase_eventFilter(self.h, watched.h, event.h)

type QTemporaryFileeventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QTemporaryFile_eventFilter(self: ptr cQTemporaryFile, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QTemporaryFile_eventFilter ".} =
  ...
  virtualReturn
proc QTemporaryFiletimerEvent*(self: gen_qtemporaryfile_types.QTemporaryFile, event: QTimerEvent): void =
  fQTemporaryFile_virtualbase_timerEvent(self.h, event.h)

type QTemporaryFiletimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QTemporaryFile_timerEvent(self: ptr cQTemporaryFile, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTemporaryFile_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTemporaryFilechildEvent*(self: gen_qtemporaryfile_types.QTemporaryFile, event: QChildEvent): void =
  fQTemporaryFile_virtualbase_childEvent(self.h, event.h)

type QTemporaryFilechildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QTemporaryFile_childEvent(self: ptr cQTemporaryFile, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTemporaryFile_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTemporaryFilecustomEvent*(self: gen_qtemporaryfile_types.QTemporaryFile, event: QEvent): void =
  fQTemporaryFile_virtualbase_customEvent(self.h, event.h)

type QTemporaryFilecustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QTemporaryFile_customEvent(self: ptr cQTemporaryFile, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTemporaryFile_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTemporaryFileconnectNotify*(self: gen_qtemporaryfile_types.QTemporaryFile, signal: QMetaMethod): void =
  fQTemporaryFile_virtualbase_connectNotify(self.h, signal.h)

type QTemporaryFileconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QTemporaryFile_connectNotify(self: ptr cQTemporaryFile, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QTemporaryFile_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QTemporaryFiledisconnectNotify*(self: gen_qtemporaryfile_types.QTemporaryFile, signal: QMetaMethod): void =
  fQTemporaryFile_virtualbase_disconnectNotify(self.h, signal.h)

type QTemporaryFiledisconnectNotifyProc* = proc(signal: QMetaMethod): void
