...
func init*(T: type gen_qobjectdefs_types.QMethodRawArguments, h: ptr cQMethodRawArguments): gen_qobjectdefs_types.QMethodRawArguments =
  T(h: h)
...
proc create*(T: type gen_qobjectdefs_types.QGenericArgument, param1: QGenericArgument): gen_qobjectdefs_types.QGenericArgument =
...
proc create*(T: type gen_qobjectdefs_types.QGenericReturnArgument, param1: QGenericReturnArgument): gen_qobjectdefs_types.QGenericReturnArgument =
...
proc create*(T: type gen_qobjectdefs_types.QMetaObject, param1: QMetaObject): gen_qobjectdefs_types.QMetaObject =
...
proc superClass*(self: gen_qobjectdefs_types.QMetaObject, ): QMetaObject =
  QMetaObject(h: fcQMetaObject_superClass(self.h))

proc inherits*(self: gen_qobjectdefs_types.QMetaObject, metaObject: QMetaObject): bool =
  fcQMetaObject_inherits(self.h, metaObject.h)

proc castX*(self: gen_qobjectdefs_types.QMetaObject, obj: QObject): QObject =
  QObject(h: fcQMetaObject_castX(self.h, obj.h))

proc castX2*(self: gen_qobjectdefs_types.QMetaObject, obj: QObject): QObject =
  QObject(h: fcQMetaObject_castWithObj(self.h, obj.h))
...
proc metaType*(self: gen_qobjectdefs_types.QMetaObject, ): QMetaType =
  QMetaType(h: fcQMetaObject_metaType(self.h))
...
proc constructor*(self: gen_qobjectdefs_types.QMetaObject, index: cint): QMetaMethod =
  QMetaMethod(h: fcQMetaObject_constructor(self.h, index))

proc methodX*(self: gen_qobjectdefs_types.QMetaObject, index: cint): QMetaMethod =
  QMetaMethod(h: fcQMetaObject_methodX(self.h, index))

proc enumerator*(self: gen_qobjectdefs_types.QMetaObject, index: cint): QMetaEnum =
  QMetaEnum(h: fcQMetaObject_enumerator(self.h, index))

proc property*(self: gen_qobjectdefs_types.QMetaObject, index: cint): QMetaProperty =
  QMetaProperty(h: fcQMetaObject_property(self.h, index))

proc classInfo*(self: gen_qobjectdefs_types.QMetaObject, index: cint): QMetaClassInfo =
  QMetaClassInfo(h: fcQMetaObject_classInfo(self.h, index))

proc userProperty*(self: gen_qobjectdefs_types.QMetaObject, ): QMetaProperty =
  QMetaProperty(h: fcQMetaObject_userProperty(self.h))
...
proc checkConnectArgs*(_: type gen_qobjectdefs_types.QMetaObject, signal: QMetaMethod, methodVal: QMetaMethod): bool =
...
proc connect*(_: type gen_qobjectdefs_types.QMetaObject, sender: QObject, signal_index: cint, receiver: QObject, method_index: cint): QMetaObjectConnection =
  QMetaObjectConnection(h: fcQMetaObject_connect(sender.h, signal_index, receiver.h, method_index))

proc disconnect*(_: type gen_qobjectdefs_types.QMetaObject, sender: QObject, signal_index: cint, receiver: QObject, method_index: cint): bool =
  fcQMetaObject_disconnect(sender.h, signal_index, receiver.h, method_index)

proc disconnectOne*(_: type gen_qobjectdefs_types.QMetaObject, sender: QObject, signal_index: cint, receiver: QObject, method_index: cint): bool =
  fcQMetaObject_disconnectOne(sender.h, signal_index, receiver.h, method_index)

proc connectSlotsByName*(_: type gen_qobjectdefs_types.QMetaObject, o: QObject): void =
  fcQMetaObject_connectSlotsByName(o.h)

proc activate*(_: type gen_qobjectdefs_types.QMetaObject, sender: QObject, signal_index: cint, argv: pointer): void =
  fcQMetaObject_activate(sender.h, signal_index, argv)

proc activate*(_: type gen_qobjectdefs_types.QMetaObject, sender: QObject, param2: QMetaObject, local_signal_index: cint, argv: pointer): void =
  fcQMetaObject_activate2(sender.h, param2.h, local_signal_index, argv)

proc activate*(_: type gen_qobjectdefs_types.QMetaObject, sender: QObject, signal_offset: cint, local_signal_index: cint, argv: pointer): void =
  fcQMetaObject_activate3(sender.h, signal_offset, local_signal_index, argv)

proc invokeMethod*(_: type gen_qobjectdefs_types.QMetaObject, obj: QObject, member: cstring, param3: cint, retVal: QGenericReturnArgument): bool =
  fcQMetaObject_invokeMethod(obj.h, member, cint(param3), retVal.h)

proc invokeMethod*(_: type gen_qobjectdefs_types.QMetaObject, obj: QObject, member: cstring, retVal: QGenericReturnArgument): bool =
  fcQMetaObject_invokeMethod2(obj.h, member, retVal.h)

proc invokeMethod*(_: type gen_qobjectdefs_types.QMetaObject, obj: QObject, member: cstring, typeVal: cint): bool =
  fcQMetaObject_invokeMethod3(obj.h, member, cint(typeVal))

proc invokeMethod*(_: type gen_qobjectdefs_types.QMetaObject, obj: QObject, member: cstring): bool =
  fcQMetaObject_invokeMethod4(obj.h, member)

proc newInstance*(self: gen_qobjectdefs_types.QMetaObject, ): QObject =
  QObject(h: fcQMetaObject_newInstance(self.h))
...
proc metacall*(_: type gen_qobjectdefs_types.QMetaObject, param1: QObject, param2: cint, param3: cint, param4: pointer): cint =
...
proc connect*(_: type gen_qobjectdefs_types.QMetaObject, sender: QObject, signal_index: cint, receiver: QObject, method_index: cint, typeVal: cint): QMetaObjectConnection =
  QMetaObjectConnection(h: fcQMetaObject_connect5(sender.h, signal_index, receiver.h, method_index, typeVal))

proc connect*(_: type gen_qobjectdefs_types.QMetaObject, sender: QObject, signal_index: cint, receiver: QObject, method_index: cint, typeVal: cint, types: ptr cint): QMetaObjectConnection =
  QMetaObjectConnection(h: fcQMetaObject_connect6(sender.h, signal_index, receiver.h, method_index, typeVal, types))

proc invokeMethod*(_: type gen_qobjectdefs_types.QMetaObject, obj: QObject, member: cstring, param3: cint, retVal: QGenericReturnArgument, val0: QGenericArgument): bool =
  fcQMetaObject_invokeMethod5(obj.h, member, cint(param3), retVal.h, val0.h)

proc invokeMethod*(_: type gen_qobjectdefs_types.QMetaObject, obj: QObject, member: cstring, param3: cint, retVal: QGenericReturnArgument, val0: QGenericArgument, val1: QGenericArgument): bool =
  fcQMetaObject_invokeMethod6(obj.h, member, cint(param3), retVal.h, val0.h, val1.h)

proc invokeMethod*(_: type gen_qobjectdefs_types.QMetaObject, obj: QObject, member: cstring, param3: cint, retVal: QGenericReturnArgument, val0: QGenericArgument, val1: QGenericArgument, val2: QGenericArgument): bool =
  fcQMetaObject_invokeMethod7(obj.h, member, cint(param3), retVal.h, val0.h, val1.h, val2.h)

proc invokeMethod*(_: type gen_qobjectdefs_types.QMetaObject, obj: QObject, member: cstring, param3: cint, retVal: QGenericReturnArgument, val0: QGenericArgument, val1: QGenericArgument, val2: QGenericArgument, val3: QGenericArgument): bool =
  fcQMetaObject_invokeMethod8(obj.h, member, cint(param3), retVal.h, val0.h, val1.h, val2.h, val3.h)

proc invokeMethod*(_: type gen_qobjectdefs_types.QMetaObject, obj: QObject, member: cstring, param3: cint, retVal: QGenericReturnArgument, val0: QGenericArgument, val1: QGenericArgument, val2: QGenericArgument, val3: QGenericArgument, val4: QGenericArgument): bool =
  fcQMetaObject_invokeMethod9(obj.h, member, cint(param3), retVal.h, val0.h, val1.h, val2.h, val3.h, val4.h)

proc invokeMethod*(_: type gen_qobjectdefs_types.QMetaObject, obj: QObject, member: cstring, param3: cint, retVal: QGenericReturnArgument, val0: QGenericArgument, val1: QGenericArgument, val2: QGenericArgument, val3: QGenericArgument, val4: QGenericArgument, val5: QGenericArgument): bool =
  fcQMetaObject_invokeMethod10(obj.h, member, cint(param3), retVal.h, val0.h, val1.h, val2.h, val3.h, val4.h, val5.h)

proc invokeMethod*(_: type gen_qobjectdefs_types.QMetaObject, obj: QObject, member: cstring, param3: cint, retVal: QGenericReturnArgument, val0: QGenericArgument, val1: QGenericArgument, val2: QGenericArgument, val3: QGenericArgument, val4: QGenericArgument, val5: QGenericArgument, val6: QGenericArgument): bool =
  fcQMetaObject_invokeMethod11(obj.h, member, cint(param3), retVal.h, val0.h, val1.h, val2.h, val3.h, val4.h, val5.h, val6.h)

proc invokeMethod*(_: type gen_qobjectdefs_types.QMetaObject, obj: QObject, member: cstring, param3: cint, retVal: QGenericReturnArgument, val0: QGenericArgument, val1: QGenericArgument, val2: QGenericArgument, val3: QGenericArgument, val4: QGenericArgument, val5: QGenericArgument, val6: QGenericArgument, val7: QGenericArgument): bool =
...
proc invokeMethod*(_: type gen_qobjectdefs_types.QMetaObject, obj: QObject, member: cstring, retVal: QGenericReturnArgument, val0: QGenericArgument): bool =
  fcQMetaObject_invokeMethod42(obj.h, member, retVal.h, val0.h)

proc invokeMethod*(_: type gen_qobjectdefs_types.QMetaObject, obj: QObject, member: cstring, retVal: QGenericReturnArgument, val0: QGenericArgument, val1: QGenericArgument): bool =
  fcQMetaObject_invokeMethod52(obj.h, member, retVal.h, val0.h, val1.h)

proc invokeMethod*(_: type gen_qobjectdefs_types.QMetaObject, obj: QObject, member: cstring, retVal: QGenericReturnArgument, val0: QGenericArgument, val1: QGenericArgument, val2: QGenericArgument): bool =
  fcQMetaObject_invokeMethod62(obj.h, member, retVal.h, val0.h, val1.h, val2.h)

proc invokeMethod*(_: type gen_qobjectdefs_types.QMetaObject, obj: QObject, member: cstring, retVal: QGenericReturnArgument, val0: QGenericArgument, val1: QGenericArgument, val2: QGenericArgument, val3: QGenericArgument): bool =
  fcQMetaObject_invokeMethod72(obj.h, member, retVal.h, val0.h, val1.h, val2.h, val3.h)

proc invokeMethod*(_: type gen_qobjectdefs_types.QMetaObject, obj: QObject, member: cstring, retVal: QGenericReturnArgument, val0: QGenericArgument, val1: QGenericArgument, val2: QGenericArgument, val3: QGenericArgument, val4: QGenericArgument): bool =
  fcQMetaObject_invokeMethod82(obj.h, member, retVal.h, val0.h, val1.h, val2.h, val3.h, val4.h)

proc invokeMethod*(_: type gen_qobjectdefs_types.QMetaObject, obj: QObject, member: cstring, retVal: QGenericReturnArgument, val0: QGenericArgument, val1: QGenericArgument, val2: QGenericArgument, val3: QGenericArgument, val4: QGenericArgument, val5: QGenericArgument): bool =
  fcQMetaObject_invokeMethod92(obj.h, member, retVal.h, val0.h, val1.h, val2.h, val3.h, val4.h, val5.h)

proc invokeMethod*(_: type gen_qobjectdefs_types.QMetaObject, obj: QObject, member: cstring, retVal: QGenericReturnArgument, val0: QGenericArgument, val1: QGenericArgument, val2: QGenericArgument, val3: QGenericArgument, val4: QGenericArgument, val5: QGenericArgument, val6: QGenericArgument): bool =
  fcQMetaObject_invokeMethod102(obj.h, member, retVal.h, val0.h, val1.h, val2.h, val3.h, val4.h, val5.h, val6.h)

proc invokeMethod*(_: type gen_qobjectdefs_types.QMetaObject, obj: QObject, member: cstring, retVal: QGenericReturnArgument, val0: QGenericArgument, val1: QGenericArgument, val2: QGenericArgument, val3: QGenericArgument, val4: QGenericArgument, val5: QGenericArgument, val6: QGenericArgument, val7: QGenericArgument): bool =
  fcQMetaObject_invokeMethod112(obj.h, member, retVal.h, val0.h, val1.h, val2.h, val3.h, val4.h, val5.h, val6.h, val7.h)

proc invokeMethod*(_: type gen_qobjectdefs_types.QMetaObject, obj: QObject, member: cstring, retVal: QGenericReturnArgument, val0: QGenericArgument, val1: QGenericArgument, val2: QGenericArgument, val3: QGenericArgument, val4: QGenericArgument, val5: QGenericArgument, val6: QGenericArgument, val7: QGenericArgument, val8: QGenericArgument): bool =
...
proc invokeMethod*(_: type gen_qobjectdefs_types.QMetaObject, obj: QObject, member: cstring, typeVal: cint, val0: QGenericArgument): bool =
  fcQMetaObject_invokeMethod43(obj.h, member, cint(typeVal), val0.h)

proc invokeMethod*(_: type gen_qobjectdefs_types.QMetaObject, obj: QObject, member: cstring, typeVal: cint, val0: QGenericArgument, val1: QGenericArgument): bool =
  fcQMetaObject_invokeMethod53(obj.h, member, cint(typeVal), val0.h, val1.h)

proc invokeMethod*(_: type gen_qobjectdefs_types.QMetaObject, obj: QObject, member: cstring, typeVal: cint, val0: QGenericArgument, val1: QGenericArgument, val2: QGenericArgument): bool =
  fcQMetaObject_invokeMethod63(obj.h, member, cint(typeVal), val0.h, val1.h, val2.h)

proc invokeMethod*(_: type gen_qobjectdefs_types.QMetaObject, obj: QObject, member: cstring, typeVal: cint, val0: QGenericArgument, val1: QGenericArgument, val2: QGenericArgument, val3: QGenericArgument): bool =
  fcQMetaObject_invokeMethod73(obj.h, member, cint(typeVal), val0.h, val1.h, val2.h, val3.h)

proc invokeMethod*(_: type gen_qobjectdefs_types.QMetaObject, obj: QObject, member: cstring, typeVal: cint, val0: QGenericArgument, val1: QGenericArgument, val2: QGenericArgument, val3: QGenericArgument, val4: QGenericArgument): bool =
  fcQMetaObject_invokeMethod83(obj.h, member, cint(typeVal), val0.h, val1.h, val2.h, val3.h, val4.h)

proc invokeMethod*(_: type gen_qobjectdefs_types.QMetaObject, obj: QObject, member: cstring, typeVal: cint, val0: QGenericArgument, val1: QGenericArgument, val2: QGenericArgument, val3: QGenericArgument, val4: QGenericArgument, val5: QGenericArgument): bool =
  fcQMetaObject_invokeMethod93(obj.h, member, cint(typeVal), val0.h, val1.h, val2.h, val3.h, val4.h, val5.h)

proc invokeMethod*(_: type gen_qobjectdefs_types.QMetaObject, obj: QObject, member: cstring, typeVal: cint, val0: QGenericArgument, val1: QGenericArgument, val2: QGenericArgument, val3: QGenericArgument, val4: QGenericArgument, val5: QGenericArgument, val6: QGenericArgument): bool =
  fcQMetaObject_invokeMethod103(obj.h, member, cint(typeVal), val0.h, val1.h, val2.h, val3.h, val4.h, val5.h, val6.h)

proc invokeMethod*(_: type gen_qobjectdefs_types.QMetaObject, obj: QObject, member: cstring, typeVal: cint, val0: QGenericArgument, val1: QGenericArgument, val2: QGenericArgument, val3: QGenericArgument, val4: QGenericArgument, val5: QGenericArgument, val6: QGenericArgument, val7: QGenericArgument): bool =
  fcQMetaObject_invokeMethod113(obj.h, member, cint(typeVal), val0.h, val1.h, val2.h, val3.h, val4.h, val5.h, val6.h, val7.h)

proc invokeMethod*(_: type gen_qobjectdefs_types.QMetaObject, obj: QObject, member: cstring, typeVal: cint, val0: QGenericArgument, val1: QGenericArgument, val2: QGenericArgument, val3: QGenericArgument, val4: QGenericArgument, val5: QGenericArgument, val6: QGenericArgument, val7: QGenericArgument, val8: QGenericArgument): bool =
...
proc invokeMethod*(_: type gen_qobjectdefs_types.QMetaObject, obj: QObject, member: cstring, val0: QGenericArgument): bool =
  fcQMetaObject_invokeMethod32(obj.h, member, val0.h)

proc invokeMethod*(_: type gen_qobjectdefs_types.QMetaObject, obj: QObject, member: cstring, val0: QGenericArgument, val1: QGenericArgument): bool =
  fcQMetaObject_invokeMethod44(obj.h, member, val0.h, val1.h)

proc invokeMethod*(_: type gen_qobjectdefs_types.QMetaObject, obj: QObject, member: cstring, val0: QGenericArgument, val1: QGenericArgument, val2: QGenericArgument): bool =
  fcQMetaObject_invokeMethod54(obj.h, member, val0.h, val1.h, val2.h)

proc invokeMethod*(_: type gen_qobjectdefs_types.QMetaObject, obj: QObject, member: cstring, val0: QGenericArgument, val1: QGenericArgument, val2: QGenericArgument, val3: QGenericArgument): bool =
  fcQMetaObject_invokeMethod64(obj.h, member, val0.h, val1.h, val2.h, val3.h)

proc invokeMethod*(_: type gen_qobjectdefs_types.QMetaObject, obj: QObject, member: cstring, val0: QGenericArgument, val1: QGenericArgument, val2: QGenericArgument, val3: QGenericArgument, val4: QGenericArgument): bool =
  fcQMetaObject_invokeMethod74(obj.h, member, val0.h, val1.h, val2.h, val3.h, val4.h)

proc invokeMethod*(_: type gen_qobjectdefs_types.QMetaObject, obj: QObject, member: cstring, val0: QGenericArgument, val1: QGenericArgument, val2: QGenericArgument, val3: QGenericArgument, val4: QGenericArgument, val5: QGenericArgument): bool =
  fcQMetaObject_invokeMethod84(obj.h, member, val0.h, val1.h, val2.h, val3.h, val4.h, val5.h)

proc invokeMethod*(_: type gen_qobjectdefs_types.QMetaObject, obj: QObject, member: cstring, val0: QGenericArgument, val1: QGenericArgument, val2: QGenericArgument, val3: QGenericArgument, val4: QGenericArgument, val5: QGenericArgument, val6: QGenericArgument): bool =
  fcQMetaObject_invokeMethod94(obj.h, member, val0.h, val1.h, val2.h, val3.h, val4.h, val5.h, val6.h)

proc invokeMethod*(_: type gen_qobjectdefs_types.QMetaObject, obj: QObject, member: cstring, val0: QGenericArgument, val1: QGenericArgument, val2: QGenericArgument, val3: QGenericArgument, val4: QGenericArgument, val5: QGenericArgument, val6: QGenericArgument, val7: QGenericArgument): bool =
  fcQMetaObject_invokeMethod104(obj.h, member, val0.h, val1.h, val2.h, val3.h, val4.h, val5.h, val6.h, val7.h)

proc invokeMethod*(_: type gen_qobjectdefs_types.QMetaObject, obj: QObject, member: cstring, val0: QGenericArgument, val1: QGenericArgument, val2: QGenericArgument, val3: QGenericArgument, val4: QGenericArgument, val5: QGenericArgument, val6: QGenericArgument, val7: QGenericArgument, val8: QGenericArgument): bool =
  fcQMetaObject_invokeMethod114(obj.h, member, val0.h, val1.h, val2.h, val3.h, val4.h, val5.h, val6.h, val7.h, val8.h)

proc invokeMethod*(_: type gen_qobjectdefs_types.QMetaObject, obj: QObject, member: cstring, val0: QGenericArgument, val1: QGenericArgument, val2: QGenericArgument, val3: QGenericArgument, val4: QGenericArgument, val5: QGenericArgument, val6: QGenericArgument, val7: QGenericArgument, val8: QGenericArgument, val9: QGenericArgument): bool =
  fcQMetaObject_invokeMethod124(obj.h, member, val0.h, val1.h, val2.h, val3.h, val4.h, val5.h, val6.h, val7.h, val8.h, val9.h)

proc newInstance*(self: gen_qobjectdefs_types.QMetaObject, val0: QGenericArgument): QObject =
  QObject(h: fcQMetaObject_newInstance1(self.h, val0.h))

proc newInstance*(self: gen_qobjectdefs_types.QMetaObject, val0: QGenericArgument, val1: QGenericArgument): QObject =
  QObject(h: fcQMetaObject_newInstance2(self.h, val0.h, val1.h))

proc newInstance*(self: gen_qobjectdefs_types.QMetaObject, val0: QGenericArgument, val1: QGenericArgument, val2: QGenericArgument): QObject =
  QObject(h: fcQMetaObject_newInstance3(self.h, val0.h, val1.h, val2.h))

proc newInstance*(self: gen_qobjectdefs_types.QMetaObject, val0: QGenericArgument, val1: QGenericArgument, val2: QGenericArgument, val3: QGenericArgument): QObject =
  QObject(h: fcQMetaObject_newInstance4(self.h, val0.h, val1.h, val2.h, val3.h))

proc newInstance*(self: gen_qobjectdefs_types.QMetaObject, val0: QGenericArgument, val1: QGenericArgument, val2: QGenericArgument, val3: QGenericArgument, val4: QGenericArgument): QObject =
  QObject(h: fcQMetaObject_newInstance5(self.h, val0.h, val1.h, val2.h, val3.h, val4.h))

proc newInstance*(self: gen_qobjectdefs_types.QMetaObject, val0: QGenericArgument, val1: QGenericArgument, val2: QGenericArgument, val3: QGenericArgument, val4: QGenericArgument, val5: QGenericArgument): QObject =
  QObject(h: fcQMetaObject_newInstance6(self.h, val0.h, val1.h, val2.h, val3.h, val4.h, val5.h))

proc newInstance*(self: gen_qobjectdefs_types.QMetaObject, val0: QGenericArgument, val1: QGenericArgument, val2: QGenericArgument, val3: QGenericArgument, val4: QGenericArgument, val5: QGenericArgument, val6: QGenericArgument): QObject =
  QObject(h: fcQMetaObject_newInstance7(self.h, val0.h, val1.h, val2.h, val3.h, val4.h, val5.h, val6.h))

proc newInstance*(self: gen_qobjectdefs_types.QMetaObject, val0: QGenericArgument, val1: QGenericArgument, val2: QGenericArgument, val3: QGenericArgument, val4: QGenericArgument, val5: QGenericArgument, val6: QGenericArgument, val7: QGenericArgument): QObject =
  QObject(h: fcQMetaObject_newInstance8(self.h, val0.h, val1.h, val2.h, val3.h, val4.h, val5.h, val6.h, val7.h))

proc newInstance*(self: gen_qobjectdefs_types.QMetaObject, val0: QGenericArgument, val1: QGenericArgument, val2: QGenericArgument, val3: QGenericArgument, val4: QGenericArgument, val5: QGenericArgument, val6: QGenericArgument, val7: QGenericArgument, val8: QGenericArgument): QObject =
  QObject(h: fcQMetaObject_newInstance9(self.h, val0.h, val1.h, val2.h, val3.h, val4.h, val5.h, val6.h, val7.h, val8.h))

proc newInstance*(self: gen_qobjectdefs_types.QMetaObject, val0: QGenericArgument, val1: QGenericArgument, val2: QGenericArgument, val3: QGenericArgument, val4: QGenericArgument, val5: QGenericArgument, val6: QGenericArgument, val7: QGenericArgument, val8: QGenericArgument, val9: QGenericArgument): QObject =
  QObject(h: fcQMetaObject_newInstance10(self.h, val0.h, val1.h, val2.h, val3.h, val4.h, val5.h, val6.h, val7.h, val8.h, val9.h))
...
proc create*(T: type gen_qobjectdefs_types.QMetaObjectConnection, other: QMetaObjectConnection): gen_qobjectdefs_types.QMetaObjectConnection =
  gen_qobjectdefs_types.QMetaObjectConnection.init(fcQMetaObjectConnection_new2(other.h))

proc operatorAssign*(self: gen_qobjectdefs_types.QMetaObjectConnection, other: QMetaObjectConnection): void =
  fcQMetaObjectConnection_operatorAssign(self.h, other.h)

proc swap*(self: gen_qobjectdefs_types.QMetaObjectConnection, other: QMetaObjectConnection): void =
...
proc create*(T: type gen_qobjectdefs_types.QMetaObjectSuperData, mo: QMetaObject): gen_qobjectdefs_types.QMetaObjectSuperData =
  gen_qobjectdefs_types.QMetaObjectSuperData.init(fcQMetaObjectSuperData_new2(mo.h))

proc create*(T: type gen_qobjectdefs_types.QMetaObjectSuperData, param1: QMetaObjectSuperData): gen_qobjectdefs_types.QMetaObjectSuperData =
  gen_qobjectdefs_types.QMetaObjectSuperData.init(fcQMetaObjectSuperData_new3(param1.h))

proc operatorMinusGreater*(self: gen_qobjectdefs_types.QMetaObjectSuperData, ): QMetaObject =
  QMetaObject(h: fcQMetaObjectSuperData_operatorMinusGreater(self.h))

proc ToConstQMetaObjectMultiply*(self: gen_qobjectdefs_types.QMetaObjectSuperData, ): QMetaObject =
  QMetaObject(h: fcQMetaObjectSuperData_ToConstQMetaObjectMultiply(self.h))

proc operatorAssign*(self: gen_qobjectdefs_types.QMetaObjectSuperData, param1: QMetaObjectSuperData): void =
...
func init*(T: type gen_qobjectdefs_types.QMetaObjectData, h: ptr cQMetaObjectData): gen_qobjectdefs_types.QMetaObjectData =
  T(h: h)
proc create*(T: type gen_qobjectdefs_types.QMetaObjectData, ): gen_qobjectdefs_types.QMetaObjectData =
  gen_qobjectdefs_types.QMetaObjectData.init(fcQMetaObjectData_new())

proc create*(T: type gen_qobjectdefs_types.QMetaObjectData, param1: QMetaObjectData): gen_qobjectdefs_types.QMetaObjectData =
  gen_qobjectdefs_types.QMetaObjectData.init(fcQMetaObjectData_new2(param1.h))

proc operatorAssign*(self: gen_qobjectdefs_types.QMetaObjectData, param1: QMetaObjectData): void =
