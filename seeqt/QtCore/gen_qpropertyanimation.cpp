...
QMetaObject* QPropertyAnimation_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQPropertyAnimation*)(self) )->QPropertyAnimation::metaObject();

}

void* QPropertyAnimation_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQPropertyAnimation*)(self) )->QPropertyAnimation::qt_metacast(param1);

}

int QPropertyAnimation_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQPropertyAnimation*)(self) )->QPropertyAnimation::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
