...
public:
	...
	MiqtVirtualQCoreApplication(struct QCoreApplication_VTable* vtbl, int& argc, char** argv): QCoreApplication(argc, argv), vtbl(vtbl) {};
	MiqtVirtualQCoreApplication(struct QCoreApplication_VTable* vtbl, int& argc, char** argv, int param3): QCoreApplication(argc, argv, param3), vtbl(vtbl) {};

	virtual ~MiqtVirtualQCoreApplication() override { if(vtbl->destructor) vtbl->destructor(vtbl, this); }
...
QCoreApplication* QCoreApplication_new(struct QCoreApplication_VTable* vtbl, int* argc, char** argv) {
	return new MiqtVirtualQCoreApplication(vtbl, static_cast<int&>(*argc), argv);
}

QCoreApplication* QCoreApplication_new2(struct QCoreApplication_VTable* vtbl, int* argc, char** argv, int param3) {
	return new MiqtVirtualQCoreApplication(vtbl, static_cast<int&>(*argc), argv, static_cast<int>(param3));
}
...
void QCoreApplication_connect_installNativeEventFilter(QCoreApplication* self, intptr_t slot, void (*callback)(intptr_t, QAbstractNativeEventFilter*), void (*release)(intptr_t)) {
	...
	MiqtVirtualQCoreApplication::connect(self, static_cast<void (QCoreApplication::*)(QAbstractNativeEventFilter*)>(&QCoreApplication::installNativeEventFilter), self, caller{slot, callback, release});
}
...
void QCoreApplication_connect_removeNativeEventFilter(QCoreApplication* self, intptr_t slot, void (*callback)(intptr_t, QAbstractNativeEventFilter*), void (*release)(intptr_t)) {
	...
	MiqtVirtualQCoreApplication::connect(self, static_cast<void (QCoreApplication::*)(QAbstractNativeEventFilter*)>(&QCoreApplication::removeNativeEventFilter), self, caller{slot, callback, release});
}
...
void QCoreApplication_connect_organizationNameChanged(QCoreApplication* self, intptr_t slot, void (*callback)(intptr_t), void (*release)(intptr_t)) {
	...
	MiqtVirtualQCoreApplication::connect(self, static_cast<void (QCoreApplication::*)()>(&QCoreApplication::organizationNameChanged), self, caller{slot, callback, release});
}
...
void QCoreApplication_connect_organizationDomainChanged(QCoreApplication* self, intptr_t slot, void (*callback)(intptr_t), void (*release)(intptr_t)) {
	...
	MiqtVirtualQCoreApplication::connect(self, static_cast<void (QCoreApplication::*)()>(&QCoreApplication::organizationDomainChanged), self, caller{slot, callback, release});
}
...
void QCoreApplication_connect_applicationNameChanged(QCoreApplication* self, intptr_t slot, void (*callback)(intptr_t), void (*release)(intptr_t)) {
	...
	MiqtVirtualQCoreApplication::connect(self, static_cast<void (QCoreApplication::*)()>(&QCoreApplication::applicationNameChanged), self, caller{slot, callback, release});
}
...
void QCoreApplication_connect_applicationVersionChanged(QCoreApplication* self, intptr_t slot, void (*callback)(intptr_t), void (*release)(intptr_t)) {
	...
	MiqtVirtualQCoreApplication::connect(self, static_cast<void (QCoreApplication::*)()>(&QCoreApplication::applicationVersionChanged), self, caller{slot, callback, release});
}
...
QMetaObject* QCoreApplication_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQCoreApplication*)(self) )->QCoreApplication::metaObject();

}

void* QCoreApplication_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQCoreApplication*)(self) )->QCoreApplication::qt_metacast(param1);

}

int QCoreApplication_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQCoreApplication*)(self) )->QCoreApplication::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
