...
proc addOption*(self: gen_qcommandlineparser_types.QCommandLineParser, commandLineOption: QCommandLineOption): bool =
  fcQCommandLineParser_addOption(self.h, commandLineOption.h)

proc addOptions*(self: gen_qcommandlineparser_types.QCommandLineParser, options: seq[QCommandLineOption]): bool =
...
proc addVersionOption*(self: gen_qcommandlineparser_types.QCommandLineParser, ): QCommandLineOption =
  QCommandLineOption(h: fcQCommandLineParser_addVersionOption(self.h))

proc addHelpOption*(self: gen_qcommandlineparser_types.QCommandLineParser, ): QCommandLineOption =
  QCommandLineOption(h: fcQCommandLineParser_addHelpOption(self.h))
...
proc process*(self: gen_qcommandlineparser_types.QCommandLineParser, app: QCoreApplication): void =
...
proc isSet*(self: gen_qcommandlineparser_types.QCommandLineParser, option: QCommandLineOption): bool =
  fcQCommandLineParser_isSetWithOption(self.h, option.h)

proc value*(self: gen_qcommandlineparser_types.QCommandLineParser, option: QCommandLineOption): string =
  let v_ms = fcQCommandLineParser_valueWithOption(self.h, option.h)
  let vx_ret = string.fromBytes(toOpenArrayByte(v_ms.data, 0, int(v_ms.len)-1))
  c_free(v_ms.data)
  vx_ret

proc values*(self: gen_qcommandlineparser_types.QCommandLineParser, option: QCommandLineOption): seq[string] =
