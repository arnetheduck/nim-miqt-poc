...
proc metaObject*(self: gen_qmimedata_types.QMimeData, ): QMetaObject =
  QMetaObject(h: fcQMimeData_metaObject(self.h))
...
proc urls*(self: gen_qmimedata_types.QMimeData, ): seq[QUrl] =
...
proc setUrls*(self: gen_qmimedata_types.QMimeData, urls: seq[QUrl]): void =
...
proc imageData*(self: gen_qmimedata_types.QMimeData, ): QVariant =
  QVariant(h: fcQMimeData_imageData(self.h))

proc setImageData*(self: gen_qmimedata_types.QMimeData, image: QVariant): void =
  fcQMimeData_setImageData(self.h, image.h)

proc hasImage*(self: gen_qmimedata_types.QMimeData, ): bool =
  fcQMimeData_hasImage(self.h)

proc colorData*(self: gen_qmimedata_types.QMimeData, ): QVariant =
  QVariant(h: fcQMimeData_colorData(self.h))

proc setColorData*(self: gen_qmimedata_types.QMimeData, color: QVariant): void =
...
proc QMimeDataretrieveData*(self: gen_qmimedata_types.QMimeData, mimetype: string, preferredType: cint): QVariant =
  QVariant(h: fQMimeData_virtualbase_retrieveData(self.h, struct_miqt_string(data: mimetype, len: csize_t(len(mimetype))), cint(preferredType)))

type QMimeDataretrieveDataProc* = proc(mimetype: string, preferredType: cint): QVariant
...
proc miqt_exec_callback_QMimeData_retrieveData(self: ptr cQMimeData, slot: int, mimetype: struct_miqt_string, preferredType: cint): pointer {.exportc: "miqt_exec_callback_QMimeData_retrieveData ".} =
  ...
  virtualReturn.h
proc QMimeDataevent*(self: gen_qmimedata_types.QMimeData, event: QEvent): bool =
  fQMimeData_virtualbase_event(self.h, event.h)

type QMimeDataeventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QMimeData_event(self: ptr cQMimeData, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QMimeData_event ".} =
  ...
  virtualReturn
proc QMimeDataeventFilter*(self: gen_qmimedata_types.QMimeData, watched: QObject, event: QEvent): bool =
  fQMimeData_virtualbase_eventFilter(self.h, watched.h, event.h)

type QMimeDataeventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QMimeData_eventFilter(self: ptr cQMimeData, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QMimeData_eventFilter ".} =
  ...
  virtualReturn
proc QMimeDatatimerEvent*(self: gen_qmimedata_types.QMimeData, event: QTimerEvent): void =
  fQMimeData_virtualbase_timerEvent(self.h, event.h)

type QMimeDatatimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QMimeData_timerEvent(self: ptr cQMimeData, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QMimeData_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QMimeDatachildEvent*(self: gen_qmimedata_types.QMimeData, event: QChildEvent): void =
  fQMimeData_virtualbase_childEvent(self.h, event.h)

type QMimeDatachildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QMimeData_childEvent(self: ptr cQMimeData, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QMimeData_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QMimeDatacustomEvent*(self: gen_qmimedata_types.QMimeData, event: QEvent): void =
  fQMimeData_virtualbase_customEvent(self.h, event.h)

type QMimeDatacustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QMimeData_customEvent(self: ptr cQMimeData, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QMimeData_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QMimeDataconnectNotify*(self: gen_qmimedata_types.QMimeData, signal: QMetaMethod): void =
  fQMimeData_virtualbase_connectNotify(self.h, signal.h)

type QMimeDataconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QMimeData_connectNotify(self: ptr cQMimeData, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QMimeData_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QMimeDatadisconnectNotify*(self: gen_qmimedata_types.QMimeData, signal: QMetaMethod): void =
  fQMimeData_virtualbase_disconnectNotify(self.h, signal.h)

type QMimeDatadisconnectNotifyProc* = proc(signal: QMetaMethod): void
