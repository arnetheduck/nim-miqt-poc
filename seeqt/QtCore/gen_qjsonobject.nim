...
proc create*(T: type gen_qjsonobject_types.QJsonObject, other: QJsonObject): gen_qjsonobject_types.QJsonObject =
  gen_qjsonobject_types.QJsonObject.init(fcQJsonObject_new2(other.h))

proc operatorAssign*(self: gen_qjsonobject_types.QJsonObject, other: QJsonObject): void =
  fcQJsonObject_operatorAssign(self.h, other.h)

proc swap*(self: gen_qjsonobject_types.QJsonObject, other: QJsonObject): void =
  fcQJsonObject_swap(self.h, other.h)

proc fromVariantMap*(_: type gen_qjsonobject_types.QJsonObject, map: Table[string,QVariant]): QJsonObject =
...
proc toVariantMap*(self: gen_qjsonobject_types.QJsonObject, ): Table[string,QVariant] =
...
proc fromVariantHash*(_: type gen_qjsonobject_types.QJsonObject, map: Table[string,QVariant]): QJsonObject =
  var map_Keys_CArray = newSeq[struct_miqt_string](len(map))
  var map_Values_CArray = newSeq[pointer](len(map))
  var map_ctr = 0
  for mapk, mapv in map:
...
proc toVariantHash*(self: gen_qjsonobject_types.QJsonObject, ): Table[string,QVariant] =
...
proc value*(self: gen_qjsonobject_types.QJsonObject, key: string): QJsonValue =
  QJsonValue(h: fcQJsonObject_value(self.h, struct_miqt_string(data: key, len: csize_t(len(key)))))

proc operatorSubscript*(self: gen_qjsonobject_types.QJsonObject, key: string): QJsonValue =
  QJsonValue(h: fcQJsonObject_operatorSubscript(self.h, struct_miqt_string(data: key, len: csize_t(len(key)))))

proc operatorSubscript2*(self: gen_qjsonobject_types.QJsonObject, key: string): QJsonValueRef =
  QJsonValueRef(h: fcQJsonObject_operatorSubscriptWithKey(self.h, struct_miqt_string(data: key, len: csize_t(len(key)))))
...
proc take*(self: gen_qjsonobject_types.QJsonObject, key: string): QJsonValue =
  QJsonValue(h: fcQJsonObject_take(self.h, struct_miqt_string(data: key, len: csize_t(len(key)))))
...
proc operatorEqual*(self: gen_qjsonobject_types.QJsonObject, other: QJsonObject): bool =
  fcQJsonObject_operatorEqual(self.h, other.h)

proc operatorNotEqual*(self: gen_qjsonobject_types.QJsonObject, other: QJsonObject): bool =
  fcQJsonObject_operatorNotEqual(self.h, other.h)

proc begin*(self: gen_qjsonobject_types.QJsonObject, ): QJsonObjectiterator =
  QJsonObjectiterator(h: fcQJsonObject_begin(self.h))

proc begin2*(self: gen_qjsonobject_types.QJsonObject, ): QJsonObjectconst_iterator =
  QJsonObjectconst_iterator(h: fcQJsonObject_begin2(self.h))

proc constBegin*(self: gen_qjsonobject_types.QJsonObject, ): QJsonObjectconst_iterator =
  QJsonObjectconst_iterator(h: fcQJsonObject_constBegin(self.h))

proc endX*(self: gen_qjsonobject_types.QJsonObject, ): QJsonObjectiterator =
  QJsonObjectiterator(h: fcQJsonObject_endX(self.h))

proc endX2*(self: gen_qjsonobject_types.QJsonObject, ): QJsonObjectconst_iterator =
  QJsonObjectconst_iterator(h: fcQJsonObject_end2(self.h))

proc constEnd*(self: gen_qjsonobject_types.QJsonObject, ): QJsonObjectconst_iterator =
  QJsonObjectconst_iterator(h: fcQJsonObject_constEnd(self.h))

proc erase*(self: gen_qjsonobject_types.QJsonObject, it: QJsonObjectiterator): QJsonObjectiterator =
  QJsonObjectiterator(h: fcQJsonObject_erase(self.h, it.h))

proc find*(self: gen_qjsonobject_types.QJsonObject, key: string): QJsonObjectiterator =
  QJsonObjectiterator(h: fcQJsonObject_find(self.h, struct_miqt_string(data: key, len: csize_t(len(key)))))

proc find2*(self: gen_qjsonobject_types.QJsonObject, key: string): QJsonObjectconst_iterator =
  QJsonObjectconst_iterator(h: fcQJsonObject_findWithKey(self.h, struct_miqt_string(data: key, len: csize_t(len(key)))))

proc constFind*(self: gen_qjsonobject_types.QJsonObject, key: string): QJsonObjectconst_iterator =
  QJsonObjectconst_iterator(h: fcQJsonObject_constFind(self.h, struct_miqt_string(data: key, len: csize_t(len(key)))))

proc insert*(self: gen_qjsonobject_types.QJsonObject, key: string, value: QJsonValue): QJsonObjectiterator =
...
proc create*(T: type gen_qjsonobject_types.QJsonObjectiterator, obj: QJsonObject, index: int64): gen_qjsonobject_types.QJsonObjectiterator =
  gen_qjsonobject_types.QJsonObjectiterator.init(fcQJsonObjectiterator_new2(obj.h, index))

proc create*(T: type gen_qjsonobject_types.QJsonObjectiterator, other: QJsonObjectiterator): gen_qjsonobject_types.QJsonObjectiterator =
  gen_qjsonobject_types.QJsonObjectiterator.init(fcQJsonObjectiterator_new3(other.h))

proc operatorAssign*(self: gen_qjsonobject_types.QJsonObjectiterator, other: QJsonObjectiterator): void =
...
proc value*(self: gen_qjsonobject_types.QJsonObjectiterator, ): QJsonValueRef =
  QJsonValueRef(h: fcQJsonObjectiterator_value(self.h))

proc operatorMultiply*(self: gen_qjsonobject_types.QJsonObjectiterator, ): QJsonValueRef =
  QJsonValueRef(h: fcQJsonObjectiterator_operatorMultiply(self.h))

proc operatorMinusGreater*(self: gen_qjsonobject_types.QJsonObjectiterator, ): QJsonValueConstRef =
  QJsonValueConstRef(h: fcQJsonObjectiterator_operatorMinusGreater(self.h))

proc operatorMinusGreater2*(self: gen_qjsonobject_types.QJsonObjectiterator, ): QJsonValueRef =
  QJsonValueRef(h: fcQJsonObjectiterator_operatorMinusGreater2(self.h))

proc operatorSubscript*(self: gen_qjsonobject_types.QJsonObjectiterator, j: int64): QJsonValueRef =
  QJsonValueRef(h: fcQJsonObjectiterator_operatorSubscript(self.h, j))

proc operatorEqual*(self: gen_qjsonobject_types.QJsonObjectiterator, other: QJsonObjectiterator): bool =
  fcQJsonObjectiterator_operatorEqual(self.h, other.h)

proc operatorNotEqual*(self: gen_qjsonobject_types.QJsonObjectiterator, other: QJsonObjectiterator): bool =
  fcQJsonObjectiterator_operatorNotEqual(self.h, other.h)

proc operatorLesser*(self: gen_qjsonobject_types.QJsonObjectiterator, other: QJsonObjectiterator): bool =
  fcQJsonObjectiterator_operatorLesser(self.h, other.h)

proc operatorLesserOrEqual*(self: gen_qjsonobject_types.QJsonObjectiterator, other: QJsonObjectiterator): bool =
  fcQJsonObjectiterator_operatorLesserOrEqual(self.h, other.h)

proc operatorGreater*(self: gen_qjsonobject_types.QJsonObjectiterator, other: QJsonObjectiterator): bool =
  fcQJsonObjectiterator_operatorGreater(self.h, other.h)

proc operatorGreaterOrEqual*(self: gen_qjsonobject_types.QJsonObjectiterator, other: QJsonObjectiterator): bool =
  fcQJsonObjectiterator_operatorGreaterOrEqual(self.h, other.h)

proc operatorPlusPlus*(self: gen_qjsonobject_types.QJsonObjectiterator, ): QJsonObjectiterator =
  QJsonObjectiterator(h: fcQJsonObjectiterator_operatorPlusPlus(self.h))

proc operatorPlusPlus*(self: gen_qjsonobject_types.QJsonObjectiterator, param1: cint): QJsonObjectiterator =
  QJsonObjectiterator(h: fcQJsonObjectiterator_operatorPlusPlusWithInt(self.h, param1))

proc operatorMinusMinus*(self: gen_qjsonobject_types.QJsonObjectiterator, ): QJsonObjectiterator =
  QJsonObjectiterator(h: fcQJsonObjectiterator_operatorMinusMinus(self.h))

proc operatorMinusMinus*(self: gen_qjsonobject_types.QJsonObjectiterator, param1: cint): QJsonObjectiterator =
  QJsonObjectiterator(h: fcQJsonObjectiterator_operatorMinusMinusWithInt(self.h, param1))

proc operatorPlus*(self: gen_qjsonobject_types.QJsonObjectiterator, j: int64): QJsonObjectiterator =
  QJsonObjectiterator(h: fcQJsonObjectiterator_operatorPlus(self.h, j))

proc operatorMinus*(self: gen_qjsonobject_types.QJsonObjectiterator, j: int64): QJsonObjectiterator =
  QJsonObjectiterator(h: fcQJsonObjectiterator_operatorMinus(self.h, j))

proc operatorPlusAssign*(self: gen_qjsonobject_types.QJsonObjectiterator, j: int64): QJsonObjectiterator =
  QJsonObjectiterator(h: fcQJsonObjectiterator_operatorPlusAssign(self.h, j))

proc operatorMinusAssign*(self: gen_qjsonobject_types.QJsonObjectiterator, j: int64): QJsonObjectiterator =
  QJsonObjectiterator(h: fcQJsonObjectiterator_operatorMinusAssign(self.h, j))

proc operatorMinus*(self: gen_qjsonobject_types.QJsonObjectiterator, j: QJsonObjectiterator): int64 =
  fcQJsonObjectiterator_operatorMinusWithQJsonObjectiterator(self.h, j.h)

proc operatorEqual*(self: gen_qjsonobject_types.QJsonObjectiterator, other: QJsonObjectconst_iterator): bool =
  fcQJsonObjectiterator_operatorEqualWithOther(self.h, other.h)

proc operatorNotEqual*(self: gen_qjsonobject_types.QJsonObjectiterator, other: QJsonObjectconst_iterator): bool =
  fcQJsonObjectiterator_operatorNotEqualWithOther(self.h, other.h)

proc operatorLesser*(self: gen_qjsonobject_types.QJsonObjectiterator, other: QJsonObjectconst_iterator): bool =
  fcQJsonObjectiterator_operatorLesserWithOther(self.h, other.h)

proc operatorLesserOrEqual*(self: gen_qjsonobject_types.QJsonObjectiterator, other: QJsonObjectconst_iterator): bool =
  fcQJsonObjectiterator_operatorLesserOrEqualWithOther(self.h, other.h)

proc operatorGreater*(self: gen_qjsonobject_types.QJsonObjectiterator, other: QJsonObjectconst_iterator): bool =
  fcQJsonObjectiterator_operatorGreaterWithOther(self.h, other.h)

proc operatorGreaterOrEqual*(self: gen_qjsonobject_types.QJsonObjectiterator, other: QJsonObjectconst_iterator): bool =
...
proc create*(T: type gen_qjsonobject_types.QJsonObjectconst_iterator, obj: QJsonObject, index: int64): gen_qjsonobject_types.QJsonObjectconst_iterator =
  gen_qjsonobject_types.QJsonObjectconst_iterator.init(fcQJsonObjectconst_iterator_new2(obj.h, index))

proc create*(T: type gen_qjsonobject_types.QJsonObjectconst_iterator, other: QJsonObjectiterator): gen_qjsonobject_types.QJsonObjectconst_iterator =
  gen_qjsonobject_types.QJsonObjectconst_iterator.init(fcQJsonObjectconst_iterator_new3(other.h))

proc create*(T: type gen_qjsonobject_types.QJsonObjectconst_iterator, other: QJsonObjectconst_iterator): gen_qjsonobject_types.QJsonObjectconst_iterator =
  gen_qjsonobject_types.QJsonObjectconst_iterator.init(fcQJsonObjectconst_iterator_new4(other.h))

proc operatorAssign*(self: gen_qjsonobject_types.QJsonObjectconst_iterator, other: QJsonObjectconst_iterator): void =
...
proc value*(self: gen_qjsonobject_types.QJsonObjectconst_iterator, ): QJsonValueConstRef =
  QJsonValueConstRef(h: fcQJsonObjectconst_iterator_value(self.h))

proc operatorMultiply*(self: gen_qjsonobject_types.QJsonObjectconst_iterator, ): QJsonValueConstRef =
  QJsonValueConstRef(h: fcQJsonObjectconst_iterator_operatorMultiply(self.h))

proc operatorMinusGreater*(self: gen_qjsonobject_types.QJsonObjectconst_iterator, ): QJsonValueConstRef =
  QJsonValueConstRef(h: fcQJsonObjectconst_iterator_operatorMinusGreater(self.h))

proc operatorSubscript*(self: gen_qjsonobject_types.QJsonObjectconst_iterator, j: int64): QJsonValueConstRef =
  QJsonValueConstRef(h: fcQJsonObjectconst_iterator_operatorSubscript(self.h, j))

proc operatorEqual*(self: gen_qjsonobject_types.QJsonObjectconst_iterator, other: QJsonObjectconst_iterator): bool =
  fcQJsonObjectconst_iterator_operatorEqual(self.h, other.h)

proc operatorNotEqual*(self: gen_qjsonobject_types.QJsonObjectconst_iterator, other: QJsonObjectconst_iterator): bool =
  fcQJsonObjectconst_iterator_operatorNotEqual(self.h, other.h)

proc operatorLesser*(self: gen_qjsonobject_types.QJsonObjectconst_iterator, other: QJsonObjectconst_iterator): bool =
  fcQJsonObjectconst_iterator_operatorLesser(self.h, other.h)

proc operatorLesserOrEqual*(self: gen_qjsonobject_types.QJsonObjectconst_iterator, other: QJsonObjectconst_iterator): bool =
  fcQJsonObjectconst_iterator_operatorLesserOrEqual(self.h, other.h)

proc operatorGreater*(self: gen_qjsonobject_types.QJsonObjectconst_iterator, other: QJsonObjectconst_iterator): bool =
  fcQJsonObjectconst_iterator_operatorGreater(self.h, other.h)

proc operatorGreaterOrEqual*(self: gen_qjsonobject_types.QJsonObjectconst_iterator, other: QJsonObjectconst_iterator): bool =
  fcQJsonObjectconst_iterator_operatorGreaterOrEqual(self.h, other.h)

proc operatorPlusPlus*(self: gen_qjsonobject_types.QJsonObjectconst_iterator, ): QJsonObjectconst_iterator =
  QJsonObjectconst_iterator(h: fcQJsonObjectconst_iterator_operatorPlusPlus(self.h))

proc operatorPlusPlus*(self: gen_qjsonobject_types.QJsonObjectconst_iterator, param1: cint): QJsonObjectconst_iterator =
  QJsonObjectconst_iterator(h: fcQJsonObjectconst_iterator_operatorPlusPlusWithInt(self.h, param1))

proc operatorMinusMinus*(self: gen_qjsonobject_types.QJsonObjectconst_iterator, ): QJsonObjectconst_iterator =
  QJsonObjectconst_iterator(h: fcQJsonObjectconst_iterator_operatorMinusMinus(self.h))

proc operatorMinusMinus*(self: gen_qjsonobject_types.QJsonObjectconst_iterator, param1: cint): QJsonObjectconst_iterator =
  QJsonObjectconst_iterator(h: fcQJsonObjectconst_iterator_operatorMinusMinusWithInt(self.h, param1))

proc operatorPlus*(self: gen_qjsonobject_types.QJsonObjectconst_iterator, j: int64): QJsonObjectconst_iterator =
  QJsonObjectconst_iterator(h: fcQJsonObjectconst_iterator_operatorPlus(self.h, j))

proc operatorMinus*(self: gen_qjsonobject_types.QJsonObjectconst_iterator, j: int64): QJsonObjectconst_iterator =
  QJsonObjectconst_iterator(h: fcQJsonObjectconst_iterator_operatorMinus(self.h, j))

proc operatorPlusAssign*(self: gen_qjsonobject_types.QJsonObjectconst_iterator, j: int64): QJsonObjectconst_iterator =
  QJsonObjectconst_iterator(h: fcQJsonObjectconst_iterator_operatorPlusAssign(self.h, j))

proc operatorMinusAssign*(self: gen_qjsonobject_types.QJsonObjectconst_iterator, j: int64): QJsonObjectconst_iterator =
  QJsonObjectconst_iterator(h: fcQJsonObjectconst_iterator_operatorMinusAssign(self.h, j))

proc operatorMinus*(self: gen_qjsonobject_types.QJsonObjectconst_iterator, j: QJsonObjectconst_iterator): int64 =
  fcQJsonObjectconst_iterator_operatorMinusWithQJsonObjectconstIterator(self.h, j.h)

proc operatorEqual*(self: gen_qjsonobject_types.QJsonObjectconst_iterator, other: QJsonObjectiterator): bool =
  fcQJsonObjectconst_iterator_operatorEqualWithOther(self.h, other.h)

proc operatorNotEqual*(self: gen_qjsonobject_types.QJsonObjectconst_iterator, other: QJsonObjectiterator): bool =
  fcQJsonObjectconst_iterator_operatorNotEqualWithOther(self.h, other.h)

proc operatorLesser*(self: gen_qjsonobject_types.QJsonObjectconst_iterator, other: QJsonObjectiterator): bool =
  fcQJsonObjectconst_iterator_operatorLesserWithOther(self.h, other.h)

proc operatorLesserOrEqual*(self: gen_qjsonobject_types.QJsonObjectconst_iterator, other: QJsonObjectiterator): bool =
  fcQJsonObjectconst_iterator_operatorLesserOrEqualWithOther(self.h, other.h)

proc operatorGreater*(self: gen_qjsonobject_types.QJsonObjectconst_iterator, other: QJsonObjectiterator): bool =
  fcQJsonObjectconst_iterator_operatorGreaterWithOther(self.h, other.h)

proc operatorGreaterOrEqual*(self: gen_qjsonobject_types.QJsonObjectconst_iterator, other: QJsonObjectiterator): bool =
