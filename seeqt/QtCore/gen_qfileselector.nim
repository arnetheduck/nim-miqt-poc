...
proc create*(T: type gen_qfileselector_types.QFileSelector, parent: QObject): gen_qfileselector_types.QFileSelector =
  gen_qfileselector_types.QFileSelector.init(fcQFileSelector_new2(parent.h))

proc metaObject*(self: gen_qfileselector_types.QFileSelector, ): QMetaObject =
  QMetaObject(h: fcQFileSelector_metaObject(self.h))
...
proc trUtf8*(_: type gen_qfileselector_types.QFileSelector, s: cstring): string =
...
proc select*(self: gen_qfileselector_types.QFileSelector, filePath: QUrl): QUrl =
  QUrl(h: fcQFileSelector_selectWithFilePath(self.h, filePath.h))
...
proc trUtf8*(_: type gen_qfileselector_types.QFileSelector, s: cstring, c: cstring): string =
  let v_ms = fcQFileSelector_trUtf82(s, c)
  let vx_ret = string.fromBytes(toOpenArrayByte(v_ms.data, 0, int(v_ms.len)-1))
  c_free(v_ms.data)
  vx_ret

proc trUtf8*(_: type gen_qfileselector_types.QFileSelector, s: cstring, c: cstring, n: cint): string =
...
proc onmetacall*(self: gen_qfileselector_types.QFileSelector, slot: QFileSelectormetacallProc) =
  # TODO check subclass
  var tmp = new QFileSelectormetacallProc
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QFileSelector_metacall(self: ptr cQFileSelector, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QFileSelector_metacall ".} =
  var nimfunc = cast[ptr QFileSelectormetacallProc](cast[pointer](slot))
  ...
  virtualReturn
proc QFileSelectorevent*(self: gen_qfileselector_types.QFileSelector, event: QEvent): bool =
  fQFileSelector_virtualbase_event(self.h, event.h)

type QFileSelectoreventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QFileSelector_event(self: ptr cQFileSelector, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QFileSelector_event ".} =
  ...
  virtualReturn
proc QFileSelectoreventFilter*(self: gen_qfileselector_types.QFileSelector, watched: QObject, event: QEvent): bool =
  fQFileSelector_virtualbase_eventFilter(self.h, watched.h, event.h)

type QFileSelectoreventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QFileSelector_eventFilter(self: ptr cQFileSelector, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QFileSelector_eventFilter ".} =
  ...
  virtualReturn
proc QFileSelectortimerEvent*(self: gen_qfileselector_types.QFileSelector, event: QTimerEvent): void =
  fQFileSelector_virtualbase_timerEvent(self.h, event.h)

type QFileSelectortimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QFileSelector_timerEvent(self: ptr cQFileSelector, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QFileSelector_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QFileSelectorchildEvent*(self: gen_qfileselector_types.QFileSelector, event: QChildEvent): void =
  fQFileSelector_virtualbase_childEvent(self.h, event.h)

type QFileSelectorchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QFileSelector_childEvent(self: ptr cQFileSelector, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QFileSelector_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QFileSelectorcustomEvent*(self: gen_qfileselector_types.QFileSelector, event: QEvent): void =
  fQFileSelector_virtualbase_customEvent(self.h, event.h)

type QFileSelectorcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QFileSelector_customEvent(self: ptr cQFileSelector, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QFileSelector_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QFileSelectorconnectNotify*(self: gen_qfileselector_types.QFileSelector, signal: QMetaMethod): void =
  fQFileSelector_virtualbase_connectNotify(self.h, signal.h)

type QFileSelectorconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QFileSelector_connectNotify(self: ptr cQFileSelector, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QFileSelector_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QFileSelectordisconnectNotify*(self: gen_qfileselector_types.QFileSelector, signal: QMetaMethod): void =
  fQFileSelector_virtualbase_disconnectNotify(self.h, signal.h)

type QFileSelectordisconnectNotifyProc* = proc(signal: QMetaMethod): void
