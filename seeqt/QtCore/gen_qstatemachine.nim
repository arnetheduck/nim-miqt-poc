...
proc create*(T: type gen_qstatemachine_types.QStateMachine, parent: QObject): gen_qstatemachine_types.QStateMachine =
  gen_qstatemachine_types.QStateMachine.init(fcQStateMachine_new3(parent.h))

proc create*(T: type gen_qstatemachine_types.QStateMachine, childMode: cint, parent: QObject): gen_qstatemachine_types.QStateMachine =
  gen_qstatemachine_types.QStateMachine.init(fcQStateMachine_new4(cint(childMode), parent.h))

proc metaObject*(self: gen_qstatemachine_types.QStateMachine, ): QMetaObject =
  QMetaObject(h: fcQStateMachine_metaObject(self.h))
...
proc addState*(self: gen_qstatemachine_types.QStateMachine, state: QAbstractState): void =
  fcQStateMachine_addState(self.h, state.h)

proc removeState*(self: gen_qstatemachine_types.QStateMachine, state: QAbstractState): void =
...
proc addDefaultAnimation*(self: gen_qstatemachine_types.QStateMachine, animation: QAbstractAnimation): void =
  fcQStateMachine_addDefaultAnimation(self.h, animation.h)

proc defaultAnimations*(self: gen_qstatemachine_types.QStateMachine, ): seq[QAbstractAnimation] =
  var v_ma = fcQStateMachine_defaultAnimations(self.h)
  var vx_ret = newSeq[QAbstractAnimation](int(v_ma.len))
  let v_outCast = cast[ptr UncheckedArray[pointer]](v_ma.data)
  for i in 0 ..< v_ma.len:
    vx_ret[i] = QAbstractAnimation(h: v_outCast[i])
  vx_ret

proc removeDefaultAnimation*(self: gen_qstatemachine_types.QStateMachine, animation: QAbstractAnimation): void =
...
proc postEvent*(self: gen_qstatemachine_types.QStateMachine, event: QEvent): void =
  fcQStateMachine_postEvent(self.h, event.h)

proc postDelayedEvent*(self: gen_qstatemachine_types.QStateMachine, event: QEvent, delay: cint): cint =
...
proc configuration*(self: gen_qstatemachine_types.QStateMachine, ): HashSet[QAbstractState] =
  var v_ma = fcQStateMachine_configuration(self.h)
  vx_ret: HashSet[QAbstractState])
  v_outCast = cast[ptr UncheckedArray[pointer](v_ma.data))
  for i in 0..<v_ma.len:
    vx_ret.incl QAbstractState(h: v_outCast[i])
  vx_ret

proc eventFilter*(self: gen_qstatemachine_types.QStateMachine, watched: QObject, event: QEvent): bool =
...
proc postEvent*(self: gen_qstatemachine_types.QStateMachine, event: QEvent, priority: cint): void =
...
proc onmetacall*(self: gen_qstatemachine_types.QStateMachine, slot: QStateMachinemetacallProc) =
  # TODO check subclass
  var tmp = new QStateMachinemetacallProc
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QStateMachine_metacall(self: ptr cQStateMachine, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QStateMachine_metacall ".} =
  var nimfunc = cast[ptr QStateMachinemetacallProc](cast[pointer](slot))
  ...
  virtualReturn
proc QStateMachineeventFilter*(self: gen_qstatemachine_types.QStateMachine, watched: QObject, event: QEvent): bool =
  fQStateMachine_virtualbase_eventFilter(self.h, watched.h, event.h)

type QStateMachineeventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QStateMachine_eventFilter(self: ptr cQStateMachine, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QStateMachine_eventFilter ".} =
  ...
  virtualReturn
proc QStateMachineonEntry*(self: gen_qstatemachine_types.QStateMachine, event: QEvent): void =
  fQStateMachine_virtualbase_onEntry(self.h, event.h)

type QStateMachineonEntryProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QStateMachine_onEntry(self: ptr cQStateMachine, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QStateMachine_onEntry ".} =
  ...
  nimfunc[](slotval1)
proc QStateMachineonExit*(self: gen_qstatemachine_types.QStateMachine, event: QEvent): void =
  fQStateMachine_virtualbase_onExit(self.h, event.h)

type QStateMachineonExitProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QStateMachine_onExit(self: ptr cQStateMachine, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QStateMachine_onExit ".} =
  ...
  nimfunc[](slotval1)
proc QStateMachinebeginSelectTransitions*(self: gen_qstatemachine_types.QStateMachine, event: QEvent): void =
  fQStateMachine_virtualbase_beginSelectTransitions(self.h, event.h)

type QStateMachinebeginSelectTransitionsProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QStateMachine_beginSelectTransitions(self: ptr cQStateMachine, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QStateMachine_beginSelectTransitions ".} =
  ...
  nimfunc[](slotval1)
proc QStateMachineendSelectTransitions*(self: gen_qstatemachine_types.QStateMachine, event: QEvent): void =
  fQStateMachine_virtualbase_endSelectTransitions(self.h, event.h)

type QStateMachineendSelectTransitionsProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QStateMachine_endSelectTransitions(self: ptr cQStateMachine, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QStateMachine_endSelectTransitions ".} =
  ...
  nimfunc[](slotval1)
proc QStateMachinebeginMicrostep*(self: gen_qstatemachine_types.QStateMachine, event: QEvent): void =
  fQStateMachine_virtualbase_beginMicrostep(self.h, event.h)

type QStateMachinebeginMicrostepProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QStateMachine_beginMicrostep(self: ptr cQStateMachine, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QStateMachine_beginMicrostep ".} =
  ...
  nimfunc[](slotval1)
proc QStateMachineendMicrostep*(self: gen_qstatemachine_types.QStateMachine, event: QEvent): void =
  fQStateMachine_virtualbase_endMicrostep(self.h, event.h)

type QStateMachineendMicrostepProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QStateMachine_endMicrostep(self: ptr cQStateMachine, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QStateMachine_endMicrostep ".} =
  ...
  nimfunc[](slotval1)
proc QStateMachineevent*(self: gen_qstatemachine_types.QStateMachine, e: QEvent): bool =
  fQStateMachine_virtualbase_event(self.h, e.h)

type QStateMachineeventProc* = proc(e: QEvent): bool
...
proc miqt_exec_callback_QStateMachine_event(self: ptr cQStateMachine, slot: int, e: pointer): bool {.exportc: "miqt_exec_callback_QStateMachine_event ".} =
  ...
  virtualReturn
proc QStateMachinetimerEvent*(self: gen_qstatemachine_types.QStateMachine, event: QTimerEvent): void =
  fQStateMachine_virtualbase_timerEvent(self.h, event.h)

type QStateMachinetimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QStateMachine_timerEvent(self: ptr cQStateMachine, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QStateMachine_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QStateMachinechildEvent*(self: gen_qstatemachine_types.QStateMachine, event: QChildEvent): void =
  fQStateMachine_virtualbase_childEvent(self.h, event.h)

type QStateMachinechildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QStateMachine_childEvent(self: ptr cQStateMachine, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QStateMachine_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QStateMachinecustomEvent*(self: gen_qstatemachine_types.QStateMachine, event: QEvent): void =
  fQStateMachine_virtualbase_customEvent(self.h, event.h)

type QStateMachinecustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QStateMachine_customEvent(self: ptr cQStateMachine, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QStateMachine_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QStateMachineconnectNotify*(self: gen_qstatemachine_types.QStateMachine, signal: QMetaMethod): void =
  fQStateMachine_virtualbase_connectNotify(self.h, signal.h)

type QStateMachineconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QStateMachine_connectNotify(self: ptr cQStateMachine, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QStateMachine_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QStateMachinedisconnectNotify*(self: gen_qstatemachine_types.QStateMachine, signal: QMetaMethod): void =
  fQStateMachine_virtualbase_disconnectNotify(self.h, signal.h)

type QStateMachinedisconnectNotifyProc* = proc(signal: QMetaMethod): void
...
func init*(T: type gen_qstatemachine_types.QStateMachineSignalEvent, h: ptr cQStateMachineSignalEvent): gen_qstatemachine_types.QStateMachineSignalEvent =
  T(h: h)
proc create*(T: type gen_qstatemachine_types.QStateMachineSignalEvent, param1: QStateMachineSignalEvent): gen_qstatemachine_types.QStateMachineSignalEvent =
  gen_qstatemachine_types.QStateMachineSignalEvent.init(fcQStateMachineSignalEvent_new(param1.h))

proc sender*(self: gen_qstatemachine_types.QStateMachineSignalEvent, ): QObject =
  QObject(h: fcQStateMachineSignalEvent_sender(self.h))
...
func init*(T: type gen_qstatemachine_types.QStateMachineWrappedEvent, h: ptr cQStateMachineWrappedEvent): gen_qstatemachine_types.QStateMachineWrappedEvent =
  T(h: h)
proc create*(T: type gen_qstatemachine_types.QStateMachineWrappedEvent, objectVal: QObject, event: QEvent): gen_qstatemachine_types.QStateMachineWrappedEvent =
  gen_qstatemachine_types.QStateMachineWrappedEvent.init(fcQStateMachineWrappedEvent_new(objectVal.h, event.h))

proc create*(T: type gen_qstatemachine_types.QStateMachineWrappedEvent, param1: QStateMachineWrappedEvent): gen_qstatemachine_types.QStateMachineWrappedEvent =
  gen_qstatemachine_types.QStateMachineWrappedEvent.init(fcQStateMachineWrappedEvent_new2(param1.h))

proc objectX*(self: gen_qstatemachine_types.QStateMachineWrappedEvent, ): QObject =
  QObject(h: fcQStateMachineWrappedEvent_objectX(self.h))

proc event*(self: gen_qstatemachine_types.QStateMachineWrappedEvent, ): QEvent =
  QEvent(h: fcQStateMachineWrappedEvent_event(self.h))
