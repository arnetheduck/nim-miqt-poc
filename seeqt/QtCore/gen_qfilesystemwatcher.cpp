...
QMetaObject* QFileSystemWatcher_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQFileSystemWatcher*)(self) )->QFileSystemWatcher::metaObject();

}

void* QFileSystemWatcher_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQFileSystemWatcher*)(self) )->QFileSystemWatcher::qt_metacast(param1);

}

int QFileSystemWatcher_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQFileSystemWatcher*)(self) )->QFileSystemWatcher::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
