...
proc create*(T: type gen_qtimezone_types.QTimeZone, other: QTimeZone): gen_qtimezone_types.QTimeZone =
...
proc operatorAssign*(self: gen_qtimezone_types.QTimeZone, other: QTimeZone): void =
  fcQTimeZone_operatorAssign(self.h, other.h)

proc swap*(self: gen_qtimezone_types.QTimeZone, other: QTimeZone): void =
...
proc displayName*(self: gen_qtimezone_types.QTimeZone, atDateTime: QDateTime): string =
...
proc abbreviation*(self: gen_qtimezone_types.QTimeZone, atDateTime: QDateTime): string =
  let v_ms = fcQTimeZone_abbreviation(self.h, atDateTime.h)
  let vx_ret = string.fromBytes(toOpenArrayByte(v_ms.data, 0, int(v_ms.len)-1))
  c_free(v_ms.data)
  vx_ret

proc offsetFromUtc*(self: gen_qtimezone_types.QTimeZone, atDateTime: QDateTime): cint =
  fcQTimeZone_offsetFromUtc(self.h, atDateTime.h)

proc standardTimeOffset*(self: gen_qtimezone_types.QTimeZone, atDateTime: QDateTime): cint =
  fcQTimeZone_standardTimeOffset(self.h, atDateTime.h)

proc daylightTimeOffset*(self: gen_qtimezone_types.QTimeZone, atDateTime: QDateTime): cint =
...
proc isDaylightTime*(self: gen_qtimezone_types.QTimeZone, atDateTime: QDateTime): bool =
  fcQTimeZone_isDaylightTime(self.h, atDateTime.h)

proc offsetData*(self: gen_qtimezone_types.QTimeZone, forDateTime: QDateTime): QTimeZoneOffsetData =
...
proc nextTransition*(self: gen_qtimezone_types.QTimeZone, afterDateTime: QDateTime): QTimeZoneOffsetData =
  QTimeZoneOffsetData(h: fcQTimeZone_nextTransition(self.h, afterDateTime.h))

proc previousTransition*(self: gen_qtimezone_types.QTimeZone, beforeDateTime: QDateTime): QTimeZoneOffsetData =
  QTimeZoneOffsetData(h: fcQTimeZone_previousTransition(self.h, beforeDateTime.h))

proc transitions*(self: gen_qtimezone_types.QTimeZone, fromDateTime: QDateTime, toDateTime: QDateTime): seq[QTimeZoneOffsetData] =
...
proc systemTimeZone*(_: type gen_qtimezone_types.QTimeZone, ): QTimeZone =
  QTimeZone(h: fcQTimeZone_systemTimeZone())

proc utc*(_: type gen_qtimezone_types.QTimeZone, ): QTimeZone =
...
proc windowsIdToDefaultIanaId*(_: type gen_qtimezone_types.QTimeZone, windowsId: seq[byte], country: cint): seq[byte] =
...
proc displayName*(self: gen_qtimezone_types.QTimeZone, atDateTime: QDateTime, nameType: cint): string =
  let v_ms = fcQTimeZone_displayName2(self.h, atDateTime.h, cint(nameType))
  let vx_ret = string.fromBytes(toOpenArrayByte(v_ms.data, 0, int(v_ms.len)-1))
  c_free(v_ms.data)
  vx_ret

proc displayName*(self: gen_qtimezone_types.QTimeZone, atDateTime: QDateTime, nameType: cint, locale: QLocale): string =
...
proc displayName*(self: gen_qtimezone_types.QTimeZone, timeType: cint, nameType: cint, locale: QLocale): string =
...
func init*(T: type gen_qtimezone_types.QTimeZoneOffsetData, h: ptr cQTimeZoneOffsetData): gen_qtimezone_types.QTimeZoneOffsetData =
  T(h: h)
proc create*(T: type gen_qtimezone_types.QTimeZoneOffsetData, param1: QTimeZoneOffsetData): gen_qtimezone_types.QTimeZoneOffsetData =
  gen_qtimezone_types.QTimeZoneOffsetData.init(fcQTimeZoneOffsetData_new(param1.h))

proc operatorAssign*(self: gen_qtimezone_types.QTimeZoneOffsetData, param1: QTimeZoneOffsetData): void =
