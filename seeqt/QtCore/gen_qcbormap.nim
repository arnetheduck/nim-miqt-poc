...
proc operatorMultiply*(self: gen_qcbormap_types.QCborMapIterator, ): tuple[first: QCborValueRef, second: QCborValueRef] =
  ...
  var v_entry_First = QCborValueRef(h: v_First_CArray[0])
...
proc operatorMultiply*(self: gen_qcbormap_types.QCborMapConstIterator, ): tuple[first: QCborValueRef, second: QCborValueRef] =
...
proc operatorMinusGreater*(self: gen_qcbormap_types.QCborMapConstIterator, ): QCborValueRef =
  QCborValueRef(h: fcQCborMapConstIterator_operatorMinusGreater(self.h))

proc key*(self: gen_qcbormap_types.QCborMapConstIterator, ): QCborValue =
  QCborValue(h: fcQCborMapConstIterator_key(self.h))

proc value*(self: gen_qcbormap_types.QCborMapConstIterator, ): QCborValueRef =
  QCborValueRef(h: fcQCborMapConstIterator_value(self.h))
