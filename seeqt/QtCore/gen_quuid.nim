...
proc create*(T: type gen_quuid_types.QUuid, string: QAnyStringView): gen_quuid_types.QUuid =
...
proc fromString*(_: type gen_quuid_types.QUuid, string: QAnyStringView): QUuid =
...
proc fromRfc4122*(_: type gen_quuid_types.QUuid, param1: QByteArrayView): QUuid =
