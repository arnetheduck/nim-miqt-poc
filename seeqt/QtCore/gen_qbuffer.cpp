...
QMetaObject* QBuffer_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQBuffer*)(self) )->QBuffer::metaObject();

}

void* QBuffer_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQBuffer*)(self) )->QBuffer::qt_metacast(param1);

}

int QBuffer_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQBuffer*)(self) )->QBuffer::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
