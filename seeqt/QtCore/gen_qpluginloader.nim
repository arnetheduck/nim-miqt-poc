...
proc create*(T: type gen_qpluginloader_types.QPluginLoader, parent: QObject): gen_qpluginloader_types.QPluginLoader =
  gen_qpluginloader_types.QPluginLoader.init(fcQPluginLoader_new3(parent.h))

proc create*(T: type gen_qpluginloader_types.QPluginLoader, fileName: string, parent: QObject): gen_qpluginloader_types.QPluginLoader =
...
proc metaObject*(self: gen_qpluginloader_types.QPluginLoader, ): QMetaObject =
  QMetaObject(h: fcQPluginLoader_metaObject(self.h))
...
proc instance*(self: gen_qpluginloader_types.QPluginLoader, ): QObject =
  QObject(h: fcQPluginLoader_instance(self.h))

proc metaData*(self: gen_qpluginloader_types.QPluginLoader, ): QJsonObject =
  QJsonObject(h: fcQPluginLoader_metaData(self.h))

proc staticInstances*(_: type gen_qpluginloader_types.QPluginLoader, ): seq[QObject] =
...
proc staticPlugins*(_: type gen_qpluginloader_types.QPluginLoader, ): seq[QStaticPlugin] =
  var v_ma = fcQPluginLoader_staticPlugins()
  var vx_ret = newSeq[QStaticPlugin](int(v_ma.len))
  let v_outCast = cast[ptr UncheckedArray[pointer]](v_ma.data)
  for i in 0 ..< v_ma.len:
    vx_ret[i] = QStaticPlugin(h: v_outCast[i])
  vx_ret
...
proc miqt_exec_callback_QPluginLoader_metacall(self: ptr cQPluginLoader, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QPluginLoader_metacall ".} =
  ...
  virtualReturn
proc QPluginLoaderevent*(self: gen_qpluginloader_types.QPluginLoader, event: QEvent): bool =
  fQPluginLoader_virtualbase_event(self.h, event.h)

type QPluginLoadereventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QPluginLoader_event(self: ptr cQPluginLoader, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QPluginLoader_event ".} =
  ...
  virtualReturn
proc QPluginLoadereventFilter*(self: gen_qpluginloader_types.QPluginLoader, watched: QObject, event: QEvent): bool =
  fQPluginLoader_virtualbase_eventFilter(self.h, watched.h, event.h)

type QPluginLoadereventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QPluginLoader_eventFilter(self: ptr cQPluginLoader, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QPluginLoader_eventFilter ".} =
  ...
  virtualReturn
proc QPluginLoadertimerEvent*(self: gen_qpluginloader_types.QPluginLoader, event: QTimerEvent): void =
  fQPluginLoader_virtualbase_timerEvent(self.h, event.h)

type QPluginLoadertimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QPluginLoader_timerEvent(self: ptr cQPluginLoader, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QPluginLoader_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QPluginLoaderchildEvent*(self: gen_qpluginloader_types.QPluginLoader, event: QChildEvent): void =
  fQPluginLoader_virtualbase_childEvent(self.h, event.h)

type QPluginLoaderchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QPluginLoader_childEvent(self: ptr cQPluginLoader, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QPluginLoader_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QPluginLoadercustomEvent*(self: gen_qpluginloader_types.QPluginLoader, event: QEvent): void =
  fQPluginLoader_virtualbase_customEvent(self.h, event.h)

type QPluginLoadercustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QPluginLoader_customEvent(self: ptr cQPluginLoader, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QPluginLoader_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QPluginLoaderconnectNotify*(self: gen_qpluginloader_types.QPluginLoader, signal: QMetaMethod): void =
  fQPluginLoader_virtualbase_connectNotify(self.h, signal.h)

type QPluginLoaderconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QPluginLoader_connectNotify(self: ptr cQPluginLoader, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QPluginLoader_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QPluginLoaderdisconnectNotify*(self: gen_qpluginloader_types.QPluginLoader, signal: QMetaMethod): void =
  fQPluginLoader_virtualbase_disconnectNotify(self.h, signal.h)

type QPluginLoaderdisconnectNotifyProc* = proc(signal: QMetaMethod): void
