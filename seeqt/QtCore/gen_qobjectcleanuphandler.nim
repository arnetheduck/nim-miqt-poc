...
proc metaObject*(self: gen_qobjectcleanuphandler_types.QObjectCleanupHandler, ): QMetaObject =
  QMetaObject(h: fcQObjectCleanupHandler_metaObject(self.h))
...
proc add*(self: gen_qobjectcleanuphandler_types.QObjectCleanupHandler, objectVal: QObject): QObject =
  QObject(h: fcQObjectCleanupHandler_add(self.h, objectVal.h))

proc remove*(self: gen_qobjectcleanuphandler_types.QObjectCleanupHandler, objectVal: QObject): void =
...
proc miqt_exec_callback_QObjectCleanupHandler_metacall(self: ptr cQObjectCleanupHandler, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QObjectCleanupHandler_metacall ".} =
  ...
  virtualReturn
proc QObjectCleanupHandlerevent*(self: gen_qobjectcleanuphandler_types.QObjectCleanupHandler, event: QEvent): bool =
  fQObjectCleanupHandler_virtualbase_event(self.h, event.h)

type QObjectCleanupHandlereventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QObjectCleanupHandler_event(self: ptr cQObjectCleanupHandler, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QObjectCleanupHandler_event ".} =
  ...
  virtualReturn
proc QObjectCleanupHandlereventFilter*(self: gen_qobjectcleanuphandler_types.QObjectCleanupHandler, watched: QObject, event: QEvent): bool =
  fQObjectCleanupHandler_virtualbase_eventFilter(self.h, watched.h, event.h)

type QObjectCleanupHandlereventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QObjectCleanupHandler_eventFilter(self: ptr cQObjectCleanupHandler, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QObjectCleanupHandler_eventFilter ".} =
  ...
  virtualReturn
proc QObjectCleanupHandlertimerEvent*(self: gen_qobjectcleanuphandler_types.QObjectCleanupHandler, event: QTimerEvent): void =
  fQObjectCleanupHandler_virtualbase_timerEvent(self.h, event.h)

type QObjectCleanupHandlertimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QObjectCleanupHandler_timerEvent(self: ptr cQObjectCleanupHandler, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QObjectCleanupHandler_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QObjectCleanupHandlerchildEvent*(self: gen_qobjectcleanuphandler_types.QObjectCleanupHandler, event: QChildEvent): void =
  fQObjectCleanupHandler_virtualbase_childEvent(self.h, event.h)

type QObjectCleanupHandlerchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QObjectCleanupHandler_childEvent(self: ptr cQObjectCleanupHandler, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QObjectCleanupHandler_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QObjectCleanupHandlercustomEvent*(self: gen_qobjectcleanuphandler_types.QObjectCleanupHandler, event: QEvent): void =
  fQObjectCleanupHandler_virtualbase_customEvent(self.h, event.h)

type QObjectCleanupHandlercustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QObjectCleanupHandler_customEvent(self: ptr cQObjectCleanupHandler, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QObjectCleanupHandler_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QObjectCleanupHandlerconnectNotify*(self: gen_qobjectcleanuphandler_types.QObjectCleanupHandler, signal: QMetaMethod): void =
  fQObjectCleanupHandler_virtualbase_connectNotify(self.h, signal.h)

type QObjectCleanupHandlerconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QObjectCleanupHandler_connectNotify(self: ptr cQObjectCleanupHandler, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QObjectCleanupHandler_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QObjectCleanupHandlerdisconnectNotify*(self: gen_qobjectcleanuphandler_types.QObjectCleanupHandler, signal: QMetaMethod): void =
  fQObjectCleanupHandler_virtualbase_disconnectNotify(self.h, signal.h)

type QObjectCleanupHandlerdisconnectNotifyProc* = proc(signal: QMetaMethod): void
