...
func init*(T: type gen_qreadwritelock_types.QReadLocker, h: ptr cQReadLocker): gen_qreadwritelock_types.QReadLocker =
  T(h: h)
proc create*(T: type gen_qreadwritelock_types.QReadLocker, readWriteLock: QReadWriteLock): gen_qreadwritelock_types.QReadLocker =
...
proc readWriteLock*(self: gen_qreadwritelock_types.QReadLocker, ): QReadWriteLock =
...
func init*(T: type gen_qreadwritelock_types.QWriteLocker, h: ptr cQWriteLocker): gen_qreadwritelock_types.QWriteLocker =
  T(h: h)
proc create*(T: type gen_qreadwritelock_types.QWriteLocker, readWriteLock: QReadWriteLock): gen_qreadwritelock_types.QWriteLocker =
...
proc readWriteLock*(self: gen_qreadwritelock_types.QWriteLocker, ): QReadWriteLock =
