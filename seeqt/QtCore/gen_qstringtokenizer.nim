...
func init*(T: type gen_qstringtokenizer_types.QStringTokenizerBaseBase, h: ptr cQStringTokenizerBaseBase): gen_qstringtokenizer_types.QStringTokenizerBaseBase =
  T(h: h)
proc create*(T: type gen_qstringtokenizer_types.QStringTokenizerBaseBase, param1: QStringTokenizerBaseBase): gen_qstringtokenizer_types.QStringTokenizerBaseBase =
