...
proc operatorMultiply*(self: gen_qcborarray_types.QCborArrayConstIterator, ): QCborValueRef =
  QCborValueRef(h: fcQCborArrayConstIterator_operatorMultiply(self.h))

proc operatorMinusGreater*(self: gen_qcborarray_types.QCborArrayConstIterator, ): QCborValueRef =
  QCborValueRef(h: fcQCborArrayConstIterator_operatorMinusGreater(self.h))

proc operatorSubscript*(self: gen_qcborarray_types.QCborArrayConstIterator, j: int64): QCborValueRef =
  QCborValueRef(h: fcQCborArrayConstIterator_operatorSubscript(self.h, j))
