...
proc fcQCborArrayIterator_operatorMinusGreater2(self: pointer, ): pointer {.importc: "QCborArray__Iterator_operatorMinusGreater2".}
...
func init*(T: type gen_qcborarray_types.QCborArray, h: ptr cQCborArray): gen_qcborarray_types.QCborArray =
  T(h: h)
proc create*(T: type gen_qcborarray_types.QCborArray, ): gen_qcborarray_types.QCborArray =
  gen_qcborarray_types.QCborArray.init(fcQCborArray_new())

proc create*(T: type gen_qcborarray_types.QCborArray, other: QCborArray): gen_qcborarray_types.QCborArray =
  gen_qcborarray_types.QCborArray.init(fcQCborArray_new2(other.h))

proc operatorAssign*(self: gen_qcborarray_types.QCborArray, other: QCborArray): void =
  fcQCborArray_operatorAssign(self.h, other.h)

proc swap*(self: gen_qcborarray_types.QCborArray, other: QCborArray): void =
  fcQCborArray_swap(self.h, other.h)

proc toCborValue*(self: gen_qcborarray_types.QCborArray, ): QCborValue =
  QCborValue(h: fcQCborArray_toCborValue(self.h))
...
proc at*(self: gen_qcborarray_types.QCborArray, i: int64): QCborValue =
  QCborValue(h: fcQCborArray_at(self.h, i))

proc first*(self: gen_qcborarray_types.QCborArray, ): QCborValue =
  QCborValue(h: fcQCborArray_first(self.h))

proc last*(self: gen_qcborarray_types.QCborArray, ): QCborValue =
  QCborValue(h: fcQCborArray_last(self.h))

proc operatorSubscript*(self: gen_qcborarray_types.QCborArray, i: int64): QCborValue =
  QCborValue(h: fcQCborArray_operatorSubscript(self.h, i))

proc first2*(self: gen_qcborarray_types.QCborArray, ): QCborValueRef =
  QCborValueRef(h: fcQCborArray_first2(self.h))

proc last2*(self: gen_qcborarray_types.QCborArray, ): QCborValueRef =
  QCborValueRef(h: fcQCborArray_last2(self.h))

proc operatorSubscript2*(self: gen_qcborarray_types.QCborArray, i: int64): QCborValueRef =
  QCborValueRef(h: fcQCborArray_operatorSubscriptWithQsizetype(self.h, i))

proc insert*(self: gen_qcborarray_types.QCborArray, i: int64, value: QCborValue): void =
  fcQCborArray_insert(self.h, i, value.h)

proc prepend*(self: gen_qcborarray_types.QCborArray, value: QCborValue): void =
  fcQCborArray_prepend(self.h, value.h)

proc append*(self: gen_qcborarray_types.QCborArray, value: QCborValue): void =
  fcQCborArray_append(self.h, value.h)

proc extract*(self: gen_qcborarray_types.QCborArray, it: QCborArrayConstIterator): QCborValue =
  QCborValue(h: fcQCborArray_extract(self.h, it.h))

proc extract*(self: gen_qcborarray_types.QCborArray, it: QCborArrayIterator): QCborValue =
  QCborValue(h: fcQCborArray_extractWithIt(self.h, it.h))

proc removeAt*(self: gen_qcborarray_types.QCborArray, i: int64): void =
  fcQCborArray_removeAt(self.h, i)

proc takeAt*(self: gen_qcborarray_types.QCborArray, i: int64): QCborValue =
  QCborValue(h: fcQCborArray_takeAt(self.h, i))
...
proc takeFirst*(self: gen_qcborarray_types.QCborArray, ): QCborValue =
  QCborValue(h: fcQCborArray_takeFirst(self.h))

proc takeLast*(self: gen_qcborarray_types.QCborArray, ): QCborValue =
  QCborValue(h: fcQCborArray_takeLast(self.h))

proc contains*(self: gen_qcborarray_types.QCborArray, value: QCborValue): bool =
  fcQCborArray_contains(self.h, value.h)

proc compare*(self: gen_qcborarray_types.QCborArray, other: QCborArray): cint =
  fcQCborArray_compare(self.h, other.h)

proc operatorEqual*(self: gen_qcborarray_types.QCborArray, other: QCborArray): bool =
  fcQCborArray_operatorEqual(self.h, other.h)

proc operatorNotEqual*(self: gen_qcborarray_types.QCborArray, other: QCborArray): bool =
  fcQCborArray_operatorNotEqual(self.h, other.h)

proc operatorLesser*(self: gen_qcborarray_types.QCborArray, other: QCborArray): bool =
  fcQCborArray_operatorLesser(self.h, other.h)

proc begin*(self: gen_qcborarray_types.QCborArray, ): QCborArrayIterator =
  QCborArrayIterator(h: fcQCborArray_begin(self.h))

proc constBegin*(self: gen_qcborarray_types.QCborArray, ): QCborArrayConstIterator =
  QCborArrayConstIterator(h: fcQCborArray_constBegin(self.h))

proc begin2*(self: gen_qcborarray_types.QCborArray, ): QCborArrayConstIterator =
  QCborArrayConstIterator(h: fcQCborArray_begin2(self.h))

proc cbegin*(self: gen_qcborarray_types.QCborArray, ): QCborArrayConstIterator =
  QCborArrayConstIterator(h: fcQCborArray_cbegin(self.h))

proc endX*(self: gen_qcborarray_types.QCborArray, ): QCborArrayIterator =
  QCborArrayIterator(h: fcQCborArray_endX(self.h))

proc constEnd*(self: gen_qcborarray_types.QCborArray, ): QCborArrayConstIterator =
  QCborArrayConstIterator(h: fcQCborArray_constEnd(self.h))

proc endX2*(self: gen_qcborarray_types.QCborArray, ): QCborArrayConstIterator =
  QCborArrayConstIterator(h: fcQCborArray_end2(self.h))

proc cend*(self: gen_qcborarray_types.QCborArray, ): QCborArrayConstIterator =
  QCborArrayConstIterator(h: fcQCborArray_cend(self.h))

proc insert*(self: gen_qcborarray_types.QCborArray, before: QCborArrayIterator, value: QCborValue): QCborArrayIterator =
  QCborArrayIterator(h: fcQCborArray_insert2(self.h, before.h, value.h))

proc insert*(self: gen_qcborarray_types.QCborArray, before: QCborArrayConstIterator, value: QCborValue): QCborArrayIterator =
  QCborArrayIterator(h: fcQCborArray_insert3(self.h, before.h, value.h))

proc erase*(self: gen_qcborarray_types.QCborArray, it: QCborArrayIterator): QCborArrayIterator =
  QCborArrayIterator(h: fcQCborArray_erase(self.h, it.h))

proc erase*(self: gen_qcborarray_types.QCborArray, it: QCborArrayConstIterator): QCborArrayIterator =
  QCborArrayIterator(h: fcQCborArray_eraseWithIt(self.h, it.h))

proc pushBack*(self: gen_qcborarray_types.QCborArray, t: QCborValue): void =
  fcQCborArray_pushBack(self.h, t.h)

proc pushFront*(self: gen_qcborarray_types.QCborArray, t: QCborValue): void =
...
proc operatorPlus*(self: gen_qcborarray_types.QCborArray, v: QCborValue): QCborArray =
  QCborArray(h: fcQCborArray_operatorPlus(self.h, v.h))

proc operatorPlusAssign*(self: gen_qcborarray_types.QCborArray, v: QCborValue): QCborArray =
  QCborArray(h: fcQCborArray_operatorPlusAssign(self.h, v.h))

proc operatorShiftLeft*(self: gen_qcborarray_types.QCborArray, v: QCborValue): QCborArray =
  QCborArray(h: fcQCborArray_operatorShiftLeft(self.h, v.h))

proc fromStringList*(_: type gen_qcborarray_types.QCborArray, list: seq[string]): QCborArray =
...
proc fromJsonArray*(_: type gen_qcborarray_types.QCborArray, array: QJsonArray): QCborArray =
  QCborArray(h: fcQCborArray_fromJsonArray(array.h))

proc toJsonArray*(self: gen_qcborarray_types.QCborArray, ): QJsonArray =
  QJsonArray(h: fcQCborArray_toJsonArray(self.h))

proc delete*(self: gen_qcborarray_types.QCborArray) =
  fcQCborArray_delete(self.h)

func init*(T: type gen_qcborarray_types.QCborArrayIterator, h: ptr cQCborArrayIterator): gen_qcborarray_types.QCborArrayIterator =
  T(h: h)
proc create*(T: type gen_qcborarray_types.QCborArrayIterator, ): gen_qcborarray_types.QCborArrayIterator =
  gen_qcborarray_types.QCborArrayIterator.init(fcQCborArrayIterator_new())

proc create*(T: type gen_qcborarray_types.QCborArrayIterator, param1: QCborArrayIterator): gen_qcborarray_types.QCborArrayIterator =
  gen_qcborarray_types.QCborArrayIterator.init(fcQCborArrayIterator_new2(param1.h))

proc operatorAssign*(self: gen_qcborarray_types.QCborArrayIterator, other: QCborArrayIterator): void =
  fcQCborArrayIterator_operatorAssign(self.h, other.h)

proc operatorMultiply*(self: gen_qcborarray_types.QCborArrayIterator, ): QCborValueRef =
  QCborValueRef(h: fcQCborArrayIterator_operatorMultiply(self.h))

proc operatorMinusGreater*(self: gen_qcborarray_types.QCborArrayIterator, ): QCborValueRef =
  QCborValueRef(h: fcQCborArrayIterator_operatorMinusGreater(self.h))

proc operatorMinusGreater2*(self: gen_qcborarray_types.QCborArrayIterator, ): QCborValueConstRef =
  QCborValueConstRef(h: fcQCborArrayIterator_operatorMinusGreater2(self.h))

proc operatorSubscript*(self: gen_qcborarray_types.QCborArrayIterator, j: int64): QCborValueRef =
  QCborValueRef(h: fcQCborArrayIterator_operatorSubscript(self.h, j))

proc operatorEqual*(self: gen_qcborarray_types.QCborArrayIterator, o: QCborArrayIterator): bool =
  fcQCborArrayIterator_operatorEqual(self.h, o.h)

proc operatorNotEqual*(self: gen_qcborarray_types.QCborArrayIterator, o: QCborArrayIterator): bool =
  fcQCborArrayIterator_operatorNotEqual(self.h, o.h)

proc operatorLesser*(self: gen_qcborarray_types.QCborArrayIterator, other: QCborArrayIterator): bool =
  fcQCborArrayIterator_operatorLesser(self.h, other.h)

proc operatorLesserOrEqual*(self: gen_qcborarray_types.QCborArrayIterator, other: QCborArrayIterator): bool =
  fcQCborArrayIterator_operatorLesserOrEqual(self.h, other.h)

proc operatorGreater*(self: gen_qcborarray_types.QCborArrayIterator, other: QCborArrayIterator): bool =
  fcQCborArrayIterator_operatorGreater(self.h, other.h)

proc operatorGreaterOrEqual*(self: gen_qcborarray_types.QCborArrayIterator, other: QCborArrayIterator): bool =
  fcQCborArrayIterator_operatorGreaterOrEqual(self.h, other.h)

proc operatorEqual*(self: gen_qcborarray_types.QCborArrayIterator, o: QCborArrayConstIterator): bool =
  fcQCborArrayIterator_operatorEqualWithQCborArrayConstIterator(self.h, o.h)

proc operatorNotEqual*(self: gen_qcborarray_types.QCborArrayIterator, o: QCborArrayConstIterator): bool =
  fcQCborArrayIterator_operatorNotEqualWithQCborArrayConstIterator(self.h, o.h)

proc operatorLesser*(self: gen_qcborarray_types.QCborArrayIterator, other: QCborArrayConstIterator): bool =
  fcQCborArrayIterator_operatorLesserWithOther(self.h, other.h)

proc operatorLesserOrEqual*(self: gen_qcborarray_types.QCborArrayIterator, other: QCborArrayConstIterator): bool =
  fcQCborArrayIterator_operatorLesserOrEqualWithOther(self.h, other.h)

proc operatorGreater*(self: gen_qcborarray_types.QCborArrayIterator, other: QCborArrayConstIterator): bool =
  fcQCborArrayIterator_operatorGreaterWithOther(self.h, other.h)

proc operatorGreaterOrEqual*(self: gen_qcborarray_types.QCborArrayIterator, other: QCborArrayConstIterator): bool =
  fcQCborArrayIterator_operatorGreaterOrEqualWithOther(self.h, other.h)

proc operatorPlusPlus*(self: gen_qcborarray_types.QCborArrayIterator, ): QCborArrayIterator =
  QCborArrayIterator(h: fcQCborArrayIterator_operatorPlusPlus(self.h))

proc operatorPlusPlus*(self: gen_qcborarray_types.QCborArrayIterator, param1: cint): QCborArrayIterator =
  QCborArrayIterator(h: fcQCborArrayIterator_operatorPlusPlusWithInt(self.h, param1))

proc operatorMinusMinus*(self: gen_qcborarray_types.QCborArrayIterator, ): QCborArrayIterator =
  QCborArrayIterator(h: fcQCborArrayIterator_operatorMinusMinus(self.h))

proc operatorMinusMinus*(self: gen_qcborarray_types.QCborArrayIterator, param1: cint): QCborArrayIterator =
  QCborArrayIterator(h: fcQCborArrayIterator_operatorMinusMinusWithInt(self.h, param1))

proc operatorPlusAssign*(self: gen_qcborarray_types.QCborArrayIterator, j: int64): QCborArrayIterator =
  QCborArrayIterator(h: fcQCborArrayIterator_operatorPlusAssign(self.h, j))

proc operatorMinusAssign*(self: gen_qcborarray_types.QCborArrayIterator, j: int64): QCborArrayIterator =
  QCborArrayIterator(h: fcQCborArrayIterator_operatorMinusAssign(self.h, j))

proc operatorPlus*(self: gen_qcborarray_types.QCborArrayIterator, j: int64): QCborArrayIterator =
  QCborArrayIterator(h: fcQCborArrayIterator_operatorPlus(self.h, j))

proc operatorMinus*(self: gen_qcborarray_types.QCborArrayIterator, j: int64): QCborArrayIterator =
  QCborArrayIterator(h: fcQCborArrayIterator_operatorMinus(self.h, j))

proc operatorMinus*(self: gen_qcborarray_types.QCborArrayIterator, j: QCborArrayIterator): int64 =
...
func init*(T: type gen_qcborarray_types.QCborArrayConstIterator, h: ptr cQCborArrayConstIterator): gen_qcborarray_types.QCborArrayConstIterator =
  T(h: h)
proc create*(T: type gen_qcborarray_types.QCborArrayConstIterator, ): gen_qcborarray_types.QCborArrayConstIterator =
  gen_qcborarray_types.QCborArrayConstIterator.init(fcQCborArrayConstIterator_new())

proc create*(T: type gen_qcborarray_types.QCborArrayConstIterator, param1: QCborArrayConstIterator): gen_qcborarray_types.QCborArrayConstIterator =
  gen_qcborarray_types.QCborArrayConstIterator.init(fcQCborArrayConstIterator_new2(param1.h))

proc operatorAssign*(self: gen_qcborarray_types.QCborArrayConstIterator, other: QCborArrayConstIterator): void =
  fcQCborArrayConstIterator_operatorAssign(self.h, other.h)

proc operatorMultiply*(self: gen_qcborarray_types.QCborArrayConstIterator, ): QCborValueConstRef =
  QCborValueConstRef(h: fcQCborArrayConstIterator_operatorMultiply(self.h))

proc operatorMinusGreater*(self: gen_qcborarray_types.QCborArrayConstIterator, ): QCborValueConstRef =
  QCborValueConstRef(h: fcQCborArrayConstIterator_operatorMinusGreater(self.h))

proc operatorSubscript*(self: gen_qcborarray_types.QCborArrayConstIterator, j: int64): QCborValueConstRef =
  QCborValueConstRef(h: fcQCborArrayConstIterator_operatorSubscript(self.h, j))

proc operatorEqual*(self: gen_qcborarray_types.QCborArrayConstIterator, o: QCborArrayIterator): bool =
  fcQCborArrayConstIterator_operatorEqual(self.h, o.h)

proc operatorNotEqual*(self: gen_qcborarray_types.QCborArrayConstIterator, o: QCborArrayIterator): bool =
  fcQCborArrayConstIterator_operatorNotEqual(self.h, o.h)

proc operatorLesser*(self: gen_qcborarray_types.QCborArrayConstIterator, other: QCborArrayIterator): bool =
  fcQCborArrayConstIterator_operatorLesser(self.h, other.h)

proc operatorLesserOrEqual*(self: gen_qcborarray_types.QCborArrayConstIterator, other: QCborArrayIterator): bool =
  fcQCborArrayConstIterator_operatorLesserOrEqual(self.h, other.h)

proc operatorGreater*(self: gen_qcborarray_types.QCborArrayConstIterator, other: QCborArrayIterator): bool =
  fcQCborArrayConstIterator_operatorGreater(self.h, other.h)

proc operatorGreaterOrEqual*(self: gen_qcborarray_types.QCborArrayConstIterator, other: QCborArrayIterator): bool =
  fcQCborArrayConstIterator_operatorGreaterOrEqual(self.h, other.h)

proc operatorEqual*(self: gen_qcborarray_types.QCborArrayConstIterator, o: QCborArrayConstIterator): bool =
  fcQCborArrayConstIterator_operatorEqualWithQCborArrayConstIterator(self.h, o.h)

proc operatorNotEqual*(self: gen_qcborarray_types.QCborArrayConstIterator, o: QCborArrayConstIterator): bool =
  fcQCborArrayConstIterator_operatorNotEqualWithQCborArrayConstIterator(self.h, o.h)

proc operatorLesser*(self: gen_qcborarray_types.QCborArrayConstIterator, other: QCborArrayConstIterator): bool =
  fcQCborArrayConstIterator_operatorLesserWithOther(self.h, other.h)

proc operatorLesserOrEqual*(self: gen_qcborarray_types.QCborArrayConstIterator, other: QCborArrayConstIterator): bool =
  fcQCborArrayConstIterator_operatorLesserOrEqualWithOther(self.h, other.h)

proc operatorGreater*(self: gen_qcborarray_types.QCborArrayConstIterator, other: QCborArrayConstIterator): bool =
  fcQCborArrayConstIterator_operatorGreaterWithOther(self.h, other.h)

proc operatorGreaterOrEqual*(self: gen_qcborarray_types.QCborArrayConstIterator, other: QCborArrayConstIterator): bool =
  fcQCborArrayConstIterator_operatorGreaterOrEqualWithOther(self.h, other.h)

proc operatorPlusPlus*(self: gen_qcborarray_types.QCborArrayConstIterator, ): QCborArrayConstIterator =
  QCborArrayConstIterator(h: fcQCborArrayConstIterator_operatorPlusPlus(self.h))

proc operatorPlusPlus*(self: gen_qcborarray_types.QCborArrayConstIterator, param1: cint): QCborArrayConstIterator =
  QCborArrayConstIterator(h: fcQCborArrayConstIterator_operatorPlusPlusWithInt(self.h, param1))

proc operatorMinusMinus*(self: gen_qcborarray_types.QCborArrayConstIterator, ): QCborArrayConstIterator =
  QCborArrayConstIterator(h: fcQCborArrayConstIterator_operatorMinusMinus(self.h))

proc operatorMinusMinus*(self: gen_qcborarray_types.QCborArrayConstIterator, param1: cint): QCborArrayConstIterator =
  QCborArrayConstIterator(h: fcQCborArrayConstIterator_operatorMinusMinusWithInt(self.h, param1))

proc operatorPlusAssign*(self: gen_qcborarray_types.QCborArrayConstIterator, j: int64): QCborArrayConstIterator =
  QCborArrayConstIterator(h: fcQCborArrayConstIterator_operatorPlusAssign(self.h, j))

proc operatorMinusAssign*(self: gen_qcborarray_types.QCborArrayConstIterator, j: int64): QCborArrayConstIterator =
  QCborArrayConstIterator(h: fcQCborArrayConstIterator_operatorMinusAssign(self.h, j))

proc operatorPlus*(self: gen_qcborarray_types.QCborArrayConstIterator, j: int64): QCborArrayConstIterator =
  QCborArrayConstIterator(h: fcQCborArrayConstIterator_operatorPlus(self.h, j))

proc operatorMinus*(self: gen_qcborarray_types.QCborArrayConstIterator, j: int64): QCborArrayConstIterator =
  QCborArrayConstIterator(h: fcQCborArrayConstIterator_operatorMinus(self.h, j))

proc operatorMinus*(self: gen_qcborarray_types.QCborArrayConstIterator, j: QCborArrayConstIterator): int64 =
