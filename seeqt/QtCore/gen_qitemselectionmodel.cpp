...
public:
	...
	MiqtVirtualQItemSelectionModel(struct QItemSelectionModel_VTable* vtbl): QItemSelectionModel(), vtbl(vtbl) {};
	MiqtVirtualQItemSelectionModel(struct QItemSelectionModel_VTable* vtbl, QAbstractItemModel* model, QObject* parent): QItemSelectionModel(model, parent), vtbl(vtbl) {};
	MiqtVirtualQItemSelectionModel(struct QItemSelectionModel_VTable* vtbl, QAbstractItemModel* model): QItemSelectionModel(model), vtbl(vtbl) {};

	virtual ~MiqtVirtualQItemSelectionModel() override { if(vtbl->destructor) vtbl->destructor(vtbl, this); }
...
QItemSelectionModel* QItemSelectionModel_new(struct QItemSelectionModel_VTable* vtbl) {
	return new MiqtVirtualQItemSelectionModel(vtbl);
}
...
QItemSelectionModel* QItemSelectionModel_new2(struct QItemSelectionModel_VTable* vtbl, QAbstractItemModel* model, QObject* parent) {
	return new MiqtVirtualQItemSelectionModel(vtbl, model, parent);
}

QItemSelectionModel* QItemSelectionModel_new3(struct QItemSelectionModel_VTable* vtbl, QAbstractItemModel* model) {
	return new MiqtVirtualQItemSelectionModel(vtbl, model);
}
...
void QItemSelectionModel_connect_selectionChanged(QItemSelectionModel* self, intptr_t slot, void (*callback)(intptr_t, QItemSelection*, QItemSelection*), void (*release)(intptr_t)) {
	...
	MiqtVirtualQItemSelectionModel::connect(self, static_cast<void (QItemSelectionModel::*)(const QItemSelection&, const QItemSelection&)>(&QItemSelectionModel::selectionChanged), self, caller{slot, callback, release});
}
...
void QItemSelectionModel_connect_currentChanged(QItemSelectionModel* self, intptr_t slot, void (*callback)(intptr_t, QModelIndex*, QModelIndex*), void (*release)(intptr_t)) {
	...
	MiqtVirtualQItemSelectionModel::connect(self, static_cast<void (QItemSelectionModel::*)(const QModelIndex&, const QModelIndex&)>(&QItemSelectionModel::currentChanged), self, caller{slot, callback, release});
}
...
void QItemSelectionModel_connect_currentRowChanged(QItemSelectionModel* self, intptr_t slot, void (*callback)(intptr_t, QModelIndex*, QModelIndex*), void (*release)(intptr_t)) {
	...
	MiqtVirtualQItemSelectionModel::connect(self, static_cast<void (QItemSelectionModel::*)(const QModelIndex&, const QModelIndex&)>(&QItemSelectionModel::currentRowChanged), self, caller{slot, callback, release});
}
...
void QItemSelectionModel_connect_currentColumnChanged(QItemSelectionModel* self, intptr_t slot, void (*callback)(intptr_t, QModelIndex*, QModelIndex*), void (*release)(intptr_t)) {
	...
	MiqtVirtualQItemSelectionModel::connect(self, static_cast<void (QItemSelectionModel::*)(const QModelIndex&, const QModelIndex&)>(&QItemSelectionModel::currentColumnChanged), self, caller{slot, callback, release});
}
...
void QItemSelectionModel_connect_modelChanged(QItemSelectionModel* self, intptr_t slot, void (*callback)(intptr_t, QAbstractItemModel*), void (*release)(intptr_t)) {
	...
	MiqtVirtualQItemSelectionModel::connect(self, static_cast<void (QItemSelectionModel::*)(QAbstractItemModel*)>(&QItemSelectionModel::modelChanged), self, caller{slot, callback, release});
}
...
QMetaObject* QItemSelectionModel_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQItemSelectionModel*)(self) )->QItemSelectionModel::metaObject();

}

void* QItemSelectionModel_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQItemSelectionModel*)(self) )->QItemSelectionModel::qt_metacast(param1);

}

int QItemSelectionModel_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQItemSelectionModel*)(self) )->QItemSelectionModel::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
