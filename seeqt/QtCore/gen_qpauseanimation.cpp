...
QMetaObject* QPauseAnimation_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQPauseAnimation*)(self) )->QPauseAnimation::metaObject();

}

void* QPauseAnimation_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQPauseAnimation*)(self) )->QPauseAnimation::qt_metacast(param1);

}

int QPauseAnimation_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQPauseAnimation*)(self) )->QPauseAnimation::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
