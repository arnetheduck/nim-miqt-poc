...
QMetaObject* QState_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQState*)(self) )->QState::metaObject();

}

void* QState_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQState*)(self) )->QState::qt_metacast(param1);

}

int QState_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQState*)(self) )->QState::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
QObject* QState_protectedbase_sender(const void* self) {
	MiqtVirtualQState* self_cast = static_cast<MiqtVirtualQState*>( (QState*)(self) );
