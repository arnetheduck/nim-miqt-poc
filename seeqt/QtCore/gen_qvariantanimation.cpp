...
void QVariantAnimation_connect_valueChanged(QVariantAnimation* self, intptr_t slot, void (*callback)(intptr_t, QVariant*), void (*release)(intptr_t)) {
	...
	MiqtVirtualQVariantAnimation::connect(self, static_cast<void (QVariantAnimation::*)(const QVariant&)>(&QVariantAnimation::valueChanged), self, caller{slot, callback, release});
}
...
QMetaObject* QVariantAnimation_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQVariantAnimation*)(self) )->QVariantAnimation::metaObject();

}

void* QVariantAnimation_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQVariantAnimation*)(self) )->QVariantAnimation::qt_metacast(param1);

}

int QVariantAnimation_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQVariantAnimation*)(self) )->QVariantAnimation::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
