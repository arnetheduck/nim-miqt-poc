...
proc addData*(self: gen_qcryptographichash_types.QCryptographicHash, data: QByteArrayView): void =
  fcQCryptographicHash_addDataWithData(self.h, data.h)

proc addData*(self: gen_qcryptographichash_types.QCryptographicHash, device: QIODevice): bool =
...
proc resultView*(self: gen_qcryptographichash_types.QCryptographicHash, ): QByteArrayView =
  QByteArrayView(h: fcQCryptographicHash_resultView(self.h))

proc hash*(_: type gen_qcryptographichash_types.QCryptographicHash, data: QByteArrayView, methodVal: cint): seq[byte] =
