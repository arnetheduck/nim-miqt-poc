...
int QPluginLoader_virtualbase_metacall(void* self, int param1, int param2, void** param3) {
	...
	return ( (MiqtVirtualQPluginLoader*)(self) )->QPluginLoader::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
QObject* QPluginLoader_protectedbase_sender(const void* self) {
	MiqtVirtualQPluginLoader* self_cast = static_cast<MiqtVirtualQPluginLoader*>( (QPluginLoader*)(self) );
