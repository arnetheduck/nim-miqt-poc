...
func init*(T: type gen_qabstractstate_types.QAbstractState, h: ptr cQAbstractState): gen_qabstractstate_types.QAbstractState =
  T(h: h)
proc metaObject*(self: gen_qabstractstate_types.QAbstractState, ): QMetaObject =
  QMetaObject(h: fcQAbstractState_metaObject(self.h))
...
proc parentState*(self: gen_qabstractstate_types.QAbstractState, ): QState =
  QState(h: fcQAbstractState_parentState(self.h))

proc machine*(self: gen_qabstractstate_types.QAbstractState, ): QStateMachine =
  QStateMachine(h: fcQAbstractState_machine(self.h))
