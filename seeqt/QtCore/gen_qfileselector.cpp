...
QMetaObject* QFileSelector_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQFileSelector*)(self) )->QFileSelector::metaObject();

}

void* QFileSelector_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQFileSelector*)(self) )->QFileSelector::qt_metacast(param1);

}

int QFileSelector_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQFileSelector*)(self) )->QFileSelector::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
