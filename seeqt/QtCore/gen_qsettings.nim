...
proc create*(T: type gen_qsettings_types.QSettings, organization: string, application: string, parent: QObject): gen_qsettings_types.QSettings =
...
proc create*(T: type gen_qsettings_types.QSettings, scope: cint, organization: string, application: string, parent: QObject): gen_qsettings_types.QSettings =
...
proc create*(T: type gen_qsettings_types.QSettings, format: cint, scope: cint, organization: string, application: string, parent: QObject): gen_qsettings_types.QSettings =
...
proc create*(T: type gen_qsettings_types.QSettings, fileName: string, format: cint, parent: QObject): gen_qsettings_types.QSettings =
...
proc create*(T: type gen_qsettings_types.QSettings, parent: QObject): gen_qsettings_types.QSettings =
  gen_qsettings_types.QSettings.init(fcQSettings_new14(parent.h))

proc create*(T: type gen_qsettings_types.QSettings, scope: cint, parent: QObject): gen_qsettings_types.QSettings =
  gen_qsettings_types.QSettings.init(fcQSettings_new15(cint(scope), parent.h))

proc metaObject*(self: gen_qsettings_types.QSettings, ): QMetaObject =
  QMetaObject(h: fcQSettings_metaObject(self.h))
...
proc beginGroup*(self: gen_qsettings_types.QSettings, prefix: QAnyStringView): void =
...
proc beginReadArray*(self: gen_qsettings_types.QSettings, prefix: QAnyStringView): cint =
  fcQSettings_beginReadArray(self.h, prefix.h)

proc beginWriteArray*(self: gen_qsettings_types.QSettings, prefix: QAnyStringView): void =
...
proc setValue*(self: gen_qsettings_types.QSettings, key: QAnyStringView, value: QVariant): void =
  fcQSettings_setValue(self.h, key.h, value.h)

proc value*(self: gen_qsettings_types.QSettings, key: QAnyStringView, defaultValue: QVariant): QVariant =
  QVariant(h: fcQSettings_value(self.h, key.h, defaultValue.h))

proc value*(self: gen_qsettings_types.QSettings, key: QAnyStringView): QVariant =
  QVariant(h: fcQSettings_valueWithKey(self.h, key.h))

proc remove*(self: gen_qsettings_types.QSettings, key: QAnyStringView): void =
  fcQSettings_remove(self.h, key.h)

proc contains*(self: gen_qsettings_types.QSettings, key: QAnyStringView): bool =
...
proc beginWriteArray*(self: gen_qsettings_types.QSettings, prefix: QAnyStringView, size: cint): void =
...
proc miqt_exec_callback_QSettings_metacall(self: ptr cQSettings, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QSettings_metacall ".} =
  ...
  virtualReturn
proc QSettingsevent*(self: gen_qsettings_types.QSettings, event: QEvent): bool =
  fQSettings_virtualbase_event(self.h, event.h)

type QSettingseventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QSettings_event(self: ptr cQSettings, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QSettings_event ".} =
  ...
  virtualReturn
proc QSettingseventFilter*(self: gen_qsettings_types.QSettings, watched: QObject, event: QEvent): bool =
  fQSettings_virtualbase_eventFilter(self.h, watched.h, event.h)

type QSettingseventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QSettings_eventFilter(self: ptr cQSettings, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QSettings_eventFilter ".} =
  ...
  virtualReturn
proc QSettingstimerEvent*(self: gen_qsettings_types.QSettings, event: QTimerEvent): void =
  fQSettings_virtualbase_timerEvent(self.h, event.h)

type QSettingstimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QSettings_timerEvent(self: ptr cQSettings, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QSettings_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QSettingschildEvent*(self: gen_qsettings_types.QSettings, event: QChildEvent): void =
  fQSettings_virtualbase_childEvent(self.h, event.h)

type QSettingschildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QSettings_childEvent(self: ptr cQSettings, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QSettings_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QSettingscustomEvent*(self: gen_qsettings_types.QSettings, event: QEvent): void =
  fQSettings_virtualbase_customEvent(self.h, event.h)

type QSettingscustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QSettings_customEvent(self: ptr cQSettings, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QSettings_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QSettingsconnectNotify*(self: gen_qsettings_types.QSettings, signal: QMetaMethod): void =
  fQSettings_virtualbase_connectNotify(self.h, signal.h)

type QSettingsconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QSettings_connectNotify(self: ptr cQSettings, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QSettings_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QSettingsdisconnectNotify*(self: gen_qsettings_types.QSettings, signal: QMetaMethod): void =
  fQSettings_virtualbase_disconnectNotify(self.h, signal.h)

type QSettingsdisconnectNotifyProc* = proc(signal: QMetaMethod): void
