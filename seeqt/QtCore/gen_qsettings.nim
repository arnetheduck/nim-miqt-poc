...
proc setValue*(self: gen_qsettings_types.QSettings, key: string, value: QVariant): void =
  fcQSettings_setValue(self.h, struct_miqt_string(data: key, len: csize_t(len(key))), value.h)

proc value*(self: gen_qsettings_types.QSettings, key: string): QVariant =
  QVariant(h: fcQSettings_value(self.h, struct_miqt_string(data: key, len: csize_t(len(key)))))
...
proc setIniCodec*(self: gen_qsettings_types.QSettings, codec: QTextCodec): void =
...
proc iniCodec*(self: gen_qsettings_types.QSettings, ): QTextCodec =
  QTextCodec(h: fcQSettings_iniCodec(self.h))
...
proc beginWriteArray*(self: gen_qsettings_types.QSettings, prefix: string, size: cint): void =
  fcQSettings_beginWriteArray2(self.h, struct_miqt_string(data: prefix, len: csize_t(len(prefix))), size)

proc value*(self: gen_qsettings_types.QSettings, key: string, defaultValue: QVariant): QVariant =
  QVariant(h: fcQSettings_value2(self.h, struct_miqt_string(data: key, len: csize_t(len(key))), defaultValue.h))
