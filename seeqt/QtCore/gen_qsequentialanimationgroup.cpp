...
void QSequentialAnimationGroup_connect_currentAnimationChanged(QSequentialAnimationGroup* self, intptr_t slot, void (*callback)(intptr_t, QAbstractAnimation*), void (*release)(intptr_t)) {
	...
	MiqtVirtualQSequentialAnimationGroup::connect(self, static_cast<void (QSequentialAnimationGroup::*)(QAbstractAnimation*)>(&QSequentialAnimationGroup::currentAnimationChanged), self, caller{slot, callback, release});
}
...
QMetaObject* QSequentialAnimationGroup_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQSequentialAnimationGroup*)(self) )->QSequentialAnimationGroup::metaObject();

}

void* QSequentialAnimationGroup_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQSequentialAnimationGroup*)(self) )->QSequentialAnimationGroup::qt_metacast(param1);

}

int QSequentialAnimationGroup_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQSequentialAnimationGroup*)(self) )->QSequentialAnimationGroup::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
QObject* QSequentialAnimationGroup_protectedbase_sender(const void* self) {
	MiqtVirtualQSequentialAnimationGroup* self_cast = static_cast<MiqtVirtualQSequentialAnimationGroup*>( (QSequentialAnimationGroup*)(self) );
