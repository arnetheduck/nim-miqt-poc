...
proc create*(T: type gen_qstringlistmodel_types.QStringListModel, parent: QObject): gen_qstringlistmodel_types.QStringListModel =
  gen_qstringlistmodel_types.QStringListModel.init(fcQStringListModel_new3(parent.h))

proc create*(T: type gen_qstringlistmodel_types.QStringListModel, strings: seq[string], parent: QObject): gen_qstringlistmodel_types.QStringListModel =
  var strings_CArray = newSeq[struct_miqt_string](len(strings))
  for i in 0..<len(strings):
    strings_CArray[i] = struct_miqt_string(data: strings[i], len: csize_t(len(strings[i])))
...
proc metaObject*(self: gen_qstringlistmodel_types.QStringListModel, ): QMetaObject =
  QMetaObject(h: fcQStringListModel_metaObject(self.h))
...
proc rowCount*(self: gen_qstringlistmodel_types.QStringListModel, parent: QModelIndex): cint =
  fcQStringListModel_rowCount(self.h, parent.h)

proc sibling*(self: gen_qstringlistmodel_types.QStringListModel, row: cint, column: cint, idx: QModelIndex): QModelIndex =
  QModelIndex(h: fcQStringListModel_sibling(self.h, row, column, idx.h))

proc data*(self: gen_qstringlistmodel_types.QStringListModel, index: QModelIndex, role: cint): QVariant =
  QVariant(h: fcQStringListModel_data(self.h, index.h, role))

proc setData*(self: gen_qstringlistmodel_types.QStringListModel, index: QModelIndex, value: QVariant, role: cint): bool =
  fcQStringListModel_setData(self.h, index.h, value.h, role)

proc clearItemData*(self: gen_qstringlistmodel_types.QStringListModel, index: QModelIndex): bool =
  fcQStringListModel_clearItemData(self.h, index.h)

proc flags*(self: gen_qstringlistmodel_types.QStringListModel, index: QModelIndex): cint =
  cint(fcQStringListModel_flags(self.h, index.h))

proc insertRows*(self: gen_qstringlistmodel_types.QStringListModel, row: cint, count: cint, parent: QModelIndex): bool =
  fcQStringListModel_insertRows(self.h, row, count, parent.h)

proc removeRows*(self: gen_qstringlistmodel_types.QStringListModel, row: cint, count: cint, parent: QModelIndex): bool =
  fcQStringListModel_removeRows(self.h, row, count, parent.h)

proc moveRows*(self: gen_qstringlistmodel_types.QStringListModel, sourceParent: QModelIndex, sourceRow: cint, count: cint, destinationParent: QModelIndex, destinationChild: cint): bool =
  fcQStringListModel_moveRows(self.h, sourceParent.h, sourceRow, count, destinationParent.h, destinationChild)

proc itemData*(self: gen_qstringlistmodel_types.QStringListModel, index: QModelIndex): Table[cint,QVariant] =
...
proc setItemData*(self: gen_qstringlistmodel_types.QStringListModel, index: QModelIndex, roles: Table[cint,QVariant]): bool =
...
proc miqt_exec_callback_QStringListModel_metacall(self: ptr cQStringListModel, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QStringListModel_metacall ".} =
  ...
  virtualReturn
proc QStringListModelrowCount*(self: gen_qstringlistmodel_types.QStringListModel, parent: QModelIndex): cint =
  fQStringListModel_virtualbase_rowCount(self.h, parent.h)

type QStringListModelrowCountProc* = proc(parent: QModelIndex): cint
...
proc miqt_exec_callback_QStringListModel_rowCount(self: ptr cQStringListModel, slot: int, parent: pointer): cint {.exportc: "miqt_exec_callback_QStringListModel_rowCount ".} =
  ...
  virtualReturn
proc QStringListModelsibling*(self: gen_qstringlistmodel_types.QStringListModel, row: cint, column: cint, idx: QModelIndex): QModelIndex =
  QModelIndex(h: fQStringListModel_virtualbase_sibling(self.h, row, column, idx.h))

type QStringListModelsiblingProc* = proc(row: cint, column: cint, idx: QModelIndex): QModelIndex
...
proc miqt_exec_callback_QStringListModel_sibling(self: ptr cQStringListModel, slot: int, row: cint, column: cint, idx: pointer): pointer {.exportc: "miqt_exec_callback_QStringListModel_sibling ".} =
  ...
  virtualReturn.h
proc QStringListModeldata*(self: gen_qstringlistmodel_types.QStringListModel, index: QModelIndex, role: cint): QVariant =
  QVariant(h: fQStringListModel_virtualbase_data(self.h, index.h, role))

type QStringListModeldataProc* = proc(index: QModelIndex, role: cint): QVariant
...
proc miqt_exec_callback_QStringListModel_data(self: ptr cQStringListModel, slot: int, index: pointer, role: cint): pointer {.exportc: "miqt_exec_callback_QStringListModel_data ".} =
  ...
  virtualReturn.h
proc QStringListModelsetData*(self: gen_qstringlistmodel_types.QStringListModel, index: QModelIndex, value: QVariant, role: cint): bool =
  fQStringListModel_virtualbase_setData(self.h, index.h, value.h, role)

type QStringListModelsetDataProc* = proc(index: QModelIndex, value: QVariant, role: cint): bool
...
proc miqt_exec_callback_QStringListModel_setData(self: ptr cQStringListModel, slot: int, index: pointer, value: pointer, role: cint): bool {.exportc: "miqt_exec_callback_QStringListModel_setData ".} =
  ...
  virtualReturn
proc QStringListModelclearItemData*(self: gen_qstringlistmodel_types.QStringListModel, index: QModelIndex): bool =
  fQStringListModel_virtualbase_clearItemData(self.h, index.h)

type QStringListModelclearItemDataProc* = proc(index: QModelIndex): bool
...
proc miqt_exec_callback_QStringListModel_clearItemData(self: ptr cQStringListModel, slot: int, index: pointer): bool {.exportc: "miqt_exec_callback_QStringListModel_clearItemData ".} =
  ...
  virtualReturn
proc QStringListModelflags*(self: gen_qstringlistmodel_types.QStringListModel, index: QModelIndex): cint =
  cint(fQStringListModel_virtualbase_flags(self.h, index.h))

type QStringListModelflagsProc* = proc(index: QModelIndex): cint
...
proc miqt_exec_callback_QStringListModel_flags(self: ptr cQStringListModel, slot: int, index: pointer): cint {.exportc: "miqt_exec_callback_QStringListModel_flags ".} =
  ...
  cint(virtualReturn)
proc QStringListModelinsertRows*(self: gen_qstringlistmodel_types.QStringListModel, row: cint, count: cint, parent: QModelIndex): bool =
  fQStringListModel_virtualbase_insertRows(self.h, row, count, parent.h)

type QStringListModelinsertRowsProc* = proc(row: cint, count: cint, parent: QModelIndex): bool
...
proc miqt_exec_callback_QStringListModel_insertRows(self: ptr cQStringListModel, slot: int, row: cint, count: cint, parent: pointer): bool {.exportc: "miqt_exec_callback_QStringListModel_insertRows ".} =
  ...
  virtualReturn
proc QStringListModelremoveRows*(self: gen_qstringlistmodel_types.QStringListModel, row: cint, count: cint, parent: QModelIndex): bool =
  fQStringListModel_virtualbase_removeRows(self.h, row, count, parent.h)

type QStringListModelremoveRowsProc* = proc(row: cint, count: cint, parent: QModelIndex): bool
...
proc miqt_exec_callback_QStringListModel_removeRows(self: ptr cQStringListModel, slot: int, row: cint, count: cint, parent: pointer): bool {.exportc: "miqt_exec_callback_QStringListModel_removeRows ".} =
  ...
  virtualReturn
proc QStringListModelmoveRows*(self: gen_qstringlistmodel_types.QStringListModel, sourceParent: QModelIndex, sourceRow: cint, count: cint, destinationParent: QModelIndex, destinationChild: cint): bool =
  fQStringListModel_virtualbase_moveRows(self.h, sourceParent.h, sourceRow, count, destinationParent.h, destinationChild)

type QStringListModelmoveRowsProc* = proc(sourceParent: QModelIndex, sourceRow: cint, count: cint, destinationParent: QModelIndex, destinationChild: cint): bool
...
proc miqt_exec_callback_QStringListModel_moveRows(self: ptr cQStringListModel, slot: int, sourceParent: pointer, sourceRow: cint, count: cint, destinationParent: pointer, destinationChild: cint): bool {.exportc: "miqt_exec_callback_QStringListModel_moveRows ".} =
  ...
  virtualReturn
proc QStringListModelitemData*(self: gen_qstringlistmodel_types.QStringListModel, index: QModelIndex): Table[cint,QVariant] =
...
type QStringListModelitemDataProc* = proc(index: QModelIndex): Table[cint,QVariant]
...
proc QStringListModelsetItemData*(self: gen_qstringlistmodel_types.QStringListModel, index: QModelIndex, roles: Table[cint,QVariant]): bool =
  var roles_Keys_CArray = newSeq[cint](len(roles))
  var roles_Values_CArray = newSeq[pointer](len(roles))
  var roles_ctr = 0
  for rolesk, rolesv in roles:
...
type QStringListModelsetItemDataProc* = proc(index: QModelIndex, roles: Table[cint,QVariant]): bool
...
proc miqt_exec_callback_QStringListModel_supportedDropActions(self: ptr cQStringListModel, slot: int): cint {.exportc: "miqt_exec_callback_QStringListModel_supportedDropActions ".} =
  ...
  cint(virtualReturn)
proc QStringListModelindex*(self: gen_qstringlistmodel_types.QStringListModel, row: cint, column: cint, parent: QModelIndex): QModelIndex =
  QModelIndex(h: fQStringListModel_virtualbase_index(self.h, row, column, parent.h))

type QStringListModelindexProc* = proc(row: cint, column: cint, parent: QModelIndex): QModelIndex
...
proc miqt_exec_callback_QStringListModel_index(self: ptr cQStringListModel, slot: int, row: cint, column: cint, parent: pointer): pointer {.exportc: "miqt_exec_callback_QStringListModel_index ".} =
  ...
  virtualReturn.h
proc QStringListModeldropMimeData*(self: gen_qstringlistmodel_types.QStringListModel, data: QMimeData, action: cint, row: cint, column: cint, parent: QModelIndex): bool =
  fQStringListModel_virtualbase_dropMimeData(self.h, data.h, cint(action), row, column, parent.h)

type QStringListModeldropMimeDataProc* = proc(data: QMimeData, action: cint, row: cint, column: cint, parent: QModelIndex): bool
...
proc miqt_exec_callback_QStringListModel_dropMimeData(self: ptr cQStringListModel, slot: int, data: pointer, action: cint, row: cint, column: cint, parent: pointer): bool {.exportc: "miqt_exec_callback_QStringListModel_dropMimeData ".} =
  ...
  virtualReturn
proc QStringListModelheaderData*(self: gen_qstringlistmodel_types.QStringListModel, section: cint, orientation: cint, role: cint): QVariant =
  QVariant(h: fQStringListModel_virtualbase_headerData(self.h, section, cint(orientation), role))

type QStringListModelheaderDataProc* = proc(section: cint, orientation: cint, role: cint): QVariant
...
proc miqt_exec_callback_QStringListModel_headerData(self: ptr cQStringListModel, slot: int, section: cint, orientation: cint, role: cint): pointer {.exportc: "miqt_exec_callback_QStringListModel_headerData ".} =
  ...
  virtualReturn.h
proc QStringListModelsetHeaderData*(self: gen_qstringlistmodel_types.QStringListModel, section: cint, orientation: cint, value: QVariant, role: cint): bool =
  fQStringListModel_virtualbase_setHeaderData(self.h, section, cint(orientation), value.h, role)

type QStringListModelsetHeaderDataProc* = proc(section: cint, orientation: cint, value: QVariant, role: cint): bool
...
proc QStringListModelmimeData*(self: gen_qstringlistmodel_types.QStringListModel, indexes: seq[QModelIndex]): QMimeData =
  var indexes_CArray = newSeq[pointer](len(indexes))
  for i in 0..<len(indexes):
    indexes_CArray[i] = indexes[i].h

  QMimeData(h: fQStringListModel_virtualbase_mimeData(self.h, struct_miqt_array(len: csize_t(len(indexes)), data: if len(indexes) == 0: nil else: addr(indexes_CArray[0]))))

type QStringListModelmimeDataProc* = proc(indexes: seq[QModelIndex]): QMimeData
...
proc miqt_exec_callback_QStringListModel_mimeData(self: ptr cQStringListModel, slot: int, indexes: struct_miqt_array): pointer {.exportc: "miqt_exec_callback_QStringListModel_mimeData ".} =
  ...
  virtualReturn.h
proc QStringListModelcanDropMimeData*(self: gen_qstringlistmodel_types.QStringListModel, data: QMimeData, action: cint, row: cint, column: cint, parent: QModelIndex): bool =
  fQStringListModel_virtualbase_canDropMimeData(self.h, data.h, cint(action), row, column, parent.h)

type QStringListModelcanDropMimeDataProc* = proc(data: QMimeData, action: cint, row: cint, column: cint, parent: QModelIndex): bool
...
proc miqt_exec_callback_QStringListModel_supportedDragActions(self: ptr cQStringListModel, slot: int): cint {.exportc: "miqt_exec_callback_QStringListModel_supportedDragActions ".} =
  ...
  cint(virtualReturn)
proc QStringListModelinsertColumns*(self: gen_qstringlistmodel_types.QStringListModel, column: cint, count: cint, parent: QModelIndex): bool =
  fQStringListModel_virtualbase_insertColumns(self.h, column, count, parent.h)

type QStringListModelinsertColumnsProc* = proc(column: cint, count: cint, parent: QModelIndex): bool
...
proc miqt_exec_callback_QStringListModel_insertColumns(self: ptr cQStringListModel, slot: int, column: cint, count: cint, parent: pointer): bool {.exportc: "miqt_exec_callback_QStringListModel_insertColumns ".} =
  ...
  virtualReturn
proc QStringListModelremoveColumns*(self: gen_qstringlistmodel_types.QStringListModel, column: cint, count: cint, parent: QModelIndex): bool =
  fQStringListModel_virtualbase_removeColumns(self.h, column, count, parent.h)

type QStringListModelremoveColumnsProc* = proc(column: cint, count: cint, parent: QModelIndex): bool
...
proc miqt_exec_callback_QStringListModel_removeColumns(self: ptr cQStringListModel, slot: int, column: cint, count: cint, parent: pointer): bool {.exportc: "miqt_exec_callback_QStringListModel_removeColumns ".} =
  ...
  virtualReturn
proc QStringListModelmoveColumns*(self: gen_qstringlistmodel_types.QStringListModel, sourceParent: QModelIndex, sourceColumn: cint, count: cint, destinationParent: QModelIndex, destinationChild: cint): bool =
  fQStringListModel_virtualbase_moveColumns(self.h, sourceParent.h, sourceColumn, count, destinationParent.h, destinationChild)

type QStringListModelmoveColumnsProc* = proc(sourceParent: QModelIndex, sourceColumn: cint, count: cint, destinationParent: QModelIndex, destinationChild: cint): bool
...
proc miqt_exec_callback_QStringListModel_moveColumns(self: ptr cQStringListModel, slot: int, sourceParent: pointer, sourceColumn: cint, count: cint, destinationParent: pointer, destinationChild: cint): bool {.exportc: "miqt_exec_callback_QStringListModel_moveColumns ".} =
  ...
  virtualReturn
proc QStringListModelfetchMore*(self: gen_qstringlistmodel_types.QStringListModel, parent: QModelIndex): void =
  fQStringListModel_virtualbase_fetchMore(self.h, parent.h)

type QStringListModelfetchMoreProc* = proc(parent: QModelIndex): void
...
proc miqt_exec_callback_QStringListModel_fetchMore(self: ptr cQStringListModel, slot: int, parent: pointer): void {.exportc: "miqt_exec_callback_QStringListModel_fetchMore ".} =
  ...
  nimfunc[](slotval1)
proc QStringListModelcanFetchMore*(self: gen_qstringlistmodel_types.QStringListModel, parent: QModelIndex): bool =
  fQStringListModel_virtualbase_canFetchMore(self.h, parent.h)

type QStringListModelcanFetchMoreProc* = proc(parent: QModelIndex): bool
...
proc miqt_exec_callback_QStringListModel_canFetchMore(self: ptr cQStringListModel, slot: int, parent: pointer): bool {.exportc: "miqt_exec_callback_QStringListModel_canFetchMore ".} =
  ...
  virtualReturn
proc QStringListModelbuddy*(self: gen_qstringlistmodel_types.QStringListModel, index: QModelIndex): QModelIndex =
  QModelIndex(h: fQStringListModel_virtualbase_buddy(self.h, index.h))

type QStringListModelbuddyProc* = proc(index: QModelIndex): QModelIndex
...
proc miqt_exec_callback_QStringListModel_buddy(self: ptr cQStringListModel, slot: int, index: pointer): pointer {.exportc: "miqt_exec_callback_QStringListModel_buddy ".} =
  ...
  virtualReturn.h
proc QStringListModelmatch*(self: gen_qstringlistmodel_types.QStringListModel, start: QModelIndex, role: cint, value: QVariant, hits: cint, flags: cint): seq[QModelIndex] =
...
type QStringListModelmatchProc* = proc(start: QModelIndex, role: cint, value: QVariant, hits: cint, flags: cint): seq[QModelIndex]
...
proc miqt_exec_callback_QStringListModel_match(self: ptr cQStringListModel, slot: int, start: pointer, role: cint, value: pointer, hits: cint, flags: cint): struct_miqt_array {.exportc: "miqt_exec_callback_QStringListModel_match ".} =
  ...
  struct_miqt_array(len: csize_t(len(virtualReturn)), data: if len(virtualReturn) == 0: nil else: addr(virtualReturn_CArray[0]))
proc QStringListModelspan*(self: gen_qstringlistmodel_types.QStringListModel, index: QModelIndex): QSize =
  QSize(h: fQStringListModel_virtualbase_span(self.h, index.h))

type QStringListModelspanProc* = proc(index: QModelIndex): QSize
...
proc miqt_exec_callback_QStringListModel_roleNames(self: ptr cQStringListModel, slot: int): struct_miqt_map {.exportc: "miqt_exec_callback_QStringListModel_roleNames ".} =
  ...
  struct_miqt_map(len: csize_t(len(virtualReturn)),keys: if len(virtualReturn) == 0: nil else: addr(virtualReturn_Keys_CArray[0]), values: if len(virtualReturn) == 0: nil else: addr(virtualReturn_Values_CArray[0]),)
proc QStringListModelmultiData*(self: gen_qstringlistmodel_types.QStringListModel, index: QModelIndex, roleDataSpan: QModelRoleDataSpan): void =
  fQStringListModel_virtualbase_multiData(self.h, index.h, roleDataSpan.h)

type QStringListModelmultiDataProc* = proc(index: QModelIndex, roleDataSpan: QModelRoleDataSpan): void
...
proc miqt_exec_callback_QStringListModel_resetInternalData(self: ptr cQStringListModel, slot: int): void {.exportc: "miqt_exec_callback_QStringListModel_resetInternalData ".} =
  ...
  nimfunc[]()
proc QStringListModelevent*(self: gen_qstringlistmodel_types.QStringListModel, event: QEvent): bool =
  fQStringListModel_virtualbase_event(self.h, event.h)

type QStringListModeleventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QStringListModel_event(self: ptr cQStringListModel, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QStringListModel_event ".} =
  ...
  virtualReturn
proc QStringListModeleventFilter*(self: gen_qstringlistmodel_types.QStringListModel, watched: QObject, event: QEvent): bool =
  fQStringListModel_virtualbase_eventFilter(self.h, watched.h, event.h)

type QStringListModeleventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QStringListModel_eventFilter(self: ptr cQStringListModel, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QStringListModel_eventFilter ".} =
  ...
  virtualReturn
proc QStringListModeltimerEvent*(self: gen_qstringlistmodel_types.QStringListModel, event: QTimerEvent): void =
  fQStringListModel_virtualbase_timerEvent(self.h, event.h)

type QStringListModeltimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QStringListModel_timerEvent(self: ptr cQStringListModel, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QStringListModel_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QStringListModelchildEvent*(self: gen_qstringlistmodel_types.QStringListModel, event: QChildEvent): void =
  fQStringListModel_virtualbase_childEvent(self.h, event.h)

type QStringListModelchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QStringListModel_childEvent(self: ptr cQStringListModel, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QStringListModel_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QStringListModelcustomEvent*(self: gen_qstringlistmodel_types.QStringListModel, event: QEvent): void =
  fQStringListModel_virtualbase_customEvent(self.h, event.h)

type QStringListModelcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QStringListModel_customEvent(self: ptr cQStringListModel, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QStringListModel_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QStringListModelconnectNotify*(self: gen_qstringlistmodel_types.QStringListModel, signal: QMetaMethod): void =
  fQStringListModel_virtualbase_connectNotify(self.h, signal.h)

type QStringListModelconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QStringListModel_connectNotify(self: ptr cQStringListModel, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QStringListModel_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QStringListModeldisconnectNotify*(self: gen_qstringlistmodel_types.QStringListModel, signal: QMetaMethod): void =
  fQStringListModel_virtualbase_disconnectNotify(self.h, signal.h)

type QStringListModeldisconnectNotifyProc* = proc(signal: QMetaMethod): void
