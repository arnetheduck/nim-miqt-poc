...
func init*(T: type gen_qobject_types.QObjectData, h: ptr cQObjectData): gen_qobject_types.QObjectData =
  T(h: h)
proc dynamicMetaObject*(self: gen_qobject_types.QObjectData, ): QMetaObject =
  QMetaObject(h: fcQObjectData_dynamicMetaObject(self.h))
...
proc create*(T: type gen_qobject_types.QObject, parent: QObject): gen_qobject_types.QObject =
  gen_qobject_types.QObject.init(fcQObject_new2(parent.h))

proc metaObject*(self: gen_qobject_types.QObject, ): QMetaObject =
  QMetaObject(h: fcQObject_metaObject(self.h))
...
proc event*(self: gen_qobject_types.QObject, event: QEvent): bool =
  fcQObject_event(self.h, event.h)

proc eventFilter*(self: gen_qobject_types.QObject, watched: QObject, event: QEvent): bool =
...
proc setObjectName*(self: gen_qobject_types.QObject, name: QAnyStringView): void =
...
proc thread*(self: gen_qobject_types.QObject, ): QThread =
  QThread(h: fcQObject_thread(self.h))

proc moveToThread*(self: gen_qobject_types.QObject, thread: QThread): void =
...
proc children*(self: gen_qobject_types.QObject, ): seq[QObject] =
...
proc setParent*(self: gen_qobject_types.QObject, parent: QObject): void =
  fcQObject_setParent(self.h, parent.h)

proc installEventFilter*(self: gen_qobject_types.QObject, filterObj: QObject): void =
  fcQObject_installEventFilter(self.h, filterObj.h)

proc removeEventFilter*(self: gen_qobject_types.QObject, obj: QObject): void =
  fcQObject_removeEventFilter(self.h, obj.h)

proc connect*(_: type gen_qobject_types.QObject, sender: QObject, signal: QMetaMethod, receiver: QObject, methodVal: QMetaMethod): QMetaObjectConnection =
  QMetaObjectConnection(h: fcQObject_connect(sender.h, signal.h, receiver.h, methodVal.h))

proc connect*(self: gen_qobject_types.QObject, sender: QObject, signal: cstring, member: cstring): QMetaObjectConnection =
  QMetaObjectConnection(h: fcQObject_connect2(self.h, sender.h, signal, member))

proc disconnect*(_: type gen_qobject_types.QObject, sender: QObject, signal: QMetaMethod, receiver: QObject, member: QMetaMethod): bool =
  fcQObject_disconnect(sender.h, signal.h, receiver.h, member.h)

proc disconnect*(_: type gen_qobject_types.QObject, param1: QMetaObjectConnection): bool =
...
proc setProperty*(self: gen_qobject_types.QObject, name: cstring, value: QVariant): bool =
  fcQObject_setProperty(self.h, name, value.h)

proc property*(self: gen_qobject_types.QObject, name: cstring): QVariant =
  QVariant(h: fcQObject_property(self.h, name))
...
proc bindingStorage*(self: gen_qobject_types.QObject, ): QBindingStorage =
  QBindingStorage(h: fcQObject_bindingStorage(self.h))

proc bindingStorage2*(self: gen_qobject_types.QObject, ): QBindingStorage =
  QBindingStorage(h: fcQObject_bindingStorage2(self.h))
...
proc parent*(self: gen_qobject_types.QObject, ): QObject =
...
proc connect*(_: type gen_qobject_types.QObject, sender: QObject, signal: QMetaMethod, receiver: QObject, methodVal: QMetaMethod, typeVal: cint): QMetaObjectConnection =
  QMetaObjectConnection(h: fcQObject_connect5(sender.h, signal.h, receiver.h, methodVal.h, cint(typeVal)))

proc connect*(self: gen_qobject_types.QObject, sender: QObject, signal: cstring, member: cstring, typeVal: cint): QMetaObjectConnection =
  QMetaObjectConnection(h: fcQObject_connect4(self.h, sender.h, signal, member, cint(typeVal)))

proc destroyed*(self: gen_qobject_types.QObject, param1: QObject): void =
  fcQObject_destroyed1(self.h, param1.h)

type QObjectdestroyed1Slot* = proc(param1: QObject)
...
proc miqt_exec_callback_QObject_metacall(self: ptr cQObject, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QObject_metacall ".} =
  ...
  virtualReturn
proc QObjectevent*(self: gen_qobject_types.QObject, event: QEvent): bool =
  fQObject_virtualbase_event(self.h, event.h)

type QObjecteventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QObject_event(self: ptr cQObject, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QObject_event ".} =
  ...
  virtualReturn
proc QObjecteventFilter*(self: gen_qobject_types.QObject, watched: QObject, event: QEvent): bool =
  fQObject_virtualbase_eventFilter(self.h, watched.h, event.h)

type QObjecteventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QObject_eventFilter(self: ptr cQObject, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QObject_eventFilter ".} =
  ...
  virtualReturn
proc QObjecttimerEvent*(self: gen_qobject_types.QObject, event: QTimerEvent): void =
  fQObject_virtualbase_timerEvent(self.h, event.h)

type QObjecttimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QObject_timerEvent(self: ptr cQObject, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QObject_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QObjectchildEvent*(self: gen_qobject_types.QObject, event: QChildEvent): void =
  fQObject_virtualbase_childEvent(self.h, event.h)

type QObjectchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QObject_childEvent(self: ptr cQObject, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QObject_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QObjectcustomEvent*(self: gen_qobject_types.QObject, event: QEvent): void =
  fQObject_virtualbase_customEvent(self.h, event.h)

type QObjectcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QObject_customEvent(self: ptr cQObject, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QObject_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QObjectconnectNotify*(self: gen_qobject_types.QObject, signal: QMetaMethod): void =
  fQObject_virtualbase_connectNotify(self.h, signal.h)

type QObjectconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QObject_connectNotify(self: ptr cQObject, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QObject_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QObjectdisconnectNotify*(self: gen_qobject_types.QObject, signal: QMetaMethod): void =
  fQObject_virtualbase_disconnectNotify(self.h, signal.h)

type QObjectdisconnectNotifyProc* = proc(signal: QMetaMethod): void
...
func init*(T: type gen_qobject_types.QSignalBlocker, h: ptr cQSignalBlocker): gen_qobject_types.QSignalBlocker =
  T(h: h)
proc create*(T: type gen_qobject_types.QSignalBlocker, o: QObject): gen_qobject_types.QSignalBlocker =
  gen_qobject_types.QSignalBlocker.init(fcQSignalBlocker_new(o.h))

proc create2*(T: type gen_qobject_types.QSignalBlocker, o: QObject): gen_qobject_types.QSignalBlocker =
