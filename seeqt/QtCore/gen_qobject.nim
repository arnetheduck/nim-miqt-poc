...
proc setUserData*(self: gen_qobject_types.QObject, id: cuint, data: QObjectUserData): void =
  fcQObject_setUserData(self.h, id, data.h)

proc userData*(self: gen_qobject_types.QObject, id: cuint): QObjectUserData =
