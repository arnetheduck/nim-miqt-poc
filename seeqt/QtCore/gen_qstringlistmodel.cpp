...
QMetaObject* QStringListModel_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQStringListModel*)(self) )->QStringListModel::metaObject();

}

void* QStringListModel_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQStringListModel*)(self) )->QStringListModel::qt_metacast(param1);

}

int QStringListModel_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQStringListModel*)(self) )->QStringListModel::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
QModelIndex* QStringListModel_protectedbase_createIndex(const void* self, int row, int column) {
	MiqtVirtualQStringListModel* self_cast = static_cast<MiqtVirtualQStringListModel*>( (QStringListModel*)(self) );
