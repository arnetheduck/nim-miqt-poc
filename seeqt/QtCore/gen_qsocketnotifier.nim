...
proc create*(T: type gen_qsocketnotifier_types.QSocketNotifier, param1: cint, parent: QObject): gen_qsocketnotifier_types.QSocketNotifier =
  gen_qsocketnotifier_types.QSocketNotifier.init(fcQSocketNotifier_new3(cint(param1), parent.h))

proc create*(T: type gen_qsocketnotifier_types.QSocketNotifier, socket: uint, param2: cint, parent: QObject): gen_qsocketnotifier_types.QSocketNotifier =
  gen_qsocketnotifier_types.QSocketNotifier.init(fcQSocketNotifier_new4(socket, cint(param2), parent.h))

proc metaObject*(self: gen_qsocketnotifier_types.QSocketNotifier, ): QMetaObject =
  QMetaObject(h: fcQSocketNotifier_metaObject(self.h))
...
proc miqt_exec_callback_QSocketNotifier_metacall(self: ptr cQSocketNotifier, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QSocketNotifier_metacall ".} =
  ...
  virtualReturn
proc QSocketNotifierevent*(self: gen_qsocketnotifier_types.QSocketNotifier, param1: QEvent): bool =
  fQSocketNotifier_virtualbase_event(self.h, param1.h)

type QSocketNotifiereventProc* = proc(param1: QEvent): bool
...
proc miqt_exec_callback_QSocketNotifier_event(self: ptr cQSocketNotifier, slot: int, param1: pointer): bool {.exportc: "miqt_exec_callback_QSocketNotifier_event ".} =
  ...
  virtualReturn
proc QSocketNotifiereventFilter*(self: gen_qsocketnotifier_types.QSocketNotifier, watched: QObject, event: QEvent): bool =
  fQSocketNotifier_virtualbase_eventFilter(self.h, watched.h, event.h)

type QSocketNotifiereventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QSocketNotifier_eventFilter(self: ptr cQSocketNotifier, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QSocketNotifier_eventFilter ".} =
  ...
  virtualReturn
proc QSocketNotifiertimerEvent*(self: gen_qsocketnotifier_types.QSocketNotifier, event: QTimerEvent): void =
  fQSocketNotifier_virtualbase_timerEvent(self.h, event.h)

type QSocketNotifiertimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QSocketNotifier_timerEvent(self: ptr cQSocketNotifier, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QSocketNotifier_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QSocketNotifierchildEvent*(self: gen_qsocketnotifier_types.QSocketNotifier, event: QChildEvent): void =
  fQSocketNotifier_virtualbase_childEvent(self.h, event.h)

type QSocketNotifierchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QSocketNotifier_childEvent(self: ptr cQSocketNotifier, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QSocketNotifier_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QSocketNotifiercustomEvent*(self: gen_qsocketnotifier_types.QSocketNotifier, event: QEvent): void =
  fQSocketNotifier_virtualbase_customEvent(self.h, event.h)

type QSocketNotifiercustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QSocketNotifier_customEvent(self: ptr cQSocketNotifier, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QSocketNotifier_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QSocketNotifierconnectNotify*(self: gen_qsocketnotifier_types.QSocketNotifier, signal: QMetaMethod): void =
  fQSocketNotifier_virtualbase_connectNotify(self.h, signal.h)

type QSocketNotifierconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QSocketNotifier_connectNotify(self: ptr cQSocketNotifier, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QSocketNotifier_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QSocketNotifierdisconnectNotify*(self: gen_qsocketnotifier_types.QSocketNotifier, signal: QMetaMethod): void =
  fQSocketNotifier_virtualbase_disconnectNotify(self.h, signal.h)

type QSocketNotifierdisconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc create*(T: type gen_qsocketnotifier_types.QSocketDescriptor, param1: QSocketDescriptor): gen_qsocketnotifier_types.QSocketDescriptor =
