...
proc create*(T: type gen_qrandom_types.QRandomGenerator, other: QRandomGenerator): gen_qrandom_types.QRandomGenerator =
...
proc operatorAssign*(self: gen_qrandom_types.QRandomGenerator, other: QRandomGenerator): void =
...
proc system*(_: type gen_qrandom_types.QRandomGenerator, ): QRandomGenerator =
  QRandomGenerator(h: fcQRandomGenerator_system())

proc global*(_: type gen_qrandom_types.QRandomGenerator, ): QRandomGenerator =
  QRandomGenerator(h: fcQRandomGenerator_global())

proc securelySeeded*(_: type gen_qrandom_types.QRandomGenerator, ): QRandomGenerator =
...
proc create*(T: type gen_qrandom_types.QRandomGenerator64, other: QRandomGenerator): gen_qrandom_types.QRandomGenerator64 =
  gen_qrandom_types.QRandomGenerator64.init(fcQRandomGenerator64_new4(other.h))

proc create*(T: type gen_qrandom_types.QRandomGenerator64, param1: QRandomGenerator64): gen_qrandom_types.QRandomGenerator64 =
...
proc system*(_: type gen_qrandom_types.QRandomGenerator64, ): QRandomGenerator64 =
  QRandomGenerator64(h: fcQRandomGenerator64_system())

proc global*(_: type gen_qrandom_types.QRandomGenerator64, ): QRandomGenerator64 =
  QRandomGenerator64(h: fcQRandomGenerator64_global())

proc securelySeeded*(_: type gen_qrandom_types.QRandomGenerator64, ): QRandomGenerator64 =
  QRandomGenerator64(h: fcQRandomGenerator64_securelySeeded())

proc operatorAssign*(self: gen_qrandom_types.QRandomGenerator64, param1: QRandomGenerator64): void =
