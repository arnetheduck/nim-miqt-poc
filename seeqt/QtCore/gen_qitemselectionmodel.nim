...
proc create*(T: type gen_qitemselectionmodel_types.QItemSelectionRange, other: QItemSelectionRange): gen_qitemselectionmodel_types.QItemSelectionRange =
  gen_qitemselectionmodel_types.QItemSelectionRange.init(fcQItemSelectionRange_new2(other.h))

proc create*(T: type gen_qitemselectionmodel_types.QItemSelectionRange, topL: QModelIndex, bottomR: QModelIndex): gen_qitemselectionmodel_types.QItemSelectionRange =
  gen_qitemselectionmodel_types.QItemSelectionRange.init(fcQItemSelectionRange_new3(topL.h, bottomR.h))

proc create*(T: type gen_qitemselectionmodel_types.QItemSelectionRange, index: QModelIndex): gen_qitemselectionmodel_types.QItemSelectionRange =
  gen_qitemselectionmodel_types.QItemSelectionRange.init(fcQItemSelectionRange_new4(index.h))

proc operatorAssign*(self: gen_qitemselectionmodel_types.QItemSelectionRange, other: QItemSelectionRange): void =
  fcQItemSelectionRange_operatorAssign(self.h, other.h)

proc swap*(self: gen_qitemselectionmodel_types.QItemSelectionRange, other: QItemSelectionRange): void =
...
proc topLeft*(self: gen_qitemselectionmodel_types.QItemSelectionRange, ): QPersistentModelIndex =
  QPersistentModelIndex(h: fcQItemSelectionRange_topLeft(self.h))

proc bottomRight*(self: gen_qitemselectionmodel_types.QItemSelectionRange, ): QPersistentModelIndex =
  QPersistentModelIndex(h: fcQItemSelectionRange_bottomRight(self.h))

proc parent*(self: gen_qitemselectionmodel_types.QItemSelectionRange, ): QModelIndex =
  QModelIndex(h: fcQItemSelectionRange_parent(self.h))

proc model*(self: gen_qitemselectionmodel_types.QItemSelectionRange, ): QAbstractItemModel =
  QAbstractItemModel(h: fcQItemSelectionRange_model(self.h))

proc contains*(self: gen_qitemselectionmodel_types.QItemSelectionRange, index: QModelIndex): bool =
  fcQItemSelectionRange_contains(self.h, index.h)

proc contains*(self: gen_qitemselectionmodel_types.QItemSelectionRange, row: cint, column: cint, parentIndex: QModelIndex): bool =
  fcQItemSelectionRange_contains2(self.h, row, column, parentIndex.h)

proc intersects*(self: gen_qitemselectionmodel_types.QItemSelectionRange, other: QItemSelectionRange): bool =
  fcQItemSelectionRange_intersects(self.h, other.h)

proc intersected*(self: gen_qitemselectionmodel_types.QItemSelectionRange, other: QItemSelectionRange): QItemSelectionRange =
  QItemSelectionRange(h: fcQItemSelectionRange_intersected(self.h, other.h))

proc operatorEqual*(self: gen_qitemselectionmodel_types.QItemSelectionRange, other: QItemSelectionRange): bool =
  fcQItemSelectionRange_operatorEqual(self.h, other.h)

proc operatorNotEqual*(self: gen_qitemselectionmodel_types.QItemSelectionRange, other: QItemSelectionRange): bool =
  fcQItemSelectionRange_operatorNotEqual(self.h, other.h)

proc operatorLesser*(self: gen_qitemselectionmodel_types.QItemSelectionRange, other: QItemSelectionRange): bool =
...
proc indexes*(self: gen_qitemselectionmodel_types.QItemSelectionRange, ): seq[QModelIndex] =
...
proc create*(T: type gen_qitemselectionmodel_types.QItemSelectionModel, model: QAbstractItemModel, parent: QObject): gen_qitemselectionmodel_types.QItemSelectionModel =
  gen_qitemselectionmodel_types.QItemSelectionModel.init(fcQItemSelectionModel_new2(model.h, parent.h))

proc create*(T: type gen_qitemselectionmodel_types.QItemSelectionModel, model: QAbstractItemModel): gen_qitemselectionmodel_types.QItemSelectionModel =
  gen_qitemselectionmodel_types.QItemSelectionModel.init(fcQItemSelectionModel_new3(model.h))

proc metaObject*(self: gen_qitemselectionmodel_types.QItemSelectionModel, ): QMetaObject =
  QMetaObject(h: fcQItemSelectionModel_metaObject(self.h))
...
proc currentIndex*(self: gen_qitemselectionmodel_types.QItemSelectionModel, ): QModelIndex =
  QModelIndex(h: fcQItemSelectionModel_currentIndex(self.h))

proc isSelected*(self: gen_qitemselectionmodel_types.QItemSelectionModel, index: QModelIndex): bool =
...
proc selectedIndexes*(self: gen_qitemselectionmodel_types.QItemSelectionModel, ): seq[QModelIndex] =
...
proc selectedRows*(self: gen_qitemselectionmodel_types.QItemSelectionModel, ): seq[QModelIndex] =
...
proc selectedColumns*(self: gen_qitemselectionmodel_types.QItemSelectionModel, ): seq[QModelIndex] =
...
proc selection*(self: gen_qitemselectionmodel_types.QItemSelectionModel, ): QItemSelection =
  QItemSelection(h: fcQItemSelectionModel_selection(self.h))

proc model*(self: gen_qitemselectionmodel_types.QItemSelectionModel, ): QAbstractItemModel =
  QAbstractItemModel(h: fcQItemSelectionModel_model(self.h))

proc model2*(self: gen_qitemselectionmodel_types.QItemSelectionModel, ): QAbstractItemModel =
  QAbstractItemModel(h: fcQItemSelectionModel_model2(self.h))

proc setModel*(self: gen_qitemselectionmodel_types.QItemSelectionModel, model: QAbstractItemModel): void =
  fcQItemSelectionModel_setModel(self.h, model.h)

proc setCurrentIndex*(self: gen_qitemselectionmodel_types.QItemSelectionModel, index: QModelIndex, command: cint): void =
  fcQItemSelectionModel_setCurrentIndex(self.h, index.h, cint(command))

proc select*(self: gen_qitemselectionmodel_types.QItemSelectionModel, index: QModelIndex, command: cint): void =
  fcQItemSelectionModel_select(self.h, index.h, cint(command))

proc select*(self: gen_qitemselectionmodel_types.QItemSelectionModel, selection: QItemSelection, command: cint): void =
...
proc selectionChanged*(self: gen_qitemselectionmodel_types.QItemSelectionModel, selected: QItemSelection, deselected: QItemSelection): void =
  fcQItemSelectionModel_selectionChanged(self.h, selected.h, deselected.h)

type QItemSelectionModelselectionChangedSlot* = proc(selected: QItemSelection, deselected: QItemSelection)
...
proc currentChanged*(self: gen_qitemselectionmodel_types.QItemSelectionModel, current: QModelIndex, previous: QModelIndex): void =
  fcQItemSelectionModel_currentChanged(self.h, current.h, previous.h)

type QItemSelectionModelcurrentChangedSlot* = proc(current: QModelIndex, previous: QModelIndex)
...
proc currentRowChanged*(self: gen_qitemselectionmodel_types.QItemSelectionModel, current: QModelIndex, previous: QModelIndex): void =
  fcQItemSelectionModel_currentRowChanged(self.h, current.h, previous.h)

type QItemSelectionModelcurrentRowChangedSlot* = proc(current: QModelIndex, previous: QModelIndex)
...
proc currentColumnChanged*(self: gen_qitemselectionmodel_types.QItemSelectionModel, current: QModelIndex, previous: QModelIndex): void =
  fcQItemSelectionModel_currentColumnChanged(self.h, current.h, previous.h)

type QItemSelectionModelcurrentColumnChangedSlot* = proc(current: QModelIndex, previous: QModelIndex)
...
proc modelChanged*(self: gen_qitemselectionmodel_types.QItemSelectionModel, model: QAbstractItemModel): void =
  fcQItemSelectionModel_modelChanged(self.h, model.h)

type QItemSelectionModelmodelChangedSlot* = proc(model: QAbstractItemModel)
...
proc isRowSelected*(self: gen_qitemselectionmodel_types.QItemSelectionModel, row: cint, parent: QModelIndex): bool =
  fcQItemSelectionModel_isRowSelected2(self.h, row, parent.h)

proc isColumnSelected*(self: gen_qitemselectionmodel_types.QItemSelectionModel, column: cint, parent: QModelIndex): bool =
  fcQItemSelectionModel_isColumnSelected2(self.h, column, parent.h)

proc rowIntersectsSelection*(self: gen_qitemselectionmodel_types.QItemSelectionModel, row: cint, parent: QModelIndex): bool =
  fcQItemSelectionModel_rowIntersectsSelection2(self.h, row, parent.h)

proc columnIntersectsSelection*(self: gen_qitemselectionmodel_types.QItemSelectionModel, column: cint, parent: QModelIndex): bool =
  fcQItemSelectionModel_columnIntersectsSelection2(self.h, column, parent.h)

proc selectedRows*(self: gen_qitemselectionmodel_types.QItemSelectionModel, column: cint): seq[QModelIndex] =
...
proc selectedColumns*(self: gen_qitemselectionmodel_types.QItemSelectionModel, row: cint): seq[QModelIndex] =
...
proc miqt_exec_callback_QItemSelectionModel_metacall(self: ptr cQItemSelectionModel, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QItemSelectionModel_metacall ".} =
  ...
  virtualReturn
proc QItemSelectionModelsetCurrentIndex*(self: gen_qitemselectionmodel_types.QItemSelectionModel, index: QModelIndex, command: cint): void =
  fQItemSelectionModel_virtualbase_setCurrentIndex(self.h, index.h, cint(command))

type QItemSelectionModelsetCurrentIndexProc* = proc(index: QModelIndex, command: cint): void
...
proc miqt_exec_callback_QItemSelectionModel_setCurrentIndex(self: ptr cQItemSelectionModel, slot: int, index: pointer, command: cint): void {.exportc: "miqt_exec_callback_QItemSelectionModel_setCurrentIndex ".} =
  ...
  nimfunc[](slotval1, slotval2)
proc QItemSelectionModelselect*(self: gen_qitemselectionmodel_types.QItemSelectionModel, index: QModelIndex, command: cint): void =
  fQItemSelectionModel_virtualbase_select(self.h, index.h, cint(command))

type QItemSelectionModelselectProc* = proc(index: QModelIndex, command: cint): void
...
proc miqt_exec_callback_QItemSelectionModel_select(self: ptr cQItemSelectionModel, slot: int, index: pointer, command: cint): void {.exportc: "miqt_exec_callback_QItemSelectionModel_select ".} =
  ...
  nimfunc[](slotval1, slotval2)
proc QItemSelectionModelselect*(self: gen_qitemselectionmodel_types.QItemSelectionModel, selection: QItemSelection, command: cint): void =
  fQItemSelectionModel_virtualbase_select2(self.h, selection.h, cint(command))

type QItemSelectionModelselect2Proc* = proc(selection: QItemSelection, command: cint): void
...
proc miqt_exec_callback_QItemSelectionModel_clearCurrentIndex(self: ptr cQItemSelectionModel, slot: int): void {.exportc: "miqt_exec_callback_QItemSelectionModel_clearCurrentIndex ".} =
  ...
  nimfunc[]()
proc QItemSelectionModelevent*(self: gen_qitemselectionmodel_types.QItemSelectionModel, event: QEvent): bool =
  fQItemSelectionModel_virtualbase_event(self.h, event.h)

type QItemSelectionModeleventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QItemSelectionModel_event(self: ptr cQItemSelectionModel, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QItemSelectionModel_event ".} =
  ...
  virtualReturn
proc QItemSelectionModeleventFilter*(self: gen_qitemselectionmodel_types.QItemSelectionModel, watched: QObject, event: QEvent): bool =
  fQItemSelectionModel_virtualbase_eventFilter(self.h, watched.h, event.h)

type QItemSelectionModeleventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QItemSelectionModel_eventFilter(self: ptr cQItemSelectionModel, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QItemSelectionModel_eventFilter ".} =
  ...
  virtualReturn
proc QItemSelectionModeltimerEvent*(self: gen_qitemselectionmodel_types.QItemSelectionModel, event: QTimerEvent): void =
  fQItemSelectionModel_virtualbase_timerEvent(self.h, event.h)

type QItemSelectionModeltimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QItemSelectionModel_timerEvent(self: ptr cQItemSelectionModel, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QItemSelectionModel_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QItemSelectionModelchildEvent*(self: gen_qitemselectionmodel_types.QItemSelectionModel, event: QChildEvent): void =
  fQItemSelectionModel_virtualbase_childEvent(self.h, event.h)

type QItemSelectionModelchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QItemSelectionModel_childEvent(self: ptr cQItemSelectionModel, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QItemSelectionModel_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QItemSelectionModelcustomEvent*(self: gen_qitemselectionmodel_types.QItemSelectionModel, event: QEvent): void =
  fQItemSelectionModel_virtualbase_customEvent(self.h, event.h)

type QItemSelectionModelcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QItemSelectionModel_customEvent(self: ptr cQItemSelectionModel, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QItemSelectionModel_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QItemSelectionModelconnectNotify*(self: gen_qitemselectionmodel_types.QItemSelectionModel, signal: QMetaMethod): void =
  fQItemSelectionModel_virtualbase_connectNotify(self.h, signal.h)

type QItemSelectionModelconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QItemSelectionModel_connectNotify(self: ptr cQItemSelectionModel, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QItemSelectionModel_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QItemSelectionModeldisconnectNotify*(self: gen_qitemselectionmodel_types.QItemSelectionModel, signal: QMetaMethod): void =
  fQItemSelectionModel_virtualbase_disconnectNotify(self.h, signal.h)

type QItemSelectionModeldisconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc create*(T: type gen_qitemselectionmodel_types.QItemSelection, topLeft: QModelIndex, bottomRight: QModelIndex): gen_qitemselectionmodel_types.QItemSelection =
  gen_qitemselectionmodel_types.QItemSelection.init(fcQItemSelection_new2(topLeft.h, bottomRight.h))

proc select*(self: gen_qitemselectionmodel_types.QItemSelection, topLeft: QModelIndex, bottomRight: QModelIndex): void =
  fcQItemSelection_select(self.h, topLeft.h, bottomRight.h)

proc contains*(self: gen_qitemselectionmodel_types.QItemSelection, index: QModelIndex): bool =
  fcQItemSelection_contains(self.h, index.h)

proc indexes*(self: gen_qitemselectionmodel_types.QItemSelection, ): seq[QModelIndex] =
...
proc merge*(self: gen_qitemselectionmodel_types.QItemSelection, other: QItemSelection, command: cint): void =
  fcQItemSelection_merge(self.h, other.h, cint(command))

proc split*(_: type gen_qitemselectionmodel_types.QItemSelection, range: QItemSelectionRange, other: QItemSelectionRange, resultVal: QItemSelection): void =
  fcQItemSelection_split(range.h, other.h, resultVal.h)

proc operatorAssign*(self: gen_qitemselectionmodel_types.QItemSelection, param1: QItemSelection): void =
