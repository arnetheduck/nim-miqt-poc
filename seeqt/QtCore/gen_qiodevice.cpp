...
public:
	...
	MiqtVirtualQIODevice(struct QIODevice_VTable* vtbl): QIODevice(), vtbl(vtbl) {};
	MiqtVirtualQIODevice(struct QIODevice_VTable* vtbl, QObject* parent): QIODevice(parent), vtbl(vtbl) {};

	virtual ~MiqtVirtualQIODevice() override { if(vtbl->destructor) vtbl->destructor(vtbl, this); }
...
QIODevice* QIODevice_new(struct QIODevice_VTable* vtbl) {
	return new MiqtVirtualQIODevice(vtbl);
}

QIODevice* QIODevice_new2(struct QIODevice_VTable* vtbl, QObject* parent) {
	return new MiqtVirtualQIODevice(vtbl, parent);
}
...
QMetaObject* QIODevice_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQIODevice*)(self) )->QIODevice::metaObject();

}

void* QIODevice_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQIODevice*)(self) )->QIODevice::qt_metacast(param1);

}

int QIODevice_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQIODevice*)(self) )->QIODevice::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
long long QIODevice_virtualbase_skipData(void* self, long long maxSize) {
	...
	qint64 _ret = ( (MiqtVirtualQIODevice*)(self) )->QIODevice::skipData(static_cast<qint64>(maxSize));
	return static_cast<long long>(_ret);
...
void QIODevice_protectedbase_setOpenMode(void* self, int openMode) {
	MiqtVirtualQIODevice* self_cast = static_cast<MiqtVirtualQIODevice*>( (QIODevice*)(self) );
