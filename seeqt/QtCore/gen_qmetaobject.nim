...
proc returnMetaType*(self: gen_qmetaobject_types.QMetaMethod, ): QMetaType =
  QMetaType(h: fcQMetaMethod_returnMetaType(self.h))
...
proc parameterMetaType*(self: gen_qmetaobject_types.QMetaMethod, index: cint): QMetaType =
  QMetaType(h: fcQMetaMethod_parameterMetaType(self.h, index))
...
proc metaType*(self: gen_qmetaobject_types.QMetaProperty, ): QMetaType =
  QMetaType(h: fcQMetaProperty_metaType(self.h))
...
proc bindable*(self: gen_qmetaobject_types.QMetaProperty, objectVal: QObject): QUntypedBindable =
  QUntypedBindable(h: fcQMetaProperty_bindable(self.h, objectVal.h))
