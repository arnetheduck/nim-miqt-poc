...
proc create*(T: type gen_qproperty_types.QPropertyBindingSourceLocation, param1: QPropertyBindingSourceLocation): gen_qproperty_types.QPropertyBindingSourceLocation =
...
proc create*(T: type gen_qproperty_types.QPropertyBindingError, other: QPropertyBindingError): gen_qproperty_types.QPropertyBindingError =
...
proc operatorAssign*(self: gen_qproperty_types.QPropertyBindingError, other: QPropertyBindingError): void =
...
proc create*(T: type gen_qproperty_types.QUntypedPropertyBinding, other: QUntypedPropertyBinding): gen_qproperty_types.QUntypedPropertyBinding =
  gen_qproperty_types.QUntypedPropertyBinding.init(fcQUntypedPropertyBinding_new2(other.h))

proc operatorAssign*(self: gen_qproperty_types.QUntypedPropertyBinding, other: QUntypedPropertyBinding): void =
...
proc error*(self: gen_qproperty_types.QUntypedPropertyBinding, ): QPropertyBindingError =
  QPropertyBindingError(h: fcQUntypedPropertyBinding_error(self.h))

proc valueMetaType*(self: gen_qproperty_types.QUntypedPropertyBinding, ): QMetaType =
  QMetaType(h: fcQUntypedPropertyBinding_valueMetaType(self.h))
...
proc create*(T: type gen_qproperty_types.QPropertyObserverBase, param1: QPropertyObserverBase): gen_qproperty_types.QPropertyObserverBase =
...
proc create*(T: type gen_qproperty_types.QUntypedBindable, param1: QUntypedBindable): gen_qproperty_types.QUntypedBindable =
...
proc makeBinding*(self: gen_qproperty_types.QUntypedBindable, ): QUntypedPropertyBinding =
  QUntypedPropertyBinding(h: fcQUntypedBindable_makeBinding(self.h))

proc takeBinding*(self: gen_qproperty_types.QUntypedBindable, ): QUntypedPropertyBinding =
  QUntypedPropertyBinding(h: fcQUntypedBindable_takeBinding(self.h))

proc observe*(self: gen_qproperty_types.QUntypedBindable, observer: QPropertyObserver): void =
  fcQUntypedBindable_observe(self.h, observer.h)

proc binding*(self: gen_qproperty_types.QUntypedBindable, ): QUntypedPropertyBinding =
  QUntypedPropertyBinding(h: fcQUntypedBindable_binding(self.h))

proc setBinding*(self: gen_qproperty_types.QUntypedBindable, binding: QUntypedPropertyBinding): bool =
...
proc metaType*(self: gen_qproperty_types.QUntypedBindable, ): QMetaType =
  QMetaType(h: fcQUntypedBindable_metaType(self.h))

proc makeBinding*(self: gen_qproperty_types.QUntypedBindable, location: QPropertyBindingSourceLocation): QUntypedPropertyBinding =
