...
proc create*(T: type gen_qcommandlineoption_types.QCommandLineOption, other: QCommandLineOption): gen_qcommandlineoption_types.QCommandLineOption =
...
proc operatorAssign*(self: gen_qcommandlineoption_types.QCommandLineOption, other: QCommandLineOption): void =
  fcQCommandLineOption_operatorAssign(self.h, other.h)

proc swap*(self: gen_qcommandlineoption_types.QCommandLineOption, other: QCommandLineOption): void =
