...
proc create*(T: type gen_qidentityproxymodel_types.QIdentityProxyModel, parent: QObject): gen_qidentityproxymodel_types.QIdentityProxyModel =
  gen_qidentityproxymodel_types.QIdentityProxyModel.init(fcQIdentityProxyModel_new2(parent.h))

proc metaObject*(self: gen_qidentityproxymodel_types.QIdentityProxyModel, ): QMetaObject =
  QMetaObject(h: fcQIdentityProxyModel_metaObject(self.h))
...
proc columnCount*(self: gen_qidentityproxymodel_types.QIdentityProxyModel, parent: QModelIndex): cint =
  fcQIdentityProxyModel_columnCount(self.h, parent.h)

proc index*(self: gen_qidentityproxymodel_types.QIdentityProxyModel, row: cint, column: cint, parent: QModelIndex): QModelIndex =
  QModelIndex(h: fcQIdentityProxyModel_index(self.h, row, column, parent.h))

proc mapFromSource*(self: gen_qidentityproxymodel_types.QIdentityProxyModel, sourceIndex: QModelIndex): QModelIndex =
  QModelIndex(h: fcQIdentityProxyModel_mapFromSource(self.h, sourceIndex.h))

proc mapToSource*(self: gen_qidentityproxymodel_types.QIdentityProxyModel, proxyIndex: QModelIndex): QModelIndex =
  QModelIndex(h: fcQIdentityProxyModel_mapToSource(self.h, proxyIndex.h))

proc parent*(self: gen_qidentityproxymodel_types.QIdentityProxyModel, child: QModelIndex): QModelIndex =
  QModelIndex(h: fcQIdentityProxyModel_parent(self.h, child.h))

proc rowCount*(self: gen_qidentityproxymodel_types.QIdentityProxyModel, parent: QModelIndex): cint =
  fcQIdentityProxyModel_rowCount(self.h, parent.h)

proc headerData*(self: gen_qidentityproxymodel_types.QIdentityProxyModel, section: cint, orientation: cint, role: cint): QVariant =
  QVariant(h: fcQIdentityProxyModel_headerData(self.h, section, cint(orientation), role))

proc dropMimeData*(self: gen_qidentityproxymodel_types.QIdentityProxyModel, data: QMimeData, action: cint, row: cint, column: cint, parent: QModelIndex): bool =
  fcQIdentityProxyModel_dropMimeData(self.h, data.h, cint(action), row, column, parent.h)

proc sibling*(self: gen_qidentityproxymodel_types.QIdentityProxyModel, row: cint, column: cint, idx: QModelIndex): QModelIndex =
  QModelIndex(h: fcQIdentityProxyModel_sibling(self.h, row, column, idx.h))

proc mapSelectionFromSource*(self: gen_qidentityproxymodel_types.QIdentityProxyModel, selection: QItemSelection): QItemSelection =
  QItemSelection(h: fcQIdentityProxyModel_mapSelectionFromSource(self.h, selection.h))

proc mapSelectionToSource*(self: gen_qidentityproxymodel_types.QIdentityProxyModel, selection: QItemSelection): QItemSelection =
  QItemSelection(h: fcQIdentityProxyModel_mapSelectionToSource(self.h, selection.h))

proc match*(self: gen_qidentityproxymodel_types.QIdentityProxyModel, start: QModelIndex, role: cint, value: QVariant, hits: cint, flags: cint): seq[QModelIndex] =
...
proc setSourceModel*(self: gen_qidentityproxymodel_types.QIdentityProxyModel, sourceModel: QAbstractItemModel): void =
  fcQIdentityProxyModel_setSourceModel(self.h, sourceModel.h)

proc insertColumns*(self: gen_qidentityproxymodel_types.QIdentityProxyModel, column: cint, count: cint, parent: QModelIndex): bool =
  fcQIdentityProxyModel_insertColumns(self.h, column, count, parent.h)

proc insertRows*(self: gen_qidentityproxymodel_types.QIdentityProxyModel, row: cint, count: cint, parent: QModelIndex): bool =
  fcQIdentityProxyModel_insertRows(self.h, row, count, parent.h)

proc removeColumns*(self: gen_qidentityproxymodel_types.QIdentityProxyModel, column: cint, count: cint, parent: QModelIndex): bool =
  fcQIdentityProxyModel_removeColumns(self.h, column, count, parent.h)

proc removeRows*(self: gen_qidentityproxymodel_types.QIdentityProxyModel, row: cint, count: cint, parent: QModelIndex): bool =
  fcQIdentityProxyModel_removeRows(self.h, row, count, parent.h)

proc moveRows*(self: gen_qidentityproxymodel_types.QIdentityProxyModel, sourceParent: QModelIndex, sourceRow: cint, count: cint, destinationParent: QModelIndex, destinationChild: cint): bool =
  fcQIdentityProxyModel_moveRows(self.h, sourceParent.h, sourceRow, count, destinationParent.h, destinationChild)

proc moveColumns*(self: gen_qidentityproxymodel_types.QIdentityProxyModel, sourceParent: QModelIndex, sourceColumn: cint, count: cint, destinationParent: QModelIndex, destinationChild: cint): bool =
...
proc miqt_exec_callback_QIdentityProxyModel_metacall(self: ptr cQIdentityProxyModel, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QIdentityProxyModel_metacall ".} =
  ...
  virtualReturn
proc QIdentityProxyModelcolumnCount*(self: gen_qidentityproxymodel_types.QIdentityProxyModel, parent: QModelIndex): cint =
  fQIdentityProxyModel_virtualbase_columnCount(self.h, parent.h)

type QIdentityProxyModelcolumnCountProc* = proc(parent: QModelIndex): cint
...
proc miqt_exec_callback_QIdentityProxyModel_columnCount(self: ptr cQIdentityProxyModel, slot: int, parent: pointer): cint {.exportc: "miqt_exec_callback_QIdentityProxyModel_columnCount ".} =
  ...
  virtualReturn
proc QIdentityProxyModelindex*(self: gen_qidentityproxymodel_types.QIdentityProxyModel, row: cint, column: cint, parent: QModelIndex): QModelIndex =
  QModelIndex(h: fQIdentityProxyModel_virtualbase_index(self.h, row, column, parent.h))

type QIdentityProxyModelindexProc* = proc(row: cint, column: cint, parent: QModelIndex): QModelIndex
...
proc miqt_exec_callback_QIdentityProxyModel_index(self: ptr cQIdentityProxyModel, slot: int, row: cint, column: cint, parent: pointer): pointer {.exportc: "miqt_exec_callback_QIdentityProxyModel_index ".} =
  ...
  virtualReturn.h
proc QIdentityProxyModelmapFromSource*(self: gen_qidentityproxymodel_types.QIdentityProxyModel, sourceIndex: QModelIndex): QModelIndex =
  QModelIndex(h: fQIdentityProxyModel_virtualbase_mapFromSource(self.h, sourceIndex.h))

type QIdentityProxyModelmapFromSourceProc* = proc(sourceIndex: QModelIndex): QModelIndex
...
proc miqt_exec_callback_QIdentityProxyModel_mapFromSource(self: ptr cQIdentityProxyModel, slot: int, sourceIndex: pointer): pointer {.exportc: "miqt_exec_callback_QIdentityProxyModel_mapFromSource ".} =
  ...
  virtualReturn.h
proc QIdentityProxyModelmapToSource*(self: gen_qidentityproxymodel_types.QIdentityProxyModel, proxyIndex: QModelIndex): QModelIndex =
  QModelIndex(h: fQIdentityProxyModel_virtualbase_mapToSource(self.h, proxyIndex.h))

type QIdentityProxyModelmapToSourceProc* = proc(proxyIndex: QModelIndex): QModelIndex
...
proc miqt_exec_callback_QIdentityProxyModel_mapToSource(self: ptr cQIdentityProxyModel, slot: int, proxyIndex: pointer): pointer {.exportc: "miqt_exec_callback_QIdentityProxyModel_mapToSource ".} =
  ...
  virtualReturn.h
proc QIdentityProxyModelparent*(self: gen_qidentityproxymodel_types.QIdentityProxyModel, child: QModelIndex): QModelIndex =
  QModelIndex(h: fQIdentityProxyModel_virtualbase_parent(self.h, child.h))

type QIdentityProxyModelparentProc* = proc(child: QModelIndex): QModelIndex
...
proc miqt_exec_callback_QIdentityProxyModel_parent(self: ptr cQIdentityProxyModel, slot: int, child: pointer): pointer {.exportc: "miqt_exec_callback_QIdentityProxyModel_parent ".} =
  ...
  virtualReturn.h
proc QIdentityProxyModelrowCount*(self: gen_qidentityproxymodel_types.QIdentityProxyModel, parent: QModelIndex): cint =
  fQIdentityProxyModel_virtualbase_rowCount(self.h, parent.h)

type QIdentityProxyModelrowCountProc* = proc(parent: QModelIndex): cint
...
proc miqt_exec_callback_QIdentityProxyModel_rowCount(self: ptr cQIdentityProxyModel, slot: int, parent: pointer): cint {.exportc: "miqt_exec_callback_QIdentityProxyModel_rowCount ".} =
  ...
  virtualReturn
proc QIdentityProxyModelheaderData*(self: gen_qidentityproxymodel_types.QIdentityProxyModel, section: cint, orientation: cint, role: cint): QVariant =
  QVariant(h: fQIdentityProxyModel_virtualbase_headerData(self.h, section, cint(orientation), role))

type QIdentityProxyModelheaderDataProc* = proc(section: cint, orientation: cint, role: cint): QVariant
...
proc miqt_exec_callback_QIdentityProxyModel_headerData(self: ptr cQIdentityProxyModel, slot: int, section: cint, orientation: cint, role: cint): pointer {.exportc: "miqt_exec_callback_QIdentityProxyModel_headerData ".} =
  ...
  virtualReturn.h
proc QIdentityProxyModeldropMimeData*(self: gen_qidentityproxymodel_types.QIdentityProxyModel, data: QMimeData, action: cint, row: cint, column: cint, parent: QModelIndex): bool =
  fQIdentityProxyModel_virtualbase_dropMimeData(self.h, data.h, cint(action), row, column, parent.h)

type QIdentityProxyModeldropMimeDataProc* = proc(data: QMimeData, action: cint, row: cint, column: cint, parent: QModelIndex): bool
...
proc miqt_exec_callback_QIdentityProxyModel_dropMimeData(self: ptr cQIdentityProxyModel, slot: int, data: pointer, action: cint, row: cint, column: cint, parent: pointer): bool {.exportc: "miqt_exec_callback_QIdentityProxyModel_dropMimeData ".} =
  ...
  virtualReturn
proc QIdentityProxyModelsibling*(self: gen_qidentityproxymodel_types.QIdentityProxyModel, row: cint, column: cint, idx: QModelIndex): QModelIndex =
  QModelIndex(h: fQIdentityProxyModel_virtualbase_sibling(self.h, row, column, idx.h))

type QIdentityProxyModelsiblingProc* = proc(row: cint, column: cint, idx: QModelIndex): QModelIndex
...
proc miqt_exec_callback_QIdentityProxyModel_sibling(self: ptr cQIdentityProxyModel, slot: int, row: cint, column: cint, idx: pointer): pointer {.exportc: "miqt_exec_callback_QIdentityProxyModel_sibling ".} =
  ...
  virtualReturn.h
proc QIdentityProxyModelmapSelectionFromSource*(self: gen_qidentityproxymodel_types.QIdentityProxyModel, selection: QItemSelection): QItemSelection =
  QItemSelection(h: fQIdentityProxyModel_virtualbase_mapSelectionFromSource(self.h, selection.h))

type QIdentityProxyModelmapSelectionFromSourceProc* = proc(selection: QItemSelection): QItemSelection
...
proc miqt_exec_callback_QIdentityProxyModel_mapSelectionFromSource(self: ptr cQIdentityProxyModel, slot: int, selection: pointer): pointer {.exportc: "miqt_exec_callback_QIdentityProxyModel_mapSelectionFromSource ".} =
  ...
  virtualReturn.h
proc QIdentityProxyModelmapSelectionToSource*(self: gen_qidentityproxymodel_types.QIdentityProxyModel, selection: QItemSelection): QItemSelection =
  QItemSelection(h: fQIdentityProxyModel_virtualbase_mapSelectionToSource(self.h, selection.h))

type QIdentityProxyModelmapSelectionToSourceProc* = proc(selection: QItemSelection): QItemSelection
...
proc miqt_exec_callback_QIdentityProxyModel_mapSelectionToSource(self: ptr cQIdentityProxyModel, slot: int, selection: pointer): pointer {.exportc: "miqt_exec_callback_QIdentityProxyModel_mapSelectionToSource ".} =
  ...
  virtualReturn.h
proc QIdentityProxyModelmatch*(self: gen_qidentityproxymodel_types.QIdentityProxyModel, start: QModelIndex, role: cint, value: QVariant, hits: cint, flags: cint): seq[QModelIndex] =
...
type QIdentityProxyModelmatchProc* = proc(start: QModelIndex, role: cint, value: QVariant, hits: cint, flags: cint): seq[QModelIndex]
...
proc QIdentityProxyModelsetSourceModel*(self: gen_qidentityproxymodel_types.QIdentityProxyModel, sourceModel: QAbstractItemModel): void =
  fQIdentityProxyModel_virtualbase_setSourceModel(self.h, sourceModel.h)

type QIdentityProxyModelsetSourceModelProc* = proc(sourceModel: QAbstractItemModel): void
...
proc miqt_exec_callback_QIdentityProxyModel_setSourceModel(self: ptr cQIdentityProxyModel, slot: int, sourceModel: pointer): void {.exportc: "miqt_exec_callback_QIdentityProxyModel_setSourceModel ".} =
  ...
  nimfunc[](slotval1)
proc QIdentityProxyModelinsertColumns*(self: gen_qidentityproxymodel_types.QIdentityProxyModel, column: cint, count: cint, parent: QModelIndex): bool =
  fQIdentityProxyModel_virtualbase_insertColumns(self.h, column, count, parent.h)

type QIdentityProxyModelinsertColumnsProc* = proc(column: cint, count: cint, parent: QModelIndex): bool
...
proc miqt_exec_callback_QIdentityProxyModel_insertColumns(self: ptr cQIdentityProxyModel, slot: int, column: cint, count: cint, parent: pointer): bool {.exportc: "miqt_exec_callback_QIdentityProxyModel_insertColumns ".} =
  ...
  virtualReturn
proc QIdentityProxyModelinsertRows*(self: gen_qidentityproxymodel_types.QIdentityProxyModel, row: cint, count: cint, parent: QModelIndex): bool =
  fQIdentityProxyModel_virtualbase_insertRows(self.h, row, count, parent.h)

type QIdentityProxyModelinsertRowsProc* = proc(row: cint, count: cint, parent: QModelIndex): bool
...
proc miqt_exec_callback_QIdentityProxyModel_insertRows(self: ptr cQIdentityProxyModel, slot: int, row: cint, count: cint, parent: pointer): bool {.exportc: "miqt_exec_callback_QIdentityProxyModel_insertRows ".} =
  ...
  virtualReturn
proc QIdentityProxyModelremoveColumns*(self: gen_qidentityproxymodel_types.QIdentityProxyModel, column: cint, count: cint, parent: QModelIndex): bool =
  fQIdentityProxyModel_virtualbase_removeColumns(self.h, column, count, parent.h)

type QIdentityProxyModelremoveColumnsProc* = proc(column: cint, count: cint, parent: QModelIndex): bool
...
proc miqt_exec_callback_QIdentityProxyModel_removeColumns(self: ptr cQIdentityProxyModel, slot: int, column: cint, count: cint, parent: pointer): bool {.exportc: "miqt_exec_callback_QIdentityProxyModel_removeColumns ".} =
  ...
  virtualReturn
proc QIdentityProxyModelremoveRows*(self: gen_qidentityproxymodel_types.QIdentityProxyModel, row: cint, count: cint, parent: QModelIndex): bool =
  fQIdentityProxyModel_virtualbase_removeRows(self.h, row, count, parent.h)

type QIdentityProxyModelremoveRowsProc* = proc(row: cint, count: cint, parent: QModelIndex): bool
...
proc miqt_exec_callback_QIdentityProxyModel_removeRows(self: ptr cQIdentityProxyModel, slot: int, row: cint, count: cint, parent: pointer): bool {.exportc: "miqt_exec_callback_QIdentityProxyModel_removeRows ".} =
  ...
  virtualReturn
proc QIdentityProxyModelmoveRows*(self: gen_qidentityproxymodel_types.QIdentityProxyModel, sourceParent: QModelIndex, sourceRow: cint, count: cint, destinationParent: QModelIndex, destinationChild: cint): bool =
  fQIdentityProxyModel_virtualbase_moveRows(self.h, sourceParent.h, sourceRow, count, destinationParent.h, destinationChild)

type QIdentityProxyModelmoveRowsProc* = proc(sourceParent: QModelIndex, sourceRow: cint, count: cint, destinationParent: QModelIndex, destinationChild: cint): bool
...
proc miqt_exec_callback_QIdentityProxyModel_moveRows(self: ptr cQIdentityProxyModel, slot: int, sourceParent: pointer, sourceRow: cint, count: cint, destinationParent: pointer, destinationChild: cint): bool {.exportc: "miqt_exec_callback_QIdentityProxyModel_moveRows ".} =
  ...
  virtualReturn
proc QIdentityProxyModelmoveColumns*(self: gen_qidentityproxymodel_types.QIdentityProxyModel, sourceParent: QModelIndex, sourceColumn: cint, count: cint, destinationParent: QModelIndex, destinationChild: cint): bool =
...
type QIdentityProxyModelmoveColumnsProc* = proc(sourceParent: QModelIndex, sourceColumn: cint, count: cint, destinationParent: QModelIndex, destinationChild: cint): bool
...
proc miqt_exec_callback_QIdentityProxyModel_revert(self: ptr cQIdentityProxyModel, slot: int): void {.exportc: "miqt_exec_callback_QIdentityProxyModel_revert ".} =
  ...
  nimfunc[]()
proc QIdentityProxyModeldata*(self: gen_qidentityproxymodel_types.QIdentityProxyModel, proxyIndex: QModelIndex, role: cint): QVariant =
  QVariant(h: fQIdentityProxyModel_virtualbase_data(self.h, proxyIndex.h, role))

type QIdentityProxyModeldataProc* = proc(proxyIndex: QModelIndex, role: cint): QVariant
...
proc miqt_exec_callback_QIdentityProxyModel_data(self: ptr cQIdentityProxyModel, slot: int, proxyIndex: pointer, role: cint): pointer {.exportc: "miqt_exec_callback_QIdentityProxyModel_data ".} =
  ...
  virtualReturn.h
proc QIdentityProxyModelitemData*(self: gen_qidentityproxymodel_types.QIdentityProxyModel, index: QModelIndex): Table[cint,QVariant] =
...
type QIdentityProxyModelitemDataProc* = proc(index: QModelIndex): Table[cint,QVariant]
...
proc QIdentityProxyModelflags*(self: gen_qidentityproxymodel_types.QIdentityProxyModel, index: QModelIndex): cint =
  cint(fQIdentityProxyModel_virtualbase_flags(self.h, index.h))

type QIdentityProxyModelflagsProc* = proc(index: QModelIndex): cint
...
proc miqt_exec_callback_QIdentityProxyModel_flags(self: ptr cQIdentityProxyModel, slot: int, index: pointer): cint {.exportc: "miqt_exec_callback_QIdentityProxyModel_flags ".} =
  ...
  cint(virtualReturn)
proc QIdentityProxyModelsetData*(self: gen_qidentityproxymodel_types.QIdentityProxyModel, index: QModelIndex, value: QVariant, role: cint): bool =
  fQIdentityProxyModel_virtualbase_setData(self.h, index.h, value.h, role)

type QIdentityProxyModelsetDataProc* = proc(index: QModelIndex, value: QVariant, role: cint): bool
...
proc miqt_exec_callback_QIdentityProxyModel_setData(self: ptr cQIdentityProxyModel, slot: int, index: pointer, value: pointer, role: cint): bool {.exportc: "miqt_exec_callback_QIdentityProxyModel_setData ".} =
  ...
  virtualReturn
proc QIdentityProxyModelsetItemData*(self: gen_qidentityproxymodel_types.QIdentityProxyModel, index: QModelIndex, roles: Table[cint,QVariant]): bool =
...
type QIdentityProxyModelsetItemDataProc* = proc(index: QModelIndex, roles: Table[cint,QVariant]): bool
...
proc miqt_exec_callback_QIdentityProxyModel_setItemData(self: ptr cQIdentityProxyModel, slot: int, index: pointer, roles: struct_miqt_map): bool {.exportc: "miqt_exec_callback_QIdentityProxyModel_setItemData ".} =
  ...
  virtualReturn
proc QIdentityProxyModelsetHeaderData*(self: gen_qidentityproxymodel_types.QIdentityProxyModel, section: cint, orientation: cint, value: QVariant, role: cint): bool =
  fQIdentityProxyModel_virtualbase_setHeaderData(self.h, section, cint(orientation), value.h, role)

type QIdentityProxyModelsetHeaderDataProc* = proc(section: cint, orientation: cint, value: QVariant, role: cint): bool
...
proc miqt_exec_callback_QIdentityProxyModel_setHeaderData(self: ptr cQIdentityProxyModel, slot: int, section: cint, orientation: cint, value: pointer, role: cint): bool {.exportc: "miqt_exec_callback_QIdentityProxyModel_setHeaderData ".} =
  ...
  virtualReturn
proc QIdentityProxyModelclearItemData*(self: gen_qidentityproxymodel_types.QIdentityProxyModel, index: QModelIndex): bool =
  fQIdentityProxyModel_virtualbase_clearItemData(self.h, index.h)

type QIdentityProxyModelclearItemDataProc* = proc(index: QModelIndex): bool
...
proc miqt_exec_callback_QIdentityProxyModel_clearItemData(self: ptr cQIdentityProxyModel, slot: int, index: pointer): bool {.exportc: "miqt_exec_callback_QIdentityProxyModel_clearItemData ".} =
  ...
  virtualReturn
proc QIdentityProxyModelbuddy*(self: gen_qidentityproxymodel_types.QIdentityProxyModel, index: QModelIndex): QModelIndex =
  QModelIndex(h: fQIdentityProxyModel_virtualbase_buddy(self.h, index.h))

type QIdentityProxyModelbuddyProc* = proc(index: QModelIndex): QModelIndex
...
proc miqt_exec_callback_QIdentityProxyModel_buddy(self: ptr cQIdentityProxyModel, slot: int, index: pointer): pointer {.exportc: "miqt_exec_callback_QIdentityProxyModel_buddy ".} =
  ...
  virtualReturn.h
proc QIdentityProxyModelcanFetchMore*(self: gen_qidentityproxymodel_types.QIdentityProxyModel, parent: QModelIndex): bool =
  fQIdentityProxyModel_virtualbase_canFetchMore(self.h, parent.h)

type QIdentityProxyModelcanFetchMoreProc* = proc(parent: QModelIndex): bool
...
proc miqt_exec_callback_QIdentityProxyModel_canFetchMore(self: ptr cQIdentityProxyModel, slot: int, parent: pointer): bool {.exportc: "miqt_exec_callback_QIdentityProxyModel_canFetchMore ".} =
  ...
  virtualReturn
proc QIdentityProxyModelfetchMore*(self: gen_qidentityproxymodel_types.QIdentityProxyModel, parent: QModelIndex): void =
  fQIdentityProxyModel_virtualbase_fetchMore(self.h, parent.h)

type QIdentityProxyModelfetchMoreProc* = proc(parent: QModelIndex): void
...
proc QIdentityProxyModelspan*(self: gen_qidentityproxymodel_types.QIdentityProxyModel, index: QModelIndex): QSize =
  QSize(h: fQIdentityProxyModel_virtualbase_span(self.h, index.h))

type QIdentityProxyModelspanProc* = proc(index: QModelIndex): QSize
...
proc miqt_exec_callback_QIdentityProxyModel_span(self: ptr cQIdentityProxyModel, slot: int, index: pointer): pointer {.exportc: "miqt_exec_callback_QIdentityProxyModel_span ".} =
  ...
  virtualReturn.h
proc QIdentityProxyModelhasChildren*(self: gen_qidentityproxymodel_types.QIdentityProxyModel, parent: QModelIndex): bool =
  fQIdentityProxyModel_virtualbase_hasChildren(self.h, parent.h)

type QIdentityProxyModelhasChildrenProc* = proc(parent: QModelIndex): bool
...
proc miqt_exec_callback_QIdentityProxyModel_hasChildren(self: ptr cQIdentityProxyModel, slot: int, parent: pointer): bool {.exportc: "miqt_exec_callback_QIdentityProxyModel_hasChildren ".} =
  ...
  virtualReturn
proc QIdentityProxyModelmimeData*(self: gen_qidentityproxymodel_types.QIdentityProxyModel, indexes: seq[QModelIndex]): QMimeData =
  var indexes_CArray = newSeq[pointer](len(indexes))
  for i in 0..<len(indexes):
    indexes_CArray[i] = indexes[i].h

  QMimeData(h: fQIdentityProxyModel_virtualbase_mimeData(self.h, struct_miqt_array(len: csize_t(len(indexes)), data: if len(indexes) == 0: nil else: addr(indexes_CArray[0]))))

type QIdentityProxyModelmimeDataProc* = proc(indexes: seq[QModelIndex]): QMimeData
...
proc miqt_exec_callback_QIdentityProxyModel_mimeData(self: ptr cQIdentityProxyModel, slot: int, indexes: struct_miqt_array): pointer {.exportc: "miqt_exec_callback_QIdentityProxyModel_mimeData ".} =
  ...
  virtualReturn.h
proc QIdentityProxyModelcanDropMimeData*(self: gen_qidentityproxymodel_types.QIdentityProxyModel, data: QMimeData, action: cint, row: cint, column: cint, parent: QModelIndex): bool =
  fQIdentityProxyModel_virtualbase_canDropMimeData(self.h, data.h, cint(action), row, column, parent.h)

type QIdentityProxyModelcanDropMimeDataProc* = proc(data: QMimeData, action: cint, row: cint, column: cint, parent: QModelIndex): bool
...
proc miqt_exec_callback_QIdentityProxyModel_roleNames(self: ptr cQIdentityProxyModel, slot: int): struct_miqt_map {.exportc: "miqt_exec_callback_QIdentityProxyModel_roleNames ".} =
  ...
  struct_miqt_map(len: csize_t(len(virtualReturn)),keys: if len(virtualReturn) == 0: nil else: addr(virtualReturn_Keys_CArray[0]), values: if len(virtualReturn) == 0: nil else: addr(virtualReturn_Values_CArray[0]),)
proc QIdentityProxyModelmultiData*(self: gen_qidentityproxymodel_types.QIdentityProxyModel, index: QModelIndex, roleDataSpan: QModelRoleDataSpan): void =
  fQIdentityProxyModel_virtualbase_multiData(self.h, index.h, roleDataSpan.h)

type QIdentityProxyModelmultiDataProc* = proc(index: QModelIndex, roleDataSpan: QModelRoleDataSpan): void
...
proc miqt_exec_callback_QIdentityProxyModel_resetInternalData(self: ptr cQIdentityProxyModel, slot: int): void {.exportc: "miqt_exec_callback_QIdentityProxyModel_resetInternalData ".} =
  ...
  nimfunc[]()
proc QIdentityProxyModelevent*(self: gen_qidentityproxymodel_types.QIdentityProxyModel, event: QEvent): bool =
  fQIdentityProxyModel_virtualbase_event(self.h, event.h)

type QIdentityProxyModeleventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QIdentityProxyModel_event(self: ptr cQIdentityProxyModel, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QIdentityProxyModel_event ".} =
  ...
  virtualReturn
proc QIdentityProxyModeleventFilter*(self: gen_qidentityproxymodel_types.QIdentityProxyModel, watched: QObject, event: QEvent): bool =
  fQIdentityProxyModel_virtualbase_eventFilter(self.h, watched.h, event.h)

type QIdentityProxyModeleventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QIdentityProxyModel_eventFilter(self: ptr cQIdentityProxyModel, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QIdentityProxyModel_eventFilter ".} =
  ...
  virtualReturn
proc QIdentityProxyModeltimerEvent*(self: gen_qidentityproxymodel_types.QIdentityProxyModel, event: QTimerEvent): void =
  fQIdentityProxyModel_virtualbase_timerEvent(self.h, event.h)

type QIdentityProxyModeltimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QIdentityProxyModel_timerEvent(self: ptr cQIdentityProxyModel, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QIdentityProxyModel_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QIdentityProxyModelchildEvent*(self: gen_qidentityproxymodel_types.QIdentityProxyModel, event: QChildEvent): void =
  fQIdentityProxyModel_virtualbase_childEvent(self.h, event.h)

type QIdentityProxyModelchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QIdentityProxyModel_childEvent(self: ptr cQIdentityProxyModel, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QIdentityProxyModel_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QIdentityProxyModelcustomEvent*(self: gen_qidentityproxymodel_types.QIdentityProxyModel, event: QEvent): void =
  fQIdentityProxyModel_virtualbase_customEvent(self.h, event.h)

type QIdentityProxyModelcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QIdentityProxyModel_customEvent(self: ptr cQIdentityProxyModel, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QIdentityProxyModel_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QIdentityProxyModelconnectNotify*(self: gen_qidentityproxymodel_types.QIdentityProxyModel, signal: QMetaMethod): void =
  fQIdentityProxyModel_virtualbase_connectNotify(self.h, signal.h)

type QIdentityProxyModelconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QIdentityProxyModel_connectNotify(self: ptr cQIdentityProxyModel, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QIdentityProxyModel_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QIdentityProxyModeldisconnectNotify*(self: gen_qidentityproxymodel_types.QIdentityProxyModel, signal: QMetaMethod): void =
  fQIdentityProxyModel_virtualbase_disconnectNotify(self.h, signal.h)

type QIdentityProxyModeldisconnectNotifyProc* = proc(signal: QMetaMethod): void
