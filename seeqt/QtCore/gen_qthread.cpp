...
QMetaObject* QThread_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQThread*)(self) )->QThread::metaObject();

}

void* QThread_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQThread*)(self) )->QThread::qt_metacast(param1);

}

int QThread_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQThread*)(self) )->QThread::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
