...
QMetaObject* QLibrary_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQLibrary*)(self) )->QLibrary::metaObject();

}

void* QLibrary_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQLibrary*)(self) )->QLibrary::qt_metacast(param1);

}

int QLibrary_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQLibrary*)(self) )->QLibrary::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
QObject* QLibrary_protectedbase_sender(const void* self) {
	MiqtVirtualQLibrary* self_cast = static_cast<MiqtVirtualQLibrary*>( (QLibrary*)(self) );
