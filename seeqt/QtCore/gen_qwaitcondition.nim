...
proc wait*(self: gen_qwaitcondition_types.QWaitCondition, lockedMutex: QMutex): bool =
  fcQWaitCondition_wait(self.h, lockedMutex.h)

proc wait*(self: gen_qwaitcondition_types.QWaitCondition, lockedMutex: QMutex, time: culong): bool =
  fcQWaitCondition_wait2(self.h, lockedMutex.h, time)

proc wait*(self: gen_qwaitcondition_types.QWaitCondition, lockedReadWriteLock: QReadWriteLock): bool =
  fcQWaitCondition_waitWithLockedReadWriteLock(self.h, lockedReadWriteLock.h)

proc wait*(self: gen_qwaitcondition_types.QWaitCondition, lockedReadWriteLock: QReadWriteLock, time: culong): bool =
...
proc wait*(self: gen_qwaitcondition_types.QWaitCondition, lockedMutex: QMutex, deadline: QDeadlineTimer): bool =
  fcQWaitCondition_wait22(self.h, lockedMutex.h, deadline.h)

proc wait*(self: gen_qwaitcondition_types.QWaitCondition, lockedReadWriteLock: QReadWriteLock, deadline: QDeadlineTimer): bool =
