...
proc create*(T: type gen_qjsonvalue_types.QJsonValue, a: QJsonArray): gen_qjsonvalue_types.QJsonValue =
  gen_qjsonvalue_types.QJsonValue.init(fcQJsonValue_new8(a.h))

proc create*(T: type gen_qjsonvalue_types.QJsonValue, o: QJsonObject): gen_qjsonvalue_types.QJsonValue =
  gen_qjsonvalue_types.QJsonValue.init(fcQJsonValue_new9(o.h))

proc create*(T: type gen_qjsonvalue_types.QJsonValue, other: QJsonValue): gen_qjsonvalue_types.QJsonValue =
...
proc operatorAssign*(self: gen_qjsonvalue_types.QJsonValue, other: QJsonValue): void =
  fcQJsonValue_operatorAssign(self.h, other.h)

proc swap*(self: gen_qjsonvalue_types.QJsonValue, other: QJsonValue): void =
  fcQJsonValue_swap(self.h, other.h)

proc fromVariant*(_: type gen_qjsonvalue_types.QJsonValue, variant: QVariant): QJsonValue =
  QJsonValue(h: fcQJsonValue_fromVariant(variant.h))

proc toVariant*(self: gen_qjsonvalue_types.QJsonValue, ): QVariant =
  QVariant(h: fcQJsonValue_toVariant(self.h))
...
proc toArray*(self: gen_qjsonvalue_types.QJsonValue, ): QJsonArray =
  QJsonArray(h: fcQJsonValue_toArray(self.h))

proc toArray*(self: gen_qjsonvalue_types.QJsonValue, defaultValue: QJsonArray): QJsonArray =
  QJsonArray(h: fcQJsonValue_toArrayWithDefaultValue(self.h, defaultValue.h))

proc toObject*(self: gen_qjsonvalue_types.QJsonValue, ): QJsonObject =
  QJsonObject(h: fcQJsonValue_toObject(self.h))

proc toObject*(self: gen_qjsonvalue_types.QJsonValue, defaultValue: QJsonObject): QJsonObject =
  QJsonObject(h: fcQJsonValue_toObjectWithDefaultValue(self.h, defaultValue.h))

proc operatorSubscript*(self: gen_qjsonvalue_types.QJsonValue, key: string): QJsonValue =
  QJsonValue(h: fcQJsonValue_operatorSubscript(self.h, struct_miqt_string(data: key, len: csize_t(len(key)))))

proc operatorSubscript*(self: gen_qjsonvalue_types.QJsonValue, i: int64): QJsonValue =
  QJsonValue(h: fcQJsonValue_operatorSubscriptWithQsizetype(self.h, i))

proc operatorEqual*(self: gen_qjsonvalue_types.QJsonValue, other: QJsonValue): bool =
  fcQJsonValue_operatorEqual(self.h, other.h)

proc operatorNotEqual*(self: gen_qjsonvalue_types.QJsonValue, other: QJsonValue): bool =
...
func init*(T: type gen_qjsonvalue_types.QJsonValueConstRef, h: ptr cQJsonValueConstRef): gen_qjsonvalue_types.QJsonValueConstRef =
  T(h: h)
proc create*(T: type gen_qjsonvalue_types.QJsonValueConstRef, param1: QJsonValueConstRef): gen_qjsonvalue_types.QJsonValueConstRef =
  gen_qjsonvalue_types.QJsonValueConstRef.init(fcQJsonValueConstRef_new(param1.h))

proc ToQJsonValue*(self: gen_qjsonvalue_types.QJsonValueConstRef, ): QJsonValue =
  QJsonValue(h: fcQJsonValueConstRef_ToQJsonValue(self.h))

proc toVariant*(self: gen_qjsonvalue_types.QJsonValueConstRef, ): QVariant =
  QVariant(h: fcQJsonValueConstRef_toVariant(self.h))
...
proc toArray*(self: gen_qjsonvalue_types.QJsonValueConstRef, ): QJsonArray =
  QJsonArray(h: fcQJsonValueConstRef_toArray(self.h))

proc toObject*(self: gen_qjsonvalue_types.QJsonValueConstRef, ): QJsonObject =
  QJsonObject(h: fcQJsonValueConstRef_toObject(self.h))

proc operatorSubscript*(self: gen_qjsonvalue_types.QJsonValueConstRef, i: int64): QJsonValue =
  QJsonValue(h: fcQJsonValueConstRef_operatorSubscriptWithQsizetype(self.h, i))

proc operatorEqual*(self: gen_qjsonvalue_types.QJsonValueConstRef, other: QJsonValue): bool =
  fcQJsonValueConstRef_operatorEqual(self.h, other.h)

proc operatorNotEqual*(self: gen_qjsonvalue_types.QJsonValueConstRef, other: QJsonValue): bool =
...
proc delete*(self: gen_qjsonvalue_types.QJsonValueConstRef) =
...
func init*(T: type gen_qjsonvalue_types.QJsonValueRef, h: ptr cQJsonValueRef): gen_qjsonvalue_types.QJsonValueRef =
  T(h: h)
proc create*(T: type gen_qjsonvalue_types.QJsonValueRef, param1: QJsonValueRef): gen_qjsonvalue_types.QJsonValueRef =
  gen_qjsonvalue_types.QJsonValueRef.init(fcQJsonValueRef_new(param1.h))

proc create*(T: type gen_qjsonvalue_types.QJsonValueRef, array: QJsonArray, idx: int64): gen_qjsonvalue_types.QJsonValueRef =
  gen_qjsonvalue_types.QJsonValueRef.init(fcQJsonValueRef_new2(array.h, idx))

proc create*(T: type gen_qjsonvalue_types.QJsonValueRef, objectVal: QJsonObject, idx: int64): gen_qjsonvalue_types.QJsonValueRef =
  gen_qjsonvalue_types.QJsonValueRef.init(fcQJsonValueRef_new3(objectVal.h, idx))

proc operatorAssign*(self: gen_qjsonvalue_types.QJsonValueRef, val: QJsonValue): void =
  fcQJsonValueRef_operatorAssign(self.h, val.h)

proc operatorAssign*(self: gen_qjsonvalue_types.QJsonValueRef, val: QJsonValueRef): void =
  fcQJsonValueRef_operatorAssignWithVal(self.h, val.h)

proc ToQJsonValue*(self: gen_qjsonvalue_types.QJsonValueRef, ): QJsonValue =
  QJsonValue(h: fcQJsonValueRef_ToQJsonValue(self.h))

proc toVariant*(self: gen_qjsonvalue_types.QJsonValueRef, ): QVariant =
  QVariant(h: fcQJsonValueRef_toVariant(self.h))
...
proc toArray*(self: gen_qjsonvalue_types.QJsonValueRef, ): QJsonArray =
  QJsonArray(h: fcQJsonValueRef_toArray(self.h))

proc toObject*(self: gen_qjsonvalue_types.QJsonValueRef, ): QJsonObject =
  QJsonObject(h: fcQJsonValueRef_toObject(self.h))

proc operatorSubscript*(self: gen_qjsonvalue_types.QJsonValueRef, i: int64): QJsonValue =
  QJsonValue(h: fcQJsonValueRef_operatorSubscriptWithQsizetype(self.h, i))

proc operatorEqual*(self: gen_qjsonvalue_types.QJsonValueRef, other: QJsonValue): bool =
  fcQJsonValueRef_operatorEqual(self.h, other.h)

proc operatorNotEqual*(self: gen_qjsonvalue_types.QJsonValueRef, other: QJsonValue): bool =
