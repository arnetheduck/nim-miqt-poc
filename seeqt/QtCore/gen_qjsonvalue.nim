...
proc operatorSubscript*(self: gen_qjsonvalue_types.QJsonValue, i: cint): QJsonValue =
...
proc create*(T: type gen_qjsonvalue_types.QJsonValueRef, array: QJsonArray, idx: cint): gen_qjsonvalue_types.QJsonValueRef =
  gen_qjsonvalue_types.QJsonValueRef.init(fcQJsonValueRef_new2(array.h, idx))

proc create*(T: type gen_qjsonvalue_types.QJsonValueRef, objectVal: QJsonObject, idx: cint): gen_qjsonvalue_types.QJsonValueRef =
...
func init*(T: type gen_qjsonvalue_types.QJsonValuePtr, h: ptr cQJsonValuePtr): gen_qjsonvalue_types.QJsonValuePtr =
  T(h: h)
proc create*(T: type gen_qjsonvalue_types.QJsonValuePtr, val: QJsonValue): gen_qjsonvalue_types.QJsonValuePtr =
  gen_qjsonvalue_types.QJsonValuePtr.init(fcQJsonValuePtr_new(val.h))

proc create*(T: type gen_qjsonvalue_types.QJsonValuePtr, param1: QJsonValuePtr): gen_qjsonvalue_types.QJsonValuePtr =
  gen_qjsonvalue_types.QJsonValuePtr.init(fcQJsonValuePtr_new2(param1.h))

proc operatorMultiply*(self: gen_qjsonvalue_types.QJsonValuePtr, ): QJsonValue =
  QJsonValue(h: fcQJsonValuePtr_operatorMultiply(self.h))

proc operatorMinusGreater*(self: gen_qjsonvalue_types.QJsonValuePtr, ): QJsonValue =
  QJsonValue(h: fcQJsonValuePtr_operatorMinusGreater(self.h))

proc operatorAssign*(self: gen_qjsonvalue_types.QJsonValuePtr, param1: QJsonValuePtr): void =
...
func init*(T: type gen_qjsonvalue_types.QJsonValueRefPtr, h: ptr cQJsonValueRefPtr): gen_qjsonvalue_types.QJsonValueRefPtr =
  T(h: h)
proc create*(T: type gen_qjsonvalue_types.QJsonValueRefPtr, array: QJsonArray, idx: cint): gen_qjsonvalue_types.QJsonValueRefPtr =
  gen_qjsonvalue_types.QJsonValueRefPtr.init(fcQJsonValueRefPtr_new(array.h, idx))

proc create*(T: type gen_qjsonvalue_types.QJsonValueRefPtr, objectVal: QJsonObject, idx: cint): gen_qjsonvalue_types.QJsonValueRefPtr =
  gen_qjsonvalue_types.QJsonValueRefPtr.init(fcQJsonValueRefPtr_new2(objectVal.h, idx))

proc create*(T: type gen_qjsonvalue_types.QJsonValueRefPtr, param1: QJsonValueRefPtr): gen_qjsonvalue_types.QJsonValueRefPtr =
  gen_qjsonvalue_types.QJsonValueRefPtr.init(fcQJsonValueRefPtr_new3(param1.h))

proc operatorMultiply*(self: gen_qjsonvalue_types.QJsonValueRefPtr, ): QJsonValueRef =
  QJsonValueRef(h: fcQJsonValueRefPtr_operatorMultiply(self.h))

proc operatorMinusGreater*(self: gen_qjsonvalue_types.QJsonValueRefPtr, ): QJsonValueRef =
  QJsonValueRef(h: fcQJsonValueRefPtr_operatorMinusGreater(self.h))

proc operatorAssign*(self: gen_qjsonvalue_types.QJsonValueRefPtr, param1: QJsonValueRefPtr): void =
