...
proc create*(T: type gen_qcborstreamreader_types.QCborStreamReader, device: QIODevice): gen_qcborstreamreader_types.QCborStreamReader =
  gen_qcborstreamreader_types.QCborStreamReader.init(fcQCborStreamReader_new5(device.h))

proc setDevice*(self: gen_qcborstreamreader_types.QCborStreamReader, device: QIODevice): void =
  fcQCborStreamReader_setDevice(self.h, device.h)

proc device*(self: gen_qcborstreamreader_types.QCborStreamReader, ): QIODevice =
  QIODevice(h: fcQCborStreamReader_device(self.h))
...
proc lastError*(self: gen_qcborstreamreader_types.QCborStreamReader, ): QCborError =
  QCborError(h: fcQCborStreamReader_lastError(self.h))
