...
QMetaObject* QAbstractItemModel_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQAbstractItemModel*)(self) )->QAbstractItemModel::metaObject();

}

void* QAbstractItemModel_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQAbstractItemModel*)(self) )->QAbstractItemModel::qt_metacast(param1);

}

int QAbstractItemModel_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQAbstractItemModel*)(self) )->QAbstractItemModel::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
QMetaObject* QAbstractTableModel_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQAbstractTableModel*)(self) )->QAbstractTableModel::metaObject();

}

void* QAbstractTableModel_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQAbstractTableModel*)(self) )->QAbstractTableModel::qt_metacast(param1);

}

int QAbstractTableModel_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQAbstractTableModel*)(self) )->QAbstractTableModel::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
QMetaObject* QAbstractListModel_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQAbstractListModel*)(self) )->QAbstractListModel::metaObject();

}

void* QAbstractListModel_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQAbstractListModel*)(self) )->QAbstractListModel::qt_metacast(param1);

}

int QAbstractListModel_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQAbstractListModel*)(self) )->QAbstractListModel::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
