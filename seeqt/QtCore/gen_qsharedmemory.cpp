...
QMetaObject* QSharedMemory_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQSharedMemory*)(self) )->QSharedMemory::metaObject();

}

void* QSharedMemory_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQSharedMemory*)(self) )->QSharedMemory::qt_metacast(param1);

}

int QSharedMemory_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQSharedMemory*)(self) )->QSharedMemory::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
