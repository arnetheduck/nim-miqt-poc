...
proc create*(T: type gen_qregexp_types.QRegExp, rx: QRegExp): gen_qregexp_types.QRegExp =
...
proc operatorAssign*(self: gen_qregexp_types.QRegExp, rx: QRegExp): void =
  fcQRegExp_operatorAssign(self.h, rx.h)

proc swap*(self: gen_qregexp_types.QRegExp, other: QRegExp): void =
  fcQRegExp_swap(self.h, other.h)

proc operatorEqual*(self: gen_qregexp_types.QRegExp, rx: QRegExp): bool =
  fcQRegExp_operatorEqual(self.h, rx.h)

proc operatorNotEqual*(self: gen_qregexp_types.QRegExp, rx: QRegExp): bool =
