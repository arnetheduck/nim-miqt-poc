...
func init*(T: type gen_qfuturewatcher_types.QFutureWatcherBase, h: ptr cQFutureWatcherBase): gen_qfuturewatcher_types.QFutureWatcherBase =
  T(h: h)
proc metaObject*(self: gen_qfuturewatcher_types.QFutureWatcherBase, ): QMetaObject =
  QMetaObject(h: fcQFutureWatcherBase_metaObject(self.h))
...
proc event*(self: gen_qfuturewatcher_types.QFutureWatcherBase, event: QEvent): bool =
