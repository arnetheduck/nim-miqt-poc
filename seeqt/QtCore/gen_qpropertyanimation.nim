...
proc create*(T: type gen_qpropertyanimation_types.QPropertyAnimation, target: QObject, propertyName: seq[byte]): gen_qpropertyanimation_types.QPropertyAnimation =
...
proc create*(T: type gen_qpropertyanimation_types.QPropertyAnimation, parent: QObject): gen_qpropertyanimation_types.QPropertyAnimation =
  gen_qpropertyanimation_types.QPropertyAnimation.init(fcQPropertyAnimation_new3(parent.h))

proc create*(T: type gen_qpropertyanimation_types.QPropertyAnimation, target: QObject, propertyName: seq[byte], parent: QObject): gen_qpropertyanimation_types.QPropertyAnimation =
...
proc metaObject*(self: gen_qpropertyanimation_types.QPropertyAnimation, ): QMetaObject =
  QMetaObject(h: fcQPropertyAnimation_metaObject(self.h))
...
proc targetObject*(self: gen_qpropertyanimation_types.QPropertyAnimation, ): QObject =
  QObject(h: fcQPropertyAnimation_targetObject(self.h))

proc setTargetObject*(self: gen_qpropertyanimation_types.QPropertyAnimation, target: QObject): void =
...
proc miqt_exec_callback_QPropertyAnimation_metacall(self: ptr cQPropertyAnimation, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QPropertyAnimation_metacall ".} =
  ...
  virtualReturn
proc QPropertyAnimationevent*(self: gen_qpropertyanimation_types.QPropertyAnimation, event: QEvent): bool =
  fQPropertyAnimation_virtualbase_event(self.h, event.h)

type QPropertyAnimationeventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QPropertyAnimation_event(self: ptr cQPropertyAnimation, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QPropertyAnimation_event ".} =
  ...
  virtualReturn
proc QPropertyAnimationupdateCurrentValue*(self: gen_qpropertyanimation_types.QPropertyAnimation, value: QVariant): void =
  fQPropertyAnimation_virtualbase_updateCurrentValue(self.h, value.h)

type QPropertyAnimationupdateCurrentValueProc* = proc(value: QVariant): void
...
proc miqt_exec_callback_QPropertyAnimation_updateCurrentTime(self: ptr cQPropertyAnimation, slot: int, param1: cint): void {.exportc: "miqt_exec_callback_QPropertyAnimation_updateCurrentTime ".} =
  ...
  nimfunc[](slotval1)
proc QPropertyAnimationinterpolated*(self: gen_qpropertyanimation_types.QPropertyAnimation, fromVal: QVariant, to: QVariant, progress: float64): QVariant =
  QVariant(h: fQPropertyAnimation_virtualbase_interpolated(self.h, fromVal.h, to.h, progress))

type QPropertyAnimationinterpolatedProc* = proc(fromVal: QVariant, to: QVariant, progress: float64): QVariant
...
proc miqt_exec_callback_QPropertyAnimation_updateDirection(self: ptr cQPropertyAnimation, slot: int, direction: cint): void {.exportc: "miqt_exec_callback_QPropertyAnimation_updateDirection ".} =
  ...
  nimfunc[](slotval1)
proc QPropertyAnimationeventFilter*(self: gen_qpropertyanimation_types.QPropertyAnimation, watched: QObject, event: QEvent): bool =
  fQPropertyAnimation_virtualbase_eventFilter(self.h, watched.h, event.h)

type QPropertyAnimationeventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QPropertyAnimation_eventFilter(self: ptr cQPropertyAnimation, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QPropertyAnimation_eventFilter ".} =
  ...
  virtualReturn
proc QPropertyAnimationtimerEvent*(self: gen_qpropertyanimation_types.QPropertyAnimation, event: QTimerEvent): void =
  fQPropertyAnimation_virtualbase_timerEvent(self.h, event.h)

type QPropertyAnimationtimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QPropertyAnimation_timerEvent(self: ptr cQPropertyAnimation, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QPropertyAnimation_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QPropertyAnimationchildEvent*(self: gen_qpropertyanimation_types.QPropertyAnimation, event: QChildEvent): void =
  fQPropertyAnimation_virtualbase_childEvent(self.h, event.h)

type QPropertyAnimationchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QPropertyAnimation_childEvent(self: ptr cQPropertyAnimation, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QPropertyAnimation_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QPropertyAnimationcustomEvent*(self: gen_qpropertyanimation_types.QPropertyAnimation, event: QEvent): void =
  fQPropertyAnimation_virtualbase_customEvent(self.h, event.h)

type QPropertyAnimationcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QPropertyAnimation_customEvent(self: ptr cQPropertyAnimation, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QPropertyAnimation_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QPropertyAnimationconnectNotify*(self: gen_qpropertyanimation_types.QPropertyAnimation, signal: QMetaMethod): void =
  fQPropertyAnimation_virtualbase_connectNotify(self.h, signal.h)

type QPropertyAnimationconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QPropertyAnimation_connectNotify(self: ptr cQPropertyAnimation, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QPropertyAnimation_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QPropertyAnimationdisconnectNotify*(self: gen_qpropertyanimation_types.QPropertyAnimation, signal: QMetaMethod): void =
  fQPropertyAnimation_virtualbase_disconnectNotify(self.h, signal.h)

type QPropertyAnimationdisconnectNotifyProc* = proc(signal: QMetaMethod): void
