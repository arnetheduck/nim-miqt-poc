...
proc create*(T: type gen_qanimationgroup_types.QAnimationGroup, parent: QObject): gen_qanimationgroup_types.QAnimationGroup =
  gen_qanimationgroup_types.QAnimationGroup.init(fcQAnimationGroup_new2(parent.h))

proc metaObject*(self: gen_qanimationgroup_types.QAnimationGroup, ): QMetaObject =
  QMetaObject(h: fcQAnimationGroup_metaObject(self.h))
...
proc animationAt*(self: gen_qanimationgroup_types.QAnimationGroup, index: cint): QAbstractAnimation =
  QAbstractAnimation(h: fcQAnimationGroup_animationAt(self.h, index))

proc animationCount*(self: gen_qanimationgroup_types.QAnimationGroup, ): cint =
  fcQAnimationGroup_animationCount(self.h)

proc indexOfAnimation*(self: gen_qanimationgroup_types.QAnimationGroup, animation: QAbstractAnimation): cint =
  fcQAnimationGroup_indexOfAnimation(self.h, animation.h)

proc addAnimation*(self: gen_qanimationgroup_types.QAnimationGroup, animation: QAbstractAnimation): void =
  fcQAnimationGroup_addAnimation(self.h, animation.h)

proc insertAnimation*(self: gen_qanimationgroup_types.QAnimationGroup, index: cint, animation: QAbstractAnimation): void =
  fcQAnimationGroup_insertAnimation(self.h, index, animation.h)

proc removeAnimation*(self: gen_qanimationgroup_types.QAnimationGroup, animation: QAbstractAnimation): void =
  fcQAnimationGroup_removeAnimation(self.h, animation.h)

proc takeAnimation*(self: gen_qanimationgroup_types.QAnimationGroup, index: cint): QAbstractAnimation =
  QAbstractAnimation(h: fcQAnimationGroup_takeAnimation(self.h, index))
...
proc miqt_exec_callback_QAnimationGroup_metacall(self: ptr cQAnimationGroup, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QAnimationGroup_metacall ".} =
  ...
  virtualReturn
proc QAnimationGroupevent*(self: gen_qanimationgroup_types.QAnimationGroup, event: QEvent): bool =
  fQAnimationGroup_virtualbase_event(self.h, event.h)

type QAnimationGroupeventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QAnimationGroup_updateDirection(self: ptr cQAnimationGroup, slot: int, direction: cint): void {.exportc: "miqt_exec_callback_QAnimationGroup_updateDirection ".} =
  ...
  nimfunc[](slotval1)
proc QAnimationGroupeventFilter*(self: gen_qanimationgroup_types.QAnimationGroup, watched: QObject, event: QEvent): bool =
  fQAnimationGroup_virtualbase_eventFilter(self.h, watched.h, event.h)

type QAnimationGroupeventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QAnimationGroup_eventFilter(self: ptr cQAnimationGroup, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QAnimationGroup_eventFilter ".} =
  ...
  virtualReturn
proc QAnimationGrouptimerEvent*(self: gen_qanimationgroup_types.QAnimationGroup, event: QTimerEvent): void =
  fQAnimationGroup_virtualbase_timerEvent(self.h, event.h)

type QAnimationGrouptimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QAnimationGroup_timerEvent(self: ptr cQAnimationGroup, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QAnimationGroup_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QAnimationGroupchildEvent*(self: gen_qanimationgroup_types.QAnimationGroup, event: QChildEvent): void =
  fQAnimationGroup_virtualbase_childEvent(self.h, event.h)

type QAnimationGroupchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QAnimationGroup_childEvent(self: ptr cQAnimationGroup, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QAnimationGroup_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QAnimationGroupcustomEvent*(self: gen_qanimationgroup_types.QAnimationGroup, event: QEvent): void =
  fQAnimationGroup_virtualbase_customEvent(self.h, event.h)

type QAnimationGroupcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QAnimationGroup_customEvent(self: ptr cQAnimationGroup, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QAnimationGroup_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QAnimationGroupconnectNotify*(self: gen_qanimationgroup_types.QAnimationGroup, signal: QMetaMethod): void =
  fQAnimationGroup_virtualbase_connectNotify(self.h, signal.h)

type QAnimationGroupconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QAnimationGroup_connectNotify(self: ptr cQAnimationGroup, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QAnimationGroup_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QAnimationGroupdisconnectNotify*(self: gen_qanimationgroup_types.QAnimationGroup, signal: QMetaMethod): void =
  fQAnimationGroup_virtualbase_disconnectNotify(self.h, signal.h)

type QAnimationGroupdisconnectNotifyProc* = proc(signal: QMetaMethod): void
