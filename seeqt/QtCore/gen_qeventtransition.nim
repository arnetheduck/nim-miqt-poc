...
proc create*(T: type gen_qeventtransition_types.QEventTransition, objectVal: QObject, typeVal: cint): gen_qeventtransition_types.QEventTransition =
  gen_qeventtransition_types.QEventTransition.init(fcQEventTransition_new2(objectVal.h, cint(typeVal)))

proc create*(T: type gen_qeventtransition_types.QEventTransition, sourceState: QState): gen_qeventtransition_types.QEventTransition =
  gen_qeventtransition_types.QEventTransition.init(fcQEventTransition_new3(sourceState.h))

proc create*(T: type gen_qeventtransition_types.QEventTransition, objectVal: QObject, typeVal: cint, sourceState: QState): gen_qeventtransition_types.QEventTransition =
  gen_qeventtransition_types.QEventTransition.init(fcQEventTransition_new4(objectVal.h, cint(typeVal), sourceState.h))

proc metaObject*(self: gen_qeventtransition_types.QEventTransition, ): QMetaObject =
  QMetaObject(h: fcQEventTransition_metaObject(self.h))
...
proc eventSource*(self: gen_qeventtransition_types.QEventTransition, ): QObject =
  QObject(h: fcQEventTransition_eventSource(self.h))

proc setEventSource*(self: gen_qeventtransition_types.QEventTransition, objectVal: QObject): void =
...
proc miqt_exec_callback_QEventTransition_metacall(self: ptr cQEventTransition, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QEventTransition_metacall ".} =
  ...
  virtualReturn
proc QEventTransitioneventTest*(self: gen_qeventtransition_types.QEventTransition, event: QEvent): bool =
  fQEventTransition_virtualbase_eventTest(self.h, event.h)

type QEventTransitioneventTestProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QEventTransition_eventTest(self: ptr cQEventTransition, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QEventTransition_eventTest ".} =
  ...
  virtualReturn
proc QEventTransitiononTransition*(self: gen_qeventtransition_types.QEventTransition, event: QEvent): void =
  fQEventTransition_virtualbase_onTransition(self.h, event.h)

type QEventTransitiononTransitionProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QEventTransition_onTransition(self: ptr cQEventTransition, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QEventTransition_onTransition ".} =
  ...
  nimfunc[](slotval1)
proc QEventTransitionevent*(self: gen_qeventtransition_types.QEventTransition, e: QEvent): bool =
  fQEventTransition_virtualbase_event(self.h, e.h)

type QEventTransitioneventProc* = proc(e: QEvent): bool
...
proc miqt_exec_callback_QEventTransition_event(self: ptr cQEventTransition, slot: int, e: pointer): bool {.exportc: "miqt_exec_callback_QEventTransition_event ".} =
  ...
  virtualReturn
proc QEventTransitioneventFilter*(self: gen_qeventtransition_types.QEventTransition, watched: QObject, event: QEvent): bool =
  fQEventTransition_virtualbase_eventFilter(self.h, watched.h, event.h)

type QEventTransitioneventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QEventTransition_eventFilter(self: ptr cQEventTransition, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QEventTransition_eventFilter ".} =
  ...
  virtualReturn
proc QEventTransitiontimerEvent*(self: gen_qeventtransition_types.QEventTransition, event: QTimerEvent): void =
  fQEventTransition_virtualbase_timerEvent(self.h, event.h)

type QEventTransitiontimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QEventTransition_timerEvent(self: ptr cQEventTransition, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QEventTransition_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QEventTransitionchildEvent*(self: gen_qeventtransition_types.QEventTransition, event: QChildEvent): void =
  fQEventTransition_virtualbase_childEvent(self.h, event.h)

type QEventTransitionchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QEventTransition_childEvent(self: ptr cQEventTransition, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QEventTransition_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QEventTransitioncustomEvent*(self: gen_qeventtransition_types.QEventTransition, event: QEvent): void =
  fQEventTransition_virtualbase_customEvent(self.h, event.h)

type QEventTransitioncustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QEventTransition_customEvent(self: ptr cQEventTransition, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QEventTransition_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QEventTransitionconnectNotify*(self: gen_qeventtransition_types.QEventTransition, signal: QMetaMethod): void =
  fQEventTransition_virtualbase_connectNotify(self.h, signal.h)

type QEventTransitionconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QEventTransition_connectNotify(self: ptr cQEventTransition, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QEventTransition_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QEventTransitiondisconnectNotify*(self: gen_qeventtransition_types.QEventTransition, signal: QMetaMethod): void =
  fQEventTransition_virtualbase_disconnectNotify(self.h, signal.h)

type QEventTransitiondisconnectNotifyProc* = proc(signal: QMetaMethod): void
