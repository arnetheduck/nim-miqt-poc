...
proc create*(T: type gen_qcalendar_types.QCalendar, name: QAnyStringView): gen_qcalendar_types.QCalendar =
  gen_qcalendar_types.QCalendar.init(fcQCalendar_new3(name.h))

proc create*(T: type gen_qcalendar_types.QCalendar, id: QCalendarSystemId): gen_qcalendar_types.QCalendar =
...
proc dateFromParts*(self: gen_qcalendar_types.QCalendar, year: cint, month: cint, day: cint): QDate =
  QDate(h: fcQCalendar_dateFromParts(self.h, year, month, day))

proc dateFromParts*(self: gen_qcalendar_types.QCalendar, parts: QCalendarYearMonthDay): QDate =
  QDate(h: fcQCalendar_dateFromPartsWithParts(self.h, parts.h))

proc partsFromDate*(self: gen_qcalendar_types.QCalendar, date: QDate): QCalendarYearMonthDay =
  QCalendarYearMonthDay(h: fcQCalendar_partsFromDate(self.h, date.h))

proc dayOfWeek*(self: gen_qcalendar_types.QCalendar, date: QDate): cint =
  fcQCalendar_dayOfWeek(self.h, date.h)

proc monthName*(self: gen_qcalendar_types.QCalendar, locale: QLocale, month: cint): string =
  let v_ms = fcQCalendar_monthName(self.h, locale.h, month)
  let vx_ret = string.fromBytes(toOpenArrayByte(v_ms.data, 0, int(v_ms.len)-1))
  c_free(v_ms.data)
  vx_ret

proc standaloneMonthName*(self: gen_qcalendar_types.QCalendar, locale: QLocale, month: cint): string =
  let v_ms = fcQCalendar_standaloneMonthName(self.h, locale.h, month)
  let vx_ret = string.fromBytes(toOpenArrayByte(v_ms.data, 0, int(v_ms.len)-1))
  c_free(v_ms.data)
  vx_ret

proc weekDayName*(self: gen_qcalendar_types.QCalendar, locale: QLocale, day: cint): string =
  let v_ms = fcQCalendar_weekDayName(self.h, locale.h, day)
  let vx_ret = string.fromBytes(toOpenArrayByte(v_ms.data, 0, int(v_ms.len)-1))
  c_free(v_ms.data)
  vx_ret

proc standaloneWeekDayName*(self: gen_qcalendar_types.QCalendar, locale: QLocale, day: cint): string =
...
proc monthName*(self: gen_qcalendar_types.QCalendar, locale: QLocale, month: cint, year: cint): string =
  let v_ms = fcQCalendar_monthName3(self.h, locale.h, month, year)
  let vx_ret = string.fromBytes(toOpenArrayByte(v_ms.data, 0, int(v_ms.len)-1))
  c_free(v_ms.data)
  vx_ret

proc monthName*(self: gen_qcalendar_types.QCalendar, locale: QLocale, month: cint, year: cint, format: cint): string =
  let v_ms = fcQCalendar_monthName4(self.h, locale.h, month, year, cint(format))
  let vx_ret = string.fromBytes(toOpenArrayByte(v_ms.data, 0, int(v_ms.len)-1))
  c_free(v_ms.data)
  vx_ret

proc standaloneMonthName*(self: gen_qcalendar_types.QCalendar, locale: QLocale, month: cint, year: cint): string =
  let v_ms = fcQCalendar_standaloneMonthName3(self.h, locale.h, month, year)
  let vx_ret = string.fromBytes(toOpenArrayByte(v_ms.data, 0, int(v_ms.len)-1))
  c_free(v_ms.data)
  vx_ret

proc standaloneMonthName*(self: gen_qcalendar_types.QCalendar, locale: QLocale, month: cint, year: cint, format: cint): string =
  let v_ms = fcQCalendar_standaloneMonthName4(self.h, locale.h, month, year, cint(format))
  let vx_ret = string.fromBytes(toOpenArrayByte(v_ms.data, 0, int(v_ms.len)-1))
  c_free(v_ms.data)
  vx_ret

proc weekDayName*(self: gen_qcalendar_types.QCalendar, locale: QLocale, day: cint, format: cint): string =
  let v_ms = fcQCalendar_weekDayName3(self.h, locale.h, day, cint(format))
  let vx_ret = string.fromBytes(toOpenArrayByte(v_ms.data, 0, int(v_ms.len)-1))
  c_free(v_ms.data)
  vx_ret

proc standaloneWeekDayName*(self: gen_qcalendar_types.QCalendar, locale: QLocale, day: cint, format: cint): string =
