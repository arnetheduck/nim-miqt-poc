...
QMetaObject* QTimer_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQTimer*)(self) )->QTimer::metaObject();

}

void* QTimer_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQTimer*)(self) )->QTimer::qt_metacast(param1);

}

int QTimer_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQTimer*)(self) )->QTimer::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
