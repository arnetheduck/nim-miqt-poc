...
proc create*(T: type gen_qcoreevent_types.QEvent, other: QEvent): gen_qcoreevent_types.QEvent =
  gen_qcoreevent_types.QEvent.init(fcQEvent_new2(other.h))

proc operatorAssign*(self: gen_qcoreevent_types.QEvent, other: QEvent): void =
...
proc create*(T: type gen_qcoreevent_types.QTimerEvent, param1: QTimerEvent): gen_qcoreevent_types.QTimerEvent =
...
func init*(T: type gen_qcoreevent_types.QChildEvent, h: ptr cQChildEvent): gen_qcoreevent_types.QChildEvent =
  T(h: h)
proc create*(T: type gen_qcoreevent_types.QChildEvent, typeVal: cint, child: QObject): gen_qcoreevent_types.QChildEvent =
  gen_qcoreevent_types.QChildEvent.init(fcQChildEvent_new(cint(typeVal), child.h))

proc create*(T: type gen_qcoreevent_types.QChildEvent, param1: QChildEvent): gen_qcoreevent_types.QChildEvent =
  gen_qcoreevent_types.QChildEvent.init(fcQChildEvent_new2(param1.h))

proc child*(self: gen_qcoreevent_types.QChildEvent, ): QObject =
  QObject(h: fcQChildEvent_child(self.h))
...
proc create*(T: type gen_qcoreevent_types.QDynamicPropertyChangeEvent, param1: QDynamicPropertyChangeEvent): gen_qcoreevent_types.QDynamicPropertyChangeEvent =
