...
proc clone*(self: gen_qcoreevent_types.QEvent, ): QEvent =
...
proc miqt_exec_callback_QEvent_setAccepted(self: ptr cQEvent, slot: int, accepted: bool): void {.exportc: "miqt_exec_callback_QEvent_setAccepted ".} =
  ...
  nimfunc[](slotval1)
proc QEventclone*(self: gen_qcoreevent_types.QEvent, ): QEvent =
  QEvent(h: fQEvent_virtualbase_clone(self.h))

type QEventcloneProc* = proc(): QEvent
...
proc clone*(self: gen_qcoreevent_types.QTimerEvent, ): QTimerEvent =
...
proc QTimerEventclone*(self: gen_qcoreevent_types.QTimerEvent, ): QTimerEvent =
  QTimerEvent(h: fQTimerEvent_virtualbase_clone(self.h))

type QTimerEventcloneProc* = proc(): QTimerEvent
...
proc clone*(self: gen_qcoreevent_types.QChildEvent, ): QChildEvent =
...
proc QChildEventclone*(self: gen_qcoreevent_types.QChildEvent, ): QChildEvent =
  QChildEvent(h: fQChildEvent_virtualbase_clone(self.h))

type QChildEventcloneProc* = proc(): QChildEvent
...
proc clone*(self: gen_qcoreevent_types.QDynamicPropertyChangeEvent, ): QDynamicPropertyChangeEvent =
...
proc QDynamicPropertyChangeEventclone*(self: gen_qcoreevent_types.QDynamicPropertyChangeEvent, ): QDynamicPropertyChangeEvent =
  QDynamicPropertyChangeEvent(h: fQDynamicPropertyChangeEvent_virtualbase_clone(self.h))

type QDynamicPropertyChangeEventcloneProc* = proc(): QDynamicPropertyChangeEvent
