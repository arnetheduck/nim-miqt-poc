...
proc create*(T: type gen_qsequentialanimationgroup_types.QSequentialAnimationGroup, parent: QObject): gen_qsequentialanimationgroup_types.QSequentialAnimationGroup =
  gen_qsequentialanimationgroup_types.QSequentialAnimationGroup.init(fcQSequentialAnimationGroup_new2(parent.h))

proc metaObject*(self: gen_qsequentialanimationgroup_types.QSequentialAnimationGroup, ): QMetaObject =
  QMetaObject(h: fcQSequentialAnimationGroup_metaObject(self.h))
...
proc addPause*(self: gen_qsequentialanimationgroup_types.QSequentialAnimationGroup, msecs: cint): QPauseAnimation =
  QPauseAnimation(h: fcQSequentialAnimationGroup_addPause(self.h, msecs))

proc insertPause*(self: gen_qsequentialanimationgroup_types.QSequentialAnimationGroup, index: cint, msecs: cint): QPauseAnimation =
  QPauseAnimation(h: fcQSequentialAnimationGroup_insertPause(self.h, index, msecs))

proc currentAnimation*(self: gen_qsequentialanimationgroup_types.QSequentialAnimationGroup, ): QAbstractAnimation =
  QAbstractAnimation(h: fcQSequentialAnimationGroup_currentAnimation(self.h))
...
proc currentAnimationChanged*(self: gen_qsequentialanimationgroup_types.QSequentialAnimationGroup, current: QAbstractAnimation): void =
  fcQSequentialAnimationGroup_currentAnimationChanged(self.h, current.h)

type QSequentialAnimationGroupcurrentAnimationChangedSlot* = proc(current: QAbstractAnimation)
proc miqt_exec_callback_QSequentialAnimationGroup_currentAnimationChanged(slot: int, current: pointer) {.exportc.} =
  ...
  let slotval1 = QAbstractAnimation(h: current)
...
proc miqt_exec_callback_QSequentialAnimationGroup_duration(self: ptr cQSequentialAnimationGroup, slot: int): cint {.exportc: "miqt_exec_callback_QSequentialAnimationGroup_duration ".} =
  ...
  virtualReturn
proc QSequentialAnimationGroupevent*(self: gen_qsequentialanimationgroup_types.QSequentialAnimationGroup, event: QEvent): bool =
  fQSequentialAnimationGroup_virtualbase_event(self.h, event.h)

type QSequentialAnimationGroupeventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QSequentialAnimationGroup_updateDirection(self: ptr cQSequentialAnimationGroup, slot: int, direction: cint): void {.exportc: "miqt_exec_callback_QSequentialAnimationGroup_updateDirection ".} =
  ...
  nimfunc[](slotval1)
proc QSequentialAnimationGroupeventFilter*(self: gen_qsequentialanimationgroup_types.QSequentialAnimationGroup, watched: QObject, event: QEvent): bool =
  fQSequentialAnimationGroup_virtualbase_eventFilter(self.h, watched.h, event.h)

type QSequentialAnimationGroupeventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QSequentialAnimationGroup_eventFilter(self: ptr cQSequentialAnimationGroup, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QSequentialAnimationGroup_eventFilter ".} =
  ...
  virtualReturn
proc QSequentialAnimationGrouptimerEvent*(self: gen_qsequentialanimationgroup_types.QSequentialAnimationGroup, event: QTimerEvent): void =
  fQSequentialAnimationGroup_virtualbase_timerEvent(self.h, event.h)

type QSequentialAnimationGrouptimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QSequentialAnimationGroup_timerEvent(self: ptr cQSequentialAnimationGroup, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QSequentialAnimationGroup_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QSequentialAnimationGroupchildEvent*(self: gen_qsequentialanimationgroup_types.QSequentialAnimationGroup, event: QChildEvent): void =
  fQSequentialAnimationGroup_virtualbase_childEvent(self.h, event.h)

type QSequentialAnimationGroupchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QSequentialAnimationGroup_childEvent(self: ptr cQSequentialAnimationGroup, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QSequentialAnimationGroup_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QSequentialAnimationGroupcustomEvent*(self: gen_qsequentialanimationgroup_types.QSequentialAnimationGroup, event: QEvent): void =
  fQSequentialAnimationGroup_virtualbase_customEvent(self.h, event.h)

type QSequentialAnimationGroupcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QSequentialAnimationGroup_customEvent(self: ptr cQSequentialAnimationGroup, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QSequentialAnimationGroup_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QSequentialAnimationGroupconnectNotify*(self: gen_qsequentialanimationgroup_types.QSequentialAnimationGroup, signal: QMetaMethod): void =
  fQSequentialAnimationGroup_virtualbase_connectNotify(self.h, signal.h)

type QSequentialAnimationGroupconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QSequentialAnimationGroup_connectNotify(self: ptr cQSequentialAnimationGroup, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QSequentialAnimationGroup_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QSequentialAnimationGroupdisconnectNotify*(self: gen_qsequentialanimationgroup_types.QSequentialAnimationGroup, signal: QMetaMethod): void =
  fQSequentialAnimationGroup_virtualbase_disconnectNotify(self.h, signal.h)

type QSequentialAnimationGroupdisconnectNotifyProc* = proc(signal: QMetaMethod): void
