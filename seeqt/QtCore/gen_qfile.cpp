...
QMetaObject* QFile_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQFile*)(self) )->QFile::metaObject();

}

void* QFile_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQFile*)(self) )->QFile::qt_metacast(param1);

}

int QFile_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQFile*)(self) )->QFile::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
