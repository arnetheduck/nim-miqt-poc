...
func init*(T: type gen_qqmlfileselector_types.QQmlFileSelector, h: ptr cQQmlFileSelector): gen_qqmlfileselector_types.QQmlFileSelector =
  T(h: h)
proc create*(T: type gen_qqmlfileselector_types.QQmlFileSelector, engine: QQmlEngine): gen_qqmlfileselector_types.QQmlFileSelector =
  gen_qqmlfileselector_types.QQmlFileSelector.init(fcQQmlFileSelector_new(engine.h))

proc create*(T: type gen_qqmlfileselector_types.QQmlFileSelector, engine: QQmlEngine, parent: QObject): gen_qqmlfileselector_types.QQmlFileSelector =
  gen_qqmlfileselector_types.QQmlFileSelector.init(fcQQmlFileSelector_new2(engine.h, parent.h))

proc metaObject*(self: gen_qqmlfileselector_types.QQmlFileSelector, ): QMetaObject =
  QMetaObject(h: fcQQmlFileSelector_metaObject(self.h))
...
proc selector*(self: gen_qqmlfileselector_types.QQmlFileSelector, ): QFileSelector =
  QFileSelector(h: fcQQmlFileSelector_selector(self.h))

proc setSelector*(self: gen_qqmlfileselector_types.QQmlFileSelector, selector: QFileSelector): void =
...
proc get*(_: type gen_qqmlfileselector_types.QQmlFileSelector, param1: QQmlEngine): QQmlFileSelector =
...
proc miqt_exec_callback_QQmlFileSelector_metacall(self: ptr cQQmlFileSelector, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QQmlFileSelector_metacall ".} =
  ...
  virtualReturn
proc QQmlFileSelectorevent*(self: gen_qqmlfileselector_types.QQmlFileSelector, event: QEvent): bool =
  fQQmlFileSelector_virtualbase_event(self.h, event.h)

type QQmlFileSelectoreventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QQmlFileSelector_event(self: ptr cQQmlFileSelector, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QQmlFileSelector_event ".} =
  ...
  virtualReturn
proc QQmlFileSelectoreventFilter*(self: gen_qqmlfileselector_types.QQmlFileSelector, watched: QObject, event: QEvent): bool =
  fQQmlFileSelector_virtualbase_eventFilter(self.h, watched.h, event.h)

type QQmlFileSelectoreventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QQmlFileSelector_eventFilter(self: ptr cQQmlFileSelector, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QQmlFileSelector_eventFilter ".} =
  ...
  virtualReturn
proc QQmlFileSelectortimerEvent*(self: gen_qqmlfileselector_types.QQmlFileSelector, event: QTimerEvent): void =
  fQQmlFileSelector_virtualbase_timerEvent(self.h, event.h)

type QQmlFileSelectortimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QQmlFileSelector_timerEvent(self: ptr cQQmlFileSelector, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QQmlFileSelector_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QQmlFileSelectorchildEvent*(self: gen_qqmlfileselector_types.QQmlFileSelector, event: QChildEvent): void =
  fQQmlFileSelector_virtualbase_childEvent(self.h, event.h)

type QQmlFileSelectorchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QQmlFileSelector_childEvent(self: ptr cQQmlFileSelector, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QQmlFileSelector_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QQmlFileSelectorcustomEvent*(self: gen_qqmlfileselector_types.QQmlFileSelector, event: QEvent): void =
  fQQmlFileSelector_virtualbase_customEvent(self.h, event.h)

type QQmlFileSelectorcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QQmlFileSelector_customEvent(self: ptr cQQmlFileSelector, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QQmlFileSelector_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QQmlFileSelectorconnectNotify*(self: gen_qqmlfileselector_types.QQmlFileSelector, signal: QMetaMethod): void =
  fQQmlFileSelector_virtualbase_connectNotify(self.h, signal.h)

type QQmlFileSelectorconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QQmlFileSelector_connectNotify(self: ptr cQQmlFileSelector, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QQmlFileSelector_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QQmlFileSelectordisconnectNotify*(self: gen_qqmlfileselector_types.QQmlFileSelector, signal: QMetaMethod): void =
  fQQmlFileSelector_virtualbase_disconnectNotify(self.h, signal.h)

type QQmlFileSelectordisconnectNotifyProc* = proc(signal: QMetaMethod): void
