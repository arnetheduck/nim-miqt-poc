...
public:
	...
	MiqtVirtualQQmlPropertyValueSource(struct QQmlPropertyValueSource_VTable* vtbl): QQmlPropertyValueSource(), vtbl(vtbl) {};

	virtual ~MiqtVirtualQQmlPropertyValueSource() override { if(vtbl->destructor) vtbl->destructor(vtbl, this); }
...
QQmlPropertyValueSource* QQmlPropertyValueSource_new(struct QQmlPropertyValueSource_VTable* vtbl) {
	return new MiqtVirtualQQmlPropertyValueSource(vtbl);
}
