...
proc create*(T: type gen_qqmllist_types.QQmlListReference, variant: QVariant): gen_qqmllist_types.QQmlListReference =
  gen_qqmllist_types.QQmlListReference.init(fcQQmlListReference_new2(variant.h))

proc create*(T: type gen_qqmllist_types.QQmlListReference, o: QObject, property: cstring): gen_qqmllist_types.QQmlListReference =
  gen_qqmllist_types.QQmlListReference.init(fcQQmlListReference_new3(o.h, property))

proc create2*(T: type gen_qqmllist_types.QQmlListReference, variant: QVariant): gen_qqmllist_types.QQmlListReference =
  gen_qqmllist_types.QQmlListReference.init(fcQQmlListReference_new4(variant.h))

proc create2*(T: type gen_qqmllist_types.QQmlListReference, o: QObject, property: cstring): gen_qqmllist_types.QQmlListReference =
  gen_qqmllist_types.QQmlListReference.init(fcQQmlListReference_new5(o.h, property))

proc create*(T: type gen_qqmllist_types.QQmlListReference, param1: QQmlListReference): gen_qqmllist_types.QQmlListReference =
  gen_qqmllist_types.QQmlListReference.init(fcQQmlListReference_new6(param1.h))

proc create*(T: type gen_qqmllist_types.QQmlListReference, variant: QVariant, engine: QQmlEngine): gen_qqmllist_types.QQmlListReference =
  gen_qqmllist_types.QQmlListReference.init(fcQQmlListReference_new7(variant.h, engine.h))

proc create*(T: type gen_qqmllist_types.QQmlListReference, o: QObject, property: cstring, engine: QQmlEngine): gen_qqmllist_types.QQmlListReference =
  gen_qqmllist_types.QQmlListReference.init(fcQQmlListReference_new8(o.h, property, engine.h))

proc operatorAssign*(self: gen_qqmllist_types.QQmlListReference, param1: QQmlListReference): void =
...
proc objectX*(self: gen_qqmllist_types.QQmlListReference, ): QObject =
  QObject(h: fcQQmlListReference_objectX(self.h))

proc listElementType*(self: gen_qqmllist_types.QQmlListReference, ): QMetaObject =
  QMetaObject(h: fcQQmlListReference_listElementType(self.h))
...
proc append*(self: gen_qqmllist_types.QQmlListReference, param1: QObject): bool =
  fcQQmlListReference_append(self.h, param1.h)

proc at*(self: gen_qqmllist_types.QQmlListReference, param1: int64): QObject =
  QObject(h: fcQQmlListReference_at(self.h, param1))
...
proc replace*(self: gen_qqmllist_types.QQmlListReference, param1: int64, param2: QObject): bool =
...
proc operatorEqual*(self: gen_qqmllist_types.QQmlListReference, other: QQmlListReference): bool =
