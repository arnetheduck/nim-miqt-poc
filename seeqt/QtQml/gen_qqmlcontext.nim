...
func init*(T: type gen_qqmlcontext_types.QQmlContext, h: ptr cQQmlContext): gen_qqmlcontext_types.QQmlContext =
  T(h: h)
proc create*(T: type gen_qqmlcontext_types.QQmlContext, parent: QQmlEngine): gen_qqmlcontext_types.QQmlContext =
  gen_qqmlcontext_types.QQmlContext.init(fcQQmlContext_new(parent.h))

proc create*(T: type gen_qqmlcontext_types.QQmlContext, parent: QQmlContext): gen_qqmlcontext_types.QQmlContext =
  gen_qqmlcontext_types.QQmlContext.init(fcQQmlContext_new2(parent.h))

proc create*(T: type gen_qqmlcontext_types.QQmlContext, parent: QQmlEngine, objParent: QObject): gen_qqmlcontext_types.QQmlContext =
  gen_qqmlcontext_types.QQmlContext.init(fcQQmlContext_new3(parent.h, objParent.h))

proc create*(T: type gen_qqmlcontext_types.QQmlContext, parent: QQmlContext, objParent: QObject): gen_qqmlcontext_types.QQmlContext =
  gen_qqmlcontext_types.QQmlContext.init(fcQQmlContext_new4(parent.h, objParent.h))

proc metaObject*(self: gen_qqmlcontext_types.QQmlContext, ): QMetaObject =
  QMetaObject(h: fcQQmlContext_metaObject(self.h))
...
proc engine*(self: gen_qqmlcontext_types.QQmlContext, ): QQmlEngine =
  QQmlEngine(h: fcQQmlContext_engine(self.h))

proc parentContext*(self: gen_qqmlcontext_types.QQmlContext, ): QQmlContext =
  QQmlContext(h: fcQQmlContext_parentContext(self.h))

proc contextObject*(self: gen_qqmlcontext_types.QQmlContext, ): QObject =
  QObject(h: fcQQmlContext_contextObject(self.h))

proc setContextObject*(self: gen_qqmlcontext_types.QQmlContext, contextObject: QObject): void =
  fcQQmlContext_setContextObject(self.h, contextObject.h)

proc contextProperty*(self: gen_qqmlcontext_types.QQmlContext, param1: string): QVariant =
  QVariant(h: fcQQmlContext_contextProperty(self.h, struct_miqt_string(data: param1, len: csize_t(len(param1)))))

proc setContextProperty*(self: gen_qqmlcontext_types.QQmlContext, param1: string, param2: QObject): void =
  fcQQmlContext_setContextProperty(self.h, struct_miqt_string(data: param1, len: csize_t(len(param1))), param2.h)

proc setContextProperty*(self: gen_qqmlcontext_types.QQmlContext, param1: string, param2: QVariant): void =
  fcQQmlContext_setContextProperty2(self.h, struct_miqt_string(data: param1, len: csize_t(len(param1))), param2.h)

proc setContextProperties*(self: gen_qqmlcontext_types.QQmlContext, properties: seq[QQmlContextPropertyPair]): void =
...
proc nameForObject*(self: gen_qqmlcontext_types.QQmlContext, param1: QObject): string =
  let v_ms = fcQQmlContext_nameForObject(self.h, param1.h)
  let vx_ret = string.fromBytes(toOpenArrayByte(v_ms.data, 0, int(v_ms.len)-1))
  c_free(v_ms.data)
  vx_ret

proc objectForName*(self: gen_qqmlcontext_types.QQmlContext, param1: string): QObject =
  QObject(h: fcQQmlContext_objectForName(self.h, struct_miqt_string(data: param1, len: csize_t(len(param1)))))

proc resolvedUrl*(self: gen_qqmlcontext_types.QQmlContext, param1: QUrl): QUrl =
  QUrl(h: fcQQmlContext_resolvedUrl(self.h, param1.h))

proc setBaseUrl*(self: gen_qqmlcontext_types.QQmlContext, baseUrl: QUrl): void =
  fcQQmlContext_setBaseUrl(self.h, baseUrl.h)

proc baseUrl*(self: gen_qqmlcontext_types.QQmlContext, ): QUrl =
  QUrl(h: fcQQmlContext_baseUrl(self.h))

proc importedScript*(self: gen_qqmlcontext_types.QQmlContext, name: string): QJSValue =
  QJSValue(h: fcQQmlContext_importedScript(self.h, struct_miqt_string(data: name, len: csize_t(len(name)))))
...
proc miqt_exec_callback_QQmlContext_metacall(self: ptr cQQmlContext, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QQmlContext_metacall ".} =
  ...
  virtualReturn
proc QQmlContextevent*(self: gen_qqmlcontext_types.QQmlContext, event: QEvent): bool =
  fQQmlContext_virtualbase_event(self.h, event.h)

type QQmlContexteventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QQmlContext_event(self: ptr cQQmlContext, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QQmlContext_event ".} =
  ...
  virtualReturn
proc QQmlContexteventFilter*(self: gen_qqmlcontext_types.QQmlContext, watched: QObject, event: QEvent): bool =
  fQQmlContext_virtualbase_eventFilter(self.h, watched.h, event.h)

type QQmlContexteventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QQmlContext_eventFilter(self: ptr cQQmlContext, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QQmlContext_eventFilter ".} =
  ...
  virtualReturn
proc QQmlContexttimerEvent*(self: gen_qqmlcontext_types.QQmlContext, event: QTimerEvent): void =
  fQQmlContext_virtualbase_timerEvent(self.h, event.h)

type QQmlContexttimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QQmlContext_timerEvent(self: ptr cQQmlContext, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QQmlContext_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QQmlContextchildEvent*(self: gen_qqmlcontext_types.QQmlContext, event: QChildEvent): void =
  fQQmlContext_virtualbase_childEvent(self.h, event.h)

type QQmlContextchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QQmlContext_childEvent(self: ptr cQQmlContext, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QQmlContext_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QQmlContextcustomEvent*(self: gen_qqmlcontext_types.QQmlContext, event: QEvent): void =
  fQQmlContext_virtualbase_customEvent(self.h, event.h)

type QQmlContextcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QQmlContext_customEvent(self: ptr cQQmlContext, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QQmlContext_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QQmlContextconnectNotify*(self: gen_qqmlcontext_types.QQmlContext, signal: QMetaMethod): void =
  fQQmlContext_virtualbase_connectNotify(self.h, signal.h)

type QQmlContextconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QQmlContext_connectNotify(self: ptr cQQmlContext, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QQmlContext_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QQmlContextdisconnectNotify*(self: gen_qqmlcontext_types.QQmlContext, signal: QMetaMethod): void =
  fQQmlContext_virtualbase_disconnectNotify(self.h, signal.h)

type QQmlContextdisconnectNotifyProc* = proc(signal: QMetaMethod): void
...
func init*(T: type gen_qqmlcontext_types.QQmlContextPropertyPair, h: ptr cQQmlContextPropertyPair): gen_qqmlcontext_types.QQmlContextPropertyPair =
  T(h: h)
proc create*(T: type gen_qqmlcontext_types.QQmlContextPropertyPair, param1: QQmlContextPropertyPair): gen_qqmlcontext_types.QQmlContextPropertyPair =
  gen_qqmlcontext_types.QQmlContextPropertyPair.init(fcQQmlContextPropertyPair_new(param1.h))

proc operatorAssign*(self: gen_qqmlcontext_types.QQmlContextPropertyPair, param1: QQmlContextPropertyPair): void =
