...
proc create*(T: type gen_qqmlscriptstring_types.QQmlScriptString, param1: QQmlScriptString): gen_qqmlscriptstring_types.QQmlScriptString =
  gen_qqmlscriptstring_types.QQmlScriptString.init(fcQQmlScriptString_new2(param1.h))

proc operatorAssign*(self: gen_qqmlscriptstring_types.QQmlScriptString, param1: QQmlScriptString): void =
  fcQQmlScriptString_operatorAssign(self.h, param1.h)

proc operatorEqual*(self: gen_qqmlscriptstring_types.QQmlScriptString, param1: QQmlScriptString): bool =
  fcQQmlScriptString_operatorEqual(self.h, param1.h)

proc operatorNotEqual*(self: gen_qqmlscriptstring_types.QQmlScriptString, param1: QQmlScriptString): bool =
