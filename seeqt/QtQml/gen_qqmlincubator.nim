...
proc errors*(self: gen_qqmlincubator_types.QQmlIncubator, ): seq[QQmlError] =
...
proc objectX*(self: gen_qqmlincubator_types.QQmlIncubator, ): QObject =
  QObject(h: fcQQmlIncubator_objectX(self.h))

proc setInitialProperties*(self: gen_qqmlincubator_types.QQmlIncubator, initialProperties: Table[string,QVariant]): void =
...
proc miqt_exec_callback_QQmlIncubator_statusChanged(self: ptr cQQmlIncubator, slot: int, param1: cint): void {.exportc: "miqt_exec_callback_QQmlIncubator_statusChanged ".} =
  ...
  nimfunc[](slotval1)
proc QQmlIncubatorsetInitialState*(self: gen_qqmlincubator_types.QQmlIncubator, initialState: QObject): void =
  fQQmlIncubator_virtualbase_setInitialState(self.h, initialState.h)

type QQmlIncubatorsetInitialStateProc* = proc(initialState: QObject): void
...
proc miqt_exec_callback_QQmlIncubator_setInitialState(self: ptr cQQmlIncubator, slot: int, initialState: pointer): void {.exportc: "miqt_exec_callback_QQmlIncubator_setInitialState ".} =
  ...
  let slotval1 = QObject(h: initialState)
...
proc engine*(self: gen_qqmlincubator_types.QQmlIncubationController, ): QQmlEngine =
  QQmlEngine(h: fcQQmlIncubationController_engine(self.h))
