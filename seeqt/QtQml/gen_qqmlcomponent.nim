...
const cflags = gorge("pkg-config --cflags Qt6Qml")
...
proc create*(T: type gen_qqmlcomponent_types.QQmlComponent, param1: QQmlEngine): gen_qqmlcomponent_types.QQmlComponent =
  gen_qqmlcomponent_types.QQmlComponent.init(fcQQmlComponent_new2(param1.h))

proc create*(T: type gen_qqmlcomponent_types.QQmlComponent, param1: QQmlEngine, fileName: string): gen_qqmlcomponent_types.QQmlComponent =
...
proc create*(T: type gen_qqmlcomponent_types.QQmlComponent, param1: QQmlEngine, fileName: string, mode: cint): gen_qqmlcomponent_types.QQmlComponent =
...
proc create*(T: type gen_qqmlcomponent_types.QQmlComponent, param1: QQmlEngine, url: QUrl): gen_qqmlcomponent_types.QQmlComponent =
  gen_qqmlcomponent_types.QQmlComponent.init(fcQQmlComponent_new5(param1.h, url.h))

proc create*(T: type gen_qqmlcomponent_types.QQmlComponent, param1: QQmlEngine, url: QUrl, mode: cint): gen_qqmlcomponent_types.QQmlComponent =
  gen_qqmlcomponent_types.QQmlComponent.init(fcQQmlComponent_new6(param1.h, url.h, cint(mode)))

proc create*(T: type gen_qqmlcomponent_types.QQmlComponent, parent: QObject): gen_qqmlcomponent_types.QQmlComponent =
  gen_qqmlcomponent_types.QQmlComponent.init(fcQQmlComponent_new7(parent.h))

proc create*(T: type gen_qqmlcomponent_types.QQmlComponent, param1: QQmlEngine, parent: QObject): gen_qqmlcomponent_types.QQmlComponent =
  gen_qqmlcomponent_types.QQmlComponent.init(fcQQmlComponent_new8(param1.h, parent.h))

proc create*(T: type gen_qqmlcomponent_types.QQmlComponent, param1: QQmlEngine, fileName: string, parent: QObject): gen_qqmlcomponent_types.QQmlComponent =
...
proc create*(T: type gen_qqmlcomponent_types.QQmlComponent, param1: QQmlEngine, fileName: string, mode: cint, parent: QObject): gen_qqmlcomponent_types.QQmlComponent =
...
proc create*(T: type gen_qqmlcomponent_types.QQmlComponent, param1: QQmlEngine, url: QUrl, parent: QObject): gen_qqmlcomponent_types.QQmlComponent =
  gen_qqmlcomponent_types.QQmlComponent.init(fcQQmlComponent_new11(param1.h, url.h, parent.h))

proc create*(T: type gen_qqmlcomponent_types.QQmlComponent, param1: QQmlEngine, url: QUrl, mode: cint, parent: QObject): gen_qqmlcomponent_types.QQmlComponent =
  gen_qqmlcomponent_types.QQmlComponent.init(fcQQmlComponent_new12(param1.h, url.h, cint(mode), parent.h))

proc metaObject*(self: gen_qqmlcomponent_types.QQmlComponent, ): QMetaObject =
  QMetaObject(h: fcQQmlComponent_metaObject(self.h))
...
proc errors*(self: gen_qqmlcomponent_types.QQmlComponent, ): seq[QQmlError] =
...
proc url*(self: gen_qqmlcomponent_types.QQmlComponent, ): QUrl =
  QUrl(h: fcQQmlComponent_url(self.h))

proc create*(self: gen_qqmlcomponent_types.QQmlComponent, context: QQmlContext): QObject =
  QObject(h: fcQQmlComponent_create(self.h, context.h))

proc createWithInitialProperties*(self: gen_qqmlcomponent_types.QQmlComponent, initialProperties: Table[string,QVariant]): QObject =
  ...
  QObject(h: fcQQmlComponent_createWithInitialProperties(self.h, struct_miqt_map(len: csize_t(len(initialProperties)),keys: if len(initialProperties) == 0: nil else: addr(initialProperties_Keys_CArray[0]), values: if len(initialProperties) == 0: nil else: addr(initialProperties_Values_CArray[0]),)))

proc setInitialProperties*(self: gen_qqmlcomponent_types.QQmlComponent, component: QObject, properties: Table[string,QVariant]): void =
...
proc beginCreate*(self: gen_qqmlcomponent_types.QQmlComponent, param1: QQmlContext): QObject =
  QObject(h: fcQQmlComponent_beginCreate(self.h, param1.h))

proc completeCreate*(self: gen_qqmlcomponent_types.QQmlComponent, ): void =
  fcQQmlComponent_completeCreate(self.h)

proc create*(self: gen_qqmlcomponent_types.QQmlComponent, param1: QQmlIncubator): void =
  fcQQmlComponent_createWithQQmlIncubator(self.h, param1.h)

proc creationContext*(self: gen_qqmlcomponent_types.QQmlComponent, ): QQmlContext =
  QQmlContext(h: fcQQmlComponent_creationContext(self.h))

proc engine*(self: gen_qqmlcomponent_types.QQmlComponent, ): QQmlEngine =
  QQmlEngine(h: fcQQmlComponent_engine(self.h))

proc loadUrl*(self: gen_qqmlcomponent_types.QQmlComponent, url: QUrl): void =
  fcQQmlComponent_loadUrl(self.h, url.h)

proc loadUrl*(self: gen_qqmlcomponent_types.QQmlComponent, url: QUrl, mode: cint): void =
  fcQQmlComponent_loadUrl2(self.h, url.h, cint(mode))

proc setData*(self: gen_qqmlcomponent_types.QQmlComponent, param1: seq[byte], baseUrl: QUrl): void =
...
proc createWithInitialProperties*(self: gen_qqmlcomponent_types.QQmlComponent, initialProperties: Table[string,QVariant], context: QQmlContext): QObject =
  var initialProperties_Keys_CArray = newSeq[struct_miqt_string](len(initialProperties))
  var initialProperties_Values_CArray = newSeq[pointer](len(initialProperties))
  var initialProperties_ctr = 0
  for initialPropertiesk, initialPropertiesv in initialProperties:
  ...
  QObject(h: fcQQmlComponent_createWithInitialProperties2(self.h, struct_miqt_map(len: csize_t(len(initialProperties)),keys: if len(initialProperties) == 0: nil else: addr(initialProperties_Keys_CArray[0]), values: if len(initialProperties) == 0: nil else: addr(initialProperties_Values_CArray[0]),), context.h))

proc create*(self: gen_qqmlcomponent_types.QQmlComponent, param1: QQmlIncubator, context: QQmlContext): void =
  fcQQmlComponent_create2(self.h, param1.h, context.h)

proc create*(self: gen_qqmlcomponent_types.QQmlComponent, param1: QQmlIncubator, context: QQmlContext, forContext: QQmlContext): void =
...
proc miqt_exec_callback_QQmlComponent_metacall(self: ptr cQQmlComponent, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QQmlComponent_metacall ".} =
  ...
  virtualReturn
proc QQmlComponentcreate*(self: gen_qqmlcomponent_types.QQmlComponent, context: QQmlContext): QObject =
  QObject(h: fQQmlComponent_virtualbase_create(self.h, context.h))

type QQmlComponentcreateProc* = proc(context: QQmlContext): QObject
...
proc miqt_exec_callback_QQmlComponent_create(self: ptr cQQmlComponent, slot: int, context: pointer): pointer {.exportc: "miqt_exec_callback_QQmlComponent_create ".} =
  ...
  let slotval1 = QQmlContext(h: context)


  let virtualReturn = nimfunc[](slotval1 )

  virtualReturn.h
proc QQmlComponentbeginCreate*(self: gen_qqmlcomponent_types.QQmlComponent, param1: QQmlContext): QObject =
  QObject(h: fQQmlComponent_virtualbase_beginCreate(self.h, param1.h))

type QQmlComponentbeginCreateProc* = proc(param1: QQmlContext): QObject
...
proc miqt_exec_callback_QQmlComponent_beginCreate(self: ptr cQQmlComponent, slot: int, param1: pointer): pointer {.exportc: "miqt_exec_callback_QQmlComponent_beginCreate ".} =
  ...
  let slotval1 = QQmlContext(h: param1)
...
proc miqt_exec_callback_QQmlComponent_completeCreate(self: ptr cQQmlComponent, slot: int): void {.exportc: "miqt_exec_callback_QQmlComponent_completeCreate ".} =
  ...
  nimfunc[]()
proc QQmlComponentevent*(self: gen_qqmlcomponent_types.QQmlComponent, event: QEvent): bool =
  fQQmlComponent_virtualbase_event(self.h, event.h)

type QQmlComponenteventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QQmlComponent_event(self: ptr cQQmlComponent, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QQmlComponent_event ".} =
  ...
  virtualReturn
proc QQmlComponenteventFilter*(self: gen_qqmlcomponent_types.QQmlComponent, watched: QObject, event: QEvent): bool =
  fQQmlComponent_virtualbase_eventFilter(self.h, watched.h, event.h)

type QQmlComponenteventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QQmlComponent_eventFilter(self: ptr cQQmlComponent, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QQmlComponent_eventFilter ".} =
  ...
  virtualReturn
proc QQmlComponenttimerEvent*(self: gen_qqmlcomponent_types.QQmlComponent, event: QTimerEvent): void =
  fQQmlComponent_virtualbase_timerEvent(self.h, event.h)

type QQmlComponenttimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QQmlComponent_timerEvent(self: ptr cQQmlComponent, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QQmlComponent_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QQmlComponentchildEvent*(self: gen_qqmlcomponent_types.QQmlComponent, event: QChildEvent): void =
  fQQmlComponent_virtualbase_childEvent(self.h, event.h)

type QQmlComponentchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QQmlComponent_childEvent(self: ptr cQQmlComponent, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QQmlComponent_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QQmlComponentcustomEvent*(self: gen_qqmlcomponent_types.QQmlComponent, event: QEvent): void =
  fQQmlComponent_virtualbase_customEvent(self.h, event.h)

type QQmlComponentcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QQmlComponent_customEvent(self: ptr cQQmlComponent, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QQmlComponent_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QQmlComponentconnectNotify*(self: gen_qqmlcomponent_types.QQmlComponent, signal: QMetaMethod): void =
  fQQmlComponent_virtualbase_connectNotify(self.h, signal.h)

type QQmlComponentconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QQmlComponent_connectNotify(self: ptr cQQmlComponent, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QQmlComponent_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QQmlComponentdisconnectNotify*(self: gen_qqmlcomponent_types.QQmlComponent, signal: QMetaMethod): void =
  fQQmlComponent_virtualbase_disconnectNotify(self.h, signal.h)

type QQmlComponentdisconnectNotifyProc* = proc(signal: QMetaMethod): void
