...
proc create*(T: type gen_qqmlpropertymap_types.QQmlPropertyMap, parent: QObject): gen_qqmlpropertymap_types.QQmlPropertyMap =
  gen_qqmlpropertymap_types.QQmlPropertyMap.init(fcQQmlPropertyMap_new2(parent.h))

proc metaObject*(self: gen_qqmlpropertymap_types.QQmlPropertyMap, ): QMetaObject =
  QMetaObject(h: fcQQmlPropertyMap_metaObject(self.h))
...
proc value*(self: gen_qqmlpropertymap_types.QQmlPropertyMap, key: string): QVariant =
  QVariant(h: fcQQmlPropertyMap_value(self.h, struct_miqt_string(data: key, len: csize_t(len(key)))))

proc insert*(self: gen_qqmlpropertymap_types.QQmlPropertyMap, key: string, value: QVariant): void =
  fcQQmlPropertyMap_insert(self.h, struct_miqt_string(data: key, len: csize_t(len(key))), value.h)

proc insert*(self: gen_qqmlpropertymap_types.QQmlPropertyMap, values: Table[string,QVariant]): void =
...
proc operatorSubscript*(self: gen_qqmlpropertymap_types.QQmlPropertyMap, key: string): QVariant =
  QVariant(h: fcQQmlPropertyMap_operatorSubscript(self.h, struct_miqt_string(data: key, len: csize_t(len(key)))))

proc operatorSubscript2*(self: gen_qqmlpropertymap_types.QQmlPropertyMap, key: string): QVariant =
  QVariant(h: fcQQmlPropertyMap_operatorSubscriptWithKey(self.h, struct_miqt_string(data: key, len: csize_t(len(key)))))

proc valueChanged*(self: gen_qqmlpropertymap_types.QQmlPropertyMap, key: string, value: QVariant): void =
  fcQQmlPropertyMap_valueChanged(self.h, struct_miqt_string(data: key, len: csize_t(len(key))), value.h)

type QQmlPropertyMapvalueChangedSlot* = proc(key: string, value: QVariant)
...
proc miqt_exec_callback_QQmlPropertyMap_metacall(self: ptr cQQmlPropertyMap, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QQmlPropertyMap_metacall ".} =
  ...
  virtualReturn
proc QQmlPropertyMapupdateValue*(self: gen_qqmlpropertymap_types.QQmlPropertyMap, key: string, input: QVariant): QVariant =
  QVariant(h: fQQmlPropertyMap_virtualbase_updateValue(self.h, struct_miqt_string(data: key, len: csize_t(len(key))), input.h))

type QQmlPropertyMapupdateValueProc* = proc(key: string, input: QVariant): QVariant
...
proc miqt_exec_callback_QQmlPropertyMap_updateValue(self: ptr cQQmlPropertyMap, slot: int, key: struct_miqt_string, input: pointer): pointer {.exportc: "miqt_exec_callback_QQmlPropertyMap_updateValue ".} =
  ...
  let slotval2 = QVariant(h: input)


  let virtualReturn = nimfunc[](slotval1, slotval2 )

  virtualReturn.h
proc QQmlPropertyMapevent*(self: gen_qqmlpropertymap_types.QQmlPropertyMap, event: QEvent): bool =
  fQQmlPropertyMap_virtualbase_event(self.h, event.h)

type QQmlPropertyMapeventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QQmlPropertyMap_event(self: ptr cQQmlPropertyMap, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QQmlPropertyMap_event ".} =
  ...
  virtualReturn
proc QQmlPropertyMapeventFilter*(self: gen_qqmlpropertymap_types.QQmlPropertyMap, watched: QObject, event: QEvent): bool =
  fQQmlPropertyMap_virtualbase_eventFilter(self.h, watched.h, event.h)

type QQmlPropertyMapeventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QQmlPropertyMap_eventFilter(self: ptr cQQmlPropertyMap, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QQmlPropertyMap_eventFilter ".} =
  ...
  virtualReturn
proc QQmlPropertyMaptimerEvent*(self: gen_qqmlpropertymap_types.QQmlPropertyMap, event: QTimerEvent): void =
  fQQmlPropertyMap_virtualbase_timerEvent(self.h, event.h)

type QQmlPropertyMaptimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QQmlPropertyMap_timerEvent(self: ptr cQQmlPropertyMap, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QQmlPropertyMap_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QQmlPropertyMapchildEvent*(self: gen_qqmlpropertymap_types.QQmlPropertyMap, event: QChildEvent): void =
  fQQmlPropertyMap_virtualbase_childEvent(self.h, event.h)

type QQmlPropertyMapchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QQmlPropertyMap_childEvent(self: ptr cQQmlPropertyMap, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QQmlPropertyMap_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QQmlPropertyMapcustomEvent*(self: gen_qqmlpropertymap_types.QQmlPropertyMap, event: QEvent): void =
  fQQmlPropertyMap_virtualbase_customEvent(self.h, event.h)

type QQmlPropertyMapcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QQmlPropertyMap_customEvent(self: ptr cQQmlPropertyMap, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QQmlPropertyMap_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QQmlPropertyMapconnectNotify*(self: gen_qqmlpropertymap_types.QQmlPropertyMap, signal: QMetaMethod): void =
  fQQmlPropertyMap_virtualbase_connectNotify(self.h, signal.h)

type QQmlPropertyMapconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QQmlPropertyMap_connectNotify(self: ptr cQQmlPropertyMap, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QQmlPropertyMap_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QQmlPropertyMapdisconnectNotify*(self: gen_qqmlpropertymap_types.QQmlPropertyMap, signal: QMetaMethod): void =
  fQQmlPropertyMap_virtualbase_disconnectNotify(self.h, signal.h)

type QQmlPropertyMapdisconnectNotifyProc* = proc(signal: QMetaMethod): void
