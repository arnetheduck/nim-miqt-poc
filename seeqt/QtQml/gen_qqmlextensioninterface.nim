...
func init*(T: type gen_qqmlextensioninterface_types.QQmlTypesExtensionInterface, h: ptr cQQmlTypesExtensionInterface): gen_qqmlextensioninterface_types.QQmlTypesExtensionInterface =
  T(h: h)
proc create*(T: type gen_qqmlextensioninterface_types.QQmlTypesExtensionInterface, param1: QQmlTypesExtensionInterface): gen_qqmlextensioninterface_types.QQmlTypesExtensionInterface =
...
proc operatorAssign*(self: gen_qqmlextensioninterface_types.QQmlTypesExtensionInterface, param1: QQmlTypesExtensionInterface): void =
...
func init*(T: type gen_qqmlextensioninterface_types.QQmlExtensionInterface, h: ptr cQQmlExtensionInterface): gen_qqmlextensioninterface_types.QQmlExtensionInterface =
  T(h: h)
proc create*(T: type gen_qqmlextensioninterface_types.QQmlExtensionInterface, param1: QQmlExtensionInterface): gen_qqmlextensioninterface_types.QQmlExtensionInterface =
  gen_qqmlextensioninterface_types.QQmlExtensionInterface.init(fcQQmlExtensionInterface_new(param1.h))

proc initializeEngine*(self: gen_qqmlextensioninterface_types.QQmlExtensionInterface, engine: QQmlEngine, uri: cstring): void =
  fcQQmlExtensionInterface_initializeEngine(self.h, engine.h, uri)

proc operatorAssign*(self: gen_qqmlextensioninterface_types.QQmlExtensionInterface, param1: QQmlExtensionInterface): void =
  fcQQmlExtensionInterface_operatorAssign(self.h, param1.h)

type QQmlExtensionInterfaceinitializeEngineProc* = proc(engine: QQmlEngine, uri: cstring): void
...
func init*(T: type gen_qqmlextensioninterface_types.QQmlEngineExtensionInterface, h: ptr cQQmlEngineExtensionInterface): gen_qqmlextensioninterface_types.QQmlEngineExtensionInterface =
  T(h: h)
proc initializeEngine*(self: gen_qqmlextensioninterface_types.QQmlEngineExtensionInterface, engine: QQmlEngine, uri: cstring): void =
  fcQQmlEngineExtensionInterface_initializeEngine(self.h, engine.h, uri)

proc operatorAssign*(self: gen_qqmlextensioninterface_types.QQmlEngineExtensionInterface, param1: QQmlEngineExtensionInterface): void =
