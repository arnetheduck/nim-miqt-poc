...
public:
	...
	MiqtVirtualQQmlExtensionPlugin(struct QQmlExtensionPlugin_VTable* vtbl): QQmlExtensionPlugin(), vtbl(vtbl) {};
	MiqtVirtualQQmlExtensionPlugin(struct QQmlExtensionPlugin_VTable* vtbl, QObject* parent): QQmlExtensionPlugin(parent), vtbl(vtbl) {};

	virtual ~MiqtVirtualQQmlExtensionPlugin() override { if(vtbl->destructor) vtbl->destructor(vtbl, this); }
...
QQmlExtensionPlugin* QQmlExtensionPlugin_new(struct QQmlExtensionPlugin_VTable* vtbl) {
	return new MiqtVirtualQQmlExtensionPlugin(vtbl);
}

QQmlExtensionPlugin* QQmlExtensionPlugin_new2(struct QQmlExtensionPlugin_VTable* vtbl, QObject* parent) {
	return new MiqtVirtualQQmlExtensionPlugin(vtbl, parent);
}
...
QMetaObject* QQmlExtensionPlugin_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQQmlExtensionPlugin*)(self) )->QQmlExtensionPlugin::metaObject();

}

void* QQmlExtensionPlugin_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQQmlExtensionPlugin*)(self) )->QQmlExtensionPlugin::qt_metacast(param1);

}

int QQmlExtensionPlugin_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQQmlExtensionPlugin*)(self) )->QQmlExtensionPlugin::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
QObject* QQmlExtensionPlugin_protectedbase_sender(const void* self) {
	MiqtVirtualQQmlExtensionPlugin* self_cast = static_cast<MiqtVirtualQQmlExtensionPlugin*>( (QQmlExtensionPlugin*)(self) );
...
public:
	...
	MiqtVirtualQQmlEngineExtensionPlugin(struct QQmlEngineExtensionPlugin_VTable* vtbl): QQmlEngineExtensionPlugin(), vtbl(vtbl) {};
	MiqtVirtualQQmlEngineExtensionPlugin(struct QQmlEngineExtensionPlugin_VTable* vtbl, QObject* parent): QQmlEngineExtensionPlugin(parent), vtbl(vtbl) {};

	virtual ~MiqtVirtualQQmlEngineExtensionPlugin() override { if(vtbl->destructor) vtbl->destructor(vtbl, this); }
...
QMetaObject* QQmlEngineExtensionPlugin_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQQmlEngineExtensionPlugin*)(self) )->QQmlEngineExtensionPlugin::metaObject();

}

void* QQmlEngineExtensionPlugin_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQQmlEngineExtensionPlugin*)(self) )->QQmlEngineExtensionPlugin::qt_metacast(param1);

}

int QQmlEngineExtensionPlugin_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQQmlEngineExtensionPlugin*)(self) )->QQmlEngineExtensionPlugin::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
QObject* QQmlEngineExtensionPlugin_protectedbase_sender(const void* self) {
	MiqtVirtualQQmlEngineExtensionPlugin* self_cast = static_cast<MiqtVirtualQQmlEngineExtensionPlugin*>( (QQmlEngineExtensionPlugin*)(self) );
