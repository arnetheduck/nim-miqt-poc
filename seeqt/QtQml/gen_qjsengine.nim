...
proc create*(T: type gen_qjsengine_types.QJSEngine, parent: QObject): gen_qjsengine_types.QJSEngine =
  gen_qjsengine_types.QJSEngine.init(fcQJSEngine_new2(parent.h))

proc metaObject*(self: gen_qjsengine_types.QJSEngine, ): QMetaObject =
  QMetaObject(h: fcQJSEngine_metaObject(self.h))
...
proc globalObject*(self: gen_qjsengine_types.QJSEngine, ): QJSValue =
  QJSValue(h: fcQJSEngine_globalObject(self.h))

proc evaluate*(self: gen_qjsengine_types.QJSEngine, program: string): QJSValue =
  QJSValue(h: fcQJSEngine_evaluate(self.h, struct_miqt_string(data: program, len: csize_t(len(program)))))

proc importModule*(self: gen_qjsengine_types.QJSEngine, fileName: string): QJSValue =
  QJSValue(h: fcQJSEngine_importModule(self.h, struct_miqt_string(data: fileName, len: csize_t(len(fileName)))))

proc registerModule*(self: gen_qjsengine_types.QJSEngine, moduleName: string, value: QJSValue): bool =
  fcQJSEngine_registerModule(self.h, struct_miqt_string(data: moduleName, len: csize_t(len(moduleName))), value.h)

proc newObject*(self: gen_qjsengine_types.QJSEngine, ): QJSValue =
  QJSValue(h: fcQJSEngine_newObject(self.h))

proc newSymbol*(self: gen_qjsengine_types.QJSEngine, name: string): QJSValue =
  QJSValue(h: fcQJSEngine_newSymbol(self.h, struct_miqt_string(data: name, len: csize_t(len(name)))))

proc newArray*(self: gen_qjsengine_types.QJSEngine, ): QJSValue =
  QJSValue(h: fcQJSEngine_newArray(self.h))

proc newQObject*(self: gen_qjsengine_types.QJSEngine, objectVal: QObject): QJSValue =
  QJSValue(h: fcQJSEngine_newQObject(self.h, objectVal.h))

proc newQMetaObject*(self: gen_qjsengine_types.QJSEngine, metaObject: QMetaObject): QJSValue =
  QJSValue(h: fcQJSEngine_newQMetaObject(self.h, metaObject.h))

proc newErrorObject*(self: gen_qjsengine_types.QJSEngine, errorType: cint): QJSValue =
  QJSValue(h: fcQJSEngine_newErrorObject(self.h, cint(errorType)))

proc collectGarbage*(self: gen_qjsengine_types.QJSEngine, ): void =
  fcQJSEngine_collectGarbage(self.h)

proc setObjectOwnership*(_: type gen_qjsengine_types.QJSEngine, param1: QObject, param2: cint): void =
  fcQJSEngine_setObjectOwnership(param1.h, cint(param2))

proc objectOwnership*(_: type gen_qjsengine_types.QJSEngine, param1: QObject): cint =
...
proc throwError*(self: gen_qjsengine_types.QJSEngine, error: QJSValue): void =
...
proc catchError*(self: gen_qjsengine_types.QJSEngine, ): QJSValue =
  QJSValue(h: fcQJSEngine_catchError(self.h))
...
proc evaluate*(self: gen_qjsengine_types.QJSEngine, program: string, fileName: string): QJSValue =
  QJSValue(h: fcQJSEngine_evaluate2(self.h, struct_miqt_string(data: program, len: csize_t(len(program))), struct_miqt_string(data: fileName, len: csize_t(len(fileName)))))

proc evaluate*(self: gen_qjsengine_types.QJSEngine, program: string, fileName: string, lineNumber: cint): QJSValue =
  QJSValue(h: fcQJSEngine_evaluate3(self.h, struct_miqt_string(data: program, len: csize_t(len(program))), struct_miqt_string(data: fileName, len: csize_t(len(fileName))), lineNumber))

proc evaluate*(self: gen_qjsengine_types.QJSEngine, program: string, fileName: string, lineNumber: cint, exceptionStackTrace: seq[string]): QJSValue =
  ...
  QJSValue(h: fcQJSEngine_evaluate4(self.h, struct_miqt_string(data: program, len: csize_t(len(program))), struct_miqt_string(data: fileName, len: csize_t(len(fileName))), lineNumber, struct_miqt_array(len: csize_t(len(exceptionStackTrace)), data: if len(exceptionStackTrace) == 0: nil else: addr(exceptionStackTrace_CArray[0]))))

proc newArray*(self: gen_qjsengine_types.QJSEngine, length: cuint): QJSValue =
  QJSValue(h: fcQJSEngine_newArray1(self.h, length))

proc newErrorObject*(self: gen_qjsengine_types.QJSEngine, errorType: cint, message: string): QJSValue =
  QJSValue(h: fcQJSEngine_newErrorObject2(self.h, cint(errorType), struct_miqt_string(data: message, len: csize_t(len(message)))))

proc installExtensions*(self: gen_qjsengine_types.QJSEngine, extensions: cint, objectVal: QJSValue): void =
...
proc miqt_exec_callback_QJSEngine_metacall(self: ptr cQJSEngine, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QJSEngine_metacall ".} =
  ...
  virtualReturn
proc QJSEngineevent*(self: gen_qjsengine_types.QJSEngine, event: QEvent): bool =
  fQJSEngine_virtualbase_event(self.h, event.h)

type QJSEngineeventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QJSEngine_event(self: ptr cQJSEngine, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QJSEngine_event ".} =
  ...
  virtualReturn
proc QJSEngineeventFilter*(self: gen_qjsengine_types.QJSEngine, watched: QObject, event: QEvent): bool =
  fQJSEngine_virtualbase_eventFilter(self.h, watched.h, event.h)

type QJSEngineeventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QJSEngine_eventFilter(self: ptr cQJSEngine, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QJSEngine_eventFilter ".} =
  ...
  virtualReturn
proc QJSEnginetimerEvent*(self: gen_qjsengine_types.QJSEngine, event: QTimerEvent): void =
  fQJSEngine_virtualbase_timerEvent(self.h, event.h)

type QJSEnginetimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QJSEngine_timerEvent(self: ptr cQJSEngine, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QJSEngine_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QJSEnginechildEvent*(self: gen_qjsengine_types.QJSEngine, event: QChildEvent): void =
  fQJSEngine_virtualbase_childEvent(self.h, event.h)

type QJSEnginechildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QJSEngine_childEvent(self: ptr cQJSEngine, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QJSEngine_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QJSEnginecustomEvent*(self: gen_qjsengine_types.QJSEngine, event: QEvent): void =
  fQJSEngine_virtualbase_customEvent(self.h, event.h)

type QJSEnginecustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QJSEngine_customEvent(self: ptr cQJSEngine, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QJSEngine_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QJSEngineconnectNotify*(self: gen_qjsengine_types.QJSEngine, signal: QMetaMethod): void =
  fQJSEngine_virtualbase_connectNotify(self.h, signal.h)

type QJSEngineconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QJSEngine_connectNotify(self: ptr cQJSEngine, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QJSEngine_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QJSEnginedisconnectNotify*(self: gen_qjsengine_types.QJSEngine, signal: QMetaMethod): void =
  fQJSEngine_virtualbase_disconnectNotify(self.h, signal.h)

type QJSEnginedisconnectNotifyProc* = proc(signal: QMetaMethod): void
