...
proc create*(T: type gen_qqmlfile_types.QQmlFile, param1: QQmlEngine, param2: QUrl): gen_qqmlfile_types.QQmlFile =
  gen_qqmlfile_types.QQmlFile.init(fcQQmlFile_new2(param1.h, param2.h))

proc create*(T: type gen_qqmlfile_types.QQmlFile, param1: QQmlEngine, param2: string): gen_qqmlfile_types.QQmlFile =
...
proc url*(self: gen_qqmlfile_types.QQmlFile, ): QUrl =
  QUrl(h: fcQQmlFile_url(self.h))
...
proc load*(self: gen_qqmlfile_types.QQmlFile, param1: QQmlEngine, param2: QUrl): void =
  fcQQmlFile_load(self.h, param1.h, param2.h)

proc load*(self: gen_qqmlfile_types.QQmlFile, param1: QQmlEngine, param2: string): void =
...
proc clear*(self: gen_qqmlfile_types.QQmlFile, param1: QObject): void =
  fcQQmlFile_clearWithQObject(self.h, param1.h)

proc connectFinished*(self: gen_qqmlfile_types.QQmlFile, param1: QObject, param2: cstring): bool =
  fcQQmlFile_connectFinished(self.h, param1.h, param2)

proc connectFinished*(self: gen_qqmlfile_types.QQmlFile, param1: QObject, param2: cint): bool =
  fcQQmlFile_connectFinished2(self.h, param1.h, param2)

proc connectDownloadProgress*(self: gen_qqmlfile_types.QQmlFile, param1: QObject, param2: cstring): bool =
  fcQQmlFile_connectDownloadProgress(self.h, param1.h, param2)

proc connectDownloadProgress*(self: gen_qqmlfile_types.QQmlFile, param1: QObject, param2: cint): bool =
...
proc isSynchronous*(_: type gen_qqmlfile_types.QQmlFile, url: QUrl): bool =
...
proc isLocalFile*(_: type gen_qqmlfile_types.QQmlFile, url: QUrl): bool =
...
proc urlToLocalFileOrQrc*(_: type gen_qqmlfile_types.QQmlFile, param1: QUrl): string =
