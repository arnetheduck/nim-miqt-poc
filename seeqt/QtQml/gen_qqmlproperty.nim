...
proc fcQQmlProperty_swap(self: pointer, other: pointer): void {.importc: "QQmlProperty_swap".}
...
proc fcQQmlProperty_propertyMetaType(self: pointer, ): pointer {.importc: "QQmlProperty_propertyMetaType".}
...
proc fcQQmlProperty_isBindable(self: pointer, ): bool {.importc: "QQmlProperty_isBindable".}
...
proc create*(T: type gen_qqmlproperty_types.QQmlProperty, param1: QObject): gen_qqmlproperty_types.QQmlProperty =
  gen_qqmlproperty_types.QQmlProperty.init(fcQQmlProperty_new2(param1.h))

proc create*(T: type gen_qqmlproperty_types.QQmlProperty, param1: QObject, param2: QQmlContext): gen_qqmlproperty_types.QQmlProperty =
  gen_qqmlproperty_types.QQmlProperty.init(fcQQmlProperty_new3(param1.h, param2.h))

proc create*(T: type gen_qqmlproperty_types.QQmlProperty, param1: QObject, param2: QQmlEngine): gen_qqmlproperty_types.QQmlProperty =
  gen_qqmlproperty_types.QQmlProperty.init(fcQQmlProperty_new4(param1.h, param2.h))

proc create*(T: type gen_qqmlproperty_types.QQmlProperty, param1: QObject, param2: string): gen_qqmlproperty_types.QQmlProperty =
...
proc create*(T: type gen_qqmlproperty_types.QQmlProperty, param1: QObject, param2: string, param3: QQmlContext): gen_qqmlproperty_types.QQmlProperty =
...
proc create*(T: type gen_qqmlproperty_types.QQmlProperty, param1: QObject, param2: string, param3: QQmlEngine): gen_qqmlproperty_types.QQmlProperty =
...
proc create*(T: type gen_qqmlproperty_types.QQmlProperty, param1: QQmlProperty): gen_qqmlproperty_types.QQmlProperty =
  gen_qqmlproperty_types.QQmlProperty.init(fcQQmlProperty_new8(param1.h))

proc operatorAssign*(self: gen_qqmlproperty_types.QQmlProperty, param1: QQmlProperty): void =
  fcQQmlProperty_operatorAssign(self.h, param1.h)

proc swap*(self: gen_qqmlproperty_types.QQmlProperty, other: QQmlProperty): void =
  fcQQmlProperty_swap(self.h, other.h)

proc operatorEqual*(self: gen_qqmlproperty_types.QQmlProperty, param1: QQmlProperty): bool =
...
proc propertyMetaType*(self: gen_qqmlproperty_types.QQmlProperty, ): QMetaType =
  QMetaType(h: fcQQmlProperty_propertyMetaType(self.h))
...
proc read*(self: gen_qqmlproperty_types.QQmlProperty, ): QVariant =
  QVariant(h: fcQQmlProperty_read(self.h))

proc read*(_: type gen_qqmlproperty_types.QQmlProperty, param1: QObject, param2: string): QVariant =
  QVariant(h: fcQQmlProperty_read2(param1.h, struct_miqt_string(data: param2, len: csize_t(len(param2)))))

proc read*(_: type gen_qqmlproperty_types.QQmlProperty, param1: QObject, param2: string, param3: QQmlContext): QVariant =
  QVariant(h: fcQQmlProperty_read3(param1.h, struct_miqt_string(data: param2, len: csize_t(len(param2))), param3.h))

proc read*(_: type gen_qqmlproperty_types.QQmlProperty, param1: QObject, param2: string, param3: QQmlEngine): QVariant =
  QVariant(h: fcQQmlProperty_read4(param1.h, struct_miqt_string(data: param2, len: csize_t(len(param2))), param3.h))

proc write*(self: gen_qqmlproperty_types.QQmlProperty, param1: QVariant): bool =
  fcQQmlProperty_write(self.h, param1.h)

proc write*(_: type gen_qqmlproperty_types.QQmlProperty, param1: QObject, param2: string, param3: QVariant): bool =
  fcQQmlProperty_write2(param1.h, struct_miqt_string(data: param2, len: csize_t(len(param2))), param3.h)

proc write*(_: type gen_qqmlproperty_types.QQmlProperty, param1: QObject, param2: string, param3: QVariant, param4: QQmlContext): bool =
  fcQQmlProperty_write3(param1.h, struct_miqt_string(data: param2, len: csize_t(len(param2))), param3.h, param4.h)

proc write*(_: type gen_qqmlproperty_types.QQmlProperty, param1: QObject, param2: string, param3: QVariant, param4: QQmlEngine): bool =
...
proc connectNotifySignal*(self: gen_qqmlproperty_types.QQmlProperty, dest: QObject, slot: cstring): bool =
  fcQQmlProperty_connectNotifySignal(self.h, dest.h, slot)

proc connectNotifySignal*(self: gen_qqmlproperty_types.QQmlProperty, dest: QObject, methodVal: cint): bool =
...
proc isBindable*(self: gen_qqmlproperty_types.QQmlProperty, ): bool =
  fcQQmlProperty_isBindable(self.h)
...
proc objectX*(self: gen_qqmlproperty_types.QQmlProperty, ): QObject =
  QObject(h: fcQQmlProperty_objectX(self.h))

proc index*(self: gen_qqmlproperty_types.QQmlProperty, ): cint =
  fcQQmlProperty_index(self.h)

proc property*(self: gen_qqmlproperty_types.QQmlProperty, ): QMetaProperty =
  QMetaProperty(h: fcQQmlProperty_property(self.h))

proc methodX*(self: gen_qqmlproperty_types.QQmlProperty, ): QMetaMethod =
  QMetaMethod(h: fcQQmlProperty_methodX(self.h))

proc staticMetaObject*(_: type gen_qqmlproperty_types.QQmlProperty): gen_qobjectdefs_types.QMetaObject =
  gen_qobjectdefs_types.QMetaObject(h: fcQQmlProperty_staticMetaObject())
