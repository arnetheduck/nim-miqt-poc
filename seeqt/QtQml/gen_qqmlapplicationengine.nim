...
proc fQQmlApplicationEngine_connect_objectCreationFailed(self: pointer, slot: int) {.importc: "QQmlApplicationEngine_connect_objectCreationFailed".}
...
proc create*(T: type gen_qqmlapplicationengine_types.QQmlApplicationEngine, url: QUrl): gen_qqmlapplicationengine_types.QQmlApplicationEngine =
...
proc create*(T: type gen_qqmlapplicationengine_types.QQmlApplicationEngine, parent: QObject): gen_qqmlapplicationengine_types.QQmlApplicationEngine =
  gen_qqmlapplicationengine_types.QQmlApplicationEngine.init(fcQQmlApplicationEngine_new4(parent.h))

proc create*(T: type gen_qqmlapplicationengine_types.QQmlApplicationEngine, url: QUrl, parent: QObject): gen_qqmlapplicationengine_types.QQmlApplicationEngine =
  gen_qqmlapplicationengine_types.QQmlApplicationEngine.init(fcQQmlApplicationEngine_new5(url.h, parent.h))

proc create*(T: type gen_qqmlapplicationengine_types.QQmlApplicationEngine, filePath: string, parent: QObject): gen_qqmlapplicationengine_types.QQmlApplicationEngine =
...
proc metaObject*(self: gen_qqmlapplicationengine_types.QQmlApplicationEngine, ): QMetaObject =
  QMetaObject(h: fcQQmlApplicationEngine_metaObject(self.h))
...
proc rootObjects*(self: gen_qqmlapplicationengine_types.QQmlApplicationEngine, ): seq[QObject] =
...
proc load*(self: gen_qqmlapplicationengine_types.QQmlApplicationEngine, url: QUrl): void =
...
proc setInitialProperties*(self: gen_qqmlapplicationengine_types.QQmlApplicationEngine, initialProperties: Table[string,QVariant]): void =
...
proc objectCreated*(self: gen_qqmlapplicationengine_types.QQmlApplicationEngine, objectVal: QObject, url: QUrl): void =
  fcQQmlApplicationEngine_objectCreated(self.h, objectVal.h, url.h)

type QQmlApplicationEngineobjectCreatedSlot* = proc(objectVal: QObject, url: QUrl)
...
proc objectCreationFailed*(self: gen_qqmlapplicationengine_types.QQmlApplicationEngine, url: QUrl): void =
  fcQQmlApplicationEngine_objectCreationFailed(self.h, url.h)

type QQmlApplicationEngineobjectCreationFailedSlot* = proc(url: QUrl)
proc miqt_exec_callback_QQmlApplicationEngine_objectCreationFailed(slot: int, url: pointer) {.exportc.} =
...
proc onobjectCreationFailed*(self: gen_qqmlapplicationengine_types.QQmlApplicationEngine, slot: QQmlApplicationEngineobjectCreationFailedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fQQmlApplicationEngine_connect_objectCreationFailed(self.h, cast[int](addr tmp[]))
...
proc loadData*(self: gen_qqmlapplicationengine_types.QQmlApplicationEngine, data: seq[byte], url: QUrl): void =
...
proc miqt_exec_callback_QQmlApplicationEngine_metacall(self: ptr cQQmlApplicationEngine, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QQmlApplicationEngine_metacall ".} =
  ...
  virtualReturn
proc QQmlApplicationEngineevent*(self: gen_qqmlapplicationengine_types.QQmlApplicationEngine, param1: QEvent): bool =
  fQQmlApplicationEngine_virtualbase_event(self.h, param1.h)

type QQmlApplicationEngineeventProc* = proc(param1: QEvent): bool
...
proc miqt_exec_callback_QQmlApplicationEngine_event(self: ptr cQQmlApplicationEngine, slot: int, param1: pointer): bool {.exportc: "miqt_exec_callback_QQmlApplicationEngine_event ".} =
  ...
  virtualReturn
proc QQmlApplicationEngineeventFilter*(self: gen_qqmlapplicationengine_types.QQmlApplicationEngine, watched: QObject, event: QEvent): bool =
  fQQmlApplicationEngine_virtualbase_eventFilter(self.h, watched.h, event.h)

type QQmlApplicationEngineeventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QQmlApplicationEngine_eventFilter(self: ptr cQQmlApplicationEngine, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QQmlApplicationEngine_eventFilter ".} =
  ...
  virtualReturn
proc QQmlApplicationEnginetimerEvent*(self: gen_qqmlapplicationengine_types.QQmlApplicationEngine, event: QTimerEvent): void =
  fQQmlApplicationEngine_virtualbase_timerEvent(self.h, event.h)

type QQmlApplicationEnginetimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QQmlApplicationEngine_timerEvent(self: ptr cQQmlApplicationEngine, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QQmlApplicationEngine_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QQmlApplicationEnginechildEvent*(self: gen_qqmlapplicationengine_types.QQmlApplicationEngine, event: QChildEvent): void =
  fQQmlApplicationEngine_virtualbase_childEvent(self.h, event.h)

type QQmlApplicationEnginechildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QQmlApplicationEngine_childEvent(self: ptr cQQmlApplicationEngine, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QQmlApplicationEngine_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QQmlApplicationEnginecustomEvent*(self: gen_qqmlapplicationengine_types.QQmlApplicationEngine, event: QEvent): void =
  fQQmlApplicationEngine_virtualbase_customEvent(self.h, event.h)

type QQmlApplicationEnginecustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QQmlApplicationEngine_customEvent(self: ptr cQQmlApplicationEngine, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QQmlApplicationEngine_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QQmlApplicationEngineconnectNotify*(self: gen_qqmlapplicationengine_types.QQmlApplicationEngine, signal: QMetaMethod): void =
  fQQmlApplicationEngine_virtualbase_connectNotify(self.h, signal.h)

type QQmlApplicationEngineconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QQmlApplicationEngine_connectNotify(self: ptr cQQmlApplicationEngine, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QQmlApplicationEngine_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QQmlApplicationEnginedisconnectNotify*(self: gen_qqmlapplicationengine_types.QQmlApplicationEngine, signal: QMetaMethod): void =
  fQQmlApplicationEngine_virtualbase_disconnectNotify(self.h, signal.h)

type QQmlApplicationEnginedisconnectNotifyProc* = proc(signal: QMetaMethod): void
