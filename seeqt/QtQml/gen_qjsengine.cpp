...
void miqt_exec_callback_QJSEngine_uiLanguageChanged_release(intptr_t);
#ifdef __cplusplus
} /* extern C */
#endif
...
void QJSEngine_connect_uiLanguageChanged(QJSEngine* self, intptr_t slot) {
	struct caller {
		...
		~caller() { miqt_exec_callback_QJSEngine_uiLanguageChanged_release(slot); }
	};
	MiqtVirtualQJSEngine::connect(self, static_cast<void (QJSEngine::*)()>(&QJSEngine::uiLanguageChanged), self, caller{slot});
}
...
QMetaObject* QJSEngine_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQJSEngine*)(self) )->QJSEngine::metaObject();

}

void* QJSEngine_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQJSEngine*)(self) )->QJSEngine::qt_metacast(param1);

}

int QJSEngine_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQJSEngine*)(self) )->QJSEngine::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
QObject* QJSEngine_protectedbase_sender(const void* self) {
	MiqtVirtualQJSEngine* self_cast = static_cast<MiqtVirtualQJSEngine*>( (QJSEngine*)(self) );
