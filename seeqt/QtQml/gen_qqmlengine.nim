...
func init*(T: type gen_qqmlengine_types.QQmlImageProviderBase, h: ptr cQQmlImageProviderBase): gen_qqmlengine_types.QQmlImageProviderBase =
  T(h: h)
proc metaObject*(self: gen_qqmlengine_types.QQmlImageProviderBase, ): QMetaObject =
  QMetaObject(h: fcQQmlImageProviderBase_metaObject(self.h))
...
proc create*(T: type gen_qqmlengine_types.QQmlEngine, p: QObject): gen_qqmlengine_types.QQmlEngine =
  gen_qqmlengine_types.QQmlEngine.init(fcQQmlEngine_new2(p.h))

proc metaObject*(self: gen_qqmlengine_types.QQmlEngine, ): QMetaObject =
  QMetaObject(h: fcQQmlEngine_metaObject(self.h))
...
proc rootContext*(self: gen_qqmlengine_types.QQmlEngine, ): QQmlContext =
  QQmlContext(h: fcQQmlEngine_rootContext(self.h))
...
proc importPlugin*(self: gen_qqmlengine_types.QQmlEngine, filePath: string, uri: string, errors: seq[QQmlError]): bool =
...
proc setNetworkAccessManagerFactory*(self: gen_qqmlengine_types.QQmlEngine, networkAccessManagerFactory: QQmlNetworkAccessManagerFactory): void =
  fcQQmlEngine_setNetworkAccessManagerFactory(self.h, networkAccessManagerFactory.h)

proc networkAccessManagerFactory*(self: gen_qqmlengine_types.QQmlEngine, ): QQmlNetworkAccessManagerFactory =
  QQmlNetworkAccessManagerFactory(h: fcQQmlEngine_networkAccessManagerFactory(self.h))

proc networkAccessManager*(self: gen_qqmlengine_types.QQmlEngine, ): QNetworkAccessManager =
  QNetworkAccessManager(h: fcQQmlEngine_networkAccessManager(self.h))

proc setUrlInterceptor*(self: gen_qqmlengine_types.QQmlEngine, urlInterceptor: QQmlAbstractUrlInterceptor): void =
  fcQQmlEngine_setUrlInterceptor(self.h, urlInterceptor.h)

proc urlInterceptor*(self: gen_qqmlengine_types.QQmlEngine, ): QQmlAbstractUrlInterceptor =
  QQmlAbstractUrlInterceptor(h: fcQQmlEngine_urlInterceptor(self.h))

proc addUrlInterceptor*(self: gen_qqmlengine_types.QQmlEngine, urlInterceptor: QQmlAbstractUrlInterceptor): void =
  fcQQmlEngine_addUrlInterceptor(self.h, urlInterceptor.h)

proc removeUrlInterceptor*(self: gen_qqmlengine_types.QQmlEngine, urlInterceptor: QQmlAbstractUrlInterceptor): void =
  fcQQmlEngine_removeUrlInterceptor(self.h, urlInterceptor.h)

proc urlInterceptors*(self: gen_qqmlengine_types.QQmlEngine, ): seq[QQmlAbstractUrlInterceptor] =
  var v_ma = fcQQmlEngine_urlInterceptors(self.h)
  var vx_ret = newSeq[QQmlAbstractUrlInterceptor](int(v_ma.len))
  let v_outCast = cast[ptr UncheckedArray[pointer]](v_ma.data)
  for i in 0 ..< v_ma.len:
    vx_ret[i] = QQmlAbstractUrlInterceptor(h: v_outCast[i])
  vx_ret

proc interceptUrl*(self: gen_qqmlengine_types.QQmlEngine, url: QUrl, typeVal: cint): QUrl =
  QUrl(h: fcQQmlEngine_interceptUrl(self.h, url.h, cint(typeVal)))

proc addImageProvider*(self: gen_qqmlengine_types.QQmlEngine, id: string, param2: QQmlImageProviderBase): void =
  fcQQmlEngine_addImageProvider(self.h, struct_miqt_string(data: id, len: csize_t(len(id))), param2.h)

proc imageProvider*(self: gen_qqmlengine_types.QQmlEngine, id: string): QQmlImageProviderBase =
...
proc setIncubationController*(self: gen_qqmlengine_types.QQmlEngine, incubationController: QQmlIncubationController): void =
  fcQQmlEngine_setIncubationController(self.h, incubationController.h)

proc incubationController*(self: gen_qqmlengine_types.QQmlEngine, ): QQmlIncubationController =
  QQmlIncubationController(h: fcQQmlEngine_incubationController(self.h))
...
proc baseUrl*(self: gen_qqmlengine_types.QQmlEngine, ): QUrl =
  QUrl(h: fcQQmlEngine_baseUrl(self.h))

proc setBaseUrl*(self: gen_qqmlengine_types.QQmlEngine, baseUrl: QUrl): void =
...
proc captureProperty*(self: gen_qqmlengine_types.QQmlEngine, objectVal: QObject, property: QMetaProperty): void =
...
proc contextForObject*(_: type gen_qqmlengine_types.QQmlEngine, param1: QObject): QQmlContext =
  QQmlContext(h: fcQQmlEngine_contextForObject(param1.h))

proc setContextForObject*(_: type gen_qqmlengine_types.QQmlEngine, param1: QObject, param2: QQmlContext): void =
...
proc warnings*(self: gen_qqmlengine_types.QQmlEngine, warnings: seq[QQmlError]): void =
...
type QQmlEnginewarningsSlot* = proc(warnings: seq[QQmlError])
proc miqt_exec_callback_QQmlEngine_warnings(slot: int, warnings: struct_miqt_array) {.exportc.} =
  ...
  var vwarningsx_ret = newSeq[QQmlError](int(vwarnings_ma.len))
  let vwarnings_outCast = cast[ptr UncheckedArray[pointer]](vwarnings_ma.data)
  for i in 0 ..< vwarnings_ma.len:
    vwarningsx_ret[i] = QQmlError(h: vwarnings_outCast[i])
...
proc miqt_exec_callback_QQmlEngine_metacall(self: ptr cQQmlEngine, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QQmlEngine_metacall ".} =
  ...
  virtualReturn
proc QQmlEngineevent*(self: gen_qqmlengine_types.QQmlEngine, param1: QEvent): bool =
  fQQmlEngine_virtualbase_event(self.h, param1.h)

type QQmlEngineeventProc* = proc(param1: QEvent): bool
...
proc miqt_exec_callback_QQmlEngine_event(self: ptr cQQmlEngine, slot: int, param1: pointer): bool {.exportc: "miqt_exec_callback_QQmlEngine_event ".} =
  ...
  virtualReturn
proc QQmlEngineeventFilter*(self: gen_qqmlengine_types.QQmlEngine, watched: QObject, event: QEvent): bool =
  fQQmlEngine_virtualbase_eventFilter(self.h, watched.h, event.h)

type QQmlEngineeventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QQmlEngine_eventFilter(self: ptr cQQmlEngine, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QQmlEngine_eventFilter ".} =
  ...
  virtualReturn
proc QQmlEnginetimerEvent*(self: gen_qqmlengine_types.QQmlEngine, event: QTimerEvent): void =
  fQQmlEngine_virtualbase_timerEvent(self.h, event.h)

type QQmlEnginetimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QQmlEngine_timerEvent(self: ptr cQQmlEngine, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QQmlEngine_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QQmlEnginechildEvent*(self: gen_qqmlengine_types.QQmlEngine, event: QChildEvent): void =
  fQQmlEngine_virtualbase_childEvent(self.h, event.h)

type QQmlEnginechildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QQmlEngine_childEvent(self: ptr cQQmlEngine, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QQmlEngine_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QQmlEnginecustomEvent*(self: gen_qqmlengine_types.QQmlEngine, event: QEvent): void =
  fQQmlEngine_virtualbase_customEvent(self.h, event.h)

type QQmlEnginecustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QQmlEngine_customEvent(self: ptr cQQmlEngine, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QQmlEngine_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QQmlEngineconnectNotify*(self: gen_qqmlengine_types.QQmlEngine, signal: QMetaMethod): void =
  fQQmlEngine_virtualbase_connectNotify(self.h, signal.h)

type QQmlEngineconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QQmlEngine_connectNotify(self: ptr cQQmlEngine, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QQmlEngine_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QQmlEnginedisconnectNotify*(self: gen_qqmlengine_types.QQmlEngine, signal: QMetaMethod): void =
  fQQmlEngine_virtualbase_disconnectNotify(self.h, signal.h)

type QQmlEnginedisconnectNotifyProc* = proc(signal: QMetaMethod): void
