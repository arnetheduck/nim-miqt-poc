...
proc setObjectOwnership*(_: type gen_qqmlengine_types.QQmlEngine, param1: QObject, param2: cint): void =
  fcQQmlEngine_setObjectOwnership(param1.h, cint(param2))

proc objectOwnership*(_: type gen_qqmlengine_types.QQmlEngine, param1: QObject): cint =
