...
QMetaObject* QQmlContext_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQQmlContext*)(self) )->QQmlContext::metaObject();

}

void* QQmlContext_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQQmlContext*)(self) )->QQmlContext::qt_metacast(param1);

}

int QQmlContext_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQQmlContext*)(self) )->QQmlContext::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
