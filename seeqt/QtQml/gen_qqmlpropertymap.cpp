...
QMetaObject* QQmlPropertyMap_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQQmlPropertyMap*)(self) )->QQmlPropertyMap::metaObject();

}

void* QQmlPropertyMap_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQQmlPropertyMap*)(self) )->QQmlPropertyMap::qt_metacast(param1);

}

int QQmlPropertyMap_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQQmlPropertyMap*)(self) )->QQmlPropertyMap::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
