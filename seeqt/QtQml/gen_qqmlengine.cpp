...
void QQmlEngine_connect_quit(QQmlEngine* self, intptr_t slot, void (*callback)(intptr_t), void (*release)(intptr_t)) {
	...
	MiqtVirtualQQmlEngine::connect(self, static_cast<void (QQmlEngine::*)()>(&QQmlEngine::quit), self, caller{slot, callback, release});
}
...
void QQmlEngine_connect_exit(QQmlEngine* self, intptr_t slot, void (*callback)(intptr_t, int), void (*release)(intptr_t)) {
	...
	MiqtVirtualQQmlEngine::connect(self, static_cast<void (QQmlEngine::*)(int)>(&QQmlEngine::exit), self, caller{slot, callback, release});
}
...
void QQmlEngine_connect_warnings(QQmlEngine* self, intptr_t slot, void (*callback)(intptr_t, struct miqt_array /* of QQmlError* */ ), void (*release)(intptr_t)) {
	...
	MiqtVirtualQQmlEngine::connect(self, static_cast<void (QQmlEngine::*)(const QList<QQmlError>&)>(&QQmlEngine::warnings), self, caller{slot, callback, release});
}
...
QMetaObject* QQmlEngine_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQQmlEngine*)(self) )->QQmlEngine::metaObject();

}

void* QQmlEngine_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQQmlEngine*)(self) )->QQmlEngine::qt_metacast(param1);

}

int QQmlEngine_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQQmlEngine*)(self) )->QQmlEngine::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);

}

bool QQmlEngine_virtualbase_event(void* self, QEvent* param1) {

	return ( (MiqtVirtualQQmlEngine*)(self) )->QQmlEngine::event(param1);

}

bool QQmlEngine_virtualbase_eventFilter(void* self, QObject* watched, QEvent* event) {

	return ( (MiqtVirtualQQmlEngine*)(self) )->QQmlEngine::eventFilter(watched, event);

}

void QQmlEngine_virtualbase_timerEvent(void* self, QTimerEvent* event) {

	( (MiqtVirtualQQmlEngine*)(self) )->QQmlEngine::timerEvent(event);

}

void QQmlEngine_virtualbase_childEvent(void* self, QChildEvent* event) {

	( (MiqtVirtualQQmlEngine*)(self) )->QQmlEngine::childEvent(event);

}

void QQmlEngine_virtualbase_customEvent(void* self, QEvent* event) {

	( (MiqtVirtualQQmlEngine*)(self) )->QQmlEngine::customEvent(event);

}

void QQmlEngine_virtualbase_connectNotify(void* self, QMetaMethod* signal) {

	( (MiqtVirtualQQmlEngine*)(self) )->QQmlEngine::connectNotify(*signal);

}

void QQmlEngine_virtualbase_disconnectNotify(void* self, QMetaMethod* signal) {

	( (MiqtVirtualQQmlEngine*)(self) )->QQmlEngine::disconnectNotify(*signal);
