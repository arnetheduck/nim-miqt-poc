...
public:
	...
	MiqtVirtualQQmlComponent(struct QQmlComponent_VTable* vtbl): QQmlComponent(), vtbl(vtbl) {};
	MiqtVirtualQQmlComponent(struct QQmlComponent_VTable* vtbl, QQmlEngine* param1): QQmlComponent(param1), vtbl(vtbl) {};
	MiqtVirtualQQmlComponent(struct QQmlComponent_VTable* vtbl, QQmlEngine* param1, const QString& fileName): QQmlComponent(param1, fileName), vtbl(vtbl) {};
	MiqtVirtualQQmlComponent(struct QQmlComponent_VTable* vtbl, QQmlEngine* param1, const QString& fileName, QQmlComponent::CompilationMode mode): QQmlComponent(param1, fileName, mode), vtbl(vtbl) {};
	MiqtVirtualQQmlComponent(struct QQmlComponent_VTable* vtbl, QQmlEngine* param1, const QUrl& url): QQmlComponent(param1, url), vtbl(vtbl) {};
	MiqtVirtualQQmlComponent(struct QQmlComponent_VTable* vtbl, QQmlEngine* param1, const QUrl& url, QQmlComponent::CompilationMode mode): QQmlComponent(param1, url, mode), vtbl(vtbl) {};
	MiqtVirtualQQmlComponent(struct QQmlComponent_VTable* vtbl, QObject* parent): QQmlComponent(parent), vtbl(vtbl) {};
	MiqtVirtualQQmlComponent(struct QQmlComponent_VTable* vtbl, QQmlEngine* param1, QObject* parent): QQmlComponent(param1, parent), vtbl(vtbl) {};
	MiqtVirtualQQmlComponent(struct QQmlComponent_VTable* vtbl, QQmlEngine* param1, const QString& fileName, QObject* parent): QQmlComponent(param1, fileName, parent), vtbl(vtbl) {};
	MiqtVirtualQQmlComponent(struct QQmlComponent_VTable* vtbl, QQmlEngine* param1, const QString& fileName, QQmlComponent::CompilationMode mode, QObject* parent): QQmlComponent(param1, fileName, mode, parent), vtbl(vtbl) {};
	MiqtVirtualQQmlComponent(struct QQmlComponent_VTable* vtbl, QQmlEngine* param1, const QUrl& url, QObject* parent): QQmlComponent(param1, url, parent), vtbl(vtbl) {};
	MiqtVirtualQQmlComponent(struct QQmlComponent_VTable* vtbl, QQmlEngine* param1, const QUrl& url, QQmlComponent::CompilationMode mode, QObject* parent): QQmlComponent(param1, url, mode, parent), vtbl(vtbl) {};

	virtual ~MiqtVirtualQQmlComponent() override { if(vtbl->destructor) vtbl->destructor(vtbl, this); }
...
QQmlComponent* QQmlComponent_new(struct QQmlComponent_VTable* vtbl) {
	return new MiqtVirtualQQmlComponent(vtbl);
}

QQmlComponent* QQmlComponent_new2(struct QQmlComponent_VTable* vtbl, QQmlEngine* param1) {
	return new MiqtVirtualQQmlComponent(vtbl, param1);
}
...
QQmlComponent* QQmlComponent_new9(struct QQmlComponent_VTable* vtbl, QQmlEngine* param1, struct miqt_string fileName, QObject* parent) {
	QString fileName_QString = QString::fromUtf8(fileName.data, fileName.len);
	return new MiqtVirtualQQmlComponent(vtbl, param1, fileName_QString, parent);
}
...
QQmlComponent* QQmlComponent_new10(struct QQmlComponent_VTable* vtbl, QQmlEngine* param1, struct miqt_string fileName, int mode, QObject* parent) {
	QString fileName_QString = QString::fromUtf8(fileName.data, fileName.len);
	return new MiqtVirtualQQmlComponent(vtbl, param1, fileName_QString, static_cast<QQmlComponent::CompilationMode>(mode), parent);
}

QQmlComponent* QQmlComponent_new11(struct QQmlComponent_VTable* vtbl, QQmlEngine* param1, QUrl* url, QObject* parent) {
	return new MiqtVirtualQQmlComponent(vtbl, param1, *url, parent);
}

QQmlComponent* QQmlComponent_new12(struct QQmlComponent_VTable* vtbl, QQmlEngine* param1, QUrl* url, int mode, QObject* parent) {
	return new MiqtVirtualQQmlComponent(vtbl, param1, *url, static_cast<QQmlComponent::CompilationMode>(mode), parent);
}
...
void QQmlComponent_connect_statusChanged(QQmlComponent* self, intptr_t slot, void (*callback)(intptr_t, int), void (*release)(intptr_t)) {
	...
	MiqtVirtualQQmlComponent::connect(self, static_cast<void (QQmlComponent::*)(QQmlComponent::Status)>(&QQmlComponent::statusChanged), self, caller{slot, callback, release});
}
...
void QQmlComponent_connect_progressChanged(QQmlComponent* self, intptr_t slot, void (*callback)(intptr_t, double), void (*release)(intptr_t)) {
	...
	MiqtVirtualQQmlComponent::connect(self, static_cast<void (QQmlComponent::*)(qreal)>(&QQmlComponent::progressChanged), self, caller{slot, callback, release});
}
...
QMetaObject* QQmlComponent_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQQmlComponent*)(self) )->QQmlComponent::metaObject();

}

void* QQmlComponent_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQQmlComponent*)(self) )->QQmlComponent::qt_metacast(param1);

}

int QQmlComponent_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQQmlComponent*)(self) )->QQmlComponent::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);

}

QObject* QQmlComponent_virtualbase_create(void* self, QQmlContext* context) {

	return ( (MiqtVirtualQQmlComponent*)(self) )->QQmlComponent::create(context);

}

QObject* QQmlComponent_virtualbase_beginCreate(void* self, QQmlContext* param1) {

	return ( (MiqtVirtualQQmlComponent*)(self) )->QQmlComponent::beginCreate(param1);

}

void QQmlComponent_virtualbase_completeCreate(void* self) {

	( (MiqtVirtualQQmlComponent*)(self) )->QQmlComponent::completeCreate();

}

bool QQmlComponent_virtualbase_event(void* self, QEvent* event) {

	return ( (MiqtVirtualQQmlComponent*)(self) )->QQmlComponent::event(event);

}

bool QQmlComponent_virtualbase_eventFilter(void* self, QObject* watched, QEvent* event) {

	return ( (MiqtVirtualQQmlComponent*)(self) )->QQmlComponent::eventFilter(watched, event);

}

void QQmlComponent_virtualbase_timerEvent(void* self, QTimerEvent* event) {

	( (MiqtVirtualQQmlComponent*)(self) )->QQmlComponent::timerEvent(event);

}

void QQmlComponent_virtualbase_childEvent(void* self, QChildEvent* event) {

	( (MiqtVirtualQQmlComponent*)(self) )->QQmlComponent::childEvent(event);

}

void QQmlComponent_virtualbase_customEvent(void* self, QEvent* event) {

	( (MiqtVirtualQQmlComponent*)(self) )->QQmlComponent::customEvent(event);

}

void QQmlComponent_virtualbase_connectNotify(void* self, QMetaMethod* signal) {

	( (MiqtVirtualQQmlComponent*)(self) )->QQmlComponent::connectNotify(*signal);

}

void QQmlComponent_virtualbase_disconnectNotify(void* self, QMetaMethod* signal) {

	( (MiqtVirtualQQmlComponent*)(self) )->QQmlComponent::disconnectNotify(*signal);
...
QObject* QQmlComponent_protectedbase_sender(const void* self) {
	MiqtVirtualQQmlComponent* self_cast = static_cast<MiqtVirtualQQmlComponent*>( (QQmlComponent*)(self) );
