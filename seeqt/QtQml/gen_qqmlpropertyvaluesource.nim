...
proc setTarget*(self: gen_qqmlpropertyvaluesource_types.QQmlPropertyValueSource, target: QQmlProperty): void =
  fcQQmlPropertyValueSource_setTarget(self.h, target.h)

proc operatorAssign*(self: gen_qqmlpropertyvaluesource_types.QQmlPropertyValueSource, param1: QQmlPropertyValueSource): void =
  fcQQmlPropertyValueSource_operatorAssign(self.h, param1.h)

type QQmlPropertyValueSourcesetTargetProc* = proc(target: QQmlProperty): void
...
proc miqt_exec_callback_QQmlPropertyValueSource_setTarget(self: ptr cQQmlPropertyValueSource, slot: int, target: pointer): void {.exportc: "miqt_exec_callback_QQmlPropertyValueSource_setTarget ".} =
  ...
  let slotval1 = QQmlProperty(h: target)
