...
func init*(T: type gen_qjsvalueiterator_types.QJSValueIterator, h: ptr cQJSValueIterator): gen_qjsvalueiterator_types.QJSValueIterator =
  T(h: h)
proc create*(T: type gen_qjsvalueiterator_types.QJSValueIterator, value: QJSValue): gen_qjsvalueiterator_types.QJSValueIterator =
...
proc value*(self: gen_qjsvalueiterator_types.QJSValueIterator, ): QJSValue =
  QJSValue(h: fcQJSValueIterator_value(self.h))

proc operatorAssign*(self: gen_qjsvalueiterator_types.QJSValueIterator, value: QJSValue): void =
