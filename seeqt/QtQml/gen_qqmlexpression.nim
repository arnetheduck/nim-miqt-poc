...
proc create*(T: type gen_qqmlexpression_types.QQmlExpression, param1: QQmlContext, param2: QObject, param3: string): gen_qqmlexpression_types.QQmlExpression =
...
proc create*(T: type gen_qqmlexpression_types.QQmlExpression, param1: QQmlScriptString): gen_qqmlexpression_types.QQmlExpression =
  gen_qqmlexpression_types.QQmlExpression.init(fcQQmlExpression_new3(param1.h))

proc create*(T: type gen_qqmlexpression_types.QQmlExpression, param1: QQmlContext, param2: QObject, param3: string, param4: QObject): gen_qqmlexpression_types.QQmlExpression =
...
proc create*(T: type gen_qqmlexpression_types.QQmlExpression, param1: QQmlScriptString, param2: QQmlContext): gen_qqmlexpression_types.QQmlExpression =
  gen_qqmlexpression_types.QQmlExpression.init(fcQQmlExpression_new5(param1.h, param2.h))

proc create*(T: type gen_qqmlexpression_types.QQmlExpression, param1: QQmlScriptString, param2: QQmlContext, param3: QObject): gen_qqmlexpression_types.QQmlExpression =
  gen_qqmlexpression_types.QQmlExpression.init(fcQQmlExpression_new6(param1.h, param2.h, param3.h))

proc create*(T: type gen_qqmlexpression_types.QQmlExpression, param1: QQmlScriptString, param2: QQmlContext, param3: QObject, param4: QObject): gen_qqmlexpression_types.QQmlExpression =
  gen_qqmlexpression_types.QQmlExpression.init(fcQQmlExpression_new7(param1.h, param2.h, param3.h, param4.h))

proc metaObject*(self: gen_qqmlexpression_types.QQmlExpression, ): QMetaObject =
  QMetaObject(h: fcQQmlExpression_metaObject(self.h))
...
proc engine*(self: gen_qqmlexpression_types.QQmlExpression, ): QQmlEngine =
  QQmlEngine(h: fcQQmlExpression_engine(self.h))

proc context*(self: gen_qqmlexpression_types.QQmlExpression, ): QQmlContext =
  QQmlContext(h: fcQQmlExpression_context(self.h))
...
proc scopeObject*(self: gen_qqmlexpression_types.QQmlExpression, ): QObject =
  QObject(h: fcQQmlExpression_scopeObject(self.h))
...
proc error*(self: gen_qqmlexpression_types.QQmlExpression, ): QQmlError =
  QQmlError(h: fcQQmlExpression_error(self.h))

proc evaluate*(self: gen_qqmlexpression_types.QQmlExpression, ): QVariant =
  QVariant(h: fcQQmlExpression_evaluate(self.h))
...
proc evaluate*(self: gen_qqmlexpression_types.QQmlExpression, valueIsUndefined: ptr bool): QVariant =
  QVariant(h: fcQQmlExpression_evaluate1(self.h, valueIsUndefined))
...
proc miqt_exec_callback_QQmlExpression_metacall(self: ptr cQQmlExpression, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QQmlExpression_metacall ".} =
  ...
  virtualReturn
proc QQmlExpressionevent*(self: gen_qqmlexpression_types.QQmlExpression, event: QEvent): bool =
  fQQmlExpression_virtualbase_event(self.h, event.h)

type QQmlExpressioneventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QQmlExpression_event(self: ptr cQQmlExpression, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QQmlExpression_event ".} =
  ...
  virtualReturn
proc QQmlExpressioneventFilter*(self: gen_qqmlexpression_types.QQmlExpression, watched: QObject, event: QEvent): bool =
  fQQmlExpression_virtualbase_eventFilter(self.h, watched.h, event.h)

type QQmlExpressioneventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QQmlExpression_eventFilter(self: ptr cQQmlExpression, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QQmlExpression_eventFilter ".} =
  ...
  virtualReturn
proc QQmlExpressiontimerEvent*(self: gen_qqmlexpression_types.QQmlExpression, event: QTimerEvent): void =
  fQQmlExpression_virtualbase_timerEvent(self.h, event.h)

type QQmlExpressiontimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QQmlExpression_timerEvent(self: ptr cQQmlExpression, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QQmlExpression_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QQmlExpressionchildEvent*(self: gen_qqmlexpression_types.QQmlExpression, event: QChildEvent): void =
  fQQmlExpression_virtualbase_childEvent(self.h, event.h)

type QQmlExpressionchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QQmlExpression_childEvent(self: ptr cQQmlExpression, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QQmlExpression_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QQmlExpressioncustomEvent*(self: gen_qqmlexpression_types.QQmlExpression, event: QEvent): void =
  fQQmlExpression_virtualbase_customEvent(self.h, event.h)

type QQmlExpressioncustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QQmlExpression_customEvent(self: ptr cQQmlExpression, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QQmlExpression_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QQmlExpressionconnectNotify*(self: gen_qqmlexpression_types.QQmlExpression, signal: QMetaMethod): void =
  fQQmlExpression_virtualbase_connectNotify(self.h, signal.h)

type QQmlExpressionconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QQmlExpression_connectNotify(self: ptr cQQmlExpression, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QQmlExpression_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QQmlExpressiondisconnectNotify*(self: gen_qqmlexpression_types.QQmlExpression, signal: QMetaMethod): void =
  fQQmlExpression_virtualbase_disconnectNotify(self.h, signal.h)

type QQmlExpressiondisconnectNotifyProc* = proc(signal: QMetaMethod): void
