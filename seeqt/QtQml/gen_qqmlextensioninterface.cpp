...
public:
	...
	MiqtVirtualQQmlTypesExtensionInterface(struct QQmlTypesExtensionInterface_VTable* vtbl, const QQmlTypesExtensionInterface& param1): QQmlTypesExtensionInterface(param1), vtbl(vtbl) {};

	virtual ~MiqtVirtualQQmlTypesExtensionInterface() override { if(vtbl->destructor) vtbl->destructor(vtbl, this); }
...
QQmlTypesExtensionInterface* QQmlTypesExtensionInterface_new(struct QQmlTypesExtensionInterface_VTable* vtbl, QQmlTypesExtensionInterface* param1) {
	return new MiqtVirtualQQmlTypesExtensionInterface(vtbl, *param1);
}
...
public:
	...
	MiqtVirtualQQmlExtensionInterface(struct QQmlExtensionInterface_VTable* vtbl, const QQmlExtensionInterface& param1): QQmlExtensionInterface(param1), vtbl(vtbl) {};

	virtual ~MiqtVirtualQQmlExtensionInterface() override { if(vtbl->destructor) vtbl->destructor(vtbl, this); }
...
QQmlExtensionInterface* QQmlExtensionInterface_new(struct QQmlExtensionInterface_VTable* vtbl, QQmlExtensionInterface* param1) {
	return new MiqtVirtualQQmlExtensionInterface(vtbl, *param1);
}
