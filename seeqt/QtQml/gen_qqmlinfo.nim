...
func init*(T: type gen_qqmlinfo_types.QQmlInfo, h: ptr cQQmlInfo): gen_qqmlinfo_types.QQmlInfo =
  T(h: h)
proc create*(T: type gen_qqmlinfo_types.QQmlInfo, param1: QQmlInfo): gen_qqmlinfo_types.QQmlInfo =
  gen_qqmlinfo_types.QQmlInfo.init(fcQQmlInfo_new(param1.h))

proc operatorShiftLeft*(self: gen_qqmlinfo_types.QQmlInfo, t: QChar): QQmlInfo =
  QQmlInfo(h: fcQQmlInfo_operatorShiftLeft(self.h, t.h))

proc operatorShiftLeft*(self: gen_qqmlinfo_types.QQmlInfo, t: bool): QQmlInfo =
  QQmlInfo(h: fcQQmlInfo_operatorShiftLeftWithBool(self.h, t))

proc operatorShiftLeft*(self: gen_qqmlinfo_types.QQmlInfo, t: cchar): QQmlInfo =
  QQmlInfo(h: fcQQmlInfo_operatorShiftLeftWithChar(self.h, t))

proc operatorShiftLeft*(self: gen_qqmlinfo_types.QQmlInfo, t: cshort): QQmlInfo =
  QQmlInfo(h: fcQQmlInfo_operatorShiftLeftWithShort(self.h, t))

proc operatorShiftLeft*(self: gen_qqmlinfo_types.QQmlInfo, t: cushort): QQmlInfo =
  QQmlInfo(h: fcQQmlInfo_operatorShiftLeftWithUnsignedshort(self.h, t))

proc operatorShiftLeft*(self: gen_qqmlinfo_types.QQmlInfo, t: cint): QQmlInfo =
  QQmlInfo(h: fcQQmlInfo_operatorShiftLeftWithInt(self.h, t))

proc operatorShiftLeft*(self: gen_qqmlinfo_types.QQmlInfo, t: cuint): QQmlInfo =
  QQmlInfo(h: fcQQmlInfo_operatorShiftLeftWithUnsignedint(self.h, t))

proc operatorShiftLeft*(self: gen_qqmlinfo_types.QQmlInfo, t: clong): QQmlInfo =
  QQmlInfo(h: fcQQmlInfo_operatorShiftLeftWithLong(self.h, t))

proc operatorShiftLeft*(self: gen_qqmlinfo_types.QQmlInfo, t: culong): QQmlInfo =
  QQmlInfo(h: fcQQmlInfo_operatorShiftLeftWithUnsignedlong(self.h, t))

proc operatorShiftLeft*(self: gen_qqmlinfo_types.QQmlInfo, t: clonglong): QQmlInfo =
  QQmlInfo(h: fcQQmlInfo_operatorShiftLeftWithQint64(self.h, t))

proc operatorShiftLeft*(self: gen_qqmlinfo_types.QQmlInfo, t: culonglong): QQmlInfo =
  QQmlInfo(h: fcQQmlInfo_operatorShiftLeftWithQuint64(self.h, t))

proc operatorShiftLeft*(self: gen_qqmlinfo_types.QQmlInfo, t: float32): QQmlInfo =
  QQmlInfo(h: fcQQmlInfo_operatorShiftLeftWithFloat(self.h, t))

proc operatorShiftLeft*(self: gen_qqmlinfo_types.QQmlInfo, t: float64): QQmlInfo =
  QQmlInfo(h: fcQQmlInfo_operatorShiftLeftWithDouble(self.h, t))

proc operatorShiftLeft*(self: gen_qqmlinfo_types.QQmlInfo, t: cstring): QQmlInfo =
  QQmlInfo(h: fcQQmlInfo_operatorShiftLeft2(self.h, t))

proc operatorShiftLeft*(self: gen_qqmlinfo_types.QQmlInfo, t: string): QQmlInfo =
  QQmlInfo(h: fcQQmlInfo_operatorShiftLeftWithQString(self.h, struct_miqt_string(data: t, len: csize_t(len(t)))))

proc operatorShiftLeft*(self: gen_qqmlinfo_types.QQmlInfo, t: seq[byte]): QQmlInfo =
...
proc operatorShiftLeft*(self: gen_qqmlinfo_types.QQmlInfo, t: pointer): QQmlInfo =
  QQmlInfo(h: fcQQmlInfo_operatorShiftLeftWithVoid(self.h, t))

proc operatorShiftLeft*(self: gen_qqmlinfo_types.QQmlInfo, t: QUrl): QQmlInfo =
