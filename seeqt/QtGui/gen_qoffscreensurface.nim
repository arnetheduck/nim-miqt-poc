...
proc create*(T: type gen_qoffscreensurface_types.QOffscreenSurface, screen: QScreen): gen_qoffscreensurface_types.QOffscreenSurface =
  gen_qoffscreensurface_types.QOffscreenSurface.init(fcQOffscreenSurface_new2(screen.h))

proc create*(T: type gen_qoffscreensurface_types.QOffscreenSurface, screen: QScreen, parent: QObject): gen_qoffscreensurface_types.QOffscreenSurface =
  gen_qoffscreensurface_types.QOffscreenSurface.init(fcQOffscreenSurface_new3(screen.h, parent.h))

proc metaObject*(self: gen_qoffscreensurface_types.QOffscreenSurface, ): QMetaObject =
  QMetaObject(h: fcQOffscreenSurface_metaObject(self.h))
...
proc setFormat*(self: gen_qoffscreensurface_types.QOffscreenSurface, format: QSurfaceFormat): void =
  fcQOffscreenSurface_setFormat(self.h, format.h)

proc format*(self: gen_qoffscreensurface_types.QOffscreenSurface, ): QSurfaceFormat =
  QSurfaceFormat(h: fcQOffscreenSurface_format(self.h))

proc requestedFormat*(self: gen_qoffscreensurface_types.QOffscreenSurface, ): QSurfaceFormat =
  QSurfaceFormat(h: fcQOffscreenSurface_requestedFormat(self.h))

proc size*(self: gen_qoffscreensurface_types.QOffscreenSurface, ): QSize =
  QSize(h: fcQOffscreenSurface_size(self.h))

proc screen*(self: gen_qoffscreensurface_types.QOffscreenSurface, ): QScreen =
  QScreen(h: fcQOffscreenSurface_screen(self.h))

proc setScreen*(self: gen_qoffscreensurface_types.QOffscreenSurface, screen: QScreen): void =
  fcQOffscreenSurface_setScreen(self.h, screen.h)

proc screenChanged*(self: gen_qoffscreensurface_types.QOffscreenSurface, screen: QScreen): void =
  fcQOffscreenSurface_screenChanged(self.h, screen.h)

type QOffscreenSurfacescreenChangedSlot* = proc(screen: QScreen)
...
proc miqt_exec_callback_QOffscreenSurface_surfaceType(self: ptr cQOffscreenSurface, slot: int): cint {.exportc: "miqt_exec_callback_QOffscreenSurface_surfaceType ".} =
  ...
  cint(virtualReturn)
proc QOffscreenSurfaceformat*(self: gen_qoffscreensurface_types.QOffscreenSurface, ): QSurfaceFormat =
  QSurfaceFormat(h: fQOffscreenSurface_virtualbase_format(self.h))

type QOffscreenSurfaceformatProc* = proc(): QSurfaceFormat
...
proc miqt_exec_callback_QOffscreenSurface_format(self: ptr cQOffscreenSurface, slot: int): pointer {.exportc: "miqt_exec_callback_QOffscreenSurface_format ".} =
  ...
  virtualReturn.h
proc QOffscreenSurfacesize*(self: gen_qoffscreensurface_types.QOffscreenSurface, ): QSize =
  QSize(h: fQOffscreenSurface_virtualbase_size(self.h))

type QOffscreenSurfacesizeProc* = proc(): QSize
...
proc miqt_exec_callback_QOffscreenSurface_size(self: ptr cQOffscreenSurface, slot: int): pointer {.exportc: "miqt_exec_callback_QOffscreenSurface_size ".} =
  ...
  virtualReturn.h
proc QOffscreenSurfaceevent*(self: gen_qoffscreensurface_types.QOffscreenSurface, event: QEvent): bool =
  fQOffscreenSurface_virtualbase_event(self.h, event.h)

type QOffscreenSurfaceeventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QOffscreenSurface_event(self: ptr cQOffscreenSurface, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QOffscreenSurface_event ".} =
  ...
  virtualReturn
proc QOffscreenSurfaceeventFilter*(self: gen_qoffscreensurface_types.QOffscreenSurface, watched: QObject, event: QEvent): bool =
  fQOffscreenSurface_virtualbase_eventFilter(self.h, watched.h, event.h)

type QOffscreenSurfaceeventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QOffscreenSurface_eventFilter(self: ptr cQOffscreenSurface, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QOffscreenSurface_eventFilter ".} =
  ...
  virtualReturn
proc QOffscreenSurfacetimerEvent*(self: gen_qoffscreensurface_types.QOffscreenSurface, event: QTimerEvent): void =
  fQOffscreenSurface_virtualbase_timerEvent(self.h, event.h)

type QOffscreenSurfacetimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QOffscreenSurface_timerEvent(self: ptr cQOffscreenSurface, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QOffscreenSurface_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QOffscreenSurfacechildEvent*(self: gen_qoffscreensurface_types.QOffscreenSurface, event: QChildEvent): void =
  fQOffscreenSurface_virtualbase_childEvent(self.h, event.h)

type QOffscreenSurfacechildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QOffscreenSurface_childEvent(self: ptr cQOffscreenSurface, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QOffscreenSurface_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QOffscreenSurfacecustomEvent*(self: gen_qoffscreensurface_types.QOffscreenSurface, event: QEvent): void =
  fQOffscreenSurface_virtualbase_customEvent(self.h, event.h)

type QOffscreenSurfacecustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QOffscreenSurface_customEvent(self: ptr cQOffscreenSurface, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QOffscreenSurface_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QOffscreenSurfaceconnectNotify*(self: gen_qoffscreensurface_types.QOffscreenSurface, signal: QMetaMethod): void =
  fQOffscreenSurface_virtualbase_connectNotify(self.h, signal.h)

type QOffscreenSurfaceconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QOffscreenSurface_connectNotify(self: ptr cQOffscreenSurface, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QOffscreenSurface_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QOffscreenSurfacedisconnectNotify*(self: gen_qoffscreensurface_types.QOffscreenSurface, signal: QMetaMethod): void =
  fQOffscreenSurface_virtualbase_disconnectNotify(self.h, signal.h)

type QOffscreenSurfacedisconnectNotifyProc* = proc(signal: QMetaMethod): void
