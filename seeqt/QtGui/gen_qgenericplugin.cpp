...
QMetaObject* QGenericPlugin_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQGenericPlugin*)(self) )->QGenericPlugin::metaObject();

}

void* QGenericPlugin_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQGenericPlugin*)(self) )->QGenericPlugin::qt_metacast(param1);

}

int QGenericPlugin_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQGenericPlugin*)(self) )->QGenericPlugin::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
QObject* QGenericPlugin_protectedbase_sender(const void* self) {
	MiqtVirtualQGenericPlugin* self_cast = static_cast<MiqtVirtualQGenericPlugin*>( (QGenericPlugin*)(self) );
