...
void QDrag_connect_actionChanged(QDrag* self, intptr_t slot, void (*callback)(intptr_t, int), void (*release)(intptr_t)) {
	...
	MiqtVirtualQDrag::connect(self, static_cast<void (QDrag::*)(Qt::DropAction)>(&QDrag::actionChanged), self, caller{slot, callback, release});
}
...
void QDrag_connect_targetChanged(QDrag* self, intptr_t slot, void (*callback)(intptr_t, QObject*), void (*release)(intptr_t)) {
	...
	MiqtVirtualQDrag::connect(self, static_cast<void (QDrag::*)(QObject*)>(&QDrag::targetChanged), self, caller{slot, callback, release});
}
...
QMetaObject* QDrag_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQDrag*)(self) )->QDrag::metaObject();

}

void* QDrag_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQDrag*)(self) )->QDrag::qt_metacast(param1);

}

int QDrag_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQDrag*)(self) )->QDrag::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
