...
proc create*(T: type gen_qvalidator_types.QValidator, parent: QObject): gen_qvalidator_types.QValidator =
  gen_qvalidator_types.QValidator.init(fcQValidator_new2(parent.h))

proc metaObject*(self: gen_qvalidator_types.QValidator, ): QMetaObject =
  QMetaObject(h: fcQValidator_metaObject(self.h))
...
proc setLocale*(self: gen_qvalidator_types.QValidator, locale: QLocale): void =
  fcQValidator_setLocale(self.h, locale.h)

proc locale*(self: gen_qvalidator_types.QValidator, ): QLocale =
  QLocale(h: fcQValidator_locale(self.h))
...
proc miqt_exec_callback_QValidator_fixup(self: ptr cQValidator, slot: int, param1: struct_miqt_string): void {.exportc: "miqt_exec_callback_QValidator_fixup ".} =
  ...
  nimfunc[](slotval1)
proc QValidatorevent*(self: gen_qvalidator_types.QValidator, event: QEvent): bool =
  fQValidator_virtualbase_event(self.h, event.h)

type QValidatoreventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QValidator_event(self: ptr cQValidator, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QValidator_event ".} =
  ...
  virtualReturn
proc QValidatoreventFilter*(self: gen_qvalidator_types.QValidator, watched: QObject, event: QEvent): bool =
  fQValidator_virtualbase_eventFilter(self.h, watched.h, event.h)

type QValidatoreventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QValidator_eventFilter(self: ptr cQValidator, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QValidator_eventFilter ".} =
  ...
  virtualReturn
proc QValidatortimerEvent*(self: gen_qvalidator_types.QValidator, event: QTimerEvent): void =
  fQValidator_virtualbase_timerEvent(self.h, event.h)

type QValidatortimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QValidator_timerEvent(self: ptr cQValidator, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QValidator_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QValidatorchildEvent*(self: gen_qvalidator_types.QValidator, event: QChildEvent): void =
  fQValidator_virtualbase_childEvent(self.h, event.h)

type QValidatorchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QValidator_childEvent(self: ptr cQValidator, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QValidator_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QValidatorcustomEvent*(self: gen_qvalidator_types.QValidator, event: QEvent): void =
  fQValidator_virtualbase_customEvent(self.h, event.h)

type QValidatorcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QValidator_customEvent(self: ptr cQValidator, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QValidator_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QValidatorconnectNotify*(self: gen_qvalidator_types.QValidator, signal: QMetaMethod): void =
  fQValidator_virtualbase_connectNotify(self.h, signal.h)

type QValidatorconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QValidator_connectNotify(self: ptr cQValidator, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QValidator_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QValidatordisconnectNotify*(self: gen_qvalidator_types.QValidator, signal: QMetaMethod): void =
  fQValidator_virtualbase_disconnectNotify(self.h, signal.h)

type QValidatordisconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc create*(T: type gen_qvalidator_types.QIntValidator, parent: QObject): gen_qvalidator_types.QIntValidator =
  gen_qvalidator_types.QIntValidator.init(fcQIntValidator_new3(parent.h))

proc create*(T: type gen_qvalidator_types.QIntValidator, bottom: cint, top: cint, parent: QObject): gen_qvalidator_types.QIntValidator =
  gen_qvalidator_types.QIntValidator.init(fcQIntValidator_new4(bottom, top, parent.h))

proc metaObject*(self: gen_qvalidator_types.QIntValidator, ): QMetaObject =
  QMetaObject(h: fcQIntValidator_metaObject(self.h))
...
proc QIntValidatorevent*(self: gen_qvalidator_types.QIntValidator, event: QEvent): bool =
  fQIntValidator_virtualbase_event(self.h, event.h)

type QIntValidatoreventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QIntValidator_event(self: ptr cQIntValidator, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QIntValidator_event ".} =
  ...
  virtualReturn
proc QIntValidatoreventFilter*(self: gen_qvalidator_types.QIntValidator, watched: QObject, event: QEvent): bool =
  fQIntValidator_virtualbase_eventFilter(self.h, watched.h, event.h)

type QIntValidatoreventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QIntValidator_eventFilter(self: ptr cQIntValidator, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QIntValidator_eventFilter ".} =
  ...
  virtualReturn
proc QIntValidatortimerEvent*(self: gen_qvalidator_types.QIntValidator, event: QTimerEvent): void =
  fQIntValidator_virtualbase_timerEvent(self.h, event.h)

type QIntValidatortimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QIntValidator_timerEvent(self: ptr cQIntValidator, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QIntValidator_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QIntValidatorchildEvent*(self: gen_qvalidator_types.QIntValidator, event: QChildEvent): void =
  fQIntValidator_virtualbase_childEvent(self.h, event.h)

type QIntValidatorchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QIntValidator_childEvent(self: ptr cQIntValidator, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QIntValidator_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QIntValidatorcustomEvent*(self: gen_qvalidator_types.QIntValidator, event: QEvent): void =
  fQIntValidator_virtualbase_customEvent(self.h, event.h)

type QIntValidatorcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QIntValidator_customEvent(self: ptr cQIntValidator, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QIntValidator_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QIntValidatorconnectNotify*(self: gen_qvalidator_types.QIntValidator, signal: QMetaMethod): void =
  fQIntValidator_virtualbase_connectNotify(self.h, signal.h)

type QIntValidatorconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QIntValidator_connectNotify(self: ptr cQIntValidator, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QIntValidator_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QIntValidatordisconnectNotify*(self: gen_qvalidator_types.QIntValidator, signal: QMetaMethod): void =
  fQIntValidator_virtualbase_disconnectNotify(self.h, signal.h)

type QIntValidatordisconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc create*(T: type gen_qvalidator_types.QDoubleValidator, parent: QObject): gen_qvalidator_types.QDoubleValidator =
  gen_qvalidator_types.QDoubleValidator.init(fcQDoubleValidator_new3(parent.h))

proc create*(T: type gen_qvalidator_types.QDoubleValidator, bottom: float64, top: float64, decimals: cint, parent: QObject): gen_qvalidator_types.QDoubleValidator =
  gen_qvalidator_types.QDoubleValidator.init(fcQDoubleValidator_new4(bottom, top, decimals, parent.h))

proc metaObject*(self: gen_qvalidator_types.QDoubleValidator, ): QMetaObject =
  QMetaObject(h: fcQDoubleValidator_metaObject(self.h))
...
proc miqt_exec_callback_QDoubleValidator_fixup(self: ptr cQDoubleValidator, slot: int, param1: struct_miqt_string): void {.exportc: "miqt_exec_callback_QDoubleValidator_fixup ".} =
  ...
  nimfunc[](slotval1)
proc QDoubleValidatorevent*(self: gen_qvalidator_types.QDoubleValidator, event: QEvent): bool =
  fQDoubleValidator_virtualbase_event(self.h, event.h)

type QDoubleValidatoreventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QDoubleValidator_event(self: ptr cQDoubleValidator, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QDoubleValidator_event ".} =
  ...
  virtualReturn
proc QDoubleValidatoreventFilter*(self: gen_qvalidator_types.QDoubleValidator, watched: QObject, event: QEvent): bool =
  fQDoubleValidator_virtualbase_eventFilter(self.h, watched.h, event.h)

type QDoubleValidatoreventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QDoubleValidator_eventFilter(self: ptr cQDoubleValidator, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QDoubleValidator_eventFilter ".} =
  ...
  virtualReturn
proc QDoubleValidatortimerEvent*(self: gen_qvalidator_types.QDoubleValidator, event: QTimerEvent): void =
  fQDoubleValidator_virtualbase_timerEvent(self.h, event.h)

type QDoubleValidatortimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QDoubleValidator_timerEvent(self: ptr cQDoubleValidator, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QDoubleValidator_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QDoubleValidatorchildEvent*(self: gen_qvalidator_types.QDoubleValidator, event: QChildEvent): void =
  fQDoubleValidator_virtualbase_childEvent(self.h, event.h)

type QDoubleValidatorchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QDoubleValidator_childEvent(self: ptr cQDoubleValidator, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QDoubleValidator_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QDoubleValidatorcustomEvent*(self: gen_qvalidator_types.QDoubleValidator, event: QEvent): void =
  fQDoubleValidator_virtualbase_customEvent(self.h, event.h)

type QDoubleValidatorcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QDoubleValidator_customEvent(self: ptr cQDoubleValidator, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QDoubleValidator_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QDoubleValidatorconnectNotify*(self: gen_qvalidator_types.QDoubleValidator, signal: QMetaMethod): void =
  fQDoubleValidator_virtualbase_connectNotify(self.h, signal.h)

type QDoubleValidatorconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QDoubleValidator_connectNotify(self: ptr cQDoubleValidator, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QDoubleValidator_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QDoubleValidatordisconnectNotify*(self: gen_qvalidator_types.QDoubleValidator, signal: QMetaMethod): void =
  fQDoubleValidator_virtualbase_disconnectNotify(self.h, signal.h)

type QDoubleValidatordisconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc create*(T: type gen_qvalidator_types.QRegExpValidator, rx: QRegExp): gen_qvalidator_types.QRegExpValidator =
  gen_qvalidator_types.QRegExpValidator.init(fcQRegExpValidator_new2(rx.h))

proc create*(T: type gen_qvalidator_types.QRegExpValidator, parent: QObject): gen_qvalidator_types.QRegExpValidator =
  gen_qvalidator_types.QRegExpValidator.init(fcQRegExpValidator_new3(parent.h))

proc create*(T: type gen_qvalidator_types.QRegExpValidator, rx: QRegExp, parent: QObject): gen_qvalidator_types.QRegExpValidator =
  gen_qvalidator_types.QRegExpValidator.init(fcQRegExpValidator_new4(rx.h, parent.h))

proc metaObject*(self: gen_qvalidator_types.QRegExpValidator, ): QMetaObject =
  QMetaObject(h: fcQRegExpValidator_metaObject(self.h))
...
proc setRegExp*(self: gen_qvalidator_types.QRegExpValidator, rx: QRegExp): void =
  fcQRegExpValidator_setRegExp(self.h, rx.h)

proc regExp*(self: gen_qvalidator_types.QRegExpValidator, ): QRegExp =
  QRegExp(h: fcQRegExpValidator_regExp(self.h))

proc regExpChanged*(self: gen_qvalidator_types.QRegExpValidator, regExp: QRegExp): void =
  fcQRegExpValidator_regExpChanged(self.h, regExp.h)

type QRegExpValidatorregExpChangedSlot* = proc(regExp: QRegExp)
...
proc miqt_exec_callback_QRegExpValidator_fixup(self: ptr cQRegExpValidator, slot: int, param1: struct_miqt_string): void {.exportc: "miqt_exec_callback_QRegExpValidator_fixup ".} =
  ...
  nimfunc[](slotval1)
proc QRegExpValidatorevent*(self: gen_qvalidator_types.QRegExpValidator, event: QEvent): bool =
  fQRegExpValidator_virtualbase_event(self.h, event.h)

type QRegExpValidatoreventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QRegExpValidator_event(self: ptr cQRegExpValidator, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QRegExpValidator_event ".} =
  ...
  virtualReturn
proc QRegExpValidatoreventFilter*(self: gen_qvalidator_types.QRegExpValidator, watched: QObject, event: QEvent): bool =
  fQRegExpValidator_virtualbase_eventFilter(self.h, watched.h, event.h)

type QRegExpValidatoreventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QRegExpValidator_eventFilter(self: ptr cQRegExpValidator, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QRegExpValidator_eventFilter ".} =
  ...
  virtualReturn
proc QRegExpValidatortimerEvent*(self: gen_qvalidator_types.QRegExpValidator, event: QTimerEvent): void =
  fQRegExpValidator_virtualbase_timerEvent(self.h, event.h)

type QRegExpValidatortimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QRegExpValidator_timerEvent(self: ptr cQRegExpValidator, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QRegExpValidator_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QRegExpValidatorchildEvent*(self: gen_qvalidator_types.QRegExpValidator, event: QChildEvent): void =
  fQRegExpValidator_virtualbase_childEvent(self.h, event.h)

type QRegExpValidatorchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QRegExpValidator_childEvent(self: ptr cQRegExpValidator, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QRegExpValidator_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QRegExpValidatorcustomEvent*(self: gen_qvalidator_types.QRegExpValidator, event: QEvent): void =
  fQRegExpValidator_virtualbase_customEvent(self.h, event.h)

type QRegExpValidatorcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QRegExpValidator_customEvent(self: ptr cQRegExpValidator, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QRegExpValidator_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QRegExpValidatorconnectNotify*(self: gen_qvalidator_types.QRegExpValidator, signal: QMetaMethod): void =
  fQRegExpValidator_virtualbase_connectNotify(self.h, signal.h)

type QRegExpValidatorconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QRegExpValidator_connectNotify(self: ptr cQRegExpValidator, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QRegExpValidator_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QRegExpValidatordisconnectNotify*(self: gen_qvalidator_types.QRegExpValidator, signal: QMetaMethod): void =
  fQRegExpValidator_virtualbase_disconnectNotify(self.h, signal.h)

type QRegExpValidatordisconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc create*(T: type gen_qvalidator_types.QRegularExpressionValidator, re: QRegularExpression): gen_qvalidator_types.QRegularExpressionValidator =
  gen_qvalidator_types.QRegularExpressionValidator.init(fcQRegularExpressionValidator_new2(re.h))

proc create*(T: type gen_qvalidator_types.QRegularExpressionValidator, parent: QObject): gen_qvalidator_types.QRegularExpressionValidator =
  gen_qvalidator_types.QRegularExpressionValidator.init(fcQRegularExpressionValidator_new3(parent.h))

proc create*(T: type gen_qvalidator_types.QRegularExpressionValidator, re: QRegularExpression, parent: QObject): gen_qvalidator_types.QRegularExpressionValidator =
  gen_qvalidator_types.QRegularExpressionValidator.init(fcQRegularExpressionValidator_new4(re.h, parent.h))

proc metaObject*(self: gen_qvalidator_types.QRegularExpressionValidator, ): QMetaObject =
  QMetaObject(h: fcQRegularExpressionValidator_metaObject(self.h))
...
proc regularExpression*(self: gen_qvalidator_types.QRegularExpressionValidator, ): QRegularExpression =
  QRegularExpression(h: fcQRegularExpressionValidator_regularExpression(self.h))

proc setRegularExpression*(self: gen_qvalidator_types.QRegularExpressionValidator, re: QRegularExpression): void =
  fcQRegularExpressionValidator_setRegularExpression(self.h, re.h)

proc regularExpressionChanged*(self: gen_qvalidator_types.QRegularExpressionValidator, re: QRegularExpression): void =
  fcQRegularExpressionValidator_regularExpressionChanged(self.h, re.h)

type QRegularExpressionValidatorregularExpressionChangedSlot* = proc(re: QRegularExpression)
proc miqt_exec_callback_QRegularExpressionValidator_regularExpressionChanged(slot: int, re: pointer) {.exportc.} =
  ...
  let slotval1 = QRegularExpression(h: re)
...
proc miqt_exec_callback_QRegularExpressionValidator_fixup(self: ptr cQRegularExpressionValidator, slot: int, param1: struct_miqt_string): void {.exportc: "miqt_exec_callback_QRegularExpressionValidator_fixup ".} =
  ...
  nimfunc[](slotval1)
proc QRegularExpressionValidatorevent*(self: gen_qvalidator_types.QRegularExpressionValidator, event: QEvent): bool =
  fQRegularExpressionValidator_virtualbase_event(self.h, event.h)

type QRegularExpressionValidatoreventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QRegularExpressionValidator_event(self: ptr cQRegularExpressionValidator, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QRegularExpressionValidator_event ".} =
  ...
  virtualReturn
proc QRegularExpressionValidatoreventFilter*(self: gen_qvalidator_types.QRegularExpressionValidator, watched: QObject, event: QEvent): bool =
  fQRegularExpressionValidator_virtualbase_eventFilter(self.h, watched.h, event.h)

type QRegularExpressionValidatoreventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QRegularExpressionValidator_eventFilter(self: ptr cQRegularExpressionValidator, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QRegularExpressionValidator_eventFilter ".} =
  ...
  virtualReturn
proc QRegularExpressionValidatortimerEvent*(self: gen_qvalidator_types.QRegularExpressionValidator, event: QTimerEvent): void =
  fQRegularExpressionValidator_virtualbase_timerEvent(self.h, event.h)

type QRegularExpressionValidatortimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QRegularExpressionValidator_timerEvent(self: ptr cQRegularExpressionValidator, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QRegularExpressionValidator_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QRegularExpressionValidatorchildEvent*(self: gen_qvalidator_types.QRegularExpressionValidator, event: QChildEvent): void =
  fQRegularExpressionValidator_virtualbase_childEvent(self.h, event.h)

type QRegularExpressionValidatorchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QRegularExpressionValidator_childEvent(self: ptr cQRegularExpressionValidator, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QRegularExpressionValidator_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QRegularExpressionValidatorcustomEvent*(self: gen_qvalidator_types.QRegularExpressionValidator, event: QEvent): void =
  fQRegularExpressionValidator_virtualbase_customEvent(self.h, event.h)

type QRegularExpressionValidatorcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QRegularExpressionValidator_customEvent(self: ptr cQRegularExpressionValidator, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QRegularExpressionValidator_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QRegularExpressionValidatorconnectNotify*(self: gen_qvalidator_types.QRegularExpressionValidator, signal: QMetaMethod): void =
  fQRegularExpressionValidator_virtualbase_connectNotify(self.h, signal.h)

type QRegularExpressionValidatorconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QRegularExpressionValidator_connectNotify(self: ptr cQRegularExpressionValidator, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QRegularExpressionValidator_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QRegularExpressionValidatordisconnectNotify*(self: gen_qvalidator_types.QRegularExpressionValidator, signal: QMetaMethod): void =
  fQRegularExpressionValidator_virtualbase_disconnectNotify(self.h, signal.h)

type QRegularExpressionValidatordisconnectNotifyProc* = proc(signal: QMetaMethod): void
