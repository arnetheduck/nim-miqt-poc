...
proc fQImageIOHandler_virtualbase_name(self: pointer, ): struct_miqt_string{.importc: "QImageIOHandler_virtualbase_name".}
proc fcQImageIOHandler_override_virtual_name(self: pointer, slot: int) {.importc: "QImageIOHandler_override_virtual_name".}
...
proc setDevice*(self: gen_qimageiohandler_types.QImageIOHandler, device: QIODevice): void =
  fcQImageIOHandler_setDevice(self.h, device.h)

proc device*(self: gen_qimageiohandler_types.QImageIOHandler, ): QIODevice =
  QIODevice(h: fcQImageIOHandler_device(self.h))
...
proc read*(self: gen_qimageiohandler_types.QImageIOHandler, image: QImage): bool =
  fcQImageIOHandler_read(self.h, image.h)

proc write*(self: gen_qimageiohandler_types.QImageIOHandler, image: QImage): bool =
  fcQImageIOHandler_write(self.h, image.h)

proc option*(self: gen_qimageiohandler_types.QImageIOHandler, option: cint): QVariant =
  QVariant(h: fcQImageIOHandler_option(self.h, cint(option)))

proc setOption*(self: gen_qimageiohandler_types.QImageIOHandler, option: cint, value: QVariant): void =
...
proc currentImageRect*(self: gen_qimageiohandler_types.QImageIOHandler, ): QRect =
  QRect(h: fcQImageIOHandler_currentImageRect(self.h))
...
type QImageIOHandlernameProc* = proc(): seq[byte]
proc onname*(self: gen_qimageiohandler_types.QImageIOHandler, slot: QImageIOHandlernameProc) =
  # TODO check subclass
  var tmp = new QImageIOHandlernameProc
  tmp[] = slot
  GC_ref(tmp)
  fcQImageIOHandler_override_virtual_name(self.h, cast[int](addr tmp[]))

proc miqt_exec_callback_QImageIOHandler_name(self: ptr cQImageIOHandler, slot: int): struct_miqt_string {.exportc: "miqt_exec_callback_QImageIOHandler_name ".} =
  var nimfunc = cast[ptr QImageIOHandlernameProc](cast[pointer](slot))
...
proc miqt_exec_callback_QImageIOHandler_canRead(self: ptr cQImageIOHandler, slot: int): bool {.exportc: "miqt_exec_callback_QImageIOHandler_canRead ".} =
  ...
  virtualReturn
type QImageIOHandlerreadProc* = proc(image: QImage): bool
...
proc miqt_exec_callback_QImageIOHandler_read(self: ptr cQImageIOHandler, slot: int, image: pointer): bool {.exportc: "miqt_exec_callback_QImageIOHandler_read ".} =
  ...
  virtualReturn
proc QImageIOHandlerwrite*(self: gen_qimageiohandler_types.QImageIOHandler, image: QImage): bool =
  fQImageIOHandler_virtualbase_write(self.h, image.h)

type QImageIOHandlerwriteProc* = proc(image: QImage): bool
...
proc miqt_exec_callback_QImageIOHandler_write(self: ptr cQImageIOHandler, slot: int, image: pointer): bool {.exportc: "miqt_exec_callback_QImageIOHandler_write ".} =
  ...
  virtualReturn
proc QImageIOHandleroption*(self: gen_qimageiohandler_types.QImageIOHandler, option: cint): QVariant =
  QVariant(h: fQImageIOHandler_virtualbase_option(self.h, cint(option)))

type QImageIOHandleroptionProc* = proc(option: cint): QVariant
...
proc miqt_exec_callback_QImageIOHandler_option(self: ptr cQImageIOHandler, slot: int, option: cint): pointer {.exportc: "miqt_exec_callback_QImageIOHandler_option ".} =
  ...
  virtualReturn.h
proc QImageIOHandlersetOption*(self: gen_qimageiohandler_types.QImageIOHandler, option: cint, value: QVariant): void =
  fQImageIOHandler_virtualbase_setOption(self.h, cint(option), value.h)

type QImageIOHandlersetOptionProc* = proc(option: cint, value: QVariant): void
...
proc miqt_exec_callback_QImageIOHandler_currentImageNumber(self: ptr cQImageIOHandler, slot: int): cint {.exportc: "miqt_exec_callback_QImageIOHandler_currentImageNumber ".} =
  ...
  virtualReturn
proc QImageIOHandlercurrentImageRect*(self: gen_qimageiohandler_types.QImageIOHandler, ): QRect =
  QRect(h: fQImageIOHandler_virtualbase_currentImageRect(self.h))

type QImageIOHandlercurrentImageRectProc* = proc(): QRect
...
proc create*(T: type gen_qimageiohandler_types.QImageIOPlugin, parent: QObject): gen_qimageiohandler_types.QImageIOPlugin =
  gen_qimageiohandler_types.QImageIOPlugin.init(fcQImageIOPlugin_new2(parent.h))

proc metaObject*(self: gen_qimageiohandler_types.QImageIOPlugin, ): QMetaObject =
  QMetaObject(h: fcQImageIOPlugin_metaObject(self.h))
...
proc capabilities*(self: gen_qimageiohandler_types.QImageIOPlugin, device: QIODevice, format: seq[byte]): cint =
...
proc create*(self: gen_qimageiohandler_types.QImageIOPlugin, device: QIODevice, format: seq[byte]): QImageIOHandler =
...
proc miqt_exec_callback_QImageIOPlugin_metacall(self: ptr cQImageIOPlugin, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QImageIOPlugin_metacall ".} =
  ...
  virtualReturn
type QImageIOPlugincapabilitiesProc* = proc(device: QIODevice, format: seq[byte]): cint
...
proc miqt_exec_callback_QImageIOPlugin_capabilities(self: ptr cQImageIOPlugin, slot: int, device: pointer, format: struct_miqt_string): cint {.exportc: "miqt_exec_callback_QImageIOPlugin_capabilities ".} =
  ...
  let slotval1 = QIODevice(h: device)
  ...
  cint(virtualReturn)
type QImageIOPlugincreateProc* = proc(device: QIODevice, format: seq[byte]): QImageIOHandler
...
proc miqt_exec_callback_QImageIOPlugin_create(self: ptr cQImageIOPlugin, slot: int, device: pointer, format: struct_miqt_string): pointer {.exportc: "miqt_exec_callback_QImageIOPlugin_create ".} =
  ...
  virtualReturn.h
proc QImageIOPluginevent*(self: gen_qimageiohandler_types.QImageIOPlugin, event: QEvent): bool =
  fQImageIOPlugin_virtualbase_event(self.h, event.h)

type QImageIOPlugineventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QImageIOPlugin_event(self: ptr cQImageIOPlugin, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QImageIOPlugin_event ".} =
  ...
  virtualReturn
proc QImageIOPlugineventFilter*(self: gen_qimageiohandler_types.QImageIOPlugin, watched: QObject, event: QEvent): bool =
  fQImageIOPlugin_virtualbase_eventFilter(self.h, watched.h, event.h)

type QImageIOPlugineventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QImageIOPlugin_eventFilter(self: ptr cQImageIOPlugin, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QImageIOPlugin_eventFilter ".} =
  ...
  virtualReturn
proc QImageIOPlugintimerEvent*(self: gen_qimageiohandler_types.QImageIOPlugin, event: QTimerEvent): void =
  fQImageIOPlugin_virtualbase_timerEvent(self.h, event.h)

type QImageIOPlugintimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QImageIOPlugin_timerEvent(self: ptr cQImageIOPlugin, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QImageIOPlugin_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QImageIOPluginchildEvent*(self: gen_qimageiohandler_types.QImageIOPlugin, event: QChildEvent): void =
  fQImageIOPlugin_virtualbase_childEvent(self.h, event.h)

type QImageIOPluginchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QImageIOPlugin_childEvent(self: ptr cQImageIOPlugin, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QImageIOPlugin_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QImageIOPlugincustomEvent*(self: gen_qimageiohandler_types.QImageIOPlugin, event: QEvent): void =
  fQImageIOPlugin_virtualbase_customEvent(self.h, event.h)

type QImageIOPlugincustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QImageIOPlugin_customEvent(self: ptr cQImageIOPlugin, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QImageIOPlugin_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QImageIOPluginconnectNotify*(self: gen_qimageiohandler_types.QImageIOPlugin, signal: QMetaMethod): void =
  fQImageIOPlugin_virtualbase_connectNotify(self.h, signal.h)

type QImageIOPluginconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QImageIOPlugin_connectNotify(self: ptr cQImageIOPlugin, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QImageIOPlugin_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QImageIOPlugindisconnectNotify*(self: gen_qimageiohandler_types.QImageIOPlugin, signal: QMetaMethod): void =
  fQImageIOPlugin_virtualbase_disconnectNotify(self.h, signal.h)

type QImageIOPlugindisconnectNotifyProc* = proc(signal: QMetaMethod): void
