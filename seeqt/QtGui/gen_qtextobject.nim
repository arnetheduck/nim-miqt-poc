...
func init*(T: type gen_qtextobject_types.QTextObject, h: ptr cQTextObject): gen_qtextobject_types.QTextObject =
  T(h: h)
proc metaObject*(self: gen_qtextobject_types.QTextObject, ): QMetaObject =
  QMetaObject(h: fcQTextObject_metaObject(self.h))
...
proc format*(self: gen_qtextobject_types.QTextObject, ): QTextFormat =
  QTextFormat(h: fcQTextObject_format(self.h))

proc formatIndex*(self: gen_qtextobject_types.QTextObject, ): cint =
  fcQTextObject_formatIndex(self.h)

proc document*(self: gen_qtextobject_types.QTextObject, ): QTextDocument =
  QTextDocument(h: fcQTextObject_document(self.h))
...
func init*(T: type gen_qtextobject_types.QTextBlockGroup, h: ptr cQTextBlockGroup): gen_qtextobject_types.QTextBlockGroup =
  T(h: h)
proc metaObject*(self: gen_qtextobject_types.QTextBlockGroup, ): QMetaObject =
  QMetaObject(h: fcQTextBlockGroup_metaObject(self.h))
...
func init*(T: type gen_qtextobject_types.QTextFrameLayoutData, h: ptr cQTextFrameLayoutData): gen_qtextobject_types.QTextFrameLayoutData =
  T(h: h)
proc operatorAssign*(self: gen_qtextobject_types.QTextFrameLayoutData, param1: QTextFrameLayoutData): void =
...
func init*(T: type gen_qtextobject_types.QTextFrame, h: ptr cQTextFrame): gen_qtextobject_types.QTextFrame =
  T(h: h)
proc create*(T: type gen_qtextobject_types.QTextFrame, doc: QTextDocument): gen_qtextobject_types.QTextFrame =
  gen_qtextobject_types.QTextFrame.init(fcQTextFrame_new(doc.h))

proc metaObject*(self: gen_qtextobject_types.QTextFrame, ): QMetaObject =
  QMetaObject(h: fcQTextFrame_metaObject(self.h))
...
proc setFrameFormat*(self: gen_qtextobject_types.QTextFrame, format: QTextFrameFormat): void =
  fcQTextFrame_setFrameFormat(self.h, format.h)

proc frameFormat*(self: gen_qtextobject_types.QTextFrame, ): QTextFrameFormat =
  QTextFrameFormat(h: fcQTextFrame_frameFormat(self.h))

proc firstCursorPosition*(self: gen_qtextobject_types.QTextFrame, ): QTextCursor =
  QTextCursor(h: fcQTextFrame_firstCursorPosition(self.h))

proc lastCursorPosition*(self: gen_qtextobject_types.QTextFrame, ): QTextCursor =
  QTextCursor(h: fcQTextFrame_lastCursorPosition(self.h))
...
proc layoutData*(self: gen_qtextobject_types.QTextFrame, ): QTextFrameLayoutData =
  QTextFrameLayoutData(h: fcQTextFrame_layoutData(self.h))

proc setLayoutData*(self: gen_qtextobject_types.QTextFrame, data: QTextFrameLayoutData): void =
  fcQTextFrame_setLayoutData(self.h, data.h)

proc childFrames*(self: gen_qtextobject_types.QTextFrame, ): seq[QTextFrame] =
...
proc parentFrame*(self: gen_qtextobject_types.QTextFrame, ): QTextFrame =
  QTextFrame(h: fcQTextFrame_parentFrame(self.h))

proc begin*(self: gen_qtextobject_types.QTextFrame, ): QTextFrameiterator =
  QTextFrameiterator(h: fcQTextFrame_begin(self.h))

proc endX*(self: gen_qtextobject_types.QTextFrame, ): QTextFrameiterator =
...
proc miqt_exec_callback_QTextFrame_metacall(self: ptr cQTextFrame, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QTextFrame_metacall ".} =
  ...
  virtualReturn
proc QTextFrameevent*(self: gen_qtextobject_types.QTextFrame, event: QEvent): bool =
  fQTextFrame_virtualbase_event(self.h, event.h)

type QTextFrameeventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QTextFrame_event(self: ptr cQTextFrame, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QTextFrame_event ".} =
  ...
  virtualReturn
proc QTextFrameeventFilter*(self: gen_qtextobject_types.QTextFrame, watched: QObject, event: QEvent): bool =
  fQTextFrame_virtualbase_eventFilter(self.h, watched.h, event.h)

type QTextFrameeventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QTextFrame_eventFilter(self: ptr cQTextFrame, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QTextFrame_eventFilter ".} =
  ...
  virtualReturn
proc QTextFrametimerEvent*(self: gen_qtextobject_types.QTextFrame, event: QTimerEvent): void =
  fQTextFrame_virtualbase_timerEvent(self.h, event.h)

type QTextFrametimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QTextFrame_timerEvent(self: ptr cQTextFrame, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTextFrame_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTextFramechildEvent*(self: gen_qtextobject_types.QTextFrame, event: QChildEvent): void =
  fQTextFrame_virtualbase_childEvent(self.h, event.h)

type QTextFramechildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QTextFrame_childEvent(self: ptr cQTextFrame, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTextFrame_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTextFramecustomEvent*(self: gen_qtextobject_types.QTextFrame, event: QEvent): void =
  fQTextFrame_virtualbase_customEvent(self.h, event.h)

type QTextFramecustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QTextFrame_customEvent(self: ptr cQTextFrame, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTextFrame_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTextFrameconnectNotify*(self: gen_qtextobject_types.QTextFrame, signal: QMetaMethod): void =
  fQTextFrame_virtualbase_connectNotify(self.h, signal.h)

type QTextFrameconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QTextFrame_connectNotify(self: ptr cQTextFrame, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QTextFrame_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QTextFramedisconnectNotify*(self: gen_qtextobject_types.QTextFrame, signal: QMetaMethod): void =
  fQTextFrame_virtualbase_disconnectNotify(self.h, signal.h)

type QTextFramedisconnectNotifyProc* = proc(signal: QMetaMethod): void
...
func init*(T: type gen_qtextobject_types.QTextBlockUserData, h: ptr cQTextBlockUserData): gen_qtextobject_types.QTextBlockUserData =
  T(h: h)
proc operatorAssign*(self: gen_qtextobject_types.QTextBlockUserData, param1: QTextBlockUserData): void =
...
proc create*(T: type gen_qtextobject_types.QTextBlock, o: QTextBlock): gen_qtextobject_types.QTextBlock =
  gen_qtextobject_types.QTextBlock.init(fcQTextBlock_new2(o.h))

proc operatorAssign*(self: gen_qtextobject_types.QTextBlock, o: QTextBlock): void =
  fcQTextBlock_operatorAssign(self.h, o.h)

proc isValid*(self: gen_qtextobject_types.QTextBlock, ): bool =
  fcQTextBlock_isValid(self.h)

proc operatorEqual*(self: gen_qtextobject_types.QTextBlock, o: QTextBlock): bool =
  fcQTextBlock_operatorEqual(self.h, o.h)

proc operatorNotEqual*(self: gen_qtextobject_types.QTextBlock, o: QTextBlock): bool =
  fcQTextBlock_operatorNotEqual(self.h, o.h)

proc operatorLesser*(self: gen_qtextobject_types.QTextBlock, o: QTextBlock): bool =
...
proc layout*(self: gen_qtextobject_types.QTextBlock, ): QTextLayout =
  QTextLayout(h: fcQTextBlock_layout(self.h))

proc clearLayout*(self: gen_qtextobject_types.QTextBlock, ): void =
  fcQTextBlock_clearLayout(self.h)

proc blockFormat*(self: gen_qtextobject_types.QTextBlock, ): QTextBlockFormat =
  QTextBlockFormat(h: fcQTextBlock_blockFormat(self.h))

proc blockFormatIndex*(self: gen_qtextobject_types.QTextBlock, ): cint =
  fcQTextBlock_blockFormatIndex(self.h)

proc charFormat*(self: gen_qtextobject_types.QTextBlock, ): QTextCharFormat =
  QTextCharFormat(h: fcQTextBlock_charFormat(self.h))
...
proc textFormats*(self: gen_qtextobject_types.QTextBlock, ): seq[QTextLayoutFormatRange] =
...
proc document*(self: gen_qtextobject_types.QTextBlock, ): QTextDocument =
  QTextDocument(h: fcQTextBlock_document(self.h))

proc textList*(self: gen_qtextobject_types.QTextBlock, ): QTextList =
  QTextList(h: fcQTextBlock_textList(self.h))

proc userData*(self: gen_qtextobject_types.QTextBlock, ): QTextBlockUserData =
  QTextBlockUserData(h: fcQTextBlock_userData(self.h))

proc setUserData*(self: gen_qtextobject_types.QTextBlock, data: QTextBlockUserData): void =
...
proc begin*(self: gen_qtextobject_types.QTextBlock, ): QTextBlockiterator =
  QTextBlockiterator(h: fcQTextBlock_begin(self.h))

proc endX*(self: gen_qtextobject_types.QTextBlock, ): QTextBlockiterator =
  QTextBlockiterator(h: fcQTextBlock_endX(self.h))

proc next*(self: gen_qtextobject_types.QTextBlock, ): QTextBlock =
  QTextBlock(h: fcQTextBlock_next(self.h))

proc previous*(self: gen_qtextobject_types.QTextBlock, ): QTextBlock =
...
proc create*(T: type gen_qtextobject_types.QTextFragment, o: QTextFragment): gen_qtextobject_types.QTextFragment =
  gen_qtextobject_types.QTextFragment.init(fcQTextFragment_new2(o.h))

proc operatorAssign*(self: gen_qtextobject_types.QTextFragment, o: QTextFragment): void =
...
proc operatorEqual*(self: gen_qtextobject_types.QTextFragment, o: QTextFragment): bool =
  fcQTextFragment_operatorEqual(self.h, o.h)

proc operatorNotEqual*(self: gen_qtextobject_types.QTextFragment, o: QTextFragment): bool =
  fcQTextFragment_operatorNotEqual(self.h, o.h)

proc operatorLesser*(self: gen_qtextobject_types.QTextFragment, o: QTextFragment): bool =
...
proc charFormat*(self: gen_qtextobject_types.QTextFragment, ): QTextCharFormat =
  QTextCharFormat(h: fcQTextFragment_charFormat(self.h))
...
proc glyphRuns*(self: gen_qtextobject_types.QTextFragment, ): seq[QGlyphRun] =
  var v_ma = fcQTextFragment_glyphRuns(self.h)
  var vx_ret = newSeq[QGlyphRun](int(v_ma.len))
  let v_outCast = cast[ptr UncheckedArray[pointer]](v_ma.data)
  for i in 0 ..< v_ma.len:
    vx_ret[i] = QGlyphRun(h: v_outCast[i])
  vx_ret

proc glyphRuns*(self: gen_qtextobject_types.QTextFragment, fromVal: cint): seq[QGlyphRun] =
...
proc glyphRuns*(self: gen_qtextobject_types.QTextFragment, fromVal: cint, length: cint): seq[QGlyphRun] =
...
proc create*(T: type gen_qtextobject_types.QTextFrameiterator, o: QTextFrameiterator): gen_qtextobject_types.QTextFrameiterator =
  gen_qtextobject_types.QTextFrameiterator.init(fcQTextFrameiterator_new2(o.h))

proc operatorAssign*(self: gen_qtextobject_types.QTextFrameiterator, o: QTextFrameiterator): void =
  fcQTextFrameiterator_operatorAssign(self.h, o.h)

proc parentFrame*(self: gen_qtextobject_types.QTextFrameiterator, ): QTextFrame =
  QTextFrame(h: fcQTextFrameiterator_parentFrame(self.h))

proc currentFrame*(self: gen_qtextobject_types.QTextFrameiterator, ): QTextFrame =
  QTextFrame(h: fcQTextFrameiterator_currentFrame(self.h))

proc currentBlock*(self: gen_qtextobject_types.QTextFrameiterator, ): QTextBlock =
...
proc operatorEqual*(self: gen_qtextobject_types.QTextFrameiterator, o: QTextFrameiterator): bool =
  fcQTextFrameiterator_operatorEqual(self.h, o.h)

proc operatorNotEqual*(self: gen_qtextobject_types.QTextFrameiterator, o: QTextFrameiterator): bool =
  fcQTextFrameiterator_operatorNotEqual(self.h, o.h)

proc operatorPlusPlus*(self: gen_qtextobject_types.QTextFrameiterator, ): QTextFrameiterator =
  QTextFrameiterator(h: fcQTextFrameiterator_operatorPlusPlus(self.h))

proc operatorPlusPlus*(self: gen_qtextobject_types.QTextFrameiterator, param1: cint): QTextFrameiterator =
  QTextFrameiterator(h: fcQTextFrameiterator_operatorPlusPlusWithInt(self.h, param1))

proc operatorMinusMinus*(self: gen_qtextobject_types.QTextFrameiterator, ): QTextFrameiterator =
  QTextFrameiterator(h: fcQTextFrameiterator_operatorMinusMinus(self.h))

proc operatorMinusMinus*(self: gen_qtextobject_types.QTextFrameiterator, param1: cint): QTextFrameiterator =
...
proc create*(T: type gen_qtextobject_types.QTextBlockiterator, o: QTextBlockiterator): gen_qtextobject_types.QTextBlockiterator =
  gen_qtextobject_types.QTextBlockiterator.init(fcQTextBlockiterator_new2(o.h))

proc operatorAssign*(self: gen_qtextobject_types.QTextBlockiterator, o: QTextBlockiterator): void =
  fcQTextBlockiterator_operatorAssign(self.h, o.h)

proc fragment*(self: gen_qtextobject_types.QTextBlockiterator, ): QTextFragment =
...
proc operatorEqual*(self: gen_qtextobject_types.QTextBlockiterator, o: QTextBlockiterator): bool =
  fcQTextBlockiterator_operatorEqual(self.h, o.h)

proc operatorNotEqual*(self: gen_qtextobject_types.QTextBlockiterator, o: QTextBlockiterator): bool =
  fcQTextBlockiterator_operatorNotEqual(self.h, o.h)

proc operatorPlusPlus*(self: gen_qtextobject_types.QTextBlockiterator, ): QTextBlockiterator =
  QTextBlockiterator(h: fcQTextBlockiterator_operatorPlusPlus(self.h))

proc operatorPlusPlus*(self: gen_qtextobject_types.QTextBlockiterator, param1: cint): QTextBlockiterator =
  QTextBlockiterator(h: fcQTextBlockiterator_operatorPlusPlusWithInt(self.h, param1))

proc operatorMinusMinus*(self: gen_qtextobject_types.QTextBlockiterator, ): QTextBlockiterator =
  QTextBlockiterator(h: fcQTextBlockiterator_operatorMinusMinus(self.h))

proc operatorMinusMinus*(self: gen_qtextobject_types.QTextBlockiterator, param1: cint): QTextBlockiterator =
