...
proc create*(T: type gen_qcolortransform_types.QColorTransform, colorTransform: QColorTransform): gen_qcolortransform_types.QColorTransform =
  gen_qcolortransform_types.QColorTransform.init(fcQColorTransform_new2(colorTransform.h))

proc operatorAssign*(self: gen_qcolortransform_types.QColorTransform, other: QColorTransform): void =
  fcQColorTransform_operatorAssign(self.h, other.h)

proc swap*(self: gen_qcolortransform_types.QColorTransform, other: QColorTransform): void =
...
proc map*(self: gen_qcolortransform_types.QColorTransform, rgba64: QRgba64): QRgba64 =
  QRgba64(h: fcQColorTransform_mapWithRgba64(self.h, rgba64.h))

proc map*(self: gen_qcolortransform_types.QColorTransform, color: QColor): QColor =
  QColor(h: fcQColorTransform_mapWithColor(self.h, color.h))
