...
func init*(T: type gen_qbackingstore_types.QBackingStore, h: ptr cQBackingStore): gen_qbackingstore_types.QBackingStore =
  T(h: h)
proc create*(T: type gen_qbackingstore_types.QBackingStore, window: QWindow): gen_qbackingstore_types.QBackingStore =
  gen_qbackingstore_types.QBackingStore.init(fcQBackingStore_new(window.h))

proc window*(self: gen_qbackingstore_types.QBackingStore, ): QWindow =
  QWindow(h: fcQBackingStore_window(self.h))

proc paintDevice*(self: gen_qbackingstore_types.QBackingStore, ): QPaintDevice =
  QPaintDevice(h: fcQBackingStore_paintDevice(self.h))

proc flush*(self: gen_qbackingstore_types.QBackingStore, region: QRegion): void =
  fcQBackingStore_flush(self.h, region.h)

proc resize*(self: gen_qbackingstore_types.QBackingStore, size: QSize): void =
  fcQBackingStore_resize(self.h, size.h)

proc size*(self: gen_qbackingstore_types.QBackingStore, ): QSize =
  QSize(h: fcQBackingStore_size(self.h))

proc scroll*(self: gen_qbackingstore_types.QBackingStore, area: QRegion, dx: cint, dy: cint): bool =
  fcQBackingStore_scroll(self.h, area.h, dx, dy)

proc beginPaint*(self: gen_qbackingstore_types.QBackingStore, param1: QRegion): void =
...
proc setStaticContents*(self: gen_qbackingstore_types.QBackingStore, region: QRegion): void =
  fcQBackingStore_setStaticContents(self.h, region.h)

proc staticContents*(self: gen_qbackingstore_types.QBackingStore, ): QRegion =
  QRegion(h: fcQBackingStore_staticContents(self.h))

proc hasStaticContents*(self: gen_qbackingstore_types.QBackingStore, ): bool =
  fcQBackingStore_hasStaticContents(self.h)

proc flush*(self: gen_qbackingstore_types.QBackingStore, region: QRegion, window: QWindow): void =
  fcQBackingStore_flush2(self.h, region.h, window.h)

proc flush*(self: gen_qbackingstore_types.QBackingStore, region: QRegion, window: QWindow, offset: QPoint): void =
