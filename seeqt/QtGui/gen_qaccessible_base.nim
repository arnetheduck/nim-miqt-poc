...
func init*(T: type gen_qaccessible_base_types.QAccessible, h: ptr cQAccessible): gen_qaccessible_base_types.QAccessible =
  T(h: h)
proc installActivationObserver*(_: type gen_qaccessible_base_types.QAccessible, param1: QAccessibleActivationObserver): void =
  fcQAccessible_installActivationObserver(param1.h)

proc removeActivationObserver*(_: type gen_qaccessible_base_types.QAccessible, param1: QAccessibleActivationObserver): void =
  fcQAccessible_removeActivationObserver(param1.h)

proc queryAccessibleInterface*(_: type gen_qaccessible_base_types.QAccessible, param1: QObject): QAccessibleInterface =
  QAccessibleInterface(h: fcQAccessible_queryAccessibleInterface(param1.h))

proc uniqueId*(_: type gen_qaccessible_base_types.QAccessible, iface: QAccessibleInterface): cuint =
  fcQAccessible_uniqueId(iface.h)

proc accessibleInterface*(_: type gen_qaccessible_base_types.QAccessible, uniqueId: cuint): QAccessibleInterface =
  QAccessibleInterface(h: fcQAccessible_accessibleInterface(uniqueId))

proc registerAccessibleInterface*(_: type gen_qaccessible_base_types.QAccessible, iface: QAccessibleInterface): cuint =
...
proc updateAccessibility*(_: type gen_qaccessible_base_types.QAccessible, event: QAccessibleEvent): void =
...
proc setRootObject*(_: type gen_qaccessible_base_types.QAccessible, objectVal: QObject): void =
...
proc qAccessibleTextBoundaryHelper*(_: type gen_qaccessible_base_types.QAccessible, cursor: QTextCursor, boundaryType: cint): tuple[first: cint, second: cint] =
...
proc operatorAssign*(self: gen_qaccessible_base_types.QAccessibleActivationObserver, param1: QAccessibleActivationObserver): void =
