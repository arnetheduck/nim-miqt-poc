...
proc metaObject*(self: gen_qguiapplication_types.QGuiApplication, ): QMetaObject =
  QMetaObject(h: fcQGuiApplication_metaObject(self.h))
...
proc allWindows*(_: type gen_qguiapplication_types.QGuiApplication, ): seq[QWindow] =
  var v_ma = fcQGuiApplication_allWindows()
  var vx_ret = newSeq[QWindow](int(v_ma.len))
  let v_outCast = cast[ptr UncheckedArray[pointer]](v_ma.data)
  for i in 0 ..< v_ma.len:
    vx_ret[i] = QWindow(h: v_outCast[i])
  vx_ret

proc topLevelWindows*(_: type gen_qguiapplication_types.QGuiApplication, ): seq[QWindow] =
...
proc topLevelAt*(_: type gen_qguiapplication_types.QGuiApplication, pos: QPoint): QWindow =
  QWindow(h: fcQGuiApplication_topLevelAt(pos.h))

proc setWindowIcon*(_: type gen_qguiapplication_types.QGuiApplication, icon: QIcon): void =
  fcQGuiApplication_setWindowIcon(icon.h)

proc windowIcon*(_: type gen_qguiapplication_types.QGuiApplication, ): QIcon =
  QIcon(h: fcQGuiApplication_windowIcon())
...
proc modalWindow*(_: type gen_qguiapplication_types.QGuiApplication, ): QWindow =
  QWindow(h: fcQGuiApplication_modalWindow())

proc focusWindow*(_: type gen_qguiapplication_types.QGuiApplication, ): QWindow =
  QWindow(h: fcQGuiApplication_focusWindow())

proc focusObject*(_: type gen_qguiapplication_types.QGuiApplication, ): QObject =
  QObject(h: fcQGuiApplication_focusObject())

proc primaryScreen*(_: type gen_qguiapplication_types.QGuiApplication, ): QScreen =
  QScreen(h: fcQGuiApplication_primaryScreen())

proc screens*(_: type gen_qguiapplication_types.QGuiApplication, ): seq[QScreen] =
...
proc screenAt*(_: type gen_qguiapplication_types.QGuiApplication, point: QPoint): QScreen =
  QScreen(h: fcQGuiApplication_screenAt(point.h))

proc devicePixelRatio*(self: gen_qguiapplication_types.QGuiApplication, ): float64 =
  fcQGuiApplication_devicePixelRatio(self.h)

proc overrideCursor*(_: type gen_qguiapplication_types.QGuiApplication, ): QCursor =
  QCursor(h: fcQGuiApplication_overrideCursor())

proc setOverrideCursor*(_: type gen_qguiapplication_types.QGuiApplication, overrideCursor: QCursor): void =
  fcQGuiApplication_setOverrideCursor(overrideCursor.h)

proc changeOverrideCursor*(_: type gen_qguiapplication_types.QGuiApplication, param1: QCursor): void =
...
proc font*(_: type gen_qguiapplication_types.QGuiApplication, ): QFont =
  QFont(h: fcQGuiApplication_font())

proc setFont*(_: type gen_qguiapplication_types.QGuiApplication, font: QFont): void =
  fcQGuiApplication_setFont(font.h)

proc clipboard*(_: type gen_qguiapplication_types.QGuiApplication, ): QClipboard =
  QClipboard(h: fcQGuiApplication_clipboard())

proc palette*(_: type gen_qguiapplication_types.QGuiApplication, ): QPalette =
  QPalette(h: fcQGuiApplication_palette())

proc setPalette*(_: type gen_qguiapplication_types.QGuiApplication, pal: QPalette): void =
...
proc styleHints*(_: type gen_qguiapplication_types.QGuiApplication, ): QStyleHints =
  QStyleHints(h: fcQGuiApplication_styleHints())
...
proc inputMethod*(_: type gen_qguiapplication_types.QGuiApplication, ): QInputMethod =
  QInputMethod(h: fcQGuiApplication_inputMethod())
...
proc notify*(self: gen_qguiapplication_types.QGuiApplication, param1: QObject, param2: QEvent): bool =
...
proc screenAdded*(self: gen_qguiapplication_types.QGuiApplication, screen: QScreen): void =
  fcQGuiApplication_screenAdded(self.h, screen.h)

type QGuiApplicationscreenAddedSlot* = proc(screen: QScreen)
...
proc screenRemoved*(self: gen_qguiapplication_types.QGuiApplication, screen: QScreen): void =
  fcQGuiApplication_screenRemoved(self.h, screen.h)

type QGuiApplicationscreenRemovedSlot* = proc(screen: QScreen)
...
proc primaryScreenChanged*(self: gen_qguiapplication_types.QGuiApplication, screen: QScreen): void =
  fcQGuiApplication_primaryScreenChanged(self.h, screen.h)

type QGuiApplicationprimaryScreenChangedSlot* = proc(screen: QScreen)
...
proc focusObjectChanged*(self: gen_qguiapplication_types.QGuiApplication, focusObject: QObject): void =
  fcQGuiApplication_focusObjectChanged(self.h, focusObject.h)

type QGuiApplicationfocusObjectChangedSlot* = proc(focusObject: QObject)
proc miqt_exec_callback_QGuiApplication_focusObjectChanged(slot: int, focusObject: pointer) {.exportc.} =
  ...
  let slotval1 = QObject(h: focusObject)
...
proc focusWindowChanged*(self: gen_qguiapplication_types.QGuiApplication, focusWindow: QWindow): void =
  fcQGuiApplication_focusWindowChanged(self.h, focusWindow.h)

type QGuiApplicationfocusWindowChangedSlot* = proc(focusWindow: QWindow)
proc miqt_exec_callback_QGuiApplication_focusWindowChanged(slot: int, focusWindow: pointer) {.exportc.} =
  ...
  let slotval1 = QWindow(h: focusWindow)
...
proc commitDataRequest*(self: gen_qguiapplication_types.QGuiApplication, sessionManager: QSessionManager): void =
  fcQGuiApplication_commitDataRequest(self.h, sessionManager.h)

type QGuiApplicationcommitDataRequestSlot* = proc(sessionManager: QSessionManager)
proc miqt_exec_callback_QGuiApplication_commitDataRequest(slot: int, sessionManager: pointer) {.exportc.} =
  ...
  let slotval1 = QSessionManager(h: sessionManager)
...
proc saveStateRequest*(self: gen_qguiapplication_types.QGuiApplication, sessionManager: QSessionManager): void =
  fcQGuiApplication_saveStateRequest(self.h, sessionManager.h)

type QGuiApplicationsaveStateRequestSlot* = proc(sessionManager: QSessionManager)
...
proc paletteChanged*(self: gen_qguiapplication_types.QGuiApplication, pal: QPalette): void =
  fcQGuiApplication_paletteChanged(self.h, pal.h)

type QGuiApplicationpaletteChangedSlot* = proc(pal: QPalette)
...
proc fontChanged*(self: gen_qguiapplication_types.QGuiApplication, font: QFont): void =
  fcQGuiApplication_fontChanged(self.h, font.h)

type QGuiApplicationfontChangedSlot* = proc(font: QFont)
...
proc miqt_exec_callback_QGuiApplication_metacall(self: ptr cQGuiApplication, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QGuiApplication_metacall ".} =
  ...
  virtualReturn
proc QGuiApplicationnotify*(self: gen_qguiapplication_types.QGuiApplication, param1: QObject, param2: QEvent): bool =
  fQGuiApplication_virtualbase_notify(self.h, param1.h, param2.h)

type QGuiApplicationnotifyProc* = proc(param1: QObject, param2: QEvent): bool
...
proc miqt_exec_callback_QGuiApplication_notify(self: ptr cQGuiApplication, slot: int, param1: pointer, param2: pointer): bool {.exportc: "miqt_exec_callback_QGuiApplication_notify ".} =
  ...
  virtualReturn
proc QGuiApplicationevent*(self: gen_qguiapplication_types.QGuiApplication, param1: QEvent): bool =
  fQGuiApplication_virtualbase_event(self.h, param1.h)

type QGuiApplicationeventProc* = proc(param1: QEvent): bool
...
proc miqt_exec_callback_QGuiApplication_event(self: ptr cQGuiApplication, slot: int, param1: pointer): bool {.exportc: "miqt_exec_callback_QGuiApplication_event ".} =
  ...
  virtualReturn
proc QGuiApplicationeventFilter*(self: gen_qguiapplication_types.QGuiApplication, watched: QObject, event: QEvent): bool =
  fQGuiApplication_virtualbase_eventFilter(self.h, watched.h, event.h)

type QGuiApplicationeventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QGuiApplication_eventFilter(self: ptr cQGuiApplication, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QGuiApplication_eventFilter ".} =
  ...
  virtualReturn
proc QGuiApplicationtimerEvent*(self: gen_qguiapplication_types.QGuiApplication, event: QTimerEvent): void =
  fQGuiApplication_virtualbase_timerEvent(self.h, event.h)

type QGuiApplicationtimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QGuiApplication_timerEvent(self: ptr cQGuiApplication, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGuiApplication_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGuiApplicationchildEvent*(self: gen_qguiapplication_types.QGuiApplication, event: QChildEvent): void =
  fQGuiApplication_virtualbase_childEvent(self.h, event.h)

type QGuiApplicationchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QGuiApplication_childEvent(self: ptr cQGuiApplication, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGuiApplication_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGuiApplicationcustomEvent*(self: gen_qguiapplication_types.QGuiApplication, event: QEvent): void =
  fQGuiApplication_virtualbase_customEvent(self.h, event.h)

type QGuiApplicationcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QGuiApplication_customEvent(self: ptr cQGuiApplication, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGuiApplication_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGuiApplicationconnectNotify*(self: gen_qguiapplication_types.QGuiApplication, signal: QMetaMethod): void =
  fQGuiApplication_virtualbase_connectNotify(self.h, signal.h)

type QGuiApplicationconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QGuiApplication_connectNotify(self: ptr cQGuiApplication, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QGuiApplication_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QGuiApplicationdisconnectNotify*(self: gen_qguiapplication_types.QGuiApplication, signal: QMetaMethod): void =
  fQGuiApplication_virtualbase_disconnectNotify(self.h, signal.h)

type QGuiApplicationdisconnectNotifyProc* = proc(signal: QMetaMethod): void
