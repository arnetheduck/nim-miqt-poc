...
proc create*(T: type gen_qpixmap_types.QPixmap, param1: QSize): gen_qpixmap_types.QPixmap =
...
proc create*(T: type gen_qpixmap_types.QPixmap, param1: QPixmap): gen_qpixmap_types.QPixmap =
...
proc operatorAssign*(self: gen_qpixmap_types.QPixmap, param1: QPixmap): void =
  fcQPixmap_operatorAssign(self.h, param1.h)

proc swap*(self: gen_qpixmap_types.QPixmap, other: QPixmap): void =
  fcQPixmap_swap(self.h, other.h)

proc ToQVariant*(self: gen_qpixmap_types.QPixmap, ): QVariant =
  QVariant(h: fcQPixmap_ToQVariant(self.h))
...
proc size*(self: gen_qpixmap_types.QPixmap, ): QSize =
  QSize(h: fcQPixmap_size(self.h))

proc rect*(self: gen_qpixmap_types.QPixmap, ): QRect =
  QRect(h: fcQPixmap_rect(self.h))
...
proc fill*(self: gen_qpixmap_types.QPixmap, device: QPaintDevice, ofs: QPoint): void =
  fcQPixmap_fill2(self.h, device.h, ofs.h)

proc fill*(self: gen_qpixmap_types.QPixmap, device: QPaintDevice, xofs: cint, yofs: cint): void =
  fcQPixmap_fill3(self.h, device.h, xofs, yofs)

proc mask*(self: gen_qpixmap_types.QPixmap, ): QBitmap =
  QBitmap(h: fcQPixmap_mask(self.h))

proc setMask*(self: gen_qpixmap_types.QPixmap, mask: QBitmap): void =
...
proc createHeuristicMask*(self: gen_qpixmap_types.QPixmap, ): QBitmap =
  QBitmap(h: fcQPixmap_createHeuristicMask(self.h))

proc createMaskFromColor*(self: gen_qpixmap_types.QPixmap, maskColor: QColor): QBitmap =
  QBitmap(h: fcQPixmap_createMaskFromColor(self.h, maskColor.h))

proc grabWindow*(_: type gen_qpixmap_types.QPixmap, param1: uint): QPixmap =
  QPixmap(h: fcQPixmap_grabWindow(param1))

proc grabWidget*(_: type gen_qpixmap_types.QPixmap, widget: QObject, rect: QRect): QPixmap =
  QPixmap(h: fcQPixmap_grabWidget(widget.h, rect.h))

proc grabWidget*(_: type gen_qpixmap_types.QPixmap, widget: QObject): QPixmap =
  QPixmap(h: fcQPixmap_grabWidgetWithWidget(widget.h))

proc scaled*(self: gen_qpixmap_types.QPixmap, w: cint, h: cint): QPixmap =
  QPixmap(h: fcQPixmap_scaled(self.h, w, h))

proc scaled*(self: gen_qpixmap_types.QPixmap, s: QSize): QPixmap =
  QPixmap(h: fcQPixmap_scaledWithQSize(self.h, s.h))

proc scaledToWidth*(self: gen_qpixmap_types.QPixmap, w: cint): QPixmap =
  QPixmap(h: fcQPixmap_scaledToWidth(self.h, w))

proc scaledToHeight*(self: gen_qpixmap_types.QPixmap, h: cint): QPixmap =
  QPixmap(h: fcQPixmap_scaledToHeight(self.h, h))

proc transformed*(self: gen_qpixmap_types.QPixmap, param1: QMatrix): QPixmap =
  QPixmap(h: fcQPixmap_transformed(self.h, param1.h))

proc trueMatrix*(_: type gen_qpixmap_types.QPixmap, m: QMatrix, w: cint, h: cint): QMatrix =
  QMatrix(h: fcQPixmap_trueMatrix(m.h, w, h))

proc transformed*(self: gen_qpixmap_types.QPixmap, param1: QTransform): QPixmap =
  QPixmap(h: fcQPixmap_transformedWithQTransform(self.h, param1.h))

proc trueMatrix*(_: type gen_qpixmap_types.QPixmap, m: QTransform, w: cint, h: cint): QTransform =
  QTransform(h: fcQPixmap_trueMatrix2(m.h, w, h))

proc toImage*(self: gen_qpixmap_types.QPixmap, ): QImage =
  QImage(h: fcQPixmap_toImage(self.h))

proc fromImage*(_: type gen_qpixmap_types.QPixmap, image: QImage): QPixmap =
  QPixmap(h: fcQPixmap_fromImage(image.h))

proc fromImageReader*(_: type gen_qpixmap_types.QPixmap, imageReader: QImageReader): QPixmap =
...
proc save*(self: gen_qpixmap_types.QPixmap, device: QIODevice): bool =
  fcQPixmap_saveWithDevice(self.h, device.h)

proc convertFromImage*(self: gen_qpixmap_types.QPixmap, img: QImage): bool =
  fcQPixmap_convertFromImage(self.h, img.h)

proc copy*(self: gen_qpixmap_types.QPixmap, x: cint, y: cint, width: cint, height: cint): QPixmap =
  QPixmap(h: fcQPixmap_copy(self.h, x, y, width, height))

proc copy*(self: gen_qpixmap_types.QPixmap, ): QPixmap =
...
proc scroll*(self: gen_qpixmap_types.QPixmap, dx: cint, dy: cint, rect: QRect): void =
...
proc paintEngine*(self: gen_qpixmap_types.QPixmap, ): QPaintEngine =
  QPaintEngine(h: fcQPixmap_paintEngine(self.h))

proc operatorNot*(self: gen_qpixmap_types.QPixmap, ): bool =
  fcQPixmap_operatorNot(self.h)

proc fill*(self: gen_qpixmap_types.QPixmap, fillColor: QColor): void =
  fcQPixmap_fill1(self.h, fillColor.h)

proc createHeuristicMask*(self: gen_qpixmap_types.QPixmap, clipTight: bool): QBitmap =
  QBitmap(h: fcQPixmap_createHeuristicMask1(self.h, clipTight))

proc createMaskFromColor*(self: gen_qpixmap_types.QPixmap, maskColor: QColor, mode: cint): QBitmap =
  QBitmap(h: fcQPixmap_createMaskFromColor2(self.h, maskColor.h, cint(mode)))

proc grabWindow*(_: type gen_qpixmap_types.QPixmap, param1: uint, x: cint): QPixmap =
  QPixmap(h: fcQPixmap_grabWindow2(param1, x))

proc grabWindow*(_: type gen_qpixmap_types.QPixmap, param1: uint, x: cint, y: cint): QPixmap =
  QPixmap(h: fcQPixmap_grabWindow3(param1, x, y))

proc grabWindow*(_: type gen_qpixmap_types.QPixmap, param1: uint, x: cint, y: cint, w: cint): QPixmap =
  QPixmap(h: fcQPixmap_grabWindow4(param1, x, y, w))

proc grabWindow*(_: type gen_qpixmap_types.QPixmap, param1: uint, x: cint, y: cint, w: cint, h: cint): QPixmap =
  QPixmap(h: fcQPixmap_grabWindow5(param1, x, y, w, h))

proc grabWidget*(_: type gen_qpixmap_types.QPixmap, widget: QObject, x: cint): QPixmap =
  QPixmap(h: fcQPixmap_grabWidget2(widget.h, x))

proc grabWidget*(_: type gen_qpixmap_types.QPixmap, widget: QObject, x: cint, y: cint): QPixmap =
  QPixmap(h: fcQPixmap_grabWidget3(widget.h, x, y))

proc grabWidget*(_: type gen_qpixmap_types.QPixmap, widget: QObject, x: cint, y: cint, w: cint): QPixmap =
  QPixmap(h: fcQPixmap_grabWidget4(widget.h, x, y, w))

proc grabWidget*(_: type gen_qpixmap_types.QPixmap, widget: QObject, x: cint, y: cint, w: cint, h: cint): QPixmap =
  QPixmap(h: fcQPixmap_grabWidget5(widget.h, x, y, w, h))

proc scaled*(self: gen_qpixmap_types.QPixmap, w: cint, h: cint, aspectMode: cint): QPixmap =
  QPixmap(h: fcQPixmap_scaled3(self.h, w, h, cint(aspectMode)))

proc scaled*(self: gen_qpixmap_types.QPixmap, w: cint, h: cint, aspectMode: cint, mode: cint): QPixmap =
  QPixmap(h: fcQPixmap_scaled4(self.h, w, h, cint(aspectMode), cint(mode)))

proc scaled*(self: gen_qpixmap_types.QPixmap, s: QSize, aspectMode: cint): QPixmap =
  QPixmap(h: fcQPixmap_scaled2(self.h, s.h, cint(aspectMode)))

proc scaled*(self: gen_qpixmap_types.QPixmap, s: QSize, aspectMode: cint, mode: cint): QPixmap =
  QPixmap(h: fcQPixmap_scaled32(self.h, s.h, cint(aspectMode), cint(mode)))

proc scaledToWidth*(self: gen_qpixmap_types.QPixmap, w: cint, mode: cint): QPixmap =
  QPixmap(h: fcQPixmap_scaledToWidth2(self.h, w, cint(mode)))

proc scaledToHeight*(self: gen_qpixmap_types.QPixmap, h: cint, mode: cint): QPixmap =
  QPixmap(h: fcQPixmap_scaledToHeight2(self.h, h, cint(mode)))

proc transformed*(self: gen_qpixmap_types.QPixmap, param1: QMatrix, mode: cint): QPixmap =
  QPixmap(h: fcQPixmap_transformed2(self.h, param1.h, cint(mode)))

proc transformed*(self: gen_qpixmap_types.QPixmap, param1: QTransform, mode: cint): QPixmap =
  QPixmap(h: fcQPixmap_transformed22(self.h, param1.h, cint(mode)))

proc fromImage*(_: type gen_qpixmap_types.QPixmap, image: QImage, flags: cint): QPixmap =
  QPixmap(h: fcQPixmap_fromImage2(image.h, cint(flags)))

proc fromImageReader*(_: type gen_qpixmap_types.QPixmap, imageReader: QImageReader, flags: cint): QPixmap =
...
proc save*(self: gen_qpixmap_types.QPixmap, device: QIODevice, format: cstring): bool =
  fcQPixmap_save22(self.h, device.h, format)

proc save*(self: gen_qpixmap_types.QPixmap, device: QIODevice, format: cstring, quality: cint): bool =
  fcQPixmap_save32(self.h, device.h, format, quality)

proc convertFromImage*(self: gen_qpixmap_types.QPixmap, img: QImage, flags: cint): bool =
  fcQPixmap_convertFromImage2(self.h, img.h, cint(flags))

proc copy*(self: gen_qpixmap_types.QPixmap, rect: QRect): QPixmap =
  QPixmap(h: fcQPixmap_copy1(self.h, rect.h))

proc scroll*(self: gen_qpixmap_types.QPixmap, dx: cint, dy: cint, x: cint, y: cint, width: cint, height: cint, exposed: QRegion): void =
  fcQPixmap_scroll7(self.h, dx, dy, x, y, width, height, exposed.h)

proc scroll*(self: gen_qpixmap_types.QPixmap, dx: cint, dy: cint, rect: QRect, exposed: QRegion): void =
...
proc miqt_exec_callback_QPixmap_devType(self: ptr cQPixmap, slot: int): cint {.exportc: "miqt_exec_callback_QPixmap_devType ".} =
  ...
  virtualReturn
proc QPixmappaintEngine*(self: gen_qpixmap_types.QPixmap, ): QPaintEngine =
  QPaintEngine(h: fQPixmap_virtualbase_paintEngine(self.h))

type QPixmappaintEngineProc* = proc(): QPaintEngine
...
proc miqt_exec_callback_QPixmap_metric(self: ptr cQPixmap, slot: int, param1: cint): cint {.exportc: "miqt_exec_callback_QPixmap_metric ".} =
  ...
  virtualReturn
proc QPixmapinitPainter*(self: gen_qpixmap_types.QPixmap, painter: QPainter): void =
  fQPixmap_virtualbase_initPainter(self.h, painter.h)

type QPixmapinitPainterProc* = proc(painter: QPainter): void
...
proc miqt_exec_callback_QPixmap_initPainter(self: ptr cQPixmap, slot: int, painter: pointer): void {.exportc: "miqt_exec_callback_QPixmap_initPainter ".} =
  ...
  nimfunc[](slotval1)
proc QPixmapredirected*(self: gen_qpixmap_types.QPixmap, offset: QPoint): QPaintDevice =
  QPaintDevice(h: fQPixmap_virtualbase_redirected(self.h, offset.h))

type QPixmapredirectedProc* = proc(offset: QPoint): QPaintDevice
...
proc miqt_exec_callback_QPixmap_redirected(self: ptr cQPixmap, slot: int, offset: pointer): pointer {.exportc: "miqt_exec_callback_QPixmap_redirected ".} =
  ...
  virtualReturn.h
proc QPixmapsharedPainter*(self: gen_qpixmap_types.QPixmap, ): QPainter =
  QPainter(h: fQPixmap_virtualbase_sharedPainter(self.h))

type QPixmapsharedPainterProc* = proc(): QPainter
