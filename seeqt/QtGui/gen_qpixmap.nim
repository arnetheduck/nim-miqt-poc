...
proc deviceIndependentSize*(self: gen_qpixmap_types.QPixmap, ): QSizeF =
  QSizeF(h: fcQPixmap_deviceIndependentSize(self.h))
...
proc trueMatrix*(_: type gen_qpixmap_types.QPixmap, m: QTransform, w: cint, h: cint): QTransform =
  QTransform(h: fcQPixmap_trueMatrix(m.h, w, h))
