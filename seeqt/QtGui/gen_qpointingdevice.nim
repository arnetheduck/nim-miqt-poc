...
proc create*(T: type gen_qpointingdevice_types.QPointingDeviceUniqueId, param1: QPointingDeviceUniqueId): gen_qpointingdevice_types.QPointingDeviceUniqueId =
  gen_qpointingdevice_types.QPointingDeviceUniqueId.init(fcQPointingDeviceUniqueId_new2(param1.h))

proc fromNumericId*(_: type gen_qpointingdevice_types.QPointingDeviceUniqueId, id: clonglong): QPointingDeviceUniqueId =
...
proc create*(T: type gen_qpointingdevice_types.QPointingDevice, parent: QObject): gen_qpointingdevice_types.QPointingDevice =
...
proc create*(T: type gen_qpointingdevice_types.QPointingDevice, name: string, systemId: clonglong, devType: cint, pType: cint, caps: cint, maxPoints: cint, buttonCount: cint, seatName: string, uniqueId: QPointingDeviceUniqueId): gen_qpointingdevice_types.QPointingDevice =
...
proc create*(T: type gen_qpointingdevice_types.QPointingDevice, name: string, systemId: clonglong, devType: cint, pType: cint, caps: cint, maxPoints: cint, buttonCount: cint, seatName: string, uniqueId: QPointingDeviceUniqueId, parent: QObject): gen_qpointingdevice_types.QPointingDevice =
...
proc metaObject*(self: gen_qpointingdevice_types.QPointingDevice, ): QMetaObject =
  QMetaObject(h: fcQPointingDevice_metaObject(self.h))
...
proc uniqueId*(self: gen_qpointingdevice_types.QPointingDevice, ): QPointingDeviceUniqueId =
  QPointingDeviceUniqueId(h: fcQPointingDevice_uniqueId(self.h))

proc primaryPointingDevice*(_: type gen_qpointingdevice_types.QPointingDevice, ): QPointingDevice =
  QPointingDevice(h: fcQPointingDevice_primaryPointingDevice())

proc operatorEqual*(self: gen_qpointingdevice_types.QPointingDevice, other: QPointingDevice): bool =
  fcQPointingDevice_operatorEqual(self.h, other.h)

proc grabChanged*(self: gen_qpointingdevice_types.QPointingDevice, grabber: QObject, transition: cint, event: QPointerEvent, point: QEventPoint): void =
  fcQPointingDevice_grabChanged(self.h, grabber.h, cint(transition), event.h, point.h)

type QPointingDevicegrabChangedSlot* = proc(grabber: QObject, transition: cint, event: QPointerEvent, point: QEventPoint)
proc miqt_exec_callback_QPointingDevice_grabChanged(slot: int, grabber: pointer, transition: cint, event: pointer, point: pointer) {.exportc.} =
  ...
  let slotval1 = QObject(h: grabber)

  let slotval2 = cint(transition)

  let slotval3 = QPointerEvent(h: event)

  let slotval4 = QEventPoint(h: point)
...
proc primaryPointingDevice*(_: type gen_qpointingdevice_types.QPointingDevice, seatName: string): QPointingDevice =
...
proc miqt_exec_callback_QPointingDevice_metacall(self: ptr cQPointingDevice, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QPointingDevice_metacall ".} =
  ...
  virtualReturn
proc QPointingDeviceevent*(self: gen_qpointingdevice_types.QPointingDevice, event: QEvent): bool =
  fQPointingDevice_virtualbase_event(self.h, event.h)

type QPointingDeviceeventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QPointingDevice_event(self: ptr cQPointingDevice, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QPointingDevice_event ".} =
  ...
  virtualReturn
proc QPointingDeviceeventFilter*(self: gen_qpointingdevice_types.QPointingDevice, watched: QObject, event: QEvent): bool =
  fQPointingDevice_virtualbase_eventFilter(self.h, watched.h, event.h)

type QPointingDeviceeventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QPointingDevice_eventFilter(self: ptr cQPointingDevice, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QPointingDevice_eventFilter ".} =
  ...
  virtualReturn
proc QPointingDevicetimerEvent*(self: gen_qpointingdevice_types.QPointingDevice, event: QTimerEvent): void =
  fQPointingDevice_virtualbase_timerEvent(self.h, event.h)

type QPointingDevicetimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QPointingDevice_timerEvent(self: ptr cQPointingDevice, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QPointingDevice_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QPointingDevicechildEvent*(self: gen_qpointingdevice_types.QPointingDevice, event: QChildEvent): void =
  fQPointingDevice_virtualbase_childEvent(self.h, event.h)

type QPointingDevicechildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QPointingDevice_childEvent(self: ptr cQPointingDevice, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QPointingDevice_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QPointingDevicecustomEvent*(self: gen_qpointingdevice_types.QPointingDevice, event: QEvent): void =
  fQPointingDevice_virtualbase_customEvent(self.h, event.h)

type QPointingDevicecustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QPointingDevice_customEvent(self: ptr cQPointingDevice, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QPointingDevice_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QPointingDeviceconnectNotify*(self: gen_qpointingdevice_types.QPointingDevice, signal: QMetaMethod): void =
  fQPointingDevice_virtualbase_connectNotify(self.h, signal.h)

type QPointingDeviceconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QPointingDevice_connectNotify(self: ptr cQPointingDevice, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QPointingDevice_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QPointingDevicedisconnectNotify*(self: gen_qpointingdevice_types.QPointingDevice, signal: QMetaMethod): void =
  fQPointingDevice_virtualbase_disconnectNotify(self.h, signal.h)

type QPointingDevicedisconnectNotifyProc* = proc(signal: QMetaMethod): void
