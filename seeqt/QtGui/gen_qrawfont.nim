...
func init*(T: type gen_qrawfont_types.QRawFont, h: ptr cQRawFont): gen_qrawfont_types.QRawFont =
  T(h: h)
proc create*(T: type gen_qrawfont_types.QRawFont, ): gen_qrawfont_types.QRawFont =
  gen_qrawfont_types.QRawFont.init(fcQRawFont_new())

proc create*(T: type gen_qrawfont_types.QRawFont, fileName: string, pixelSize: float64): gen_qrawfont_types.QRawFont =
  gen_qrawfont_types.QRawFont.init(fcQRawFont_new2(struct_miqt_string(data: fileName, len: csize_t(len(fileName))), pixelSize))

proc create*(T: type gen_qrawfont_types.QRawFont, fontData: seq[byte], pixelSize: float64): gen_qrawfont_types.QRawFont =
  gen_qrawfont_types.QRawFont.init(fcQRawFont_new3(struct_miqt_string(data: cast[cstring](if len(fontData) == 0: nil else: unsafeAddr fontData[0]), len: csize_t(len(fontData))), pixelSize))

proc create*(T: type gen_qrawfont_types.QRawFont, other: QRawFont): gen_qrawfont_types.QRawFont =
  gen_qrawfont_types.QRawFont.init(fcQRawFont_new4(other.h))

proc create*(T: type gen_qrawfont_types.QRawFont, fileName: string, pixelSize: float64, hintingPreference: cint): gen_qrawfont_types.QRawFont =
  gen_qrawfont_types.QRawFont.init(fcQRawFont_new5(struct_miqt_string(data: fileName, len: csize_t(len(fileName))), pixelSize, cint(hintingPreference)))

proc create*(T: type gen_qrawfont_types.QRawFont, fontData: seq[byte], pixelSize: float64, hintingPreference: cint): gen_qrawfont_types.QRawFont =
  gen_qrawfont_types.QRawFont.init(fcQRawFont_new6(struct_miqt_string(data: cast[cstring](if len(fontData) == 0: nil else: unsafeAddr fontData[0]), len: csize_t(len(fontData))), pixelSize, cint(hintingPreference)))

proc operatorAssign*(self: gen_qrawfont_types.QRawFont, other: QRawFont): void =
  fcQRawFont_operatorAssign(self.h, other.h)

proc swap*(self: gen_qrawfont_types.QRawFont, other: QRawFont): void =
  fcQRawFont_swap(self.h, other.h)

proc isValid*(self: gen_qrawfont_types.QRawFont, ): bool =
  fcQRawFont_isValid(self.h)

proc operatorEqual*(self: gen_qrawfont_types.QRawFont, other: QRawFont): bool =
  fcQRawFont_operatorEqual(self.h, other.h)

proc operatorNotEqual*(self: gen_qrawfont_types.QRawFont, other: QRawFont): bool =
...
proc advancesForGlyphIndexes*(self: gen_qrawfont_types.QRawFont, glyphIndexes: seq[cuint]): seq[QPointF] =
...
proc advancesForGlyphIndexes*(self: gen_qrawfont_types.QRawFont, glyphIndexes: seq[cuint], layoutFlags: cint): seq[QPointF] =
  var glyphIndexes_CArray = newSeq[cuint](len(glyphIndexes))
  for i in 0..<len(glyphIndexes):
    glyphIndexes_CArray[i] = glyphIndexes[i]
...
proc glyphIndexesForChars*(self: gen_qrawfont_types.QRawFont, chars: QChar, numChars: cint, glyphIndexes: ptr cuint, numGlyphs: ptr cint): bool =
  fcQRawFont_glyphIndexesForChars(self.h, chars.h, numChars, glyphIndexes, numGlyphs)

proc advancesForGlyphIndexes*(self: gen_qrawfont_types.QRawFont, glyphIndexes: ptr cuint, advances: QPointF, numGlyphs: cint): bool =
  fcQRawFont_advancesForGlyphIndexes3(self.h, glyphIndexes, advances.h, numGlyphs)

proc advancesForGlyphIndexes*(self: gen_qrawfont_types.QRawFont, glyphIndexes: ptr cuint, advances: QPointF, numGlyphs: cint, layoutFlags: cint): bool =
  fcQRawFont_advancesForGlyphIndexes4(self.h, glyphIndexes, advances.h, numGlyphs, cint(layoutFlags))

proc alphaMapForGlyph*(self: gen_qrawfont_types.QRawFont, glyphIndex: cuint): QImage =
  QImage(h: fcQRawFont_alphaMapForGlyph(self.h, glyphIndex))

proc pathForGlyph*(self: gen_qrawfont_types.QRawFont, glyphIndex: cuint): QPainterPath =
  QPainterPath(h: fcQRawFont_pathForGlyph(self.h, glyphIndex))

proc boundingRect*(self: gen_qrawfont_types.QRawFont, glyphIndex: cuint): QRectF =
  QRectF(h: fcQRawFont_boundingRect(self.h, glyphIndex))
...
proc supportsCharacter*(self: gen_qrawfont_types.QRawFont, character: QChar): bool =
...
proc fromFont*(_: type gen_qrawfont_types.QRawFont, font: QFont): QRawFont =
  QRawFont(h: fcQRawFont_fromFont(font.h))

proc alphaMapForGlyph*(self: gen_qrawfont_types.QRawFont, glyphIndex: cuint, antialiasingType: cint): QImage =
  QImage(h: fcQRawFont_alphaMapForGlyph2(self.h, glyphIndex, cint(antialiasingType)))

proc alphaMapForGlyph*(self: gen_qrawfont_types.QRawFont, glyphIndex: cuint, antialiasingType: cint, transform: QTransform): QImage =
  QImage(h: fcQRawFont_alphaMapForGlyph3(self.h, glyphIndex, cint(antialiasingType), transform.h))

proc fromFont*(_: type gen_qrawfont_types.QRawFont, font: QFont, writingSystem: cint): QRawFont =
