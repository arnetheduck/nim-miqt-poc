...
proc font*(self: gen_qpaintengine_types.QTextItem, ): QFont =
  QFont(h: fcQTextItem_font(self.h))
...
proc begin*(self: gen_qpaintengine_types.QPaintEngine, pdev: QPaintDevice): bool =
  fcQPaintEngine_begin(self.h, pdev.h)

proc endX*(self: gen_qpaintengine_types.QPaintEngine, ): bool =
  fcQPaintEngine_endX(self.h)

proc updateState*(self: gen_qpaintengine_types.QPaintEngine, state: QPaintEngineState): void =
  fcQPaintEngine_updateState(self.h, state.h)

proc drawRects*(self: gen_qpaintengine_types.QPaintEngine, rects: QRect, rectCount: cint): void =
  fcQPaintEngine_drawRects(self.h, rects.h, rectCount)

proc drawRects*(self: gen_qpaintengine_types.QPaintEngine, rects: QRectF, rectCount: cint): void =
  fcQPaintEngine_drawRects2(self.h, rects.h, rectCount)

proc drawLines*(self: gen_qpaintengine_types.QPaintEngine, lines: QLine, lineCount: cint): void =
  fcQPaintEngine_drawLines(self.h, lines.h, lineCount)

proc drawLines*(self: gen_qpaintengine_types.QPaintEngine, lines: QLineF, lineCount: cint): void =
  fcQPaintEngine_drawLines2(self.h, lines.h, lineCount)

proc drawEllipse*(self: gen_qpaintengine_types.QPaintEngine, r: QRectF): void =
  fcQPaintEngine_drawEllipse(self.h, r.h)

proc drawEllipse*(self: gen_qpaintengine_types.QPaintEngine, r: QRect): void =
  fcQPaintEngine_drawEllipseWithQRect(self.h, r.h)

proc drawPath*(self: gen_qpaintengine_types.QPaintEngine, path: QPainterPath): void =
  fcQPaintEngine_drawPath(self.h, path.h)

proc drawPoints*(self: gen_qpaintengine_types.QPaintEngine, points: QPointF, pointCount: cint): void =
  fcQPaintEngine_drawPoints(self.h, points.h, pointCount)

proc drawPoints*(self: gen_qpaintengine_types.QPaintEngine, points: QPoint, pointCount: cint): void =
  fcQPaintEngine_drawPoints2(self.h, points.h, pointCount)

proc drawPolygon*(self: gen_qpaintengine_types.QPaintEngine, points: QPointF, pointCount: cint, mode: cint): void =
  fcQPaintEngine_drawPolygon(self.h, points.h, pointCount, cint(mode))

proc drawPolygon*(self: gen_qpaintengine_types.QPaintEngine, points: QPoint, pointCount: cint, mode: cint): void =
  fcQPaintEngine_drawPolygon2(self.h, points.h, pointCount, cint(mode))

proc drawPixmap*(self: gen_qpaintengine_types.QPaintEngine, r: QRectF, pm: QPixmap, sr: QRectF): void =
  fcQPaintEngine_drawPixmap(self.h, r.h, pm.h, sr.h)

proc drawTextItem*(self: gen_qpaintengine_types.QPaintEngine, p: QPointF, textItem: QTextItem): void =
  fcQPaintEngine_drawTextItem(self.h, p.h, textItem.h)

proc drawTiledPixmap*(self: gen_qpaintengine_types.QPaintEngine, r: QRectF, pixmap: QPixmap, s: QPointF): void =
  fcQPaintEngine_drawTiledPixmap(self.h, r.h, pixmap.h, s.h)

proc drawImage*(self: gen_qpaintengine_types.QPaintEngine, r: QRectF, pm: QImage, sr: QRectF, flags: cint): void =
  fcQPaintEngine_drawImage(self.h, r.h, pm.h, sr.h, cint(flags))

proc setPaintDevice*(self: gen_qpaintengine_types.QPaintEngine, device: QPaintDevice): void =
  fcQPaintEngine_setPaintDevice(self.h, device.h)

proc paintDevice*(self: gen_qpaintengine_types.QPaintEngine, ): QPaintDevice =
  QPaintDevice(h: fcQPaintEngine_paintDevice(self.h))

proc setSystemClip*(self: gen_qpaintengine_types.QPaintEngine, baseClip: QRegion): void =
  fcQPaintEngine_setSystemClip(self.h, baseClip.h)

proc systemClip*(self: gen_qpaintengine_types.QPaintEngine, ): QRegion =
  QRegion(h: fcQPaintEngine_systemClip(self.h))

proc setSystemRect*(self: gen_qpaintengine_types.QPaintEngine, rect: QRect): void =
  fcQPaintEngine_setSystemRect(self.h, rect.h)

proc systemRect*(self: gen_qpaintengine_types.QPaintEngine, ): QRect =
  QRect(h: fcQPaintEngine_systemRect(self.h))

proc coordinateOffset*(self: gen_qpaintengine_types.QPaintEngine, ): QPoint =
  QPoint(h: fcQPaintEngine_coordinateOffset(self.h))
...
proc painter*(self: gen_qpaintengine_types.QPaintEngine, ): QPainter =
  QPainter(h: fcQPaintEngine_painter(self.h))
...
proc createPixmap*(self: gen_qpaintengine_types.QPaintEngine, size: QSize): QPixmap =
  QPixmap(h: fcQPaintEngine_createPixmap(self.h, size.h))

proc createPixmapFromImage*(self: gen_qpaintengine_types.QPaintEngine, image: QImage, flags: cint): QPixmap =
  QPixmap(h: fcQPaintEngine_createPixmapFromImage(self.h, image.h, cint(flags)))

type QPaintEnginebeginProc* = proc(pdev: QPaintDevice): bool
...
proc miqt_exec_callback_QPaintEngine_begin(self: ptr cQPaintEngine, slot: int, pdev: pointer): bool {.exportc: "miqt_exec_callback_QPaintEngine_begin ".} =
  ...
  let slotval1 = QPaintDevice(h: pdev)
...
proc miqt_exec_callback_QPaintEngine_end(self: ptr cQPaintEngine, slot: int): bool {.exportc: "miqt_exec_callback_QPaintEngine_end ".} =
  ...
  virtualReturn
type QPaintEngineupdateStateProc* = proc(state: QPaintEngineState): void
...
proc miqt_exec_callback_QPaintEngine_updateState(self: ptr cQPaintEngine, slot: int, state: pointer): void {.exportc: "miqt_exec_callback_QPaintEngine_updateState ".} =
  ...
  nimfunc[](slotval1)
proc QPaintEnginedrawRects*(self: gen_qpaintengine_types.QPaintEngine, rects: QRect, rectCount: cint): void =
  fQPaintEngine_virtualbase_drawRects(self.h, rects.h, rectCount)

type QPaintEnginedrawRectsProc* = proc(rects: QRect, rectCount: cint): void
...
proc miqt_exec_callback_QPaintEngine_drawRects(self: ptr cQPaintEngine, slot: int, rects: pointer, rectCount: cint): void {.exportc: "miqt_exec_callback_QPaintEngine_drawRects ".} =
  ...
  let slotval1 = QRect(h: rects)

  let slotval2 = rectCount


  nimfunc[](slotval1, slotval2)
proc QPaintEnginedrawRects*(self: gen_qpaintengine_types.QPaintEngine, rects: QRectF, rectCount: cint): void =
  fQPaintEngine_virtualbase_drawRects2(self.h, rects.h, rectCount)

type QPaintEnginedrawRects2Proc* = proc(rects: QRectF, rectCount: cint): void
...
proc miqt_exec_callback_QPaintEngine_drawRects2(self: ptr cQPaintEngine, slot: int, rects: pointer, rectCount: cint): void {.exportc: "miqt_exec_callback_QPaintEngine_drawRects2 ".} =
  ...
  let slotval1 = QRectF(h: rects)

  let slotval2 = rectCount


  nimfunc[](slotval1, slotval2)
proc QPaintEnginedrawLines*(self: gen_qpaintengine_types.QPaintEngine, lines: QLine, lineCount: cint): void =
  fQPaintEngine_virtualbase_drawLines(self.h, lines.h, lineCount)

type QPaintEnginedrawLinesProc* = proc(lines: QLine, lineCount: cint): void
...
proc miqt_exec_callback_QPaintEngine_drawLines(self: ptr cQPaintEngine, slot: int, lines: pointer, lineCount: cint): void {.exportc: "miqt_exec_callback_QPaintEngine_drawLines ".} =
  ...
  let slotval1 = QLine(h: lines)

  let slotval2 = lineCount


  nimfunc[](slotval1, slotval2)
proc QPaintEnginedrawLines*(self: gen_qpaintengine_types.QPaintEngine, lines: QLineF, lineCount: cint): void =
  fQPaintEngine_virtualbase_drawLines2(self.h, lines.h, lineCount)

type QPaintEnginedrawLines2Proc* = proc(lines: QLineF, lineCount: cint): void
...
proc miqt_exec_callback_QPaintEngine_drawLines2(self: ptr cQPaintEngine, slot: int, lines: pointer, lineCount: cint): void {.exportc: "miqt_exec_callback_QPaintEngine_drawLines2 ".} =
  ...
  let slotval1 = QLineF(h: lines)

  let slotval2 = lineCount


  nimfunc[](slotval1, slotval2)
proc QPaintEnginedrawEllipse*(self: gen_qpaintengine_types.QPaintEngine, r: QRectF): void =
  fQPaintEngine_virtualbase_drawEllipse(self.h, r.h)

type QPaintEnginedrawEllipseProc* = proc(r: QRectF): void
...
proc miqt_exec_callback_QPaintEngine_drawEllipse(self: ptr cQPaintEngine, slot: int, r: pointer): void {.exportc: "miqt_exec_callback_QPaintEngine_drawEllipse ".} =
  ...
  let slotval1 = QRectF(h: r)


  nimfunc[](slotval1)
proc QPaintEnginedrawEllipse*(self: gen_qpaintengine_types.QPaintEngine, r: QRect): void =
  fQPaintEngine_virtualbase_drawEllipseWithQRect(self.h, r.h)

type QPaintEnginedrawEllipseWithQRectProc* = proc(r: QRect): void
...
proc miqt_exec_callback_QPaintEngine_drawEllipseWithQRect(self: ptr cQPaintEngine, slot: int, r: pointer): void {.exportc: "miqt_exec_callback_QPaintEngine_drawEllipseWithQRect ".} =
  ...
  nimfunc[](slotval1)
proc QPaintEnginedrawPath*(self: gen_qpaintengine_types.QPaintEngine, path: QPainterPath): void =
  fQPaintEngine_virtualbase_drawPath(self.h, path.h)

type QPaintEnginedrawPathProc* = proc(path: QPainterPath): void
...
proc miqt_exec_callback_QPaintEngine_drawPath(self: ptr cQPaintEngine, slot: int, path: pointer): void {.exportc: "miqt_exec_callback_QPaintEngine_drawPath ".} =
  ...
  nimfunc[](slotval1)
proc QPaintEnginedrawPoints*(self: gen_qpaintengine_types.QPaintEngine, points: QPointF, pointCount: cint): void =
  fQPaintEngine_virtualbase_drawPoints(self.h, points.h, pointCount)

type QPaintEnginedrawPointsProc* = proc(points: QPointF, pointCount: cint): void
...
proc miqt_exec_callback_QPaintEngine_drawPoints(self: ptr cQPaintEngine, slot: int, points: pointer, pointCount: cint): void {.exportc: "miqt_exec_callback_QPaintEngine_drawPoints ".} =
  ...
  let slotval1 = QPointF(h: points)

  let slotval2 = pointCount


  nimfunc[](slotval1, slotval2)
proc QPaintEnginedrawPoints*(self: gen_qpaintengine_types.QPaintEngine, points: QPoint, pointCount: cint): void =
  fQPaintEngine_virtualbase_drawPoints2(self.h, points.h, pointCount)

type QPaintEnginedrawPoints2Proc* = proc(points: QPoint, pointCount: cint): void
...
proc miqt_exec_callback_QPaintEngine_drawPoints2(self: ptr cQPaintEngine, slot: int, points: pointer, pointCount: cint): void {.exportc: "miqt_exec_callback_QPaintEngine_drawPoints2 ".} =
  ...
  let slotval1 = QPoint(h: points)

  let slotval2 = pointCount


  nimfunc[](slotval1, slotval2)
proc QPaintEnginedrawPolygon*(self: gen_qpaintengine_types.QPaintEngine, points: QPointF, pointCount: cint, mode: cint): void =
  fQPaintEngine_virtualbase_drawPolygon(self.h, points.h, pointCount, cint(mode))

type QPaintEnginedrawPolygonProc* = proc(points: QPointF, pointCount: cint, mode: cint): void
...
proc QPaintEnginedrawPolygon*(self: gen_qpaintengine_types.QPaintEngine, points: QPoint, pointCount: cint, mode: cint): void =
  fQPaintEngine_virtualbase_drawPolygon2(self.h, points.h, pointCount, cint(mode))

type QPaintEnginedrawPolygon2Proc* = proc(points: QPoint, pointCount: cint, mode: cint): void
...
proc miqt_exec_callback_QPaintEngine_drawPolygon2(self: ptr cQPaintEngine, slot: int, points: pointer, pointCount: cint, mode: cint): void {.exportc: "miqt_exec_callback_QPaintEngine_drawPolygon2 ".} =
  ...
  nimfunc[](slotval1, slotval2, slotval3)
type QPaintEnginedrawPixmapProc* = proc(r: QRectF, pm: QPixmap, sr: QRectF): void
...
proc miqt_exec_callback_QPaintEngine_drawPixmap(self: ptr cQPaintEngine, slot: int, r: pointer, pm: pointer, sr: pointer): void {.exportc: "miqt_exec_callback_QPaintEngine_drawPixmap ".} =
  ...
  let slotval2 = QPixmap(h: pm)

  let slotval3 = QRectF(h: sr)


  nimfunc[](slotval1, slotval2, slotval3)
proc QPaintEnginedrawTextItem*(self: gen_qpaintengine_types.QPaintEngine, p: QPointF, textItem: QTextItem): void =
  fQPaintEngine_virtualbase_drawTextItem(self.h, p.h, textItem.h)

type QPaintEnginedrawTextItemProc* = proc(p: QPointF, textItem: QTextItem): void
...
proc miqt_exec_callback_QPaintEngine_drawTextItem(self: ptr cQPaintEngine, slot: int, p: pointer, textItem: pointer): void {.exportc: "miqt_exec_callback_QPaintEngine_drawTextItem ".} =
  ...
  let slotval1 = QPointF(h: p)

  let slotval2 = QTextItem(h: textItem)


  nimfunc[](slotval1, slotval2)
proc QPaintEnginedrawTiledPixmap*(self: gen_qpaintengine_types.QPaintEngine, r: QRectF, pixmap: QPixmap, s: QPointF): void =
  fQPaintEngine_virtualbase_drawTiledPixmap(self.h, r.h, pixmap.h, s.h)

type QPaintEnginedrawTiledPixmapProc* = proc(r: QRectF, pixmap: QPixmap, s: QPointF): void
...
proc miqt_exec_callback_QPaintEngine_drawTiledPixmap(self: ptr cQPaintEngine, slot: int, r: pointer, pixmap: pointer, s: pointer): void {.exportc: "miqt_exec_callback_QPaintEngine_drawTiledPixmap ".} =
  ...
  let slotval3 = QPointF(h: s)


  nimfunc[](slotval1, slotval2, slotval3)
proc QPaintEnginedrawImage*(self: gen_qpaintengine_types.QPaintEngine, r: QRectF, pm: QImage, sr: QRectF, flags: cint): void =
  fQPaintEngine_virtualbase_drawImage(self.h, r.h, pm.h, sr.h, cint(flags))

type QPaintEnginedrawImageProc* = proc(r: QRectF, pm: QImage, sr: QRectF, flags: cint): void
...
proc QPaintEnginecoordinateOffset*(self: gen_qpaintengine_types.QPaintEngine, ): QPoint =
  QPoint(h: fQPaintEngine_virtualbase_coordinateOffset(self.h))

type QPaintEnginecoordinateOffsetProc* = proc(): QPoint
...
proc miqt_exec_callback_QPaintEngine_type(self: ptr cQPaintEngine, slot: int): cint {.exportc: "miqt_exec_callback_QPaintEngine_type ".} =
  ...
  cint(virtualReturn)
proc QPaintEnginecreatePixmap*(self: gen_qpaintengine_types.QPaintEngine, size: QSize): QPixmap =
  QPixmap(h: fQPaintEngine_virtualbase_createPixmap(self.h, size.h))

type QPaintEnginecreatePixmapProc* = proc(size: QSize): QPixmap
...
proc miqt_exec_callback_QPaintEngine_createPixmap(self: ptr cQPaintEngine, slot: int, size: pointer): pointer {.exportc: "miqt_exec_callback_QPaintEngine_createPixmap ".} =
  ...
  virtualReturn.h
proc QPaintEnginecreatePixmapFromImage*(self: gen_qpaintengine_types.QPaintEngine, image: QImage, flags: cint): QPixmap =
  QPixmap(h: fQPaintEngine_virtualbase_createPixmapFromImage(self.h, image.h, cint(flags)))

type QPaintEnginecreatePixmapFromImageProc* = proc(image: QImage, flags: cint): QPixmap
...
proc pen*(self: gen_qpaintengine_types.QPaintEngineState, ): QPen =
  QPen(h: fcQPaintEngineState_pen(self.h))

proc brush*(self: gen_qpaintengine_types.QPaintEngineState, ): QBrush =
  QBrush(h: fcQPaintEngineState_brush(self.h))

proc brushOrigin*(self: gen_qpaintengine_types.QPaintEngineState, ): QPointF =
  QPointF(h: fcQPaintEngineState_brushOrigin(self.h))

proc backgroundBrush*(self: gen_qpaintengine_types.QPaintEngineState, ): QBrush =
  QBrush(h: fcQPaintEngineState_backgroundBrush(self.h))

proc backgroundMode*(self: gen_qpaintengine_types.QPaintEngineState, ): cint =
  cint(fcQPaintEngineState_backgroundMode(self.h))

proc font*(self: gen_qpaintengine_types.QPaintEngineState, ): QFont =
  QFont(h: fcQPaintEngineState_font(self.h))

proc transform*(self: gen_qpaintengine_types.QPaintEngineState, ): QTransform =
  QTransform(h: fcQPaintEngineState_transform(self.h))

proc clipOperation*(self: gen_qpaintengine_types.QPaintEngineState, ): cint =
  cint(fcQPaintEngineState_clipOperation(self.h))

proc clipRegion*(self: gen_qpaintengine_types.QPaintEngineState, ): QRegion =
  QRegion(h: fcQPaintEngineState_clipRegion(self.h))

proc clipPath*(self: gen_qpaintengine_types.QPaintEngineState, ): QPainterPath =
  QPainterPath(h: fcQPaintEngineState_clipPath(self.h))
...
proc painter*(self: gen_qpaintengine_types.QPaintEngineState, ): QPainter =
  QPainter(h: fcQPaintEngineState_painter(self.h))
