...
proc fcQMatrix4x4_new7(matrix: pointer): ptr cQMatrix4x4 {.importc: "QMatrix4x4_new7".}
proc fcQMatrix4x4_new8(param1: pointer): ptr cQMatrix4x4 {.importc: "QMatrix4x4_new8".}
...
proc fcQMatrix4x4_toAffine(self: pointer, ): pointer {.importc: "QMatrix4x4_toAffine".}
...
proc create*(T: type gen_qmatrix4x4_types.QMatrix4x4, transform: QTransform): gen_qmatrix4x4_types.QMatrix4x4 =
  gen_qmatrix4x4_types.QMatrix4x4.init(fcQMatrix4x4_new6(transform.h))

proc create*(T: type gen_qmatrix4x4_types.QMatrix4x4, matrix: QMatrix): gen_qmatrix4x4_types.QMatrix4x4 =
  gen_qmatrix4x4_types.QMatrix4x4.init(fcQMatrix4x4_new7(matrix.h))

proc create*(T: type gen_qmatrix4x4_types.QMatrix4x4, param1: QMatrix4x4): gen_qmatrix4x4_types.QMatrix4x4 =
  gen_qmatrix4x4_types.QMatrix4x4.init(fcQMatrix4x4_new8(param1.h))

proc column*(self: gen_qmatrix4x4_types.QMatrix4x4, index: cint): QVector4D =
  QVector4D(h: fcQMatrix4x4_column(self.h, index))

proc setColumn*(self: gen_qmatrix4x4_types.QMatrix4x4, index: cint, value: QVector4D): void =
  fcQMatrix4x4_setColumn(self.h, index, value.h)

proc row*(self: gen_qmatrix4x4_types.QMatrix4x4, index: cint): QVector4D =
  QVector4D(h: fcQMatrix4x4_row(self.h, index))

proc setRow*(self: gen_qmatrix4x4_types.QMatrix4x4, index: cint, value: QVector4D): void =
...
proc inverted*(self: gen_qmatrix4x4_types.QMatrix4x4, ): QMatrix4x4 =
  QMatrix4x4(h: fcQMatrix4x4_inverted(self.h))

proc transposed*(self: gen_qmatrix4x4_types.QMatrix4x4, ): QMatrix4x4 =
  QMatrix4x4(h: fcQMatrix4x4_transposed(self.h))

proc operatorPlusAssign*(self: gen_qmatrix4x4_types.QMatrix4x4, other: QMatrix4x4): QMatrix4x4 =
  QMatrix4x4(h: fcQMatrix4x4_operatorPlusAssign(self.h, other.h))

proc operatorMinusAssign*(self: gen_qmatrix4x4_types.QMatrix4x4, other: QMatrix4x4): QMatrix4x4 =
  QMatrix4x4(h: fcQMatrix4x4_operatorMinusAssign(self.h, other.h))

proc operatorMultiplyAssign*(self: gen_qmatrix4x4_types.QMatrix4x4, other: QMatrix4x4): QMatrix4x4 =
  QMatrix4x4(h: fcQMatrix4x4_operatorMultiplyAssign(self.h, other.h))

proc operatorMultiplyAssign*(self: gen_qmatrix4x4_types.QMatrix4x4, factor: float32): QMatrix4x4 =
  QMatrix4x4(h: fcQMatrix4x4_operatorMultiplyAssignWithFactor(self.h, factor))

proc operatorDivideAssign*(self: gen_qmatrix4x4_types.QMatrix4x4, divisor: float32): QMatrix4x4 =
  QMatrix4x4(h: fcQMatrix4x4_operatorDivideAssign(self.h, divisor))

proc operatorEqual*(self: gen_qmatrix4x4_types.QMatrix4x4, other: QMatrix4x4): bool =
  fcQMatrix4x4_operatorEqual(self.h, other.h)

proc operatorNotEqual*(self: gen_qmatrix4x4_types.QMatrix4x4, other: QMatrix4x4): bool =
  fcQMatrix4x4_operatorNotEqual(self.h, other.h)

proc scale*(self: gen_qmatrix4x4_types.QMatrix4x4, vector: QVector3D): void =
  fcQMatrix4x4_scale(self.h, vector.h)

proc translate*(self: gen_qmatrix4x4_types.QMatrix4x4, vector: QVector3D): void =
  fcQMatrix4x4_translate(self.h, vector.h)

proc rotate*(self: gen_qmatrix4x4_types.QMatrix4x4, angle: float32, vector: QVector3D): void =
...
proc rotate*(self: gen_qmatrix4x4_types.QMatrix4x4, quaternion: QQuaternion): void =
  fcQMatrix4x4_rotateWithQuaternion(self.h, quaternion.h)

proc ortho*(self: gen_qmatrix4x4_types.QMatrix4x4, rect: QRect): void =
  fcQMatrix4x4_ortho(self.h, rect.h)

proc ortho*(self: gen_qmatrix4x4_types.QMatrix4x4, rect: QRectF): void =
...
proc lookAt*(self: gen_qmatrix4x4_types.QMatrix4x4, eye: QVector3D, center: QVector3D, up: QVector3D): void =
  fcQMatrix4x4_lookAt(self.h, eye.h, center.h, up.h)

proc viewport*(self: gen_qmatrix4x4_types.QMatrix4x4, rect: QRectF): void =
...
proc toAffine*(self: gen_qmatrix4x4_types.QMatrix4x4, ): QMatrix =
  QMatrix(h: fcQMatrix4x4_toAffine(self.h))

proc toTransform*(self: gen_qmatrix4x4_types.QMatrix4x4, ): QTransform =
  QTransform(h: fcQMatrix4x4_toTransform(self.h))

proc toTransform*(self: gen_qmatrix4x4_types.QMatrix4x4, distanceToPlane: float32): QTransform =
  QTransform(h: fcQMatrix4x4_toTransformWithDistanceToPlane(self.h, distanceToPlane))

proc map*(self: gen_qmatrix4x4_types.QMatrix4x4, point: QPoint): QPoint =
  QPoint(h: fcQMatrix4x4_map(self.h, point.h))

proc map*(self: gen_qmatrix4x4_types.QMatrix4x4, point: QPointF): QPointF =
  QPointF(h: fcQMatrix4x4_mapWithPoint(self.h, point.h))

proc map*(self: gen_qmatrix4x4_types.QMatrix4x4, point: QVector3D): QVector3D =
  QVector3D(h: fcQMatrix4x4_map2(self.h, point.h))

proc mapVector*(self: gen_qmatrix4x4_types.QMatrix4x4, vector: QVector3D): QVector3D =
  QVector3D(h: fcQMatrix4x4_mapVector(self.h, vector.h))

proc map*(self: gen_qmatrix4x4_types.QMatrix4x4, point: QVector4D): QVector4D =
  QVector4D(h: fcQMatrix4x4_map3(self.h, point.h))

proc mapRect*(self: gen_qmatrix4x4_types.QMatrix4x4, rect: QRect): QRect =
  QRect(h: fcQMatrix4x4_mapRect(self.h, rect.h))

proc mapRect*(self: gen_qmatrix4x4_types.QMatrix4x4, rect: QRectF): QRectF =
  QRectF(h: fcQMatrix4x4_mapRectWithRect(self.h, rect.h))
...
proc ToQVariant*(self: gen_qmatrix4x4_types.QMatrix4x4, ): QVariant =
  QVariant(h: fcQMatrix4x4_ToQVariant(self.h))

proc inverted*(self: gen_qmatrix4x4_types.QMatrix4x4, invertible: ptr bool): QMatrix4x4 =
