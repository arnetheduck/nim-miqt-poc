...
proc find*(_: type gen_qpixmapcache_types.QPixmapCache, key: string): QPixmap =
  QPixmap(h: fcQPixmapCache_find(struct_miqt_string(data: key, len: csize_t(len(key)))))

proc find*(_: type gen_qpixmapcache_types.QPixmapCache, key: string, pixmap: QPixmap): bool =
  fcQPixmapCache_find2(struct_miqt_string(data: key, len: csize_t(len(key))), pixmap.h)

proc find2*(_: type gen_qpixmapcache_types.QPixmapCache, key: string, pixmap: QPixmap): bool =
  fcQPixmapCache_find3(struct_miqt_string(data: key, len: csize_t(len(key))), pixmap.h)

proc find*(_: type gen_qpixmapcache_types.QPixmapCache, key: QPixmapCacheKey, pixmap: QPixmap): bool =
  fcQPixmapCache_find4(key.h, pixmap.h)

proc insert*(_: type gen_qpixmapcache_types.QPixmapCache, key: string, pixmap: QPixmap): bool =
  fcQPixmapCache_insert(struct_miqt_string(data: key, len: csize_t(len(key))), pixmap.h)

proc insert*(_: type gen_qpixmapcache_types.QPixmapCache, pixmap: QPixmap): QPixmapCacheKey =
  QPixmapCacheKey(h: fcQPixmapCache_insertWithPixmap(pixmap.h))

proc replace*(_: type gen_qpixmapcache_types.QPixmapCache, key: QPixmapCacheKey, pixmap: QPixmap): bool =
...
proc remove*(_: type gen_qpixmapcache_types.QPixmapCache, key: QPixmapCacheKey): void =
...
proc create*(T: type gen_qpixmapcache_types.QPixmapCacheKey, other: QPixmapCacheKey): gen_qpixmapcache_types.QPixmapCacheKey =
  gen_qpixmapcache_types.QPixmapCacheKey.init(fcQPixmapCacheKey_new2(other.h))

proc operatorEqual*(self: gen_qpixmapcache_types.QPixmapCacheKey, key: QPixmapCacheKey): bool =
  fcQPixmapCacheKey_operatorEqual(self.h, key.h)

proc operatorNotEqual*(self: gen_qpixmapcache_types.QPixmapCacheKey, key: QPixmapCacheKey): bool =
  fcQPixmapCacheKey_operatorNotEqual(self.h, key.h)

proc operatorAssign*(self: gen_qpixmapcache_types.QPixmapCacheKey, other: QPixmapCacheKey): void =
  fcQPixmapCacheKey_operatorAssign(self.h, other.h)

proc swap*(self: gen_qpixmapcache_types.QPixmapCacheKey, other: QPixmapCacheKey): void =
