...
proc create*(T: type gen_qimagereader_types.QImageReader, device: QIODevice): gen_qimagereader_types.QImageReader =
...
proc create*(T: type gen_qimagereader_types.QImageReader, device: QIODevice, format: seq[byte]): gen_qimagereader_types.QImageReader =
...
proc setDevice*(self: gen_qimagereader_types.QImageReader, device: QIODevice): void =
  fcQImageReader_setDevice(self.h, device.h)

proc device*(self: gen_qimagereader_types.QImageReader, ): QIODevice =
  QIODevice(h: fcQImageReader_device(self.h))
...
proc size*(self: gen_qimagereader_types.QImageReader, ): QSize =
  QSize(h: fcQImageReader_size(self.h))
...
proc setClipRect*(self: gen_qimagereader_types.QImageReader, rect: QRect): void =
  fcQImageReader_setClipRect(self.h, rect.h)

proc clipRect*(self: gen_qimagereader_types.QImageReader, ): QRect =
  QRect(h: fcQImageReader_clipRect(self.h))

proc setScaledSize*(self: gen_qimagereader_types.QImageReader, size: QSize): void =
  fcQImageReader_setScaledSize(self.h, size.h)

proc scaledSize*(self: gen_qimagereader_types.QImageReader, ): QSize =
  QSize(h: fcQImageReader_scaledSize(self.h))
...
proc setScaledClipRect*(self: gen_qimagereader_types.QImageReader, rect: QRect): void =
  fcQImageReader_setScaledClipRect(self.h, rect.h)

proc scaledClipRect*(self: gen_qimagereader_types.QImageReader, ): QRect =
  QRect(h: fcQImageReader_scaledClipRect(self.h))

proc setBackgroundColor*(self: gen_qimagereader_types.QImageReader, color: QColor): void =
  fcQImageReader_setBackgroundColor(self.h, color.h)

proc backgroundColor*(self: gen_qimagereader_types.QImageReader, ): QColor =
  QColor(h: fcQImageReader_backgroundColor(self.h))
...
proc read*(self: gen_qimagereader_types.QImageReader, ): QImage =
  QImage(h: fcQImageReader_read(self.h))

proc read*(self: gen_qimagereader_types.QImageReader, image: QImage): bool =
...
proc currentImageRect*(self: gen_qimagereader_types.QImageReader, ): QRect =
  QRect(h: fcQImageReader_currentImageRect(self.h))
...
proc imageFormat*(_: type gen_qimagereader_types.QImageReader, device: QIODevice): seq[byte] =
...
proc trUtf8*(_: type gen_qimagereader_types.QImageReader, sourceText: cstring, disambiguation: cstring): string =
  let v_ms = fcQImageReader_trUtf82(sourceText, disambiguation)
  let vx_ret = string.fromBytes(toOpenArrayByte(v_ms.data, 0, int(v_ms.len)-1))
  c_free(v_ms.data)
  vx_ret

proc trUtf8*(_: type gen_qimagereader_types.QImageReader, sourceText: cstring, disambiguation: cstring, n: cint): string =
