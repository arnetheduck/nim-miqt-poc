...
QMetaObject* QRasterWindow_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQRasterWindow*)(self) )->QRasterWindow::metaObject();

}

void* QRasterWindow_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQRasterWindow*)(self) )->QRasterWindow::qt_metacast(param1);

}

int QRasterWindow_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQRasterWindow*)(self) )->QRasterWindow::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
bool QRasterWindow_virtualbase_nativeEvent(void* self, struct miqt_string eventType, void* message, long* result) {
	...
	return ( (MiqtVirtualQRasterWindow*)(self) )->QRasterWindow::nativeEvent(eventType_QByteArray, message, static_cast<long*>(result));
...
QObject* QRasterWindow_protectedbase_sender(const void* self) {
	MiqtVirtualQRasterWindow* self_cast = static_cast<MiqtVirtualQRasterWindow*>( (QRasterWindow*)(self) );
