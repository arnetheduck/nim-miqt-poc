...
func init*(T: type gen_qshortcut_types.QShortcut, h: ptr cQShortcut): gen_qshortcut_types.QShortcut =
  T(h: h)
proc create*(T: type gen_qshortcut_types.QShortcut, parent: QObject): gen_qshortcut_types.QShortcut =
  gen_qshortcut_types.QShortcut.init(fcQShortcut_new(parent.h))

proc create*(T: type gen_qshortcut_types.QShortcut, key: QKeySequence, parent: QObject): gen_qshortcut_types.QShortcut =
  gen_qshortcut_types.QShortcut.init(fcQShortcut_new2(key.h, parent.h))

proc create*(T: type gen_qshortcut_types.QShortcut, key: cint, parent: QObject): gen_qshortcut_types.QShortcut =
  gen_qshortcut_types.QShortcut.init(fcQShortcut_new3(cint(key), parent.h))

proc create*(T: type gen_qshortcut_types.QShortcut, key: QKeySequence, parent: QObject, member: cstring): gen_qshortcut_types.QShortcut =
  gen_qshortcut_types.QShortcut.init(fcQShortcut_new4(key.h, parent.h, member))

proc create*(T: type gen_qshortcut_types.QShortcut, key: QKeySequence, parent: QObject, member: cstring, ambiguousMember: cstring): gen_qshortcut_types.QShortcut =
  gen_qshortcut_types.QShortcut.init(fcQShortcut_new5(key.h, parent.h, member, ambiguousMember))

proc create*(T: type gen_qshortcut_types.QShortcut, key: QKeySequence, parent: QObject, member: cstring, ambiguousMember: cstring, context: cint): gen_qshortcut_types.QShortcut =
  gen_qshortcut_types.QShortcut.init(fcQShortcut_new6(key.h, parent.h, member, ambiguousMember, cint(context)))

proc create*(T: type gen_qshortcut_types.QShortcut, key: cint, parent: QObject, member: cstring): gen_qshortcut_types.QShortcut =
  gen_qshortcut_types.QShortcut.init(fcQShortcut_new7(cint(key), parent.h, member))

proc create*(T: type gen_qshortcut_types.QShortcut, key: cint, parent: QObject, member: cstring, ambiguousMember: cstring): gen_qshortcut_types.QShortcut =
  gen_qshortcut_types.QShortcut.init(fcQShortcut_new8(cint(key), parent.h, member, ambiguousMember))

proc create*(T: type gen_qshortcut_types.QShortcut, key: cint, parent: QObject, member: cstring, ambiguousMember: cstring, context: cint): gen_qshortcut_types.QShortcut =
  gen_qshortcut_types.QShortcut.init(fcQShortcut_new9(cint(key), parent.h, member, ambiguousMember, cint(context)))

proc metaObject*(self: gen_qshortcut_types.QShortcut, ): QMetaObject =
  QMetaObject(h: fcQShortcut_metaObject(self.h))
...
proc setKey*(self: gen_qshortcut_types.QShortcut, key: QKeySequence): void =
  fcQShortcut_setKey(self.h, key.h)

proc key*(self: gen_qshortcut_types.QShortcut, ): QKeySequence =
  QKeySequence(h: fcQShortcut_key(self.h))

proc setKeys*(self: gen_qshortcut_types.QShortcut, key: cint): void =
  fcQShortcut_setKeys(self.h, cint(key))

proc setKeys*(self: gen_qshortcut_types.QShortcut, keys: seq[QKeySequence]): void =
...
proc keys*(self: gen_qshortcut_types.QShortcut, ): seq[QKeySequence] =
...
proc miqt_exec_callback_QShortcut_metacall(self: ptr cQShortcut, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QShortcut_metacall ".} =
  ...
  virtualReturn
proc QShortcutevent*(self: gen_qshortcut_types.QShortcut, e: QEvent): bool =
  fQShortcut_virtualbase_event(self.h, e.h)

type QShortcuteventProc* = proc(e: QEvent): bool
...
proc miqt_exec_callback_QShortcut_event(self: ptr cQShortcut, slot: int, e: pointer): bool {.exportc: "miqt_exec_callback_QShortcut_event ".} =
  ...
  virtualReturn
proc QShortcuteventFilter*(self: gen_qshortcut_types.QShortcut, watched: QObject, event: QEvent): bool =
  fQShortcut_virtualbase_eventFilter(self.h, watched.h, event.h)

type QShortcuteventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QShortcut_eventFilter(self: ptr cQShortcut, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QShortcut_eventFilter ".} =
  ...
  virtualReturn
proc QShortcuttimerEvent*(self: gen_qshortcut_types.QShortcut, event: QTimerEvent): void =
  fQShortcut_virtualbase_timerEvent(self.h, event.h)

type QShortcuttimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QShortcut_timerEvent(self: ptr cQShortcut, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QShortcut_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QShortcutchildEvent*(self: gen_qshortcut_types.QShortcut, event: QChildEvent): void =
  fQShortcut_virtualbase_childEvent(self.h, event.h)

type QShortcutchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QShortcut_childEvent(self: ptr cQShortcut, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QShortcut_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QShortcutcustomEvent*(self: gen_qshortcut_types.QShortcut, event: QEvent): void =
  fQShortcut_virtualbase_customEvent(self.h, event.h)

type QShortcutcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QShortcut_customEvent(self: ptr cQShortcut, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QShortcut_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QShortcutconnectNotify*(self: gen_qshortcut_types.QShortcut, signal: QMetaMethod): void =
  fQShortcut_virtualbase_connectNotify(self.h, signal.h)

type QShortcutconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QShortcut_connectNotify(self: ptr cQShortcut, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QShortcut_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QShortcutdisconnectNotify*(self: gen_qshortcut_types.QShortcut, signal: QMetaMethod): void =
  fQShortcut_virtualbase_disconnectNotify(self.h, signal.h)

type QShortcutdisconnectNotifyProc* = proc(signal: QMetaMethod): void
