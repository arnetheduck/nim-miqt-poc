...
func init*(T: type gen_qdesktopservices_types.QDesktopServices, h: ptr cQDesktopServices): gen_qdesktopservices_types.QDesktopServices =
  T(h: h)
proc openUrl*(_: type gen_qdesktopservices_types.QDesktopServices, url: QUrl): bool =
  fcQDesktopServices_openUrl(url.h)

proc setUrlHandler*(_: type gen_qdesktopservices_types.QDesktopServices, scheme: string, receiver: QObject, methodVal: cstring): void =
