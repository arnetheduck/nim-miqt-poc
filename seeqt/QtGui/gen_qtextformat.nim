...
template FontLetterSpacingType*(_: type QTextFormatPropertyEnum): untyped = 8169
template FontStretch*(_: type QTextFormatPropertyEnum): untyped = 8170
...
template TextUnderlineColor*(_: type QTextFormatPropertyEnum): untyped = 8224
...
template TextSuperScriptBaseline*(_: type QTextFormatPropertyEnum): untyped = 8229
template TextSubScriptBaseline*(_: type QTextFormatPropertyEnum): untyped = 8230
template TextBaselineOffset*(_: type QTextFormatPropertyEnum): untyped = 8231
...
template OldFontLetterSpacingType*(_: type QTextFormatPropertyEnum): untyped = 8243
template OldFontStretch*(_: type QTextFormatPropertyEnum): untyped = 8244
template OldTextUnderlineColor*(_: type QTextFormatPropertyEnum): untyped = 8208
template OldFontFamily*(_: type QTextFormatPropertyEnum): untyped = 8192
...
proc fcQTextCharFormat_setFont(self: pointer, font: pointer): void {.importc: "QTextCharFormat_setFont".}
...
proc fcQTextCharFormat_setSuperScriptBaseline(self: pointer, baseline: float64): void {.importc: "QTextCharFormat_setSuperScriptBaseline".}
proc fcQTextCharFormat_superScriptBaseline(self: pointer, ): float64 {.importc: "QTextCharFormat_superScriptBaseline".}
proc fcQTextCharFormat_setSubScriptBaseline(self: pointer, baseline: float64): void {.importc: "QTextCharFormat_setSubScriptBaseline".}
proc fcQTextCharFormat_subScriptBaseline(self: pointer, ): float64 {.importc: "QTextCharFormat_subScriptBaseline".}
proc fcQTextCharFormat_setBaselineOffset(self: pointer, baseline: float64): void {.importc: "QTextCharFormat_setBaselineOffset".}
proc fcQTextCharFormat_baselineOffset(self: pointer, ): float64 {.importc: "QTextCharFormat_baselineOffset".}
...
proc create*(T: type gen_qtextformat_types.QTextLength, param1: QTextLength): gen_qtextformat_types.QTextLength =
...
proc operatorEqual*(self: gen_qtextformat_types.QTextLength, other: QTextLength): bool =
  fcQTextLength_operatorEqual(self.h, other.h)

proc operatorNotEqual*(self: gen_qtextformat_types.QTextLength, other: QTextLength): bool =
  fcQTextLength_operatorNotEqual(self.h, other.h)

proc ToQVariant*(self: gen_qtextformat_types.QTextLength, ): QVariant =
  QVariant(h: fcQTextLength_ToQVariant(self.h))
...
proc create*(T: type gen_qtextformat_types.QTextFormat, rhs: QTextFormat): gen_qtextformat_types.QTextFormat =
  gen_qtextformat_types.QTextFormat.init(fcQTextFormat_new3(rhs.h))

proc operatorAssign*(self: gen_qtextformat_types.QTextFormat, rhs: QTextFormat): void =
  fcQTextFormat_operatorAssign(self.h, rhs.h)

proc swap*(self: gen_qtextformat_types.QTextFormat, other: QTextFormat): void =
  fcQTextFormat_swap(self.h, other.h)

proc merge*(self: gen_qtextformat_types.QTextFormat, other: QTextFormat): void =
...
proc property*(self: gen_qtextformat_types.QTextFormat, propertyId: cint): QVariant =
  QVariant(h: fcQTextFormat_property(self.h, propertyId))

proc setProperty*(self: gen_qtextformat_types.QTextFormat, propertyId: cint, value: QVariant): void =
...
proc colorProperty*(self: gen_qtextformat_types.QTextFormat, propertyId: cint): QColor =
  QColor(h: fcQTextFormat_colorProperty(self.h, propertyId))

proc penProperty*(self: gen_qtextformat_types.QTextFormat, propertyId: cint): QPen =
  QPen(h: fcQTextFormat_penProperty(self.h, propertyId))

proc brushProperty*(self: gen_qtextformat_types.QTextFormat, propertyId: cint): QBrush =
  QBrush(h: fcQTextFormat_brushProperty(self.h, propertyId))

proc lengthProperty*(self: gen_qtextformat_types.QTextFormat, propertyId: cint): QTextLength =
  QTextLength(h: fcQTextFormat_lengthProperty(self.h, propertyId))

proc lengthVectorProperty*(self: gen_qtextformat_types.QTextFormat, propertyId: cint): seq[QTextLength] =
...
proc setProperty*(self: gen_qtextformat_types.QTextFormat, propertyId: cint, lengths: seq[QTextLength]): void =
...
proc properties*(self: gen_qtextformat_types.QTextFormat, ): Table[cint,QVariant] =
...
proc toBlockFormat*(self: gen_qtextformat_types.QTextFormat, ): QTextBlockFormat =
  QTextBlockFormat(h: fcQTextFormat_toBlockFormat(self.h))

proc toCharFormat*(self: gen_qtextformat_types.QTextFormat, ): QTextCharFormat =
  QTextCharFormat(h: fcQTextFormat_toCharFormat(self.h))

proc toListFormat*(self: gen_qtextformat_types.QTextFormat, ): QTextListFormat =
  QTextListFormat(h: fcQTextFormat_toListFormat(self.h))

proc toTableFormat*(self: gen_qtextformat_types.QTextFormat, ): QTextTableFormat =
  QTextTableFormat(h: fcQTextFormat_toTableFormat(self.h))

proc toFrameFormat*(self: gen_qtextformat_types.QTextFormat, ): QTextFrameFormat =
  QTextFrameFormat(h: fcQTextFormat_toFrameFormat(self.h))

proc toImageFormat*(self: gen_qtextformat_types.QTextFormat, ): QTextImageFormat =
  QTextImageFormat(h: fcQTextFormat_toImageFormat(self.h))

proc toTableCellFormat*(self: gen_qtextformat_types.QTextFormat, ): QTextTableCellFormat =
  QTextTableCellFormat(h: fcQTextFormat_toTableCellFormat(self.h))

proc operatorEqual*(self: gen_qtextformat_types.QTextFormat, rhs: QTextFormat): bool =
  fcQTextFormat_operatorEqual(self.h, rhs.h)

proc operatorNotEqual*(self: gen_qtextformat_types.QTextFormat, rhs: QTextFormat): bool =
  fcQTextFormat_operatorNotEqual(self.h, rhs.h)

proc ToQVariant*(self: gen_qtextformat_types.QTextFormat, ): QVariant =
  QVariant(h: fcQTextFormat_ToQVariant(self.h))
...
proc setBackground*(self: gen_qtextformat_types.QTextFormat, brush: QBrush): void =
  fcQTextFormat_setBackground(self.h, brush.h)

proc background*(self: gen_qtextformat_types.QTextFormat, ): QBrush =
  QBrush(h: fcQTextFormat_background(self.h))

proc clearBackground*(self: gen_qtextformat_types.QTextFormat, ): void =
  fcQTextFormat_clearBackground(self.h)

proc setForeground*(self: gen_qtextformat_types.QTextFormat, brush: QBrush): void =
  fcQTextFormat_setForeground(self.h, brush.h)

proc foreground*(self: gen_qtextformat_types.QTextFormat, ): QBrush =
  QBrush(h: fcQTextFormat_foreground(self.h))
...
proc create*(T: type gen_qtextformat_types.QTextCharFormat, param1: QTextCharFormat): gen_qtextformat_types.QTextCharFormat =
...
proc setFont*(self: gen_qtextformat_types.QTextCharFormat, font: QFont): void =
  fcQTextCharFormat_setFont(self.h, font.h)

proc font*(self: gen_qtextformat_types.QTextCharFormat, ): QFont =
  QFont(h: fcQTextCharFormat_font(self.h))
...
proc fontFamilies*(self: gen_qtextformat_types.QTextCharFormat, ): QVariant =
  QVariant(h: fcQTextCharFormat_fontFamilies(self.h))
...
proc fontStyleName*(self: gen_qtextformat_types.QTextCharFormat, ): QVariant =
  QVariant(h: fcQTextCharFormat_fontStyleName(self.h))
...
proc setUnderlineColor*(self: gen_qtextformat_types.QTextCharFormat, color: QColor): void =
  fcQTextCharFormat_setUnderlineColor(self.h, color.h)

proc underlineColor*(self: gen_qtextformat_types.QTextCharFormat, ): QColor =
  QColor(h: fcQTextCharFormat_underlineColor(self.h))
...
proc setTextOutline*(self: gen_qtextformat_types.QTextCharFormat, pen: QPen): void =
  fcQTextCharFormat_setTextOutline(self.h, pen.h)

proc textOutline*(self: gen_qtextformat_types.QTextCharFormat, ): QPen =
  QPen(h: fcQTextCharFormat_textOutline(self.h))
...
proc setSuperScriptBaseline*(self: gen_qtextformat_types.QTextCharFormat, baseline: float64): void =
  fcQTextCharFormat_setSuperScriptBaseline(self.h, baseline)

proc superScriptBaseline*(self: gen_qtextformat_types.QTextCharFormat, ): float64 =
  fcQTextCharFormat_superScriptBaseline(self.h)

proc setSubScriptBaseline*(self: gen_qtextformat_types.QTextCharFormat, baseline: float64): void =
  fcQTextCharFormat_setSubScriptBaseline(self.h, baseline)

proc subScriptBaseline*(self: gen_qtextformat_types.QTextCharFormat, ): float64 =
  fcQTextCharFormat_subScriptBaseline(self.h)

proc setBaselineOffset*(self: gen_qtextformat_types.QTextCharFormat, baseline: float64): void =
  fcQTextCharFormat_setBaselineOffset(self.h, baseline)

proc baselineOffset*(self: gen_qtextformat_types.QTextCharFormat, ): float64 =
  fcQTextCharFormat_baselineOffset(self.h)
...
proc setFont*(self: gen_qtextformat_types.QTextCharFormat, font: QFont, behavior: cint): void =
  fcQTextCharFormat_setFont2(self.h, font.h, cint(behavior))
...
proc create*(T: type gen_qtextformat_types.QTextBlockFormat, param1: QTextBlockFormat): gen_qtextformat_types.QTextBlockFormat =
...
proc setTabPositions*(self: gen_qtextformat_types.QTextBlockFormat, tabs: seq[QTextOptionTab]): void =
...
proc tabPositions*(self: gen_qtextformat_types.QTextBlockFormat, ): seq[QTextOptionTab] =
...
proc create*(T: type gen_qtextformat_types.QTextListFormat, param1: QTextListFormat): gen_qtextformat_types.QTextListFormat =
...
proc setQuality*(self: gen_qtextformat_types.QTextImageFormat, quality: cint): void =
  fcQTextImageFormat_setQuality(self.h, quality)

proc setQuality*(self: gen_qtextformat_types.QTextImageFormat, ): void =
  fcQTextImageFormat_setQuality2(self.h)
...
proc create*(T: type gen_qtextformat_types.QTextFrameFormat, param1: QTextFrameFormat): gen_qtextformat_types.QTextFrameFormat =
...
proc setBorderBrush*(self: gen_qtextformat_types.QTextFrameFormat, brush: QBrush): void =
  fcQTextFrameFormat_setBorderBrush(self.h, brush.h)

proc borderBrush*(self: gen_qtextformat_types.QTextFrameFormat, ): QBrush =
  QBrush(h: fcQTextFrameFormat_borderBrush(self.h))
...
proc setWidth*(self: gen_qtextformat_types.QTextFrameFormat, length: QTextLength): void =
  fcQTextFrameFormat_setWidthWithLength(self.h, length.h)

proc width*(self: gen_qtextformat_types.QTextFrameFormat, ): QTextLength =
...
proc setHeight*(self: gen_qtextformat_types.QTextFrameFormat, height: QTextLength): void =
  fcQTextFrameFormat_setHeightWithHeight(self.h, height.h)

proc height*(self: gen_qtextformat_types.QTextFrameFormat, ): QTextLength =
...
proc setColumnWidthConstraints*(self: gen_qtextformat_types.QTextTableFormat, constraints: seq[QTextLength]): void =
...
proc columnWidthConstraints*(self: gen_qtextformat_types.QTextTableFormat, ): seq[QTextLength] =
...
proc setTopBorderBrush*(self: gen_qtextformat_types.QTextTableCellFormat, brush: QBrush): void =
  fcQTextTableCellFormat_setTopBorderBrush(self.h, brush.h)

proc topBorderBrush*(self: gen_qtextformat_types.QTextTableCellFormat, ): QBrush =
  QBrush(h: fcQTextTableCellFormat_topBorderBrush(self.h))

proc setBottomBorderBrush*(self: gen_qtextformat_types.QTextTableCellFormat, brush: QBrush): void =
  fcQTextTableCellFormat_setBottomBorderBrush(self.h, brush.h)

proc bottomBorderBrush*(self: gen_qtextformat_types.QTextTableCellFormat, ): QBrush =
  QBrush(h: fcQTextTableCellFormat_bottomBorderBrush(self.h))

proc setLeftBorderBrush*(self: gen_qtextformat_types.QTextTableCellFormat, brush: QBrush): void =
  fcQTextTableCellFormat_setLeftBorderBrush(self.h, brush.h)

proc leftBorderBrush*(self: gen_qtextformat_types.QTextTableCellFormat, ): QBrush =
  QBrush(h: fcQTextTableCellFormat_leftBorderBrush(self.h))

proc setRightBorderBrush*(self: gen_qtextformat_types.QTextTableCellFormat, brush: QBrush): void =
  fcQTextTableCellFormat_setRightBorderBrush(self.h, brush.h)

proc rightBorderBrush*(self: gen_qtextformat_types.QTextTableCellFormat, ): QBrush =
  QBrush(h: fcQTextTableCellFormat_rightBorderBrush(self.h))

proc setBorderBrush*(self: gen_qtextformat_types.QTextTableCellFormat, brush: QBrush): void =
