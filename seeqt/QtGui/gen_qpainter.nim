...
template HighQualityAntialiasing*(_: type QPainterRenderHintEnum): untyped = 8
template NonCosmeticDefaultPen*(_: type QPainterRenderHintEnum): untyped = 16
template Qt4CompatiblePainting*(_: type QPainterRenderHintEnum): untyped = 32
...
proc create*(T: type gen_qpainter_types.QPainter, param1: QPaintDevice): gen_qpainter_types.QPainter =
  gen_qpainter_types.QPainter.init(fcQPainter_new2(param1.h))

proc device*(self: gen_qpainter_types.QPainter, ): QPaintDevice =
  QPaintDevice(h: fcQPainter_device(self.h))

proc begin*(self: gen_qpainter_types.QPainter, param1: QPaintDevice): bool =
...
proc initFrom*(self: gen_qpainter_types.QPainter, device: QPaintDevice): void =
...
proc font*(self: gen_qpainter_types.QPainter, ): QFont =
  QFont(h: fcQPainter_font(self.h))

proc setFont*(self: gen_qpainter_types.QPainter, f: QFont): void =
  fcQPainter_setFont(self.h, f.h)

proc fontMetrics*(self: gen_qpainter_types.QPainter, ): QFontMetrics =
  QFontMetrics(h: fcQPainter_fontMetrics(self.h))

proc fontInfo*(self: gen_qpainter_types.QPainter, ): QFontInfo =
  QFontInfo(h: fcQPainter_fontInfo(self.h))

proc setPen*(self: gen_qpainter_types.QPainter, color: QColor): void =
  fcQPainter_setPen(self.h, color.h)

proc setPen*(self: gen_qpainter_types.QPainter, pen: QPen): void =
...
proc pen*(self: gen_qpainter_types.QPainter, ): QPen =
  QPen(h: fcQPainter_pen(self.h))

proc setBrush*(self: gen_qpainter_types.QPainter, brush: QBrush): void =
...
proc brush*(self: gen_qpainter_types.QPainter, ): QBrush =
  QBrush(h: fcQPainter_brush(self.h))
...
proc brushOrigin*(self: gen_qpainter_types.QPainter, ): QPoint =
  QPoint(h: fcQPainter_brushOrigin(self.h))

proc setBrushOrigin*(self: gen_qpainter_types.QPainter, x: cint, y: cint): void =
  fcQPainter_setBrushOrigin(self.h, x, y)

proc setBrushOrigin*(self: gen_qpainter_types.QPainter, brushOrigin: QPoint): void =
  fcQPainter_setBrushOriginWithBrushOrigin(self.h, brushOrigin.h)

proc setBrushOrigin*(self: gen_qpainter_types.QPainter, brushOrigin: QPointF): void =
  fcQPainter_setBrushOrigin2(self.h, brushOrigin.h)

proc setBackground*(self: gen_qpainter_types.QPainter, bg: QBrush): void =
  fcQPainter_setBackground(self.h, bg.h)

proc background*(self: gen_qpainter_types.QPainter, ): QBrush =
  QBrush(h: fcQPainter_background(self.h))
...
proc clipRegion*(self: gen_qpainter_types.QPainter, ): QRegion =
  QRegion(h: fcQPainter_clipRegion(self.h))

proc clipPath*(self: gen_qpainter_types.QPainter, ): QPainterPath =
  QPainterPath(h: fcQPainter_clipPath(self.h))

proc setClipRect*(self: gen_qpainter_types.QPainter, param1: QRectF): void =
  fcQPainter_setClipRect(self.h, param1.h)

proc setClipRect*(self: gen_qpainter_types.QPainter, param1: QRect): void =
...
proc setClipRegion*(self: gen_qpainter_types.QPainter, param1: QRegion): void =
  fcQPainter_setClipRegion(self.h, param1.h)

proc setClipPath*(self: gen_qpainter_types.QPainter, path: QPainterPath): void =
...
proc clipBoundingRect*(self: gen_qpainter_types.QPainter, ): QRectF =
  QRectF(h: fcQPainter_clipBoundingRect(self.h))
...
proc setMatrix*(self: gen_qpainter_types.QPainter, matrix: QMatrix): void =
  fcQPainter_setMatrix(self.h, matrix.h)

proc matrix*(self: gen_qpainter_types.QPainter, ): QMatrix =
  QMatrix(h: fcQPainter_matrix(self.h))

proc deviceMatrix*(self: gen_qpainter_types.QPainter, ): QMatrix =
  QMatrix(h: fcQPainter_deviceMatrix(self.h))

proc resetMatrix*(self: gen_qpainter_types.QPainter, ): void =
  fcQPainter_resetMatrix(self.h)

proc setTransform*(self: gen_qpainter_types.QPainter, transform: QTransform): void =
  fcQPainter_setTransform(self.h, transform.h)

proc transform*(self: gen_qpainter_types.QPainter, ): QTransform =
  QTransform(h: fcQPainter_transform(self.h))

proc deviceTransform*(self: gen_qpainter_types.QPainter, ): QTransform =
  QTransform(h: fcQPainter_deviceTransform(self.h))

proc resetTransform*(self: gen_qpainter_types.QPainter, ): void =
  fcQPainter_resetTransform(self.h)

proc setWorldMatrix*(self: gen_qpainter_types.QPainter, matrix: QMatrix): void =
  fcQPainter_setWorldMatrix(self.h, matrix.h)

proc worldMatrix*(self: gen_qpainter_types.QPainter, ): QMatrix =
  QMatrix(h: fcQPainter_worldMatrix(self.h))

proc combinedMatrix*(self: gen_qpainter_types.QPainter, ): QMatrix =
  QMatrix(h: fcQPainter_combinedMatrix(self.h))
...
proc setWorldTransform*(self: gen_qpainter_types.QPainter, matrix: QTransform): void =
  fcQPainter_setWorldTransform(self.h, matrix.h)

proc worldTransform*(self: gen_qpainter_types.QPainter, ): QTransform =
  QTransform(h: fcQPainter_worldTransform(self.h))

proc combinedTransform*(self: gen_qpainter_types.QPainter, ): QTransform =
  QTransform(h: fcQPainter_combinedTransform(self.h))
...
proc translate*(self: gen_qpainter_types.QPainter, offset: QPointF): void =
  fcQPainter_translate(self.h, offset.h)

proc translate*(self: gen_qpainter_types.QPainter, offset: QPoint): void =
...
proc window*(self: gen_qpainter_types.QPainter, ): QRect =
  QRect(h: fcQPainter_window(self.h))

proc setWindow*(self: gen_qpainter_types.QPainter, window: QRect): void =
...
proc viewport*(self: gen_qpainter_types.QPainter, ): QRect =
  QRect(h: fcQPainter_viewport(self.h))

proc setViewport*(self: gen_qpainter_types.QPainter, viewport: QRect): void =
...
proc strokePath*(self: gen_qpainter_types.QPainter, path: QPainterPath, pen: QPen): void =
  fcQPainter_strokePath(self.h, path.h, pen.h)

proc fillPath*(self: gen_qpainter_types.QPainter, path: QPainterPath, brush: QBrush): void =
  fcQPainter_fillPath(self.h, path.h, brush.h)

proc drawPath*(self: gen_qpainter_types.QPainter, path: QPainterPath): void =
  fcQPainter_drawPath(self.h, path.h)

proc drawPoint*(self: gen_qpainter_types.QPainter, pt: QPointF): void =
  fcQPainter_drawPoint(self.h, pt.h)

proc drawPoint*(self: gen_qpainter_types.QPainter, p: QPoint): void =
...
proc drawPoints*(self: gen_qpainter_types.QPainter, points: QPointF, pointCount: cint): void =
  fcQPainter_drawPoints(self.h, points.h, pointCount)

proc drawPoints*(self: gen_qpainter_types.QPainter, points: QPoint, pointCount: cint): void =
  fcQPainter_drawPoints2(self.h, points.h, pointCount)

proc drawLine*(self: gen_qpainter_types.QPainter, line: QLineF): void =
  fcQPainter_drawLine(self.h, line.h)

proc drawLine*(self: gen_qpainter_types.QPainter, line: QLine): void =
...
proc drawLine*(self: gen_qpainter_types.QPainter, p1: QPoint, p2: QPoint): void =
  fcQPainter_drawLine3(self.h, p1.h, p2.h)

proc drawLine*(self: gen_qpainter_types.QPainter, p1: QPointF, p2: QPointF): void =
  fcQPainter_drawLine4(self.h, p1.h, p2.h)

proc drawLines*(self: gen_qpainter_types.QPainter, lines: QLineF, lineCount: cint): void =
  fcQPainter_drawLines(self.h, lines.h, lineCount)

proc drawLines*(self: gen_qpainter_types.QPainter, lines: seq[QLineF]): void =
...
proc drawLines*(self: gen_qpainter_types.QPainter, pointPairs: QPointF, lineCount: cint): void =
  fcQPainter_drawLines2(self.h, pointPairs.h, lineCount)

proc drawLines*(self: gen_qpainter_types.QPainter, pointPairs: seq[QPointF]): void =
...
proc drawLines*(self: gen_qpainter_types.QPainter, lines: QLine, lineCount: cint): void =
  fcQPainter_drawLines3(self.h, lines.h, lineCount)

proc drawLines*(self: gen_qpainter_types.QPainter, lines: seq[QLine]): void =
  var lines_CArray = newSeq[pointer](len(lines))
  for i in 0..<len(lines):
    lines_CArray[i] = lines[i].h
...
proc drawLines*(self: gen_qpainter_types.QPainter, pointPairs: QPoint, lineCount: cint): void =
  fcQPainter_drawLines5(self.h, pointPairs.h, lineCount)

proc drawLines*(self: gen_qpainter_types.QPainter, pointPairs: seq[QPoint]): void =
  var pointPairs_CArray = newSeq[pointer](len(pointPairs))
  for i in 0..<len(pointPairs):
    pointPairs_CArray[i] = pointPairs[i].h
...
proc drawRect*(self: gen_qpainter_types.QPainter, rect: QRectF): void =
...
proc drawRect*(self: gen_qpainter_types.QPainter, rect: QRect): void =
  fcQPainter_drawRectWithRect(self.h, rect.h)

proc drawRects*(self: gen_qpainter_types.QPainter, rects: QRectF, rectCount: cint): void =
  fcQPainter_drawRects(self.h, rects.h, rectCount)

proc drawRects*(self: gen_qpainter_types.QPainter, rectangles: seq[QRectF]): void =
...
proc drawRects*(self: gen_qpainter_types.QPainter, rects: QRect, rectCount: cint): void =
  fcQPainter_drawRects2(self.h, rects.h, rectCount)

proc drawRects*(self: gen_qpainter_types.QPainter, rectangles: seq[QRect]): void =
  var rectangles_CArray = newSeq[pointer](len(rectangles))
  for i in 0..<len(rectangles):
    rectangles_CArray[i] = rectangles[i].h
...
proc drawEllipse*(self: gen_qpainter_types.QPainter, r: QRectF): void =
  fcQPainter_drawEllipse(self.h, r.h)

proc drawEllipse*(self: gen_qpainter_types.QPainter, r: QRect): void =
...
proc drawEllipse*(self: gen_qpainter_types.QPainter, center: QPointF, rx: float64, ry: float64): void =
  fcQPainter_drawEllipse3(self.h, center.h, rx, ry)

proc drawEllipse*(self: gen_qpainter_types.QPainter, center: QPoint, rx: cint, ry: cint): void =
  fcQPainter_drawEllipse4(self.h, center.h, rx, ry)

proc drawPolyline*(self: gen_qpainter_types.QPainter, points: QPointF, pointCount: cint): void =
  fcQPainter_drawPolyline(self.h, points.h, pointCount)

proc drawPolyline*(self: gen_qpainter_types.QPainter, points: QPoint, pointCount: cint): void =
  fcQPainter_drawPolyline2(self.h, points.h, pointCount)

proc drawPolygon*(self: gen_qpainter_types.QPainter, points: QPointF, pointCount: cint): void =
  fcQPainter_drawPolygon(self.h, points.h, pointCount)

proc drawPolygon*(self: gen_qpainter_types.QPainter, points: QPoint, pointCount: cint): void =
  fcQPainter_drawPolygon2(self.h, points.h, pointCount)

proc drawConvexPolygon*(self: gen_qpainter_types.QPainter, points: QPointF, pointCount: cint): void =
  fcQPainter_drawConvexPolygon(self.h, points.h, pointCount)

proc drawConvexPolygon*(self: gen_qpainter_types.QPainter, points: QPoint, pointCount: cint): void =
  fcQPainter_drawConvexPolygon2(self.h, points.h, pointCount)

proc drawArc*(self: gen_qpainter_types.QPainter, rect: QRectF, a: cint, alen: cint): void =
  fcQPainter_drawArc(self.h, rect.h, a, alen)

proc drawArc*(self: gen_qpainter_types.QPainter, param1: QRect, a: cint, alen: cint): void =
...
proc drawPie*(self: gen_qpainter_types.QPainter, rect: QRectF, a: cint, alen: cint): void =
...
proc drawPie*(self: gen_qpainter_types.QPainter, param1: QRect, a: cint, alen: cint): void =
  fcQPainter_drawPie3(self.h, param1.h, a, alen)

proc drawChord*(self: gen_qpainter_types.QPainter, rect: QRectF, a: cint, alen: cint): void =
...
proc drawChord*(self: gen_qpainter_types.QPainter, param1: QRect, a: cint, alen: cint): void =
  fcQPainter_drawChord3(self.h, param1.h, a, alen)

proc drawRoundedRect*(self: gen_qpainter_types.QPainter, rect: QRectF, xRadius: float64, yRadius: float64): void =
...
proc drawRoundedRect*(self: gen_qpainter_types.QPainter, rect: QRect, xRadius: float64, yRadius: float64): void =
  fcQPainter_drawRoundedRect3(self.h, rect.h, xRadius, yRadius)

proc drawRoundRect*(self: gen_qpainter_types.QPainter, r: QRectF): void =
  fcQPainter_drawRoundRect(self.h, r.h)

proc drawRoundRect*(self: gen_qpainter_types.QPainter, x: cint, y: cint, w: cint, h: cint): void =
  fcQPainter_drawRoundRect2(self.h, x, y, w, h)

proc drawRoundRect*(self: gen_qpainter_types.QPainter, r: QRect): void =
  fcQPainter_drawRoundRectWithQRect(self.h, r.h)

proc drawTiledPixmap*(self: gen_qpainter_types.QPainter, rect: QRectF, pm: QPixmap): void =
  fcQPainter_drawTiledPixmap(self.h, rect.h, pm.h)

proc drawTiledPixmap*(self: gen_qpainter_types.QPainter, x: cint, y: cint, w: cint, h: cint, param5: QPixmap): void =
  fcQPainter_drawTiledPixmap2(self.h, x, y, w, h, param5.h)

proc drawTiledPixmap*(self: gen_qpainter_types.QPainter, param1: QRect, param2: QPixmap): void =
  fcQPainter_drawTiledPixmap3(self.h, param1.h, param2.h)

proc drawPicture*(self: gen_qpainter_types.QPainter, p: QPointF, picture: QPicture): void =
  fcQPainter_drawPicture(self.h, p.h, picture.h)

proc drawPicture*(self: gen_qpainter_types.QPainter, x: cint, y: cint, picture: QPicture): void =
  fcQPainter_drawPicture2(self.h, x, y, picture.h)

proc drawPicture*(self: gen_qpainter_types.QPainter, p: QPoint, picture: QPicture): void =
  fcQPainter_drawPicture3(self.h, p.h, picture.h)

proc drawPixmap*(self: gen_qpainter_types.QPainter, targetRect: QRectF, pixmap: QPixmap, sourceRect: QRectF): void =
  fcQPainter_drawPixmap(self.h, targetRect.h, pixmap.h, sourceRect.h)

proc drawPixmap*(self: gen_qpainter_types.QPainter, targetRect: QRect, pixmap: QPixmap, sourceRect: QRect): void =
  fcQPainter_drawPixmap2(self.h, targetRect.h, pixmap.h, sourceRect.h)

proc drawPixmap*(self: gen_qpainter_types.QPainter, x: cint, y: cint, w: cint, h: cint, pm: QPixmap, sx: cint, sy: cint, sw: cint, sh: cint): void =
  fcQPainter_drawPixmap3(self.h, x, y, w, h, pm.h, sx, sy, sw, sh)

proc drawPixmap*(self: gen_qpainter_types.QPainter, x: cint, y: cint, pm: QPixmap, sx: cint, sy: cint, sw: cint, sh: cint): void =
  fcQPainter_drawPixmap4(self.h, x, y, pm.h, sx, sy, sw, sh)

proc drawPixmap*(self: gen_qpainter_types.QPainter, p: QPointF, pm: QPixmap, sr: QRectF): void =
  fcQPainter_drawPixmap5(self.h, p.h, pm.h, sr.h)

proc drawPixmap*(self: gen_qpainter_types.QPainter, p: QPoint, pm: QPixmap, sr: QRect): void =
  fcQPainter_drawPixmap6(self.h, p.h, pm.h, sr.h)

proc drawPixmap*(self: gen_qpainter_types.QPainter, p: QPointF, pm: QPixmap): void =
  fcQPainter_drawPixmap7(self.h, p.h, pm.h)

proc drawPixmap*(self: gen_qpainter_types.QPainter, p: QPoint, pm: QPixmap): void =
  fcQPainter_drawPixmap8(self.h, p.h, pm.h)

proc drawPixmap*(self: gen_qpainter_types.QPainter, x: cint, y: cint, pm: QPixmap): void =
  fcQPainter_drawPixmap9(self.h, x, y, pm.h)

proc drawPixmap*(self: gen_qpainter_types.QPainter, r: QRect, pm: QPixmap): void =
  fcQPainter_drawPixmap10(self.h, r.h, pm.h)

proc drawPixmap*(self: gen_qpainter_types.QPainter, x: cint, y: cint, w: cint, h: cint, pm: QPixmap): void =
  fcQPainter_drawPixmap11(self.h, x, y, w, h, pm.h)

proc drawPixmapFragments*(self: gen_qpainter_types.QPainter, fragments: QPainterPixmapFragment, fragmentCount: cint, pixmap: QPixmap): void =
  fcQPainter_drawPixmapFragments(self.h, fragments.h, fragmentCount, pixmap.h)

proc drawImage*(self: gen_qpainter_types.QPainter, targetRect: QRectF, image: QImage, sourceRect: QRectF): void =
  fcQPainter_drawImage(self.h, targetRect.h, image.h, sourceRect.h)

proc drawImage*(self: gen_qpainter_types.QPainter, targetRect: QRect, image: QImage, sourceRect: QRect): void =
  fcQPainter_drawImage2(self.h, targetRect.h, image.h, sourceRect.h)

proc drawImage*(self: gen_qpainter_types.QPainter, p: QPointF, image: QImage, sr: QRectF): void =
  fcQPainter_drawImage3(self.h, p.h, image.h, sr.h)

proc drawImage*(self: gen_qpainter_types.QPainter, p: QPoint, image: QImage, sr: QRect): void =
  fcQPainter_drawImage4(self.h, p.h, image.h, sr.h)

proc drawImage*(self: gen_qpainter_types.QPainter, r: QRectF, image: QImage): void =
  fcQPainter_drawImage5(self.h, r.h, image.h)

proc drawImage*(self: gen_qpainter_types.QPainter, r: QRect, image: QImage): void =
  fcQPainter_drawImage6(self.h, r.h, image.h)

proc drawImage*(self: gen_qpainter_types.QPainter, p: QPointF, image: QImage): void =
  fcQPainter_drawImage7(self.h, p.h, image.h)

proc drawImage*(self: gen_qpainter_types.QPainter, p: QPoint, image: QImage): void =
  fcQPainter_drawImage8(self.h, p.h, image.h)

proc drawImage*(self: gen_qpainter_types.QPainter, x: cint, y: cint, image: QImage): void =
...
proc drawGlyphRun*(self: gen_qpainter_types.QPainter, position: QPointF, glyphRun: QGlyphRun): void =
  fcQPainter_drawGlyphRun(self.h, position.h, glyphRun.h)

proc drawStaticText*(self: gen_qpainter_types.QPainter, topLeftPosition: QPointF, staticText: QStaticText): void =
  fcQPainter_drawStaticText(self.h, topLeftPosition.h, staticText.h)

proc drawStaticText*(self: gen_qpainter_types.QPainter, topLeftPosition: QPoint, staticText: QStaticText): void =
  fcQPainter_drawStaticText2(self.h, topLeftPosition.h, staticText.h)

proc drawStaticText*(self: gen_qpainter_types.QPainter, left: cint, top: cint, staticText: QStaticText): void =
  fcQPainter_drawStaticText3(self.h, left, top, staticText.h)

proc drawText*(self: gen_qpainter_types.QPainter, p: QPointF, s: string): void =
  fcQPainter_drawText(self.h, p.h, struct_miqt_string(data: s, len: csize_t(len(s))))

proc drawText*(self: gen_qpainter_types.QPainter, p: QPoint, s: string): void =
...
proc drawText*(self: gen_qpainter_types.QPainter, p: QPointF, str: string, tf: cint, justificationPadding: cint): void =
  fcQPainter_drawText4(self.h, p.h, struct_miqt_string(data: str, len: csize_t(len(str))), tf, justificationPadding)

proc drawText*(self: gen_qpainter_types.QPainter, r: QRectF, flags: cint, text: string): void =
  fcQPainter_drawText5(self.h, r.h, flags, struct_miqt_string(data: text, len: csize_t(len(text))))

proc drawText*(self: gen_qpainter_types.QPainter, r: QRect, flags: cint, text: string): void =
...
proc drawText*(self: gen_qpainter_types.QPainter, r: QRectF, text: string): void =
  fcQPainter_drawText8(self.h, r.h, struct_miqt_string(data: text, len: csize_t(len(text))))

proc boundingRect*(self: gen_qpainter_types.QPainter, rect: QRectF, flags: cint, text: string): QRectF =
  QRectF(h: fcQPainter_boundingRect(self.h, rect.h, flags, struct_miqt_string(data: text, len: csize_t(len(text)))))

proc boundingRect*(self: gen_qpainter_types.QPainter, rect: QRect, flags: cint, text: string): QRect =
  QRect(h: fcQPainter_boundingRect2(self.h, rect.h, flags, struct_miqt_string(data: text, len: csize_t(len(text)))))

proc boundingRect*(self: gen_qpainter_types.QPainter, x: cint, y: cint, w: cint, h: cint, flags: cint, text: string): QRect =
  QRect(h: fcQPainter_boundingRect3(self.h, x, y, w, h, flags, struct_miqt_string(data: text, len: csize_t(len(text)))))

proc boundingRect*(self: gen_qpainter_types.QPainter, rect: QRectF, text: string): QRectF =
  QRectF(h: fcQPainter_boundingRect4(self.h, rect.h, struct_miqt_string(data: text, len: csize_t(len(text)))))

proc drawTextItem*(self: gen_qpainter_types.QPainter, p: QPointF, ti: QTextItem): void =
  fcQPainter_drawTextItem(self.h, p.h, ti.h)

proc drawTextItem*(self: gen_qpainter_types.QPainter, x: cint, y: cint, ti: QTextItem): void =
  fcQPainter_drawTextItem2(self.h, x, y, ti.h)

proc drawTextItem*(self: gen_qpainter_types.QPainter, p: QPoint, ti: QTextItem): void =
  fcQPainter_drawTextItem3(self.h, p.h, ti.h)

proc fillRect*(self: gen_qpainter_types.QPainter, param1: QRectF, param2: QBrush): void =
  fcQPainter_fillRect(self.h, param1.h, param2.h)

proc fillRect*(self: gen_qpainter_types.QPainter, x: cint, y: cint, w: cint, h: cint, param5: QBrush): void =
  fcQPainter_fillRect2(self.h, x, y, w, h, param5.h)

proc fillRect*(self: gen_qpainter_types.QPainter, param1: QRect, param2: QBrush): void =
  fcQPainter_fillRect3(self.h, param1.h, param2.h)

proc fillRect*(self: gen_qpainter_types.QPainter, param1: QRectF, color: QColor): void =
  fcQPainter_fillRect4(self.h, param1.h, color.h)

proc fillRect*(self: gen_qpainter_types.QPainter, x: cint, y: cint, w: cint, h: cint, color: QColor): void =
  fcQPainter_fillRect5(self.h, x, y, w, h, color.h)

proc fillRect*(self: gen_qpainter_types.QPainter, param1: QRect, color: QColor): void =
...
proc fillRect*(self: gen_qpainter_types.QPainter, r: QRect, c: cint): void =
  fcQPainter_fillRect8(self.h, r.h, cint(c))

proc fillRect*(self: gen_qpainter_types.QPainter, r: QRectF, c: cint): void =
...
proc fillRect2*(self: gen_qpainter_types.QPainter, r: QRect, style: cint): void =
  fcQPainter_fillRect11(self.h, r.h, cint(style))

proc fillRect2*(self: gen_qpainter_types.QPainter, r: QRectF, style: cint): void =
...
proc fillRect3*(self: gen_qpainter_types.QPainter, r: QRect, preset: cint): void =
  fcQPainter_fillRect14(self.h, r.h, cint(preset))

proc fillRect3*(self: gen_qpainter_types.QPainter, r: QRectF, preset: cint): void =
  fcQPainter_fillRect15(self.h, r.h, cint(preset))

proc eraseRect*(self: gen_qpainter_types.QPainter, param1: QRectF): void =
...
proc eraseRect*(self: gen_qpainter_types.QPainter, param1: QRect): void =
...
proc paintEngine*(self: gen_qpainter_types.QPainter, ): QPaintEngine =
  QPaintEngine(h: fcQPainter_paintEngine(self.h))

proc setRedirected*(_: type gen_qpainter_types.QPainter, device: QPaintDevice, replacement: QPaintDevice): void =
  fcQPainter_setRedirected(device.h, replacement.h)

proc redirected*(_: type gen_qpainter_types.QPainter, device: QPaintDevice): QPaintDevice =
  QPaintDevice(h: fcQPainter_redirected(device.h))

proc restoreRedirected*(_: type gen_qpainter_types.QPainter, device: QPaintDevice): void =
...
proc setClipRect*(self: gen_qpainter_types.QPainter, param1: QRectF, op: cint): void =
  fcQPainter_setClipRect22(self.h, param1.h, cint(op))

proc setClipRect*(self: gen_qpainter_types.QPainter, param1: QRect, op: cint): void =
...
proc setClipRegion*(self: gen_qpainter_types.QPainter, param1: QRegion, op: cint): void =
  fcQPainter_setClipRegion2(self.h, param1.h, cint(op))

proc setClipPath*(self: gen_qpainter_types.QPainter, path: QPainterPath, op: cint): void =
  fcQPainter_setClipPath2(self.h, path.h, cint(op))

proc setMatrix*(self: gen_qpainter_types.QPainter, matrix: QMatrix, combine: bool): void =
  fcQPainter_setMatrix2(self.h, matrix.h, combine)

proc setTransform*(self: gen_qpainter_types.QPainter, transform: QTransform, combine: bool): void =
  fcQPainter_setTransform2(self.h, transform.h, combine)

proc setWorldMatrix*(self: gen_qpainter_types.QPainter, matrix: QMatrix, combine: bool): void =
  fcQPainter_setWorldMatrix2(self.h, matrix.h, combine)

proc setWorldTransform*(self: gen_qpainter_types.QPainter, matrix: QTransform, combine: bool): void =
  fcQPainter_setWorldTransform2(self.h, matrix.h, combine)

proc drawPolygon*(self: gen_qpainter_types.QPainter, points: QPointF, pointCount: cint, fillRule: cint): void =
  fcQPainter_drawPolygon32(self.h, points.h, pointCount, cint(fillRule))

proc drawPolygon*(self: gen_qpainter_types.QPainter, points: QPoint, pointCount: cint, fillRule: cint): void =
  fcQPainter_drawPolygon33(self.h, points.h, pointCount, cint(fillRule))

proc drawRoundedRect*(self: gen_qpainter_types.QPainter, rect: QRectF, xRadius: float64, yRadius: float64, mode: cint): void =
...
proc drawRoundedRect*(self: gen_qpainter_types.QPainter, rect: QRect, xRadius: float64, yRadius: float64, mode: cint): void =
  fcQPainter_drawRoundedRect42(self.h, rect.h, xRadius, yRadius, cint(mode))

proc drawRoundRect*(self: gen_qpainter_types.QPainter, r: QRectF, xround: cint): void =
  fcQPainter_drawRoundRect22(self.h, r.h, xround)

proc drawRoundRect*(self: gen_qpainter_types.QPainter, r: QRectF, xround: cint, yround: cint): void =
  fcQPainter_drawRoundRect3(self.h, r.h, xround, yround)

proc drawRoundRect*(self: gen_qpainter_types.QPainter, x: cint, y: cint, w: cint, h: cint, param5: cint): void =
  fcQPainter_drawRoundRect5(self.h, x, y, w, h, param5)

proc drawRoundRect*(self: gen_qpainter_types.QPainter, x: cint, y: cint, w: cint, h: cint, param5: cint, param6: cint): void =
  fcQPainter_drawRoundRect6(self.h, x, y, w, h, param5, param6)

proc drawRoundRect*(self: gen_qpainter_types.QPainter, r: QRect, xround: cint): void =
  fcQPainter_drawRoundRect23(self.h, r.h, xround)

proc drawRoundRect*(self: gen_qpainter_types.QPainter, r: QRect, xround: cint, yround: cint): void =
  fcQPainter_drawRoundRect32(self.h, r.h, xround, yround)

proc drawTiledPixmap*(self: gen_qpainter_types.QPainter, rect: QRectF, pm: QPixmap, offset: QPointF): void =
  fcQPainter_drawTiledPixmap32(self.h, rect.h, pm.h, offset.h)

proc drawTiledPixmap*(self: gen_qpainter_types.QPainter, x: cint, y: cint, w: cint, h: cint, param5: QPixmap, sx: cint): void =
  fcQPainter_drawTiledPixmap6(self.h, x, y, w, h, param5.h, sx)

proc drawTiledPixmap*(self: gen_qpainter_types.QPainter, x: cint, y: cint, w: cint, h: cint, param5: QPixmap, sx: cint, sy: cint): void =
  fcQPainter_drawTiledPixmap7(self.h, x, y, w, h, param5.h, sx, sy)

proc drawTiledPixmap*(self: gen_qpainter_types.QPainter, param1: QRect, param2: QPixmap, param3: QPoint): void =
  fcQPainter_drawTiledPixmap33(self.h, param1.h, param2.h, param3.h)

proc drawPixmapFragments*(self: gen_qpainter_types.QPainter, fragments: QPainterPixmapFragment, fragmentCount: cint, pixmap: QPixmap, hints: cint): void =
  fcQPainter_drawPixmapFragments4(self.h, fragments.h, fragmentCount, pixmap.h, cint(hints))

proc drawImage*(self: gen_qpainter_types.QPainter, targetRect: QRectF, image: QImage, sourceRect: QRectF, flags: cint): void =
  fcQPainter_drawImage42(self.h, targetRect.h, image.h, sourceRect.h, cint(flags))

proc drawImage*(self: gen_qpainter_types.QPainter, targetRect: QRect, image: QImage, sourceRect: QRect, flags: cint): void =
  fcQPainter_drawImage43(self.h, targetRect.h, image.h, sourceRect.h, cint(flags))

proc drawImage*(self: gen_qpainter_types.QPainter, p: QPointF, image: QImage, sr: QRectF, flags: cint): void =
  fcQPainter_drawImage44(self.h, p.h, image.h, sr.h, cint(flags))

proc drawImage*(self: gen_qpainter_types.QPainter, p: QPoint, image: QImage, sr: QRect, flags: cint): void =
  fcQPainter_drawImage45(self.h, p.h, image.h, sr.h, cint(flags))

proc drawImage*(self: gen_qpainter_types.QPainter, x: cint, y: cint, image: QImage, sx: cint): void =
  fcQPainter_drawImage46(self.h, x, y, image.h, sx)

proc drawImage*(self: gen_qpainter_types.QPainter, x: cint, y: cint, image: QImage, sx: cint, sy: cint): void =
  fcQPainter_drawImage52(self.h, x, y, image.h, sx, sy)

proc drawImage*(self: gen_qpainter_types.QPainter, x: cint, y: cint, image: QImage, sx: cint, sy: cint, sw: cint): void =
  fcQPainter_drawImage62(self.h, x, y, image.h, sx, sy, sw)

proc drawImage*(self: gen_qpainter_types.QPainter, x: cint, y: cint, image: QImage, sx: cint, sy: cint, sw: cint, sh: cint): void =
  fcQPainter_drawImage72(self.h, x, y, image.h, sx, sy, sw, sh)

proc drawImage*(self: gen_qpainter_types.QPainter, x: cint, y: cint, image: QImage, sx: cint, sy: cint, sw: cint, sh: cint, flags: cint): void =
  fcQPainter_drawImage82(self.h, x, y, image.h, sx, sy, sw, sh, cint(flags))

proc drawText*(self: gen_qpainter_types.QPainter, r: QRectF, flags: cint, text: string, br: QRectF): void =
  fcQPainter_drawText42(self.h, r.h, flags, struct_miqt_string(data: text, len: csize_t(len(text))), br.h)

proc drawText*(self: gen_qpainter_types.QPainter, r: QRect, flags: cint, text: string, br: QRect): void =
  fcQPainter_drawText43(self.h, r.h, flags, struct_miqt_string(data: text, len: csize_t(len(text))), br.h)

proc drawText*(self: gen_qpainter_types.QPainter, x: cint, y: cint, w: cint, h: cint, flags: cint, text: string, br: QRect): void =
  fcQPainter_drawText72(self.h, x, y, w, h, flags, struct_miqt_string(data: text, len: csize_t(len(text))), br.h)

proc drawText*(self: gen_qpainter_types.QPainter, r: QRectF, text: string, o: QTextOption): void =
  fcQPainter_drawText32(self.h, r.h, struct_miqt_string(data: text, len: csize_t(len(text))), o.h)

proc boundingRect*(self: gen_qpainter_types.QPainter, rect: QRectF, text: string, o: QTextOption): QRectF =
  QRectF(h: fcQPainter_boundingRect32(self.h, rect.h, struct_miqt_string(data: text, len: csize_t(len(text))), o.h))
...
proc setRedirected*(_: type gen_qpainter_types.QPainter, device: QPaintDevice, replacement: QPaintDevice, offset: QPoint): void =
  fcQPainter_setRedirected3(device.h, replacement.h, offset.h)

proc redirected*(_: type gen_qpainter_types.QPainter, device: QPaintDevice, offset: QPoint): QPaintDevice =
  QPaintDevice(h: fcQPainter_redirected2(device.h, offset.h))
...
func init*(T: type gen_qpainter_types.QPainterPixmapFragment, h: ptr cQPainterPixmapFragment): gen_qpainter_types.QPainterPixmapFragment =
  T(h: h)
proc create*(_: type gen_qpainter_types.QPainterPixmapFragment, pos: QPointF, sourceRect: QRectF): QPainterPixmapFragment =
  QPainterPixmapFragment(h: fcQPainterPixmapFragment_create(pos.h, sourceRect.h))

proc create*(_: type gen_qpainter_types.QPainterPixmapFragment, pos: QPointF, sourceRect: QRectF, scaleX: float64): QPainterPixmapFragment =
  QPainterPixmapFragment(h: fcQPainterPixmapFragment_create3(pos.h, sourceRect.h, scaleX))

proc create*(_: type gen_qpainter_types.QPainterPixmapFragment, pos: QPointF, sourceRect: QRectF, scaleX: float64, scaleY: float64): QPainterPixmapFragment =
  QPainterPixmapFragment(h: fcQPainterPixmapFragment_create4(pos.h, sourceRect.h, scaleX, scaleY))

proc create*(_: type gen_qpainter_types.QPainterPixmapFragment, pos: QPointF, sourceRect: QRectF, scaleX: float64, scaleY: float64, rotation: float64): QPainterPixmapFragment =
  QPainterPixmapFragment(h: fcQPainterPixmapFragment_create5(pos.h, sourceRect.h, scaleX, scaleY, rotation))

proc create*(_: type gen_qpainter_types.QPainterPixmapFragment, pos: QPointF, sourceRect: QRectF, scaleX: float64, scaleY: float64, rotation: float64, opacity: float64): QPainterPixmapFragment =
