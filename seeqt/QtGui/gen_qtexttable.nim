...
proc create*(T: type gen_qtexttable_types.QTextTableCell, o: QTextTableCell): gen_qtexttable_types.QTextTableCell =
  gen_qtexttable_types.QTextTableCell.init(fcQTextTableCell_new2(o.h))

proc operatorAssign*(self: gen_qtexttable_types.QTextTableCell, o: QTextTableCell): void =
  fcQTextTableCell_operatorAssign(self.h, o.h)

proc setFormat*(self: gen_qtexttable_types.QTextTableCell, format: QTextCharFormat): void =
  fcQTextTableCell_setFormat(self.h, format.h)

proc format*(self: gen_qtexttable_types.QTextTableCell, ): QTextCharFormat =
  QTextCharFormat(h: fcQTextTableCell_format(self.h))
...
proc firstCursorPosition*(self: gen_qtexttable_types.QTextTableCell, ): QTextCursor =
  QTextCursor(h: fcQTextTableCell_firstCursorPosition(self.h))

proc lastCursorPosition*(self: gen_qtexttable_types.QTextTableCell, ): QTextCursor =
  QTextCursor(h: fcQTextTableCell_lastCursorPosition(self.h))
...
proc operatorEqual*(self: gen_qtexttable_types.QTextTableCell, other: QTextTableCell): bool =
  fcQTextTableCell_operatorEqual(self.h, other.h)

proc operatorNotEqual*(self: gen_qtexttable_types.QTextTableCell, other: QTextTableCell): bool =
  fcQTextTableCell_operatorNotEqual(self.h, other.h)

proc begin*(self: gen_qtexttable_types.QTextTableCell, ): QTextFrameiterator =
  QTextFrameiterator(h: fcQTextTableCell_begin(self.h))

proc endX*(self: gen_qtexttable_types.QTextTableCell, ): QTextFrameiterator =
  QTextFrameiterator(h: fcQTextTableCell_endX(self.h))
...
func init*(T: type gen_qtexttable_types.QTextTable, h: ptr cQTextTable): gen_qtexttable_types.QTextTable =
  T(h: h)
proc create*(T: type gen_qtexttable_types.QTextTable, doc: QTextDocument): gen_qtexttable_types.QTextTable =
  gen_qtexttable_types.QTextTable.init(fcQTextTable_new(doc.h))

proc metaObject*(self: gen_qtexttable_types.QTextTable, ): QMetaObject =
  QMetaObject(h: fcQTextTable_metaObject(self.h))
...
proc mergeCells*(self: gen_qtexttable_types.QTextTable, cursor: QTextCursor): void =
...
proc cellAt*(self: gen_qtexttable_types.QTextTable, row: cint, col: cint): QTextTableCell =
  QTextTableCell(h: fcQTextTable_cellAt(self.h, row, col))

proc cellAt*(self: gen_qtexttable_types.QTextTable, position: cint): QTextTableCell =
  QTextTableCell(h: fcQTextTable_cellAtWithPosition(self.h, position))

proc cellAt*(self: gen_qtexttable_types.QTextTable, c: QTextCursor): QTextTableCell =
  QTextTableCell(h: fcQTextTable_cellAtWithQTextCursor(self.h, c.h))

proc rowStart*(self: gen_qtexttable_types.QTextTable, c: QTextCursor): QTextCursor =
  QTextCursor(h: fcQTextTable_rowStart(self.h, c.h))

proc rowEnd*(self: gen_qtexttable_types.QTextTable, c: QTextCursor): QTextCursor =
  QTextCursor(h: fcQTextTable_rowEnd(self.h, c.h))

proc setFormat*(self: gen_qtexttable_types.QTextTable, format: QTextTableFormat): void =
  fcQTextTable_setFormat(self.h, format.h)

proc format*(self: gen_qtexttable_types.QTextTable, ): QTextTableFormat =
  QTextTableFormat(h: fcQTextTable_format(self.h))
...
proc miqt_exec_callback_QTextTable_metacall(self: ptr cQTextTable, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QTextTable_metacall ".} =
  ...
  virtualReturn
proc QTextTableevent*(self: gen_qtexttable_types.QTextTable, event: QEvent): bool =
  fQTextTable_virtualbase_event(self.h, event.h)

type QTextTableeventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QTextTable_event(self: ptr cQTextTable, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QTextTable_event ".} =
  ...
  virtualReturn
proc QTextTableeventFilter*(self: gen_qtexttable_types.QTextTable, watched: QObject, event: QEvent): bool =
  fQTextTable_virtualbase_eventFilter(self.h, watched.h, event.h)

type QTextTableeventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QTextTable_eventFilter(self: ptr cQTextTable, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QTextTable_eventFilter ".} =
  ...
  virtualReturn
proc QTextTabletimerEvent*(self: gen_qtexttable_types.QTextTable, event: QTimerEvent): void =
  fQTextTable_virtualbase_timerEvent(self.h, event.h)

type QTextTabletimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QTextTable_timerEvent(self: ptr cQTextTable, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTextTable_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTextTablechildEvent*(self: gen_qtexttable_types.QTextTable, event: QChildEvent): void =
  fQTextTable_virtualbase_childEvent(self.h, event.h)

type QTextTablechildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QTextTable_childEvent(self: ptr cQTextTable, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTextTable_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTextTablecustomEvent*(self: gen_qtexttable_types.QTextTable, event: QEvent): void =
  fQTextTable_virtualbase_customEvent(self.h, event.h)

type QTextTablecustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QTextTable_customEvent(self: ptr cQTextTable, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTextTable_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTextTableconnectNotify*(self: gen_qtexttable_types.QTextTable, signal: QMetaMethod): void =
  fQTextTable_virtualbase_connectNotify(self.h, signal.h)

type QTextTableconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QTextTable_connectNotify(self: ptr cQTextTable, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QTextTable_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QTextTabledisconnectNotify*(self: gen_qtexttable_types.QTextTable, signal: QMetaMethod): void =
  fQTextTable_virtualbase_disconnectNotify(self.h, signal.h)

type QTextTabledisconnectNotifyProc* = proc(signal: QMetaMethod): void
