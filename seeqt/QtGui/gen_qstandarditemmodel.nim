...
proc sibling*(self: gen_qstandarditemmodel_types.QStandardItemModel, row: cint, column: cint, idx: QModelIndex): QModelIndex =
  QModelIndex(h: fcQStandardItemModel_sibling(self.h, row, column, idx.h))
