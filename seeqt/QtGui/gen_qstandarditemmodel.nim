...
proc create*(T: type gen_qstandarditemmodel_types.QStandardItem, icon: QIcon, text: string): gen_qstandarditemmodel_types.QStandardItem =
...
proc data*(self: gen_qstandarditemmodel_types.QStandardItem, role: cint): QVariant =
  QVariant(h: fcQStandardItem_data(self.h, role))

proc multiData*(self: gen_qstandarditemmodel_types.QStandardItem, roleDataSpan: QModelRoleDataSpan): void =
  fcQStandardItem_multiData(self.h, roleDataSpan.h)

proc setData*(self: gen_qstandarditemmodel_types.QStandardItem, value: QVariant, role: cint): void =
...
proc icon*(self: gen_qstandarditemmodel_types.QStandardItem, ): QIcon =
  QIcon(h: fcQStandardItem_icon(self.h))

proc setIcon*(self: gen_qstandarditemmodel_types.QStandardItem, icon: QIcon): void =
...
proc sizeHint*(self: gen_qstandarditemmodel_types.QStandardItem, ): QSize =
  QSize(h: fcQStandardItem_sizeHint(self.h))

proc setSizeHint*(self: gen_qstandarditemmodel_types.QStandardItem, sizeHint: QSize): void =
  fcQStandardItem_setSizeHint(self.h, sizeHint.h)

proc font*(self: gen_qstandarditemmodel_types.QStandardItem, ): QFont =
  QFont(h: fcQStandardItem_font(self.h))

proc setFont*(self: gen_qstandarditemmodel_types.QStandardItem, font: QFont): void =
...
proc background*(self: gen_qstandarditemmodel_types.QStandardItem, ): QBrush =
  QBrush(h: fcQStandardItem_background(self.h))

proc setBackground*(self: gen_qstandarditemmodel_types.QStandardItem, brush: QBrush): void =
  fcQStandardItem_setBackground(self.h, brush.h)

proc foreground*(self: gen_qstandarditemmodel_types.QStandardItem, ): QBrush =
  QBrush(h: fcQStandardItem_foreground(self.h))

proc setForeground*(self: gen_qstandarditemmodel_types.QStandardItem, brush: QBrush): void =
...
proc parent*(self: gen_qstandarditemmodel_types.QStandardItem, ): QStandardItem =
...
proc index*(self: gen_qstandarditemmodel_types.QStandardItem, ): QModelIndex =
  QModelIndex(h: fcQStandardItem_index(self.h))

proc model*(self: gen_qstandarditemmodel_types.QStandardItem, ): QStandardItemModel =
...
proc child*(self: gen_qstandarditemmodel_types.QStandardItem, row: cint): QStandardItem =
  QStandardItem(h: fcQStandardItem_child(self.h, row))

proc setChild*(self: gen_qstandarditemmodel_types.QStandardItem, row: cint, column: cint, item: QStandardItem): void =
  fcQStandardItem_setChild(self.h, row, column, item.h)

proc setChild*(self: gen_qstandarditemmodel_types.QStandardItem, row: cint, item: QStandardItem): void =
  fcQStandardItem_setChild2(self.h, row, item.h)

proc insertRow*(self: gen_qstandarditemmodel_types.QStandardItem, row: cint, items: seq[QStandardItem]): void =
...
proc insertColumn*(self: gen_qstandarditemmodel_types.QStandardItem, column: cint, items: seq[QStandardItem]): void =
  var items_CArray = newSeq[pointer](len(items))
  for i in 0..<len(items):
    items_CArray[i] = items[i].h
...
proc insertRows*(self: gen_qstandarditemmodel_types.QStandardItem, row: cint, items: seq[QStandardItem]): void =
  var items_CArray = newSeq[pointer](len(items))
  for i in 0..<len(items):
    items_CArray[i] = items[i].h
...
proc appendRow*(self: gen_qstandarditemmodel_types.QStandardItem, items: seq[QStandardItem]): void =
  var items_CArray = newSeq[pointer](len(items))
  for i in 0..<len(items):
    items_CArray[i] = items[i].h
...
proc appendRows*(self: gen_qstandarditemmodel_types.QStandardItem, items: seq[QStandardItem]): void =
  var items_CArray = newSeq[pointer](len(items))
  for i in 0..<len(items):
    items_CArray[i] = items[i].h
...
proc appendColumn*(self: gen_qstandarditemmodel_types.QStandardItem, items: seq[QStandardItem]): void =
  var items_CArray = newSeq[pointer](len(items))
  for i in 0..<len(items):
    items_CArray[i] = items[i].h
...
proc insertRow*(self: gen_qstandarditemmodel_types.QStandardItem, row: cint, item: QStandardItem): void =
  fcQStandardItem_insertRow2(self.h, row, item.h)

proc appendRow*(self: gen_qstandarditemmodel_types.QStandardItem, item: QStandardItem): void =
  fcQStandardItem_appendRowWithItem(self.h, item.h)

proc takeChild*(self: gen_qstandarditemmodel_types.QStandardItem, row: cint): QStandardItem =
  QStandardItem(h: fcQStandardItem_takeChild(self.h, row))

proc takeRow*(self: gen_qstandarditemmodel_types.QStandardItem, row: cint): seq[QStandardItem] =
...
proc takeColumn*(self: gen_qstandarditemmodel_types.QStandardItem, column: cint): seq[QStandardItem] =
...
proc clone*(self: gen_qstandarditemmodel_types.QStandardItem, ): QStandardItem =
...
proc read*(self: gen_qstandarditemmodel_types.QStandardItem, inVal: QDataStream): void =
  fcQStandardItem_read(self.h, inVal.h)

proc write*(self: gen_qstandarditemmodel_types.QStandardItem, outVal: QDataStream): void =
  fcQStandardItem_write(self.h, outVal.h)

proc operatorLesser*(self: gen_qstandarditemmodel_types.QStandardItem, other: QStandardItem): bool =
  fcQStandardItem_operatorLesser(self.h, other.h)

proc child*(self: gen_qstandarditemmodel_types.QStandardItem, row: cint, column: cint): QStandardItem =
  QStandardItem(h: fcQStandardItem_child2(self.h, row, column))

proc takeChild*(self: gen_qstandarditemmodel_types.QStandardItem, row: cint, column: cint): QStandardItem =
...
proc QStandardItemdata*(self: gen_qstandarditemmodel_types.QStandardItem, role: cint): QVariant =
  QVariant(h: fQStandardItem_virtualbase_data(self.h, role))

type QStandardItemdataProc* = proc(role: cint): QVariant
...
proc miqt_exec_callback_QStandardItem_data(self: ptr cQStandardItem, slot: int, role: cint): pointer {.exportc: "miqt_exec_callback_QStandardItem_data ".} =
  ...
  virtualReturn.h
proc QStandardItemmultiData*(self: gen_qstandarditemmodel_types.QStandardItem, roleDataSpan: QModelRoleDataSpan): void =
  fQStandardItem_virtualbase_multiData(self.h, roleDataSpan.h)

type QStandardItemmultiDataProc* = proc(roleDataSpan: QModelRoleDataSpan): void
...
proc miqt_exec_callback_QStandardItem_multiData(self: ptr cQStandardItem, slot: int, roleDataSpan: pointer): void {.exportc: "miqt_exec_callback_QStandardItem_multiData ".} =
  ...
  let slotval1 = QModelRoleDataSpan(h: roleDataSpan)


  nimfunc[](slotval1)
proc QStandardItemsetData*(self: gen_qstandarditemmodel_types.QStandardItem, value: QVariant, role: cint): void =
  fQStandardItem_virtualbase_setData(self.h, value.h, role)

type QStandardItemsetDataProc* = proc(value: QVariant, role: cint): void
...
proc miqt_exec_callback_QStandardItem_setData(self: ptr cQStandardItem, slot: int, value: pointer, role: cint): void {.exportc: "miqt_exec_callback_QStandardItem_setData ".} =
  ...
  let slotval1 = QVariant(h: value)

  let slotval2 = role


  nimfunc[](slotval1, slotval2)
proc QStandardItemclone*(self: gen_qstandarditemmodel_types.QStandardItem, ): QStandardItem =
  QStandardItem(h: fQStandardItem_virtualbase_clone(self.h))

type QStandardItemcloneProc* = proc(): QStandardItem
...
proc miqt_exec_callback_QStandardItem_type(self: ptr cQStandardItem, slot: int): cint {.exportc: "miqt_exec_callback_QStandardItem_type ".} =
  ...
  virtualReturn
proc QStandardItemread*(self: gen_qstandarditemmodel_types.QStandardItem, inVal: QDataStream): void =
  fQStandardItem_virtualbase_read(self.h, inVal.h)

type QStandardItemreadProc* = proc(inVal: QDataStream): void
...
proc miqt_exec_callback_QStandardItem_read(self: ptr cQStandardItem, slot: int, inVal: pointer): void {.exportc: "miqt_exec_callback_QStandardItem_read ".} =
  ...
  nimfunc[](slotval1)
proc QStandardItemwrite*(self: gen_qstandarditemmodel_types.QStandardItem, outVal: QDataStream): void =
  fQStandardItem_virtualbase_write(self.h, outVal.h)

type QStandardItemwriteProc* = proc(outVal: QDataStream): void
...
proc miqt_exec_callback_QStandardItem_write(self: ptr cQStandardItem, slot: int, outVal: pointer): void {.exportc: "miqt_exec_callback_QStandardItem_write ".} =
  ...
  nimfunc[](slotval1)
proc QStandardItemoperatorLesser*(self: gen_qstandarditemmodel_types.QStandardItem, other: QStandardItem): bool =
  fQStandardItem_virtualbase_operatorLesser(self.h, other.h)

type QStandardItemoperatorLesserProc* = proc(other: QStandardItem): bool
...
proc create*(T: type gen_qstandarditemmodel_types.QStandardItemModel, parent: QObject): gen_qstandarditemmodel_types.QStandardItemModel =
  gen_qstandarditemmodel_types.QStandardItemModel.init(fcQStandardItemModel_new3(parent.h))

proc create*(T: type gen_qstandarditemmodel_types.QStandardItemModel, rows: cint, columns: cint, parent: QObject): gen_qstandarditemmodel_types.QStandardItemModel =
  gen_qstandarditemmodel_types.QStandardItemModel.init(fcQStandardItemModel_new4(rows, columns, parent.h))

proc metaObject*(self: gen_qstandarditemmodel_types.QStandardItemModel, ): QMetaObject =
  QMetaObject(h: fcQStandardItemModel_metaObject(self.h))
...
proc index*(self: gen_qstandarditemmodel_types.QStandardItemModel, row: cint, column: cint, parent: QModelIndex): QModelIndex =
  QModelIndex(h: fcQStandardItemModel_index(self.h, row, column, parent.h))

proc parent*(self: gen_qstandarditemmodel_types.QStandardItemModel, child: QModelIndex): QModelIndex =
  QModelIndex(h: fcQStandardItemModel_parent(self.h, child.h))

proc rowCount*(self: gen_qstandarditemmodel_types.QStandardItemModel, parent: QModelIndex): cint =
  fcQStandardItemModel_rowCount(self.h, parent.h)

proc columnCount*(self: gen_qstandarditemmodel_types.QStandardItemModel, parent: QModelIndex): cint =
  fcQStandardItemModel_columnCount(self.h, parent.h)

proc hasChildren*(self: gen_qstandarditemmodel_types.QStandardItemModel, parent: QModelIndex): bool =
  fcQStandardItemModel_hasChildren(self.h, parent.h)

proc data*(self: gen_qstandarditemmodel_types.QStandardItemModel, index: QModelIndex, role: cint): QVariant =
  QVariant(h: fcQStandardItemModel_data(self.h, index.h, role))

proc multiData*(self: gen_qstandarditemmodel_types.QStandardItemModel, index: QModelIndex, roleDataSpan: QModelRoleDataSpan): void =
  fcQStandardItemModel_multiData(self.h, index.h, roleDataSpan.h)

proc setData*(self: gen_qstandarditemmodel_types.QStandardItemModel, index: QModelIndex, value: QVariant, role: cint): bool =
  fcQStandardItemModel_setData(self.h, index.h, value.h, role)

proc clearItemData*(self: gen_qstandarditemmodel_types.QStandardItemModel, index: QModelIndex): bool =
  fcQStandardItemModel_clearItemData(self.h, index.h)

proc headerData*(self: gen_qstandarditemmodel_types.QStandardItemModel, section: cint, orientation: cint, role: cint): QVariant =
  QVariant(h: fcQStandardItemModel_headerData(self.h, section, cint(orientation), role))

proc setHeaderData*(self: gen_qstandarditemmodel_types.QStandardItemModel, section: cint, orientation: cint, value: QVariant, role: cint): bool =
  fcQStandardItemModel_setHeaderData(self.h, section, cint(orientation), value.h, role)

proc insertRows*(self: gen_qstandarditemmodel_types.QStandardItemModel, row: cint, count: cint, parent: QModelIndex): bool =
  fcQStandardItemModel_insertRows(self.h, row, count, parent.h)

proc insertColumns*(self: gen_qstandarditemmodel_types.QStandardItemModel, column: cint, count: cint, parent: QModelIndex): bool =
  fcQStandardItemModel_insertColumns(self.h, column, count, parent.h)

proc removeRows*(self: gen_qstandarditemmodel_types.QStandardItemModel, row: cint, count: cint, parent: QModelIndex): bool =
  fcQStandardItemModel_removeRows(self.h, row, count, parent.h)

proc removeColumns*(self: gen_qstandarditemmodel_types.QStandardItemModel, column: cint, count: cint, parent: QModelIndex): bool =
  fcQStandardItemModel_removeColumns(self.h, column, count, parent.h)

proc flags*(self: gen_qstandarditemmodel_types.QStandardItemModel, index: QModelIndex): cint =
...
proc itemData*(self: gen_qstandarditemmodel_types.QStandardItemModel, index: QModelIndex): Table[cint,QVariant] =
...
proc setItemData*(self: gen_qstandarditemmodel_types.QStandardItemModel, index: QModelIndex, roles: Table[cint,QVariant]): bool =
...
proc itemFromIndex*(self: gen_qstandarditemmodel_types.QStandardItemModel, index: QModelIndex): QStandardItem =
  QStandardItem(h: fcQStandardItemModel_itemFromIndex(self.h, index.h))

proc indexFromItem*(self: gen_qstandarditemmodel_types.QStandardItemModel, item: QStandardItem): QModelIndex =
  QModelIndex(h: fcQStandardItemModel_indexFromItem(self.h, item.h))

proc item*(self: gen_qstandarditemmodel_types.QStandardItemModel, row: cint): QStandardItem =
  QStandardItem(h: fcQStandardItemModel_item(self.h, row))

proc setItem*(self: gen_qstandarditemmodel_types.QStandardItemModel, row: cint, column: cint, item: QStandardItem): void =
  fcQStandardItemModel_setItem(self.h, row, column, item.h)

proc setItem*(self: gen_qstandarditemmodel_types.QStandardItemModel, row: cint, item: QStandardItem): void =
  fcQStandardItemModel_setItem2(self.h, row, item.h)

proc invisibleRootItem*(self: gen_qstandarditemmodel_types.QStandardItemModel, ): QStandardItem =
  QStandardItem(h: fcQStandardItemModel_invisibleRootItem(self.h))

proc horizontalHeaderItem*(self: gen_qstandarditemmodel_types.QStandardItemModel, column: cint): QStandardItem =
  QStandardItem(h: fcQStandardItemModel_horizontalHeaderItem(self.h, column))

proc setHorizontalHeaderItem*(self: gen_qstandarditemmodel_types.QStandardItemModel, column: cint, item: QStandardItem): void =
  fcQStandardItemModel_setHorizontalHeaderItem(self.h, column, item.h)

proc verticalHeaderItem*(self: gen_qstandarditemmodel_types.QStandardItemModel, row: cint): QStandardItem =
  QStandardItem(h: fcQStandardItemModel_verticalHeaderItem(self.h, row))

proc setVerticalHeaderItem*(self: gen_qstandarditemmodel_types.QStandardItemModel, row: cint, item: QStandardItem): void =
...
proc appendRow*(self: gen_qstandarditemmodel_types.QStandardItemModel, items: seq[QStandardItem]): void =
  var items_CArray = newSeq[pointer](len(items))
  for i in 0..<len(items):
    items_CArray[i] = items[i].h
...
proc appendColumn*(self: gen_qstandarditemmodel_types.QStandardItemModel, items: seq[QStandardItem]): void =
  var items_CArray = newSeq[pointer](len(items))
  for i in 0..<len(items):
    items_CArray[i] = items[i].h
...
proc appendRow*(self: gen_qstandarditemmodel_types.QStandardItemModel, item: QStandardItem): void =
  fcQStandardItemModel_appendRowWithItem(self.h, item.h)

proc insertRow*(self: gen_qstandarditemmodel_types.QStandardItemModel, row: cint, items: seq[QStandardItem]): void =
  var items_CArray = newSeq[pointer](len(items))
  for i in 0..<len(items):
    items_CArray[i] = items[i].h
...
proc insertColumn*(self: gen_qstandarditemmodel_types.QStandardItemModel, column: cint, items: seq[QStandardItem]): void =
  var items_CArray = newSeq[pointer](len(items))
  for i in 0..<len(items):
    items_CArray[i] = items[i].h
...
proc insertRow*(self: gen_qstandarditemmodel_types.QStandardItemModel, row: cint, item: QStandardItem): void =
...
proc takeItem*(self: gen_qstandarditemmodel_types.QStandardItemModel, row: cint): QStandardItem =
  QStandardItem(h: fcQStandardItemModel_takeItem(self.h, row))

proc takeRow*(self: gen_qstandarditemmodel_types.QStandardItemModel, row: cint): seq[QStandardItem] =
...
proc takeColumn*(self: gen_qstandarditemmodel_types.QStandardItemModel, column: cint): seq[QStandardItem] =
...
proc takeHorizontalHeaderItem*(self: gen_qstandarditemmodel_types.QStandardItemModel, column: cint): QStandardItem =
  QStandardItem(h: fcQStandardItemModel_takeHorizontalHeaderItem(self.h, column))

proc takeVerticalHeaderItem*(self: gen_qstandarditemmodel_types.QStandardItemModel, row: cint): QStandardItem =
  QStandardItem(h: fcQStandardItemModel_takeVerticalHeaderItem(self.h, row))

proc itemPrototype*(self: gen_qstandarditemmodel_types.QStandardItemModel, ): QStandardItem =
  QStandardItem(h: fcQStandardItemModel_itemPrototype(self.h))

proc setItemPrototype*(self: gen_qstandarditemmodel_types.QStandardItemModel, item: QStandardItem): void =
  fcQStandardItemModel_setItemPrototype(self.h, item.h)

proc findItems*(self: gen_qstandarditemmodel_types.QStandardItemModel, text: string): seq[QStandardItem] =
...
proc mimeData*(self: gen_qstandarditemmodel_types.QStandardItemModel, indexes: seq[QModelIndex]): QMimeData =
  var indexes_CArray = newSeq[pointer](len(indexes))
  for i in 0..<len(indexes):
    indexes_CArray[i] = indexes[i].h

  QMimeData(h: fcQStandardItemModel_mimeData(self.h, struct_miqt_array(len: csize_t(len(indexes)), data: if len(indexes) == 0: nil else: addr(indexes_CArray[0]))))

proc dropMimeData*(self: gen_qstandarditemmodel_types.QStandardItemModel, data: QMimeData, action: cint, row: cint, column: cint, parent: QModelIndex): bool =
  fcQStandardItemModel_dropMimeData(self.h, data.h, cint(action), row, column, parent.h)

proc itemChanged*(self: gen_qstandarditemmodel_types.QStandardItemModel, item: QStandardItem): void =
  fcQStandardItemModel_itemChanged(self.h, item.h)

type QStandardItemModelitemChangedSlot* = proc(item: QStandardItem)
...
proc item*(self: gen_qstandarditemmodel_types.QStandardItemModel, row: cint, column: cint): QStandardItem =
  QStandardItem(h: fcQStandardItemModel_item2(self.h, row, column))

proc insertRow*(self: gen_qstandarditemmodel_types.QStandardItemModel, row: cint, parent: QModelIndex): bool =
  fcQStandardItemModel_insertRow22(self.h, row, parent.h)

proc insertColumn*(self: gen_qstandarditemmodel_types.QStandardItemModel, column: cint, parent: QModelIndex): bool =
  fcQStandardItemModel_insertColumn2(self.h, column, parent.h)

proc takeItem*(self: gen_qstandarditemmodel_types.QStandardItemModel, row: cint, column: cint): QStandardItem =
  QStandardItem(h: fcQStandardItemModel_takeItem2(self.h, row, column))

proc findItems*(self: gen_qstandarditemmodel_types.QStandardItemModel, text: string, flags: cint): seq[QStandardItem] =
...
proc findItems*(self: gen_qstandarditemmodel_types.QStandardItemModel, text: string, flags: cint, column: cint): seq[QStandardItem] =
...
proc QStandardItemModelindex*(self: gen_qstandarditemmodel_types.QStandardItemModel, row: cint, column: cint, parent: QModelIndex): QModelIndex =
  QModelIndex(h: fQStandardItemModel_virtualbase_index(self.h, row, column, parent.h))

type QStandardItemModelindexProc* = proc(row: cint, column: cint, parent: QModelIndex): QModelIndex
...
proc miqt_exec_callback_QStandardItemModel_index(self: ptr cQStandardItemModel, slot: int, row: cint, column: cint, parent: pointer): pointer {.exportc: "miqt_exec_callback_QStandardItemModel_index ".} =
  ...
  virtualReturn.h
proc QStandardItemModelparent*(self: gen_qstandarditemmodel_types.QStandardItemModel, child: QModelIndex): QModelIndex =
  QModelIndex(h: fQStandardItemModel_virtualbase_parent(self.h, child.h))

type QStandardItemModelparentProc* = proc(child: QModelIndex): QModelIndex
...
proc miqt_exec_callback_QStandardItemModel_parent(self: ptr cQStandardItemModel, slot: int, child: pointer): pointer {.exportc: "miqt_exec_callback_QStandardItemModel_parent ".} =
  ...
  virtualReturn.h
proc QStandardItemModelrowCount*(self: gen_qstandarditemmodel_types.QStandardItemModel, parent: QModelIndex): cint =
  fQStandardItemModel_virtualbase_rowCount(self.h, parent.h)

type QStandardItemModelrowCountProc* = proc(parent: QModelIndex): cint
...
proc miqt_exec_callback_QStandardItemModel_rowCount(self: ptr cQStandardItemModel, slot: int, parent: pointer): cint {.exportc: "miqt_exec_callback_QStandardItemModel_rowCount ".} =
  ...
  virtualReturn
proc QStandardItemModelcolumnCount*(self: gen_qstandarditemmodel_types.QStandardItemModel, parent: QModelIndex): cint =
  fQStandardItemModel_virtualbase_columnCount(self.h, parent.h)

type QStandardItemModelcolumnCountProc* = proc(parent: QModelIndex): cint
...
proc miqt_exec_callback_QStandardItemModel_columnCount(self: ptr cQStandardItemModel, slot: int, parent: pointer): cint {.exportc: "miqt_exec_callback_QStandardItemModel_columnCount ".} =
  ...
  virtualReturn
proc QStandardItemModelhasChildren*(self: gen_qstandarditemmodel_types.QStandardItemModel, parent: QModelIndex): bool =
  fQStandardItemModel_virtualbase_hasChildren(self.h, parent.h)

type QStandardItemModelhasChildrenProc* = proc(parent: QModelIndex): bool
...
proc miqt_exec_callback_QStandardItemModel_hasChildren(self: ptr cQStandardItemModel, slot: int, parent: pointer): bool {.exportc: "miqt_exec_callback_QStandardItemModel_hasChildren ".} =
  ...
  virtualReturn
proc QStandardItemModeldata*(self: gen_qstandarditemmodel_types.QStandardItemModel, index: QModelIndex, role: cint): QVariant =
  QVariant(h: fQStandardItemModel_virtualbase_data(self.h, index.h, role))

type QStandardItemModeldataProc* = proc(index: QModelIndex, role: cint): QVariant
...
proc miqt_exec_callback_QStandardItemModel_data(self: ptr cQStandardItemModel, slot: int, index: pointer, role: cint): pointer {.exportc: "miqt_exec_callback_QStandardItemModel_data ".} =
  ...
  virtualReturn.h
proc QStandardItemModelmultiData*(self: gen_qstandarditemmodel_types.QStandardItemModel, index: QModelIndex, roleDataSpan: QModelRoleDataSpan): void =
  fQStandardItemModel_virtualbase_multiData(self.h, index.h, roleDataSpan.h)

type QStandardItemModelmultiDataProc* = proc(index: QModelIndex, roleDataSpan: QModelRoleDataSpan): void
...
proc miqt_exec_callback_QStandardItemModel_multiData(self: ptr cQStandardItemModel, slot: int, index: pointer, roleDataSpan: pointer): void {.exportc: "miqt_exec_callback_QStandardItemModel_multiData ".} =
  ...
  nimfunc[](slotval1, slotval2)
proc QStandardItemModelsetData*(self: gen_qstandarditemmodel_types.QStandardItemModel, index: QModelIndex, value: QVariant, role: cint): bool =
  fQStandardItemModel_virtualbase_setData(self.h, index.h, value.h, role)

type QStandardItemModelsetDataProc* = proc(index: QModelIndex, value: QVariant, role: cint): bool
...
proc miqt_exec_callback_QStandardItemModel_setData(self: ptr cQStandardItemModel, slot: int, index: pointer, value: pointer, role: cint): bool {.exportc: "miqt_exec_callback_QStandardItemModel_setData ".} =
  ...
  virtualReturn
proc QStandardItemModelclearItemData*(self: gen_qstandarditemmodel_types.QStandardItemModel, index: QModelIndex): bool =
  fQStandardItemModel_virtualbase_clearItemData(self.h, index.h)

type QStandardItemModelclearItemDataProc* = proc(index: QModelIndex): bool
...
proc miqt_exec_callback_QStandardItemModel_clearItemData(self: ptr cQStandardItemModel, slot: int, index: pointer): bool {.exportc: "miqt_exec_callback_QStandardItemModel_clearItemData ".} =
  ...
  virtualReturn
proc QStandardItemModelheaderData*(self: gen_qstandarditemmodel_types.QStandardItemModel, section: cint, orientation: cint, role: cint): QVariant =
  QVariant(h: fQStandardItemModel_virtualbase_headerData(self.h, section, cint(orientation), role))

type QStandardItemModelheaderDataProc* = proc(section: cint, orientation: cint, role: cint): QVariant
...
proc miqt_exec_callback_QStandardItemModel_headerData(self: ptr cQStandardItemModel, slot: int, section: cint, orientation: cint, role: cint): pointer {.exportc: "miqt_exec_callback_QStandardItemModel_headerData ".} =
  ...
  virtualReturn.h
proc QStandardItemModelsetHeaderData*(self: gen_qstandarditemmodel_types.QStandardItemModel, section: cint, orientation: cint, value: QVariant, role: cint): bool =
  fQStandardItemModel_virtualbase_setHeaderData(self.h, section, cint(orientation), value.h, role)

type QStandardItemModelsetHeaderDataProc* = proc(section: cint, orientation: cint, value: QVariant, role: cint): bool
...
proc miqt_exec_callback_QStandardItemModel_setHeaderData(self: ptr cQStandardItemModel, slot: int, section: cint, orientation: cint, value: pointer, role: cint): bool {.exportc: "miqt_exec_callback_QStandardItemModel_setHeaderData ".} =
  ...
  virtualReturn
proc QStandardItemModelinsertRows*(self: gen_qstandarditemmodel_types.QStandardItemModel, row: cint, count: cint, parent: QModelIndex): bool =
  fQStandardItemModel_virtualbase_insertRows(self.h, row, count, parent.h)

type QStandardItemModelinsertRowsProc* = proc(row: cint, count: cint, parent: QModelIndex): bool
...
proc miqt_exec_callback_QStandardItemModel_insertRows(self: ptr cQStandardItemModel, slot: int, row: cint, count: cint, parent: pointer): bool {.exportc: "miqt_exec_callback_QStandardItemModel_insertRows ".} =
  ...
  virtualReturn
proc QStandardItemModelinsertColumns*(self: gen_qstandarditemmodel_types.QStandardItemModel, column: cint, count: cint, parent: QModelIndex): bool =
  fQStandardItemModel_virtualbase_insertColumns(self.h, column, count, parent.h)

type QStandardItemModelinsertColumnsProc* = proc(column: cint, count: cint, parent: QModelIndex): bool
...
proc miqt_exec_callback_QStandardItemModel_insertColumns(self: ptr cQStandardItemModel, slot: int, column: cint, count: cint, parent: pointer): bool {.exportc: "miqt_exec_callback_QStandardItemModel_insertColumns ".} =
  ...
  virtualReturn
proc QStandardItemModelremoveRows*(self: gen_qstandarditemmodel_types.QStandardItemModel, row: cint, count: cint, parent: QModelIndex): bool =
  fQStandardItemModel_virtualbase_removeRows(self.h, row, count, parent.h)

type QStandardItemModelremoveRowsProc* = proc(row: cint, count: cint, parent: QModelIndex): bool
...
proc miqt_exec_callback_QStandardItemModel_removeRows(self: ptr cQStandardItemModel, slot: int, row: cint, count: cint, parent: pointer): bool {.exportc: "miqt_exec_callback_QStandardItemModel_removeRows ".} =
  ...
  virtualReturn
proc QStandardItemModelremoveColumns*(self: gen_qstandarditemmodel_types.QStandardItemModel, column: cint, count: cint, parent: QModelIndex): bool =
  fQStandardItemModel_virtualbase_removeColumns(self.h, column, count, parent.h)

type QStandardItemModelremoveColumnsProc* = proc(column: cint, count: cint, parent: QModelIndex): bool
...
proc miqt_exec_callback_QStandardItemModel_removeColumns(self: ptr cQStandardItemModel, slot: int, column: cint, count: cint, parent: pointer): bool {.exportc: "miqt_exec_callback_QStandardItemModel_removeColumns ".} =
  ...
  virtualReturn
proc QStandardItemModelflags*(self: gen_qstandarditemmodel_types.QStandardItemModel, index: QModelIndex): cint =
  cint(fQStandardItemModel_virtualbase_flags(self.h, index.h))

type QStandardItemModelflagsProc* = proc(index: QModelIndex): cint
...
proc miqt_exec_callback_QStandardItemModel_supportedDropActions(self: ptr cQStandardItemModel, slot: int): cint {.exportc: "miqt_exec_callback_QStandardItemModel_supportedDropActions ".} =
  ...
  cint(virtualReturn)
proc QStandardItemModelitemData*(self: gen_qstandarditemmodel_types.QStandardItemModel, index: QModelIndex): Table[cint,QVariant] =
...
type QStandardItemModelitemDataProc* = proc(index: QModelIndex): Table[cint,QVariant]
...
proc miqt_exec_callback_QStandardItemModel_itemData(self: ptr cQStandardItemModel, slot: int, index: pointer): struct_miqt_map {.exportc: "miqt_exec_callback_QStandardItemModel_itemData ".} =
  ...
  struct_miqt_map(len: csize_t(len(virtualReturn)),keys: if len(virtualReturn) == 0: nil else: addr(virtualReturn_Keys_CArray[0]), values: if len(virtualReturn) == 0: nil else: addr(virtualReturn_Values_CArray[0]),)
proc QStandardItemModelsetItemData*(self: gen_qstandarditemmodel_types.QStandardItemModel, index: QModelIndex, roles: Table[cint,QVariant]): bool =
  var roles_Keys_CArray = newSeq[cint](len(roles))
  var roles_Values_CArray = newSeq[pointer](len(roles))
  var roles_ctr = 0
  for rolesk, rolesv in roles:
...
type QStandardItemModelsetItemDataProc* = proc(index: QModelIndex, roles: Table[cint,QVariant]): bool
...
proc QStandardItemModelmimeData*(self: gen_qstandarditemmodel_types.QStandardItemModel, indexes: seq[QModelIndex]): QMimeData =
  var indexes_CArray = newSeq[pointer](len(indexes))
  for i in 0..<len(indexes):
    indexes_CArray[i] = indexes[i].h

  QMimeData(h: fQStandardItemModel_virtualbase_mimeData(self.h, struct_miqt_array(len: csize_t(len(indexes)), data: if len(indexes) == 0: nil else: addr(indexes_CArray[0]))))

type QStandardItemModelmimeDataProc* = proc(indexes: seq[QModelIndex]): QMimeData
...
proc miqt_exec_callback_QStandardItemModel_mimeData(self: ptr cQStandardItemModel, slot: int, indexes: struct_miqt_array): pointer {.exportc: "miqt_exec_callback_QStandardItemModel_mimeData ".} =
  ...
  virtualReturn.h
proc QStandardItemModeldropMimeData*(self: gen_qstandarditemmodel_types.QStandardItemModel, data: QMimeData, action: cint, row: cint, column: cint, parent: QModelIndex): bool =
  fQStandardItemModel_virtualbase_dropMimeData(self.h, data.h, cint(action), row, column, parent.h)

type QStandardItemModeldropMimeDataProc* = proc(data: QMimeData, action: cint, row: cint, column: cint, parent: QModelIndex): bool
...
proc miqt_exec_callback_QStandardItemModel_dropMimeData(self: ptr cQStandardItemModel, slot: int, data: pointer, action: cint, row: cint, column: cint, parent: pointer): bool {.exportc: "miqt_exec_callback_QStandardItemModel_dropMimeData ".} =
  ...
  virtualReturn
proc QStandardItemModelsibling*(self: gen_qstandarditemmodel_types.QStandardItemModel, row: cint, column: cint, idx: QModelIndex): QModelIndex =
  QModelIndex(h: fQStandardItemModel_virtualbase_sibling(self.h, row, column, idx.h))

type QStandardItemModelsiblingProc* = proc(row: cint, column: cint, idx: QModelIndex): QModelIndex
...
proc miqt_exec_callback_QStandardItemModel_sibling(self: ptr cQStandardItemModel, slot: int, row: cint, column: cint, idx: pointer): pointer {.exportc: "miqt_exec_callback_QStandardItemModel_sibling ".} =
  ...
  virtualReturn.h
proc QStandardItemModelcanDropMimeData*(self: gen_qstandarditemmodel_types.QStandardItemModel, data: QMimeData, action: cint, row: cint, column: cint, parent: QModelIndex): bool =
  fQStandardItemModel_virtualbase_canDropMimeData(self.h, data.h, cint(action), row, column, parent.h)

type QStandardItemModelcanDropMimeDataProc* = proc(data: QMimeData, action: cint, row: cint, column: cint, parent: QModelIndex): bool
...
proc miqt_exec_callback_QStandardItemModel_supportedDragActions(self: ptr cQStandardItemModel, slot: int): cint {.exportc: "miqt_exec_callback_QStandardItemModel_supportedDragActions ".} =
  ...
  cint(virtualReturn)
proc QStandardItemModelmoveRows*(self: gen_qstandarditemmodel_types.QStandardItemModel, sourceParent: QModelIndex, sourceRow: cint, count: cint, destinationParent: QModelIndex, destinationChild: cint): bool =
  fQStandardItemModel_virtualbase_moveRows(self.h, sourceParent.h, sourceRow, count, destinationParent.h, destinationChild)

type QStandardItemModelmoveRowsProc* = proc(sourceParent: QModelIndex, sourceRow: cint, count: cint, destinationParent: QModelIndex, destinationChild: cint): bool
...
proc miqt_exec_callback_QStandardItemModel_moveRows(self: ptr cQStandardItemModel, slot: int, sourceParent: pointer, sourceRow: cint, count: cint, destinationParent: pointer, destinationChild: cint): bool {.exportc: "miqt_exec_callback_QStandardItemModel_moveRows ".} =
  ...
  virtualReturn
proc QStandardItemModelmoveColumns*(self: gen_qstandarditemmodel_types.QStandardItemModel, sourceParent: QModelIndex, sourceColumn: cint, count: cint, destinationParent: QModelIndex, destinationChild: cint): bool =
...
type QStandardItemModelmoveColumnsProc* = proc(sourceParent: QModelIndex, sourceColumn: cint, count: cint, destinationParent: QModelIndex, destinationChild: cint): bool
...
proc miqt_exec_callback_QStandardItemModel_moveColumns(self: ptr cQStandardItemModel, slot: int, sourceParent: pointer, sourceColumn: cint, count: cint, destinationParent: pointer, destinationChild: cint): bool {.exportc: "miqt_exec_callback_QStandardItemModel_moveColumns ".} =
  ...
  virtualReturn
proc QStandardItemModelfetchMore*(self: gen_qstandarditemmodel_types.QStandardItemModel, parent: QModelIndex): void =
  fQStandardItemModel_virtualbase_fetchMore(self.h, parent.h)

type QStandardItemModelfetchMoreProc* = proc(parent: QModelIndex): void
...
proc miqt_exec_callback_QStandardItemModel_fetchMore(self: ptr cQStandardItemModel, slot: int, parent: pointer): void {.exportc: "miqt_exec_callback_QStandardItemModel_fetchMore ".} =
  ...
  nimfunc[](slotval1)
proc QStandardItemModelcanFetchMore*(self: gen_qstandarditemmodel_types.QStandardItemModel, parent: QModelIndex): bool =
  fQStandardItemModel_virtualbase_canFetchMore(self.h, parent.h)

type QStandardItemModelcanFetchMoreProc* = proc(parent: QModelIndex): bool
...
proc miqt_exec_callback_QStandardItemModel_canFetchMore(self: ptr cQStandardItemModel, slot: int, parent: pointer): bool {.exportc: "miqt_exec_callback_QStandardItemModel_canFetchMore ".} =
  ...
  virtualReturn
proc QStandardItemModelbuddy*(self: gen_qstandarditemmodel_types.QStandardItemModel, index: QModelIndex): QModelIndex =
  QModelIndex(h: fQStandardItemModel_virtualbase_buddy(self.h, index.h))

type QStandardItemModelbuddyProc* = proc(index: QModelIndex): QModelIndex
...
proc miqt_exec_callback_QStandardItemModel_buddy(self: ptr cQStandardItemModel, slot: int, index: pointer): pointer {.exportc: "miqt_exec_callback_QStandardItemModel_buddy ".} =
  ...
  virtualReturn.h
proc QStandardItemModelmatch*(self: gen_qstandarditemmodel_types.QStandardItemModel, start: QModelIndex, role: cint, value: QVariant, hits: cint, flags: cint): seq[QModelIndex] =
...
type QStandardItemModelmatchProc* = proc(start: QModelIndex, role: cint, value: QVariant, hits: cint, flags: cint): seq[QModelIndex]
...
proc miqt_exec_callback_QStandardItemModel_match(self: ptr cQStandardItemModel, slot: int, start: pointer, role: cint, value: pointer, hits: cint, flags: cint): struct_miqt_array {.exportc: "miqt_exec_callback_QStandardItemModel_match ".} =
  ...
  struct_miqt_array(len: csize_t(len(virtualReturn)), data: if len(virtualReturn) == 0: nil else: addr(virtualReturn_CArray[0]))
proc QStandardItemModelspan*(self: gen_qstandarditemmodel_types.QStandardItemModel, index: QModelIndex): QSize =
  QSize(h: fQStandardItemModel_virtualbase_span(self.h, index.h))

type QStandardItemModelspanProc* = proc(index: QModelIndex): QSize
...
proc miqt_exec_callback_QStandardItemModel_resetInternalData(self: ptr cQStandardItemModel, slot: int): void {.exportc: "miqt_exec_callback_QStandardItemModel_resetInternalData ".} =
  ...
  nimfunc[]()
proc QStandardItemModelevent*(self: gen_qstandarditemmodel_types.QStandardItemModel, event: QEvent): bool =
  fQStandardItemModel_virtualbase_event(self.h, event.h)

type QStandardItemModeleventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QStandardItemModel_event(self: ptr cQStandardItemModel, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QStandardItemModel_event ".} =
  ...
  virtualReturn
proc QStandardItemModeleventFilter*(self: gen_qstandarditemmodel_types.QStandardItemModel, watched: QObject, event: QEvent): bool =
  fQStandardItemModel_virtualbase_eventFilter(self.h, watched.h, event.h)

type QStandardItemModeleventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QStandardItemModel_eventFilter(self: ptr cQStandardItemModel, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QStandardItemModel_eventFilter ".} =
  ...
  virtualReturn
proc QStandardItemModeltimerEvent*(self: gen_qstandarditemmodel_types.QStandardItemModel, event: QTimerEvent): void =
  fQStandardItemModel_virtualbase_timerEvent(self.h, event.h)

type QStandardItemModeltimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QStandardItemModel_timerEvent(self: ptr cQStandardItemModel, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QStandardItemModel_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QStandardItemModelchildEvent*(self: gen_qstandarditemmodel_types.QStandardItemModel, event: QChildEvent): void =
  fQStandardItemModel_virtualbase_childEvent(self.h, event.h)

type QStandardItemModelchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QStandardItemModel_childEvent(self: ptr cQStandardItemModel, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QStandardItemModel_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QStandardItemModelcustomEvent*(self: gen_qstandarditemmodel_types.QStandardItemModel, event: QEvent): void =
  fQStandardItemModel_virtualbase_customEvent(self.h, event.h)

type QStandardItemModelcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QStandardItemModel_customEvent(self: ptr cQStandardItemModel, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QStandardItemModel_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QStandardItemModelconnectNotify*(self: gen_qstandarditemmodel_types.QStandardItemModel, signal: QMetaMethod): void =
  fQStandardItemModel_virtualbase_connectNotify(self.h, signal.h)

type QStandardItemModelconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QStandardItemModel_connectNotify(self: ptr cQStandardItemModel, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QStandardItemModel_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QStandardItemModeldisconnectNotify*(self: gen_qstandarditemmodel_types.QStandardItemModel, signal: QMetaMethod): void =
  fQStandardItemModel_virtualbase_disconnectNotify(self.h, signal.h)

type QStandardItemModeldisconnectNotifyProc* = proc(signal: QMetaMethod): void
