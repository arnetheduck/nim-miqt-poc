...
func init*(T: type gen_qstylehints_types.QStyleHints, h: ptr cQStyleHints): gen_qstylehints_types.QStyleHints =
  T(h: h)
proc metaObject*(self: gen_qstylehints_types.QStyleHints, ): QMetaObject =
  QMetaObject(h: fcQStyleHints_metaObject(self.h))
...
proc passwordMaskCharacter*(self: gen_qstylehints_types.QStyleHints, ): QChar =
  QChar(h: fcQStyleHints_passwordMaskCharacter(self.h))
