...
proc create*(T: type gen_qiconengine_types.QIconEngine, other: QIconEngine): gen_qiconengine_types.QIconEngine =
  gen_qiconengine_types.QIconEngine.init(fcQIconEngine_new2(other.h))

proc paint*(self: gen_qiconengine_types.QIconEngine, painter: QPainter, rect: QRect, mode: cint, state: cint): void =
  fcQIconEngine_paint(self.h, painter.h, rect.h, cint(mode), cint(state))

proc actualSize*(self: gen_qiconengine_types.QIconEngine, size: QSize, mode: cint, state: cint): QSize =
  QSize(h: fcQIconEngine_actualSize(self.h, size.h, cint(mode), cint(state)))

proc pixmap*(self: gen_qiconengine_types.QIconEngine, size: QSize, mode: cint, state: cint): QPixmap =
  QPixmap(h: fcQIconEngine_pixmap(self.h, size.h, cint(mode), cint(state)))

proc addPixmap*(self: gen_qiconengine_types.QIconEngine, pixmap: QPixmap, mode: cint, state: cint): void =
  fcQIconEngine_addPixmap(self.h, pixmap.h, cint(mode), cint(state))

proc addFile*(self: gen_qiconengine_types.QIconEngine, fileName: string, size: QSize, mode: cint, state: cint): void =
...
proc clone*(self: gen_qiconengine_types.QIconEngine, ): QIconEngine =
  QIconEngine(h: fcQIconEngine_clone(self.h))

proc read*(self: gen_qiconengine_types.QIconEngine, inVal: QDataStream): bool =
  fcQIconEngine_read(self.h, inVal.h)

proc write*(self: gen_qiconengine_types.QIconEngine, outVal: QDataStream): bool =
  fcQIconEngine_write(self.h, outVal.h)

proc availableSizes*(self: gen_qiconengine_types.QIconEngine, mode: cint, state: cint): seq[QSize] =
...
proc scaledPixmap*(self: gen_qiconengine_types.QIconEngine, size: QSize, mode: cint, state: cint, scale: float64): QPixmap =
  QPixmap(h: fcQIconEngine_scaledPixmap(self.h, size.h, cint(mode), cint(state), scale))
...
type QIconEnginepaintProc* = proc(painter: QPainter, rect: QRect, mode: cint, state: cint): void
...
proc QIconEngineactualSize*(self: gen_qiconengine_types.QIconEngine, size: QSize, mode: cint, state: cint): QSize =
  QSize(h: fQIconEngine_virtualbase_actualSize(self.h, size.h, cint(mode), cint(state)))

type QIconEngineactualSizeProc* = proc(size: QSize, mode: cint, state: cint): QSize
...
proc miqt_exec_callback_QIconEngine_actualSize(self: ptr cQIconEngine, slot: int, size: pointer, mode: cint, state: cint): pointer {.exportc: "miqt_exec_callback_QIconEngine_actualSize ".} =
  ...
  virtualReturn.h
proc QIconEnginepixmap*(self: gen_qiconengine_types.QIconEngine, size: QSize, mode: cint, state: cint): QPixmap =
  QPixmap(h: fQIconEngine_virtualbase_pixmap(self.h, size.h, cint(mode), cint(state)))

type QIconEnginepixmapProc* = proc(size: QSize, mode: cint, state: cint): QPixmap
...
proc miqt_exec_callback_QIconEngine_pixmap(self: ptr cQIconEngine, slot: int, size: pointer, mode: cint, state: cint): pointer {.exportc: "miqt_exec_callback_QIconEngine_pixmap ".} =
  ...
  virtualReturn.h
proc QIconEngineaddPixmap*(self: gen_qiconengine_types.QIconEngine, pixmap: QPixmap, mode: cint, state: cint): void =
  fQIconEngine_virtualbase_addPixmap(self.h, pixmap.h, cint(mode), cint(state))

type QIconEngineaddPixmapProc* = proc(pixmap: QPixmap, mode: cint, state: cint): void
...
proc QIconEngineaddFile*(self: gen_qiconengine_types.QIconEngine, fileName: string, size: QSize, mode: cint, state: cint): void =
...
type QIconEngineaddFileProc* = proc(fileName: string, size: QSize, mode: cint, state: cint): void
...
type QIconEnginecloneProc* = proc(): QIconEngine
...
proc miqt_exec_callback_QIconEngine_clone(self: ptr cQIconEngine, slot: int): pointer {.exportc: "miqt_exec_callback_QIconEngine_clone ".} =
  ...
  virtualReturn.h
proc QIconEngineread*(self: gen_qiconengine_types.QIconEngine, inVal: QDataStream): bool =
  fQIconEngine_virtualbase_read(self.h, inVal.h)

type QIconEnginereadProc* = proc(inVal: QDataStream): bool
...
proc miqt_exec_callback_QIconEngine_read(self: ptr cQIconEngine, slot: int, inVal: pointer): bool {.exportc: "miqt_exec_callback_QIconEngine_read ".} =
  ...
  virtualReturn
proc QIconEnginewrite*(self: gen_qiconengine_types.QIconEngine, outVal: QDataStream): bool =
  fQIconEngine_virtualbase_write(self.h, outVal.h)

type QIconEnginewriteProc* = proc(outVal: QDataStream): bool
...
proc miqt_exec_callback_QIconEngine_write(self: ptr cQIconEngine, slot: int, outVal: pointer): bool {.exportc: "miqt_exec_callback_QIconEngine_write ".} =
  ...
  virtualReturn
proc QIconEngineavailableSizes*(self: gen_qiconengine_types.QIconEngine, mode: cint, state: cint): seq[QSize] =
...
type QIconEngineavailableSizesProc* = proc(mode: cint, state: cint): seq[QSize]
...
func init*(T: type gen_qiconengine_types.QIconEngineAvailableSizesArgument, h: ptr cQIconEngineAvailableSizesArgument): gen_qiconengine_types.QIconEngineAvailableSizesArgument =
  T(h: h)
proc create*(T: type gen_qiconengine_types.QIconEngineAvailableSizesArgument, param1: QIconEngineAvailableSizesArgument): gen_qiconengine_types.QIconEngineAvailableSizesArgument =
  gen_qiconengine_types.QIconEngineAvailableSizesArgument.init(fcQIconEngineAvailableSizesArgument_new(param1.h))

proc operatorAssign*(self: gen_qiconengine_types.QIconEngineAvailableSizesArgument, param1: QIconEngineAvailableSizesArgument): void =
...
func init*(T: type gen_qiconengine_types.QIconEngineScaledPixmapArgument, h: ptr cQIconEngineScaledPixmapArgument): gen_qiconengine_types.QIconEngineScaledPixmapArgument =
  T(h: h)
proc create*(T: type gen_qiconengine_types.QIconEngineScaledPixmapArgument, param1: QIconEngineScaledPixmapArgument): gen_qiconengine_types.QIconEngineScaledPixmapArgument =
  gen_qiconengine_types.QIconEngineScaledPixmapArgument.init(fcQIconEngineScaledPixmapArgument_new(param1.h))

proc operatorAssign*(self: gen_qiconengine_types.QIconEngineScaledPixmapArgument, param1: QIconEngineScaledPixmapArgument): void =
