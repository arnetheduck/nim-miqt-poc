...
proc create*(T: type gen_qvector2d_types.QVector2D, point: QPoint): gen_qvector2d_types.QVector2D =
  gen_qvector2d_types.QVector2D.init(fcQVector2D_new4(point.h))

proc create*(T: type gen_qvector2d_types.QVector2D, point: QPointF): gen_qvector2d_types.QVector2D =
  gen_qvector2d_types.QVector2D.init(fcQVector2D_new5(point.h))

proc create*(T: type gen_qvector2d_types.QVector2D, vector: QVector3D): gen_qvector2d_types.QVector2D =
  gen_qvector2d_types.QVector2D.init(fcQVector2D_new6(vector.h))

proc create*(T: type gen_qvector2d_types.QVector2D, vector: QVector4D): gen_qvector2d_types.QVector2D =
  gen_qvector2d_types.QVector2D.init(fcQVector2D_new7(vector.h))

proc create*(T: type gen_qvector2d_types.QVector2D, param1: QVector2D): gen_qvector2d_types.QVector2D =
...
proc normalized*(self: gen_qvector2d_types.QVector2D, ): QVector2D =
...
proc distanceToPoint*(self: gen_qvector2d_types.QVector2D, point: QVector2D): float32 =
  fcQVector2D_distanceToPoint(self.h, point.h)

proc distanceToLine*(self: gen_qvector2d_types.QVector2D, point: QVector2D, direction: QVector2D): float32 =
  fcQVector2D_distanceToLine(self.h, point.h, direction.h)

proc operatorPlusAssign*(self: gen_qvector2d_types.QVector2D, vector: QVector2D): QVector2D =
  QVector2D(h: fcQVector2D_operatorPlusAssign(self.h, vector.h))

proc operatorMinusAssign*(self: gen_qvector2d_types.QVector2D, vector: QVector2D): QVector2D =
  QVector2D(h: fcQVector2D_operatorMinusAssign(self.h, vector.h))

proc operatorMultiplyAssign*(self: gen_qvector2d_types.QVector2D, factor: float32): QVector2D =
  QVector2D(h: fcQVector2D_operatorMultiplyAssign(self.h, factor))

proc operatorMultiplyAssign*(self: gen_qvector2d_types.QVector2D, vector: QVector2D): QVector2D =
  QVector2D(h: fcQVector2D_operatorMultiplyAssignWithVector(self.h, vector.h))

proc operatorDivideAssign*(self: gen_qvector2d_types.QVector2D, divisor: float32): QVector2D =
  QVector2D(h: fcQVector2D_operatorDivideAssign(self.h, divisor))

proc operatorDivideAssign*(self: gen_qvector2d_types.QVector2D, vector: QVector2D): QVector2D =
  QVector2D(h: fcQVector2D_operatorDivideAssignWithVector(self.h, vector.h))

proc dotProduct*(_: type gen_qvector2d_types.QVector2D, v1: QVector2D, v2: QVector2D): float32 =
  fcQVector2D_dotProduct(v1.h, v2.h)

proc toVector3D*(self: gen_qvector2d_types.QVector2D, ): QVector3D =
  QVector3D(h: fcQVector2D_toVector3D(self.h))

proc toVector4D*(self: gen_qvector2d_types.QVector2D, ): QVector4D =
  QVector4D(h: fcQVector2D_toVector4D(self.h))

proc toPoint*(self: gen_qvector2d_types.QVector2D, ): QPoint =
  QPoint(h: fcQVector2D_toPoint(self.h))

proc toPointF*(self: gen_qvector2d_types.QVector2D, ): QPointF =
  QPointF(h: fcQVector2D_toPointF(self.h))

proc ToQVariant*(self: gen_qvector2d_types.QVector2D, ): QVariant =
