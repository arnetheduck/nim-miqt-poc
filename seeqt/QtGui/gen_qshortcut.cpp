...
public:
	...
	MiqtVirtualQShortcut(struct QShortcut_VTable* vtbl, QObject* parent): QShortcut(parent), vtbl(vtbl) {};
	MiqtVirtualQShortcut(struct QShortcut_VTable* vtbl, const QKeySequence& key, QObject* parent): QShortcut(key, parent), vtbl(vtbl) {};
	MiqtVirtualQShortcut(struct QShortcut_VTable* vtbl, QKeySequence::StandardKey key, QObject* parent): QShortcut(key, parent), vtbl(vtbl) {};
	MiqtVirtualQShortcut(struct QShortcut_VTable* vtbl, const QKeySequence& key, QObject* parent, const char* member): QShortcut(key, parent, member), vtbl(vtbl) {};
	MiqtVirtualQShortcut(struct QShortcut_VTable* vtbl, const QKeySequence& key, QObject* parent, const char* member, const char* ambiguousMember): QShortcut(key, parent, member, ambiguousMember), vtbl(vtbl) {};
	MiqtVirtualQShortcut(struct QShortcut_VTable* vtbl, const QKeySequence& key, QObject* parent, const char* member, const char* ambiguousMember, Qt::ShortcutContext context): QShortcut(key, parent, member, ambiguousMember, context), vtbl(vtbl) {};
	MiqtVirtualQShortcut(struct QShortcut_VTable* vtbl, QKeySequence::StandardKey key, QObject* parent, const char* member): QShortcut(key, parent, member), vtbl(vtbl) {};
	MiqtVirtualQShortcut(struct QShortcut_VTable* vtbl, QKeySequence::StandardKey key, QObject* parent, const char* member, const char* ambiguousMember): QShortcut(key, parent, member, ambiguousMember), vtbl(vtbl) {};
	MiqtVirtualQShortcut(struct QShortcut_VTable* vtbl, QKeySequence::StandardKey key, QObject* parent, const char* member, const char* ambiguousMember, Qt::ShortcutContext context): QShortcut(key, parent, member, ambiguousMember, context), vtbl(vtbl) {};

	virtual ~MiqtVirtualQShortcut() override { if(vtbl->destructor) vtbl->destructor(vtbl, this); }
...
QShortcut* QShortcut_new5(struct QShortcut_VTable* vtbl, QKeySequence* key, QObject* parent, const char* member, const char* ambiguousMember) {
	return new MiqtVirtualQShortcut(vtbl, *key, parent, member, ambiguousMember);
}
...
QShortcut* QShortcut_new6(struct QShortcut_VTable* vtbl, QKeySequence* key, QObject* parent, const char* member, const char* ambiguousMember, int context) {
	return new MiqtVirtualQShortcut(vtbl, *key, parent, member, ambiguousMember, static_cast<Qt::ShortcutContext>(context));
}

QShortcut* QShortcut_new7(struct QShortcut_VTable* vtbl, int key, QObject* parent, const char* member) {
	return new MiqtVirtualQShortcut(vtbl, static_cast<QKeySequence::StandardKey>(key), parent, member);
}
...
QShortcut* QShortcut_new8(struct QShortcut_VTable* vtbl, int key, QObject* parent, const char* member, const char* ambiguousMember) {
	return new MiqtVirtualQShortcut(vtbl, static_cast<QKeySequence::StandardKey>(key), parent, member, ambiguousMember);
}
...
QShortcut* QShortcut_new9(struct QShortcut_VTable* vtbl, int key, QObject* parent, const char* member, const char* ambiguousMember, int context) {
	return new MiqtVirtualQShortcut(vtbl, static_cast<QKeySequence::StandardKey>(key), parent, member, ambiguousMember, static_cast<Qt::ShortcutContext>(context));
}
...
QMetaObject* QShortcut_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQShortcut*)(self) )->QShortcut::metaObject();

}

void* QShortcut_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQShortcut*)(self) )->QShortcut::qt_metacast(param1);

}

int QShortcut_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQShortcut*)(self) )->QShortcut::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
