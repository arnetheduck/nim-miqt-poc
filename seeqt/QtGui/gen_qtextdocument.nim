...
proc operatorAssign*(self: gen_qtextdocument_types.QAbstractUndoItem, param1: QAbstractUndoItem): void =
...
proc create*(T: type gen_qtextdocument_types.QTextDocument, parent: QObject): gen_qtextdocument_types.QTextDocument =
  gen_qtextdocument_types.QTextDocument.init(fcQTextDocument_new3(parent.h))

proc create*(T: type gen_qtextdocument_types.QTextDocument, text: string, parent: QObject): gen_qtextdocument_types.QTextDocument =
...
proc metaObject*(self: gen_qtextdocument_types.QTextDocument, ): QMetaObject =
  QMetaObject(h: fcQTextDocument_metaObject(self.h))
...
proc clone*(self: gen_qtextdocument_types.QTextDocument, ): QTextDocument =
...
proc setDocumentLayout*(self: gen_qtextdocument_types.QTextDocument, layout: QAbstractTextDocumentLayout): void =
  fcQTextDocument_setDocumentLayout(self.h, layout.h)

proc documentLayout*(self: gen_qtextdocument_types.QTextDocument, ): QAbstractTextDocumentLayout =
  QAbstractTextDocumentLayout(h: fcQTextDocument_documentLayout(self.h))
...
proc characterAt*(self: gen_qtextdocument_types.QTextDocument, pos: cint): QChar =
  QChar(h: fcQTextDocument_characterAt(self.h, pos))

proc find*(self: gen_qtextdocument_types.QTextDocument, subString: string): QTextCursor =
  QTextCursor(h: fcQTextDocument_find(self.h, struct_miqt_string(data: subString, len: csize_t(len(subString)))))

proc find*(self: gen_qtextdocument_types.QTextDocument, subString: string, cursor: QTextCursor): QTextCursor =
  QTextCursor(h: fcQTextDocument_find2(self.h, struct_miqt_string(data: subString, len: csize_t(len(subString))), cursor.h))

proc find*(self: gen_qtextdocument_types.QTextDocument, expr: QRegExp): QTextCursor =
  QTextCursor(h: fcQTextDocument_findWithExpr(self.h, expr.h))

proc find*(self: gen_qtextdocument_types.QTextDocument, expr: QRegExp, cursor: QTextCursor): QTextCursor =
  QTextCursor(h: fcQTextDocument_find3(self.h, expr.h, cursor.h))

proc find*(self: gen_qtextdocument_types.QTextDocument, expr: QRegularExpression): QTextCursor =
  QTextCursor(h: fcQTextDocument_find4(self.h, expr.h))

proc find*(self: gen_qtextdocument_types.QTextDocument, expr: QRegularExpression, cursor: QTextCursor): QTextCursor =
  QTextCursor(h: fcQTextDocument_find5(self.h, expr.h, cursor.h))

proc frameAt*(self: gen_qtextdocument_types.QTextDocument, pos: cint): QTextFrame =
  QTextFrame(h: fcQTextDocument_frameAt(self.h, pos))

proc rootFrame*(self: gen_qtextdocument_types.QTextDocument, ): QTextFrame =
  QTextFrame(h: fcQTextDocument_rootFrame(self.h))

proc objectX*(self: gen_qtextdocument_types.QTextDocument, objectIndex: cint): QTextObject =
  QTextObject(h: fcQTextDocument_objectX(self.h, objectIndex))

proc objectForFormat*(self: gen_qtextdocument_types.QTextDocument, param1: QTextFormat): QTextObject =
  QTextObject(h: fcQTextDocument_objectForFormat(self.h, param1.h))

proc findBlock*(self: gen_qtextdocument_types.QTextDocument, pos: cint): QTextBlock =
  QTextBlock(h: fcQTextDocument_findBlock(self.h, pos))

proc findBlockByNumber*(self: gen_qtextdocument_types.QTextDocument, blockNumber: cint): QTextBlock =
  QTextBlock(h: fcQTextDocument_findBlockByNumber(self.h, blockNumber))

proc findBlockByLineNumber*(self: gen_qtextdocument_types.QTextDocument, blockNumber: cint): QTextBlock =
  QTextBlock(h: fcQTextDocument_findBlockByLineNumber(self.h, blockNumber))

proc begin*(self: gen_qtextdocument_types.QTextDocument, ): QTextBlock =
  QTextBlock(h: fcQTextDocument_begin(self.h))

proc endX*(self: gen_qtextdocument_types.QTextDocument, ): QTextBlock =
  QTextBlock(h: fcQTextDocument_endX(self.h))

proc firstBlock*(self: gen_qtextdocument_types.QTextDocument, ): QTextBlock =
  QTextBlock(h: fcQTextDocument_firstBlock(self.h))

proc lastBlock*(self: gen_qtextdocument_types.QTextDocument, ): QTextBlock =
  QTextBlock(h: fcQTextDocument_lastBlock(self.h))

proc setPageSize*(self: gen_qtextdocument_types.QTextDocument, size: QSizeF): void =
  fcQTextDocument_setPageSize(self.h, size.h)

proc pageSize*(self: gen_qtextdocument_types.QTextDocument, ): QSizeF =
  QSizeF(h: fcQTextDocument_pageSize(self.h))

proc setDefaultFont*(self: gen_qtextdocument_types.QTextDocument, font: QFont): void =
  fcQTextDocument_setDefaultFont(self.h, font.h)

proc defaultFont*(self: gen_qtextdocument_types.QTextDocument, ): QFont =
  QFont(h: fcQTextDocument_defaultFont(self.h))
...
proc print*(self: gen_qtextdocument_types.QTextDocument, printer: QPagedPaintDevice): void =
  fcQTextDocument_print(self.h, printer.h)

proc resource*(self: gen_qtextdocument_types.QTextDocument, typeVal: cint, name: QUrl): QVariant =
  QVariant(h: fcQTextDocument_resource(self.h, typeVal, name.h))

proc addResource*(self: gen_qtextdocument_types.QTextDocument, typeVal: cint, name: QUrl, resource: QVariant): void =
  fcQTextDocument_addResource(self.h, typeVal, name.h, resource.h)

proc allFormats*(self: gen_qtextdocument_types.QTextDocument, ): seq[QTextFormat] =
  var v_ma = fcQTextDocument_allFormats(self.h)
  var vx_ret = newSeq[QTextFormat](int(v_ma.len))
  let v_outCast = cast[ptr UncheckedArray[pointer]](v_ma.data)
  for i in 0 ..< v_ma.len:
    vx_ret[i] = QTextFormat(h: v_outCast[i])
  vx_ret
...
proc drawContents*(self: gen_qtextdocument_types.QTextDocument, painter: QPainter): void =
...
proc size*(self: gen_qtextdocument_types.QTextDocument, ): QSizeF =
  QSizeF(h: fcQTextDocument_size(self.h))
...
proc undo*(self: gen_qtextdocument_types.QTextDocument, cursor: QTextCursor): void =
  fcQTextDocument_undo(self.h, cursor.h)

proc redo*(self: gen_qtextdocument_types.QTextDocument, cursor: QTextCursor): void =
...
proc defaultTextOption*(self: gen_qtextdocument_types.QTextDocument, ): QTextOption =
  QTextOption(h: fcQTextDocument_defaultTextOption(self.h))

proc setDefaultTextOption*(self: gen_qtextdocument_types.QTextDocument, option: QTextOption): void =
  fcQTextDocument_setDefaultTextOption(self.h, option.h)

proc baseUrl*(self: gen_qtextdocument_types.QTextDocument, ): QUrl =
  QUrl(h: fcQTextDocument_baseUrl(self.h))

proc setBaseUrl*(self: gen_qtextdocument_types.QTextDocument, url: QUrl): void =
...
proc cursorPositionChanged*(self: gen_qtextdocument_types.QTextDocument, cursor: QTextCursor): void =
  fcQTextDocument_cursorPositionChanged(self.h, cursor.h)

type QTextDocumentcursorPositionChangedSlot* = proc(cursor: QTextCursor)
...
proc baseUrlChanged*(self: gen_qtextdocument_types.QTextDocument, url: QUrl): void =
  fcQTextDocument_baseUrlChanged(self.h, url.h)

type QTextDocumentbaseUrlChangedSlot* = proc(url: QUrl)
...
proc appendUndoItem*(self: gen_qtextdocument_types.QTextDocument, param1: QAbstractUndoItem): void =
...
proc clone*(self: gen_qtextdocument_types.QTextDocument, parent: QObject): QTextDocument =
...
proc find*(self: gen_qtextdocument_types.QTextDocument, subString: string, fromVal: cint): QTextCursor =
  QTextCursor(h: fcQTextDocument_find22(self.h, struct_miqt_string(data: subString, len: csize_t(len(subString))), fromVal))

proc find*(self: gen_qtextdocument_types.QTextDocument, subString: string, fromVal: cint, options: cint): QTextCursor =
  QTextCursor(h: fcQTextDocument_find32(self.h, struct_miqt_string(data: subString, len: csize_t(len(subString))), fromVal, cint(options)))

proc find*(self: gen_qtextdocument_types.QTextDocument, subString: string, cursor: QTextCursor, options: cint): QTextCursor =
  QTextCursor(h: fcQTextDocument_find33(self.h, struct_miqt_string(data: subString, len: csize_t(len(subString))), cursor.h, cint(options)))

proc find*(self: gen_qtextdocument_types.QTextDocument, expr: QRegExp, fromVal: cint): QTextCursor =
  QTextCursor(h: fcQTextDocument_find23(self.h, expr.h, fromVal))

proc find*(self: gen_qtextdocument_types.QTextDocument, expr: QRegExp, fromVal: cint, options: cint): QTextCursor =
  QTextCursor(h: fcQTextDocument_find34(self.h, expr.h, fromVal, cint(options)))

proc find*(self: gen_qtextdocument_types.QTextDocument, expr: QRegExp, cursor: QTextCursor, options: cint): QTextCursor =
  QTextCursor(h: fcQTextDocument_find35(self.h, expr.h, cursor.h, cint(options)))

proc find*(self: gen_qtextdocument_types.QTextDocument, expr: QRegularExpression, fromVal: cint): QTextCursor =
  QTextCursor(h: fcQTextDocument_find24(self.h, expr.h, fromVal))

proc find*(self: gen_qtextdocument_types.QTextDocument, expr: QRegularExpression, fromVal: cint, options: cint): QTextCursor =
  QTextCursor(h: fcQTextDocument_find36(self.h, expr.h, fromVal, cint(options)))

proc find*(self: gen_qtextdocument_types.QTextDocument, expr: QRegularExpression, cursor: QTextCursor, options: cint): QTextCursor =
  QTextCursor(h: fcQTextDocument_find37(self.h, expr.h, cursor.h, cint(options)))

proc drawContents*(self: gen_qtextdocument_types.QTextDocument, painter: QPainter, rect: QRectF): void =
...
proc onmetacall*(self: gen_qtextdocument_types.QTextDocument, slot: QTextDocumentmetacallProc) =
  # TODO check subclass
  var tmp = new QTextDocumentmetacallProc
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QTextDocument_metacall(self: ptr cQTextDocument, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QTextDocument_metacall ".} =
  var nimfunc = cast[ptr QTextDocumentmetacallProc](cast[pointer](slot))
...
proc miqt_exec_callback_QTextDocument_clear(self: ptr cQTextDocument, slot: int): void {.exportc: "miqt_exec_callback_QTextDocument_clear ".} =
  ...
  nimfunc[]()
proc QTextDocumentcreateObject*(self: gen_qtextdocument_types.QTextDocument, f: QTextFormat): QTextObject =
  QTextObject(h: fQTextDocument_virtualbase_createObject(self.h, f.h))

type QTextDocumentcreateObjectProc* = proc(f: QTextFormat): QTextObject
...
proc miqt_exec_callback_QTextDocument_createObject(self: ptr cQTextDocument, slot: int, f: pointer): pointer {.exportc: "miqt_exec_callback_QTextDocument_createObject ".} =
  ...
  let slotval1 = QTextFormat(h: f)


  let virtualReturn = nimfunc[](slotval1 )

  virtualReturn.h
proc QTextDocumentloadResource*(self: gen_qtextdocument_types.QTextDocument, typeVal: cint, name: QUrl): QVariant =
  QVariant(h: fQTextDocument_virtualbase_loadResource(self.h, typeVal, name.h))

type QTextDocumentloadResourceProc* = proc(typeVal: cint, name: QUrl): QVariant
...
proc miqt_exec_callback_QTextDocument_loadResource(self: ptr cQTextDocument, slot: int, typeVal: cint, name: pointer): pointer {.exportc: "miqt_exec_callback_QTextDocument_loadResource ".} =
  ...
  virtualReturn.h
proc QTextDocumentevent*(self: gen_qtextdocument_types.QTextDocument, event: QEvent): bool =
  fQTextDocument_virtualbase_event(self.h, event.h)

type QTextDocumenteventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QTextDocument_event(self: ptr cQTextDocument, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QTextDocument_event ".} =
  ...
  virtualReturn
proc QTextDocumenteventFilter*(self: gen_qtextdocument_types.QTextDocument, watched: QObject, event: QEvent): bool =
  fQTextDocument_virtualbase_eventFilter(self.h, watched.h, event.h)

type QTextDocumenteventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QTextDocument_eventFilter(self: ptr cQTextDocument, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QTextDocument_eventFilter ".} =
  ...
  virtualReturn
proc QTextDocumenttimerEvent*(self: gen_qtextdocument_types.QTextDocument, event: QTimerEvent): void =
  fQTextDocument_virtualbase_timerEvent(self.h, event.h)

type QTextDocumenttimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QTextDocument_timerEvent(self: ptr cQTextDocument, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTextDocument_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTextDocumentchildEvent*(self: gen_qtextdocument_types.QTextDocument, event: QChildEvent): void =
  fQTextDocument_virtualbase_childEvent(self.h, event.h)

type QTextDocumentchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QTextDocument_childEvent(self: ptr cQTextDocument, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTextDocument_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTextDocumentcustomEvent*(self: gen_qtextdocument_types.QTextDocument, event: QEvent): void =
  fQTextDocument_virtualbase_customEvent(self.h, event.h)

type QTextDocumentcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QTextDocument_customEvent(self: ptr cQTextDocument, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTextDocument_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTextDocumentconnectNotify*(self: gen_qtextdocument_types.QTextDocument, signal: QMetaMethod): void =
  fQTextDocument_virtualbase_connectNotify(self.h, signal.h)

type QTextDocumentconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QTextDocument_connectNotify(self: ptr cQTextDocument, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QTextDocument_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QTextDocumentdisconnectNotify*(self: gen_qtextdocument_types.QTextDocument, signal: QMetaMethod): void =
  fQTextDocument_virtualbase_disconnectNotify(self.h, signal.h)

type QTextDocumentdisconnectNotifyProc* = proc(signal: QMetaMethod): void
