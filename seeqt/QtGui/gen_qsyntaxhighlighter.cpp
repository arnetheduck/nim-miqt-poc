...
QMetaObject* QSyntaxHighlighter_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQSyntaxHighlighter*)(self) )->QSyntaxHighlighter::metaObject();

}

void* QSyntaxHighlighter_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQSyntaxHighlighter*)(self) )->QSyntaxHighlighter::qt_metacast(param1);

}

int QSyntaxHighlighter_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQSyntaxHighlighter*)(self) )->QSyntaxHighlighter::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
void QSyntaxHighlighter_protectedbase_setFormat(void* self, int start, int count, QTextCharFormat* format) {
	MiqtVirtualQSyntaxHighlighter* self_cast = static_cast<MiqtVirtualQSyntaxHighlighter*>( (QSyntaxHighlighter*)(self) );
