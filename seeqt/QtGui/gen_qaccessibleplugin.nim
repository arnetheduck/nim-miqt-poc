...
proc create*(T: type gen_qaccessibleplugin_types.QAccessiblePlugin, parent: QObject): gen_qaccessibleplugin_types.QAccessiblePlugin =
  gen_qaccessibleplugin_types.QAccessiblePlugin.init(fcQAccessiblePlugin_new2(parent.h))

proc metaObject*(self: gen_qaccessibleplugin_types.QAccessiblePlugin, ): QMetaObject =
  QMetaObject(h: fcQAccessiblePlugin_metaObject(self.h))
...
proc create*(self: gen_qaccessibleplugin_types.QAccessiblePlugin, key: string, objectVal: QObject): QAccessibleInterface =
  QAccessibleInterface(h: fcQAccessiblePlugin_create(self.h, struct_miqt_string(data: key, len: csize_t(len(key))), objectVal.h))
...
proc miqt_exec_callback_QAccessiblePlugin_metacall(self: ptr cQAccessiblePlugin, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QAccessiblePlugin_metacall ".} =
  ...
  virtualReturn
type QAccessiblePlugincreateProc* = proc(key: string, objectVal: QObject): QAccessibleInterface
...
proc miqt_exec_callback_QAccessiblePlugin_create(self: ptr cQAccessiblePlugin, slot: int, key: struct_miqt_string, objectVal: pointer): pointer {.exportc: "miqt_exec_callback_QAccessiblePlugin_create ".} =
  ...
  let slotval2 = QObject(h: objectVal)


  let virtualReturn = nimfunc[](slotval1, slotval2 )

  virtualReturn.h
proc QAccessiblePluginevent*(self: gen_qaccessibleplugin_types.QAccessiblePlugin, event: QEvent): bool =
  fQAccessiblePlugin_virtualbase_event(self.h, event.h)

type QAccessiblePlugineventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QAccessiblePlugin_event(self: ptr cQAccessiblePlugin, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QAccessiblePlugin_event ".} =
  ...
  virtualReturn
proc QAccessiblePlugineventFilter*(self: gen_qaccessibleplugin_types.QAccessiblePlugin, watched: QObject, event: QEvent): bool =
  fQAccessiblePlugin_virtualbase_eventFilter(self.h, watched.h, event.h)

type QAccessiblePlugineventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QAccessiblePlugin_eventFilter(self: ptr cQAccessiblePlugin, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QAccessiblePlugin_eventFilter ".} =
  ...
  virtualReturn
proc QAccessiblePlugintimerEvent*(self: gen_qaccessibleplugin_types.QAccessiblePlugin, event: QTimerEvent): void =
  fQAccessiblePlugin_virtualbase_timerEvent(self.h, event.h)

type QAccessiblePlugintimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QAccessiblePlugin_timerEvent(self: ptr cQAccessiblePlugin, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QAccessiblePlugin_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QAccessiblePluginchildEvent*(self: gen_qaccessibleplugin_types.QAccessiblePlugin, event: QChildEvent): void =
  fQAccessiblePlugin_virtualbase_childEvent(self.h, event.h)

type QAccessiblePluginchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QAccessiblePlugin_childEvent(self: ptr cQAccessiblePlugin, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QAccessiblePlugin_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QAccessiblePlugincustomEvent*(self: gen_qaccessibleplugin_types.QAccessiblePlugin, event: QEvent): void =
  fQAccessiblePlugin_virtualbase_customEvent(self.h, event.h)

type QAccessiblePlugincustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QAccessiblePlugin_customEvent(self: ptr cQAccessiblePlugin, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QAccessiblePlugin_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QAccessiblePluginconnectNotify*(self: gen_qaccessibleplugin_types.QAccessiblePlugin, signal: QMetaMethod): void =
  fQAccessiblePlugin_virtualbase_connectNotify(self.h, signal.h)

type QAccessiblePluginconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QAccessiblePlugin_connectNotify(self: ptr cQAccessiblePlugin, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QAccessiblePlugin_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QAccessiblePlugindisconnectNotify*(self: gen_qaccessibleplugin_types.QAccessiblePlugin, signal: QMetaMethod): void =
  fQAccessiblePlugin_virtualbase_disconnectNotify(self.h, signal.h)

type QAccessiblePlugindisconnectNotifyProc* = proc(signal: QMetaMethod): void
