...
proc create*(T: type gen_qpicture_types.QPicture, param1: QPicture): gen_qpicture_types.QPicture =
...
proc play*(self: gen_qpicture_types.QPicture, p: QPainter): bool =
  fcQPicture_play(self.h, p.h)

proc load*(self: gen_qpicture_types.QPicture, dev: QIODevice): bool =
...
proc save*(self: gen_qpicture_types.QPicture, dev: QIODevice): bool =
...
proc boundingRect*(self: gen_qpicture_types.QPicture, ): QRect =
  QRect(h: fcQPicture_boundingRect(self.h))

proc setBoundingRect*(self: gen_qpicture_types.QPicture, r: QRect): void =
  fcQPicture_setBoundingRect(self.h, r.h)

proc operatorAssign*(self: gen_qpicture_types.QPicture, p: QPicture): void =
  fcQPicture_operatorAssign(self.h, p.h)

proc swap*(self: gen_qpicture_types.QPicture, other: QPicture): void =
...
proc paintEngine*(self: gen_qpicture_types.QPicture, ): QPaintEngine =
  QPaintEngine(h: fcQPicture_paintEngine(self.h))

proc load*(self: gen_qpicture_types.QPicture, dev: QIODevice, format: cstring): bool =
...
proc save*(self: gen_qpicture_types.QPicture, dev: QIODevice, format: cstring): bool =
...
proc QPicturepaintEngine*(self: gen_qpicture_types.QPicture, ): QPaintEngine =
  QPaintEngine(h: fQPicture_virtualbase_paintEngine(self.h))

type QPicturepaintEngineProc* = proc(): QPaintEngine
...
proc miqt_exec_callback_QPicture_metric(self: ptr cQPicture, slot: int, m: cint): cint {.exportc: "miqt_exec_callback_QPicture_metric ".} =
  ...
  virtualReturn
proc QPictureinitPainter*(self: gen_qpicture_types.QPicture, painter: QPainter): void =
  fQPicture_virtualbase_initPainter(self.h, painter.h)

type QPictureinitPainterProc* = proc(painter: QPainter): void
...
proc miqt_exec_callback_QPicture_initPainter(self: ptr cQPicture, slot: int, painter: pointer): void {.exportc: "miqt_exec_callback_QPicture_initPainter ".} =
  ...
  nimfunc[](slotval1)
proc QPictureredirected*(self: gen_qpicture_types.QPicture, offset: QPoint): QPaintDevice =
  QPaintDevice(h: fQPicture_virtualbase_redirected(self.h, offset.h))

type QPictureredirectedProc* = proc(offset: QPoint): QPaintDevice
...
proc miqt_exec_callback_QPicture_redirected(self: ptr cQPicture, slot: int, offset: pointer): pointer {.exportc: "miqt_exec_callback_QPicture_redirected ".} =
  ...
  virtualReturn.h
proc QPicturesharedPainter*(self: gen_qpicture_types.QPicture, ): QPainter =
  QPainter(h: fQPicture_virtualbase_sharedPainter(self.h))

type QPicturesharedPainterProc* = proc(): QPainter
...
proc create*(T: type gen_qpicture_types.QPictureIO, ioDevice: QIODevice, format: cstring): gen_qpicture_types.QPictureIO =
...
proc picture*(self: gen_qpicture_types.QPictureIO, ): QPicture =
...
proc ioDevice*(self: gen_qpicture_types.QPictureIO, ): QIODevice =
  QIODevice(h: fcQPictureIO_ioDevice(self.h))
...
proc setPicture*(self: gen_qpicture_types.QPictureIO, picture: QPicture): void =
...
proc setIODevice*(self: gen_qpicture_types.QPictureIO, iODevice: QIODevice): void =
...
proc pictureFormat*(_: type gen_qpicture_types.QPictureIO, param1: QIODevice): seq[byte] =
