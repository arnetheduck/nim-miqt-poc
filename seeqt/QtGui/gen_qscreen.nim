...
func init*(T: type gen_qscreen_types.QScreen, h: ptr cQScreen): gen_qscreen_types.QScreen =
  T(h: h)
proc metaObject*(self: gen_qscreen_types.QScreen, ): QMetaObject =
  QMetaObject(h: fcQScreen_metaObject(self.h))
...
proc size*(self: gen_qscreen_types.QScreen, ): QSize =
  QSize(h: fcQScreen_size(self.h))

proc geometry*(self: gen_qscreen_types.QScreen, ): QRect =
  QRect(h: fcQScreen_geometry(self.h))

proc physicalSize*(self: gen_qscreen_types.QScreen, ): QSizeF =
  QSizeF(h: fcQScreen_physicalSize(self.h))
...
proc availableSize*(self: gen_qscreen_types.QScreen, ): QSize =
  QSize(h: fcQScreen_availableSize(self.h))

proc availableGeometry*(self: gen_qscreen_types.QScreen, ): QRect =
  QRect(h: fcQScreen_availableGeometry(self.h))

proc virtualSiblings*(self: gen_qscreen_types.QScreen, ): seq[QScreen] =
...
proc virtualSiblingAt*(self: gen_qscreen_types.QScreen, point: QPoint): QScreen =
  QScreen(h: fcQScreen_virtualSiblingAt(self.h, point.h))

proc virtualSize*(self: gen_qscreen_types.QScreen, ): QSize =
  QSize(h: fcQScreen_virtualSize(self.h))

proc virtualGeometry*(self: gen_qscreen_types.QScreen, ): QRect =
  QRect(h: fcQScreen_virtualGeometry(self.h))

proc availableVirtualSize*(self: gen_qscreen_types.QScreen, ): QSize =
  QSize(h: fcQScreen_availableVirtualSize(self.h))

proc availableVirtualGeometry*(self: gen_qscreen_types.QScreen, ): QRect =
  QRect(h: fcQScreen_availableVirtualGeometry(self.h))
...
proc transformBetween*(self: gen_qscreen_types.QScreen, a: cint, b: cint, target: QRect): QTransform =
  QTransform(h: fcQScreen_transformBetween(self.h, cint(a), cint(b), target.h))

proc mapBetween*(self: gen_qscreen_types.QScreen, a: cint, b: cint, rect: QRect): QRect =
  QRect(h: fcQScreen_mapBetween(self.h, cint(a), cint(b), rect.h))
...
proc grabWindow*(self: gen_qscreen_types.QScreen, ): QPixmap =
  QPixmap(h: fcQScreen_grabWindow(self.h))

proc refreshRate*(self: gen_qscreen_types.QScreen, ): float64 =
  fcQScreen_refreshRate(self.h)

proc geometryChanged*(self: gen_qscreen_types.QScreen, geometry: QRect): void =
  fcQScreen_geometryChanged(self.h, geometry.h)

type QScreengeometryChangedSlot* = proc(geometry: QRect)
...
proc availableGeometryChanged*(self: gen_qscreen_types.QScreen, geometry: QRect): void =
  fcQScreen_availableGeometryChanged(self.h, geometry.h)

type QScreenavailableGeometryChangedSlot* = proc(geometry: QRect)
...
proc physicalSizeChanged*(self: gen_qscreen_types.QScreen, size: QSizeF): void =
  fcQScreen_physicalSizeChanged(self.h, size.h)

type QScreenphysicalSizeChangedSlot* = proc(size: QSizeF)
...
proc virtualGeometryChanged*(self: gen_qscreen_types.QScreen, rect: QRect): void =
  fcQScreen_virtualGeometryChanged(self.h, rect.h)

type QScreenvirtualGeometryChangedSlot* = proc(rect: QRect)
...
proc grabWindow*(self: gen_qscreen_types.QScreen, window: uint): QPixmap =
  QPixmap(h: fcQScreen_grabWindow1(self.h, window))

proc grabWindow*(self: gen_qscreen_types.QScreen, window: uint, x: cint): QPixmap =
  QPixmap(h: fcQScreen_grabWindow2(self.h, window, x))

proc grabWindow*(self: gen_qscreen_types.QScreen, window: uint, x: cint, y: cint): QPixmap =
  QPixmap(h: fcQScreen_grabWindow3(self.h, window, x, y))

proc grabWindow*(self: gen_qscreen_types.QScreen, window: uint, x: cint, y: cint, w: cint): QPixmap =
  QPixmap(h: fcQScreen_grabWindow4(self.h, window, x, y, w))
