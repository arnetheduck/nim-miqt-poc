...
proc create*(T: type gen_qundostack_types.QUndoCommand, parent: QUndoCommand): gen_qundostack_types.QUndoCommand =
  gen_qundostack_types.QUndoCommand.init(fcQUndoCommand_new3(parent.h))

proc create*(T: type gen_qundostack_types.QUndoCommand, text: string, parent: QUndoCommand): gen_qundostack_types.QUndoCommand =
...
proc mergeWith*(self: gen_qundostack_types.QUndoCommand, other: QUndoCommand): bool =
...
proc child*(self: gen_qundostack_types.QUndoCommand, index: cint): QUndoCommand =
...
proc miqt_exec_callback_QUndoCommand_id(self: ptr cQUndoCommand, slot: int): cint {.exportc: "miqt_exec_callback_QUndoCommand_id ".} =
  ...
  virtualReturn
proc QUndoCommandmergeWith*(self: gen_qundostack_types.QUndoCommand, other: QUndoCommand): bool =
  fQUndoCommand_virtualbase_mergeWith(self.h, other.h)

type QUndoCommandmergeWithProc* = proc(other: QUndoCommand): bool
...
proc create*(T: type gen_qundostack_types.QUndoStack, parent: QObject): gen_qundostack_types.QUndoStack =
  gen_qundostack_types.QUndoStack.init(fcQUndoStack_new2(parent.h))

proc metaObject*(self: gen_qundostack_types.QUndoStack, ): QMetaObject =
  QMetaObject(h: fcQUndoStack_metaObject(self.h))
...
proc push*(self: gen_qundostack_types.QUndoStack, cmd: QUndoCommand): void =
...
proc command*(self: gen_qundostack_types.QUndoStack, index: cint): QUndoCommand =
...
proc miqt_exec_callback_QUndoStack_metacall(self: ptr cQUndoStack, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QUndoStack_metacall ".} =
  ...
  virtualReturn
proc QUndoStackevent*(self: gen_qundostack_types.QUndoStack, event: QEvent): bool =
  fQUndoStack_virtualbase_event(self.h, event.h)

type QUndoStackeventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QUndoStack_event(self: ptr cQUndoStack, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QUndoStack_event ".} =
  ...
  virtualReturn
proc QUndoStackeventFilter*(self: gen_qundostack_types.QUndoStack, watched: QObject, event: QEvent): bool =
  fQUndoStack_virtualbase_eventFilter(self.h, watched.h, event.h)

type QUndoStackeventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QUndoStack_eventFilter(self: ptr cQUndoStack, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QUndoStack_eventFilter ".} =
  ...
  virtualReturn
proc QUndoStacktimerEvent*(self: gen_qundostack_types.QUndoStack, event: QTimerEvent): void =
  fQUndoStack_virtualbase_timerEvent(self.h, event.h)

type QUndoStacktimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QUndoStack_timerEvent(self: ptr cQUndoStack, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QUndoStack_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QUndoStackchildEvent*(self: gen_qundostack_types.QUndoStack, event: QChildEvent): void =
  fQUndoStack_virtualbase_childEvent(self.h, event.h)

type QUndoStackchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QUndoStack_childEvent(self: ptr cQUndoStack, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QUndoStack_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QUndoStackcustomEvent*(self: gen_qundostack_types.QUndoStack, event: QEvent): void =
  fQUndoStack_virtualbase_customEvent(self.h, event.h)

type QUndoStackcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QUndoStack_customEvent(self: ptr cQUndoStack, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QUndoStack_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QUndoStackconnectNotify*(self: gen_qundostack_types.QUndoStack, signal: QMetaMethod): void =
  fQUndoStack_virtualbase_connectNotify(self.h, signal.h)

type QUndoStackconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QUndoStack_connectNotify(self: ptr cQUndoStack, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QUndoStack_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QUndoStackdisconnectNotify*(self: gen_qundostack_types.QUndoStack, signal: QMetaMethod): void =
  fQUndoStack_virtualbase_disconnectNotify(self.h, signal.h)

type QUndoStackdisconnectNotifyProc* = proc(signal: QMetaMethod): void
