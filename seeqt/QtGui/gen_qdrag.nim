...
func init*(T: type gen_qdrag_types.QDrag, h: ptr cQDrag): gen_qdrag_types.QDrag =
  T(h: h)
proc create*(T: type gen_qdrag_types.QDrag, dragSource: QObject): gen_qdrag_types.QDrag =
  gen_qdrag_types.QDrag.init(fcQDrag_new(dragSource.h))

proc metaObject*(self: gen_qdrag_types.QDrag, ): QMetaObject =
  QMetaObject(h: fcQDrag_metaObject(self.h))
...
proc setMimeData*(self: gen_qdrag_types.QDrag, data: QMimeData): void =
  fcQDrag_setMimeData(self.h, data.h)

proc mimeData*(self: gen_qdrag_types.QDrag, ): QMimeData =
  QMimeData(h: fcQDrag_mimeData(self.h))

proc setPixmap*(self: gen_qdrag_types.QDrag, pixmap: QPixmap): void =
  fcQDrag_setPixmap(self.h, pixmap.h)

proc pixmap*(self: gen_qdrag_types.QDrag, ): QPixmap =
  QPixmap(h: fcQDrag_pixmap(self.h))

proc setHotSpot*(self: gen_qdrag_types.QDrag, hotspot: QPoint): void =
  fcQDrag_setHotSpot(self.h, hotspot.h)

proc hotSpot*(self: gen_qdrag_types.QDrag, ): QPoint =
  QPoint(h: fcQDrag_hotSpot(self.h))

proc source*(self: gen_qdrag_types.QDrag, ): QObject =
  QObject(h: fcQDrag_source(self.h))

proc target*(self: gen_qdrag_types.QDrag, ): QObject =
  QObject(h: fcQDrag_target(self.h))
...
proc setDragCursor*(self: gen_qdrag_types.QDrag, cursor: QPixmap, action: cint): void =
  fcQDrag_setDragCursor(self.h, cursor.h, cint(action))

proc dragCursor*(self: gen_qdrag_types.QDrag, action: cint): QPixmap =
  QPixmap(h: fcQDrag_dragCursor(self.h, cint(action)))
...
proc targetChanged*(self: gen_qdrag_types.QDrag, newTarget: QObject): void =
  fcQDrag_targetChanged(self.h, newTarget.h)

type QDragtargetChangedSlot* = proc(newTarget: QObject)
proc miqt_exec_callback_QDrag_targetChanged(slot: int, newTarget: pointer) {.exportc.} =
  ...
  let slotval1 = QObject(h: newTarget)
...
proc miqt_exec_callback_QDrag_metacall(self: ptr cQDrag, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QDrag_metacall ".} =
  ...
  virtualReturn
proc QDragevent*(self: gen_qdrag_types.QDrag, event: QEvent): bool =
  fQDrag_virtualbase_event(self.h, event.h)

type QDrageventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QDrag_event(self: ptr cQDrag, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QDrag_event ".} =
  ...
  virtualReturn
proc QDrageventFilter*(self: gen_qdrag_types.QDrag, watched: QObject, event: QEvent): bool =
  fQDrag_virtualbase_eventFilter(self.h, watched.h, event.h)

type QDrageventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QDrag_eventFilter(self: ptr cQDrag, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QDrag_eventFilter ".} =
  ...
  virtualReturn
proc QDragtimerEvent*(self: gen_qdrag_types.QDrag, event: QTimerEvent): void =
  fQDrag_virtualbase_timerEvent(self.h, event.h)

type QDragtimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QDrag_timerEvent(self: ptr cQDrag, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QDrag_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QDragchildEvent*(self: gen_qdrag_types.QDrag, event: QChildEvent): void =
  fQDrag_virtualbase_childEvent(self.h, event.h)

type QDragchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QDrag_childEvent(self: ptr cQDrag, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QDrag_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QDragcustomEvent*(self: gen_qdrag_types.QDrag, event: QEvent): void =
  fQDrag_virtualbase_customEvent(self.h, event.h)

type QDragcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QDrag_customEvent(self: ptr cQDrag, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QDrag_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QDragconnectNotify*(self: gen_qdrag_types.QDrag, signal: QMetaMethod): void =
  fQDrag_virtualbase_connectNotify(self.h, signal.h)

type QDragconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QDrag_connectNotify(self: ptr cQDrag, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QDrag_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QDragdisconnectNotify*(self: gen_qdrag_types.QDrag, signal: QMetaMethod): void =
  fQDrag_virtualbase_disconnectNotify(self.h, signal.h)

type QDragdisconnectNotifyProc* = proc(signal: QMetaMethod): void
