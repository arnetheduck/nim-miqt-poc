...
proc create*(T: type gen_qimagewriter_types.QImageWriter, device: QIODevice, format: seq[byte]): gen_qimagewriter_types.QImageWriter =
...
proc setDevice*(self: gen_qimagewriter_types.QImageWriter, device: QIODevice): void =
  fcQImageWriter_setDevice(self.h, device.h)

proc device*(self: gen_qimagewriter_types.QImageWriter, ): QIODevice =
  QIODevice(h: fcQImageWriter_device(self.h))
...
proc write*(self: gen_qimagewriter_types.QImageWriter, image: QImage): bool =
