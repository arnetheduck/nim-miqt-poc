...
QMetaObject* QIconEnginePlugin_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQIconEnginePlugin*)(self) )->QIconEnginePlugin::metaObject();

}

void* QIconEnginePlugin_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQIconEnginePlugin*)(self) )->QIconEnginePlugin::qt_metacast(param1);

}

int QIconEnginePlugin_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQIconEnginePlugin*)(self) )->QIconEnginePlugin::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
