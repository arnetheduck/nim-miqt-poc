...
template NImageFormats*(_: type QImageFormatEnum): untyped = 30
...
proc fcQImage_byteCount(self: pointer, ): cint {.importc: "QImage_byteCount".}
...
proc fcQImage_bytesPerLine(self: pointer, ): cint {.importc: "QImage_bytesPerLine".}
...
proc fcQImage_alphaChannel(self: pointer, ): pointer {.importc: "QImage_alphaChannel".}
...
proc fcQImage_transformedWithMatrix(self: pointer, matrix: pointer): pointer {.importc: "QImage_transformedWithMatrix".}
proc fcQImage_trueMatrix2(param1: pointer, w: cint, h: cint): pointer {.importc: "QImage_trueMatrix2".}
...
proc fcQImage_loadFromData(self: pointer, buf: ptr uint8, len: cint): bool {.importc: "QImage_loadFromData".}
...
proc fcQImage_fromData(data: ptr uint8, size: cint): pointer {.importc: "QImage_fromData".}
...
proc fcQImage_transformed22(self: pointer, matrix: pointer, mode: cint): pointer {.importc: "QImage_transformed22".}
...
proc fcQImage_loadFromData2(self: pointer, data: struct_miqt_string, aformat: cstring): bool {.importc: "QImage_loadFromData2".}
...
proc create*(T: type gen_qimage_types.QImage, size: QSize, format: cint): gen_qimage_types.QImage =
...
proc create*(T: type gen_qimage_types.QImage, param1: QImage): gen_qimage_types.QImage =
...
proc operatorAssign*(self: gen_qimage_types.QImage, param1: QImage): void =
  fcQImage_operatorAssign(self.h, param1.h)

proc swap*(self: gen_qimage_types.QImage, other: QImage): void =
...
proc operatorEqual*(self: gen_qimage_types.QImage, param1: QImage): bool =
  fcQImage_operatorEqual(self.h, param1.h)

proc operatorNotEqual*(self: gen_qimage_types.QImage, param1: QImage): bool =
  fcQImage_operatorNotEqual(self.h, param1.h)

proc ToQVariant*(self: gen_qimage_types.QImage, ): QVariant =
  QVariant(h: fcQImage_ToQVariant(self.h))
...
proc copy*(self: gen_qimage_types.QImage, ): QImage =
  QImage(h: fcQImage_copy(self.h))

proc copy*(self: gen_qimage_types.QImage, x: cint, y: cint, w: cint, h: cint): QImage =
  QImage(h: fcQImage_copy2(self.h, x, y, w, h))

proc format*(self: gen_qimage_types.QImage, ): cint =
  cint(fcQImage_format(self.h))

proc convertToFormat*(self: gen_qimage_types.QImage, f: cint): QImage =
  QImage(h: fcQImage_convertToFormat(self.h, cint(f)))

proc convertToFormat*(self: gen_qimage_types.QImage, f: cint, colorTable: seq[cuint]): QImage =
...
proc size*(self: gen_qimage_types.QImage, ): QSize =
  QSize(h: fcQImage_size(self.h))

proc rect*(self: gen_qimage_types.QImage, ): QRect =
  QRect(h: fcQImage_rect(self.h))
...
proc byteCount*(self: gen_qimage_types.QImage, ): cint =
  fcQImage_byteCount(self.h)
...
proc pixelIndex*(self: gen_qimage_types.QImage, pt: QPoint): cint =
...
proc pixel*(self: gen_qimage_types.QImage, pt: QPoint): cuint =
...
proc setPixel*(self: gen_qimage_types.QImage, pt: QPoint, index_or_rgb: cuint): void =
  fcQImage_setPixel2(self.h, pt.h, index_or_rgb)

proc pixelColor*(self: gen_qimage_types.QImage, x: cint, y: cint): QColor =
  QColor(h: fcQImage_pixelColor(self.h, x, y))

proc pixelColor*(self: gen_qimage_types.QImage, pt: QPoint): QColor =
  QColor(h: fcQImage_pixelColorWithPt(self.h, pt.h))

proc setPixelColor*(self: gen_qimage_types.QImage, x: cint, y: cint, c: QColor): void =
  fcQImage_setPixelColor(self.h, x, y, c.h)

proc setPixelColor*(self: gen_qimage_types.QImage, pt: QPoint, c: QColor): void =
...
proc fill*(self: gen_qimage_types.QImage, color: QColor): void =
...
proc setAlphaChannel*(self: gen_qimage_types.QImage, alphaChannel: QImage): void =
  fcQImage_setAlphaChannel(self.h, alphaChannel.h)

proc alphaChannel*(self: gen_qimage_types.QImage, ): QImage =
  QImage(h: fcQImage_alphaChannel(self.h))

proc createAlphaMask*(self: gen_qimage_types.QImage, ): QImage =
  QImage(h: fcQImage_createAlphaMask(self.h))

proc createHeuristicMask*(self: gen_qimage_types.QImage, ): QImage =
  QImage(h: fcQImage_createHeuristicMask(self.h))

proc createMaskFromColor*(self: gen_qimage_types.QImage, color: cuint): QImage =
  QImage(h: fcQImage_createMaskFromColor(self.h, color))

proc scaled*(self: gen_qimage_types.QImage, w: cint, h: cint): QImage =
  QImage(h: fcQImage_scaled(self.h, w, h))

proc scaled*(self: gen_qimage_types.QImage, s: QSize): QImage =
  QImage(h: fcQImage_scaledWithQSize(self.h, s.h))

proc scaledToWidth*(self: gen_qimage_types.QImage, w: cint): QImage =
  QImage(h: fcQImage_scaledToWidth(self.h, w))

proc scaledToHeight*(self: gen_qimage_types.QImage, h: cint): QImage =
  QImage(h: fcQImage_scaledToHeight(self.h, h))

proc transformed*(self: gen_qimage_types.QImage, matrix: QMatrix): QImage =
  QImage(h: fcQImage_transformed(self.h, matrix.h))

proc trueMatrix*(_: type gen_qimage_types.QImage, param1: QMatrix, w: cint, h: cint): QMatrix =
  QMatrix(h: fcQImage_trueMatrix(param1.h, w, h))

proc transformed*(self: gen_qimage_types.QImage, matrix: QTransform): QImage =
  QImage(h: fcQImage_transformedWithMatrix(self.h, matrix.h))

proc trueMatrix*(_: type gen_qimage_types.QImage, param1: QTransform, w: cint, h: cint): QTransform =
  QTransform(h: fcQImage_trueMatrix2(param1.h, w, h))

proc mirrored*(self: gen_qimage_types.QImage, ): QImage =
  QImage(h: fcQImage_mirrored(self.h))

proc rgbSwapped*(self: gen_qimage_types.QImage, ): QImage =
  QImage(h: fcQImage_rgbSwapped(self.h))

proc invertPixels*(self: gen_qimage_types.QImage, ): void =
  fcQImage_invertPixels(self.h)

proc colorSpace*(self: gen_qimage_types.QImage, ): QColorSpace =
  QColorSpace(h: fcQImage_colorSpace(self.h))

proc convertedToColorSpace*(self: gen_qimage_types.QImage, param1: QColorSpace): QImage =
  QImage(h: fcQImage_convertedToColorSpace(self.h, param1.h))

proc convertToColorSpace*(self: gen_qimage_types.QImage, param1: QColorSpace): void =
  fcQImage_convertToColorSpace(self.h, param1.h)

proc setColorSpace*(self: gen_qimage_types.QImage, colorSpace: QColorSpace): void =
  fcQImage_setColorSpace(self.h, colorSpace.h)

proc applyColorTransform*(self: gen_qimage_types.QImage, transform: QColorTransform): void =
  fcQImage_applyColorTransform(self.h, transform.h)

proc load*(self: gen_qimage_types.QImage, device: QIODevice, format: cstring): bool =
...
proc loadFromData*(self: gen_qimage_types.QImage, buf: ptr uint8, len: cint): bool =
  fcQImage_loadFromData(self.h, buf, len)
...
proc save*(self: gen_qimage_types.QImage, device: QIODevice): bool =
  fcQImage_saveWithDevice(self.h, device.h)

proc fromData*(_: type gen_qimage_types.QImage, data: ptr uint8, size: cint): QImage =
  QImage(h: fcQImage_fromData(data, size))

proc fromData*(_: type gen_qimage_types.QImage, data: seq[byte]): QImage =
...
proc paintEngine*(self: gen_qimage_types.QImage, ): QPaintEngine =
  QPaintEngine(h: fcQImage_paintEngine(self.h))
...
proc offset*(self: gen_qimage_types.QImage, ): QPoint =
  QPoint(h: fcQImage_offset(self.h))

proc setOffset*(self: gen_qimage_types.QImage, offset: QPoint): void =
...
proc pixelFormat*(self: gen_qimage_types.QImage, ): QPixelFormat =
  QPixelFormat(h: fcQImage_pixelFormat(self.h))

proc toPixelFormat*(_: type gen_qimage_types.QImage, format: cint): QPixelFormat =
  QPixelFormat(h: fcQImage_toPixelFormat(cint(format)))

proc toImageFormat*(_: type gen_qimage_types.QImage, format: QPixelFormat): cint =
  cint(fcQImage_toImageFormat(format.h))

proc copy*(self: gen_qimage_types.QImage, rect: QRect): QImage =
  QImage(h: fcQImage_copy1(self.h, rect.h))

proc convertToFormat*(self: gen_qimage_types.QImage, f: cint, flags: cint): QImage =
  QImage(h: fcQImage_convertToFormat22(self.h, cint(f), cint(flags)))

proc convertToFormat*(self: gen_qimage_types.QImage, f: cint, colorTable: seq[cuint], flags: cint): QImage =
  var colorTable_CArray = newSeq[cuint](len(colorTable))
  for i in 0..<len(colorTable):
    colorTable_CArray[i] = colorTable[i]
...
proc createAlphaMask*(self: gen_qimage_types.QImage, flags: cint): QImage =
  QImage(h: fcQImage_createAlphaMask1(self.h, cint(flags)))

proc createHeuristicMask*(self: gen_qimage_types.QImage, clipTight: bool): QImage =
  QImage(h: fcQImage_createHeuristicMask1(self.h, clipTight))

proc createMaskFromColor*(self: gen_qimage_types.QImage, color: cuint, mode: cint): QImage =
  QImage(h: fcQImage_createMaskFromColor2(self.h, color, cint(mode)))

proc scaled*(self: gen_qimage_types.QImage, w: cint, h: cint, aspectMode: cint): QImage =
  QImage(h: fcQImage_scaled3(self.h, w, h, cint(aspectMode)))

proc scaled*(self: gen_qimage_types.QImage, w: cint, h: cint, aspectMode: cint, mode: cint): QImage =
  QImage(h: fcQImage_scaled4(self.h, w, h, cint(aspectMode), cint(mode)))

proc scaled*(self: gen_qimage_types.QImage, s: QSize, aspectMode: cint): QImage =
  QImage(h: fcQImage_scaled2(self.h, s.h, cint(aspectMode)))

proc scaled*(self: gen_qimage_types.QImage, s: QSize, aspectMode: cint, mode: cint): QImage =
  QImage(h: fcQImage_scaled32(self.h, s.h, cint(aspectMode), cint(mode)))

proc scaledToWidth*(self: gen_qimage_types.QImage, w: cint, mode: cint): QImage =
  QImage(h: fcQImage_scaledToWidth2(self.h, w, cint(mode)))

proc scaledToHeight*(self: gen_qimage_types.QImage, h: cint, mode: cint): QImage =
  QImage(h: fcQImage_scaledToHeight2(self.h, h, cint(mode)))

proc transformed*(self: gen_qimage_types.QImage, matrix: QMatrix, mode: cint): QImage =
  QImage(h: fcQImage_transformed2(self.h, matrix.h, cint(mode)))

proc transformed*(self: gen_qimage_types.QImage, matrix: QTransform, mode: cint): QImage =
  QImage(h: fcQImage_transformed22(self.h, matrix.h, cint(mode)))

proc mirrored*(self: gen_qimage_types.QImage, horizontally: bool): QImage =
  QImage(h: fcQImage_mirrored1(self.h, horizontally))

proc mirrored*(self: gen_qimage_types.QImage, horizontally: bool, vertically: bool): QImage =
...
proc loadFromData*(self: gen_qimage_types.QImage, data: seq[byte], aformat: cstring): bool =
  fcQImage_loadFromData2(self.h, struct_miqt_string(data: cast[cstring](if len(data) == 0: nil else: unsafeAddr data[0]), len: csize_t(len(data))), aformat)
...
proc save*(self: gen_qimage_types.QImage, device: QIODevice, format: cstring): bool =
  fcQImage_save22(self.h, device.h, format)

proc save*(self: gen_qimage_types.QImage, device: QIODevice, format: cstring, quality: cint): bool =
  fcQImage_save32(self.h, device.h, format, quality)

proc fromData*(_: type gen_qimage_types.QImage, data: ptr uint8, size: cint, format: cstring): QImage =
  QImage(h: fcQImage_fromData3(data, size, format))

proc fromData*(_: type gen_qimage_types.QImage, data: seq[byte], format: cstring): QImage =
  QImage(h: fcQImage_fromData2(struct_miqt_string(data: cast[cstring](if len(data) == 0: nil else: unsafeAddr data[0]), len: csize_t(len(data))), format))
...
proc miqt_exec_callback_QImage_devType(self: ptr cQImage, slot: int): cint {.exportc: "miqt_exec_callback_QImage_devType ".} =
  ...
  virtualReturn
proc QImagepaintEngine*(self: gen_qimage_types.QImage, ): QPaintEngine =
  QPaintEngine(h: fQImage_virtualbase_paintEngine(self.h))

type QImagepaintEngineProc* = proc(): QPaintEngine
...
proc miqt_exec_callback_QImage_metric(self: ptr cQImage, slot: int, metric: cint): cint {.exportc: "miqt_exec_callback_QImage_metric ".} =
  ...
  virtualReturn
proc QImageinitPainter*(self: gen_qimage_types.QImage, painter: QPainter): void =
  fQImage_virtualbase_initPainter(self.h, painter.h)

type QImageinitPainterProc* = proc(painter: QPainter): void
...
proc miqt_exec_callback_QImage_initPainter(self: ptr cQImage, slot: int, painter: pointer): void {.exportc: "miqt_exec_callback_QImage_initPainter ".} =
  ...
  nimfunc[](slotval1)
proc QImageredirected*(self: gen_qimage_types.QImage, offset: QPoint): QPaintDevice =
  QPaintDevice(h: fQImage_virtualbase_redirected(self.h, offset.h))

type QImageredirectedProc* = proc(offset: QPoint): QPaintDevice
...
proc miqt_exec_callback_QImage_redirected(self: ptr cQImage, slot: int, offset: pointer): pointer {.exportc: "miqt_exec_callback_QImage_redirected ".} =
  ...
  virtualReturn.h
proc QImagesharedPainter*(self: gen_qimage_types.QImage, ): QPainter =
  QPainter(h: fQImage_virtualbase_sharedPainter(self.h))

type QImagesharedPainterProc* = proc(): QPainter
