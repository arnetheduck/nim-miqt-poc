...
proc convertedTo*(self: gen_qimage_types.QImage, f: cint): QImage =
...
proc deviceIndependentSize*(self: gen_qimage_types.QImage, ): QSizeF =
  QSizeF(h: fcQImage_deviceIndependentSize(self.h))
...
proc trueMatrix*(_: type gen_qimage_types.QImage, param1: QTransform, w: cint, h: cint): QTransform =
  QTransform(h: fcQImage_trueMatrix(param1.h, w, h))
...
proc colorTransformed*(self: gen_qimage_types.QImage, transform: QColorTransform): QImage =
...
proc loadFromData*(self: gen_qimage_types.QImage, data: QByteArrayView): bool =
...
proc fromData*(_: type gen_qimage_types.QImage, data: QByteArrayView): QImage =
...
proc convertedTo*(self: gen_qimage_types.QImage, f: cint, flags: cint): QImage =
...
proc loadFromData*(self: gen_qimage_types.QImage, data: QByteArrayView, format: cstring): bool =
...
proc fromData*(_: type gen_qimage_types.QImage, data: QByteArrayView, format: cstring): QImage =
