...
struct miqt_string QImageIOHandler_virtualbase_name(const void* self) {
	...
	QByteArray _qb = ( (const MiqtVirtualQImageIOHandler*)(self) )->QImageIOHandler::name();
	struct miqt_string _ms;
	_ms.len = _qb.length();
	_ms.data = static_cast<char*>(malloc(_ms.len));
	memcpy(_ms.data, _qb.data(), _ms.len);
...
QMetaObject* QImageIOPlugin_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQImageIOPlugin*)(self) )->QImageIOPlugin::metaObject();

}

void* QImageIOPlugin_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQImageIOPlugin*)(self) )->QImageIOPlugin::qt_metacast(param1);

}

int QImageIOPlugin_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQImageIOPlugin*)(self) )->QImageIOPlugin::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
