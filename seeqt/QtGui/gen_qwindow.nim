...
proc fQWindow_virtualbase_paintEvent(self: pointer, param1: pointer): void{.importc: "QWindow_virtualbase_paintEvent".}
proc fcQWindow_override_virtual_paintEvent(self: pointer, slot: int) {.importc: "QWindow_override_virtual_paintEvent".}
...
proc fQWindow_virtualbase_closeEvent(self: pointer, param1: pointer): void{.importc: "QWindow_virtualbase_closeEvent".}
proc fcQWindow_override_virtual_closeEvent(self: pointer, slot: int) {.importc: "QWindow_override_virtual_closeEvent".}
...
proc fQWindow_virtualbase_nativeEvent(self: pointer, eventType: struct_miqt_string, message: pointer, resultVal: ptr uint): bool{.importc: "QWindow_virtualbase_nativeEvent".}
...
proc create*(T: type gen_qwindow_types.QWindow, parent: QWindow): gen_qwindow_types.QWindow =
  gen_qwindow_types.QWindow.init(fcQWindow_new2(parent.h))

proc create*(T: type gen_qwindow_types.QWindow, screen: QScreen): gen_qwindow_types.QWindow =
  gen_qwindow_types.QWindow.init(fcQWindow_new3(screen.h))

proc metaObject*(self: gen_qwindow_types.QWindow, ): QMetaObject =
  QMetaObject(h: fcQWindow_metaObject(self.h))
...
proc parent*(self: gen_qwindow_types.QWindow, ): QWindow =
  QWindow(h: fcQWindow_parent(self.h))

proc setParent*(self: gen_qwindow_types.QWindow, parent: QWindow): void =
...
proc setFormat*(self: gen_qwindow_types.QWindow, format: QSurfaceFormat): void =
  fcQWindow_setFormat(self.h, format.h)

proc format*(self: gen_qwindow_types.QWindow, ): QSurfaceFormat =
  QSurfaceFormat(h: fcQWindow_format(self.h))

proc requestedFormat*(self: gen_qwindow_types.QWindow, ): QSurfaceFormat =
  QSurfaceFormat(h: fcQWindow_requestedFormat(self.h))
...
proc setMask*(self: gen_qwindow_types.QWindow, region: QRegion): void =
  fcQWindow_setMask(self.h, region.h)

proc mask*(self: gen_qwindow_types.QWindow, ): QRegion =
  QRegion(h: fcQWindow_mask(self.h))
...
proc setTransientParent*(self: gen_qwindow_types.QWindow, parent: QWindow): void =
  fcQWindow_setTransientParent(self.h, parent.h)

proc transientParent*(self: gen_qwindow_types.QWindow, ): QWindow =
  QWindow(h: fcQWindow_transientParent(self.h))

proc isAncestorOf*(self: gen_qwindow_types.QWindow, child: QWindow): bool =
...
proc minimumSize*(self: gen_qwindow_types.QWindow, ): QSize =
  QSize(h: fcQWindow_minimumSize(self.h))

proc maximumSize*(self: gen_qwindow_types.QWindow, ): QSize =
  QSize(h: fcQWindow_maximumSize(self.h))

proc baseSize*(self: gen_qwindow_types.QWindow, ): QSize =
  QSize(h: fcQWindow_baseSize(self.h))

proc sizeIncrement*(self: gen_qwindow_types.QWindow, ): QSize =
  QSize(h: fcQWindow_sizeIncrement(self.h))

proc setMinimumSize*(self: gen_qwindow_types.QWindow, size: QSize): void =
  fcQWindow_setMinimumSize(self.h, size.h)

proc setMaximumSize*(self: gen_qwindow_types.QWindow, size: QSize): void =
  fcQWindow_setMaximumSize(self.h, size.h)

proc setBaseSize*(self: gen_qwindow_types.QWindow, size: QSize): void =
  fcQWindow_setBaseSize(self.h, size.h)

proc setSizeIncrement*(self: gen_qwindow_types.QWindow, size: QSize): void =
  fcQWindow_setSizeIncrement(self.h, size.h)

proc geometry*(self: gen_qwindow_types.QWindow, ): QRect =
  QRect(h: fcQWindow_geometry(self.h))

proc frameMargins*(self: gen_qwindow_types.QWindow, ): QMargins =
  QMargins(h: fcQWindow_frameMargins(self.h))

proc frameGeometry*(self: gen_qwindow_types.QWindow, ): QRect =
  QRect(h: fcQWindow_frameGeometry(self.h))

proc framePosition*(self: gen_qwindow_types.QWindow, ): QPoint =
  QPoint(h: fcQWindow_framePosition(self.h))

proc setFramePosition*(self: gen_qwindow_types.QWindow, point: QPoint): void =
...
proc size*(self: gen_qwindow_types.QWindow, ): QSize =
  QSize(h: fcQWindow_size(self.h))

proc position*(self: gen_qwindow_types.QWindow, ): QPoint =
  QPoint(h: fcQWindow_position(self.h))

proc setPosition*(self: gen_qwindow_types.QWindow, pt: QPoint): void =
...
proc resize*(self: gen_qwindow_types.QWindow, newSize: QSize): void =
...
proc setIcon*(self: gen_qwindow_types.QWindow, icon: QIcon): void =
  fcQWindow_setIcon(self.h, icon.h)

proc icon*(self: gen_qwindow_types.QWindow, ): QIcon =
  QIcon(h: fcQWindow_icon(self.h))
...
proc screen*(self: gen_qwindow_types.QWindow, ): QScreen =
  QScreen(h: fcQWindow_screen(self.h))

proc setScreen*(self: gen_qwindow_types.QWindow, screen: QScreen): void =
  fcQWindow_setScreen(self.h, screen.h)

proc accessibleRoot*(self: gen_qwindow_types.QWindow, ): QAccessibleInterface =
  QAccessibleInterface(h: fcQWindow_accessibleRoot(self.h))

proc focusObject*(self: gen_qwindow_types.QWindow, ): QObject =
  QObject(h: fcQWindow_focusObject(self.h))

proc mapToGlobal*(self: gen_qwindow_types.QWindow, pos: QPointF): QPointF =
  QPointF(h: fcQWindow_mapToGlobal(self.h, pos.h))

proc mapFromGlobal*(self: gen_qwindow_types.QWindow, pos: QPointF): QPointF =
  QPointF(h: fcQWindow_mapFromGlobal(self.h, pos.h))

proc mapToGlobal*(self: gen_qwindow_types.QWindow, pos: QPoint): QPoint =
  QPoint(h: fcQWindow_mapToGlobalWithPos(self.h, pos.h))

proc mapFromGlobal*(self: gen_qwindow_types.QWindow, pos: QPoint): QPoint =
  QPoint(h: fcQWindow_mapFromGlobalWithPos(self.h, pos.h))

proc cursor*(self: gen_qwindow_types.QWindow, ): QCursor =
  QCursor(h: fcQWindow_cursor(self.h))

proc setCursor*(self: gen_qwindow_types.QWindow, cursor: QCursor): void =
  fcQWindow_setCursor(self.h, cursor.h)

proc unsetCursor*(self: gen_qwindow_types.QWindow, ): void =
  fcQWindow_unsetCursor(self.h)

proc fromWinId*(_: type gen_qwindow_types.QWindow, id: uint): QWindow =
...
proc setGeometry*(self: gen_qwindow_types.QWindow, rect: QRect): void =
...
proc screenChanged*(self: gen_qwindow_types.QWindow, screen: QScreen): void =
  fcQWindow_screenChanged(self.h, screen.h)

type QWindowscreenChangedSlot* = proc(screen: QScreen)
...
proc focusObjectChanged*(self: gen_qwindow_types.QWindow, objectVal: QObject): void =
  fcQWindow_focusObjectChanged(self.h, objectVal.h)

type QWindowfocusObjectChangedSlot* = proc(objectVal: QObject)
...
proc transientParentChanged*(self: gen_qwindow_types.QWindow, transientParent: QWindow): void =
  fcQWindow_transientParentChanged(self.h, transientParent.h)

type QWindowtransientParentChangedSlot* = proc(transientParent: QWindow)
...
proc parent*(self: gen_qwindow_types.QWindow, mode: cint): QWindow =
  QWindow(h: fcQWindow_parent1(self.h, cint(mode)))

proc setFlag*(self: gen_qwindow_types.QWindow, param1: cint, on: bool): void =
  fcQWindow_setFlag2(self.h, cint(param1), on)

proc isAncestorOf*(self: gen_qwindow_types.QWindow, child: QWindow, mode: cint): bool =
...
proc miqt_exec_callback_QWindow_surfaceType(self: ptr cQWindow, slot: int): cint {.exportc: "miqt_exec_callback_QWindow_surfaceType ".} =
  ...
  cint(virtualReturn)
proc QWindowformat*(self: gen_qwindow_types.QWindow, ): QSurfaceFormat =
  QSurfaceFormat(h: fQWindow_virtualbase_format(self.h))

type QWindowformatProc* = proc(): QSurfaceFormat
...
proc miqt_exec_callback_QWindow_format(self: ptr cQWindow, slot: int): pointer {.exportc: "miqt_exec_callback_QWindow_format ".} =
  ...
  virtualReturn.h
proc QWindowsize*(self: gen_qwindow_types.QWindow, ): QSize =
  QSize(h: fQWindow_virtualbase_size(self.h))

type QWindowsizeProc* = proc(): QSize
...
proc miqt_exec_callback_QWindow_size(self: ptr cQWindow, slot: int): pointer {.exportc: "miqt_exec_callback_QWindow_size ".} =
  ...
  virtualReturn.h
proc QWindowaccessibleRoot*(self: gen_qwindow_types.QWindow, ): QAccessibleInterface =
  QAccessibleInterface(h: fQWindow_virtualbase_accessibleRoot(self.h))

type QWindowaccessibleRootProc* = proc(): QAccessibleInterface
...
proc miqt_exec_callback_QWindow_accessibleRoot(self: ptr cQWindow, slot: int): pointer {.exportc: "miqt_exec_callback_QWindow_accessibleRoot ".} =
  ...
  virtualReturn.h
proc QWindowfocusObject*(self: gen_qwindow_types.QWindow, ): QObject =
  QObject(h: fQWindow_virtualbase_focusObject(self.h))

type QWindowfocusObjectProc* = proc(): QObject
...
proc miqt_exec_callback_QWindow_focusObject(self: ptr cQWindow, slot: int): pointer {.exportc: "miqt_exec_callback_QWindow_focusObject ".} =
  ...
  virtualReturn.h
proc QWindowexposeEvent*(self: gen_qwindow_types.QWindow, param1: QExposeEvent): void =
  fQWindow_virtualbase_exposeEvent(self.h, param1.h)

type QWindowexposeEventProc* = proc(param1: QExposeEvent): void
...
proc miqt_exec_callback_QWindow_exposeEvent(self: ptr cQWindow, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QWindow_exposeEvent ".} =
  ...
  let slotval1 = QExposeEvent(h: param1)


  nimfunc[](slotval1)
proc QWindowresizeEvent*(self: gen_qwindow_types.QWindow, param1: QResizeEvent): void =
  fQWindow_virtualbase_resizeEvent(self.h, param1.h)

type QWindowresizeEventProc* = proc(param1: QResizeEvent): void
...
proc miqt_exec_callback_QWindow_resizeEvent(self: ptr cQWindow, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QWindow_resizeEvent ".} =
  ...
  nimfunc[](slotval1)
proc QWindowpaintEvent*(self: gen_qwindow_types.QWindow, param1: QPaintEvent): void =
  fQWindow_virtualbase_paintEvent(self.h, param1.h)

type QWindowpaintEventProc* = proc(param1: QPaintEvent): void
proc onpaintEvent*(self: gen_qwindow_types.QWindow, slot: QWindowpaintEventProc) =
  # TODO check subclass
  var tmp = new QWindowpaintEventProc
  tmp[] = slot
  GC_ref(tmp)
  fcQWindow_override_virtual_paintEvent(self.h, cast[int](addr tmp[]))

proc miqt_exec_callback_QWindow_paintEvent(self: ptr cQWindow, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QWindow_paintEvent ".} =
  var nimfunc = cast[ptr QWindowpaintEventProc](cast[pointer](slot))
  let slotval1 = QPaintEvent(h: param1)


  nimfunc[](slotval1)
proc QWindowmoveEvent*(self: gen_qwindow_types.QWindow, param1: QMoveEvent): void =
  fQWindow_virtualbase_moveEvent(self.h, param1.h)

type QWindowmoveEventProc* = proc(param1: QMoveEvent): void
...
proc miqt_exec_callback_QWindow_moveEvent(self: ptr cQWindow, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QWindow_moveEvent ".} =
  ...
  let slotval1 = QMoveEvent(h: param1)


  nimfunc[](slotval1)
proc QWindowfocusInEvent*(self: gen_qwindow_types.QWindow, param1: QFocusEvent): void =
  fQWindow_virtualbase_focusInEvent(self.h, param1.h)

type QWindowfocusInEventProc* = proc(param1: QFocusEvent): void
...
proc miqt_exec_callback_QWindow_focusInEvent(self: ptr cQWindow, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QWindow_focusInEvent ".} =
  ...
  nimfunc[](slotval1)
proc QWindowfocusOutEvent*(self: gen_qwindow_types.QWindow, param1: QFocusEvent): void =
  fQWindow_virtualbase_focusOutEvent(self.h, param1.h)

type QWindowfocusOutEventProc* = proc(param1: QFocusEvent): void
...
proc miqt_exec_callback_QWindow_focusOutEvent(self: ptr cQWindow, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QWindow_focusOutEvent ".} =
  ...
  nimfunc[](slotval1)
proc QWindowshowEvent*(self: gen_qwindow_types.QWindow, param1: QShowEvent): void =
  fQWindow_virtualbase_showEvent(self.h, param1.h)

type QWindowshowEventProc* = proc(param1: QShowEvent): void
...
proc miqt_exec_callback_QWindow_showEvent(self: ptr cQWindow, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QWindow_showEvent ".} =
  ...
  nimfunc[](slotval1)
proc QWindowhideEvent*(self: gen_qwindow_types.QWindow, param1: QHideEvent): void =
  fQWindow_virtualbase_hideEvent(self.h, param1.h)

type QWindowhideEventProc* = proc(param1: QHideEvent): void
...
proc miqt_exec_callback_QWindow_hideEvent(self: ptr cQWindow, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QWindow_hideEvent ".} =
  ...
  nimfunc[](slotval1)
proc QWindowcloseEvent*(self: gen_qwindow_types.QWindow, param1: QCloseEvent): void =
  fQWindow_virtualbase_closeEvent(self.h, param1.h)

type QWindowcloseEventProc* = proc(param1: QCloseEvent): void
proc oncloseEvent*(self: gen_qwindow_types.QWindow, slot: QWindowcloseEventProc) =
  # TODO check subclass
  var tmp = new QWindowcloseEventProc
  tmp[] = slot
  GC_ref(tmp)
  fcQWindow_override_virtual_closeEvent(self.h, cast[int](addr tmp[]))

proc miqt_exec_callback_QWindow_closeEvent(self: ptr cQWindow, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QWindow_closeEvent ".} =
  var nimfunc = cast[ptr QWindowcloseEventProc](cast[pointer](slot))
  let slotval1 = QCloseEvent(h: param1)


  nimfunc[](slotval1)
proc QWindowevent*(self: gen_qwindow_types.QWindow, param1: QEvent): bool =
  fQWindow_virtualbase_event(self.h, param1.h)

type QWindoweventProc* = proc(param1: QEvent): bool
...
proc miqt_exec_callback_QWindow_event(self: ptr cQWindow, slot: int, param1: pointer): bool {.exportc: "miqt_exec_callback_QWindow_event ".} =
  ...
  virtualReturn
proc QWindowkeyPressEvent*(self: gen_qwindow_types.QWindow, param1: QKeyEvent): void =
  fQWindow_virtualbase_keyPressEvent(self.h, param1.h)

type QWindowkeyPressEventProc* = proc(param1: QKeyEvent): void
...
proc miqt_exec_callback_QWindow_keyPressEvent(self: ptr cQWindow, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QWindow_keyPressEvent ".} =
  ...
  nimfunc[](slotval1)
proc QWindowkeyReleaseEvent*(self: gen_qwindow_types.QWindow, param1: QKeyEvent): void =
  fQWindow_virtualbase_keyReleaseEvent(self.h, param1.h)

type QWindowkeyReleaseEventProc* = proc(param1: QKeyEvent): void
...
proc miqt_exec_callback_QWindow_keyReleaseEvent(self: ptr cQWindow, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QWindow_keyReleaseEvent ".} =
  ...
  nimfunc[](slotval1)
proc QWindowmousePressEvent*(self: gen_qwindow_types.QWindow, param1: QMouseEvent): void =
  fQWindow_virtualbase_mousePressEvent(self.h, param1.h)

type QWindowmousePressEventProc* = proc(param1: QMouseEvent): void
...
proc miqt_exec_callback_QWindow_mousePressEvent(self: ptr cQWindow, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QWindow_mousePressEvent ".} =
  ...
  nimfunc[](slotval1)
proc QWindowmouseReleaseEvent*(self: gen_qwindow_types.QWindow, param1: QMouseEvent): void =
  fQWindow_virtualbase_mouseReleaseEvent(self.h, param1.h)

type QWindowmouseReleaseEventProc* = proc(param1: QMouseEvent): void
...
proc miqt_exec_callback_QWindow_mouseReleaseEvent(self: ptr cQWindow, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QWindow_mouseReleaseEvent ".} =
  ...
  nimfunc[](slotval1)
proc QWindowmouseDoubleClickEvent*(self: gen_qwindow_types.QWindow, param1: QMouseEvent): void =
  fQWindow_virtualbase_mouseDoubleClickEvent(self.h, param1.h)

type QWindowmouseDoubleClickEventProc* = proc(param1: QMouseEvent): void
...
proc miqt_exec_callback_QWindow_mouseDoubleClickEvent(self: ptr cQWindow, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QWindow_mouseDoubleClickEvent ".} =
  ...
  nimfunc[](slotval1)
proc QWindowmouseMoveEvent*(self: gen_qwindow_types.QWindow, param1: QMouseEvent): void =
  fQWindow_virtualbase_mouseMoveEvent(self.h, param1.h)

type QWindowmouseMoveEventProc* = proc(param1: QMouseEvent): void
...
proc miqt_exec_callback_QWindow_mouseMoveEvent(self: ptr cQWindow, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QWindow_mouseMoveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QWindowwheelEvent*(self: gen_qwindow_types.QWindow, param1: QWheelEvent): void =
  fQWindow_virtualbase_wheelEvent(self.h, param1.h)

type QWindowwheelEventProc* = proc(param1: QWheelEvent): void
...
proc miqt_exec_callback_QWindow_wheelEvent(self: ptr cQWindow, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QWindow_wheelEvent ".} =
  ...
  nimfunc[](slotval1)
proc QWindowtouchEvent*(self: gen_qwindow_types.QWindow, param1: QTouchEvent): void =
  fQWindow_virtualbase_touchEvent(self.h, param1.h)

type QWindowtouchEventProc* = proc(param1: QTouchEvent): void
...
proc miqt_exec_callback_QWindow_touchEvent(self: ptr cQWindow, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QWindow_touchEvent ".} =
  ...
  let slotval1 = QTouchEvent(h: param1)


  nimfunc[](slotval1)
proc QWindowtabletEvent*(self: gen_qwindow_types.QWindow, param1: QTabletEvent): void =
  fQWindow_virtualbase_tabletEvent(self.h, param1.h)

type QWindowtabletEventProc* = proc(param1: QTabletEvent): void
...
proc miqt_exec_callback_QWindow_tabletEvent(self: ptr cQWindow, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QWindow_tabletEvent ".} =
  ...
  let slotval1 = QTabletEvent(h: param1)
...
type QWindownativeEventProc* = proc(eventType: seq[byte], message: pointer, resultVal: ptr uint): bool
...
proc miqt_exec_callback_QWindow_nativeEvent(self: ptr cQWindow, slot: int, eventType: struct_miqt_string, message: pointer, resultVal: ptr uint): bool {.exportc: "miqt_exec_callback_QWindow_nativeEvent ".} =
  ...
  virtualReturn
proc QWindoweventFilter*(self: gen_qwindow_types.QWindow, watched: QObject, event: QEvent): bool =
  fQWindow_virtualbase_eventFilter(self.h, watched.h, event.h)

type QWindoweventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QWindow_eventFilter(self: ptr cQWindow, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QWindow_eventFilter ".} =
  ...
  virtualReturn
proc QWindowtimerEvent*(self: gen_qwindow_types.QWindow, event: QTimerEvent): void =
  fQWindow_virtualbase_timerEvent(self.h, event.h)

type QWindowtimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QWindow_timerEvent(self: ptr cQWindow, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QWindow_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QWindowchildEvent*(self: gen_qwindow_types.QWindow, event: QChildEvent): void =
  fQWindow_virtualbase_childEvent(self.h, event.h)

type QWindowchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QWindow_childEvent(self: ptr cQWindow, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QWindow_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QWindowcustomEvent*(self: gen_qwindow_types.QWindow, event: QEvent): void =
  fQWindow_virtualbase_customEvent(self.h, event.h)

type QWindowcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QWindow_customEvent(self: ptr cQWindow, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QWindow_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QWindowconnectNotify*(self: gen_qwindow_types.QWindow, signal: QMetaMethod): void =
  fQWindow_virtualbase_connectNotify(self.h, signal.h)

type QWindowconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QWindow_connectNotify(self: ptr cQWindow, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QWindow_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QWindowdisconnectNotify*(self: gen_qwindow_types.QWindow, signal: QMetaMethod): void =
  fQWindow_virtualbase_disconnectNotify(self.h, signal.h)

type QWindowdisconnectNotifyProc* = proc(signal: QMetaMethod): void
