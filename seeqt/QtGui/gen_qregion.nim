...
proc create*(T: type gen_qregion_types.QRegion, r: QRect): gen_qregion_types.QRegion =
  gen_qregion_types.QRegion.init(fcQRegion_new3(r.h))

proc create*(T: type gen_qregion_types.QRegion, region: QRegion): gen_qregion_types.QRegion =
  gen_qregion_types.QRegion.init(fcQRegion_new4(region.h))

proc create*(T: type gen_qregion_types.QRegion, bitmap: QBitmap): gen_qregion_types.QRegion =
...
proc create*(T: type gen_qregion_types.QRegion, r: QRect, t: cint): gen_qregion_types.QRegion =
  gen_qregion_types.QRegion.init(fcQRegion_new7(r.h, cint(t)))

proc operatorAssign*(self: gen_qregion_types.QRegion, param1: QRegion): void =
  fcQRegion_operatorAssign(self.h, param1.h)

proc swap*(self: gen_qregion_types.QRegion, other: QRegion): void =
...
proc begin*(self: gen_qregion_types.QRegion, ): QRect =
  QRect(h: fcQRegion_begin(self.h))

proc cbegin*(self: gen_qregion_types.QRegion, ): QRect =
  QRect(h: fcQRegion_cbegin(self.h))

proc endX*(self: gen_qregion_types.QRegion, ): QRect =
  QRect(h: fcQRegion_endX(self.h))

proc cend*(self: gen_qregion_types.QRegion, ): QRect =
  QRect(h: fcQRegion_cend(self.h))

proc contains*(self: gen_qregion_types.QRegion, p: QPoint): bool =
  fcQRegion_contains(self.h, p.h)

proc contains*(self: gen_qregion_types.QRegion, r: QRect): bool =
...
proc translate*(self: gen_qregion_types.QRegion, p: QPoint): void =
  fcQRegion_translateWithQPoint(self.h, p.h)

proc translated*(self: gen_qregion_types.QRegion, dx: cint, dy: cint): QRegion =
  QRegion(h: fcQRegion_translated(self.h, dx, dy))

proc translated*(self: gen_qregion_types.QRegion, p: QPoint): QRegion =
  QRegion(h: fcQRegion_translatedWithQPoint(self.h, p.h))

proc united*(self: gen_qregion_types.QRegion, r: QRegion): QRegion =
  QRegion(h: fcQRegion_united(self.h, r.h))

proc united*(self: gen_qregion_types.QRegion, r: QRect): QRegion =
  QRegion(h: fcQRegion_unitedWithQRect(self.h, r.h))

proc intersected*(self: gen_qregion_types.QRegion, r: QRegion): QRegion =
  QRegion(h: fcQRegion_intersected(self.h, r.h))

proc intersected*(self: gen_qregion_types.QRegion, r: QRect): QRegion =
  QRegion(h: fcQRegion_intersectedWithQRect(self.h, r.h))

proc subtracted*(self: gen_qregion_types.QRegion, r: QRegion): QRegion =
  QRegion(h: fcQRegion_subtracted(self.h, r.h))

proc xored*(self: gen_qregion_types.QRegion, r: QRegion): QRegion =
  QRegion(h: fcQRegion_xored(self.h, r.h))

proc intersects*(self: gen_qregion_types.QRegion, r: QRegion): bool =
  fcQRegion_intersects(self.h, r.h)

proc intersects*(self: gen_qregion_types.QRegion, r: QRect): bool =
  fcQRegion_intersectsWithQRect(self.h, r.h)

proc boundingRect*(self: gen_qregion_types.QRegion, ): QRect =
  QRect(h: fcQRegion_boundingRect(self.h))

proc rects*(self: gen_qregion_types.QRegion, ): seq[QRect] =
  var v_ma = fcQRegion_rects(self.h)
  var vx_ret = newSeq[QRect](int(v_ma.len))
  let v_outCast = cast[ptr UncheckedArray[pointer]](v_ma.data)
  for i in 0 ..< v_ma.len:
    vx_ret[i] = QRect(h: v_outCast[i])
  vx_ret

proc setRects*(self: gen_qregion_types.QRegion, rect: QRect, num: cint): void =
  fcQRegion_setRects(self.h, rect.h, num)

proc rectCount*(self: gen_qregion_types.QRegion, ): cint =
  fcQRegion_rectCount(self.h)

proc operatorBitwiseOr*(self: gen_qregion_types.QRegion, r: QRegion): QRegion =
  QRegion(h: fcQRegion_operatorBitwiseOr(self.h, r.h))

proc operatorPlus*(self: gen_qregion_types.QRegion, r: QRegion): QRegion =
  QRegion(h: fcQRegion_operatorPlus(self.h, r.h))

proc operatorPlus*(self: gen_qregion_types.QRegion, r: QRect): QRegion =
  QRegion(h: fcQRegion_operatorPlusWithQRect(self.h, r.h))

proc operatorBitwiseAnd*(self: gen_qregion_types.QRegion, r: QRegion): QRegion =
  QRegion(h: fcQRegion_operatorBitwiseAnd(self.h, r.h))

proc operatorBitwiseAnd*(self: gen_qregion_types.QRegion, r: QRect): QRegion =
  QRegion(h: fcQRegion_operatorBitwiseAndWithQRect(self.h, r.h))

proc operatorMinus*(self: gen_qregion_types.QRegion, r: QRegion): QRegion =
  QRegion(h: fcQRegion_operatorMinus(self.h, r.h))

proc operatorBitwiseNot*(self: gen_qregion_types.QRegion, r: QRegion): QRegion =
  QRegion(h: fcQRegion_operatorBitwiseNot(self.h, r.h))

proc operatorBitwiseOrAssign*(self: gen_qregion_types.QRegion, r: QRegion): void =
  fcQRegion_operatorBitwiseOrAssign(self.h, r.h)

proc operatorPlusAssign*(self: gen_qregion_types.QRegion, r: QRegion): QRegion =
  QRegion(h: fcQRegion_operatorPlusAssign(self.h, r.h))

proc operatorPlusAssign*(self: gen_qregion_types.QRegion, r: QRect): QRegion =
  QRegion(h: fcQRegion_operatorPlusAssignWithQRect(self.h, r.h))

proc operatorBitwiseAndAssign*(self: gen_qregion_types.QRegion, r: QRegion): void =
  fcQRegion_operatorBitwiseAndAssign(self.h, r.h)

proc operatorBitwiseAndAssign*(self: gen_qregion_types.QRegion, r: QRect): void =
  fcQRegion_operatorBitwiseAndAssignWithQRect(self.h, r.h)

proc operatorMinusAssign*(self: gen_qregion_types.QRegion, r: QRegion): QRegion =
  QRegion(h: fcQRegion_operatorMinusAssign(self.h, r.h))

proc operatorBitwiseNotAssign*(self: gen_qregion_types.QRegion, r: QRegion): void =
  fcQRegion_operatorBitwiseNotAssign(self.h, r.h)

proc operatorEqual*(self: gen_qregion_types.QRegion, r: QRegion): bool =
  fcQRegion_operatorEqual(self.h, r.h)

proc operatorNotEqual*(self: gen_qregion_types.QRegion, r: QRegion): bool =
  fcQRegion_operatorNotEqual(self.h, r.h)

proc ToQVariant*(self: gen_qregion_types.QRegion, ): QVariant =
  QVariant(h: fcQRegion_ToQVariant(self.h))
