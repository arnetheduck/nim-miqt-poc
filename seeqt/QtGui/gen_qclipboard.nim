...
func init*(T: type gen_qclipboard_types.QClipboard, h: ptr cQClipboard): gen_qclipboard_types.QClipboard =
  T(h: h)
proc metaObject*(self: gen_qclipboard_types.QClipboard, ): QMetaObject =
  QMetaObject(h: fcQClipboard_metaObject(self.h))
...
proc mimeData*(self: gen_qclipboard_types.QClipboard, ): QMimeData =
  QMimeData(h: fcQClipboard_mimeData(self.h))

proc setMimeData*(self: gen_qclipboard_types.QClipboard, data: QMimeData): void =
  fcQClipboard_setMimeData(self.h, data.h)

proc image*(self: gen_qclipboard_types.QClipboard, ): QImage =
  QImage(h: fcQClipboard_image(self.h))

proc pixmap*(self: gen_qclipboard_types.QClipboard, ): QPixmap =
  QPixmap(h: fcQClipboard_pixmap(self.h))

proc setImage*(self: gen_qclipboard_types.QClipboard, param1: QImage): void =
  fcQClipboard_setImage(self.h, param1.h)

proc setPixmap*(self: gen_qclipboard_types.QClipboard, param1: QPixmap): void =
...
proc mimeData*(self: gen_qclipboard_types.QClipboard, mode: cint): QMimeData =
  QMimeData(h: fcQClipboard_mimeData1(self.h, cint(mode)))

proc setMimeData*(self: gen_qclipboard_types.QClipboard, data: QMimeData, mode: cint): void =
  fcQClipboard_setMimeData2(self.h, data.h, cint(mode))

proc image*(self: gen_qclipboard_types.QClipboard, mode: cint): QImage =
  QImage(h: fcQClipboard_image1(self.h, cint(mode)))

proc pixmap*(self: gen_qclipboard_types.QClipboard, mode: cint): QPixmap =
  QPixmap(h: fcQClipboard_pixmap1(self.h, cint(mode)))

proc setImage*(self: gen_qclipboard_types.QClipboard, param1: QImage, mode: cint): void =
  fcQClipboard_setImage2(self.h, param1.h, cint(mode))

proc setPixmap*(self: gen_qclipboard_types.QClipboard, param1: QPixmap, mode: cint): void =
