...
proc create*(T: type gen_qpen_types.QPen, color: QColor): gen_qpen_types.QPen =
  gen_qpen_types.QPen.init(fcQPen_new3(color.h))

proc create*(T: type gen_qpen_types.QPen, brush: QBrush, width: float64): gen_qpen_types.QPen =
  gen_qpen_types.QPen.init(fcQPen_new4(brush.h, width))

proc create*(T: type gen_qpen_types.QPen, pen: QPen): gen_qpen_types.QPen =
  gen_qpen_types.QPen.init(fcQPen_new5(pen.h))

proc create*(T: type gen_qpen_types.QPen, brush: QBrush, width: float64, s: cint): gen_qpen_types.QPen =
  gen_qpen_types.QPen.init(fcQPen_new6(brush.h, width, cint(s)))

proc create*(T: type gen_qpen_types.QPen, brush: QBrush, width: float64, s: cint, c: cint): gen_qpen_types.QPen =
  gen_qpen_types.QPen.init(fcQPen_new7(brush.h, width, cint(s), cint(c)))

proc create*(T: type gen_qpen_types.QPen, brush: QBrush, width: float64, s: cint, c: cint, j: cint): gen_qpen_types.QPen =
  gen_qpen_types.QPen.init(fcQPen_new8(brush.h, width, cint(s), cint(c), cint(j)))

proc operatorAssign*(self: gen_qpen_types.QPen, pen: QPen): void =
  fcQPen_operatorAssign(self.h, pen.h)

proc swap*(self: gen_qpen_types.QPen, other: QPen): void =
...
proc color*(self: gen_qpen_types.QPen, ): QColor =
  QColor(h: fcQPen_color(self.h))

proc setColor*(self: gen_qpen_types.QPen, color: QColor): void =
  fcQPen_setColor(self.h, color.h)

proc brush*(self: gen_qpen_types.QPen, ): QBrush =
  QBrush(h: fcQPen_brush(self.h))

proc setBrush*(self: gen_qpen_types.QPen, brush: QBrush): void =
...
proc operatorEqual*(self: gen_qpen_types.QPen, p: QPen): bool =
  fcQPen_operatorEqual(self.h, p.h)

proc operatorNotEqual*(self: gen_qpen_types.QPen, p: QPen): bool =
  fcQPen_operatorNotEqual(self.h, p.h)

proc ToQVariant*(self: gen_qpen_types.QPen, ): QVariant =
  QVariant(h: fcQPen_ToQVariant(self.h))
