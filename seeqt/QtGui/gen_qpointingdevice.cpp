...
QMetaObject* QPointingDevice_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQPointingDevice*)(self) )->QPointingDevice::metaObject();

}

void* QPointingDevice_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQPointingDevice*)(self) )->QPointingDevice::qt_metacast(param1);

}

int QPointingDevice_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQPointingDevice*)(self) )->QPointingDevice::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
