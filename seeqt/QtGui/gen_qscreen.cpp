...
void QScreen_connect_geometryChanged(QScreen* self, intptr_t slot, void (*callback)(intptr_t, QRect*), void (*release)(intptr_t)) {
	...
	QScreen::connect(self, static_cast<void (QScreen::*)(const QRect&)>(&QScreen::geometryChanged), self, caller{slot, callback, release});
}
...
void QScreen_connect_availableGeometryChanged(QScreen* self, intptr_t slot, void (*callback)(intptr_t, QRect*), void (*release)(intptr_t)) {
	...
	QScreen::connect(self, static_cast<void (QScreen::*)(const QRect&)>(&QScreen::availableGeometryChanged), self, caller{slot, callback, release});
}
...
void QScreen_connect_physicalSizeChanged(QScreen* self, intptr_t slot, void (*callback)(intptr_t, QSizeF*), void (*release)(intptr_t)) {
	...
	QScreen::connect(self, static_cast<void (QScreen::*)(const QSizeF&)>(&QScreen::physicalSizeChanged), self, caller{slot, callback, release});
}
...
void QScreen_connect_physicalDotsPerInchChanged(QScreen* self, intptr_t slot, void (*callback)(intptr_t, double), void (*release)(intptr_t)) {
	...
	QScreen::connect(self, static_cast<void (QScreen::*)(qreal)>(&QScreen::physicalDotsPerInchChanged), self, caller{slot, callback, release});
}
...
void QScreen_connect_logicalDotsPerInchChanged(QScreen* self, intptr_t slot, void (*callback)(intptr_t, double), void (*release)(intptr_t)) {
	...
	QScreen::connect(self, static_cast<void (QScreen::*)(qreal)>(&QScreen::logicalDotsPerInchChanged), self, caller{slot, callback, release});
}
...
void QScreen_connect_virtualGeometryChanged(QScreen* self, intptr_t slot, void (*callback)(intptr_t, QRect*), void (*release)(intptr_t)) {
	...
	QScreen::connect(self, static_cast<void (QScreen::*)(const QRect&)>(&QScreen::virtualGeometryChanged), self, caller{slot, callback, release});
}
...
void QScreen_connect_primaryOrientationChanged(QScreen* self, intptr_t slot, void (*callback)(intptr_t, int), void (*release)(intptr_t)) {
	...
	QScreen::connect(self, static_cast<void (QScreen::*)(Qt::ScreenOrientation)>(&QScreen::primaryOrientationChanged), self, caller{slot, callback, release});
}
...
void QScreen_connect_orientationChanged(QScreen* self, intptr_t slot, void (*callback)(intptr_t, int), void (*release)(intptr_t)) {
	...
	QScreen::connect(self, static_cast<void (QScreen::*)(Qt::ScreenOrientation)>(&QScreen::orientationChanged), self, caller{slot, callback, release});
}
...
void QScreen_connect_refreshRateChanged(QScreen* self, intptr_t slot, void (*callback)(intptr_t, double), void (*release)(intptr_t)) {
	...
	QScreen::connect(self, static_cast<void (QScreen::*)(qreal)>(&QScreen::refreshRateChanged), self, caller{slot, callback, release});
}
