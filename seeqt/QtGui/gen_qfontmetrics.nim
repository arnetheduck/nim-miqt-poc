...
proc fcQFontMetrics_horizontalAdvance2(self: pointer, param1: struct_miqt_string, textOption: pointer): cint {.importc: "QFontMetrics_horizontalAdvance2".}
...
proc fcQFontMetrics_boundingRect2(self: pointer, text: struct_miqt_string, textOption: pointer): pointer {.importc: "QFontMetrics_boundingRect2".}
proc fcQFontMetrics_boundingRect3(self: pointer, r: pointer, flags: cint, text: struct_miqt_string): pointer {.importc: "QFontMetrics_boundingRect3".}
proc fcQFontMetrics_boundingRect4(self: pointer, x: cint, y: cint, w: cint, h: cint, flags: cint, text: struct_miqt_string): pointer {.importc: "QFontMetrics_boundingRect4".}
...
proc fcQFontMetrics_boundingRect42(self: pointer, r: pointer, flags: cint, text: struct_miqt_string, tabstops: cint): pointer {.importc: "QFontMetrics_boundingRect42".}
...
proc fcQFontMetricsF_horizontalAdvance2(self: pointer, string: struct_miqt_string, textOption: pointer): float64 {.importc: "QFontMetricsF_horizontalAdvance2".}
proc fcQFontMetricsF_boundingRect(self: pointer, string: struct_miqt_string): pointer {.importc: "QFontMetricsF_boundingRect".}
proc fcQFontMetricsF_boundingRect2(self: pointer, text: struct_miqt_string, textOption: pointer): pointer {.importc: "QFontMetricsF_boundingRect2".}
...
proc fcQFontMetricsF_boundingRect3(self: pointer, r: pointer, flags: cint, string: struct_miqt_string): pointer {.importc: "QFontMetricsF_boundingRect3".}
...
func init*(T: type gen_qfontmetrics_types.QFontMetrics, h: ptr cQFontMetrics): gen_qfontmetrics_types.QFontMetrics =
  T(h: h)
proc create*(T: type gen_qfontmetrics_types.QFontMetrics, param1: QFont): gen_qfontmetrics_types.QFontMetrics =
  gen_qfontmetrics_types.QFontMetrics.init(fcQFontMetrics_new(param1.h))

proc create*(T: type gen_qfontmetrics_types.QFontMetrics, font: QFont, pd: QPaintDevice): gen_qfontmetrics_types.QFontMetrics =
  gen_qfontmetrics_types.QFontMetrics.init(fcQFontMetrics_new2(font.h, pd.h))

proc create*(T: type gen_qfontmetrics_types.QFontMetrics, param1: QFontMetrics): gen_qfontmetrics_types.QFontMetrics =
  gen_qfontmetrics_types.QFontMetrics.init(fcQFontMetrics_new3(param1.h))

proc operatorAssign*(self: gen_qfontmetrics_types.QFontMetrics, param1: QFontMetrics): void =
  fcQFontMetrics_operatorAssign(self.h, param1.h)

proc swap*(self: gen_qfontmetrics_types.QFontMetrics, other: QFontMetrics): void =
...
proc inFont*(self: gen_qfontmetrics_types.QFontMetrics, param1: QChar): bool =
...
proc leftBearing*(self: gen_qfontmetrics_types.QFontMetrics, param1: QChar): cint =
  fcQFontMetrics_leftBearing(self.h, param1.h)

proc rightBearing*(self: gen_qfontmetrics_types.QFontMetrics, param1: QChar): cint =
...
proc horizontalAdvance*(self: gen_qfontmetrics_types.QFontMetrics, param1: string, textOption: QTextOption): cint =
  fcQFontMetrics_horizontalAdvance2(self.h, struct_miqt_string(data: param1, len: csize_t(len(param1))), textOption.h)

proc horizontalAdvance*(self: gen_qfontmetrics_types.QFontMetrics, param1: QChar): cint =
  fcQFontMetrics_horizontalAdvanceWithQChar(self.h, param1.h)

proc boundingRect*(self: gen_qfontmetrics_types.QFontMetrics, param1: QChar): QRect =
  QRect(h: fcQFontMetrics_boundingRect(self.h, param1.h))

proc boundingRect*(self: gen_qfontmetrics_types.QFontMetrics, text: string): QRect =
  QRect(h: fcQFontMetrics_boundingRectWithText(self.h, struct_miqt_string(data: text, len: csize_t(len(text)))))

proc boundingRect*(self: gen_qfontmetrics_types.QFontMetrics, text: string, textOption: QTextOption): QRect =
  QRect(h: fcQFontMetrics_boundingRect2(self.h, struct_miqt_string(data: text, len: csize_t(len(text))), textOption.h))

proc boundingRect*(self: gen_qfontmetrics_types.QFontMetrics, r: QRect, flags: cint, text: string): QRect =
  QRect(h: fcQFontMetrics_boundingRect3(self.h, r.h, flags, struct_miqt_string(data: text, len: csize_t(len(text)))))

proc boundingRect*(self: gen_qfontmetrics_types.QFontMetrics, x: cint, y: cint, w: cint, h: cint, flags: cint, text: string): QRect =
  QRect(h: fcQFontMetrics_boundingRect4(self.h, x, y, w, h, flags, struct_miqt_string(data: text, len: csize_t(len(text)))))

proc size*(self: gen_qfontmetrics_types.QFontMetrics, flags: cint, str: string): QSize =
  QSize(h: fcQFontMetrics_size(self.h, flags, struct_miqt_string(data: str, len: csize_t(len(str)))))

proc tightBoundingRect*(self: gen_qfontmetrics_types.QFontMetrics, text: string): QRect =
  QRect(h: fcQFontMetrics_tightBoundingRect(self.h, struct_miqt_string(data: text, len: csize_t(len(text)))))

proc tightBoundingRect*(self: gen_qfontmetrics_types.QFontMetrics, text: string, textOption: QTextOption): QRect =
  QRect(h: fcQFontMetrics_tightBoundingRect2(self.h, struct_miqt_string(data: text, len: csize_t(len(text))), textOption.h))
...
proc operatorEqual*(self: gen_qfontmetrics_types.QFontMetrics, other: QFontMetrics): bool =
  fcQFontMetrics_operatorEqual(self.h, other.h)

proc operatorNotEqual*(self: gen_qfontmetrics_types.QFontMetrics, other: QFontMetrics): bool =
...
proc horizontalAdvance*(self: gen_qfontmetrics_types.QFontMetrics, param1: string, len: cint): cint =
  fcQFontMetrics_horizontalAdvance22(self.h, struct_miqt_string(data: param1, len: csize_t(len(param1))), len)

proc boundingRect*(self: gen_qfontmetrics_types.QFontMetrics, r: QRect, flags: cint, text: string, tabstops: cint): QRect =
  QRect(h: fcQFontMetrics_boundingRect42(self.h, r.h, flags, struct_miqt_string(data: text, len: csize_t(len(text))), tabstops))

proc boundingRect*(self: gen_qfontmetrics_types.QFontMetrics, r: QRect, flags: cint, text: string, tabstops: cint, tabarray: ptr cint): QRect =
  QRect(h: fcQFontMetrics_boundingRect5(self.h, r.h, flags, struct_miqt_string(data: text, len: csize_t(len(text))), tabstops, tabarray))

proc boundingRect*(self: gen_qfontmetrics_types.QFontMetrics, x: cint, y: cint, w: cint, h: cint, flags: cint, text: string, tabstops: cint): QRect =
  QRect(h: fcQFontMetrics_boundingRect7(self.h, x, y, w, h, flags, struct_miqt_string(data: text, len: csize_t(len(text))), tabstops))

proc boundingRect*(self: gen_qfontmetrics_types.QFontMetrics, x: cint, y: cint, w: cint, h: cint, flags: cint, text: string, tabstops: cint, tabarray: ptr cint): QRect =
  QRect(h: fcQFontMetrics_boundingRect8(self.h, x, y, w, h, flags, struct_miqt_string(data: text, len: csize_t(len(text))), tabstops, tabarray))

proc size*(self: gen_qfontmetrics_types.QFontMetrics, flags: cint, str: string, tabstops: cint): QSize =
  QSize(h: fcQFontMetrics_size3(self.h, flags, struct_miqt_string(data: str, len: csize_t(len(str))), tabstops))

proc size*(self: gen_qfontmetrics_types.QFontMetrics, flags: cint, str: string, tabstops: cint, tabarray: ptr cint): QSize =
  QSize(h: fcQFontMetrics_size4(self.h, flags, struct_miqt_string(data: str, len: csize_t(len(str))), tabstops, tabarray))
...
func init*(T: type gen_qfontmetrics_types.QFontMetricsF, h: ptr cQFontMetricsF): gen_qfontmetrics_types.QFontMetricsF =
  T(h: h)
proc create*(T: type gen_qfontmetrics_types.QFontMetricsF, font: QFont): gen_qfontmetrics_types.QFontMetricsF =
  gen_qfontmetrics_types.QFontMetricsF.init(fcQFontMetricsF_new(font.h))

proc create*(T: type gen_qfontmetrics_types.QFontMetricsF, font: QFont, pd: QPaintDevice): gen_qfontmetrics_types.QFontMetricsF =
  gen_qfontmetrics_types.QFontMetricsF.init(fcQFontMetricsF_new2(font.h, pd.h))

proc create*(T: type gen_qfontmetrics_types.QFontMetricsF, param1: QFontMetrics): gen_qfontmetrics_types.QFontMetricsF =
  gen_qfontmetrics_types.QFontMetricsF.init(fcQFontMetricsF_new3(param1.h))

proc create*(T: type gen_qfontmetrics_types.QFontMetricsF, param1: QFontMetricsF): gen_qfontmetrics_types.QFontMetricsF =
  gen_qfontmetrics_types.QFontMetricsF.init(fcQFontMetricsF_new4(param1.h))

proc operatorAssign*(self: gen_qfontmetrics_types.QFontMetricsF, param1: QFontMetricsF): void =
  fcQFontMetricsF_operatorAssign(self.h, param1.h)

proc operatorAssign*(self: gen_qfontmetrics_types.QFontMetricsF, param1: QFontMetrics): void =
  fcQFontMetricsF_operatorAssignWithQFontMetrics(self.h, param1.h)

proc swap*(self: gen_qfontmetrics_types.QFontMetricsF, other: QFontMetricsF): void =
...
proc inFont*(self: gen_qfontmetrics_types.QFontMetricsF, param1: QChar): bool =
...
proc leftBearing*(self: gen_qfontmetrics_types.QFontMetricsF, param1: QChar): float64 =
  fcQFontMetricsF_leftBearing(self.h, param1.h)

proc rightBearing*(self: gen_qfontmetrics_types.QFontMetricsF, param1: QChar): float64 =
...
proc horizontalAdvance*(self: gen_qfontmetrics_types.QFontMetricsF, param1: QChar): float64 =
  fcQFontMetricsF_horizontalAdvanceWithQChar(self.h, param1.h)

proc horizontalAdvance*(self: gen_qfontmetrics_types.QFontMetricsF, string: string, textOption: QTextOption): float64 =
  fcQFontMetricsF_horizontalAdvance2(self.h, struct_miqt_string(data: string, len: csize_t(len(string))), textOption.h)

proc boundingRect*(self: gen_qfontmetrics_types.QFontMetricsF, string: string): QRectF =
  QRectF(h: fcQFontMetricsF_boundingRect(self.h, struct_miqt_string(data: string, len: csize_t(len(string)))))

proc boundingRect*(self: gen_qfontmetrics_types.QFontMetricsF, text: string, textOption: QTextOption): QRectF =
  QRectF(h: fcQFontMetricsF_boundingRect2(self.h, struct_miqt_string(data: text, len: csize_t(len(text))), textOption.h))

proc boundingRect*(self: gen_qfontmetrics_types.QFontMetricsF, param1: QChar): QRectF =
  QRectF(h: fcQFontMetricsF_boundingRectWithQChar(self.h, param1.h))

proc boundingRect*(self: gen_qfontmetrics_types.QFontMetricsF, r: QRectF, flags: cint, string: string): QRectF =
  QRectF(h: fcQFontMetricsF_boundingRect3(self.h, r.h, flags, struct_miqt_string(data: string, len: csize_t(len(string)))))

proc size*(self: gen_qfontmetrics_types.QFontMetricsF, flags: cint, str: string): QSizeF =
  QSizeF(h: fcQFontMetricsF_size(self.h, flags, struct_miqt_string(data: str, len: csize_t(len(str)))))

proc tightBoundingRect*(self: gen_qfontmetrics_types.QFontMetricsF, text: string): QRectF =
  QRectF(h: fcQFontMetricsF_tightBoundingRect(self.h, struct_miqt_string(data: text, len: csize_t(len(text)))))

proc tightBoundingRect*(self: gen_qfontmetrics_types.QFontMetricsF, text: string, textOption: QTextOption): QRectF =
  QRectF(h: fcQFontMetricsF_tightBoundingRect2(self.h, struct_miqt_string(data: text, len: csize_t(len(text))), textOption.h))
...
proc operatorEqual*(self: gen_qfontmetrics_types.QFontMetricsF, other: QFontMetricsF): bool =
  fcQFontMetricsF_operatorEqual(self.h, other.h)

proc operatorNotEqual*(self: gen_qfontmetrics_types.QFontMetricsF, other: QFontMetricsF): bool =
...
proc horizontalAdvance*(self: gen_qfontmetrics_types.QFontMetricsF, string: string, length: cint): float64 =
  fcQFontMetricsF_horizontalAdvance22(self.h, struct_miqt_string(data: string, len: csize_t(len(string))), length)

proc boundingRect*(self: gen_qfontmetrics_types.QFontMetricsF, r: QRectF, flags: cint, string: string, tabstops: cint): QRectF =
  QRectF(h: fcQFontMetricsF_boundingRect4(self.h, r.h, flags, struct_miqt_string(data: string, len: csize_t(len(string))), tabstops))

proc boundingRect*(self: gen_qfontmetrics_types.QFontMetricsF, r: QRectF, flags: cint, string: string, tabstops: cint, tabarray: ptr cint): QRectF =
  QRectF(h: fcQFontMetricsF_boundingRect5(self.h, r.h, flags, struct_miqt_string(data: string, len: csize_t(len(string))), tabstops, tabarray))

proc size*(self: gen_qfontmetrics_types.QFontMetricsF, flags: cint, str: string, tabstops: cint): QSizeF =
  QSizeF(h: fcQFontMetricsF_size3(self.h, flags, struct_miqt_string(data: str, len: csize_t(len(str))), tabstops))

proc size*(self: gen_qfontmetrics_types.QFontMetricsF, flags: cint, str: string, tabstops: cint, tabarray: ptr cint): QSizeF =
  QSizeF(h: fcQFontMetricsF_size4(self.h, flags, struct_miqt_string(data: str, len: csize_t(len(str))), tabstops, tabarray))
