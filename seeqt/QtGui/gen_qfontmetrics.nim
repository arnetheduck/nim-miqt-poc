...
proc width*(self: gen_qfontmetrics_types.QFontMetrics, param1: QChar): cint =
...
proc boundingRect*(self: gen_qfontmetrics_types.QFontMetrics, r: QRect, flags: cint, text: string): QRect =
  QRect(h: fcQFontMetrics_boundingRect2(self.h, r.h, flags, struct_miqt_string(data: text, len: csize_t(len(text)))))

proc boundingRect*(self: gen_qfontmetrics_types.QFontMetrics, x: cint, y: cint, w: cint, h: cint, flags: cint, text: string): QRect =
  QRect(h: fcQFontMetrics_boundingRect3(self.h, x, y, w, h, flags, struct_miqt_string(data: text, len: csize_t(len(text)))))
...
proc boundingRect*(self: gen_qfontmetrics_types.QFontMetrics, r: QRect, flags: cint, text: string, tabstops: cint): QRect =
  QRect(h: fcQFontMetrics_boundingRect4(self.h, r.h, flags, struct_miqt_string(data: text, len: csize_t(len(text))), tabstops))
...
proc width*(self: gen_qfontmetrics_types.QFontMetricsF, param1: QChar): float64 =
...
proc boundingRect*(self: gen_qfontmetrics_types.QFontMetricsF, r: QRectF, flags: cint, string: string): QRectF =
  QRectF(h: fcQFontMetricsF_boundingRect2(self.h, r.h, flags, struct_miqt_string(data: string, len: csize_t(len(string)))))
