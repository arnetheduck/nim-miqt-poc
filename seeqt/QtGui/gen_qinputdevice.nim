...
proc create*(T: type gen_qinputdevice_types.QInputDevice, parent: QObject): gen_qinputdevice_types.QInputDevice =
...
proc create*(T: type gen_qinputdevice_types.QInputDevice, name: string, systemId: clonglong, typeVal: cint, seatName: string, parent: QObject): gen_qinputdevice_types.QInputDevice =
...
proc metaObject*(self: gen_qinputdevice_types.QInputDevice, ): QMetaObject =
  QMetaObject(h: fcQInputDevice_metaObject(self.h))
...
proc availableVirtualGeometry*(self: gen_qinputdevice_types.QInputDevice, ): QRect =
  QRect(h: fcQInputDevice_availableVirtualGeometry(self.h))
...
proc devices*(_: type gen_qinputdevice_types.QInputDevice, ): seq[QInputDevice] =
...
proc primaryKeyboard*(_: type gen_qinputdevice_types.QInputDevice, ): QInputDevice =
  QInputDevice(h: fcQInputDevice_primaryKeyboard())

proc operatorEqual*(self: gen_qinputdevice_types.QInputDevice, other: QInputDevice): bool =
  fcQInputDevice_operatorEqual(self.h, other.h)

proc availableVirtualGeometryChanged*(self: gen_qinputdevice_types.QInputDevice, area: QRect): void =
  fcQInputDevice_availableVirtualGeometryChanged(self.h, area.h)

type QInputDeviceavailableVirtualGeometryChangedSlot* = proc(area: QRect)
...
proc primaryKeyboard*(_: type gen_qinputdevice_types.QInputDevice, seatName: string): QInputDevice =
...
proc miqt_exec_callback_QInputDevice_metacall(self: ptr cQInputDevice, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QInputDevice_metacall ".} =
  ...
  virtualReturn
proc QInputDeviceevent*(self: gen_qinputdevice_types.QInputDevice, event: QEvent): bool =
  fQInputDevice_virtualbase_event(self.h, event.h)

type QInputDeviceeventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QInputDevice_event(self: ptr cQInputDevice, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QInputDevice_event ".} =
  ...
  virtualReturn
proc QInputDeviceeventFilter*(self: gen_qinputdevice_types.QInputDevice, watched: QObject, event: QEvent): bool =
  fQInputDevice_virtualbase_eventFilter(self.h, watched.h, event.h)

type QInputDeviceeventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QInputDevice_eventFilter(self: ptr cQInputDevice, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QInputDevice_eventFilter ".} =
  ...
  virtualReturn
proc QInputDevicetimerEvent*(self: gen_qinputdevice_types.QInputDevice, event: QTimerEvent): void =
  fQInputDevice_virtualbase_timerEvent(self.h, event.h)

type QInputDevicetimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QInputDevice_timerEvent(self: ptr cQInputDevice, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QInputDevice_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QInputDevicechildEvent*(self: gen_qinputdevice_types.QInputDevice, event: QChildEvent): void =
  fQInputDevice_virtualbase_childEvent(self.h, event.h)

type QInputDevicechildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QInputDevice_childEvent(self: ptr cQInputDevice, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QInputDevice_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QInputDevicecustomEvent*(self: gen_qinputdevice_types.QInputDevice, event: QEvent): void =
  fQInputDevice_virtualbase_customEvent(self.h, event.h)

type QInputDevicecustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QInputDevice_customEvent(self: ptr cQInputDevice, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QInputDevice_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QInputDeviceconnectNotify*(self: gen_qinputdevice_types.QInputDevice, signal: QMetaMethod): void =
  fQInputDevice_virtualbase_connectNotify(self.h, signal.h)

type QInputDeviceconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QInputDevice_connectNotify(self: ptr cQInputDevice, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QInputDevice_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QInputDevicedisconnectNotify*(self: gen_qinputdevice_types.QInputDevice, signal: QMetaMethod): void =
  fQInputDevice_virtualbase_disconnectNotify(self.h, signal.h)

type QInputDevicedisconnectNotifyProc* = proc(signal: QMetaMethod): void
