...
proc objectX*(self: gen_qaccessibleobject_types.QAccessibleObject, ): QObject =
  QObject(h: fcQAccessibleObject_objectX(self.h))

proc rect*(self: gen_qaccessibleobject_types.QAccessibleObject, ): QRect =
  QRect(h: fcQAccessibleObject_rect(self.h))
...
proc childAt*(self: gen_qaccessibleobject_types.QAccessibleObject, x: cint, y: cint): QAccessibleInterface =
  QAccessibleInterface(h: fcQAccessibleObject_childAt(self.h, x, y))
...
proc window*(self: gen_qaccessibleobject_types.QAccessibleApplication, ): QWindow =
  QWindow(h: fcQAccessibleApplication_window(self.h))

proc childCount*(self: gen_qaccessibleobject_types.QAccessibleApplication, ): cint =
  fcQAccessibleApplication_childCount(self.h)

proc indexOfChild*(self: gen_qaccessibleobject_types.QAccessibleApplication, param1: QAccessibleInterface): cint =
  fcQAccessibleApplication_indexOfChild(self.h, param1.h)

proc focusChild*(self: gen_qaccessibleobject_types.QAccessibleApplication, ): QAccessibleInterface =
  QAccessibleInterface(h: fcQAccessibleApplication_focusChild(self.h))

proc parent*(self: gen_qaccessibleobject_types.QAccessibleApplication, ): QAccessibleInterface =
  QAccessibleInterface(h: fcQAccessibleApplication_parent(self.h))

proc child*(self: gen_qaccessibleobject_types.QAccessibleApplication, index: cint): QAccessibleInterface =
  QAccessibleInterface(h: fcQAccessibleApplication_child(self.h, index))
...
proc state*(self: gen_qaccessibleobject_types.QAccessibleApplication, ): QAccessibleState =
  QAccessibleState(h: fcQAccessibleApplication_state(self.h))
