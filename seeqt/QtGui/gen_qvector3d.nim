...
proc create*(T: type gen_qvector3d_types.QVector3D, point: QPoint): gen_qvector3d_types.QVector3D =
  gen_qvector3d_types.QVector3D.init(fcQVector3D_new4(point.h))

proc create*(T: type gen_qvector3d_types.QVector3D, point: QPointF): gen_qvector3d_types.QVector3D =
  gen_qvector3d_types.QVector3D.init(fcQVector3D_new5(point.h))

proc create*(T: type gen_qvector3d_types.QVector3D, vector: QVector2D): gen_qvector3d_types.QVector3D =
  gen_qvector3d_types.QVector3D.init(fcQVector3D_new6(vector.h))

proc create*(T: type gen_qvector3d_types.QVector3D, vector: QVector2D, zpos: float32): gen_qvector3d_types.QVector3D =
  gen_qvector3d_types.QVector3D.init(fcQVector3D_new7(vector.h, zpos))

proc create*(T: type gen_qvector3d_types.QVector3D, vector: QVector4D): gen_qvector3d_types.QVector3D =
  gen_qvector3d_types.QVector3D.init(fcQVector3D_new8(vector.h))

proc create*(T: type gen_qvector3d_types.QVector3D, param1: QVector3D): gen_qvector3d_types.QVector3D =
...
proc normalized*(self: gen_qvector3d_types.QVector3D, ): QVector3D =
...
proc operatorPlusAssign*(self: gen_qvector3d_types.QVector3D, vector: QVector3D): QVector3D =
  QVector3D(h: fcQVector3D_operatorPlusAssign(self.h, vector.h))

proc operatorMinusAssign*(self: gen_qvector3d_types.QVector3D, vector: QVector3D): QVector3D =
  QVector3D(h: fcQVector3D_operatorMinusAssign(self.h, vector.h))

proc operatorMultiplyAssign*(self: gen_qvector3d_types.QVector3D, factor: float32): QVector3D =
  QVector3D(h: fcQVector3D_operatorMultiplyAssign(self.h, factor))

proc operatorMultiplyAssign*(self: gen_qvector3d_types.QVector3D, vector: QVector3D): QVector3D =
  QVector3D(h: fcQVector3D_operatorMultiplyAssignWithVector(self.h, vector.h))

proc operatorDivideAssign*(self: gen_qvector3d_types.QVector3D, divisor: float32): QVector3D =
  QVector3D(h: fcQVector3D_operatorDivideAssign(self.h, divisor))

proc operatorDivideAssign*(self: gen_qvector3d_types.QVector3D, vector: QVector3D): QVector3D =
  QVector3D(h: fcQVector3D_operatorDivideAssignWithVector(self.h, vector.h))

proc dotProduct*(_: type gen_qvector3d_types.QVector3D, v1: QVector3D, v2: QVector3D): float32 =
  fcQVector3D_dotProduct(v1.h, v2.h)

proc crossProduct*(_: type gen_qvector3d_types.QVector3D, v1: QVector3D, v2: QVector3D): QVector3D =
  QVector3D(h: fcQVector3D_crossProduct(v1.h, v2.h))

proc normal*(_: type gen_qvector3d_types.QVector3D, v1: QVector3D, v2: QVector3D): QVector3D =
  QVector3D(h: fcQVector3D_normal(v1.h, v2.h))

proc normal*(_: type gen_qvector3d_types.QVector3D, v1: QVector3D, v2: QVector3D, v3: QVector3D): QVector3D =
  QVector3D(h: fcQVector3D_normal2(v1.h, v2.h, v3.h))

proc project*(self: gen_qvector3d_types.QVector3D, modelView: QMatrix4x4, projection: QMatrix4x4, viewport: QRect): QVector3D =
  QVector3D(h: fcQVector3D_project(self.h, modelView.h, projection.h, viewport.h))

proc unproject*(self: gen_qvector3d_types.QVector3D, modelView: QMatrix4x4, projection: QMatrix4x4, viewport: QRect): QVector3D =
  QVector3D(h: fcQVector3D_unproject(self.h, modelView.h, projection.h, viewport.h))

proc distanceToPoint*(self: gen_qvector3d_types.QVector3D, point: QVector3D): float32 =
  fcQVector3D_distanceToPoint(self.h, point.h)

proc distanceToPlane*(self: gen_qvector3d_types.QVector3D, plane: QVector3D, normal: QVector3D): float32 =
  fcQVector3D_distanceToPlane(self.h, plane.h, normal.h)

proc distanceToPlane*(self: gen_qvector3d_types.QVector3D, plane1: QVector3D, plane2: QVector3D, plane3: QVector3D): float32 =
  fcQVector3D_distanceToPlane2(self.h, plane1.h, plane2.h, plane3.h)

proc distanceToLine*(self: gen_qvector3d_types.QVector3D, point: QVector3D, direction: QVector3D): float32 =
  fcQVector3D_distanceToLine(self.h, point.h, direction.h)

proc toVector2D*(self: gen_qvector3d_types.QVector3D, ): QVector2D =
  QVector2D(h: fcQVector3D_toVector2D(self.h))

proc toVector4D*(self: gen_qvector3d_types.QVector3D, ): QVector4D =
  QVector4D(h: fcQVector3D_toVector4D(self.h))

proc toPoint*(self: gen_qvector3d_types.QVector3D, ): QPoint =
  QPoint(h: fcQVector3D_toPoint(self.h))

proc toPointF*(self: gen_qvector3d_types.QVector3D, ): QPointF =
  QPointF(h: fcQVector3D_toPointF(self.h))

proc ToQVariant*(self: gen_qvector3d_types.QVector3D, ): QVariant =
