...
proc create*(T: type gen_qkeysequence_types.QKeySequence, k1: cint, k2: cint, k3: cint, k4: cint): gen_qkeysequence_types.QKeySequence =
  gen_qkeysequence_types.QKeySequence.init(fcQKeySequence_new9(k1, k2, k3, k4))
