...
void QFileSystemModel_connect_rootPathChanged(QFileSystemModel* self, intptr_t slot, void (*callback)(intptr_t, struct miqt_string), void (*release)(intptr_t)) {
	...
	MiqtVirtualQFileSystemModel::connect(self, static_cast<void (QFileSystemModel::*)(const QString&)>(&QFileSystemModel::rootPathChanged), self, caller{slot, callback, release});
}
...
void QFileSystemModel_connect_fileRenamed(QFileSystemModel* self, intptr_t slot, void (*callback)(intptr_t, struct miqt_string, struct miqt_string, struct miqt_string), void (*release)(intptr_t)) {
	...
	MiqtVirtualQFileSystemModel::connect(self, static_cast<void (QFileSystemModel::*)(const QString&, const QString&, const QString&)>(&QFileSystemModel::fileRenamed), self, caller{slot, callback, release});
}
...
void QFileSystemModel_connect_directoryLoaded(QFileSystemModel* self, intptr_t slot, void (*callback)(intptr_t, struct miqt_string), void (*release)(intptr_t)) {
	...
	MiqtVirtualQFileSystemModel::connect(self, static_cast<void (QFileSystemModel::*)(const QString&)>(&QFileSystemModel::directoryLoaded), self, caller{slot, callback, release});
}
...
QMetaObject* QFileSystemModel_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQFileSystemModel*)(self) )->QFileSystemModel::metaObject();

}

void* QFileSystemModel_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQFileSystemModel*)(self) )->QFileSystemModel::qt_metacast(param1);

}

int QFileSystemModel_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQFileSystemModel*)(self) )->QFileSystemModel::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
bool QFileSystemModel_virtualbase_clearItemData(void* self, QModelIndex* index) {
	...
	return ( (MiqtVirtualQFileSystemModel*)(self) )->QFileSystemModel::clearItemData(*index);
...
void QFileSystemModel_virtualbase_multiData(const void* self, QModelIndex* index, QModelRoleDataSpan* roleDataSpan) {
	...
	( (const MiqtVirtualQFileSystemModel*)(self) )->QFileSystemModel::multiData(*index, *roleDataSpan);
...
void QFileSystemModel_virtualbase_resetInternalData(void* self) {
	...
	( (MiqtVirtualQFileSystemModel*)(self) )->QFileSystemModel::resetInternalData();
