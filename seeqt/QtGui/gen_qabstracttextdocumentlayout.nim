...
func init*(T: type gen_qabstracttextdocumentlayout_types.QAbstractTextDocumentLayout, h: ptr cQAbstractTextDocumentLayout): gen_qabstracttextdocumentlayout_types.QAbstractTextDocumentLayout =
  T(h: h)
proc create*(T: type gen_qabstracttextdocumentlayout_types.QAbstractTextDocumentLayout, doc: QTextDocument): gen_qabstracttextdocumentlayout_types.QAbstractTextDocumentLayout =
  gen_qabstracttextdocumentlayout_types.QAbstractTextDocumentLayout.init(fcQAbstractTextDocumentLayout_new(doc.h))

proc metaObject*(self: gen_qabstracttextdocumentlayout_types.QAbstractTextDocumentLayout, ): QMetaObject =
  QMetaObject(h: fcQAbstractTextDocumentLayout_metaObject(self.h))
...
proc draw*(self: gen_qabstracttextdocumentlayout_types.QAbstractTextDocumentLayout, painter: QPainter, context: QAbstractTextDocumentLayoutPaintContext): void =
  fcQAbstractTextDocumentLayout_draw(self.h, painter.h, context.h)

proc hitTest*(self: gen_qabstracttextdocumentlayout_types.QAbstractTextDocumentLayout, point: QPointF, accuracy: cint): cint =
  fcQAbstractTextDocumentLayout_hitTest(self.h, point.h, cint(accuracy))

proc anchorAt*(self: gen_qabstracttextdocumentlayout_types.QAbstractTextDocumentLayout, pos: QPointF): string =
  let v_ms = fcQAbstractTextDocumentLayout_anchorAt(self.h, pos.h)
  let vx_ret = string.fromBytes(toOpenArrayByte(v_ms.data, 0, int(v_ms.len)-1))
  c_free(v_ms.data)
  vx_ret

proc imageAt*(self: gen_qabstracttextdocumentlayout_types.QAbstractTextDocumentLayout, pos: QPointF): string =
  let v_ms = fcQAbstractTextDocumentLayout_imageAt(self.h, pos.h)
  let vx_ret = string.fromBytes(toOpenArrayByte(v_ms.data, 0, int(v_ms.len)-1))
  c_free(v_ms.data)
  vx_ret

proc formatAt*(self: gen_qabstracttextdocumentlayout_types.QAbstractTextDocumentLayout, pos: QPointF): QTextFormat =
  QTextFormat(h: fcQAbstractTextDocumentLayout_formatAt(self.h, pos.h))

proc blockWithMarkerAt*(self: gen_qabstracttextdocumentlayout_types.QAbstractTextDocumentLayout, pos: QPointF): QTextBlock =
  QTextBlock(h: fcQAbstractTextDocumentLayout_blockWithMarkerAt(self.h, pos.h))
...
proc documentSize*(self: gen_qabstracttextdocumentlayout_types.QAbstractTextDocumentLayout, ): QSizeF =
  QSizeF(h: fcQAbstractTextDocumentLayout_documentSize(self.h))

proc frameBoundingRect*(self: gen_qabstracttextdocumentlayout_types.QAbstractTextDocumentLayout, frame: QTextFrame): QRectF =
  QRectF(h: fcQAbstractTextDocumentLayout_frameBoundingRect(self.h, frame.h))

proc blockBoundingRect*(self: gen_qabstracttextdocumentlayout_types.QAbstractTextDocumentLayout, blockVal: QTextBlock): QRectF =
  QRectF(h: fcQAbstractTextDocumentLayout_blockBoundingRect(self.h, blockVal.h))

proc setPaintDevice*(self: gen_qabstracttextdocumentlayout_types.QAbstractTextDocumentLayout, device: QPaintDevice): void =
  fcQAbstractTextDocumentLayout_setPaintDevice(self.h, device.h)

proc paintDevice*(self: gen_qabstracttextdocumentlayout_types.QAbstractTextDocumentLayout, ): QPaintDevice =
  QPaintDevice(h: fcQAbstractTextDocumentLayout_paintDevice(self.h))

proc document*(self: gen_qabstracttextdocumentlayout_types.QAbstractTextDocumentLayout, ): QTextDocument =
  QTextDocument(h: fcQAbstractTextDocumentLayout_document(self.h))

proc registerHandler*(self: gen_qabstracttextdocumentlayout_types.QAbstractTextDocumentLayout, objectType: cint, component: QObject): void =
...
proc handlerForObject*(self: gen_qabstracttextdocumentlayout_types.QAbstractTextDocumentLayout, objectType: cint): QTextObjectInterface =
...
proc updateBlock*(self: gen_qabstracttextdocumentlayout_types.QAbstractTextDocumentLayout, blockVal: QTextBlock): void =
  fcQAbstractTextDocumentLayout_updateBlock(self.h, blockVal.h)

type QAbstractTextDocumentLayoutupdateBlockSlot* = proc(blockVal: QTextBlock)
...
proc documentSizeChanged*(self: gen_qabstracttextdocumentlayout_types.QAbstractTextDocumentLayout, newSize: QSizeF): void =
  fcQAbstractTextDocumentLayout_documentSizeChanged(self.h, newSize.h)

type QAbstractTextDocumentLayoutdocumentSizeChangedSlot* = proc(newSize: QSizeF)
...
proc unregisterHandler*(self: gen_qabstracttextdocumentlayout_types.QAbstractTextDocumentLayout, objectType: cint, component: QObject): void =
  fcQAbstractTextDocumentLayout_unregisterHandler2(self.h, objectType, component.h)

proc update*(self: gen_qabstracttextdocumentlayout_types.QAbstractTextDocumentLayout, param1: QRectF): void =
  fcQAbstractTextDocumentLayout_update1(self.h, param1.h)

type QAbstractTextDocumentLayoutupdate1Slot* = proc(param1: QRectF)
...
proc miqt_exec_callback_QAbstractTextDocumentLayout_metacall(self: ptr cQAbstractTextDocumentLayout, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QAbstractTextDocumentLayout_metacall ".} =
  ...
  virtualReturn
type QAbstractTextDocumentLayoutdrawProc* = proc(painter: QPainter, context: QAbstractTextDocumentLayoutPaintContext): void
...
type QAbstractTextDocumentLayouthitTestProc* = proc(point: QPointF, accuracy: cint): cint
...
proc miqt_exec_callback_QAbstractTextDocumentLayout_pageCount(self: ptr cQAbstractTextDocumentLayout, slot: int): cint {.exportc: "miqt_exec_callback_QAbstractTextDocumentLayout_pageCount ".} =
  ...
  virtualReturn
type QAbstractTextDocumentLayoutdocumentSizeProc* = proc(): QSizeF
...
proc miqt_exec_callback_QAbstractTextDocumentLayout_documentSize(self: ptr cQAbstractTextDocumentLayout, slot: int): pointer {.exportc: "miqt_exec_callback_QAbstractTextDocumentLayout_documentSize ".} =
  ...
  virtualReturn.h
type QAbstractTextDocumentLayoutframeBoundingRectProc* = proc(frame: QTextFrame): QRectF
...
proc miqt_exec_callback_QAbstractTextDocumentLayout_frameBoundingRect(self: ptr cQAbstractTextDocumentLayout, slot: int, frame: pointer): pointer {.exportc: "miqt_exec_callback_QAbstractTextDocumentLayout_frameBoundingRect ".} =
  ...
  let slotval1 = QTextFrame(h: frame)


  let virtualReturn = nimfunc[](slotval1 )

  virtualReturn.h
type QAbstractTextDocumentLayoutblockBoundingRectProc* = proc(blockVal: QTextBlock): QRectF
...
proc QAbstractTextDocumentLayoutresizeInlineObject*(self: gen_qabstracttextdocumentlayout_types.QAbstractTextDocumentLayout, item: QTextInlineObject, posInDocument: cint, format: QTextFormat): void =
  fQAbstractTextDocumentLayout_virtualbase_resizeInlineObject(self.h, item.h, posInDocument, format.h)

type QAbstractTextDocumentLayoutresizeInlineObjectProc* = proc(item: QTextInlineObject, posInDocument: cint, format: QTextFormat): void
...
proc miqt_exec_callback_QAbstractTextDocumentLayout_resizeInlineObject(self: ptr cQAbstractTextDocumentLayout, slot: int, item: pointer, posInDocument: cint, format: pointer): void {.exportc: "miqt_exec_callback_QAbstractTextDocumentLayout_resizeInlineObject ".} =
  ...
  nimfunc[](slotval1, slotval2, slotval3)
proc QAbstractTextDocumentLayoutpositionInlineObject*(self: gen_qabstracttextdocumentlayout_types.QAbstractTextDocumentLayout, item: QTextInlineObject, posInDocument: cint, format: QTextFormat): void =
  fQAbstractTextDocumentLayout_virtualbase_positionInlineObject(self.h, item.h, posInDocument, format.h)

type QAbstractTextDocumentLayoutpositionInlineObjectProc* = proc(item: QTextInlineObject, posInDocument: cint, format: QTextFormat): void
...
proc miqt_exec_callback_QAbstractTextDocumentLayout_positionInlineObject(self: ptr cQAbstractTextDocumentLayout, slot: int, item: pointer, posInDocument: cint, format: pointer): void {.exportc: "miqt_exec_callback_QAbstractTextDocumentLayout_positionInlineObject ".} =
  ...
  nimfunc[](slotval1, slotval2, slotval3)
proc QAbstractTextDocumentLayoutdrawInlineObject*(self: gen_qabstracttextdocumentlayout_types.QAbstractTextDocumentLayout, painter: QPainter, rect: QRectF, objectVal: QTextInlineObject, posInDocument: cint, format: QTextFormat): void =
  fQAbstractTextDocumentLayout_virtualbase_drawInlineObject(self.h, painter.h, rect.h, objectVal.h, posInDocument, format.h)

type QAbstractTextDocumentLayoutdrawInlineObjectProc* = proc(painter: QPainter, rect: QRectF, objectVal: QTextInlineObject, posInDocument: cint, format: QTextFormat): void
...
proc QAbstractTextDocumentLayoutevent*(self: gen_qabstracttextdocumentlayout_types.QAbstractTextDocumentLayout, event: QEvent): bool =
  fQAbstractTextDocumentLayout_virtualbase_event(self.h, event.h)

type QAbstractTextDocumentLayouteventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QAbstractTextDocumentLayout_event(self: ptr cQAbstractTextDocumentLayout, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QAbstractTextDocumentLayout_event ".} =
  ...
  virtualReturn
proc QAbstractTextDocumentLayouteventFilter*(self: gen_qabstracttextdocumentlayout_types.QAbstractTextDocumentLayout, watched: QObject, event: QEvent): bool =
  fQAbstractTextDocumentLayout_virtualbase_eventFilter(self.h, watched.h, event.h)

type QAbstractTextDocumentLayouteventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QAbstractTextDocumentLayout_eventFilter(self: ptr cQAbstractTextDocumentLayout, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QAbstractTextDocumentLayout_eventFilter ".} =
  ...
  virtualReturn
proc QAbstractTextDocumentLayouttimerEvent*(self: gen_qabstracttextdocumentlayout_types.QAbstractTextDocumentLayout, event: QTimerEvent): void =
  fQAbstractTextDocumentLayout_virtualbase_timerEvent(self.h, event.h)

type QAbstractTextDocumentLayouttimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QAbstractTextDocumentLayout_timerEvent(self: ptr cQAbstractTextDocumentLayout, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QAbstractTextDocumentLayout_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QAbstractTextDocumentLayoutchildEvent*(self: gen_qabstracttextdocumentlayout_types.QAbstractTextDocumentLayout, event: QChildEvent): void =
  fQAbstractTextDocumentLayout_virtualbase_childEvent(self.h, event.h)

type QAbstractTextDocumentLayoutchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QAbstractTextDocumentLayout_childEvent(self: ptr cQAbstractTextDocumentLayout, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QAbstractTextDocumentLayout_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QAbstractTextDocumentLayoutcustomEvent*(self: gen_qabstracttextdocumentlayout_types.QAbstractTextDocumentLayout, event: QEvent): void =
  fQAbstractTextDocumentLayout_virtualbase_customEvent(self.h, event.h)

type QAbstractTextDocumentLayoutcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QAbstractTextDocumentLayout_customEvent(self: ptr cQAbstractTextDocumentLayout, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QAbstractTextDocumentLayout_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QAbstractTextDocumentLayoutconnectNotify*(self: gen_qabstracttextdocumentlayout_types.QAbstractTextDocumentLayout, signal: QMetaMethod): void =
  fQAbstractTextDocumentLayout_virtualbase_connectNotify(self.h, signal.h)

type QAbstractTextDocumentLayoutconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QAbstractTextDocumentLayout_connectNotify(self: ptr cQAbstractTextDocumentLayout, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QAbstractTextDocumentLayout_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QAbstractTextDocumentLayoutdisconnectNotify*(self: gen_qabstracttextdocumentlayout_types.QAbstractTextDocumentLayout, signal: QMetaMethod): void =
  fQAbstractTextDocumentLayout_virtualbase_disconnectNotify(self.h, signal.h)

type QAbstractTextDocumentLayoutdisconnectNotifyProc* = proc(signal: QMetaMethod): void
...
func init*(T: type gen_qabstracttextdocumentlayout_types.QTextObjectInterface, h: ptr cQTextObjectInterface): gen_qabstracttextdocumentlayout_types.QTextObjectInterface =
  T(h: h)
proc intrinsicSize*(self: gen_qabstracttextdocumentlayout_types.QTextObjectInterface, doc: QTextDocument, posInDocument: cint, format: QTextFormat): QSizeF =
  QSizeF(h: fcQTextObjectInterface_intrinsicSize(self.h, doc.h, posInDocument, format.h))

proc drawObject*(self: gen_qabstracttextdocumentlayout_types.QTextObjectInterface, painter: QPainter, rect: QRectF, doc: QTextDocument, posInDocument: cint, format: QTextFormat): void =
  fcQTextObjectInterface_drawObject(self.h, painter.h, rect.h, doc.h, posInDocument, format.h)

proc operatorAssign*(self: gen_qabstracttextdocumentlayout_types.QTextObjectInterface, param1: QTextObjectInterface): void =
...
func init*(T: type gen_qabstracttextdocumentlayout_types.QAbstractTextDocumentLayoutSelection, h: ptr cQAbstractTextDocumentLayoutSelection): gen_qabstracttextdocumentlayout_types.QAbstractTextDocumentLayoutSelection =
  T(h: h)
proc create*(T: type gen_qabstracttextdocumentlayout_types.QAbstractTextDocumentLayoutSelection, param1: QAbstractTextDocumentLayoutSelection): gen_qabstracttextdocumentlayout_types.QAbstractTextDocumentLayoutSelection =
...
proc operatorAssign*(self: gen_qabstracttextdocumentlayout_types.QAbstractTextDocumentLayoutSelection, param1: QAbstractTextDocumentLayoutSelection): void =
...
proc create*(T: type gen_qabstracttextdocumentlayout_types.QAbstractTextDocumentLayoutPaintContext, param1: QAbstractTextDocumentLayoutPaintContext): gen_qabstracttextdocumentlayout_types.QAbstractTextDocumentLayoutPaintContext =
...
proc operatorAssign*(self: gen_qabstracttextdocumentlayout_types.QAbstractTextDocumentLayoutPaintContext, param1: QAbstractTextDocumentLayoutPaintContext): void =
