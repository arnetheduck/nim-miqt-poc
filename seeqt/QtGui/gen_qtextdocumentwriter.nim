...
proc create*(T: type gen_qtextdocumentwriter_types.QTextDocumentWriter, device: QIODevice, format: seq[byte]): gen_qtextdocumentwriter_types.QTextDocumentWriter =
...
proc setDevice*(self: gen_qtextdocumentwriter_types.QTextDocumentWriter, device: QIODevice): void =
  fcQTextDocumentWriter_setDevice(self.h, device.h)

proc device*(self: gen_qtextdocumentwriter_types.QTextDocumentWriter, ): QIODevice =
  QIODevice(h: fcQTextDocumentWriter_device(self.h))
...
proc write*(self: gen_qtextdocumentwriter_types.QTextDocumentWriter, document: QTextDocument): bool =
  fcQTextDocumentWriter_write(self.h, document.h)

proc write*(self: gen_qtextdocumentwriter_types.QTextDocumentWriter, fragment: QTextDocumentFragment): bool =
  fcQTextDocumentWriter_writeWithFragment(self.h, fragment.h)

proc setCodec*(self: gen_qtextdocumentwriter_types.QTextDocumentWriter, codec: QTextCodec): void =
  fcQTextDocumentWriter_setCodec(self.h, codec.h)

proc codec*(self: gen_qtextdocumentwriter_types.QTextDocumentWriter, ): QTextCodec =
  QTextCodec(h: fcQTextDocumentWriter_codec(self.h))
