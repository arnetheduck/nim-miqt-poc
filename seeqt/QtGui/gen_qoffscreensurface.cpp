...
void QOffscreenSurface_connect_screenChanged(QOffscreenSurface* self, intptr_t slot, void (*callback)(intptr_t, QScreen*), void (*release)(intptr_t)) {
	...
	MiqtVirtualQOffscreenSurface::connect(self, static_cast<void (QOffscreenSurface::*)(QScreen*)>(&QOffscreenSurface::screenChanged), self, caller{slot, callback, release});
}
...
QMetaObject* QOffscreenSurface_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQOffscreenSurface*)(self) )->QOffscreenSurface::metaObject();

}

void* QOffscreenSurface_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQOffscreenSurface*)(self) )->QOffscreenSurface::qt_metacast(param1);

}

int QOffscreenSurface_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQOffscreenSurface*)(self) )->QOffscreenSurface::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
QObject* QOffscreenSurface_protectedbase_sender(const void* self) {
	MiqtVirtualQOffscreenSurface* self_cast = static_cast<MiqtVirtualQOffscreenSurface*>( (QOffscreenSurface*)(self) );
