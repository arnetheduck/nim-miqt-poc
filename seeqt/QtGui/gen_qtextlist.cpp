...
public:
	...
	MiqtVirtualQTextList(struct QTextList_VTable* vtbl, QTextDocument* doc): QTextList(doc), vtbl(vtbl) {};

	virtual ~MiqtVirtualQTextList() override { if(vtbl->destructor) vtbl->destructor(vtbl, this); }
...
QTextList* QTextList_new(struct QTextList_VTable* vtbl, QTextDocument* doc) {
	return new MiqtVirtualQTextList(vtbl, doc);
}
...
QMetaObject* QTextList_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQTextList*)(self) )->QTextList::metaObject();

}

void* QTextList_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQTextList*)(self) )->QTextList::qt_metacast(param1);

}

int QTextList_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQTextList*)(self) )->QTextList::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
struct miqt_array /* of QTextBlock* */  QTextList_protectedbase_blockList(const void* self) {
	MiqtVirtualQTextList* self_cast = static_cast<MiqtVirtualQTextList*>( (QTextList*)(self) );
