...
proc fcQActionEvent_new(param1: pointer): ptr cQActionEvent {.importc: "QActionEvent_new".}
...
func init*(T: type gen_qevent_types.QInputEvent, h: ptr cQInputEvent): gen_qevent_types.QInputEvent =
  T(h: h)
proc create*(T: type gen_qevent_types.QInputEvent, typeVal: cint): gen_qevent_types.QInputEvent =
  gen_qevent_types.QInputEvent.init(fcQInputEvent_new(cint(typeVal)))

proc create*(T: type gen_qevent_types.QInputEvent, param1: QInputEvent): gen_qevent_types.QInputEvent =
  gen_qevent_types.QInputEvent.init(fcQInputEvent_new2(param1.h))

proc create*(T: type gen_qevent_types.QInputEvent, typeVal: cint, modifiers: cint): gen_qevent_types.QInputEvent =
  gen_qevent_types.QInputEvent.init(fcQInputEvent_new3(cint(typeVal), cint(modifiers)))
...
func init*(T: type gen_qevent_types.QEnterEvent, h: ptr cQEnterEvent): gen_qevent_types.QEnterEvent =
  T(h: h)
proc create*(T: type gen_qevent_types.QEnterEvent, localPos: QPointF, windowPos: QPointF, screenPos: QPointF): gen_qevent_types.QEnterEvent =
  gen_qevent_types.QEnterEvent.init(fcQEnterEvent_new(localPos.h, windowPos.h, screenPos.h))

proc create*(T: type gen_qevent_types.QEnterEvent, param1: QEnterEvent): gen_qevent_types.QEnterEvent =
  gen_qevent_types.QEnterEvent.init(fcQEnterEvent_new2(param1.h))

proc pos*(self: gen_qevent_types.QEnterEvent, ): QPoint =
  QPoint(h: fcQEnterEvent_pos(self.h))

proc globalPos*(self: gen_qevent_types.QEnterEvent, ): QPoint =
  QPoint(h: fcQEnterEvent_globalPos(self.h))
...
proc localPos*(self: gen_qevent_types.QEnterEvent, ): QPointF =
  QPointF(h: fcQEnterEvent_localPos(self.h))

proc windowPos*(self: gen_qevent_types.QEnterEvent, ): QPointF =
  QPointF(h: fcQEnterEvent_windowPos(self.h))

proc screenPos*(self: gen_qevent_types.QEnterEvent, ): QPointF =
  QPointF(h: fcQEnterEvent_screenPos(self.h))
...
func init*(T: type gen_qevent_types.QMouseEvent, h: ptr cQMouseEvent): gen_qevent_types.QMouseEvent =
  T(h: h)
proc create*(T: type gen_qevent_types.QMouseEvent, typeVal: cint, localPos: QPointF, button: cint, buttons: cint, modifiers: cint): gen_qevent_types.QMouseEvent =
  gen_qevent_types.QMouseEvent.init(fcQMouseEvent_new(cint(typeVal), localPos.h, cint(button), cint(buttons), cint(modifiers)))

proc create*(T: type gen_qevent_types.QMouseEvent, typeVal: cint, localPos: QPointF, screenPos: QPointF, button: cint, buttons: cint, modifiers: cint): gen_qevent_types.QMouseEvent =
  gen_qevent_types.QMouseEvent.init(fcQMouseEvent_new2(cint(typeVal), localPos.h, screenPos.h, cint(button), cint(buttons), cint(modifiers)))

proc create*(T: type gen_qevent_types.QMouseEvent, typeVal: cint, localPos: QPointF, windowPos: QPointF, screenPos: QPointF, button: cint, buttons: cint, modifiers: cint): gen_qevent_types.QMouseEvent =
  gen_qevent_types.QMouseEvent.init(fcQMouseEvent_new3(cint(typeVal), localPos.h, windowPos.h, screenPos.h, cint(button), cint(buttons), cint(modifiers)))

proc create*(T: type gen_qevent_types.QMouseEvent, typeVal: cint, localPos: QPointF, windowPos: QPointF, screenPos: QPointF, button: cint, buttons: cint, modifiers: cint, source: cint): gen_qevent_types.QMouseEvent =
  gen_qevent_types.QMouseEvent.init(fcQMouseEvent_new4(cint(typeVal), localPos.h, windowPos.h, screenPos.h, cint(button), cint(buttons), cint(modifiers), cint(source)))

proc create*(T: type gen_qevent_types.QMouseEvent, param1: QMouseEvent): gen_qevent_types.QMouseEvent =
  gen_qevent_types.QMouseEvent.init(fcQMouseEvent_new5(param1.h))

proc pos*(self: gen_qevent_types.QMouseEvent, ): QPoint =
  QPoint(h: fcQMouseEvent_pos(self.h))

proc globalPos*(self: gen_qevent_types.QMouseEvent, ): QPoint =
  QPoint(h: fcQMouseEvent_globalPos(self.h))
...
proc localPos*(self: gen_qevent_types.QMouseEvent, ): QPointF =
  QPointF(h: fcQMouseEvent_localPos(self.h))

proc windowPos*(self: gen_qevent_types.QMouseEvent, ): QPointF =
  QPointF(h: fcQMouseEvent_windowPos(self.h))

proc screenPos*(self: gen_qevent_types.QMouseEvent, ): QPointF =
  QPointF(h: fcQMouseEvent_screenPos(self.h))
...
proc setLocalPos*(self: gen_qevent_types.QMouseEvent, localPosition: QPointF): void =
...
func init*(T: type gen_qevent_types.QHoverEvent, h: ptr cQHoverEvent): gen_qevent_types.QHoverEvent =
  T(h: h)
proc create*(T: type gen_qevent_types.QHoverEvent, typeVal: cint, pos: QPointF, oldPos: QPointF): gen_qevent_types.QHoverEvent =
  gen_qevent_types.QHoverEvent.init(fcQHoverEvent_new(cint(typeVal), pos.h, oldPos.h))

proc create*(T: type gen_qevent_types.QHoverEvent, param1: QHoverEvent): gen_qevent_types.QHoverEvent =
  gen_qevent_types.QHoverEvent.init(fcQHoverEvent_new2(param1.h))

proc create*(T: type gen_qevent_types.QHoverEvent, typeVal: cint, pos: QPointF, oldPos: QPointF, modifiers: cint): gen_qevent_types.QHoverEvent =
  gen_qevent_types.QHoverEvent.init(fcQHoverEvent_new3(cint(typeVal), pos.h, oldPos.h, cint(modifiers)))

proc pos*(self: gen_qevent_types.QHoverEvent, ): QPoint =
  QPoint(h: fcQHoverEvent_pos(self.h))

proc oldPos*(self: gen_qevent_types.QHoverEvent, ): QPoint =
  QPoint(h: fcQHoverEvent_oldPos(self.h))

proc posF*(self: gen_qevent_types.QHoverEvent, ): QPointF =
  QPointF(h: fcQHoverEvent_posF(self.h))

proc oldPosF*(self: gen_qevent_types.QHoverEvent, ): QPointF =
  QPointF(h: fcQHoverEvent_oldPosF(self.h))
...
func init*(T: type gen_qevent_types.QWheelEvent, h: ptr cQWheelEvent): gen_qevent_types.QWheelEvent =
  T(h: h)
proc create*(T: type gen_qevent_types.QWheelEvent, pos: QPointF, delta: cint, buttons: cint, modifiers: cint): gen_qevent_types.QWheelEvent =
  gen_qevent_types.QWheelEvent.init(fcQWheelEvent_new(pos.h, delta, cint(buttons), cint(modifiers)))

proc create*(T: type gen_qevent_types.QWheelEvent, pos: QPointF, globalPos: QPointF, delta: cint, buttons: cint, modifiers: cint): gen_qevent_types.QWheelEvent =
  gen_qevent_types.QWheelEvent.init(fcQWheelEvent_new2(pos.h, globalPos.h, delta, cint(buttons), cint(modifiers)))

proc create*(T: type gen_qevent_types.QWheelEvent, pos: QPointF, globalPos: QPointF, pixelDelta: QPoint, angleDelta: QPoint, qt4Delta: cint, qt4Orientation: cint, buttons: cint, modifiers: cint): gen_qevent_types.QWheelEvent =
  gen_qevent_types.QWheelEvent.init(fcQWheelEvent_new3(pos.h, globalPos.h, pixelDelta.h, angleDelta.h, qt4Delta, cint(qt4Orientation), cint(buttons), cint(modifiers)))

proc create*(T: type gen_qevent_types.QWheelEvent, pos: QPointF, globalPos: QPointF, pixelDelta: QPoint, angleDelta: QPoint, qt4Delta: cint, qt4Orientation: cint, buttons: cint, modifiers: cint, phase: cint): gen_qevent_types.QWheelEvent =
  gen_qevent_types.QWheelEvent.init(fcQWheelEvent_new4(pos.h, globalPos.h, pixelDelta.h, angleDelta.h, qt4Delta, cint(qt4Orientation), cint(buttons), cint(modifiers), cint(phase)))

proc create*(T: type gen_qevent_types.QWheelEvent, pos: QPointF, globalPos: QPointF, pixelDelta: QPoint, angleDelta: QPoint, qt4Delta: cint, qt4Orientation: cint, buttons: cint, modifiers: cint, phase: cint, source: cint): gen_qevent_types.QWheelEvent =
  gen_qevent_types.QWheelEvent.init(fcQWheelEvent_new5(pos.h, globalPos.h, pixelDelta.h, angleDelta.h, qt4Delta, cint(qt4Orientation), cint(buttons), cint(modifiers), cint(phase), cint(source)))

proc create*(T: type gen_qevent_types.QWheelEvent, pos: QPointF, globalPos: QPointF, pixelDelta: QPoint, angleDelta: QPoint, qt4Delta: cint, qt4Orientation: cint, buttons: cint, modifiers: cint, phase: cint, source: cint, inverted: bool): gen_qevent_types.QWheelEvent =
  gen_qevent_types.QWheelEvent.init(fcQWheelEvent_new6(pos.h, globalPos.h, pixelDelta.h, angleDelta.h, qt4Delta, cint(qt4Orientation), cint(buttons), cint(modifiers), cint(phase), cint(source), inverted))

proc create*(T: type gen_qevent_types.QWheelEvent, pos: QPointF, globalPos: QPointF, pixelDelta: QPoint, angleDelta: QPoint, buttons: cint, modifiers: cint, phase: cint, inverted: bool): gen_qevent_types.QWheelEvent =
  gen_qevent_types.QWheelEvent.init(fcQWheelEvent_new7(pos.h, globalPos.h, pixelDelta.h, angleDelta.h, cint(buttons), cint(modifiers), cint(phase), inverted))

proc create*(T: type gen_qevent_types.QWheelEvent, param1: QWheelEvent): gen_qevent_types.QWheelEvent =
  gen_qevent_types.QWheelEvent.init(fcQWheelEvent_new8(param1.h))

proc create*(T: type gen_qevent_types.QWheelEvent, pos: QPointF, delta: cint, buttons: cint, modifiers: cint, orient: cint): gen_qevent_types.QWheelEvent =
  gen_qevent_types.QWheelEvent.init(fcQWheelEvent_new9(pos.h, delta, cint(buttons), cint(modifiers), cint(orient)))

proc create*(T: type gen_qevent_types.QWheelEvent, pos: QPointF, globalPos: QPointF, delta: cint, buttons: cint, modifiers: cint, orient: cint): gen_qevent_types.QWheelEvent =
  gen_qevent_types.QWheelEvent.init(fcQWheelEvent_new10(pos.h, globalPos.h, delta, cint(buttons), cint(modifiers), cint(orient)))

proc create*(T: type gen_qevent_types.QWheelEvent, pos: QPointF, globalPos: QPointF, pixelDelta: QPoint, angleDelta: QPoint, buttons: cint, modifiers: cint, phase: cint, inverted: bool, source: cint): gen_qevent_types.QWheelEvent =
  gen_qevent_types.QWheelEvent.init(fcQWheelEvent_new11(pos.h, globalPos.h, pixelDelta.h, angleDelta.h, cint(buttons), cint(modifiers), cint(phase), inverted, cint(source)))

proc pixelDelta*(self: gen_qevent_types.QWheelEvent, ): QPoint =
  QPoint(h: fcQWheelEvent_pixelDelta(self.h))

proc angleDelta*(self: gen_qevent_types.QWheelEvent, ): QPoint =
  QPoint(h: fcQWheelEvent_angleDelta(self.h))
...
proc pos*(self: gen_qevent_types.QWheelEvent, ): QPoint =
  QPoint(h: fcQWheelEvent_pos(self.h))

proc globalPos*(self: gen_qevent_types.QWheelEvent, ): QPoint =
  QPoint(h: fcQWheelEvent_globalPos(self.h))
...
proc posF*(self: gen_qevent_types.QWheelEvent, ): QPointF =
  QPointF(h: fcQWheelEvent_posF(self.h))

proc globalPosF*(self: gen_qevent_types.QWheelEvent, ): QPointF =
  QPointF(h: fcQWheelEvent_globalPosF(self.h))

proc position*(self: gen_qevent_types.QWheelEvent, ): QPointF =
  QPointF(h: fcQWheelEvent_position(self.h))

proc globalPosition*(self: gen_qevent_types.QWheelEvent, ): QPointF =
  QPointF(h: fcQWheelEvent_globalPosition(self.h))
...
func init*(T: type gen_qevent_types.QTabletEvent, h: ptr cQTabletEvent): gen_qevent_types.QTabletEvent =
  T(h: h)
proc create*(T: type gen_qevent_types.QTabletEvent, t: cint, pos: QPointF, globalPos: QPointF, device: cint, pointerType: cint, pressure: float64, xTilt: cint, yTilt: cint, tangentialPressure: float64, rotation: float64, z: cint, keyState: cint, uniqueID: clonglong): gen_qevent_types.QTabletEvent =
  gen_qevent_types.QTabletEvent.init(fcQTabletEvent_new(cint(t), pos.h, globalPos.h, device, pointerType, pressure, xTilt, yTilt, tangentialPressure, rotation, z, cint(keyState), uniqueID))

proc create*(T: type gen_qevent_types.QTabletEvent, t: cint, pos: QPointF, globalPos: QPointF, device: cint, pointerType: cint, pressure: float64, xTilt: cint, yTilt: cint, tangentialPressure: float64, rotation: float64, z: cint, keyState: cint, uniqueID: clonglong, button: cint, buttons: cint): gen_qevent_types.QTabletEvent =
  gen_qevent_types.QTabletEvent.init(fcQTabletEvent_new2(cint(t), pos.h, globalPos.h, device, pointerType, pressure, xTilt, yTilt, tangentialPressure, rotation, z, cint(keyState), uniqueID, cint(button), cint(buttons)))

proc create*(T: type gen_qevent_types.QTabletEvent, param1: QTabletEvent): gen_qevent_types.QTabletEvent =
  gen_qevent_types.QTabletEvent.init(fcQTabletEvent_new3(param1.h))

proc pos*(self: gen_qevent_types.QTabletEvent, ): QPoint =
  QPoint(h: fcQTabletEvent_pos(self.h))

proc globalPos*(self: gen_qevent_types.QTabletEvent, ): QPoint =
  QPoint(h: fcQTabletEvent_globalPos(self.h))

proc posF*(self: gen_qevent_types.QTabletEvent, ): QPointF =
  QPointF(h: fcQTabletEvent_posF(self.h))

proc globalPosF*(self: gen_qevent_types.QTabletEvent, ): QPointF =
  QPointF(h: fcQTabletEvent_globalPosF(self.h))
...
func init*(T: type gen_qevent_types.QNativeGestureEvent, h: ptr cQNativeGestureEvent): gen_qevent_types.QNativeGestureEvent =
  T(h: h)
proc create*(T: type gen_qevent_types.QNativeGestureEvent, typeVal: cint, localPos: QPointF, windowPos: QPointF, screenPos: QPointF, value: float64, sequenceId: culong, intArgument: culonglong): gen_qevent_types.QNativeGestureEvent =
  gen_qevent_types.QNativeGestureEvent.init(fcQNativeGestureEvent_new(cint(typeVal), localPos.h, windowPos.h, screenPos.h, value, sequenceId, intArgument))

proc create*(T: type gen_qevent_types.QNativeGestureEvent, typeVal: cint, dev: QTouchDevice, localPos: QPointF, windowPos: QPointF, screenPos: QPointF, value: float64, sequenceId: culong, intArgument: culonglong): gen_qevent_types.QNativeGestureEvent =
  gen_qevent_types.QNativeGestureEvent.init(fcQNativeGestureEvent_new2(cint(typeVal), dev.h, localPos.h, windowPos.h, screenPos.h, value, sequenceId, intArgument))

proc create*(T: type gen_qevent_types.QNativeGestureEvent, param1: QNativeGestureEvent): gen_qevent_types.QNativeGestureEvent =
  gen_qevent_types.QNativeGestureEvent.init(fcQNativeGestureEvent_new3(param1.h))
...
proc pos*(self: gen_qevent_types.QNativeGestureEvent, ): QPoint =
  QPoint(h: fcQNativeGestureEvent_pos(self.h))

proc globalPos*(self: gen_qevent_types.QNativeGestureEvent, ): QPoint =
  QPoint(h: fcQNativeGestureEvent_globalPos(self.h))

proc localPos*(self: gen_qevent_types.QNativeGestureEvent, ): QPointF =
  QPointF(h: fcQNativeGestureEvent_localPos(self.h))

proc windowPos*(self: gen_qevent_types.QNativeGestureEvent, ): QPointF =
  QPointF(h: fcQNativeGestureEvent_windowPos(self.h))

proc screenPos*(self: gen_qevent_types.QNativeGestureEvent, ): QPointF =
  QPointF(h: fcQNativeGestureEvent_screenPos(self.h))

proc device*(self: gen_qevent_types.QNativeGestureEvent, ): QTouchDevice =
  QTouchDevice(h: fcQNativeGestureEvent_device(self.h))
...
proc create*(T: type gen_qevent_types.QKeyEvent, param1: QKeyEvent): gen_qevent_types.QKeyEvent =
  gen_qevent_types.QKeyEvent.init(fcQKeyEvent_new3(param1.h))
...
proc create*(T: type gen_qevent_types.QKeyEvent, typeVal: cint, key: cint, modifiers: cint, text: string): gen_qevent_types.QKeyEvent =
  gen_qevent_types.QKeyEvent.init(fcQKeyEvent_new4(cint(typeVal), key, cint(modifiers), struct_miqt_string(data: text, len: csize_t(len(text)))))
...
proc create*(T: type gen_qevent_types.QKeyEvent, typeVal: cint, key: cint, modifiers: cint, text: string, autorep: bool): gen_qevent_types.QKeyEvent =
  gen_qevent_types.QKeyEvent.init(fcQKeyEvent_new5(cint(typeVal), key, cint(modifiers), struct_miqt_string(data: text, len: csize_t(len(text))), autorep))
...
proc create*(T: type gen_qevent_types.QKeyEvent, typeVal: cint, key: cint, modifiers: cint, text: string, autorep: bool, count: cushort): gen_qevent_types.QKeyEvent =
  gen_qevent_types.QKeyEvent.init(fcQKeyEvent_new6(cint(typeVal), key, cint(modifiers), struct_miqt_string(data: text, len: csize_t(len(text))), autorep, count))
...
proc create*(T: type gen_qevent_types.QKeyEvent, typeVal: cint, key: cint, modifiers: cint, nativeScanCode: cuint, nativeVirtualKey: cuint, nativeModifiers: cuint, text: string): gen_qevent_types.QKeyEvent =
  gen_qevent_types.QKeyEvent.init(fcQKeyEvent_new7(cint(typeVal), key, cint(modifiers), nativeScanCode, nativeVirtualKey, nativeModifiers, struct_miqt_string(data: text, len: csize_t(len(text)))))
...
proc create*(T: type gen_qevent_types.QKeyEvent, typeVal: cint, key: cint, modifiers: cint, nativeScanCode: cuint, nativeVirtualKey: cuint, nativeModifiers: cuint, text: string, autorep: bool): gen_qevent_types.QKeyEvent =
  gen_qevent_types.QKeyEvent.init(fcQKeyEvent_new8(cint(typeVal), key, cint(modifiers), nativeScanCode, nativeVirtualKey, nativeModifiers, struct_miqt_string(data: text, len: csize_t(len(text))), autorep))
...
proc create*(T: type gen_qevent_types.QKeyEvent, typeVal: cint, key: cint, modifiers: cint, nativeScanCode: cuint, nativeVirtualKey: cuint, nativeModifiers: cuint, text: string, autorep: bool, count: cushort): gen_qevent_types.QKeyEvent =
  gen_qevent_types.QKeyEvent.init(fcQKeyEvent_new9(cint(typeVal), key, cint(modifiers), nativeScanCode, nativeVirtualKey, nativeModifiers, struct_miqt_string(data: text, len: csize_t(len(text))), autorep, count))
...
proc create*(T: type gen_qevent_types.QFocusEvent, param1: QFocusEvent): gen_qevent_types.QFocusEvent =
  gen_qevent_types.QFocusEvent.init(fcQFocusEvent_new2(param1.h))

proc create*(T: type gen_qevent_types.QFocusEvent, typeVal: cint, reason: cint): gen_qevent_types.QFocusEvent =
  gen_qevent_types.QFocusEvent.init(fcQFocusEvent_new3(cint(typeVal), cint(reason)))
...
func init*(T: type gen_qevent_types.QPaintEvent, h: ptr cQPaintEvent): gen_qevent_types.QPaintEvent =
  T(h: h)
proc create*(T: type gen_qevent_types.QPaintEvent, paintRegion: QRegion): gen_qevent_types.QPaintEvent =
  gen_qevent_types.QPaintEvent.init(fcQPaintEvent_new(paintRegion.h))

proc create*(T: type gen_qevent_types.QPaintEvent, paintRect: QRect): gen_qevent_types.QPaintEvent =
  gen_qevent_types.QPaintEvent.init(fcQPaintEvent_new2(paintRect.h))

proc create*(T: type gen_qevent_types.QPaintEvent, param1: QPaintEvent): gen_qevent_types.QPaintEvent =
  gen_qevent_types.QPaintEvent.init(fcQPaintEvent_new3(param1.h))

proc rect*(self: gen_qevent_types.QPaintEvent, ): QRect =
  QRect(h: fcQPaintEvent_rect(self.h))

proc region*(self: gen_qevent_types.QPaintEvent, ): QRegion =
  QRegion(h: fcQPaintEvent_region(self.h))
...
func init*(T: type gen_qevent_types.QMoveEvent, h: ptr cQMoveEvent): gen_qevent_types.QMoveEvent =
  T(h: h)
proc create*(T: type gen_qevent_types.QMoveEvent, pos: QPoint, oldPos: QPoint): gen_qevent_types.QMoveEvent =
  gen_qevent_types.QMoveEvent.init(fcQMoveEvent_new(pos.h, oldPos.h))

proc create*(T: type gen_qevent_types.QMoveEvent, param1: QMoveEvent): gen_qevent_types.QMoveEvent =
  gen_qevent_types.QMoveEvent.init(fcQMoveEvent_new2(param1.h))

proc pos*(self: gen_qevent_types.QMoveEvent, ): QPoint =
  QPoint(h: fcQMoveEvent_pos(self.h))

proc oldPos*(self: gen_qevent_types.QMoveEvent, ): QPoint =
  QPoint(h: fcQMoveEvent_oldPos(self.h))
...
func init*(T: type gen_qevent_types.QExposeEvent, h: ptr cQExposeEvent): gen_qevent_types.QExposeEvent =
  T(h: h)
proc create*(T: type gen_qevent_types.QExposeEvent, rgn: QRegion): gen_qevent_types.QExposeEvent =
  gen_qevent_types.QExposeEvent.init(fcQExposeEvent_new(rgn.h))

proc create*(T: type gen_qevent_types.QExposeEvent, param1: QExposeEvent): gen_qevent_types.QExposeEvent =
  gen_qevent_types.QExposeEvent.init(fcQExposeEvent_new2(param1.h))

proc region*(self: gen_qevent_types.QExposeEvent, ): QRegion =
  QRegion(h: fcQExposeEvent_region(self.h))
...
proc create*(T: type gen_qevent_types.QPlatformSurfaceEvent, param1: QPlatformSurfaceEvent): gen_qevent_types.QPlatformSurfaceEvent =
  gen_qevent_types.QPlatformSurfaceEvent.init(fcQPlatformSurfaceEvent_new2(param1.h))
...
func init*(T: type gen_qevent_types.QResizeEvent, h: ptr cQResizeEvent): gen_qevent_types.QResizeEvent =
  T(h: h)
proc create*(T: type gen_qevent_types.QResizeEvent, size: QSize, oldSize: QSize): gen_qevent_types.QResizeEvent =
  gen_qevent_types.QResizeEvent.init(fcQResizeEvent_new(size.h, oldSize.h))

proc create*(T: type gen_qevent_types.QResizeEvent, param1: QResizeEvent): gen_qevent_types.QResizeEvent =
  gen_qevent_types.QResizeEvent.init(fcQResizeEvent_new2(param1.h))

proc size*(self: gen_qevent_types.QResizeEvent, ): QSize =
  QSize(h: fcQResizeEvent_size(self.h))

proc oldSize*(self: gen_qevent_types.QResizeEvent, ): QSize =
  QSize(h: fcQResizeEvent_oldSize(self.h))
...
proc create*(T: type gen_qevent_types.QCloseEvent, param1: QCloseEvent): gen_qevent_types.QCloseEvent =
  gen_qevent_types.QCloseEvent.init(fcQCloseEvent_new2(param1.h))

proc operatorAssign*(self: gen_qevent_types.QCloseEvent, param1: QCloseEvent): void =
...
proc create*(T: type gen_qevent_types.QIconDragEvent, param1: QIconDragEvent): gen_qevent_types.QIconDragEvent =
  gen_qevent_types.QIconDragEvent.init(fcQIconDragEvent_new2(param1.h))

proc operatorAssign*(self: gen_qevent_types.QIconDragEvent, param1: QIconDragEvent): void =
...
proc create*(T: type gen_qevent_types.QShowEvent, param1: QShowEvent): gen_qevent_types.QShowEvent =
  gen_qevent_types.QShowEvent.init(fcQShowEvent_new2(param1.h))

proc operatorAssign*(self: gen_qevent_types.QShowEvent, param1: QShowEvent): void =
...
proc create*(T: type gen_qevent_types.QHideEvent, param1: QHideEvent): gen_qevent_types.QHideEvent =
  gen_qevent_types.QHideEvent.init(fcQHideEvent_new2(param1.h))

proc operatorAssign*(self: gen_qevent_types.QHideEvent, param1: QHideEvent): void =
...
func init*(T: type gen_qevent_types.QContextMenuEvent, h: ptr cQContextMenuEvent): gen_qevent_types.QContextMenuEvent =
  T(h: h)
proc create*(T: type gen_qevent_types.QContextMenuEvent, reason: cint, pos: QPoint, globalPos: QPoint, modifiers: cint): gen_qevent_types.QContextMenuEvent =
  gen_qevent_types.QContextMenuEvent.init(fcQContextMenuEvent_new(cint(reason), pos.h, globalPos.h, cint(modifiers)))

proc create*(T: type gen_qevent_types.QContextMenuEvent, reason: cint, pos: QPoint, globalPos: QPoint): gen_qevent_types.QContextMenuEvent =
  gen_qevent_types.QContextMenuEvent.init(fcQContextMenuEvent_new2(cint(reason), pos.h, globalPos.h))

proc create*(T: type gen_qevent_types.QContextMenuEvent, reason: cint, pos: QPoint): gen_qevent_types.QContextMenuEvent =
  gen_qevent_types.QContextMenuEvent.init(fcQContextMenuEvent_new3(cint(reason), pos.h))

proc create*(T: type gen_qevent_types.QContextMenuEvent, param1: QContextMenuEvent): gen_qevent_types.QContextMenuEvent =
  gen_qevent_types.QContextMenuEvent.init(fcQContextMenuEvent_new4(param1.h))
...
proc pos*(self: gen_qevent_types.QContextMenuEvent, ): QPoint =
  QPoint(h: fcQContextMenuEvent_pos(self.h))

proc globalPos*(self: gen_qevent_types.QContextMenuEvent, ): QPoint =
  QPoint(h: fcQContextMenuEvent_globalPos(self.h))
...
proc create*(T: type gen_qevent_types.QInputMethodEvent, preeditText: string, attributes: seq[QInputMethodEventAttribute]): gen_qevent_types.QInputMethodEvent =
...
proc create*(T: type gen_qevent_types.QInputMethodEvent, other: QInputMethodEvent): gen_qevent_types.QInputMethodEvent =
  gen_qevent_types.QInputMethodEvent.init(fcQInputMethodEvent_new3(other.h))
...
proc attributes*(self: gen_qevent_types.QInputMethodEvent, ): seq[QInputMethodEventAttribute] =
...
proc create*(T: type gen_qevent_types.QInputMethodQueryEvent, param1: QInputMethodQueryEvent): gen_qevent_types.QInputMethodQueryEvent =
  gen_qevent_types.QInputMethodQueryEvent.init(fcQInputMethodQueryEvent_new2(param1.h))

proc queries*(self: gen_qevent_types.QInputMethodQueryEvent, ): cint =
  cint(fcQInputMethodQueryEvent_queries(self.h))

proc setValue*(self: gen_qevent_types.QInputMethodQueryEvent, query: cint, value: QVariant): void =
  fcQInputMethodQueryEvent_setValue(self.h, cint(query), value.h)

proc value*(self: gen_qevent_types.QInputMethodQueryEvent, query: cint): QVariant =
  QVariant(h: fcQInputMethodQueryEvent_value(self.h, cint(query)))
...
func init*(T: type gen_qevent_types.QDropEvent, h: ptr cQDropEvent): gen_qevent_types.QDropEvent =
  T(h: h)
proc create*(T: type gen_qevent_types.QDropEvent, pos: QPointF, actions: cint, data: QMimeData, buttons: cint, modifiers: cint): gen_qevent_types.QDropEvent =
  gen_qevent_types.QDropEvent.init(fcQDropEvent_new(pos.h, cint(actions), data.h, cint(buttons), cint(modifiers)))

proc create*(T: type gen_qevent_types.QDropEvent, param1: QDropEvent): gen_qevent_types.QDropEvent =
  gen_qevent_types.QDropEvent.init(fcQDropEvent_new2(param1.h))

proc create*(T: type gen_qevent_types.QDropEvent, pos: QPointF, actions: cint, data: QMimeData, buttons: cint, modifiers: cint, typeVal: cint): gen_qevent_types.QDropEvent =
  gen_qevent_types.QDropEvent.init(fcQDropEvent_new3(pos.h, cint(actions), data.h, cint(buttons), cint(modifiers), cint(typeVal)))

proc pos*(self: gen_qevent_types.QDropEvent, ): QPoint =
  QPoint(h: fcQDropEvent_pos(self.h))

proc posF*(self: gen_qevent_types.QDropEvent, ): QPointF =
  QPointF(h: fcQDropEvent_posF(self.h))
...
proc source*(self: gen_qevent_types.QDropEvent, ): QObject =
  QObject(h: fcQDropEvent_source(self.h))

proc mimeData*(self: gen_qevent_types.QDropEvent, ): QMimeData =
  QMimeData(h: fcQDropEvent_mimeData(self.h))
...
func init*(T: type gen_qevent_types.QDragMoveEvent, h: ptr cQDragMoveEvent): gen_qevent_types.QDragMoveEvent =
  T(h: h)
proc create*(T: type gen_qevent_types.QDragMoveEvent, pos: QPoint, actions: cint, data: QMimeData, buttons: cint, modifiers: cint): gen_qevent_types.QDragMoveEvent =
  gen_qevent_types.QDragMoveEvent.init(fcQDragMoveEvent_new(pos.h, cint(actions), data.h, cint(buttons), cint(modifiers)))

proc create*(T: type gen_qevent_types.QDragMoveEvent, param1: QDragMoveEvent): gen_qevent_types.QDragMoveEvent =
  gen_qevent_types.QDragMoveEvent.init(fcQDragMoveEvent_new2(param1.h))

proc create*(T: type gen_qevent_types.QDragMoveEvent, pos: QPoint, actions: cint, data: QMimeData, buttons: cint, modifiers: cint, typeVal: cint): gen_qevent_types.QDragMoveEvent =
  gen_qevent_types.QDragMoveEvent.init(fcQDragMoveEvent_new3(pos.h, cint(actions), data.h, cint(buttons), cint(modifiers), cint(typeVal)))

proc answerRect*(self: gen_qevent_types.QDragMoveEvent, ): QRect =
  QRect(h: fcQDragMoveEvent_answerRect(self.h))
...
proc accept*(self: gen_qevent_types.QDragMoveEvent, r: QRect): void =
  fcQDragMoveEvent_acceptWithQRect(self.h, r.h)

proc ignore*(self: gen_qevent_types.QDragMoveEvent, r: QRect): void =
...
func init*(T: type gen_qevent_types.QDragEnterEvent, h: ptr cQDragEnterEvent): gen_qevent_types.QDragEnterEvent =
  T(h: h)
proc create*(T: type gen_qevent_types.QDragEnterEvent, pos: QPoint, actions: cint, data: QMimeData, buttons: cint, modifiers: cint): gen_qevent_types.QDragEnterEvent =
  gen_qevent_types.QDragEnterEvent.init(fcQDragEnterEvent_new(pos.h, cint(actions), data.h, cint(buttons), cint(modifiers)))

proc create*(T: type gen_qevent_types.QDragEnterEvent, param1: QDragEnterEvent): gen_qevent_types.QDragEnterEvent =
  gen_qevent_types.QDragEnterEvent.init(fcQDragEnterEvent_new2(param1.h))

proc operatorAssign*(self: gen_qevent_types.QDragEnterEvent, param1: QDragEnterEvent): void =
...
proc create*(T: type gen_qevent_types.QDragLeaveEvent, param1: QDragLeaveEvent): gen_qevent_types.QDragLeaveEvent =
  gen_qevent_types.QDragLeaveEvent.init(fcQDragLeaveEvent_new2(param1.h))

proc operatorAssign*(self: gen_qevent_types.QDragLeaveEvent, param1: QDragLeaveEvent): void =
...
func init*(T: type gen_qevent_types.QHelpEvent, h: ptr cQHelpEvent): gen_qevent_types.QHelpEvent =
  T(h: h)
proc create*(T: type gen_qevent_types.QHelpEvent, typeVal: cint, pos: QPoint, globalPos: QPoint): gen_qevent_types.QHelpEvent =
  gen_qevent_types.QHelpEvent.init(fcQHelpEvent_new(cint(typeVal), pos.h, globalPos.h))

proc create*(T: type gen_qevent_types.QHelpEvent, param1: QHelpEvent): gen_qevent_types.QHelpEvent =
  gen_qevent_types.QHelpEvent.init(fcQHelpEvent_new2(param1.h))
...
proc pos*(self: gen_qevent_types.QHelpEvent, ): QPoint =
  QPoint(h: fcQHelpEvent_pos(self.h))

proc globalPos*(self: gen_qevent_types.QHelpEvent, ): QPoint =
  QPoint(h: fcQHelpEvent_globalPos(self.h))
...
proc create*(T: type gen_qevent_types.QStatusTipEvent, param1: QStatusTipEvent): gen_qevent_types.QStatusTipEvent =
  gen_qevent_types.QStatusTipEvent.init(fcQStatusTipEvent_new2(param1.h))
...
proc create*(T: type gen_qevent_types.QWhatsThisClickedEvent, param1: QWhatsThisClickedEvent): gen_qevent_types.QWhatsThisClickedEvent =
  gen_qevent_types.QWhatsThisClickedEvent.init(fcQWhatsThisClickedEvent_new2(param1.h))
...
func init*(T: type gen_qevent_types.QActionEvent, h: ptr cQActionEvent): gen_qevent_types.QActionEvent =
  T(h: h)
proc create*(T: type gen_qevent_types.QActionEvent, param1: QActionEvent): gen_qevent_types.QActionEvent =
  gen_qevent_types.QActionEvent.init(fcQActionEvent_new(param1.h))

proc operatorAssign*(self: gen_qevent_types.QActionEvent, param1: QActionEvent): void =
...
proc create*(T: type gen_qevent_types.QFileOpenEvent, url: QUrl): gen_qevent_types.QFileOpenEvent =
  gen_qevent_types.QFileOpenEvent.init(fcQFileOpenEvent_new2(url.h))

proc create*(T: type gen_qevent_types.QFileOpenEvent, param1: QFileOpenEvent): gen_qevent_types.QFileOpenEvent =
  gen_qevent_types.QFileOpenEvent.init(fcQFileOpenEvent_new3(param1.h))
...
proc url*(self: gen_qevent_types.QFileOpenEvent, ): QUrl =
  QUrl(h: fcQFileOpenEvent_url(self.h))

proc openFile*(self: gen_qevent_types.QFileOpenEvent, file: QFile, flags: cint): bool =
...
proc create*(T: type gen_qevent_types.QToolBarChangeEvent, param1: QToolBarChangeEvent): gen_qevent_types.QToolBarChangeEvent =
  gen_qevent_types.QToolBarChangeEvent.init(fcQToolBarChangeEvent_new2(param1.h))
...
func init*(T: type gen_qevent_types.QShortcutEvent, h: ptr cQShortcutEvent): gen_qevent_types.QShortcutEvent =
  T(h: h)
proc create*(T: type gen_qevent_types.QShortcutEvent, key: QKeySequence, id: cint): gen_qevent_types.QShortcutEvent =
  gen_qevent_types.QShortcutEvent.init(fcQShortcutEvent_new(key.h, id))

proc create*(T: type gen_qevent_types.QShortcutEvent, param1: QShortcutEvent): gen_qevent_types.QShortcutEvent =
  gen_qevent_types.QShortcutEvent.init(fcQShortcutEvent_new2(param1.h))

proc create*(T: type gen_qevent_types.QShortcutEvent, key: QKeySequence, id: cint, ambiguous: bool): gen_qevent_types.QShortcutEvent =
  gen_qevent_types.QShortcutEvent.init(fcQShortcutEvent_new3(key.h, id, ambiguous))

proc key*(self: gen_qevent_types.QShortcutEvent, ): QKeySequence =
  QKeySequence(h: fcQShortcutEvent_key(self.h))
...
func init*(T: type gen_qevent_types.QWindowStateChangeEvent, h: ptr cQWindowStateChangeEvent): gen_qevent_types.QWindowStateChangeEvent =
  T(h: h)
proc create*(T: type gen_qevent_types.QWindowStateChangeEvent, aOldState: cint): gen_qevent_types.QWindowStateChangeEvent =
  gen_qevent_types.QWindowStateChangeEvent.init(fcQWindowStateChangeEvent_new(cint(aOldState)))

proc create*(T: type gen_qevent_types.QWindowStateChangeEvent, param1: QWindowStateChangeEvent): gen_qevent_types.QWindowStateChangeEvent =
  gen_qevent_types.QWindowStateChangeEvent.init(fcQWindowStateChangeEvent_new2(param1.h))

proc create*(T: type gen_qevent_types.QWindowStateChangeEvent, aOldState: cint, isOverride: bool): gen_qevent_types.QWindowStateChangeEvent =
  gen_qevent_types.QWindowStateChangeEvent.init(fcQWindowStateChangeEvent_new3(cint(aOldState), isOverride))
...
func init*(T: type gen_qevent_types.QPointingDeviceUniqueId, h: ptr cQPointingDeviceUniqueId): gen_qevent_types.QPointingDeviceUniqueId =
  T(h: h)
proc create*(T: type gen_qevent_types.QPointingDeviceUniqueId, ): gen_qevent_types.QPointingDeviceUniqueId =
  gen_qevent_types.QPointingDeviceUniqueId.init(fcQPointingDeviceUniqueId_new())

proc create*(T: type gen_qevent_types.QPointingDeviceUniqueId, param1: QPointingDeviceUniqueId): gen_qevent_types.QPointingDeviceUniqueId =
  gen_qevent_types.QPointingDeviceUniqueId.init(fcQPointingDeviceUniqueId_new2(param1.h))

proc fromNumericId*(_: type gen_qevent_types.QPointingDeviceUniqueId, id: clonglong): QPointingDeviceUniqueId =
...
proc create*(T: type gen_qevent_types.QTouchEvent, param1: QTouchEvent): gen_qevent_types.QTouchEvent =
  gen_qevent_types.QTouchEvent.init(fcQTouchEvent_new2(param1.h))

proc create*(T: type gen_qevent_types.QTouchEvent, eventType: cint, device: QTouchDevice): gen_qevent_types.QTouchEvent =
  gen_qevent_types.QTouchEvent.init(fcQTouchEvent_new3(cint(eventType), device.h))

proc create*(T: type gen_qevent_types.QTouchEvent, eventType: cint, device: QTouchDevice, modifiers: cint): gen_qevent_types.QTouchEvent =
  gen_qevent_types.QTouchEvent.init(fcQTouchEvent_new4(cint(eventType), device.h, cint(modifiers)))

proc create*(T: type gen_qevent_types.QTouchEvent, eventType: cint, device: QTouchDevice, modifiers: cint, touchPointStates: cint): gen_qevent_types.QTouchEvent =
  gen_qevent_types.QTouchEvent.init(fcQTouchEvent_new5(cint(eventType), device.h, cint(modifiers), cint(touchPointStates)))

proc create*(T: type gen_qevent_types.QTouchEvent, eventType: cint, device: QTouchDevice, modifiers: cint, touchPointStates: cint, touchPoints: seq[QTouchEventTouchPoint]): gen_qevent_types.QTouchEvent =
...
proc window*(self: gen_qevent_types.QTouchEvent, ): QWindow =
  QWindow(h: fcQTouchEvent_window(self.h))

proc target*(self: gen_qevent_types.QTouchEvent, ): QObject =
  QObject(h: fcQTouchEvent_target(self.h))

proc touchPointStates*(self: gen_qevent_types.QTouchEvent, ): cint =
  cint(fcQTouchEvent_touchPointStates(self.h))

proc touchPoints*(self: gen_qevent_types.QTouchEvent, ): seq[QTouchEventTouchPoint] =
...
proc device*(self: gen_qevent_types.QTouchEvent, ): QTouchDevice =
  QTouchDevice(h: fcQTouchEvent_device(self.h))

proc setWindow*(self: gen_qevent_types.QTouchEvent, awindow: QWindow): void =
  fcQTouchEvent_setWindow(self.h, awindow.h)

proc setTarget*(self: gen_qevent_types.QTouchEvent, atarget: QObject): void =
...
proc setTouchPoints*(self: gen_qevent_types.QTouchEvent, atouchPoints: seq[QTouchEventTouchPoint]): void =
...
proc setDevice*(self: gen_qevent_types.QTouchEvent, adevice: QTouchDevice): void =
...
func init*(T: type gen_qevent_types.QScrollPrepareEvent, h: ptr cQScrollPrepareEvent): gen_qevent_types.QScrollPrepareEvent =
  T(h: h)
proc create*(T: type gen_qevent_types.QScrollPrepareEvent, startPos: QPointF): gen_qevent_types.QScrollPrepareEvent =
  gen_qevent_types.QScrollPrepareEvent.init(fcQScrollPrepareEvent_new(startPos.h))

proc create*(T: type gen_qevent_types.QScrollPrepareEvent, param1: QScrollPrepareEvent): gen_qevent_types.QScrollPrepareEvent =
  gen_qevent_types.QScrollPrepareEvent.init(fcQScrollPrepareEvent_new2(param1.h))

proc startPos*(self: gen_qevent_types.QScrollPrepareEvent, ): QPointF =
  QPointF(h: fcQScrollPrepareEvent_startPos(self.h))

proc viewportSize*(self: gen_qevent_types.QScrollPrepareEvent, ): QSizeF =
  QSizeF(h: fcQScrollPrepareEvent_viewportSize(self.h))

proc contentPosRange*(self: gen_qevent_types.QScrollPrepareEvent, ): QRectF =
  QRectF(h: fcQScrollPrepareEvent_contentPosRange(self.h))

proc contentPos*(self: gen_qevent_types.QScrollPrepareEvent, ): QPointF =
  QPointF(h: fcQScrollPrepareEvent_contentPos(self.h))

proc setViewportSize*(self: gen_qevent_types.QScrollPrepareEvent, size: QSizeF): void =
  fcQScrollPrepareEvent_setViewportSize(self.h, size.h)

proc setContentPosRange*(self: gen_qevent_types.QScrollPrepareEvent, rect: QRectF): void =
  fcQScrollPrepareEvent_setContentPosRange(self.h, rect.h)

proc setContentPos*(self: gen_qevent_types.QScrollPrepareEvent, pos: QPointF): void =
...
func init*(T: type gen_qevent_types.QScrollEvent, h: ptr cQScrollEvent): gen_qevent_types.QScrollEvent =
  T(h: h)
proc create*(T: type gen_qevent_types.QScrollEvent, contentPos: QPointF, overshoot: QPointF, scrollState: cint): gen_qevent_types.QScrollEvent =
  gen_qevent_types.QScrollEvent.init(fcQScrollEvent_new(contentPos.h, overshoot.h, cint(scrollState)))

proc create*(T: type gen_qevent_types.QScrollEvent, param1: QScrollEvent): gen_qevent_types.QScrollEvent =
  gen_qevent_types.QScrollEvent.init(fcQScrollEvent_new2(param1.h))

proc contentPos*(self: gen_qevent_types.QScrollEvent, ): QPointF =
  QPointF(h: fcQScrollEvent_contentPos(self.h))

proc overshootDistance*(self: gen_qevent_types.QScrollEvent, ): QPointF =
  QPointF(h: fcQScrollEvent_overshootDistance(self.h))
...
func init*(T: type gen_qevent_types.QScreenOrientationChangeEvent, h: ptr cQScreenOrientationChangeEvent): gen_qevent_types.QScreenOrientationChangeEvent =
  T(h: h)
proc create*(T: type gen_qevent_types.QScreenOrientationChangeEvent, screen: QScreen, orientation: cint): gen_qevent_types.QScreenOrientationChangeEvent =
  gen_qevent_types.QScreenOrientationChangeEvent.init(fcQScreenOrientationChangeEvent_new(screen.h, cint(orientation)))

proc create*(T: type gen_qevent_types.QScreenOrientationChangeEvent, param1: QScreenOrientationChangeEvent): gen_qevent_types.QScreenOrientationChangeEvent =
  gen_qevent_types.QScreenOrientationChangeEvent.init(fcQScreenOrientationChangeEvent_new2(param1.h))

proc screen*(self: gen_qevent_types.QScreenOrientationChangeEvent, ): QScreen =
  QScreen(h: fcQScreenOrientationChangeEvent_screen(self.h))
...
proc create*(T: type gen_qevent_types.QApplicationStateChangeEvent, param1: QApplicationStateChangeEvent): gen_qevent_types.QApplicationStateChangeEvent =
  gen_qevent_types.QApplicationStateChangeEvent.init(fcQApplicationStateChangeEvent_new2(param1.h))
...
func init*(T: type gen_qevent_types.QInputMethodEventAttribute, h: ptr cQInputMethodEventAttribute): gen_qevent_types.QInputMethodEventAttribute =
  T(h: h)
proc create*(T: type gen_qevent_types.QInputMethodEventAttribute, typ: cint, s: cint, l: cint, val: QVariant): gen_qevent_types.QInputMethodEventAttribute =
...
proc create*(T: type gen_qevent_types.QInputMethodEventAttribute, param1: QInputMethodEventAttribute): gen_qevent_types.QInputMethodEventAttribute =
  gen_qevent_types.QInputMethodEventAttribute.init(fcQInputMethodEventAttribute_new3(param1.h))

proc operatorAssign*(self: gen_qevent_types.QInputMethodEventAttribute, param1: QInputMethodEventAttribute): void =
...
func init*(T: type gen_qevent_types.QTouchEventTouchPoint, h: ptr cQTouchEventTouchPoint): gen_qevent_types.QTouchEventTouchPoint =
  T(h: h)
proc create*(T: type gen_qevent_types.QTouchEventTouchPoint, ): gen_qevent_types.QTouchEventTouchPoint =
  gen_qevent_types.QTouchEventTouchPoint.init(fcQTouchEventTouchPoint_new())

proc create*(T: type gen_qevent_types.QTouchEventTouchPoint, other: QTouchEventTouchPoint): gen_qevent_types.QTouchEventTouchPoint =
  gen_qevent_types.QTouchEventTouchPoint.init(fcQTouchEventTouchPoint_new2(other.h))

proc create*(T: type gen_qevent_types.QTouchEventTouchPoint, id: cint): gen_qevent_types.QTouchEventTouchPoint =
  gen_qevent_types.QTouchEventTouchPoint.init(fcQTouchEventTouchPoint_new3(id))

proc operatorAssign*(self: gen_qevent_types.QTouchEventTouchPoint, other: QTouchEventTouchPoint): void =
  fcQTouchEventTouchPoint_operatorAssign(self.h, other.h)

proc swap*(self: gen_qevent_types.QTouchEventTouchPoint, other: QTouchEventTouchPoint): void =
...
proc uniqueId*(self: gen_qevent_types.QTouchEventTouchPoint, ): QPointingDeviceUniqueId =
...
proc pos*(self: gen_qevent_types.QTouchEventTouchPoint, ): QPointF =
  QPointF(h: fcQTouchEventTouchPoint_pos(self.h))

proc startPos*(self: gen_qevent_types.QTouchEventTouchPoint, ): QPointF =
  QPointF(h: fcQTouchEventTouchPoint_startPos(self.h))

proc lastPos*(self: gen_qevent_types.QTouchEventTouchPoint, ): QPointF =
  QPointF(h: fcQTouchEventTouchPoint_lastPos(self.h))

proc scenePos*(self: gen_qevent_types.QTouchEventTouchPoint, ): QPointF =
  QPointF(h: fcQTouchEventTouchPoint_scenePos(self.h))

proc startScenePos*(self: gen_qevent_types.QTouchEventTouchPoint, ): QPointF =
  QPointF(h: fcQTouchEventTouchPoint_startScenePos(self.h))

proc lastScenePos*(self: gen_qevent_types.QTouchEventTouchPoint, ): QPointF =
  QPointF(h: fcQTouchEventTouchPoint_lastScenePos(self.h))

proc screenPos*(self: gen_qevent_types.QTouchEventTouchPoint, ): QPointF =
  QPointF(h: fcQTouchEventTouchPoint_screenPos(self.h))

proc startScreenPos*(self: gen_qevent_types.QTouchEventTouchPoint, ): QPointF =
  QPointF(h: fcQTouchEventTouchPoint_startScreenPos(self.h))

proc lastScreenPos*(self: gen_qevent_types.QTouchEventTouchPoint, ): QPointF =
  QPointF(h: fcQTouchEventTouchPoint_lastScreenPos(self.h))

proc normalizedPos*(self: gen_qevent_types.QTouchEventTouchPoint, ): QPointF =
  QPointF(h: fcQTouchEventTouchPoint_normalizedPos(self.h))

proc startNormalizedPos*(self: gen_qevent_types.QTouchEventTouchPoint, ): QPointF =
  QPointF(h: fcQTouchEventTouchPoint_startNormalizedPos(self.h))

proc lastNormalizedPos*(self: gen_qevent_types.QTouchEventTouchPoint, ): QPointF =
  QPointF(h: fcQTouchEventTouchPoint_lastNormalizedPos(self.h))

proc rect*(self: gen_qevent_types.QTouchEventTouchPoint, ): QRectF =
  QRectF(h: fcQTouchEventTouchPoint_rect(self.h))

proc sceneRect*(self: gen_qevent_types.QTouchEventTouchPoint, ): QRectF =
  QRectF(h: fcQTouchEventTouchPoint_sceneRect(self.h))

proc screenRect*(self: gen_qevent_types.QTouchEventTouchPoint, ): QRectF =
  QRectF(h: fcQTouchEventTouchPoint_screenRect(self.h))

proc setRect*(self: gen_qevent_types.QTouchEventTouchPoint, rect: QRectF): void =
  fcQTouchEventTouchPoint_setRect(self.h, rect.h)

proc setSceneRect*(self: gen_qevent_types.QTouchEventTouchPoint, sceneRect: QRectF): void =
  fcQTouchEventTouchPoint_setSceneRect(self.h, sceneRect.h)

proc setScreenRect*(self: gen_qevent_types.QTouchEventTouchPoint, screenRect: QRectF): void =
...
proc ellipseDiameters*(self: gen_qevent_types.QTouchEventTouchPoint, ): QSizeF =
  QSizeF(h: fcQTouchEventTouchPoint_ellipseDiameters(self.h))

proc velocity*(self: gen_qevent_types.QTouchEventTouchPoint, ): QVector2D =
  QVector2D(h: fcQTouchEventTouchPoint_velocity(self.h))

proc flags*(self: gen_qevent_types.QTouchEventTouchPoint, ): cint =
  cint(fcQTouchEventTouchPoint_flags(self.h))

proc rawScreenPositions*(self: gen_qevent_types.QTouchEventTouchPoint, ): seq[QPointF] =
  var v_ma = fcQTouchEventTouchPoint_rawScreenPositions(self.h)
  var vx_ret = newSeq[QPointF](int(v_ma.len))
  let v_outCast = cast[ptr UncheckedArray[pointer]](v_ma.data)
  for i in 0 ..< v_ma.len:
    vx_ret[i] = QPointF(h: v_outCast[i])
  vx_ret
...
proc setPos*(self: gen_qevent_types.QTouchEventTouchPoint, pos: QPointF): void =
  fcQTouchEventTouchPoint_setPos(self.h, pos.h)

proc setScenePos*(self: gen_qevent_types.QTouchEventTouchPoint, scenePos: QPointF): void =
  fcQTouchEventTouchPoint_setScenePos(self.h, scenePos.h)

proc setScreenPos*(self: gen_qevent_types.QTouchEventTouchPoint, screenPos: QPointF): void =
  fcQTouchEventTouchPoint_setScreenPos(self.h, screenPos.h)

proc setNormalizedPos*(self: gen_qevent_types.QTouchEventTouchPoint, normalizedPos: QPointF): void =
  fcQTouchEventTouchPoint_setNormalizedPos(self.h, normalizedPos.h)

proc setStartPos*(self: gen_qevent_types.QTouchEventTouchPoint, startPos: QPointF): void =
  fcQTouchEventTouchPoint_setStartPos(self.h, startPos.h)

proc setStartScenePos*(self: gen_qevent_types.QTouchEventTouchPoint, startScenePos: QPointF): void =
  fcQTouchEventTouchPoint_setStartScenePos(self.h, startScenePos.h)

proc setStartScreenPos*(self: gen_qevent_types.QTouchEventTouchPoint, startScreenPos: QPointF): void =
  fcQTouchEventTouchPoint_setStartScreenPos(self.h, startScreenPos.h)

proc setStartNormalizedPos*(self: gen_qevent_types.QTouchEventTouchPoint, startNormalizedPos: QPointF): void =
  fcQTouchEventTouchPoint_setStartNormalizedPos(self.h, startNormalizedPos.h)

proc setLastPos*(self: gen_qevent_types.QTouchEventTouchPoint, lastPos: QPointF): void =
  fcQTouchEventTouchPoint_setLastPos(self.h, lastPos.h)

proc setLastScenePos*(self: gen_qevent_types.QTouchEventTouchPoint, lastScenePos: QPointF): void =
  fcQTouchEventTouchPoint_setLastScenePos(self.h, lastScenePos.h)

proc setLastScreenPos*(self: gen_qevent_types.QTouchEventTouchPoint, lastScreenPos: QPointF): void =
  fcQTouchEventTouchPoint_setLastScreenPos(self.h, lastScreenPos.h)

proc setLastNormalizedPos*(self: gen_qevent_types.QTouchEventTouchPoint, lastNormalizedPos: QPointF): void =
...
proc setEllipseDiameters*(self: gen_qevent_types.QTouchEventTouchPoint, dia: QSizeF): void =
  fcQTouchEventTouchPoint_setEllipseDiameters(self.h, dia.h)

proc setVelocity*(self: gen_qevent_types.QTouchEventTouchPoint, v: QVector2D): void =
...
proc setRawScreenPositions*(self: gen_qevent_types.QTouchEventTouchPoint, positions: seq[QPointF]): void =
...
proc delete*(self: gen_qevent_types.QTouchEventTouchPoint) =
