...
func init*(T: type gen_qevent_types.QInputEvent, h: ptr cQInputEvent): gen_qevent_types.QInputEvent =
  T(h: h)
proc create*(T: type gen_qevent_types.QInputEvent, typeVal: cint, m_dev: QInputDevice): gen_qevent_types.QInputEvent =
  gen_qevent_types.QInputEvent.init(fcQInputEvent_new(cint(typeVal), m_dev.h))

proc create*(T: type gen_qevent_types.QInputEvent, typeVal: cint, m_dev: QInputDevice, modifiers: cint): gen_qevent_types.QInputEvent =
  gen_qevent_types.QInputEvent.init(fcQInputEvent_new2(cint(typeVal), m_dev.h, cint(modifiers)))

proc clone*(self: gen_qevent_types.QInputEvent, ): QInputEvent =
  QInputEvent(h: fcQInputEvent_clone(self.h))

proc device*(self: gen_qevent_types.QInputEvent, ): QInputDevice =
  QInputDevice(h: fcQInputEvent_device(self.h))
...
proc QInputEventclone*(self: gen_qevent_types.QInputEvent, ): QInputEvent =
  QInputEvent(h: fQInputEvent_virtualbase_clone(self.h))

type QInputEventcloneProc* = proc(): QInputEvent
...
func init*(T: type gen_qevent_types.QPointerEvent, h: ptr cQPointerEvent): gen_qevent_types.QPointerEvent =
  T(h: h)
proc create*(T: type gen_qevent_types.QPointerEvent, typeVal: cint, dev: QPointingDevice): gen_qevent_types.QPointerEvent =
  gen_qevent_types.QPointerEvent.init(fcQPointerEvent_new(cint(typeVal), dev.h))

proc create*(T: type gen_qevent_types.QPointerEvent, typeVal: cint, dev: QPointingDevice, modifiers: cint): gen_qevent_types.QPointerEvent =
  gen_qevent_types.QPointerEvent.init(fcQPointerEvent_new2(cint(typeVal), dev.h, cint(modifiers)))

proc create*(T: type gen_qevent_types.QPointerEvent, typeVal: cint, dev: QPointingDevice, modifiers: cint, points: seq[QEventPoint]): gen_qevent_types.QPointerEvent =
...
proc clone*(self: gen_qevent_types.QPointerEvent, ): QPointerEvent =
  QPointerEvent(h: fcQPointerEvent_clone(self.h))

proc pointingDevice*(self: gen_qevent_types.QPointerEvent, ): QPointingDevice =
  QPointingDevice(h: fcQPointerEvent_pointingDevice(self.h))
...
proc point*(self: gen_qevent_types.QPointerEvent, i: int64): QEventPoint =
  QEventPoint(h: fcQPointerEvent_point(self.h, i))

proc points*(self: gen_qevent_types.QPointerEvent, ): seq[QEventPoint] =
  var v_ma = fcQPointerEvent_points(self.h)
  var vx_ret = newSeq[QEventPoint](int(v_ma.len))
  let v_outCast = cast[ptr UncheckedArray[pointer]](v_ma.data)
  for i in 0 ..< v_ma.len:
    vx_ret[i] = QEventPoint(h: v_outCast[i])
  vx_ret

proc pointById*(self: gen_qevent_types.QPointerEvent, id: cint): QEventPoint =
  QEventPoint(h: fcQPointerEvent_pointById(self.h, id))
...
proc exclusiveGrabber*(self: gen_qevent_types.QPointerEvent, point: QEventPoint): QObject =
  QObject(h: fcQPointerEvent_exclusiveGrabber(self.h, point.h))

proc setExclusiveGrabber*(self: gen_qevent_types.QPointerEvent, point: QEventPoint, exclusiveGrabber: QObject): void =
  fcQPointerEvent_setExclusiveGrabber(self.h, point.h, exclusiveGrabber.h)

proc clearPassiveGrabbers*(self: gen_qevent_types.QPointerEvent, point: QEventPoint): void =
  fcQPointerEvent_clearPassiveGrabbers(self.h, point.h)

proc addPassiveGrabber*(self: gen_qevent_types.QPointerEvent, point: QEventPoint, grabber: QObject): bool =
  fcQPointerEvent_addPassiveGrabber(self.h, point.h, grabber.h)

proc removePassiveGrabber*(self: gen_qevent_types.QPointerEvent, point: QEventPoint, grabber: QObject): bool =
  fcQPointerEvent_removePassiveGrabber(self.h, point.h, grabber.h)

proc QPointerEventclone*(self: gen_qevent_types.QPointerEvent, ): QPointerEvent =
  QPointerEvent(h: fQPointerEvent_virtualbase_clone(self.h))

type QPointerEventcloneProc* = proc(): QPointerEvent
...
func init*(T: type gen_qevent_types.QSinglePointEvent, h: ptr cQSinglePointEvent): gen_qevent_types.QSinglePointEvent =
  T(h: h)
proc clone*(self: gen_qevent_types.QSinglePointEvent, ): QSinglePointEvent =
...
proc position*(self: gen_qevent_types.QSinglePointEvent, ): QPointF =
  QPointF(h: fcQSinglePointEvent_position(self.h))

proc scenePosition*(self: gen_qevent_types.QSinglePointEvent, ): QPointF =
  QPointF(h: fcQSinglePointEvent_scenePosition(self.h))

proc globalPosition*(self: gen_qevent_types.QSinglePointEvent, ): QPointF =
  QPointF(h: fcQSinglePointEvent_globalPosition(self.h))
...
proc exclusivePointGrabber*(self: gen_qevent_types.QSinglePointEvent, ): QObject =
  QObject(h: fcQSinglePointEvent_exclusivePointGrabber(self.h))

proc setExclusivePointGrabber*(self: gen_qevent_types.QSinglePointEvent, exclusiveGrabber: QObject): void =
...
func init*(T: type gen_qevent_types.QEnterEvent, h: ptr cQEnterEvent): gen_qevent_types.QEnterEvent =
  T(h: h)
proc create*(T: type gen_qevent_types.QEnterEvent, localPos: QPointF, scenePos: QPointF, globalPos: QPointF): gen_qevent_types.QEnterEvent =
  gen_qevent_types.QEnterEvent.init(fcQEnterEvent_new(localPos.h, scenePos.h, globalPos.h))

proc create*(T: type gen_qevent_types.QEnterEvent, localPos: QPointF, scenePos: QPointF, globalPos: QPointF, device: QPointingDevice): gen_qevent_types.QEnterEvent =
  gen_qevent_types.QEnterEvent.init(fcQEnterEvent_new2(localPos.h, scenePos.h, globalPos.h, device.h))

proc clone*(self: gen_qevent_types.QEnterEvent, ): QEnterEvent =
...
proc QEnterEventclone*(self: gen_qevent_types.QEnterEvent, ): QEnterEvent =
  QEnterEvent(h: fQEnterEvent_virtualbase_clone(self.h))

type QEnterEventcloneProc* = proc(): QEnterEvent
...
proc create*(T: type gen_qevent_types.QMouseEvent, typeVal: cint, localPos: QPointF, globalPos: QPointF, button: cint, buttons: cint, modifiers: cint): gen_qevent_types.QMouseEvent =
...
proc create*(T: type gen_qevent_types.QMouseEvent, typeVal: cint, localPos: QPointF, scenePos: QPointF, globalPos: QPointF, button: cint, buttons: cint, modifiers: cint): gen_qevent_types.QMouseEvent =
...
proc create*(T: type gen_qevent_types.QMouseEvent, typeVal: cint, localPos: QPointF, scenePos: QPointF, globalPos: QPointF, button: cint, buttons: cint, modifiers: cint, source: cint): gen_qevent_types.QMouseEvent =
...
proc create*(T: type gen_qevent_types.QMouseEvent, typeVal: cint, localPos: QPointF, button: cint, buttons: cint, modifiers: cint, device: QPointingDevice): gen_qevent_types.QMouseEvent =
...
proc create*(T: type gen_qevent_types.QMouseEvent, typeVal: cint, localPos: QPointF, globalPos: QPointF, button: cint, buttons: cint, modifiers: cint, device: QPointingDevice): gen_qevent_types.QMouseEvent =
...
proc create*(T: type gen_qevent_types.QMouseEvent, typeVal: cint, localPos: QPointF, scenePos: QPointF, globalPos: QPointF, button: cint, buttons: cint, modifiers: cint, device: QPointingDevice): gen_qevent_types.QMouseEvent =
...
proc create*(T: type gen_qevent_types.QMouseEvent, typeVal: cint, localPos: QPointF, scenePos: QPointF, globalPos: QPointF, button: cint, buttons: cint, modifiers: cint, source: cint, device: QPointingDevice): gen_qevent_types.QMouseEvent =
...
proc clone*(self: gen_qevent_types.QMouseEvent, ): QMouseEvent =
...
proc QMouseEventclone*(self: gen_qevent_types.QMouseEvent, ): QMouseEvent =
  QMouseEvent(h: fQMouseEvent_virtualbase_clone(self.h))

type QMouseEventcloneProc* = proc(): QMouseEvent
...
func init*(T: type gen_qevent_types.QHoverEvent, h: ptr cQHoverEvent): gen_qevent_types.QHoverEvent =
  T(h: h)
proc create*(T: type gen_qevent_types.QHoverEvent, typeVal: cint, scenePos: QPointF, globalPos: QPointF, oldPos: QPointF): gen_qevent_types.QHoverEvent =
...
proc create*(T: type gen_qevent_types.QHoverEvent, typeVal: cint, scenePos: QPointF, globalPos: QPointF, oldPos: QPointF, modifiers: cint): gen_qevent_types.QHoverEvent =
  gen_qevent_types.QHoverEvent.init(fcQHoverEvent_new3(cint(typeVal), scenePos.h, globalPos.h, oldPos.h, cint(modifiers)))

proc create*(T: type gen_qevent_types.QHoverEvent, typeVal: cint, scenePos: QPointF, globalPos: QPointF, oldPos: QPointF, modifiers: cint, device: QPointingDevice): gen_qevent_types.QHoverEvent =
...
proc create*(T: type gen_qevent_types.QHoverEvent, typeVal: cint, pos: QPointF, oldPos: QPointF, modifiers: cint, device: QPointingDevice): gen_qevent_types.QHoverEvent =
  gen_qevent_types.QHoverEvent.init(fcQHoverEvent_new6(cint(typeVal), pos.h, oldPos.h, cint(modifiers), device.h))

proc clone*(self: gen_qevent_types.QHoverEvent, ): QHoverEvent =
...
proc QHoverEventclone*(self: gen_qevent_types.QHoverEvent, ): QHoverEvent =
  QHoverEvent(h: fQHoverEvent_virtualbase_clone(self.h))

type QHoverEventcloneProc* = proc(): QHoverEvent
...
proc create*(T: type gen_qevent_types.QWheelEvent, pos: QPointF, globalPos: QPointF, pixelDelta: QPoint, angleDelta: QPoint, buttons: cint, modifiers: cint, phase: cint, inverted: bool, source: cint, device: QPointingDevice): gen_qevent_types.QWheelEvent =
...
proc clone*(self: gen_qevent_types.QWheelEvent, ): QWheelEvent =
...
proc QWheelEventclone*(self: gen_qevent_types.QWheelEvent, ): QWheelEvent =
  QWheelEvent(h: fQWheelEvent_virtualbase_clone(self.h))

type QWheelEventcloneProc* = proc(): QWheelEvent
...
func init*(T: type gen_qevent_types.QTabletEvent, h: ptr cQTabletEvent): gen_qevent_types.QTabletEvent =
  T(h: h)
proc create*(T: type gen_qevent_types.QTabletEvent, t: cint, device: QPointingDevice, pos: QPointF, globalPos: QPointF, pressure: float64, xTilt: float32, yTilt: float32, tangentialPressure: float32, rotation: float64, z: float32, keyState: cint, button: cint, buttons: cint): gen_qevent_types.QTabletEvent =
...
proc clone*(self: gen_qevent_types.QTabletEvent, ): QTabletEvent =
...
proc QTabletEventclone*(self: gen_qevent_types.QTabletEvent, ): QTabletEvent =
  QTabletEvent(h: fQTabletEvent_virtualbase_clone(self.h))

type QTabletEventcloneProc* = proc(): QTabletEvent
...
func init*(T: type gen_qevent_types.QNativeGestureEvent, h: ptr cQNativeGestureEvent): gen_qevent_types.QNativeGestureEvent =
  T(h: h)
proc create*(T: type gen_qevent_types.QNativeGestureEvent, typeVal: cint, dev: QPointingDevice, localPos: QPointF, scenePos: QPointF, globalPos: QPointF, value: float64, sequenceId: culonglong, intArgument: culonglong): gen_qevent_types.QNativeGestureEvent =
...
proc create*(T: type gen_qevent_types.QNativeGestureEvent, typeVal: cint, dev: QPointingDevice, fingerCount: cint, localPos: QPointF, scenePos: QPointF, globalPos: QPointF, value: float64, delta: QPointF): gen_qevent_types.QNativeGestureEvent =
...
proc create*(T: type gen_qevent_types.QNativeGestureEvent, typeVal: cint, dev: QPointingDevice, fingerCount: cint, localPos: QPointF, scenePos: QPointF, globalPos: QPointF, value: float64, delta: QPointF, sequenceId: culonglong): gen_qevent_types.QNativeGestureEvent =
...
proc clone*(self: gen_qevent_types.QNativeGestureEvent, ): QNativeGestureEvent =
...
proc delta*(self: gen_qevent_types.QNativeGestureEvent, ): QPointF =
  QPointF(h: fcQNativeGestureEvent_delta(self.h))
...
proc QNativeGestureEventclone*(self: gen_qevent_types.QNativeGestureEvent, ): QNativeGestureEvent =
  QNativeGestureEvent(h: fQNativeGestureEvent_virtualbase_clone(self.h))

type QNativeGestureEventcloneProc* = proc(): QNativeGestureEvent
...
proc create*(T: type gen_qevent_types.QKeyEvent, typeVal: cint, key: cint, modifiers: cint, nativeScanCode: cuint, nativeVirtualKey: cuint, nativeModifiers: cuint, text: string, autorep: bool, count: cushort, device: QInputDevice): gen_qevent_types.QKeyEvent =
...
proc clone*(self: gen_qevent_types.QKeyEvent, ): QKeyEvent =
...
proc keyCombination*(self: gen_qevent_types.QKeyEvent, ): QKeyCombination =
  QKeyCombination(h: fcQKeyEvent_keyCombination(self.h))
...
proc QKeyEventclone*(self: gen_qevent_types.QKeyEvent, ): QKeyEvent =
  QKeyEvent(h: fQKeyEvent_virtualbase_clone(self.h))

type QKeyEventcloneProc* = proc(): QKeyEvent
...
proc clone*(self: gen_qevent_types.QFocusEvent, ): QFocusEvent =
...
proc QFocusEventclone*(self: gen_qevent_types.QFocusEvent, ): QFocusEvent =
  QFocusEvent(h: fQFocusEvent_virtualbase_clone(self.h))

type QFocusEventcloneProc* = proc(): QFocusEvent
...
proc clone*(self: gen_qevent_types.QPaintEvent, ): QPaintEvent =
...
proc QPaintEventclone*(self: gen_qevent_types.QPaintEvent, ): QPaintEvent =
  QPaintEvent(h: fQPaintEvent_virtualbase_clone(self.h))

type QPaintEventcloneProc* = proc(): QPaintEvent
...
proc clone*(self: gen_qevent_types.QMoveEvent, ): QMoveEvent =
...
proc QMoveEventclone*(self: gen_qevent_types.QMoveEvent, ): QMoveEvent =
  QMoveEvent(h: fQMoveEvent_virtualbase_clone(self.h))

type QMoveEventcloneProc* = proc(): QMoveEvent
...
func init*(T: type gen_qevent_types.QExposeEvent, h: ptr cQExposeEvent): gen_qevent_types.QExposeEvent =
  T(h: h)
proc create*(T: type gen_qevent_types.QExposeEvent, m_region: QRegion): gen_qevent_types.QExposeEvent =
  gen_qevent_types.QExposeEvent.init(fcQExposeEvent_new(m_region.h))

proc clone*(self: gen_qevent_types.QExposeEvent, ): QExposeEvent =
...
proc QExposeEventclone*(self: gen_qevent_types.QExposeEvent, ): QExposeEvent =
  QExposeEvent(h: fQExposeEvent_virtualbase_clone(self.h))

type QExposeEventcloneProc* = proc(): QExposeEvent
...
proc clone*(self: gen_qevent_types.QPlatformSurfaceEvent, ): QPlatformSurfaceEvent =
...
proc QPlatformSurfaceEventclone*(self: gen_qevent_types.QPlatformSurfaceEvent, ): QPlatformSurfaceEvent =
  QPlatformSurfaceEvent(h: fQPlatformSurfaceEvent_virtualbase_clone(self.h))

type QPlatformSurfaceEventcloneProc* = proc(): QPlatformSurfaceEvent
...
proc clone*(self: gen_qevent_types.QResizeEvent, ): QResizeEvent =
...
proc QResizeEventclone*(self: gen_qevent_types.QResizeEvent, ): QResizeEvent =
  QResizeEvent(h: fQResizeEvent_virtualbase_clone(self.h))

type QResizeEventcloneProc* = proc(): QResizeEvent
...
proc clone*(self: gen_qevent_types.QCloseEvent, ): QCloseEvent =
  QCloseEvent(h: fcQCloseEvent_clone(self.h))

proc QCloseEventclone*(self: gen_qevent_types.QCloseEvent, ): QCloseEvent =
  QCloseEvent(h: fQCloseEvent_virtualbase_clone(self.h))

type QCloseEventcloneProc* = proc(): QCloseEvent
...
proc clone*(self: gen_qevent_types.QIconDragEvent, ): QIconDragEvent =
  QIconDragEvent(h: fcQIconDragEvent_clone(self.h))

proc QIconDragEventclone*(self: gen_qevent_types.QIconDragEvent, ): QIconDragEvent =
  QIconDragEvent(h: fQIconDragEvent_virtualbase_clone(self.h))

type QIconDragEventcloneProc* = proc(): QIconDragEvent
...
proc clone*(self: gen_qevent_types.QShowEvent, ): QShowEvent =
  QShowEvent(h: fcQShowEvent_clone(self.h))

proc QShowEventclone*(self: gen_qevent_types.QShowEvent, ): QShowEvent =
  QShowEvent(h: fQShowEvent_virtualbase_clone(self.h))

type QShowEventcloneProc* = proc(): QShowEvent
...
proc clone*(self: gen_qevent_types.QHideEvent, ): QHideEvent =
  QHideEvent(h: fcQHideEvent_clone(self.h))

proc QHideEventclone*(self: gen_qevent_types.QHideEvent, ): QHideEvent =
  QHideEvent(h: fQHideEvent_virtualbase_clone(self.h))

type QHideEventcloneProc* = proc(): QHideEvent
...
proc clone*(self: gen_qevent_types.QContextMenuEvent, ): QContextMenuEvent =
...
proc QContextMenuEventclone*(self: gen_qevent_types.QContextMenuEvent, ): QContextMenuEvent =
  QContextMenuEvent(h: fQContextMenuEvent_virtualbase_clone(self.h))

type QContextMenuEventcloneProc* = proc(): QContextMenuEvent
...
proc clone*(self: gen_qevent_types.QInputMethodEvent, ): QInputMethodEvent =
...
proc QInputMethodEventclone*(self: gen_qevent_types.QInputMethodEvent, ): QInputMethodEvent =
  QInputMethodEvent(h: fQInputMethodEvent_virtualbase_clone(self.h))

type QInputMethodEventcloneProc* = proc(): QInputMethodEvent
...
proc clone*(self: gen_qevent_types.QInputMethodQueryEvent, ): QInputMethodQueryEvent =
...
proc QInputMethodQueryEventclone*(self: gen_qevent_types.QInputMethodQueryEvent, ): QInputMethodQueryEvent =
  QInputMethodQueryEvent(h: fQInputMethodQueryEvent_virtualbase_clone(self.h))

type QInputMethodQueryEventcloneProc* = proc(): QInputMethodQueryEvent
...
proc clone*(self: gen_qevent_types.QDropEvent, ): QDropEvent =
...
proc position*(self: gen_qevent_types.QDropEvent, ): QPointF =
  QPointF(h: fcQDropEvent_position(self.h))
...
proc QDropEventclone*(self: gen_qevent_types.QDropEvent, ): QDropEvent =
  QDropEvent(h: fQDropEvent_virtualbase_clone(self.h))

type QDropEventcloneProc* = proc(): QDropEvent
...
proc clone*(self: gen_qevent_types.QDragMoveEvent, ): QDragMoveEvent =
...
proc QDragMoveEventclone*(self: gen_qevent_types.QDragMoveEvent, ): QDragMoveEvent =
  QDragMoveEvent(h: fQDragMoveEvent_virtualbase_clone(self.h))

type QDragMoveEventcloneProc* = proc(): QDragMoveEvent
...
proc clone*(self: gen_qevent_types.QDragEnterEvent, ): QDragEnterEvent =
  QDragEnterEvent(h: fcQDragEnterEvent_clone(self.h))

proc QDragEnterEventclone*(self: gen_qevent_types.QDragEnterEvent, ): QDragEnterEvent =
  QDragEnterEvent(h: fQDragEnterEvent_virtualbase_clone(self.h))

type QDragEnterEventcloneProc* = proc(): QDragEnterEvent
...
proc clone*(self: gen_qevent_types.QDragLeaveEvent, ): QDragLeaveEvent =
  QDragLeaveEvent(h: fcQDragLeaveEvent_clone(self.h))

proc QDragLeaveEventclone*(self: gen_qevent_types.QDragLeaveEvent, ): QDragLeaveEvent =
  QDragLeaveEvent(h: fQDragLeaveEvent_virtualbase_clone(self.h))

type QDragLeaveEventcloneProc* = proc(): QDragLeaveEvent
...
proc clone*(self: gen_qevent_types.QHelpEvent, ): QHelpEvent =
...
proc QHelpEventclone*(self: gen_qevent_types.QHelpEvent, ): QHelpEvent =
  QHelpEvent(h: fQHelpEvent_virtualbase_clone(self.h))

type QHelpEventcloneProc* = proc(): QHelpEvent
...
proc clone*(self: gen_qevent_types.QStatusTipEvent, ): QStatusTipEvent =
...
proc QStatusTipEventclone*(self: gen_qevent_types.QStatusTipEvent, ): QStatusTipEvent =
  QStatusTipEvent(h: fQStatusTipEvent_virtualbase_clone(self.h))

type QStatusTipEventcloneProc* = proc(): QStatusTipEvent
...
proc clone*(self: gen_qevent_types.QWhatsThisClickedEvent, ): QWhatsThisClickedEvent =
...
proc QWhatsThisClickedEventclone*(self: gen_qevent_types.QWhatsThisClickedEvent, ): QWhatsThisClickedEvent =
  QWhatsThisClickedEvent(h: fQWhatsThisClickedEvent_virtualbase_clone(self.h))

type QWhatsThisClickedEventcloneProc* = proc(): QWhatsThisClickedEvent
...
func init*(T: type gen_qevent_types.QActionEvent, h: ptr cQActionEvent): gen_qevent_types.QActionEvent =
  T(h: h)
proc clone*(self: gen_qevent_types.QActionEvent, ): QActionEvent =
...
proc clone*(self: gen_qevent_types.QFileOpenEvent, ): QFileOpenEvent =
...
proc QFileOpenEventclone*(self: gen_qevent_types.QFileOpenEvent, ): QFileOpenEvent =
  QFileOpenEvent(h: fQFileOpenEvent_virtualbase_clone(self.h))

type QFileOpenEventcloneProc* = proc(): QFileOpenEvent
...
proc clone*(self: gen_qevent_types.QToolBarChangeEvent, ): QToolBarChangeEvent =
...
proc QToolBarChangeEventclone*(self: gen_qevent_types.QToolBarChangeEvent, ): QToolBarChangeEvent =
  QToolBarChangeEvent(h: fQToolBarChangeEvent_virtualbase_clone(self.h))

type QToolBarChangeEventcloneProc* = proc(): QToolBarChangeEvent
...
proc clone*(self: gen_qevent_types.QShortcutEvent, ): QShortcutEvent =
...
proc QShortcutEventclone*(self: gen_qevent_types.QShortcutEvent, ): QShortcutEvent =
  QShortcutEvent(h: fQShortcutEvent_virtualbase_clone(self.h))

type QShortcutEventcloneProc* = proc(): QShortcutEvent
...
proc clone*(self: gen_qevent_types.QWindowStateChangeEvent, ): QWindowStateChangeEvent =
...
proc QWindowStateChangeEventclone*(self: gen_qevent_types.QWindowStateChangeEvent, ): QWindowStateChangeEvent =
  QWindowStateChangeEvent(h: fQWindowStateChangeEvent_virtualbase_clone(self.h))

type QWindowStateChangeEventcloneProc* = proc(): QWindowStateChangeEvent
...
proc create*(T: type gen_qevent_types.QTouchEvent, eventType: cint, device: QPointingDevice, modifiers: cint, touchPointStates: cint): gen_qevent_types.QTouchEvent =
  gen_qevent_types.QTouchEvent.init(fcQTouchEvent_new2(cint(eventType), device.h, cint(modifiers), cint(touchPointStates)))

proc create*(T: type gen_qevent_types.QTouchEvent, eventType: cint, device: QPointingDevice): gen_qevent_types.QTouchEvent =
  gen_qevent_types.QTouchEvent.init(fcQTouchEvent_new3(cint(eventType), device.h))

proc create*(T: type gen_qevent_types.QTouchEvent, eventType: cint, device: QPointingDevice, modifiers: cint): gen_qevent_types.QTouchEvent =
  gen_qevent_types.QTouchEvent.init(fcQTouchEvent_new4(cint(eventType), device.h, cint(modifiers)))

proc create*(T: type gen_qevent_types.QTouchEvent, eventType: cint, device: QPointingDevice, modifiers: cint, touchPoints: seq[QEventPoint]): gen_qevent_types.QTouchEvent =
...
proc create*(T: type gen_qevent_types.QTouchEvent, eventType: cint, device: QPointingDevice, modifiers: cint, touchPointStates: cint, touchPoints: seq[QEventPoint]): gen_qevent_types.QTouchEvent =
  var touchPoints_CArray = newSeq[pointer](len(touchPoints))
  for i in 0..<len(touchPoints):
    touchPoints_CArray[i] = touchPoints[i].h
...
proc clone*(self: gen_qevent_types.QTouchEvent, ): QTouchEvent =
...
proc touchPoints*(self: gen_qevent_types.QTouchEvent, ): seq[QEventPoint] =
...
proc QTouchEventclone*(self: gen_qevent_types.QTouchEvent, ): QTouchEvent =
  QTouchEvent(h: fQTouchEvent_virtualbase_clone(self.h))

type QTouchEventcloneProc* = proc(): QTouchEvent
...
proc clone*(self: gen_qevent_types.QScrollPrepareEvent, ): QScrollPrepareEvent =
...
proc QScrollPrepareEventclone*(self: gen_qevent_types.QScrollPrepareEvent, ): QScrollPrepareEvent =
  QScrollPrepareEvent(h: fQScrollPrepareEvent_virtualbase_clone(self.h))

type QScrollPrepareEventcloneProc* = proc(): QScrollPrepareEvent
...
proc clone*(self: gen_qevent_types.QScrollEvent, ): QScrollEvent =
...
proc QScrollEventclone*(self: gen_qevent_types.QScrollEvent, ): QScrollEvent =
  QScrollEvent(h: fQScrollEvent_virtualbase_clone(self.h))

type QScrollEventcloneProc* = proc(): QScrollEvent
...
proc clone*(self: gen_qevent_types.QScreenOrientationChangeEvent, ): QScreenOrientationChangeEvent =
...
proc QScreenOrientationChangeEventclone*(self: gen_qevent_types.QScreenOrientationChangeEvent, ): QScreenOrientationChangeEvent =
  QScreenOrientationChangeEvent(h: fQScreenOrientationChangeEvent_virtualbase_clone(self.h))

type QScreenOrientationChangeEventcloneProc* = proc(): QScreenOrientationChangeEvent
...
proc clone*(self: gen_qevent_types.QApplicationStateChangeEvent, ): QApplicationStateChangeEvent =
...
proc QApplicationStateChangeEventclone*(self: gen_qevent_types.QApplicationStateChangeEvent, ): QApplicationStateChangeEvent =
  QApplicationStateChangeEvent(h: fQApplicationStateChangeEvent_virtualbase_clone(self.h))

type QApplicationStateChangeEventcloneProc* = proc(): QApplicationStateChangeEvent
