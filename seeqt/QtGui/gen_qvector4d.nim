...
proc create*(T: type gen_qvector4d_types.QVector4D, point: QPoint): gen_qvector4d_types.QVector4D =
  gen_qvector4d_types.QVector4D.init(fcQVector4D_new4(point.h))

proc create*(T: type gen_qvector4d_types.QVector4D, point: QPointF): gen_qvector4d_types.QVector4D =
  gen_qvector4d_types.QVector4D.init(fcQVector4D_new5(point.h))

proc create*(T: type gen_qvector4d_types.QVector4D, vector: QVector2D): gen_qvector4d_types.QVector4D =
  gen_qvector4d_types.QVector4D.init(fcQVector4D_new6(vector.h))

proc create*(T: type gen_qvector4d_types.QVector4D, vector: QVector2D, zpos: float32, wpos: float32): gen_qvector4d_types.QVector4D =
  gen_qvector4d_types.QVector4D.init(fcQVector4D_new7(vector.h, zpos, wpos))

proc create*(T: type gen_qvector4d_types.QVector4D, vector: QVector3D): gen_qvector4d_types.QVector4D =
  gen_qvector4d_types.QVector4D.init(fcQVector4D_new8(vector.h))

proc create*(T: type gen_qvector4d_types.QVector4D, vector: QVector3D, wpos: float32): gen_qvector4d_types.QVector4D =
  gen_qvector4d_types.QVector4D.init(fcQVector4D_new9(vector.h, wpos))

proc create*(T: type gen_qvector4d_types.QVector4D, param1: QVector4D): gen_qvector4d_types.QVector4D =
...
proc normalized*(self: gen_qvector4d_types.QVector4D, ): QVector4D =
...
proc operatorPlusAssign*(self: gen_qvector4d_types.QVector4D, vector: QVector4D): QVector4D =
  QVector4D(h: fcQVector4D_operatorPlusAssign(self.h, vector.h))

proc operatorMinusAssign*(self: gen_qvector4d_types.QVector4D, vector: QVector4D): QVector4D =
  QVector4D(h: fcQVector4D_operatorMinusAssign(self.h, vector.h))

proc operatorMultiplyAssign*(self: gen_qvector4d_types.QVector4D, factor: float32): QVector4D =
  QVector4D(h: fcQVector4D_operatorMultiplyAssign(self.h, factor))

proc operatorMultiplyAssign*(self: gen_qvector4d_types.QVector4D, vector: QVector4D): QVector4D =
  QVector4D(h: fcQVector4D_operatorMultiplyAssignWithVector(self.h, vector.h))

proc operatorDivideAssign*(self: gen_qvector4d_types.QVector4D, divisor: float32): QVector4D =
  QVector4D(h: fcQVector4D_operatorDivideAssign(self.h, divisor))

proc operatorDivideAssign*(self: gen_qvector4d_types.QVector4D, vector: QVector4D): QVector4D =
  QVector4D(h: fcQVector4D_operatorDivideAssignWithVector(self.h, vector.h))

proc dotProduct*(_: type gen_qvector4d_types.QVector4D, v1: QVector4D, v2: QVector4D): float32 =
  fcQVector4D_dotProduct(v1.h, v2.h)

proc toVector2D*(self: gen_qvector4d_types.QVector4D, ): QVector2D =
  QVector2D(h: fcQVector4D_toVector2D(self.h))

proc toVector2DAffine*(self: gen_qvector4d_types.QVector4D, ): QVector2D =
  QVector2D(h: fcQVector4D_toVector2DAffine(self.h))

proc toVector3D*(self: gen_qvector4d_types.QVector4D, ): QVector3D =
  QVector3D(h: fcQVector4D_toVector3D(self.h))

proc toVector3DAffine*(self: gen_qvector4d_types.QVector4D, ): QVector3D =
  QVector3D(h: fcQVector4D_toVector3DAffine(self.h))

proc toPoint*(self: gen_qvector4d_types.QVector4D, ): QPoint =
  QPoint(h: fcQVector4D_toPoint(self.h))

proc toPointF*(self: gen_qvector4d_types.QVector4D, ): QPointF =
  QPointF(h: fcQVector4D_toPointF(self.h))

proc ToQVariant*(self: gen_qvector4d_types.QVector4D, ): QVariant =
