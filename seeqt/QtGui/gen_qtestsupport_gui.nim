...
func init*(T: type gen_qtestsupport_gui_types.QTestQTouchEventSequence, h: ptr cQTestQTouchEventSequence): gen_qtestsupport_gui_types.QTestQTouchEventSequence =
  T(h: h)
proc press*(self: gen_qtestsupport_gui_types.QTestQTouchEventSequence, touchId: cint, pt: QPoint): QTestQTouchEventSequence =
  QTestQTouchEventSequence(h: fcQTestQTouchEventSequence_press(self.h, touchId, pt.h))

proc move*(self: gen_qtestsupport_gui_types.QTestQTouchEventSequence, touchId: cint, pt: QPoint): QTestQTouchEventSequence =
  QTestQTouchEventSequence(h: fcQTestQTouchEventSequence_move(self.h, touchId, pt.h))

proc release*(self: gen_qtestsupport_gui_types.QTestQTouchEventSequence, touchId: cint, pt: QPoint): QTestQTouchEventSequence =
  QTestQTouchEventSequence(h: fcQTestQTouchEventSequence_release(self.h, touchId, pt.h))

proc stationary*(self: gen_qtestsupport_gui_types.QTestQTouchEventSequence, touchId: cint): QTestQTouchEventSequence =
...
proc press*(self: gen_qtestsupport_gui_types.QTestQTouchEventSequence, touchId: cint, pt: QPoint, window: QWindow): QTestQTouchEventSequence =
  QTestQTouchEventSequence(h: fcQTestQTouchEventSequence_press3(self.h, touchId, pt.h, window.h))

proc move*(self: gen_qtestsupport_gui_types.QTestQTouchEventSequence, touchId: cint, pt: QPoint, window: QWindow): QTestQTouchEventSequence =
  QTestQTouchEventSequence(h: fcQTestQTouchEventSequence_move3(self.h, touchId, pt.h, window.h))

proc release*(self: gen_qtestsupport_gui_types.QTestQTouchEventSequence, touchId: cint, pt: QPoint, window: QWindow): QTestQTouchEventSequence =
