...
proc create*(T: type gen_qstatictext_types.QStaticText, other: QStaticText): gen_qstatictext_types.QStaticText =
  gen_qstatictext_types.QStaticText.init(fcQStaticText_new3(other.h))

proc operatorAssign*(self: gen_qstatictext_types.QStaticText, param1: QStaticText): void =
  fcQStaticText_operatorAssign(self.h, param1.h)

proc swap*(self: gen_qstatictext_types.QStaticText, other: QStaticText): void =
...
proc setTextOption*(self: gen_qstatictext_types.QStaticText, textOption: QTextOption): void =
  fcQStaticText_setTextOption(self.h, textOption.h)

proc textOption*(self: gen_qstatictext_types.QStaticText, ): QTextOption =
  QTextOption(h: fcQStaticText_textOption(self.h))

proc size*(self: gen_qstatictext_types.QStaticText, ): QSizeF =
  QSizeF(h: fcQStaticText_size(self.h))
...
proc operatorEqual*(self: gen_qstatictext_types.QStaticText, param1: QStaticText): bool =
  fcQStaticText_operatorEqual(self.h, param1.h)

proc operatorNotEqual*(self: gen_qstatictext_types.QStaticText, param1: QStaticText): bool =
  fcQStaticText_operatorNotEqual(self.h, param1.h)

proc prepare*(self: gen_qstatictext_types.QStaticText, matrix: QTransform): void =
  fcQStaticText_prepare1(self.h, matrix.h)

proc prepare*(self: gen_qstatictext_types.QStaticText, matrix: QTransform, font: QFont): void =
