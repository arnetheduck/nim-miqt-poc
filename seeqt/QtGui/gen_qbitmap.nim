...
proc create*(T: type gen_qbitmap_types.QBitmap, param1: QPixmap): gen_qbitmap_types.QBitmap =
...
proc create*(T: type gen_qbitmap_types.QBitmap, param1: QSize): gen_qbitmap_types.QBitmap =
...
proc create*(T: type gen_qbitmap_types.QBitmap, other: QBitmap): gen_qbitmap_types.QBitmap =
...
proc operatorAssign*(self: gen_qbitmap_types.QBitmap, other: QBitmap): void =
  fcQBitmap_operatorAssign(self.h, other.h)

proc operatorAssign*(self: gen_qbitmap_types.QBitmap, param1: QPixmap): void =
  fcQBitmap_operatorAssignWithQPixmap(self.h, param1.h)

proc swap*(self: gen_qbitmap_types.QBitmap, other: QBitmap): void =
  fcQBitmap_swap(self.h, other.h)

proc ToQVariant*(self: gen_qbitmap_types.QBitmap, ): QVariant =
  QVariant(h: fcQBitmap_ToQVariant(self.h))

proc clear*(self: gen_qbitmap_types.QBitmap, ): void =
  fcQBitmap_clear(self.h)

proc fromImage*(_: type gen_qbitmap_types.QBitmap, image: QImage): QBitmap =
  QBitmap(h: fcQBitmap_fromImage(image.h))

proc fromData*(_: type gen_qbitmap_types.QBitmap, size: QSize, bits: ptr uint8): QBitmap =
  QBitmap(h: fcQBitmap_fromData(size.h, bits))

proc transformed*(self: gen_qbitmap_types.QBitmap, param1: QMatrix): QBitmap =
  QBitmap(h: fcQBitmap_transformed(self.h, param1.h))

proc transformed*(self: gen_qbitmap_types.QBitmap, matrix: QTransform): QBitmap =
  QBitmap(h: fcQBitmap_transformedWithMatrix(self.h, matrix.h))

proc fromImage*(_: type gen_qbitmap_types.QBitmap, image: QImage, flags: cint): QBitmap =
  QBitmap(h: fcQBitmap_fromImage2(image.h, cint(flags)))

proc fromData*(_: type gen_qbitmap_types.QBitmap, size: QSize, bits: ptr uint8, monoFormat: cint): QBitmap =
...
proc miqt_exec_callback_QBitmap_devType(self: ptr cQBitmap, slot: int): cint {.exportc: "miqt_exec_callback_QBitmap_devType ".} =
  ...
  virtualReturn
proc QBitmappaintEngine*(self: gen_qbitmap_types.QBitmap, ): QPaintEngine =
  QPaintEngine(h: fQBitmap_virtualbase_paintEngine(self.h))

type QBitmappaintEngineProc* = proc(): QPaintEngine
...
proc miqt_exec_callback_QBitmap_metric(self: ptr cQBitmap, slot: int, param1: cint): cint {.exportc: "miqt_exec_callback_QBitmap_metric ".} =
  ...
  virtualReturn
proc QBitmapinitPainter*(self: gen_qbitmap_types.QBitmap, painter: QPainter): void =
  fQBitmap_virtualbase_initPainter(self.h, painter.h)

type QBitmapinitPainterProc* = proc(painter: QPainter): void
...
proc miqt_exec_callback_QBitmap_initPainter(self: ptr cQBitmap, slot: int, painter: pointer): void {.exportc: "miqt_exec_callback_QBitmap_initPainter ".} =
  ...
  nimfunc[](slotval1)
proc QBitmapredirected*(self: gen_qbitmap_types.QBitmap, offset: QPoint): QPaintDevice =
  QPaintDevice(h: fQBitmap_virtualbase_redirected(self.h, offset.h))

type QBitmapredirectedProc* = proc(offset: QPoint): QPaintDevice
...
proc miqt_exec_callback_QBitmap_redirected(self: ptr cQBitmap, slot: int, offset: pointer): pointer {.exportc: "miqt_exec_callback_QBitmap_redirected ".} =
  ...
  virtualReturn.h
proc QBitmapsharedPainter*(self: gen_qbitmap_types.QBitmap, ): QPainter =
  QPainter(h: fQBitmap_virtualbase_sharedPainter(self.h))

type QBitmapsharedPainterProc* = proc(): QPainter
