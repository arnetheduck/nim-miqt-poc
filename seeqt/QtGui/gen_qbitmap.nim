...
proc create*(T: type gen_qbitmap_types.QBitmap, param1: QBitmap): gen_qbitmap_types.QBitmap =
...
proc fromPixmap*(_: type gen_qbitmap_types.QBitmap, pixmap: QPixmap): QBitmap =
...
proc operatorAssign*(self: gen_qbitmap_types.QBitmap, param1: QBitmap): void =
