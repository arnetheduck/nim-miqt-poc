...
func init*(T: type gen_qaccessible_types.QAccessible, h: ptr cQAccessible): gen_qaccessible_types.QAccessible =
  T(h: h)
proc installActivationObserver*(_: type gen_qaccessible_types.QAccessible, param1: QAccessibleActivationObserver): void =
  fcQAccessible_installActivationObserver(param1.h)

proc removeActivationObserver*(_: type gen_qaccessible_types.QAccessible, param1: QAccessibleActivationObserver): void =
  fcQAccessible_removeActivationObserver(param1.h)

proc queryAccessibleInterface*(_: type gen_qaccessible_types.QAccessible, param1: QObject): QAccessibleInterface =
  QAccessibleInterface(h: fcQAccessible_queryAccessibleInterface(param1.h))

proc uniqueId*(_: type gen_qaccessible_types.QAccessible, iface: QAccessibleInterface): cuint =
  fcQAccessible_uniqueId(iface.h)

proc accessibleInterface*(_: type gen_qaccessible_types.QAccessible, uniqueId: cuint): QAccessibleInterface =
  QAccessibleInterface(h: fcQAccessible_accessibleInterface(uniqueId))

proc registerAccessibleInterface*(_: type gen_qaccessible_types.QAccessible, iface: QAccessibleInterface): cuint =
...
proc updateAccessibility*(_: type gen_qaccessible_types.QAccessible, event: QAccessibleEvent): void =
...
proc setRootObject*(_: type gen_qaccessible_types.QAccessible, objectVal: QObject): void =
  fcQAccessible_setRootObject(objectVal.h)

proc cleanup*(_: type gen_qaccessible_types.QAccessible, ): void =
  fcQAccessible_cleanup()

proc qAccessibleTextBoundaryHelper*(_: type gen_qaccessible_types.QAccessible, cursor: QTextCursor, boundaryType: cint): tuple[first: cint, second: cint] =
...
proc objectX*(self: gen_qaccessible_types.QAccessibleInterface, ): QObject =
  QObject(h: fcQAccessibleInterface_objectX(self.h))

proc window*(self: gen_qaccessible_types.QAccessibleInterface, ): QWindow =
  QWindow(h: fcQAccessibleInterface_window(self.h))

proc relations*(self: gen_qaccessible_types.QAccessibleInterface, match: cint): seq[tuple[first: QAccessibleInterface, second: cint]] =
  var v_ma = fcQAccessibleInterface_relations(self.h, cint(match))
  var vx_ret = newSeq[tuple[first: QAccessibleInterface, second: cint]](int(v_ma.len))
  ...
  for i in 0 ..< v_ma.len:
    ...
    var vx_vv_entry_First = QAccessibleInterface(h: vx_vv_First_CArray[0])
...
proc focusChild*(self: gen_qaccessible_types.QAccessibleInterface, ): QAccessibleInterface =
  QAccessibleInterface(h: fcQAccessibleInterface_focusChild(self.h))

proc childAt*(self: gen_qaccessible_types.QAccessibleInterface, x: cint, y: cint): QAccessibleInterface =
  QAccessibleInterface(h: fcQAccessibleInterface_childAt(self.h, x, y))

proc parent*(self: gen_qaccessible_types.QAccessibleInterface, ): QAccessibleInterface =
  QAccessibleInterface(h: fcQAccessibleInterface_parent(self.h))

proc child*(self: gen_qaccessible_types.QAccessibleInterface, index: cint): QAccessibleInterface =
...
proc indexOfChild*(self: gen_qaccessible_types.QAccessibleInterface, param1: QAccessibleInterface): cint =
...
proc rect*(self: gen_qaccessible_types.QAccessibleInterface, ): QRect =
  QRect(h: fcQAccessibleInterface_rect(self.h))

proc role*(self: gen_qaccessible_types.QAccessibleInterface, ): cint =
  cint(fcQAccessibleInterface_role(self.h))

proc state*(self: gen_qaccessible_types.QAccessibleInterface, ): QAccessibleState =
  QAccessibleState(h: fcQAccessibleInterface_state(self.h))

proc foregroundColor*(self: gen_qaccessible_types.QAccessibleInterface, ): QColor =
  QColor(h: fcQAccessibleInterface_foregroundColor(self.h))

proc backgroundColor*(self: gen_qaccessible_types.QAccessibleInterface, ): QColor =
  QColor(h: fcQAccessibleInterface_backgroundColor(self.h))

proc textInterface*(self: gen_qaccessible_types.QAccessibleInterface, ): QAccessibleTextInterface =
  QAccessibleTextInterface(h: fcQAccessibleInterface_textInterface(self.h))

proc editableTextInterface*(self: gen_qaccessible_types.QAccessibleInterface, ): QAccessibleEditableTextInterface =
  QAccessibleEditableTextInterface(h: fcQAccessibleInterface_editableTextInterface(self.h))

proc valueInterface*(self: gen_qaccessible_types.QAccessibleInterface, ): QAccessibleValueInterface =
  QAccessibleValueInterface(h: fcQAccessibleInterface_valueInterface(self.h))

proc actionInterface*(self: gen_qaccessible_types.QAccessibleInterface, ): QAccessibleActionInterface =
  QAccessibleActionInterface(h: fcQAccessibleInterface_actionInterface(self.h))

proc imageInterface*(self: gen_qaccessible_types.QAccessibleInterface, ): QAccessibleImageInterface =
  QAccessibleImageInterface(h: fcQAccessibleInterface_imageInterface(self.h))

proc tableInterface*(self: gen_qaccessible_types.QAccessibleInterface, ): QAccessibleTableInterface =
  QAccessibleTableInterface(h: fcQAccessibleInterface_tableInterface(self.h))

proc tableCellInterface*(self: gen_qaccessible_types.QAccessibleInterface, ): QAccessibleTableCellInterface =
...
proc characterRect*(self: gen_qaccessible_types.QAccessibleTextInterface, offset: cint): QRect =
  QRect(h: fcQAccessibleTextInterface_characterRect(self.h, offset))

proc offsetAtPoint*(self: gen_qaccessible_types.QAccessibleTextInterface, point: QPoint): cint =
...
proc operatorAssign*(self: gen_qaccessible_types.QAccessibleTextInterface, param1: QAccessibleTextInterface): void =
...
proc operatorAssign*(self: gen_qaccessible_types.QAccessibleEditableTextInterface, param1: QAccessibleEditableTextInterface): void =
...
func init*(T: type gen_qaccessible_types.QAccessibleValueInterface, h: ptr cQAccessibleValueInterface): gen_qaccessible_types.QAccessibleValueInterface =
  T(h: h)
proc currentValue*(self: gen_qaccessible_types.QAccessibleValueInterface, ): QVariant =
  QVariant(h: fcQAccessibleValueInterface_currentValue(self.h))

proc setCurrentValue*(self: gen_qaccessible_types.QAccessibleValueInterface, value: QVariant): void =
  fcQAccessibleValueInterface_setCurrentValue(self.h, value.h)

proc maximumValue*(self: gen_qaccessible_types.QAccessibleValueInterface, ): QVariant =
  QVariant(h: fcQAccessibleValueInterface_maximumValue(self.h))

proc minimumValue*(self: gen_qaccessible_types.QAccessibleValueInterface, ): QVariant =
  QVariant(h: fcQAccessibleValueInterface_minimumValue(self.h))

proc minimumStepSize*(self: gen_qaccessible_types.QAccessibleValueInterface, ): QVariant =
  QVariant(h: fcQAccessibleValueInterface_minimumStepSize(self.h))

proc operatorAssign*(self: gen_qaccessible_types.QAccessibleValueInterface, param1: QAccessibleValueInterface): void =
...
proc columnHeaderCells*(self: gen_qaccessible_types.QAccessibleTableCellInterface, ): seq[QAccessibleInterface] =
...
proc rowHeaderCells*(self: gen_qaccessible_types.QAccessibleTableCellInterface, ): seq[QAccessibleInterface] =
...
proc table*(self: gen_qaccessible_types.QAccessibleTableCellInterface, ): QAccessibleInterface =
  QAccessibleInterface(h: fcQAccessibleTableCellInterface_table(self.h))

proc operatorAssign*(self: gen_qaccessible_types.QAccessibleTableCellInterface, param1: QAccessibleTableCellInterface): void =
...
func init*(T: type gen_qaccessible_types.QAccessibleTableInterface, h: ptr cQAccessibleTableInterface): gen_qaccessible_types.QAccessibleTableInterface =
  T(h: h)
proc caption*(self: gen_qaccessible_types.QAccessibleTableInterface, ): QAccessibleInterface =
  QAccessibleInterface(h: fcQAccessibleTableInterface_caption(self.h))

proc summary*(self: gen_qaccessible_types.QAccessibleTableInterface, ): QAccessibleInterface =
  QAccessibleInterface(h: fcQAccessibleTableInterface_summary(self.h))

proc cellAt*(self: gen_qaccessible_types.QAccessibleTableInterface, row: cint, column: cint): QAccessibleInterface =
...
proc selectedCells*(self: gen_qaccessible_types.QAccessibleTableInterface, ): seq[QAccessibleInterface] =
...
proc modelChange*(self: gen_qaccessible_types.QAccessibleTableInterface, event: QAccessibleTableModelChangeEvent): void =
...
proc operatorAssign*(self: gen_qaccessible_types.QAccessibleActionInterface, param1: QAccessibleActionInterface): void =
...
proc imageSize*(self: gen_qaccessible_types.QAccessibleImageInterface, ): QSize =
  QSize(h: fcQAccessibleImageInterface_imageSize(self.h))

proc imagePosition*(self: gen_qaccessible_types.QAccessibleImageInterface, ): QPoint =
  QPoint(h: fcQAccessibleImageInterface_imagePosition(self.h))

proc operatorAssign*(self: gen_qaccessible_types.QAccessibleImageInterface, param1: QAccessibleImageInterface): void =
...
func init*(T: type gen_qaccessible_types.QAccessibleEvent, h: ptr cQAccessibleEvent): gen_qaccessible_types.QAccessibleEvent =
  T(h: h)
proc create*(T: type gen_qaccessible_types.QAccessibleEvent, obj: QObject, typ: cint): gen_qaccessible_types.QAccessibleEvent =
  gen_qaccessible_types.QAccessibleEvent.init(fcQAccessibleEvent_new(obj.h, cint(typ)))

proc create*(T: type gen_qaccessible_types.QAccessibleEvent, iface: QAccessibleInterface, typ: cint): gen_qaccessible_types.QAccessibleEvent =
...
proc objectX*(self: gen_qaccessible_types.QAccessibleEvent, ): QObject =
  QObject(h: fcQAccessibleEvent_objectX(self.h))
...
proc accessibleInterface*(self: gen_qaccessible_types.QAccessibleEvent, ): QAccessibleInterface =
  QAccessibleInterface(h: fcQAccessibleEvent_accessibleInterface(self.h))

proc QAccessibleEventaccessibleInterface*(self: gen_qaccessible_types.QAccessibleEvent, ): QAccessibleInterface =
  QAccessibleInterface(h: fQAccessibleEvent_virtualbase_accessibleInterface(self.h))

type QAccessibleEventaccessibleInterfaceProc* = proc(): QAccessibleInterface
...
func init*(T: type gen_qaccessible_types.QAccessibleStateChangeEvent, h: ptr cQAccessibleStateChangeEvent): gen_qaccessible_types.QAccessibleStateChangeEvent =
  T(h: h)
proc create*(T: type gen_qaccessible_types.QAccessibleStateChangeEvent, obj: QObject, state: QAccessibleState): gen_qaccessible_types.QAccessibleStateChangeEvent =
  gen_qaccessible_types.QAccessibleStateChangeEvent.init(fcQAccessibleStateChangeEvent_new(obj.h, state.h))

proc create*(T: type gen_qaccessible_types.QAccessibleStateChangeEvent, iface: QAccessibleInterface, state: QAccessibleState): gen_qaccessible_types.QAccessibleStateChangeEvent =
  gen_qaccessible_types.QAccessibleStateChangeEvent.init(fcQAccessibleStateChangeEvent_new2(iface.h, state.h))

proc changedStates*(self: gen_qaccessible_types.QAccessibleStateChangeEvent, ): QAccessibleState =
  QAccessibleState(h: fcQAccessibleStateChangeEvent_changedStates(self.h))

proc QAccessibleStateChangeEventaccessibleInterface*(self: gen_qaccessible_types.QAccessibleStateChangeEvent, ): QAccessibleInterface =
  QAccessibleInterface(h: fQAccessibleStateChangeEvent_virtualbase_accessibleInterface(self.h))

type QAccessibleStateChangeEventaccessibleInterfaceProc* = proc(): QAccessibleInterface
...
func init*(T: type gen_qaccessible_types.QAccessibleTextCursorEvent, h: ptr cQAccessibleTextCursorEvent): gen_qaccessible_types.QAccessibleTextCursorEvent =
  T(h: h)
proc create*(T: type gen_qaccessible_types.QAccessibleTextCursorEvent, obj: QObject, cursorPos: cint): gen_qaccessible_types.QAccessibleTextCursorEvent =
  gen_qaccessible_types.QAccessibleTextCursorEvent.init(fcQAccessibleTextCursorEvent_new(obj.h, cursorPos))

proc create*(T: type gen_qaccessible_types.QAccessibleTextCursorEvent, iface: QAccessibleInterface, cursorPos: cint): gen_qaccessible_types.QAccessibleTextCursorEvent =
...
proc QAccessibleTextCursorEventaccessibleInterface*(self: gen_qaccessible_types.QAccessibleTextCursorEvent, ): QAccessibleInterface =
  QAccessibleInterface(h: fQAccessibleTextCursorEvent_virtualbase_accessibleInterface(self.h))

type QAccessibleTextCursorEventaccessibleInterfaceProc* = proc(): QAccessibleInterface
...
func init*(T: type gen_qaccessible_types.QAccessibleTextSelectionEvent, h: ptr cQAccessibleTextSelectionEvent): gen_qaccessible_types.QAccessibleTextSelectionEvent =
  T(h: h)
proc create*(T: type gen_qaccessible_types.QAccessibleTextSelectionEvent, obj: QObject, start: cint, endVal: cint): gen_qaccessible_types.QAccessibleTextSelectionEvent =
  gen_qaccessible_types.QAccessibleTextSelectionEvent.init(fcQAccessibleTextSelectionEvent_new(obj.h, start, endVal))

proc create*(T: type gen_qaccessible_types.QAccessibleTextSelectionEvent, iface: QAccessibleInterface, start: cint, endVal: cint): gen_qaccessible_types.QAccessibleTextSelectionEvent =
...
proc QAccessibleTextSelectionEventaccessibleInterface*(self: gen_qaccessible_types.QAccessibleTextSelectionEvent, ): QAccessibleInterface =
  QAccessibleInterface(h: fQAccessibleTextSelectionEvent_virtualbase_accessibleInterface(self.h))

type QAccessibleTextSelectionEventaccessibleInterfaceProc* = proc(): QAccessibleInterface
...
func init*(T: type gen_qaccessible_types.QAccessibleTextInsertEvent, h: ptr cQAccessibleTextInsertEvent): gen_qaccessible_types.QAccessibleTextInsertEvent =
  T(h: h)
proc create*(T: type gen_qaccessible_types.QAccessibleTextInsertEvent, obj: QObject, position: cint, text: string): gen_qaccessible_types.QAccessibleTextInsertEvent =
...
proc create*(T: type gen_qaccessible_types.QAccessibleTextInsertEvent, iface: QAccessibleInterface, position: cint, text: string): gen_qaccessible_types.QAccessibleTextInsertEvent =
...
proc QAccessibleTextInsertEventaccessibleInterface*(self: gen_qaccessible_types.QAccessibleTextInsertEvent, ): QAccessibleInterface =
  QAccessibleInterface(h: fQAccessibleTextInsertEvent_virtualbase_accessibleInterface(self.h))

type QAccessibleTextInsertEventaccessibleInterfaceProc* = proc(): QAccessibleInterface
...
func init*(T: type gen_qaccessible_types.QAccessibleTextRemoveEvent, h: ptr cQAccessibleTextRemoveEvent): gen_qaccessible_types.QAccessibleTextRemoveEvent =
  T(h: h)
proc create*(T: type gen_qaccessible_types.QAccessibleTextRemoveEvent, obj: QObject, position: cint, text: string): gen_qaccessible_types.QAccessibleTextRemoveEvent =
...
proc create*(T: type gen_qaccessible_types.QAccessibleTextRemoveEvent, iface: QAccessibleInterface, position: cint, text: string): gen_qaccessible_types.QAccessibleTextRemoveEvent =
...
proc QAccessibleTextRemoveEventaccessibleInterface*(self: gen_qaccessible_types.QAccessibleTextRemoveEvent, ): QAccessibleInterface =
  QAccessibleInterface(h: fQAccessibleTextRemoveEvent_virtualbase_accessibleInterface(self.h))

type QAccessibleTextRemoveEventaccessibleInterfaceProc* = proc(): QAccessibleInterface
...
func init*(T: type gen_qaccessible_types.QAccessibleTextUpdateEvent, h: ptr cQAccessibleTextUpdateEvent): gen_qaccessible_types.QAccessibleTextUpdateEvent =
  T(h: h)
proc create*(T: type gen_qaccessible_types.QAccessibleTextUpdateEvent, obj: QObject, position: cint, oldText: string, text: string): gen_qaccessible_types.QAccessibleTextUpdateEvent =
...
proc create*(T: type gen_qaccessible_types.QAccessibleTextUpdateEvent, iface: QAccessibleInterface, position: cint, oldText: string, text: string): gen_qaccessible_types.QAccessibleTextUpdateEvent =
...
proc QAccessibleTextUpdateEventaccessibleInterface*(self: gen_qaccessible_types.QAccessibleTextUpdateEvent, ): QAccessibleInterface =
  QAccessibleInterface(h: fQAccessibleTextUpdateEvent_virtualbase_accessibleInterface(self.h))

type QAccessibleTextUpdateEventaccessibleInterfaceProc* = proc(): QAccessibleInterface
...
func init*(T: type gen_qaccessible_types.QAccessibleValueChangeEvent, h: ptr cQAccessibleValueChangeEvent): gen_qaccessible_types.QAccessibleValueChangeEvent =
  T(h: h)
proc create*(T: type gen_qaccessible_types.QAccessibleValueChangeEvent, obj: QObject, val: QVariant): gen_qaccessible_types.QAccessibleValueChangeEvent =
  gen_qaccessible_types.QAccessibleValueChangeEvent.init(fcQAccessibleValueChangeEvent_new(obj.h, val.h))

proc create*(T: type gen_qaccessible_types.QAccessibleValueChangeEvent, iface: QAccessibleInterface, val: QVariant): gen_qaccessible_types.QAccessibleValueChangeEvent =
  gen_qaccessible_types.QAccessibleValueChangeEvent.init(fcQAccessibleValueChangeEvent_new2(iface.h, val.h))

proc setValue*(self: gen_qaccessible_types.QAccessibleValueChangeEvent, val: QVariant): void =
  fcQAccessibleValueChangeEvent_setValue(self.h, val.h)

proc value*(self: gen_qaccessible_types.QAccessibleValueChangeEvent, ): QVariant =
  QVariant(h: fcQAccessibleValueChangeEvent_value(self.h))

proc QAccessibleValueChangeEventaccessibleInterface*(self: gen_qaccessible_types.QAccessibleValueChangeEvent, ): QAccessibleInterface =
  QAccessibleInterface(h: fQAccessibleValueChangeEvent_virtualbase_accessibleInterface(self.h))

type QAccessibleValueChangeEventaccessibleInterfaceProc* = proc(): QAccessibleInterface
...
func init*(T: type gen_qaccessible_types.QAccessibleTableModelChangeEvent, h: ptr cQAccessibleTableModelChangeEvent): gen_qaccessible_types.QAccessibleTableModelChangeEvent =
  T(h: h)
proc create*(T: type gen_qaccessible_types.QAccessibleTableModelChangeEvent, obj: QObject, changeType: cint): gen_qaccessible_types.QAccessibleTableModelChangeEvent =
  gen_qaccessible_types.QAccessibleTableModelChangeEvent.init(fcQAccessibleTableModelChangeEvent_new(obj.h, cint(changeType)))

proc create*(T: type gen_qaccessible_types.QAccessibleTableModelChangeEvent, iface: QAccessibleInterface, changeType: cint): gen_qaccessible_types.QAccessibleTableModelChangeEvent =
...
proc QAccessibleTableModelChangeEventaccessibleInterface*(self: gen_qaccessible_types.QAccessibleTableModelChangeEvent, ): QAccessibleInterface =
  QAccessibleInterface(h: fQAccessibleTableModelChangeEvent_virtualbase_accessibleInterface(self.h))

type QAccessibleTableModelChangeEventaccessibleInterfaceProc* = proc(): QAccessibleInterface
...
proc create*(T: type gen_qaccessible_types.QAccessibleState, param1: QAccessibleState): gen_qaccessible_types.QAccessibleState =
...
proc operatorAssign*(self: gen_qaccessible_types.QAccessibleActivationObserver, param1: QAccessibleActivationObserver): void =
