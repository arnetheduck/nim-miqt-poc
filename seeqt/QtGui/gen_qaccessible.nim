...
proc hyperlinkInterface*(self: gen_qaccessible_types.QAccessibleInterface, ): QAccessibleHyperlinkInterface =
...
proc operatorAssign*(self: gen_qaccessible_types.QAccessibleHyperlinkInterface, param1: QAccessibleHyperlinkInterface): void =
