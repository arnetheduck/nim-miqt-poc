...
proc create*(T: type gen_qrasterwindow_types.QRasterWindow, parent: QWindow): gen_qrasterwindow_types.QRasterWindow =
  gen_qrasterwindow_types.QRasterWindow.init(fcQRasterWindow_new2(parent.h))

proc metaObject*(self: gen_qrasterwindow_types.QRasterWindow, ): QMetaObject =
  QMetaObject(h: fcQRasterWindow_metaObject(self.h))
...
proc trUtf8*(_: type gen_qrasterwindow_types.QRasterWindow, s: cstring): string =
...
proc trUtf8*(_: type gen_qrasterwindow_types.QRasterWindow, s: cstring, c: cstring): string =
  let v_ms = fcQRasterWindow_trUtf82(s, c)
  let vx_ret = string.fromBytes(toOpenArrayByte(v_ms.data, 0, int(v_ms.len)-1))
  c_free(v_ms.data)
  vx_ret

proc trUtf8*(_: type gen_qrasterwindow_types.QRasterWindow, s: cstring, c: cstring, n: cint): string =
...
proc miqt_exec_callback_QRasterWindow_metric(self: ptr cQRasterWindow, slot: int, metric: cint): cint {.exportc: "miqt_exec_callback_QRasterWindow_metric ".} =
  ...
  virtualReturn
proc QRasterWindowredirected*(self: gen_qrasterwindow_types.QRasterWindow, param1: QPoint): QPaintDevice =
  QPaintDevice(h: fQRasterWindow_virtualbase_redirected(self.h, param1.h))

type QRasterWindowredirectedProc* = proc(param1: QPoint): QPaintDevice
...
proc miqt_exec_callback_QRasterWindow_redirected(self: ptr cQRasterWindow, slot: int, param1: pointer): pointer {.exportc: "miqt_exec_callback_QRasterWindow_redirected ".} =
  ...
  virtualReturn.h
proc QRasterWindowpaintEvent*(self: gen_qrasterwindow_types.QRasterWindow, event: QPaintEvent): void =
  fQRasterWindow_virtualbase_paintEvent(self.h, event.h)

type QRasterWindowpaintEventProc* = proc(event: QPaintEvent): void
...
proc miqt_exec_callback_QRasterWindow_paintEvent(self: ptr cQRasterWindow, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QRasterWindow_paintEvent ".} =
  ...
  nimfunc[](slotval1)
proc QRasterWindowexposeEvent*(self: gen_qrasterwindow_types.QRasterWindow, param1: QExposeEvent): void =
  fQRasterWindow_virtualbase_exposeEvent(self.h, param1.h)

type QRasterWindowexposeEventProc* = proc(param1: QExposeEvent): void
...
proc miqt_exec_callback_QRasterWindow_exposeEvent(self: ptr cQRasterWindow, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QRasterWindow_exposeEvent ".} =
  ...
  nimfunc[](slotval1)
proc QRasterWindowevent*(self: gen_qrasterwindow_types.QRasterWindow, event: QEvent): bool =
  fQRasterWindow_virtualbase_event(self.h, event.h)

type QRasterWindoweventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QRasterWindow_surfaceType(self: ptr cQRasterWindow, slot: int): cint {.exportc: "miqt_exec_callback_QRasterWindow_surfaceType ".} =
  ...
  cint(virtualReturn)
proc QRasterWindowformat*(self: gen_qrasterwindow_types.QRasterWindow, ): QSurfaceFormat =
  QSurfaceFormat(h: fQRasterWindow_virtualbase_format(self.h))

type QRasterWindowformatProc* = proc(): QSurfaceFormat
...
proc miqt_exec_callback_QRasterWindow_format(self: ptr cQRasterWindow, slot: int): pointer {.exportc: "miqt_exec_callback_QRasterWindow_format ".} =
  ...
  virtualReturn.h
proc QRasterWindowsize*(self: gen_qrasterwindow_types.QRasterWindow, ): QSize =
  QSize(h: fQRasterWindow_virtualbase_size(self.h))

type QRasterWindowsizeProc* = proc(): QSize
...
proc miqt_exec_callback_QRasterWindow_size(self: ptr cQRasterWindow, slot: int): pointer {.exportc: "miqt_exec_callback_QRasterWindow_size ".} =
  ...
  virtualReturn.h
proc QRasterWindowaccessibleRoot*(self: gen_qrasterwindow_types.QRasterWindow, ): QAccessibleInterface =
  QAccessibleInterface(h: fQRasterWindow_virtualbase_accessibleRoot(self.h))

type QRasterWindowaccessibleRootProc* = proc(): QAccessibleInterface
...
proc miqt_exec_callback_QRasterWindow_accessibleRoot(self: ptr cQRasterWindow, slot: int): pointer {.exportc: "miqt_exec_callback_QRasterWindow_accessibleRoot ".} =
  ...
  virtualReturn.h
proc QRasterWindowfocusObject*(self: gen_qrasterwindow_types.QRasterWindow, ): QObject =
  QObject(h: fQRasterWindow_virtualbase_focusObject(self.h))

type QRasterWindowfocusObjectProc* = proc(): QObject
...
proc miqt_exec_callback_QRasterWindow_focusObject(self: ptr cQRasterWindow, slot: int): pointer {.exportc: "miqt_exec_callback_QRasterWindow_focusObject ".} =
  ...
  virtualReturn.h
proc QRasterWindowresizeEvent*(self: gen_qrasterwindow_types.QRasterWindow, param1: QResizeEvent): void =
  fQRasterWindow_virtualbase_resizeEvent(self.h, param1.h)

type QRasterWindowresizeEventProc* = proc(param1: QResizeEvent): void
...
proc miqt_exec_callback_QRasterWindow_resizeEvent(self: ptr cQRasterWindow, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QRasterWindow_resizeEvent ".} =
  ...
  nimfunc[](slotval1)
proc QRasterWindowmoveEvent*(self: gen_qrasterwindow_types.QRasterWindow, param1: QMoveEvent): void =
  fQRasterWindow_virtualbase_moveEvent(self.h, param1.h)

type QRasterWindowmoveEventProc* = proc(param1: QMoveEvent): void
...
proc miqt_exec_callback_QRasterWindow_moveEvent(self: ptr cQRasterWindow, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QRasterWindow_moveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QRasterWindowfocusInEvent*(self: gen_qrasterwindow_types.QRasterWindow, param1: QFocusEvent): void =
  fQRasterWindow_virtualbase_focusInEvent(self.h, param1.h)

type QRasterWindowfocusInEventProc* = proc(param1: QFocusEvent): void
...
proc miqt_exec_callback_QRasterWindow_focusInEvent(self: ptr cQRasterWindow, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QRasterWindow_focusInEvent ".} =
  ...
  nimfunc[](slotval1)
proc QRasterWindowfocusOutEvent*(self: gen_qrasterwindow_types.QRasterWindow, param1: QFocusEvent): void =
  fQRasterWindow_virtualbase_focusOutEvent(self.h, param1.h)

type QRasterWindowfocusOutEventProc* = proc(param1: QFocusEvent): void
...
proc miqt_exec_callback_QRasterWindow_focusOutEvent(self: ptr cQRasterWindow, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QRasterWindow_focusOutEvent ".} =
  ...
  nimfunc[](slotval1)
proc QRasterWindowshowEvent*(self: gen_qrasterwindow_types.QRasterWindow, param1: QShowEvent): void =
  fQRasterWindow_virtualbase_showEvent(self.h, param1.h)

type QRasterWindowshowEventProc* = proc(param1: QShowEvent): void
...
proc miqt_exec_callback_QRasterWindow_showEvent(self: ptr cQRasterWindow, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QRasterWindow_showEvent ".} =
  ...
  nimfunc[](slotval1)
proc QRasterWindowhideEvent*(self: gen_qrasterwindow_types.QRasterWindow, param1: QHideEvent): void =
  fQRasterWindow_virtualbase_hideEvent(self.h, param1.h)

type QRasterWindowhideEventProc* = proc(param1: QHideEvent): void
...
proc miqt_exec_callback_QRasterWindow_hideEvent(self: ptr cQRasterWindow, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QRasterWindow_hideEvent ".} =
  ...
  nimfunc[](slotval1)
proc QRasterWindowkeyPressEvent*(self: gen_qrasterwindow_types.QRasterWindow, param1: QKeyEvent): void =
  fQRasterWindow_virtualbase_keyPressEvent(self.h, param1.h)

type QRasterWindowkeyPressEventProc* = proc(param1: QKeyEvent): void
...
proc miqt_exec_callback_QRasterWindow_keyPressEvent(self: ptr cQRasterWindow, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QRasterWindow_keyPressEvent ".} =
  ...
  nimfunc[](slotval1)
proc QRasterWindowkeyReleaseEvent*(self: gen_qrasterwindow_types.QRasterWindow, param1: QKeyEvent): void =
  fQRasterWindow_virtualbase_keyReleaseEvent(self.h, param1.h)

type QRasterWindowkeyReleaseEventProc* = proc(param1: QKeyEvent): void
...
proc miqt_exec_callback_QRasterWindow_keyReleaseEvent(self: ptr cQRasterWindow, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QRasterWindow_keyReleaseEvent ".} =
  ...
  nimfunc[](slotval1)
proc QRasterWindowmousePressEvent*(self: gen_qrasterwindow_types.QRasterWindow, param1: QMouseEvent): void =
  fQRasterWindow_virtualbase_mousePressEvent(self.h, param1.h)

type QRasterWindowmousePressEventProc* = proc(param1: QMouseEvent): void
...
proc miqt_exec_callback_QRasterWindow_mousePressEvent(self: ptr cQRasterWindow, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QRasterWindow_mousePressEvent ".} =
  ...
  nimfunc[](slotval1)
proc QRasterWindowmouseReleaseEvent*(self: gen_qrasterwindow_types.QRasterWindow, param1: QMouseEvent): void =
  fQRasterWindow_virtualbase_mouseReleaseEvent(self.h, param1.h)

type QRasterWindowmouseReleaseEventProc* = proc(param1: QMouseEvent): void
...
proc miqt_exec_callback_QRasterWindow_mouseReleaseEvent(self: ptr cQRasterWindow, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QRasterWindow_mouseReleaseEvent ".} =
  ...
  nimfunc[](slotval1)
proc QRasterWindowmouseDoubleClickEvent*(self: gen_qrasterwindow_types.QRasterWindow, param1: QMouseEvent): void =
  fQRasterWindow_virtualbase_mouseDoubleClickEvent(self.h, param1.h)

type QRasterWindowmouseDoubleClickEventProc* = proc(param1: QMouseEvent): void
...
proc miqt_exec_callback_QRasterWindow_mouseDoubleClickEvent(self: ptr cQRasterWindow, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QRasterWindow_mouseDoubleClickEvent ".} =
  ...
  nimfunc[](slotval1)
proc QRasterWindowmouseMoveEvent*(self: gen_qrasterwindow_types.QRasterWindow, param1: QMouseEvent): void =
  fQRasterWindow_virtualbase_mouseMoveEvent(self.h, param1.h)

type QRasterWindowmouseMoveEventProc* = proc(param1: QMouseEvent): void
...
proc miqt_exec_callback_QRasterWindow_mouseMoveEvent(self: ptr cQRasterWindow, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QRasterWindow_mouseMoveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QRasterWindowwheelEvent*(self: gen_qrasterwindow_types.QRasterWindow, param1: QWheelEvent): void =
  fQRasterWindow_virtualbase_wheelEvent(self.h, param1.h)

type QRasterWindowwheelEventProc* = proc(param1: QWheelEvent): void
...
proc miqt_exec_callback_QRasterWindow_wheelEvent(self: ptr cQRasterWindow, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QRasterWindow_wheelEvent ".} =
  ...
  nimfunc[](slotval1)
proc QRasterWindowtouchEvent*(self: gen_qrasterwindow_types.QRasterWindow, param1: QTouchEvent): void =
  fQRasterWindow_virtualbase_touchEvent(self.h, param1.h)

type QRasterWindowtouchEventProc* = proc(param1: QTouchEvent): void
...
proc miqt_exec_callback_QRasterWindow_touchEvent(self: ptr cQRasterWindow, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QRasterWindow_touchEvent ".} =
  ...
  nimfunc[](slotval1)
proc QRasterWindowtabletEvent*(self: gen_qrasterwindow_types.QRasterWindow, param1: QTabletEvent): void =
  fQRasterWindow_virtualbase_tabletEvent(self.h, param1.h)

type QRasterWindowtabletEventProc* = proc(param1: QTabletEvent): void
...
proc miqt_exec_callback_QRasterWindow_tabletEvent(self: ptr cQRasterWindow, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QRasterWindow_tabletEvent ".} =
  ...
  nimfunc[](slotval1)
proc QRasterWindownativeEvent*(self: gen_qrasterwindow_types.QRasterWindow, eventType: seq[byte], message: pointer, resultVal: ptr clong): bool =
...
type QRasterWindownativeEventProc* = proc(eventType: seq[byte], message: pointer, resultVal: ptr clong): bool
...
proc miqt_exec_callback_QRasterWindow_nativeEvent(self: ptr cQRasterWindow, slot: int, eventType: struct_miqt_string, message: pointer, resultVal: ptr clong): bool {.exportc: "miqt_exec_callback_QRasterWindow_nativeEvent ".} =
  ...
  virtualReturn
proc QRasterWindoweventFilter*(self: gen_qrasterwindow_types.QRasterWindow, watched: QObject, event: QEvent): bool =
  fQRasterWindow_virtualbase_eventFilter(self.h, watched.h, event.h)

type QRasterWindoweventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QRasterWindow_eventFilter(self: ptr cQRasterWindow, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QRasterWindow_eventFilter ".} =
  ...
  virtualReturn
proc QRasterWindowtimerEvent*(self: gen_qrasterwindow_types.QRasterWindow, event: QTimerEvent): void =
  fQRasterWindow_virtualbase_timerEvent(self.h, event.h)

type QRasterWindowtimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QRasterWindow_timerEvent(self: ptr cQRasterWindow, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QRasterWindow_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QRasterWindowchildEvent*(self: gen_qrasterwindow_types.QRasterWindow, event: QChildEvent): void =
  fQRasterWindow_virtualbase_childEvent(self.h, event.h)

type QRasterWindowchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QRasterWindow_childEvent(self: ptr cQRasterWindow, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QRasterWindow_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QRasterWindowcustomEvent*(self: gen_qrasterwindow_types.QRasterWindow, event: QEvent): void =
  fQRasterWindow_virtualbase_customEvent(self.h, event.h)

type QRasterWindowcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QRasterWindow_customEvent(self: ptr cQRasterWindow, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QRasterWindow_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QRasterWindowconnectNotify*(self: gen_qrasterwindow_types.QRasterWindow, signal: QMetaMethod): void =
  fQRasterWindow_virtualbase_connectNotify(self.h, signal.h)

type QRasterWindowconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QRasterWindow_connectNotify(self: ptr cQRasterWindow, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QRasterWindow_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QRasterWindowdisconnectNotify*(self: gen_qrasterwindow_types.QRasterWindow, signal: QMetaMethod): void =
  fQRasterWindow_virtualbase_disconnectNotify(self.h, signal.h)

type QRasterWindowdisconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QRasterWindow_devType(self: ptr cQRasterWindow, slot: int): cint {.exportc: "miqt_exec_callback_QRasterWindow_devType ".} =
  ...
  virtualReturn
proc QRasterWindowinitPainter*(self: gen_qrasterwindow_types.QRasterWindow, painter: QPainter): void =
  fQRasterWindow_virtualbase_initPainter(self.h, painter.h)

type QRasterWindowinitPainterProc* = proc(painter: QPainter): void
...
proc miqt_exec_callback_QRasterWindow_initPainter(self: ptr cQRasterWindow, slot: int, painter: pointer): void {.exportc: "miqt_exec_callback_QRasterWindow_initPainter ".} =
  ...
  nimfunc[](slotval1)
proc QRasterWindowsharedPainter*(self: gen_qrasterwindow_types.QRasterWindow, ): QPainter =
  QPainter(h: fQRasterWindow_virtualbase_sharedPainter(self.h))

type QRasterWindowsharedPainterProc* = proc(): QPainter
