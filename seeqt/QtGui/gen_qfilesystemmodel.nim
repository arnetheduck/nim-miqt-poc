...
proc create*(T: type gen_qfilesystemmodel_types.QFileSystemModel, parent: QObject): gen_qfilesystemmodel_types.QFileSystemModel =
  gen_qfilesystemmodel_types.QFileSystemModel.init(fcQFileSystemModel_new2(parent.h))

proc metaObject*(self: gen_qfilesystemmodel_types.QFileSystemModel, ): QMetaObject =
  QMetaObject(h: fcQFileSystemModel_metaObject(self.h))
...
proc index*(self: gen_qfilesystemmodel_types.QFileSystemModel, row: cint, column: cint, parent: QModelIndex): QModelIndex =
  QModelIndex(h: fcQFileSystemModel_index(self.h, row, column, parent.h))

proc index*(self: gen_qfilesystemmodel_types.QFileSystemModel, path: string): QModelIndex =
  QModelIndex(h: fcQFileSystemModel_indexWithPath(self.h, struct_miqt_string(data: path, len: csize_t(len(path)))))

proc parent*(self: gen_qfilesystemmodel_types.QFileSystemModel, child: QModelIndex): QModelIndex =
  QModelIndex(h: fcQFileSystemModel_parent(self.h, child.h))

proc sibling*(self: gen_qfilesystemmodel_types.QFileSystemModel, row: cint, column: cint, idx: QModelIndex): QModelIndex =
  QModelIndex(h: fcQFileSystemModel_sibling(self.h, row, column, idx.h))

proc hasChildren*(self: gen_qfilesystemmodel_types.QFileSystemModel, parent: QModelIndex): bool =
  fcQFileSystemModel_hasChildren(self.h, parent.h)

proc canFetchMore*(self: gen_qfilesystemmodel_types.QFileSystemModel, parent: QModelIndex): bool =
  fcQFileSystemModel_canFetchMore(self.h, parent.h)

proc fetchMore*(self: gen_qfilesystemmodel_types.QFileSystemModel, parent: QModelIndex): void =
  fcQFileSystemModel_fetchMore(self.h, parent.h)

proc rowCount*(self: gen_qfilesystemmodel_types.QFileSystemModel, parent: QModelIndex): cint =
  fcQFileSystemModel_rowCount(self.h, parent.h)

proc columnCount*(self: gen_qfilesystemmodel_types.QFileSystemModel, parent: QModelIndex): cint =
  fcQFileSystemModel_columnCount(self.h, parent.h)

proc myComputer*(self: gen_qfilesystemmodel_types.QFileSystemModel, ): QVariant =
  QVariant(h: fcQFileSystemModel_myComputer(self.h))

proc data*(self: gen_qfilesystemmodel_types.QFileSystemModel, index: QModelIndex, role: cint): QVariant =
  QVariant(h: fcQFileSystemModel_data(self.h, index.h, role))

proc setData*(self: gen_qfilesystemmodel_types.QFileSystemModel, index: QModelIndex, value: QVariant, role: cint): bool =
  fcQFileSystemModel_setData(self.h, index.h, value.h, role)

proc headerData*(self: gen_qfilesystemmodel_types.QFileSystemModel, section: cint, orientation: cint, role: cint): QVariant =
  QVariant(h: fcQFileSystemModel_headerData(self.h, section, cint(orientation), role))

proc flags*(self: gen_qfilesystemmodel_types.QFileSystemModel, index: QModelIndex): cint =
...
proc mimeData*(self: gen_qfilesystemmodel_types.QFileSystemModel, indexes: seq[QModelIndex]): QMimeData =
  var indexes_CArray = newSeq[pointer](len(indexes))
  for i in 0..<len(indexes):
    indexes_CArray[i] = indexes[i].h

  QMimeData(h: fcQFileSystemModel_mimeData(self.h, struct_miqt_array(len: csize_t(len(indexes)), data: if len(indexes) == 0: nil else: addr(indexes_CArray[0]))))

proc dropMimeData*(self: gen_qfilesystemmodel_types.QFileSystemModel, data: QMimeData, action: cint, row: cint, column: cint, parent: QModelIndex): bool =
...
proc setRootPath*(self: gen_qfilesystemmodel_types.QFileSystemModel, path: string): QModelIndex =
  QModelIndex(h: fcQFileSystemModel_setRootPath(self.h, struct_miqt_string(data: path, len: csize_t(len(path)))))
...
proc rootDirectory*(self: gen_qfilesystemmodel_types.QFileSystemModel, ): QDir =
  QDir(h: fcQFileSystemModel_rootDirectory(self.h))

proc setIconProvider*(self: gen_qfilesystemmodel_types.QFileSystemModel, provider: QAbstractFileIconProvider): void =
  fcQFileSystemModel_setIconProvider(self.h, provider.h)

proc iconProvider*(self: gen_qfilesystemmodel_types.QFileSystemModel, ): QAbstractFileIconProvider =
  QAbstractFileIconProvider(h: fcQFileSystemModel_iconProvider(self.h))
...
proc filePath*(self: gen_qfilesystemmodel_types.QFileSystemModel, index: QModelIndex): string =
  let v_ms = fcQFileSystemModel_filePath(self.h, index.h)
  let vx_ret = string.fromBytes(toOpenArrayByte(v_ms.data, 0, int(v_ms.len)-1))
  c_free(v_ms.data)
  vx_ret

proc isDir*(self: gen_qfilesystemmodel_types.QFileSystemModel, index: QModelIndex): bool =
  fcQFileSystemModel_isDir(self.h, index.h)

proc size*(self: gen_qfilesystemmodel_types.QFileSystemModel, index: QModelIndex): clonglong =
  fcQFileSystemModel_size(self.h, index.h)

proc typeX*(self: gen_qfilesystemmodel_types.QFileSystemModel, index: QModelIndex): string =
  let v_ms = fcQFileSystemModel_typeX(self.h, index.h)
  let vx_ret = string.fromBytes(toOpenArrayByte(v_ms.data, 0, int(v_ms.len)-1))
  c_free(v_ms.data)
  vx_ret

proc lastModified*(self: gen_qfilesystemmodel_types.QFileSystemModel, index: QModelIndex): QDateTime =
  QDateTime(h: fcQFileSystemModel_lastModified(self.h, index.h))

proc mkdir*(self: gen_qfilesystemmodel_types.QFileSystemModel, parent: QModelIndex, name: string): QModelIndex =
  QModelIndex(h: fcQFileSystemModel_mkdir(self.h, parent.h, struct_miqt_string(data: name, len: csize_t(len(name)))))

proc rmdir*(self: gen_qfilesystemmodel_types.QFileSystemModel, index: QModelIndex): bool =
  fcQFileSystemModel_rmdir(self.h, index.h)

proc fileName*(self: gen_qfilesystemmodel_types.QFileSystemModel, index: QModelIndex): string =
  let v_ms = fcQFileSystemModel_fileName(self.h, index.h)
  let vx_ret = string.fromBytes(toOpenArrayByte(v_ms.data, 0, int(v_ms.len)-1))
  c_free(v_ms.data)
  vx_ret

proc fileIcon*(self: gen_qfilesystemmodel_types.QFileSystemModel, index: QModelIndex): QIcon =
  QIcon(h: fcQFileSystemModel_fileIcon(self.h, index.h))

proc permissions*(self: gen_qfilesystemmodel_types.QFileSystemModel, index: QModelIndex): cint =
  cint(fcQFileSystemModel_permissions(self.h, index.h))

proc fileInfo*(self: gen_qfilesystemmodel_types.QFileSystemModel, index: QModelIndex): QFileInfo =
  QFileInfo(h: fcQFileSystemModel_fileInfo(self.h, index.h))

proc remove*(self: gen_qfilesystemmodel_types.QFileSystemModel, index: QModelIndex): bool =
...
proc index*(self: gen_qfilesystemmodel_types.QFileSystemModel, path: string, column: cint): QModelIndex =
  QModelIndex(h: fcQFileSystemModel_index2(self.h, struct_miqt_string(data: path, len: csize_t(len(path))), column))

proc myComputer*(self: gen_qfilesystemmodel_types.QFileSystemModel, role: cint): QVariant =
  QVariant(h: fcQFileSystemModel_myComputer1(self.h, role))
...
proc miqt_exec_callback_QFileSystemModel_metacall(self: ptr cQFileSystemModel, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QFileSystemModel_metacall ".} =
  ...
  virtualReturn
proc QFileSystemModelindex*(self: gen_qfilesystemmodel_types.QFileSystemModel, row: cint, column: cint, parent: QModelIndex): QModelIndex =
  QModelIndex(h: fQFileSystemModel_virtualbase_index(self.h, row, column, parent.h))

type QFileSystemModelindexProc* = proc(row: cint, column: cint, parent: QModelIndex): QModelIndex
...
proc miqt_exec_callback_QFileSystemModel_index(self: ptr cQFileSystemModel, slot: int, row: cint, column: cint, parent: pointer): pointer {.exportc: "miqt_exec_callback_QFileSystemModel_index ".} =
  ...
  virtualReturn.h
proc QFileSystemModelparent*(self: gen_qfilesystemmodel_types.QFileSystemModel, child: QModelIndex): QModelIndex =
  QModelIndex(h: fQFileSystemModel_virtualbase_parent(self.h, child.h))

type QFileSystemModelparentProc* = proc(child: QModelIndex): QModelIndex
...
proc miqt_exec_callback_QFileSystemModel_parent(self: ptr cQFileSystemModel, slot: int, child: pointer): pointer {.exportc: "miqt_exec_callback_QFileSystemModel_parent ".} =
  ...
  virtualReturn.h
proc QFileSystemModelsibling*(self: gen_qfilesystemmodel_types.QFileSystemModel, row: cint, column: cint, idx: QModelIndex): QModelIndex =
  QModelIndex(h: fQFileSystemModel_virtualbase_sibling(self.h, row, column, idx.h))

type QFileSystemModelsiblingProc* = proc(row: cint, column: cint, idx: QModelIndex): QModelIndex
...
proc miqt_exec_callback_QFileSystemModel_sibling(self: ptr cQFileSystemModel, slot: int, row: cint, column: cint, idx: pointer): pointer {.exportc: "miqt_exec_callback_QFileSystemModel_sibling ".} =
  ...
  virtualReturn.h
proc QFileSystemModelhasChildren*(self: gen_qfilesystemmodel_types.QFileSystemModel, parent: QModelIndex): bool =
  fQFileSystemModel_virtualbase_hasChildren(self.h, parent.h)

type QFileSystemModelhasChildrenProc* = proc(parent: QModelIndex): bool
...
proc miqt_exec_callback_QFileSystemModel_hasChildren(self: ptr cQFileSystemModel, slot: int, parent: pointer): bool {.exportc: "miqt_exec_callback_QFileSystemModel_hasChildren ".} =
  ...
  virtualReturn
proc QFileSystemModelcanFetchMore*(self: gen_qfilesystemmodel_types.QFileSystemModel, parent: QModelIndex): bool =
  fQFileSystemModel_virtualbase_canFetchMore(self.h, parent.h)

type QFileSystemModelcanFetchMoreProc* = proc(parent: QModelIndex): bool
...
proc miqt_exec_callback_QFileSystemModel_canFetchMore(self: ptr cQFileSystemModel, slot: int, parent: pointer): bool {.exportc: "miqt_exec_callback_QFileSystemModel_canFetchMore ".} =
  ...
  virtualReturn
proc QFileSystemModelfetchMore*(self: gen_qfilesystemmodel_types.QFileSystemModel, parent: QModelIndex): void =
  fQFileSystemModel_virtualbase_fetchMore(self.h, parent.h)

type QFileSystemModelfetchMoreProc* = proc(parent: QModelIndex): void
...
proc miqt_exec_callback_QFileSystemModel_fetchMore(self: ptr cQFileSystemModel, slot: int, parent: pointer): void {.exportc: "miqt_exec_callback_QFileSystemModel_fetchMore ".} =
  ...
  nimfunc[](slotval1)
proc QFileSystemModelrowCount*(self: gen_qfilesystemmodel_types.QFileSystemModel, parent: QModelIndex): cint =
  fQFileSystemModel_virtualbase_rowCount(self.h, parent.h)

type QFileSystemModelrowCountProc* = proc(parent: QModelIndex): cint
...
proc miqt_exec_callback_QFileSystemModel_rowCount(self: ptr cQFileSystemModel, slot: int, parent: pointer): cint {.exportc: "miqt_exec_callback_QFileSystemModel_rowCount ".} =
  ...
  virtualReturn
proc QFileSystemModelcolumnCount*(self: gen_qfilesystemmodel_types.QFileSystemModel, parent: QModelIndex): cint =
  fQFileSystemModel_virtualbase_columnCount(self.h, parent.h)

type QFileSystemModelcolumnCountProc* = proc(parent: QModelIndex): cint
...
proc miqt_exec_callback_QFileSystemModel_columnCount(self: ptr cQFileSystemModel, slot: int, parent: pointer): cint {.exportc: "miqt_exec_callback_QFileSystemModel_columnCount ".} =
  ...
  virtualReturn
proc QFileSystemModeldata*(self: gen_qfilesystemmodel_types.QFileSystemModel, index: QModelIndex, role: cint): QVariant =
  QVariant(h: fQFileSystemModel_virtualbase_data(self.h, index.h, role))

type QFileSystemModeldataProc* = proc(index: QModelIndex, role: cint): QVariant
...
proc miqt_exec_callback_QFileSystemModel_data(self: ptr cQFileSystemModel, slot: int, index: pointer, role: cint): pointer {.exportc: "miqt_exec_callback_QFileSystemModel_data ".} =
  ...
  virtualReturn.h
proc QFileSystemModelsetData*(self: gen_qfilesystemmodel_types.QFileSystemModel, index: QModelIndex, value: QVariant, role: cint): bool =
  fQFileSystemModel_virtualbase_setData(self.h, index.h, value.h, role)

type QFileSystemModelsetDataProc* = proc(index: QModelIndex, value: QVariant, role: cint): bool
...
proc miqt_exec_callback_QFileSystemModel_setData(self: ptr cQFileSystemModel, slot: int, index: pointer, value: pointer, role: cint): bool {.exportc: "miqt_exec_callback_QFileSystemModel_setData ".} =
  ...
  virtualReturn
proc QFileSystemModelheaderData*(self: gen_qfilesystemmodel_types.QFileSystemModel, section: cint, orientation: cint, role: cint): QVariant =
  QVariant(h: fQFileSystemModel_virtualbase_headerData(self.h, section, cint(orientation), role))

type QFileSystemModelheaderDataProc* = proc(section: cint, orientation: cint, role: cint): QVariant
...
proc miqt_exec_callback_QFileSystemModel_headerData(self: ptr cQFileSystemModel, slot: int, section: cint, orientation: cint, role: cint): pointer {.exportc: "miqt_exec_callback_QFileSystemModel_headerData ".} =
  ...
  virtualReturn.h
proc QFileSystemModelflags*(self: gen_qfilesystemmodel_types.QFileSystemModel, index: QModelIndex): cint =
  cint(fQFileSystemModel_virtualbase_flags(self.h, index.h))

type QFileSystemModelflagsProc* = proc(index: QModelIndex): cint
...
proc QFileSystemModelmimeData*(self: gen_qfilesystemmodel_types.QFileSystemModel, indexes: seq[QModelIndex]): QMimeData =
  var indexes_CArray = newSeq[pointer](len(indexes))
  for i in 0..<len(indexes):
    indexes_CArray[i] = indexes[i].h

  QMimeData(h: fQFileSystemModel_virtualbase_mimeData(self.h, struct_miqt_array(len: csize_t(len(indexes)), data: if len(indexes) == 0: nil else: addr(indexes_CArray[0]))))

type QFileSystemModelmimeDataProc* = proc(indexes: seq[QModelIndex]): QMimeData
...
proc miqt_exec_callback_QFileSystemModel_mimeData(self: ptr cQFileSystemModel, slot: int, indexes: struct_miqt_array): pointer {.exportc: "miqt_exec_callback_QFileSystemModel_mimeData ".} =
  ...
  virtualReturn.h
proc QFileSystemModeldropMimeData*(self: gen_qfilesystemmodel_types.QFileSystemModel, data: QMimeData, action: cint, row: cint, column: cint, parent: QModelIndex): bool =
  fQFileSystemModel_virtualbase_dropMimeData(self.h, data.h, cint(action), row, column, parent.h)

type QFileSystemModeldropMimeDataProc* = proc(data: QMimeData, action: cint, row: cint, column: cint, parent: QModelIndex): bool
...
proc QFileSystemModeltimerEvent*(self: gen_qfilesystemmodel_types.QFileSystemModel, event: QTimerEvent): void =
  fQFileSystemModel_virtualbase_timerEvent(self.h, event.h)

type QFileSystemModeltimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QFileSystemModel_timerEvent(self: ptr cQFileSystemModel, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QFileSystemModel_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QFileSystemModelevent*(self: gen_qfilesystemmodel_types.QFileSystemModel, event: QEvent): bool =
  fQFileSystemModel_virtualbase_event(self.h, event.h)

type QFileSystemModeleventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QFileSystemModel_event(self: ptr cQFileSystemModel, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QFileSystemModel_event ".} =
  ...
  virtualReturn
proc QFileSystemModelsetHeaderData*(self: gen_qfilesystemmodel_types.QFileSystemModel, section: cint, orientation: cint, value: QVariant, role: cint): bool =
  fQFileSystemModel_virtualbase_setHeaderData(self.h, section, cint(orientation), value.h, role)

type QFileSystemModelsetHeaderDataProc* = proc(section: cint, orientation: cint, value: QVariant, role: cint): bool
...
proc miqt_exec_callback_QFileSystemModel_setHeaderData(self: ptr cQFileSystemModel, slot: int, section: cint, orientation: cint, value: pointer, role: cint): bool {.exportc: "miqt_exec_callback_QFileSystemModel_setHeaderData ".} =
  ...
  virtualReturn
proc QFileSystemModelitemData*(self: gen_qfilesystemmodel_types.QFileSystemModel, index: QModelIndex): Table[cint,QVariant] =
...
type QFileSystemModelitemDataProc* = proc(index: QModelIndex): Table[cint,QVariant]
...
proc miqt_exec_callback_QFileSystemModel_itemData(self: ptr cQFileSystemModel, slot: int, index: pointer): struct_miqt_map {.exportc: "miqt_exec_callback_QFileSystemModel_itemData ".} =
  ...
  struct_miqt_map(len: csize_t(len(virtualReturn)),keys: if len(virtualReturn) == 0: nil else: addr(virtualReturn_Keys_CArray[0]), values: if len(virtualReturn) == 0: nil else: addr(virtualReturn_Values_CArray[0]),)
proc QFileSystemModelsetItemData*(self: gen_qfilesystemmodel_types.QFileSystemModel, index: QModelIndex, roles: Table[cint,QVariant]): bool =
...
type QFileSystemModelsetItemDataProc* = proc(index: QModelIndex, roles: Table[cint,QVariant]): bool
...
proc miqt_exec_callback_QFileSystemModel_setItemData(self: ptr cQFileSystemModel, slot: int, index: pointer, roles: struct_miqt_map): bool {.exportc: "miqt_exec_callback_QFileSystemModel_setItemData ".} =
  ...
  virtualReturn
proc QFileSystemModelclearItemData*(self: gen_qfilesystemmodel_types.QFileSystemModel, index: QModelIndex): bool =
  fQFileSystemModel_virtualbase_clearItemData(self.h, index.h)

type QFileSystemModelclearItemDataProc* = proc(index: QModelIndex): bool
...
proc miqt_exec_callback_QFileSystemModel_clearItemData(self: ptr cQFileSystemModel, slot: int, index: pointer): bool {.exportc: "miqt_exec_callback_QFileSystemModel_clearItemData ".} =
  ...
  virtualReturn
proc QFileSystemModelcanDropMimeData*(self: gen_qfilesystemmodel_types.QFileSystemModel, data: QMimeData, action: cint, row: cint, column: cint, parent: QModelIndex): bool =
  fQFileSystemModel_virtualbase_canDropMimeData(self.h, data.h, cint(action), row, column, parent.h)

type QFileSystemModelcanDropMimeDataProc* = proc(data: QMimeData, action: cint, row: cint, column: cint, parent: QModelIndex): bool
...
proc miqt_exec_callback_QFileSystemModel_supportedDragActions(self: ptr cQFileSystemModel, slot: int): cint {.exportc: "miqt_exec_callback_QFileSystemModel_supportedDragActions ".} =
  ...
  cint(virtualReturn)
proc QFileSystemModelinsertRows*(self: gen_qfilesystemmodel_types.QFileSystemModel, row: cint, count: cint, parent: QModelIndex): bool =
  fQFileSystemModel_virtualbase_insertRows(self.h, row, count, parent.h)

type QFileSystemModelinsertRowsProc* = proc(row: cint, count: cint, parent: QModelIndex): bool
...
proc miqt_exec_callback_QFileSystemModel_insertRows(self: ptr cQFileSystemModel, slot: int, row: cint, count: cint, parent: pointer): bool {.exportc: "miqt_exec_callback_QFileSystemModel_insertRows ".} =
  ...
  virtualReturn
proc QFileSystemModelinsertColumns*(self: gen_qfilesystemmodel_types.QFileSystemModel, column: cint, count: cint, parent: QModelIndex): bool =
  fQFileSystemModel_virtualbase_insertColumns(self.h, column, count, parent.h)

type QFileSystemModelinsertColumnsProc* = proc(column: cint, count: cint, parent: QModelIndex): bool
...
proc miqt_exec_callback_QFileSystemModel_insertColumns(self: ptr cQFileSystemModel, slot: int, column: cint, count: cint, parent: pointer): bool {.exportc: "miqt_exec_callback_QFileSystemModel_insertColumns ".} =
  ...
  virtualReturn
proc QFileSystemModelremoveRows*(self: gen_qfilesystemmodel_types.QFileSystemModel, row: cint, count: cint, parent: QModelIndex): bool =
  fQFileSystemModel_virtualbase_removeRows(self.h, row, count, parent.h)

type QFileSystemModelremoveRowsProc* = proc(row: cint, count: cint, parent: QModelIndex): bool
...
proc miqt_exec_callback_QFileSystemModel_removeRows(self: ptr cQFileSystemModel, slot: int, row: cint, count: cint, parent: pointer): bool {.exportc: "miqt_exec_callback_QFileSystemModel_removeRows ".} =
  ...
  virtualReturn
proc QFileSystemModelremoveColumns*(self: gen_qfilesystemmodel_types.QFileSystemModel, column: cint, count: cint, parent: QModelIndex): bool =
  fQFileSystemModel_virtualbase_removeColumns(self.h, column, count, parent.h)

type QFileSystemModelremoveColumnsProc* = proc(column: cint, count: cint, parent: QModelIndex): bool
...
proc miqt_exec_callback_QFileSystemModel_removeColumns(self: ptr cQFileSystemModel, slot: int, column: cint, count: cint, parent: pointer): bool {.exportc: "miqt_exec_callback_QFileSystemModel_removeColumns ".} =
  ...
  virtualReturn
proc QFileSystemModelmoveRows*(self: gen_qfilesystemmodel_types.QFileSystemModel, sourceParent: QModelIndex, sourceRow: cint, count: cint, destinationParent: QModelIndex, destinationChild: cint): bool =
  fQFileSystemModel_virtualbase_moveRows(self.h, sourceParent.h, sourceRow, count, destinationParent.h, destinationChild)

type QFileSystemModelmoveRowsProc* = proc(sourceParent: QModelIndex, sourceRow: cint, count: cint, destinationParent: QModelIndex, destinationChild: cint): bool
...
proc miqt_exec_callback_QFileSystemModel_moveRows(self: ptr cQFileSystemModel, slot: int, sourceParent: pointer, sourceRow: cint, count: cint, destinationParent: pointer, destinationChild: cint): bool {.exportc: "miqt_exec_callback_QFileSystemModel_moveRows ".} =
  ...
  virtualReturn
proc QFileSystemModelmoveColumns*(self: gen_qfilesystemmodel_types.QFileSystemModel, sourceParent: QModelIndex, sourceColumn: cint, count: cint, destinationParent: QModelIndex, destinationChild: cint): bool =
  fQFileSystemModel_virtualbase_moveColumns(self.h, sourceParent.h, sourceColumn, count, destinationParent.h, destinationChild)

type QFileSystemModelmoveColumnsProc* = proc(sourceParent: QModelIndex, sourceColumn: cint, count: cint, destinationParent: QModelIndex, destinationChild: cint): bool
...
proc miqt_exec_callback_QFileSystemModel_moveColumns(self: ptr cQFileSystemModel, slot: int, sourceParent: pointer, sourceColumn: cint, count: cint, destinationParent: pointer, destinationChild: cint): bool {.exportc: "miqt_exec_callback_QFileSystemModel_moveColumns ".} =
  ...
  virtualReturn
proc QFileSystemModelbuddy*(self: gen_qfilesystemmodel_types.QFileSystemModel, index: QModelIndex): QModelIndex =
  QModelIndex(h: fQFileSystemModel_virtualbase_buddy(self.h, index.h))

type QFileSystemModelbuddyProc* = proc(index: QModelIndex): QModelIndex
...
proc miqt_exec_callback_QFileSystemModel_buddy(self: ptr cQFileSystemModel, slot: int, index: pointer): pointer {.exportc: "miqt_exec_callback_QFileSystemModel_buddy ".} =
  ...
  virtualReturn.h
proc QFileSystemModelmatch*(self: gen_qfilesystemmodel_types.QFileSystemModel, start: QModelIndex, role: cint, value: QVariant, hits: cint, flags: cint): seq[QModelIndex] =
...
type QFileSystemModelmatchProc* = proc(start: QModelIndex, role: cint, value: QVariant, hits: cint, flags: cint): seq[QModelIndex]
...
proc miqt_exec_callback_QFileSystemModel_match(self: ptr cQFileSystemModel, slot: int, start: pointer, role: cint, value: pointer, hits: cint, flags: cint): struct_miqt_array {.exportc: "miqt_exec_callback_QFileSystemModel_match ".} =
  ...
  struct_miqt_array(len: csize_t(len(virtualReturn)), data: if len(virtualReturn) == 0: nil else: addr(virtualReturn_CArray[0]))
proc QFileSystemModelspan*(self: gen_qfilesystemmodel_types.QFileSystemModel, index: QModelIndex): QSize =
  QSize(h: fQFileSystemModel_virtualbase_span(self.h, index.h))

type QFileSystemModelspanProc* = proc(index: QModelIndex): QSize
...
proc miqt_exec_callback_QFileSystemModel_span(self: ptr cQFileSystemModel, slot: int, index: pointer): pointer {.exportc: "miqt_exec_callback_QFileSystemModel_span ".} =
  ...
  virtualReturn.h
proc QFileSystemModelmultiData*(self: gen_qfilesystemmodel_types.QFileSystemModel, index: QModelIndex, roleDataSpan: QModelRoleDataSpan): void =
  fQFileSystemModel_virtualbase_multiData(self.h, index.h, roleDataSpan.h)

type QFileSystemModelmultiDataProc* = proc(index: QModelIndex, roleDataSpan: QModelRoleDataSpan): void
...
proc miqt_exec_callback_QFileSystemModel_resetInternalData(self: ptr cQFileSystemModel, slot: int): void {.exportc: "miqt_exec_callback_QFileSystemModel_resetInternalData ".} =
  ...
  nimfunc[]()
proc QFileSystemModeleventFilter*(self: gen_qfilesystemmodel_types.QFileSystemModel, watched: QObject, event: QEvent): bool =
  fQFileSystemModel_virtualbase_eventFilter(self.h, watched.h, event.h)

type QFileSystemModeleventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QFileSystemModel_eventFilter(self: ptr cQFileSystemModel, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QFileSystemModel_eventFilter ".} =
  ...
  virtualReturn
proc QFileSystemModelchildEvent*(self: gen_qfilesystemmodel_types.QFileSystemModel, event: QChildEvent): void =
  fQFileSystemModel_virtualbase_childEvent(self.h, event.h)

type QFileSystemModelchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QFileSystemModel_childEvent(self: ptr cQFileSystemModel, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QFileSystemModel_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QFileSystemModelcustomEvent*(self: gen_qfilesystemmodel_types.QFileSystemModel, event: QEvent): void =
  fQFileSystemModel_virtualbase_customEvent(self.h, event.h)

type QFileSystemModelcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QFileSystemModel_customEvent(self: ptr cQFileSystemModel, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QFileSystemModel_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QFileSystemModelconnectNotify*(self: gen_qfilesystemmodel_types.QFileSystemModel, signal: QMetaMethod): void =
  fQFileSystemModel_virtualbase_connectNotify(self.h, signal.h)

type QFileSystemModelconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QFileSystemModel_connectNotify(self: ptr cQFileSystemModel, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QFileSystemModel_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QFileSystemModeldisconnectNotify*(self: gen_qfilesystemmodel_types.QFileSystemModel, signal: QMetaMethod): void =
  fQFileSystemModel_virtualbase_disconnectNotify(self.h, signal.h)

type QFileSystemModeldisconnectNotifyProc* = proc(signal: QMetaMethod): void
