...
public:
	...
	MiqtVirtualQWindow(struct QWindow_VTable* vtbl): QWindow(), vtbl(vtbl) {};
	MiqtVirtualQWindow(struct QWindow_VTable* vtbl, QWindow* parent): QWindow(parent), vtbl(vtbl) {};
	MiqtVirtualQWindow(struct QWindow_VTable* vtbl, QScreen* screen): QWindow(screen), vtbl(vtbl) {};

	virtual ~MiqtVirtualQWindow() override { if(vtbl->destructor) vtbl->destructor(vtbl, this); }
...
void QWindow_connect_screenChanged(QWindow* self, intptr_t slot, void (*callback)(intptr_t, QScreen*), void (*release)(intptr_t)) {
	...
	MiqtVirtualQWindow::connect(self, static_cast<void (QWindow::*)(QScreen*)>(&QWindow::screenChanged), self, caller{slot, callback, release});
}
...
void QWindow_connect_modalityChanged(QWindow* self, intptr_t slot, void (*callback)(intptr_t, int), void (*release)(intptr_t)) {
	...
	MiqtVirtualQWindow::connect(self, static_cast<void (QWindow::*)(Qt::WindowModality)>(&QWindow::modalityChanged), self, caller{slot, callback, release});
}
...
void QWindow_connect_windowStateChanged(QWindow* self, intptr_t slot, void (*callback)(intptr_t, int), void (*release)(intptr_t)) {
	...
	MiqtVirtualQWindow::connect(self, static_cast<void (QWindow::*)(Qt::WindowState)>(&QWindow::windowStateChanged), self, caller{slot, callback, release});
}
...
void QWindow_connect_windowTitleChanged(QWindow* self, intptr_t slot, void (*callback)(intptr_t, struct miqt_string), void (*release)(intptr_t)) {
	...
	MiqtVirtualQWindow::connect(self, static_cast<void (QWindow::*)(const QString&)>(&QWindow::windowTitleChanged), self, caller{slot, callback, release});
}
...
void QWindow_connect_xChanged(QWindow* self, intptr_t slot, void (*callback)(intptr_t, int), void (*release)(intptr_t)) {
	...
	MiqtVirtualQWindow::connect(self, static_cast<void (QWindow::*)(int)>(&QWindow::xChanged), self, caller{slot, callback, release});
}
...
void QWindow_connect_yChanged(QWindow* self, intptr_t slot, void (*callback)(intptr_t, int), void (*release)(intptr_t)) {
	...
	MiqtVirtualQWindow::connect(self, static_cast<void (QWindow::*)(int)>(&QWindow::yChanged), self, caller{slot, callback, release});
}
...
void QWindow_connect_widthChanged(QWindow* self, intptr_t slot, void (*callback)(intptr_t, int), void (*release)(intptr_t)) {
	...
	MiqtVirtualQWindow::connect(self, static_cast<void (QWindow::*)(int)>(&QWindow::widthChanged), self, caller{slot, callback, release});
}
...
void QWindow_connect_heightChanged(QWindow* self, intptr_t slot, void (*callback)(intptr_t, int), void (*release)(intptr_t)) {
	...
	MiqtVirtualQWindow::connect(self, static_cast<void (QWindow::*)(int)>(&QWindow::heightChanged), self, caller{slot, callback, release});
}
...
void QWindow_connect_minimumWidthChanged(QWindow* self, intptr_t slot, void (*callback)(intptr_t, int), void (*release)(intptr_t)) {
	...
	MiqtVirtualQWindow::connect(self, static_cast<void (QWindow::*)(int)>(&QWindow::minimumWidthChanged), self, caller{slot, callback, release});
}
...
void QWindow_connect_minimumHeightChanged(QWindow* self, intptr_t slot, void (*callback)(intptr_t, int), void (*release)(intptr_t)) {
	...
	MiqtVirtualQWindow::connect(self, static_cast<void (QWindow::*)(int)>(&QWindow::minimumHeightChanged), self, caller{slot, callback, release});
}
...
void QWindow_connect_maximumWidthChanged(QWindow* self, intptr_t slot, void (*callback)(intptr_t, int), void (*release)(intptr_t)) {
	...
	MiqtVirtualQWindow::connect(self, static_cast<void (QWindow::*)(int)>(&QWindow::maximumWidthChanged), self, caller{slot, callback, release});
}
...
void QWindow_connect_maximumHeightChanged(QWindow* self, intptr_t slot, void (*callback)(intptr_t, int), void (*release)(intptr_t)) {
	...
	MiqtVirtualQWindow::connect(self, static_cast<void (QWindow::*)(int)>(&QWindow::maximumHeightChanged), self, caller{slot, callback, release});
}
...
void QWindow_connect_visibleChanged(QWindow* self, intptr_t slot, void (*callback)(intptr_t, bool), void (*release)(intptr_t)) {
	...
	MiqtVirtualQWindow::connect(self, static_cast<void (QWindow::*)(bool)>(&QWindow::visibleChanged), self, caller{slot, callback, release});
}
...
void QWindow_connect_visibilityChanged(QWindow* self, intptr_t slot, void (*callback)(intptr_t, int), void (*release)(intptr_t)) {
	...
	MiqtVirtualQWindow::connect(self, static_cast<void (QWindow::*)(QWindow::Visibility)>(&QWindow::visibilityChanged), self, caller{slot, callback, release});
}
...
void QWindow_connect_activeChanged(QWindow* self, intptr_t slot, void (*callback)(intptr_t), void (*release)(intptr_t)) {
	...
	MiqtVirtualQWindow::connect(self, static_cast<void (QWindow::*)()>(&QWindow::activeChanged), self, caller{slot, callback, release});
}
...
void QWindow_connect_contentOrientationChanged(QWindow* self, intptr_t slot, void (*callback)(intptr_t, int), void (*release)(intptr_t)) {
	...
	MiqtVirtualQWindow::connect(self, static_cast<void (QWindow::*)(Qt::ScreenOrientation)>(&QWindow::contentOrientationChanged), self, caller{slot, callback, release});
}
...
void QWindow_connect_focusObjectChanged(QWindow* self, intptr_t slot, void (*callback)(intptr_t, QObject*), void (*release)(intptr_t)) {
	...
	MiqtVirtualQWindow::connect(self, static_cast<void (QWindow::*)(QObject*)>(&QWindow::focusObjectChanged), self, caller{slot, callback, release});
}
...
void QWindow_connect_opacityChanged(QWindow* self, intptr_t slot, void (*callback)(intptr_t, double), void (*release)(intptr_t)) {
	...
	MiqtVirtualQWindow::connect(self, static_cast<void (QWindow::*)(qreal)>(&QWindow::opacityChanged), self, caller{slot, callback, release});
}
...
void QWindow_connect_transientParentChanged(QWindow* self, intptr_t slot, void (*callback)(intptr_t, QWindow*), void (*release)(intptr_t)) {
	...
	MiqtVirtualQWindow::connect(self, static_cast<void (QWindow::*)(QWindow*)>(&QWindow::transientParentChanged), self, caller{slot, callback, release});
}
...
QMetaObject* QWindow_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQWindow*)(self) )->QWindow::metaObject();

}

void* QWindow_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQWindow*)(self) )->QWindow::qt_metacast(param1);

}

int QWindow_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQWindow*)(self) )->QWindow::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);

}

int QWindow_virtualbase_surfaceType(const void* self) {

	MiqtVirtualQWindow::SurfaceType _ret = ( (const MiqtVirtualQWindow*)(self) )->QWindow::surfaceType();
	return static_cast<int>(_ret);
...
bool QWindow_virtualbase_nativeEvent(void* self, struct miqt_string eventType, void* message, intptr_t* result) {
	...
	return ( (MiqtVirtualQWindow*)(self) )->QWindow::nativeEvent(eventType_QByteArray, message, (qintptr*)(result));

}

bool QWindow_virtualbase_eventFilter(void* self, QObject* watched, QEvent* event) {

	return ( (MiqtVirtualQWindow*)(self) )->QWindow::eventFilter(watched, event);

}

void QWindow_virtualbase_timerEvent(void* self, QTimerEvent* event) {

	( (MiqtVirtualQWindow*)(self) )->QWindow::timerEvent(event);

}

void QWindow_virtualbase_childEvent(void* self, QChildEvent* event) {

	( (MiqtVirtualQWindow*)(self) )->QWindow::childEvent(event);

}

void QWindow_virtualbase_customEvent(void* self, QEvent* event) {

	( (MiqtVirtualQWindow*)(self) )->QWindow::customEvent(event);

}

void QWindow_virtualbase_connectNotify(void* self, QMetaMethod* signal) {

	( (MiqtVirtualQWindow*)(self) )->QWindow::connectNotify(*signal);

}

void QWindow_virtualbase_disconnectNotify(void* self, QMetaMethod* signal) {

	( (MiqtVirtualQWindow*)(self) )->QWindow::disconnectNotify(*signal);
