...
QMetaObject* QTextTable_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQTextTable*)(self) )->QTextTable::metaObject();

}

void* QTextTable_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQTextTable*)(self) )->QTextTable::qt_metacast(param1);

}

int QTextTable_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQTextTable*)(self) )->QTextTable::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
