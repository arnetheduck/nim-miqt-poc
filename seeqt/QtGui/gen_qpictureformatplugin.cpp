...
QMetaObject* QPictureFormatPlugin_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQPictureFormatPlugin*)(self) )->QPictureFormatPlugin::metaObject();

}

void* QPictureFormatPlugin_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQPictureFormatPlugin*)(self) )->QPictureFormatPlugin::qt_metacast(param1);

}

int QPictureFormatPlugin_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQPictureFormatPlugin*)(self) )->QPictureFormatPlugin::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
