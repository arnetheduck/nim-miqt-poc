...
proc icon*(self: gen_qabstractfileiconprovider_types.QAbstractFileIconProvider, param1: cint): QIcon =
  QIcon(h: fcQAbstractFileIconProvider_icon(self.h, cint(param1)))

proc icon*(self: gen_qabstractfileiconprovider_types.QAbstractFileIconProvider, param1: QFileInfo): QIcon =
  QIcon(h: fcQAbstractFileIconProvider_iconWithQFileInfo(self.h, param1.h))

proc typeX*(self: gen_qabstractfileiconprovider_types.QAbstractFileIconProvider, param1: QFileInfo): string =
...
proc QAbstractFileIconProvidericon*(self: gen_qabstractfileiconprovider_types.QAbstractFileIconProvider, param1: cint): QIcon =
  QIcon(h: fQAbstractFileIconProvider_virtualbase_icon(self.h, cint(param1)))

type QAbstractFileIconProvidericonProc* = proc(param1: cint): QIcon
...
proc miqt_exec_callback_QAbstractFileIconProvider_icon(self: ptr cQAbstractFileIconProvider, slot: int, param1: cint): pointer {.exportc: "miqt_exec_callback_QAbstractFileIconProvider_icon ".} =
  ...
  virtualReturn.h
proc QAbstractFileIconProvidericon*(self: gen_qabstractfileiconprovider_types.QAbstractFileIconProvider, param1: QFileInfo): QIcon =
  QIcon(h: fQAbstractFileIconProvider_virtualbase_iconWithQFileInfo(self.h, param1.h))

type QAbstractFileIconProvidericonWithQFileInfoProc* = proc(param1: QFileInfo): QIcon
...
proc miqt_exec_callback_QAbstractFileIconProvider_iconWithQFileInfo(self: ptr cQAbstractFileIconProvider, slot: int, param1: pointer): pointer {.exportc: "miqt_exec_callback_QAbstractFileIconProvider_iconWithQFileInfo ".} =
  ...
  let slotval1 = QFileInfo(h: param1)


  let virtualReturn = nimfunc[](slotval1 )

  virtualReturn.h
proc QAbstractFileIconProvidertypeX*(self: gen_qabstractfileiconprovider_types.QAbstractFileIconProvider, param1: QFileInfo): string =
  let v_ms = fQAbstractFileIconProvider_virtualbase_type(self.h, param1.h)
  let vx_ret = string.fromBytes(toOpenArrayByte(v_ms.data, 0, int(v_ms.len)-1))
  c_free(v_ms.data)
  vx_ret

type QAbstractFileIconProvidertypeXProc* = proc(param1: QFileInfo): string
