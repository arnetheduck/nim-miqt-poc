...
proc create*(T: type gen_qbrush_types.QBrush, color: QColor): gen_qbrush_types.QBrush =
...
proc create*(T: type gen_qbrush_types.QBrush, color: QColor, pixmap: QPixmap): gen_qbrush_types.QBrush =
  gen_qbrush_types.QBrush.init(fcQBrush_new5(color.h, pixmap.h))

proc create*(T: type gen_qbrush_types.QBrush, color: cint, pixmap: QPixmap): gen_qbrush_types.QBrush =
  gen_qbrush_types.QBrush.init(fcQBrush_new6(cint(color), pixmap.h))

proc create*(T: type gen_qbrush_types.QBrush, pixmap: QPixmap): gen_qbrush_types.QBrush =
  gen_qbrush_types.QBrush.init(fcQBrush_new7(pixmap.h))

proc create*(T: type gen_qbrush_types.QBrush, image: QImage): gen_qbrush_types.QBrush =
  gen_qbrush_types.QBrush.init(fcQBrush_new8(image.h))

proc create*(T: type gen_qbrush_types.QBrush, brush: QBrush): gen_qbrush_types.QBrush =
  gen_qbrush_types.QBrush.init(fcQBrush_new9(brush.h))

proc create*(T: type gen_qbrush_types.QBrush, gradient: QGradient): gen_qbrush_types.QBrush =
  gen_qbrush_types.QBrush.init(fcQBrush_new10(gradient.h))

proc create*(T: type gen_qbrush_types.QBrush, color: QColor, bs: cint): gen_qbrush_types.QBrush =
...
proc operatorAssign*(self: gen_qbrush_types.QBrush, brush: QBrush): void =
  fcQBrush_operatorAssign(self.h, brush.h)

proc swap*(self: gen_qbrush_types.QBrush, other: QBrush): void =
  fcQBrush_swap(self.h, other.h)

proc ToQVariant*(self: gen_qbrush_types.QBrush, ): QVariant =
  QVariant(h: fcQBrush_ToQVariant(self.h))
...
proc matrix*(self: gen_qbrush_types.QBrush, ): QMatrix =
  QMatrix(h: fcQBrush_matrix(self.h))

proc setMatrix*(self: gen_qbrush_types.QBrush, mat: QMatrix): void =
  fcQBrush_setMatrix(self.h, mat.h)

proc transform*(self: gen_qbrush_types.QBrush, ): QTransform =
  QTransform(h: fcQBrush_transform(self.h))

proc setTransform*(self: gen_qbrush_types.QBrush, transform: QTransform): void =
  fcQBrush_setTransform(self.h, transform.h)

proc texture*(self: gen_qbrush_types.QBrush, ): QPixmap =
  QPixmap(h: fcQBrush_texture(self.h))

proc setTexture*(self: gen_qbrush_types.QBrush, pixmap: QPixmap): void =
  fcQBrush_setTexture(self.h, pixmap.h)

proc textureImage*(self: gen_qbrush_types.QBrush, ): QImage =
  QImage(h: fcQBrush_textureImage(self.h))

proc setTextureImage*(self: gen_qbrush_types.QBrush, image: QImage): void =
  fcQBrush_setTextureImage(self.h, image.h)

proc color*(self: gen_qbrush_types.QBrush, ): QColor =
  QColor(h: fcQBrush_color(self.h))

proc setColor*(self: gen_qbrush_types.QBrush, color: QColor): void =
...
proc gradient*(self: gen_qbrush_types.QBrush, ): QGradient =
  QGradient(h: fcQBrush_gradient(self.h))

proc isOpaque*(self: gen_qbrush_types.QBrush, ): bool =
  fcQBrush_isOpaque(self.h)

proc operatorEqual*(self: gen_qbrush_types.QBrush, b: QBrush): bool =
  fcQBrush_operatorEqual(self.h, b.h)

proc operatorNotEqual*(self: gen_qbrush_types.QBrush, b: QBrush): bool =
...
func init*(T: type gen_qbrush_types.QBrushData, h: ptr cQBrushData): gen_qbrush_types.QBrushData =
  T(h: h)
proc create*(T: type gen_qbrush_types.QBrushData, param1: QBrushData): gen_qbrush_types.QBrushData =
  gen_qbrush_types.QBrushData.init(fcQBrushData_new(param1.h))

proc operatorAssign*(self: gen_qbrush_types.QBrushData, param1: QBrushData): void =
...
proc create*(T: type gen_qbrush_types.QGradient, param1: QGradient): gen_qbrush_types.QGradient =
...
proc setColorAt*(self: gen_qbrush_types.QGradient, pos: float64, color: QColor): void =
  fcQGradient_setColorAt(self.h, pos, color.h)

proc setStops*(self: gen_qbrush_types.QGradient, stops: seq[tuple[first: float64, second: QColor]]): void =
...
proc stops*(self: gen_qbrush_types.QGradient, ): seq[tuple[first: float64, second: QColor]] =
  var v_ma = fcQGradient_stops(self.h)
  var vx_ret = newSeq[tuple[first: float64, second: QColor]](int(v_ma.len))
  ...
  for i in 0 ..< v_ma.len:
    ...
    var vx_vv_entry_Second = QColor(h: vx_vv_Second_CArray[0])
...
proc operatorEqual*(self: gen_qbrush_types.QGradient, gradient: QGradient): bool =
  fcQGradient_operatorEqual(self.h, gradient.h)

proc operatorNotEqual*(self: gen_qbrush_types.QGradient, other: QGradient): bool =
  fcQGradient_operatorNotEqual(self.h, other.h)

proc staticMetaObject*(_: type gen_qbrush_types.QGradient): gen_qobjectdefs_types.QMetaObject =
  gen_qobjectdefs_types.QMetaObject(h: fcQGradient_staticMetaObject())
...
proc create*(T: type gen_qbrush_types.QLinearGradient, start: QPointF, finalStop: QPointF): gen_qbrush_types.QLinearGradient =
...
proc create*(T: type gen_qbrush_types.QLinearGradient, param1: QLinearGradient): gen_qbrush_types.QLinearGradient =
  gen_qbrush_types.QLinearGradient.init(fcQLinearGradient_new4(param1.h))

proc start*(self: gen_qbrush_types.QLinearGradient, ): QPointF =
  QPointF(h: fcQLinearGradient_start(self.h))

proc setStart*(self: gen_qbrush_types.QLinearGradient, start: QPointF): void =
...
proc finalStop*(self: gen_qbrush_types.QLinearGradient, ): QPointF =
  QPointF(h: fcQLinearGradient_finalStop(self.h))

proc setFinalStop*(self: gen_qbrush_types.QLinearGradient, stop: QPointF): void =
...
proc create*(T: type gen_qbrush_types.QRadialGradient, center: QPointF, radius: float64, focalPoint: QPointF): gen_qbrush_types.QRadialGradient =
...
proc create*(T: type gen_qbrush_types.QRadialGradient, center: QPointF, radius: float64): gen_qbrush_types.QRadialGradient =
...
proc create*(T: type gen_qbrush_types.QRadialGradient, center: QPointF, centerRadius: float64, focalPoint: QPointF, focalRadius: float64): gen_qbrush_types.QRadialGradient =
...
proc create*(T: type gen_qbrush_types.QRadialGradient, param1: QRadialGradient): gen_qbrush_types.QRadialGradient =
  gen_qbrush_types.QRadialGradient.init(fcQRadialGradient_new8(param1.h))

proc center*(self: gen_qbrush_types.QRadialGradient, ): QPointF =
  QPointF(h: fcQRadialGradient_center(self.h))

proc setCenter*(self: gen_qbrush_types.QRadialGradient, center: QPointF): void =
...
proc focalPoint*(self: gen_qbrush_types.QRadialGradient, ): QPointF =
  QPointF(h: fcQRadialGradient_focalPoint(self.h))

proc setFocalPoint*(self: gen_qbrush_types.QRadialGradient, focalPoint: QPointF): void =
...
proc create*(T: type gen_qbrush_types.QConicalGradient, center: QPointF, startAngle: float64): gen_qbrush_types.QConicalGradient =
...
proc create*(T: type gen_qbrush_types.QConicalGradient, param1: QConicalGradient): gen_qbrush_types.QConicalGradient =
  gen_qbrush_types.QConicalGradient.init(fcQConicalGradient_new4(param1.h))

proc center*(self: gen_qbrush_types.QConicalGradient, ): QPointF =
  QPointF(h: fcQConicalGradient_center(self.h))

proc setCenter*(self: gen_qbrush_types.QConicalGradient, center: QPointF): void =
...
func init*(T: type gen_qbrush_types.QGradientQGradientData, h: ptr cQGradientQGradientData): gen_qbrush_types.QGradientQGradientData =
  T(h: h)
proc create*(T: type gen_qbrush_types.QGradientQGradientData, param1: QGradientQGradientData): gen_qbrush_types.QGradientQGradientData =
  gen_qbrush_types.QGradientQGradientData.init(fcQGradientQGradientData_new(param1.h))

proc operatorAssign*(self: gen_qbrush_types.QGradientQGradientData, param1: QGradientQGradientData): void =
