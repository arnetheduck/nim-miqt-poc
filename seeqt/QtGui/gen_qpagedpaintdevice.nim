...
proc setPageLayout*(self: gen_qpagedpaintdevice_types.QPagedPaintDevice, pageLayout: QPageLayout): bool =
  fcQPagedPaintDevice_setPageLayout(self.h, pageLayout.h)

proc setPageSize*(self: gen_qpagedpaintdevice_types.QPagedPaintDevice, pageSize: QPageSize): bool =
...
proc setPageMargins*(self: gen_qpagedpaintdevice_types.QPagedPaintDevice, margins: QMarginsF): bool =
  fcQPagedPaintDevice_setPageMargins(self.h, margins.h)

proc setPageMargins*(self: gen_qpagedpaintdevice_types.QPagedPaintDevice, margins: QMarginsF, units: cint): bool =
  fcQPagedPaintDevice_setPageMargins2(self.h, margins.h, cint(units))

proc pageLayout*(self: gen_qpagedpaintdevice_types.QPagedPaintDevice, ): QPageLayout =
  QPageLayout(h: fcQPagedPaintDevice_pageLayout(self.h))
...
proc setPageSizeMM*(self: gen_qpagedpaintdevice_types.QPagedPaintDevice, size: QSizeF): void =
  fcQPagedPaintDevice_setPageSizeMM(self.h, size.h)

proc pageSizeMM*(self: gen_qpagedpaintdevice_types.QPagedPaintDevice, ): QSizeF =
  QSizeF(h: fcQPagedPaintDevice_pageSizeMM(self.h))

proc setMargins*(self: gen_qpagedpaintdevice_types.QPagedPaintDevice, margins: QPagedPaintDeviceMargins): void =
  fcQPagedPaintDevice_setMargins(self.h, margins.h)

proc margins*(self: gen_qpagedpaintdevice_types.QPagedPaintDevice, ): QPagedPaintDeviceMargins =
...
proc miqt_exec_callback_QPagedPaintDevice_setPageSizeWithSize(self: ptr cQPagedPaintDevice, slot: int, size: cint): void {.exportc: "miqt_exec_callback_QPagedPaintDevice_setPageSizeWithSize ".} =
  ...
  nimfunc[](slotval1)
proc QPagedPaintDevicesetPageSizeMM*(self: gen_qpagedpaintdevice_types.QPagedPaintDevice, size: QSizeF): void =
  fQPagedPaintDevice_virtualbase_setPageSizeMM(self.h, size.h)

type QPagedPaintDevicesetPageSizeMMProc* = proc(size: QSizeF): void
...
proc miqt_exec_callback_QPagedPaintDevice_setPageSizeMM(self: ptr cQPagedPaintDevice, slot: int, size: pointer): void {.exportc: "miqt_exec_callback_QPagedPaintDevice_setPageSizeMM ".} =
  ...
  nimfunc[](slotval1)
proc QPagedPaintDevicesetMargins*(self: gen_qpagedpaintdevice_types.QPagedPaintDevice, margins: QPagedPaintDeviceMargins): void =
  fQPagedPaintDevice_virtualbase_setMargins(self.h, margins.h)

type QPagedPaintDevicesetMarginsProc* = proc(margins: QPagedPaintDeviceMargins): void
...
proc miqt_exec_callback_QPagedPaintDevice_devType(self: ptr cQPagedPaintDevice, slot: int): cint {.exportc: "miqt_exec_callback_QPagedPaintDevice_devType ".} =
  ...
  virtualReturn
type QPagedPaintDevicepaintEngineProc* = proc(): QPaintEngine
...
proc miqt_exec_callback_QPagedPaintDevice_metric(self: ptr cQPagedPaintDevice, slot: int, metric: cint): cint {.exportc: "miqt_exec_callback_QPagedPaintDevice_metric ".} =
  ...
  virtualReturn
proc QPagedPaintDeviceinitPainter*(self: gen_qpagedpaintdevice_types.QPagedPaintDevice, painter: QPainter): void =
  fQPagedPaintDevice_virtualbase_initPainter(self.h, painter.h)

type QPagedPaintDeviceinitPainterProc* = proc(painter: QPainter): void
...
proc miqt_exec_callback_QPagedPaintDevice_initPainter(self: ptr cQPagedPaintDevice, slot: int, painter: pointer): void {.exportc: "miqt_exec_callback_QPagedPaintDevice_initPainter ".} =
  ...
  nimfunc[](slotval1)
proc QPagedPaintDeviceredirected*(self: gen_qpagedpaintdevice_types.QPagedPaintDevice, offset: QPoint): QPaintDevice =
  QPaintDevice(h: fQPagedPaintDevice_virtualbase_redirected(self.h, offset.h))

type QPagedPaintDeviceredirectedProc* = proc(offset: QPoint): QPaintDevice
...
proc miqt_exec_callback_QPagedPaintDevice_redirected(self: ptr cQPagedPaintDevice, slot: int, offset: pointer): pointer {.exportc: "miqt_exec_callback_QPagedPaintDevice_redirected ".} =
  ...
  virtualReturn.h
proc QPagedPaintDevicesharedPainter*(self: gen_qpagedpaintdevice_types.QPagedPaintDevice, ): QPainter =
  QPainter(h: fQPagedPaintDevice_virtualbase_sharedPainter(self.h))

type QPagedPaintDevicesharedPainterProc* = proc(): QPainter
