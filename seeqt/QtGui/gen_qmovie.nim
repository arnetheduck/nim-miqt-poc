...
proc create*(T: type gen_qmovie_types.QMovie, device: QIODevice): gen_qmovie_types.QMovie =
...
proc create*(T: type gen_qmovie_types.QMovie, parent: QObject): gen_qmovie_types.QMovie =
  gen_qmovie_types.QMovie.init(fcQMovie_new4(parent.h))

proc create*(T: type gen_qmovie_types.QMovie, device: QIODevice, format: seq[byte]): gen_qmovie_types.QMovie =
...
proc create*(T: type gen_qmovie_types.QMovie, device: QIODevice, format: seq[byte], parent: QObject): gen_qmovie_types.QMovie =
...
proc create*(T: type gen_qmovie_types.QMovie, fileName: string, format: seq[byte], parent: QObject): gen_qmovie_types.QMovie =
...
proc metaObject*(self: gen_qmovie_types.QMovie, ): QMetaObject =
  QMetaObject(h: fcQMovie_metaObject(self.h))
...
proc setDevice*(self: gen_qmovie_types.QMovie, device: QIODevice): void =
  fcQMovie_setDevice(self.h, device.h)

proc device*(self: gen_qmovie_types.QMovie, ): QIODevice =
  QIODevice(h: fcQMovie_device(self.h))
...
proc setBackgroundColor*(self: gen_qmovie_types.QMovie, color: QColor): void =
  fcQMovie_setBackgroundColor(self.h, color.h)

proc backgroundColor*(self: gen_qmovie_types.QMovie, ): QColor =
  QColor(h: fcQMovie_backgroundColor(self.h))

proc state*(self: gen_qmovie_types.QMovie, ): cint =
  cint(fcQMovie_state(self.h))

proc frameRect*(self: gen_qmovie_types.QMovie, ): QRect =
  QRect(h: fcQMovie_frameRect(self.h))

proc currentImage*(self: gen_qmovie_types.QMovie, ): QImage =
  QImage(h: fcQMovie_currentImage(self.h))

proc currentPixmap*(self: gen_qmovie_types.QMovie, ): QPixmap =
  QPixmap(h: fcQMovie_currentPixmap(self.h))
...
proc scaledSize*(self: gen_qmovie_types.QMovie, ): QSize =
  QSize(h: fcQMovie_scaledSize(self.h))

proc setScaledSize*(self: gen_qmovie_types.QMovie, size: QSize): void =
...
proc resized*(self: gen_qmovie_types.QMovie, size: QSize): void =
  fcQMovie_resized(self.h, size.h)

type QMovieresizedSlot* = proc(size: QSize)
...
proc updated*(self: gen_qmovie_types.QMovie, rect: QRect): void =
  fcQMovie_updated(self.h, rect.h)

type QMovieupdatedSlot* = proc(rect: QRect)
...
proc miqt_exec_callback_QMovie_metacall(self: ptr cQMovie, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QMovie_metacall ".} =
  ...
  virtualReturn
proc QMovieevent*(self: gen_qmovie_types.QMovie, event: QEvent): bool =
  fQMovie_virtualbase_event(self.h, event.h)

type QMovieeventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QMovie_event(self: ptr cQMovie, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QMovie_event ".} =
  ...
  virtualReturn
proc QMovieeventFilter*(self: gen_qmovie_types.QMovie, watched: QObject, event: QEvent): bool =
  fQMovie_virtualbase_eventFilter(self.h, watched.h, event.h)

type QMovieeventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QMovie_eventFilter(self: ptr cQMovie, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QMovie_eventFilter ".} =
  ...
  virtualReturn
proc QMovietimerEvent*(self: gen_qmovie_types.QMovie, event: QTimerEvent): void =
  fQMovie_virtualbase_timerEvent(self.h, event.h)

type QMovietimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QMovie_timerEvent(self: ptr cQMovie, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QMovie_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QMoviechildEvent*(self: gen_qmovie_types.QMovie, event: QChildEvent): void =
  fQMovie_virtualbase_childEvent(self.h, event.h)

type QMoviechildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QMovie_childEvent(self: ptr cQMovie, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QMovie_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QMoviecustomEvent*(self: gen_qmovie_types.QMovie, event: QEvent): void =
  fQMovie_virtualbase_customEvent(self.h, event.h)

type QMoviecustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QMovie_customEvent(self: ptr cQMovie, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QMovie_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QMovieconnectNotify*(self: gen_qmovie_types.QMovie, signal: QMetaMethod): void =
  fQMovie_virtualbase_connectNotify(self.h, signal.h)

type QMovieconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QMovie_connectNotify(self: ptr cQMovie, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QMovie_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QMoviedisconnectNotify*(self: gen_qmovie_types.QMovie, signal: QMetaMethod): void =
  fQMovie_virtualbase_disconnectNotify(self.h, signal.h)

type QMoviedisconnectNotifyProc* = proc(signal: QMetaMethod): void
