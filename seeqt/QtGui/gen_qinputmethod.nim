...
func init*(T: type gen_qinputmethod_types.QInputMethod, h: ptr cQInputMethod): gen_qinputmethod_types.QInputMethod =
  T(h: h)
proc metaObject*(self: gen_qinputmethod_types.QInputMethod, ): QMetaObject =
  QMetaObject(h: fcQInputMethod_metaObject(self.h))
...
proc inputItemTransform*(self: gen_qinputmethod_types.QInputMethod, ): QTransform =
  QTransform(h: fcQInputMethod_inputItemTransform(self.h))

proc setInputItemTransform*(self: gen_qinputmethod_types.QInputMethod, transform: QTransform): void =
  fcQInputMethod_setInputItemTransform(self.h, transform.h)

proc inputItemRectangle*(self: gen_qinputmethod_types.QInputMethod, ): QRectF =
  QRectF(h: fcQInputMethod_inputItemRectangle(self.h))

proc setInputItemRectangle*(self: gen_qinputmethod_types.QInputMethod, rect: QRectF): void =
  fcQInputMethod_setInputItemRectangle(self.h, rect.h)

proc cursorRectangle*(self: gen_qinputmethod_types.QInputMethod, ): QRectF =
  QRectF(h: fcQInputMethod_cursorRectangle(self.h))

proc anchorRectangle*(self: gen_qinputmethod_types.QInputMethod, ): QRectF =
  QRectF(h: fcQInputMethod_anchorRectangle(self.h))

proc keyboardRectangle*(self: gen_qinputmethod_types.QInputMethod, ): QRectF =
  QRectF(h: fcQInputMethod_keyboardRectangle(self.h))

proc inputItemClipRectangle*(self: gen_qinputmethod_types.QInputMethod, ): QRectF =
  QRectF(h: fcQInputMethod_inputItemClipRectangle(self.h))
...
proc locale*(self: gen_qinputmethod_types.QInputMethod, ): QLocale =
  QLocale(h: fcQInputMethod_locale(self.h))

proc inputDirection*(self: gen_qinputmethod_types.QInputMethod, ): cint =
  cint(fcQInputMethod_inputDirection(self.h))

proc queryFocusObject*(_: type gen_qinputmethod_types.QInputMethod, query: cint, argument: QVariant): QVariant =
  QVariant(h: fcQInputMethod_queryFocusObject(cint(query), argument.h))
