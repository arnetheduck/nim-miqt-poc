...
proc setAdditionalFormats*(self: gen_qtextlayout_types.QTextLayout, overrides: seq[QTextLayoutFormatRange]): void =
...
proc additionalFormats*(self: gen_qtextlayout_types.QTextLayout, ): seq[QTextLayoutFormatRange] =
...
proc draw*(self: gen_qtextlayout_types.QTextLine, p: QPainter, point: QPointF): void =
...
proc draw*(self: gen_qtextlayout_types.QTextLine, p: QPainter, point: QPointF, selection: QTextLayoutFormatRange): void =
