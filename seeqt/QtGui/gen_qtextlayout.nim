...
proc rect*(self: gen_qtextlayout_types.QTextInlineObject, ): QRectF =
  QRectF(h: fcQTextInlineObject_rect(self.h))
...
proc format*(self: gen_qtextlayout_types.QTextInlineObject, ): QTextFormat =
  QTextFormat(h: fcQTextInlineObject_format(self.h))
...
proc create*(T: type gen_qtextlayout_types.QTextLayout, text: string, font: QFont): gen_qtextlayout_types.QTextLayout =
  gen_qtextlayout_types.QTextLayout.init(fcQTextLayout_new3(struct_miqt_string(data: text, len: csize_t(len(text))), font.h))

proc create*(T: type gen_qtextlayout_types.QTextLayout, b: QTextBlock): gen_qtextlayout_types.QTextLayout =
  gen_qtextlayout_types.QTextLayout.init(fcQTextLayout_new4(b.h))

proc create*(T: type gen_qtextlayout_types.QTextLayout, text: string, font: QFont, paintdevice: QPaintDevice): gen_qtextlayout_types.QTextLayout =
...
proc setFont*(self: gen_qtextlayout_types.QTextLayout, f: QFont): void =
  fcQTextLayout_setFont(self.h, f.h)

proc font*(self: gen_qtextlayout_types.QTextLayout, ): QFont =
  QFont(h: fcQTextLayout_font(self.h))

proc setRawFont*(self: gen_qtextlayout_types.QTextLayout, rawFont: QRawFont): void =
...
proc setTextOption*(self: gen_qtextlayout_types.QTextLayout, option: QTextOption): void =
  fcQTextLayout_setTextOption(self.h, option.h)

proc textOption*(self: gen_qtextlayout_types.QTextLayout, ): QTextOption =
  QTextOption(h: fcQTextLayout_textOption(self.h))
...
proc setFormats*(self: gen_qtextlayout_types.QTextLayout, overrides: seq[QTextLayoutFormatRange]): void =
...
proc formats*(self: gen_qtextlayout_types.QTextLayout, ): seq[QTextLayoutFormatRange] =
...
proc createLine*(self: gen_qtextlayout_types.QTextLayout, ): QTextLine =
...
proc lineAt*(self: gen_qtextlayout_types.QTextLayout, i: cint): QTextLine =
  QTextLine(h: fcQTextLayout_lineAt(self.h, i))

proc lineForTextPosition*(self: gen_qtextlayout_types.QTextLayout, pos: cint): QTextLine =
...
proc draw*(self: gen_qtextlayout_types.QTextLayout, p: QPainter, pos: QPointF): void =
  fcQTextLayout_draw(self.h, p.h, pos.h)

proc drawCursor*(self: gen_qtextlayout_types.QTextLayout, p: QPainter, pos: QPointF, cursorPosition: cint): void =
  fcQTextLayout_drawCursor(self.h, p.h, pos.h, cursorPosition)

proc drawCursor*(self: gen_qtextlayout_types.QTextLayout, p: QPainter, pos: QPointF, cursorPosition: cint, width: cint): void =
  fcQTextLayout_drawCursor2(self.h, p.h, pos.h, cursorPosition, width)

proc position*(self: gen_qtextlayout_types.QTextLayout, ): QPointF =
  QPointF(h: fcQTextLayout_position(self.h))

proc setPosition*(self: gen_qtextlayout_types.QTextLayout, p: QPointF): void =
  fcQTextLayout_setPosition(self.h, p.h)

proc boundingRect*(self: gen_qtextlayout_types.QTextLayout, ): QRectF =
  QRectF(h: fcQTextLayout_boundingRect(self.h))
...
proc glyphRuns*(self: gen_qtextlayout_types.QTextLayout, ): seq[QGlyphRun] =
...
proc draw*(self: gen_qtextlayout_types.QTextLayout, p: QPainter, pos: QPointF, selections: seq[QTextLayoutFormatRange]): void =
...
proc draw*(self: gen_qtextlayout_types.QTextLayout, p: QPainter, pos: QPointF, selections: seq[QTextLayoutFormatRange], clip: QRectF): void =
  var selections_CArray = newSeq[pointer](len(selections))
  for i in 0..<len(selections):
    selections_CArray[i] = selections[i].h
...
proc glyphRuns*(self: gen_qtextlayout_types.QTextLayout, fromVal: cint): seq[QGlyphRun] =
...
proc glyphRuns*(self: gen_qtextlayout_types.QTextLayout, fromVal: cint, length: cint): seq[QGlyphRun] =
...
proc rect*(self: gen_qtextlayout_types.QTextLine, ): QRectF =
  QRectF(h: fcQTextLine_rect(self.h))
...
proc naturalTextRect*(self: gen_qtextlayout_types.QTextLine, ): QRectF =
  QRectF(h: fcQTextLine_naturalTextRect(self.h))
...
proc setPosition*(self: gen_qtextlayout_types.QTextLine, pos: QPointF): void =
  fcQTextLine_setPosition(self.h, pos.h)

proc position*(self: gen_qtextlayout_types.QTextLine, ): QPointF =
  QPointF(h: fcQTextLine_position(self.h))
...
proc draw*(self: gen_qtextlayout_types.QTextLine, painter: QPainter, position: QPointF): void =
  fcQTextLine_draw(self.h, painter.h, position.h)

proc glyphRuns*(self: gen_qtextlayout_types.QTextLine, ): seq[QGlyphRun] =
...
proc glyphRuns*(self: gen_qtextlayout_types.QTextLine, fromVal: cint): seq[QGlyphRun] =
...
proc glyphRuns*(self: gen_qtextlayout_types.QTextLine, fromVal: cint, length: cint): seq[QGlyphRun] =
...
func init*(T: type gen_qtextlayout_types.QTextLayoutFormatRange, h: ptr cQTextLayoutFormatRange): gen_qtextlayout_types.QTextLayoutFormatRange =
  T(h: h)
proc create*(T: type gen_qtextlayout_types.QTextLayoutFormatRange, param1: QTextLayoutFormatRange): gen_qtextlayout_types.QTextLayoutFormatRange =
  gen_qtextlayout_types.QTextLayoutFormatRange.init(fcQTextLayoutFormatRange_new(param1.h))

proc operatorAssign*(self: gen_qtextlayout_types.QTextLayoutFormatRange, param1: QTextLayoutFormatRange): void =
