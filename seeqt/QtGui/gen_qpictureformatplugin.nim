...
proc create*(T: type gen_qpictureformatplugin_types.QPictureFormatPlugin, parent: QObject): gen_qpictureformatplugin_types.QPictureFormatPlugin =
  gen_qpictureformatplugin_types.QPictureFormatPlugin.init(fcQPictureFormatPlugin_new2(parent.h))

proc metaObject*(self: gen_qpictureformatplugin_types.QPictureFormatPlugin, ): QMetaObject =
  QMetaObject(h: fcQPictureFormatPlugin_metaObject(self.h))
...
proc loadPicture*(self: gen_qpictureformatplugin_types.QPictureFormatPlugin, format: string, filename: string, pic: QPicture): bool =
...
proc savePicture*(self: gen_qpictureformatplugin_types.QPictureFormatPlugin, format: string, filename: string, pic: QPicture): bool =
...
proc miqt_exec_callback_QPictureFormatPlugin_metacall(self: ptr cQPictureFormatPlugin, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QPictureFormatPlugin_metacall ".} =
  ...
  virtualReturn
proc QPictureFormatPluginloadPicture*(self: gen_qpictureformatplugin_types.QPictureFormatPlugin, format: string, filename: string, pic: QPicture): bool =
...
type QPictureFormatPluginloadPictureProc* = proc(format: string, filename: string, pic: QPicture): bool
...
proc miqt_exec_callback_QPictureFormatPlugin_loadPicture(self: ptr cQPictureFormatPlugin, slot: int, format: struct_miqt_string, filename: struct_miqt_string, pic: pointer): bool {.exportc: "miqt_exec_callback_QPictureFormatPlugin_loadPicture ".} =
  ...
  let slotval3 = QPicture(h: pic)


  let virtualReturn = nimfunc[](slotval1, slotval2, slotval3 )

  virtualReturn
proc QPictureFormatPluginsavePicture*(self: gen_qpictureformatplugin_types.QPictureFormatPlugin, format: string, filename: string, pic: QPicture): bool =
...
type QPictureFormatPluginsavePictureProc* = proc(format: string, filename: string, pic: QPicture): bool
...
proc miqt_exec_callback_QPictureFormatPlugin_installIOHandler(self: ptr cQPictureFormatPlugin, slot: int, format: struct_miqt_string): bool {.exportc: "miqt_exec_callback_QPictureFormatPlugin_installIOHandler ".} =
  ...
  virtualReturn
proc QPictureFormatPluginevent*(self: gen_qpictureformatplugin_types.QPictureFormatPlugin, event: QEvent): bool =
  fQPictureFormatPlugin_virtualbase_event(self.h, event.h)

type QPictureFormatPlugineventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QPictureFormatPlugin_event(self: ptr cQPictureFormatPlugin, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QPictureFormatPlugin_event ".} =
  ...
  virtualReturn
proc QPictureFormatPlugineventFilter*(self: gen_qpictureformatplugin_types.QPictureFormatPlugin, watched: QObject, event: QEvent): bool =
  fQPictureFormatPlugin_virtualbase_eventFilter(self.h, watched.h, event.h)

type QPictureFormatPlugineventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QPictureFormatPlugin_eventFilter(self: ptr cQPictureFormatPlugin, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QPictureFormatPlugin_eventFilter ".} =
  ...
  virtualReturn
proc QPictureFormatPlugintimerEvent*(self: gen_qpictureformatplugin_types.QPictureFormatPlugin, event: QTimerEvent): void =
  fQPictureFormatPlugin_virtualbase_timerEvent(self.h, event.h)

type QPictureFormatPlugintimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QPictureFormatPlugin_timerEvent(self: ptr cQPictureFormatPlugin, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QPictureFormatPlugin_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QPictureFormatPluginchildEvent*(self: gen_qpictureformatplugin_types.QPictureFormatPlugin, event: QChildEvent): void =
  fQPictureFormatPlugin_virtualbase_childEvent(self.h, event.h)

type QPictureFormatPluginchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QPictureFormatPlugin_childEvent(self: ptr cQPictureFormatPlugin, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QPictureFormatPlugin_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QPictureFormatPlugincustomEvent*(self: gen_qpictureformatplugin_types.QPictureFormatPlugin, event: QEvent): void =
  fQPictureFormatPlugin_virtualbase_customEvent(self.h, event.h)

type QPictureFormatPlugincustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QPictureFormatPlugin_customEvent(self: ptr cQPictureFormatPlugin, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QPictureFormatPlugin_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QPictureFormatPluginconnectNotify*(self: gen_qpictureformatplugin_types.QPictureFormatPlugin, signal: QMetaMethod): void =
  fQPictureFormatPlugin_virtualbase_connectNotify(self.h, signal.h)

type QPictureFormatPluginconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QPictureFormatPlugin_connectNotify(self: ptr cQPictureFormatPlugin, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QPictureFormatPlugin_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QPictureFormatPlugindisconnectNotify*(self: gen_qpictureformatplugin_types.QPictureFormatPlugin, signal: QMetaMethod): void =
  fQPictureFormatPlugin_virtualbase_disconnectNotify(self.h, signal.h)

type QPictureFormatPlugindisconnectNotifyProc* = proc(signal: QMetaMethod): void
