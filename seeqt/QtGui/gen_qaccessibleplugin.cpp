...
QMetaObject* QAccessiblePlugin_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQAccessiblePlugin*)(self) )->QAccessiblePlugin::metaObject();

}

void* QAccessiblePlugin_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQAccessiblePlugin*)(self) )->QAccessiblePlugin::qt_metacast(param1);

}

int QAccessiblePlugin_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQAccessiblePlugin*)(self) )->QAccessiblePlugin::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
QObject* QAccessiblePlugin_protectedbase_sender(const void* self) {
	MiqtVirtualQAccessiblePlugin* self_cast = static_cast<MiqtVirtualQAccessiblePlugin*>( (QAccessiblePlugin*)(self) );
