...
proc create*(T: type gen_qcolorspace_types.QColorSpace, primaries: cint, transferFunctionTable: seq[uint16]): gen_qcolorspace_types.QColorSpace =
  ...
  gen_qcolorspace_types.QColorSpace.init(fcQColorSpace_new5(cint(primaries), struct_miqt_array(len: csize_t(len(transferFunctionTable)), data: if len(transferFunctionTable) == 0: nil else: addr(transferFunctionTable_CArray[0]))))

proc create*(T: type gen_qcolorspace_types.QColorSpace, whitePoint: QPointF, redPoint: QPointF, greenPoint: QPointF, bluePoint: QPointF, transferFunction: cint): gen_qcolorspace_types.QColorSpace =
  gen_qcolorspace_types.QColorSpace.init(fcQColorSpace_new6(whitePoint.h, redPoint.h, greenPoint.h, bluePoint.h, cint(transferFunction)))

proc create*(T: type gen_qcolorspace_types.QColorSpace, whitePoint: QPointF, redPoint: QPointF, greenPoint: QPointF, bluePoint: QPointF, transferFunctionTable: seq[uint16]): gen_qcolorspace_types.QColorSpace =
  var transferFunctionTable_CArray = newSeq[uint16](len(transferFunctionTable))
  for i in 0..<len(transferFunctionTable):
    transferFunctionTable_CArray[i] = transferFunctionTable[i]

  gen_qcolorspace_types.QColorSpace.init(fcQColorSpace_new7(whitePoint.h, redPoint.h, greenPoint.h, bluePoint.h, struct_miqt_array(len: csize_t(len(transferFunctionTable)), data: if len(transferFunctionTable) == 0: nil else: addr(transferFunctionTable_CArray[0]))))

proc create*(T: type gen_qcolorspace_types.QColorSpace, whitePoint: QPointF, redPoint: QPointF, greenPoint: QPointF, bluePoint: QPointF, redTransferFunctionTable: seq[uint16], greenTransferFunctionTable: seq[uint16], blueTransferFunctionTable: seq[uint16]): gen_qcolorspace_types.QColorSpace =
...
proc create*(T: type gen_qcolorspace_types.QColorSpace, primaries: cint, transferFunction: cint, gamma: float32): gen_qcolorspace_types.QColorSpace =
  gen_qcolorspace_types.QColorSpace.init(fcQColorSpace_new10(cint(primaries), cint(transferFunction), gamma))

proc create*(T: type gen_qcolorspace_types.QColorSpace, whitePoint: QPointF, redPoint: QPointF, greenPoint: QPointF, bluePoint: QPointF, transferFunction: cint, gamma: float32): gen_qcolorspace_types.QColorSpace =
  gen_qcolorspace_types.QColorSpace.init(fcQColorSpace_new11(whitePoint.h, redPoint.h, greenPoint.h, bluePoint.h, cint(transferFunction), gamma))

proc operatorAssign*(self: gen_qcolorspace_types.QColorSpace, colorSpace: QColorSpace): void =
  fcQColorSpace_operatorAssign(self.h, colorSpace.h)

proc swap*(self: gen_qcolorspace_types.QColorSpace, colorSpace: QColorSpace): void =
...
proc withTransferFunction*(self: gen_qcolorspace_types.QColorSpace, transferFunction: cint): QColorSpace =
  QColorSpace(h: fcQColorSpace_withTransferFunction(self.h, cint(transferFunction)))

proc withTransferFunction*(self: gen_qcolorspace_types.QColorSpace, transferFunctionTable: seq[uint16]): QColorSpace =
  var transferFunctionTable_CArray = newSeq[uint16](len(transferFunctionTable))
  for i in 0..<len(transferFunctionTable):
    transferFunctionTable_CArray[i] = transferFunctionTable[i]

  QColorSpace(h: fcQColorSpace_withTransferFunctionWithTransferFunctionTable(self.h, struct_miqt_array(len: csize_t(len(transferFunctionTable)), data: if len(transferFunctionTable) == 0: nil else: addr(transferFunctionTable_CArray[0]))))

proc withTransferFunctions*(self: gen_qcolorspace_types.QColorSpace, redTransferFunctionTable: seq[uint16], greenTransferFunctionTable: seq[uint16], blueTransferFunctionTable: seq[uint16]): QColorSpace =
  var redTransferFunctionTable_CArray = newSeq[uint16](len(redTransferFunctionTable))
  for i in 0..<len(redTransferFunctionTable):
    redTransferFunctionTable_CArray[i] = redTransferFunctionTable[i]
  ...
  QColorSpace(h: fcQColorSpace_withTransferFunctions(self.h, struct_miqt_array(len: csize_t(len(redTransferFunctionTable)), data: if len(redTransferFunctionTable) == 0: nil else: addr(redTransferFunctionTable_CArray[0])), struct_miqt_array(len: csize_t(len(greenTransferFunctionTable)), data: if len(greenTransferFunctionTable) == 0: nil else: addr(greenTransferFunctionTable_CArray[0])), struct_miqt_array(len: csize_t(len(blueTransferFunctionTable)), data: if len(blueTransferFunctionTable) == 0: nil else: addr(blueTransferFunctionTable_CArray[0]))))
...
proc setPrimaries*(self: gen_qcolorspace_types.QColorSpace, whitePoint: QPointF, redPoint: QPointF, greenPoint: QPointF, bluePoint: QPointF): void =
...
proc fromIccProfile*(_: type gen_qcolorspace_types.QColorSpace, iccProfile: seq[byte]): QColorSpace =
...
proc transformationToColorSpace*(self: gen_qcolorspace_types.QColorSpace, colorspace: QColorSpace): QColorTransform =
  QColorTransform(h: fcQColorSpace_transformationToColorSpace(self.h, colorspace.h))

proc ToQVariant*(self: gen_qcolorspace_types.QColorSpace, ): QVariant =
  QVariant(h: fcQColorSpace_ToQVariant(self.h))
...
proc withTransferFunction*(self: gen_qcolorspace_types.QColorSpace, transferFunction: cint, gamma: float32): QColorSpace =
