...
public:
	...
	MiqtVirtualQTextDocument(struct QTextDocument_VTable* vtbl): QTextDocument(), vtbl(vtbl) {};
	MiqtVirtualQTextDocument(struct QTextDocument_VTable* vtbl, const QString& text): QTextDocument(text), vtbl(vtbl) {};
	MiqtVirtualQTextDocument(struct QTextDocument_VTable* vtbl, QObject* parent): QTextDocument(parent), vtbl(vtbl) {};
	MiqtVirtualQTextDocument(struct QTextDocument_VTable* vtbl, const QString& text, QObject* parent): QTextDocument(text, parent), vtbl(vtbl) {};

	virtual ~MiqtVirtualQTextDocument() override { if(vtbl->destructor) vtbl->destructor(vtbl, this); }
...
void QTextDocument_connect_contentsChange(QTextDocument* self, intptr_t slot, void (*callback)(intptr_t, int, int, int), void (*release)(intptr_t)) {
	...
	MiqtVirtualQTextDocument::connect(self, static_cast<void (QTextDocument::*)(int, int, int)>(&QTextDocument::contentsChange), self, caller{slot, callback, release});
}
...
void QTextDocument_connect_contentsChanged(QTextDocument* self, intptr_t slot, void (*callback)(intptr_t), void (*release)(intptr_t)) {
	...
	MiqtVirtualQTextDocument::connect(self, static_cast<void (QTextDocument::*)()>(&QTextDocument::contentsChanged), self, caller{slot, callback, release});
}
...
void QTextDocument_connect_undoAvailable(QTextDocument* self, intptr_t slot, void (*callback)(intptr_t, bool), void (*release)(intptr_t)) {
	...
	MiqtVirtualQTextDocument::connect(self, static_cast<void (QTextDocument::*)(bool)>(&QTextDocument::undoAvailable), self, caller{slot, callback, release});
}
...
void QTextDocument_connect_redoAvailable(QTextDocument* self, intptr_t slot, void (*callback)(intptr_t, bool), void (*release)(intptr_t)) {
	...
	MiqtVirtualQTextDocument::connect(self, static_cast<void (QTextDocument::*)(bool)>(&QTextDocument::redoAvailable), self, caller{slot, callback, release});
}
...
void QTextDocument_connect_undoCommandAdded(QTextDocument* self, intptr_t slot, void (*callback)(intptr_t), void (*release)(intptr_t)) {
	...
	MiqtVirtualQTextDocument::connect(self, static_cast<void (QTextDocument::*)()>(&QTextDocument::undoCommandAdded), self, caller{slot, callback, release});
}
...
void QTextDocument_connect_modificationChanged(QTextDocument* self, intptr_t slot, void (*callback)(intptr_t, bool), void (*release)(intptr_t)) {
	...
	MiqtVirtualQTextDocument::connect(self, static_cast<void (QTextDocument::*)(bool)>(&QTextDocument::modificationChanged), self, caller{slot, callback, release});
}
...
void QTextDocument_connect_cursorPositionChanged(QTextDocument* self, intptr_t slot, void (*callback)(intptr_t, QTextCursor*), void (*release)(intptr_t)) {
	...
	MiqtVirtualQTextDocument::connect(self, static_cast<void (QTextDocument::*)(const QTextCursor&)>(&QTextDocument::cursorPositionChanged), self, caller{slot, callback, release});
}
...
void QTextDocument_connect_blockCountChanged(QTextDocument* self, intptr_t slot, void (*callback)(intptr_t, int), void (*release)(intptr_t)) {
	...
	MiqtVirtualQTextDocument::connect(self, static_cast<void (QTextDocument::*)(int)>(&QTextDocument::blockCountChanged), self, caller{slot, callback, release});
}
...
void QTextDocument_connect_baseUrlChanged(QTextDocument* self, intptr_t slot, void (*callback)(intptr_t, QUrl*), void (*release)(intptr_t)) {
	...
	MiqtVirtualQTextDocument::connect(self, static_cast<void (QTextDocument::*)(const QUrl&)>(&QTextDocument::baseUrlChanged), self, caller{slot, callback, release});
}
...
void QTextDocument_connect_documentLayoutChanged(QTextDocument* self, intptr_t slot, void (*callback)(intptr_t), void (*release)(intptr_t)) {
	...
	MiqtVirtualQTextDocument::connect(self, static_cast<void (QTextDocument::*)()>(&QTextDocument::documentLayoutChanged), self, caller{slot, callback, release});
}
...
QMetaObject* QTextDocument_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQTextDocument*)(self) )->QTextDocument::metaObject();

}

void* QTextDocument_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQTextDocument*)(self) )->QTextDocument::qt_metacast(param1);

}

int QTextDocument_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQTextDocument*)(self) )->QTextDocument::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
