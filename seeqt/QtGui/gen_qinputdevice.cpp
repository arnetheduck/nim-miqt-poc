...
public:
	...
	MiqtVirtualQInputDevice(struct QInputDevice_VTable* vtbl): QInputDevice(), vtbl(vtbl) {};
	MiqtVirtualQInputDevice(struct QInputDevice_VTable* vtbl, const QString& name, qint64 systemId, QInputDevice::DeviceType type): QInputDevice(name, systemId, type), vtbl(vtbl) {};
	MiqtVirtualQInputDevice(struct QInputDevice_VTable* vtbl, QObject* parent): QInputDevice(parent), vtbl(vtbl) {};
	MiqtVirtualQInputDevice(struct QInputDevice_VTable* vtbl, const QString& name, qint64 systemId, QInputDevice::DeviceType type, const QString& seatName): QInputDevice(name, systemId, type, seatName), vtbl(vtbl) {};
	MiqtVirtualQInputDevice(struct QInputDevice_VTable* vtbl, const QString& name, qint64 systemId, QInputDevice::DeviceType type, const QString& seatName, QObject* parent): QInputDevice(name, systemId, type, seatName, parent), vtbl(vtbl) {};

	virtual ~MiqtVirtualQInputDevice() override { if(vtbl->destructor) vtbl->destructor(vtbl, this); }
...
QInputDevice* QInputDevice_new(struct QInputDevice_VTable* vtbl) {
	return new MiqtVirtualQInputDevice(vtbl);
}
...
QInputDevice* QInputDevice_new2(struct QInputDevice_VTable* vtbl, struct miqt_string name, long long systemId, int type) {
	...
	return new MiqtVirtualQInputDevice(vtbl, name_QString, static_cast<qint64>(systemId), static_cast<QInputDevice::DeviceType>(type));
}

QInputDevice* QInputDevice_new3(struct QInputDevice_VTable* vtbl, QObject* parent) {
	return new MiqtVirtualQInputDevice(vtbl, parent);
}
...
QInputDevice* QInputDevice_new4(struct QInputDevice_VTable* vtbl, struct miqt_string name, long long systemId, int type, struct miqt_string seatName) {
	...
	return new MiqtVirtualQInputDevice(vtbl, name_QString, static_cast<qint64>(systemId), static_cast<QInputDevice::DeviceType>(type), seatName_QString);
}
...
QInputDevice* QInputDevice_new5(struct QInputDevice_VTable* vtbl, struct miqt_string name, long long systemId, int type, struct miqt_string seatName, QObject* parent) {
	QString name_QString = QString::fromUtf8(name.data, name.len);
	QString seatName_QString = QString::fromUtf8(seatName.data, seatName.len);
	return new MiqtVirtualQInputDevice(vtbl, name_QString, static_cast<qint64>(systemId), static_cast<QInputDevice::DeviceType>(type), seatName_QString, parent);
}
...
void QInputDevice_connect_availableVirtualGeometryChanged(QInputDevice* self, intptr_t slot, void (*callback)(intptr_t, QRect*), void (*release)(intptr_t)) {
	...
	MiqtVirtualQInputDevice::connect(self, static_cast<void (QInputDevice::*)(QRect)>(&QInputDevice::availableVirtualGeometryChanged), self, caller{slot, callback, release});
}
...
QMetaObject* QInputDevice_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQInputDevice*)(self) )->QInputDevice::metaObject();

}

void* QInputDevice_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQInputDevice*)(self) )->QInputDevice::qt_metacast(param1);

}

int QInputDevice_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQInputDevice*)(self) )->QInputDevice::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
QObject* QInputDevice_protectedbase_sender(const void* self) {
	MiqtVirtualQInputDevice* self_cast = static_cast<MiqtVirtualQInputDevice*>( (QInputDevice*)(self) );
