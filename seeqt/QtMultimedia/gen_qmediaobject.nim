...
func init*(T: type gen_qmediaobject_types.QMediaObject, h: ptr cQMediaObject): gen_qmediaobject_types.QMediaObject =
  T(h: h)
proc metaObject*(self: gen_qmediaobject_types.QMediaObject, ): QMetaObject =
  QMetaObject(h: fcQMediaObject_metaObject(self.h))
...
proc service*(self: gen_qmediaobject_types.QMediaObject, ): QMediaService =
  QMediaService(h: fcQMediaObject_service(self.h))
...
proc bindX*(self: gen_qmediaobject_types.QMediaObject, param1: QObject): bool =
  fcQMediaObject_bindX(self.h, param1.h)

proc unbind*(self: gen_qmediaobject_types.QMediaObject, param1: QObject): void =
...
proc metaData*(self: gen_qmediaobject_types.QMediaObject, key: string): QVariant =
  QVariant(h: fcQMediaObject_metaData(self.h, struct_miqt_string(data: key, len: csize_t(len(key)))))
...
proc metaDataChanged*(self: gen_qmediaobject_types.QMediaObject, key: string, value: QVariant): void =
  fcQMediaObject_metaDataChanged2(self.h, struct_miqt_string(data: key, len: csize_t(len(key))), value.h)

type QMediaObjectmetaDataChanged2Slot* = proc(key: string, value: QVariant)
