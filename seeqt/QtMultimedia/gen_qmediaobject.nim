...
proc miqt_exec_callback_cQMediaObject_notifyIntervalChanged(slot: int, milliSeconds: cint) {.cdecl.} =
  let nimfunc = cast[ptr QMediaObjectnotifyIntervalChangedSlot](cast[pointer](slot))
  let slotval1 = milliSeconds

  nimfunc[](slotval1)

proc miqt_exec_callback_cQMediaObject_notifyIntervalChanged_release(slot: int) {.cdecl.} =
...
proc onnotifyIntervalChanged*(self: gen_qmediaobject_types.QMediaObject, slot: QMediaObjectnotifyIntervalChangedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQMediaObject_connect_notifyIntervalChanged(self.h, cast[int](addr tmp[]), miqt_exec_callback_cQMediaObject_notifyIntervalChanged, miqt_exec_callback_cQMediaObject_notifyIntervalChanged_release)
...
proc miqt_exec_callback_cQMediaObject_metaDataAvailableChanged(slot: int, available: bool) {.cdecl.} =
  let nimfunc = cast[ptr QMediaObjectmetaDataAvailableChangedSlot](cast[pointer](slot))
  let slotval1 = available

  nimfunc[](slotval1)

proc miqt_exec_callback_cQMediaObject_metaDataAvailableChanged_release(slot: int) {.cdecl.} =
...
proc onmetaDataAvailableChanged*(self: gen_qmediaobject_types.QMediaObject, slot: QMediaObjectmetaDataAvailableChangedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQMediaObject_connect_metaDataAvailableChanged(self.h, cast[int](addr tmp[]), miqt_exec_callback_cQMediaObject_metaDataAvailableChanged, miqt_exec_callback_cQMediaObject_metaDataAvailableChanged_release)
...
proc miqt_exec_callback_cQMediaObject_metaDataChanged(slot: int) {.cdecl.} =
  let nimfunc = cast[ptr QMediaObjectmetaDataChangedSlot](cast[pointer](slot))
  nimfunc[]()

proc miqt_exec_callback_cQMediaObject_metaDataChanged_release(slot: int) {.cdecl.} =
...
proc onmetaDataChanged*(self: gen_qmediaobject_types.QMediaObject, slot: QMediaObjectmetaDataChangedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQMediaObject_connect_metaDataChanged(self.h, cast[int](addr tmp[]), miqt_exec_callback_cQMediaObject_metaDataChanged, miqt_exec_callback_cQMediaObject_metaDataChanged_release)
...
proc miqt_exec_callback_cQMediaObject_metaDataChanged2(slot: int, key: struct_miqt_string, value: pointer) {.cdecl.} =
...
proc miqt_exec_callback_cQMediaObject_metaDataChanged2_release(slot: int) {.cdecl.} =
...
proc onmetaDataChanged*(self: gen_qmediaobject_types.QMediaObject, slot: QMediaObjectmetaDataChanged2Slot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQMediaObject_connect_metaDataChanged2(self.h, cast[int](addr tmp[]), miqt_exec_callback_cQMediaObject_metaDataChanged2, miqt_exec_callback_cQMediaObject_metaDataChanged2_release)
...
proc miqt_exec_callback_cQMediaObject_availabilityChanged(slot: int, available: bool) {.cdecl.} =
  let nimfunc = cast[ptr QMediaObjectavailabilityChangedSlot](cast[pointer](slot))
  let slotval1 = available

  nimfunc[](slotval1)

proc miqt_exec_callback_cQMediaObject_availabilityChanged_release(slot: int) {.cdecl.} =
...
proc onavailabilityChanged*(self: gen_qmediaobject_types.QMediaObject, slot: QMediaObjectavailabilityChangedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQMediaObject_connect_availabilityChanged(self.h, cast[int](addr tmp[]), miqt_exec_callback_cQMediaObject_availabilityChanged, miqt_exec_callback_cQMediaObject_availabilityChanged_release)
...
proc miqt_exec_callback_cQMediaObject_availabilityChangedWithAvailability(slot: int, availability: cint) {.cdecl.} =
  let nimfunc = cast[ptr QMediaObjectavailabilityChangedWithAvailabilitySlot](cast[pointer](slot))
  let slotval1 = cint(availability)

  nimfunc[](slotval1)

proc miqt_exec_callback_cQMediaObject_availabilityChangedWithAvailability_release(slot: int) {.cdecl.} =
...
proc onavailabilityChanged*(self: gen_qmediaobject_types.QMediaObject, slot: QMediaObjectavailabilityChangedWithAvailabilitySlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQMediaObject_connect_availabilityChangedWithAvailability(self.h, cast[int](addr tmp[]), miqt_exec_callback_cQMediaObject_availabilityChangedWithAvailability, miqt_exec_callback_cQMediaObject_availabilityChangedWithAvailability_release)
