...
func init*(T: type gen_qmediaaudioprobecontrol_types.QMediaAudioProbeControl, h: ptr cQMediaAudioProbeControl): gen_qmediaaudioprobecontrol_types.QMediaAudioProbeControl =
  T(h: h)
proc metaObject*(self: gen_qmediaaudioprobecontrol_types.QMediaAudioProbeControl, ): QMetaObject =
  QMetaObject(h: fcQMediaAudioProbeControl_metaObject(self.h))
...
proc audioBufferProbed*(self: gen_qmediaaudioprobecontrol_types.QMediaAudioProbeControl, buffer: QAudioBuffer): void =
  fcQMediaAudioProbeControl_audioBufferProbed(self.h, buffer.h)

type QMediaAudioProbeControlaudioBufferProbedSlot* = proc(buffer: QAudioBuffer)
