...
public:
	...
	MiqtVirtualQRadioData(struct QRadioData_VTable* vtbl, QMediaObject* mediaObject): QRadioData(mediaObject), vtbl(vtbl) {};
	MiqtVirtualQRadioData(struct QRadioData_VTable* vtbl, QMediaObject* mediaObject, QObject* parent): QRadioData(mediaObject, parent), vtbl(vtbl) {};

	virtual ~MiqtVirtualQRadioData() override { if(vtbl->destructor) vtbl->destructor(vtbl, this); }
...
QRadioData* QRadioData_new(struct QRadioData_VTable* vtbl, QMediaObject* mediaObject) {
	return new MiqtVirtualQRadioData(vtbl, mediaObject);
}

QRadioData* QRadioData_new2(struct QRadioData_VTable* vtbl, QMediaObject* mediaObject, QObject* parent) {
	return new MiqtVirtualQRadioData(vtbl, mediaObject, parent);
}
...
void QRadioData_connect_stationIdChanged(QRadioData* self, intptr_t slot, void (*callback)(intptr_t, struct miqt_string), void (*release)(intptr_t)) {
	...
	MiqtVirtualQRadioData::connect(self, static_cast<void (QRadioData::*)(QString)>(&QRadioData::stationIdChanged), self, caller{slot, callback, release});
}
...
void QRadioData_connect_programTypeChanged(QRadioData* self, intptr_t slot, void (*callback)(intptr_t, int), void (*release)(intptr_t)) {
	...
	MiqtVirtualQRadioData::connect(self, static_cast<void (QRadioData::*)(QRadioData::ProgramType)>(&QRadioData::programTypeChanged), self, caller{slot, callback, release});
}
...
void QRadioData_connect_programTypeNameChanged(QRadioData* self, intptr_t slot, void (*callback)(intptr_t, struct miqt_string), void (*release)(intptr_t)) {
	...
	MiqtVirtualQRadioData::connect(self, static_cast<void (QRadioData::*)(QString)>(&QRadioData::programTypeNameChanged), self, caller{slot, callback, release});
}
...
void QRadioData_connect_stationNameChanged(QRadioData* self, intptr_t slot, void (*callback)(intptr_t, struct miqt_string), void (*release)(intptr_t)) {
	...
	MiqtVirtualQRadioData::connect(self, static_cast<void (QRadioData::*)(QString)>(&QRadioData::stationNameChanged), self, caller{slot, callback, release});
}
...
void QRadioData_connect_radioTextChanged(QRadioData* self, intptr_t slot, void (*callback)(intptr_t, struct miqt_string), void (*release)(intptr_t)) {
	...
	MiqtVirtualQRadioData::connect(self, static_cast<void (QRadioData::*)(QString)>(&QRadioData::radioTextChanged), self, caller{slot, callback, release});
}
...
void QRadioData_connect_alternativeFrequenciesEnabledChanged(QRadioData* self, intptr_t slot, void (*callback)(intptr_t, bool), void (*release)(intptr_t)) {
	...
	MiqtVirtualQRadioData::connect(self, static_cast<void (QRadioData::*)(bool)>(&QRadioData::alternativeFrequenciesEnabledChanged), self, caller{slot, callback, release});
}
...
void QRadioData_connect_errorWithError(QRadioData* self, intptr_t slot, void (*callback)(intptr_t, int), void (*release)(intptr_t)) {
	...
	MiqtVirtualQRadioData::connect(self, static_cast<void (QRadioData::*)(QRadioData::Error)>(&QRadioData::error), self, caller{slot, callback, release});
}
...
QMetaObject* QRadioData_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQRadioData*)(self) )->QRadioData::metaObject();

}

void* QRadioData_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQRadioData*)(self) )->QRadioData::qt_metacast(param1);

}

int QRadioData_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQRadioData*)(self) )->QRadioData::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
QObject* QRadioData_protectedbase_sender(const void* self) {
	MiqtVirtualQRadioData* self_cast = static_cast<MiqtVirtualQRadioData*>( (QRadioData*)(self) );
