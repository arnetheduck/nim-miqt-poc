...
QMetaObject* QWaveDecoder_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQWaveDecoder*)(self) )->QWaveDecoder::metaObject();

}

void* QWaveDecoder_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQWaveDecoder*)(self) )->QWaveDecoder::qt_metacast(param1);

}

int QWaveDecoder_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQWaveDecoder*)(self) )->QWaveDecoder::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
void QWaveDecoder_protectedbase_setOpenMode(void* self, int openMode) {
	MiqtVirtualQWaveDecoder* self_cast = static_cast<MiqtVirtualQWaveDecoder*>( (QWaveDecoder*)(self) );
