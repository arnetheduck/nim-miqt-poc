...
func init*(T: type gen_qmediametadata_types.QMediaMetaData, h: ptr cQMediaMetaData): gen_qmediametadata_types.QMediaMetaData =
  T(h: h)
proc create*(T: type gen_qmediametadata_types.QMediaMetaData, param1: QMediaMetaData): gen_qmediametadata_types.QMediaMetaData =
...
proc value*(self: gen_qmediametadata_types.QMediaMetaData, k: cint): QVariant =
  QVariant(h: fcQMediaMetaData_value(self.h, cint(k)))

proc insert*(self: gen_qmediametadata_types.QMediaMetaData, k: cint, value: QVariant): void =
...
proc operatorSubscript*(self: gen_qmediametadata_types.QMediaMetaData, k: cint): QVariant =
  QVariant(h: fcQMediaMetaData_operatorSubscript(self.h, cint(k)))
