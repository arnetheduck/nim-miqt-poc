...
QMetaObject* QMediaDevices_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQMediaDevices*)(self) )->QMediaDevices::metaObject();

}

void* QMediaDevices_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQMediaDevices*)(self) )->QMediaDevices::qt_metacast(param1);

}

int QMediaDevices_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQMediaDevices*)(self) )->QMediaDevices::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
QObject* QMediaDevices_protectedbase_sender(const void* self) {
	MiqtVirtualQMediaDevices* self_cast = static_cast<MiqtVirtualQMediaDevices*>( (QMediaDevices*)(self) );
