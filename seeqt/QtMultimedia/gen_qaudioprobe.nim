...
proc create*(T: type gen_qaudioprobe_types.QAudioProbe, parent: QObject): gen_qaudioprobe_types.QAudioProbe =
  gen_qaudioprobe_types.QAudioProbe.init(fcQAudioProbe_new2(parent.h))

proc metaObject*(self: gen_qaudioprobe_types.QAudioProbe, ): QMetaObject =
  QMetaObject(h: fcQAudioProbe_metaObject(self.h))
...
proc setSource*(self: gen_qaudioprobe_types.QAudioProbe, source: QMediaObject): bool =
  fcQAudioProbe_setSource(self.h, source.h)

proc setSource*(self: gen_qaudioprobe_types.QAudioProbe, source: QMediaRecorder): bool =
...
proc audioBufferProbed*(self: gen_qaudioprobe_types.QAudioProbe, buffer: QAudioBuffer): void =
  fcQAudioProbe_audioBufferProbed(self.h, buffer.h)

type QAudioProbeaudioBufferProbedSlot* = proc(buffer: QAudioBuffer)
proc miqt_exec_callback_QAudioProbe_audioBufferProbed(slot: int, buffer: pointer) {.exportc.} =
  ...
  let slotval1 = QAudioBuffer(h: buffer)
...
proc miqt_exec_callback_QAudioProbe_metacall(self: ptr cQAudioProbe, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QAudioProbe_metacall ".} =
  ...
  virtualReturn
proc QAudioProbeevent*(self: gen_qaudioprobe_types.QAudioProbe, event: QEvent): bool =
  fQAudioProbe_virtualbase_event(self.h, event.h)

type QAudioProbeeventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QAudioProbe_event(self: ptr cQAudioProbe, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QAudioProbe_event ".} =
  ...
  virtualReturn
proc QAudioProbeeventFilter*(self: gen_qaudioprobe_types.QAudioProbe, watched: QObject, event: QEvent): bool =
  fQAudioProbe_virtualbase_eventFilter(self.h, watched.h, event.h)

type QAudioProbeeventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QAudioProbe_eventFilter(self: ptr cQAudioProbe, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QAudioProbe_eventFilter ".} =
  ...
  virtualReturn
proc QAudioProbetimerEvent*(self: gen_qaudioprobe_types.QAudioProbe, event: QTimerEvent): void =
  fQAudioProbe_virtualbase_timerEvent(self.h, event.h)

type QAudioProbetimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QAudioProbe_timerEvent(self: ptr cQAudioProbe, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QAudioProbe_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QAudioProbechildEvent*(self: gen_qaudioprobe_types.QAudioProbe, event: QChildEvent): void =
  fQAudioProbe_virtualbase_childEvent(self.h, event.h)

type QAudioProbechildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QAudioProbe_childEvent(self: ptr cQAudioProbe, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QAudioProbe_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QAudioProbecustomEvent*(self: gen_qaudioprobe_types.QAudioProbe, event: QEvent): void =
  fQAudioProbe_virtualbase_customEvent(self.h, event.h)

type QAudioProbecustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QAudioProbe_customEvent(self: ptr cQAudioProbe, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QAudioProbe_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QAudioProbeconnectNotify*(self: gen_qaudioprobe_types.QAudioProbe, signal: QMetaMethod): void =
  fQAudioProbe_virtualbase_connectNotify(self.h, signal.h)

type QAudioProbeconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QAudioProbe_connectNotify(self: ptr cQAudioProbe, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QAudioProbe_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QAudioProbedisconnectNotify*(self: gen_qaudioprobe_types.QAudioProbe, signal: QMetaMethod): void =
  fQAudioProbe_virtualbase_disconnectNotify(self.h, signal.h)

type QAudioProbedisconnectNotifyProc* = proc(signal: QMetaMethod): void
