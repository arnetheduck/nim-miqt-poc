...
void QCameraExposure_connect_flashReady(QCameraExposure* self, intptr_t slot, void (*callback)(intptr_t, bool), void (*release)(intptr_t)) {
	...
	QCameraExposure::connect(self, static_cast<void (QCameraExposure::*)(bool)>(&QCameraExposure::flashReady), self, caller{slot, callback, release});
}
...
void QCameraExposure_connect_apertureChanged(QCameraExposure* self, intptr_t slot, void (*callback)(intptr_t, double), void (*release)(intptr_t)) {
	...
	QCameraExposure::connect(self, static_cast<void (QCameraExposure::*)(qreal)>(&QCameraExposure::apertureChanged), self, caller{slot, callback, release});
}
...
void QCameraExposure_connect_apertureRangeChanged(QCameraExposure* self, intptr_t slot, void (*callback)(intptr_t), void (*release)(intptr_t)) {
	...
	QCameraExposure::connect(self, static_cast<void (QCameraExposure::*)()>(&QCameraExposure::apertureRangeChanged), self, caller{slot, callback, release});
}
...
void QCameraExposure_connect_shutterSpeedChanged(QCameraExposure* self, intptr_t slot, void (*callback)(intptr_t, double), void (*release)(intptr_t)) {
	...
	QCameraExposure::connect(self, static_cast<void (QCameraExposure::*)(qreal)>(&QCameraExposure::shutterSpeedChanged), self, caller{slot, callback, release});
}
...
void QCameraExposure_connect_shutterSpeedRangeChanged(QCameraExposure* self, intptr_t slot, void (*callback)(intptr_t), void (*release)(intptr_t)) {
	...
	QCameraExposure::connect(self, static_cast<void (QCameraExposure::*)()>(&QCameraExposure::shutterSpeedRangeChanged), self, caller{slot, callback, release});
}
...
void QCameraExposure_connect_isoSensitivityChanged(QCameraExposure* self, intptr_t slot, void (*callback)(intptr_t, int), void (*release)(intptr_t)) {
	...
	QCameraExposure::connect(self, static_cast<void (QCameraExposure::*)(int)>(&QCameraExposure::isoSensitivityChanged), self, caller{slot, callback, release});
}
...
void QCameraExposure_connect_exposureCompensationChanged(QCameraExposure* self, intptr_t slot, void (*callback)(intptr_t, double), void (*release)(intptr_t)) {
	...
	QCameraExposure::connect(self, static_cast<void (QCameraExposure::*)(qreal)>(&QCameraExposure::exposureCompensationChanged), self, caller{slot, callback, release});
}
