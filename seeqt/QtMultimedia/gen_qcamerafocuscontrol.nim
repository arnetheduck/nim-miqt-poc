...
func init*(T: type gen_qcamerafocuscontrol_types.QCameraFocusControl, h: ptr cQCameraFocusControl): gen_qcamerafocuscontrol_types.QCameraFocusControl =
  T(h: h)
proc metaObject*(self: gen_qcamerafocuscontrol_types.QCameraFocusControl, ): QMetaObject =
  QMetaObject(h: fcQCameraFocusControl_metaObject(self.h))
...
proc customFocusPoint*(self: gen_qcamerafocuscontrol_types.QCameraFocusControl, ): QPointF =
  QPointF(h: fcQCameraFocusControl_customFocusPoint(self.h))

proc setCustomFocusPoint*(self: gen_qcamerafocuscontrol_types.QCameraFocusControl, point: QPointF): void =
  fcQCameraFocusControl_setCustomFocusPoint(self.h, point.h)

proc focusZones*(self: gen_qcamerafocuscontrol_types.QCameraFocusControl, ): seq[QCameraFocusZone] =
...
proc customFocusPointChanged*(self: gen_qcamerafocuscontrol_types.QCameraFocusControl, point: QPointF): void =
  fcQCameraFocusControl_customFocusPointChanged(self.h, point.h)

type QCameraFocusControlcustomFocusPointChangedSlot* = proc(point: QPointF)
