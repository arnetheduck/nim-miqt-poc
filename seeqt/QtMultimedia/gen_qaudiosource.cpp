...
void QAudioSource_connect_stateChanged(QAudioSource* self, intptr_t slot, void (*callback)(intptr_t, int), void (*release)(intptr_t)) {
	...
	MiqtVirtualQAudioSource::connect(self, static_cast<void (QAudioSource::*)(QAudio::State)>(&QAudioSource::stateChanged), self, caller{slot, callback, release});
}
...
QMetaObject* QAudioSource_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQAudioSource*)(self) )->QAudioSource::metaObject();

}

void* QAudioSource_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQAudioSource*)(self) )->QAudioSource::qt_metacast(param1);

}

int QAudioSource_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQAudioSource*)(self) )->QAudioSource::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
