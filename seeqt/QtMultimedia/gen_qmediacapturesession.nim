...
proc create*(T: type gen_qmediacapturesession_types.QMediaCaptureSession, parent: QObject): gen_qmediacapturesession_types.QMediaCaptureSession =
  gen_qmediacapturesession_types.QMediaCaptureSession.init(fcQMediaCaptureSession_new2(parent.h))

proc metaObject*(self: gen_qmediacapturesession_types.QMediaCaptureSession, ): QMetaObject =
  QMetaObject(h: fcQMediaCaptureSession_metaObject(self.h))
...
proc audioInput*(self: gen_qmediacapturesession_types.QMediaCaptureSession, ): QAudioInput =
  QAudioInput(h: fcQMediaCaptureSession_audioInput(self.h))

proc setAudioInput*(self: gen_qmediacapturesession_types.QMediaCaptureSession, input: QAudioInput): void =
  fcQMediaCaptureSession_setAudioInput(self.h, input.h)

proc camera*(self: gen_qmediacapturesession_types.QMediaCaptureSession, ): QCamera =
  QCamera(h: fcQMediaCaptureSession_camera(self.h))

proc setCamera*(self: gen_qmediacapturesession_types.QMediaCaptureSession, camera: QCamera): void =
  fcQMediaCaptureSession_setCamera(self.h, camera.h)

proc imageCapture*(self: gen_qmediacapturesession_types.QMediaCaptureSession, ): QImageCapture =
  QImageCapture(h: fcQMediaCaptureSession_imageCapture(self.h))

proc setImageCapture*(self: gen_qmediacapturesession_types.QMediaCaptureSession, imageCapture: QImageCapture): void =
  fcQMediaCaptureSession_setImageCapture(self.h, imageCapture.h)

proc recorder*(self: gen_qmediacapturesession_types.QMediaCaptureSession, ): QMediaRecorder =
  QMediaRecorder(h: fcQMediaCaptureSession_recorder(self.h))

proc setRecorder*(self: gen_qmediacapturesession_types.QMediaCaptureSession, recorder: QMediaRecorder): void =
  fcQMediaCaptureSession_setRecorder(self.h, recorder.h)

proc setVideoOutput*(self: gen_qmediacapturesession_types.QMediaCaptureSession, output: QObject): void =
  fcQMediaCaptureSession_setVideoOutput(self.h, output.h)

proc videoOutput*(self: gen_qmediacapturesession_types.QMediaCaptureSession, ): QObject =
  QObject(h: fcQMediaCaptureSession_videoOutput(self.h))

proc setVideoSink*(self: gen_qmediacapturesession_types.QMediaCaptureSession, sink: QVideoSink): void =
  fcQMediaCaptureSession_setVideoSink(self.h, sink.h)

proc videoSink*(self: gen_qmediacapturesession_types.QMediaCaptureSession, ): QVideoSink =
  QVideoSink(h: fcQMediaCaptureSession_videoSink(self.h))

proc setAudioOutput*(self: gen_qmediacapturesession_types.QMediaCaptureSession, output: QAudioOutput): void =
  fcQMediaCaptureSession_setAudioOutput(self.h, output.h)

proc audioOutput*(self: gen_qmediacapturesession_types.QMediaCaptureSession, ): QAudioOutput =
  QAudioOutput(h: fcQMediaCaptureSession_audioOutput(self.h))
...
proc miqt_exec_callback_QMediaCaptureSession_metacall(self: ptr cQMediaCaptureSession, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QMediaCaptureSession_metacall ".} =
  ...
  virtualReturn
proc QMediaCaptureSessionevent*(self: gen_qmediacapturesession_types.QMediaCaptureSession, event: QEvent): bool =
  fQMediaCaptureSession_virtualbase_event(self.h, event.h)

type QMediaCaptureSessioneventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QMediaCaptureSession_event(self: ptr cQMediaCaptureSession, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QMediaCaptureSession_event ".} =
  ...
  virtualReturn
proc QMediaCaptureSessioneventFilter*(self: gen_qmediacapturesession_types.QMediaCaptureSession, watched: QObject, event: QEvent): bool =
  fQMediaCaptureSession_virtualbase_eventFilter(self.h, watched.h, event.h)

type QMediaCaptureSessioneventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QMediaCaptureSession_eventFilter(self: ptr cQMediaCaptureSession, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QMediaCaptureSession_eventFilter ".} =
  ...
  virtualReturn
proc QMediaCaptureSessiontimerEvent*(self: gen_qmediacapturesession_types.QMediaCaptureSession, event: QTimerEvent): void =
  fQMediaCaptureSession_virtualbase_timerEvent(self.h, event.h)

type QMediaCaptureSessiontimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QMediaCaptureSession_timerEvent(self: ptr cQMediaCaptureSession, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QMediaCaptureSession_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QMediaCaptureSessionchildEvent*(self: gen_qmediacapturesession_types.QMediaCaptureSession, event: QChildEvent): void =
  fQMediaCaptureSession_virtualbase_childEvent(self.h, event.h)

type QMediaCaptureSessionchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QMediaCaptureSession_childEvent(self: ptr cQMediaCaptureSession, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QMediaCaptureSession_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QMediaCaptureSessioncustomEvent*(self: gen_qmediacapturesession_types.QMediaCaptureSession, event: QEvent): void =
  fQMediaCaptureSession_virtualbase_customEvent(self.h, event.h)

type QMediaCaptureSessioncustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QMediaCaptureSession_customEvent(self: ptr cQMediaCaptureSession, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QMediaCaptureSession_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QMediaCaptureSessionconnectNotify*(self: gen_qmediacapturesession_types.QMediaCaptureSession, signal: QMetaMethod): void =
  fQMediaCaptureSession_virtualbase_connectNotify(self.h, signal.h)

type QMediaCaptureSessionconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QMediaCaptureSession_connectNotify(self: ptr cQMediaCaptureSession, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QMediaCaptureSession_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QMediaCaptureSessiondisconnectNotify*(self: gen_qmediacapturesession_types.QMediaCaptureSession, signal: QMetaMethod): void =
  fQMediaCaptureSession_virtualbase_disconnectNotify(self.h, signal.h)

type QMediaCaptureSessiondisconnectNotifyProc* = proc(signal: QMetaMethod): void
