...
func init*(T: type gen_qabstractvideofilter_types.QVideoFilterRunnable, h: ptr cQVideoFilterRunnable): gen_qabstractvideofilter_types.QVideoFilterRunnable =
  T(h: h)
proc run*(self: gen_qabstractvideofilter_types.QVideoFilterRunnable, input: QVideoFrame, surfaceFormat: QVideoSurfaceFormat, flags: cint): QVideoFrame =
  QVideoFrame(h: fcQVideoFilterRunnable_run(self.h, input.h, surfaceFormat.h, cint(flags)))

proc operatorAssign*(self: gen_qabstractvideofilter_types.QVideoFilterRunnable, param1: QVideoFilterRunnable): void =
...
proc create*(T: type gen_qabstractvideofilter_types.QAbstractVideoFilter, parent: QObject): gen_qabstractvideofilter_types.QAbstractVideoFilter =
  gen_qabstractvideofilter_types.QAbstractVideoFilter.init(fcQAbstractVideoFilter_new2(parent.h))

proc metaObject*(self: gen_qabstractvideofilter_types.QAbstractVideoFilter, ): QMetaObject =
  QMetaObject(h: fcQAbstractVideoFilter_metaObject(self.h))
...
proc createFilterRunnable*(self: gen_qabstractvideofilter_types.QAbstractVideoFilter, ): QVideoFilterRunnable =
...
proc miqt_exec_callback_QAbstractVideoFilter_metacall(self: ptr cQAbstractVideoFilter, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QAbstractVideoFilter_metacall ".} =
  ...
  virtualReturn
type QAbstractVideoFiltercreateFilterRunnableProc* = proc(): QVideoFilterRunnable
...
proc miqt_exec_callback_QAbstractVideoFilter_createFilterRunnable(self: ptr cQAbstractVideoFilter, slot: int): pointer {.exportc: "miqt_exec_callback_QAbstractVideoFilter_createFilterRunnable ".} =
  ...
  virtualReturn.h
proc QAbstractVideoFilterevent*(self: gen_qabstractvideofilter_types.QAbstractVideoFilter, event: QEvent): bool =
  fQAbstractVideoFilter_virtualbase_event(self.h, event.h)

type QAbstractVideoFiltereventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QAbstractVideoFilter_event(self: ptr cQAbstractVideoFilter, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QAbstractVideoFilter_event ".} =
  ...
  virtualReturn
proc QAbstractVideoFiltereventFilter*(self: gen_qabstractvideofilter_types.QAbstractVideoFilter, watched: QObject, event: QEvent): bool =
  fQAbstractVideoFilter_virtualbase_eventFilter(self.h, watched.h, event.h)

type QAbstractVideoFiltereventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QAbstractVideoFilter_eventFilter(self: ptr cQAbstractVideoFilter, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QAbstractVideoFilter_eventFilter ".} =
  ...
  virtualReturn
proc QAbstractVideoFiltertimerEvent*(self: gen_qabstractvideofilter_types.QAbstractVideoFilter, event: QTimerEvent): void =
  fQAbstractVideoFilter_virtualbase_timerEvent(self.h, event.h)

type QAbstractVideoFiltertimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QAbstractVideoFilter_timerEvent(self: ptr cQAbstractVideoFilter, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QAbstractVideoFilter_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QAbstractVideoFilterchildEvent*(self: gen_qabstractvideofilter_types.QAbstractVideoFilter, event: QChildEvent): void =
  fQAbstractVideoFilter_virtualbase_childEvent(self.h, event.h)

type QAbstractVideoFilterchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QAbstractVideoFilter_childEvent(self: ptr cQAbstractVideoFilter, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QAbstractVideoFilter_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QAbstractVideoFiltercustomEvent*(self: gen_qabstractvideofilter_types.QAbstractVideoFilter, event: QEvent): void =
  fQAbstractVideoFilter_virtualbase_customEvent(self.h, event.h)

type QAbstractVideoFiltercustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QAbstractVideoFilter_customEvent(self: ptr cQAbstractVideoFilter, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QAbstractVideoFilter_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QAbstractVideoFilterconnectNotify*(self: gen_qabstractvideofilter_types.QAbstractVideoFilter, signal: QMetaMethod): void =
  fQAbstractVideoFilter_virtualbase_connectNotify(self.h, signal.h)

type QAbstractVideoFilterconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QAbstractVideoFilter_connectNotify(self: ptr cQAbstractVideoFilter, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QAbstractVideoFilter_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QAbstractVideoFilterdisconnectNotify*(self: gen_qabstractvideofilter_types.QAbstractVideoFilter, signal: QMetaMethod): void =
  fQAbstractVideoFilter_virtualbase_disconnectNotify(self.h, signal.h)

type QAbstractVideoFilterdisconnectNotifyProc* = proc(signal: QMetaMethod): void
