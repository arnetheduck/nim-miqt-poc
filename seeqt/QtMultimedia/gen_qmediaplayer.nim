...
proc fcQMediaPlayer_connect_networkConfigurationChanged(self: pointer, slot: int, callback: proc (slot: int, configuration: ptr cQNetworkConfiguration) {.cdecl.}, release: proc(slot: int) {.cdecl.}) {.importc: "QMediaPlayer_connect_networkConfigurationChanged".}
...
proc miqt_exec_callback_cQMediaPlayer_networkConfigurationChanged(slot: int, configuration: ptr cQNetworkConfiguration) {.cdecl.} =
