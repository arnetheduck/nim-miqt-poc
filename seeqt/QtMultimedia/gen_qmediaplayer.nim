...
proc create*(T: type gen_qmediaplayer_types.QMediaPlayer, parent: QObject): gen_qmediaplayer_types.QMediaPlayer =
  gen_qmediaplayer_types.QMediaPlayer.init(fcQMediaPlayer_new2(parent.h))

proc create*(T: type gen_qmediaplayer_types.QMediaPlayer, parent: QObject, flags: cint): gen_qmediaplayer_types.QMediaPlayer =
  gen_qmediaplayer_types.QMediaPlayer.init(fcQMediaPlayer_new3(parent.h, cint(flags)))

proc metaObject*(self: gen_qmediaplayer_types.QMediaPlayer, ): QMetaObject =
  QMetaObject(h: fcQMediaPlayer_metaObject(self.h))
...
proc setVideoOutput*(self: gen_qmediaplayer_types.QMediaPlayer, surface: QAbstractVideoSurface): void =
  fcQMediaPlayer_setVideoOutputWithSurface(self.h, surface.h)

proc setVideoOutput*(self: gen_qmediaplayer_types.QMediaPlayer, surfaces: seq[QAbstractVideoSurface]): void =
...
proc media*(self: gen_qmediaplayer_types.QMediaPlayer, ): QMediaContent =
  QMediaContent(h: fcQMediaPlayer_media(self.h))

proc mediaStream*(self: gen_qmediaplayer_types.QMediaPlayer, ): QIODevice =
  QIODevice(h: fcQMediaPlayer_mediaStream(self.h))

proc playlist*(self: gen_qmediaplayer_types.QMediaPlayer, ): QMediaPlaylist =
  QMediaPlaylist(h: fcQMediaPlayer_playlist(self.h))

proc currentMedia*(self: gen_qmediaplayer_types.QMediaPlayer, ): QMediaContent =
  QMediaContent(h: fcQMediaPlayer_currentMedia(self.h))
...
proc setMedia*(self: gen_qmediaplayer_types.QMediaPlayer, media: QMediaContent): void =
  fcQMediaPlayer_setMedia(self.h, media.h)

proc setPlaylist*(self: gen_qmediaplayer_types.QMediaPlayer, playlist: QMediaPlaylist): void =
...
proc mediaChanged*(self: gen_qmediaplayer_types.QMediaPlayer, media: QMediaContent): void =
  fcQMediaPlayer_mediaChanged(self.h, media.h)

type QMediaPlayermediaChangedSlot* = proc(media: QMediaContent)
proc miqt_exec_callback_QMediaPlayer_mediaChanged(slot: int, media: pointer) {.exportc.} =
  ...
  let slotval1 = QMediaContent(h: media)
...
proc currentMediaChanged*(self: gen_qmediaplayer_types.QMediaPlayer, media: QMediaContent): void =
  fcQMediaPlayer_currentMediaChanged(self.h, media.h)

type QMediaPlayercurrentMediaChangedSlot* = proc(media: QMediaContent)
...
proc miqt_exec_callback_QMediaPlayer_networkConfigurationChanged(slot: int, configuration: ptr cQNetworkConfiguration) {.exportc.} =
...
proc bindX*(self: gen_qmediaplayer_types.QMediaPlayer, param1: QObject): bool =
  fcQMediaPlayer_bindX(self.h, param1.h)

proc unbind*(self: gen_qmediaplayer_types.QMediaPlayer, param1: QObject): void =
...
proc setMedia*(self: gen_qmediaplayer_types.QMediaPlayer, media: QMediaContent, stream: QIODevice): void =
...
proc miqt_exec_callback_QMediaPlayer_availability(self: ptr cQMediaPlayer, slot: int): cint {.exportc: "miqt_exec_callback_QMediaPlayer_availability ".} =
  ...
  cint(virtualReturn)
proc QMediaPlayerbindX*(self: gen_qmediaplayer_types.QMediaPlayer, param1: QObject): bool =
  fQMediaPlayer_virtualbase_bind(self.h, param1.h)

type QMediaPlayerbindXProc* = proc(param1: QObject): bool
...
proc miqt_exec_callback_QMediaPlayer_bind(self: ptr cQMediaPlayer, slot: int, param1: pointer): bool {.exportc: "miqt_exec_callback_QMediaPlayer_bind ".} =
  ...
  virtualReturn
proc QMediaPlayerunbind*(self: gen_qmediaplayer_types.QMediaPlayer, param1: QObject): void =
  fQMediaPlayer_virtualbase_unbind(self.h, param1.h)

type QMediaPlayerunbindProc* = proc(param1: QObject): void
...
proc miqt_exec_callback_QMediaPlayer_isAvailable(self: ptr cQMediaPlayer, slot: int): bool {.exportc: "miqt_exec_callback_QMediaPlayer_isAvailable ".} =
  ...
  virtualReturn
proc QMediaPlayerservice*(self: gen_qmediaplayer_types.QMediaPlayer, ): QMediaService =
  QMediaService(h: fQMediaPlayer_virtualbase_service(self.h))

type QMediaPlayerserviceProc* = proc(): QMediaService
...
proc miqt_exec_callback_QMediaPlayer_service(self: ptr cQMediaPlayer, slot: int): pointer {.exportc: "miqt_exec_callback_QMediaPlayer_service ".} =
  ...
  virtualReturn.h
proc QMediaPlayerevent*(self: gen_qmediaplayer_types.QMediaPlayer, event: QEvent): bool =
  fQMediaPlayer_virtualbase_event(self.h, event.h)

type QMediaPlayereventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QMediaPlayer_event(self: ptr cQMediaPlayer, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QMediaPlayer_event ".} =
  ...
  virtualReturn
proc QMediaPlayereventFilter*(self: gen_qmediaplayer_types.QMediaPlayer, watched: QObject, event: QEvent): bool =
  fQMediaPlayer_virtualbase_eventFilter(self.h, watched.h, event.h)

type QMediaPlayereventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QMediaPlayer_eventFilter(self: ptr cQMediaPlayer, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QMediaPlayer_eventFilter ".} =
  ...
  virtualReturn
proc QMediaPlayertimerEvent*(self: gen_qmediaplayer_types.QMediaPlayer, event: QTimerEvent): void =
  fQMediaPlayer_virtualbase_timerEvent(self.h, event.h)

type QMediaPlayertimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QMediaPlayer_timerEvent(self: ptr cQMediaPlayer, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QMediaPlayer_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QMediaPlayerchildEvent*(self: gen_qmediaplayer_types.QMediaPlayer, event: QChildEvent): void =
  fQMediaPlayer_virtualbase_childEvent(self.h, event.h)

type QMediaPlayerchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QMediaPlayer_childEvent(self: ptr cQMediaPlayer, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QMediaPlayer_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QMediaPlayercustomEvent*(self: gen_qmediaplayer_types.QMediaPlayer, event: QEvent): void =
  fQMediaPlayer_virtualbase_customEvent(self.h, event.h)

type QMediaPlayercustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QMediaPlayer_customEvent(self: ptr cQMediaPlayer, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QMediaPlayer_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QMediaPlayerconnectNotify*(self: gen_qmediaplayer_types.QMediaPlayer, signal: QMetaMethod): void =
  fQMediaPlayer_virtualbase_connectNotify(self.h, signal.h)

type QMediaPlayerconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QMediaPlayer_connectNotify(self: ptr cQMediaPlayer, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QMediaPlayer_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QMediaPlayerdisconnectNotify*(self: gen_qmediaplayer_types.QMediaPlayer, signal: QMetaMethod): void =
  fQMediaPlayer_virtualbase_disconnectNotify(self.h, signal.h)

type QMediaPlayerdisconnectNotifyProc* = proc(signal: QMetaMethod): void
