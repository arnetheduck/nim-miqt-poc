...
proc audioTracks*(self: gen_qmediaplayer_types.QMediaPlayer, ): seq[QMediaMetaData] =
  var v_ma = fcQMediaPlayer_audioTracks(self.h)
  var vx_ret = newSeq[QMediaMetaData](int(v_ma.len))
  let v_outCast = cast[ptr UncheckedArray[pointer]](v_ma.data)
  for i in 0 ..< v_ma.len:
    vx_ret[i] = QMediaMetaData(h: v_outCast[i])
  vx_ret

proc videoTracks*(self: gen_qmediaplayer_types.QMediaPlayer, ): seq[QMediaMetaData] =
...
proc subtitleTracks*(self: gen_qmediaplayer_types.QMediaPlayer, ): seq[QMediaMetaData] =
...
proc setAudioOutput*(self: gen_qmediaplayer_types.QMediaPlayer, output: QAudioOutput): void =
  fcQMediaPlayer_setAudioOutput(self.h, output.h)

proc audioOutput*(self: gen_qmediaplayer_types.QMediaPlayer, ): QAudioOutput =
  QAudioOutput(h: fcQMediaPlayer_audioOutput(self.h))

proc setVideoOutput*(self: gen_qmediaplayer_types.QMediaPlayer, videoOutput: QObject): void =
  fcQMediaPlayer_setVideoOutput(self.h, videoOutput.h)

proc videoOutput*(self: gen_qmediaplayer_types.QMediaPlayer, ): QObject =
  QObject(h: fcQMediaPlayer_videoOutput(self.h))

proc setVideoSink*(self: gen_qmediaplayer_types.QMediaPlayer, sink: QVideoSink): void =
  fcQMediaPlayer_setVideoSink(self.h, sink.h)

proc videoSink*(self: gen_qmediaplayer_types.QMediaPlayer, ): QVideoSink =
  QVideoSink(h: fcQMediaPlayer_videoSink(self.h))

proc source*(self: gen_qmediaplayer_types.QMediaPlayer, ): QUrl =
  QUrl(h: fcQMediaPlayer_source(self.h))

proc sourceDevice*(self: gen_qmediaplayer_types.QMediaPlayer, ): QIODevice =
  QIODevice(h: fcQMediaPlayer_sourceDevice(self.h))
...
proc bufferedTimeRange*(self: gen_qmediaplayer_types.QMediaPlayer, ): QMediaTimeRange =
  QMediaTimeRange(h: fcQMediaPlayer_bufferedTimeRange(self.h))
...
proc metaData*(self: gen_qmediaplayer_types.QMediaPlayer, ): QMediaMetaData =
  QMediaMetaData(h: fcQMediaPlayer_metaData(self.h))
...
proc setSource*(self: gen_qmediaplayer_types.QMediaPlayer, source: QUrl): void =
  fcQMediaPlayer_setSource(self.h, source.h)

proc setSourceDevice*(self: gen_qmediaplayer_types.QMediaPlayer, device: QIODevice): void =
  fcQMediaPlayer_setSourceDevice(self.h, device.h)

proc sourceChanged*(self: gen_qmediaplayer_types.QMediaPlayer, media: QUrl): void =
  fcQMediaPlayer_sourceChanged(self.h, media.h)

type QMediaPlayersourceChangedSlot* = proc(media: QUrl)
...
proc setSourceDevice*(self: gen_qmediaplayer_types.QMediaPlayer, device: QIODevice, sourceUrl: QUrl): void =
