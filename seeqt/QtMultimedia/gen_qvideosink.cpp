...
void QVideoSink_connect_videoFrameChanged(QVideoSink* self, intptr_t slot, void (*callback)(intptr_t, QVideoFrame*), void (*release)(intptr_t)) {
	...
	MiqtVirtualQVideoSink::connect(self, static_cast<void (QVideoSink::*)(const QVideoFrame&) const>(&QVideoSink::videoFrameChanged), self, caller{slot, callback, release});
}
...
void QVideoSink_connect_subtitleTextChanged(QVideoSink* self, intptr_t slot, void (*callback)(intptr_t, struct miqt_string), void (*release)(intptr_t)) {
	...
	MiqtVirtualQVideoSink::connect(self, static_cast<void (QVideoSink::*)(const QString&) const>(&QVideoSink::subtitleTextChanged), self, caller{slot, callback, release});
}
...
void QVideoSink_connect_videoSizeChanged(QVideoSink* self, intptr_t slot, void (*callback)(intptr_t), void (*release)(intptr_t)) {
	...
	MiqtVirtualQVideoSink::connect(self, static_cast<void (QVideoSink::*)()>(&QVideoSink::videoSizeChanged), self, caller{slot, callback, release});
}
...
QMetaObject* QVideoSink_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQVideoSink*)(self) )->QVideoSink::metaObject();

}

void* QVideoSink_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQVideoSink*)(self) )->QVideoSink::qt_metacast(param1);

}

int QVideoSink_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQVideoSink*)(self) )->QVideoSink::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
