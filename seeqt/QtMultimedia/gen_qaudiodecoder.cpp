...
void QAudioDecoder_connect_bufferAvailableChanged(QAudioDecoder* self, intptr_t slot, void (*callback)(intptr_t, bool), void (*release)(intptr_t)) {
	...
	MiqtVirtualQAudioDecoder::connect(self, static_cast<void (QAudioDecoder::*)(bool)>(&QAudioDecoder::bufferAvailableChanged), self, caller{slot, callback, release});
}
...
void QAudioDecoder_connect_bufferReady(QAudioDecoder* self, intptr_t slot, void (*callback)(intptr_t), void (*release)(intptr_t)) {
	...
	MiqtVirtualQAudioDecoder::connect(self, static_cast<void (QAudioDecoder::*)()>(&QAudioDecoder::bufferReady), self, caller{slot, callback, release});
}
...
void QAudioDecoder_connect_finished(QAudioDecoder* self, intptr_t slot, void (*callback)(intptr_t), void (*release)(intptr_t)) {
	...
	MiqtVirtualQAudioDecoder::connect(self, static_cast<void (QAudioDecoder::*)()>(&QAudioDecoder::finished), self, caller{slot, callback, release});
}
...
void QAudioDecoder_connect_stateChanged(QAudioDecoder* self, intptr_t slot, void (*callback)(intptr_t, int), void (*release)(intptr_t)) {
	...
	MiqtVirtualQAudioDecoder::connect(self, static_cast<void (QAudioDecoder::*)(QAudioDecoder::State)>(&QAudioDecoder::stateChanged), self, caller{slot, callback, release});
}
...
void QAudioDecoder_connect_formatChanged(QAudioDecoder* self, intptr_t slot, void (*callback)(intptr_t, QAudioFormat*), void (*release)(intptr_t)) {
	...
	MiqtVirtualQAudioDecoder::connect(self, static_cast<void (QAudioDecoder::*)(const QAudioFormat&)>(&QAudioDecoder::formatChanged), self, caller{slot, callback, release});
}
...
void QAudioDecoder_connect_errorWithError(QAudioDecoder* self, intptr_t slot, void (*callback)(intptr_t, int), void (*release)(intptr_t)) {
	...
	MiqtVirtualQAudioDecoder::connect(self, static_cast<void (QAudioDecoder::*)(QAudioDecoder::Error)>(&QAudioDecoder::error), self, caller{slot, callback, release});
}
...
void QAudioDecoder_connect_sourceChanged(QAudioDecoder* self, intptr_t slot, void (*callback)(intptr_t), void (*release)(intptr_t)) {
	...
	MiqtVirtualQAudioDecoder::connect(self, static_cast<void (QAudioDecoder::*)()>(&QAudioDecoder::sourceChanged), self, caller{slot, callback, release});
}
...
void QAudioDecoder_connect_positionChanged(QAudioDecoder* self, intptr_t slot, void (*callback)(intptr_t, long long), void (*release)(intptr_t)) {
	...
	MiqtVirtualQAudioDecoder::connect(self, static_cast<void (QAudioDecoder::*)(qint64)>(&QAudioDecoder::positionChanged), self, caller{slot, callback, release});
}
...
void QAudioDecoder_connect_durationChanged(QAudioDecoder* self, intptr_t slot, void (*callback)(intptr_t, long long), void (*release)(intptr_t)) {
	...
	MiqtVirtualQAudioDecoder::connect(self, static_cast<void (QAudioDecoder::*)(qint64)>(&QAudioDecoder::durationChanged), self, caller{slot, callback, release});
}
...
QMetaObject* QAudioDecoder_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQAudioDecoder*)(self) )->QAudioDecoder::metaObject();

}

void* QAudioDecoder_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQAudioDecoder*)(self) )->QAudioDecoder::qt_metacast(param1);

}

int QAudioDecoder_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQAudioDecoder*)(self) )->QAudioDecoder::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);

}

bool QAudioDecoder_virtualbase_bind(void* self, QObject* param1) {

	return ( (MiqtVirtualQAudioDecoder*)(self) )->QAudioDecoder::bind(param1);

}

void QAudioDecoder_virtualbase_unbind(void* self, QObject* param1) {

	( (MiqtVirtualQAudioDecoder*)(self) )->QAudioDecoder::unbind(param1);

}

bool QAudioDecoder_virtualbase_isAvailable(const void* self) {

	return ( (const MiqtVirtualQAudioDecoder*)(self) )->QAudioDecoder::isAvailable();

}

int QAudioDecoder_virtualbase_availability(const void* self) {

	QMultimedia::AvailabilityStatus _ret = ( (const MiqtVirtualQAudioDecoder*)(self) )->QAudioDecoder::availability();
	return static_cast<int>(_ret);
...
QMediaService* QAudioDecoder_virtualbase_service(const void* self) {
	...
	return ( (const MiqtVirtualQAudioDecoder*)(self) )->QAudioDecoder::service();
...
void QAudioDecoder_protectedbase_addPropertyWatch(void* self, struct miqt_string name) {
	MiqtVirtualQAudioDecoder* self_cast = static_cast<MiqtVirtualQAudioDecoder*>( (QAudioDecoder*)(self) );
