...
void QAbstractVideoFilter_connect_activeChanged(QAbstractVideoFilter* self, intptr_t slot, void (*callback)(intptr_t), void (*release)(intptr_t)) {
	...
	MiqtVirtualQAbstractVideoFilter::connect(self, static_cast<void (QAbstractVideoFilter::*)()>(&QAbstractVideoFilter::activeChanged), self, caller{slot, callback, release});
}
...
QMetaObject* QAbstractVideoFilter_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQAbstractVideoFilter*)(self) )->QAbstractVideoFilter::metaObject();

}

void* QAbstractVideoFilter_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQAbstractVideoFilter*)(self) )->QAbstractVideoFilter::qt_metacast(param1);

}

int QAbstractVideoFilter_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQAbstractVideoFilter*)(self) )->QAbstractVideoFilter::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
QObject* QAbstractVideoFilter_protectedbase_sender(const void* self) {
	MiqtVirtualQAbstractVideoFilter* self_cast = static_cast<MiqtVirtualQAbstractVideoFilter*>( (QAbstractVideoFilter*)(self) );
