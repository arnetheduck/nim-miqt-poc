...
func init*(T: type gen_qmediarecorder_types.QMediaRecorder, h: ptr cQMediaRecorder): gen_qmediarecorder_types.QMediaRecorder =
  T(h: h)
proc create*(T: type gen_qmediarecorder_types.QMediaRecorder, mediaObject: QMediaObject): gen_qmediarecorder_types.QMediaRecorder =
  gen_qmediarecorder_types.QMediaRecorder.init(fcQMediaRecorder_new(mediaObject.h))

proc create*(T: type gen_qmediarecorder_types.QMediaRecorder, mediaObject: QMediaObject, parent: QObject): gen_qmediarecorder_types.QMediaRecorder =
  gen_qmediarecorder_types.QMediaRecorder.init(fcQMediaRecorder_new2(mediaObject.h, parent.h))

proc metaObject*(self: gen_qmediarecorder_types.QMediaRecorder, ): QMetaObject =
  QMetaObject(h: fcQMediaRecorder_metaObject(self.h))
...
proc mediaObject*(self: gen_qmediarecorder_types.QMediaRecorder, ): QMediaObject =
  QMediaObject(h: fcQMediaRecorder_mediaObject(self.h))
...
proc outputLocation*(self: gen_qmediarecorder_types.QMediaRecorder, ): QUrl =
  QUrl(h: fcQMediaRecorder_outputLocation(self.h))

proc setOutputLocation*(self: gen_qmediarecorder_types.QMediaRecorder, location: QUrl): bool =
  fcQMediaRecorder_setOutputLocation(self.h, location.h)

proc actualLocation*(self: gen_qmediarecorder_types.QMediaRecorder, ): QUrl =
  QUrl(h: fcQMediaRecorder_actualLocation(self.h))
...
proc supportedResolutions*(self: gen_qmediarecorder_types.QMediaRecorder, ): seq[QSize] =
...
proc audioSettings*(self: gen_qmediarecorder_types.QMediaRecorder, ): QAudioEncoderSettings =
  QAudioEncoderSettings(h: fcQMediaRecorder_audioSettings(self.h))

proc videoSettings*(self: gen_qmediarecorder_types.QMediaRecorder, ): QVideoEncoderSettings =
  QVideoEncoderSettings(h: fcQMediaRecorder_videoSettings(self.h))
...
proc setAudioSettings*(self: gen_qmediarecorder_types.QMediaRecorder, audioSettings: QAudioEncoderSettings): void =
  fcQMediaRecorder_setAudioSettings(self.h, audioSettings.h)

proc setVideoSettings*(self: gen_qmediarecorder_types.QMediaRecorder, videoSettings: QVideoEncoderSettings): void =
...
proc setEncodingSettings*(self: gen_qmediarecorder_types.QMediaRecorder, audioSettings: QAudioEncoderSettings): void =
...
proc metaData*(self: gen_qmediarecorder_types.QMediaRecorder, key: string): QVariant =
  QVariant(h: fcQMediaRecorder_metaData(self.h, struct_miqt_string(data: key, len: csize_t(len(key)))))

proc setMetaData*(self: gen_qmediarecorder_types.QMediaRecorder, key: string, value: QVariant): void =
...
proc actualLocationChanged*(self: gen_qmediarecorder_types.QMediaRecorder, location: QUrl): void =
  fcQMediaRecorder_actualLocationChanged(self.h, location.h)

type QMediaRecorderactualLocationChangedSlot* = proc(location: QUrl)
...
proc metaDataChanged*(self: gen_qmediarecorder_types.QMediaRecorder, key: string, value: QVariant): void =
  fcQMediaRecorder_metaDataChanged2(self.h, struct_miqt_string(data: key, len: csize_t(len(key))), value.h)

type QMediaRecordermetaDataChanged2Slot* = proc(key: string, value: QVariant)
...
proc supportedAudioSampleRates*(self: gen_qmediarecorder_types.QMediaRecorder, settings: QAudioEncoderSettings): seq[cint] =
...
proc supportedAudioSampleRates*(self: gen_qmediarecorder_types.QMediaRecorder, settings: QAudioEncoderSettings, continuous: ptr bool): seq[cint] =
...
proc supportedResolutions*(self: gen_qmediarecorder_types.QMediaRecorder, settings: QVideoEncoderSettings): seq[QSize] =
...
proc supportedResolutions*(self: gen_qmediarecorder_types.QMediaRecorder, settings: QVideoEncoderSettings, continuous: ptr bool): seq[QSize] =
...
proc supportedFrameRates*(self: gen_qmediarecorder_types.QMediaRecorder, settings: QVideoEncoderSettings): seq[float64] =
...
proc supportedFrameRates*(self: gen_qmediarecorder_types.QMediaRecorder, settings: QVideoEncoderSettings, continuous: ptr bool): seq[float64] =
...
proc setEncodingSettings*(self: gen_qmediarecorder_types.QMediaRecorder, audioSettings: QAudioEncoderSettings, videoSettings: QVideoEncoderSettings): void =
  fcQMediaRecorder_setEncodingSettings2(self.h, audioSettings.h, videoSettings.h)

proc setEncodingSettings*(self: gen_qmediarecorder_types.QMediaRecorder, audioSettings: QAudioEncoderSettings, videoSettings: QVideoEncoderSettings, containerMimeType: string): void =
...
proc miqt_exec_callback_QMediaRecorder_metacall(self: ptr cQMediaRecorder, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QMediaRecorder_metacall ".} =
  ...
  virtualReturn
proc QMediaRecordermediaObject*(self: gen_qmediarecorder_types.QMediaRecorder, ): QMediaObject =
  QMediaObject(h: fQMediaRecorder_virtualbase_mediaObject(self.h))

type QMediaRecordermediaObjectProc* = proc(): QMediaObject
...
proc miqt_exec_callback_QMediaRecorder_mediaObject(self: ptr cQMediaRecorder, slot: int): pointer {.exportc: "miqt_exec_callback_QMediaRecorder_mediaObject ".} =
  ...
  virtualReturn.h
proc QMediaRecordersetMediaObject*(self: gen_qmediarecorder_types.QMediaRecorder, objectVal: QMediaObject): bool =
  fQMediaRecorder_virtualbase_setMediaObject(self.h, objectVal.h)

type QMediaRecordersetMediaObjectProc* = proc(objectVal: QMediaObject): bool
...
proc miqt_exec_callback_QMediaRecorder_setMediaObject(self: ptr cQMediaRecorder, slot: int, objectVal: pointer): bool {.exportc: "miqt_exec_callback_QMediaRecorder_setMediaObject ".} =
  ...
  virtualReturn
proc QMediaRecorderevent*(self: gen_qmediarecorder_types.QMediaRecorder, event: QEvent): bool =
  fQMediaRecorder_virtualbase_event(self.h, event.h)

type QMediaRecordereventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QMediaRecorder_event(self: ptr cQMediaRecorder, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QMediaRecorder_event ".} =
  ...
  virtualReturn
proc QMediaRecordereventFilter*(self: gen_qmediarecorder_types.QMediaRecorder, watched: QObject, event: QEvent): bool =
  fQMediaRecorder_virtualbase_eventFilter(self.h, watched.h, event.h)

type QMediaRecordereventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QMediaRecorder_eventFilter(self: ptr cQMediaRecorder, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QMediaRecorder_eventFilter ".} =
  ...
  virtualReturn
proc QMediaRecordertimerEvent*(self: gen_qmediarecorder_types.QMediaRecorder, event: QTimerEvent): void =
  fQMediaRecorder_virtualbase_timerEvent(self.h, event.h)

type QMediaRecordertimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QMediaRecorder_timerEvent(self: ptr cQMediaRecorder, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QMediaRecorder_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QMediaRecorderchildEvent*(self: gen_qmediarecorder_types.QMediaRecorder, event: QChildEvent): void =
  fQMediaRecorder_virtualbase_childEvent(self.h, event.h)

type QMediaRecorderchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QMediaRecorder_childEvent(self: ptr cQMediaRecorder, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QMediaRecorder_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QMediaRecordercustomEvent*(self: gen_qmediarecorder_types.QMediaRecorder, event: QEvent): void =
  fQMediaRecorder_virtualbase_customEvent(self.h, event.h)

type QMediaRecordercustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QMediaRecorder_customEvent(self: ptr cQMediaRecorder, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QMediaRecorder_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QMediaRecorderconnectNotify*(self: gen_qmediarecorder_types.QMediaRecorder, signal: QMetaMethod): void =
  fQMediaRecorder_virtualbase_connectNotify(self.h, signal.h)

type QMediaRecorderconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QMediaRecorder_connectNotify(self: ptr cQMediaRecorder, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QMediaRecorder_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QMediaRecorderdisconnectNotify*(self: gen_qmediarecorder_types.QMediaRecorder, signal: QMetaMethod): void =
  fQMediaRecorder_virtualbase_disconnectNotify(self.h, signal.h)

type QMediaRecorderdisconnectNotifyProc* = proc(signal: QMetaMethod): void
