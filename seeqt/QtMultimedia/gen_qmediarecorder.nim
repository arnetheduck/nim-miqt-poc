...
proc create*(T: type gen_qmediarecorder_types.QMediaRecorder, parent: QObject): gen_qmediarecorder_types.QMediaRecorder =
...
proc setOutputLocation*(self: gen_qmediarecorder_types.QMediaRecorder, location: QUrl): void =
...
proc mediaFormat*(self: gen_qmediarecorder_types.QMediaRecorder, ): QMediaFormat =
  QMediaFormat(h: fcQMediaRecorder_mediaFormat(self.h))

proc setMediaFormat*(self: gen_qmediarecorder_types.QMediaRecorder, format: QMediaFormat): void =
...
proc videoResolution*(self: gen_qmediarecorder_types.QMediaRecorder, ): QSize =
  QSize(h: fcQMediaRecorder_videoResolution(self.h))

proc setVideoResolution*(self: gen_qmediarecorder_types.QMediaRecorder, videoResolution: QSize): void =
...
proc metaData*(self: gen_qmediarecorder_types.QMediaRecorder, ): QMediaMetaData =
  QMediaMetaData(h: fcQMediaRecorder_metaData(self.h))

proc setMetaData*(self: gen_qmediarecorder_types.QMediaRecorder, metaData: QMediaMetaData): void =
  fcQMediaRecorder_setMetaData(self.h, metaData.h)

proc addMetaData*(self: gen_qmediarecorder_types.QMediaRecorder, metaData: QMediaMetaData): void =
  fcQMediaRecorder_addMetaData(self.h, metaData.h)

proc captureSession*(self: gen_qmediarecorder_types.QMediaRecorder, ): QMediaCaptureSession =
  QMediaCaptureSession(h: fcQMediaRecorder_captureSession(self.h))
