...
proc create*(T: type gen_qabstractvideosurface_types.QAbstractVideoSurface, parent: QObject): gen_qabstractvideosurface_types.QAbstractVideoSurface =
  gen_qabstractvideosurface_types.QAbstractVideoSurface.init(fcQAbstractVideoSurface_new2(parent.h))

proc metaObject*(self: gen_qabstractvideosurface_types.QAbstractVideoSurface, ): QMetaObject =
  QMetaObject(h: fcQAbstractVideoSurface_metaObject(self.h))
...
proc isFormatSupported*(self: gen_qabstractvideosurface_types.QAbstractVideoSurface, format: QVideoSurfaceFormat): bool =
  fcQAbstractVideoSurface_isFormatSupported(self.h, format.h)

proc nearestFormat*(self: gen_qabstractvideosurface_types.QAbstractVideoSurface, format: QVideoSurfaceFormat): QVideoSurfaceFormat =
  QVideoSurfaceFormat(h: fcQAbstractVideoSurface_nearestFormat(self.h, format.h))

proc surfaceFormat*(self: gen_qabstractvideosurface_types.QAbstractVideoSurface, ): QVideoSurfaceFormat =
  QVideoSurfaceFormat(h: fcQAbstractVideoSurface_surfaceFormat(self.h))

proc nativeResolution*(self: gen_qabstractvideosurface_types.QAbstractVideoSurface, ): QSize =
  QSize(h: fcQAbstractVideoSurface_nativeResolution(self.h))

proc start*(self: gen_qabstractvideosurface_types.QAbstractVideoSurface, format: QVideoSurfaceFormat): bool =
...
proc present*(self: gen_qabstractvideosurface_types.QAbstractVideoSurface, frame: QVideoFrame): bool =
...
proc surfaceFormatChanged*(self: gen_qabstractvideosurface_types.QAbstractVideoSurface, format: QVideoSurfaceFormat): void =
  fcQAbstractVideoSurface_surfaceFormatChanged(self.h, format.h)

type QAbstractVideoSurfacesurfaceFormatChangedSlot* = proc(format: QVideoSurfaceFormat)
proc miqt_exec_callback_QAbstractVideoSurface_surfaceFormatChanged(slot: int, format: pointer) {.exportc.} =
  ...
  let slotval1 = QVideoSurfaceFormat(h: format)
...
proc nativeResolutionChanged*(self: gen_qabstractvideosurface_types.QAbstractVideoSurface, resolution: QSize): void =
  fcQAbstractVideoSurface_nativeResolutionChanged(self.h, resolution.h)

type QAbstractVideoSurfacenativeResolutionChangedSlot* = proc(resolution: QSize)
proc miqt_exec_callback_QAbstractVideoSurface_nativeResolutionChanged(slot: int, resolution: pointer) {.exportc.} =
  ...
  let slotval1 = QSize(h: resolution)
...
proc QAbstractVideoSurfaceisFormatSupported*(self: gen_qabstractvideosurface_types.QAbstractVideoSurface, format: QVideoSurfaceFormat): bool =
  fQAbstractVideoSurface_virtualbase_isFormatSupported(self.h, format.h)

type QAbstractVideoSurfaceisFormatSupportedProc* = proc(format: QVideoSurfaceFormat): bool
...
proc miqt_exec_callback_QAbstractVideoSurface_isFormatSupported(self: ptr cQAbstractVideoSurface, slot: int, format: pointer): bool {.exportc: "miqt_exec_callback_QAbstractVideoSurface_isFormatSupported ".} =
  ...
  virtualReturn
proc QAbstractVideoSurfacenearestFormat*(self: gen_qabstractvideosurface_types.QAbstractVideoSurface, format: QVideoSurfaceFormat): QVideoSurfaceFormat =
  QVideoSurfaceFormat(h: fQAbstractVideoSurface_virtualbase_nearestFormat(self.h, format.h))

type QAbstractVideoSurfacenearestFormatProc* = proc(format: QVideoSurfaceFormat): QVideoSurfaceFormat
...
proc miqt_exec_callback_QAbstractVideoSurface_nearestFormat(self: ptr cQAbstractVideoSurface, slot: int, format: pointer): pointer {.exportc: "miqt_exec_callback_QAbstractVideoSurface_nearestFormat ".} =
  ...
  virtualReturn.h
proc QAbstractVideoSurfacestart*(self: gen_qabstractvideosurface_types.QAbstractVideoSurface, format: QVideoSurfaceFormat): bool =
  fQAbstractVideoSurface_virtualbase_start(self.h, format.h)

type QAbstractVideoSurfacestartProc* = proc(format: QVideoSurfaceFormat): bool
...
proc miqt_exec_callback_QAbstractVideoSurface_stop(self: ptr cQAbstractVideoSurface, slot: int): void {.exportc: "miqt_exec_callback_QAbstractVideoSurface_stop ".} =
  ...
  nimfunc[]()
type QAbstractVideoSurfacepresentProc* = proc(frame: QVideoFrame): bool
...
proc miqt_exec_callback_QAbstractVideoSurface_present(self: ptr cQAbstractVideoSurface, slot: int, frame: pointer): bool {.exportc: "miqt_exec_callback_QAbstractVideoSurface_present ".} =
  ...
  let slotval1 = QVideoFrame(h: frame)


  let virtualReturn = nimfunc[](slotval1 )

  virtualReturn
proc QAbstractVideoSurfaceevent*(self: gen_qabstractvideosurface_types.QAbstractVideoSurface, event: QEvent): bool =
  fQAbstractVideoSurface_virtualbase_event(self.h, event.h)

type QAbstractVideoSurfaceeventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QAbstractVideoSurface_event(self: ptr cQAbstractVideoSurface, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QAbstractVideoSurface_event ".} =
  ...
  virtualReturn
proc QAbstractVideoSurfaceeventFilter*(self: gen_qabstractvideosurface_types.QAbstractVideoSurface, watched: QObject, event: QEvent): bool =
  fQAbstractVideoSurface_virtualbase_eventFilter(self.h, watched.h, event.h)

type QAbstractVideoSurfaceeventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QAbstractVideoSurface_eventFilter(self: ptr cQAbstractVideoSurface, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QAbstractVideoSurface_eventFilter ".} =
  ...
  virtualReturn
proc QAbstractVideoSurfacetimerEvent*(self: gen_qabstractvideosurface_types.QAbstractVideoSurface, event: QTimerEvent): void =
  fQAbstractVideoSurface_virtualbase_timerEvent(self.h, event.h)

type QAbstractVideoSurfacetimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QAbstractVideoSurface_timerEvent(self: ptr cQAbstractVideoSurface, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QAbstractVideoSurface_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QAbstractVideoSurfacechildEvent*(self: gen_qabstractvideosurface_types.QAbstractVideoSurface, event: QChildEvent): void =
  fQAbstractVideoSurface_virtualbase_childEvent(self.h, event.h)

type QAbstractVideoSurfacechildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QAbstractVideoSurface_childEvent(self: ptr cQAbstractVideoSurface, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QAbstractVideoSurface_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QAbstractVideoSurfacecustomEvent*(self: gen_qabstractvideosurface_types.QAbstractVideoSurface, event: QEvent): void =
  fQAbstractVideoSurface_virtualbase_customEvent(self.h, event.h)

type QAbstractVideoSurfacecustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QAbstractVideoSurface_customEvent(self: ptr cQAbstractVideoSurface, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QAbstractVideoSurface_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QAbstractVideoSurfaceconnectNotify*(self: gen_qabstractvideosurface_types.QAbstractVideoSurface, signal: QMetaMethod): void =
  fQAbstractVideoSurface_virtualbase_connectNotify(self.h, signal.h)

type QAbstractVideoSurfaceconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QAbstractVideoSurface_connectNotify(self: ptr cQAbstractVideoSurface, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QAbstractVideoSurface_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QAbstractVideoSurfacedisconnectNotify*(self: gen_qabstractvideosurface_types.QAbstractVideoSurface, signal: QMetaMethod): void =
  fQAbstractVideoSurface_virtualbase_disconnectNotify(self.h, signal.h)

type QAbstractVideoSurfacedisconnectNotifyProc* = proc(signal: QMetaMethod): void
