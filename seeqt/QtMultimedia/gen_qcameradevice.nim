...
proc create*(T: type gen_qcameradevice_types.QCameraFormat, other: QCameraFormat): gen_qcameradevice_types.QCameraFormat =
  gen_qcameradevice_types.QCameraFormat.init(fcQCameraFormat_new2(other.h))

proc operatorAssign*(self: gen_qcameradevice_types.QCameraFormat, other: QCameraFormat): void =
...
proc resolution*(self: gen_qcameradevice_types.QCameraFormat, ): QSize =
  QSize(h: fcQCameraFormat_resolution(self.h))
...
proc operatorEqual*(self: gen_qcameradevice_types.QCameraFormat, other: QCameraFormat): bool =
  fcQCameraFormat_operatorEqual(self.h, other.h)

proc operatorNotEqual*(self: gen_qcameradevice_types.QCameraFormat, other: QCameraFormat): bool =
...
proc create*(T: type gen_qcameradevice_types.QCameraDevice, other: QCameraDevice): gen_qcameradevice_types.QCameraDevice =
  gen_qcameradevice_types.QCameraDevice.init(fcQCameraDevice_new2(other.h))

proc operatorAssign*(self: gen_qcameradevice_types.QCameraDevice, other: QCameraDevice): void =
  fcQCameraDevice_operatorAssign(self.h, other.h)

proc operatorEqual*(self: gen_qcameradevice_types.QCameraDevice, other: QCameraDevice): bool =
  fcQCameraDevice_operatorEqual(self.h, other.h)

proc operatorNotEqual*(self: gen_qcameradevice_types.QCameraDevice, other: QCameraDevice): bool =
...
proc photoResolutions*(self: gen_qcameradevice_types.QCameraDevice, ): seq[QSize] =
...
proc videoFormats*(self: gen_qcameradevice_types.QCameraDevice, ): seq[QCameraFormat] =
