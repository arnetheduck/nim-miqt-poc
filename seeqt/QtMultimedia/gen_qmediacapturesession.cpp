...
QMetaObject* QMediaCaptureSession_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQMediaCaptureSession*)(self) )->QMediaCaptureSession::metaObject();

}

void* QMediaCaptureSession_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQMediaCaptureSession*)(self) )->QMediaCaptureSession::qt_metacast(param1);

}

int QMediaCaptureSession_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQMediaCaptureSession*)(self) )->QMediaCaptureSession::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
