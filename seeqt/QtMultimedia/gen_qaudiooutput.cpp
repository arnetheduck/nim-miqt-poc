...
void QAudioOutput_connect_deviceChanged(QAudioOutput* self, intptr_t slot, void (*callback)(intptr_t), void (*release)(intptr_t)) {
	...
	MiqtVirtualQAudioOutput::connect(self, static_cast<void (QAudioOutput::*)()>(&QAudioOutput::deviceChanged), self, caller{slot, callback, release});
}
...
void QAudioOutput_connect_volumeChanged(QAudioOutput* self, intptr_t slot, void (*callback)(intptr_t, float), void (*release)(intptr_t)) {
	...
	MiqtVirtualQAudioOutput::connect(self, static_cast<void (QAudioOutput::*)(float)>(&QAudioOutput::volumeChanged), self, caller{slot, callback, release});
}
...
void QAudioOutput_connect_mutedChanged(QAudioOutput* self, intptr_t slot, void (*callback)(intptr_t, bool), void (*release)(intptr_t)) {
	...
	MiqtVirtualQAudioOutput::connect(self, static_cast<void (QAudioOutput::*)(bool)>(&QAudioOutput::mutedChanged), self, caller{slot, callback, release});
}
...
QMetaObject* QAudioOutput_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQAudioOutput*)(self) )->QAudioOutput::metaObject();

}

void* QAudioOutput_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQAudioOutput*)(self) )->QAudioOutput::qt_metacast(param1);

}

int QAudioOutput_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQAudioOutput*)(self) )->QAudioOutput::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);

}

bool QAudioOutput_virtualbase_event(void* self, QEvent* event) {

	return ( (MiqtVirtualQAudioOutput*)(self) )->QAudioOutput::event(event);

}

bool QAudioOutput_virtualbase_eventFilter(void* self, QObject* watched, QEvent* event) {

	return ( (MiqtVirtualQAudioOutput*)(self) )->QAudioOutput::eventFilter(watched, event);

}

void QAudioOutput_virtualbase_timerEvent(void* self, QTimerEvent* event) {

	( (MiqtVirtualQAudioOutput*)(self) )->QAudioOutput::timerEvent(event);

}

void QAudioOutput_virtualbase_childEvent(void* self, QChildEvent* event) {

	( (MiqtVirtualQAudioOutput*)(self) )->QAudioOutput::childEvent(event);

}

void QAudioOutput_virtualbase_customEvent(void* self, QEvent* event) {

	( (MiqtVirtualQAudioOutput*)(self) )->QAudioOutput::customEvent(event);

}

void QAudioOutput_virtualbase_connectNotify(void* self, QMetaMethod* signal) {

	( (MiqtVirtualQAudioOutput*)(self) )->QAudioOutput::connectNotify(*signal);

}

void QAudioOutput_virtualbase_disconnectNotify(void* self, QMetaMethod* signal) {

	( (MiqtVirtualQAudioOutput*)(self) )->QAudioOutput::disconnectNotify(*signal);
...
QObject* QAudioOutput_protectedbase_sender(const void* self) {
	MiqtVirtualQAudioOutput* self_cast = static_cast<MiqtVirtualQAudioOutput*>( (QAudioOutput*)(self) );
