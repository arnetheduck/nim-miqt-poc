...
func init*(T: type gen_qcameraexposure_types.QCameraExposure, h: ptr cQCameraExposure): gen_qcameraexposure_types.QCameraExposure =
  T(h: h)
proc metaObject*(self: gen_qcameraexposure_types.QCameraExposure, ): QMetaObject =
  QMetaObject(h: fcQCameraExposure_metaObject(self.h))
...
proc spotMeteringPoint*(self: gen_qcameraexposure_types.QCameraExposure, ): QPointF =
  QPointF(h: fcQCameraExposure_spotMeteringPoint(self.h))

proc setSpotMeteringPoint*(self: gen_qcameraexposure_types.QCameraExposure, point: QPointF): void =
