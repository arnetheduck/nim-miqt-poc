...
func init*(T: type gen_qimageencodercontrol_types.QImageEncoderControl, h: ptr cQImageEncoderControl): gen_qimageencodercontrol_types.QImageEncoderControl =
  T(h: h)
proc metaObject*(self: gen_qimageencodercontrol_types.QImageEncoderControl, ): QMetaObject =
  QMetaObject(h: fcQImageEncoderControl_metaObject(self.h))
...
proc supportedResolutions*(self: gen_qimageencodercontrol_types.QImageEncoderControl, settings: QImageEncoderSettings, continuous: ptr bool): seq[QSize] =
...
proc imageSettings*(self: gen_qimageencodercontrol_types.QImageEncoderControl, ): QImageEncoderSettings =
  QImageEncoderSettings(h: fcQImageEncoderControl_imageSettings(self.h))

proc setImageSettings*(self: gen_qimageencodercontrol_types.QImageEncoderControl, settings: QImageEncoderSettings): void =
