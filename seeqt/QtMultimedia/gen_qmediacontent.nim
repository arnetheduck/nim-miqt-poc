...
proc fcQMediaContent_new3(contentRequest: ptr cQNetworkRequest): ptr cQMediaContent {.importc: "QMediaContent_new3".}
...
proc fcQMediaContent_request(self: pointer, ): cQNetworkRequest {.importc: "QMediaContent_request".}
proc fcQMediaContent_canonicalUrl(self: pointer, ): pointer {.importc: "QMediaContent_canonicalUrl".}
proc fcQMediaContent_canonicalRequest(self: pointer, ): cQNetworkRequest {.importc: "QMediaContent_canonicalRequest".}
...
proc create*(T: type gen_qmediacontent_types.QMediaContent, contentUrl: QUrl): gen_qmediacontent_types.QMediaContent =
  gen_qmediacontent_types.QMediaContent.init(fcQMediaContent_new2(contentUrl.h))

proc create*(T: type gen_qmediacontent_types.QMediaContent, contentRequest: ptr QNetworkRequest): gen_qmediacontent_types.QMediaContent =
  gen_qmediacontent_types.QMediaContent.init(fcQMediaContent_new3(contentRequest))

proc create*(T: type gen_qmediacontent_types.QMediaContent, contentResource: QMediaResource): gen_qmediacontent_types.QMediaContent =
  gen_qmediacontent_types.QMediaContent.init(fcQMediaContent_new4(contentResource.h))

proc create*(T: type gen_qmediacontent_types.QMediaContent, resources: seq[QMediaResource]): gen_qmediacontent_types.QMediaContent =
...
proc create*(T: type gen_qmediacontent_types.QMediaContent, other: QMediaContent): gen_qmediacontent_types.QMediaContent =
  gen_qmediacontent_types.QMediaContent.init(fcQMediaContent_new6(other.h))

proc create*(T: type gen_qmediacontent_types.QMediaContent, playlist: QMediaPlaylist): gen_qmediacontent_types.QMediaContent =
  gen_qmediacontent_types.QMediaContent.init(fcQMediaContent_new7(playlist.h))

proc create*(T: type gen_qmediacontent_types.QMediaContent, playlist: QMediaPlaylist, contentUrl: QUrl): gen_qmediacontent_types.QMediaContent =
  gen_qmediacontent_types.QMediaContent.init(fcQMediaContent_new8(playlist.h, contentUrl.h))

proc create*(T: type gen_qmediacontent_types.QMediaContent, playlist: QMediaPlaylist, contentUrl: QUrl, takeOwnership: bool): gen_qmediacontent_types.QMediaContent =
  gen_qmediacontent_types.QMediaContent.init(fcQMediaContent_new9(playlist.h, contentUrl.h, takeOwnership))

proc operatorAssign*(self: gen_qmediacontent_types.QMediaContent, other: QMediaContent): void =
  fcQMediaContent_operatorAssign(self.h, other.h)

proc operatorEqual*(self: gen_qmediacontent_types.QMediaContent, other: QMediaContent): bool =
  fcQMediaContent_operatorEqual(self.h, other.h)

proc operatorNotEqual*(self: gen_qmediacontent_types.QMediaContent, other: QMediaContent): bool =
...
proc request*(self: gen_qmediacontent_types.QMediaContent, ): QNetworkRequest =
TODO QNetworkRequest
proc canonicalUrl*(self: gen_qmediacontent_types.QMediaContent, ): QUrl =
  QUrl(h: fcQMediaContent_canonicalUrl(self.h))

proc canonicalRequest*(self: gen_qmediacontent_types.QMediaContent, ): QNetworkRequest =
TODO QNetworkRequest
proc canonicalResource*(self: gen_qmediacontent_types.QMediaContent, ): QMediaResource =
  QMediaResource(h: fcQMediaContent_canonicalResource(self.h))

proc resources*(self: gen_qmediacontent_types.QMediaContent, ): seq[QMediaResource] =
  var v_ma = fcQMediaContent_resources(self.h)
  var vx_ret = newSeq[QMediaResource](int(v_ma.len))
  let v_outCast = cast[ptr UncheckedArray[pointer]](v_ma.data)
  for i in 0 ..< v_ma.len:
    vx_ret[i] = QMediaResource(h: v_outCast[i])
  vx_ret

proc playlist*(self: gen_qmediacontent_types.QMediaContent, ): QMediaPlaylist =
  QMediaPlaylist(h: fcQMediaContent_playlist(self.h))
