...
proc create*(T: type gen_qmediacontent_types.QMediaContent,
    contentRequest: ptr QNetworkRequest): gen_qmediacontent_types.QMediaContent =
  gen_qmediacontent_types.QMediaContent(h: fcQMediaContent_new3(contentRequest), owned: true)
