...
func init*(T: type gen_qaudiosystem_types.QAbstractAudioDeviceInfo, h: ptr cQAbstractAudioDeviceInfo): gen_qaudiosystem_types.QAbstractAudioDeviceInfo =
  T(h: h)
proc metaObject*(self: gen_qaudiosystem_types.QAbstractAudioDeviceInfo, ): QMetaObject =
  QMetaObject(h: fcQAbstractAudioDeviceInfo_metaObject(self.h))
...
proc preferredFormat*(self: gen_qaudiosystem_types.QAbstractAudioDeviceInfo, ): QAudioFormat =
  QAudioFormat(h: fcQAbstractAudioDeviceInfo_preferredFormat(self.h))

proc isFormatSupported*(self: gen_qaudiosystem_types.QAbstractAudioDeviceInfo, format: QAudioFormat): bool =
...
func init*(T: type gen_qaudiosystem_types.QAbstractAudioOutput, h: ptr cQAbstractAudioOutput): gen_qaudiosystem_types.QAbstractAudioOutput =
  T(h: h)
proc metaObject*(self: gen_qaudiosystem_types.QAbstractAudioOutput, ): QMetaObject =
  QMetaObject(h: fcQAbstractAudioOutput_metaObject(self.h))
...
proc start*(self: gen_qaudiosystem_types.QAbstractAudioOutput, device: QIODevice): void =
  fcQAbstractAudioOutput_start(self.h, device.h)

proc start*(self: gen_qaudiosystem_types.QAbstractAudioOutput, ): QIODevice =
  QIODevice(h: fcQAbstractAudioOutput_start2(self.h))
...
proc setFormat*(self: gen_qaudiosystem_types.QAbstractAudioOutput, fmt: QAudioFormat): void =
  fcQAbstractAudioOutput_setFormat(self.h, fmt.h)

proc format*(self: gen_qaudiosystem_types.QAbstractAudioOutput, ): QAudioFormat =
  QAudioFormat(h: fcQAbstractAudioOutput_format(self.h))
...
func init*(T: type gen_qaudiosystem_types.QAbstractAudioInput, h: ptr cQAbstractAudioInput): gen_qaudiosystem_types.QAbstractAudioInput =
  T(h: h)
proc metaObject*(self: gen_qaudiosystem_types.QAbstractAudioInput, ): QMetaObject =
  QMetaObject(h: fcQAbstractAudioInput_metaObject(self.h))
...
proc start*(self: gen_qaudiosystem_types.QAbstractAudioInput, device: QIODevice): void =
  fcQAbstractAudioInput_start(self.h, device.h)

proc start*(self: gen_qaudiosystem_types.QAbstractAudioInput, ): QIODevice =
  QIODevice(h: fcQAbstractAudioInput_start2(self.h))
...
proc setFormat*(self: gen_qaudiosystem_types.QAbstractAudioInput, fmt: QAudioFormat): void =
  fcQAbstractAudioInput_setFormat(self.h, fmt.h)

proc format*(self: gen_qaudiosystem_types.QAbstractAudioInput, ): QAudioFormat =
  QAudioFormat(h: fcQAbstractAudioInput_format(self.h))
