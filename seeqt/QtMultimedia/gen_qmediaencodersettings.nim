...
proc create*(T: type gen_qmediaencodersettings_types.QAudioEncoderSettings, other: QAudioEncoderSettings): gen_qmediaencodersettings_types.QAudioEncoderSettings =
  gen_qmediaencodersettings_types.QAudioEncoderSettings.init(fcQAudioEncoderSettings_new2(other.h))

proc operatorAssign*(self: gen_qmediaencodersettings_types.QAudioEncoderSettings, other: QAudioEncoderSettings): void =
  fcQAudioEncoderSettings_operatorAssign(self.h, other.h)

proc operatorEqual*(self: gen_qmediaencodersettings_types.QAudioEncoderSettings, other: QAudioEncoderSettings): bool =
  fcQAudioEncoderSettings_operatorEqual(self.h, other.h)

proc operatorNotEqual*(self: gen_qmediaencodersettings_types.QAudioEncoderSettings, other: QAudioEncoderSettings): bool =
...
proc encodingOption*(self: gen_qmediaencodersettings_types.QAudioEncoderSettings, option: string): QVariant =
  QVariant(h: fcQAudioEncoderSettings_encodingOption(self.h, struct_miqt_string(data: option, len: csize_t(len(option)))))

proc encodingOptions*(self: gen_qmediaencodersettings_types.QAudioEncoderSettings, ): Table[string,QVariant] =
...
proc setEncodingOption*(self: gen_qmediaencodersettings_types.QAudioEncoderSettings, option: string, value: QVariant): void =
  fcQAudioEncoderSettings_setEncodingOption(self.h, struct_miqt_string(data: option, len: csize_t(len(option))), value.h)

proc setEncodingOptions*(self: gen_qmediaencodersettings_types.QAudioEncoderSettings, options: Table[string,QVariant]): void =
...
proc delete*(self: gen_qmediaencodersettings_types.QAudioEncoderSettings) =
...
proc create*(T: type gen_qmediaencodersettings_types.QVideoEncoderSettings, other: QVideoEncoderSettings): gen_qmediaencodersettings_types.QVideoEncoderSettings =
  gen_qmediaencodersettings_types.QVideoEncoderSettings.init(fcQVideoEncoderSettings_new2(other.h))

proc operatorAssign*(self: gen_qmediaencodersettings_types.QVideoEncoderSettings, other: QVideoEncoderSettings): void =
  fcQVideoEncoderSettings_operatorAssign(self.h, other.h)

proc operatorEqual*(self: gen_qmediaencodersettings_types.QVideoEncoderSettings, other: QVideoEncoderSettings): bool =
  fcQVideoEncoderSettings_operatorEqual(self.h, other.h)

proc operatorNotEqual*(self: gen_qmediaencodersettings_types.QVideoEncoderSettings, other: QVideoEncoderSettings): bool =
...
proc resolution*(self: gen_qmediaencodersettings_types.QVideoEncoderSettings, ): QSize =
  QSize(h: fcQVideoEncoderSettings_resolution(self.h))

proc setResolution*(self: gen_qmediaencodersettings_types.QVideoEncoderSettings, resolution: QSize): void =
...
proc encodingOption*(self: gen_qmediaencodersettings_types.QVideoEncoderSettings, option: string): QVariant =
  QVariant(h: fcQVideoEncoderSettings_encodingOption(self.h, struct_miqt_string(data: option, len: csize_t(len(option)))))

proc encodingOptions*(self: gen_qmediaencodersettings_types.QVideoEncoderSettings, ): Table[string,QVariant] =
...
proc setEncodingOption*(self: gen_qmediaencodersettings_types.QVideoEncoderSettings, option: string, value: QVariant): void =
  fcQVideoEncoderSettings_setEncodingOption(self.h, struct_miqt_string(data: option, len: csize_t(len(option))), value.h)

proc setEncodingOptions*(self: gen_qmediaencodersettings_types.QVideoEncoderSettings, options: Table[string,QVariant]): void =
  var options_Keys_CArray = newSeq[struct_miqt_string](len(options))
  var options_Values_CArray = newSeq[pointer](len(options))
  var options_ctr = 0
  for optionsk, optionsv in options:
...
proc delete*(self: gen_qmediaencodersettings_types.QVideoEncoderSettings) =
...
proc create*(T: type gen_qmediaencodersettings_types.QImageEncoderSettings, other: QImageEncoderSettings): gen_qmediaencodersettings_types.QImageEncoderSettings =
  gen_qmediaencodersettings_types.QImageEncoderSettings.init(fcQImageEncoderSettings_new2(other.h))

proc operatorAssign*(self: gen_qmediaencodersettings_types.QImageEncoderSettings, other: QImageEncoderSettings): void =
  fcQImageEncoderSettings_operatorAssign(self.h, other.h)

proc operatorEqual*(self: gen_qmediaencodersettings_types.QImageEncoderSettings, other: QImageEncoderSettings): bool =
  fcQImageEncoderSettings_operatorEqual(self.h, other.h)

proc operatorNotEqual*(self: gen_qmediaencodersettings_types.QImageEncoderSettings, other: QImageEncoderSettings): bool =
...
proc resolution*(self: gen_qmediaencodersettings_types.QImageEncoderSettings, ): QSize =
  QSize(h: fcQImageEncoderSettings_resolution(self.h))

proc setResolution*(self: gen_qmediaencodersettings_types.QImageEncoderSettings, resolution: QSize): void =
...
proc encodingOption*(self: gen_qmediaencodersettings_types.QImageEncoderSettings, option: string): QVariant =
  QVariant(h: fcQImageEncoderSettings_encodingOption(self.h, struct_miqt_string(data: option, len: csize_t(len(option)))))

proc encodingOptions*(self: gen_qmediaencodersettings_types.QImageEncoderSettings, ): Table[string,QVariant] =
...
proc setEncodingOption*(self: gen_qmediaencodersettings_types.QImageEncoderSettings, option: string, value: QVariant): void =
  fcQImageEncoderSettings_setEncodingOption(self.h, struct_miqt_string(data: option, len: csize_t(len(option))), value.h)

proc setEncodingOptions*(self: gen_qmediaencodersettings_types.QImageEncoderSettings, options: Table[string,QVariant]): void =
  var options_Keys_CArray = newSeq[struct_miqt_string](len(options))
  var options_Values_CArray = newSeq[pointer](len(options))
  var options_ctr = 0
  for optionsk, optionsv in options:
...
proc delete*(self: gen_qmediaencodersettings_types.QImageEncoderSettings) =
