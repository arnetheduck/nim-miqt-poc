...
func init*(T: type gen_qcameraimagecapture_types.QCameraImageCapture, h: ptr cQCameraImageCapture): gen_qcameraimagecapture_types.QCameraImageCapture =
  T(h: h)
proc create*(T: type gen_qcameraimagecapture_types.QCameraImageCapture, mediaObject: QMediaObject): gen_qcameraimagecapture_types.QCameraImageCapture =
  gen_qcameraimagecapture_types.QCameraImageCapture.init(fcQCameraImageCapture_new(mediaObject.h))

proc create*(T: type gen_qcameraimagecapture_types.QCameraImageCapture, mediaObject: QMediaObject, parent: QObject): gen_qcameraimagecapture_types.QCameraImageCapture =
  gen_qcameraimagecapture_types.QCameraImageCapture.init(fcQCameraImageCapture_new2(mediaObject.h, parent.h))

proc metaObject*(self: gen_qcameraimagecapture_types.QCameraImageCapture, ): QMetaObject =
  QMetaObject(h: fcQCameraImageCapture_metaObject(self.h))
...
proc mediaObject*(self: gen_qcameraimagecapture_types.QCameraImageCapture, ): QMediaObject =
  QMediaObject(h: fcQCameraImageCapture_mediaObject(self.h))
...
proc supportedResolutions*(self: gen_qcameraimagecapture_types.QCameraImageCapture, ): seq[QSize] =
...
proc encodingSettings*(self: gen_qcameraimagecapture_types.QCameraImageCapture, ): QImageEncoderSettings =
  QImageEncoderSettings(h: fcQCameraImageCapture_encodingSettings(self.h))

proc setEncodingSettings*(self: gen_qcameraimagecapture_types.QCameraImageCapture, settings: QImageEncoderSettings): void =
...
proc imageCaptured*(self: gen_qcameraimagecapture_types.QCameraImageCapture, id: cint, preview: QImage): void =
  fcQCameraImageCapture_imageCaptured(self.h, id, preview.h)

type QCameraImageCaptureimageCapturedSlot* = proc(id: cint, preview: QImage)
...
proc imageMetadataAvailable*(self: gen_qcameraimagecapture_types.QCameraImageCapture, id: cint, key: string, value: QVariant): void =
  fcQCameraImageCapture_imageMetadataAvailable(self.h, id, struct_miqt_string(data: key, len: csize_t(len(key))), value.h)

type QCameraImageCaptureimageMetadataAvailableSlot* = proc(id: cint, key: string, value: QVariant)
...
proc imageAvailable*(self: gen_qcameraimagecapture_types.QCameraImageCapture, id: cint, frame: QVideoFrame): void =
  fcQCameraImageCapture_imageAvailable(self.h, id, frame.h)

type QCameraImageCaptureimageAvailableSlot* = proc(id: cint, frame: QVideoFrame)
proc miqt_exec_callback_QCameraImageCapture_imageAvailable(slot: int, id: cint, frame: pointer) {.exportc.} =
  ...
  let slotval2 = QVideoFrame(h: frame)
...
proc supportedResolutions*(self: gen_qcameraimagecapture_types.QCameraImageCapture, settings: QImageEncoderSettings): seq[QSize] =
...
proc supportedResolutions*(self: gen_qcameraimagecapture_types.QCameraImageCapture, settings: QImageEncoderSettings, continuous: ptr bool): seq[QSize] =
...
proc miqt_exec_callback_QCameraImageCapture_metacall(self: ptr cQCameraImageCapture, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QCameraImageCapture_metacall ".} =
  ...
  virtualReturn
proc QCameraImageCapturemediaObject*(self: gen_qcameraimagecapture_types.QCameraImageCapture, ): QMediaObject =
  QMediaObject(h: fQCameraImageCapture_virtualbase_mediaObject(self.h))

type QCameraImageCapturemediaObjectProc* = proc(): QMediaObject
...
proc miqt_exec_callback_QCameraImageCapture_mediaObject(self: ptr cQCameraImageCapture, slot: int): pointer {.exportc: "miqt_exec_callback_QCameraImageCapture_mediaObject ".} =
  ...
  virtualReturn.h
proc QCameraImageCapturesetMediaObject*(self: gen_qcameraimagecapture_types.QCameraImageCapture, mediaObject: QMediaObject): bool =
  fQCameraImageCapture_virtualbase_setMediaObject(self.h, mediaObject.h)

type QCameraImageCapturesetMediaObjectProc* = proc(mediaObject: QMediaObject): bool
...
proc miqt_exec_callback_QCameraImageCapture_setMediaObject(self: ptr cQCameraImageCapture, slot: int, mediaObject: pointer): bool {.exportc: "miqt_exec_callback_QCameraImageCapture_setMediaObject ".} =
  ...
  let slotval1 = QMediaObject(h: mediaObject)


  let virtualReturn = nimfunc[](slotval1 )

  virtualReturn
proc QCameraImageCaptureevent*(self: gen_qcameraimagecapture_types.QCameraImageCapture, event: QEvent): bool =
  fQCameraImageCapture_virtualbase_event(self.h, event.h)

type QCameraImageCaptureeventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QCameraImageCapture_event(self: ptr cQCameraImageCapture, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QCameraImageCapture_event ".} =
  ...
  virtualReturn
proc QCameraImageCaptureeventFilter*(self: gen_qcameraimagecapture_types.QCameraImageCapture, watched: QObject, event: QEvent): bool =
  fQCameraImageCapture_virtualbase_eventFilter(self.h, watched.h, event.h)

type QCameraImageCaptureeventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QCameraImageCapture_eventFilter(self: ptr cQCameraImageCapture, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QCameraImageCapture_eventFilter ".} =
  ...
  virtualReturn
proc QCameraImageCapturetimerEvent*(self: gen_qcameraimagecapture_types.QCameraImageCapture, event: QTimerEvent): void =
  fQCameraImageCapture_virtualbase_timerEvent(self.h, event.h)

type QCameraImageCapturetimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QCameraImageCapture_timerEvent(self: ptr cQCameraImageCapture, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QCameraImageCapture_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QCameraImageCapturechildEvent*(self: gen_qcameraimagecapture_types.QCameraImageCapture, event: QChildEvent): void =
  fQCameraImageCapture_virtualbase_childEvent(self.h, event.h)

type QCameraImageCapturechildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QCameraImageCapture_childEvent(self: ptr cQCameraImageCapture, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QCameraImageCapture_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QCameraImageCapturecustomEvent*(self: gen_qcameraimagecapture_types.QCameraImageCapture, event: QEvent): void =
  fQCameraImageCapture_virtualbase_customEvent(self.h, event.h)

type QCameraImageCapturecustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QCameraImageCapture_customEvent(self: ptr cQCameraImageCapture, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QCameraImageCapture_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QCameraImageCaptureconnectNotify*(self: gen_qcameraimagecapture_types.QCameraImageCapture, signal: QMetaMethod): void =
  fQCameraImageCapture_virtualbase_connectNotify(self.h, signal.h)

type QCameraImageCaptureconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QCameraImageCapture_connectNotify(self: ptr cQCameraImageCapture, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QCameraImageCapture_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QCameraImageCapturedisconnectNotify*(self: gen_qcameraimagecapture_types.QCameraImageCapture, signal: QMetaMethod): void =
  fQCameraImageCapture_virtualbase_disconnectNotify(self.h, signal.h)

type QCameraImageCapturedisconnectNotifyProc* = proc(signal: QMetaMethod): void
