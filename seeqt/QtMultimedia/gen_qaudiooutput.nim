...
proc create*(T: type gen_qaudiooutput_types.QAudioOutput, audioDeviceInfo: QAudioDeviceInfo): gen_qaudiooutput_types.QAudioOutput =
  gen_qaudiooutput_types.QAudioOutput.init(fcQAudioOutput_new2(audioDeviceInfo.h))

proc create*(T: type gen_qaudiooutput_types.QAudioOutput, format: QAudioFormat): gen_qaudiooutput_types.QAudioOutput =
  gen_qaudiooutput_types.QAudioOutput.init(fcQAudioOutput_new3(format.h))

proc create*(T: type gen_qaudiooutput_types.QAudioOutput, format: QAudioFormat, parent: QObject): gen_qaudiooutput_types.QAudioOutput =
  gen_qaudiooutput_types.QAudioOutput.init(fcQAudioOutput_new4(format.h, parent.h))

proc create*(T: type gen_qaudiooutput_types.QAudioOutput, audioDeviceInfo: QAudioDeviceInfo, format: QAudioFormat): gen_qaudiooutput_types.QAudioOutput =
  gen_qaudiooutput_types.QAudioOutput.init(fcQAudioOutput_new5(audioDeviceInfo.h, format.h))

proc create*(T: type gen_qaudiooutput_types.QAudioOutput, audioDeviceInfo: QAudioDeviceInfo, format: QAudioFormat, parent: QObject): gen_qaudiooutput_types.QAudioOutput =
  gen_qaudiooutput_types.QAudioOutput.init(fcQAudioOutput_new6(audioDeviceInfo.h, format.h, parent.h))

proc metaObject*(self: gen_qaudiooutput_types.QAudioOutput, ): QMetaObject =
  QMetaObject(h: fcQAudioOutput_metaObject(self.h))
...
proc format*(self: gen_qaudiooutput_types.QAudioOutput, ): QAudioFormat =
  QAudioFormat(h: fcQAudioOutput_format(self.h))

proc start*(self: gen_qaudiooutput_types.QAudioOutput, device: QIODevice): void =
  fcQAudioOutput_start(self.h, device.h)

proc start*(self: gen_qaudiooutput_types.QAudioOutput, ): QIODevice =
  QIODevice(h: fcQAudioOutput_start2(self.h))
...
proc miqt_exec_callback_QAudioOutput_metacall(self: ptr cQAudioOutput, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QAudioOutput_metacall ".} =
  ...
  virtualReturn
proc QAudioOutputevent*(self: gen_qaudiooutput_types.QAudioOutput, event: QEvent): bool =
  fQAudioOutput_virtualbase_event(self.h, event.h)

type QAudioOutputeventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QAudioOutput_event(self: ptr cQAudioOutput, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QAudioOutput_event ".} =
  ...
  virtualReturn
proc QAudioOutputeventFilter*(self: gen_qaudiooutput_types.QAudioOutput, watched: QObject, event: QEvent): bool =
  fQAudioOutput_virtualbase_eventFilter(self.h, watched.h, event.h)

type QAudioOutputeventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QAudioOutput_eventFilter(self: ptr cQAudioOutput, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QAudioOutput_eventFilter ".} =
  ...
  virtualReturn
proc QAudioOutputtimerEvent*(self: gen_qaudiooutput_types.QAudioOutput, event: QTimerEvent): void =
  fQAudioOutput_virtualbase_timerEvent(self.h, event.h)

type QAudioOutputtimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QAudioOutput_timerEvent(self: ptr cQAudioOutput, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QAudioOutput_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QAudioOutputchildEvent*(self: gen_qaudiooutput_types.QAudioOutput, event: QChildEvent): void =
  fQAudioOutput_virtualbase_childEvent(self.h, event.h)

type QAudioOutputchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QAudioOutput_childEvent(self: ptr cQAudioOutput, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QAudioOutput_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QAudioOutputcustomEvent*(self: gen_qaudiooutput_types.QAudioOutput, event: QEvent): void =
  fQAudioOutput_virtualbase_customEvent(self.h, event.h)

type QAudioOutputcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QAudioOutput_customEvent(self: ptr cQAudioOutput, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QAudioOutput_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QAudioOutputconnectNotify*(self: gen_qaudiooutput_types.QAudioOutput, signal: QMetaMethod): void =
  fQAudioOutput_virtualbase_connectNotify(self.h, signal.h)

type QAudioOutputconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QAudioOutput_connectNotify(self: ptr cQAudioOutput, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QAudioOutput_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QAudioOutputdisconnectNotify*(self: gen_qaudiooutput_types.QAudioOutput, signal: QMetaMethod): void =
  fQAudioOutput_virtualbase_disconnectNotify(self.h, signal.h)

type QAudioOutputdisconnectNotifyProc* = proc(signal: QMetaMethod): void
