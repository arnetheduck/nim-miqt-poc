...
proc create*(T: type gen_qaudiooutput_types.QAudioOutput, device: QAudioDevice): gen_qaudiooutput_types.QAudioOutput =
  gen_qaudiooutput_types.QAudioOutput.init(fcQAudioOutput_new2(device.h))

proc create*(T: type gen_qaudiooutput_types.QAudioOutput, parent: QObject): gen_qaudiooutput_types.QAudioOutput =
  gen_qaudiooutput_types.QAudioOutput.init(fcQAudioOutput_new3(parent.h))

proc create*(T: type gen_qaudiooutput_types.QAudioOutput, device: QAudioDevice, parent: QObject): gen_qaudiooutput_types.QAudioOutput =
...
proc device*(self: gen_qaudiooutput_types.QAudioOutput, ): QAudioDevice =
  QAudioDevice(h: fcQAudioOutput_device(self.h))
...
proc setDevice*(self: gen_qaudiooutput_types.QAudioOutput, device: QAudioDevice): void =
