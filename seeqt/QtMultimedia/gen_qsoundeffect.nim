...
proc create*(T: type gen_qsoundeffect_types.QSoundEffect, audioDevice: QAudioDeviceInfo): gen_qsoundeffect_types.QSoundEffect =
...
proc create*(T: type gen_qsoundeffect_types.QSoundEffect, audioDevice: QAudioDeviceInfo, parent: QObject): gen_qsoundeffect_types.QSoundEffect =
