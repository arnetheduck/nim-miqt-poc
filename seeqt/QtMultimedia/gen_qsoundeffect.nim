...
proc create*(T: type gen_qsoundeffect_types.QSoundEffect, audioDevice: QAudioDevice): gen_qsoundeffect_types.QSoundEffect =
  gen_qsoundeffect_types.QSoundEffect.init(fcQSoundEffect_new2(audioDevice.h))

proc create*(T: type gen_qsoundeffect_types.QSoundEffect, parent: QObject): gen_qsoundeffect_types.QSoundEffect =
  gen_qsoundeffect_types.QSoundEffect.init(fcQSoundEffect_new3(parent.h))

proc create*(T: type gen_qsoundeffect_types.QSoundEffect, audioDevice: QAudioDevice, parent: QObject): gen_qsoundeffect_types.QSoundEffect =
  gen_qsoundeffect_types.QSoundEffect.init(fcQSoundEffect_new4(audioDevice.h, parent.h))

proc metaObject*(self: gen_qsoundeffect_types.QSoundEffect, ): QMetaObject =
  QMetaObject(h: fcQSoundEffect_metaObject(self.h))
...
proc source*(self: gen_qsoundeffect_types.QSoundEffect, ): QUrl =
  QUrl(h: fcQSoundEffect_source(self.h))

proc setSource*(self: gen_qsoundeffect_types.QSoundEffect, url: QUrl): void =
...
proc audioDevice*(self: gen_qsoundeffect_types.QSoundEffect, ): QAudioDevice =
  QAudioDevice(h: fcQSoundEffect_audioDevice(self.h))

proc setAudioDevice*(self: gen_qsoundeffect_types.QSoundEffect, device: QAudioDevice): void =
...
proc miqt_exec_callback_QSoundEffect_metacall(self: ptr cQSoundEffect, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QSoundEffect_metacall ".} =
  ...
  virtualReturn
proc QSoundEffectevent*(self: gen_qsoundeffect_types.QSoundEffect, event: QEvent): bool =
  fQSoundEffect_virtualbase_event(self.h, event.h)

type QSoundEffecteventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QSoundEffect_event(self: ptr cQSoundEffect, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QSoundEffect_event ".} =
  ...
  virtualReturn
proc QSoundEffecteventFilter*(self: gen_qsoundeffect_types.QSoundEffect, watched: QObject, event: QEvent): bool =
  fQSoundEffect_virtualbase_eventFilter(self.h, watched.h, event.h)

type QSoundEffecteventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QSoundEffect_eventFilter(self: ptr cQSoundEffect, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QSoundEffect_eventFilter ".} =
  ...
  virtualReturn
proc QSoundEffecttimerEvent*(self: gen_qsoundeffect_types.QSoundEffect, event: QTimerEvent): void =
  fQSoundEffect_virtualbase_timerEvent(self.h, event.h)

type QSoundEffecttimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QSoundEffect_timerEvent(self: ptr cQSoundEffect, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QSoundEffect_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QSoundEffectchildEvent*(self: gen_qsoundeffect_types.QSoundEffect, event: QChildEvent): void =
  fQSoundEffect_virtualbase_childEvent(self.h, event.h)

type QSoundEffectchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QSoundEffect_childEvent(self: ptr cQSoundEffect, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QSoundEffect_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QSoundEffectcustomEvent*(self: gen_qsoundeffect_types.QSoundEffect, event: QEvent): void =
  fQSoundEffect_virtualbase_customEvent(self.h, event.h)

type QSoundEffectcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QSoundEffect_customEvent(self: ptr cQSoundEffect, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QSoundEffect_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QSoundEffectconnectNotify*(self: gen_qsoundeffect_types.QSoundEffect, signal: QMetaMethod): void =
  fQSoundEffect_virtualbase_connectNotify(self.h, signal.h)

type QSoundEffectconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QSoundEffect_connectNotify(self: ptr cQSoundEffect, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QSoundEffect_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QSoundEffectdisconnectNotify*(self: gen_qsoundeffect_types.QSoundEffect, signal: QMetaMethod): void =
  fQSoundEffect_virtualbase_disconnectNotify(self.h, signal.h)

type QSoundEffectdisconnectNotifyProc* = proc(signal: QMetaMethod): void
