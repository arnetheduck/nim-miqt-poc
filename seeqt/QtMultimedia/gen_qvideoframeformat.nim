...
proc create*(T: type gen_qvideoframeformat_types.QVideoFrameFormat, size: QSize, pixelFormat: cint): gen_qvideoframeformat_types.QVideoFrameFormat =
  gen_qvideoframeformat_types.QVideoFrameFormat.init(fcQVideoFrameFormat_new2(size.h, cint(pixelFormat)))

proc create*(T: type gen_qvideoframeformat_types.QVideoFrameFormat, format: QVideoFrameFormat): gen_qvideoframeformat_types.QVideoFrameFormat =
  gen_qvideoframeformat_types.QVideoFrameFormat.init(fcQVideoFrameFormat_new3(format.h))

proc swap*(self: gen_qvideoframeformat_types.QVideoFrameFormat, other: QVideoFrameFormat): void =
...
proc operatorAssign*(self: gen_qvideoframeformat_types.QVideoFrameFormat, format: QVideoFrameFormat): void =
  fcQVideoFrameFormat_operatorAssign(self.h, format.h)

proc operatorEqual*(self: gen_qvideoframeformat_types.QVideoFrameFormat, format: QVideoFrameFormat): bool =
  fcQVideoFrameFormat_operatorEqual(self.h, format.h)

proc operatorNotEqual*(self: gen_qvideoframeformat_types.QVideoFrameFormat, format: QVideoFrameFormat): bool =
...
proc frameSize*(self: gen_qvideoframeformat_types.QVideoFrameFormat, ): QSize =
  QSize(h: fcQVideoFrameFormat_frameSize(self.h))

proc setFrameSize*(self: gen_qvideoframeformat_types.QVideoFrameFormat, size: QSize): void =
...
proc viewport*(self: gen_qvideoframeformat_types.QVideoFrameFormat, ): QRect =
  QRect(h: fcQVideoFrameFormat_viewport(self.h))

proc setViewport*(self: gen_qvideoframeformat_types.QVideoFrameFormat, viewport: QRect): void =
