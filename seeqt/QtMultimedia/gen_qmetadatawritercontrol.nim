...
func init*(T: type gen_qmetadatawritercontrol_types.QMetaDataWriterControl, h: ptr cQMetaDataWriterControl): gen_qmetadatawritercontrol_types.QMetaDataWriterControl =
  T(h: h)
proc metaObject*(self: gen_qmetadatawritercontrol_types.QMetaDataWriterControl, ): QMetaObject =
  QMetaObject(h: fcQMetaDataWriterControl_metaObject(self.h))
...
proc metaData*(self: gen_qmetadatawritercontrol_types.QMetaDataWriterControl, key: string): QVariant =
  QVariant(h: fcQMetaDataWriterControl_metaData(self.h, struct_miqt_string(data: key, len: csize_t(len(key)))))

proc setMetaData*(self: gen_qmetadatawritercontrol_types.QMetaDataWriterControl, key: string, value: QVariant): void =
...
proc metaDataChanged*(self: gen_qmetadatawritercontrol_types.QMetaDataWriterControl, key: string, value: QVariant): void =
  fcQMetaDataWriterControl_metaDataChanged2(self.h, struct_miqt_string(data: key, len: csize_t(len(key))), value.h)

type QMetaDataWriterControlmetaDataChanged2Slot* = proc(key: string, value: QVariant)
