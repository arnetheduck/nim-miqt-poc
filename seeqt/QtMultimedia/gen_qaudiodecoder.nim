...
proc source*(self: gen_qaudiodecoder_types.QAudioDecoder, ): QUrl =
  QUrl(h: fcQAudioDecoder_source(self.h))

proc setSource*(self: gen_qaudiodecoder_types.QAudioDecoder, fileName: QUrl): void =
