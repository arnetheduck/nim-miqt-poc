...
proc create*(T: type gen_qaudiodecoder_types.QAudioDecoder, parent: QObject): gen_qaudiodecoder_types.QAudioDecoder =
  gen_qaudiodecoder_types.QAudioDecoder.init(fcQAudioDecoder_new2(parent.h))

proc metaObject*(self: gen_qaudiodecoder_types.QAudioDecoder, ): QMetaObject =
  QMetaObject(h: fcQAudioDecoder_metaObject(self.h))
...
proc sourceDevice*(self: gen_qaudiodecoder_types.QAudioDecoder, ): QIODevice =
  QIODevice(h: fcQAudioDecoder_sourceDevice(self.h))

proc setSourceDevice*(self: gen_qaudiodecoder_types.QAudioDecoder, device: QIODevice): void =
  fcQAudioDecoder_setSourceDevice(self.h, device.h)

proc audioFormat*(self: gen_qaudiodecoder_types.QAudioDecoder, ): QAudioFormat =
  QAudioFormat(h: fcQAudioDecoder_audioFormat(self.h))

proc setAudioFormat*(self: gen_qaudiodecoder_types.QAudioDecoder, format: QAudioFormat): void =
...
proc read*(self: gen_qaudiodecoder_types.QAudioDecoder, ): QAudioBuffer =
  QAudioBuffer(h: fcQAudioDecoder_read(self.h))
...
proc formatChanged*(self: gen_qaudiodecoder_types.QAudioDecoder, format: QAudioFormat): void =
  fcQAudioDecoder_formatChanged(self.h, format.h)

type QAudioDecoderformatChangedSlot* = proc(format: QAudioFormat)
proc miqt_exec_callback_QAudioDecoder_formatChanged(slot: int, format: pointer) {.exportc.} =
  ...
  let slotval1 = QAudioFormat(h: format)
...
proc bindX*(self: gen_qaudiodecoder_types.QAudioDecoder, param1: QObject): bool =
  fcQAudioDecoder_bindX(self.h, param1.h)

proc unbind*(self: gen_qaudiodecoder_types.QAudioDecoder, param1: QObject): void =
...
proc miqt_exec_callback_QAudioDecoder_metacall(self: ptr cQAudioDecoder, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QAudioDecoder_metacall ".} =
  ...
  virtualReturn
proc QAudioDecoderbindX*(self: gen_qaudiodecoder_types.QAudioDecoder, param1: QObject): bool =
  fQAudioDecoder_virtualbase_bind(self.h, param1.h)

type QAudioDecoderbindXProc* = proc(param1: QObject): bool
...
proc miqt_exec_callback_QAudioDecoder_bind(self: ptr cQAudioDecoder, slot: int, param1: pointer): bool {.exportc: "miqt_exec_callback_QAudioDecoder_bind ".} =
  ...
  virtualReturn
proc QAudioDecoderunbind*(self: gen_qaudiodecoder_types.QAudioDecoder, param1: QObject): void =
  fQAudioDecoder_virtualbase_unbind(self.h, param1.h)

type QAudioDecoderunbindProc* = proc(param1: QObject): void
...
proc miqt_exec_callback_QAudioDecoder_availability(self: ptr cQAudioDecoder, slot: int): cint {.exportc: "miqt_exec_callback_QAudioDecoder_availability ".} =
  ...
  cint(virtualReturn)
proc QAudioDecoderservice*(self: gen_qaudiodecoder_types.QAudioDecoder, ): QMediaService =
  QMediaService(h: fQAudioDecoder_virtualbase_service(self.h))

type QAudioDecoderserviceProc* = proc(): QMediaService
...
proc miqt_exec_callback_QAudioDecoder_service(self: ptr cQAudioDecoder, slot: int): pointer {.exportc: "miqt_exec_callback_QAudioDecoder_service ".} =
  ...
  virtualReturn.h
proc QAudioDecoderevent*(self: gen_qaudiodecoder_types.QAudioDecoder, event: QEvent): bool =
  fQAudioDecoder_virtualbase_event(self.h, event.h)

type QAudioDecodereventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QAudioDecoder_event(self: ptr cQAudioDecoder, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QAudioDecoder_event ".} =
  ...
  virtualReturn
proc QAudioDecodereventFilter*(self: gen_qaudiodecoder_types.QAudioDecoder, watched: QObject, event: QEvent): bool =
  fQAudioDecoder_virtualbase_eventFilter(self.h, watched.h, event.h)

type QAudioDecodereventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QAudioDecoder_eventFilter(self: ptr cQAudioDecoder, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QAudioDecoder_eventFilter ".} =
  ...
  virtualReturn
proc QAudioDecodertimerEvent*(self: gen_qaudiodecoder_types.QAudioDecoder, event: QTimerEvent): void =
  fQAudioDecoder_virtualbase_timerEvent(self.h, event.h)

type QAudioDecodertimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QAudioDecoder_timerEvent(self: ptr cQAudioDecoder, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QAudioDecoder_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QAudioDecoderchildEvent*(self: gen_qaudiodecoder_types.QAudioDecoder, event: QChildEvent): void =
  fQAudioDecoder_virtualbase_childEvent(self.h, event.h)

type QAudioDecoderchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QAudioDecoder_childEvent(self: ptr cQAudioDecoder, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QAudioDecoder_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QAudioDecodercustomEvent*(self: gen_qaudiodecoder_types.QAudioDecoder, event: QEvent): void =
  fQAudioDecoder_virtualbase_customEvent(self.h, event.h)

type QAudioDecodercustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QAudioDecoder_customEvent(self: ptr cQAudioDecoder, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QAudioDecoder_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QAudioDecoderconnectNotify*(self: gen_qaudiodecoder_types.QAudioDecoder, signal: QMetaMethod): void =
  fQAudioDecoder_virtualbase_connectNotify(self.h, signal.h)

type QAudioDecoderconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QAudioDecoder_connectNotify(self: ptr cQAudioDecoder, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QAudioDecoder_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QAudioDecoderdisconnectNotify*(self: gen_qaudiodecoder_types.QAudioDecoder, signal: QMetaMethod): void =
  fQAudioDecoder_virtualbase_disconnectNotify(self.h, signal.h)

type QAudioDecoderdisconnectNotifyProc* = proc(signal: QMetaMethod): void
