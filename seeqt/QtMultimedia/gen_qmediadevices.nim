...
proc create*(T: type gen_qmediadevices_types.QMediaDevices, parent: QObject): gen_qmediadevices_types.QMediaDevices =
  gen_qmediadevices_types.QMediaDevices.init(fcQMediaDevices_new2(parent.h))

proc metaObject*(self: gen_qmediadevices_types.QMediaDevices, ): QMetaObject =
  QMetaObject(h: fcQMediaDevices_metaObject(self.h))
...
proc audioInputs*(_: type gen_qmediadevices_types.QMediaDevices, ): seq[QAudioDevice] =
  var v_ma = fcQMediaDevices_audioInputs()
  var vx_ret = newSeq[QAudioDevice](int(v_ma.len))
  let v_outCast = cast[ptr UncheckedArray[pointer]](v_ma.data)
  for i in 0 ..< v_ma.len:
    vx_ret[i] = QAudioDevice(h: v_outCast[i])
  vx_ret

proc audioOutputs*(_: type gen_qmediadevices_types.QMediaDevices, ): seq[QAudioDevice] =
...
proc videoInputs*(_: type gen_qmediadevices_types.QMediaDevices, ): seq[QCameraDevice] =
  var v_ma = fcQMediaDevices_videoInputs()
  var vx_ret = newSeq[QCameraDevice](int(v_ma.len))
  let v_outCast = cast[ptr UncheckedArray[pointer]](v_ma.data)
  for i in 0 ..< v_ma.len:
    vx_ret[i] = QCameraDevice(h: v_outCast[i])
  vx_ret

proc defaultAudioInput*(_: type gen_qmediadevices_types.QMediaDevices, ): QAudioDevice =
  QAudioDevice(h: fcQMediaDevices_defaultAudioInput())

proc defaultAudioOutput*(_: type gen_qmediadevices_types.QMediaDevices, ): QAudioDevice =
  QAudioDevice(h: fcQMediaDevices_defaultAudioOutput())

proc defaultVideoInput*(_: type gen_qmediadevices_types.QMediaDevices, ): QCameraDevice =
  QCameraDevice(h: fcQMediaDevices_defaultVideoInput())
...
proc miqt_exec_callback_QMediaDevices_metacall(self: ptr cQMediaDevices, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QMediaDevices_metacall ".} =
  ...
  virtualReturn
proc QMediaDevicesevent*(self: gen_qmediadevices_types.QMediaDevices, event: QEvent): bool =
  fQMediaDevices_virtualbase_event(self.h, event.h)

type QMediaDeviceseventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QMediaDevices_event(self: ptr cQMediaDevices, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QMediaDevices_event ".} =
  ...
  virtualReturn
proc QMediaDeviceseventFilter*(self: gen_qmediadevices_types.QMediaDevices, watched: QObject, event: QEvent): bool =
  fQMediaDevices_virtualbase_eventFilter(self.h, watched.h, event.h)

type QMediaDeviceseventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QMediaDevices_eventFilter(self: ptr cQMediaDevices, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QMediaDevices_eventFilter ".} =
  ...
  virtualReturn
proc QMediaDevicestimerEvent*(self: gen_qmediadevices_types.QMediaDevices, event: QTimerEvent): void =
  fQMediaDevices_virtualbase_timerEvent(self.h, event.h)

type QMediaDevicestimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QMediaDevices_timerEvent(self: ptr cQMediaDevices, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QMediaDevices_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QMediaDeviceschildEvent*(self: gen_qmediadevices_types.QMediaDevices, event: QChildEvent): void =
  fQMediaDevices_virtualbase_childEvent(self.h, event.h)

type QMediaDeviceschildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QMediaDevices_childEvent(self: ptr cQMediaDevices, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QMediaDevices_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QMediaDevicescustomEvent*(self: gen_qmediadevices_types.QMediaDevices, event: QEvent): void =
  fQMediaDevices_virtualbase_customEvent(self.h, event.h)

type QMediaDevicescustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QMediaDevices_customEvent(self: ptr cQMediaDevices, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QMediaDevices_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QMediaDevicesconnectNotify*(self: gen_qmediadevices_types.QMediaDevices, signal: QMetaMethod): void =
  fQMediaDevices_virtualbase_connectNotify(self.h, signal.h)

type QMediaDevicesconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QMediaDevices_connectNotify(self: ptr cQMediaDevices, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QMediaDevices_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QMediaDevicesdisconnectNotify*(self: gen_qmediadevices_types.QMediaDevices, signal: QMetaMethod): void =
  fQMediaDevices_virtualbase_disconnectNotify(self.h, signal.h)

type QMediaDevicesdisconnectNotifyProc* = proc(signal: QMetaMethod): void
