...
proc create*(T: type gen_qaudioformat_types.QAudioFormat, other: QAudioFormat): gen_qaudioformat_types.QAudioFormat =
  gen_qaudioformat_types.QAudioFormat.init(fcQAudioFormat_new2(other.h))

proc operatorAssign*(self: gen_qaudioformat_types.QAudioFormat, other: QAudioFormat): void =
  fcQAudioFormat_operatorAssign(self.h, other.h)

proc operatorEqual*(self: gen_qaudioformat_types.QAudioFormat, other: QAudioFormat): bool =
  fcQAudioFormat_operatorEqual(self.h, other.h)

proc operatorNotEqual*(self: gen_qaudioformat_types.QAudioFormat, other: QAudioFormat): bool =
