...
proc create*(T: type gen_qvideosurfaceformat_types.QVideoSurfaceFormat, size: QSize, pixelFormat: cint): gen_qvideosurfaceformat_types.QVideoSurfaceFormat =
  gen_qvideosurfaceformat_types.QVideoSurfaceFormat.init(fcQVideoSurfaceFormat_new2(size.h, cint(pixelFormat)))

proc create*(T: type gen_qvideosurfaceformat_types.QVideoSurfaceFormat, format: QVideoSurfaceFormat): gen_qvideosurfaceformat_types.QVideoSurfaceFormat =
  gen_qvideosurfaceformat_types.QVideoSurfaceFormat.init(fcQVideoSurfaceFormat_new3(format.h))

proc create*(T: type gen_qvideosurfaceformat_types.QVideoSurfaceFormat, size: QSize, pixelFormat: cint, handleType: cint): gen_qvideosurfaceformat_types.QVideoSurfaceFormat =
...
proc operatorAssign*(self: gen_qvideosurfaceformat_types.QVideoSurfaceFormat, format: QVideoSurfaceFormat): void =
  fcQVideoSurfaceFormat_operatorAssign(self.h, format.h)

proc operatorEqual*(self: gen_qvideosurfaceformat_types.QVideoSurfaceFormat, format: QVideoSurfaceFormat): bool =
  fcQVideoSurfaceFormat_operatorEqual(self.h, format.h)

proc operatorNotEqual*(self: gen_qvideosurfaceformat_types.QVideoSurfaceFormat, format: QVideoSurfaceFormat): bool =
...
proc frameSize*(self: gen_qvideosurfaceformat_types.QVideoSurfaceFormat, ): QSize =
  QSize(h: fcQVideoSurfaceFormat_frameSize(self.h))

proc setFrameSize*(self: gen_qvideosurfaceformat_types.QVideoSurfaceFormat, size: QSize): void =
...
proc viewport*(self: gen_qvideosurfaceformat_types.QVideoSurfaceFormat, ): QRect =
  QRect(h: fcQVideoSurfaceFormat_viewport(self.h))

proc setViewport*(self: gen_qvideosurfaceformat_types.QVideoSurfaceFormat, viewport: QRect): void =
...
proc pixelAspectRatio*(self: gen_qvideosurfaceformat_types.QVideoSurfaceFormat, ): QSize =
  QSize(h: fcQVideoSurfaceFormat_pixelAspectRatio(self.h))

proc setPixelAspectRatio*(self: gen_qvideosurfaceformat_types.QVideoSurfaceFormat, ratio: QSize): void =
...
proc sizeHint*(self: gen_qvideosurfaceformat_types.QVideoSurfaceFormat, ): QSize =
  QSize(h: fcQVideoSurfaceFormat_sizeHint(self.h))
...
proc property*(self: gen_qvideosurfaceformat_types.QVideoSurfaceFormat, name: cstring): QVariant =
  QVariant(h: fcQVideoSurfaceFormat_property(self.h, name))

proc setProperty*(self: gen_qvideosurfaceformat_types.QVideoSurfaceFormat, name: cstring, value: QVariant): void =
