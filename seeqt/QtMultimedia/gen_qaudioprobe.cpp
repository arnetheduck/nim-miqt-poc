...
QMetaObject* QAudioProbe_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQAudioProbe*)(self) )->QAudioProbe::metaObject();

}

void* QAudioProbe_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQAudioProbe*)(self) )->QAudioProbe::qt_metacast(param1);

}

int QAudioProbe_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQAudioProbe*)(self) )->QAudioProbe::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
