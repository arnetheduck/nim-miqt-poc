...
public:
	...
	MiqtVirtualQCameraImageCapture(struct QCameraImageCapture_VTable* vtbl, QMediaObject* mediaObject): QCameraImageCapture(mediaObject), vtbl(vtbl) {};
	MiqtVirtualQCameraImageCapture(struct QCameraImageCapture_VTable* vtbl, QMediaObject* mediaObject, QObject* parent): QCameraImageCapture(mediaObject, parent), vtbl(vtbl) {};

	virtual ~MiqtVirtualQCameraImageCapture() override { if(vtbl->destructor) vtbl->destructor(vtbl, this); }
...
QCameraImageCapture* QCameraImageCapture_new(struct QCameraImageCapture_VTable* vtbl, QMediaObject* mediaObject) {
	return new MiqtVirtualQCameraImageCapture(vtbl, mediaObject);
}
...
QCameraImageCapture* QCameraImageCapture_new2(struct QCameraImageCapture_VTable* vtbl, QMediaObject* mediaObject, QObject* parent) {
	return new MiqtVirtualQCameraImageCapture(vtbl, mediaObject, parent);
}
...
void QCameraImageCapture_connect_error2(QCameraImageCapture* self, intptr_t slot, void (*callback)(intptr_t, int, int, struct miqt_string), void (*release)(intptr_t)) {
	...
	MiqtVirtualQCameraImageCapture::connect(self, static_cast<void (QCameraImageCapture::*)(int, QCameraImageCapture::Error, const QString&)>(&QCameraImageCapture::error), self, caller{slot, callback, release});
}
...
void QCameraImageCapture_connect_readyForCaptureChanged(QCameraImageCapture* self, intptr_t slot, void (*callback)(intptr_t, bool), void (*release)(intptr_t)) {
	...
	MiqtVirtualQCameraImageCapture::connect(self, static_cast<void (QCameraImageCapture::*)(bool)>(&QCameraImageCapture::readyForCaptureChanged), self, caller{slot, callback, release});
}
...
void QCameraImageCapture_connect_bufferFormatChanged(QCameraImageCapture* self, intptr_t slot, void (*callback)(intptr_t, int), void (*release)(intptr_t)) {
	...
	MiqtVirtualQCameraImageCapture::connect(self, static_cast<void (QCameraImageCapture::*)(QVideoFrame::PixelFormat)>(&QCameraImageCapture::bufferFormatChanged), self, caller{slot, callback, release});
}
...
void QCameraImageCapture_connect_captureDestinationChanged(QCameraImageCapture* self, intptr_t slot, void (*callback)(intptr_t, int), void (*release)(intptr_t)) {
	...
	MiqtVirtualQCameraImageCapture::connect(self, static_cast<void (QCameraImageCapture::*)(QCameraImageCapture::CaptureDestinations)>(&QCameraImageCapture::captureDestinationChanged), self, caller{slot, callback, release});
}
...
void QCameraImageCapture_connect_imageExposed(QCameraImageCapture* self, intptr_t slot, void (*callback)(intptr_t, int), void (*release)(intptr_t)) {
	...
	MiqtVirtualQCameraImageCapture::connect(self, static_cast<void (QCameraImageCapture::*)(int)>(&QCameraImageCapture::imageExposed), self, caller{slot, callback, release});
}
...
void QCameraImageCapture_connect_imageCaptured(QCameraImageCapture* self, intptr_t slot, void (*callback)(intptr_t, int, QImage*), void (*release)(intptr_t)) {
	...
	MiqtVirtualQCameraImageCapture::connect(self, static_cast<void (QCameraImageCapture::*)(int, const QImage&)>(&QCameraImageCapture::imageCaptured), self, caller{slot, callback, release});
}
...
void QCameraImageCapture_connect_imageMetadataAvailable(QCameraImageCapture* self, intptr_t slot, void (*callback)(intptr_t, int, struct miqt_string, QVariant*), void (*release)(intptr_t)) {
	...
	MiqtVirtualQCameraImageCapture::connect(self, static_cast<void (QCameraImageCapture::*)(int, const QString&, const QVariant&)>(&QCameraImageCapture::imageMetadataAvailable), self, caller{slot, callback, release});
}
...
void QCameraImageCapture_connect_imageAvailable(QCameraImageCapture* self, intptr_t slot, void (*callback)(intptr_t, int, QVideoFrame*), void (*release)(intptr_t)) {
	...
	MiqtVirtualQCameraImageCapture::connect(self, static_cast<void (QCameraImageCapture::*)(int, const QVideoFrame&)>(&QCameraImageCapture::imageAvailable), self, caller{slot, callback, release});
}
...
void QCameraImageCapture_connect_imageSaved(QCameraImageCapture* self, intptr_t slot, void (*callback)(intptr_t, int, struct miqt_string), void (*release)(intptr_t)) {
	...
	MiqtVirtualQCameraImageCapture::connect(self, static_cast<void (QCameraImageCapture::*)(int, const QString&)>(&QCameraImageCapture::imageSaved), self, caller{slot, callback, release});
}
...
QMetaObject* QCameraImageCapture_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQCameraImageCapture*)(self) )->QCameraImageCapture::metaObject();

}

void* QCameraImageCapture_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQCameraImageCapture*)(self) )->QCameraImageCapture::qt_metacast(param1);

}

int QCameraImageCapture_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQCameraImageCapture*)(self) )->QCameraImageCapture::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
QObject* QCameraImageCapture_protectedbase_sender(const void* self) {
	MiqtVirtualQCameraImageCapture* self_cast = static_cast<MiqtVirtualQCameraImageCapture*>( (QCameraImageCapture*)(self) );
