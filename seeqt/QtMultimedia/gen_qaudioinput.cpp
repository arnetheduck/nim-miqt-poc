...
public:
	...
	MiqtVirtualQAudioInput(struct QAudioInput_VTable* vtbl, const QAudioDeviceInfo& audioDeviceInfo): QAudioInput(audioDeviceInfo), vtbl(vtbl) {};
	MiqtVirtualQAudioInput(struct QAudioInput_VTable* vtbl, const QAudioFormat& format): QAudioInput(format), vtbl(vtbl) {};
	MiqtVirtualQAudioInput(struct QAudioInput_VTable* vtbl, const QAudioFormat& format, QObject* parent): QAudioInput(format, parent), vtbl(vtbl) {};
	MiqtVirtualQAudioInput(struct QAudioInput_VTable* vtbl, const QAudioDeviceInfo& audioDeviceInfo, const QAudioFormat& format): QAudioInput(audioDeviceInfo, format), vtbl(vtbl) {};
	MiqtVirtualQAudioInput(struct QAudioInput_VTable* vtbl, const QAudioDeviceInfo& audioDeviceInfo, const QAudioFormat& format, QObject* parent): QAudioInput(audioDeviceInfo, format, parent), vtbl(vtbl) {};
...
QAudioInput* QAudioInput_new6(struct QAudioInput_VTable* vtbl, QAudioDeviceInfo* audioDeviceInfo, QAudioFormat* format, QObject* parent) {
	return new MiqtVirtualQAudioInput(vtbl, *audioDeviceInfo, *format, parent);
}
...
void QAudioInput_connect_stateChanged(QAudioInput* self, intptr_t slot, void (*callback)(intptr_t, int), void (*release)(intptr_t)) {
	...
	MiqtVirtualQAudioInput::connect(self, static_cast<void (QAudioInput::*)(QAudio::State)>(&QAudioInput::stateChanged), self, caller{slot, callback, release});
}
...
void QAudioInput_connect_notify(QAudioInput* self, intptr_t slot, void (*callback)(intptr_t), void (*release)(intptr_t)) {
	...
	MiqtVirtualQAudioInput::connect(self, static_cast<void (QAudioInput::*)()>(&QAudioInput::notify), self, caller{slot, callback, release});
}
...
QMetaObject* QAudioInput_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQAudioInput*)(self) )->QAudioInput::metaObject();

}

void* QAudioInput_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQAudioInput*)(self) )->QAudioInput::qt_metacast(param1);

}

int QAudioInput_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQAudioInput*)(self) )->QAudioInput::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
