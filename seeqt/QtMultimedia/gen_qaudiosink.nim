...
proc create*(T: type gen_qaudiosink_types.QAudioSink, audioDeviceInfo: QAudioDevice): gen_qaudiosink_types.QAudioSink =
  gen_qaudiosink_types.QAudioSink.init(fcQAudioSink_new2(audioDeviceInfo.h))

proc create*(T: type gen_qaudiosink_types.QAudioSink, format: QAudioFormat): gen_qaudiosink_types.QAudioSink =
  gen_qaudiosink_types.QAudioSink.init(fcQAudioSink_new3(format.h))

proc create*(T: type gen_qaudiosink_types.QAudioSink, format: QAudioFormat, parent: QObject): gen_qaudiosink_types.QAudioSink =
  gen_qaudiosink_types.QAudioSink.init(fcQAudioSink_new4(format.h, parent.h))

proc create*(T: type gen_qaudiosink_types.QAudioSink, audioDeviceInfo: QAudioDevice, format: QAudioFormat): gen_qaudiosink_types.QAudioSink =
  gen_qaudiosink_types.QAudioSink.init(fcQAudioSink_new5(audioDeviceInfo.h, format.h))

proc create*(T: type gen_qaudiosink_types.QAudioSink, audioDeviceInfo: QAudioDevice, format: QAudioFormat, parent: QObject): gen_qaudiosink_types.QAudioSink =
  gen_qaudiosink_types.QAudioSink.init(fcQAudioSink_new6(audioDeviceInfo.h, format.h, parent.h))

proc metaObject*(self: gen_qaudiosink_types.QAudioSink, ): QMetaObject =
  QMetaObject(h: fcQAudioSink_metaObject(self.h))
...
proc format*(self: gen_qaudiosink_types.QAudioSink, ): QAudioFormat =
  QAudioFormat(h: fcQAudioSink_format(self.h))

proc start*(self: gen_qaudiosink_types.QAudioSink, device: QIODevice): void =
  fcQAudioSink_start(self.h, device.h)

proc start*(self: gen_qaudiosink_types.QAudioSink, ): QIODevice =
  QIODevice(h: fcQAudioSink_start2(self.h))
...
proc miqt_exec_callback_QAudioSink_metacall(self: ptr cQAudioSink, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QAudioSink_metacall ".} =
  ...
  virtualReturn
proc QAudioSinkevent*(self: gen_qaudiosink_types.QAudioSink, event: QEvent): bool =
  fQAudioSink_virtualbase_event(self.h, event.h)

type QAudioSinkeventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QAudioSink_event(self: ptr cQAudioSink, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QAudioSink_event ".} =
  ...
  virtualReturn
proc QAudioSinkeventFilter*(self: gen_qaudiosink_types.QAudioSink, watched: QObject, event: QEvent): bool =
  fQAudioSink_virtualbase_eventFilter(self.h, watched.h, event.h)

type QAudioSinkeventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QAudioSink_eventFilter(self: ptr cQAudioSink, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QAudioSink_eventFilter ".} =
  ...
  virtualReturn
proc QAudioSinktimerEvent*(self: gen_qaudiosink_types.QAudioSink, event: QTimerEvent): void =
  fQAudioSink_virtualbase_timerEvent(self.h, event.h)

type QAudioSinktimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QAudioSink_timerEvent(self: ptr cQAudioSink, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QAudioSink_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QAudioSinkchildEvent*(self: gen_qaudiosink_types.QAudioSink, event: QChildEvent): void =
  fQAudioSink_virtualbase_childEvent(self.h, event.h)

type QAudioSinkchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QAudioSink_childEvent(self: ptr cQAudioSink, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QAudioSink_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QAudioSinkcustomEvent*(self: gen_qaudiosink_types.QAudioSink, event: QEvent): void =
  fQAudioSink_virtualbase_customEvent(self.h, event.h)

type QAudioSinkcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QAudioSink_customEvent(self: ptr cQAudioSink, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QAudioSink_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QAudioSinkconnectNotify*(self: gen_qaudiosink_types.QAudioSink, signal: QMetaMethod): void =
  fQAudioSink_virtualbase_connectNotify(self.h, signal.h)

type QAudioSinkconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QAudioSink_connectNotify(self: ptr cQAudioSink, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QAudioSink_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QAudioSinkdisconnectNotify*(self: gen_qaudiosink_types.QAudioSink, signal: QMetaMethod): void =
  fQAudioSink_virtualbase_disconnectNotify(self.h, signal.h)

type QAudioSinkdisconnectNotifyProc* = proc(signal: QMetaMethod): void
