...
proc create*(T: type gen_qvideosink_types.QVideoSink, parent: QObject): gen_qvideosink_types.QVideoSink =
  gen_qvideosink_types.QVideoSink.init(fcQVideoSink_new2(parent.h))

proc metaObject*(self: gen_qvideosink_types.QVideoSink, ): QMetaObject =
  QMetaObject(h: fcQVideoSink_metaObject(self.h))
...
proc videoSize*(self: gen_qvideosink_types.QVideoSink, ): QSize =
  QSize(h: fcQVideoSink_videoSize(self.h))
...
proc setVideoFrame*(self: gen_qvideosink_types.QVideoSink, frame: QVideoFrame): void =
  fcQVideoSink_setVideoFrame(self.h, frame.h)

proc videoFrame*(self: gen_qvideosink_types.QVideoSink, ): QVideoFrame =
  QVideoFrame(h: fcQVideoSink_videoFrame(self.h))

proc videoFrameChanged*(self: gen_qvideosink_types.QVideoSink, frame: QVideoFrame): void =
  fcQVideoSink_videoFrameChanged(self.h, frame.h)

type QVideoSinkvideoFrameChangedSlot* = proc(frame: QVideoFrame)
...
proc miqt_exec_callback_QVideoSink_metacall(self: ptr cQVideoSink, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QVideoSink_metacall ".} =
  ...
  virtualReturn
proc QVideoSinkevent*(self: gen_qvideosink_types.QVideoSink, event: QEvent): bool =
  fQVideoSink_virtualbase_event(self.h, event.h)

type QVideoSinkeventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QVideoSink_event(self: ptr cQVideoSink, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QVideoSink_event ".} =
  ...
  virtualReturn
proc QVideoSinkeventFilter*(self: gen_qvideosink_types.QVideoSink, watched: QObject, event: QEvent): bool =
  fQVideoSink_virtualbase_eventFilter(self.h, watched.h, event.h)

type QVideoSinkeventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QVideoSink_eventFilter(self: ptr cQVideoSink, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QVideoSink_eventFilter ".} =
  ...
  virtualReturn
proc QVideoSinktimerEvent*(self: gen_qvideosink_types.QVideoSink, event: QTimerEvent): void =
  fQVideoSink_virtualbase_timerEvent(self.h, event.h)

type QVideoSinktimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QVideoSink_timerEvent(self: ptr cQVideoSink, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QVideoSink_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QVideoSinkchildEvent*(self: gen_qvideosink_types.QVideoSink, event: QChildEvent): void =
  fQVideoSink_virtualbase_childEvent(self.h, event.h)

type QVideoSinkchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QVideoSink_childEvent(self: ptr cQVideoSink, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QVideoSink_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QVideoSinkcustomEvent*(self: gen_qvideosink_types.QVideoSink, event: QEvent): void =
  fQVideoSink_virtualbase_customEvent(self.h, event.h)

type QVideoSinkcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QVideoSink_customEvent(self: ptr cQVideoSink, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QVideoSink_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QVideoSinkconnectNotify*(self: gen_qvideosink_types.QVideoSink, signal: QMetaMethod): void =
  fQVideoSink_virtualbase_connectNotify(self.h, signal.h)

type QVideoSinkconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QVideoSink_connectNotify(self: ptr cQVideoSink, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QVideoSink_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QVideoSinkdisconnectNotify*(self: gen_qvideosink_types.QVideoSink, signal: QMetaMethod): void =
  fQVideoSink_virtualbase_disconnectNotify(self.h, signal.h)

type QVideoSinkdisconnectNotifyProc* = proc(signal: QMetaMethod): void
