...
void QMetaDataWriterControl_connect_metaDataChanged(QMetaDataWriterControl* self, intptr_t slot, void (*callback)(intptr_t), void (*release)(intptr_t)) {
	...
	QMetaDataWriterControl::connect(self, static_cast<void (QMetaDataWriterControl::*)()>(&QMetaDataWriterControl::metaDataChanged), self, caller{slot, callback, release});
}
...
void QMetaDataWriterControl_connect_metaDataChanged2(QMetaDataWriterControl* self, intptr_t slot, void (*callback)(intptr_t, struct miqt_string, QVariant*), void (*release)(intptr_t)) {
	...
	QMetaDataWriterControl::connect(self, static_cast<void (QMetaDataWriterControl::*)(const QString&, const QVariant&)>(&QMetaDataWriterControl::metaDataChanged), self, caller{slot, callback, release});
}
...
void QMetaDataWriterControl_connect_writableChanged(QMetaDataWriterControl* self, intptr_t slot, void (*callback)(intptr_t, bool), void (*release)(intptr_t)) {
	...
	QMetaDataWriterControl::connect(self, static_cast<void (QMetaDataWriterControl::*)(bool)>(&QMetaDataWriterControl::writableChanged), self, caller{slot, callback, release});
}
...
void QMetaDataWriterControl_connect_metaDataAvailableChanged(QMetaDataWriterControl* self, intptr_t slot, void (*callback)(intptr_t, bool), void (*release)(intptr_t)) {
	...
	QMetaDataWriterControl::connect(self, static_cast<void (QMetaDataWriterControl::*)(bool)>(&QMetaDataWriterControl::metaDataAvailableChanged), self, caller{slot, callback, release});
}
