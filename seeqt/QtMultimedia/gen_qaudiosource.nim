...
proc create*(T: type gen_qaudiosource_types.QAudioSource, audioDeviceInfo: QAudioDevice): gen_qaudiosource_types.QAudioSource =
  gen_qaudiosource_types.QAudioSource.init(fcQAudioSource_new2(audioDeviceInfo.h))

proc create*(T: type gen_qaudiosource_types.QAudioSource, format: QAudioFormat): gen_qaudiosource_types.QAudioSource =
  gen_qaudiosource_types.QAudioSource.init(fcQAudioSource_new3(format.h))

proc create*(T: type gen_qaudiosource_types.QAudioSource, format: QAudioFormat, parent: QObject): gen_qaudiosource_types.QAudioSource =
  gen_qaudiosource_types.QAudioSource.init(fcQAudioSource_new4(format.h, parent.h))

proc create*(T: type gen_qaudiosource_types.QAudioSource, audioDeviceInfo: QAudioDevice, format: QAudioFormat): gen_qaudiosource_types.QAudioSource =
  gen_qaudiosource_types.QAudioSource.init(fcQAudioSource_new5(audioDeviceInfo.h, format.h))

proc create*(T: type gen_qaudiosource_types.QAudioSource, audioDeviceInfo: QAudioDevice, format: QAudioFormat, parent: QObject): gen_qaudiosource_types.QAudioSource =
  gen_qaudiosource_types.QAudioSource.init(fcQAudioSource_new6(audioDeviceInfo.h, format.h, parent.h))

proc metaObject*(self: gen_qaudiosource_types.QAudioSource, ): QMetaObject =
  QMetaObject(h: fcQAudioSource_metaObject(self.h))
...
proc format*(self: gen_qaudiosource_types.QAudioSource, ): QAudioFormat =
  QAudioFormat(h: fcQAudioSource_format(self.h))

proc start*(self: gen_qaudiosource_types.QAudioSource, device: QIODevice): void =
  fcQAudioSource_start(self.h, device.h)

proc start*(self: gen_qaudiosource_types.QAudioSource, ): QIODevice =
  QIODevice(h: fcQAudioSource_start2(self.h))
...
proc onmetacall*(self: gen_qaudiosource_types.QAudioSource, slot: QAudioSourcemetacallProc) =
  # TODO check subclass
  var tmp = new QAudioSourcemetacallProc
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QAudioSource_metacall(self: ptr cQAudioSource, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QAudioSource_metacall ".} =
  var nimfunc = cast[ptr QAudioSourcemetacallProc](cast[pointer](slot))
  ...
  virtualReturn
proc QAudioSourceevent*(self: gen_qaudiosource_types.QAudioSource, event: QEvent): bool =
  fQAudioSource_virtualbase_event(self.h, event.h)

type QAudioSourceeventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QAudioSource_event(self: ptr cQAudioSource, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QAudioSource_event ".} =
  ...
  virtualReturn
proc QAudioSourceeventFilter*(self: gen_qaudiosource_types.QAudioSource, watched: QObject, event: QEvent): bool =
  fQAudioSource_virtualbase_eventFilter(self.h, watched.h, event.h)

type QAudioSourceeventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QAudioSource_eventFilter(self: ptr cQAudioSource, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QAudioSource_eventFilter ".} =
  ...
  virtualReturn
proc QAudioSourcetimerEvent*(self: gen_qaudiosource_types.QAudioSource, event: QTimerEvent): void =
  fQAudioSource_virtualbase_timerEvent(self.h, event.h)

type QAudioSourcetimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QAudioSource_timerEvent(self: ptr cQAudioSource, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QAudioSource_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QAudioSourcechildEvent*(self: gen_qaudiosource_types.QAudioSource, event: QChildEvent): void =
  fQAudioSource_virtualbase_childEvent(self.h, event.h)

type QAudioSourcechildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QAudioSource_childEvent(self: ptr cQAudioSource, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QAudioSource_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QAudioSourcecustomEvent*(self: gen_qaudiosource_types.QAudioSource, event: QEvent): void =
  fQAudioSource_virtualbase_customEvent(self.h, event.h)

type QAudioSourcecustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QAudioSource_customEvent(self: ptr cQAudioSource, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QAudioSource_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QAudioSourceconnectNotify*(self: gen_qaudiosource_types.QAudioSource, signal: QMetaMethod): void =
  fQAudioSource_virtualbase_connectNotify(self.h, signal.h)

type QAudioSourceconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QAudioSource_connectNotify(self: ptr cQAudioSource, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QAudioSource_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QAudioSourcedisconnectNotify*(self: gen_qaudiosource_types.QAudioSource, signal: QMetaMethod): void =
  fQAudioSource_virtualbase_disconnectNotify(self.h, signal.h)

type QAudioSourcedisconnectNotifyProc* = proc(signal: QMetaMethod): void
