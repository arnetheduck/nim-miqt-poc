...
public:
	...
	MiqtVirtualQSoundEffect(struct QSoundEffect_VTable* vtbl, const QAudioDevice& audioDevice): QSoundEffect(audioDevice), vtbl(vtbl) {};
	MiqtVirtualQSoundEffect(struct QSoundEffect_VTable* vtbl, QObject* parent): QSoundEffect(parent), vtbl(vtbl) {};
	MiqtVirtualQSoundEffect(struct QSoundEffect_VTable* vtbl, const QAudioDevice& audioDevice, QObject* parent): QSoundEffect(audioDevice, parent), vtbl(vtbl) {};
...
void QSoundEffect_connect_sourceChanged(QSoundEffect* self, intptr_t slot, void (*callback)(intptr_t), void (*release)(intptr_t)) {
	...
	MiqtVirtualQSoundEffect::connect(self, static_cast<void (QSoundEffect::*)()>(&QSoundEffect::sourceChanged), self, caller{slot, callback, release});
}
...
void QSoundEffect_connect_loopCountChanged(QSoundEffect* self, intptr_t slot, void (*callback)(intptr_t), void (*release)(intptr_t)) {
	...
	MiqtVirtualQSoundEffect::connect(self, static_cast<void (QSoundEffect::*)()>(&QSoundEffect::loopCountChanged), self, caller{slot, callback, release});
}
...
void QSoundEffect_connect_loopsRemainingChanged(QSoundEffect* self, intptr_t slot, void (*callback)(intptr_t), void (*release)(intptr_t)) {
	...
	MiqtVirtualQSoundEffect::connect(self, static_cast<void (QSoundEffect::*)()>(&QSoundEffect::loopsRemainingChanged), self, caller{slot, callback, release});
}
...
void QSoundEffect_connect_volumeChanged(QSoundEffect* self, intptr_t slot, void (*callback)(intptr_t), void (*release)(intptr_t)) {
	...
	MiqtVirtualQSoundEffect::connect(self, static_cast<void (QSoundEffect::*)()>(&QSoundEffect::volumeChanged), self, caller{slot, callback, release});
}
...
void QSoundEffect_connect_mutedChanged(QSoundEffect* self, intptr_t slot, void (*callback)(intptr_t), void (*release)(intptr_t)) {
	...
	MiqtVirtualQSoundEffect::connect(self, static_cast<void (QSoundEffect::*)()>(&QSoundEffect::mutedChanged), self, caller{slot, callback, release});
}
...
void QSoundEffect_connect_loadedChanged(QSoundEffect* self, intptr_t slot, void (*callback)(intptr_t), void (*release)(intptr_t)) {
	...
	MiqtVirtualQSoundEffect::connect(self, static_cast<void (QSoundEffect::*)()>(&QSoundEffect::loadedChanged), self, caller{slot, callback, release});
}
...
void QSoundEffect_connect_playingChanged(QSoundEffect* self, intptr_t slot, void (*callback)(intptr_t), void (*release)(intptr_t)) {
	...
	MiqtVirtualQSoundEffect::connect(self, static_cast<void (QSoundEffect::*)()>(&QSoundEffect::playingChanged), self, caller{slot, callback, release});
}
...
void QSoundEffect_connect_statusChanged(QSoundEffect* self, intptr_t slot, void (*callback)(intptr_t), void (*release)(intptr_t)) {
	...
	MiqtVirtualQSoundEffect::connect(self, static_cast<void (QSoundEffect::*)()>(&QSoundEffect::statusChanged), self, caller{slot, callback, release});
}
...
void QSoundEffect_connect_audioDeviceChanged(QSoundEffect* self, intptr_t slot, void (*callback)(intptr_t), void (*release)(intptr_t)) {
	...
	MiqtVirtualQSoundEffect::connect(self, static_cast<void (QSoundEffect::*)()>(&QSoundEffect::audioDeviceChanged), self, caller{slot, callback, release});
}
...
QMetaObject* QSoundEffect_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQSoundEffect*)(self) )->QSoundEffect::metaObject();

}

void* QSoundEffect_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQSoundEffect*)(self) )->QSoundEffect::qt_metacast(param1);

}

int QSoundEffect_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQSoundEffect*)(self) )->QSoundEffect::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
