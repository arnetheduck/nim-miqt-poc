...
proc create*(T: type gen_qvideoprobe_types.QVideoProbe, parent: QObject): gen_qvideoprobe_types.QVideoProbe =
  gen_qvideoprobe_types.QVideoProbe.init(fcQVideoProbe_new2(parent.h))

proc metaObject*(self: gen_qvideoprobe_types.QVideoProbe, ): QMetaObject =
  QMetaObject(h: fcQVideoProbe_metaObject(self.h))
...
proc setSource*(self: gen_qvideoprobe_types.QVideoProbe, source: QMediaObject): bool =
  fcQVideoProbe_setSource(self.h, source.h)

proc setSource*(self: gen_qvideoprobe_types.QVideoProbe, source: QMediaRecorder): bool =
...
proc videoFrameProbed*(self: gen_qvideoprobe_types.QVideoProbe, frame: QVideoFrame): void =
  fcQVideoProbe_videoFrameProbed(self.h, frame.h)

type QVideoProbevideoFrameProbedSlot* = proc(frame: QVideoFrame)
...
proc miqt_exec_callback_QVideoProbe_metacall(self: ptr cQVideoProbe, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QVideoProbe_metacall ".} =
  ...
  virtualReturn
proc QVideoProbeevent*(self: gen_qvideoprobe_types.QVideoProbe, event: QEvent): bool =
  fQVideoProbe_virtualbase_event(self.h, event.h)

type QVideoProbeeventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QVideoProbe_event(self: ptr cQVideoProbe, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QVideoProbe_event ".} =
  ...
  virtualReturn
proc QVideoProbeeventFilter*(self: gen_qvideoprobe_types.QVideoProbe, watched: QObject, event: QEvent): bool =
  fQVideoProbe_virtualbase_eventFilter(self.h, watched.h, event.h)

type QVideoProbeeventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QVideoProbe_eventFilter(self: ptr cQVideoProbe, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QVideoProbe_eventFilter ".} =
  ...
  virtualReturn
proc QVideoProbetimerEvent*(self: gen_qvideoprobe_types.QVideoProbe, event: QTimerEvent): void =
  fQVideoProbe_virtualbase_timerEvent(self.h, event.h)

type QVideoProbetimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QVideoProbe_timerEvent(self: ptr cQVideoProbe, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QVideoProbe_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QVideoProbechildEvent*(self: gen_qvideoprobe_types.QVideoProbe, event: QChildEvent): void =
  fQVideoProbe_virtualbase_childEvent(self.h, event.h)

type QVideoProbechildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QVideoProbe_childEvent(self: ptr cQVideoProbe, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QVideoProbe_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QVideoProbecustomEvent*(self: gen_qvideoprobe_types.QVideoProbe, event: QEvent): void =
  fQVideoProbe_virtualbase_customEvent(self.h, event.h)

type QVideoProbecustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QVideoProbe_customEvent(self: ptr cQVideoProbe, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QVideoProbe_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QVideoProbeconnectNotify*(self: gen_qvideoprobe_types.QVideoProbe, signal: QMetaMethod): void =
  fQVideoProbe_virtualbase_connectNotify(self.h, signal.h)

type QVideoProbeconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QVideoProbe_connectNotify(self: ptr cQVideoProbe, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QVideoProbe_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QVideoProbedisconnectNotify*(self: gen_qvideoprobe_types.QVideoProbe, signal: QMetaMethod): void =
  fQVideoProbe_virtualbase_disconnectNotify(self.h, signal.h)

type QVideoProbedisconnectNotifyProc* = proc(signal: QMetaMethod): void
