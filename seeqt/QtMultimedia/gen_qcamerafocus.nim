...
proc create*(T: type gen_qcamerafocus_types.QCameraFocusZone, area: QRectF): gen_qcamerafocus_types.QCameraFocusZone =
  gen_qcamerafocus_types.QCameraFocusZone.init(fcQCameraFocusZone_new2(area.h))

proc create*(T: type gen_qcamerafocus_types.QCameraFocusZone, other: QCameraFocusZone): gen_qcamerafocus_types.QCameraFocusZone =
  gen_qcamerafocus_types.QCameraFocusZone.init(fcQCameraFocusZone_new3(other.h))

proc create*(T: type gen_qcamerafocus_types.QCameraFocusZone, area: QRectF, status: cint): gen_qcamerafocus_types.QCameraFocusZone =
  gen_qcamerafocus_types.QCameraFocusZone.init(fcQCameraFocusZone_new4(area.h, cint(status)))

proc operatorAssign*(self: gen_qcamerafocus_types.QCameraFocusZone, other: QCameraFocusZone): void =
  fcQCameraFocusZone_operatorAssign(self.h, other.h)

proc operatorEqual*(self: gen_qcamerafocus_types.QCameraFocusZone, other: QCameraFocusZone): bool =
  fcQCameraFocusZone_operatorEqual(self.h, other.h)

proc operatorNotEqual*(self: gen_qcamerafocus_types.QCameraFocusZone, other: QCameraFocusZone): bool =
...
proc area*(self: gen_qcamerafocus_types.QCameraFocusZone, ): QRectF =
  QRectF(h: fcQCameraFocusZone_area(self.h))
...
func init*(T: type gen_qcamerafocus_types.QCameraFocus, h: ptr cQCameraFocus): gen_qcamerafocus_types.QCameraFocus =
  T(h: h)
proc metaObject*(self: gen_qcamerafocus_types.QCameraFocus, ): QMetaObject =
  QMetaObject(h: fcQCameraFocus_metaObject(self.h))
...
proc customFocusPoint*(self: gen_qcamerafocus_types.QCameraFocus, ): QPointF =
  QPointF(h: fcQCameraFocus_customFocusPoint(self.h))

proc setCustomFocusPoint*(self: gen_qcamerafocus_types.QCameraFocus, point: QPointF): void =
  fcQCameraFocus_setCustomFocusPoint(self.h, point.h)

proc focusZones*(self: gen_qcamerafocus_types.QCameraFocus, ): seq[QCameraFocusZone] =
