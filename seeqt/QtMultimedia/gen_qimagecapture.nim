...
proc create*(T: type gen_qimagecapture_types.QImageCapture, parent: QObject): gen_qimagecapture_types.QImageCapture =
  gen_qimagecapture_types.QImageCapture.init(fcQImageCapture_new2(parent.h))

proc metaObject*(self: gen_qimagecapture_types.QImageCapture, ): QMetaObject =
  QMetaObject(h: fcQImageCapture_metaObject(self.h))
...
proc captureSession*(self: gen_qimagecapture_types.QImageCapture, ): QMediaCaptureSession =
  QMediaCaptureSession(h: fcQImageCapture_captureSession(self.h))
...
proc resolution*(self: gen_qimagecapture_types.QImageCapture, ): QSize =
  QSize(h: fcQImageCapture_resolution(self.h))

proc setResolution*(self: gen_qimagecapture_types.QImageCapture, resolution: QSize): void =
...
proc metaData*(self: gen_qimagecapture_types.QImageCapture, ): QMediaMetaData =
  QMediaMetaData(h: fcQImageCapture_metaData(self.h))

proc setMetaData*(self: gen_qimagecapture_types.QImageCapture, metaData: QMediaMetaData): void =
  fcQImageCapture_setMetaData(self.h, metaData.h)

proc addMetaData*(self: gen_qimagecapture_types.QImageCapture, metaData: QMediaMetaData): void =
...
proc imageCaptured*(self: gen_qimagecapture_types.QImageCapture, id: cint, preview: QImage): void =
  fcQImageCapture_imageCaptured(self.h, id, preview.h)

type QImageCaptureimageCapturedSlot* = proc(id: cint, preview: QImage)
...
proc imageMetadataAvailable*(self: gen_qimagecapture_types.QImageCapture, id: cint, metaData: QMediaMetaData): void =
  fcQImageCapture_imageMetadataAvailable(self.h, id, metaData.h)

type QImageCaptureimageMetadataAvailableSlot* = proc(id: cint, metaData: QMediaMetaData)
proc miqt_exec_callback_QImageCapture_imageMetadataAvailable(slot: int, id: cint, metaData: pointer) {.exportc.} =
  ...
  let slotval2 = QMediaMetaData(h: metaData)
...
proc imageAvailable*(self: gen_qimagecapture_types.QImageCapture, id: cint, frame: QVideoFrame): void =
  fcQImageCapture_imageAvailable(self.h, id, frame.h)

type QImageCaptureimageAvailableSlot* = proc(id: cint, frame: QVideoFrame)
...
proc miqt_exec_callback_QImageCapture_metacall(self: ptr cQImageCapture, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QImageCapture_metacall ".} =
  ...
  virtualReturn
proc QImageCaptureevent*(self: gen_qimagecapture_types.QImageCapture, event: QEvent): bool =
  fQImageCapture_virtualbase_event(self.h, event.h)

type QImageCaptureeventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QImageCapture_event(self: ptr cQImageCapture, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QImageCapture_event ".} =
  ...
  virtualReturn
proc QImageCaptureeventFilter*(self: gen_qimagecapture_types.QImageCapture, watched: QObject, event: QEvent): bool =
  fQImageCapture_virtualbase_eventFilter(self.h, watched.h, event.h)

type QImageCaptureeventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QImageCapture_eventFilter(self: ptr cQImageCapture, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QImageCapture_eventFilter ".} =
  ...
  virtualReturn
proc QImageCapturetimerEvent*(self: gen_qimagecapture_types.QImageCapture, event: QTimerEvent): void =
  fQImageCapture_virtualbase_timerEvent(self.h, event.h)

type QImageCapturetimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QImageCapture_timerEvent(self: ptr cQImageCapture, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QImageCapture_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QImageCapturechildEvent*(self: gen_qimagecapture_types.QImageCapture, event: QChildEvent): void =
  fQImageCapture_virtualbase_childEvent(self.h, event.h)

type QImageCapturechildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QImageCapture_childEvent(self: ptr cQImageCapture, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QImageCapture_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QImageCapturecustomEvent*(self: gen_qimagecapture_types.QImageCapture, event: QEvent): void =
  fQImageCapture_virtualbase_customEvent(self.h, event.h)

type QImageCapturecustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QImageCapture_customEvent(self: ptr cQImageCapture, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QImageCapture_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QImageCaptureconnectNotify*(self: gen_qimagecapture_types.QImageCapture, signal: QMetaMethod): void =
  fQImageCapture_virtualbase_connectNotify(self.h, signal.h)

type QImageCaptureconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QImageCapture_connectNotify(self: ptr cQImageCapture, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QImageCapture_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QImageCapturedisconnectNotify*(self: gen_qimagecapture_types.QImageCapture, signal: QMetaMethod): void =
  fQImageCapture_virtualbase_disconnectNotify(self.h, signal.h)

type QImageCapturedisconnectNotifyProc* = proc(signal: QMetaMethod): void
