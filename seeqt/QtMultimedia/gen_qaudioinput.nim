...
proc create*(T: type gen_qaudioinput_types.QAudioInput, deviceInfo: QAudioDevice): gen_qaudioinput_types.QAudioInput =
  gen_qaudioinput_types.QAudioInput.init(fcQAudioInput_new2(deviceInfo.h))

proc create*(T: type gen_qaudioinput_types.QAudioInput, parent: QObject): gen_qaudioinput_types.QAudioInput =
  gen_qaudioinput_types.QAudioInput.init(fcQAudioInput_new3(parent.h))

proc create*(T: type gen_qaudioinput_types.QAudioInput, deviceInfo: QAudioDevice, parent: QObject): gen_qaudioinput_types.QAudioInput =
...
proc device*(self: gen_qaudioinput_types.QAudioInput, ): QAudioDevice =
  QAudioDevice(h: fcQAudioInput_device(self.h))
...
proc setDevice*(self: gen_qaudioinput_types.QAudioInput, device: QAudioDevice): void =
