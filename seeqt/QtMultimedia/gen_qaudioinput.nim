...
proc create*(T: type gen_qaudioinput_types.QAudioInput, audioDeviceInfo: QAudioDeviceInfo): gen_qaudioinput_types.QAudioInput =
  gen_qaudioinput_types.QAudioInput.init(fcQAudioInput_new2(audioDeviceInfo.h))

proc create*(T: type gen_qaudioinput_types.QAudioInput, format: QAudioFormat): gen_qaudioinput_types.QAudioInput =
  gen_qaudioinput_types.QAudioInput.init(fcQAudioInput_new3(format.h))

proc create*(T: type gen_qaudioinput_types.QAudioInput, format: QAudioFormat, parent: QObject): gen_qaudioinput_types.QAudioInput =
  gen_qaudioinput_types.QAudioInput.init(fcQAudioInput_new4(format.h, parent.h))

proc create*(T: type gen_qaudioinput_types.QAudioInput, audioDeviceInfo: QAudioDeviceInfo, format: QAudioFormat): gen_qaudioinput_types.QAudioInput =
  gen_qaudioinput_types.QAudioInput.init(fcQAudioInput_new5(audioDeviceInfo.h, format.h))

proc create*(T: type gen_qaudioinput_types.QAudioInput, audioDeviceInfo: QAudioDeviceInfo, format: QAudioFormat, parent: QObject): gen_qaudioinput_types.QAudioInput =
  gen_qaudioinput_types.QAudioInput.init(fcQAudioInput_new6(audioDeviceInfo.h, format.h, parent.h))

proc metaObject*(self: gen_qaudioinput_types.QAudioInput, ): QMetaObject =
  QMetaObject(h: fcQAudioInput_metaObject(self.h))
...
proc format*(self: gen_qaudioinput_types.QAudioInput, ): QAudioFormat =
  QAudioFormat(h: fcQAudioInput_format(self.h))

proc start*(self: gen_qaudioinput_types.QAudioInput, device: QIODevice): void =
  fcQAudioInput_start(self.h, device.h)

proc start*(self: gen_qaudioinput_types.QAudioInput, ): QIODevice =
  QIODevice(h: fcQAudioInput_start2(self.h))
...
proc miqt_exec_callback_QAudioInput_metacall(self: ptr cQAudioInput, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QAudioInput_metacall ".} =
  ...
  virtualReturn
proc QAudioInputevent*(self: gen_qaudioinput_types.QAudioInput, event: QEvent): bool =
  fQAudioInput_virtualbase_event(self.h, event.h)

type QAudioInputeventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QAudioInput_event(self: ptr cQAudioInput, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QAudioInput_event ".} =
  ...
  virtualReturn
proc QAudioInputeventFilter*(self: gen_qaudioinput_types.QAudioInput, watched: QObject, event: QEvent): bool =
  fQAudioInput_virtualbase_eventFilter(self.h, watched.h, event.h)

type QAudioInputeventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QAudioInput_eventFilter(self: ptr cQAudioInput, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QAudioInput_eventFilter ".} =
  ...
  virtualReturn
proc QAudioInputtimerEvent*(self: gen_qaudioinput_types.QAudioInput, event: QTimerEvent): void =
  fQAudioInput_virtualbase_timerEvent(self.h, event.h)

type QAudioInputtimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QAudioInput_timerEvent(self: ptr cQAudioInput, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QAudioInput_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QAudioInputchildEvent*(self: gen_qaudioinput_types.QAudioInput, event: QChildEvent): void =
  fQAudioInput_virtualbase_childEvent(self.h, event.h)

type QAudioInputchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QAudioInput_childEvent(self: ptr cQAudioInput, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QAudioInput_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QAudioInputcustomEvent*(self: gen_qaudioinput_types.QAudioInput, event: QEvent): void =
  fQAudioInput_virtualbase_customEvent(self.h, event.h)

type QAudioInputcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QAudioInput_customEvent(self: ptr cQAudioInput, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QAudioInput_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QAudioInputconnectNotify*(self: gen_qaudioinput_types.QAudioInput, signal: QMetaMethod): void =
  fQAudioInput_virtualbase_connectNotify(self.h, signal.h)

type QAudioInputconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QAudioInput_connectNotify(self: ptr cQAudioInput, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QAudioInput_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QAudioInputdisconnectNotify*(self: gen_qaudioinput_types.QAudioInput, signal: QMetaMethod): void =
  fQAudioInput_virtualbase_disconnectNotify(self.h, signal.h)

type QAudioInputdisconnectNotifyProc* = proc(signal: QMetaMethod): void
