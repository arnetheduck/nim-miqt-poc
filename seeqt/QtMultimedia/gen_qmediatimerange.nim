...
proc create*(T: type gen_qmediatimerange_types.QMediaTimeInterval, param1: QMediaTimeInterval): gen_qmediatimerange_types.QMediaTimeInterval =
  gen_qmediatimerange_types.QMediaTimeInterval.init(fcQMediaTimeInterval_new3(param1.h))

proc operatorAssign*(self: gen_qmediatimerange_types.QMediaTimeInterval, param1: QMediaTimeInterval): void =
...
proc normalized*(self: gen_qmediatimerange_types.QMediaTimeInterval, ): QMediaTimeInterval =
  QMediaTimeInterval(h: fcQMediaTimeInterval_normalized(self.h))

proc translated*(self: gen_qmediatimerange_types.QMediaTimeInterval, offset: clonglong): QMediaTimeInterval =
...
proc create*(T: type gen_qmediatimerange_types.QMediaTimeRange, param1: QMediaTimeInterval): gen_qmediatimerange_types.QMediaTimeRange =
...
proc operatorAssign*(self: gen_qmediatimerange_types.QMediaTimeRange, param1: QMediaTimeInterval): void =
...
proc intervals*(self: gen_qmediatimerange_types.QMediaTimeRange, ): seq[QMediaTimeInterval] =
...
proc addInterval*(self: gen_qmediatimerange_types.QMediaTimeRange, interval: QMediaTimeInterval): void =
...
proc removeInterval*(self: gen_qmediatimerange_types.QMediaTimeRange, interval: QMediaTimeInterval): void =
...
proc operatorPlusAssign*(self: gen_qmediatimerange_types.QMediaTimeRange, param1: QMediaTimeInterval): QMediaTimeRange =
...
proc operatorMinusAssign*(self: gen_qmediatimerange_types.QMediaTimeRange, param1: QMediaTimeInterval): QMediaTimeRange =
