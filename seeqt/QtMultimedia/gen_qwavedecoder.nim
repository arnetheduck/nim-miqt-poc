...
func init*(T: type gen_qwavedecoder_types.QWaveDecoder, h: ptr cQWaveDecoder): gen_qwavedecoder_types.QWaveDecoder =
  T(h: h)
proc create*(T: type gen_qwavedecoder_types.QWaveDecoder, device: QIODevice): gen_qwavedecoder_types.QWaveDecoder =
  gen_qwavedecoder_types.QWaveDecoder.init(fcQWaveDecoder_new(device.h))

proc create*(T: type gen_qwavedecoder_types.QWaveDecoder, device: QIODevice, format: QAudioFormat): gen_qwavedecoder_types.QWaveDecoder =
  gen_qwavedecoder_types.QWaveDecoder.init(fcQWaveDecoder_new2(device.h, format.h))

proc create*(T: type gen_qwavedecoder_types.QWaveDecoder, device: QIODevice, parent: QObject): gen_qwavedecoder_types.QWaveDecoder =
  gen_qwavedecoder_types.QWaveDecoder.init(fcQWaveDecoder_new3(device.h, parent.h))

proc create*(T: type gen_qwavedecoder_types.QWaveDecoder, device: QIODevice, format: QAudioFormat, parent: QObject): gen_qwavedecoder_types.QWaveDecoder =
  gen_qwavedecoder_types.QWaveDecoder.init(fcQWaveDecoder_new4(device.h, format.h, parent.h))

proc metaObject*(self: gen_qwavedecoder_types.QWaveDecoder, ): QMetaObject =
  QMetaObject(h: fcQWaveDecoder_metaObject(self.h))
...
proc audioFormat*(self: gen_qwavedecoder_types.QWaveDecoder, ): QAudioFormat =
  QAudioFormat(h: fcQWaveDecoder_audioFormat(self.h))

proc getDevice*(self: gen_qwavedecoder_types.QWaveDecoder, ): QIODevice =
  QIODevice(h: fcQWaveDecoder_getDevice(self.h))
...
proc miqt_exec_callback_QWaveDecoder_skipData(self: ptr cQWaveDecoder, slot: int, maxSize: clonglong): clonglong {.exportc: "miqt_exec_callback_QWaveDecoder_skipData ".} =
  ...
  virtualReturn
proc QWaveDecoderevent*(self: gen_qwavedecoder_types.QWaveDecoder, event: QEvent): bool =
  fQWaveDecoder_virtualbase_event(self.h, event.h)

type QWaveDecodereventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QWaveDecoder_event(self: ptr cQWaveDecoder, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QWaveDecoder_event ".} =
  ...
  virtualReturn
proc QWaveDecodereventFilter*(self: gen_qwavedecoder_types.QWaveDecoder, watched: QObject, event: QEvent): bool =
  fQWaveDecoder_virtualbase_eventFilter(self.h, watched.h, event.h)

type QWaveDecodereventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QWaveDecoder_eventFilter(self: ptr cQWaveDecoder, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QWaveDecoder_eventFilter ".} =
  ...
  virtualReturn
proc QWaveDecodertimerEvent*(self: gen_qwavedecoder_types.QWaveDecoder, event: QTimerEvent): void =
  fQWaveDecoder_virtualbase_timerEvent(self.h, event.h)

type QWaveDecodertimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QWaveDecoder_timerEvent(self: ptr cQWaveDecoder, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QWaveDecoder_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QWaveDecoderchildEvent*(self: gen_qwavedecoder_types.QWaveDecoder, event: QChildEvent): void =
  fQWaveDecoder_virtualbase_childEvent(self.h, event.h)

type QWaveDecoderchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QWaveDecoder_childEvent(self: ptr cQWaveDecoder, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QWaveDecoder_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QWaveDecodercustomEvent*(self: gen_qwavedecoder_types.QWaveDecoder, event: QEvent): void =
  fQWaveDecoder_virtualbase_customEvent(self.h, event.h)

type QWaveDecodercustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QWaveDecoder_customEvent(self: ptr cQWaveDecoder, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QWaveDecoder_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QWaveDecoderconnectNotify*(self: gen_qwavedecoder_types.QWaveDecoder, signal: QMetaMethod): void =
  fQWaveDecoder_virtualbase_connectNotify(self.h, signal.h)

type QWaveDecoderconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QWaveDecoder_connectNotify(self: ptr cQWaveDecoder, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QWaveDecoder_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QWaveDecoderdisconnectNotify*(self: gen_qwavedecoder_types.QWaveDecoder, signal: QMetaMethod): void =
  fQWaveDecoder_virtualbase_disconnectNotify(self.h, signal.h)

type QWaveDecoderdisconnectNotifyProc* = proc(signal: QMetaMethod): void
