...
proc fcQMediaPlaylist_load(self: pointer, request: ptr cQNetworkRequest): void {.importc: "QMediaPlaylist_load".}
...
proc fcQMediaPlaylist_load2(self: pointer, request: ptr cQNetworkRequest, format: cstring): void {.importc: "QMediaPlaylist_load2".}
...
proc create*(T: type gen_qmediaplaylist_types.QMediaPlaylist, parent: QObject): gen_qmediaplaylist_types.QMediaPlaylist =
  gen_qmediaplaylist_types.QMediaPlaylist.init(fcQMediaPlaylist_new2(parent.h))

proc metaObject*(self: gen_qmediaplaylist_types.QMediaPlaylist, ): QMetaObject =
  QMetaObject(h: fcQMediaPlaylist_metaObject(self.h))
...
proc mediaObject*(self: gen_qmediaplaylist_types.QMediaPlaylist, ): QMediaObject =
  QMediaObject(h: fcQMediaPlaylist_mediaObject(self.h))
...
proc currentMedia*(self: gen_qmediaplaylist_types.QMediaPlaylist, ): QMediaContent =
  QMediaContent(h: fcQMediaPlaylist_currentMedia(self.h))
...
proc media*(self: gen_qmediaplaylist_types.QMediaPlaylist, index: cint): QMediaContent =
  QMediaContent(h: fcQMediaPlaylist_media(self.h, index))
...
proc addMedia*(self: gen_qmediaplaylist_types.QMediaPlaylist, content: QMediaContent): bool =
  fcQMediaPlaylist_addMedia(self.h, content.h)

proc addMedia*(self: gen_qmediaplaylist_types.QMediaPlaylist, items: seq[QMediaContent]): bool =
...
proc insertMedia*(self: gen_qmediaplaylist_types.QMediaPlaylist, index: cint, content: QMediaContent): bool =
  fcQMediaPlaylist_insertMedia(self.h, index, content.h)

proc insertMedia*(self: gen_qmediaplaylist_types.QMediaPlaylist, index: cint, items: seq[QMediaContent]): bool =
  var items_CArray = newSeq[pointer](len(items))
  for i in 0..<len(items):
    items_CArray[i] = items[i].h
...
proc load*(self: gen_qmediaplaylist_types.QMediaPlaylist, request: ptr QNetworkRequest): void =
  fcQMediaPlaylist_load(self.h, request)

proc load*(self: gen_qmediaplaylist_types.QMediaPlaylist, location: QUrl): void =
  fcQMediaPlaylist_loadWithLocation(self.h, location.h)

proc load*(self: gen_qmediaplaylist_types.QMediaPlaylist, device: QIODevice): void =
  fcQMediaPlaylist_loadWithDevice(self.h, device.h)

proc save*(self: gen_qmediaplaylist_types.QMediaPlaylist, location: QUrl): bool =
  fcQMediaPlaylist_save(self.h, location.h)

proc save*(self: gen_qmediaplaylist_types.QMediaPlaylist, device: QIODevice, format: cstring): bool =
...
proc currentMediaChanged*(self: gen_qmediaplaylist_types.QMediaPlaylist, param1: QMediaContent): void =
  fcQMediaPlaylist_currentMediaChanged(self.h, param1.h)

type QMediaPlaylistcurrentMediaChangedSlot* = proc(param1: QMediaContent)
proc miqt_exec_callback_QMediaPlaylist_currentMediaChanged(slot: int, param1: pointer) {.exportc.} =
  ...
  let slotval1 = QMediaContent(h: param1)
...
proc load*(self: gen_qmediaplaylist_types.QMediaPlaylist, request: ptr QNetworkRequest, format: cstring): void =
  fcQMediaPlaylist_load2(self.h, request, format)

proc load*(self: gen_qmediaplaylist_types.QMediaPlaylist, location: QUrl, format: cstring): void =
  fcQMediaPlaylist_load22(self.h, location.h, format)

proc load*(self: gen_qmediaplaylist_types.QMediaPlaylist, device: QIODevice, format: cstring): void =
  fcQMediaPlaylist_load23(self.h, device.h, format)

proc save*(self: gen_qmediaplaylist_types.QMediaPlaylist, location: QUrl, format: cstring): bool =
...
proc miqt_exec_callback_QMediaPlaylist_metacall(self: ptr cQMediaPlaylist, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QMediaPlaylist_metacall ".} =
  ...
  virtualReturn
proc QMediaPlaylistmediaObject*(self: gen_qmediaplaylist_types.QMediaPlaylist, ): QMediaObject =
  QMediaObject(h: fQMediaPlaylist_virtualbase_mediaObject(self.h))

type QMediaPlaylistmediaObjectProc* = proc(): QMediaObject
...
proc miqt_exec_callback_QMediaPlaylist_mediaObject(self: ptr cQMediaPlaylist, slot: int): pointer {.exportc: "miqt_exec_callback_QMediaPlaylist_mediaObject ".} =
  ...
  virtualReturn.h
proc QMediaPlaylistsetMediaObject*(self: gen_qmediaplaylist_types.QMediaPlaylist, objectVal: QMediaObject): bool =
  fQMediaPlaylist_virtualbase_setMediaObject(self.h, objectVal.h)

type QMediaPlaylistsetMediaObjectProc* = proc(objectVal: QMediaObject): bool
...
proc miqt_exec_callback_QMediaPlaylist_setMediaObject(self: ptr cQMediaPlaylist, slot: int, objectVal: pointer): bool {.exportc: "miqt_exec_callback_QMediaPlaylist_setMediaObject ".} =
  ...
  virtualReturn
proc QMediaPlaylistevent*(self: gen_qmediaplaylist_types.QMediaPlaylist, event: QEvent): bool =
  fQMediaPlaylist_virtualbase_event(self.h, event.h)

type QMediaPlaylisteventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QMediaPlaylist_event(self: ptr cQMediaPlaylist, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QMediaPlaylist_event ".} =
  ...
  virtualReturn
proc QMediaPlaylisteventFilter*(self: gen_qmediaplaylist_types.QMediaPlaylist, watched: QObject, event: QEvent): bool =
  fQMediaPlaylist_virtualbase_eventFilter(self.h, watched.h, event.h)

type QMediaPlaylisteventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QMediaPlaylist_eventFilter(self: ptr cQMediaPlaylist, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QMediaPlaylist_eventFilter ".} =
  ...
  virtualReturn
proc QMediaPlaylisttimerEvent*(self: gen_qmediaplaylist_types.QMediaPlaylist, event: QTimerEvent): void =
  fQMediaPlaylist_virtualbase_timerEvent(self.h, event.h)

type QMediaPlaylisttimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QMediaPlaylist_timerEvent(self: ptr cQMediaPlaylist, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QMediaPlaylist_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QMediaPlaylistchildEvent*(self: gen_qmediaplaylist_types.QMediaPlaylist, event: QChildEvent): void =
  fQMediaPlaylist_virtualbase_childEvent(self.h, event.h)

type QMediaPlaylistchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QMediaPlaylist_childEvent(self: ptr cQMediaPlaylist, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QMediaPlaylist_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QMediaPlaylistcustomEvent*(self: gen_qmediaplaylist_types.QMediaPlaylist, event: QEvent): void =
  fQMediaPlaylist_virtualbase_customEvent(self.h, event.h)

type QMediaPlaylistcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QMediaPlaylist_customEvent(self: ptr cQMediaPlaylist, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QMediaPlaylist_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QMediaPlaylistconnectNotify*(self: gen_qmediaplaylist_types.QMediaPlaylist, signal: QMetaMethod): void =
  fQMediaPlaylist_virtualbase_connectNotify(self.h, signal.h)

type QMediaPlaylistconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QMediaPlaylist_connectNotify(self: ptr cQMediaPlaylist, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QMediaPlaylist_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QMediaPlaylistdisconnectNotify*(self: gen_qmediaplaylist_types.QMediaPlaylist, signal: QMetaMethod): void =
  fQMediaPlaylist_virtualbase_disconnectNotify(self.h, signal.h)

type QMediaPlaylistdisconnectNotifyProc* = proc(signal: QMetaMethod): void
