...
func init*(T: type gen_qvideowindowcontrol_types.QVideoWindowControl, h: ptr cQVideoWindowControl): gen_qvideowindowcontrol_types.QVideoWindowControl =
  T(h: h)
proc metaObject*(self: gen_qvideowindowcontrol_types.QVideoWindowControl, ): QMetaObject =
  QMetaObject(h: fcQVideoWindowControl_metaObject(self.h))
...
proc displayRect*(self: gen_qvideowindowcontrol_types.QVideoWindowControl, ): QRect =
  QRect(h: fcQVideoWindowControl_displayRect(self.h))

proc setDisplayRect*(self: gen_qvideowindowcontrol_types.QVideoWindowControl, rect: QRect): void =
...
proc nativeSize*(self: gen_qvideowindowcontrol_types.QVideoWindowControl, ): QSize =
  QSize(h: fcQVideoWindowControl_nativeSize(self.h))
