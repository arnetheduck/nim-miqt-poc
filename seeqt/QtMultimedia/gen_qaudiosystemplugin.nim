...
proc createInput*(self: gen_qaudiosystemplugin_types.QAudioSystemFactoryInterface, device: seq[byte]): QAbstractAudioInput =
  QAbstractAudioInput(h: fcQAudioSystemFactoryInterface_createInput(self.h, struct_miqt_string(data: cast[cstring](if len(device) == 0: nil else: unsafeAddr device[0]), len: csize_t(len(device)))))

proc createOutput*(self: gen_qaudiosystemplugin_types.QAudioSystemFactoryInterface, device: seq[byte]): QAbstractAudioOutput =
  QAbstractAudioOutput(h: fcQAudioSystemFactoryInterface_createOutput(self.h, struct_miqt_string(data: cast[cstring](if len(device) == 0: nil else: unsafeAddr device[0]), len: csize_t(len(device)))))

proc createDeviceInfo*(self: gen_qaudiosystemplugin_types.QAudioSystemFactoryInterface, device: seq[byte], mode: cint): QAbstractAudioDeviceInfo =
  QAbstractAudioDeviceInfo(h: fcQAudioSystemFactoryInterface_createDeviceInfo(self.h, struct_miqt_string(data: cast[cstring](if len(device) == 0: nil else: unsafeAddr device[0]), len: csize_t(len(device))), cint(mode)))

proc operatorAssign*(self: gen_qaudiosystemplugin_types.QAudioSystemFactoryInterface, param1: QAudioSystemFactoryInterface): void =
...
proc create*(T: type gen_qaudiosystemplugin_types.QAudioSystemPlugin, parent: QObject): gen_qaudiosystemplugin_types.QAudioSystemPlugin =
  gen_qaudiosystemplugin_types.QAudioSystemPlugin.init(fcQAudioSystemPlugin_new2(parent.h))

proc metaObject*(self: gen_qaudiosystemplugin_types.QAudioSystemPlugin, ): QMetaObject =
  QMetaObject(h: fcQAudioSystemPlugin_metaObject(self.h))
...
proc createInput*(self: gen_qaudiosystemplugin_types.QAudioSystemPlugin, device: seq[byte]): QAbstractAudioInput =
  QAbstractAudioInput(h: fcQAudioSystemPlugin_createInput(self.h, struct_miqt_string(data: cast[cstring](if len(device) == 0: nil else: unsafeAddr device[0]), len: csize_t(len(device)))))

proc createOutput*(self: gen_qaudiosystemplugin_types.QAudioSystemPlugin, device: seq[byte]): QAbstractAudioOutput =
  QAbstractAudioOutput(h: fcQAudioSystemPlugin_createOutput(self.h, struct_miqt_string(data: cast[cstring](if len(device) == 0: nil else: unsafeAddr device[0]), len: csize_t(len(device)))))

proc createDeviceInfo*(self: gen_qaudiosystemplugin_types.QAudioSystemPlugin, device: seq[byte], mode: cint): QAbstractAudioDeviceInfo =
  QAbstractAudioDeviceInfo(h: fcQAudioSystemPlugin_createDeviceInfo(self.h, struct_miqt_string(data: cast[cstring](if len(device) == 0: nil else: unsafeAddr device[0]), len: csize_t(len(device))), cint(mode)))
...
type QAudioSystemPlugincreateInputProc* = proc(device: seq[byte]): QAbstractAudioInput
...
proc miqt_exec_callback_QAudioSystemPlugin_createInput(self: ptr cQAudioSystemPlugin, slot: int, device: struct_miqt_string): pointer {.exportc: "miqt_exec_callback_QAudioSystemPlugin_createInput ".} =
  ...
  virtualReturn.h
type QAudioSystemPlugincreateOutputProc* = proc(device: seq[byte]): QAbstractAudioOutput
...
proc miqt_exec_callback_QAudioSystemPlugin_createOutput(self: ptr cQAudioSystemPlugin, slot: int, device: struct_miqt_string): pointer {.exportc: "miqt_exec_callback_QAudioSystemPlugin_createOutput ".} =
  ...
  virtualReturn.h
type QAudioSystemPlugincreateDeviceInfoProc* = proc(device: seq[byte], mode: cint): QAbstractAudioDeviceInfo
...
proc miqt_exec_callback_QAudioSystemPlugin_createDeviceInfo(self: ptr cQAudioSystemPlugin, slot: int, device: struct_miqt_string, mode: cint): pointer {.exportc: "miqt_exec_callback_QAudioSystemPlugin_createDeviceInfo ".} =
  ...
  virtualReturn.h
proc QAudioSystemPluginevent*(self: gen_qaudiosystemplugin_types.QAudioSystemPlugin, event: QEvent): bool =
  fQAudioSystemPlugin_virtualbase_event(self.h, event.h)

type QAudioSystemPlugineventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QAudioSystemPlugin_event(self: ptr cQAudioSystemPlugin, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QAudioSystemPlugin_event ".} =
  ...
  virtualReturn
proc QAudioSystemPlugineventFilter*(self: gen_qaudiosystemplugin_types.QAudioSystemPlugin, watched: QObject, event: QEvent): bool =
  fQAudioSystemPlugin_virtualbase_eventFilter(self.h, watched.h, event.h)

type QAudioSystemPlugineventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QAudioSystemPlugin_eventFilter(self: ptr cQAudioSystemPlugin, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QAudioSystemPlugin_eventFilter ".} =
  ...
  virtualReturn
proc QAudioSystemPlugintimerEvent*(self: gen_qaudiosystemplugin_types.QAudioSystemPlugin, event: QTimerEvent): void =
  fQAudioSystemPlugin_virtualbase_timerEvent(self.h, event.h)

type QAudioSystemPlugintimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QAudioSystemPlugin_timerEvent(self: ptr cQAudioSystemPlugin, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QAudioSystemPlugin_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QAudioSystemPluginchildEvent*(self: gen_qaudiosystemplugin_types.QAudioSystemPlugin, event: QChildEvent): void =
  fQAudioSystemPlugin_virtualbase_childEvent(self.h, event.h)

type QAudioSystemPluginchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QAudioSystemPlugin_childEvent(self: ptr cQAudioSystemPlugin, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QAudioSystemPlugin_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QAudioSystemPlugincustomEvent*(self: gen_qaudiosystemplugin_types.QAudioSystemPlugin, event: QEvent): void =
  fQAudioSystemPlugin_virtualbase_customEvent(self.h, event.h)

type QAudioSystemPlugincustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QAudioSystemPlugin_customEvent(self: ptr cQAudioSystemPlugin, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QAudioSystemPlugin_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QAudioSystemPluginconnectNotify*(self: gen_qaudiosystemplugin_types.QAudioSystemPlugin, signal: QMetaMethod): void =
  fQAudioSystemPlugin_virtualbase_connectNotify(self.h, signal.h)

type QAudioSystemPluginconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QAudioSystemPlugin_connectNotify(self: ptr cQAudioSystemPlugin, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QAudioSystemPlugin_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QAudioSystemPlugindisconnectNotify*(self: gen_qaudiosystemplugin_types.QAudioSystemPlugin, signal: QMetaMethod): void =
  fQAudioSystemPlugin_virtualbase_disconnectNotify(self.h, signal.h)

type QAudioSystemPlugindisconnectNotifyProc* = proc(signal: QMetaMethod): void
