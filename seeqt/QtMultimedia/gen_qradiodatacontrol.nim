...
proc miqt_exec_callback_cQRadioDataControl_stationIdChanged(slot: int, stationId: struct_miqt_string) {.cdecl.} =
...
proc miqt_exec_callback_cQRadioDataControl_stationIdChanged_release(slot: int) {.cdecl.} =
...
proc onstationIdChanged*(self: gen_qradiodatacontrol_types.QRadioDataControl, slot: QRadioDataControlstationIdChangedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQRadioDataControl_connect_stationIdChanged(self.h, cast[int](addr tmp[]), miqt_exec_callback_cQRadioDataControl_stationIdChanged, miqt_exec_callback_cQRadioDataControl_stationIdChanged_release)
...
proc miqt_exec_callback_cQRadioDataControl_programTypeChanged(slot: int, programType: cint) {.cdecl.} =
  let nimfunc = cast[ptr QRadioDataControlprogramTypeChangedSlot](cast[pointer](slot))
  let slotval1 = cint(programType)

  nimfunc[](slotval1)

proc miqt_exec_callback_cQRadioDataControl_programTypeChanged_release(slot: int) {.cdecl.} =
...
proc onprogramTypeChanged*(self: gen_qradiodatacontrol_types.QRadioDataControl, slot: QRadioDataControlprogramTypeChangedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQRadioDataControl_connect_programTypeChanged(self.h, cast[int](addr tmp[]), miqt_exec_callback_cQRadioDataControl_programTypeChanged, miqt_exec_callback_cQRadioDataControl_programTypeChanged_release)
...
proc miqt_exec_callback_cQRadioDataControl_programTypeNameChanged(slot: int, programTypeName: struct_miqt_string) {.cdecl.} =
...
proc miqt_exec_callback_cQRadioDataControl_programTypeNameChanged_release(slot: int) {.cdecl.} =
...
proc onprogramTypeNameChanged*(self: gen_qradiodatacontrol_types.QRadioDataControl, slot: QRadioDataControlprogramTypeNameChangedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQRadioDataControl_connect_programTypeNameChanged(self.h, cast[int](addr tmp[]), miqt_exec_callback_cQRadioDataControl_programTypeNameChanged, miqt_exec_callback_cQRadioDataControl_programTypeNameChanged_release)
...
proc miqt_exec_callback_cQRadioDataControl_stationNameChanged(slot: int, stationName: struct_miqt_string) {.cdecl.} =
...
proc miqt_exec_callback_cQRadioDataControl_stationNameChanged_release(slot: int) {.cdecl.} =
...
proc onstationNameChanged*(self: gen_qradiodatacontrol_types.QRadioDataControl, slot: QRadioDataControlstationNameChangedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQRadioDataControl_connect_stationNameChanged(self.h, cast[int](addr tmp[]), miqt_exec_callback_cQRadioDataControl_stationNameChanged, miqt_exec_callback_cQRadioDataControl_stationNameChanged_release)
...
proc miqt_exec_callback_cQRadioDataControl_radioTextChanged(slot: int, radioText: struct_miqt_string) {.cdecl.} =
...
proc miqt_exec_callback_cQRadioDataControl_radioTextChanged_release(slot: int) {.cdecl.} =
...
proc onradioTextChanged*(self: gen_qradiodatacontrol_types.QRadioDataControl, slot: QRadioDataControlradioTextChangedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQRadioDataControl_connect_radioTextChanged(self.h, cast[int](addr tmp[]), miqt_exec_callback_cQRadioDataControl_radioTextChanged, miqt_exec_callback_cQRadioDataControl_radioTextChanged_release)
...
proc miqt_exec_callback_cQRadioDataControl_alternativeFrequenciesEnabledChanged(slot: int, enabled: bool) {.cdecl.} =
  let nimfunc = cast[ptr QRadioDataControlalternativeFrequenciesEnabledChangedSlot](cast[pointer](slot))
  let slotval1 = enabled

  nimfunc[](slotval1)

proc miqt_exec_callback_cQRadioDataControl_alternativeFrequenciesEnabledChanged_release(slot: int) {.cdecl.} =
...
proc onalternativeFrequenciesEnabledChanged*(self: gen_qradiodatacontrol_types.QRadioDataControl, slot: QRadioDataControlalternativeFrequenciesEnabledChangedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQRadioDataControl_connect_alternativeFrequenciesEnabledChanged(self.h, cast[int](addr tmp[]), miqt_exec_callback_cQRadioDataControl_alternativeFrequenciesEnabledChanged, miqt_exec_callback_cQRadioDataControl_alternativeFrequenciesEnabledChanged_release)
...
proc miqt_exec_callback_cQRadioDataControl_errorWithErr(slot: int, err: cint) {.cdecl.} =
  let nimfunc = cast[ptr QRadioDataControlerrorWithErrSlot](cast[pointer](slot))
  let slotval1 = cint(err)

  nimfunc[](slotval1)

proc miqt_exec_callback_cQRadioDataControl_errorWithErr_release(slot: int) {.cdecl.} =
...
proc onerror*(self: gen_qradiodatacontrol_types.QRadioDataControl, slot: QRadioDataControlerrorWithErrSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQRadioDataControl_connect_errorWithErr(self.h, cast[int](addr tmp[]), miqt_exec_callback_cQRadioDataControl_errorWithErr, miqt_exec_callback_cQRadioDataControl_errorWithErr_release)
