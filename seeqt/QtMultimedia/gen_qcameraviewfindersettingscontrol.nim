...
func init*(T: type gen_qcameraviewfindersettingscontrol_types.QCameraViewfinderSettingsControl, h: ptr cQCameraViewfinderSettingsControl): gen_qcameraviewfindersettingscontrol_types.QCameraViewfinderSettingsControl =
  T(h: h)
proc metaObject*(self: gen_qcameraviewfindersettingscontrol_types.QCameraViewfinderSettingsControl, ): QMetaObject =
  QMetaObject(h: fcQCameraViewfinderSettingsControl_metaObject(self.h))
...
proc viewfinderParameter*(self: gen_qcameraviewfindersettingscontrol_types.QCameraViewfinderSettingsControl, parameter: cint): QVariant =
  QVariant(h: fcQCameraViewfinderSettingsControl_viewfinderParameter(self.h, cint(parameter)))

proc setViewfinderParameter*(self: gen_qcameraviewfindersettingscontrol_types.QCameraViewfinderSettingsControl, parameter: cint, value: QVariant): void =
...
func init*(T: type gen_qcameraviewfindersettingscontrol_types.QCameraViewfinderSettingsControl2, h: ptr cQCameraViewfinderSettingsControl2): gen_qcameraviewfindersettingscontrol_types.QCameraViewfinderSettingsControl2 =
  T(h: h)
proc metaObject*(self: gen_qcameraviewfindersettingscontrol_types.QCameraViewfinderSettingsControl2, ): QMetaObject =
  QMetaObject(h: fcQCameraViewfinderSettingsControl2_metaObject(self.h))
...
proc supportedViewfinderSettings*(self: gen_qcameraviewfindersettingscontrol_types.QCameraViewfinderSettingsControl2, ): seq[QCameraViewfinderSettings] =
...
proc viewfinderSettings*(self: gen_qcameraviewfindersettingscontrol_types.QCameraViewfinderSettingsControl2, ): QCameraViewfinderSettings =
  QCameraViewfinderSettings(h: fcQCameraViewfinderSettingsControl2_viewfinderSettings(self.h))

proc setViewfinderSettings*(self: gen_qcameraviewfindersettingscontrol_types.QCameraViewfinderSettingsControl2, settings: QCameraViewfinderSettings): void =
