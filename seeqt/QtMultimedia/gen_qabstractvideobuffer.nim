...
proc handle*(self: gen_qabstractvideobuffer_types.QAbstractVideoBuffer, ): QVariant =
  QVariant(h: fcQAbstractVideoBuffer_handle(self.h))
...
proc miqt_exec_callback_QAbstractVideoBuffer_unmap(self: ptr cQAbstractVideoBuffer, slot: int): void {.exportc: "miqt_exec_callback_QAbstractVideoBuffer_unmap ".} =
  ...
  nimfunc[]()
proc QAbstractVideoBufferhandle*(self: gen_qabstractvideobuffer_types.QAbstractVideoBuffer, ): QVariant =
  QVariant(h: fQAbstractVideoBuffer_virtualbase_handle(self.h))

type QAbstractVideoBufferhandleProc* = proc(): QVariant
...
proc miqt_exec_callback_QAbstractPlanarVideoBuffer_unmap(self: ptr cQAbstractPlanarVideoBuffer, slot: int): void {.exportc: "miqt_exec_callback_QAbstractPlanarVideoBuffer_unmap ".} =
  ...
  nimfunc[]()
proc QAbstractPlanarVideoBufferhandle*(self: gen_qabstractvideobuffer_types.QAbstractPlanarVideoBuffer, ): QVariant =
  QVariant(h: fQAbstractPlanarVideoBuffer_virtualbase_handle(self.h))

type QAbstractPlanarVideoBufferhandleProc* = proc(): QVariant
