...
func init*(T: type gen_qmediarecordercontrol_types.QMediaRecorderControl, h: ptr cQMediaRecorderControl): gen_qmediarecordercontrol_types.QMediaRecorderControl =
  T(h: h)
proc metaObject*(self: gen_qmediarecordercontrol_types.QMediaRecorderControl, ): QMetaObject =
  QMetaObject(h: fcQMediaRecorderControl_metaObject(self.h))
...
proc outputLocation*(self: gen_qmediarecordercontrol_types.QMediaRecorderControl, ): QUrl =
  QUrl(h: fcQMediaRecorderControl_outputLocation(self.h))

proc setOutputLocation*(self: gen_qmediarecordercontrol_types.QMediaRecorderControl, location: QUrl): bool =
...
proc actualLocationChanged*(self: gen_qmediarecordercontrol_types.QMediaRecorderControl, location: QUrl): void =
  fcQMediaRecorderControl_actualLocationChanged(self.h, location.h)

type QMediaRecorderControlactualLocationChangedSlot* = proc(location: QUrl)
