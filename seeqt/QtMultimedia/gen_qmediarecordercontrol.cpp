...
void QMediaRecorderControl_connect_stateChanged(QMediaRecorderControl* self, intptr_t slot, void (*callback)(intptr_t, int), void (*release)(intptr_t)) {
	...
	QMediaRecorderControl::connect(self, static_cast<void (QMediaRecorderControl::*)(QMediaRecorder::State)>(&QMediaRecorderControl::stateChanged), self, caller{slot, callback, release});
}
...
void QMediaRecorderControl_connect_statusChanged(QMediaRecorderControl* self, intptr_t slot, void (*callback)(intptr_t, int), void (*release)(intptr_t)) {
	...
	QMediaRecorderControl::connect(self, static_cast<void (QMediaRecorderControl::*)(QMediaRecorder::Status)>(&QMediaRecorderControl::statusChanged), self, caller{slot, callback, release});
}
...
void QMediaRecorderControl_connect_durationChanged(QMediaRecorderControl* self, intptr_t slot, void (*callback)(intptr_t, long long), void (*release)(intptr_t)) {
	...
	QMediaRecorderControl::connect(self, static_cast<void (QMediaRecorderControl::*)(qint64)>(&QMediaRecorderControl::durationChanged), self, caller{slot, callback, release});
}
...
void QMediaRecorderControl_connect_mutedChanged(QMediaRecorderControl* self, intptr_t slot, void (*callback)(intptr_t, bool), void (*release)(intptr_t)) {
	...
	QMediaRecorderControl::connect(self, static_cast<void (QMediaRecorderControl::*)(bool)>(&QMediaRecorderControl::mutedChanged), self, caller{slot, callback, release});
}
...
void QMediaRecorderControl_connect_volumeChanged(QMediaRecorderControl* self, intptr_t slot, void (*callback)(intptr_t, double), void (*release)(intptr_t)) {
	...
	QMediaRecorderControl::connect(self, static_cast<void (QMediaRecorderControl::*)(qreal)>(&QMediaRecorderControl::volumeChanged), self, caller{slot, callback, release});
}
...
void QMediaRecorderControl_connect_actualLocationChanged(QMediaRecorderControl* self, intptr_t slot, void (*callback)(intptr_t, QUrl*), void (*release)(intptr_t)) {
	...
	QMediaRecorderControl::connect(self, static_cast<void (QMediaRecorderControl::*)(const QUrl&)>(&QMediaRecorderControl::actualLocationChanged), self, caller{slot, callback, release});
}
...
void QMediaRecorderControl_connect_error(QMediaRecorderControl* self, intptr_t slot, void (*callback)(intptr_t, int, struct miqt_string), void (*release)(intptr_t)) {
	...
	QMediaRecorderControl::connect(self, static_cast<void (QMediaRecorderControl::*)(int, const QString&)>(&QMediaRecorderControl::error), self, caller{slot, callback, release});
}
