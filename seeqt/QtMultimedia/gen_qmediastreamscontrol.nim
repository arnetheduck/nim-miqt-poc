...
func init*(T: type gen_qmediastreamscontrol_types.QMediaStreamsControl, h: ptr cQMediaStreamsControl): gen_qmediastreamscontrol_types.QMediaStreamsControl =
  T(h: h)
proc metaObject*(self: gen_qmediastreamscontrol_types.QMediaStreamsControl, ): QMetaObject =
  QMetaObject(h: fcQMediaStreamsControl_metaObject(self.h))
...
proc metaData*(self: gen_qmediastreamscontrol_types.QMediaStreamsControl, streamNumber: cint, key: string): QVariant =
  QVariant(h: fcQMediaStreamsControl_metaData(self.h, streamNumber, struct_miqt_string(data: key, len: csize_t(len(key)))))
