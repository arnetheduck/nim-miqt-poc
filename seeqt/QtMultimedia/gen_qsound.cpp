...
public:
	...
	MiqtVirtualQSound(struct QSound_VTable* vtbl, const QString& filename): QSound(filename), vtbl(vtbl) {};
	MiqtVirtualQSound(struct QSound_VTable* vtbl, const QString& filename, QObject* parent): QSound(filename, parent), vtbl(vtbl) {};

	virtual ~MiqtVirtualQSound() override { if(vtbl->destructor) vtbl->destructor(vtbl, this); }
...
QSound* QSound_new(struct QSound_VTable* vtbl, struct miqt_string filename) {
	...
	return new MiqtVirtualQSound(vtbl, filename_QString);
}

QSound* QSound_new2(struct QSound_VTable* vtbl, struct miqt_string filename, QObject* parent) {
	QString filename_QString = QString::fromUtf8(filename.data, filename.len);
	return new MiqtVirtualQSound(vtbl, filename_QString, parent);
}
...
QMetaObject* QSound_virtualbase_metaObject(const void* self) {
	...
	return (QMetaObject*) ( (const MiqtVirtualQSound*)(self) )->QSound::metaObject();

}

void* QSound_virtualbase_metacast(void* self, const char* param1) {

	return ( (MiqtVirtualQSound*)(self) )->QSound::qt_metacast(param1);

}

int QSound_virtualbase_metacall(void* self, int param1, int param2, void** param3) {

	return ( (MiqtVirtualQSound*)(self) )->QSound::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);

}

bool QSound_virtualbase_event(void* self, QEvent* event) {

	return ( (MiqtVirtualQSound*)(self) )->QSound::event(event);

}

bool QSound_virtualbase_eventFilter(void* self, QObject* watched, QEvent* event) {

	return ( (MiqtVirtualQSound*)(self) )->QSound::eventFilter(watched, event);

}

void QSound_virtualbase_timerEvent(void* self, QTimerEvent* event) {

	( (MiqtVirtualQSound*)(self) )->QSound::timerEvent(event);

}

void QSound_virtualbase_childEvent(void* self, QChildEvent* event) {

	( (MiqtVirtualQSound*)(self) )->QSound::childEvent(event);

}

void QSound_virtualbase_customEvent(void* self, QEvent* event) {

	( (MiqtVirtualQSound*)(self) )->QSound::customEvent(event);

}

void QSound_virtualbase_connectNotify(void* self, QMetaMethod* signal) {

	( (MiqtVirtualQSound*)(self) )->QSound::connectNotify(*signal);

}

void QSound_virtualbase_disconnectNotify(void* self, QMetaMethod* signal) {

	( (MiqtVirtualQSound*)(self) )->QSound::disconnectNotify(*signal);
...
QObject* QSound_protectedbase_sender(const void* self) {
	MiqtVirtualQSound* self_cast = static_cast<MiqtVirtualQSound*>( (QSound*)(self) );
