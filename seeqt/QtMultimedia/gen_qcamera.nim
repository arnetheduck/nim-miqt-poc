...
proc create*(T: type gen_qcamera_types.QCamera, cameraInfo: QCameraInfo): gen_qcamera_types.QCamera =
...
proc create*(T: type gen_qcamera_types.QCamera, parent: QObject): gen_qcamera_types.QCamera =
  gen_qcamera_types.QCamera.init(fcQCamera_new5(parent.h))

proc create*(T: type gen_qcamera_types.QCamera, deviceName: seq[byte], parent: QObject): gen_qcamera_types.QCamera =
...
proc create*(T: type gen_qcamera_types.QCamera, cameraInfo: QCameraInfo, parent: QObject): gen_qcamera_types.QCamera =
  gen_qcamera_types.QCamera.init(fcQCamera_new7(cameraInfo.h, parent.h))

proc create*(T: type gen_qcamera_types.QCamera, position: cint, parent: QObject): gen_qcamera_types.QCamera =
  gen_qcamera_types.QCamera.init(fcQCamera_new8(cint(position), parent.h))

proc metaObject*(self: gen_qcamera_types.QCamera, ): QMetaObject =
  QMetaObject(h: fcQCamera_metaObject(self.h))
...
proc exposure*(self: gen_qcamera_types.QCamera, ): QCameraExposure =
  QCameraExposure(h: fcQCamera_exposure(self.h))

proc focus*(self: gen_qcamera_types.QCamera, ): QCameraFocus =
  QCameraFocus(h: fcQCamera_focus(self.h))

proc imageProcessing*(self: gen_qcamera_types.QCamera, ): QCameraImageProcessing =
  QCameraImageProcessing(h: fcQCamera_imageProcessing(self.h))
...
proc setViewfinder*(self: gen_qcamera_types.QCamera, surface: QAbstractVideoSurface): void =
  fcQCamera_setViewfinderWithSurface(self.h, surface.h)

proc viewfinderSettings*(self: gen_qcamera_types.QCamera, ): QCameraViewfinderSettings =
  QCameraViewfinderSettings(h: fcQCamera_viewfinderSettings(self.h))

proc setViewfinderSettings*(self: gen_qcamera_types.QCamera, settings: QCameraViewfinderSettings): void =
  fcQCamera_setViewfinderSettings(self.h, settings.h)

proc supportedViewfinderSettings*(self: gen_qcamera_types.QCamera, ): seq[QCameraViewfinderSettings] =
  var v_ma = fcQCamera_supportedViewfinderSettings(self.h)
  var vx_ret = newSeq[QCameraViewfinderSettings](int(v_ma.len))
  let v_outCast = cast[ptr UncheckedArray[pointer]](v_ma.data)
  for i in 0 ..< v_ma.len:
    vx_ret[i] = QCameraViewfinderSettings(h: v_outCast[i])
  vx_ret

proc supportedViewfinderResolutions*(self: gen_qcamera_types.QCamera, ): seq[QSize] =
...
proc supportedViewfinderFrameRateRanges*(self: gen_qcamera_types.QCamera, ): seq[QCameraFrameRateRange] =
...
proc supportedViewfinderSettings*(self: gen_qcamera_types.QCamera, settings: QCameraViewfinderSettings): seq[QCameraViewfinderSettings] =
...
proc supportedViewfinderResolutions*(self: gen_qcamera_types.QCamera, settings: QCameraViewfinderSettings): seq[QSize] =
...
proc supportedViewfinderFrameRateRanges*(self: gen_qcamera_types.QCamera, settings: QCameraViewfinderSettings): seq[QCameraFrameRateRange] =
...
proc supportedViewfinderPixelFormats*(self: gen_qcamera_types.QCamera, settings: QCameraViewfinderSettings): seq[cint] =
...
proc miqt_exec_callback_QCamera_isAvailable(self: ptr cQCamera, slot: int): bool {.exportc: "miqt_exec_callback_QCamera_isAvailable ".} =
  ...
  virtualReturn
proc QCameraservice*(self: gen_qcamera_types.QCamera, ): QMediaService =
  QMediaService(h: fQCamera_virtualbase_service(self.h))

type QCameraserviceProc* = proc(): QMediaService
...
proc miqt_exec_callback_QCamera_service(self: ptr cQCamera, slot: int): pointer {.exportc: "miqt_exec_callback_QCamera_service ".} =
  ...
  virtualReturn.h
proc QCamerabindX*(self: gen_qcamera_types.QCamera, param1: QObject): bool =
  fQCamera_virtualbase_bind(self.h, param1.h)

type QCamerabindXProc* = proc(param1: QObject): bool
...
proc miqt_exec_callback_QCamera_bind(self: ptr cQCamera, slot: int, param1: pointer): bool {.exportc: "miqt_exec_callback_QCamera_bind ".} =
  ...
  virtualReturn
proc QCameraunbind*(self: gen_qcamera_types.QCamera, param1: QObject): void =
  fQCamera_virtualbase_unbind(self.h, param1.h)

type QCameraunbindProc* = proc(param1: QObject): void
...
proc miqt_exec_callback_QCamera_unbind(self: ptr cQCamera, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QCamera_unbind ".} =
  ...
  nimfunc[](slotval1)
proc QCameraevent*(self: gen_qcamera_types.QCamera, event: QEvent): bool =
  fQCamera_virtualbase_event(self.h, event.h)

type QCameraeventProc* = proc(event: QEvent): bool
...
proc miqt_exec_callback_QCamera_event(self: ptr cQCamera, slot: int, event: pointer): bool {.exportc: "miqt_exec_callback_QCamera_event ".} =
  ...
  virtualReturn
proc QCameraeventFilter*(self: gen_qcamera_types.QCamera, watched: QObject, event: QEvent): bool =
  fQCamera_virtualbase_eventFilter(self.h, watched.h, event.h)

type QCameraeventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QCamera_eventFilter(self: ptr cQCamera, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QCamera_eventFilter ".} =
  ...
  virtualReturn
proc QCameratimerEvent*(self: gen_qcamera_types.QCamera, event: QTimerEvent): void =
  fQCamera_virtualbase_timerEvent(self.h, event.h)

type QCameratimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QCamera_timerEvent(self: ptr cQCamera, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QCamera_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QCamerachildEvent*(self: gen_qcamera_types.QCamera, event: QChildEvent): void =
  fQCamera_virtualbase_childEvent(self.h, event.h)

type QCamerachildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QCamera_childEvent(self: ptr cQCamera, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QCamera_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QCameracustomEvent*(self: gen_qcamera_types.QCamera, event: QEvent): void =
  fQCamera_virtualbase_customEvent(self.h, event.h)

type QCameracustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QCamera_customEvent(self: ptr cQCamera, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QCamera_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QCameraconnectNotify*(self: gen_qcamera_types.QCamera, signal: QMetaMethod): void =
  fQCamera_virtualbase_connectNotify(self.h, signal.h)

type QCameraconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QCamera_connectNotify(self: ptr cQCamera, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QCamera_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QCameradisconnectNotify*(self: gen_qcamera_types.QCamera, signal: QMetaMethod): void =
  fQCamera_virtualbase_disconnectNotify(self.h, signal.h)

type QCameradisconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc create*(T: type gen_qcamera_types.QCameraFrameRateRange, param1: QCameraFrameRateRange): gen_qcamera_types.QCameraFrameRateRange =
