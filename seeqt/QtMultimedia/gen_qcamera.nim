...
proc create*(T: type gen_qcamera_types.QCamera, cameraDevice: QCameraDevice): gen_qcamera_types.QCamera =
...
proc create*(T: type gen_qcamera_types.QCamera, cameraDevice: QCameraDevice, parent: QObject): gen_qcamera_types.QCamera =
...
proc captureSession*(self: gen_qcamera_types.QCamera, ): QMediaCaptureSession =
  QMediaCaptureSession(h: fcQCamera_captureSession(self.h))

proc cameraDevice*(self: gen_qcamera_types.QCamera, ): QCameraDevice =
  QCameraDevice(h: fcQCamera_cameraDevice(self.h))

proc setCameraDevice*(self: gen_qcamera_types.QCamera, cameraDevice: QCameraDevice): void =
  fcQCamera_setCameraDevice(self.h, cameraDevice.h)

proc cameraFormat*(self: gen_qcamera_types.QCamera, ): QCameraFormat =
  QCameraFormat(h: fcQCamera_cameraFormat(self.h))

proc setCameraFormat*(self: gen_qcamera_types.QCamera, format: QCameraFormat): void =
...
proc focusPoint*(self: gen_qcamera_types.QCamera, ): QPointF =
  QPointF(h: fcQCamera_focusPoint(self.h))

proc customFocusPoint*(self: gen_qcamera_types.QCamera, ): QPointF =
  QPointF(h: fcQCamera_customFocusPoint(self.h))

proc setCustomFocusPoint*(self: gen_qcamera_types.QCamera, point: QPointF): void =
