...
proc create*(T: type gen_qmediaresource_types.QMediaResource,
    request: ptr QNetworkRequest): gen_qmediaresource_types.QMediaResource =
  gen_qmediaresource_types.QMediaResource(h: fcQMediaResource_new3(request), owned: true)
...
proc create*(T: type gen_qmediaresource_types.QMediaResource,
    request: ptr QNetworkRequest, mimeType: string): gen_qmediaresource_types.QMediaResource =
  gen_qmediaresource_types.QMediaResource(h: fcQMediaResource_new6(request, struct_miqt_string(data: mimeType, len: csize_t(len(mimeType)))), owned: true)
