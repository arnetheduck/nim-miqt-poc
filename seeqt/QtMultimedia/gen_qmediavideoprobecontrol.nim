...
func init*(T: type gen_qmediavideoprobecontrol_types.QMediaVideoProbeControl, h: ptr cQMediaVideoProbeControl): gen_qmediavideoprobecontrol_types.QMediaVideoProbeControl =
  T(h: h)
proc metaObject*(self: gen_qmediavideoprobecontrol_types.QMediaVideoProbeControl, ): QMetaObject =
  QMetaObject(h: fcQMediaVideoProbeControl_metaObject(self.h))
...
proc videoFrameProbed*(self: gen_qmediavideoprobecontrol_types.QMediaVideoProbeControl, frame: QVideoFrame): void =
  fcQMediaVideoProbeControl_videoFrameProbed(self.h, frame.h)

type QMediaVideoProbeControlvideoFrameProbedSlot* = proc(frame: QVideoFrame)
