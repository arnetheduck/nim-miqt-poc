...
func init*(T: type gen_qmetadatareadercontrol_types.QMetaDataReaderControl, h: ptr cQMetaDataReaderControl): gen_qmetadatareadercontrol_types.QMetaDataReaderControl =
  T(h: h)
proc metaObject*(self: gen_qmetadatareadercontrol_types.QMetaDataReaderControl, ): QMetaObject =
  QMetaObject(h: fcQMetaDataReaderControl_metaObject(self.h))
...
proc metaData*(self: gen_qmetadatareadercontrol_types.QMetaDataReaderControl, key: string): QVariant =
  QVariant(h: fcQMetaDataReaderControl_metaData(self.h, struct_miqt_string(data: key, len: csize_t(len(key)))))
...
proc metaDataChanged*(self: gen_qmetadatareadercontrol_types.QMetaDataReaderControl, key: string, value: QVariant): void =
  fcQMetaDataReaderControl_metaDataChanged2(self.h, struct_miqt_string(data: key, len: csize_t(len(key))), value.h)

type QMetaDataReaderControlmetaDataChanged2Slot* = proc(key: string, value: QVariant)
