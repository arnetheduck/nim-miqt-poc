...
proc create*(T: type gen_qvideoframe_types.QVideoFrame, bytes: cint, size: QSize, bytesPerLine: cint, format: cint): gen_qvideoframe_types.QVideoFrame =
  gen_qvideoframe_types.QVideoFrame.init(fcQVideoFrame_new2(bytes, size.h, bytesPerLine, cint(format)))

proc create*(T: type gen_qvideoframe_types.QVideoFrame, image: QImage): gen_qvideoframe_types.QVideoFrame =
...
proc handle*(self: gen_qvideoframe_types.QVideoFrame, ): QVariant =
  QVariant(h: fcQVideoFrame_handle(self.h))
...
proc availableMetaData*(self: gen_qvideoframe_types.QVideoFrame, ): Table[string,QVariant] =
...
proc metaData*(self: gen_qvideoframe_types.QVideoFrame, key: string): QVariant =
  QVariant(h: fcQVideoFrame_metaData(self.h, struct_miqt_string(data: key, len: csize_t(len(key)))))

proc setMetaData*(self: gen_qvideoframe_types.QVideoFrame, key: string, value: QVariant): void =
  fcQVideoFrame_setMetaData(self.h, struct_miqt_string(data: key, len: csize_t(len(key))), value.h)

proc image*(self: gen_qvideoframe_types.QVideoFrame, ): QImage =
  QImage(h: fcQVideoFrame_image(self.h))
