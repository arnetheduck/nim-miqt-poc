...
public:
	...
	MiqtVirtualQCamera(struct QCamera_VTable* vtbl, const QByteArray& deviceName): QCamera(deviceName), vtbl(vtbl) {};
	MiqtVirtualQCamera(struct QCamera_VTable* vtbl, const QCameraInfo& cameraInfo): QCamera(cameraInfo), vtbl(vtbl) {};
	MiqtVirtualQCamera(struct QCamera_VTable* vtbl, QCamera::Position position): QCamera(position), vtbl(vtbl) {};
	MiqtVirtualQCamera(struct QCamera_VTable* vtbl, QObject* parent): QCamera(parent), vtbl(vtbl) {};
	MiqtVirtualQCamera(struct QCamera_VTable* vtbl, const QByteArray& deviceName, QObject* parent): QCamera(deviceName, parent), vtbl(vtbl) {};
	MiqtVirtualQCamera(struct QCamera_VTable* vtbl, const QCameraInfo& cameraInfo, QObject* parent): QCamera(cameraInfo, parent), vtbl(vtbl) {};
	MiqtVirtualQCamera(struct QCamera_VTable* vtbl, QCamera::Position position, QObject* parent): QCamera(position, parent), vtbl(vtbl) {};
...
QCamera* QCamera_new2(struct QCamera_VTable* vtbl, struct miqt_string deviceName) {
	...
	return new MiqtVirtualQCamera(vtbl, deviceName_QByteArray);
}

QCamera* QCamera_new3(struct QCamera_VTable* vtbl, QCameraInfo* cameraInfo) {
	return new MiqtVirtualQCamera(vtbl, *cameraInfo);
}

QCamera* QCamera_new4(struct QCamera_VTable* vtbl, int position) {
	return new MiqtVirtualQCamera(vtbl, static_cast<QCamera::Position>(position));
}
...
QCamera* QCamera_new6(struct QCamera_VTable* vtbl, struct miqt_string deviceName, QObject* parent) {
	QByteArray deviceName_QByteArray(deviceName.data, deviceName.len);
	return new MiqtVirtualQCamera(vtbl, deviceName_QByteArray, parent);
}

QCamera* QCamera_new7(struct QCamera_VTable* vtbl, QCameraInfo* cameraInfo, QObject* parent) {
	return new MiqtVirtualQCamera(vtbl, *cameraInfo, parent);
}

QCamera* QCamera_new8(struct QCamera_VTable* vtbl, int position, QObject* parent) {
	return new MiqtVirtualQCamera(vtbl, static_cast<QCamera::Position>(position), parent);
}
...
void QCamera_connect_stateChanged(QCamera* self, intptr_t slot, void (*callback)(intptr_t, int), void (*release)(intptr_t)) {
	...
	MiqtVirtualQCamera::connect(self, static_cast<void (QCamera::*)(QCamera::State)>(&QCamera::stateChanged), self, caller{slot, callback, release});
}
...
void QCamera_connect_captureModeChanged(QCamera* self, intptr_t slot, void (*callback)(intptr_t, int), void (*release)(intptr_t)) {
	...
	MiqtVirtualQCamera::connect(self, static_cast<void (QCamera::*)(QCamera::CaptureModes)>(&QCamera::captureModeChanged), self, caller{slot, callback, release});
}
...
void QCamera_connect_statusChanged(QCamera* self, intptr_t slot, void (*callback)(intptr_t, int), void (*release)(intptr_t)) {
	...
	MiqtVirtualQCamera::connect(self, static_cast<void (QCamera::*)(QCamera::Status)>(&QCamera::statusChanged), self, caller{slot, callback, release});
}
...
void QCamera_connect_locked(QCamera* self, intptr_t slot, void (*callback)(intptr_t), void (*release)(intptr_t)) {
	...
	MiqtVirtualQCamera::connect(self, static_cast<void (QCamera::*)()>(&QCamera::locked), self, caller{slot, callback, release});
}
...
void QCamera_connect_lockFailed(QCamera* self, intptr_t slot, void (*callback)(intptr_t), void (*release)(intptr_t)) {
	...
	MiqtVirtualQCamera::connect(self, static_cast<void (QCamera::*)()>(&QCamera::lockFailed), self, caller{slot, callback, release});
}
...
void QCamera_connect_lockStatusChanged(QCamera* self, intptr_t slot, void (*callback)(intptr_t, int, int), void (*release)(intptr_t)) {
	...
	MiqtVirtualQCamera::connect(self, static_cast<void (QCamera::*)(QCamera::LockStatus, QCamera::LockChangeReason)>(&QCamera::lockStatusChanged), self, caller{slot, callback, release});
}
...
void QCamera_connect_lockStatusChanged2(QCamera* self, intptr_t slot, void (*callback)(intptr_t, int, int, int), void (*release)(intptr_t)) {
	...
	MiqtVirtualQCamera::connect(self, static_cast<void (QCamera::*)(QCamera::LockType, QCamera::LockStatus, QCamera::LockChangeReason)>(&QCamera::lockStatusChanged), self, caller{slot, callback, release});
}
...
void QCamera_connect_errorWithQCameraError(QCamera* self, intptr_t slot, void (*callback)(intptr_t, int), void (*release)(intptr_t)) {
	...
	MiqtVirtualQCamera::connect(self, static_cast<void (QCamera::*)(QCamera::Error)>(&QCamera::error), self, caller{slot, callback, release});
}
...
void QCamera_connect_errorOccurred(QCamera* self, intptr_t slot, void (*callback)(intptr_t, int), void (*release)(intptr_t)) {
	...
	MiqtVirtualQCamera::connect(self, static_cast<void (QCamera::*)(QCamera::Error)>(&QCamera::errorOccurred), self, caller{slot, callback, release});
}
