...
func init*(T: type gen_qvideoencodersettingscontrol_types.QVideoEncoderSettingsControl, h: ptr cQVideoEncoderSettingsControl): gen_qvideoencodersettingscontrol_types.QVideoEncoderSettingsControl =
  T(h: h)
proc metaObject*(self: gen_qvideoencodersettingscontrol_types.QVideoEncoderSettingsControl, ): QMetaObject =
  QMetaObject(h: fcQVideoEncoderSettingsControl_metaObject(self.h))
...
proc supportedResolutions*(self: gen_qvideoencodersettingscontrol_types.QVideoEncoderSettingsControl, settings: QVideoEncoderSettings, continuous: ptr bool): seq[QSize] =
...
proc supportedFrameRates*(self: gen_qvideoencodersettingscontrol_types.QVideoEncoderSettingsControl, settings: QVideoEncoderSettings, continuous: ptr bool): seq[float64] =
...
proc videoSettings*(self: gen_qvideoencodersettingscontrol_types.QVideoEncoderSettingsControl, ): QVideoEncoderSettings =
  QVideoEncoderSettings(h: fcQVideoEncoderSettingsControl_videoSettings(self.h))

proc setVideoSettings*(self: gen_qvideoencodersettingscontrol_types.QVideoEncoderSettingsControl, settings: QVideoEncoderSettings): void =
