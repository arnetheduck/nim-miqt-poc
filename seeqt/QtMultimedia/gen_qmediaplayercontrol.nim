...
func init*(T: type gen_qmediaplayercontrol_types.QMediaPlayerControl, h: ptr cQMediaPlayerControl): gen_qmediaplayercontrol_types.QMediaPlayerControl =
  T(h: h)
proc metaObject*(self: gen_qmediaplayercontrol_types.QMediaPlayerControl, ): QMetaObject =
  QMetaObject(h: fcQMediaPlayerControl_metaObject(self.h))
...
proc availablePlaybackRanges*(self: gen_qmediaplayercontrol_types.QMediaPlayerControl, ): QMediaTimeRange =
  QMediaTimeRange(h: fcQMediaPlayerControl_availablePlaybackRanges(self.h))
...
proc media*(self: gen_qmediaplayercontrol_types.QMediaPlayerControl, ): QMediaContent =
  QMediaContent(h: fcQMediaPlayerControl_media(self.h))

proc mediaStream*(self: gen_qmediaplayercontrol_types.QMediaPlayerControl, ): QIODevice =
  QIODevice(h: fcQMediaPlayerControl_mediaStream(self.h))

proc setMedia*(self: gen_qmediaplayercontrol_types.QMediaPlayerControl, media: QMediaContent, stream: QIODevice): void =
...
proc mediaChanged*(self: gen_qmediaplayercontrol_types.QMediaPlayerControl, content: QMediaContent): void =
  fcQMediaPlayerControl_mediaChanged(self.h, content.h)

type QMediaPlayerControlmediaChangedSlot* = proc(content: QMediaContent)
proc miqt_exec_callback_QMediaPlayerControl_mediaChanged(slot: int, content: pointer) {.exportc.} =
  ...
  let slotval1 = QMediaContent(h: content)
...
proc availablePlaybackRangesChanged*(self: gen_qmediaplayercontrol_types.QMediaPlayerControl, ranges: QMediaTimeRange): void =
  fcQMediaPlayerControl_availablePlaybackRangesChanged(self.h, ranges.h)

type QMediaPlayerControlavailablePlaybackRangesChangedSlot* = proc(ranges: QMediaTimeRange)
proc miqt_exec_callback_QMediaPlayerControl_availablePlaybackRangesChanged(slot: int, ranges: pointer) {.exportc.} =
  ...
  let slotval1 = QMediaTimeRange(h: ranges)
