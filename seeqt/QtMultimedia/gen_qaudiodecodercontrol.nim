...
func init*(T: type gen_qaudiodecodercontrol_types.QAudioDecoderControl, h: ptr cQAudioDecoderControl): gen_qaudiodecodercontrol_types.QAudioDecoderControl =
  T(h: h)
proc metaObject*(self: gen_qaudiodecodercontrol_types.QAudioDecoderControl, ): QMetaObject =
  QMetaObject(h: fcQAudioDecoderControl_metaObject(self.h))
...
proc sourceDevice*(self: gen_qaudiodecodercontrol_types.QAudioDecoderControl, ): QIODevice =
  QIODevice(h: fcQAudioDecoderControl_sourceDevice(self.h))

proc setSourceDevice*(self: gen_qaudiodecodercontrol_types.QAudioDecoderControl, device: QIODevice): void =
...
proc audioFormat*(self: gen_qaudiodecodercontrol_types.QAudioDecoderControl, ): QAudioFormat =
  QAudioFormat(h: fcQAudioDecoderControl_audioFormat(self.h))

proc setAudioFormat*(self: gen_qaudiodecodercontrol_types.QAudioDecoderControl, format: QAudioFormat): void =
  fcQAudioDecoderControl_setAudioFormat(self.h, format.h)

proc read*(self: gen_qaudiodecodercontrol_types.QAudioDecoderControl, ): QAudioBuffer =
  QAudioBuffer(h: fcQAudioDecoderControl_read(self.h))
...
proc formatChanged*(self: gen_qaudiodecodercontrol_types.QAudioDecoderControl, format: QAudioFormat): void =
  fcQAudioDecoderControl_formatChanged(self.h, format.h)

type QAudioDecoderControlformatChangedSlot* = proc(format: QAudioFormat)
