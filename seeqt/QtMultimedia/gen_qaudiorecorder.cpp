...
void QAudioRecorder_connect_audioInputChanged(QAudioRecorder* self, intptr_t slot, void (*callback)(intptr_t, struct miqt_string), void (*release)(intptr_t)) {
	...
	MiqtVirtualQAudioRecorder::connect(self, static_cast<void (QAudioRecorder::*)(const QString&)>(&QAudioRecorder::audioInputChanged), self, caller{slot, callback, release});
}
...
void QAudioRecorder_connect_availableAudioInputsChanged(QAudioRecorder* self, intptr_t slot, void (*callback)(intptr_t), void (*release)(intptr_t)) {
	...
	MiqtVirtualQAudioRecorder::connect(self, static_cast<void (QAudioRecorder::*)()>(&QAudioRecorder::availableAudioInputsChanged), self, caller{slot, callback, release});
}
...
int QAudioRecorder_virtualbase_metacall(void* self, int param1, int param2, void** param3) {
	...
	return ( (MiqtVirtualQAudioRecorder*)(self) )->QAudioRecorder::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
bool QAudioRecorder_virtualbase_setMediaObject(void* self, QMediaObject* object) {
	...
	return ( (MiqtVirtualQAudioRecorder*)(self) )->QAudioRecorder::setMediaObject(object);
...
bool QAudioRecorder_virtualbase_eventFilter(void* self, QObject* watched, QEvent* event) {
	...
	return ( (MiqtVirtualQAudioRecorder*)(self) )->QAudioRecorder::eventFilter(watched, event);
...
void QAudioRecorder_virtualbase_childEvent(void* self, QChildEvent* event) {
	...
	( (MiqtVirtualQAudioRecorder*)(self) )->QAudioRecorder::childEvent(event);
...
void QAudioRecorder_virtualbase_disconnectNotify(void* self, QMetaMethod* signal) {
	...
	( (MiqtVirtualQAudioRecorder*)(self) )->QAudioRecorder::disconnectNotify(*signal);
