...
proc create*(T: type gen_qgraphicswebview_types.QGraphicsWebView, parent: QGraphicsItem): gen_qgraphicswebview_types.QGraphicsWebView =
  gen_qgraphicswebview_types.QGraphicsWebView.init(fcQGraphicsWebView_new2(parent.h))

proc metaObject*(self: gen_qgraphicswebview_types.QGraphicsWebView, ): QMetaObject =
  QMetaObject(h: fcQGraphicsWebView_metaObject(self.h))
...
proc page*(self: gen_qgraphicswebview_types.QGraphicsWebView, ): QWebPage =
  QWebPage(h: fcQGraphicsWebView_page(self.h))

proc setPage*(self: gen_qgraphicswebview_types.QGraphicsWebView, page: QWebPage): void =
  fcQGraphicsWebView_setPage(self.h, page.h)

proc url*(self: gen_qgraphicswebview_types.QGraphicsWebView, ): QUrl =
  QUrl(h: fcQGraphicsWebView_url(self.h))

proc setUrl*(self: gen_qgraphicswebview_types.QGraphicsWebView, url: QUrl): void =
...
proc icon*(self: gen_qgraphicswebview_types.QGraphicsWebView, ): QIcon =
  QIcon(h: fcQGraphicsWebView_icon(self.h))
...
proc load*(self: gen_qgraphicswebview_types.QGraphicsWebView, url: QUrl): void =
  fcQGraphicsWebView_load(self.h, url.h)

proc load*(self: gen_qgraphicswebview_types.QGraphicsWebView, request: QNetworkRequest): void =
...
proc history*(self: gen_qgraphicswebview_types.QGraphicsWebView, ): QWebHistory =
  QWebHistory(h: fcQGraphicsWebView_history(self.h))

proc settings*(self: gen_qgraphicswebview_types.QGraphicsWebView, ): QWebSettings =
  QWebSettings(h: fcQGraphicsWebView_settings(self.h))
...
proc setGeometry*(self: gen_qgraphicswebview_types.QGraphicsWebView, rect: QRectF): void =
...
proc paint*(self: gen_qgraphicswebview_types.QGraphicsWebView, param1: QPainter, options: QStyleOptionGraphicsItem, widget: QWidget): void =
  fcQGraphicsWebView_paint(self.h, param1.h, options.h, widget.h)

proc itemChange*(self: gen_qgraphicswebview_types.QGraphicsWebView, change: cint, value: QVariant): QVariant =
  QVariant(h: fcQGraphicsWebView_itemChange(self.h, cint(change), value.h))

proc event*(self: gen_qgraphicswebview_types.QGraphicsWebView, param1: QEvent): bool =
  fcQGraphicsWebView_event(self.h, param1.h)

proc sizeHint*(self: gen_qgraphicswebview_types.QGraphicsWebView, which: cint, constraint: QSizeF): QSizeF =
  QSizeF(h: fcQGraphicsWebView_sizeHint(self.h, cint(which), constraint.h))

proc inputMethodQuery*(self: gen_qgraphicswebview_types.QGraphicsWebView, query: cint): QVariant =
  QVariant(h: fcQGraphicsWebView_inputMethodQuery(self.h, cint(query)))
...
proc urlChanged*(self: gen_qgraphicswebview_types.QGraphicsWebView, param1: QUrl): void =
  fcQGraphicsWebView_urlChanged(self.h, param1.h)

type QGraphicsWebViewurlChangedSlot* = proc(param1: QUrl)
...
proc linkClicked*(self: gen_qgraphicswebview_types.QGraphicsWebView, param1: QUrl): void =
  fcQGraphicsWebView_linkClicked(self.h, param1.h)

type QGraphicsWebViewlinkClickedSlot* = proc(param1: QUrl)
...
proc load*(self: gen_qgraphicswebview_types.QGraphicsWebView, request: QNetworkRequest, operation: cint): void =
  fcQGraphicsWebView_load2(self.h, request.h, cint(operation))

proc load*(self: gen_qgraphicswebview_types.QGraphicsWebView, request: QNetworkRequest, operation: cint, body: seq[byte]): void =
...
proc setHtml*(self: gen_qgraphicswebview_types.QGraphicsWebView, html: string, baseUrl: QUrl): void =
...
proc setContent*(self: gen_qgraphicswebview_types.QGraphicsWebView, data: seq[byte], mimeType: string, baseUrl: QUrl): void =
...
proc miqt_exec_callback_QGraphicsWebView_metacall(self: ptr cQGraphicsWebView, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QGraphicsWebView_metacall ".} =
  ...
  virtualReturn
proc QGraphicsWebViewsetGeometry*(self: gen_qgraphicswebview_types.QGraphicsWebView, rect: QRectF): void =
  fQGraphicsWebView_virtualbase_setGeometry(self.h, rect.h)

type QGraphicsWebViewsetGeometryProc* = proc(rect: QRectF): void
...
proc miqt_exec_callback_QGraphicsWebView_updateGeometry(self: ptr cQGraphicsWebView, slot: int): void {.exportc: "miqt_exec_callback_QGraphicsWebView_updateGeometry ".} =
  ...
  nimfunc[]()
proc QGraphicsWebViewpaint*(self: gen_qgraphicswebview_types.QGraphicsWebView, param1: QPainter, options: QStyleOptionGraphicsItem, widget: QWidget): void =
  fQGraphicsWebView_virtualbase_paint(self.h, param1.h, options.h, widget.h)

type QGraphicsWebViewpaintProc* = proc(param1: QPainter, options: QStyleOptionGraphicsItem, widget: QWidget): void
...
proc miqt_exec_callback_QGraphicsWebView_paint(self: ptr cQGraphicsWebView, slot: int, param1: pointer, options: pointer, widget: pointer): void {.exportc: "miqt_exec_callback_QGraphicsWebView_paint ".} =
  ...
  let slotval2 = QStyleOptionGraphicsItem(h: options)

  let slotval3 = QWidget(h: widget)


  nimfunc[](slotval1, slotval2, slotval3)
proc QGraphicsWebViewitemChange*(self: gen_qgraphicswebview_types.QGraphicsWebView, change: cint, value: QVariant): QVariant =
  QVariant(h: fQGraphicsWebView_virtualbase_itemChange(self.h, cint(change), value.h))

type QGraphicsWebViewitemChangeProc* = proc(change: cint, value: QVariant): QVariant
...
proc miqt_exec_callback_QGraphicsWebView_itemChange(self: ptr cQGraphicsWebView, slot: int, change: cint, value: pointer): pointer {.exportc: "miqt_exec_callback_QGraphicsWebView_itemChange ".} =
  ...
  virtualReturn.h
proc QGraphicsWebViewevent*(self: gen_qgraphicswebview_types.QGraphicsWebView, param1: QEvent): bool =
  fQGraphicsWebView_virtualbase_event(self.h, param1.h)

type QGraphicsWebVieweventProc* = proc(param1: QEvent): bool
...
proc miqt_exec_callback_QGraphicsWebView_event(self: ptr cQGraphicsWebView, slot: int, param1: pointer): bool {.exportc: "miqt_exec_callback_QGraphicsWebView_event ".} =
  ...
  virtualReturn
proc QGraphicsWebViewsizeHint*(self: gen_qgraphicswebview_types.QGraphicsWebView, which: cint, constraint: QSizeF): QSizeF =
  QSizeF(h: fQGraphicsWebView_virtualbase_sizeHint(self.h, cint(which), constraint.h))

type QGraphicsWebViewsizeHintProc* = proc(which: cint, constraint: QSizeF): QSizeF
...
proc miqt_exec_callback_QGraphicsWebView_sizeHint(self: ptr cQGraphicsWebView, slot: int, which: cint, constraint: pointer): pointer {.exportc: "miqt_exec_callback_QGraphicsWebView_sizeHint ".} =
  ...
  virtualReturn.h
proc QGraphicsWebViewinputMethodQuery*(self: gen_qgraphicswebview_types.QGraphicsWebView, query: cint): QVariant =
  QVariant(h: fQGraphicsWebView_virtualbase_inputMethodQuery(self.h, cint(query)))

type QGraphicsWebViewinputMethodQueryProc* = proc(query: cint): QVariant
...
proc miqt_exec_callback_QGraphicsWebView_inputMethodQuery(self: ptr cQGraphicsWebView, slot: int, query: cint): pointer {.exportc: "miqt_exec_callback_QGraphicsWebView_inputMethodQuery ".} =
  ...
  virtualReturn.h
proc QGraphicsWebViewmousePressEvent*(self: gen_qgraphicswebview_types.QGraphicsWebView, param1: QGraphicsSceneMouseEvent): void =
  fQGraphicsWebView_virtualbase_mousePressEvent(self.h, param1.h)

type QGraphicsWebViewmousePressEventProc* = proc(param1: QGraphicsSceneMouseEvent): void
...
proc miqt_exec_callback_QGraphicsWebView_mousePressEvent(self: ptr cQGraphicsWebView, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QGraphicsWebView_mousePressEvent ".} =
  ...
  let slotval1 = QGraphicsSceneMouseEvent(h: param1)


  nimfunc[](slotval1)
proc QGraphicsWebViewmouseDoubleClickEvent*(self: gen_qgraphicswebview_types.QGraphicsWebView, param1: QGraphicsSceneMouseEvent): void =
  fQGraphicsWebView_virtualbase_mouseDoubleClickEvent(self.h, param1.h)

type QGraphicsWebViewmouseDoubleClickEventProc* = proc(param1: QGraphicsSceneMouseEvent): void
...
proc miqt_exec_callback_QGraphicsWebView_mouseDoubleClickEvent(self: ptr cQGraphicsWebView, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QGraphicsWebView_mouseDoubleClickEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsWebViewmouseReleaseEvent*(self: gen_qgraphicswebview_types.QGraphicsWebView, param1: QGraphicsSceneMouseEvent): void =
  fQGraphicsWebView_virtualbase_mouseReleaseEvent(self.h, param1.h)

type QGraphicsWebViewmouseReleaseEventProc* = proc(param1: QGraphicsSceneMouseEvent): void
...
proc miqt_exec_callback_QGraphicsWebView_mouseReleaseEvent(self: ptr cQGraphicsWebView, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QGraphicsWebView_mouseReleaseEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsWebViewmouseMoveEvent*(self: gen_qgraphicswebview_types.QGraphicsWebView, param1: QGraphicsSceneMouseEvent): void =
  fQGraphicsWebView_virtualbase_mouseMoveEvent(self.h, param1.h)

type QGraphicsWebViewmouseMoveEventProc* = proc(param1: QGraphicsSceneMouseEvent): void
...
proc miqt_exec_callback_QGraphicsWebView_mouseMoveEvent(self: ptr cQGraphicsWebView, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QGraphicsWebView_mouseMoveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsWebViewhoverMoveEvent*(self: gen_qgraphicswebview_types.QGraphicsWebView, param1: QGraphicsSceneHoverEvent): void =
  fQGraphicsWebView_virtualbase_hoverMoveEvent(self.h, param1.h)

type QGraphicsWebViewhoverMoveEventProc* = proc(param1: QGraphicsSceneHoverEvent): void
...
proc miqt_exec_callback_QGraphicsWebView_hoverMoveEvent(self: ptr cQGraphicsWebView, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QGraphicsWebView_hoverMoveEvent ".} =
  ...
  let slotval1 = QGraphicsSceneHoverEvent(h: param1)


  nimfunc[](slotval1)
proc QGraphicsWebViewhoverLeaveEvent*(self: gen_qgraphicswebview_types.QGraphicsWebView, param1: QGraphicsSceneHoverEvent): void =
  fQGraphicsWebView_virtualbase_hoverLeaveEvent(self.h, param1.h)

type QGraphicsWebViewhoverLeaveEventProc* = proc(param1: QGraphicsSceneHoverEvent): void
...
proc miqt_exec_callback_QGraphicsWebView_hoverLeaveEvent(self: ptr cQGraphicsWebView, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QGraphicsWebView_hoverLeaveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsWebViewwheelEvent*(self: gen_qgraphicswebview_types.QGraphicsWebView, param1: QGraphicsSceneWheelEvent): void =
  fQGraphicsWebView_virtualbase_wheelEvent(self.h, param1.h)

type QGraphicsWebViewwheelEventProc* = proc(param1: QGraphicsSceneWheelEvent): void
...
proc miqt_exec_callback_QGraphicsWebView_wheelEvent(self: ptr cQGraphicsWebView, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QGraphicsWebView_wheelEvent ".} =
  ...
  let slotval1 = QGraphicsSceneWheelEvent(h: param1)


  nimfunc[](slotval1)
proc QGraphicsWebViewkeyPressEvent*(self: gen_qgraphicswebview_types.QGraphicsWebView, param1: QKeyEvent): void =
  fQGraphicsWebView_virtualbase_keyPressEvent(self.h, param1.h)

type QGraphicsWebViewkeyPressEventProc* = proc(param1: QKeyEvent): void
...
proc miqt_exec_callback_QGraphicsWebView_keyPressEvent(self: ptr cQGraphicsWebView, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QGraphicsWebView_keyPressEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsWebViewkeyReleaseEvent*(self: gen_qgraphicswebview_types.QGraphicsWebView, param1: QKeyEvent): void =
  fQGraphicsWebView_virtualbase_keyReleaseEvent(self.h, param1.h)

type QGraphicsWebViewkeyReleaseEventProc* = proc(param1: QKeyEvent): void
...
proc miqt_exec_callback_QGraphicsWebView_keyReleaseEvent(self: ptr cQGraphicsWebView, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QGraphicsWebView_keyReleaseEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsWebViewcontextMenuEvent*(self: gen_qgraphicswebview_types.QGraphicsWebView, param1: QGraphicsSceneContextMenuEvent): void =
  fQGraphicsWebView_virtualbase_contextMenuEvent(self.h, param1.h)

type QGraphicsWebViewcontextMenuEventProc* = proc(param1: QGraphicsSceneContextMenuEvent): void
...
proc miqt_exec_callback_QGraphicsWebView_contextMenuEvent(self: ptr cQGraphicsWebView, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QGraphicsWebView_contextMenuEvent ".} =
  ...
  let slotval1 = QGraphicsSceneContextMenuEvent(h: param1)


  nimfunc[](slotval1)
proc QGraphicsWebViewdragEnterEvent*(self: gen_qgraphicswebview_types.QGraphicsWebView, param1: QGraphicsSceneDragDropEvent): void =
  fQGraphicsWebView_virtualbase_dragEnterEvent(self.h, param1.h)

type QGraphicsWebViewdragEnterEventProc* = proc(param1: QGraphicsSceneDragDropEvent): void
...
proc miqt_exec_callback_QGraphicsWebView_dragEnterEvent(self: ptr cQGraphicsWebView, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QGraphicsWebView_dragEnterEvent ".} =
  ...
  let slotval1 = QGraphicsSceneDragDropEvent(h: param1)


  nimfunc[](slotval1)
proc QGraphicsWebViewdragLeaveEvent*(self: gen_qgraphicswebview_types.QGraphicsWebView, param1: QGraphicsSceneDragDropEvent): void =
  fQGraphicsWebView_virtualbase_dragLeaveEvent(self.h, param1.h)

type QGraphicsWebViewdragLeaveEventProc* = proc(param1: QGraphicsSceneDragDropEvent): void
...
proc miqt_exec_callback_QGraphicsWebView_dragLeaveEvent(self: ptr cQGraphicsWebView, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QGraphicsWebView_dragLeaveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsWebViewdragMoveEvent*(self: gen_qgraphicswebview_types.QGraphicsWebView, param1: QGraphicsSceneDragDropEvent): void =
  fQGraphicsWebView_virtualbase_dragMoveEvent(self.h, param1.h)

type QGraphicsWebViewdragMoveEventProc* = proc(param1: QGraphicsSceneDragDropEvent): void
...
proc miqt_exec_callback_QGraphicsWebView_dragMoveEvent(self: ptr cQGraphicsWebView, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QGraphicsWebView_dragMoveEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsWebViewdropEvent*(self: gen_qgraphicswebview_types.QGraphicsWebView, param1: QGraphicsSceneDragDropEvent): void =
  fQGraphicsWebView_virtualbase_dropEvent(self.h, param1.h)

type QGraphicsWebViewdropEventProc* = proc(param1: QGraphicsSceneDragDropEvent): void
...
proc miqt_exec_callback_QGraphicsWebView_dropEvent(self: ptr cQGraphicsWebView, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QGraphicsWebView_dropEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsWebViewfocusInEvent*(self: gen_qgraphicswebview_types.QGraphicsWebView, param1: QFocusEvent): void =
  fQGraphicsWebView_virtualbase_focusInEvent(self.h, param1.h)

type QGraphicsWebViewfocusInEventProc* = proc(param1: QFocusEvent): void
...
proc miqt_exec_callback_QGraphicsWebView_focusInEvent(self: ptr cQGraphicsWebView, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QGraphicsWebView_focusInEvent ".} =
  ...
  let slotval1 = QFocusEvent(h: param1)


  nimfunc[](slotval1)
proc QGraphicsWebViewfocusOutEvent*(self: gen_qgraphicswebview_types.QGraphicsWebView, param1: QFocusEvent): void =
  fQGraphicsWebView_virtualbase_focusOutEvent(self.h, param1.h)

type QGraphicsWebViewfocusOutEventProc* = proc(param1: QFocusEvent): void
...
proc miqt_exec_callback_QGraphicsWebView_focusOutEvent(self: ptr cQGraphicsWebView, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QGraphicsWebView_focusOutEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsWebViewinputMethodEvent*(self: gen_qgraphicswebview_types.QGraphicsWebView, param1: QInputMethodEvent): void =
  fQGraphicsWebView_virtualbase_inputMethodEvent(self.h, param1.h)

type QGraphicsWebViewinputMethodEventProc* = proc(param1: QInputMethodEvent): void
...
proc miqt_exec_callback_QGraphicsWebView_focusNextPrevChild(self: ptr cQGraphicsWebView, slot: int, next: bool): bool {.exportc: "miqt_exec_callback_QGraphicsWebView_focusNextPrevChild ".} =
  ...
  virtualReturn
proc QGraphicsWebViewsceneEvent*(self: gen_qgraphicswebview_types.QGraphicsWebView, param1: QEvent): bool =
  fQGraphicsWebView_virtualbase_sceneEvent(self.h, param1.h)

type QGraphicsWebViewsceneEventProc* = proc(param1: QEvent): bool
...
proc miqt_exec_callback_QGraphicsWebView_type(self: ptr cQGraphicsWebView, slot: int): cint {.exportc: "miqt_exec_callback_QGraphicsWebView_type ".} =
  ...
  virtualReturn
proc QGraphicsWebViewpaintWindowFrame*(self: gen_qgraphicswebview_types.QGraphicsWebView, painter: QPainter, option: QStyleOptionGraphicsItem, widget: QWidget): void =
  fQGraphicsWebView_virtualbase_paintWindowFrame(self.h, painter.h, option.h, widget.h)

type QGraphicsWebViewpaintWindowFrameProc* = proc(painter: QPainter, option: QStyleOptionGraphicsItem, widget: QWidget): void
...
proc miqt_exec_callback_QGraphicsWebView_paintWindowFrame(self: ptr cQGraphicsWebView, slot: int, painter: pointer, option: pointer, widget: pointer): void {.exportc: "miqt_exec_callback_QGraphicsWebView_paintWindowFrame ".} =
  ...
  nimfunc[](slotval1, slotval2, slotval3)
proc QGraphicsWebViewboundingRect*(self: gen_qgraphicswebview_types.QGraphicsWebView, ): QRectF =
  QRectF(h: fQGraphicsWebView_virtualbase_boundingRect(self.h))

type QGraphicsWebViewboundingRectProc* = proc(): QRectF
...
proc miqt_exec_callback_QGraphicsWebView_boundingRect(self: ptr cQGraphicsWebView, slot: int): pointer {.exportc: "miqt_exec_callback_QGraphicsWebView_boundingRect ".} =
  ...
  virtualReturn.h
proc QGraphicsWebViewshape*(self: gen_qgraphicswebview_types.QGraphicsWebView, ): QPainterPath =
  QPainterPath(h: fQGraphicsWebView_virtualbase_shape(self.h))

type QGraphicsWebViewshapeProc* = proc(): QPainterPath
...
proc miqt_exec_callback_QGraphicsWebView_shape(self: ptr cQGraphicsWebView, slot: int): pointer {.exportc: "miqt_exec_callback_QGraphicsWebView_shape ".} =
  ...
  virtualReturn.h
proc QGraphicsWebViewinitStyleOption*(self: gen_qgraphicswebview_types.QGraphicsWebView, option: QStyleOption): void =
  fQGraphicsWebView_virtualbase_initStyleOption(self.h, option.h)

type QGraphicsWebViewinitStyleOptionProc* = proc(option: QStyleOption): void
...
proc miqt_exec_callback_QGraphicsWebView_initStyleOption(self: ptr cQGraphicsWebView, slot: int, option: pointer): void {.exportc: "miqt_exec_callback_QGraphicsWebView_initStyleOption ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsWebViewpropertyChange*(self: gen_qgraphicswebview_types.QGraphicsWebView, propertyName: string, value: QVariant): QVariant =
  QVariant(h: fQGraphicsWebView_virtualbase_propertyChange(self.h, struct_miqt_string(data: propertyName, len: csize_t(len(propertyName))), value.h))

type QGraphicsWebViewpropertyChangeProc* = proc(propertyName: string, value: QVariant): QVariant
...
proc miqt_exec_callback_QGraphicsWebView_propertyChange(self: ptr cQGraphicsWebView, slot: int, propertyName: struct_miqt_string, value: pointer): pointer {.exportc: "miqt_exec_callback_QGraphicsWebView_propertyChange ".} =
  ...
  virtualReturn.h
proc QGraphicsWebViewwindowFrameEvent*(self: gen_qgraphicswebview_types.QGraphicsWebView, e: QEvent): bool =
  fQGraphicsWebView_virtualbase_windowFrameEvent(self.h, e.h)

type QGraphicsWebViewwindowFrameEventProc* = proc(e: QEvent): bool
...
proc miqt_exec_callback_QGraphicsWebView_windowFrameEvent(self: ptr cQGraphicsWebView, slot: int, e: pointer): bool {.exportc: "miqt_exec_callback_QGraphicsWebView_windowFrameEvent ".} =
  ...
  virtualReturn
proc QGraphicsWebViewwindowFrameSectionAt*(self: gen_qgraphicswebview_types.QGraphicsWebView, pos: QPointF): cint =
  cint(fQGraphicsWebView_virtualbase_windowFrameSectionAt(self.h, pos.h))

type QGraphicsWebViewwindowFrameSectionAtProc* = proc(pos: QPointF): cint
...
proc miqt_exec_callback_QGraphicsWebView_windowFrameSectionAt(self: ptr cQGraphicsWebView, slot: int, pos: pointer): cint {.exportc: "miqt_exec_callback_QGraphicsWebView_windowFrameSectionAt ".} =
  ...
  cint(virtualReturn)
proc QGraphicsWebViewchangeEvent*(self: gen_qgraphicswebview_types.QGraphicsWebView, event: QEvent): void =
  fQGraphicsWebView_virtualbase_changeEvent(self.h, event.h)

type QGraphicsWebViewchangeEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QGraphicsWebView_changeEvent(self: ptr cQGraphicsWebView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsWebView_changeEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsWebViewcloseEvent*(self: gen_qgraphicswebview_types.QGraphicsWebView, event: QCloseEvent): void =
  fQGraphicsWebView_virtualbase_closeEvent(self.h, event.h)

type QGraphicsWebViewcloseEventProc* = proc(event: QCloseEvent): void
...
proc miqt_exec_callback_QGraphicsWebView_closeEvent(self: ptr cQGraphicsWebView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsWebView_closeEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsWebViewhideEvent*(self: gen_qgraphicswebview_types.QGraphicsWebView, event: QHideEvent): void =
  fQGraphicsWebView_virtualbase_hideEvent(self.h, event.h)

type QGraphicsWebViewhideEventProc* = proc(event: QHideEvent): void
...
proc miqt_exec_callback_QGraphicsWebView_hideEvent(self: ptr cQGraphicsWebView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsWebView_hideEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsWebViewmoveEvent*(self: gen_qgraphicswebview_types.QGraphicsWebView, event: QGraphicsSceneMoveEvent): void =
  fQGraphicsWebView_virtualbase_moveEvent(self.h, event.h)

type QGraphicsWebViewmoveEventProc* = proc(event: QGraphicsSceneMoveEvent): void
...
proc miqt_exec_callback_QGraphicsWebView_polishEvent(self: ptr cQGraphicsWebView, slot: int): void {.exportc: "miqt_exec_callback_QGraphicsWebView_polishEvent ".} =
  ...
  nimfunc[]()
proc QGraphicsWebViewresizeEvent*(self: gen_qgraphicswebview_types.QGraphicsWebView, event: QGraphicsSceneResizeEvent): void =
  fQGraphicsWebView_virtualbase_resizeEvent(self.h, event.h)

type QGraphicsWebViewresizeEventProc* = proc(event: QGraphicsSceneResizeEvent): void
...
proc miqt_exec_callback_QGraphicsWebView_resizeEvent(self: ptr cQGraphicsWebView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsWebView_resizeEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsWebViewshowEvent*(self: gen_qgraphicswebview_types.QGraphicsWebView, event: QShowEvent): void =
  fQGraphicsWebView_virtualbase_showEvent(self.h, event.h)

type QGraphicsWebViewshowEventProc* = proc(event: QShowEvent): void
...
proc miqt_exec_callback_QGraphicsWebView_showEvent(self: ptr cQGraphicsWebView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsWebView_showEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsWebViewgrabMouseEvent*(self: gen_qgraphicswebview_types.QGraphicsWebView, event: QEvent): void =
  fQGraphicsWebView_virtualbase_grabMouseEvent(self.h, event.h)

type QGraphicsWebViewgrabMouseEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QGraphicsWebView_grabMouseEvent(self: ptr cQGraphicsWebView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsWebView_grabMouseEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsWebViewungrabMouseEvent*(self: gen_qgraphicswebview_types.QGraphicsWebView, event: QEvent): void =
  fQGraphicsWebView_virtualbase_ungrabMouseEvent(self.h, event.h)

type QGraphicsWebViewungrabMouseEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QGraphicsWebView_ungrabMouseEvent(self: ptr cQGraphicsWebView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsWebView_ungrabMouseEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsWebViewgrabKeyboardEvent*(self: gen_qgraphicswebview_types.QGraphicsWebView, event: QEvent): void =
  fQGraphicsWebView_virtualbase_grabKeyboardEvent(self.h, event.h)

type QGraphicsWebViewgrabKeyboardEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QGraphicsWebView_grabKeyboardEvent(self: ptr cQGraphicsWebView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsWebView_grabKeyboardEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsWebViewungrabKeyboardEvent*(self: gen_qgraphicswebview_types.QGraphicsWebView, event: QEvent): void =
  fQGraphicsWebView_virtualbase_ungrabKeyboardEvent(self.h, event.h)

type QGraphicsWebViewungrabKeyboardEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QGraphicsWebView_ungrabKeyboardEvent(self: ptr cQGraphicsWebView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsWebView_ungrabKeyboardEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsWebVieweventFilter*(self: gen_qgraphicswebview_types.QGraphicsWebView, watched: QObject, event: QEvent): bool =
  fQGraphicsWebView_virtualbase_eventFilter(self.h, watched.h, event.h)

type QGraphicsWebVieweventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QGraphicsWebView_eventFilter(self: ptr cQGraphicsWebView, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QGraphicsWebView_eventFilter ".} =
  ...
  virtualReturn
proc QGraphicsWebViewtimerEvent*(self: gen_qgraphicswebview_types.QGraphicsWebView, event: QTimerEvent): void =
  fQGraphicsWebView_virtualbase_timerEvent(self.h, event.h)

type QGraphicsWebViewtimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QGraphicsWebView_timerEvent(self: ptr cQGraphicsWebView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsWebView_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsWebViewchildEvent*(self: gen_qgraphicswebview_types.QGraphicsWebView, event: QChildEvent): void =
  fQGraphicsWebView_virtualbase_childEvent(self.h, event.h)

type QGraphicsWebViewchildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QGraphicsWebView_childEvent(self: ptr cQGraphicsWebView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsWebView_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsWebViewcustomEvent*(self: gen_qgraphicswebview_types.QGraphicsWebView, event: QEvent): void =
  fQGraphicsWebView_virtualbase_customEvent(self.h, event.h)

type QGraphicsWebViewcustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QGraphicsWebView_customEvent(self: ptr cQGraphicsWebView, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGraphicsWebView_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsWebViewconnectNotify*(self: gen_qgraphicswebview_types.QGraphicsWebView, signal: QMetaMethod): void =
  fQGraphicsWebView_virtualbase_connectNotify(self.h, signal.h)

type QGraphicsWebViewconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QGraphicsWebView_connectNotify(self: ptr cQGraphicsWebView, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QGraphicsWebView_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsWebViewdisconnectNotify*(self: gen_qgraphicswebview_types.QGraphicsWebView, signal: QMetaMethod): void =
  fQGraphicsWebView_virtualbase_disconnectNotify(self.h, signal.h)

type QGraphicsWebViewdisconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QGraphicsWebView_advance(self: ptr cQGraphicsWebView, slot: int, phase: cint): void {.exportc: "miqt_exec_callback_QGraphicsWebView_advance ".} =
  ...
  nimfunc[](slotval1)
proc QGraphicsWebViewcontains*(self: gen_qgraphicswebview_types.QGraphicsWebView, point: QPointF): bool =
  fQGraphicsWebView_virtualbase_contains(self.h, point.h)

type QGraphicsWebViewcontainsProc* = proc(point: QPointF): bool
...
proc miqt_exec_callback_QGraphicsWebView_contains(self: ptr cQGraphicsWebView, slot: int, point: pointer): bool {.exportc: "miqt_exec_callback_QGraphicsWebView_contains ".} =
  ...
  virtualReturn
proc QGraphicsWebViewcollidesWithItem*(self: gen_qgraphicswebview_types.QGraphicsWebView, other: QGraphicsItem, mode: cint): bool =
  fQGraphicsWebView_virtualbase_collidesWithItem(self.h, other.h, cint(mode))

type QGraphicsWebViewcollidesWithItemProc* = proc(other: QGraphicsItem, mode: cint): bool
...
proc miqt_exec_callback_QGraphicsWebView_collidesWithItem(self: ptr cQGraphicsWebView, slot: int, other: pointer, mode: cint): bool {.exportc: "miqt_exec_callback_QGraphicsWebView_collidesWithItem ".} =
  ...
  virtualReturn
proc QGraphicsWebViewcollidesWithPath*(self: gen_qgraphicswebview_types.QGraphicsWebView, path: QPainterPath, mode: cint): bool =
  fQGraphicsWebView_virtualbase_collidesWithPath(self.h, path.h, cint(mode))

type QGraphicsWebViewcollidesWithPathProc* = proc(path: QPainterPath, mode: cint): bool
...
proc miqt_exec_callback_QGraphicsWebView_collidesWithPath(self: ptr cQGraphicsWebView, slot: int, path: pointer, mode: cint): bool {.exportc: "miqt_exec_callback_QGraphicsWebView_collidesWithPath ".} =
  ...
  virtualReturn
proc QGraphicsWebViewisObscuredBy*(self: gen_qgraphicswebview_types.QGraphicsWebView, item: QGraphicsItem): bool =
  fQGraphicsWebView_virtualbase_isObscuredBy(self.h, item.h)

type QGraphicsWebViewisObscuredByProc* = proc(item: QGraphicsItem): bool
...
proc miqt_exec_callback_QGraphicsWebView_isObscuredBy(self: ptr cQGraphicsWebView, slot: int, item: pointer): bool {.exportc: "miqt_exec_callback_QGraphicsWebView_isObscuredBy ".} =
  ...
  virtualReturn
proc QGraphicsWebViewopaqueArea*(self: gen_qgraphicswebview_types.QGraphicsWebView, ): QPainterPath =
  QPainterPath(h: fQGraphicsWebView_virtualbase_opaqueArea(self.h))

type QGraphicsWebViewopaqueAreaProc* = proc(): QPainterPath
...
proc miqt_exec_callback_QGraphicsWebView_opaqueArea(self: ptr cQGraphicsWebView, slot: int): pointer {.exportc: "miqt_exec_callback_QGraphicsWebView_opaqueArea ".} =
  ...
  virtualReturn.h
proc QGraphicsWebViewsceneEventFilter*(self: gen_qgraphicswebview_types.QGraphicsWebView, watched: QGraphicsItem, event: QEvent): bool =
  fQGraphicsWebView_virtualbase_sceneEventFilter(self.h, watched.h, event.h)

type QGraphicsWebViewsceneEventFilterProc* = proc(watched: QGraphicsItem, event: QEvent): bool
...
proc miqt_exec_callback_QGraphicsWebView_sceneEventFilter(self: ptr cQGraphicsWebView, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QGraphicsWebView_sceneEventFilter ".} =
  ...
  virtualReturn
proc QGraphicsWebViewhoverEnterEvent*(self: gen_qgraphicswebview_types.QGraphicsWebView, event: QGraphicsSceneHoverEvent): void =
  fQGraphicsWebView_virtualbase_hoverEnterEvent(self.h, event.h)

type QGraphicsWebViewhoverEnterEventProc* = proc(event: QGraphicsSceneHoverEvent): void
...
proc miqt_exec_callback_QGraphicsWebView_supportsExtension(self: ptr cQGraphicsWebView, slot: int, extension: cint): bool {.exportc: "miqt_exec_callback_QGraphicsWebView_supportsExtension ".} =
  ...
  virtualReturn
proc QGraphicsWebViewsetExtension*(self: gen_qgraphicswebview_types.QGraphicsWebView, extension: cint, variant: QVariant): void =
  fQGraphicsWebView_virtualbase_setExtension(self.h, cint(extension), variant.h)

type QGraphicsWebViewsetExtensionProc* = proc(extension: cint, variant: QVariant): void
...
proc QGraphicsWebViewextension*(self: gen_qgraphicswebview_types.QGraphicsWebView, variant: QVariant): QVariant =
  QVariant(h: fQGraphicsWebView_virtualbase_extension(self.h, variant.h))

type QGraphicsWebViewextensionProc* = proc(variant: QVariant): QVariant
