...
proc create*(T: type gen_qwebpage_types.QWebPage, parent: QObject): gen_qwebpage_types.QWebPage =
  gen_qwebpage_types.QWebPage.init(fcQWebPage_new2(parent.h))

proc metaObject*(self: gen_qwebpage_types.QWebPage, ): QMetaObject =
  QMetaObject(h: fcQWebPage_metaObject(self.h))
...
proc mainFrame*(self: gen_qwebpage_types.QWebPage, ): QWebFrame =
  QWebFrame(h: fcQWebPage_mainFrame(self.h))

proc currentFrame*(self: gen_qwebpage_types.QWebPage, ): QWebFrame =
  QWebFrame(h: fcQWebPage_currentFrame(self.h))

proc frameAt*(self: gen_qwebpage_types.QWebPage, pos: QPoint): QWebFrame =
  QWebFrame(h: fcQWebPage_frameAt(self.h, pos.h))

proc history*(self: gen_qwebpage_types.QWebPage, ): QWebHistory =
  QWebHistory(h: fcQWebPage_history(self.h))

proc settings*(self: gen_qwebpage_types.QWebPage, ): QWebSettings =
  QWebSettings(h: fcQWebPage_settings(self.h))

proc setView*(self: gen_qwebpage_types.QWebPage, view: QWidget): void =
  fcQWebPage_setView(self.h, view.h)

proc view*(self: gen_qwebpage_types.QWebPage, ): QWidget =
  QWidget(h: fcQWebPage_view(self.h))

proc isModified*(self: gen_qwebpage_types.QWebPage, ): bool =
  fcQWebPage_isModified(self.h)

proc undoStack*(self: gen_qwebpage_types.QWebPage, ): QUndoStack =
  QUndoStack(h: fcQWebPage_undoStack(self.h))

proc setNetworkAccessManager*(self: gen_qwebpage_types.QWebPage, manager: QNetworkAccessManager): void =
  fcQWebPage_setNetworkAccessManager(self.h, manager.h)

proc networkAccessManager*(self: gen_qwebpage_types.QWebPage, ): QNetworkAccessManager =
  QNetworkAccessManager(h: fcQWebPage_networkAccessManager(self.h))

proc setPluginFactory*(self: gen_qwebpage_types.QWebPage, factory: QWebPluginFactory): void =
  fcQWebPage_setPluginFactory(self.h, factory.h)

proc pluginFactory*(self: gen_qwebpage_types.QWebPage, ): QWebPluginFactory =
  QWebPluginFactory(h: fcQWebPage_pluginFactory(self.h))
...
proc viewportSize*(self: gen_qwebpage_types.QWebPage, ): QSize =
  QSize(h: fcQWebPage_viewportSize(self.h))

proc setViewportSize*(self: gen_qwebpage_types.QWebPage, size: QSize): void =
  fcQWebPage_setViewportSize(self.h, size.h)

proc viewportAttributesForSize*(self: gen_qwebpage_types.QWebPage, availableSize: QSize): QWebPageViewportAttributes =
  QWebPageViewportAttributes(h: fcQWebPage_viewportAttributesForSize(self.h, availableSize.h))

proc preferredContentsSize*(self: gen_qwebpage_types.QWebPage, ): QSize =
  QSize(h: fcQWebPage_preferredContentsSize(self.h))

proc setPreferredContentsSize*(self: gen_qwebpage_types.QWebPage, size: QSize): void =
  fcQWebPage_setPreferredContentsSize(self.h, size.h)

proc setActualVisibleContentRect*(self: gen_qwebpage_types.QWebPage, rect: QRect): void =
  fcQWebPage_setActualVisibleContentRect(self.h, rect.h)

proc event*(self: gen_qwebpage_types.QWebPage, param1: QEvent): bool =
...
proc inputMethodQuery*(self: gen_qwebpage_types.QWebPage, property: cint): QVariant =
  QVariant(h: fcQWebPage_inputMethodQuery(self.h, cint(property)))
...
proc setPalette*(self: gen_qwebpage_types.QWebPage, palette: QPalette): void =
  fcQWebPage_setPalette(self.h, palette.h)

proc palette*(self: gen_qwebpage_types.QWebPage, ): QPalette =
  QPalette(h: fcQWebPage_palette(self.h))
...
proc swallowContextMenuEvent*(self: gen_qwebpage_types.QWebPage, event: QContextMenuEvent): bool =
  fcQWebPage_swallowContextMenuEvent(self.h, event.h)

proc updatePositionDependentActions*(self: gen_qwebpage_types.QWebPage, pos: QPoint): void =
  fcQWebPage_updatePositionDependentActions(self.h, pos.h)

proc createStandardContextMenu*(self: gen_qwebpage_types.QWebPage, ): QMenu =
  QMenu(h: fcQWebPage_createStandardContextMenu(self.h))

proc setFeaturePermission*(self: gen_qwebpage_types.QWebPage, frame: QWebFrame, feature: cint, policy: cint): void =
...
proc extension*(self: gen_qwebpage_types.QWebPage, extension: cint, option: QWebPageExtensionOption, output: QWebPageExtensionReturn): bool =
...
proc frameCreated*(self: gen_qwebpage_types.QWebPage, frame: QWebFrame): void =
  fcQWebPage_frameCreated(self.h, frame.h)

type QWebPageframeCreatedSlot* = proc(frame: QWebFrame)
proc miqt_exec_callback_QWebPage_frameCreated(slot: int, frame: pointer) {.exportc.} =
  ...
  let slotval1 = QWebFrame(h: frame)
...
proc geometryChangeRequested*(self: gen_qwebpage_types.QWebPage, geom: QRect): void =
  fcQWebPage_geometryChangeRequested(self.h, geom.h)

type QWebPagegeometryChangeRequestedSlot* = proc(geom: QRect)
...
proc repaintRequested*(self: gen_qwebpage_types.QWebPage, dirtyRect: QRect): void =
  fcQWebPage_repaintRequested(self.h, dirtyRect.h)

type QWebPagerepaintRequestedSlot* = proc(dirtyRect: QRect)
proc miqt_exec_callback_QWebPage_repaintRequested(slot: int, dirtyRect: pointer) {.exportc.} =
  ...
  let slotval1 = QRect(h: dirtyRect)
...
proc scrollRequested*(self: gen_qwebpage_types.QWebPage, dx: cint, dy: cint, scrollViewRect: QRect): void =
  fcQWebPage_scrollRequested(self.h, dx, dy, scrollViewRect.h)

type QWebPagescrollRequestedSlot* = proc(dx: cint, dy: cint, scrollViewRect: QRect)
proc miqt_exec_callback_QWebPage_scrollRequested(slot: int, dx: cint, dy: cint, scrollViewRect: pointer) {.exportc.} =
  ...
  let slotval3 = QRect(h: scrollViewRect)
...
proc printRequested*(self: gen_qwebpage_types.QWebPage, frame: QWebFrame): void =
  fcQWebPage_printRequested(self.h, frame.h)

type QWebPageprintRequestedSlot* = proc(frame: QWebFrame)
...
proc linkClicked*(self: gen_qwebpage_types.QWebPage, url: QUrl): void =
  fcQWebPage_linkClicked(self.h, url.h)

type QWebPagelinkClickedSlot* = proc(url: QUrl)
...
proc unsupportedContent*(self: gen_qwebpage_types.QWebPage, reply: QNetworkReply): void =
  fcQWebPage_unsupportedContent(self.h, reply.h)

type QWebPageunsupportedContentSlot* = proc(reply: QNetworkReply)
proc miqt_exec_callback_QWebPage_unsupportedContent(slot: int, reply: pointer) {.exportc.} =
  ...
  let slotval1 = QNetworkReply(h: reply)
...
proc downloadRequested*(self: gen_qwebpage_types.QWebPage, request: QNetworkRequest): void =
  fcQWebPage_downloadRequested(self.h, request.h)

type QWebPagedownloadRequestedSlot* = proc(request: QNetworkRequest)
proc miqt_exec_callback_QWebPage_downloadRequested(slot: int, request: pointer) {.exportc.} =
  ...
  let slotval1 = QNetworkRequest(h: request)
...
proc focusedElementChanged*(self: gen_qwebpage_types.QWebPage, element: QWebElement): void =
  fcQWebPage_focusedElementChanged(self.h, element.h)

type QWebPagefocusedElementChangedSlot* = proc(element: QWebElement)
proc miqt_exec_callback_QWebPage_focusedElementChanged(slot: int, element: pointer) {.exportc.} =
  ...
  let slotval1 = QWebElement(h: element)
...
proc databaseQuotaExceeded*(self: gen_qwebpage_types.QWebPage, frame: QWebFrame, databaseName: string): void =
  fcQWebPage_databaseQuotaExceeded(self.h, frame.h, struct_miqt_string(data: databaseName, len: csize_t(len(databaseName))))

type QWebPagedatabaseQuotaExceededSlot* = proc(frame: QWebFrame, databaseName: string)
...
proc applicationCacheQuotaExceeded*(self: gen_qwebpage_types.QWebPage, origin: QWebSecurityOrigin, defaultOriginQuota: culonglong, totalSpaceNeeded: culonglong): void =
  fcQWebPage_applicationCacheQuotaExceeded(self.h, origin.h, defaultOriginQuota, totalSpaceNeeded)

type QWebPageapplicationCacheQuotaExceededSlot* = proc(origin: QWebSecurityOrigin, defaultOriginQuota: culonglong, totalSpaceNeeded: culonglong)
proc miqt_exec_callback_QWebPage_applicationCacheQuotaExceeded(slot: int, origin: pointer, defaultOriginQuota: culonglong, totalSpaceNeeded: culonglong) {.exportc.} =
  ...
  let slotval1 = QWebSecurityOrigin(h: origin)
...
proc saveFrameStateRequested*(self: gen_qwebpage_types.QWebPage, frame: QWebFrame, item: QWebHistoryItem): void =
  fcQWebPage_saveFrameStateRequested(self.h, frame.h, item.h)

type QWebPagesaveFrameStateRequestedSlot* = proc(frame: QWebFrame, item: QWebHistoryItem)
proc miqt_exec_callback_QWebPage_saveFrameStateRequested(slot: int, frame: pointer, item: pointer) {.exportc.} =
  ...
  let slotval2 = QWebHistoryItem(h: item)
...
proc restoreFrameStateRequested*(self: gen_qwebpage_types.QWebPage, frame: QWebFrame): void =
  fcQWebPage_restoreFrameStateRequested(self.h, frame.h)

type QWebPagerestoreFrameStateRequestedSlot* = proc(frame: QWebFrame)
...
proc featurePermissionRequested*(self: gen_qwebpage_types.QWebPage, frame: QWebFrame, feature: cint): void =
  fcQWebPage_featurePermissionRequested(self.h, frame.h, cint(feature))

type QWebPagefeaturePermissionRequestedSlot* = proc(frame: QWebFrame, feature: cint)
...
proc featurePermissionRequestCanceled*(self: gen_qwebpage_types.QWebPage, frame: QWebFrame, feature: cint): void =
  fcQWebPage_featurePermissionRequestCanceled(self.h, frame.h, cint(feature))

type QWebPagefeaturePermissionRequestCanceledSlot* = proc(frame: QWebFrame, feature: cint)
...
proc fullScreenRequested*(self: gen_qwebpage_types.QWebPage, fullScreenRequest: QWebFullScreenRequest): void =
  fcQWebPage_fullScreenRequested(self.h, fullScreenRequest.h)

type QWebPagefullScreenRequestedSlot* = proc(fullScreenRequest: QWebFullScreenRequest)
proc miqt_exec_callback_QWebPage_fullScreenRequested(slot: int, fullScreenRequest: pointer) {.exportc.} =
  ...
  let slotval1 = QWebFullScreenRequest(h: fullScreenRequest)
...
proc miqt_exec_callback_QWebPage_triggerAction(self: ptr cQWebPage, slot: int, action: cint, checked: bool): void {.exportc: "miqt_exec_callback_QWebPage_triggerAction ".} =
  ...
  nimfunc[](slotval1, slotval2)
proc QWebPageevent*(self: gen_qwebpage_types.QWebPage, param1: QEvent): bool =
  fQWebPage_virtualbase_event(self.h, param1.h)

type QWebPageeventProc* = proc(param1: QEvent): bool
...
proc miqt_exec_callback_QWebPage_event(self: ptr cQWebPage, slot: int, param1: pointer): bool {.exportc: "miqt_exec_callback_QWebPage_event ".} =
  ...
  virtualReturn
proc QWebPageextension*(self: gen_qwebpage_types.QWebPage, extension: cint, option: QWebPageExtensionOption, output: QWebPageExtensionReturn): bool =
  fQWebPage_virtualbase_extension(self.h, cint(extension), option.h, output.h)

type QWebPageextensionProc* = proc(extension: cint, option: QWebPageExtensionOption, output: QWebPageExtensionReturn): bool
...
proc miqt_exec_callback_QWebPage_shouldInterruptJavaScript(self: ptr cQWebPage, slot: int): bool {.exportc: "miqt_exec_callback_QWebPage_shouldInterruptJavaScript ".} =
  ...
  virtualReturn
proc QWebPagecreateWindow*(self: gen_qwebpage_types.QWebPage, typeVal: cint): QWebPage =
  QWebPage(h: fQWebPage_virtualbase_createWindow(self.h, cint(typeVal)))

type QWebPagecreateWindowProc* = proc(typeVal: cint): QWebPage
...
proc miqt_exec_callback_QWebPage_createWindow(self: ptr cQWebPage, slot: int, typeVal: cint): pointer {.exportc: "miqt_exec_callback_QWebPage_createWindow ".} =
  ...
  virtualReturn.h
proc QWebPagecreatePlugin*(self: gen_qwebpage_types.QWebPage, classid: string, url: QUrl, paramNames: seq[string], paramValues: seq[string]): QObject =
...
type QWebPagecreatePluginProc* = proc(classid: string, url: QUrl, paramNames: seq[string], paramValues: seq[string]): QObject
...
proc miqt_exec_callback_QWebPage_createPlugin(self: ptr cQWebPage, slot: int, classid: struct_miqt_string, url: pointer, paramNames: struct_miqt_array, paramValues: struct_miqt_array): pointer {.exportc: "miqt_exec_callback_QWebPage_createPlugin ".} =
  ...
  virtualReturn.h
proc QWebPageacceptNavigationRequest*(self: gen_qwebpage_types.QWebPage, frame: QWebFrame, request: QNetworkRequest, typeVal: cint): bool =
  fQWebPage_virtualbase_acceptNavigationRequest(self.h, frame.h, request.h, cint(typeVal))

type QWebPageacceptNavigationRequestProc* = proc(frame: QWebFrame, request: QNetworkRequest, typeVal: cint): bool
...
proc miqt_exec_callback_QWebPage_acceptNavigationRequest(self: ptr cQWebPage, slot: int, frame: pointer, request: pointer, typeVal: cint): bool {.exportc: "miqt_exec_callback_QWebPage_acceptNavigationRequest ".} =
  ...
  let slotval2 = QNetworkRequest(h: request)
  ...
  virtualReturn
proc QWebPagechooseFile*(self: gen_qwebpage_types.QWebPage, originatingFrame: QWebFrame, oldFile: string): string =
...
type QWebPagechooseFileProc* = proc(originatingFrame: QWebFrame, oldFile: string): string
...
proc miqt_exec_callback_QWebPage_chooseFile(self: ptr cQWebPage, slot: int, originatingFrame: pointer, oldFile: struct_miqt_string): struct_miqt_string {.exportc: "miqt_exec_callback_QWebPage_chooseFile ".} =
  ...
  let slotval1 = QWebFrame(h: originatingFrame)
...
proc QWebPagejavaScriptAlert*(self: gen_qwebpage_types.QWebPage, originatingFrame: QWebFrame, msg: string): void =
  fQWebPage_virtualbase_javaScriptAlert(self.h, originatingFrame.h, struct_miqt_string(data: msg, len: csize_t(len(msg))))

type QWebPagejavaScriptAlertProc* = proc(originatingFrame: QWebFrame, msg: string): void
...
proc miqt_exec_callback_QWebPage_javaScriptAlert(self: ptr cQWebPage, slot: int, originatingFrame: pointer, msg: struct_miqt_string): void {.exportc: "miqt_exec_callback_QWebPage_javaScriptAlert ".} =
  ...
  nimfunc[](slotval1, slotval2)
proc QWebPagejavaScriptConfirm*(self: gen_qwebpage_types.QWebPage, originatingFrame: QWebFrame, msg: string): bool =
  fQWebPage_virtualbase_javaScriptConfirm(self.h, originatingFrame.h, struct_miqt_string(data: msg, len: csize_t(len(msg))))

type QWebPagejavaScriptConfirmProc* = proc(originatingFrame: QWebFrame, msg: string): bool
...
proc miqt_exec_callback_QWebPage_javaScriptConsoleMessage(self: ptr cQWebPage, slot: int, message: struct_miqt_string, lineNumber: cint, sourceID: struct_miqt_string): void {.exportc: "miqt_exec_callback_QWebPage_javaScriptConsoleMessage ".} =
  ...
  nimfunc[](slotval1, slotval2, slotval3)
proc QWebPageuserAgentForUrl*(self: gen_qwebpage_types.QWebPage, url: QUrl): string =
  let v_ms = fQWebPage_virtualbase_userAgentForUrl(self.h, url.h)
  let vx_ret = string.fromBytes(toOpenArrayByte(v_ms.data, 0, int(v_ms.len)-1))
  c_free(v_ms.data)
  vx_ret

type QWebPageuserAgentForUrlProc* = proc(url: QUrl): string
...
proc miqt_exec_callback_QWebPage_userAgentForUrl(self: ptr cQWebPage, slot: int, url: pointer): struct_miqt_string {.exportc: "miqt_exec_callback_QWebPage_userAgentForUrl ".} =
  ...
  struct_miqt_string(data: virtualReturn, len: csize_t(len(virtualReturn)))
proc QWebPageeventFilter*(self: gen_qwebpage_types.QWebPage, watched: QObject, event: QEvent): bool =
  fQWebPage_virtualbase_eventFilter(self.h, watched.h, event.h)

type QWebPageeventFilterProc* = proc(watched: QObject, event: QEvent): bool
...
proc miqt_exec_callback_QWebPage_eventFilter(self: ptr cQWebPage, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QWebPage_eventFilter ".} =
  ...
  virtualReturn
proc QWebPagetimerEvent*(self: gen_qwebpage_types.QWebPage, event: QTimerEvent): void =
  fQWebPage_virtualbase_timerEvent(self.h, event.h)

type QWebPagetimerEventProc* = proc(event: QTimerEvent): void
...
proc miqt_exec_callback_QWebPage_timerEvent(self: ptr cQWebPage, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QWebPage_timerEvent ".} =
  ...
  nimfunc[](slotval1)
proc QWebPagechildEvent*(self: gen_qwebpage_types.QWebPage, event: QChildEvent): void =
  fQWebPage_virtualbase_childEvent(self.h, event.h)

type QWebPagechildEventProc* = proc(event: QChildEvent): void
...
proc miqt_exec_callback_QWebPage_childEvent(self: ptr cQWebPage, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QWebPage_childEvent ".} =
  ...
  nimfunc[](slotval1)
proc QWebPagecustomEvent*(self: gen_qwebpage_types.QWebPage, event: QEvent): void =
  fQWebPage_virtualbase_customEvent(self.h, event.h)

type QWebPagecustomEventProc* = proc(event: QEvent): void
...
proc miqt_exec_callback_QWebPage_customEvent(self: ptr cQWebPage, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QWebPage_customEvent ".} =
  ...
  nimfunc[](slotval1)
proc QWebPageconnectNotify*(self: gen_qwebpage_types.QWebPage, signal: QMetaMethod): void =
  fQWebPage_virtualbase_connectNotify(self.h, signal.h)

type QWebPageconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc miqt_exec_callback_QWebPage_connectNotify(self: ptr cQWebPage, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QWebPage_connectNotify ".} =
  ...
  nimfunc[](slotval1)
proc QWebPagedisconnectNotify*(self: gen_qwebpage_types.QWebPage, signal: QMetaMethod): void =
  fQWebPage_virtualbase_disconnectNotify(self.h, signal.h)

type QWebPagedisconnectNotifyProc* = proc(signal: QMetaMethod): void
...
proc create*(T: type gen_qwebpage_types.QWebPageViewportAttributes, other: QWebPageViewportAttributes): gen_qwebpage_types.QWebPageViewportAttributes =
  gen_qwebpage_types.QWebPageViewportAttributes.init(fcQWebPageViewportAttributes_new2(other.h))

proc operatorAssign*(self: gen_qwebpage_types.QWebPageViewportAttributes, other: QWebPageViewportAttributes): void =
...
proc size*(self: gen_qwebpage_types.QWebPageViewportAttributes, ): QSizeF =
  QSizeF(h: fcQWebPageViewportAttributes_size(self.h))
...
func init*(T: type gen_qwebpage_types.QWebPageExtensionOption, h: ptr cQWebPageExtensionOption): gen_qwebpage_types.QWebPageExtensionOption =
  T(h: h)
proc create*(T: type gen_qwebpage_types.QWebPageExtensionOption, param1: QWebPageExtensionOption): gen_qwebpage_types.QWebPageExtensionOption =
...
func init*(T: type gen_qwebpage_types.QWebPageExtensionReturn, h: ptr cQWebPageExtensionReturn): gen_qwebpage_types.QWebPageExtensionReturn =
  T(h: h)
proc create*(T: type gen_qwebpage_types.QWebPageExtensionReturn, param1: QWebPageExtensionReturn): gen_qwebpage_types.QWebPageExtensionReturn =
...
func init*(T: type gen_qwebpage_types.QWebPageErrorPageExtensionOption, h: ptr cQWebPageErrorPageExtensionOption): gen_qwebpage_types.QWebPageErrorPageExtensionOption =
  T(h: h)
proc create*(T: type gen_qwebpage_types.QWebPageErrorPageExtensionOption, param1: QWebPageErrorPageExtensionOption): gen_qwebpage_types.QWebPageErrorPageExtensionOption =
  gen_qwebpage_types.QWebPageErrorPageExtensionOption.init(fcQWebPageErrorPageExtensionOption_new(param1.h))

proc operatorAssign*(self: gen_qwebpage_types.QWebPageErrorPageExtensionOption, param1: QWebPageErrorPageExtensionOption): void =
...
proc create*(T: type gen_qwebpage_types.QWebPageErrorPageExtensionReturn, param1: QWebPageErrorPageExtensionReturn): gen_qwebpage_types.QWebPageErrorPageExtensionReturn =
  gen_qwebpage_types.QWebPageErrorPageExtensionReturn.init(fcQWebPageErrorPageExtensionReturn_new2(param1.h))

proc operatorAssign*(self: gen_qwebpage_types.QWebPageErrorPageExtensionReturn, param1: QWebPageErrorPageExtensionReturn): void =
