...
struct Scintilla__Internal__Surface_VTable {
	void (*destructor)(struct Scintilla__Internal__Surface_VTable* vtbl, Scintilla__Internal__Surface* self);
	void (*Init)(struct Scintilla__Internal__Surface_VTable* vtbl, Scintilla__Internal__Surface* self, void* wid);
	void (*Init2)(struct Scintilla__Internal__Surface_VTable* vtbl, Scintilla__Internal__Surface* self, void* sid, void* wid);
	void (*SetMode)(struct Scintilla__Internal__Surface_VTable* vtbl, Scintilla__Internal__Surface* self, Scintilla__Internal__SurfaceMode* mode);
	void (*Release)(struct Scintilla__Internal__Surface_VTable* vtbl, Scintilla__Internal__Surface* self);
	int (*SupportsFeature)(struct Scintilla__Internal__Surface_VTable* vtbl, Scintilla__Internal__Surface* self, int feature);
	bool (*Initialised)(struct Scintilla__Internal__Surface_VTable* vtbl, Scintilla__Internal__Surface* self);
	int (*LogPixelsY)(struct Scintilla__Internal__Surface_VTable* vtbl, Scintilla__Internal__Surface* self);
	int (*PixelDivisions)(struct Scintilla__Internal__Surface_VTable* vtbl, Scintilla__Internal__Surface* self);
	int (*DeviceHeightFont)(struct Scintilla__Internal__Surface_VTable* vtbl, Scintilla__Internal__Surface* self, int points);
	void (*LineDraw)(struct Scintilla__Internal__Surface_VTable* vtbl, Scintilla__Internal__Surface* self, Scintilla__Internal__Point* start, Scintilla__Internal__Point* end, Scintilla__Internal__Stroke* stroke);
	void (*PolyLine)(struct Scintilla__Internal__Surface_VTable* vtbl, Scintilla__Internal__Surface* self, Scintilla__Internal__Point* pts, size_t npts, Scintilla__Internal__Stroke* stroke);
	void (*Polygon)(struct Scintilla__Internal__Surface_VTable* vtbl, Scintilla__Internal__Surface* self, Scintilla__Internal__Point* pts, size_t npts, Scintilla__Internal__FillStroke* fillStroke);
	void (*RectangleDraw)(struct Scintilla__Internal__Surface_VTable* vtbl, Scintilla__Internal__Surface* self, Scintilla__Internal__PRectangle* rc, Scintilla__Internal__FillStroke* fillStroke);
	void (*RectangleFrame)(struct Scintilla__Internal__Surface_VTable* vtbl, Scintilla__Internal__Surface* self, Scintilla__Internal__PRectangle* rc, Scintilla__Internal__Stroke* stroke);
	void (*FillRectangle)(struct Scintilla__Internal__Surface_VTable* vtbl, Scintilla__Internal__Surface* self, Scintilla__Internal__PRectangle* rc, Scintilla__Internal__Fill* fill);
	void (*FillRectangleAligned)(struct Scintilla__Internal__Surface_VTable* vtbl, Scintilla__Internal__Surface* self, Scintilla__Internal__PRectangle* rc, Scintilla__Internal__Fill* fill);
	void (*FillRectangle2)(struct Scintilla__Internal__Surface_VTable* vtbl, Scintilla__Internal__Surface* self, Scintilla__Internal__PRectangle* rc, Scintilla__Internal__Surface* surfacePattern);
	void (*RoundedRectangle)(struct Scintilla__Internal__Surface_VTable* vtbl, Scintilla__Internal__Surface* self, Scintilla__Internal__PRectangle* rc, Scintilla__Internal__FillStroke* fillStroke);
	void (*AlphaRectangle)(struct Scintilla__Internal__Surface_VTable* vtbl, Scintilla__Internal__Surface* self, Scintilla__Internal__PRectangle* rc, double cornerSize, Scintilla__Internal__FillStroke* fillStroke);
	void (*DrawRGBAImage)(struct Scintilla__Internal__Surface_VTable* vtbl, Scintilla__Internal__Surface* self, Scintilla__Internal__PRectangle* rc, int width, int height, const unsigned char* pixelsImage);
	void (*Ellipse)(struct Scintilla__Internal__Surface_VTable* vtbl, Scintilla__Internal__Surface* self, Scintilla__Internal__PRectangle* rc, Scintilla__Internal__FillStroke* fillStroke);
	void (*Stadium)(struct Scintilla__Internal__Surface_VTable* vtbl, Scintilla__Internal__Surface* self, Scintilla__Internal__PRectangle* rc, Scintilla__Internal__FillStroke* fillStroke, int ends);
	void (*Copy)(struct Scintilla__Internal__Surface_VTable* vtbl, Scintilla__Internal__Surface* self, Scintilla__Internal__PRectangle* rc, Scintilla__Internal__Point* from, Scintilla__Internal__Surface* surfaceSource);
	double (*Ascent)(struct Scintilla__Internal__Surface_VTable* vtbl, Scintilla__Internal__Surface* self, Scintilla__Internal__Font* font_);
	double (*Descent)(struct Scintilla__Internal__Surface_VTable* vtbl, Scintilla__Internal__Surface* self, Scintilla__Internal__Font* font_);
	double (*InternalLeading)(struct Scintilla__Internal__Surface_VTable* vtbl, Scintilla__Internal__Surface* self, Scintilla__Internal__Font* font_);
	double (*Height)(struct Scintilla__Internal__Surface_VTable* vtbl, Scintilla__Internal__Surface* self, Scintilla__Internal__Font* font_);
	double (*AverageCharWidth)(struct Scintilla__Internal__Surface_VTable* vtbl, Scintilla__Internal__Surface* self, Scintilla__Internal__Font* font_);
	void (*SetClip)(struct Scintilla__Internal__Surface_VTable* vtbl, Scintilla__Internal__Surface* self, Scintilla__Internal__PRectangle* rc);
	void (*PopClip)(struct Scintilla__Internal__Surface_VTable* vtbl, Scintilla__Internal__Surface* self);
	void (*FlushCachedState)(struct Scintilla__Internal__Surface_VTable* vtbl, Scintilla__Internal__Surface* self);
	void (*FlushDrawing)(struct Scintilla__Internal__Surface_VTable* vtbl, Scintilla__Internal__Surface* self);
};
...
struct Scintilla__Internal__ListBox_VTable {
	void (*destructor)(struct Scintilla__Internal__ListBox_VTable* vtbl, Scintilla__Internal__ListBox* self);
	void (*SetFont)(struct Scintilla__Internal__ListBox_VTable* vtbl, Scintilla__Internal__ListBox* self, Scintilla__Internal__Font* font);
	void (*Create)(struct Scintilla__Internal__ListBox_VTable* vtbl, Scintilla__Internal__ListBox* self, Scintilla__Internal__Window* parent, int ctrlID, Scintilla__Internal__Point* location, int lineHeight_, bool unicodeMode_, int technology_);
	void (*SetAverageCharWidth)(struct Scintilla__Internal__ListBox_VTable* vtbl, Scintilla__Internal__ListBox* self, int width);
	void (*SetVisibleRows)(struct Scintilla__Internal__ListBox_VTable* vtbl, Scintilla__Internal__ListBox* self, int rows);
	int (*GetVisibleRows)(struct Scintilla__Internal__ListBox_VTable* vtbl, const Scintilla__Internal__ListBox* self);
	Scintilla__Internal__PRectangle* (*GetDesiredRect)(struct Scintilla__Internal__ListBox_VTable* vtbl, Scintilla__Internal__ListBox* self);
	int (*CaretFromEdge)(struct Scintilla__Internal__ListBox_VTable* vtbl, Scintilla__Internal__ListBox* self);
	void (*Clear)(struct Scintilla__Internal__ListBox_VTable* vtbl, Scintilla__Internal__ListBox* self);
	void (*Append)(struct Scintilla__Internal__ListBox_VTable* vtbl, Scintilla__Internal__ListBox* self, char* s, int type);
	int (*Length)(struct Scintilla__Internal__ListBox_VTable* vtbl, Scintilla__Internal__ListBox* self);
	void (*Select)(struct Scintilla__Internal__ListBox_VTable* vtbl, Scintilla__Internal__ListBox* self, int n);
	int (*GetSelection)(struct Scintilla__Internal__ListBox_VTable* vtbl, Scintilla__Internal__ListBox* self);
	int (*Find)(struct Scintilla__Internal__ListBox_VTable* vtbl, Scintilla__Internal__ListBox* self, const char* prefix);
	void (*RegisterImage)(struct Scintilla__Internal__ListBox_VTable* vtbl, Scintilla__Internal__ListBox* self, int type, const char* xpm_data);
	void (*RegisterRGBAImage)(struct Scintilla__Internal__ListBox_VTable* vtbl, Scintilla__Internal__ListBox* self, int type, int width, int height, const unsigned char* pixelsImage);
	void (*ClearRegisteredImages)(struct Scintilla__Internal__ListBox_VTable* vtbl, Scintilla__Internal__ListBox* self);
	void (*SetDelegate)(struct Scintilla__Internal__ListBox_VTable* vtbl, Scintilla__Internal__ListBox* self, Scintilla__Internal__IListBoxDelegate* lbDelegate);
	void (*SetList)(struct Scintilla__Internal__ListBox_VTable* vtbl, Scintilla__Internal__ListBox* self, const char* list, char separator, char typesep);
	void (*SetOptions)(struct Scintilla__Internal__ListBox_VTable* vtbl, Scintilla__Internal__ListBox* self, Scintilla__Internal__ListOptions* options_);
};
...
struct ScintillaEditBase_VTable {
	void (*destructor)(struct ScintillaEditBase_VTable* vtbl, ScintillaEditBase* self);
	QMetaObject* (*metaObject)(struct ScintillaEditBase_VTable* vtbl, const ScintillaEditBase* self);
	void* (*metacast)(struct ScintillaEditBase_VTable* vtbl, ScintillaEditBase* self, const char* param1);
	int (*metacall)(struct ScintillaEditBase_VTable* vtbl, ScintillaEditBase* self, int param1, int param2, void** param3);
	intptr_t (*send)(struct ScintillaEditBase_VTable* vtbl, const ScintillaEditBase* self, unsigned int iMessage, uintptr_t wParam, intptr_t lParam);
	intptr_t (*sends)(struct ScintillaEditBase_VTable* vtbl, const ScintillaEditBase* self, unsigned int iMessage, uintptr_t wParam, const char* s);
	bool (*event)(struct ScintillaEditBase_VTable* vtbl, ScintillaEditBase* self, QEvent* event);
	void (*paintEvent)(struct ScintillaEditBase_VTable* vtbl, ScintillaEditBase* self, QPaintEvent* event);
	void (*wheelEvent)(struct ScintillaEditBase_VTable* vtbl, ScintillaEditBase* self, QWheelEvent* event);
	void (*focusInEvent)(struct ScintillaEditBase_VTable* vtbl, ScintillaEditBase* self, QFocusEvent* event);
	void (*focusOutEvent)(struct ScintillaEditBase_VTable* vtbl, ScintillaEditBase* self, QFocusEvent* event);
	void (*resizeEvent)(struct ScintillaEditBase_VTable* vtbl, ScintillaEditBase* self, QResizeEvent* event);
	void (*keyPressEvent)(struct ScintillaEditBase_VTable* vtbl, ScintillaEditBase* self, QKeyEvent* event);
	void (*mousePressEvent)(struct ScintillaEditBase_VTable* vtbl, ScintillaEditBase* self, QMouseEvent* event);
	void (*mouseReleaseEvent)(struct ScintillaEditBase_VTable* vtbl, ScintillaEditBase* self, QMouseEvent* event);
	void (*mouseDoubleClickEvent)(struct ScintillaEditBase_VTable* vtbl, ScintillaEditBase* self, QMouseEvent* event);
	void (*mouseMoveEvent)(struct ScintillaEditBase_VTable* vtbl, ScintillaEditBase* self, QMouseEvent* event);
	void (*contextMenuEvent)(struct ScintillaEditBase_VTable* vtbl, ScintillaEditBase* self, QContextMenuEvent* event);
	void (*dragEnterEvent)(struct ScintillaEditBase_VTable* vtbl, ScintillaEditBase* self, QDragEnterEvent* event);
	void (*dragLeaveEvent)(struct ScintillaEditBase_VTable* vtbl, ScintillaEditBase* self, QDragLeaveEvent* event);
	void (*dragMoveEvent)(struct ScintillaEditBase_VTable* vtbl, ScintillaEditBase* self, QDragMoveEvent* event);
	void (*dropEvent)(struct ScintillaEditBase_VTable* vtbl, ScintillaEditBase* self, QDropEvent* event);
	void (*inputMethodEvent)(struct ScintillaEditBase_VTable* vtbl, ScintillaEditBase* self, QInputMethodEvent* event);
	QVariant* (*inputMethodQuery)(struct ScintillaEditBase_VTable* vtbl, const ScintillaEditBase* self, int query);
	void (*scrollContentsBy)(struct ScintillaEditBase_VTable* vtbl, ScintillaEditBase* self, int param1, int param2);
	QSize* (*minimumSizeHint)(struct ScintillaEditBase_VTable* vtbl, const ScintillaEditBase* self);
	QSize* (*sizeHint)(struct ScintillaEditBase_VTable* vtbl, const ScintillaEditBase* self);
	void (*setupViewport)(struct ScintillaEditBase_VTable* vtbl, ScintillaEditBase* self, QWidget* viewport);
	bool (*eventFilter)(struct ScintillaEditBase_VTable* vtbl, ScintillaEditBase* self, QObject* param1, QEvent* param2);
	bool (*viewportEvent)(struct ScintillaEditBase_VTable* vtbl, ScintillaEditBase* self, QEvent* param1);
	QSize* (*viewportSizeHint)(struct ScintillaEditBase_VTable* vtbl, const ScintillaEditBase* self);
	void (*changeEvent)(struct ScintillaEditBase_VTable* vtbl, ScintillaEditBase* self, QEvent* param1);
	int (*devType)(struct ScintillaEditBase_VTable* vtbl, const ScintillaEditBase* self);
	void (*setVisible)(struct ScintillaEditBase_VTable* vtbl, ScintillaEditBase* self, bool visible);
	int (*heightForWidth)(struct ScintillaEditBase_VTable* vtbl, const ScintillaEditBase* self, int param1);
	bool (*hasHeightForWidth)(struct ScintillaEditBase_VTable* vtbl, const ScintillaEditBase* self);
	QPaintEngine* (*paintEngine)(struct ScintillaEditBase_VTable* vtbl, const ScintillaEditBase* self);
	void (*keyReleaseEvent)(struct ScintillaEditBase_VTable* vtbl, ScintillaEditBase* self, QKeyEvent* event);
	void (*enterEvent)(struct ScintillaEditBase_VTable* vtbl, ScintillaEditBase* self, QEvent* event);
	void (*leaveEvent)(struct ScintillaEditBase_VTable* vtbl, ScintillaEditBase* self, QEvent* event);
	void (*moveEvent)(struct ScintillaEditBase_VTable* vtbl, ScintillaEditBase* self, QMoveEvent* event);
	void (*closeEvent)(struct ScintillaEditBase_VTable* vtbl, ScintillaEditBase* self, QCloseEvent* event);
	void (*tabletEvent)(struct ScintillaEditBase_VTable* vtbl, ScintillaEditBase* self, QTabletEvent* event);
	void (*actionEvent)(struct ScintillaEditBase_VTable* vtbl, ScintillaEditBase* self, QActionEvent* event);
	void (*showEvent)(struct ScintillaEditBase_VTable* vtbl, ScintillaEditBase* self, QShowEvent* event);
	void (*hideEvent)(struct ScintillaEditBase_VTable* vtbl, ScintillaEditBase* self, QHideEvent* event);
	bool (*nativeEvent)(struct ScintillaEditBase_VTable* vtbl, ScintillaEditBase* self, struct miqt_string eventType, void* message, long* result);
	int (*metric)(struct ScintillaEditBase_VTable* vtbl, const ScintillaEditBase* self, int param1);
	void (*initPainter)(struct ScintillaEditBase_VTable* vtbl, const ScintillaEditBase* self, QPainter* painter);
	QPaintDevice* (*redirected)(struct ScintillaEditBase_VTable* vtbl, const ScintillaEditBase* self, QPoint* offset);
	QPainter* (*sharedPainter)(struct ScintillaEditBase_VTable* vtbl, const ScintillaEditBase* self);
	bool (*focusNextPrevChild)(struct ScintillaEditBase_VTable* vtbl, ScintillaEditBase* self, bool next);
	void (*timerEvent)(struct ScintillaEditBase_VTable* vtbl, ScintillaEditBase* self, QTimerEvent* event);
	void (*childEvent)(struct ScintillaEditBase_VTable* vtbl, ScintillaEditBase* self, QChildEvent* event);
	void (*customEvent)(struct ScintillaEditBase_VTable* vtbl, ScintillaEditBase* self, QEvent* event);
	void (*connectNotify)(struct ScintillaEditBase_VTable* vtbl, ScintillaEditBase* self, QMetaMethod* signal);
	void (*disconnectNotify)(struct ScintillaEditBase_VTable* vtbl, ScintillaEditBase* self, QMetaMethod* signal);
};
...
struct ScintillaDocument_VTable {
	void (*destructor)(struct ScintillaDocument_VTable* vtbl, ScintillaDocument* self);
	QMetaObject* (*metaObject)(struct ScintillaDocument_VTable* vtbl, const ScintillaDocument* self);
	void* (*metacast)(struct ScintillaDocument_VTable* vtbl, ScintillaDocument* self, const char* param1);
	int (*metacall)(struct ScintillaDocument_VTable* vtbl, ScintillaDocument* self, int param1, int param2, void** param3);
	bool (*event)(struct ScintillaDocument_VTable* vtbl, ScintillaDocument* self, QEvent* event);
	bool (*eventFilter)(struct ScintillaDocument_VTable* vtbl, ScintillaDocument* self, QObject* watched, QEvent* event);
	void (*timerEvent)(struct ScintillaDocument_VTable* vtbl, ScintillaDocument* self, QTimerEvent* event);
	void (*childEvent)(struct ScintillaDocument_VTable* vtbl, ScintillaDocument* self, QChildEvent* event);
	void (*customEvent)(struct ScintillaDocument_VTable* vtbl, ScintillaDocument* self, QEvent* event);
	void (*connectNotify)(struct ScintillaDocument_VTable* vtbl, ScintillaDocument* self, QMetaMethod* signal);
	void (*disconnectNotify)(struct ScintillaDocument_VTable* vtbl, ScintillaDocument* self, QMetaMethod* signal);
};
...
struct ScintillaEdit_VTable {
	void (*destructor)(struct ScintillaEdit_VTable* vtbl, ScintillaEdit* self);
	QMetaObject* (*metaObject)(struct ScintillaEdit_VTable* vtbl, const ScintillaEdit* self);
	void* (*metacast)(struct ScintillaEdit_VTable* vtbl, ScintillaEdit* self, const char* param1);
	int (*metacall)(struct ScintillaEdit_VTable* vtbl, ScintillaEdit* self, int param1, int param2, void** param3);
	intptr_t (*send)(struct ScintillaEdit_VTable* vtbl, const ScintillaEdit* self, unsigned int iMessage, uintptr_t wParam, intptr_t lParam);
	intptr_t (*sends)(struct ScintillaEdit_VTable* vtbl, const ScintillaEdit* self, unsigned int iMessage, uintptr_t wParam, const char* s);
	bool (*event)(struct ScintillaEdit_VTable* vtbl, ScintillaEdit* self, QEvent* event);
	void (*paintEvent)(struct ScintillaEdit_VTable* vtbl, ScintillaEdit* self, QPaintEvent* event);
	void (*wheelEvent)(struct ScintillaEdit_VTable* vtbl, ScintillaEdit* self, QWheelEvent* event);
	void (*focusInEvent)(struct ScintillaEdit_VTable* vtbl, ScintillaEdit* self, QFocusEvent* event);
	void (*focusOutEvent)(struct ScintillaEdit_VTable* vtbl, ScintillaEdit* self, QFocusEvent* event);
	void (*resizeEvent)(struct ScintillaEdit_VTable* vtbl, ScintillaEdit* self, QResizeEvent* event);
	void (*keyPressEvent)(struct ScintillaEdit_VTable* vtbl, ScintillaEdit* self, QKeyEvent* event);
	void (*mousePressEvent)(struct ScintillaEdit_VTable* vtbl, ScintillaEdit* self, QMouseEvent* event);
	void (*mouseReleaseEvent)(struct ScintillaEdit_VTable* vtbl, ScintillaEdit* self, QMouseEvent* event);
	void (*mouseDoubleClickEvent)(struct ScintillaEdit_VTable* vtbl, ScintillaEdit* self, QMouseEvent* event);
	void (*mouseMoveEvent)(struct ScintillaEdit_VTable* vtbl, ScintillaEdit* self, QMouseEvent* event);
	void (*contextMenuEvent)(struct ScintillaEdit_VTable* vtbl, ScintillaEdit* self, QContextMenuEvent* event);
	void (*dragEnterEvent)(struct ScintillaEdit_VTable* vtbl, ScintillaEdit* self, QDragEnterEvent* event);
	void (*dragLeaveEvent)(struct ScintillaEdit_VTable* vtbl, ScintillaEdit* self, QDragLeaveEvent* event);
	void (*dragMoveEvent)(struct ScintillaEdit_VTable* vtbl, ScintillaEdit* self, QDragMoveEvent* event);
	void (*dropEvent)(struct ScintillaEdit_VTable* vtbl, ScintillaEdit* self, QDropEvent* event);
	void (*inputMethodEvent)(struct ScintillaEdit_VTable* vtbl, ScintillaEdit* self, QInputMethodEvent* event);
	QVariant* (*inputMethodQuery)(struct ScintillaEdit_VTable* vtbl, const ScintillaEdit* self, int query);
	void (*scrollContentsBy)(struct ScintillaEdit_VTable* vtbl, ScintillaEdit* self, int param1, int param2);
	QSize* (*minimumSizeHint)(struct ScintillaEdit_VTable* vtbl, const ScintillaEdit* self);
	QSize* (*sizeHint)(struct ScintillaEdit_VTable* vtbl, const ScintillaEdit* self);
	void (*setupViewport)(struct ScintillaEdit_VTable* vtbl, ScintillaEdit* self, QWidget* viewport);
	bool (*eventFilter)(struct ScintillaEdit_VTable* vtbl, ScintillaEdit* self, QObject* param1, QEvent* param2);
	bool (*viewportEvent)(struct ScintillaEdit_VTable* vtbl, ScintillaEdit* self, QEvent* param1);
	QSize* (*viewportSizeHint)(struct ScintillaEdit_VTable* vtbl, const ScintillaEdit* self);
	void (*changeEvent)(struct ScintillaEdit_VTable* vtbl, ScintillaEdit* self, QEvent* param1);
	int (*devType)(struct ScintillaEdit_VTable* vtbl, const ScintillaEdit* self);
	void (*setVisible)(struct ScintillaEdit_VTable* vtbl, ScintillaEdit* self, bool visible);
	int (*heightForWidth)(struct ScintillaEdit_VTable* vtbl, const ScintillaEdit* self, int param1);
	bool (*hasHeightForWidth)(struct ScintillaEdit_VTable* vtbl, const ScintillaEdit* self);
	QPaintEngine* (*paintEngine)(struct ScintillaEdit_VTable* vtbl, const ScintillaEdit* self);
	void (*keyReleaseEvent)(struct ScintillaEdit_VTable* vtbl, ScintillaEdit* self, QKeyEvent* event);
	void (*enterEvent)(struct ScintillaEdit_VTable* vtbl, ScintillaEdit* self, QEvent* event);
	void (*leaveEvent)(struct ScintillaEdit_VTable* vtbl, ScintillaEdit* self, QEvent* event);
	void (*moveEvent)(struct ScintillaEdit_VTable* vtbl, ScintillaEdit* self, QMoveEvent* event);
	void (*closeEvent)(struct ScintillaEdit_VTable* vtbl, ScintillaEdit* self, QCloseEvent* event);
	void (*tabletEvent)(struct ScintillaEdit_VTable* vtbl, ScintillaEdit* self, QTabletEvent* event);
	void (*actionEvent)(struct ScintillaEdit_VTable* vtbl, ScintillaEdit* self, QActionEvent* event);
	void (*showEvent)(struct ScintillaEdit_VTable* vtbl, ScintillaEdit* self, QShowEvent* event);
	void (*hideEvent)(struct ScintillaEdit_VTable* vtbl, ScintillaEdit* self, QHideEvent* event);
	bool (*nativeEvent)(struct ScintillaEdit_VTable* vtbl, ScintillaEdit* self, struct miqt_string eventType, void* message, long* result);
	int (*metric)(struct ScintillaEdit_VTable* vtbl, const ScintillaEdit* self, int param1);
	void (*initPainter)(struct ScintillaEdit_VTable* vtbl, const ScintillaEdit* self, QPainter* painter);
	QPaintDevice* (*redirected)(struct ScintillaEdit_VTable* vtbl, const ScintillaEdit* self, QPoint* offset);
	QPainter* (*sharedPainter)(struct ScintillaEdit_VTable* vtbl, const ScintillaEdit* self);
	bool (*focusNextPrevChild)(struct ScintillaEdit_VTable* vtbl, ScintillaEdit* self, bool next);
	void (*timerEvent)(struct ScintillaEdit_VTable* vtbl, ScintillaEdit* self, QTimerEvent* event);
	void (*childEvent)(struct ScintillaEdit_VTable* vtbl, ScintillaEdit* self, QChildEvent* event);
	void (*customEvent)(struct ScintillaEdit_VTable* vtbl, ScintillaEdit* self, QEvent* event);
	void (*connectNotify)(struct ScintillaEdit_VTable* vtbl, ScintillaEdit* self, QMetaMethod* signal);
	void (*disconnectNotify)(struct ScintillaEdit_VTable* vtbl, ScintillaEdit* self, QMetaMethod* signal);
};
