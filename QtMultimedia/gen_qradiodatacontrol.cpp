...
void miqt_exec_callback_QRadioDataControl_stationIdChanged_release(intptr_t);
void miqt_exec_callback_QRadioDataControl_programTypeChanged(intptr_t, int);
void miqt_exec_callback_QRadioDataControl_programTypeChanged_release(intptr_t);
void miqt_exec_callback_QRadioDataControl_programTypeNameChanged(intptr_t, struct miqt_string);
void miqt_exec_callback_QRadioDataControl_programTypeNameChanged_release(intptr_t);
void miqt_exec_callback_QRadioDataControl_stationNameChanged(intptr_t, struct miqt_string);
void miqt_exec_callback_QRadioDataControl_stationNameChanged_release(intptr_t);
void miqt_exec_callback_QRadioDataControl_radioTextChanged(intptr_t, struct miqt_string);
void miqt_exec_callback_QRadioDataControl_radioTextChanged_release(intptr_t);
void miqt_exec_callback_QRadioDataControl_alternativeFrequenciesEnabledChanged(intptr_t, bool);
void miqt_exec_callback_QRadioDataControl_alternativeFrequenciesEnabledChanged_release(intptr_t);
void miqt_exec_callback_QRadioDataControl_errorWithErr(intptr_t, int);
void miqt_exec_callback_QRadioDataControl_errorWithErr_release(intptr_t);
#ifdef __cplusplus
} /* extern C */
#endif
...
void QRadioDataControl_connect_stationIdChanged(QRadioDataControl* self, intptr_t slot) {
	struct caller {
		...
		~caller() { miqt_exec_callback_QRadioDataControl_stationIdChanged_release(slot); }
	};
	QRadioDataControl::connect(self, static_cast<void (QRadioDataControl::*)(QString)>(&QRadioDataControl::stationIdChanged), self, caller{slot});
}
...
void QRadioDataControl_connect_programTypeChanged(QRadioDataControl* self, intptr_t slot) {
	struct caller {
		...
		caller(const caller &) = delete;
		caller &operator=(const caller &) = delete;
		~caller() { miqt_exec_callback_QRadioDataControl_programTypeChanged_release(slot); }
	};
	QRadioDataControl::connect(self, static_cast<void (QRadioDataControl::*)(QRadioData::ProgramType)>(&QRadioDataControl::programTypeChanged), self, caller{slot});
}
...
void QRadioDataControl_connect_programTypeNameChanged(QRadioDataControl* self, intptr_t slot) {
	struct caller {
		...
		caller(const caller &) = delete;
		caller &operator=(const caller &) = delete;
		~caller() { miqt_exec_callback_QRadioDataControl_programTypeNameChanged_release(slot); }
	};
	QRadioDataControl::connect(self, static_cast<void (QRadioDataControl::*)(QString)>(&QRadioDataControl::programTypeNameChanged), self, caller{slot});
}
...
void QRadioDataControl_connect_stationNameChanged(QRadioDataControl* self, intptr_t slot) {
	struct caller {
		...
		caller(const caller &) = delete;
		caller &operator=(const caller &) = delete;
		~caller() { miqt_exec_callback_QRadioDataControl_stationNameChanged_release(slot); }
	};
	QRadioDataControl::connect(self, static_cast<void (QRadioDataControl::*)(QString)>(&QRadioDataControl::stationNameChanged), self, caller{slot});
}
...
void QRadioDataControl_connect_radioTextChanged(QRadioDataControl* self, intptr_t slot) {
	struct caller {
		...
		caller(const caller &) = delete;
		caller &operator=(const caller &) = delete;
		~caller() { miqt_exec_callback_QRadioDataControl_radioTextChanged_release(slot); }
	};
	QRadioDataControl::connect(self, static_cast<void (QRadioDataControl::*)(QString)>(&QRadioDataControl::radioTextChanged), self, caller{slot});
}
...
void QRadioDataControl_connect_alternativeFrequenciesEnabledChanged(QRadioDataControl* self, intptr_t slot) {
	struct caller {
		...
		caller(const caller &) = delete;
		caller &operator=(const caller &) = delete;
		~caller() { miqt_exec_callback_QRadioDataControl_alternativeFrequenciesEnabledChanged_release(slot); }
	};
	QRadioDataControl::connect(self, static_cast<void (QRadioDataControl::*)(bool)>(&QRadioDataControl::alternativeFrequenciesEnabledChanged), self, caller{slot});
}
...
void QRadioDataControl_connect_errorWithErr(QRadioDataControl* self, intptr_t slot) {
	struct caller {
		...
		caller(const caller &) = delete;
		caller &operator=(const caller &) = delete;
		~caller() { miqt_exec_callback_QRadioDataControl_errorWithErr_release(slot); }
	};
	QRadioDataControl::connect(self, static_cast<void (QRadioDataControl::*)(QRadioData::Error)>(&QRadioDataControl::error), self, caller{slot});
}
