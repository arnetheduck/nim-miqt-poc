...
proc fcQMediaPlayer_setVideoOutput(self: pointer, videoOutput: ptr cQVideoWidget): void {.importc: "QMediaPlayer_setVideoOutput".}
proc fcQMediaPlayer_setVideoOutputWithVideoOutput(self: pointer, videoOutput: ptr cQGraphicsVideoItem): void {.importc: "QMediaPlayer_setVideoOutputWithVideoOutput".}
...
proc fcQMediaPlayer_currentNetworkConfiguration(self: pointer, ): cQNetworkConfiguration {.importc: "QMediaPlayer_currentNetworkConfiguration".}
...
proc fcQMediaPlayer_networkConfigurationChanged(self: pointer, configuration: ptr cQNetworkConfiguration): void {.importc: "QMediaPlayer_networkConfigurationChanged".}
...
proc setVideoOutput*(self: gen_qmediaplayer_types.QMediaPlayer, videoOutput: ptr QVideoWidget): void =
  fcQMediaPlayer_setVideoOutput(self.h, videoOutput)

proc setVideoOutput*(self: gen_qmediaplayer_types.QMediaPlayer, videoOutput: ptr QGraphicsVideoItem): void =
  fcQMediaPlayer_setVideoOutputWithVideoOutput(self.h, videoOutput)
...
proc currentNetworkConfiguration*(self: gen_qmediaplayer_types.QMediaPlayer, ): QNetworkConfiguration =
...
proc setNetworkConfigurations*(self: gen_qmediaplayer_types.QMediaPlayer, configurations: seq[QNetworkConfiguration]): void =
  var configurations_CArray = newSeq[cQNetworkConfiguration](len(configurations))
  for i in 0..<len(configurations):
    configurations_CArray[i] = configurations[i]
...
proc miqt_exec_callback_cQMediaPlayer_mediaChanged(slot: int, media: pointer) {.exportc: "miqt_exec_callback_QMediaPlayer_mediaChanged".} =
...
proc miqt_exec_callback_cQMediaPlayer_mediaChanged_release(slot: int) {.exportc: "miqt_exec_callback_QMediaPlayer_mediaChanged_release".} =
...
proc miqt_exec_callback_cQMediaPlayer_currentMediaChanged(slot: int, media: pointer) {.exportc: "miqt_exec_callback_QMediaPlayer_currentMediaChanged".} =
  let nimfunc = cast[ptr QMediaPlayercurrentMediaChangedSlot](cast[pointer](slot))
  let slotval1 = gen_qmediacontent_types.QMediaContent(h: media)

  nimfunc[](slotval1)

proc miqt_exec_callback_cQMediaPlayer_currentMediaChanged_release(slot: int) {.exportc: "miqt_exec_callback_QMediaPlayer_currentMediaChanged_release".} =
...
proc miqt_exec_callback_cQMediaPlayer_stateChanged(slot: int, newState: cint) {.exportc: "miqt_exec_callback_QMediaPlayer_stateChanged".} =
  let nimfunc = cast[ptr QMediaPlayerstateChangedSlot](cast[pointer](slot))
  let slotval1 = cint(newState)

  nimfunc[](slotval1)

proc miqt_exec_callback_cQMediaPlayer_stateChanged_release(slot: int) {.exportc: "miqt_exec_callback_QMediaPlayer_stateChanged_release".} =
...
proc miqt_exec_callback_cQMediaPlayer_mediaStatusChanged_release(slot: int) {.exportc: "miqt_exec_callback_QMediaPlayer_mediaStatusChanged_release".} =
...
proc miqt_exec_callback_cQMediaPlayer_durationChanged_release(slot: int) {.exportc: "miqt_exec_callback_QMediaPlayer_durationChanged_release".} =
...
proc miqt_exec_callback_cQMediaPlayer_positionChanged_release(slot: int) {.exportc: "miqt_exec_callback_QMediaPlayer_positionChanged_release".} =
...
proc miqt_exec_callback_cQMediaPlayer_volumeChanged(slot: int, volume: cint) {.exportc: "miqt_exec_callback_QMediaPlayer_volumeChanged".} =
  let nimfunc = cast[ptr QMediaPlayervolumeChangedSlot](cast[pointer](slot))
  let slotval1 = volume

  nimfunc[](slotval1)

proc miqt_exec_callback_cQMediaPlayer_volumeChanged_release(slot: int) {.exportc: "miqt_exec_callback_QMediaPlayer_volumeChanged_release".} =
...
proc miqt_exec_callback_cQMediaPlayer_mutedChanged(slot: int, muted: bool) {.exportc: "miqt_exec_callback_QMediaPlayer_mutedChanged".} =
  let nimfunc = cast[ptr QMediaPlayermutedChangedSlot](cast[pointer](slot))
  let slotval1 = muted

  nimfunc[](slotval1)

proc miqt_exec_callback_cQMediaPlayer_mutedChanged_release(slot: int) {.exportc: "miqt_exec_callback_QMediaPlayer_mutedChanged_release".} =
...
proc miqt_exec_callback_cQMediaPlayer_audioAvailableChanged(slot: int, available: bool) {.exportc: "miqt_exec_callback_QMediaPlayer_audioAvailableChanged".} =
  let nimfunc = cast[ptr QMediaPlayeraudioAvailableChangedSlot](cast[pointer](slot))
  let slotval1 = available

  nimfunc[](slotval1)

proc miqt_exec_callback_cQMediaPlayer_audioAvailableChanged_release(slot: int) {.exportc: "miqt_exec_callback_QMediaPlayer_audioAvailableChanged_release".} =
...
proc miqt_exec_callback_cQMediaPlayer_videoAvailableChanged(slot: int, videoAvailable: bool) {.exportc: "miqt_exec_callback_QMediaPlayer_videoAvailableChanged".} =
  let nimfunc = cast[ptr QMediaPlayervideoAvailableChangedSlot](cast[pointer](slot))
  let slotval1 = videoAvailable

  nimfunc[](slotval1)

proc miqt_exec_callback_cQMediaPlayer_videoAvailableChanged_release(slot: int) {.exportc: "miqt_exec_callback_QMediaPlayer_videoAvailableChanged_release".} =
...
proc miqt_exec_callback_cQMediaPlayer_bufferStatusChanged(slot: int, percentFilled: cint) {.exportc: "miqt_exec_callback_QMediaPlayer_bufferStatusChanged".} =
  let nimfunc = cast[ptr QMediaPlayerbufferStatusChangedSlot](cast[pointer](slot))
  let slotval1 = percentFilled

  nimfunc[](slotval1)

proc miqt_exec_callback_cQMediaPlayer_bufferStatusChanged_release(slot: int) {.exportc: "miqt_exec_callback_QMediaPlayer_bufferStatusChanged_release".} =
...
proc miqt_exec_callback_cQMediaPlayer_seekableChanged_release(slot: int) {.exportc: "miqt_exec_callback_QMediaPlayer_seekableChanged_release".} =
...
proc miqt_exec_callback_cQMediaPlayer_playbackRateChanged_release(slot: int) {.exportc: "miqt_exec_callback_QMediaPlayer_playbackRateChanged_release".} =
...
proc miqt_exec_callback_cQMediaPlayer_audioRoleChanged(slot: int, role: cint) {.exportc: "miqt_exec_callback_QMediaPlayer_audioRoleChanged".} =
  let nimfunc = cast[ptr QMediaPlayeraudioRoleChangedSlot](cast[pointer](slot))
  let slotval1 = cint(role)

  nimfunc[](slotval1)

proc miqt_exec_callback_cQMediaPlayer_audioRoleChanged_release(slot: int) {.exportc: "miqt_exec_callback_QMediaPlayer_audioRoleChanged_release".} =
...
proc miqt_exec_callback_cQMediaPlayer_customAudioRoleChanged(slot: int, role: struct_miqt_string) {.exportc: "miqt_exec_callback_QMediaPlayer_customAudioRoleChanged".} =
...
proc miqt_exec_callback_cQMediaPlayer_customAudioRoleChanged_release(slot: int) {.exportc: "miqt_exec_callback_QMediaPlayer_customAudioRoleChanged_release".} =
...
proc miqt_exec_callback_cQMediaPlayer_errorWithError(slot: int, error: cint) {.exportc: "miqt_exec_callback_QMediaPlayer_errorWithError".} =
  let nimfunc = cast[ptr QMediaPlayererrorWithErrorSlot](cast[pointer](slot))
  let slotval1 = cint(error)

  nimfunc[](slotval1)

proc miqt_exec_callback_cQMediaPlayer_errorWithError_release(slot: int) {.exportc: "miqt_exec_callback_QMediaPlayer_errorWithError_release".} =
...
proc networkConfigurationChanged*(self: gen_qmediaplayer_types.QMediaPlayer, configuration: ptr QNetworkConfiguration): void =
  fcQMediaPlayer_networkConfigurationChanged(self.h, configuration)

type QMediaPlayernetworkConfigurationChangedSlot* = proc(configuration: ptr QNetworkConfiguration)
proc miqt_exec_callback_cQMediaPlayer_networkConfigurationChanged(slot: int, configuration: ptr cQNetworkConfiguration) {.exportc: "miqt_exec_callback_QMediaPlayer_networkConfigurationChanged".} =
  let nimfunc = cast[ptr QMediaPlayernetworkConfigurationChangedSlot](cast[pointer](slot))
TODO QNetworkConfiguration
  nimfunc[](slotval1)

proc miqt_exec_callback_cQMediaPlayer_networkConfigurationChanged_release(slot: int) {.exportc: "miqt_exec_callback_QMediaPlayer_networkConfigurationChanged_release".} =
...
proc miqt_exec_callback_cQMediaPlayer_availability(vtbl: pointer, self: pointer): cint {.cdecl.} =
  let vtbl = cast[ptr QMediaPlayerVTable](vtbl)
  let self = QMediaPlayer(h: self)
  let virtualReturn = vtbl[].availability(self)
  cint(virtualReturn)
...
proc miqt_exec_callback_cQMediaPlayer_bindX(vtbl: pointer, self: pointer, param1: pointer): bool {.cdecl.} =
  ...
  let virtualReturn = vtbl[].bindX(self, slotval1)
  virtualReturn
...
proc create*(T: type gen_qmediaplayer_types.QMediaPlayer,
  ...
  if not isNil(vtbl.disconnectNotify):
    vtbl[].vtbl.disconnectNotify = miqt_exec_callback_cQMediaPlayer_disconnectNotify
  gen_qmediaplayer_types.QMediaPlayer(h: fcQMediaPlayer_new3(addr(vtbl[]), parent.h, cint(flags)))
