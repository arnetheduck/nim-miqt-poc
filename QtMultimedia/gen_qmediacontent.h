#pragma once
#ifndef MIQT_QTMULTIMEDIA_GEN_QMEDIACONTENT_H
#define MIQT_QTMULTIMEDIA_GEN_QMEDIACONTENT_H
...
QMediaContent* QMediaContent_new3(const QNetworkRequest* contentRequest);
