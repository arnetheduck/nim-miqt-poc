...
proc create*(T: type gen_qsoundeffect_types.QSoundEffect, audioDevice: gen_qaudiodevice_types.QAudioDevice): gen_qsoundeffect_types.QSoundEffect =
...
proc create*(T: type gen_qsoundeffect_types.QSoundEffect, audioDevice: gen_qaudiodevice_types.QAudioDevice, parent: gen_qobject_types.QObject): gen_qsoundeffect_types.QSoundEffect =
