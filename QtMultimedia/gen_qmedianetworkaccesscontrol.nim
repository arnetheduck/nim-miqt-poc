...
proc miqt_exec_callback_cQMediaNetworkAccessControl_configurationChanged(slot: int, configuration: ptr cQNetworkConfiguration) {.exportc: "miqt_exec_callback_QMediaNetworkAccessControl_configurationChanged".} =
