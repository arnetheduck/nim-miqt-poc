#pragma once
#ifndef MIQT_QTMULTIMEDIA_GEN_QMEDIARESOURCE_H
#define MIQT_QTMULTIMEDIA_GEN_QMEDIARESOURCE_H
...
QMediaResource* QMediaResource_new3(const QNetworkRequest* request);
...
QMediaResource* QMediaResource_new6(const QNetworkRequest* request, struct miqt_string mimeType);
