...
proc fcQSslSocket_connect_sslErrors(self: pointer, slot: int) {.importc: "QSslSocket_connect_sslErrors".}
...
proc fcQSslSocket_connect_alertSent(self: pointer, slot: int) {.importc: "QSslSocket_connect_alertSent".}
...
proc fcQSslSocket_connect_alertReceived(self: pointer, slot: int) {.importc: "QSslSocket_connect_alertReceived".}
...
proc fcQSslSocket_connect_handshakeInterruptedOnError(self: pointer, slot: int) {.importc: "QSslSocket_connect_handshakeInterruptedOnError".}
...
proc miqt_exec_callback_cQSslSocket_encrypted(slot: int) {.exportc: "miqt_exec_callback_QSslSocket_encrypted".} =
...
proc miqt_exec_callback_cQSslSocket_peerVerifyError(slot: int, error: pointer) {.exportc: "miqt_exec_callback_QSslSocket_peerVerifyError".} =
...
proc miqt_exec_callback_cQSslSocket_sslErrors(slot: int, errors: struct_miqt_array) {.exportc: "miqt_exec_callback_QSslSocket_sslErrors".} =
...
proc miqt_exec_callback_cQSslSocket_sslErrors_release(slot: int) {.exportc: "miqt_exec_callback_QSslSocket_sslErrors_release".} =
...
proc onsslErrors*(self: gen_qsslsocket_types.QSslSocket, slot: QSslSocketsslErrorsSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQSslSocket_connect_sslErrors(self.h, cast[int](addr tmp[]))
...
proc miqt_exec_callback_cQSslSocket_modeChanged(slot: int, newMode: cint) {.exportc: "miqt_exec_callback_QSslSocket_modeChanged".} =
...
proc miqt_exec_callback_cQSslSocket_encryptedBytesWritten(slot: int, totalBytes: clonglong) {.exportc: "miqt_exec_callback_QSslSocket_encryptedBytesWritten".} =
...
proc miqt_exec_callback_cQSslSocket_preSharedKeyAuthenticationRequired(slot: int, authenticator: pointer) {.exportc: "miqt_exec_callback_QSslSocket_preSharedKeyAuthenticationRequired".} =
...
proc miqt_exec_callback_cQSslSocket_alertSent(slot: int, level: cint, typeVal: cint, description: struct_miqt_string) {.exportc: "miqt_exec_callback_QSslSocket_alertSent".} =
...
proc miqt_exec_callback_cQSslSocket_alertSent_release(slot: int) {.exportc: "miqt_exec_callback_QSslSocket_alertSent_release".} =
...
proc onalertSent*(self: gen_qsslsocket_types.QSslSocket, slot: QSslSocketalertSentSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQSslSocket_connect_alertSent(self.h, cast[int](addr tmp[]))
...
proc miqt_exec_callback_cQSslSocket_alertReceived(slot: int, level: cint, typeVal: cint, description: struct_miqt_string) {.exportc: "miqt_exec_callback_QSslSocket_alertReceived".} =
...
proc miqt_exec_callback_cQSslSocket_alertReceived_release(slot: int) {.exportc: "miqt_exec_callback_QSslSocket_alertReceived_release".} =
...
proc onalertReceived*(self: gen_qsslsocket_types.QSslSocket, slot: QSslSocketalertReceivedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQSslSocket_connect_alertReceived(self.h, cast[int](addr tmp[]))
...
proc miqt_exec_callback_cQSslSocket_handshakeInterruptedOnError(slot: int, error: pointer) {.exportc: "miqt_exec_callback_QSslSocket_handshakeInterruptedOnError".} =
  let nimfunc = cast[ptr QSslSockethandshakeInterruptedOnErrorSlot](cast[pointer](slot))
  let slotval1 = gen_qsslerror_types.QSslError(h: error)

  nimfunc[](slotval1)

proc miqt_exec_callback_cQSslSocket_handshakeInterruptedOnError_release(slot: int) {.exportc: "miqt_exec_callback_QSslSocket_handshakeInterruptedOnError_release".} =
...
proc onhandshakeInterruptedOnError*(self: gen_qsslsocket_types.QSslSocket, slot: QSslSockethandshakeInterruptedOnErrorSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQSslSocket_connect_handshakeInterruptedOnError(self.h, cast[int](addr tmp[]))
...
proc miqt_exec_callback_cQSslSocket_setSocketDescriptor(vtbl: pointer, self: pointer, socketDescriptor: uint, state: cint, openMode: cint): bool {.cdecl.} =
  ...
  let virtualReturn = vtbl[].setSocketDescriptor(self, slotval1, slotval2, slotval3)
  virtualReturn
...
proc miqt_exec_callback_cQSslSocket_socketOption(vtbl: pointer, self: pointer, option: cint): pointer {.cdecl.} =
  ...
  let self = QSslSocket(h: self)
  let slotval1 = cint(option)
  let virtualReturn = vtbl[].socketOption(self, slotval1)
  virtualReturn.h
...
proc miqt_exec_callback_cQSslSocket_bytesAvailable(vtbl: pointer, self: pointer): clonglong {.cdecl.} =
  let vtbl = cast[ptr QSslSocketVTable](vtbl)
  let self = QSslSocket(h: self)
  let virtualReturn = vtbl[].bytesAvailable(self)
  virtualReturn
...
proc miqt_exec_callback_cQSslSocket_bytesToWrite(vtbl: pointer, self: pointer): clonglong {.cdecl.} =
  let vtbl = cast[ptr QSslSocketVTable](vtbl)
  let self = QSslSocket(h: self)
  let virtualReturn = vtbl[].bytesToWrite(self)
  virtualReturn
...
proc miqt_exec_callback_cQSslSocket_canReadLine(vtbl: pointer, self: pointer): bool {.cdecl.} =
  let vtbl = cast[ptr QSslSocketVTable](vtbl)
  let self = QSslSocket(h: self)
  let virtualReturn = vtbl[].canReadLine(self)
  virtualReturn
...
proc miqt_exec_callback_cQSslSocket_atEnd(vtbl: pointer, self: pointer): bool {.cdecl.} =
  let vtbl = cast[ptr QSslSocketVTable](vtbl)
  let self = QSslSocket(h: self)
  let virtualReturn = vtbl[].atEnd(self)
  virtualReturn
...
proc miqt_exec_callback_cQSslSocket_waitForConnected(vtbl: pointer, self: pointer, msecs: cint): bool {.cdecl.} =
  ...
  let self = QSslSocket(h: self)
  let slotval1 = msecs
  let virtualReturn = vtbl[].waitForConnected(self, slotval1)
  virtualReturn
...
proc miqt_exec_callback_cQSslSocket_waitForReadyRead(vtbl: pointer, self: pointer, msecs: cint): bool {.cdecl.} =
  ...
  let self = QSslSocket(h: self)
  let slotval1 = msecs
  let virtualReturn = vtbl[].waitForReadyRead(self, slotval1)
  virtualReturn
...
proc miqt_exec_callback_cQSslSocket_waitForBytesWritten(vtbl: pointer, self: pointer, msecs: cint): bool {.cdecl.} =
  ...
  let self = QSslSocket(h: self)
  let slotval1 = msecs
  let virtualReturn = vtbl[].waitForBytesWritten(self, slotval1)
  virtualReturn
...
proc miqt_exec_callback_cQSslSocket_waitForDisconnected(vtbl: pointer, self: pointer, msecs: cint): bool {.cdecl.} =
  ...
  let self = QSslSocket(h: self)
  let slotval1 = msecs
  let virtualReturn = vtbl[].waitForDisconnected(self, slotval1)
  virtualReturn
...
proc miqt_exec_callback_cQSslSocket_readData(vtbl: pointer, self: pointer, data: cstring, maxlen: clonglong): clonglong {.cdecl.} =
  ...
  let slotval1 = (data)
  let slotval2 = maxlen
  let virtualReturn = vtbl[].readData(self, slotval1, slotval2)
  virtualReturn
...
proc miqt_exec_callback_cQSslSocket_skipData(vtbl: pointer, self: pointer, maxSize: clonglong): clonglong {.cdecl.} =
  ...
  let virtualReturn = vtbl[].skipData(self, slotval1)
  virtualReturn
...
proc miqt_exec_callback_cQSslSocket_writeData(vtbl: pointer, self: pointer, data: cstring, len: clonglong): clonglong {.cdecl.} =
  ...
  let slotval1 = (data)
  let slotval2 = len
  let virtualReturn = vtbl[].writeData(self, slotval1, slotval2)
  virtualReturn
...
proc miqt_exec_callback_cQSslSocket_bindX(vtbl: pointer, self: pointer, address: pointer, port: cushort, mode: cint): bool {.cdecl.} =
  ...
  let virtualReturn = vtbl[].bindX(self, slotval1, slotval2, slotval3)
  virtualReturn
...
proc miqt_exec_callback_cQSslSocket_socketDescriptor(vtbl: pointer, self: pointer): uint {.cdecl.} =
  let vtbl = cast[ptr QSslSocketVTable](vtbl)
  let self = QSslSocket(h: self)
  let virtualReturn = vtbl[].socketDescriptor(self)
  virtualReturn
...
proc miqt_exec_callback_cQSslSocket_isSequential(vtbl: pointer, self: pointer): bool {.cdecl.} =
  let vtbl = cast[ptr QSslSocketVTable](vtbl)
  let self = QSslSocket(h: self)
  let virtualReturn = vtbl[].isSequential(self)
  virtualReturn
...
proc miqt_exec_callback_cQSslSocket_readLineData(vtbl: pointer, self: pointer, data: cstring, maxlen: clonglong): clonglong {.cdecl.} =
  ...
  let slotval1 = (data)
  let slotval2 = maxlen
  let virtualReturn = vtbl[].readLineData(self, slotval1, slotval2)
  virtualReturn
...
proc miqt_exec_callback_cQSslSocket_open(vtbl: pointer, self: pointer, mode: cint): bool {.cdecl.} =
  ...
  let virtualReturn = vtbl[].open(self, slotval1)
  virtualReturn
...
proc miqt_exec_callback_cQSslSocket_pos(vtbl: pointer, self: pointer): clonglong {.cdecl.} =
  let vtbl = cast[ptr QSslSocketVTable](vtbl)
  let self = QSslSocket(h: self)
  let virtualReturn = vtbl[].pos(self)
  virtualReturn
...
proc miqt_exec_callback_cQSslSocket_size(vtbl: pointer, self: pointer): clonglong {.cdecl.} =
  let vtbl = cast[ptr QSslSocketVTable](vtbl)
  let self = QSslSocket(h: self)
  let virtualReturn = vtbl[].size(self)
  virtualReturn
...
proc miqt_exec_callback_cQSslSocket_seek(vtbl: pointer, self: pointer, pos: clonglong): bool {.cdecl.} =
  ...
  let self = QSslSocket(h: self)
  let slotval1 = pos
  let virtualReturn = vtbl[].seek(self, slotval1)
  virtualReturn
...
proc miqt_exec_callback_cQSslSocket_reset(vtbl: pointer, self: pointer): bool {.cdecl.} =
  let vtbl = cast[ptr QSslSocketVTable](vtbl)
  let self = QSslSocket(h: self)
  let virtualReturn = vtbl[].reset(self)
  virtualReturn
