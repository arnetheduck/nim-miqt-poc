...
proc trUtf8*(_: type QIdentityProxyModel, s: cstring): string =
...
proc trUtf82*(_: type QIdentityProxyModel, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type QIdentityProxyModel, s: cstring, c: cstring, n: cint): string =
