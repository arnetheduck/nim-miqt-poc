...
func init*(T: type QAbstractState, h: ptr cQAbstractState): QAbstractState =
  T(h: h)
proc metaObject*(self: QAbstractState, ): gen_qobjectdefs.QMetaObject =

  gen_qobjectdefs.QMetaObject(h: fcQAbstractState_metaObject(self.h))

proc metacast*(self: QAbstractState, param1: cstring): pointer =

  fcQAbstractState_metacast(self.h, param1)

proc metacall*(self: QAbstractState, param1: gen_qobjectdefs.QMetaObjectCall, param2: cint, param3: pointer): cint =

  fcQAbstractState_metacall(self.h, cint(param1), param2, param3)

proc tr*(_: type QAbstractState, s: cstring): string =
...
proc trUtf8*(_: type QAbstractState, s: cstring): string =
...
proc parentState*(self: QAbstractState, ): gen_qstate.QState =

  gen_qstate.QState(h: fcQAbstractState_parentState(self.h))

proc machine*(self: QAbstractState, ): gen_qstatemachine.QStateMachine =

  gen_qstatemachine.QStateMachine(h: fcQAbstractState_machine(self.h))

proc active*(self: QAbstractState, ): bool =

  fcQAbstractState_active(self.h)

proc activeChanged*(self: QAbstractState, active: bool): void =
...
proc onactiveChanged*(self: QAbstractState, slot: proc(active: bool)) =
  type Cb = proc(active: bool)
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
  fQAbstractState_connect_activeChanged(self.h, cast[int](addr tmp[]))
proc tr2*(_: type QAbstractState, s: cstring, c: cstring): string =
...
proc tr3*(_: type QAbstractState, s: cstring, c: cstring, n: cint): string =
...
proc trUtf82*(_: type QAbstractState, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type QAbstractState, s: cstring, c: cstring, n: cint): string =
