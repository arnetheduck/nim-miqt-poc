...
template QFont2*(_: type QMetaTypeTypeEnum): untyped = 64
template QPixmap2*(_: type QMetaTypeTypeEnum): untyped = 65
template QBrush2*(_: type QMetaTypeTypeEnum): untyped = 66
template QColor2*(_: type QMetaTypeTypeEnum): untyped = 67
template QPalette2*(_: type QMetaTypeTypeEnum): untyped = 68
template QIcon2*(_: type QMetaTypeTypeEnum): untyped = 69
template QImage2*(_: type QMetaTypeTypeEnum): untyped = 70
template QPolygon2*(_: type QMetaTypeTypeEnum): untyped = 71
template QRegion2*(_: type QMetaTypeTypeEnum): untyped = 72
template QBitmap2*(_: type QMetaTypeTypeEnum): untyped = 73
template QCursor2*(_: type QMetaTypeTypeEnum): untyped = 74
template QKeySequence2*(_: type QMetaTypeTypeEnum): untyped = 75
template QPen2*(_: type QMetaTypeTypeEnum): untyped = 76
template QTextLength2*(_: type QMetaTypeTypeEnum): untyped = 77
template QTextFormat2*(_: type QMetaTypeTypeEnum): untyped = 78
template QMatrix2*(_: type QMetaTypeTypeEnum): untyped = 79
template QTransform2*(_: type QMetaTypeTypeEnum): untyped = 80
template QMatrix4x42*(_: type QMetaTypeTypeEnum): untyped = 81
template QVector2D2*(_: type QMetaTypeTypeEnum): untyped = 82
template QVector3D2*(_: type QMetaTypeTypeEnum): untyped = 83
template QVector4D2*(_: type QMetaTypeTypeEnum): untyped = 84
template QQuaternion2*(_: type QMetaTypeTypeEnum): untyped = 85
template QPolygonF2*(_: type QMetaTypeTypeEnum): untyped = 86
template QColorSpace2*(_: type QMetaTypeTypeEnum): untyped = 87
template QSizePolicy2*(_: type QMetaTypeTypeEnum): untyped = 121
...
proc save*(_: type gen_qmetatype_types.QMetaType, stream: gen_qdatastream.QDataStream, typeVal: cint, data: pointer): bool =

  fcQMetaType_save(stream.h, typeVal, data)

proc load*(_: type gen_qmetatype_types.QMetaType, stream: gen_qdatastream.QDataStream, typeVal: cint, data: pointer): bool =
...
proc sizeOf2*(self: gen_qmetatype_types.QMetaType, ): cint =
...
proc debugStream*(_: type gen_qmetatype_types.QMetaType, dbg: gen_qdebug.QDebug, rhs: pointer, typeId: cint): bool =
