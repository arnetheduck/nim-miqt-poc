...
proc trUtf8*(_: type QTemporaryFile, s: cstring): string =
...
proc createLocalFile*(_: type QTemporaryFile, fileName: string): QTemporaryFile =

  QTemporaryFile(h: fcQTemporaryFile_createLocalFile(struct_miqt_string(data: fileName, len: csize_t(len(fileName)))))

proc createLocalFileWithFile*(_: type QTemporaryFile, file: gen_qfile.QFile): QTemporaryFile =
...
proc trUtf82*(_: type QTemporaryFile, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type QTemporaryFile, s: cstring, c: cstring, n: cint): string =
...
proc callVirtualBase_openWithFlags(self: QTemporaryFile, flags: gen_qiodevice.QIODeviceOpenModeFlag): bool =


  fQTemporaryFile_virtualbase_openWithFlags(self.h, cint(flags))

type QTemporaryFileopenWithFlagsBase* = proc(flags: gen_qiodevice.QIODeviceOpenModeFlag): bool
proc onopenWithFlags*(self: QTemporaryFile, slot: proc(super: QTemporaryFileopenWithFlagsBase, flags: gen_qiodevice.QIODeviceOpenModeFlag): bool) =
  # TODO check subclass
  type Cb = proc(super: QTemporaryFileopenWithFlagsBase, flags: gen_qiodevice.QIODeviceOpenModeFlag): bool
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QTemporaryFile_openWithFlags(self: ptr cQTemporaryFile, slot: int, flags: cint): bool {.exportc: "miqt_exec_callback_QTemporaryFile_openWithFlags ".} =
  type Cb = proc(super: QTemporaryFileopenWithFlagsBase, flags: gen_qiodevice.QIODeviceOpenModeFlag): bool
  var nimfunc = cast[ptr Cb](cast[pointer](slot))
  proc superCall(flags: gen_qiodevice.QIODeviceOpenModeFlag): auto =
    callVirtualBase_openWithFlags(QTemporaryFile(h: self), flags)
  let slotval1 = gen_qiodevice.QIODeviceOpenModeFlag(flags)
