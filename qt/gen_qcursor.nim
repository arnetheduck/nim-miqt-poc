...
proc create*(T: type gen_qcursor_types.QCursor, cursor: gen_qcursor_types.QCursor): gen_qcursor_types.QCursor =
...
proc bitmap*(self: gen_qcursor_types.QCursor, param1: cint): gen_qbitmap.QBitmap =
  gen_qbitmap.QBitmap(h: fcQCursor_bitmapWithQtReturnByValueConstant(self.h, cint(param1)))

proc mask*(self: gen_qcursor_types.QCursor, param1: cint): gen_qbitmap.QBitmap =
...
proc pos*(_: type gen_qcursor_types.QCursor, screen: gen_qscreen.QScreen): gen_qpoint.QPoint =
...
proc setPos*(_: type gen_qcursor_types.QCursor, screen: gen_qscreen.QScreen, x: cint, y: cint): void =
  fcQCursor_setPos2(screen.h, x, y)

proc setPos*(_: type gen_qcursor_types.QCursor, p: gen_qpoint.QPoint): void =
  fcQCursor_setPosWithQPoint(p.h)

proc setPos*(_: type gen_qcursor_types.QCursor, screen: gen_qscreen.QScreen, p: gen_qpoint.QPoint): void =
