...
return  _ret
			...
			func (this *QQmlIncubator) Object() *qt.QObject {
				return qt.UnsafeNewQObject(unsafe.Pointer(C.QQmlIncubator_object(this.h)))
}
			
			func (this *QQmlIncubator) SetInitialProperties(initialProperties map[string]qt.QVariant)  {
...
gofunc((&QQmlIncubator{h: self}).callVirtualBase_StatusChanged, slotval1 )
				...
				func (this *QQmlIncubator) callVirtualBase_SetInitialState(initialState *qt.QObject)  {
					
					 C.QQmlIncubator_virtualbase_setInitialState(unsafe.Pointer(this.h), (*C.QObject)(initialState.UnsafePointer()))

				}
			func (this *QQmlIncubator) OnSetInitialState(slot func(super func(initialState *qt.QObject) , initialState *qt.QObject) ) {
				...
				func miqt_exec_callback_QQmlIncubator_setInitialState(self *C.QQmlIncubator, cb C.intptr_t, initialState *C.QObject) {
					gofunc, ok := cgo.Handle(cb).Value().(func(super func(initialState *qt.QObject) , initialState *qt.QObject) )
					if !ok {
						panic("miqt: callback of non-callback type (heap corruption?)")
					}

			// Convert all CABI parameters to Go parameters
slotval1 := qt.UnsafeNewQObject(unsafe.Pointer(initialState))
...
gofunc((&QQmlIncubator{h: self}).callVirtualBase_SetInitialState, slotval1 )
		...
		func (this *QQmlIncubationController) UnsafePointer() unsafe.Pointer {
			...
			func (this *QQmlIncubationController) IncubateWhile(flag *volatile bool)  {
				 C.QQmlIncubationController_incubateWhile(this.h, flag)
}
			
			func (this *QQmlIncubationController) IncubateWhile2(flag *volatile bool, msecs int)  {
				 C.QQmlIncubationController_incubateWhile2(this.h, flag, (C.int)(msecs))
}
