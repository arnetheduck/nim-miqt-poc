...
func newQQmlInfo(h *C.QQmlInfo) *QQmlInfo {
	...
	return &QQmlInfo{h: h,
		QDebug: qt.UnsafeNewQDebug(unsafe.Pointer(outptr_QDebug))}
}
...
func (this *QQmlInfo) OperatorShiftLeft(t qt.QChar) *QQmlInfo {
...
func (this *QQmlInfo) OperatorShiftLeftWithQUrl(t *qt.QUrl) *QQmlInfo {
