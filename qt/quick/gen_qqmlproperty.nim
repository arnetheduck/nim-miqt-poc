...
proc create*(T: type gen_qqmlproperty_types.QQmlProperty, param1: gen_qobject.QObject, param2: gen_qqmlengine.QQmlEngine): gen_qqmlproperty_types.QQmlProperty =
...
proc create*(T: type gen_qqmlproperty_types.QQmlProperty, param1: gen_qobject.QObject, param2: string, param3: gen_qqmlengine.QQmlEngine): gen_qqmlproperty_types.QQmlProperty =
...
proc read*(_: type gen_qqmlproperty_types.QQmlProperty, param1: gen_qobject.QObject, param2: string): gen_qvariant.QVariant =
  gen_qvariant.QVariant(h: fcQQmlProperty_read2(param1.h, struct_miqt_string(data: param2, len: csize_t(len(param2)))))

proc read*(_: type gen_qqmlproperty_types.QQmlProperty, param1: gen_qobject.QObject, param2: string, param3: gen_qqmlcontext.QQmlContext): gen_qvariant.QVariant =
  gen_qvariant.QVariant(h: fcQQmlProperty_read3(param1.h, struct_miqt_string(data: param2, len: csize_t(len(param2))), param3.h))

proc read*(_: type gen_qqmlproperty_types.QQmlProperty, param1: gen_qobject.QObject, param2: string, param3: gen_qqmlengine.QQmlEngine): gen_qvariant.QVariant =
...
proc write*(_: type gen_qqmlproperty_types.QQmlProperty, param1: gen_qobject.QObject, param2: string, param3: gen_qvariant.QVariant): bool =
  fcQQmlProperty_write2(param1.h, struct_miqt_string(data: param2, len: csize_t(len(param2))), param3.h)

proc write*(_: type gen_qqmlproperty_types.QQmlProperty, param1: gen_qobject.QObject, param2: string, param3: gen_qvariant.QVariant, param4: gen_qqmlcontext.QQmlContext): bool =
  fcQQmlProperty_write3(param1.h, struct_miqt_string(data: param2, len: csize_t(len(param2))), param3.h, param4.h)

proc write*(_: type gen_qqmlproperty_types.QQmlProperty, param1: gen_qobject.QObject, param2: string, param3: gen_qvariant.QVariant, param4: gen_qqmlengine.QQmlEngine): bool =
...
proc connectNotifySignal*(self: gen_qqmlproperty_types.QQmlProperty, dest: gen_qobject.QObject, methodVal: cint): bool =
