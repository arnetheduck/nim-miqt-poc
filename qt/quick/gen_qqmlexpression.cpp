...
public:
	...
	QMetaObject* virtualbase_metaObject() const {
		...
		return (QMetaObject*) QQmlExpression::metaObject();
	...
	int virtualbase_metacall(int param1, int param2, void** param3) {
		...
		return QQmlExpression::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
QMetaObject* QQmlExpression_virtualbase_metaObject(const void* self) {
	return ( (const MiqtVirtualQQmlExpression*)(self) )->virtualbase_metaObject();
}

void* QQmlExpression_virtualbase_metacast(void* self, const char* param1) {
	return ( (MiqtVirtualQQmlExpression*)(self) )->virtualbase_metacast(param1);
}

int QQmlExpression_virtualbase_metacall(void* self, int param1, int param2, void** param3) {
	return ( (MiqtVirtualQQmlExpression*)(self) )->virtualbase_metacall(param1, param2, param3);
}

bool QQmlExpression_virtualbase_event(void* self, QEvent* event) {
	return ( (MiqtVirtualQQmlExpression*)(self) )->virtualbase_event(event);
}

bool QQmlExpression_virtualbase_eventFilter(void* self, QObject* watched, QEvent* event) {
	return ( (MiqtVirtualQQmlExpression*)(self) )->virtualbase_eventFilter(watched, event);
}

void QQmlExpression_virtualbase_timerEvent(void* self, QTimerEvent* event) {
	( (MiqtVirtualQQmlExpression*)(self) )->virtualbase_timerEvent(event);
}

void QQmlExpression_virtualbase_childEvent(void* self, QChildEvent* event) {
	( (MiqtVirtualQQmlExpression*)(self) )->virtualbase_childEvent(event);
}

void QQmlExpression_virtualbase_customEvent(void* self, QEvent* event) {
	( (MiqtVirtualQQmlExpression*)(self) )->virtualbase_customEvent(event);
}

void QQmlExpression_virtualbase_connectNotify(void* self, QMetaMethod* signal) {
	( (MiqtVirtualQQmlExpression*)(self) )->virtualbase_connectNotify(signal);
}
