...
proc callVirtualBase_metaObject(self: QQuickFramebufferObject, ): gen_qobjectdefs.QMetaObject =


  gen_qobjectdefs.QMetaObject(h: fQQuickFramebufferObject_virtualbase_metaObject(self.h))

type QQuickFramebufferObjectmetaObjectBase* = proc(): gen_qobjectdefs.QMetaObject
proc onmetaObject*(self: QQuickFramebufferObject, slot: proc(super: QQuickFramebufferObjectmetaObjectBase): gen_qobjectdefs.QMetaObject) =
  # TODO check subclass
  type Cb = proc(super: QQuickFramebufferObjectmetaObjectBase): gen_qobjectdefs.QMetaObject
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QQuickFramebufferObject_metaObject(self: ptr cQQuickFramebufferObject, slot: int): pointer {.exportc: "miqt_exec_callback_QQuickFramebufferObject_metaObject ".} =
  ...
  proc superCall(): auto =
    callVirtualBase_metaObject(QQuickFramebufferObject(h: self), )

  let virtualReturn = nimfunc[](superCall )

  virtualReturn.h
proc callVirtualBase_metacast(self: QQuickFramebufferObject, param1: cstring): pointer =


  fQQuickFramebufferObject_virtualbase_metacast(self.h, param1)

type QQuickFramebufferObjectmetacastBase* = proc(param1: cstring): pointer
proc onmetacast*(self: QQuickFramebufferObject, slot: proc(super: QQuickFramebufferObjectmetacastBase, param1: cstring): pointer) =
  # TODO check subclass
  type Cb = proc(super: QQuickFramebufferObjectmetacastBase, param1: cstring): pointer
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QQuickFramebufferObject_metacast(self: ptr cQQuickFramebufferObject, slot: int, param1: cstring): pointer {.exportc: "miqt_exec_callback_QQuickFramebufferObject_metacast ".} =
  ...
  proc superCall(param1: cstring): auto =
    callVirtualBase_metacast(QQuickFramebufferObject(h: self), param1)
  let slotval1 = (param1)
...
proc miqt_exec_callback_QQuickFramebufferObject_disconnectNotify(self: ptr cQQuickFramebufferObject, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QQuickFramebufferObject_disconnectNotify ".} =
  ...
  nimfunc[](superCall, slotval1)
proc staticMetaObject*(_: type QQuickFramebufferObject): gen_qobjectdefs.QMetaObject =
