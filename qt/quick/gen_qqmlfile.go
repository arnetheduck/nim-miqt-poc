...
func NewQQmlFile2(param1 *QQmlEngine, param2 *qt.QUrl) *QQmlFile {
...
func (this *QQmlFile) Url() *qt.QUrl {
	_goptr := qt.UnsafeNewQUrl(unsafe.Pointer(C.QQmlFile_url(this.h)))
...
func (this *QQmlFile) Load(param1 *QQmlEngine, param2 *qt.QUrl) {
...
func (this *QQmlFile) ClearWithQObject(param1 *qt.QObject) {
	C.QQmlFile_clearWithQObject(this.h, (*C.QObject)(param1.UnsafePointer()))
}

func (this *QQmlFile) ConnectFinished(param1 *qt.QObject, param2 string) bool {
...
func (this *QQmlFile) ConnectFinished2(param1 *qt.QObject, param2 int) bool {
	return (bool)(C.QQmlFile_connectFinished2(this.h, (*C.QObject)(param1.UnsafePointer()), (C.int)(param2)))
}

func (this *QQmlFile) ConnectDownloadProgress(param1 *qt.QObject, param2 string) bool {
	param2_Cstring := C.CString(param2)
	defer C.free(unsafe.Pointer(param2_Cstring))
	return (bool)(C.QQmlFile_connectDownloadProgress(this.h, (*C.QObject)(param1.UnsafePointer()), param2_Cstring))
}

func (this *QQmlFile) ConnectDownloadProgress2(param1 *qt.QObject, param2 int) bool {
...
func QQmlFile_IsSynchronousWithUrl(url *qt.QUrl) bool {
...
func QQmlFile_IsLocalFileWithUrl(url *qt.QUrl) bool {
...
func QQmlFile_UrlToLocalFileOrQrcWithQUrl(param1 *qt.QUrl) string {
