...
proc setDeviceRect*(self: gen_qsgabstractrenderer_types.QSGAbstractRenderer, size: gen_qsize.QSize): void =
...
proc setViewportRect*(self: gen_qsgabstractrenderer_types.QSGAbstractRenderer, size: gen_qsize.QSize): void =
...
proc setProjectionMatrixToRect*(self: gen_qsgabstractrenderer_types.QSGAbstractRenderer, rect: gen_qrect.QRectF, flags: cint): void =
