...
func (this *QQuickPaintedItem) callVirtualBase_MetaObject() *qt.QMetaObject {

	return qt.UnsafeNewQMetaObject(unsafe.Pointer(C.QQuickPaintedItem_virtualbase_metaObject(unsafe.Pointer(this.h))))

}
func (this *QQuickPaintedItem) OnMetaObject(slot func(super func() *qt.QMetaObject) *qt.QMetaObject) {
	ok := C.QQuickPaintedItem_override_virtual_metaObject(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}

//export miqt_exec_callback_QQuickPaintedItem_metaObject
func miqt_exec_callback_QQuickPaintedItem_metaObject(self *C.QQuickPaintedItem, cb C.intptr_t) *C.QMetaObject {
	gofunc, ok := cgo.Handle(cb).Value().(func(super func() *qt.QMetaObject) *qt.QMetaObject)
	if !ok {
		panic("miqt: callback of non-callback type (heap corruption?)")
	}

	virtualReturn := gofunc((&QQuickPaintedItem{h: self}).callVirtualBase_MetaObject)

	return (*C.QMetaObject)(virtualReturn.UnsafePointer())

}

func (this *QQuickPaintedItem) callVirtualBase_Metacast(param1 string) unsafe.Pointer {
	param1_Cstring := C.CString(param1)
	defer C.free(unsafe.Pointer(param1_Cstring))

	return (unsafe.Pointer)(C.QQuickPaintedItem_virtualbase_metacast(unsafe.Pointer(this.h), param1_Cstring))

}
func (this *QQuickPaintedItem) OnMetacast(slot func(super func(param1 string) unsafe.Pointer, param1 string) unsafe.Pointer) {
	ok := C.QQuickPaintedItem_override_virtual_metacast(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}

//export miqt_exec_callback_QQuickPaintedItem_metacast
func miqt_exec_callback_QQuickPaintedItem_metacast(self *C.QQuickPaintedItem, cb C.intptr_t, param1 *C.const_char) unsafe.Pointer {
	...
	virtualReturn := gofunc((&QQuickPaintedItem{h: self}).callVirtualBase_Metacast, slotval1)
