...
func init*(T: type QSGNinePatchNode, h: ptr cQSGNinePatchNode): QSGNinePatchNode =
  T(h: h)
proc setTexture*(self: QSGNinePatchNode, texture: gen_qsgtexture.QSGTexture): void =

  fcQSGNinePatchNode_setTexture(self.h, texture.h)

proc setBounds*(self: QSGNinePatchNode, bounds: gen_qrect.QRectF): void =

  fcQSGNinePatchNode_setBounds(self.h, bounds.h)

proc setDevicePixelRatio*(self: QSGNinePatchNode, ratio: float64): void =

  fcQSGNinePatchNode_setDevicePixelRatio(self.h, ratio)

proc setPadding*(self: QSGNinePatchNode, left: float64, top: float64, right: float64, bottom: float64): void =

  fcQSGNinePatchNode_setPadding(self.h, left, top, right, bottom)

proc update*(self: QSGNinePatchNode, ): void =

  fcQSGNinePatchNode_update(self.h)

proc rebuildGeometry*(_: type QSGNinePatchNode, texture: gen_qsgtexture.QSGTexture, geometry: gen_qsggeometry.QSGGeometry, padding: gen_qvector4d.QVector4D, bounds: gen_qrect.QRectF, dpr: float64): void =

  fcQSGNinePatchNode_rebuildGeometry(texture.h, geometry.h, padding.h, bounds.h, dpr)

proc delete*(self: QSGNinePatchNode) =
