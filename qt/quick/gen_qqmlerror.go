...
func (this *QQmlError) Url() *qt.QUrl {
	_goptr := qt.UnsafeNewQUrl(unsafe.Pointer(C.QQmlError_url(this.h)))
	_goptr.GoGC() // Qt uses pass-by-value semantics for this type. Mimic with finalizer
	return _goptr
}

func (this *QQmlError) SetUrl(url *qt.QUrl) {
...
func (this *QQmlError) Object() *qt.QObject {
	return qt.UnsafeNewQObject(unsafe.Pointer(C.QQmlError_object(this.h)))
}

func (this *QQmlError) SetObject(object *qt.QObject) {
