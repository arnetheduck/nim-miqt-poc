...
func (this *QJSValue) ToVariant() *qt.QVariant {
	_goptr := qt.UnsafeNewQVariant(unsafe.Pointer(C.QJSValue_toVariant(this.h)))
	_goptr.GoGC() // Qt uses pass-by-value semantics for this type. Mimic with finalizer
	return _goptr
}

func (this *QJSValue) ToQObject() *qt.QObject {
	return qt.UnsafeNewQObject(unsafe.Pointer(C.QJSValue_toQObject(this.h)))
}

func (this *QJSValue) ToQMetaObject() *qt.QMetaObject {
	return qt.UnsafeNewQMetaObject(unsafe.Pointer(C.QJSValue_toQMetaObject(this.h)))
}

func (this *QJSValue) ToDateTime() *qt.QDateTime {
	_goptr := qt.UnsafeNewQDateTime(unsafe.Pointer(C.QJSValue_toDateTime(this.h)))
	_goptr.GoGC() // Qt uses pass-by-value semantics for this type. Mimic with finalizer
	return _goptr
}
...
func (this *QJSValue) Engine() *QJSEngine {
	return newQJSEngine(C.QJSValue_engine(this.h))
}
