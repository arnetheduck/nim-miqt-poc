...
QObject* QQmlContext_protectedbase_sender(const void* self) {
	return ( (const MiqtVirtualQQmlContext*)(self) )->protectedbase_sender();
}

int QQmlContext_protectedbase_senderSignalIndex(const void* self) {
	return ( (const MiqtVirtualQQmlContext*)(self) )->protectedbase_senderSignalIndex();
}

int QQmlContext_protectedbase_receivers(const void* self, const char* signal) {
	return ( (const MiqtVirtualQQmlContext*)(self) )->protectedbase_receivers(signal);
}

bool QQmlContext_protectedbase_isSignalConnected(const void* self, QMetaMethod* signal) {
	return ( (const MiqtVirtualQQmlContext*)(self) )->protectedbase_isSignalConnected(signal);
}
