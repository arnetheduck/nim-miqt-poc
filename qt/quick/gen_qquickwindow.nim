...
proc callVirtualBase_metaObject(self: QQuickWindow, ): gen_qobjectdefs.QMetaObject =


  gen_qobjectdefs.QMetaObject(h: fQQuickWindow_virtualbase_metaObject(self.h))

type QQuickWindowmetaObjectBase* = proc(): gen_qobjectdefs.QMetaObject
proc onmetaObject*(self: QQuickWindow, slot: proc(super: QQuickWindowmetaObjectBase): gen_qobjectdefs.QMetaObject) =
  # TODO check subclass
  type Cb = proc(super: QQuickWindowmetaObjectBase): gen_qobjectdefs.QMetaObject
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QQuickWindow_metaObject(self: ptr cQQuickWindow, slot: int): pointer {.exportc: "miqt_exec_callback_QQuickWindow_metaObject ".} =
  ...
  proc superCall(): auto =
    callVirtualBase_metaObject(QQuickWindow(h: self), )

  let virtualReturn = nimfunc[](superCall )

  virtualReturn.h
proc callVirtualBase_metacast(self: QQuickWindow, param1: cstring): pointer =


  fQQuickWindow_virtualbase_metacast(self.h, param1)

type QQuickWindowmetacastBase* = proc(param1: cstring): pointer
proc onmetacast*(self: QQuickWindow, slot: proc(super: QQuickWindowmetacastBase, param1: cstring): pointer) =
  # TODO check subclass
  type Cb = proc(super: QQuickWindowmetacastBase, param1: cstring): pointer
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QQuickWindow_metacast(self: ptr cQQuickWindow, slot: int, param1: cstring): pointer {.exportc: "miqt_exec_callback_QQuickWindow_metacast ".} =
  ...
  proc superCall(param1: cstring): auto =
    callVirtualBase_metacast(QQuickWindow(h: self), param1)
  let slotval1 = (param1)
...
proc miqt_exec_callback_QQuickWindow_disconnectNotify(self: ptr cQQuickWindow, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QQuickWindow_disconnectNotify ".} =
  ...
  nimfunc[](superCall, slotval1)
proc staticMetaObject*(_: type QQuickWindow): gen_qobjectdefs.QMetaObject =
