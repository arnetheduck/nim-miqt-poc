...
QObject* QQmlEngine_protectedbase_sender(const void* self) {
	return ( (const MiqtVirtualQQmlEngine*)(self) )->protectedbase_sender();
}

int QQmlEngine_protectedbase_senderSignalIndex(const void* self) {
	return ( (const MiqtVirtualQQmlEngine*)(self) )->protectedbase_senderSignalIndex();
}

int QQmlEngine_protectedbase_receivers(const void* self, const char* signal) {
	return ( (const MiqtVirtualQQmlEngine*)(self) )->protectedbase_receivers(signal);
}

bool QQmlEngine_protectedbase_isSignalConnected(const void* self, QMetaMethod* signal) {
	return ( (const MiqtVirtualQQmlEngine*)(self) )->protectedbase_isSignalConnected(signal);
}
