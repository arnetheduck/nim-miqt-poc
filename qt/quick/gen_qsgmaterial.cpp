...
class MiqtVirtualQSGMaterial final : public QSGMaterial {
public:

	MiqtVirtualQSGMaterial(): QSGMaterial() {};

	virtual ~MiqtVirtualQSGMaterial() override = default;
...
QSGMaterial* QSGMaterial_new() {
	return new MiqtVirtualQSGMaterial();
}
...
bool QSGMaterial_override_virtual_type(void* self, intptr_t slot) {
	MiqtVirtualQSGMaterial* self_cast = dynamic_cast<MiqtVirtualQSGMaterial*>( (QSGMaterial*)(self) );
...
int QSGMaterial_virtualbase_compare(const void* self, QSGMaterial* other) {
	return ( (const MiqtVirtualQSGMaterial*)(self) )->virtualbase_compare(other);
}
