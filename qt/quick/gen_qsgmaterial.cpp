...
public:
	...
	MiqtVirtualQSGMaterial(struct QSGMaterial_VTable* vtbl): QSGMaterial(), vtbl(vtbl) {};

	virtual ~MiqtVirtualQSGMaterial() override { if(vtbl->destructor) vtbl->destructor(vtbl, this); }
...
QSGMaterial* QSGMaterial_new(struct QSGMaterial_VTable* vtbl) {
	return new MiqtVirtualQSGMaterial(vtbl);
}
