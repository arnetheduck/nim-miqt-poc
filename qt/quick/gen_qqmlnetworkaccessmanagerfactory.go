...
func (this *QQmlNetworkAccessManagerFactory) Create(parent *qt.QObject) *network.QNetworkAccessManager {
	return network.UnsafeNewQNetworkAccessManager(unsafe.Pointer(C.QQmlNetworkAccessManagerFactory_create(this.h, (*C.QObject)(parent.UnsafePointer()))))
}
