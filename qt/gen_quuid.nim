...
proc create2*(T: type gen_quuid_types.QUuid, param1: seq[byte]): gen_quuid_types.QUuid =
...
proc toStringWithMode*(self: gen_quuid_types.QUuid, mode: cint): string =
...
proc toByteArrayWithMode*(self: gen_quuid_types.QUuid, mode: cint): seq[byte] =
