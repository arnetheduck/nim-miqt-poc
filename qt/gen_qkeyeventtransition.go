...
func (this *QKeyEventTransition) Metacall(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {
	return (int)(C.QKeyEventTransition_metacall(this.h, (C.int)(param1), (C.int)(param2), param3))
}
...
func (this *QKeyEventTransition) callVirtualBase_MetaObject() *QMetaObject {
...
//export miqt_exec_callback_QKeyEventTransition_metaObject
func miqt_exec_callback_QKeyEventTransition_metaObject(self *C.QKeyEventTransition, cb C.intptr_t) *C.QMetaObject {
	gofunc, ok := cgo.Handle(cb).Value().(func(super func() *QMetaObject) *QMetaObject)
	if !ok {
		panic("miqt: callback of non-callback type (heap corruption?)")
	}

	virtualReturn := gofunc((&QKeyEventTransition{h: self}).callVirtualBase_MetaObject)

	return virtualReturn.cPointer()

}

func (this *QKeyEventTransition) callVirtualBase_Metacast(param1 string) unsafe.Pointer {
	param1_Cstring := C.CString(param1)
	defer C.free(unsafe.Pointer(param1_Cstring))
...
//export miqt_exec_callback_QKeyEventTransition_metacast
func miqt_exec_callback_QKeyEventTransition_metacast(self *C.QKeyEventTransition, cb C.intptr_t, param1 *C.const_char) unsafe.Pointer {
	...
	virtualReturn := gofunc((&QKeyEventTransition{h: self}).callVirtualBase_Metacast, slotval1)

	return virtualReturn

}

func (this *QKeyEventTransition) callVirtualBase_Metacall(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {

	return (int)(C.QKeyEventTransition_virtualbase_metacall(unsafe.Pointer(this.h), (C.int)(param1), (C.int)(param2), param3))

}
func (this *QKeyEventTransition) OnMetacall(slot func(super func(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int, param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int) {
	ok := C.QKeyEventTransition_override_virtual_metacall(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}

//export miqt_exec_callback_QKeyEventTransition_metacall
func miqt_exec_callback_QKeyEventTransition_metacall(self *C.QKeyEventTransition, cb C.intptr_t, param1 C.int, param2 C.int, param3 unsafe.Pointer) C.int {
	...
	virtualReturn := gofunc((&QKeyEventTransition{h: self}).callVirtualBase_Metacall, slotval1, slotval2, slotval3)
