...
public:
	...
	QObject* protectedbase_sender() const {
		...
		return QScriptExtensionPlugin::sender();
	...
	int protectedbase_senderSignalIndex() const {
		...
		return QScriptExtensionPlugin::senderSignalIndex();
	...
	int protectedbase_receivers(const char* signal) const {
		...
		return QScriptExtensionPlugin::receivers(signal);
	...
	bool protectedbase_isSignalConnected(QMetaMethod* signal) const {
		...
		return QScriptExtensionPlugin::isSignalConnected(*signal);
...
QObject* QScriptExtensionPlugin_protectedbase_sender(const void* self) {
	return ( (const MiqtVirtualQScriptExtensionPlugin*)(self) )->protectedbase_sender();
}

int QScriptExtensionPlugin_protectedbase_senderSignalIndex(const void* self) {
	return ( (const MiqtVirtualQScriptExtensionPlugin*)(self) )->protectedbase_senderSignalIndex();
}

int QScriptExtensionPlugin_protectedbase_receivers(const void* self, const char* signal) {
	return ( (const MiqtVirtualQScriptExtensionPlugin*)(self) )->protectedbase_receivers(signal);
}

bool QScriptExtensionPlugin_protectedbase_isSignalConnected(const void* self, QMetaMethod* signal) {
	return ( (const MiqtVirtualQScriptExtensionPlugin*)(self) )->protectedbase_isSignalConnected(signal);
}
