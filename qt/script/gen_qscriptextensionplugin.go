...
func (this *QScriptExtensionPlugin) Metacall(param1 qt.QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {
	return (int)(C.QScriptExtensionPlugin_metacall(this.h, (C.int)(param1), (C.int)(param2), param3))
}
...
func (this *QScriptExtensionPlugin) callVirtualBase_MetaObject() *qt.QMetaObject {

	return qt.UnsafeNewQMetaObject(unsafe.Pointer(C.QScriptExtensionPlugin_virtualbase_metaObject(unsafe.Pointer(this.h))))

}
func (this *QScriptExtensionPlugin) OnmetaObject(slot func(super func() *qt.QMetaObject) *qt.QMetaObject) {
	ok := C.QScriptExtensionPlugin_override_virtual_metaObject(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}

//export miqt_exec_callback_QScriptExtensionPlugin_metaObject
func miqt_exec_callback_QScriptExtensionPlugin_metaObject(self *C.QScriptExtensionPlugin, cb C.intptr_t) *C.QMetaObject {
	gofunc, ok := cgo.Handle(cb).Value().(func(super func() *qt.QMetaObject) *qt.QMetaObject)
	if !ok {
		panic("miqt: callback of non-callback type (heap corruption?)")
	}

	virtualReturn := gofunc((&QScriptExtensionPlugin{h: self}).callVirtualBase_MetaObject)

	return (*C.QMetaObject)(virtualReturn.UnsafePointer())

}

func (this *QScriptExtensionPlugin) callVirtualBase_Metacast(param1 string) unsafe.Pointer {
	param1_Cstring := C.CString(param1)
	defer C.free(unsafe.Pointer(param1_Cstring))

	return (unsafe.Pointer)(C.QScriptExtensionPlugin_virtualbase_metacast(unsafe.Pointer(this.h), param1_Cstring))

}
func (this *QScriptExtensionPlugin) Onmetacast(slot func(super func(param1 string) unsafe.Pointer, param1 string) unsafe.Pointer) {
	ok := C.QScriptExtensionPlugin_override_virtual_metacast(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}

//export miqt_exec_callback_QScriptExtensionPlugin_metacast
func miqt_exec_callback_QScriptExtensionPlugin_metacast(self *C.QScriptExtensionPlugin, cb C.intptr_t, param1 *C.const_char) unsafe.Pointer {
	...
	virtualReturn := gofunc((&QScriptExtensionPlugin{h: self}).callVirtualBase_Metacast, slotval1)

	return virtualReturn

}

func (this *QScriptExtensionPlugin) callVirtualBase_Metacall(param1 qt.QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {

	return (int)(C.QScriptExtensionPlugin_virtualbase_metacall(unsafe.Pointer(this.h), (C.int)(param1), (C.int)(param2), param3))

}
func (this *QScriptExtensionPlugin) OnMetacall(slot func(super func(param1 qt.QMetaObject__Call, param2 int, param3 unsafe.Pointer) int, param1 qt.QMetaObject__Call, param2 int, param3 unsafe.Pointer) int) {
	ok := C.QScriptExtensionPlugin_override_virtual_metacall(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}

//export miqt_exec_callback_QScriptExtensionPlugin_metacall
func miqt_exec_callback_QScriptExtensionPlugin_metacall(self *C.QScriptExtensionPlugin, cb C.intptr_t, param1 C.int, param2 C.int, param3 unsafe.Pointer) C.int {
	...
	virtualReturn := gofunc((&QScriptExtensionPlugin{h: self}).callVirtualBase_Metacall, slotval1, slotval2, slotval3)
