...
proc load*(self: gen_qwebframe_types.QWebFrame, request: gen_qnetworkrequest.QNetworkRequest): void =
...
proc render*(self: gen_qwebframe_types.QWebFrame, param1: gen_qpainter.QPainter, layer: cint): void =
...
type QWebFrameurlChangedSlot* = proc(url: gen_qurl.QUrl)
...
type QWebFramecontentsSizeChangedSlot* = proc(size: gen_qsize.QSize)
...
proc load*(self: gen_qwebframe_types.QWebFrame, request: gen_qnetworkrequest.QNetworkRequest, operation: cint): void =
  fcQWebFrame_load2(self.h, request.h, cint(operation))

proc load*(self: gen_qwebframe_types.QWebFrame, request: gen_qnetworkrequest.QNetworkRequest, operation: cint, body: seq[byte]): void =
...
proc setHtml*(self: gen_qwebframe_types.QWebFrame, html: string, baseUrl: gen_qurl.QUrl): void =
...
proc setContent*(self: gen_qwebframe_types.QWebFrame, data: seq[byte], mimeType: string, baseUrl: gen_qurl.QUrl): void =
...
proc addToJavaScriptWindowObject*(self: gen_qwebframe_types.QWebFrame, name: string, objectVal: gen_qobject.QObject, ownership: cint): void =
...
proc render*(self: gen_qwebframe_types.QWebFrame, param1: gen_qpainter.QPainter, clip: gen_qregion.QRegion): void =
  fcQWebFrame_render22(self.h, param1.h, clip.h)

proc render*(self: gen_qwebframe_types.QWebFrame, param1: gen_qpainter.QPainter, layer: cint, clip: gen_qregion.QRegion): void =
