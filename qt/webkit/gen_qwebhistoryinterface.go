...
func (this *QWebHistoryInterface) Metacall(param1 qt.QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {
	return (int)(C.QWebHistoryInterface_metacall(this.h, (C.int)(param1), (C.int)(param2), param3))
}
...
func (this *QWebHistoryInterface) callVirtualBase_MetaObject() *qt.QMetaObject {

	return qt.UnsafeNewQMetaObject(unsafe.Pointer(C.QWebHistoryInterface_virtualbase_metaObject(unsafe.Pointer(this.h))))

}
func (this *QWebHistoryInterface) OnMetaObject(slot func(super func() *qt.QMetaObject) *qt.QMetaObject) {
	ok := C.QWebHistoryInterface_override_virtual_metaObject(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}

//export miqt_exec_callback_QWebHistoryInterface_metaObject
func miqt_exec_callback_QWebHistoryInterface_metaObject(self *C.QWebHistoryInterface, cb C.intptr_t) *C.QMetaObject {
	gofunc, ok := cgo.Handle(cb).Value().(func(super func() *qt.QMetaObject) *qt.QMetaObject)
	if !ok {
		panic("miqt: callback of non-callback type (heap corruption?)")
	}

	virtualReturn := gofunc((&QWebHistoryInterface{h: self}).callVirtualBase_MetaObject)

	return (*C.QMetaObject)(virtualReturn.UnsafePointer())

}

func (this *QWebHistoryInterface) callVirtualBase_Metacast(param1 string) unsafe.Pointer {
	param1_Cstring := C.CString(param1)
	defer C.free(unsafe.Pointer(param1_Cstring))

	return (unsafe.Pointer)(C.QWebHistoryInterface_virtualbase_metacast(unsafe.Pointer(this.h), param1_Cstring))

}
func (this *QWebHistoryInterface) OnMetacast(slot func(super func(param1 string) unsafe.Pointer, param1 string) unsafe.Pointer) {
	ok := C.QWebHistoryInterface_override_virtual_metacast(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}

//export miqt_exec_callback_QWebHistoryInterface_metacast
func miqt_exec_callback_QWebHistoryInterface_metacast(self *C.QWebHistoryInterface, cb C.intptr_t, param1 *C.const_char) unsafe.Pointer {
	...
	virtualReturn := gofunc((&QWebHistoryInterface{h: self}).callVirtualBase_Metacast, slotval1)

	return virtualReturn

}

func (this *QWebHistoryInterface) callVirtualBase_Metacall(param1 qt.QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {

	return (int)(C.QWebHistoryInterface_virtualbase_metacall(unsafe.Pointer(this.h), (C.int)(param1), (C.int)(param2), param3))

}
func (this *QWebHistoryInterface) OnMetacall(slot func(super func(param1 qt.QMetaObject__Call, param2 int, param3 unsafe.Pointer) int, param1 qt.QMetaObject__Call, param2 int, param3 unsafe.Pointer) int) {
	ok := C.QWebHistoryInterface_override_virtual_metacall(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}

//export miqt_exec_callback_QWebHistoryInterface_metacall
func miqt_exec_callback_QWebHistoryInterface_metacall(self *C.QWebHistoryInterface, cb C.intptr_t, param1 C.int, param2 C.int, param3 unsafe.Pointer) C.int {
	...
	virtualReturn := gofunc((&QWebHistoryInterface{h: self}).callVirtualBase_Metacall, slotval1, slotval2, slotval3)
