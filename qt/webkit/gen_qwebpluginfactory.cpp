...
public:
	...
	MiqtVirtualQWebPluginFactory(struct QWebPluginFactory_VTable* vtbl): QWebPluginFactory(), vtbl(vtbl) {};
	MiqtVirtualQWebPluginFactory(struct QWebPluginFactory_VTable* vtbl, QObject* parent): QWebPluginFactory(parent), vtbl(vtbl) {};

	virtual ~MiqtVirtualQWebPluginFactory() override { if(vtbl->destructor) vtbl->destructor(vtbl, this); }
	...
	int virtualbase_metacall(int param1, int param2, void** param3) {
		...
		return QWebPluginFactory::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
	...
	QObject* protectedbase_sender() const {
		...
		return QWebPluginFactory::sender();
	...
	int protectedbase_senderSignalIndex() const {
		...
		return QWebPluginFactory::senderSignalIndex();
	...
	int protectedbase_receivers(const char* signal) const {
		...
		return QWebPluginFactory::receivers(signal);
	...
	bool protectedbase_isSignalConnected(QMetaMethod* signal) const {
		...
		return QWebPluginFactory::isSignalConnected(*signal);
...
QWebPluginFactory* QWebPluginFactory_new(struct QWebPluginFactory_VTable* vtbl) {
	return new MiqtVirtualQWebPluginFactory(vtbl);
}

QWebPluginFactory* QWebPluginFactory_new2(struct QWebPluginFactory_VTable* vtbl, QObject* parent) {
	return new MiqtVirtualQWebPluginFactory(vtbl, parent);
}
...
int QWebPluginFactory_virtualbase_metacall(void* self, int param1, int param2, void** param3) {
	return ( (MiqtVirtualQWebPluginFactory*)(self) )->virtualbase_metacall(param1, param2, param3);
}
...
QObject* QWebPluginFactory_protectedbase_sender(const void* self) {
	return ( (const MiqtVirtualQWebPluginFactory*)(self) )->protectedbase_sender();
}

int QWebPluginFactory_protectedbase_senderSignalIndex(const void* self) {
	return ( (const MiqtVirtualQWebPluginFactory*)(self) )->protectedbase_senderSignalIndex();
}

int QWebPluginFactory_protectedbase_receivers(const void* self, const char* signal) {
	return ( (const MiqtVirtualQWebPluginFactory*)(self) )->protectedbase_receivers(signal);
}

bool QWebPluginFactory_protectedbase_isSignalConnected(const void* self, QMetaMethod* signal) {
	return ( (const MiqtVirtualQWebPluginFactory*)(self) )->protectedbase_isSignalConnected(signal);
}
