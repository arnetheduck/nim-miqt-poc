...
proc fcQWebEngineSettings_globalSettings(): pointer {.importc: "QWebEngineSettings_globalSettings".}
proc fcQWebEngineSettings_defaultSettings(): pointer {.importc: "QWebEngineSettings_defaultSettings".}
...
func init*(T: type QWebEngineSettings, h: ptr cQWebEngineSettings): QWebEngineSettings =
  T(h: h)
proc globalSettings*(_: type QWebEngineSettings, ): QWebEngineSettings =

  QWebEngineSettings(h: fcQWebEngineSettings_globalSettings())

proc defaultSettings*(_: type QWebEngineSettings, ): QWebEngineSettings =

  QWebEngineSettings(h: fcQWebEngineSettings_defaultSettings())
