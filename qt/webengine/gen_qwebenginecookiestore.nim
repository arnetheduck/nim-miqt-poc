...
proc trUtf8*(_: type QWebEngineCookieStore, s: cstring): string =
...
proc trUtf82*(_: type QWebEngineCookieStore, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type QWebEngineCookieStore, s: cstring, c: cstring, n: cint): string =
