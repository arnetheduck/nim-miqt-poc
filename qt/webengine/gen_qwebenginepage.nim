...
proc trUtf8*(_: type QWebEnginePage, s: cstring): string =
...
proc setView*(self: QWebEnginePage, view: gen_qwidget.QWidget): void =

  fcQWebEnginePage_setView(self.h, view.h)

proc view*(self: QWebEnginePage, ): gen_qwidget.QWidget =
...
proc findText*(self: QWebEnginePage, subString: string): void =

  fcQWebEnginePage_findText(self.h, struct_miqt_string(data: subString, len: csize_t(len(subString))))

proc createStandardContextMenu*(self: QWebEnginePage, ): gen_qmenu.QMenu =
...
proc runJavaScript*(self: QWebEnginePage, scriptSource: string): void =

  fcQWebEnginePage_runJavaScript(self.h, struct_miqt_string(data: scriptSource, len: csize_t(len(scriptSource))))

proc runJavaScript2*(self: QWebEnginePage, scriptSource: string, worldId: cuint): void =
...
proc setWebChannel*(self: QWebEnginePage, webChannel: gen_qwebchannel.QWebChannel): void =
...
proc contextMenuData*(self: QWebEnginePage, ): gen_qwebenginecontextmenudata.QWebEngineContextMenuData =
...
proc trUtf82*(_: type QWebEnginePage, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type QWebEnginePage, s: cstring, c: cstring, n: cint): string =
...
proc findText2*(self: QWebEnginePage, subString: string, options: QWebEnginePageFindFlag): void =
...
proc save2*(self: QWebEnginePage, filePath: string, format: gen_qwebenginedownloaditem.QWebEngineDownloadItemSavePageFormat): void =
...
proc callVirtualBase_metaObject(self: QWebEnginePage, ): gen_qobjectdefs.QMetaObject =


  gen_qobjectdefs.QMetaObject(h: fQWebEnginePage_virtualbase_metaObject(self.h))

type QWebEnginePagemetaObjectBase* = proc(): gen_qobjectdefs.QMetaObject
proc onmetaObject*(self: QWebEnginePage, slot: proc(super: QWebEnginePagemetaObjectBase): gen_qobjectdefs.QMetaObject) =
  # TODO check subclass
  type Cb = proc(super: QWebEnginePagemetaObjectBase): gen_qobjectdefs.QMetaObject
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QWebEnginePage_metaObject(self: ptr cQWebEnginePage, slot: int): pointer {.exportc: "miqt_exec_callback_QWebEnginePage_metaObject ".} =
  ...
  proc superCall(): auto =
    callVirtualBase_metaObject(QWebEnginePage(h: self), )

  let virtualReturn = nimfunc[](superCall )

  virtualReturn.h
proc callVirtualBase_metacast(self: QWebEnginePage, param1: cstring): pointer =


  fQWebEnginePage_virtualbase_metacast(self.h, param1)

type QWebEnginePagemetacastBase* = proc(param1: cstring): pointer
proc onmetacast*(self: QWebEnginePage, slot: proc(super: QWebEnginePagemetacastBase, param1: cstring): pointer) =
  # TODO check subclass
  type Cb = proc(super: QWebEnginePagemetacastBase, param1: cstring): pointer
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QWebEnginePage_metacast(self: ptr cQWebEnginePage, slot: int, param1: cstring): pointer {.exportc: "miqt_exec_callback_QWebEnginePage_metacast ".} =
  ...
  proc superCall(param1: cstring): auto =
    callVirtualBase_metacast(QWebEnginePage(h: self), param1)
  let slotval1 = (param1)
...
proc callVirtualBase_certificateError(self: QWebEnginePage, certificateError: gen_qwebenginecertificateerror.QWebEngineCertificateError): bool =


  fQWebEnginePage_virtualbase_certificateError(self.h, certificateError.h)

type QWebEnginePagecertificateErrorBase* = proc(certificateError: gen_qwebenginecertificateerror.QWebEngineCertificateError): bool
proc oncertificateError*(self: QWebEnginePage, slot: proc(super: QWebEnginePagecertificateErrorBase, certificateError: gen_qwebenginecertificateerror.QWebEngineCertificateError): bool) =
  # TODO check subclass
  type Cb = proc(super: QWebEnginePagecertificateErrorBase, certificateError: gen_qwebenginecertificateerror.QWebEngineCertificateError): bool
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QWebEnginePage_certificateError(self: ptr cQWebEnginePage, slot: int, certificateError: pointer): bool {.exportc: "miqt_exec_callback_QWebEnginePage_certificateError ".} =
  type Cb = proc(super: QWebEnginePagecertificateErrorBase, certificateError: gen_qwebenginecertificateerror.QWebEngineCertificateError): bool
  var nimfunc = cast[ptr Cb](cast[pointer](slot))
  proc superCall(certificateError: gen_qwebenginecertificateerror.QWebEngineCertificateError): auto =
    callVirtualBase_certificateError(QWebEnginePage(h: self), certificateError)
...
proc miqt_exec_callback_QWebEnginePage_disconnectNotify(self: ptr cQWebEnginePage, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QWebEnginePage_disconnectNotify ".} =
  ...
  nimfunc[](superCall, slotval1)
proc staticMetaObject*(_: type QWebEnginePage): gen_qobjectdefs.QMetaObject =
