...
proc trUtf8*(_: type QWebEngineNotification, s: cstring): string =
...
proc trUtf82*(_: type QWebEngineNotification, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type QWebEngineNotification, s: cstring, c: cstring, n: cint): string =
