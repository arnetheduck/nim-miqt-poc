...
func (this *QColumnView) Metacall(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {
	return (int)(C.QColumnView_metacall(this.h, (C.int)(param1), (C.int)(param2), param3))
}
...
func (this *QColumnView) callVirtualBase_MetaObject() *QMetaObject {
	...
	return newQMetaObject(C.QColumnView_virtualbase_metaObject(unsafe.Pointer(this.h)))

}
func (this *QColumnView) OnMetaObject(slot func(super func() *QMetaObject) *QMetaObject) {
	ok := C.QColumnView_override_virtual_metaObject(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
...
func miqt_exec_callback_QColumnView_metaObject(self *C.QColumnView, cb C.intptr_t) *C.QMetaObject {
...
func (this *QColumnView) callVirtualBase_Metacast(param1 string) unsafe.Pointer {
	...
	return (unsafe.Pointer)(C.QColumnView_virtualbase_metacast(unsafe.Pointer(this.h), param1_Cstring))

}
func (this *QColumnView) OnMetacast(slot func(super func(param1 string) unsafe.Pointer, param1 string) unsafe.Pointer) {
	ok := C.QColumnView_override_virtual_metacast(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func miqt_exec_callback_QColumnView_metacast(self *C.QColumnView, cb C.intptr_t, param1 *C.const_char) unsafe.Pointer {
...
func (this *QColumnView) callVirtualBase_Metacall(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {

	return (int)(C.QColumnView_virtualbase_metacall(unsafe.Pointer(this.h), (C.int)(param1), (C.int)(param2), param3))

}
func (this *QColumnView) OnMetacall(slot func(super func(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int, param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int) {
	ok := C.QColumnView_override_virtual_metacall(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}

//export miqt_exec_callback_QColumnView_metacall
func miqt_exec_callback_QColumnView_metacall(self *C.QColumnView, cb C.intptr_t, param1 C.int, param2 C.int, param3 unsafe.Pointer) C.int {
	...
	virtualReturn := gofunc((&QColumnView{h: self}).callVirtualBase_Metacall, slotval1, slotval2, slotval3)
