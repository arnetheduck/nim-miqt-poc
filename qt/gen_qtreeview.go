...
func miqt_exec_callback_QTreeView_metaObject(self *C.QTreeView, cb C.intptr_t) *C.QMetaObject {
...
func miqt_exec_callback_QTreeView_metacast(self *C.QTreeView, cb C.intptr_t, param1 *C.const_char) unsafe.Pointer {
