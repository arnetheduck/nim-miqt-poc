...
func (this *QSvgWidget) Metacall(param1 qt.QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {
...
func (this *QSvgWidget) callVirtualBase_MetaObject() *qt.QMetaObject {
	...
	return qt.UnsafeNewQMetaObject(unsafe.Pointer(C.QSvgWidget_virtualbase_metaObject(unsafe.Pointer(this.h))))
...
func (this *QSvgWidget) callVirtualBase_Metacall(param1 qt.QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {

	return (int)(C.QSvgWidget_virtualbase_metacall(unsafe.Pointer(this.h), (C.int)(param1), (C.int)(param2), param3))

}
func (this *QSvgWidget) OnMetacall(slot func(super func(param1 qt.QMetaObject__Call, param2 int, param3 unsafe.Pointer) int, param1 qt.QMetaObject__Call, param2 int, param3 unsafe.Pointer) int) {
