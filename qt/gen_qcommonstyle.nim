...
type cQCommonStyleVTable = object
  ...
  polish*: proc(vtbl, self: pointer, app: pointer): void {.cdecl, raises: [], gcsafe.}
...
type QCommonStylepolishProc* = proc(self: QCommonStyle, app: gen_qapplication_types.QApplication): void {.raises: [], gcsafe.}
type QCommonStylepolishProc* = proc(self: QCommonStyle, widget: gen_qwidget_types.QWidget): void {.raises: [], gcsafe.}
type QCommonStyleunpolishProc* = proc(self: QCommonStyle, widget: gen_qwidget_types.QWidget): void {.raises: [], gcsafe.}
type QCommonStyleunpolishProc* = proc(self: QCommonStyle, application: gen_qapplication_types.QApplication): void {.raises: [], gcsafe.}
...
proc create*(T: type gen_qcommonstyle_types.QCommonStyle,
  ...
  if not isNil(vtbl.polish):
    vtbl[].vtbl.polish = miqt_exec_callback_cQCommonStyle_polishWithApp
  if not isNil(vtbl.polish):
    vtbl[].vtbl.polish = miqt_exec_callback_cQCommonStyle_polishWithWidget
  if not isNil(vtbl.unpolish):
    vtbl[].vtbl.unpolish = miqt_exec_callback_cQCommonStyle_unpolish
  if not isNil(vtbl.unpolish):
    vtbl[].vtbl.unpolish = miqt_exec_callback_cQCommonStyle_unpolishWithApplication
