...
proc trUtf82*(_: type gen_qcommonstyle_types.QCommonStyle, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type gen_qcommonstyle_types.QCommonStyle, s: cstring, c: cstring, n: cint): string =
