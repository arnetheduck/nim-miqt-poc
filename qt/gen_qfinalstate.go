...
func (this *QFinalState) callVirtualBase_MetaObject() *QMetaObject {

	return newQMetaObject(C.QFinalState_virtualbase_metaObject(unsafe.Pointer(this.h)))

}
func (this *QFinalState) OnmetaObject(slot func(super func() *QMetaObject) *QMetaObject) {
	ok := C.QFinalState_override_virtual_metaObject(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}

//export miqt_exec_callback_QFinalState_metaObject
func miqt_exec_callback_QFinalState_metaObject(self *C.QFinalState, cb C.intptr_t) *C.QMetaObject {
	gofunc, ok := cgo.Handle(cb).Value().(func(super func() *QMetaObject) *QMetaObject)
	if !ok {
		panic("miqt: callback of non-callback type (heap corruption?)")
	}

	virtualReturn := gofunc((&QFinalState{h: self}).callVirtualBase_MetaObject)

	return virtualReturn.cPointer()

}

func (this *QFinalState) callVirtualBase_Metacast(param1 string) unsafe.Pointer {
	param1_Cstring := C.CString(param1)
	defer C.free(unsafe.Pointer(param1_Cstring))

	return (unsafe.Pointer)(C.QFinalState_virtualbase_metacast(unsafe.Pointer(this.h), param1_Cstring))

}
func (this *QFinalState) Onmetacast(slot func(super func(param1 string) unsafe.Pointer, param1 string) unsafe.Pointer) {
	ok := C.QFinalState_override_virtual_metacast(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}

//export miqt_exec_callback_QFinalState_metacast
func miqt_exec_callback_QFinalState_metacast(self *C.QFinalState, cb C.intptr_t, param1 *C.const_char) unsafe.Pointer {
	...
	virtualReturn := gofunc((&QFinalState{h: self}).callVirtualBase_Metacast, slotval1)
