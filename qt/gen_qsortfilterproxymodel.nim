...
proc filterRegExp*(self: gen_qsortfilterproxymodel_types.QSortFilterProxyModel, ): gen_qregexp.QRegExp =
...
proc setFilterRegExpWithRegExp*(self: gen_qsortfilterproxymodel_types.QSortFilterProxyModel, regExp: gen_qregexp.QRegExp): void =
...
proc trUtf82*(_: type gen_qsortfilterproxymodel_types.QSortFilterProxyModel, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type gen_qsortfilterproxymodel_types.QSortFilterProxyModel, s: cstring, c: cstring, n: cint): string =
