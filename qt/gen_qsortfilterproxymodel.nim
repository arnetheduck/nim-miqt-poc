...
proc trUtf8*(_: type QSortFilterProxyModel, s: cstring): string =
...
proc filterRegExp*(self: QSortFilterProxyModel, ): gen_qregexp.QRegExp =

  gen_qregexp.QRegExp(h: fcQSortFilterProxyModel_filterRegExp(self.h))
...
proc setFilterRegExp*(self: QSortFilterProxyModel, pattern: string): void =

  fcQSortFilterProxyModel_setFilterRegExp(self.h, struct_miqt_string(data: pattern, len: csize_t(len(pattern))))

proc setFilterRegExpWithRegExp*(self: QSortFilterProxyModel, regExp: gen_qregexp.QRegExp): void =
...
proc clear*(self: QSortFilterProxyModel, ): void =
...
proc trUtf82*(_: type QSortFilterProxyModel, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type QSortFilterProxyModel, s: cstring, c: cstring, n: cint): string =
