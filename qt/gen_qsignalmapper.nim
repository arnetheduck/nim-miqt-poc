...
proc setMapping*(self: gen_qsignalmapper_types.QSignalMapper, sender: gen_qobject.QObject, text: string): void =
  fcQSignalMapper_setMapping2(self.h, sender.h, struct_miqt_string(data: text, len: csize_t(len(text))))

proc setMapping*(self: gen_qsignalmapper_types.QSignalMapper, sender: gen_qobject.QObject, widget: gen_qwidget.QWidget): void =
  fcQSignalMapper_setMapping3(self.h, sender.h, widget.h)

proc setMapping*(self: gen_qsignalmapper_types.QSignalMapper, sender: gen_qobject.QObject, objectVal: gen_qobject.QObject): void =
...
proc mapping*(self: gen_qsignalmapper_types.QSignalMapper, text: string): gen_qobject.QObject =
  gen_qobject.QObject(h: fcQSignalMapper_mappingWithText(self.h, struct_miqt_string(data: text, len: csize_t(len(text)))))

proc mapping*(self: gen_qsignalmapper_types.QSignalMapper, widget: gen_qwidget.QWidget): gen_qobject.QObject =
  gen_qobject.QObject(h: fcQSignalMapper_mappingWithWidget(self.h, widget.h))

proc mapping*(self: gen_qsignalmapper_types.QSignalMapper, objectVal: gen_qobject.QObject): gen_qobject.QObject =
...
proc mapped*(self: gen_qsignalmapper_types.QSignalMapper, param1: gen_qwidget.QWidget): void =
  fcQSignalMapper_mappedWithQWidget(self.h, param1.h)

type QSignalMappermappedWithQWidgetSlot* = proc(param1: gen_qwidget.QWidget)
...
proc mapped*(self: gen_qsignalmapper_types.QSignalMapper, param1: gen_qobject.QObject): void =
  fcQSignalMapper_mappedWithQObject(self.h, param1.h)

type QSignalMappermappedWithQObjectSlot* = proc(param1: gen_qobject.QObject)
...
type QSignalMappermappedWidgetSlot* = proc(param1: gen_qwidget.QWidget)
...
type QSignalMappermappedObjectSlot* = proc(param1: gen_qobject.QObject)
...
proc map*(self: gen_qsignalmapper_types.QSignalMapper, sender: gen_qobject.QObject): void =
