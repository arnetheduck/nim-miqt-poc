...
proc intersect*(self: gen_qline_types.QLineF, l: gen_qline_types.QLineF, intersectionPoint: gen_qpoint.QPointF): cint =

  cint(fcQLineF_intersect(self.h, l.h, intersectionPoint.h))

proc angleWithQLineF*(self: gen_qline_types.QLineF, l: gen_qline_types.QLineF): float64 =
