...
proc create2*(T: type QBitmap, other: QBitmap): QBitmap =

  QBitmap.init(fcQBitmap_new6(other.h))
...
proc operatorAssign*(self: QBitmap, other: QBitmap): void =

  fcQBitmap_operatorAssign(self.h, other.h)

proc operatorAssignWithQPixmap*(self: QBitmap, param1: gen_qpixmap.QPixmap): void =
...
proc transformed*(self: QBitmap, param1: gen_qmatrix.QMatrix): QBitmap =

  QBitmap(h: fcQBitmap_transformed(self.h, param1.h))

proc transformedWithMatrix*(self: QBitmap, matrix: gen_qtransform.QTransform): QBitmap =
