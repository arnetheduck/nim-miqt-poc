...
proc create2*(T: type gen_qbitmap_types.QBitmap, other: gen_qbitmap_types.QBitmap): gen_qbitmap_types.QBitmap =
...
proc operatorAssignWithQPixmap*(self: gen_qbitmap_types.QBitmap, param1: gen_qpixmap.QPixmap): void =
...
proc transformedWithMatrix*(self: gen_qbitmap_types.QBitmap, matrix: gen_qtransform.QTransform): gen_qbitmap_types.QBitmap =
