...
proc trUtf82*(_: type gen_qformlayout_types.QFormLayout, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type gen_qformlayout_types.QFormLayout, s: cstring, c: cstring, n: cint): string =
