...
proc trUtf8*(_: type QWidgetAction, s: cstring): string =
...
proc trUtf82*(_: type QWidgetAction, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type QWidgetAction, s: cstring, c: cstring, n: cint): string =
