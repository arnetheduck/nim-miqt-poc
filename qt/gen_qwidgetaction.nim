...
proc trUtf82*(_: type gen_qwidgetaction_types.QWidgetAction, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type gen_qwidgetaction_types.QWidgetAction, s: cstring, c: cstring, n: cint): string =
