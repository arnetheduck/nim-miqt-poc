...
proc create*(T: type QAccessibleWidget, o: gen_qwidget.QWidget, r: gen_qaccessible.QAccessibleRole): QAccessibleWidget =

  QAccessibleWidget.init(fcQAccessibleWidget_new2(o.h, cint(r)))
proc create*(T: type QAccessibleWidget, o: gen_qwidget.QWidget, r: gen_qaccessible.QAccessibleRole, name: string): QAccessibleWidget =
...
proc relations*(self: QAccessibleWidget, match: gen_qaccessible.QAccessibleRelationFlag): seq[tuple[first: gen_qaccessible.QAccessibleInterface, second: gen_qaccessible.QAccessibleRelationFlag]] =

  var v_ma = fcQAccessibleWidget_relations(self.h, cint(match))
  var vx_ret = newSeq[tuple[first: gen_qaccessible.QAccessibleInterface, second: gen_qaccessible.QAccessibleRelationFlag]](int(v_ma.len))
  ...
  for i in 0 ..< v_ma.len:
    ...
    var vx_vv_entry_First = gen_qaccessible.QAccessibleInterface(h: vx_vv_First_CArray[0])

    var vx_vv_entry_Second = gen_qaccessible.QAccessibleRelationFlag(vx_vv_Second_CArray[0])
...
proc text*(self: QAccessibleWidget, t: gen_qaccessible.QAccessibleText): string =
...
proc role*(self: QAccessibleWidget, ): gen_qaccessible.QAccessibleRole =

  gen_qaccessible.QAccessibleRole(fcQAccessibleWidget_role(self.h))

proc state*(self: QAccessibleWidget, ): gen_qaccessible.QAccessibleState =

  gen_qaccessible.QAccessibleState(h: fcQAccessibleWidget_state(self.h))
...
proc interfaceCast*(self: QAccessibleWidget, t: gen_qaccessible.QAccessibleInterfaceType): pointer =
