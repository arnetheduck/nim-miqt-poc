...
proc trUtf82*(_: type gen_qgraphicswidget_types.QGraphicsWidget, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type gen_qgraphicswidget_types.QGraphicsWidget, s: cstring, c: cstring, n: cint): string =
