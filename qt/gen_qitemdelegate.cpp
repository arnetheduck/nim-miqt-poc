...
public:
	...
	// Wrapper to allow calling protected method
	QPixmap* protectedbase_selected(QPixmap* pixmap, QPalette* palette, bool enabled) const {
...
QPixmap* QItemDelegate_protectedbase_selected(const void* self, QPixmap* pixmap, QPalette* palette, bool enabled) {
	return ( (const MiqtVirtualQItemDelegate*)(self) )->protectedbase_selected(pixmap, palette, enabled);
}
