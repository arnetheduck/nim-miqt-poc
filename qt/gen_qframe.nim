...
proc trUtf82*(_: type gen_qframe_types.QFrame, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type gen_qframe_types.QFrame, s: cstring, c: cstring, n: cint): string =
...
proc miqt_exec_callback_QFrame_focusOutEvent(self: ptr cQFrame, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QFrame_focusOutEvent ".} =
  ...
  nimfunc[](slotval1)
proc QFrameenterEvent*(self: gen_qframe_types.QFrame, event: gen_qcoreevent.QEvent): void =

  fQFrame_virtualbase_enterEvent(self.h, event.h)

type QFrameenterEventProc* = proc(event: gen_qcoreevent.QEvent): void
