...
proc trUtf8*(_: type QLineEdit, s: cstring): string =
...
proc getTextMargins*(self: QLineEdit, left: ptr cint, top: ptr cint, right: ptr cint, bottom: ptr cint): void =
...
proc trUtf82*(_: type QLineEdit, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type QLineEdit, s: cstring, c: cstring, n: cint): string =
...
proc miqt_exec_callback_QLineEdit_wheelEvent(self: ptr cQLineEdit, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QLineEdit_wheelEvent ".} =
  ...
  nimfunc[](superCall, slotval1)
proc callVirtualBase_keyReleaseEvent(self: QLineEdit, event: gen_qevent.QKeyEvent): void =


  fQLineEdit_virtualbase_keyReleaseEvent(self.h, event.h)

type QLineEditkeyReleaseEventBase* = proc(event: gen_qevent.QKeyEvent): void
proc onkeyReleaseEvent*(self: QLineEdit, slot: proc(super: QLineEditkeyReleaseEventBase, event: gen_qevent.QKeyEvent): void) =
  # TODO check subclass
  type Cb = proc(super: QLineEditkeyReleaseEventBase, event: gen_qevent.QKeyEvent): void
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QLineEdit_keyReleaseEvent(self: ptr cQLineEdit, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QLineEdit_keyReleaseEvent ".} =
  ...
  proc superCall(event: gen_qevent.QKeyEvent): auto =
    callVirtualBase_keyReleaseEvent(QLineEdit(h: self), event)
  let slotval1 = gen_qevent.QKeyEvent(h: event)


  nimfunc[](superCall, slotval1)
proc callVirtualBase_enterEvent(self: QLineEdit, event: gen_qcoreevent.QEvent): void =


  fQLineEdit_virtualbase_enterEvent(self.h, event.h)

type QLineEditenterEventBase* = proc(event: gen_qcoreevent.QEvent): void
proc onenterEvent*(self: QLineEdit, slot: proc(super: QLineEditenterEventBase, event: gen_qcoreevent.QEvent): void) =
  # TODO check subclass
  type Cb = proc(super: QLineEditenterEventBase, event: gen_qcoreevent.QEvent): void
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QLineEdit_hideEvent(self: ptr cQLineEdit, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QLineEdit_hideEvent ".} =
  ...
  nimfunc[](superCall, slotval1)
proc callVirtualBase_nativeEvent(self: QLineEdit, eventType: seq[byte], message: pointer, resultVal: ptr clong): bool =
...
type QLineEditnativeEventBase* = proc(eventType: seq[byte], message: pointer, resultVal: ptr clong): bool
proc onnativeEvent*(self: QLineEdit, slot: proc(super: QLineEditnativeEventBase, eventType: seq[byte], message: pointer, resultVal: ptr clong): bool) =
  # TODO check subclass
  type Cb = proc(super: QLineEditnativeEventBase, eventType: seq[byte], message: pointer, resultVal: ptr clong): bool
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QLineEdit_eventFilter(self: ptr cQLineEdit, slot: int, watched: pointer, event: pointer): bool {.exportc: "miqt_exec_callback_QLineEdit_eventFilter ".} =
  ...
  virtualReturn
proc callVirtualBase_timerEvent(self: QLineEdit, event: gen_qcoreevent.QTimerEvent): void =


  fQLineEdit_virtualbase_timerEvent(self.h, event.h)

type QLineEdittimerEventBase* = proc(event: gen_qcoreevent.QTimerEvent): void
proc ontimerEvent*(self: QLineEdit, slot: proc(super: QLineEdittimerEventBase, event: gen_qcoreevent.QTimerEvent): void) =
  # TODO check subclass
  type Cb = proc(super: QLineEdittimerEventBase, event: gen_qcoreevent.QTimerEvent): void
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QLineEdit_timerEvent(self: ptr cQLineEdit, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QLineEdit_timerEvent ".} =
  ...
  proc superCall(event: gen_qcoreevent.QTimerEvent): auto =
    callVirtualBase_timerEvent(QLineEdit(h: self), event)
