...
proc trUtf8*(_: type QAccessiblePlugin, s: cstring): string =
...
proc trUtf82*(_: type QAccessiblePlugin, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type QAccessiblePlugin, s: cstring, c: cstring, n: cint): string =
