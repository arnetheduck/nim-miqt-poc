...
proc trUtf8*(_: type QProxyStyle, s: cstring): string =
...
proc trUtf82*(_: type QProxyStyle, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type QProxyStyle, s: cstring, c: cstring, n: cint): string =
