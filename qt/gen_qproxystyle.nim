...
proc trUtf82*(_: type gen_qproxystyle_types.QProxyStyle, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type gen_qproxystyle_types.QProxyStyle, s: cstring, c: cstring, n: cint): string =
