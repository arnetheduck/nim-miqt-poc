...
const
  ...
  QDataStreamQt_DefaultCompiledVersion* = 19
...
proc unsetDevice*(self: QDataStream, ): void =
...
proc operatorShiftRight*(self: QDataStream, i: ptr cschar): void =
...
proc operatorShiftLeft*(self: QDataStream, i: cschar): void =
