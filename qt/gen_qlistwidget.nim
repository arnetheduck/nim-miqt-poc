...
proc backgroundColor*(self: QListWidgetItem, ): gen_qcolor.QColor =

  gen_qcolor.QColor(h: fcQListWidgetItem_backgroundColor(self.h))

proc setBackgroundColor*(self: QListWidgetItem, color: gen_qcolor.QColor): void =
...
proc textColor*(self: QListWidgetItem, ): gen_qcolor.QColor =

  gen_qcolor.QColor(h: fcQListWidgetItem_textColor(self.h))

proc setTextColor*(self: QListWidgetItem, color: gen_qcolor.QColor): void =
...
proc miqt_exec_callback_QListWidgetItem_clone(self: ptr cQListWidgetItem, slot: int): pointer {.exportc: "miqt_exec_callback_QListWidgetItem_clone ".} =
  ...
  virtualReturn.h
proc callVirtualBase_setBackgroundColor(self: QListWidgetItem, color: gen_qcolor.QColor): void =


  fQListWidgetItem_virtualbase_setBackgroundColor(self.h, color.h)

type QListWidgetItemsetBackgroundColorBase* = proc(color: gen_qcolor.QColor): void
proc onsetBackgroundColor*(self: QListWidgetItem, slot: proc(super: QListWidgetItemsetBackgroundColorBase, color: gen_qcolor.QColor): void) =
  # TODO check subclass
  type Cb = proc(super: QListWidgetItemsetBackgroundColorBase, color: gen_qcolor.QColor): void
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QListWidgetItem_setBackgroundColor(self: ptr cQListWidgetItem, slot: int, color: pointer): void {.exportc: "miqt_exec_callback_QListWidgetItem_setBackgroundColor ".} =
  type Cb = proc(super: QListWidgetItemsetBackgroundColorBase, color: gen_qcolor.QColor): void
  var nimfunc = cast[ptr Cb](cast[pointer](slot))
  proc superCall(color: gen_qcolor.QColor): auto =
    callVirtualBase_setBackgroundColor(QListWidgetItem(h: self), color)
...
proc trUtf8*(_: type QListWidget, s: cstring): string =
...
proc isItemSelected*(self: QListWidget, item: QListWidgetItem): bool =

  fcQListWidget_isItemSelected(self.h, item.h)

proc setItemSelected*(self: QListWidget, item: QListWidgetItem, select: bool): void =
...
proc isItemHidden*(self: QListWidget, item: QListWidgetItem): bool =

  fcQListWidget_isItemHidden(self.h, item.h)

proc setItemHidden*(self: QListWidget, item: QListWidgetItem, hide: bool): void =

  fcQListWidget_setItemHidden(self.h, item.h, hide)

proc dropEvent*(self: QListWidget, event: gen_qevent.QDropEvent): void =
...
proc trUtf82*(_: type QListWidget, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type QListWidget, s: cstring, c: cstring, n: cint): string =
...
proc callVirtualBase_metaObject(self: QListWidget, ): gen_qobjectdefs.QMetaObject =


  gen_qobjectdefs.QMetaObject(h: fQListWidget_virtualbase_metaObject(self.h))

type QListWidgetmetaObjectBase* = proc(): gen_qobjectdefs.QMetaObject
proc onmetaObject*(self: QListWidget, slot: proc(super: QListWidgetmetaObjectBase): gen_qobjectdefs.QMetaObject) =
  # TODO check subclass
  type Cb = proc(super: QListWidgetmetaObjectBase): gen_qobjectdefs.QMetaObject
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QListWidget_metaObject(self: ptr cQListWidget, slot: int): pointer {.exportc: "miqt_exec_callback_QListWidget_metaObject ".} =
  ...
  var nimfunc = cast[ptr Cb](cast[pointer](slot))
  proc superCall(): auto =
    callVirtualBase_metaObject(QListWidget(h: self), )

  let virtualReturn = nimfunc[](superCall )

  virtualReturn.h
proc callVirtualBase_metacast(self: QListWidget, param1: cstring): pointer =


  fQListWidget_virtualbase_metacast(self.h, param1)

type QListWidgetmetacastBase* = proc(param1: cstring): pointer
proc onmetacast*(self: QListWidget, slot: proc(super: QListWidgetmetacastBase, param1: cstring): pointer) =
  # TODO check subclass
  type Cb = proc(super: QListWidgetmetacastBase, param1: cstring): pointer
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QListWidget_metacast(self: ptr cQListWidget, slot: int, param1: cstring): pointer {.exportc: "miqt_exec_callback_QListWidget_metacast ".} =
  ...
  proc superCall(param1: cstring): auto =
    callVirtualBase_metacast(QListWidget(h: self), param1)
  let slotval1 = (param1)
...
proc miqt_exec_callback_QListWidget_startDrag(self: ptr cQListWidget, slot: int, supportedActions: cint): void {.exportc: "miqt_exec_callback_QListWidget_startDrag ".} =
  ...
  nimfunc[](superCall, slotval1)
proc callVirtualBase_viewOptions(self: QListWidget, ): gen_qstyleoption.QStyleOptionViewItem =


  gen_qstyleoption.QStyleOptionViewItem(h: fQListWidget_virtualbase_viewOptions(self.h))

type QListWidgetviewOptionsBase* = proc(): gen_qstyleoption.QStyleOptionViewItem
proc onviewOptions*(self: QListWidget, slot: proc(super: QListWidgetviewOptionsBase): gen_qstyleoption.QStyleOptionViewItem) =
  # TODO check subclass
  type Cb = proc(super: QListWidgetviewOptionsBase): gen_qstyleoption.QStyleOptionViewItem
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QListWidget_viewOptions(self: ptr cQListWidget, slot: int): pointer {.exportc: "miqt_exec_callback_QListWidget_viewOptions ".} =
  ...
  var nimfunc = cast[ptr Cb](cast[pointer](slot))
  proc superCall(): auto =
    callVirtualBase_viewOptions(QListWidget(h: self), )
...
proc miqt_exec_callback_QListWidget_keyReleaseEvent(self: ptr cQListWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QListWidget_keyReleaseEvent ".} =
  ...
  nimfunc[](superCall, slotval1)
proc callVirtualBase_enterEvent(self: QListWidget, event: gen_qcoreevent.QEvent): void =


  fQListWidget_virtualbase_enterEvent(self.h, event.h)

type QListWidgetenterEventBase* = proc(event: gen_qcoreevent.QEvent): void
proc onenterEvent*(self: QListWidget, slot: proc(super: QListWidgetenterEventBase, event: gen_qcoreevent.QEvent): void) =
  # TODO check subclass
  type Cb = proc(super: QListWidgetenterEventBase, event: gen_qcoreevent.QEvent): void
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QListWidget_hideEvent(self: ptr cQListWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QListWidget_hideEvent ".} =
  ...
  nimfunc[](superCall, slotval1)
proc callVirtualBase_nativeEvent(self: QListWidget, eventType: seq[byte], message: pointer, resultVal: ptr clong): bool =
...
type QListWidgetnativeEventBase* = proc(eventType: seq[byte], message: pointer, resultVal: ptr clong): bool
proc onnativeEvent*(self: QListWidget, slot: proc(super: QListWidgetnativeEventBase, eventType: seq[byte], message: pointer, resultVal: ptr clong): bool) =
  # TODO check subclass
  type Cb = proc(super: QListWidgetnativeEventBase, eventType: seq[byte], message: pointer, resultVal: ptr clong): bool
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QListWidget_disconnectNotify(self: ptr cQListWidget, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QListWidget_disconnectNotify ".} =
  ...
  nimfunc[](superCall, slotval1)
proc staticMetaObject*(_: type QListWidget): gen_qobjectdefs.QMetaObject =
