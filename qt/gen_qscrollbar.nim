...
proc fcQScrollBar_virtualbase_nativeEvent(self: pointer, eventType: struct_miqt_string, message: pointer, resultVal: ptr clong): bool {.importc: "QScrollBar_virtualbase_nativeEvent".}
...
proc fcQScrollBar_protectedbase_initStyleOption(self: pointer, option: pointer): void {.importc: "QScrollBar_protectedbase_initStyleOption".}
...
type QScrollBarenterEventProc* = proc(self: QScrollBar, event: gen_qcoreevent_types.QEvent): void {.raises: [], gcsafe.}
...
proc miqt_exec_callback_cQScrollBar_nativeEvent(vtbl: pointer, self: pointer, eventType: struct_miqt_string, message: pointer, resultVal: ptr clong): bool {.cdecl.} =
  let vtbl = cast[ptr QScrollBarVTable](vtbl)
  let self = QScrollBar(h: self)
...
proc initStyleOption*(self: gen_qscrollbar_types.QScrollBar, option: gen_qstyleoption_types.QStyleOptionSlider): void =
  fcQScrollBar_protectedbase_initStyleOption(self.h, option.h)
