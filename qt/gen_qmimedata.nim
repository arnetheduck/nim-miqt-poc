...
proc trUtf8*(_: type QMimeData, s: cstring): string =
...
proc trUtf82*(_: type QMimeData, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type QMimeData, s: cstring, c: cstring, n: cint): string =
...
proc callVirtualBase_metaObject(self: QMimeData, ): gen_qobjectdefs.QMetaObject =


  gen_qobjectdefs.QMetaObject(h: fQMimeData_virtualbase_metaObject(self.h))

type QMimeDatametaObjectBase* = proc(): gen_qobjectdefs.QMetaObject
proc onmetaObject*(self: QMimeData, slot: proc(super: QMimeDatametaObjectBase): gen_qobjectdefs.QMetaObject) =
  # TODO check subclass
  type Cb = proc(super: QMimeDatametaObjectBase): gen_qobjectdefs.QMetaObject
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QMimeData_metaObject(self: ptr cQMimeData, slot: int): pointer {.exportc: "miqt_exec_callback_QMimeData_metaObject ".} =
  ...
  proc superCall(): auto =
    callVirtualBase_metaObject(QMimeData(h: self), )

  let virtualReturn = nimfunc[](superCall )

  virtualReturn.h
proc callVirtualBase_metacast(self: QMimeData, param1: cstring): pointer =


  fQMimeData_virtualbase_metacast(self.h, param1)

type QMimeDatametacastBase* = proc(param1: cstring): pointer
proc onmetacast*(self: QMimeData, slot: proc(super: QMimeDatametacastBase, param1: cstring): pointer) =
  # TODO check subclass
  type Cb = proc(super: QMimeDatametacastBase, param1: cstring): pointer
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QMimeData_metacast(self: ptr cQMimeData, slot: int, param1: cstring): pointer {.exportc: "miqt_exec_callback_QMimeData_metacast ".} =
  ...
  proc superCall(param1: cstring): auto =
    callVirtualBase_metacast(QMimeData(h: self), param1)
  let slotval1 = (param1)
...
proc callVirtualBase_retrieveData(self: QMimeData, mimetype: string, preferredType: gen_qvariant.QVariantType): gen_qvariant.QVariant =
...
type QMimeDataretrieveDataBase* = proc(mimetype: string, preferredType: gen_qvariant.QVariantType): gen_qvariant.QVariant
proc onretrieveData*(self: QMimeData, slot: proc(super: QMimeDataretrieveDataBase, mimetype: string, preferredType: gen_qvariant.QVariantType): gen_qvariant.QVariant) =
  # TODO check subclass
  type Cb = proc(super: QMimeDataretrieveDataBase, mimetype: string, preferredType: gen_qvariant.QVariantType): gen_qvariant.QVariant
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QMimeData_retrieveData(self: ptr cQMimeData, slot: int, mimetype: struct_miqt_string, preferredType: cint): pointer {.exportc: "miqt_exec_callback_QMimeData_retrieveData ".} =
  type Cb = proc(super: QMimeDataretrieveDataBase, mimetype: string, preferredType: gen_qvariant.QVariantType): gen_qvariant.QVariant
  var nimfunc = cast[ptr Cb](cast[pointer](slot))
  proc superCall(mimetype: string, preferredType: gen_qvariant.QVariantType): auto =
  ...
  let slotval2 = gen_qvariant.QVariantType(preferredType)
