...
proc trUtf82*(_: type gen_qsharedmemory_types.QSharedMemory, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type gen_qsharedmemory_types.QSharedMemory, s: cstring, c: cstring, n: cint): string =
...
proc create2*(self: gen_qsharedmemory_types.QSharedMemory, size: cint, mode: cint): bool =
