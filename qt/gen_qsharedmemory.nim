...
proc trUtf8*(_: type QSharedMemory, s: cstring): string =
...
proc create*(self: QSharedMemory, size: cint): bool =

  fcQSharedMemory_create(self.h, size)

proc size*(self: QSharedMemory, ): cint =
...
proc trUtf82*(_: type QSharedMemory, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type QSharedMemory, s: cstring, c: cstring, n: cint): string =
...
proc create2*(self: QSharedMemory, size: cint, mode: QSharedMemoryAccessMode): bool =
