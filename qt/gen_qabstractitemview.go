...
func (this *QAbstractItemView) Metacall(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {
	return (int)(C.QAbstractItemView_metacall(this.h, (C.int)(param1), (C.int)(param2), param3))
}
...
func (this *QAbstractItemView) callVirtualBase_MetaObject() *QMetaObject {
	...
	return newQMetaObject(C.QAbstractItemView_virtualbase_metaObject(unsafe.Pointer(this.h)))

}
func (this *QAbstractItemView) OnMetaObject(slot func(super func() *QMetaObject) *QMetaObject) {
	ok := C.QAbstractItemView_override_virtual_metaObject(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
...
func miqt_exec_callback_QAbstractItemView_metaObject(self *C.QAbstractItemView, cb C.intptr_t) *C.QMetaObject {
...
func (this *QAbstractItemView) callVirtualBase_Metacast(param1 string) unsafe.Pointer {
	...
	return (unsafe.Pointer)(C.QAbstractItemView_virtualbase_metacast(unsafe.Pointer(this.h), param1_Cstring))

}
func (this *QAbstractItemView) OnMetacast(slot func(super func(param1 string) unsafe.Pointer, param1 string) unsafe.Pointer) {
	ok := C.QAbstractItemView_override_virtual_metacast(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func miqt_exec_callback_QAbstractItemView_metacast(self *C.QAbstractItemView, cb C.intptr_t, param1 *C.const_char) unsafe.Pointer {
...
func (this *QAbstractItemView) callVirtualBase_Metacall(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {

	return (int)(C.QAbstractItemView_virtualbase_metacall(unsafe.Pointer(this.h), (C.int)(param1), (C.int)(param2), param3))

}
func (this *QAbstractItemView) OnMetacall(slot func(super func(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int, param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int) {
	ok := C.QAbstractItemView_override_virtual_metacall(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}

//export miqt_exec_callback_QAbstractItemView_metacall
func miqt_exec_callback_QAbstractItemView_metacall(self *C.QAbstractItemView, cb C.intptr_t, param1 C.int, param2 C.int, param3 unsafe.Pointer) C.int {
	...
	virtualReturn := gofunc((&QAbstractItemView{h: self}).callVirtualBase_Metacall, slotval1, slotval2, slotval3)
...
func (this *QAbstractItemView) callVirtualBase_ViewOptions() *QStyleOptionViewItem {

	_goptr := newQStyleOptionViewItem(C.QAbstractItemView_virtualbase_viewOptions(unsafe.Pointer(this.h)))
	_goptr.GoGC() // Qt uses pass-by-value semantics for this type. Mimic with finalizer
	return _goptr

}
func (this *QAbstractItemView) OnViewOptions(slot func(super func() *QStyleOptionViewItem) *QStyleOptionViewItem) {
	ok := C.QAbstractItemView_override_virtual_viewOptions(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}

//export miqt_exec_callback_QAbstractItemView_viewOptions
func miqt_exec_callback_QAbstractItemView_viewOptions(self *C.QAbstractItemView, cb C.intptr_t) *C.QStyleOptionViewItem {
	gofunc, ok := cgo.Handle(cb).Value().(func(super func() *QStyleOptionViewItem) *QStyleOptionViewItem)
	if !ok {
		panic("miqt: callback of non-callback type (heap corruption?)")
	}

	virtualReturn := gofunc((&QAbstractItemView{h: self}).callVirtualBase_ViewOptions)
...
func (this *QAbstractItemView) callVirtualBase_EnterEvent(event *QEvent) {

	C.QAbstractItemView_virtualbase_enterEvent(unsafe.Pointer(this.h), event.cPointer())

}
func (this *QAbstractItemView) OnEnterEvent(slot func(super func(event *QEvent), event *QEvent)) {
...
func miqt_exec_callback_QAbstractItemView_enterEvent(self *C.QAbstractItemView, cb C.intptr_t, event *C.QEvent) {
...
func (this *QAbstractItemView) OnNativeEvent(slot func(super func(eventType []byte, message unsafe.Pointer, result *int64) bool, eventType []byte, message unsafe.Pointer, result *int64) bool) {
...
func miqt_exec_callback_QAbstractItemView_nativeEvent(self *C.QAbstractItemView, cb C.intptr_t, eventType C.struct_miqt_string, message unsafe.Pointer, result *C.long) C.bool {
