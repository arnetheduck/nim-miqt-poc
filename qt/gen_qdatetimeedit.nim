...
proc trUtf8*(_: type QDateTimeEdit, s: cstring): string =
...
proc trUtf82*(_: type QDateTimeEdit, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type QDateTimeEdit, s: cstring, c: cstring, n: cint): string =
...
proc miqt_exec_callback_QDateTimeEdit_mouseDoubleClickEvent(self: ptr cQDateTimeEdit, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QDateTimeEdit_mouseDoubleClickEvent ".} =
  ...
  nimfunc[](superCall, slotval1)
proc callVirtualBase_enterEvent(self: QDateTimeEdit, event: gen_qcoreevent.QEvent): void =


  fQDateTimeEdit_virtualbase_enterEvent(self.h, event.h)

type QDateTimeEditenterEventBase* = proc(event: gen_qcoreevent.QEvent): void
proc onenterEvent*(self: QDateTimeEdit, slot: proc(super: QDateTimeEditenterEventBase, event: gen_qcoreevent.QEvent): void) =
  # TODO check subclass
  type Cb = proc(super: QDateTimeEditenterEventBase, event: gen_qcoreevent.QEvent): void
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QDateTimeEdit_dropEvent(self: ptr cQDateTimeEdit, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QDateTimeEdit_dropEvent ".} =
  ...
  nimfunc[](superCall, slotval1)
proc callVirtualBase_nativeEvent(self: QDateTimeEdit, eventType: seq[byte], message: pointer, resultVal: ptr clong): bool =
...
type QDateTimeEditnativeEventBase* = proc(eventType: seq[byte], message: pointer, resultVal: ptr clong): bool
proc onnativeEvent*(self: QDateTimeEdit, slot: proc(super: QDateTimeEditnativeEventBase, eventType: seq[byte], message: pointer, resultVal: ptr clong): bool) =
  # TODO check subclass
  type Cb = proc(super: QDateTimeEditnativeEventBase, eventType: seq[byte], message: pointer, resultVal: ptr clong): bool
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc trUtf8*(_: type QTimeEdit, s: cstring): string =
...
proc trUtf82*(_: type QTimeEdit, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type QTimeEdit, s: cstring, c: cstring, n: cint): string =
...
proc miqt_exec_callback_QTimeEdit_mouseDoubleClickEvent(self: ptr cQTimeEdit, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTimeEdit_mouseDoubleClickEvent ".} =
  ...
  nimfunc[](superCall, slotval1)
proc callVirtualBase_enterEvent(self: QTimeEdit, event: gen_qcoreevent.QEvent): void =


  fQTimeEdit_virtualbase_enterEvent(self.h, event.h)

type QTimeEditenterEventBase* = proc(event: gen_qcoreevent.QEvent): void
proc onenterEvent*(self: QTimeEdit, slot: proc(super: QTimeEditenterEventBase, event: gen_qcoreevent.QEvent): void) =
  # TODO check subclass
  type Cb = proc(super: QTimeEditenterEventBase, event: gen_qcoreevent.QEvent): void
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QTimeEdit_dropEvent(self: ptr cQTimeEdit, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTimeEdit_dropEvent ".} =
  ...
  nimfunc[](superCall, slotval1)
proc callVirtualBase_nativeEvent(self: QTimeEdit, eventType: seq[byte], message: pointer, resultVal: ptr clong): bool =
...
type QTimeEditnativeEventBase* = proc(eventType: seq[byte], message: pointer, resultVal: ptr clong): bool
proc onnativeEvent*(self: QTimeEdit, slot: proc(super: QTimeEditnativeEventBase, eventType: seq[byte], message: pointer, resultVal: ptr clong): bool) =
  # TODO check subclass
  type Cb = proc(super: QTimeEditnativeEventBase, eventType: seq[byte], message: pointer, resultVal: ptr clong): bool
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc trUtf8*(_: type QDateEdit, s: cstring): string =
...
proc trUtf82*(_: type QDateEdit, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type QDateEdit, s: cstring, c: cstring, n: cint): string =
...
proc miqt_exec_callback_QDateEdit_mouseDoubleClickEvent(self: ptr cQDateEdit, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QDateEdit_mouseDoubleClickEvent ".} =
  ...
  nimfunc[](superCall, slotval1)
proc callVirtualBase_enterEvent(self: QDateEdit, event: gen_qcoreevent.QEvent): void =


  fQDateEdit_virtualbase_enterEvent(self.h, event.h)

type QDateEditenterEventBase* = proc(event: gen_qcoreevent.QEvent): void
proc onenterEvent*(self: QDateEdit, slot: proc(super: QDateEditenterEventBase, event: gen_qcoreevent.QEvent): void) =
  # TODO check subclass
  type Cb = proc(super: QDateEditenterEventBase, event: gen_qcoreevent.QEvent): void
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QDateEdit_dropEvent(self: ptr cQDateEdit, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QDateEdit_dropEvent ".} =
  ...
  nimfunc[](superCall, slotval1)
proc callVirtualBase_nativeEvent(self: QDateEdit, eventType: seq[byte], message: pointer, resultVal: ptr clong): bool =
...
type QDateEditnativeEventBase* = proc(eventType: seq[byte], message: pointer, resultVal: ptr clong): bool
proc onnativeEvent*(self: QDateEdit, slot: proc(super: QDateEditnativeEventBase, eventType: seq[byte], message: pointer, resultVal: ptr clong): bool) =
  # TODO check subclass
  type Cb = proc(super: QDateEditnativeEventBase, eventType: seq[byte], message: pointer, resultVal: ptr clong): bool
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
