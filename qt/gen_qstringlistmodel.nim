...
proc trUtf8*(_: type QStringListModel, s: cstring): string =
...
proc trUtf82*(_: type QStringListModel, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type QStringListModel, s: cstring, c: cstring, n: cint): string =
...
proc callVirtualBase_metaObject(self: QStringListModel, ): gen_qobjectdefs.QMetaObject =


  gen_qobjectdefs.QMetaObject(h: fQStringListModel_virtualbase_metaObject(self.h))

type QStringListModelmetaObjectBase* = proc(): gen_qobjectdefs.QMetaObject
proc onmetaObject*(self: QStringListModel, slot: proc(super: QStringListModelmetaObjectBase): gen_qobjectdefs.QMetaObject) =
  # TODO check subclass
  type Cb = proc(super: QStringListModelmetaObjectBase): gen_qobjectdefs.QMetaObject
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QStringListModel_metaObject(self: ptr cQStringListModel, slot: int): pointer {.exportc: "miqt_exec_callback_QStringListModel_metaObject ".} =
  ...
  proc superCall(): auto =
    callVirtualBase_metaObject(QStringListModel(h: self), )

  let virtualReturn = nimfunc[](superCall )

  virtualReturn.h
proc callVirtualBase_metacast(self: QStringListModel, param1: cstring): pointer =


  fQStringListModel_virtualbase_metacast(self.h, param1)

type QStringListModelmetacastBase* = proc(param1: cstring): pointer
proc onmetacast*(self: QStringListModel, slot: proc(super: QStringListModelmetacastBase, param1: cstring): pointer) =
  # TODO check subclass
  type Cb = proc(super: QStringListModelmetacastBase, param1: cstring): pointer
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QStringListModel_metacast(self: ptr cQStringListModel, slot: int, param1: cstring): pointer {.exportc: "miqt_exec_callback_QStringListModel_metacast ".} =
  ...
  proc superCall(param1: cstring): auto =
    callVirtualBase_metacast(QStringListModel(h: self), param1)
  let slotval1 = (param1)
