...
proc draw*(self: gen_qtextlayout_types.QTextLine, p: gen_qpainter.QPainter, point: gen_qpoint.QPointF, selection: gen_qtextlayout_types.QTextLayoutFormatRange): void =
