...
proc pixmap*(self: gen_qlabel_types.QLabel, ): gen_qpixmap.QPixmap =

  gen_qpixmap.QPixmap(h: fcQLabel_pixmap(self.h))

proc pixmapWithQtReturnByValueConstant*(self: gen_qlabel_types.QLabel, param1: cint): gen_qpixmap.QPixmap =

  gen_qpixmap.QPixmap(h: fcQLabel_pixmapWithQtReturnByValueConstant(self.h, cint(param1)))

proc picture*(self: gen_qlabel_types.QLabel, ): gen_qpicture.QPicture =

  gen_qpicture.QPicture(h: fcQLabel_picture(self.h))

proc pictureWithQtReturnByValueConstant*(self: gen_qlabel_types.QLabel, param1: cint): gen_qpicture.QPicture =
...
proc trUtf82*(_: type gen_qlabel_types.QLabel, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type gen_qlabel_types.QLabel, s: cstring, c: cstring, n: cint): string =
...
proc miqt_exec_callback_QLabel_keyReleaseEvent(self: ptr cQLabel, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QLabel_keyReleaseEvent ".} =
  ...
  nimfunc[](slotval1)
proc QLabelenterEvent*(self: gen_qlabel_types.QLabel, event: gen_qcoreevent.QEvent): void =

  fQLabel_virtualbase_enterEvent(self.h, event.h)

type QLabelenterEventProc* = proc(event: gen_qcoreevent.QEvent): void
