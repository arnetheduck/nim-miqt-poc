...
proc trUtf8*(_: type QLabel, s: cstring): string =
...
proc pixmap*(self: QLabel, ): gen_qpixmap.QPixmap =

  gen_qpixmap.QPixmap(h: fcQLabel_pixmap(self.h))

proc pixmapWithQtReturnByValueConstant*(self: QLabel, param1: gen_qnamespace.ReturnByValueConstant): gen_qpixmap.QPixmap =

  gen_qpixmap.QPixmap(h: fcQLabel_pixmapWithQtReturnByValueConstant(self.h, cint(param1)))

proc picture*(self: QLabel, ): gen_qpicture.QPicture =

  gen_qpicture.QPicture(h: fcQLabel_picture(self.h))

proc pictureWithQtReturnByValueConstant*(self: QLabel, param1: gen_qnamespace.ReturnByValueConstant): gen_qpicture.QPicture =

  gen_qpicture.QPicture(h: fcQLabel_pictureWithQtReturnByValueConstant(self.h, cint(param1)))
...
proc trUtf82*(_: type QLabel, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type QLabel, s: cstring, c: cstring, n: cint): string =
...
proc miqt_exec_callback_QLabel_keyReleaseEvent(self: ptr cQLabel, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QLabel_keyReleaseEvent ".} =
  ...
  nimfunc[](superCall, slotval1)
proc callVirtualBase_enterEvent(self: QLabel, event: gen_qcoreevent.QEvent): void =


  fQLabel_virtualbase_enterEvent(self.h, event.h)

type QLabelenterEventBase* = proc(event: gen_qcoreevent.QEvent): void
proc onenterEvent*(self: QLabel, slot: proc(super: QLabelenterEventBase, event: gen_qcoreevent.QEvent): void) =
  # TODO check subclass
  type Cb = proc(super: QLabelenterEventBase, event: gen_qcoreevent.QEvent): void
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QLabel_hideEvent(self: ptr cQLabel, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QLabel_hideEvent ".} =
  ...
  nimfunc[](superCall, slotval1)
proc callVirtualBase_nativeEvent(self: QLabel, eventType: seq[byte], message: pointer, resultVal: ptr clong): bool =
...
type QLabelnativeEventBase* = proc(eventType: seq[byte], message: pointer, resultVal: ptr clong): bool
proc onnativeEvent*(self: QLabel, slot: proc(super: QLabelnativeEventBase, eventType: seq[byte], message: pointer, resultVal: ptr clong): bool) =
  # TODO check subclass
  type Cb = proc(super: QLabelnativeEventBase, eventType: seq[byte], message: pointer, resultVal: ptr clong): bool
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
