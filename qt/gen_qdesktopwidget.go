...
func (this *QDesktopWidget) Metacall(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {
	return (int)(C.QDesktopWidget_metacall(this.h, (C.int)(param1), (C.int)(param2), param3))
}
...
func (this *QDesktopWidget) callVirtualBase_MetaObject() *QMetaObject {

	return newQMetaObject(C.QDesktopWidget_virtualbase_metaObject(unsafe.Pointer(this.h)))

}
func (this *QDesktopWidget) OnmetaObject(slot func(super func() *QMetaObject) *QMetaObject) {
	ok := C.QDesktopWidget_override_virtual_metaObject(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}

//export miqt_exec_callback_QDesktopWidget_metaObject
func miqt_exec_callback_QDesktopWidget_metaObject(self *C.QDesktopWidget, cb C.intptr_t) *C.QMetaObject {
	gofunc, ok := cgo.Handle(cb).Value().(func(super func() *QMetaObject) *QMetaObject)
	if !ok {
		panic("miqt: callback of non-callback type (heap corruption?)")
	}

	virtualReturn := gofunc((&QDesktopWidget{h: self}).callVirtualBase_MetaObject)

	return virtualReturn.cPointer()

}

func (this *QDesktopWidget) callVirtualBase_Metacast(param1 string) unsafe.Pointer {
	param1_Cstring := C.CString(param1)
	defer C.free(unsafe.Pointer(param1_Cstring))

	return (unsafe.Pointer)(C.QDesktopWidget_virtualbase_metacast(unsafe.Pointer(this.h), param1_Cstring))

}
func (this *QDesktopWidget) Onmetacast(slot func(super func(param1 string) unsafe.Pointer, param1 string) unsafe.Pointer) {
	ok := C.QDesktopWidget_override_virtual_metacast(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}

//export miqt_exec_callback_QDesktopWidget_metacast
func miqt_exec_callback_QDesktopWidget_metacast(self *C.QDesktopWidget, cb C.intptr_t, param1 *C.const_char) unsafe.Pointer {
	...
	virtualReturn := gofunc((&QDesktopWidget{h: self}).callVirtualBase_Metacast, slotval1)

	return virtualReturn

}

func (this *QDesktopWidget) callVirtualBase_Metacall(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {

	return (int)(C.QDesktopWidget_virtualbase_metacall(unsafe.Pointer(this.h), (C.int)(param1), (C.int)(param2), param3))

}
func (this *QDesktopWidget) OnMetacall(slot func(super func(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int, param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int) {
	ok := C.QDesktopWidget_override_virtual_metacall(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}

//export miqt_exec_callback_QDesktopWidget_metacall
func miqt_exec_callback_QDesktopWidget_metacall(self *C.QDesktopWidget, cb C.intptr_t, param1 C.int, param2 C.int, param3 unsafe.Pointer) C.int {
	...
	virtualReturn := gofunc((&QDesktopWidget{h: self}).callVirtualBase_Metacall, slotval1, slotval2, slotval3)
