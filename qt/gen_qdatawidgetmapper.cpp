...
QObject* QDataWidgetMapper_protectedbase_sender(const void* self) {
	return ( (const MiqtVirtualQDataWidgetMapper*)(self) )->protectedbase_sender();
}

int QDataWidgetMapper_protectedbase_senderSignalIndex(const void* self) {
	return ( (const MiqtVirtualQDataWidgetMapper*)(self) )->protectedbase_senderSignalIndex();
}

int QDataWidgetMapper_protectedbase_receivers(const void* self, const char* signal) {
	return ( (const MiqtVirtualQDataWidgetMapper*)(self) )->protectedbase_receivers(signal);
}

bool QDataWidgetMapper_protectedbase_isSignalConnected(const void* self, QMetaMethod* signal) {
	return ( (const MiqtVirtualQDataWidgetMapper*)(self) )->protectedbase_isSignalConnected(signal);
}
