...
func (this *QEventTransition) Metacall(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {
	return (int)(C.QEventTransition_metacall(this.h, (C.int)(param1), (C.int)(param2), param3))
}
...
func (this *QEventTransition) callVirtualBase_MetaObject() *QMetaObject {

	return newQMetaObject(C.QEventTransition_virtualbase_metaObject(unsafe.Pointer(this.h)))

}
func (this *QEventTransition) OnmetaObject(slot func(super func() *QMetaObject) *QMetaObject) {
	ok := C.QEventTransition_override_virtual_metaObject(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}

//export miqt_exec_callback_QEventTransition_metaObject
func miqt_exec_callback_QEventTransition_metaObject(self *C.QEventTransition, cb C.intptr_t) *C.QMetaObject {
	gofunc, ok := cgo.Handle(cb).Value().(func(super func() *QMetaObject) *QMetaObject)
	if !ok {
		panic("miqt: callback of non-callback type (heap corruption?)")
	}

	virtualReturn := gofunc((&QEventTransition{h: self}).callVirtualBase_MetaObject)

	return virtualReturn.cPointer()

}

func (this *QEventTransition) callVirtualBase_Metacast(param1 string) unsafe.Pointer {
	param1_Cstring := C.CString(param1)
	defer C.free(unsafe.Pointer(param1_Cstring))

	return (unsafe.Pointer)(C.QEventTransition_virtualbase_metacast(unsafe.Pointer(this.h), param1_Cstring))

}
func (this *QEventTransition) Onmetacast(slot func(super func(param1 string) unsafe.Pointer, param1 string) unsafe.Pointer) {
	ok := C.QEventTransition_override_virtual_metacast(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}

//export miqt_exec_callback_QEventTransition_metacast
func miqt_exec_callback_QEventTransition_metacast(self *C.QEventTransition, cb C.intptr_t, param1 *C.const_char) unsafe.Pointer {
	...
	virtualReturn := gofunc((&QEventTransition{h: self}).callVirtualBase_Metacast, slotval1)

	return virtualReturn

}

func (this *QEventTransition) callVirtualBase_Metacall(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {

	return (int)(C.QEventTransition_virtualbase_metacall(unsafe.Pointer(this.h), (C.int)(param1), (C.int)(param2), param3))

}
func (this *QEventTransition) OnMetacall(slot func(super func(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int, param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int) {
	ok := C.QEventTransition_override_virtual_metacall(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}

//export miqt_exec_callback_QEventTransition_metacall
func miqt_exec_callback_QEventTransition_metacall(self *C.QEventTransition, cb C.intptr_t, param1 C.int, param2 C.int, param3 unsafe.Pointer) C.int {
	...
	virtualReturn := gofunc((&QEventTransition{h: self}).callVirtualBase_Metacall, slotval1, slotval2, slotval3)
