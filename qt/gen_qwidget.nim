...
proc trUtf82*(_: type gen_qwidget_types.QWidget, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type gen_qwidget_types.QWidget, s: cstring, c: cstring, n: cint): string =
