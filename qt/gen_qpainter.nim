...
proc drawRoundRect*(self: gen_qpainter_types.QPainter, r: gen_qrect.QRect): void =
...
proc setMatrix*(self: gen_qpainter_types.QPainter, matrix: gen_qmatrix.QMatrix, combine: bool): void =
...
proc setWorldMatrix*(self: gen_qpainter_types.QPainter, matrix: gen_qmatrix.QMatrix, combine: bool): void =
...
proc drawRoundRect*(self: gen_qpainter_types.QPainter, r: gen_qrect.QRectF, xround: cint): void =
  fcQPainter_drawRoundRect22(self.h, r.h, xround)

proc drawRoundRect*(self: gen_qpainter_types.QPainter, r: gen_qrect.QRectF, xround: cint, yround: cint): void =
...
proc drawRoundRect*(self: gen_qpainter_types.QPainter, r: gen_qrect.QRect, xround: cint): void =
  fcQPainter_drawRoundRect23(self.h, r.h, xround)

proc drawRoundRect*(self: gen_qpainter_types.QPainter, r: gen_qrect.QRect, xround: cint, yround: cint): void =
...
proc setRedirected*(_: type gen_qpainter_types.QPainter, device: gen_qpaintdevice.QPaintDevice, replacement: gen_qpaintdevice.QPaintDevice, offset: gen_qpoint.QPoint): void =
  fcQPainter_setRedirected3(device.h, replacement.h, offset.h)

proc redirected*(_: type gen_qpainter_types.QPainter, device: gen_qpaintdevice.QPaintDevice, offset: gen_qpoint.QPoint): gen_qpaintdevice.QPaintDevice =
