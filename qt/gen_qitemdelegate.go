...
func (this *QItemDelegate) Metacall(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {
	return (int)(C.QItemDelegate_metacall(this.h, (C.int)(param1), (C.int)(param2), param3))
}
...
func (this *QItemDelegate) callVirtualBase_MetaObject() *QMetaObject {
	...
	return newQMetaObject(C.QItemDelegate_virtualbase_metaObject(unsafe.Pointer(this.h)))

}
func (this *QItemDelegate) OnmetaObject(slot func(super func() *QMetaObject) *QMetaObject) {
	ok := C.QItemDelegate_override_virtual_metaObject(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
...
func miqt_exec_callback_QItemDelegate_metaObject(self *C.QItemDelegate, cb C.intptr_t) *C.QMetaObject {
...
func (this *QItemDelegate) callVirtualBase_Metacast(param1 string) unsafe.Pointer {
	...
	return (unsafe.Pointer)(C.QItemDelegate_virtualbase_metacast(unsafe.Pointer(this.h), param1_Cstring))

}
func (this *QItemDelegate) Onmetacast(slot func(super func(param1 string) unsafe.Pointer, param1 string) unsafe.Pointer) {
	ok := C.QItemDelegate_override_virtual_metacast(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func miqt_exec_callback_QItemDelegate_metacast(self *C.QItemDelegate, cb C.intptr_t, param1 *C.const_char) unsafe.Pointer {
...
func (this *QItemDelegate) callVirtualBase_Metacall(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {

	return (int)(C.QItemDelegate_virtualbase_metacall(unsafe.Pointer(this.h), (C.int)(param1), (C.int)(param2), param3))

}
func (this *QItemDelegate) OnMetacall(slot func(super func(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int, param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int) {
	ok := C.QItemDelegate_override_virtual_metacall(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}

//export miqt_exec_callback_QItemDelegate_metacall
func miqt_exec_callback_QItemDelegate_metacall(self *C.QItemDelegate, cb C.intptr_t, param1 C.int, param2 C.int, param3 unsafe.Pointer) C.int {
	...
	virtualReturn := gofunc((&QItemDelegate{h: self}).callVirtualBase_Metacall, slotval1, slotval2, slotval3)
