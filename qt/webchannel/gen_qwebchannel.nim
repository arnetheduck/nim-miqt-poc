...
proc trUtf8*(_: type QWebChannel, s: cstring): string =
...
proc trUtf82*(_: type QWebChannel, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type QWebChannel, s: cstring, c: cstring, n: cint): string =
