...
proc trUtf8*(_: type QWebChannelAbstractTransport, s: cstring): string =
...
proc trUtf82*(_: type QWebChannelAbstractTransport, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type QWebChannelAbstractTransport, s: cstring, c: cstring, n: cint): string =
