...
type QWebChannelAbstractTransportmessageReceivedSlot* = proc(message: gen_qjsonobject.QJsonObject, transport: gen_qwebchannelabstracttransport_types.QWebChannelAbstractTransport)
