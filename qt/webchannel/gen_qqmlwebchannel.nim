...
proc trUtf8*(_: type QQmlWebChannel, s: cstring): string =
...
proc trUtf82*(_: type QQmlWebChannel, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type QQmlWebChannel, s: cstring, c: cstring, n: cint): string =
