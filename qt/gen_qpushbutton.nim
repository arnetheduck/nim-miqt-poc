...
proc trUtf8*(_: type QPushButton, s: cstring): string =
...
proc trUtf82*(_: type QPushButton, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type QPushButton, s: cstring, c: cstring, n: cint): string =
...
proc miqt_exec_callback_QPushButton_mouseReleaseEvent(self: ptr cQPushButton, slot: int, e: pointer): void {.exportc: "miqt_exec_callback_QPushButton_mouseReleaseEvent ".} =
  ...
  nimfunc[](superCall, slotval1)
proc callVirtualBase_mouseMoveEvent(self: QPushButton, e: gen_qevent.QMouseEvent): void =


  fQPushButton_virtualbase_mouseMoveEvent(self.h, e.h)

type QPushButtonmouseMoveEventBase* = proc(e: gen_qevent.QMouseEvent): void
proc onmouseMoveEvent*(self: QPushButton, slot: proc(super: QPushButtonmouseMoveEventBase, e: gen_qevent.QMouseEvent): void) =
  # TODO check subclass
  type Cb = proc(super: QPushButtonmouseMoveEventBase, e: gen_qevent.QMouseEvent): void
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QPushButton_mouseMoveEvent(self: ptr cQPushButton, slot: int, e: pointer): void {.exportc: "miqt_exec_callback_QPushButton_mouseMoveEvent ".} =
  ...
  var nimfunc = cast[ptr Cb](cast[pointer](slot))
  proc superCall(e: gen_qevent.QMouseEvent): auto =
    callVirtualBase_mouseMoveEvent(QPushButton(h: self), e)
  let slotval1 = gen_qevent.QMouseEvent(h: e)
...
proc miqt_exec_callback_QPushButton_wheelEvent(self: ptr cQPushButton, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QPushButton_wheelEvent ".} =
  ...
  nimfunc[](superCall, slotval1)
proc callVirtualBase_enterEvent(self: QPushButton, event: gen_qcoreevent.QEvent): void =


  fQPushButton_virtualbase_enterEvent(self.h, event.h)

type QPushButtonenterEventBase* = proc(event: gen_qcoreevent.QEvent): void
proc onenterEvent*(self: QPushButton, slot: proc(super: QPushButtonenterEventBase, event: gen_qcoreevent.QEvent): void) =
  # TODO check subclass
  type Cb = proc(super: QPushButtonenterEventBase, event: gen_qcoreevent.QEvent): void
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QPushButton_hideEvent(self: ptr cQPushButton, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QPushButton_hideEvent ".} =
  ...
  nimfunc[](superCall, slotval1)
proc callVirtualBase_nativeEvent(self: QPushButton, eventType: seq[byte], message: pointer, resultVal: ptr clong): bool =
...
type QPushButtonnativeEventBase* = proc(eventType: seq[byte], message: pointer, resultVal: ptr clong): bool
proc onnativeEvent*(self: QPushButton, slot: proc(super: QPushButtonnativeEventBase, eventType: seq[byte], message: pointer, resultVal: ptr clong): bool) =
  # TODO check subclass
  type Cb = proc(super: QPushButtonnativeEventBase, eventType: seq[byte], message: pointer, resultVal: ptr clong): bool
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
