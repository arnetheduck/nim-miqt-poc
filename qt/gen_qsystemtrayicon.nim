...
proc trUtf8*(_: type QSystemTrayIcon, s: cstring): string =
...
proc trUtf82*(_: type QSystemTrayIcon, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type QSystemTrayIcon, s: cstring, c: cstring, n: cint): string =
...
proc miqt_exec_callback_QSystemTrayIcon_disconnectNotify(self: ptr cQSystemTrayIcon, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QSystemTrayIcon_disconnectNotify ".} =
  ...
  nimfunc[](superCall, slotval1)
proc staticMetaObject*(_: type QSystemTrayIcon): gen_qobjectdefs.QMetaObject =
