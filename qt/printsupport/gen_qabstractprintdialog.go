...
func (this *QAbstractPrintDialog) Metacall(param1 qt.QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {
	return (int)(C.QAbstractPrintDialog_metacall(this.h, (C.int)(param1), (C.int)(param2), param3))
}
...
func (this *QAbstractPrintDialog) callVirtualBase_MetaObject() *qt.QMetaObject {
	...
	return qt.UnsafeNewQMetaObject(unsafe.Pointer(C.QAbstractPrintDialog_virtualbase_metaObject(unsafe.Pointer(this.h))))
...
func miqt_exec_callback_QAbstractPrintDialog_metaObject(self *C.QAbstractPrintDialog, cb C.intptr_t) *C.QMetaObject {
...
func miqt_exec_callback_QAbstractPrintDialog_metacast(self *C.QAbstractPrintDialog, cb C.intptr_t, param1 *C.const_char) unsafe.Pointer {
...
func (this *QAbstractPrintDialog) callVirtualBase_Metacall(param1 qt.QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {

	return (int)(C.QAbstractPrintDialog_virtualbase_metacall(unsafe.Pointer(this.h), (C.int)(param1), (C.int)(param2), param3))

}
func (this *QAbstractPrintDialog) OnMetacall(slot func(super func(param1 qt.QMetaObject__Call, param2 int, param3 unsafe.Pointer) int, param1 qt.QMetaObject__Call, param2 int, param3 unsafe.Pointer) int) {
	ok := C.QAbstractPrintDialog_override_virtual_metacall(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}

//export miqt_exec_callback_QAbstractPrintDialog_metacall
func miqt_exec_callback_QAbstractPrintDialog_metacall(self *C.QAbstractPrintDialog, cb C.intptr_t, param1 C.int, param2 C.int, param3 unsafe.Pointer) C.int {
	...
	virtualReturn := gofunc((&QAbstractPrintDialog{h: self}).callVirtualBase_Metacall, slotval1, slotval2, slotval3)
