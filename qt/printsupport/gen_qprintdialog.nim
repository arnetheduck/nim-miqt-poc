...
proc trUtf82*(_: type gen_qprintdialog_types.QPrintDialog, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type gen_qprintdialog_types.QPrintDialog, s: cstring, c: cstring, n: cint): string =
