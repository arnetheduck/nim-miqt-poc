...
proc create*(T: type gen_qprintdialog_types.QPrintDialog, printer: gen_qprinter.QPrinter): gen_qprintdialog_types.QPrintDialog =
...
type QPrintDialogacceptedSlot* = proc(printer: gen_qprinter.QPrinter)
...
proc miqt_exec_callback_QPrintDialog_focusOutEvent(self: ptr cQPrintDialog, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QPrintDialog_focusOutEvent ".} =
  ...
  nimfunc[](slotval1)
proc QPrintDialogenterEvent*(self: gen_qprintdialog_types.QPrintDialog, event: gen_qcoreevent.QEvent): void =
  fQPrintDialog_virtualbase_enterEvent(self.h, event.h)

type QPrintDialogenterEventProc* = proc(event: gen_qcoreevent.QEvent): void
