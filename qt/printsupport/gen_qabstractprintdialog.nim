...
const
  ...
  QAbstractPrintDialogDontUseSheet* = 32
...
proc trUtf8*(_: type QAbstractPrintDialog, s: cstring): string =
...
proc addEnabledOption*(self: QAbstractPrintDialog, option: QAbstractPrintDialogPrintDialogOption): void =

  fcQAbstractPrintDialog_addEnabledOption(self.h, cint(option))

proc setEnabledOptions*(self: QAbstractPrintDialog, options: QAbstractPrintDialogPrintDialogOption): void =

  fcQAbstractPrintDialog_setEnabledOptions(self.h, cint(options))

proc enabledOptions*(self: QAbstractPrintDialog, ): QAbstractPrintDialogPrintDialogOption =

  QAbstractPrintDialogPrintDialogOption(fcQAbstractPrintDialog_enabledOptions(self.h))

proc isOptionEnabled*(self: QAbstractPrintDialog, option: QAbstractPrintDialogPrintDialogOption): bool =
...
proc trUtf82*(_: type QAbstractPrintDialog, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type QAbstractPrintDialog, s: cstring, c: cstring, n: cint): string =
...
proc miqt_exec_callback_QAbstractPrintDialog_focusOutEvent(self: ptr cQAbstractPrintDialog, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QAbstractPrintDialog_focusOutEvent ".} =
  ...
  nimfunc[](superCall, slotval1)
proc callVirtualBase_enterEvent(self: QAbstractPrintDialog, event: gen_qcoreevent.QEvent): void =


  fQAbstractPrintDialog_virtualbase_enterEvent(self.h, event.h)

type QAbstractPrintDialogenterEventBase* = proc(event: gen_qcoreevent.QEvent): void
proc onenterEvent*(self: QAbstractPrintDialog, slot: proc(super: QAbstractPrintDialogenterEventBase, event: gen_qcoreevent.QEvent): void) =
  # TODO check subclass
  type Cb = proc(super: QAbstractPrintDialogenterEventBase, event: gen_qcoreevent.QEvent): void
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QAbstractPrintDialog_hideEvent(self: ptr cQAbstractPrintDialog, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QAbstractPrintDialog_hideEvent ".} =
  ...
  nimfunc[](superCall, slotval1)
proc callVirtualBase_nativeEvent(self: QAbstractPrintDialog, eventType: seq[byte], message: pointer, resultVal: ptr clong): bool =
...
type QAbstractPrintDialognativeEventBase* = proc(eventType: seq[byte], message: pointer, resultVal: ptr clong): bool
proc onnativeEvent*(self: QAbstractPrintDialog, slot: proc(super: QAbstractPrintDialognativeEventBase, eventType: seq[byte], message: pointer, resultVal: ptr clong): bool) =
  # TODO check subclass
  type Cb = proc(super: QAbstractPrintDialognativeEventBase, eventType: seq[byte], message: pointer, resultVal: ptr clong): bool
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
