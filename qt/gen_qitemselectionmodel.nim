...
proc create2*(T: type gen_qitemselectionmodel_types.QItemSelectionRange, index: gen_qabstractitemmodel.QModelIndex): gen_qitemselectionmodel_types.QItemSelectionRange =
...
proc trUtf82*(_: type gen_qitemselectionmodel_types.QItemSelectionModel, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type gen_qitemselectionmodel_types.QItemSelectionModel, s: cstring, c: cstring, n: cint): string =
...
proc miqt_exec_callback_QItemSelectionModel_disconnectNotify(self: ptr cQItemSelectionModel, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QItemSelectionModel_disconnectNotify ".} =
  ...
  nimfunc[](slotval1)
proc staticMetaObject*(_: type gen_qitemselectionmodel_types.QItemSelectionModel): gen_qobjectdefs.QMetaObject =
