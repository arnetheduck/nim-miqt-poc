...
func (this *QHistoryState) Metacall(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {
	return (int)(C.QHistoryState_metacall(this.h, (C.int)(param1), (C.int)(param2), param3))
}
...
func (this *QHistoryState) callVirtualBase_MetaObject() *QMetaObject {

	return newQMetaObject(C.QHistoryState_virtualbase_metaObject(unsafe.Pointer(this.h)))

}
func (this *QHistoryState) OnmetaObject(slot func(super func() *QMetaObject) *QMetaObject) {
	ok := C.QHistoryState_override_virtual_metaObject(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}

//export miqt_exec_callback_QHistoryState_metaObject
func miqt_exec_callback_QHistoryState_metaObject(self *C.QHistoryState, cb C.intptr_t) *C.QMetaObject {
	gofunc, ok := cgo.Handle(cb).Value().(func(super func() *QMetaObject) *QMetaObject)
	if !ok {
		panic("miqt: callback of non-callback type (heap corruption?)")
	}

	virtualReturn := gofunc((&QHistoryState{h: self}).callVirtualBase_MetaObject)

	return virtualReturn.cPointer()

}

func (this *QHistoryState) callVirtualBase_Metacast(param1 string) unsafe.Pointer {
	param1_Cstring := C.CString(param1)
	defer C.free(unsafe.Pointer(param1_Cstring))

	return (unsafe.Pointer)(C.QHistoryState_virtualbase_metacast(unsafe.Pointer(this.h), param1_Cstring))

}
func (this *QHistoryState) Onmetacast(slot func(super func(param1 string) unsafe.Pointer, param1 string) unsafe.Pointer) {
	ok := C.QHistoryState_override_virtual_metacast(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}

//export miqt_exec_callback_QHistoryState_metacast
func miqt_exec_callback_QHistoryState_metacast(self *C.QHistoryState, cb C.intptr_t, param1 *C.const_char) unsafe.Pointer {
	...
	virtualReturn := gofunc((&QHistoryState{h: self}).callVirtualBase_Metacast, slotval1)

	return virtualReturn

}

func (this *QHistoryState) callVirtualBase_Metacall(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {

	return (int)(C.QHistoryState_virtualbase_metacall(unsafe.Pointer(this.h), (C.int)(param1), (C.int)(param2), param3))

}
func (this *QHistoryState) OnMetacall(slot func(super func(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int, param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int) {
	ok := C.QHistoryState_override_virtual_metacall(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}

//export miqt_exec_callback_QHistoryState_metacall
func miqt_exec_callback_QHistoryState_metacall(self *C.QHistoryState, cb C.intptr_t, param1 C.int, param2 C.int, param3 unsafe.Pointer) C.int {
	...
	virtualReturn := gofunc((&QHistoryState{h: self}).callVirtualBase_Metacall, slotval1, slotval2, slotval3)
