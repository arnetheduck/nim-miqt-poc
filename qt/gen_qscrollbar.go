...
func (this *QScrollBar) Metacall(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {
	return (int)(C.QScrollBar_metacall(this.h, (C.int)(param1), (C.int)(param2), param3))
}
...
func (this *QScrollBar) callVirtualBase_MetaObject() *QMetaObject {

	return newQMetaObject(C.QScrollBar_virtualbase_metaObject(unsafe.Pointer(this.h)))

}
func (this *QScrollBar) OnmetaObject(slot func(super func() *QMetaObject) *QMetaObject) {
	ok := C.QScrollBar_override_virtual_metaObject(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}

//export miqt_exec_callback_QScrollBar_metaObject
func miqt_exec_callback_QScrollBar_metaObject(self *C.QScrollBar, cb C.intptr_t) *C.QMetaObject {
	gofunc, ok := cgo.Handle(cb).Value().(func(super func() *QMetaObject) *QMetaObject)
	if !ok {
		panic("miqt: callback of non-callback type (heap corruption?)")
	}

	virtualReturn := gofunc((&QScrollBar{h: self}).callVirtualBase_MetaObject)

	return virtualReturn.cPointer()

}

func (this *QScrollBar) callVirtualBase_Metacast(param1 string) unsafe.Pointer {
	param1_Cstring := C.CString(param1)
	defer C.free(unsafe.Pointer(param1_Cstring))

	return (unsafe.Pointer)(C.QScrollBar_virtualbase_metacast(unsafe.Pointer(this.h), param1_Cstring))

}
func (this *QScrollBar) Onmetacast(slot func(super func(param1 string) unsafe.Pointer, param1 string) unsafe.Pointer) {
	ok := C.QScrollBar_override_virtual_metacast(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}

//export miqt_exec_callback_QScrollBar_metacast
func miqt_exec_callback_QScrollBar_metacast(self *C.QScrollBar, cb C.intptr_t, param1 *C.const_char) unsafe.Pointer {
	...
	virtualReturn := gofunc((&QScrollBar{h: self}).callVirtualBase_Metacast, slotval1)

	return virtualReturn

}

func (this *QScrollBar) callVirtualBase_Metacall(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {

	return (int)(C.QScrollBar_virtualbase_metacall(unsafe.Pointer(this.h), (C.int)(param1), (C.int)(param2), param3))

}
func (this *QScrollBar) OnMetacall(slot func(super func(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int, param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int) {
	ok := C.QScrollBar_override_virtual_metacall(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}

//export miqt_exec_callback_QScrollBar_metacall
func miqt_exec_callback_QScrollBar_metacall(self *C.QScrollBar, cb C.intptr_t, param1 C.int, param2 C.int, param3 unsafe.Pointer) C.int {
	...
	virtualReturn := gofunc((&QScrollBar{h: self}).callVirtualBase_Metacall, slotval1, slotval2, slotval3)
