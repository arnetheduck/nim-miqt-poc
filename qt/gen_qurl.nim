...
type QUrlUrlFormattingOption* = cint
const
  QUrlNone* = 0
  QUrlRemoveScheme* = 1
...
type QUrlComponentFormattingOption* = cint
const
  QUrlPrettyDecoded* = 0
...
proc topLevelDomain*(self: QUrl, ): string =
...
proc fromAce*(_: type QUrl, param1: seq[byte]): string =
...
proc toAce*(_: type QUrl, param1: string): seq[byte] =
...
proc topLevelDomain1*(self: QUrl, options: QUrlComponentFormattingOption): string =
