...
func miqt_exec_callback_QThreadPool_metaObject(self *C.QThreadPool, cb C.intptr_t) *C.QMetaObject {
...
func miqt_exec_callback_QThreadPool_metacast(self *C.QThreadPool, cb C.intptr_t, param1 *C.const_char) unsafe.Pointer {
