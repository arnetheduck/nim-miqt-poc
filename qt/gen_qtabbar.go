...
func (this *QTabBar) Metacall(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {
	return (int)(C.QTabBar_metacall(this.h, (C.int)(param1), (C.int)(param2), param3))
}
...
func (this *QTabBar) callVirtualBase_MetaObject() *QMetaObject {
	...
	return newQMetaObject(C.QTabBar_virtualbase_metaObject(unsafe.Pointer(this.h)))

}
func (this *QTabBar) OnmetaObject(slot func(super func() *QMetaObject) *QMetaObject) {
	ok := C.QTabBar_override_virtual_metaObject(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
...
func miqt_exec_callback_QTabBar_metaObject(self *C.QTabBar, cb C.intptr_t) *C.QMetaObject {
...
func (this *QTabBar) callVirtualBase_Metacast(param1 string) unsafe.Pointer {
	...
	return (unsafe.Pointer)(C.QTabBar_virtualbase_metacast(unsafe.Pointer(this.h), param1_Cstring))

}
func (this *QTabBar) Onmetacast(slot func(super func(param1 string) unsafe.Pointer, param1 string) unsafe.Pointer) {
	ok := C.QTabBar_override_virtual_metacast(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func miqt_exec_callback_QTabBar_metacast(self *C.QTabBar, cb C.intptr_t, param1 *C.const_char) unsafe.Pointer {
...
func (this *QTabBar) callVirtualBase_Metacall(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {

	return (int)(C.QTabBar_virtualbase_metacall(unsafe.Pointer(this.h), (C.int)(param1), (C.int)(param2), param3))

}
func (this *QTabBar) OnMetacall(slot func(super func(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int, param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int) {
	ok := C.QTabBar_override_virtual_metacall(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}

//export miqt_exec_callback_QTabBar_metacall
func miqt_exec_callback_QTabBar_metacall(self *C.QTabBar, cb C.intptr_t, param1 C.int, param2 C.int, param3 unsafe.Pointer) C.int {
	...
	virtualReturn := gofunc((&QTabBar{h: self}).callVirtualBase_Metacall, slotval1, slotval2, slotval3)
