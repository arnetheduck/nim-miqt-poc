...
proc trUtf8*(_: type QClipboard, s: cstring): string =
...
proc trUtf82*(_: type QClipboard, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type QClipboard, s: cstring, c: cstring, n: cint): string =
