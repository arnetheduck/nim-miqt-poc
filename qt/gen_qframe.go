...
func (this *QFrame) Metacall(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {
	return (int)(C.QFrame_metacall(this.h, (C.int)(param1), (C.int)(param2), param3))
}
...
func (this *QFrame) callVirtualBase_MetaObject() *QMetaObject {
	...
	return newQMetaObject(C.QFrame_virtualbase_metaObject(unsafe.Pointer(this.h)))

}
func (this *QFrame) OnmetaObject(slot func(super func() *QMetaObject) *QMetaObject) {
	ok := C.QFrame_override_virtual_metaObject(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
...
func miqt_exec_callback_QFrame_metaObject(self *C.QFrame, cb C.intptr_t) *C.QMetaObject {
...
func (this *QFrame) callVirtualBase_Metacast(param1 string) unsafe.Pointer {
	...
	return (unsafe.Pointer)(C.QFrame_virtualbase_metacast(unsafe.Pointer(this.h), param1_Cstring))

}
func (this *QFrame) Onmetacast(slot func(super func(param1 string) unsafe.Pointer, param1 string) unsafe.Pointer) {
	ok := C.QFrame_override_virtual_metacast(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func miqt_exec_callback_QFrame_metacast(self *C.QFrame, cb C.intptr_t, param1 *C.const_char) unsafe.Pointer {
...
func (this *QFrame) callVirtualBase_Metacall(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {

	return (int)(C.QFrame_virtualbase_metacall(unsafe.Pointer(this.h), (C.int)(param1), (C.int)(param2), param3))

}
func (this *QFrame) OnMetacall(slot func(super func(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int, param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int) {
	ok := C.QFrame_override_virtual_metacall(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}

//export miqt_exec_callback_QFrame_metacall
func miqt_exec_callback_QFrame_metacall(self *C.QFrame, cb C.intptr_t, param1 C.int, param2 C.int, param3 unsafe.Pointer) C.int {
	...
	virtualReturn := gofunc((&QFrame{h: self}).callVirtualBase_Metacall, slotval1, slotval2, slotval3)
