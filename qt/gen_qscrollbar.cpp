...
public:
	...
	bool virtualbase_nativeEvent(struct miqt_string eventType, void* message, long* result) {
		...
		return QScrollBar::nativeEvent(eventType_QByteArray, message, static_cast<long*>(result));
	...
	// Wrapper to allow calling protected method
	void protectedbase_initStyleOption(QStyleOptionSlider* option) const {
...
void QScrollBar_protectedbase_initStyleOption(const void* self, QStyleOptionSlider* option) {
	( (const MiqtVirtualQScrollBar*)(self) )->protectedbase_initStyleOption(option);
}
