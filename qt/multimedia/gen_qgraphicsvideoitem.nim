...
proc trUtf8*(_: type QGraphicsVideoItem, s: cstring): string =
...
proc mediaObject*(self: QGraphicsVideoItem, ): gen_qmediaobject.QMediaObject =

  gen_qmediaobject.QMediaObject(h: fcQGraphicsVideoItem_mediaObject(self.h))

proc videoSurface*(self: QGraphicsVideoItem, ): gen_qabstractvideosurface.QAbstractVideoSurface =

  gen_qabstractvideosurface.QAbstractVideoSurface(h: fcQGraphicsVideoItem_videoSurface(self.h))
...
proc trUtf82*(_: type QGraphicsVideoItem, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type QGraphicsVideoItem, s: cstring, c: cstring, n: cint): string =
...
proc callVirtualBase_metaObject(self: QGraphicsVideoItem, ): gen_qobjectdefs.QMetaObject =


  gen_qobjectdefs.QMetaObject(h: fQGraphicsVideoItem_virtualbase_metaObject(self.h))

type QGraphicsVideoItemmetaObjectBase* = proc(): gen_qobjectdefs.QMetaObject
proc onmetaObject*(self: QGraphicsVideoItem, slot: proc(super: QGraphicsVideoItemmetaObjectBase): gen_qobjectdefs.QMetaObject) =
  # TODO check subclass
  type Cb = proc(super: QGraphicsVideoItemmetaObjectBase): gen_qobjectdefs.QMetaObject
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QGraphicsVideoItem_metaObject(self: ptr cQGraphicsVideoItem, slot: int): pointer {.exportc: "miqt_exec_callback_QGraphicsVideoItem_metaObject ".} =
  ...
  proc superCall(): auto =
    callVirtualBase_metaObject(QGraphicsVideoItem(h: self), )

  let virtualReturn = nimfunc[](superCall )

  virtualReturn.h
proc callVirtualBase_metacast(self: QGraphicsVideoItem, param1: cstring): pointer =


  fQGraphicsVideoItem_virtualbase_metacast(self.h, param1)

type QGraphicsVideoItemmetacastBase* = proc(param1: cstring): pointer
proc onmetacast*(self: QGraphicsVideoItem, slot: proc(super: QGraphicsVideoItemmetacastBase, param1: cstring): pointer) =
  # TODO check subclass
  type Cb = proc(super: QGraphicsVideoItemmetacastBase, param1: cstring): pointer
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QGraphicsVideoItem_metacast(self: ptr cQGraphicsVideoItem, slot: int, param1: cstring): pointer {.exportc: "miqt_exec_callback_QGraphicsVideoItem_metacast ".} =
  ...
  proc superCall(param1: cstring): auto =
    callVirtualBase_metacast(QGraphicsVideoItem(h: self), param1)
  let slotval1 = (param1)
...
proc miqt_exec_callback_QGraphicsVideoItem_metacall(self: ptr cQGraphicsVideoItem, slot: int, param1: cint, param2: cint, param3: pointer): cint {.exportc: "miqt_exec_callback_QGraphicsVideoItem_metacall ".} =
  ...
  virtualReturn
proc callVirtualBase_mediaObject(self: QGraphicsVideoItem, ): gen_qmediaobject.QMediaObject =


  gen_qmediaobject.QMediaObject(h: fQGraphicsVideoItem_virtualbase_mediaObject(self.h))

type QGraphicsVideoItemmediaObjectBase* = proc(): gen_qmediaobject.QMediaObject
proc onmediaObject*(self: QGraphicsVideoItem, slot: proc(super: QGraphicsVideoItemmediaObjectBase): gen_qmediaobject.QMediaObject) =
  # TODO check subclass
  type Cb = proc(super: QGraphicsVideoItemmediaObjectBase): gen_qmediaobject.QMediaObject
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QGraphicsVideoItem_mediaObject(self: ptr cQGraphicsVideoItem, slot: int): pointer {.exportc: "miqt_exec_callback_QGraphicsVideoItem_mediaObject ".} =
  ...
  var nimfunc = cast[ptr Cb](cast[pointer](slot))
  proc superCall(): auto =
    callVirtualBase_mediaObject(QGraphicsVideoItem(h: self), )
...
proc miqt_exec_callback_QGraphicsVideoItem_itemChange(self: ptr cQGraphicsVideoItem, slot: int, change: cint, value: pointer): pointer {.exportc: "miqt_exec_callback_QGraphicsVideoItem_itemChange ".} =
  ...
  virtualReturn.h
proc callVirtualBase_setMediaObject(self: QGraphicsVideoItem, objectVal: gen_qmediaobject.QMediaObject): bool =


  fQGraphicsVideoItem_virtualbase_setMediaObject(self.h, objectVal.h)

type QGraphicsVideoItemsetMediaObjectBase* = proc(objectVal: gen_qmediaobject.QMediaObject): bool
proc onsetMediaObject*(self: QGraphicsVideoItem, slot: proc(super: QGraphicsVideoItemsetMediaObjectBase, objectVal: gen_qmediaobject.QMediaObject): bool) =
  # TODO check subclass
  type Cb = proc(super: QGraphicsVideoItemsetMediaObjectBase, objectVal: gen_qmediaobject.QMediaObject): bool
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QGraphicsVideoItem_setMediaObject(self: ptr cQGraphicsVideoItem, slot: int, objectVal: pointer): bool {.exportc: "miqt_exec_callback_QGraphicsVideoItem_setMediaObject ".} =
  ...
  proc superCall(objectVal: gen_qmediaobject.QMediaObject): auto =
    callVirtualBase_setMediaObject(QGraphicsVideoItem(h: self), objectVal)
...
proc miqt_exec_callback_QGraphicsVideoItem_extension(self: ptr cQGraphicsVideoItem, slot: int, variant: pointer): pointer {.exportc: "miqt_exec_callback_QGraphicsVideoItem_extension ".} =
  ...
  virtualReturn.h
proc staticMetaObject*(_: type QGraphicsVideoItem): gen_qobjectdefs.QMetaObject =
  gen_qobjectdefs.QMetaObject(h: fcQGraphicsVideoItem_staticMetaObject())
