...
func init*(T: type QAudioDeviceInfo, h: ptr cQAudioDeviceInfo): QAudioDeviceInfo =
  T(h: h)
proc create*(T: type QAudioDeviceInfo, ): QAudioDeviceInfo =

  QAudioDeviceInfo.init(fcQAudioDeviceInfo_new())
proc create*(T: type QAudioDeviceInfo, other: QAudioDeviceInfo): QAudioDeviceInfo =

  QAudioDeviceInfo.init(fcQAudioDeviceInfo_new2(other.h))
proc operatorAssign*(self: QAudioDeviceInfo, other: QAudioDeviceInfo): void =

  fcQAudioDeviceInfo_operatorAssign(self.h, other.h)

proc operatorEqual*(self: QAudioDeviceInfo, other: QAudioDeviceInfo): bool =

  fcQAudioDeviceInfo_operatorEqual(self.h, other.h)

proc operatorNotEqual*(self: QAudioDeviceInfo, other: QAudioDeviceInfo): bool =

  fcQAudioDeviceInfo_operatorNotEqual(self.h, other.h)

proc isNull*(self: QAudioDeviceInfo, ): bool =

  fcQAudioDeviceInfo_isNull(self.h)

proc deviceName*(self: QAudioDeviceInfo, ): string =
...
proc isFormatSupported*(self: QAudioDeviceInfo, format: gen_qaudioformat.QAudioFormat): bool =

  fcQAudioDeviceInfo_isFormatSupported(self.h, format.h)

proc preferredFormat*(self: QAudioDeviceInfo, ): gen_qaudioformat.QAudioFormat =

  gen_qaudioformat.QAudioFormat(h: fcQAudioDeviceInfo_preferredFormat(self.h))

proc nearestFormat*(self: QAudioDeviceInfo, format: gen_qaudioformat.QAudioFormat): gen_qaudioformat.QAudioFormat =

  gen_qaudioformat.QAudioFormat(h: fcQAudioDeviceInfo_nearestFormat(self.h, format.h))

proc supportedCodecs*(self: QAudioDeviceInfo, ): seq[string] =
...
proc supportedSampleRates*(self: QAudioDeviceInfo, ): seq[cint] =
...
proc supportedChannelCounts*(self: QAudioDeviceInfo, ): seq[cint] =
...
proc supportedSampleSizes*(self: QAudioDeviceInfo, ): seq[cint] =
...
proc supportedByteOrders*(self: QAudioDeviceInfo, ): seq[gen_qaudioformat.QAudioFormatEndian] =
...
proc supportedSampleTypes*(self: QAudioDeviceInfo, ): seq[gen_qaudioformat.QAudioFormatSampleType] =
...
proc realm*(self: QAudioDeviceInfo, ): string =
...
proc defaultInputDevice*(_: type QAudioDeviceInfo, ): QAudioDeviceInfo =

  QAudioDeviceInfo(h: fcQAudioDeviceInfo_defaultInputDevice())

proc defaultOutputDevice*(_: type QAudioDeviceInfo, ): QAudioDeviceInfo =

  QAudioDeviceInfo(h: fcQAudioDeviceInfo_defaultOutputDevice())

proc availableDevices*(_: type QAudioDeviceInfo, mode: gen_qaudio.QAudioMode): seq[QAudioDeviceInfo] =
...
proc delete*(self: QAudioDeviceInfo) =
