...
void miqt_exec_callback_QAudioProbe_audioBufferProbed_release(intptr_t);
void miqt_exec_callback_QAudioProbe_flush(intptr_t);
void miqt_exec_callback_QAudioProbe_flush_release(intptr_t);
#ifdef __cplusplus
} /* extern C */
#endif
...
public:
	...
	MiqtVirtualQAudioProbe(struct QAudioProbe_VTable* vtbl): QAudioProbe(), vtbl(vtbl) {};
	MiqtVirtualQAudioProbe(struct QAudioProbe_VTable* vtbl, QObject* parent): QAudioProbe(parent), vtbl(vtbl) {};

	virtual ~MiqtVirtualQAudioProbe() override { if(vtbl->destructor) vtbl->destructor(vtbl, this); }
	...
	QMetaObject* virtualbase_metaObject() const {
		...
		return (QMetaObject*) QAudioProbe::metaObject();
	...
	int virtualbase_metacall(int param1, int param2, void** param3) {
		...
		return QAudioProbe::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
QAudioProbe* QAudioProbe_new(struct QAudioProbe_VTable* vtbl) {
	return new MiqtVirtualQAudioProbe(vtbl);
}

QAudioProbe* QAudioProbe_new2(struct QAudioProbe_VTable* vtbl, QObject* parent) {
	return new MiqtVirtualQAudioProbe(vtbl, parent);
}
...
void QAudioProbe_connect_audioBufferProbed(QAudioProbe* self, intptr_t slot) {
	struct caller {
		...
		~caller() { miqt_exec_callback_QAudioProbe_audioBufferProbed_release(slot); }
	};
	MiqtVirtualQAudioProbe::connect(self, static_cast<void (QAudioProbe::*)(const QAudioBuffer&)>(&QAudioProbe::audioBufferProbed), self, caller{slot});
}
...
void QAudioProbe_connect_flush(QAudioProbe* self, intptr_t slot) {
	struct caller {
		...
		caller(const caller &) = delete;
		caller &operator=(const caller &) = delete;
		~caller() { miqt_exec_callback_QAudioProbe_flush_release(slot); }
	};
	MiqtVirtualQAudioProbe::connect(self, static_cast<void (QAudioProbe::*)()>(&QAudioProbe::flush), self, caller{slot});
}
...
QMetaObject* QAudioProbe_virtualbase_metaObject(const void* self) {
	return ( (const MiqtVirtualQAudioProbe*)(self) )->virtualbase_metaObject();
}

void* QAudioProbe_virtualbase_metacast(void* self, const char* param1) {
	return ( (MiqtVirtualQAudioProbe*)(self) )->virtualbase_metacast(param1);
}

int QAudioProbe_virtualbase_metacall(void* self, int param1, int param2, void** param3) {
	return ( (MiqtVirtualQAudioProbe*)(self) )->virtualbase_metacall(param1, param2, param3);
}
...
QObject* QAudioProbe_protectedbase_sender(const void* self) {
	return ( (const MiqtVirtualQAudioProbe*)(self) )->protectedbase_sender();
}

int QAudioProbe_protectedbase_senderSignalIndex(const void* self) {
	return ( (const MiqtVirtualQAudioProbe*)(self) )->protectedbase_senderSignalIndex();
}

int QAudioProbe_protectedbase_receivers(const void* self, const char* signal) {
	return ( (const MiqtVirtualQAudioProbe*)(self) )->protectedbase_receivers(signal);
}

bool QAudioProbe_protectedbase_isSignalConnected(const void* self, QMetaMethod* signal) {
	return ( (const MiqtVirtualQAudioProbe*)(self) )->protectedbase_isSignalConnected(signal);
}
