...
func init*(T: type gen_qaudioinputselectorcontrol_types.QAudioInputSelectorControl, h: ptr cQAudioInputSelectorControl): gen_qaudioinputselectorcontrol_types.QAudioInputSelectorControl =
  T(h: h)
proc metaObject*(self: gen_qaudioinputselectorcontrol_types.QAudioInputSelectorControl, ): gen_qobjectdefs.QMetaObject =
...
proc onactiveInputChanged*(self: gen_qaudioinputselectorcontrol_types.QAudioInputSelectorControl, slot: proc(name: string)) =
  type Cb = proc(name: string)
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc onavailableInputsChanged*(self: gen_qaudioinputselectorcontrol_types.QAudioInputSelectorControl, slot: proc()) =
  type Cb = proc()
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
  fQAudioInputSelectorControl_connect_availableInputsChanged(self.h, cast[int](addr tmp[]))
proc tr2*(_: type gen_qaudioinputselectorcontrol_types.QAudioInputSelectorControl, s: cstring, c: cstring): string =
...
proc tr3*(_: type gen_qaudioinputselectorcontrol_types.QAudioInputSelectorControl, s: cstring, c: cstring, n: cint): string =
...
proc trUtf82*(_: type gen_qaudioinputselectorcontrol_types.QAudioInputSelectorControl, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type gen_qaudioinputselectorcontrol_types.QAudioInputSelectorControl, s: cstring, c: cstring, n: cint): string =
