...
proc fQAudioInputSelectorControl_connect_activeInputChanged(self: pointer, slot: int) {.importc: "QAudioInputSelectorControl_connect_activeInputChanged".}
...
proc fQAudioInputSelectorControl_connect_availableInputsChanged(self: pointer, slot: int) {.importc: "QAudioInputSelectorControl_connect_availableInputsChanged".}
...
func init*(T: type QAudioInputSelectorControl, h: ptr cQAudioInputSelectorControl): QAudioInputSelectorControl =
  T(h: h)
proc metaObject*(self: QAudioInputSelectorControl, ): gen_qobjectdefs.QMetaObject =

  gen_qobjectdefs.QMetaObject(h: fcQAudioInputSelectorControl_metaObject(self.h))

proc metacast*(self: QAudioInputSelectorControl, param1: cstring): pointer =

  fcQAudioInputSelectorControl_metacast(self.h, param1)

proc metacall*(self: QAudioInputSelectorControl, param1: gen_qobjectdefs.QMetaObjectCall, param2: cint, param3: pointer): cint =

  fcQAudioInputSelectorControl_metacall(self.h, cint(param1), param2, param3)

proc tr*(_: type QAudioInputSelectorControl, s: cstring): string =
...
proc trUtf8*(_: type QAudioInputSelectorControl, s: cstring): string =
...
proc availableInputs*(self: QAudioInputSelectorControl, ): seq[string] =
...
proc inputDescription*(self: QAudioInputSelectorControl, name: string): string =
...
proc defaultInput*(self: QAudioInputSelectorControl, ): string =
...
proc activeInput*(self: QAudioInputSelectorControl, ): string =
...
proc setActiveInput*(self: QAudioInputSelectorControl, name: string): void =

  fcQAudioInputSelectorControl_setActiveInput(self.h, struct_miqt_string(data: name, len: csize_t(len(name))))

proc activeInputChanged*(self: QAudioInputSelectorControl, name: string): void =
...
proc onactiveInputChanged*(self: QAudioInputSelectorControl, slot: proc(name: string)) =
  type Cb = proc(name: string)
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
  fQAudioInputSelectorControl_connect_activeInputChanged(self.h, cast[int](addr tmp[]))
proc availableInputsChanged*(self: QAudioInputSelectorControl, ): void =
...
proc onavailableInputsChanged*(self: QAudioInputSelectorControl, slot: proc()) =
  type Cb = proc()
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
  fQAudioInputSelectorControl_connect_availableInputsChanged(self.h, cast[int](addr tmp[]))
proc tr2*(_: type QAudioInputSelectorControl, s: cstring, c: cstring): string =
...
proc tr3*(_: type QAudioInputSelectorControl, s: cstring, c: cstring, n: cint): string =
...
proc trUtf82*(_: type QAudioInputSelectorControl, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type QAudioInputSelectorControl, s: cstring, c: cstring, n: cint): string =
...
proc staticMetaObject*(_: type QAudioInputSelectorControl): gen_qobjectdefs.QMetaObject =
  gen_qobjectdefs.QMetaObject(h: fcQAudioInputSelectorControl_staticMetaObject())
proc delete*(self: QAudioInputSelectorControl) =
