...
proc setSource*(self: gen_qaudioprobe_types.QAudioProbe, source: gen_qmediarecorder.QMediaRecorder): bool =
...
type QAudioProbeaudioBufferProbedSlot* = proc(buffer: gen_qaudiobuffer.QAudioBuffer)
