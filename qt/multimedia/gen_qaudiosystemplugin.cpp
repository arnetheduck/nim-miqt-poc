...
public:
	...
	MiqtVirtualQAudioSystemPlugin(struct QAudioSystemPlugin_VTable* vtbl): QAudioSystemPlugin(), vtbl(vtbl) {};
	MiqtVirtualQAudioSystemPlugin(struct QAudioSystemPlugin_VTable* vtbl, QObject* parent): QAudioSystemPlugin(parent), vtbl(vtbl) {};

	virtual ~MiqtVirtualQAudioSystemPlugin() override { if(vtbl->destructor) vtbl->destructor(vtbl, this); }
	...
	QMetaObject* virtualbase_metaObject() const {
		...
		return (QMetaObject*) QAudioSystemPlugin::metaObject();
	...
	int virtualbase_metacall(int param1, int param2, void** param3) {
		...
		return QAudioSystemPlugin::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
QAudioSystemPlugin* QAudioSystemPlugin_new(struct QAudioSystemPlugin_VTable* vtbl) {
	return new MiqtVirtualQAudioSystemPlugin(vtbl);
}

QAudioSystemPlugin* QAudioSystemPlugin_new2(struct QAudioSystemPlugin_VTable* vtbl, QObject* parent) {
	return new MiqtVirtualQAudioSystemPlugin(vtbl, parent);
}
...
QMetaObject* QAudioSystemPlugin_virtualbase_metaObject(const void* self) {
	return ( (const MiqtVirtualQAudioSystemPlugin*)(self) )->virtualbase_metaObject();
}

void* QAudioSystemPlugin_virtualbase_metacast(void* self, const char* param1) {
	return ( (MiqtVirtualQAudioSystemPlugin*)(self) )->virtualbase_metacast(param1);
}

int QAudioSystemPlugin_virtualbase_metacall(void* self, int param1, int param2, void** param3) {
	return ( (MiqtVirtualQAudioSystemPlugin*)(self) )->virtualbase_metacall(param1, param2, param3);
}
...
QObject* QAudioSystemPlugin_protectedbase_sender(const void* self) {
	return ( (const MiqtVirtualQAudioSystemPlugin*)(self) )->protectedbase_sender();
}

int QAudioSystemPlugin_protectedbase_senderSignalIndex(const void* self) {
	return ( (const MiqtVirtualQAudioSystemPlugin*)(self) )->protectedbase_senderSignalIndex();
}

int QAudioSystemPlugin_protectedbase_receivers(const void* self, const char* signal) {
	return ( (const MiqtVirtualQAudioSystemPlugin*)(self) )->protectedbase_receivers(signal);
}

bool QAudioSystemPlugin_protectedbase_isSignalConnected(const void* self, QMetaMethod* signal) {
	return ( (const MiqtVirtualQAudioSystemPlugin*)(self) )->protectedbase_isSignalConnected(signal);
}
