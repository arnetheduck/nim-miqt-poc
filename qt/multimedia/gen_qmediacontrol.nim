...
func init*(T: type QMediaControl, h: ptr cQMediaControl): QMediaControl =
  T(h: h)
proc metaObject*(self: QMediaControl, ): gen_qobjectdefs.QMetaObject =

  gen_qobjectdefs.QMetaObject(h: fcQMediaControl_metaObject(self.h))

proc metacast*(self: QMediaControl, param1: cstring): pointer =

  fcQMediaControl_metacast(self.h, param1)

proc metacall*(self: QMediaControl, param1: gen_qobjectdefs.QMetaObjectCall, param2: cint, param3: pointer): cint =

  fcQMediaControl_metacall(self.h, cint(param1), param2, param3)

proc tr*(_: type QMediaControl, s: cstring): string =
...
proc trUtf8*(_: type QMediaControl, s: cstring): string =
...
proc tr2*(_: type QMediaControl, s: cstring, c: cstring): string =
...
proc tr3*(_: type QMediaControl, s: cstring, c: cstring, n: cint): string =
...
proc trUtf82*(_: type QMediaControl, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type QMediaControl, s: cstring, c: cstring, n: cint): string =
...
proc staticMetaObject*(_: type QMediaControl): gen_qobjectdefs.QMetaObject =
  gen_qobjectdefs.QMetaObject(h: fcQMediaControl_staticMetaObject())
proc delete*(self: QMediaControl) =
