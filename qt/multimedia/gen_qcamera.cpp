...
public:
	...
	void protectedbase_addPropertyWatch(struct miqt_string name) {
		...
		QCamera::addPropertyWatch(name_QByteArray);
	...
	void protectedbase_removePropertyWatch(struct miqt_string name) {
		...
		QCamera::removePropertyWatch(name_QByteArray);
...
void QCamera_protectedbase_addPropertyWatch(void* self, struct miqt_string name) {
	( (MiqtVirtualQCamera*)(self) )->protectedbase_addPropertyWatch(name);
}

void QCamera_protectedbase_removePropertyWatch(void* self, struct miqt_string name) {
	( (MiqtVirtualQCamera*)(self) )->protectedbase_removePropertyWatch(name);
}
