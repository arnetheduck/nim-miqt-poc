...
proc create*(T: type gen_qmediacontent_types.QMediaContent, contentRequest: gen_qnetworkrequest.QNetworkRequest): gen_qmediacontent_types.QMediaContent =
  gen_qmediacontent_types.QMediaContent.init(fcQMediaContent_new3(contentRequest.h))

proc create*(T: type gen_qmediacontent_types.QMediaContent, contentResource: gen_qmediaresource.QMediaResource): gen_qmediacontent_types.QMediaContent =
...
proc create*(T: type gen_qmediacontent_types.QMediaContent, playlist: gen_qmediaplaylist.QMediaPlaylist): gen_qmediacontent_types.QMediaContent =
