...
public:
	...
	QMetaObject* virtualbase_metaObject() const {
		...
		return (QMetaObject*) QCameraImageCapture::metaObject();
	...
	int virtualbase_metacall(int param1, int param2, void** param3) {
		...
		return QCameraImageCapture::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
QMetaObject* QCameraImageCapture_virtualbase_metaObject(const void* self) {
	return ( (const MiqtVirtualQCameraImageCapture*)(self) )->virtualbase_metaObject();
}

void* QCameraImageCapture_virtualbase_metacast(void* self, const char* param1) {
	return ( (MiqtVirtualQCameraImageCapture*)(self) )->virtualbase_metacast(param1);
}

int QCameraImageCapture_virtualbase_metacall(void* self, int param1, int param2, void** param3) {
	return ( (MiqtVirtualQCameraImageCapture*)(self) )->virtualbase_metacall(param1, param2, param3);
}
...
QObject* QCameraImageCapture_protectedbase_sender(const void* self) {
	return ( (const MiqtVirtualQCameraImageCapture*)(self) )->protectedbase_sender();
}

int QCameraImageCapture_protectedbase_senderSignalIndex(const void* self) {
	return ( (const MiqtVirtualQCameraImageCapture*)(self) )->protectedbase_senderSignalIndex();
}

int QCameraImageCapture_protectedbase_receivers(const void* self, const char* signal) {
	return ( (const MiqtVirtualQCameraImageCapture*)(self) )->protectedbase_receivers(signal);
}

bool QCameraImageCapture_protectedbase_isSignalConnected(const void* self, QMetaMethod* signal) {
	return ( (const MiqtVirtualQCameraImageCapture*)(self) )->protectedbase_isSignalConnected(signal);
}
