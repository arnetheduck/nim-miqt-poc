...
func init*(T: type QCustomAudioRoleControl, h: ptr cQCustomAudioRoleControl): QCustomAudioRoleControl =
  T(h: h)
proc metaObject*(self: QCustomAudioRoleControl, ): gen_qobjectdefs.QMetaObject =

  gen_qobjectdefs.QMetaObject(h: fcQCustomAudioRoleControl_metaObject(self.h))

proc metacast*(self: QCustomAudioRoleControl, param1: cstring): pointer =

  fcQCustomAudioRoleControl_metacast(self.h, param1)

proc metacall*(self: QCustomAudioRoleControl, param1: gen_qobjectdefs.QMetaObjectCall, param2: cint, param3: pointer): cint =

  fcQCustomAudioRoleControl_metacall(self.h, cint(param1), param2, param3)

proc tr*(_: type QCustomAudioRoleControl, s: cstring): string =
...
proc trUtf8*(_: type QCustomAudioRoleControl, s: cstring): string =
...
proc customAudioRole*(self: QCustomAudioRoleControl, ): string =
...
proc setCustomAudioRole*(self: QCustomAudioRoleControl, role: string): void =

  fcQCustomAudioRoleControl_setCustomAudioRole(self.h, struct_miqt_string(data: role, len: csize_t(len(role))))

proc supportedCustomAudioRoles*(self: QCustomAudioRoleControl, ): seq[string] =
...
proc customAudioRoleChanged*(self: QCustomAudioRoleControl, role: string): void =
...
proc oncustomAudioRoleChanged*(self: QCustomAudioRoleControl, slot: proc(role: string)) =
  type Cb = proc(role: string)
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
  fQCustomAudioRoleControl_connect_customAudioRoleChanged(self.h, cast[int](addr tmp[]))
proc tr2*(_: type QCustomAudioRoleControl, s: cstring, c: cstring): string =
...
proc tr3*(_: type QCustomAudioRoleControl, s: cstring, c: cstring, n: cint): string =
...
proc trUtf82*(_: type QCustomAudioRoleControl, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type QCustomAudioRoleControl, s: cstring, c: cstring, n: cint): string =
