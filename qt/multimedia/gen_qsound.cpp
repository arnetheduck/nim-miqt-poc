...
public:
	...
	QMetaObject* virtualbase_metaObject() const {
		...
		return (QMetaObject*) QSound::metaObject();
	...
	int virtualbase_metacall(int param1, int param2, void** param3) {
		...
		return QSound::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
QMetaObject* QSound_virtualbase_metaObject(const void* self) {
	return ( (const MiqtVirtualQSound*)(self) )->virtualbase_metaObject();
}

void* QSound_virtualbase_metacast(void* self, const char* param1) {
	return ( (MiqtVirtualQSound*)(self) )->virtualbase_metacast(param1);
}

int QSound_virtualbase_metacall(void* self, int param1, int param2, void** param3) {
	return ( (MiqtVirtualQSound*)(self) )->virtualbase_metacall(param1, param2, param3);
}
...
QObject* QSound_protectedbase_sender(const void* self) {
	return ( (const MiqtVirtualQSound*)(self) )->protectedbase_sender();
}

int QSound_protectedbase_senderSignalIndex(const void* self) {
	return ( (const MiqtVirtualQSound*)(self) )->protectedbase_senderSignalIndex();
}

int QSound_protectedbase_receivers(const void* self, const char* signal) {
	return ( (const MiqtVirtualQSound*)(self) )->protectedbase_receivers(signal);
}

bool QSound_protectedbase_isSignalConnected(const void* self, QMetaMethod* signal) {
	return ( (const MiqtVirtualQSound*)(self) )->protectedbase_isSignalConnected(signal);
}
