...
type QMediaPlayerControlmediaChangedSlot* = proc(content: gen_qmediacontent.QMediaContent)
...
type QMediaPlayerControlavailablePlaybackRangesChangedSlot* = proc(ranges: gen_qmediatimerange.QMediaTimeRange)
