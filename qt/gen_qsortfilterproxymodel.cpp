...
public:
	...
	// Wrapper to allow calling protected method
	void protectedbase_filterChanged() {
...
void QSortFilterProxyModel_protectedbase_filterChanged(void* self) {
	( (MiqtVirtualQSortFilterProxyModel*)(self) )->protectedbase_filterChanged();
}
...
void QSortFilterProxyModel_protectedbase_resetInternalData(void* self) {
	( (MiqtVirtualQSortFilterProxyModel*)(self) )->protectedbase_resetInternalData();
}
