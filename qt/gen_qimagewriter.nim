...
proc trUtf8*(_: type QImageWriter, sourceText: cstring): string =
...
proc setGamma*(self: QImageWriter, gamma: float32): void =

  fcQImageWriter_setGamma(self.h, gamma)

proc gamma*(self: QImageWriter, ): float32 =
...
proc setDescription*(self: QImageWriter, description: string): void =

  fcQImageWriter_setDescription(self.h, struct_miqt_string(data: description, len: csize_t(len(description))))

proc description*(self: QImageWriter, ): string =
...
proc trUtf82*(_: type QImageWriter, sourceText: cstring, disambiguation: cstring): string =
...
proc trUtf83*(_: type QImageWriter, sourceText: cstring, disambiguation: cstring, n: cint): string =
