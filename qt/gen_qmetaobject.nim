...
proc isEditable*(self: QMetaProperty, ): bool =
...
proc isDesignable1*(self: QMetaProperty, obj: gen_qobject.QObject): bool =

  fcQMetaProperty_isDesignable1(self.h, obj.h)

proc isScriptable1*(self: QMetaProperty, obj: gen_qobject.QObject): bool =

  fcQMetaProperty_isScriptable1(self.h, obj.h)

proc isStored1*(self: QMetaProperty, obj: gen_qobject.QObject): bool =

  fcQMetaProperty_isStored1(self.h, obj.h)

proc isEditable1*(self: QMetaProperty, obj: gen_qobject.QObject): bool =

  fcQMetaProperty_isEditable1(self.h, obj.h)

proc isUser1*(self: QMetaProperty, obj: gen_qobject.QObject): bool =
