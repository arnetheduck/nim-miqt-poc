...
const
  ...
  QRegularExpressionOptimizeOnFirstUsageOption* = 128
  QRegularExpressionDontAutomaticallyOptimizeOption* = 256
...
proc patternErrorOffset*(self: QRegularExpression, ): cint =
...
proc match2*(self: QRegularExpression, subject: string, offset: cint): QRegularExpressionMatch =
...
proc match3*(self: QRegularExpression, subject: string, offset: cint, matchType: QRegularExpressionMatchType): QRegularExpressionMatch =
...
proc match4*(self: QRegularExpression, subject: string, offset: cint, matchType: QRegularExpressionMatchType, matchOptions: QRegularExpressionMatchOption): QRegularExpressionMatch =
...
proc globalMatch2*(self: QRegularExpression, subject: string, offset: cint): QRegularExpressionMatchIterator =
...
proc globalMatch3*(self: QRegularExpression, subject: string, offset: cint, matchType: QRegularExpressionMatchType): QRegularExpressionMatchIterator =
...
proc globalMatch4*(self: QRegularExpression, subject: string, offset: cint, matchType: QRegularExpressionMatchType, matchOptions: QRegularExpressionMatchOption): QRegularExpressionMatchIterator =
...
proc capturedStart*(self: QRegularExpressionMatch, ): cint =

  fcQRegularExpressionMatch_capturedStart(self.h)

proc capturedLength*(self: QRegularExpressionMatch, ): cint =

  fcQRegularExpressionMatch_capturedLength(self.h)

proc capturedEnd*(self: QRegularExpressionMatch, ): cint =

  fcQRegularExpressionMatch_capturedEnd(self.h)

proc capturedStartWithName*(self: QRegularExpressionMatch, name: string): cint =

  fcQRegularExpressionMatch_capturedStartWithName(self.h, struct_miqt_string(data: name, len: csize_t(len(name))))

proc capturedLengthWithName*(self: QRegularExpressionMatch, name: string): cint =

  fcQRegularExpressionMatch_capturedLengthWithName(self.h, struct_miqt_string(data: name, len: csize_t(len(name))))

proc capturedEndWithName*(self: QRegularExpressionMatch, name: string): cint =
...
proc capturedStart1*(self: QRegularExpressionMatch, nth: cint): cint =

  fcQRegularExpressionMatch_capturedStart1(self.h, nth)

proc capturedLength1*(self: QRegularExpressionMatch, nth: cint): cint =

  fcQRegularExpressionMatch_capturedLength1(self.h, nth)

proc capturedEnd1*(self: QRegularExpressionMatch, nth: cint): cint =
