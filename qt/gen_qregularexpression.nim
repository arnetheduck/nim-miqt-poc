...
proc match2*(self: gen_qregularexpression_types.QRegularExpression, subject: string, offset: cint): gen_qregularexpression_types.QRegularExpressionMatch =
...
proc match3*(self: gen_qregularexpression_types.QRegularExpression, subject: string, offset: cint, matchType: cint): gen_qregularexpression_types.QRegularExpressionMatch =
...
proc match4*(self: gen_qregularexpression_types.QRegularExpression, subject: string, offset: cint, matchType: cint, matchOptions: cint): gen_qregularexpression_types.QRegularExpressionMatch =
...
proc globalMatch2*(self: gen_qregularexpression_types.QRegularExpression, subject: string, offset: cint): gen_qregularexpression_types.QRegularExpressionMatchIterator =
...
proc globalMatch3*(self: gen_qregularexpression_types.QRegularExpression, subject: string, offset: cint, matchType: cint): gen_qregularexpression_types.QRegularExpressionMatchIterator =
...
proc globalMatch4*(self: gen_qregularexpression_types.QRegularExpression, subject: string, offset: cint, matchType: cint, matchOptions: cint): gen_qregularexpression_types.QRegularExpressionMatchIterator =
...
proc capturedStartWithName*(self: gen_qregularexpression_types.QRegularExpressionMatch, name: string): cint =

  fcQRegularExpressionMatch_capturedStartWithName(self.h, struct_miqt_string(data: name, len: csize_t(len(name))))

proc capturedLengthWithName*(self: gen_qregularexpression_types.QRegularExpressionMatch, name: string): cint =

  fcQRegularExpressionMatch_capturedLengthWithName(self.h, struct_miqt_string(data: name, len: csize_t(len(name))))

proc capturedEndWithName*(self: gen_qregularexpression_types.QRegularExpressionMatch, name: string): cint =
...
proc capturedStart1*(self: gen_qregularexpression_types.QRegularExpressionMatch, nth: cint): cint =

  fcQRegularExpressionMatch_capturedStart1(self.h, nth)

proc capturedLength1*(self: gen_qregularexpression_types.QRegularExpressionMatch, nth: cint): cint =

  fcQRegularExpressionMatch_capturedLength1(self.h, nth)

proc capturedEnd1*(self: gen_qregularexpression_types.QRegularExpressionMatch, nth: cint): cint =
