...
proc setTabStop*(self: QTextOption, tabStop: float64): void =

  fcQTextOption_setTabStop(self.h, tabStop)

proc tabStop*(self: QTextOption, ): float64 =
...
proc create*(T: type QTextOptionTab, param1: QTextOptionTab): QTextOptionTab =

  QTextOptionTab.init(fcQTextOptionTab_new3(param1.h))
proc create*(T: type QTextOptionTab, pos: float64, tabType: QTextOptionTabType, delim: gen_qchar.QChar): QTextOptionTab =

  QTextOptionTab.init(fcQTextOptionTab_new4(pos, cint(tabType), delim.h))
