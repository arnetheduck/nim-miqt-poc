...
proc size*(self: QJsonArray, ): cint =

  fcQJsonArray_size(self.h)

proc count*(self: QJsonArray, ): cint =
...
proc at*(self: QJsonArray, i: cint): gen_qjsonvalue.QJsonValue =
...
proc removeAt*(self: QJsonArray, i: cint): void =

  fcQJsonArray_removeAt(self.h, i)

proc takeAt*(self: QJsonArray, i: cint): gen_qjsonvalue.QJsonValue =
...
proc insert*(self: QJsonArray, i: cint, value: gen_qjsonvalue.QJsonValue): void =

  fcQJsonArray_insert(self.h, i, value.h)

proc replace*(self: QJsonArray, i: cint, value: gen_qjsonvalue.QJsonValue): void =
...
proc operatorSubscript*(self: QJsonArray, i: cint): gen_qjsonvalue.QJsonValueRef =

  gen_qjsonvalue.QJsonValueRef(h: fcQJsonArray_operatorSubscript(self.h, i))

proc operatorSubscriptWithInt*(self: QJsonArray, i: cint): gen_qjsonvalue.QJsonValue =
...
proc create*(T: type QJsonArrayiterator, array: QJsonArray, index: cint): QJsonArrayiterator =

  QJsonArrayiterator.init(fcQJsonArrayiterator_new2(array.h, index))
proc create*(T: type QJsonArrayiterator, param1: QJsonArrayiterator): QJsonArrayiterator =

  QJsonArrayiterator.init(fcQJsonArrayiterator_new3(param1.h))
...
proc operatorMinusGreater*(self: QJsonArrayiterator, ): gen_qjsonvalue.QJsonValueRefPtr =

  gen_qjsonvalue.QJsonValueRefPtr(h: fcQJsonArrayiterator_operatorMinusGreater(self.h))

proc operatorSubscript*(self: QJsonArrayiterator, j: cint): gen_qjsonvalue.QJsonValueRef =
...
proc operatorPlusAssign*(self: QJsonArrayiterator, j: cint): QJsonArrayiterator =

  QJsonArrayiterator(h: fcQJsonArrayiterator_operatorPlusAssign(self.h, j))

proc operatorMinusAssign*(self: QJsonArrayiterator, j: cint): QJsonArrayiterator =

  QJsonArrayiterator(h: fcQJsonArrayiterator_operatorMinusAssign(self.h, j))

proc operatorPlus*(self: QJsonArrayiterator, j: cint): QJsonArrayiterator =

  QJsonArrayiterator(h: fcQJsonArrayiterator_operatorPlus(self.h, j))

proc operatorMinus*(self: QJsonArrayiterator, j: cint): QJsonArrayiterator =

  QJsonArrayiterator(h: fcQJsonArrayiterator_operatorMinus(self.h, j))

proc operatorMinusWithQJsonArrayiterator*(self: QJsonArrayiterator, j: QJsonArrayiterator): cint =
...
proc create*(T: type QJsonArrayconst_iterator, array: QJsonArray, index: cint): QJsonArrayconst_iterator =

  QJsonArrayconst_iterator.init(fcQJsonArrayconst_iterator_new2(array.h, index))
proc create*(T: type QJsonArrayconst_iterator, o: QJsonArrayconst_iterator): QJsonArrayconst_iterator =

  QJsonArrayconst_iterator.init(fcQJsonArrayconst_iterator_new3(o.h))
proc create2*(T: type QJsonArrayconst_iterator, o: QJsonArrayiterator): QJsonArrayconst_iterator =

  QJsonArrayconst_iterator.init(fcQJsonArrayconst_iterator_new4(o.h))
proc operatorMultiply*(self: QJsonArrayconst_iterator, ): gen_qjsonvalue.QJsonValue =

  gen_qjsonvalue.QJsonValue(h: fcQJsonArrayconst_iterator_operatorMultiply(self.h))

proc operatorMinusGreater*(self: QJsonArrayconst_iterator, ): gen_qjsonvalue.QJsonValuePtr =

  gen_qjsonvalue.QJsonValuePtr(h: fcQJsonArrayconst_iterator_operatorMinusGreater(self.h))

proc operatorSubscript*(self: QJsonArrayconst_iterator, j: cint): gen_qjsonvalue.QJsonValue =
...
proc operatorPlusAssign*(self: QJsonArrayconst_iterator, j: cint): QJsonArrayconst_iterator =

  QJsonArrayconst_iterator(h: fcQJsonArrayconst_iterator_operatorPlusAssign(self.h, j))

proc operatorMinusAssign*(self: QJsonArrayconst_iterator, j: cint): QJsonArrayconst_iterator =

  QJsonArrayconst_iterator(h: fcQJsonArrayconst_iterator_operatorMinusAssign(self.h, j))

proc operatorPlus*(self: QJsonArrayconst_iterator, j: cint): QJsonArrayconst_iterator =

  QJsonArrayconst_iterator(h: fcQJsonArrayconst_iterator_operatorPlus(self.h, j))

proc operatorMinus*(self: QJsonArrayconst_iterator, j: cint): QJsonArrayconst_iterator =

  QJsonArrayconst_iterator(h: fcQJsonArrayconst_iterator_operatorMinus(self.h, j))

proc operatorMinusWithQJsonArrayconstIterator*(self: QJsonArrayconst_iterator, j: QJsonArrayconst_iterator): cint =
