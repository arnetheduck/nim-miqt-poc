...
public:
	...
	void protectedbase_setHorizontalStepsPerItem(int steps) {
		...
		QColumnView::setHorizontalStepsPerItem(static_cast<int>(steps));
	...
	void protectedbase_setVerticalStepsPerItem(int steps) {
		...
		QColumnView::setVerticalStepsPerItem(static_cast<int>(steps));
...
void QColumnView_protectedbase_setHorizontalStepsPerItem(void* self, int steps) {
	( (MiqtVirtualQColumnView*)(self) )->protectedbase_setHorizontalStepsPerItem(steps);
}

int QColumnView_protectedbase_horizontalStepsPerItem(const void* self) {
	return ( (const MiqtVirtualQColumnView*)(self) )->protectedbase_horizontalStepsPerItem();
}

void QColumnView_protectedbase_setVerticalStepsPerItem(void* self, int steps) {
	( (MiqtVirtualQColumnView*)(self) )->protectedbase_setVerticalStepsPerItem(steps);
}

int QColumnView_protectedbase_verticalStepsPerItem(const void* self) {
	return ( (const MiqtVirtualQColumnView*)(self) )->protectedbase_verticalStepsPerItem();
}
...
void QColumnView_protectedbase_initStyleOption(const void* self, QStyleOptionFrame* option) {
	( (const MiqtVirtualQColumnView*)(self) )->protectedbase_initStyleOption(option);
}
