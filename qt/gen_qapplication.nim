...
type QApplicationColorSpec* = cint
const
...
proc trUtf8*(_: type QApplication, s: cstring): string =
...
proc colorSpec*(_: type QApplication, ): cint =

  fcQApplication_colorSpec()

proc setColorSpec*(_: type QApplication, colorSpec: cint): void =
...
proc setWindowIcon*(_: type QApplication, icon: gen_qicon.QIcon): void =

  fcQApplication_setWindowIcon(icon.h)

proc windowIcon*(_: type QApplication, ): gen_qicon.QIcon =
...
proc desktop*(_: type QApplication, ): gen_qdesktopwidget.QDesktopWidget =
...
proc setGlobalStrut*(_: type QApplication, globalStrut: gen_qsize.QSize): void =

  fcQApplication_setGlobalStrut(globalStrut.h)

proc globalStrut*(_: type QApplication, ): gen_qsize.QSize =
...
proc trUtf82*(_: type QApplication, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type QApplication, s: cstring, c: cstring, n: cint): string =
