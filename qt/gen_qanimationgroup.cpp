...
public:
	...
	int virtualbase_metacall(int param1, int param2, void** param3) {
		...
		return QAnimationGroup::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
int QAnimationGroup_virtualbase_metacall(void* self, int param1, int param2, void** param3) {
	return ( (MiqtVirtualQAnimationGroup*)(self) )->virtualbase_metacall(param1, param2, param3);
}
...
QObject* QAnimationGroup_protectedbase_sender(const void* self) {
	return ( (const MiqtVirtualQAnimationGroup*)(self) )->protectedbase_sender();
}

int QAnimationGroup_protectedbase_senderSignalIndex(const void* self) {
	return ( (const MiqtVirtualQAnimationGroup*)(self) )->protectedbase_senderSignalIndex();
}

int QAnimationGroup_protectedbase_receivers(const void* self, const char* signal) {
	return ( (const MiqtVirtualQAnimationGroup*)(self) )->protectedbase_receivers(signal);
}

bool QAnimationGroup_protectedbase_isSignalConnected(const void* self, QMetaMethod* signal) {
	return ( (const MiqtVirtualQAnimationGroup*)(self) )->protectedbase_isSignalConnected(signal);
}
