...
proc addAction*(self: gen_qmenu_types.QMenu, text: string): gen_qaction.QAction =

  gen_qaction.QAction(h: fcQMenu_addAction(self.h, struct_miqt_string(data: text, len: csize_t(len(text)))))

proc addAction2*(self: gen_qmenu_types.QMenu, icon: gen_qicon.QIcon, text: string): gen_qaction.QAction =
...
proc trUtf82*(_: type gen_qmenu_types.QMenu, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type gen_qmenu_types.QMenu, s: cstring, c: cstring, n: cint): string =
...
proc miqt_exec_callback_QMenu_wheelEvent(self: ptr cQMenu, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QMenu_wheelEvent ".} =
  ...
  nimfunc[](slotval1)
proc QMenuenterEvent*(self: gen_qmenu_types.QMenu, param1: gen_qcoreevent.QEvent): void =

  fQMenu_virtualbase_enterEvent(self.h, param1.h)

type QMenuenterEventProc* = proc(param1: gen_qcoreevent.QEvent): void
