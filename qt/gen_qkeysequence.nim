...
proc create*(T: type QKeySequence, ks: QKeySequence): QKeySequence =

  QKeySequence.init(fcQKeySequence_new4(ks.h))
proc create2*(T: type QKeySequence, key: QKeySequenceStandardKey): QKeySequence =

  QKeySequence.init(fcQKeySequence_new5(cint(key)))
proc create*(T: type QKeySequence, key: string, format: QKeySequenceSequenceFormat): QKeySequence =

  QKeySequence.init(fcQKeySequence_new6(struct_miqt_string(data: key, len: csize_t(len(key))), cint(format)))
proc create*(T: type QKeySequence, k1: cint, k2: cint): QKeySequence =

  QKeySequence.init(fcQKeySequence_new7(k1, k2))
proc create*(T: type QKeySequence, k1: cint, k2: cint, k3: cint): QKeySequence =

  QKeySequence.init(fcQKeySequence_new8(k1, k2, k3))
proc create*(T: type QKeySequence, k1: cint, k2: cint, k3: cint, k4: cint): QKeySequence =

  QKeySequence.init(fcQKeySequence_new9(k1, k2, k3, k4))
...
proc operatorSubscript*(self: QKeySequence, i: cuint): cint =
