...
proc cancel*(self: gen_qthreadpool_types.QThreadPool, runnable: gen_qrunnable.QRunnable): void =
...
proc trUtf82*(_: type gen_qthreadpool_types.QThreadPool, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type gen_qthreadpool_types.QThreadPool, s: cstring, c: cstring, n: cint): string =
