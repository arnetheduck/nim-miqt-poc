...
func (this *QCommonStyle) Metacall(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {
	return (int)(C.QCommonStyle_metacall(this.h, (C.int)(param1), (C.int)(param2), param3))
}
...
func (this *QCommonStyle) callVirtualBase_MetaObject() *QMetaObject {
	...
	return newQMetaObject(C.QCommonStyle_virtualbase_metaObject(unsafe.Pointer(this.h)))

}
func (this *QCommonStyle) OnmetaObject(slot func(super func() *QMetaObject) *QMetaObject) {
	ok := C.QCommonStyle_override_virtual_metaObject(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
...
func miqt_exec_callback_QCommonStyle_metaObject(self *C.QCommonStyle, cb C.intptr_t) *C.QMetaObject {
...
func (this *QCommonStyle) callVirtualBase_Metacast(param1 string) unsafe.Pointer {
	...
	return (unsafe.Pointer)(C.QCommonStyle_virtualbase_metacast(unsafe.Pointer(this.h), param1_Cstring))

}
func (this *QCommonStyle) Onmetacast(slot func(super func(param1 string) unsafe.Pointer, param1 string) unsafe.Pointer) {
	ok := C.QCommonStyle_override_virtual_metacast(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func miqt_exec_callback_QCommonStyle_metacast(self *C.QCommonStyle, cb C.intptr_t, param1 *C.const_char) unsafe.Pointer {
...
func (this *QCommonStyle) callVirtualBase_Metacall(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {

	return (int)(C.QCommonStyle_virtualbase_metacall(unsafe.Pointer(this.h), (C.int)(param1), (C.int)(param2), param3))

}
func (this *QCommonStyle) OnMetacall(slot func(super func(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int, param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int) {
	ok := C.QCommonStyle_override_virtual_metacall(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}

//export miqt_exec_callback_QCommonStyle_metacall
func miqt_exec_callback_QCommonStyle_metacall(self *C.QCommonStyle, cb C.intptr_t, param1 C.int, param2 C.int, param3 unsafe.Pointer) C.int {
	...
	virtualReturn := gofunc((&QCommonStyle{h: self}).callVirtualBase_Metacall, slotval1, slotval2, slotval3)
