...
proc trUtf8*(_: type QRadioButton, s: cstring): string =
...
proc trUtf82*(_: type QRadioButton, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type QRadioButton, s: cstring, c: cstring, n: cint): string =
...
proc miqt_exec_callback_QRadioButton_wheelEvent(self: ptr cQRadioButton, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QRadioButton_wheelEvent ".} =
  ...
  nimfunc[](superCall, slotval1)
proc callVirtualBase_enterEvent(self: QRadioButton, event: gen_qcoreevent.QEvent): void =


  fQRadioButton_virtualbase_enterEvent(self.h, event.h)

type QRadioButtonenterEventBase* = proc(event: gen_qcoreevent.QEvent): void
proc onenterEvent*(self: QRadioButton, slot: proc(super: QRadioButtonenterEventBase, event: gen_qcoreevent.QEvent): void) =
  # TODO check subclass
  type Cb = proc(super: QRadioButtonenterEventBase, event: gen_qcoreevent.QEvent): void
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QRadioButton_hideEvent(self: ptr cQRadioButton, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QRadioButton_hideEvent ".} =
  ...
  nimfunc[](superCall, slotval1)
proc callVirtualBase_nativeEvent(self: QRadioButton, eventType: seq[byte], message: pointer, resultVal: ptr clong): bool =
...
type QRadioButtonnativeEventBase* = proc(eventType: seq[byte], message: pointer, resultVal: ptr clong): bool
proc onnativeEvent*(self: QRadioButton, slot: proc(super: QRadioButtonnativeEventBase, eventType: seq[byte], message: pointer, resultVal: ptr clong): bool) =
  # TODO check subclass
  type Cb = proc(super: QRadioButtonnativeEventBase, eventType: seq[byte], message: pointer, resultVal: ptr clong): bool
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
