...
proc trUtf8*(_: type QAbstractSlider, s: cstring): string =
...
proc trUtf82*(_: type QAbstractSlider, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type QAbstractSlider, s: cstring, c: cstring, n: cint): string =
...
proc miqt_exec_callback_QAbstractSlider_focusOutEvent(self: ptr cQAbstractSlider, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QAbstractSlider_focusOutEvent ".} =
  ...
  nimfunc[](superCall, slotval1)
proc callVirtualBase_enterEvent(self: QAbstractSlider, event: gen_qcoreevent.QEvent): void =


  fQAbstractSlider_virtualbase_enterEvent(self.h, event.h)

type QAbstractSliderenterEventBase* = proc(event: gen_qcoreevent.QEvent): void
proc onenterEvent*(self: QAbstractSlider, slot: proc(super: QAbstractSliderenterEventBase, event: gen_qcoreevent.QEvent): void) =
  # TODO check subclass
  type Cb = proc(super: QAbstractSliderenterEventBase, event: gen_qcoreevent.QEvent): void
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QAbstractSlider_hideEvent(self: ptr cQAbstractSlider, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QAbstractSlider_hideEvent ".} =
  ...
  nimfunc[](superCall, slotval1)
proc callVirtualBase_nativeEvent(self: QAbstractSlider, eventType: seq[byte], message: pointer, resultVal: ptr clong): bool =
...
type QAbstractSlidernativeEventBase* = proc(eventType: seq[byte], message: pointer, resultVal: ptr clong): bool
proc onnativeEvent*(self: QAbstractSlider, slot: proc(super: QAbstractSlidernativeEventBase, eventType: seq[byte], message: pointer, resultVal: ptr clong): bool) =
  # TODO check subclass
  type Cb = proc(super: QAbstractSlidernativeEventBase, eventType: seq[byte], message: pointer, resultVal: ptr clong): bool
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
