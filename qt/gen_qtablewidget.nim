...
proc create*(T: type gen_qtablewidget_types.QTableWidgetSelectionRange,
  ...
  gen_qtablewidget_types.QTableWidgetSelectionRange(h: fcQTableWidgetSelectionRange_new3(other.h))
...
proc miqt_exec_callback_cQTableWidgetItem_clone(vtbl: pointer, self: pointer): pointer {.cdecl.} =
  ...
  let virtualReturn = vtbl[].clone(self)
  virtualReturn.h
...
proc miqt_exec_callback_cQTableWidgetItem_data(vtbl: pointer, self: pointer, role: cint): pointer {.cdecl.} =
  ...
  let self = QTableWidgetItem(h: self)
  let slotval1 = role
  let virtualReturn = vtbl[].data(self, slotval1)
  virtualReturn.h
...
proc miqt_exec_callback_cQTableWidgetItem_operatorLesser(vtbl: pointer, self: pointer, other: pointer): bool {.cdecl.} =
  ...
  let virtualReturn = vtbl[].operatorLesser(self, slotval1)
  virtualReturn
...
proc miqt_exec_callback_cQTableWidget_itemPressed_release(slot: int) {.exportc: "miqt_exec_callback_QTableWidget_itemPressed_release".} =
...
proc miqt_exec_callback_cQTableWidget_itemClicked_release(slot: int) {.exportc: "miqt_exec_callback_QTableWidget_itemClicked_release".} =
...
proc miqt_exec_callback_cQTableWidget_itemDoubleClicked_release(slot: int) {.exportc: "miqt_exec_callback_QTableWidget_itemDoubleClicked_release".} =
...
proc miqt_exec_callback_cQTableWidget_itemActivated_release(slot: int) {.exportc: "miqt_exec_callback_QTableWidget_itemActivated_release".} =
...
proc miqt_exec_callback_cQTableWidget_itemEntered_release(slot: int) {.exportc: "miqt_exec_callback_QTableWidget_itemEntered_release".} =
...
proc miqt_exec_callback_cQTableWidget_itemChanged_release(slot: int) {.exportc: "miqt_exec_callback_QTableWidget_itemChanged_release".} =
...
proc miqt_exec_callback_cQTableWidget_currentItemChanged_release(slot: int) {.exportc: "miqt_exec_callback_QTableWidget_currentItemChanged_release".} =
...
proc miqt_exec_callback_cQTableWidget_itemSelectionChanged_release(slot: int) {.exportc: "miqt_exec_callback_QTableWidget_itemSelectionChanged_release".} =
...
proc miqt_exec_callback_cQTableWidget_cellPressed_release(slot: int) {.exportc: "miqt_exec_callback_QTableWidget_cellPressed_release".} =
...
proc miqt_exec_callback_cQTableWidget_cellClicked_release(slot: int) {.exportc: "miqt_exec_callback_QTableWidget_cellClicked_release".} =
...
proc miqt_exec_callback_cQTableWidget_cellDoubleClicked_release(slot: int) {.exportc: "miqt_exec_callback_QTableWidget_cellDoubleClicked_release".} =
...
proc miqt_exec_callback_cQTableWidget_cellActivated_release(slot: int) {.exportc: "miqt_exec_callback_QTableWidget_cellActivated_release".} =
...
proc miqt_exec_callback_cQTableWidget_cellEntered_release(slot: int) {.exportc: "miqt_exec_callback_QTableWidget_cellEntered_release".} =
...
proc miqt_exec_callback_cQTableWidget_cellChanged_release(slot: int) {.exportc: "miqt_exec_callback_QTableWidget_cellChanged_release".} =
...
proc miqt_exec_callback_cQTableWidget_currentCellChanged_release(slot: int) {.exportc: "miqt_exec_callback_QTableWidget_currentCellChanged_release".} =
...
type QTableWidgeteditProc* = proc(self: QTableWidget, index: gen_qabstractitemmodel_types.QModelIndex, trigger: cint, event: gen_qcoreevent_types.QEvent): bool {.raises: [], gcsafe.}
...
proc miqt_exec_callback_cQTableWidget_dropMimeData(vtbl: pointer, self: pointer, row: cint, column: cint, data: pointer, action: cint): bool {.cdecl.} =
  ...
  let virtualReturn = vtbl[].dropMimeData(self, slotval1, slotval2, slotval3, slotval4)
  virtualReturn
...
proc QTableWidgetviewOptions*(self: gen_qtablewidget_types.QTableWidget, ): gen_qstyleoption_types.QStyleOptionViewItem =
  gen_qstyleoption_types.QStyleOptionViewItem(h: fcQTableWidget_virtualbase_viewOptions(self.h))
...
proc indexFromItem*(self: gen_qtablewidget_types.QTableWidget, item: gen_qtablewidget_types.QTableWidgetItem): gen_qabstractitemmodel_types.QModelIndex =
  gen_qabstractitemmodel_types.QModelIndex(h: fcQTableWidget_protectedbase_indexFromItem(self.h, item.h))

proc indexFromItem*(self: gen_qtablewidget_types.QTableWidget, item: gen_qtablewidget_types.QTableWidgetItem): gen_qabstractitemmodel_types.QModelIndex =
  gen_qabstractitemmodel_types.QModelIndex(h: fcQTableWidget_protectedbase_indexFromItemWithItem(self.h, item.h))
...
proc itemFromIndex*(self: gen_qtablewidget_types.QTableWidget, index: gen_qabstractitemmodel_types.QModelIndex): gen_qtablewidget_types.QTableWidgetItem =
  gen_qtablewidget_types.QTableWidgetItem(h: fcQTableWidget_protectedbase_itemFromIndex(self.h, index.h))
...
proc create*(T: type gen_qtablewidget_types.QTableWidget,
  ...
  if not isNil(vtbl.edit):
    vtbl[].vtbl.edit = miqt_exec_callback_cQTableWidget_edit2
