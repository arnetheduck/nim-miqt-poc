...
proc backgroundColor*(self: gen_qtablewidget_types.QTableWidgetItem, ): gen_qcolor.QColor =

  gen_qcolor.QColor(h: fcQTableWidgetItem_backgroundColor(self.h))

proc setBackgroundColor*(self: gen_qtablewidget_types.QTableWidgetItem, color: gen_qcolor.QColor): void =
...
proc textColor*(self: gen_qtablewidget_types.QTableWidgetItem, ): gen_qcolor.QColor =

  gen_qcolor.QColor(h: fcQTableWidgetItem_textColor(self.h))

proc setTextColor*(self: gen_qtablewidget_types.QTableWidgetItem, color: gen_qcolor.QColor): void =
...
proc trUtf82*(_: type gen_qtablewidget_types.QTableWidget, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type gen_qtablewidget_types.QTableWidget, s: cstring, c: cstring, n: cint): string =
...
proc miqt_exec_callback_QTableWidget_scrollContentsBy(self: ptr cQTableWidget, slot: int, dx: cint, dy: cint): void {.exportc: "miqt_exec_callback_QTableWidget_scrollContentsBy ".} =
  ...
  nimfunc[](slotval1, slotval2)
proc QTableWidgetviewOptions*(self: gen_qtablewidget_types.QTableWidget, ): gen_qstyleoption.QStyleOptionViewItem =

  gen_qstyleoption.QStyleOptionViewItem(h: fQTableWidget_virtualbase_viewOptions(self.h))

type QTableWidgetviewOptionsProc* = proc(): gen_qstyleoption.QStyleOptionViewItem
...
proc miqt_exec_callback_QTableWidget_keyReleaseEvent(self: ptr cQTableWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTableWidget_keyReleaseEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTableWidgetenterEvent*(self: gen_qtablewidget_types.QTableWidget, event: gen_qcoreevent.QEvent): void =

  fQTableWidget_virtualbase_enterEvent(self.h, event.h)

type QTableWidgetenterEventProc* = proc(event: gen_qcoreevent.QEvent): void
