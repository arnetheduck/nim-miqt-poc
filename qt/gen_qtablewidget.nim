...
proc create*(T: type QTableWidgetSelectionRange, other: QTableWidgetSelectionRange): QTableWidgetSelectionRange =

  QTableWidgetSelectionRange.init(fcQTableWidgetSelectionRange_new3(other.h))
proc operatorAssign*(self: QTableWidgetSelectionRange, other: QTableWidgetSelectionRange): void =
...
proc backgroundColor*(self: QTableWidgetItem, ): gen_qcolor.QColor =

  gen_qcolor.QColor(h: fcQTableWidgetItem_backgroundColor(self.h))

proc setBackgroundColor*(self: QTableWidgetItem, color: gen_qcolor.QColor): void =
...
proc textColor*(self: QTableWidgetItem, ): gen_qcolor.QColor =

  gen_qcolor.QColor(h: fcQTableWidgetItem_textColor(self.h))

proc setTextColor*(self: QTableWidgetItem, color: gen_qcolor.QColor): void =
...
proc trUtf8*(_: type QTableWidget, s: cstring): string =
...
proc isItemSelected*(self: QTableWidget, item: QTableWidgetItem): bool =

  fcQTableWidget_isItemSelected(self.h, item.h)

proc setItemSelected*(self: QTableWidget, item: QTableWidgetItem, select: bool): void =
...
proc trUtf82*(_: type QTableWidget, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type QTableWidget, s: cstring, c: cstring, n: cint): string =
...
proc miqt_exec_callback_QTableWidget_scrollContentsBy(self: ptr cQTableWidget, slot: int, dx: cint, dy: cint): void {.exportc: "miqt_exec_callback_QTableWidget_scrollContentsBy ".} =
  ...
  nimfunc[](superCall, slotval1, slotval2)
proc callVirtualBase_viewOptions(self: QTableWidget, ): gen_qstyleoption.QStyleOptionViewItem =


  gen_qstyleoption.QStyleOptionViewItem(h: fQTableWidget_virtualbase_viewOptions(self.h))

type QTableWidgetviewOptionsBase* = proc(): gen_qstyleoption.QStyleOptionViewItem
proc onviewOptions*(self: QTableWidget, slot: proc(super: QTableWidgetviewOptionsBase): gen_qstyleoption.QStyleOptionViewItem) =
  # TODO check subclass
  type Cb = proc(super: QTableWidgetviewOptionsBase): gen_qstyleoption.QStyleOptionViewItem
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QTableWidget_viewOptions(self: ptr cQTableWidget, slot: int): pointer {.exportc: "miqt_exec_callback_QTableWidget_viewOptions ".} =
  ...
  var nimfunc = cast[ptr Cb](cast[pointer](slot))
  proc superCall(): auto =
    callVirtualBase_viewOptions(QTableWidget(h: self), )
...
proc miqt_exec_callback_QTableWidget_keyReleaseEvent(self: ptr cQTableWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTableWidget_keyReleaseEvent ".} =
  ...
  nimfunc[](superCall, slotval1)
proc callVirtualBase_enterEvent(self: QTableWidget, event: gen_qcoreevent.QEvent): void =


  fQTableWidget_virtualbase_enterEvent(self.h, event.h)

type QTableWidgetenterEventBase* = proc(event: gen_qcoreevent.QEvent): void
proc onenterEvent*(self: QTableWidget, slot: proc(super: QTableWidgetenterEventBase, event: gen_qcoreevent.QEvent): void) =
  # TODO check subclass
  type Cb = proc(super: QTableWidgetenterEventBase, event: gen_qcoreevent.QEvent): void
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QTableWidget_hideEvent(self: ptr cQTableWidget, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTableWidget_hideEvent ".} =
  ...
  nimfunc[](superCall, slotval1)
proc callVirtualBase_nativeEvent(self: QTableWidget, eventType: seq[byte], message: pointer, resultVal: ptr clong): bool =
...
type QTableWidgetnativeEventBase* = proc(eventType: seq[byte], message: pointer, resultVal: ptr clong): bool
proc onnativeEvent*(self: QTableWidget, slot: proc(super: QTableWidgetnativeEventBase, eventType: seq[byte], message: pointer, resultVal: ptr clong): bool) =
  # TODO check subclass
  type Cb = proc(super: QTableWidgetnativeEventBase, eventType: seq[byte], message: pointer, resultVal: ptr clong): bool
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
