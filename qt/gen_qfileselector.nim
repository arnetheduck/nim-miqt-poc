...
proc trUtf82*(_: type gen_qfileselector_types.QFileSelector, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type gen_qfileselector_types.QFileSelector, s: cstring, c: cstring, n: cint): string =
