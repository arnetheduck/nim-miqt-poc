...
proc trUtf82*(_: type gen_qcheckbox_types.QCheckBox, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type gen_qcheckbox_types.QCheckBox, s: cstring, c: cstring, n: cint): string =
...
proc miqt_exec_callback_QCheckBox_wheelEvent(self: ptr cQCheckBox, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QCheckBox_wheelEvent ".} =
  ...
  nimfunc[](slotval1)
proc QCheckBoxenterEvent*(self: gen_qcheckbox_types.QCheckBox, event: gen_qcoreevent.QEvent): void =

  fQCheckBox_virtualbase_enterEvent(self.h, event.h)

type QCheckBoxenterEventProc* = proc(event: gen_qcoreevent.QEvent): void
