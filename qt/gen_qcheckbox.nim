...
proc trUtf8*(_: type QCheckBox, s: cstring): string =
...
proc trUtf82*(_: type QCheckBox, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type QCheckBox, s: cstring, c: cstring, n: cint): string =
...
proc miqt_exec_callback_QCheckBox_wheelEvent(self: ptr cQCheckBox, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QCheckBox_wheelEvent ".} =
  ...
  nimfunc[](superCall, slotval1)
proc callVirtualBase_enterEvent(self: QCheckBox, event: gen_qcoreevent.QEvent): void =


  fQCheckBox_virtualbase_enterEvent(self.h, event.h)

type QCheckBoxenterEventBase* = proc(event: gen_qcoreevent.QEvent): void
proc onenterEvent*(self: QCheckBox, slot: proc(super: QCheckBoxenterEventBase, event: gen_qcoreevent.QEvent): void) =
  # TODO check subclass
  type Cb = proc(super: QCheckBoxenterEventBase, event: gen_qcoreevent.QEvent): void
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QCheckBox_hideEvent(self: ptr cQCheckBox, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QCheckBox_hideEvent ".} =
  ...
  nimfunc[](superCall, slotval1)
proc callVirtualBase_nativeEvent(self: QCheckBox, eventType: seq[byte], message: pointer, resultVal: ptr clong): bool =
...
type QCheckBoxnativeEventBase* = proc(eventType: seq[byte], message: pointer, resultVal: ptr clong): bool
proc onnativeEvent*(self: QCheckBox, slot: proc(super: QCheckBoxnativeEventBase, eventType: seq[byte], message: pointer, resultVal: ptr clong): bool) =
  # TODO check subclass
  type Cb = proc(super: QCheckBoxnativeEventBase, eventType: seq[byte], message: pointer, resultVal: ptr clong): bool
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
