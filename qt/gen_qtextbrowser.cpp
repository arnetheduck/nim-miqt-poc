...
public:
	...
	// Wrapper to allow calling protected method
	void protectedbase_doSetSource(QUrl* name) {
	...
	// Wrapper to allow calling protected method
	void protectedbase_doSetSource2(QUrl* name, int type) {
...
void QTextBrowser_protectedbase_doSetSource(void* self, QUrl* name) {
	( (MiqtVirtualQTextBrowser*)(self) )->protectedbase_doSetSource(name);
}

void QTextBrowser_protectedbase_doSetSource2(void* self, QUrl* name, int type) {
	( (MiqtVirtualQTextBrowser*)(self) )->protectedbase_doSetSource2(name, type);
}
...
void QTextBrowser_protectedbase_initStyleOption(const void* self, QStyleOptionFrame* option) {
	( (const MiqtVirtualQTextBrowser*)(self) )->protectedbase_initStyleOption(option);
}
