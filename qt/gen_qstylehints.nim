...
proc trUtf82*(_: type gen_qstylehints_types.QStyleHints, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type gen_qstylehints_types.QStyleHints, s: cstring, c: cstring, n: cint): string =
