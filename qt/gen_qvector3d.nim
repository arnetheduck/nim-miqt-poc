...
proc create*(T: type gen_qvector3d_types.QVector3D, point: gen_qpoint.QPoint): gen_qvector3d_types.QVector3D =

  gen_qvector3d_types.QVector3D.init(fcQVector3D_new4(point.h))
proc create2*(T: type gen_qvector3d_types.QVector3D, point: gen_qpoint.QPointF): gen_qvector3d_types.QVector3D =

  gen_qvector3d_types.QVector3D.init(fcQVector3D_new5(point.h))
proc create2*(T: type gen_qvector3d_types.QVector3D, vector: gen_qvector2d.QVector2D): gen_qvector3d_types.QVector3D =

  gen_qvector3d_types.QVector3D.init(fcQVector3D_new6(vector.h))
proc create*(T: type gen_qvector3d_types.QVector3D, vector: gen_qvector2d.QVector2D, zpos: float32): gen_qvector3d_types.QVector3D =

  gen_qvector3d_types.QVector3D.init(fcQVector3D_new7(vector.h, zpos))
proc create2*(T: type gen_qvector3d_types.QVector3D, vector: gen_qvector4d.QVector4D): gen_qvector3d_types.QVector3D =

  gen_qvector3d_types.QVector3D.init(fcQVector3D_new8(vector.h))
proc create2*(T: type gen_qvector3d_types.QVector3D, param1: gen_qvector3d_types.QVector3D): gen_qvector3d_types.QVector3D =
...
proc normalized*(self: gen_qvector3d_types.QVector3D, ): gen_qvector3d_types.QVector3D =
  ...
  gen_qvector3d_types.QVector3D(h: fcQVector3D_normalized(self.h))
...
proc operatorPlusAssign*(self: gen_qvector3d_types.QVector3D, vector: gen_qvector3d_types.QVector3D): gen_qvector3d_types.QVector3D =
  ...
  gen_qvector3d_types.QVector3D(h: fcQVector3D_operatorPlusAssign(self.h, vector.h))
...
proc operatorMinusAssign*(self: gen_qvector3d_types.QVector3D, vector: gen_qvector3d_types.QVector3D): gen_qvector3d_types.QVector3D =
  ...
  gen_qvector3d_types.QVector3D(h: fcQVector3D_operatorMinusAssign(self.h, vector.h))

proc operatorMultiplyAssign*(self: gen_qvector3d_types.QVector3D, factor: float32): gen_qvector3d_types.QVector3D =

  gen_qvector3d_types.QVector3D(h: fcQVector3D_operatorMultiplyAssign(self.h, factor))

proc operatorMultiplyAssignWithVector*(self: gen_qvector3d_types.QVector3D, vector: gen_qvector3d_types.QVector3D): gen_qvector3d_types.QVector3D =

  gen_qvector3d_types.QVector3D(h: fcQVector3D_operatorMultiplyAssignWithVector(self.h, vector.h))

proc operatorDivideAssign*(self: gen_qvector3d_types.QVector3D, divisor: float32): gen_qvector3d_types.QVector3D =

  gen_qvector3d_types.QVector3D(h: fcQVector3D_operatorDivideAssign(self.h, divisor))

proc operatorDivideAssignWithVector*(self: gen_qvector3d_types.QVector3D, vector: gen_qvector3d_types.QVector3D): gen_qvector3d_types.QVector3D =

  gen_qvector3d_types.QVector3D(h: fcQVector3D_operatorDivideAssignWithVector(self.h, vector.h))
...
proc crossProduct*(_: type gen_qvector3d_types.QVector3D, v1: gen_qvector3d_types.QVector3D, v2: gen_qvector3d_types.QVector3D): gen_qvector3d_types.QVector3D =
  ...
  gen_qvector3d_types.QVector3D(h: fcQVector3D_crossProduct(v1.h, v2.h))
...
proc normal*(_: type gen_qvector3d_types.QVector3D, v1: gen_qvector3d_types.QVector3D, v2: gen_qvector3d_types.QVector3D): gen_qvector3d_types.QVector3D =
  ...
  gen_qvector3d_types.QVector3D(h: fcQVector3D_normal(v1.h, v2.h))

proc normal2*(_: type gen_qvector3d_types.QVector3D, v1: gen_qvector3d_types.QVector3D, v2: gen_qvector3d_types.QVector3D, v3: gen_qvector3d_types.QVector3D): gen_qvector3d_types.QVector3D =

  gen_qvector3d_types.QVector3D(h: fcQVector3D_normal2(v1.h, v2.h, v3.h))

proc project*(self: gen_qvector3d_types.QVector3D, modelView: gen_qmatrix4x4.QMatrix4x4, projection: gen_qmatrix4x4.QMatrix4x4, viewport: gen_qrect.QRect): gen_qvector3d_types.QVector3D =

  gen_qvector3d_types.QVector3D(h: fcQVector3D_project(self.h, modelView.h, projection.h, viewport.h))

proc unproject*(self: gen_qvector3d_types.QVector3D, modelView: gen_qmatrix4x4.QMatrix4x4, projection: gen_qmatrix4x4.QMatrix4x4, viewport: gen_qrect.QRect): gen_qvector3d_types.QVector3D =

  gen_qvector3d_types.QVector3D(h: fcQVector3D_unproject(self.h, modelView.h, projection.h, viewport.h))
...
proc distanceToPlane2*(self: gen_qvector3d_types.QVector3D, plane1: gen_qvector3d_types.QVector3D, plane2: gen_qvector3d_types.QVector3D, plane3: gen_qvector3d_types.QVector3D): float32 =
...
proc toVector2D*(self: gen_qvector3d_types.QVector3D, ): gen_qvector2d.QVector2D =

  gen_qvector2d.QVector2D(h: fcQVector3D_toVector2D(self.h))

proc toVector4D*(self: gen_qvector3d_types.QVector3D, ): gen_qvector4d.QVector4D =

  gen_qvector4d.QVector4D(h: fcQVector3D_toVector4D(self.h))

proc toPoint*(self: gen_qvector3d_types.QVector3D, ): gen_qpoint.QPoint =

  gen_qpoint.QPoint(h: fcQVector3D_toPoint(self.h))

proc toPointF*(self: gen_qvector3d_types.QVector3D, ): gen_qpoint.QPointF =

  gen_qpoint.QPointF(h: fcQVector3D_toPointF(self.h))

proc ToQVariant*(self: gen_qvector3d_types.QVector3D, ): gen_qvariant.QVariant =
