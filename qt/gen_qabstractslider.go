...
func (this *QAbstractSlider) Metacall(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {
	return (int)(C.QAbstractSlider_metacall(this.h, (C.int)(param1), (C.int)(param2), param3))
}
...
func (this *QAbstractSlider) callVirtualBase_MetaObject() *QMetaObject {
	...
	return newQMetaObject(C.QAbstractSlider_virtualbase_metaObject(unsafe.Pointer(this.h)))

}
func (this *QAbstractSlider) OnMetaObject(slot func(super func() *QMetaObject) *QMetaObject) {
	ok := C.QAbstractSlider_override_virtual_metaObject(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
...
func miqt_exec_callback_QAbstractSlider_metaObject(self *C.QAbstractSlider, cb C.intptr_t) *C.QMetaObject {
...
func (this *QAbstractSlider) callVirtualBase_Metacast(param1 string) unsafe.Pointer {
	...
	return (unsafe.Pointer)(C.QAbstractSlider_virtualbase_metacast(unsafe.Pointer(this.h), param1_Cstring))

}
func (this *QAbstractSlider) OnMetacast(slot func(super func(param1 string) unsafe.Pointer, param1 string) unsafe.Pointer) {
	ok := C.QAbstractSlider_override_virtual_metacast(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func miqt_exec_callback_QAbstractSlider_metacast(self *C.QAbstractSlider, cb C.intptr_t, param1 *C.const_char) unsafe.Pointer {
...
func (this *QAbstractSlider) callVirtualBase_Metacall(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {

	return (int)(C.QAbstractSlider_virtualbase_metacall(unsafe.Pointer(this.h), (C.int)(param1), (C.int)(param2), param3))

}
func (this *QAbstractSlider) OnMetacall(slot func(super func(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int, param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int) {
	ok := C.QAbstractSlider_override_virtual_metacall(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}

//export miqt_exec_callback_QAbstractSlider_metacall
func miqt_exec_callback_QAbstractSlider_metacall(self *C.QAbstractSlider, cb C.intptr_t, param1 C.int, param2 C.int, param3 unsafe.Pointer) C.int {
	...
	virtualReturn := gofunc((&QAbstractSlider{h: self}).callVirtualBase_Metacall, slotval1, slotval2, slotval3)
...
func (this *QAbstractSlider) callVirtualBase_EnterEvent(event *QEvent) {

	C.QAbstractSlider_virtualbase_enterEvent(unsafe.Pointer(this.h), event.cPointer())

}
func (this *QAbstractSlider) OnEnterEvent(slot func(super func(event *QEvent), event *QEvent)) {
...
func miqt_exec_callback_QAbstractSlider_enterEvent(self *C.QAbstractSlider, cb C.intptr_t, event *C.QEvent) {
...
func (this *QAbstractSlider) OnNativeEvent(slot func(super func(eventType []byte, message unsafe.Pointer, result *int64) bool, eventType []byte, message unsafe.Pointer, result *int64) bool) {
...
func miqt_exec_callback_QAbstractSlider_nativeEvent(self *C.QAbstractSlider, cb C.intptr_t, eventType C.struct_miqt_string, message unsafe.Pointer, result *C.long) C.bool {
