...
proc trUtf82*(_: type gen_qfiledevice_types.QFileDevice, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type gen_qfiledevice_types.QFileDevice, s: cstring, c: cstring, n: cint): string =
