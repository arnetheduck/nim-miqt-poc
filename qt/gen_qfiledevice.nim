...
type QFileDeviceMemoryMapFlags* = cint
const
...
proc trUtf8*(_: type QFileDevice, s: cstring): string =
...
proc trUtf82*(_: type QFileDevice, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type QFileDevice, s: cstring, c: cstring, n: cint): string =
...
proc map3*(self: QFileDevice, offset: clonglong, size: clonglong, flags: QFileDeviceMemoryMapFlags): ptr uint8 =
