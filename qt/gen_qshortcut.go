...
func NewQShortcut3(key *QKeySequence, parent *QWidget, member string) *QShortcut {
	...
	return newQShortcut(C.QShortcut_new3(key.cPointer(), parent.cPointer(), member_Cstring))
}
...
func NewQShortcut4(key *QKeySequence, parent *QWidget, member string, ambiguousMember string) *QShortcut {
	...
	return newQShortcut(C.QShortcut_new4(key.cPointer(), parent.cPointer(), member_Cstring, ambiguousMember_Cstring))
}
...
func NewQShortcut5(key *QKeySequence, parent *QWidget, member string, ambiguousMember string, shortcutContext ShortcutContext) *QShortcut {
	...
	return newQShortcut(C.QShortcut_new5(key.cPointer(), parent.cPointer(), member_Cstring, ambiguousMember_Cstring, (C.int)(shortcutContext)))
}
...
func (this *QShortcut) Metacall(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {
	return (int)(C.QShortcut_metacall(this.h, (C.int)(param1), (C.int)(param2), param3))
}
...
func (this *QShortcut) ParentWidget() *QWidget {
	return newQWidget(C.QShortcut_parentWidget(this.h))
}
...
func (this *QShortcut) callVirtualBase_MetaObject() *QMetaObject {
	...
	return newQMetaObject(C.QShortcut_virtualbase_metaObject(unsafe.Pointer(this.h)))

}
func (this *QShortcut) OnmetaObject(slot func(super func() *QMetaObject) *QMetaObject) {
	ok := C.QShortcut_override_virtual_metaObject(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
...
func miqt_exec_callback_QShortcut_metaObject(self *C.QShortcut, cb C.intptr_t) *C.QMetaObject {
...
func (this *QShortcut) callVirtualBase_Metacast(param1 string) unsafe.Pointer {
	...
	return (unsafe.Pointer)(C.QShortcut_virtualbase_metacast(unsafe.Pointer(this.h), param1_Cstring))

}
func (this *QShortcut) Onmetacast(slot func(super func(param1 string) unsafe.Pointer, param1 string) unsafe.Pointer) {
	ok := C.QShortcut_override_virtual_metacast(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func miqt_exec_callback_QShortcut_metacast(self *C.QShortcut, cb C.intptr_t, param1 *C.const_char) unsafe.Pointer {
...
func (this *QShortcut) callVirtualBase_Metacall(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {

	return (int)(C.QShortcut_virtualbase_metacall(unsafe.Pointer(this.h), (C.int)(param1), (C.int)(param2), param3))

}
func (this *QShortcut) OnMetacall(slot func(super func(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int, param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int) {
	ok := C.QShortcut_override_virtual_metacall(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}

//export miqt_exec_callback_QShortcut_metacall
func miqt_exec_callback_QShortcut_metacall(self *C.QShortcut, cb C.intptr_t, param1 C.int, param2 C.int, param3 unsafe.Pointer) C.int {
	...
	virtualReturn := gofunc((&QShortcut{h: self}).callVirtualBase_Metacall, slotval1, slotval2, slotval3)
