...
proc trUtf8*(_: type QSequentialAnimationGroup, s: cstring): string =
...
proc trUtf82*(_: type QSequentialAnimationGroup, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type QSequentialAnimationGroup, s: cstring, c: cstring, n: cint): string =
