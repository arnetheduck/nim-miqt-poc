...
proc trUtf8*(_: type QToolButton, s: cstring): string =
...
proc trUtf82*(_: type QToolButton, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type QToolButton, s: cstring, c: cstring, n: cint): string =
...
proc callVirtualBase_metaObject(self: QToolButton, ): gen_qobjectdefs.QMetaObject =


  gen_qobjectdefs.QMetaObject(h: fQToolButton_virtualbase_metaObject(self.h))

type QToolButtonmetaObjectBase* = proc(): gen_qobjectdefs.QMetaObject
proc onmetaObject*(self: QToolButton, slot: proc(super: QToolButtonmetaObjectBase): gen_qobjectdefs.QMetaObject) =
  # TODO check subclass
  type Cb = proc(super: QToolButtonmetaObjectBase): gen_qobjectdefs.QMetaObject
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QToolButton_metaObject(self: ptr cQToolButton, slot: int): pointer {.exportc: "miqt_exec_callback_QToolButton_metaObject ".} =
  ...
  proc superCall(): auto =
    callVirtualBase_metaObject(QToolButton(h: self), )

  let virtualReturn = nimfunc[](superCall )

  virtualReturn.h
proc callVirtualBase_metacast(self: QToolButton, param1: cstring): pointer =


  fQToolButton_virtualbase_metacast(self.h, param1)

type QToolButtonmetacastBase* = proc(param1: cstring): pointer
proc onmetacast*(self: QToolButton, slot: proc(super: QToolButtonmetacastBase, param1: cstring): pointer) =
  # TODO check subclass
  type Cb = proc(super: QToolButtonmetacastBase, param1: cstring): pointer
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QToolButton_metacast(self: ptr cQToolButton, slot: int, param1: cstring): pointer {.exportc: "miqt_exec_callback_QToolButton_metacast ".} =
  ...
  proc superCall(param1: cstring): auto =
    callVirtualBase_metacast(QToolButton(h: self), param1)
  let slotval1 = (param1)
...
proc miqt_exec_callback_QToolButton_actionEvent(self: ptr cQToolButton, slot: int, param1: pointer): void {.exportc: "miqt_exec_callback_QToolButton_actionEvent ".} =
  ...
  nimfunc[](superCall, slotval1)
proc callVirtualBase_enterEvent(self: QToolButton, param1: gen_qcoreevent.QEvent): void =


  fQToolButton_virtualbase_enterEvent(self.h, param1.h)

type QToolButtonenterEventBase* = proc(param1: gen_qcoreevent.QEvent): void
proc onenterEvent*(self: QToolButton, slot: proc(super: QToolButtonenterEventBase, param1: gen_qcoreevent.QEvent): void) =
  # TODO check subclass
  type Cb = proc(super: QToolButtonenterEventBase, param1: gen_qcoreevent.QEvent): void
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QToolButton_hideEvent(self: ptr cQToolButton, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QToolButton_hideEvent ".} =
  ...
  nimfunc[](superCall, slotval1)
proc callVirtualBase_nativeEvent(self: QToolButton, eventType: seq[byte], message: pointer, resultVal: ptr clong): bool =
...
type QToolButtonnativeEventBase* = proc(eventType: seq[byte], message: pointer, resultVal: ptr clong): bool
proc onnativeEvent*(self: QToolButton, slot: proc(super: QToolButtonnativeEventBase, eventType: seq[byte], message: pointer, resultVal: ptr clong): bool) =
  # TODO check subclass
  type Cb = proc(super: QToolButtonnativeEventBase, eventType: seq[byte], message: pointer, resultVal: ptr clong): bool
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
