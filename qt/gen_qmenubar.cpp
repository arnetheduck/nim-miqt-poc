...
public:
	...
	int virtualbase_metacall(int param1, int param2, void** param3) {
		...
		return QMenuBar::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
	...
	// Wrapper to allow calling protected method
	void protectedbase_initStyleOption(QStyleOptionMenuItem* option, QAction* action) const {
...
int QMenuBar_virtualbase_metacall(void* self, int param1, int param2, void** param3) {
	return ( (MiqtVirtualQMenuBar*)(self) )->virtualbase_metacall(param1, param2, param3);
}
...
void QMenuBar_protectedbase_initStyleOption(const void* self, QStyleOptionMenuItem* option, QAction* action) {
	( (const MiqtVirtualQMenuBar*)(self) )->protectedbase_initStyleOption(option, action);
}
