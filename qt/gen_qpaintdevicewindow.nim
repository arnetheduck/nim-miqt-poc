...
proc trUtf8*(_: type QPaintDeviceWindow, s: cstring): string =
...
proc trUtf82*(_: type QPaintDeviceWindow, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type QPaintDeviceWindow, s: cstring, c: cstring, n: cint): string =
