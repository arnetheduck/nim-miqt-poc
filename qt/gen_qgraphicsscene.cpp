...
public:
	...
	QMetaObject* virtualbase_metaObject() const {
		...
		return (QMetaObject*) QGraphicsScene::metaObject();
	...
	int virtualbase_metacall(int param1, int param2, void** param3) {
		...
		return QGraphicsScene::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
	...
	// Wrapper to allow calling protected method
	bool protectedbase_focusNextPrevChild(bool next) {
...
QMetaObject* QGraphicsScene_virtualbase_metaObject(const void* self) {
	return ( (const MiqtVirtualQGraphicsScene*)(self) )->virtualbase_metaObject();
}

void* QGraphicsScene_virtualbase_metacast(void* self, const char* param1) {
	return ( (MiqtVirtualQGraphicsScene*)(self) )->virtualbase_metacast(param1);
}

int QGraphicsScene_virtualbase_metacall(void* self, int param1, int param2, void** param3) {
	return ( (MiqtVirtualQGraphicsScene*)(self) )->virtualbase_metacall(param1, param2, param3);
}
...
bool QGraphicsScene_protectedbase_focusNextPrevChild(void* self, bool next) {
	return ( (MiqtVirtualQGraphicsScene*)(self) )->protectedbase_focusNextPrevChild(next);
}
