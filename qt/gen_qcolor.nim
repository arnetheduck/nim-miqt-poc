...
proc create2*(T: type QColor, color: QColor): QColor =

  QColor.init(fcQColor_new9(color.h))
proc create*(T: type QColor, spec: QColorSpec, a1: cushort, a2: cushort, a3: cushort, a4: cushort): QColor =

  QColor.init(fcQColor_new10(cint(spec), a1, a2, a3, a4))
...
proc operatorAssign*(self: QColor, param1: QColor): void =

  fcQColor_operatorAssign(self.h, param1.h)

proc operatorAssignWithColor*(self: QColor, color: gen_qnamespace.GlobalColor): void =
...
proc nameWithFormat*(self: QColor, format: QColorNameFormat): string =
...
proc alphaF*(self: QColor, ): float64 =

  fcQColor_alphaF(self.h)

proc setAlphaF*(self: QColor, alpha: float64): void =
...
proc redF*(self: QColor, ): float64 =

  fcQColor_redF(self.h)

proc greenF*(self: QColor, ): float64 =

  fcQColor_greenF(self.h)

proc blueF*(self: QColor, ): float64 =

  fcQColor_blueF(self.h)

proc setRedF*(self: QColor, red: float64): void =

  fcQColor_setRedF(self.h, red)

proc setGreenF*(self: QColor, green: float64): void =

  fcQColor_setGreenF(self.h, green)

proc setBlueF*(self: QColor, blue: float64): void =
...
proc getRgbF*(self: QColor, r: ptr float64, g: ptr float64, b: ptr float64): void =

  fcQColor_getRgbF(self.h, r, g, b)

proc setRgbF*(self: QColor, r: float64, g: float64, b: float64): void =
...
proc hueF*(self: QColor, ): float64 =

  fcQColor_hueF(self.h)

proc saturationF*(self: QColor, ): float64 =

  fcQColor_saturationF(self.h)

proc hsvHueF*(self: QColor, ): float64 =

  fcQColor_hsvHueF(self.h)

proc hsvSaturationF*(self: QColor, ): float64 =

  fcQColor_hsvSaturationF(self.h)

proc valueF*(self: QColor, ): float64 =
...
proc getHsvF*(self: QColor, h: ptr float64, s: ptr float64, v: ptr float64): void =

  fcQColor_getHsvF(self.h, h, s, v)

proc setHsvF*(self: QColor, h: float64, s: float64, v: float64): void =
...
proc cyanF*(self: QColor, ): float64 =

  fcQColor_cyanF(self.h)

proc magentaF*(self: QColor, ): float64 =

  fcQColor_magentaF(self.h)

proc yellowF*(self: QColor, ): float64 =

  fcQColor_yellowF(self.h)

proc blackF*(self: QColor, ): float64 =
...
proc getCmyk2*(self: QColor, c: ptr cint, m: ptr cint, y: ptr cint, k: ptr cint): void =
...
proc getCmykF*(self: QColor, c: ptr float64, m: ptr float64, y: ptr float64, k: ptr float64): void =

  fcQColor_getCmykF(self.h, c, m, y, k)

proc getCmykF2*(self: QColor, c: ptr float64, m: ptr float64, y: ptr float64, k: ptr float64): void =

  fcQColor_getCmykF2(self.h, c, m, y, k)

proc setCmykF*(self: QColor, c: float64, m: float64, y: float64, k: float64): void =
...
proc hslHueF*(self: QColor, ): float64 =

  fcQColor_hslHueF(self.h)

proc hslSaturationF*(self: QColor, ): float64 =

  fcQColor_hslSaturationF(self.h)

proc lightnessF*(self: QColor, ): float64 =
...
proc getHslF*(self: QColor, h: ptr float64, s: ptr float64, l: ptr float64): void =

  fcQColor_getHslF(self.h, h, s, l)

proc setHslF*(self: QColor, h: float64, s: float64, l: float64): void =
...
proc fromRgbF*(_: type QColor, r: float64, g: float64, b: float64): QColor =
...
proc fromHsvF*(_: type QColor, h: float64, s: float64, v: float64): QColor =
...
proc fromCmykF*(_: type QColor, c: float64, m: float64, y: float64, k: float64): QColor =
...
proc fromHslF*(_: type QColor, h: float64, s: float64, l: float64): QColor =

  QColor(h: fcQColor_fromHslF(h, s, l))

proc light*(self: QColor, ): QColor =

  QColor(h: fcQColor_light(self.h))

proc dark*(self: QColor, ): QColor =

  QColor(h: fcQColor_dark(self.h))
...
proc getRgbF4*(self: QColor, r: ptr float64, g: ptr float64, b: ptr float64, a: ptr float64): void =

  fcQColor_getRgbF4(self.h, r, g, b, a)

proc setRgbF4*(self: QColor, r: float64, g: float64, b: float64, a: float64): void =
...
proc getHsvF4*(self: QColor, h: ptr float64, s: ptr float64, v: ptr float64, a: ptr float64): void =

  fcQColor_getHsvF4(self.h, h, s, v, a)

proc setHsvF4*(self: QColor, h: float64, s: float64, v: float64, a: float64): void =
...
proc getCmyk52*(self: QColor, c: ptr cint, m: ptr cint, y: ptr cint, k: ptr cint, a: ptr cint): void =
...
proc getCmykF5*(self: QColor, c: ptr float64, m: ptr float64, y: ptr float64, k: ptr float64, a: ptr float64): void =

  fcQColor_getCmykF5(self.h, c, m, y, k, a)

proc getCmykF52*(self: QColor, c: ptr float64, m: ptr float64, y: ptr float64, k: ptr float64, a: ptr float64): void =

  fcQColor_getCmykF52(self.h, c, m, y, k, a)

proc setCmykF5*(self: QColor, c: float64, m: float64, y: float64, k: float64, a: float64): void =
...
proc getHslF4*(self: QColor, h: ptr float64, s: ptr float64, l: ptr float64, a: ptr float64): void =

  fcQColor_getHslF4(self.h, h, s, l, a)

proc setHslF4*(self: QColor, h: float64, s: float64, l: float64, a: float64): void =
...
proc fromRgbF4*(_: type QColor, r: float64, g: float64, b: float64, a: float64): QColor =
...
proc fromHsvF4*(_: type QColor, h: float64, s: float64, v: float64, a: float64): QColor =
...
proc fromCmykF5*(_: type QColor, c: float64, m: float64, y: float64, k: float64, a: float64): QColor =
...
proc fromHslF4*(_: type QColor, h: float64, s: float64, l: float64, a: float64): QColor =

  QColor(h: fcQColor_fromHslF4(h, s, l, a))

proc light1*(self: QColor, f: cint): QColor =

  QColor(h: fcQColor_light1(self.h, f))

proc dark1*(self: QColor, f: cint): QColor =

  QColor(h: fcQColor_dark1(self.h, f))
