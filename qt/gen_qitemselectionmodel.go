...
func NewQItemSelectionRange2(other *QItemSelectionRange) *QItemSelectionRange {
	...
	return newQItemSelectionRange(C.QItemSelectionRange_new2(other.cPointer()))
}
...
func NewQItemSelectionRange3(topL *QModelIndex, bottomR *QModelIndex) *QItemSelectionRange {
	...
	return newQItemSelectionRange(C.QItemSelectionRange_new3(topL.cPointer(), bottomR.cPointer()))
}
...
func NewQItemSelectionRange4(index *QModelIndex) *QItemSelectionRange {
	...
	return newQItemSelectionRange(C.QItemSelectionRange_new4(index.cPointer()))
}
...
func (this *QItemSelectionModel) Metacall(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {
	return (int)(C.QItemSelectionModel_metacall(this.h, (C.int)(param1), (C.int)(param2), param3))
}
...
func miqt_exec_callback_QItemSelectionModel_metaObject(self *C.QItemSelectionModel, cb C.intptr_t) *C.QMetaObject {
...
func miqt_exec_callback_QItemSelectionModel_metacast(self *C.QItemSelectionModel, cb C.intptr_t, param1 *C.const_char) unsafe.Pointer {
...
func (this *QItemSelectionModel) callVirtualBase_Metacall(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {

	return (int)(C.QItemSelectionModel_virtualbase_metacall(unsafe.Pointer(this.h), (C.int)(param1), (C.int)(param2), param3))

}
func (this *QItemSelectionModel) OnMetacall(slot func(super func(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int, param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int) {
	ok := C.QItemSelectionModel_override_virtual_metacall(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}

//export miqt_exec_callback_QItemSelectionModel_metacall
func miqt_exec_callback_QItemSelectionModel_metacall(self *C.QItemSelectionModel, cb C.intptr_t, param1 C.int, param2 C.int, param3 unsafe.Pointer) C.int {
	...
	virtualReturn := gofunc((&QItemSelectionModel{h: self}).callVirtualBase_Metacall, slotval1, slotval2, slotval3)
...
func NewQItemSelection() *QItemSelection {
	...
	return newQItemSelection(C.QItemSelection_new())
}

// NewQItemSelection2 constructs a new QItemSelection object.
func NewQItemSelection2(topLeft *QModelIndex, bottomRight *QModelIndex) *QItemSelection {
...
func (this *QItemSelection) OperatorAssign(param1 *QItemSelection) {
	C.QItemSelection_operatorAssign(this.h, param1.cPointer())
}
