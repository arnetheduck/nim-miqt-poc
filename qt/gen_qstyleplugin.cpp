...
public:
	...
	MiqtVirtualQStylePlugin(struct QStylePlugin_VTable* vtbl): QStylePlugin(), vtbl(vtbl) {};
	MiqtVirtualQStylePlugin(struct QStylePlugin_VTable* vtbl, QObject* parent): QStylePlugin(parent), vtbl(vtbl) {};

	virtual ~MiqtVirtualQStylePlugin() override { if(vtbl->destructor) vtbl->destructor(vtbl, this); }
	...
	int virtualbase_metacall(int param1, int param2, void** param3) {
		...
		return QStylePlugin::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
QStylePlugin* QStylePlugin_new(struct QStylePlugin_VTable* vtbl) {
	return new MiqtVirtualQStylePlugin(vtbl);
}

QStylePlugin* QStylePlugin_new2(struct QStylePlugin_VTable* vtbl, QObject* parent) {
	return new MiqtVirtualQStylePlugin(vtbl, parent);
}
...
int QStylePlugin_virtualbase_metacall(void* self, int param1, int param2, void** param3) {
	return ( (MiqtVirtualQStylePlugin*)(self) )->virtualbase_metacall(param1, param2, param3);
}
...
QObject* QStylePlugin_protectedbase_sender(const void* self) {
	return ( (const MiqtVirtualQStylePlugin*)(self) )->protectedbase_sender();
}

int QStylePlugin_protectedbase_senderSignalIndex(const void* self) {
	return ( (const MiqtVirtualQStylePlugin*)(self) )->protectedbase_senderSignalIndex();
}

int QStylePlugin_protectedbase_receivers(const void* self, const char* signal) {
	return ( (const MiqtVirtualQStylePlugin*)(self) )->protectedbase_receivers(signal);
}

bool QStylePlugin_protectedbase_isSignalConnected(const void* self, QMetaMethod* signal) {
	return ( (const MiqtVirtualQStylePlugin*)(self) )->protectedbase_isSignalConnected(signal);
}
