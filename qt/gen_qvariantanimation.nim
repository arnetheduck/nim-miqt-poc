...
proc trUtf8*(_: type QVariantAnimation, s: cstring): string =
...
proc trUtf82*(_: type QVariantAnimation, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type QVariantAnimation, s: cstring, c: cstring, n: cint): string =
