...
proc indexIn*(self: gen_qstringmatcher_types.QStringMatcher, str: gen_qchar.QChar, length: cint): cint =
...
proc indexIn*(self: gen_qstringmatcher_types.QStringMatcher, str: gen_qchar.QChar, length: cint, fromVal: cint): cint =
