...
proc trUtf8*(_: type QAbstractButton, s: cstring): string =
...
proc trUtf82*(_: type QAbstractButton, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type QAbstractButton, s: cstring, c: cstring, n: cint): string =
...
proc animateClick1*(self: QAbstractButton, msec: cint): void =
...
proc miqt_exec_callback_QAbstractButton_wheelEvent(self: ptr cQAbstractButton, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QAbstractButton_wheelEvent ".} =
  ...
  nimfunc[](superCall, slotval1)
proc callVirtualBase_enterEvent(self: QAbstractButton, event: gen_qcoreevent.QEvent): void =


  fQAbstractButton_virtualbase_enterEvent(self.h, event.h)

type QAbstractButtonenterEventBase* = proc(event: gen_qcoreevent.QEvent): void
proc onenterEvent*(self: QAbstractButton, slot: proc(super: QAbstractButtonenterEventBase, event: gen_qcoreevent.QEvent): void) =
  # TODO check subclass
  type Cb = proc(super: QAbstractButtonenterEventBase, event: gen_qcoreevent.QEvent): void
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QAbstractButton_hideEvent(self: ptr cQAbstractButton, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QAbstractButton_hideEvent ".} =
  ...
  nimfunc[](superCall, slotval1)
proc callVirtualBase_nativeEvent(self: QAbstractButton, eventType: seq[byte], message: pointer, resultVal: ptr clong): bool =
...
type QAbstractButtonnativeEventBase* = proc(eventType: seq[byte], message: pointer, resultVal: ptr clong): bool
proc onnativeEvent*(self: QAbstractButton, slot: proc(super: QAbstractButtonnativeEventBase, eventType: seq[byte], message: pointer, resultVal: ptr clong): bool) =
  # TODO check subclass
  type Cb = proc(super: QAbstractButtonnativeEventBase, eventType: seq[byte], message: pointer, resultVal: ptr clong): bool
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
