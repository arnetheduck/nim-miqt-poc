...
public:
	...
	QMetaObject* virtualbase_metaObject() const {
		...
		return (QMetaObject*) QAbstractItemDelegate::metaObject();
...
QMetaObject* QAbstractItemDelegate_virtualbase_metaObject(const void* self) {
	return ( (const MiqtVirtualQAbstractItemDelegate*)(self) )->virtualbase_metaObject();
}

void* QAbstractItemDelegate_virtualbase_metacast(void* self, const char* param1) {
	return ( (MiqtVirtualQAbstractItemDelegate*)(self) )->virtualbase_metacast(param1);
}
...
QObject* QAbstractItemDelegate_protectedbase_sender(const void* self) {
	return ( (const MiqtVirtualQAbstractItemDelegate*)(self) )->protectedbase_sender();
}

int QAbstractItemDelegate_protectedbase_senderSignalIndex(const void* self) {
	return ( (const MiqtVirtualQAbstractItemDelegate*)(self) )->protectedbase_senderSignalIndex();
}

int QAbstractItemDelegate_protectedbase_receivers(const void* self, const char* signal) {
	return ( (const MiqtVirtualQAbstractItemDelegate*)(self) )->protectedbase_receivers(signal);
}

bool QAbstractItemDelegate_protectedbase_isSignalConnected(const void* self, QMetaMethod* signal) {
	return ( (const MiqtVirtualQAbstractItemDelegate*)(self) )->protectedbase_isSignalConnected(signal);
}
