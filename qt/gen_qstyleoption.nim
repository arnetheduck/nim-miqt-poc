...
const
  QStyleOptionTabWidgetFrameVersion* = 2
...
const
  QStyleOptionTabBarBaseVersion* = 2
...
type QStyleOptionTabV4StyleOptionVersion* = cint
const
  QStyleOptionTabV4Version* = 4
...
const
  QStyleOptionProgressBarVersion* = 2
...
const
  QStyleOptionDockWidgetVersion* = 2
...
proc init*(self: QStyleOption, w: gen_qwidget.QWidget): void =
...
func init*(T: type QStyleOptionTabV4, h: ptr cQStyleOptionTabV4): QStyleOptionTabV4 =
  T(h: h)
proc create*(T: type QStyleOptionTabV4, ): QStyleOptionTabV4 =

  QStyleOptionTabV4.init(fcQStyleOptionTabV4_new())
proc create*(T: type QStyleOptionTabV4, param1: QStyleOptionTabV4): QStyleOptionTabV4 =

  QStyleOptionTabV4.init(fcQStyleOptionTabV4_new2(param1.h))
proc operatorAssign*(self: QStyleOptionTabV4, param1: QStyleOptionTabV4): void =

  fcQStyleOptionTabV4_operatorAssign(self.h, param1.h)

proc delete*(self: QStyleOptionTabV4) =
