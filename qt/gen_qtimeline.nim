...
type QTimeLineCurveShape* = cint
const
  QTimeLineEaseInCurve* = 0
  QTimeLineEaseOutCurve* = 1
  QTimeLineEaseInOutCurve* = 2
  QTimeLineLinearCurve* = 3
  QTimeLineSineCurve* = 4
  QTimeLineCosineCurve* = 5
...
proc trUtf8*(_: type QTimeLine, s: cstring): string =
...
proc curveShape*(self: QTimeLine, ): QTimeLineCurveShape =

  QTimeLineCurveShape(fcQTimeLine_curveShape(self.h))

proc setCurveShape*(self: QTimeLine, shape: QTimeLineCurveShape): void =
...
proc trUtf82*(_: type QTimeLine, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type QTimeLine, s: cstring, c: cstring, n: cint): string =
