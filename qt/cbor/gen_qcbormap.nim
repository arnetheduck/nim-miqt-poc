...
proc operatorMultiply*(self: QCborMapIterator, ): tuple[first: gen_qcborvalue.QCborValueRef, second: gen_qcborvalue.QCborValueRef] =
  ...
  var v_entry_First = gen_qcborvalue.QCborValueRef(h: v_First_CArray[0])
...
proc operatorMultiply*(self: QCborMapConstIterator, ): tuple[first: gen_qcborvalue.QCborValueRef, second: gen_qcborvalue.QCborValueRef] =
...
proc operatorMinusGreater*(self: QCborMapConstIterator, ): gen_qcborvalue.QCborValueRef =

  gen_qcborvalue.QCborValueRef(h: fcQCborMapConstIterator_operatorMinusGreater(self.h))
...
proc value*(self: QCborMapConstIterator, ): gen_qcborvalue.QCborValueRef =

  gen_qcborvalue.QCborValueRef(h: fcQCborMapConstIterator_value(self.h))
