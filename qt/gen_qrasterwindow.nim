...
proc fcQRasterWindow_virtualbase_nativeEvent(self: pointer, eventType: struct_miqt_string, message: pointer, resultVal: ptr clong): bool {.importc: "QRasterWindow_virtualbase_nativeEvent".}
...
type QRasterWindownativeEventProc* = proc(self: QRasterWindow, eventType: seq[byte], message: pointer, resultVal: ptr clong): bool {.raises: [], gcsafe.}
...
proc miqt_exec_callback_cQRasterWindow_nativeEvent(vtbl: pointer, self: pointer, eventType: struct_miqt_string, message: pointer, resultVal: ptr clong): bool {.cdecl.} =
  let vtbl = cast[ptr QRasterWindowVTable](vtbl)
  let self = QRasterWindow(h: self)
