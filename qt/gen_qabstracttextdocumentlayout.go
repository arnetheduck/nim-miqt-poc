...
func (this *QAbstractTextDocumentLayout) callVirtualBase_MetaObject() *QMetaObject {
	...
	return newQMetaObject(C.QAbstractTextDocumentLayout_virtualbase_metaObject(unsafe.Pointer(this.h)))

}
func (this *QAbstractTextDocumentLayout) OnMetaObject(slot func(super func() *QMetaObject) *QMetaObject) {
	ok := C.QAbstractTextDocumentLayout_override_virtual_metaObject(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
...
func miqt_exec_callback_QAbstractTextDocumentLayout_metaObject(self *C.QAbstractTextDocumentLayout, cb C.intptr_t) *C.QMetaObject {
...
func (this *QAbstractTextDocumentLayout) callVirtualBase_Metacast(param1 string) unsafe.Pointer {
	...
	return (unsafe.Pointer)(C.QAbstractTextDocumentLayout_virtualbase_metacast(unsafe.Pointer(this.h), param1_Cstring))
...
func (this *QAbstractTextDocumentLayout) OnMetacast(slot func(super func(param1 string) unsafe.Pointer, param1 string) unsafe.Pointer) {
	ok := C.QAbstractTextDocumentLayout_override_virtual_metacast(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func miqt_exec_callback_QAbstractTextDocumentLayout_metacast(self *C.QAbstractTextDocumentLayout, cb C.intptr_t, param1 *C.const_char) unsafe.Pointer {
