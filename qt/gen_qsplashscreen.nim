...
func init*(T: type QSplashScreen, h: ptr cQSplashScreen): QSplashScreen =
  T(h: h)
proc create*(T: type QSplashScreen, parent: gen_qwidget.QWidget): QSplashScreen =

  QSplashScreen.init(fcQSplashScreen_new(parent.h))
proc create*(T: type QSplashScreen, ): QSplashScreen =

  QSplashScreen.init(fcQSplashScreen_new2())
proc create2*(T: type QSplashScreen, screen: gen_qscreen.QScreen): QSplashScreen =

  QSplashScreen.init(fcQSplashScreen_new3(screen.h))
proc create2*(T: type QSplashScreen, pixmap: gen_qpixmap.QPixmap): QSplashScreen =

  QSplashScreen.init(fcQSplashScreen_new4(pixmap.h))
proc create*(T: type QSplashScreen, pixmap: gen_qpixmap.QPixmap, f: gen_qnamespace.WindowType): QSplashScreen =

  QSplashScreen.init(fcQSplashScreen_new5(pixmap.h, cint(f)))
proc create*(T: type QSplashScreen, screen: gen_qscreen.QScreen, pixmap: gen_qpixmap.QPixmap): QSplashScreen =

  QSplashScreen.init(fcQSplashScreen_new6(screen.h, pixmap.h))
proc create*(T: type QSplashScreen, screen: gen_qscreen.QScreen, pixmap: gen_qpixmap.QPixmap, f: gen_qnamespace.WindowType): QSplashScreen =
  ...
  QSplashScreen.init(fcQSplashScreen_new7(screen.h, pixmap.h, cint(f)))
proc create2*(T: type QSplashScreen, parent: gen_qwidget.QWidget, pixmap: gen_qpixmap.QPixmap): QSplashScreen =

  QSplashScreen.init(fcQSplashScreen_new8(parent.h, pixmap.h))
proc create2*(T: type QSplashScreen, parent: gen_qwidget.QWidget, pixmap: gen_qpixmap.QPixmap, f: gen_qnamespace.WindowType): QSplashScreen =

  QSplashScreen.init(fcQSplashScreen_new9(parent.h, pixmap.h, cint(f)))
...
proc trUtf8*(_: type QSplashScreen, s: cstring): string =
...
proc trUtf82*(_: type QSplashScreen, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type QSplashScreen, s: cstring, c: cstring, n: cint): string =
...
proc miqt_exec_callback_QSplashScreen_focusOutEvent(self: ptr cQSplashScreen, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QSplashScreen_focusOutEvent ".} =
  ...
  nimfunc[](superCall, slotval1)
proc callVirtualBase_enterEvent(self: QSplashScreen, event: gen_qcoreevent.QEvent): void =


  fQSplashScreen_virtualbase_enterEvent(self.h, event.h)

type QSplashScreenenterEventBase* = proc(event: gen_qcoreevent.QEvent): void
proc onenterEvent*(self: QSplashScreen, slot: proc(super: QSplashScreenenterEventBase, event: gen_qcoreevent.QEvent): void) =
  # TODO check subclass
  type Cb = proc(super: QSplashScreenenterEventBase, event: gen_qcoreevent.QEvent): void
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QSplashScreen_hideEvent(self: ptr cQSplashScreen, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QSplashScreen_hideEvent ".} =
  ...
  nimfunc[](superCall, slotval1)
proc callVirtualBase_nativeEvent(self: QSplashScreen, eventType: seq[byte], message: pointer, resultVal: ptr clong): bool =
...
type QSplashScreennativeEventBase* = proc(eventType: seq[byte], message: pointer, resultVal: ptr clong): bool
proc onnativeEvent*(self: QSplashScreen, slot: proc(super: QSplashScreennativeEventBase, eventType: seq[byte], message: pointer, resultVal: ptr clong): bool) =
  # TODO check subclass
  type Cb = proc(super: QSplashScreennativeEventBase, eventType: seq[byte], message: pointer, resultVal: ptr clong): bool
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
