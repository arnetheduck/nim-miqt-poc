...
proc trUtf82*(_: type gen_qstyleditemdelegate_types.QStyledItemDelegate, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type gen_qstyleditemdelegate_types.QStyledItemDelegate, s: cstring, c: cstring, n: cint): string =
...
type QStyledItemDelegatedisplayTextProc* = proc(value: gen_qvariant.QVariant, locale: gen_qlocale.QLocale): string
