...
func (this *QMdiSubWindow) Metacall(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {
	return (int)(C.QMdiSubWindow_metacall(this.h, (C.int)(param1), (C.int)(param2), param3))
}
...
func (this *QMdiSubWindow) callVirtualBase_MetaObject() *QMetaObject {
	...
	return newQMetaObject(C.QMdiSubWindow_virtualbase_metaObject(unsafe.Pointer(this.h)))

}
func (this *QMdiSubWindow) OnMetaObject(slot func(super func() *QMetaObject) *QMetaObject) {
	ok := C.QMdiSubWindow_override_virtual_metaObject(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
...
func miqt_exec_callback_QMdiSubWindow_metaObject(self *C.QMdiSubWindow, cb C.intptr_t) *C.QMetaObject {
...
func (this *QMdiSubWindow) callVirtualBase_Metacast(param1 string) unsafe.Pointer {
	...
	return (unsafe.Pointer)(C.QMdiSubWindow_virtualbase_metacast(unsafe.Pointer(this.h), param1_Cstring))

}
func (this *QMdiSubWindow) OnMetacast(slot func(super func(param1 string) unsafe.Pointer, param1 string) unsafe.Pointer) {
	ok := C.QMdiSubWindow_override_virtual_metacast(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func miqt_exec_callback_QMdiSubWindow_metacast(self *C.QMdiSubWindow, cb C.intptr_t, param1 *C.const_char) unsafe.Pointer {
...
func (this *QMdiSubWindow) callVirtualBase_Metacall(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {

	return (int)(C.QMdiSubWindow_virtualbase_metacall(unsafe.Pointer(this.h), (C.int)(param1), (C.int)(param2), param3))

}
func (this *QMdiSubWindow) OnMetacall(slot func(super func(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int, param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int) {
	ok := C.QMdiSubWindow_override_virtual_metacall(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}

//export miqt_exec_callback_QMdiSubWindow_metacall
func miqt_exec_callback_QMdiSubWindow_metacall(self *C.QMdiSubWindow, cb C.intptr_t, param1 C.int, param2 C.int, param3 unsafe.Pointer) C.int {
	...
	virtualReturn := gofunc((&QMdiSubWindow{h: self}).callVirtualBase_Metacall, slotval1, slotval2, slotval3)
...
func (this *QMdiSubWindow) callVirtualBase_EnterEvent(event *QEvent) {
...
func miqt_exec_callback_QMdiSubWindow_enterEvent(self *C.QMdiSubWindow, cb C.intptr_t, event *C.QEvent) {
...
func miqt_exec_callback_QMdiSubWindow_nativeEvent(self *C.QMdiSubWindow, cb C.intptr_t, eventType C.struct_miqt_string, message unsafe.Pointer, result *C.long) C.bool {
