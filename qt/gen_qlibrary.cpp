...
QObject* QLibrary_protectedbase_sender(const void* self) {
	return ( (const MiqtVirtualQLibrary*)(self) )->protectedbase_sender();
}

int QLibrary_protectedbase_senderSignalIndex(const void* self) {
	return ( (const MiqtVirtualQLibrary*)(self) )->protectedbase_senderSignalIndex();
}

int QLibrary_protectedbase_receivers(const void* self, const char* signal) {
	return ( (const MiqtVirtualQLibrary*)(self) )->protectedbase_receivers(signal);
}

bool QLibrary_protectedbase_isSignalConnected(const void* self, QMetaMethod* signal) {
	return ( (const MiqtVirtualQLibrary*)(self) )->protectedbase_isSignalConnected(signal);
}
