...
proc trUtf82*(_: type gen_qtexttable_types.QTextTable, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type gen_qtexttable_types.QTextTable, s: cstring, c: cstring, n: cint): string =
