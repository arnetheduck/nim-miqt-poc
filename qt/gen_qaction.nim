...
proc menu*(self: gen_qaction_types.QAction, ): gen_qmenu.QMenu =

  gen_qmenu.QMenu(h: fcQAction_menu(self.h))

proc setMenu*(self: gen_qaction_types.QAction, menu: gen_qmenu.QMenu): void =
...
proc parentWidget*(self: gen_qaction_types.QAction, ): gen_qwidget.QWidget =

  gen_qwidget.QWidget(h: fcQAction_parentWidget(self.h))

proc associatedWidgets*(self: gen_qaction_types.QAction, ): seq[gen_qwidget.QWidget] =
...
proc associatedGraphicsWidgets*(self: gen_qaction_types.QAction, ): seq[gen_qgraphicswidget.QGraphicsWidget] =

  var v_ma = fcQAction_associatedGraphicsWidgets(self.h)
  var vx_ret = newSeq[gen_qgraphicswidget.QGraphicsWidget](int(v_ma.len))
  let v_outCast = cast[ptr UncheckedArray[pointer]](v_ma.data)
  for i in 0 ..< v_ma.len:
    vx_ret[i] = gen_qgraphicswidget.QGraphicsWidget(h: v_outCast[i])
  vx_ret
...
proc trUtf82*(_: type gen_qaction_types.QAction, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type gen_qaction_types.QAction, s: cstring, c: cstring, n: cint): string =
...
proc showStatusText1*(self: gen_qaction_types.QAction, widget: gen_qwidget.QWidget): bool =
