...
proc trUtf8*(_: type QAction, s: cstring): string =
...
proc menu*(self: QAction, ): gen_qmenu.QMenu =

  gen_qmenu.QMenu(h: fcQAction_menu(self.h))

proc setMenu*(self: QAction, menu: gen_qmenu.QMenu): void =
...
proc parentWidget*(self: QAction, ): gen_qwidget.QWidget =

  gen_qwidget.QWidget(h: fcQAction_parentWidget(self.h))

proc associatedWidgets*(self: QAction, ): seq[gen_qwidget.QWidget] =
...
proc associatedGraphicsWidgets*(self: QAction, ): seq[gen_qgraphicswidget.QGraphicsWidget] =
...
proc trUtf82*(_: type QAction, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type QAction, s: cstring, c: cstring, n: cint): string =
...
proc showStatusText1*(self: QAction, widget: gen_qwidget.QWidget): bool =
