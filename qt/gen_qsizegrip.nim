...
proc trUtf8*(_: type QSizeGrip, s: cstring): string =
...
proc trUtf82*(_: type QSizeGrip, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type QSizeGrip, s: cstring, c: cstring, n: cint): string =
...
proc callVirtualBase_metaObject(self: QSizeGrip, ): gen_qobjectdefs.QMetaObject =


  gen_qobjectdefs.QMetaObject(h: fQSizeGrip_virtualbase_metaObject(self.h))

type QSizeGripmetaObjectBase* = proc(): gen_qobjectdefs.QMetaObject
proc onmetaObject*(self: QSizeGrip, slot: proc(super: QSizeGripmetaObjectBase): gen_qobjectdefs.QMetaObject) =
  # TODO check subclass
  type Cb = proc(super: QSizeGripmetaObjectBase): gen_qobjectdefs.QMetaObject
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QSizeGrip_metaObject(self: ptr cQSizeGrip, slot: int): pointer {.exportc: "miqt_exec_callback_QSizeGrip_metaObject ".} =
  ...
  proc superCall(): auto =
    callVirtualBase_metaObject(QSizeGrip(h: self), )

  let virtualReturn = nimfunc[](superCall )

  virtualReturn.h
proc callVirtualBase_metacast(self: QSizeGrip, param1: cstring): pointer =


  fQSizeGrip_virtualbase_metacast(self.h, param1)

type QSizeGripmetacastBase* = proc(param1: cstring): pointer
proc onmetacast*(self: QSizeGrip, slot: proc(super: QSizeGripmetacastBase, param1: cstring): pointer) =
  # TODO check subclass
  type Cb = proc(super: QSizeGripmetacastBase, param1: cstring): pointer
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QSizeGrip_metacast(self: ptr cQSizeGrip, slot: int, param1: cstring): pointer {.exportc: "miqt_exec_callback_QSizeGrip_metacast ".} =
  ...
  proc superCall(param1: cstring): auto =
    callVirtualBase_metacast(QSizeGrip(h: self), param1)
  let slotval1 = (param1)
...
proc miqt_exec_callback_QSizeGrip_focusOutEvent(self: ptr cQSizeGrip, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QSizeGrip_focusOutEvent ".} =
  ...
  nimfunc[](superCall, slotval1)
proc callVirtualBase_enterEvent(self: QSizeGrip, event: gen_qcoreevent.QEvent): void =


  fQSizeGrip_virtualbase_enterEvent(self.h, event.h)

type QSizeGripenterEventBase* = proc(event: gen_qcoreevent.QEvent): void
proc onenterEvent*(self: QSizeGrip, slot: proc(super: QSizeGripenterEventBase, event: gen_qcoreevent.QEvent): void) =
  # TODO check subclass
  type Cb = proc(super: QSizeGripenterEventBase, event: gen_qcoreevent.QEvent): void
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QSizeGrip_dropEvent(self: ptr cQSizeGrip, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QSizeGrip_dropEvent ".} =
  ...
  nimfunc[](superCall, slotval1)
proc callVirtualBase_nativeEvent(self: QSizeGrip, eventType: seq[byte], message: pointer, resultVal: ptr clong): bool =
...
type QSizeGripnativeEventBase* = proc(eventType: seq[byte], message: pointer, resultVal: ptr clong): bool
proc onnativeEvent*(self: QSizeGrip, slot: proc(super: QSizeGripnativeEventBase, eventType: seq[byte], message: pointer, resultVal: ptr clong): bool) =
  # TODO check subclass
  type Cb = proc(super: QSizeGripnativeEventBase, eventType: seq[byte], message: pointer, resultVal: ptr clong): bool
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
