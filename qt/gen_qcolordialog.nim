...
proc trUtf82*(_: type gen_qcolordialog_types.QColorDialog, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type gen_qcolordialog_types.QColorDialog, s: cstring, c: cstring, n: cint): string =
...
proc getRgba1*(_: type gen_qcolordialog_types.QColorDialog, rgba: cuint): cuint =

  fcQColorDialog_getRgba1(rgba)

proc getRgba2*(_: type gen_qcolordialog_types.QColorDialog, rgba: cuint, ok: ptr bool): cuint =

  fcQColorDialog_getRgba2(rgba, ok)

proc getRgba3*(_: type gen_qcolordialog_types.QColorDialog, rgba: cuint, ok: ptr bool, parent: gen_qwidget.QWidget): cuint =
