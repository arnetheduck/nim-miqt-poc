...
proc trUtf82*(_: type gen_qmdiarea_types.QMdiArea, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type gen_qmdiarea_types.QMdiArea, s: cstring, c: cstring, n: cint): string =
...
proc miqt_exec_callback_QMdiArea_focusOutEvent(self: ptr cQMdiArea, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QMdiArea_focusOutEvent ".} =
  ...
  nimfunc[](slotval1)
proc QMdiAreaenterEvent*(self: gen_qmdiarea_types.QMdiArea, event: gen_qcoreevent.QEvent): void =

  fQMdiArea_virtualbase_enterEvent(self.h, event.h)

type QMdiAreaenterEventProc* = proc(event: gen_qcoreevent.QEvent): void
