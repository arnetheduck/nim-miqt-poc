...
proc create*(T: type QImage, data: ptr uint8, width: cint, height: cint, bytesPerLine: cint, format: QImageFormat): QImage =

  QImage.init(fcQImage_new6(data, width, height, bytesPerLine, cint(format)))
proc create2*(T: type QImage, data: ptr uint8, width: cint, height: cint, bytesPerLine: cint, format: QImageFormat): QImage =
...
proc byteCount*(self: QImage, ): cint =
...
proc bytesPerLine*(self: QImage, ): cint =
...
proc alphaChannel*(self: QImage, ): QImage =
...
proc transformed*(self: QImage, matrix: gen_qmatrix.QMatrix): QImage =

  QImage(h: fcQImage_transformed(self.h, matrix.h))

proc trueMatrix*(_: type QImage, param1: gen_qmatrix.QMatrix, w: cint, h: cint): gen_qmatrix.QMatrix =

  gen_qmatrix.QMatrix(h: fcQImage_trueMatrix(param1.h, w, h))

proc transformedWithMatrix*(self: QImage, matrix: gen_qtransform.QTransform): QImage =

  QImage(h: fcQImage_transformedWithMatrix(self.h, matrix.h))

proc trueMatrix2*(_: type QImage, param1: gen_qtransform.QTransform, w: cint, h: cint): gen_qtransform.QTransform =
...
proc loadFromData*(self: QImage, buf: ptr uint8, len: cint): bool =
...
proc fromData*(_: type QImage, data: ptr uint8, size: cint): QImage =
...
proc transformed2*(self: QImage, matrix: gen_qmatrix.QMatrix, mode: gen_qnamespace.TransformationMode): QImage =

  QImage(h: fcQImage_transformed2(self.h, matrix.h, cint(mode)))

proc transformed22*(self: QImage, matrix: gen_qtransform.QTransform, mode: gen_qnamespace.TransformationMode): QImage =
...
proc loadFromData2*(self: QImage, data: seq[byte], aformat: cstring): bool =
...
proc fromData2*(_: type QImage, data: seq[byte], format: cstring): QImage =
