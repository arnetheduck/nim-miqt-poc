...
func (this *QDialogButtonBox) Metacall(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {
	return (int)(C.QDialogButtonBox_metacall(this.h, (C.int)(param1), (C.int)(param2), param3))
}
...
func (this *QDialogButtonBox) callVirtualBase_MetaObject() *QMetaObject {
	...
	return newQMetaObject(C.QDialogButtonBox_virtualbase_metaObject(unsafe.Pointer(this.h)))

}
func (this *QDialogButtonBox) OnMetaObject(slot func(super func() *QMetaObject) *QMetaObject) {
	ok := C.QDialogButtonBox_override_virtual_metaObject(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
...
func miqt_exec_callback_QDialogButtonBox_metaObject(self *C.QDialogButtonBox, cb C.intptr_t) *C.QMetaObject {
...
func (this *QDialogButtonBox) callVirtualBase_Metacast(param1 string) unsafe.Pointer {
	...
	return (unsafe.Pointer)(C.QDialogButtonBox_virtualbase_metacast(unsafe.Pointer(this.h), param1_Cstring))

}
func (this *QDialogButtonBox) OnMetacast(slot func(super func(param1 string) unsafe.Pointer, param1 string) unsafe.Pointer) {
	ok := C.QDialogButtonBox_override_virtual_metacast(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func miqt_exec_callback_QDialogButtonBox_metacast(self *C.QDialogButtonBox, cb C.intptr_t, param1 *C.const_char) unsafe.Pointer {
...
func (this *QDialogButtonBox) callVirtualBase_Metacall(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {

	return (int)(C.QDialogButtonBox_virtualbase_metacall(unsafe.Pointer(this.h), (C.int)(param1), (C.int)(param2), param3))

}
func (this *QDialogButtonBox) OnMetacall(slot func(super func(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int, param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int) {
	ok := C.QDialogButtonBox_override_virtual_metacall(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}

//export miqt_exec_callback_QDialogButtonBox_metacall
func miqt_exec_callback_QDialogButtonBox_metacall(self *C.QDialogButtonBox, cb C.intptr_t, param1 C.int, param2 C.int, param3 unsafe.Pointer) C.int {
	...
	virtualReturn := gofunc((&QDialogButtonBox{h: self}).callVirtualBase_Metacall, slotval1, slotval2, slotval3)
...
func (this *QDialogButtonBox) callVirtualBase_EnterEvent(event *QEvent) {

	C.QDialogButtonBox_virtualbase_enterEvent(unsafe.Pointer(this.h), event.cPointer())

}
func (this *QDialogButtonBox) OnEnterEvent(slot func(super func(event *QEvent), event *QEvent)) {
...
func miqt_exec_callback_QDialogButtonBox_enterEvent(self *C.QDialogButtonBox, cb C.intptr_t, event *C.QEvent) {
	gofunc, ok := cgo.Handle(cb).Value().(func(super func(event *QEvent), event *QEvent))
	if !ok {
		panic("miqt: callback of non-callback type (heap corruption?)")
	}
...
func (this *QDialogButtonBox) OnNativeEvent(slot func(super func(eventType []byte, message unsafe.Pointer, result *int64) bool, eventType []byte, message unsafe.Pointer, result *int64) bool) {
...
func miqt_exec_callback_QDialogButtonBox_nativeEvent(self *C.QDialogButtonBox, cb C.intptr_t, eventType C.struct_miqt_string, message unsafe.Pointer, result *C.long) C.bool {
