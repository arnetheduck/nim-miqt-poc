...
proc length*(self: QStringView, ): cint =

  fcQStringView_length(self.h)

proc first*(self: QStringView, ): gen_qchar.QChar =

  gen_qchar.QChar(h: fcQStringView_first(self.h))

proc last*(self: QStringView, ): gen_qchar.QChar =
...
proc lastIndexOf3*(self: QStringView, c: gen_qchar.QChar, fromVal: int64, cs: gen_qnamespace.CaseSensitivity): int64 =
