...
proc trUtf82*(_: type gen_qgroupbox_types.QGroupBox, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type gen_qgroupbox_types.QGroupBox, s: cstring, c: cstring, n: cint): string =
...
proc miqt_exec_callback_QGroupBox_focusOutEvent(self: ptr cQGroupBox, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QGroupBox_focusOutEvent ".} =
  ...
  nimfunc[](slotval1)
proc QGroupBoxenterEvent*(self: gen_qgroupbox_types.QGroupBox, event: gen_qcoreevent.QEvent): void =

  fQGroupBox_virtualbase_enterEvent(self.h, event.h)

type QGroupBoxenterEventProc* = proc(event: gen_qcoreevent.QEvent): void
