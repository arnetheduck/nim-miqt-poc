...
public:
	...
	MiqtVirtualQAbstractTransition(struct QAbstractTransition_VTable* vtbl): QAbstractTransition(), vtbl(vtbl) {};
	MiqtVirtualQAbstractTransition(struct QAbstractTransition_VTable* vtbl, QState* sourceState): QAbstractTransition(sourceState), vtbl(vtbl) {};

	virtual ~MiqtVirtualQAbstractTransition() override { if(vtbl->destructor) vtbl->destructor(vtbl, this); }
	...
	QMetaObject* virtualbase_metaObject() const {
		...
		return (QMetaObject*) QAbstractTransition::metaObject();
	...
	int virtualbase_metacall(int param1, int param2, void** param3) {
		...
		return QAbstractTransition::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
QAbstractTransition* QAbstractTransition_new(struct QAbstractTransition_VTable* vtbl) {
	return new MiqtVirtualQAbstractTransition(vtbl);
}

QAbstractTransition* QAbstractTransition_new2(struct QAbstractTransition_VTable* vtbl, QState* sourceState) {
	return new MiqtVirtualQAbstractTransition(vtbl, sourceState);
}
...
QMetaObject* QAbstractTransition_virtualbase_metaObject(const void* self) {
	return ( (const MiqtVirtualQAbstractTransition*)(self) )->virtualbase_metaObject();
}

void* QAbstractTransition_virtualbase_metacast(void* self, const char* param1) {
	return ( (MiqtVirtualQAbstractTransition*)(self) )->virtualbase_metacast(param1);
}

int QAbstractTransition_virtualbase_metacall(void* self, int param1, int param2, void** param3) {
	return ( (MiqtVirtualQAbstractTransition*)(self) )->virtualbase_metacall(param1, param2, param3);
}
...
QObject* QAbstractTransition_protectedbase_sender(const void* self) {
	return ( (const MiqtVirtualQAbstractTransition*)(self) )->protectedbase_sender();
}

int QAbstractTransition_protectedbase_senderSignalIndex(const void* self) {
	return ( (const MiqtVirtualQAbstractTransition*)(self) )->protectedbase_senderSignalIndex();
}

int QAbstractTransition_protectedbase_receivers(const void* self, const char* signal) {
	return ( (const MiqtVirtualQAbstractTransition*)(self) )->protectedbase_receivers(signal);
}

bool QAbstractTransition_protectedbase_isSignalConnected(const void* self, QMetaMethod* signal) {
	return ( (const MiqtVirtualQAbstractTransition*)(self) )->protectedbase_isSignalConnected(signal);
}
