...
proc countWithOn*(self: gen_qbitarray_types.QBitArray, on: bool): cint =
...
proc setBit2*(self: gen_qbitarray_types.QBitArray, i: cint, val: bool): void =
...
proc operatorSubscriptWithInt*(self: gen_qbitarray_types.QBitArray, i: cint): bool =

  fcQBitArray_operatorSubscriptWithInt(self.h, i)

proc operatorSubscriptWithUint*(self: gen_qbitarray_types.QBitArray, i: cuint): gen_qbitarray_types.QBitRef =
...
proc fill2*(self: gen_qbitarray_types.QBitArray, val: bool, first: cint, last: cint): void =
...
proc fill22*(self: gen_qbitarray_types.QBitArray, val: bool, size: cint): bool =
