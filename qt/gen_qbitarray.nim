...
proc create*(T: type QBitArray, size: cint): QBitArray =
...
proc create*(T: type QBitArray, size: cint, val: bool): QBitArray =
...
proc size*(self: QBitArray, ): cint =

  fcQBitArray_size(self.h)

proc count*(self: QBitArray, ): cint =

  fcQBitArray_count(self.h)

proc countWithOn*(self: QBitArray, on: bool): cint =
...
proc resize*(self: QBitArray, size: cint): void =
...
proc testBit*(self: QBitArray, i: cint): bool =

  fcQBitArray_testBit(self.h, i)

proc setBit*(self: QBitArray, i: cint): void =

  fcQBitArray_setBit(self.h, i)

proc setBit2*(self: QBitArray, i: cint, val: bool): void =

  fcQBitArray_setBit2(self.h, i, val)

proc clearBit*(self: QBitArray, i: cint): void =

  fcQBitArray_clearBit(self.h, i)

proc toggleBit*(self: QBitArray, i: cint): bool =

  fcQBitArray_toggleBit(self.h, i)

proc at*(self: QBitArray, i: cint): bool =

  fcQBitArray_at(self.h, i)

proc operatorSubscript*(self: QBitArray, i: cint): QBitRef =

  QBitRef(h: fcQBitArray_operatorSubscript(self.h, i))

proc operatorSubscriptWithInt*(self: QBitArray, i: cint): bool =

  fcQBitArray_operatorSubscriptWithInt(self.h, i)

proc operatorSubscriptWithUint*(self: QBitArray, i: cuint): QBitRef =

  QBitRef(h: fcQBitArray_operatorSubscriptWithUint(self.h, i))

proc operatorSubscript2*(self: QBitArray, i: cuint): bool =
...
proc fill2*(self: QBitArray, val: bool, first: cint, last: cint): void =

  fcQBitArray_fill2(self.h, val, first, last)

proc truncate*(self: QBitArray, pos: cint): void =
...
proc fill22*(self: QBitArray, val: bool, size: cint): bool =
