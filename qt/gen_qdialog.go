...
func (this *QDialog) Metacall(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {
	return (int)(C.QDialog_metacall(this.h, (C.int)(param1), (C.int)(param2), param3))
}
...
func (this *QDialog) Extension() *QWidget {
	return newQWidget(C.QDialog_extension(this.h))
}
...
func (this *QDialog) callVirtualBase_MetaObject() *QMetaObject {
	...
	return newQMetaObject(C.QDialog_virtualbase_metaObject(unsafe.Pointer(this.h)))

}
func (this *QDialog) OnmetaObject(slot func(super func() *QMetaObject) *QMetaObject) {
	ok := C.QDialog_override_virtual_metaObject(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
...
func miqt_exec_callback_QDialog_metaObject(self *C.QDialog, cb C.intptr_t) *C.QMetaObject {
...
func (this *QDialog) callVirtualBase_Metacast(param1 string) unsafe.Pointer {
	...
	return (unsafe.Pointer)(C.QDialog_virtualbase_metacast(unsafe.Pointer(this.h), param1_Cstring))

}
func (this *QDialog) Onmetacast(slot func(super func(param1 string) unsafe.Pointer, param1 string) unsafe.Pointer) {
	ok := C.QDialog_override_virtual_metacast(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func miqt_exec_callback_QDialog_metacast(self *C.QDialog, cb C.intptr_t, param1 *C.const_char) unsafe.Pointer {
...
func (this *QDialog) callVirtualBase_Metacall(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {

	return (int)(C.QDialog_virtualbase_metacall(unsafe.Pointer(this.h), (C.int)(param1), (C.int)(param2), param3))

}
func (this *QDialog) OnMetacall(slot func(super func(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int, param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int) {
	ok := C.QDialog_override_virtual_metacall(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}

//export miqt_exec_callback_QDialog_metacall
func miqt_exec_callback_QDialog_metacall(self *C.QDialog, cb C.intptr_t, param1 C.int, param2 C.int, param3 unsafe.Pointer) C.int {
	...
	virtualReturn := gofunc((&QDialog{h: self}).callVirtualBase_Metacall, slotval1, slotval2, slotval3)
