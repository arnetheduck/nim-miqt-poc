...
proc trUtf8*(_: type QTextBrowser, s: cstring): string =
...
proc highlightedWithQString*(self: QTextBrowser, param1: string): void =
...
proc onhighlightedWithQString*(self: QTextBrowser, slot: proc(param1: string)) =
  type Cb = proc(param1: string)
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc trUtf82*(_: type QTextBrowser, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type QTextBrowser, s: cstring, c: cstring, n: cint): string =
...
proc callVirtualBase_metaObject(self: QTextBrowser, ): gen_qobjectdefs.QMetaObject =


  gen_qobjectdefs.QMetaObject(h: fQTextBrowser_virtualbase_metaObject(self.h))

type QTextBrowsermetaObjectBase* = proc(): gen_qobjectdefs.QMetaObject
proc onmetaObject*(self: QTextBrowser, slot: proc(super: QTextBrowsermetaObjectBase): gen_qobjectdefs.QMetaObject) =
  # TODO check subclass
  type Cb = proc(super: QTextBrowsermetaObjectBase): gen_qobjectdefs.QMetaObject
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QTextBrowser_metaObject(self: ptr cQTextBrowser, slot: int): pointer {.exportc: "miqt_exec_callback_QTextBrowser_metaObject ".} =
  ...
  proc superCall(): auto =
    callVirtualBase_metaObject(QTextBrowser(h: self), )

  let virtualReturn = nimfunc[](superCall )

  virtualReturn.h
proc callVirtualBase_metacast(self: QTextBrowser, param1: cstring): pointer =


  fQTextBrowser_virtualbase_metacast(self.h, param1)

type QTextBrowsermetacastBase* = proc(param1: cstring): pointer
proc onmetacast*(self: QTextBrowser, slot: proc(super: QTextBrowsermetacastBase, param1: cstring): pointer) =
  # TODO check subclass
  type Cb = proc(super: QTextBrowsermetacastBase, param1: cstring): pointer
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QTextBrowser_metacast(self: ptr cQTextBrowser, slot: int, param1: cstring): pointer {.exportc: "miqt_exec_callback_QTextBrowser_metacast ".} =
  ...
  proc superCall(param1: cstring): auto =
    callVirtualBase_metacast(QTextBrowser(h: self), param1)
  let slotval1 = (param1)
...
proc miqt_exec_callback_QTextBrowser_loadResource(self: ptr cQTextBrowser, slot: int, typeVal: cint, name: pointer): pointer {.exportc: "miqt_exec_callback_QTextBrowser_loadResource ".} =
  ...
  virtualReturn.h
proc callVirtualBase_setSource(self: QTextBrowser, name: gen_qurl.QUrl): void =


  fQTextBrowser_virtualbase_setSource(self.h, name.h)

type QTextBrowsersetSourceBase* = proc(name: gen_qurl.QUrl): void
proc onsetSource*(self: QTextBrowser, slot: proc(super: QTextBrowsersetSourceBase, name: gen_qurl.QUrl): void) =
  # TODO check subclass
  type Cb = proc(super: QTextBrowsersetSourceBase, name: gen_qurl.QUrl): void
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QTextBrowser_setSource(self: ptr cQTextBrowser, slot: int, name: pointer): void {.exportc: "miqt_exec_callback_QTextBrowser_setSource ".} =
  type Cb = proc(super: QTextBrowsersetSourceBase, name: gen_qurl.QUrl): void
  var nimfunc = cast[ptr Cb](cast[pointer](slot))
  proc superCall(name: gen_qurl.QUrl): auto =
    callVirtualBase_setSource(QTextBrowser(h: self), name)
...
proc miqt_exec_callback_QTextBrowser_paintEngine(self: ptr cQTextBrowser, slot: int): pointer {.exportc: "miqt_exec_callback_QTextBrowser_paintEngine ".} =
  ...
  virtualReturn.h
proc callVirtualBase_enterEvent(self: QTextBrowser, event: gen_qcoreevent.QEvent): void =


  fQTextBrowser_virtualbase_enterEvent(self.h, event.h)

type QTextBrowserenterEventBase* = proc(event: gen_qcoreevent.QEvent): void
proc onenterEvent*(self: QTextBrowser, slot: proc(super: QTextBrowserenterEventBase, event: gen_qcoreevent.QEvent): void) =
  # TODO check subclass
  type Cb = proc(super: QTextBrowserenterEventBase, event: gen_qcoreevent.QEvent): void
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QTextBrowser_hideEvent(self: ptr cQTextBrowser, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTextBrowser_hideEvent ".} =
  ...
  nimfunc[](superCall, slotval1)
proc callVirtualBase_nativeEvent(self: QTextBrowser, eventType: seq[byte], message: pointer, resultVal: ptr clong): bool =
...
type QTextBrowsernativeEventBase* = proc(eventType: seq[byte], message: pointer, resultVal: ptr clong): bool
proc onnativeEvent*(self: QTextBrowser, slot: proc(super: QTextBrowsernativeEventBase, eventType: seq[byte], message: pointer, resultVal: ptr clong): bool) =
  # TODO check subclass
  type Cb = proc(super: QTextBrowsernativeEventBase, eventType: seq[byte], message: pointer, resultVal: ptr clong): bool
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
