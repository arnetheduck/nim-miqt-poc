...
proc miqt_exec_callback_cQTextBrowser_highlightedWithQString(slot: int, param1: struct_miqt_string) {.exportc: "miqt_exec_callback_QTextBrowser_highlightedWithQString".} =
