...
proc trUtf8*(_: type QStylePlugin, s: cstring): string =
...
proc trUtf82*(_: type QStylePlugin, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type QStylePlugin, s: cstring, c: cstring, n: cint): string =
