...
proc trUtf8*(_: type QGuiApplication, s: cstring): string =
...
proc isFallbackSessionManagementEnabled*(_: type QGuiApplication, ): bool =

  fcQGuiApplication_isFallbackSessionManagementEnabled()

proc setFallbackSessionManagementEnabled*(_: type QGuiApplication, fallbackSessionManagementEnabled: bool): void =
...
proc trUtf82*(_: type QGuiApplication, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type QGuiApplication, s: cstring, c: cstring, n: cint): string =
...
proc callVirtualBase_metaObject(self: QGuiApplication, ): gen_qobjectdefs.QMetaObject =


  gen_qobjectdefs.QMetaObject(h: fQGuiApplication_virtualbase_metaObject(self.h))

type QGuiApplicationmetaObjectBase* = proc(): gen_qobjectdefs.QMetaObject
proc onmetaObject*(self: QGuiApplication, slot: proc(super: QGuiApplicationmetaObjectBase): gen_qobjectdefs.QMetaObject) =
  # TODO check subclass
  type Cb = proc(super: QGuiApplicationmetaObjectBase): gen_qobjectdefs.QMetaObject
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QGuiApplication_metaObject(self: ptr cQGuiApplication, slot: int): pointer {.exportc: "miqt_exec_callback_QGuiApplication_metaObject ".} =
  ...
  proc superCall(): auto =
    callVirtualBase_metaObject(QGuiApplication(h: self), )

  let virtualReturn = nimfunc[](superCall )

  virtualReturn.h
proc callVirtualBase_metacast(self: QGuiApplication, param1: cstring): pointer =


  fQGuiApplication_virtualbase_metacast(self.h, param1)

type QGuiApplicationmetacastBase* = proc(param1: cstring): pointer
proc onmetacast*(self: QGuiApplication, slot: proc(super: QGuiApplicationmetacastBase, param1: cstring): pointer) =
  # TODO check subclass
  type Cb = proc(super: QGuiApplicationmetacastBase, param1: cstring): pointer
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QGuiApplication_metacast(self: ptr cQGuiApplication, slot: int, param1: cstring): pointer {.exportc: "miqt_exec_callback_QGuiApplication_metacast ".} =
  ...
  proc superCall(param1: cstring): auto =
    callVirtualBase_metacast(QGuiApplication(h: self), param1)
  let slotval1 = (param1)
