...
void miqt_exec_callback_QStateMachine_runningChanged_release(intptr_t);
#ifdef __cplusplus
} /* extern C */
#endif
...
public:
	...
	MiqtVirtualQStateMachine(struct QStateMachine_VTable* vtbl): QStateMachine(), vtbl(vtbl) {};
	MiqtVirtualQStateMachine(struct QStateMachine_VTable* vtbl, QState::ChildMode childMode): QStateMachine(childMode), vtbl(vtbl) {};
	MiqtVirtualQStateMachine(struct QStateMachine_VTable* vtbl, QObject* parent): QStateMachine(parent), vtbl(vtbl) {};
	MiqtVirtualQStateMachine(struct QStateMachine_VTable* vtbl, QState::ChildMode childMode, QObject* parent): QStateMachine(childMode, parent), vtbl(vtbl) {};

	virtual ~MiqtVirtualQStateMachine() override { if(vtbl->destructor) vtbl->destructor(vtbl, this); }
	...
	QMetaObject* virtualbase_metaObject() const {
		...
		return (QMetaObject*) QStateMachine::metaObject();
...
void QStateMachine_connect_runningChanged(QStateMachine* self, intptr_t slot) {
	struct caller {
		...
		~caller() { miqt_exec_callback_QStateMachine_runningChanged_release(slot); }
	};
	MiqtVirtualQStateMachine::connect(self, static_cast<void (QStateMachine::*)(bool)>(&QStateMachine::runningChanged), self, caller{slot});
}
...
QMetaObject* QStateMachine_virtualbase_metaObject(const void* self) {
	return ( (const MiqtVirtualQStateMachine*)(self) )->virtualbase_metaObject();
}

void* QStateMachine_virtualbase_metacast(void* self, const char* param1) {
	return ( (MiqtVirtualQStateMachine*)(self) )->virtualbase_metacast(param1);
}
...
QObject* QStateMachine_protectedbase_sender(const void* self) {
	return ( (const MiqtVirtualQStateMachine*)(self) )->protectedbase_sender();
}

int QStateMachine_protectedbase_senderSignalIndex(const void* self) {
	return ( (const MiqtVirtualQStateMachine*)(self) )->protectedbase_senderSignalIndex();
}

int QStateMachine_protectedbase_receivers(const void* self, const char* signal) {
	return ( (const MiqtVirtualQStateMachine*)(self) )->protectedbase_receivers(signal);
}

bool QStateMachine_protectedbase_isSignalConnected(const void* self, QMetaMethod* signal) {
	return ( (const MiqtVirtualQStateMachine*)(self) )->protectedbase_isSignalConnected(signal);
}
