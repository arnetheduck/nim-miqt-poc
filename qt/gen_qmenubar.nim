...
proc trUtf8*(_: type QMenuBar, s: cstring): string =
...
proc addAction*(self: QMenuBar, text: string): gen_qaction.QAction =

  gen_qaction.QAction(h: fcQMenuBar_addAction(self.h, struct_miqt_string(data: text, len: csize_t(len(text)))))
...
proc trUtf82*(_: type QMenuBar, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type QMenuBar, s: cstring, c: cstring, n: cint): string =
...
proc miqt_exec_callback_QMenuBar_keyReleaseEvent(self: ptr cQMenuBar, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QMenuBar_keyReleaseEvent ".} =
  ...
  nimfunc[](superCall, slotval1)
proc callVirtualBase_enterEvent(self: QMenuBar, event: gen_qcoreevent.QEvent): void =


  fQMenuBar_virtualbase_enterEvent(self.h, event.h)

type QMenuBarenterEventBase* = proc(event: gen_qcoreevent.QEvent): void
proc onenterEvent*(self: QMenuBar, slot: proc(super: QMenuBarenterEventBase, event: gen_qcoreevent.QEvent): void) =
  # TODO check subclass
  type Cb = proc(super: QMenuBarenterEventBase, event: gen_qcoreevent.QEvent): void
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QMenuBar_hideEvent(self: ptr cQMenuBar, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QMenuBar_hideEvent ".} =
  ...
  nimfunc[](superCall, slotval1)
proc callVirtualBase_nativeEvent(self: QMenuBar, eventType: seq[byte], message: pointer, resultVal: ptr clong): bool =
...
type QMenuBarnativeEventBase* = proc(eventType: seq[byte], message: pointer, resultVal: ptr clong): bool
proc onnativeEvent*(self: QMenuBar, slot: proc(super: QMenuBarnativeEventBase, eventType: seq[byte], message: pointer, resultVal: ptr clong): bool) =
  # TODO check subclass
  type Cb = proc(super: QMenuBarnativeEventBase, eventType: seq[byte], message: pointer, resultVal: ptr clong): bool
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
