...
proc trUtf82*(_: type gen_qtabbar_types.QTabBar, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type gen_qtabbar_types.QTabBar, s: cstring, c: cstring, n: cint): string =
...
proc miqt_exec_callback_QTabBar_paintEngine(self: ptr cQTabBar, slot: int): pointer {.exportc: "miqt_exec_callback_QTabBar_paintEngine ".} =
  ...
  virtualReturn.h
proc QTabBarmouseDoubleClickEvent*(self: gen_qtabbar_types.QTabBar, event: gen_qevent.QMouseEvent): void =

  fQTabBar_virtualbase_mouseDoubleClickEvent(self.h, event.h)

type QTabBarmouseDoubleClickEventProc* = proc(event: gen_qevent.QMouseEvent): void
...
proc miqt_exec_callback_QTabBar_focusOutEvent(self: ptr cQTabBar, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QTabBar_focusOutEvent ".} =
  ...
  nimfunc[](slotval1)
proc QTabBarenterEvent*(self: gen_qtabbar_types.QTabBar, event: gen_qcoreevent.QEvent): void =

  fQTabBar_virtualbase_enterEvent(self.h, event.h)

type QTabBarenterEventProc* = proc(event: gen_qcoreevent.QEvent): void
