...
func init*(T: type QXmlStreamStringRef, h: ptr cQXmlStreamStringRef): QXmlStreamStringRef =
  T(h: h)
proc create*(T: type QXmlStreamStringRef, ): QXmlStreamStringRef =

  QXmlStreamStringRef.init(fcQXmlStreamStringRef_new())
proc create*(T: type QXmlStreamStringRef, aString: string): QXmlStreamStringRef =

  QXmlStreamStringRef.init(fcQXmlStreamStringRef_new2(struct_miqt_string(data: aString, len: csize_t(len(aString)))))
proc create*(T: type QXmlStreamStringRef, other: QXmlStreamStringRef): QXmlStreamStringRef =

  QXmlStreamStringRef.init(fcQXmlStreamStringRef_new3(other.h))
proc operatorAssign*(self: QXmlStreamStringRef, other: QXmlStreamStringRef): void =

  fcQXmlStreamStringRef_operatorAssign(self.h, other.h)

proc swap*(self: QXmlStreamStringRef, other: QXmlStreamStringRef): void =

  fcQXmlStreamStringRef_swap(self.h, other.h)

proc clear*(self: QXmlStreamStringRef, ): void =

  fcQXmlStreamStringRef_clear(self.h)

proc string*(self: QXmlStreamStringRef, ): string =
...
proc position*(self: QXmlStreamStringRef, ): cint =

  fcQXmlStreamStringRef_position(self.h)

proc size*(self: QXmlStreamStringRef, ): cint =

  fcQXmlStreamStringRef_size(self.h)

proc delete*(self: QXmlStreamStringRef) =
...
proc create*(T: type QXmlStreamNamespaceDeclaration, param1: QXmlStreamNamespaceDeclaration): QXmlStreamNamespaceDeclaration =

  QXmlStreamNamespaceDeclaration.init(fcQXmlStreamNamespaceDeclaration_new3(param1.h))
proc operatorAssign*(self: QXmlStreamNamespaceDeclaration, param1: QXmlStreamNamespaceDeclaration): void =
...
proc create*(T: type QXmlStreamNotationDeclaration, param1: QXmlStreamNotationDeclaration): QXmlStreamNotationDeclaration =

  QXmlStreamNotationDeclaration.init(fcQXmlStreamNotationDeclaration_new2(param1.h))
proc operatorAssign*(self: QXmlStreamNotationDeclaration, param1: QXmlStreamNotationDeclaration): void =
...
proc create*(T: type QXmlStreamEntityDeclaration, param1: QXmlStreamEntityDeclaration): QXmlStreamEntityDeclaration =

  QXmlStreamEntityDeclaration.init(fcQXmlStreamEntityDeclaration_new2(param1.h))
proc operatorAssign*(self: QXmlStreamEntityDeclaration, param1: QXmlStreamEntityDeclaration): void =
...
proc setCodec*(self: QXmlStreamWriter, codec: gen_qtextcodec.QTextCodec): void =

  fcQXmlStreamWriter_setCodec(self.h, codec.h)

proc setCodecWithCodecName*(self: QXmlStreamWriter, codecName: cstring): void =

  fcQXmlStreamWriter_setCodecWithCodecName(self.h, codecName)

proc codec*(self: QXmlStreamWriter, ): gen_qtextcodec.QTextCodec =
