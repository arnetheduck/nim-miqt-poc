...
proc trUtf8*(_: type QAbstractEventDispatcher, s: cstring): string =
...
proc hasPendingEvents*(self: QAbstractEventDispatcher, ): bool =
...
proc registerTimer*(self: QAbstractEventDispatcher, interval: cint, timerType: gen_qnamespace.TimerType, objectVal: gen_qobject.QObject): cint =

  fcQAbstractEventDispatcher_registerTimer(self.h, interval, cint(timerType), objectVal.h)

proc registerTimer2*(self: QAbstractEventDispatcher, timerId: cint, interval: cint, timerType: gen_qnamespace.TimerType, objectVal: gen_qobject.QObject): void =
...
proc flush*(self: QAbstractEventDispatcher, ): void =
...
proc filterNativeEvent*(self: QAbstractEventDispatcher, eventType: seq[byte], message: pointer, resultVal: ptr clong): bool =
...
proc trUtf82*(_: type QAbstractEventDispatcher, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type QAbstractEventDispatcher, s: cstring, c: cstring, n: cint): string =
