...
proc trUtf82*(_: type gen_qwizard_types.QWizard, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type gen_qwizard_types.QWizard, s: cstring, c: cstring, n: cint): string =
...
proc miqt_exec_callback_QWizard_focusOutEvent(self: ptr cQWizard, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QWizard_focusOutEvent ".} =
  ...
  nimfunc[](slotval1)
proc QWizardenterEvent*(self: gen_qwizard_types.QWizard, event: gen_qcoreevent.QEvent): void =

  fQWizard_virtualbase_enterEvent(self.h, event.h)

type QWizardenterEventProc* = proc(event: gen_qcoreevent.QEvent): void
...
proc trUtf82*(_: type gen_qwizard_types.QWizardPage, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type gen_qwizard_types.QWizardPage, s: cstring, c: cstring, n: cint): string =
...
proc miqt_exec_callback_QWizardPage_focusOutEvent(self: ptr cQWizardPage, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QWizardPage_focusOutEvent ".} =
  ...
  nimfunc[](slotval1)
proc QWizardPageenterEvent*(self: gen_qwizard_types.QWizardPage, event: gen_qcoreevent.QEvent): void =

  fQWizardPage_virtualbase_enterEvent(self.h, event.h)

type QWizardPageenterEventProc* = proc(event: gen_qcoreevent.QEvent): void
