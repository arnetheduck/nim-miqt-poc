...
func init*(T: type QWaitCondition, h: ptr cQWaitCondition): QWaitCondition =
  T(h: h)
proc create*(T: type QWaitCondition, ): QWaitCondition =

  QWaitCondition.init(fcQWaitCondition_new())
proc wait*(self: QWaitCondition, lockedMutex: gen_qmutex.QMutex): bool =

  fcQWaitCondition_wait(self.h, lockedMutex.h)

proc wait2*(self: QWaitCondition, lockedMutex: gen_qmutex.QMutex, time: culong): bool =

  fcQWaitCondition_wait2(self.h, lockedMutex.h, time)

proc waitWithLockedReadWriteLock*(self: QWaitCondition, lockedReadWriteLock: gen_qreadwritelock.QReadWriteLock): bool =

  fcQWaitCondition_waitWithLockedReadWriteLock(self.h, lockedReadWriteLock.h)

proc wait3*(self: QWaitCondition, lockedReadWriteLock: gen_qreadwritelock.QReadWriteLock, time: culong): bool =

  fcQWaitCondition_wait3(self.h, lockedReadWriteLock.h, time)

proc wakeOne*(self: QWaitCondition, ): void =

  fcQWaitCondition_wakeOne(self.h)

proc wakeAll*(self: QWaitCondition, ): void =

  fcQWaitCondition_wakeAll(self.h)

proc notifyOne*(self: QWaitCondition, ): void =

  fcQWaitCondition_notifyOne(self.h)

proc notifyAll*(self: QWaitCondition, ): void =

  fcQWaitCondition_notifyAll(self.h)

proc wait22*(self: QWaitCondition, lockedMutex: gen_qmutex.QMutex, deadline: gen_qdeadlinetimer.QDeadlineTimer): bool =

  fcQWaitCondition_wait22(self.h, lockedMutex.h, deadline.h)

proc wait23*(self: QWaitCondition, lockedReadWriteLock: gen_qreadwritelock.QReadWriteLock, deadline: gen_qdeadlinetimer.QDeadlineTimer): bool =

  fcQWaitCondition_wait23(self.h, lockedReadWriteLock.h, deadline.h)

proc delete*(self: QWaitCondition) =
