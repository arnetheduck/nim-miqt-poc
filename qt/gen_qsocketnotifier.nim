...
proc trUtf82*(_: type gen_qsocketnotifier_types.QSocketNotifier, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type gen_qsocketnotifier_types.QSocketNotifier, s: cstring, c: cstring, n: cint): string =
