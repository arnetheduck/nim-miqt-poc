...
proc create*(T: type QSocketNotifier, socket: uint, param2: QSocketNotifierType): QSocketNotifier =
  ...
  QSocketNotifier.init(fcQSocketNotifier_new(socket, cint(param2)))
proc create*(T: type QSocketNotifier, socket: uint, param2: QSocketNotifierType, parent: gen_qobject.QObject): QSocketNotifier =

  QSocketNotifier.init(fcQSocketNotifier_new2(socket, cint(param2), parent.h))
...
proc trUtf8*(_: type QSocketNotifier, s: cstring): string =
...
proc trUtf82*(_: type QSocketNotifier, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type QSocketNotifier, s: cstring, c: cstring, n: cint): string =
