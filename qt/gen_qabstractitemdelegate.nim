...
proc trUtf8*(_: type QAbstractItemDelegate, s: cstring): string =
...
proc elidedText*(_: type QAbstractItemDelegate, fontMetrics: gen_qfontmetrics.QFontMetrics, width: cint, mode: gen_qnamespace.TextElideMode, text: string): string =
...
proc trUtf82*(_: type QAbstractItemDelegate, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type QAbstractItemDelegate, s: cstring, c: cstring, n: cint): string =
