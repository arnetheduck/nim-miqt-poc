...
proc setDirectory*(self: gen_qfiledialog_types.QFileDialog, directory: gen_qdir.QDir): void =
...
proc setIconProvider*(self: gen_qfiledialog_types.QFileDialog, provider: gen_qfileiconprovider.QFileIconProvider): void =
  fcQFileDialog_setIconProvider(self.h, provider.h)

proc iconProvider*(self: gen_qfiledialog_types.QFileDialog, ): gen_qfileiconprovider.QFileIconProvider =
...
type QFileDialogurlSelectedSlot* = proc(url: gen_qurl.QUrl)
...
type QFileDialogurlsSelectedSlot* = proc(urls: seq[gen_qurl.QUrl])
...
type QFileDialogcurrentUrlChangedSlot* = proc(url: gen_qurl.QUrl)
...
type QFileDialogdirectoryUrlEnteredSlot* = proc(directory: gen_qurl.QUrl)
...
proc getOpenFileName*(_: type gen_qfiledialog_types.QFileDialog, parent: gen_qwidget.QWidget): string =
  let v_ms = fcQFileDialog_getOpenFileName1(parent.h)
  let vx_ret = string.fromBytes(toOpenArrayByte(v_ms.data, 0, int(v_ms.len)-1))
  c_free(v_ms.data)
  vx_ret

proc getOpenFileName*(_: type gen_qfiledialog_types.QFileDialog, parent: gen_qwidget.QWidget, caption: string): string =
  let v_ms = fcQFileDialog_getOpenFileName2(parent.h, struct_miqt_string(data: caption, len: csize_t(len(caption))))
  let vx_ret = string.fromBytes(toOpenArrayByte(v_ms.data, 0, int(v_ms.len)-1))
  c_free(v_ms.data)
  vx_ret

proc getOpenFileName*(_: type gen_qfiledialog_types.QFileDialog, parent: gen_qwidget.QWidget, caption: string, dir: string): string =
...
proc getOpenFileName*(_: type gen_qfiledialog_types.QFileDialog, parent: gen_qwidget.QWidget, caption: string, dir: string, filter: string): string =
...
proc getOpenFileUrl*(_: type gen_qfiledialog_types.QFileDialog, parent: gen_qwidget.QWidget): gen_qurl.QUrl =
  gen_qurl.QUrl(h: fcQFileDialog_getOpenFileUrl1(parent.h))

proc getOpenFileUrl*(_: type gen_qfiledialog_types.QFileDialog, parent: gen_qwidget.QWidget, caption: string): gen_qurl.QUrl =
  gen_qurl.QUrl(h: fcQFileDialog_getOpenFileUrl2(parent.h, struct_miqt_string(data: caption, len: csize_t(len(caption)))))

proc getOpenFileUrl*(_: type gen_qfiledialog_types.QFileDialog, parent: gen_qwidget.QWidget, caption: string, dir: gen_qurl.QUrl): gen_qurl.QUrl =
  gen_qurl.QUrl(h: fcQFileDialog_getOpenFileUrl3(parent.h, struct_miqt_string(data: caption, len: csize_t(len(caption))), dir.h))

proc getOpenFileUrl*(_: type gen_qfiledialog_types.QFileDialog, parent: gen_qwidget.QWidget, caption: string, dir: gen_qurl.QUrl, filter: string): gen_qurl.QUrl =
...
proc getSaveFileName*(_: type gen_qfiledialog_types.QFileDialog, parent: gen_qwidget.QWidget): string =
  let v_ms = fcQFileDialog_getSaveFileName1(parent.h)
  let vx_ret = string.fromBytes(toOpenArrayByte(v_ms.data, 0, int(v_ms.len)-1))
  c_free(v_ms.data)
  vx_ret

proc getSaveFileName*(_: type gen_qfiledialog_types.QFileDialog, parent: gen_qwidget.QWidget, caption: string): string =
  let v_ms = fcQFileDialog_getSaveFileName2(parent.h, struct_miqt_string(data: caption, len: csize_t(len(caption))))
  let vx_ret = string.fromBytes(toOpenArrayByte(v_ms.data, 0, int(v_ms.len)-1))
  c_free(v_ms.data)
  vx_ret

proc getSaveFileName*(_: type gen_qfiledialog_types.QFileDialog, parent: gen_qwidget.QWidget, caption: string, dir: string): string =
...
proc getSaveFileName*(_: type gen_qfiledialog_types.QFileDialog, parent: gen_qwidget.QWidget, caption: string, dir: string, filter: string): string =
...
proc getSaveFileUrl*(_: type gen_qfiledialog_types.QFileDialog, parent: gen_qwidget.QWidget): gen_qurl.QUrl =
  gen_qurl.QUrl(h: fcQFileDialog_getSaveFileUrl1(parent.h))

proc getSaveFileUrl*(_: type gen_qfiledialog_types.QFileDialog, parent: gen_qwidget.QWidget, caption: string): gen_qurl.QUrl =
  gen_qurl.QUrl(h: fcQFileDialog_getSaveFileUrl2(parent.h, struct_miqt_string(data: caption, len: csize_t(len(caption)))))

proc getSaveFileUrl*(_: type gen_qfiledialog_types.QFileDialog, parent: gen_qwidget.QWidget, caption: string, dir: gen_qurl.QUrl): gen_qurl.QUrl =
  gen_qurl.QUrl(h: fcQFileDialog_getSaveFileUrl3(parent.h, struct_miqt_string(data: caption, len: csize_t(len(caption))), dir.h))

proc getSaveFileUrl*(_: type gen_qfiledialog_types.QFileDialog, parent: gen_qwidget.QWidget, caption: string, dir: gen_qurl.QUrl, filter: string): gen_qurl.QUrl =
...
proc getExistingDirectory*(_: type gen_qfiledialog_types.QFileDialog, parent: gen_qwidget.QWidget): string =
  let v_ms = fcQFileDialog_getExistingDirectory1(parent.h)
  let vx_ret = string.fromBytes(toOpenArrayByte(v_ms.data, 0, int(v_ms.len)-1))
  c_free(v_ms.data)
  vx_ret

proc getExistingDirectory*(_: type gen_qfiledialog_types.QFileDialog, parent: gen_qwidget.QWidget, caption: string): string =
  let v_ms = fcQFileDialog_getExistingDirectory2(parent.h, struct_miqt_string(data: caption, len: csize_t(len(caption))))
  let vx_ret = string.fromBytes(toOpenArrayByte(v_ms.data, 0, int(v_ms.len)-1))
  c_free(v_ms.data)
  vx_ret

proc getExistingDirectory*(_: type gen_qfiledialog_types.QFileDialog, parent: gen_qwidget.QWidget, caption: string, dir: string): string =
...
proc getExistingDirectory*(_: type gen_qfiledialog_types.QFileDialog, parent: gen_qwidget.QWidget, caption: string, dir: string, options: cint): string =
...
proc getExistingDirectoryUrl*(_: type gen_qfiledialog_types.QFileDialog, parent: gen_qwidget.QWidget): gen_qurl.QUrl =
  gen_qurl.QUrl(h: fcQFileDialog_getExistingDirectoryUrl1(parent.h))

proc getExistingDirectoryUrl*(_: type gen_qfiledialog_types.QFileDialog, parent: gen_qwidget.QWidget, caption: string): gen_qurl.QUrl =
  gen_qurl.QUrl(h: fcQFileDialog_getExistingDirectoryUrl2(parent.h, struct_miqt_string(data: caption, len: csize_t(len(caption)))))

proc getExistingDirectoryUrl*(_: type gen_qfiledialog_types.QFileDialog, parent: gen_qwidget.QWidget, caption: string, dir: gen_qurl.QUrl): gen_qurl.QUrl =
...
proc getExistingDirectoryUrl*(_: type gen_qfiledialog_types.QFileDialog, parent: gen_qwidget.QWidget, caption: string, dir: gen_qurl.QUrl, options: cint): gen_qurl.QUrl =
...
proc getExistingDirectoryUrl*(_: type gen_qfiledialog_types.QFileDialog, parent: gen_qwidget.QWidget, caption: string, dir: gen_qurl.QUrl, options: cint, supportedSchemes: seq[string]): gen_qurl.QUrl =
...
proc getOpenFileNames*(_: type gen_qfiledialog_types.QFileDialog, parent: gen_qwidget.QWidget): seq[string] =
...
proc getOpenFileNames*(_: type gen_qfiledialog_types.QFileDialog, parent: gen_qwidget.QWidget, caption: string): seq[string] =
...
proc getOpenFileNames*(_: type gen_qfiledialog_types.QFileDialog, parent: gen_qwidget.QWidget, caption: string, dir: string): seq[string] =
...
proc getOpenFileNames*(_: type gen_qfiledialog_types.QFileDialog, parent: gen_qwidget.QWidget, caption: string, dir: string, filter: string): seq[string] =
...
proc getOpenFileUrls*(_: type gen_qfiledialog_types.QFileDialog, parent: gen_qwidget.QWidget): seq[gen_qurl.QUrl] =
...
proc getOpenFileUrls*(_: type gen_qfiledialog_types.QFileDialog, parent: gen_qwidget.QWidget, caption: string): seq[gen_qurl.QUrl] =
...
proc getOpenFileUrls*(_: type gen_qfiledialog_types.QFileDialog, parent: gen_qwidget.QWidget, caption: string, dir: gen_qurl.QUrl): seq[gen_qurl.QUrl] =
...
proc getOpenFileUrls*(_: type gen_qfiledialog_types.QFileDialog, parent: gen_qwidget.QWidget, caption: string, dir: gen_qurl.QUrl, filter: string): seq[gen_qurl.QUrl] =
...
proc miqt_exec_callback_QFileDialog_focusOutEvent(self: ptr cQFileDialog, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QFileDialog_focusOutEvent ".} =
  ...
  nimfunc[](slotval1)
proc QFileDialogenterEvent*(self: gen_qfiledialog_types.QFileDialog, event: gen_qcoreevent.QEvent): void =
  fQFileDialog_virtualbase_enterEvent(self.h, event.h)

type QFileDialogenterEventProc* = proc(event: gen_qcoreevent.QEvent): void
