...
proc trUtf82*(_: type gen_qfiledialog_types.QFileDialog, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type gen_qfiledialog_types.QFileDialog, s: cstring, c: cstring, n: cint): string =
