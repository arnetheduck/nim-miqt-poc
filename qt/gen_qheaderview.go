...
func (this *QHeaderView) Metacall(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {
	return (int)(C.QHeaderView_metacall(this.h, (C.int)(param1), (C.int)(param2), param3))
}
...
func (this *QHeaderView) callVirtualBase_MetaObject() *QMetaObject {
	...
	return newQMetaObject(C.QHeaderView_virtualbase_metaObject(unsafe.Pointer(this.h)))

}
func (this *QHeaderView) OnMetaObject(slot func(super func() *QMetaObject) *QMetaObject) {
	ok := C.QHeaderView_override_virtual_metaObject(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
...
func miqt_exec_callback_QHeaderView_metaObject(self *C.QHeaderView, cb C.intptr_t) *C.QMetaObject {
...
func (this *QHeaderView) callVirtualBase_Metacast(param1 string) unsafe.Pointer {
	...
	return (unsafe.Pointer)(C.QHeaderView_virtualbase_metacast(unsafe.Pointer(this.h), param1_Cstring))

}
func (this *QHeaderView) OnMetacast(slot func(super func(param1 string) unsafe.Pointer, param1 string) unsafe.Pointer) {
	ok := C.QHeaderView_override_virtual_metacast(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func miqt_exec_callback_QHeaderView_metacast(self *C.QHeaderView, cb C.intptr_t, param1 *C.const_char) unsafe.Pointer {
...
func (this *QHeaderView) callVirtualBase_Metacall(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {

	return (int)(C.QHeaderView_virtualbase_metacall(unsafe.Pointer(this.h), (C.int)(param1), (C.int)(param2), param3))

}
func (this *QHeaderView) OnMetacall(slot func(super func(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int, param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int) {
	ok := C.QHeaderView_override_virtual_metacall(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}

//export miqt_exec_callback_QHeaderView_metacall
func miqt_exec_callback_QHeaderView_metacall(self *C.QHeaderView, cb C.intptr_t, param1 C.int, param2 C.int, param3 unsafe.Pointer) C.int {
	...
	virtualReturn := gofunc((&QHeaderView{h: self}).callVirtualBase_Metacall, slotval1, slotval2, slotval3)
...
func (this *QHeaderView) OnViewOptions(slot func(super func() *QStyleOptionViewItem) *QStyleOptionViewItem) {
	ok := C.QHeaderView_override_virtual_viewOptions(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}

//export miqt_exec_callback_QHeaderView_viewOptions
func miqt_exec_callback_QHeaderView_viewOptions(self *C.QHeaderView, cb C.intptr_t) *C.QStyleOptionViewItem {
...
func (this *QHeaderView) callVirtualBase_EnterEvent(event *QEvent) {

	C.QHeaderView_virtualbase_enterEvent(unsafe.Pointer(this.h), event.cPointer())

}
func (this *QHeaderView) OnEnterEvent(slot func(super func(event *QEvent), event *QEvent)) {
...
func miqt_exec_callback_QHeaderView_enterEvent(self *C.QHeaderView, cb C.intptr_t, event *C.QEvent) {
...
func (this *QHeaderView) OnNativeEvent(slot func(super func(eventType []byte, message unsafe.Pointer, result *int64) bool, eventType []byte, message unsafe.Pointer, result *int64) bool) {
...
func miqt_exec_callback_QHeaderView_nativeEvent(self *C.QHeaderView, cb C.intptr_t, eventType C.struct_miqt_string, message unsafe.Pointer, result *C.long) C.bool {
