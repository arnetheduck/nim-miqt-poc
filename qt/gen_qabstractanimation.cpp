...
public:
	...
	// Wrapper to allow calling protected method
	void protectedbase_advanceAnimation1(long long timeStep) {

		QAnimationDriver::advanceAnimation(static_cast<qint64>(timeStep));
...
void QAnimationDriver_protectedbase_advanceAnimation1(void* self, long long timeStep) {
	( (MiqtVirtualQAnimationDriver*)(self) )->protectedbase_advanceAnimation1(timeStep);
}
