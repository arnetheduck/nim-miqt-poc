...
proc trUtf82*(_: type gen_qundogroup_types.QUndoGroup, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type gen_qundogroup_types.QUndoGroup, s: cstring, c: cstring, n: cint): string =
