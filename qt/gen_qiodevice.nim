...
proc trUtf82*(_: type gen_qiodevice_types.QIODevice, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type gen_qiodevice_types.QIODevice, s: cstring, c: cstring, n: cint): string =
