...
func init*(T: type QSslCertificateExtension, h: ptr cQSslCertificateExtension): QSslCertificateExtension =
  T(h: h)
proc create*(T: type QSslCertificateExtension, ): QSslCertificateExtension =

  QSslCertificateExtension.init(fcQSslCertificateExtension_new())
proc create*(T: type QSslCertificateExtension, other: QSslCertificateExtension): QSslCertificateExtension =

  QSslCertificateExtension.init(fcQSslCertificateExtension_new2(other.h))
proc operatorAssign*(self: QSslCertificateExtension, other: QSslCertificateExtension): void =

  fcQSslCertificateExtension_operatorAssign(self.h, other.h)

proc swap*(self: QSslCertificateExtension, other: QSslCertificateExtension): void =

  fcQSslCertificateExtension_swap(self.h, other.h)

proc oid*(self: QSslCertificateExtension, ): string =
...
proc name*(self: QSslCertificateExtension, ): string =
...
proc value*(self: QSslCertificateExtension, ): gen_qvariant.QVariant =

  gen_qvariant.QVariant(h: fcQSslCertificateExtension_value(self.h))

proc isCritical*(self: QSslCertificateExtension, ): bool =

  fcQSslCertificateExtension_isCritical(self.h)

proc isSupported*(self: QSslCertificateExtension, ): bool =

  fcQSslCertificateExtension_isSupported(self.h)

proc delete*(self: QSslCertificateExtension) =
