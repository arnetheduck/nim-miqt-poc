...
proc trUtf8*(_: type QLocalSocket, s: cstring): string =
...
proc open*(self: QLocalSocket, openMode: gen_qiodevice.QIODeviceOpenModeFlag): bool =
...
proc errorWithSocketError*(self: QLocalSocket, socketError: QLocalSocketLocalSocketError): void =
...
proc onerrorWithSocketError*(self: QLocalSocket, slot: proc(socketError: QLocalSocketLocalSocketError)) =
  type Cb = proc(socketError: QLocalSocketLocalSocketError)
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc trUtf82*(_: type QLocalSocket, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type QLocalSocket, s: cstring, c: cstring, n: cint): string =
...
proc connectToServer1*(self: QLocalSocket, openMode: gen_qiodevice.QIODeviceOpenModeFlag): void =

  fcQLocalSocket_connectToServer1(self.h, cint(openMode))

proc connectToServer2*(self: QLocalSocket, name: string, openMode: gen_qiodevice.QIODeviceOpenModeFlag): void =
...
proc setSocketDescriptor3*(self: QLocalSocket, socketDescriptor: uint, socketState: QLocalSocketLocalSocketState, openMode: gen_qiodevice.QIODeviceOpenModeFlag): bool =
...
proc miqt_exec_callback_QLocalSocket_canReadLine(self: ptr cQLocalSocket, slot: int): bool {.exportc: "miqt_exec_callback_QLocalSocket_canReadLine ".} =
  ...
  virtualReturn
proc callVirtualBase_open(self: QLocalSocket, openMode: gen_qiodevice.QIODeviceOpenModeFlag): bool =


  fQLocalSocket_virtualbase_open(self.h, cint(openMode))

type QLocalSocketopenBase* = proc(openMode: gen_qiodevice.QIODeviceOpenModeFlag): bool
proc onopen*(self: QLocalSocket, slot: proc(super: QLocalSocketopenBase, openMode: gen_qiodevice.QIODeviceOpenModeFlag): bool) =
  # TODO check subclass
  type Cb = proc(super: QLocalSocketopenBase, openMode: gen_qiodevice.QIODeviceOpenModeFlag): bool
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QLocalSocket_reset(self: ptr cQLocalSocket, slot: int): bool {.exportc: "miqt_exec_callback_QLocalSocket_reset ".} =
  ...
  virtualReturn
proc callVirtualBase_readLineData(self: QLocalSocket, data: cstring, maxlen: clonglong): clonglong =


  fQLocalSocket_virtualbase_readLineData(self.h, data, maxlen)

type QLocalSocketreadLineDataBase* = proc(data: cstring, maxlen: clonglong): clonglong
proc onreadLineData*(self: QLocalSocket, slot: proc(super: QLocalSocketreadLineDataBase, data: cstring, maxlen: clonglong): clonglong) =
  # TODO check subclass
  type Cb = proc(super: QLocalSocketreadLineDataBase, data: cstring, maxlen: clonglong): clonglong
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QLocalSocket_readLineData(self: ptr cQLocalSocket, slot: int, data: cstring, maxlen: clonglong): clonglong {.exportc: "miqt_exec_callback_QLocalSocket_readLineData ".} =
  ...
  proc superCall(data: cstring, maxlen: clonglong): auto =
    callVirtualBase_readLineData(QLocalSocket(h: self), data, maxlen)
  let slotval1 = (data)
