...
proc trUtf82*(_: type gen_qtcpsocket_types.QTcpSocket, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type gen_qtcpsocket_types.QTcpSocket, s: cstring, c: cstring, n: cint): string =
