...
proc trUtf8*(_: type QTcpSocket, s: cstring): string =
...
proc trUtf82*(_: type QTcpSocket, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type QTcpSocket, s: cstring, c: cstring, n: cint): string =
...
proc callVirtualBase_metaObject(self: QTcpSocket, ): gen_qobjectdefs.QMetaObject =


  gen_qobjectdefs.QMetaObject(h: fQTcpSocket_virtualbase_metaObject(self.h))

type QTcpSocketmetaObjectBase* = proc(): gen_qobjectdefs.QMetaObject
proc onmetaObject*(self: QTcpSocket, slot: proc(super: QTcpSocketmetaObjectBase): gen_qobjectdefs.QMetaObject) =
  # TODO check subclass
  type Cb = proc(super: QTcpSocketmetaObjectBase): gen_qobjectdefs.QMetaObject
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QTcpSocket_metaObject(self: ptr cQTcpSocket, slot: int): pointer {.exportc: "miqt_exec_callback_QTcpSocket_metaObject ".} =
  ...
  proc superCall(): auto =
    callVirtualBase_metaObject(QTcpSocket(h: self), )

  let virtualReturn = nimfunc[](superCall )

  virtualReturn.h
proc callVirtualBase_metacast(self: QTcpSocket, param1: cstring): pointer =


  fQTcpSocket_virtualbase_metacast(self.h, param1)

type QTcpSocketmetacastBase* = proc(param1: cstring): pointer
proc onmetacast*(self: QTcpSocket, slot: proc(super: QTcpSocketmetacastBase, param1: cstring): pointer) =
  # TODO check subclass
  type Cb = proc(super: QTcpSocketmetacastBase, param1: cstring): pointer
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QTcpSocket_metacast(self: ptr cQTcpSocket, slot: int, param1: cstring): pointer {.exportc: "miqt_exec_callback_QTcpSocket_metacast ".} =
  ...
  proc superCall(param1: cstring): auto =
    callVirtualBase_metacast(QTcpSocket(h: self), param1)
  let slotval1 = (param1)
...
proc miqt_exec_callback_QTcpSocket_resume(self: ptr cQTcpSocket, slot: int): void {.exportc: "miqt_exec_callback_QTcpSocket_resume ".} =
  ...
  nimfunc[](superCall)
proc callVirtualBase_connectToHost(self: QTcpSocket, hostName: string, port: cushort, mode: gen_qiodevice.QIODeviceOpenModeFlag, protocol: gen_qabstractsocket.QAbstractSocketNetworkLayerProtocol): void =
...
type QTcpSocketconnectToHostBase* = proc(hostName: string, port: cushort, mode: gen_qiodevice.QIODeviceOpenModeFlag, protocol: gen_qabstractsocket.QAbstractSocketNetworkLayerProtocol): void
proc onconnectToHost*(self: QTcpSocket, slot: proc(super: QTcpSocketconnectToHostBase, hostName: string, port: cushort, mode: gen_qiodevice.QIODeviceOpenModeFlag, protocol: gen_qabstractsocket.QAbstractSocketNetworkLayerProtocol): void) =
  # TODO check subclass
  type Cb = proc(super: QTcpSocketconnectToHostBase, hostName: string, port: cushort, mode: gen_qiodevice.QIODeviceOpenModeFlag, protocol: gen_qabstractsocket.QAbstractSocketNetworkLayerProtocol): void
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QTcpSocket_socketDescriptor(self: ptr cQTcpSocket, slot: int): uint {.exportc: "miqt_exec_callback_QTcpSocket_socketDescriptor ".} =
  ...
  virtualReturn
proc callVirtualBase_setSocketDescriptor(self: QTcpSocket, socketDescriptor: uint, state: gen_qabstractsocket.QAbstractSocketSocketState, openMode: gen_qiodevice.QIODeviceOpenModeFlag): bool =


  fQTcpSocket_virtualbase_setSocketDescriptor(self.h, socketDescriptor, cint(state), cint(openMode))

type QTcpSocketsetSocketDescriptorBase* = proc(socketDescriptor: uint, state: gen_qabstractsocket.QAbstractSocketSocketState, openMode: gen_qiodevice.QIODeviceOpenModeFlag): bool
proc onsetSocketDescriptor*(self: QTcpSocket, slot: proc(super: QTcpSocketsetSocketDescriptorBase, socketDescriptor: uint, state: gen_qabstractsocket.QAbstractSocketSocketState, openMode: gen_qiodevice.QIODeviceOpenModeFlag): bool) =
  # TODO check subclass
  type Cb = proc(super: QTcpSocketsetSocketDescriptorBase, socketDescriptor: uint, state: gen_qabstractsocket.QAbstractSocketSocketState, openMode: gen_qiodevice.QIODeviceOpenModeFlag): bool
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QTcpSocket_writeData(self: ptr cQTcpSocket, slot: int, data: cstring, len: clonglong): clonglong {.exportc: "miqt_exec_callback_QTcpSocket_writeData ".} =
  ...
  virtualReturn
proc callVirtualBase_open(self: QTcpSocket, mode: gen_qiodevice.QIODeviceOpenModeFlag): bool =


  fQTcpSocket_virtualbase_open(self.h, cint(mode))

type QTcpSocketopenBase* = proc(mode: gen_qiodevice.QIODeviceOpenModeFlag): bool
proc onopen*(self: QTcpSocket, slot: proc(super: QTcpSocketopenBase, mode: gen_qiodevice.QIODeviceOpenModeFlag): bool) =
  # TODO check subclass
  type Cb = proc(super: QTcpSocketopenBase, mode: gen_qiodevice.QIODeviceOpenModeFlag): bool
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
