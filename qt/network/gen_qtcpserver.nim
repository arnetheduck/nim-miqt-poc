...
proc trUtf8*(_: type QTcpServer, s: cstring): string =
...
proc trUtf82*(_: type QTcpServer, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type QTcpServer, s: cstring, c: cstring, n: cint): string =
