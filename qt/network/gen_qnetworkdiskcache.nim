...
proc trUtf8*(_: type QNetworkDiskCache, s: cstring): string =
...
proc trUtf82*(_: type QNetworkDiskCache, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type QNetworkDiskCache, s: cstring, c: cstring, n: cint): string =
