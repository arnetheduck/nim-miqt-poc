...
proc tr2*(_: type gen_qhttpmultipart_types.QHttpMultiPart, s: cstring, c: cstring): string =
...
proc tr3*(_: type gen_qhttpmultipart_types.QHttpMultiPart, s: cstring, c: cstring, n: cint): string =
...
proc trUtf82*(_: type gen_qhttpmultipart_types.QHttpMultiPart, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type gen_qhttpmultipart_types.QHttpMultiPart, s: cstring, c: cstring, n: cint): string =
