...
proc trUtf8*(_: type QAbstractNetworkCache, s: cstring): string =
...
proc trUtf82*(_: type QAbstractNetworkCache, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type QAbstractNetworkCache, s: cstring, c: cstring, n: cint): string =
