...
proc trUtf8*(_: type QAbstractSocket, s: cstring): string =
...
proc bindX*(self: QAbstractSocket, address: gen_qhostaddress.QHostAddress): bool =
...
proc connectToHost*(self: QAbstractSocket, hostName: string, port: cushort, mode: gen_qiodevice.QIODeviceOpenModeFlag, protocol: QAbstractSocketNetworkLayerProtocol): void =
...
proc connectToHost2*(self: QAbstractSocket, address: gen_qhostaddress.QHostAddress, port: cushort, mode: gen_qiodevice.QIODeviceOpenModeFlag): void =
...
proc canReadLine*(self: QAbstractSocket, ): bool =
...
proc setSocketDescriptor*(self: QAbstractSocket, socketDescriptor: uint, state: QAbstractSocketSocketState, openMode: gen_qiodevice.QIODeviceOpenModeFlag): bool =
...
proc atEnd*(self: QAbstractSocket, ): bool =
...
proc errorWithQAbstractSocketSocketError*(self: QAbstractSocket, param1: QAbstractSocketSocketError): void =
...
proc onerrorWithQAbstractSocketSocketError*(self: QAbstractSocket, slot: proc(param1: QAbstractSocketSocketError)) =
  type Cb = proc(param1: QAbstractSocketSocketError)
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc trUtf82*(_: type QAbstractSocket, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type QAbstractSocket, s: cstring, c: cstring, n: cint): string =
...
proc bind22*(self: QAbstractSocket, address: gen_qhostaddress.QHostAddress, port: cushort): bool =

  fcQAbstractSocket_bind22(self.h, address.h, port)

proc bind3*(self: QAbstractSocket, address: gen_qhostaddress.QHostAddress, port: cushort, mode: QAbstractSocketBindFlag): bool =
...
proc bind23*(self: QAbstractSocket, port: cushort, mode: QAbstractSocketBindFlag): bool =
...
proc miqt_exec_callback_QAbstractSocket_resume(self: ptr cQAbstractSocket, slot: int): void {.exportc: "miqt_exec_callback_QAbstractSocket_resume ".} =
  ...
  nimfunc[](superCall)
proc callVirtualBase_connectToHost(self: QAbstractSocket, hostName: string, port: cushort, mode: gen_qiodevice.QIODeviceOpenModeFlag, protocol: QAbstractSocketNetworkLayerProtocol): void =
...
type QAbstractSocketconnectToHostBase* = proc(hostName: string, port: cushort, mode: gen_qiodevice.QIODeviceOpenModeFlag, protocol: QAbstractSocketNetworkLayerProtocol): void
proc onconnectToHost*(self: QAbstractSocket, slot: proc(super: QAbstractSocketconnectToHostBase, hostName: string, port: cushort, mode: gen_qiodevice.QIODeviceOpenModeFlag, protocol: QAbstractSocketNetworkLayerProtocol): void) =
  # TODO check subclass
  type Cb = proc(super: QAbstractSocketconnectToHostBase, hostName: string, port: cushort, mode: gen_qiodevice.QIODeviceOpenModeFlag, protocol: QAbstractSocketNetworkLayerProtocol): void
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QAbstractSocket_connectToHost(self: ptr cQAbstractSocket, slot: int, hostName: struct_miqt_string, port: cushort, mode: cint, protocol: cint): void {.exportc: "miqt_exec_callback_QAbstractSocket_connectToHost ".} =
  type Cb = proc(super: QAbstractSocketconnectToHostBase, hostName: string, port: cushort, mode: gen_qiodevice.QIODeviceOpenModeFlag, protocol: QAbstractSocketNetworkLayerProtocol): void
  var nimfunc = cast[ptr Cb](cast[pointer](slot))
  proc superCall(hostName: string, port: cushort, mode: gen_qiodevice.QIODeviceOpenModeFlag, protocol: QAbstractSocketNetworkLayerProtocol): auto =
...
proc callVirtualBase_connectToHost2(self: QAbstractSocket, address: gen_qhostaddress.QHostAddress, port: cushort, mode: gen_qiodevice.QIODeviceOpenModeFlag): void =


  fQAbstractSocket_virtualbase_connectToHost2(self.h, address.h, port, cint(mode))

type QAbstractSocketconnectToHost2Base* = proc(address: gen_qhostaddress.QHostAddress, port: cushort, mode: gen_qiodevice.QIODeviceOpenModeFlag): void
proc onconnectToHost2*(self: QAbstractSocket, slot: proc(super: QAbstractSocketconnectToHost2Base, address: gen_qhostaddress.QHostAddress, port: cushort, mode: gen_qiodevice.QIODeviceOpenModeFlag): void) =
  # TODO check subclass
  type Cb = proc(super: QAbstractSocketconnectToHost2Base, address: gen_qhostaddress.QHostAddress, port: cushort, mode: gen_qiodevice.QIODeviceOpenModeFlag): void
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QAbstractSocket_connectToHost2(self: ptr cQAbstractSocket, slot: int, address: pointer, port: cushort, mode: cint): void {.exportc: "miqt_exec_callback_QAbstractSocket_connectToHost2 ".} =
  type Cb = proc(super: QAbstractSocketconnectToHost2Base, address: gen_qhostaddress.QHostAddress, port: cushort, mode: gen_qiodevice.QIODeviceOpenModeFlag): void
  var nimfunc = cast[ptr Cb](cast[pointer](slot))
  proc superCall(address: gen_qhostaddress.QHostAddress, port: cushort, mode: gen_qiodevice.QIODeviceOpenModeFlag): auto =
    callVirtualBase_connectToHost2(QAbstractSocket(h: self), address, port, mode)
...
proc miqt_exec_callback_QAbstractSocket_socketDescriptor(self: ptr cQAbstractSocket, slot: int): uint {.exportc: "miqt_exec_callback_QAbstractSocket_socketDescriptor ".} =
  ...
  virtualReturn
proc callVirtualBase_setSocketDescriptor(self: QAbstractSocket, socketDescriptor: uint, state: QAbstractSocketSocketState, openMode: gen_qiodevice.QIODeviceOpenModeFlag): bool =


  fQAbstractSocket_virtualbase_setSocketDescriptor(self.h, socketDescriptor, cint(state), cint(openMode))

type QAbstractSocketsetSocketDescriptorBase* = proc(socketDescriptor: uint, state: QAbstractSocketSocketState, openMode: gen_qiodevice.QIODeviceOpenModeFlag): bool
proc onsetSocketDescriptor*(self: QAbstractSocket, slot: proc(super: QAbstractSocketsetSocketDescriptorBase, socketDescriptor: uint, state: QAbstractSocketSocketState, openMode: gen_qiodevice.QIODeviceOpenModeFlag): bool) =
  # TODO check subclass
  type Cb = proc(super: QAbstractSocketsetSocketDescriptorBase, socketDescriptor: uint, state: QAbstractSocketSocketState, openMode: gen_qiodevice.QIODeviceOpenModeFlag): bool
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QAbstractSocket_setSocketDescriptor(self: ptr cQAbstractSocket, slot: int, socketDescriptor: uint, state: cint, openMode: cint): bool {.exportc: "miqt_exec_callback_QAbstractSocket_setSocketDescriptor ".} =
  type Cb = proc(super: QAbstractSocketsetSocketDescriptorBase, socketDescriptor: uint, state: QAbstractSocketSocketState, openMode: gen_qiodevice.QIODeviceOpenModeFlag): bool
  var nimfunc = cast[ptr Cb](cast[pointer](slot))
  proc superCall(socketDescriptor: uint, state: QAbstractSocketSocketState, openMode: gen_qiodevice.QIODeviceOpenModeFlag): auto =
...
proc miqt_exec_callback_QAbstractSocket_writeData(self: ptr cQAbstractSocket, slot: int, data: cstring, len: clonglong): clonglong {.exportc: "miqt_exec_callback_QAbstractSocket_writeData ".} =
  ...
  virtualReturn
proc callVirtualBase_open(self: QAbstractSocket, mode: gen_qiodevice.QIODeviceOpenModeFlag): bool =


  fQAbstractSocket_virtualbase_open(self.h, cint(mode))

type QAbstractSocketopenBase* = proc(mode: gen_qiodevice.QIODeviceOpenModeFlag): bool
proc onopen*(self: QAbstractSocket, slot: proc(super: QAbstractSocketopenBase, mode: gen_qiodevice.QIODeviceOpenModeFlag): bool) =
  # TODO check subclass
  type Cb = proc(super: QAbstractSocketopenBase, mode: gen_qiodevice.QIODeviceOpenModeFlag): bool
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
