...
proc trUtf8*(_: type QLocalServer, s: cstring): string =
...
proc trUtf82*(_: type QLocalServer, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type QLocalServer, s: cstring, c: cstring, n: cint): string =
