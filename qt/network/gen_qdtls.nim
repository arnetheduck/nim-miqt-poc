...
proc trUtf8*(_: type QDtlsClientVerifier, s: cstring): string =
...
proc trUtf82*(_: type QDtlsClientVerifier, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type QDtlsClientVerifier, s: cstring, c: cstring, n: cint): string =
...
proc trUtf8*(_: type QDtls, s: cstring): string =
...
proc trUtf82*(_: type QDtls, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type QDtls, s: cstring, c: cstring, n: cint): string =
