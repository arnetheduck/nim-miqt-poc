...
func (this *QListWidgetItem) BackgroundColor() *QColor {
	_goptr := newQColor(C.QListWidgetItem_backgroundColor(this.h))
	_goptr.GoGC() // Qt uses pass-by-value semantics for this type. Mimic with finalizer
	return _goptr
}
...
func (this *QListWidgetItem) TextColor() *QColor {
	_goptr := newQColor(C.QListWidgetItem_textColor(this.h))
	_goptr.GoGC() // Qt uses pass-by-value semantics for this type. Mimic with finalizer
	return _goptr
}
...
func (this *QListWidgetItem) OnSetBackgroundColor(slot func(super func(color *QColor), color *QColor)) {
	ok := C.QListWidgetItem_override_virtual_setBackgroundColor(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func (this *QListWidget) Metacall(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {
	return (int)(C.QListWidget_metacall(this.h, (C.int)(param1), (C.int)(param2), param3))
}
...
func (this *QListWidget) callVirtualBase_MetaObject() *QMetaObject {
	...
	return newQMetaObject(C.QListWidget_virtualbase_metaObject(unsafe.Pointer(this.h)))

}
func (this *QListWidget) OnmetaObject(slot func(super func() *QMetaObject) *QMetaObject) {
	ok := C.QListWidget_override_virtual_metaObject(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func miqt_exec_callback_QListWidget_metaObject(self *C.QListWidget, cb C.intptr_t) *C.QMetaObject {
...
func (this *QListWidget) callVirtualBase_Metacast(param1 string) unsafe.Pointer {
	...
	return (unsafe.Pointer)(C.QListWidget_virtualbase_metacast(unsafe.Pointer(this.h), param1_Cstring))

}
func (this *QListWidget) Onmetacast(slot func(super func(param1 string) unsafe.Pointer, param1 string) unsafe.Pointer) {
	ok := C.QListWidget_override_virtual_metacast(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func miqt_exec_callback_QListWidget_metacast(self *C.QListWidget, cb C.intptr_t, param1 *C.const_char) unsafe.Pointer {
...
func (this *QListWidget) callVirtualBase_Metacall(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {

	return (int)(C.QListWidget_virtualbase_metacall(unsafe.Pointer(this.h), (C.int)(param1), (C.int)(param2), param3))

}
func (this *QListWidget) OnMetacall(slot func(super func(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int, param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int) {
	ok := C.QListWidget_override_virtual_metacall(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}

//export miqt_exec_callback_QListWidget_metacall
func miqt_exec_callback_QListWidget_metacall(self *C.QListWidget, cb C.intptr_t, param1 C.int, param2 C.int, param3 unsafe.Pointer) C.int {
	...
	virtualReturn := gofunc((&QListWidget{h: self}).callVirtualBase_Metacall, slotval1, slotval2, slotval3)
...
func (this *QListWidget) OnViewOptions(slot func(super func() *QStyleOptionViewItem) *QStyleOptionViewItem) {
	ok := C.QListWidget_override_virtual_viewOptions(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func (this *QListWidget) callVirtualBase_EnterEvent(event *QEvent) {

	C.QListWidget_virtualbase_enterEvent(unsafe.Pointer(this.h), event.cPointer())

}
func (this *QListWidget) OnEnterEvent(slot func(super func(event *QEvent), event *QEvent)) {
...
func miqt_exec_callback_QListWidget_enterEvent(self *C.QListWidget, cb C.intptr_t, event *C.QEvent) {
...
func (this *QListWidget) OnNativeEvent(slot func(super func(eventType []byte, message unsafe.Pointer, result *int64) bool, eventType []byte, message unsafe.Pointer, result *int64) bool) {
...
func miqt_exec_callback_QListWidget_nativeEvent(self *C.QListWidget, cb C.intptr_t, eventType C.struct_miqt_string, message unsafe.Pointer, result *C.long) C.bool {
