...
func (this *QAbstractButton) Metacall(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {
	return (int)(C.QAbstractButton_metacall(this.h, (C.int)(param1), (C.int)(param2), param3))
}
...
func (this *QAbstractButton) callVirtualBase_MetaObject() *QMetaObject {
	...
	return newQMetaObject(C.QAbstractButton_virtualbase_metaObject(unsafe.Pointer(this.h)))

}
func (this *QAbstractButton) OnmetaObject(slot func(super func() *QMetaObject) *QMetaObject) {
	ok := C.QAbstractButton_override_virtual_metaObject(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
...
func miqt_exec_callback_QAbstractButton_metaObject(self *C.QAbstractButton, cb C.intptr_t) *C.QMetaObject {
...
func (this *QAbstractButton) callVirtualBase_Metacast(param1 string) unsafe.Pointer {
	...
	return (unsafe.Pointer)(C.QAbstractButton_virtualbase_metacast(unsafe.Pointer(this.h), param1_Cstring))

}
func (this *QAbstractButton) Onmetacast(slot func(super func(param1 string) unsafe.Pointer, param1 string) unsafe.Pointer) {
	ok := C.QAbstractButton_override_virtual_metacast(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func miqt_exec_callback_QAbstractButton_metacast(self *C.QAbstractButton, cb C.intptr_t, param1 *C.const_char) unsafe.Pointer {
...
func (this *QAbstractButton) callVirtualBase_Metacall(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {

	return (int)(C.QAbstractButton_virtualbase_metacall(unsafe.Pointer(this.h), (C.int)(param1), (C.int)(param2), param3))

}
func (this *QAbstractButton) OnMetacall(slot func(super func(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int, param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int) {
	ok := C.QAbstractButton_override_virtual_metacall(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}

//export miqt_exec_callback_QAbstractButton_metacall
func miqt_exec_callback_QAbstractButton_metacall(self *C.QAbstractButton, cb C.intptr_t, param1 C.int, param2 C.int, param3 unsafe.Pointer) C.int {
	...
	virtualReturn := gofunc((&QAbstractButton{h: self}).callVirtualBase_Metacall, slotval1, slotval2, slotval3)
...
func (this *QAbstractButton) callVirtualBase_EnterEvent(event *QEvent) {
...
func miqt_exec_callback_QAbstractButton_enterEvent(self *C.QAbstractButton, cb C.intptr_t, event *C.QEvent) {
...
func miqt_exec_callback_QAbstractButton_nativeEvent(self *C.QAbstractButton, cb C.intptr_t, eventType C.struct_miqt_string, message unsafe.Pointer, result *C.long) C.bool {
