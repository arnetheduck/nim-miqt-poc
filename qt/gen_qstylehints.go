...
func (this *QStyleHints) Metacall(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {
	return (int)(C.QStyleHints_metacall(this.h, (C.int)(param1), (C.int)(param2), param3))
}
