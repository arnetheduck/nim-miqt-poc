...
func (this *QStateMachine) callVirtualBase_MetaObject() *QMetaObject {

	return newQMetaObject(C.QStateMachine_virtualbase_metaObject(unsafe.Pointer(this.h)))

}
func (this *QStateMachine) OnmetaObject(slot func(super func() *QMetaObject) *QMetaObject) {
	ok := C.QStateMachine_override_virtual_metaObject(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}

//export miqt_exec_callback_QStateMachine_metaObject
func miqt_exec_callback_QStateMachine_metaObject(self *C.QStateMachine, cb C.intptr_t) *C.QMetaObject {
	gofunc, ok := cgo.Handle(cb).Value().(func(super func() *QMetaObject) *QMetaObject)
	if !ok {
		panic("miqt: callback of non-callback type (heap corruption?)")
	}

	virtualReturn := gofunc((&QStateMachine{h: self}).callVirtualBase_MetaObject)

	return virtualReturn.cPointer()

}

func (this *QStateMachine) callVirtualBase_Metacast(param1 string) unsafe.Pointer {
	param1_Cstring := C.CString(param1)
	defer C.free(unsafe.Pointer(param1_Cstring))

	return (unsafe.Pointer)(C.QStateMachine_virtualbase_metacast(unsafe.Pointer(this.h), param1_Cstring))

}
func (this *QStateMachine) Onmetacast(slot func(super func(param1 string) unsafe.Pointer, param1 string) unsafe.Pointer) {
	ok := C.QStateMachine_override_virtual_metacast(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}

//export miqt_exec_callback_QStateMachine_metacast
func miqt_exec_callback_QStateMachine_metacast(self *C.QStateMachine, cb C.intptr_t, param1 *C.const_char) unsafe.Pointer {
	...
	virtualReturn := gofunc((&QStateMachine{h: self}).callVirtualBase_Metacast, slotval1)
