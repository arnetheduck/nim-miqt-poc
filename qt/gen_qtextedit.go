...
func (this *QTextEdit) Metacall(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {
	return (int)(C.QTextEdit_metacall(this.h, (C.int)(param1), (C.int)(param2), param3))
}
...
func (this *QTextEdit) callVirtualBase_MetaObject() *QMetaObject {
	...
	return newQMetaObject(C.QTextEdit_virtualbase_metaObject(unsafe.Pointer(this.h)))

}
func (this *QTextEdit) OnmetaObject(slot func(super func() *QMetaObject) *QMetaObject) {
	ok := C.QTextEdit_override_virtual_metaObject(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
...
func miqt_exec_callback_QTextEdit_metaObject(self *C.QTextEdit, cb C.intptr_t) *C.QMetaObject {
...
func (this *QTextEdit) callVirtualBase_Metacast(param1 string) unsafe.Pointer {
	...
	return (unsafe.Pointer)(C.QTextEdit_virtualbase_metacast(unsafe.Pointer(this.h), param1_Cstring))

}
func (this *QTextEdit) Onmetacast(slot func(super func(param1 string) unsafe.Pointer, param1 string) unsafe.Pointer) {
	ok := C.QTextEdit_override_virtual_metacast(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}
...
func miqt_exec_callback_QTextEdit_metacast(self *C.QTextEdit, cb C.intptr_t, param1 *C.const_char) unsafe.Pointer {
...
func (this *QTextEdit) callVirtualBase_Metacall(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {

	return (int)(C.QTextEdit_virtualbase_metacall(unsafe.Pointer(this.h), (C.int)(param1), (C.int)(param2), param3))

}
func (this *QTextEdit) OnMetacall(slot func(super func(param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int, param1 QMetaObject__Call, param2 int, param3 unsafe.Pointer) int) {
	ok := C.QTextEdit_override_virtual_metacall(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}

//export miqt_exec_callback_QTextEdit_metacall
func miqt_exec_callback_QTextEdit_metacall(self *C.QTextEdit, cb C.intptr_t, param1 C.int, param2 C.int, param3 unsafe.Pointer) C.int {
	...
	virtualReturn := gofunc((&QTextEdit{h: self}).callVirtualBase_Metacall, slotval1, slotval2, slotval3)
...
func (this *QTextEdit) callVirtualBase_EnterEvent(event *QEvent) {

	C.QTextEdit_virtualbase_enterEvent(unsafe.Pointer(this.h), event.cPointer())

}
func (this *QTextEdit) OnEnterEvent(slot func(super func(event *QEvent), event *QEvent)) {
...
func miqt_exec_callback_QTextEdit_enterEvent(self *C.QTextEdit, cb C.intptr_t, event *C.QEvent) {
...
func (this *QTextEdit) callVirtualBase_NativeEvent(eventType []byte, message unsafe.Pointer, result *int64) bool {
	...
	return (bool)(C.QTextEdit_virtualbase_nativeEvent(unsafe.Pointer(this.h), eventType_alias, message, (*C.long)(unsafe.Pointer(result))))

}
func (this *QTextEdit) OnNativeEvent(slot func(super func(eventType []byte, message unsafe.Pointer, result *int64) bool, eventType []byte, message unsafe.Pointer, result *int64) bool) {
...
func miqt_exec_callback_QTextEdit_nativeEvent(self *C.QTextEdit, cb C.intptr_t, eventType C.struct_miqt_string, message unsafe.Pointer, result *C.long) C.bool {
