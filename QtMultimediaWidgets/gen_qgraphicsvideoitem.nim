...
proc QGraphicsVideoItemmediaObject*(self: gen_qgraphicsvideoitem_types.QGraphicsVideoItem, ): gen_qmediaobject_types.QMediaObject =
  gen_qmediaobject_types.QMediaObject(h: fQGraphicsVideoItem_virtualbase_mediaObject(self.h))

type QGraphicsVideoItemmediaObjectProc* = proc(): gen_qmediaobject_types.QMediaObject
...
type QGraphicsVideoItemsetMediaObjectProc* = proc(objectVal: gen_qmediaobject_types.QMediaObject): bool
