...
func init*(T: type gen_qwebenginecertificateerror_types.QWebEngineCertificateError, h: ptr cQWebEngineCertificateError): gen_qwebenginecertificateerror_types.QWebEngineCertificateError =
  T(h: h)
proc create*(T: type gen_qwebenginecertificateerror_types.QWebEngineCertificateError, error: cint, url: gen_qurl_types.QUrl, overridable: bool, errorDescription: string): gen_qwebenginecertificateerror_types.QWebEngineCertificateError =
