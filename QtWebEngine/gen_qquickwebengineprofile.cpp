...
void QQuickWebEngineProfile_connect_useForGlobalCertificateVerificationChanged(QQuickWebEngineProfile* self, intptr_t slot) {
	MiqtVirtualQQuickWebEngineProfile::connect(self, static_cast<void (QQuickWebEngineProfile::*)()>(&QQuickWebEngineProfile::useForGlobalCertificateVerificationChanged), self, [=]() {
...
void QQuickWebEngineProfile_connect_downloadRequested(QQuickWebEngineProfile* self, intptr_t slot) {
	MiqtVirtualQQuickWebEngineProfile::connect(self, static_cast<void (QQuickWebEngineProfile::*)(QQuickWebEngineDownloadItem*)>(&QQuickWebEngineProfile::downloadRequested), self, [=](QQuickWebEngineDownloadItem* download) {
...
void QQuickWebEngineProfile_connect_downloadFinished(QQuickWebEngineProfile* self, intptr_t slot) {
	MiqtVirtualQQuickWebEngineProfile::connect(self, static_cast<void (QQuickWebEngineProfile::*)(QQuickWebEngineDownloadItem*)>(&QQuickWebEngineProfile::downloadFinished), self, [=](QQuickWebEngineDownloadItem* download) {
		QQuickWebEngineDownloadItem* sigval1 = download;
