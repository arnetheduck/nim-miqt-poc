...
void miqt_exec_callback_QQuickWebEngineProfile_useForGlobalCertificateVerificationChanged(intptr_t);
void miqt_exec_callback_QQuickWebEngineProfile_useForGlobalCertificateVerificationChanged_release(intptr_t);
...
void miqt_exec_callback_QQuickWebEngineProfile_downloadRequested(intptr_t, QQuickWebEngineDownloadItem*);
void miqt_exec_callback_QQuickWebEngineProfile_downloadRequested_release(intptr_t);
void miqt_exec_callback_QQuickWebEngineProfile_downloadFinished(intptr_t, QQuickWebEngineDownloadItem*);
...
public:
	...
	QMetaObject* virtualbase_metaObject() const {
		...
		return (QMetaObject*) QQuickWebEngineProfile::metaObject();
	...
	int virtualbase_metacall(int param1, int param2, void** param3) {
		...
		return QQuickWebEngineProfile::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
struct miqt_string QQuickWebEngineProfile_trUtf8(const char* s) {
	QString _ret = QQuickWebEngineProfile::trUtf8(s);
	// Convert QString from UTF-16 in C++ RAII memory to UTF-8 in manually-managed C memory
	QByteArray _b = _ret.toUtf8();
	struct miqt_string _ms;
	_ms.len = _b.length();
...
void QQuickWebEngineProfile_setRequestInterceptor(QQuickWebEngineProfile* self, QWebEngineUrlRequestInterceptor* interceptor) {
...
void QQuickWebEngineProfile_setUseForGlobalCertificateVerification(QQuickWebEngineProfile* self, bool b) {
	self->setUseForGlobalCertificateVerification(b);
}

bool QQuickWebEngineProfile_isUsedForGlobalCertificateVerification(const QQuickWebEngineProfile* self) {
...
void QQuickWebEngineProfile_useForGlobalCertificateVerificationChanged(QQuickWebEngineProfile* self) {
	self->useForGlobalCertificateVerificationChanged();
}

void QQuickWebEngineProfile_connect_useForGlobalCertificateVerificationChanged(QQuickWebEngineProfile* self, intptr_t slot) {
	struct caller {
		intptr_t slot;
		void operator()() {
			miqt_exec_callback_QQuickWebEngineProfile_useForGlobalCertificateVerificationChanged(slot);
		}
		caller(caller &&) = default;
		caller &operator=(caller &&) = default;
		caller(const caller &) = delete;
		caller &operator=(const caller &) = delete;
		~caller() { miqt_exec_callback_QQuickWebEngineProfile_useForGlobalCertificateVerificationChanged_release(slot); }
	};
	MiqtVirtualQQuickWebEngineProfile::connect(self, static_cast<void (QQuickWebEngineProfile::*)()>(&QQuickWebEngineProfile::useForGlobalCertificateVerificationChanged), self, caller{slot});
}
...
void QQuickWebEngineProfile_downloadRequested(QQuickWebEngineProfile* self, QQuickWebEngineDownloadItem* download) {
...
void QQuickWebEngineProfile_connect_downloadRequested(QQuickWebEngineProfile* self, intptr_t slot) {
	struct caller {
		intptr_t slot;
		void operator()(QQuickWebEngineDownloadItem* download) {
			QQuickWebEngineDownloadItem* sigval1 = download;
	...
	MiqtVirtualQQuickWebEngineProfile::connect(self, static_cast<void (QQuickWebEngineProfile::*)(QQuickWebEngineDownloadItem*)>(&QQuickWebEngineProfile::downloadRequested), self, caller{slot});
}

void QQuickWebEngineProfile_downloadFinished(QQuickWebEngineProfile* self, QQuickWebEngineDownloadItem* download) {
...
void QQuickWebEngineProfile_connect_downloadFinished(QQuickWebEngineProfile* self, intptr_t slot) {
	...
	MiqtVirtualQQuickWebEngineProfile::connect(self, static_cast<void (QQuickWebEngineProfile::*)(QQuickWebEngineDownloadItem*)>(&QQuickWebEngineProfile::downloadFinished), self, caller{slot});
}
...
struct miqt_string QQuickWebEngineProfile_trUtf82(const char* s, const char* c) {
	QString _ret = QQuickWebEngineProfile::trUtf8(s, c);
	// Convert QString from UTF-16 in C++ RAII memory to UTF-8 in manually-managed C memory
	QByteArray _b = _ret.toUtf8();
	struct miqt_string _ms;
	_ms.len = _b.length();
...
struct miqt_string QQuickWebEngineProfile_trUtf83(const char* s, const char* c, int n) {
	QString _ret = QQuickWebEngineProfile::trUtf8(s, c, static_cast<int>(n));
	// Convert QString from UTF-16 in C++ RAII memory to UTF-8 in manually-managed C memory
	QByteArray _b = _ret.toUtf8();
	struct miqt_string _ms;
	_ms.len = _b.length();
...
QMetaObject* QQuickWebEngineProfile_virtualbase_metaObject(const void* self) {
	return ( (const MiqtVirtualQQuickWebEngineProfile*)(self) )->virtualbase_metaObject();
}

void* QQuickWebEngineProfile_virtualbase_metacast(void* self, const char* param1) {
	return ( (MiqtVirtualQQuickWebEngineProfile*)(self) )->virtualbase_metacast(param1);
}

int QQuickWebEngineProfile_virtualbase_metacall(void* self, int param1, int param2, void** param3) {
	return ( (MiqtVirtualQQuickWebEngineProfile*)(self) )->virtualbase_metacall(param1, param2, param3);
}

bool QQuickWebEngineProfile_virtualbase_event(void* self, QEvent* event) {
	return ( (MiqtVirtualQQuickWebEngineProfile*)(self) )->virtualbase_event(event);
}

bool QQuickWebEngineProfile_virtualbase_eventFilter(void* self, QObject* watched, QEvent* event) {
	return ( (MiqtVirtualQQuickWebEngineProfile*)(self) )->virtualbase_eventFilter(watched, event);
}

void QQuickWebEngineProfile_virtualbase_timerEvent(void* self, QTimerEvent* event) {
	( (MiqtVirtualQQuickWebEngineProfile*)(self) )->virtualbase_timerEvent(event);
}

void QQuickWebEngineProfile_virtualbase_childEvent(void* self, QChildEvent* event) {
	( (MiqtVirtualQQuickWebEngineProfile*)(self) )->virtualbase_childEvent(event);
}

void QQuickWebEngineProfile_virtualbase_customEvent(void* self, QEvent* event) {
	( (MiqtVirtualQQuickWebEngineProfile*)(self) )->virtualbase_customEvent(event);
}

void QQuickWebEngineProfile_virtualbase_connectNotify(void* self, QMetaMethod* signal) {
	( (MiqtVirtualQQuickWebEngineProfile*)(self) )->virtualbase_connectNotify(signal);
}

void QQuickWebEngineProfile_virtualbase_disconnectNotify(void* self, QMetaMethod* signal) {
	( (MiqtVirtualQQuickWebEngineProfile*)(self) )->virtualbase_disconnectNotify(signal);
}
