...
proc fcQQuickWebEngineProfile_trUtf8(s: cstring): struct_miqt_string {.importc: "QQuickWebEngineProfile_trUtf8".}
...
proc fcQQuickWebEngineProfile_setRequestInterceptor(self: pointer, interceptor: pointer): void {.importc: "QQuickWebEngineProfile_setRequestInterceptor".}
...
proc fcQQuickWebEngineProfile_setUseForGlobalCertificateVerification(self: pointer, b: bool): void {.importc: "QQuickWebEngineProfile_setUseForGlobalCertificateVerification".}
proc fcQQuickWebEngineProfile_isUsedForGlobalCertificateVerification(self: pointer, ): bool {.importc: "QQuickWebEngineProfile_isUsedForGlobalCertificateVerification".}
...
proc fcQQuickWebEngineProfile_useForGlobalCertificateVerificationChanged(self: pointer, ): void {.importc: "QQuickWebEngineProfile_useForGlobalCertificateVerificationChanged".}
proc fQQuickWebEngineProfile_connect_useForGlobalCertificateVerificationChanged(self: pointer, slot: int) {.importc: "QQuickWebEngineProfile_connect_useForGlobalCertificateVerificationChanged".}
...
proc fcQQuickWebEngineProfile_downloadRequested(self: pointer, download: ptr cQQuickWebEngineDownloadItem): void {.importc: "QQuickWebEngineProfile_downloadRequested".}
...
proc fcQQuickWebEngineProfile_downloadFinished(self: pointer, download: ptr cQQuickWebEngineDownloadItem): void {.importc: "QQuickWebEngineProfile_downloadFinished".}
...
proc fcQQuickWebEngineProfile_trUtf82(s: cstring, c: cstring): struct_miqt_string {.importc: "QQuickWebEngineProfile_trUtf82".}
proc fcQQuickWebEngineProfile_trUtf83(s: cstring, c: cstring, n: cint): struct_miqt_string {.importc: "QQuickWebEngineProfile_trUtf83".}
...
proc trUtf8*(_: type gen_qquickwebengineprofile_types.QQuickWebEngineProfile, s: cstring): string =
  let v_ms = fcQQuickWebEngineProfile_trUtf8(s)
  let vx_ret = string.fromBytes(toOpenArrayByte(v_ms.data, 0, int(v_ms.len)-1))
  c_free(v_ms.data)
  vx_ret
...
proc setRequestInterceptor*(self: gen_qquickwebengineprofile_types.QQuickWebEngineProfile, interceptor: gen_qwebengineurlrequestinterceptor_types.QWebEngineUrlRequestInterceptor): void =
  fcQQuickWebEngineProfile_setRequestInterceptor(self.h, interceptor.h)
...
proc setUseForGlobalCertificateVerification*(self: gen_qquickwebengineprofile_types.QQuickWebEngineProfile, b: bool): void =
  fcQQuickWebEngineProfile_setUseForGlobalCertificateVerification(self.h, b)

proc isUsedForGlobalCertificateVerification*(self: gen_qquickwebengineprofile_types.QQuickWebEngineProfile, ): bool =
  fcQQuickWebEngineProfile_isUsedForGlobalCertificateVerification(self.h)
...
proc useForGlobalCertificateVerificationChanged*(self: gen_qquickwebengineprofile_types.QQuickWebEngineProfile, ): void =
  fcQQuickWebEngineProfile_useForGlobalCertificateVerificationChanged(self.h)

type QQuickWebEngineProfileuseForGlobalCertificateVerificationChangedSlot* = proc()
proc miqt_exec_callback_QQuickWebEngineProfile_useForGlobalCertificateVerificationChanged(slot: int) {.exportc.} =
...
proc onuseForGlobalCertificateVerificationChanged*(self: gen_qquickwebengineprofile_types.QQuickWebEngineProfile, slot: QQuickWebEngineProfileuseForGlobalCertificateVerificationChangedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fQQuickWebEngineProfile_connect_useForGlobalCertificateVerificationChanged(self.h, cast[int](addr tmp[]))
...
proc downloadRequested*(self: gen_qquickwebengineprofile_types.QQuickWebEngineProfile, download: ptr QQuickWebEngineDownloadItem): void =
  fcQQuickWebEngineProfile_downloadRequested(self.h, download)

type QQuickWebEngineProfiledownloadRequestedSlot* = proc(download: ptr QQuickWebEngineDownloadItem)
proc miqt_exec_callback_QQuickWebEngineProfile_downloadRequested(slot: int, download: ptr cQQuickWebEngineDownloadItem) {.exportc.} =
...
proc downloadFinished*(self: gen_qquickwebengineprofile_types.QQuickWebEngineProfile, download: ptr QQuickWebEngineDownloadItem): void =
  fcQQuickWebEngineProfile_downloadFinished(self.h, download)

type QQuickWebEngineProfiledownloadFinishedSlot* = proc(download: ptr QQuickWebEngineDownloadItem)
proc miqt_exec_callback_QQuickWebEngineProfile_downloadFinished(slot: int, download: ptr cQQuickWebEngineDownloadItem) {.exportc.} =
...
proc trUtf8*(_: type gen_qquickwebengineprofile_types.QQuickWebEngineProfile, s: cstring, c: cstring): string =
  let v_ms = fcQQuickWebEngineProfile_trUtf82(s, c)
  let vx_ret = string.fromBytes(toOpenArrayByte(v_ms.data, 0, int(v_ms.len)-1))
  c_free(v_ms.data)
  vx_ret

proc trUtf8*(_: type gen_qquickwebengineprofile_types.QQuickWebEngineProfile, s: cstring, c: cstring, n: cint): string =
  let v_ms = fcQQuickWebEngineProfile_trUtf83(s, c, n)
  let vx_ret = string.fromBytes(toOpenArrayByte(v_ms.data, 0, int(v_ms.len)-1))
  c_free(v_ms.data)
  vx_ret
