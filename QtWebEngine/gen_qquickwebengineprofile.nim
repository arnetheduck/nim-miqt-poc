...
proc fcQQuickWebEngineProfile_connect_useForGlobalCertificateVerificationChanged(self: pointer, slot: int) {.importc: "QQuickWebEngineProfile_connect_useForGlobalCertificateVerificationChanged".}
...
proc fcQQuickWebEngineProfile_connect_downloadRequested(self: pointer, slot: int) {.importc: "QQuickWebEngineProfile_connect_downloadRequested".}
...
proc fcQQuickWebEngineProfile_connect_downloadFinished(self: pointer, slot: int) {.importc: "QQuickWebEngineProfile_connect_downloadFinished".}
...
proc miqt_exec_callback_cQQuickWebEngineProfile_storageNameChanged(slot: int) {.exportc: "miqt_exec_callback_QQuickWebEngineProfile_storageNameChanged".} =
...
proc miqt_exec_callback_cQQuickWebEngineProfile_persistentStoragePathChanged(slot: int) {.exportc: "miqt_exec_callback_QQuickWebEngineProfile_persistentStoragePathChanged".} =
...
proc miqt_exec_callback_cQQuickWebEngineProfile_httpUserAgentChanged(slot: int) {.exportc: "miqt_exec_callback_QQuickWebEngineProfile_httpUserAgentChanged".} =
...
proc miqt_exec_callback_cQQuickWebEngineProfile_persistentCookiesPolicyChanged(slot: int) {.exportc: "miqt_exec_callback_QQuickWebEngineProfile_persistentCookiesPolicyChanged".} =
...
proc miqt_exec_callback_cQQuickWebEngineProfile_httpAcceptLanguageChanged(slot: int) {.exportc: "miqt_exec_callback_QQuickWebEngineProfile_httpAcceptLanguageChanged".} =
...
proc miqt_exec_callback_cQQuickWebEngineProfile_spellCheckEnabledChanged(slot: int) {.exportc: "miqt_exec_callback_QQuickWebEngineProfile_spellCheckEnabledChanged".} =
...
proc miqt_exec_callback_cQQuickWebEngineProfile_useForGlobalCertificateVerificationChanged(slot: int) {.exportc: "miqt_exec_callback_QQuickWebEngineProfile_useForGlobalCertificateVerificationChanged".} =
...
proc onuseForGlobalCertificateVerificationChanged*(self: gen_qquickwebengineprofile_types.QQuickWebEngineProfile, slot: QQuickWebEngineProfileuseForGlobalCertificateVerificationChangedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQQuickWebEngineProfile_connect_useForGlobalCertificateVerificationChanged(self.h, cast[int](addr tmp[]))
...
proc miqt_exec_callback_cQQuickWebEngineProfile_downloadRequested(slot: int, download: ptr cQQuickWebEngineDownloadItem) {.exportc: "miqt_exec_callback_QQuickWebEngineProfile_downloadRequested".} =
...
proc ondownloadRequested*(self: gen_qquickwebengineprofile_types.QQuickWebEngineProfile, slot: QQuickWebEngineProfiledownloadRequestedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQQuickWebEngineProfile_connect_downloadRequested(self.h, cast[int](addr tmp[]))
...
proc miqt_exec_callback_cQQuickWebEngineProfile_downloadFinished(slot: int, download: ptr cQQuickWebEngineDownloadItem) {.exportc: "miqt_exec_callback_QQuickWebEngineProfile_downloadFinished".} =
...
proc ondownloadFinished*(self: gen_qquickwebengineprofile_types.QQuickWebEngineProfile, slot: QQuickWebEngineProfiledownloadFinishedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQQuickWebEngineProfile_connect_downloadFinished(self.h, cast[int](addr tmp[]))
...
proc miqt_exec_callback_cQQuickWebEngineProfile_presentNotification(slot: int, notification: pointer) {.exportc: "miqt_exec_callback_QQuickWebEngineProfile_presentNotification".} =
