...
public:
	...
	MiqtVirtualQScriptClass(struct QScriptClass_VTable* vtbl, QScriptEngine* engine): QScriptClass(engine), vtbl(vtbl) {};

	virtual ~MiqtVirtualQScriptClass() override { if(vtbl->destructor) vtbl->destructor(vtbl, this); }
...
QScriptClass* QScriptClass_new(struct QScriptClass_VTable* vtbl, QScriptEngine* engine) {
	return new MiqtVirtualQScriptClass(vtbl, engine);
}
