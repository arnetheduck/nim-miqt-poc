...
class MiqtVirtualQsciLexerProperties final : public QsciLexerProperties {
	struct QsciLexerProperties_VTable* vtbl;
public:

	MiqtVirtualQsciLexerProperties(struct QsciLexerProperties_VTable* vtbl): QsciLexerProperties(), vtbl(vtbl) {};
	MiqtVirtualQsciLexerProperties(struct QsciLexerProperties_VTable* vtbl, QObject* parent): QsciLexerProperties(parent), vtbl(vtbl) {};

	virtual ~MiqtVirtualQsciLexerProperties() override { if(vtbl->destructor) vtbl->destructor(vtbl, this); }
	...
	QMetaObject* virtualbase_metaObject() const {
		...
		return (QMetaObject*) QsciLexerProperties::metaObject();
...
QsciLexerProperties* QsciLexerProperties_new(struct QsciLexerProperties_VTable* vtbl) {
	return new MiqtVirtualQsciLexerProperties(vtbl);
}

QsciLexerProperties* QsciLexerProperties_new2(struct QsciLexerProperties_VTable* vtbl, QObject* parent) {
	return new MiqtVirtualQsciLexerProperties(vtbl, parent);
}
...
QMetaObject* QsciLexerProperties_virtualbase_metaObject(const void* self) {
	return ( (const MiqtVirtualQsciLexerProperties*)(self) )->virtualbase_metaObject();
}

void* QsciLexerProperties_virtualbase_metacast(void* self, const char* param1) {
	return ( (MiqtVirtualQsciLexerProperties*)(self) )->virtualbase_metacast(param1);
}
...
bool QsciLexerProperties_virtualbase_event(void* self, QEvent* event) {
	return ( (MiqtVirtualQsciLexerProperties*)(self) )->virtualbase_event(event);
}

bool QsciLexerProperties_virtualbase_eventFilter(void* self, QObject* watched, QEvent* event) {
	return ( (MiqtVirtualQsciLexerProperties*)(self) )->virtualbase_eventFilter(watched, event);
}

void QsciLexerProperties_virtualbase_timerEvent(void* self, QTimerEvent* event) {
	( (MiqtVirtualQsciLexerProperties*)(self) )->virtualbase_timerEvent(event);
}

void QsciLexerProperties_virtualbase_childEvent(void* self, QChildEvent* event) {
	( (MiqtVirtualQsciLexerProperties*)(self) )->virtualbase_childEvent(event);
}

void QsciLexerProperties_virtualbase_customEvent(void* self, QEvent* event) {
	( (MiqtVirtualQsciLexerProperties*)(self) )->virtualbase_customEvent(event);
}

void QsciLexerProperties_virtualbase_connectNotify(void* self, QMetaMethod* signal) {
	( (MiqtVirtualQsciLexerProperties*)(self) )->virtualbase_connectNotify(signal);
}

void QsciLexerProperties_virtualbase_disconnectNotify(void* self, QMetaMethod* signal) {
	( (MiqtVirtualQsciLexerProperties*)(self) )->virtualbase_disconnectNotify(signal);
}

bool QsciLexerProperties_protectedbase_readProperties(void* self, QSettings* qs, struct miqt_string prefix) {
	return ( (MiqtVirtualQsciLexerProperties*)(self) )->protectedbase_readProperties(qs, prefix);
}

bool QsciLexerProperties_protectedbase_writeProperties(const void* self, QSettings* qs, struct miqt_string prefix) {
	return ( (const MiqtVirtualQsciLexerProperties*)(self) )->protectedbase_writeProperties(qs, prefix);
}

QObject* QsciLexerProperties_protectedbase_sender(const void* self) {
	return ( (const MiqtVirtualQsciLexerProperties*)(self) )->protectedbase_sender();
}

int QsciLexerProperties_protectedbase_senderSignalIndex(const void* self) {
	return ( (const MiqtVirtualQsciLexerProperties*)(self) )->protectedbase_senderSignalIndex();
}

int QsciLexerProperties_protectedbase_receivers(const void* self, const char* signal) {
	return ( (const MiqtVirtualQsciLexerProperties*)(self) )->protectedbase_receivers(signal);
}

bool QsciLexerProperties_protectedbase_isSignalConnected(const void* self, QMetaMethod* signal) {
	return ( (const MiqtVirtualQsciLexerProperties*)(self) )->protectedbase_isSignalConnected(signal);
}

const QMetaObject* QsciLexerProperties_staticMetaObject() { return &QsciLexerProperties::staticMetaObject; }
