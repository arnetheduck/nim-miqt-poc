...
func (this *QsciLexerCustom) callVirtualBase_MetaObject() *qt6.QMetaObject {

	return qt6.UnsafeNewQMetaObject(unsafe.Pointer(C.QsciLexerCustom_virtualbase_metaObject(unsafe.Pointer(this.h))))

}
func (this *QsciLexerCustom) OnMetaObject(slot func(super func() *qt6.QMetaObject) *qt6.QMetaObject) {
