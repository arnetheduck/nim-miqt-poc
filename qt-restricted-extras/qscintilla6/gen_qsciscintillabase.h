...
struct QsciScintillaBase_VTable {
	...
	void (*initStyleOption)(struct QsciScintillaBase_VTable* vtbl, const QsciScintillaBase* self, QStyleOptionFrame* option);
	...
	void (*enterEvent)(struct QsciScintillaBase_VTable* vtbl, QsciScintillaBase* self, QEnterEvent* event);
	...
	bool (*nativeEvent)(struct QsciScintillaBase_VTable* vtbl, QsciScintillaBase* self, struct miqt_string eventType, void* message, intptr_t* result);
