...
class MiqtVirtualQsciLexerXML final : public QsciLexerXML {
	struct QsciLexerXML_VTable* vtbl;
public:

	MiqtVirtualQsciLexerXML(struct QsciLexerXML_VTable* vtbl): QsciLexerXML(), vtbl(vtbl) {};
	MiqtVirtualQsciLexerXML(struct QsciLexerXML_VTable* vtbl, QObject* parent): QsciLexerXML(parent), vtbl(vtbl) {};

	virtual ~MiqtVirtualQsciLexerXML() override { if(vtbl->destructor) vtbl->destructor(vtbl, this); }
	...
	QMetaObject* virtualbase_metaObject() const {
		...
		return (QMetaObject*) QsciLexerXML::metaObject();
	...
	int virtualbase_metacall(int param1, int param2, void** param3) {
		...
		return QsciLexerXML::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
QsciLexerXML* QsciLexerXML_new(struct QsciLexerXML_VTable* vtbl) {
	return new MiqtVirtualQsciLexerXML(vtbl);
}

QsciLexerXML* QsciLexerXML_new2(struct QsciLexerXML_VTable* vtbl, QObject* parent) {
	return new MiqtVirtualQsciLexerXML(vtbl, parent);
}
...
QMetaObject* QsciLexerXML_virtualbase_metaObject(const void* self) {
	return ( (const MiqtVirtualQsciLexerXML*)(self) )->virtualbase_metaObject();
}

void* QsciLexerXML_virtualbase_metacast(void* self, const char* param1) {
	return ( (MiqtVirtualQsciLexerXML*)(self) )->virtualbase_metacast(param1);
}

int QsciLexerXML_virtualbase_metacall(void* self, int param1, int param2, void** param3) {
	return ( (MiqtVirtualQsciLexerXML*)(self) )->virtualbase_metacall(param1, param2, param3);
}
...
bool QsciLexerXML_protectedbase_readProperties(void* self, QSettings* qs, struct miqt_string prefix) {
	return ( (MiqtVirtualQsciLexerXML*)(self) )->protectedbase_readProperties(qs, prefix);
}

bool QsciLexerXML_protectedbase_writeProperties(const void* self, QSettings* qs, struct miqt_string prefix) {
	return ( (const MiqtVirtualQsciLexerXML*)(self) )->protectedbase_writeProperties(qs, prefix);
}

QObject* QsciLexerXML_protectedbase_sender(const void* self) {
	return ( (const MiqtVirtualQsciLexerXML*)(self) )->protectedbase_sender();
}

int QsciLexerXML_protectedbase_senderSignalIndex(const void* self) {
	return ( (const MiqtVirtualQsciLexerXML*)(self) )->protectedbase_senderSignalIndex();
}

int QsciLexerXML_protectedbase_receivers(const void* self, const char* signal) {
	return ( (const MiqtVirtualQsciLexerXML*)(self) )->protectedbase_receivers(signal);
}

bool QsciLexerXML_protectedbase_isSignalConnected(const void* self, QMetaMethod* signal) {
	return ( (const MiqtVirtualQsciLexerXML*)(self) )->protectedbase_isSignalConnected(signal);
}
