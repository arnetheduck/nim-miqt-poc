...
func (this *QsciMacro) Metacall(param1 qt6.QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {
...
func (this *QsciMacro) callVirtualBase_MetaObject() *qt6.QMetaObject {

	return qt6.UnsafeNewQMetaObject(unsafe.Pointer(C.QsciMacro_virtualbase_metaObject(unsafe.Pointer(this.h))))

}
func (this *QsciMacro) OnmetaObject(slot func(super func() *qt6.QMetaObject) *qt6.QMetaObject) {
...
func (this *QsciMacro) callVirtualBase_Metacall(param1 qt6.QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {

	return (int)(C.QsciMacro_virtualbase_metacall(unsafe.Pointer(this.h), (C.int)(param1), (C.int)(param2), param3))

}
func (this *QsciMacro) OnMetacall(slot func(super func(param1 qt6.QMetaObject__Call, param2 int, param3 unsafe.Pointer) int, param1 qt6.QMetaObject__Call, param2 int, param3 unsafe.Pointer) int) {
