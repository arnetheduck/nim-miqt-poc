...
QMetaObject* miqt_exec_callback_QsciLexerBash_metaObject(const QsciLexerBash*, intptr_t);
void* miqt_exec_callback_QsciLexerBash_metacast(QsciLexerBash*, intptr_t, const char*);
...
public:
	...
	virtual const QMetaObject* metaObject() const override {
		...
		QMetaObject* callback_return_value = miqt_exec_callback_QsciLexerBash_metaObject(this, handle__metaObject);
	...
	virtual void* qt_metacast(const char* param1) override {
		...
		void* callback_return_value = miqt_exec_callback_QsciLexerBash_metacast(this, handle__metacast, sigval1);
...
bool QsciLexerBash_override_virtual_metaObject(void* self, intptr_t slot) {
...
bool QsciLexerBash_override_virtual_metacast(void* self, intptr_t slot) {
	MiqtVirtualQsciLexerBash* self_cast = dynamic_cast<MiqtVirtualQsciLexerBash*>( (QsciLexerBash*)(self) );
	if (self_cast == nullptr) {
		return false;
	}
