...
QMetaObject* miqt_exec_callback_QsciLexerBatch_metaObject(const QsciLexerBatch*, intptr_t);
void* miqt_exec_callback_QsciLexerBatch_metacast(QsciLexerBatch*, intptr_t, const char*);
int miqt_exec_callback_QsciLexerBatch_metacall(QsciLexerBatch*, intptr_t, int, int, void**);
...
public:
	...
	virtual const QMetaObject* metaObject() const override {
		...
		QMetaObject* callback_return_value = miqt_exec_callback_QsciLexerBatch_metaObject(this, handle__metaObject);
	...
	QMetaObject* virtualbase_metaObject() const {
		...
		return (QMetaObject*) QsciLexerBatch::metaObject();
	...
	virtual void* qt_metacast(const char* param1) override {
		...
		void* callback_return_value = miqt_exec_callback_QsciLexerBatch_metacast(this, handle__metacast, sigval1);
	...
	virtual int qt_metacall(QMetaObject::Call param1, int param2, void** param3) override {
		...
		int callback_return_value = miqt_exec_callback_QsciLexerBatch_metacall(this, handle__metacall, sigval1, sigval2, sigval3);
	...
	int virtualbase_metacall(int param1, int param2, void** param3) {
		...
		return QsciLexerBatch::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
bool QsciLexerBatch_override_virtual_metaObject(void* self, intptr_t slot) {
...
QMetaObject* QsciLexerBatch_virtualbase_metaObject(const void* self) {
	return ( (const MiqtVirtualQsciLexerBatch*)(self) )->virtualbase_metaObject();
}

bool QsciLexerBatch_override_virtual_metacast(void* self, intptr_t slot) {
	MiqtVirtualQsciLexerBatch* self_cast = dynamic_cast<MiqtVirtualQsciLexerBatch*>( (QsciLexerBatch*)(self) );
	if (self_cast == nullptr) {
		return false;
	}
...
void* QsciLexerBatch_virtualbase_metacast(void* self, const char* param1) {
	return ( (MiqtVirtualQsciLexerBatch*)(self) )->virtualbase_metacast(param1);
}

bool QsciLexerBatch_override_virtual_metacall(void* self, intptr_t slot) {
	MiqtVirtualQsciLexerBatch* self_cast = dynamic_cast<MiqtVirtualQsciLexerBatch*>( (QsciLexerBatch*)(self) );
	if (self_cast == nullptr) {
		return false;
	}
...
int QsciLexerBatch_virtualbase_metacall(void* self, int param1, int param2, void** param3) {
	return ( (MiqtVirtualQsciLexerBatch*)(self) )->virtualbase_metacall(param1, param2, param3);
}
...
const QMetaObject* QsciLexerBatch_staticMetaObject() { return &QsciLexerBatch::staticMetaObject; }
