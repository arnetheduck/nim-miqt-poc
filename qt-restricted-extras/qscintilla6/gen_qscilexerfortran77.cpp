...
class MiqtVirtualQsciLexerFortran77 final : public QsciLexerFortran77 {
	struct QsciLexerFortran77_VTable* vtbl;
public:

	MiqtVirtualQsciLexerFortran77(struct QsciLexerFortran77_VTable* vtbl): QsciLexerFortran77(), vtbl(vtbl) {};
	MiqtVirtualQsciLexerFortran77(struct QsciLexerFortran77_VTable* vtbl, QObject* parent): QsciLexerFortran77(parent), vtbl(vtbl) {};

	virtual ~MiqtVirtualQsciLexerFortran77() override { if(vtbl->destructor) vtbl->destructor(vtbl, this); }
...
QsciLexerFortran77* QsciLexerFortran77_new(struct QsciLexerFortran77_VTable* vtbl) {
	return new MiqtVirtualQsciLexerFortran77(vtbl);
}

QsciLexerFortran77* QsciLexerFortran77_new2(struct QsciLexerFortran77_VTable* vtbl, QObject* parent) {
	return new MiqtVirtualQsciLexerFortran77(vtbl, parent);
}
...
bool QsciLexerFortran77_protectedbase_readProperties(void* self, QSettings* qs, struct miqt_string prefix) {
	return ( (MiqtVirtualQsciLexerFortran77*)(self) )->protectedbase_readProperties(qs, prefix);
}

bool QsciLexerFortran77_protectedbase_writeProperties(const void* self, QSettings* qs, struct miqt_string prefix) {
	return ( (const MiqtVirtualQsciLexerFortran77*)(self) )->protectedbase_writeProperties(qs, prefix);
}

QObject* QsciLexerFortran77_protectedbase_sender(const void* self) {
	return ( (const MiqtVirtualQsciLexerFortran77*)(self) )->protectedbase_sender();
}

int QsciLexerFortran77_protectedbase_senderSignalIndex(const void* self) {
	return ( (const MiqtVirtualQsciLexerFortran77*)(self) )->protectedbase_senderSignalIndex();
}

int QsciLexerFortran77_protectedbase_receivers(const void* self, const char* signal) {
	return ( (const MiqtVirtualQsciLexerFortran77*)(self) )->protectedbase_receivers(signal);
}

bool QsciLexerFortran77_protectedbase_isSignalConnected(const void* self, QMetaMethod* signal) {
	return ( (const MiqtVirtualQsciLexerFortran77*)(self) )->protectedbase_isSignalConnected(signal);
}
