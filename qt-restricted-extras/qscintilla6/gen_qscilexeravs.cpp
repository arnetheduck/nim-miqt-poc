...
class MiqtVirtualQsciLexerAVS final : public QsciLexerAVS {
	struct QsciLexerAVS_VTable* vtbl;
public:

	MiqtVirtualQsciLexerAVS(struct QsciLexerAVS_VTable* vtbl): QsciLexerAVS(), vtbl(vtbl) {};
	MiqtVirtualQsciLexerAVS(struct QsciLexerAVS_VTable* vtbl, QObject* parent): QsciLexerAVS(parent), vtbl(vtbl) {};

	virtual ~MiqtVirtualQsciLexerAVS() override { if(vtbl->destructor) vtbl->destructor(vtbl, this); }
	...
	QMetaObject* virtualbase_metaObject() const {
		...
		return (QMetaObject*) QsciLexerAVS::metaObject();
	...
	int virtualbase_metacall(int param1, int param2, void** param3) {
		...
		return QsciLexerAVS::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
QsciLexerAVS* QsciLexerAVS_new(struct QsciLexerAVS_VTable* vtbl) {
	return new MiqtVirtualQsciLexerAVS(vtbl);
}

QsciLexerAVS* QsciLexerAVS_new2(struct QsciLexerAVS_VTable* vtbl, QObject* parent) {
	return new MiqtVirtualQsciLexerAVS(vtbl, parent);
}
...
QMetaObject* QsciLexerAVS_virtualbase_metaObject(const void* self) {
	return ( (const MiqtVirtualQsciLexerAVS*)(self) )->virtualbase_metaObject();
}

void* QsciLexerAVS_virtualbase_metacast(void* self, const char* param1) {
	return ( (MiqtVirtualQsciLexerAVS*)(self) )->virtualbase_metacast(param1);
}

int QsciLexerAVS_virtualbase_metacall(void* self, int param1, int param2, void** param3) {
	return ( (MiqtVirtualQsciLexerAVS*)(self) )->virtualbase_metacall(param1, param2, param3);
}
...
bool QsciLexerAVS_protectedbase_readProperties(void* self, QSettings* qs, struct miqt_string prefix) {
	return ( (MiqtVirtualQsciLexerAVS*)(self) )->protectedbase_readProperties(qs, prefix);
}

bool QsciLexerAVS_protectedbase_writeProperties(const void* self, QSettings* qs, struct miqt_string prefix) {
	return ( (const MiqtVirtualQsciLexerAVS*)(self) )->protectedbase_writeProperties(qs, prefix);
}

QObject* QsciLexerAVS_protectedbase_sender(const void* self) {
	return ( (const MiqtVirtualQsciLexerAVS*)(self) )->protectedbase_sender();
}

int QsciLexerAVS_protectedbase_senderSignalIndex(const void* self) {
	return ( (const MiqtVirtualQsciLexerAVS*)(self) )->protectedbase_senderSignalIndex();
}

int QsciLexerAVS_protectedbase_receivers(const void* self, const char* signal) {
	return ( (const MiqtVirtualQsciLexerAVS*)(self) )->protectedbase_receivers(signal);
}

bool QsciLexerAVS_protectedbase_isSignalConnected(const void* self, QMetaMethod* signal) {
	return ( (const MiqtVirtualQsciLexerAVS*)(self) )->protectedbase_isSignalConnected(signal);
}

const QMetaObject* QsciLexerAVS_staticMetaObject() { return &QsciLexerAVS::staticMetaObject; }
