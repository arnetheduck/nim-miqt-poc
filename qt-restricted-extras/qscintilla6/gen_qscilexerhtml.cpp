...
QMetaObject* miqt_exec_callback_QsciLexerHTML_metaObject(const QsciLexerHTML*, intptr_t);
void* miqt_exec_callback_QsciLexerHTML_metacast(QsciLexerHTML*, intptr_t, const char*);
...
public:
	...
	virtual const QMetaObject* metaObject() const override {
		...
		QMetaObject* callback_return_value = miqt_exec_callback_QsciLexerHTML_metaObject(this, handle__metaObject);
	...
	virtual void* qt_metacast(const char* param1) override {
		...
		void* callback_return_value = miqt_exec_callback_QsciLexerHTML_metacast(this, handle__metacast, sigval1);
...
bool QsciLexerHTML_override_virtual_metaObject(void* self, intptr_t slot) {
...
bool QsciLexerHTML_override_virtual_metacast(void* self, intptr_t slot) {
	MiqtVirtualQsciLexerHTML* self_cast = dynamic_cast<MiqtVirtualQsciLexerHTML*>( (QsciLexerHTML*)(self) );
	if (self_cast == nullptr) {
		return false;
	}
