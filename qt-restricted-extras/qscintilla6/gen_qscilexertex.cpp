...
class MiqtVirtualQsciLexerTeX final : public QsciLexerTeX {
	struct QsciLexerTeX_VTable* vtbl;
public:

	MiqtVirtualQsciLexerTeX(struct QsciLexerTeX_VTable* vtbl): QsciLexerTeX(), vtbl(vtbl) {};
	MiqtVirtualQsciLexerTeX(struct QsciLexerTeX_VTable* vtbl, QObject* parent): QsciLexerTeX(parent), vtbl(vtbl) {};

	virtual ~MiqtVirtualQsciLexerTeX() override { if(vtbl->destructor) vtbl->destructor(vtbl, this); }
	...
	QMetaObject* virtualbase_metaObject() const {
		...
		return (QMetaObject*) QsciLexerTeX::metaObject();
...
QsciLexerTeX* QsciLexerTeX_new(struct QsciLexerTeX_VTable* vtbl) {
	return new MiqtVirtualQsciLexerTeX(vtbl);
}

QsciLexerTeX* QsciLexerTeX_new2(struct QsciLexerTeX_VTable* vtbl, QObject* parent) {
	return new MiqtVirtualQsciLexerTeX(vtbl, parent);
}
...
QMetaObject* QsciLexerTeX_virtualbase_metaObject(const void* self) {
	return ( (const MiqtVirtualQsciLexerTeX*)(self) )->virtualbase_metaObject();
}

void* QsciLexerTeX_virtualbase_metacast(void* self, const char* param1) {
	return ( (MiqtVirtualQsciLexerTeX*)(self) )->virtualbase_metacast(param1);
}
...
bool QsciLexerTeX_protectedbase_readProperties(void* self, QSettings* qs, struct miqt_string prefix) {
	return ( (MiqtVirtualQsciLexerTeX*)(self) )->protectedbase_readProperties(qs, prefix);
}

bool QsciLexerTeX_protectedbase_writeProperties(const void* self, QSettings* qs, struct miqt_string prefix) {
	return ( (const MiqtVirtualQsciLexerTeX*)(self) )->protectedbase_writeProperties(qs, prefix);
}

QObject* QsciLexerTeX_protectedbase_sender(const void* self) {
	return ( (const MiqtVirtualQsciLexerTeX*)(self) )->protectedbase_sender();
}

int QsciLexerTeX_protectedbase_senderSignalIndex(const void* self) {
	return ( (const MiqtVirtualQsciLexerTeX*)(self) )->protectedbase_senderSignalIndex();
}

int QsciLexerTeX_protectedbase_receivers(const void* self, const char* signal) {
	return ( (const MiqtVirtualQsciLexerTeX*)(self) )->protectedbase_receivers(signal);
}

bool QsciLexerTeX_protectedbase_isSignalConnected(const void* self, QMetaMethod* signal) {
	return ( (const MiqtVirtualQsciLexerTeX*)(self) )->protectedbase_isSignalConnected(signal);
}
