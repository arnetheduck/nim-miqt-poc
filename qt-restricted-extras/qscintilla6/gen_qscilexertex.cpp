...
QMetaObject* miqt_exec_callback_QsciLexerTeX_metaObject(const QsciLexerTeX*, intptr_t);
void* miqt_exec_callback_QsciLexerTeX_metacast(QsciLexerTeX*, intptr_t, const char*);
...
public:
	...
	virtual const QMetaObject* metaObject() const override {
		...
		QMetaObject* callback_return_value = miqt_exec_callback_QsciLexerTeX_metaObject(this, handle__metaObject);
	...
	virtual void* qt_metacast(const char* param1) override {
		...
		void* callback_return_value = miqt_exec_callback_QsciLexerTeX_metacast(this, handle__metacast, sigval1);
...
bool QsciLexerTeX_override_virtual_metaObject(void* self, intptr_t slot) {
...
bool QsciLexerTeX_override_virtual_metacast(void* self, intptr_t slot) {
	MiqtVirtualQsciLexerTeX* self_cast = dynamic_cast<MiqtVirtualQsciLexerTeX*>( (QsciLexerTeX*)(self) );
	if (self_cast == nullptr) {
		return false;
	}
