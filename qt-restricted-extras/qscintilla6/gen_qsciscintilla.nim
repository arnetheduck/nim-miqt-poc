...
proc miqt_exec_callback_QsciScintilla_viewportSizeHint(self: ptr cQsciScintilla, slot: int): pointer {.exportc: "miqt_exec_callback_QsciScintilla_viewportSizeHint ".} =
  ...
  virtualReturn.h
proc QsciScintillainitStyleOption*(self: gen_qsciscintilla_types.QsciScintilla, option: gen_qstyleoption.QStyleOptionFrame): void =

  fQsciScintilla_virtualbase_initStyleOption(self.h, option.h)

type QsciScintillainitStyleOptionProc* = proc(option: gen_qstyleoption.QStyleOptionFrame): void
proc oninitStyleOption*(self: gen_qsciscintilla_types.QsciScintilla, slot: QsciScintillainitStyleOptionProc) =
  # TODO check subclass
  var tmp = new QsciScintillainitStyleOptionProc
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QsciScintilla_initStyleOption(self: ptr cQsciScintilla, slot: int, option: pointer): void {.exportc: "miqt_exec_callback_QsciScintilla_initStyleOption ".} =
  var nimfunc = cast[ptr QsciScintillainitStyleOptionProc](cast[pointer](slot))
...
proc miqt_exec_callback_QsciScintilla_keyReleaseEvent(self: ptr cQsciScintilla, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QsciScintilla_keyReleaseEvent ".} =
  ...
  nimfunc[](slotval1)
proc QsciScintillaenterEvent*(self: gen_qsciscintilla_types.QsciScintilla, event: gen_qevent.QEnterEvent): void =

  fQsciScintilla_virtualbase_enterEvent(self.h, event.h)

type QsciScintillaenterEventProc* = proc(event: gen_qevent.QEnterEvent): void
...
type QsciScintillanativeEventProc* = proc(eventType: seq[byte], message: pointer, resultVal: ptr uint): bool
