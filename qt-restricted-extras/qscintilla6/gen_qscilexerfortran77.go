...
func (this *QsciLexerFortran77) Metacall(param1 qt6.QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {
	return (int)(C.QsciLexerFortran77_metacall(this.h, (C.int)(param1), (C.int)(param2), param3))
}
...
func (this *QsciLexerFortran77) callVirtualBase_MetaObject() *qt6.QMetaObject {

	return qt6.UnsafeNewQMetaObject(unsafe.Pointer(C.QsciLexerFortran77_virtualbase_metaObject(unsafe.Pointer(this.h))))

}
func (this *QsciLexerFortran77) OnMetaObject(slot func(super func() *qt6.QMetaObject) *qt6.QMetaObject) {
	ok := C.QsciLexerFortran77_override_virtual_metaObject(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}

//export miqt_exec_callback_QsciLexerFortran77_metaObject
func miqt_exec_callback_QsciLexerFortran77_metaObject(self *C.QsciLexerFortran77, cb C.intptr_t) *C.QMetaObject {
	gofunc, ok := cgo.Handle(cb).Value().(func(super func() *qt6.QMetaObject) *qt6.QMetaObject)
	if !ok {
		panic("miqt: callback of non-callback type (heap corruption?)")
	}

	virtualReturn := gofunc((&QsciLexerFortran77{h: self}).callVirtualBase_MetaObject)

	return (*C.QMetaObject)(virtualReturn.UnsafePointer())

}

func (this *QsciLexerFortran77) callVirtualBase_Metacast(param1 string) unsafe.Pointer {
	param1_Cstring := C.CString(param1)
	defer C.free(unsafe.Pointer(param1_Cstring))

	return (unsafe.Pointer)(C.QsciLexerFortran77_virtualbase_metacast(unsafe.Pointer(this.h), param1_Cstring))

}
func (this *QsciLexerFortran77) OnMetacast(slot func(super func(param1 string) unsafe.Pointer, param1 string) unsafe.Pointer) {
	ok := C.QsciLexerFortran77_override_virtual_metacast(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}

//export miqt_exec_callback_QsciLexerFortran77_metacast
func miqt_exec_callback_QsciLexerFortran77_metacast(self *C.QsciLexerFortran77, cb C.intptr_t, param1 *C.const_char) unsafe.Pointer {
	...
	virtualReturn := gofunc((&QsciLexerFortran77{h: self}).callVirtualBase_Metacast, slotval1)

	return virtualReturn

}

func (this *QsciLexerFortran77) callVirtualBase_Metacall(param1 qt6.QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {

	return (int)(C.QsciLexerFortran77_virtualbase_metacall(unsafe.Pointer(this.h), (C.int)(param1), (C.int)(param2), param3))

}
func (this *QsciLexerFortran77) OnMetacall(slot func(super func(param1 qt6.QMetaObject__Call, param2 int, param3 unsafe.Pointer) int, param1 qt6.QMetaObject__Call, param2 int, param3 unsafe.Pointer) int) {
	ok := C.QsciLexerFortran77_override_virtual_metacall(unsafe.Pointer(this.h), C.intptr_t(cgo.NewHandle(slot)))
	if !ok {
		panic("miqt: can only override virtual methods for directly constructed types")
	}
}

//export miqt_exec_callback_QsciLexerFortran77_metacall
func miqt_exec_callback_QsciLexerFortran77_metacall(self *C.QsciLexerFortran77, cb C.intptr_t, param1 C.int, param2 C.int, param3 unsafe.Pointer) C.int {
	...
	virtualReturn := gofunc((&QsciLexerFortran77{h: self}).callVirtualBase_Metacall, slotval1, slotval2, slotval3)
