...
QObject* QsciAPIs_protectedbase_sender(const void* self) {
	return ( (const MiqtVirtualQsciAPIs*)(self) )->protectedbase_sender();
}

int QsciAPIs_protectedbase_senderSignalIndex(const void* self) {
	return ( (const MiqtVirtualQsciAPIs*)(self) )->protectedbase_senderSignalIndex();
}

int QsciAPIs_protectedbase_receivers(const void* self, const char* signal) {
	return ( (const MiqtVirtualQsciAPIs*)(self) )->protectedbase_receivers(signal);
}

bool QsciAPIs_protectedbase_isSignalConnected(const void* self, QMetaMethod* signal) {
	return ( (const MiqtVirtualQsciAPIs*)(self) )->protectedbase_isSignalConnected(signal);
}
