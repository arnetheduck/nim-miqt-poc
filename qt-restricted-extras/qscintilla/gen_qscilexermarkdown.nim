...
proc trUtf82*(_: type gen_qscilexermarkdown_types.QsciLexerMarkdown, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type gen_qscilexermarkdown_types.QsciLexerMarkdown, s: cstring, c: cstring, n: cint): string =
