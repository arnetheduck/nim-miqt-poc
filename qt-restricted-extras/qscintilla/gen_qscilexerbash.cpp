...
class MiqtVirtualQsciLexerBash final : public QsciLexerBash {
	struct QsciLexerBash_VTable* vtbl;
public:

	MiqtVirtualQsciLexerBash(struct QsciLexerBash_VTable* vtbl): QsciLexerBash(), vtbl(vtbl) {};
	MiqtVirtualQsciLexerBash(struct QsciLexerBash_VTable* vtbl, QObject* parent): QsciLexerBash(parent), vtbl(vtbl) {};

	virtual ~MiqtVirtualQsciLexerBash() override { if(vtbl->destructor) vtbl->destructor(vtbl, this); }
	...
	QMetaObject* virtualbase_metaObject() const {
		...
		return (QMetaObject*) QsciLexerBash::metaObject();
...
QsciLexerBash* QsciLexerBash_new(struct QsciLexerBash_VTable* vtbl) {
	return new MiqtVirtualQsciLexerBash(vtbl);
}

QsciLexerBash* QsciLexerBash_new2(struct QsciLexerBash_VTable* vtbl, QObject* parent) {
	return new MiqtVirtualQsciLexerBash(vtbl, parent);
}
...
QMetaObject* QsciLexerBash_virtualbase_metaObject(const void* self) {
	return ( (const MiqtVirtualQsciLexerBash*)(self) )->virtualbase_metaObject();
}

void* QsciLexerBash_virtualbase_metacast(void* self, const char* param1) {
	return ( (MiqtVirtualQsciLexerBash*)(self) )->virtualbase_metacast(param1);
}
...
bool QsciLexerBash_protectedbase_readProperties(void* self, QSettings* qs, struct miqt_string prefix) {
	return ( (MiqtVirtualQsciLexerBash*)(self) )->protectedbase_readProperties(qs, prefix);
}

bool QsciLexerBash_protectedbase_writeProperties(const void* self, QSettings* qs, struct miqt_string prefix) {
	return ( (const MiqtVirtualQsciLexerBash*)(self) )->protectedbase_writeProperties(qs, prefix);
}

QObject* QsciLexerBash_protectedbase_sender(const void* self) {
	return ( (const MiqtVirtualQsciLexerBash*)(self) )->protectedbase_sender();
}

int QsciLexerBash_protectedbase_senderSignalIndex(const void* self) {
	return ( (const MiqtVirtualQsciLexerBash*)(self) )->protectedbase_senderSignalIndex();
}

int QsciLexerBash_protectedbase_receivers(const void* self, const char* signal) {
	return ( (const MiqtVirtualQsciLexerBash*)(self) )->protectedbase_receivers(signal);
}

bool QsciLexerBash_protectedbase_isSignalConnected(const void* self, QMetaMethod* signal) {
	return ( (const MiqtVirtualQsciLexerBash*)(self) )->protectedbase_isSignalConnected(signal);
}
