...
proc trUtf82*(_: type gen_qscilexertcl_types.QsciLexerTCL, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type gen_qscilexertcl_types.QsciLexerTCL, s: cstring, c: cstring, n: cint): string =
