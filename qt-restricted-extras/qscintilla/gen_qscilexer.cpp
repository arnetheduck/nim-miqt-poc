...
QObject* QsciLexer_protectedbase_sender(const void* self) {
	return ( (const MiqtVirtualQsciLexer*)(self) )->protectedbase_sender();
}

int QsciLexer_protectedbase_senderSignalIndex(const void* self) {
	return ( (const MiqtVirtualQsciLexer*)(self) )->protectedbase_senderSignalIndex();
}

int QsciLexer_protectedbase_receivers(const void* self, const char* signal) {
	return ( (const MiqtVirtualQsciLexer*)(self) )->protectedbase_receivers(signal);
}

bool QsciLexer_protectedbase_isSignalConnected(const void* self, QMetaMethod* signal) {
	return ( (const MiqtVirtualQsciLexer*)(self) )->protectedbase_isSignalConnected(signal);
}
