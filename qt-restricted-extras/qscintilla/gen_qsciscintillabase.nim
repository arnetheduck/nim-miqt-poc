...
proc trUtf8*(_: type QsciScintillaBase, s: cstring): string =
...
proc trUtf82*(_: type QsciScintillaBase, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type QsciScintillaBase, s: cstring, c: cstring, n: cint): string =
...
proc miqt_exec_callback_QsciScintillaBase_keyReleaseEvent(self: ptr cQsciScintillaBase, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QsciScintillaBase_keyReleaseEvent ".} =
  ...
  nimfunc[](superCall, slotval1)
proc callVirtualBase_enterEvent(self: QsciScintillaBase, event: gen_qcoreevent.QEvent): void =


  fQsciScintillaBase_virtualbase_enterEvent(self.h, event.h)

type QsciScintillaBaseenterEventBase* = proc(event: gen_qcoreevent.QEvent): void
proc onenterEvent*(self: QsciScintillaBase, slot: proc(super: QsciScintillaBaseenterEventBase, event: gen_qcoreevent.QEvent): void) =
  # TODO check subclass
  type Cb = proc(super: QsciScintillaBaseenterEventBase, event: gen_qcoreevent.QEvent): void
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QsciScintillaBase_hideEvent(self: ptr cQsciScintillaBase, slot: int, event: pointer): void {.exportc: "miqt_exec_callback_QsciScintillaBase_hideEvent ".} =
  ...
  nimfunc[](superCall, slotval1)
proc callVirtualBase_nativeEvent(self: QsciScintillaBase, eventType: seq[byte], message: pointer, resultVal: ptr clong): bool =
...
type QsciScintillaBasenativeEventBase* = proc(eventType: seq[byte], message: pointer, resultVal: ptr clong): bool
proc onnativeEvent*(self: QsciScintillaBase, slot: proc(super: QsciScintillaBasenativeEventBase, eventType: seq[byte], message: pointer, resultVal: ptr clong): bool) =
  # TODO check subclass
  type Cb = proc(super: QsciScintillaBasenativeEventBase, eventType: seq[byte], message: pointer, resultVal: ptr clong): bool
  var tmp = new Cb
  tmp[] = slot
  GC_ref(tmp)
...
proc miqt_exec_callback_QsciScintillaBase_disconnectNotify(self: ptr cQsciScintillaBase, slot: int, signal: pointer): void {.exportc: "miqt_exec_callback_QsciScintillaBase_disconnectNotify ".} =
  ...
  nimfunc[](superCall, slotval1)
proc staticMetaObject*(_: type QsciScintillaBase): gen_qobjectdefs.QMetaObject =
