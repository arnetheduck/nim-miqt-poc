...
class MiqtVirtualQsciLexerLua final : public QsciLexerLua {
	struct QsciLexerLua_VTable* vtbl;
public:

	MiqtVirtualQsciLexerLua(struct QsciLexerLua_VTable* vtbl): QsciLexerLua(), vtbl(vtbl) {};
	MiqtVirtualQsciLexerLua(struct QsciLexerLua_VTable* vtbl, QObject* parent): QsciLexerLua(parent), vtbl(vtbl) {};

	virtual ~MiqtVirtualQsciLexerLua() override { if(vtbl->destructor) vtbl->destructor(vtbl, this); }
...
QsciLexerLua* QsciLexerLua_new(struct QsciLexerLua_VTable* vtbl) {
	return new MiqtVirtualQsciLexerLua(vtbl);
}

QsciLexerLua* QsciLexerLua_new2(struct QsciLexerLua_VTable* vtbl, QObject* parent) {
	return new MiqtVirtualQsciLexerLua(vtbl, parent);
}
