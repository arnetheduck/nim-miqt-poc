...
proc trUtf8*(_: type QsciMacro, s: cstring): string =
...
proc trUtf82*(_: type QsciMacro, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type QsciMacro, s: cstring, c: cstring, n: cint): string =
