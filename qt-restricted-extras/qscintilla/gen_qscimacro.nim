...
proc trUtf82*(_: type gen_qscimacro_types.QsciMacro, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type gen_qscimacro_types.QsciMacro, s: cstring, c: cstring, n: cint): string =
