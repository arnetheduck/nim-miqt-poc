...
class MiqtVirtualQsciLexerBatch final : public QsciLexerBatch {
	struct QsciLexerBatch_VTable* vtbl;
public:

	MiqtVirtualQsciLexerBatch(struct QsciLexerBatch_VTable* vtbl): QsciLexerBatch(), vtbl(vtbl) {};
	MiqtVirtualQsciLexerBatch(struct QsciLexerBatch_VTable* vtbl, QObject* parent): QsciLexerBatch(parent), vtbl(vtbl) {};

	virtual ~MiqtVirtualQsciLexerBatch() override { if(vtbl->destructor) vtbl->destructor(vtbl, this); }
...
QsciLexerBatch* QsciLexerBatch_new(struct QsciLexerBatch_VTable* vtbl) {
	return new MiqtVirtualQsciLexerBatch(vtbl);
}

QsciLexerBatch* QsciLexerBatch_new2(struct QsciLexerBatch_VTable* vtbl, QObject* parent) {
	return new MiqtVirtualQsciLexerBatch(vtbl, parent);
}
...
QObject* QsciLexerBatch_protectedbase_sender(const void* self) {
	return ( (const MiqtVirtualQsciLexerBatch*)(self) )->protectedbase_sender();
}

int QsciLexerBatch_protectedbase_senderSignalIndex(const void* self) {
	return ( (const MiqtVirtualQsciLexerBatch*)(self) )->protectedbase_senderSignalIndex();
}

int QsciLexerBatch_protectedbase_receivers(const void* self, const char* signal) {
	return ( (const MiqtVirtualQsciLexerBatch*)(self) )->protectedbase_receivers(signal);
}

bool QsciLexerBatch_protectedbase_isSignalConnected(const void* self, QMetaMethod* signal) {
	return ( (const MiqtVirtualQsciLexerBatch*)(self) )->protectedbase_isSignalConnected(signal);
}
