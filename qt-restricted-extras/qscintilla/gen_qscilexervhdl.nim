...
proc fcQsciLexerVHDL_trUtf8(s: cstring): struct_miqt_string {.importc: "QsciLexerVHDL_trUtf8".}
...
proc fcQsciLexerVHDL_trUtf82(s: cstring, c: cstring): struct_miqt_string {.importc: "QsciLexerVHDL_trUtf82".}
proc fcQsciLexerVHDL_trUtf83(s: cstring, c: cstring, n: cint): struct_miqt_string {.importc: "QsciLexerVHDL_trUtf83".}
...
proc trUtf8*(_: type gen_qscilexervhdl_types.QsciLexerVHDL, s: cstring): string =

  let v_ms = fcQsciLexerVHDL_trUtf8(s)
  let vx_ret = string.fromBytes(toOpenArrayByte(v_ms.data, 0, int(v_ms.len)-1))
  c_free(v_ms.data)
  vx_ret
...
proc tr2*(_: type gen_qscilexervhdl_types.QsciLexerVHDL, s: cstring, c: cstring): string =
...
proc tr3*(_: type gen_qscilexervhdl_types.QsciLexerVHDL, s: cstring, c: cstring, n: cint): string =
...
proc trUtf82*(_: type gen_qscilexervhdl_types.QsciLexerVHDL, s: cstring, c: cstring): string =

  let v_ms = fcQsciLexerVHDL_trUtf82(s, c)
  let vx_ret = string.fromBytes(toOpenArrayByte(v_ms.data, 0, int(v_ms.len)-1))
  c_free(v_ms.data)
  vx_ret

proc trUtf83*(_: type gen_qscilexervhdl_types.QsciLexerVHDL, s: cstring, c: cstring, n: cint): string =

  let v_ms = fcQsciLexerVHDL_trUtf83(s, c, n)
  let vx_ret = string.fromBytes(toOpenArrayByte(v_ms.data, 0, int(v_ms.len)-1))
  c_free(v_ms.data)
  vx_ret
...
proc miqt_exec_callback_QsciLexerVHDL_paper(self: ptr cQsciLexerVHDL, slot: int, style: cint): pointer {.exportc: "miqt_exec_callback_QsciLexerVHDL_paper ".} =
  ...
  virtualReturn.h
proc QsciLexerVHDLdefaultColorWithStyle*(self: gen_qscilexervhdl_types.QsciLexerVHDL, style: cint): gen_qcolor.QColor =
...
proc ondefaultColorWithStyle*(self: gen_qscilexervhdl_types.QsciLexerVHDL, slot: QsciLexerVHDLdefaultColorWithStyleProc) =
  # TODO check subclass
...
proc miqt_exec_callback_QsciLexerVHDL_defaultEolFill(self: ptr cQsciLexerVHDL, slot: int, style: cint): bool {.exportc: "miqt_exec_callback_QsciLexerVHDL_defaultEolFill ".} =
  ...
  virtualReturn
proc QsciLexerVHDLdefaultFontWithStyle*(self: gen_qscilexervhdl_types.QsciLexerVHDL, style: cint): gen_qfont.QFont =
...
proc ondefaultFontWithStyle*(self: gen_qscilexervhdl_types.QsciLexerVHDL, slot: QsciLexerVHDLdefaultFontWithStyleProc) =
  # TODO check subclass
...
proc miqt_exec_callback_QsciLexerVHDL_defaultFontWithStyle(self: ptr cQsciLexerVHDL, slot: int, style: cint): pointer {.exportc: "miqt_exec_callback_QsciLexerVHDL_defaultFontWithStyle ".} =
  ...
  virtualReturn.h
proc QsciLexerVHDLdefaultPaperWithStyle*(self: gen_qscilexervhdl_types.QsciLexerVHDL, style: cint): gen_qcolor.QColor =
...
proc ondefaultPaperWithStyle*(self: gen_qscilexervhdl_types.QsciLexerVHDL, slot: QsciLexerVHDLdefaultPaperWithStyleProc) =
  # TODO check subclass
