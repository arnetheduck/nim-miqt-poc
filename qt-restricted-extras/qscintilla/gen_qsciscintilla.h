...
struct QsciScintilla_VTable {
	...
	void (*enterEvent)(struct QsciScintilla_VTable* vtbl, QsciScintilla* self, QEvent* event);
	...
	bool (*nativeEvent)(struct QsciScintilla_VTable* vtbl, QsciScintilla* self, struct miqt_string eventType, void* message, long* result);
