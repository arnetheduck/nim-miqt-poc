...
class MiqtVirtualQsciLexerJavaScript final : public QsciLexerJavaScript {
	struct QsciLexerJavaScript_VTable* vtbl;
public:

	MiqtVirtualQsciLexerJavaScript(struct QsciLexerJavaScript_VTable* vtbl): QsciLexerJavaScript(), vtbl(vtbl) {};
	MiqtVirtualQsciLexerJavaScript(struct QsciLexerJavaScript_VTable* vtbl, QObject* parent): QsciLexerJavaScript(parent), vtbl(vtbl) {};

	virtual ~MiqtVirtualQsciLexerJavaScript() override { if(vtbl->destructor) vtbl->destructor(vtbl, this); }
...
QsciLexerJavaScript* QsciLexerJavaScript_new(struct QsciLexerJavaScript_VTable* vtbl) {
	return new MiqtVirtualQsciLexerJavaScript(vtbl);
}

QsciLexerJavaScript* QsciLexerJavaScript_new2(struct QsciLexerJavaScript_VTable* vtbl, QObject* parent) {
	return new MiqtVirtualQsciLexerJavaScript(vtbl, parent);
}
