...
proc trUtf82*(_: type gen_qscilexeryaml_types.QsciLexerYAML, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type gen_qscilexeryaml_types.QsciLexerYAML, s: cstring, c: cstring, n: cint): string =
