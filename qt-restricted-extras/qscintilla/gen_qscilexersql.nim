...
proc trUtf8*(_: type QsciLexerSQL, s: cstring): string =
...
proc trUtf82*(_: type QsciLexerSQL, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type QsciLexerSQL, s: cstring, c: cstring, n: cint): string =
