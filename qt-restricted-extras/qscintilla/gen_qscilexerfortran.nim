...
proc fcQsciLexerFortran_trUtf8(s: cstring): struct_miqt_string {.importc: "QsciLexerFortran_trUtf8".}
...
proc fcQsciLexerFortran_trUtf82(s: cstring, c: cstring): struct_miqt_string {.importc: "QsciLexerFortran_trUtf82".}
proc fcQsciLexerFortran_trUtf83(s: cstring, c: cstring, n: cint): struct_miqt_string {.importc: "QsciLexerFortran_trUtf83".}
...
proc trUtf8*(_: type QsciLexerFortran, s: cstring): string =
...
proc trUtf82*(_: type QsciLexerFortran, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type QsciLexerFortran, s: cstring, c: cstring, n: cint): string =
