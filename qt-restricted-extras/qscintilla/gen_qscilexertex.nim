...
proc trUtf8*(_: type QsciLexerTeX, s: cstring): string =
...
proc trUtf82*(_: type QsciLexerTeX, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type QsciLexerTeX, s: cstring, c: cstring, n: cint): string =
