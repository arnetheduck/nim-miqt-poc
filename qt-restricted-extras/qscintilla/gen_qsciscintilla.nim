...
proc fcQsciScintilla_protectedbase_initStyleOption(self: pointer, option: pointer): void {.importc: "QsciScintilla_protectedbase_initStyleOption".}
...
proc initStyleOption*(self: gen_qsciscintilla_types.QsciScintilla, option: gen_qstyleoption_types.QStyleOptionFrame): void =
  fcQsciScintilla_protectedbase_initStyleOption(self.h, option.h)
