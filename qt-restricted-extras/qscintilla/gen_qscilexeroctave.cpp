...
QObject* QsciLexerOctave_protectedbase_sender(const void* self) {
	return ( (const MiqtVirtualQsciLexerOctave*)(self) )->protectedbase_sender();
}

int QsciLexerOctave_protectedbase_senderSignalIndex(const void* self) {
	return ( (const MiqtVirtualQsciLexerOctave*)(self) )->protectedbase_senderSignalIndex();
}

int QsciLexerOctave_protectedbase_receivers(const void* self, const char* signal) {
	return ( (const MiqtVirtualQsciLexerOctave*)(self) )->protectedbase_receivers(signal);
}

bool QsciLexerOctave_protectedbase_isSignalConnected(const void* self, QMetaMethod* signal) {
	return ( (const MiqtVirtualQsciLexerOctave*)(self) )->protectedbase_isSignalConnected(signal);
}
