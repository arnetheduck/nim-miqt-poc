...
proc trUtf8*(_: type QsciLexerPOV, s: cstring): string =
...
proc trUtf82*(_: type QsciLexerPOV, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type QsciLexerPOV, s: cstring, c: cstring, n: cint): string =
