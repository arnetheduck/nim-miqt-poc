...
QMetaObject* miqt_exec_callback_QsciLexerPO_metaObject(const QsciLexerPO*, intptr_t);
void* miqt_exec_callback_QsciLexerPO_metacast(QsciLexerPO*, intptr_t, const char*);
...
public:
	...
	virtual const QMetaObject* metaObject() const override {
		...
		QMetaObject* callback_return_value = miqt_exec_callback_QsciLexerPO_metaObject(this, handle__metaObject);
	...
	virtual void* qt_metacast(const char* param1) override {
		...
		void* callback_return_value = miqt_exec_callback_QsciLexerPO_metacast(this, handle__metacast, sigval1);
...
bool QsciLexerPO_override_virtual_metaObject(void* self, intptr_t slot) {
...
bool QsciLexerPO_override_virtual_metacast(void* self, intptr_t slot) {
	MiqtVirtualQsciLexerPO* self_cast = dynamic_cast<MiqtVirtualQsciLexerPO*>( (QsciLexerPO*)(self) );
	if (self_cast == nullptr) {
		return false;
	}
