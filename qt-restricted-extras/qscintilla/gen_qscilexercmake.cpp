...
QMetaObject* miqt_exec_callback_QsciLexerCMake_metaObject(const QsciLexerCMake*, intptr_t);
void* miqt_exec_callback_QsciLexerCMake_metacast(QsciLexerCMake*, intptr_t, const char*);
int miqt_exec_callback_QsciLexerCMake_metacall(QsciLexerCMake*, intptr_t, int, int, void**);
...
public:
	...
	virtual const QMetaObject* metaObject() const override {
		...
		QMetaObject* callback_return_value = miqt_exec_callback_QsciLexerCMake_metaObject(this, handle__metaObject);
	...
	virtual void* qt_metacast(const char* param1) override {
		...
		void* callback_return_value = miqt_exec_callback_QsciLexerCMake_metacast(this, handle__metacast, sigval1);
	...
	virtual int qt_metacall(QMetaObject::Call param1, int param2, void** param3) override {
		...
		int callback_return_value = miqt_exec_callback_QsciLexerCMake_metacall(this, handle__metacall, sigval1, sigval2, sigval3);
...
bool QsciLexerCMake_override_virtual_metaObject(void* self, intptr_t slot) {
...
bool QsciLexerCMake_override_virtual_metacast(void* self, intptr_t slot) {
	MiqtVirtualQsciLexerCMake* self_cast = dynamic_cast<MiqtVirtualQsciLexerCMake*>( (QsciLexerCMake*)(self) );
	if (self_cast == nullptr) {
		return false;
	}
...
bool QsciLexerCMake_override_virtual_metacall(void* self, intptr_t slot) {
	MiqtVirtualQsciLexerCMake* self_cast = dynamic_cast<MiqtVirtualQsciLexerCMake*>( (QsciLexerCMake*)(self) );
	if (self_cast == nullptr) {
		return false;
	}
