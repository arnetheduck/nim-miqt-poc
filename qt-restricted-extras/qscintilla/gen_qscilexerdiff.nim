...
proc trUtf82*(_: type gen_qscilexerdiff_types.QsciLexerDiff, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type gen_qscilexerdiff_types.QsciLexerDiff, s: cstring, c: cstring, n: cint): string =
