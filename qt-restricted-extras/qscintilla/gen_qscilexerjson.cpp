...
QMetaObject* miqt_exec_callback_QsciLexerJSON_metaObject(const QsciLexerJSON*, intptr_t);
void* miqt_exec_callback_QsciLexerJSON_metacast(QsciLexerJSON*, intptr_t, const char*);
...
public:
	...
	virtual const QMetaObject* metaObject() const override {
		...
		QMetaObject* callback_return_value = miqt_exec_callback_QsciLexerJSON_metaObject(this, handle__metaObject);
	...
	virtual void* qt_metacast(const char* param1) override {
		...
		void* callback_return_value = miqt_exec_callback_QsciLexerJSON_metacast(this, handle__metacast, sigval1);
...
bool QsciLexerJSON_override_virtual_metaObject(void* self, intptr_t slot) {
...
bool QsciLexerJSON_override_virtual_metacast(void* self, intptr_t slot) {
	MiqtVirtualQsciLexerJSON* self_cast = dynamic_cast<MiqtVirtualQsciLexerJSON*>( (QsciLexerJSON*)(self) );
	if (self_cast == nullptr) {
		return false;
	}
