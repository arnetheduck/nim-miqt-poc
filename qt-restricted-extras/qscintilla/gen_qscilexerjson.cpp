...
class MiqtVirtualQsciLexerJSON final : public QsciLexerJSON {
	struct QsciLexerJSON_VTable* vtbl;
public:

	MiqtVirtualQsciLexerJSON(struct QsciLexerJSON_VTable* vtbl): QsciLexerJSON(), vtbl(vtbl) {};
	MiqtVirtualQsciLexerJSON(struct QsciLexerJSON_VTable* vtbl, QObject* parent): QsciLexerJSON(parent), vtbl(vtbl) {};

	virtual ~MiqtVirtualQsciLexerJSON() override { if(vtbl->destructor) vtbl->destructor(vtbl, this); }
	...
	QMetaObject* virtualbase_metaObject() const {
		...
		return (QMetaObject*) QsciLexerJSON::metaObject();
...
QsciLexerJSON* QsciLexerJSON_new(struct QsciLexerJSON_VTable* vtbl) {
	return new MiqtVirtualQsciLexerJSON(vtbl);
}

QsciLexerJSON* QsciLexerJSON_new2(struct QsciLexerJSON_VTable* vtbl, QObject* parent) {
	return new MiqtVirtualQsciLexerJSON(vtbl, parent);
}
...
QMetaObject* QsciLexerJSON_virtualbase_metaObject(const void* self) {
	return ( (const MiqtVirtualQsciLexerJSON*)(self) )->virtualbase_metaObject();
}

void* QsciLexerJSON_virtualbase_metacast(void* self, const char* param1) {
	return ( (MiqtVirtualQsciLexerJSON*)(self) )->virtualbase_metacast(param1);
}
...
bool QsciLexerJSON_protectedbase_readProperties(void* self, QSettings* qs, struct miqt_string prefix) {
	return ( (MiqtVirtualQsciLexerJSON*)(self) )->protectedbase_readProperties(qs, prefix);
}

bool QsciLexerJSON_protectedbase_writeProperties(const void* self, QSettings* qs, struct miqt_string prefix) {
	return ( (const MiqtVirtualQsciLexerJSON*)(self) )->protectedbase_writeProperties(qs, prefix);
}

QObject* QsciLexerJSON_protectedbase_sender(const void* self) {
	return ( (const MiqtVirtualQsciLexerJSON*)(self) )->protectedbase_sender();
}

int QsciLexerJSON_protectedbase_senderSignalIndex(const void* self) {
	return ( (const MiqtVirtualQsciLexerJSON*)(self) )->protectedbase_senderSignalIndex();
}

int QsciLexerJSON_protectedbase_receivers(const void* self, const char* signal) {
	return ( (const MiqtVirtualQsciLexerJSON*)(self) )->protectedbase_receivers(signal);
}

bool QsciLexerJSON_protectedbase_isSignalConnected(const void* self, QMetaMethod* signal) {
	return ( (const MiqtVirtualQsciLexerJSON*)(self) )->protectedbase_isSignalConnected(signal);
}
