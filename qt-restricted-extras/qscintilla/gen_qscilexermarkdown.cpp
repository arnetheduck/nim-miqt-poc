...
QMetaObject* miqt_exec_callback_QsciLexerMarkdown_metaObject(const QsciLexerMarkdown*, intptr_t);
void* miqt_exec_callback_QsciLexerMarkdown_metacast(QsciLexerMarkdown*, intptr_t, const char*);
...
public:
	...
	virtual const QMetaObject* metaObject() const override {
		...
		QMetaObject* callback_return_value = miqt_exec_callback_QsciLexerMarkdown_metaObject(this, handle__metaObject);
	...
	virtual void* qt_metacast(const char* param1) override {
		...
		void* callback_return_value = miqt_exec_callback_QsciLexerMarkdown_metacast(this, handle__metacast, sigval1);
...
bool QsciLexerMarkdown_override_virtual_metaObject(void* self, intptr_t slot) {
...
bool QsciLexerMarkdown_override_virtual_metacast(void* self, intptr_t slot) {
	MiqtVirtualQsciLexerMarkdown* self_cast = dynamic_cast<MiqtVirtualQsciLexerMarkdown*>( (QsciLexerMarkdown*)(self) );
	if (self_cast == nullptr) {
		return false;
	}
