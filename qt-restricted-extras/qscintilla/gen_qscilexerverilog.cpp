...
public:
	...
	QMetaObject* virtualbase_metaObject() const {
		...
		return (QMetaObject*) QsciLexerVerilog::metaObject();
...
bool QsciLexerVerilog_protectedbase_readProperties(void* self, QSettings* qs, struct miqt_string prefix) {
	return ( (MiqtVirtualQsciLexerVerilog*)(self) )->protectedbase_readProperties(qs, prefix);
}

bool QsciLexerVerilog_protectedbase_writeProperties(const void* self, QSettings* qs, struct miqt_string prefix) {
	return ( (const MiqtVirtualQsciLexerVerilog*)(self) )->protectedbase_writeProperties(qs, prefix);
}

QObject* QsciLexerVerilog_protectedbase_sender(const void* self) {
	return ( (const MiqtVirtualQsciLexerVerilog*)(self) )->protectedbase_sender();
}

int QsciLexerVerilog_protectedbase_senderSignalIndex(const void* self) {
	return ( (const MiqtVirtualQsciLexerVerilog*)(self) )->protectedbase_senderSignalIndex();
}

int QsciLexerVerilog_protectedbase_receivers(const void* self, const char* signal) {
	return ( (const MiqtVirtualQsciLexerVerilog*)(self) )->protectedbase_receivers(signal);
}

bool QsciLexerVerilog_protectedbase_isSignalConnected(const void* self, QMetaMethod* signal) {
	return ( (const MiqtVirtualQsciLexerVerilog*)(self) )->protectedbase_isSignalConnected(signal);
}
