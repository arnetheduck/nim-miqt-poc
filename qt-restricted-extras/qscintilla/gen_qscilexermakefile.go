...
func (this *QsciLexerMakefile) Metacall(param1 qt.QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {
...
func (this *QsciLexerMakefile) callVirtualBase_MetaObject() *qt.QMetaObject {

	return qt.UnsafeNewQMetaObject(unsafe.Pointer(C.QsciLexerMakefile_virtualbase_metaObject(unsafe.Pointer(this.h))))

}
func (this *QsciLexerMakefile) OnmetaObject(slot func(super func() *qt.QMetaObject) *qt.QMetaObject) {
...
func (this *QsciLexerMakefile) callVirtualBase_Metacall(param1 qt.QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {

	return (int)(C.QsciLexerMakefile_virtualbase_metacall(unsafe.Pointer(this.h), (C.int)(param1), (C.int)(param2), param3))

}
func (this *QsciLexerMakefile) OnMetacall(slot func(super func(param1 qt.QMetaObject__Call, param2 int, param3 unsafe.Pointer) int, param1 qt.QMetaObject__Call, param2 int, param3 unsafe.Pointer) int) {
