...
proc trUtf8*(_: type QsciAPIs, s: cstring): string =
...
proc trUtf82*(_: type QsciAPIs, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type QsciAPIs, s: cstring, c: cstring, n: cint): string =
