...
proc trUtf82*(_: type gen_qsciapis_types.QsciAPIs, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type gen_qsciapis_types.QsciAPIs, s: cstring, c: cstring, n: cint): string =
