...
QMetaObject* miqt_exec_callback_QsciLexerCustom_metaObject(const QsciLexerCustom*, intptr_t);
void* miqt_exec_callback_QsciLexerCustom_metacast(QsciLexerCustom*, intptr_t, const char*);
...
public:
	...
	virtual const QMetaObject* metaObject() const override {
		...
		QMetaObject* callback_return_value = miqt_exec_callback_QsciLexerCustom_metaObject(this, handle__metaObject);
	...
	virtual void* qt_metacast(const char* param1) override {
		...
		void* callback_return_value = miqt_exec_callback_QsciLexerCustom_metacast(this, handle__metacast, sigval1);
...
bool QsciLexerCustom_override_virtual_metaObject(void* self, intptr_t slot) {
...
bool QsciLexerCustom_override_virtual_metacast(void* self, intptr_t slot) {
	MiqtVirtualQsciLexerCustom* self_cast = dynamic_cast<MiqtVirtualQsciLexerCustom*>( (QsciLexerCustom*)(self) );
	if (self_cast == nullptr) {
		return false;
	}
