...
func (this *QsciLexerTeX) Metacall(param1 qt.QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {
...
func (this *QsciLexerTeX) callVirtualBase_MetaObject() *qt.QMetaObject {

	return qt.UnsafeNewQMetaObject(unsafe.Pointer(C.QsciLexerTeX_virtualbase_metaObject(unsafe.Pointer(this.h))))

}
func (this *QsciLexerTeX) OnMetaObject(slot func(super func() *qt.QMetaObject) *qt.QMetaObject) {
...
func (this *QsciLexerTeX) callVirtualBase_Metacall(param1 qt.QMetaObject__Call, param2 int, param3 unsafe.Pointer) int {

	return (int)(C.QsciLexerTeX_virtualbase_metacall(unsafe.Pointer(this.h), (C.int)(param1), (C.int)(param2), param3))

}
func (this *QsciLexerTeX) OnMetacall(slot func(super func(param1 qt.QMetaObject__Call, param2 int, param3 unsafe.Pointer) int, param1 qt.QMetaObject__Call, param2 int, param3 unsafe.Pointer) int) {
