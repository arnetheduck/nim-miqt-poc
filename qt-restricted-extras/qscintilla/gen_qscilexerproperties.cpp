...
QMetaObject* miqt_exec_callback_QsciLexerProperties_metaObject(const QsciLexerProperties*, intptr_t);
void* miqt_exec_callback_QsciLexerProperties_metacast(QsciLexerProperties*, intptr_t, const char*);
...
public:
	...
	virtual const QMetaObject* metaObject() const override {
		...
		QMetaObject* callback_return_value = miqt_exec_callback_QsciLexerProperties_metaObject(this, handle__metaObject);
	...
	virtual void* qt_metacast(const char* param1) override {
		...
		void* callback_return_value = miqt_exec_callback_QsciLexerProperties_metacast(this, handle__metacast, sigval1);
...
bool QsciLexerProperties_override_virtual_metaObject(void* self, intptr_t slot) {
...
bool QsciLexerProperties_override_virtual_metacast(void* self, intptr_t slot) {
	MiqtVirtualQsciLexerProperties* self_cast = dynamic_cast<MiqtVirtualQsciLexerProperties*>( (QsciLexerProperties*)(self) );
	if (self_cast == nullptr) {
		return false;
	}
