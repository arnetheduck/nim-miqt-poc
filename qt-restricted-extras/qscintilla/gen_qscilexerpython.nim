...
proc trUtf8*(_: type QsciLexerPython, s: cstring): string =
...
proc trUtf82*(_: type QsciLexerPython, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type QsciLexerPython, s: cstring, c: cstring, n: cint): string =
