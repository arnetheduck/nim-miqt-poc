...
QMetaObject* miqt_exec_callback_QsciLexerPascal_metaObject(const QsciLexerPascal*, intptr_t);
void* miqt_exec_callback_QsciLexerPascal_metacast(QsciLexerPascal*, intptr_t, const char*);
int miqt_exec_callback_QsciLexerPascal_metacall(QsciLexerPascal*, intptr_t, int, int, void**);
...
public:
	...
	virtual const QMetaObject* metaObject() const override {
		...
		QMetaObject* callback_return_value = miqt_exec_callback_QsciLexerPascal_metaObject(this, handle__metaObject);
	...
	virtual void* qt_metacast(const char* param1) override {
		...
		void* callback_return_value = miqt_exec_callback_QsciLexerPascal_metacast(this, handle__metacast, sigval1);
	...
	virtual int qt_metacall(QMetaObject::Call param1, int param2, void** param3) override {
		...
		int callback_return_value = miqt_exec_callback_QsciLexerPascal_metacall(this, handle__metacall, sigval1, sigval2, sigval3);
...
bool QsciLexerPascal_override_virtual_metaObject(void* self, intptr_t slot) {
...
bool QsciLexerPascal_override_virtual_metacast(void* self, intptr_t slot) {
	MiqtVirtualQsciLexerPascal* self_cast = dynamic_cast<MiqtVirtualQsciLexerPascal*>( (QsciLexerPascal*)(self) );
	if (self_cast == nullptr) {
		return false;
	}
...
bool QsciLexerPascal_override_virtual_metacall(void* self, intptr_t slot) {
	MiqtVirtualQsciLexerPascal* self_cast = dynamic_cast<MiqtVirtualQsciLexerPascal*>( (QsciLexerPascal*)(self) );
	if (self_cast == nullptr) {
		return false;
	}
