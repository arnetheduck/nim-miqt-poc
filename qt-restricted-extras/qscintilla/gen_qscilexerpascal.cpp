...
class MiqtVirtualQsciLexerPascal final : public QsciLexerPascal {
	struct QsciLexerPascal_VTable* vtbl;
public:

	MiqtVirtualQsciLexerPascal(struct QsciLexerPascal_VTable* vtbl): QsciLexerPascal(), vtbl(vtbl) {};
	MiqtVirtualQsciLexerPascal(struct QsciLexerPascal_VTable* vtbl, QObject* parent): QsciLexerPascal(parent), vtbl(vtbl) {};

	virtual ~MiqtVirtualQsciLexerPascal() override { if(vtbl->destructor) vtbl->destructor(vtbl, this); }
	...
	QMetaObject* virtualbase_metaObject() const {
		...
		return (QMetaObject*) QsciLexerPascal::metaObject();
	...
	int virtualbase_metacall(int param1, int param2, void** param3) {
		...
		return QsciLexerPascal::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
QsciLexerPascal* QsciLexerPascal_new(struct QsciLexerPascal_VTable* vtbl) {
	return new MiqtVirtualQsciLexerPascal(vtbl);
}

QsciLexerPascal* QsciLexerPascal_new2(struct QsciLexerPascal_VTable* vtbl, QObject* parent) {
	return new MiqtVirtualQsciLexerPascal(vtbl, parent);
}
...
QMetaObject* QsciLexerPascal_virtualbase_metaObject(const void* self) {
	return ( (const MiqtVirtualQsciLexerPascal*)(self) )->virtualbase_metaObject();
}

void* QsciLexerPascal_virtualbase_metacast(void* self, const char* param1) {
	return ( (MiqtVirtualQsciLexerPascal*)(self) )->virtualbase_metacast(param1);
}

int QsciLexerPascal_virtualbase_metacall(void* self, int param1, int param2, void** param3) {
	return ( (MiqtVirtualQsciLexerPascal*)(self) )->virtualbase_metacall(param1, param2, param3);
}
...
bool QsciLexerPascal_protectedbase_readProperties(void* self, QSettings* qs, struct miqt_string prefix) {
	return ( (MiqtVirtualQsciLexerPascal*)(self) )->protectedbase_readProperties(qs, prefix);
}

bool QsciLexerPascal_protectedbase_writeProperties(const void* self, QSettings* qs, struct miqt_string prefix) {
	return ( (const MiqtVirtualQsciLexerPascal*)(self) )->protectedbase_writeProperties(qs, prefix);
}

QObject* QsciLexerPascal_protectedbase_sender(const void* self) {
	return ( (const MiqtVirtualQsciLexerPascal*)(self) )->protectedbase_sender();
}

int QsciLexerPascal_protectedbase_senderSignalIndex(const void* self) {
	return ( (const MiqtVirtualQsciLexerPascal*)(self) )->protectedbase_senderSignalIndex();
}

int QsciLexerPascal_protectedbase_receivers(const void* self, const char* signal) {
	return ( (const MiqtVirtualQsciLexerPascal*)(self) )->protectedbase_receivers(signal);
}

bool QsciLexerPascal_protectedbase_isSignalConnected(const void* self, QMetaMethod* signal) {
	return ( (const MiqtVirtualQsciLexerPascal*)(self) )->protectedbase_isSignalConnected(signal);
}
