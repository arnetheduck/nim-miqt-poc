...
proc trUtf8*(_: type QsciLexerHTML, s: cstring): string =
...
proc trUtf82*(_: type QsciLexerHTML, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type QsciLexerHTML, s: cstring, c: cstring, n: cint): string =
