...
proc trUtf8*(_: type QsciLexerMatlab, s: cstring): string =
...
proc trUtf82*(_: type QsciLexerMatlab, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type QsciLexerMatlab, s: cstring, c: cstring, n: cint): string =
