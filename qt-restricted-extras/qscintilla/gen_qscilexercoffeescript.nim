...
proc trUtf8*(_: type QsciLexerCoffeeScript, s: cstring): string =
...
proc trUtf82*(_: type QsciLexerCoffeeScript, s: cstring, c: cstring): string =
...
proc trUtf83*(_: type QsciLexerCoffeeScript, s: cstring, c: cstring, n: cint): string =
