...
class MiqtVirtualQsciLexerCSharp final : public QsciLexerCSharp {
	struct QsciLexerCSharp_VTable* vtbl;
public:

	MiqtVirtualQsciLexerCSharp(struct QsciLexerCSharp_VTable* vtbl): QsciLexerCSharp(), vtbl(vtbl) {};
	MiqtVirtualQsciLexerCSharp(struct QsciLexerCSharp_VTable* vtbl, QObject* parent): QsciLexerCSharp(parent), vtbl(vtbl) {};

	virtual ~MiqtVirtualQsciLexerCSharp() override { if(vtbl->destructor) vtbl->destructor(vtbl, this); }
	...
	QMetaObject* virtualbase_metaObject() const {
		...
		return (QMetaObject*) QsciLexerCSharp::metaObject();
	...
	int virtualbase_metacall(int param1, int param2, void** param3) {
		...
		return QsciLexerCSharp::qt_metacall(static_cast<QMetaObject::Call>(param1), static_cast<int>(param2), param3);
...
QsciLexerCSharp* QsciLexerCSharp_new(struct QsciLexerCSharp_VTable* vtbl) {
	return new MiqtVirtualQsciLexerCSharp(vtbl);
}

QsciLexerCSharp* QsciLexerCSharp_new2(struct QsciLexerCSharp_VTable* vtbl, QObject* parent) {
	return new MiqtVirtualQsciLexerCSharp(vtbl, parent);
}
...
QMetaObject* QsciLexerCSharp_virtualbase_metaObject(const void* self) {
	return ( (const MiqtVirtualQsciLexerCSharp*)(self) )->virtualbase_metaObject();
}

void* QsciLexerCSharp_virtualbase_metacast(void* self, const char* param1) {
	return ( (MiqtVirtualQsciLexerCSharp*)(self) )->virtualbase_metacast(param1);
}

int QsciLexerCSharp_virtualbase_metacall(void* self, int param1, int param2, void** param3) {
	return ( (MiqtVirtualQsciLexerCSharp*)(self) )->virtualbase_metacall(param1, param2, param3);
}
...
bool QsciLexerCSharp_protectedbase_readProperties(void* self, QSettings* qs, struct miqt_string prefix) {
	return ( (MiqtVirtualQsciLexerCSharp*)(self) )->protectedbase_readProperties(qs, prefix);
}

bool QsciLexerCSharp_protectedbase_writeProperties(const void* self, QSettings* qs, struct miqt_string prefix) {
	return ( (const MiqtVirtualQsciLexerCSharp*)(self) )->protectedbase_writeProperties(qs, prefix);
}

QObject* QsciLexerCSharp_protectedbase_sender(const void* self) {
	return ( (const MiqtVirtualQsciLexerCSharp*)(self) )->protectedbase_sender();
}

int QsciLexerCSharp_protectedbase_senderSignalIndex(const void* self) {
	return ( (const MiqtVirtualQsciLexerCSharp*)(self) )->protectedbase_senderSignalIndex();
}

int QsciLexerCSharp_protectedbase_receivers(const void* self, const char* signal) {
	return ( (const MiqtVirtualQsciLexerCSharp*)(self) )->protectedbase_receivers(signal);
}

bool QsciLexerCSharp_protectedbase_isSignalConnected(const void* self, QMetaMethod* signal) {
	return ( (const MiqtVirtualQsciLexerCSharp*)(self) )->protectedbase_isSignalConnected(signal);
}
