...
type cQAbstractNativeEventFilterVTable = object
  ...
  nativeEventFilter*: proc(vtbl, self: pointer, eventType: struct_miqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl, raises: [], gcsafe.}
...
proc miqt_exec_callback_cQAbstractNativeEventFilter_nativeEventFilter(vtbl: pointer, self: pointer, eventType: struct_miqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  ...
  let virtualReturn = vtbl[].nativeEventFilter(self, slotval1, slotval2, slotval3)
  virtualReturn
