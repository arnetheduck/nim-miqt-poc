...
proc create*(T: type gen_qbytearraymatcher_types.QByteArrayMatcher, pattern: gen_qbytearrayview_types.QByteArrayView): gen_qbytearraymatcher_types.QByteArrayMatcher =
