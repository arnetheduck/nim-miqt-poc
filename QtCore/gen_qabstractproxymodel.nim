...
type QAbstractProxyModelclearItemDataProc* = proc(index: gen_qabstractitemmodel_types.QModelIndex): bool
...
type QAbstractProxyModelmultiDataProc* = proc(index: gen_qabstractitemmodel_types.QModelIndex, roleDataSpan: gen_qabstractitemmodel_types.QModelRoleDataSpan): void
