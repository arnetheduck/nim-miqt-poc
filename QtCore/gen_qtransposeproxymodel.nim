...
type QTransposeProxyModelclearItemDataProc* = proc(index: gen_qabstractitemmodel_types.QModelIndex): bool
...
type QTransposeProxyModelmultiDataProc* = proc(index: gen_qabstractitemmodel_types.QModelIndex, roleDataSpan: gen_qabstractitemmodel_types.QModelRoleDataSpan): void
