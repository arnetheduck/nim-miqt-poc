...
template UNICODE_ACCEL*(_: type ModifierEnum): untyped = 0
...
template MidButton*(_: type MouseButtonEnum): untyped = 4
...
template TextBypassShaping*(_: type TextFlagEnum): untyped = 1048576
...
template WA_ContentsPropagated*(_: type WidgetAttributeEnum): untyped = 3
template WA_OpaquePaintEvent*(_: type WidgetAttributeEnum): untyped = 4
template WA_NoBackground*(_: type WidgetAttributeEnum): untyped = 4
...
template WA_MacNoClickThrough*(_: type WidgetAttributeEnum): untyped = 12
...
template WA_MacBrushedMetal*(_: type WidgetAttributeEnum): untyped = 46
template WA_MacMetalStyle*(_: type WidgetAttributeEnum): untyped = 46
...
template WA_WState_DND*(_: type WidgetAttributeEnum): untyped = 67
...
template WA_GroupLeader*(_: type WidgetAttributeEnum): untyped = 72
...
template WA_ForceAcceptDrops*(_: type WidgetAttributeEnum): untyped = 79
...
template WA_MSWindowsUseDirect3D*(_: type WidgetAttributeEnum): untyped = 94
...
template WA_MacVariableSize*(_: type WidgetAttributeEnum): untyped = 102
...
template WA_MacFrameworkScaled*(_: type WidgetAttributeEnum): untyped = 117
...
template WA_MacNoShadow*(_: type WidgetAttributeEnum): untyped = 127
...
template AA_ImmediateWidgetCreation*(_: type ApplicationAttributeEnum): untyped = 0
template AA_MSWindowsUseDirect3DByDefault*(_: type ApplicationAttributeEnum): untyped = 1
...
template AA_MacPluginApplication*(_: type ApplicationAttributeEnum): untyped = 5
...
template AA_X11InitThreads*(_: type ApplicationAttributeEnum): untyped = 10
...
template AA_DisableWindowContextHelpButton*(_: type ApplicationAttributeEnum): untyped = 30
...
template SystemLocaleDate*(_: type DateFormatEnum): untyped = 2
template LocalDate*(_: type DateFormatEnum): untyped = 2
template LocaleDate*(_: type DateFormatEnum): untyped = 3
template SystemLocaleShortDate*(_: type DateFormatEnum): untyped = 4
template SystemLocaleLongDate*(_: type DateFormatEnum): untyped = 5
template DefaultLocaleShortDate*(_: type DateFormatEnum): untyped = 6
template DefaultLocaleLongDate*(_: type DateFormatEnum): untyped = 7
...
template ImMicroFocus*(_: type InputMethodQueryEnum): untyped = 2
...
template BackgroundColorRole*(_: type ItemDataRoleEnum): untyped = 8
template TextColorRole*(_: type ItemDataRoleEnum): untyped = 9
...
template ItemIsTristate*(_: type ItemFlagEnum): untyped = 64
...
template MatchRegExp*(_: type MatchFlagEnum): untyped = 4
template MatchWildcard*(_: type MatchFlagEnum): untyped = 5
template MatchFixedString*(_: type MatchFlagEnum): untyped = 8
template MatchRegularExpression*(_: type MatchFlagEnum): untyped = 9
...
template MacQuartz*(_: type QInternalPaintDeviceFlagsEnum): untyped = 9
